...
public abstract class a extends s2 {
    ...
    public final int e(int i10, int i11, boolean z10) {
        int s10 = s(i10);
        int v = v(s10);
        int e9 = x(s10).e(i10 - v, i11 == 2 ? 0 : i11, z10);
        if (e9 != -1) {
            return v + e9;
        }
        int w10 = w(s10, z10);
    ...
    */
    ...
    public final r2 m(int i10, r2 r2Var, long j10) {
        ...
        int v = v(s10);
        int u10 = u(s10);
        x(s10).m(i10 - v, r2Var, j10);
        Object t10 = t(s10);
        if (!r2.D.equals(r2Var.a)) {
            t10 = Pair.create(t10, r2Var.a);
        }
        r2Var.a = t10;
        r2Var.A += u10;
        r2Var.B += u10;
