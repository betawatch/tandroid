...
public abstract class j {
    ...
    public static final k6.c[] b = {new k6.c("app_client", 4), new k6.c("carrier_auth", 1), new k6.c("wear3_oem_companion", 1), new k6.c("wear_consent", 2), new k6.c("wear_consent_recordoptin", 1), new k6.c("wear_consent_supervised", 1), new k6.c("wear_fast_pair_account_key_sync", 1), new k6.c("wear_get_related_configs", 1), new k6.c("wear_get_node_id", 1), new k6.c("wear_retry_connection", 1), new k6.c("wear_set_cloud_sync_setting_by_node", 1), new k6.c("wear_update_config", 1), new k6.c("wear_update_connection_retry_strategy", 1), new k6.c("wearable_services", 1)};
    ...
    public static String a(int i10) {
        switch (i10) {
            ...
            case 12:
            default:
                return hg.c.i(i10, "unknown status code: ");
            case 2:
