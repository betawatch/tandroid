    ...
    public p9.b c(int i10) {
        ...
        try {
            if (!j.b(2, i10)) {
                ...
                if (H != null) {
                    p9.b s6 = ((o3.c) this.c).s(H);
                    f("Loaded cached settings: ", H);
                    ((cb.b) this.d).getClass();
                    long currentTimeMillis = System.currentTimeMillis();
                    if (j.b(3, i10) || s6.c >= currentTimeMillis) {
                        try {
        ...
        while (true) {
            ...
            if (!((Boolean) hVar.f(new g3.b(gVar) { // from class: e3.e
                ...
                public final Object h() {
                    ...
                    switch (i13) {
                        case 0:
                            i iVar3 = iVar2;
                            f3.h hVar2 = (f3.h) ((f3.d) this.b.c);
                            SQLiteDatabase a10 = hVar2.a();
                            a10.beginTransaction();
                            try {
                                Long b11 = f3.h.b(a10, iVar3);
                                if (b11 == null) {
                                    bool = Boolean.FALSE;
                                } else {
            ...
            if (a2 == null) {
                ...
                if (bArr2 != null) {
                    ...
                    a9.a aVar4 = new a9.a();
                    aVar4.f = new HashMap();
                    aVar4.d = Long.valueOf(((h3.a) gVar.g).l());
                    aVar4.e = Long.valueOf(((h3.a) gVar.h).l());
                ...
                while (it2.hasNext()) {
                    ...
                    for (y2.h hVar4 : (List) entry.getValue()) {
                        ...
                        if (((Long) s3Var.f) == null) {
                            str6 = w2.k(str6, " timezoneOffsetSeconds");
                        }
                        if (!str6.isEmpty()) {
                    ...
                    arrayList3.add(new x2.l(l10, l11, jVar, num, str2, arrayList4));
                    it2 = it2;
                }
                bArr = bArr2;
                j10 = j11;
