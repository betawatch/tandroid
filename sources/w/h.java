...
public abstract class h {
    ...
    public static void a(Bundle bundle, AbstractCollection abstractCollection, e eVar) {
        ...
        if (parcelableArrayList == null) {
            throw new g("Bundle is missing the collection", eVar);
        }
    ...
    public static Object b(Bundle bundle, e eVar) {
        ...
        if (string == null) {
            throw new g(a4.a.p("Missing enum name [", string, "]"), eVar);
        }
        String string2 = bundle.getString("tag_class_name");
        if (string2 == null) {
            throw new g(a4.a.p("Missing enum className [", string2, "]"), eVar);
        }
        try {
            ...
            throw new g(p6.j("Enum value [", string, "] does not exist in enum class [", string2, "]"), eVar, e7);
    ...
    public static Object c(Bundle bundle, e eVar) {
        ...
        if (binder == null) {
            throw new g("Bundle is missing the binder", eVar);
        }
        String string = bundle.getString("tag_class_name");
        if (string == null) {
            throw new g("Bundle is missing IInterface class name", eVar);
        }
        try {
    ...
    public static HashMap d(Bundle bundle, e eVar) {
        ArrayList parcelableArrayList = bundle.getParcelableArrayList("tag_value");
        if (parcelableArrayList == null) {
            throw new g("Bundle is missing the map", eVar);
        }
        ...
        while (i10 < size) {
            ...
            if (bundle3 == null) {
                throw new g("Bundle is missing key", eVar);
            }
    ...
    public static Object e(Bundle bundle, e eVar) {
        String string = bundle.getString("tag_class_name");
        if (string == null) {
            throw new g("Bundle is missing the class name", eVar);
        }
        try {
    ...
    */
        ...
        try {
            switch (i10) {
                case 0:
                    ...
                    if (obj == null) {
                        throw new g("Bundle is missing the primitive value", eVar2);
                    }
                    eVar2.close();
                    return obj;
                case 1:
                ...
                case 6:
                    ...
                    if (bundle2 == null) {
                        throw new g("IconCompat bundle is null", eVar2);
                    }
                    IconCompat a2 = IconCompat.a(bundle2);
                    if (a2 == null) {
                        throw new g("Failed to create IconCompat from bundle", eVar2);
                    }
                    eVar2.close();
                    return a2;
                case 7:
                ...
                case 8:
                    String string = bundle.getString("tag_value");
                    if (string == null) {
                        throw new g("Class is missing the class name", eVar2);
                    }
                    try {
                        Class<?> cls = Class.forName(string);
                        eVar2.close();
                ...
                case 9:
                    IBinder binder = bundle.getBinder("tag_value");
                    if (binder == null) {
                        throw new g("Bundle is missing the binder", eVar2);
                    }
                    eVar2.close();
                    return binder;
                case 10:
                    ...
                    return a10;
                default:
                    throw new g("Unsupported class type in bundle: " + i10, eVar2);
            }
        } catch (Throwable th2) {
            eVar2.close();
            throw th2;
    ...
    public static Method g(Class cls, String str, e eVar) {
        if (cls == null || cls == Object.class) {
            throw new g("No method " + str + " in class " + cls, eVar);
        }
        ...
        try {
            ...
            while (i10 < size) {
                ...
                try {
                    ...
                    throw new g(p6.i("Field is not accessible: ", t10), eVar, e);
                }
            }
            return bundle;
    ...
    public static Bundle n(Object obj, e eVar) {
        ...
        if (!(obj instanceof Parcelable)) {
            throw new g("Unsupported primitive type: ".concat(obj.getClass().getName()), eVar);
        }
    ...
    public static Bundle o(Object obj, String str, e eVar) {
        ...
        try {
            if (obj == null) {
                throw new g("Bundling of null object is not supported", eVar2);
            }
            ...
            if (!(obj instanceof Boolean) && !(obj instanceof Byte) && !(obj instanceof Character) && !(obj instanceof Short) && !(obj instanceof Integer) && !(obj instanceof Long) && !(obj instanceof Double) && !(obj instanceof Float) && !(obj instanceof String) && !(obj instanceof Parcelable)) {
                ...
                if (obj instanceof Map) {
                    Bundle l4 = l((Map) obj, eVar2);
                    eVar2.close();
                    return l4;
                }
                if (obj instanceof List) {
                    Bundle j3 = j((List) obj, eVar2);
                    j3.putInt("tag_class_type", 4);
                    eVar2.close();
                    return j3;
                }
                if (obj instanceof Set) {
                    Bundle j10 = j((Set) obj, eVar2);
                ...
                if (obj.getClass().isArray()) {
                    throw new g("Object serializing contains an array, use a list or a set instead", eVar2);
                }
