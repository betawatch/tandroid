...
public abstract class h {
    ...
    public static Object b(Bundle bundle, f fVar) {
        ...
        if (string == null) {
            throw new g(a4.a.q("Missing enum name [", string, "]"), fVar);
        }
        String string2 = bundle.getString("tag_class_name");
        if (string2 == null) {
            throw new g(a4.a.q("Missing enum className [", string2, "]"), fVar);
        }
        try {
            return g(Class.forName(string2), "valueOf", fVar).invoke(null, string);
        } catch (ClassNotFoundException e) {
            throw new g(a4.a.q("Enum class [", string2, "] not found"), fVar, e);
        } catch (IllegalArgumentException e7) {
            throw new g(q3.j("Enum value [", string, "] does not exist in enum class [", string2, "]"), fVar, e7);
        } catch (ReflectiveOperationException e10) {
            throw new g(a4.a.q("Enum of class [", string2, "] missing valueOf method"), fVar, e10);
        }
    }
    ...
    public static Object c(Bundle bundle, f fVar) {
        ...
        try {
            ...
            throw new g("Binder for unknown IInterface: ".concat(string), fVar, e);
        } catch (ReflectiveOperationException e7) {
            throw new g("Method to create IInterface from a Binder is not accessible for interface: ".concat(string), fVar, e7);
        }
    }
    ...
    public static HashMap d(Bundle bundle, f fVar) {
        ...
        while (i10 < size) {
            ...
            hashMap.put(f(bundle3, fVar), bundle4 == null ? null : f(bundle4, fVar));
        }
        return hashMap;
    }
    ...
    public static Object e(Bundle bundle, f fVar) {
        ...
        try {
            ...
            throw new g("Object for unknown class: ".concat(string), fVar, e);
        } catch (IllegalArgumentException e7) {
            throw new g("Failed to deserialize class: ".concat(string), fVar, e7);
        } catch (NoSuchMethodException e10) {
            throw new g("Object missing no args constructor: ".concat(string), fVar, e10);
        } catch (ReflectiveOperationException e11) {
            throw new g("Constructor or field is not accessible: ".concat(string), fVar, e11);
        }
    }
    ...
    */
    public static Object f(Bundle bundle, f fVar) {
        ...
        f fVar2 = new f(bundle, str, fVar.b);
        try {
            switch (i10) {
                case 0:
                ...
                case 8:
                    ...
                    try {
                        ...
                        throw new g("Class name is unknown: ".concat(string), fVar2, e7);
                    }
                case 9:
                    IBinder binder = bundle.getBinder("tag_value");
                    if (binder == null) {
    ...
    public static Bundle j(Collection collection, f fVar) {
        ...
        int i10 = 0;
        while (it.hasNext()) {
            arrayList.add(o(it.next(), "<item " + i10 + ">", fVar));
            i10++;
        }
    ...
    public static Bundle k(Object obj, f fVar) {
        ...
        try {
            ...
            throw new g("Enum missing name method", fVar, e);
        }
    }
    ...
    public static Bundle l(Map map, f fVar) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            bundle2.putBundle("tag_1", o(entry.getKey(), "<key " + i10 + ">", fVar));
            if (entry.getValue() != null) {
                bundle2.putBundle("tag_2", o(entry.getValue(), "<value " + i10 + ">", fVar));
            }
            i10++;
    ...
    public static Bundle m(Object obj, f fVar) {
        ...
        try {
            ...
            while (i10 < size) {
                ...
                field.setAccessible(true);
                String g10 = c.g(field.getDeclaringClass().getName(), field.getName());
                try {
                    Object obj3 = field.get(obj);
                    if (obj3 != null) {
                        bundle.putParcelable(g10, o(obj3, field.getName(), fVar));
                    }
                } catch (IllegalAccessException e) {
                    throw new g(q3.i("Field is not accessible: ", g10), fVar, e);
                }
            }
            return bundle;
        } catch (NoSuchMethodException e7) {
            throw new g("Class to deserialize is missing a no args constructor: ".concat(name), fVar, e7);
        }
    }
    ...
    public static Bundle o(Object obj, String str, f fVar) {
        ...
        if (obj != null) {
            ...
            while (it.hasNext()) {
                if (((e) it.next()).a == obj) {
                    throw new d("Found cycle while bundling type ".concat(obj.getClass().getSimpleName()), fVar);
                }
            }
        }
        ...
        try {
            ...
            if (!(obj instanceof Boolean) && !(obj instanceof Byte) && !(obj instanceof Character) && !(obj instanceof Short) && !(obj instanceof Integer) && !(obj instanceof Long) && !(obj instanceof Double) && !(obj instanceof Float) && !(obj instanceof String) && !(obj instanceof Parcelable)) {
                ...
                if (obj instanceof Map) {
                    Bundle l4 = l((Map) obj, fVar2);
                    fVar2.close();
                    return l4;
                }
                if (obj instanceof List) {
                    Bundle j3 = j((List) obj, fVar2);
                    j3.putInt("tag_class_type", 4);
                    fVar2.close();
                    return j3;
                }
                if (obj instanceof Set) {
                    Bundle j10 = j((Set) obj, fVar2);
