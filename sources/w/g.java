...
public abstract class g {
    ...
    public static Object b(Bundle bundle, e eVar) {
        ...
        try {
            ...
            throw new f(ai.k("Enum value [", string, "] does not exist in enum class [", string2, "]"), eVar, e6);
            ...
            switch (i10) {
                ...
                case 8:
                    ...
                    try {
                        ...
                        throw new f("Class name is unknown: ".concat(string), eVar2, e6);
                    }
                case 9:
                    IBinder binder = bundle.getBinder("tag_value");
                    if (binder == null) {
    ...
    public static Bundle m(Object obj, e eVar) {
        ...
        try {
            ...
            while (i10 < size) {
                ...
                field.setAccessible(true);
                String k10 = w2.k(field.getDeclaringClass().getName(), field.getName());
                try {
                    ...
                    throw new f(w2.e("Field is not accessible: ", k10), eVar, e);
                }
            }
            return bundle;
