...
public abstract class a2 {
    ...
    public static final /* synthetic */ a2[] G0;
    ...
    static {
        ...
        w1 w1Var = new w1();
        f = w1Var;
        a2 a2Var = new a2() { // from class: pc.x1
            @Override // pc.a2
        ...
        D0 = new char[]{0, '\t', '\n', '\f', '\r', ' ', '\"', '\'', '/', '<', '=', '>'};
        E0 = new char[]{0, '\t', '\n', '\f', '\r', ' ', '\"', '&', '\'', '<', '=', '>', '`'};
        F0 = String.valueOf((char) 65533);
    }

    public static void a(k kVar, a aVar, a2 a2Var, a2 a2Var2) {
        char i10 = aVar.i();
        if (i10 == 0) {
            kVar.m(a2Var);
            aVar.a();
    ...
    public static void b(k kVar, a aVar, a2 a2Var) {
