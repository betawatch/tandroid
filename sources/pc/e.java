...
public final class e extends AbstractList implements List {
    ...
    public final boolean addAll(int i9, Collection elements) {
        ...
        if (i9 >= ((this.c + 1) >> 1)) {
            ...
            if (r11 < r10) {
                ...
                if (i12 <= objArr.length) {
                    f.c(i11, r11, r10, objArr, objArr);
                } else if (i11 >= objArr.length) {
                    f.c(i11 - objArr.length, r11, r10, objArr, objArr);
                } else {
                    int length = r10 - (i12 - objArr.length);
                    f.c(0, length, r10, objArr, objArr);
                    Object[] objArr2 = this.b;
                    f.c(i11, r11, length, objArr2, objArr2);
                }
            } else {
                Object[] objArr3 = this.b;
                ...
                if (i11 >= objArr4.length) {
                    f.c(i11 - objArr4.length, r11, objArr4.length, objArr4, objArr4);
                } else {
                    f.c(0, objArr4.length - size, objArr4.length, objArr4, objArr4);
                    Object[] objArr5 = this.b;
                    f.c(i11, r11, objArr5.length - size, objArr5, objArr5);
                }
            }
            i(r11, elements);
            return true;
        ...
        if (r11 < i13) {
            Object[] objArr6 = this.b;
            f.c(i14, i13, objArr6.length, objArr6, objArr6);
            if (size >= r11) {
                Object[] objArr7 = this.b;
            ...
            f.c(i14, i13, r11, objArr10, objArr10);
        } else {
            ...
            if (length2 >= i15) {
                f.c(i14, i13, r11, objArr11, objArr11);
            } else {
                f.c(i14, i13, i13 + length2, objArr11, objArr11);
    ...
    public final int indexOf(Object obj) {
        ...
        if (i10 < r10) {
            while (i10 < r10) {
                if (kotlin.jvm.internal.i.a(obj, this.b[i10])) {
                    i9 = this.a;
                } else {
                    i10++;
                }
        ...
        while (true) {
            if (i10 >= length) {
                for (int i11 = 0; i11 < r10; i11++) {
                    if (kotlin.jvm.internal.i.a(obj, this.b[i11])) {
    ...
    public final int lastIndexOf(Object obj) {
        ...
        if (i10 < r10) {
            length = r10 - 1;
            if (i10 <= length) {
                while (!kotlin.jvm.internal.i.a(obj, this.b[length])) {
                    if (length != i10) {
                        length--;
                    }
                }
    ...
    public final void n(int i9) {
        ...
        if (i10 - 2147483639 > 0) {
            i10 = i9 > 2147483639 ? ConnectionsManager.DEFAULT_DATACENTER_ID : 2147483639;
        }
    ...
    public final int o(int i9) {
        kotlin.jvm.internal.i.e(this.b, "<this>");
        if (i9 == r0.length - 1) {
            return 0;
        }
        return i9 + 1;
    ...
    public final int p(int i9) {
        return i9 < 0 ? i9 + this.b.length : i9;
    }
    ...
    public final void removeRange(int i9, int i10) {
        ...
        s();
        if (i9 < this.c - i10) {
            int r10 = r((i9 - 1) + this.a);
            int r11 = r((i10 - 1) + this.a);
            while (i9 > 0) {
                int i12 = r10 + 1;
            ...
            int r12 = r(this.a + i11);
            q(this.a, r12);
            this.a = r12;
        } else {
            int r13 = r(this.a + i10);
            int r14 = r(this.a + i9);
            int i15 = this.c;
            while (true) {
                i15 -= i10;
