...
public abstract /* synthetic */ class a {
    ...
    public static s t(int i10, HashMap hashMap) {
        DesugarCollections.unmodifiableMap(new HashMap(hashMap));
        return new s(i10);
    }
    ...
    public static r9.c u(int i10, i6 i6Var) {
        s sVar = new s(i10);
        if (((HashMap) i6Var.c) == null) {
            i6Var.c = new HashMap();
        }
        ((HashMap) i6Var.c).put(k7.w.class, sVar);
        return new r9.c((String) i6Var.b, ((HashMap) i6Var.c) == null ? Collections.EMPTY_MAP : DesugarCollections.unmodifiableMap(new HashMap((HashMap) i6Var.c)));
    }
