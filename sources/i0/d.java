        ...
        while (i12 < length) {
            ...
            while (i13 < fArr3.length) {
                if (c13 == 'A') {
                    ...
                    int i14 = i10 + 5;
                    int i15 = i10 + 6;
                    a(path, f30, f31, fArr[i14], fArr[i15], fArr[i10], fArr[i10 + 1], fArr[i10 + 2], fArr[i10 + 3] != 0.0f, fArr[i10 + 4] != 0.0f);
                    f22 = fArr[i14];
                    f10 = fArr[i15];
                    f23 = f10;
                    f11 = f22;
                    ...
                    int i18 = i10 + 4;
                    int i19 = i10 + 5;
                    path2.cubicTo(fArr[i10], fArr[i10 + 1], fArr[i16], fArr[i17], fArr[i18], fArr[i19]);
                    float f32 = fArr[i18];
                    float f33 = fArr[i19];
                    f22 = fArr[i16];
                    f23 = fArr[i17];
                    ...
                    int i21 = i10 + 2;
                    int i22 = i10 + 3;
                    path2.quadTo(fArr[i10], fArr[i20], fArr[i21], fArr[i22]);
                    float f34 = fArr[i10];
                    float f35 = fArr[i20];
                    float f36 = fArr[i21];
                    float f37 = fArr[i22];
                    ...
                    if (c13 == 'c') {
                        ...
                        int i25 = i10 + 4;
                        int i26 = i10 + 5;
                        path2.rCubicTo(fArr[i10], fArr[i10 + 1], fArr[i23], fArr[i24], fArr[i25], fArr[i26]);
                        float f38 = fArr[i23] + f28;
                        float f39 = fArr[i24] + f29;
                        f28 += fArr[i25];
                        f29 += fArr[i26];
                        f22 = f38;
                        f23 = f39;
                        ...
                        if (c13 != 'q') {
                            if (c13 != 'v') {
                                if (c13 == 'L') {
                                    ...
                                    i10 = i13;
                                    int i27 = i10 + 1;
                                    path2.lineTo(fArr[i10], fArr[i27]);
                                    f11 = fArr[i10];
                                    f10 = fArr[i27];
                                } else if (c13 == 'M') {
                                    fArr = fArr3;
                                    ...
                                    if (c13 == 'T') {
                                        ...
                                        int i28 = i10 + 1;
                                        path2.quadTo(f28, f29, fArr[i10], fArr[i28]);
                                        f11 = fArr[i10];
                                        f10 = fArr[i28];
                                        dVar = dVar3;
                                        f22 = f28;
                                        ...
                                        i10 = i13;
                                        int i29 = i10 + 1;
                                        path2.rLineTo(fArr[i10], fArr[i29]);
                                        f28 += fArr[i10];
                                        f15 = fArr[i29];
                                    } else if (c13 == 'm') {
                                        fArr = fArr3;
                                        ...
                                        if (c13 != 't') {
                                            ...
                                            int i30 = i13 + 1;
                                            path2.rQuadTo(f18, f19, fArr3[i13], fArr3[i30]);
                                            float f42 = f18 + f28;
                                            float f43 = f19 + f29;
                                            float f44 = f28 + fArr3[i13];
                                            f29 += fArr3[i30];
                                            f23 = f43;
                                            fArr = fArr3;
                                            i10 = i13;
                                        ...
                                        fArr = fArr3;
                                        i10 = i31;
                                        path2.rCubicTo(f17, f16, fArr3[i31], fArr3[i32], fArr3[i33], fArr3[i34]);
                                        f12 = fArr[i10] + f28;
                                        f13 = fArr[i32] + f29;
                                        f28 += fArr[i33];
                                        f14 = fArr[i34];
                                    ...
                                    int i36 = i10 + 2;
                                    int i37 = i10 + 3;
                                    path2.cubicTo(f45, f46, fArr[i10], fArr[i35], fArr[i36], fArr[i37]);
                                    float f47 = fArr[i10];
                                    f22 = f47;
                                    f23 = fArr[i35];
                                    f11 = fArr[i36];
                            ...
                            int i39 = i10 + 2;
                            int i40 = i10 + 3;
                            path2.rQuadTo(fArr[i10], fArr[i38], fArr[i39], fArr[i40]);
                            f12 = fArr[i10] + f28;
                            f13 = fArr[i38] + f29;
                            f28 += fArr[i39];
                            f14 = fArr[i40];
                    ...
                    i10 = i13;
                    int i41 = i10 + 5;
                    float f48 = fArr[i41] + f28;
                    int i42 = i10 + 6;
                    float f49 = fArr[i42] + f29;
                    float f50 = fArr[i10];
                    float f51 = fArr[i10 + 1];
                    float f52 = fArr[i10 + 2];
                    if (fArr[i10 + 3] != 0.0f) {
                        dVar2 = dVar3;
                        z10 = true;
                    } else {
                    ...
                    float f54 = f29;
                    i11 = i12;
                    a(path, f53, f54, f48, f49, f50, f51, f52, z10, fArr[i10 + 4] != 0.0f);
                    f11 = f53 + fArr[i41];
                    f10 = f54 + fArr[i42];
                    f22 = f11;
                    f23 = f10;
