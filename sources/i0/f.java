    ...
    */
    public static Typeface a(Context context, h0.d dVar, Resources resources, int i10, String str, int i11, int i12, a0 a0Var) {
        ...
        if (dVar instanceof h0.g) {
            ...
            typeface = null;
            if (typeface != null) {
                new Handler(Looper.getMainLooper()).post(new s1(i13, a0Var, typeface));
                return typeface;
            }
            int i14 = 1;
            ...
            of.b bVar = new of.b(cVar, nVar, z10, 29);
            int i18 = 19;
            if (!z11) {
                String a10 = o0.h.a(i12, unmodifiableList);
                Typeface typeface2 = (Typeface) o0.h.a.a(a10);
                if (typeface2 != null) {
                    nVar.execute(new s(i18, cVar, typeface2));
                    a2 = typeface2;
                } else {
                    z zVar = new z(bVar, i14);
                    synchronized (o0.h.c) {
                        try {
                            l lVar = o0.h.d;
                ...
                if (typeface3 != null) {
                    nVar.execute(new s(i18, cVar, typeface3));
                    a2 = typeface3;
                } else if (i15 == -1) {
                    ...
                    try {
                        ...
                        ((n) bVar.c).execute(new androidx.activity.i((pb.c) bVar.b, -3));
                    }
                }
            }
        } else {
            ...
            if (a2 != null) {
                new Handler(Looper.getMainLooper()).post(new s1(i13, a0Var, a2));
            } else {
                a0Var.b();
            }
        }
