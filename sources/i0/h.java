                    ...
                    if (obj != null) {
                        ...
                        while (true) {
                            ...
                            if (i11 < length) {
                                ...
                                if (byteBuffer != null) {
                                    try {
                                        z4 = ((Boolean) this.i.invoke(obj, byteBuffer, Integer.valueOf(iVar2.b), null, Integer.valueOf(iVar2.c), Integer.valueOf(iVar2.d ? 1 : 0))).booleanValue();
                                    } catch (IllegalAccessException | InvocationTargetException unused2) {
                                        z4 = false;
                                        if (z4) {
                                        }
