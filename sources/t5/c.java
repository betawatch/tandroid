...
public final class c extends z5.a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof c) {
            c cVar = (c) obj;
            if (y5.l.l(this.a, cVar.a) && Arrays.equals(this.b, cVar.b) && Arrays.equals(this.c, cVar.c) && Arrays.equals(this.d, cVar.d) && y5.l.l(this.r, cVar.r) && y5.l.l(null, null) && y5.l.l(null, null) && Arrays.equals(this.e, cVar.e) && Arrays.deepEquals(this.f, cVar.f) && Arrays.equals(this.h, cVar.h) && this.n == cVar.n) {
                return true;
            }
        }
        return false;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        r8.g(parcel, 4, this.c);
        r8.m(parcel, 5, this.d);
        r8.g(parcel, 6, this.e);
