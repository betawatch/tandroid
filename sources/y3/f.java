...
public final class f implements h {
    ...
    public t0 i;
    public int j;
    public final f5.w a = new f5.w(new byte[18]);
    public int e = 0;
        ...
        while (wVar.a() > 0) {
            ...
            if (i15 == 0) {
                while (wVar.a() > 0) {
                    ...
                    int r6 = i18 | wVar.r();
                    this.g = r6;
                    if (r6 == 2147385345 || r6 == -25230976 || r6 == 536864768 || r6 == -14745368) {
                        byte[] bArr = wVar2.a;
                ...
                if (i19 == 18) {
                    ...
                    if (this.i == null) {
                        ...
                        if (bArr3[0] == Byte.MAX_VALUE) {
                            vVar = new f5.v(bArr3, bArr3.length);
                            c6 = '\b';
                        } else {
                            ...
                            f5.v vVar2 = new f5.v(copyOf, copyOf.length);
                            if (copyOf[0] == 31) {
                                f5.v vVar3 = new f5.v(copyOf, copyOf.length);
                                while (vVar3.b() >= 16) {
                                    vVar3.s(i17);
                        ...
                        vVar.s(60);
                        int i28 = l3.b.j[vVar.i(6)];
                        int i29 = l3.b.k[vVar.i(4)];
                        int i30 = vVar.i(5);
                        int i31 = i30 >= 29 ? -1 : (l3.b.l[i30] * MediaDataController.MAX_STYLE_RUNS_COUNT) / 2;
                        vVar.s(10);
