...
public final class m {
    ...
    public static void a(m mVar, String str, Boolean bool) {
        ...
        String i11 = q3.i("Opening a new session with ID ", str);
        ...
        u uVar = mVar.f;
        a aVar = mVar.h;
        c1 c1Var = new c1(uVar.c, aVar.f, aVar.g, uVar.b().a, w.c.c(aVar.d != null ? 4 : 1), aVar.h);
        ...
        a1 a1Var = aVar2.h;
        if (((c5.a) a1Var.c) == null) {
            a1Var.c = new c5.a(a1Var);
        }
        c5.a aVar3 = (c5.a) a1Var.c;
        String str15 = aVar3.a;
        if (aVar3 == null) {
            a1Var.c = new c5.a(a1Var);
        }
        g0Var.g = new i0(str13, str10, str11, str14, str15, ((c5.a) a1Var.c).b);
        ni.f fVar = new ni.f();
        ...
        try {
            ba.b.g.getClass();
            ba.b.f(cVar.b(str16, "report"), z9.a.a.e(a10));
            ...
            String i13 = q3.i("Could not persist report for session ", str16);
            if (Log.isLoggable("FirebaseCrashlytics", 3)) {
    ...
    */
    public final void c(boolean z10, da.b bVar) {
            ...
            if (i11 >= 30) {
                ...
                if (historicalProcessExitReasons.size() != 0) {
                    ...
                    if (applicationExitInfo == null) {
                        String i12 = q3.i("No relevant ApplicationExitInfo occurred during session: ", str4);
                        if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                        ...
                        if (traceInputStream != null) {
                            ...
                            nVar2.d = pVar.b(i10);
                            l0 i19 = nVar2.i();
                            String i20 = q3.i("Persisting anr for session ", str4);
                            if (Log.isLoggable("FirebaseCrashlytics", 3)) {
                    ...
                    String i21 = q3.i("No ApplicationExitInfo available. Session: ", str4);
                    if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                        Log.v("FirebaseCrashlytics", i21, null);
                    }
                }
            } else {
                String i22 = hg.c.i(i11, "ANR feature enabled, but device is API ");
                if (Log.isLoggable("FirebaseCrashlytics", 2)) {
        ...
        if (this.j.c(str4)) {
            String i23 = q3.i("Finalizing native report for session ", str4);
            if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                r52 = 0;
        ...
        if (c10.size() > 8) {
            while (c10.size() > 8) {
                ...
                String i24 = q3.i("Removing session over cap: ", str10);
                if (Log.isLoggable("FirebaseCrashlytics", 3)) {
        ...
        for (String str11 : c10) {
            String i25 = q3.i("Finalizing report for session ", str11);
            if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                    ...
                    try {
                        ...
                        if (d2Var4 != null) {
                            ...
                            try {
                                ...
                                ba.b.f(z12 ? new File(cVar3.e, ((h0) d2Var4).b) : new File(cVar3.d, ((h0) d2Var4).b), z9.a.a.e(a21));
