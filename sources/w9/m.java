...
public final class m {
    ...
    public static void a(m mVar, String str, Boolean bool) {
        ...
        u uVar = mVar.f;
        a aVar = mVar.h;
        c1 c1Var = new c1(uVar.c, aVar.f, aVar.g, uVar.b().a, v7.j.c(aVar.d != null ? 4 : 1), aVar.h);
        ...
        mVar.j.d(str, currentTimeMillis, new b1(c1Var, e1Var, new d1(ordinal, availableProcessors, d, b10, blockCount, g11)));
        ...
        try {
            ba.b.g.getClass();
            ba.b.f(cVar.b(str16, "report"), z9.a.a.J(a10));
            ...
            String g14 = v7.j.g("Could not persist report for session ", str16);
            if (Log.isLoggable("FirebaseCrashlytics", 3)) {
    ...
    */
    public final void c(boolean z10, da.b bVar) {
            ...
            if (i11 >= 30) {
                ...
                if (historicalProcessExitReasons.size() != 0) {
                    ...
                    if (applicationExitInfo == null) {
                        String g10 = v7.j.g("No relevant ApplicationExitInfo occurred during session: ", str4);
                        if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                        ...
                        if (traceInputStream != null) {
                            ...
                            bVar3.h = str3;
                            y9.b0 a2 = bVar3.a();
                            int i12 = pVar.a.getResources().getConfiguration().orientation;
                            ...
                            nVar2.d = pVar.b(i10);
                            l0 i18 = nVar2.i();
                            String g11 = v7.j.g("Persisting anr for session ", str4);
                            if (Log.isLoggable("FirebaseCrashlytics", 3)) {
                    ...
                    String g12 = v7.j.g("No ApplicationExitInfo available. Session: ", str4);
                    if (Log.isLoggable("FirebaseCrashlytics", 2)) {
        ...
        if (this.j.c(str4)) {
            String g13 = v7.j.g("Finalizing native report for session ", str4);
            if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                r52 = 0;
        ...
        if (c10.size() > 8) {
            while (c10.size() > 8) {
                ...
                String g14 = v7.j.g("Removing session over cap: ", str10);
                if (Log.isLoggable("FirebaseCrashlytics", 3)) {
        ...
        for (String str11 : c10) {
            String g15 = v7.j.g("Finalizing report for session ", str11);
            if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                    ...
                    try {
                        ...
                        if (d2Var4 != null) {
                            ...
                            try {
                                ...
                                ba.b.f(z12 ? new File(cVar3.e, ((h0) d2Var4).b) : new File(cVar3.d, ((h0) d2Var4).b), z9.a.a.J(a21));
