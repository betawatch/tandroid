    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                ((n70) obj).u();
                or0Var.n();
                TL_stars.TL_starGiftCollection c10 = or0Var.e.c(n2Var.e.d);
                if (c10 != null) {
                    vc.a0(or0Var.a).R(savedStarGift.gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2RemovedFromCollection, a4.D1(savedStarGift.gift), c10.title))).j();
                    break;
                }
                break;
            case 3:
                ...
                n2Var2.a.e.m(savedStarGift2, savedStarGift2.unsaved);
                TL_stars.saveStarGift savestargift = new TL_stars.saveStarGift();
                savestargift.stargift = n2Var2.e.g(savedStarGift2);
                savestargift.unsave = savedStarGift2.unsaved;
                ConnectionsManager.getInstance(n2Var2.b).sendRequest(savestargift, null);
                break;
            case 4:
                u3 u3Var = (u3) obj3;
                ...
                if (tLObject instanceof TL_stars.resaleStarGifts) {
                    ...
                    u3Var.u = arrayList4.size() >= u3Var.e || TextUtils.isEmpty(resalestargifts.next_offset);
                    ...
                    Utilities.Callback callback = u3Var.c;
                    if (callback != null) {
            ...
            case 9:
                ...
                a4Var2.e0.setResellPrice(zf.a.i(0L, zf.b.a));
                c2 c2Var = a4Var2.d1;
                if (c2Var != null) {
                    c2Var.run();
                }
                ...
                if (tLObject4 instanceof TL_stars.StarsStatus) {
                    ...
                    if (arrayListArr[0].isEmpty()) {
                        ...
                        for (int i16 = 0; i16 < 3; i16++) {
                            ...
                            v5Var.s[i16] = zArr2[i16] ? null : starsStatus.next_offset;
                        }
                        z13 = true;
                    } else {
                        j3 = 0;
