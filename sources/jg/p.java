...
public final class p extends g {
    ...
    public final void K() {
        if (g.B1) {
            int length = ((kg.d) this.h0).a.length;
            ...
            if (j3 > 0) {
                ...
                if (f7 != this.l0) {
                    ...
                    ValueAnimator e7 = g.e(this.j0, this.l0, new u5(this, 5));
                    this.d0 = e7;
                    e7.start();
                }
            }
    ...
    public final void k(Canvas canvas) {
        ...
        int min = Math.min(((kg.d) this.h0).b.length - 1, this.G + i13 + 2);
        int i14 = 0;
        while (true) {
            arrayList = this.d;
            ...
            if (this.s0 != max || !z10) {
                ...
                while (i16 < arrayList.size()) {
                    ...
                    if (fVar.n || fVar.o != 0.0f) {
                        long[] jArr = fVar.a.a;
                        float f25 = (((f17 - f10) * ((kg.d) this.h0).b[max]) + (f10 / f11)) - f19;
                        i11 = min;
                        i12 = max;
        ...
        if (z10) {
            ...
            while (i22 < arrayList.size()) {
                ...
                if (z11 || fVar2.o != 0.0f) {
                    ...
                    float f27 = (((f17 - f10) * ((kg.d) this.h0).b[this.s0]) + (f10 / f11)) - f19;
    ...
    public final void n(Canvas canvas) {
        ...
        kg.b bVar = this.h0;
        if (bVar != null) {
            int length = ((kg.d) bVar).b.length;
            ArrayList arrayList = this.d;
            int size = arrayList.size();
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ((lg.f) arrayList.get(i12)).j = 0;
            }
            ...
            int i13 = 0;
            while (i13 < length) {
                float f10 = ((kg.d) this.h0).b[i13] * this.C0;
                int i14 = 0;
                while (true) {
                    f7 = 0.0f;
                    if (i14 >= size) {
                ...
                if (i13 % max == 0) {
                    ...
                    while (i15 < size) {
                        ...
                        if (fVar2.n || fVar2.o != f7) {
                            float f12 = g.B1 ? this.j0 : ((kg.d) this.h0).e;
                            long[] jArr3 = this.D1;
                            i10 = i13;
            ...
            kg.b bVar2 = this.h0;
            float f15 = ((kg.d) bVar2).b.length < 2 ? 1.0f : ((kg.d) bVar2).b[1] * this.C0;
    ...
    public final long r(int i10, int i11) {
        return ((kg.d) this.h0).m.rMaxQ(i10, i11);
    }
    ...
    @Override // jg.g
    public final void z() {
        int length = ((kg.a) ((kg.d) this.h0).d.get(0)).a.length;
        int size = ((kg.d) this.h0).d.size();
        ((kg.d) this.h0).l = new long[length];
        for (int i10 = 0; i10 < length; i10++) {
            ((kg.d) this.h0).l[i10] = 0;
            for (int i11 = 0; i11 < size; i11++) {
                if (((lg.h) this.d.get(i11)).n) {
                    kg.b bVar = this.h0;
                    long[] jArr = ((kg.d) bVar).l;
                    jArr[i10] = jArr[i10] + ((kg.a) ((kg.d) bVar).d.get(i11)).a[i10];
                }
            }
        }
        kg.b bVar2 = this.h0;
        ((kg.d) bVar2).m = new SegmentTree(((kg.d) bVar2).l);
        super.z();
    }
