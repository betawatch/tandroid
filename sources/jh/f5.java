...
public final class f5 extends org.telegram.ui.Components.ra {
    ...
    public f5(Context context, long j10, ArrayList arrayList, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        while (i12 < arrayList.size()) {
            if (currentTime <= ((TL_stars.StarGiftUpgradePrice) arrayList.get(i12)).date || ((i10 = i12 + 1) < arrayList.size() && currentTime <= ((TL_stars.StarGiftUpgradePrice) arrayList.get(i10)).date)) {
                ...
                hz0Var.c(LocaleController.getInstance().getFormatterDay().format(date) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date), ia.X0(false, j7.l1.m((int) r13.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
                z10 = true;
            } else {
                f9 = f11;
            }
        ...
        if (!z10) {
            ...
            while (i13 < size) {
                ...
                hz0Var.c(LocaleController.getInstance().getFormatterDay().format(date2) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date2), ia.X0(false, j7.l1.m((int) starGiftUpgradePrice.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
            }
        }
        float f13 = f12 + 14.0f;
    ...
    public final void P(long j10) {
        ...
        o6Var2.setTextColor(limitPreviewView.H ? -1 : org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.G6, c6Var));
