...
public final /* synthetic */ class g implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                ((SendMessagesHelper) this.c).lambda$requestUrlAuth$37((TLRPC.TL_messages_requestUrlAuth) this.d, (zn) this.e, (String) this.f, this.b, tLObject, tL_error);
                break;
            case 3:
                ...
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new h((wg1) this.c, tL_error, this.b, tLObject, (byte[]) this.d, (String) this.e, (TL_account.passwordInputSettings) this.f));
                break;
            default:
    ...
    public /* synthetic */ g(SendMessagesHelper sendMessagesHelper, TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth, zn znVar, String str, boolean z4) {
        this.a = 2;
    ...
    public /* synthetic */ g(l0 l0Var, int[] iArr, ArrayList arrayList, boolean z4, TLRPC.User user) {
        this.a = 5;
        this.c = l0Var;
        this.d = iArr;
        this.f = arrayList;
