...
public final class u2 implements ei {
    ...
    public final void P0(ArrayList arrayList, CharSequence charSequence, boolean z10, int i10, int i11, long j10, boolean z11, long j11) {
        ...
        SendMessagesHelper.prepareSendingAudioDocuments(accountInstance, arrayList, charSequence != null ? charSequence : null, e4Var.x1, null, null, storyItem, z10, i10, i11, null, null, j10, z11, j11);
        e4Var.k0(j11 <= 0);
    }
    ...
    public final void n0(int i10, boolean z10, boolean z11, int i11, int i12, long j10, boolean z12, boolean z13, long j11) {
        ...
        String str;
        e4 e4Var = this.a;
        if (!e4Var.F0.i0 || (storyItem = e4Var.K1.a) == null || (storyItem instanceof TL_stories.TL_storyItemSkipped)) {
            return;
        }
        if (i10 != 8 && i10 != 7 && (i10 != 4 || e4Var.E2.f0.getSelectedPhotos().isEmpty())) {
            t2 t2Var = e4Var.E2;
            if (t2Var != null) {
        ...
        HashMap<Object, Object> selectedPhotos = e4Var.E2.f0.getSelectedPhotos();
        ArrayList<Object> selectedPhotosOrder = e4Var.E2.f0.getSelectedPhotosOrder();
        ...
        while (i14 < Math.ceil(selectedPhotos.size() / 10.0f)) {
            ...
            SendMessagesHelper.prepareSendingMedia(accountInstance, arrayList, e4Var.x1, null, null, storyItem, null, i10 == 4 || z13, z10, null, z11, i11, i12, 0, z15, null, null, 0L, false, 0L, e4Var.X1.getSendMonoForumPeerId(), e4Var.X1.getSendMessageSuggestionParams());
            i14++;
    ...
    public final void y(sg sgVar) {
        NotificationCenter.getInstance(this.a.y2).doOnIdle(sgVar);
    }
