...
public final class u extends Dialog {
    ...
    public u(v vVar, Activity activity, sl0 sl0Var, f6 f6Var, boolean z4) {
        ...
        this.n = qVar;
        vh0 vh0Var = new vh0(activity, p2Var.getActionBar(), sl0Var, qVar);
        this.h = vh0Var;
        vh0Var.setCreateThumbFromParent(true);
        tVar.addView(vh0Var);
        qVar.setProfileGalleryView(vh0Var);
        tVar.addView(qVar);
    ...
    public final void e(boolean z4) {
        ...
        final float left = iArr[0] - (vh0Var.getLeft() + ((int) ((vh0Var.getMeasuredWidth() * f10) / 2.0f)));
        final float top = iArr[1] - (vh0Var.getTop() + ((int) ((d() * f10) / 2.0f)));
