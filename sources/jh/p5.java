...
public final /* synthetic */ class p5 implements RequestDelegate {
    ...
    public /* synthetic */ p5(s6 s6Var, int i10) {
        this.a = i10;
        this.b = s6Var;
    }
    ...
    public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.a) {
            case 0:
                ...
                break;
            case 1:
                AndroidUtilities.runOnUIThread(new j3.m(this.b, tLObject, tL_error, 5));
                break;
            case 2:
                final int i10 = 1;
                final s6 s6Var2 = this.b;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: jh.t5
