...
public final class o8 extends Drawable {
    ...
    public o8(View view) {
        this.b = view;
        this.g = new org.telegram.ui.Components.y5(view, 350L, er.h);
    ...
    public final void c(float f10) {
        this.c.setShadowLayer(AndroidUtilities.dp(2.0f) / f10, 0.0f, AndroidUtilities.dpf2(0.7f) / f10, i0.b.k(-16777216, 45));
    }
