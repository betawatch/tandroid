...
public final class f extends d0 {
    ...
    public final int e(RecyclerView recyclerView, q1 q1Var) {
        switch (this.d) {
            case 0:
                q qVar = (q) this.e;
                if (!qVar.S.C.y1 || !qVar.v.L(q1Var.b())) {
                    break;
                } else {
                    qVar.f.setItemAnimator(qVar.n);
                    break;
                }
            case 1:
                if (q1Var.f != 1 || !((ja) q1Var.a).C) {
                    break;
                } else {
                    break;
                }
            ...
            case 3:
                ...
                if (b10 >= gm0Var.v && q1Var.b() < gm0Var.w) {
                    break;
                } else {
                    break;
                }
            ...
            case 4:
                ...
                break;
            case 5:
                if (!((n2.p) ((m71) this.e).y).o(q1Var.b())) {
                    break;
                } else {
                    break;
                }
            default:
                if (q1Var.f != 5 || !r(q1Var.b())) {
                    break;
                } else {
                    break;
                }
    ...
    public boolean k() {
        switch (this.d) {
            ...
            default:
                return super.k();
            case 3:
                return ((gm0) this.e).E.f();
            case 4:
                i51 i51Var = (i51) this.e;
                return i51Var.Y2 && i51Var.a3;
            case 6:
                return true;
        }
    }
    ...
    public final boolean n(RecyclerView recyclerView, q1 q1Var, q1 q1Var2) {
        ...
        switch (this.d) {
            case 0:
                ...
                n6 n6Var = lVar.e;
                if (n6Var != null && b10 >= 0 && b10 < n6Var.i.size() && b11 >= 0 && b11 < lVar.e.i.size()) {
                    if (lVar.e instanceof f6) {
                        arrayList = new ArrayList();
                        for (int i12 = 0; i12 < lVar.e.i.size(); i12++) {
                            arrayList.add(Integer.valueOf(((MessageObject) lVar.e.i.get(i12)).getId()));
                        }
                    } else {
            ...
            case 1:
                if (q1Var.f == q1Var2.f) {
                    ...
                    if (!(view instanceof ja) || ((ja) view).C) {
                        ...
                        TLRPC.TL_username tL_username = (TLRPC.TL_username) arrayList3.get(i13);
                        arrayList3.set(i13, (TLRPC.TL_username) arrayList3.get(i14));
                        arrayList3.set(i14, tL_username);
                        toVar.p(b12, b13);
            ...
            case 3:
                int b17 = q1Var2.b();
                gm0 gm0Var = (gm0) this.e;
                ArrayList arrayList4 = gm0Var.e;
                if (b17 < gm0Var.v || q1Var2.b() >= gm0Var.w) {
                    return false;
                }
                int b18 = q1Var.b();
                int b19 = q1Var2.b();
                ...
                MessageObject messageObject2 = (MessageObject) arrayList4.get(i19);
                MessageObject messageObject3 = (MessageObject) arrayList4.get(i20);
                arrayList4.set(i19, messageObject3);
                arrayList4.set(i20, messageObject2);
                DownloadController.getInstance(gm0Var.d).swapLoadingPriority(messageObject2, messageObject3);
                gm0Var.c.p(b18, b19);
                return false;
            case 4:
                i51 i51Var = (i51) this.e;
            ...
            case 5:
                ...
                int i21 = 0;
                z11 = false;
                if (((n2.p) m71Var.y).o(b22) && ((n2.p) m71Var.y).o(b23)) {
                    ...
                    while (i21 < size2) {
                        ...
                        i21++;
                        arrayList7.add(Integer.valueOf(((j71) obj).a));
                    }
                    e71 e71Var = ((n71) ((n2.p) m71Var.y).b).H;
                    z11 = true;
                    z11 = true;
                    if (e71Var != null) {
                        e71Var.a(arrayList7);
                ...
                return z11;
            default:
                if (q1Var.f != q1Var2.f || !r(q1Var.b()) || !r(q1Var2.b())) {
                    return false;
                }
                vu0 vu0Var = ((xu0) this.e).b;
                int b24 = q1Var.b();
                int b25 = q1Var2.b();
                xu0 xu0Var = vu0Var.d;
                int i22 = xu0Var.j0;
                int i23 = b24 - i22;
                int i24 = b25 - i22;
                if (i23 >= 0 && i24 >= 0 && i23 < (i11 = xu0Var.y) && i24 < i11) {
        ...
        switch (this.d) {
            case 0:
                ...
                if (i9 == 0) {
                    ...
                    ArrayList arrayList2 = lVar.n;
                    n6 n6Var = lVar.e;
                    if (n6Var != null && lVar.r) {
                        if (n6Var instanceof f6) {
                            arrayList = new ArrayList();
                            for (int i10 = 0; i10 < lVar.e.i.size(); i10++) {
                                arrayList.add(Integer.valueOf(((MessageObject) lVar.e.i.get(i10)).getId()));
                            }
                        } else {
                            arrayList = n6Var.g;
                        }
            ...
            case 2:
                ...
                if (i9 != 0) {
                    ...
                    va1Var.I0(false);
                    q1Var.a.setPressed(true);
                    q1Var.a.setBackgroundColor(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.h5, jnVar.a));
                    break;
                }
                break;
            case 3:
                if (i9 != 0) {
                    ((gm0) this.e).b.I0(false);
                    q1Var.a.setPressed(true);
                    break;
                }
                break;
    ...
    public boolean r(int i9) {
        ...
        return !xu0Var.E || i9 - xu0Var.j0 >= xu0Var.x;
    }
