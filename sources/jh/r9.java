...
public class r9 {
    ...
    public int d;
    public boolean e;
    public final y9 f = new y9(this, 29);
    ...
    public void a(ArrayList arrayList) {
        ...
        while (i10 < y10.stories.size()) {
            i10 = i0.a.f(y10.stories.get(i10).id, i10, 1, arrayList);
        }
    }
    ...
    public final void c() {
        if (this.e) {
            ...
            if (currentTimeMillis > 0) {
                ...
                AndroidUtilities.runOnUIThread(y9Var, currentTimeMillis);
                return;
            }
            if (this.d == 0) {
    ...
    public boolean d(ArrayList arrayList, TL_stories.TL_stories_storyViews tL_stories_storyViews) {
        if (tL_stories_storyViews != null && tL_stories_storyViews.views != null) {
            ...
            if (y10 != null && !y10.stories.isEmpty()) {
                ...
                f7 f7Var = s6Var.k;
                f7Var.b.getStorageQueue().postRunnable(new c7(f7Var, y10, 1));
                return true;
            }
        }
        return false;
