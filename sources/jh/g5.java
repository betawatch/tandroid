...
public final class g5 extends View {
    ...
    public g5(Activity activity, org.telegram.ui.ActionBar.c6 c6Var) {
        super(activity);
        this.c = new vd.a(this, jr.h, 380L);
        this.b = new Paint(1);
        this.d = c6Var;
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.a) {
            ...
            default:
                ...
                float f10 = ((vd.a) this.c).e;
                float f11 = 1.0f - f10;
                if (f11 > 0.0f) {
                    jf.r.b(canvas, (u41) this.e, f11 * 1.35f);
                    invalidate();
                }
                if (f10 > 0.0f) {
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.a) {
            case 2:
                ...
                jf.r.d((u41) this.e, i10 / 2.0f, i11 / 2.0f, 17);
                break;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                break;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.a) {
            case 2:
                return super.verifyDrawable(drawable) || (drawable == ((u41) this.e) && !((vd.a) this.c).f);
            default:
    ...
    public g5(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        this.e = new RectF();
        paint2.setColor(-1);
        paint.setColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.d6, c6Var));
