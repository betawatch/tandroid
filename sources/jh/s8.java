...
public final class s8 implements GestureDetector.OnGestureListener {
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f10, float f11) {
        i9 i9Var = this.a;
        if (i9Var.V != 0.0f && i9Var.q1 == null && f11 < -1000.0f && !i9Var.W) {
            i9Var.W = true;
            try {
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f10, float f11) {
        ...
        if (i9Var.Y) {
            ...
            if (f13 <= i9Var.w.c || f11 <= 0.0f) {
                ...
                i9Var.a0 = (0.05f * f11) + f13;
            }
            w8 w8Var = i9Var.s;
            ec ecVar2 = ec.w;
            if (ecVar2 != null && ecVar2.h == w8Var) {
                ecVar2.b();
            }
            if (i9Var.j0.getCurrentPeerView() != null) {
                i9Var.j0.getCurrentPeerView().invalidate();
        ...
        if (i9Var.R > 0.8f) {
            float f14 = -f11;
            if ((f14 > 0.0f && i9Var.S > 0.0f) || (f14 < 0.0f && i9Var.S < 0.0f)) {
                f12 = 0.3f;
                i9Var.S -= f11 * f12;
                w8 w8Var2 = i9Var.s;
                ecVar = ec.w;
                if (ecVar != null && ecVar.h == w8Var2) {
                    ecVar.b();
                }
                i9.k(i9Var);
                return true;
