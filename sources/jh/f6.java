...
public final class f6 {
    ...
    public final void d() {
        ...
        int i10 = this.a;
        if (!z10) {
            MessagesStorage.getInstance(i10).loadStoryAlbumsCache(j10, new Consumer() { // from class: jh.e6
                @Override // java.util.function.Consumer
                /* renamed from: accept */
                public final void x(Object obj) {
                    AndroidUtilities.runOnUIThread(new hh.m5(27, f6.this, (List) obj));
                }
    ...
    public final void e() {
        ...
        while (i11 < size) {
            ...
            i11++;
            tL_reorderAlbums.order.add(Integer.valueOf(((k6) obj).a));
        }
