...
public final /* synthetic */ class v0 implements NativeInstance.PayloadCallback, RequestDelegateTimestamp, NativeInstance.VideoSourcesCallback, NativeInstance.RequestBroadcastPartCallback, NativeInstance.RequestCurrentTimeCallback {
    ...
    public void run(long j10, int[] iArr) {
        ...
        while (i10 < iArr.length) {
            i10 = i0.a.f(iArr[i10], i10, 1, getgroupparticipants.sources);
        }
        ConnectionsManager.getInstance(d1Var.e).sendRequest(getgroupparticipants, new cg.c0(d1Var, iArr, j10));
    }
        ...
        switch (this.a) {
            case 3:
                ...
                if (d1Var.v != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new d5.i(d1Var, str2, AccountInstance.getInstance(d1Var.e).getConnectionsManager().sendRequest(tL_upload_getFile, new RequestDelegateTimestamp() { // from class: jh.x0
                        @Override // org.telegram.tgnet.RequestDelegateTimestamp
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error, long j12) {
                            ...
                            AndroidUtilities.runOnUIThread(new hh.m5(20, d1Var2, str2));
