...
public final class i9 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.j2, af.a {
    ...
    public org.telegram.ui.ActionBar.j2 r0;
    ...
    public static boolean i(i9 i9Var, w8 w8Var, float f10, float f11, boolean z10) {
        ...
        if (currentPeerView != null) {
            if (currentPeerView.G0(currentPeerView, ((f10 - i9Var.v.getX()) - i9Var.j0.getX()) - currentPeerView.getX(), ((f11 - i9Var.v.getY()) - i9Var.j0.getY()) - currentPeerView.getY(), z10)) {
                return true;
            }
        ...
        if (currentPeerView != null && (o2Var2 = currentPeerView.X1) != null && o2Var2.getVisibility() == 0) {
            if (f11 > currentPeerView.X1.getY() + currentPeerView.getY() + i9Var.j0.getY() + i9Var.v.getY()) {
                return true;
            }
        }
        if ((currentPeerView == null || (o2Var = currentPeerView.X1) == null || !o2Var.w0()) && i9Var.q1 == null) {
    ...
    public final void A(int i10, Context context, TL_stories.StoryItem storyItem, ArrayList arrayList, int i11, j6 j6Var, TL_stories.PeerStories peerStories, e9 e9Var, boolean z10) {
        ...
        if (this.v == null) {
            ...
            this.v.addView(this.j0, h7.z5.e(-1, -1, 1));
        ...
        if (j6Var != null) {
            this.j0.D(this.h, j6Var.d, j6Var.h());
        } else {
            y8 y8Var3 = this.j0;
            int i12 = this.h;
            y8Var3.w0 = arrayList;
    ...
    public final void D(Context context, long j10, e9 e9Var) {
        ...
        if (y10 != null) {
            ...
            while (i11 < y10.stories.size()) {
                if (l7.w(i10, y10.stories.get(i11))) {
    ...
    public final void L(boolean z10) {
        ...
        if (this.W0 != z10) {
            this.W0 = z10;
            if (z10 && !this.b1 && (currentPeerView2 = this.j0.getCurrentPeerView()) != null && (c4Var = currentPeerView2.K1) != null && !c4Var.f && c4Var.b == null) {
                if (!this.g0 && !this.f0 && (d4Var = this.C0) != null && d4Var.b != null) {
                    currentPeerView2.Y0.invalidate();
                    BotWebViewVibrationEffect.IMPACT_LIGHT.vibrate();
                }
                d4 d4Var2 = this.C0;
                if (d4Var2 != null && (h9Var = d4Var2.b) != null && !this.g0) {
    ...
    public final void N() {
        ...
        if (this.w0 == null || (n2Var = this.f) == null || this.z0 == null) {
            return;
        }
        Activity findActivity = AndroidUtilities.findActivity(n2Var.getContext());
        if (bf.d.a(findActivity) > 0) {
    ...
    public final void O() {
        ...
        e4 currentPeerView = this.j0.getCurrentPeerView();
        if (currentPeerView != null) {
    ...
    */
            ...
            if (selectedPosition >= 0 && selectedPosition < arrayList.size()) {
                ...
                if (currentPeerView != null) {
                    ...
                    if (selectedPosition >= 0 && selectedPosition < arrayList2.size()) {
                        ...
                        f9Var.j = null;
                        f9Var.k = 1.0f;
                        if (!this.p0.y0(j10, this.Q0, i11, storyItem == null ? -1 : storyItem.messageType, f9Var)) {
                            this.R0 = false;
                            this.K = 0.0f;
                            this.J = 0.0f;
                            return;
    ...
    public final boolean g() {
        org.telegram.ui.ActionBar.n2 n2Var = this.f;
        return (n2Var == null || t() == null || AndroidUtilities.findActivity(n2Var.getContext()) == null || this.w0 == null || this.z0 == null || this.D0) ? false : true;
    }

    @Override // org.telegram.ui.ActionBar.j2
    public final /* synthetic */ mc getBulletinFactory() {
        return null;
    }
    ...
    @Override // af.a
    public final View h() {
        lh.c4 c4Var = new lh.c4(this.z0.getContext(), this.h);
        this.A0 = c4Var;
        return c4Var;
    }
    ...
    public final void m() {
        if (this.D == null) {
            ...
            this.D.setInterpolator(org.telegram.ui.ActionBar.p1.w);
            this.D.start();
        }
    }
    ...
    public final void n(boolean z10) {
        ...
        if (this.Y || this.a0 != 0.0f) {
            ...
            this.r1.addListener(new ag.x(6, this, z10));
            if (z10) {
                this.r1.setDuration(350L);
                this.r1.setInterpolator(er.h);
            } else {
                this.r1.setDuration(350L);
                this.r1.setInterpolator(er.f);
            }
            this.r1.start();
        }
    }
    ...
    public final void y() {
        ...
        if (this.p0 != null) {
            ...
            if (this.K0 instanceof m6) {
                e4 currentPeerView2 = this.j0.getCurrentPeerView();
            ...
            this.p0.g1(currentDialogId, i10, new l3(this, 5));
        }
    }
