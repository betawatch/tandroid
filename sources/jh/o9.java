...
public final class o9 extends ReplacementSpan {
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f10, int i12, int i13, int i14, Paint paint) {
        ...
        for (int i16 = 0; i16 < 3; i16++) {
            ...
            if (i16 == this.b) {
                f17 = AndroidUtilities.lerp(f17, com.google.android.recaptcha.internal.a.d(measureText, i16 + 1, f10, f16), this.d);
                float f18 = this.d;
                f11 = AndroidUtilities.lerp(f14, f14 - f16, this.h.getInterpolation(f18 < 0.5f ? f18 / 0.5f : org.telegram.messenger.y1.a(f18, 0.5f, 0.5f, 1.0f)));
            } else {
                if (i16 == this.c) {
                    f17 = AndroidUtilities.lerp(f17, com.google.android.recaptcha.internal.a.d(measureText, i16 - 1, f10, f16), this.d);
                }
