...
public final /* synthetic */ class b8 implements RequestDelegate {
    ...
    public /* synthetic */ b8(int i10, ci0 ci0Var, org.telegram.ui.ActionBar.n2 n2Var, TLRPC.TL_payments_assignPlayMarketTransaction tL_payments_assignPlayMarketTransaction) {
        this.a = 7;
        this.b = i10;
        this.c = ci0Var;
        this.d = n2Var;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 1:
                AndroidUtilities.runOnUIThread(new gh.e1(tLObject, (boolean[]) obj3, (Utilities.Callback) obj2, this.b, (TL_account.updateEmojiStatus) obj));
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new gf.k0((d70) obj3, (org.telegram.ui.k4) obj2, tL_error, tLObject, this.b, (org.telegram.ui.g1) obj));
                break;
            case 3:
                ...
                if (tL_error != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new gh.e1(sharedPreferences, (TLRPC.TL_help_support) tLObject, b2Var, this.b, n2Var, 18));
                    break;
                }
            case 4:
                AndroidUtilities.runOnUIThread(new gh.e1((ur) obj3, tLObject, (TLRPC.InputPeer) obj2, this.b, (int[]) obj, 19));
                break;
            case 5:
                hu0 hu0Var = (hu0) obj3;
            ...
            case 6:
                ...
                AndroidUtilities.runOnUIThread(new gh.e1((LaunchActivity) obj3, tLObject, (Uri) obj2, this.b, (org.telegram.ui.ActionBar.b2) obj, 21), 2L);
                break;
            case 7:
                ci0 ci0Var = (ci0) obj3;
                ...
                break;
            default:
                AndroidUtilities.runOnUIThread(new gf.k0((org.telegram.ui.web.z0) obj3, (String) obj2, tLObject, tL_error, this.b, (org.telegram.ui.web.w0) obj));
                break;
        }
    }

    public /* synthetic */ b8(Object obj, int i10, TLRPC.TL_messages_getAttachedStickers tL_messages_getAttachedStickers, gf.j0 j0Var) {
        this.a = 0;
        this.c = obj;
        this.b = i10;
