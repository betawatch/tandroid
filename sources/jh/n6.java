...
public final /* synthetic */ class n6 implements RequestDelegate {
    public final /* synthetic */ int a;
    public final /* synthetic */ r6 b;

    public /* synthetic */ n6(r6 r6Var, int i10) {
        this.a = i10;
        this.b = r6Var;
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.a) {
            case 0:
                    ...
                    if (z7Var.b0) {
                                ...
                                if (storyItem == null) {
                                    ...
                                    while (true) {
                                        ...
                                        if (i19 < arrayList2.size()) {
                                                ...
                                                if (inputPrivacyRule instanceof TLRPC.TL_inputPrivacyValueAllowAll) {
                                                    ...
                                                    if (inputPrivacyRule instanceof TLRPC.TL_inputPrivacyValueDisallowUsers) {
                                                        ...
                                                        for (TLRPC.TL_inputPrivacyValueDisallowUsers tL_inputPrivacyValueDisallowUsers = (TLRPC.TL_inputPrivacyValueDisallowUsers) inputPrivacyRule; i20 < tL_inputPrivacyValueDisallowUsers.users.size(); tL_inputPrivacyValueDisallowUsers = tL_inputPrivacyValueDisallowUsers) {
                                                            i20 = com.google.android.recaptcha.internal.a.f(tL_inputPrivacyValueDisallowUsers.users.get(i20).user_id, tL_privacyValueDisallowUsers.users, i20, 1);
                                                            i14 = i14;
                                                            updates3 = updates3;
                                                        }
                                                        updates2 = updates3;
                                                        ...
                                                        if (inputPrivacyRule instanceof TLRPC.TL_inputPrivacyValueAllowUsers) {
                                                            ...
                                                            for (TLRPC.TL_inputPrivacyValueAllowUsers tL_inputPrivacyValueAllowUsers = (TLRPC.TL_inputPrivacyValueAllowUsers) inputPrivacyRule; i21 < tL_inputPrivacyValueAllowUsers.users.size(); tL_inputPrivacyValueAllowUsers = tL_inputPrivacyValueAllowUsers) {
                                                                i21 = com.google.android.recaptcha.internal.a.f(tL_inputPrivacyValueAllowUsers.users.get(i21).user_id, tL_privacyValueAllowUsers.users, i21, 1);
                                                            }
                                            ...
                                            storyItem.pinned = z7Var.I0 == Integer.MAX_VALUE;
                        ...
                        if (r6Var.v) {
                            ...
                            if (inputPeer != null) {
                                ...
                                ConnectionsManager.getInstance(i22).sendRequest(tL_stories_deleteStories, new n6(r6Var, 1));
                            }
                        } else {
                            ...
                            AndroidUtilities.runOnUIThread(new e5.u(r6Var, j10, storyItem, 7));
                ...
                } else if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && z7Var.c0 != null && (iVar = z7Var.d0) != null) {
                ...
                break;
            default:
                AndroidUtilities.runOnUIThread(new v5(this.b.I, 2));
                break;
        }
    }
}
