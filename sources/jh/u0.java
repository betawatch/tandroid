...
public final class u0 extends View implements NotificationCenter.NotificationCenterDelegate {
                ...
                if (arrayList3.size() == arrayList2.size()) {
                    ...
                    while (i10 < arrayList3.size()) {
                        ...
                        if (t0Var2 != null) {
                            ...
                            int i18 = t0Var6.d;
                            t0Var6.h = new RadialGradient(0.0f, 0.0f, dp, new int[]{i18, org.telegram.ui.ActionBar.g6.l1(0.0f, i18)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
                            Paint paint = new Paint(1);
                            t0Var6.i = paint;
                            paint.setShader(t0Var6.h);
                            TLRPC.Document document = t0Var6.b;
                            if (document != null) {
                                t0Var6.j = org.telegram.ui.Components.p5.m(i13, i14, document);
                            } else {
                                t0Var6.j = org.telegram.ui.Components.p5.n(i13, t0Var6.c, null, i14);
                            }
                    ...
                    for (i11 = 0; i11 < this.F; i11 = th.d(i11, i11, 1, arrayList)) {
                    }
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        float min = Math.min(x4, (u0Var.getWidth() - dpf2) / 2.0f);
        float max = Math.max(y8, (u0Var.x - dpf2) / 2.0f);
        ...
        float f15 = (scaleX / 2.0f) + x4;
        float f16 = (scaleY / 2.0f) + y8;
        float f17 = u0Var.w;
        float f18 = f17 / u0Var.x;
        float clamp012 = Utilities.clamp01((f17 - (org.telegram.ui.ActionBar.l.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight)) / AndroidUtilities.dp(50.0f));
        boolean z10 = false;
        int i10 = 0;
        while (i10 < arrayList2.size()) {
            t0 t0Var2 = (t0) arrayList2.get(i10);
            float d = t0Var2.k.d(f12, z10);
            float lerp = AndroidUtilities.lerp(0.5f, f12, d);
            int i11 = i10;
            float y10 = org.telegram.messenger.x3.y(f12, u0Var.n, (f12 - u0Var.e) * d, clamp012);
            int i12 = t0Var2.g;
            float f19 = 1.6f;
            if (i12 != 0) {
                if (i12 != 1) {
                    ...
                    if (clamp01 < 1.0f) {
                        dp = AndroidUtilities.lerp(f15, dp, u0Var.G.getInterpolation(clamp01));
                        f10 = AndroidUtilities.lerp(f16, f10, u0Var.H.getInterpolation(clamp01));
                    ...
                    if (y10 <= 0.0f) {
                        ...
                        f11 = f16;
                        arrayList = arrayList2;
                        t0Var2.l.set(dp - f22, f10 - f22, dp + f22, f10 + f22);
                        canvas.save();
                        canvas.translate(dp, f10);
                        canvas.rotate(0.0f);
                        float a2 = t0Var2.m.a(0.1f) * f21;
                        canvas.scale(a2, a2);
                        t0Var2.f.d();
                        t0Var2.f.b(canvas, t0Var2.d, y10);
                        Paint paint = t0Var2.i;
                        if (paint != null) {
                            paint.setAlpha((int) (y10 * 255.0f * 1.0f));
                            float f23 = (-dp3) / 2.0f;
                            t0Var = t0Var2;
                            canvas.drawRect(f23, f23, f22, f22, t0Var2.i);
                        } else {
                            t0Var = t0Var2;
                        }
                        if (t0Var.j != null) {
                            ...
                            t0Var.j.setAlpha((int) (y10 * 255.0f));
                            t0Var.j.draw(canvas);
                        }
                        canvas.restore();
                    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (true) {
            ...
            if (((t0) arrayList.get(i10)).l.contains(x4, y8)) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            t0 t0Var4 = this.I;
            if (t0Var4 != null) {
                ye.d.s(getContext(), "https://t.me/nft/" + t0Var4.e);
                this.I.m.c(false);
                this.I = null;
            }
