...
public abstract class x0 {
    ...
    public static void a(Canvas canvas, int i10, Drawable drawable, float f9, float f10, float f11, float f12) {
        if (f11 <= 0.0f) {
            return;
        }
        int i11 = 0;
    ...
    public static void b(Canvas canvas, int i10, Paint paint, Bitmap bitmap, float f9, float f10, float f11) {
        e0.i0 i0Var;
        if (f11 <= 0.0f) {
            return;
        }
    ...
    public static void c(Canvas canvas, org.telegram.ui.Components.n5 n5Var, int i10, float f9, float f10, RectF rectF, float f11) {
        float f12;
        float f13;
        float f14;
        float f15 = f10;
        ...
        float max = Math.max(f17, (f9 - dpf2) / 2.0f);
        ...
        for (int i13 = 54; i12 < i13; i13 = 54) {
            ...
            if (i12 == 18 || i12 == 19 || i12 == 6 || i12 == 7) {
                f13 = jr.i.getInterpolation(f13);
            }
            float[] fArr3 = fArr;
            float b10 = th.b(1.0f, f15, AndroidUtilities.dp(12.0f), f47);
            if (f13 < 1.0f) {
                f46 = AndroidUtilities.lerp(f18, f46, jr.i.getInterpolation(f13));
            ...
            float clamp013 = (f45 - Utilities.clamp01(i7.z5.a(f21, f23, f46, b10) / (max2 * 2.0f))) * f11 * 0.5f * f14;
            if (f13 < 1.0f) {
