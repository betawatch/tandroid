...
public final class f7 {
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x024d A[DONT_GENERATE] */
    ...
    */
    ...
    public final void d(a0.h hVar, Runnable runnable, int i10, boolean z10, Timer timer) {
        ...
        while (i12 < hVar.m()) {
            ...
            while (i13 < arrayList2.size()) {
                ...
                TL_stories.StoryItem f10 = f7Var.f(e(messageObject), j10);
        ...
        while (i14 < hVar.m()) {
            ...
            StringBuilder q6 = a9.p.q(j11, "fillMessagesWithStories: getStoriesByID did=", " ids=");
            q6.append(TextUtils.join(",", tL_stories_getStoriesByID.id));
            int sendRequest = ConnectionsManager.getInstance(i11).sendRequest(tL_stories_getStoriesByID, new e7(f7Var, Timer.start(timer2, q6.toString()), arrayList3, j11, z10, timer2, iArr, runnable));
            if (i10 != 0) {
    ...
    public final void k(long j10, TL_stories.StoryItem storyItem) {
        ...
        this.b.getStorageQueue().postRunnable(new e5.u(this, j10, storyItem, 9));
    }
