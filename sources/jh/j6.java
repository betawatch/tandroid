...
public class j6 {
    ...
    public final g6 q = new g6(this, 0);
    public int s = -1;
    public int A = -1;
    ...
    public j6(int i10, long j10, int i11, int i12, Utilities.Callback callback) {
        ...
        this.e = i11;
        this.f = i12;
        this.x = new hh.m5(29, this, callback);
        if (i11 != 0 || i12 <= 0) {
    ...
    public final void D(List list, boolean z10) {
        ...
        while (true) {
            ...
            if (storyItem2 != null) {
                ...
                if (z12 != z13) {
                    if (!z13) {
                        i0.a.v(storyItem2.id, new StringBuilder("StoriesList remove story "));
                    ...
                    i0.a.v(storyItem2.id, new StringBuilder("StoriesList update story "));
    ...
    */
    ...
    public boolean q(int i10, List list, boolean z10) {
        ...
        if (this.t) {
            this.y = new i6(this, z10, i10, list);
            return false;
        }
        int i12 = this.e;
        long j10 = this.d;
        ...
        pa.v("} load", sb2);
        this.u = true;
        this.A = ConnectionsManager.getInstance(i13).sendRequest(tL_stories_getStoriesArchive, new hh.u1(this, n10, 3));
        return true;
    }
    ...
    public final void z(int i10) {
        ...
        if (!arrayList.isEmpty() || (m5Var = this.x) == null) {
            return;
        }
        AndroidUtilities.cancelRunOnUIThread(m5Var);
