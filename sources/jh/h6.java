...
public final /* synthetic */ class h6 implements Runnable {
    ...
    public /* synthetic */ h6(j6 j6Var, MessagesStorage messagesStorage, int i10) {
        this.a = i10;
        this.b = j6Var;
        ...
        switch (this.a) {
            case 0:
                ...
                try {
                    ...
                    sQLiteCursor = messagesStorage.createLoadStoriesCursor(j12, j6Var2.f, j6Var2.e);
                    while (sQLiteCursor.next()) {
                        ...
                        if (byteBufferValue != null) {
                            ...
                            MessageObject messageObject = new MessageObject(j6Var2.c, TLdeserialize);
            ...
            default:
                ...
                try {
                    ...
                    database.executeFast("DELETE FROM profile_stories WHERE dialog_id = " + j6Var3.d + " AND type = " + j6Var3.e).stepThis().dispose();
                } catch (Throwable th4) {
