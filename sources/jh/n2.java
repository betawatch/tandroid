...
public final /* synthetic */ class n2 implements Runnable {
    ...
    */
    public final void run() {
        ...
        switch (i10) {
            case 0:
                h5.h0((h5) obj5, (TLObject) obj4, (String) obj3, (TL_stars.InputSavedStarGift) obj, (TLRPC.TL_error) obj2, this.b);
                break;
            case 1:
                ((boolean[]) obj3)[0] = true;
                ((s7) obj5).g(this.b, (TLObject) obj4, (TLRPC.TL_textWithEntities) obj, (Utilities.Callback2) obj2);
                break;
            case 2:
                ((boolean[]) obj4)[0] = true;
                ((s7) obj5).h((TLRPC.TL_payments_paymentFormStarGift) obj3, (TL_stars.StarGift) obj, this.b, null, true, (Utilities.Callback2) obj2);
                break;
            case 3:
                lh.k7 k7Var = (lh.k7) obj5;
                TLObject tLObject = (TLObject) obj4;
                View view = (View) obj3;
                lh.h7 h7Var = (lh.h7) obj;
                ...
                if (tLObject != null) {
                    ...
                    if (!peerStories.stories.isEmpty()) {
                        ...
                        j10 = j11;
                        lh.l7.n(peerStories, new c2(k7Var, view, j11, h7Var, 11));
                        z10 = false;
            ...
            case 5:
                ...
                long j13 = this.b;
                b9.d dVar = new b9.d(tnVar, (ArrayList) obj, j13, yl0Var, 5);
                ie ieVar = new ie(yl0Var, i11);
                Pattern pattern = org.telegram.ui.Components.c5.a;
                org.telegram.ui.Components.c5.K(parentActivity, j13, j12, 0, true, dVar, ieVar, new org.telegram.ui.Components.a5(null), null);
                break;
            default:
                ...
                if (o2Var.getContext() != null) {
                    if (tLObject2 instanceof TL_chatlists.TL_chatlists_exportedInvites) {
                        ...
                        new c00(o2Var, dialogFilter, tL_chatlists_exportedInvites.invites).show();
                    } else if (tL_error == null || !"FILTER_ID_INVALID".equals(tL_error.text) || dialogFilter.isDefault()) {
                        org.telegram.messenger.x3.s(R.string.UnknownError, tc.a0(o2Var), null);
                    } else {
                        new c00(o2Var, dialogFilter, null).show();
                    }
                    if (runnable != null) {
    ...
    public /* synthetic */ n2(h5 h5Var, TLObject tLObject, String str, TL_stars.InputSavedStarGift inputSavedStarGift, TLRPC.TL_error tL_error, long j10) {
        this.a = 0;
        this.d = h5Var;
        this.c = tLObject;
        this.e = str;
    ...
    public /* synthetic */ n2(s7 s7Var, boolean[] zArr, long j10, TLObject tLObject, TLRPC.TL_textWithEntities tL_textWithEntities, Utilities.Callback2 callback2) {
        this.a = 1;
        this.d = s7Var;
        this.e = zArr;
        this.b = j10;
    ...
    public /* synthetic */ n2(s7 s7Var, boolean[] zArr, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j10, Utilities.Callback2 callback2) {
        this.a = 2;
        this.d = s7Var;
        this.c = zArr;
    ...
    public /* synthetic */ n2(org.telegram.ui.ActionBar.o2 o2Var, TLObject tLObject, MessagesController.DialogFilter dialogFilter, TLRPC.TL_error tL_error, Runnable runnable, long j10) {
        this.a = 6;
        this.d = o2Var;
        this.c = tLObject;
        this.e = dialogFilter;
