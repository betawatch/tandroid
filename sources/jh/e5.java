...
public final class e5 extends lq {
    ...
    public final void draw(Canvas canvas) {
        ...
        int i11 = 0;
        while (i11 < 4) {
            float f9 = i11 == 0 ? 1.0f - currentTimeMillis : i11 == 3 ? currentTimeMillis : 1.0f;
            paint2.setAlpha((int) (f9 * 255.0f * this.f));
            canvas.save();
    ...
    @Override // org.telegram.ui.Components.lq, android.graphics.drawable.Drawable
