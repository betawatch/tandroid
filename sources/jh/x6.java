    ...
    */
    public final void onDraw(Canvas canvas) {
        if (this.n) {
            ...
            b4 b4Var = this.a;
            if (d < 1.0f) {
                Drawable drawable = b4Var.o;
                Drawable drawable2 = b4Var.o;
            ...
            if (d > 0.0f) {
                Drawable drawable3 = b4Var.p;
                Drawable drawable4 = b4Var.p;
    ...
    public void setReaction(ig.q0 q0Var) {
        ...
        if (q0Var != null) {
            if (q0Var.g != 0) {
                org.telegram.ui.Components.k5 k5Var2 = new org.telegram.ui.Components.k5(3, UserConfig.selectedAccount, q0Var.g);
                this.f = k5Var2;
                if (this.s) {
                    k5Var2.a(this);
                }
