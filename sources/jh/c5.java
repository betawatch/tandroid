...
public abstract class c5 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public c5(i9 i9Var, Context context, o4 o4Var, ig.i iVar) {
        ...
        frameLayout.addView(view, h7.z5.d(-1, 8.0f, 0, 0.0f, this.e - 8, 0.0f, 0.0f));
        View view2 = new View(getContext());
        this.b = view2;
        view2.setBackgroundColor(org.telegram.ui.ActionBar.g6.v0(i10, bVar));
        frameLayout.addView(view2, h7.z5.d(-1, 10.0f, 0, 0.0f, this.e - 17, 0.0f, 0.0f));
    ...
    public static void a(c5 c5Var) {
        new ag.g2(c5Var.G.f, 14, false).show();
    }
    ...
    public final boolean d(TL_stories.StoryView storyView) {
        ...
        if (j5Var != null) {
            ...
            r6 r6Var = j5Var.b;
            if (r6Var != null && (z7Var = r6Var.c) != null && (o9Var = z7Var.E0) != null) {
                return o9Var.b(user);
            }
        }
        return true;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.k6) && (R = RecyclerView.R(childAt)) >= 0) {
                y4 y4Var = this.w;
                if (R < y4Var.c.size()) {
                    ((org.telegram.ui.Cells.k6) childAt).a(d(((t4) y4Var.c.get(R)).b) ? 1.0f : 0.5f, true);
                }
            }
            i12++;
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (frameLayout.getTranslationY() != f10) {
            ...
            g5 g5Var = (g5) this;
            int intValue = ((Integer) g5Var.getTag()).intValue();
            k5 k5Var = g5Var.T.e;
            d5 d5Var = k5Var.h;
            if (intValue == k5Var.A.getCurrentItem()) {
    ...
    public final void g(long j10, j5 j5Var) {
        ...
        i();
        h(false);
        if (j5Var == null || j5Var.a == null) {
            return;
        }
        NotificationsController.getInstance(this.v).processSeenStoryReactions(j10, j5Var.a.id);
    }
    ...
    public final void h(boolean z10) {
        ...
        if (z11 != s4Var.s || !z10) {
            ...
            if (z10) {
                ...
                s4Var.w = ofFloat;
                ofFloat.addUpdateListener(new ag.u(s4Var, 23));
                s4Var.w.addListener(new ag.r1(s4Var, 19));
                s4Var.w.setDuration(250L);
                s4Var.w.setInterpolator(er.f);
                s4Var.w.start();
            } else {
                s4Var.r = 1.0f;
                s4Var.invalidate();
