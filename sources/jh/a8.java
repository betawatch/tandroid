...
public class a8 extends NestedScrollView implements a70 {
    ...
    public final void C() {
        if (this.r0) {
            ...
            ofFloat.addUpdateListener(new s7(this, scrollY, f10, 0));
    ...
    public final void D(boolean z10) {
        if (!this.r0 || z10) {
            ...
            float f10 = this.U.w;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            ofFloat.addUpdateListener(new s7(this, scrollY, f10, 1));
            ofFloat.setDuration(250L);
            ofFloat.setInterpolator(er.f);
            ofFloat.start();
        }
    ...
    */
    ...
    public final void c(Canvas canvas, float f10) {
        ...
        canvas.translate(x10, (y10 + AndroidUtilities.lerp(y7Var2.m, y7Var2.l, z7Var.w)) - y7VarArr2[0].p.b());
