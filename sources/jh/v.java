...
public abstract class v implements e5 {
    ...
    public final zw0 c() {
        if (this.o == null) {
            ...
            this.o = zw0Var;
            if (this.B) {
                zw0Var.setBackgroundColor(j6.v0(j6.d6, p2Var.getResourceProvider()));
            }
    ...
    */
    ...
    public final void h(View view) {
        if (view instanceof f5) {
            ...
            AndroidUtilities.runOnUIThread(new ff.c(19, this, (f5) view), this.y ? 100L : 0L);
        }
    }
    ...
    public final void i(boolean z4) {
        int i10;
        rl0 rl0Var = this.p;
        if (rl0Var == null || (i10 = !this.f.c.B ? 1 : 0) < 0 || i10 >= rl0Var.getChildCount()) {
            return;
        }
