...
public final class b6 extends j6 {
    ...
    public final void G(TLRPC.InputMedia inputMedia, TL_bots.botPreviewMedia botpreviewmedia) {
        ...
        MessageObject messageObject2 = new MessageObject(this.c, new a6(this, this.d, botpreviewmedia));
    ...
    public final boolean H(Runnable runnable) {
        ...
        this.C = true;
        this.F = ConnectionsManager.getInstance(i10).sendRequest(getpreviewmedias, new cg.g0(12, this, runnable));
        return true;
    }

    public final void I(TL_bots.botPreviewMedia botpreviewmedia) {
        MessageObject messageObject = new MessageObject(this.c, new a6(this, this.d, botpreviewmedia));
