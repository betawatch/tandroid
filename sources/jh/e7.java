...
public final /* synthetic */ class e7 implements Runnable {
    ...
    public /* synthetic */ e7(s7 s7Var, TLObject tLObject, Runnable runnable, TLRPC.TL_error tL_error, boolean z10, long j10, int i10, MessageObject messageObject, long j11) {
        this.f = s7Var;
        this.h = tLObject;
        this.n = runnable;
        this.r = tL_error;
            ...
            case 0:
                ...
                if (!(tLObject instanceof TLRPC.Updates)) {
                    if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && !z10) {
                        ...
                        tL_messages_getScheduledMessages.peer = MessagesController.getInstance(s7Var.a).getInputPeer(j10);
                        tL_messages_getScheduledMessages.id.add(Integer.valueOf(i10));
                        ConnectionsManager.getInstance(s7Var.a).sendRequest(tL_messages_getScheduledMessages, new v(s7Var, messageObject, j11, runnable, 2));
                        break;
                    } else {
                        runnable.run();
                        break;
    ...
    public /* synthetic */ e7(MessagesStorage messagesStorage, long j10, boolean z10, String str, long j11, int i10, String str2, String str3, String str4) {
