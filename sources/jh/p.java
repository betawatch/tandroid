...
public abstract class p extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, ud.b {
    ...
    public p(Context context, gy gyVar, int i10, int i11) {
        super(context);
        this.a = new ud.a(1, this, er.h, 380L, false);
    ...
    public final void c() {
        ...
        s6 s6Var = this.s;
        if (N02 > size || ((N0 = k0Var.N0() + 9) < arrayList.size() && s6Var.D(0, ((m) arrayList.get(N0)).c) == 0)) {
    ...
    public final void d() {
        float a2 = h7.n.a(Math.min(this.J, this.W), 0.0f, 1.0f);
        float f10 = this.a.e;
        float f11 = 1.0f - f10;
        float f12 = f10 * a2;
        float f13 = f11 * a2;
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i18 < 0 || i18 == 2) {
            ...
            for (int i19 = 0; i19 < hVar5.getChildCount(); i19++) {
                float x8 = ((o) hVar5.getChildAt(i19)).getX() + hVar5.getX() + r4.getMeasuredWidth();
                if (f25 == 0.0f || x8 > f25) {
                    f25 = x8;
                }
            }
            ...
            while (i22 < hVar4.getChildCount()) {
                ...
                if (R2 >= i10 && R2 < arrayList2.size() + i10) {
                    ...
                    if (i23 == i10 + 2) {
                        ...
                        oVar2.d(f27, this.W, this.j0, this.k0 == oVar2.b);
                        if (R2 > i10 || R2 >= arrayList2.size() + i10) {
                            z11 = z10;
                            f15 = f26;
                            f16 = f27;
                            ...
                            if (oVar3 != null) {
                                ...
                                z11 = z10;
                                float lerp5 = (AndroidUtilities.lerp(dp2, dp3, oVar3.F) + AndroidUtilities.dp(8.0f)) / f12;
                                float lerp6 = (AndroidUtilities.lerp(dp2, dp3, oVar2.F) + AndroidUtilities.dp(8.0f)) / f12;
                                float x10 = oVar3.getX() + h7Var2.F.centerX();
                                float y10 = oVar3.getY() + h7Var2.F.centerY();
                                float x11 = (oVar2.getX() + h7Var.F.centerX()) - x10;
                                float y11 = (oVar2.getY() + h7Var.F.centerY()) - y10;
                                f15 = f26;
                                if (((float) Math.sqrt((y11 * y11) + (x11 * x11))) < lerp5 + lerp6) {
                                    ...
                                    h7Var2.g = degrees2 - f28;
                                    h7Var2.h = degrees2 + f28;
                        ...
                        if (this.w0) {
                            f19 = 0.0f;
                            lerp2 = AndroidUtilities.lerp(0.0f, f31 - oVar2.getLeft(), this.F0.getInterpolation(this.A0));
                        } else {
                            if (this.j0 > f18) {
                                int i24 = oVar2.b;
                                int i25 = this.k0;
                                ...
                                lerp2 = AndroidUtilities.lerp(f31 - oVar2.getLeft(), f22, 1.0f - this.E0);
                                f19 = 0.0f;
                            }
                            f22 = 0.0f;
                            lerp2 = AndroidUtilities.lerp(f31 - oVar2.getLeft(), f22, 1.0f - this.E0);
                        ...
                        float a2 = h7.n.a((this.V - 0.2f) / 0.1f, f19, 1.0f);
                        i12 = R2 - i10;
                        if (i12 == 0) {
                            f20 = 0.65f;
                            lerp3 = AndroidUtilities.lerp(f19, f11 - f14, er.h.getInterpolation(this.J));
                        } else {
                            f20 = 0.65f;
                            if (i12 == 1) {
                                lerp3 = AndroidUtilities.lerp(f19, (f11 - f14) * 0.65f, er.h.getInterpolation(this.J));
                            } else {
                                f21 = 0.0f;
                                float f32 = (oVar2.b == this.k0 || this.j0 <= f19) ? 0.0f : (-dp) / f12;
                                float lerp7 = AndroidUtilities.lerp(i12 != 0 ? AndroidUtilities.lerp(f32, f11 - f14, this.C0) : i12 == 1 ? AndroidUtilities.lerp(f32, (f11 - f14) * f20, this.C0) : 0.0f, f21, a2);
                                if (this.J <= 0.0f) {
                        ...
                        float lerp72 = AndroidUtilities.lerp(i12 != 0 ? AndroidUtilities.lerp(f32, f11 - f14, this.C0) : i12 == 1 ? AndroidUtilities.lerp(f32, (f11 - f14) * f20, this.C0) : 0.0f, f21, a2);
                        if (this.J <= 0.0f) {
                        }
                        if (oVar2.a) {
                        }
                        ...
                        float a22 = h7.n.a((this.V - 0.2f) / 0.1f, f19, 1.0f);
                        i12 = R2 - i10;
                        if (i12 == 0) {
                        }
                        f21 = lerp3;
                        ...
                        float lerp722 = AndroidUtilities.lerp(i12 != 0 ? AndroidUtilities.lerp(f32, f11 - f14, this.C0) : i12 == 1 ? AndroidUtilities.lerp(f32, (f11 - f14) * f20, this.C0) : 0.0f, f21, a22);
                        if (this.J <= 0.0f) {
                        }
                        if (oVar2.a) {
                        }
                ...
                float a222 = h7.n.a((this.V - 0.2f) / 0.1f, f19, 1.0f);
                i12 = R2 - i10;
                if (i12 == 0) {
                }
                f21 = lerp3;
                ...
                float lerp7222 = AndroidUtilities.lerp(i12 != 0 ? AndroidUtilities.lerp(f32, f11 - f14, this.C0) : i12 == 1 ? AndroidUtilities.lerp(f32, (f11 - f14) * f20, this.C0) : 0.0f, f21, a222);
                if (this.J <= 0.0f) {
                }
                if (oVar2.a) {
                }
        ...
        if (this.F != null) {
            float lerp8 = AndroidUtilities.lerp(29, 74, er.g.getInterpolation(this.J));
            hVar2 = hVar;
            i11 = 0;
        ...
        if (min != 0.0f) {
            ...
            j6Var.setTranslationY((((f11 + AndroidUtilities.dp(14.0f)) - ((j6Var.getMeasuredHeight() - j6Var.getTextHeight()) / f12)) + AndroidUtilities.dp(f10)) - (iVar.getTotalVisibility() * AndroidUtilities.dp(6.0f)));
            ...
            float d10 = com.google.android.recaptcha.internal.a.d(lerp9, 2.0f, AndroidUtilities.lerp((dp5 / f12) - lerp9, 0.0f, f33), -dp5) + AndroidUtilities.dp(12.0f) + f13;
            j6Var.setTranslationX(d10);
        ...
        if ((!z10 || (valueAnimator = this.D0) == null || !valueAnimator.isRunning()) && oVar != null) {
            ...
            if (!z11 || s6Var.H()) {
                if (s6Var.I(oVar.A) || s6Var.K(oVar.A)) {
                    TL_stories.PeerStories y10 = s6Var.y(oVar.A);
                    long j10 = oVar.A;
                    i7 i7Var = this.n0;
                    if (i7Var != null) {
                        i7Var.a();
    ...
    public final void j(long j10) {
        ...
        if (j10 == 0 && (o10 = MessagesController.getInstance(i10).getStoriesController().o()) != null && o10.a(i10, 1)) {
            gyVar.showDialog(new ag.i1(o10.b(), this.f, getContext(), this.a0, null));
            return;
        }
        int i11 = 0;
        while (true) {
    ...
    public final void l(float f10, boolean z10) {
        ...
        if (z11 != this.w0) {
            ...
            this.y0 = ofFloat;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: jh.c
            ...
            this.y0.setInterpolator(er.h);
            float f11 = this.V;
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(f11, z11 ? f11 : 0.0f);
            this.B0 = ofFloat2;
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: jh.c
                public final /* synthetic */ p b;
            ...
            if (this.w0) {
                ...
                this.z0 = ofFloat3;
                ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: jh.c
                    public final /* synthetic */ p b;
                ...
                this.D0.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: jh.c
                    public final /* synthetic */ p b;
    ...
    public final void n() {
        if (this.F == null) {
            ...
            if (clickableSpanArr != null && clickableSpanArr.length >= 1) {
                replaceSingleTag.setSpan(new k41(AndroidUtilities.bold()), replaceSingleTag.getSpanStart(clickableSpanArr[0]), replaceSingleTag.getSpanEnd(clickableSpanArr[0]), 33);
            }
            lh.w3 w3Var2 = this.F;
            w3Var2.h = lh.w3.a(replaceSingleTag, w3Var2.getTextPaint());
            ...
            if (getParent() instanceof FrameLayout) {
                ((FrameLayout) getParent()).addView(this.F, h7.z5.e(-1, ImageReceiver.DEFAULT_CROSSFADE_DURATION, 51));
            }
        }
        lh.w3 w3Var3 = this.F;
        if (w3Var3 != null) {
    ...
    public final void p() {
        ...
        if (l7.d != null) {
            ...
            l7.d.d(i0.b.d(0.25f, w02, w03), w03, 0, 0);
        }
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.h, new d5.d() { // from class: jh.e
            @Override // d5.d
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.r, (d5.d) new j4.w0(3));
    }
