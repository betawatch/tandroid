...
public class d5 extends FrameLayout {
    ...
    public d5(Context context, org.telegram.ui.ActionBar.c6 c6Var, Runnable runnable, View.OnClickListener onClickListener, l1 l1Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        ...
        while (true) {
            ...
            this.b.addView(this.d[i12], i7.f6.e(-1, -1, 119));
        ...
        while (true) {
            ...
            if (i14 == 2) {
                ...
                this.F = frameLayout;
                this.f[i14].addView(frameLayout, i7.f6.q(-1, 144, 119));
                ...
                this.r[i14] = new y80(context, null);
                ...
                y80 y80Var2 = this.r[i14];
                TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
                y80Var2.setEllipsize(truncateAt);
                this.r[i14].setGravity(17);
                frameLayout.addView(this.r[i14], i7.f6.d(-1, -2.0f, 49, 16.0f, 95.33f, 16.0f, 0.0f));
                this.y[i14] = new y80(context, null);
                ...
                frameLayout.addView(this.y[i14], i7.f6.d(-1, -2.0f, 49, 16.0f, 122.0f, 16.0f, 0.0f));
            } else if (i14 == 4) {
                g4 g4Var = new g4(context, c6Var);
                this.H = g4Var;
                this.f[i14].addView(g4Var, i7.f6.n(-1, -2));
                ...
                this.r[i14].setTypeface(AndroidUtilities.bold());
                this.r[i14].setGravity(17);
                this.f[i14].addView(this.r[i14], i7.f6.t(-1, -2, 17, 24, i14 == 3 ? 10 : 0, 24, 0));
                if (i14 == 0) {
                    this.f[i14].addView(this.s, i7.f6.t(-2, -2, 17, 0, 4, 0, 4));
                    this.f[i14].addView(this.v, i7.f6.s(-2, 17, 0, 6, 0, 19.33f, 2));
                }
                if (i14 == 0) {
                    this.y[i14] = new y80(context, null);
                    ...
                    this.y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.y[i14].setDisablePaddingsOffsetY(true);
                    this.x.addView(this.y[i14], i7.f6.e(-2, -2, 17));
                    this.x.addView(this.J, i7.f6.a(-2.0f, 20.33f, 17));
                ...
                this.f[i14].addView(this.B[i14], i7.f6.t(-1, -2, 17, 24, 8, 24, 0));
            }
            if (i14 == 0) {
                this.f[i14].addView(this.D, i7.f6.t(-1, -2, 7, 0, 15, 0, 0));
            }
        ...
        addView(this.b, i7.f6.d(160, 160.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
    ...
    public final void a() {
        ...
        this.q0.addListener(new b5(this, 4));
        this.q0.setDuration(320L);
        this.q0.setInterpolator(jr.g);
        this.q0.start();
    }
    ...
    public final void c(Canvas canvas, float f9, float f10, float f11, float f12) {
        ...
        TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop2 = stargiftattributebackdropArr[2];
        int d = i0.a.d(this.o0, i10, stargiftattributebackdrop2 != null ? stargiftattributebackdrop2.pattern_color | (-16777216) : 0);
        org.telegram.ui.Components.n5[] n5VarArr = this.m0;
        n5VarArr[1].k(Integer.valueOf(d));
        x0.a(canvas, 0, n5VarArr[1], f11, f12, this.Q.a(1), this.p0);
        canvas.restore();
    }
    ...
    public void d(a5.d dVar) {
        ...
        if (!this.W) {
            ...
            textView.setScaleX(AndroidUtilities.lerp(0.4f, this.I ? 1.0f : 0.4f, dVar.a(0)));
            textView.setScaleY(AndroidUtilities.lerp(0.4f, this.I ? 1.0f : 0.4f, dVar.a(0)));
        ...
        while (true) {
            ...
            if (i13 == 0 || i13 == 2) {
                ...
                TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop3 = stargiftattributebackdropArr[2];
                i10 = i0.a.d(this.o0, i14, stargiftattributebackdrop3 == null ? v02 : stargiftattributebackdrop3.text_color | (-16777216));
            }
            ...
            if (z10) {
                ...
                if (i13 == 0) {
                    ...
                    y80VarArr[i13].setLayoutParams(layoutParamsArr2[i13]);
                }
            }
            i13++;
        }
        ...
        this.v.setBackground(org.telegram.ui.ActionBar.g6.b0(dp, stargiftattributebackdrop5 == null ? 553648127 : i0.a.d(0.25f, stargiftattributebackdrop5.edge_color | (-16777216), stargiftattributebackdrop5.pattern_color | (-16777216))));
        y80 y80Var2 = y80VarArr[2];
        ...
        y80Var2.setTextColor(v02);
        org.telegram.ui.Components.t9[] t9VarArr = this.d;
        org.telegram.ui.Components.t9 t9Var = t9VarArr[0];
        a5.d dVar2 = this.Q;
        t9Var.setAlpha(Math.max((dVar2.b(0) && dVar2.b(2)) ? 1.0f : Math.max(dVar2.a(0), dVar2.a(2)), this.Q.a(3)));
        t9VarArr[1].setAlpha((1.0f - this.o0) * dVar.a(1));
        t9VarArr[2].setAlpha(dVar.a(1) * this.o0);
        float lerp3 = AndroidUtilities.lerp(1.0f, this.c0, dVar.a(2));
        FrameLayout frameLayout = this.b;
        frameLayout.setScaleX(lerp3);
        frameLayout.setScaleY(AndroidUtilities.lerp(1.0f, this.c0, dVar.a(2)));
        frameLayout.setTranslationX(dVar.a(2) * this.a0);
        frameLayout.setTranslationY((dVar.a(2) * this.b0) + (dVar.a(1) * AndroidUtilities.dp(16.0f)));
        View view = viewArr[2];
        int i15 = dVar.a;
        if (i15 == 2 && i12 == 2) {
            a2 = 0.0f;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        v4 v4Var2 = this.c;
        if (v4Var2.s == null && v4Var2.v == null && v4Var2.w == null) {
            d5Var = this;
            f12 = f9;
            f11 = f10;
            iArr3 = iArr4;
            ...
            v4Var2.a(canvas2, v4Var2.v, v4Var2.y, width2, realHeight, iArr7, iArr8, iArr9);
            v4Var2.a(canvas2, v4Var2.w, v4Var2.A, width2, realHeight, iArr7, iArr8, iArr9);
            v4Var = v4Var2;
            d5Var.invalidate();
        }
        if (max > 0.0f && stargiftattributebackdropArr[0] != null) {
            ...
            if (d5Var.Q.a(2) > 0.0f) {
                ...
                LinearLayout[] linearLayoutArr = d5Var.f;
            ...
            if (textView != null && d5Var.w != i13) {
                d5Var.w = i13;
                textView.setTextColor(i13);
                org.telegram.ui.ActionBar.g6.B1(textView.getBackground(), i14, false);
            }
            if (v4Var.s != null || v4Var.v != null || v4Var.w != null) {
                d5Var.y[0].setTextColor(i13);
            }
            if (d5Var.Q.a(2) > 0.0f) {
                if (d5Var.s0 == null) {
                    d5Var.s0 = new va(1, 12);
                }
                FrameLayout frameLayout2 = d5Var.b;
                ...
                RectF rectF2 = d5Var.r0;
                rectF2.set(measuredWidth - scaleX, measuredHeight - scaleY, measuredWidth + scaleX, f17);
                d5Var.s0.g(rectF2);
                d5Var.s0.d();
                d5Var.s0.a(canvas2, org.telegram.ui.ActionBar.g6.l1(d5Var.Q.a(2), -1));
                d5Var.invalidate();
            }
        }
        if (d5Var.Q.a(1) > 0.0f) {
    ...
    public final void f(TL_stars.StarGift starGift, boolean z10, boolean z11, boolean z12) {
        ...
        if (z14) {
            ...
            ua1Var.setVisibility(z13 ? 0 : 8);
            bg.d1[] d1VarArr = this.E;
            if (z13) {
                d1VarArr[1].b(z12 ? R.drawable.filled_crown_off : R.drawable.filled_crown_on, LocaleController.getString(z12 ? R.string.Gift2ActionWearOff : R.string.Gift2ActionWear), false);
            }
            float f9 = 1.0f;
            if (starGift.resell_amount != null) {
                ...
                kf.b bVar = kf.b.b;
                kf.a resellAmount = starGift.getResellAmount(z15 ? bVar : kf.b.a);
                CharSequence formatSpannable = LocaleController.formatSpannable(R.string.GiftOnSale, ia.S0("⭐️ " + ((Object) ia.J0(resellAmount.o(), 1.0f, ',')), resellAmount.a == bVar), Float.valueOf(0.9f));
                TextView textView = this.J;
        ...
        this.e[0] = (TL_stars.starGiftAttributeModel) s7.l(starGift.attributes, TL_stars.starGiftAttributeModel.class);
        d(this.Q);
    }
    ...
    public TL_stars.starGiftAttributeBackdrop getUpgradeBackdropAttribute() {
        float f9 = this.o0;
        TL_stars.starGiftAttributeBackdrop[] stargiftattributebackdropArr = this.R;
        return f9 > 0.5f ? stargiftattributebackdropArr[2] : stargiftattributebackdropArr[1];
    }

    public org.telegram.ui.Components.t9 getUpgradeImageView() {
        float f9 = this.o0;
        org.telegram.ui.Components.t9[] t9VarArr = this.d;
        return f9 > 0.5f ? t9VarArr[2] : t9VarArr[1];
    }
    ...
    public TL_stars.starGiftAttributeModel getUpgradeImageViewAttribute() {
        ...
        return f9 > 0.5f ? stargiftattributemodelArr[2] : stargiftattributemodelArr[1];
    }
    ...
    public final void h(int i10, CharSequence charSequence, CharSequence charSequence2, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence3, TLObject tLObject, Spannable spannable) {
        ...
        if (i10 == 0 && !TextUtils.isEmpty(spannableStringBuilder)) {
            ...
            if (i10 == 0) {
                ...
                y80VarArr[i10].setVisibility(TextUtils.isEmpty(charSequence2) ? 8 : 0);
            }
            y80Var.setVisibility(8);
        ...
        if (x0Var != null) {
            x0Var.setVisibility(TextUtils.isEmpty(spannable) ? 8 : 0);
    ...
    public final void k() {
        ...
        float f9 = -this.b.getLeft();
        y80[] y80VarArr = this.r;
        this.a0 = ((((Math.min(y80VarArr[2].getPaint().measureText(y80VarArr[2].getText().toString()), y80VarArr[2].getWidth()) + y80VarArr[2].getWidth()) / 2.0f) + (y80VarArr[2].getX() + f9)) + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(126.67f) / 2.0f);
    ...
    public void setPreviewAttributes(f1 f1Var) {
        ...
        if (dVar != null && dVar.b == 1 && isAttachedToWindow()) {
            ...
            xi0 lottieAnimation2 = t9VarArr[this.n0 + 1].getImageReceiver().getLottieAnimation();
            ...
            ia.Z0(t9VarArr[i12].getImageReceiver(), stargiftattributemodelArr[this.n0 + 1].document, 160);
            a();
            float f9 = this.n0;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(1.0f - f9, f9);
            this.d0 = ofFloat;
            ofFloat.addUpdateListener(new z4(this, 0));
            this.d0.addListener(new b5(this, 3));
            this.d0.setDuration(320L);
            this.d0.setInterpolator(jr.h);
            this.d0.start();
        }
    }
    ...
    public void setResellPrice(kf.a aVar) {
        ...
        if (k9) {
            ...
            jr jrVar = jr.h;
            duration.setInterpolator(jrVar).setListener(new b5(this, 2)).setListener(new b5(this, 1)).start();
            y80VarArr[0].animate().alpha(1.0f).setDuration(420L).setInterpolator(jrVar).start();
        } else {
            textView.setText(LocaleController.formatSpannable(R.string.GiftOnSale, ia.U0(aVar.a == kf.b.b, "⭐️ " + ((Object) ia.J0(aVar.o(), 1.0f, ',')), 0.9f, null, 0.0f, 1.0f)));
            ...
            jr jrVar2 = jr.h;
            duration2.setInterpolator(jrVar2).setListener(new b5(this, 0)).start();
            y80VarArr[0].animate().alpha(0.0f).setDuration(420L).setInterpolator(jrVar2).start();
        }
        boolean z10 = this.I;
        bg.d1[] d1VarArr = this.E;
        if (z10) {
