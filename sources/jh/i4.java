...
public abstract class i4 extends View {
    ...
    public final void c(int i10, boolean z10, boolean z11) {
        if ((this.G != i10 || z11) && getMeasuredHeight() > 0) {
            ...
            this.I = ofFloat;
            ofFloat.addUpdateListener(new ag.q1(this, 3));
            this.I.addListener(new ag.r1(this, 18));
            this.I.setInterpolator(er.f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (i14 < this.A.size()) {
            ...
            float b10 = f18 < 0.0f ? pa.b(1.0f, f10, this.s * 0.1f, f17) : com.google.android.recaptcha.internal.a.z(1.0f, f10, this.s * 0.1f, f17);
            if (b10 > getMeasuredWidth() || this.s + b10 < 0.0f) {
                ...
                float f22 = f11 * f21;
                f12 = measuredWidth;
                float a2 = org.telegram.messenger.y1.a(f20, f19, 2.0f, b10);
                float a3 = org.telegram.messenger.y1.a(f22, f21, 2.0f, this.x);
                if (this.y == 0.0f || i14 == (i12 = this.G)) {
                    arrayList2 = arrayList3;
                    arrayList = arrayList4;
                    f13 = f15;
                    i11 = i15;
                    h4Var.a.setImageCoords(a2, a3, f20, f22);
                } else {
                    f13 = f15;
                    i11 = i15;
                    arrayList = arrayList4;
                    arrayList2 = arrayList3;
                    h4Var.a.setImageCoords(AndroidUtilities.lerp(getMeasuredWidth() * (i14 - i12), a2, this.y), AndroidUtilities.lerp(this.a, a3, this.y), AndroidUtilities.lerp(this.b, f20, this.y), AndroidUtilities.lerp(this.c, f22, this.y));
                }
                if (this.y == 1.0f || i14 != this.G) {
                    ImageReceiver imageReceiver = h4Var.a;
                    imageReceiver.draw(canvas);
                    if (h4Var.c != null) {
                        int B = (int) com.google.android.recaptcha.internal.a.B(f10, 0.3f, 0.7f, 255.0f);
