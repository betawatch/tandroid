...
public final class e4 extends FrameLayout {
    ...
    public e4(Context context) {
        ...
        v1Var.s = AndroidUtilities.dp(18.0f);
        v1Var.u = false;
    ...
    public final void a(TL_stars.StarGift starGift, boolean z10) {
        ...
        if (starGift != null) {
            ...
            ia.Z0(this.c.getImageReceiver(), stargiftattributemodel.document, 52);
            ...
            this.e.setBackground(new t4(AndroidUtilities.dp(10.0f), b10));
        }
        b(starGift != null, z10);
    }
    ...
    public final void b(final boolean z10, boolean z11) {
        ...
        jr jrVar = jr.h;
        final int i10 = 0;
        alpha.setInterpolator(jrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: jh.d4
        ...
        final int i11 = 1;
        textView.animate().alpha(z10 ? 1.0f : 0.0f).setInterpolator(jrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: jh.d4
            public final /* synthetic */ e4 b;
        ...
        final int i12 = 2;
        frameLayout2.animate().alpha(z10 ? 1.0f : 0.0f).setInterpolator(jrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: jh.d4
            public final /* synthetic */ e4 b;
