...
public abstract class ab extends View {
    ...
    public ab(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        this.U = new Path();
        this.V = 0.0f;
        this.b0 = new vd.a(this, jrVar, 320L);
        this.a = c6Var;
    ...
    public final void a(float f9) {
        ...
        int value = getValue();
        this.h0.addListener(new za(this, f9, value));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        vaVar.g(rectF2);
        float f11 = this.V;
        vaVar.h = (f11 * 15.0f) + 1.0f;
        vaVar.j = (int) (vaVar.b.size() * ((f11 * 0.85f) + 0.15f));
        vaVar.d();
        canvas.save();
        ...
        if (j10 == -1 || b((int) j10) >= 1.0f || b((int) this.L) <= 0.0f) {
            ...
            float e10 = d6Var4.e(Math.abs((rectF3.right - ((float) AndroidUtilities.dp(10.0f))) - clamp01) < ((float) AndroidUtilities.dp(14.0f)));
            ...
            float f12 = (clamp01 + zz0Var.c) + ((float) (AndroidUtilities.dp(16.0f) * 2)) > rectF2.right ? (clamp01 - lerp) - zz0Var.c : clamp01 + lerp;
            ...
            direction = direction2;
            paint2 = paint5;
            this.H.c(f12, rectF2.centerY(), 0.6f, i10, canvas);
            canvas2 = canvas;
        }
        ...
        if (j11 == -1 || b((int) j11) >= 1.0f || b((int) this.L) <= 0.0f) {
            ...
            float e11 = d6Var2.e(Math.abs((rectF.right - ((float) AndroidUtilities.dp(10.0f))) - dp3) < ((float) AndroidUtilities.dp(14.0f)));
            ...
            float f13 = (zz0Var.c + dp3) + ((float) (AndroidUtilities.dp(16.0f) * 2)) > rectF2.right ? (dp3 - lerp2) - zz0Var.c : lerp2 + dp3;
            ...
            this.H.c(f13, rectF2.centerY(), 0.75f, -1, canvas);
            canvas2 = canvas;
        }
        canvas2.restore();
        invalidate();
        ...
        canvas2.restore();
        canvas2.save();
        float f25 = 1.0f - (this.b0.e * 0.15f);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f0) {
            float x4 = motionEvent.getX() - this.c0;
            float y8 = motionEvent.getY() - this.d0;
            if (!this.g0 && Math.abs(x4) > Math.abs(y8 * 1.5f) && Math.abs(x4) > AndroidUtilities.touchSlop) {
            ...
            if (!this.g0 && motionEvent.getPointerId(0) == this.f0 && i7.z5.a(this.c0, this.d0, motionEvent.getX(), motionEvent.getY()) < AndroidUtilities.touchSlop && System.currentTimeMillis() - this.e0 <= ViewConfiguration.getTapTimeout() * 1.5f) {
