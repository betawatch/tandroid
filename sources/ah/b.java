...
public final class b extends Drawable implements DownloadController.FileDownloadProgressListener {
    ...
    public b(int i9, t1 t1Var) {
        ...
        this.e = i9;
        this.d = t1Var;
        this.y = new td.a(t1Var, gr.h, 380L);
        i6 i6Var = new i6(false, false, false, false);
        this.a = i6Var;
        i6Var.b = 21;
        i6Var.t(AndroidUtilities.dp(11.0f));
        i6Var.setCallback(t1Var);
        this.b = new e9(i9, t1Var, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(8.33f), AndroidUtilities.dpf2(1.0f));
    ...
    public final void c(Canvas canvas) {
        ...
        if (this.y.e > 0.0f) {
            ...
            float f10 = gVar.c.a;
            int i9 = (int) gVar.f.a;
            int lerp = (bounds.right - dp) - AndroidUtilities.lerp(AndroidUtilities.dp(2.0f), AndroidUtilities.dp(4.0f) + i9, f10);
            if (f10 > 0.0f) {
                e9 e9Var = this.b;
                e9Var.i = (int) (this.y.e * 255.0f);
                e9Var.setBounds((bounds.right - dp) - i9, bounds.bottom - AndroidUtilities.dp(31.33f), bounds.right - dp, bounds.bottom);
                this.b.c(canvas);
            }
        ...
        if (this.h) {
            ...
            if (this.v || this.n) {
                if (!this.n || this.r) {
                    ...
                    this.x.setColor(i0.a.k(f6.w0(null, this.B.isOutOwner() ? f6.fc : f6.ec, false), 16));
            ...
            if (this.n) {
                ...
                if (this.r) {
                    ...
                    w02 = f6.w0(null, this.B.isOutOwner() ? f6.sb : f6.nd, false);
                }
    ...
    public final float d(float f10) {
        e9 e9Var = this.b;
        float d = this.a.d() + e9Var.c.d.f.a;
        float dp = e9Var.c.d.c.a * AndroidUtilities.dp(4.0f);
        float f11 = this.y.e;
    ...
    */
        ...
        if (messageMedia != null && !(messageMedia instanceof TLRPC.TL_messageMediaEmpty)) {
            ...
            if (messageMedia instanceof TLRPC.TL_messageMediaWebPage) {
                ...
                if (!(messageMedia instanceof TLRPC.TL_messageMediaPhoto)) {
                        ...
                        if (document != null) {
                            ...
                            if (MessageObject.isVideoDocument(tL_messageMediaDocument.document)) {
                                ...
                                if (z12 || isAnimatedStickerDocument) {
                                    imageReceiver.setImage(ImageLocation.getForDocument(document), "36_36", DocumentObject.getSvgThumb(document, f6.lc, 1.0f), document.size, z12 ? "webp" : null, messageObject2, 1);
                                }
                                z11 = false;
                            }
                        }
                    ...
                    this.A.setColors(this.v ? 0 : f6.w0(null, f6.le, false), this.v ? 0 : f6.w0(null, f6.me, false), f6.w0(null, f6.ne, false), f6.w0(null, f6.oe, false));
                    if (!TextUtils.equals(str2, this.D)) {
                        ...
                        if (!TextUtils.isEmpty(this.D)) {
                            DownloadController.getInstance(i9).addLoadingFileObserver(this.D, this);
                        }
                    }
                    b(z10);
                }
    ...
    public final void j(int i9, boolean z10) {
        this.a.q(i9 > 0 ? LocaleController.formatShortNumber(i9, null) : null, z10, true);
    }
