...
public final class f {
    ...
    public final void a(RenderNode renderNode) {
        ...
        float f10 = height;
        int round2 = Math.round((hVar.d * f10) / this.f);
        float f11 = round;
        float f12 = f11 / f7;
        float f13 = round2;
        float f14 = f13 / f10;
    ...
    public final void c(float f7) {
        this.b[0].setRenderEffect(RenderEffect.createBlurEffect(h.a(f7, this.e), h.a(f7, this.f), Shader.TileMode.CLAMP));
    }

    public final void d(float f7, RenderEffect renderEffect) {
        this.b[0].setRenderEffect(RenderEffect.createChainEffect(RenderEffect.createBlurEffect(h.a(f7, this.e), h.a(f7, this.f), Shader.TileMode.CLAMP), renderEffect));
    }
