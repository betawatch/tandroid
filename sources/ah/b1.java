...
public final class b1 extends FrameLayout {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:191:0x0558, code lost:
        ...
        if (((int) org.telegram.messenger.vl.c(r23.x.b.getImageReceiver().getLottieAnimation().b0, r23.x.b.getImageReceiver().getLottieAnimation().e[0], r8, r8)) < r6.b) goto L262;
     */
