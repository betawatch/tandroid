...
public final class h {
    ...
    */
    ...
    public final RenderNode d(int i10, int i11) {
        f fVar;
        g gVar = (g) this.i.get(i11);
        if (this.a && (fVar = gVar.c) != null) {
            return i10 == 0 ? fVar.c[0] : gVar.b.c[0];
        }
        return gVar.b.c[Math.min(i10, r4.length - 1)];
    }
    ...
    public final boolean e(bh.a aVar, int i10, int i11) {
        ...
        while (true) {
            ...
            if (z11 || gVar3.e != j3 || !gVar3.a.hasDisplayList()) {
                gVar3.e = j3;
                if (this.l != null) {
                    throw new IllegalStateException();
                }
                ...
                gVar4.a.setPosition(0, 0, i20, height);
                RecordingCanvas beginRecording2 = gVar4.a.beginRecording(i20, height);
                float f7 = 1.0f / i19;
                ...
                g gVar5 = (g) arrayList.get(this.k);
                gVar5.a.endRecording();
                f fVar = gVar5.b;
                f fVar2 = gVar5.c;
                if (fVar2 != null) {
                    fVar2.a(gVar5.a);
