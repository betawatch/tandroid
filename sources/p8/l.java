...
public abstract class l {
    ...
    public static u0 e(Set set, o8.f fVar) {
        if (set instanceof SortedSet) {
            ...
            o8.f fVar2 = u0Var.b;
            fVar2.getClass();
            return new v0((SortedSet) u0Var.a, new o8.g(Arrays.asList(fVar2, fVar)));
        }
        ...
        o8.f fVar3 = u0Var2.b;
        fVar3.getClass();
        return new u0(u0Var2.a, new o8.g(Arrays.asList(fVar3, fVar)));
    }
    ...
    public static ArrayList k(Object... objArr) {
        ...
        a(length, "arraySize");
        ArrayList arrayList = new ArrayList(u6.d(length + 5 + (length / 10)));
