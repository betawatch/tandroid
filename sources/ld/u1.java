...
public class u1 implements f1, r, y1 {
    ...
    public u1(boolean z4) {
        this._state$volatile = z4 ? e0.j : e0.i;
    }

    public static q D(qd.k kVar) {
        while (kVar.h()) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = qd.k.b;
            qd.k d = kVar.d();
            if (d == null) {
    ...
    public final void E(v1 v1Var, Throwable th2) {
        ...
        a7.b bVar = null;
        for (qd.k kVar = (qd.k) f10; !kVar.equals(v1Var); kVar = kVar.g()) {
    ...
    public final void H(k1 k1Var) {
        ...
        v1 v1Var = new v1();
        k1Var.getClass();
        qd.k.b.set(v1Var, k1Var);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = qd.k.a;
    ...
    */
    ...
    public final boolean j(Throwable th2) {
        ...
        p pVar = (p) b.get(this);
        return (pVar == null || pVar == w1.a) ? z4 : pVar.b(th2) || z4;
    }
    ...
    public final void m(a1 a1Var, Object obj) {
        ...
        if (a1Var instanceof k1) {
            try {
                ...
                w(new a7.b("Exception in completion handler " + a1Var + " for " + this, th3));
                return;
            }
        }
        v1 c3 = a1Var.c();
        if (c3 != null) {
            Object f10 = c3.f();
            kotlin.jvm.internal.j.c(f10, "null cannot be cast to non-null type kotlinx.coroutines.internal.LockFreeLinkedListNode{ kotlinx.coroutines.internal.LockFreeLinkedListKt.Node }");
            for (qd.k kVar = (qd.k) f10; !kVar.equals(c3); kVar = kVar.g()) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final o0 y(boolean z4, boolean z10, d1 d1Var) {
        k1 k1Var;
        Throwable th2;
        if (z4) {
