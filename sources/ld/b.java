...
public class b {
    ...
    public final h b(long j10) {
        ...
        loop0: while (true) {
            dVar.getClass();
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = od.d.a;
        ...
        h hVar3 = (h) dVar;
        loop2: for (h hVar4 = hVar3; hVar4 != null; hVar4 = (h) ((od.d) od.d.b.get(hVar4))) {
    ...
    public final void d() {
        ...
        loop0: while (true) {
            ...
            if (!z10 || andIncrement < atomicLongFieldUpdater2.get(this) || !hVar.k(i10, l10, d.g)) {
                while (true) {
    ...
    public final Throwable f() {
        ...
        return th2 == null ? new w0("Channel was closed") : th2;
    }
    ...
    public final boolean i(long j10, boolean z10) {
        ...
        if (i10 != 0 && i10 != 1) {
            ...
            if (i10 == 2) {
                ...
                if (i10 != 3) {
                    throw new IllegalStateException(l1.k(i10, "unexpected close status: ").toString());
                }
    ...
    */
    ...
    public final void l(i2 i2Var, boolean z10) {
        ...
        if (z10) {
            f9 = (Throwable) i.get(this);
            if (f9 == null) {
                f9 = new i("Channel was closed");
            }
        } else {
            f9 = f();
        }
        ...
        while (true) {
            ...
            if (l10 == null) {
                ...
                if (l10 != d.e) {
                    ...
                    if (hVar.f.getAndSet((i10 * 2) + 1, aVar) != aVar) {
                        hVar.m(i10, true);
                    }
                    return 5;
                }
    ...
    */
    public final String toString() {
        ...
        sb2.append("data=[");
        List c3 = rc.h.c(g.get(this), f.get(this), h.get(this));
