...
public final class w extends t {
    ...
    public w(Class cls, v vVar) {
        ...
        this.d = new HashMap();
        w6 w6Var = ra.c.a;
        Constructor b10 = w6Var.b(cls);
        this.b = b10;
        ra.c.f(b10);
        String[] c10 = w6Var.c(cls);
    ...
    public final void c(Object obj, ua.a aVar, s sVar) {
        ...
        if (read != null || !sVar.g) {
            ...
            StringBuilder r10 = a9.p.r("null is not allowed as value for record component '", str, "' of primitive type; at path ");
            r10.append(aVar.h());
            throw new a7.c(r10.toString());
        }
    }
}
