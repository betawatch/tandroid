...
public final /* synthetic */ class d implements f3.f, j3.f, ba.a, c2, tc0, Continuation, r8.i, r8.e, j {
    ...
    public j3.g c(Bundle bundle) {
        ...
        switch (this.a) {
            case 2:
                Bundle bundle2 = bundle.getBundle(u.c);
                bundle2.getClass();
                s0 s0Var = (s0) s0.n.c(bundle2);
                int[] intArray = bundle.getIntArray(u.d);
                intArray.getClass();
                return new u(s0Var, intArray.length == 0 ? Collections.EMPTY_LIST : new u8.a(0, intArray.length, intArray));
            case 18:
            ...
            case 27:
                ...
                while (true) {
                    ...
                    if (byteArray == null) {
                        m0Var.q = arrayList;
                        m0Var.r = (o3.h) bundle.getParcelable(n0.n0);
    ...
    public void invoke(Object obj) {
        ...
        switch (this.a) {
            case 23:
                y1Var.onPlayerError(new n(2, new a7.b("Player release timed out."), 1003));
                break;
            default:
