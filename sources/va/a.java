...
public class a implements Closeable {
    ...
    */
    ...
    public final IllegalStateException E(String str) {
        ...
        StringBuilder s10 = w.s("Expected ", str, " but was ");
        s10.append(u3.c.m(x()));
        s10.append(m());
        s10.append("\nSee ");
        s10.append("https://github.com/google/gson/blob/main/Troubleshooting.md#".concat(str2));
    ...
    */
        ...
        while (true) {
            ...
            switch (i12) {
                ...
                case 8:
                    break;
                default:
                    throw new AssertionError(l1.k(i12, "Unknown scope value: "));
            }
            i10++;
        }
    }
    ...
    final String m() {
        StringBuilder o10 = com.google.android.recaptcha.internal.a.o(" at line ", this.e + 1, " column ", (this.c - this.f) + 1, " path ");
        o10.append(h());
        return o10.toString();
    }
