...
public final /* synthetic */ class c implements Runnable {
    ...
    public /* synthetic */ c(e eVar, d2[] d2VarArr, TLObject tLObject, int i10, Uri uri, Context context, boolean z10) {
        this.e = eVar;
        this.f = d2VarArr;
        this.b = tLObject;
        this.c = i10;
            ...
            default:
                ...
                if (!(tLObject3 instanceof TLRPC.TL_webPage)) {
                            ...
                            if (i13 != i14) {
                                ...
                                while (true) {
                                    ...
                                    if (i10 >= n3VarArr.length) {
                                        ...
                                        h4 h4Var = n3VarArr[i10].c;
                                        if (h4Var.E == webPage2 && (K = j4Var.u0[i10].b.K(h4Var.h() - 1)) != null) {
                                            j4Var.u0[i10].c.y(K);
                                        }
                                        i10++;
                                    }
                    ...
                    if (tL_webPage.cached_page != null) {
                        if (!j4Var.d0.isEmpty() && j4Var.d0.get(0) == webPage2) {
                            if (messageObject != null) {
                            ...
                            if (z11) {
                                j4Var.d0.add(tL_webPage);
                            } else {
                                j4Var.d0.set(0, tL_webPage);
                            }
                            if (j4Var.d0.size() == 1) {
    ...
    public /* synthetic */ c(j4 j4Var, TLObject tLObject, int i10, TLRPC.WebPage webPage, MessageObject messageObject, boolean z10, String str) {
        this.e = j4Var;
        this.b = tLObject;
        this.c = i10;
        this.f = webPage;
