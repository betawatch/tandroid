        ...
        while (c10.j()) {
            ...
            switch (c11) {
                ...
                case 1:
                    ...
                    b d9 = k10.d("mdhd");
                    DataInputStream dataInputStream4 = (DataInputStream) d9.e;
                    if (logger.isLoggable(level2)) {
                        logger.log(level2, d9.toString());
                    }
                    byte readByte2 = dataInputStream4.readByte();
                    d9.n(3);
                    d9.n(readByte2 == r62 ? 16 : 8);
                                                    ...
                                                    switch (c12) {
                                                        ...
                                                        case 1:
                                                            try {
                                                                ...
                                                                BitmapFactory.decodeByteArray(bArr2, 0, i11, options);
                                                                int i12 = options.outWidth;
                                                                if (i12 <= 800) {
                                                                    if (options.outHeight > 800) {
                                                                    }
                                                                    options.inJustDecodeBounds = false;
                                                                    decodeByteArray = BitmapFactory.decodeByteArray(bArr2, 0, i11, options);
                                                                ...
                                                                for (int max2 = Math.max(i12, options.outHeight); max2 > 800; max2 /= 2) {
                                                        ...
                                                        case 5:
                                                            ...
                                                            if (str5 == null || str5.trim().length() == 0) {
                                                                if (k11.i() == 2) {
                                                                    int a2 = ta.b.a(dataInputStream5.readShort() - r62);
                                                                    if (a2 != 0) {
                                                                        this.h = ta.b.b(a2);
                                                                    }
                                                                } else {
                                                        ...
                                                        case 14:
                                                            ...
                                                            if (trim2.length() >= i9) {
                                                                try {
                                                                    this.g = Short.valueOf(trim2.substring(0, i9)).shortValue();
