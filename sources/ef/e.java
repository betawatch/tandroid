...
public final class e implements df.c, df.b {
    ...
    public final void g() {
        ...
        final int i10 = 0;
        this.d = new g(measuredWidth, measuredHeight, new Utilities.Callback() { // from class: ef.d
        ...
        final int i11 = 1;
        this.e = new g(measuredWidth, measuredHeight, new Utilities.Callback() { // from class: ef.d
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                switch (i11) {
                    case 0:
