...
public abstract class b {
    ...
    public static long a() {
        ...
        try {
            ...
            datagramSocket.setSoTimeout(MediaDataController.MAX_STYLE_RUNS_COUNT);
            c();
            ...
            while (i10 < length) {
                ...
                try {
                    ...
                    long e7 = e(32, bArr3);
                    long e10 = e(40, bArr3);
                    b((byte) ((b11 >> 6) & 3), (byte) (b11 & 7), i12, e10);
    ...
    public static void b(byte b10, byte b11, int i10, long j3) {
        ...
        if (b11 != 4 && b11 != 5) {
            throw new IOException(k0.i(b11, "SNTP: Untrusted mode: "));
        }
        if (i10 == 0 || i10 > 15) {
            throw new IOException(k0.i(i10, "SNTP: Untrusted stratum: "));
        }
        if (j3 == 0) {
