    ...
    */
    private final Object a() {
        ...
        if (!bVar.r) {
            ...
            d0Var.a(hVar2, new r(vVar2, vVar2));
            return null;
        }
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList();
        String str = ((q) ((com.google.android.gms.internal.play_billing.r) cVar2.b).get(0)).b;
        com.google.android.gms.internal.play_billing.r rVar = (com.google.android.gms.internal.play_billing.r) cVar2.b;
        int size = rVar.size();
        int i13 = 0;
        while (true) {
            if (i13 >= size) {
            ...
            try {
                ...
                try {
                    ...
                    if (a12.containsKey("DETAILS_LIST")) {
                        ...
                        kVar = a2 != 0 ? bVar.s(b0.a(a2, f10), 23, k0.j(a2, "getSkuDetails() failed for queryProductDetailsAsync. Response code: "), null) : bVar.s(b0.a(6, f10), 45, "getSkuDetails() returned a bundle with neither an error nor a product detail list for queryProductDetailsAsync.", null);
                    }
                } catch (DeadObjectException e10) {
                    e = e10;
                    kVar = bVar.s(b0.h, i10, "queryProductDetailsAsync got a remote exception (try to reconnect).", e);
                    d0Var.a(b0.a(kVar.a, (String) kVar.d), new r((ArrayList) kVar.b, (ArrayList) kVar.c));
                    return null;
                } catch (Exception e11) {
                    e = e11;
                        ...
                        try {
                            if (cVar == null) {
                                ...
                                try {
                                    ...
                                    e = e6;
                                    exc = e;
                                    bVar.g(iVar, str2, b0.f, 29, "Error consuming purchase!", exc);
                                    return null;
                                }
                            }
                            if (bVar.n) {
