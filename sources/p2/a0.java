    ...
    public final synchronized void b(Context context, IntentFilter intentFilter) {
        ...
        try {
            try {
                ...
                if (Build.VERSION.SDK_INT >= 33) {
                    a0Var = this;
                    context.registerReceiver(a0Var, intentFilter, "com.google.android.finsky.permission.PLAY_BILLING_LIBRARY_BROADCAST", null, true != this.b ? 4 : 2);
                } else {
                    a0Var = this;
    ...
    public final void c(Bundle bundle, g gVar, int i10, l3 l3Var, long j10, boolean z10) {
        ...
        try {
            if (bundle.getByteArray("FAILURE_LOGGING_PAYLOAD") == null) {
                ((oc.i) ((y) this.c.d)).o2(x.b(23, i10, gVar, null, l3Var), j10, z10);
                return;
            }
            y yVar = (y) this.c.d;
    ...
    */
    public final void onReceive(Context context, Intent intent) {
        ...
        if (extras == null) {
            ...
            y yVar = (y) fVar.d;
            g gVar2 = z.f;
            ((oc.i) yVar).k2(x.b(11, i10, gVar2, null, l3Var));
            n nVar = (n) fVar.c;
            if (nVar != null) {
        ...
        if (!l3Var.equals(l3Var3) && !l3Var.equals(l3Var2)) {
            if (l3Var.equals(l3Var4)) {
                if (e10.a != 0) {
                    c(extras, e10, i10, l3Var, j11, z10);
                    n nVar2 = (n) fVar.c;
                ...
                y yVar2 = (y) fVar.d;
                g gVar3 = z.f;
                ((oc.i) yVar2).o2(x.b(77, i10, gVar3, null, l3Var), j11, z10);
                n nVar3 = (n) fVar.c;
