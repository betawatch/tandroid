    ...
    public final void c(Bundle bundle, h hVar, int i10, m3 m3Var, long j10, boolean z4) {
        ...
        try {
            if (bundle.getByteArray("FAILURE_LOGGING_PAYLOAD") == null) {
                ((qa) ((a0) this.c.d)).T0(z.b(23, i10, hVar, null, m3Var), j10, z4);
                return;
            }
            ...
            ((qa) a0Var).T0(g3.n(byteArray, d), j10, z4);
    ...
    */
    public final void onReceive(Context context, Intent intent) {
        ...
        if (extras == null) {
            ...
            a0 a0Var = (a0) fVar.d;
            h hVar2 = b0.f;
            ((qa) a0Var).O0(z.b(11, i10, hVar2, null, m3Var));
            p pVar = (p) fVar.c;
            if (pVar != null) {
        ...
        if (!m3Var.equals(m3Var3) && !m3Var.equals(m3Var2)) {
            if (m3Var.equals(m3Var4)) {
                ...
                a0 a0Var2 = (a0) fVar.d;
                h hVar3 = b0.f;
                ((qa) a0Var2).T0(z.b(77, i10, hVar3, null, m3Var), j11, z4);
                p pVar4 = (p) fVar.c;
