...
public final class e implements s9.e, g {
    ...
    public e(Writer writer, Map map, Map map2, s9.d dVar, boolean z10) {
    ...
    public final e h(Object obj) {
        ...
        if (!obj.getClass().isArray()) {
            ...
            if (obj instanceof Map) {
                ...
                for (Map.Entry entry : ((Map) obj).entrySet()) {
                    ...
                    try {
                        ...
                        throw new s9.b(String.format("Only String keys are currently supported in maps, got %s of type %s instead.", key, key.getClass()), e10);
                    }
                }
                jsonWriter.endObject();
                return this;
            }
            s9.d dVar = (s9.d) this.c.get(obj.getClass());
            if (dVar != null) {
                jsonWriter.beginObject();
                dVar.a(obj, this);
                jsonWriter.endObject();
            ...
            s9.f fVar = (s9.f) this.d.get(obj.getClass());
            if (fVar != null) {
                fVar.a(obj, this);
                return this;
            }
