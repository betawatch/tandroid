                ...
                if (iArr2[c10] != 0) {
                    ...
                    if (iArr2[1] != 0) {
                        ...
                        if (iArr2[0] != 0) {
                            ...
                            if (Math.abs(f13 - iArr2[0]) >= f14 || Math.abs(f13 - iArr2[1]) >= f14 || Math.abs((f13 * 3.0f) - iArr2[c10]) >= 3.0f * f14 || Math.abs(f13 - iArr2[c11]) >= f14 || Math.abs(f13 - iArr2[4]) >= f14) {
                                return false;
                            }
                            float f15 = i15 / 7.0f;
                            int i45 = 0;
                            while (true) {
                                ...
                                if (i45 >= arrayList.size()) {
                                    arrayList.add(new c(f12, f7, f15, 1));
                                    return true;
                                }
                            ...
                            float f17 = i46;
                            float f18 = i47;
                            arrayList.set(i45, new c(((f10 * f17) + f12) / f18, e2.y(f17, f11, f7, f18), e2.y(f17, cVar.c, f15, f18), i47));
                            return true;
                        }
                    }
                }
