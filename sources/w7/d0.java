...
public abstract class d0 {
    public static void A(Parcel parcel, int i10, int i11) {
        ...
        throw new androidx.car.app.j(a4.a.t(hg.c.m("Expected size ", i11, " got ", i10, " (0x"), Integer.toHexString(i10), ")"), parcel);
    }
    ...
    public static void B(Parcel parcel, int i10, int i11) {
        ...
        throw new androidx.car.app.j(a4.a.t(hg.c.m("Expected size ", i11, " got ", x10, " (0x"), Integer.toHexString(x10), ")"), parcel);
    }
    ...
    public static void m(Parcel parcel, int i10) {
        if (parcel.dataPosition() != i10) {
            throw new androidx.car.app.j(hg.c.i(i10, "Overread allowed size end="), parcel);
        }
    }
