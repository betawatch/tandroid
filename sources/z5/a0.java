...
public final class a0 extends v0 {
    ...
    public final void handleMessage(Message message) {
        ...
        if (i12 == 3) {
            ...
            w5.a aVar3 = new w5.a(message.arg2, obj instanceof PendingIntent ? (PendingIntent) obj : null);
            this.a.A.a(aVar3);
            this.a.z(aVar3);
            return;
        }
        ...
        if (bool != null) {
            ...
            if (i14 != 0) {
                ...
                wVar4.a(new w5.a(i14, bundle != null ? (PendingIntent) bundle.getParcelable("pendingIntent") : null));
            } else if (!wVar4.b()) {
                gVar5.F(1, null);
                wVar4.a(new w5.a(8, null));
            }
        }
        synchronized (wVar4) {
            wVar4.b = true;
