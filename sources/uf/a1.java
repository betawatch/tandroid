    ...
    public a1(Context context, f6 f6Var) {
        ...
        for (int i11 = 7; i10 < i11; i11 = 7) {
            if (i10 == 0) {
                ...
                h51Var.addView(this.h[i10], b6.i(-2.0f, -2.0f, 8388659, 0.0f, 33.0f, 0.0f, 10.0f));
                ...
                aqVar.setGravity(LocaleController.isRTL ? 3 : 5);
    ...
    public final void b(TL_account.TL_businessWorkHours tL_businessWorkHours, boolean z4, boolean z10, boolean z11) {
        ...
        if (!tL_businessWorkHours.weekly_open.isEmpty()) {
            ...
            if (z13) {
                ...
                textViewArr3[1].animate().alpha((z17 || !z18) ? 0.0f : 1.0f).setDuration(320L).setInterpolator(mrVar).start();
                textViewArr[0][0].animate().alpha(z17 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(mrVar).start();
                textViewArr[0][1].animate().alpha(z17 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(mrVar).start();
                imageView.animate().rotation(z17 ? 180.0f : 0.0f).setDuration(320L).setInterpolator(mrVar).start();
            } else {
                    ...
                    if (i26 < textViewArr4.length) {
                        if (i11 != 0 || z17) {
                            if ((i26 == i22) == z18) {
                                f11 = 1.0f;
                                if (this.y) {
                                    textViewArr4[i26].animate().alpha(f11).setDuration(320L).setInterpolator(mr.h).start();
                                } else {
            ...
            aqVar.c(LocaleController.getString(!z18 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
            this.y = false;
            ...
            Collections.sort(arrayList2, new eu(22));
            ...
            f10 = 6.0f;
            layoutParams.topMargin = AndroidUtilities.dp((this.w <= 2 || aqVar.getVisibility() == 0) ? 6.0f : 12.0f);
            if (this.w <= 2 && aqVar.getVisibility() != 0) {
                f10 = 12.0f;
            }
            layoutParams.bottomMargin = AndroidUtilities.dp(f10);
            layoutParams.gravity = ((this.w <= 2 || aqVar.getVisibility() == 0) ? 16 : 80) | (!LocaleController.isRTL ? 3 : 5);
        ...
        aqVar2.c(LocaleController.getString(!z18 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
        this.y = false;
        ...
        f10 = 6.0f;
        layoutParams2.topMargin = AndroidUtilities.dp((this.w <= 2 || aqVar2.getVisibility() == 0) ? 6.0f : 12.0f);
        if (this.w <= 2) {
            f10 = 12.0f;
        }
        layoutParams2.bottomMargin = AndroidUtilities.dp(f10);
        layoutParams2.gravity = ((this.w <= 2 || aqVar2.getVisibility() == 0) ? 16 : 80) | (!LocaleController.isRTL ? 3 : 5);
        if (i14 == this.w) {
        }
        requestLayout();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!this.C) {
            ...
            if (i12 > 2 || aqVar.getVisibility() == 0) {
                dp = AndroidUtilities.dp(aqVar.getVisibility() == 0 ? 21.0f : 0.0f) + AndroidUtilities.dp(15.0f) + this.x;
            } else {
                dp = 0;
            }
