...
public final class k extends b61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void Z(k kVar) {
        ...
        if (iVar != null && iVar.isAttachedToWindow() && kVar.w) {
            ...
            iVar2.n.getImageReceiver().setDelegate(new bo(iVar2, gVar));
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(greetingsSticker, j6.lc, 1.0f);
            if (svgThumb != null) {
                iVar2.n.n(ImageLocation.getForDocument(greetingsSticker), eo.b(greetingsSticker), svgThumb, greetingsSticker);
            } else {
                iVar2.n.j(ImageLocation.getForDocument(greetingsSticker), eo.b(greetingsSticker), ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(greetingsSticker.thumbs, 90), greetingsSticker), null, 0, greetingsSticker);
            }
            iVar2.n.setOnClickListener(new ao(iVar2, greetingsSticker, 1));
        }
    }
