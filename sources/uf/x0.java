...
public final class x0 extends FrameLayout {
    ...
    public x0(Context context, g6 g6Var) {
        ...
        while (i10 < 2) {
            ...
            addView(this.d[i10], c6.d(-1, -2.0f, 48, 76.0f, 26.33f, 40.0f, 0.0f));
            i10++;
        }
    ...
    public final boolean a(f6 f6Var) {
        ...
        if (isEmpty) {
            ...
            textViewArr[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagStoriesFoundChannel", f6Var.J, "@" + str), k6.v0(k6.Oh, this.a), null));
        }
    ...
    public final void b(int i10, String str, String str2) {
        ...
        if (isEmpty) {
            ...
            textViewArr[1].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagMessagesFoundChannel", i10, yh.k("@", str2)), k6.v0(k6.Oh, this.a), null));
        }
