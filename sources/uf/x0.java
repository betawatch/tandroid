...
public final class x0 extends p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static ArrayList[] Z(ArrayList arrayList) {
        ...
        while (i15 < 7) {
            ...
            if (i19 >= i18) {
                int i21 = (i15 + 6) % 7;
                if (!arrayListArr[i21].isEmpty() && ((w0) a2.i(1, arrayListArr[i21])).b >= 1440) {
                    ((w0) a2.i(1, arrayListArr[i21])).b = 1439;
                }
    ...
    public final void X(int i10) {
        if ((this.h[i10].isEmpty() ? null : (w0) a2.i(1, this.h[i10])) == null) {
            return;
        }
        int i11 = (i10 + 6) % 7;
        w0 w0Var = this.h[i11].isEmpty() ? null : (w0) a2.i(1, this.h[i11]);
