...
public final class u0 extends p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void Y() {
        y3 y3Var;
        t0 t0Var = this.n;
        if (t0Var == null || (y3Var = this.s) == null) {
            return;
        }
        if (this.x == null) {
        ...
        y3 y3Var2 = this.s;
        TLRPC.GeoPoint geoPoint = this.x;
        y3Var2.n(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(geoPoint.lat, geoPoint._long, 0L, min * i10, min * 240, 15, min)), android.support.v4.media.a.l(i10, "_240"), this.r, null);
    }
    ...
    public final View createView(Context context) {
        ...
        this.b = new mr(mutate, new rp(j6.w0(null, i10, false)));
        ...
        r0 r0Var2 = this.f;
        int i12 = j6.G6;
        r0Var2.setTextColor(j6.w0(null, i12, false));
        ...
        this.f.addTextChangedListener(new dh.c(this, 19));
        this.f.setFilters(new InputFilter[]{new s0()});
        ...
        if (r0Var3 != null) {
            this.d = true;
            r0Var3.setText(this.y);
            r0 r0Var4 = this.f;
            r0Var4.setSelection(r0Var4.getText().length());
            this.d = false;
        }
        ...
        this.r = cqVar;
        cqVar.setCallback(this.s);
        this.s.setBackgroundColor(getThemedColor(i13));
        this.n = new t0(this, context);
        FrameLayout frameLayout4 = new FrameLayout(context);
        this.h = frameLayout4;
        frameLayout4.addView(this.s, b6.c(-1.0f, -1));
        this.h.addView(this.n, b6.d(-2, -2.0f, 17, 0.0f, -31.0f, 0.0f, 0.0f));
        Y();
        g61 g61Var = new g61(this, new d4(this, 21), new p0(this, i11), null);
        this.a = g61Var;
        g61Var.p1();
        g61 g61Var2 = this.a;
        g61Var2.V2.r = false;
