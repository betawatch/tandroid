...
public final class l0 extends p2 {
    ...
    public static void W(final l0 l0Var, i51 i51Var, final View view) {
        if (i51Var.g && !l0Var.v.h(i51Var)) {
            int i10 = i51Var.d;
            if (i10 == R) {
                v vVar = l0Var.v;
                l0Var.F = true;
            ...
            if (i51Var.a == 13) {
                TLRPC.User user = (TLRPC.User) l0Var.K.get(i51Var.x);
                if (user == null) {
                    return;
                }
            ...
            if (i10 == e0) {
                final int i12 = 5;
                l0Var.X(i10, !l0Var.G.edit_username, new Runnable(l0Var) { // from class: uf.g0
            ...
            if (i10 == g0) {
                final int i13 = 0;
                l0Var.X(i10, !l0Var.G.view_gifts, new Runnable(l0Var) { // from class: uf.g0
                    public final /* synthetic */ l0 b;
            ...
            if (i10 == h0) {
                final int i14 = 1;
                l0Var.X(i10, !l0Var.G.sell_gifts, new Runnable(l0Var) { // from class: uf.g0
                    public final /* synthetic */ l0 b;
            ...
            if (i10 == i0) {
                final int i15 = 2;
                l0Var.X(i10, !l0Var.G.change_gift_settings, new Runnable(l0Var) { // from class: uf.g0
                    public final /* synthetic */ l0 b;
            ...
            if (i10 == j0) {
                final int i16 = 3;
                l0Var.X(i10, !l0Var.G.transfer_and_upgrade_gifts, new Runnable(l0Var) { // from class: uf.g0
                    public final /* synthetic */ l0 b;
                ...
                final int i17 = 4;
                l0Var.X(i10, !l0Var.G.transfer_stars, new Runnable(l0Var) { // from class: uf.g0
                    public final /* synthetic */ l0 b;
    ...
    public final void X(int i10, boolean z4, final Runnable runnable) {
        ...
        if (!this.H && i10 == e0 && z4) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Allow), new c2(this) { // from class: uf.k0
                public final /* synthetic */ l0 b;
                ...
                public final void l(d2 d2Var2, int i13) {
                    switch (i12) {
                        case 0:
                            this.b.H = true;
                            runnable.run();
        ...
        alertDialog$Builder2.k(LocaleController.getString(R.string.Allow), new c2(this) { // from class: uf.k0
            public final /* synthetic */ l0 b;
            ...
            @Override // org.telegram.ui.ActionBar.c2
            public final void l(d2 d2Var22, int i13) {
                switch (i11) {
                    case 0:
                        this.b.H = true;
                        runnable.run();
    ...
    public final void b0() {
        ...
        if (z4 != (e || this.x || longSparseArray.size() > 0)) {
            ...
            this.s.animate().alpha(z10 ? 1.0f : 0.0f).translationY(z10 ? 0.0f : AndroidUtilities.dp(8.0f)).setDuration(320L).setInterpolator(mrVar).start();
        }
    }
