    ...
    */
    public final void i(Runnable runnable, boolean z4) {
        ...
        if (z4) {
            ...
            messagesStorage.getStorageQueue().postRunnable(new di(this, messagesStorage, UserConfig.getInstance(i12).getClientUserId(), runnable, 12));
            return;
        }
        ...
        loop0: while (true) {
            ...
            if (i14 >= arrayList.size()) {
                ConnectionsManager.getInstance(i12).sendRequest(tL_messages_getQuickReplies, new ff.a(this, 27));
                return;
            }
