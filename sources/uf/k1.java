        ...
        if (z4) {
            if (str.length() <= 0) {
                ...
                while (i13 < arrayList6.size()) {
                    ...
                    atomicInteger2.set(ConnectionsManager.getInstance(i12).sendRequest(tLObject, new RequestDelegate() { // from class: uf.e1
                        ...
                        public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: uf.f1
                                            ...
                                            if (j1Var != null) {
                                                ...
                                                if (K != null) {
                                                    ...
                                                    for (int i20 = 0; i20 < m9; i20++) {
                                                        TLRPC.User user2 = (TLRPC.User) hVar4.f(K.j(i20));
                                                        if (user2 != null) {
                                                ...
                                                if (y10 != null) {
                                                    ...
                                                    for (int i21 = 0; i21 < m10; i21++) {
                                                        TLRPC.User user3 = (TLRPC.User) hVar4.f(y10.j(i21));
                                                        if (user3 != null) {
            ...
            arrayList6.add(new Pair(tL_contacts_search, new RequestDelegate() { // from class: uf.d1
                ...
                */
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    ...
                    a0.h hVar7 = k1Var.f;
                    if (k1Var.a.R(i11) && tL_error == null) {
