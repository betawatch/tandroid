    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 4:
                ...
                boolean z4 = false;
                vh.q a2 = vh.q.a(strArr[0], AndroidUtilities.dp(26.0f), false);
                if (a2 == null) {
                    a2 = vh.q.a(LocaleController.getString(R.string.ArticleLatexError), AndroidUtilities.dp(26.0f), false);
                    z4 = true;
                }
                AndroidUtilities.runOnUIThread(new vq0(callback2, a2 != null ? a2.a : null, z4, 12));
                return;
            case 5:
                vh.v vVar = (vh.v) this.b;
            ...
            case 6:
                ...
                AndroidUtilities.runOnUIThread(new v0(7, r3Var, str));
                return;
            case 7:
            ...
            case 8:
                ...
                if (m9 instanceof v5) {
                    v5 v5Var = (v5) m9;
                    v5Var.B();
                    vh.d1 editText = v5Var.getEditText();
                    int length = editText.length();
                    editText.setSelection(Math.max(0, Math.min(i15, length)), Math.max(0, Math.min(i14, length)));
                    return;
                }
                if (!(m9 instanceof i5)) {
                    if (m9 instanceof vh.i0) {
                        vh.d1 captionEditText = ((vh.i0) m9).getCaptionEditText();
                        captionEditText.r();
