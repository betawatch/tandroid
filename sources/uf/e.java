...
public final class e extends FrameLayout {
    ...
    public e(Context context) {
        ...
        final int i10 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: uf.c
        ...
        final int i11 = 1;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: uf.c
            public final /* synthetic */ e b;
        ...
        final int i12 = 2;
        imageView3.setOnClickListener(new View.OnClickListener(this) { // from class: uf.c
            public final /* synthetic */ e b;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 2) {
                float max = Math.max(-45.0f, Math.min(45.0f, this.n + ((float) ((((this.s - x8) / AndroidUtilities.density) / 3.141592653589793d) / 1.649999976158142d))));
