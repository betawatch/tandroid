...
public final class l1 extends FrameLayout {
    ...
    public l1(Context context, f6 f6Var, boolean z4) {
        ...
        sVar.setTextColor(j6.v0(j6.z6, f6Var));
        sVar.setTextSize(1, 14.0f);
        boolean z10 = LocaleController.isRTL;
        addView(sVar, b6.d(-1, -2.0f, 7, z10 ? i10 : 64.0f, 7.0f, z10 ? 64.0f : i10, 0.0f));
        if (z4) {
            ...
            addView(imageView, b6.e(50, 50, (LocaleController.isRTL ? 3 : 5) | 112));
        } else {
            this.e = null;
        }
        kp kpVar = new kp(getContext(), 21, f6Var);
        this.d = kpVar;
        kpVar.b(-1, j6.d6, j6.k7);
