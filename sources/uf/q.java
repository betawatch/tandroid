...
public final class q extends b61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void b0(Activity activity, int i10, TL_account.TL_businessChatLink tL_businessChatLink, f6 f6Var) {
        ...
        LinearLayout h = a2.h(activity, 1);
        ...
        g2Var.h(LocaleController.getString(R.string.Cancel), new s0.b(12));
        if (z4) {
            d = d2Var;
            d2VarArr[0] = d2Var;
    ...
    public final void U(ArrayList arrayList, w51 w51Var) {
        ...
        while (i11 < size2) {
            ...
            if (indexOf > -1) {
                h4 h4Var = new h4(v2.e("https://", str), (s01) null);
                h4Var.f = this;
    ...
    public final boolean X(i51 i51Var, View view) {
        if (i51Var.a == 29) {
            ...
            if (obj instanceof p) {
                ...
                H.c(R.drawable.msg_copy, LocaleController.getString(R.string.Copy), new ga(tL_businessChatLink, 17), false);
                final int i10 = 0;
