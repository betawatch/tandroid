...
public final class r1 extends p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void V(r1 r1Var, ArrayList arrayList, w51 w51Var) {
        ...
        if (!z4) {
            ...
            w51Var.T();
            arrayList.add(i51.B(LocaleController.formatString(R.string.TimezoneDetectAutomaticallyInfo, b10.d(r1Var.n, true))));
        }
        w51Var.U();
        if (!z4) {
        ...
        while (true) {
            ...
            i51Var2.l = e;
            i51Var2.n = f10;
            i51Var2.K(TextUtils.equals(tL_timezone.id, r1Var.n));
            i51Var2.g = !r1Var.h || z4;
    ...
    public final View createView(Context context) {
        ...
        g61 g61Var = new g61(this, new d4(this, 24), new rh.e(this, 7), null);
        this.a = g61Var;
        g61Var.p1();
        this.actionBar.setAdaptiveBackground(this.a);
        frameLayout.addView(this.a, b6.c(-1.0f, -1));
        this.a.setOnScrollListener(new lb0(this, 21));
        ...
        this.b.addView(p9Var, b6.t(130, 130, 49, 0, 42, 0, 12));
        TextView textView = new TextView(context);
        textView.setText(LocaleController.getString(R.string.TimezoneNotFound));
        org.telegram.ui.b.l(j6.y6, this.resourceProvider, textView, 1, 15.0f);
        this.b.addView(textView, b6.t(-2, -2, 49, 0, 0, 0, 0));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        g61 g61Var;
        w51 w51Var;
        if (i10 != NotificationCenter.timezonesUpdated || (g61Var = this.a) == null || (w51Var = g61Var.V2) == null) {
            return;
        }
        w51Var.N(true);
    }
