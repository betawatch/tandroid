    ...
    */
    ...
    public static List e(Object obj, String str) {
        ...
        if (!(obj instanceof List)) {
            if ("".equals(obj)) {
                throw new fc.d(yh.l("You cannot set '", str, "' to an empty string. We interpret empty strings as null in requests. You may set '", str, "' to null to delete the property."), null, null);
            }
            if (obj == null) {
                LinkedList linkedList = new LinkedList();
        ...
        while (it.hasNext()) {
            linkedList3.addAll(e(it.next(), e6));
        }
        return linkedList3;
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static e0 f(HashMap hashMap, a aVar) {
        String next;
        ...
        try {
            ...
            throw new fc.d("Unable to encode parameters to UTF-8. Please contact support@stripe.com for assistance.", null, e11);
        }
    }
