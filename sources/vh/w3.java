...
public final class w3 extends FrameLayout {
    ...
    public w3(Context context, final l lVar) {
        ...
        int i12 = j6.i6;
        imageView.setBackground(new x1(j6.Z(v02, j6.v(v03, j6.v0(i12, f6Var)), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f))));
        int i13 = j6.G6;
        ...
        linearLayout.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), j6.v0(i11, f6Var))));
        ...
        final int i14 = 7;
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            ...
            public final void onClick(View view3) {
                switch (i14) {
                    ...
                    case 9:
                        ...
                        new w(qVar3.n, context2, new org.telegram.ui.web.a1(lVar2, 24), qVar3.a).show();
                        break;
                    case 10:
                        q.K(lVar.a);
                        break;
        ...
        final int i15 = 8;
        imageView3.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i15) {
                    case 0:
        ...
        imageView4.setBackground(new x1(j6.Z(j6.v0(i11, f6Var), j6.v(j6.v0(i11, f6Var), j6.v0(i12, f6Var)), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f))));
        linearLayout2.addView(imageView4, b6.p(44, 44, 0.0f, 19, 0, 0, 8, 0));
        d6.a(imageView4);
        imageView4.setContentDescription("AI");
        final int i16 = 9;
        imageView4.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i16) {
                    case 0:
        ...
        frameLayout5.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), j6.v0(i10, f6Var))));
        ...
        qgVar.setColorFilter(new PorterDuffColorFilter(j6.v0(i13, f6Var), mode));
        qgVar.setBackground(j6.Z(j6.v0(i10, f6Var), j6.v0(i12, f6Var), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f)));
        qgVar.j(og.e, false);
        linearLayout3.addView(qgVar, b6.q(38, 38, 16));
        d6.a(qgVar);
        qgVar.setContentDescription("Emoji");
        final int i17 = 10;
        qgVar.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i17) {
                    case 0:
        ...
        final int i18 = 11;
        imageView5.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i18) {
                    case 0:
        ...
        jj0Var.setColorFilter(new PorterDuffColorFilter(j6.v0(i13, f6Var), mode));
        jj0Var.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), j6.v0(i11, f6Var))));
        frameLayout6.addView(jj0Var, b6.e(-1, -1, 119));
        FrameLayout frameLayout7 = new FrameLayout(context);
        frameLayout7.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), j6.v0(i11, f6Var))));
        ...
        final int i19 = 0;
        u1Var.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i19) {
                    case 0:
        ...
        linearLayout4.addView(u1Var, b6.t(38, 38, 16, linearLayout4.getChildCount() == 0 ? 0 : 2, 0, 0, 0));
        ...
        final int i20 = 1;
        u1Var2.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i20) {
                    case 0:
        ...
        linearLayout4.addView(u1Var2, b6.t(38, 38, 16, linearLayout4.getChildCount() == 0 ? 0 : 2, 0, 0, 0));
        LinearLayout linearLayout5 = new LinearLayout(context);
        this.J = linearLayout5;
        linearLayout5.setOrientation(0);
        linearLayout5.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        linearLayout5.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), j6.v0(i11, f6Var))));
        ...
        final int i21 = 2;
        u1Var3.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i21) {
                    case 0:
        ...
        final int i22 = 3;
        u1Var4.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i22) {
                    case 0:
        ...
        linearLayout6.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), j6.v0(i11, f6Var))));
        ...
        final int i23 = 4;
        u1Var5.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i23) {
                    case 0:
        ...
        linearLayout7.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), j6.v0(i11, f6Var))));
        ...
        final int i24 = 5;
        u1Var6.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i24) {
                    case 0:
        ...
        final int i25 = 6;
        pp0Var.setOnClickListener(new View.OnClickListener() { // from class: vh.t3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i25) {
                    case 0:
    ...
    public final void e(boolean z4, boolean z10) {
        ...
        jj0Var.setColorFilter(new PorterDuffColorFilter(j6.v0(z4 ? j6.q7 : j6.G6, this.b), PorterDuff.Mode.SRC_IN));
        gj0 animatedDrawable = jj0Var.getAnimatedDrawable();
        if (animatedDrawable != null) {
            if (z4) {
    ...
    public final void f(int i10, boolean z4) {
        ...
        if (z4) {
            ...
            mr mrVar = mr.h;
            final int i11 = 0;
            duration.setInterpolator(mrVar).withEndAction(new Runnable(this) { // from class: vh.u3
            ...
            final int i12 = 1;
            pb1Var.animate().alpha(i10 == 1 ? 1.0f : 0.0f).scaleX(i10 == 1 ? 1.0f : 0.8f).scaleY(i10 == 1 ? 1.0f : 0.8f).translationY(i10 == 1 ? 0.0f : AndroidUtilities.dp(30.0f)).setDuration(420L).setInterpolator(mrVar).withEndAction(new Runnable(this) { // from class: vh.u3
                public final /* synthetic */ w3 b;
            ...
            final int i13 = 2;
            scaleX.scaleY(i10 == 2 ? 1.0f : 0.8f).setDuration(420L).setInterpolator(mrVar).withEndAction(new Runnable(this) { // from class: vh.u3
                public final /* synthetic */ w3 b;
        ...
        pb1Var.setVisibility(i10 == 1 ? 0 : 8);
        pb1Var.setAlpha(i10 == 1 ? 1.0f : 0.0f);
        pb1Var.setScaleX(i10 == 1 ? 1.0f : 0.8f);
        pb1Var.setScaleY(i10 == 1 ? 1.0f : 0.8f);
        pb1Var.setTranslationY(i10 == 1 ? 0.0f : AndroidUtilities.dp(30.0f));
    ...
    public void setSendEnabled(boolean z4) {
        ...
        pp0Var.animate().alpha(z4 ? 1.0f : 0.5f).setDuration(150L).start();
    }
