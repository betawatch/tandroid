    ...
    public final void onClick(View view) {
        ...
        switch (this.a) {
            ...
            case 6:
                ...
                H.Q = true;
                a P2 = y1Var3.M.P2();
                H.j(P2 == null || !P2.b(), R.drawable.field_carret_empty, null, LocaleController.getString(R.string.ArticleNone), new j1(y1Var3, P2, 5));
                H.j((P2 == null || !P2.b() || P2.a() || P2.c()) ? false : true, R.drawable.iv_list, null, LocaleController.getString(R.string.ArticleListBulletedList), new j1(y1Var3, P2, 6));
                H.j(P2 != null && P2.b() && !P2.a() && P2.c(), R.drawable.iv_ordered_list, null, LocaleController.getString(R.string.ArticleListNumberedList), new j1(y1Var3, P2, 7));
                H.j(P2 != null && P2.b() && P2.a() && !P2.c(), R.drawable.iv_todo, null, LocaleController.getString(R.string.ArticleListChecklist), new j1(y1Var3, P2, 8));
                ...
                H.j(z4, i10, null, string, new b(s3Var, 1));
                ...
                if (l22 || o22) {
                    ...
                    if (l22) {
                        final int i11 = 0;
                        H.c(R.drawable.iv_list_tab, LocaleController.getString(R.string.ArticleIndent), new Runnable() { // from class: vh.m1
                    ...
                    if (o22) {
                        final int i12 = 1;
                        H.c(R.drawable.iv_list_untab, LocaleController.getString(R.string.ArticleOutdent), new Runnable() { // from class: vh.m1
                            @Override // java.lang.Runnable
                            public final void run() {
                                switch (i12) {
                                    case 0:
            ...
            case 8:
                ...
                q.U(y1Var5.getParentActivity(), (pageblockmath == null || TextUtils.isEmpty(pageblockmath.source)) ? "" : pageblockmath.source, new ph.s1(20, y1Var5, pageblockmath), y1Var5.getResourceProvider());
                break;
            case 9:
                y1 y1Var6 = this.b;
                y1Var6.M.Y3 = null;
