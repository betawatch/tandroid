...
public final class a6 {
    ...
    public a6(TL_iv.pageBlockTable pageblocktable) {
    ...
    public static void d(TL_iv.pageTableCell pagetablecell, CharSequence charSequence) {
        pagetablecell.text = y5.f(charSequence);
        int i10 = pagetablecell.flags;
        int i11 = i10 | 128;
        pagetablecell.flags = i11;
        pagetablecell.flags = pagetablecell.colspan > 1 ? i10 | 130 : i11 & (-3);
    ...
    public static String g(TL_iv.pageTableCell pagetablecell) {
        ...
        return (pagetablecell == null || (richText = pagetablecell.text) == null) ? "" : y5.l(richText);
    }

    public static CharSequence h(TL_iv.pageTableCell pagetablecell) {
        TL_iv.RichText richText;
        return (pagetablecell == null || (richText = pagetablecell.text) == null) ? "" : y5.r(richText, null, true);
    }
    ...
    public static void k(TL_iv.pageTableCell pagetablecell, int i10) {
        ...
        pagetablecell.flags = z4 ? i11 | 8 : i11 & (-9);
        int i12 = pagetablecell.flags;
        pagetablecell.flags = z10 ? i12 | 16 : i12 & (-17);
    }
    ...
    public static void l(TL_iv.pageTableCell pagetablecell, boolean z4) {
        ...
        pagetablecell.flags = z4 ? pagetablecell.flags | 1 : pagetablecell.flags & (-2);
    }
    ...
    public static void m(TL_iv.pageTableCell pagetablecell, int i10) {
        ...
        int i11 = pagetablecell.flags;
        pagetablecell.flags = z4 ? i11 | 32 : i11 & (-33);
        int i12 = pagetablecell.flags;
        pagetablecell.flags = z10 ? i12 | 64 : i12 & (-65);
    }
    ...
    public final void j(final IdentityHashMap identityHashMap, int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            ...
            Collections.sort(arrayList, Comparator$-CC.comparingInt(new ToIntFunction() { // from class: vh.z5
        ...
        if (b10 >= 0 && a2 >= 0) {
            ...
            if (i10 > 1 || i11 > 1) {
                ...
                for (int i12 = b10; i12 < b10 + i10 && i12 < this.b; i12++) {
                    ...
                    Collections.sort(arrayList, Comparator$-CC.comparingInt(new kf.d(19)));
