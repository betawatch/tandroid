...
public final class y1 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean W(y1 y1Var, View view) {
        zn znVar = y1Var.G;
        if (znVar != null && y1Var.r == null && !znVar.c() && y1Var.M.j3() && !y1Var.M.l3()) {
            if (!y1Var.M.L3()) {
                y1Var.B0();
                return false;
            }
            ...
            if (!Y2.isEmpty()) {
                ...
                long a2 = y1Var.G.a();
                MessageObject messageObject = y1Var.G.k5;
                ...
                y1Var.v0.setScaleX(1.0f);
                y1Var.v0.setScaleY(1.0f);
                lg r10 = y1Var.L0.r(y1Var.v0, true, new g1(y1Var, 10));
                if (r10 != null) {
                ...
                p70 H = p70.H(y1Var, y1Var.v0);
                boolean isUserSelf = UserObject.isUserSelf(y1Var.G.i());
                if (y1Var.G.D6()) {
                    H.c(R.drawable.msg_calendar2, LocaleController.getString(isUserSelf ? R.string.SetReminder : R.string.ScheduleMessage), new d(y1Var, a2, 1), false);
                    if (!isUserSelf && a2 > 0) {
    ...
    public static /* synthetic */ void X(y1 y1Var, MessageObject messageObject, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, long j10, MessageObject messageObject2, MessageObject messageObject3, boolean z4, int i10, int i11, SendMessageChatArguments sendMessageChatArguments, long j11) {
    ...
    public static void Y(final y1 y1Var, Context context, View view) {
        p70 p70Var;
        boolean z4;
        p70 p70Var2 = y1Var.u0;
        if (p70Var2 != null) {
            p70Var2.u();
            y1Var.u0 = null;
        }
        boolean z10 = (MessagesController.getInstance(y1Var.currentAccount).richEditorAllowed() || UserConfig.getInstance(y1Var.currentAccount).isPremium()) ? false : true;
        ...
        J.k();
        final int i10 = 0;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading1), R.drawable.iv_h1, null, LocaleController.getString(R.string.ArticleHeading1), new Runnable(y1Var) { // from class: vh.k1
            ...
            public final void run() {
                switch (i10) {
                    case 0:
                        this.b.M.U4(P2, new TL_iv.pageBlockHeading1());
                        I.u();
                        break;
                    case 1:
                        this.b.M.U4(P2, new TL_iv.pageBlockHeading2());
                        I.u();
                        break;
                    case 2:
                        this.b.M.U4(P2, new TL_iv.pageBlockHeading3());
                        I.u();
                        break;
                    case 3:
                        this.b.M.U4(P2, new TL_iv.pageBlockHeading4());
                        I.u();
                        break;
                    case 4:
                        this.b.M.U4(P2, new TL_iv.pageBlockHeading5());
                        I.u();
                        break;
                    default:
                        this.b.M.U4(P2, new TL_iv.pageBlockHeading6());
                        I.u();
                        break;
                }
            }
        ...
        final int i11 = 1;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading2), R.drawable.iv_h2, null, LocaleController.getString(R.string.ArticleHeading2), new Runnable(y1Var) { // from class: vh.k1
            public final /* synthetic */ y1 b;
        ...
        final int i12 = 2;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading3), R.drawable.iv_h3, null, LocaleController.getString(R.string.ArticleHeading3), new Runnable(y1Var) { // from class: vh.k1
            public final /* synthetic */ y1 b;
        ...
        final int i13 = 3;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading4), R.drawable.iv_h4, null, LocaleController.getString(R.string.ArticleHeading4), new Runnable(y1Var) { // from class: vh.k1
            public final /* synthetic */ y1 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 1);
        final int i14 = 4;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading5), R.drawable.iv_h5, null, LocaleController.getString(R.string.ArticleHeading5), new Runnable(y1Var) { // from class: vh.k1
            public final /* synthetic */ y1 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 2);
        final int i15 = 5;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading6), R.drawable.iv_h6, null, LocaleController.getString(R.string.ArticleHeading6), new Runnable(y1Var) { // from class: vh.k1
            public final /* synthetic */ y1 b;
        ...
        int i16 = j6.G8;
        w1Var.d = i16;
        I.j(z4, 0, w1Var, LocaleController.getString(R.string.ArticleHeading), new kh.y2(I, p70Var, 11));
        ...
        I.j(P2 != null && (P2.b instanceof TL_iv.pageBlockParagraph), R.drawable.iv_text2, null, LocaleController.getString(R.string.ArticleText), new j1(y1Var, P2, 3));
        I.j(P2 != null && (P2.b instanceof TL_iv.pageBlockBlockquote), R.drawable.iv_quote, null, LocaleController.getString(R.string.ArticleQuote), new j1(y1Var, P2, 4));
        boolean z11 = P2 != null && (P2.b instanceof TL_iv.pageBlockPullquote);
        w1 w1Var2 = new w1(context, R.drawable.iv_pullquote);
        w1Var2.a(z10);
        w1Var2.d = i16;
        I.j(z11, 0, w1Var2, LocaleController.getString(R.string.ArticlePullquote), new j1(y1Var, P2, 0));
        I.y().setPadding(AndroidUtilities.dp(LocaleController.isRTL ? 18.0f : 9.0f), 0, AndroidUtilities.dp(LocaleController.isRTL ? 9.0f : 18.0f), 0);
        I.j(P2 != null && (P2.b instanceof TL_iv.pageBlockPreformatted), R.drawable.iv_code, null, LocaleController.getString(R.string.ArticleCode), new j1(y1Var, P2, 1));
        boolean z12 = P2 != null && (P2.b instanceof TL_iv.pageBlockFooter);
        w1 w1Var3 = new w1(context, R.drawable.iv_footer);
        w1Var3.a(z10);
        w1Var3.d = i16;
        I.j(z12, 0, w1Var3, LocaleController.getString(R.string.ArticleFooter), new j1(y1Var, P2, 2));
        I.y().setPadding(AndroidUtilities.dp(LocaleController.isRTL ? 18.0f : 9.0f), 0, AndroidUtilities.dp(LocaleController.isRTL ? 9.0f : 18.0f), 0);
        I.Z();
        y1Var.u0 = I;
    }
    ...
    public static void Z(y1 y1Var, boolean z4, boolean z10) {
        ...
        if (z10) {
            y1Var.t0.animate().scaleX(f10).scaleY(f10).setDuration(180L).setInterpolator(mr.h).start();
        } else {
            y1Var.t0.animate().cancel();
            y1Var.t0.setScaleX(f10);
            y1Var.t0.setScaleY(f10);
        }
        y1Var.t0.setColorFilter(new PorterDuffColorFilter(y1Var.getThemedColor(z4 ? j6.q7 : j6.G6), PorterDuff.Mode.SRC_IN));
        gj0 animatedDrawable = y1Var.t0.getAnimatedDrawable();
    ...
    public static e1 a0(y1 y1Var) {
        ...
        if (focusedEditTextOrNull == null) {
            e1 e1Var = y1Var.O0;
            return e1Var != null ? e1Var : y1Var.M.O2();
        }
    ...
    public static int b0(y1 y1Var, e1 e1Var) {
        return (e1Var != y1Var.O0 || y1Var.M.getFocusedEditTextOrNull() == e1Var) ? Math.max(0, e1Var.getSelectionEnd()) : Math.min(y1Var.P0, e1Var.length());
    }
    ...
    public static void p0(Context context, final Runnable runnable, final Runnable runnable2, f6 f6Var) {
        ...
        TextView i12 = ai.i(linearLayout, textView, b6.t(-1, -2, 49, 25, 16, 25, 0), context);
        ...
        linearLayout.addView(i12, b6.t(-1, -2, 49, 25, 11, 25, 0));
        ...
        o10.show();
        p10.setOnClickListener(new View.OnClickListener() { // from class: vh.i1
        ...
        final int i13 = 1;
        p11.setOnClickListener(new View.OnClickListener() { // from class: vh.i1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                switch (i13) {
                    case 0:
    ...
    public final void B0() {
        ...
        this.v0.setEnabled(L3);
        this.v0.animate().alpha(L3 ? 1.0f : 0.5f).setDuration(150L).start();
    }
    ...
    public final u1 c0(int i10, int i11, boolean z4) {
        ...
        linearLayout.addView(u1Var, b6.t(38, 38, 16, linearLayout.getChildCount() == 0 ? 0 : 2, 0, 0, 0));
        return u1Var;
    }
    ...
    public final View createView(Context context) {
        ...
        this.M = s3Var;
        s3Var.setFileRefParentObject(this.r);
        this.L.addView(this.M, b6.e(-1, -1, 119));
        this.L.addView(this.M.getOverlayView(), b6.c(-1.0f, -1));
        TL_iv.RichMessage richMessage = this.b;
        if (richMessage != null) {
            s3 s3Var2 = this.M;
            ArrayList arrayList2 = s3Var2.i3;
            s3Var2.h3 = richMessage;
            s3.V2(arrayList2, richMessage.blocks, s3Var2.j3);
            s3Var2.U3();
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                s3Var2.u4((a) arrayList2.get(i10));
            }
            s3Var2.V2.N(false);
        } else {
            String str = this.f;
            if (str != null) {
                ...
                HashMap hashMap = s3Var3.j3;
                ArrayList arrayList3 = s3Var3.i3;
        ...
        int i12 = j6.i6;
        imageView3.setBackground(new x1(j6.Z(themedColor, j6.v(themedColor2, getThemedColor(i12)), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f))));
        ...
        this.R.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        ...
        this.S.setBackground(j6.f0(getThemedColor(i12), 1, -1));
        ...
        this.T.setBackground(j6.f0(getThemedColor(i12), 1, -1));
        ...
        this.Z.setBackground(new x1(j6.Z(getThemedColor(i11), j6.v(getThemedColor(i11), getThemedColor(i12)), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f))));
        ...
        this.Y.setBackground(j6.Z(getThemedColor(i11), getThemedColor(i12), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f)));
        this.Y.j(og.e, false);
        this.b0.addView(this.Y, b6.q(38, 38, 16));
        d6.a(this.Y);
        ...
        this.d0.setBackground(j6.Z(getThemedColor(i11), getThemedColor(i12), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f)));
        this.b0.addView(this.d0, b6.t(38, 38, 16, 2, 0, 0, 0));
        d6.a(this.d0);
        ...
        this.V.addView(this.e0, b6.e(-2, 60, 81));
        ...
        this.V.addView(this.s0, b6.e(80, 60, 81));
        jj0 jj0Var = new jj0(context);
        this.t0 = jj0Var;
        jj0Var.f(R.raw.group_pip_delete_icon, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), null);
        gj0 animatedDrawable = this.t0.getAnimatedDrawable();
        if (animatedDrawable != null) {
        ...
        this.t0.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.s0.addView(this.t0, b6.e(-1, -1, 119));
        FrameLayout frameLayout8 = new FrameLayout(context);
        frameLayout8.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.e0.addView(frameLayout8, b6.c(44.0f, -2));
        t1 t1Var = new t1(this, context);
        this.g0 = t1Var;
        t1Var.setHorizontalScrollBarEnabled(false);
        this.g0.setClipToOutline(true);
        this.g0.setOutlineProvider(new gg.j1(20));
        frameLayout8.addView(this.g0, b6.c(-1.0f, -1));
        ...
        linearLayout5.addView(this.r0, b6.t(38, 38, 16, linearLayout5.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
        ...
        linearLayout6.addView(this.o0, b6.t(38, 38, 16, linearLayout6.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
        LinearLayout linearLayout7 = new LinearLayout(context);
        this.k0 = linearLayout7;
        linearLayout7.setOrientation(0);
        this.k0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.k0.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.e0.addView(this.k0, b6.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        ...
        this.k0.addView(this.n0, b6.q(38, 38, 16));
        ...
        this.k0.addView(this.p0, b6.q(38, 38, 16));
        LinearLayout linearLayout8 = new LinearLayout(context);
        this.l0 = linearLayout8;
        linearLayout8.setOrientation(0);
        this.l0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.l0.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.e0.addView(this.l0, b6.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        ...
        this.l0.addView(this.q0, b6.q(38, 38, 16));
        LinearLayout linearLayout9 = new LinearLayout(context);
        this.j0 = linearLayout9;
        linearLayout9.setOrientation(0);
        this.j0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.j0.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.e0.addView(this.j0, 0, b6.d(-2, 44.0f, 80, 0.0f, 0.0f, 8.0f, 0.0f));
        ...
        this.j0.addView(this.m0, b6.q(38, 38, 16));
        pp0 pp0Var = new pp0((Object) this, context, this.r != null ? R.drawable.input_done : l0() ? R.drawable.input_schedule : R.drawable.send_plane_24, getResourceProvider(), 3);
        this.v0 = pp0Var;
        pp0Var.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(j6.Yd))));
        d6.a(this.v0);
        this.X.addView(this.v0, b6.p(44, 44, 0.0f, 5, 8, 0, 0, 0));
        this.v0.setContentDescription(LocaleController.getString(R.string.Send));
        this.v0.setOnClickListener(new g1(this, 0));
        this.v0.setOnLongClickListener(new dg.f0(this, 4));
        C0();
    ...
    public final void d0(Context context, int i10, int i11, boolean z4) {
        ...
        linearLayout.addView(u1Var, b6.t(38, 38, 16, linearLayout.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
    }
    ...
    public final boolean l0() {
        zn znVar;
        return this.r == null && (znVar = this.G) != null && znVar.c();
    }
    ...
    public final void n0() {
        ...
        f0Var.n0(a2);
        f0Var.h0 = new org.telegram.ui.web.a1(g22, 23);
        f0Var.show();
    }
    ...
    public final void o0(int i10, int i11) {
        ...
        liVar.g0.setIncludeVideosInGallery(true);
        liVar.g0.f0();
        liVar.J1(1, true);
        liVar.h1(i10);
        liVar.q2 = new n1(this, liVar);
    ...
    public final r0.m1 onInsetsInternal(View view, r0.m1 m1Var) {
        ...
        if (!this.D0 && z4 && (p70Var = this.u0) != null) {
            p70Var.u();
            this.u0 = null;
        }
    ...
    public final void onTransitionAnimationStart(boolean z4, boolean z10) {
        ...
        if (z4 && !z10 && (i10 = this.c) >= 0 && (s3Var2 = this.M) != null) {
            int i11 = this.d;
            this.d = -1;
            this.c = -1;
        ...
        if ((this.b == null && this.f == null) || (s3Var = this.M) == null || s3Var.Z2()) {
            return;
        }
    ...
    public final boolean q0() {
        Runnable runnable;
        if (this.G == null || this.r != null || !this.M.q2()) {
            return false;
        }
        TL_iv.RichMessage i22 = this.J ? null : this.M.i2();
        ...
        if (i22 != null && !this.J) {
            s3 s3Var = this.M;
            if (s3Var.j3() && !x4.f(s3Var.i3, s3Var.j3) && lkVar != null) {
                SpannableStringBuilder k10 = x4.k(this.M.i3);
                zn znVar = lkVar.L2;
                if (lkVar.B0 == null) {
                    return true;
                }
                ...
                if (znVar != null) {
                    ...
                    MediaDataController.getInstance(lkVar.N).saveDraft(znVar.a(), znVar.B7(znVar.k5), charSequenceArr[0], MediaDataController.getInstance(lkVar.N).getEntities(charSequenceArr, true, false), null, null, null, 0L, false, false, null);
                }
        ...
        long a2 = this.G.a();
        zn znVar2 = this.G;
        mediaDataController.saveDraft(a2, znVar2.B7(znVar2.k5), "", null, null, null, null, 0L, false, false, i22);
    ...
    /* JADX WARN: Type inference failed for: r0v19, types: [vh.l1] */
    public final void s0(final int i10, final int i11, final boolean z4) {
        ...
        if (this.G == null || !this.M.j3() || this.M.l3()) {
            return;
        }
        if (!this.M.L3()) {
            B0();
        ...
        if (!MessagesController.getInstance(this.currentAccount).richEditorAllowed()) {
            ...
            lkVar.R0(x4.k(this.M.i3), z4, i10, i11);
            finishFragment();
            return;
        }
        this.J = true;
        ...
        zn znVar = this.G;
        final MessageObject messageObject = znVar.k5;
        ...
        ?? r02 = new Runnable() { // from class: vh.l1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    public final void w0() {
        ...
        if (textSelectionHelper == null || !textSelectionHelper.y()) {
            ...
            P2 = i12 == textSelectionHelper.x0 ? this.M.x4(i12) : null;
        }
        if (this.M.Q2() == null) {
            if (P2 != null) {
                if (!P2.a() && !P2.b() && !P2.c()) {
    ...
    public final void x0(int i10, boolean z4) {
        ...
        if (z4) {
            ...
            this.e0.animate().alpha(this.H0 == 1 ? 1.0f : 0.0f).scaleX(this.H0 == 1 ? 1.0f : 0.8f).scaleY(this.H0 == 1 ? 1.0f : 0.8f).translationY(this.H0 == 1 ? 0.0f : AndroidUtilities.dp(30.0f)).setDuration(420L).setInterpolator(mrVar).withEndAction(new f1(this, 2)).start();
            this.s0.setVisibility(0);
            this.s0.animate().alpha(this.H0 == 2 ? 1.0f : 0.0f).scaleX(this.H0 == 2 ? 1.0f : 0.8f).scaleY(this.H0 == 2 ? 1.0f : 0.8f).setDuration(420L).setInterpolator(mrVar).withEndAction(new f1(this, 3)).start();
            return;
        }
    ...
    public final void y0() {
        ...
        if (u1Var != null) {
            s3 s3Var = this.M;
            int[] A4 = s3Var.A4();
            u1Var.setSelected(A4 != null && s3Var.G3(A4[0], A4[1]));
        }
        if (this.M.K3()) {
            ...
            boolean z12 = i11 == i12;
            e1 M4 = z12 ? this.M.M4(i10, i11) : null;
            int max = Math.max(0, Math.min(i13, i14));
            int max2 = M4 == null ? 0 : Math.max(0, Math.min(Math.max(i13, i14), M4.length()));
            u1 u1Var3 = this.n0;
            if (u1Var3 != null) {
                u1Var3.setSelected(M4 != null && max < max2 && y5.h(M4.getText(), max, max2));
            }
            u1 u1Var4 = this.p0;
            if (u1Var4 != null) {
                if (M4 != null && max < max2 && y5.g(M4.getText(), max, max2)) {
                    z11 = true;
                }
        ...
        if (this.M.v3()) {
            ...
            e1 r22 = this.M.r2(textSelectionHelper3.u0);
            ...
            while (i18 < size2) {
                ...
                i18++;
                u1 u1Var5 = (u1) obj2;
                u1Var5.setSelected((r22 == null || max3 >= max4 || (((Integer) u1Var5.getTag()).intValue() & r22.getCurrentStyle(max3, max4)) == 0) ? false : true);
            }
            u1 u1Var6 = this.n0;
            if (u1Var6 != null) {
                u1Var6.setSelected(r22 != null && max3 < max4 && y5.h(r22.getText(), max3, max4));
            }
            u1 u1Var7 = this.p0;
            if (u1Var7 != null) {
                if (r22 != null && max3 < max4 && y5.g(r22.getText(), max3, max4)) {
                    z11 = true;
                }
        ...
        while (i23 < size3) {
            ...
            u1Var8.setSelected(z13 && this.M.I3(((Integer) u1Var8.getTag()).intValue(), i19, i21, i20, i22));
            i23 = i24;
        }
        t0(!this.M.H3());
        u1 u1Var9 = this.n0;
        if (u1Var9 != null) {
            if (z13) {
                ...
                if (G4 == null ? false : y5.h(G4, Math.max(0, Math.min(i21, i22)), Math.max(i21, i22))) {
                    z10 = true;
        ...
        if (u1Var10 != null) {
            if (z13) {
                ...
                if (G42 == null ? false : y5.g(G42, Math.max(0, Math.min(i21, i22)), Math.max(i21, i22))) {
                    z4 = true;
    ...
    public final void z0() {
        ...
        if (imageView != null) {
            ...
            this.S.setAlpha(q22 ? 1.0f : 0.35f);
        }
