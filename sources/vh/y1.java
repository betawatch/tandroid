...
public final class y1 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean W(y1 y1Var, View view) {
        xn xnVar = y1Var.G;
        if (xnVar != null && y1Var.r == null && !xnVar.c() && y1Var.M.k3() && !y1Var.M.m3()) {
            if (!y1Var.M.M3()) {
                y1Var.B0();
                return false;
            }
            ...
            if (!Z2.isEmpty()) {
                ...
                lg r10 = y1Var.L0.r(y1Var.v0, true, new f1(y1Var, 10));
                if (r10 != null) {
                ...
                o70 H = o70.H(y1Var, y1Var.v0);
                boolean isUserSelf = UserObject.isUserSelf(y1Var.G.i());
                if (y1Var.G.D6()) {
                    H.c(R.drawable.msg_calendar2, LocaleController.getString(isUserSelf ? R.string.SetReminder : R.string.ScheduleMessage), new sh.m0(y1Var, a2, 2), false);
                    if (!isUserSelf && a2 > 0) {
    ...
    public static void Y(final y1 y1Var, Context context, View view) {
        ...
        J.k();
        final int i10 = 0;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading1), R.drawable.iv_h1, null, LocaleController.getString(R.string.ArticleHeading1), new Runnable(y1Var) { // from class: vh.j1
        ...
        final int i11 = 1;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading2), R.drawable.iv_h2, null, LocaleController.getString(R.string.ArticleHeading2), new Runnable(y1Var) { // from class: vh.j1
            public final /* synthetic */ y1 b;
        ...
        final int i12 = 2;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading3), R.drawable.iv_h3, null, LocaleController.getString(R.string.ArticleHeading3), new Runnable(y1Var) { // from class: vh.j1
            public final /* synthetic */ y1 b;
        ...
        final int i13 = 3;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading4), R.drawable.iv_h4, null, LocaleController.getString(R.string.ArticleHeading4), new Runnable(y1Var) { // from class: vh.j1
            public final /* synthetic */ y1 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 1);
        final int i14 = 4;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading5), R.drawable.iv_h5, null, LocaleController.getString(R.string.ArticleHeading5), new Runnable(y1Var) { // from class: vh.j1
            public final /* synthetic */ y1 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 2);
        final int i15 = 5;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading6), R.drawable.iv_h6, null, LocaleController.getString(R.string.ArticleHeading6), new Runnable(y1Var) { // from class: vh.j1
            public final /* synthetic */ y1 b;
        ...
        int i16 = j6.G8;
        w1Var.d = i16;
        I.j(z4, 0, w1Var, LocaleController.getString(R.string.ArticleHeading), new kh.z2(I, o70Var, 11));
        ...
        I.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockParagraph), R.drawable.iv_text2, null, LocaleController.getString(R.string.ArticleText), new i1(y1Var, Q2, 3));
        I.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockBlockquote), R.drawable.iv_quote, null, LocaleController.getString(R.string.ArticleQuote), new i1(y1Var, Q2, 4));
        boolean z11 = Q2 != null && (Q2.b instanceof TL_iv.pageBlockPullquote);
        w1 w1Var2 = new w1(context, R.drawable.iv_pullquote);
        w1Var2.a(z10);
        w1Var2.d = i16;
        I.j(z11, 0, w1Var2, LocaleController.getString(R.string.ArticlePullquote), new i1(y1Var, Q2, 0));
        I.y().setPadding(AndroidUtilities.dp(LocaleController.isRTL ? 18.0f : 9.0f), 0, AndroidUtilities.dp(LocaleController.isRTL ? 9.0f : 18.0f), 0);
        I.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockPreformatted), R.drawable.iv_code, null, LocaleController.getString(R.string.ArticleCode), new i1(y1Var, Q2, 1));
        boolean z12 = Q2 != null && (Q2.b instanceof TL_iv.pageBlockFooter);
        w1 w1Var3 = new w1(context, R.drawable.iv_footer);
        w1Var3.a(z10);
        w1Var3.d = i16;
        I.j(z12, 0, w1Var3, LocaleController.getString(R.string.ArticleFooter), new i1(y1Var, Q2, 2));
        I.y().setPadding(AndroidUtilities.dp(LocaleController.isRTL ? 18.0f : 9.0f), 0, AndroidUtilities.dp(LocaleController.isRTL ? 9.0f : 18.0f), 0);
        I.Z();
        y1Var.u0 = I;
    }
    ...
    public static void Z(y1 y1Var, boolean z4, boolean z10) {
        ...
        if (z10) {
            y1Var.t0.animate().scaleX(f10).scaleY(f10).setDuration(180L).setInterpolator(nr.h).start();
        } else {
    ...
    public static d1 a0(y1 y1Var) {
        ...
        if (focusedEditTextOrNull == null) {
            d1 d1Var = y1Var.O0;
            return d1Var != null ? d1Var : y1Var.M.P2();
        }
    ...
    public static int b0(y1 y1Var, d1 d1Var) {
        return (d1Var != y1Var.O0 || y1Var.M.getFocusedEditTextOrNull() == d1Var) ? Math.max(0, d1Var.getSelectionEnd()) : Math.min(y1Var.P0, d1Var.length());
    }
    ...
    public static void p0(Context context, final Runnable runnable, final Runnable runnable2, f6 f6Var) {
        ...
        j10.setGravity(17);
        j10.setTextColor(j6.v0(i11, f6Var));
        ...
        o10.show();
        p10.setOnClickListener(new View.OnClickListener() { // from class: vh.h1
        ...
        final int i12 = 1;
        p11.setOnClickListener(new View.OnClickListener() { // from class: vh.h1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                switch (i12) {
                    case 0:
    ...
    public final View createView(Context context) {
        ...
        this.d0.setOnClickListener(new f1(this, 9));
        ...
        this.r0.setOnClickListener(new f1(this, 11));
        ...
        this.o0.setOnClickListener(new f1(this, 12));
        ...
        this.n0.setOnClickListener(new f1(this, 13));
        ...
        this.p0.setOnClickListener(new f1(this, 14));
        ...
        this.q0.setOnClickListener(new f1(this, 15));
        ...
        qp0 qp0Var = new qp0((Object) this, context, this.r != null ? R.drawable.input_done : l0() ? R.drawable.input_schedule : R.drawable.send_plane_24, getResourceProvider(), 3);
        this.v0 = qp0Var;
        ...
        this.v0.setOnClickListener(new f1(this, 0));
    ...
    public final void n0() {
        ...
        f0Var.n0(a2);
        f0Var.h0 = new org.telegram.ui.web.y0(h22, 23);
        f0Var.show();
    }
    ...
    public final AnimatorSet onCustomTransitionAnimation(boolean z4, Runnable runnable) {
        ...
        this.L.post(new rt0(animatorSet, i11));
        return animatorSet;
    }
    ...
    public final r0.m1 onInsetsInternal(View view, r0.m1 m1Var) {
        ...
        if (!this.D0 && z4 && (o70Var = this.u0) != null) {
            o70Var.u();
            this.u0 = null;
        }
    ...
    /* JADX WARN: Type inference failed for: r0v19, types: [vh.k1] */
    public final void s0(final int i10, final int i11, final boolean z4) {
        ...
        ?? r02 = new Runnable() { // from class: vh.k1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    ...
    public final void x0(int i10, boolean z4) {
        ...
        if (z4) {
            ...
            this.e0.animate().alpha(this.H0 == 1 ? 1.0f : 0.0f).scaleX(this.H0 == 1 ? 1.0f : 0.8f).scaleY(this.H0 == 1 ? 1.0f : 0.8f).translationY(this.H0 == 1 ? 0.0f : AndroidUtilities.dp(30.0f)).setDuration(420L).setInterpolator(nrVar).withEndAction(new e1(this, 2)).start();
            this.s0.setVisibility(0);
            this.s0.animate().alpha(this.H0 == 2 ? 1.0f : 0.0f).scaleX(this.H0 == 2 ? 1.0f : 0.8f).scaleY(this.H0 == 2 ? 1.0f : 0.8f).setDuration(420L).setInterpolator(nrVar).withEndAction(new e1(this, 3)).start();
            return;
        }
    ...
    public final void y0() {
        ...
        if (this.M.L3()) {
            ...
            boolean z12 = i11 == i12;
            d1 N4 = z12 ? this.M.N4(i10, i11) : null;
        ...
        if (this.M.w3()) {
            ...
            d1 s22 = this.M.s2(textSelectionHelper3.u0);
