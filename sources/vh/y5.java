...
public abstract class y5 {
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder, TL_iv.RichText richText, int i10, TL_iv.PageBlock pageBlock, boolean z4) {
        ...
        if (richText instanceof TL_iv.textMath) {
            ...
            Object a2 = s.a(textmath.source, j6.w0(null, j6.G6, false), AndroidUtilities.dp(SharedConfig.fontSize + 4));
            if (a2 != null) {
        ...
        if (richText instanceof TL_iv.textButton) {
            ...
            if (z4 && spannableStringBuilder.length() > length7 && f4.c(textbutton.type)) {
                spannableStringBuilder.setSpan(new f4(textbutton), length7, spannableStringBuilder.length(), 33);
                return;
            }
            return;
        }
    ...
    */
    public static TL_iv.RichText f(CharSequence charSequence) {
        ...
        while (i10 < length) {
            ...
            x5 x5Var2 = new x5();
            x5Var2.a = e(spanned, i10, nextSpanTransition);
            ...
            if (u5VarArr.length > 0) {
                x5Var2.d = u5VarArr[0].getDocumentId();
            }
            s[] sVarArr = (s[]) spanned.getSpans(i10, nextSpanTransition, s.class);
            if (sVarArr.length > 0) {
                x5Var2.e = sVarArr[0].a;
            }
            f4[] f4VarArr = (f4[]) spanned.getSpans(i10, nextSpanTransition, f4.class);
            if (f4VarArr.length > 0) {
                x5Var2.f = f4VarArr[0];
            }
            if (x5Var != null) {
                f4 f4Var = x5Var.f;
                if (f4Var == null && x5Var2.f == null) {
                    if (x5Var.d == 0 && x5Var2.d == 0 && x5Var.e == null && x5Var2.e == null && x5Var.a == x5Var2.a) {
                        if ((r9 = x5Var.b) == null) {
                        }
                    }
                    arrayList.add(s(charSequence.subSequence(i11, i10).toString(), x5Var));
                    i11 = i10;
                } else {
                    i10 = (f4Var != null && f4Var == x5Var2.f) ? nextSpanTransition : 0;
                    arrayList.add(s(charSequence.subSequence(i11, i10).toString(), x5Var));
                    i11 = i10;
                }
            }
        ...
        arrayList.add(s(charSequence3, x5Var));
        if (arrayList.size() == 1) {
    ...
    public static TL_iv.RichText s(String str, x5 x5Var) {
