...
public final class b0 extends View {
    ...
    public b0(e0 e0Var, Context context, TL_keyboard.PageButton pageButton, int i10) {
        ...
        this.f = e0Var;
        this.b = i10;
        RichMessageLayout.RichButton createEditorPageButton = RichMessageLayout.createEditorPageButton(e0Var.n, kh.a2.c(32.0f, AndroidUtilities.displaySize.x, AndroidUtilities.dp(240.0f)), e0Var.r, pageButton, new ga(this, 26));
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 1) {
            ...
            if (z4 && (c0Var = (e0Var = this.f).B) != null && (aVar = e0Var.a) != null) {
                r3 r3Var = ((j3) c0Var).a;
