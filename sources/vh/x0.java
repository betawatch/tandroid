...
public final class x0 extends z implements org.telegram.ui.ActionBar.a6, k9, j0, DownloadController.FileDownloadProgressListener {
    ...
    public x0(Context context, int i10, f6 f6Var) {
        ...
        i0 i0Var = new i0(context, f6Var, new o2.i(this, 26));
        this.C = i0Var;
    ...
    public final void h(TLRPC.Document document) {
        ...
        n3 n3Var = this.P;
        MessageObject messageObject = n3Var == null ? null : n3Var.a.f3;
        imageReceiver.setImageCoords(this.H, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(86.0f), AndroidUtilities.dp(86.0f));
    ...
    */
    public final void l(boolean z4) {
        ...
        if (z10) {
            ...
            radialProgress2.d = j6.v0(j6.hd, f6Var);
        } else {
            radialProgress2.g(j6.ie, j6.je, j6.uc, j6.vc);
            radialProgress2.d = j6.v0(j6.Bd, f6Var);
        }
        boolean j10 = j();
        int i10 = this.n;
        if (j10) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        this.w.setColor(j6.v0(j6.Dd, f6Var));
        ...
        this.x.setColor(j6.v0(j6.nd, f6Var));
                    ...
                    if (z4) {
                        ...
                        if (j()) {
                            ...
                            if (n3Var != null) {
                                a aVar = this.a;
                                s3 s3Var = n3Var.a;
                                v4 v4Var = (v4) s3Var.W3.remove(aVar.g);
                                if (v4Var != null) {
                                    v4Var.b();
                                }
                                d2 d2Var = s3Var.G3;
                            ...
                            if (i10 == 0) {
                                ...
                                if (i10 == 1 && i() != null) {
                                    n3 n3Var2 = this.P;
                                    MessageObject messageObject2 = n3Var2 != null ? n3Var2.a.f3 : null;
