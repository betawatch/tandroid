...
public final class y extends z implements org.telegram.ui.ActionBar.a6, k9, j0, NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    public int B;
    public final int C;
    public final int D;
    public boolean E;
    ...
    public y(Context context, int i10, f6 f6Var) {
        super(context);
        this.s = new Paint(1);
        ...
        this.x = fo0Var;
        fo0Var.h = new o3.c(this, 25);
        setMinimumHeight(AndroidUtilities.dp(66.0f));
        i0 i0Var = new i0(context, f6Var, new zz(this, 21));
        this.R = i0Var;
    ...
    public final void i(a aVar, m3 m3Var) {
        t tVar;
        this.a = aVar;
        this.L = m3Var;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        m3 m3Var = this.L;
        if (m3Var != null && (textSelectionHelper = m3Var.a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
