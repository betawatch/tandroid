...
public final class e2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, e2 e2Var) {
        ...
        e2Var.a = y5.l(richText).length() + e2Var.a;
    ...
    public static void b(TL_iv.PageBlock pageBlock, int i10, e2 e2Var) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            ...
            e2Var.b = pageblockblockquoteblocks.blocks.size() + e2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockDetails) {
            ...
            e2Var.b = pageblockdetails.blocks.size() + e2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockList) {
            ...
            e2Var.b = pageblocklist.items.size() + e2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            e2Var.b = pageblockorderedlist.items.size() + e2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockTable) {
            ...
            if (arrayList3 != null) {
                e2Var.b = arrayList3.size() + e2Var.b;
