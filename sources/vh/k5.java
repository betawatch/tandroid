...
public final class k5 extends ViewGroup {
    ...
    public final TL_iv.pageTableCell a() {
        ...
        if (z5Var != null && z5Var.b != 0 && z5Var.c != 0) {
            ...
            while (i12 < size) {
                ...
                if (((LinkedHashSet) ((rh.e) this.h).b).contains(pagetablecell3)) {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        z5 z5Var2 = this.a;
        RectF rectF = this.y;
        if (z5Var2 != null && z5Var2.b != 0 && z5Var2.c != 0) {
            ...
            float f13 = this.f[0];
            z5 z5Var3 = this.a;
            rectF.set(f12, f13, r2[z5Var3.c], r4[z5Var3.b]);
            Path path = this.C;
            path.rewind();
            ...
            for (int i19 = 0; i19 < getChildCount(); i19++) {
                ...
                if (childAt instanceof l5) {
                    l5 l5Var = (l5) childAt;
                    int b12 = this.a.b(l5Var.b);
                    int a11 = this.a.a(l5Var.b);
                    if (b12 >= 0 && a11 >= 0) {
                        int n10 = z5.n(l5Var.b);
                        int o10 = z5.o(l5Var.b);
                        int[] iArr3 = this.e;
                        int i20 = iArr3[a11];
                        int i21 = this.f[b12];
        ...
        z5 z5Var4 = this.a;
        if (z5Var4 != null && (pageblocktable = z5Var4.a) != null && pageblocktable.bordered) {
            Paint paint = this.n;
            ...
            int[] iArr7 = this.f;
            z5 z5Var5 = this.a;
            rectF.set(iArr6[0] + strokeWidth, iArr7[0] + strokeWidth, iArr6[z5Var5.c] - strokeWidth, iArr7[z5Var5.b] - strokeWidth);
            ...
            while (i24 < this.a.c) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[] pagetablecellArr = z5Var6.d[i27];
            ...
            for (int i28 = 1; i28 < this.a.b; i28++) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[][] pagetablecellArr2 = z5Var7.d;
    ...
    public final boolean l() {
        ...
        if (z5Var != null && this.h != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                if (((LinkedHashSet) ((rh.e) this.h).b).contains((TL_iv.pageTableCell) obj)) {
                    return true;
                }
            }
        }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt instanceof l5) {
                l5 l5Var = (l5) childAt;
                int b10 = this.a.b(l5Var.b);
                int a2 = this.a.a(l5Var.b);
                if (b10 >= 0 && a2 >= 0) {
                    int i15 = this.e[a2];
                    int i16 = this.f[b10];
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.c = new int[i17];
        this.d = new int[i16];
        int dp5 = AndroidUtilities.dp(z5Var2.a.compact ? 20.0f : 50.0f);
        int i18 = this.a.a.compact ? 5 : 12;
        int c3 = i17 == 2 ? kh.a2.c(i18 * 4, size / 2, 0) : Math.max(0, Math.round(size / 1.5f));
        float f10 = i18 * 2;
        ...
        while (true) {
            ...
            if (childAt instanceof l5) {
                l5 l5Var = (l5) childAt;
                d1 d1Var = l5Var.a;
                if (z5.n(l5Var.b) == 1 && (a2 = this.a.a(l5Var.b)) >= 0 && a2 < i17) {
        ...
        while (i21 < getChildCount()) {
            ...
            if (childAt2 instanceof l5) {
                ...
                d1 d1Var2 = l5Var2.a;
                int n10 = z5.n(l5Var2.b);
                if (n10 > i12) {
                    int a10 = this.a.a(l5Var2.b);
                    ...
                    if (a10 >= 0 && a10 < min) {
                        ...
                        int min2 = Math.min((min - a10) * b10, AndroidUtilities.dp(f10) + Math.round(Layout.getDesiredWidth(d1Var2.getText(), d1Var2.getPaint()))) - i22;
        ...
        while (i30 < getChildCount()) {
            ...
            if (childAt3 instanceof l5) {
                ...
                int b11 = this.a.b(l5Var3.b);
                int a11 = this.a.a(l5Var3.b);
                int n11 = z5.n(l5Var3.b);
                i15 = i30;
                int i31 = 0;
                for (int i32 = a11; i32 < a11 + n11 && i32 < i17; i32++) {
                    i31 += this.c[i32];
                }
                l5Var3.measure(View.MeasureSpec.makeMeasureSpec(i31, TLObject.FLAG_30), makeMeasureSpec);
                if (z5.o(l5Var3.b) == 1) {
        ...
        for (int i33 = 0; i33 < getChildCount(); i33++) {
            ...
            if (childAt4 instanceof l5) {
                ...
                int b12 = this.a.b(l5Var4.b);
                int o10 = z5.o(l5Var4.b);
                if (o10 > 1) {
                    int i34 = b12;
                    int i35 = 0;
                    while (true) {
        ...
        while (i37 < getChildCount()) {
            ...
            if (childAt5 instanceof l5) {
                ...
                int b13 = this.a.b(l5Var5.b);
                int a12 = this.a.a(l5Var5.b);
                int n12 = z5.n(l5Var5.b);
                int o11 = z5.o(l5Var5.b);
                i13 = i37;
                int i38 = 0;
                ...
                l5Var5.measure(View.MeasureSpec.makeMeasureSpec(i38, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i40, TLObject.FLAG_30));
            } else {
                i13 = i37;
            }
            i37 = i13 + 1;
    ...
    public final boolean p(int i10, int i11) {
        ...
        return ((LinkedHashSet) ((rh.e) j5Var).b).contains(z5Var.d[i10][i11]);
    }
    ...
    public final void s() {
        ...
        int size = z5Var.g.size();
        for (int i10 = 0; i10 < size; i10++) {
            TL_iv.pageTableCell pagetablecell = (TL_iv.pageTableCell) this.a.g.get(i10);
            l5 l5Var = new l5(getContext(), this.b);
            l5Var.setCompact(this.a.a.compact);
            l5Var.b(pagetablecell);
            addView(l5Var);
        }
    }
