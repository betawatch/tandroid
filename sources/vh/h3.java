...
public final class h3 extends k7.x5 {
    ...
    public final void a(boolean z4) {
        ...
        final int i11 = r3Var.n3;
        final int i12 = r3Var.o3;
        r3Var.m3 = -1;
        r3Var.n3 = -1;
        r3Var.o3 = 0;
        boolean z10 = r3Var.p3;
        final float f10 = r3Var.q3;
        final float f11 = r3Var.r3;
        r3Var.p3 = false;
        r3Var.setEditTextsLocked(false);
        r3Var.V2();
        if (z10) {
            r3Var.post(new Runnable() { // from class: vh.g3
                @Override // java.lang.Runnable
                public final void run() {
                    r3 r3Var2 = h3.this.b;
                    for (int i13 = 0; i13 < r3Var2.getChildCount(); i13++) {
                        KeyEvent.Callback childAt = r3Var2.getChildAt(i13);
