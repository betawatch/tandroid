...
public final class z5 {
    ...
    public static String g(TL_iv.pageTableCell pagetablecell) {
        ...
        return (pagetablecell == null || (richText = pagetablecell.text) == null) ? "" : x5.l(richText);
    }

    public static CharSequence h(TL_iv.pageTableCell pagetablecell) {
        TL_iv.RichText richText;
        return (pagetablecell == null || (richText = pagetablecell.text) == null) ? "" : x5.r(richText, null, true);
    }
    ...
    public final void j(final IdentityHashMap identityHashMap, int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            ...
            Collections.sort(arrayList, Comparator$-CC.comparingInt(new ToIntFunction() { // from class: vh.y5
