...
public final class v3 extends FrameLayout {
    ...
    public v3(Context context, final k kVar) {
        super(context);
        ...
        imageView.setOnClickListener(new dg.m(kVar, 27));
        ...
        final int i14 = 7;
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            ...
            public final void onClick(View view3) {
                switch (i14) {
                    ...
                    case 5:
                        ...
                        if (h22 != null) {
                            ...
                            if (!a2.blocks.isEmpty()) {
                                org.telegram.ui.Components.f0 f0Var = new org.telegram.ui.Components.f0(pVar2.getContext(), pVar2.a);
                                f0Var.n0(a2);
                    ...
                    case 9:
                        ...
                        new v(pVar3.n, context2, new org.telegram.ui.web.y0(kVar2, 24), pVar3.a).show();
                        break;
                    case 10:
                        p.K(kVar.a);
                        break;
        ...
        final int i15 = 8;
        imageView3.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i15) {
                    case 0:
        ...
        final int i16 = 9;
        imageView4.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i16) {
                    case 0:
        ...
        final int i17 = 10;
        qgVar.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i17) {
                    case 0:
        ...
        final int i18 = 11;
        imageView5.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i18) {
                    case 0:
        ...
        hb1 hb1Var = new hb1(this, context, 20);
        this.D = hb1Var;
        hb1Var.setOrientation(0);
        hb1Var.setClipToPadding(false);
        hb1Var.setClipChildren(false);
        hb1Var.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        frameLayout2.addView(hb1Var, b6.e(-2, 60, 81));
        ...
        hb1Var.addView(frameLayout7, b6.c(44.0f, -2));
        ...
        g2Var.setOutlineProvider(new gg.j1(22));
        frameLayout7.addView(g2Var, b6.c(-1.0f, -1));
        ...
        final int i19 = 0;
        u1Var.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i19) {
                    case 0:
        ...
        final int i20 = 1;
        u1Var2.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i20) {
                    case 0:
        ...
        hb1Var.addView(linearLayout5, b6.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        ...
        final int i21 = 2;
        u1Var3.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i21) {
                    case 0:
        ...
        final int i22 = 3;
        u1Var4.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i22) {
                    case 0:
        ...
        hb1Var.addView(linearLayout6, b6.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        ...
        final int i23 = 4;
        u1Var5.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i23) {
                    case 0:
        ...
        hb1Var.addView(linearLayout7, 0, b6.d(-2, 44.0f, 80, 0.0f, 0.0f, 8.0f, 0.0f));
        ...
        final int i24 = 5;
        u1Var6.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i24) {
                    case 0:
        ...
        qp0 qp0Var = new qp0(this, context, R.drawable.send_plane_24, f6Var, 4);
        this.C = qp0Var;
        qp0Var.setBackground(new x1(j6.b0(AndroidUtilities.dp(22.0f), j6.v0(j6.Yd, f6Var))));
        d6.a(qp0Var);
        linearLayout2.addView(qp0Var, b6.p(44, 44, 0.0f, 5, 8, 0, 0, 0));
        qp0Var.setContentDescription("Send");
        final int i25 = 6;
        qp0Var.setOnClickListener(new View.OnClickListener() { // from class: vh.s3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                switch (i25) {
                    case 0:
        ...
        qp0Var.setOnLongClickListener(new dg.f0(kVar, 5));
        f(0, false);
    }
    ...
    public final void e(boolean z4, boolean z10) {
        ...
        jj0 jj0Var = this.F;
        if (z10) {
            jj0Var.animate().scaleX(f10).scaleY(f10).setDuration(180L).setInterpolator(nr.h).start();
        } else {
    ...
    public final void f(int i10, boolean z4) {
        ...
        if (z4) {
            ...
            nr nrVar = nr.h;
            final int i11 = 0;
            duration.setInterpolator(nrVar).withEndAction(new Runnable(this) { // from class: vh.t3
            ...
            final int i12 = 1;
            hb1Var.animate().alpha(i10 == 1 ? 1.0f : 0.0f).scaleX(i10 == 1 ? 1.0f : 0.8f).scaleY(i10 == 1 ? 1.0f : 0.8f).translationY(i10 == 1 ? 0.0f : AndroidUtilities.dp(30.0f)).setDuration(420L).setInterpolator(nrVar).withEndAction(new Runnable(this) { // from class: vh.t3
                public final /* synthetic */ v3 b;
            ...
            final int i13 = 2;
            scaleX.scaleY(i10 == 2 ? 1.0f : 0.8f).setDuration(420L).setInterpolator(nrVar).withEndAction(new Runnable(this) { // from class: vh.t3
                public final /* synthetic */ v3 b;
        ...
        hb1Var.setVisibility(i10 == 1 ? 0 : 8);
        hb1Var.setAlpha(i10 == 1 ? 1.0f : 0.0f);
        hb1Var.setScaleX(i10 == 1 ? 1.0f : 0.8f);
        hb1Var.setScaleY(i10 == 1 ? 1.0f : 0.8f);
        hb1Var.setTranslationY(i10 == 1 ? 0.0f : AndroidUtilities.dp(30.0f));
