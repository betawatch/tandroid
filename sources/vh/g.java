...
public final class g extends Drawable {
    ...
    public static void a(View view, Layout layout, int i10, int i11, Spanned spanned, Stack stack, List list, ArrayList arrayList) {
        ...
        f11[] f11VarArr = (f11[]) spanned.getSpans(0, layout.getText().length(), f11.class);
        for (int i14 = 0; i14 < Math.min(100, f11VarArr.length); i14++) {
            if (f11VarArr[i14].c()) {
                int spanStart = spanned.getSpanStart(f11VarArr[i14]);
                int spanEnd = spanned.getSpanEnd(f11VarArr[i14]);
                if (i10 == -1 && i11 == -1) {
    ...
    public static void g(View view, boolean z10, int i10, int i11, AtomicReference atomicReference, int i12, Layout layout, List list, Canvas canvas, boolean z11) {
        ...
        if (layout2 == null || !layout.getText().toString().equals(layout2.getText().toString()) || layout.getWidth() != layout2.getWidth() || layout.getHeight() != layout2.getHeight()) {
            ...
            if (layout.getText() instanceof Spanned) {
                ...
                f11[] f11VarArr2 = (f11[]) spanned.getSpans(0, spanned.length(), f11.class);
                int i15 = 0;
                while (i15 < Math.min(100, f11VarArr2.length)) {
                    f11 f11Var = f11VarArr2[i15];
                    if (f11Var.c()) {
                        ...
                        while (i14 < length) {
                            f11[] f11VarArr3 = f11VarArr2;
                            Emoji.EmojiSpan emojiSpan = emojiSpanArr[i14];
                            spannableStringBuilder.setSpan(new b(emojiSpan), spanned.getSpanStart(emojiSpan), spanned.getSpanEnd(emojiSpan), spanned.getSpanFlags(f11Var));
                            spannableStringBuilder.removeSpan(emojiSpan);
                            i14++;
                            f11VarArr2 = f11VarArr3;
                            i15 = i15;
                            length = length;
                            emojiSpanArr = emojiSpanArr;
                        }
                        f11VarArr = f11VarArr2;
                        i13 = i15;
                        spannableStringBuilder.setSpan(new ForegroundColorSpan(0), spanStart, spanEnd, spanned.getSpanFlags(f11Var));
                        spannableStringBuilder.removeSpan(f11Var);
                    } else {
                        f11VarArr = f11VarArr2;
                        i13 = i15;
                    }
                    i15 = i13 + 1;
                    f11VarArr2 = f11VarArr;
                    i14 = 0;
                }
            }
            if (i12 == 1) {
        ...
        int i16 = 0;
        if (!list.isEmpty() && ((g) list.get(0)).n != -1.0f) {
            canvas.save();
        ...
        boolean z12 = ((g) list.get(i16)).n != -1.0f;
        if (z12) {
        ...
        while (it2.hasNext()) {
            ...
            gVar.p = false;
            if (z13) {
                gVar.h(i0.a.d(Math.max(0.0f, gVar.n), i10, (i12 == 1 ? layout.getPaint() : j6.o2).getColor()));
            } else {
                gVar.h(i10);
            }
            gVar.draw(canvas);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (eVarArr[0] == null) {
            ...
            i10 = 128;
            iVar.a(new Canvas((Bitmap) eVarArr[0].b), new Rect(0, 0, i11, i11));
            iVar.g.setShader((BitmapShader) eVarArr[0].c);
        ...
        if (LiteMode.isEnabled(i10)) {
            ...
            if (iVar2.l || rect.isEmpty()) {
                return;
            }
            iVar2.l = true;
            Choreographer.getInstance().postFrameCallback(iVar2.n);
        }
    }
