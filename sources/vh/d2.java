...
public final class d2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, d2 d2Var) {
        ...
        d2Var.a = x5.l(richText).length() + d2Var.a;
    ...
    public static void b(TL_iv.PageBlock pageBlock, int i10, d2 d2Var) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            ...
            d2Var.b = pageblockblockquoteblocks.blocks.size() + d2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockDetails) {
            ...
            d2Var.b = pageblockdetails.blocks.size() + d2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockList) {
            ...
            d2Var.b = pageblocklist.items.size() + d2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            d2Var.b = pageblockorderedlist.items.size() + d2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockTable) {
            ...
            if (arrayList3 != null) {
                d2Var.b = arrayList3.size() + d2Var.b;
