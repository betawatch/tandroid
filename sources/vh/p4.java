...
public final class p4 extends z implements org.telegram.ui.ActionBar.a6, k9, j0 {
    ...
    private void settle(float f10) {
        ...
        if (f10 >= 0.0f || this.T >= size - 1) {
            ...
            this.f0.addUpdateListener(new nh.e5(this, 26));
            this.f0.addListener(new org.telegram.ui.Cells.a4(this, i11, 11));
            this.f0.start();
        }
        i10 = 1;
        int i112 = i10 + this.T;
        ...
        this.f0.setInterpolator(mr.h);
        this.f0.addUpdateListener(new nh.e5(this, 26));
        this.f0.addListener(new org.telegram.ui.Cells.a4(this, i112, 11));
        this.f0.start();
    }
    ...
    public final ImageView h() {
        ...
        if (!this.E || Build.VERSION.SDK_INT < 31) {
            ...
            int i11 = j6.d6;
            imageView.setBackground(new x1(j6.Z(j6.v0(i11, f6Var), j6.v(j6.v0(i11, f6Var), j6.v0(j6.i6, f6Var)), 20, 20)));
        } else {
    ...
    public final void j(Canvas canvas) {
        ...
        Paint paint = p4Var.r;
        if (z4 && (((i10 = p4Var.T) == 0 && p4Var.U < 0.0f) || (i10 == arrayList.size() - 1 && p4Var.U > 0.0f))) {
        ...
        if (size == 1 && arrayList2.size() == 1) {
            ...
            if (rectF.left > 0.5f || rectF.right < max - 0.5f) {
                ...
                ImageReceiver imageReceiver = s4Var.b;
                if (s4Var.b()) {
                    imageReceiver.setImageCoords(rectF2);
                    imageReceiver.setAlpha(s4Var.a.getCurrentAlpha());
        ...
        while (i13 < arrayList.size() && i13 < arrayList2.size()) {
            s4 s4Var2 = (s4) arrayList.get(i13);
            ...
            if (z4) {
                ...
                int i17 = i13 == 0 ? dp : 0;
                s4Var2.a.setRoundRadius(i14, i15, i16, i17);
                s4Var2.b.setRoundRadius(i14, i15, i16, i17);
            } else {
                s4Var2.a.setRoundRadius(i11, i11, i11, i11);
                s4Var2.b.setRoundRadius(i11, i11, i11, i11);
            }
            boolean c3 = s4Var2.c();
            ImageReceiver imageReceiver2 = s4Var2.a;
            if (!c3) {
            ...
            if (tVar != null && tVar.a()) {
                ...
                radialProgress2.o(s4Var2.e.f, true);
                radialProgress2.draw(canvas2);
            }
            t tVar2 = s4Var2.e;
            if (tVar2 != null && tVar2.n && s4Var2.c()) {
                ih.j spoilerEffect = p4Var.getSpoilerEffect();
                ImageReceiver imageReceiver3 = s4Var2.b;
                canvas2.save();
    ...
    public final void k(int i10) {
        ...
        s3.M1(this.a, (t) m9.get(i10), this.K.a);
    }
    ...
    public final void n() {
        ...
        while (true) {
            ...
            s4 s4Var = new s4(this, this.n);
            if (this.L) {
                s4Var.a.onAttachedToWindow();
                s4Var.b.onAttachedToWindow();
                s4Var.a();
            }
            arrayList.add(s4Var);
        }
        while (arrayList.size() > m9.size()) {
            ...
            s4Var2.a.onDetachedFromWindow();
            s4Var2.b.onDetachedFromWindow();
            s4Var2.c = null;
        }
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            s4 s4Var = (s4) arrayList.get(i10);
            s4Var.a.onDetachedFromWindow();
            s4Var.b.onDetachedFromWindow();
            s4Var.c = null;
            i10++;
        }
        ih.j jVar = this.J;
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int dp = i8.b(this.a) > 0 ? AndroidUtilities.dp(16.0f) : 0;
        ...
        if (size3 == 0) {
            ...
            if (size3 != 1) {
                ...
                for (int i22 = 0; i22 < size3; i22++) {
                    s4 s4Var = (s4) arrayList3.get(i22);
                    int i23 = s4Var.e == null ? 0 : s4Var.d() ? s4Var.e.k : s4Var.e.j;
                    if (s4Var.e == null) {
                        i18 = 0;
                    } else {
                        boolean d10 = s4Var.d();
                ...
                for (int i45 = 0; i45 < size3; i45++) {
                    s4 s4Var2 = (s4) arrayList3.get(i45);
                    int i46 = s4Var2.e == null ? 0 : s4Var2.d() ? s4Var2.e.k : s4Var2.e.j;
                    if (s4Var2.e == null) {
                        i14 = 0;
                    } else {
                        boolean d11 = s4Var2.d();
                        t tVar2 = s4Var2.e;
                ...
                int dp4 = i8.b(this.a) <= 0 ? AndroidUtilities.dp(16.0f) : 0;
            ...
            s4 s4Var3 = (s4) arrayList3.get(0);
            int i48 = s4Var3.e == null ? 0 : s4Var3.d() ? s4Var3.e.k : s4Var3.e.j;
            if (s4Var3.e == null) {
                i19 = 0;
            } else {
                boolean d12 = s4Var3.d();
                t tVar3 = s4Var3.e;
