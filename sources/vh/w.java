...
public final class w extends sa {
    ...
    public final org.telegram.ui.Cells.h3 b0;
    ...
    public w(int i10, Context context, Utilities.Callback callback, f6 f6Var) {
        ...
        d6.a(imageView);
        final int i13 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: vh.u
            ...
            public final void onClick(View view) {
                switch (i13) {
                    ...
                    default:
                        w wVar = this.b;
                        org.telegram.ui.Cells.h3 h3Var = wVar.b0;
                        if (!wVar.d0) {
                            ...
                            if (richMessage == null) {
                                ...
                                if (!TextUtils.isEmpty(trim)) {
                                    ...
                                    wVar.e0 = ConnectionsManager.getInstance(wVar.U).sendRequest(tL_messages_composeRichMessageWithAI, new ff.a(wVar, 28));
        ...
        f3Var.setMaxLines(5);
        h3Var.setBackground(j6.b0(AndroidUtilities.dp(20.0f), j6.v0(i14, f6Var)));
        ...
        final int i15 = 1;
        p10.setOnClickListener(new View.OnClickListener(this) { // from class: vh.u
            public final /* synthetic */ w b;
            ...
            public final void onClick(View view) {
                switch (i15) {
                    ...
                    default:
                        w wVar = this.b;
                        org.telegram.ui.Cells.h3 h3Var2 = wVar.b0;
                        if (!wVar.d0) {
                            TL_iv.RichMessage richMessage = wVar.f0;
                            if (richMessage == null) {
                                String trim = h3Var2.b.getText().toString().trim();
                                if (!TextUtils.isEmpty(trim)) {
                                    wVar.d0 = true;
                                    wVar.c0.setLoading(true);
                                    TLRPC.TL_messages_composeRichMessageWithAI tL_messages_composeRichMessageWithAI = new TLRPC.TL_messages_composeRichMessageWithAI();
                                    ...
                                    tL_messages_composeRichMessageWithAI.tone = inputaicomposetonesingleuse;
                                    wVar.e0 = ConnectionsManager.getInstance(wVar.U).sendRequest(tL_messages_composeRichMessageWithAI, new ff.a(wVar, 28));
                                    AndroidUtilities.hideKeyboard(h3Var2.b);
                                    break;
                                }
                            } else {
                                Utilities.Callback callback2 = wVar.V;
        ...
        rl0Var.setPadding(i16, 0, i16, AndroidUtilities.dp(72.0f));
