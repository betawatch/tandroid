...
public final class i {
    ...
    public final a0[] b = new a0[g.C.length];
    public final m5.e[] c = new m5.e[2];
    public int d = 0;
    ...
    public i() {
        ...
        while (true) {
            ...
            a0 a0Var = new a0((char) 0, 9);
            a0Var.c = new float[Math.max(64, 2)];
            a0Var.b = 0;
            a0VarArr[i10] = a0Var;
            i10++;
        }
    ...
    public final void a(Canvas canvas, Rect rect) {
            ...
            if (Rect.intersects(gVar.getBounds(), rect2)) {
                ...
                if (a0VarArr != null) {
                    ...
                    if (length == fArr3.length) {
                        ...
                        int min = (int) Math.min(currentTimeMillis - gVar.j, 34L);
                        ...
                        while (i16 < size) {
                            ...
                            float f23 = f21;
                            float f24 = f15;
                            float min2 = Math.min(cVar.g + f23, cVar.f);
                            cVar.g = min2;
                            float f25 = cVar.a;
                            float f26 = cVar.b;
                            boolean z10 = f25 < f13 || f25 > f24 || f26 < f14 || f26 > f16;
                            if (min2 >= cVar.f || z10) {
                                if (stack.size() < i15) {
                                    stack.push(cVar);
                                }
                                ...
                                float f27 = cVar.e * f22;
                                cVar.a = (cVar.c * f27) + f25;
                                cVar.b = (cVar.d * f27) + f26;
                                size = i17;
                            }
                            i16++;
                            f21 = f23;
                        ...
                        if (size2 < i15) {
                            ...
                            while (i21 < i19) {
                                ...
                                int i23 = i22 + 1;
                                i22 = i23 == i20 ? 0 : i23;
                                c cVar2 = !stack.isEmpty() ? (c) stack.pop() : new c();
                                int i24 = 0;
                                while (true) {
                                    cVar2.a = (Utilities.fastRandom.nextFloat() * width) + f11;
                                ...
                                cVar2.g = 0.0f;
                                cVar2.f = Utilities.fastRandom.nextInt(2000) + MediaDataController.MAX_STYLE_RUNS_COUNT;
                                cVar2.e = (f32 * 6.0f) + 4.0f;
                        ...
                        for (int i36 = 0; i36 < length2; i36++) {
                            a0 a0Var2 = a0VarArr[i36];
                            float[] fArr5 = fArr[i36];
                            int i37 = iArr5[i36];
                            int i38 = a0Var2.b + i37;
                            float[] fArr6 = (float[]) a0Var2.c;
                            if (i38 > fArr6.length) {
                                a0Var2.c = Arrays.copyOf((float[]) a0Var2.c, Math.max(i38, fArr6.length * 2));
                            }
                            System.arraycopy(fArr5, 0, (float[]) a0Var2.c, a0Var2.b, i37);
                            a0Var2.b += i37;
                        }
                        i14 = i10 + 1;
                        rect2 = rect;
        ...
        g gVar2 = (g) this.i.get(0);
        gVar2.getClass();
        float[] fArr7 = g.C;
        if (a0VarArr == null || a0VarArr.length != fArr7.length) {
            return;
        }
        for (int i39 = 0; i39 < fArr7.length; i39++) {
            a0 a0Var3 = a0VarArr[i39];
            Paint paint = gVar2.a[i39];
            int i40 = a0Var3.b;
            if (i40 > 0) {
                canvas.drawPoints((float[]) a0Var3.c, 0, i40, paint);
            }
        }
    }
}
