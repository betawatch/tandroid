...
public abstract class x4 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i13 < size) {
            ...
            aj0 aj0Var = (spanned == null || span != null) ? 0 : (aj0) a(spanned, i14, i15, aj0.class);
            if (span == null && aj0Var == 0) {
                CharSequence subSequence = charSequence.subSequence(i14, i15);
                TL_iv.pageBlockParagraph pageblockparagraph2 = new TL_iv.pageBlockParagraph();
                pageblockparagraph2.text = y5.f(subSequence);
                arrayList.add(pageblockparagraph2);
            } else {
                CodeHighlighting.Span span2 = span != null ? span : aj0Var;
                while (true) {
                    if (i13 >= size) {
                        i10 = length;
                        break;
                    ...
                    if ((span != null ? a(spanned, i16, length, CodeHighlighting.Span.class) : a(spanned, i16, length, aj0.class)) != span2) {
                        break;
                    }
                    i15 = length;
                    i13 = i17;
                ...
                if (span != null) {
                    ...
                    pageblockpreformatted.text = y5.f(subSequence2);
                    String str = span.lng;
                    if (str == null) {
                        str = "";
                    }
                    ...
                    pageblockblockquote.text = y5.f(subSequence2);
                    pageblockblockquote.caption = new TL_iv.textEmpty();
                    pageblockblockquote.collapsed = aj0Var != 0 && aj0Var.e;
        ...
        while (it.hasNext()) {
            ...
            if (pageBlock != null) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                    SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(y5.r(pageBlock.text, pageBlock, true));
                    ...
                    if (z4 || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                        spannableStringBuilder = h(y5.r(pageBlock.text, pageBlock, true), z4 ? ((TL_iv.pageBlockBlockquote) pageBlock).caption : ((TL_iv.pageBlockPullquote) pageBlock).caption);
                        ...
                        if (arrayList4 != null && !arrayList4.isEmpty()) {
                            ...
                            while (i10 < size) {
                                ...
                                SpannableStringBuilder r11 = pageListItem2 instanceof TL_iv.TL_pageListItemText ? y5.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true) : pageListItem2 instanceof TL_iv.TL_pageListItemBlocks ? c(((TL_iv.TL_pageListItemBlocks) pageListItem2).blocks) : null;
                                if (r11 != null) {
                        ...
                        SpannableStringBuilder r13 = y5.r(pageblocktable.title, null, true);
                            ...
                            while (i12 < size3) {
                                ...
                                if (arrayList10 != null && !arrayList10.isEmpty()) {
                                    ...
                                    for (int i13 = 0; i13 < pagetablerow2.cells.size(); i13++) {
                                        ...
                                        spannableStringBuilder5.append((CharSequence) y5.r(pagetablerow2.cells.get(i13).text, null, true));
                                    }
                        ...
                        ?? l10 = l(1, y5.r(pageBlock.text, pageBlock, true));
                        if (!TextUtils.isEmpty(l10)) {
                            spannableStringBuilder = l10;
                        }
                    } else if (pageBlock instanceof TL_iv.pageBlockAuthorDate) {
                        spannableStringBuilder = y5.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                        ...
                        spannableStringBuilder = y5.r(pageBlock.text, pageBlock, true);
                    } else if (pageBlock.caption != null) {
                        SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder();
                        SpannableStringBuilder r14 = y5.r(pageBlock.caption.text, null, true);
                        if (!TextUtils.isEmpty(r14)) {
                            spannableStringBuilder6.append((CharSequence) r14);
                        }
                        SpannableStringBuilder r15 = y5.r(pageBlock.caption.credit, null, true);
                ...
                if (aVar == null) {
                    ...
                    if (!aVar.i && aVar.c <= 0) {
                        ...
                        if (!(pageBlock instanceof TL_iv.pageBlockPullquote)) {
                            boolean z4 = pageBlock instanceof TL_iv.pageBlockBlockquote;
                            if (arrayList2.size() + (z4 ? 1 : 0) <= 1 && (!z4 || (richText = ((TL_iv.pageBlockBlockquote) pageBlock).caption) == null || (richText instanceof TL_iv.textEmpty) || y5.l(richText).isEmpty())) {
                                if (hashMap != null && !arrayList2.isEmpty()) {
                                    ...
                                    while (i11 < size2) {
                                        ...
                                        if (richText2 != null && !(richText2 instanceof TL_iv.textEmpty) && !y5.l(richText2).isEmpty()) {
                                            break;
                                        }
                                    }
                                }
    ...
    public static SpannableStringBuilder h(SpannableStringBuilder spannableStringBuilder, TL_iv.RichText richText) {
        ...
        aj0.b(spannableStringBuilder2, 0, spannableStringBuilder2.length(), false);
    ...
    public static SpannableStringBuilder i(a aVar, boolean z4) {
        ...
        if (z4) {
            TL_iv.PageBlock pageBlock = aVar.b;
            r10 = y5.r(pageBlock != null ? pageBlock.text : null, pageBlock, false);
        } else {
            TL_iv.PageBlock pageBlock2 = aVar.b;
            r10 = y5.r(pageBlock2 != null ? pageBlock2.text : null, pageBlock2, true);
        }
        ...
        while (list != null && i10 < list.size()) {
            ...
            if (aVar.k.isEmpty()) {
                ...
                if ((pageBlock instanceof TL_iv.pageBlockBlockquote) || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(z4 ? y5.r(pageBlock.text, pageBlock, false) : y5.r(pageBlock.text, pageBlock, true));
                    TL_iv.PageBlock pageBlock2 = aVar.b;
                    boolean z10 = (pageBlock2 instanceof TL_iv.pageBlockBlockquote) && ((TL_iv.pageBlockBlockquote) pageBlock2).collapsed;
                    if (spannableStringBuilder.length() > 0) {
                        aj0.b(spannableStringBuilder, 0, spannableStringBuilder.length(), z10);
                    }
                    arrayList.add(spannableStringBuilder);
                } else {
    ...
    public static SpannableStringBuilder k(ArrayList arrayList) {
        ...
        y5.o(spannableStringBuilder, 0, length, 65536, false, null);
        y5.o(spannableStringBuilder, 0, length, 16384, false, null);
        y5.o(spannableStringBuilder, 0, length, 32768, false, null);
