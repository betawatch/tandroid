...
public final class r5 implements d1 {
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(htmlText)) {
                        ...
                        try {
                            ...
                            if (!v42.isEmpty() && ((v42.size() != 1 || !s3.E3((a) v42.get(0))) && (indexOf = s3Var.i3.indexOf(aVar)) >= 0)) {
    ...
    public final void g1(e1 e1Var) {
        ...
        Editable text;
        w5 w5Var = this.a;
        if (w5Var.y == null || w5Var.x == null) {
            return;
        }
        String obj = e1Var.getText().toString();
        ((b3) w5Var.y).a.e3.t(w5Var, null);
        String b10 = w5.b(obj);
        if (b10 != null) {
        ...
        if (q10 != 0) {
            ((b3) w5Var.y).c(w5Var.x, q10);
            return;
        }
        v5 r10 = w5.r(e1Var.getText().toString(), w5Var.x);
        if (r10 != null) {
            ((b3) w5Var.y).d(w5Var.x, r10.a, r10.b, r10.c, r10.d, r10.e);
            return;
        }
        if ((w5Var.x.b instanceof TL_iv.pageBlockPullquote) && w5Var.f.length() > 0) {
            w5Var.i();
            return;
        }
        t5 t5Var = w5Var.y;
        ...
        if (z10) {
            ...
            SpannableStringBuilder A = w5.A(aVar.b);
            length = A.length();
            spanned = A;
        }
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
            ...
            if (richText != null && !(richText instanceof TL_iv.textEmpty)) {
                s3Var.j3.put(Long.valueOf(a10), richText);
            }
    ...
    public final boolean h0(e1 e1Var) {
        ...
        return s3.P1(((b3) t5Var).a, aVar, false);
    }
    ...
    public final void l1(Editable editable) {
        ...
        w5Var.E(editable);
        w5Var.J();
        w5.d(w5Var.x.b, editable);
        w5Var.C();
        w5Var.G();
        int i10 = 0;
        if (w5Var.o() && !w5Var.l()) {
            ((TL_iv.pageBlockBlockquote) w5Var.x.b).collapsed = false;
        }
        w5Var.H();
        t5 t5Var = w5Var.y;
        if (t5Var != null) {
        ...
        t5 t5Var2 = w5Var.y;
        if (t5Var2 != null) {
            ((b3) t5Var2).a.e3.t(w5Var, w5.b(editable.toString()));
        }
        ...
        if (i10 == 0 || w5Var.y == null) {
            v5 s6 = w5.s(editable.toString(), w5Var.x);
            if (s6 != null && w5Var.y != null) {
                w5Var.post(new tf.k1(this, w5Var.x, s6, 12));
            }
        } else {
            w5Var.post(new gu0(this, w5Var.x, i10, 19));
        }
        if (w5Var.Q || ((aVar = w5Var.x) != null && (aVar.b instanceof TL_iv.pageBlockPullquote))) {
            w5Var.invalidate();
        }
    }
    ...
    public final void n1(e1 e1Var, int i10, int i11) {
        ...
        w5 w5Var = this.a;
        if (w5Var.C || i10 == i11 || (t5Var = w5Var.y) == null || (textSelectionHelper = ((b3) t5Var).a.getTextSelectionHelper()) == null) {
            return;
        }
