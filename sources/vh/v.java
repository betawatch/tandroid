...
public final class v extends sa {
    ...
    public v(int i10, Context context, Utilities.Callback callback, f6 f6Var) {
        ...
        d6.a(imageView);
        final int i13 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: vh.t
            ...
            public final void onClick(View view) {
                switch (i13) {
                    ...
                    default:
                        v vVar = this.b;
                        org.telegram.ui.Cells.i3 i3Var = vVar.b0;
                        if (!vVar.d0) {
                            ...
                            if (richMessage == null) {
                                ...
                                if (!TextUtils.isEmpty(trim)) {
                                    ...
                                    vVar.e0 = ConnectionsManager.getInstance(vVar.U).sendRequest(tL_messages_composeRichMessageWithAI, new gf.a(vVar, 28));
        ...
        g3Var.setMaxLines(5);
        i3Var.setBackground(j6.b0(AndroidUtilities.dp(20.0f), j6.v0(i14, f6Var)));
        ...
        final int i15 = 1;
        p10.setOnClickListener(new View.OnClickListener(this) { // from class: vh.t
            public final /* synthetic */ v b;
            ...
            public final void onClick(View view) {
                switch (i15) {
                    ...
                    default:
                        v vVar = this.b;
                        org.telegram.ui.Cells.i3 i3Var2 = vVar.b0;
                        if (!vVar.d0) {
                            TL_iv.RichMessage richMessage = vVar.f0;
                            if (richMessage == null) {
