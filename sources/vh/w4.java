...
public abstract class w4 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i13 < size) {
            ...
            zi0 zi0Var = (spanned == null || span != null) ? 0 : (zi0) a(spanned, i14, i15, zi0.class);
            if (span == null && zi0Var == 0) {
                ...
                CodeHighlighting.Span span2 = span != null ? span : zi0Var;
                while (true) {
                    if (i13 >= size) {
                        i10 = length;
                        break;
                    ...
                    if ((span != null ? a(spanned, i16, length, CodeHighlighting.Span.class) : a(spanned, i16, length, zi0.class)) != span2) {
                        break;
                    }
                    i15 = length;
                    i13 = i17;
                ...
                if (span != null) {
                    ...
                    pageblockblockquote.collapsed = zi0Var != 0 && zi0Var.e;
                    ...
                    if (z4 || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                        ...
                        if (arrayList6 != null && !arrayList6.isEmpty()) {
                            ...
                            while (i10 < size2) {
                                ...
                                if (r12 != null) {
                                    SpannableStringBuilder spannableStringBuilder4 = new SpannableStringBuilder(v2.k(!TextUtils.isEmpty(pageListOrderedItem2.num) ? pageListOrderedItem2.num : String.valueOf(i11), ".  "));
    ...
    public static SpannableStringBuilder h(SpannableStringBuilder spannableStringBuilder, TL_iv.RichText richText) {
        ...
        zi0.b(spannableStringBuilder2, 0, spannableStringBuilder2.length(), false);
            ...
            if (aVar.k.isEmpty()) {
                ...
                if ((pageBlock instanceof TL_iv.pageBlockBlockquote) || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    ...
                    if (spannableStringBuilder.length() > 0) {
                        zi0.b(spannableStringBuilder, 0, spannableStringBuilder.length(), z10);
                    }
                    arrayList.add(spannableStringBuilder);
                } else {
