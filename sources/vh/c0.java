...
public final class c0 extends View {
    ...
    public c0(f0 f0Var, Context context, TL_keyboard.PageButton pageButton, int i10) {
        ...
        this.f = f0Var;
        this.b = i10;
        RichMessageLayout.RichButton createEditorPageButton = RichMessageLayout.createEditorPageButton(f0Var.n, kf.k0.c(32.0f, AndroidUtilities.displaySize.x, AndroidUtilities.dp(240.0f)), f0Var.r, pageButton, new ga(this, 27));
