...
public final class o4 extends y implements a6, l9, i0 {
    ...
    public o4(Context context, f6 f6Var) {
        ...
        h0 h0Var = new h0(context, f6Var, new org.telegram.ui.Cells.f1(this, 28));
        this.v = h0Var;
        addView(h0Var.a, b6.e(-2, -2, 51));
    ...
    public final void j(Canvas canvas) {
        ...
        while (i13 < arrayList.size() && i13 < arrayList2.size()) {
            ...
            s sVar2 = r4Var2.e;
            if (sVar2 != null && sVar2.n && r4Var2.c()) {
                ih.j spoilerEffect = o4Var.getSpoilerEffect();
    ...
    public final void k(int i10) {
        ...
        List m9 = m();
        if (m9.isEmpty() || (m9.size() == 1 && ((s) m9.get(0)).a == 0)) {
            k3 k3Var = this.K;
            a aVar = this.a;
            r3 r3Var = k3Var.a;
            r3Var.Y3 = aVar;
        ...
        if (i10 < 0 || i10 >= m9.size() || !((s) m9.get(i10)).a()) {
            return;
        }
        r3.N1(this.a, (s) m9.get(i10), this.K.a);
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        while (true) {
            ...
            if (i18 < m9.size() && ((s) m9.get(i18)).a != 0) {
