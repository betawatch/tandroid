...
public final class f implements n5.b {
    ...
    public boolean C(r rVar, int i10) {
        ...
        if (eVar != null) {
            ...
            Iterator<E> it = h1Var.a.iterator();
            while (it.hasNext()) {
                if (((g1) it.next()).a == i10) {
                    return true;
                }
        ...
        synchronized (this.a) {
            try {
                ...
                if (t10 == null) {
                    ...
                    vVar.c = new Object();
                    vVar.d = new a0.f(0);
                    fVar.put(rVar, new m4.e(obj, vVar, h1Var, x0Var));
                } else {
    ...
    @Override // fd.a
    public Object get() {
        return new t((Executor) ((fd.a) this.a).get(), (s5.d) ((fd.a) this.b).get(), (la.h) ((la.h) this.c).get(), (t5.c) ((fd.a) this.d).get(), 9);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0063, code lost:
        ...
        throw new java.lang.Exception(v7.j.g("Premature end of parens in ", r13));
     */
    /*
