...
public final class y2 {
    ...
    public y2(Context context, WindowManager windowManager, View view, WindowManager.LayoutParams layoutParams) {
        ...
        this.f = view;
        this.g = layoutParams;
        this.b = new v2(this, context, 0);
        this.c = new v2(this, context, 1);
        paint.setAlpha(0);
    }
    ...
    public final void e(float f7, long j3, Runnable runnable) {
        ...
        this.i.addListener(new bi.h2(this, f7, runnable, 1));
    ...
    public final void g() {
        ...
        int i11 = this.n;
        v2 v2Var = this.b;
        if (i10 == i11 && this.j == v2Var.getMeasuredWidth() && this.k == v2Var.getMeasuredHeight() && Math.abs(this.m - this.h) <= 0.005f) {
            return;
        }
        this.l = this.n;
        this.j = v2Var.getMeasuredWidth();
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            this.r = android.support.v4.media.session.y.b(f7, f10, min, jArr, fArr);
        } else {
