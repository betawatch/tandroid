...
public final /* synthetic */ class f1 implements View.OnClickListener {
    ...
    public /* synthetic */ f1(s1 s1Var, TLRPC.TL_messages_preparedInlineMessage tL_messages_preparedInlineMessage, org.telegram.tgnet.g gVar, int i10, long j3, org.telegram.ui.web.t tVar) {
        this.d = s1Var;
    ...
    public final void onClick(View view) {
        ...
        switch (this.a) {
            case 0:
                ...
                final org.telegram.tgnet.g gVar = (org.telegram.tgnet.g) this.f;
                ...
                if (U != null) {
                    ...
                    q1Var.C2 = new qy() { // from class: di.g1
                        ...
                        public final boolean v(wy wyVar, ArrayList arrayList2, CharSequence charSequence, boolean z10, boolean z11, int i12, int i13, ig1 ig1Var) {
                            ...
                            if (!s1Var2.c0) {
                                s1Var2.c0 = true;
                                gVar.run(arrayList3.size() > 0 ? null : "USER_DECLINED", arrayList3);
                            }
                            if (ig1Var == null) {
                ...
                if (e0Var.s.W) {
                    ...
                    if (!MessagesController.getInstance(i12).isFrozen()) {
                        ...
                        if (!e0Var.c && (l4 == null || l4.b < e0Var.H.b)) {
                            ...
                            if (bVar != yf.b.a) {
                                if (bVar == yf.b.b) {
                                    new ci.i(context, f6Var, aVar, true, null).show();
                                    break;
                                }
                            } else {
                                long a2 = aVar.a();
    ...
    public /* synthetic */ f1(fg0 fg0Var, String str, long j3, String str2, String str3, int i10) {
        this.d = fg0Var;
        this.e = str;
        this.b = j3;
        this.f = str2;
    ...
    public /* synthetic */ f1(xh.e0 e0Var, eo eoVar, int i10, Context context, f6 f6Var, long j3, Utilities.Callback callback) {
        this.d = e0Var;
        this.c = i10;
        this.e = context;
        this.f = f6Var;
