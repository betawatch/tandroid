...
public final class i9 extends FrameLayout {
    ...
    public /* synthetic */ i9(Context context) {
        super(context);
    }
    ...
    */
    ...
    public i9(gi.k0 k0Var, Context context) {
        super(context);
        this.e = k0Var;
        this.b = new org.telegram.ui.Components.e6(this, 250L, pr.h);
        this.d = new Path();
    }
