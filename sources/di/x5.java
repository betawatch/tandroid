...
public final class x5 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.a) {
            case 4:
                ...
                ((f01) this.b).e(canvas, ((vc0) this.c).getX() - AndroidUtilities.dp(50.0f), getHeight() / 2.0f);
                break;
            case 5:
                canvas.save();
                org.telegram.ui.Components.e6 e6Var = (org.telegram.ui.Components.e6) this.b;
                v21 v21Var = (v21) this.c;
                float e7 = e6Var.e(v21Var.w);
                if (e7 > 0.0f) {
                    if (v21Var.c == null) {
                        v21Var.c = new zo0(this);
                    }
                    canvas.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                    v21Var.c.a(canvas, e7);
                    canvas.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
                }
                super.dispatchDraw(canvas);
                canvas.restore();
        ...
        switch (this.a) {
            case 0:
                ...
                if (layout != null) {
                    ...
                    float interpolation = layout2 == null ? 0.0f : pr.f.getInterpolation(q6Var.a1);
            ...
            case 8:
                ...
                TextView textView3 = (TextView) getChildAt(o0Var.g1);
                int i11 = o0Var.h1;
                ...
                float interpolation2 = layout4 == null ? 0.0f : pr.f.getInterpolation(o0Var.i1);
    ...
    public x5(v21 v21Var, Context context) {
        ...
        this.a = 5;
        this.c = v21Var;
        this.b = new org.telegram.ui.Components.e6(this, 360L, pr.h);
    }
