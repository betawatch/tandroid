...
public final class m6 extends FrameLayout {
    public float a;
    public float b;
    public final /* synthetic */ qg.s0 c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = rbVar.y1;
        Paint paint2 = rbVar.x1;
        Paint paint3 = rbVar.z1;
        ...
        if (childAt.getAlpha() != 0.0f) {
            ...
            View view = childAt;
            if (i11 != -1) {
                ViewGroup viewGroup = i11 == 0 ? rbVar.k1 : i11 == 2 ? rbVar.l1 : null;
                ...
                x10 = AndroidUtilities.lerp(x10, (((childAt2.getWidth() - childAt2.getPaddingLeft()) - childAt2.getPaddingRight()) / 2.0f) + childAt2.getX() + childAt2.getPaddingLeft(), rbVar.a1);
                y3 = AndroidUtilities.lerp(y3, (((childAt2.getHeight() - childAt2.getPaddingTop()) - childAt2.getPaddingBottom()) / 2.0f) + childAt2.getY() + childAt2.getPaddingTop(), rbVar.a1);
            }
            if (r5Var != null && r5Var.getChildCount() > 0) {
                ...
                i10 = i0.a.d(rbVar.D1, q1Var.a, this.c.b(0));
            }
            float f7 = x10;
            float f10 = y3;
