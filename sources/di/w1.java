        ...
        try {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    v1 v1Var = new v1();
                    v1Var.a = next;
                    v1Var.b = jSONObject2.getLong("user_id");
                    v1Var.c = jSONObject2.getString("user_name");
                    v1Var.d = jSONObject2.getLong("created_at");
                    v1Var.e = jSONObject2.getLong("edited_at");
                    hashMap.put(next, v1Var);
                }
                return hashMap;
    ...
    public static void k(HashMap hashMap) {
        try {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                jSONObject2.put("user_id", ((v1) entry.getValue()).b);
                jSONObject2.put("user_name", ((v1) entry.getValue()).c);
    ...
    public final File c() {
        ...
        if (this.d && TextUtils.isEmpty(this.e)) {
            ...
            if (TextUtils.isEmpty(this.e)) {
                ...
                v1Var.a = uuid;
                v1Var.b = j3;
                v1Var.c = DialogObject.getName(UserConfig.getInstance(this.a).getCurrentUser());
                long currentTimeMillis = System.currentTimeMillis();
                v1Var.e = currentTimeMillis;
                v1Var.d = currentTimeMillis;
                i10.put(this.e, v1Var);
                k(i10);
            }
        }
        return d(this.e);
