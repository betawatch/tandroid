...
public final class l4 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void c(Runnable runnable, boolean z10) {
        ...
        d dVar = k4Var.b;
        k4Var.animate().alpha(this.y ? 1.0f : 0.0f).setInterpolator(pr.h).setDuration(320L).withEndAction(new ah.u(3, this, z10)).start();
        dVar.setVisibility((!z10 || runnable == null) ? 8 : 0);
        dVar.setOnClickListener(runnable == null ? null : new ci.o(1, runnable));
    }
        ...
        if (this.s != j3) {
            ...
            if (j3 == 0) {
                ...
                if (j3 > 0) {
                    ...
                    int d = user != null ? org.telegram.ui.Components.i9.d(user.id) : i0.a.d(0.2f, -16777216, -1);
                    x9Var.getImageReceiver().setImage(ImageLocation.getForPath(absolutePath), "500_500_nocache", forUser, "50_50_b2", null, null, new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{i0.a.d(0.2f, d, -16777216), i0.a.d(0.4f, d, -16777216)}), 0L, null, user, 0);
                } else {
                    ...
                    int d10 = chat != null ? org.telegram.ui.Components.i9.d(chat.id) : i0.a.d(0.2f, -16777216, -1);
                    x9Var.getImageReceiver().setImage(ImageLocation.getForPath(absolutePath), "500_500_nocache", forChat, "50_50_b2", null, null, new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{i0.a.d(0.2f, d10, -16777216), i0.a.d(0.4f, d10, -16777216)}), 0L, null, chat, 0);
                }
            }
        }
        this.s = j3;
        this.v = n5Var;
        if (this.r && n5Var != null && !n5Var.a) {
            n5Var.a = true;
            n5Var.b();
        }
        boolean z10 = (n5Var == null || (t1Var2 = (bi.t1) n5Var.b) == null || !t1Var2.n()) ? false : true;
        if (n5Var == null || (t1Var = (bi.t1) n5Var.b) == null || !t1Var.a()) {
            k1Var = null;
        } else {
            bi.t1 t1Var3 = (bi.t1) n5Var.b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.liveStoryUpdated) {
            ...
            bi.n5 n5Var = this.v;
            if (n5Var == null || (t1Var = (bi.t1) n5Var.b) == null || t1Var.g() != longValue) {
                return;
            }
            boolean n10 = ((bi.t1) this.v.b).n();
            if (((bi.t1) this.v.b).a()) {
                bi.t1 t1Var2 = (bi.t1) this.v.b;
    ...
    public final void e(boolean z10, boolean z11) {
        if (z10 || !z11) {
            if (z11) {
                wl.q(getTextureView().animate().alpha(z10 ? 1.0f : 0.0f), pr.h, 320L);
            } else {
