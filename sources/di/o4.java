        ...
        switch (i11) {
            ...
            case 24:
                ...
                if (!xu0.w0(profileActivity.O.getClosestTab())) {
                    ...
                    org.telegram.messenger.s8 s8Var = profileActivity.x5;
                    if (s8Var != null) {
                        s8Var.run();
                    ...
                    if (!arrayList6.isEmpty()) {
                        ...
                        boolean[] zArr3 = {false};
                        boolean z13 = z12;
                        profileActivity.x5 = new org.telegram.messenger.s8(profileActivity, clientUserId, arrayList6, z13, 9);
                    ...
                    org.telegram.messenger.s8 s8Var2 = profileActivity.x5;
                    if (s8Var2 != null) {
                        s8Var2.run();
                        profileActivity.x5 = null;
                    }
                    ...
                    if (!arrayList7.isEmpty()) {
                        org.telegram.messenger.i7 i7Var = new org.telegram.messenger.i7(profileActivity, a2, h12, arrayList7, 13);
                        profileActivity.getMessagesController().getStoriesController().c0(h12, a2, arrayList7);
                        org.telegram.ui.Components.yc.a0(profileActivity).J(R.raw.chats_archived, AndroidUtilities.replaceTags(LocaleController.formatPluralString("StoryRemovedFromAlbumTitle", arrayList7.size(), w10)), LocaleController.getString(R.string.UndoNoCaps), i7Var).j();
                        break;
                    }
                }
                break;
