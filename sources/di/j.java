...
public final class j extends FrameLayout {
    ...
    public j(Context context, f6 f6Var) {
        ...
        FrameLayout.LayoutParams d = a6.d(28, 28.0f, 51, 17.0f, 14.33f, 0.0f, 0.0f);
        this.b = d;
        addView(imageView, d);
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        FrameLayout.LayoutParams d10 = a6.d(-1, -2.0f, 55, 62.0f, 10.0f, 40.0f, 8.66f);
        this.c = d10;
        ...
        TextView g10 = com.google.android.gms.internal.vision.e2.g(linearLayout, textView, a6.t(-1, -2, 55, 0, 0, 0, 0), context);
        this.e = g10;
        g10.setTextSize(1, 14.0f);
        g10.setTextColor(j6.v0(j6.z6, f6Var));
        linearLayout.addView(g10, a6.t(-1, -2, 55, 0, 3, 0, 0));
        ...
        addView(textView2, a6.d(-2, 18.0f, 21, 0.0f, 0.0f, 35.33f, 0.0f));
    }
