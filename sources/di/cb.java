    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.a) {
            case 0:
                ...
                int i10 = pcVar.c;
                if (obj != null && pcVar.p2 == null && !pcVar.W && pcVar.J()) {
                    int i11 = 0;
                    if (!this.b) {
                        pcVar.i0(false, true);
                        pcVar.Q0.a(pcVar.O1);
                        ...
                        if (!z11) {
                            if (obj instanceof o8) {
                                ...
                                if (o8Var.L == null && !o8Var.v()) {
                                    pcVar.e1.c(R.raw.error, "Failed to load draft");
                ...
                break;
            case 1:
                gi.k0.m((gi.k0) this.c, this.b, (TLRPC.TL_error) obj2);
                break;
            default:
