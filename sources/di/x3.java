...
public abstract class x3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public x3(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, MediaController.AlbumEntry albumEntry, boolean z10, float f7, boolean z11, boolean z12) {
        ...
        if (z11) {
            ...
            d g10 = vl.g(24, context, f6Var, true);
            this.J = g10;
            ...
            d g11 = vl.g(24, context, f6Var, z12);
    ...
    public final void j() {
        ...
        if (imageView != null) {
            vl.q(imageView.animate().alpha(!isEmpty ? 1.0f : 0.0f).scaleX(!isEmpty ? 1.0f : 0.7f).scaleY(isEmpty ? 0.7f : 1.0f).translationY(!isEmpty ? -AndroidUtilities.navigationBarHeight : AndroidUtilities.dp(8.0f)), pr.h, 320L);
        }
