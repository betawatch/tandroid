...
public abstract class p {
    ...
    public te.b c() {
        ...
        te.b bVar = (te.b) this.f;
        if (bVar != null) {
            while (bVar.i() > 0) {
                if (((ve.a) ((com.google.firebase.messaging.d) bVar.b)).skip(bVar.i()) == 0) {
        ...
        te.b bVar2 = new te.b(readInt == 1 ? new ve.a(dVar, 16L, dataInputStream.readLong() - 16) : new ve.a(dVar, 8L, readInt - 8), this, new String(bArr, "ISO8859_1"), 0);
        this.f = bVar2;
        return bVar2;
    }
