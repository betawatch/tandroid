...
public abstract class n5 {
    ...
    public static float[] c(float[] fArr, float[] fArr2) {
        ...
        float f53 = (f29 * f50) + (f28 * f49) + (f27 * f48) + (f26 * f47);
        float f54 = f50 * f35;
        ...
        float f61 = fArr2[15];
        return new float[]{f19, f25, f31, f37, f42, f43, f44, f46, f51, f52, f53, f55, (f16 * f61) + f60, (f23 * f61) + (f22 * f59) + (f21 * f57) + (f20 * f56), (f29 * f61) + (f28 * f59) + (f27 * f57) + (f26 * f56), (f35 * f61) + (f34 * f59) + (f33 * f57) + (f32 * f56)};
    }
}
