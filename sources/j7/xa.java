...
public class xa extends AbstractMap {
    ...
    public q8.v a(Map.Entry entry) {
        ...
        q8.h0 h0Var = (q8.h0) this.e;
        List list = (List) ((Collection) entry.getValue());
        return new q8.v(key, list instanceof RandomAccess ? new q8.f(h0Var, key, list, null) : new e(h0Var, key, list, (e) null));
    }
    ...
    public final Object get(Object obj) {
        ...
        switch (this.a) {
            ...
            default:
                ...
                return list3 instanceof RandomAccess ? new q8.f(h0Var, obj, list3, null) : new e(h0Var, obj, list3, (e) null);
        }
    }
    ...
    public Set keySet() {
        switch (this.a) {
            ...
            default:
                ...
                if (cVar == null) {
                    Map map = h0Var.d;
                    cVar = map instanceof NavigableMap ? new q8.e(h0Var, (NavigableMap) map) : map instanceof SortedMap ? new q8.h(h0Var, (SortedMap) map) : new q8.c(h0Var, map);
                    h0Var.a = cVar;
                }
                return cVar;
        }
