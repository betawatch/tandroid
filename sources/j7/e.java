...
public class e extends AbstractCollection implements List {
    ...
    public void i() {
        ...
        if (eVar != null) {
            ...
            ((q8.h0) this.f).d.put(this.b, this.c);
        }
    }
    ...
    public void n() {
        ...
        if (eVar != null) {
            ...
            if (!this.c.isEmpty() || (collection = (Collection) ((q8.h0) this.f).d.get(this.b)) == null) {
                return;
            }
            this.c = collection;
        }
    ...
    public final List subList(int i10, int i11) {
        switch (this.a) {
            ...
            default:
                ...
                Object obj3 = this.b;
                return z12 ? new q8.f(h0Var, obj3, subList3, eVar3) : new e(h0Var, obj3, subList3, eVar3);
        }
    }
