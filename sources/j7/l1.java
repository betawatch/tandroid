...
public abstract /* synthetic */ class l1 {
    ...
    public static s9.c s(int i10, oc.i iVar) {
        ...
        if (((HashMap) iVar.c) == null) {
            iVar.c = new HashMap();
        }
        ((HashMap) iVar.c).put(l7.w.class, sVar);
        return new s9.c((String) iVar.b, ((HashMap) iVar.c) == null ? Collections.EMPTY_MAP : DesugarCollections.unmodifiableMap(new HashMap((HashMap) iVar.c)));
    }
