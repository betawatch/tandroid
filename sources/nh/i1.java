...
public final class i1 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        for (View view : viewPages) {
            if (view instanceof u1) {
                u1 u1Var = (u1) view;
                k2Var.x += Utilities.clamp(1.0f - Math.abs(u1Var.getTranslationX() / u1Var.getMeasuredWidth()), 1.0f, 0.0f) * u1Var.b();
                if (u1Var.getVisibility() == 0) {
                    u1Var.c();
                }
            }
        }
        float d = this.h.d(k2Var.x <= 0.0f ? 1.0f : 0.0f, false);
        float paddingTop = (k2Var.x + g1Var.getPaddingTop()) - AndroidUtilities.lerp(AndroidUtilities.dp(8.0f), g1Var.getPaddingTop(), d);
        ...
        float f9 = 1.0f - d;
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(14.0f) * f9, AndroidUtilities.dp(14.0f) * f9, paint);
        RectF rectF2 = this.n;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.d == null) {
            ...
            if (k2Var.w == null || SharedConfig.getDevicePerformanceClass() <= 0 || LiteMode.isPowerSaverApplied()) {
                return;
            }
            Point point = AndroidUtilities.displaySize;
            Bitmap createBitmap = Bitmap.createBitmap(point.x / 16, point.y / 16, Bitmap.Config.ARGB_8888);
            k2Var.w.run(createBitmap, Float.valueOf(16.0f));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        g1Var.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
        j2 j2Var = k2Var.h;
        if (j2Var != null) {
            j2Var.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), 0);
        }
