...
public class l6 {
    ...
    public final i6 q = new i6(this, 0);
    public int s = -1;
    public int A = -1;
    ...
    public static boolean e(MessageObject messageObject, boolean z4, boolean z10) {
        ...
        return (z10 && messageObject.isVideo()) || (messageObject.storyItem.media instanceof TLRPC.TL_messageMediaUnsupported);
    }
    ...
    public final void D(List list, boolean z4) {
        ...
        while (true) {
            ...
            if (storyItem2 != null) {
                ...
                boolean contains = abstractSet.contains(valueOf);
                AbstractSet abstractSet2 = this.k;
                boolean z11 = contains || abstractSet2.contains(Integer.valueOf(storyItem2.id));
                boolean z12 = i11 == 1 || storyItem2.pinned;
                if (i10 > 0) {
                    ArrayList<Integer> arrayList2 = storyItem2.albums;
                    z12 = arrayList2 != null && arrayList2.contains(Integer.valueOf(i10));
                }
                ...
                if (z11 != z12) {
                    if (!z12) {
                        kh.a2.t(storyItem2.id, new StringBuilder("StoriesList remove story "));
                ...
                } else if (z11 && z12 && ((messageObject = (MessageObject) hashMap.get(Integer.valueOf(storyItem2.id))) == null || z4 || (storyItem = messageObject.storyItem) == null || (storyItem != storyItem2 && (storyItem.id != storyItem2.id || storyItem.media != storyItem2.media || !TextUtils.equals(storyItem.caption, storyItem2.caption))))) {
                    kh.a2.t(storyItem2.id, new StringBuilder("StoriesList update story "));
    ...
    public final void E(int i10, ArrayList arrayList, boolean z4) {
        ...
        while (i11 < size) {
            ...
            if (messageObject != null && (storyItem = messageObject.storyItem) != null) {
                ...
                boolean remove = z4 ? hashSet.remove(valueOf) : hashSet.add(valueOf);
    ...
    */
    public final void c(ArrayList arrayList, boolean z4, boolean z10) {
    ...
    public int g() {
        ...
        return (z4 && this.n) ? this.s < 0 ? arrayList.size() : Math.max(arrayList.size(), this.s) : arrayList.size();
    }
    ...
    public boolean q(int i10, List list, boolean z4) {
        ...
        int i11;
        if (this.u || ((this.r || this.w || !a()) && !z4)) {
            return false;
        }
        if (this.t) {
            this.y = new k6(this, z4, i10, list);
            return false;
        }
        int i12 = this.e;
        long j10 = this.d;
    ...
    public final void t(MessageObject messageObject, boolean z4) {
        ...
        (z4 ? this.k : this.l).add(Integer.valueOf(messageObject.getId()));
    ...
    public final void z(int i10) {
        ...
        if (!arrayList.isEmpty() || (n4Var = this.x) == null) {
            return;
        }
        AndroidUtilities.cancelRunOnUIThread(n4Var);
