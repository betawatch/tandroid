...
public final class f6 extends l6 {
    ...
    public final boolean q(final int i10, final List list, final boolean z4) {
        ...
        if (isEmpty) {
            ...
            if (tLObject == null) {
                MessagesController.getInstance(i11).getUserNameResolver().resolve(str2, new h5.d() { // from class: nh.e6
                    @Override // h5.d
        ...
        this.I = ConnectionsManager.getInstance(i11).sendRequest(tL_stories_searchPosts, new ff.a(this, 12));
        return true;
    }
