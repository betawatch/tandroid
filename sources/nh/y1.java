...
public final /* synthetic */ class y1 implements Runnable {
    ...
    public /* synthetic */ y1(b3 b3Var, int i10) {
        this.a = i10;
        this.b = b3Var;
    }
        ...
        switch (i10) {
            ...
            case 1:
                if (!b3Var.Y && b3Var.F != 0) {
                    ...
                    if (b3Var.G != 0) {
                        TLRPC.InputReplyTo createReplyInput = SendMessagesHelper.getInstance(b3Var.C).createReplyInput(b3Var.G);
                        tL_messages_prolongWebView.reply_to = createReplyInput;
                        if (b3Var.H != 0) {
                            createReplyInput.monoforum_peer_id = MessagesController.getInstance(b3Var.C).getInputPeer(b3Var.H);
