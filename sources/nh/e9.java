...
public final class e9 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public e9(Context context, int i10, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        j1(context);
        this.b.setAdapter(new c8(this, context, 0));
    ...
    public static int d1(e9 e9Var, TLRPC.Chat chat) {
        Integer num;
        int i10;
        TLRPC.ChatFull chatFull = MessagesController.getInstance(e9Var.currentAccount).getChatFull(chat.id);
    ...
    public final void dismiss() {
        ...
        if (callback != null) {
            ...
            if (i10 == 3) {
                ...
                c9Var = i10 == 2 ? new c9(i10, this.currentAccount, arrayList) : new c9(i10, this.currentAccount, (ArrayList) null);
            }
            this.Q.run(c9Var);
            this.Q = null;
        }
    ...
    public final void f1() {
        ...
        for (View view : this.b.getViewPages()) {
            if ((view instanceof y8) && (r8Var = ((y8) view).x) != null) {
                AndroidUtilities.hideKeyboard(r8Var.a);
            }
        }
    }
    ...
    public final void g1(c9 c9Var, Runnable runnable, boolean z10) {
        ...
        if (arrayList.isEmpty() || z10) {
            ...
            d dVar = view instanceof y8 ? ((y8) view).v : null;
            if (dVar != null) {
                dVar.setLoading(true);
            }
            j8 j8Var = this.P;
            if (j8Var != null) {
                j8Var.e(c9Var, this.w, this.x, this.y, this.C, this.c, this.D, new b6(13, dVar, runnable), new m6(dVar, 2));
                return;
            } else {
                runnable.run();
                return;
    ...
    public final void j1(Context context) {
        ...
        this.containerView.addView(this.b, i7.f6.e(-1, -1, 119));
    }
    ...
    public e9(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        this.V = false;
        j1(context);
        this.b.setAdapter(new c8(this, context, 1));
    }
}
