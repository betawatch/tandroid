...
public final class e0 extends g0 {
    ...
    public e0(j0 j0Var, Context context) {
        ...
        this.c.addView(j0Var.B, e6.g());
        this.c.addView(this.d, e6.g());
        this.c.addView(j0Var.D, e6.g());
        ...
        this.a.setActionBarMenuOnItemClick(new w4(this, 10));
        z8 z8Var = new z8(j0Var.f);
        this.n = z8Var;
        o9 o9Var = new o9(getContext());
        this.h = o9Var;
        o9Var.setRoundRadius(AndroidUtilities.dp(9.0f));
        o9Var.e(j0Var.f, z8Var);
        this.a.addView(o9Var, e6.b(27.33f, 27.33f, 83, 14.33f, 0.0f, 0.0f, 14.33f));
        this.c.addView(this.a, e6.e(-1, 56, 48));
        this.c.addView(j0Var.y, e6.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        ...
        this.c.addView(dVar, e6.f(48.0f, 80, AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + AndroidUtilities.navigationBarHeight));
        a();
    }

    @Override // nh.g0
    public final float b() {
        return ff.m0.b(this.r.b.e) * super.b();
    }
