...
public abstract class v0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public v0(Context context, i9 i9Var, ViewGroup viewGroup, View view, FrameLayout frameLayout) {
        ...
        final int i12 = 1;
        jb1 jb1Var = new jb1(context, i12, null);
        this.f = jb1Var;
        jb1Var.setWillNotDraw(false);
        f2.i0 i0Var2 = new f2.i0(0, false);
        this.h = i0Var2;
        jb1Var.setLayoutManager(i0Var2);
        w51 w51Var = new w51(jb1Var, context, i10, 0, false, new Utilities.Callback2() { // from class: nh.d0
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                int i122 = i12;
                int i13 = 0;
    ...
    public final void u(boolean z4) {
        ...
        if (z4) {
            ...
            jb1Var.animate().translationY(this.G ? 0.0f : AndroidUtilities.dp(35.0f)).alpha(this.G ? 1.0f : 0.0f).setInterpolator(nrVar).setDuration(420L).start();
            return;
        }
        e1Var.setTranslationY(!isEmpty ? 0.0f : AndroidUtilities.dp(35.0f));
        jb1Var.setTranslationY(this.G ? 0.0f : AndroidUtilities.dp(35.0f));
        jb1Var.setAlpha(this.G ? 1.0f : 0.0f);
        invalidate();
    }
}
