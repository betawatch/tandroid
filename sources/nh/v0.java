...
public abstract class v0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Type inference failed for: r6v3, types: [nh.d0] */
    public v0(Context context, i9 i9Var, ViewGroup viewGroup, View view, FrameLayout frameLayout) {
        ...
        this.a0 = new z(g2Var, 1);
        this.c0 = false;
        this.d0 = new z(g2Var, 2);
        this.a = view;
        this.b = frameLayout;
        view.setAlpha(0.5f);
        ...
        final int i11 = 0;
        f0 f0Var = new f0(g2Var, e1Var, context, i10, new Utilities.Callback2() { // from class: nh.d0
            ...
            public final void run(Object obj, Object obj2) {
                ...
                switch (i12) {
                    case 0:
                        ...
                        e1 e1Var2 = g2Var2.M;
                        long j10 = e1Var2 == null ? 0L : e1Var2.j();
                        g2Var2.E = j10;
        ...
        final int i12 = 1;
        rb1 rb1Var = new rb1(context, i12, null);
        this.f = rb1Var;
        rb1Var.setWillNotDraw(false);
        f2.i0 i0Var2 = new f2.i0(0, false);
        this.h = i0Var2;
        rb1Var.setLayoutManager(i0Var2);
        w51 w51Var = new w51(rb1Var, context, i10, 0, false, new Utilities.Callback2() { // from class: nh.d0
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                int i122 = i12;
                int i13 = 0;
        ...
        this.n = w51Var;
        rb1Var.setAdapter(w51Var);
        w51Var.r = false;
        rb1Var.setPadding(AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f), 0);
        rb1Var.setClipToPadding(false);
        addView(rb1Var, k7.b6.d(-1, 26.0f, 87, 0.0f, 0.0f, 0.0f, 9.66f));
        rb1Var.setOnItemClickListener(new lh.m5(g2Var, 7));
        h0 h0Var = new h0();
        h0Var.m = false;
        h0Var.C = false;
        h0Var.o(mrVar);
        h0Var.n(350L);
        rb1Var.setItemAnimator(h0Var);
        u(false);
    }
    ...
    public final void c(int i10) {
        ...
        if (z4) {
            ...
            Collections.sort(arrayList2, new e5.e(this, 26));
            this.n.N(true);
            t();
            u(true);
        }
    ...
    public final void k(boolean z4) {
        ...
        i0 i0Var = new i0(0);
        eb ebVar = new eb(getContext(), this.K, this.J, null, null, arrayList, !z4, true, clientUserId, i0Var);
        g2 g2Var = (g2) this;
        ebVar.K = g2Var;
        ...
        while (i11 < size) {
            ...
            while (i14 < size2) {
                ...
                if (t0Var.g > 0) {
                    ...
                    i10 = i15;
                    i13 = Math.max(i13, t.b(u0Var.a, (int) t0Var.g, 0) + t0Var.d);
                } else {
                    i10 = i15;
                }
    ...
    public final int n(final long j10, final TLRPC.TL_textWithEntities tL_textWithEntities, final long j11) {
        ...
        ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(sendgroupcallmessage, new RequestDelegate() { // from class: nh.x
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (!z10) {
                    if (tL_error != null) {
                        AndroidUtilities.runOnUIThread(new lh.u7(v0Var, i12, tL_error, j11, j10, tL_textWithEntities));
                        return;
                    }
                    return;
                }
    ...
    public final void p() {
        ...
        j6Var.b();
        j6Var.q(kf.k0.l(j10, ',', new StringBuilder("+")), true, true);
        p1 p1Var = r1Var.d;
    ...
    public void setLivePlayer(e1 e1Var) {
        ...
        this.e.N(true);
        ConnectionsManager.getInstance(this.K).getCurrentTime();
        Collections.sort(arrayList4, new e5.e(this, 26));
        this.n.N(true);
        u(false);
    }
    ...
    public final void t() {
        ...
        Collections.sort(arrayList, new e5.e(27));
        int size = arrayList.size();
        int i10 = 0;
        ...
        while (true) {
            rb1 rb1Var = this.f;
            if (i17 >= rb1Var.getChildCount()) {
                break;
            }
            View childAt2 = rb1Var.getChildAt(i17);
    ...
    public final void u(boolean z4) {
        ...
        rb1 rb1Var = this.f;
        if (z4) {
            ViewPropertyAnimator translationY = e1Var.animate().translationY(this.G ? 0.0f : AndroidUtilities.dp(35.0f));
            mr mrVar = mr.h;
            translationY.setInterpolator(mrVar).setUpdateListener(new dg.o1(this, 21)).setDuration(420L).start();
            rb1Var.animate().translationY(this.G ? 0.0f : AndroidUtilities.dp(35.0f)).alpha(this.G ? 1.0f : 0.0f).setInterpolator(mrVar).setDuration(420L).start();
            return;
        }
        e1Var.setTranslationY(!isEmpty ? 0.0f : AndroidUtilities.dp(35.0f));
        rb1Var.setTranslationY(this.G ? 0.0f : AndroidUtilities.dp(35.0f));
        rb1Var.setAlpha(this.G ? 1.0f : 0.0f);
        invalidate();
    }
}
