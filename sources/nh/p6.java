...
public final /* synthetic */ class p6 implements RequestDelegate {
    ...
    public /* synthetic */ p6(s6 s6Var, int i10) {
        this.a = i10;
        this.b = s6Var;
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.a) {
            case 0:
                    ...
                    if (u6Var.b0) {
                        ...
                        while (i15 < updates3.updates.size()) {
                            if (updates3.updates.get(i15) instanceof TL_stories.TL_updateStory) {
                                ...
                                storyItem2.attachPath = s6Var.e;
                                storyItem2.firstFramePath = str;
                                storyItem2.justUploaded = !z10;
                                ...
                                if (storyItem == null) {
                                    ...
                                    while (true) {
                                        ...
                                        if (i19 < arrayList2.size()) {
                                            ...
                                            storyItem.pinned = u6Var.I0 == Integer.MAX_VALUE;
                ...
                } else if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && u6Var.c0 != null && (hVar = u6Var.d0) != null) {
                    hVar.run(new r6(s6Var, 0));
                    u6Var.d0 = null;
                    break;
                } else if (tL_error != null && !z10) {
                    AndroidUtilities.runOnUIThread(new n4(7, s6Var, tL_error));
                }
                AndroidUtilities.runOnUIThread(new q6(s6Var, 1));
                break;
            default:
                AndroidUtilities.runOnUIThread(new x5(this.b.J, 2));
                break;
        }
    }
}
