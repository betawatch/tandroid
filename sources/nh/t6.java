...
public final class t6 {
    ...
    public final void l0(long j10, List list, boolean z4) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                ...
                if (peerStories.stories.get(i12).id == storyItem.id) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        kf.k0.t(storyItem.id, new StringBuilder("StoriesController update story for full peer storyId="));
                    }
                } else {
                    i12++;
                }
            ...
            if (!z10) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    kf.k0.t(storyItem.id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z4) {
                    kf.k0.t(storyItem.id, new StringBuilder("StoriesController add new story for full peer storyId="));
