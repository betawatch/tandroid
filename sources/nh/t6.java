...
public final class t6 {
    ...
    public t6(int i10) {
        ...
        g7 g7Var2 = this.k;
        g7Var2.b.getStorageQueue().postRunnable(new n4(11, g7Var2, new w5(this, 0)));
        this.K = new af.b(this, i10, 11);
        this.w = new ph.t0(i10);
    }
    ...
    public final l6 A(long j10, int i10, int i11, boolean z4) {
        if (i10 == 0 && i11 > 0) {
            ...
            l6 l6Var2 = new l6(this.a, j10, i10, i11, new cg.h0(this, 27));
        ...
        if (i10 == 4) {
            ...
            d6 d6Var = new d6(this.a, j10, null, new cg.h0(this, 27));
            hashMap4.put(valueOf2, d6Var);
            return d6Var;
        }
        HashMap hashMap5 = hashMapArr[i10];
        Long valueOf3 = Long.valueOf(j10);
        l6 l6Var4 = new l6(this.a, j10, i10, i11, new cg.h0(this, 27));
    ...
    public final boolean N(long j10) {
        ...
        return ((s6) kh.a2.i(1, arrayList)).F;
    }
    ...
    public final void S(final TL_stories.PeerStories peerStories, final boolean z4) {
        ...
        if (arrayList != null) {
            ...
            ConnectionsManager.getInstance(i11).sendRequest(tL_stories_getStoriesByID, new RequestDelegate() { // from class: nh.u5
    ...
    public final void T() {
        if (this.A) {
            ...
            g7 g7Var = this.k;
            g7Var.b.getStorageQueue().postRunnable(new n4(12, g7Var, w5Var));
        } else {
            Q(false);
            Q(true);
        }
    ...
    public final void Y(TL_stories.TL_stories_allStories tL_stories_allStories, boolean z4, boolean z10, boolean z11) {
        ...
        if (!z10) {
            ...
            g7 g7Var = this.k;
            g7Var.b.getStorageQueue().postRunnable(new cg.x0(g7Var, arrayList4, z11, z4, n0Var, 3));
        }
        af.b bVar = this.K;
    ...
    public final void Z(TL_stories.TL_updateStory tL_updateStory) {
        ...
        if (peerDialogId > 0) {
            ...
            if (user != null && (M(user) || user.self)) {
                g7Var.b.getStorageQueue().postRunnable(new n4(10, g7Var, tL_updateStory));
            }
        } else {
            g7Var.b.getStorageQueue().postRunnable(new n4(10, g7Var, tL_updateStory));
            user = null;
    ...
    public final void l0(long j10, List list, boolean z4) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                ...
                if (peerStories.stories.get(i12).id == storyItem.id) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        kh.a2.t(storyItem.id, new StringBuilder("StoriesController update story for full peer storyId="));
                    }
                } else {
                    i12++;
                }
            ...
            if (!z10) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    kh.a2.t(storyItem.id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z4) {
                    kh.a2.t(storyItem.id, new StringBuilder("StoriesController add new story for full peer storyId="));
