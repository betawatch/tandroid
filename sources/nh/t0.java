    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (d10 > 0.0f) {
            ...
            if (xi0Var != null) {
                ...
                this.n.setBounds((int) (rectF.left + AndroidUtilities.dp(9.0f)), (int) (rectF.top + AndroidUtilities.dp(6.0f)), (int) (rectF.left + AndroidUtilities.dp(45.0f)), (int) (rectF.top + AndroidUtilities.dp(f9)));
                this.n.draw(canvas2);
            }
            if (this.w != null) {
                canvas2.save();
