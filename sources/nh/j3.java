...
public final /* synthetic */ class j3 implements View.OnClickListener {
    ...
    public /* synthetic */ j3(lh.d dVar, kz0 kz0Var, MessagesController messagesController, long j10, TLRPC.User user, String[] strArr, int i10, org.telegram.ui.ActionBar.e3 e3Var, boolean z10, c6 c6Var) {
        this.b = dVar;
        this.r = kz0Var;
        ...
        switch (this.a) {
            case 0:
                ...
                if (!dVar.J) {
                    ...
                    final c6 c6Var = this.n;
                    final TLRPC.User user = this.d;
                    connectionsManager.sendRequest(connectstarrefbot, new RequestDelegate() { // from class: nh.d3
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            AndroidUtilities.runOnUIThread(new h3(lh.d.this, tLObject, i10, j10, e3Var, starrefprogram, j11, z10, context, c6Var, user, tL_error));
                        }
                    });
                    break;
                }
            ...
            default:
                ...
                if (!dVar2.J) {
                    ...
                    if (textView.getText().toString().trim().length() > 16) {
                        ...
                        final c6 c6Var2 = this.n;
                        connectionsManager2.sendRequestTyped(tL_messages_editChatParticipantRank, aVar, new Utilities.Callback2() { // from class: org.telegram.ui.Components.az0
                            ...
                            public final void run(Object obj, Object obj2) {
                                ...
                                ec M = mc.a0(U).M(LocaleController.getString(z11 ? R.string.TagAdded : R.string.TagEdited), tL_messages_editChatParticipantRank2.rank, R.raw.contact_check);
                                jb jbVar = M.e;
    ...
    public /* synthetic */ j3(lh.d dVar, long[] jArr, int i10, TL_payments.starRefProgram starrefprogram, org.telegram.ui.ActionBar.e3 e3Var, long j10, boolean z10, Context context, c6 c6Var, TLRPC.User user) {
        this.b = dVar;
        this.r = jArr;
        this.e = i10;
