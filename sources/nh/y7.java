...
public final class y7 {
    ...
    public y7(z7 z7Var) {
        this.v = z7Var;
        this.c = new c90(z7Var);
        ArrayList arrayList = new ArrayList();
        this.i = arrayList;
        this.j = new Stack();
        this.n = "";
        this.r = new org.telegram.ui.Components.z5(z7Var.G, 0L, 400L, mr.h);
        Path path = new Path();
        this.t = path;
                ...
                while (true) {
                    ...
                    if (w7Var != null) {
                        ...
                        if (f12 != f13) {
                            ...
                            float lerp2 = AndroidUtilities.lerp(w7Var.d, w7Var.f, mr.g.getInterpolation(z7Var.w));
