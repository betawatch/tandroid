...
public final class o1 {
        ...
        try {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    n1 n1Var = new n1();
                    n1Var.a = next;
                    n1Var.b = jSONObject2.getLong("user_id");
                    n1Var.c = jSONObject2.getString("user_name");
                    n1Var.d = jSONObject2.getLong("created_at");
                    n1Var.e = jSONObject2.getLong("edited_at");
                    hashMap.put(next, n1Var);
                }
                return hashMap;
    ...
    public static void k(HashMap hashMap) {
        try {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                jSONObject2.put("user_id", ((n1) entry.getValue()).b);
                jSONObject2.put("user_name", ((n1) entry.getValue()).c);
                jSONObject2.put("created_at", ((n1) entry.getValue()).d);
                jSONObject2.put("edited_at", ((n1) entry.getValue()).e);
    ...
    public final File c() {
        ...
        if (this.d && TextUtils.isEmpty(this.e)) {
            ...
            if (TextUtils.isEmpty(this.e)) {
                ...
                n1Var.a = uuid;
                n1Var.b = j10;
                n1Var.c = DialogObject.getName(UserConfig.getInstance(this.a).getCurrentUser());
                long currentTimeMillis = System.currentTimeMillis();
                n1Var.e = currentTimeMillis;
                n1Var.d = currentTimeMillis;
                i10.put(this.e, n1Var);
                k(i10);
            }
        }
        return d(this.e);
    ...
    public final Pair f(String str) {
        ...
        JSONObject e9 = e(c());
        String optString = e9.optString(str);
        boolean z11 = false;
        if (z10 && optString == null && !e9.keys().hasNext()) {
    ...
    public final void j(String str) {
        ...
        HashMap i11 = i();
        n1 n1Var = (n1) i11.get(str);
        if (n1Var == null) {
            throw new RuntimeException("STORAGE_NOT_FOUND");
        }
        n1Var.b = this.c;
        n1Var.c = DialogObject.getName(UserConfig.getInstance(this.a).getCurrentUser());
        n1Var.e = System.currentTimeMillis();
        k(i11);
        this.e = n1Var.a;
    }
