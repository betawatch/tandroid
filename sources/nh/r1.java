...
public final class r1 extends View {
    ...
    public final void a(float f10, p1 p1Var) {
        ...
        this.r.addListener(new lh.k5(this, f10, p1Var, 1));
        this.r.setInterpolator(nr.h);
    ...
    public final void c(s1 s1Var) {
        this.b.set(s1Var.getX() - getX(), s1Var.getY() - getY(), (s1Var.getX() - getX()) + s1Var.getWidth(), (s1Var.getY() - getY()) + s1Var.getHeight());
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10 = 1.0f;
        float lerp = AndroidUtilities.lerp(1.0f, 1.8f, r1Var.n);
        ...
        while (true) {
            ...
            if (gj0Var.Y >= gj0Var.e[0]) {
                ...
                gj0Var.setAlpha((int) (r1Var.n * 255.0f));
                gj0Var.draw(canvas2);
            }
            i11++;
        }
        ...
        while (true) {
            ...
            float f12 = q1Var.c;
            float f13 = q1Var.b;
            ImageReceiver imageReceiver = q1Var.f;
            float d = q1Var.i.d(f10, z4);
            float e = q1Var.j.e(q1Var.h);
            float dp3 = AndroidUtilities.dp(23.0f) + q1Var.g.c;
            ...
            if (d >= 1.0f || e >= 1.0f) {
                ((q1) arrayList2.get(i14)).f.onDetachedFromWindow();
