    ...
    public final void a(Rect rect, View view, RecyclerView recyclerView, f2.i1 i1Var) {
        switch (this.a) {
            ...
            case 2:
                ...
                break;
            case 3:
                dl0 dl0Var = (dl0) recyclerView.T(view);
                if (dl0Var == null) {
            ...
            case 4:
                dl0 dl0Var2 = (dl0) recyclerView.T(view);
                if (dl0Var2 == null) {
                    rect.left = AndroidUtilities.dp(4.0f);
                    rect.right = AndroidUtilities.dp(4.0f);
                    break;
            ...
            case 5:
                dl0 dl0Var3 = (dl0) recyclerView.T(view);
                if (dl0Var3 == null) {
                    rect.left = AndroidUtilities.dp(4.0f);
                    rect.right = AndroidUtilities.dp(4.0f);
                    break;
        ...
        switch (this.a) {
            case 8:
                ...
                while (i11 < i10) {
                    ...
                    if (RecyclerView.R(childAt) >= 0 && !(childAt instanceof org.telegram.ui.Cells.t3) && !(childAt2 instanceof org.telegram.ui.Cells.t3)) {
