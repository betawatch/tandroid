...
public final class p extends FrameLayout {
    ...
    public final void c(Canvas canvas, float f10, float f11, float f12) {
        ...
        if (this.C && !t6Var.I(this.B) && Utilities.isNullOrEmpty(t6Var.E(this.B))) {
            ...
            if (i10 == 0) {
                paint2.setColor(org.telegram.ui.ActionBar.j6.l1(f12, ixVar.f(org.telegram.ui.ActionBar.j6.s8)));
            } else {
            ...
            int f13 = ixVar.f(i10 == 0 ? org.telegram.ui.ActionBar.j6.s8 : org.telegram.ui.ActionBar.j6.M8);
            if (f13 != ixVar.e) {
                ixVar.e = f13;
    ...
    public final void d(float f10, float f11, float f12, boolean z4) {
        ...
        float clamp = this.K ? 0.0f : 1.0f - Utilities.clamp(ixVar.K / ixVar.y0, 1.0f, 0.0f);
        this.N = clamp;
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i10 = ixVar3.b;
        t6 t6Var = ixVar3.s;
        Paint paint = ixVar3.E;
        float clamp = Utilities.clamp(ixVar3.k0 / 0.5f, 1.0f, 0.0f) * dp3;
        if (this.S) {
            clamp += Utilities.clamp((ixVar3.k0 - 0.5f) / 0.5f, 1.0f, 0.0f) * AndroidUtilities.dp(16.0f);
        }
        ...
        if (i10 == 0) {
            f10 = f17;
            paint.setColor(ixVar3.f(org.telegram.ui.ActionBar.j6.s8));
        } else {
            f10 = f17;
            paint.setColor(ixVar3.f(org.telegram.ui.ActionBar.j6.M8));
        }
        if (this.G != 0.0f) {
        ...
        if (z12 || (this.T && (kj0Var = this.O) != null && kj0Var.f < 0.98f)) {
            ...
            if (this.w) {
                ...
                i7Var2.b = !this.T;
                ixVar = ixVar2;
                if (!this.c && ixVar.k0 <= 0.0f) {
                    if (AndroidUtilities.lerp(getMeasuredWidth(), AndroidUtilities.dp(16.0f), mr.g.getInterpolation(this.G)) < (AndroidUtilities.dpf2(3.5f) + f10) * 2.0f) {
            ...
            if (this.w) {
                ...
                if (e > 0.0f) {
                    ...
                    Paint paint3 = ixVar.D;
                    paint3.setColor(org.telegram.ui.ActionBar.j6.l1(e, ixVar.f(org.telegram.ui.ActionBar.j6.q7)));
                    if (i10 == 0) {
                        paint.setColor(org.telegram.ui.ActionBar.j6.l1(e, ixVar.f(org.telegram.ui.ActionBar.j6.s8)));
                    } else {
                        paint.setColor(org.telegram.ui.ActionBar.j6.l1(e, ixVar.f(org.telegram.ui.ActionBar.j6.M8)));
                    }
                    float interpolation = mr.k.getInterpolation(e) * AndroidUtilities.dp(9.0f);
            ...
            if (!values.isEmpty()) {
                ...
                if (this.C) {
                    if (z4 && this.R && !this.K) {
                        ...
                        ixVar.g0.addListener(new dg.y2(5, this, k5Var));
                        ixVar.g0.setDuration(150L);
                        this.y.setAlpha(0.0f);
                        this.y.setTranslationY(AndroidUtilities.dp(5.0f));
                        ixVar.h0 = new o(this, i11);
                    }
                    AndroidUtilities.runOnUIThread(ixVar.h0, 500L);
                    this.R = false;
                    this.y.setTextSize(10);
                ...
                if (this.P == null) {
                    ...
                    g gVar = new g(ixVar, mutate, mutate2, mutate, mutate2);
                    gVar.w = true;
                    this.P = gVar;
                }
                this.y.l(Emoji.replaceEmoji(trim, this.y.getPaint().getFontMetricsInt(), false), false);
