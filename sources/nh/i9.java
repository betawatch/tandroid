            ...
            if (selectedPosition >= 0 && selectedPosition < arrayList.size()) {
                ...
                if (currentPeerView != null) {
                    ...
                    if (selectedPosition >= 0 && selectedPosition < arrayList2.size()) {
                        ...
                        f9Var.j = null;
                        f9Var.k = 1.0f;
                        if (!this.q0.X0(j10, this.R0, i11, storyItem == null ? -1 : storyItem.messageType, f9Var)) {
                            this.S0 = false;
                            this.L = 0.0f;
                            this.K = 0.0f;
                            return;
    ...
    public final void n(boolean z4) {
        ...
        if (this.Z || this.b0 != 0.0f) {
            ...
            if (z4) {
                ...
                this.s1.setInterpolator(nr.h);
            } else {
                this.s1.setDuration(350L);
                this.s1.setInterpolator(nr.f);
            }
            this.s1.start();
        }
    }
    ...
    */
    public final void y() {
        ...
        if (this.q0 != null) {
            ...
            this.q0.D0(currentDialogId, i10, new k3(this, 5));
        }
    }
