...
public final class i9 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.l2, df.a {
    ...
    public static boolean i(i9 i9Var, w8 w8Var, float f10, float f11, boolean z4) {
        ...
        if ((currentPeerView == null || (o2Var = currentPeerView.Y1) == null || !o2Var.w0()) && i9Var.r1 == null) {
    ...
    public final void A(int i10, Context context, TL_stories.StoryItem storyItem, ArrayList arrayList, int i11, l6 l6Var, TL_stories.PeerStories peerStories, e9 e9Var, boolean z4) {
        ...
        if (this.v == null) {
            ...
            this.v.addView(this.k0, k7.b6.e(-1, -1, 1));
            this.v0 = new org.telegram.ui.q4(context);
            if (this.a) {
    ...
    public final void L(boolean z4) {
        ...
        if (this.X0 != z4) {
            this.X0 = z4;
            if (z4 && !this.c1 && (currentPeerView2 = this.k0.getCurrentPeerView()) != null && (b4Var = currentPeerView2.L1) != null && !b4Var.f && b4Var.b == null) {
                if (!this.h0 && !this.g0 && (c4Var = this.D0) != null && c4Var.b != null) {
                    currentPeerView2.Z0.invalidate();
                    BotWebViewVibrationEffect.IMPACT_LIGHT.vibrate();
                }
                c4 c4Var2 = this.D0;
                if (c4Var2 != null && (h9Var = c4Var2.b) != null && !this.h0) {
    ...
    public final void O() {
        ...
        d4 currentPeerView = this.k0.getCurrentPeerView();
        if (currentPeerView != null) {
    ...
    */
            ...
            if (selectedPosition >= 0 && selectedPosition < arrayList.size()) {
                ...
                if (currentPeerView != null) {
                    ...
                    if (selectedPosition >= 0 && selectedPosition < arrayList2.size()) {
                        ...
                        f9Var.j = null;
                        f9Var.k = 1.0f;
                        if (!this.q0.V0(j10, this.R0, i11, storyItem == null ? -1 : storyItem.messageType, f9Var)) {
                            this.S0 = false;
                            this.L = 0.0f;
                            this.K = 0.0f;
                            return;
    ...
    public final void n(boolean z4) {
        ...
        if (this.Z || this.b0 != 0.0f) {
            ...
            this.s1.addListener(new dg.w2(7, this, z4));
            if (z4) {
                this.s1.setDuration(350L);
                this.s1.setInterpolator(mr.h);
            } else {
                this.s1.setDuration(350L);
                this.s1.setInterpolator(mr.f);
            }
            this.s1.start();
        }
    }
    ...
    public final void y() {
        ...
        if (this.q0 != null) {
            ...
            if (this.L0 instanceof o6) {
                d4 currentPeerView2 = this.k0.getCurrentPeerView();
            ...
            this.q0.z0(currentDialogId, i10, new k3(this, 5));
        }
    }
