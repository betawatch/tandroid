...
public final class p8 extends k8 {
    public final mg.q0 F;
    public final o8 G;
    public final mg.h0 H;
    public final ImageReceiver I;
    public final org.telegram.ui.Components.z5 J;
    public final org.telegram.ui.Components.j6 K;
    public boolean L;

    public p8(Context context, m8 m8Var, TL_stories.TL_mediaAreaSuggestedReaction tL_mediaAreaSuggestedReaction, bz bzVar) {
        ...
        mg.q0 d = mg.q0.d(tL_mediaAreaSuggestedReaction.reaction);
        this.F = d;
        ...
        bzVar.getClass();
        String str = d.f;
        str = str == null ? MessageObject.findAnimatedEmojiEmoticon(org.telegram.ui.Components.l5.f(bzVar.b, d.g)) : str;
        if (str != null && (arrayList = (ArrayList) bzVar.e.get(str)) != null && !arrayList.isEmpty()) {
            int min = Math.min(1, arrayList.size());
            for (int i10 = 0; i10 < min; i10++) {
                bzVar.m((TLRPC.Document) arrayList.get(i10));
            }
        }
    ...
    public final void c(TL_stories.StoryViews storyViews, boolean z4) {
        ...
        if (storyViews != null) {
            for (int i10 = 0; i10 < storyViews.reactions.size(); i10++) {
                if (mg.s0.c(storyViews.reactions.get(i10).reaction, this.F)) {
