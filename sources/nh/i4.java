...
public abstract class i4 extends View {
    ...
    public static void a(i4 i4Var, SpannableStringBuilder spannableStringBuilder, TL_stories.StoryViews storyViews, boolean z4) {
        ...
        if (i10 > 0) {
            ...
            spannableStringBuilder.setSpan(new mq(R.drawable.msg_views, 0), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
            ...
            spannableStringBuilder.append("d");
            spannableStringBuilder.setSpan(new mq(R.drawable.mini_like_filled, 0), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
    ...
    public h4 getCenteredImageReciever() {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (((h4) arrayList.get(i10)).b == this.H) {
        ...
        while (i14 < this.B.size()) {
            ...
            if (c3 > getMeasuredWidth() || this.s + c3 < 0.0f) {
                ...
                if (this.y == 0.0f || i14 == (i12 = this.H)) {
                    ...
                    f13 = f15;
                    i11 = i15;
                    h4Var.a.setImageCoords(a2, a10, f20, f22);
                } else {
                    f13 = f15;
                    i11 = i15;
                    arrayList = arrayList4;
                    arrayList2 = arrayList3;
                    h4Var.a.setImageCoords(AndroidUtilities.lerp(getMeasuredWidth() * (i14 - i12), a2, this.y), AndroidUtilities.lerp(this.a, a10, this.y), AndroidUtilities.lerp(this.b, f20, this.y), AndroidUtilities.lerp(this.c, f22, this.y));
                }
                if (this.y == 1.0f || i14 != this.H) {
                    ...
                    if (h4Var.c != null) {
                        ...
                        canvas.save();
                        canvas.translate(imageReceiver.getCenterX() - (this.G / 2.0f), (imageReceiver.getImageY2() - AndroidUtilities.dp(8.0f)) - h4Var.c.getHeight());
