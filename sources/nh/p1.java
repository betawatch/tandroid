...
public final /* synthetic */ class p1 implements zx, org.telegram.ui.ActionBar.a2, ResultCallback {
    ...
    public /* synthetic */ p1(int i10, long j10, TLRPC.TL_attachMenuBot tL_attachMenuBot, Runnable runnable) {
        this.b = i10;
        this.c = j10;
    ...
    public void onComplete(Object obj) {
        ...
        if (drawable instanceof nb0) {
            ...
            nb0Var.t(b11.e((Bitmap) pair.second), this.b >= 0 ? 100 : -100);
            nb0Var.u(b11Var.H);
        }
        b11Var.invalidate();
    }
    ...
    public boolean w(gy gyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, we1 we1Var) {
        ...
        n9Var2.setEmojiColorFilter(new PorterDuffColorFilter(g6.w0(null, g6.z9, false), PorterDuff.Mode.SRC_IN));
        ...
        f10.addView(frameLayout, z5.t(-2, -2, 1, 16, 0, 16, 0));
        ...
        f10.addView(textView, z5.k(24.0f, 21.0f, 24.0f, 8.33f, -1, -2));
        ...
        f10.addView(textView2, z5.k(24.0f, 0.0f, 24.0f, 22.0f, -1, -2));
        ...
        editTextBoldCursor.setHighlightColor(g6.w0(null, g6.uf, false));
        editTextBoldCursor.setHandlesColor(g6.w0(null, g6.vf, false));
        ...
        if (botverifiersettings.can_modify_custom_description) {
            ...
            i12 = -1;
            f10.addView(textView3, z5.c(-2.0f, -1));
        } else {
            i12 = -1;
            f10.addView(new View(activity), z5.c(12.0f, -1));
        }
        final lh.d dVar = new lh.d(activity, null, true);
        dVar.g(textView.getText(), false, true);
        f10.addView(dVar, z5.n(i12, 48));
        e3Var.customView = f10;
        dVar.setOnClickListener(new View.OnClickListener() { // from class: nh.r1
    ...
    public /* synthetic */ p1(EditText editText, long j10, int i10, EditText editText2) {
        this.d = editText;
        this.c = j10;
        this.b = i10;
        this.e = editText2;
    ...
    public /* synthetic */ p1(b11 b11Var, long j10, zo zoVar, int i10) {
        this.d = b11Var;
        this.c = j10;
        this.e = zoVar;
        this.b = i10;
    ...
    public /* synthetic */ p1(gy gyVar, int i10, long j10, TL_bots.botVerifierSettings botverifiersettings) {
        this.d = gyVar;
        this.b = i10;
        this.c = j10;
