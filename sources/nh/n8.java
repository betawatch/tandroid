...
public final class n8 extends View {
    ...
    public n8(Context context) {
        ...
        this.e = new org.telegram.ui.Components.z5(this, 0L, 260L, mr.h);
    ...
    public final void a(boolean z4, s6 s6Var, boolean z10) {
        ...
        this.s = z4;
        this.f = true;
        if (s6Var == null || (c8Var = s6Var.c.E0) == null) {
            this.f = false;
        } else {
            int i10 = c8Var.a;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f) {
            ...
            rectF.set(e2.c.x(getWidth(), dpf22, 2.0f, dpf2), (getHeight() - dpf23) / 2.0f, kf.k0.b(getWidth(), dpf22, 2.0f, dpf2), (getHeight() + dpf23) / 2.0f);
            ...
            if (drawable == null || d <= 0.5f) {
                ...
                c3 = 0;
                f10 = 12.0f;
                drawable2.setBounds(A, (int) (centerY - f12), (int) (f12 + dpf24), (int) vh.w2.c(fArr[1], 2.0f, abs, rectF.centerY()));
            ...
            if (drawableArr[c3] != null && d <= f11) {
                ...
                drawable3.setBounds(A2, (int) (centerY2 - f13), (int) (f13 + dpf25), (int) vh.w2.c(fArr[c3], 2.0f, abs, rectF.centerY()));
