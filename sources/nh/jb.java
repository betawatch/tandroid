...
public final class jb {
    ...
    public jb(qb qbVar, String str, int i10) {
        this.l = qbVar;
        this.a = new org.telegram.ui.Components.d6(qbVar, 0L, 600L, jr.h);
        int i11 = 0;
        ...
        int min = Math.min(Math.round((((this.h * 1000) / Math.min(qbVar.h != null ? r8.e : !qbVar.s.isEmpty() ? qbVar.getBaseDuration() : qbVar.A ? qbVar.D : this.h * 1000, qbVar.getMaxScrollDuration())) * i10) / Math.round(AndroidUtilities.dpf2(3.3333f))), 4000);
        this.b = min;
        ...
        if ("audio/mpeg".equals(str2) || "audio/mp3".equals(str2) || "audio/mp4a".equals(str2) || MediaController.AUDIO_MIME_TYPE.equals(str2)) {
            this.k = new FfmpegAudioWaveformLoader(str, min, new t4(this, 3));
        } else {
