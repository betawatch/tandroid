...
public final class d8 extends View {
    ...
    public d8(Context context, int i10, TLObject tLObject, Object obj, boolean z4, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        i90Var.e(org.telegram.ui.ActionBar.j6.l1(0.2f, -1), org.telegram.ui.ActionBar.j6.l1(0.05f, -1));
        Path path = new Path();
        this.n = path;
        i90Var.x = path;
        i90Var.j(4.0f);
    ...
    public final void d(boolean z4) {
        ...
        this.E.addUpdateListener(new dg.b1(i10, this, this.d == null || Math.abs(getMeasuredHeight() - (getPaddingBottom() + (this.d.getHeight() + getPaddingTop()))) > AndroidUtilities.dp(3.0f)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f10 < 1.0f) {
            i90 i90Var = this.h;
            i90Var.setAlpha((int) ((1.0f - f10) * 255.0f));
            Path path = this.n;
            path.rewind();
    ...
    public mv getAlert() {
        if (this.s != null) {
            return new mv(null, getContext(), this.a, this.s);
        }
        int i10 = -this.D;
        this.D = i10;
    ...
    private void set(int i10) {
        ...
        i90 i90Var = this.h;
        if (z4 && this.w) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickersEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, i90Var.a), null));
        } else if (z4) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, i90Var.a), null));
        } else {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickers", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, i90Var.a), null));
        }
    }
}
