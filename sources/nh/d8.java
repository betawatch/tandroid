...
public final class d8 extends View {
    ...
    public lv getAlert() {
        if (this.s != null) {
            return new lv(null, getContext(), this.a, this.s);
        }
        int i10 = -this.D;
        this.D = i10;
    ...
    private void set(int i10) {
        ...
        j90 j90Var = this.h;
        if (z4 && this.w) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickersEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, j90Var.a), null));
        } else if (z4) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, j90Var.a), null));
        } else {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickers", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, j90Var.a), null));
        }
    }
}
