...
public final class s1 extends View {
    ...
    public s1(Context context, r1 r1Var, qg.b bVar) {
        ...
        this.c = new Path();
        nr nrVar = nr.h;
        this.e = new org.telegram.ui.Components.z5(this, 320L, nrVar);
        this.f = new org.telegram.ui.Components.z5(this, 320L, nrVar);
        ...
        new mq(R.drawable.star, 0).setScale(1.8f, 1.8f);
        setCount(0);
        this.d = new wa(1, 50);
    }
