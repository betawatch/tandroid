...
public final class w3 extends vr {
    ...
    @Override // org.telegram.ui.Components.vr
    /*
    ...
    */
    public final void b(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        if (z11 || b4Var.b != null) {
            ...
            if ((d4Var.z1 || d4Var.P1.h(d4Var.y1)) && !b4Var.f && (storyItem = b4Var.a) != null) {
                ...
                o70 o70Var = new o70(actionBarPopupWindow$ActionBarPopupWindowLayout2, f6Var);
                o70Var.c(R.drawable.ic_ab_back, LocaleController.getString(R.string.Back), new lh.b(actionBarPopupWindow$ActionBarPopupWindowLayout2, 27), false);
                o70Var.k();
                h6 B = d4Var.getStoriesController().B(d4Var.y1, true);
                h6 B2 = d4Var.P1.B(d4Var.y1, false);
                o70.f(o70Var, B, hashSet, B2 != null && B2.a(), new lh.p6(w3Var, f6Var, storyItem, 3), new gg.c1(w3Var, hashSet, storyItem, f6Var, 4));
            ...
            if (d4Var.z1) {
                ph.d8 d8Var = storyItem4.privacy.isEmpty() ? new ph.d8(3, d4Var.z2, new ArrayList()) : new ph.d8(d4Var.z2, storyItem4.privacy);
                ...
                c3.setSubtext(d8Var.toString());
                c3.setOnClickListener(new dg.p(w3Var, d8Var, storyItem4, 11));
                c3.setItemHeight(56);
            } else {
        ...
        if (b4Var != null) {
            ...
            if (storyItem9 == null || (arrayList2 = storyItem9.entities) == null || arrayList2.isEmpty()) {
                s6 s6Var = b4Var.b;
                if (s6Var != null && (u6Var = s6Var.c) != null) {
                    if (u6Var.T0 != null) {
        ...
        if (z18 || z19) {
            ...
            d8 d8Var2 = new d8(w3Var.i, d4Var.z2, tLObject, b4Var.a, z18, arrayList, w3Var.d);
            d8Var2.setOnClickListener(new cg.n(28, w3Var, d8Var2));
            d8Var2.setTag(R.id.fit_width_tag, num);
            actionBarPopupWindow$ActionBarPopupWindowLayout6.a(d8Var2, k7.b6.n(-1, -2));
        }
    }
    ...
    public final void d(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, boolean z4) {
        ...
        org.telegram.ui.vr vrVar = new org.telegram.ui.vr();
        ...
        c10.c(-328966, -328966);
        final int i10 = 0;
        c10.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ur
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                switch (i10) {
                    case 0:
