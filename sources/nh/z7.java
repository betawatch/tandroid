...
public final class z7 extends View implements u9 {
    ...
    /* JADX WARN: Type inference failed for: r8v14, types: [nh.v7] */
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            a8Var.d0 = motionEvent.getX();
            a8Var.e0 = motionEvent.getY();
        }
        a8Var.f0 = motionEvent.getX();
        a8Var.g0 = motionEvent.getY();
        if (this.v != null) {
            ...
            if (rectF.contains(motionEvent.getX(), motionEvent.getY())) {
                ...
                if (y7Var != null || (v7Var = y7Var.o) == null) {
                    ...
                    if (motionEvent.getAction() == 0 && z10) {
                        ...
                        y7VarArr[z13 ? 1 : 0].o.e(motionEvent.getX(), motionEvent.getY(), z13);
                        r13 = z13;
                    }
                    r13 = 0;
                }
                if (!z10 && (y7Var3 = y7VarArr[r13]) != null && y7Var3.p != null) {
                    RectF rectF3 = AndroidUtilities.rectTmp;
                    float f11 = this.B;
                    float lerp = (AndroidUtilities.lerp(y7Var3.m, y7Var3.l, this.w) + this.C) - y7VarArr[0].p.b();
                    int i13 = this.B;
                    y7 y7Var4 = y7VarArr[0];
                    rectF3.set(f11, lerp, i13 + y7Var4.p.x, AndroidUtilities.lerp(y7Var4.m, y7Var4.l, this.w) + this.C);
                ...
                if (z4 && (a8Var.s0 || (y7Var2 = y7VarArr[0]) == null || y7Var2.g == null)) {
                    float f12 = this.B;
                    float f13 = this.C + i10;
                    Rect rect = v9Var.B;
                    u9 u9Var = v9Var.u0;
                    staticTextLayout = u9Var.getStaticTextLayout();
                    if (staticTextLayout != null) {
                        ...
                        int i15 = (int) f13;
                        v9Var.d = i15;
                        org.telegram.ui.Cells.o9 o9Var = v9Var.a0;
                        o9Var.b = staticTextLayout;
                        o9Var.d = f12;
                        o9Var.c = f13;
                        o9Var.a = 0;
                ...
                return (super.dispatchTouchEvent(motionEvent) || z10) ? z11 : z12;
            }
        }
        z4 = true;
        y7VarArr = this.r;
        ...
        if (!z10) {
            ...
            float f112 = this.B;
            float lerp2 = (AndroidUtilities.lerp(y7Var3.m, y7Var3.l, this.w) + this.C) - y7VarArr[0].p.b();
            int i132 = this.B;
            y7 y7Var42 = y7VarArr[0];
            rectF32.set(f112, lerp2, i132 + y7Var42.p.x, AndroidUtilities.lerp(y7Var42.m, y7Var42.l, this.w) + this.C);
        ...
        if (z4) {
            float f122 = this.B;
            float f132 = this.C + i10;
            Rect rect2 = v9Var.B;
            u9 u9Var2 = v9Var.u0;
            staticTextLayout = u9Var2.getStaticTextLayout();
            if (staticTextLayout != null) {
            }
            v9Var.N(motionEvent);
        }
    ...
    public float getAnimatedHeight() {
        ...
        return AndroidUtilities.lerp(i11, y7VarArr[1] != null ? r1.l : 0, this.D) + i10;
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        org.telegram.ui.Components.u5.release(z7Var, y7Var.f);
        if (y7Var.h == null) {
            return;
        }
        while (true) {
            ...
            if (w7Var != null) {
                org.telegram.ui.Components.u5.release(z7Var, w7Var.a);
            }
            i10++;
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v != null) {
            ...
            canvas2.restore();
            canvas2.drawRect(this.n - AndroidUtilities.dp(16.0f), scrollY, getMeasuredWidth(), this.v.getHeight() + scrollY + this.C, paint2);
            canvas2.save();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        y7 y7Var2 = y7VarArr[1];
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.lerp(i15, y7Var2 != null ? y7Var2.l : 0, this.D) + i14, TLObject.FLAG_30));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x009f, code lost:
        ...
        r5 = (int) (r20.getX() - r4.B);
        r9 = (int) ((r20.getY() - r4.C) - (r10 + r9));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x0109, code lost:
        ...
        r3.d(true);
        r1.b = null;
        r13 = new org.telegram.ui.Components.g90(r9[0], null, r20.getX(), r20.getY(), 0);
        r1.a = r13;
        ...
        r9 = r1.a;
        r6.T.f(false);
        r4.postDelayed(new nh.n4(18, r1, r9), android.view.ViewConfiguration.getLongPressTimeout());
        r4 = true;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x0179, code lost:
        ...
        r5 = (org.telegram.ui.Components.u5[]) r5.getSpans(r11, r11, org.telegram.ui.Components.u5.class);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x00f4, code lost:
        ...
        r9 = (android.text.style.CharacterStyle[]) r5.getSpans(r11, r11, org.telegram.ui.Components.l51.class);
     */
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        y7[] y7VarArr;
        if (!this.G.p0 && (y7VarArr = this.r) != null) {
            y7 y7Var = y7VarArr[0];
            if (y7Var.e != null) {
                c90 c90Var = y7Var.c;
                z7 z7Var = y7Var.v;
