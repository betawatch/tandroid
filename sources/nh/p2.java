...
public final class p2 {
    ...
    public p2(Context context, WindowManager windowManager, View view, WindowManager.LayoutParams layoutParams) {
        ...
        this.f = view;
        this.g = layoutParams;
        this.b = new m2(this, context, 0);
        this.c = new m2(this, context, 1);
        paint.setAlpha(0);
    }

    public static int f(float f9) {
        return f9 < 0.5f ? i0.a.d(Utilities.clamp(f9 / 0.5f, 1.0f, 0.0f), -7544833, -1) : i0.a.d(Utilities.clamp((f9 - 0.5f) / 0.5f, 1.0f, 0.0f), -1, -70004);
    }
    ...
    public final void e(float f9, long j10, Runnable runnable) {
        ...
        this.i.addListener(new jh.l5(this, f9, runnable, 2));
        this.i.setDuration(j10);
        this.i.setInterpolator(jr.i);
        this.i.start();
    }
    ...
    public final void g() {
        ...
        int i11 = this.n;
        m2 m2Var = this.b;
        if (i10 == i11 && this.j == m2Var.getMeasuredWidth() && this.k == m2Var.getMeasuredHeight() && Math.abs(this.m - this.h) <= 0.005f) {
            return;
        }
        this.l = this.n;
        this.j = m2Var.getMeasuredWidth();
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            this.r = android.support.v4.media.session.z.b(f9, f10, min, jArr, fArr);
        } else {
