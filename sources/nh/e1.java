...
public final class e1 implements NotificationCenter.NotificationCenterDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    public final void k() {
        ...
        int i10 = 2;
        NativeInstance makeGroup = NativeInstance.makeGroup(org.telegram.ui.Components.voip.f2.d("live_" + this.f.id), 0L, false, SharedConfig.noiseSupression, new w0(this, 0), new m.j0(i10), new w0(this, i10), new w0(this, 3), new w0(this, 4), new w0(this, 5), false);
        this.B = makeGroup;
