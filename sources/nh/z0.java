    ...
    public final void run() {
        switch (this.a) {
            ...
            default:
                e1 e1Var4 = this.b;
                if (!e1Var4.n) {
                    he0.d(R.raw.permission_request_camera, R.string.PermissionNoCameraMicVideo, new String[]{"android.permission.CAMERA", "android.permission.RECORD_AUDIO"}, new cg.h0(e1Var4, 24));
                    break;
                }
                break;
        }
