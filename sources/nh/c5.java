...
public final class c5 {
    ...
    public final void a() {
        ...
        if (z4 || !TextUtils.isEmpty(p4Var.c)) {
            if (TextUtils.isEmpty(p4Var.c)) {
                str = null;
                str2 = null;
                str3 = null;
                str4 = null;
            } else {
                str = p4Var.c.trim().toLowerCase();
            ...
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                ...
                boolean z10 = !p4Var.b || (user != null && user.contact);
                if (z10 && str != null) {
    ...
    public final void c() {
        ...
        if (z4) {
            ...
            tL_getStoryReactionsList.forwards_first = p4Var.a;
            ...
            final int i11 = 0;
            int sendRequest = ConnectionsManager.getInstance(i10).sendRequest(tL_getStoryReactionsList, new RequestDelegate(this) { // from class: nh.a5
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    switch (i11) {
                        case 0:
                            ...
                            final int[] iArr = r2;
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: nh.b5
                                ...
                                public final void run() {
                                    ...
                                    switch (i12) {
                                        case 0:
                                            ...
                                            int i13 = c5Var2.d;
                                            ArrayList arrayList3 = c5Var2.g;
                                            TL_stories.StoryItem storyItem2 = c5Var2.b;
                                            if (iArr[0] != c5Var2.o) {
                                                ...
                                                if (tLObject2 != null) {
                                                    ...
                                                    if (c5Var2.l) {
                                                        ...
                                                        for (int i15 = 0; i15 < arrayList3.size(); i15++) {
                                                            c5Var2.p.add(Long.valueOf(((TL_stories.StoryView) arrayList3.get(i15)).user_id));
                                                        }
                                                        arrayList3.clear();
                                                        arrayList2.clear();
                                                    }
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.id + " response  totalItems " + arrayList3.size() + " has next " + c5Var2.m);
                                                for (int i20 = 0; i20 < arrayList.size(); i20++) {
                                                    ((d5) arrayList.get(i20)).e(c5Var2);
                                                }
                                                if (arrayList3.size() < 20 && c5Var2.m) {
                                                    c5Var2.c();
                                                    break;
                                                }
                                            }
                                        ...
                                        default:
                                            c5 c5Var3 = c5Var;
                                            ArrayList arrayList4 = c5Var3.r;
                                            TL_stories.StoryItem storyItem3 = c5Var3.b;
                                            int i21 = c5Var3.d;
                                            ArrayList arrayList5 = c5Var3.i;
                                            if (iArr[0] != c5Var3.o) {
                                                ...
                                                if (tLObject3 != null) {
                                                    ...
                                                    if (c5Var3.l) {
                                                        ...
                                                        for (int i22 = 0; i22 < arrayList5.size(); i22++) {
                                                            c5Var3.p.add(Long.valueOf(DialogObject.getPeerDialogId(((TL_stories.StoryReaction) arrayList5.get(i22)).peer_id)));
                                                        }
                                                        arrayList5.clear();
                                                        c5Var3.h.clear();
                                                    }
                                                ...
                                                FileLog.d("SelfStoryViewsPage reactions " + storyItem3.id + " response  totalItems " + arrayList5.size() + " has next " + c5Var3.m);
                                                for (int i25 = 0; i25 < arrayList4.size(); i25++) {
                                                    ((d5) arrayList4.get(i25)).e(c5Var3);
                                                }
                                                if (arrayList5.size() < 20 && c5Var3.m) {
                                                    c5Var3.c();
                                                    break;
                                                }
                                            }
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: nh.b5
                                ...
                                public final void run() {
                                    ...
                                    switch (i13) {
                                        case 0:
                                            c5 c5Var22 = c5Var2;
                                            ArrayList arrayList = c5Var22.r;
                                            ArrayList arrayList2 = c5Var22.h;
                                            int i132 = c5Var22.d;
                                            ArrayList arrayList3 = c5Var22.g;
                                            TL_stories.StoryItem storyItem2 = c5Var22.b;
                                            if (iArr2[0] != c5Var22.o) {
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.id + " localId != reqId");
                                                break;
                                            } else {
                                                c5Var22.e = false;
                                                ...
                                                if (tLObject2 != null) {
                                                    ...
                                                    if (c5Var22.l) {
                                                        c5Var22.l = false;
                                                        for (int i15 = 0; i15 < arrayList3.size(); i15++) {
                                                            c5Var22.p.add(Long.valueOf(((TL_stories.StoryView) arrayList3.get(i15)).user_id));
                                                        }
                                                        arrayList3.clear();
                                                        arrayList2.clear();
                                                    }
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.id + " response  totalItems " + arrayList3.size() + " has next " + c5Var22.m);
                                                for (int i20 = 0; i20 < arrayList.size(); i20++) {
                                                    ((d5) arrayList.get(i20)).e(c5Var22);
                                                }
                                                if (arrayList3.size() < 20 && c5Var22.m) {
                                                    c5Var22.c();
                                                    break;
                                                }
                                            }
        ...
        if (this.q) {
            ...
            tL_stories_getStoryViewsList.just_contacts = p4Var.b;
            tL_stories_getStoryViewsList.reactions_first = p4Var.a;
        }
        ...
        final int i12 = 1;
        int sendRequest2 = ConnectionsManager.getInstance(i10).sendRequest(tL_stories_getStoryViewsList, new RequestDelegate(this) { // from class: nh.a5
            public final /* synthetic */ c5 b;
