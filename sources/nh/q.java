...
public abstract class q extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, xd.b {
    ...
    public q(Context context, oy oyVar, int i10, int i11) {
        super(context);
        this.a = new xd.a(1, this, nr.h, 380L, false);
        this.v = new ArrayList();
        this.w = new ArrayList();
        this.x = new ArrayList();
        this.y = new ArrayList();
        gx gxVar = (gx) this;
        m mVar = new m(gxVar, false);
        this.B = mVar;
        m mVar2 = new m(gxVar, true);
        this.C = mVar2;
        ...
        i iVar = new i(gxVar, context, 0);
        this.h = iVar;
        iVar.setPadding(AndroidUtilities.dp(3.0f), 0, AndroidUtilities.dp(3.0f), 0);
        iVar.setClipToPadding(false);
        iVar.setClipChildren(false);
        xcVar.h = new lh.b(gxVar, 21);
        cg.n0 n0Var = new cg.n0(gxVar, 13);
        xcVar.l = true;
        xcVar.j = n0Var;
        iVar.j(new eg.f2(gxVar, 11));
        f2.l lVar = new f2.l();
        this.O = lVar;
        lVar.C = false;
        lVar.n(150L);
        ...
        iVar.setOnItemClickListener(new dg.n(gxVar, 11));
        iVar.setOnItemLongClickListener(new lh.m5(gxVar, 5));
        ...
        j jVar = new j(gxVar, context, mVar3);
        this.R = jVar;
        ...
        i iVar2 = new i(gxVar, getContext(), 1);
        this.r = iVar2;
        getContext();
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
            ...
            while (i22 < iVar4.getChildCount()) {
                ...
                if (R2 >= i10 && R2 < arrayList2.size() + i10) {
                    ...
                    if (i23 == i10 + 2) {
                        ...
                        if (i12 == 0) {
                            f20 = 0.65f;
                            lerp3 = AndroidUtilities.lerp(f19, f11 - f14, nr.h.getInterpolation(this.K));
                        } else {
                            f20 = 0.65f;
                            if (i12 == 1) {
                                lerp3 = AndroidUtilities.lerp(f19, (f11 - f14) * 0.65f, nr.h.getInterpolation(this.K));
                            } else {
                                f21 = 0.0f;
        ...
        if (this.G != null) {
            float lerp8 = AndroidUtilities.lerp(29, 74, nr.g.getInterpolation(this.K));
            iVar2 = iVar;
            i11 = 0;
    ...
    public final int f(int i10) {
        oy oyVar = this.b0;
        return (oyVar == null || oyVar.getResourceProvider() == null) ? org.telegram.ui.ActionBar.j6.w0(null, i10, false) : oyVar.getThemedColor(i10);
    }
    ...
    public final void j(long j10) {
        ...
        if (j10 == 0 && (o10 = MessagesController.getInstance(i10).getStoriesController().o()) != null && o10.a(i10, 1)) {
            oyVar.showDialog(new eg.v0(o10.b(), this.f, getContext(), this.b0, null));
            return;
        }
        int i11 = 0;
        while (true) {
        ...
        if (j10 == 0) {
            da.E(oyVar.getParentActivity(), i10).R(y9.c(pVar));
            return;
        }
        org.telegram.ui.ActionBar.f6 resourceProvider = oyVar != null ? oyVar.getResourceProvider() : null;
    ...
    public final void o() {
        ...
        p20 p20Var2 = m7.c;
        if (p20Var2 != null) {
            p20Var2.d(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.nk, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.ok, false), 0, 0);
        }
        p20[] p20VarArr = m7.a;
        p20 p20Var3 = p20VarArr[0];
        if (p20Var3 != null) {
            p20Var3.d(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.jk, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.kk, false), 0, 0);
        }
        p20 p20Var4 = p20VarArr[1];
        if (p20Var4 != null) {
            p20Var4.d(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.hk, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.ik, false), 0, 0);
        }
        if (m7.d != null) {
