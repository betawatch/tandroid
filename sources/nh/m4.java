    ...
    public final boolean f(int i10, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n6) {
            ...
            if (i9Var.v != null && (storyView = ((u4) d5Var.w.c.get(i10)).b) != null && (user = (messagesController = MessagesController.getInstance(i11)).getUser(Long.valueOf(storyView.user_id))) != null) {
                    ...
                    public final void run() {
                        ...
                        switch (i13) {
                            case 0:
                                ...
                                d5 d5Var2 = m4Var.b;
                                yh.s(R.string.StoryHidFromToast, new Object[]{str3}, new qc(d5Var2, d5Var2.s), R.raw.ic_ban, 36);
                                n6Var2.a(d5Var2.d(storyView2) ? 1.0f : 0.5f, true);
                                break;
                            default:
                                messagesController2.getStoriesController().j0(user2.id, false, true);
                                d5 d5Var3 = m4Var.b;
                                yh.s(R.string.StoryShownBackToToast, new Object[]{str3}, new qc(d5Var3, d5Var3.s), R.raw.contact_check, 36);
                                n6Var2.a(d5Var3.d(storyView2) ? 1.0f : 0.5f, true);
                                break;
                        }
                    }
                }, z12);
                    ...
                    public final void run() {
                        switch (i14) {
                            case 0:
                                ...
                                n6Var.a(d5Var2.d(storyView) ? 1.0f : 0.5f, true);
                                break;
                            default:
                                MessagesController messagesController2 = messagesController;
                                ...
                                n6Var.a(d5Var3.d(storyView) ? 1.0f : 0.5f, true);
                                break;
                        }
                    }
                });
                ...
                F.m(z11 && !isUserSelf, R.drawable.msg_user_remove, LocaleController.getString(R.string.StoryDeleteContact), true, new gg.j0(this, user, str2, n6Var, storyView, 16));
