    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            case 0:
                ...
                int i12 = q31.v;
                q31.J(i11, context, storyItem.dialogId, true, false, new ArrayList(Collections.singleton(Integer.valueOf(storyItem.id))), qcVar, f6Var2, new byte[0], null, h0Var);
                w3 w3Var2 = d4Var.q1;
                if (w3Var2 != null) {
                    w3Var2.a();
                    break;
            ...
            case 1:
                ...
                ph.e8 e8Var = new ph.e8(d4Var2.getContext(), 86400, f6Var);
                e8Var.o1();
                e8Var.p1(MessagesController.getInstance(d4Var2.z2).getInputPeer(d4Var2.y1));
                e8Var.I = true;
                View[] viewPages = e8Var.b.getViewPages();
                View view4 = viewPages[0];
                if (view4 instanceof ph.y7) {
                    ph.y7 y7Var = (ph.y7) view4;
                    y7Var.b(y7Var.a);
                }
                View view5 = viewPages[1];
                if (view5 instanceof ph.y7) {
                    ph.y7 y7Var2 = (ph.y7) view5;
                    y7Var2.b(y7Var2.a);
                }
                e8Var.e1(false);
                e8Var.m1(1);
                ...
                if (e1Var != null) {
                    ...
                    if (groupCall == null ? true : groupCall.messages_enabled) {
                        ...
                        e8Var.y = z10;
                        e8Var.E = j10;
                        View[] viewPages2 = e8Var.b.getViewPages();
                        view2 = viewPages2[0];
                        if (view2 instanceof ph.y7) {
                            ph.y7 y7Var3 = (ph.y7) view2;
                            y7Var3.b(y7Var3.a);
                        }
                        view3 = viewPages2[1];
                        if (view3 instanceof ph.y7) {
                            ph.y7 y7Var4 = (ph.y7) view3;
                            y7Var4.b(y7Var4.a);
                        }
                        e8Var.Q = new mg.w(3, w3Var, e8Var);
                        e8Var.show();
                        break;
                    }
                }
                ...
                e8Var.y = z10;
                e8Var.E = j10;
                View[] viewPages22 = e8Var.b.getViewPages();
                view2 = viewPages22[0];
                if (view2 instanceof ph.y7) {
                }
                view3 = viewPages22[1];
