...
public final class v5 extends View {
    ...
    public v5(w5 w5Var, Context context, String str, boolean z10) {
        ...
        this.b = paint2;
        this.r = new org.telegram.ui.Components.d6(this, 0L, 220L, jr.h);
        this.s = true;
        this.n = z10;
    ...
    public final void onDraw(Canvas canvas) {
        if (isPressed()) {
            float f9 = this.v;
            if (f9 != 1.0f) {
                float min = (Math.min(40.0f, 1000.0f / AndroidUtilities.screenRefreshRate) / 80.0f) + f9;
                this.v = min;
    ...
    public final void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            if (f9 != 0.0f) {
                ...
                this.w.addListener(new q5(this, 1));
