...
public final class z4 extends ql0 {
    ...
    public final void E() {
        ...
        if (d5Var.N) {
            ...
            if (c5Var != null) {
                p4 p4Var = c5Var.s;
                boolean z4 = c5Var.j;
                if (c5Var.b() <= 0 && (z4 || (!c5Var.e && !c5Var.m))) {
            ...
            if (c5Var != null) {
                ArrayList arrayList2 = c5Var.g;
                ArrayList arrayList3 = c5Var.i;
                if (c5Var.f) {
            ...
            if (c5Var == null || !(c5Var.e || c5Var.m)) {
                if (c5Var != null && c5Var.k) {
                    arrayList.add(new u4(11));
                } else if (c5Var != null) {
                    p4 p4Var2 = c5Var.s;
                    if (c5Var.b() < c5Var.a && TextUtils.isEmpty(p4Var2.c) && !p4Var2.b) {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        org.telegram.ui.Cells.m6 m6Var = (org.telegram.ui.Cells.m6) l1Var.a;
        ...
        boolean remove = d5Var.C.p.remove(Long.valueOf(j10));
        if (storyView != null) {
            TLRPC.Reaction reaction = storyView.reaction;
            if (reaction == null || (str2 = mg.q0.d(reaction).f) == null || !str2.equals("❤")) {
                j11 = 0;
                z4 = false;
            } else {
                j11 = 0;
            ...
            if (storyView instanceof TL_stories.TL_storyViewPublicRepost) {
                ...
                i12 = 11;
                i13 = 12;
                m6Var.c(user2, null, null, z4, 0L, storyView.story, false, true, remove);
            } else {
                ...
                if (storyView instanceof TL_stories.TL_storyViewPublicForward) {
                    ...
                    l5 l5Var = d5Var.y;
                    m6Var.c(user3, null, null, z4, j12, l5Var == null ? null : l5Var.a, true, true, remove);
                } else {
                    m6Var.c(user3, null, z4 ? null : storyView.reaction, z4, storyView.date, null, false, true, remove);
                }
            }
            int i15 = i10 < arrayList.size() + (-1) ? ((u4) arrayList.get(i10 + 1)).a : -1;
            m6Var.a = i15 == 1 || i15 == i12 || i15 == i13;
            m6Var.a(d5Var.d(storyView) ? 1.0f : 0.5f, false);
            return;
        }
        ...
        if (storyReaction != null) {
            if (storyReaction instanceof TL_stories.TL_storyReaction) {
                ...
                boolean z10 = (reaction2 == null || (str = mg.q0.d(reaction2).f) == null || !str.equals("❤")) ? false : true;
                i11 = 12;
                m6Var.c(user4, chat, z10 ? null : tL_storyReaction.reaction, z10, tL_storyReaction.date, null, false, true, remove);
            } else {
                i11 = 12;
                if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
                    ...
                    l5 l5Var2 = d5Var.y;
                    m6Var.c(user4, chat, null, false, j13, l5Var2 == null ? null : l5Var2.a, true, true, remove);
                }
            }
            boolean z11 = true;
            int i16 = i10 < arrayList.size() - 1 ? ((u4) arrayList.get(i10 + 1)).a : -1;
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                view = new w4(this, d5Var.getContext(), i13);
                break;
            case 1:
                cc0 cc0Var = org.telegram.ui.Cells.m6.D;
                view = new x4(i11, d5Var.getContext(), bVar, this);
                break;
            case 2:
            case 9:
            default:
                view = new w4(this, d5Var.getContext(), i12);
                break;
            case 3:
                view = new org.telegram.ui.Cells.r3(d5Var.getContext(), 70);
                break;
            case 4:
            ...
            case 8:
            case 10:
                y4 y4Var = new y4(d5Var.C.j ? 12 : (i10 == 10 || i10 == 7 || i10 == 8 || i10 == 5) ? 1 : 0, d5Var.getContext(), bVar, this);
                ih.s sVar = y4Var.d;
                if (i10 == 7) {
                    ...
                    if (!premiumFeaturesBlocked) {
                        ...
                        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ExpiredViewsStubPremiumDescription), new Runnable() { // from class: nh.v4
                        ...
                        Runnable runnable = new Runnable() { // from class: nh.v4
                            @Override // java.lang.Runnable
                            public final void run() {
                                switch (i12) {
                                    case 0:
                        ...
                        ((LinearLayout.LayoutParams) f90Var.getLayoutParams()).topMargin = AndroidUtilities.dp(12.0f);
                        TextView textView = new TextView(y4Var.getContext());
                        textView.setText(string);
                        int i14 = org.telegram.ui.ActionBar.j6.Sh;
                        org.telegram.ui.ActionBar.f6 f6Var = y4Var.n;
            ...
            case 11:
            case 12:
                f90 f90Var2 = new f90(d5Var.getContext(), null);
                f90Var2.setTextSize(1, 13.0f);
                f90Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.y6, bVar));
                f90Var2.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.J6, bVar));
                int dp2 = AndroidUtilities.dp(16.0f);
                int dp3 = AndroidUtilities.dp(21.0f);
                f90Var2.setPadding(dp3, dp2, dp3, dp2);
                f90Var2.setMaxLines(ConnectionsManager.DEFAULT_DATACENTER_ID);
                f90Var2.setGravity(17);
                f90Var2.setDisablePaddingsOffsetY(true);
                if (i10 == 11) {
                    f90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryViewsPremiumHint), new lh.b(this, 29)));
                } else {
                    f90Var2.setText(LocaleController.getString(R.string.ServerErrorViewersFull));
                }
                f90Var2.setLayoutParams(new f2.w0(-1, -2));
                view = f90Var2;
                break;
        }
        return new dl0(view);
