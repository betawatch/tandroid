        ...
        switch (this.a) {
            case 0:
                ...
                if (!(tLObject instanceof TLRPC.Updates)) {
                    ...
                    AndroidUtilities.runOnUIThread(new lh.n2(25, e1Var, MessagesController.findUpdatesAndRemove(updates, TL_update.TL_updateGroupCallMessage.class)));
                    ...
                    while (i13 < size3) {
                        ...
                        if (tL_updateGroupCallParticipants.call.id != e1Var.g() || z4) {
                            ...
                            if (e1Var.D != null) {
                                ...
                                kh.a2.x(new StringBuilder("[LivePlayer] joined call "), inputGroupCall.id);
                                e1Var.x = true;
                                if (e1Var.w && e1Var.B != null) {
                                    ...
                                    ConnectionsManager.getInstance(i11).sendRequest(leavegroupcall, new dg.d3(11, e1Var, updates));
                                    break;
                                }
                            }
                        }
                    ...
                    ConnectionsManager.getInstance(i11).sendRequest(leavegroupcall2, new dg.d3(11, e1Var, updates));
                }
                break;
            case 1:
                final int i15 = 0;
                final e1 e1Var2 = this.b;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: nh.a1
