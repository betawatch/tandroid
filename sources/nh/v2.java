...
public final class v2 implements xj {
    ...
    public final void l(ArrayList arrayList, String str, ArrayList arrayList2, ArrayList arrayList3, boolean z4, int i10, long j10, boolean z10, long j11) {
        ...
        SendMessagesHelper.prepareSendingDocuments(accountInstance, (ArrayList<String>) arrayList, (ArrayList<String>) arrayList, (ArrayList<Uri>) null, str, (String) null, d4Var.y1, (MessageObject) null, (MessageObject) null, storyItem, (pn) null, (MessageObject) null, z4, i10, (t0.i) null, (SendMessageChatArguments) null, 0L, false, j11);
        d4Var.k0(j11 <= 0);
    }
