...
public final class f {
    public static final s5.b u = new s5.b("MediaNotificationProxy", null);
    ...
    public f(Context context) {
        ...
        this.i = new j(context.getApplicationContext(), new q5.b(1, dimensionPixelSize, dimensionPixelSize));
            ...
            case -945151566:
                if (str.equals(MediaIntentReceiver.ACTION_SKIP_NEXT)) {
                    ...
                    if (this.o == null) {
                        ...
                        this.o = new e0.j(fVar.r, resources.getString(fVar.I), pendingIntent).b();
                    }
                    return this.o;
                }
                break;
            case -945080078:
                if (str.equals(MediaIntentReceiver.ACTION_SKIP_PREV)) {
                    ...
                    if (this.p == null) {
                        ...
                        this.p = new e0.j(fVar.s, resources.getString(fVar.J), pendingIntent).b();
                    }
                    return this.p;
                }
                break;
            case -668151673:
                if (str.equals(MediaIntentReceiver.ACTION_STOP_CASTING)) {
                    if (this.t == null) {
                        ...
                        this.t = new e0.j(fVar.C, resources.getString(fVar.Q), PendingIntent.getBroadcast(context, 0, intent4, z.a)).b();
                    }
                    return this.t;
                }
                break;
            case -124479363:
                if (str.equals(MediaIntentReceiver.ACTION_DISCONNECT)) {
                    if (this.s == null) {
                        ...
                        this.s = new e0.j(fVar.C, resources.getString(fVar.Q, ""), PendingIntent.getBroadcast(context, 0, intent5, z.a)).b();
                    }
                    return this.s;
                }
                break;
                ...
                if (str.equals(MediaIntentReceiver.ACTION_TOGGLE_PLAYBACK)) {
                    ...
                    if (!bVar2.a) {
                        if (this.m == null) {
                            ...
                            this.m = new e0.j(fVar.n, resources.getString(fVar.H), PendingIntent.getBroadcast(context, 0, intent6, z.a)).b();
                        }
                        return this.m;
                    }
                    if (this.n == null) {
                        ...
                        this.n = new e0.j(i10, resources.getString(i11), PendingIntent.getBroadcast(context, 0, intent7, z.a)).b();
                    }
                    return this.n;
                }
                break;
            ...
            if (a11 != null) {
                ...
                while (i12 < size2) {
                    ...
                    if (str.equals(MediaIntentReceiver.ACTION_TOGGLE_PLAYBACK) || str.equals(MediaIntentReceiver.ACTION_SKIP_NEXT) || str.equals(MediaIntentReceiver.ACTION_SKIP_PREV) || str.equals(MediaIntentReceiver.ACTION_FORWARD) || str.equals(MediaIntentReceiver.ACTION_REWIND) || str.equals(MediaIntentReceiver.ACTION_STOP_CASTING) || str.equals(MediaIntentReceiver.ACTION_DISCONNECT)) {
                        ...
                        a2 = new e0.j(dVar.b, dVar.c, PendingIntent.getBroadcast(context, 0, intent2, z.a)).b();
                    }
                    if (a2 != null) {
                        this.f.add(a2);
                    }
