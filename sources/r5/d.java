...
public final /* synthetic */ class d implements t5.b, t0.e, pa.a, a2, ll0, uh.a, Continuation, m, yf.m, n, BillingController.ProductDetailsResponseListenerLegacy, d5, le.d, Utilities.Callback5, wo0, i5.e {
    ...
    public Object h() {
        ...
        switch (this.a) {
            ...
            default:
                t tVar = (t) this.b;
                Iterator it = ((Iterable) ((h) ((s5.d) tVar.c)).c(new s0(29))).iterator();
                while (it.hasNext()) {
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (x51Var.G instanceof TL_stars.StarsTransaction) {
                    v7.h1(s7Var.getContext(), false, 0L, s7Var.c, (TL_stars.StarsTransaction) x51Var.G, s7Var.b);
                    break;
                }
                break;
        }
