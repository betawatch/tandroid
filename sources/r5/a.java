                ...
                try {
                    ...
                    try {
                        ...
                        if (!DesugarCollections.unmodifiableList(bVar.w).isEmpty()) {
                            ...
                            mVar.getClass();
                            com.google.android.gms.internal.cast.m.f.b(a2.k(unmodifiableList.size(), "SetRouteDiscovery for ", " IDs"), new Object[0]);
                        ...
                        e.c = new j5(sVar, new String[]{"com.google.android.gms.cast.MAP_CAST_STATUS_CODES_TO_CAST_REASON_CODES"}, 11);
                        e.d = new y5.c[]{q5.y.d};
                        e.b = false;
                        e.a = 8427;
        ...
        if (n == null) {
            synchronized (m) {
                if (n == null) {
                    ...
                    try {
                        n = new a(applicationContext, castOptions, d.getAdditionalSessionProviders(applicationContext), new com.google.android.gms.internal.cast.p(applicationContext, c2.c0.d(applicationContext), castOptions, sVar), sVar);
                    } catch (d e) {
