    ...
    public final int h(l lVar, jb jbVar) {
            ...
            while (!z11) {
                ...
                if (i13 == 0) {
                    ...
                    if (i13 == i12) {
                        ...
                        wVar3.G(4);
                        c a10 = x6.a(Arrays.asList((String[]) x6.b(wVar3, false, false).b));
                        if (cVar2 == null) {
                            cVar = a10;
                        } else {
                            if (a10 != null) {
        ...
        if (i11 == 4) {
            ...
            if (oVar3.k != null) {
                ...
                x xVar = new x(z8Var, e0Var, b10, j15, j13, j14, j10, Math.max(6, i19));
                this.l = xVar;
                nVar = xVar.a;
            }
            mVar.h2(nVar);
        ...
        if (this.n == -1) {
            ...
            int i22 = 0;
            while (i22 < r10) {
                int d = hVar4.d(i22, r10 - i22, bArr5);
                if (d == -1) {
                    break;
                }
                i22 += d;
