...
public final /* synthetic */ class i implements Runnable {
        ...
        switch (i12) {
            ...
            case 2:
                ...
                if (user != null) {
                    ...
                    if (user.photo != null && !z10) {
                        if (nVar.s == null) {
                            m mVar = new m(nVar, o2Var.getParentActivity(), (ml0) f5Var.getParent(), o2Var.getResourceProvider(), nVar.a);
                            nVar.s = mVar;
                            ...
                            nVar.s.setOnDismissListener(new g5(nVar, 11));
                            nVar.s.show();
                            break;
                        }
                    } else {
            ...
            case 20:
                ...
                if (a0Var != null) {
                    ...
                    q8 q8Var = new q8(e4Var.getContext(), boVar.getCurrentAccount(), boVar.a(), boVar, messageObject2, arrayList4, chatFull == null || chatFull.paid_reactions_available, false, 0L, boVar.getResourceProvider());
            ...
            case 23:
                ...
                if (tLObject4 instanceof TL_stars.TL_payments_savedStarGifts) {
                    ...
                    if (tL_payments_savedStarGifts.gifts.size() > 0) {
                        ...
                        NotificationCenter.getInstance(i20).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(n5Var.b), n5Var);
                        break;
                    }
                }
                break;
            ...
            case 26:
                q8 q8Var2 = (q8) obj2;
                q8Var2.R = true;
                q8Var2.o(new s5((u5) obj, i13));
                AndroidUtilities.runOnUIThread(new z7(q8Var2, i15), 240L);
                break;
            case 27:
                q qVar = (q) obj2;
                x5 x5Var = (x5) obj;
    ...
    public /* synthetic */ i(v5 v5Var, boolean[] zArr, Utilities.Callback2 callback2) {
        this.a = 22;
        this.b = zArr;
        this.c = callback2;
    }
