...
public final class j {
    ...
    public final b0[] b = new b0[h.C.length];
    public final a1[] c = new a1[2];
    public int d = 0;
    ...
    public final void a(Canvas canvas, Rect rect) {
            ...
            if (Rect.intersects(hVar.getBounds(), rect2)) {
                ...
                if (b0VarArr != null) {
                    ...
                    if (length == fArr3.length) {
                        ...
                        int min = (int) Math.min(currentTimeMillis - hVar.j, 34L);
                        ...
                        for (int i36 = 0; i36 < length2; i36++) {
                            ...
                            if (i38 > fArr6.length) {
                                b0Var2.c = Arrays.copyOf((float[]) b0Var2.c, Math.max(i38, fArr6.length * 2));
                            }
                            System.arraycopy(fArr5, 0, (float[]) b0Var2.c, b0Var2.b, i37);
                            b0Var2.b += i37;
                        }
                        i14 = i10 + 1;
                        rect2 = rect;
        ...
        for (int i39 = 0; i39 < fArr7.length; i39++) {
            ...
            Paint paint = hVar2.a[i39];
            int i40 = b0Var3.b;
            if (i40 > 0) {
                canvas.drawPoints((float[]) b0Var3.c, 0, i40, paint);
            }
        }
    }
}
