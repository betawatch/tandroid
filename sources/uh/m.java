...
public abstract class m extends f2.l {
    ...
    */
    public final void T(final n1 n1Var, f2.k kVar, boolean z10) {
        n1 n1Var2;
        r1 r1Var;
        s1 s1Var;
        int i10;
        ...
        tn tnVar = this.F;
        if (tnVar != null && (view instanceof h0)) {
            h0 h0Var = (h0) view;
            ...
            if (tnVar == null || !(view instanceof ua)) {
                if (view instanceof s1) {
                    ...
                    if (lVar2.n) {
                        s1Var3.U3(lVar2.o, lVar2.p, lVar2.q, lVar2.r);
                        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
                        float f11 = s1Var3.getCurrentMessagesGroup() == null ? transitionParams.u0 : s1Var3.getCurrentMessagesGroup().transitionParams.captionEnterProgress;
                        final float P2 = s1Var3.getCurrentMessagesGroup() == null ? s1Var3.P2() : s1Var3.getCurrentMessagesGroup().hasCaption;
                        if (f11 != P2) {
                            f10 = f11;
                            z12 = true;
                        } else {
                        ...
                        i10 = 2;
                        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: uh.a
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                l lVar3 = l.this;
                                float f13 = 1.0f - floatValue;
                                float f14 = lVar3.o * f13;
                                r1 r1Var4 = transitionParams;
                                float f15 = (r1Var4.m0 * floatValue) + f14;
                                float f16 = (r1Var4.n0 * floatValue) + (lVar3.p * f13);
                                float f17 = (r1Var4.o0 * floatValue) + (lVar3.q * f13);
                                float f18 = (r1Var4.p0 * floatValue) + (lVar3.r * f13);
                                boolean z13 = z12;
                                s1 s1Var4 = s1Var3;
                                if (z13) {
                                    float f19 = (P2 * floatValue) + (f12 * f13);
                                    r1Var4.u0 = f19;
                                    if (s1Var4.getCurrentMessagesGroup() != null) {
                                        s1Var4.getCurrentMessagesGroup().transitionParams.captionEnterProgress = f19;
                                    }
                                }
                                if (r1Var4.B0) {
                                    ...
                                    int[] iArr3 = iArr2;
                                    int[] iArr4 = r1Var4.A0;
                                    photoImage.setRoundRadius((int) ((iArr4[0] * floatValue) + (iArr3[0] * f13)), (int) ((iArr4[1] * floatValue) + (iArr3[1] * f13)), (int) ((iArr4[2] * floatValue) + (iArr3[2] * f13)), (int) ((iArr4[3] * floatValue) + (iArr3[3] * f13)));
                                }
                                s1Var4.U3(f15, f16, f17, f18);
                                n1Var.a.invalidate();
                            }
                        };
                    ...
                    if (lVar2.v == 0 && lVar2.t == 0 && lVar2.u == 0 && lVar2.s == 0) {
                        ...
                        ofFloat3.addUpdateListener(new s(lVar2, r1Var, s1Var, 4));
                        z11 = false;
                    ...
                    if (lVar2.j) {
                        ...
                        final jl0 jl0Var2 = (jl0) view.getParent();
                        final float f13 = currentMessagesGroup.transitionParams.captionEnterProgress;
                        if (currentMessagesGroup.hasCaption) {
                            f9 = 1.0f;
                        }
                        final boolean z13 = f13 != f9;
                        r1Var2 = r1Var4;
                        final float f14 = f9;
                        lVar = lVar2;
                        s1Var2 = s1Var;
                        ofFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: uh.b
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                l lVar3 = lVar;
                                ...
                                if (z13) {
                                    transitionParams3.captionEnterProgress = com.google.android.recaptcha.internal.a.z(1.0f, floatValue, f14, f13 * floatValue);
                                }
                                jl0 jl0Var3 = jl0Var2;
                                if (jl0Var3 != null) {
                                    jl0Var3.invalidate();
                    ...
                    if (lVar.k) {
                        ...
                        r1Var3 = r1Var2;
                        ofFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: uh.c
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i11) {
                                    case 0:
                                        r1Var3.z0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                        s1Var2.invalidate();
                                        break;
                                    default:
                                        r1Var3.K1 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                        s1Var2.invalidate();
                                        break;
                                }
                            }
                    ...
                    if (lVar.m) {
                        ...
                        r1Var3.g = true;
                        ofFloat6.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: uh.c
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i16) {
                                    case 0:
                    ...
                    if (view instanceof v0) {
                        ...
                        if (lVar2.m) {
                            ...
                            ofFloat7.addUpdateListener(new yf.a(i16, transitionParams3, v0Var));
                ...
                animatorSet.addListener(new i(this, n1Var2, i14, view));
                animatorSet.start();
                this.J.put(n1Var2, animatorSet);
            }
            ua uaVar = (ua) view;
        ...
        if (a2 && this.N) {
            ...
            if (z10) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    i10 += ((n1) arrayList.get(i12)).a.getHeight();
                }
            } else {
                i10 = 0;
            }
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                ((n1) arrayList.get(i13)).a.setTranslationY(i10);
            }
        }
        return a2;
    }
    ...
    */
    public final void m() {
        ...
        if (z21) {
            ...
            while (i17 < arrayList9.size()) {
                if (this.Q) {
                    i17 = ((n1) arrayList9.get(i17)).c() != (jl0Var.getAdapter() == null ? 0 : jl0Var.getAdapter().h()) - 1 ? i17 + 1 : 0;
                    z10 = true;
                } else {
                    if (((n1) arrayList9.get(i17)).c() != 0) {
                    }
                    z10 = true;
                }
            }
        ...
        if (z10) {
            ...
            if (!isEmpty5 || !isEmpty6 || !isEmpty8 || !isEmpty7) {
                ...
                if (!isEmpty8) {
                    ...
                    while (i21 < size4) {
                        int i22 = i21 + 1;
                        n1 n1Var = (n1) arrayList12.get(i21);
                        View view2 = n1Var.a;
                        ViewPropertyAnimator animate = view2.animate();
                        arrayList10.add(n1Var);
                        ...
                        tn tnVar2 = this.F;
                        if (tnVar2 != null) {
                            ArrayList arrayList13 = tnVar2.q4;
                            if (s1Var2 != null && arrayList13.contains(s1Var2.getMessageObject())) {
                                arrayList13.remove(s1Var2.getMessageObject());
                                dk dkVar = tnVar2.U;
                                if (dkVar.b0 == null || !((ffVar = dkVar.H0) == null || ffVar.m0)) {
                                    i16 = size4;
                                } else {
                                    i16 = size4;
                                    if (System.currentTimeMillis() - dkVar.I0 > 300) {
                                        z20 = true;
                                        dkVar.I0 = -1L;
                                        if (z20) {
                                            if (s1Var2.getMessageObject().isVoice()) {
                                                if (Math.abs(view2.getTranslationY()) < view2.getMeasuredHeight() * 3.0f) {
                                                    new rh1(s1Var2, tnVar2.U, this.G, tnVar2.I9, this.R).f.start();
                                                }
                                            } else if (SharedConfig.getDevicePerformanceClass() != 0 && Math.abs(view2.getTranslationY()) < jl0Var.getMeasuredHeight()) {
                                                tnVar = tnVar2;
                                                ValueAnimator valueAnimator = new da1(s1Var2, tnVar2, this.G, tnVar2.I9, this.R).d;
                                                ...
                                                if (runnable != null) {
                                                    ...
                                                    dkVar2.b0.run();
                                                    dkVar2.b0 = null;
                                                    animate.translationY(0.0f).setDuration(250L).setInterpolator(this.o).setListener(new rs((f2.l) this, n1Var, (Object) view2, (Object) animate, 5)).start();
                                                    i18 = i18;
                                                    i21 = i22;
                                                    size4 = i16;
                                                    f10 = 1.0f;
            ...
            if (!isEmpty9 || !isEmpty10 || !isEmpty12 || !isEmpty11) {
                boolean z22 = (this.U == null || (pgVar2 = this.T) == null || !((Boolean) pgVar2.run()).booleanValue()) ? false : true;
                ...
                if (z22) {
                    ...
                    while (i23 < arrayList6.size()) {
                        n1 n1Var2 = (n1) arrayList6.get(i23);
                        if (arrayList16.contains(n1Var2)) {
                            z17 = isEmpty10;
                            View view4 = n1Var2.a;
                            z18 = isEmpty11;
                            if ((view4 instanceof s1) && ((s1) view4).getCurrentMessagesGroup() != null && (messageObject = ((s1) n1Var2.a).getMessageObject()) != null && messageObject.getGroupId() != 0) {
                                ...
                                arrayList16.remove(n1Var2);
                                arrayList6.remove(i23);
                                i23--;
                                arrayList17.add(n1Var2);
                                i23++;
                                z22 = z19;
                                isEmpty10 = z17;
                                isEmpty11 = z18;
                    ...
                    if (longSparseArray != null) {
                        ...
                        while (i24 < longSparseArray.size()) {
                            ...
                            if (arrayList19.size() > 0) {
                                View view5 = ((n1) arrayList19.get(0)).a;
                                if (!(view5 instanceof s1) || (currentMessagesGroup = ((s1) view5).getCurrentMessagesGroup()) == null || currentMessagesGroup.messages.size() <= arrayList19.size()) {
                                    ...
                                    p01 p01Var = (p01) this.U.run();
                                    for (int i25 = 0; i25 < arrayList19.size(); i25++) {
                                    }
                                    ArrayList arrayList20 = new ArrayList();
                                    i14 = i24;
                                    for (int i26 = 0; i26 < arrayList19.size(); i26++) {
                                        arrayList20.add(((n1) arrayList19.get(i26)).a);
                                    }
                                    sf.a aVar = new sf.a(this, arrayList20, arrayList19, 12);
                                    n01 n01Var = p01Var.a;
                                    if (n01Var != null) {
                                        n01Var.f(arrayList20, aVar);
                                        Choreographer.getInstance().postFrameCallback(p01Var.b);
                                    } else {
                                        p01Var.c.add(new o01(arrayList20, aVar));
                                    }
                        ...
                        while (true) {
                            ...
                            int i27 = i10 + 1;
                            n1 n1Var3 = (n1) obj3;
                            boolean z24 = arrayList16.remove(n1Var3) && z13;
                            if (BuildVars.LOGS_ENABLED) {
                            ...
                            View view6 = n1Var3.a;
                            arrayList15.add(n1Var3);
                            if (!z24 || (pgVar = this.U) == null) {
                                i13 = i27;
                                z16 = z13;
                                ...
                                ofFloat.addListener(new f(this, view6, n1Var3));
                                hashMap.put(n1Var3, ofFloat);
                                ofFloat.start();
                            } else {
                                p01 p01Var2 = (p01) pgVar.run();
                                i13 = i27;
                                sf.a aVar2 = new sf.a(this, view6, n1Var3, 13);
                                n01 n01Var2 = p01Var2.a;
                                if (n01Var2 != null) {
                                    n01Var2.e(view6, 1.0f, aVar2);
                                    Choreographer.getInstance().postFrameCallback(p01Var2.b);
                                } else {
                                    p01Var2.c.add(new o01(view6, aVar2));
                                }
                        ...
                        if (!z11) {
                            ...
                            arrayList7.clear();
                            ic.k kVar2 = new ic.k(this, arrayList21, z23, 2);
                            if (!this.C || isEmpty9) {
                                kVar2.run();
                            } else {
                        ...
                        if (!z12) {
                            ...
                            arrayList8.clear();
                            od.i iVar = new od.i(10, this, arrayList22);
                            if (!this.C || isEmpty9) {
                                iVar.run();
                            } else {
                                View view8 = ((f2.j) arrayList22.get(0)).a.a;
                                WeakHashMap weakHashMap2 = j0.a;
                                view8.postOnAnimationDelayed(iVar, 0L);
                            }
                        }
                        if (!isEmpty12) {
                            ...
                            arrayList9.clear();
                            Collections.sort(arrayList23, new wp0(25));
                            int size5 = arrayList23.size();
                            int i28 = 0;
                            while (i28 < size5) {
                                int i29 = i28 + 1;
                                n1 n1Var4 = (n1) arrayList23.get(i28);
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.d("animate add impl");
                                }
                                View view9 = n1Var4.a;
                                ArrayList arrayList24 = arrayList;
                                arrayList24.add(n1Var4);
                                if (n1Var4 == this.O) {
                                    view9.setAlpha(1.0f);
                                }
                                AnimatorSet animatorSet = new AnimatorSet();
                                ...
                                long max = (long) ((1.0f - Math.max(f9, Math.min(1.0f, view9.getBottom() / jl0Var.getMeasuredHeight()))) * 100.0f);
                                if (!(view9 instanceof s1)) {
                                    i11 = size5;
                                } else if (n1Var4 == this.O) {
                                    co coVar = this.P;
                                    if (coVar != null) {
                                        coVar.h.setAlpha(0.0f);
                                    }
                                    jl0Var.setClipChildren(false);
                                    final s1 s1Var4 = (s1) view9;
                                    View view10 = (View) this.P.getParent();
                                    float x4 = view10.getX() + this.P.getX() + this.P.h.getX();
                                    float y8 = view10.getY() + this.P.getY() + this.P.h.getY();
                                    float x10 = s1Var4.getX() + jl0Var.getX() + s1Var4.getPhotoImage().getImageX();
                                    float y10 = s1Var4.getY() + jl0Var.getY() + s1Var4.getPhotoImage().getImageY();
                                    ...
                                    final float f11 = x4 - x10;
                                    final float f12 = y8 - y10;
                                    ...
                                    s1Var4.getPhotoImage().setImageCoords(imageX + f11, imageX + f12, width, height);
                                    ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
                                    ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: uh.d
                                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                            ...
                                            float f13 = 1.0f - floatValue;
                                            s1Var5.getPhotoImage().setImageCoords((f11 * f13) + imageX, (f12 * f13) + imageY, (imageWidth * floatValue) + (width * f13), (imageHeight * floatValue) + (height * f13));
                                            s1Var5.invalidate();
                                        }
                                    });
                                    i11 = size5;
                                    ...
                                    animatorSet.addListener(new f(this, n1Var4, view9));
                                    hashMap.put(n1Var4, animatorSet);
                                    animatorSet.start();
                                    i28 = i29;
        ...
        ofFloat3.addUpdateListener(new d5(this, 27));
    ...
    public final boolean q(n1 n1Var, n1 n1Var2, a5.e eVar, int i10, int i11, int i12, int i13) {
        ...
        view2.setAlpha(0.0f);
        this.s.add(new f2.j(n1Var, n1Var2, i10, i11, i12, i13));
        F();
        return true;
    }
    ...
    public final boolean r(n1 n1Var, a5.e eVar, int i10, int i11, int i12, int i13) {
        ...
        v0 v0Var2 = v0Var;
        float f16 = f11;
        l lVar = new l(n1Var, i17, translationY, i12, i13);
        if (s1Var != null) {
            ...
            if (z11) {
                ...
                k kVar = (k) eVar;
                i15 = i19;
                boolean z12 = (!transitionParams.v0 || kVar.f == f9 || kVar.e == f9) ? false : true;
                lVar.n = z12;
                if (z12) {
                    jl0Var.setClipChildren(false);
                    jl0Var.invalidate();
                    ...
                    float f18 = kVar.c;
                    if (f17 == f18 && transitionParams.n0 == kVar.d && transitionParams.p0 == kVar.f && transitionParams.o0 == kVar.e && !transitionParams.B0) {
                        ...
                        s1Var.U3(lVar.o, lVar.p, lVar.q, lVar.r);
                    }
                }
            ...
            if (currentMessagesGroup != null) {
                ...
                if (arrayList.contains(currentMessagesGroup)) {
                    ...
                    int i26 = 0;
                    int i27 = 0;
                    while (i23 < jl0Var2.getChildCount()) {
                        View childAt = jl0Var2.getChildAt(i23);
                        if (childAt instanceof s1) {
            ...
            if (i15 == 0 && i20 == 0 && !lVar.n && !lVar.w && !lVar.j && !lVar.k && !lVar.l && !f19) {
                v(n1Var);
                return false;
            }
        } else if (v0Var2 != null) {
    ...
    public final void s(n1 n1Var, a5.e eVar) {
        ...
        if (eVar != null) {
            ...
            if (eVar instanceof k) {
                k kVar = (k) eVar;
                s1Var.U3(kVar.c, kVar.d, kVar.e, kVar.f);
            }
        }
    }
}
