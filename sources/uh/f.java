...
public abstract class f {
    ...
    static {
        ...
        f = h.i(new qr(0.7f, -0.6f, 0.4f, 1.0f), 0, 200, 560, false);
        g = h.i(new qr(0.7f, -0.6f, 0.4f, 1.0f), 200, 400, 560, true);
        ...
        qr qrVar = qr.h;
        j = h.i(qrVar, 0, 320, 560, false);
        k = h.i(qrVar, 40, 320, 560, false);
        l = h.i(new DecelerateInterpolator(), 0, MediaDataController.MAX_LINKS_COUNT, 560, false);
        m = h.i(qrVar, 0, 460, 560, false);
        n = h.i(qrVar, 0, 325, 560, false);
        ...
        q = h.i(qrVar, 60, 320, 560, false);
        r = h.i(qrVar, 90, 380, 560, false);
        s = h.i(qrVar, 110, 440, 560, false);
