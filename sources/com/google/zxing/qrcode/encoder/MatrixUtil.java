...
abstract class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = {new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, 106, -1, -1}, new int[]{6, 32, 58, 84, 110, -1, -1}, new int[]{6, 30, 58, 86, 114, -1, -1}, new int[]{6, 34, 62, 90, 118, -1, -1}, new int[]{6, 26, 50, 74, 98, 122, -1}, new int[]{6, 30, 54, 78, 102, 126, -1}, new int[]{6, 26, 52, 78, 104, NotificationCenter.dialogIsTranslatable, -1}, new int[]{6, 30, 56, 82, 108, NotificationCenter.walletSyncProgressChanged, -1}, new int[]{6, 34, 60, 86, 112, NotificationCenter.fileUploaded, -1}, new int[]{6, 30, 58, 86, 114, NotificationCenter.fileLoaded, -1}, new int[]{6, 34, 62, 90, 118, NotificationCenter.filePreparingFailed, -1}, new int[]{6, 30, 54, 78, 102, 126, 150}, new int[]{6, 24, 50, 76, 102, 128, NotificationCenter.recordProgressChanged}, new int[]{6, 28, 54, 80, 106, NotificationCenter.didGenerateFingerprintKeyPair, NotificationCenter.recordPaused}, new int[]{6, 32, 58, 84, 110, NotificationCenter.httpFileDidFailedLoad, NotificationCenter.audioDidSent}, new int[]{6, 26, 54, 82, 110, NotificationCenter.fileUploaded, NotificationCenter.groupCallUpdated}, new int[]{6, 30, 58, 86, 114, NotificationCenter.fileLoaded, NotificationCenter.activeGroupCallsUpdated}};
