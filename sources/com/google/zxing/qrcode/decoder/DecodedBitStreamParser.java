    ...
    */
    ...
    private static void decodeHanziSegment(BitSource bitSource, StringBuilder sb, int i) {
        ...
        while (i > 0) {
            ...
            bArr[i2] = (byte) ((i4 >> 8) & NotificationCenter.didReceiveSmsCode);
            bArr[i2 + 1] = (byte) (i4 & NotificationCenter.didReceiveSmsCode);
            i2 += 2;
            i--;
        }
    ...
    private static void decodeKanjiSegment(BitSource bitSource, StringBuilder sb, int i) {
        ...
        while (i > 0) {
            int readBits = bitSource.readBits(13);
            int i3 = (readBits % NotificationCenter.didUpdatePremiumGiftStickers) | ((readBits / NotificationCenter.didUpdatePremiumGiftStickers) << 8);
    ...
    private static int parseECIValue(BitSource bitSource) {
        int readBits = bitSource.readBits(8);
        if ((readBits & 128) == 0) {
            return readBits & NotificationCenter.needDeleteBusinessLink;
        }
        if ((readBits & NotificationCenter.didUpdatePremiumGiftStickers) == 128) {
            return bitSource.readBits(8) | ((readBits & 63) << 8);
        }
        if ((readBits & NotificationCenter.factCheckLoaded) == 192) {
