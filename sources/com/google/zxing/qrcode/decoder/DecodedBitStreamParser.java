...
abstract class DecodedBitStreamParser {
    ...
    private static void decodeHanziSegment(BitSource bitSource, StringBuilder sb, int i) {
        ...
        while (i > 0) {
            ...
            bArr[i2] = (byte) ((i4 >> 8) & NotificationCenter.didReplacedPhotoInMemCache);
            bArr[i2 + 1] = (byte) (i4 & NotificationCenter.didReplacedPhotoInMemCache);
            i2 += 2;
            i--;
        }
        try {
    ...
    private static void decodeKanjiSegment(BitSource bitSource, StringBuilder sb, int i) {
        ...
        while (i > 0) {
            int readBits = bitSource.readBits(13);
            int i3 = (readBits % NotificationCenter.didUpdateTonGiftStickers) | ((readBits / NotificationCenter.didUpdateTonGiftStickers) << 8);
