...
public class DefaultDrmSessionManager implements DrmSessionManager {
    ...
    public static final class Builder {
        ...
        private final HashMap keyRequestParameters = new HashMap();
    ...
    private DefaultDrmSession createAndAcquireSessionWithRetry(List list, boolean z, DrmSessionEventListener.EventDispatcher eventDispatcher, boolean z2) {
    ...
    private DefaultDrmSession createAndAcquireSession(List list, boolean z, DrmSessionEventListener.EventDispatcher eventDispatcher) {
    ...
    private class ProvisioningManagerImpl implements DefaultDrmSession.ProvisioningManager {
        ...
        public void onSessionFullyReleased(DefaultDrmSession defaultDrmSession) {
            ...
            if (this.provisioningSession == defaultDrmSession) {
                ...
                DefaultDrmSession defaultDrmSession2 = (DefaultDrmSession) this.sessionsAwaitingProvisioning.iterator().next();
                this.provisioningSession = defaultDrmSession2;
