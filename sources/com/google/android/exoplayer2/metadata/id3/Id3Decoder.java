    ...
    */
    private static Id3Frame decodeFrame(int i, ParsableByteArray parsableByteArray, boolean z, int i2, FramePredicate framePredicate) {
        ...
        if (i == 4) {
            ...
            if (!z) {
                readUnsignedIntToInt = (((readUnsignedIntToInt >> 24) & NotificationCenter.goingToPreviewTheme) << 21) | (readUnsignedIntToInt & NotificationCenter.goingToPreviewTheme) | (((readUnsignedIntToInt >> 8) & NotificationCenter.goingToPreviewTheme) << 7) | (((readUnsignedIntToInt >> 16) & NotificationCenter.goingToPreviewTheme) << 14);
            }
        } else {
