...
final class OggPageHeader {
    ...
    public int type;
    public final int[] laces = new int[NotificationCenter.goingToPreviewTheme];
    private final ParsableByteArray scratch = new ParsableByteArray(NotificationCenter.goingToPreviewTheme);
