...
final class OggPageHeader {
    ...
    public int type;
    public final int[] laces = new int[NotificationCenter.didReceiveSmsCode];
    private final ParsableByteArray scratch = new ParsableByteArray(NotificationCenter.didReceiveSmsCode);
