...
final class OggPageHeader {
    ...
    public int type;
    public final int[] laces = new int[NotificationCenter.proxyCheckDone];
    private final ParsableByteArray scratch = new ParsableByteArray(NotificationCenter.proxyCheckDone);
