...
final class OggPageHeader {
    ...
    public int type;
    public final int[] laces = new int[NotificationCenter.didSetNewWallpapper];
    private final ParsableByteArray scratch = new ParsableByteArray(NotificationCenter.didSetNewWallpapper);
