...
final class OggPageHeader {
    ...
    public int type;
    public final int[] laces = new int[NotificationCenter.didReceiveCall];
    private final ParsableByteArray scratch = new ParsableByteArray(NotificationCenter.didReceiveCall);
