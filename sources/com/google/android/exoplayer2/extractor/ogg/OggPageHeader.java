...
final class OggPageHeader {
    ...
    public int type;
    public final int[] laces = new int[NotificationCenter.cameraInitied];
    private final ParsableByteArray scratch = new ParsableByteArray(NotificationCenter.cameraInitied);
