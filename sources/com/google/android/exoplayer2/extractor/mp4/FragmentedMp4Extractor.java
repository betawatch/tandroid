    ...
    private static final class TrackBundle {
        ...
        public int outputSampleEncryptionData(int i, int i2) {
            ...
            if (!sampleHasSubsampleEncryptionTable) {
                ...
                data[0] = 0;
                data[1] = 1;
                data[2] = (byte) ((i2 >> 8) & NotificationCenter.invalidateMotionBackground);
                data[3] = (byte) (i2 & NotificationCenter.invalidateMotionBackground);
                data[4] = (byte) ((i >> 24) & NotificationCenter.invalidateMotionBackground);
                data[5] = (byte) ((i >> 16) & NotificationCenter.invalidateMotionBackground);
                data[6] = (byte) ((i >> 8) & NotificationCenter.invalidateMotionBackground);
                data[7] = (byte) (i & NotificationCenter.invalidateMotionBackground);
            ...
            if (i2 != 0) {
                ...
                data2[2] = (byte) ((i5 >> 8) & NotificationCenter.invalidateMotionBackground);
                data2[3] = (byte) (i5 & NotificationCenter.invalidateMotionBackground);
