...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private static final class TrackBundle {
        ...
        public int outputSampleEncryptionData(int i, int i2) {
            ...
            if (!sampleHasSubsampleEncryptionTable) {
                ...
                data[0] = 0;
                data[1] = 1;
                data[2] = (byte) ((i2 >> 8) & NotificationCenter.didSetNewWallpapper);
                data[3] = (byte) (i2 & NotificationCenter.didSetNewWallpapper);
                data[4] = (byte) ((i >> 24) & NotificationCenter.didSetNewWallpapper);
                data[5] = (byte) ((i >> 16) & NotificationCenter.didSetNewWallpapper);
                data[6] = (byte) ((i >> 8) & NotificationCenter.didSetNewWallpapper);
                data[7] = (byte) (i & NotificationCenter.didSetNewWallpapper);
            ...
            if (i2 != 0) {
                ...
                data2[2] = (byte) ((i5 >> 8) & NotificationCenter.didSetNewWallpapper);
                data2[3] = (byte) (i5 & NotificationCenter.didSetNewWallpapper);
    ...
    private static void parseSampleGroups(Atom.ContainerAtom containerAtom, String str, TrackFragment trackFragment) {
        ...
        int i3 = (readUnsignedByte & NotificationCenter.closeOtherAppActivities) >> 4;
