...
public class MatroskaExtractor implements Extractor {
    ...
    protected int getElementType(int i) {
        switch (i) {
            ...
            case NotificationCenter.conferenceEmojiUpdated /* 238 */:
            case NotificationCenter.musicIdsLoaded /* 241 */:
            case NotificationCenter.cameraInitied /* 251 */:
            case 16871:
            case 16980:
            case 17029:
            case 17143:
    ...
    static {
        ...
        hashMap.put("htc_video_rotA-180", Integer.valueOf(NotificationCenter.dialogFiltersUpdated));
        hashMap.put("htc_video_rotA-270", Integer.valueOf(NotificationCenter.newLocationAvailable));
    ...
    */
                        ...
                        if (i16 < i18) {
                            ...
                            while (true) {
                                ...
                                if ((this.scratch.getData()[i9] & i21) != 0) {
                                    ...
                                    j = (~i21) & this.scratch.getData()[i9] & 255;
                                    while (i19 < i22) {
    ...
    private int writeSampleData(ExtractorInput extractorInput, Track track, int i, boolean z) {
        ...
        if (!this.sampleEncodingHandled) {
            ...
            if (track.samplesHaveSupplementalData(z)) {
                this.blockFlags |= TLObject.FLAG_28;
                this.supplementalData.reset(0);
                int limit = (this.sampleStrippedBytes.limit() + i) - this.sampleBytesRead;
                this.scratch.reset(4);
                this.scratch.getData()[0] = (byte) ((limit >> 24) & NotificationCenter.didApplyNewTheme);
                this.scratch.getData()[1] = (byte) ((limit >> 16) & NotificationCenter.didApplyNewTheme);
                this.scratch.getData()[2] = (byte) ((limit >> 8) & NotificationCenter.didApplyNewTheme);
                this.scratch.getData()[3] = (byte) (limit & NotificationCenter.didApplyNewTheme);
    ...
    protected static final class Track {
        ...
        public int maxFrameAverageLuminance = NotificationCenter.userIsPremiumBlockedUpadted;
        ...
        */
        public void initializeOutput(ExtractorOutput extractorOutput, int i) {
            ...
            switch (c) {
                ...
                case '\t':
                    ...
                    int i9 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    ...
                    if (!MimeTypes.isAudio(str2)) {
                        ...
                        float f = (this.displayWidth == i6 || (i7 = this.displayHeight) == i6) ? -1.0f : (this.height * r4) / (this.width * i7);
                        ...
                        if (this.projectionType == 0 && Float.compare(this.projectionPoseYaw, 0.0f) == 0 && Float.compare(this.projectionPosePitch, 0.0f) == 0) {
                            if (Float.compare(this.projectionPoseRoll, 0.0f) == 0) {
                                ...
                                i6 = NotificationCenter.dialogFiltersUpdated;
                            } else if (Float.compare(this.projectionPosePitch, -90.0f) == 0) {
                    ...
                    Format build = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                ...
                case 2:
                    if (parseMsAcmCodecPrivate(new ParsableByteArray(getCodecPrivate(this.codecId)))) {
                        ...
                        int i92 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                        builder = new Format.Builder();
                        if (!MimeTypes.isAudio(str2)) {
                        }
                        if (this.name != null) {
                        ...
                        Format build2 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                        TrackOutput track2 = extractorOutput.track(this.number, i8);
                        this.output = track2;
                    ...
                    int i922 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22 = extractorOutput.track(this.number, i8);
                    this.output = track22;
                ...
                case 3:
                    ...
                    int i9222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222 = extractorOutput.track(this.number, i8);
                ...
                case 4:
                    ...
                    int i92222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222 = extractorOutput.track(this.number, i8);
                ...
                case 5:
                    ...
                    int i922222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22222 = extractorOutput.track(this.number, i8);
                ...
                case 6:
                    ...
                    int i9222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222 = extractorOutput.track(this.number, i8);
                ...
                case 7:
                    ...
                    int i92222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222 = extractorOutput.track(this.number, i8);
                ...
                case '\b':
                    ...
                    int i922222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22222222 = extractorOutput.track(this.number, i8);
                ...
                case '\n':
                    ...
                    int i9222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222222 = extractorOutput.track(this.number, i8);
                ...
                case 11:
                    ...
                    int i92222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222 = extractorOutput.track(this.number, i8);
                ...
                case '\f':
                    ...
                    int i922222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22222222222 = extractorOutput.track(this.number, i8);
                ...
                case '\r':
                    ...
                    int i9222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 14:
                    ...
                    int i92222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 21:
                    ...
                    int i922222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 16:
                    ...
                    int i9222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 17:
                    ...
                    int i92222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 18:
                    ...
                    int i922222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 19:
                    ...
                    int i9222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 20:
                    ...
                    int i92222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 22:
                    if (this.audioBitDepth != 32) {
                        ...
                        int i922222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                        builder = new Format.Builder();
                        if (!MimeTypes.isAudio(str2)) {
                        }
                        if (this.name != null) {
                        }
                        Format build22222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                        TrackOutput track22222222222222222222 = extractorOutput.track(this.number, i8);
                    ...
                    int i9222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 23:
                    ...
                    int i92222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 24:
                    ...
                    int i922222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 25:
                    ...
                    int i9222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 26:
                    ...
                    int i92222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 27:
                    ...
                    int i922222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 28:
                    ...
                    int i9222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 29:
                    ...
                    int i92222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 30:
                    ...
                    int i922222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i922222222222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track22222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case 31:
                    ...
                    int i9222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9222222222222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track222222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case ' ':
                    ...
                    int i92222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str2)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222222222222222 = builder.setId(i).setSampleMimeType(str2).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i92222222222222222222222222222222).setInitializationData(singletonList).setCodecs(str3).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222222222222222222222222 = extractorOutput.track(this.number, i8);
        ...
        private static List parseVorbisCodecPrivate(byte[] bArr) {
            ...
            try {
                ...
                int i4 = 0;
                while (true) {
                    i = bArr[i3] & NotificationCenter.didApplyNewTheme;
                    if (i != 255) {
                        break;
                    }
                ...
                int i7 = 0;
                while (true) {
                    i2 = bArr[i5] & NotificationCenter.didApplyNewTheme;
                    if (i2 != 255) {
                        break;
                    }
                    i7 += NotificationCenter.didApplyNewTheme;
                    i5++;
                }
                int i8 = i5 + 1;
                int i9 = i7 + i2;
