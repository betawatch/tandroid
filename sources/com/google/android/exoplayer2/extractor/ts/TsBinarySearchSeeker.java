...
final class TsBinarySearchSeeker extends BinarySearchSeeker {
    ...
    private static final class TsPcrSeeker implements BinarySearchSeeker.TimestampSeeker {
        ...
        private BinarySearchSeeker.TimestampSearchResult searchForPcrValueInBuffer(ParsableByteArray parsableByteArray, long j, long j2) {
            ...
            while (parsableByteArray.bytesLeft() >= 188 && (findSyncBytePosition2 = (findSyncBytePosition = TsUtil.findSyncBytePosition(parsableByteArray.getData(), parsableByteArray.getPosition(), limit)) + NotificationCenter.giftsToUserSent) <= limit) {
