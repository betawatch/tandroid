...
public abstract class Timeline implements Bundleable {
    ...
    public static final Bundleable.Creator CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.Timeline$$ExternalSyntheticLambda0
    ...
    public static final class Period implements Bundleable {
        ...
        public static final Bundleable.Creator CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.Timeline$Period$$ExternalSyntheticLambda0
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public int hashCode() {
            Object obj = this.id;
            int hashCode = ((obj == null ? 0 : obj.hashCode()) + NotificationCenter.starSubscriptionsLoaded) * 31;
    ...
    public static final class Window implements Bundleable {
        ...
        public static final Bundleable.Creator CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.Timeline$Window$$ExternalSyntheticLambda0
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public int hashCode() {
            int hashCode = (((this.uid.hashCode() + NotificationCenter.starSubscriptionsLoaded) * 31) + this.mediaItem.hashCode()) * 31;
    ...
    private static ImmutableList fromBundleListRetriever(Bundleable.Creator creator, IBinder iBinder) {
        if (iBinder == null) {
        ...
        for (int i = 0; i < list.size(); i++) {
            builder.add((Object) creator.fromBundle((Bundle) list.get(i)));
        }
    ...
    public int hashCode() {
        ...
        Window window = new Window();
        Period period = new Period();
        int windowCount = getWindowCount() + NotificationCenter.starSubscriptionsLoaded;
        int i2 = 0;
        while (true) {
            i = windowCount * 31;
