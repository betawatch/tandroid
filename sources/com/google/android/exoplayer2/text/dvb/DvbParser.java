...
final class DvbParser {
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i7 > 0) {
            ...
            iArr[readBits4] = getColor((byte) (255 - (readBits2 & NotificationCenter.goingToPreviewTheme)), Util.constrainValue((int) (d + (1.402d * d2)), 0, NotificationCenter.goingToPreviewTheme), Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, NotificationCenter.goingToPreviewTheme), Util.constrainValue((int) (d + (d3 * 1.772d)), 0, NotificationCenter.goingToPreviewTheme));
            i7 = i2;
            readBits3 = readBits3;
            i5 = 8;
            i6 = 2;
