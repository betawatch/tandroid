...
final class DvbParser {
        ...
        while (i4 < sparseArray2.size()) {
            ...
            while (i7 < sparseArray3.size()) {
                ...
                if (objectData != null) {
                    ...
                    i3 = i7;
                    paintPixelDataSubBlocks(objectData, clutDefinition2, regionComposition.depth, regionObject.horizontalPosition + i5, regionObject.verticalPosition + i6, objectData.nonModifyingColorFlag ? null : this.defaultPaint, this.canvas);
                } else {
                    sparseArray = sparseArray2;
                    i3 = i7;
                }
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i7 > 0) {
            ...
            if (i3 == 0) {
                i4 = 0;
                readBits = 0;
                readBits2 = NotificationCenter.didReceiveSmsCode;
            }
            double d = i3;
            double d2 = i4 - 128;
            double d3 = readBits - 128;
            iArr[readBits4] = getColor((byte) (255 - (readBits2 & NotificationCenter.didReceiveSmsCode)), Util.constrainValue((int) (d + (1.402d * d2)), 0, NotificationCenter.didReceiveSmsCode), Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, NotificationCenter.didReceiveSmsCode), Util.constrainValue((int) (d + (d3 * 1.772d)), 0, NotificationCenter.didReceiveSmsCode));
            i7 = i2;
            readBits3 = readBits3;
            i5 = 8;
            i6 = 2;
    ...
    private static int[] generateDefault4BitClutEntries() {
        ...
        for (int i = 1; i < 16; i++) {
            if (i < 8) {
                iArr[i] = getColor(NotificationCenter.didReceiveSmsCode, (i & 1) != 0 ? NotificationCenter.didReceiveSmsCode : 0, (i & 2) != 0 ? NotificationCenter.didReceiveSmsCode : 0, (i & 4) != 0 ? NotificationCenter.didReceiveSmsCode : 0);
            } else {
                int i2 = i & 1;
                int i3 = NotificationCenter.needDeleteBusinessLink;
                int i4 = i2 != 0 ? NotificationCenter.needDeleteBusinessLink : 0;
                int i5 = (i & 2) != 0 ? NotificationCenter.needDeleteBusinessLink : 0;
                if ((i & 4) == 0) {
                    i3 = 0;
                }
                iArr[i] = getColor(NotificationCenter.didReceiveSmsCode, i4, i5, i3);
            }
        }
        return iArr;
    }
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i2 = 0; i2 < 256; i2++) {
            int i3 = NotificationCenter.didReceiveSmsCode;
            if (i2 < 8) {
                int i4 = (i2 & 1) != 0 ? NotificationCenter.didReceiveSmsCode : 0;
                int i5 = (i2 & 2) != 0 ? NotificationCenter.didReceiveSmsCode : 0;
                if ((i2 & 4) == 0) {
                    i3 = 0;
                }
                iArr[i2] = getColor(63, i4, i5, i3);
            } else {
                int i6 = i2 & NotificationCenter.httpFileDidFailedLoad;
                int i7 = NotificationCenter.activeGroupCallsUpdated;
                if (i6 == 0) {
                    int i8 = ((i2 & 1) != 0 ? 85 : 0) + ((i2 & 16) != 0 ? NotificationCenter.activeGroupCallsUpdated : 0);
                    int i9 = ((i2 & 2) != 0 ? 85 : 0) + ((i2 & 32) != 0 ? NotificationCenter.activeGroupCallsUpdated : 0);
                    i = (i2 & 4) == 0 ? 0 : 85;
                    if ((i2 & 64) == 0) {
                        i7 = 0;
                    }
                    iArr[i2] = getColor(NotificationCenter.didReceiveSmsCode, i8, i9, i + i7);
                } else if (i6 == 8) {
                    int i10 = ((i2 & 1) != 0 ? 85 : 0) + ((i2 & 16) != 0 ? NotificationCenter.activeGroupCallsUpdated : 0);
                    int i11 = ((i2 & 2) != 0 ? 85 : 0) + ((i2 & 32) != 0 ? NotificationCenter.activeGroupCallsUpdated : 0);
                    i = (i2 & 4) == 0 ? 0 : 85;
                    if ((i2 & 64) == 0) {
                        i7 = 0;
                    }
                    iArr[i2] = getColor(NotificationCenter.needDeleteBusinessLink, i10, i11, i + i7);
                } else if (i6 == 128) {
                    iArr[i2] = getColor(NotificationCenter.didReceiveSmsCode, ((i2 & 1) != 0 ? 43 : 0) + NotificationCenter.needDeleteBusinessLink + ((i2 & 16) != 0 ? 85 : 0), ((i2 & 2) != 0 ? 43 : 0) + NotificationCenter.needDeleteBusinessLink + ((i2 & 32) != 0 ? 85 : 0), ((i2 & 4) == 0 ? 0 : 43) + NotificationCenter.needDeleteBusinessLink + ((i2 & 64) == 0 ? 0 : 85));
                } else if (i6 == 136) {
                    iArr[i2] = getColor(NotificationCenter.didReceiveSmsCode, ((i2 & 1) != 0 ? 43 : 0) + ((i2 & 16) != 0 ? 85 : 0), ((i2 & 2) != 0 ? 43 : 0) + ((i2 & 32) != 0 ? 85 : 0), ((i2 & 4) == 0 ? 0 : 43) + ((i2 & 64) == 0 ? 0 : 85));
                }
            }
        }
        return iArr;
            ...
            if (readBits != 240) {
                switch (readBits) {
                    ...
                    case 17:
                        ...
                        i4 = paint4BitPixelCodeString(parsableBitArray, iArr3, bArr4, i4, i5, paint3, canvas2);
                        parsableBitArray.byteAlign();
                        paint = paint3;
                        iArr = iArr3;
                        break;
