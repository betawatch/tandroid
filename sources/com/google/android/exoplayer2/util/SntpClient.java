...
public abstract class SntpClient {
    ...
    private static long read32(byte[] bArr, int i) {
        ...
        int i5 = bArr[i + 3];
        if ((i2 & 128) == 128) {
            i2 = (i2 & NotificationCenter.needDeleteBusinessLink) + 128;
        }
        if ((i3 & 128) == 128) {
            i3 = (i3 & NotificationCenter.needDeleteBusinessLink) + 128;
        }
        if ((i4 & 128) == 128) {
            i4 = (i4 & NotificationCenter.needDeleteBusinessLink) + 128;
        }
        if ((i5 & 128) == 128) {
            i5 = (i5 & NotificationCenter.needDeleteBusinessLink) + 128;
        }
