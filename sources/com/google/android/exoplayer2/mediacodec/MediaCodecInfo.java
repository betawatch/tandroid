...
public final class MediaCodecInfo {
    ...
    private static final class Api29 {
        public static int areResolutionAndFrameRateCovered(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
            ...
            MediaCodecInfo.VideoCapabilities.PerformancePoint m = MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline0.m(i, i2, (int) d);
            for (int i3 = 0; i3 < supportedPerformancePoints.size(); i3++) {
                covers = MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline3.m(supportedPerformancePoints.get(i3)).covers(m);
                if (covers) {
                    return 2;
                }
            }
