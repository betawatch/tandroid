...
final class zzma {
    ...
    */
                ...
                if ((charAt2 >= 55296 && charAt2 <= 57343) || i7 > i3 - 3) {
                    ...
                    if (i8 != charSequence.length()) {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            ...
                            bArr[i7] = (byte) ((codePoint >>> 18) | NotificationCenter.closeOtherAppActivities);
    ...
    static String zzd(byte[] bArr, int i, int i2) {
        int i3;
        ...
        while (i < i4) {
            ...
            if (zzlw.zzd(b2)) {
                ...
                if (b2 < -32) {
                    ...
                    int i8 = i + 2;
                    i += 3;
                    zzlw.zzb(b2, bArr[i7], bArr[i8], cArr, i6);
                } else {
                    if (i7 >= i4 - 2) {
                        throw zzje.zzd();
                    }
                    ...
                    byte b5 = bArr[i + 2];
                    i += 4;
                    zzlw.zza(b2, b4, b5, bArr[i9], cArr, i6);
                    i6 += 2;
                }
                i6 = i3;
            }
