...
public final class zzvm {
    ...
    protected zzvm(byte[] bArr, byte[] bArr2) {
        if (bArr.length != 32) {
    ...
    protected final byte[] zzd(byte[] bArr) {
        ...
        while (length > 0) {
            ...
            for (int i3 = 0; i3 < 16; i3++) {
                int i4 = this.zzb[i3];
                int i5 = i3 * 4;
                bArr3[i5] = (byte) (i4 & NotificationCenter.didReceiveSmsCode);
                bArr3[i5 + 1] = (byte) ((i4 >> 8) & NotificationCenter.didReceiveSmsCode);
                bArr3[i5 + 2] = (byte) ((i4 >> 16) & NotificationCenter.didReceiveSmsCode);
                bArr3[i5 + 3] = (byte) ((i4 >> 24) & NotificationCenter.didReceiveSmsCode);
            }
