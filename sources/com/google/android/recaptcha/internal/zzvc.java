...
final class zzvc {
    ...
    static {
        ...
        if (zzvbVar3 != null) {
            try {
                Class<?> cls2 = zzvbVar3.zza.getClass();
            ...
            if (zzB() != null) {
                ...
                if (zzvbVar != null) {
                    try {
                        Class<?> cls3 = zzvbVar.zza.getClass();
    ...
    public static void zzD(Object obj, long j, byte b) {
        ...
        int i2 = ((~((int) j)) & 3) << 3;
        unsafe.putInt(obj, j2, ((255 & b) << i2) | (i & (~(NotificationCenter.closeOtherAppActivities << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        unsafe.putInt(obj, j2, ((255 & b) << i) | (unsafe.getInt(obj, j2) & (~(NotificationCenter.closeOtherAppActivities << i))));
    }
