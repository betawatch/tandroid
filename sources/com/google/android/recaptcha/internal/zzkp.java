    ...
    public final Object zzb(Object obj, Object obj2) {
        ...
        if (obj instanceof String) {
            ...
            if (obj2 instanceof Integer) {
                ...
                while (i10 < length2) {
                    i10 = ai.d(charArray[i10] ^ ((Number) obj2).intValue(), i10, 1, arrayList2);
                }
        ...
        if (z10 && (obj2 instanceof short[])) {
            ...
            for (short s6 : sArr) {
                arrayList4.add(Short.valueOf((short) (s6 ^ ((Number) obj).shortValue())));
            }
        ...
        if (z11 && (obj2 instanceof int[])) {
            ...
            int i11 = 0;
            while (i11 < length3) {
                i11 = ai.d(iArr[i11] ^ ((Number) obj).intValue(), i11, 1, arrayList5);
            }
        ...
        if (z12 && (obj2 instanceof long[])) {
            ...
            int i12 = 0;
            while (i12 < length4) {
                i12 = android.support.v4.media.a.g(jArr[i12] ^ ((Number) obj).longValue(), arrayList6, i12, 1);
            }
        ...
        if (z14 && (obj2 instanceof Short)) {
            ...
            for (short s9 : sArr2) {
                arrayList8.add(Short.valueOf((short) (s9 ^ ((Number) obj2).shortValue())));
            }
        ...
        if (z15 && (obj2 instanceof Integer)) {
            ...
            int i13 = 0;
            while (i13 < length5) {
                i13 = ai.d(iArr2[i13] ^ ((Number) obj2).intValue(), i13, 1, arrayList9);
            }
        ...
        if (z16 && (obj2 instanceof Long)) {
            ...
            int i14 = 0;
            while (i14 < length6) {
                i14 = android.support.v4.media.a.g(jArr2[i14] ^ ((Number) obj2).longValue(), arrayList10, i14, 1);
            }
