    ...
    final int zza(byte[] bArr, CharSequence charSequence) {
        ...
        while (i < zze.length()) {
            ...
            if (i4 < zze.length()) {
                ...
                int i6 = i2 + 2;
                bArr[i3] = (byte) ((zzb2 >>> 8) & NotificationCenter.didReplacedPhotoInMemCache);
                if (i5 < zze.length()) {
                    i += 4;
                    i2 += 3;
                    bArr[i6] = (byte) ((zzb2 | this.zzb.zzb(zze.charAt(i5))) & NotificationCenter.didReplacedPhotoInMemCache);
                } else {
                    i2 = i6;
                    i = i5;
                }
