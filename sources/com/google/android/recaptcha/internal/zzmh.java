    ...
    public static String zzb(String str, byte[] bArr, zzmi zzmiVar) {
        ...
        while (i6 > 0) {
            ...
            for (int i12 = 0; i12 < 16; i12++) {
                int i13 = iArr6[i12];
                int i14 = i12 * 4;
                bArr6[i14] = (byte) (i13 & NotificationCenter.suggestedLangpack);
                bArr6[i14 + 1] = (byte) ((i13 >> 8) & NotificationCenter.suggestedLangpack);
                bArr6[i14 + 2] = (byte) ((i13 >> 16) & NotificationCenter.suggestedLangpack);
                bArr6[i14 + 3] = (byte) ((i13 >> 24) & NotificationCenter.suggestedLangpack);
            }
