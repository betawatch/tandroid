...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final Integer zza = Integer.valueOf(Color.argb(NotificationCenter.needCheckSystemBarColors, NotificationCenter.conferenceEmojiUpdated, NotificationCenter.messagesFeeUpdated, NotificationCenter.starUserGiftsLoaded));
    private Boolean zzb;
    private Boolean zzc;
    private int zzd;
