...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final Integer zza = Integer.valueOf(Color.argb(NotificationCenter.proxyCheckDone, NotificationCenter.emojiLoaded, NotificationCenter.wallpapersNeedReload, NotificationCenter.botDownloadsUpdate));
    private Boolean zzb;
    private Boolean zzc;
    private int zzd;
