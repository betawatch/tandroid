...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final Integer zza = Integer.valueOf(Color.argb(NotificationCenter.didReplacedPhotoInMemCache, NotificationCenter.channelConnectedBotsUpdate, NotificationCenter.updateStories, NotificationCenter.botStarsTransactionsLoaded));
    private Boolean zzb;
    private Boolean zzc;
    private int zzd;
