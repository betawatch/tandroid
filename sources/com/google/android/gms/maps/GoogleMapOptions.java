...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final Integer zza = Integer.valueOf(Color.argb(NotificationCenter.reloadInterface, NotificationCenter.wallpapersDidLoad, NotificationCenter.appConfigUpdated, NotificationCenter.starGiftSoldOut));
    private Boolean zzb;
    private Boolean zzc;
    private int zzd;
