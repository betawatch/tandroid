...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final Integer zza = Integer.valueOf(Color.argb(NotificationCenter.didApplyNewTheme, NotificationCenter.commonChatsLoaded, NotificationCenter.channelConnectedBotsUpdate, NotificationCenter.updateAllMessages));
    private Boolean zzb;
    private Boolean zzc;
    private int zzd;
