...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final Integer zza = Integer.valueOf(Color.argb(NotificationCenter.locationPermissionGranted, NotificationCenter.contentSettingsLoaded, NotificationCenter.commonChatsLoaded, NotificationCenter.starUserGiftCollectionsLoaded));
    private Boolean zzb;
    private Boolean zzc;
    private int zzd;
