...
public final class zzb {
    ...
    public final boolean zzd(Uri uri) {
        ...
        if (this.zzb.getWidthInPixels() == 0 || this.zzb.getHeightInPixels() == 0) {
            this.zzd = new zzf(this.zza, 0, 0, false, 2097152L, 5, NotificationCenter.nearEarEvent, 10000, this);
        } else {
            Context context = this.zza;
            ImageHints imageHints = this.zzb;
            this.zzd = new zzf(context, imageHints.getWidthInPixels(), imageHints.getHeightInPixels(), false, 2097152L, 5, NotificationCenter.nearEarEvent, 10000, this);
        }
