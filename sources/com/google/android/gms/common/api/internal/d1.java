...
public final class d1 {
    ...
    public d1(r rVar, p pVar, y5.c[] cVarArr, boolean z4, int i10) {
        this.e = rVar;
        this.c = pVar;
        this.d = cVarArr;
        this.b = z4;
    ...
    public d1(Context context) {
        ...
        if (context != null && (telephonyManager = (TelephonyManager) context.getSystemService("phone")) != null) {
            ...
            if (!TextUtils.isEmpty(networkCountryIso)) {
                ...
                s8.i0 i0Var2 = g5.s.n;
                hashMap.put(2, (Long) i0Var2.get(iArr[0]));
                hashMap.put(3, (Long) g5.s.o.get(iArr[1]));
                hashMap.put(4, (Long) g5.s.p.get(iArr[2]));
                hashMap.put(5, (Long) g5.s.q.get(iArr[3]));
                hashMap.put(10, (Long) g5.s.r.get(iArr[4]));
                hashMap.put(9, (Long) g5.s.s.get(iArr[5]));
                hashMap.put(7, (Long) i0Var2.get(iArr[0]));
                this.d = hashMap;
                this.a = 2000;
                this.e = h5.y.a;
                this.b = true;
        ...
        s8.i0 i0Var22 = g5.s.n;
        hashMap2.put(2, (Long) i0Var22.get(iArr[0]));
        hashMap2.put(3, (Long) g5.s.o.get(iArr[1]));
        hashMap2.put(4, (Long) g5.s.p.get(iArr[2]));
        hashMap2.put(5, (Long) g5.s.q.get(iArr[3]));
        hashMap2.put(10, (Long) g5.s.r.get(iArr[4]));
        hashMap2.put(9, (Long) g5.s.s.get(iArr[5]));
        hashMap2.put(7, (Long) i0Var22.get(iArr[0]));
        this.d = hashMap2;
        this.a = 2000;
        this.e = h5.y.a;
        this.b = true;
