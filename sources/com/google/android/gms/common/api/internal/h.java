...
public final class h implements Handler.Callback {
    ...
    public h(Context context, Looper looper) {
        ...
        this.y = true;
        this.e = context;
        c2.t0 t0Var = new c2.t0(looper, this);
        this.x = t0Var;
        this.f = dVar;
        this.h = new w3.b0((v5.e) dVar);
        PackageManager packageManager = context.getPackageManager();
        if (f6.b.e == null) {
            f6.b.e = Boolean.valueOf(f6.b.d() && packageManager.hasSystemFeature("android.hardware.type.automotive"));
        }
        if (f6.b.e.booleanValue()) {
            this.y = false;
        }
        ...
        synchronized (C) {
            try {
                ...
                if (hVar != null) {
                    ...
                    c2.t0 t0Var = hVar.x;
                    t0Var.sendMessageAtFrontOfQueue(t0Var.obtainMessage(10));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public static Status d(b bVar, v5.a aVar) {
        return new Status(17, i0.a.n("API: ", bVar.b.c, " is not available on this device. Connection failed with: ", String.valueOf(aVar)), aVar.c, aVar);
    }
    ...
    public static h g(Context context) {
        ...
        synchronized (C) {
            try {
                if (D == null) {
                    Looper looper = y5.j0.a().getLooper();
    ...
    public final boolean c(v5.a aVar, int i10) {
        ...
        if (!h6.a.e(context)) {
            ...
            if (pendingIntent != null) {
                ...
                dVar.h(context, i11, PendingIntent.getActivity(context, 0, intent, v6.d.a | TLObject.FLAG_27));
                return true;
            }
        }
        return false;
    ...
    */
    public final void f(TaskCompletionSource taskCompletionSource, int i10, com.google.android.gms.common.api.j jVar) {
        ...
        if (b()) {
            ...
            if (y0Var == null) {
                ...
                c2.t0 t0Var = hVar.x;
                t0Var.getClass();
                task.addOnCompleteListener(new androidx.biometric.n(t0Var, 2), y0Var);
                return;
            }
            return;
        }
    ...
    public final void h(v5.a aVar, int i10) {
        if (c(aVar, i10)) {
            return;
        }
        c2.t0 t0Var = this.x;
    ...
    */
    public final boolean handleMessage(Message message) {
        ...
        com.google.android.gms.common.api.e eVar = a6.c.k;
        y5.p pVar = y5.p.b;
        Context context = this.e;
        c2.t0 t0Var = this.x;
        ConcurrentHashMap concurrentHashMap = this.s;
        switch (i10) {
            case 1:
                ...
                while (it.hasNext()) {
                    t0Var.sendMessageDelayed(t0Var.obtainMessage(12, (b) it.next()), this.a);
                }
                return true;
            case 2:
                throw a9.p.i(message.obj);
            case 3:
            ...
            case 13:
                ...
                if (!p0Var3.b.o() || this.r.get() == a1Var.b) {
                    p0Var3.l(k1Var);
                    return true;
                }
                k1Var.a(A);
            ...
            case 5:
                ...
                if (p0Var == null) {
                    Log.wtf("GoogleApiManager", i0.a.l(i11, "Could not find API instance ", " while trying to fail enqueued calls."), new Exception());
                    return true;
                }
                int i12 = aVar.b;
                if (i12 != 13) {
                ...
                p0Var.c(new Status(17, i0.a.n("Error resolution was canceled by the user, original error message: ", v5.a.d(i12), ": ", aVar.d), null, null));
                return true;
            case 6:
            ...
            case 11:
                if (concurrentHashMap.containsKey(message.obj)) {
                    ...
                    if (z11) {
                        b bVar2 = p0Var6.c;
                        c2.t0 t0Var2 = p0Var6.o.x;
                        if (z11) {
                            t0Var2.removeMessages(11, bVar2);
                            t0Var2.removeMessages(9, bVar2);
                            p0Var6.k = false;
                        }
                        p0Var6.c(hVar.f.d(hVar.e, v5.e.a) == 18 ? new Status(21, "Connection timed out waiting for Google Play services update to complete.", null, null) : new Status(22, "API failed to connect while resuming due to an unknown error.", null, null));
            ...
            case 16:
                ...
                if (concurrentHashMap.containsKey(q0Var2.a)) {
                    ...
                    c2.t0 t0Var3 = p0Var9.o.x;
                    LinkedList<k1> linkedList = p0Var9.a;
                    if (arrayList.remove(q0Var2)) {
                        t0Var3.removeMessages(15, q0Var2);
                        t0Var3.removeMessages(16, q0Var2);
                        v5.c cVar2 = q0Var2.b;
            ...
            case 17:
                ...
                if (oVar != null) {
                    if (oVar.a > 0 || b()) {
                        if (this.d == null) {
                            this.d = new a6.c(context, eVar, pVar, com.google.android.gms.common.api.i.c);
                        }
                        this.d.f(oVar);
                    }
                    this.c = null;
            ...
            case 18:
                ...
                int i15 = z0Var.b;
                if (j10 == 0) {
                    y5.o oVar2 = new y5.o(i15, Arrays.asList(jVar2));
                    if (this.d == null) {
                        this.d = new a6.c(context, eVar, pVar, com.google.android.gms.common.api.i.c);
                    }
                    this.d.f(oVar2);
                ...
                if (this.c == null) {
                    ...
                    this.c = new y5.o(i15, arrayList3);
                    t0Var.sendMessageDelayed(t0Var.obtainMessage(17), z0Var.c);
                    return true;
                }
                return true;
            case 19:
