            ...
            default:
                ...
                while (parcel.dataPosition() < z14) {
                    ...
                    if (c12 == 1) {
                        ...
                        str2 = e0.h(parcel, readInt4);
                    } else if (c12 == 3) {
                        pendingIntent = (PendingIntent) e0.g(parcel, readInt4, PendingIntent.CREATOR);
                    } else if (c12 != 4) {
                        e0.y(parcel, readInt4);
                    } else {
                        aVar = (k6.a) e0.g(parcel, readInt4, k6.a.CREATOR);
                    }
                }
                e0.m(parcel, z14);
