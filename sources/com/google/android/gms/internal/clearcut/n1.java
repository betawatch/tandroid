...
public final class n1 {
    ...
    public static int c(int i10, byte[] bArr, int i11, int i12, c1 c1Var, m mVar) {
        ...
        if (i13 == 2) {
            ...
            int i14 = mVar.a;
            c1Var.a(i10, i14 == 0 ? o.c : o.n(f10, i14, bArr));
            return f10 + i14;
        }
        if (i13 != 3) {
            if (i13 != 5) {
    ...
    public static int e(long j10, byte[] bArr, int i10, int i11) {
        ...
        byte a10 = k1.a(j10, bArr);
        byte a11 = k1.a(j10 + 1, bArr);
        n1 n1Var3 = m1.a;
    ...
    */
    public static void i(z zVar, StringBuilder sb, int i10) {
        boolean equals;
        ...
        while (it.hasNext()) {
            ...
            if (replaceFirst.endsWith("List") && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    k(sb, i10, u(concat), z.b(method2, zVar, new Object[0]));
                }
            }
            if (replaceFirst.endsWith(TeXFormulaSettingsParser.CHARTODEL_MAPPING_EL) && !replaceFirst.equals(TeXFormulaSettingsParser.CHARTODEL_MAPPING_EL)) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    k(sb, i10, u(concat2), z.b(method3, zVar, new Object[0]));
                }
            }
            if (((Method) hashMap2.get(replaceFirst.length() != 0 ? "set".concat(replaceFirst) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    ...
                    if (method5 == null) {
                        ...
                        z4 = ((Boolean) z.b(method5, zVar, new Object[0])).booleanValue();
                    }
                    if (z4) {
                        k(sb, i10, u(concat3), b10);
                    }
                }
            }
        }
        ...
        if (c1Var != null) {
            for (int i11 = 0; i11 < c1Var.a; i11++) {
                k(sb, i10, String.valueOf(c1Var.b[i11] >>> 3), c1Var.c[i11]);
            }
        }
    }
    ...
    public static final void k(StringBuilder sb, int i10, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"");
            o oVar = o.c;
            sb.append(p(new o(((String) obj).getBytes(a0.a))));
            sb.append('\"');
            return;
        }
        if (obj instanceof o) {
    ...
    public static String p(o oVar) {
        String str;
        StringBuilder sb = new StringBuilder(oVar.size());
