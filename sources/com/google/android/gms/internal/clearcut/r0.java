...
public final class r0 implements a1 {
    ...
    */
    public final void f(Object obj, byte[] bArr, int i10, int i11, m mVar) {
        ...
        c1 c1Var2 = c1Var;
        while (i10 < i11) {
            int f7 = n1.f(bArr, i10, mVar);
            int i13 = mVar.a;
            if (i13 != 11) {
                byte[] bArr2 = bArr;
                int i14 = i11;
                m mVar2 = mVar;
                i10 = (i13 & 7) == 2 ? n1.c(i13, bArr2, f7, i14, c1Var2, mVar2) : n1.b(i13, bArr2, f7, i14, mVar2);
            } else {
                byte[] bArr3 = bArr;
                int i15 = i11;
                m mVar3 = mVar;
                ...
                while (true) {
                    ...
                    i12 = n1.f(bArr3, f7, mVar3);
                    int i17 = mVar3.a;
                    int i18 = i17 >>> 3;
                    int i19 = i17 & 7;
                    if (i18 != 2) {
                        if (i18 == 3 && i19 == 2) {
                            f7 = n1.s(bArr3, i12, mVar3);
                            oVar = (o) mVar3.c;
                        }
                        if (i17 != 12) {
                            break;
                        } else {
                            f7 = n1.b(i17, bArr3, i12, i15, mVar3);
                        }
                    } else if (i19 == 0) {
                        f7 = n1.f(bArr3, i12, mVar3);
                        i16 = mVar3.a;
                    } else if (i17 != 12) {
                    }
                }
