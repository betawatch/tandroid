    ...
    public final void f(Object obj, byte[] bArr, int i10, int i11, m mVar) {
        ...
        while (i10 < i11) {
            ...
            if (i13 != 11) {
                ...
                int i14 = i11;
                m mVar2 = mVar;
                i10 = (i13 & 7) == 2 ? o1.c(i13, bArr2, f9, i14, d1Var2, mVar2) : o1.b(i13, bArr2, f9, i14, mVar2);
            } else {
                byte[] bArr3 = bArr;
                int i15 = i11;
                m mVar3 = mVar;
                ...
                while (true) {
                    ...
                    i12 = o1.f(bArr3, f9, mVar3);
                    int i17 = mVar3.a;
                    int i18 = i17 >>> 3;
                    int i19 = i17 & 7;
                    if (i18 != 2) {
                        if (i18 == 3 && i19 == 2) {
                            f9 = o1.s(bArr3, i12, mVar3);
                            oVar = (o) mVar3.c;
                        }
                        if (i17 != 12) {
                            break;
                        } else {
                            f9 = o1.b(i17, bArr3, i12, i15, mVar3);
                        }
                    } else if (i19 == 0) {
                        f9 = o1.f(bArr3, i12, mVar3);
                        i16 = mVar3.a;
                    } else if (i17 != 12) {
                    }
                }
