...
public final class m1 {
    ...
    public static int b(int i10, byte[] bArr, int i11, int i12, l lVar) {
        if ((i10 >>> 3) == 0) {
            throw new c0("Protocol message contained an invalid tag (zero).");
        }
        int i13 = i10 & 7;
        if (i13 == 0) {
            return m(bArr, i11, lVar);
        }
        if (i13 == 1) {
            return i11 + 8;
        }
        if (i13 == 2) {
            return f(bArr, i11, lVar) + lVar.a;
        }
        if (i13 != 3) {
            if (i13 == 5) {
                return i11 + 4;
    ...
    public static int c(int i10, byte[] bArr, int i11, int i12, b1 b1Var, l lVar) {
        if ((i10 >>> 3) == 0) {
            throw new c0("Protocol message contained an invalid tag (zero).");
        }
        int i13 = i10 & 7;
        if (i13 == 0) {
            int m10 = m(bArr, i11, lVar);
            b1Var.a(i10, Long.valueOf(lVar.b));
            return m10;
        }
        if (i13 == 1) {
            b1Var.a(i10, Long.valueOf(r(i11, bArr)));
            return i11 + 8;
        }
        if (i13 == 2) {
            int f7 = f(bArr, i11, lVar);
            int i14 = lVar.a;
            b1Var.a(i10, i14 == 0 ? n.c : n.n(f7, i14, bArr));
            return f7 + i14;
        }
        if (i13 != 3) {
            if (i13 != 5) {
            ...
            b1Var.a(i10, Integer.valueOf(o(i11, bArr)));
            return i11 + 4;
        }
        b1 b10 = b1.b();
        int i15 = (i10 & (-8)) | 4;
        ...
        while (true) {
            ...
            i11 = c(i17, bArr, f10, i12, b10, lVar);
            i16 = i17;
        }
        if (i11 > i12 || i16 != i15) {
            throw c0.b();
    ...
    public static int d(int i10, byte[] bArr, int i11, l lVar) {
        int i12;
        int i13 = i10 & 127;
        int i14 = i11 + 1;
        byte b10 = bArr[i11];
    ...
    public static int e(long j3, byte[] bArr, int i10, int i11) {
        ...
        byte a10 = j1.a(j3, bArr);
        byte a11 = j1.a(j3 + 1, bArr);
        m1 m1Var3 = l1.a;
    ...
    public static int f(byte[] bArr, int i10, l lVar) {
        int i11 = i10 + 1;
        byte b10 = bArr[i10];
        if (b10 < 0) {
    ...
    */
    public static void i(y yVar, StringBuilder sb2, int i10) {
        boolean equals;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet treeSet = new TreeSet();
        for (Method method : yVar.getClass().getDeclaredMethods()) {
        ...
        while (it.hasNext()) {
            ...
            if (replaceFirst.endsWith("List") && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    k(sb2, i10, u(concat), y.b(method2, yVar, new Object[0]));
                }
            }
            if (replaceFirst.endsWith(TeXFormulaSettingsParser.CHARTODEL_MAPPING_EL) && !replaceFirst.equals(TeXFormulaSettingsParser.CHARTODEL_MAPPING_EL)) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    k(sb2, i10, u(concat2), y.b(method3, yVar, new Object[0]));
                }
            }
            if (((Method) hashMap2.get(replaceFirst.length() != 0 ? "set".concat(replaceFirst) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object b10 = y.b(method4, yVar, new Object[0]);
                    if (method5 == null) {
                                    ...
                                    if (!(b10 instanceof Double)) {
                                        if (!(b10 instanceof String)) {
                                            if (b10 instanceof n) {
                                                ...
                                                equals = !(b10 instanceof i) ? false : false;
                                            }
                                        }
                        ...
                        z10 = ((Boolean) y.b(method5, yVar, new Object[0])).booleanValue();
                    }
                    if (z10) {
        ...
        if (b1Var != null) {
            for (int i11 = 0; i11 < b1Var.a; i11++) {
                k(sb2, i10, String.valueOf(b1Var.b[i11] >>> 3), b1Var.c[i11]);
            }
        }
    }
    ...
    public static final void k(StringBuilder sb2, int i10, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb2.append(": \"");
            n nVar = n.c;
            sb2.append(p(new n(((String) obj).getBytes(z.a))));
            sb2.append('\"');
            return;
        }
        if (obj instanceof n) {
    ...
    public static int m(byte[] bArr, int i10, l lVar) {
        int i11 = i10 + 1;
        long j3 = bArr[i10];
        if (j3 >= 0) {
            lVar.b = j3;
    ...
    public static String p(n nVar) {
        String str;
        StringBuilder sb2 = new StringBuilder(nVar.size());
    ...
    public static int q(byte[] bArr, int i10, l lVar) {
        int f7 = f(bArr, i10, lVar);
        int i11 = lVar.a;
        if (i11 == 0) {
            lVar.c = "";
            return f7;
        ...
        int i12 = f7 + i11;
        if (!l1.a.t(bArr, f7, i12)) {
            throw new c0("Protocol message had invalid UTF-8.");
        }
        lVar.c = new String(bArr, f7, i11, z.a);
        return i12;
    }
    ...
    public static int s(byte[] bArr, int i10, l lVar) {
        int f7 = f(bArr, i10, lVar);
        int i11 = lVar.a;
        if (i11 == 0) {
            lVar.c = n.c;
