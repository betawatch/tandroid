...
public final class zzfs {
    ...
    private final void zzap(int i) {
        while ((i & (-128)) != 0) {
            zzao((i & NotificationCenter.needDeleteBusinessLink) | 128);
            i >>>= 7;
        }
        zzao(i);
    }
                        ...
                        if (charAt2 >= 55296 && 57343 >= charAt2) {
                            ...
                            if (i3 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(charAt2, charAt3)) {
                                    ...
                                    byteBuffer.put((byte) ((codePoint >>> 18) | NotificationCenter.commonChatsLoaded));
                        ...
                        if ((charAt4 >= 55296 && c >= charAt4) || i > i4 - 3) {
                            ...
                            if (i7 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(charAt4, charAt5)) {
                                    ...
                                    array[i] = (byte) ((codePoint2 >>> 18) | NotificationCenter.commonChatsLoaded);
    ...
    public final void zzn(long j) {
        while (((-128) & j) != 0) {
            zzao((((int) j) & NotificationCenter.needDeleteBusinessLink) | 128);
            j >>>= 7;
        }
        zzao((int) j);
    }
