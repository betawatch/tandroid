...
public final class l1 extends c6 {
    ...
    public l1(byte[] bArr, int i10) {
        ...
        if (((length - i10) | i10) < 0) {
            ...
            throw new IllegalArgumentException(a9.p.j(length, i10, "Array range is invalid. Buffer.length=", ", offset=0, length="));
        }
        this.b = bArr;
        this.d = 0;
        this.c = i10;
    ...
    public final void d(int i10, byte[] bArr) {
        try {
            ...
            throw new x4(this.d, this.c, i10, e9);
        }
    }
