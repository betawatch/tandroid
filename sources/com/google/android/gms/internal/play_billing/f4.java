...
public class f4 implements t0 {
    ...
    public static void c(f4 f4Var) {
        ...
        do {
            e4Var = f4Var.c;
            a6Var = f;
        } while (!a6Var.e(f4Var, e4Var, e4.c));
        while (true) {
            u2Var = null;
            if (e4Var == null) {
                break;
        ...
        do {
            u2Var2 = f4Var.b;
        } while (!a6Var.c(f4Var, u2Var2, u2.d));
        while (true) {
            u2Var3 = u2Var;
            u2Var = u2Var2;
            if (u2Var == null) {
    ...
    public static void e(Runnable runnable, Executor executor) {
        try {
            ...
            e.logp(Level.SEVERE, "com.android.billingclient.util.concurrent.AbstractResolvableFuture", "executeListener", i0.a.n("RuntimeException while executing runnable ", String.valueOf(runnable), " with executor ", String.valueOf(executor)), (Throwable) e9);
        }
    }

    public static final Object g(Object obj) {
        if (obj instanceof i1) {
            Throwable th = ((i1) obj).a;
    ...
    public final Object get() {
        ...
        if (e4Var != e4Var2) {
            ...
            do {
                a6 a6Var = f;
                a6Var.a(e4Var3, e4Var);
                if (a6Var.e(this, e4Var, e4Var3)) {
                    do {
    ...
    public final Object get(long j10, TimeUnit timeUnit) {
        ...
        if (!Thread.interrupted()) {
            ...
            throw new TimeoutException(a9.p.w(str, " for ", f4Var));
        }
        throw new InterruptedException();
    }
}
