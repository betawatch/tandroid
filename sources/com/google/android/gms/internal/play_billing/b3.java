    ...
    static {
        ...
        if (a3Var2 != null) {
            try {
                ...
                c10 = 0;
                Logger.getLogger(b3.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                z11 = false;
            }
        }
        c10 = 0;
