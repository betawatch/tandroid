...
final class zzgo extends zzgr {
    ...
    public final void zzt(int i) {
        while ((i & (-128)) != 0) {
            try {
                ...
                int i2 = this.zzd;
                this.zzd = i2 + 1;
                bArr[i2] = (byte) ((i | 128) & NotificationCenter.goingToPreviewTheme);
                i >>>= 7;
            } catch (IndexOutOfBoundsException e) {
    ...
    public final void zzv(long j) {
        ...
        if (!z || this.zzc - this.zzd < 10) {
            while ((j & (-128)) != 0) {
                try {
                    ...
                    int i = this.zzd;
                    this.zzd = i + 1;
                    bArr[i] = (byte) ((((int) j) | 128) & NotificationCenter.goingToPreviewTheme);
                    j >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new zzgp(this.zzd, this.zzc, 1, e);
                }
        ...
        while (true) {
            ...
            int i5 = this.zzd;
            this.zzd = i5 + 1;
            zzjq.zzn(bArr4, i5, (byte) ((i3 | 128) & NotificationCenter.goingToPreviewTheme));
            j >>>= 7;
        }
    }
}
