...
final class zzvg extends zzsi implements RandomAccess {
    private static final zzvg zza = new zzvg(new Object[0], 0, false);
    private Object[] zzb;
    private int zzc;

    private zzvg(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzb = objArr;
        this.zzc = i;
    }
    ...
    public final /* bridge */ /* synthetic */ zztx zzg(int i) {
        if (i >= this.zzc) {
            return new zzvg(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
