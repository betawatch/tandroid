...
public abstract class h0 extends e0 implements List, RandomAccess, j$.util.List {
    ...
    public static m0 r(int i9, Object[] objArr) {
        return i9 == 0 ? m0.e : new m0(i9, objArr);
    }
    ...
    @Override // java.util.List
    /* renamed from: q */
    public h0 subList(int i9, int i10) {
        f7.l5.c(i9, i10, size());
        int i11 = i10 - i9;
        return i11 == size() ? this : i11 == 0 ? m0.e : new g0(this, i9, i11);
    }
    ...
    public final f0 listIterator(int i9) {
        f7.l5.b(i9, size());
        return isEmpty() ? b : new f0(this, i9);
    }
