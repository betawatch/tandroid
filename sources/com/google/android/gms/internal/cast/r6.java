...
public abstract class r6 {
    ...
    static {
        ...
        if (q6Var2 != null) {
            try {
                ...
                c3 = 0;
                Logger.getLogger(r6.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                z10 = false;
            }
        }
        c3 = 0;
        ...
        if (q6Var3 != null) {
            try {
                ...
                Logger.getLogger(r6.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th3.toString()));
            }
            e = z4;
            f = p(byte[].class);
            p(boolean[].class);
            ...
            a(Object[].class);
            b10 = b();
            if (b10 != null && (q6Var = c) != null) {
                q6Var.a.objectFieldOffset(b10);
            }
    ...
    public static void c(Object obj, long j10, byte b10) {
        q6 q6Var = c;
        long j11 = (-4) & j10;
        int i10 = q6Var.a.getInt(obj, j11);
        int i11 = ((~((int) j10)) & 3) << 3;
        q6Var.a.putInt(obj, j11, ((255 & b10) << i11) | (i10 & (~(255 << i11))));
    }
    ...
    public static void d(Object obj, long j10, byte b10) {
        ...
        long j11 = (-4) & j10;
        int i10 = (((int) j10) & 3) << 3;
        q6Var.a.putInt(obj, j11, ((255 & b10) << i10) | (q6Var.a.getInt(obj, j11) & (~(255 << i10))));
    }
