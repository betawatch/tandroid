...
abstract class zzwj {
    ...
    static {
        ...
        if (zzg2 != null) {
            if (zzv) {
                zzwiVar3 = new zzwh(zzg2);
            } else if (zzv2) {
                zzwiVar3 = new zzwg(zzg2);
            }
        }
        zzf = zzwiVar3;
        if (zzwiVar3 != null) {
            ...
            if (zzB() != null) {
                ...
                if (zzwiVar != null) {
                    ...
                    zzA(Object[].class);
                    zzB = zzB();
                    if (zzB != null && (zzwiVar2 = zzf) != null) {
                        zzwiVar2.zza.objectFieldOffset(zzB);
                    }
    ...
    public static void zzD(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = ((((int) j) ^ (-1)) & 3) << 3;
        zzwiVar.zza.putInt(obj, j2, ((255 & b) << i) | (zzwiVar.zza.getInt(obj, j2) & ((NotificationCenter.didSetNewWallpapper << i) ^ (-1))));
    }
    ...
    static /* bridge */ /* synthetic */ boolean zzt(Object obj, long j) {
        return ((byte) ((zzf.zza.getInt(obj, (-4) & j) >>> ((int) (((j ^ (-1)) & 3) << 3))) & NotificationCenter.didSetNewWallpapper)) != 0;
    }

    static /* bridge */ /* synthetic */ boolean zzu(Object obj, long j) {
        return ((byte) ((zzf.zza.getInt(obj, (-4) & j) >>> ((int) ((j & 3) << 3))) & NotificationCenter.didSetNewWallpapper)) != 0;
    }
