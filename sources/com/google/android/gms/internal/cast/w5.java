...
public abstract class w5 {
    ...
    public static void a(StringBuilder sb2, int i10, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb2.append(": \"");
            sb2.append(g7.t5.a(new v4(((String) obj).getBytes(j5.a))));
            sb2.append('\"');
            return;
        }
        if (obj instanceof v4) {
            sb2.append(": \"");
            sb2.append(g7.t5.a((v4) obj));
            sb2.append('\"');
            return;
        }
    ...
    public static void c(d5 d5Var, StringBuilder sb2, int i10) {
        int i11;
        boolean equals;
        Method method;
        Method method2;
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List") && (method2 = (Method) entry.getValue()) != null && method2.getReturnType().equals(List.class)) {
                a(sb2, i10, substring.substring(0, substring.length() - 4), d5.c(method2, d5Var, new Object[0]));
                ...
                a(sb2, i10, substring.substring(0, substring.length() - 3), d5.c(method, d5Var, new Object[0]));
            } else if (hashSet.contains("set".concat(substring)) && (!substring.endsWith("Bytes") || !treeMap.containsKey("get".concat(String.valueOf(substring.substring(0, substring.length() - 5)))))) {
                Method method4 = (Method) entry.getValue();
                Method method5 = (Method) hashMap.get("has".concat(substring));
                if (method4 != null) {
                    Object c10 = d5.c(method4, d5Var, new Object[0]);
                    if (method5 != null) {
                        ...
                        if (c10 instanceof String) {
                            ...
                            equals = c10.equals(v4.c);
                        } else if (c10 instanceof r4) {
                            if (c10 == ((d5) ((d5) ((r4) c10)).h(6, null))) {
                            }
                            a(sb2, i10, substring, c10);
                        } else {
