...
public abstract class w5 {
    ...
    public static void a(StringBuilder sb, int i10, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"");
            sb.append(j7.c6.a(new w4(((String) obj).getBytes(j5.a))));
            sb.append('\"');
            return;
        }
        if (obj instanceof w4) {
            sb.append(": \"");
            sb.append(j7.c6.a((w4) obj));
            sb.append('\"');
            return;
        }
    ...
    public static void c(d5 d5Var, StringBuilder sb, int i10) {
        int i11;
        boolean equals;
        Method method;
        Method method2;
        ...
        Method[] declaredMethods = d5Var.getClass().getDeclaredMethods();
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List") && (method2 = (Method) entry.getValue()) != null && method2.getReturnType().equals(List.class)) {
                a(sb, i10, substring.substring(0, substring.length() - 4), d5.c(method2, d5Var, new Object[0]));
                ...
                a(sb, i10, substring.substring(0, substring.length() - 3), d5.c(method, d5Var, new Object[0]));
            } else if (hashSet.contains("set".concat(substring)) && (!substring.endsWith("Bytes") || !treeMap.containsKey("get".concat(String.valueOf(substring.substring(0, substring.length() - 5)))))) {
                Method method4 = (Method) entry.getValue();
                Method method5 = (Method) hashMap.get("has".concat(substring));
                if (method4 != null) {
                    Object c3 = d5.c(method4, d5Var, new Object[0]);
                    if (method5 != null) {
                        if (!((Boolean) d5.c(method5, d5Var, new Object[0])).booleanValue()) {
                        }
                        ...
                        if (c3 instanceof String) {
                            equals = c3.equals("");
                        } else if (c3 instanceof w4) {
                            equals = c3.equals(w4.c);
                        } else if (c3 instanceof s4) {
                            if (c3 == ((d5) ((d5) ((s4) c3)).h(6, null))) {
                            }
                            a(sb, i10, substring, c3);
                        } else {
