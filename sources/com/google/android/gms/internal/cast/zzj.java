...
public final class zzj extends SessionTransferCallback {
    ...
    public final void onTransferFailed(int i, int i2) {
        ...
        zzgVar = this.zza.zzb;
        zzgVar.zze(zzf, NotificationCenter.channelSuggestedBotsUpdate);
        this.zza.zzj = false;
    }
    ...
    public final void onTransferred(int i, SessionState sessionState) {
        ...
        zzgVar = this.zza.zzb;
        zzgVar.zze(zzg, NotificationCenter.botDownloadsUpdate);
        this.zza.zzj = false;
        this.zza.zzh = null;
    }
    ...
    public final void onTransferring(int i) {
        ...
        zzno zzg = zzmVar.zzg(zzlVar, i);
        zzgVar = this.zza.zzb;
        zzgVar.zze(zzg, NotificationCenter.updateStories);
    }
}
