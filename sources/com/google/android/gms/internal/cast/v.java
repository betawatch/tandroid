                ...
                if (j11 == 0 || currentTimeMillis - j11 >= j10) {
                    ...
                    if (!hashSet2.equals(hashSet)) {
                        ...
                        while (it.hasNext()) {
                            ...
                            String e = vh.w2.e("feature_usage_timestamp_reported_feature_", num);
                            if (!sharedPreferences.contains(e)) {
                                e = vh.w2.e("feature_usage_timestamp_detected_feature_", num);
                            }
                            String e6 = vh.w2.e("feature_usage_timestamp_reported_feature_", num);
