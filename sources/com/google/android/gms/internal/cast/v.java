                ...
                if (j11 == 0 || currentTimeMillis - j11 >= j10) {
                    ...
                    if (!hashSet2.equals(hashSet)) {
                        ...
                        while (it.hasNext()) {
                            ...
                            String e10 = s3.c.e("feature_usage_timestamp_reported_feature_", num);
                            if (!TextUtils.equals(e9, e10)) {
                                long j12 = sharedPreferences.getLong(e9, 0L);
                                edit.remove(e9);
                                if (j12 != 0) {
                                    edit.putLong(e10, j12);
                                }
                            }
                        }
                    }
