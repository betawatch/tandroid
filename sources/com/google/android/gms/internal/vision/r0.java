...
public final class r0 extends e1 {
    ...
    public final void B(byte b10) {
        try {
            ...
            throw new s0(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.e), Integer.valueOf(this.d), 1), e9);
        }
    }
    ...
    public final void L(byte[] bArr, int i10, int i11) {
        try {
            ...
            throw new s0(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.e), Integer.valueOf(this.d), Integer.valueOf(i11)), e9);
        }
    }
