        ...
        if (!(list instanceof t1)) {
            for (int i11 = 0; i11 < list.size(); i11++) {
                ...
                try {
                    ...
                    r0Var.e = i12;
                    r0.f.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) e9);
