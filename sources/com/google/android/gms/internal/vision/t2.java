...
public final class t2 extends c2.s {
    ...
    */
    public final Object i(j6.e eVar, Context context) {
        e3 e3Var;
        IInterface eVar2;
        int i10 = this.r;
        z5.a aVar = this.s;
        ...
        switch (i10) {
            case 0:
                ...
                break;
            default:
                if (j6.e.a(context, "com.google.android.gms.vision.dynamite.face") > j6.e.d(context, "com.google.android.gms.vision.dynamite", false)) {
                    ...
                    if (b11 != null) {
                        ...
                        eVar2 = queryLocalInterface3 instanceof f8.c ? (f8.c) queryLocalInterface3 : new f8.e(b11, "com.google.android.gms.vision.face.internal.client.INativeFaceDetectorCreator", 3);
                        if (eVar2 != null) {
                            i6.b bVar2 = new i6.b(context);
                            f8.b bVar3 = (f8.b) aVar;
                            y5.l.h(bVar3);
                            f8.e eVar3 = (f8.e) eVar2;
                            Parcel E02 = eVar3.E0();
                            int i13 = a.a;
                            ...
                            if (readStrongBinder2 != null) {
                                ...
                                obj = queryLocalInterface4 instanceof f8.d ? (f8.d) queryLocalInterface4 : new f8.d(readStrongBinder2, "com.google.android.gms.vision.face.internal.client.INativeFaceDetector", 3);
                            }
                            N02.recycle();
                            break;
                        }
                    ...
                    if (b12 != null) {
                        ...
                        eVar2 = queryLocalInterface5 instanceof f8.c ? (f8.c) queryLocalInterface5 : new f8.e(b12, "com.google.android.gms.vision.face.internal.client.INativeFaceDetectorCreator", 3);
                        if (eVar2 != null) {
                        }
                    }
                    eVar2 = null;
    ...
    public e8.a[] n(ByteBuffer byteBuffer, f3 f3Var) {
        e8.d[] dVarArr;
        za.b[] bVarArr;
        if (!k()) {
            return new e8.a[0];
        ...
        try {
            ...
            N0.recycle();
            e8.a[] aVarArr = new e8.a[faceParcelArr.length];
            for (int i11 = 0; i11 < faceParcelArr.length; i11++) {
                ...
                if (landmarkParcelArr == null) {
                    ...
                    e8.d[] dVarArr2 = new e8.d[landmarkParcelArr.length];
                    for (int i13 = 0; i13 < landmarkParcelArr.length; i13++) {
                        LandmarkParcel landmarkParcel = landmarkParcelArr[i13];
                        dVarArr2[i13] = new e8.d(new PointF(landmarkParcel.b, landmarkParcel.c), landmarkParcel.d);
                    }
                    dVarArr = dVarArr2;
                }
                f8.a[] aVarArr2 = faceParcel.y;
                if (aVarArr2 == null) {
                    bVarArr = new za.b[0];
                } else {
                    za.b[] bVarArr2 = new za.b[aVarArr2.length];
                    for (int i14 = 0; i14 < aVarArr2.length; i14++) {
                        PointF[] pointFArr = aVarArr2[i14].a;
                        bVarArr2[i14] = new za.b(5);
                    }
                    bVarArr = bVarArr2;
                }
                aVarArr[i11] = new e8.a(i12, dVarArr, bVarArr);
            }
            return aVarArr;
    ...
    public t2(Context context, f8.b bVar) {
