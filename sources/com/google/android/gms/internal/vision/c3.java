...
public final class c3 extends e1 {
    ...
    public static int B(long j10, byte[] bArr, int i10, int i11) {
        ...
        byte a10 = x2.a(j10, bArr);
        byte a11 = x2.a(j10 + 1, bArr);
        e1 e1Var3 = a3.a;
    ...
    public final String v(int i10, int i11, byte[] bArr) {
        switch (this.b) {
            ...
            default:
                ...
                int i22 = 0;
                while (i21 < i20) {
                    byte a2 = x2.a(i21, bArr);
                    if (a2 < 0) {
                        int i23 = i22;
                        while (i21 < i20) {
                            int i24 = i21 + 1;
                            byte a10 = x2.a(i21, bArr);
                            if (a10 >= 0) {
                                int i25 = i23 + 1;
                                cArr2[i23] = (char) a10;
                                while (i24 < i20) {
                                    byte a11 = x2.a(i24, bArr);
                                    if (a11 >= 0) {
                                        i24++;
                                        cArr2[i25] = (char) a11;
                                        i25++;
                                ...
                                i21 += 2;
                                e1.o(a10, x2.a(i24, bArr), cArr2, i23);
                                i23++;
                            } else if (a10 < -16) {
                                if (i24 >= i20 - 1) {
                                    throw n1.c();
                                ...
                                int i26 = i21 + 2;
                                i21 += 3;
                                e1.n(a10, x2.a(i24, bArr), x2.a(i26, bArr), cArr2, i23);
                                i23++;
                            } else {
                                if (i24 >= i20 - 2) {
                                    throw n1.c();
                                }
                                byte a12 = x2.a(i24, bArr);
                                int i27 = i21 + 3;
                                byte a13 = x2.a(i21 + 2, bArr);
                                i21 += 4;
                                e1.m(a10, a12, a13, x2.a(i27, bArr), cArr2, i23);
                                i23 += 2;
                            }
                        }
