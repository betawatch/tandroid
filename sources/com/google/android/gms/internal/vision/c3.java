            ...
            default:
                ...
                while (i21 < i20) {
                    ...
                    if (a2 < 0) {
                        ...
                        while (i21 < i20) {
                            int i24 = i21 + 1;
                            byte a3 = x2.a(i21, bArr);
                            if (a3 >= 0) {
                                int i25 = i23 + 1;
                                cArr2[i23] = (char) a3;
                                while (i24 < i20) {
                                    byte a10 = x2.a(i24, bArr);
                                    if (a10 >= 0) {
                                        i24++;
                                        cArr2[i25] = (char) a10;
                                        i25++;
                                ...
                                i21 += 2;
                                e1.o(a3, x2.a(i24, bArr), cArr2, i23);
                                i23++;
                            } else if (a3 < -16) {
                                if (i24 >= i20 - 1) {
                                    throw n1.c();
                                ...
                                int i26 = i21 + 2;
                                i21 += 3;
                                e1.n(a3, x2.a(i24, bArr), x2.a(i26, bArr), cArr2, i23);
                                i23++;
                            } else {
                                if (i24 >= i20 - 2) {
                                    throw n1.c();
                                ...
                                int i27 = i21 + 3;
                                byte a12 = x2.a(i21 + 2, bArr);
                                i21 += 4;
                                e1.m(a3, a11, a12, x2.a(i27, bArr), cArr2, i23);
                                i23 += 2;
                            }
                        }
