...
public abstract class p2 {
    ...
    public static int a(int i10, Object obj, o2 o2Var) {
        l0 l0Var = (l0) obj;
        int T = r0.T(i10 << 3);
        int c10 = l0Var.c();
        if (c10 == -1) {
    ...
    public static q2 d(boolean z10) {
        Class<?> cls;
        try {
        ...
        if (cls != null) {
            try {
                return (q2) cls.getConstructor(Boolean.TYPE).newInstance(Boolean.valueOf(z10));
            ...
            for (int i11 = 0; i11 < list.size(); i11++) {
                ...
                try {
                    ...
                    if (T2 == T) {
                        int i13 = i12 + T2;
                        r0Var.e = i13;
                        int h = b3.a.h(str, bArr, i13, r0Var.F());
                        r0Var.e = i12;
                        r0Var.H((h - i12) - T2);
                        r0Var.e = h;
                    } else {
            ...
            if (a2 instanceof String) {
                ...
                try {
                    ...
                    if (T4 == T3) {
                        int i16 = i15 + T4;
                        r0Var.e = i16;
                        int h10 = b3.a.h(str2, bArr2, i16, r0Var.F());
                        r0Var.e = i15;
                        r0Var.H((h10 - i15) - T4);
                        r0Var.e = h10;
                    } else {
    ...
    public static void f(int i10, List list, y1 y1Var, o2 o2Var) {
        if (list == null || list.isEmpty()) {
            return;
        }
        y1Var.getClass();
        for (int i11 = 0; i11 < list.size(); i11++) {
            y1Var.b(i10, list.get(i11), o2Var);
        }
    }
    ...
    public static void h(q2 q2Var, Object obj, Object obj2) {
        q2Var.getClass();
        f1 f1Var = (f1) obj;
        r2 r2Var = f1Var.zzb;
        r2 r2Var2 = ((f1) obj2).zzb;
        if (!r2Var2.equals(r2.f)) {
            int i10 = r2Var.a + r2Var2.a;
            int[] copyOf = Arrays.copyOf(r2Var.b, i10);
            System.arraycopy(r2Var2.b, 0, copyOf, r2Var.a, r2Var2.a);
            Object[] copyOf2 = Arrays.copyOf(r2Var.c, i10);
            System.arraycopy(r2Var2.c, 0, copyOf2, r2Var.a, r2Var2.a);
            r2Var = new r2(i10, copyOf, copyOf2, true);
        }
        f1Var.zzb = r2Var;
    }
    ...
    public static void m(int i10, List list, y1 y1Var, o2 o2Var) {
        if (list == null || list.isEmpty()) {
            return;
        }
        y1Var.getClass();
        for (int i11 = 0; i11 < list.size(); i11++) {
            y1Var.c(i10, list.get(i11), o2Var);
        }
    }
