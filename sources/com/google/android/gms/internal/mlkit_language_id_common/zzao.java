...
final class zzao implements ObjectEncoderContext {
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_language_id_common.zzan
            @Override // com.google.firebase.encoders.ObjectEncoder
            public final void encode(Object obj, Object obj2) {
                zzao.zzg((Map.Entry) obj, (ObjectEncoderContext) obj2);
            }
        };
    }

    zzao(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzam zzamVar = (zzam) fieldDescriptor.getProperty(zzam.class);
        if (zzamVar != null) {
            return zzamVar.zza();
        }
    ...
    private final zzao zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) {
    ...
    private final zzao zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) {
    ...
    private final void zzn(int i) {
        while (true) {
            ...
            OutputStream outputStream = this.zze;
            if (j == 0) {
                outputStream.write(i & NotificationCenter.needDeleteBusinessLink);
                return;
            } else {
                outputStream.write((i & NotificationCenter.needDeleteBusinessLink) | 128);
                i >>>= 7;
            }
        }
    }
    ...
    private final void zzo(long j) {
        while (true) {
            ...
            OutputStream outputStream = this.zze;
            if (j2 == 0) {
                outputStream.write(((int) j) & NotificationCenter.needDeleteBusinessLink);
                return;
            } else {
                outputStream.write((((int) j) & NotificationCenter.needDeleteBusinessLink) | 128);
                j >>>= 7;
            }
        }
    }
    ...
    final zzao zzd(FieldDescriptor fieldDescriptor, int i, boolean z) {
        if (!z || i != 0) {
    ...
    final zzao zze(FieldDescriptor fieldDescriptor, long j, boolean z) {
        if (!z || j != 0) {
            zzam zzj = zzj(fieldDescriptor);
            zzal zzalVar = zzal.zza;
            int ordinal = zzj.zzb().ordinal();
