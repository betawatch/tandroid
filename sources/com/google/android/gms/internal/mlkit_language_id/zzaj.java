...
public enum zzaj implements zzet {
    ...
    zzab(NotificationCenter.cameraInitied),
    zzac(NotificationCenter.didReplacedPhotoInMemCache),
    zzad(NotificationCenter.didSetNewTheme),
    zzae(NotificationCenter.themeListUpdated),
    zzaf(NotificationCenter.didApplyNewTheme),
    ...
    zzak(NotificationCenter.storiesReadUpdated),
    zzal(NotificationCenter.nearEarEvent),
    zzam(313),
    zzan(314),
    zzao(315),
    zzap(321),
    ...
    zzcr(100),
    zzcs(101),
    zzct(NotificationCenter.locationPermissionGranted),
    zzcu(NotificationCenter.locationPermissionDenied),
    ...
    zzdh(NotificationCenter.showBulletin),
    zzdi(NotificationCenter.appUpdateAvailable),
    zzdj(NotificationCenter.onDatabaseOpened),
    zzdk(NotificationCenter.billingConfirmPurchaseError),
    zzdl(NotificationCenter.premiumStickersPreviewLoaded),
    zzdm(NotificationCenter.userEmojiStatusUpdated),
    zzdn(NotificationCenter.wallpaperSettedToUser),
    zzdo(NotificationCenter.storiesUpdated),
    zzdp(361),
    zzdq(371);
