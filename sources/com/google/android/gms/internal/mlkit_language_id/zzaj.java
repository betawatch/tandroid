...
public enum zzaj implements zzet {
    ...
    zzdh(NotificationCenter.appUpdateLoading),
    zzdi(NotificationCenter.onDatabaseMigration),
    zzdj(NotificationCenter.onActivityResultReceived),
    zzdk(NotificationCenter.userEmojiStatusUpdated),
    zzdl(NotificationCenter.requestPermissions),
    zzdm(NotificationCenter.permissionsGranted),
    zzdn(NotificationCenter.storiesListUpdated),
    zzdo(NotificationCenter.storiesDraftsUpdated),
    zzdp(361),
    zzdq(371);
