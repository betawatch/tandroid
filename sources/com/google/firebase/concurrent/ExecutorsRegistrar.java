...
public class ExecutorsRegistrar implements ComponentRegistrar {
    ...
    public final List getComponents() {
        ...
        b bVar = new b(null, new HashSet(hashSet), new HashSet(hashSet2), 0, 0, new w(21), hashSet3);
        ...
        for (t tVar4 : tVarArr2) {
            j5.a(tVar4, "Null interface");
        }
        Collections.addAll(hashSet4, tVarArr2);
        b bVar2 = new b(null, new HashSet(hashSet4), new HashSet(hashSet5), 0, 0, new w(22), hashSet6);
        ...
        for (t tVar6 : tVarArr3) {
            j5.a(tVar6, "Null interface");
        }
        Collections.addAll(hashSet7, tVarArr3);
        b bVar3 = new b(null, new HashSet(hashSet7), new HashSet(hashSet8), 0, 0, new w(23), hashSet9);
