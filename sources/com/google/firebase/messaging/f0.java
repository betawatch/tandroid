...
public final class f0 implements ServiceConnection {
    ...
    public f0(Context context) {
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor = new ScheduledThreadPoolExecutor(0, new c5.v("Firebase-FirebaseInstanceIdServiceConnection"));
    ...
    public final synchronized Task b(Intent intent) {
        ...
        try {
            ...
            e0Var.b.getTask().addOnCompleteListener(scheduledThreadPoolExecutor, new a1.c(scheduledThreadPoolExecutor.schedule(new uc(e0Var, 3), 20L, TimeUnit.SECONDS), 25));
            this.d.add(e0Var);
            a();
        } catch (Throwable th2) {
            throw th2;
