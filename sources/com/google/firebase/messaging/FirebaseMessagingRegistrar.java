...
public class FirebaseMessagingRegistrar implements ComponentRegistrar {
    ...
    public static /* synthetic */ FirebaseMessaging lambda$getComponents$0(c9.c cVar) {
        ...
        if (cVar.a(aa.a.class) == null) {
            return new FirebaseMessaging(gVar, cVar.d(ja.b.class), cVar.d(z9.f.class), (ca.d) cVar.a(ca.d.class), (v2.f) cVar.a(v2.f.class), (y9.b) cVar.a(y9.b.class));
        }
    ...
    public List<c9.b> getComponents() {
        ...
        b10.g = new androidx.emoji2.text.w(19);
        b10.c(1);
        return Arrays.asList(b10.b(), l8.a(LIBRARY_NAME, "23.4.0"));
    }
}
