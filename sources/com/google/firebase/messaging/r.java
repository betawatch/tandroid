...
public final class r {
        ...
        if (str != null) {
            ...
            while (true) {
                ...
                if (readLine.length() == length && readLine.substring(2).equals(str)) {
                    ...
                    k1Var = new k1();
                    k1Var.b = (File) this.a;
                    k1Var.a.putAll(l(bufferedReader));
                    k1Var.c = jArr[0];
                }
            }
    ...
    public w0 c() {
        ...
        if (((String) this.c) == null) {
            str = w2.k(str, " parameterValue");
        }
        if (((Long) this.d) == null) {
            str = w2.k(str, " templateVersion");
        }
        if (str.isEmpty()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0063, code lost:
        ...
        throw new java.lang.Exception(vh.w2.e("Premature end of parens in ", r13));
     */
    /*
    ...
    */
    public void k(k1.m mVar) {
        ...
        if (!z11) {
            ...
            if (((AtomicInteger) this.d).getAndIncrement() == 0) {
                e0.q((ld.c0) this.a, new k1.c(this, (uc.c) null, 1));
                return;
            }
            return;
        }
    ...
    public s4.b n(List list) {
        ...
        Collections.sort(b10, new eu(18));
        ArrayList arrayList = new ArrayList();
        int i10 = 0;
