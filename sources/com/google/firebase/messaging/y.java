...
public final class y {
    ...
    public y(FirebaseMessaging firebaseMessaging, p pVar, w wVar, n nVar, Context context, ScheduledThreadPoolExecutor scheduledThreadPoolExecutor) {
    ...
    */
    ...
    public final void h(long j3) {
        this.f.schedule(new a0(this, this.a, this.b, Math.min(Math.max(30L, 2 * j3), i)), j3, TimeUnit.SECONDS);
        f(true);
    }
}
