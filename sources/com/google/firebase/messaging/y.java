...
public final class y {
    ...
    public y(FirebaseMessaging firebaseMessaging, n nVar, w wVar, a9.a aVar, Context context, ScheduledThreadPoolExecutor scheduledThreadPoolExecutor) {
    ...
    */
    ...
    public final void h(long j10) {
        this.f.schedule(new a0(this, this.a, this.b, Math.min(Math.max(30L, 2 * j10), i)), j10, TimeUnit.SECONDS);
        f(true);
    }
}
