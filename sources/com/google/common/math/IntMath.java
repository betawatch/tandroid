...
public abstract class IntMath {
    ...
    static final int[] halfPowersOf10 = {3, 31, NotificationCenter.activityPermissionsGranted, 3162, 31622, 316227, 3162277, 31622776, 316227766, ConnectionsManager.DEFAULT_DATACENTER_ID};
    private static final int[] factorials = {1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600};
    static int[] biggestBinomials = {ConnectionsManager.DEFAULT_DATACENTER_ID, ConnectionsManager.DEFAULT_DATACENTER_ID, 65536, 2345, 477, NotificationCenter.didUpdateTonGiftStickers, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
