...
public class ProxyBillingActivityV2 extends l {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.F = r(new a(this, 12), new e0(3));
        this.G = r(new g(this, 8), new e0(3));
        this.H = r(new n(this, 6), new e0(3));
        if (bundle != null) {
        ...
        if (getIntent().hasExtra("ALTERNATIVE_BILLING_ONLY_DIALOG_INTENT")) {
            ...
            cVar.a(new androidx.activity.result.g(intentSender, null, 0, 0));
            return;
        }
        if (getIntent().hasExtra("external_payment_dialog_pending_intent")) {
            ...
            cVar2.a(new androidx.activity.result.g(intentSender2, null, 0, 0));
            return;
        }
        if (getIntent().hasExtra("external_offer_flow_pending_intent")) {
            ...
            cVar3.a(new androidx.activity.result.g(intentSender3, null, 0, 0));
        }
    }
