...
public final class q implements y2.h, y2.k, d1, c3.q, z0 {
            ...
            while (i20 < length) {
                ...
                if (i20 == i16) {
                    ...
                    for (int i21 = 0; i21 < i18; i21++) {
                        ...
                        sVarArr[i21] = i18 == 1 ? w12.d(sVar3) : x(sVar3, w12, true);
                    }
    ...
    public final k4.d g(y2.j jVar, long j3, long j10, IOException iOException, int i10) {
        ...
        if (z10) {
            if (z11 && j11 == 0) {
                ArrayList arrayList = this.y;
                e2.d.g(((j) i2.g.z(1, arrayList)) == eVar);
        ...
        k4.d dVar2 = dVar;
        boolean a10 = dVar2.a();
        this.v.p(tVar, eVar.c, this.b, eVar.d, eVar.e, eVar.f, eVar.h, eVar.n, iOException, !a10);
        if (!a10) {
            this.K = null;
        }
        if (z10) {
    ...
    public final void h(y2.j jVar, long j3, long j10, int i10) {
        ...
        u2.t tVar2 = tVar;
        this.v.r(tVar2, eVar.c, this.b, eVar.d, eVar.e, eVar.f, eVar.h, eVar.n, i10);
    }
    ...
    */
    public final boolean p(i2.r0 r0Var) {
        ...
        oVar4.b = false;
        oVar4.d = null;
        boolean z17 = this.T || !list.isEmpty();
        i iVar4 = this.d;
        l.d dVar2 = iVar4.j;
        Uri[] uriArr = iVar4.e;
        p2.c cVar = iVar4.g;
        ...
        if (cVar.c(uri2)) {
            ...
            oVar2 = oVar5;
            long j26 = j11;
            Pair c10 = iVar4.c(jVar3, z18, a10, j25, j26);
                ...
                if (longValue < a10.k || ((d = i.d(a10, longValue, intValue)) != null && j13 + d.a.e < j3)) {
                    ...
                    if (longValue >= j14) {
                        ...
                        if (e7 == null) {
                            ...
                            oVar2.c = e10;
                            if (e10 == null) {
                                boolean z21 = jVar4 instanceof p2.g ? ((p2.g) jVar4).w || (d10.c == 0 && z19) : z19;
                                if (jVar == null) {
                                    ...
                                    if (!z21 || j29 < j26) {
                                        ...
                                        if (z10 || !z20) {
                                            ...
                                            if (m11 != null) {
                                                ...
                                                z11 = z22;
                                                dVar = dVar2;
                                                bArr = (byte[]) ((d) dVar.b).get(m11);
                                            }
                                            byte[] bArr4 = m10 != null ? null : (byte[]) ((d) dVar.b).get(m10);
                                            j2.k kVar2 = iVar.k;
                                            ...
                                            if (jVar == null) {
                                                g2.m mVar6 = jVar.G;
                                                boolean z25 = mVar2 == mVar6 || (mVar2 != null && mVar6 != null && mVar2.a.equals(mVar6.a) && mVar2.e == mVar6.e);
                                                boolean z26 = uri.equals(jVar.x) && jVar.X;
                                                iVar3 = jVar.O;
                                                vVar = jVar.P;
                                                bVar = (z25 && z26 && !jVar.Z && jVar.w == i12) ? jVar.S : null;
                                            } else {
                                                iVar3 = new q3.i(null);
                                                vVar = new v(10);
                                                bVar = null;
                                            ...
                                            boolean z27 = !z20;
                                            boolean z28 = jVar4.v;
                                            SparseArray sparseArray = (SparseArray) g0Var.b;
                                            ...
                                            oVar2 = oVar3;
                                            oVar2.c = new j(cVar2, hVar, mVar4, sVar, z12, hVar2, mVar2, z13, uri, list2, n10, q6, j34, j35, j36, i13, z27, i12, z28, z11, b0Var, jVar4.f, bVar, iVar6, vVar2, z10, z21, kVar);
                                        }
                                    }
                                }
                                z10 = false;
                                ...
                                int i132 = d10.c;
                                boolean z272 = !z20;
                                boolean z282 = jVar4.v;
                                SparseArray sparseArray2 = (SparseArray) g0Var2.b;
                                b0Var = (e2.b0) sparseArray2.get(i122);
                                if (b0Var == null) {
                                }
                                oVar2 = oVar3;
                                oVar2.c = new j(cVar22, hVar, mVar42, sVar2, z12, hVar2, mVar2, z13, uri, list2, n102, q62, j342, j352, j362, i132, z272, i122, z282, z11, b0Var, jVar4.f, bVar, iVar62, vVar22, z10, z21, kVar);
                            }
                        }
                    }
                    mVar = mVar3;
        ...
        this.K = eVar;
        mVar.f(eVar, this, this.r.L3(eVar.c));
        return true;
    }
    ...
    public final long s() {
        ...
        if (!z10.X) {
            ArrayList arrayList = this.y;
            z10 = arrayList.size() > 1 ? (j) i2.g.h(2, arrayList) : null;
        }
        if (z10 != null) {
            j3 = Math.max(j3, z10.n);
        }
        if (this.S) {
            for (p pVar : this.L) {
    ...
    public final void w(y2.j jVar, long j3, long j10, boolean z10) {
        ...
        u2.t tVar = new u2.t(j10);
        this.r.getClass();
        this.v.n(tVar, eVar.c, this.b, eVar.d, eVar.e, eVar.f, eVar.h, eVar.n);
        if (z10) {
            return;
        }
        if (B() || this.U == 0) {
