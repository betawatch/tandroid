...
public final class c1 extends c6.a implements l8.n {
    ...
    public final int hashCode() {
        int e = a2.e((this.a + 31) * 31, 31, this.b);
        String str = this.c;
        int e6 = a2.e(a2.e(a2.e((e + (str != null ? str.hashCode() : 0)) * 31, 31, this.d), 31, this.e), 31, this.f);
        String str2 = this.h;
    ...
    public final String toString() {
        ...
        a2.w(sb, this.r, ", categoryId=", this.s, ", categoryCount=");
