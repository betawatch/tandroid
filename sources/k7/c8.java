...
public abstract class c8 {
    ...
    */
    public static NinePatchDrawable b(Bitmap[] bitmapArr, float[] fArr, float f10, float f11, int i10, ug.e eVar) {
        float f12;
        int i11;
        char c3;
        Bitmap bitmap;
        ...
        int i13 = ceil7 + ceil5;
        boolean z4 = bitmapArr != null && bitmapArr.length == 1;
        if (z4) {
            c3 = 1;
            bitmap = bitmapArr[0];
            if (bitmap != null && !bitmap.isRecycled() && bitmap.isMutable() && bitmap.getWidth() == i12 && bitmap.getHeight() == i13) {
                ...
                if (bitmap.getConfig() == Bitmap.Config.ARGB_8888) {
                    ...
                    int b10 = o.b(((int) Math.ceil(max11)) + ceil2, 1, i12 - 2);
                    int b11 = o.b((i12 - ceil3) - ((int) Math.ceil(max12)), b10 + 1, i12 - 1);
                    int b12 = o.b(((int) Math.ceil(max13)) + ceil4, 1, i14 - 2);
                    return new NinePatchDrawable(ApplicationLoader.applicationContext.getResources(), bitmap, c(b10, b11, b12, o.b((i14 - ceil5) - ((int) Math.ceil(max14)), b12 + 1, i14 - 1), ceil2, ceil4, ceil3, ceil5, i10).array(), new Rect(ceil2, ceil4, ceil3, ceil5), null);
                }
            } else {
                f12 = max5;
            }
        ...
        int b102 = o.b(((int) Math.ceil(max112)) + ceil2, 1, i12 - 2);
        int b112 = o.b((i12 - ceil3) - ((int) Math.ceil(max122)), b102 + 1, i12 - 1);
        int b122 = o.b(((int) Math.ceil(max132)) + ceil4, 1, i142 - 2);
        return new NinePatchDrawable(ApplicationLoader.applicationContext.getResources(), bitmap, c(b102, b112, b122, o.b((i142 - ceil5) - ((int) Math.ceil(max142)), b122 + 1, i142 - 1), ceil2, ceil4, ceil3, ceil5, i10).array(), new Rect(ceil2, ceil4, ceil3, ceil5), null);
    }
