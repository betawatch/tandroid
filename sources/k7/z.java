    ...
    */
    public static int a(Object obj, Object obj2, int i10, Object obj3, int[] iArr, Object[] objArr, Object[] objArr2) {
        ...
        if (b10 != 0) {
            ...
            while (true) {
                ...
                int i16 = iArr[i15];
                int i17 = i16 & i10;
                if ((i16 & i12) != i13 || !d0.a(obj, objArr[i15]) || (objArr2 != null && !d0.a(obj2, objArr2[i15]))) {
                    if (i17 == 0) {
                        break;
                    }
                    i14 = i15;
    ...
    public static Object c(int i10) {
        if (i10 < 2 || i10 > 1073741824 || Integer.highestOneBit(i10) != i10) {
            throw new IllegalArgumentException(kf.k0.j(i10, "must be power of 2 between 2^1 and 2^30: "));
        }
