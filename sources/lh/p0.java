...
public final /* synthetic */ class p0 implements View.OnClickListener {
    ...
    public /* synthetic */ p0(s0 s0Var, zn znVar, int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, long j10, Utilities.Callback callback) {
        this.d = s0Var;
        this.c = i10;
        this.e = context;
        this.f = f6Var;
    ...
    public final void onClick(View view) {
        ...
        switch (this.a) {
            case 0:
                ...
                if (s0Var.s.T) {
                    ...
                    if (!MessagesController.getInstance(i10).isFrozen()) {
                        t7 x10 = t7.x(i10, s0Var.E.a);
                        lf.a l10 = x10.e ? lf.a.l(x10.p()) : null;
                        if (!s0Var.c && (l10 == null || l10.b < s0Var.E.b)) {
                            lf.a aVar = s0Var.E;
                            lf.b bVar = aVar.a;
                            if (bVar != lf.b.a) {
                                if (bVar == lf.b.b) {
                                    new qh.f(context, f6Var, aVar, true, null).show();
                                    break;
                                }
                            } else {
                                long a2 = aVar.a();
            ...
            default:
                ...
                final kh.a0 a0Var = (kh.a0) this.f;
                ...
                if (U != null) {
                    ...
                    c1Var.z2 = new ky() { // from class: rh.v0
                        ...
                        @Override // org.telegram.ui.ky
                        public final /* synthetic */ boolean I(qy qyVar) {
                            return false;
                        }
                        ...
                        public final boolean w(qy qyVar, ArrayList arrayList2, CharSequence charSequence, boolean z4, boolean z10, int i13, int i14, sf1 sf1Var) {
                            ...
                            if (!e1Var2.Z) {
                                e1Var2.Z = true;
                                a0Var.run(arrayList3.size() > 0 ? null : "USER_DECLINED", arrayList3);
                            }
                            if (sf1Var == null) {
    ...
    public /* synthetic */ p0(yf0 yf0Var, String str, long j10, String str2, String str3, int i10) {
        this.d = yf0Var;
        this.e = str;
        this.b = j10;
        this.f = str2;
    ...
    public /* synthetic */ p0(rh.e1 e1Var, TLRPC.TL_messages_preparedInlineMessage tL_messages_preparedInlineMessage, kh.a0 a0Var, int i10, long j10, org.telegram.ui.web.t tVar) {
        this.d = e1Var;
