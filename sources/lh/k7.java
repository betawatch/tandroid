    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.a) {
            case 0:
                ...
                break;
            case 1:
                AndroidUtilities.runOnUIThread(new gg.j((me) this.c, tL_error, tLObject, (TwoStepVerificationActivity) this.d, this.b, 10));
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new cg.u0((e60) this.c, tLObject, (TLRPC.ChatFull) this.d, this.b, 17));
                break;
            case 5:
                    ...
                    if (tL_messages_exportedChatInvites.invites.size() > 0 && tL_chatInviteExported2 != null) {
                        for (int i10 = 0; i10 < tL_messages_exportedChatInvites.invites.size(); i10++) {
                            if (((TLRPC.TL_chatInviteExported) tL_messages_exportedChatInvites.invites.get(i10)).link.equals(tL_chatInviteExported2.link)) {
                                ...
                                AndroidUtilities.runOnUIThread(new eh0(rh0Var, tL_chatInviteExported, tL_error, tLObject, this.b, 0));
                                break;
                            }
                        }
                    }
            ...
            case 6:
                ...
                break;
            case 7:
                AndroidUtilities.runOnUIThread(new cg.u0((ph.f1) this.c, tLObject, (String) this.d, this.b, 25));
                break;
            default:
