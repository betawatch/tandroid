...
public final class d8 extends View {
    ...
    public final void d(boolean z10) {
        ...
        this.D.addUpdateListener(new bg.c1(i10, this, this.d == null || Math.abs(getMeasuredHeight() - (getPaddingBottom() + (this.d.getHeight() + getPaddingTop()))) > AndroidUtilities.dp(3.0f)));
    ...
    public jv getAlert() {
        if (this.s != null) {
            return new jv(null, getContext(), this.a, this.s);
        }
        int i10 = -this.C;
        this.C = i10;
    ...
    private void set(int i10) {
        ...
        c90 c90Var = this.h;
        if (z10 && this.w) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickersEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.gc, c90Var.a), null));
        } else if (z10) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.gc, c90Var.a), null));
        } else {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickers", i10, new Object[0]), 0, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.gc, c90Var.a), null));
        }
    }
}
