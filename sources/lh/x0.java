...
public abstract class x0 {
    ...
    public static void b(Canvas canvas, int i10, Paint paint, Bitmap bitmap, float f10, float f11, float f12) {
        ...
        while (true) {
            ...
            a4.k.b((float[]) kVar.c, i12, 0.0f, 0.0f, width, height);
            i12++;
        }
        while (true) {
            float[] fArr = a[i10];
            ...
            float f19 = f15 * 1.0f;
            int i13 = i11 / 4;
            a4.k.b((float[]) kVar.b, i13, AndroidUtilities.dp(f17) - (AndroidUtilities.dp(f19) / 2.0f), AndroidUtilities.dp(f18) - (AndroidUtilities.dp(f19) / 2.0f), (AndroidUtilities.dp(f19) / 2.0f) + AndroidUtilities.dp(f17), (AndroidUtilities.dp(f19) / 2.0f) + AndroidUtilities.dp(f18));
    ...
    public static void c(Canvas canvas, org.telegram.ui.Components.j5 j5Var, int i10, float f10, float f11, RectF rectF, float f12) {
        ...
        for (int i13 = 54; i12 < i13; i13 = 54) {
            ...
            if (i12 == 18 || i12 == 19 || i12 == 6 || i12 == 7) {
                f14 = nr.i.getInterpolation(f14);
            }
            float[] fArr3 = fArr;
            float c3 = yh.c(1.0f, f16, AndroidUtilities.dp(12.0f), f48);
            if (f14 < 1.0f) {
                f47 = AndroidUtilities.lerp(f19, f47, nr.i.getInterpolation(f14));
                c3 = AndroidUtilities.lerp(f20, c3, f14);
                dpf27 = AndroidUtilities.lerp(AndroidUtilities.dpf2(8.0f), dpf27, f14);
            }
            if (c3 > f52 + AndroidUtilities.dp(8.0f)) {
                f46 = 1.0f;
                f15 = 1.0f - Utilities.clamp01((((c3 - max) - f13) - AndroidUtilities.dp(8.0f)) / AndroidUtilities.dp(56.0f));
            } else {
                f46 = 1.0f;
                f15 = 1.0f;
            }
