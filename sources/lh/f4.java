...
public final class f4 extends FrameLayout {
    ...
    public f4(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        layoutTransition2.setInterpolator(2, mrVar);
        layoutTransition2.setInterpolator(3, mrVar);
        layoutTransition2.setInterpolator(0, mrVar);
        layoutTransition2.setInterpolator(1, mrVar);
        layoutTransition2.setInterpolator(4, mrVar);
        ...
        TextView h = ai.h(this.O, textView3, k7.b6.d(-1, -2.0f, 49, 0.0f, 383.0f, 0.0f, 0.0f), context);
        this.I = h;
        ...
        h.setBackground(new s4(AndroidUtilities.dp(14.0f), org.telegram.ui.ActionBar.j6.l1(0.08f, -1)));
        TextView h9 = ai.h(this.O, h, k7.b6.d(-2, 27.0f, 81, 0.0f, 0.0f, 0.0f, 74.0f), context);
        h9.setTextSize(1, 13.0f);
        h9.setTextColor(org.telegram.ui.ActionBar.j6.l1(0.5f, -1));
        h9.setGravity(17);
        h9.setText(LocaleController.getString(R.string.GiftCraftProgressText));
        TextView h10 = ai.h(this.O, h9, k7.b6.d(-1, -2.0f, 81, 42.0f, 0.0f, 42.0f, 24.0f), context);
        ...
        h10.setGravity(17);
        TextView h11 = ai.h(this.P, h10, k7.b6.d(-1, -2.0f, 55, 32.0f, 352.0f, 32.0f, 0.0f), context);
        this.J = h11;
        h11.setTextColor(-17253);
        h11.setTextSize(1, 13.0f);
        h11.setGravity(17);
        this.P.addView(h11, k7.b6.d(-1, -2.0f, 55, 32.0f, 383.0f, 32.0f, 0.0f));
    ...
    */
    public final void d(boolean z4) {
        ...
        if (giftsSelectedCount <= 0) {
            ...
            k6Var2.setText(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.GiftCraftSuccessChance, rh.j.G0(getGiftsSuccessChance()))));
        }
