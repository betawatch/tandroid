...
public final class b extends i51 {
    ...
    public final void bindView(View view, j51 j51Var, boolean z4, x51 x51Var, i61 i61Var) {
        ...
        spannableStringBuilder.setSpan(new org.telegram.ui.Components.u5(auction.giftDocumentId, k6.s2.getFontMetricsInt()), 0, spannableStringBuilder.length(), 33);
        ...
        tz0 tz0Var = new tz0(cVar.getContext(), cVar.a);
        tz0Var.a(spannableStringBuilder).setFilled(true);
        tz0Var.k(LocaleController.getString(R.string.Gift2AuctionsAcquiredRecipient), cVar.b, DialogObject.getPeerDialogId(tL_StarGiftAuctionAcquiredGift.peer), new gf.c(22, cVar, onClickListener));
