...
public final class f7 {
    ...
    */
    public static void a(f7 f7Var, v5 v5Var) {
        ...
        try {
            ...
            try {
                            ...
                            if (byteBufferValue != 0) {
                                ...
                                if (storyFwdHeader != null) {
                                    try {
                                        ...
                                        try {
                                            FileLog.e(th);
                                            AndroidUtilities.runOnUIThread(new m5(v5Var, 4));
                                            return;
                                        } finally {
                                            if (sQLiteCursor != 0) {
                ...
                Collections.sort(tL_stories_allStories.peer_stories, Comparator$-CC.comparingInt(new jf.d(9)));
                AndroidUtilities.runOnUIThread(new r3(10, v5Var, tL_stories_allStories));
            } catch (Throwable th5) {
                th = th5;
    ...
    public final void d(a0.h hVar, Runnable runnable, int i10, boolean z10, Timer timer) {
        ...
        while (i12 < hVar.m()) {
            ...
            while (i13 < arrayList2.size()) {
                ...
                TL_stories.StoryItem f9 = f7Var.f(e(messageObject), j10);
                if (f9 != null && !(f9 instanceof TL_stories.TL_storyItemSkipped)) {
                    b(i11, j10, messageObject, f9);
        ...
        while (i14 < hVar.m()) {
            ...
            StringBuilder r6 = a4.w.r(j11, "fillMessagesWithStories: getStoriesByID did=", " ids=");
            r6.append(TextUtils.join(",", tL_stories_getStoriesByID.id));
            int sendRequest = ConnectionsManager.getInstance(i11).sendRequest(tL_stories_getStoriesByID, new e7(f7Var, Timer.start(timer2, r6.toString()), arrayList3, j11, z10, timer2, iArr, runnable));
            if (i10 != 0) {
    ...
    public final void k(long j10, TL_stories.StoryItem storyItem) {
        ...
        this.b.getStorageQueue().postRunnable(new g5.v(this, j10, storyItem, 9));
    }
