    ...
    public final void run(Object obj) {
        ...
        switch (i11) {
            case 0:
                ...
                if (this.b == this.c) {
                    f4Var.a0 = arrayList;
                    t5Var.animate().alpha(f4Var.s ? 0.0f : f4Var.a0 != null ? 1.0f : 0.25f).setInterpolator(nr.h).setDuration(420L).start();
            ...
            default:
                ...
                if (xnVar.getParentActivity() != null) {
                    ...
                    org.telegram.ui.Components.z4.i0(parentActivity, string, replaceTags, formatPluralStringComma, string2, ghVar, f6Var, true);
                    break;
                }
                break;
        }
