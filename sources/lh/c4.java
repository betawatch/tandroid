...
public final class c4 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void c(Runnable runnable, boolean z10) {
        ...
        d dVar = b4Var.b;
        b4Var.animate().alpha(this.y ? 1.0f : 0.0f).setInterpolator(er.h).setDuration(320L).withEndAction(new fh.f(8, this, z10)).start();
        ...
        if (this.s != j10) {
            ...
            if (j10 == 0) {
                ...
                if (j10 > 0) {
                    ...
                    int d = user != null ? org.telegram.ui.Components.y8.d(user.id) : i0.b.d(0.2f, -16777216, -1);
                    n9Var.getImageReceiver().setImage(ImageLocation.getForPath(absolutePath), "500_500_nocache", forUser, "50_50_b2", null, null, new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{i0.b.d(0.2f, d, -16777216), i0.b.d(0.4f, d, -16777216)}), 0L, null, user, 0);
                } else {
                    ...
                    int d10 = chat != null ? org.telegram.ui.Components.y8.d(chat.id) : i0.b.d(0.2f, -16777216, -1);
                    n9Var.getImageReceiver().setImage(ImageLocation.getForPath(absolutePath), "500_500_nocache", forChat, "50_50_b2", null, null, new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{i0.b.d(0.2f, d10, -16777216), i0.b.d(0.4f, d10, -16777216)}), 0L, null, chat, 0);
                }
            }
        }
        this.s = j10;
        this.v = d4Var;
        if (this.r && d4Var != null && !d4Var.f) {
            d4Var.f = true;
            d4Var.a();
        }
        boolean z10 = (d4Var == null || (d1Var2 = d4Var.a) == null || !d1Var2.n()) ? false : true;
        if (d4Var == null || (d1Var = d4Var.a) == null || !d1Var.a()) {
            y0Var = null;
        } else {
            jh.d1 d1Var3 = d4Var.a;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.liveStoryUpdated) {
            ...
            jh.d4 d4Var = this.v;
            if (d4Var == null || (d1Var = d4Var.a) == null || d1Var.g() != longValue) {
                return;
            }
            boolean n10 = this.v.a.n();
            if (this.v.a.a()) {
                jh.d1 d1Var2 = this.v.a;
