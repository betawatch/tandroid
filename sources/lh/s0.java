...
public final class s0 extends org.telegram.ui.ActionBar.g3 {
    ...
    public s0(final Context context, int i10, long j10, MessageSuggestionParams messageSuggestionParams, zn znVar, final org.telegram.ui.ActionBar.f6 f6Var, int i11, Utilities.Callback callback) {
        ...
        bd0Var2.e(q0Var);
        bd0Var2.addView(q0Var, k7.b6.d(-1, -2.0f, 48, 0.0f, 0.0f, 48.0f, 0.0f));
        k7.d6.b(bd0Var2, 0.02f, 1.2f);
        final int i16 = 1;
        bd0Var2.setOnClickListener(new View.OnClickListener(this) { // from class: lh.o0
            public final /* synthetic */ s0 b;
        ...
        if (aVar2 != null) {
            z4 = false;
            q(lf.a.i(aVar2.b, aVar2.a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z4 = false;
    ...
    public final lf.a p() {
        return this.E.a == lf.b.b ? this.D : this.B;
    }
    ...
    public final void q(lf.a aVar, boolean z4, boolean z10, boolean z11) {
        ...
        if (z12) {
            ...
            o40 o40Var = this.e;
            if (o40Var != null) {
                o40Var.a(this.E.a == bVar3 ? 0 : 1, z11);
            }
            lf.b bVar4 = this.E.a;
        ...
        if (z12 || z14) {
            ...
            if ((i11 & 4) != 0) {
                ...
                bd0Var.setText(LocaleController.getString(this.E.a == bVar3 ? R.string.PostSuggestionsOfferTitlePriceStars : R.string.PostSuggestionsOfferTitlePriceTON));
            }
        }
        if (z12 || z13 || z14) {
            int i14 = this.d;
