...
public final /* synthetic */ class e7 implements RequestDelegate {
    ...
    public /* synthetic */ e7(f7 f7Var, Timer.Task task, ArrayList arrayList, long j10, boolean z10, Timer timer, int[] iArr, Runnable runnable) {
        this.g = f7Var;
        this.b = task;
        this.h = arrayList;
        this.c = j10;
                    ...
                    for (int i11 = 0; i11 < arrayList.size(); i11++) {
                        ...
                        while (true) {
                            ...
                            if (i12 >= size) {
                                ...
                                tL_storyItemDeleted.id = f7.e(messageObject);
                                f7.b(i10, j10, messageObject, tL_storyItemDeleted);
                            } else if (tL_stories_stories.stories.get(i12).id == f7.e(messageObject)) {
                        ...
                        if (this.d) {
                            f7Var.b.getStorageQueue().postRunnable(new r3(14, f7Var, arrayList));
                        }
                    }
    ...
    public /* synthetic */ e7(MediaDataController mediaDataController, Timer.Task task, long j10, a0.h hVar, boolean z10, Timer timer, AtomicInteger atomicInteger, Runnable runnable) {
