...
public final class z9 extends org.telegram.ui.Components.sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public z9(Context context, org.telegram.ui.ActionBar.f6 f6Var, long j10, int i10, String str, Runnable runnable, long j11) {
        ...
        f90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.B6, f6Var));
        f90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var));
        if (isReady) {
            f90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StarsTOS), new b(this, i12)));
        } else {
            org.telegram.ui.b.n(R.string.StarsPurchaseUnavailable, f90Var);
        }
        f90Var.setGravity(17);
        f90Var.setMaxWidth(ph.f3.a(f90Var.getText(), f90Var.getPaint()));
        frameLayout.addView(f90Var, k7.b6.e(-2, -1, 17));
        ...
        this.X = s00Var;
        this.containerView.addView(s00Var, k7.b6.c(-1.0f, -1));
        w51 w51Var = this.b0;
        if (w51Var != null) {
            w51Var.N(false);
        }
