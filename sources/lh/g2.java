...
public final class g2 extends f2 {
    ...
    public g2(j2 j2Var, int i10, int i11, String str) {
        ...
        this.o = j2Var;
        this.a = i10;
        Drawable mutate = j2Var.getContext().getResources().getDrawable(i11).mutate();
        this.i = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
        String upperCase = str.toUpperCase();
        TextPaint textPaint = j2Var.b;
    ...
    public final void a(Canvas canvas, float f10, float f11) {
        ...
        canvas.translate((rectF.left + AndroidUtilities.dp(6 + (this.i != null ? 28 : 0))) - this.m, ((this.c / 2.0f) + rectF.top) - (this.k.getHeight() / 2.0f));
        this.k.draw(canvas);
        canvas.restore();
    }
