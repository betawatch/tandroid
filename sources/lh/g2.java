    ...
    public final void run(Object obj) {
        switch (this.a) {
            case 0:
                ...
                break;
            case 1:
                AndroidUtilities.runOnUIThread(new kh.e1((ub) this.b, (TLRPC.ChannelParticipant) obj, (ArrayList) this.c, (ArrayList) this.d, (ArrayList) this.e, (org.telegram.ui.ta) this.f, 10));
                break;
            case 2:
                final zn znVar = (zn) this.b;
                ...
                hm0 hm0Var = new hm0(znVar.getParentActivity(), znVar.ba);
                I.p = new re(hm0Var, 1);
                ...
                if (tL_contact == null && (user == null || !znVar.getContactsController().contactsDict.containsKey(Long.valueOf(user.id)))) {
                ...
                if (user == null) {
                    ...
                    if (!UserObject.isUserSelf(user)) {
                        final int i10 = 0;
                        I.c(R.drawable.msg_calls, LocaleController.getString(R.string.VoiceCallViaTelegram), new Runnable() { // from class: org.telegram.ui.mg
                        ...
                        final int i11 = 1;
                        I.c(R.drawable.msg_videocall, LocaleController.getString(R.string.VideoCallViaTelegram), new Runnable() { // from class: org.telegram.ui.mg
                            @Override // java.lang.Runnable
                            public final void run() {
                                boolean z4;
                                boolean z10;
            ...
            case 3:
                ...
                Object obj2 = this.e;
                if (i12 == 1) {
                    org.telegram.ui.Components.z4.M(znVar2.getParentActivity(), znVar2.Q5, new a1.d(znVar2, tL_document, str2, obj2, 5), znVar2.ba);
                } else {
                    znVar2.getSendMessagesHelper().sendSticker(tL_document, str2, znVar2.Q5, znVar2.k5, znVar2.U3, null, znVar2.i5, sendAnimationData, true, 0, 0, false, obj2, znVar2.C8(), l10.longValue(), znVar2.N8(), znVar2.d5);
