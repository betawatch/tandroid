...
public final class y6 extends View implements q2 {
    ...
    public y6(Activity activity) {
        ...
        this.d0 = new org.telegram.ui.Components.y5(this, 0L, 200L, er.f);
        this.i0 = new org.telegram.ui.Components.y5(this, 0L, 350L, erVar);
        this.j0 = -1.0f;
        this.k0 = true;
        this.l0 = new org.telegram.ui.Components.y5(this, 0L, 350L, erVar);
        this.m0 = new org.telegram.ui.Components.y5(this, 0L, 850L, erVar);
        this.o0 = new float[2];
        this.p0 = new org.telegram.ui.Components.y5(this, 0L, 350L, erVar);
        this.x0 = new org.telegram.ui.Components.y5(this, 0L, 350L, erVar);
        this.y0 = new org.telegram.ui.Components.y5(this, 0L, 650L, erVar);
        this.z0 = new org.telegram.ui.Components.y5(this, 0L, 160L, er.i);
    ...
    public final boolean c(float f10, float f11, float f12, float f13, float f14, boolean z10) {
        return this.n0 ? (!z10 || f13 - f11 <= ((float) AndroidUtilities.dp(100.0f))) && Math.abs(f12 - f10) <= f14 : h7.y.a(f10, f11, f12, f13) <= f14;
    }
    ...
    public final void h() {
        ...
        if (w6Var != null) {
            ...
            if (arrayList2 != null && !arrayList2.isEmpty() && ((z7) arrayList2.get(0)).O0 != null) {
                this.b.setImage(ImageLocation.getForPath(((z7) arrayList2.get(0)).O0.getAbsolutePath()), "80_80", null, null, this.c, 0L, null, null, 0);
                return;
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d14 = this.y0.d((abs >= dp || !(this.n0 || ncVar2.h)) ? 0.0f : 1.0f, false) * d13;
        ...
        float f34 = 1.0f - d11;
        float e9 = this.E0.e(this.D0 > 0.0f) * f34;
        float d17 = this.F0.d(this.D0, false);
        float e10 = this.G0.e(b());
        float f35 = this.v0 ? d11 * max * d13 : 0.0f;
        if (f35 > 0.0f) {
            f15 = 1.0f;
        ...
        float f37 = this.e0;
        float lerp = AndroidUtilities.lerp(f37, this.A0.d((AndroidUtilities.dp(4.0f) * clamp) + f37, false), d14);
        ...
        float lerp4 = AndroidUtilities.lerp(ncVar2.a(this.k0 ? 0.0f : 0.2f), (this.d0.d(this.c0, false) * 0.2f) + f15, d11);
        ...
        float f41 = f15 - f13;
        int d18 = i0.b.d(max * f41, -1, -577231);
        Paint paint4 = this.r;
        paint4.setColor(d18);
        if (f13 > f16) {
            canvas2.save();
        ...
        if (e11 <= 0.0f) {
            ...
            hp.a(this.o0, (SystemClock.elapsedRealtime() - this.r0) % 5400);
            invalidate();
            float[] fArr = this.o0;
            float f49 = fArr[0];
            float f50 = fArr[c10];
        ...
        float a3 = ncVar3.a(0.2f) * f34 * f17;
        if (a3 > 0.0f) {
            canvas3.save();
        ...
        if (d19 > 0.0f) {
            canvas3.save();
            float a10 = ncVar4.a(0.2f) * d19 * f17;
        ...
        if (d19 < 1.0f) {
            canvas3.save();
            f26 = f17;
            float z11 = org.telegram.messenger.y1.z(1.0f, d19, ncVar4.a(0.2f), f26);
            canvas3.scale(z11, z11, this.h0, this.f0);
            canvas3.rotate(y5Var2.d(this.I, false) - getRotation(), this.h0, this.f0);
        ...
        if (i11 > 0) {
            ...
            if (abs4 >= lerp2 + (f27 * 2.0f) || clamp3 >= 0.6f) {
                ...
                y5Var = y5Var2;
                ncVar = ncVar4;
                float min2 = Math.min(1.0f, (abs4 * 2.0f) / f57) * Math.min(clamp3 * 2.4f, h7.y.a(pointF4.x, pointF4.y, pointF6.x, pointF6.y) / f57);
                float f66 = lerp2 * min2;
                float f67 = f28 * min2;
                a(pointF4.x, pointF4.y, d26 - 1.5707963705062866d, f66, this.P0);
                a(pointF5.x, pointF5.y, d27 + 1.5707963705062866d, f66, this.Q0);
                a(pointF6.x, pointF6.y, d29 + 1.5707963705062866d, f67, this.R0);
                a(pointF7.x, pointF7.y, d30 - 1.5707963705062866d, f67, this.S0);
                float f68 = f19;
                float C = com.google.android.recaptcha.internal.a.C(f20, f23, f68, f10);
                if (C > 0.0f) {
                    Path path2 = this.J0;
                    path2.rewind();
        ...
        if (i10 > 0 || f29 > 0.0f) {
            float a11 = ncVar3.a(0.2f) * f19 * f30;
            canvas3.save();
            Path path3 = this.K0;
            path3.rewind();
            if (i10 > 0) {
        ...
        boolean z12 = this.T;
        boolean z13 = this.n0;
        if (z12 == z13 && this.U == b10 && this.V == this.K && this.W == this.k0 && this.a0 == this.q0 && this.b0 == this.w0) {
            return;
        }
        this.T = z13;
        this.U = b10;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (z10) {
            ...
            ncVar2.c(c(clamp, y10, this.e0, this.f0, AndroidUtilities.dp(60.0f), false));
            ncVar3.c(c(clamp, y10, this.h0, this.f0, (float) AndroidUtilities.dp(30.0f), true) && !b());
            ncVar.c(c(clamp, y10, this.g0, this.f0, (float) AndroidUtilities.dp(30.0f), false) && !b());
        }
        v6 v6Var = this.I0;
        v6 v6Var2 = this.H0;
        if (action == 0) {
            this.s0 = true;
            this.t0 = ncVar2.h || ncVar3.h;
            ...
            if (action == 2) {
                if (this.s0) {
                    ...
                    if (this.n0 && this.v0) {
                        ...
                        sb sbVar = ((oa) this.a).a;
                        sbVar.R0.b(clamp2, true);
                        sbVar.j0(false);
                    }
                }
                return false;
            ...
            if (action == 1 || action == 3) {
                if (this.s0) {
                    ...
                    boolean z12 = this.n0;
                    if (!z12 && ncVar.h) {
                        sb sbVar2 = ((oa) this.a).a;
                        if (sbVar2.b0 == 0 && !sbVar2.L1 && !sbVar2.M1 && sb.b(sbVar2)) {
                            sbVar2.f(true);
                        }
                    } else if (z12 && this.v0) {
                        if (ncVar.h) {
                        ...
                        if (b()) {
                            ...
                            this.q0 = true;
                            ((oa) this.a).d(false);
                        } else if (sb.d(((oa) this.a).a)) {
                            this.N = 0L;
                            this.M = System.currentTimeMillis();
                            this.w0 = false;
                            ((oa) this.a).e(new v6(this, 1), false);
                        }
                    }
                    this.v0 = false;
                    if (ncVar3.h) {
    ...
    public void setInvert(float f10) {
        this.s.setColor(i0.b.d(f10, -1, -16777216));
        this.w.setColor(i0.b.d(f10, 1677721600, 369098752));
        this.A.setColor(i0.b.d(f10, 1493172223, 285212671));
        this.B.setColor(i0.b.d(f10, 402653184, 805306368));
        int d = i0.b.d(f10, -1, -16777216);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        this.d.setColorFilter(new PorterDuffColorFilter(d, mode));
        this.f.setColorFilter(new PorterDuffColorFilter(i0.b.d(f10, -1, -16777216), mode));
    }
}
