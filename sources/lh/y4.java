...
public final class y4 extends il0 {
    ...
    public final void v(f2.n1 n1Var, int i10) {
        ...
        org.telegram.ui.Cells.l6 l6Var = (org.telegram.ui.Cells.l6) n1Var.a;
        ...
        if (storyView != null) {
            ...
            if (reaction == null || (str2 = kg.q0.d(reaction).f) == null || !str2.equals("❤")) {
                j11 = 0;
                z10 = false;
            } else {
                j11 = 0;
            ...
            if (storyView instanceof TL_stories.TL_storyViewPublicRepost) {
                ...
                i12 = 11;
                i13 = 12;
                l6Var.c(user2, null, null, z10, 0L, storyView.story, false, true, remove);
            } else {
                ...
                if (storyView instanceof TL_stories.TL_storyViewPublicForward) {
                    ...
                    k5 k5Var = c5Var.y;
                    l6Var.c(user3, null, null, z10, j12, k5Var == null ? null : k5Var.a, true, true, remove);
                } else {
                    l6Var.c(user3, null, z10 ? null : storyView.reaction, z10, storyView.date, null, false, true, remove);
                }
            }
            int i15 = i10 < arrayList.size() + (-1) ? ((t4) arrayList.get(i10 + 1)).a : -1;
            l6Var.a = i15 == 1 || i15 == i12 || i15 == i13;
            l6Var.a(c5Var.d(storyView) ? 1.0f : 0.5f, false);
            return;
        }
        ...
        if (storyReaction != null) {
            if (storyReaction instanceof TL_stories.TL_storyReaction) {
                ...
                boolean z11 = (reaction2 == null || (str = kg.q0.d(reaction2).f) == null || !str.equals("❤")) ? false : true;
                i11 = 12;
                l6Var.c(user4, chat, z11 ? null : tL_storyReaction.reaction, z11, tL_storyReaction.date, null, false, true, remove);
            } else {
                i11 = 12;
                if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
                    ...
                    k5 k5Var2 = c5Var.y;
                    l6Var.c(user4, chat, null, false, j13, k5Var2 == null ? null : k5Var2.a, true, true, remove);
                }
            }
            boolean z12 = true;
    ...
    public final f2.n1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 10:
                ...
                if (i10 == 7) {
                    ...
                    if (!premiumFeaturesBlocked) {
                        ...
                        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ExpiredViewsStubPremiumDescription), new Runnable() { // from class: lh.u4
                        ...
                        Runnable runnable = new Runnable() { // from class: lh.u4
                            @Override // java.lang.Runnable
                            public final void run() {
                                switch (i12) {
                                    case 0:
                        ...
                        ((LinearLayout.LayoutParams) y80Var.getLayoutParams()).topMargin = AndroidUtilities.dp(12.0f);
                        ...
                        int k9 = i0.a.k(org.telegram.ui.ActionBar.g6.v0(i14, c6Var), 30);
            ...
            case 11:
            case 12:
                y80 y80Var2 = new y80(c5Var.getContext(), null);
                y80Var2.setTextSize(1, 13.0f);
                y80Var2.setTextColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.y6, bVar));
                y80Var2.setLinkTextColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.J6, bVar));
                int dp2 = AndroidUtilities.dp(16.0f);
                int dp3 = AndroidUtilities.dp(21.0f);
                y80Var2.setPadding(dp3, dp2, dp3, dp2);
                y80Var2.setMaxLines(ConnectionsManager.DEFAULT_DATACENTER_ID);
                y80Var2.setGravity(17);
                y80Var2.setDisablePaddingsOffsetY(true);
                if (i10 == 11) {
                    y80Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryViewsPremiumHint), new jh.o(this, 29)));
                } else {
                    y80Var2.setText(LocaleController.getString(R.string.ServerErrorViewersFull));
                }
                y80Var2.setLayoutParams(new f2.x0(-1, -2));
                view = y80Var2;
                break;
        }
        return new vk0(view);
