...
public final class i2 extends f2 {
    ...
    public i2(j2 j2Var) {
        ...
        int i10;
        this.p = j2Var;
        this.i = new ig.h0(j2Var);
        this.j = new ig.h0(j2Var);
        this.l = new org.telegram.ui.Components.y5(j2Var);
        this.n = new jh.o8(j2Var);
        this.o = new ArrayList();
        this.a = 3;
        this.b = AndroidUtilities.dp(44.0f);
        this.c = AndroidUtilities.dp(36.0f);
        i10 = ((org.telegram.ui.ActionBar.e3) j2Var.f).currentAccount;
        ...
        for (int i11 = 0; i11 < Math.min(reactionsList.size(), 8); i11++) {
            this.o.add(ig.q0.c(reactionsList.get(i11)));
        }
        Collections.sort(this.o, new k9.a(2));
        if (!this.o.isEmpty()) {
            this.i.e((ig.q0) this.o.get(this.k));
        }
        this.l.d(1.0f, true);
    }
