...
public final class t7 {
    ...
    public static void e(String str) {
        ...
        ai.r(R.string.UnknownErrorCode, new Object[]{str}, (R == null || R.visibleDialog != null) ? qc.X() : qc.a0(R), R.raw.error, 36);
    }
    ...
    public final void Y(MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, Runnable runnable, Utilities.Callback callback) {
        ...
        if (messageObject == null || (message2 = messageObject.messageOwner) == null || !(message2.media instanceof TLRPC.TL_messageMediaPaidMedia)) {
            ...
            if (webDocument != null) {
                ...
                j11 = j15;
                textView.setText(ja.R0(kf.k0.l((int) j15, ',', new StringBuilder("XTR ")), 0.85f, null));
                i12 = 0;
                ...
                f90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, I));
                f90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
                f90Var.setTextSize(1, 14.0f);
                f90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i10 <= 0 ? R.string.StarsConfirmSubscriptionTOS : R.string.StarsConfirmPurchaseTOS), new e2.f(context2, 6)));
                f90Var.setGravity(17);
                viewGroup.addView(f90Var, k7.b6.k(0.0f, 12.0f, 0.0f, 2.0f, -1, -2));
        ...
        f90 f90Var2 = new f90(context2, I);
        f90Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, I));
        f90Var2.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
        f90Var2.setTextSize(1, 14.0f);
        f90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i10 <= 0 ? R.string.StarsConfirmSubscriptionTOS : R.string.StarsConfirmPurchaseTOS), new e2.f(context2, 6)));
        f90Var2.setGravity(17);
        viewGroup.addView(f90Var2, k7.b6.k(0.0f, 12.0f, 0.0f, 2.0f, -1, -2));
                    ...
                    public final void run() {
                        ...
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 == null || !"BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                ...
                                ai.r(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, a02, R.raw.error, 36);
                                return;
                    ...
                    public final void run() {
                        ...
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            ...
                            if (tL_error2 != null && "FORM_EXPIRED".equals(tL_error2.text)) {
                                TLRPC.TL_payments_getPaymentForm tL_payments_getPaymentForm = new TLRPC.TL_payments_getPaymentForm();
                                JSONObject p10 = rh.p2.p(f6Var2, false);
                                if (p10 != null) {
                                    TLRPC.TL_dataJSON tL_dataJSON = new TLRPC.TL_dataJSON();
                                    tL_payments_getPaymentForm.theme_params = tL_dataJSON;
                                    tL_dataJSON.data = p10.toString();
                            ...
                            qc qcVar = X;
                            callback3.run(Boolean.FALSE);
                            ai.r(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, qcVar, R.raw.error, 36);
    ...
    */
    ...
    public final s7 d0(final MessageObject messageObject, final zn znVar, final long j10, boolean z4, boolean z10, final Long l10) {
        ...
        if (z10 && y10.e && y10.q(false, false, null).amount <= 0) {
            ...
            final int i11 = 0;
            new z9(t6, znVar.getResourceProvider(), j10, 5, str, new Runnable(this) { // from class: lh.o6
                ...
                public final void run() {
                    switch (i11) {
                        case 0:
                            this.b.d0(messageObject, znVar, j10, true, true, l10);
                            break;
                        default:
                            this.b.d0(messageObject, znVar, j10, true, true, l10);
                            break;
        ...
        if (z10 && y10.e && y10.q(false, false, null).amount < j12) {
            ...
            final int i12 = 1;
            new z9(t6, znVar.getResourceProvider(), j12, 5, str2, new Runnable(t7Var) { // from class: lh.o6
                public final /* synthetic */ t7 b;
                ...
                public final void run() {
                    switch (i12) {
                        case 0:
                            this.b.d0(messageObject, znVar, j12, true, true, l10);
                            break;
                        default:
                            this.b.d0(messageObject, znVar, j12, true, true, l10);
                            break;
                                            ...
                                            if (tL_error4 != null) {
                                                ...
                                                if ("BALANCE_TOO_LOW".equals(tL_error4.text)) {
                                                    if (!MessagesController.getInstance(t7Var4.a).starsPurchaseAvailable()) {
                                                        ...
                                                        boolean[] zArr = {false};
                                                        z9 z9Var = new z9(context6, f6Var4, j16, 6, str4, new i6(t7Var4, zArr, starGift5, z18, z19, j17, tL_textWithEntities5, r5Var5), 0L);
                                                        z9Var.setOnDismissListener(new gg.g(i12, r5Var5, zArr));
                                                        z9Var.show();
                                                        return;
                                                    }
                                                }
    ...
    public final void j0(String str, TLRPC.ChatInvite chatInvite, Utilities.Callback2 callback2) {
        ...
        if (chatInvite != null && chatInvite.subscription_pricing != null) {
            ...
            if (context2 != null) {
                ...
                f90 f90Var = new f90(context2, I);
                int i16 = 9;
                f90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StarsSubscribeInfo), new e2.f(context2, i16)));
                f90Var.setGravity(17);
                ...
                o10.customView = f10;
                dVar.setOnClickListener(new dg.p(d7Var, o10, dVar, i16));
    ...
    public final TL_stars.StarsAmount q(boolean z4, boolean z10, Runnable runnable) {
        ...
        lf.a m9 = lf.a.m(this.f);
        return lf.a.g(Math.max(0L, m9.a() - this.g), m9.a).o();
    }
    ...
    public final lf.a s() {
        lf.a l10 = lf.a.l(p());
        if (l10 == null) {
            return lf.a.i(0L, this.b ? lf.b.b : lf.b.a);
        }
        return l10;
    }
