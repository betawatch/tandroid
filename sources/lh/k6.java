...
public class k6 {
    ...
    public final h6 q = new h6(this, 0);
    public int s = -1;
    public int A = -1;
    ...
    public final void D(List list, boolean z10) {
        ...
        while (true) {
            ...
            if (storyItem2 != null) {
                ...
                if (z12 != z13) {
                    if (!z13) {
                        j7.l1.t(storyItem2.id, new StringBuilder("StoriesList remove story "));
                    ...
                    j7.l1.t(storyItem2.id, new StringBuilder("StoriesList update story "));
    ...
    */
    ...
    public boolean q(int i10, List list, boolean z10) {
        ...
        if (this.t) {
            this.y = new j6(this, z10, i10, list);
            return false;
        }
        int i12 = this.e;
        long j10 = this.d;
    ...
    public final void z(int i10) {
        ...
        if (!arrayList.isEmpty() || (r3Var = this.x) == null) {
            return;
        }
        AndroidUtilities.cancelRunOnUIThread(r3Var);
