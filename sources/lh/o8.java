...
public final class o8 extends Drawable {
    ...
    public o8(View view) {
        this.b = view;
        this.g = new org.telegram.ui.Components.d6(view, 350L, jr.h);
    ...
    public final void c(float f9) {
        this.c.setShadowLayer(AndroidUtilities.dp(2.0f) / f9, 0.0f, AndroidUtilities.dpf2(0.7f) / f9, i0.a.k(-16777216, 45));
    }
