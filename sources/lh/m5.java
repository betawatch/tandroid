...
public final class m5 extends LinearLayout {
    ...
    public /* synthetic */ m5(Context context, Object obj, LinearLayout linearLayout, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
        this.c = linearLayout;
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.a) {
            case 4:
                ...
                ((pz0) this.b).e(canvas, ((fc0) this.c).getX() - AndroidUtilities.dp(50.0f), getHeight() / 2.0f);
                break;
            case 5:
                canvas.save();
                org.telegram.ui.Components.y5 y5Var = (org.telegram.ui.Components.y5) this.b;
                c21 c21Var = (c21) this.c;
                float e9 = y5Var.e(c21Var.w);
                if (e9 > 0.0f) {
                    if (c21Var.c == null) {
                        c21Var.c = new io0(this);
                    }
                    canvas.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                    c21Var.c.a(canvas, e9);
                    canvas.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
                }
                super.dispatchDraw(canvas);
                canvas.restore();
        ...
        switch (this.a) {
            case 0:
                ...
                if (layout != null) {
                    ...
                    float interpolation = layout2 == null ? 0.0f : er.f.getInterpolation(f6Var.W0);
            ...
            case 8:
                ...
                float interpolation2 = layout4 == null ? 0.0f : er.f.getInterpolation(l0Var.e1);
    ...
    public m5(c21 c21Var, Context context) {
        ...
        this.a = 5;
        this.c = c21Var;
        this.b = new org.telegram.ui.Components.y5(this, 360L, er.h);
    }
