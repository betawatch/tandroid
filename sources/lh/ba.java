    ...
    public final void bindView(View view, i51 i51Var, boolean z4, w51 w51Var, g61 g61Var) {
        ...
        if (TextUtils.isEmpty(starsSubscription.title)) {
            ...
            if (starsSubscription.photo != null) {
                p70 p70Var = new p70(textView3, 14.0f, i10);
                p70Var.a(4.0f);
                p70Var.f = false;
                ...
                p70Var.b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsSubscription.photo)), "14_14", null, null, 0, 0);
