...
public final /* synthetic */ class u6 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.a) {
                ...
                if (tL_error2 != null || !(tLObject2 instanceof Vector)) {
                    ...
                    if (arrayList2.isEmpty()) {
                        for (int i16 = 0; i16 < arrayList4.size(); i16++) {
                            ...
                            wh0Var.a.add((Long) pair.first);
                            wh0Var.b.add((Integer) pair.second);
                            wh0Var.c.add((TLObject) hashMap.get(pair.first));
                        }
                        wh0Var.b();
                        break;
                        ...
                        final int i17 = 0;
                        ConnectionsManager.getInstance(i13).sendRequest(tL_channels_getParticipants, new RequestDelegate() { // from class: org.telegram.ui.th0
                                                                ...
                                                                if (i21 < size3) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i20 < arrayList6.size()) {
                                                                            ...
                                                                            wh0Var3.a.add((Long) pair2.first);
                                                                            wh0Var3.b.add((Integer) pair2.second);
                                                                            wh0Var3.c.add((TLObject) hashMap3.get(pair2.first));
                                                                            i20++;
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (i23 < size4) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i22 < arrayList7.size()) {
                                                                            ...
                                                                            wh0Var4.a.add((Long) pair3.first);
                                                                            wh0Var4.b.add((Integer) pair3.second);
                                                                            wh0Var4.c.add((TLObject) hashMap4.get(pair3.first));
                                                                            i22++;
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (i212 < size3) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i202 < arrayList62.size()) {
                                                                            ...
                                                                            wh0Var32.a.add((Long) pair2.first);
                                                                            wh0Var32.b.add((Integer) pair2.second);
                                                                            wh0Var32.c.add((TLObject) hashMap32.get(pair2.first));
                                                                            i202++;
                                                                        }
                                                                    }
                                                                }
                        ...
                        final int i18 = 1;
                        ConnectionsManager.getInstance(i13).sendRequest(tL_messages_getFullChat, new RequestDelegate() { // from class: org.telegram.ui.th0
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(final TLObject tLObject3, TLRPC.TL_error tL_error3) {
                                switch (i18) {
                                    case 0:
            ...
            default:
                ...
                b0.g(i19).f(context, j16, connectedbotstarref.bot_id, new re1(i19, j16, context, connectedbotstarref, (org.telegram.ui.ActionBar.g3) this.f, (org.telegram.ui.ActionBar.f6) this.h));
                break;
        }
    }
    ...
    public /* synthetic */ u6(wh0 wh0Var, TLRPC.TL_error tL_error, TLObject tLObject, long j10, int i10, TLRPC.Chat chat) {
        this.d = wh0Var;
        this.e = tL_error;
        this.f = tLObject;
        this.b = j10;
