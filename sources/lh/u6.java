...
public final /* synthetic */ class u6 implements Runnable {
    ...
    public /* synthetic */ u6(int i10, long j10, Context context, TL_payments.connectedBotStarRef connectedbotstarref, org.telegram.ui.ActionBar.g3 g3Var, org.telegram.ui.ActionBar.f6 f6Var) {
        this.c = i10;
        this.d = context;
        this.b = j10;
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                org.telegram.ui.Cells.e6.a((org.telegram.ui.Cells.e6) this.d, (TLObject) this.f, (MessagesStorage) this.h, this.b, this.c, (ArrayList) this.e);
                break;
            case 3:
                ...
                if (tLObject instanceof TLRPC.Updates) {
                    ...
                    if (LaunchActivity.D1 == null) {
                        ...
                        g3Var.dismiss();
                        org.telegram.ui.Components.voip.f2.g(LaunchActivity.D1, i11, tL_inputGroupCall, false, groupcall.call, null);
                    ...
                    ai.u(g3Var.topBulletinContainer, null, tL_error, false);
                    break;
                }
                break;
            case 4:
                final yh0 yh0Var = (yh0) this.d;
                ...
                if (tL_error2 != null || !(tLObject2 instanceof Vector)) {
                    ...
                    if (arrayList2.isEmpty()) {
                        for (int i16 = 0; i16 < arrayList4.size(); i16++) {
                            ...
                            yh0Var.a.add((Long) pair.first);
                            yh0Var.b.add((Integer) pair.second);
                            yh0Var.c.add((TLObject) hashMap.get(pair.first));
                        }
                        yh0Var.b();
                        break;
                        ...
                        final int i17 = 0;
                        ConnectionsManager.getInstance(i13).sendRequest(tL_channels_getParticipants, new RequestDelegate() { // from class: org.telegram.ui.vh0
                                                                ...
                                                                if (i21 < size3) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i20 < arrayList6.size()) {
                                                                            ...
                                                                            yh0Var3.a.add((Long) pair2.first);
                                                                            yh0Var3.b.add((Integer) pair2.second);
                                                                            yh0Var3.c.add((TLObject) hashMap3.get(pair2.first));
                                                                            i20++;
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (i23 < size4) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i22 < arrayList7.size()) {
                                                                            ...
                                                                            yh0Var4.a.add((Long) pair3.first);
                                                                            yh0Var4.b.add((Integer) pair3.second);
                                                                            yh0Var4.c.add((TLObject) hashMap4.get(pair3.first));
                                                                            i22++;
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (i212 < size3) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i202 < arrayList62.size()) {
                                                                            ...
                                                                            yh0Var32.a.add((Long) pair2.first);
                                                                            yh0Var32.b.add((Integer) pair2.second);
                                                                            yh0Var32.c.add((TLObject) hashMap32.get(pair2.first));
                                                                            i202++;
                                                                        }
                                                                    }
                                                                }
                        ...
                        final int i18 = 1;
                        ConnectionsManager.getInstance(i13).sendRequest(tL_messages_getFullChat, new RequestDelegate() { // from class: org.telegram.ui.vh0
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(final TLObject tLObject3, TLRPC.TL_error tL_error3) {
                                switch (i18) {
                                    case 0:
            ...
            default:
                ...
                b0.g(i19).f(context, j16, connectedbotstarref.bot_id, new ze1(i19, j16, context, connectedbotstarref, (org.telegram.ui.ActionBar.g3) this.f, (org.telegram.ui.ActionBar.f6) this.h));
                break;
        }
    }
    ...
    public /* synthetic */ u6(TLObject tLObject, int i10, ph.d dVar, org.telegram.ui.ActionBar.g3 g3Var, long j10, TLRPC.TL_error tL_error) {
        this.d = tLObject;
        this.c = i10;
        this.e = dVar;
        this.f = g3Var;
    ...
    public /* synthetic */ u6(org.telegram.ui.Cells.e6 e6Var, TLObject tLObject, MessagesStorage messagesStorage, long j10, int i10, ArrayList arrayList) {
        this.d = e6Var;
        this.f = tLObject;
    ...
    public /* synthetic */ u6(yh0 yh0Var, TLRPC.TL_error tL_error, TLObject tLObject, long j10, int i10, TLRPC.Chat chat) {
        this.d = yh0Var;
        this.e = tL_error;
        this.f = tLObject;
        this.b = j10;
