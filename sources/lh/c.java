...
public final class c extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a() {
        ...
        if (bVar2 == bVar3) {
            ...
            f90Var.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.Gift2MessageStarsInfoLink), new b(this, i11)), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)));
            return;
        }
        if (bVar2 == lf.b.b) {
            ...
            f90Var.setTextColor(i0.a.d(0.33f, v02, org.telegram.ui.ActionBar.j6.v0(i14, f6Var)));
            f90Var.setLinkTextColor(i0.a.d(0.33f, org.telegram.ui.ActionBar.j6.v0(i13, f6Var), org.telegram.ui.ActionBar.j6.v0(i14, f6Var)));
            f90Var.setText(sb);
        }
    }
