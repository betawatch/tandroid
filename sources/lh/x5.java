...
public final /* synthetic */ class x5 implements Runnable {
    ...
    public /* synthetic */ x5(s6 s6Var, long j10, boolean z10, TL_stories.PeerStories peerStories, long j11, TLObject tLObject) {
        this.e = s6Var;
        this.c = j10;
        this.b = z10;
        this.f = peerStories;
    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                s6Var.D.remove(Long.valueOf(this.c));
                boolean z10 = this.b;
                long j10 = this.d;
                if (!z10) {
                ...
                if (peerStories != null) {
                    if (tLObject instanceof TL_stories.TL_stories_stories) {
                        ...
                        if (!z10) {
                            f7 f7Var = s6Var.k;
                            f7Var.b.getStorageQueue().postRunnable(new c7(f7Var, peerStories, 1));
                        }
                    }
    ...
    public /* synthetic */ x5(FileLoader fileLoader, boolean z10, String str, long j10, long j11, Float f9) {
        this.e = fileLoader;
        this.b = z10;
        this.f = str;
        this.c = j10;
