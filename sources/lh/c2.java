    ...
    */
    public final void run() {
        ...
        switch (i11) {
            ...
            case 1:
                g5.d0((g5) obj3, j10, (TL_stars.TL_starGiftUnique) obj2, (oy) obj);
                break;
            case 2:
                g5 g5Var2 = (g5) obj3;
                g5Var2.getClass();
                ...
                if (peerStories == null) {
                    ...
                    if (!(storyItem2 instanceof TL_stories.TL_storyItemDeleted)) {
                        if (!nh.m7.w(i13, storyItem2)) {
                            if (j10 > 0 && (user == null || (!user.self && !t6Var.M(user)))) {
                                ...
                                kh.a2.t(tL_updateStory.story.id, new StringBuilder("StoriesController add new user with story id="));
                    ...
                    while (true) {
                        if (i15 >= peerStories.stories.size()) {
                            ...
                            kh.a2.t(storyItem3.id, new StringBuilder("StoriesController remove story id="));
                            z10 = true;
                            z11 = true;
                        } else {
                            ...
                            kh.a2.t(storyItem3.id, new StringBuilder("StoriesController update story id="));
                            z10 = true;
                        }
                    }
                    z11 = false;
