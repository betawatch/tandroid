    ...
    */
    public final void run() {
        ...
        switch (i11) {
            ...
            case 1:
                g5.d0((g5) obj3, j10, (TL_stars.TL_starGiftUnique) obj2, (qy) obj);
                break;
            case 2:
                g5 g5Var2 = (g5) obj3;
                g5Var2.getClass();
                ...
                if (peerStories == null) {
                    ...
                    if (!(storyItem2 instanceof TL_stories.TL_storyItemDeleted)) {
                        if (!nh.m7.w(i13, storyItem2)) {
                            if (j10 > 0 && (user == null || (!user.self && !t6Var.M(user)))) {
                                ...
                                kf.k0.t(tL_updateStory.story.id, new StringBuilder("StoriesController add new user with story id="));
                    ...
                    while (true) {
                        if (i15 >= peerStories.stories.size()) {
                            ...
                            kf.k0.t(storyItem3.id, new StringBuilder("StoriesController remove story id="));
                            z10 = true;
                            z11 = true;
                        } else {
                            TL_stories.StoryItem storyItem4 = peerStories.stories.get(i15);
                            storyItem3 = nh.t6.f(storyItem4, storyItem3);
                            ...
                            kf.k0.t(storyItem3.id, new StringBuilder("StoriesController update story id="));
                            z10 = true;
                        }
                    }
                    z11 = false;
                    ...
                    if (z11) {
                        if (!peerStories.stories.isEmpty() || t6Var.K(j10)) {
                            Collections.sort(peerStories.stories, nh.t6.X);
                        } else {
            ...
            case 9:
                ...
                la0Var.accept(storyItem);
                break;
            case 10:
                TLObject tLObject3 = (TLObject) obj2;
                h5.d dVar = (h5.d) obj;
                nh.t6 t6Var3 = ((nh.b6) obj3).c;
                if (tLObject3 != null) {
            ...
            case 11:
                long j11 = this.c;
                AndroidUtilities.runOnUIThread(new i5.v((nh.l7) obj3, (View) obj2, j11, 10), 500L);
                ((nh.i7) obj).f(j11);
                break;
            case 12:
    ...
    public /* synthetic */ c2(t7 t7Var, Object obj, long j10, Object obj2, int i10) {
        this.a = i10;
        this.d = t7Var;
        this.b = obj;
        this.c = j10;
    ...
    public /* synthetic */ c2(t7 t7Var, Utilities.Callback callback, TL_stars.StarGift starGift, long j10) {
        this.a = 5;
        this.d = t7Var;
        this.e = callback;
        this.b = starGift;
