...
public final class z7 extends View implements t9 {
    ...
    /* JADX WARN: Type inference failed for: r8v14, types: [lh.v7] */
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.v != null) {
            ...
            float f9 = this.n;
            rectF.set(f9, this.h, r4.getWidth() + f9, this.h + this.v.getHeight());
            if (rectF.contains(motionEvent.getX(), motionEvent.getY())) {
                ...
                if (!z11 && (y7Var3 = y7VarArr[r13]) != null && y7Var3.p != null) {
                    ...
                    rectF3.set(f10, lerp, i13 + y7Var4.p.x, AndroidUtilities.lerp(y7Var4.m, y7Var4.l, this.w) + this.B);
                ...
                if (z10 && (a8Var.r0 || (y7Var2 = y7VarArr[0]) == null || y7Var2.g == null)) {
                    float f11 = this.A;
                    float f12 = this.B + i10;
                    Rect rect = u9Var.B;
                    t9 t9Var = u9Var.u0;
                    staticTextLayout = t9Var.getStaticTextLayout();
                    if (staticTextLayout != null) {
                        ...
                        int i15 = (int) f12;
                        u9Var.d = i15;
                        org.telegram.ui.Cells.n9 n9Var = u9Var.a0;
                        n9Var.b = staticTextLayout;
                        n9Var.d = f11;
                        n9Var.c = f12;
                        n9Var.a = 0;
        ...
        if (!z11) {
            ...
            rectF32.set(f102, lerp2, i132 + y7Var42.p.x, AndroidUtilities.lerp(y7Var42.m, y7Var42.l, this.w) + this.B);
        ...
        if (z10) {
            float f112 = this.A;
            float f122 = this.B + i10;
            Rect rect2 = u9Var.B;
            t9 t9Var2 = u9Var.u0;
            staticTextLayout = t9Var2.getStaticTextLayout();
            if (staticTextLayout != null) {
            }
            u9Var.N(motionEvent);
        }
    ...
    public final void onDetachedFromWindow() {
        ...
        org.telegram.ui.Components.y5.release(z7Var, y7Var.f);
        if (y7Var.h == null) {
            return;
        }
        while (true) {
            ...
            if (w7Var != null) {
                org.telegram.ui.Components.y5.release(z7Var, w7Var.a);
            }
            i10++;
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x0109, code lost:
        ...
        r3.d(true);
        r1.b = null;
        r13 = new org.telegram.ui.Components.z80(r9[0], null, r20.getX(), r20.getY(), 0);
        r1.a = r13;
        ...
        r9 = r1.a;
        r6.S.f(false);
        r4.postDelayed(new lh.r3(19, r1, r9), android.view.ViewConfiguration.getLongPressTimeout());
        r4 = true;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x00f4, code lost:
        ...
        r9 = (android.text.style.CharacterStyle[]) r5.getSpans(r11, r11, org.telegram.ui.Components.z41.class);
     */
        ...
        if (!this.F.o0 && (y7VarArr = this.r) != null) {
            ...
            if (y7Var.e != null) {
                ...
                if (staticLayout != null) {
                    RectF rectF = AndroidUtilities.rectTmp;
                    float f9 = z7Var.n;
                    rectF.set(f9, z7Var.h, staticLayout.getWidth() + f9, z7Var.h + z7Var.v.getHeight());
                }
            }
        }
        return false;
