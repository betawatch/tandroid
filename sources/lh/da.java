...
public final class da extends h51 {
    ...
    */
    public final void bindView(View view, i51 i51Var, boolean z4, w51 w51Var, g61 g61Var) {
        ...
        f90Var.setVisibility(eaVar.x ? 0 : 8);
            ...
            if (!starsTransaction.posts_search) {
                if (peerDialogId != 0) {
                    ...
                    if (starsTransaction.stargift != null) {
                        r70 r70Var = new r70(f90Var, 16.0f, i10);
                        r70Var.a(4.0f);
                        r70Var.f = false;
                        SpannableString spannableString4 = new SpannableString("x");
                        spannableString4.setSpan(r70Var, 0, 1, 33);
                        ja.a1(r70Var.b, starsTransaction.stargift, 16);
                        textView3.setText(str);
                        if (starsTransaction.offer) {
                            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("x ");
                            spannableStringBuilder.setSpan(new org.telegram.ui.Components.u5(starsTransaction.stargift.getDocument(), f90Var.getPaint().getFontMetricsInt()), 0, 1, 33);
                            ...
                            spannableStringBuilder2.setSpan(new org.telegram.ui.Components.u5(starsTransaction.stargift.getDocument(), f90Var.getPaint().getFontMetricsInt()), 0, 1, 33);
                            if (starsTransaction.amount.negative()) {
                            ...
                            f90Var.setText(TextUtils.concat(charSequenceArr));
                        } else if (starsTransaction.stargift instanceof TL_stars.TL_starGiftUnique) {
                            f90Var.setText(LocaleController.getString(starsTransaction.refund ? R.string.StarGiftTransactionGiftTransferRefund : R.string.StarGiftTransactionGiftTransfer));
                            ...
                            f90Var.setText(TextUtils.concat(charSequenceArr2));
                        } else {
                            ...
                            f90Var.setText(TextUtils.concat(charSequenceArr3));
                        }
                        ...
                        if (i12 == 2592000) {
                            ...
                            f90Var.setText(LocaleController.getString(R.string.StarsTransactionSubscriptionMonthly));
                        } else {
                            String str2 = i12 == 300 ? "5 minutes" : "Minute";
                            f90Var.setVisibility(0);
                            Locale locale = Locale.US;
                            f90Var.setText(str2.concat(" subscription fee"));
                        }
                    } else if (starsTransaction.phonegroup_message) {
                        textView3.setText(str);
                        f90Var.setVisibility(z11 ? 8 : 0);
                        f90Var.setText(LocaleController.getString(starsTransaction.reaction ? R.string.StarsTransactionLiveStoryReactionFee : R.string.StarsTransactionLiveStoryMessageFee));
                    } else if (starsTransaction.paid_message) {
                        textView3.setText(str);
                        f90Var.setVisibility(z11 ? 8 : 0);
                        f90Var.setText(LocaleController.formatPluralStringComma("StarsTransactionMessageFee", starsTransaction.paid_messages));
                    } else if (starsTransaction.premium_gift) {
                        textView3.setText(str);
                        f90Var.setVisibility(z11 ? 8 : 0);
                        f90Var.setText(LocaleController.getString(R.string.StarsTransactionPremiumGift));
                    } else if (z15) {
                        textView3.setText(str);
                        f90Var.setVisibility(z11 ? 8 : 0);
                        f90Var.setText(LocaleController.formatString(R.string.StarTransactionCommission, rh.j.G0(starsTransaction.starref_commission_permille)));
                    } else if (starsTransaction.gift) {
                        textView3.setText(str);
                        f90Var.setVisibility(z11 ? 8 : 0);
                        f90Var.setText(LocaleController.getString(R.string.StarsGiftReceived));
                    } else if ((starsTransaction.flags & 8192) != 0) {
                        textView3.setText(str);
                        f90Var.setVisibility(z11 ? 8 : 0);
                        f90Var.setText(LocaleController.getString(R.string.StarsGiveawayPrizeReceived));
                    } else if (starsTransaction.reaction) {
                        textView3.setText(str);
                        f90Var.setVisibility(z11 ? 8 : 0);
                        f90Var.setText(LocaleController.getString(R.string.StarsReactionsSent));
                    } else if (starsTransaction.extended_media.isEmpty()) {
                        z10 = z14;
                        if (starsTransaction.photo != null) {
                            r70 r70Var2 = new r70(f90Var, 14.0f, i10);
                            r70Var2.a(4.0f);
                            r70Var2.f = false;
                            SpannableString spannableString5 = new SpannableString("x");
                            spannableString5.setSpan(r70Var2, 0, 1, 33);
                            r70Var2.b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsTransaction.photo)), "14_14", null, null, num, 0);
                            textView3.setText(str);
                            f90Var.setVisibility(z11 ? 8 : 0);
                            String str3 = starsTransaction.title;
                            f90Var.setText(Emoji.replaceEmoji(TextUtils.concat(spannableString5, " ", str3 != null ? str3 : ""), f90Var.getPaint().getFontMetricsInt(), false));
                        } else {
                            textView3.setText(str);
                            f90Var.setVisibility(z11 ? 8 : 0);
                            String str4 = starsTransaction.title;
                            f90Var.setText(Emoji.replaceEmoji(str4 != null ? str4 : "", f90Var.getPaint().getFontMetricsInt(), false));
                        }
                    } else {
                        if (z13) {
                            textView3.setText(str);
                            f90Var.setVisibility(0);
                            f90Var.setText(LocaleController.getString(R.string.StarMediaPurchase));
                        } else {
                    ...
                    if (starsTransaction.floodskip) {
                        ...
                        f90Var.setText(LocaleController.formatPluralStringComma("StarsTransactionFloodskipMessages", starsTransaction.floodskip_number));
                        ...
                        if (starsTransactionPeer instanceof TL_stars.TL_starsTransactionPeerAppStore) {
                            ...
                            if (starsTransaction.gift) {
                                ...
                                f90Var.setText(LocaleController.getString(z10 ? R.string.StarsTransactionTONFromFragment : R.string.StarsTransactionUnknown));
                                f90Var.setVisibility(0);
                            } else {
