...
public final class z0 {
    ...
    public z0(z7 z7Var) {
        ...
        this.q = z7Var.j0;
        this.r = j10;
        z7Var.n0.getValues(fArr);
        this.t = z7Var.A0;
        this.u = z7Var.B0;
        CharSequence[] charSequenceArr = {z7Var.C0};
        this.w = z7Var.D0 ? MediaDataController.getInstance(z7Var.a).getEntities(charSequenceArr, true) : null;
        ...
        this.i0 = z7Var.L0;
        this.j0 = z7Var.S;
        this.k0 = VideoEditedInfo.Part.toParts(z7Var);
    }
    ...
    public final z7 a() {
        ...
        if (str4 != null) {
            ...
            z7Var.C0 = MessageObject.replaceAnimatedEmoji(replaceEmoji, this.w, org.telegram.ui.ActionBar.g6.o2.getFontMetricsInt());
        } else {
            z7Var.C0 = "";
        }
        ...
        z7Var.L0 = this.i0;
        z7Var.S = this.j0;
        z7Var.T = VideoEditedInfo.Part.toStoryEntries(this.k0);
        return z7Var;
    }
