...
public final class n0 extends org.telegram.ui.Components.sa {
    ...
    public n0(final Context context, final int i10, final long j10, TL_stars.TL_starGiftUnique tL_starGiftUnique, final org.telegram.ui.ActionBar.f6 f6Var, t1 t1Var) {
        ...
        ad0Var2.e(l0Var);
        ad0Var2.addView(l0Var, k7.b6.d(-1, -2.0f, 48, 0.0f, 0.0f, 48.0f, 0.0f));
    ...
    public static void P(n0 n0Var, long j10, boolean z4, mf.a aVar, long j11, org.telegram.ui.ActionBar.d2 d2Var) {
        if (j10 > 0) {
            ...
            mf.a g10 = z4 ? mf.a.g(j10, bVar) : mf.a.i(n0Var.j0.b + aVar.b, bVar);
            ...
            if (l10 != null) {
                ...
                if (j11 >= aVar.b) {
                    ...
                    if (sendPaidMessagesStars == 0) {
                        ...
                        if (!z4) {
                            z10 = z4;
                            spannableStringBuilder.append((CharSequence) ja.Q0(LocaleController.formatString(R.string.GiftOfferPay, mf.a.i(n0Var.j0.b + g10.b, bVar).d())));
                    ...
                    alertDialog$Builder2.k(spannableStringBuilder, new org.telegram.ui.ActionBar.c2() { // from class: lh.h0
                        @Override // org.telegram.ui.ActionBar.c2
                        public final void i(org.telegram.ui.ActionBar.d2 d2Var2, int i12) {
    ...
    public static /* synthetic */ void R(n0 n0Var, af.f fVar, org.telegram.ui.ActionBar.d2 d2Var, TLRPC.Updates updates, TLRPC.TL_error tL_error) {
    ...
    public final void U(mf.a aVar, boolean z4, boolean z10, boolean z11) {
        ...
        if (z12) {
            n40 n40Var = this.Y;
            if (n40Var != null) {
                n40Var.a(this.j0.a == bVar3 ? 0 : 1, z11);
            }
            ...
            c cVar2 = this.U;
            if (cVar2 != null && cVar2.e != (bVar = this.j0.a)) {
                cVar2.e = bVar;
                cVar2.a();
            }
        } else {
        ...
        if (z12 || z14) {
            ...
            if (i12 != 0) {
                ...
                String d = ((mf.a) bVarArr2[bVar6.ordinal()].c).d();
                ...
                String d10 = ((mf.a) bVarArr2[bVar6.ordinal()].b).d();
