...
public final class h1 extends FrameLayout implements xd.b {
    ...
    public h1(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.r = new xd.a(0, this, nr.h, 320L, false);
        this.a = f6Var;
    ...
    public static void a(h1 h1Var, TLRPC.Document document, int i10, Object obj, boolean z4) {
        ...
        p9Var.setLayoutParams(k7.b6.d(i10, i10, 49, 0.0f, r3 + 17, 0.0f, (80 - i10) / 2));
    ...
    public final void b() {
        ...
        if (num != null) {
            d = org.telegram.ui.ActionBar.j6.v(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false), org.telegram.ui.ActionBar.j6.l1(AndroidUtilities.lerp(0.15f, 1.0f, aVar.e), this.h.intValue()));
            u1Var.x = this.h;
            this.b.invalidate();
