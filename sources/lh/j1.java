...
public final class j1 extends org.telegram.ui.Components.sa {
    ...
    public j1(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, String str, ArrayList arrayList, boolean z4) {
        ...
        this.o0 = new ng.k(sl0Var, e3Var, new ts(sl0Var, 0));
        ...
        TextView i19 = yh.i(frameLayout, textView, k7.b6.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 102.0f), context);
        this.m0 = i19;
        i19.setTextSize(1, 13.0f);
        i19.setText(LocaleController.getString(R.string.Gift2PreviewRandomTraits));
        i19.setGravity(17);
        int i20 = -1879048193;
        i19.setTextColor(-1879048193);
        frameLayout.addView(i19, k7.b6.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 82.0f));
        ...
        while (true) {
            ...
            if (i21 >= v3VarArr.length) {
                ...
                this.s0 = new f1((TL_stars.starGiftAttributeBackdrop) mf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) mf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) mf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.h0.N(false);
                T(false);
                return;
            }
            ...
            v3VarArr[i21] = v3Var;
            if (i21 == 0) {
                ((TextView) this.W[i21].c).setText(LocaleController.getString(R.string.GiftPreviewModel));
            } else if (i21 == 1) {
                ((TextView) this.W[i21].c).setText(LocaleController.getString(R.string.GiftPreviewBackdrop));
            } else if (i21 == 2) {
                ((TextView) this.W[i21].c).setText(LocaleController.getString(R.string.GiftPreviewSymbol));
            }
            k7.d6.a(this.W[i21]);
            this.W[i21].setOnClickListener(new y0(this, i21, 0));
            this.W[i21].setBackground(org.telegram.ui.ActionBar.j6.Z(0, 285212671, 10, 10));
            LinearLayout linearLayout2 = this.V;
            dg.v3[] v3VarArr2 = this.W;
            linearLayout2.addView(v3VarArr2[i21], k7.b6.p(0, 42, 1.0f, 7, 0, 0, i21 != v3VarArr2.length - 1 ? 11 : 0, 0));
            i21++;
            i18 = 17;
            i16 = -1;
            i20 = -1879048193;
    ...
    public final void T(boolean z4) {
        ...
        ((org.telegram.ui.Components.k6) v3VarArr[1].b).c(rh.k.G0(c1Var.getUpgradeBackdropAttribute().getRarityPermille()), z4, true);
        ((org.telegram.ui.Components.k6) v3VarArr[2].d).c(c1Var.getUpgradePatternAttribute().name, z4, true);
        ((org.telegram.ui.Components.k6) v3VarArr[2].b).c(rh.k.G0(c1Var.getUpgradePatternAttribute().getRarityPermille()), z4, true);
    }
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT < 31 || !canvas.isHardwareAccelerated() || (eVar = this.p0) == null || (dVar = this.q0) == null || dVar.n || !dVar.e(width, height)) {
            return;
        }
