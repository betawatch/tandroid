...
public final class bc extends Path {
    ...
    public final void a(float f10, float f11, float f12, float f13, float f14, float f15, ArrayList arrayList) {
        ...
        if (Math.abs(this.e - f13) <= 1.0f && Math.abs(this.f - f14) <= 0.01f && Math.abs(this.g - 0.0f) <= 0.1f && Math.abs(this.h - f15) <= 1.0f && Math.abs(this.i - f16) <= 1.0f && Math.abs(this.j - f11) <= 1.0f && Math.abs(this.k - f17) <= 1.0f) {
            ...
            if (arrayList2 != null && arrayList2.size() == arrayList.size()) {
                for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                    if (((Integer) arrayList2.get(i10)).intValue() == (arrayList.get(i10) == null ? 0 : ((vb) arrayList.get(i10)).b)) {
                    }
                }
            }
            ...
            for (int i11 = 0; i11 < arrayList3.size(); i11++) {
                if (((Float) arrayList3.get(i11)).floatValue() != (arrayList.get(i11) == null ? 0.0f : ((vb) arrayList.get(i11)).a.d(((vb) arrayList.get(i11)).c, false))) {
                    return;
                }
            }
        }
        ...
        while (i12 < arrayList.size()) {
            i12 = i0.a.f(arrayList.get(i12) == null ? 0 : ((vb) arrayList.get(i12)).b, i12, 1, this.c);
        }
        ...
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            this.d.add(Float.valueOf(arrayList.get(i13) == null ? 0.0f : ((vb) arrayList.get(i13)).a.d(((vb) arrayList.get(i13)).c, false)));
        }
        this.i = f16;
        this.j = f11;
        this.k = f17;
        ...
        for (int i15 = 0; i15 < arrayList.size(); i15++) {
            if (arrayList.get(i15) != null) {
                i14 = Math.max(i14, ((vb) arrayList.get(i15)).b);
            }
        }
        ...
        while (max <= min) {
            ...
            for (int i17 = 0; i17 < arrayList.size(); i17++) {
                short s10 = (arrayList.get(i17) == null || max >= ((vb) arrayList.get(i17)).b) ? (short) 0 : ((vb) arrayList.get(i17)).d[max];
                if (f18 < ((Float) arrayList6.get(i17)).floatValue() && max + 1 > ((Float) arrayList6.get(i17)).floatValue()) {
                    s10 = (short) ((((Float) arrayList6.get(i17)).floatValue() - f18) * s10);
            ...
            rectF.set(dp, AndroidUtilities.lerp(f15 - max2, f15 - ((f13 + max2) / 2.0f), 0.0f), AndroidUtilities.dpf2(1.66f) + dp, AndroidUtilities.lerp(f15, org.telegram.messenger.y1.a(f13, max2, 2.0f, f15), 0.0f));
    ...
    public final void b(float f10, float f11, float f12, float f13, long j10, float f14, float f15, float f16, vb vbVar) {
        ...
        int i10 = vbVar.b;
        org.telegram.ui.Components.y5 y5Var = vbVar.a;
        float d = y5Var.d(vbVar.c, false);
        ...
        this.e = f14;
        this.h = f16;
        float d10 = y5Var.d(vbVar.c, false);
        rewind();
        float round = Math.round(AndroidUtilities.dpf2(3.3333f));
        ...
        while (max <= min) {
            ...
            float f21 = f15 <= 0.0f ? 0.0f : (vbVar.d[max] / f15) * f14 * 0.6f;
            ...
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(dp, AndroidUtilities.lerp(f16 - max2, f16 - ((f14 + max2) / 2.0f), f13), AndroidUtilities.dpf2(1.66f) + dp, AndroidUtilities.lerp(f16, org.telegram.messenger.y1.a(f14, max2, 2.0f, f16), f13));
            addRoundRect(rectF, this.b, Path.Direction.CW);
            max++;
            f17 = f10;
            f18 = f11;
