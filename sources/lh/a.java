...
public final class a extends FrameLayout {
    ...
    public a(Context context, og.b bVar) {
        ...
        frameLayout.addView(imageView, i7.f6.e(20, 20, 17));
        ...
        frameLayout.addView(imageView2, i7.f6.e(20, 20, 17));
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            org.telegram.ui.b.q(imageView.animate().rotation(z10 ? 0.0f : 180.0f), jr.h, 420L);
        } else {
    ...
    public void setCount(int i10) {
        ...
        if (this.f != i10) {
            ...
            this.n = ofFloat;
            ofFloat.addUpdateListener(new bg.q1(this, 19));
            this.n.addListener(new ag.m0(this, 14));
