        ...
        switch (this.a) {
            ...
            case 2:
                ...
                if (!arrayList2.isEmpty()) {
                    final int i13 = 0;
                    Runnable runnable = new Runnable() { // from class: lh.x6
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i13) {
                                case 0:
                                    ...
                                    while (true) {
                                        ...
                                        if (i14 >= arrayList5.size()) {
                                            ...
                                            billingController.queryProductDetails(arrayList4, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: lh.v5
                                                ...
                                                public final void onProductDetailsResponse(final p2.h hVar, final List list) {
                                                    switch (i15) {
                                                        case 0:
                                                            ...
                                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: lh.x5
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i16 >= arrayList7.size()) {
                                            ...
                                            billingController2.queryProductDetails(arrayList6, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: lh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                                            ...
                                                                            if (hVar22.a != 0) {
                                                                                ...
                                                                                if (list2 != null) {
                                                                                    for (int i1722 = 0; i1722 < list2.size(); i1722++) {
                                                                                        p2.n nVar = (p2.n) list2.get(i1722);
                                                                                        int i182 = 0;
                                                                                        while (true) {
                                ...
                                default:
                                    ...
                                    while (true) {
                                        ...
                                        if (i18 >= arrayList9.size()) {
                                            ...
                                            billingController3.queryProductDetails(arrayList8, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: lh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
            ...
            case 3:
                ...
                if (!arrayList5.isEmpty()) {
                    final int i15 = 1;
                    Runnable runnable2 = new Runnable() { // from class: lh.x6
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i15) {
                                case 0:
                                    ...
                                    while (true) {
                                        ...
                                        if (i142 >= arrayList52.size()) {
                                            ...
                                            billingController.queryProductDetails(arrayList42, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: lh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final p2.h hVar22, final List list) {
                                                    switch (i152) {
                                                        case 0:
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i16 >= arrayList7.size()) {
                                            ...
                                            final int i17 = 2;
                                            final t7 t7Var5 = t7Var4;
                                            billingController2.queryProductDetails(arrayList62, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: lh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final p2.h hVar22, final List list) {
                                                    switch (i17) {
                                                        case 0:
            ...
            case 4:
                ...
                if (!arrayList8.isEmpty()) {
                    final int i17 = 2;
                    Runnable runnable3 = new Runnable() { // from class: lh.x6
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i17) {
                                case 0:
                                                                            ...
                                                                            if (hVar222.a != 0) {
                                                                                ...
                                                                                if (list2 != null) {
                                                                                    for (int i17222 = 0; i17222 < list2.size(); i17222++) {
                                                                                        p2.n nVar = (p2.n) list2.get(i17222);
                                                                                        int i1822 = 0;
                                                                                        while (true) {
                                ...
                                default:
                                    ...
                                    while (true) {
                                        ...
                                        if (i18 >= arrayList92.size()) {
                                            ...
                                            final int i19 = 0;
                                            final t7 t7Var6 = t7Var5;
                                            billingController3.queryProductDetails(arrayList82, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: lh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final p2.h hVar22, final List list) {
                                                    switch (i19) {
                                                        case 0:
