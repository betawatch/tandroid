    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i12) {
            case 0:
                ...
                arrayList.add(j51.j(-1, e6Var.e0));
                if (sendPaidMessagesStars <= 0) {
                    arrayList.add(j51.j(-2, e6Var.p0));
                ...
                if (starGift != null) {
                    if (!starGift.can_upgrade || z12) {
                        ...
                        j51 i14 = j51.i(2, ja.X0(false, LocaleController.formatString(z12 ? R.string.Gift2UpgradeSelf : R.string.Gift2Upgrade, Integer.valueOf((int) starGift.upgrade_stars)), 0.78f, null));
                        i14.K(e6Var.n0);
                        arrayList.add(i14);
                        if (z11) {
                    ...
                    j51 i15 = j51.i(1, LocaleController.getString(z12 ? R.string.Gift2HideSelf : R.string.Gift2Hide));
                    i15.K(e6Var.m0);
                    arrayList.add(i15);
                    if (z12) {
                    ...
                    if (nVar != null && (nVar.c != null || nVar.d != null)) {
                        j51 i17 = j51.i(3, ja.X0(false, LocaleController.formatString(R.string.Gift2MessageStars, Integer.valueOf((int) nVar.g())), 0.78f, null));
                        i17.K(e6Var.o0);
                        arrayList.add(i17);
