...
public final class j6 extends FrameLayout {
    public final int a;
    public int b;
    public final hh.h1 c;
    public final FrameLayout d;
    public final jh.a8 e;
    public boolean f;
    public boolean h;
    ...
    public j6(Activity activity, int i10, jh.b bVar) {
        ...
        a4Var.a.getAvatarDrawable().m(i10, currentUser);
        jh.z3 z3Var = a4Var.a;
        z3Var.e(currentUser, z3Var.getAvatarDrawable());
        a4Var.b.l(Emoji.replaceEmoji(UserObject.getUserName(currentUser), a4Var.b.getPaint().getFontMetricsInt(), false), false);
