...
public final class q1 extends View {
    ...
    public final void a(float f9, o1 o1Var) {
        ...
        this.r.addListener(new jh.l5(this, f9, o1Var, 1));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (xi0Var.X >= xi0Var.e[0]) {
                ...
                xi0Var.setAlpha((int) (q1Var.n * 255.0f));
                xi0Var.draw(canvas2);
            }
            i11++;
        }
        ...
        while (true) {
            ...
            float d = p1Var.i.d(f9, z10);
            float e10 = p1Var.j.e(p1Var.h);
            ...
            p1Var.g.c(AndroidUtilities.dp(18.0f), f15, lerp2, -1, canvas3);
            canvas2 = canvas3;
            canvas2.restore();
            if (xi0Var2 != null) {
                canvas2.save();
