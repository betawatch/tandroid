...
public final class l extends Drawable {
    ...
    public l(int i10) {
        ...
        er erVar = er.h;
        this.f = new org.telegram.ui.Components.y5(cVar, 350L, erVar, 0);
        this.g = new Path();
        this.i = 21.0f;
        this.h = i10;
    ...
    public final void a(Canvas canvas, float f10) {
        ...
        if (e9 > 0.0f) {
            Paint paint = this.b;
            paint.setAlpha((int) (f10 * 255.0f * e9));
            canvas.drawCircle(this.n, this.o, AndroidUtilities.dpf2(11.33f) * e9, paint);
        }
        Paint paint2 = this.a;
        paint2.setAlpha((int) ((1.0f - e9) * Color.alpha(this.l) * f10));
        ...
        if (e9 > 0.0f) {
            Path path = this.g;
            path.rewind();
            path.addCircle(this.n, this.o + AndroidUtilities.dp(1.0f), AndroidUtilities.dpf2(11.33f) * e9, Path.Direction.CW);
