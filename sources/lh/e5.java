...
public final class e5 extends org.telegram.ui.Components.ma {
    ...
    public e5(Context context, long j10, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var);
        float f10;
        int i10;
        this.X = arrayList;
        ...
        float f12 = f11;
        this.U.addView(limitPreviewView, k7.b6.r(-1, -2, 17, f12, 20.0f, f12, 10.0f));
        P(j10);
        ...
        while (i12 < arrayList.size()) {
            if (currentTime <= ((TL_stars.StarGiftUpgradePrice) arrayList.get(i12)).date || ((i10 = i12 + 1) < arrayList.size() && currentTime <= ((TL_stars.StarGiftUpgradePrice) arrayList.get(i10)).date)) {
                ...
                sz0Var.c(LocaleController.getInstance().getFormatterDay().format(date) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date), ja.X0(false, kf.k0.l((int) r13.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
                z4 = true;
            } else {
                f10 = f12;
            }
        ...
        if (!z4) {
            ...
            while (i13 < size) {
                ...
                sz0Var.c(LocaleController.getInstance().getFormatterDay().format(date2) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date2), ja.X0(false, kf.k0.l((int) starGiftUpgradePrice.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
            }
        }
        float f14 = f13 + 14.0f;
        this.U.addView(sz0Var, k7.b6.r(-1, -2, 7, f14, 16.0f, f14, 15.0f));
        ...
        this.U.addView(b12, k7.b6.t(-1, -2, 17, 32, 0, 32, 15));
        ...
        this.V.addView(view, k7.b6.a(-1.0f, 1.0f / AndroidUtilities.density, 55));
        ph.d dVar = new ph.d(getContext(), this.resourcesProvider, true);
        this.W = dVar;
        float f16 = f15 + 16.0f;
        this.V.addView(dVar, k7.b6.d(-1, 48.0f, 119, f16, 16.0f, f16, 16.0f));
        this.containerView.addView(this.V, k7.b6.e(-1, -2, 87));
        rl0 rl0Var = this.d;
        rl0Var.setPadding(rl0Var.getPaddingLeft(), rl0Var.getPaddingTop(), rl0Var.getPaddingRight(), AndroidUtilities.dp(80.0f) + rl0Var.getPaddingBottom());
    ...
    public final void P(long j10) {
        ...
        TL_stars.StarGiftUpgradePrice starGiftUpgradePrice2 = (TL_stars.StarGiftUpgradePrice) kf.k0.i(1, arrayList);
        LimitPreviewView limitPreviewView = this.Y;
        limitPreviewView.J = true;
        Paint paint = limitPreviewView.H;
        int i10 = org.telegram.ui.ActionBar.j6.Oh;
        org.telegram.ui.ActionBar.f6 f6Var = limitPreviewView.P;
        ...
        k6Var2.setTextColor(limitPreviewView.I ? -1 : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, f6Var));
