...
public final /* synthetic */ class u implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.a) {
            ...
            case 6:
                ...
                break;
            default:
                AndroidUtilities.runOnUIThread(new u6((wh0) this.d, tL_error, tLObject, this.c, this.b, (TLRPC.Chat) this.e));
                break;
        }
    }
    ...
    public /* synthetic */ u(wh0 wh0Var, long j10, int i10, TLRPC.Chat chat) {
        this.a = 7;
        this.d = wh0Var;
        this.c = j10;
        this.b = i10;
