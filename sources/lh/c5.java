...
public class c5 extends FrameLayout {
    ...
    public c5(Context context, org.telegram.ui.ActionBar.f6 f6Var, Runnable runnable, View.OnClickListener onClickListener, l1 l1Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        ...
        while (true) {
            ...
            if (i14 == 2) {
                ...
                this.r[i14] = new f90(context, null);
                ...
                this.y[i14] = new f90(context, null);
        ...
        while (true) {
            ...
            if (z4) {
                ...
                if (i13 == 0) {
                    ...
                    f90VarArr[i13].setLayoutParams(layoutParamsArr2[i13]);
                }
            }
            i13++;
        }
    ...
    public final void f(TL_stars.StarGift starGift, boolean z4, boolean z10, boolean z11) {
        ...
        if (z13) {
            ...
            pb1Var.setVisibility(z12 ? 0 : 8);
            ah.e[] eVarArr = this.F;
            if (z12) {
                eVarArr[1].b(z11 ? R.drawable.filled_crown_off : R.drawable.filled_crown_on, LocaleController.getString(z11 ? R.string.Gift2ActionWearOff : R.string.Gift2ActionWear), false);
            }
            float f10 = 1.0f;
            if (starGift.resell_amount != null) {
                ...
                lf.b bVar = lf.b.b;
                lf.a resellAmount = starGift.getResellAmount(z14 ? bVar : lf.b.a);
    ...
    public final void h(int i10, CharSequence charSequence, CharSequence charSequence2, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence3, TLObject tLObject, Spannable spannable) {
        ...
        if (i10 == 0 && !TextUtils.isEmpty(spannableStringBuilder)) {
            ...
            if (i10 == 0) {
                ...
                f90VarArr[i10].setVisibility(TextUtils.isEmpty(charSequence2) ? 8 : 0);
            }
            f90Var.setVisibility(8);
    ...
    public final void k() {
        ...
        f90[] f90VarArr = this.r;
        this.b0 = ((((Math.min(f90VarArr[2].getPaint().measureText(f90VarArr[2].getText().toString()), f90VarArr[2].getWidth()) + f90VarArr[2].getWidth()) / 2.0f) + (f90VarArr[2].getX() + f10)) + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(126.67f) / 2.0f);
    ...
    public void setResellPrice(lf.a aVar) {
        ...
        if (k10) {
            ...
            mr mrVar = mr.h;
            duration.setInterpolator(mrVar).setListener(new a5(this, 2)).setListener(new a5(this, 1)).start();
            f90VarArr[0].animate().alpha(1.0f).setDuration(420L).setInterpolator(mrVar).start();
        } else {
            textView.setText(LocaleController.formatSpannable(R.string.GiftOnSale, ja.U0(aVar.a == lf.b.b, "⭐️ " + ((Object) ja.J0(aVar.o(), 1.0f, ',')), 0.9f, null, 0.0f, 1.0f)));
            ...
            mr mrVar2 = mr.h;
            duration2.setInterpolator(mrVar2).setListener(new a5(this, 0)).start();
            f90VarArr[0].animate().alpha(0.0f).setDuration(420L).setInterpolator(mrVar2).start();
        }
        boolean z4 = this.J;
        ah.e[] eVarArr = this.F;
        if (z4) {
