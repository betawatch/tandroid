...
public class c5 extends FrameLayout {
    ...
    public c5(Context context, org.telegram.ui.ActionBar.f6 f6Var, Runnable runnable, View.OnClickListener onClickListener, l1 l1Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        ...
        while (true) {
            ...
            this.b.addView(this.d[i12], k7.b6.e(-1, -1, 119));
        ...
        k7.d6.a(textView2);
        hb1 hb1Var = new hb1(this, context, 3);
        this.E = hb1Var;
        ...
        while (true) {
            ...
            ah.d dVar = new ah.d(context, 4);
            ImageView imageView = new ImageView(context);
            dVar.b = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
            dVar.addView(imageView, k7.b6.d(24, 24.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
            ...
            dVar.addView(textView3, k7.b6.d(-1, -2.0f, 49, 4.0f, 35.0f, 4.0f, 0.0f));
            dVarArr[i13] = dVar;
            if (i13 == 0) {
            ...
            hb1 hb1Var2 = this.E;
            ah.d[] dVarArr2 = this.F;
            hb1Var2.addView(dVarArr2[i13], k7.b6.p(0, 56, 1.0f, 119, 0, 0, i13 != dVarArr2.length - 1 ? 11 : 0, 0));
            i13++;
        }
        ...
        while (true) {
            ...
            if (i14 == 2) {
                ...
                this.G = frameLayout;
                this.f[i14].addView(frameLayout, k7.b6.q(-1, 144, 119));
                ...
                this.r[i14] = new e90(context, null);
                ...
                e90 e90Var2 = this.r[i14];
                TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
                e90Var2.setEllipsize(truncateAt);
                this.r[i14].setGravity(17);
                frameLayout.addView(this.r[i14], k7.b6.d(-1, -2.0f, 49, 16.0f, 95.33f, 16.0f, 0.0f));
                this.y[i14] = new e90(context, null);
                ...
                frameLayout.addView(this.y[i14], k7.b6.d(-1, -2.0f, 49, 16.0f, 122.0f, 16.0f, 0.0f));
            } else if (i14 == 4) {
                f4 f4Var = new f4(context, f6Var);
                this.I = f4Var;
                this.f[i14].addView(f4Var, k7.b6.n(-1, -2));
                ...
                this.r[i14].setTypeface(AndroidUtilities.bold());
                this.r[i14].setGravity(17);
                this.f[i14].addView(this.r[i14], k7.b6.t(-1, -2, 17, 24, i14 == 3 ? 10 : 0, 24, 0));
                if (i14 == 0) {
                    this.f[i14].addView(this.s, k7.b6.t(-2, -2, 17, 0, 4, 0, 4));
                    this.f[i14].addView(this.v, k7.b6.s(-2, 17, 0, 6, 0, 19.33f, 2));
                }
                if (i14 == 0) {
                    this.y[i14] = new e90(context, null);
                    ...
                    this.y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.y[i14].setDisablePaddingsOffsetY(true);
                    this.x.addView(this.y[i14], k7.b6.e(-2, -2, 17));
                    this.x.addView(this.K, k7.b6.a(-2.0f, 20.33f, 17));
                    ...
                    linearLayout2.addView(e90Var3, t9);
                }
                ...
                this.f[i14].addView(this.C[i14], k7.b6.t(-1, -2, 17, 24, 8, 24, 0));
            }
            if (i14 == 0) {
                this.f[i14].addView(this.E, k7.b6.t(-1, -2, 7, 0, 15, 0, 0));
            }
        ...
        addView(this.b, k7.b6.d(160, 160.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
    ...
    public final void c(Canvas canvas, float f10, float f11, float f12, float f13) {
        ...
        x0.a(canvas, 0, j5VarArr[1], f12, f13, this.R.a(1), this.q0);
        canvas.restore();
    }
        ...
        while (true) {
            ...
            if (z4) {
                ...
                if (i13 == 0) {
                    ...
                    e90VarArr[i13].setLayoutParams(layoutParamsArr2[i13]);
                }
            }
            i13++;
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (max > 0.0f && stargiftattributebackdropArr[0] != null) {
            ...
            ah.d[] dVarArr = c5Var.F;
            int length = dVarArr.length;
            int i12 = 0;
            while (i12 < length) {
                ah.d dVar3 = dVarArr[i12];
                int[] iArr10 = iArr2;
                if (org.telegram.ui.ActionBar.j6.B1(dVar3.getBackground(), iArr10[Utilities.clamp(Math.round((((dVar3.getWidth() / 2.0f) + dVar3.getX()) / c5Var.getWidth()) * (iArr10.length - 1)), iArr10.length - 1, 0)], false)) {
                    dVar3.invalidate();
                }
                i12++;
                iArr2 = iArr10;
            ...
            if (c5Var.R.a(2) > 0.0f) {
                ...
                c5Var.t0.g(rectF2);
                c5Var.t0.d();
                c5Var.t0.a(canvas2, org.telegram.ui.ActionBar.j6.l1(c5Var.R.a(2), -1));
                c5Var.invalidate();
            }
        }
        if (c5Var.R.a(1) > 0.0f) {
    ...
    public final void f(TL_stars.StarGift starGift, boolean z4, boolean z10, boolean z11) {
        ...
        if (z13) {
            ...
            e90VarArr[0].setTextSize(1, 13.0f);
            hb1Var.setVisibility(z12 ? 0 : 8);
            ah.d[] dVarArr = this.F;
            if (z12) {
                dVarArr[1].b(z11 ? R.drawable.filled_crown_off : R.drawable.filled_crown_on, LocaleController.getString(z11 ? R.string.Gift2ActionWearOff : R.string.Gift2ActionWear), false);
            }
            float f10 = 1.0f;
            ...
            if (z4) {
                dVarArr[0].setAlpha(1.0f);
                dVarArr[0].b(R.drawable.filled_gift_transfer, LocaleController.getString(R.string.Gift2ActionTransfer), false);
            } else {
                dVarArr[0].setAlpha(0.5f);
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("L ");
                spannableStringBuilder.setSpan(new mq(R.drawable.msg_mini_lock2, 0), 0, 1, 33);
                spannableStringBuilder.append((CharSequence) LocaleController.getString(R.string.Gift2ActionTransfer));
                dVarArr[0].b(R.drawable.filled_gift_transfer, spannableStringBuilder, false);
            }
            ah.d dVar = dVarArr[1];
            if (!z4 && !z10) {
                f10 = 0.5f;
            ...
            if (z4) {
                ...
                if (arrayList != null) {
                    dVarArr[2].b(R.drawable.filled_gift_sell_off, LocaleController.getString(R.string.Gift2ActionUnlist), false);
                    dVarArr[2].setOnClickListener(onClickListener);
                } else {
                    dVarArr[2].b(R.drawable.filled_gift_sell_on, LocaleController.getString(R.string.Gift2ActionResell), false);
                    dVarArr[2].setOnClickListener(onClickListener);
                }
            } else {
                dVarArr[2].b(R.drawable.filled_share, LocaleController.getString(R.string.Gift2ActionShare), false);
                dVarArr[2].setOnClickListener(this.O);
            }
            this.W = starGift.crafted;
            this.n.a.d(stargiftattributebackdropArr[0], false, true);
        } else {
            stargiftattributebackdropArr[0] = null;
            e90VarArr[0].setTextSize(1, 14.0f);
            this.W = false;
            hb1Var.setVisibility(8);
        }
    ...
    public final void h(int i10, CharSequence charSequence, CharSequence charSequence2, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence3, TLObject tLObject, Spannable spannable) {
        ...
        if (i10 == 0 && !TextUtils.isEmpty(spannableStringBuilder)) {
            ...
            if (i10 == 0) {
                ...
                e90VarArr[i10].setVisibility(8);
            }
        } else if (i10 != 0 || TextUtils.isEmpty(charSequence3)) {
            e90VarArr[i10].setText(charSequence2);
            if (i10 == 0) {
                frameLayout.setVisibility(TextUtils.isEmpty(charSequence2) ? 8 : 0);
            } else {
                e90VarArr[i10].setVisibility(TextUtils.isEmpty(charSequence2) ? 8 : 0);
            }
            e90Var.setVisibility(8);
    ...
    public final void k() {
        ...
        e90[] e90VarArr = this.r;
        this.b0 = ((((Math.min(e90VarArr[2].getPaint().measureText(e90VarArr[2].getText().toString()), e90VarArr[2].getWidth()) + e90VarArr[2].getWidth()) / 2.0f) + (e90VarArr[2].getX() + f10)) + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(126.67f) / 2.0f);
    ...
    public void setPreviewAttributes(f1 f1Var) {
        ...
        if (dVar != null && dVar.b == 1 && isAttachedToWindow()) {
            ...
            gj0 lottieAnimation2 = p9VarArr[this.o0 + 1].getImageReceiver().getLottieAnimation();
    ...
    public void setResellPrice(mf.a aVar) {
        ...
        if (k10) {
            ...
            nr nrVar = nr.h;
            duration.setInterpolator(nrVar).setListener(new a5(this, 2)).setListener(new a5(this, 1)).start();
            e90VarArr[0].animate().alpha(1.0f).setDuration(420L).setInterpolator(nrVar).start();
        } else {
            ...
            nr nrVar2 = nr.h;
            duration2.setInterpolator(nrVar2).setListener(new a5(this, 0)).start();
            e90VarArr[0].animate().alpha(0.0f).setDuration(420L).setInterpolator(nrVar2).start();
        }
        boolean z4 = this.J;
        ah.d[] dVarArr = this.F;
        if (z4) {
            dVarArr[2].b(R.drawable.filled_gift_sell_off, LocaleController.getString(R.string.Gift2ActionUnlist), true);
        } else {
            dVarArr[2].b(R.drawable.filled_gift_sell_on, LocaleController.getString(R.string.Gift2ActionResell), true);
        }
        dVarArr[2].setOnClickListener(this.P);
    }
