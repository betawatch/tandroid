...
public final class t9 extends org.telegram.ui.Components.sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public t9(Context context, org.telegram.ui.ActionBar.f6 f6Var, TLRPC.User user, gg.g2 g2Var) {
            ...
            public final void run() {
                ...
                switch (i11) {
                    case 0:
                        ...
                        break;
                    default:
                        ze.d.s(this.b.getContext(), LocaleController.getString(R.string.StarsTOSLink));
                        break;
                }
            }
        }), true)));
        ...
        f90Var2.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var));
        f90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StarsTOS), new Runnable(this) { // from class: lh.r9
            public final /* synthetic */ t9 b;
    ...
    public static void P(t9 t9Var, int i10) {
        ...
        if (G.d == -1) {
            t9Var.Z = !t9Var.Z;
            w51Var2.N(true);
            t9Var.d.v0(0, AndroidUtilities.dp(200.0f), mr.g);
            return;
        }
