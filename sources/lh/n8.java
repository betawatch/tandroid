...
public final class n8 extends View {
    ...
    public n8(Context context) {
        ...
        this.e = new org.telegram.ui.Components.d6(this, 0L, 260L, jr.h);
        this.n = new Drawable[2];
        this.r = new float[2];
        Paint paint = new Paint(1);
        this.v = paint;
        this.w = new Path();
        this.x = new uc(this, 0.6f, 5.0f);
    ...
    public final void a(boolean z10, r6 r6Var, boolean z11) {
        ...
        this.s = z10;
        this.f = true;
        if (r6Var == null || (c9Var = r6Var.c.E0) == null) {
            this.f = false;
        } else {
            int i10 = c9Var.a;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f) {
            ...
            if (drawable == null || d <= 0.5f) {
                ...
                int A = (int) org.telegram.messenger.x3.A(fArr[1], 2.0f, abs, dpf24);
                float centerY = rectF.centerY();
                float f11 = (fArr[1] / 2.0f) * abs;
                f10 = 0.5f;
                c3 = 0;
                f9 = 12.0f;
                drawable2.setBounds(A, (int) (centerY - f11), (int) (f11 + dpf24), (int) u3.c.c(fArr[1], 2.0f, abs, rectF.centerY()));
            ...
            if (drawableArr[c3] != null && d <= f10) {
                ...
                int A2 = (int) org.telegram.messenger.x3.A(fArr[c3], 2.0f, abs, dpf25);
                float centerY2 = rectF.centerY();
                float f12 = (fArr[c3] / 2.0f) * abs;
                drawable3.setBounds(A2, (int) (centerY2 - f12), (int) (f12 + dpf25), (int) u3.c.c(fArr[c3], 2.0f, abs, rectF.centerY()));
