...
public final class j4 extends pv0 {
        ...
        switch (this.t0) {
            ...
            case 4:
                ...
                if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled() && contactsActivity.r0 != null) {
                    canvas.save();
                    canvas.translate(0.0f, -f10);
                    contactsActivity.r0.I(canvas, rect.left, rect.top + f10, rect.right, rect.bottom + f10);
                    canvas.restore();
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.t0) {
            case 1:
                ...
                if (Build.VERSION.SDK_INT >= 31 && eVar != null) {
                    ...
                    if (dVar2 != null && !dVar2.n) {
                        ...
                        a2.drawColor(l9Var.getThemedColor(k6.a7));
                    ...
                    if (dVar != null && !dVar.n) {
                        ...
                        a10.drawColor(l9Var.getThemedColor(k6.a7));
                        if (SharedConfig.chatBlurEnabled()) {
                            eVar.b(a10, -2);
                        }
                        dVar.c();
            ...
            case 4:
                ContactsActivity contactsActivity = (ContactsActivity) this.u0;
                tg.d dVar3 = contactsActivity.s0;
                tg.d dVar4 = contactsActivity.r0;
                og.e eVar2 = contactsActivity.q0;
                if (Build.VERSION.SDK_INT >= 31 && eVar2 != null) {
                    ...
                    if (dVar4 != null && !dVar4.n) {
                        ...
                        a11.drawColor(contactsActivity.getThemedColor(k6.d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            eVar2.b(a11, -3);
                        }
                        dVar4.c();
                    ...
                    if (dVar3 != null && !dVar3.n) {
                        ...
                        a12.drawColor(contactsActivity.getThemedColor(k6.d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            eVar2.b(a12, -2);
                        }
                        dVar3.c();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.t0) {
            case 2:
                if (motionEvent.getY() < ((sb0) this.u0).Q) {
                    return false;
                }
    ...
    public Drawable getNewDrawable() {
        switch (this.t0) {
            case 2:
                Drawable d = ((vn) ((sb0) this.u0).W.C).d();
                if (d == null) {
                    break;
                }
                break;
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        switch (this.t0) {
            ...
            case 4:
                ...
                break;
            case 5:
                ob0 ob0Var = (ob0) this.u0;
                int scrollY = ob0Var.G.getScrollY();
                super.onLayout(z4, i10, i11, i12, i13);
                if (scrollY != ob0Var.G.getScrollY()) {
                    ob0Var.G.setTranslationY(r11.getScrollY() - scrollY);
                    ob0Var.G.animate().cancel();
                    ob0Var.G.animate().translationY(0.0f).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.r1.w).start();
                    break;
                }
                break;
            case 7:
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.t0) {
            ...
            case 5:
                ...
                ob0Var.E.setVisibility(this.f > AndroidUtilities.dp(20.0f) ? 8 : 0);
                break;
            case 6:
                og0 og0Var = (og0) this.u0;
                ViewGroup.MarginLayoutParams marginLayoutParams6 = (ViewGroup.MarginLayoutParams) og0Var.K.getLayoutParams();
                int dp = og0Var.h1() ? AndroidUtilities.dp(226.0f) : 0;
                ...
                ((ViewGroup.MarginLayoutParams) og0Var.R.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i13;
                ((ViewGroup.MarginLayoutParams) og0Var.T.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i13;
                ((ViewGroup.MarginLayoutParams) og0Var.S.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i13;
                TextView textView = og0Var.c0;
                if (textView != null) {
                    ((ViewGroup.MarginLayoutParams) textView.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i13;
                }
                if (R() > AndroidUtilities.dp(20.0f) && og0Var.c.getVisibility() != 8 && !AndroidUtilities.isAccessibilityTouchExplorationEnabled() && !og0Var.X) {
                    ValueAnimator valueAnimator = og0Var.d;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                    }
                    og0Var.c.setVisibility(8);
                }
                super.onMeasure(i10, i11);
                break;
            case 7:
