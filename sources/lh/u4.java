...
public final /* synthetic */ class u4 implements Runnable {
    ...
    public final /* synthetic */ zf.j c;

    public /* synthetic */ u4(f6 f6Var, zf.j jVar, int i10) {
        this.a = i10;
        this.b = f6Var;
        this.c = jVar;
    }
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (!z10) {
                    ...
                    final int i10 = 0;
                    textView.setOnClickListener(new View.OnClickListener() { // from class: lh.z4
                        ...
                        public final void onClick(View view) {
                            ...
                            switch (i10) {
                                ...
                                case 1:
                                    ...
                                    f6Var3.getClass();
                                    try {
                                        ((zf.v2) jVar4).getEditText().onTextContextMenuItem(android.R.id.pasteAsPlainText);
                                    } catch (Exception e9) {
                                        FileLog.e(e9);
                                    }
                                ...
                                default:
                                    ...
                                    zf.j jVar7 = jVar;
                                    if (jVar7 != null) {
                                        PointF Q0 = f6Var9.Q0(jVar7);
                                        if (jVar7 instanceof zf.o2) {
                                            zf.j o2Var = new zf.o2(f6Var9.getContext(), (zf.o2) jVar7, Q0);
                                            o2Var.setDelegate(f6Var9);
                                            z5Var2.addView(o2Var);
                                            f6Var9.g0();
                                            jVar2 = o2Var;
                                        } else if (jVar7 instanceof zf.v2) {
                                            zf.v2 v2Var = new zf.v2(f6Var9.getContext(), (zf.v2) jVar7, Q0);
                ...
                if (jVar instanceof zf.v2) {
                    ...
                    if ((!i5Var.c() || i5Var.d) && f6Var.p2 <= 0) {
                        textView2.setTag(1);
                        textView2.setText(LocaleController.getString(R.string.PaintEdit));
                        final int i11 = 2;
                        textView2.setOnClickListener(new View.OnClickListener() { // from class: lh.z4
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                zf.j jVar2;
                                switch (i11) {
                    ...
                    TextView h02 = f6Var.h0(1, LocaleController.getString(R.string.PaintEdit));
                    final int i13 = 3;
                    h02.setOnClickListener(new View.OnClickListener() { // from class: lh.z4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            zf.j jVar2;
                            switch (i13) {
                    ...
                    linearLayout.addView(h02, h7.z5.n(-2, 44));
                } else if (jVar instanceof zf.p0) {
                    TextView h03 = f6Var.h0(1, LocaleController.getString(R.string.PaintEdit));
                    final int i14 = 4;
                    h03.setOnClickListener(new View.OnClickListener() { // from class: lh.z4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            zf.j jVar2;
                            switch (i14) {
                    ...
                    linearLayout.addView(h03, h7.z5.n(-2, 44));
                }
                if ((jVar instanceof zf.o2) || (jVar instanceof zf.c2) || (jVar instanceof zf.x1) || (jVar instanceof zf.b2)) {
                    TextView h04 = f6Var.h0(4, LocaleController.getString(R.string.Flip));
                    final int i15 = 5;
                    h04.setOnClickListener(new View.OnClickListener() { // from class: lh.z4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            zf.j jVar2;
                            switch (i15) {
                    ...
                    linearLayout.addView(h04, h7.z5.n(-2, 44));
                }
                ...
                if (z5Var.indexOfChild(jVar) != z5Var.getChildCount() - 1 && !(jVar instanceof zf.b2)) {
                    ...
                    final int i16 = 6;
                    textView3.setOnClickListener(new View.OnClickListener() { // from class: lh.z4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            zf.j jVar2;
                            switch (i16) {
                                case 0:
                                    zf.j jVar3 = jVar;
                                    boolean z112 = jVar3 instanceof zf.c2;
                                    f6 f6Var2 = f6Var;
                                    if (z112) {
                                        ib ibVar = ((va) f6Var2).w2.Y0;
                                        if (ibVar != null) {
                    ...
                    final int i17 = 7;
                    textView4.setOnClickListener(new View.OnClickListener() { // from class: lh.z4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            zf.j jVar2;
                            switch (i17) {
                ...
                while (i18 < linearLayout.getChildCount()) {
                    ...
                    int v02 = org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.i6, t5Var);
                    int i19 = 8;
                    int i20 = i18 == 0 ? 8 : 0;
