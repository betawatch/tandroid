    ...
    public final void a(Canvas canvas, o4 o4Var, float f10, float f11, float f12, int[] iArr, int[] iArr2, int[] iArr3) {
        if (o4Var != null) {
            ...
            for (int i10 = 0; i10 < iArr.length; i10++) {
                ...
                iArr[i10] = org.telegram.ui.ActionBar.j6.v(iArr[i10], org.telegram.ui.ActionBar.j6.l1(clamp01 * ((width < f15 || width > f16) ? 0.0f : Math.min(Utilities.clamp01((width - f15) / max), Utilities.clamp01(1.0f - ((width - (f16 - max)) / max)))), o4Var.g));
            }
            for (int i11 = 0; i11 < iArr2.length; i11++) {
                float width2 = (getWidth() / (iArr2.length - 1)) * i11;
                iArr2[i11] = org.telegram.ui.ActionBar.j6.v(iArr2[i11], org.telegram.ui.ActionBar.j6.l1(clamp01 * ((width2 < f15 || width2 > f16) ? 0.0f : Math.min(Utilities.clamp01((width2 - f15) / max), Utilities.clamp01(1.0f - ((width2 - (f16 - max)) / max)))), o4Var.f));
            }
            for (int i12 = 0; i12 < iArr3.length; i12++) {
                float width3 = (getWidth() / (iArr2.length - 1)) * i12;
                iArr3[i12] = org.telegram.ui.ActionBar.j6.v(iArr3[i12], org.telegram.ui.ActionBar.j6.l1(clamp01 * ((width3 < f15 || width3 > f16) ? 0.0f : Math.min(Utilities.clamp01((width3 - f15) / max), Utilities.clamp01(1.0f - ((width3 - (f16 - max)) / max)))), o4Var.h));
            }
        }
    }
