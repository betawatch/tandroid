...
public final class a2 extends rq {
    ...
    public static void c(Path path, float f10, final boolean z4) {
        Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: lh.z1
        ...
        float f13 = l.d.f((Float) callbackReturn.run(Float.valueOf(46.56f)), f10);
        float dp = AndroidUtilities.dp(48.28f * f10);
        Float valueOf = Float.valueOf(48.0f);
        path.cubicTo(f13, dp, l.d.f((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(47.68f * f10), l.d.f((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(46.5f * f10));
    ...
    public final void d(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop, boolean z4, boolean z10) {
        ...
        if (stargiftattributebackdrop == null) {
            ...
            paint.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f), new int[]{k6.b(z11 ? 0.07f : 0.05f, (z11 ? -0.15f : -0.1f) - (z10 ? 0.125f : 0.0f), stargiftattributebackdrop.center_color | (-16777216)), k6.b(z11 ? 0.07f : 0.05f, (z11 ? -0.15f : -0.1f) - (z10 ? 0.125f : 0.0f), stargiftattributebackdrop.edge_color | (-16777216))}, new float[]{z11 ? 1.0f : 0.0f, z11 ? 0.0f : 1.0f}, Shader.TileMode.CLAMP));
        }
    }
    ...
    public final void e(int i10, CharSequence charSequence, boolean z4) {
        this.b = new l01(charSequence, i10, z4 ? AndroidUtilities.bold() : null);
    }
}
