...
public final class u1 extends Drawable {
    ...
    public u1(ViewGroup viewGroup, g6 g6Var, boolean z4) {
        ...
        this.q = paint3;
        this.r = new org.telegram.ui.Components.z5(new eh.m(this, 28), 320L, pr.h);
    ...
    public final void a(boolean z4) {
        if (this.t != z4) {
            ...
            Paint paint = this.c;
            if (z4) {
                paint.setShadowLayer(AndroidUtilities.dp(1.66f), 0.0f, AndroidUtilities.dp(0.33f), k6.v0(k6.a6, this.b));
            } else {
    ...
    */
    public final void b(Canvas canvas, float f10) {
        ...
        int i11 = k6.a6;
        g6 g6Var2 = this.b;
        final int v02 = k6.v0(i11, g6Var2);
        int i12 = k6.d6;
        final int v03 = k6.v0(i12, g6Var2);
        final int i13 = 0;
        boolean z10 = this.s == ((float) AndroidUtilities.dp(11.0f)) && v02 == k6.w0(null, i11, false) && v03 == k6.w0(null, i12, false);
        boolean z11 = this.g;
        a(z11 && !z10);
        if (z10) {
            if (C == null) {
            ...
            if (this.h != null) {
                if (z11) {
                    ...
                    if (b2Var.b == null || b2Var.h != v02) {
                        ...
                        b2Var.b = c8.b(bitmapArr, fArr, dp, dp2, 0, new ug.e() { // from class: ug.d
                            @Override // ug.e
                    ...
                    lf.r.h(ninePatchDrawable2, rect);
                ...
                if (z11) {
                    ...
                    if (b2Var2.f == null || (b2Var2.j != v03 && b2Var2.k != v02)) {
                        ...
                        b2Var2.f = c8.b(bitmapArr2, fArr2, dp3, dp4, v03, new ug.e() { // from class: ug.d
                            @Override // ug.e
                    ...
                    if (b2Var3.d == null || b2Var3.i != v03) {
                        ...
                        b2Var3.d = c8.b(b2Var3.c, b2Var3.g, 0.0f, 0.0f, v03, new ug.e() { // from class: ug.d
                            @Override // ug.e
                            public final void a(Canvas canvas3, RectF rectF2, float[] fArr22) {
                                Path path = new Path();
                                path.addRoundRect(rectF2, fArr22, Path.Direction.CW);
        ...
        if (this.h == null || t1Var.d()) {
                ...
                if (drawable != null && t1Var.d.c == 1.0f && (drawable instanceof org.telegram.ui.Components.l5)) {
                    ...
                    if (z2Var != null) {
                        ...
                        if (bitmap != null) {
                            ...
                            if (f10 < 1.0f) {
                                bitmap2 = bitmap;
                                mh.w0.b(canvas2, 2, this.A, bitmap2, bounds.width(), bounds.height(), 1.0f - f10);
                            } else {
                                bitmap2 = bitmap;
                            }
                            if (f10 > 0.0f) {
                                canvas2.translate(0.0f, AndroidUtilities.dp(-31.0f));
                                mh.w0.b(canvas2, 0, this.A, bitmap2, bounds.width(), bounds.height(), f10);
                            }
                            canvas2 = canvas;
                            canvas2.restore();
                        }
            ...
            if (f10 < f11) {
                canvas2 = canvas;
                mh.w0.a(canvas2, 2, t1Var, bounds.width(), bounds.height(), f11 - f10, 1.0f);
            } else {
                canvas2 = canvas;
            }
            if (f10 > 0.0f) {
                canvas2.translate(0.0f, AndroidUtilities.dp(-31.0f));
                mh.w0.a(canvas2, 0, t1Var, bounds.width(), bounds.height(), f10, 1.0f);
            }
            canvas2.restore();
        }
        if (z12) {
        ...
        if (e6 > 0.0f) {
            ...
            if (i17 == 0) {
                Integer num = this.x;
                paint4.setColor(num != null ? num.intValue() : k6.v0(this.w, g6Var));
                paint4.setStrokeWidth(AndroidUtilities.lerp(0.0f, AndroidUtilities.dpf2(1.667f), e6));
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(rectF);
                float lerp2 = AndroidUtilities.lerp(-AndroidUtilities.dpf2(2.33f), AndroidUtilities.dpf2(3.33f), e6);
                rectF2.inset(lerp2, lerp2);
                float lerp3 = AndroidUtilities.lerp(this.s, AndroidUtilities.dpf2(7.33f), e6);
            ...
            if (i17 == 1) {
                Integer num2 = this.x;
                paint4.setColor(num2 != null ? num2.intValue() : k6.v0(this.w, g6Var3));
                paint4.setStrokeWidth(AndroidUtilities.lerp(0.0f, AndroidUtilities.dpf2(3.0f), e6));
                RectF rectF3 = AndroidUtilities.rectTmp;
                rectF3.set(rectF);
                float lerp4 = AndroidUtilities.lerp(0.0f, AndroidUtilities.dpf2(3.0f) / 2.0f, e6);
                rectF3.inset(lerp4, lerp4);
                float lerp5 = AndroidUtilities.lerp(this.s, AndroidUtilities.dpf2(10.0f), e6);
