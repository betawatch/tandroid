...
public final class r2 {
    ...
    public r2(Context context, WindowManager windowManager, View view, WindowManager.LayoutParams layoutParams) {
        ...
        this.f = view;
        this.g = layoutParams;
        this.b = new o2(this, context, 0);
        this.c = new o2(this, context, 1);
        paint.setAlpha(0);
    }
    ...
    public final void e(float f10, long j10, Runnable runnable) {
        ...
        this.i.addListener(new hh.n5(this, f10, runnable, 2));
        this.i.setDuration(j10);
        this.i.setInterpolator(er.i);
        this.i.start();
    }
    ...
    public final void g() {
        ...
        int i11 = this.n;
        o2 o2Var = this.b;
        if (i10 == i11 && this.j == o2Var.getMeasuredWidth() && this.k == o2Var.getMeasuredHeight() && Math.abs(this.m - this.h) <= 0.005f) {
            return;
        }
        this.l = this.n;
        this.j = o2Var.getMeasuredWidth();
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            this.r = new RadialGradient(this.j * 0.5f, this.k * 0.4f, (2.0f - this.h) * (Math.min(r1, r11) / 2.0f) * 1.35f, new int[]{i0.b.k(this.n, 0), this.n}, new float[]{AndroidUtilities.lerp(0.9f, 0.22f, this.h), 1.0f}, Shader.TileMode.CLAMP);
        }
