...
public final class s4 extends FrameLayout {
    ...
    public s4(c5 c5Var, Context context) {
        ...
        final int i12 = 0;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: lh.p4
        ...
        final int i13 = 1;
        textView2.setOnClickListener(new View.OnClickListener(this) { // from class: lh.p4
            public final /* synthetic */ s4 b;
        ...
        final int i14 = 2;
        linearLayout2.setOnClickListener(new View.OnClickListener(this) { // from class: lh.p4
            public final /* synthetic */ s4 b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.x.P) {
            ...
            if (f11 != 1.0f) {
                ...
                f9 = AndroidUtilities.lerp(this.h, f9, this.r);
