...
public final class vb {
    ...
    public vb(cc ccVar, String str, int i10) {
        this.l = ccVar;
        this.a = new org.telegram.ui.Components.y5(ccVar, 0L, 600L, er.h);
        int i11 = 0;
        ...
        int min = Math.min(Math.round((((this.h * 1000) / Math.min(ccVar.h != null ? r8.e : !ccVar.s.isEmpty() ? ccVar.getBaseDuration() : ccVar.A ? ccVar.D : this.h * 1000, ccVar.getMaxScrollDuration())) * i10) / Math.round(AndroidUtilities.dpf2(3.3333f))), 4000);
        this.b = min;
        ...
        if ("audio/mpeg".equals(str2) || "audio/mp3".equals(str2) || "audio/mp4a".equals(str2) || MediaController.AUDIO_MIME_TYPE.equals(str2)) {
            this.k = new FfmpegAudioWaveformLoader(str, min, new a8(this, 2));
        } else {
