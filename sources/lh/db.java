...
public final class db extends View {
    ...
    public void setSenders(ArrayList<xa> arrayList) {
        ...
        while (i12 < arrayList3.size()) {
            ...
            long j10 = xaVar3.d;
            Paint paint = r92.h;
            r92.o = new k01(ja.R0(kh.a2.l(j10, ',', new StringBuilder("⭐️")), 0.85f, mqVarArr), 12.0f, AndroidUtilities.getTypeface("fonts/num.otf"));
            boolean z12 = dbVar.a;
            int i15 = ebVar.c;
            if (z12) {
                int i16 = (int) j10;
            ...
            if (this.a) {
                int i17 = i12 + 1;
                r92.v = i17;
                r92.u = new k01(kh.a2.j(i17, ""), 10.0f, AndroidUtilities.getTypeface("fonts/num.otf"));
                if (i17 > 0 && r92.s == null) {
