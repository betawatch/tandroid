...
public final class db extends View {
    ...
    public db(eb ebVar, Context context, boolean z4) {
        ...
        this.d = paint;
        this.e = new org.telegram.ui.Components.z5(this, 0L, 320L, mr.h);
        this.a = z4;
        paint.setStyle(Paint.Style.FILL_AND_STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(3.0f));
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.h5, ebVar.b));
    }
    ...
    /* JADX WARN: Type inference failed for: r9v5, types: [lh.cb] */
    /* JADX WARN: Type inference failed for: r9v6, types: [java.lang.Object, lh.cb] */
    /* JADX WARN: Type inference failed for: r9v7, types: [java.lang.Object, lh.cb] */
    /* JADX WARN: Type inference failed for: r9v9, types: [lh.cb] */
    public void setSenders(ArrayList<xa> arrayList) {
        ...
        while (i12 < arrayList3.size()) {
            ...
            long j10 = xaVar3.d;
            Paint paint = r92.h;
            r92.o = new k01(ja.R0(kf.k0.l(j10, ',', new StringBuilder("⭐️")), 0.85f, lqVarArr), 12.0f, AndroidUtilities.getTypeface("fonts/num.otf"));
            boolean z12 = dbVar.a;
            int i15 = ebVar.c;
            if (z12) {
                int i16 = (int) j10;
                r92.f = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(16.0f), new int[]{nh.t.b(i15, i16, 4), nh.t.b(i15, i16, 3)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
                r92.r = i0.a.d(0.5f, nh.t.b(i15, i16, 4), nh.t.b(i15, i16, 3));
            ...
            if (this.a) {
                int i17 = i12 + 1;
                r92.v = i17;
                r92.u = new k01(kf.k0.j(i17, ""), 10.0f, AndroidUtilities.getTypeface("fonts/num.otf"));
                if (i17 > 0 && r92.s == null) {
                    ...
                    r92.t = mutate2;
                    mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.h5, ebVar.b), mode));
                }
            }
            if (xaVar3.b) {
                r92.b(this.r.B);
