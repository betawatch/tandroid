...
public final class u9 extends m20 {
    public final /* synthetic */ int H0 = 0;
    public final c5.e I0;
    public final /* synthetic */ n20 J0;
    ...
    @Override // org.telegram.ui.Components.pc0, r0.m
            ...
            case 0:
                ...
                if (viewGroup == jaVar.c && jaVar.O.isAttachedToWindow()) {
                    ...
                    if (i11 >= 0) {
                        if (!z4) {
                            if (i11 > 0) {
                                rl0 currentListView = jaVar.O.getCurrentListView();
                            ...
                            rl0 currentListView2 = jaVar.O.getCurrentListView();
                            iArr[1] = i11;
                            if (top > 0) {
                                iArr[1] = 0;
                            }
                        ...
                        if ((jaVar.c.getHeight() - jaVar.c.getPaddingBottom()) - bottom >= 0) {
                            rl0 currentListView3 = jaVar.O.getCurrentListView();
            ...
            default:
                ...
                if (viewGroup == gVar.c && gVar.O.isAttachedToWindow()) {
                    ...
                    if (i11 >= 0) {
                        if (!z11) {
                            if (i11 > 0) {
                                rl0 currentListView4 = gVar.O.getCurrentListView();
                            ...
                            rl0 currentListView5 = gVar.O.getCurrentListView();
                            iArr[1] = i11;
                            if (top3 > 0) {
                                iArr[1] = 0;
                            }
                        ...
                        if (gVar.c.getHeight() - bottom2 >= 0) {
                            rl0 currentListView6 = gVar.O.getCurrentListView();
                            int L02 = ((f2.i0) currentListView6.getLayoutManager()).L0();
                            if (L02 != -1) {
                                f2.l1 K2 = currentListView6.K(L02);
    ...
    @Override // org.telegram.ui.Components.pc0, r0.n
    public final void i(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        switch (this.H0) {
            ...
            default:
                ...
                try {
                    if (viewGroup == gVar.c && gVar.O.isAttachedToWindow()) {
                        rl0 currentListView2 = gVar.O.getCurrentListView();
    ...
    @Override // org.telegram.ui.Components.pc0, android.view.ViewGroup, android.view.ViewParent
