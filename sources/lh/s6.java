...
public final class s6 {
    ...
    public s6(int i10) {
        ...
        f7 f7Var2 = this.k;
        f7Var2.b.getStorageQueue().postRunnable(new r3(12, f7Var2, new v5(this, 0)));
        this.K = new bg.f(this, i10, 9);
        this.w = new nh.a1(i10);
    }
    ...
    public final k6 A(long j10, int i10, int i11, boolean z10) {
        if (i10 == 0 && i11 > 0) {
            ...
            k6 k6Var2 = new k6(this.a, j10, i10, i11, new ag.i0(this, 27));
        ...
        if (i10 == 4) {
            ...
            c6 c6Var = new c6(this.a, j10, null, new ag.i0(this, 27));
            hashMap4.put(valueOf2, c6Var);
            return c6Var;
        }
        HashMap hashMap5 = hashMapArr[i10];
        Long valueOf3 = Long.valueOf(j10);
        k6 k6Var4 = new k6(this.a, j10, i10, i11, new ag.i0(this, 27));
    ...
    public final g6 B(long j10, boolean z10) {
        ...
        g6 g6Var2 = new g6(this.a, j10, this);
        hVar.k(g6Var2, j10);
        return g6Var2;
    }
    ...
    public final void P() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_contacts_getBlocked, new r5(this, 3));
    }
    ...
    public final void Q(boolean z10) {
        ...
        if ((z10 || !this.q) && !this.n) {
            ...
            ConnectionsManager.getInstance(this.a).sendRequest(tL_stories_getAllStories, new y5(this, z10, tL_stories_getAllStories, z11));
        }
    }
    ...
    public final void R() {
        ...
        this.U = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stories.TL_stories_getChatsToSend(), new r5(this, 2));
    }
    ...
    public final void S(final TL_stories.PeerStories peerStories, final boolean z10) {
        ...
        if (arrayList != null) {
            ...
            ConnectionsManager.getInstance(i11).sendRequest(tL_stories_getStoriesByID, new RequestDelegate() { // from class: lh.t5
    ...
    public final void T() {
        if (this.A) {
            ...
            f7 f7Var = this.k;
            f7Var.b.getStorageQueue().postRunnable(new r3(13, f7Var, v5Var));
        } else {
            Q(false);
            Q(true);
        }
    ...
    public final void Y(TL_stories.TL_stories_allStories tL_stories_allStories, boolean z10, boolean z11, boolean z12) {
        ...
        if (!z11) {
            ...
            f7 f7Var = this.k;
            f7Var.b.getStorageQueue().postRunnable(new ag.z0(f7Var, arrayList4, z12, z10, o0Var, 3));
        }
        bg.f fVar = this.K;
    ...
    public final void Z(TL_stories.TL_updateStory tL_updateStory) {
        ...
        if (peerDialogId > 0) {
            ...
            if (user != null && (M(user) || user.self)) {
                f7Var.b.getStorageQueue().postRunnable(new r3(11, f7Var, tL_updateStory));
            }
        } else {
            f7Var.b.getStorageQueue().postRunnable(new r3(11, f7Var, tL_updateStory));
            user = null;
    ...
    public final void b(int i10, long j10, ArrayList arrayList) {
        ...
        while (i14 < size3) {
            ...
            i14++;
            k6 A2 = s6Var.A(B.b, 0, ((l6) obj3).a, false);
            if (A2 != null) {
    ...
    public final void d0(long j10, int i10, f5.d dVar) {
        ...
        if (y8 != null) {
            for (int i11 = 0; i11 < y8.stories.size(); i11++) {
                if (y8.stories.get(i11).id == i10 && !(y8.stories.get(i11) instanceof TL_stories.TL_storyItemSkipped)) {
    ...
    public final void k0(long j10, List list) {
        ...
        while (i10 < size) {
            ...
            i10++;
            k6 A3 = s6Var.A(j10, 0, ((l6) obj).a, false);
            if (A3 != null) {
                A3.A(list);
            }
            s6Var = this;
    ...
    public final void l0(long j10, List list, boolean z10) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                ...
                if (peerStories.stories.get(i12).id == storyItem.id) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        j7.l1.t(storyItem.id, new StringBuilder("StoriesController update story for full peer storyId="));
                    }
                } else {
                    i12++;
                }
            ...
            if (!z11) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    j7.l1.t(storyItem.id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z10) {
                    j7.l1.t(storyItem.id, new StringBuilder("StoriesController add new story for full peer storyId="));
    ...
    */
    ...
    public final void n0(long j10, List list, boolean z10) {
        ...
        while (i10 < size2) {
            int i12 = i10 + 1;
            k6 A3 = s6Var.A(j10, 0, ((l6) arrayList.get(i10)).a, false);
            if (A3 != null) {
                A3.D(list, z10);
            }
            s6Var = this;
    ...
    public final m6 o() {
        ...
        TL_stories.PeerStories y8 = y(UserConfig.getInstance(i10).getClientUserId());
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_stories_canSendStory, new r5(this, 1), 1024);
        return null;
    }
    ...
    public final void o0(long j10, ArrayList arrayList, boolean z10, c3 c3Var) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (!(storyItem instanceof TL_stories.TL_storyItemDeleted)) {
                ...
                if (y8 != null) {
                    for (int i11 = 0; i11 < y8.stories.size(); i11++) {
                        if (y8.stories.get(i11).id == storyItem.id) {
    ...
    public final void q() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stories.TL_stories_getAllReadPeerStories(), new r5(this, 0));
    }
    ...
    public final void s(long j10, ArrayList arrayList) {
        ...
        f7 f7Var = this.k;
        f7Var.b.getStorageQueue().postRunnable(new g5.v(f7Var, arrayList2, j10, 8));
        NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.storiesUpdated, new Object[0]);
    }
    ...
    public final int x(long j10) {
        ...
        return y8 != null ? Math.max(y8.max_read_id, this.f.get(j10, 0)) : this.f.get(j10, 0);
    }
