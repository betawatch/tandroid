...
public final /* synthetic */ class i6 implements Runnable {
    ...
    public /* synthetic */ i6(t7 t7Var, boolean[] zArr, TL_stars.StarGift starGift, boolean z4, boolean z10, long j10, TLRPC.TL_textWithEntities tL_textWithEntities, kh.r5 r5Var) {
        this.e = t7Var;
        this.f = zArr;
        this.h = starGift;
        this.b = z4;
    ...
    */
    public final void run() {
        ...
        switch (i11) {
            case 0:
                ((boolean[]) obj2)[0] = true;
                ((t7) obj3).i((TL_stars.StarGift) tLObject2, this.b, this.d, this.c, (TLRPC.TL_textWithEntities) tLObject, (kh.r5) obj);
                break;
            default:
                ...
                org.telegram.ui.web.q0 q0Var = (org.telegram.ui.web.q0) obj;
                nh.b bVar = daVar.a;
                int i12 = daVar.c;
                if (!(tLObject3 instanceof TLRPC.Updates)) {
                    if (tL_error != null) {
                        if (!tL_error.text.startsWith("STORY_LIVE_ALREADY_")) {
                            ph.e8 e8Var = daVar.n0;
                            if (e8Var != null) {
                                new qc(e8Var.container, bVar).d0(tL_error, true);
                                q0Var.run();
                                break;
                            }
                        } else {
                            ...
                            if (storyItem != null) {
                                ...
                                if (messageMedia instanceof TLRPC.TL_messageMediaVideoStream) {
                                    ...
                                    if (inputGroupCall != null) {
                                        ...
                                        AndroidUtilities.runOnUIThread(new jw(daVar, this.b, storyItem, this.c, inputGroupCall, this.d), 100L);
                                        break;
                                    }
                                }
                            }
    ...
    public /* synthetic */ i6(ph.da daVar, TLObject tLObject, TL_stories.TL_startLive tL_startLive, boolean z4, long j10, boolean z10, TLRPC.TL_error tL_error, org.telegram.ui.web.q0 q0Var) {
        this.e = daVar;
        this.f = tLObject;
        this.h = tL_startLive;
        this.b = z4;
