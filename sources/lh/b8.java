...
public final /* synthetic */ class b8 implements RequestDelegate {
    ...
    public /* synthetic */ b8(int i10, zh0 zh0Var, org.telegram.ui.ActionBar.o2 o2Var, TLRPC.TL_payments_assignPlayMarketTransaction tL_payments_assignPlayMarketTransaction) {
        this.a = 6;
        this.b = i10;
        this.c = zh0Var;
        this.d = o2Var;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            case 0:
                ...
                break;
            case 1:
                AndroidUtilities.runOnUIThread(new jf.j0((d70) obj3, (org.telegram.ui.k4) obj2, tL_error, tLObject, this.b, (org.telegram.ui.g1) obj));
                break;
            case 2:
                ...
                if (tL_error != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new bg.j3(sharedPreferences, (TLRPC.TL_help_support) tLObject, c2Var, this.b, o2Var, 17));
                    break;
                }
            case 3:
                AndroidUtilities.runOnUIThread(new bg.j3((as) obj3, tLObject, (TLRPC.InputPeer) obj2, this.b, (int[]) obj, 18));
                break;
            case 4:
                qu0 qu0Var = (qu0) obj3;
            ...
            case 5:
                ...
                AndroidUtilities.runOnUIThread(new bg.j3((LaunchActivity) obj3, tLObject, (Uri) obj2, this.b, (org.telegram.ui.ActionBar.c2) obj, 20), 2L);
                break;
            case 6:
                zh0 zh0Var = (zh0) obj3;
                ...
                break;
            case 7:
                AndroidUtilities.runOnUIThread(new jf.j0((org.telegram.ui.web.z0) obj3, (String) obj2, tLObject, tL_error, this.b, (org.telegram.ui.web.w0) obj));
                break;
            default:
                AndroidUtilities.runOnUIThread(new bg.j3(tLObject, (boolean[]) obj3, (Utilities.Callback) obj2, this.b, (TL_account.updateEmojiStatus) obj, 27));
                break;
        }
    }

    public /* synthetic */ b8(Object obj, int i10, TLRPC.TL_messages_getAttachedStickers tL_messages_getAttachedStickers, jf.i0 i0Var) {
        this.a = 0;
        this.c = obj;
        this.b = i10;
