...
public final class q extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public q(int i10, long j10) {
        super(null);
        this.r = je.a("XTR", LocaleController.getString(R.string.BotStarsOverviewAvailableBalance));
        this.s = je.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalBalance));
        this.v = je.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalProceeds));
        this.w = je.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewAvailable));
        this.x = je.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewLastWithdrawal));
        this.y = je.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewTotal));
        this.K = false;
        this.L = true;
        this.Q = new lq[1];
        this.e0 = false;
    ...
    public static void W(q qVar, i51 i51Var) {
        if (i51Var.G(da.class)) {
            ...
            me.h0(qVar.getParentActivity(), qVar.currentAccount, (TL_stats.BroadcastRevenueTransaction) i51Var.G, qVar.b, qVar.resourceProvider);
        } else if (i51Var.d == 2) {
            qVar.presentFragment(new rh.d3(qVar.b));
        }
    }
    ...
    public static void Y(q qVar, ArrayList arrayList) {
        ...
        if (i13 == 0) {
            ...
            if (h != null && (tL_starsRevenueStatus2 = h.status) != null) {
                ...
                double d11 = qVar.W;
                jeVar5.j = (long) (d10 * d11 * 100.0d);
                jeVar4.a = false;
                jeVar4.g = true;
                jeVar4.i = tL_starsRevenueStatus2.current_balance;
                jeVar4.h = "XTR";
                jeVar4.j = (long) (r9.amount * d11 * 100.0d);
                jeVar4.f = "USD";
                jeVar3.a = false;
                jeVar3.g = true;
                jeVar3.i = tL_starsRevenueStatus2.overall_revenue;
                jeVar3.h = "XTR";
                jeVar3.j = (long) (r9.amount * d11 * 100.0d);
                jeVar3.f = "USD";
        ...
        if (i13 == 1) {
            ...
            if (aa1Var != null && !aa1Var.l) {
                arrayList.add(i51.h(5, i12, aa1Var));
                arrayList.add(i51.A(-1, null));
            }
            if (qVar.d0 != null || j11 == null) {
                ...
                i10 = 2;
                qVar.d0 = oa1.f0(statsGraph, LocaleController.getString(R.string.BotMonetizationGraphRevenue), 2, false);
            }
            aa1 aa1Var2 = qVar.d0;
            if (aa1Var2 != null && !aa1Var2.l) {
                arrayList.add(i51.h(i10, i12, aa1Var2));
            ...
            if (!qVar.b0 && j11 != null && (tL_starsRevenueStatus = j11.status) != null) {
                ...
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(me.f0("TON " + qVar.i0.format(d13), qVar.T.getPaint(), 0.9f, 0.0f, true));
            ...
            if (qVar.b0) {
                ...
                if (qVar.Z == null) {
                    qVar.Z = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.BotMonetizationProceedsTONInfo), -1, 3, new ah.b(qVar, R.string.BotMonetizationProceedsTONInfoLink, i14), qVar.resourceProvider), true);
                }
    ...
    public final View createView(Context context) {
        ...
        ynVar2.i(org.telegram.ui.ActionBar.j6.w0(null, i10, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Pi, false));
    ...
    public final void g0() {
        ...
        if (h != null) {
            ...
            if (f02 != null && (bVar = f02.d) != null && (arrayList = bVar.d) != null && !arrayList.isEmpty() && this.n.d.d.get(0) != null) {
                aa1 aa1Var = this.n;
                aa1Var.h = true;
                ((wf.a) aa1Var.d.d.get(0)).g = org.telegram.ui.ActionBar.j6.yj;
