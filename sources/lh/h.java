    ...
    public final void run(Object obj) {
        ...
        switch (i10) {
            case 0:
                ...
                new d(sVar.getContext(), (g6) obj2, sVar.i0, (List) obj).show();
                break;
            case 1:
                f0 f0Var = (f0) obj4;
                g6 g6Var = (g6) obj2;
                ...
                ((boolean[]) obj3)[0] = false;
                if (f0Var.j0 != null) {
                    new d(f0Var.getContext(), g6Var, f0Var.j0, list).show();
                    f0Var.dismiss();
                    break;
                }
                break;
            ...
            case 3:
                ...
                if (tL_error == null) {
                    ...
                    AndroidUtilities.runOnUIThread(new mh.m2(i12, g5Var2, tL_error));
                    break;
                }
            case 4:
                ...
                ov ovVar = new ov(((i9) obj3).f, n3Var.getContext(), (g6) obj2, arrayList2);
                oh.z3 z3Var = n3Var.w0.N1;
                if (z3Var != null) {
                    ((z8) z3Var).h(ovVar);
                    break;
                }
            ...
            case 5:
                ...
                oh.f4 f4Var = y3Var.l;
                if ((storyItem instanceof oh.c6) && (d6Var = ((oh.c6) storyItem).a) != null) {
                    ...
                    tL_stories_getStoriesByID.peer = MessagesController.getInstance(f4Var.z2).getInputPeer(storyItem.dialogId);
                    tL_stories_getStoriesByID.id.add(Integer.valueOf(storyItem.id));
                    ConnectionsManager.getInstance(f4Var.z2).sendRequest(tL_stories_getStoriesByID, new hg.y(y3Var, storyItem, callback));
                    break;
                }
                break;
            case 6:
                m6 m6Var = (m6) obj;
                oh.f4 f4Var2 = ((oh.y3) obj4).l;
                f4Var2.P1.c(m6Var.a, f4Var2.y1, (TL_stories.StoryItem) obj3);
                new qc(f4Var2.Z0, (g6) obj2).Q(R.raw.contact_check, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.StoryAddedToAlbumX, m6Var.b))).j();
                break;
            case 7:
            ...
            case 9:
                ...
                while (i11 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(kyVar.a.C.Z0).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
            ...
            case 11:
                ...
                if (user != null) {
                    ...
                    ConnectionsManager.getInstance(a1Var.J).sendRequestTyped(tL_messages_sendBotRequestedPeer, new org.telegram.messenger.a(), new a0(a1Var, str, user, 8));
