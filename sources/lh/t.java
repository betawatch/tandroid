...
public final /* synthetic */ class t implements Utilities.Callback2 {
    ...
    public /* synthetic */ t(int i10, long j10, TLRPC.Photo photo, Context context, oh.b bVar) {
        this.b = i10;
        this.c = j10;
        this.e = photo;
        this.d = context;
            ...
            case 0:
                ...
                if (auction != null) {
                    ...
                    if (j12 != peerDialogId && j12 != 0 && peerDialogId != 0) {
                        ...
                        f10.addView(new mh.f5(context, chat, user), k7.c6.t(-1, -2, 48, 0, -4, 0, 0));
                        TextView textView = new TextView(context);
                        NotificationCenter.listenEmojiLoading(textView);
                        textView.setText(LocaleController.getString(R.string.Gift2AuctionsChangeRecipient));
                        int i12 = k6.j5;
                        org.telegram.ui.b.w(i12, g6Var, textView, 1, 20.0f);
                        textView.setGravity(LocaleController.isRTL ? 5 : 3);
                        f10.addView(textView, k7.c6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 24.0f, 19.0f, 24.0f, 2.0f));
                        TextView textView2 = new TextView(context);
                        org.telegram.ui.b.l(i12, g6Var, textView2, 1, 16.0f);
    ...
    public /* synthetic */ t(Context context, g6 g6Var, int i10, long j10, Runnable runnable) {
        this.d = context;
        this.e = g6Var;
        this.b = i10;
        this.c = j10;
