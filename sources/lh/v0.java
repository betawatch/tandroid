...
public final /* synthetic */ class v0 implements NativeInstance.PayloadCallback, RequestDelegateTimestamp, NativeInstance.VideoSourcesCallback, NativeInstance.RequestBroadcastPartCallback, NativeInstance.RequestCurrentTimeCallback {
    ...
    public void run(long j10, int[] iArr) {
        ...
        getgroupparticipants.call = d1Var.f;
        getgroupparticipants.offset = "";
        int i10 = 0;
        while (i10 < iArr.length) {
            i10 = th.d(iArr[i10], i10, 1, getgroupparticipants.sources);
        }
        ConnectionsManager.getInstance(d1Var.e).sendRequest(getgroupparticipants, new eg.d0(d1Var, iArr, j10));
    }
        ...
        switch (this.a) {
            case 3:
                ...
                if (d1Var.v != null) {
                    ...
                    tL_inputGroupCallStream.call = d1Var.f;
                    ...
                    AndroidUtilities.runOnUIThread(new ag.v0(d1Var, str2, AccountInstance.getInstance(d1Var.e).getConnectionsManager().sendRequest(tL_upload_getFile, new RequestDelegateTimestamp() { // from class: lh.x0
                        @Override // org.telegram.tgnet.RequestDelegateTimestamp
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error, long j12) {
                            d1 d1Var2 = d1.this;
                            if (d1Var2.w || d1Var2.A == null) {
                                return;
                            }
                            AndroidUtilities.runOnUIThread(new jh.w2(27, d1Var2, str2));
            ...
            default:
                ...
                sb3.append(i10 != 0 ? a4.w.k(i10, i11, ", video_channel = ", ", video_quality = ") : "");
                FileLog.d(sb3.toString());
                AndroidUtilities.runOnUIThread(new a1(i10, i11, 0, j10, this.b));
                break;
        }
    }
    ...
    public void run(long j10) {
        ...
        if (groupCall != null && groupCall.rtmp_stream) {
            ...
            getgroupcallstreamchannels.call = d1Var.f;
            if (d1Var.v == null || d1Var.A == null) {
                return;
            }
            ConnectionsManager.getInstance(i10).sendRequest(getgroupcallstreamchannels, new f3.e(d1Var, j10, 1), 65536, 2, d1Var.h());
            return;
        }
        NativeInstance nativeInstance = d1Var.A;
