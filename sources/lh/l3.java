...
public final class l3 extends a8 {
    ...
    public final void F(org.telegram.ui.Components.y5 y5Var) {
        if (y5Var != null) {
            ...
            mc h = new tc(h3Var, c6Var).h(document, 2, new ih.i(this, this.t0, c6Var, 4));
            if (h == null) {
                return;
            }
            h.a = 1;
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        d4 d4Var = this.v0;
        if (z10) {
            TLRPC.User user = MessagesController.getInstance(d4Var.y2).getUser(Utilities.parseLong(((d51) characterStyle).getURL()));
            if (user != null) {
                MessagesController.getInstance(d4Var.y2).openChatOrProfileWith(user, null, i9Var.f, 0, false);
                return;
            }
            return;
        }
        if (!(characterStyle instanceof a51)) {
            ...
            if (!(characterStyle instanceof z41)) {
                ...
                org.telegram.ui.b.n(R.string.TextCopied, new tc(d4Var.Y0, this.u0));
                return;
            }
        }
        ...
        if (url.startsWith("@")) {
            MessagesController.getInstance(d4Var.y2).openByUserName(lowerCase, i9Var.f, 0, null);
        } else {
            M(0, url, characterStyle, false);
        }
    }
    ...
    public final void H(final URLSpan uRLSpan, final View view, m5 m5Var) {
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() { // from class: lh.k3
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (i10 == 0) {
                    ...
                    new tc(l3Var.v0.Y0, c6Var2).k(false).j();
                }
            }
        };
    ...
    public final void I(v7 v7Var) {
        ...
        if (document != null) {
            ...
            final int i10 = 0;
            F.l(R.drawable.msg_saved, LocaleController.getString(R.string.StoryAudioAddToSavedMessages), new Runnable(this) { // from class: lh.i3
                ...
                public final void run() {
                    switch (i10) {
                        case 0:
                            d4 d4Var2 = this.b.v0;
                            SendMessagesHelper sendMessagesHelper = SendMessagesHelper.getInstance(d4Var2.y2);
                            TLRPC.TL_document tL_document = (TLRPC.TL_document) document;
                            long clientUserId = UserConfig.getInstance(d4Var2.y2).getClientUserId();
                            b4 b4Var = d4Var2.K1;
                        ...
                        default:
                            ...
                            if (MediaController.getInstance().currentSavedMusicList != null && MediaController.getInstance().currentSavedMusicList.dialogId == UserConfig.getInstance(d4Var3.y2).getClientUserId()) {
                                MediaController.getInstance().currentSavedMusicList.add(document2);
                            }
                            ConnectionsManager.getInstance(d4Var3.y2).sendRequest(tL_account_saveMusic, null);
            ...
            final int i11 = 1;
            F.c(R.drawable.msg_tone_add, LocaleController.getString(R.string.StoryAudioAddToProfile), new Runnable(this) { // from class: lh.i3
                public final /* synthetic */ l3 b;
        ...
        if (v7Var.b != null && v7Var.c != null) {
            MessagesController.getInstance(d4Var.y2).getStoriesController().d0(v7Var.b.longValue(), v7Var.c.intValue(), new eg.o1(this, v7Var, i9Var, c6Var, 1));
            return;
        }
    ...
    public final void M(int i10, String str, CharacterStyle characterStyle, boolean z10) {
        ...
        if (z10 || AndroidUtilities.shouldShowUrlInAlert(str)) {
            i9 i9Var = this.t0;
            if (i10 == 0 || i10 == 2) {
                org.telegram.ui.Components.c5.r0(i9Var.f, str, true, true, true, (!(characterStyle instanceof c51) || (h01Var = ((c51) characterStyle).a) == null || (h01Var.a & 1024) == 0) ? false : true, null, null, this.u0);
                return;
            } else {
                if (i10 == 1) {
                    org.telegram.ui.Components.c5.r0(i9Var.f, str, true, true, false, false, null, null, this.u0);
                    return;
                }
                return;
            }
