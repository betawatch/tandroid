...
public final class k0 extends ReplacementSpan {
    ...
    public final zz0 c = new zz0(LocaleController.getString(R.string.LiveStoryBadge), 8.0f, AndroidUtilities.bold());
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f9, int i12, int i13, int i14, Paint paint) {
        ...
        RectF rectF = this.a;
        rectF.set(f9, dp - AndroidUtilities.dp(6.0f), this.c.l() + f9 + AndroidUtilities.dp(8.0f), AndroidUtilities.dp(6.0f) + dp);
        Paint paint2 = this.b;
        paint2.setColor(-572850);
        canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, paint2);
        this.c.c(AndroidUtilities.dp(4.0f) + f9, dp, 1.0f, -1, canvas);
    }
