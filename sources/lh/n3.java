...
public final /* synthetic */ class n3 implements RequestDelegate {
    public final /* synthetic */ int a;
    public final /* synthetic */ boolean b;
    public final /* synthetic */ Object c;

    public /* synthetic */ n3(int i10, Object obj, boolean z10) {
        this.a = i10;
        this.c = obj;
        this.b = z10;
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 6:
                AndroidUtilities.runOnUIThread(new cg.c((xo) obj, tL_error, tLObject, this.b, 10));
                break;
            case 7:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.i3((md0) obj, tL_error, tLObject, z10));
                break;
            case 8:
                AndroidUtilities.runOnUIThread(new cg.c((w60) obj, tL_error, tLObject, this.b, 19));
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new cg.c((km0) obj, tL_error, tLObject, this.b, 20));
                break;
            case 10:
                AndroidUtilities.runOnUIThread(new cg.c((do0) obj, tL_error, tLObject, this.b, 23));
                break;
            case 11:
                aq0 aq0Var = (aq0) obj;
                if (tLObject != null) {
                ...
                break;
            case 12:
                AndroidUtilities.runOnUIThread(new cg.c((zf1) obj, tL_error, tLObject, this.b, 25));
                break;
            default:
