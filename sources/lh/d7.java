...
public abstract class d7 extends FrameLayout {
    ...
    public d7(Context context) {
        ...
        this.b = z7.x(UserConfig.selectedAccount, true);
    ...
    public final void a(boolean z10) {
        ...
        this.y.addListener(new ag.r1(this, 28));
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        c7Var.layout(measuredWidth, dp, c7Var.getMeasuredWidth() + measuredWidth, c7Var.getMeasuredHeight() + dp);
    }
