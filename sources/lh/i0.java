...
public final /* synthetic */ class i0 implements Utilities.Callback2 {
    ...
    public /* synthetic */ i0(int i10, org.telegram.ui.ActionBar.p2 p2Var, ze.c cVar, org.telegram.ui.ActionBar.d2 d2Var) {
        this.a = 0;
        this.b = i10;
        this.c = p2Var;
        this.d = cVar;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.a) {
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new androidx.car.app.utils.c(p2Var, tL_error, cVar, d2Var, 6));
                break;
            case 1:
                ...
                int i10 = this.b;
                if (tL_error2 != null) {
                    AndroidUtilities.runOnUIThread(new cg.v1(g1Var, i10, tL_error2, tL_channels_joinChannel, 8));
                    break;
                } else {
                    boolean z10 = false;
                    ...
                    AndroidUtilities.runOnUIThread(new yt0(g1Var, 5));
                    AndroidUtilities.runOnUIThread(new ah.b(i10, chat, 12), 1000L);
            ...
            case 2:
                org.telegram.ui.Components.f0.Z((org.telegram.ui.Components.f0) this.c, (org.telegram.ui.ActionBar.k5) this.d, this.b, (TLRPC.TL_messages_composeMessageWithAI) this.e, (TLRPC.TL_composedMessageWithAI) obj, (TLRPC.TL_error) obj2);
                break;
            case 3:
                org.telegram.ui.Components.f0.V((org.telegram.ui.Components.f0) this.c, (org.telegram.ui.ActionBar.k5) this.d, this.b, (TLRPC.TL_messages_composeRichMessageWithAI) this.e, (TLRPC.TL_composedRichMessageWithAI) obj, (TLRPC.TL_error) obj2);
                break;
            case 4:
            ...
            case 5:
                ...
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        ...
                        alertDialog$Builder.a.setOnDismissListener(new org.telegram.ui.x5(g3Var, 10));
                        ...
                        if (U != null) {
                            if (str2 != null) {
                                ...
                                if (U instanceof PasskeysActivity) {
                                    ...
                                    ConnectionsManager.getInstance(i13).sendRequestTyped(new TL_account.getPasskeys(), new org.telegram.messenger.a(), new org.telegram.ui.r6(g3Var, passkey, str2, 3));
                                    break;
                                }
                            }
                        }
                    ...
                    if (!(webPage instanceof TLRPC.TL_webPageEmpty)) {
                        if (messageMedia instanceof TLRPC.TL_messageMediaWebPage) {
                            if (webPage instanceof TLRPC.TL_webPagePending) {
                                long j11 = webPage.id;
                                int i14 = this.b;
                                rh.x0 x0Var = new rh.x0(j11, notificationCenterDelegateArr, i14, w0Var);
            ...
            default:
                ...
                if (tL_error3 != null) {
                    ...
                    if (arrayList3.isEmpty()) {
                        kf.k0.v(R.string.CommunityNoChatsToAdd, qc.a0(p2Var2), R.raw.info, 36);
                        break;
                    } else if (arrayList3.isEmpty()) {
                        qc.a0(p2Var2).Q(R.raw.info, 36, "").j();
                        break;
                    } else {
                        p2Var2.showDialog(new sh.i0(p2Var2, 0L, arrayList3, new dg.j3(p2Var2, chat2, this.b, 5)));
                        break;
                    }
                }
                break;
    ...
    public /* synthetic */ i0(org.telegram.ui.ActionBar.d2[] d2VarArr, org.telegram.ui.ActionBar.p2 p2Var, int i10, TLRPC.Chat chat) {
        this.a = 7;
        this.d = d2VarArr;
        this.c = p2Var;
        this.b = i10;
