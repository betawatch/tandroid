...
public final /* synthetic */ class i0 implements Utilities.Callback2 {
    ...
    public /* synthetic */ i0(int i10, org.telegram.ui.ActionBar.p2 p2Var, af.f fVar, org.telegram.ui.ActionBar.d2 d2Var) {
        this.a = 0;
        this.b = i10;
        this.c = p2Var;
        this.d = fVar;
            ...
            case 5:
                ...
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        ...
                        alertDialog$Builder.a.setOnDismissListener(new org.telegram.ui.v5(g3Var, 10));
                        ...
                        if (U != null) {
                            if (str2 != null) {
                                ...
                                if (U instanceof PasskeysActivity) {
                                    ...
                                    ConnectionsManager.getInstance(i13).sendRequestTyped(new TL_account.getPasskeys(), new org.telegram.messenger.a(), new org.telegram.ui.p6(g3Var, passkey, str2, 3));
                                    break;
                                }
                            }
                        }
                    ...
                    if (!(webPage instanceof TLRPC.TL_webPageEmpty)) {
                        if (messageMedia instanceof TLRPC.TL_messageMediaWebPage) {
                            if (webPage instanceof TLRPC.TL_webPagePending) {
                                ...
                                x0Var.run(webPage instanceof TLRPC.TL_webPage ? webPage : null);
                                break;
                            }
                        } else {
                            x0Var.run(null);
    ...
    public /* synthetic */ i0(org.telegram.ui.e1 e1Var, int i10, TLRPC.TL_channels_joinChannel tL_channels_joinChannel, TLRPC.Chat chat) {
        this.a = 1;
        this.c = e1Var;
        this.b = i10;
