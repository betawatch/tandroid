...
public final class v7 {
    ...
    public final uc i = new uc((View) null);
    ...
    public static CharSequence d() {
        ...
        if (charSequenceArr[0] == null) {
            ...
            ((SpannableStringBuilder) y[0]).setSpan(iqVar, 0, 1, 33);
        }
        return y[0];
    }
    ...
    public final void a(Canvas canvas, float f9) {
        if (this.n == null) {
            ...
            this.n = new zz0(charSequence, document != null ? 12.0f : 14.0f, document != null ? null : AndroidUtilities.bold());
        }
        if (this.o == null || this.m) {
            String str = this.l;
            this.o = new zz0(str != null ? str : "", 14.0f, null);
        }
        float e10 = this.h.e(this.f);
        Paint paint = this.t;
        paint.setColor(TLObject.FLAG_30);
        int min = (int) Math.min(f9, Math.max(this.n.c, this.o.c) + AndroidUtilities.lerp(AndroidUtilities.dp(20.0f), AndroidUtilities.dp(18.0f), e10));
        this.x = min;
        ...
        zz0 zz0Var2 = this.o;
        zz0Var2.p = f12;
        zz0Var2.c(AndroidUtilities.dp(10.0f), AndroidUtilities.dp(30.0f), f11, -1, canvas);
        canvas.restore();
    }
    ...
    public final void c() {
        ...
        this.q = true;
        MessagesController.getInstance(this.a).getStoriesController().d0(this.b.longValue(), this.c.intValue(), new kg.i(this, 3));
    }
