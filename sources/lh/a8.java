...
public class a8 extends NestedScrollView implements i70 {
    ...
    public a8(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        o1.k kVar = new o1.k(z7Var, o1.i.n, 0.0f);
        this.T = kVar;
        kVar.u.b(100.0f);
        kVar.j = 1.0f;
    ...
    public final void C() {
        if (this.r0) {
            ...
            ofFloat.addUpdateListener(new t7(this, scrollY, f9, 0));
    ...
    public final void D(boolean z10) {
        if (!this.r0 || z10) {
            ...
            float f9 = this.U.w;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            ofFloat.addUpdateListener(new t7(this, scrollY, f9, 1));
            ofFloat.setDuration(250L);
            ofFloat.setInterpolator(jr.f);
            ofFloat.start();
        }
    ...
    */
    public final void L(int i10, int i11) {
        ...
        if (i10 != 0 && i11 != 0) {
            ...
            if (this.i0 != hashCode || this.j0 != hashCode2 || this.k0 != hashCode3 || this.h0 != z10 || this.l0 != i11 || z7Var.D) {
                this.i0 = hashCode;
                this.j0 = hashCode2;
                this.k0 = hashCode3;
                this.h0 = z10;
                ...
                i12 = AndroidUtilities.lerp(a2, y7Var2 != null ? y7Var2.a(i11) : 0, z7Var.C);
                if (i12 < 0) {
                    ((ViewGroup.MarginLayoutParams) this.n0.getLayoutParams()).topMargin = i12;
                    this.m0 = -1;
                    return;
                }
                return;
    ...
    public final void a(RectF rectF) {
        ...
        float f9 = z7Var.A;
        float lerp = (AndroidUtilities.lerp(y7Var.m, y7Var.l, z7Var.w) + z7Var.B) - z7Var.r[0].p.b();
        float width = getWidth() - z7Var.A;
        int i10 = z7Var.B;
        y7 y7Var2 = z7Var.r[0];
        rectF.set(f9, lerp, width, AndroidUtilities.lerp(y7Var2.m, y7Var2.l, z7Var.w) + i10);
    ...
    public final void b(Canvas canvas, float f9) {
        ...
        canvas.translate(x10, (y8 + AndroidUtilities.lerp(y7Var2.m, y7Var2.l, z7Var.w)) - y7VarArr2[0].p.b());
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.clipRect(0, scrollY, width, this.q0 + i10);
    ...
    public int getPendingMarginTopDiff() {
        int i10 = this.m0;
        if (i10 >= 0) {
            return i10 - ((ViewGroup.MarginLayoutParams) this.n0.getLayoutParams()).topMargin;
        }
        return 0;
    }
    ...
    public final void h(int i10, int i11, int i12, int i13, int[] iArr, int i14, int[] iArr2) {
        float f9;
        if (i13 != 0) {
            int round = Math.round((1.0f - Math.abs((-this.W) / this.n0.getTop())) * i13);
            if (round != 0) {
                boolean z10 = this.V;
                z7 z7Var = this.U;
                if (z10) {
                    float f10 = this.W - round;
                    this.W = f10;
                    z7Var.setTranslationY(f10);
                } else if (!this.T.f) {
