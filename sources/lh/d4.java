...
public final class d4 extends FrameLayout {
    ...
    public final void a(TL_stars.StarGift starGift, boolean z4) {
        ...
        if (starGift != null) {
            ...
            String G0 = rh.j.G0(starGift.craft_chance_permille);
    ...
    public final void b(final boolean z4, boolean z10) {
        ...
        mr mrVar = mr.h;
        final int i10 = 0;
        alpha.setInterpolator(mrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: lh.c4
        ...
        final int i11 = 1;
        textView.animate().alpha(z4 ? 1.0f : 0.0f).setInterpolator(mrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: lh.c4
            public final /* synthetic */ d4 b;
        ...
        final int i12 = 2;
        frameLayout2.animate().alpha(z4 ? 1.0f : 0.0f).setInterpolator(mrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: lh.c4
            public final /* synthetic */ d4 b;
