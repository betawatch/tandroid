...
public final class b5 {
    ...
    public final void c() {
        ...
        if (z10) {
            ...
            final int i11 = 0;
            int sendRequest = ConnectionsManager.getInstance(i10).sendRequest(tL_getStoryReactionsList, new RequestDelegate(this) { // from class: lh.z4
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    switch (i11) {
                        case 0:
                            ...
                            final int[] iArr = r2;
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: lh.a5
                                            ...
                                            if (iArr[0] != b5Var2.o) {
                                                ...
                                                if (tLObject2 != null) {
                                                    ...
                                                    if (i16 > storyViews.views_count) {
                                                        ...
                                                        for (int i17 = 0; i17 < Math.min(3, storyViewsList.users.size()); i17 = a4.w.g(storyViewsList.users.get(i17).id, storyItem2.views.recent_viewers, i17, 1)) {
                                                        }
        ...
        final int i12 = 1;
        int sendRequest2 = ConnectionsManager.getInstance(i10).sendRequest(tL_stories_getStoryViewsList, new RequestDelegate(this) { // from class: lh.z4
            public final /* synthetic */ b5 b;
