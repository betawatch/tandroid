    ...
    public final void run() {
        switch (this.a) {
            ...
            case 12:
                ...
                if (n4Var.D0 != 0) {
                    ...
                    if (tLObject != null) {
                        ...
                        if (!tL_contacts_resolvedPeer.users.isEmpty()) {
                            n4Var.P(this.b, tL_contacts_resolvedPeer.users.get(0));
                            break;
                        }
                    }
                }
                break;
            case 13:
                ((org.telegram.ui.r6) this.d).run(Float.valueOf(((int[]) this.e)[0] / this.c), Boolean.valueOf(System.currentTimeMillis() - this.b > 250));
                break;
            default:
