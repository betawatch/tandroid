...
public final class f5 extends View {
    ...
    public f5(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity);
        this.c = new xd.a(this, mr.h, 380L);
        this.b = new Paint(1);
        this.d = f6Var;
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.a) {
            ...
            default:
                ...
                float f11 = ((xd.a) this.c).e;
                float f12 = 1.0f - f11;
                if (f12 > 0.0f) {
                    kf.r.b(canvas, (g51) this.e, f12 * 1.35f);
                    invalidate();
                }
                if (f11 > 0.0f) {
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.a) {
            case 2:
                ...
                kf.r.d((g51) this.e, i10 / 2.0f, i11 / 2.0f, 17);
                break;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                break;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.a) {
            case 2:
                return super.verifyDrawable(drawable) || (drawable == ((g51) this.e) && !((xd.a) this.c).f);
            default:
    ...
    public f5(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.e = new RectF();
        paint2.setColor(-1);
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.d6, f6Var));
