...
public final class r0 extends a6.a {
    ...
    public r0(byte[][] bArr) {
        z5.l.b(bArr != null);
        z5.l.b(1 == ((bArr.length & 1) ^ 1));
        int i10 = 0;
        while (i10 < bArr.length) {
            z5.l.b(i10 == 0 || bArr[i10] != null);
            int i11 = i10 + 1;
            z5.l.b(bArr[i11] != null);
            int length = bArr[i11].length;
            z5.l.b(length == 32 || length == 64);
            i10 += 2;
        }
        this.a = bArr;
    }
    ...
    */
    ...
    public static byte[] f(JSONObject jSONObject) {
        ...
        return !jSONObject.has("second") ? d : z6.a.j(d, d(g6.b.b(jSONObject.getString("second"))));
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        com.google.android.gms.internal.cast.o.d(parcel, 1, this.a);
