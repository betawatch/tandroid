...
public final class v extends a6.a {
    ...
    */
    public static v b(JSONObject jSONObject) {
        ...
        b0 b0Var = new b0(jSONObject3.getString("name"), g6.b.b(jSONObject3.getString("id")), jSONObject3.has("icon") ? jSONObject3.optString("icon") : null, jSONObject3.optString("displayName"));
        byte[] b11 = g6.b.b(jSONObject.getString("challenge"));
        z5.l.h(b11);
        ...
        for (int i11 = 0; i11 < jSONArray3.length(); i11++) {
            ...
            try {
                dVar = new z6.e(new x(jSONObject4.getString(TeXSymbolParser.TYPE_ATTR), jSONObject4.getInt("alg")));
        ...
        if (jSONObject.has("extensions")) {
            ...
            if (!jSONObject7.has("prf")) {
                ...
                if (jSONObject7.has("prfAlreadyHashed")) {
                    ...
                    o0 o0Var = !jSONObject7.has("google_silentVerificationExtension") ? new o0(jSONObject7.getJSONObject("google_silentVerificationExtension").getBoolean("silentVerification")) : null;
    ...
    public final boolean equals(Object obj) {
        ...
        List list2 = vVar.d;
        List list3 = vVar.f;
        if (z5.l.l(this.a, vVar.a) && z5.l.l(this.b, vVar.b) && Arrays.equals(this.c, vVar.c) && z5.l.l(this.e, vVar.e)) {
            List list4 = this.d;
            if (list4.containsAll(list2) && list2.containsAll(list4) && ((((list = this.f) == null && list3 == null) || (list != null && list3 != null && list.containsAll(list3) && list3.containsAll(list))) && z5.l.l(this.h, vVar.h) && z5.l.l(this.n, vVar.n) && z5.l.l(this.r, vVar.r) && z5.l.l(this.s, vVar.s) && z5.l.l(this.v, vVar.v) && z5.l.l(this.w, vVar.w))) {
                return true;
            }
        }
        return false;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        com.google.android.gms.internal.cast.o.p(parcel, 7, this.f);
        com.google.android.gms.internal.cast.o.k(parcel, 8, this.h, i10);
        com.google.android.gms.internal.cast.o.i(parcel, 9, this.n);
        com.google.android.gms.internal.cast.o.k(parcel, 10, this.r, i10);
        e eVar = this.s;
        com.google.android.gms.internal.cast.o.l(parcel, 11, eVar == null ? null : eVar.a);
