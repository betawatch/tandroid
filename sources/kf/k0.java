...
public abstract /* synthetic */ class k0 {
    ...
    public static void C(int i10, AlertDialog$Builder alertDialog$Builder, c2 c2Var) {
        alertDialog$Builder.k(LocaleController.getString(i10), c2Var);
        alertDialog$Builder.o();
    }

    public static void D(o3.j jVar, o3.j jVar2) {
        if (jVar == jVar2) {
            return;
        }
        if (jVar2 != null) {
    ...
    public static void u(int i10, AlertDialog$Builder alertDialog$Builder, c2 c2Var) {
