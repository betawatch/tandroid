...
public final /* synthetic */ class i0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            case 0:
                AndroidUtilities.runOnUIThread(new j0(tLObject, this.b, (TLRPC.PhotoSize) obj4, (TLRPC.PhotoSize) obj2, (bj) obj, (e5) obj3, 0));
                break;
            case 1:
            ...
            case 4:
                ...
                break;
            case 5:
                AndroidUtilities.runOnUIThread(new j0(tLObject, this.b, (d2) obj4, (Context) obj2, (f6) obj, (q60) obj3, 7));
                break;
            case 6:
                AndroidUtilities.runOnUIThread(new l2(tL_error, tLObject, (ArrayList) obj4, this.b, (AtomicInteger) obj2, (ArrayList) obj, (tq) obj3, 6));
                break;
            case 7:
                AndroidUtilities.runOnUIThread(new j0((wg0) obj4, (Integer[]) obj2, this.b, tLObject, (ArrayList) obj, (TLRPC.PollAnswerVoters) obj3));
                break;
            case 8:
                ...
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new j0((ps) obj4, (TLRPC.FileLocation) obj2, (TLRPC.InputFile) obj, tLObject, (TLRPC.FileLocation) obj3, this.b));
                break;
            case 10:
                AndroidUtilities.runOnUIThread(new l2((d2) obj4, (ze.c) obj2, tLObject, this.b, (Context) obj, (TLRPC.TL_inputGroupCallSlug) obj3, tL_error, 8));
                break;
            case 11:
                Pattern pattern = LaunchActivity.y1;
                AndroidUtilities.runOnUIThread(new l2((LaunchActivity) obj4, tL_error, tLObject, (TLRPC.TL_inputInvoiceSlug) obj2, (w10) obj, this.b, (String) obj3, 10));
                break;
            case 12:
                Pattern pattern2 = LaunchActivity.y1;
                AndroidUtilities.runOnUIThread(new l2((LaunchActivity) obj4, tL_error, tLObject, this.b, (d2) obj2, (w10) obj, (String) obj3));
                break;
            case 13:
                AndroidUtilities.runOnUIThread(new l2((c1) obj4, (String) obj2, tLObject, tL_error, this.b, (y0) obj, (j7) obj3));
                break;
            default:
                AndroidUtilities.runOnUIThread(new l2((tf.p0) obj4, this.b, (ArrayList) obj2, (a0.h) obj, tL_error, tLObject, (MessagesController) obj3, 15));
                break;
        }
    }
