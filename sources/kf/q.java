...
public abstract class q {
    ...
    public static String c(Spanned spanned) {
        ...
        int i14 = 0;
        while (i14 < length) {
            int nextSpanTransition = spanned.nextSpanTransition(i14, length, aj0.class);
            if (nextSpanTransition < 0) {
                nextSpanTransition = length;
            }
            aj0[] aj0VarArr = (aj0[]) spanned.getSpans(i14, nextSpanTransition, aj0.class);
            if (aj0VarArr != null) {
                for (aj0 aj0Var : aj0VarArr) {
                    sb.append(aj0Var.e ? "<blockquote collapsed>" : "<blockquote>");
                }
            }
            ...
            if (aj0VarArr != null) {
                for (int length2 = aj0VarArr.length - 1; length2 >= 0; length2--) {
