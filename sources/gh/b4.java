...
public final class b4 extends FrameLayout {
    ...
    public b4(Context context, View[] viewArr) {
        super(context);
        this.b = new Matrix();
        ...
        this.y = new float[6];
        this.B = -1;
        this.E = new fh.o1(this, 12);
        setClipToOutline(false);
        setClipToPadding(false);
        android.opengl.Matrix.setIdentityM(fArr, 0);
        this.a = viewArr;
        for (View view : viewArr) {
            addView(view, g7.e6.e(108, 108, 17));
        }
    }
    ...
    public static void b(float f10, float f11, float f12, float[] fArr) {
        ...
        fArr[2] = f17 - f18;
        fArr[6] = f20 + f21;
        fArr[10] = e2.c.x(f13, 0.0f, 0.0f, cos);
        fArr[14] = 0.0f;
        fArr[3] = 0.0f;
        fArr[7] = 0.0f;
        fArr[11] = 0.0f;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (indexOfChild >= 6) {
            ...
            if (view instanceof g4) {
                ...
                g4Var.d.setAlpha(f12);
                g4Var.e.setAlpha(f12);
                if (!z10 || this.A >= 1.0f) {
        ...
        int i10 = 2;
        int i11 = 1;
        float[][] fArr10 = (float[][]) Array.newInstance((Class<?>) Float.TYPE, 4, i9);
        int i12 = 0;
        for (int i13 = 4; i12 < i13; i13 = 4) {
            float f22 = (i12 == i11 || i12 == i10) ? 1.0f : -1.0f;
            float f23 = (i12 == 0 || i12 == i11) ? 1.0f : -1.0f;
            float[] fArr11 = fArr10[i12];
            float[] fArr12 = fArr8;
            float[] fArr13 = fArr9;
            fArr11[0] = e2.c.B(fArr7[0], f23, (fArr9[0] * f22) + fArr8[0], dp);
            fArr11[1] = e2.c.B(fArr7[1], f23, (fArr13[1] * f22) + fArr12[1], dp);
            fArr11[2] = e2.c.B(fArr7[2], f23, (fArr13[2] * f22) + fArr12[2], dp);
            i12++;
            fArr9 = fArr13;
            fArr8 = fArr12;
            i11 = 1;
        ...
        int i14 = 0;
        while (i14 < 4) {
            float[] fArr15 = fArr10[i14];
            float f24 = f21 / (f21 - fArr15[c11]);
            int i15 = i14 * 2;
            fArr14[i15] = (fArr15[0] * f24) + width2;
            fArr14[i15 + 1] = (fArr15[1] * f24) + height;
            i14++;
            c11 = 2;
        }
    ...
    public final void f(int i9, FrameLayout frameLayout) {
        if (i9 == -1) {
            i9 = 5;
        }
        AndroidUtilities.removeFromParent(frameLayout);
        int childCount = getChildCount();
        addView(frameLayout, g7.e6.e(64, 64, 17));
        this.v.add(Integer.valueOf(i9));
        this.w.put(Integer.valueOf(childCount), Integer.valueOf(i9));
    }
