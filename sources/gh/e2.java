...
public final class e2 extends fq {
    ...
    public static void c(Path path, float f10, final boolean z10) {
        Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: gh.d2
        ...
        float g10 = com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(Float.valueOf(46.56f)), f10);
        float dp = AndroidUtilities.dp(48.28f * f10);
        Float valueOf = Float.valueOf(48.0f);
        path.cubicTo(g10, dp, com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(47.68f * f10), com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(46.5f * f10));
        path.cubicTo(com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(45.31f * f10), com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(28.38f * f10), com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(27.32f * f10));
        path.cubicTo(com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(26.26f * f10), com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(Float.valueOf(47.5f)), f10), AndroidUtilities.dp(25.24f * f10), com.google.android.recaptcha.internal.a.g((Float) callbackReturn.run(Float.valueOf(46.82f)), f10), AndroidUtilities.dp(f11));
        path.close();
    }
    ...
    public final void e(int i10, CharSequence charSequence, boolean z10) {
        this.b = new pz0(charSequence, i10, z10 ? AndroidUtilities.bold() : null);
    }
}
