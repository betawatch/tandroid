    ...
    public final void R() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                boolean z13 = z12 || Math.abs(fArr4[i9] - kbVar.d) > 0.001f;
                float f10 = kbVar.d;
                float f11 = kbVar.c;
                float f12 = kbVar.b;
                float f13 = kbVar.a;
                fArr4[i9] = f10;
                boolean z14 = z13 || Math.abs(fArr3[i9] - f13) > 0.001f;
                fArr3[i9] = f13;
                boolean z15 = z14 || Math.abs(fArr2[i9] - f12) > 0.001f;
                fArr2[i9] = f12;
                z12 = z15 || Math.abs(fArr[i9] - f11) > 0.001f;
                fArr[i9] = f11;
                i9++;
            }
