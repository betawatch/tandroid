...
public final class k extends Drawable {
    ...
    public static void a(View view, Layout layout, int i10, int i11, Spanned spanned, Stack stack, List list, ArrayList arrayList) {
        ...
        i01[] i01VarArr = (i01[]) spanned.getSpans(0, layout.getText().length(), i01.class);
        for (int i14 = 0; i14 < Math.min(100, i01VarArr.length); i14++) {
            if (i01VarArr[i14].c()) {
                int spanStart = spanned.getSpanStart(i01VarArr[i14]);
                int spanEnd = spanned.getSpanEnd(i01VarArr[i14]);
                if (i10 == -1 && i11 == -1) {
    ...
    public static void g(View view, boolean z10, int i10, int i11, AtomicReference atomicReference, int i12, Layout layout, List list, Canvas canvas, boolean z11) {
        ...
        boolean z12 = ((k) list.get(i16)).n != -1.0f;
        if (z12) {
        ...
        while (it2.hasNext()) {
            ...
            kVar.p = false;
            if (z13) {
                kVar.h(i0.a.d(Math.max(0.0f, kVar.n), i10, (i12 == 1 ? layout.getPaint() : g6.o2).getColor()));
            } else {
                kVar.h(i10);
            }
            kVar.draw(canvas);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (lVarArr[0] == null) {
            ...
            i10 = 128;
            mVar.a(new Canvas((Bitmap) lVarArr[0].b), new Rect(0, 0, i11, i11));
            mVar.g.setShader((BitmapShader) lVarArr[0].c);
    ...
    public final void e(Path path) {
        path.addCircle(this.k, this.l, w.a(this.n, 0.0f, 1.0f) * this.m, Path.Direction.CW);
    }
    ...
    public final void j(float f9, float f10, float f11, boolean z10) {
        ...
        ValueAnimator duration = ValueAnimator.ofFloat(this.n, z10 ? 0.0f : 1.0f).setDuration((long) w.a(this.m * 0.3f, 250.0f, 550.0f));
        this.r = duration;
        duration.setInterpolator(this.t);
        this.r.addUpdateListener(new b(this, alpha, 0));
        this.r.addListener(new m0(this, 7));
        this.r.start();
        invalidateSelf();
    }
