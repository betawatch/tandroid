...
public final class e extends FrameLayout {
    ...
    public e(Context context, GiftAuctionController.Auction auction) {
        ...
        this.e = paint;
        this.f = new gf.q(new a1.c(this, 25));
    ...
    public final void b(boolean z10) {
        ...
        String m10 = i0.a.m(auction.auctionUserState.bid_amount, ',', new StringBuilder("⭐️"));
        boolean isOutbid = auction.getBidStatus().isOutbid();
        cq[] cqVarArr = this.n;
        org.telegram.ui.Components.j6 j6Var = this.c;
        if (isOutbid) {
            j6Var.c(oa.X0(false, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveBidOutbid, m10)), 0.66f, cqVarArr), z10, true);
            j6Var.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.q7, false));
        } else {
            j6Var.c(oa.X0(false, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveBidActive, m10, Integer.valueOf(auction.getApproximatedMyPlace()))), 0.66f, cqVarArr), z10, true);
            j6Var.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.G6, false));
        }
    }
