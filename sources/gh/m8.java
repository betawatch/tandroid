...
public final /* synthetic */ class m8 implements Runnable {
    ...
    public /* synthetic */ m8(MessagesController messagesController, TLRPC.Chat chat, boolean z10, int i9, q0.a aVar) {
        this.a = 1;
        ...
        switch (this.a) {
            case 0:
                ...
                if (document != null) {
                    ...
                    MediaDataController.getInstance(i9).loadStickersByEmojiOrName(str, false, tL_messages_stickerSet == null);
                    break;
                }
                break;
            case 1:
            ...
            case 2:
                ...
                int i12 = hsVar.J;
                if (this.c == hsVar.Z && TextUtils.equals(tL_messages_searchGlobal.q, hsVar.a0)) {
                    hsVar.V = false;
                    if (!this.b) {
                        arrayList.clear();
                    }
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        ...
                        while (i13 < size) {
                            ...
                            messageObject.setQuery(hsVar.a0);
            ...
            case 3:
                ...
                int i14 = jsVar.J;
                if (this.c == jsVar.W && TextUtils.equals(tL_messages_searchGlobal2.q, jsVar.X)) {
                    jsVar.S = false;
                    if (!this.b) {
                        arrayList3.clear();
                    }
            ...
            default:
                ...
                xf.r0 r0Var = (xf.r0) this.e;
                Runnable runnable = (Runnable) this.f;
                boolean z11 = this.b;
                q0Var.d(r0Var, this.c, z11 ? q0Var.h : null);
                if (z11) {
                    q0Var.h = null;
                }
                if (runnable != null) {
    ...
    public /* synthetic */ m8(z41 z41Var, int i9, TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, boolean z10, TLObject tLObject, int i10) {
        this.a = i10;
        this.d = z41Var;
        this.c = i9;
    ...
    public /* synthetic */ m8(xf.q0 q0Var, xf.r0 r0Var, int i9, boolean z10, Runnable runnable) {
        this.a = 4;
        this.d = q0Var;
        this.e = r0Var;
        this.c = i9;
    ...
    public /* synthetic */ m8(boolean z10, int i9, String str, ImageReceiver imageReceiver, boolean[] zArr) {
        this.a = 0;
        this.b = z10;
        this.c = i9;
        this.d = str;
