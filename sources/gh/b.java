...
public final class b extends m41 {
    ...
    public final void bindView(View view, n41 n41Var, boolean z10, b51 b51Var, k51 k51Var) {
        ...
        spannableStringBuilder.setSpan(new org.telegram.ui.Components.t5(auction.giftDocumentId, org.telegram.ui.ActionBar.g6.s2.getFontMetricsInt()), 0, spannableStringBuilder.length(), 33);
        ...
        yy0 yy0Var = new yy0(cVar.getContext(), cVar.a);
        yy0Var.a(spannableStringBuilder).setFilled(true);
        yy0Var.k(LocaleController.getString(R.string.Gift2AuctionsAcquiredRecipient), cVar.b, DialogObject.getPeerDialogId(tL_StarGiftAuctionAcquiredGift.peer), new d5.u(10, cVar, onClickListener));
        yy0Var.f(tL_StarGiftAuctionAcquiredGift.date, LocaleController.getString(R.string.Gift2AuctionsAcquiredDate));
        yy0Var.e(LocaleController.getString(R.string.Gift2AuctionsAcquiredAcceptedBid), spannableStringBuilder2, formatString, null, null);
