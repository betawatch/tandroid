...
public final class b extends Drawable implements DownloadController.FileDownloadProgressListener {
    ...
    public b(int i10, t1 t1Var) {
        ...
        this.e = i10;
        this.d = t1Var;
        this.y = new xd.a(t1Var, pr.h, 380L);
        ...
        if (this.h) {
            ...
            if (this.v || this.n) {
                if (!this.n || this.r) {
                    ...
                    this.x.setColor(i0.a.k(k6.w0(null, this.C.isOutOwner() ? k6.fc : k6.ec, false), 16));
            ...
            if (this.n) {
                ...
                if (this.r) {
                    ...
                    w02 = k6.w0(null, this.C.isOutOwner() ? k6.sb : k6.nd, false);
                }
        ...
        if (messageMedia != null && !(messageMedia instanceof TLRPC.TL_messageMediaEmpty)) {
            ...
            if (messageMedia instanceof TLRPC.TL_messageMediaWebPage) {
                ...
                if (!(messageMedia instanceof TLRPC.TL_messageMediaPhoto)) {
                        ...
                        if (document != null) {
                            ...
                            if (MessageObject.isVideoDocument(tL_messageMediaDocument.document)) {
                                ...
                                if (z11 || isAnimatedStickerDocument) {
                                    imageReceiver.setImage(ImageLocation.getForDocument(document), "36_36", DocumentObject.getSvgThumb(document, k6.lc, 1.0f), document.size, z11 ? "webp" : null, messageObject2, 1);
                                }
                                z10 = false;
                            }
                        }
                    ...
                    this.B.setColors(this.v ? 0 : k6.w0(null, k6.le, false), this.v ? 0 : k6.w0(null, k6.me, false), k6.w0(null, k6.ne, false), k6.w0(null, k6.oe, false));
