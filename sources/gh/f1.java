...
public final /* synthetic */ class f1 implements RequestDelegate {
    ...
    /* JADX WARN: Type inference failed for: r2v18, types: [java.io.Serializable, org.telegram.ui.ActionBar.b2[]] */
        ...
        switch (i10) {
            ...
            case 7:
                ...
                if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && storyItem != null) {
                    FileRefController.getInstance(z7Var.a).requestReference(storyItem, tL_messages_getAttachedStickers, aVar);
                    break;
                } else {
            ...
            case 8:
                ...
                if (tL_error == null) {
                    ...
                    for (int i11 = 0; i11 < tL_messages_exportedChatInvite.users.size(); i11++) {
                        ...
                        if (qbVar.z0 == null) {
                            qbVar.z0 = new HashMap();
                        }
                        qbVar.z0.put(Long.valueOf(user.id), user);
                    }
                } else {
            ...
            case 10:
                ...
                break;
            case 11:
                ex0.q((pr0) obj4, this.c, (TLRPC.TL_messages_getAttachedStickers) obj3, (gg) obj2, tLObject, tL_error);
                break;
            case 12:
    ...
    public /* synthetic */ f1(kb kbVar, TLRPC.TL_chatInviteExported tL_chatInviteExported, boolean[] zArr, org.telegram.ui.ActionBar.b2 b2Var) {
        this.a = 8;
        this.b = kbVar;
