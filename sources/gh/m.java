...
public final class m {
    ...
    public final u[] b = new u[k.C.length];
    public final g9.l[] c = new g9.l[2];
    public int d = 0;
    public final Rect m = new Rect();
    public final af.b n = new af.b(this, 2);
    ...
    public m() {
        ...
        while (true) {
            ...
            uVar.c = new float[Math.max(64, 2)];
            uVar.b = 0;
            uVarArr[i10] = uVar;
            i10++;
        }
    ...
    public final void a(Canvas canvas, Rect rect) {
            ...
            if (Rect.intersects(kVar.getBounds(), rect2)) {
                ...
                if (uVarArr != null) {
                    ...
                    if (length == fArr3.length) {
                        ...
                        int min = (int) Math.min(currentTimeMillis - kVar.j, 34L);
                        ...
                        while (i16 < size) {
                            ...
                            float f23 = f21;
                            float f24 = f15;
                            float min2 = Math.min(eVar.g + f23, eVar.f);
                            eVar.g = min2;
                            float f25 = eVar.a;
                            float f26 = eVar.b;
                            ...
                            if (min2 >= eVar.f || z10) {
                                ...
                                float f27 = eVar.e * f22;
                                eVar.a = (eVar.c * f27) + f25;
                                eVar.b = (eVar.d * f27) + f26;
                                size = i17;
                            }
                            i16++;
                            f21 = f23;
                        ...
                        if (size2 < i15) {
                            ...
                            while (i21 < i19) {
                                ...
                                int i24 = 0;
                                while (true) {
                                    eVar2.a = (Utilities.fastRandom.nextFloat() * width) + f11;
                        ...
                        for (int i36 = 0; i36 < length2; i36++) {
                            ...
                            int i37 = iArr5[i36];
                            int i38 = uVar2.b + i37;
                            float[] fArr6 = (float[]) uVar2.c;
                            if (i38 > fArr6.length) {
                                uVar2.c = Arrays.copyOf((float[]) uVar2.c, Math.max(i38, fArr6.length * 2));
                            }
                            System.arraycopy(fArr5, 0, (float[]) uVar2.c, uVar2.b, i37);
                            uVar2.b += i37;
                        }
                        i14 = i10 + 1;
                        rect2 = rect;
        ...
        for (int i39 = 0; i39 < fArr7.length; i39++) {
            u uVar3 = uVarArr[i39];
            Paint paint = kVar2.a[i39];
            int i40 = uVar3.b;
            if (i40 > 0) {
                canvas.drawPoints((float[]) uVar3.c, 0, i40, paint);
            }
        }
    }
}
