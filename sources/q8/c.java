    ...
    */
        ...
        if (str.equals("com.google.android.googlequicksearchbox") || str.equals("com.google.android.apps.assistant")) {
            if (a() || n6.a(this, str)) {
                ...
                if (this.dbg) {
                    ...
                    StringBuilder sb2 = new StringBuilder(valueOf4.length() + 28);
                    sb2.append("No extra, nothing to check: ");
                    sb2.append(valueOf4);
    ...
    public final void onHandleIntent(Intent intent) {
        ...
        while (true) {
            ...
            boolean z4 = true;
            boolean z10 = !b10 || b.a(this.searchActionVerificationServiceConnection);
            if (this.dbg) {
