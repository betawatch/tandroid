...
public final class l {
    ...
    static {
        ...
        float C = com.google.android.recaptcha.internal.a.C(f18, f18, f18, f18);
        float f19 = 1.0f - C;
        ...
        k = new l(j11, com.google.android.recaptcha.internal.a.B(fArr8[2], 0.05f, (fArr8[0] * 2.0f) + fArr8[1], pow), pow, pow, f17, 1.0f, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), sqrt);
    }
