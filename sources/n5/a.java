...
public final class a {
    public static final q5.b l = new q5.b("CastContext", null);
    ...
    public a(Context context, b bVar, List list, com.google.android.gms.internal.cast.q qVar, q5.s sVar) {
        r rVar;
        y yVar;
        com.google.android.gms.internal.cast.v e1Var;
        this.a = context;
        this.e = bVar;
        this.f = sVar;
        this.i = list;
        ...
        try {
            ...
            try {
                ...
                if (readStrongBinder == null) {
                    ...
                    rVar = queryLocalInterface instanceof r ? (r) queryLocalInterface : new r(readStrongBinder, "com.google.android.gms.cast.framework.IDiscoveryManager", 2);
                }
                O0.recycle();
                this.d = new k(rVar);
                try {
                    ...
                    if (readStrongBinder2 == null) {
                        ...
                        yVar = queryLocalInterface2 instanceof y ? (y) queryLocalInterface2 : new y(readStrongBinder2, "com.google.android.gms.cast.framework.ISessionManager", 2);
                    }
                    O02.recycle();
                    ...
                    if (tVar != null) {
                        ...
                        u0 u0Var = tVar.c;
                        x5.l.h(u0Var);
                        u0Var.post(new com.google.android.gms.internal.cast.s(tVar, i9));
                    }
                    int i10 = 3;
                    if (Build.VERSION.SDK_INT >= 23) {
                        ExecutorService newFixedThreadPool = Executors.newFixedThreadPool(3);
                        e1Var = new com.google.android.gms.internal.cast.y(context, newFixedThreadPool instanceof l4 ? (l4) newFixedThreadPool : newFixedThreadPool instanceof ScheduledExecutorService ? new q4((ScheduledExecutorService) newFixedThreadPool) : new m4(newFixedThreadPool));
                    } else {
                        e1Var = new e1();
                    }
                    ...
                    try {
                        ...
                        lVar3.Q0(M0, 3);
                        dVar.c.add(this.h.a);
                        boolean isEmpty = DesugarCollections.unmodifiableList(bVar.w).isEmpty();
                        int i11 = 0;
                        if (!isEmpty) {
                            q5.b bVar2 = l;
                            ...
                            nVar.getClass();
                            com.google.android.gms.internal.cast.n.f.b(r0.m(unmodifiableList.size(), "SetRouteDiscovery for ", " IDs"), new Object[0]);
                        ...
                        sVar.f(new String[]{"com.google.android.gms.cast.FLAG_CLIENT_SESSION_ANALYTICS_ENABLED", "com.google.android.gms.cast.FLAG_CLIENT_SESSION_ANALYTICS_MODE", "com.google.android.gms.cast.FLAG_FIRELOG_UPLOAD_MODE", "com.google.android.gms.cast.FLAG_ANALYTICS_LOGGING_BUCKET_SIZE", "com.google.android.gms.cast.FLAG_CLIENT_FEATURE_USAGE_ANALYTICS_ENABLED"}).addOnSuccessListener(new a0(this, i11));
                        com.google.android.gms.common.api.internal.v b10 = com.google.android.gms.common.api.internal.w.b();
                        b10.c = new m3.y(sVar, new String[]{"com.google.android.gms.cast.MAP_CAST_STATUS_CODES_TO_CAST_REASON_CODES"});
                        b10.d = new u5.c[]{m5.y.d};
                        b10.b = false;
                        b10.a = 8427;
                        sVar.e(0, b10.b()).addOnSuccessListener(new m5.c0(this, i10));
        ...
        if (n == null) {
            synchronized (m) {
                if (n == null) {
                    ...
                    q5.s sVar = new q5.s(applicationContext, q5.s.k, com.google.android.gms.common.api.b.g, com.google.android.gms.common.api.i.c);
                    try {
                        n = new a(applicationContext, castOptions, d.getAdditionalSessionProviders(applicationContext), new com.google.android.gms.internal.cast.q(applicationContext, c2.c0.d(applicationContext), castOptions, sVar), sVar);
                    } catch (d e10) {
