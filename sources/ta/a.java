    ...
    public static Date b(String str, ParsePosition parsePosition) {
        ...
        try {
            ...
            if (!a2 && str.length() <= i16) {
                GregorianCalendar gregorianCalendar = new GregorianCalendar(c3, c10 - 1, c11);
            ...
            if (a2) {
                int i17 = i15 + 5;
                int c12 = c(i15 + 3, i17, str);
                if (a(str, i17, ':')) {
                    i17 = i15 + 6;
                }
                int i18 = i17 + 2;
                int c13 = c(i17, i18, str);
                if (a(str, i18, ':')) {
                    i18 = i17 + 3;
                }
            ...
            ParseException parseException = new ParseException(c.k("Failed to parse date [", str3, "]: ", message), parsePosition.getIndex());
            ...
            message = "(" + e.getClass().getName() + ")";
            ParseException parseException2 = new ParseException(c.k("Failed to parse date [", str3, "]: ", message), parsePosition.getIndex());
