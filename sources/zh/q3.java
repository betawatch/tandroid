...
public final class q3 extends FrameLayout {
    ...
    public q3(z3 z3Var, Context context) {
        ...
        final int i12 = 0;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: zh.n3
            ...
            public final void onClick(View view) {
                switch (i12) {
                    ...
                    default:
                        q3 q3Var = this.b;
                        z3 z3Var4 = q3Var.x;
                        p3 p3Var = new p3(q3Var, q3Var.getContext(), z3Var4.s);
                        z3Var4.f = p3Var;
                        LinearLayout linearLayout3 = q3Var.a;
                        int dp = (-linearLayout3.getMeasuredHeight()) - AndroidUtilities.dp(8.0f);
                        p3Var.b = true;
                        p3Var.a.showAsDropDown(linearLayout3, 0, dp);
                        break;
                }
            }
        });
        final int i13 = 1;
        textView2.setOnClickListener(new View.OnClickListener(this) { // from class: zh.n3
            public final /* synthetic */ q3 b;
        ...
        final int i14 = 2;
        linearLayout2.setOnClickListener(new View.OnClickListener(this) { // from class: zh.n3
            public final /* synthetic */ q3 b;
