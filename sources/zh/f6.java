    ...
    */
    public final void D(int i10, long j3, ArrayList arrayList) {
        ...
        if (this.w0 == j3 && this.y0 == i10 && (arrayList2 = this.x0) != null && arrayList != null && arrayList.size() > arrayList2.size()) {
            ...
            setAdapter(null);
            setAdapter(c6Var);
            while (i11 < arrayList.size() && !((ArrayList) arrayList.get(i11)).contains(Integer.valueOf(u7Var.P0))) {
                i11++;
            }
            if (u7Var.R0) {
    ...
    public final boolean E(boolean z10) {
        ...
        if (z10) {
            ...
            if (currentItem < arrayList.size() - 1) {
                ...
                if (u7Var.a && Build.VERSION.SDK_INT < 33) {
                    z11 = true;
                }
                x(currentItem2, !z11);
                return true;
    ...
    public final void F() {
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            a3Var.setActive(((Integer) getChildAt(i10).getTag()).intValue() == getCurrentItem() && !a3Var.U3);
        }
    }
