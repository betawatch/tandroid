...
public final class h8 {
        ...
        if (LiteMode.isEnabled(131072)) {
            ...
            if (this.l != null) {
                ...
                for (int i12 = 0; i12 < min; i12++) {
                    ...
                    this.l.e(i12, i0.a.k(i10, (int) (Utilities.clamp01(g8Var.h * f7) * 255.0f)));
                }
                ...
                while (i13 < min) {
                    ...
                    rect.set((int) (g8Var2.a - ((((bitmap2.getWidth() / f10) * g8Var2.i) * g8Var2.e) * f16)), (int) (g8Var2.b - ((((bitmap2.getHeight() / f10) * g8Var2.i) * g8Var2.e) * f16)), (int) com.google.android.gms.internal.vision.e2.x((bitmap2.getWidth() / f10) * g8Var2.i, g8Var2.e, f16, g8Var2.a), (int) com.google.android.gms.internal.vision.e2.x((bitmap2.getHeight() / 2.0f) * g8Var2.i, g8Var2.e, f16, g8Var2.b));
    ...
    public final void c(g8 g8Var, long j3, boolean z10) {
        ...
        g8Var.g = lerp;
        if (z10) {
            g8Var.f -= (long) (Utilities.clamp01(Utilities.fastRandom.nextFloat()) * lerp);
        }
        RectF rectF = this.c;
        g8Var.a = AndroidUtilities.lerp(rectF.left, rectF.right, Utilities.fastRandom.nextFloat());
        g8Var.b = AndroidUtilities.lerp(rectF.top, rectF.bottom, Utilities.fastRandom.nextFloat());
        if (this.a == 0) {
            g8Var.c = AndroidUtilities.dp(AndroidUtilities.lerp(-7.0f, -18.0f, Utilities.fastRandom.nextFloat()));
            g8Var.d = AndroidUtilities.dp(AndroidUtilities.lerp(-2.0f, 2.0f, Utilities.fastRandom.nextFloat()));
        } else {
            g8Var.c = rectF.centerX() - g8Var.a;
            g8Var.d = rectF.centerY() - g8Var.b;
        ...
        g8Var.i = AndroidUtilities.lerp(0.4f, 1.0f, Utilities.fastRandom.nextFloat());
    ...
    public final boolean d() {
        if (LiteMode.isEnabled(131072)) {
            ...
            while (true) {
                ...
                long j3 = g8Var.g;
                float f7 = j3 <= 0 ? 2.0f : (currentTimeMillis - g8Var.f) / j3;
                if (f7 > 1.0f) {
                    c(g8Var, currentTimeMillis, this.k);
                    f7 = 0.0f;
                }
                g8Var.a = (g8Var.c * min) + g8Var.a;
                g8Var.b = (g8Var.d * min) + g8Var.b;
                float f10 = 4.0f * f7;
                g8Var.h = f10 - (f7 * f10);
                i10++;
            }
    ...
    public final void e() {
        ...
        while (true) {
            ...
            g8 g8Var = (g8) arrayList.get(i10);
            if (!this.c.contains((int) g8Var.a, (int) g8Var.b)) {
                c(g8Var, currentTimeMillis, this.k);
            }
            i10++;
        }
