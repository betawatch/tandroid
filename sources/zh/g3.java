...
public abstract class g3 extends View {
    public ArrayList E;
    public ArrayList F;
    public ArrayList G;
    ...
    public static void a(g3 g3Var, SpannableStringBuilder spannableStringBuilder, TL_stories.StoryViews storyViews, boolean z10) {
        int i10 = storyViews == null ? 0 : storyViews.views_count;
        if (i10 > 0) {
            spannableStringBuilder.append("d");
            spannableStringBuilder.setSpan(new uq(R.drawable.msg_views, 0), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
            ...
            spannableStringBuilder.append("d");
            spannableStringBuilder.setSpan(new uq(R.drawable.mini_like_filled, 0), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
    ...
    public final void c(int i10, boolean z10, boolean z11) {
        if ((this.K != i10 || z11) && getMeasuredHeight() > 0) {
            ...
            this.M = ofFloat;
            ofFloat.addUpdateListener(new ai.m(this, 13));
            this.M.addListener(new yg.b(this, 10));
            this.M.setInterpolator(wr.f);
    ...
    public f3 getCenteredImageReciever() {
        ArrayList arrayList = this.G;
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (((f3) arrayList.get(i10)).b == this.K) {
    ...
    public final void onDetachedFromWindow() {
        ...
        this.v = false;
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ((f3) arrayList.get(i10)).a.onDetachedFromWindow();
        }
        arrayList.clear();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (i14 < this.E.size()) {
            ...
            float a2 = f17 < 0.0f ? com.google.android.gms.internal.vision.e2.a(1.0f, f7, this.s * 0.1f, f16) : com.google.android.gms.internal.vision.e2.z(1.0f, f7, this.s * 0.1f, f16);
            if (a2 > getMeasuredWidth() || this.s + a2 < 0.0f) {
                ...
                while (true) {
                    if (i16 >= arrayList4.size()) {
                        ...
                        if (((f3) arrayList4.get(i16)).b == i14) {
                            f3Var = (f3) arrayList4.remove(i16);
                            break;
                        }
                        i16++;
                    }
                ...
                float f21 = f10 * f20;
                f11 = measuredWidth;
                float y3 = org.telegram.messenger.a2.y(f19, f18, 2.0f, a2);
                float y10 = org.telegram.messenger.a2.y(f21, f20, 2.0f, this.x);
                if (this.y == 0.0f || i14 == (i12 = this.K)) {
                    arrayList2 = arrayList3;
                    arrayList = arrayList4;
                    f12 = f14;
                    i11 = i15;
                    f3Var.a.setImageCoords(y3, y10, f19, f21);
                } else {
                    f12 = f14;
                    i11 = i15;
                    arrayList = arrayList4;
                    arrayList2 = arrayList3;
                    f3Var.a.setImageCoords(AndroidUtilities.lerp(getMeasuredWidth() * (i14 - i12), y3, this.y), AndroidUtilities.lerp(this.a, y10, this.y), AndroidUtilities.lerp(this.b, f19, this.y), AndroidUtilities.lerp(this.c, f21, this.y));
                }
                if (this.y == 1.0f || i14 != this.K) {
                    ...
                    if (f3Var.c != null) {
                        ...
                        canvas.save();
                        canvas.translate(imageReceiver.getCenterX() - (this.J / 2.0f), (imageReceiver.getImageY2() - AndroidUtilities.dp(8.0f)) - f3Var.c.getHeight());
                        f3Var.d.setAlpha(B);
                        f3Var.c.draw(canvas);
                        canvas.restore();
                    }
        ...
        for (int i17 = 0; i17 < arrayList5.size(); i17++) {
            ((f3) arrayList5.get(i17)).a.onDetachedFromWindow();
        }
        arrayList5.clear();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.J != dp2) {
            ...
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                ((f3) arrayList.get(i13)).a(((f3) arrayList.get(i13)).b);
            }
        }
    }
