...
public final /* synthetic */ class d5 implements RequestDelegate {
    ...
    public /* synthetic */ d5(h5 h5Var, int i10) {
        this.a = i10;
        this.b = h5Var;
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.a) {
            case 0:
                                ...
                                if (storyItem == null) {
                                    ...
                                    while (true) {
                                        ...
                                        if (i19 < arrayList2.size()) {
                                            ...
                                            storyItem.pinned = r9Var.I0 == Integer.MAX_VALUE;
                ...
                } else if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && r9Var.c0 != null && (h7Var = r9Var.d0) != null) {
                ...
                break;
            default:
                AndroidUtilities.runOnUIThread(new n4(this.b.M, 2));
                break;
        }
    }
}
