...
public final class i5 {
    ...
    public i5(int i10) {
        ...
        v5 v5Var = new v5();
        v5Var.a = i10;
        v5Var.b = MessagesStorage.getInstance(i10);
        this.k = v5Var;
        ...
        v5 v5Var2 = this.k;
        v5Var2.b.getStorageQueue().postRunnable(new yg.q(24, v5Var2, new m4(this, 0)));
        this.K = new pg.f2(this, i10, 6);
        this.w = new bi.f1(i10);
    }
    ...
    public final a5 A(long j3, int i10, int i11, boolean z10) {
        if (i10 == 0 && i11 > 0) {
            ...
            a5 a5Var2 = new a5(this.a, j3, i10, i11, new org.telegram.ui.web.y1(this, 26));
        ...
        if (i10 == 4) {
            ...
            s4 s4Var = new s4(this.a, j3, null, new org.telegram.ui.web.y1(this, 26));
            hashMap4.put(valueOf2, s4Var);
            return s4Var;
        }
        HashMap hashMap5 = hashMapArr[i10];
        Long valueOf3 = Long.valueOf(j3);
        a5 a5Var4 = new a5(this.a, j3, i10, i11, new org.telegram.ui.web.y1(this, 26));
    ...
    public final w4 B(long j3, boolean z10) {
        ...
        w4 w4Var2 = new w4(this.a, j3, this);
        iVar.k(w4Var2, j3);
        return w4Var2;
    }
    ...
    public final void P() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_contacts_getBlocked, new j4(this, 3));
    }
    ...
    public final void Q(boolean z10) {
        ...
        if ((z10 || !this.q) && !this.n) {
            ...
            ConnectionsManager.getInstance(this.a).sendRequest(tL_stories_getAllStories, new sg1(this, z10, tL_stories_getAllStories, z11));
        }
    }
    ...
    public final void R() {
        ...
        this.U = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stories.TL_stories_getChatsToSend(), new j4(this, 2));
    }
    ...
    public final void S(final TL_stories.PeerStories peerStories, final boolean z10) {
        ...
        if (arrayList != null) {
            ...
            ConnectionsManager.getInstance(i11).sendRequest(tL_stories_getStoriesByID, new RequestDelegate() { // from class: zh.k4
    ...
    public final void T() {
        if (this.A) {
            ...
            v5 v5Var = this.k;
            v5Var.b.getStorageQueue().postRunnable(new yg.q(21, v5Var, m4Var));
        } else {
            Q(false);
            Q(true);
        }
    ...
    public final void Y(TL_stories.TL_stories_allStories tL_stories_allStories, boolean z10, boolean z11, boolean z12) {
        ...
        if (!z11) {
            ...
            v5 v5Var = this.k;
            v5Var.b.getStorageQueue().postRunnable(new og.p0(5, v5Var, arrayList4, d1Var, z12, z10));
        }
        pg.f2 f2Var = this.K;
    ...
    public final void Z(TL_stories.TL_updateStory tL_updateStory) {
        ...
        if (peerDialogId > 0) {
            ...
            if (user != null && (M(user) || user.self)) {
                v5Var.b.getStorageQueue().postRunnable(new yg.q(23, v5Var, tL_updateStory));
            }
        } else {
            v5Var.b.getStorageQueue().postRunnable(new yg.q(23, v5Var, tL_updateStory));
            user = null;
    ...
    public final void a0(long j3, TL_stories.PeerStories peerStories) {
        ...
        if (j3 <= 0) {
            if (ChatObject.isInChat(MessagesController.getInstance(i10).getChat(Long.valueOf(-j3)))) {
                v5Var.b.getStorageQueue().postRunnable(new t5(v5Var, peerStories, 0));
            }
        } else {
    ...
    public final void b(int i10, long j3, ArrayList arrayList) {
        ...
        while (i14 < size3) {
            ...
            i14++;
            a5 A2 = i5Var.A(B.b, 0, ((b5) obj3).a, false);
            if (A2 != null) {
    ...
    public final void k0(long j3, List list) {
        ...
        while (i10 < size) {
            ...
            i10++;
            a5 A3 = i5Var.A(j3, 0, ((b5) obj).a, false);
            if (A3 != null) {
                A3.A(list);
            }
            i5Var = this;
    ...
    public final void l0(long j3, List list, boolean z10) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                ...
                if (peerStories.stories.get(i12).id == storyItem.id) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        hc.b.q(storyItem.id, new StringBuilder("StoriesController update story for full peer storyId="));
                    }
                } else {
                    i12++;
                }
            ...
            if (!z11) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    hc.b.q(storyItem.id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z10) {
                    hc.b.q(storyItem.id, new StringBuilder("StoriesController add new story for full peer storyId="));
    ...
    public final void m(TL_stories.PeerStories peerStories) {
        ...
        while (i10 < peerStories.stories.size()) {
            if (a6.w(this.a, peerStories.stories.get(i10))) {
    ...
    */
    ...
    public final void n0(long j3, List list, boolean z10) {
        ...
        while (i10 < size2) {
            int i12 = i10 + 1;
            a5 A3 = i5Var.A(j3, 0, ((b5) arrayList.get(i10)).a, false);
            if (A3 != null) {
                A3.D(list, z10);
            }
            i5Var = this;
    ...
    public final j4.w o() {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_stories_canSendStory, new j4(this, 1), 1024);
        return null;
    }
    ...
    public final void q() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stories.TL_stories_getAllReadPeerStories(), new j4(this, 0));
    }
    ...
    public final void s(long j3, ArrayList arrayList) {
        ...
        v5 v5Var = this.k;
        v5Var.b.getStorageQueue().postRunnable(new f5(v5Var, arrayList2, j3, 1));
        NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.storiesUpdated, new Object[0]);
    }
    ...
    public final h5 t(long j3, TL_stories.StoryItem storyItem) {
        ...
        return (h5) hashMap.get(Integer.valueOf(storyItem.id));
    }
