...
public final /* synthetic */ class y4 implements Runnable {
    ...
    public /* synthetic */ y4(a5 a5Var, MessagesStorage messagesStorage, int i10) {
        this.a = i10;
        this.b = a5Var;
        ...
        switch (this.a) {
            case 0:
                ...
                try {
                    ...
                    sQLiteCursor = messagesStorage.createLoadStoriesCursor(j11, a5Var2.f, a5Var2.e);
                    while (sQLiteCursor.next()) {
                        ...
                        if (byteBufferValue != null) {
                            ...
                            MessageObject messageObject = new MessageObject(a5Var2.c, TLdeserialize);
                ...
                sQLiteCursor.dispose();
                AndroidUtilities.runOnUIThread(new te(a5Var, arrayList2, arrayList, arrayList3, arrayList4, hashSet, 22));
                return;
            default:
                a5 a5Var3 = this.b;
                ...
                try {
                    ...
                    database.executeFast("DELETE FROM profile_stories WHERE dialog_id = " + a5Var3.d + " AND type = " + a5Var3.e).stepThis().dispose();
                } catch (Throwable th5) {
                    messagesStorage2.checkSQLException(th5);
                }
                AndroidUtilities.runOnUIThread(new x4(a5Var3, 3));
                return;
        }
    }
}
