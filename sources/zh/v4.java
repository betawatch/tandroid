...
public final /* synthetic */ class v4 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        if (starsPurchaseAvailable) {
            boolean[] zArr2 = {false};
            k7 k7Var = new k7(context, f6Var, j10, this.g ? 9 : 0, this.h, new jb(s5Var, zArr2, messageObject, inputInvoice, tL_payments_paymentFormStars, zArr, i10, callback2, callback), this.m);
