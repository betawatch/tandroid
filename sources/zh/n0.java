...
public final /* synthetic */ class n0 implements NativeInstance.PayloadCallback, RequestDelegateTimestamp, NativeInstance.VideoSourcesCallback, NativeInstance.RequestBroadcastPartCallback, NativeInstance.RequestCurrentTimeCallback {
    ...
    public void run(long j3, int[] iArr) {
        ...
        getgroupparticipants.call = t0Var.f;
        ...
        switch (this.a) {
            case 3:
                ...
                if (t0Var.v != null) {
                    ...
                    tL_inputGroupCallStream.call = t0Var.f;
                    ...
                    AndroidUtilities.runOnUIThread(new uu0(t0Var, str2, AccountInstance.getInstance(t0Var.e).getConnectionsManager().sendRequest(tL_upload_getFile, new RequestDelegateTimestamp() { // from class: zh.p0
                        @Override // org.telegram.tgnet.RequestDelegateTimestamp
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error, long j11) {
                            t0 t0Var2 = t0.this;
                            if (t0Var2.w || t0Var2.E == null) {
                                return;
                            }
                            ...
                            if ("GROUPCALL_INVALID".equalsIgnoreCase(tL_error.text)) {
                                t0Var2.E.onStreamPartAvailable(j13, null, -1, j11, i12, i13);
                            ...
                            t0Var2.E.onStreamPartAvailable(j13, null, i14, j11, i12, i13);
                        }
                    }, 2, 2, t0Var.h()), 17));
                    break;
                }
            ...
            default:
                ...
                FileLog.d(sb3.toString());
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.voip.a0(i10, i11, 1, j3, this.b));
                break;
        }
    }
    ...
    public void run(long j3) {
        ...
        if (groupCall != null && groupCall.rtmp_stream) {
            ...
            getgroupcallstreamchannels.call = t0Var.f;
