...
public final class r6 extends View {
    ...
    public r6(Context context, int i10, TLObject tLObject, Object obj, boolean z10, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (!z10) {
            ...
            if (this.s.size() == 1) {
                MediaDataController.getInstance(i10).getStickerSet((TLRPC.InputStickerSet) this.s.get(0), 0, false, new q6(this, 0));
                return;
            } else {
                set(this.s.size());
                d(false);
    ...
    public static /* synthetic */ void a(r6 r6Var, TLObject tLObject, Object obj, ArrayList arrayList, boolean[] zArr, int i10) {
        if (tLObject instanceof Vector) {
            ...
            for (int i11 = 0; i11 < vector.objects.size(); i11++) {
                ...
                r6Var.r.add(stickerSetCovered);
                TLRPC.StickerSet stickerSet = stickerSetCovered.set;
                if (stickerSet != null) {
                    r6Var.s.add(MediaDataController.getInputStickerSet(stickerSet));
            ...
            ArrayList arrayList2 = r6Var.r;
            int size2 = size + (arrayList2 == null ? 0 : arrayList2.size());
            if (r6Var.s != null && arrayList != null && !arrayList.isEmpty()) {
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    ...
                    while (true) {
                        if (i13 >= r6Var.s.size()) {
                            r6Var.s.add(inputStickerSet);
                            break;
                        } else if (((TLRPC.InputStickerSet) r6Var.s.get(i13)).id == j3) {
                            break;
                        } else {
                            i13++;
                        }
            ...
            if (size2 != 1) {
                r6Var.set(size2);
            } else if (r6Var.r.size() >= 1) {
                r6Var.set((TLRPC.StickerSetCovered) r6Var.r.get(0));
            } else {
    ...
    public static /* synthetic */ void b(r6 r6Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        r6Var.set(tL_messages_stickerSet);
        r6Var.d(false);
    }

    public static /* synthetic */ void c(r6 r6Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        r6Var.set(tL_messages_stickerSet);
        r6Var.d(true);
    }
    ...
    private void set(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (document != null) {
            spannableString.setSpan(new org.telegram.ui.Components.y5(document, this.b.getFontMetricsInt()), 0, 1, 33);
    ...
    public final void d(boolean z10) {
        ...
        if (!z10) {
            ...
            this.H.addUpdateListener(new bi.m7(12, this, this.d == null || Math.abs(getMeasuredHeight() - (getPaddingBottom() + (this.d.getHeight() + getPaddingTop()))) > AndroidUtilities.dp(3.0f)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d != null) {
            if (this.y > 0.0f) {
                ...
                this.d.draw(canvas);
                org.telegram.ui.Components.y5.drawAnimatedEmojis(canvas, this.d, this.f, 0.0f, null, 0.0f, 0.0f, 0.0f, this.y, this.c);
                canvas.restore();
            }
        }
    }
    ...
    public void setText(CharSequence charSequence) {
        ...
        this.f = org.telegram.ui.Components.y5.update(0, this, this.f, this.d);
    }
    ...
    private void set(int i10) {
        ...
        q90 q90Var = this.h;
        if (z10 && this.w) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickersEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, q90Var.a), null));
        } else if (z10) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, q90Var.a), null));
        } else {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickers", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, q90Var.a), null));
        }
    }
}
