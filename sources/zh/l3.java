...
public final class l3 extends qq {
    ...
    public final f01 k;
    public final f01 l;
    public org.telegram.ui.Components.p6 m;
    ...
    public l3(View view, TL_stars.StarGift starGift, int i10, float f7) {
        ...
        if (starGift instanceof TL_stars.TL_starGift) {
            float f12 = i10;
            v7.Z0(imageReceiver, starGift.sticker, (int) (0.75f * f12));
            String str = starGift.title;
            f01 f01Var = new f01(str == null ? "Gift" : str, 16.0f, AndroidUtilities.bold());
            this.k = f01Var;
            f01Var.o(-1);
            float f13 = i10 - 30;
            f01Var.q(AndroidUtilities.dp(f13));
            Layout.Alignment alignment = Layout.Alignment.ALIGN_CENTER;
            f01Var.a();
            f01Var.n(1);
            f01 f01Var2 = new f01(starGift.sold_out ? LocaleController.getString(R.string.Gift2SoldOutTitle) : LocaleController.formatPluralString("Gift2SoldAuctionPreviewGifts", starGift.availability_total, new Object[0]), 13.0f, null);
            this.l = f01Var2;
            f01Var2.q(AndroidUtilities.dp(f13));
            f01Var2.a();
            f01Var2.n(1);
            h8 h8Var = new h8(1, 40);
            this.d = h8Var;
            float f14 = 0.45f * f12;
            h8Var.f(-AndroidUtilities.dp(f14), -AndroidUtilities.dp(f14), AndroidUtilities.dp(f14), AndroidUtilities.dp(f12 * 0.25f));
            ...
            for (int i28 = 0; i28 < h8Var.j; i28++) {
                g8 g8Var = (g8) arrayList3.get(i28);
                PointF pointF5 = (PointF) arrayList.get(i28);
                h8Var.c(g8Var, currentTimeMillis, true);
                g8Var.a = pointF5.x + rectF.left;
                g8Var.b = pointF5.y + rectF.top;
    ...
    public final void d(int i10, int i11) {
        ...
        this.p = i11;
        if (this.o == null) {
            this.o = new yf.n(new rg.p2(this, 21));
        }
        ...
        if (this.m == null) {
            ...
            this.m.setCallback(new ah.g1(this, 10));
        }
        h();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (f01Var2 == null || (f01Var = this.l) == null) {
    ...
    public final void h() {
        ...
        if (currentTime <= this.p || (f01Var = this.l) == null) {
            return;
        }
