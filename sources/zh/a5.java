...
public class a5 {
    ...
    public final x4 q = new x4(this, 0);
    public int s = -1;
    public int A = -1;
    ...
    public a5(int i10, long j3, int i11, int i12, Utilities.Callback callback) {
        ...
        this.e = i11;
        this.f = i12;
        this.x = new yg.q(17, this, callback);
        if (i11 != 0 || i12 <= 0) {
    ...
    public final void D(List list, boolean z10) {
        ...
        while (true) {
            ...
            if (storyItem2 != null) {
                ...
                if (z12 != z13) {
                    if (!z13) {
                        hc.b.q(storyItem2.id, new StringBuilder("StoriesList remove story "));
                    ...
                    hc.b.q(storyItem2.id, new StringBuilder("StoriesList update story "));
    ...
    */
    ...
    public boolean q(int i10, List list, boolean z10) {
        ...
        if (this.t) {
            this.y = new z4(this, z10, i10, list);
            return false;
        }
        int i12 = this.e;
        long j3 = this.d;
    ...
    public final void z(int i10) {
        ...
        if (!arrayList.isEmpty() || (qVar = this.x) == null) {
            return;
        }
        AndroidUtilities.cancelRunOnUIThread(qVar);
