...
public final class j0 extends FrameLayout {
    ...
    public j0(Context context) {
        ...
        this.c = new g9((org.telegram.ui.ActionBar.f6) null);
    ...
    public void set(l0 l0Var) {
        ...
        g9 g9Var = this.c;
        if (j3 >= 0) {
            TLRPC.User user = MessagesController.getInstance(UserConfig.selectedAccount).getUser(Long.valueOf(l0Var.b));
            g9Var.r(user);
            w9Var.e(user, g9Var);
        } else {
            TLRPC.Chat chat = MessagesController.getInstance(UserConfig.selectedAccount).getChat(Long.valueOf(-l0Var.b));
            g9Var.q(chat);
            w9Var.e(chat, g9Var);
        }
        int i10 = l0Var.e;
        ...
        this.e.setText(DialogObject.getName(l0Var.b));
        this.a.invalidate();
    }
}
