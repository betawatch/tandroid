...
public final class v5 {
    ...
    */
    public static void a(v5 v5Var, m4 m4Var) {
        ...
        try {
            ...
            try {
                            ...
                            if (byteBufferValue != 0) {
                                ...
                                if (storyFwdHeader != null) {
                                    try {
                                        ...
                                        try {
                                            FileLog.e(th);
                                            AndroidUtilities.runOnUIThread(new k5(m4Var, 1));
                                            return;
                                        } finally {
                                            if (sQLiteCursor != 0) {
                                ...
                                t6.a(TLdeserialize, byteBufferValue2);
                ...
                while (i18 < tL_stories_allStories.peer_stories.size()) {
                    ...
                    Collections.sort(peerStories.stories, i5.X);
                    i18++;
                }
                Collections.sort(tL_stories_allStories.peer_stories, Comparator$-CC.comparingInt(new hi.j6(19)));
                AndroidUtilities.runOnUIThread(new yg.q(22, m4Var, tL_stories_allStories));
            } catch (Throwable th5) {
                th = th5;
    ...
    public static void b(int i10, long j3, MessageObject messageObject, TL_stories.StoryItem storyItem) {
        ...
        if (i11 == 23 || i11 == 24) {
            y0 y0Var = new y0();
            y0Var.user_id = DialogObject.getPeerDialogId(messageObject.messageOwner.media.peer);
            TLRPC.MessageMedia messageMedia = messageObject.messageOwner.media;
            y0Var.peer = messageMedia.peer;
            y0Var.id = messageMedia.id;
            y0Var.storyItem = c(i10, j3, storyItem);
            TLRPC.Message message2 = messageObject.messageOwner;
            y0Var.via_mention = message2.media.via_mention;
            message2.media = y0Var;
        }
    ...
    public final void d(a0.i iVar, Runnable runnable, int i10, boolean z10, Timer timer) {
        ...
        while (i12 < iVar.m()) {
            ...
            while (i13 < arrayList2.size()) {
                ...
                TL_stories.StoryItem f7 = v5Var.f(e(messageObject), j3);
        ...
        while (i14 < iVar.m()) {
            ...
            int sendRequest = ConnectionsManager.getInstance(i11).sendRequest(tL_stories_getStoriesByID, new f8(v5Var, Timer.start(timer2, t10.toString()), arrayList3, j10, z10, timer2, iArr, runnable));
            if (i10 != 0) {
    ...
    public final TL_stories.StoryItem f(int i10, long j3) {
        ...
        try {
            ...
            if (queryFinalized.next()) {
                ...
                if (storyItem != null) {
                    t6.a(storyItem, byteBufferValue2);
                }
                if (byteBufferValue2 != null) {
                    byteBufferValue2.reuse();
                }
            ...
            try {
                ...
                for (int i10 = 0; i10 < arrayList.size(); i10++) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        NativeByteBuffer b10 = t6.b(storyItem);
                        if (b10 != null) {
    ...
    public final void i(int i10, long j3) {
        ...
        messagesStorage.getStorageQueue().postRunnable(new u5(this, j3, i10, 1));
    }
    ...
    public final void k(long j3, TL_stories.StoryItem storyItem) {
        ...
        this.b.getStorageQueue().postRunnable(new f5(this, j3, storyItem, 2));
    }
