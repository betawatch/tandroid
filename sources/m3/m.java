...
public abstract class m implements e {
        ...
        synchronized (this.lock) {
            ...
            if (removeFirst.isEndOfStream()) {
                ...
                if (removeFirst.isDecodeOnly()) {
                    kVar.addFlag(TLObject.FLAG_31);
                }
                if (removeFirst.isFirstSample()) {
                    kVar.addFlag(TLObject.FLAG_27);
                }
                try {
                    createUnexpectedDecodeException = decode(removeFirst, kVar, z10);
    ...
    public final void setInitialInputBufferSize(int i10) {
        f5.a.i(this.availableInputBufferCount == this.availableInputBuffers.length);
