...
public final class v extends xa {
    ...
    public v(int i10, Context context, Utilities.Callback callback, c6 c6Var) {
        ...
        h6.a(imageView);
        final int i13 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: th.t
                        ...
                        if (!vVar.c0) {
                            ...
                            if (richMessage == null) {
                                ...
                                if (!TextUtils.isEmpty(trim)) {
                                    ...
                                    vVar.d0 = ConnectionsManager.getInstance(vVar.T).sendRequest(tL_messages_composeRichMessageWithAI, new ef.a(vVar, 28));
        ...
        final int i15 = 1;
        o10.setOnClickListener(new View.OnClickListener(this) { // from class: th.t
            public final /* synthetic */ v b;
        ...
        jl0Var.setPadding(i16, 0, i16, AndroidUtilities.dp(72.0f));
