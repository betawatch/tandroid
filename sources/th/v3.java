...
public abstract class v3 {
    ...
    */
                        ...
                        switch (c3) {
                            ...
                            case 16:
                                ...
                                if (lowerCase.contains("button-row")) {
                                    ...
                                    String a10 = u3Var2.a("data-align");
                            ...
                            case 24:
                                ...
                                if (a12 == null || !a12.toLowerCase().contains("pull")) {
                                    ...
                                    TL_iv.RichText f9 = (u3Var5 == null || (w10 = w(u3Var5)) == null || w10.length() == 0) ? null : v5.f(w10);
                                    if (z11) {
                                        long a13 = m0.a();
                                        ...
                                        t5.d(pageblockblockquote, L(spannableStringBuilder4));
                                        if (f9 != null) {
                                            pageblockblockquote.caption = f9;
                                        }
                                    ...
                                    t5.d(pageblockpullquote, L(spannableStringBuilder5));
                                    TL_iv.RichText f10 = (u3Var == null || (w11 = w(u3Var)) == null || w11.length() == 0) ? null : v5.f(w11);
                                    if (f10 != null) {
                ...
                if (aVar.k.size() > i18) {
                    ...
                    if (p3.x3(aVar)) {
                        ...
                        if (aVar.c <= 0 || l(aVar.b) == null) {
                            ...
                            if (!arrayList.isEmpty() && ((Boolean) j7.l1.i(1, arrayList)).booleanValue() != z12) {
                                vVar2.b(sb3);
    ...
    public static void H(StringBuilder sb2, TL_iv.pageBlockTable pageblocktable) {
        ...
        SpannableStringBuilder r6 = richText != null ? v5.r(richText, null, true) : null;
    ...
    public static CharSequence K(a aVar, int i10, int i11, int i12, int i13, int i14) {
        CharSequence r6 = p3.x3(aVar) ? v5.r(((TL_iv.pageBlockDetails) aVar.b).title, null, true) : t5.A(aVar.b);
        if (r6 == null) {
            r6 = "";
        }
        ...
        return (max == 0 && max2 == length) ? r6 : r6.subSequence(max, max2);
    }
    ...
    public static void g(StringBuilder sb2, CharSequence charSequence) {
        ...
        while (i22 < length) {
            ...
            if (c4Var != null) {
                ...
                int i24 = 0;
                for (i01 i01Var : (i01[]) spanned.getSpans(i22, nextSpanTransition, i01.class)) {
                    h01 h01Var = i01Var.b;
                    if (h01Var != null) {
                        i24 |= h01Var.a;
                    }
                }
                c51[] c51VarArr = (c51[]) spanned.getSpans(i22, nextSpanTransition, c51.class);
                String url = c51VarArr.length > 0 ? c51VarArr[c3].getURL() : null;
                y5[] y5VarArr = (y5[]) spanned.getSpans(i22, nextSpanTransition, y5.class);
                if (y5VarArr.length > 0) {
                    y5 y5Var = y5VarArr[c3];
                    if (!y5Var.standard) {
                        j10 = y5Var.getDocumentId();
                        i11 = i24 & 256;
                        if (i11 != 0) {
                            sb2.append("<spoiler>");
                        }
    ...
    */
    ...
    public static void j(SpannableStringBuilder spannableStringBuilder, String str, int i10, String str2, long j10) {
        ...
        if (i10 != 0) {
            h01 h01Var = new h01();
            h01Var.a = i10 & 114975;
            spannableStringBuilder.setSpan(new i01(h01Var, AndroidUtilities.dp(SharedConfig.fontSize)), length, length2, 33);
        }
        if (str2 != null) {
                    ...
                    if (str.charAt(i12) != '<') {
                        ...
                        if (!substring.isEmpty()) {
                            ...
                            if (arrayList3.isEmpty()) {
                                ...
                                ((u3) j7.l1.i(1, arrayList3)).e.add(u3Var);
                            }
                        }
                        ...
                        if (i13 >= 0) {
                            ...
                            if (endsWith) {
                                substring2 = com.google.android.recaptcha.internal.a.m(substring2, 1, 0);
                            }
                            String trim = substring2.trim();
                            u3 u3Var2 = null;
                            if (!trim.isEmpty()) {
                                int i14 = 0;
                                while (i14 < trim.length() && !z7.a(trim.charAt(i14))) {
                                    i14++;
                                }
                                ...
                                if (!lowerCase.isEmpty()) {
                                    ...
                                    while (i14 < trim.length()) {
                                        ...
                                        if (i14 < trim.length()) {
                                            int i15 = i14;
                                            while (i15 < trim.length() && trim.charAt(i15) != '=' && !z7.a(trim.charAt(i15))) {
                                                i15++;
                                            }
                                            String lowerCase2 = trim.substring(i14, i15).toLowerCase();
                                            while (i15 < trim.length() && z7.a(trim.charAt(i15))) {
                                                i15++;
                                            }
                                            if (i15 >= trim.length() || trim.charAt(i15) != '=') {
                                                ...
                                                do {
                                                    ...
                                                    if (i15 < trim.length() || !(trim.charAt(i15) == '\"' || trim.charAt(i15) == c3)) {
                                                        i11 = i15;
                                                        while (i11 < trim.length() && !z7.a(trim.charAt(i11))) {
                                                            i11++;
                                                        }
                            ...
                            if (u3Var2 != null) {
                                if (arrayList3.isEmpty()) {
                                    ...
                                    ((u3) j7.l1.i(1, arrayList3)).e.add(u3Var2);
                                }
                                if (!endsWith) {
                            ...
                            if (!substring3.isEmpty()) {
                                ...
                                if (arrayList3.isEmpty()) {
                                    ...
                                    ((u3) j7.l1.i(1, arrayList3)).e.add(u3Var3);
                                }
                            }
                        }
                    } else {
