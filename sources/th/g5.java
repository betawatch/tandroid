...
public final class g5 extends y implements org.telegram.ui.ActionBar.x5, j9 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        w2 w2Var = this.A;
        k9 textSelectionHelper = w2Var != null ? w2Var.a.getTextSelectionHelper() : null;
    ...
    public final int n(int i10, int i11) {
        ...
        if (a10 == null || (a2 = i5Var.a.a(a10)) < 0) {
            return -1;
        }
        int i13 = a10.colspan;
        int i14 = i13 != 0 ? i13 : 1;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (aVar != null && (i14 = aVar.l) > 0) {
            i18 = AndroidUtilities.dp(com.google.android.recaptcha.internal.a.f(i14, 1, 16, 10));
        }
        int i19 = i15 - i16;
        int i20 = measuredHeight + i18;
        d1Var.layout(AndroidUtilities.dp(16.0f) + i17, i18, j7.l1.d(16.0f, i19, AndroidUtilities.dp(16.0f) + i17), i20);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i14 = 0;
        int max = Math.max(0, (size - this.c) - x7.d(this.a));
        ...
        a aVar = this.a;
        int dp = (aVar != null && (i12 = aVar.l) > 0) ? AndroidUtilities.dp(com.google.android.recaptcha.internal.a.f(i12, 1, 16, 10)) : 0;
        a aVar2 = this.a;
