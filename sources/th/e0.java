...
public final class e0 extends y implements org.telegram.ui.ActionBar.x5 {
    ...
    public e0(Context context, int i10, c6 c6Var) {
        ...
        addView(horizontalScrollView, f6.e(-1, -1, 23));
        ...
        final int i11 = 0;
        t1Var.setOnClickListener(new View.OnClickListener(this) { // from class: th.a0
                ...
                switch (i11) {
                    case 0:
                        ...
                        if (c0Var != null && (aVar = e0Var.a) != null) {
                            p3 p3Var = ((h3) c0Var).a;
                            p3Var.o3(false);
                            p3Var.d3.Q0(new m3(p3Var, aVar, -1), view);
                            break;
                        }
                        break;
                    default:
                        ...
                        if (c0Var2 != null && (aVar2 = e0Var2.a) != null) {
                            ...
                            p3Var2.o3(false);
                            p3Var2.d3.Q0(new m3(p3Var2, aVar2, -1), view);
                            break;
                        }
                        break;
                }
        ...
        final int i12 = 1;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: th.a0
            public final /* synthetic */ e0 b;
    ...
    public static boolean h(View view, float f9, float f10) {
        ...
        if (f9 >= iArr[0] && f9 <= view.getWidth() + r2) {
        ...
        if (aVar != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockButtonRow) {
                ...
                while (i10 < size) {
                    ...
                    linearLayout.addView(b0Var, f6.t(-2, -1, 16, i10 == 0 ? 0 : 7, 0, 0, 0));
                    i10++;
                }
                boolean z10 = size >= 8;
