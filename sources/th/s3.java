            ...
            default:
                ...
                if (i10 == 1) {
                    ...
                    if (m22 || p22) {
                        ...
                        if (m22) {
                            final int i12 = 0;
                            F.c(R.drawable.iv_list_tab, LocaleController.getString(R.string.ArticleIndent), new Runnable() { // from class: th.g
                        ...
                        if (p22) {
                            final int i13 = 1;
                            F.c(R.drawable.iv_list_untab, LocaleController.getString(R.string.ArticleOutdent), new Runnable() { // from class: th.g
                                @Override // java.lang.Runnable
                                public final void run() {
                                    switch (i13) {
                                        case 0:
                    ...
                    if (i10 == 4) {
                        ...
                        p.U(pVar.getContext(), (pageblockmath == null || TextUtils.isEmpty(pageblockmath.source)) ? "" : pageblockmath.source, new yu0(20, pVar, pageblockmath), c6Var);
                        break;
                    } else if (i10 == 9) {
                        p3Var.t3();
                        break;
