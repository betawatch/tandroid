...
public final class p4 {
    ...
    public p4(m4 m4Var, c6 c6Var) {
        this.a = new ImageReceiver(m4Var);
        this.b = new ImageReceiver(m4Var);
    ...
    public final void a() {
        ...
        if (!sVar4.b) {
            if (sVar4.e != null) {
                ...
                imageReceiver.setImage(ImageLocation.getForPath(this.e.e), k9, null, null, null, 0);
                return;
            } else {
                ...
                imageReceiver.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, this.e.g), k9, ImageLocation.getForPhoto(closestPhotoSizeWithSize2, this.e.g), k9, null, 0L, null, this.e.g, 0);
                return;
            }
        }
        if (sVar4.e != null) {
            imageReceiver.setOrientation(0, 0, false);
            imageReceiver.setImage(ImageLocation.getForVideoPath(this.e.e), ImageLoader.AUTOPLAY_FILTER, null, k9, null, k9, null, 0L, null, null, 0);
            return;
        }
        ...
        imageReceiver.setOrientation(0, 0, false);
        imageReceiver.setImage(ImageLocation.getForDocument(this.e.h), ImageLoader.AUTOPLAY_FILTER, ImageLocation.getForDocument(photoSize, this.e.h), k9, ImageLocation.getForDocument(photoSize2, this.e.h), k9, null, 0L, null, this.e.h, 0);
    }
