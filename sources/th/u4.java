...
public abstract class u4 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i13 < size) {
            ...
            qi0 qi0Var = (spanned == null || span != null) ? 0 : (qi0) a(spanned, i14, i15, qi0.class);
            if (span == null && qi0Var == 0) {
                ...
                CodeHighlighting.Span span2 = span != null ? span : qi0Var;
                while (true) {
                    if (i13 >= size) {
                        i10 = length;
                        break;
                    ...
                    if ((span != null ? a(spanned, i16, length, CodeHighlighting.Span.class) : a(spanned, i16, length, qi0.class)) != span2) {
                        break;
                    }
                    i15 = length;
                    i13 = i17;
                ...
                if (span != null) {
                    ...
                    pageblockblockquote.collapsed = qi0Var != 0 && qi0Var.e;
                    ...
                    if (z10 || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                        ...
                        if (arrayList4 != null && !arrayList4.isEmpty()) {
                            ...
                            while (i10 < size) {
                                ...
                                SpannableStringBuilder r9 = pageListItem2 instanceof TL_iv.TL_pageListItemText ? v5.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true) : pageListItem2 instanceof TL_iv.TL_pageListItemBlocks ? c(((TL_iv.TL_pageListItemBlocks) pageListItem2).blocks) : null;
                                if (r9 != null) {
                                    SpannableStringBuilder spannableStringBuilder3 = new SpannableStringBuilder(pageListItem2.checkbox ? pageListItem2.checked ? "☑  " : "☐  " : "•  ");
                                    spannableStringBuilder3.append((CharSequence) r9);
                        ...
                        if (arrayList6 != null && !arrayList6.isEmpty()) {
                            ...
                            while (i10 < size2) {
                                ...
                                SpannableStringBuilder r10 = pageListOrderedItem2 instanceof TL_iv.TL_pageListOrderedItemText ? v5.r(((TL_iv.TL_pageListOrderedItemText) pageListOrderedItem2).text, null, true) : pageListOrderedItem2 instanceof TL_iv.TL_pageListOrderedItemBlocks ? c(((TL_iv.TL_pageListOrderedItemBlocks) pageListOrderedItem2).blocks) : null;
                                if (r10 != null) {
                                    SpannableStringBuilder spannableStringBuilder4 = new SpannableStringBuilder(u3.c.k(!TextUtils.isEmpty(pageListOrderedItem2.num) ? pageListOrderedItem2.num : String.valueOf(i11), ".  "));
                                    spannableStringBuilder4.append((CharSequence) r10);
                        ...
                        SpannableStringBuilder r11 = v5.r(pageblocktable.title, null, true);
                        ...
                        SpannableStringBuilder r12 = v5.r(pageBlock.caption.text, null, true);
                        if (!TextUtils.isEmpty(r12)) {
                            spannableStringBuilder6.append((CharSequence) r12);
                        }
                        SpannableStringBuilder r13 = v5.r(pageBlock.caption.credit, null, true);
                        if (!TextUtils.isEmpty(r13)) {
                            if (spannableStringBuilder6.length() > 0) {
                                spannableStringBuilder6.append('\n');
                            }
                            spannableStringBuilder6.append((CharSequence) r13);
                        }
                        if (spannableStringBuilder6.length() > 0) {
    ...
    public static SpannableStringBuilder i(a aVar, boolean z10) {
        ...
        if (z10) {
            TL_iv.PageBlock pageBlock = aVar.b;
            r6 = v5.r(pageBlock != null ? pageBlock.text : null, pageBlock, false);
        } else {
            TL_iv.PageBlock pageBlock2 = aVar.b;
            r6 = v5.r(pageBlock2 != null ? pageBlock2.text : null, pageBlock2, true);
        }
            ...
            if (aVar.k.isEmpty()) {
                ...
                if ((pageBlock instanceof TL_iv.pageBlockBlockquote) || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    ...
                    if (spannableStringBuilder.length() > 0) {
                        qi0.b(spannableStringBuilder, 0, spannableStringBuilder.length(), z11);
                    }
                    arrayList.add(spannableStringBuilder);
                } else {
    ...
    public static CharSequence l(int i10, SpannableStringBuilder spannableStringBuilder) {
        ...
        h01 h01Var = new h01();
        h01Var.a = i10;
        spannableStringBuilder2.setSpan(new i01(h01Var, 0), 0, spannableStringBuilder2.length(), 33);
        return spannableStringBuilder2;
    }
}
