...
public final class j5 extends FrameLayout {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:6:0x001e, code lost:
        ...
        if ((th.v5.q(0, r0.length(), r0) & 1) == 0) goto L9;
     */
    /*
    ...
    */
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (d1Var.getVisibility() == 0 && motionEvent.getActionMasked() != 3) {
            ...
            boolean z10 = x4 >= ((float) d1Var.getLeft()) && x4 < ((float) d1Var.getRight());
            boolean z11 = y8 < ((float) d1Var.getTop()) || y8 >= ((float) d1Var.getBottom());
            if (z10 && z11 && d1Var.getHeight() > 0) {
                float max = Math.max(0.0f, Math.min(y8 - d1Var.getTop(), d1Var.getHeight() - 1));
                MotionEvent obtain = MotionEvent.obtain(motionEvent);
                obtain.setLocation(x4 - d1Var.getLeft(), max);
