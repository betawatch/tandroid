...
public final /* synthetic */ class q4 implements Runnable {
    ...
    public /* synthetic */ q4(s4 s4Var, int i10) {
        this.a = i10;
        this.b = s4Var;
    }
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                s4 s4Var = this.b;
                String str = s4Var.b;
                TLRPC.Document document = s4Var.r;
                String str2 = null;
                        ...
                        if (bitmap != null) {
                            try {
                                ...
                                if (scaleAndSaveImage != null) {
                                    ...
                                    document.flags |= 1;
                                    File pathToAttach = FileLoader.getInstance(s4Var.a).getPathToAttach(scaleAndSaveImage, true);
            ...
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new sf.o1(10, s4Var2, str4));
                return;
            default:
                s4 s4Var3 = this.b;
                if (s4Var3.w || s4Var3.x) {
                    return;
                }
                s4Var3.a(s4Var3.b);
                return;
