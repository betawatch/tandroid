    ...
    public final TL_iv.pageTableCell a() {
        ...
        if (x5Var != null && x5Var.b != 0 && x5Var.c != 0) {
            ...
            while (i12 < size) {
                ...
                if (((LinkedHashSet) ((sf.f1) this.h).b).contains(pagetablecell3)) {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (a2 != null) {
            ...
            if (b11 >= 0 && a10 >= 0) {
                ...
                if (n(a10)) {
                    ...
                    int[] iArr2 = this.e;
                    this.I = iArr2[a10];
                    this.J = iArr2[Math.min(a10 + i18, this.a.c)];
                }
            }
        }
        x5 x5Var2 = this.a;
        ...
        if (x5Var2 != null && x5Var2.b != 0 && x5Var2.c != 0) {
            ...
            float f12 = this.f[0];
            x5 x5Var3 = this.a;
            rectF.set(f11, f12, r2[x5Var3.c], r4[x5Var3.b]);
            Path path = this.B;
            path.rewind();
        ...
        if (this.a != null) {
            ...
            if (d > 0.001f) {
                ...
                float f32 = (i10 + i11) / f9;
                paint3.setColor((v && d(k10, r9)) ? this.L : this.K);
    ...
    public final void h(Canvas canvas, int i10, int i11) {
        ...
        float min = Math.min(AndroidUtilities.dpf2(10.0f), (dpf22 - dpf2) / 2.0f);
        float f9 = f(this.e[0], i10);
        float f10 = f(this.e[0], i11);
        Path path = this.B;
        path.rewind();
        path.moveTo(this.e[0] + f9, dpf2);
    ...
    public final boolean l() {
        ...
        if (x5Var != null && this.h != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                if (((LinkedHashSet) ((sf.f1) this.h).b).contains((TL_iv.pageTableCell) obj)) {
                    return true;
                }
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int d = i17 == 2 ? j7.l1.d(i18 * 4, size / 2, 0) : Math.max(0, Math.round(size / 1.5f));
        float f9 = i18 * 2;
        int b10 = org.telegram.messenger.x3.b(f9, d, dp5);
        ...
        while (true) {
            ...
            if (childAt instanceof j5) {
                ...
                if (x5.n(j5Var.b) == 1 && (a2 = this.a.a(j5Var.b)) >= 0 && a2 < i17) {
                    int dp6 = AndroidUtilities.dp(f9) + Math.round(Layout.getDesiredWidth(d1Var.getText(), d1Var.getPaint()));
                    int[] iArr = this.c;
            ...
            if (childAt2 instanceof j5) {
                ...
                if (n10 > i12) {
                    ...
                    if (a10 >= 0 && a10 < min) {
                        ...
                        int min2 = Math.min((min - a10) * b10, AndroidUtilities.dp(f9) + Math.round(Layout.getDesiredWidth(d1Var2.getText(), d1Var2.getPaint()))) - i22;
    ...
    public final boolean p(int i10, int i11) {
        ...
        return ((LinkedHashSet) ((sf.f1) h5Var).b).contains(x5Var.d[i10][i11]);
    }
