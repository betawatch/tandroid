...
public final class b extends Drawable implements DownloadController.FileDownloadProgressListener {
    ...
    public b(int i10, t1 t1Var) {
        ...
        this.e = i10;
        this.d = t1Var;
        this.y = new le.b(t1Var, pr.h, 380L);
        p6 p6Var = new p6(false, false, false, false);
        this.a = p6Var;
        p6Var.b = 21;
        p6Var.t(AndroidUtilities.dp(11.0f));
        p6Var.setCallback(t1Var);
        this.b = new n9(i10, t1Var, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(8.33f), AndroidUtilities.dpf2(1.0f));
    ...
    public final void c(Canvas canvas) {
        ...
        if (this.y.e > 0.0f) {
            ...
            if (f7 > 0.0f) {
                n9 n9Var = this.b;
                n9Var.i = (int) (this.y.e * 255.0f);
                n9Var.setBounds((bounds.right - dp) - i10, bounds.bottom - AndroidUtilities.dp(31.33f), bounds.right - dp, bounds.bottom);
                this.b.c(canvas);
            }
            int dp2 = bounds.bottom - AndroidUtilities.dp(21.33f);
            p6 p6Var = this.a;
            p6Var.w = (int) (this.y.e * 255.0f);
    ...
    public final float d(float f7) {
        n9 n9Var = this.b;
        float d = this.a.d() + n9Var.c.d.f.a;
        float dp = n9Var.c.d.c.a * AndroidUtilities.dp(4.0f);
        float f10 = this.y.e;
