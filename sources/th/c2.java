...
public final class c2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, c2 c2Var) {
        ...
        c2Var.a = v5.l(richText).length() + c2Var.a;
    ...
    public static void b(TL_iv.PageBlock pageBlock, int i10, c2 c2Var) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            ...
            c2Var.b = pageblockblockquoteblocks.blocks.size() + c2Var.b;
            while (i12 < pageblockblockquoteblocks.blocks.size()) {
                b(pageblockblockquoteblocks.blocks.get(i12), i10 + 1, c2Var);
                i12++;
            }
            return;
        }
        if (pageBlock instanceof TL_iv.pageBlockDetails) {
            ...
            c2Var.b = pageblockdetails.blocks.size() + c2Var.b;
            while (i12 < pageblockdetails.blocks.size()) {
                b(pageblockdetails.blocks.get(i12), i10 + 1, c2Var);
                i12++;
            }
            return;
        }
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            c2Var.b = pageblockorderedlist.items.size() + c2Var.b;
            for (int i16 = 0; i16 < pageblockorderedlist.items.size(); i16++) {
                ...
                if (pageListOrderedItem instanceof TL_iv.TL_pageListOrderedItemText) {
                    a(((TL_iv.TL_pageListOrderedItemText) pageListOrderedItem).text, i17, c2Var);
                    ...
                    for (int i18 = 0; i18 < arrayList2.size(); i18++) {
                        b(arrayList2.get(i18), i17, c2Var);
                    }
                }
            }
            return;
        ...
        if (pageBlock instanceof TL_iv.pageBlockTable) {
            ...
            if (arrayList3 != null) {
                c2Var.b = arrayList3.size() + c2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockCollage) {
            ...
            while (i12 < arrayList5.size()) {
                b(arrayList5.get(i12), i10 + 1, c2Var);
                i12++;
            }
            return;
        }
        if (pageBlock instanceof TL_iv.pageBlockSlideshow) {
            ...
            while (i12 < arrayList6.size()) {
                b(arrayList6.get(i12), i10 + 1, c2Var);
                i12++;
            }
            return;
        }
