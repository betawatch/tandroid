...
public final class x5 {
        ...
        for (int i30 = 0; i30 < this.b; i30++) {
            for (int i31 = 0; i31 < this.c; i31++) {
                ...
                if (pagetablecellArr4[i30][i31] == null) {
                    TL_iv.pageTableCell f9 = f();
                    this.d[i30][i31] = f9;
                    this.e[i30][i31] = i30;
                    this.f[i30][i31] = i31;
                    pageblocktable.rows.get(i30).cells.add(f9);
                }
            }
        }
    ...
    public final void j(final IdentityHashMap identityHashMap, int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            ...
            Collections.sort(arrayList, Comparator$-CC.comparingInt(new ToIntFunction() { // from class: th.w5
        ...
        if (b10 >= 0 && a2 >= 0) {
            ...
            if (i10 > 1 || i11 > 1) {
                ...
                for (int i12 = b10; i12 < b10 + i10 && i12 < this.b; i12++) {
                    ...
                    Collections.sort(arrayList, Comparator$-CC.comparingInt(new jf.d(19)));
