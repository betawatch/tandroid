...
public final class x1 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean W(x1 x1Var, View view) {
        tn tnVar = x1Var.F;
        if (tnVar != null && x1Var.r == null && !tnVar.c() && x1Var.L.k3() && !x1Var.L.m3()) {
            if (!x1Var.L.M3()) {
                x1Var.B0();
                return false;
            }
            ...
            if (!Z2.isEmpty()) {
                ...
                og r6 = x1Var.K0.r(x1Var.u0, true, new f1(x1Var, 10));
                if (r6 != null) {
                ...
                j70 H = j70.H(x1Var, x1Var.u0);
                boolean isUserSelf = UserObject.isUserSelf(x1Var.F.i());
                if (x1Var.F.D6()) {
                    H.c(R.drawable.msg_calendar2, LocaleController.getString(isUserSelf ? R.string.SetReminder : R.string.ScheduleMessage), new qh.m0(x1Var, a2, 2), false);
                    if (!isUserSelf && a2 > 0) {
    ...
    public static void Y(final x1 x1Var, Context context, View view) {
        ...
        J.k();
        final int i10 = 0;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading1), R.drawable.iv_h1, null, LocaleController.getString(R.string.ArticleHeading1), new Runnable(x1Var) { // from class: th.j1
        ...
        final int i11 = 1;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading2), R.drawable.iv_h2, null, LocaleController.getString(R.string.ArticleHeading2), new Runnable(x1Var) { // from class: th.j1
            public final /* synthetic */ x1 b;
        ...
        final int i12 = 2;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading3), R.drawable.iv_h3, null, LocaleController.getString(R.string.ArticleHeading3), new Runnable(x1Var) { // from class: th.j1
            public final /* synthetic */ x1 b;
        ...
        final int i13 = 3;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading4), R.drawable.iv_h4, null, LocaleController.getString(R.string.ArticleHeading4), new Runnable(x1Var) { // from class: th.j1
            public final /* synthetic */ x1 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 1);
        final int i14 = 4;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading5), R.drawable.iv_h5, null, LocaleController.getString(R.string.ArticleHeading5), new Runnable(x1Var) { // from class: th.j1
            public final /* synthetic */ x1 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 2);
        final int i15 = 5;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading6), R.drawable.iv_h6, null, LocaleController.getString(R.string.ArticleHeading6), new Runnable(x1Var) { // from class: th.j1
            public final /* synthetic */ x1 b;
        ...
        int i16 = g6.G8;
        v1Var.d = i16;
        I.j(z10, 0, v1Var, LocaleController.getString(R.string.ArticleHeading), new ih.z2(I, j70Var, 11));
    ...
    public static void Z(x1 x1Var, boolean z10, boolean z11) {
        ...
        if (z11) {
            x1Var.s0.animate().scaleX(f9).scaleY(f9).setDuration(180L).setInterpolator(jr.h).start();
        } else {
            x1Var.s0.animate().cancel();
            x1Var.s0.setScaleX(f9);
            x1Var.s0.setScaleY(f9);
        }
        x1Var.s0.setColorFilter(new PorterDuffColorFilter(x1Var.getThemedColor(z10 ? g6.q7 : g6.G6), PorterDuff.Mode.SRC_IN));
        xi0 animatedDrawable = x1Var.s0.getAnimatedDrawable();
    ...
    public static void p0(Context context, final Runnable runnable, final Runnable runnable2, c6 c6Var) {
        ...
        TextView i12 = th.i(linearLayout, textView, f6.t(-1, -2, 49, 25, 16, 25, 0), context);
        ...
        linearLayout.addView(i12, f6.t(-1, -2, 49, 25, 11, 25, 0));
        ...
        q6.show();
        o10.setOnClickListener(new View.OnClickListener() { // from class: th.h1
        ...
        final int i13 = 1;
        o11.setOnClickListener(new View.OnClickListener() { // from class: th.h1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                switch (i13) {
                    case 0:
    ...
    public final View createView(Context context) {
        ...
        this.X.j(rg.e, false);
        this.a0.addView(this.X, f6.q(38, 38, 16));
        h6.a(this.X);
        ...
        this.a0.addView(this.c0, f6.t(38, 38, 16, 2, 0, 0, 0));
        h6.a(this.c0);
        ...
        this.U.addView(this.d0, f6.e(-2, 60, 81));
        ...
        linearLayout5.addView(this.q0, f6.t(38, 38, 16, linearLayout5.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
        ...
        linearLayout6.addView(this.n0, f6.t(38, 38, 16, linearLayout6.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
        ...
        this.d0.addView(this.j0, f6.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        ...
        this.j0.addView(this.m0, f6.q(38, 38, 16));
        ...
        this.j0.addView(this.o0, f6.q(38, 38, 16));
        ...
        this.d0.addView(this.k0, f6.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        ...
        this.k0.addView(this.p0, f6.q(38, 38, 16));
        ...
        this.d0.addView(this.i0, 0, f6.d(-2, 44.0f, 80, 0.0f, 0.0f, 8.0f, 0.0f));
        ...
        this.i0.addView(this.l0, f6.q(38, 38, 16));
        hp0 hp0Var = new hp0((Object) this, context, this.r != null ? R.drawable.input_done : l0() ? R.drawable.input_schedule : R.drawable.send_plane_24, getResourceProvider(), 3);
        this.u0 = hp0Var;
        hp0Var.setBackground(new w1(g6.b0(AndroidUtilities.dp(22.0f), getThemedColor(g6.Yd))));
        h6.a(this.u0);
        this.W.addView(this.u0, f6.p(44, 44, 0.0f, 5, 8, 0, 0, 0));
        this.u0.setContentDescription(LocaleController.getString(R.string.Send));
        this.u0.setOnClickListener(new f1(this, 0));
        this.u0.setOnLongClickListener(new bg.g0(this, 4));
        C0();
    ...
    public final void d0(Context context, int i10, int i11, boolean z10) {
        ...
        linearLayout.addView(t1Var, f6.t(38, 38, 16, linearLayout.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
    }
    ...
    public final boolean l0() {
        tn tnVar;
        return this.r == null && (tnVar = this.F) != null && tnVar.c();
    }
    ...
    public final void o0(int i10, int i11) {
        ...
        niVar.f0.setIncludeVideosInGallery(true);
        niVar.f0.f0();
        niVar.J1(1, true);
        niVar.h1(i10);
        niVar.p2 = new m1(this, niVar);
    ...
    public final AnimatorSet onCustomTransitionAnimation(boolean z10, Runnable runnable) {
        ...
        this.K.post(new it0(animatorSet, i11));
        return animatorSet;
    }
    ...
    public final r0.m1 onInsetsInternal(View view, r0.m1 m1Var) {
        ...
        if (!this.C0 && z10 && (j70Var = this.t0) != null) {
            j70Var.u();
            this.t0 = null;
        }
        onInsets(f9.a, f9.b, f9.c, f9.d);
        return r0.m1.b;
    }
    ...
    public final boolean q0() {
        ...
        if (j22 != null && !this.I) {
            p3 p3Var = this.L;
            if (p3Var.k3() && !u4.f(p3Var.h3, p3Var.i3) && dkVar != null) {
                SpannableStringBuilder k9 = u4.k(this.L.h3);
                tn tnVar = dkVar.K2;
                if (dkVar.A0 == null) {
                    return true;
                }
                ...
                if (tnVar != null) {
                    ...
                    MediaDataController.getInstance(dkVar.M).saveDraft(tnVar.a(), tnVar.B7(tnVar.j5), charSequenceArr[0], MediaDataController.getInstance(dkVar.M).getEntities(charSequenceArr, true, false), null, null, null, 0L, false, false, null);
                }
        ...
        long a2 = this.F.a();
        tn tnVar2 = this.F;
        mediaDataController.saveDraft(a2, tnVar2.B7(tnVar2.j5), "", null, null, null, null, 0L, false, false, j22);
    ...
    /* JADX WARN: Type inference failed for: r0v19, types: [th.k1] */
    public final void s0(final int i10, final int i11, final boolean z10) {
        ...
        if (!MessagesController.getInstance(this.currentAccount).richEditorAllowed()) {
            ...
            dkVar.R0(u4.k(this.L.h3), z10, i10, i11);
            finishFragment();
            return;
        }
        this.I = true;
        ...
        tn tnVar = this.F;
        final MessageObject messageObject = tnVar.j5;
        ...
        ?? r02 = new Runnable() { // from class: th.k1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    ...
    public final void x0(int i10, boolean z10) {
        ...
        if (z10) {
            ...
            this.d0.animate().alpha(this.G0 == 1 ? 1.0f : 0.0f).scaleX(this.G0 == 1 ? 1.0f : 0.8f).scaleY(this.G0 == 1 ? 1.0f : 0.8f).translationY(this.G0 == 1 ? 0.0f : AndroidUtilities.dp(30.0f)).setDuration(420L).setInterpolator(jrVar).withEndAction(new e1(this, 2)).start();
            this.r0.setVisibility(0);
            this.r0.animate().alpha(this.G0 == 2 ? 1.0f : 0.0f).scaleX(this.G0 == 2 ? 1.0f : 0.8f).scaleY(this.G0 == 2 ? 1.0f : 0.8f).setDuration(420L).setInterpolator(jrVar).withEndAction(new e1(this, 3)).start();
            return;
        }
