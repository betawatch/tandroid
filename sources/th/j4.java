            ...
            case 0:
                ...
                if (m4Var.J != null && m4Var.a != null) {
                    ...
                    if (indexOf >= 0 && indexOf < m10.size() && indexOf < arrayList.size()) {
                        ...
                        j70 q12 = m4Var.J.a.d3.q1((View) arrayList.get(indexOf));
                        boolean z10 = sVar.n;
                        final int i10 = 0;
                        q12.c(z10 ? R.drawable.msg_spoiler_off : R.drawable.msg_spoiler, LocaleController.getString(z10 ? R.string.DisablePhotoSpoiler : R.string.EnablePhotoSpoiler), new Runnable() { // from class: th.k4
                        ...
                        final int i11 = 1;
                        q12.c(R.drawable.msg_delete, LocaleController.getString(R.string.Delete), new Runnable() { // from class: th.k4
                            @Override // java.lang.Runnable
                            public final void run() {
                                a aVar3;
                                a aVar4;
