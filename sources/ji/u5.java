...
public final class u5 extends ViewGroup {
    ...
    public final TL_iv.pageTableCell a() {
        ...
        if (k6Var != null && k6Var.b != 0 && k6Var.c != 0) {
            ...
            while (i12 < size) {
                ...
                if (((LinkedHashSet) ((k5) this.h).b).contains(pagetablecell3)) {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        k6 k6Var2 = this.a;
        RectF rectF = this.y;
        if (k6Var2 != null && k6Var2.b != 0 && k6Var2.c != 0) {
            ...
            float f12 = this.f[0];
            k6 k6Var3 = this.a;
            rectF.set(f11, f12, r2[k6Var3.c], r4[k6Var3.b]);
            Path path = this.F;
            path.rewind();
            ...
            for (int i19 = 0; i19 < getChildCount(); i19++) {
                ...
                if (childAt instanceof v5) {
                    v5 v5Var = (v5) childAt;
                    int b12 = this.a.b(v5Var.b);
                    int a11 = this.a.a(v5Var.b);
                    if (b12 >= 0 && a11 >= 0) {
                        int n10 = k6.n(v5Var.b);
                        int o9 = k6.o(v5Var.b);
                        int[] iArr3 = this.e;
                        int i20 = iArr3[a11];
                        int i21 = this.f[b12];
        ...
        k6 k6Var4 = this.a;
        if (k6Var4 != null && (pageblocktable = k6Var4.a) != null && pageblocktable.bordered) {
            Paint paint = this.n;
            ...
            int[] iArr7 = this.f;
            k6 k6Var5 = this.a;
            rectF.set(iArr6[0] + strokeWidth, iArr7[0] + strokeWidth, iArr6[k6Var5.c] - strokeWidth, iArr7[k6Var5.b] - strokeWidth);
            ...
            while (i24 < this.a.c) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[] pagetablecellArr = k6Var6.d[i27];
            ...
            for (int i28 = 1; i28 < this.a.b; i28++) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[][] pagetablecellArr2 = k6Var7.d;
    ...
    public final boolean l() {
        ...
        if (k6Var != null && this.h != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                if (((LinkedHashSet) ((k5) this.h).b).contains((TL_iv.pageTableCell) obj)) {
                    return true;
                }
            }
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt instanceof v5) {
                v5 v5Var = (v5) childAt;
                int b10 = this.a.b(v5Var.b);
                int a2 = this.a.a(v5Var.b);
                if (b10 >= 0 && a2 >= 0) {
                    int i15 = this.e[a2];
                    int i16 = this.f[b10];
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.c = new int[i17];
        this.d = new int[i16];
        int dp5 = AndroidUtilities.dp(k6Var2.a.compact ? 20.0f : 50.0f);
        int i18 = this.a.a.compact ? 5 : 12;
        int f7 = i17 == 2 ? i2.g.f(i18 * 4, size / 2, 0) : Math.max(0, Math.round(size / 1.5f));
        float f10 = i18 * 2;
        ...
        while (true) {
            ...
            if (childAt instanceof v5) {
                v5 v5Var = (v5) childAt;
                h1 h1Var = v5Var.a;
                if (k6.n(v5Var.b) == 1 && (a2 = this.a.a(v5Var.b)) >= 0 && a2 < i17) {
        ...
        while (i21 < getChildCount()) {
            ...
            if (childAt2 instanceof v5) {
                ...
                h1 h1Var2 = v5Var2.a;
                int n10 = k6.n(v5Var2.b);
                if (n10 > i12) {
                    int a10 = this.a.a(v5Var2.b);
                    ...
                    if (a10 >= 0 && a10 < min) {
                        ...
                        int min2 = Math.min((min - a10) * b10, AndroidUtilities.dp(f10) + Math.round(Layout.getDesiredWidth(h1Var2.getText(), h1Var2.getPaint()))) - i22;
        ...
        while (i30 < getChildCount()) {
            ...
            if (childAt3 instanceof v5) {
                ...
                int b11 = this.a.b(v5Var3.b);
                int a11 = this.a.a(v5Var3.b);
                int n11 = k6.n(v5Var3.b);
                i15 = i30;
                int i31 = 0;
                for (int i32 = a11; i32 < a11 + n11 && i32 < i17; i32++) {
                    i31 += this.c[i32];
                }
                v5Var3.measure(View.MeasureSpec.makeMeasureSpec(i31, TLObject.FLAG_30), makeMeasureSpec);
                if (k6.o(v5Var3.b) == 1) {
        ...
        for (int i33 = 0; i33 < getChildCount(); i33++) {
            ...
            if (childAt4 instanceof v5) {
                ...
                int b12 = this.a.b(v5Var4.b);
                int o9 = k6.o(v5Var4.b);
                if (o9 > 1) {
                    int i34 = b12;
                    int i35 = 0;
                    while (true) {
        ...
        while (i37 < getChildCount()) {
            ...
            if (childAt5 instanceof v5) {
                ...
                int b13 = this.a.b(v5Var5.b);
                int a12 = this.a.a(v5Var5.b);
                int n12 = k6.n(v5Var5.b);
                int o10 = k6.o(v5Var5.b);
                i13 = i37;
                int i38 = 0;
                ...
                v5Var5.measure(View.MeasureSpec.makeMeasureSpec(i38, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i40, TLObject.FLAG_30));
            } else {
                i13 = i37;
            }
            i37 = i13 + 1;
    ...
    public final boolean p(int i10, int i11) {
        t5 t5Var;
        k6 k6Var = this.a;
        if (k6Var == null || (t5Var = this.h) == null || i10 < 0 || i10 >= k6Var.b || i11 < 0 || i11 >= k6Var.c) {
            return false;
        }
        return ((LinkedHashSet) ((k5) t5Var).b).contains(k6Var.d[i10][i11]);
    }
    ...
    public final void s() {
        ...
        int size = k6Var.g.size();
        for (int i10 = 0; i10 < size; i10++) {
            TL_iv.pageTableCell pagetablecell = (TL_iv.pageTableCell) this.a.g.get(i10);
            v5 v5Var = new v5(getContext(), this.b);
            v5Var.setCompact(this.a.a.compact);
            v5Var.b(pagetablecell);
            addView(v5Var);
        }
    }
