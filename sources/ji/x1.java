...
public final class x1 extends vg {
    ...
    public /* synthetic */ x1(Object obj, Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var, int i11) {
    ...
    public final boolean f() {
        switch (this.l0) {
            case 0:
                if (((c2) this.m0).L0 || this.r > 0) {
                }
                break;
            case 1:
                if (((a4) this.m0).W || this.r > 0) {
                }
                break;
        }
        return true;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ x1(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var, int i11) {
