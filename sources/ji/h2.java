...
public final class h2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, h2 h2Var) {
        ...
        h2Var.a = i6.l(richText).length() + h2Var.a;
    ...
    public static void b(TL_iv.PageBlock pageBlock, int i10, h2 h2Var) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            ...
            h2Var.b = pageblockblockquoteblocks.blocks.size() + h2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockDetails) {
            ...
            h2Var.b = pageblockdetails.blocks.size() + h2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockList) {
            ...
            h2Var.b = pageblocklist.items.size() + h2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            h2Var.b = pageblockorderedlist.items.size() + h2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockTable) {
            ...
            if (arrayList3 != null) {
                h2Var.b = arrayList3.size() + h2Var.b;
