...
public final class l implements c3.o, b0 {
    ...
    public final boolean a(c3.p pVar) {
        a1 a1Var;
        f0 n10 = o.n(pVar, false, (this.b & 2) != 0);
        if (n10 != null) {
            a1Var = i0.z(n10);
        } else {
            g0 g0Var = i0.b;
    ...
    public final void h(long j3, long j10) {
        ...
        for (k kVar : this.A) {
            s sVar = kVar.b;
            int e = d0.e(sVar.f, j10, false);
            while (true) {
                if (e < 0) {
                    e = -1;
                    break;
                } else if ((sVar.g[e] & 1) != 0) {
                    break;
                } else {
                    e--;
                }
    ...
    */
    public final a0 j(long j3) {
        ...
        if (i12 != -1) {
            ...
            j11 = jArr[e];
            j10 = jArr2[e];
            if (j11 < j3 && e < sVar.b - 1 && (a2 = sVar.a(j3)) != -1 && a2 != e) {
                j12 = jArr[a2];
                j14 = jArr2[a2];
                long j15 = j10;
                i10 = 0;
                ...
                if (i15 != 1) {
                            ...
                            if (i21 != 1) {
                                ...
                                if (i21 == 2) {
                                    ...
                                    while (i23 < i22 / 12) {
                                        ...
                                        j3 = length2;
                                        vVar = vVar5;
                                        arrayList.add(new m((j3 - nVar.c) - vVar5.l(), vVar.l()));
                                        i23++;
                                        length2 = j3;
                                        vVar5 = vVar;
                                        s12 = 2192;
                                    ...
                                    int length3 = (int) ((pVar.getLength() - pVar.getPosition()) - nVar.c);
                                    v vVar6 = new v(length3);
                                    pVar.readFully(vVar6.a, 0, length3);
                                    int i24 = 0;
                                    while (i24 < arrayList.size()) {
                                        m mVar = (m) arrayList.get(i24);
                                        vVar6.J((int) (mVar.a - position3));
                                        vVar6.K(i17);
                                        int l4 = vVar6.l();
                                        ...
                                        if (c13 == 2192) {
                                            ...
                                            List x10 = n.e.x(vVar6.v(i25, charset));
                                            for (int i26 = 0; i26 < x10.size(); i26++) {
                                                List x11 = n.d.x((CharSequence) x10.get(i26));
                                                if (x11.size() != 3) {
                                ...
                                if (vVar7.j() != 1397048916) {
                                    ...
                                    sVar.a = pVar.getPosition() - (nVar.c - 12);
                                    nVar.b = 2;
                                }
                            }
                            i14 = 1;
                    ...
                    if (i34 != 0) {
                        ...
                        while (this.r < i37) {
                            int i38 = this.s;
                            if (i38 == 0) {
                                if (this.t || f2.o.d(sVar4) + i34 > iArr[i31] - this.q) {
                                    i12 = i34;
                                    i13 = 0;
                                } else {
                                    i13 = f2.o.d(sVar4);
        ...
        while (true) {
            ...
            if (cVar.b == 1836019574) {
                ...
                if (d != null) {
                    ...
                    if (this.x) {
                        e2.d.h(p0Var);
                        f2.a b11 = o.b(p0Var, "auxiliary.tracks.interleaved");
                        if (b11 != null && b11.b[0] == 0) {
                            this.y = this.w + 16;
                        }
                        f2.a b12 = o.b(p0Var, "auxiliary.tracks.map");
                        e2.d.h(b12);
                        ArrayList d10 = b12.d();
                    ...
                    } else if (p0Var != null && (i13 & 64) != 0 && (b10 = o.b(p0Var, "auxiliary.tracks.offset")) != null) {
                ...
                p0 p0Var6 = p0Var3;
                ArrayList j10 = d.j(cVar, wVar, -9223372036854775807L, null, z10, z11, new o1(9));
                if (this.x) {
                ...
                while (i16 < j10.size()) {
                    ...
                    if (i18 == 0) {
                        ...
                        int i21 = "audio/true-hd".equals(sVar2.r) ? i19 * 16 : i19 + 30;
                        b2.r a2 = sVar2.a();
                        a2.r = i21;
                        if (i20 == 2) {
                            int i22 = sVar2.f;
                ...
                this.C = i15;
                this.D = j11;
                k[] kVarArr = (k[]) arrayList4.toArray(new k[0]);
                this.A = kVarArr;
                long[][] jArr = new long[kVarArr.length][];
                int[] iArr = new int[kVarArr.length];
                long[] jArr2 = new long[kVarArr.length];
                boolean[] zArr = new boolean[kVarArr.length];
                for (int i23 = 0; i23 < kVarArr.length; i23++) {
                    jArr[i23] = new long[kVarArr[i23].b.b];
                    jArr2[i23] = kVarArr[i23].b.f[0];
                }
                int i24 = 0;
                long j13 = 0;
                while (i24 < kVarArr.length) {
                    ...
                    long[] jArr3 = jArr[i25];
                    jArr3[i27] = j13;
                    s sVar3 = kVarArr[i25].b;
                    j13 += sVar3.d[i27];
                    int i28 = i27 + 1;
                    iArr[i25] = i28;
                    if (i28 < jArr3.length) {
                        jArr2[i25] = sVar3.f[i28];
                    } else {
                        zArr[i25] = true;
                        i24++;
                    }
