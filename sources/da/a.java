...
public final class a {
    ...
    public void c() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ((o0) this.f).a((f2.a) arrayList.get(i10));
        }
        m(arrayList);
        this.b = 0;
    }
    ...
    public void d() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (i11 == 1) {
                ...
                recyclerView.q0.c += i13;
            } else if (i11 == 4) {
                o0Var.a(aVar);
                o0Var.b(aVar.b, aVar.d, aVar.c);
            } else if (i11 == 8) {
                o0Var.a(aVar);
                o0Var.d(aVar.b, aVar.d);
            }
        }
        m(arrayList);
        this.b = 0;
    ...
    public void f(f2.a aVar, int i10) {
        ...
        if (i11 != 2) {
            ...
            o0Var.b(i10, aVar.d, aVar.c);
        } else {
            int i12 = aVar.d;
            RecyclerView recyclerView = o0Var.a;
            recyclerView.e0(i10, i12, true);
            recyclerView.t0 = true;
            recyclerView.q0.c += i12;
        }
    }
        ...
        while (i41 < size2) {
            ...
            if (i42 == 1) {
                ...
                while (i47 < i48) {
                    ...
                    m1 L2 = recyclerView2.L(i47, true);
                    if (L2 != null) {
                    }
                    L2 = null;
                    if (L2 != null || b(i47)) {
    ...
    */
    public String n() {
        ...
        de.b bVar = de.b.e;
        if (i) {
            ja.c cVar = (ja.c) this.f;
            if (cVar == null) {
                try {
                    ja.c cVar2 = new ja.c();
                    cVar2.a = new SoftReference(new String[3]);
                    this.f = cVar2;
                } catch (Throwable unused) {
                    i = false;
                }
            } else {
                String[] strArr = (String[]) ((SoftReference) cVar.a).get();
                if (strArr != null) {
                    str = strArr[0];
                    if (str == null) {
                        ...
                        if (bVar.b) {
                            ...
                            stringBuffer.append(de.b.a(cls.getName(), cls, bVar.a));
                        }
                        if (bVar.b) {
                            stringBuffer.append(" ");
                        }
                        ...
                        stringBuffer.append(de.b.a((String) this.d, cls2, bVar.d));
                        stringBuffer.append(".");
                        ...
                        if (bVar.b) {
                            ...
                            for (int i11 = 0; i11 < clsArr.length; i11++) {
                                ...
                                stringBuffer.append(de.b.a(cls3.getName(), cls3, bVar.a));
                            }
                            stringBuffer.append(")");
                    ...
                    if (i) {
                        ja.c cVar3 = (ja.c) this.f;
                        String[] strArr2 = (String[]) ((SoftReference) cVar3.a).get();
                        if (strArr2 == null) {
                            strArr2 = new String[3];
                            cVar3.a = new SoftReference(strArr2);
                        }
                        strArr2[0] = str;
                    }
                    return str;
