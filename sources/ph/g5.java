...
public final class g5 extends FrameLayout {
    ...
    public g5(Activity activity, int i10, nh.b bVar) {
        ...
        z3Var.a.getAvatarDrawable().m(i10, currentUser);
        nh.y3 y3Var = z3Var.a;
        y3Var.e(currentUser, y3Var.getAvatarDrawable());
        z3Var.b.l(Emoji.replaceEmoji(UserObject.getUserName(currentUser), z3Var.b.getPaint().getFontMetricsInt(), false), false);
