...
public class o6 extends View {
    ...
    public o6(Context context, int i10) {
        ...
        this.E = new Path();
        this.F = new Path();
        this.G = new org.telegram.ui.Components.z5(this, 0L, 350L, nrVar);
        this.H = new org.telegram.ui.Components.z5(this, 0L, 350L, nrVar);
        this.N = new TextPaint(1);
        this.a = i10;
        j6Var.u(AndroidUtilities.bold());
        j6Var.k(0.3f, 40L, nrVar);
    ...
    public final void e(float f10) {
        ...
        if (!TextUtils.equals(j6Var.g, str)) {
            j6Var.b();
            j6Var.k(0.3f, this.e ? 320L : 40L, nr.h);
