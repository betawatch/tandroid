...
public final class p9 extends FrameLayout {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ef0 ef0Var = daVar.C1;
        if (ef0Var != null) {
            float measuredWidth = ef0Var.getMeasuredWidth();
            float measuredHeight = daVar.C1.getMeasuredHeight();
            sk0 sk0Var = ef0Var.e;
            sk0Var.a = 0.0f;
            sk0Var.b = 0.0f;
        ...
        cf0 cf0Var = daVar.B1;
        if (cf0Var != null) {
            float measuredWidth2 = cf0Var.getMeasuredWidth();
            float measuredHeight2 = daVar.B1.getMeasuredHeight();
            jv0 jv0Var = cf0Var.d;
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [android.widget.FrameLayout, ph.z9] */
    @Override // android.view.View
