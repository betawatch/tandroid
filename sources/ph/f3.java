...
public class f3 extends View {
    ...
    public f3(Context context, int i10) {
        ...
        this.R = true;
        mr mrVar = mr.h;
        this.T = new org.telegram.ui.Components.z5(this, 350L, mrVar);
        this.b0 = AndroidUtilities.dp(2.0f);
        this.j0 = new gl0(this, 26);
        this.l0 = 1.0f;
                    ...
                    if (lineLeft <= f10 && this.I.getLineWidth(lineForVertical) + lineLeft >= f10 && i11 >= 0 && i11 <= this.I.getHeight()) {
                        ...
                        if (clickableSpanArr.length != 0 && !AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
                            ...
                            if (clickableSpan == null && motionEvent.getAction() == 0) {
                                g90 g90Var = new g90(clickableSpan, null, motionEvent.getX(), motionEvent.getY(), 0);
                                this.H0 = g90Var;
                                ...
                                invalidate();
                                AndroidUtilities.runOnUIThread(new kh.w(this, g90Var, clickableSpan), ViewConfiguration.getLongPressTimeout());
