...
public final class v2 extends bl0 {
    ...
    public final String F(int i10) {
        ...
        if (a3Var.W) {
            ...
            if (i11 >= 0 && i11 < a3Var.V.size()) {
                return LocaleController.formatYearMont(((t6) a3Var.V.get(i11)).d / 1000, true);
            }
            i11 -= a3Var.V.size();
        }
    ...
    public final void G(rl0 rl0Var, float f10, int[] iArr) {
        int k10 = k();
        float width = (rl0Var.getWidth() - rl0Var.getPaddingLeft()) - rl0Var.getPaddingRight();
        a3 a3Var = this.c;
        m2 m2Var = a3Var.e;
        float f11 = m2Var.J;
        int i10 = (int) (((int) (width / f11)) * a3Var.L);
        int ceil = (int) Math.ceil(k10 / f11);
        float lerp = (AndroidUtilities.lerp(0, Math.max(0, r2 - ((AndroidUtilities.displaySize.y - rl0Var.getPaddingTop()) - rl0Var.getPaddingBottom())), f10) / (ceil * i10)) * ceil;
        int round = Math.round(lerp);
        iArr[0] = Math.max(0, m2Var.J * round) + 2;
        iArr[1] = rl0Var.getPaddingTop() + ((int) ((lerp - round) * i10));
    }
    ...
    public final float H(rl0 rl0Var) {
        ...
        return (Math.max(0, rl0Var.computeVerticalScrollOffset() - r2.getPadding()) - rl0Var.getPaddingTop()) / ((((int) Math.ceil(k10 / f10)) * ((int) (((int) (width / f10)) * r2.L))) - (AndroidUtilities.displaySize.y - rl0Var.getPaddingTop()));
    }
        ...
        if (i11 == 2) {
            ...
            if (a3Var.W) {
                if (i12 == 0) {
                    ...
                    x2Var.e(arrayList2.size(), (t6) arrayList2.get(0));
                    return;
                }
                i12 = i10 - 3;
            } else if (a3Var.a0) {
                if (i12 >= 0 && i12 < arrayList2.size()) {
                    x2Var.f(-1, false, false);
                    x2Var.e(0, (t6) arrayList2.get(i12));
                    return;
                }
                i12 -= arrayList2.size();
            }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            h51Var.addView(textView, k7.b6.d(-1, -1.0f, 119, 0.0f, 0.0f, z4 ? 32.0f : 0.0f, 0.0f));
            a3Var.f0 = h51Var;
            view = h51Var;
        } else {
