...
public final class oa extends View {
    ...
    public oa(Context context, ViewGroup viewGroup, p9 p9Var, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ba baVar) {
        ...
        this.V = 1;
        mr mrVar = mr.h;
        this.W = new org.telegram.ui.Components.z5(this, 0L, 360L, mrVar);
        this.a0 = new org.telegram.ui.Components.z5(this, 360L, mrVar);
        this.b0 = new org.telegram.ui.Components.z5(this, 0L, 360L, mrVar);
        this.c0 = new org.telegram.ui.Components.z5(this, 360L, mrVar);
        this.d0 = new org.telegram.ui.Components.z5(this, 0L, 360L, mrVar);
        this.e0 = new org.telegram.ui.Components.z5(this, 0L, 360L, mrVar);
        this.f0 = new org.telegram.ui.Components.z5(this, 0L, 320L, mrVar);
        this.g0 = true;
        this.l0 = new RectF();
        this.m0 = new Path();
        this.p0 = new na();
        ...
        this.S0 = paint8;
        this.T0 = new um0(getContext(), null);
        this.W0 = -1L;
        this.X0 = -1L;
        this.Y0 = new org.telegram.ui.Components.z5(0.0f, this, 0L, 340L, mrVar);
        this.Z0 = -1L;
        this.e1 = -1;
        this.f1 = -1;
        this.g1 = -1;
        ...
        this.V0 = new z61(this, viewGroup, f6Var, baVar, p9Var, 2);
    }
    ...
    public static void a(final oa oaVar, ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ba baVar, View view) {
        ...
        try {
            if (i11 == 2 && oaVar.K) {
                n6 n6Var = new n6(oaVar.getContext(), 0);
                n6Var.b = 0.0f;
                n6Var.c = 1.5f;
                n6Var.d(oaVar.S);
                final int i12 = 0;
                n6Var.h = new Utilities.Callback(oaVar) { // from class: ph.fa
                ...
                p70 F = p70.F(viewGroup, f6Var, oaVar);
                F.q(n6Var);
                F.o();
                ...
                n6 n6Var2 = new n6(oaVar.getContext(), 0);
                n6Var2.b = 0.0f;
                n6Var2.c = 1.5f;
                n6Var2.d(oaVar.I);
                final int i16 = 1;
                n6Var2.h = new Utilities.Callback(oaVar) { // from class: ph.fa
                    public final /* synthetic */ oa b;
                ...
                p70 F2 = p70.F(viewGroup, f6Var, oaVar);
                F2.q(n6Var2);
                F2.o();
                ...
                n6 n6Var3 = new n6(oaVar.getContext(), 0);
                n6Var3.b = 0.0f;
                n6Var3.c = 1.5f;
                n6Var3.d(oaVar.h.i);
                final int i20 = 2;
                n6Var3.h = new Utilities.Callback(oaVar) { // from class: ph.fa
                    public final /* synthetic */ oa b;
                ...
                p70 F3 = p70.F(viewGroup, f6Var, oaVar);
                F3.q(n6Var3);
                F3.V(5);
                F3.U = true;
                ...
                n6 n6Var4 = new n6(oaVar.getContext(), 0);
                n6Var4.b = 0.0f;
                n6Var4.c = 1.5f;
                n6Var4.d(jaVar.i);
                n6Var4.h = new s1(7, oaVar, jaVar);
                p70 F4 = p70.F(viewGroup, f6Var, oaVar);
                F4.q(n6Var4);
                F4.V(5);
                F4.U = true;
                    ...
                    if (z11) {
                        ...
                        if (z10) {
                            ...
                            if (this.D || this.h == null) {
                                ...
                                f26 = vh.w2.c((j10 + this.E) - j11, f10, f28, f27);
                                f25 = f29;
                            }
                            if (x10 >= f25 && x10 <= f26) {
                                return 9;
                            ...
                            if (this.M || (this.h == null && !this.B)) {
                                ...
                                f37 = vh.w2.c((j12 + this.O) - j13, f10, f39, f38);
                                f36 = f40;
                            }
                            if (x10 >= f36 && x10 <= f37) {
                                return 5;
                        ...
                        for (int i11 = 0; i11 < arrayList.size(); i11++) {
                            ...
                            if (rectF.contains(x10, y10)) {
                                ...
                                float c3 = vh.w2.c(r6 + r11, f10, f43, f41);
                                this.f1 = i11;
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (e > 0.0f) {
            ...
            if (arrayList2.isEmpty()) {
                ...
                while (i26 < arrayList2.size()) {
                    ...
                    if (jaVar7 != oaVar.v) {
                        ...
                        f51 = (f92 * f93) + f90;
                        path = path2;
                        c10 = vh.w2.c(r8 + jaVar7.e, f91, f93, f90);
                    }
                    float f94 = f51;
                    canvas2.save();
            ...
            if (e11 > 0.0f) {
                ...
                if (oaVar.h != null) {
                    ...
                    c3 = vh.w2.c(j19 + r6, f123, f124, f122);
                    f44 = f125;
                }
                float f126 = oaVar.u1;
            ...
            if (e13 > 0.0f) {
                ...
                if (oaVar.h == null && !oaVar.B && arrayList3.isEmpty()) {
                    ...
                    paint2 = paint;
                    f36 = f149;
                    v = vh.w2.c(r10 + oaVar.O, f155, f156, f153);
                    lerp = f157;
                } else {
                    f36 = f149;
                    f37 = f17;
        ...
        if (oaVar.j1) {
            ...
            if (i42 == 4 && (jaVar2 = oaVar.h) != null) {
                ...
                ia iaVar = oaVar.a;
                if (iaVar != null) {
                    iaVar.C0(oaVar.h.g, false);
                    oaVar.a.B1(oaVar.h.h);
                }
                oaVar.invalidate();
            } else if (i42 == 8) {
                float f216 = oaVar.P;
    ...
    public final void e(Canvas canvas, Paint paint, float f10, float f11, float f12, float f13, float f14) {
        ...
        rectF.set(e2.c.x(AndroidUtilities.dp(this.U0 ? 2.5f : 10.0f), dp, 2.0f, f13), f16, kf.k0.b(AndroidUtilities.dp(this.U0 ? 2.5f : 10.0f), dp, 2.0f, f13), f17);
        if (!this.U0) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), paint5);
            if (paint != null) {
                paint4.setAlpha((int) (f14 * 48.0f));
    ...
    public final void h(float f10) {
        ...
        ia iaVar5 = this.a;
        if (iaVar5 != null) {
            iaVar5.i2(this.N + ((long) (this.P * this.O)));
        }
        boolean z4 = this.j1;
        ...
        if (jaVar2 != jaVar && jaVar2 != null) {
            if (this.n == this.s.indexOf(jaVar)) {
                ...
                if (j18 > j14) {
                    ...
                    ia iaVar2 = this.a;
                    if (iaVar2 != null) {
                        iaVar2.i1(jaVar.g, jaVar.a);
                        this.a.A1(jaVar.h, jaVar.a);
                    }
                } else if (j18 < j15) {
    ...
    public final void j(float f10) {
        ...
        ia iaVar5 = this.a;
        if (iaVar5 != null) {
            iaVar5.P0(this.F + ((long) (this.G * this.E)));
        }
        boolean z4 = this.j1;
        if (z4 || (iaVar = this.a) == null) {
            if (z4 || this.o1) {
    ...
    public final boolean m(float f10, boolean z4) {
        ...
        gg.y1 y1Var2 = new gg.y1(this, clamp, 27);
        this.a1 = y1Var2;
    ...
    */
            ...
            if (motionEvent.getAction() != 0 || motionEvent.getY() >= timelineHeight) {
                ...
                if (action == 0) {
                    ...
                    if (!this.U0) {
                        ...
                        AndroidUtilities.runOnUIThread(z61Var, ViewConfiguration.getLongPressTimeout());
                    }
                        ...
                        if (jaVar2 != null && this.e1 == 1) {
                            ...
                            if (i15 == 6 || i15 == 7 || i15 == 8) {
                                ...
                                if (this.e1 == 8) {
                                    ...
                                    if (iaVar8 != null) {
                                        iaVar8.v1(f28);
                                        this.a.i2(this.N + ((long) (this.P * this.O)));
                                        this.a.j1(this.Q);
                                    }
                                    ia iaVar9 = this.a;
                                    if (iaVar9 != null) {
                                ...
                                if (i15 == 10) {
                                    ...
                                    ia iaVar11 = this.a;
                                    if (iaVar11 != null) {
                                        iaVar11.P0(this.F + ((long) (this.G * this.E)));
                                    }
                                    ia iaVar12 = this.a;
                                    if (iaVar12 != null) {
                                        iaVar12.e0(this.G);
                                ...
                                if (this.e1 == 12) {
                                    ...
                                    if (iaVar14 != null) {
                                        iaVar14.e0(f37);
                                        this.a.P0(this.F + ((long) (this.G * this.E)));
                                        this.a.W1(this.H);
                                    }
                                    ia iaVar15 = this.a;
                                    if (iaVar15 != null) {
                                    ...
                                    if (i19 == 13) {
                                        ...
                                        if (jaVar11 == this.v) {
                                            ...
                                            if (!this.l1 && f11 < 0.0f) {
                                                ...
                                                iaVar3 = this.a;
                                                if (iaVar3 != null) {
                                                    iaVar3.b2(jaVar11.a, jaVar11.f);
                                                }
                                                iaVar4 = this.a;
                                                if (iaVar4 != null) {
                                                    iaVar4.i1(jaVar11.g, jaVar11.a);
                                                }
                                            }
                                        } else {
                                            f11 = f38;
                                        ...
                                        if (i19 == 14) {
                                            ...
                                            ia iaVar17 = this.a;
                                            if (iaVar17 != null) {
                                                iaVar17.A1(jaVar11.h, jaVar11.a);
                                            }
                                        }
                                    }
                                    if (this.e1 == 15) {
                                        ...
                                        ia iaVar18 = this.a;
                                        if (iaVar18 != null) {
                                            iaVar18.i1(f40, jaVar11.a);
                                            this.a.b2(jaVar11.a, jaVar11.f);
                                            this.a.A1(jaVar11.h, jaVar11.a);
                                        }
                                        ia iaVar19 = this.a;
                                        if (iaVar19 != null) {
                                            z14 = true;
                        ...
                        if ((System.currentTimeMillis() - this.c1 > ViewConfiguration.getTapTimeout() || this.j1) && this.g0) {
                            ...
                            if (i21 == 16 && (velocityTracker5 = this.m1) != null) {
                                ...
                                if (this.h != null && Math.abs(xVelocity) > AndroidUtilities.dp(100.0f)) {
                                    ...
                                    int c3 = (int) vh.w2.c(this.h.e - min11, f53, f54, f52);
                                    this.o1 = true;
                                    this.p1 = i24;
                                ...
                                if (this.h != null && Math.abs(xVelocity2) > AndroidUtilities.dp(100.0f)) {
                                    ...
                                    int c10 = (int) vh.w2.c(this.h.e - min12, f56, f57, f55);
                                    this.o1 = true;
                                    this.p1 = i26;
                                ...
                                if (Math.abs(xVelocity3) > AndroidUtilities.dp(100.0f)) {
                                    ...
                                    if (jaVar18 != null) {
                                        ...
                                        float f63 = this.r1;
                                        this.T0.c(i27, 0, xVelocity3, 0, (int) (((j10 / min13) * f63) + f62), (int) vh.w2.c(j11, min13, f63, f62), 0, 0);
                                        z4 = false;
                                    }
                                    j10 = (long) (f10 - j12);
                                    j11 = j13;
                                    ...
                                    float f632 = this.r1;
                                    this.T0.c(i27, 0, xVelocity3, 0, (int) (((j10 / min13) * f632) + f622), (int) vh.w2.c(j11, min13, f632, f622), 0, 0);
                                    z4 = false;
                                }
                                ...
                                if (Math.abs(xVelocity4) > AndroidUtilities.dp(100.0f)) {
                                    ...
                                    float f67 = this.r1;
                                    this.T0.c(i28, 0, xVelocity4, 0, (int) (((j14 / min14) * f67) + f66), (int) vh.w2.c(j15, min14, f67, f66), 0, 0);
                                    z4 = false;
                                }
                            }
                            y1Var = this.a1;
                                ...
                                if (i29 == 3) {
                                    ...
                                    if (i30 != i31) {
                                        ...
                                        if (this.a != null && i31 >= 0 && i31 < arrayList.size()) {
                                            this.a.d(((ja) arrayList.get(this.h1)).a);
                                        }
                                        invalidate();
                                    }
                                }
    ...
    public final void q() {
        eu euVar = new eu(17);
        ArrayList arrayList = this.s;
        Collections.sort(arrayList, euVar);
    ...
    public void setCollage(ArrayList<t6> arrayList) {
        ArrayList arrayList2;
        ArrayList arrayList3;
        ma maVar;
        int i10 = 0;
        ...
        if (arrayList != null) {
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                arrayList3.add(null);
                t6 t6Var = arrayList.get(i12);
                if (t6Var.K) {
                    ja jaVar2 = new ja(this);
                    jaVar2.a = i12;
                    jaVar2.b = false;
                    jaVar2.d = t6Var.L.getAbsolutePath();
                    jaVar2.e = t6Var.h0;
                    jaVar2.f = t6Var.X;
                    jaVar2.i = t6Var.P;
                    jaVar2.g = t6Var.V;
