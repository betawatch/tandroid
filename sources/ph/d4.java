        ...
        switch (this.a) {
            ...
            case 2:
                ...
                if (d7Var.e0 || d7Var.d0 != null) {
                    TLRPC.WebPage webPage = d7Var.d0;
                ...
                i51 i14 = i51.i(2, LocaleController.getString(R.string.StoryLinkNameHeader));
                i14.K(d7Var.j0);
                arrayList.add(i14);
                if (d7Var.j0) {
            ...
            case 6:
                ...
                break;
            case 7:
                ((rh.k) this.b).E0((ArrayList) obj, (w51) obj2);
                break;
            case 8:
                rh.s.U((rh.s) this.b, (ArrayList) obj);
                break;
            case 9:
            ...
            case 11:
                ...
                break;
            case 12:
                ((rh.e3) this.b).F0((ArrayList) obj, (w51) obj2);
                break;
            case 13:
                ((rh.y3) this.b).U((ArrayList) obj, (w51) obj2);
                break;
            case 14:
            ...
            case 15:
                ...
                if (TextUtils.isEmpty(tL_sponsoredPeer.sponsor_info) && TextUtils.isEmpty(tL_sponsoredPeer.additional_info)) {
                    ...
                    z4 = false;
                    I.c(R.drawable.msg_channel, LocaleController.getString(R.string.SponsoredMessageSponsorReportable), new kh.z2(I, J2, i11), false);
                }
            ...
            case 18:
                ...
                break;
            case 19:
                final uf.k0 k0Var = (uf.k0) this.b;
                ...
                if (k0Var.J != null) {
                    ...
                    i51Var3.D = new View.OnClickListener() { // from class: uf.h0
                        ...
                        public final void onClick(View view) {
                            switch (i17) {
                                ...
                                default:
                                    k0 k0Var6 = k0Var;
                                    k0Var6.G.manage_stories = !r0.manage_stories;
                                    k0Var6.c.V2.N(true);
                                    k0Var6.Y(true);
                                    break;
                            }
                    ...
                    boolean z11 = false;
                    for (int i18 = 0; i18 < k0Var.d.d.size(); i18++) {
                        TLObject tLObject = (TLObject) k0Var.d.d.get(i18);
                    ...
                    for (int i19 = 0; i19 < k0Var.d.e.size(); i19++) {
                        TLObject tLObject2 = (TLObject) k0Var.d.e.get(i19);
                    ...
                    if (longSparseArray.size() <= 0 && (!TextUtils.isEmpty(k0Var.f.getText().toString()) || k0Var.d.e() || k0Var.x)) {
                        arrayList5.add(i51.k(k0Var.n));
                        z11 = true;
                    }
                    k0Var.h.setVisibility(z11 ? 0 : 8);
                    w51Var3.T();
                }
                ...
                k0Var.v.a(arrayList5, w51Var3, k0Var.J != null);
                ...
                if (k0Var.J != null) {
                    ...
                    m9.f = !k0Var.M;
                    final int i20 = 1;
                    m9.D = new View.OnClickListener() { // from class: uf.h0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i20) {
                                case 0:
                    ...
                    m10.f = !k0Var.N;
                    final int i21 = 2;
                    m10.D = new View.OnClickListener() { // from class: uf.h0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i21) {
                                case 0:
                    ...
                    m11.f = !k0Var.O;
                    final int i22 = 3;
                    m11.D = new View.OnClickListener() { // from class: uf.h0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i22) {
                                case 0:
                    ...
                    final int i23 = 4;
                    m12.D = new View.OnClickListener() { // from class: uf.h0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i23) {
                                case 0:
                ...
                break;
            case 20:
                uf.m0.U((uf.m0) this.b, (ArrayList) obj, (w51) obj2);
                break;
            case 21:
                ...
                arrayList6.add(i51.B(null));
                if (u0Var.w != null && (u0Var.x != null || !TextUtils.isEmpty(u0Var.y))) {
                    z10 = true;
                }
                u0Var.D = z10;
                if (z10) {
            ...
            case 23:
                ...
                if (z0Var.r) {
                    for (int i26 = 0; i26 < arrayList8.size(); i26++) {
                        ...
                        uf.w0 w0Var = (uf.w0) arrayList8.get(i26);
                        if (!z0Var.U()) {
                            int i27 = i26 * 3;
                            arrayList7.add(i51.f(LocaleController.getString(R.string.BusinessHoursDayOpenHour), uf.w0.a(w0Var.a), i27));
                            arrayList7.add(i51.f(LocaleController.getString(R.string.BusinessHoursDayCloseHour), uf.w0.a(w0Var.b), i27 + 1));
                            i51 e6 = i51.e(i27 + 2, LocaleController.getString(R.string.Remove));
                            e6.r = true;
                            arrayList7.add(e6);
                        }
                    }
            ...
            case 26:
                ...
                break;
            case 27:
                Utilities.themeQueue.postRunnable(new uf.v0(i12, (String[]) this.b, (Utilities.Callback2) obj2));
                break;
            case 28:
                vh.v vVar2 = (vh.v) this.b;
                ArrayList arrayList10 = (ArrayList) obj;
                arrayList10.add(i51.j(1, vVar2.X));
                arrayList10.add(i51.j(3, vVar2.a0));
                if (vVar2.f0 != null) {
                    arrayList10.add(i51.j(2, vVar2.Y));
                    break;
                }
                break;
            default:
                vh.r3.I1((vh.r3[]) this.b, (ArrayList) obj, (w51) obj2);
                break;
        }
    }
}
