...
public abstract class y extends FrameLayout implements o70 {
    ...
    */
    ...
    public long getDuration() {
        x mainPart;
        t6 t6Var;
        if (!this.k0 || (mainPart = getMainPart()) == null || (t6Var = mainPart.n) == null) {
            return 1L;
        }
        return Math.max(Math.min((long) ((t6Var.W - t6Var.V) * t6Var.h0), 59500L), 1L);
    }
    ...
    public ArrayList<Integer> getOrder() {
        ...
        while (true) {
            ...
            i10 = ai.d(((x) arrayList2.get(i10)).a, i10, 1, arrayList);
        }
    }
    ...
    public final void h(float f10, Canvas canvas, RectF rectF, View view) {
        ...
        canvas.restore();
        if (view != this.d || (n5Var = this.c) == null) {
            return;
        }
        Paint paint = n5Var.i;
        org.telegram.ui.Components.z5[] z5VarArr = n5Var.h;
        org.telegram.ui.Components.z5[] z5VarArr2 = n5Var.g;
        Path path = n5Var.j;
        m5 m5Var = n5Var.c;
        if (m5Var == null || m5Var.b.length <= 0) {
            return;
        }
        float e = n5Var.d.e(n5Var.b);
        float d = n5Var.e.d(n5Var.c.c, false);
        float width = (rectF.width() * d) + rectF.left;
        float d10 = n5Var.f.d(n5Var.c.d, false);
        ...
        if (e > 0.0f) {
            path.rewind();
            int min = Math.min(4, n5Var.c.b.length);
            int i10 = 0;
            while (i10 < min) {
                int i11 = i10 - 1;
                if (i11 < 0) {
                ...
                float f11 = e;
                float width2 = (rectF.width() * (z5VarArr4[i11].d(pointF.x - m5Var2.c, false) + d)) + rectF.left;
                float height2 = (rectF.height() * (z5VarArr3[i11].d(pointF.y - n5Var.c.d, false) + d10)) + rectF.top;
                float width3 = (rectF.width() * (z5VarArr4[i10].d(pointF2.x - n5Var.c.c, false) + d)) + rectF.left;
                float height3 = (rectF.height() * (z5VarArr3[i10].d(pointF2.y - n5Var.c.d, false) + d10)) + rectF.top;
                float width4 = (rectF.width() * (z5VarArr4[i13].d(pointF3.x - n5Var.c.c, false) + d)) + rectF.left;
                float height4 = ((rectF.height() * (z5VarArr3[i13].d(pointF3.y - n5Var.c.d, false) + d10)) + rectF.top) - height3;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt == this.d) {
                ...
                if (xVar == null || (t6Var = xVar.n) == null || (i12 = t6Var.k0) <= 0 || (i13 = t6Var.l0) <= 0) {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
                } else {
                    if (t6Var.Q % 90 == 1) {
                        i13 = i12;
