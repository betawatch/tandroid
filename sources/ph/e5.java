...
public final class e5 extends View {
    ...
    public final /* synthetic */ f5 x;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e5(f5 f5Var, Context context, String str, boolean z4) {
        super(context);
        ...
        this.b = paint2;
        this.r = new org.telegram.ui.Components.z5(this, 0L, 220L, mr.h);
        this.s = true;
        this.n = z4;
        ...
        setOnClickListener(new oh.n(this, 10));
    }
    ...
    public final void setPressed(boolean z4) {
        ...
        if (isPressed() != z4) {
            ...
            if (f10 != 0.0f) {
                ...
                this.w = ofFloat;
                ofFloat.addUpdateListener(new nh.e5(this, 19));
