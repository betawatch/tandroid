...
public abstract class r3 extends FrameLayout {
    ...
    public r3(Context context, nh.b bVar, org.telegram.ui.Components.ba baVar) {
        ...
        path.moveTo(-AndroidUtilities.dp(4.33f), AndroidUtilities.dp(4.33f));
        path.lineTo(AndroidUtilities.dp(4.33f), -AndroidUtilities.dp(4.33f));
        this.a = new org.telegram.ui.Components.fa(baVar, this, 0, !v8Var.L.o0.c());
        setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(44.0f));
        final int i10 = 0;
        m3 m3Var = new m3(v8Var, context, UserConfig.selectedAccount, new Utilities.Callback2() { // from class: ph.l3
            ...
            public final void run(Object obj, Object obj2) {
                ...
                switch (i11) {
                    case 0:
                        ...
                        w51Var.M();
                        int i13 = 0;
                        for (int i14 = 0; i14 < v8Var2.d.size(); i14++) {
                            Integer num = (Integer) v8Var2.d.get(i14);
                            int intValue = num.intValue();
                            t6 t6Var = (t6) v8Var2.c.get(intValue);
                            int i15 = p3.a;
                            i51 J = i51.J(p3.class);
                            J.d = intValue;
                            J.G = t6Var;
                            J.z = i13;
                            J.K(v8Var2.f == intValue);
                            J.f = v8Var2.e.contains(num);
                    ...
                    default:
                        ...
                        AndroidUtilities.forEachViews((RecyclerView) v8Var2.b, (h5.d) new mg.i(v8Var2, 4));
                        break;
                }
            }
        ...
        m3Var.v1(true);
        final int i11 = 1;
        m3Var.A1(new Utilities.Callback2() { // from class: ph.l3
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                int i112 = i11;
                int i12 = 0;
    ...
    public final void c(boolean z4, boolean z10) {
        ...
        if (z10) {
            ...
            org.telegram.ui.b.p(m3Var.animate().alpha(z4 ? 1.0f : 0.0f).scaleX(z4 ? 1.0f : 0.65f).scaleY(z4 ? 1.0f : 0.65f).setListener(new s61(10, this, z4)).setUpdateListener(new nh.e5(this, 17)), mr.h, 360L);
        } else {
    ...
    public void setSelected(int i10) {
        ...
        this.f = i10;
        AndroidUtilities.forEachViews((RecyclerView) this.b, (h5.d) new l60(this, i10, 1));
    }
}
