...
public final class s0 {
    ...
    public s0(u6 u6Var) {
        ...
        this.q = u6Var.j0;
        this.r = j10;
        u6Var.n0.getValues(fArr);
        this.t = u6Var.A0;
        this.u = u6Var.B0;
        CharSequence[] charSequenceArr = {u6Var.C0};
        this.w = u6Var.D0 ? MediaDataController.getInstance(u6Var.a).getEntities(charSequenceArr, true) : null;
        ...
        this.i0 = u6Var.L0;
        this.j0 = u6Var.S;
        this.k0 = VideoEditedInfo.Part.toParts(u6Var);
    }
    ...
    public final u6 a() {
        ...
        if (str4 != null) {
            ...
            u6Var.C0 = MessageObject.replaceAnimatedEmoji(replaceEmoji, this.w, org.telegram.ui.ActionBar.j6.o2.getFontMetricsInt());
        } else {
            u6Var.C0 = "";
        }
        ...
        u6Var.L0 = this.i0;
        u6Var.S = this.j0;
        u6Var.T = VideoEditedInfo.Part.toStoryEntries(this.k0);
        return u6Var;
    }
