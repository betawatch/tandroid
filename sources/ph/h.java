...
public final class h {
    public final f a;
    public final TLRPC.TL_messageMediaPoll b;
    public final TLRPC.TL_inputMediaPoll c;
    public final long d;
    ...
    public h(f fVar, TLRPC.TL_messageMediaPoll tL_messageMediaPoll, long j3, String str, ArrayList arrayList, ArrayList arrayList2) {
        ...
        if (fVar != null) {
            ...
            for (int i12 = 0; i12 < size3; i12++) {
                ...
                if (eVar2 instanceof qh.e) {
                    TLRPC.TL_messageMediaWebPage tL_messageMediaWebPage = new TLRPC.TL_messageMediaWebPage();
                    TLRPC.TL_webPage tL_webPage = new TLRPC.TL_webPage();
                    tL_messageMediaWebPage.webpage = tL_webPage;
                    String str2 = ((qh.e) eVar2).b;
                    tL_webPage.display_url = str2;
                    tL_webPage.url = str2;
                    f.l(tL_messageMediaPoll, keyAt2, tL_messageMediaWebPage);
                } else if (eVar2 instanceof qh.f) {
                    f.l(tL_messageMediaPoll, keyAt2, ((qh.f) eVar2).b);
                } else if (eVar2 instanceof qh.h) {
                    TLRPC.TL_messageMediaDocument tL_messageMediaDocument = new TLRPC.TL_messageMediaDocument();
                    tL_messageMediaDocument.document = ((qh.h) eVar2).b;
                    f.l(tL_messageMediaPoll, keyAt2, tL_messageMediaDocument);
                }
            }
        }
        this.b = tL_messageMediaPoll;
        this.c = tL_inputMediaPoll;
    }
}
