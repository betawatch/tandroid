...
public abstract class z2 extends ql0 {
    public boolean d;
    public String f;
    public String h;
    public TLRPC.User n;
    ...
    public final org.telegram.ui.web.q0 v = new org.telegram.ui.web.q0(this, 19);
    ...
    public final void E() {
        ...
        if (user == null && !this.r) {
            ...
            this.e = ConnectionsManager.getInstance(i10).sendRequest(tL_contacts_resolveUsername, new qi1(2, this, messagesController));
        } else {
            if (user == null) {
                return;
            }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        return new dl0(new lh.z4(this.w.getContext(), 1));
    }
}
