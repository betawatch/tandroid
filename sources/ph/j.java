...
public final class j extends z10 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void x0(j jVar, Context context) {
        if (jVar.P.S) {
            ...
            int i10 = jVar.U.duration_months;
            hz0Var.c(string, i10 <= 0 ? LocaleController.getString(R.string.Infinity) : (i10 < 12 || i10 % 12 != 0) ? LocaleController.formatPluralString("Months", i10, new Object[0]) : LocaleController.formatPluralString("Years", i10 / 12, new Object[0]), null, null);
            ...
            alertDialog$Builder.a.N = LocaleController.getString(R.string.AffiliateProgramAlert);
            alertDialog$Builder.a.P = LocaleController.getString(jVar.S ? R.string.AffiliateProgramStartAlertText : R.string.AffiliateProgramUpdateAlertText);
            alertDialog$Builder.n(frameLayout);
            alertDialog$Builder.k(LocaleController.getString(jVar.S ? R.string.AffiliateProgramStartAlertButton : R.string.AffiliateProgramUpdateAlertButton), new l4.s0(dVar, 24));
            j7.l1.u(R.string.Cancel, alertDialog$Builder, null);
        }
    }

    public static /* synthetic */ void y0(j jVar, org.telegram.ui.ActionBar.c2 c2Var, TLObject tLObject, TLRPC.TL_error tL_error) {
        long j10 = jVar.L;
        c2Var.dismiss();
    ...
    public static /* synthetic */ void z0(j jVar, org.telegram.ui.ActionBar.c2 c2Var, TLObject tLObject, TLRPC.TL_error tL_error) {
        long j10 = jVar.L;
        c2Var.dismiss();
        if (!(tLObject instanceof TL_payments.starRefProgram)) {
            if (tL_error != null) {
    ...
    public final void E0(ArrayList arrayList, k51 k51Var) {
        ...
        u7Var.a = i10;
        u7Var.b = i12;
        u7Var.e = new fa(rhVar, 7);
        w41Var2.G = u7Var;
        w41Var2.B = -1L;
        w41Var2.B = this.T == null ? -1 : r3.commission_permille;
    ...
    public final void H0(boolean z10) {
        ...
        dVar.run();
        this.Q.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString((this.S || this.U.end_date != 0) ? R.string.AffiliateProgramStartInfo : R.string.AffiliateProgramUpdateInfo), new d(this, 2)));
        I0();
        e eVar = this.Y;
        if (eVar != null) {
            eVar.N(z10);
    ...
    public final void I0() {
        ...
        nVar.setEnabled(starrefprogram2.end_date == 0 && !((starrefprogram = this.T) != null && starrefprogram.commission_permille == starrefprogram2.commission_permille && starrefprogram.duration_months == starrefprogram2.duration_months));
    }
    ...
    public final View createView(Context context) {
        ...
        new op0(this, context, 8).setBackgroundColor(g6.w0(null, g6.i5, false));
        ...
        this.O = linearLayout;
        linearLayout.setOrientation(1);
        this.O.setBackgroundColor(getThemedColor(g6.d6));
        ...
        int i10 = 2;
        jh.n nVar = new jh.n(i10, context, this.resourceProvider, true);
        ...
        this.Q = y80Var;
        y80Var.setTextColor(getThemedColor(g6.z6));
        ...
        this.c.setOnItemClickListener(new bg.o(this, 19));
        f2.l lVar = new f2.l();
        lVar.m = false;
        lVar.C = false;
        lVar.o(jr.h);
    ...
    public final int getNavigationBarColor() {
        return getThemedColor(g6.d6);
    }

    @Override // org.telegram.ui.z10
    public final f2.p0 n0() {
        e eVar = new e(this, this.c, getParentActivity(), this.currentAccount, this.classGuid, new t4(this, 7), getResourceProvider());
        this.Y = eVar;
        return eVar;
    }
