            ...
            case 0:
                ...
                if (daVar2.H1 != null && daVar2.z2 == null && daVar2.f1 != null) {
                    ...
                    if (valueAnimator == null || !valueAnimator.isRunning()) {
                        ...
                        uo uoVar = new uo(daVar2, daVar2.b, z10, canvas, (daVar2.f1.getMeasuredWidth() / 2.0f) + f10, (daVar2.f1.getMeasuredHeight() / 2.0f) + f11, max, paint, createBitmap, paint2, f10, f11, 2);
                        daVar2.z2 = uoVar;
                        ...
                        daVar2.B2.setInterpolator(z10 ? nr.i : nr.h);
                        daVar2.B2.start();
            ...
            case 6:
                if (daVar.c0 == 0 && !daVar.X1) {
                    ...
                    if (!daVar.F0.e && !daVar.x0.j()) {
                        ...
                        daVar.D0.a(new jc0(daVar.w0, false), true);
