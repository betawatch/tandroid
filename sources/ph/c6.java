...
public final class c6 extends View {
    ...
    public final void a() {
        ...
        this.r = new k01(b6Var.b(), 16.0f, AndroidUtilities.bold());
    ...
    public void setLink(String str) {
        ...
        b6 b6Var = this.B;
        if (!(b6Var == null && this.E == null) && (b6Var == null || TextUtils.equals(b6Var.a, str) || TextUtils.equals(this.F, str))) {
            b6 b6Var2 = this.B;
            if (b6Var2 == null || this.y || !TextUtils.equals(b6Var2.a, str)) {
                return;
            }
            this.y = true;
            a();
