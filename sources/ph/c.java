...
public final class c extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
    ...
    public c(Activity activity, f6 f6Var, eo eoVar) {
        ...
        this.E = new Rect();
        int i10 = 16;
        org.telegram.tgnet.j jVar = new org.telegram.tgnet.j(this, i10);
        wr wrVar = wr.h;
        this.H = new le.b(0, jVar, wrVar, 380L, false);
        this.I = new le.b(0, new org.telegram.tgnet.j(this, i10), wrVar, 380L, false);
        this.d = eoVar;
        this.x = eoVar.getMessagesController().config.pollAnswerLengthMax.get();
    ...
    public static void a(c cVar) {
        ...
        int i10 = j6.A6;
        eo eoVar = cVar.d;
        l5Var.setTextColor(i0.a.d(cVar.I.e, j6.v0(i10, eoVar.getResourceProvider()), j6.v0(j6.p7, eoVar.getResourceProvider())));
    }
