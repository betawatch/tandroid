...
public final class b7 extends FrameLayout {
    ...
    public b7(Context context) {
        ...
        addView(imageView, k7.b6.d(48, 48.0f, 19, 9.0f, 0.0f, 0.0f, 0.0f));
        ImageView imageView2 = new ImageView(context);
        this.c = imageView2;
        imageView2.setBackground(new z6(AndroidUtilities.dp(20.0f), AndroidUtilities.dp(2.4f), -15033089));
        addView(imageView2, k7.b6.d(48, 48.0f, 19, 9.0f, 0.0f, 0.0f, 0.0f));
        ...
        addView(k6Var, k7.b6.d(-1, 24.0f, 55, 57.0f, 2.33f, 48.0f, 0.0f));
        ...
        addView(k6Var2, k7.b6.d(-1, 24.0f, 55, 57.0f, 20.66f, 48.0f, 0.0f));
        int textColor = k6Var.getTextColor();
        SpannableString spannableString = new SpannableString("x");
        this.h = spannableString;
        k90 k90Var = new k90(AndroidUtilities.dp(200.0f), k6Var);
        k90Var.e = 0.8f;
        k90Var.a(org.telegram.ui.ActionBar.j6.l1(0.4f, textColor), org.telegram.ui.ActionBar.j6.l1(0.08f, textColor));
        spannableString.setSpan(k90Var, 0, spannableString.length(), 33);
        int textColor2 = k6Var2.getTextColor();
        SpannableString spannableString2 = new SpannableString("x");
        this.n = spannableString2;
        k90 k90Var2 = new k90(AndroidUtilities.dp(140.0f), k6Var2);
        k90Var2.e = 0.8f;
        k90Var2.a(org.telegram.ui.ActionBar.j6.l1(0.4f, textColor2), org.telegram.ui.ActionBar.j6.l1(0.08f, textColor2));
        spannableString2.setSpan(k90Var2, 0, spannableString2.length(), 33);
        ...
        addView(imageView3, k7.b6.d(48, 48.0f, 21, 0.0f, 0.0f, 4.0f, 0.0f));
    }
