...
public final class b0 extends View {
    ...
    */
    public final void a(Matrix matrix, boolean z4) {
        ...
        t6 t6Var = c0Var.x;
        if (t6Var != null && (cropState = t6Var.m0) != null) {
            if (z4) {
        ...
        t6 t6Var2 = c0Var.x;
        float f20 = t6Var2.Q + fVar.g + i10;
        MediaController.CropState cropState3 = t6Var2.m0;
        if (cropState3 != null) {
            if (z4) {
    ...
    */
    public final void b(Canvas canvas, boolean z4) {
        ...
        if (!z4) {
            ...
            f10 = 2.0f;
            f11 = 255.0f;
            canvas2.saveLayerAlpha(0.0f, 0.0f, k5Var.getWidth(), k5Var.getHeight(), (int) (Math.min(1.0f, (1.0f - c0Var.r) * 2.0f) * 255.0f), 31);
        ...
        if (c0Var.r < 1.0f && !z4) {
            Path path = this.b;
            path.rewind();
            float width = k5Var.getWidth();
            float height = k5Var.getHeight();
            RectF rectF = this.c;
        ...
        matrix.preScale(k5Var.getWidth() / c0Var.x.i0, k5Var.getHeight() / c0Var.x.j0);
        matrix.preConcat(c0Var.x.n0);
        matrix.preTranslate(k5Var.getContentWidth() / f10, k5Var.getContentHeight() / f10);
        matrix2.preTranslate((getContainerWidth() / f10) + AndroidUtilities.dp(16.0f), kf.k0.b(getContainerHeight(), AndroidUtilities.dp(32.0f), f10, !(getContext() instanceof BubbleActivity) ? AndroidUtilities.statusBarHeight : 0.0f));
        if (z4) {
            ...
            if (matrix4.invert(matrix5)) {
                ...
                float contentWidth = k5Var.getContentWidth();
                float contentHeight = k5Var.getContentHeight();
                MediaController.CropState cropState2 = c0Var.x.m0;
                ...
                float e = z5Var.e(z10);
                float f19 = 1.0f - (e * f12);
                matrix2.preScale(f19, 1.0f);
                matrix.preScale(f19, 1.0f);
                float y10 = org.telegram.messenger.y3.y(1.0f, e, 4.0f * e, 0.25f);
                matrix2.preSkew(0.0f, y10);
                matrix.preSkew(0.0f, y10);
                matrix2.preTranslate((-k5Var.getContentWidth()) / f12, (-k5Var.getContentHeight()) / f12);
                matrix.preTranslate((-k5Var.getContentWidth()) / f12, (-k5Var.getContentHeight()) / f12);
                float f20 = c0Var.r;
                Matrix matrix6 = this.e;
                AndroidUtilities.lerp(matrix, matrix2, f20, matrix6);
                canvas2.concat(matrix6);
                Paint paint2 = k5Var.N;
                Matrix matrix7 = k5Var.T;
                if (k5Var.n == null) {
                    canvas2.save();
                    canvas2.scale(k5Var.getContentWidth() / k5Var.getWidth(), k5Var.getContentHeight() / k5Var.getHeight());
                    canvas2.concat(k5Var.g0);
                    k5Var.n.draw(canvas2);
                    canvas2.restore();
                } else if (k5Var.a != null && k5Var.d != null) {
                    matrix7.reset();
                    matrix7.preScale(k5Var.d.k0 / k5Var.a.getWidth(), k5Var.d.l0 / k5Var.a.getHeight());
                    paint2.setAlpha(255);
                    canvas2.drawBitmap(k5Var.a, matrix7, paint2);
                }
                canvas2.restore();
                if (z4) {
                    return;
        ...
        float f192 = 1.0f - (e6 * f12);
        matrix2.preScale(f192, 1.0f);
        matrix.preScale(f192, 1.0f);
        float y102 = org.telegram.messenger.y3.y(1.0f, e6, 4.0f * e6, 0.25f);
        ...
        Paint paint22 = k5Var.N;
        Matrix matrix72 = k5Var.T;
        if (k5Var.n == null) {
        }
        canvas2.restore();
        if (z4) {
