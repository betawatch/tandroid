...
public final class b0 extends View {
    ...
    */
    public final void a(Matrix matrix, boolean z4) {
        ...
        u6 u6Var = c0Var.x;
        if (u6Var != null && (cropState = u6Var.m0) != null) {
            if (z4) {
        ...
        u6 u6Var2 = c0Var.x;
        float f20 = u6Var2.Q + fVar.g + i10;
        MediaController.CropState cropState3 = u6Var2.m0;
        if (cropState3 != null) {
            if (z4) {
    ...
    */
    public final void b(Canvas canvas, boolean z4) {
        ...
        if (!z4) {
            ...
            f10 = 2.0f;
            f11 = 255.0f;
            canvas2.saveLayerAlpha(0.0f, 0.0f, l5Var.getWidth(), l5Var.getHeight(), (int) (Math.min(1.0f, (1.0f - c0Var.r) * 2.0f) * 255.0f), 31);
        ...
        matrix.preScale(l5Var.getWidth() / c0Var.x.i0, l5Var.getHeight() / c0Var.x.j0);
        matrix.preConcat(c0Var.x.n0);
        matrix.preTranslate(l5Var.getContentWidth() / f10, l5Var.getContentHeight() / f10);
        matrix2.preTranslate((getContainerWidth() / f10) + AndroidUtilities.dp(16.0f), kh.a2.b(getContainerHeight(), AndroidUtilities.dp(32.0f), f10, !(getContext() instanceof BubbleActivity) ? AndroidUtilities.statusBarHeight : 0.0f));
        if (z4) {
            ...
            if (matrix4.invert(matrix5)) {
                ...
                float contentWidth = l5Var.getContentWidth();
                float contentHeight = l5Var.getContentHeight();
                MediaController.CropState cropState2 = c0Var.x.m0;
                ...
                matrix2.preTranslate((-l5Var.getContentWidth()) / f12, (-l5Var.getContentHeight()) / f12);
                matrix.preTranslate((-l5Var.getContentWidth()) / f12, (-l5Var.getContentHeight()) / f12);
                float f20 = c0Var.r;
                Matrix matrix6 = this.e;
                AndroidUtilities.lerp(matrix, matrix2, f20, matrix6);
                canvas2.concat(matrix6);
                Paint paint2 = l5Var.N;
                Matrix matrix7 = l5Var.T;
                if (l5Var.n == null) {
                    canvas2.save();
                    canvas2.scale(l5Var.getContentWidth() / l5Var.getWidth(), l5Var.getContentHeight() / l5Var.getHeight());
                    canvas2.concat(l5Var.g0);
                    l5Var.n.draw(canvas2);
                    canvas2.restore();
                } else if (l5Var.a != null && l5Var.d != null) {
                    matrix7.reset();
                    matrix7.preScale(l5Var.d.k0 / l5Var.a.getWidth(), l5Var.d.l0 / l5Var.a.getHeight());
                    paint2.setAlpha(255);
                    canvas2.drawBitmap(l5Var.a, matrix7, paint2);
                }
                canvas2.restore();
                if (z4) {
                    return;
        ...
        Paint paint22 = l5Var.N;
        Matrix matrix72 = l5Var.T;
        if (l5Var.n == null) {
        }
        canvas2.restore();
        if (z4) {
