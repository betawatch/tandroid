...
public final /* synthetic */ class q1 implements Runnable {
    ...
    public /* synthetic */ q1(p2 p2Var, int i10) {
        this.a = i10;
        this.b = p2Var;
    }
        ...
        switch (i10) {
            ...
            case 1:
                if (!p2Var.Y && p2Var.F != 0) {
                    ...
                    ConnectionsManager.getInstance(p2Var.C).sendRequest(tL_messages_prolongWebView, new a2(p2Var, i11));
                    break;
                }
                break;
            case 2:
            ...
            case 7:
                ...
                p2Var.e.invalidate();
                p2Var.x.n(false, false);
                if (p2Var.c != null) {
                    float f9 = (1.0f - (Math.min(g2Var.getTopActionBarOffsetY(), g2Var.getTranslationY() - g2Var.getTopActionBarOffsetY()) / g2Var.getTopActionBarOffsetY()) <= 0.5f ? 0 : 1) * 100.0f;
                    o1.k kVar = p2Var.c;
                    o1.l lVar = kVar.u;
                    if (((float) lVar.i) != f9) {
                        lVar.i = f9;
