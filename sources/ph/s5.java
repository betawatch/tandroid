...
public final class s5 extends View implements c2 {
    ...
    public s5(Activity activity) {
        ...
        this.I = new rc(this);
        mr mrVar = mr.h;
        this.K = new org.telegram.ui.Components.z5(this, 0L, 310L, mrVar);
        this.M = new org.telegram.ui.Components.z5(this, 0L, 330L, mrVar);
        this.P = new Path();
        ...
        this.e0 = new org.telegram.ui.Components.z5(this, 0L, 200L, mr.f);
        this.j0 = new org.telegram.ui.Components.z5(this, 0L, 350L, mrVar);
        this.k0 = -1.0f;
        this.l0 = true;
        this.m0 = new org.telegram.ui.Components.z5(this, 0L, 350L, mrVar);
        this.n0 = new org.telegram.ui.Components.z5(this, 0L, 850L, mrVar);
        this.p0 = new float[2];
        this.q0 = new org.telegram.ui.Components.z5(this, 0L, 350L, mrVar);
        this.y0 = new org.telegram.ui.Components.z5(this, 0L, 350L, mrVar);
        this.z0 = new org.telegram.ui.Components.z5(this, 0L, 650L, mrVar);
        this.A0 = new org.telegram.ui.Components.z5(this, 0L, 160L, mr.i);
        this.B0 = new org.telegram.ui.Components.z5(this, 0L, 750L, mrVar);
        this.C0 = new org.telegram.ui.Components.z5(this, 0L, 650L, mrVar);
        this.D0 = new org.telegram.ui.Components.z5(this, 0L, 320L, mrVar);
        this.F0 = new org.telegram.ui.Components.z5(this, 0L, 320L, mrVar);
        this.G0 = new org.telegram.ui.Components.z5(this, 0L, 320L, mrVar);
        this.H0 = new org.telegram.ui.Components.z5(this, 0L, 320L, mrVar);
        this.I0 = new p5(this, 2);
        this.J0 = new p5(this, 3);
        this.K0 = new Path();
        this.L0 = new Path();
        this.M0 = new PointF();
        this.N0 = new PointF();
    ...
    public final boolean c(float f10, float f11, float f12, float f13, float f14, boolean z4) {
        return this.o0 ? (!z4 || f13 - f11 <= ((float) AndroidUtilities.dp(100.0f))) && Math.abs(f12 - f10) <= f14 : k7.n6.a(f10, f11, f12, f13) <= f14;
    }
    ...
    public final boolean dispatchHoverEvent(MotionEvent motionEvent) {
        r5 r5Var = this.T;
        if (r5Var == null || !r5Var.f(motionEvent)) {
    ...
    public final void h() {
        ...
        if (q5Var != null) {
            ...
            if (arrayList2 != null && !arrayList2.isEmpty() && ((t6) arrayList2.get(0)).O0 != null) {
                this.b.setImage(ImageLocation.getForPath(((t6) arrayList2.get(0)).O0.getAbsolutePath()), "80_80", null, null, this.c, 0L, null, null, 0);
                return;
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f34 = 1.0f - d11;
        float e = this.F0.e(this.E0 > 0.0f) * f34;
        ...
        float e10 = this.q0.e(this.r0);
        Paint paint7 = this.v;
        paint7.setStrokeWidth(lerp5);
        paint7.setAlpha((int) (Math.max(e10 * f25, 1.0f - f48) * 255.0f));
        if (e10 <= 0.0f) {
            canvas3 = canvas;
            canvas3.drawArc(rectF3, -90.0f, min, false, paint7);
        } else {
            qp.a(this.p0, (SystemClock.elapsedRealtime() - this.s0) % 5400);
            invalidate();
            float[] fArr = this.p0;
            float f49 = fArr[0];
            float f50 = fArr[c3];
            ...
            if (this.r0) {
                float f52 = min / 2.0f;
                f51 = AndroidUtilities.lerp((-90.0f) + f52, f51, e10);
                abs2 = AndroidUtilities.lerp(f52, abs2, e10);
            }
            float f53 = f51 - abs2;
            float f54 = abs2 * 2.0f;
            canvas3 = canvas;
        ...
        if (i11 > 0) {
            ...
            if (abs4 >= lerp2 + (f27 * 2.0f) || clamp3 >= 0.6f) {
                ...
                z5Var = z5Var2;
                rcVar = rcVar4;
                float min2 = Math.min(1.0f, (abs4 * 2.0f) / f57) * Math.min(clamp3 * 2.4f, k7.n6.a(pointF4.x, pointF4.y, pointF6.x, pointF6.y) / f57);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (Math.abs(clamp - this.f0) < AndroidUtilities.dp(50.0f)) {
                AndroidUtilities.runOnUIThread(p5Var2, ViewConfiguration.getLongPressTimeout());
            }
            if (rcVar3.h) {
            ...
            if (action == 1 || action == 3) {
                if (this.t0) {
                    this.t0 = false;
                    this.u0 = false;
                    AndroidUtilities.cancelRunOnUIThread(p5Var2);
                    AndroidUtilities.cancelRunOnUIThread(p5Var);
                    boolean z11 = this.o0;
                    if (!z11 && rcVar.h) {
                        da daVar2 = ((a9) this.a).a;
                        if (daVar2.c0 == 0 && !daVar2.M1 && !daVar2.N1 && da.b(daVar2)) {
                            daVar2.f(true);
                        }
                    } else if (z11 && this.w0) {
                        if (rcVar.h) {
                        ...
                        if (b()) {
                            ...
                            this.r0 = true;
                            ((a9) this.a).d(false);
                        } else if (da.d(((a9) this.a).a)) {
                            this.O = 0L;
                            this.N = System.currentTimeMillis();
                            this.x0 = false;
                            ((a9) this.a).e(new p5(this, 1), false);
                        }
                    }
                    this.w0 = false;
                    if (rcVar3.h) {
