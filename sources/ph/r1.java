...
public final class r1 extends FrameLayout {
    ...
    public r1(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        final int i12 = 0;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: ph.o1
        ...
        final int i13 = 1;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: ph.o1
            public final /* synthetic */ r1 b;
    ...
    public final void a(int i10, boolean z4) {
        if (this.e != i10 || this.f == null) {
            ...
            final int i11 = 0;
            this.f.setOnScrollIntoOccupiedWidth(new Utilities.Callback(this) { // from class: ph.p1
                public final /* synthetic */ r1 b;
            ...
            final int i12 = 1;
            this.f.setOnCategoryClick(new Utilities.Callback(this) { // from class: ph.p1
                public final /* synthetic */ r1 b;
            ...
            frameLayout.addView(this.f, Math.max(0, frameLayout.getChildCount() - 1), k7.b6.d(-1, 36.0f, 51, 36.0f, 0.0f, 0.0f, 0.0f));
        }
    }
