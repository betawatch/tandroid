...
public final class f8 extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public f8(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        j1(context);
        this.b.setAdapter(new h7(this, context, 0));
    ...
    public static int d1(f8 f8Var, TLRPC.Chat chat) {
        Integer num;
        int i10;
        TLRPC.ChatFull chatFull = MessagesController.getInstance(f8Var.currentAccount).getChatFull(chat.id);
    ...
    public final void dismiss() {
        ...
        if (callback != null) {
            ...
            if (i10 == 3) {
                ...
                d8Var = i10 == 2 ? new d8(i10, this.currentAccount, arrayList) : new d8(i10, this.currentAccount, (ArrayList) null);
            }
            this.R.run(d8Var);
            this.R = null;
        }
    ...
    public final void f1() {
        ...
        for (View view : this.b.getViewPages()) {
            if ((view instanceof z7) && (t7Var = ((z7) view).x) != null) {
                AndroidUtilities.hideKeyboard(t7Var.a);
            }
        }
    }
    ...
    public final void g1(d8 d8Var, Runnable runnable, boolean z4) {
        ...
        if (arrayList.isEmpty() || z4) {
            ...
            d dVar = view instanceof z7 ? ((z7) view).v : null;
            if (dVar != null) {
                dVar.setLoading(true);
            }
            n7 n7Var = this.Q;
            if (n7Var != null) {
                n7Var.e(d8Var, this.w, this.x, this.y, this.D, this.c, this.E, new f6(6, dVar, runnable), new org.telegram.ui.web.o0(dVar, 23));
                return;
            } else {
                runnable.run();
                return;
    ...
    public final void j1(Context context) {
        ...
        this.containerView.addView(this.b, k7.b6.e(-1, -1, 119));
    }
    ...
    public f8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.W = false;
        j1(context);
        this.b.setAdapter(new h7(this, context, 1));
    }
}
