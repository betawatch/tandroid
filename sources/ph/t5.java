...
public final class t5 extends View implements c2 {
    ...
    public t5(Activity activity) {
        ...
        this.e0 = new org.telegram.ui.Components.z5(this, 0L, 200L, nr.f);
        this.j0 = new org.telegram.ui.Components.z5(this, 0L, 350L, nrVar);
        this.k0 = -1.0f;
        this.l0 = true;
        this.m0 = new org.telegram.ui.Components.z5(this, 0L, 350L, nrVar);
        this.n0 = new org.telegram.ui.Components.z5(this, 0L, 850L, nrVar);
        this.p0 = new float[2];
        this.q0 = new org.telegram.ui.Components.z5(this, 0L, 350L, nrVar);
        this.y0 = new org.telegram.ui.Components.z5(this, 0L, 350L, nrVar);
        this.z0 = new org.telegram.ui.Components.z5(this, 0L, 650L, nrVar);
        this.A0 = new org.telegram.ui.Components.z5(this, 0L, 160L, nr.i);
    ...
    public final void h() {
        ...
        if (r5Var != null) {
            ...
            if (arrayList2 != null && !arrayList2.isEmpty() && ((u6) arrayList2.get(0)).O0 != null) {
                this.b.setImage(ImageLocation.getForPath(((u6) arrayList2.get(0)).O0.getAbsolutePath()), "80_80", null, null, this.c, 0L, null, null, 0);
                return;
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (e10 <= 0.0f) {
            ...
            rp.a(this.p0, (SystemClock.elapsedRealtime() - this.s0) % 5400);
            invalidate();
            float[] fArr = this.p0;
            float f49 = fArr[0];
            float f50 = fArr[c3];
                ...
                if (this.t0) {
                    ...
                    if (!z11 && rcVar.h) {
                        ...
                        if (b()) {
                            ...
                            this.x0 = false;
                            ((a9) this.a).e(new q5(this, 1), false);
                        }
                    }
                    this.w0 = false;
                    if (rcVar3.h) {
