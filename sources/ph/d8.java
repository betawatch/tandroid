...
public final class d8 extends FrameLayout {
    ...
    public d8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        kpVar.b(i11, i12, org.telegram.ui.ActionBar.j6.C5);
    ...
    public final void b(float f10, boolean z4) {
        ...
        kp kpVar = this.f;
        if (!z4) {
            kpVar.animate().cancel();
            kpVar.setAlpha(f10);
            radioButton.animate().cancel();
            radioButton.setAlpha(f10);
            return;
        }
        if (Math.abs(kpVar.getAlpha() - f10) > 0.1d) {
            kpVar.animate().cancel();
            kpVar.animate().alpha(f10).start();
        }
            ...
            try {
                if (kpVar.getVisibility() == 0) {
                    ...
                    if (!z4 || z10) {
                        ...
                        accessibilityNodeInfo.setChecked(!z4 ? kpVar.a.q : radioButton.f);
