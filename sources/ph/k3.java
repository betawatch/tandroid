...
public final class k3 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void c(Runnable runnable, boolean z4) {
        ...
        d dVar = j3Var.b;
        j3Var.animate().alpha(this.y ? 1.0f : 0.0f).setInterpolator(mr.h).setDuration(320L).withEndAction(new kv0(12, this, z4)).start();
    ...
    public final void e(boolean z4, boolean z10) {
        if (z4 || !z10) {
            if (z10) {
                org.telegram.ui.b.p(getTextureView().animate().alpha(z4 ? 1.0f : 0.0f), mr.h, 320L);
            } else {
