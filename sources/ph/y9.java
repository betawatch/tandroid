...
public abstract class y9 {
    ...
    public static w9 b(org.telegram.ui.Cells.d7 d7Var) {
        if (d7Var == null) {
            return null;
        }
        org.telegram.ui.Components.p9 imageView = d7Var.getImageView();
        w9 w9Var = new w9(imageView, 2);
        int[] iArr = new int[2];
        imageView.getLocationOnScreen(iArr);
        w9Var.c.set(iArr[0], iArr[1], imageView.getWidth() + r5, imageView.getHeight() + iArr[1]);
        w9Var.d = new org.telegram.ui.Cells.c7(imageView.getContext(), null, false, d7Var.y);
