...
public final class ra extends View {
    ...
    public ra(Activity activity) {
        ...
        this.e = new rc(this);
        nr nrVar = nr.h;
        this.h = new org.telegram.ui.Components.z5(this, 0L, 240L, nrVar);
        paint.setColor(-1);
        ...
        gj0 gj0Var = new gj0(R.raw.group_pip_delete_icon, "" + R.raw.group_pip_delete_icon, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f), true, null);
        this.a = gj0Var;
        gj0Var.s0 = this;
