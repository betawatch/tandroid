...
public final class e8 extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public e8(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        j1(context);
        this.b.setAdapter(new g7(this, context, 0));
    ...
    public static int d1(e8 e8Var, TLRPC.Chat chat) {
        Integer num;
        int i10;
        TLRPC.ChatFull chatFull = MessagesController.getInstance(e8Var.currentAccount).getChatFull(chat.id);
    ...
    public final void dismiss() {
        ...
        if (callback != null) {
            ...
            if (i10 == 3) {
                ...
                c8Var = i10 == 2 ? new c8(i10, this.currentAccount, arrayList) : new c8(i10, this.currentAccount, (ArrayList) null);
            }
            this.R.run(c8Var);
            this.R = null;
        }
    ...
    public final void f1() {
        ...
        for (View view : this.b.getViewPages()) {
            if ((view instanceof y7) && (s7Var = ((y7) view).x) != null) {
                AndroidUtilities.hideKeyboard(s7Var.a);
            }
        }
    }
    ...
    public final void g1(c8 c8Var, Runnable runnable, boolean z4) {
        ...
        if (arrayList.isEmpty() || z4) {
            ...
            d dVar = view instanceof y7 ? ((y7) view).v : null;
            if (dVar != null) {
                dVar.setLoading(true);
            }
            m7 m7Var = this.Q;
            if (m7Var != null) {
                m7Var.d(c8Var, this.w, this.x, this.y, this.D, this.c, this.E, new e6(6, dVar, runnable), new org.telegram.ui.web.q0(dVar, 23));
                return;
            } else {
                runnable.run();
                return;
    ...
    public e8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.W = false;
        j1(context);
        this.b.setAdapter(new g7(this, context, 1));
    }
}
