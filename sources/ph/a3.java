...
public abstract class a3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public a3(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, MediaController.AlbumEntry albumEntry, boolean z4, float f10, boolean z10, boolean z11) {
        ...
        final int i11 = 0;
        l2Var.setOnItemClickListener(new il0(this) { // from class: ph.e2
                            ...
                            if (!a3Var.W) {
                                if (a3Var.a0) {
                                    if (i13 >= 0 && i13 < arrayList2.size()) {
                                        u6 u6Var = (u6) arrayList2.get(i13);
                                        a3Var.T.run(u6Var, u6Var.K ? a3.d(x2Var) : null);
                                        break;
                                    } else {
                                        i13 -= arrayList2.size();
                                    }
        ...
        final int i13 = 1;
        sl0Var.setOnItemClickListener(new il0(this) { // from class: ph.e2
            public final /* synthetic */ a3 b;
                            ...
                            if (!a3Var.W) {
                                if (a3Var.a0) {
                                    if (i132 >= 0 && i132 < arrayList2.size()) {
                                        u6 u6Var = (u6) arrayList2.get(i132);
                                        a3Var.T.run(u6Var, u6Var.K ? a3.d(x2Var) : null);
                                        break;
                                    } else {
    ...
    public final void dispatchDraw(Canvas canvas) {
        float g10 = g();
        boolean z4 = g10 <= ((float) kh.a2.c(32.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight, 0));
        float e = this.P.e(z4);
    ...
    public final void j() {
        ...
        if (imageView != null) {
            org.telegram.ui.b.p(imageView.animate().alpha(!isEmpty ? 1.0f : 0.0f).scaleX(!isEmpty ? 1.0f : 0.7f).scaleY(isEmpty ? 0.7f : 1.0f).translationY(!isEmpty ? -AndroidUtilities.navigationBarHeight : AndroidUtilities.dp(8.0f)), nr.h, 320L);
        }
        ...
        if (linearLayout != null) {
            ...
            if (this.Q != z4) {
                ...
                linearLayout.animate().alpha(isEmpty ? 0.0f : 1.0f).translationY(isEmpty ? AndroidUtilities.dp(32.0f) : 0.0f).setInterpolator(nr.h).setDuration(320L).setListener(new l61(9, this, z4)).start();
            }
        }
    }
