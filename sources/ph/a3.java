...
public abstract class a3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public a3(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, MediaController.AlbumEntry albumEntry, boolean z4, float f10, boolean z10, boolean z11) {
        ...
        final int i11 = 0;
        l2Var.setOnItemClickListener(new hl0(this) { // from class: ph.e2
                            ...
                            if (!a3Var.W) {
                                if (a3Var.a0) {
                                    if (i13 >= 0 && i13 < arrayList2.size()) {
                                        t6 t6Var = (t6) arrayList2.get(i13);
                                        a3Var.T.run(t6Var, t6Var.K ? a3.d(x2Var) : null);
                                        break;
                                    } else {
                                        i13 -= arrayList2.size();
                                    }
        ...
        final int i12 = 0;
        r2Var.setOnClickListener(new View.OnClickListener(this) { // from class: ph.f2
            public final /* synthetic */ a3 b;
        ...
        h2 h2Var = new h2(context, f6Var);
        h2Var.setViewType(2);
        h2Var.setAlpha(0.0f);
        h2Var.setVisibility(8);
        frameLayout.addView(h2Var, k7.b6.e(-1, -1, 119));
        zw0 zw0Var = new zw0(context, h2Var, 11, f6Var);
        this.s = zw0Var;
        ih.s sVar = zw0Var.d;
        sVar.setTextSize(1, 16.0f);
        sVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.y6, f6Var));
        ...
        final int i13 = 1;
        rl0Var.setOnItemClickListener(new hl0(this) { // from class: ph.e2
            public final /* synthetic */ a3 b;
                            ...
                            if (!a3Var.W) {
                                if (a3Var.a0) {
                                    if (i132 >= 0 && i132 < arrayList2.size()) {
                                        t6 t6Var = (t6) arrayList2.get(i132);
                                        a3Var.T.run(t6Var, t6Var.K ? a3.d(x2Var) : null);
                                        break;
                                    } else {
        ...
        if (z10) {
            ...
            if (!z11) {
                ...
                final int i15 = 1;
                p10.setOnClickListener(new View.OnClickListener(this) { // from class: ph.f2
                    public final /* synthetic */ a3 b;
            ...
            final int i16 = 2;
            p11.setOnClickListener(new View.OnClickListener(this) { // from class: ph.f2
                public final /* synthetic */ a3 b;
            ...
            final int i17 = 3;
            imageView.setOnClickListener(new View.OnClickListener(this) { // from class: ph.f2
                public final /* synthetic */ a3 b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        float g10 = g();
        boolean z4 = g10 <= ((float) kf.k0.c(32.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight, 0));
        float e = this.P.e(z4);
    ...
    public final void j() {
        ...
        if (imageView != null) {
            org.telegram.ui.b.p(imageView.animate().alpha(!isEmpty ? 1.0f : 0.0f).scaleX(!isEmpty ? 1.0f : 0.7f).scaleY(isEmpty ? 0.7f : 1.0f).translationY(!isEmpty ? -AndroidUtilities.navigationBarHeight : AndroidUtilities.dp(8.0f)), mr.h, 320L);
        }
        ...
        if (linearLayout != null) {
            ...
            if (this.Q != z4) {
                ...
                linearLayout.animate().alpha(isEmpty ? 0.0f : 1.0f).translationY(isEmpty ? AndroidUtilities.dp(32.0f) : 0.0f).setInterpolator(mr.h).setDuration(320L).setListener(new s61(9, this, z4)).start();
            }
        }
    }
