            ...
            case 0:
                ...
                if (!yVar.b0 && !yVar.k0) {
                    ...
                    if (xVar2 != null && xVar2.n != null) {
                        ...
                        o70 F = o70.F(yVar.a, yVar.b, yVar);
                        if (yVar.g0.n.K) {
                            o6 o6Var = new o6(yVar.getContext(), 0);
                            o6Var.b = 0.0f;
                            o6Var.c = 1.5f;
                            o6Var.d(yVar.g0.n.P);
                            o6Var.h = new org.telegram.ui.web.y0(yVar, 4);
                            o6Var.O = AndroidUtilities.dp(220.0f);
                            F.q(o6Var);
                            F.o();
                        }
                        F.T = 220;
                ...
                for (int i10 = 0; i10 < yVar3.h.size(); i10++) {
                    ...
                    if (xVar4.n != null && (t2Var2 = xVar4.d) != null) {
                        ...
                        if (!yVar3.k0 || yVar3.n0) {
                            ...
                            u6 u6Var2 = xVar4.n;
                            float f12 = duration;
                            if (f11 > u6Var2.V * f12 && f11 < u6Var2.W * f12) {
                                z4 = true;
                                u6 u6Var3 = xVar4.n;
                                float f13 = duration;
                                clamp = Utilities.clamp(clamp2, (long) (u6Var3.W * f13), (long) (u6Var3.V * f13));
                                ...
                                if (Math.abs((xVar4.g >= 0 ? xVar4.g : xVar4.d.getCurrentPosition()) - clamp) <= 450) {
                                    ...
                                    xVar4.g = clamp;
                                    t2Var62.seekTo(clamp, yVar3.m0, new org.telegram.ui.web.o0(xVar4, 9));
                                }
                            }
                        }
                        z4 = false;
                        u6 u6Var32 = xVar4.n;
                        float f132 = duration;
                        clamp = Utilities.clamp(clamp2, (long) (u6Var32.W * f132), (long) (u6Var32.V * f132));
                        if (xVar4.d.isPlaying() != z4) {
                        }
            ...
            case 5:
                ...
                if (xVar6 != null && yVar5.h.indexOf(xVar6) >= 0) {
                    ...
                    if (rVar.e.size() > 1) {
                        v vVar = daVar.D0;
                        daVar.w0 = rVar;
                        vVar.a(new jc0(rVar, false), true);
