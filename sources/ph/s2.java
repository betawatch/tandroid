...
public final /* synthetic */ class s2 implements Utilities.Callback {
    ...
    public /* synthetic */ s2(Object obj, Context context, int i10, long j10, c6 c6Var, int i11) {
        this.a = i11;
        this.b = obj;
        this.c = context;
        this.d = i10;
    ...
    public final void run(Object obj) {
        switch (this.a) {
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: ph.t2
                        ...
                        switch (i10) {
                            case 0:
                                ...
                                if (userFull2 != null && userFull2.starref_program != null) {
                                    f3Var.dismiss();
                                    d3.G0(context, i11, userFull2.starref_program, j10, c6Var, true);
                                    break;
                                }
                                break;
                            default:
                                ...
                                if (userFull3 != null && userFull3.starref_program != null) {
                                    f3Var.dismiss();
                                    d3.G0(context, i11, userFull3.starref_program, j10, c6Var, true);
                                    break;
                                }
                                break;
                        }
                        ...
                        switch (i12) {
                            case 0:
                                ...
                                if (userFull22 != null && userFull22.starref_program != null) {
                                    f3Var2.dismiss();
                                    d3.G0(context2, i13, userFull22.starref_program, j11, c6Var2, true);
                                    break;
                                }
                                break;
                            default:
                                ...
                                if (userFull3 != null && userFull3.starref_program != null) {
                                    f3Var2.dismiss();
                                    d3.G0(context2, i13, userFull3.starref_program, j11, c6Var2, true);
                                    break;
                                }
                                break;
                        }
