...
public final class ma {
    ...
    public ma(oa oaVar, boolean z4, final String str, final int i10, final int i11, final Long l10, final long j10, final long j11, final long j12, final Runnable runnable) {
        this.n = oaVar;
        this.h = z4;
        Utilities.themeQueue.postRunnable(new Runnable() { // from class: ph.ka
            ...
            */
            public final void run() {
                ...
                long maxScrollDuration = maVar.n.getMaxScrollDuration();
                try {
                    maVar.e.setDataSource(str2);
                    String extractMetadata = maVar.e.extractMetadata(9);
                    if (extractMetadata != null) {
                        maxScrollDuration = Long.parseLong(extractMetadata);
                        maVar.a = maxScrollDuration;
                    }
                    String extractMetadata2 = maVar.e.extractMetadata(18);
                ...
                try {
                    String extractMetadata3 = maVar.e.extractMetadata(19);
                    i13 = extractMetadata3 != null ? Integer.parseInt(extractMetadata3) : 0;
                    try {
                        String extractMetadata4 = maVar.e.extractMetadata(24);
                        ...
                        maVar.g = Math.max(1, i14);
                        maVar.f = Math.max(1, (int) Math.ceil(i14 * clamp));
                        int ceil = (int) Math.ceil(((Math.max(maxScrollDuration, j15) / j15) * i15) / maVar.f);
                        maVar.c = ceil;
                        maVar.b = (long) (maxScrollDuration / ceil);
                        maVar.j = -maVar.b;
                        if (j13 != -1) {
                        }
                        maVar.c();
                    ...
                    maVar.g = Math.max(1, i14);
                    maVar.f = Math.max(1, (int) Math.ceil(i14 * clamp2));
                    int ceil2 = (int) Math.ceil(((Math.max(maxScrollDuration, j15) / j15) * i15) / maVar.f);
                    maVar.c = ceil2;
                    maVar.b = (long) (maxScrollDuration / ceil2);
                    maVar.j = -maVar.b;
                    if (j13 != -1) {
                    }
                    maVar.c();
                ...
                maVar.g = Math.max(1, i14);
                maVar.f = Math.max(1, (int) Math.ceil(i14 * clamp22));
                int ceil22 = (int) Math.ceil(((Math.max(maxScrollDuration, j15) / j15) * i15) / maVar.f);
                maVar.c = ceil22;
                maVar.b = (long) (maxScrollDuration / ceil22);
                maVar.j = -maVar.b;
                if (j13 != -1) {
                    maVar.j = j13 - maVar.b;
                }
    ...
    public final void c() {
        ...
        this.j += this.b;
        int i10 = 2;
        Utilities.themeQueue.cancelRunnable(new ga(this, i10));
        Utilities.themeQueue.postRunnable(new ga(this, i10));
    }
}
