...
public final class h9 extends c5 {
    ...
    public final void V0(boolean z4, boolean z10) {
        ...
        if (!z4) {
            ...
            daVar.m1.animate().alpha(0.0f).withEndAction(new org.telegram.ui.web.o0(this, 27)).setDuration(180L).setInterpolator(nr.g).setStartDelay(z10 ? 500L : 0L).start();
        } else {
            daVar.m1.setVisibility(0);
            daVar.m1.setAlpha(0.0f);
            daVar.m1.clearAnimation();
            daVar.m1.animate().alpha(1.0f).setDuration(180L).setInterpolator(nr.g).start();
        }
    }
    ...
    public final void h(boolean z4) {
        ...
        int i10 = daVar.d0;
        animate.alpha((i10 == -1 || i10 == 2) ? 1.0f : 0.0f).setDuration(180L).setInterpolator(nrVar).start();
        V0(false, z4);
