...
public final class ca extends qv0 {
    ...
    public ca(da daVar, Activity activity) {
        ...
        this.B0 = daVar;
        this.x0 = false;
        this.t0 = new ja.c(activity, new aa(this));
    ...
    */
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (h9Var != null) {
            ...
            if (pk0Var != null) {
                ...
                ah.d dVar = daVar.s1.W1.getReactionsWindow() != null ? daVar.s1.W1.getReactionsWindow().c : null;
                if (dVar != null) {
                    int i22 = daVar.V;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        uo uoVar = daVar.z2;
        if (uoVar != null) {
            uoVar.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
        }
        e9 e9Var = daVar.J0;
        if (e9Var != null) {
