...
public abstract class p extends k {
    ...
    public p(Context context, FrameLayout frameLayout, qv0 qv0Var, FrameLayout frameLayout2, nh.b bVar, org.telegram.ui.Components.ba baVar) {
        ...
        this.i1 = new org.telegram.ui.Components.z5(new l(t9Var, 0), 200L, mrVar, 0);
        this.j1 = new Path();
        this.k1 = new Path();
        this.l1 = new Paint(1);
        this.m1 = new Paint(1);
        ...
        mr mrVar2 = mr.h;
        this.p1 = new org.telegram.ui.Components.z5(lVar, 350L, mrVar2);
        this.q1 = new RectF();
        this.r1 = new RectF();
        this.s1 = new RectF();
        this.t1 = new Path();
        this.D1 = new org.telegram.ui.Components.z5(this, 0L, 350L, mrVar2);
        this.E1 = new org.telegram.ui.Components.z5(new l(t9Var, 0), 420L, mrVar2, 0);
        this.F1 = new org.telegram.ui.Components.z5(this, 0L, 350L, mrVar2);
        this.G1 = new org.telegram.ui.Components.z5(new l(t9Var, 0), 350L, mrVar2, 0);
    ...
    public final void B() {
        if (this.W0) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new lh.m5(this, 24));
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        da daVar = t9Var.P1;
        if (!isCameraAllowed ? false : da.d(daVar)) {
            ...
            nVar3.n = new nh.a0(1, t9Var, nVar3);
            nVar3.r = new l(t9Var, 2);
            p9 p9Var = daVar.e0;
            daVar.n1 = nVar3;
            p9Var.addView(nVar3, k7.b6.c(-1.0f, -1));
            return true;
        }
        return true;
    }
    ...
    public final void j(Canvas canvas, RectF rectF) {
        ...
        if (this.A1 != null) {
            ...
            if (f10 > 0.0f) {
                ...
                float c10 = ai.c(1.0f, this.Z0, AndroidUtilities.dp(6.0f) * sin, (rectF.centerX() - ((this.u1.l() + AndroidUtilities.dp(11.33f)) / 2.0f)) - (AndroidUtilities.lerp(this.Z0, 1.0f, e6) * (rectF.width() / 6.0f)));
                int l1 = org.telegram.ui.ActionBar.j6.l1(f10, paint != null ? -1 : -2130706433);
                canvas3.save();
            ...
            if (e6 > f14) {
                ...
                canvas2 = canvas;
                this.x1.c(width, rectF.centerY(), 1.0f, org.telegram.ui.ActionBar.j6.l1(e6, paint != null ? -1 : -2130706433), canvas2);
    ...
    public final void k(Canvas canvas, RectF rectF, float f10) {
        ...
        float lerp = AndroidUtilities.lerp(ai.c(1.0f, e6, getWidth() * 0.35f * this.Z0, rectF.right - AndroidUtilities.dp(20.0f)), rectF.left + AndroidUtilities.dp(20.0f), e);
        ...
        int l1 = org.telegram.ui.ActionBar.j6.l1(y10, TLObject.FLAG_29);
        ...
        paint7.setColor(l12);
        int l13 = org.telegram.ui.ActionBar.j6.l1(y10 * f20, -1);
