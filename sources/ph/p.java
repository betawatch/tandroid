...
public abstract class p extends k {
    ...
    public p(Context context, FrameLayout frameLayout, qv0 qv0Var, FrameLayout frameLayout2, nh.b bVar, org.telegram.ui.Components.ba baVar) {
        ...
        this.i1 = new org.telegram.ui.Components.z5(new l(t9Var, 0), 200L, nrVar, 0);
        this.j1 = new Path();
        this.k1 = new Path();
        this.l1 = new Paint(1);
        this.m1 = new Paint(1);
        ...
        nr nrVar2 = nr.h;
        this.p1 = new org.telegram.ui.Components.z5(lVar, 350L, nrVar2);
        this.q1 = new RectF();
        this.r1 = new RectF();
        this.s1 = new RectF();
        this.t1 = new Path();
    ...
    public final void j(Canvas canvas, RectF rectF) {
        ...
        if (this.A1 != null) {
            ...
            if (f10 > 0.0f) {
                ...
                float c10 = yh.c(1.0f, this.Z0, AndroidUtilities.dp(6.0f) * sin, (rectF.centerX() - ((this.u1.l() + AndroidUtilities.dp(11.33f)) / 2.0f)) - (AndroidUtilities.lerp(this.Z0, 1.0f, e6) * (rectF.width() / 6.0f)));
