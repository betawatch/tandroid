...
public abstract class p extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public p(Context context, p2 p2Var, long j10) {
        ...
        this.d = j10;
        setBackgroundColor(k6.v(k6.v0(k6.d6, resourceProvider), k6.l1(0.04f, k6.v0(k6.G6, resourceProvider))));
        if (C == null) {
    ...
    public final void a(String str) {
        ...
        mi miVar = new mi(p2Var.getParentActivity(), this.a, false, false, false, this.c);
        miVar.J1(1, false);
        miVar.Q0 = true;
        miVar.P0 = false;
    ...
    public final boolean d() {
        ...
        if (!(currentView instanceof l) || (d6Var = ((l) currentView).a) == null) {
            return true;
        }
