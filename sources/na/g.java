...
public final class g {
    ...
    public final synchronized void h(String str) {
        try {
            ...
            HashSet hashSet = new HashSet(this.a.getStringSet(e7, new HashSet()));
            hashSet.remove(str);
            if (hashSet.isEmpty()) {
                this.a.edit().remove(e7).commit();
            } else {
                this.a.edit().putStringSet(e7, hashSet).commit();
            }
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    public final synchronized boolean j(long j3) {
        ...
        if (f(this.a.getLong("fire-global", -1L), j3)) {
            return false;
        }
        this.a.edit().putLong("fire-global", j3).commit();
        return true;
    ...
    public final synchronized void k(long j3, String str) {
        ...
        HashSet hashSet = new HashSet(this.a.getStringSet(str, new HashSet()));
        hashSet.add(d);
        this.a.edit().putStringSet(str, hashSet).putLong("fire-count", j10 + 1).putString("last-used-date", d).commit();
    }
