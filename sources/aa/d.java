...
public abstract /* synthetic */ class d {
    public static int A(int i9, int i10, int i11) {
        return r0.T(i9) + i10 + i11;
    }

    public static int B(int i9, int i10, int i11) {
        return (r0.y(i9) * i10) + i11;
    }

    public static int C(int i9, int i10, int i11) {
        return zzqv.zzA(i9) + i10 + i11;
    }

    public static final void a(int i9, View view, ViewGroup container) {
        i.e(view, "view");
    ...
    public static int e(int i9, int i10, int i11) {
        return k.y(i9) + i10 + i11;
    }

    public static int f(int i9, int i10, int i11, int i12) {
        return k.z(i9) + i10 + i11 + i12;
    }

    public static int g(long j10, ArrayList arrayList, int i9, int i10) {
        arrayList.add(Long.valueOf(j10));
        return i9 + i10;
    }

    public static Bundle h(int i9, String str) {
    ...
    public static String k(int i9, int i10, String str, String str2) {
        return str + i9 + str2 + i10;
    }

    public static String l(int i9, String str, StringBuilder sb2) {
        sb2.append(i9);
        sb2.append(str);
        return sb2.toString();
    }
    ...
    public static String p(String str, String str2, String str3, StringBuilder sb2) {
        sb2.append(str);
        sb2.append(str2);
        sb2.append(str3);
        return sb2.toString();
    ...
    public static String q(StringBuilder sb2, long j10, String str) {
        sb2.append(j10);
        sb2.append(str);
        return sb2.toString();
    }
    ...
    public static StringBuilder s(long j10, String str, String str2) {
    ...
    public static void u(int i9, ArrayList arrayList) {
