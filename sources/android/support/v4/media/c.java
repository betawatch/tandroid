...
public class c implements a0, androidx.activity.result.b, s, o, sc, OnCompleteListener, fb.o, i1, ti, k0, h1, k2.o, n, x0, n5.b {
    ...
    public float k0(ic.c cVar, ic.c cVar2) {
        int i10 = (int) cVar.a;
        int i11 = (int) cVar.b;
        int i12 = (int) cVar2.a;
        int i13 = (int) cVar2.b;
        float z02 = z0(i10, i11, i12, i13);
        float z03 = z0((int) cVar2.a, i13, (int) cVar.a, i11);
        return Float.isNaN(z02) ? z03 / 7.0f : Float.isNaN(z03) ? z02 / 7.0f : (z02 + z03) / 14.0f;
    }
    ...
    */
    public aa.a l0(of.b bVar) {
        ...
        cVarArr[1] = cVar;
        cVarArr[2] = cVar3;
        float k02 = cVar5.k0(cVar, cVar3);
        float f17 = cVar.a;
        float f18 = cVar3.b;
        float f19 = cVar3.a;
        float k03 = cVar5.k0(cVar, cVar2);
        float f20 = cVar2.b;
        float f21 = cVar2.a;
        float f22 = (k03 + k02) / 2.0f;
        if (f22 < 1.0f) {
            throw cc.e.a();
        }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (i13 >= 0) {
                        aVar3.u(cc.i.d, Integer.valueOf(i14));
                        aVar3.u(cc.i.e, Integer.valueOf(i13));
                    }
                    aVar3.u(cc.i.c, dVar.d);
                    aVar3.u(cc.i.f, "]Q" + dVar.h);
                    return aVar3;
    ...
    public ic.a n0(float f7, float f10, int i10, int i11) {
        ic.a b10;
        ic.a b11;
        int i12 = (int) (f10 * f7);
    ...
    @Override // ii.h1
    public /* synthetic */ boolean o(ii.i1 i1Var) {
        return false;
    }
    ...
    @Override // ii.h1
    public /* synthetic */ boolean s(ii.i1 i1Var) {
        return false;
    }
    ...
    public int w0() {
        return ((s0() & Byte.MAX_VALUE) << 21) | ((s0() & Byte.MAX_VALUE) << 14) | ((s0() & Byte.MAX_VALUE) << 7) | (s0() & Byte.MAX_VALUE);
    }
    ...
    @Override // ii.h1
    public void z(ii.i1 i1Var, int i10, int i11) {
        e5 e5Var;
    ...
    public float z0(int i10, int i11, int i12, int i13) {
        float f7;
        float f10;
        dc.b bVar = (dc.b) this.b;
        float x02 = x0(i10, i11, i12, i13);
        int i14 = i10 - (i12 - i10);
        int i15 = 0;
        if (i14 < 0) {
            f7 = i10 / (i10 - i14);
        ...
        return (x0(i10, i11, (int) (((i14 - i10) * f10) + i10), i15) + x02) - 1.0f;
    }

    public /* synthetic */ c(b7.a aVar, v vVar) {
        this.a = 4;
        this.b = vVar;
    }
