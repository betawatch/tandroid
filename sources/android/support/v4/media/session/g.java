...
public final class g extends Binder implements b {
    ...
    public final void n0(int i10) {
        androidx.mediarouter.app.p pVar = (androidx.mediarouter.app.p) this.a.get();
        if (pVar != null) {
            pVar.e(12, Integer.valueOf(i10), null);
        }
    }
    ...
    public final void onRepeatModeChanged(int i10) {
        androidx.mediarouter.app.p pVar = (androidx.mediarouter.app.p) this.a.get();
        if (pVar != null) {
            pVar.e(9, Integer.valueOf(i10), null);
        }
    }
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            ...
            case 6:
                parcel.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                Y(parcel.readInt() != 0 ? (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel) : null);
                return true;
            case 7:
                parcel.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
            ...
            case 11:
                ...
                if (pVar2 != null) {
                    pVar2.e(11, Boolean.valueOf(z10), null);
                    return true;
                }
                return true;
            case 12:
