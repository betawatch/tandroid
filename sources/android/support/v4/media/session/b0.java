...
public final class b0 {
    ...
    public b0(Context context, String str, ComponentName componentName, PendingIntent pendingIntent) {
        ...
        this.b = new of.b(context, this.a.c);
        if (d == 0) {
    ...
    public final void f(PlaybackStateCompat playbackStateCompat) {
        ...
        if (playbackStateCompat == null) {
            ...
            if (playbackStateCompat.w == null) {
                ...
                c0.x(d10, playbackStateCompat.a, playbackStateCompat.b, playbackStateCompat.d, playbackStateCompat.n);
                c0.u(d10, playbackStateCompat.c);
                c0.s(d10, playbackStateCompat.e);
                c0.v(d10, playbackStateCompat.h);
                ...
                c0.t(d10, playbackStateCompat.s);
                if (Build.VERSION.SDK_INT >= 22) {
                    d0.b(d10, playbackStateCompat.v);
                }
                playbackStateCompat.w = c0.c(d10);
            }
    ...
    public final void g(ArrayList arrayList) {
        ...
        while (i10 < size2) {
            ...
            if (queueItem == null) {
                queueItem = z.a(mediaSessionCompat$QueueItem2.a.b(), mediaSessionCompat$QueueItem2.b);
