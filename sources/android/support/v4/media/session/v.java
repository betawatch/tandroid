...
public final class v extends Binder implements d {
    ...
    @Override // android.support.v4.media.session.d
    public final void g0(MediaDescriptionCompat mediaDescriptionCompat, int i10) {
        throw new AssertionError();
    }
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            case 1:
                ...
                s0(parcel.readString(), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? MediaSessionCompat$ResultReceiverWrapper.CREATOR.createFromParcel(parcel) : null);
                parcel2.writeNoException();
                return true;
            case 2:
                parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                boolean a02 = a0(parcel.readInt() != 0 ? (KeyEvent) KeyEvent.CREATOR.createFromParcel(parcel) : null);
                parcel2.writeNoException();
            ...
            case 25:
                parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                k(parcel.readInt() != 0 ? RatingCompat.CREATOR.createFromParcel(parcel) : null);
                parcel2.writeNoException();
                return true;
            case 26:
                parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
            ...
            case Maneuver.TYPE_DESTINATION_RIGHT /* 42 */:
                parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                g0(parcel.readInt() != 0 ? MediaDescriptionCompat.CREATOR.createFromParcel(parcel) : null, parcel.readInt());
                parcel2.writeNoException();
                return true;
