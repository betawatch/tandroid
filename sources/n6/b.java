    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        switch (this.a) {
            case 0:
                ...
                o5.a(createFromParcel, pendingIntent, (TaskCompletionSource) this.b);
                return true;
            case 1:
                if (i10 > 16777215) {
                    break;
                ...
                o5.a(createFromParcel2, null, (TaskCompletionSource) this.b);
                return true;
            default:
                if (i10 > 16777215) {
                    break;
                ...
                if (i10 == 1) {
                    ((z8.c) this.b).a((Status) b7.c.a(parcel, Status.CREATOR));
                } else if (i10 == 2) {
                } else {
                    if (i10 != 4) {
                        return false;
