        ...
        switch (i10) {
            ...
            case 4:
                ...
                if (!this.b && r41Var.r > 0.0f) {
                    ...
                    super.dispatchDraw(canvas);
                    ((Paint) this.c).setAlpha((int) (r41Var.r * 255.0f));
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 1:
                ...
                int i21 = cg0Var.A;
                i10 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingTop;
                int i22 = (i21 - i10) - dp;
                i11 = ((org.telegram.ui.ActionBar.e3) cg0Var).currentSheetAnimationType;
                if (i11 == 1) {
                    i22 = (int) (cg0Var.b.getTranslationY() + i22);
                }
                ...
                int i23 = i12 + dp3;
                i13 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingTop;
                if (i13 + i22 < org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) {
                    ...
                    i20 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingTop;
                ...
                if (f10 != 1.0f) {
                    ...
                    i16 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingLeft;
                    i17 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingTop;
                    int measuredWidth = getMeasuredWidth();
                    i18 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingLeft;
                    float f11 = measuredWidth - i18;
                    i19 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingTop;
                    rectF.set(i16, i17 + r4, f11, AndroidUtilities.dp(24.0f) + i19 + r4);
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f) * f10, AndroidUtilities.dp(12.0f) * f10, g6.t0);
                }
                if (f10 != 0.0f) {
                    ...
                    g6.t0.setColor(w02);
                    g6.t0.setAlpha((int) (alpha * 1.0f * f10));
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), g6.t0);
                }
                int w03 = g6.w0(null, g6.h5, false);
                g6.t0.setColor(Color.argb((int) (cg0Var.f.getAlpha() * 255.0f), Color.red(w03), Color.green(w03), Color.blue(w03)));
                i14 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingLeft;
                float f12 = i14;
                int measuredWidth2 = getMeasuredWidth();
                i15 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingLeft;
                canvas.drawRect(f12, 0.0f, measuredWidth2 - i15, AndroidUtilities.statusBarHeight, g6.t0);
                break;
            default:
                super.onDraw(canvas);
                break;
        ...
        switch (this.a) {
            case 1:
                ...
                if (motionEvent.getAction() == 0 && cg0Var.A != 0) {
                    if (motionEvent.getY() < AndroidUtilities.dp(12.0f) + cg0Var.A && cg0Var.f.getAlpha() == 0.0f) {
                        cg0Var.dismiss();
                        return true;
                    }
                }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            case 1:
                ...
                yf0 yf0Var = cg0Var.c;
                wf0 wf0Var = cg0Var.b;
                z10 = ((org.telegram.ui.ActionBar.e3) cg0Var).isFullscreen;
                if (!z10) {
                    this.b = true;
                    i14 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingLeft;
                ...
                ((FrameLayout.LayoutParams) cg0Var.e.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
                i12 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingTop;
                int dp = AndroidUtilities.dp(15.0f) + i12 + AndroidUtilities.statusBarHeight;
                int R = yf0Var.R();
                for (int i17 = 0; i17 < R; i17++) {
                    if (i17 == 0) {
                        i13 = ((org.telegram.ui.ActionBar.e3) cg0Var).backgroundPaddingLeft;
                        s5Var.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10 - (i13 * 2)), TLObject.FLAG_30), i11);
                        M = s5Var.getMeasuredHeight();
                    } else {
                        M = ((yf0Var.M(i17) - 1) * AndroidUtilities.dp(50.0f)) + AndroidUtilities.dp(32.0f);
                    }
                    dp = M + dp;
                }
                int dp2 = AndroidUtilities.dp(8.0f) + (dp < paddingTop ? paddingTop - dp : paddingTop - ((paddingTop / 5) * 3));
                if (wf0Var.getPaddingTop() != dp2) {
                    this.b = true;
                    wf0Var.setPinnedSectionOffsetY(-dp2);
                    wf0Var.setPadding(0, dp2, 0, AndroidUtilities.navigationBarHeight);
                    this.b = false;
                }
