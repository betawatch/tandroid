    ...
    */
    public final void a() {
        ...
        while (i13 < i10) {
            ...
            int i14 = this.N;
            if (i14 == 9) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_folder : i13 == 1 ? R.raw.premium_object_bubble : R.raw.premium_object_settings, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 27) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.filled_messages_paid : i13 == 1 ? R.raw.filled_crown_on : R.raw.premium_object_star2, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 11 || i14 == 4) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_smile1 : i13 == 1 ? R.raw.premium_object_smile2 : R.raw.premium_object_like, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 22) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_user : i13 == 1 ? R.raw.cache_photos : R.raw.cache_profile_photos, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == i12) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_adsbubble : i13 == 1 ? R.raw.premium_object_like : R.raw.premium_object_noads, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 7) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_video2 : i13 == 1 ? R.raw.premium_object_video : R.raw.premium_object_user, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 43) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_list : i13 == 1 ? R.raw.premium_object_math : i13 == 2 ? R.raw.premium_object_table : i13 == i12 ? R.raw.premium_object_superscript : i13 == 4 ? R.raw.premium_object_bold : R.raw.premium_object_code, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 1001) {
                this.d[i13] = SvgHelper.getBitmap(R.raw.premium_object_fire, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 1002) {
                this.d[i13] = SvgHelper.getBitmap(R.raw.premium_object_star2, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 24) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_tag : i13 == 1 ? R.raw.premium_object_check : R.raw.premium_object_star, dp, dp, i0.b.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 28) {
                if (i13 == 0) {
                    this.d[i13] = SvgHelper.getBitmap(R.raw.filled_premium_dollar, dp, dp, i0.b.k(g6.v0(this.P, this.O), 255));
                    this.f[i13] = true;
                }
                ...
                if (this.N == i11 || !(i13 == 1 || i13 == 2)) {
                    ...
                    if (this.q) {
                        ...
                        if (dp >= AndroidUtilities.dp(10.0f)) {
                            j2.d().f(dp * (-2), 0.0f, dp, dp);
                        } else {
                            j2.d().f(dp * (-4), 0.0f, dp, dp);
                        }
                        Paint e9 = j2.d().e();
                        if (this.M) {
                            e9.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(this.r / 5.0f)));
                        }
                        if (this.L) {
                            e9.setAlpha(255);
                        } else if (this.K) {
    ...
    */
    public final void e(Canvas canvas, float f10) {
        ...
        for (int i16 = 0; i16 < arrayList.size(); i16++) {
            ...
            if (this.g) {
                ...
                i3Var2.a(canvas, currentTimeMillis, f10);
            }
            if (this.I && currentTimeMillis > i3Var2.a) {
                i3Var2.b(currentTimeMillis);
            }
            if (this.H) {
                if (!this.b.contains(i3Var2.h, i3Var2.i)) {
                    i3Var2.b(currentTimeMillis);
                }
            }
        }
    ...
    public final void f() {
        ...
        while (true) {
            ...
            ((i3) arrayList.get(i10)).b(currentTimeMillis);
            i10++;
        }
    }
