...
public final class h1 {
    ...
    public int a(int i10) {
        SparseArray sparseArray = ((androidx.emoji2.text.r) this.e).a;
        ...
        if (this.a == 2) {
            if (rVar != null) {
                ...
                androidx.emoji2.text.r rVar2 = (androidx.emoji2.text.r) this.e;
                if (rVar2.b != null) {
                    if (this.c != 1) {
                        this.f = rVar2;
                        d();
                    } else if (e()) {
                        this.f = (androidx.emoji2.text.r) this.e;
                        d();
                    } else {
                        d();
                    }
            ...
            while (i14 < size2) {
                ...
                if (f14 >= fArr2[0] && f14 <= fArr2[2]) {
                    ...
                    if (f15 >= fArr3[0] && f15 <= fArr3[2] && !sparseBooleanArray.get(eVar2.d)) {
                        ...
                        float f18 = fArr4[2];
                        float f19 = abs + abs2 + (f18 > 0.0f ? (eVar2.e / i15) * f18 : 0.0f);
    ...
    public VolumeProvider c() {
        ...
        if (((VolumeProvider) this.e) != null) {
            ...
            h1Var = this;
            h1Var.e = new y1.e(h1Var, this.a, this.b, this.c, (String) this.d);
        } else {
            h1Var = this;
            h1Var.e = new y1.f(this, h1Var.a, h1Var.b, h1Var.c);
        }
        return (VolumeProvider) h1Var.e;
    }

    public void d() {
        this.a = 1;
        this.e = (androidx.emoji2.text.r) this.d;
        this.c = 0;
    }

    public boolean e() {
        p1.a b10 = ((androidx.emoji2.text.r) this.e).b.b();
        int a2 = b10.a(6);
