...
public final class h1 {
    ...
    public h1(int i10) {
        ...
        int i13 = 0;
        while (i13 < o) {
            i13 = th.d((int) sharedPreferences.getLong(j7.l1.k(i13, "color_"), ((Integer) m.get(i13)).intValue()), i13, 1, this.b);
        }
        while (true) {
            if (i12 >= m.a.size()) {
                ...
                hashMap.put(Integer.valueOf(i12), Integer.valueOf((int) sharedPreferences.getLong(j7.l1.k(i12, "brush_color_"), ((m) r1.get(i12)).c())));
                i12++;
            }
        }
    }
    ...
    public final float f(String str, float f9) {
        return this.a.getFloat("weight_" + str, f9);
    }
    ...
    public final void g() {
        if (!this.d.isEmpty() || this.e) {
            ...
            if (!this.d.isEmpty()) {
                int i10 = 0;
                while (i10 < o) {
                    edit.putLong(j7.l1.k(i10, "color_"), ((Integer) (i10 < this.d.size() ? this.d : m).get(i10)).intValue());
                    i10++;
                }
    ...
    public final void j(float f9) {
        this.i = f9;
        this.a.edit().putFloat("weight", f9).apply();
    }

    public final void k(String str, float f9) {
        this.a.edit().putFloat("weight_" + str, f9).apply();
    }
}
