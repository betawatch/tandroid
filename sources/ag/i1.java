...
public class i1 extends qa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public i1(int i10, int i11, Context context, org.telegram.ui.ActionBar.n2 n2Var, c6 c6Var) {
        ...
        if (i10 == 18 || i10 == 20 || i10 == 24 || i10 == 25 || i10 == 26 || i10 == 29 || i10 == 22 || i10 == 23 || i10 == 21 || i10 == 27 || i10 == 28 || i10 == 30 || i10 == 35 || i10 == 31) {
            ...
            int k10 = i0.b.k(g6.v0(g6.d6, c6Var), 120);
            textView.setBackground(g6.i0(dp, dp, dp, dp, v02, k10, k10));
        }
        if (i10 == 32) {
            ((ViewGroup) this.A0.getParent()).removeView(this.A0);
    ...
    public static /* synthetic */ void P(i1 i1Var, ArrayList arrayList, TLRPC.User user) {
        i1Var.dismiss();
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            MessagesController.getInstance(i1Var.currentAccount).deleteParticipantFromChat(chat.id, user);
        }
    }

    public static /* synthetic */ void Q(i1 i1Var, ArrayList arrayList) {
        i1Var.dismiss();
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
    ...
    public static void R(i1 i1Var, ArrayList arrayList, int i10, TLRPC.TL_messages_inactiveChats tL_messages_inactiveChats) {
        int i11;
        zk0 zk0Var = i1Var.d;
        ArrayList arrayList2 = i1Var.w0;
        arrayList2.clear();
        ArrayList arrayList3 = i1Var.v0;
        arrayList3.clear();
        ...
        while (true) {
            if (i13 >= zk0Var.getChildCount()) {
                ...
                if (zk0Var.getChildAt(i13) instanceof g1) {
                    i11 = zk0Var.getChildAt(i13).getTop();
                    break;
                }
                i13++;
            }
        ...
        i1Var.M1();
        if (i1Var.h0 >= 0 && i11 != 0) {
            ((f2.k0) zk0Var.getLayoutManager()).h1(i1Var.h0 + 1, i11);
        }
        if (i1Var.I0 == null) {
            i1Var.I0 = u1(i1Var.d0, i1Var.currentAccount);
        }
        int max = Math.max(arrayList3.size(), i1Var.I0.b);
        f1 f1Var = i1Var.t0;
        if (f1Var != null) {
            f1Var.g(max, false);
    ...
    public static void S(i1 i1Var) {
        ...
        if (i10 == 2) {
            ...
            while (it.hasNext()) {
                i1Var.e0.add((TLRPC.Chat) it.next());
            }
            i1Var.D1(arrayList);
            return;
        }
        if (i10 == 5) {
            ...
            if (textView != null) {
                textView.setTextColor(g6.v0(g6.q7, i1Var.resourcesProvider));
            }
        }
    }

    public static /* synthetic */ void U(i1 i1Var, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tL_error == null) {
            ...
            AndroidUtilities.runOnUIThread(new k0(i1Var, arrayList, min, tL_messages_inactiveChats, 0));
        }
    }
    ...
    public static void V(i1 i1Var, Context context) {
        ...
        if (z10 && canApplyBoost.replaceDialogId == 0) {
            ...
            i1Var.b0 = true;
            i1Var.t0.W = false;
            org.telegram.ui.ActionBar.n2 n2Var2 = i1Var.n;
            ChannelBoostsController.CanApplyBoost canApplyBoost2 = i1Var.Y;
    ...
    public static void W(i1 i1Var, View view) {
        ...
        if (view instanceof d4) {
            if (i1Var.U || !((i10 = i1Var.d0) == 11 || i10 == 34)) {
                d4 d4Var = (d4) view;
    ...
    public static h1 u1(int i10, int i11) {
        ...
        h1Var.c = 0;
        if (i10 == 0) {
            h1Var.b = MessagesController.getInstance(i11).dialogFiltersPinnedLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).dialogFiltersPinnedLimitPremium;
            h1Var.a = R.drawable.msg_limit_pin;
            h1Var.d = LocaleController.formatString("LimitReachedPinDialogs", R.string.LimitReachedPinDialogs, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedPinDialogsPremium", R.string.LimitReachedPinDialogsPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedPinDialogsLocked", R.string.LimitReachedPinDialogsLocked, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 33) {
            h1Var.b = MessagesController.getInstance(i11).savedDialogsPinnedLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).savedDialogsPinnedLimitPremium;
            h1Var.a = R.drawable.msg_limit_pin;
            h1Var.d = LocaleController.formatString(R.string.LimitReachedPinSavedDialogs, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString(R.string.LimitReachedPinSavedDialogsPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString(R.string.LimitReachedPinSavedDialogsLocked, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 2) {
            h1Var.b = MessagesController.getInstance(i11).publicLinksLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).publicLinksLimitPremium;
            h1Var.a = R.drawable.msg_limit_links;
            h1Var.d = LocaleController.formatString("LimitReachedPublicLinks", R.string.LimitReachedPublicLinks, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedPublicLinksPremium", R.string.LimitReachedPublicLinksPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedPublicLinksLocked", R.string.LimitReachedPublicLinksLocked, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 12) {
            h1Var.b = MessagesController.getInstance(i11).chatlistInvitesLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).chatlistInvitesLimitPremium;
            h1Var.a = R.drawable.msg_limit_links;
            h1Var.d = LocaleController.formatString("LimitReachedFolderLinks", R.string.LimitReachedFolderLinks, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedFolderLinksPremium", R.string.LimitReachedFolderLinksPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedFolderLinksLocked", R.string.LimitReachedFolderLinksLocked, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 13) {
            h1Var.b = MessagesController.getInstance(i11).chatlistJoinedLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).chatlistJoinedLimitPremium;
            h1Var.a = R.drawable.msg_limit_folder;
            h1Var.d = LocaleController.formatString("LimitReachedSharedFolders", R.string.LimitReachedSharedFolders, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedSharedFoldersPremium", R.string.LimitReachedSharedFoldersPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedSharedFoldersLocked", R.string.LimitReachedSharedFoldersLocked, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 3) {
            h1Var.b = MessagesController.getInstance(i11).dialogFiltersLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).dialogFiltersLimitPremium;
            h1Var.a = R.drawable.msg_limit_folder;
            h1Var.d = LocaleController.formatString("LimitReachedFolders", R.string.LimitReachedFolders, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedFoldersPremium", R.string.LimitReachedFoldersPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedFoldersLocked", R.string.LimitReachedFoldersLocked, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 4) {
            h1Var.b = MessagesController.getInstance(i11).dialogFiltersChatsLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).dialogFiltersChatsLimitPremium;
            h1Var.a = R.drawable.msg_limit_chats;
            h1Var.d = LocaleController.formatString("LimitReachedChatInFolders", R.string.LimitReachedChatInFolders, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedChatInFoldersPremium", R.string.LimitReachedChatInFoldersPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedChatInFoldersLocked", R.string.LimitReachedChatInFoldersLocked, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 5) {
            h1Var.b = MessagesController.getInstance(i11).channelsLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).channelsLimitPremium;
            h1Var.a = R.drawable.msg_limit_groups;
            h1Var.d = LocaleController.formatString("LimitReachedCommunities", R.string.LimitReachedCommunities, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedCommunitiesPremium", R.string.LimitReachedCommunitiesPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedCommunitiesLocked", R.string.LimitReachedCommunitiesLocked, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 6) {
            h1Var.b = 100;
            ...
            h1Var.e = LocaleController.formatString("LimitReachedFileSizePremium", R.string.LimitReachedFileSizePremium, "4 GB");
            h1Var.f = LocaleController.formatString("LimitReachedFileSizeLocked", R.string.LimitReachedFileSizeLocked, "2 GB");
            return h1Var;
        }
        if (i10 == 7) {
            h1Var.b = 3;
            h1Var.c = 4;
            h1Var.a = R.drawable.msg_limit_accounts;
            h1Var.d = LocaleController.formatString("LimitReachedAccounts", R.string.LimitReachedAccounts, 3, Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedAccountsPremium", R.string.LimitReachedAccountsPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedAccountsPremium", R.string.LimitReachedAccountsPremium, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 11) {
            h1Var.b = 0;
            h1Var.c = 0;
            h1Var.a = R.drawable.msg_limit_links;
            h1Var.d = LocaleController.formatString("LimitReachedAccounts", R.string.LimitReachedAccounts, 0, Integer.valueOf(h1Var.c));
            h1Var.e = "";
            h1Var.f = "";
            return h1Var;
        }
        if (i10 == 14) {
            h1Var.b = MessagesController.getInstance(i11).storyExpiringLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).storyExpiringLimitPremium;
            h1Var.a = R.drawable.msg_limit_stories;
            h1Var.d = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2First", h1Var.b) + "\n" + LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Second", h1Var.c);
            h1Var.e = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Premium", h1Var.c);
            h1Var.f = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Premium", h1Var.b);
            return h1Var;
        }
        if (i10 == 15) {
            h1Var.b = MessagesController.getInstance(i11).storiesSentWeeklyLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).storiesSentWeeklyLimitPremium;
            h1Var.a = R.drawable.msg_limit_stories;
            h1Var.d = LocaleController.formatString("LimitReachedStoriesWeekly", R.string.LimitReachedStoriesWeekly, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        if (i10 == 16) {
            h1Var.b = MessagesController.getInstance(i11).storiesSentMonthlyLimitDefault;
            h1Var.c = MessagesController.getInstance(i11).storiesSentMonthlyLimitPremium;
            h1Var.a = R.drawable.msg_limit_stories;
            h1Var.d = LocaleController.formatString("LimitReachedStoriesMonthly", R.string.LimitReachedStoriesMonthly, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
            h1Var.e = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(h1Var.c));
            h1Var.f = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(h1Var.b));
            return h1Var;
        }
        ...
        h1Var.b = MessagesController.getInstance(i11).storiesSentMonthlyLimitDefault;
        h1Var.c = MessagesController.getInstance(i11).storiesSentMonthlyLimitPremium;
        h1Var.a = R.drawable.filled_limit_boost;
        h1Var.d = LocaleController.formatString("LimitReachedStoriesMonthly", R.string.LimitReachedStoriesMonthly, Integer.valueOf(h1Var.b), Integer.valueOf(h1Var.c));
        h1Var.e = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(h1Var.c));
        h1Var.f = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(h1Var.b));
        return h1Var;
    ...
    public final boolean B1() {
        ...
        g1 g1Var = this.Z;
        cg.b bVar = g1Var.c;
        int indexOfChild = g1Var.indexOfChild(g1Var.b);
        i1 i1Var = g1Var.e;
        if (i1Var.a0) {
            int indexOfChild2 = g1Var.indexOfChild(g1Var.d);
            g1Var.removeView(g1Var.d);
            g1Var.d.removeView(g1Var.a);
            ...
            g1Var.d.addView(g1Var.a, z5.o(-2, -2, 1.0f, 0));
            g1Var.d.addView(bVar, z5.t(-2, -2, 48, 0, 2, 0, 0));
            g1Var.addView(g1Var.d, indexOfChild2, z5.t(-2, -2, 1, 25, 22, 12, 9));
        } else {
            int indexOfChild3 = g1Var.indexOfChild(g1Var.a);
            g1Var.removeView(g1Var.a);
            TextView textView = new TextView(g1Var.getContext());
            g1Var.a = textView;
            textView.setTypeface(AndroidUtilities.bold());
            g1Var.a.setTextSize(1, 20.0f);
            g1Var.a.setTextColor(g6.v0(g6.G6, i1Var.resourcesProvider));
            g1Var.a.setGravity(17);
            g1Var.addView(g1Var.a, indexOfChild3, z5.t(-2, -2, 1, 0, 22, 0, 0));
        }
        g1Var.removeView(g1Var.b);
        TextView textView2 = new TextView(g1Var.getContext());
        g1Var.b = textView2;
        textView2.setTextSize(1, 14.0f);
        TextView textView3 = g1Var.b;
        textView3.setLineSpacing(textView3.getLineSpacingExtra(), g1Var.b.getLineSpacingMultiplier() * 1.1f);
        g1Var.b.setGravity(1);
        g1Var.b.setTextColor(g6.v0(g6.G6, i1Var.resourcesProvider));
        g1Var.addView(g1Var.b, indexOfChild, z5.t(-2, -2, 1, 24, -2, 24, 17));
        this.Z.a.setText(r1());
    ...
    public final void G(zu0 zu0Var) {
        ...
        if (!this.r && (i10 = this.d0) != 18 && i10 != 20 && i10 != 24 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 22 && i10 != 23 && i10 != 21 && i10 != 27 && i10 != 28 && i10 != 30 && i10 != 35) {
            ...
            this.H0 = s0Var;
            s0Var.setBackgroundColor(g6.v0(g6.h5, this.resourcesProvider));
        ...
        this.A0.r.setOnClickListener(new q0(0, this, context));
        this.A0.e.setOnClickListener(new e0(this, 3));
    ...
    public final void J1() {
        ...
        while (i11 <= i12) {
            ...
            if (messagesController2 != null) {
                ...
                b1 b10 = b1.b(R.drawable.menu_feature_stories, i11, "BoostFeatureStoriesPerDay");
                b10.f = true;
                arrayList2.add(b10);
                if (!x12) {
                    b1 b11 = b1.b(R.drawable.menu_feature_reactions, i11, "BoostFeatureCustomReaction");
                    b11.f = true;
                    arrayList2.add(b11);
                }
                ...
                if (!x12 && colorsAvailable > 0) {
                    arrayList2.add(b1.b(R.drawable.menu_feature_links, colorsAvailable, "BoostFeatureReplyColor"));
                }
                ...
                if (colorsAvailable2 > 0) {
                    arrayList2.add(b1.b(R.drawable.menu_feature_color_profile, colorsAvailable2, x12 ? "BoostFeatureProfileColorGroup" : "BoostFeatureProfileColor"));
                }
                ...
                if ((!x12 && i11 >= messagesController2.channelProfileIconLevelMin) || (x12 && i11 >= messagesController2.groupProfileBgIconLevelMin)) {
                    arrayList2.add(b1.a(R.drawable.menu_feature_cover, x12 ? R.string.BoostFeatureProfileIconGroup : R.string.BoostFeatureProfileIcon));
                }
                ...
                if ((!x12 && i11 >= messagesController2.channelWallpaperLevelMin) || (x12 && i11 >= messagesController2.groupWallpaperLevelMin)) {
                    arrayList2.add(b1.b(R.drawable.menu_feature_wallpaper, 8, x12 ? "BoostFeatureBackgroundGroup" : "BoostFeatureBackground"));
                }
                if ((!x12 && i11 >= messagesController2.channelCustomWallpaperLevelMin) || (x12 && i11 >= messagesController2.groupCustomWallpaperLevelMin)) {
                    arrayList2.add(b1.a(R.drawable.menu_feature_custombg, x12 ? R.string.BoostFeatureCustomBackgroundGroup : R.string.BoostFeatureCustomBackground));
                }
            ...
            if (arrayList != null && arrayList.size() == arrayList2.size()) {
                while (i10 < arrayList.size()) {
                    ...
                    int i13 = b1Var.e;
                    i10 = (b1Var2 != null && ((b1Var.f && i13 > 2) || (b1Var.a == b1Var2.a && b1Var.b == b1Var2.b && TextUtils.equals(b1Var.c, b1Var2.c) && TextUtils.equals(b1Var.d, b1Var2.d) && i13 == b1Var2.e))) ? i10 + 1 : 0;
                }
                i11++;
            }
            ArrayList arrayList3 = this.q0;
            arrayList3.add(new a1(i11, arrayList3.isEmpty()));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 != NotificationCenter.boostByChannelCreated) {
            ...
            if (B1()) {
                ec Q = new mc(this.container, this.resourcesProvider).Q(R.raw.ic_boosts_replace, 30, LocaleController.formatPluralString("BoostingReassignedFromPlural", intValue, LocaleController.formatPluralString("BoostingFromOtherChannel", intValue2, new Object[0])));
                Q.j = 4000;
                Q.k(true);
                return;
            }
        ...
        if (lastFragment instanceof ig.s) {
            ...
            org.telegram.ui.ActionBar.n2 n2Var2 = fragmentStack.size() >= 2 ? (org.telegram.ui.ActionBar.n2) i0.a.j(2, fragmentStack) : null;
            org.telegram.ui.ActionBar.n2 n2Var3 = fragmentStack.size() >= 3 ? (org.telegram.ui.ActionBar.n2) i0.a.j(3, fragmentStack) : null;
            r6 = fragmentStack.size() >= 4 ? (org.telegram.ui.ActionBar.n2) i0.a.j(4, fragmentStack) : null;
        ...
        if ((lastFragment instanceof rn) && booleanValue) {
        ...
        if ((lastFragment instanceof xc) && booleanValue) {
            ...
            for (int size = fragmentStack2.size() - 2; size >= 0; size--) {
                org.telegram.ui.ActionBar.n2 n2Var4 = (org.telegram.ui.ActionBar.n2) fragmentStack2.get(size);
                if ((n2Var4 instanceof rn) || (n2Var4 instanceof gy)) {
                    r6 = n2Var4;
                    break;
                }
        ...
        if (!booleanValue) {
            ...
            sb.x();
            dismiss();
            cg.r.f(R9, chat, false);
            return;
        }
        sb sbVar2 = sb.B2;
        if (sbVar2 != null && sbVar2.d) {
            rn R92 = rn.R9(-chat.id);
            LaunchActivity.R().presentFragment(R92, false, false);
            sb.x();
            dismiss();
            cg.r.f(R92, chat, true);
            return;
        }
        List fragmentStack3 = n2Var.getParentLayout().getFragmentStack();
        r6 = fragmentStack3.size() >= 2 ? (org.telegram.ui.ActionBar.n2) i0.a.j(2, fragmentStack3) : null;
        n2Var.finishFragment();
        dismiss();
        if (r6 instanceof rn) {
            cg.r.f(r6, chat, true);
    ...
    public final void m1(final s80 s80Var, boolean z10) {
        if (!s80Var.b() || z10) {
            ...
            int i10 = this.Y.slot;
            final int i11 = 0;
            Utilities.Callback<TL_stories.TL_premium_myBoosts> callback = new Utilities.Callback(this) { // from class: ag.m0
                ...
                public final void run(Object obj) {
                    switch (i11) {
                        case 0:
                            MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.W, new o0(this.b, s80Var, (TL_stories.TL_premium_myBoosts) obj, 0));
                            break;
                        default:
                            ...
                            if (startsWith) {
                                ...
                                if (intValue <= 5) {
                                    AndroidUtilities.runOnUIThread(new a1.e(5, this.b, s80Var2), intValue * 1000);
                                    break;
                                } else {
                                    cg.r.g(intValue);
                                }
            ...
            final int i12 = 1;
            boostsController.applyBoost(j10, i10, callback, new Utilities.Callback(this) { // from class: ag.m0
                public final /* synthetic */ i1 b;
    ...
    public final void z1() {
        ...
        f1Var.b++;
        f1Var.a = h7.n.a((i10 - r3) / i11, 0.0f, 1.0f);
        f1Var.S = true;
        f1Var.T = f1Var.n;
        f1Var.g(i10, true);
