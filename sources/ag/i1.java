...
public final class i1 {
    ...
    public i1(f8.a aVar, Bitmap bitmap, bv0 bv0Var, boolean z10) {
        ...
        if (pointF != null && pointF2 != null) {
            ...
            this.c = new PointF((((float) Math.cos(radians)) * f9) + pointF7.x, (f9 * ((float) Math.sin(radians))) + pointF7.y);
        }
    ...
    public static PointF b(PointF pointF, Bitmap bitmap, bv0 bv0Var, boolean z10) {
        return new PointF((bv0Var.a * pointF.x) / (z10 ? bitmap.getHeight() : bitmap.getWidth()), (bv0Var.b * pointF.y) / (z10 ? bitmap.getWidth() : bitmap.getHeight()));
    }
