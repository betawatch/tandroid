...
public final class y extends View {
        ...
        for (int i10 = 0; i10 < 12; i10++) {
            for (int i11 = 0; i11 < 10; i11++) {
                if (i11 == 0) {
                    ...
                    this.n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(i11 < 6 ? i0.a.d(((5 - i11) / 4.0f) * 0.5f, this.b[i10], -16777216) : i0.a.d(x3.A(9 - i11, 5.0f, 0.5f, 0.5f), this.b[i10], -1)));
                }
            }
        }
    }
    ...
    public final void c(MotionEvent motionEvent) {
        ...
        int x4 = (int) ((motionEvent.getX() - getPaddingLeft()) / width);
        int y8 = (int) (motionEvent.getY() / height);
        Integer num = (Integer) this.n.get(Long.valueOf((x4 << 16) + y8));
        if (num != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            paint2.setStrokeWidth(jr.h.getInterpolation(min) * AndroidUtilities.dp(3.0f));
            Path path2 = this.f;
            path2.rewind();
            ...
            rectF3.set((i13 * f9) + getPaddingLeft(), (i14 * f10) + getPaddingTop(), ((i13 + 1) * f9) + getPaddingLeft(), ((i14 + 1) * f10) + getPaddingTop());
