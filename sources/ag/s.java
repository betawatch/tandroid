...
public final class s extends View {
    ...
    public void a() {
        this.b.setShader(new LinearGradient(0.0f, 0.0f, getWidth(), 0.0f, new int[]{0, ((f0) this.e).f}, (float[]) null, Shader.TileMode.CLAMP));
    }

    public void b(float f9) {
        float dp = AndroidUtilities.dp(6.0f);
        float a2 = i7.w.a(((f9 - dp) + (AndroidUtilities.dp(13.0f) - (this.c.getStrokeWidth() / 2.0f))) / (getWidth() - (dp * 2.0f)), 0.0f, 1.0f);
        this.d = a2;
        f0 f0Var = (f0) this.e;
        f0Var.m(i0.a.k(f0Var.f, (int) (a2 * 255.0f)), 1);
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.a) {
            case 0:
                ...
                f0 f0Var = (f0) this.e;
                f0Var.e.rewind();
                f0Var.e.addRoundRect(rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), Path.Direction.CW);
                canvas.clipPath(f0Var.e);
                ...
                bg.h2.x1(max, height, strokeWidth, i0.a.k(f0Var.f, (int) (this.d * 255.0f)), canvas);
                break;
            default:
                super.onDraw(canvas);
