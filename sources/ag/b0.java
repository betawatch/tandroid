...
public final class b0 extends View {
    ...
    public static void a(b0 b0Var) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (((a0) arrayList.get(i10)).f != null) {
                return;
            }
        }
        arrayList.clear();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (limitPreviewView.F) {
            ...
            canvas.drawRoundRect(rectF, f10, f10, d10.c);
        } else {
            if (this.v) {
                this.v = false;
                b();
            ...
            canvas.drawRoundRect(rectF2, f12, f12, z10 ? paint : limitPreviewView.a0 != null ? textPaint : j2.d().e());
            Paint e9 = j2.d().e();
            CornerPathEffect cornerPathEffect = this.b;
            e9.setPathEffect(cornerPathEffect);
            if (limitPreviewView.a0 != null) {
                textPaint.setPathEffect(cornerPathEffect);
            }
            if (!limitPreviewView.N) {
                paint = limitPreviewView.a0 != null ? textPaint : j2.d().e();
            }
        ...
        if (this.r) {
            ...
            while (true) {
                ...
                if (z11) {
                    canvas.translate(a0Var.e + measuredWidth3, ((i10 * a0Var.c) + height) - ((1 - arrayList2.size()) * i10));
                    for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                        canvas.translate(0.0f, -i10);
                        ((StaticLayout) arrayList2.get(i12)).draw(canvas);
                    }
                } else if (a0Var.d) {
                    canvas.translate(a0Var.e + measuredWidth3, (height - ((i10 * 10) * a0Var.c)) + ((10 - arrayList2.size()) * i10));
                    for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                        canvas.translate(0.0f, i10);
                        ((StaticLayout) arrayList2.get(i13)).draw(canvas);
                    }
                } else {
                    canvas.translate(a0Var.e + measuredWidth3, (((i10 * 10) * a0Var.c) + height) - ((10 - arrayList2.size()) * i10));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TextPaint textPaint = this.c;
        this.e = w3.g(spannableStringBuilder, textPaint);
