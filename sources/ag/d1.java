...
public final /* synthetic */ class d1 implements Runnable {
    ...
    public /* synthetic */ d1(f1 f1Var, g1 g1Var, int i10, boolean z10, Runnable runnable) {
        this.a = 0;
        this.d = f1Var;
        this.e = g1Var;
        this.c = i10;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                boolean z10 = this.b;
                f1Var.d(g1Var, this.c, z10 ? f1Var.h : null);
                if (z10) {
                    f1Var.h = null;
                }
                if (runnable != null) {
            ...
            case 1:
                ...
                if (document != null) {
                    ...
                    SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, g6.a7, 0.3f);
            ...
            case 3:
                ...
                int i13 = lsVar.J;
                if (this.c == lsVar.Z && TextUtils.equals(tL_messages_searchGlobal.q, lsVar.a0)) {
                    lsVar.V = false;
                    if (!this.b) {
                        arrayList.clear();
                    }
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        ...
                        while (i14 < size) {
                            ...
                            messageObject.setQuery(lsVar.a0);
            ...
            default:
                ...
                int i15 = nsVar.J;
                if (this.c == nsVar.W && TextUtils.equals(tL_messages_searchGlobal2.q, nsVar.X)) {
                    nsVar.S = false;
                    if (!this.b) {
                        arrayList3.clear();
                    }
    ...
    public /* synthetic */ d1(MessagesController messagesController, TLRPC.Chat chat, boolean z10, int i10, q0.a aVar) {
        this.a = 2;
    ...
    public /* synthetic */ d1(k51 k51Var, int i10, TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, boolean z10, TLObject tLObject, int i11) {
        this.a = i11;
        this.d = k51Var;
        this.c = i10;
    ...
    public /* synthetic */ d1(boolean z10, int i10, String str, ImageReceiver imageReceiver, boolean[] zArr) {
        this.a = 1;
        this.b = z10;
        this.c = i10;
        this.d = str;
