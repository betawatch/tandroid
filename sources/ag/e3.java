...
public class e3 extends ViewGroup {
    ...
    */
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        e3 e3Var = this.A;
        Paint paint = e3Var != null ? e3Var.y : this.y;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        b(textView2);
        rect.set(getPaddingLeft() + bpVar.getMeasuredWidth() + AndroidUtilities.dp(f10) + (textView2.getVisibility() == 0 ? AndroidUtilities.dp(6.0f) + textView2.getMeasuredWidth() : 0), (getMeasuredHeight() - textView3.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
        b(textView3);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        bp bpVar = this.a;
        bpVar.measure(makeMeasureSpec, makeMeasureSpec);
        int makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(size - bpVar.getMeasuredWidth(), TLObject.FLAG_31);
        ...
        this.b.measure(View.MeasureSpec.makeMeasureSpec((size - bpVar.getMeasuredWidth()) - textView.getMeasuredWidth(), TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(dp, TLObject.FLAG_31));
        TextView textView2 = this.r;
        if (textView2.getVisibility() == 0) {
            textView2.measure(View.MeasureSpec.makeMeasureSpec((size - bpVar.getMeasuredWidth()) - textView.getMeasuredWidth(), TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(dp, TLObject.FLAG_31));
        } else {
        ...
        int makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(size - bpVar.getMeasuredWidth(), TLObject.FLAG_31);
        ...
        int d = rl.d(6.0f, (size - bpVar.getMeasuredWidth()) - (textView3.getVisibility() == 0 ? textView3.getMeasuredWidth() : 0), TLObject.FLAG_31);
    ...
    public void setProgressDelegate(cp cpVar) {
        this.a.setProgressDelegate(cpVar);
    }
}
