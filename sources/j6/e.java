...
public final class e {
    ...
    public static final bd.b j = new bd.b(2);
    public static final ab.a k;
    public static j l;
    public static k m;
    ...
    public static e c(Context context, d dVar, String str) {
        ...
        try {
            ...
            b8.b Y1 = dVar.Y1(context, str, k);
            j10 = longValue;
            try {
                Log.i("DynamiteModule", "Considering local module " + str + ":" + Y1.a + " and remote module " + str + ":" + Y1.b);
                int i10 = Y1.c;
                if (i10 != 0) {
                    if (i10 == -1) {
                        if (Y1.a != 0) {
                    ...
                    if (i10 != 1 || Y1.b != 0) {
                        if (i10 == -1) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (bool.booleanValue()) {
                                        ...
                                        if (z10) {
                                            ...
                                            U02 = kVar.V0(new i6.b(applicationContext2), str, i11, new i6.b(cursor));
                                        } else {
                                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                                            U02 = kVar.U0(new i6.b(applicationContext2), str, i11, new i6.b(cursor));
                                        }
                                        Context context2 = (Context) i6.b.K0(U02);
                                        if (context2 == null) {
                                        ...
                                        if (readInt >= 3) {
                                            ...
                                            U0 = h10.V0(new i6.b(context), str, i11, new i6.b(iVar4.a));
                                        } else if (readInt == 2) {
                                            Log.w("DynamiteModule", "IDynamite loader version = 2");
                                            U0 = h10.W0(new i6.b(context), str, i11);
                                        } else {
                                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                                            U0 = h10.U0(new i6.b(context), str, i11);
                                        }
                                        Object K02 = i6.b.K0(U0);
                                        if (K02 == null) {
                                ...
                                int i12 = Y1.a;
                                if (i12 == 0 || dVar.Y1(context, str, new com.google.android.gms.internal.cast.a(i12)).c != -1) {
                ...
                throw new b("No acceptable module " + str + " found. Local version is " + Y1.a + " and remote version is " + Y1.b + ".");
            } catch (Throwable th2) {
                th = th2;
                if (j10 == 0) {
                    j.remove();
                ...
                try {
                    ...
                    try {
                        ...
                        if (readInt2 >= 3) {
                            ...
                            Cursor cursor3 = (Cursor) i6.b.K0(h10.X0(new i6.b(context), str, z10, ((Long) j.get()).longValue()));
                            if (cursor3 != null) {
                                try {
    ...
    */
    ...
    public static boolean g(Context context) {
        ...
        if (h == null) {
            ...
            if (v5.e.b.d(context, 10000000) == 0 && resolveContentProvider != null && "com.google.android.gms".equals(resolveContentProvider.packageName)) {
                z10 = true;
            }
