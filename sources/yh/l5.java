...
public final class l5 {
    ...
    public final void b(String str, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(createstargiftcollection, new ai.p3(this, tL_starGiftCollection, m5Var, callback, 20));
    }
    ...
    public final m5 e(int i10) {
        return (m5) this.h.get(Integer.valueOf(i10));
    }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                while (i11 < arrayList2.size()) {
                    ...
                    while (true) {
                        ...
                        if (u5.k(savedStarGift2, (TL_stars.SavedStarGift) arrayList.get(i12))) {
    ...
    public final void l(TL_stars.SavedStarGift savedStarGift, int i10, boolean z10) {
        ...
        while (it.hasNext()) {
            ((m5) it.next()).n(savedStarGift, i10, z10);
        }
        m5 m5Var = this.g;
        if (m5Var != null) {
            m5Var.n(savedStarGift, i10, z10);
        }
    }
    ...
    public final void m(TL_stars.SavedStarGift savedStarGift, boolean z10) {
        Iterator it = this.h.values().iterator();
        while (it.hasNext()) {
            ((m5) it.next()).o(savedStarGift, z10);
        }
        m5 m5Var = this.g;
        if (m5Var != null) {
            m5Var.o(savedStarGift, z10);
        }
    }
