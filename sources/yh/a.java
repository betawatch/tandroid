...
public final class a extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a() {
        ...
        c90 c90Var = this.d;
        if (bVar2 == bVar3) {
            textView.setText(y7.X0(false, LocaleController.formatString(R.string.Gift2MessageStarsInfo, LocaleController.formatNumber(s10.a(), ',')), 0.6f, null));
        ...
        if (bVar2 == zf.b.b) {
            ...
            oq[] oqVarArr = this.f;
            textView.setText(y7.X0(true, replaceTags, 0.6f, oqVarArr));
            ...
            c90Var.setTextColor(i0.a.d(0.33f, v02, org.telegram.ui.ActionBar.j6.v0(i13, f6Var)));
            c90Var.setLinkTextColor(i0.a.d(0.33f, org.telegram.ui.ActionBar.j6.v0(i12, f6Var), org.telegram.ui.ActionBar.j6.v0(i13, f6Var)));
            c90Var.setText(sb2);
        }
    }
    ...
    public a(Context context, int i10, zf.b bVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        c90Var.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.Gift2MessageStarsInfoLink), new ns(context, f6Var)), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)));
