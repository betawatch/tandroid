...
public final class j5 {
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        ConnectionsManager.getInstance(i13).sendRequest(updatestargiftcollection, new h5(this, i11));
    }
    ...
    public final void i() {
        ...
        this.i = ConnectionsManager.getInstance(i10).sendRequest(getstargiftcollections, new h5(this, 0));
    }
    ...
    public final void l(TL_stars.SavedStarGift savedStarGift, int i10, boolean z10) {
        ...
        while (it.hasNext()) {
            ((k5) it.next()).n(savedStarGift, i10, z10);
        }
        k5 k5Var = this.g;
        if (k5Var != null) {
    ...
    public final void m(TL_stars.SavedStarGift savedStarGift, boolean z10) {
        Iterator it = this.h.values().iterator();
        while (it.hasNext()) {
            ((k5) it.next()).o(savedStarGift, z10);
        }
        k5 k5Var = this.g;
        if (k5Var != null) {
