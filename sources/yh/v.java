...
public final class v extends bb implements GiftAuctionController.OnAuctionUpdateListener {
    ...
    public static final nz0[] q0 = new nz0[1];
    ...
    public v(Context context, f6 f6Var, long j3, TL_stars.StarGift starGift, Runnable runnable) {
        ...
        r rVar = new r(context, this.currentAccount, f6Var);
        rVar.a0 = true;
        ...
        this.h0 = new org.telegram.tgnet.e(this, new di.f4[1], frameLayout2, 5);
        TableRow c10 = oz0Var.c(LocaleController.getString(R.string.GiftValueAveragePrice), "", null, adVarArr);
        this.i0 = c10;
        final int i14 = 1;
        c10.setOnClickListener(new View.OnClickListener(this) { // from class: yh.q
            ...
            public final void onClick(View view) {
                switch (i14) {
                    case 0:
                        new sg.a1(this.b.getContext(), 40, (f6) null).show();
                        break;
                    default:
                        this.b.T();
                        break;
        ...
        if (auction2 != null && auction2.previewAttributes != null) {
            ...
            TextView f7 = p6.f(this.a0, textView2, x5.d(-2, 26.0f, 81, 16.0f, 0.0f, 16.0f, 77.0f), context);
            f7.setTypeface(AndroidUtilities.bold());
            f7.setTextSize(1, 21.0f);
            f7.setText(str2);
            f7.setGravity(17);
            f7.setTextColor(-1);
            TextView f10 = p6.f(this.a0, f7, x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 40.0f), context);
            ...
            f10.setOnClickListener(new View.OnClickListener(this) { // from class: yh.q
                public final /* synthetic */ v b;
            ...
            int i24 = j6.J6;
            d90Var3.setTextColor(j6.v0(i24, f6Var));
            d90Var3.setLinkTextColor(j6.v0(i24, f6Var));
            ...
            for (int i25 = 0; i25 < 3; i25++) {
                ...
                if (stargiftattributemodel != null) {
                    ...
                    spannableStringBuilder2.setSpan(new org.telegram.ui.Components.z5(stargiftattributemodel.document, d90Var3.getPaint().getFontMetricsInt()), i25, i25 + 1, 33);
                }
            }
    ...
    public static /* synthetic */ void P(v vVar, boolean[] zArr, f6 f6Var) {
        if (zArr[0]) {
            return;
        }
        zArr[0] = true;
    ...
    public static /* synthetic */ void R(v vVar, Context context, f6 f6Var) {
    ...
    public static void U(Context context, TL_stars.StarGift starGift, f6 f6Var) {
        ...
        org.telegram.ui.ActionBar.f3 i10 = vl.i(1, context, null, false);
    ...
    */
    public final void V(boolean z10) {
        ...
        if (auction2 != null && (tL_starGiftAuctionStateFinished = auction2.auctionStateFinished) != null) {
            ...
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(v7.X0(false, i2.g.k(this.m0.auctionStateFinished.average_price, ',', new StringBuilder("⭐️ ")), 0.8f, null));
        ...
        if (auction3 != null) {
            ...
            nz0 nz0Var = this.g0;
            if (i10 != i11) {
                nz0Var.setText(LocaleController.getString(R.string.Gift2AuctionTableCurrentQuantity));
                adVar3.setText(LocaleController.formatNumber(i11, ','));
            } else {
                nz0Var.setText(LocaleController.getString(R.string.Gift2AuctionTableCurrentAvailability));
            ...
            if (i12 <= 0) {
                ...
                d90Var.setText(TextUtils.concat(AndroidUtilities.replaceArrows(LocaleController.formatPluralSpannable("Gift2AuctionsItemsBought2", i12, this.n0), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f))));
            } else {
            ...
            d90Var2.setTextColor(j6.v0(j6.q7, this.resourcesProvider));
