...
public final class o3 extends rq {
    ...
    public final h01 k;
    public final h01 l;
    public org.telegram.ui.Components.m6 m;
    ...
    public o3(View view, TL_stars.StarGift starGift, int i10, float f7) {
        ...
        org.telegram.ui.Components.m5 m5Var = new org.telegram.ui.Components.m5(view, AndroidUtilities.dp(i10 > 180 ? 24.0f : 18.0f), false);
        this.h = m5Var;
        this.e = i10;
        if (starGift instanceof TL_stars.TL_starGift) {
            float f12 = i10;
            y7.Z0(imageReceiver, starGift.sticker, (int) (0.75f * f12));
            String str = starGift.title;
            h01 h01Var = new h01(str == null ? "Gift" : str, 16.0f, AndroidUtilities.bold());
            this.k = h01Var;
            h01Var.o(-1);
            float f13 = i10 - 30;
            h01Var.q(AndroidUtilities.dp(f13));
            Layout.Alignment alignment = Layout.Alignment.ALIGN_CENTER;
            h01Var.a();
            h01Var.n(1);
            h01 h01Var2 = new h01(starGift.sold_out ? LocaleController.getString(R.string.Gift2SoldOutTitle) : LocaleController.formatPluralString("Gift2SoldAuctionPreviewGifts", starGift.availability_total, new Object[0]), 13.0f, null);
            this.l = h01Var2;
            h01Var2.q(AndroidUtilities.dp(f13));
            h01Var2.a();
            h01Var2.n(1);
            k8 k8Var = new k8(1, 40);
            this.d = k8Var;
            float f14 = 0.45f * f12;
            k8Var.f(-AndroidUtilities.dp(f14), -AndroidUtilities.dp(f14), AndroidUtilities.dp(f14), AndroidUtilities.dp(f12 * 0.25f));
            ...
            for (int i28 = 0; i28 < k8Var.j; i28++) {
                j8 j8Var = (j8) arrayList3.get(i28);
                PointF pointF5 = (PointF) arrayList.get(i28);
                k8Var.c(j8Var, currentTimeMillis, true);
                j8Var.a = pointF5.x + rectF.left;
                j8Var.b = pointF5.y + rectF.top;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (h01Var2 == null || (h01Var = this.l) == null) {
    ...
    public final void h() {
        ...
        if (currentTime <= this.p || (h01Var = this.l) == null) {
            return;
        }
