...
public final /* synthetic */ class s4 implements Runnable {
    ...
    public /* synthetic */ s4(t5 t5Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.d6 d6Var, long j3, String str, long j10, TLObject tLObject2, TLRPC.TL_textWithEntities tL_textWithEntities) {
        this.b = t5Var;
        this.c = tLObject;
        this.d = tL_error;
        this.e = callback2;
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                        if (!MessagesController.getInstance(t5Var.a).starsPurchaseAvailable()) {
                            ...
                            boolean[] zArr = {false};
                            l7 l7Var = new l7(context, d6Var, j3, 6, str, new ga(t5Var, zArr, tL_payments_paymentFormStarGift, starGift, j10, callback2), 0L);
                ...
                if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                        if (!MessagesController.getInstance(t5Var2.a).starsPurchaseAvailable()) {
                            ...
                            boolean[] zArr2 = {false};
                            l7 l7Var2 = new l7(context2, d6Var2, j11, 6, str2, new ga(t5Var2, zArr2, j12, tLObject3, tL_textWithEntities, callback22), 0L);
                    ...
                    if (launchActivity2 != null && (bb0Var2 = launchActivity2.x0) != null) {
                        bb0Var2.c(true);
                        break;
                    }
                }
    ...
    public /* synthetic */ s4(t5 t5Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.d6 d6Var, long j3, String str, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j10) {
        this.b = t5Var;
        this.c = tLObject;
        this.d = tL_error;
        this.e = callback2;
