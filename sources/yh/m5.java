...
public final class m5 {
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        ConnectionsManager.getInstance(i13).sendRequest(updatestargiftcollection, new k5(this, i11));
    }
    ...
    public final void i() {
        ...
        this.i = ConnectionsManager.getInstance(i10).sendRequest(getstargiftcollections, new k5(this, 0));
    }
    ...
    public final void k(int i10, TL_stars.SavedStarGift savedStarGift) {
        ...
        ConnectionsManager.getInstance(i13).sendRequest(updatestargiftcollection, new k5(this, i14));
        NotificationCenter.getInstance(i13).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(j3), e);
    }
