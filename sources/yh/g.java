...
public final class g extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void W(g gVar, i51 i51Var) {
        if (i51Var.G(q7.class)) {
            x7.h1(gVar.getParentActivity(), true, gVar.b, gVar.currentAccount, (TL_stars.StarsTransaction) i51Var.G, gVar.getResourceProvider());
        } else if (i51Var.G instanceof TL_stats.BroadcastRevenueTransaction) {
            je.h0(gVar.getParentActivity(), gVar.currentAccount, (TL_stats.BroadcastRevenueTransaction) i51Var.G, gVar.b, gVar.resourceProvider);
        } else if (i51Var.d == 2) {
    ...
    public static void Y(g gVar, ArrayList arrayList) {
        ...
        int i13 = gVar.a;
        if (i13 == 0) {
            arrayList.add(i51.h(2, i12, gVar.n));
            ...
            arrayList.add(i51.A(-2, LocaleController.getString(z10 ? R.string.SelfStarsOverviewInfo : R.string.BotStarsOverviewInfo)));
        ...
        if (i13 == 1) {
            ...
            if (la1Var != null && !la1Var.l) {
                arrayList.add(i51.h(5, i12, la1Var));
                arrayList.add(i51.A(-1, null));
            }
            ...
            if (la1Var2 != null && !la1Var2.l) {
                arrayList.add(i51.h(i10, i12, la1Var2));
    ...
    public final View createView(Context context) {
        ...
        eoVar2.i(org.telegram.ui.ActionBar.i6.w0(null, i10, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Pi, false));
        ...
        this.F = new w7(context, this.currentAccount, false, this.b, getClassGuid(), getResourceProvider());
        xd xdVar = new xd(context, 9);
        this.H = xdVar;
        xdVar.setOrientation(1);
        this.H.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(i11, getResourceProvider()));
        ...
        n6Var2.setTextColor(org.telegram.ui.ActionBar.i6.v0(i12, getResourceProvider()));
        ...
        n6Var4.setTextColor(org.telegram.ui.ActionBar.i6.v0(i13, getResourceProvider()));
        ...
        this.Q.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.i6.uf));
        this.Q.setHandlesColor(getThemedColor(org.telegram.ui.ActionBar.i6.vf));
        ...
        this.U.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(i11, this.resourceProvider));
        ...
        this.W.setTextColor(org.telegram.ui.ActionBar.i6.v0(i12, this.resourceProvider));
        ...
        this.X.setTextColor(org.telegram.ui.ActionBar.i6.v0(i13, this.resourceProvider));
                ...
                switch (i15) {
                    ...
                    default:
                        if (view.isEnabled()) {
                            ...
                            if (!gVar.Y.N) {
                                TwoStepVerificationActivity twoStepVerificationActivity = new TwoStepVerificationActivity();
                                tg.d dVar3 = new tg.d(14, gVar, twoStepVerificationActivity);
                                twoStepVerificationActivity.Z = 1;
        ...
        this.e = e61Var;
        e61Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.a7));
        this.e.p1();
    ...
    public final void g0() {
        ...
        if (h != null) {
            ...
            if (f02 != null && (bVar = f02.d) != null && (arrayList = bVar.d) != null && !arrayList.isEmpty() && this.n.d.d.get(0) != null) {
                la1 la1Var = this.n;
                la1Var.h = true;
                ((jg.a) la1Var.d.d.get(0)).g = org.telegram.ui.ActionBar.i6.yj;
    ...
    public final void k0() {
        ...
        if (this.G > currentTime) {
            this.a0 = vc.a0(this).Q(R.raw.timer_3, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotStarsWithdrawalToast, j0(this.G - currentTime)))).j();
            return;
        }
        if (this.P < getMessagesController().starsRevenueWithdrawalMin) {
            vc.a0(this).L(getParentActivity().getResources().getDrawable(R.drawable.star_small_inner).mutate(), AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("BotStarsWithdrawMinLimit", (int) getMessagesController().starsRevenueWithdrawalMin, new Object[0]), new b(this, i10))).j();
            return;
        }
        long j3 = this.P;
        TwoStepVerificationActivity twoStepVerificationActivity = new TwoStepVerificationActivity();
