...
public abstract class l8 extends View {
    ...
    public l8(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        o6Var2.b = 17;
        paint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.h5, d6Var));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int l1 = org.telegram.ui.ActionBar.h6.l1(0.15f, this.r);
        Paint paint4 = this.b;
        paint4.setColor(l1);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.j0) {
            ...
            if (!this.k0 && motionEvent.getPointerId(0) == this.j0 && v7.a7.a(this.g0, this.h0, motionEvent.getX(), motionEvent.getY()) < AndroidUtilities.touchSlop && System.currentTimeMillis() - this.i0 <= ViewConfiguration.getTapTimeout() * 1.5f) {
