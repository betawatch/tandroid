...
public final /* synthetic */ class z4 implements Utilities.Callback {
    ...
    public /* synthetic */ z4(v5 v5Var, long j3, boolean[] zArr, Utilities.Callback callback, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, String str, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, int i10, long j10) {
        this.a = v5Var;
        this.b = j3;
        this.c = zArr;
        this.d = callback;
    ...
    public final void run(Object obj) {
        ...
        if (starsPurchaseAvailable) {
            boolean[] zArr2 = {false};
            n7 n7Var = new n7(context, f6Var, j10, this.g ? 9 : 0, this.h, new jb(v5Var, zArr2, messageObject, inputInvoice, tL_payments_paymentFormStars, zArr, i10, callback2, callback), this.m);
