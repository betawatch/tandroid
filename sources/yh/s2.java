...
public final class s2 extends FrameLayout {
    ...
    public s2(Context context, View[] viewArr) {
        super(context);
        this.b = new Matrix();
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (indexOfChild >= 6) {
            ...
            if (view instanceof x2) {
                ...
                x2Var.d.setAlpha(f11);
                x2Var.e.setAlpha(f11);
                if (!z10 || this.E >= 1.0f) {
        ...
        for (int i14 = 4; i13 < i14; i14 = 4) {
            ...
            float[] fArr12 = fArr8;
            float[] fArr13 = fArr9;
            fArr11[0] = com.google.android.gms.internal.vision.e2.B(fArr7[0], f22, (fArr9[0] * f21) + fArr8[0], dp);
            fArr11[1] = com.google.android.gms.internal.vision.e2.B(fArr7[1], f22, (fArr13[1] * f21) + fArr12[1], dp);
            fArr11[2] = com.google.android.gms.internal.vision.e2.B(fArr7[2], f22, (fArr13[2] * f21) + fArr12[2], dp);
            i13++;
            fArr9 = fArr13;
            fArr8 = fArr12;
            i12 = 1;
