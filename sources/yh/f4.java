...
public final class f4 extends bb {
    ...
    public f4(final Context context, String str, final e4 e4Var) {
        ...
        final int i10 = 0;
        k3Var2.setOnClickListener(new View.OnClickListener(this) { // from class: yh.z3
            ...
            public final void onClick(View view) {
                switch (i10) {
                    case 0:
                        f4.R(this.b, e4Var, context);
                        break;
                    case 1:
                        f4.W(this.b, e4Var, context);
                        break;
                    default:
                        f4.S(this.b, e4Var, context);
                        break;
                }
            }
        });
        ...
        final int i11 = 1;
        k3Var3.setOnClickListener(new View.OnClickListener(this) { // from class: yh.z3
            public final /* synthetic */ f4 b;
        ...
        final int i12 = 2;
        k3Var4.setOnClickListener(new View.OnClickListener(this) { // from class: yh.z3
            public final /* synthetic */ f4 b;
    ...
    public static void P(f4 f4Var, e4 e4Var) {
        n70 F = n70.F(f4Var.container, f4Var.resourcesProvider, f4Var.a0);
        F.c(R.drawable.menu_sort_value, LocaleController.getString(s3.b.a), new w3(e4Var, 3), false);
        F.c(R.drawable.menu_sort_date, LocaleController.getString(s3.c.a), new w3(e4Var, 4), false);
        F.c(R.drawable.menu_sort_number, LocaleController.getString(s3.d.a), new w3(e4Var, 5), false);
        F.t = false;
        F.Y = true;
    ...
    public static void Q(f4 f4Var, e4 e4Var, int i10) {
        ...
        if (obj instanceof TL_stars.StarGift) {
            ...
            boolean z10 = G.r;
            if (!TextUtils.isEmpty(starGift.gift_address) && f4Var.h0) {
            ...
            if (z10 && (starGift instanceof TL_stars.TL_starGiftUnique)) {
                ...
                s5.x(f4Var.currentAccount, bVar).H(tL_starGiftUnique, clientUserId, null, true, new cp0(f4Var, b2Var2, bVar, tL_starGiftUnique, clientUserId));
                return;
            }
            if (!z10) {
                ArrayList arrayList = e4Var.b.l;
    ...
    public static void R(f4 f4Var, e4 e4Var, Context context) {
        ...
        n70 n70Var = new n70(f4Var.container, f4Var.resourcesProvider, f4Var.b0, false, true, false);
        n70Var.t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.p = new ji.h(n70Var, 8);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(t3Var.f);
        Collections.sort(arrayList, new y3(e4Var, 2));
        int i10 = 0;
        a4 a4Var = new a4(context, f4Var.currentAccount, 0, false, new u3(strArr, e4Var, arrayList, i10), new v3(e4Var, n70Var, i10), null, f4Var.resourcesProvider);
        a4Var.Y2.r = false;
        ...
        ztVar.addTextChangedListener(new pn(strArr, a4Var, false, 11));
        if (arrayList.size() > 8) {
    ...
    public static void S(f4 f4Var, e4 e4Var, Context context) {
        ...
        n70 n70Var = new n70(f4Var.container, f4Var.resourcesProvider, f4Var.d0, false, true, false);
        n70Var.t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.p = new ji.h(n70Var, 7);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(t3Var.h);
        Collections.sort(arrayList, new y3(e4Var, 1));
        int i10 = 2;
        c4 c4Var = new c4(context, f4Var.currentAccount, 0, false, new u3(strArr, e4Var, arrayList, i10), new v3(e4Var, n70Var, i10), null, f4Var.resourcesProvider);
        c4Var.Y2.r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        ztVar.setBackground(null);
        frameLayout.addView(ztVar, x5.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        ztVar.addTextChangedListener(new pn(strArr, c4Var, false, 13));
        if (arrayList.size() > 8) {
            n70Var.r(frameLayout, x5.n(-1, 44));
            n70Var.k();
        }
    ...
    public static void T(f4 f4Var, ArrayList arrayList) {
        ...
        if (e4Var != null) {
            ...
            while (i12 < size) {
                ...
                if (!f4Var.g0.contains(Long.valueOf(savedStarGift.gift.id))) {
    ...
    public static /* synthetic */ void U(f4 f4Var, org.telegram.ui.ActionBar.b2 b2Var, zf.b bVar, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift) {
        b2Var.dismiss();
    ...
    public static void V(f4 f4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, zh.a3 a3Var, of.e eVar) {
        eVar.d();
        s5.x(f4Var.currentAccount, a3Var.a).h(a3Var.b, tL_starGiftUnique, j3, null, true, new org.telegram.tgnet.e(f4Var, eVar, tL_starGiftUnique, 6));
    }
    ...
    public static void W(f4 f4Var, e4 e4Var, Context context) {
        ...
        n70 n70Var = new n70(f4Var.container, f4Var.resourcesProvider, f4Var.c0, false, true, false);
        n70Var.t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.p = new ji.h(n70Var, 6);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(t3Var.g);
        Collections.sort(arrayList, new y3(e4Var, 0));
        int i10 = 1;
        b4 b4Var = new b4(context, f4Var.currentAccount, 0, false, new u3(strArr, e4Var, arrayList, i10), new v3(e4Var, n70Var, i10), null, f4Var.resourcesProvider);
        b4Var.Y2.r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        ztVar.setBackground(null);
        frameLayout.addView(ztVar, x5.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        ztVar.addTextChangedListener(new pn(strArr, b4Var, false, 12));
        if (arrayList.size() > 8) {
            n70Var.r(frameLayout, x5.n(-1, 44));
            n70Var.k();
        }
