...
public final /* synthetic */ class u4 implements Runnable {
    ...
    public /* synthetic */ u4(v5 v5Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.f6 f6Var, long j3, String str, long j10, TLObject tLObject2, TLRPC.TL_textWithEntities tL_textWithEntities) {
        this.b = v5Var;
        this.c = tLObject;
        this.d = tL_error;
        this.e = callback2;
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                        if (!MessagesController.getInstance(v5Var.a).starsPurchaseAvailable()) {
                            ...
                            boolean[] zArr = {false};
                            n7 n7Var = new n7(context, f6Var, j3, 6, str, new ga(v5Var, zArr, tL_payments_paymentFormStarGift, starGift, j10, callback2), 0L);
                        ...
                        callback2.run(Boolean.FALSE, null);
                        hg.k0.s(R.string.UnknownErrorCode, new Object[]{tL_error != null ? tL_error.text : "FAILED_SEND_STARS"}, X, R.raw.error, 36);
                        break;
                    }
                } else {
                ...
                if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                        if (!MessagesController.getInstance(v5Var2.a).starsPurchaseAvailable()) {
                            ...
                            boolean[] zArr2 = {false};
                            n7 n7Var2 = new n7(context2, f6Var2, j11, 6, str2, new ga(v5Var2, zArr2, j12, tLObject3, tL_textWithEntities, callback22), 0L);
                        ...
                        callback22.run(Boolean.FALSE, null);
                        hg.k0.s(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, X2, R.raw.error, 36);
                        break;
                    }
                } else {
    ...
    public /* synthetic */ u4(v5 v5Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.f6 f6Var, long j3, String str, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j10) {
        this.b = v5Var;
        this.c = tLObject;
        this.d = tL_error;
        this.e = callback2;
