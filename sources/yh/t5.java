...
public final class t5 {
    ...
    public static void e(String str) {
        ...
        hg.k0.p(R.string.UnknownErrorCode, new Object[]{str}, (R == null || R.visibleDialog != null) ? xc.X() : xc.a0(R), R.raw.error, 36);
    }
    ...
    public final void H(TL_stars.StarGift starGift, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getPaymentForm, new aj1(10, this, callback));
    }
    ...
    */
    public final void Y(MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, Runnable runnable, Utilities.Callback callback) {
        ...
        m31 m31Var2 = new m31(this, zArr, callback);
        org.telegram.ui.ActionBar.f3 i20 = wh.i(1, context2, I, false);
        ...
        if (messageObject == null || (message2 = messageObject.messageOwner) == null || !(message2.media instanceof TLRPC.TL_messageMediaPaidMedia)) {
            ...
            if (webDocument != null) {
                ...
                j10 = j14;
                textView.setText(v7.R0(org.telegram.messenger.q.i((int) j14, ',', new StringBuilder("XTR ")), 0.85f, null));
                i12 = 0;
                ...
                w7.a6.a(j7Var);
                j7Var.setOnClickListener(new f6(j7Var, i12));
                viewGroup.addView(j7Var, w7.y5.d(-2, -2.0f, 53, 0.0f, 0.0f, -8.0f, 0.0f));
                e.addView(viewGroup, w7.y5.q(i11, 117, 7));
                TextView g10 = org.telegram.messenger.q.g(context2, r22, 20.0f);
                ...
                g10.setGravity(17);
                e.addView(g10, w7.y5.t(-2, -2, 1, 0, webDocument == null ? -8 : 8, 0, 0));
                if (webDocument != null) {
                    LinearLayout e7 = wh.e(context2, i12);
                    e7.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(28.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.a7, I)));
                    ...
                    e7.addView(w9Var2, w7.y5.n(28, 28));
                    ...
                    e7.addView(textView2, w7.y5.t(-2, -2, 16, 6, 0, 10, 0));
                    e.addView(e7, w7.y5.t(-2, 28, 1, 0, 8, 0, 2));
                }
                TextView g11 = org.telegram.messenger.q.g(context2, r22, 14.0f);
                ...
                g11.setGravity(17);
                e.addView(g11, w7.y5.t(-2, -2, 1, 0, 6, 0, 18));
                ...
                e.addView(dVar, w7.y5.c(48.0f, -1));
                l90 l90Var = new l90(context2, I);
                l90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, I));
                l90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
                l90Var.setTextSize(r22, 14.0f);
                l90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i10 <= 0 ? R.string.StarsConfirmSubscriptionTOS : R.string.StarsConfirmPurchaseTOS), new di.a(context2, 8)));
                l90Var.setGravity(17);
                e.addView(l90Var, w7.y5.k(0.0f, 12.0f, 0.0f, 2.0f, -1, -2));
                org.telegram.ui.ActionBar.f3 f3Var2 = f3Var;
                f3Var2.customView = e;
                dVar.setOnClickListener(new xg.e(x4Var, f3Var2, dVar, 7));
                f3Var2.setOnDismissListener(new ai.g5(m31Var, 12));
            ...
            viewGroup.addView(z6Var2, w7.y5.e(i16, i16, i15));
        }
        j10 = j14;
        r22 = 1;
        i11 = -1;
        ...
        w7.a6.a(j7Var2);
        j7Var2.setOnClickListener(new f6(j7Var2, i12));
        viewGroup.addView(j7Var2, w7.y5.d(-2, -2.0f, 53, 0.0f, 0.0f, -8.0f, 0.0f));
        e.addView(viewGroup, w7.y5.q(i11, 117, 7));
        TextView g102 = org.telegram.messenger.q.g(context2, r22, 20.0f);
        ...
        g102.setGravity(17);
        e.addView(g102, w7.y5.t(-2, -2, 1, 0, webDocument == null ? -8 : 8, 0, 0));
        if (webDocument != null) {
        }
        TextView g112 = org.telegram.messenger.q.g(context2, r22, 14.0f);
        ...
        g112.setGravity(17);
        e.addView(g112, w7.y5.t(-2, -2, 1, 0, 6, 0, 18));
        ci.d dVar2 = new ci.d(context2, I, r22);
        if (i10 <= 0) {
        }
        e.addView(dVar2, w7.y5.c(48.0f, -1));
        l90 l90Var2 = new l90(context2, I);
        l90Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, I));
        l90Var2.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
        l90Var2.setTextSize(r22, 14.0f);
        l90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i10 <= 0 ? R.string.StarsConfirmSubscriptionTOS : R.string.StarsConfirmPurchaseTOS), new di.a(context2, 8)));
        l90Var2.setGravity(17);
        e.addView(l90Var2, w7.y5.k(0.0f, 12.0f, 0.0f, 2.0f, -1, -2));
        org.telegram.ui.ActionBar.f3 f3Var22 = f3Var;
        f3Var22.customView = e;
        dVar2.setOnClickListener(new xg.e(x4Var, f3Var22, dVar2, 7));
        f3Var22.setOnDismissListener(new ai.g5(m31Var, 12));
                    ...
                    public final void run() {
                        ...
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 == null || !"BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                ...
                                boolean[] zArr = {false};
                                k7 k7Var = new k7(context3, e6Var2, j11, 1, chatInvite3.title, new u(t5Var2, zArr, str6, chatInvite3, callback23, 3), 0L);
                        ...
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                if (!MessagesController.getInstance(t5Var2.a).starsPurchaseAvailable()) {
                                    ...
                                    boolean[] zArr = {false};
                                    k7 k7Var = new k7(context3, e6Var2, j14, 0, str6, new z8(t5Var2, zArr, messageObject3, inputInvoice3, tL_payments_paymentFormStars3, callback3, 21), j15);
                            ...
                            if (tL_error2 != null && "FORM_EXPIRED".equals(tL_error2.text)) {
                                ...
                                ConnectionsManager.getInstance(t5Var2.a).sendRequest(tL_payments_getPaymentForm, new kd(t5Var2, messageObject3, inputInvoice3, callback3, X, 14));
                                return;
                            }
                            xc xcVar = X;
                            callback3.run(Boolean.FALSE);
                            hg.k0.p(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, xcVar, R.raw.error, 36);
    ...
    */
    ...
    public final s5 d0(final MessageObject messageObject, final zn znVar, final long j3, boolean z10, boolean z11, final Long l4) {
        ...
        if (z11 && y3.e && y3.q(false, false, null).amount <= 0) {
            ...
            final int i11 = 0;
            new k7(t10, znVar.getResourceProvider(), j3, 5, str, new Runnable(this) { // from class: yh.y4
        ...
        if (z11 && y3.e && y3.q(false, false, null).amount < j11) {
            ...
            final int i12 = 1;
            new k7(t10, znVar.getResourceProvider(), j11, 5, str2, new Runnable(t5Var) { // from class: yh.y4
                public final /* synthetic */ t5 b;
                ...
                public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: yh.p4
                        ...
                        public final void run() {
                            ...
                            t5 t5Var2 = t5.this;
                            ConnectionsManager.getInstance(t5Var2.a).sendRequest(tL_payments_sendStarsForm, new r4(t5Var2, callback23, context3, e6Var, j11, str, j10, tLObject3, tL_textWithEntities2));
                        }
                    });
                }
            });
                                        ...
                                        if (!z21) {
                                            if (tL_error4 != null && "BALANCE_TOO_LOW".equals(tL_error4.text)) {
                                                if (!MessagesController.getInstance(t5Var4.a).starsPurchaseAvailable()) {
                                                    ...
                                                    boolean[] zArr = {false};
                                                    k7 k7Var = new k7(context6, e6Var4, j15, 6, str5, new xa(t5Var4, zArr, starGift5, z19, z20, j16, tL_textWithEntities5, n4Var5), 0L);
    ...
    public final TL_stars.StarsAmount q(boolean z10, boolean z11, Runnable runnable) {
        if (((!this.e || System.currentTimeMillis() - this.c > 60000) && !this.d) || z11) {
            ...
            ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getStarsStatus, new aj1(11, this, runnable));
        }
        if (!z10 || this.g <= 0) {
            return this.f;
        }
