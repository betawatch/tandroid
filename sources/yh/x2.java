...
public final class x2 extends FrameLayout {
    ...
    public final void a(TL_stars.StarGift starGift, boolean z10) {
        ...
        if (starGift != null) {
            ...
            y7.Z0(this.c.getImageReceiver(), stargiftattributemodel.document, 52);
    ...
    public final void b(final boolean z10, boolean z11) {
        ...
        qr qrVar = qr.h;
        final int i10 = 0;
        alpha.setInterpolator(qrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: yh.w2
        ...
        final int i11 = 1;
        textView.animate().alpha(z10 ? 1.0f : 0.0f).setInterpolator(qrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: yh.w2
            public final /* synthetic */ x2 b;
        ...
        final int i12 = 2;
        frameLayout2.animate().alpha(z10 ? 1.0f : 0.0f).setInterpolator(qrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: yh.w2
            public final /* synthetic */ x2 b;
