...
public final class y3 extends sa {
    public final ArrayList a0;
    public final LimitPreviewView b0;

    public y3(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context, e6Var);
        float f7;
        int i10;
        this.a0 = arrayList;
        ...
        while (i12 < arrayList.size()) {
            if (currentTime <= ((TL_stars.StarGiftUpgradePrice) arrayList.get(i12)).date || ((i10 = i12 + 1) < arrayList.size() && currentTime <= ((TL_stars.StarGiftUpgradePrice) arrayList.get(i10)).date)) {
                ...
                pz0Var.c(LocaleController.getInstance().getFormatterDay().format(date) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date), x7.X0(false, hg.c.k((int) r13.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
                z10 = true;
            } else {
                f7 = f11;
            }
        ...
        if (!z10) {
            ...
            while (i13 < size) {
                ...
                pz0Var.c(LocaleController.getInstance().getFormatterDay().format(date2) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date2), x7.X0(false, hg.c.k((int) starGiftUpgradePrice.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
            }
        }
        float f13 = f12 + 14.0f;
        this.X.addView(pz0Var, w7.x5.r(-1, -2, 7, f13, 16.0f, f13, 15.0f));
        ...
        this.Z.g(z3.g2(LocaleController.getString(R.string.Understood)), false, true);
    ...
    public final void P(long j3) {
        ...
        n6Var2.setTextColor(limitPreviewView.L ? -1 : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, e6Var));
