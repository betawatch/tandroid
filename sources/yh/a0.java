...
public final class a0 extends za {
    ...
    public a0(final Context context, final int i10, final long j3, TL_stars.TL_starGiftUnique tL_starGiftUnique, final org.telegram.ui.ActionBar.f6 f6Var, b1 b1Var) {
        ...
        TLRPC.User user;
        ka.c cVar = new ka.c(23);
        n7.a1[] a1VarArr = (n7.a1[]) cVar.b;
        this.l0 = cVar;
        this.r0 = new oq[1];
        this.s0 = new oq[1];
        this.L = false;
        ...
        sb2.append(" #");
        this.Z = hg.k0.k(tL_starGiftUnique.num, ',', sb2);
        this.q0 = b1Var;
        ...
        zf.b bVar3 = g10.a;
        if (bVar3 == g11.a) {
            a1VarArr[bVar3.ordinal()] = new n7.a1(29, g10, g11);
        }
        zf.b bVar4 = i11.a;
        if (bVar4 == i12.a) {
            a1VarArr[bVar4.ordinal()] = new n7.a1(29, i11, i12);
        }
        ...
        f7.addView(yc0Var, w7.x5.k(18.0f, 0.0f, 18.0f, 0.0f, -1, 58));
        ...
        yc0Var2.setText(LocaleController.getString(R.string.GiftOfferDuration));
        yc0Var2.e(yVar);
        yc0Var2.addView(yVar, w7.x5.d(-1, -2.0f, 48, 0.0f, 0.0f, 48.0f, 0.0f));
        w7.z5.b(yc0Var2, 0.02f, 1.2f);
        yc0Var2.setOnClickListener(new w(0, this, context));
        f7.addView(yc0Var2, w7.x5.k(18.0f, 18.0f, 18.0f, 0.0f, -1, 58));
        ...
        yc0Var2.addView(imageView3, w7.x5.d(24, 24.0f, 21, 0.0f, 0.0f, 14.0f, 0.0f));
        ...
        ml0Var.setPadding(i17, 0, i17, AndroidUtilities.dp(64.0f));
        this.d.setOverScrollMode(2);
        this.v0 = j51.k(linearLayout);
        this.u0.N(false);
    }

    public static void P(a0 a0Var, long j3, boolean z10, zf.a aVar, long j10, org.telegram.ui.ActionBar.c2 c2Var) {
        if (j3 > 0) {
            ...
            if (l4 == null || l4.b < g10.b) {
                new n7(a0Var.getContext(), a0Var.resourcesProvider, g10.a(), 14, null, null, a0Var.a0).show();
                return;
            }
        }
        nf.e g11 = c2Var.g(-1, true, true);
        g11.d();
        ...
        ConnectionsManager.getInstance(a0Var.currentAccount).sendRequestTyped(tL_sendStarGiftOffer, new org.telegram.tgnet.e(a0Var, g11, c2Var, 7));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r14v4 */
    /* JADX WARN: Type inference failed for: r14v5, types: [org.telegram.ui.Components.pz0[], org.telegram.ui.Components.xc[]] */
        ...
        if (a0Var.h0.W) {
            ...
            if (l4 != null) {
                ...
                if (j10 >= aVar.b) {
                    ...
                    qz0 qz0Var = new qz0(a0Var.getContext(), a0Var.resourcesProvider);
                    ...
                    qz0Var.c(LocaleController.getString(R.string.GiftOfferRowOffer), y7.X0(z10, LocaleController.formatString(R.string.GiftOfferAmount, d), 0.8f, null), null, null);
                    if (sendPaidMessagesStars > 0) {
                        r14 = 0;
                        qz0Var.c(LocaleController.getString(R.string.GiftOfferRowFee), y7.X0(false, LocaleController.formatString(R.string.GiftOfferAmount, g10.d()), 0.8f, null), null, null);
                    } else {
                        r14 = 0;
                    }
                    qz0Var.c(LocaleController.getString(R.string.GiftOfferRowDuration), LocaleController.formatPluralString("GiftOfferHours", a0Var.n0 / 3600, new Object[0]), r14, r14);
                    ...
                    if (sendPaidMessagesStars == 0) {
                        spannableStringBuilder.append((CharSequence) y7.S0(LocaleController.formatString(R.string.GiftOfferPay, d), z10));
                    } else {
                        if (!z10) {
                            z11 = z10;
                            spannableStringBuilder.append((CharSequence) y7.Q0(LocaleController.formatString(R.string.GiftOfferPay, zf.a.i(a0Var.m0.b + g10.b, bVar).d())));
                            AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(a0Var.getContext(), 0, a0Var.resourcesProvider);
                            alertDialog$Builder.n(linearLayout);
                            final boolean z12 = z11;
                            alertDialog$Builder.k(spannableStringBuilder, new org.telegram.ui.ActionBar.b2() { // from class: yh.t
                                @Override // org.telegram.ui.ActionBar.b2
                                public final void f(org.telegram.ui.ActionBar.c2 c2Var, int i12) {
                                    a0.P(a0.this, sendPaidMessagesStars, z12, g10, nextRandomId, c2Var);
                                }
                            });
                        ...
                        spannableStringBuilder.append(LocaleController.formatSpannable(R.string.GiftOfferPayMulti, y7.S0(LocaleController.formatString(R.string.GiftOfferPayMultiPart, d), true), y7.Q0(LocaleController.formatString(R.string.GiftOfferPayMultiPart, g10.d()))));
                    }
                    z11 = z10;
                    ...
                    alertDialog$Builder2.k(spannableStringBuilder, new org.telegram.ui.ActionBar.b2() { // from class: yh.t
                        @Override // org.telegram.ui.ActionBar.b2
                        public final void f(org.telegram.ui.ActionBar.c2 c2Var2, int i12) {
                            a0.P(a0.this, sendPaidMessagesStars, z122, g10, nextRandomId, c2Var2);
                        }
                    });
            ...
            zf.b bVar3 = aVar2.a;
            if (bVar3 == bVar) {
                new n7(context, f6Var, aVar2.a(), 14, null, null, j3).show();
            } else if (bVar3 == bVar2) {
    ...
    public static /* synthetic */ void R(a0 a0Var, nf.e eVar, org.telegram.ui.ActionBar.c2 c2Var, TLRPC.Updates updates, TLRPC.TL_error tL_error) {
        if (updates != null && tL_error == null) {
            MessagesController.getInstance(a0Var.currentAccount).processUpdates(updates, false);
        }
        AndroidUtilities.runOnUIThread(new u(a0Var, eVar, c2Var, updates, tL_error, 0));
    }
    ...
    public final void U(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        ka.c cVar = this.l0;
        n7.a1[] a1VarArr = (n7.a1[]) cVar.b;
        n7.a1[] a1VarArr2 = (n7.a1[]) cVar.b;
        long j3 = ((zf.a) a1VarArr[bVar2.ordinal()].c).b;
        zf.a aVar3 = this.m0;
        if (j3 < aVar3.b) {
            this.o0 |= 4;
        }
        if (!aVar3.k() && ((zf.a) a1VarArr2[this.m0.a.ordinal()].b).b > this.m0.b) {
            this.o0 |= 2;
        }
        ...
        if (z13) {
            ...
            if (bVar5 == bVar3) {
                ...
                editTextBoldCursor.setFilters(new InputFilter[]{new InputFilter.LengthFilter(Long.toString(((zf.a) a1VarArr2[this.m0.a.ordinal()].c).a()).length())});
            } else if (bVar5 == bVar4) {
                ...
                editTextBoldCursor.setFilters(new InputFilter[]{new InputFilter.LengthFilter(Long.toString(((zf.a) a1VarArr2[this.m0.a.ordinal()].c).a()).length() + 3)});
            }
        ...
        if (z13 || z15) {
            ...
            if (i12 != 0) {
                ...
                String d = ((zf.a) a1VarArr2[bVar6.ordinal()].c).d();
                ...
                String d10 = ((zf.a) a1VarArr2[bVar6.ordinal()].b).d();
        ...
        if (z13 || z14 || z15) {
            ...
            this.h0.g(y7.V0(z16, LocaleController.formatString(i16, objArr4), z16 ? this.s0 : this.r0), z12, true);
            T(z12);
        }
        if (z13 || z14) {
    ...
    public final void show() {
        super.show();
        AndroidUtilities.runOnUIThread(new rg.w1(this, 23), 50L);
    }

    @Override // org.telegram.ui.Components.za
    public final ll0 v(ml0 ml0Var) {
        x51 x51Var = new x51(this.d, getContext(), this.currentAccount, 0, true, new hi.a(this, 23), this.resourcesProvider);
        this.u0 = x51Var;
        x51Var.r = false;
        return x51Var;
    }
