...
public final class a0 extends bb {
    ...
    public final void S() {
        ...
        if (this.p0 != z11) {
            ...
            if (aVar != null) {
                ...
                ok.r(aVar.animate().scaleX(z11 ? 1.0f : 0.6f).scaleY(z11 ? 1.0f : 0.6f), z11 ? 1.0f : 0.0f, 180L);
            }
        }
    }
    ...
    public final void T(boolean z10) {
        ...
        if (dVar.W != z11) {
            ...
            if (z10) {
                ok.r(dVar.animate(), z11 ? 1.0f : 0.6f, 180L);
            } else {
