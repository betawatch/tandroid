...
public final class z3 extends sa {
    ...
    public z3(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        while (i12 < arrayList.size()) {
            if (currentTime <= ((TL_stars.StarGiftUpgradePrice) arrayList.get(i12)).date || ((i10 = i12 + 1) < arrayList.size() && currentTime <= ((TL_stars.StarGiftUpgradePrice) arrayList.get(i10)).date)) {
                ...
                qz0Var.c(LocaleController.getInstance().getFormatterDay().format(date) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date), y7.X0(false, hg.k0.k((int) r13.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
                z10 = true;
            } else {
                f7 = f11;
            }
        ...
        if (!z10) {
            ...
            while (i13 < size) {
                ...
                qz0Var.c(LocaleController.getInstance().getFormatterDay().format(date2) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date2), y7.X0(false, hg.k0.k((int) starGiftUpgradePrice.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
            }
        }
        float f13 = f12 + 14.0f;
    ...
    public final void P(long j3) {
        ...
        n6Var2.setTextColor(limitPreviewView.L ? -1 : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, f6Var));
