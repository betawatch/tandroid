...
public final class p7 extends i51 {
    ...
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        u9 u9Var = q7Var.c;
        org.telegram.ui.ActionBar.f6 f6Var = q7Var.b;
        TextView textView = q7Var.h;
        TextView textView2 = q7Var.f;
        TextView textView3 = q7Var.e;
        int i10 = q7Var.a;
        TextView textView4 = q7Var.n;
        long peerDialogId = DialogObject.getPeerDialogId(starsSubscription.peer);
        q7Var.r = !TextUtils.isEmpty(starsSubscription.title);
        if (peerDialogId < 0) {
        ...
        if (TextUtils.isEmpty(starsSubscription.title)) {
            ...
            if (starsSubscription.photo != null) {
                z70 z70Var = new z70(textView3, 14.0f, i10);
                z70Var.a(4.0f);
                z70Var.f = false;
                ...
                z70Var.b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsSubscription.photo)), "14_14", null, null, 0, 0);
        ...
        textView2.setTextSize(1, q7Var.r ? 13.0f : 14.0f);
