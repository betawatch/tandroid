...
public final class p7 extends g51 {
    ...
    */
    public final void bindView(View view, h51 h51Var, boolean z10, v51 v51Var, d61 d61Var) {
        ...
        q7Var.x = z17;
        boolean z18 = z17;
        LinearLayout.LayoutParams layoutParams = q7Var.h;
        if (z18) {
        ...
        d90Var.setVisibility(q7Var.x ? 0 : 8);
            ...
            if (!starsTransaction.posts_search) {
                if (peerDialogId != 0) {
                    if (UserObject.isService(peerDialogId)) {
                        ...
                        w9Var2.setImageDrawable(q7.a(44, "fragment"));
                        z12 = false;
                    ...
                    if (starsTransaction.stargift != null) {
                        u70 u70Var = new u70(d90Var, 16.0f, i10);
                        u70Var.a(4.0f);
                        u70Var.f = false;
                        SpannableString spannableString4 = new SpannableString("x");
                        spannableString4.setSpan(u70Var, 0, 1, 33);
                        w7.a1(u70Var.b, starsTransaction.stargift, 16);
                        ...
                        textView3.setText(str);
                        d90Var.setVisibility(z12 ? 8 : 0);
                        d90Var.setText(LocaleController.formatString(R.string.StarTransactionCommission, ei.l.G0(starsTransaction.starref_commission_permille)));
                        ...
                        if (starsTransaction.photo != null) {
                            u70 u70Var2 = new u70(d90Var, 14.0f, i10);
                            u70Var2.a(4.0f);
                            u70Var2.f = false;
                            SpannableString spannableString5 = new SpannableString("x");
                            spannableString5.setSpan(u70Var2, 0, 1, 33);
                            u70Var2.b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsTransaction.photo)), "14_14", null, null, num, 0);
                            textView3.setText(str);
                            d90Var.setVisibility(z12 ? 8 : 0);
                        ...
                        while (i14 < q7Var.e) {
                            ...
                            float f7 = i14;
                            w9Var4.setTranslationX(((f7 - (q7Var.e / 2.0f)) * AndroidUtilities.dp(4.33f)) + AndroidUtilities.dp(2.0f));
                            w9Var4.setTranslationY((f7 - (q7Var.e / 2.0f)) * AndroidUtilities.dp(4.33f));
                            i14++;
                        }
                    }
                } else {
                    ...
                    if (starsTransaction.floodskip) {
                        ...
                        if (starsTransactionPeer instanceof TL_stars.TL_starsTransactionPeerAppStore) {
                            ...
                            w9Var2.setImageDrawable(q7.a(44, "premiumbot"));
                            ...
                            w9Var2.setImageDrawable(q7.a(44, "?"));
                            ...
                            w9Var2.setImageDrawable(q7.a(44, "ads"));
                        } else {
                            textView3.setText("");
                ...
                if (j3 <= 0 || (j3 == 0 && starsAmount.nanos > 0)) {
                    ...
                    textView2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.uj, false));
                    textView2.setText(TextUtils.concat("+", w7.I0(starsTransaction.amount), " ", !z11 ? spannableString3 : spannableString));
                    z13 = z10;
                } else {
                    if (j3 < 0 || (j3 == 0 && starsAmount.nanos < 0)) {
                        textView2.setVisibility(0);
                        textView2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.wj, false));
                        textView2.setText(TextUtils.concat(w7.I0(starsTransaction.amount), " ", z11 ? spannableString3 : spannableString));
                    } else {
