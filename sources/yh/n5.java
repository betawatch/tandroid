...
public final class n5 implements o5 {
    ...
    public n5(int i10, long j3, boolean z10) {
        this.a = i10;
        this.b = j3;
        if (z10) {
            a();
    ...
    public final void a() {
        ...
        int sendRequest = ConnectionsManager.getInstance(i10).sendRequest(getsavedstargifts, new ci.v1(this, r2, z10, 8));
        this.m = sendRequest;
        ...
        if (savedStarGift != null) {
            ...
            if (contains) {
                if (!z10) {
                    ...
                    if (this.e && !this.c) {
                        Collections.sort(arrayList, new lb1(21));
                    }
                ...
                if (h.size() + 1 <= MessagesController.getInstance(i10).stargiftsPinnedToTopLimit) {
                    ...
                    while (h.size() > 0 && h.size() + 1 > MessagesController.getInstance(i10).stargiftsPinnedToTopLimit) {
                        ((TL_stars.SavedStarGift) hg.k0.z(1, h)).pinned_to_top = false;
                    }
                    z12 = true;
                }
                h.add(savedStarGift);
    ...
    public final void n(TL_stars.SavedStarGift savedStarGift, int i10, boolean z10) {
        ...
        while (i11 < size) {
            ...
            if (v5.k(savedStarGift2, savedStarGift)) {
                if (!z10) {
    ...
    public final void o(TL_stars.SavedStarGift savedStarGift, boolean z10) {
        ...
        while (i10 < size) {
            ...
            i10++;
            TL_stars.SavedStarGift savedStarGift2 = (TL_stars.SavedStarGift) obj;
            if (v5.k(savedStarGift2, savedStarGift) && savedStarGift2.unsaved != z10) {
