...
public final class c3 extends FrameLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        d3 d3Var = this.b;
        l40 l40Var = d3Var.i;
        if (l40Var == null || l40Var.d.getChildCount() < 2 || d3Var.r == null || (frameLayout = d3Var.m) == null) {
            return;
        }
        int[] iArr = this.a;
        ...
        d3Var.r.setTranslationY(((translationY2 - translationY) - r1.getMeasuredHeight()) - l40Var.getMeasuredHeight());
