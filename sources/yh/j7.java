...
public final class j7 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public j7(Context context, org.telegram.ui.ActionBar.f6 f6Var, TLRPC.User user, tg.b1 b1Var) {
        ...
        c90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StarsTOS), new Runnable(this) { // from class: yh.i7
            public final /* synthetic */ j7 b;
    ...
    public static void P(j7 j7Var, int i10) {
        ...
        x51 x51Var2 = j7Var.b0;
        if (G.d == -1) {
            j7Var.c0 = !j7Var.c0;
            x51Var2.N(true);
            j7Var.d.w0(0, AndroidUtilities.dp(200.0f), qr.g);
            return;
        }
        if (G.G(k7.class) && (G.G instanceof TL_stars.TL_starsGiftOption)) {
    ...
    public static void Q(j7 j7Var, j51 j51Var, long j3, Boolean bool, String str) {
        ...
        if ((bool.booleanValue() || str != null) && (b1Var = j7Var.a0) != null) {
            b1Var.run();
        }
        super.dismiss();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        x51 x51Var;
        if ((i10 == NotificationCenter.starGiftOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) && (x51Var = this.b0) != null) {
            x51Var.N(true);
        }
    }
