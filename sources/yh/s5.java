...
public final class s5 {
    ...
    public static void e(String str) {
        ...
        hg.c.q(R.string.UnknownErrorCode, new Object[]{str}, (R == null || R.visibleDialog != null) ? xc.X() : xc.a0(R), R.raw.error, 36);
    }
    ...
    public final long A(MessageObject messageObject) {
        Long l4;
        r5 r5Var = this.B;
        if (r5Var != null && r5Var.a.equals(m5.b(messageObject)) && (l4 = this.B.n) != null) {
            return l4.longValue();
        }
    ...
    public final long B(m5 m5Var, TLRPC.TL_messageReactions tL_messageReactions) {
        Long l4;
        r5 r5Var = this.B;
        if (r5Var != null && r5Var.a.equals(m5Var) && (l4 = this.B.n) != null) {
            return l4.longValue();
        }
    ...
    public final long D(int i10, long j3) {
        ...
        m5 m5Var = r5Var.a;
        if (m5Var.a == j3 && m5Var.b == i10 && r5Var.l) {
            return r5Var.h;
        }
        return 0L;
    }
                    ...
                    public final void run() {
                        ...
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 == null || !"BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                ...
                                boolean[] zArr = {false};
                                l7 l7Var = new l7(context3, d6Var2, j11, 1, chatInvite3.title, new u(s5Var2, zArr, str6, chatInvite3, callback23, 3), 0L);
                        ...
                        Utilities.stageQueue.postRunnable(new s4(s5Var2, tL_payments_paymentResult, i10));
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: yh.g5
                    ...
                    */
                    public final void run() {
                        ...
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                if (!MessagesController.getInstance(s5Var2.a).starsPurchaseAvailable()) {
                                    ...
                                    boolean[] zArr = {false};
                                    l7 l7Var = new l7(context3, d6Var2, j14, 0, str6, new z8(s5Var2, zArr, messageObject3, inputInvoice3, tL_payments_paymentFormStars3, callback3, 21), j15);
                            ...
                            if (tL_error2 != null && "FORM_EXPIRED".equals(tL_error2.text)) {
                                ...
                                ConnectionsManager.getInstance(s5Var2.a).sendRequest(tL_payments_getPaymentForm, new hd(s5Var2, messageObject3, inputInvoice3, callback3, X, 14));
                                return;
                            }
                            xc xcVar = X;
                            callback3.run(Boolean.FALSE);
                            hg.c.q(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, xcVar, R.raw.error, 36);
                        ...
                        Utilities.stageQueue.postRunnable(new s4(s5Var2, (TLRPC.TL_payments_paymentResult) tLObject2, 4));
    ...
    */
    ...
    public final r5 d0(final MessageObject messageObject, final wn wnVar, final long j3, boolean z10, boolean z11, final Long l4) {
        ...
        if (z11 && y3.e && y3.q(false, false, null).amount < j11) {
            ...
            final int i12 = 1;
            new l7(t10, wnVar.getResourceProvider(), j11, 5, str2, new Runnable(s5Var) { // from class: yh.x4
                public final /* synthetic */ s5 b;
                ...
                public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: yh.o4
                        ...
                        public final void run() {
                            ...
                            s5 s5Var2 = s5.this;
                            ConnectionsManager.getInstance(s5Var2.a).sendRequest(tL_payments_sendStarsForm, new q4(s5Var2, callback23, context3, d6Var, j11, str, j10, tLObject3, tL_textWithEntities2));
                        }
                    });
                }
            });
                            ...
                            public final void run(final TLObject tLObject3, final TLRPC.TL_error tL_error3) {
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: yh.d4
                                    ...
                                    public final void run() {
                                        ...
                                        if (!z21) {
                                            if (tL_error4 != null && "BALANCE_TOO_LOW".equals(tL_error4.text)) {
                                                if (!MessagesController.getInstance(s5Var4.a).starsPurchaseAvailable()) {
                                                    ...
                                                    boolean[] zArr = {false};
                                                    l7 l7Var = new l7(context6, d6Var4, j15, 6, str5, new ua(s5Var4, zArr, starGift5, z19, z20, j16, tL_textWithEntities5, n4Var5), 0L);
                                        ...
                                        Utilities.stageQueue.postRunnable(new s4(s5Var4, (TLRPC.TL_payments_paymentResult) tLObject4, i12));
                                        s5Var4.D = false;
                                        s5Var4.E = true;
                                        s5Var4.G = 0L;
                                        s5Var4.V();
