...
public final class k8 {
        ...
        if (LiteMode.isEnabled(131072)) {
            ...
            if (this.l != null) {
                ...
                for (int i12 = 0; i12 < min; i12++) {
                    ...
                    this.l.e(i12, i0.a.k(i10, (int) (Utilities.clamp01(j8Var.h * f7) * 255.0f)));
                }
                ...
                while (i13 < min) {
                    ...
                    rect.set((int) (j8Var2.a - ((((bitmap2.getWidth() / f10) * j8Var2.i) * j8Var2.e) * f16)), (int) (j8Var2.b - ((((bitmap2.getHeight() / f10) * j8Var2.i) * j8Var2.e) * f16)), (int) com.google.android.gms.internal.vision.e2.x((bitmap2.getWidth() / f10) * j8Var2.i, j8Var2.e, f16, j8Var2.a), (int) com.google.android.gms.internal.vision.e2.x((bitmap2.getHeight() / 2.0f) * j8Var2.i, j8Var2.e, f16, j8Var2.b));
    ...
    public final void c(j8 j8Var, long j3, boolean z10) {
        ...
        j8Var.g = lerp;
        if (z10) {
            j8Var.f -= (long) (Utilities.clamp01(Utilities.fastRandom.nextFloat()) * lerp);
        }
        RectF rectF = this.c;
        j8Var.a = AndroidUtilities.lerp(rectF.left, rectF.right, Utilities.fastRandom.nextFloat());
        j8Var.b = AndroidUtilities.lerp(rectF.top, rectF.bottom, Utilities.fastRandom.nextFloat());
        if (this.a == 0) {
            j8Var.c = AndroidUtilities.dp(AndroidUtilities.lerp(-7.0f, -18.0f, Utilities.fastRandom.nextFloat()));
            j8Var.d = AndroidUtilities.dp(AndroidUtilities.lerp(-2.0f, 2.0f, Utilities.fastRandom.nextFloat()));
        } else {
            j8Var.c = rectF.centerX() - j8Var.a;
            j8Var.d = rectF.centerY() - j8Var.b;
        ...
        j8Var.i = AndroidUtilities.lerp(0.4f, 1.0f, Utilities.fastRandom.nextFloat());
    ...
    public final boolean d() {
        if (LiteMode.isEnabled(131072)) {
            ...
            while (true) {
                ...
                long j3 = j8Var.g;
                float f7 = j3 <= 0 ? 2.0f : (currentTimeMillis - j8Var.f) / j3;
                if (f7 > 1.0f) {
                    c(j8Var, currentTimeMillis, this.k);
                    f7 = 0.0f;
                }
                j8Var.a = (j8Var.c * min) + j8Var.a;
                j8Var.b = (j8Var.d * min) + j8Var.b;
                float f10 = 4.0f * f7;
                j8Var.h = f10 - (f7 * f10);
                i10++;
            }
    ...
    public final void e() {
        ...
        while (true) {
            ...
            j8 j8Var = (j8) arrayList.get(i10);
            if (!this.c.contains((int) j8Var.a, (int) j8Var.b)) {
                c(j8Var, currentTimeMillis, this.k);
            }
            i10++;
        }
