...
public final /* synthetic */ class t2 implements Utilities.Callback2 {
    ...
    public /* synthetic */ t2(g4 g4Var, String[] strArr, ArrayList arrayList, int i10) {
        this.a = i10;
        this.b = g4Var;
        this.c = strArr;
        this.d = arrayList;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                ...
                t3 t3Var = g4Var.d;
                boolean isEmpty = t3Var.l.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = t3Var.l.contains(Long.valueOf(stargiftattributepattern.document.id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.w1.w(" ", lowerCase, stargiftattributepattern.name.toLowerCase()) || org.telegram.messenger.w1.w(" ", translitSafe, stargiftattributepattern.name.toLowerCase())) {
                        Integer num = (Integer) t3Var.o.get(Long.valueOf(stargiftattributepattern.document.id));
            ...
            case 1:
                ...
                t3 t3Var2 = g4Var.d;
                boolean isEmpty2 = t3Var2.k.isEmpty();
                ...
                while (i13 < size2) {
                    ...
                    boolean contains2 = t3Var2.k.contains(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    ...
                    if (TextUtils.isEmpty(lowerCase2) || stargiftattributebackdrop.name.toLowerCase().startsWith(lowerCase2) || stargiftattributebackdrop.name.toLowerCase().startsWith(translitSafe2)) {
                        ...
                        str2 = str;
                        str = (org.telegram.messenger.w1.w(str2, lowerCase2, stargiftattributebackdrop.name.toLowerCase()) || org.telegram.messenger.w1.w(str2, translitSafe2, stargiftattributebackdrop.name.toLowerCase())) ? " " : str2;
                    }
                    Integer num2 = (Integer) t3Var2.n.get(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
            ...
            default:
                ...
                t3 t3Var3 = g4Var.d;
                boolean isEmpty3 = t3Var3.j.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = t3Var3.j.contains(Long.valueOf(stargiftattributemodel.document.id));
                    boolean z12 = !contains3;
                    if (TextUtils.isEmpty(lowerCase3) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase3) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe3) || org.telegram.messenger.w1.w(str4, lowerCase3, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.w1.w(str4, translitSafe3, stargiftattributemodel.name.toLowerCase())) {
                        str3 = str4;
                        Integer num3 = (Integer) t3Var3.m.get(Long.valueOf(stargiftattributemodel.document.id));
