...
public final class b3 extends View {
    ...
    public b3(Context context, TL_stars.StarGift starGift, TLObject tLObject) {
        super(context);
        Path path = new Path();
        this.c = path;
        Paint paint = new Paint(1);
        this.d = paint;
        n3 n3Var = new n3(this, starGift, 60, 0.27f);
        this.a = n3Var;
        n3Var.t = 3;
    ...
    public b3(Context context, TL_stars.TL_starGiftUnique tL_starGiftUnique) {
        super(context);
        Path path = new Path();
        this.c = path;
        Paint paint = new Paint(1);
