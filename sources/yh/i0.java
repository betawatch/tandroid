...
public final class i0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public i0(Context context, org.telegram.ui.ActionBar.e6 e6Var, int i10, zf.a aVar, nj0 nj0Var) {
        ...
        id0Var.b(1.0f, aVar != null && !aVar.k() ? 1.0f : 0.0f, false);
        ...
        this.f = f7;
        f7.setOnClickListener(new w(1, this, nj0Var));
        f7.g(LocaleController.getString(R.string.ResellGiftButton), false, true);
        linearLayout3.addView(f7, w7.y5.k(18.0f, 0.0f, 18.0f, 8.0f, -1, 48));
        if (aVar != null) {
    ...
    public final void n(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (z13 || z15) {
            ...
            if ((i11 & 4) != 0) {
                ...
                id0Var.setText(LocaleController.getString(this.E.a == bVar2 ? R.string.ResellGiftPriceTitle : R.string.ResellGiftPriceTitleTON));
            }
        }
        if (z13 || z14 || z15) {
            ...
            if (dVar.W != z16) {
                ...
                if (z12) {
                    wh.q(dVar.animate(), z16 ? 1.0f : 0.6f, 180L);
                } else {
