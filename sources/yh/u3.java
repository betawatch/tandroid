...
public class u3 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (max > 0.0f && stargiftattributebackdropArr[0] != null) {
            ...
            org.telegram.ui.Components.o5[] o5VarArr = u3Var.q0;
            if (max2 > 0.0f) {
                canvas2.save();
                canvas2.translate(f12, f11);
                o5VarArr[0].k(Integer.valueOf(i11));
                j0.a(canvas, 0, o5VarArr[0], u3Var.getWidth(), realHeight, max2, 1.0f);
            ...
            if (u3Var.U.a(2) > 0.0f) {
                ...
                j0.c(canvas, o5VarArr[0], u3Var.getWidth(), f16 * 0.7f, 1.0f, rectF, u3Var.U.a(2));
                canvas2 = canvas;
                canvas2.restore();
            } else {
                canvas2 = canvas;
