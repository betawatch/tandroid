...
public class w3 extends FrameLayout {
    ...
    public w3(Context context, org.telegram.ui.ActionBar.e6 e6Var, Runnable runnable, View.OnClickListener onClickListener, u0 u0Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        super(context);
        float f7;
        this.d = new u9[5];
        ...
        this.v = textView;
        textView.setOnClickListener(new r3(this, 0));
        ...
        while (true) {
            ...
            v3Var.addView(imageView, w7.x5.d(24, 24.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
            ...
            v3Var.addView(textView3, w7.x5.d(-1, -2.0f, 49, 4.0f, 35.0f, 4.0f, 0.0f));
            v3VarArr[i13] = v3Var;
            if (i13 == 0) {
            ...
            cc1 cc1Var2 = this.H;
            v3[] v3VarArr2 = this.I;
            cc1Var2.addView(v3VarArr2[i13], w7.x5.p(0, 56, 1.0f, 119, 0, 0, i13 != v3VarArr2.length - 1 ? 11 : 0, 0));
            i13++;
        }
        ...
        while (true) {
            ...
            if (i14 == 2) {
                ...
                this.y[i14].setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.j5, e6Var));
                this.y[i14].setTextSize(1, 14.0f);
                this.y[i14].setLinkTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.gc, e6Var));
                ...
                z2 z2Var = new z2(context, e6Var);
                this.L = z2Var;
                this.f[i14].addView(z2Var, w7.x5.n(-1, -2));
                ...
                this.r[i14] = new c90(context, null);
                this.r[i14].setTextColor(i14 == 3 ? -1 : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.j5, e6Var));
                this.r[i14].setTextSize(1, 20.0f);
                this.r[i14].setTypeface(AndroidUtilities.bold());
                this.r[i14].setGravity(17);
                ...
                if (i14 == 0) {
                    this.y[i14] = new c90(context, null);
                    this.y[i14].setTextColor(i14 == 3 ? org.telegram.ui.ActionBar.i6.l1(0.75f, -1) : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.j5, e6Var));
                    this.y[i14].setTextSize(1, 14.0f);
                    this.y[i14].setGravity(17);
                    this.y[i14].setLinkTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.gc, e6Var));
                    this.y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        ...
        this.c = o3Var;
        addView(o3Var, w7.x5.d(-1, 160.0f, 55, 0.0f, 8.0f, 0.0f, 0.0f));
    ...
    public final void a() {
        ...
        this.u0.addListener(new t3(this, 4));
    ...
    public void d(f4.d dVar) {
        ...
        z2 z2Var = this.L;
        z2Var.setVisibility(i17);
        z2Var.setAlpha(dVar.a(4));
        invalidate();
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        o3 o3Var2 = this.c;
        if (o3Var2.s == null && o3Var2.v == null && o3Var2.w == null) {
            w3Var = this;
            f12 = f7;
            f11 = f10;
            iArr3 = iArr4;
            ...
            w3Var = this;
            canvas2 = canvas;
            o3Var2.a(canvas2, i3Var, f15, width2, realHeight, iArr7, iArr8, iArr9);
            o3Var2.a(canvas2, o3Var2.v, o3Var2.y, width2, realHeight, iArr7, iArr8, iArr9);
            o3Var2.a(canvas2, o3Var2.w, o3Var2.E, width2, realHeight, iArr7, iArr8, iArr9);
            o3Var = o3Var2;
            w3Var.invalidate();
        }
        if (max > 0.0f && stargiftattributebackdropArr[0] != null) {
            ...
            org.telegram.ui.Components.m5[] m5VarArr = w3Var.q0;
            if (max2 > 0.0f) {
                canvas2.save();
                canvas2.translate(f12, f11);
                m5VarArr[0].k(Integer.valueOf(i11));
                j0.a(canvas, 0, m5VarArr[0], w3Var.getWidth(), realHeight, max2, 1.0f);
            ...
            if (w3Var.U.a(2) > 0.0f) {
                ...
                LinearLayout[] linearLayoutArr = w3Var.f;
                float x10 = linearLayoutArr[2].getX();
                FrameLayout frameLayout = w3Var.J;
                ...
                j0.c(canvas, m5VarArr[0], w3Var.getWidth(), f16 * 0.7f, 1.0f, rectF, w3Var.U.a(2));
                canvas2 = canvas;
                canvas2.restore();
            } else {
                canvas2 = canvas;
            ...
            while (i12 < length) {
                ...
                int[] iArr10 = iArr2;
                if (org.telegram.ui.ActionBar.i6.B1(v3Var.getBackground(), iArr10[Utilities.clamp(Math.round((((v3Var.getWidth() / 2.0f) + v3Var.getX()) / w3Var.getWidth()) * (iArr10.length - 1)), iArr10.length - 1, 0)], false)) {
                    v3Var.invalidate();
                }
                i12++;
                iArr2 = iArr10;
            ...
            if (textView != null && w3Var.w != i13) {
                w3Var.w = i13;
                textView.setTextColor(i13);
                org.telegram.ui.ActionBar.i6.B1(textView.getBackground(), i14, false);
            }
            if (o3Var.s != null || o3Var.v != null || o3Var.w != null) {
                w3Var.y[0].setTextColor(i13);
            }
            if (w3Var.U.a(2) > 0.0f) {
                if (w3Var.w0 == null) {
                    w3Var.w0 = new j8(1, 12);
                }
                FrameLayout frameLayout2 = w3Var.b;
                ...
                RectF rectF2 = w3Var.v0;
                rectF2.set(measuredWidth - scaleX, measuredHeight - scaleY, measuredWidth + scaleX, f17);
                w3Var.w0.g(rectF2);
                w3Var.w0.d();
                w3Var.w0.a(canvas2, org.telegram.ui.ActionBar.i6.l1(w3Var.U.a(2), -1));
                w3Var.invalidate();
            }
        }
        if (w3Var.U.a(1) > 0.0f) {
            w3Var.c(canvas2, f12, f11, w3Var.getWidth(), w3Var.getRealHeight());
        }
    ...
    public final void f(TL_stars.StarGift starGift, boolean z10, boolean z11, boolean z12) {
        ...
        TL_stars.starGiftAttributeBackdrop[] stargiftattributebackdropArr = this.V;
        if (z14) {
            stargiftattributebackdropArr[0] = (TL_stars.starGiftAttributeBackdrop) u5.l(starGift.attributes, TL_stars.starGiftAttributeBackdrop.class);
            g(0, (TL_stars.starGiftAttributePattern) u5.l(starGift.attributes, TL_stars.starGiftAttributePattern.class), false);
            c90VarArr[0].setTextSize(1, 13.0f);
            cc1Var.setVisibility(z13 ? 0 : 8);
            v3[] v3VarArr = this.I;
            if (z13) {
                v3VarArr[1].b(z12 ? R.drawable.filled_crown_off : R.drawable.filled_crown_on, LocaleController.getString(z12 ? R.string.Gift2ActionWearOff : R.string.Gift2ActionWear), false);
            }
            float f7 = 1.0f;
            if (starGift.resell_amount != null) {
                ...
                CharSequence formatSpannable = LocaleController.formatSpannable(R.string.GiftOnSale, x7.S0("⭐️ " + ((Object) x7.J0(resellAmount.o(), 1.0f, ',')), resellAmount.a == bVar), Float.valueOf(0.9f));
                TextView textView = this.N;
                ...
                if (z3.N1(UserConfig.selectedAccount, DialogObject.getPeerDialogId(starGift.owner_id))) {
                    textView.setOnClickListener(new r3(this, 1));
                    w7.z5.a(textView);
                } else {
            ...
            if (z10) {
                v3VarArr[0].setAlpha(1.0f);
                v3VarArr[0].b(R.drawable.filled_gift_transfer, LocaleController.getString(R.string.Gift2ActionTransfer), false);
            } else {
                v3VarArr[0].setAlpha(0.5f);
                ...
                v3VarArr[0].b(R.drawable.filled_gift_transfer, spannableStringBuilder, false);
            }
            v3 v3Var = v3VarArr[1];
            if (!z10 && !z11) {
                f7 = 0.5f;
            ...
            if (z10) {
                ...
                if (arrayList != null) {
                    v3VarArr[2].b(R.drawable.filled_gift_sell_off, LocaleController.getString(R.string.Gift2ActionUnlist), false);
                    v3VarArr[2].setOnClickListener(onClickListener);
                } else {
                    v3VarArr[2].b(R.drawable.filled_gift_sell_on, LocaleController.getString(R.string.Gift2ActionResell), false);
                    v3VarArr[2].setOnClickListener(onClickListener);
                }
            } else {
                v3VarArr[2].b(R.drawable.filled_share, LocaleController.getString(R.string.Gift2ActionShare), false);
                v3VarArr[2].setOnClickListener(this.R);
            }
        ...
        x7.a1(this.d[0].getImageReceiver(), starGift, 160);
        this.e[0] = (TL_stars.starGiftAttributeModel) u5.l(starGift.attributes, TL_stars.starGiftAttributeModel.class);
        d(this.U);
    }
    ...
    public int getFinalHeight() {
        ...
        if (this.U.d(2)) {
            ...
            if (!this.U.d(3)) {
                ...
                z2 z2Var = this.L;
                return z2Var.getMeasuredHeight() > 0 ? z2Var.getMeasuredHeight() : AndroidUtilities.dp(550.0f);
            }
    ...
    public void setPreviewAttributes(o0 o0Var) {
        ...
        if (dVar != null && dVar.b == 1 && isAttachedToWindow()) {
            ...
            xi0 lottieAnimation2 = u9VarArr[this.r0 + 1].getImageReceiver().getLottieAnimation();
            ...
            x7.Z0(u9VarArr[i12].getImageReceiver(), stargiftattributemodelArr[this.r0 + 1].document, 160);
            a();
            float f7 = this.r0;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(1.0f - f7, f7);
            this.h0 = ofFloat;
            ofFloat.addUpdateListener(new s3(this, 0));
            this.h0.addListener(new t3(this, 3));
    ...
    public void setPreviewingAttributes(ArrayList<TL_stars.StarGiftAttribute> arrayList) {
        this.W = new com.google.android.gms.common.api.internal.r(u5.m(arrayList, TL_stars.starGiftAttributeModel.class));
        this.a0 = new com.google.android.gms.common.api.internal.r(u5.m(arrayList, TL_stars.starGiftAttributePattern.class));
        this.b0 = new com.google.android.gms.common.api.internal.r(u5.m(arrayList, TL_stars.starGiftAttributeBackdrop.class));
        ...
        u9[] u9VarArr = this.d;
        x7.Z0(u9VarArr[1].getImageReceiver(), stargiftattributemodelArr[1].document, 160);
        ...
        x7.Z0(u9VarArr[2].getImageReceiver(), stargiftattributemodelArr[2].document, 160);
        x2 x2Var = this.i0;
    ...
    public void setResellPrice(zf.a aVar) {
        ...
        if (k10) {
            ...
            qr qrVar = qr.h;
            duration.setInterpolator(qrVar).setListener(new t3(this, 2)).setListener(new t3(this, 1)).start();
            c90VarArr[0].animate().alpha(1.0f).setDuration(420L).setInterpolator(qrVar).start();
        } else {
            textView.setText(LocaleController.formatSpannable(R.string.GiftOnSale, x7.U0(aVar.a == zf.b.b, "⭐️ " + ((Object) x7.J0(aVar.o(), 1.0f, ',')), 0.9f, null, 0.0f, 1.0f)));
            ...
            qr qrVar2 = qr.h;
            duration2.setInterpolator(qrVar2).setListener(new t3(this, 0)).start();
            c90VarArr[0].animate().alpha(0.0f).setDuration(420L).setInterpolator(qrVar2).start();
        }
        boolean z10 = this.M;
        v3[] v3VarArr = this.I;
        if (z10) {
            v3VarArr[2].b(R.drawable.filled_gift_sell_off, LocaleController.getString(R.string.Gift2ActionUnlist), true);
        } else {
            v3VarArr[2].b(R.drawable.filled_gift_sell_on, LocaleController.getString(R.string.Gift2ActionResell), true);
        }
        v3VarArr[2].setOnClickListener(this.S);
    }
