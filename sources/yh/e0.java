            ...
            aVar.setOnClickListener(new View.OnClickListener(this) { // from class: yh.b0
                ...
                public final void onClick(View view) {
                    switch (i12) {
                        ...
                        default:
                            e0 e0Var = this.b;
                            org.telegram.ui.Components.c5.T(context, e0Var.I, new r5.d(e0Var, 19), f6Var, 0).a.show();
                            break;
                    }
                }
            });
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (z13 || z14 || z15) {
            ...
            if (i14 != 0) {
                ...
                dVar.g(y7.V0(z16, LocaleController.formatString(i15, objArr3), z16 ? this.M : this.L), z12, true);
            }
            n(z12);
        }
        if (z13 || z14) {
