...
public final class e0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, zn znVar, final org.telegram.ui.ActionBar.e6 e6Var, int i11, Utilities.Callback callback) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) { // from class: yh.b0
                ...
                public final void onClick(View view) {
                    switch (i12) {
                        ...
                        default:
                            e0 e0Var = this.b;
                            org.telegram.ui.Components.e5.T(context, e0Var.I, new r5.d(e0Var, 19), e6Var, 0).a.show();
                            break;
                    }
                }
            });
        ...
        id0Var.b(1.0f, aVar2 != null && !aVar2.k() ? 1.0f : 0.0f, false);
        ...
        id0Var2.e(c0Var);
        id0Var2.addView(c0Var, w7.y5.d(-1, -2.0f, 48, 0.0f, 0.0f, 48.0f, 0.0f));
        w7.a6.b(id0Var2, 0.02f, 1.2f);
        final int i16 = 1;
        id0Var2.setOnClickListener(new View.OnClickListener(this) { // from class: yh.b0
            public final /* synthetic */ e0 b;
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (z13 || z15) {
            ...
            if ((i11 & 4) != 0) {
                ...
                objArr[c10] = p().f();
                id0Var.setText(LocaleController.formatString(i12, objArr));
            } else if ((i11 & 2) != 0) {
                int i13 = R.string.SuggestAPostTooSmall;
                Object[] objArr2 = new Object[1];
                objArr2[c10] = (this.H.a == bVar2 ? aVar6 : aVar2).f();
                id0Var.setText(LocaleController.formatString(i13, objArr2));
            } else {
                id0Var.setText(LocaleController.getString(this.H.a == bVar3 ? R.string.PostSuggestionsOfferTitlePriceStars : R.string.PostSuggestionsOfferTitlePriceTON));
            }
        }
        if (z13 || z14 || z15) {
            int i14 = this.d;
