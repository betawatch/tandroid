...
public final class e0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, zn znVar, final org.telegram.ui.ActionBar.f6 f6Var, int i11, Utilities.Callback callback) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) { // from class: yh.b0
                ...
                public final void onClick(View view) {
                    switch (i12) {
                        ...
                        default:
                            e0 e0Var = this.b;
                            org.telegram.ui.Components.d5.T(context, e0Var.I, new r5.d(e0Var, 19), f6Var, 0).a.show();
                            break;
                    }
                }
            });
        ...
        this.s = dVar;
        dVar.setOnClickListener(new ei.c1(this, znVar, i10, context, f6Var, j3, callback));
        if (i11 == 1) {
