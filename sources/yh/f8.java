...
public final class f8 extends View {
    ...
    public f8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.c = new Paint(1);
        this.d = new Paint(1);
        this.e = new h01(LocaleController.getString(R.string.StarsReactionTopSenders), 14.16f, AndroidUtilities.bold());
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        h01 h01Var = this.e;
        float dp = h01Var.c + AndroidUtilities.dp(30.0f);
        ...
        this.e.c((getWidth() - h01Var.c) / 2.0f, getHeight() / 2.0f, 1.0f, -1, canvas);
    }
}
