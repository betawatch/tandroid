...
public final class r7 extends i51 {
    ...
    */
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        boolean z13;
        s7 s7Var = (s7) view;
        TL_stars.StarsTransaction starsTransaction = (TL_stars.StarsTransaction) j51Var.G;
        boolean z14 = j51Var.q;
        u9 u9Var = s7Var.d;
        SpannableString spannableString2 = s7Var.v;
        SpannableString spannableString3 = s7Var.w;
        f9 f9Var = s7Var.b;
        int i10 = s7Var.a;
        TextView textView = s7Var.r;
        TextView textView2 = s7Var.s;
        u9 u9Var2 = s7Var.c;
        ...
        s7Var.x = z17;
        boolean z18 = z17;
        LinearLayout.LayoutParams layoutParams = s7Var.h;
        if (z18) {
        ...
        c90Var.setVisibility(s7Var.x ? 0 : 8);
        textView.setTextSize(1, s7Var.x ? 13.0f : 14.0f);
        ...
        if (starsTransaction.stargift_upgrade && starsTransaction.stargift != null) {
            u9Var2.setImageDrawable(new o3(u9Var2, starsTransaction.stargift, 46, 0.25f));
            ...
            if (!starsTransaction.posts_search) {
                if (peerDialogId != 0) {
                    if (UserObject.isService(peerDialogId)) {
                        ...
                        u9Var2.setImageDrawable(s7.a(44, "fragment"));
                        z12 = false;
                    ...
                    if (starsTransaction.stargift != null) {
                        z70 z70Var = new z70(c90Var, 16.0f, i10);
                        z70Var.a(4.0f);
                        z70Var.f = false;
                        SpannableString spannableString4 = new SpannableString("x");
                        spannableString4.setSpan(z70Var, 0, 1, 33);
                        y7.a1(z70Var.b, starsTransaction.stargift, 16);
                        ...
                        if (starsTransaction.photo != null) {
                            z70 z70Var2 = new z70(c90Var, 14.0f, i10);
                            z70Var2.a(4.0f);
                            z70Var2.f = false;
                            SpannableString spannableString5 = new SpannableString("x");
                            spannableString5.setSpan(z70Var2, 0, 1, 33);
                            z70Var2.b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsTransaction.photo)), "14_14", null, null, num, 0);
                            textView3.setText(str);
                            c90Var.setVisibility(z12 ? 8 : 0);
                        ...
                        while (i14 < s7Var.e) {
                            ...
                            float f7 = i14;
                            u9Var4.setTranslationX(((f7 - (s7Var.e / 2.0f)) * AndroidUtilities.dp(4.33f)) + AndroidUtilities.dp(2.0f));
                            u9Var4.setTranslationY((f7 - (s7Var.e / 2.0f)) * AndroidUtilities.dp(4.33f));
                            i14++;
                        }
                    }
                } else {
                    ...
                    if (starsTransaction.floodskip) {
                        ...
                        u9Var2.setImageDrawable(s7.a(44, "api"));
                    } else {
                        ...
                        if (starsTransactionPeer instanceof TL_stars.TL_starsTransactionPeerAppStore) {
                            ...
                            u9Var2.setImageDrawable(s7.a(44, "premiumbot"));
                            ...
                            u9Var2.setImageDrawable(s7.a(44, "?"));
                            ...
                            u9Var2.setImageDrawable(s7.a(44, "ads"));
                        } else {
                            textView3.setText("");
                ...
                if (j3 <= 0 || (j3 == 0 && starsAmount.nanos > 0)) {
                    ...
                    textView2.setText(TextUtils.concat("+", y7.I0(starsTransaction.amount), " ", !z11 ? spannableString3 : spannableString));
                    z13 = z10;
                } else {
                    if (j3 < 0 || (j3 == 0 && starsAmount.nanos < 0)) {
                        textView2.setVisibility(0);
                ...
                s7Var.y = z13;
                s7Var.setWillNotDraw(!z13);
            }
            u9Var2.setImageDrawable(s7.a(44, "search"));
    ...
    public final View createView(Context context, ml0 ml0Var, int i10, int i11, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        return s7Var != null ? s7Var : new s7(context, i10, f6Var);
    }
}
