...
public final class v5 {
    public static volatile v5[][] S = (v5[][]) Array.newInstance((Class<?>) v5.class, 2, 4);
    ...
    public static /* synthetic */ void a(v5 v5Var, TL_stars.StarGifts starGifts) {
    ...
    public static /* synthetic */ void b(v5 v5Var, ArrayList arrayList, Integer num, Long l4, ArrayList arrayList2, ArrayList arrayList3) {
        int i10 = v5Var.a;
    ...
    public static void e(String str) {
        ...
        hg.k0.s(R.string.UnknownErrorCode, new Object[]{str}, (R == null || R.visibleDialog != null) ? vc.X() : vc.a0(R), R.raw.error, 36);
    }
    ...
    public static v5 x(int i10, zf.b bVar) {
    ...
    public final long A(MessageObject messageObject) {
        Long l4;
        u5 u5Var = this.B;
        if (u5Var != null && u5Var.a.equals(p5.b(messageObject)) && (l4 = this.B.n) != null) {
            return l4.longValue();
        }
    ...
    public final long B(p5 p5Var, TLRPC.TL_messageReactions tL_messageReactions) {
        Long l4;
        u5 u5Var = this.B;
        if (u5Var != null && u5Var.a.equals(p5Var) && (l4 = this.B.n) != null) {
            return l4.longValue();
        }
    ...
    public final long D(int i10, long j3) {
        ...
        p5 p5Var = u5Var.a;
        if (p5Var.a == j3 && p5Var.b == i10 && u5Var.l) {
            return u5Var.h;
        }
        return 0L;
    }
    ...
    public final n5 G(long j3, boolean z10) {
        ...
        n5 n5Var2 = new n5(this.a, j3, true);
    ...
    public final void H(TL_stars.StarGift starGift, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10, Utilities.Callback callback) {
        ...
        if (!this.e) {
            r(new k21(this, callback, starGift, j3, 11));
            return;
        }
    ...
    public final void M(TL_stars.InputSavedStarGift inputSavedStarGift, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(getsavedstargift, new ai.p3(this, c2Var, inputSavedStarGift, callback, 18));
    }
    ...
    public final void W() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_getStarsSubscriptions, new y4(this, 1));
    }
    ...
    */
    public final void Y(MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, Runnable runnable, Utilities.Callback callback) {
        ...
        z4 z4Var3 = new z4(this, j14, zArr, callback, context2, I, z10, str, messageObject, inputInvoice, tL_payments_paymentFormStars, i18, j13);
        o31 o31Var2 = new o31(this, zArr, callback);
        org.telegram.ui.ActionBar.g3 i20 = wl.i(1, context2, I, false);
        ...
        frameLayout.addView(new a7(context2, 40, 0), w7.x5.c(-1.0f, -1));
        if (messageObject == null || (message2 = messageObject.messageOwner) == null || !(message2.media instanceof TLRPC.TL_messageMediaPaidMedia)) {
            ...
            if (webDocument != null) {
                ...
                u9Var.n(ImageLocation.getForWebFile(WebFile.createWithWebDocument(webDocument)), "80_80", null, null);
                frameLayout2.addView(u9Var, w7.x5.e(80, 80, 48));
                ...
                j10 = j14;
                textView.setText(y7.R0(hg.k0.k((int) j14, ',', new StringBuilder("XTR ")), 0.85f, null));
                i12 = 0;
                ...
                m7 m7Var = new m7(context2, i19, I);
                w7.z5.a(m7Var);
                m7Var.setOnClickListener(new h6(m7Var, i12));
                viewGroup.addView(m7Var, w7.x5.d(-2, -2.0f, 53, 0.0f, 0.0f, -8.0f, 0.0f));
                ...
                g11.setMaxWidth(ci.f4.a(g11.getText(), g11.getPaint()));
                g11.setGravity(17);
                f7.addView(g11, w7.x5.t(-2, -2, 1, 0, 6, 0, 18));
                ci.d dVar = new ci.d(context2, I, r22);
                if (i10 <= 0) {
                    dVar.g(y7.Q0(AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("StarsConfirmSubscriptionButton", (int) j11))), i12, r22);
                } else {
                    dVar.g(y7.Q0(AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("StarsConfirmPurchaseButton", (int) j11))), i12, r22);
                }
                f7.addView(dVar, w7.x5.c(48.0f, -1));
                c90 c90Var = new c90(context2, I);
                c90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, I));
                c90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
                c90Var.setTextSize(r22, 14.0f);
                c90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i10 <= 0 ? R.string.StarsConfirmSubscriptionTOS : R.string.StarsConfirmPurchaseTOS), new di.a(context2, 8)));
                c90Var.setGravity(17);
                f7.addView(c90Var, w7.x5.k(0.0f, 12.0f, 0.0f, 2.0f, -1, -2));
                org.telegram.ui.ActionBar.g3 g3Var2 = g3Var;
                g3Var2.customView = f7;
                dVar.setOnClickListener(new xg.e(z4Var, g3Var2, dVar, 7));
                g3Var2.setOnDismissListener(new ai.g5(o31Var, 12));
                g3Var2.fixNavigationBar();
                g3Var2.show();
            }
            u9 u9Var3 = new u9(context2);
            u9Var3.setRoundRadius(AndroidUtilities.dp(80.0f));
            f9 f9Var2 = new f9((org.telegram.ui.ActionBar.f6) null);
            f9Var2.r(user3);
            u9Var3.e(user3, f9Var2);
            viewGroup.addView(u9Var3, w7.x5.e(80, 80, 17));
        } else {
            c7 c7Var2 = new c7(context2);
            c7Var2.H = new Path();
            c7Var2.I = new RectF();
            c7Var2.J = context2.getResources().getDrawable(R.drawable.large_locked_post).mutate();
            c7Var2.setRoundRadius(AndroidUtilities.dp(24.0f));
            ...
            if (tL_messageMediaPaidMedia2.extended_media.isEmpty()) {
                ...
                o31Var = o31Var2;
                i15 = 17;
                c7Var2.l(imageLocation, "80_80_b2", null, null, null, messageObject);
                messageObject2 = messageObject;
            }
            viewGroup.addView(c7Var2, w7.x5.e(i16, i16, i15));
        }
        j10 = j14;
        r22 = 1;
        i11 = -1;
        i12 = 0;
        m7 m7Var2 = new m7(context2, i19, I);
        w7.z5.a(m7Var2);
        m7Var2.setOnClickListener(new h6(m7Var2, i12));
        viewGroup.addView(m7Var2, w7.x5.d(-2, -2.0f, 53, 0.0f, 0.0f, -8.0f, 0.0f));
        f7.addView(viewGroup, w7.x5.q(i11, 117, 7));
        ...
        g112.setMaxWidth(ci.f4.a(g112.getText(), g112.getPaint()));
        g112.setGravity(17);
        ...
        c90 c90Var2 = new c90(context2, I);
        c90Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, I));
        c90Var2.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
        c90Var2.setTextSize(r22, 14.0f);
        c90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i10 <= 0 ? R.string.StarsConfirmSubscriptionTOS : R.string.StarsConfirmPurchaseTOS), new di.a(context2, 8)));
        c90Var2.setGravity(17);
        f7.addView(c90Var2, w7.x5.k(0.0f, 12.0f, 0.0f, 2.0f, -1, -2));
        org.telegram.ui.ActionBar.g3 g3Var22 = g3Var;
        g3Var22.customView = f7;
        dVar2.setOnClickListener(new xg.e(z4Var, g3Var22, dVar2, 7));
        g3Var22.setOnDismissListener(new ai.g5(o31Var, 12));
        g3Var22.fixNavigationBar();
        g3Var22.show();
    }
    ...
    public final void Z(final String str, final TLRPC.ChatInvite chatInvite, final Utilities.Callback2 callback2) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: yh.k4
            ...
            public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: yh.q4
                    ...
                    public final void run() {
                        ...
                        String str6 = str4;
                        org.telegram.ui.ActionBar.o2 R = LaunchActivity.R();
                        vc a02 = !AndroidUtilities.hasDialogOnTop(R) ? vc.a0(R) : vc.X();
                        int i10 = 0;
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 == null || !"BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                ...
                                hg.k0.s(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, a02, R.raw.error, 36);
                                return;
                            } else if (!MessagesController.getInstance(v5Var2.a).starsPurchaseAvailable()) {
                                callback23.run(0L, Boolean.FALSE);
                                v5.e0(context3, f6Var2);
                                return;
                            } else {
                                boolean[] zArr = {false};
                                n7 n7Var = new n7(context3, f6Var2, j11, 1, chatInvite3.title, new u(v5Var2, zArr, str6, chatInvite3, callback23, 3), 0L);
                                n7Var.setOnDismissListener(new w4(callback23, zArr, 0));
                                n7Var.show();
                                return;
                            }
                        }
                        TLRPC.TL_payments_paymentResult tL_payments_paymentResult = (TLRPC.TL_payments_paymentResult) tLObject2;
                        Utilities.stageQueue.postRunnable(new v4(v5Var2, tL_payments_paymentResult, i10));
    ...
    public final void a0(final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: yh.h5
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                final v5 v5Var = v5.this;
                    ...
                    */
                    public final void run() {
                        ...
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                if (!MessagesController.getInstance(v5Var2.a).starsPurchaseAvailable()) {
                                    ...
                                    boolean[] zArr = {false};
                                    n7 n7Var = new n7(context3, f6Var2, j14, 0, str6, new z8(v5Var2, zArr, messageObject3, inputInvoice3, tL_payments_paymentFormStars3, callback3, 21), j15);
                                    n7Var.setOnDismissListener(new org.telegram.ui.ActionBar.l3(callback3, zArr));
                                    n7Var.show();
                                    return;
                                }
                            }
                            if (tL_error2 != null && "FORM_EXPIRED".equals(tL_error2.text)) {
                                ...
                                ConnectionsManager.getInstance(v5Var2.a).sendRequest(tL_payments_getPaymentForm, new kd(v5Var2, messageObject3, inputInvoice3, callback3, X, 14));
                                return;
                            }
                            vc vcVar = X;
                            callback3.run(Boolean.FALSE);
                            hg.k0.s(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, vcVar, R.raw.error, 36);
                            if (messageObject3 != null) {
                                TLRPC.TL_messages_getExtendedMedia tL_messages_getExtendedMedia = new TLRPC.TL_messages_getExtendedMedia();
                                tL_messages_getExtendedMedia.peer = MessagesController.getInstance(v5Var2.a).getInputPeer(j15);
                                tL_messages_getExtendedMedia.id.add(Integer.valueOf(messageObject3.getId()));
                                ConnectionsManager.getInstance(v5Var2.a).sendRequest(tL_messages_getExtendedMedia, null);
                                return;
                            }
                            return;
                        }
                        callback3.run(Boolean.TRUE);
                        Utilities.stageQueue.postRunnable(new v4(v5Var2, (TLRPC.TL_payments_paymentResult) tLObject2, 4));
                        if (messageObject3 != null && (message2 = messageObject3.messageOwner) != null && (message2.media instanceof TLRPC.TL_messageMediaPaidMedia)) {
                            ...
                            X.getClass();
                            lc lcVar = new lc(X.W(), X.c);
                            lcVar.a.setImageDrawable(mutate);
                            lcVar.b.setText(string);
                            lcVar.c.setText(replaceTags);
                            X.b(lcVar, 2750).j();
                        } else {
                            if (i13 <= 0) {
                                z10 = true;
                                ...
                                if (messageObject3 == null) {
                                    ...
                                    tL_messages_getExtendedMedia2.peer = MessagesController.getInstance(v5Var2.a).getInputPeer(j15);
                                    tL_messages_getExtendedMedia2.id.add(Integer.valueOf(messageObject3.getId()));
                                    ConnectionsManager.getInstance(v5Var2.a).sendRequest(tL_messages_getExtendedMedia2, null);
                                    return;
                                }
                                return;
                            }
    ...
    */
    public final void d(MessageObject messageObject) {
        ...
        r5 r5Var2 = this.N;
        if (r5Var2 == null || r5Var2.g <= 0 || !r5Var2.m || r5Var2.n || r5Var2.o) {
            ...
            U = LaunchActivity.U();
            r5Var = this.N;
            if (r5Var != null && (r5Var.o || r5Var.n)) {
                this.N = null;
            }
            if (this.N != null) {
                if (U != null && !U.isRemovingFromStack()) {
                    r5 r5Var3 = this.N;
                    if (r5Var3.b == dialogId) {
                    }
                }
                this.N.a();
                this.N = null;
            ...
            if (this.N == null) {
                this.N = new r5(U, dialogId);
            }
            r5 r5Var4 = this.N;
            ic icVar = r5Var4.d;
            mc mcVar = r5Var4.e;
            q5 q5Var = r5Var4.p;
            if (r5Var4.n || r5Var4.o) {
                f0Var.run();
                return;
            }
            r5Var4.g++;
            r5Var4.k.add(messageObject);
            r5Var4.h += j3;
            r5Var4.i = i3Var;
            r5Var4.j.add(f0Var);
            if (r5Var4.m && !z10) {
                ...
                ocVar.j = 5000;
                ocVar.i(true);
                if (System.currentTimeMillis() - r5Var4.l > 500) {
                    mcVar.animate().alpha(0.0f).scaleX(0.3f).scaleY(0.3f).start();
                } else {
                    mcVar.setAlpha(0.0f);
            ...
            hc hcVar = r5Var4.f;
            if (hcVar != null && r5Var4.m) {
                hcVar.b = 3000L;
                AndroidUtilities.cancelRunOnUIThread(q5Var);
                AndroidUtilities.runOnUIThread(q5Var, 3000L);
            }
            org.telegram.ui.Components.n6 n6Var = icVar.b;
            int i10 = r5Var4.g;
            n6Var.setText(i10 == 1 ? LocaleController.getString(R.string.PaidMessageSentTitleOne) : LocaleController.formatPluralString("PaidMessageSentTitle", i10, new Object[0]));
            icVar.c.setText(AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("PaidMessageSentSubtitle", Math.max(0, (int) r5Var4.h))));
            icVar.a.d();
            return;
        }
        z10 = true;
    ...
    public final u5 d0(final MessageObject messageObject, final bo boVar, final long j3, boolean z10, boolean z11, final Long l4) {
        String str;
        long j10;
        final v5 v5Var;
        String str2;
        ...
        if (z11 && y3.e && y3.q(false, false, null).amount <= 0) {
            ...
            final int i11 = 0;
            new n7(t10, boVar.getResourceProvider(), j3, 5, str, new Runnable(this) { // from class: yh.a5
                ...
                public final void run() {
                    switch (i11) {
                        case 0:
                            this.b.d0(messageObject, boVar, j3, true, true, l4);
                            break;
                        default:
                            this.b.d0(messageObject, boVar, j3, true, true, l4);
                            break;
        ...
        u5 u5Var = this.B;
        if (u5Var == null || !u5Var.a.equals(b10)) {
            u5 u5Var2 = this.B;
            if (u5Var2 != null) {
                u5Var2.b();
            }
            ...
            j10 = 0;
            v5Var = this;
            u5 u5Var3 = new u5(v5Var, b10, messageObject, boVar, z10);
            v5Var.B = u5Var3;
            u5Var3.n = l4;
        } else {
            j10 = 0;
        ...
        if (v5Var.B.h + j3 > MessagesController.getInstance(i10).starsPaidReactionAmountMax) {
            v5Var.B.b();
            ConnectionsManager.getInstance(i10).getCurrentTime();
            v5Var.B = new u5(v5Var, b10, messageObject, boVar, z10);
        }
        ...
        if (z11 && y3.e && y3.q(false, false, null).amount < j11) {
            ...
            long a10 = boVar.a();
            if (a10 >= j10) {
                str2 = UserObject.getForcedFirstName(boVar.getMessagesController().getUser(Long.valueOf(a10)));
            } else {
                TLRPC.Chat chat2 = boVar.getMessagesController().getChat(Long.valueOf(-a10));
                str2 = chat2 != null ? chat2.title : "";
            }
            final int i12 = 1;
            new n7(t10, boVar.getResourceProvider(), j11, 5, str2, new Runnable(v5Var) { // from class: yh.a5
                public final /* synthetic */ v5 b;
                ...
                public final void run() {
                    switch (i12) {
                        case 0:
                            this.b.d0(messageObject, boVar, j11, true, true, l4);
                            break;
                        default:
                            this.b.d0(messageObject, boVar, j11, true, true, l4);
                            break;
        ...
        int i13 = v5Var2.a;
        ic icVar = u5Var4.e;
        MessageObject messageObject2 = u5Var4.b;
        if (!u5Var4.i && !u5Var4.j) {
            u5Var4.h += j3;
            System.currentTimeMillis();
            icVar.c.a();
            icVar.c.c(AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsSentText", (int) u5Var4.h, new Object[0])), true, true);
            if (u5Var4.m) {
                u5Var4.f.b = 5000L;
    ...
    public final void g(final long j3, final TLObject tLObject, final TLRPC.TL_textWithEntities tL_textWithEntities, final Utilities.Callback2 callback2) {
        ...
        if ((z10 || (tLObject instanceof TLRPC.TL_premiumGiftCodeOption)) && context2 != null) {
            ...
            ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: yh.p4
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: yh.r4
                        @Override // java.lang.Runnable
                        public final void run() {
                            ...
                            if (!z11) {
                                TLRPC.TL_error tL_error2 = tL_error;
                                v5.e(tL_error2 == null ? "NO_PAYMENT_FORM" : tL_error2.text);
                            ...
                            v5 v5Var2 = v5.this;
                            ConnectionsManager.getInstance(v5Var2.a).sendRequest(tL_payments_sendStarsForm, new t4(v5Var2, callback23, context3, f6Var, j11, str, j10, tLObject3, tL_textWithEntities2));
                        }
                    });
                }
            });
    ...
    public final void g0(LaunchActivity launchActivity, long j3, String str) {
        if (this.e) {
            ...
            r(new k21(this, launchActivity, j3, str, 13));
        }
    }
    ...
    public final void h(TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10, Utilities.Callback2 callback2) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_sendStarsForm, new t4(this, callback2, context2, I, j10, name, tL_payments_paymentFormStarGift, starGift, j3));
    }

    public final void h0(LaunchActivity launchActivity, long j3, String str) {
        if (p().amount < j3 && j3 > 0) {
            new n7(launchActivity, null, j3, 4, str, new p91(19), 0L).show();
            return;
        }
        org.telegram.ui.ActionBar.o2 U = LaunchActivity.U();
        if (U == null) {
        ...
        oc J = vc.a0(U).J(R.raw.stars_topup, LocaleController.getString(R.string.StarsTopupLinkEnough), LocaleController.getString(R.string.StarsTopupLinkTopupAnyway), new p91(18));
        J.j = 5000;
        J.k(true);
    }
    ...
    public final void i(final TL_stars.StarGift starGift, final boolean z10, final boolean z11, final long j3, final TLRPC.TL_textWithEntities tL_textWithEntities, final xh.m4 m4Var) {
        ...
        if (!this.e) {
            r(new Runnable() { // from class: yh.i4
                @Override // java.lang.Runnable
                public final void run() {
                    v5 v5Var = v5.this;
                    boolean z12 = v5Var.e;
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: yh.j4
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                final v5 v5Var = v5.this;
                ...
                final long j10 = j3;
                final TLRPC.TL_textWithEntities tL_textWithEntities2 = tL_textWithEntities;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: yh.s4
                    @Override // java.lang.Runnable
                    public final void run() {
                        TLObject tLObject2 = tLObject;
                        ...
                        ConnectionsManager connectionsManager = ConnectionsManager.getInstance(v5Var2.a);
                        ...
                        connectionsManager.sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: yh.x4
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(final TLObject tLObject3, final TLRPC.TL_error tL_error3) {
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: yh.g4
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        int i11;
                                        String str4;
                                        ...
                                        if (!z21) {
                                            if (tL_error4 != null && "BALANCE_TOO_LOW".equals(tL_error4.text)) {
                                                if (!MessagesController.getInstance(v5Var4.a).starsPurchaseAvailable()) {
                                                    m4Var5.run(Boolean.FALSE, null);
                                                    v5.e0(context6, f6Var4);
                                                    return;
                                                } else {
                                                    boolean[] zArr = {false};
                                                    n7 n7Var = new n7(context6, f6Var4, j15, 6, str5, new xa(v5Var4, zArr, starGift5, z19, z20, j16, tL_textWithEntities5, m4Var5), 0L);
                                                    n7Var.setOnDismissListener(new ei.e0(m4Var5, zArr, 16));
                                                    n7Var.show();
                                                    return;
                                                }
                                            }
                                            ...
                                            m4Var5.run(Boolean.FALSE, null);
                                            hg.k0.s(R.string.UnknownErrorCode, new Object[]{tL_error4 != null ? tL_error4.text : "FAILED_SEND_STARS"}, X, R.raw.error, 36);
                                            return;
                                        }
                                        Utilities.stageQueue.postRunnable(new v4(v5Var4, (TLRPC.TL_payments_paymentResult) tLObject4, i12));
                                        v5Var4.D = false;
                                        v5Var4.E = true;
                                        v5Var4.G = 0L;
                                        v5Var4.V();
                                        ...
                                        if (BirthdayController.getInstance(v5Var4.a).contains(j16)) {
                                            i11 = 0;
                                            MessagesController.getInstance(v5Var4.a).getMainSettings().edit().putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j16, false).apply();
                                        } else {
                                            i11 = 0;
                                        }
                                        ...
                                        if (j16 < 0) {
                                            long j17 = -j16;
                                            TLRPC.ChatFull chatFull = MessagesController.getInstance(v5Var4.a).getChatFull(j17);
                                            if (chatFull != null) {
                                                chatFull.stargifts_count++;
                                                chatFull.flags2 |= 262144;
                                                MessagesController.getInstance(v5Var4.a).putChatFull(chatFull);
                                            }
                                            ...
                                            NotificationCenter notificationCenter = NotificationCenter.getInstance(v5Var4.a);
                                            ...
                                            NotificationCenter.getInstance(v5Var4.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChatActivity, Long.valueOf(j16), bool);
                                            bo R9 = bo.R9(j16);
                                            R9.whenFullyVisible(new k21(R9, starGift5, spannableStringBuilder, j15, 12));
                                            R.presentFragment(R9);
                                        }
                                        MessagesController.getInstance(v5Var4.a).getMainSettings().edit().putBoolean("show_gift_for_" + j16, true).putBoolean(Calendar.getInstance().get(1) + "show_gift_for_" + j16, true).apply();
                                        LaunchActivity launchActivity = LaunchActivity.G1;
                                        if (launchActivity == null || (ib0Var = launchActivity.x0) == null) {
                                            return;
                                        }
    ...
    public final void i0(final long j3, final long j10, boolean z10, final boolean z11) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(togglenopaidmessagesexception, new RequestDelegate() { // from class: yh.b5
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new kg(v5.this, tLObject, j10, j3, z11));
            }
        });
    }
    ...
    public final void j0(String str, TLRPC.ChatInvite chatInvite, Utilities.Callback2 callback2) {
        ...
        if (chatInvite != null && chatInvite.subscription_pricing != null) {
            ...
            if (context2 != null) {
                ...
                boolean[] zArr = {false};
                i5 i5Var = new i5(this, j3, i11, zArr, callback2, context2, I, chatInvite, str);
                uh.i iVar = new uh.i(this, zArr, callback2);
                org.telegram.ui.ActionBar.g3 i12 = wl.i(1, context2, I, false);
                LinearLayout f7 = wl.f(context2, 1);
                f7.setPadding(AndroidUtilities.dp(16.0f), 0, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(8.0f));
                FrameLayout frameLayout = new FrameLayout(context2);
                frameLayout.addView(new a7(context2, 40, 0), w7.x5.c(-1.0f, -1));
                ...
                m7 m7Var = new m7(context2, i11, I);
                w7.z5.a(m7Var);
                m7Var.setOnClickListener(new h6(m7Var, 1));
                frameLayout.addView(m7Var, w7.x5.d(-2, -2.0f, 53, 0.0f, 0.0f, -8.0f, 0.0f));
                ...
                c90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.B6, I));
                c90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
                f7.addView(c90Var, w7.x5.t(-1, -2, 49, 14, 14, 14, 6));
                i12.customView = f7;
                dVar.setOnClickListener(new xg.e(i5Var, i12, dVar, 8));
                i12.setOnDismissListener(new ai.g5(iVar, 14));
    ...
    public final void l0(final MessageObject messageObject, final long j3, final Runnable runnable, final boolean z10) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_editMessage, new RequestDelegate() { // from class: yh.g5
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new bg(v5.this, tLObject, runnable, tL_error, z10, dialogId, id2, messageObject, j3));
            }
        });
    }
    ...
    public final TL_stars.SavedStarGift n(long j3) {
        ...
        while (true) {
            ...
            for (int i11 = 0; i11 < n5Var.l.size(); i11++) {
                TL_stars.SavedStarGift savedStarGift = (TL_stars.SavedStarGift) n5Var.l.get(i11);
    ...
    public final ArrayList u() {
        ...
        this.k = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stars.TL_payments_getStarsGiftOptions(), new y4(this, 3));
        return this.m;
    }
    ...
    public final ArrayList v() {
        ...
        this.n = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stars.TL_payments_getStarsGiveawayOptions(), new y4(this, 4));
        return this.p;
    }
    ...
    public final ArrayList z() {
        ...
        this.h = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stars.TL_payments_getStarsTopupOptions(), new y4(this, 2));
        return this.j;
    }
}
