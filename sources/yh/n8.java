...
public abstract class n8 extends View {
    ...
    public n8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.K = paint;
        this.L = new h01(LocaleController.getString(R.string.StarsReactionTop), 14.0f, AndroidUtilities.getTypeface("fonts/rcondensedbold.ttf"));
        qr qrVar = qr.h;
    ...
    public final void a(float f7) {
        ...
        m6Var.b();
        m6Var.q(y7.V0(false, LocaleController.formatNumber(c(f7), ','), this.J), true, true);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        k8Var.g(rectF2);
        float f11 = this.c0;
        k8Var.h = (f11 * 15.0f) + 1.0f;
        k8Var.j = (int) (k8Var.b.size() * ((f11 * 0.85f) + 0.15f));
        k8Var.d();
        canvas.save();
        ...
        if (j3 == -1 || b((int) j3) >= 1.0f || b((int) this.P) <= 0.0f) {
            ...
            float f12 = (clamp01 + h01Var.c) + ((float) (AndroidUtilities.dp(16.0f) * 2)) > rectF2.right ? (clamp01 - lerp) - h01Var.c : clamp01 + lerp;
        ...
        if (j10 == -1 || b((int) j10) >= 1.0f || b((int) this.P) <= 0.0f) {
            ...
            float f13 = (h01Var.c + dp3) + ((float) (AndroidUtilities.dp(16.0f) * 2)) > rectF2.right ? (dp3 - lerp2) - h01Var.c : lerp2 + dp3;
        ...
        k8 k8Var2 = this.n;
        k8Var2.g(rectF7);
        k8Var2.h = (this.c0 * 15.0f) + 1.0f;
        k8Var2.d();
        canvas2.save();
        k8Var2.a(canvas2, i11);
        canvas2.restore();
        canvas2.save();
        ...
        if (motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.j0) {
            ...
            if (this.k0) {
                ...
                if (getValue() != value) {
                    ...
                    org.telegram.ui.Components.m6 m6Var = this.H;
                    m6Var.b();
                    m6Var.q(y7.V0(false, LocaleController.formatNumber(getValue(), ','), this.J), true, true);
                }
                this.g0 = motionEvent.getX();
                return true;
            }
    ...
    public final void f(int i10, int i11, boolean z10) {
        ...
        this.v.addListener(new m8(this, i12, i10, i13, i11));
