...
public final class d4 extends View {
    ...
    public final void a() {
        ...
        if (getMessageObject() != null) {
            ...
            bo boVar = this.a;
            u5 y3 = u5.y(boVar.getCurrentAccount(), false);
            long E = y3.E(messageObject);
            if (!y3.e || y3.q(false, false, null).amount >= E) {
                return;
            }
            t5 t5Var = u5.y(boVar.getCurrentAccount(), false).B;
            if (t5Var != null) {
                t5Var.a();
            }
            long a2 = boVar.a();
            ...
            new m7(boVar.getParentActivity(), boVar.getResourceProvider(), E, 5, str, new j21(this, y3, messageObject, E, 9), 0L).show();
        }
    }

    public final void b(float f7, c4 c4Var) {
        ...
        this.E.addListener(new ai.t2(this, f7, c4Var, 4));
    ...
    public final void d(float f7, float f10, boolean z10) {
        ...
        if (z10) {
            ...
            u5.y(boVar.getCurrentAccount(), false).d0(messageObject, this.a, 1L, true, false, null);
        }
        ...
        this.r = true;
        c4 c4Var = this.H;
        AndroidUtilities.cancelRunOnUIThread(c4Var);
        AndroidUtilities.runOnUIThread(c4Var, 1500L);
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (a0Var3 instanceof org.telegram.ui.Cells.t1) {
            ...
            org.telegram.ui.ActionBar.e6 e6Var = w0Var.Y0;
            if (e6Var != null) {
                f10 = 255.0f;
            ...
            if (l4 != null) {
                ...
                while (true) {
                    ...
                    if (xi0Var.a0 >= xi0Var.e[c11]) {
                        arrayList.remove(i12);
                        i12--;
                    } else {
                        float f15 = dp / 2.0f;
                        xi0Var.setBounds((int) (((AndroidUtilities.dp(15.0f) * lerp) + rectF.left) - f15), (int) (rectF.centerY() - f15), (int) org.telegram.ui.Cells.q3.a(AndroidUtilities.dp(15.0f), lerp, rectF.left, f15), (int) (rectF.centerY() + f15));
                ...
                org.telegram.ui.Components.m6 m6Var = this.v;
                m6Var.w = (int) (e * f10);
                m6Var.p(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.5f), org.telegram.ui.ActionBar.i6.l1(e, -1442840576));
    ...
    public void setMessageCell(org.telegram.ui.Cells.a0 a0Var) {
        ...
        if (a0Var3 instanceof org.telegram.ui.Cells.t1) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.t1) this.b).setInvalidateListener(new c4(this, 1));
        } else if (a0Var3 instanceof org.telegram.ui.Cells.w0) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.w0) this.b).setInvalidateListener(new c4(this, 1));
        }
        invalidate();
    }
}
