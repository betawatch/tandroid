...
public final /* synthetic */ class w4 implements Utilities.Callback {
    ...
    public /* synthetic */ w4(s5 s5Var, long j3, boolean[] zArr, Utilities.Callback callback, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, String str, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, int i10, long j10) {
        this.a = s5Var;
        this.b = j3;
        this.c = zArr;
        this.d = callback;
    ...
    public final void run(Object obj) {
        ...
        if (starsPurchaseAvailable) {
            boolean[] zArr2 = {false};
            l7 l7Var = new l7(context, d6Var, j10, this.g ? 9 : 0, this.h, new jb(s5Var, zArr2, messageObject, inputInvoice, tL_payments_paymentFormStars, zArr, i10, callback2, callback), this.m);
