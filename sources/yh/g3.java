...
public final class g3 {
    ...
    public final f3 d(boolean z10) {
        ...
        while (true) {
            ...
            if (i11 != this.n && ((f3) arrayList.get(i11)).b()) {
    ...
    public final float f(float f7, boolean z10) {
        ...
        if (lerp >= 0.0f) {
            double d = lerp;
            if (Math.floor(d) + 1.0d > this.e && (f3Var = this.c) != f3Var2) {
                this.b = f3Var;
                f3 f3Var3 = this.d;
                this.c = f3Var3;
                this.d = f3Var3 == f3Var2 ? null : d(z10);
                this.e = ((int) Math.floor(d)) + 1;
            }
        }
        return this.c == f3Var2 ? Math.min(lerp, this.e + 0.5f) : lerp;
    }
}
