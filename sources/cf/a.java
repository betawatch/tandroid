        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (tLObject != null) {
                    ...
                    while (it.hasNext()) {
                        Collections.sort((List) it.next(), new Comparator() { // from class: cg.i0
                    ...
                    AndroidUtilities.runOnUIThread(new androidx.car.app.utils.a(f2Var, hashMap, arrayList, 4));
                    break;
                }
                break;
            case 3:
                ...
                if (tLObject != null) {
                    ...
                    while (it2.hasNext()) {
                        Collections.sort((List) it2.next(), new Comparator() { // from class: cg.i0
                            @Override // java.util.Comparator
                            public final int compare(Object obj2, Object obj3) {
                    ...
                    AndroidUtilities.runOnUIThread(new androidx.car.app.utils.a(n0Var, hashMap2, arrayList2, 7));
                    break;
                }
                break;
            case 4:
