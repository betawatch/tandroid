...
public abstract class f5 {
        ...
        while (it.hasNext()) {
            ...
            if (pageBlock != null) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                    SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(i6.r(pageBlock.text, pageBlock, true));
                    ...
                    if (z10 || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                        spannableStringBuilder = h(i6.r(pageBlock.text, pageBlock, true), z10 ? ((TL_iv.pageBlockBlockquote) pageBlock).caption : ((TL_iv.pageBlockPullquote) pageBlock).caption);
                        ...
                        if (arrayList4 != null && !arrayList4.isEmpty()) {
                            ...
                            while (i10 < size) {
                                ...
                                SpannableStringBuilder r11 = pageListItem2 instanceof TL_iv.TL_pageListItemText ? i6.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true) : pageListItem2 instanceof TL_iv.TL_pageListItemBlocks ? c(((TL_iv.TL_pageListItemBlocks) pageListItem2).blocks) : null;
                                if (r11 != null) {
                        ...
                        SpannableStringBuilder r13 = i6.r(pageblocktable.title, null, true);
                            ...
                            while (i12 < size3) {
                                ...
                                if (arrayList10 != null && !arrayList10.isEmpty()) {
                                    ...
                                    for (int i13 = 0; i13 < pagetablerow2.cells.size(); i13++) {
                                        ...
                                        spannableStringBuilder5.append((CharSequence) i6.r(pagetablerow2.cells.get(i13).text, null, true));
                                    }
                        ...
                        spannableStringBuilder = i6.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                        ...
                        spannableStringBuilder = i6.r(pageBlock.text, pageBlock, true);
                    } else if (pageBlock.caption != null) {
                        SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder();
                        SpannableStringBuilder r14 = i6.r(pageBlock.caption.text, null, true);
                        if (!TextUtils.isEmpty(r14)) {
                            spannableStringBuilder6.append((CharSequence) r14);
                        }
                        SpannableStringBuilder r15 = i6.r(pageBlock.caption.credit, null, true);
    ...
    public static SpannableStringBuilder i(a aVar, boolean z10) {
        ...
        if (z10) {
            TL_iv.PageBlock pageBlock = aVar.b;
            r10 = i6.r(pageBlock != null ? pageBlock.text : null, pageBlock, false);
        } else {
            TL_iv.PageBlock pageBlock2 = aVar.b;
            r10 = i6.r(pageBlock2 != null ? pageBlock2.text : null, pageBlock2, true);
        }
        ...
        while (list != null && i10 < list.size()) {
            ...
            if (aVar.k.isEmpty()) {
                ...
                if ((pageBlock instanceof TL_iv.pageBlockBlockquote) || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(z10 ? i6.r(pageBlock.text, pageBlock, false) : i6.r(pageBlock.text, pageBlock, true));
                    TL_iv.PageBlock pageBlock2 = aVar.b;
