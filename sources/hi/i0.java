...
public final class i0 extends b0 implements org.telegram.ui.ActionBar.a6 {
    ...
    public i0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        final int i11 = 0;
        c2Var.setOnClickListener(new View.OnClickListener(this) { // from class: hi.e0
            ...
            public final void onClick(View view) {
                ...
                switch (i11) {
                    case 0:
                        i0 i0Var = this.b;
                        g0 g0Var = i0Var.E;
                        if (g0Var != null && (aVar = i0Var.a) != null) {
                            z3 z3Var = ((r3) g0Var).a;
                            z3Var.n3(false);
                            z3Var.h3.t(new w3(z3Var, aVar, -1), view);
                            break;
                        }
                        break;
                    default:
                        i0 i0Var2 = this.b;
                        g0 g0Var2 = i0Var2.E;
                        if (g0Var2 != null && (aVar2 = i0Var2.a) != null) {
                            z3 z3Var2 = ((r3) g0Var2).a;
                            z3Var2.n3(false);
                            z3Var2.h3.t(new w3(z3Var2, aVar2, -1), view);
                            break;
                        }
                        break;
                }
        ...
        final int i12 = 1;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: hi.e0
            public final /* synthetic */ i0 b;
    ...
    */
    public final void i() {
        ...
        if (aVar != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockButtonRow) {
                ...
                i10 = 0;
                while (i10 < size) {
                    f0 f0Var = new f0(this, getContext(), pageblockbuttonrow.buttons.get(i10), i10);
                    arrayList2.add(f0Var);
                    linearLayout.addView(f0Var, w7.a6.t(-2, -1, 16, i10 == 0 ? 0 : 7, 0, 0, 0));
                    i10++;
                }
                boolean z10 = size >= 8;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (size2 > 0) {
            ...
            if (size3 != 0) {
                ...
                for (int i17 = 0; i17 < size3; i17++) {
                    ...
                    f0Var.getClass();
                    int max3 = Math.max(AndroidUtilities.dp(34.0f), f0Var.a.getPreferredWidth());
                    iArr[i17] = max3;
                    i16 += max3;
                }
                if (i16 <= max2) {
                    ...
                    for (int i27 = 0; i27 < size3; i27++) {
                        int i28 = iArr[i27];
                        f0 f0Var2 = (f0) arrayList.get(i27);
                        f0Var2.getClass();
                        i26 += i28 - Math.max(AndroidUtilities.dp(34.0f), f0Var2.a.getMinWidth());
                    }
                    if (i26 <= 0) {
                        for (int i29 = 0; i29 < size3; i29++) {
                            f0 f0Var3 = (f0) arrayList.get(i29);
                            f0Var3.getClass();
                            iArr[i29] = Math.max(AndroidUtilities.dp(34.0f), f0Var3.a.getMinWidth());
                        }
                    } else {
                        ...
                        while (i30 < size3) {
                            int i32 = iArr[i30];
                            f0 f0Var4 = (f0) arrayList.get(i30);
                            f0Var4.getClass();
                            int max4 = i32 - Math.max(AndroidUtilities.dp(34.0f), f0Var4.a.getMinWidth());
                            if (i30 == i15) {
                                i13 = min - i31;
                                i12 = min;
                            } else {
                ...
                for (int i33 = 0; i33 < size3; i33++) {
                    f0 f0Var5 = (f0) arrayList.get(i33);
                    int i34 = iArr[i33];
                    RichMessageLayout.RichButton richButton = f0Var5.a;
        ...
        if (size2 > 0) {
            dp = ((f0) arrayList.get(0)).a.getHeight();
