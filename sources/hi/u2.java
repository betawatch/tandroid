...
public final /* synthetic */ class u2 implements Runnable {
    ...
    public /* synthetic */ u2(Activity activity, int i10, TLRPC.InputGroupCall inputGroupCall, boolean z10, TLRPC.GroupCall groupCall, HashSet hashSet) {
        this.a = 4;
        this.d = activity;
        this.b = i10;
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
                            ...
                            try {
                                ...
                                if (extractMetadata2 != null) {
                                    try {
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: hi.x2
                                            @Override // java.lang.Runnable
                                            public final void run() {
                                                z3 z3Var2 = z3.this;
                                                z3Var2.getClass();
                                                ...
                                                a aVar2 = aVar;
                                                if (aVar2 == null || !z3.C3(aVar2.b)) {
                                                    z3Var2.e2(photoEntry);
                                                } else {
                                                    z3Var2.S1(aVar2, photoEntry);
                                                }
                                            }
                                        });
                                        return;
                ...
                while (true) {
                    ...
                    if (i23 >= length) {
                        if (z12) {
                            ...
                            AndroidUtilities.runOnUIThread(new org.telegram.messenger.voip.o0(iw0Var, this.c, i24, t1Var));
                            return;
                        }
                    }
                    if (i23 <= 2) {
                        if (rLottieNativeArr2[i23] == null) {
                            ...
                            if (TextUtils.isEmpty(readRes)) {
                                ...
                                AndroidUtilities.runOnUIThread(new hw0(document, i24, messageObject, t1Var, tL_messages_stickerSet, 0));
                                z12 = true;
                            }
                        }
            ...
            case 4:
                ...
                org.telegram.ui.Components.voip.e2.g(activity, this.b, inputGroupCall, this.c, groupCall, hashSet);
                return;
            default:
    ...
    public /* synthetic */ u2(z3 z3Var, Uri uri, boolean z10, String str, int i10, a aVar) {
        this.a = 0;
        this.d = z3Var;
        this.e = uri;
        this.c = z10;
    ...
    public /* synthetic */ u2(Object obj, TLObject tLObject, int i10, Object obj2, Object obj3, boolean z10, int i11) {
        this.a = i11;
        this.d = obj;
        this.e = tLObject;
        this.b = i10;
    ...
    public /* synthetic */ u2(ContactsController contactsController, int i10, ArrayList arrayList, ArrayList arrayList2, a0.i iVar, boolean z10) {
        this.a = 1;
    ...
    public /* synthetic */ u2(br0 br0Var, String str, int i10, TLObject tLObject, boolean z10, TLRPC.User user) {
        this.a = 5;
        this.d = br0Var;
        this.f = str;
        this.b = i10;
