...
public final class y extends ab {
    ...
    public y(int i10, Context context, Utilities.Callback callback, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        w7.c6.a(imageView);
        final int i13 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: hi.w
            ...
            public final void onClick(View view) {
                switch (i13) {
                    ...
                    default:
                        y yVar = this.b;
                        org.telegram.ui.Cells.i3 i3Var = yVar.e0;
                        if (!yVar.g0) {
                            ...
                            if (richMessage == null) {
                                ...
                                if (!TextUtils.isEmpty(trim)) {
                                    ...
                                    yVar.h0 = ConnectionsManager.getInstance(yVar.X).sendRequest(tL_messages_composeRichMessageWithAI, new bi.c2(yVar, 13));
        ...
        final int i15 = 1;
        g10.setOnClickListener(new View.OnClickListener(this) { // from class: hi.w
            public final /* synthetic */ y b;
            ...
            public final void onClick(View view) {
                switch (i15) {
                    ...
                    default:
                        y yVar = this.b;
                        org.telegram.ui.Cells.i3 i3Var2 = yVar.e0;
                        if (!yVar.g0) {
                            TL_iv.RichMessage richMessage = yVar.i0;
                            if (richMessage == null) {
