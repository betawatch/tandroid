...
public final /* synthetic */ class l implements Runnable {
    ...
    public /* synthetic */ l(Object obj, Object obj2, Object obj3, Object obj4, Object obj5, Object obj6, Object obj7, Object obj8, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
        this.d = obj3;
        ...
        switch (this.a) {
            case 0:
                ...
                if (!TextUtils.isEmpty(strArr[0].trim())) {
                    ...
                    aVar.run(str, new Utilities.Callback2() { // from class: hi.d
            ...
            case 3:
                ...
                org.telegram.ui.ActionBar.p2 p2Var = (org.telegram.ui.ActionBar.p2) this.n;
                ...
                if (tL_error == null) {
                    if (tLObject != null) {
                        BillingController.getInstance().addResultListener(((c5.o) list.get(0)).c, new bi.h6(3, hVar, vVar2));
            ...
            case 4:
                ...
                org.telegram.ui.ActionBar.p2 p2Var2 = (org.telegram.ui.ActionBar.p2) this.n;
                ...
                if (tL_error2 == null) {
                    if (tLObject2 != null) {
                        BillingController.getInstance().addResultListener(((c5.o) list2.get(0)).c, new bi.h6(2, hVar2, callback2));
            ...
            case 5:
                ...
                if (!(tLObject3 instanceof TLRPC.TL_boolTrue)) {
                    if (!(tLObject3 instanceof TLRPC.TL_boolFalse)) {
                        k6Var.run(Boolean.FALSE, tL_error3 != null ? tL_error3.text : "SERVER_ERROR");
                        break;
                    } else {
                    ...
                    BillingController.getInstance().addResultListener(oVar.c, new bi.h6(5, hVar3, k6Var));
            ...
            default:
                ...
                if (!(tLObject4 instanceof TLRPC.TL_boolTrue)) {
                    if (!(tLObject4 instanceof TLRPC.TL_boolFalse)) {
                        n80Var.run(Boolean.FALSE, tL_error4 != null ? tL_error4.text : "SERVER_ERROR");
                        break;
                    } else {
                    ...
                    BillingController.getInstance().addResultListener(oVar2.c, new bi.h6(4, hVar4, n80Var));
    ...
    public /* synthetic */ l(UserInfoActivity userInfoActivity, TLRPC.TL_error tL_error, TLObject tLObject, TL_account.TL_birthday tL_birthday, TLRPC.UserFull userFull, TLObject tLObject2, int[] iArr, ArrayList arrayList) {
        this.a = 2;
