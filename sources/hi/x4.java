...
public final class x4 extends b0 implements org.telegram.ui.ActionBar.a6, r9, n0 {
    ...
    private void settle(float f7) {
        ...
        if (f7 >= 0.0f || this.W >= size - 1) {
            ...
            this.i0.addUpdateListener(new ai.a(this, 14));
            this.i0.addListener(new di.y2(this, i11, 2));
            this.i0.start();
        }
        i10 = 1;
        int i112 = i10 + this.W;
        ...
        this.i0.setInterpolator(wr.h);
        this.i0.addUpdateListener(new ai.a(this, 14));
        this.i0.addListener(new di.y2(this, i112, 2));
        this.i0.start();
    }
    ...
    public final ImageView h() {
        ...
        if (!this.H || Build.VERSION.SDK_INT < 31) {
            ...
            imageView.setBackground(new f2(org.telegram.ui.ActionBar.j6.Z(org.telegram.ui.ActionBar.j6.v0(i11, f6Var), org.telegram.ui.ActionBar.j6.v(org.telegram.ui.ActionBar.j6.v0(i11, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, f6Var)), 20, 20)));
        } else {
    ...
    public final void j(Canvas canvas) {
        ...
        Paint paint = x4Var.r;
        if (z10 && (((i10 = x4Var.W) == 0 && x4Var.a0 < 0.0f) || (i10 == arrayList.size() - 1 && x4Var.a0 > 0.0f))) {
        ...
        if (size == 1 && arrayList2.size() == 1) {
            ...
            if (rectF.left > 0.5f || rectF.right < max - 0.5f) {
                ...
                ImageReceiver imageReceiver = a5Var.b;
                if (a5Var.b()) {
                    imageReceiver.setImageCoords(rectF2);
                    imageReceiver.setAlpha(a5Var.a.getCurrentAlpha());
        ...
        while (i13 < arrayList.size() && i13 < arrayList2.size()) {
            a5 a5Var2 = (a5) arrayList.get(i13);
            ...
            if (z10) {
                ...
                int i17 = i13 == 0 ? dp : 0;
                a5Var2.a.setRoundRadius(i14, i15, i16, i17);
                a5Var2.b.setRoundRadius(i14, i15, i16, i17);
            } else {
                a5Var2.a.setRoundRadius(i11, i11, i11, i11);
                a5Var2.b.setRoundRadius(i11, i11, i11, i11);
            }
            boolean c10 = a5Var2.c();
            ImageReceiver imageReceiver2 = a5Var2.a;
            if (!c10) {
            ...
            if (vVar != null && vVar.a()) {
                ...
                radialProgress2.o(a5Var2.e.f, true);
                radialProgress2.draw(canvas2);
            }
            v vVar2 = a5Var2.e;
            if (vVar2 != null && vVar2.n && a5Var2.c()) {
                uh.g spoilerEffect = x4Var.getSpoilerEffect();
                ImageReceiver imageReceiver3 = a5Var2.b;
                canvas2.save();
    ...
    public final void k(int i10) {
        ...
        List m10 = m();
        if (m10.isEmpty() || (m10.size() == 1 && ((v) m10.get(0)).a == 0)) {
            s3 s3Var = this.N;
            a aVar = this.a;
            z3 z3Var = s3Var.a;
            z3Var.b4 = aVar;
        ...
        z3.M1(this.a, (v) m10.get(i10), this.N.a);
    }
    ...
    public final void n() {
        ...
        while (true) {
            ...
            if (this.O) {
                a5Var.a.onAttachedToWindow();
                a5Var.b.onAttachedToWindow();
                a5Var.a();
            }
            arrayList.add(a5Var);
        }
        while (arrayList.size() > m10.size()) {
            ...
            a5Var2.a.onDetachedFromWindow();
            a5Var2.b.onDetachedFromWindow();
            a5Var2.c = null;
        }
        ...
        while (arrayList2.size() > m10.size()) {
            ImageView imageView = (ImageView) hc.b.z(1, arrayList2);
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            a5 a5Var = (a5) arrayList.get(i10);
            a5Var.a.onDetachedFromWindow();
            a5Var.b.onDetachedFromWindow();
            a5Var.c = null;
            i10++;
        }
        uh.g gVar = this.M;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (arrayList.size() >= 2 && f12 > 0.001f) {
            ...
            int dp2 = AndroidUtilities.dp(4.0f) + org.telegram.messenger.a2.D(6.0f, size - 1, AndroidUtilities.dp(7.0f) * size);
        ...
        s3 s3Var = this.N;
        if (s3Var != null && (textSelectionHelper = s3Var.a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int dp = f8.b(this.a) > 0 ? AndroidUtilities.dp(16.0f) : 0;
        ...
        while (true) {
            ...
            if (i18 < m10.size() && ((v) m10.get(i18)).a != 0) {
        ...
        if (size3 == 0) {
            ...
            if (size3 != 1) {
                ...
                for (int i22 = 0; i22 < size3; i22++) {
                    a5 a5Var = (a5) arrayList3.get(i22);
                    int i23 = a5Var.e == null ? 0 : a5Var.d() ? a5Var.e.k : a5Var.e.j;
                    if (a5Var.e == null) {
                        i18 = 0;
                    } else {
                        boolean d10 = a5Var.d();
                        v vVar = a5Var.e;
                        i18 = d10 ? vVar.j : vVar.k;
                    }
                ...
                for (int i45 = 0; i45 < size3; i45++) {
                    a5 a5Var2 = (a5) arrayList3.get(i45);
                    int i46 = a5Var2.e == null ? 0 : a5Var2.d() ? a5Var2.e.k : a5Var2.e.j;
                    if (a5Var2.e == null) {
                        i14 = 0;
                    } else {
                        boolean d11 = a5Var2.d();
                        v vVar2 = a5Var2.e;
                        i14 = d11 ? vVar2.j : vVar2.k;
                    }
                ...
                int dp4 = f8.b(this.a) <= 0 ? AndroidUtilities.dp(16.0f) : 0;
            ...
            a5 a5Var3 = (a5) arrayList3.get(0);
            int i48 = a5Var3.e == null ? 0 : a5Var3.d() ? a5Var3.e.k : a5Var3.e.j;
            if (a5Var3.e == null) {
                i19 = 0;
            } else {
                boolean d12 = a5Var3.d();
                v vVar3 = a5Var3.e;
                i19 = d12 ? vVar3.j : vVar3.k;
            }
            if (i48 <= 0 || i19 <= 0) {
