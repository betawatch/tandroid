...
public final class g2 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean W(g2 g2Var, View view) {
        eo eoVar = g2Var.J;
        if (eoVar != null && g2Var.r == null && !eoVar.c() && g2Var.P.j3() && !g2Var.P.l3()) {
            if (!g2Var.P.L3()) {
                g2Var.B0();
                return false;
            }
            ...
            if (!Y2.isEmpty()) {
                ...
                long a2 = g2Var.J.a();
                MessageObject messageObject = g2Var.J.n5;
                ...
                g2Var.y0.setScaleX(1.0f);
                g2Var.y0.setScaleY(1.0f);
                xg r10 = g2Var.O0.r(g2Var.y0, true, new m1(g2Var, 10));
                if (r10 != null) {
                ...
                w70 H = w70.H(g2Var, g2Var.y0);
                boolean isUserSelf = UserObject.isUserSelf(g2Var.J.i());
                if (g2Var.J.D6()) {
                    H.c(R.drawable.msg_calendar2, LocaleController.getString(isUserSelf ? R.string.SetReminder : R.string.ScheduleMessage), new va(g2Var, a2, 6), false);
                    if (!isUserSelf && a2 > 0) {
    ...
    public static /* synthetic */ void X(g2 g2Var, MessageObject messageObject, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, long j3, MessageObject messageObject2, MessageObject messageObject3, boolean z10, int i10, int i11, SendMessageChatArguments sendMessageChatArguments, long j10) {
    ...
    public static void Y(final g2 g2Var, Context context, View view) {
        w70 w70Var;
        boolean z10;
        w70 w70Var2 = g2Var.x0;
        if (w70Var2 != null) {
            w70Var2.u();
            g2Var.x0 = null;
        }
        boolean z11 = (MessagesController.getInstance(g2Var.currentAccount).richEditorAllowed() || UserConfig.getInstance(g2Var.currentAccount).isPremium()) ? false : true;
        ...
        J.k();
        final int i10 = 0;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading1), R.drawable.iv_h1, null, LocaleController.getString(R.string.ArticleHeading1), new Runnable(g2Var) { // from class: hi.q1
        ...
        final int i11 = 1;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading2), R.drawable.iv_h2, null, LocaleController.getString(R.string.ArticleHeading2), new Runnable(g2Var) { // from class: hi.q1
            public final /* synthetic */ g2 b;
        ...
        final int i12 = 2;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading3), R.drawable.iv_h3, null, LocaleController.getString(R.string.ArticleHeading3), new Runnable(g2Var) { // from class: hi.q1
            public final /* synthetic */ g2 b;
        ...
        final int i13 = 3;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading4), R.drawable.iv_h4, null, LocaleController.getString(R.string.ArticleHeading4), new Runnable(g2Var) { // from class: hi.q1
            public final /* synthetic */ g2 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 1);
        final int i14 = 4;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading5), R.drawable.iv_h5, null, LocaleController.getString(R.string.ArticleHeading5), new Runnable(g2Var) { // from class: hi.q1
            public final /* synthetic */ g2 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 2);
        final int i15 = 5;
        J.j(P2 != null && (P2.b instanceof TL_iv.pageBlockHeading6), R.drawable.iv_h6, null, LocaleController.getString(R.string.ArticleHeading6), new Runnable(g2Var) { // from class: hi.q1
            public final /* synthetic */ g2 b;
        ...
        e2Var.d = i16;
        I.j(z10, 0, e2Var, LocaleController.getString(R.string.ArticleHeading), new di.p2(I, w70Var, 2));
        ...
        I.j(P2 != null && (P2.b instanceof TL_iv.pageBlockParagraph), R.drawable.iv_text2, null, LocaleController.getString(R.string.ArticleText), new p1(g2Var, P2, 3));
        I.j(P2 != null && (P2.b instanceof TL_iv.pageBlockBlockquote), R.drawable.iv_quote, null, LocaleController.getString(R.string.ArticleQuote), new p1(g2Var, P2, 4));
        boolean z12 = P2 != null && (P2.b instanceof TL_iv.pageBlockPullquote);
        e2 e2Var2 = new e2(context, R.drawable.iv_pullquote);
        e2Var2.a(z11);
        e2Var2.d = i16;
        I.j(z12, 0, e2Var2, LocaleController.getString(R.string.ArticlePullquote), new p1(g2Var, P2, 0));
        I.y().setPadding(AndroidUtilities.dp(LocaleController.isRTL ? 18.0f : 9.0f), 0, AndroidUtilities.dp(LocaleController.isRTL ? 9.0f : 18.0f), 0);
        I.j(P2 != null && (P2.b instanceof TL_iv.pageBlockPreformatted), R.drawable.iv_code, null, LocaleController.getString(R.string.ArticleCode), new p1(g2Var, P2, 1));
        boolean z13 = P2 != null && (P2.b instanceof TL_iv.pageBlockFooter);
        e2 e2Var3 = new e2(context, R.drawable.iv_footer);
        e2Var3.a(z11);
        e2Var3.d = i16;
        I.j(z13, 0, e2Var3, LocaleController.getString(R.string.ArticleFooter), new p1(g2Var, P2, 2));
        I.y().setPadding(AndroidUtilities.dp(LocaleController.isRTL ? 18.0f : 9.0f), 0, AndroidUtilities.dp(LocaleController.isRTL ? 9.0f : 18.0f), 0);
        I.Z();
        g2Var.x0 = I;
    }
    ...
    public static void Z(g2 g2Var, boolean z10, boolean z11) {
        ...
        if (z11) {
            g2Var.w0.animate().scaleX(f7).scaleY(f7).setDuration(180L).setInterpolator(wr.h).start();
        } else {
            g2Var.w0.animate().cancel();
            g2Var.w0.setScaleX(f7);
            g2Var.w0.setScaleY(f7);
        }
        g2Var.w0.setColorFilter(new PorterDuffColorFilter(g2Var.getThemedColor(z10 ? org.telegram.ui.ActionBar.j6.q7 : org.telegram.ui.ActionBar.j6.G6), PorterDuff.Mode.SRC_IN));
        hj0 animatedDrawable = g2Var.w0.getAnimatedDrawable();
    ...
    public static k1 a0(g2 g2Var) {
        ...
        if (focusedEditTextOrNull == null) {
            k1 k1Var = g2Var.R0;
            return k1Var != null ? k1Var : g2Var.P.O2();
        }
    ...
    public static int b0(g2 g2Var, k1 k1Var) {
        return (k1Var != g2Var.R0 || g2Var.P.getFocusedEditTextOrNull() == k1Var) ? Math.max(0, k1Var.getSelectionEnd()) : Math.min(g2Var.S0, k1Var.length());
    }
    ...
    public static void p0(Context context, final Runnable runnable, final Runnable runnable2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        i11.show();
        g11.setOnClickListener(new View.OnClickListener() { // from class: hi.o1
        ...
        final int i13 = 1;
        g12.setOnClickListener(new View.OnClickListener() { // from class: hi.o1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                switch (i13) {
                    case 0:
    ...
    public final c2 c0(int i10, int i11, boolean z10) {
        c2 c2Var = new c2(this.e0.getContext(), i10, getResourceProvider());
        if (z10) {
            c2Var.d();
            this.N.add(c2Var);
        }
        ...
        linearLayout.addView(c2Var, w7.a6.t(38, 38, 16, linearLayout.getChildCount() == 0 ? 0 : 2, 0, 0, 0));
        return c2Var;
    }
    ...
    public final View createView(Context context) {
        ...
        this.P = z3Var;
        z3Var.setFileRefParentObject(this.r);
        ...
        if (richMessage != null) {
            z3 z3Var2 = this.P;
            ArrayList arrayList2 = z3Var2.l3;
            z3Var2.k3 = richMessage;
            z3.V2(arrayList2, richMessage.blocks, z3Var2.m3);
            z3Var2.U3();
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                z3Var2.u4((a) arrayList2.get(i10));
            }
            z3Var2.Y2.N(false);
        } else {
            String str = this.f;
            if (str != null) {
                ...
                HashMap hashMap = z3Var3.m3;
                ArrayList arrayList3 = z3Var3.l3;
        ...
        imageView3.setBackground(new f2(org.telegram.ui.ActionBar.j6.Z(themedColor, org.telegram.ui.ActionBar.j6.v(themedColor2, getThemedColor(i12)), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f))));
        ...
        this.U.setBackground(new f2(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        ...
        this.Z.addView(this.a0, w7.a6.e(-1, 60, 87));
        ...
        this.c0.setBackground(new f2(org.telegram.ui.ActionBar.j6.Z(getThemedColor(i11), org.telegram.ui.ActionBar.j6.v(getThemedColor(i11), getThemedColor(i12)), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f))));
        this.a0.addView(this.c0, w7.a6.p(44, 44, 0.0f, 19, 0, 0, 8, 0));
        w7.c6.a(this.c0);
        this.c0.setContentDescription(LocaleController.getString(R.string.AIEditor));
        this.c0.setOnClickListener(new m1(this, 4));
        FrameLayout frameLayout5 = new FrameLayout(context);
        frameLayout5.setClipToPadding(false);
        frameLayout5.setClipChildren(false);
        FrameLayout frameLayout6 = new FrameLayout(context);
        frameLayout6.setBackground(new f2(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        frameLayout5.addView(frameLayout6, w7.a6.e(-2, 44, 81));
        z1 z1Var = new z1(context, 0);
        this.d0 = z1Var;
        z1Var.setClipToOutline(true);
        this.d0.setOutlineProvider(new bi.g(2));
        ...
        frameLayout6.addView(this.d0, w7.a6.c(-1.0f, -1));
        ...
        this.e0.addView(this.g0, w7.a6.t(38, 38, 16, 2, 0, 0, 0));
        w7.c6.a(this.g0);
        this.g0.setContentDescription(LocaleController.getString(R.string.AccDescrAttachButton));
        this.g0.setOnClickListener(new m1(this, 9));
        this.a0.addView(frameLayout5, w7.a6.l(1.0f, 0, 44));
        ...
        this.Y.addView(this.h0, w7.a6.e(-2, 60, 81));
        ...
        this.Y.addView(this.v0, w7.a6.e(80, 60, 81));
        ...
        this.w0.setBackground(new f2(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.v0.addView(this.w0, w7.a6.e(-1, -1, 119));
        FrameLayout frameLayout8 = new FrameLayout(context);
        frameLayout8.setBackground(new f2(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.h0.addView(frameLayout8, w7.a6.c(44.0f, -2));
        a2 a2Var = new a2(this, context);
        this.j0 = a2Var;
        a2Var.setHorizontalScrollBarEnabled(false);
        this.j0.setClipToOutline(true);
        this.j0.setOutlineProvider(new bi.g(3));
        frameLayout8.addView(this.j0, w7.a6.c(-1.0f, -1));
        ...
        this.u0.setOnClickListener(new m1(this, 11));
        LinearLayout linearLayout5 = this.i0;
        linearLayout5.addView(this.u0, w7.a6.t(38, 38, 16, linearLayout5.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
        c2 c2Var2 = new c2(context, R.drawable.iv_button, getResourceProvider());
        this.r0 = c2Var2;
        c2Var2.setContentDescription(LocaleController.getString(R.string.RichEditorButton));
        this.r0.setOnClickListener(new m1(this, 12));
        LinearLayout linearLayout6 = this.i0;
        linearLayout6.addView(this.r0, w7.a6.t(38, 38, 16, linearLayout6.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
        LinearLayout linearLayout7 = new LinearLayout(context);
        this.n0 = linearLayout7;
        linearLayout7.setOrientation(0);
        this.n0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.n0.setBackground(new f2(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.h0.addView(this.n0, w7.a6.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        c2 c2Var3 = new c2(context, R.drawable.media_link_24, getResourceProvider());
        this.q0 = c2Var3;
        c2Var3.setContentDescription(LocaleController.getString(R.string.CreateLink));
        this.q0.setOnClickListener(new m1(this, 13));
        this.n0.addView(this.q0, w7.a6.q(38, 38, 16));
        c2 c2Var4 = new c2(context, R.drawable.msg_calendar2, getResourceProvider());
        this.s0 = c2Var4;
        c2Var4.setContentDescription(LocaleController.getString(R.string.AccDescrIVInsertDate));
        this.s0.setOnClickListener(new m1(this, 14));
        this.n0.addView(this.s0, w7.a6.q(38, 38, 16));
        LinearLayout linearLayout8 = new LinearLayout(context);
        this.o0 = linearLayout8;
        linearLayout8.setOrientation(0);
        this.o0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.o0.setBackground(new f2(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.h0.addView(this.o0, w7.a6.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        c2 c2Var5 = new c2(context, R.drawable.iv_math, getResourceProvider());
        this.t0 = c2Var5;
        c2Var5.d();
        arrayList.add(this.t0);
        this.t0.setContentDescription(LocaleController.getString(R.string.AccDescrIVFormula));
        this.t0.setOnClickListener(new m1(this, 15));
        this.o0.addView(this.t0, w7.a6.q(38, 38, 16));
        LinearLayout linearLayout9 = new LinearLayout(context);
        this.m0 = linearLayout9;
        linearLayout9.setOrientation(0);
        this.m0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.m0.setBackground(new f2(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.h0.addView(this.m0, 0, w7.a6.d(-2, 44.0f, 80, 0.0f, 0.0f, 8.0f, 0.0f));
        c2 c2Var6 = new c2(context, 0, getResourceProvider());
        this.p0 = c2Var6;
        ...
        this.p0.setOnClickListener(new m1(this, 16));
        this.m0.addView(this.p0, w7.a6.q(38, 38, 16));
        b2 b2Var = new b2((Object) this, context, this.r != null ? R.drawable.input_done : l0() ? R.drawable.input_schedule : R.drawable.send_plane_24, getResourceProvider(), 0);
        this.y0 = b2Var;
        ...
        w7.c6.a(this.y0);
        this.a0.addView(this.y0, w7.a6.p(44, 44, 0.0f, 5, 8, 0, 0, 0));
        this.y0.setContentDescription(LocaleController.getString(R.string.Send));
        this.y0.setOnClickListener(new m1(this, 0));
        this.y0.setOnLongClickListener(new bi.l6(this, 3));
        C0();
    ...
    public final void d0(Context context, int i10, int i11, boolean z10) {
        ...
        linearLayout.addView(c2Var, w7.a6.t(38, 38, 16, linearLayout.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
    }
    ...
    public final boolean l0() {
        eo eoVar;
        return this.r == null && (eoVar = this.J) != null && eoVar.c();
    }
    ...
    public final AnimatorSet onCustomTransitionAnimation(boolean z10, Runnable runnable) {
        ...
        this.E = true;
        this.O.invalidate();
        ofFloat.addUpdateListener(new n1(this, i10));
    ...
    public final void onTransitionAnimationStart(boolean z10, boolean z11) {
        ...
        if (z10 && !z11 && (i10 = this.c) >= 0 && (z3Var2 = this.P) != null) {
            int i11 = this.d;
            this.d = -1;
            this.c = -1;
        ...
        if ((this.b == null && this.f == null) || (z3Var = this.P) == null || z3Var.Z2()) {
            return;
        }
    ...
    public final boolean q0() {
        ...
        if (i22 != null && !this.M) {
            z3 z3Var = this.P;
            if (z3Var.j3() && !f5.f(z3Var.l3, z3Var.m3) && okVar != null) {
                ...
                if (eoVar != null) {
                    ...
                    MediaDataController.getInstance(okVar.Q).saveDraft(eoVar.a(), eoVar.B7(eoVar.n5), charSequenceArr[0], MediaDataController.getInstance(okVar.Q).getEntities(charSequenceArr, true, false), null, null, null, 0L, false, false, null);
                }
        ...
        long a2 = this.J.a();
        eo eoVar2 = this.J;
        mediaDataController.saveDraft(a2, eoVar2.B7(eoVar2.n5), "", null, null, null, null, 0L, false, false, i22);
    ...
    /* JADX WARN: Type inference failed for: r0v19, types: [hi.r1] */
    public final void s0(final int i10, final int i11, final boolean z10) {
        ...
        if (!MessagesController.getInstance(this.currentAccount).richEditorAllowed()) {
            ...
            okVar.R0(f5.k(this.P.l3), z10, i10, i11);
            finishFragment();
            return;
        }
        this.M = true;
        ...
        eo eoVar = this.J;
        final MessageObject messageObject = eoVar.n5;
        ...
        ?? r02 = new Runnable() { // from class: hi.r1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
                    ...
                    if (!(pageBlock instanceof TL_iv.pageBlockDetails)) {
                        if (!(pageBlock instanceof TL_iv.pageBlockTable)) {
                            ...
                            while (i11 < size) {
                                ...
                                c2Var.setSelected(i10 == intValue);
                                if (i10 == intValue) {
    ...
    public final void x0(int i10, boolean z10) {
        ...
        if (z10) {
            ...
            this.h0.animate().alpha(this.K0 == 1 ? 1.0f : 0.0f).scaleX(this.K0 == 1 ? 1.0f : 0.8f).scaleY(this.K0 == 1 ? 1.0f : 0.8f).translationY(this.K0 == 1 ? 0.0f : AndroidUtilities.dp(30.0f)).setDuration(420L).setInterpolator(wrVar).withEndAction(new l1(this, 2)).start();
            this.v0.setVisibility(0);
            this.v0.animate().alpha(this.K0 == 2 ? 1.0f : 0.0f).scaleX(this.K0 == 2 ? 1.0f : 0.8f).scaleY(this.K0 == 2 ? 1.0f : 0.8f).setDuration(420L).setInterpolator(wrVar).withEndAction(new l1(this, 3)).start();
            return;
        }
    ...
    public final void y0() {
        ...
        if (c2Var != null) {
            z3 z3Var = this.P;
            int[] A4 = z3Var.A4();
            c2Var.setSelected(A4 != null && z3Var.G3(A4[0], A4[1]));
        }
        if (this.P.K3()) {
        ...
        if (this.P.v3()) {
            ...
            k1 r22 = this.P.r2(textSelectionHelper3.u0);
            ...
            while (i18 < size2) {
                ...
                i18++;
                c2 c2Var5 = (c2) obj2;
                c2Var5.setSelected((r22 == null || max3 >= max4 || (((Integer) c2Var5.getTag()).intValue() & r22.getCurrentStyle(max3, max4)) == 0) ? false : true);
            }
            c2 c2Var6 = this.q0;
            if (c2Var6 != null) {
                c2Var6.setSelected(r22 != null && max3 < max4 && i6.h(r22.getText(), max3, max4));
            }
            c2 c2Var7 = this.s0;
            if (c2Var7 != null) {
        ...
        while (i23 < size3) {
            ...
            c2Var8.setSelected(z14 && this.P.I3(((Integer) c2Var8.getTag()).intValue(), i19, i21, i20, i22));
            i23 = i24;
        }
        t0(!this.P.H3());
        c2 c2Var9 = this.q0;
