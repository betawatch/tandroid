...
public final class l2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, l2 l2Var) {
        ...
        l2Var.a = i6.l(richText).length() + l2Var.a;
    ...
    public static void b(TL_iv.PageBlock pageBlock, int i10, l2 l2Var) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            ...
            l2Var.b = pageblockblockquoteblocks.blocks.size() + l2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockDetails) {
            ...
            l2Var.b = pageblockdetails.blocks.size() + l2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockList) {
            ...
            l2Var.b = pageblocklist.items.size() + l2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            l2Var.b = pageblockorderedlist.items.size() + l2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockTable) {
            ...
            if (arrayList3 != null) {
                l2Var.b = arrayList3.size() + l2Var.b;
