...
public final class k1 extends fu {
    ...
    @Override // org.telegram.ui.Components.fu, org.telegram.ui.ActionBar.y4
    ...
    public final boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        } else if (keyEvent.getAction() == 0 && (j1Var = this.c) != null) {
    ...
    public final void onDetachedFromWindow() {
        ...
        if (text != null) {
            for (n4 n4Var : (n4[]) text.getSpans(0, text.length(), n4.class)) {
                ...
                if (richButtonSpan != null && n4Var.c == this) {
    ...
    public final boolean onTextContextMenuItem(int i10) {
        j1 j1Var;
        j1 j1Var2;
        if (i10 == 16908319 && (j1Var2 = this.c) != null && j1Var2.f()) {
            return true;
        }
        if (i10 == 16908322 && (j1Var = this.c) != null && j1Var.F(this)) {
            return true;
        }
        ...
        if (!this.v) {
            ...
            if (action == 0) {
                ...
                if (n4Var != null) {
                    ...
                    boolean z11 = motionEvent.getAction() != 3 && o(motionEvent.getX(), motionEvent.getY()) == n4Var;
                    if (!z11 || z10) {
                ...
                if (motionEvent.getAction() == 1) {
                    ...
                    if (f7 <= i11 * i11 && motionEvent.getEventTime() - this.P < ViewConfiguration.getLongPressTimeout()) {
                        ...
                        if (uVar != null) {
                            s.U(getContext(), uVar.a, new bi.y2(19, this, uVar), this.e);
                            return true;
                        }
                    }
                }
