...
public final class c1 extends b0 implements org.telegram.ui.ActionBar.a6, r9, n0, DownloadController.FileDownloadProgressListener {
    ...
    public final void h(TLRPC.Document document) {
        ...
        v vVar;
        a aVar = this.a;
        String str2 = (aVar == null || (vVar = aVar.g) == null) ? null : vVar.e;
        ...
        u3 u3Var = this.S;
        MessageObject messageObject = u3Var == null ? null : u3Var.a.i3;
        imageReceiver.setImageCoords(this.K, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(86.0f), AndroidUtilities.dp(86.0f));
    ...
    public final boolean j() {
        v vVar;
        a aVar = this.a;
        return (aVar == null || (vVar = aVar.g) == null || !vVar.a()) ? false : true;
    }
    ...
    public final void k() {
        ...
        if (TextUtils.isEmpty(documentFileName) && (vVar = this.a.g) != null && !TextUtils.isEmpty(vVar.e)) {
        ...
        if (j3 <= 0) {
            v vVar2 = this.a.g;
            j3 = (vVar2 == null || TextUtils.isEmpty(vVar2.e)) ? 0L : new File(this.a.g.e).length();
        }
    ...
    */
    public final void l(boolean z10) {
        ...
        a aVar = this.a;
        if (aVar != null && (vVar = aVar.g) != null && !TextUtils.isEmpty(vVar.e)) {
                    ...
                    if (z10) {
                        ...
                        if (j()) {
                            ...
                            if (u3Var != null) {
                                a aVar = this.a;
                                z3 z3Var = u3Var.a;
                                d5 d5Var = (d5) z3Var.Z3.remove(aVar.g);
                                if (d5Var != null) {
                                    d5Var.b();
                                }
                                k2 k2Var = z3Var.J3;
                            ...
                            if (i10 == 0) {
                                ...
                                if (i10 == 1 && i() != null) {
                                    u3 u3Var2 = this.S;
                                    MessageObject messageObject2 = u3Var2 != null ? u3Var2.a.i3 : null;
