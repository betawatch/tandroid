...
public final class l6 {
    ...
    public l6(TL_iv.pageBlockTable pageblocktable) {
    ...
    public final void j(final IdentityHashMap identityHashMap, int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            ...
            Collections.sort(arrayList, Comparator$-CC.comparingInt(new ToIntFunction() { // from class: hi.k6
    ...
    public final boolean p(TL_iv.pageTableCell pagetablecell) {
        ...
        if (b10 >= 0 && a2 >= 0) {
            ...
            if (i11 > 1 || i12 > 1) {
                ...
                for (int i13 = b10; i13 < b10 + i11 && i13 < this.b; i13++) {
                    TL_iv.pageTableRow pagetablerow = this.a.rows.get(i13);
                    ArrayList arrayList = new ArrayList();
                    ArrayList<TL_iv.pageTableCell> arrayList2 = pagetablerow.cells;
                    int size = arrayList2.size();
                    int i14 = 0;
                    while (i14 < size) {
                        TL_iv.pageTableCell pagetablecell2 = arrayList2.get(i14);
                        i14++;
                    ...
                    for (int i15 = a2; i15 < a2 + i12; i15++) {
                        if (i13 != b10 || i15 != a2) {
                            ...
                            c(pagetablecell4, "");
                            arrayList.add(new Object[]{pagetablecell4, Integer.valueOf(i15)});
                        }
                    }
                    Collections.sort(arrayList, Comparator$-CC.comparingInt(new j6(i10)));
