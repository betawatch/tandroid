...
public final class d5 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public d5(int i10, String str, boolean z10, int i11, int i12, int i13, l3 l3Var) {
        this.a = i10;
        this.b = str;
        this.c = z10;
        this.d = false;
    ...
    public final void c(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2) {
        ...
        this.y = ConnectionsManager.getInstance(this.a).sendRequest(tL_messages_uploadMedia, new bi.c2(this, 14));
    }
    ...
    public final void d() {
        ...
        if (this.e) {
            Utilities.globalQueue.postRunnable(new b5(this, 0));
            return;
        }
        if (this.d) {
            a(this.b);
        ...
        Utilities.globalQueue.postRunnable(new b5(this, 1));
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploadProgressChanged) {
            ...
            c5Var.f(longValue2 > 0 ? longValue / longValue2 : 0.0f);
        }
    }
    ...
    public d5(int i10, String str, TLRPC.Document document, j3 j3Var) {
        this.a = i10;
        this.b = str;
        this.c = false;
        this.d = true;
    ...
    public d5(int i10, String str, TLRPC.Document document, i3 i3Var) {
        this.a = i10;
        this.b = str;
        this.c = false;
        this.d = false;
