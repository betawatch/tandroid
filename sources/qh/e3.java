    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (hj0Var != null) {
            if (this.e0) {
                ...
                hj0Var.setBounds((int) f20, (int) (f21 - f22), (int) (f20 + this.c0), (int) (f22 + f21));
                ...
                hj0Var.setBounds((int) (f23 - this.c0), (int) (f24 - f25), (int) f23, (int) (f25 + f24));
                f11 = 0.0f;
            }
        ...
        if (this.F) {
            ...
            float f26 = ((f11 + rectF.left) + rectF2.left) - e3Var.K;
            e3Var.O = f26;
        ...
        if (e3Var.r) {
            ...
            e3Var.n.setAlpha((int) (f12 * f10));
            e3Var.n.setBounds((int) ((rectF.right - (rectF2.right * 0.66f)) - r1.getIntrinsicWidth()), (int) (rectF.centerY() - (e3Var.n.getIntrinsicHeight() / 2.0f)), (int) (rectF.right - (rectF2.right * 0.66f)), (int) ((e3Var.n.getIntrinsicHeight() / 2.0f) + rectF.centerY()));
            e3Var.n.draw(canvas2);
        }
        canvas2.restore();
    }
    ...
    */
    ...
    public final void u() {
        ...
        if (this.S && this.R) {
            ...
            this.k0.addListener(new i2(this, i10));
