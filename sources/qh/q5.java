...
public final class q5 extends View implements b2 {
    ...
    public q5(Activity activity) {
        ...
        this.I0 = new n5(this, 2);
        this.J0 = new n5(this, 3);
        this.K0 = new Path();
        this.L0 = new Path();
        this.M0 = new PointF();
        this.N0 = new PointF();
    ...
    public final boolean dispatchHoverEvent(MotionEvent motionEvent) {
        p5 p5Var = this.T;
        if (p5Var == null || !p5Var.f(motionEvent)) {
    ...
    public final void h() {
        ...
        if (o5Var != null) {
            ...
            if (arrayList2 != null && !arrayList2.isEmpty() && ((r6) arrayList2.get(0)).O0 != null) {
                this.b.setImage(ImageLocation.getForPath(((r6) arrayList2.get(0)).O0.getAbsolutePath()), "80_80", null, null, this.c, 0L, null, null, 0);
                return;
            }
        }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (Math.abs(clamp - this.f0) < AndroidUtilities.dp(50.0f)) {
                AndroidUtilities.runOnUIThread(n5Var2, ViewConfiguration.getLongPressTimeout());
            }
            if (rcVar3.h) {
                AndroidUtilities.runOnUIThread(n5Var, ViewConfiguration.getLongPressTimeout());
            }
        } else {
            if (action == 2) {
                if (this.t0) {
                    ...
                    if (this.o0 && this.w0) {
                        ...
                        ba baVar = ((x8) this.a).a;
                        baVar.S0.b(clamp2, true);
                        baVar.j0(false);
                    }
                }
                return false;
            ...
            if (action == 1 || action == 3) {
                if (this.t0) {
                    this.t0 = false;
                    this.u0 = false;
                    AndroidUtilities.cancelRunOnUIThread(n5Var2);
                    AndroidUtilities.cancelRunOnUIThread(n5Var);
                    boolean z11 = this.o0;
                    if (!z11 && rcVar.h) {
                        ba baVar2 = ((x8) this.a).a;
                        if (baVar2.c0 == 0 && !baVar2.M1 && !baVar2.N1 && ba.b(baVar2)) {
                            baVar2.f(true);
                        }
                    } else if (z11 && this.w0) {
                        if (rcVar.h) {
                        ...
                        if (b()) {
                            ...
                            this.r0 = true;
                            ((x8) this.a).d(false);
                        } else if (ba.d(((x8) this.a).a)) {
                            this.O = 0L;
                            this.N = System.currentTimeMillis();
                            this.x0 = false;
                            ((x8) this.a).e(new n5(this, 1), false);
                        }
                    }
                    this.w0 = false;
                    if (rcVar3.h) {
    ...
    public void setDelegate(o5 o5Var) {
        this.a = o5Var;
    }
