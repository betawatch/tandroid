...
public final class a6 extends View {
    ...
    public final void a() {
        ...
        this.r = new k01(z5Var.b(), 16.0f, AndroidUtilities.bold());
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        k01 k01Var = this.r;
        if (k01Var == null || this.s == null || e6 <= 0.0f) {
            return;
        }
        ...
        k01 k01Var2 = this.r;
        k01Var2.c(rectF.left + (this.n ? dp5 + dp3 + dp5 : 0.0f) + f10, (k01Var2.j() / f11) + centerY, e6, -1, canvas);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (rcVar.h && (g8Var = this.c) != null && this.B != null) {
    ...
    public void setLink(String str) {
        ...
        z5 z5Var = this.B;
        if (!(z5Var == null && this.E == null) && (z5Var == null || TextUtils.equals(z5Var.a, str) || TextUtils.equals(this.F, str))) {
            z5 z5Var2 = this.B;
            if (z5Var2 == null || this.y || !TextUtils.equals(z5Var2.a, str)) {
                return;
            }
            this.y = true;
            a();
