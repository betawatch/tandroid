...
public final class ka extends Path {
    ...
    public final void a(float f10, float f11, float f12, float f13, float f14, float f15, ArrayList arrayList) {
        ...
        if (Math.abs(this.e - f13) <= 1.0f && Math.abs(this.f - f14) <= 0.01f && Math.abs(this.g - 0.0f) <= 0.1f && Math.abs(this.h - f15) <= 1.0f && Math.abs(this.i - f16) <= 1.0f && Math.abs(this.j - f11) <= 1.0f && Math.abs(this.k - f17) <= 1.0f) {
            ...
            if (arrayList2 != null && arrayList2.size() == arrayList.size()) {
                for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                    if (((Integer) arrayList2.get(i10)).intValue() == (arrayList.get(i10) == null ? 0 : ((ea) arrayList.get(i10)).b)) {
                    }
                }
            }
            ...
            for (int i11 = 0; i11 < arrayList3.size(); i11++) {
                if (((Float) arrayList3.get(i11)).floatValue() != (arrayList.get(i11) == null ? 0.0f : ((ea) arrayList.get(i11)).a.d(((ea) arrayList.get(i11)).c, false))) {
                    return;
                }
            }
        }
        ...
        while (i12 < arrayList.size()) {
            i12 = yh.d(arrayList.get(i12) == null ? 0 : ((ea) arrayList.get(i12)).b, i12, 1, this.c);
        }
        ...
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            this.d.add(Float.valueOf(arrayList.get(i13) == null ? 0.0f : ((ea) arrayList.get(i13)).a.d(((ea) arrayList.get(i13)).c, false)));
        }
        this.i = f16;
        this.j = f11;
        this.k = f17;
        ...
        for (int i15 = 0; i15 < arrayList.size(); i15++) {
            if (arrayList.get(i15) != null) {
                i14 = Math.max(i14, ((ea) arrayList.get(i15)).b);
            }
        }
        ...
        while (max <= min) {
            ...
            for (int i17 = 0; i17 < arrayList.size(); i17++) {
                short s6 = (arrayList.get(i17) == null || max >= ((ea) arrayList.get(i17)).b) ? (short) 0 : ((ea) arrayList.get(i17)).d[max];
    ...
    public final void b(float f10, float f11, float f12, float f13, long j10, float f14, float f15, float f16, ea eaVar) {
        ArrayList arrayList;
        float f17 = f10;
        float f18 = f11;
        float f19 = f12;
        ...
        int i10 = eaVar.b;
        org.telegram.ui.Components.z5 z5Var = eaVar.a;
        float d = z5Var.d(eaVar.c, false);
        ...
        this.e = f14;
        this.h = f16;
        float d10 = z5Var.d(eaVar.c, false);
        rewind();
        float round = Math.round(AndroidUtilities.dpf2(3.3333f));
        ...
        while (max <= min) {
            ...
            float f21 = f15 <= 0.0f ? 0.0f : (eaVar.d[max] / f15) * f14 * 0.6f;
