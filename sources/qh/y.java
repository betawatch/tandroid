    ...
    */
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (k7.o6.a(motionEvent.getX(), motionEvent.getY(), this.S, this.T) > AndroidUtilities.touchSlop * 1.2f && (wVar = this.f0) != null) {
                AndroidUtilities.cancelRunOnUIThread(wVar);
                this.f0 = null;
            }
            if (!this.b0 && getFilledProgress() >= 1.0f && this.d0 != null && xVar != null && k7.o6.a(motionEvent.getX(), motionEvent.getY(), this.S, this.T) > AndroidUtilities.touchSlop * 1.2f) {
                this.b0 = true;
                this.e0 = this.d0;
                this.W = 0.0f;
                this.U = 0.0f;
    ...
    */
    ...
    public ArrayList<Integer> getOrder() {
        ...
        while (true) {
            ...
            i10 = yh.d(((x) arrayList2.get(i10)).a, i10, 1, arrayList);
        }
    }
