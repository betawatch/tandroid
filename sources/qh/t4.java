...
public abstract class t4 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i12 < size) {
            ...
            fi0 fi0Var = (spanned == null || span != null) ? 0 : (fi0) a(spanned, i13, i14, fi0.class);
            if (span == null && fi0Var == 0) {
                ...
                CodeHighlighting.Span span2 = span != null ? span : fi0Var;
                while (true) {
                    if (i12 >= size) {
                        i9 = length;
                        break;
                    ...
                    if ((span != null ? a(spanned, i15, length, CodeHighlighting.Span.class) : a(spanned, i15, length, fi0.class)) != span2) {
                        break;
                    }
                    i14 = length;
                    i12 = i16;
                ...
                if (span != null) {
                    ...
                    pageblockblockquote.collapsed = fi0Var != 0 && fi0Var.e;
        ...
        while (it.hasNext()) {
            ...
            if (pageBlock != null) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                    SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(u5.r(pageBlock.text, pageBlock, true));
                    ...
                    if (z10 || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                        spannableStringBuilder = h(u5.r(pageBlock.text, pageBlock, true), z10 ? ((TL_iv.pageBlockBlockquote) pageBlock).caption : ((TL_iv.pageBlockPullquote) pageBlock).caption);
                        ...
                        if (arrayList4 != null && !arrayList4.isEmpty()) {
                            ...
                            while (i9 < size) {
                                ...
                                SpannableStringBuilder r11 = pageListItem2 instanceof TL_iv.TL_pageListItemText ? u5.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true) : pageListItem2 instanceof TL_iv.TL_pageListItemBlocks ? c(((TL_iv.TL_pageListItemBlocks) pageListItem2).blocks) : null;
                                if (r11 != null) {
                        ...
                        SpannableStringBuilder r13 = u5.r(pageblocktable.title, null, true);
                            ...
                            while (i11 < size3) {
                                ...
                                if (arrayList10 != null && !arrayList10.isEmpty()) {
                                    ...
                                    for (int i12 = 0; i12 < pagetablerow2.cells.size(); i12++) {
                                        ...
                                        spannableStringBuilder5.append((CharSequence) u5.r(pagetablerow2.cells.get(i12).text, null, true));
                                    }
                        ...
                        spannableStringBuilder = u5.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                        ...
                        spannableStringBuilder = u5.r(pageBlock.text, pageBlock, true);
                    } else if (pageBlock.caption != null) {
                        SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder();
                        SpannableStringBuilder r14 = u5.r(pageBlock.caption.text, null, true);
                        if (!TextUtils.isEmpty(r14)) {
                            spannableStringBuilder6.append((CharSequence) r14);
                        }
                        SpannableStringBuilder r15 = u5.r(pageBlock.caption.credit, null, true);
    ...
    public static SpannableStringBuilder i(a aVar, boolean z10) {
        ...
        if (z10) {
            TL_iv.PageBlock pageBlock = aVar.b;
            r10 = u5.r(pageBlock != null ? pageBlock.text : null, pageBlock, false);
        } else {
            TL_iv.PageBlock pageBlock2 = aVar.b;
            r10 = u5.r(pageBlock2 != null ? pageBlock2.text : null, pageBlock2, true);
        }
        ...
        while (list != null && i9 < list.size()) {
            ...
            if (aVar.k.isEmpty()) {
                ...
                if ((pageBlock instanceof TL_iv.pageBlockBlockquote) || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(z10 ? u5.r(pageBlock.text, pageBlock, false) : u5.r(pageBlock.text, pageBlock, true));
                    TL_iv.PageBlock pageBlock2 = aVar.b;
                    boolean z11 = (pageBlock2 instanceof TL_iv.pageBlockBlockquote) && ((TL_iv.pageBlockBlockquote) pageBlock2).collapsed;
                    if (spannableStringBuilder.length() > 0) {
                        fi0.b(spannableStringBuilder, 0, spannableStringBuilder.length(), z11);
                    }
                    arrayList.add(spannableStringBuilder);
                } else {
                ...
                int i10 = i9;
                while (i10 < list.size() && !((a) list.get(i10)).k.isEmpty() && ((Long) ((a) list.get(i10)).k.get(0)).longValue() == longValue) {
                    if (i10 > i9) {
                        spannableStringBuilder2.append('\n');
                    }
                    spannableStringBuilder2.append((CharSequence) i((a) list.get(i10), z10));
                    i10++;
                }
                if (spannableStringBuilder2.length() > 0) {
                    fi0.b(spannableStringBuilder2, 0, spannableStringBuilder2.length(), false);
    ...
    public static CharSequence l(int i9, SpannableStringBuilder spannableStringBuilder) {
        ...
        vz0 vz0Var = new vz0();
        vz0Var.a = i9;
        spannableStringBuilder2.setSpan(new wz0(vz0Var, 0), 0, spannableStringBuilder2.length(), 33);
        return spannableStringBuilder2;
    }
}
