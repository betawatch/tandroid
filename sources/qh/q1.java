...
public final class q1 extends xu0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        x1 x1Var = this.v0;
        Rect rect = x1Var.w;
        int l1 = f6.l1(x1Var.E, x1Var.getThemedColor(f6.d6));
        Paint paint = this.t0;
        paint.setColor(l1);
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (!x1Var.L.j3.y() || !x1Var.L.k3.onTouchEvent(motionEvent)) {
            int height = (!x1Var.y0 || (wyVar = x1Var.w0) == null) ? (getHeight() - AndroidUtilities.dp(60.0f)) - Math.max(Math.max(x1Var.z0, x1Var.P0), x1Var.Q0) : (int) wyVar.getY();
