...
public final class w7 extends FrameLayout implements View.OnClickListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b(int i10) {
        ...
        if (i10 == 4) {
            ...
            arrayList.addAll(c8Var.n);
            hashMap.putAll(c8Var.r);
        } else if (i10 == 6) {
            a(false);
        }
        this.n.getClass();
    ...
    public final void e(boolean z4) {
        ...
        if (i11 == 0) {
            ...
            if (c8Var.I) {
                ...
                int i13 = c8Var.F;
                if (i13 == 1) {
                    dVar2.g(LocaleController.getString(c8Var.H ? R.string.StoryLivePrivacyButtonPost : R.string.StoryPrivacyButtonPost), z4, true);
                } else {
        ...
        if (i11 != 6) {
            if (i11 == 4) {
                int size2 = c8.l1(c8Var.d, c8Var.e).size();
                c8Var.f = size2;
                dVar2.g(LocaleController.getString(R.string.StoryPrivacyButtonSave), z4, true);
                dVar2.setShowZero(false);
                u7Var.b(false, z4);
    ...
    public final void f(boolean z4) {
        ...
        if (this.a == 3 && (c8Var.K != 3 || (arrayList6.isEmpty() && hashMap3.isEmpty()))) {
            ...
            if (m7Var != null) {
                ...
                if (i13 > 0) {
                    ...
                    if (user != null) {
                        ...
                        m7Var.k = contains;
                        m7Var.l = !contains && l1.contains(Long.valueOf(m7Var.g.id));
                    } else {
                        TLRPC.Chat chat = m7Var.h;
                        if (chat != null) {
                            m7Var.k = hashMap3.containsKey(Long.valueOf(chat.id));
                            m7Var.l = false;
                        }
                    }
                }
        ...
        while (true) {
            ...
            if ((childAt instanceof b8) && (R = RecyclerView.R(childAt)) >= 0 && R < arrayList.size()) {
                ...
                b8 b8Var = (b8) childAt;
                b8Var.c(m7Var2.k || m7Var2.l, z4);
                TLRPC.Chat chat2 = m7Var2.h;
                if (chat2 != null) {
                    b8Var.b(c8.d1(c8Var, chat2) > 200 ? 0.3f : 1.0f, z4);
                } else {
                    if (m7Var2.l && !m7Var2.k) {
                        r8 = 0.5f;
                    }
                    b8Var.b(r8, z4);
                }
    ...
    */
    public final void g(boolean z4) {
        ...
        int i25;
        c8 c8Var = this.T;
        ArrayList arrayList = c8Var.n;
        ArrayList arrayList2 = c8Var.d;
        ArrayList arrayList3 = c8Var.h;
        ...
        if (i26 != 0) {
            ...
            if (i26 == 1) {
                ...
                if (this.a != 0) {
                    ...
                    int i27 = this.a;
                    ArrayList Y0 = i27 == 5 ? c8.Y0(c8Var) : c8.Z0(c8Var, i27 == 1 || i27 == 2, c8Var.V && (i27 == 3 || i27 == 6));
                    ArrayList arrayList6 = this.c;
                    HashMap hashMap = this.d;
                    HashSet l1 = c8.l1(arrayList6, hashMap);
                    ...
                    if (isEmpty) {
                        ...
                        while (i29 < arrayList7.size()) {
                            ...
                            if (tLObject2 instanceof TLRPC.User) {
                                ...
                                i12 = i29;
                                i13 = i30;
                                m7 i31 = m7.i(user, contains, !contains && l1.contains(Long.valueOf(user.id)));
                                int i32 = this.a;
                                i31.m = i32 == 2 || i32 == 4;
                                arrayList5.add(i31);
                                ...
                                if (tLObject2 instanceof TLRPC.Chat) {
                                    ...
                                    float f11 = dp;
                                    m7 m7Var3 = new m7(3, true);
                                    m7Var3.h = chat;
                                    m7Var3.k = containsKey2;
                                    int i33 = this.a;
                                    m7Var3.m = i33 == 2 || i33 == 4;
                                    arrayList5.add(m7Var3);
                            ...
                            if (!TextUtils.isEmpty(lowerCase)) {
                                ...
                                if (z12) {
                                    if (tLObject3 instanceof TLRPC.User) {
                                        ...
                                        m7 i37 = m7.i(user3, contains2, !contains2 && l1.contains(Long.valueOf(user3.id)));
                                        int i38 = this.a;
                                        i37.m = i38 == 2 || i38 == 4;
                                        arrayList5.add(i37);
                                        dp += AndroidUtilities.dp(56.0f);
                                        ...
                                        m7 m7Var4 = new m7(3, true);
                                        m7Var4.h = chat3;
                                        m7Var4.k = containsKey3;
                                        int i39 = this.a;
                                        if (i39 != 2 && i39 != 4) {
                                            z13 = false;
                                            m7Var4.m = z13;
                                            arrayList5.add(m7Var4);
                                            dp += AndroidUtilities.dp(56.0f);
                                            i10++;
                                            i34 = i11 + 1;
                                        }
                    ...
                    if (!z10) {
                        ...
                        float f12 = dp3 - dp;
                        if (f12 > 0.0f) {
                            m7 m7Var5 = new m7(-1, false);
                            m7Var5.p = (int) f12;
                            arrayList5.add(m7Var5);
                        }
                    }
                }
                if (this.h.t) {
        ...
        m7 m7Var6 = new m7(-1, false);
        m7Var6.o = 24;
        arrayList5.add(m7Var6);
        if (c8Var.I) {
            String string = LocaleController.getString(R.string.LiveStorySettingsHeader);
            m7 m7Var7 = new m7(11, false);
            m7Var7.e = string;
            arrayList5.add(m7Var7);
            m7Var6.o = AndroidUtilities.dp(72.0f) + m7Var6.o;
        } else if (c8Var.C && (c8Var.W || arrayList10 == null || arrayList10.size() <= 1)) {
            String string2 = c8Var.W ? LocaleController.getString(R.string.StoryPrivacyAlertEditTitle) : LocaleController.getString(c8Var.H ? R.string.StoryLivePrivacyAlertTitle : R.string.StoryPrivacyAlertTitle);
            if (c8Var.H) {
            ...
            m7 m7Var8 = new m7(4, false);
            m7Var8.e = string2;
            m7Var8.f = formatPluralString;
            arrayList5.add(m7Var8);
            m7Var6.o = AndroidUtilities.dp(72.0f) + m7Var6.o;
        } else {
            String string3 = LocaleController.getString(c8Var.H ? R.string.StoryLivePrivacyPublishAs : R.string.StoryPrivacyPublishAs);
            m7 m7Var9 = new m7(8, false);
            m7Var9.e = string3;
            arrayList5.add(m7Var9);
            m7Var6.o = AndroidUtilities.dp(50.0f) + m7Var6.o;
            TLRPC.InputPeer inputPeer = c8Var.c;
            if (inputPeer == null || (inputPeer instanceof TLRPC.TL_inputPeerSelf)) {
                i15 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                m7 i41 = m7.i(UserConfig.getInstance(i15).getCurrentUser(), false, false);
                i41.n = true;
                arrayList5.add(i41);
                m7Var6.o = AndroidUtilities.dp(62.0f) + m7Var6.o;
            } else if (inputPeer instanceof TLRPC.TL_inputPeerUser) {
                i18 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                m7 i42 = m7.i(MessagesController.getInstance(i18).getUser(Long.valueOf(c8Var.c.user_id)), false, false);
                i42.n = true;
                arrayList5.add(i42);
                m7Var6.o = AndroidUtilities.dp(62.0f) + m7Var6.o;
            } else {
                if (inputPeer instanceof TLRPC.TL_inputPeerChannel) {
                    ...
                    TLRPC.Chat chat4 = MessagesController.getInstance(i17).getChat(Long.valueOf(c8Var.c.channel_id));
                    m7 m7Var10 = new m7(3, true);
                    m7Var10.h = chat4;
                    m7Var10.k = false;
                    m7Var10.n = true;
                    arrayList5.add(m7Var10);
                    z16 = ChatObject.isChannelAndNotMegaGroup(chat4);
                    m7Var6.o = AndroidUtilities.dp(104.0f) + m7Var6.o;
                } else if (inputPeer instanceof TLRPC.TL_inputPeerChat) {
                    i16 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                    TLRPC.Chat chat5 = MessagesController.getInstance(i16).getChat(Long.valueOf(c8Var.c.chat_id));
                    m7 m7Var11 = new m7(3, true);
                    m7Var11.h = chat5;
                    m7Var11.k = false;
                    m7Var11.n = true;
                    arrayList5.add(m7Var11);
                    m7Var6.o = AndroidUtilities.dp(104.0f) + m7Var6.o;
                    z16 = false;
                }
                z15 = false;
                ...
                g10.c = !z15 ? 1 : 2;
                arrayList5.add(g10);
                m7Var6.o = AndroidUtilities.dp(12.0f) + m7Var6.o;
                if (z15) {
                    String string4 = LocaleController.getString(c8Var.H ? R.string.StoryLivePrivacyWhoCanView : R.string.StoryPrivacyWhoCanView);
                    m7 m7Var12 = new m7(8, false);
                    m7Var12.e = string4;
                    arrayList5.add(m7Var12);
                    m7Var6.o = AndroidUtilities.dp(40.0f) + m7Var6.o;
                }
                if (z15 || c8Var.I) {
                    f10 = 80.0f;
                } else {
                    m7 h = m7.h(4, c8Var.f, c8Var.K == 4);
                    arrayList5.add(h);
                    m7Var6.o = AndroidUtilities.dp(56.0f) + m7Var6.o;
                    f10 = 80.0f;
                    if (c8Var.f == 1) {
                        if (arrayList2.size() != 1) {
                            Iterator it = c8Var.e.values().iterator();
                            while (true) {
                                if (!it.hasNext()) {
                                    break;
                                }
                                ...
                                if (arrayList11.size() >= 1) {
                                    i24 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                                    h.g = MessagesController.getInstance(i24).getUser((Long) arrayList11.get(0));
                                    break;
                                }
                            }
                        } else {
                            i25 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                            h.g = MessagesController.getInstance(i25).getUser((Long) arrayList2.get(0));
                        }
                    }
                    m7 h9 = m7.h(2, arrayList3.size(), c8Var.K == 2);
                    arrayList5.add(h9);
                    m7Var6.o = AndroidUtilities.dp(56.0f) + m7Var6.o;
                    if (arrayList3.size() == 1) {
                        i23 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                        h9.g = MessagesController.getInstance(i23).getUser((Long) arrayList3.get(0));
                    }
                    ArrayList J0 = c8.J0(c8Var);
                    m7 h10 = m7.h(1, J0.size(), c8Var.K == 1);
                    arrayList5.add(h10);
                    m7Var6.o = AndroidUtilities.dp(56.0f) + m7Var6.o;
                    if (J0.size() == 1 && (J0.get(0) instanceof TLRPC.User)) {
                        h10.g = (TLRPC.User) J0.get(0);
                    }
                    m7 h11 = m7.h(3, c8Var.s, c8Var.K == 3);
                    arrayList5.add(h11);
                    m7Var6.o = AndroidUtilities.dp(56.0f) + m7Var6.o;
                    if (c8Var.s == 1) {
                        if (arrayList.size() != 1) {
                            Iterator it2 = c8Var.r.values().iterator();
                            while (true) {
                                if (!it2.hasNext()) {
                                    break;
                                }
                                ...
                                if (arrayList12.size() >= 1) {
                                    i21 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                                    h11.g = MessagesController.getInstance(i21).getUser((Long) arrayList12.get(0));
                                    break;
                                }
                            }
                        } else {
                            i22 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                            h11.g = MessagesController.getInstance(i22).getUser((Long) arrayList.get(0));
                        }
                    }
                    i20 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                    int i43 = MessagesController.getInstance(i20).getStoriesController().N;
                    String string5 = i43 <= 0 ? LocaleController.getString(c8Var.H ? R.string.StoryLiveBlockListEmpty : R.string.StoryBlockListEmpty) : LocaleController.formatPluralString(c8Var.H ? "StoryLiveBlockList" : "StoryBlockList", i43, new Object[0]);
                    int i44 = org.telegram.ui.ActionBar.k6.gc;
                    o7 o7Var = new o7(this, 3);
                    g6Var = ((org.telegram.ui.ActionBar.h3) c8Var).resourcesProvider;
                    arrayList5.add(m7.g(AndroidUtilities.replaceSingleTag(string5, i44, 0, o7Var, g6Var)));
                    m7Var6.o = AndroidUtilities.dp(80.0f) + m7Var6.o;
                }
                if (!c8Var.W) {
                    if (c8Var.H && !c8Var.I) {
                        if (c8Var.D) {
                            arrayList5.add(m7.b(LocaleController.getString(R.string.LiveStoryRTMPSettings), "", 5));
                            m7Var6.o = AndroidUtilities.dp(50.0f) + m7Var6.o;
                            arrayList5.add(m7.b(LocaleController.getString(R.string.LiveStoryRTMPDisable), "", 6));
                            m7Var6.o = AndroidUtilities.dp(50.0f) + m7Var6.o;
                            arrayList5.add(m7.g(null));
                            m7Var6.o = AndroidUtilities.dp(12.0f) + m7Var6.o;
                        } else {
                            arrayList5.add(m7.b(LocaleController.getString(R.string.LiveStoryRTMPEnable), "", 5));
                            m7Var6.o = AndroidUtilities.dp(50.0f) + m7Var6.o;
                            arrayList5.add(m7.g(LocaleController.getString(R.string.LiveStoryRTMPEnableInfo)));
                            m7Var6.o = AndroidUtilities.dp(30.0f) + m7Var6.o;
                        }
                    }
                    if (c8Var.H) {
                        String string6 = LocaleController.getString(R.string.StoryLiveAllowComments);
                        boolean z19 = c8Var.w;
                        m7 m7Var13 = new m7(7, false);
                        m7Var13.c = 2;
                        m7Var13.e = string6;
                        m7Var13.k = z19;
                        arrayList5.add(m7Var13);
                        m7Var6.o = AndroidUtilities.dp(50.0f) + m7Var6.o;
                    }
                    if (!c8Var.I) {
                        String string7 = LocaleController.getString(R.string.StoryAllowScreenshots);
                        boolean z20 = c8Var.x;
                        m7 m7Var14 = new m7(7, false);
                        m7Var14.c = 0;
                        m7Var14.e = string7;
                        m7Var14.k = z20;
                        arrayList5.add(m7Var14);
                        m7Var6.o = AndroidUtilities.dp(50.0f) + m7Var6.o;
                    }
                    if (!c8Var.H && !c8Var.I) {
                        String string8 = LocaleController.getString(z15 ? R.string.StoryKeep : z16 ? R.string.StoryKeepChannel : R.string.StoryKeepGroup);
                        boolean z21 = c8Var.y;
                        m7 m7Var15 = new m7(7, false);
                        m7Var15.c = 1;
                        m7Var15.e = string8;
                        m7Var15.k = z21;
                        arrayList5.add(m7Var15);
                        m7Var6.o = AndroidUtilities.dp(50.0f) + m7Var6.o;
                    }
                }
                z17 = c8Var.H;
                ...
                if (!z17 || c8Var.I) {
                    arrayList5.add(m7.g(null));
                    m7Var6.o = AndroidUtilities.dp(12.0f) + m7Var6.o;
                } else if (!c8Var.W && c8Var.B && c8Var.Z != null) {
                    if (z17) {
                    ...
                    arrayList5.add(m7.g(formatPluralString3));
                    m7Var6.o = AndroidUtilities.dp(f10) + m7Var6.o;
                }
                if (c8Var.y || c8Var.H || c8Var.I) {
                    m7Var = m7Var6;
                } else {
                    ...
                    if (inputPeer2 != null) {
                        ...
                        i19 = ((org.telegram.ui.ActionBar.h3) c8Var).currentAccount;
                    ...
                    if (hashSet.isEmpty()) {
                        ...
                        if (hashSet.size() < 3) {
                            ...
                            while (it3.hasNext()) {
                                Iterator it4 = it3;
                                oh.m6 b10 = c8Var.i1().B(j10, true).b(((Integer) it3.next()).intValue());
                                if (b10 != null) {
                                    if (sb.length() != 0) {
                                        sb.append(", ");
                                    }
                    ...
                    arrayList5.add(m7.b(LocaleController.getString(R.string.StoriesAlbum), sb, 1));
                    m7Var = m7Var2;
                    m7Var.o = AndroidUtilities.dp(50.0f) + m7Var.o;
                }
                if (!c8Var.W && ((!c8Var.B || c8Var.Z == null) && !(z18 = c8Var.H) && !c8Var.I)) {
                    if (z18) {
                        if (z15) {
                            str = "StoryKeepInfo";
                        } else if (z16) {
                    ...
                    arrayList5.add(m7.g(formatPluralString2));
                    m7Var.o = AndroidUtilities.dp(f10) + m7Var.o;
                }
                if (c8Var.y && c8Var.B && c8Var.Z != null) {
                    String string9 = LocaleController.getString(R.string.StoryEditCover);
                    BitmapDrawable bitmapDrawable = c8Var.Y;
                    m7 m7Var16 = new m7(9, false);
                    m7Var16.e = string9;
                    m7Var16.d = bitmapDrawable;
                    m7Var16.q = 0;
                    arrayList5.add(m7Var16);
                    m7Var.o = AndroidUtilities.dp(50.0f) + m7Var.o;
                    arrayList5.add(m7.g(LocaleController.getString(R.string.StoryEditCoverInfo)));
                    m7Var.o = AndroidUtilities.dp(72.0f) + m7Var.o;
                }
                if (c8Var.I) {
                    arrayList5.add(m7.b(LocaleController.getString(R.string.LiveStoryRTMPSettings), "", 5));
                    m7Var.o = AndroidUtilities.dp(50.0f) + m7Var.o;
                    arrayList5.add(m7.g(null));
                    m7Var.o = AndroidUtilities.dp(52.0f) + m7Var.o;
                }
                if (c8Var.H && c8Var.w) {
                    String string10 = LocaleController.getString(R.string.LiveStoryPricePerComment);
                    m7 m7Var17 = new m7(8, false);
                    m7Var17.e = string10;
                    arrayList5.add(m7Var17);
                    m7Var.o = AndroidUtilities.dp(40.0f) + m7Var.o;
                    m7 m7Var18 = new m7(10, false);
                    m7Var18.q = 8;
                    arrayList5.add(m7Var18);
                    m7Var.o = AndroidUtilities.dp(75.0f) + m7Var.o;
                    arrayList5.add(m7.g(LocaleController.getString(R.string.LiveStoryPricePerCommentInfo)));
                    m7Var.o = AndroidUtilities.dp(50.0f) + m7Var.o;
                }
            }
            z16 = false;
            ...
            if (c8Var.y) {
                ...
                BitmapDrawable bitmapDrawable2 = c8Var.Y;
                m7 m7Var162 = new m7(9, false);
                m7Var162.e = string92;
                m7Var162.d = bitmapDrawable2;
                m7Var162.q = 0;
                arrayList5.add(m7Var162);
                m7Var.o = AndroidUtilities.dp(50.0f) + m7Var.o;
                arrayList5.add(m7.g(LocaleController.getString(R.string.StoryEditCoverInfo)));
                m7Var.o = AndroidUtilities.dp(72.0f) + m7Var.o;
            }
            ...
            if (c8Var.H) {
                ...
                m7 m7Var172 = new m7(8, false);
                m7Var172.e = string102;
                arrayList5.add(m7Var172);
                m7Var.o = AndroidUtilities.dp(40.0f) + m7Var.o;
                m7 m7Var182 = new m7(10, false);
                m7Var182.q = 8;
                arrayList5.add(m7Var182);
                m7Var.o = AndroidUtilities.dp(75.0f) + m7Var.o;
                arrayList5.add(m7.g(LocaleController.getString(R.string.LiveStoryPricePerCommentInfo)));
                m7Var.o = AndroidUtilities.dp(50.0f) + m7Var.o;
            }
    ...
    public final void i(boolean z4) {
        ...
        Property property3;
        org.telegram.ui.ActionBar.g6 g6Var;
        HashSet l1 = c8.l1(this.c, this.d);
        int i11 = this.a;
        c8 c8Var = this.T;
        if (i11 == 3) {
            c8Var.s = l1.size();
        ...
        if (z4) {
            ...
            jVar.b = animatorSet;
            animatorSet.addListener(new y7(jVar, arrayList2, i12));
            arrayList7.clear();
            arrayList6.clear();
            arrayList5.clear();
            int i16 = 0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (i12 > 0) {
            i13 = ((org.telegram.ui.ActionBar.h3) c8Var).keyboardHeight;
            this.Q = i13;
        }
        ...
        if (z16 != z4) {
            ...
            if (i15 == 0) {
                ...
                u7Var.setTranslationY(z14 ? this.Q : 0.0f);
                ...
                this.R = true;
                view.animate().translationY(0.0f).setDuration(250L).setInterpolator(prVar).withEndAction(new o7(this, i14)).start();
            }
