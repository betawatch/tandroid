...
public final class h0 extends f0 {
    ...
    public h0(i0 i0Var, Context context) {
        ...
        int i12 = g6.G6;
        lVar2.setTitleColor(i0Var.getThemedColor(i12));
        ...
        dVar.d();
        dVar.setColor(i0.a.d(0.125f, i0Var.getThemedColor(g6.d6), i0Var.getThemedColor(i12)));
        dVar.setText(LocaleController.getString(R.string.CommunityPendingRequestDeclineAll));
        dVar.e();
        final int i13 = 0;
        dVar.setOnClickListener(new View.OnClickListener(this) { // from class: qh.g0
        ...
        dVar2.e();
        final int i14 = 1;
        dVar2.setOnClickListener(new View.OnClickListener(this) { // from class: qh.g0
            public final /* synthetic */ h0 b;
        ...
        this.c.addView(g10, f6.f(-2.0f, 80, 0, 0, 0, AndroidUtilities.navigationBarHeight));
        a();
    }
}
