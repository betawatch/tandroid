...
public abstract class k extends FrameLayout {
    ...
    public k(Context context, FrameLayout frameLayout, qv0 qv0Var, FrameLayout frameLayout2, org.telegram.ui.ActionBar.g6 g6Var, org.telegram.ui.Components.ba baVar) {
        ...
        pr prVar = pr.h;
        this.s0 = new org.telegram.ui.Components.z5(this, 0L, 300L, prVar);
        this.v0 = false;
        this.w0 = new RectF();
        this.x0 = new RectF();
        this.y0 = new RectF();
        ...
        iVar.a(new z10(g6Var, i10, 0.0f, 1));
        iVar.g.setColor(0);
        iVar.invalidateSelf();
        iVar2.j = true;
        iVar2.a(new z10(g6Var, i10, 0.0f, 2));
        iVar2.g.setColor(0);
        ...
        fVar.getEditText().drawHint = new eg.p1(this, 26);
        ...
        addView(fVar, k7.c6.d(-1, -2.0f, (z4 ? 48 : 80) | 7, 12.0f, 8.0f, b() + 12, 8.0f));
        ...
        pq pqVar = new pq(org.telegram.ui.ActionBar.k6.K(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.zf, g6Var)), mutate, 0, AndroidUtilities.dp(1.0f));
        this.n = pqVar;
        ...
        hVar.setOnClickListener(new org.telegram.ui.Components.voip.o(this, 6));
        addView(hVar, k7.c6.d(44, 44.0f, (z4 ? 48 : 80) | 5, 8.0f, 8.0f, 8.0f, 8.0f));
        ...
        frameLayout3.addView(k6Var, k7.c6.e(52, 16, (z4 ? 48 : 80) | 5));
        addView(frameLayout3, k7.c6.d(52, 16.0f, (z4 ? 48 : 80) | 5, 0.0f, z4 ? 50 : 0, 0.0f, z4 ? 0 : 50));
    ...
    */
    public void dispatchDraw(Canvas canvas) {
        ...
        float f20 = z5Var.c;
        float e6 = z5Var.e(kVar.H0);
        if (Math.abs(f20 - e6) <= 0.001f) {
        }
        kVar.n();
        if (e6 > 0.0f) {
        ...
        if (!kVar.z0 || (faVar = kVar.P) == null || (faVar2 = kVar.N) == null) {
            ...
            l01 l01Var = kVar.A0;
            if (l01Var != null) {
                l01Var.p = (int) (rectF2.width() - AndroidUtilities.dp(40.0f));
                l01Var.c(rectF2.left + AndroidUtilities.dp(20.0f), f22 + AndroidUtilities.dp(22.0f), 1.0f, -1, canvas2);
            }
            Path path3 = kVar.E0;
            if (path3 == null) {
                kVar.E0 = new Path();
            ...
            l01 l01Var2 = kVar.B0;
            if (l01Var2 != null) {
                l01Var2.p = (int) (rectF2.width() - AndroidUtilities.dp(40.0f));
                l01Var2.c(rectF2.left + AndroidUtilities.dp(20.0f), f22 + AndroidUtilities.dp(40.0f), 1.0f, -1, canvas2);
            }
        }
        ...
        if (e6 > 0.0f) {
            ...
            float max = Math.max(Math.max(k7.o6.a(rectF2.left, rectF2.top, dp6, dp7), k7.o6.a(rectF2.left, rectF2.bottom, dp6, dp7)), Math.max(k7.o6.a(rectF2.right, rectF2.top, dp6, dp7), k7.o6.a(rectF2.right, rectF2.bottom, dp6, dp7))) * e6;
            if (kVar.K0 == null) {
            ...
            canvas2.restore();
            canvas2.restore();
            if (!(kVar instanceof r9)) {
                kVar.k(canvas2, rectF2, e6);
            }
        }
        canvas2.restore();
        if (kVar.e0 == null) {
    ...
    public final void v(CharSequence charSequence, SpannableStringBuilder spannableStringBuilder) {
        ...
        this.A0 = new l01(charSequence2, 14.0f, AndroidUtilities.bold());
