...
public final class q extends FrameLayout {
    ...
    public q(Context context, int i10, e6 e6Var) {
        super(context);
        this.a = new k9(i10, this, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dpf2(1.0f));
    ...
    public final e61 a(n2 n2Var, long j3, int i10, byte[] bArr, int i11, Utilities.Callback callback) {
        k kVar = this.c;
        if (kVar != null) {
            return kVar;
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        k9 k9Var = this.a;
        k9Var.setBounds(width - ((int) k9Var.c.d.f.a), AndroidUtilities.dp(12.0f), getWidth() - AndroidUtilities.dp(11.0f), AndroidUtilities.dp(24.0f) + AndroidUtilities.dp(12.0f));
        k9Var.c(canvas);
    }
