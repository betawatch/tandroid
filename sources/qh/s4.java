...
public abstract class s4 {
    public static ArrayList a(int i9, ArrayList arrayList) {
    ...
    public static void b(TL_iv.PageBlock pageBlock, LinkedHashSet linkedHashSet) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockButtonRow) {
            ...
            if (arrayList2 != null) {
                ...
                while (i9 < size) {
                    TL_keyboard.PageButton pageButton = arrayList2.get(i9);
                    i9++;
        ...
        if (pageBlock instanceof TL_iv.pageBlockList) {
            ...
            if (arrayList3 != null) {
                ...
                while (i9 < size2) {
                    TL_iv.PageListItem pageListItem = arrayList3.get(i9);
                    i9++;
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            if (arrayList4 != null) {
                ...
                while (i9 < size3) {
                    TL_iv.PageListOrderedItem pageListOrderedItem = arrayList4.get(i9);
                    i9++;
        ...
        if (arrayList5 != null) {
            ...
            int i10 = 0;
            while (i10 < size4) {
                TL_iv.pageTableRow pagetablerow = arrayList5.get(i10);
                i10++;
