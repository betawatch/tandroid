...
public final class e0 extends View {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        eg.t2 t2Var = f0Var.b;
        float lerp6 = (t2Var == null || (cropState = t2Var.D0) == null) ? AndroidUtilities.lerp(1.0f, f18, f12) : AndroidUtilities.lerp(cropState.cropScale, f18, f12);
        ...
        eg.t2 t2Var2 = f0Var.b;
        Paint paint2 = t2Var2.C0;
        Bitmap bitmap = t2Var2.x0;
        if (bitmap != null) {
            paint2.setAlpha(255);
