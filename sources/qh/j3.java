...
public final class j3 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void c(Runnable runnable, boolean z4) {
        ...
        d dVar = i3Var.b;
        i3Var.animate().alpha(this.y ? 1.0f : 0.0f).setInterpolator(pr.h).setDuration(320L).withEndAction(new qv0(12, this, z4)).start();
        dVar.setVisibility((!z4 || runnable == null) ? 8 : 0);
        dVar.setOnClickListener(runnable == null ? null : new jg.u(4, runnable));
    }
    ...
    public final void d(long j10, oh.e4 e4Var) {
        ...
        this.s = j10;
        this.v = e4Var;
        if (this.r && e4Var != null && !e4Var.f) {
            e4Var.f = true;
            e4Var.a();
        }
        boolean z4 = (e4Var == null || (e1Var2 = e4Var.a) == null || !e1Var2.n()) ? false : true;
        if (e4Var == null || (e1Var = e4Var.a) == null || !e1Var.a()) {
            z0Var = null;
        } else {
            oh.e1 e1Var3 = e4Var.a;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.liveStoryUpdated) {
            ...
            oh.e4 e4Var = this.v;
            if (e4Var == null || (e1Var = e4Var.a) == null || e1Var.g() != longValue) {
                return;
            }
            boolean n10 = this.v.a.n();
            if (this.v.a.a()) {
                oh.e1 e1Var2 = this.v.a;
    ...
    public final void e(boolean z4, boolean z10) {
        if (z4 || !z10) {
            if (z10) {
                org.telegram.ui.b.p(getTextureView().animate().alpha(z4 ? 1.0f : 0.0f), pr.h, 320L);
            } else {
