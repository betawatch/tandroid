...
public abstract class z2 extends sl0 {
    public boolean d;
    public String f;
    public String h;
    public TLRPC.User n;
    ...
    public final void E() {
        ...
        if (user == null && !this.r) {
            ...
            this.e = ConnectionsManager.getInstance(i10).sendRequest(tL_contacts_resolveUsername, new li1(2, this, messagesController));
        } else {
            if (user == null) {
                return;
            }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        return new fl0(new mh.z4(this.w.getContext(), 1));
    }
}
