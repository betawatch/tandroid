    ...
    */
    ...
    public static float g(CharSequence charSequence, TextPaint textPaint) {
        ...
        for (int i13 = 0; i13 < g51VarArr.length; i13++) {
            int spanStart = spanned.getSpanStart(g51VarArr[i13]);
            int spanEnd = spanned.getSpanEnd(g51VarArr[i13]);
            ...
            if (i12 - max > 0) {
                ...
                textPaint3.setTypeface(g51VarArr[i13].a);
    ...
    public void c(Canvas canvas, float f10) {
        ...
        Paint paint = this.C;
        if (i10 != 0) {
            paint.setShadowLayer(this.f0, 0.0f, this.g0, org.telegram.ui.ActionBar.k6.l1(f10, i10));
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        float e6 = this.T.e(this.S && !this.w0);
        if (this.w0) {
            this.w0 = false;
            invalidate();
        }
        ...
        if (ij0Var != null) {
            if (this.e0) {
                ...
                ij0Var.setBounds((int) f20, (int) (f21 - f22), (int) (f20 + this.c0), (int) (f22 + f21));
                ...
                ij0Var.setBounds((int) (f23 - this.c0), (int) (f24 - f25), (int) f23, (int) (f25 + f24));
                f11 = 0.0f;
            }
                    ...
                    if (lineLeft <= f10 && this.I.getLineWidth(lineForVertical) + lineLeft >= f10 && i11 >= 0 && i11 <= this.I.getHeight()) {
                        ...
                        if (clickableSpanArr.length != 0 && !AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
                            ...
                            if (clickableSpan == null && motionEvent.getAction() == 0) {
                                h90 h90Var = new h90(clickableSpan, null, motionEvent.getX(), motionEvent.getY(), 0);
                                this.H0 = h90Var;
                                ...
                                invalidate();
                                AndroidUtilities.runOnUIThread(new lh.w(this, h90Var, clickableSpan), ViewConfiguration.getLongPressTimeout());
                            ...
                            if (motionEvent.getAction() == 3) {
                                ...
                                long j11 = this.d;
                                if (j11 > 0) {
                                    AndroidUtilities.runOnUIThread(gl0Var, j11);
                                }
                                this.H0 = null;
                            }
                        }
