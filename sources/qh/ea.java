...
public final class ea {
    ...
    public ea(la laVar, String str, int i10) {
        this.l = laVar;
        this.a = new org.telegram.ui.Components.z5(laVar, 0L, 600L, pr.h);
        int i11 = 0;
        ...
        int min = Math.min(Math.round((((this.h * 1000) / Math.min(laVar.h != null ? r8.e : !laVar.s.isEmpty() ? laVar.getBaseDuration() : laVar.B ? laVar.E : this.h * 1000, laVar.getMaxScrollDuration())) * i10) / Math.round(AndroidUtilities.dpf2(3.3333f))), 4000);
        this.b = min;
        ...
        if ("audio/mpeg".equals(str2) || "audio/mp3".equals(str2) || "audio/mp4a".equals(str2) || MediaController.AUDIO_MIME_TYPE.equals(str2)) {
            this.k = new FfmpegAudioWaveformLoader(str, min, new c4(this, 4));
        } else {
