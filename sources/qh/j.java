...
public final class j extends Drawable {
    ...
    public j(int i10) {
        ...
        pr prVar = pr.h;
        this.f = new org.telegram.ui.Components.z5(s0Var, 350L, prVar, 0);
        this.g = new Path();
        this.i = 21.0f;
        this.h = i10;
    ...
    public final void a(Canvas canvas, float f10) {
        ...
        if (e6 > 0.0f) {
            ...
            canvas.drawCircle(this.n, this.o, AndroidUtilities.dpf2(11.33f) * e6, paint);
        }
        Paint paint2 = this.a;
        paint2.setAlpha((int) ((1.0f - e6) * Color.alpha(this.l) * f10));
        ...
        if (e6 > 0.0f) {
            Path path = this.g;
            path.rewind();
            path.addCircle(this.n, this.o + AndroidUtilities.dp(1.0f), AndroidUtilities.dpf2(11.33f) * e6, Path.Direction.CW);
