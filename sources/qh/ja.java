...
public final class ja {
    ...
    public ja(la laVar, boolean z4, final String str, final int i10, final int i11, final Long l10, final long j10, final long j11, final long j12, final Runnable runnable) {
        this.n = laVar;
        this.h = z4;
        Utilities.themeQueue.postRunnable(new Runnable() { // from class: qh.ha
            ...
            */
            public final void run() {
                ...
                long maxScrollDuration = jaVar.n.getMaxScrollDuration();
                try {
                    jaVar.e.setDataSource(str2);
                    String extractMetadata = jaVar.e.extractMetadata(9);
                    if (extractMetadata != null) {
                        maxScrollDuration = Long.parseLong(extractMetadata);
                        jaVar.a = maxScrollDuration;
                    }
                    String extractMetadata2 = jaVar.e.extractMetadata(18);
                ...
                try {
                    String extractMetadata3 = jaVar.e.extractMetadata(19);
                    i13 = extractMetadata3 != null ? Integer.parseInt(extractMetadata3) : 0;
                    try {
                        String extractMetadata4 = jaVar.e.extractMetadata(24);
                        ...
                        jaVar.g = Math.max(1, i14);
                        jaVar.f = Math.max(1, (int) Math.ceil(i14 * clamp));
                        int ceil = (int) Math.ceil(((Math.max(maxScrollDuration, j15) / j15) * i15) / jaVar.f);
                        jaVar.c = ceil;
                        jaVar.b = (long) (maxScrollDuration / ceil);
                        jaVar.j = -jaVar.b;
                        if (j13 != -1) {
                        }
                        jaVar.c();
                    ...
                    jaVar.g = Math.max(1, i14);
                    jaVar.f = Math.max(1, (int) Math.ceil(i14 * clamp2));
                    int ceil2 = (int) Math.ceil(((Math.max(maxScrollDuration, j15) / j15) * i15) / jaVar.f);
                    jaVar.c = ceil2;
                    jaVar.b = (long) (maxScrollDuration / ceil2);
                    jaVar.j = -jaVar.b;
                    if (j13 != -1) {
                    }
                    jaVar.c();
                ...
                jaVar.g = Math.max(1, i14);
                jaVar.f = Math.max(1, (int) Math.ceil(i14 * clamp22));
                int ceil22 = (int) Math.ceil(((Math.max(maxScrollDuration, j15) / j15) * i15) / jaVar.f);
                jaVar.c = ceil22;
                jaVar.b = (long) (maxScrollDuration / ceil22);
                jaVar.j = -jaVar.b;
                if (j13 != -1) {
                    jaVar.j = j13 - jaVar.b;
                }
    ...
    public final void c() {
        ...
        this.j += this.b;
        int i10 = 3;
        Utilities.themeQueue.cancelRunnable(new u9(this, i10));
        Utilities.themeQueue.postRunnable(new u9(this, i10));
    }
}
