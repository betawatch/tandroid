...
public final /* synthetic */ class v9 implements Runnable {
    ...
    public /* synthetic */ v9(Object obj, int i10) {
        this.a = i10;
        this.b = obj;
    }
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                fa faVar = (fa) this.b;
                try {
                    int round = Math.round(((faVar.h * faVar.g.getInteger("sample-rate")) / faVar.b) / 5.0f);
                    MediaCodec createDecoderByType = MediaCodec.createDecoderByType(faVar.g.getString("mime"));
                    if (createDecoderByType == null) {
                        return;
                    }
                    createDecoderByType.configure(faVar.g, (Surface) null, (MediaCrypto) null, 0);
                    ...
                    while (true) {
                        ...
                        if (dequeueInputBuffer >= 0) {
                            int readSampleData = faVar.f.readSampleData(createDecoderByType.getInputBuffer(dequeueInputBuffer), 0);
                            if (readSampleData < 0) {
                                j10 = 2500;
                                ...
                                j10 = 2500;
                                bufferInfo = bufferInfo2;
                                createDecoderByType.queueInputBuffer(dequeueInputBuffer, 0, readSampleData, faVar.f.getSampleTime(), 0);
                                faVar.f.advance();
                            }
                        } else {
                            bufferInfo = bufferInfo2;
                                ...
                                if (outputBuffer != null && bufferInfo3.size > 0) {
                                    ...
                                    while (outputBuffer.remaining() > 0) {
                                        ...
                                        if (i14 >= round) {
                                            ...
                                            i11++;
                                            int i15 = i11 - i12;
                                            if (i15 >= sArr.length || i11 >= faVar.b) {
                                                short[] sArr2 = new short[sArr.length];
                                                AndroidUtilities.runOnUIThread(new bu0(faVar, sArr, i15, 14));
                                                sArr = sArr2;
                                                i12 = i11;
                                            }
                                            if (i11 >= faVar.d.length) {
                                                i13 = 0;
                                                s9 = 0;
                                            } else {
                                                i14 = 0;
            ...
            case 3:
                ka kaVar2 = (ka) this.b;
                MediaMetadataRetriever mediaMetadataRetriever = kaVar2.e;
                if (mediaMetadataRetriever == null) {
                    return;
                }
                Bitmap bitmap = null;
                try {
                    bitmap = mediaMetadataRetriever.getFrameAtTime(kaVar2.j * 1000, 2);
                    if (bitmap != null) {
                        Bitmap createBitmap = Bitmap.createBitmap(kaVar2.f, kaVar2.g, Bitmap.Config.ARGB_8888);
                        Canvas canvas = new Canvas(createBitmap);
                        float max = Math.max(kaVar2.f / bitmap.getWidth(), kaVar2.g / bitmap.getHeight());
                        ...
                        if (kaVar2.h) {
                            ...
                            kaVar2.m.rewind();
                            kaVar2.m.addCircle(kaVar2.f / 2.0f, kaVar2.g / 2.0f, Math.min(kaVar2.f, kaVar2.g) / 2.0f, Path.Direction.CW);
                            canvas.clipPath(kaVar2.m);
                        }
                        canvas.drawBitmap(bitmap, rect, rect2, kaVar2.l);
                        bitmap.recycle();
                        bitmap = createBitmap;
                    }
                } catch (Exception e10) {
                ...
                AndroidUtilities.runOnUIThread(new d6(7, kaVar2, bitmap));
                return;
            case 4:
                mh.u9 u9Var = (mh.u9) this.b;
                u9Var.getClass();
                try {
                    tl0 currentListView = ((rh.g) u9Var.J0).O.getCurrentListView();
            ...
            case 5:
                ...
                AndroidUtilities.runOnUIThread(new sf.b(cVar.a, cVar.b, 1), 500L);
                return;
            case 6:
