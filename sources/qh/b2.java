...
public final class b2 {
    ...
    public final pf.o1 g = new pf.o1(this, 6);
    public a2 d = b();
    ...
    */
    public final void a(a2 a2Var) {
        ...
        o3Var.U2.N(false);
        if (y1Var.a >= 0) {
            o3Var.post(new ai1(23, o3Var, y1Var));
        }
    ...
    /* JADX WARN: Type inference failed for: r1v4, types: [android.view.View, android.widget.TextView, qh.d1] */
    /* JADX WARN: Type inference failed for: r1v5, types: [android.view.View] */
    /* JADX WARN: Type inference failed for: r1v9, types: [android.view.View] */
    /* JADX WARN: Type inference failed for: r2v4, types: [qh.f5] */
    public final a2 b() {
        y1 y1Var;
        i0 i0Var;
        n2.p pVar = this.a;
        ArrayList arrayList = ((o3) pVar.b).h3;
        ...
        for (int i9 = 0; i9 < arrayList.size(); i9++) {
                ...
                if (arrayList3 != arrayList4) {
                    if (arrayList3 != null && arrayList4 != null && arrayList3.size() == arrayList4.size()) {
                        for (int i10 = 0; i10 < arrayList3.size(); i10++) {
                            if (arrayList3.get(i10) != arrayList4.get(i10)) {
                                break;
                            }
                        }
                    }
            ...
            z1VarArr[i9] = new z1(aVar.a, byteArray, aVar.c, aVar.d, aVar.e, aVar.f, aVar.i, aVar.g, aVar.h != null ? new ArrayList(aVar.h) : null, new ArrayList(arrayList2));
        }
        View findFocus = ((o3) pVar.b).findFocus();
        if (findFocus instanceof d1) {
            ...
            if (U2 == 0 || U2.getRow() == null) {
                ...
                if (i0Var == null || i0Var.getRow() == null) {
                    ...
                    if (r12 instanceof s5) {
                        ...
                        if (s5Var.getRow() != null) {
                            y1Var = new y1(s5Var.getRow().a, -1, selectionStart, selectionEnd);
                        }
                    }
                } else {
                ...
                i5 o6 = U2.o(r12);
                y1Var = new y1(U2.getRow().a, o6 != null ? U2.k(o6.b) : -1, selectionStart, selectionEnd);
            }
