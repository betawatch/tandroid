...
public final class c extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
    ...
    public c(Activity activity, d6 d6Var, xn xnVar) {
        ...
        this.b = bVar2;
        int i11 = h6.Vh;
        bVar2.setBackground(h6.f0(h6.v0(i11, d6Var), 1, -1));
        z5.a(bVar2);
        d dVar = new d(getContext(), 36);
        this.c = dVar;
        dVar.setBackground(h6.f0(h6.v0(i11, d6Var), 1, -1));
    ...
    public static void a(c cVar) {
        ...
        int i10 = h6.A6;
        xn xnVar = cVar.d;
        i5Var.setTextColor(i0.a.d(cVar.I.e, h6.v0(i10, xnVar.getResourceProvider()), h6.v0(h6.p7, xnVar.getResourceProvider())));
    }
