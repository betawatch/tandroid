...
public final /* synthetic */ class d6 implements Runnable {
    ...
    public /* synthetic */ d6(int i10, Object obj, Object obj2) {
        this.a = i10;
        this.c = obj;
        this.b = obj2;
    }
    ...
    private final void a() {
        ...
        while (i11 < bArr.length) {
            ...
            if (i13 != 0) {
                synchronized (jVar.a) {
                    try {
                        sf.i iVar = (sf.i) jVar.k.get(Integer.valueOf(i13));
                        if (iVar == null) {
                ...
                synchronized (jVar.a) {
                    try {
                        if (!jVar.p && !jVar.o) {
                            ...
                            jVar.a.notifyAll();
                            if (cVar != null) {
                                AndroidUtilities.runOnUIThread(new v9(cVar, 5));
                            }
                        }
                    } finally {
                    }
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                k6.R((k6) this.c, (TLObject) this.b);
                return;
            case 1:
                s6 s6Var = (s6) this.c;
                ...
                return;
            case 2:
                b7.R((b7) this.c, (TLObject) this.b);
                return;
            case 3:
                b7 b7Var = (b7) this.c;
                TextView textView = (TextView) this.b;
                ClipboardManager clipboardManager = (ClipboardManager) b7Var.getContext().getSystemService("clipboard");
                org.telegram.ui.Cells.g3 g3Var = b7Var.V.b;
            ...
            case 4:
                ...
                AndroidUtilities.runOnUIThread(new d6(5, d8Var, smallGroupsParticipantsCount));
                return;
            case 5:
                d8 d8Var2 = (d8) this.c;
                HashMap hashMap = (HashMap) this.b;
                if (d8Var2.M == null) {
                    d8Var2.M = new HashMap();
                }
                d8Var2.M.putAll(hashMap);
                return;
            case 6:
                d dVar = (d) this.c;
            ...
            case 7:
                ...
                kaVar.d.add(new ja(kaVar, bitmap));
                kaVar.k = false;
                kaVar.n.invalidate();
                return;
            case 8:
