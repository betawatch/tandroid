...
public class d extends FrameLayout implements j90 {
    ...
    public d(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        this(context, g6Var, true);
    }
    ...
    public final void d() {
        this.w = true;
        setFilled(true);
        setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.xa, this.a));
        j();
    }
    ...
    public final void j() {
        if (!this.x) {
            this.y = org.telegram.ui.ActionBar.k6.v0(this.w ? org.telegram.ui.ActionBar.k6.xa : org.telegram.ui.ActionBar.k6.Oh, this.a);
        }
        int v02 = org.telegram.ui.ActionBar.k6.v0(this.s ? this.w ? org.telegram.ui.ActionBar.k6.ya : org.telegram.ui.ActionBar.k6.Sh : org.telegram.ui.ActionBar.k6.Oh, this.a);
        org.telegram.ui.Components.j6 j6Var = this.d;
        j6Var.r(v02);
        boolean z4 = this.s;
        View view = this.r;
        if (z4) {
            int v03 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.i6, this.a);
            int i10 = this.b;
            view.setBackground(org.telegram.ui.ActionBar.k6.Y(v03, i10, i10));
        } else {
            int l1 = org.telegram.ui.ActionBar.k6.l1(0.1f, j6Var.a.getColor());
            int i11 = this.b;
            view.setBackground(org.telegram.ui.ActionBar.k6.Y(l1, i11, i11));
        }
        this.e.r(org.telegram.ui.ActionBar.k6.v0(this.s ? this.w ? org.telegram.ui.ActionBar.k6.ya : org.telegram.ui.ActionBar.k6.Sh : org.telegram.ui.ActionBar.k6.Oh, this.a));
        this.f.r(this.y);
        this.c.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Sh, this.a));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.I) {
            if (this.K) {
                if (this.H == null) {
                    ...
                    k90Var2.t = 2.0f;
                    k90Var2.C = true;
                    k90Var2.w.setStrokeWidth(0.0f);
                    this.H.e(org.telegram.ui.ActionBar.k6.l1(0.02f, -1), org.telegram.ui.ActionBar.k6.l1(0.375f, -1));
                }
                k90 k90Var3 = this.H;
                k90Var3.c = -1L;
                k90Var3.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
                this.H.j(this.b);
                this.H.draw(canvas);
            } else {
                k90 k90Var4 = this.H;
        ...
        if (f11 > 0.0f) {
            if (this.V == null) {
                this.V = new tp(j6Var.a.getColor());
            }
        ...
        if (f12 < 1.0f) {
            ...
            rect.set((int) (((getMeasuredWidth() - a2) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - j6Var.e) / 2.0f) - AndroidUtilities.dp(1.0f)), (int) l.d.b(getMeasuredWidth() - a2, getWidth(), 2.0f, d), (int) (((getMeasuredHeight() + j6Var.e) / 2.0f) - AndroidUtilities.dp(1.0f)));
            ...
            if (this.G) {
                ...
                a2 = j6Var3.d();
                rect.set((int) (((getMeasuredWidth() - a2) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - j6Var3.e) / 2.0f) - AndroidUtilities.dp(1.0f)), (int) l.d.b(getMeasuredWidth() - a2, getWidth(), 2.0f, a2), (int) (((getMeasuredHeight() + j6Var3.e) / 2.0f) - AndroidUtilities.dp(1.0f)));
    ...
    public void setColor(int i10) {
        if (this.s) {
            ...
            this.y = i10;
            setBackground(org.telegram.ui.ActionBar.k6.b0(dp, i10));
            return;
        }
        this.d.r(i10);
        int l1 = org.telegram.ui.ActionBar.k6.l1(0.1f, i10);
        int i11 = this.b;
        this.r.setBackground(org.telegram.ui.ActionBar.k6.Y(l1, i11, i11));
    }
    ...
    public void setFilled(boolean z4) {
        ...
        org.telegram.ui.Components.j6 j6Var = this.d;
        if (z4) {
            setBackground(org.telegram.ui.ActionBar.k6.b0(AndroidUtilities.dp(this.b), this.y));
    ...
    public void setRoundRadius(int i10) {
        this.b = i10;
        if (this.s) {
            setBackground(org.telegram.ui.ActionBar.k6.b0(AndroidUtilities.dp(i10), this.y));
        } else {
            setBackground(null);
        }
        j();
    ...
    public d(Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4) {
        super(context);
        this.b = 8;
        pr prVar = pr.h;
        this.n = new org.telegram.ui.Components.z5(350L, prVar);
        this.B = true;
        this.C = 0;
        this.E = 0.0f;
        this.J = 0.0f;
        ...
        if (z4) {
            ...
            this.y = v02;
            setBackground(org.telegram.ui.ActionBar.k6.b0(dp, v02));
        }
        Paint paint = new Paint(1);
        this.c = paint;
        paint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Sh, g6Var));
