...
public final class d5 extends View {
    ...
    public d5(e5 e5Var, Context context, String str, boolean z4) {
        super(context);
        ...
        this.b = paint2;
        this.r = new org.telegram.ui.Components.z5(this, 0L, 220L, pr.h);
        this.s = true;
        this.n = z4;
    ...
    public final void onDraw(Canvas canvas) {
        if (isPressed()) {
            float f10 = this.v;
            if (f10 != 1.0f) {
                float min = (Math.min(40.0f, 1000.0f / AndroidUtilities.screenRefreshRate) / 80.0f) + f10;
                this.v = min;
    ...
    public final void setPressed(boolean z4) {
        ...
        if (isPressed() != z4) {
            super.setPressed(z4);
            invalidate();
            if (z4 && (valueAnimator = this.w) != null) {
            ...
            if (f10 != 0.0f) {
                ...
                this.w.addListener(new j2(this, 3));
