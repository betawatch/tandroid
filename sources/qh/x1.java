...
public class x1 extends org.telegram.ui.ActionBar.h3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void m(x1 x1Var) {
        boolean z4 = x1Var.v;
        ...
        if (z4 != z10) {
            ...
            if (x1Var.keyboardVisible) {
                ...
                f10 = Math.min(0.0f, Math.max(((i10 - i11) * 0.3f) - x1Var.x, (-i11) / 3.0f));
            }
            x1Var.container.animate().translationY(f10).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.r1.w).start();
        }
    }
        ...
        if (i10 == NotificationCenter.stickersDidLoad || i10 == NotificationCenter.groupStickersDidLoad) {
            for (View view : this.f.getViewPages()) {
                if (view instanceof n1) {
                    n1 n1Var = (n1) view;
                    if (i10 == NotificationCenter.groupStickersDidLoad || ((n1Var.a == 0 && ((Integer) objArr[0]).intValue() == 5) || (n1Var.a == 1 && ((Integer) objArr[0]).intValue() == 0))) {
                        m1 m1Var = n1Var.c;
                        if (m1Var.E == null) {
                            m1Var.D(null);
                        }
