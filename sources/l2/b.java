...
public final class b implements d0, d1, v2.g {
    ...
    public b(int i10, m2.c cVar, t tVar, int i11, a5.a aVar, g2.c0 c0Var, n2.m mVar, n2.j jVar, qb.b bVar, a5.a aVar2, long j3, y2.n nVar, y2.d dVar, ob.a aVar3, e0 e0Var, j2.k kVar) {
        ...
        for (int i16 = 0; i16 < size2; i16++) {
            int[] f7 = z7.f((Collection) arrayList.get(i16));
            iArr2[i16] = f7;
            Arrays.sort(f7);
        }
        ...
        for (v2.h hVar : this.H) {
            ...
            if (hVar.y()) {
                ...
                if (aVar != null) {
                    ...
                    long d = hVar.d();
                    G = b1Var.G(j3, d == Long.MIN_VALUE || j3 < d);
                }
                if (G) {
    ...
    public final void i(long j3) {
        ...
        for (v2.h hVar : this.H) {
            if (!hVar.y()) {
                ...
                if (i11 > i10) {
                    synchronized (b1Var2) {
                        j10 = b1Var2.p == 0 ? Long.MIN_VALUE : b1Var2.n[b1Var2.r];
                    }
                    int i12 = 0;
                    while (true) {
                        b1[] b1VarArr = hVar.y;
    ...
    public final long r(x2.s[] sVarArr, boolean[] zArr, c1[] c1VarArr, boolean[] zArr2, long j3) {
        ...
        for (int i15 = 0; i15 < sVarArr.length; i15++) {
            if (sVarArr[i15] == null || !zArr[i15]) {
                ...
                if (c1Var instanceof v2.h) {
                    ((v2.h) c1Var).B(this);
                } else if (c1Var instanceof v2.f) {
                    v2.f fVar = (v2.f) c1Var;
                    v2.h hVar = fVar.e;
        ...
        while (true) {
            ...
            if ((c1Var2 instanceof u2.q) || (c1Var2 instanceof v2.f)) {
                int f7 = f(i17, iArr3);
                if (f7 == -1) {
                    z11 = c1VarArr[i17] instanceof u2.q;
                } else {
                    c1 c1Var3 = c1VarArr[i17];
                    z11 = (c1Var3 instanceof v2.f) && ((v2.f) c1Var3).a == c1VarArr[f7];
                }
                if (!z11) {
                    c1 c1Var4 = c1VarArr[i17];
                    if (c1Var4 instanceof v2.f) {
                        v2.f fVar2 = (v2.f) c1Var4;
                        v2.h hVar2 = fVar2.e;
            ...
            if (sVar2 == null) {
                ...
                if (c1Var5 == null) {
                    ...
                    if (i20 == 0) {
                        ...
                        n nVar3 = nVar;
                        i11 = i19;
                        v2.h hVar3 = new v2.h(aVar.b, iArr4, sVarArr2, new k((p) aVar2.d, nVar2, cVar, tVar, i24, iArr5, sVar2, i25, createDataSource, j10, aVar2.b, z12, arrayList, nVar), this, this.r, j3, this.d, this.F, this.e, this.E, this.N);
                        synchronized (this) {
                        ...
                        i11 = i19;
                        if (i20 == 2) {
                            c1VarArr[i11] = new l((m2.g) this.M.get(aVar.d), sVar2.b().d[0], this.K.d);
                        }
                    }
                } else {
                    iArr2 = iArr3;
                    i11 = i19;
                    if (c1Var5 instanceof v2.h) {
                        ((v2.h) c1Var5).e.j = sVar2;
                    }
                }
            }
            i19 = i11 + 1;
        ...
        while (i26 < sVarArr.length) {
            if (c1VarArr[i26] != null || sVarArr[i26] == null) {
                iArr = iArr6;
            } else {
        ...
        for (c1 c1Var6 : c1VarArr) {
            if (c1Var6 instanceof v2.h) {
                arrayList2.add((v2.h) c1Var6);
        ...
        ob.a aVar4 = this.w;
        AbstractList w10 = q.w(arrayList2, new j2.e(21));
        aVar4.getClass();
