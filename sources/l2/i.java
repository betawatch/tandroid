...
public final class i extends u2.a {
    ...
    public final void A() {
        ...
        y2.q qVar = new y2.q(this.z, new g2.m(uri, 1, null, map, 0L, -1L, null, 1), 4, this.r);
        g gVar = this.s;
        this.m.getClass();
    ...
    public final u2.e0 c(g0 g0Var, y2.d dVar, long j3) {
        int intValue = ((Integer) g0Var.a).intValue() - this.O;
        a5.a b10 = b(g0Var);
    ...
    public final void w(y2.q qVar, long j3) {
        ...
        u uVar = new u(j3);
        this.m.getClass();
        this.q.m(uVar, qVar.c, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L);
    }
    ...
    public final void y(boolean z10) {
        ...
        while (true) {
            ...
            if (keyAt >= this.O) {
                ...
                qVar.n = z14;
                qVar.f = cVar2;
                Iterator it = qVar.e.entrySet().iterator();
                while (it.hasNext()) {
                    if (((Long) ((Map.Entry) it.next()).getKey()).longValue() < qVar.f.h) {
                        it.remove();
                    }
                }
                v2.h[] hVarArr = bVar.H;
                    ...
                    for (v2.h hVar : hVarArr) {
                        ...
                        try {
                            ...
                            for (int i13 = 0; i13 < kVarArr.length; i13++) {
                                try {
                                    kVarArr[i13] = kVarArr[i13].a(d10, (m2.m) a2.get(mVar.j.h(i13)));
                                } catch (u2.b e) {
                                    e = e;
                                    mVar.m = e;
                                }
                ...
                for (n nVar : bVar.I) {
                    ...
                    while (true) {
                        if (it2.hasNext()) {
                            ...
                            if (gVar.a().equals(nVar.e.a())) {
                                nVar.b(gVar, cVar2.d && i12 == cVar2.m.size() + (-1));
                            }
                        }
                    }
                }
        ...
        while (true) {
            ...
            if ((!u10 || !z15) && !list2.isEmpty()) {
                j d13 = ((m2.m) list2.get(0)).d();
                if (d13 != null && d13.M(d12, Q2) != 0) {
                    j21 = Math.max(j21, d13.a(d13.i(d12, Q2)) + j22);
                }
            }
            i14++;
            Q3 = j22;
            ...
            if (i17 != 1 && i17 != 2) {
                ...
                if ((z16 || !z13) && !list4.isEmpty()) {
                    ...
                    if (M == j3) {
                        ...
                        long i18 = (d.i(d11, Q2) + M) - 1;
                        j24 = Math.min(j24, d.c(i18, d11) + d.a(i18) + j25);
                    }
                }
                i16++;
                u11 = z16;
        ...
        if (this.H.d) {
            for (int i19 = 0; i19 < list3.size(); i19++) {
                j d14 = ((m2.m) ((m2.a) list3.get(i19)).c.get(0)).d();
                if (d14 != null && !d14.E()) {
                }
            }
            z11 = true;
            ...
            if (cVar.d) {
                ...
                if (j36 > j35) {
                    ...
                    j17 = j34;
                    j18 = Q5;
                    j19 = d0.i(d0.e0(Q5 - Math.min(j38, j27 / 2)), j34, j35);
                } else {
                    j16 = 2;
                    j17 = j34;
                    j18 = Q5;
                ...
                long e042 = d0.e0(j10) + this.H.a;
                Q = j18 - d0.Q(this.E.a);
                min = Math.min(j38, j27 / j16);
                if (Q >= min) {
                }
            }
            long Q6 = j10 - d0.Q(b10.b);
            m2.c cVar4 = this.H;
            ...
            if (this.h) {
                ...
                if (z12) {
                    ...
                    long Q8 = d0.Q(A);
                    long Q9 = d0.Q(cVar6.a);
                    long Q10 = d0.Q(cVar6.e);
                    if (Q10 == j12 || Q10 >= 5000000) {
                        Q10 = 5000000;
                    }
                    int i20 = 0;
                    while (i20 < list5.size()) {
                        List list6 = ((m2.a) list5.get(i20)).c;
                        if (list6.isEmpty()) {
                            i10 = i20;
                        } else {
                            i10 = i20;
                            j d16 = ((m2.m) list6.get(0)).d();
                            if (d16 != null) {
                                long k10 = (d16.k(d15, Q8) + (Q9 + Q7)) - Q8;
                                if (k10 > j3 && (k10 < Q10 - 100000 || (k10 > Q10 && k10 < Q10 + 100000))) {
                                    Q10 = k10;
                                }
                            }
                        }
