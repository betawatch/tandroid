...
public class j0 extends w0 {
    ...
    public final int C0(j1 j1Var) {
        if (r() != 0) {
            ...
            boolean z11 = this.v;
            if (r() != 0 && j1Var.b() != 0 && K0 != null && J0 != null) {
                int max = z11 ? Math.max(0, (j1Var.b() - Math.max(((x0) K0.getLayoutParams()).b(), ((x0) J0.getLayoutParams()).b())) - 1) : Math.max(0, Math.min(((x0) K0.getLayoutParams()).b(), ((x0) J0.getLayoutParams()).b()));
                if (z4) {
    ...
    public final int H0(bf.f fVar, h0 h0Var, j1 j1Var, boolean z4) {
        ...
        while (true) {
            if ((!h0Var.l && i12 <= 0) || !h0Var.b(j1Var)) {
                break;
            }
            g0 g0Var = this.D;
            g0Var.a = 0;
            ...
            if (!g0Var.b) {
                ...
                if (!g0Var.c || h0Var.k != null || !j1Var.g) {
                    h0Var.c -= i14;
                    i12 -= i14;
                }
                int i15 = h0Var.g;
    ...
    public View R(View view, int i10, bf.f fVar, j1 j1Var) {
        ...
        if (r() != 0 && (F0 = F0(i10)) != Integer.MIN_VALUE) {
            G0();
            m1(F0, (int) (this.q.k() * 0.33333334f), false, j1Var);
            h0 h0Var = this.p;
    ...
    */
    public void b0(bf.f fVar, j1 j1Var) {
        ...
        j1 j1Var2 = j1Var;
        int i18 = -1;
        if (!(j0Var.B == null && j0Var.y == -1) && j1Var2.b() == 0) {
            g0(fVar);
            return;
        }
        i0 i0Var = j0Var.B;
        ...
        b4.v vVar = j0Var.C;
        if (vVar.e && j0Var.y == -1 && j0Var.B == null) {
            if (view != null && (j0Var.q.d(view) >= j0Var.q.f() || j0Var.q.a(view) <= j0Var.q.j())) {
                vVar.d(((x0) view.getLayoutParams()).b(), view);
            }
            fVar2 = fVar;
        } else {
            vVar.f();
            vVar.d = j0Var.v ^ j0Var.w;
            if (!j1Var2.g && (i10 = j0Var.y) != -1) {
                if (i10 < 0 || i10 >= j1Var2.b()) {
                    j0Var.y = -1;
                    ...
                    if (i0Var2 != null && i0Var2.a >= 0) {
                        ...
                        vVar.d = z4;
                        if (z4) {
                            vVar.c = j0Var.q.f() - j0Var.B.b;
                        } else {
                            vVar.c = j0Var.q.j() + j0Var.B.b;
                        }
                    } else if (j0Var.A == Integer.MIN_VALUE) {
                        View m10 = j0Var.m(i19);
                        if (m10 == null) {
                            if (j0Var.r() > 0) {
                                vVar.d = (j0Var.y < w0.H(j0Var.q(0))) == j0Var.z;
                            }
                            vVar.b();
                        } else if (j0Var.q.b(m10) > j0Var.q.k()) {
                            vVar.b();
                        } else if (j0Var.q.d(m10) - j0Var.q.j() < 0) {
                            vVar.c = j0Var.q.j();
                            vVar.d = false;
                        } else if (j0Var.q.f() - j0Var.q.a(m10) < 0) {
                            vVar.c = j0Var.q.f();
                            vVar.d = true;
                        } else {
                            if (vVar.d) {
                                int a2 = j0Var.q.a(m10);
                        ...
                        vVar.d = z10;
                        if (z10) {
                            vVar.c = j0Var.q.f() - j0Var.A;
                        } else {
                            vVar.c = j0Var.q.j() + j0Var.A;
                        }
                    }
                    fVar2 = fVar;
                    vVar.e = true;
            ...
            if (j0Var.r() != 0) {
                ...
                if (view2 != null) {
                    ...
                    if (!x0Var.a.j() && x0Var.b() >= 0 && x0Var.b() < j1Var2.b()) {
                        vVar.d(((x0) view2.getLayoutParams()).b(), view2);
                        fVar2 = fVar;
                        vVar.e = true;
                    }
                }
                if (j0Var.s == j0Var.w) {
                    if (vVar.d) {
                        if (j0Var.v) {
                            Q0 = j0Var.Q0(fVar, j1Var2, 0, j0Var.r(), j1Var2.b());
                            j0Var = this;
                        } else {
                            j0Var = this;
                            Q0 = j0Var.Q0(fVar, j1Var, r() - 1, -1, j1Var.b());
                        }
                        fVar2 = fVar;
                        j1Var2 = j1Var;
                    } else if (j0Var.v) {
                        fVar2 = fVar;
                        j1Var2 = j1Var;
                        Q0 = j0Var.Q0(fVar2, j1Var2, j0Var.r() - 1, -1, j1Var.b());
                        j0Var = this;
                    } else {
                        j0Var = this;
                        fVar2 = fVar;
                        j1Var2 = j1Var;
                        Q0 = j0Var.Q0(fVar2, j1Var2, 0, r(), j1Var.b());
                    }
                    if (Q0 != null) {
                        vVar.c(((x0) Q0.getLayoutParams()).b(), Q0);
                        if (!j1Var2.g && j0Var.y0() && (j0Var.q.d(Q0) >= j0Var.q.f() || j0Var.q.a(Q0) < j0Var.q.j())) {
                            vVar.c = vVar.d ? j0Var.q.f() : j0Var.q.j();
                        }
                        vVar.e = true;
                    }
                    vVar.b();
                    vVar.b = !j0Var.w ? j1Var2.b() - 1 : j0Var.R0();
                    vVar.e = true;
                }
            }
            fVar2 = fVar;
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        j0Var.z0(j1Var2, iArr);
        int j10 = j0Var.q.j() + Math.max(0, iArr[0]);
        int g10 = j0Var.q.g() + Math.max(0, iArr[1]);
        if (j1Var2.g && (i15 = j0Var.y) != -1 && j0Var.A != Integer.MIN_VALUE && (m9 = j0Var.m(i15)) != null) {
            if (j0Var.z) {
                i16 = j0Var.q.f() - j0Var.q.a(m9);
                d10 = j0Var.A;
            } else {
                d10 = j0Var.q.d(m9) - j0Var.q.j();
                i16 = j0Var.A;
            }
            int i20 = i16 - d10;
            if (i20 > 0) {
        ...
        if (!vVar.d ? !j0Var.v : j0Var.v) {
            i18 = 1;
        }
        j0Var.a1(fVar2, j1Var2, vVar, i18);
        for (int r10 = j0Var.r() - 1; r10 >= 0; r10--) {
            View q10 = j0Var.q(r10);
            m1 U = RecyclerView.U(q10);
            if (U != null && !U.r()) {
        ...
        j0Var.p.i = 0;
        if (vVar.d) {
            j0Var.o1(vVar.b, vVar.c);
            h0 h0Var2 = j0Var.p;
            h0Var2.h = j10;
            j0Var.H0(fVar2, h0Var2, j1Var2, false);
            h0 h0Var3 = j0Var.p;
            i12 = h0Var3.b;
            int i21 = h0Var3.d;
            int i22 = h0Var3.c;
            ...
            j0Var.n1(vVar.b, vVar.c);
            h0 h0Var4 = j0Var.p;
            h0Var4.h = g10;
            h0Var4.d += h0Var4.e;
            j0Var.H0(fVar2, h0Var4, j1Var2, false);
            h0 h0Var5 = j0Var.p;
            i11 = h0Var5.b;
            int i23 = h0Var5.c;
            if (i23 > 0) {
                ...
                h0 h0Var6 = j0Var.p;
                h0Var6.h = i23;
                j0Var.H0(fVar2, h0Var6, j1Var2, false);
                i12 = j0Var.p.b;
            }
        } else {
            j0Var.n1(vVar.b, vVar.c);
            h0 h0Var7 = j0Var.p;
            h0Var7.h = g10;
            j0Var.H0(fVar2, h0Var7, j1Var2, false);
            h0 h0Var8 = j0Var.p;
            i11 = h0Var8.b;
            int i24 = h0Var8.d;
            int i25 = h0Var8.c;
            ...
            h0Var9.h = j10;
            h0Var9.d += h0Var9.e;
            j0Var.H0(fVar2, h0Var9, j1Var2, false);
            h0 h0Var10 = j0Var.p;
            i12 = h0Var10.b;
            int i26 = h0Var10.c;
            if (i26 > 0) {
                ...
                h0 h0Var11 = j0Var.p;
                h0Var11.h = i26;
                j0Var.H0(fVar2, h0Var11, j1Var2, false);
                i11 = j0Var.p.b;
            }
        }
        if (j0Var.r() > 0) {
            if (j0Var.v ^ j0Var.w) {
                int S02 = j0Var.S0(i11, fVar2, j1Var2, true);
                i13 = i12 + S02;
                i14 = i11 + S02;
                S0 = j0Var.T0(i13, fVar2, j1Var2, false);
            } else {
                int T0 = j0Var.T0(i12, fVar2, j1Var2, true);
                i13 = i12 + T0;
                i14 = i11 + T0;
                S0 = j0Var.S0(i14, fVar2, j1Var2, false);
            }
            i12 = i13 + S0;
            i11 = i14 + S0;
        }
        if (j1Var2.k && j0Var.r() != 0 && !j1Var2.g && j0Var.y0()) {
            List list2 = (List) fVar2.f;
            int size = list2.size();
            ...
            if (i27 > 0) {
                ...
                h0Var12.c = 0;
                h0Var12.a(null);
                j0Var.H0(fVar2, j0Var.p, j1Var2, false);
            }
            if (i28 > 0) {
    ...
    public final void c1(bf.f fVar, h0 h0Var) {
        ...
        int e6 = (this.q.e() - i10) + i11;
        if (this.v) {
            for (int i12 = 0; i12 < r10; i12++) {
                View q10 = q(i12);
                if (q10 != null && (T2 = this.b.T(q10)) != null && !T2.r() && (this.q.d(q10) < e6 || this.q.m(q10) < e6)) {
                    d1(fVar, 0, i12);
                    return;
                }
            }
        ...
        for (int i14 = i13; i14 >= 0; i14--) {
            View q11 = q(i14);
            if (q11 != null && (T = this.b.T(q11)) != null && !T.r() && (this.q.d(q11) < e6 || this.q.m(q11) < e6)) {
                d1(fVar, i13, i14);
                return;
            }
        }
    ...
    public final int g1(int i10, bf.f fVar, j1 j1Var) {
        ...
        h0 h0Var = this.p;
        int H0 = H0(fVar, h0Var, j1Var, false) + h0Var.g;
        if (H0 < 0) {
            return 0;
        }
        if (abs > H0) {
