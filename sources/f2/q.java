...
public abstract class q {
    ...
    */
    public static m c(q qVar, boolean z10) {
        ...
        oVar.d = d;
        arrayList2.add(oVar);
        int abs = Math.abs(e9 - d) + e9 + d;
        int i18 = abs * 2;
        int[] iArr3 = new int[i18];
        int[] iArr4 = new int[i18];
        ArrayList arrayList3 = new ArrayList();
        while (!arrayList2.isEmpty()) {
            o oVar2 = (o) com.google.android.recaptcha.internal.a.k(1, arrayList2);
            int i19 = oVar2.a;
            int i20 = oVar2.b;
            int i21 = oVar2.c;
            int i22 = i20 - i19;
            ...
            if (pVar != null) {
                ...
                pVar.a += oVar2.a;
                pVar.b += oVar2.c;
                o oVar3 = arrayList3.isEmpty() ? new o() : (o) com.google.android.recaptcha.internal.a.k(1, arrayList3);
                oVar3.a = oVar2.a;
                oVar3.c = oVar2.c;
                if (pVar.e) {
                    oVar3.b = pVar.a;
