...
public abstract class w0 {
    ...
    */
    ...
    public void P(View view) {
        ...
        int s6 = s(d(), this.m, this.k, E() + D() + ((ViewGroup.MarginLayoutParams) x0Var).leftMargin + ((ViewGroup.MarginLayoutParams) x0Var).rightMargin + i10, ((ViewGroup.MarginLayoutParams) x0Var).width);
        int s9 = s(e(), this.n, this.l, C() + F() + ((ViewGroup.MarginLayoutParams) x0Var).topMargin + ((ViewGroup.MarginLayoutParams) x0Var).bottomMargin + i11, ((ViewGroup.MarginLayoutParams) x0Var).height);
    ...
    public final void T(View view, s0.d dVar) {
        ...
        RecyclerView recyclerView = this.b;
        U(recyclerView.b, recyclerView.q0, view, dVar);
    }
    ...
    public final void a(View view, int i10, boolean z4) {
        ...
        if (U.s() || U.k()) {
            ...
            int y10 = (indexOfChild == -1 || cVar.D(indexOfChild)) ? -1 : indexOfChild - cVar.y(indexOfChild);
            if (i10 == -1) {
                i10 = this.a.p();
            }
            if (y10 == -1) {
            ...
            if (y10 != i10) {
                ...
                if (q10 == null) {
                    throw new IllegalArgumentException("Cannot move a child from non-existing index:" + y10 + w0Var.b.toString());
                }
                w0Var.q(y10);
                w0Var.a.k(y10);
            ...
            if (i1Var != null && i1Var.e) {
                i1Var.b.getClass();
                if (RecyclerView.S(view) == i1Var.a) {
                    i1Var.f = view;
                }
            }
        }
    ...
    public final void h0(bf.f fVar) {
        ...
        for (int i10 = size - 1; i10 >= 0; i10--) {
            View view = ((m1) arrayList2.get(i10)).a;
            m1 U = RecyclerView.U(view);
            if (!U.r()) {
                U.q(false);
                if (U.l()) {
    ...
    public final void j0(int i10) {
        if (q(i10) != null) {
            ...
            View childAt = ((RecyclerView) cVar.a).getChildAt(s6);
            if (childAt == null) {
                return;
            }
            if (((c) eVar.c).G(s6)) {
    ...
    */
    ...
    public final void w0(i1 i1Var) {
        i1 i1Var2 = this.e;
        if (i1Var2 != null && i1Var != i1Var2 && i1Var2.e) {
            i1Var2.h();
        }
        this.e = i1Var;
        RecyclerView recyclerView = this.b;
