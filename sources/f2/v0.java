...
public abstract class v0 {
    ...
    public v0() {
        ...
        a3.c cVar = new a3.c(this, 13);
        this.c = new bf.b((p1) f0Var);
        this.d = new bf.b((p1) cVar);
        this.f = false;
        this.g = true;
        this.h = true;
    }
    ...
    */
    ...
    public abstract View R(View view, int i10, bf.f fVar, i1 i1Var);

    public void S(bf.f fVar, i1 i1Var, s0.e eVar) {
        ...
        accessibilityNodeInfo.setCollectionInfo(AccessibilityNodeInfo.CollectionInfo.obtain(I(fVar, i1Var), u(fVar, i1Var), false, 0));
    }

    public final void T(View view, s0.e eVar) {
        l1 U = RecyclerView.U(view);
        if (U == null || U.j()) {
            return;
        }
        androidx.biometric.e eVar2 = this.a;
        if (((ArrayList) eVar2.d).contains(U.a)) {
            return;
        }
        RecyclerView recyclerView = this.b;
        U(recyclerView.b, recyclerView.q0, view, eVar);
    }

    public void U(bf.f fVar, i1 i1Var, View view, s0.e eVar) {
        eVar.a.setCollectionItemInfo(AccessibilityNodeInfo.CollectionItemInfo.obtain(e() ? H(view) : 0, 1, d() ? H(view) : 0, 1, false, false));
    }
    ...
    public final void a(View view, int i10, boolean z4) {
        ...
        if (U.s() || U.k()) {
            ...
            this.a.h(view, i10, view.getLayoutParams(), false);
        } else if (view.getParent() == this.b) {
            androidx.biometric.e eVar = this.a;
            c cVar = (c) eVar.c;
            int indexOfChild = ((RecyclerView) ((a3.c) eVar.b).b).indexOfChild(view);
            int z10 = (indexOfChild == -1 || cVar.C(indexOfChild)) ? -1 : indexOfChild - cVar.z(indexOfChild);
            if (i10 == -1) {
                i10 = this.a.r();
            }
            if (z10 == -1) {
            ...
            if (z10 != i10) {
                v0 v0Var = this.b.x;
                View q10 = v0Var.q(z10);
                if (q10 == null) {
                    throw new IllegalArgumentException("Cannot move a child from non-existing index:" + z10 + v0Var.b.toString());
                }
                v0Var.q(z10);
                v0Var.a.l(z10);
    ...
    public abstract void b0(bf.f fVar, i1 i1Var);
    ...
    public void d0(bf.f fVar, i1 i1Var, int i10, int i11) {
        this.b.q(i10, i11);
    }
    ...
    public final void j0(int i10) {
        if (q(i10) != null) {
            ...
            View childAt = ((RecyclerView) cVar.b).getChildAt(t6);
            if (childAt == null) {
                return;
            }
            if (((c) eVar.c).E(t6)) {
    ...
    */
    ...
    public abstract int m0(int i10, bf.f fVar, i1 i1Var);
    ...
    public abstract int o0(int i10, bf.f fVar, i1 i1Var);
