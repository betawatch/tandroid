...
public class i0 extends v0 {
    ...
    public final int H0(bf.f fVar, g0 g0Var, i1 i1Var, boolean z4) {
        int i10 = g0Var.c;
        int i11 = g0Var.g;
    ...
    public View Q0(bf.f fVar, i1 i1Var, int i10, int i11, int i12) {
        G0();
    ...
    @Override // f2.v0
    public View R(View view, int i10, bf.f fVar, i1 i1Var) {
        int F0;
        f1();
    ...
    public final int S0(int i10, bf.f fVar, i1 i1Var, boolean z4) {
        int f10;
        int f11;
        if (!this.G || !this.H || (f10 = this.q.f() - i10) <= 0) {
            return 0;
        }
        int i11 = -g1(-f10, fVar, i1Var);
        int i12 = i10 + i11;
    ...
    public final int T0(int i10, bf.f fVar, i1 i1Var, boolean z4) {
        int X0;
        int j10;
        if (!this.G || (X0 = i10 - X0()) <= 0) {
            return 0;
        }
        int i11 = -g1(X0, fVar, i1Var);
        int i12 = i10 + i11;
    ...
    */
    public void b0(bf.f fVar, i1 i1Var) {
        ...
        if (vVar.e && i0Var.y == -1 && i0Var.B == null) {
            ...
            if (i0Var.r() != 0) {
                ...
                if (i0Var.s == i0Var.w) {
                    if (vVar.d) {
                        if (i0Var.v) {
                            Q0 = i0Var.Q0(fVar, i1Var2, 0, i0Var.r(), i1Var2.b());
                            i0Var = this;
                        } else {
                            i0Var = this;
                            Q0 = i0Var.Q0(fVar, i1Var, r() - 1, -1, i1Var.b());
                        }
                        fVar2 = fVar;
                        i1Var2 = i1Var;
                    } else if (i0Var.v) {
                        fVar2 = fVar;
                        i1Var2 = i1Var;
                        Q0 = i0Var.Q0(fVar2, i1Var2, i0Var.r() - 1, -1, i1Var.b());
                        i0Var = this;
                    } else {
                        i0Var = this;
                        fVar2 = fVar;
                        i1Var2 = i1Var;
                        Q0 = i0Var.Q0(fVar2, i1Var2, 0, r(), i1Var.b());
                    }
                    if (Q0 != null) {
        ...
        i0Var.a1(fVar2, i1Var2, vVar, i18);
        ...
        if (vVar.d) {
            ...
            g0 g0Var2 = i0Var.p;
            g0Var2.h = j10;
            i0Var.H0(fVar2, g0Var2, i1Var2, false);
            g0 g0Var3 = i0Var.p;
            i12 = g0Var3.b;
            int i21 = g0Var3.d;
            int i22 = g0Var3.c;
            ...
            g0Var4.h = g10;
            g0Var4.d += g0Var4.e;
            i0Var.H0(fVar2, g0Var4, i1Var2, false);
            g0 g0Var5 = i0Var.p;
            i11 = g0Var5.b;
            int i23 = g0Var5.c;
            if (i23 > 0) {
                ...
                g0 g0Var6 = i0Var.p;
                g0Var6.h = i23;
                i0Var.H0(fVar2, g0Var6, i1Var2, false);
                i12 = i0Var.p.b;
            }
        } else {
            i0Var.n1(vVar.b, vVar.c);
            g0 g0Var7 = i0Var.p;
            g0Var7.h = g10;
            i0Var.H0(fVar2, g0Var7, i1Var2, false);
            g0 g0Var8 = i0Var.p;
            i11 = g0Var8.b;
            int i24 = g0Var8.d;
            int i25 = g0Var8.c;
            ...
            g0Var9.h = j10;
            g0Var9.d += g0Var9.e;
            i0Var.H0(fVar2, g0Var9, i1Var2, false);
            g0 g0Var10 = i0Var.p;
            i12 = g0Var10.b;
            int i26 = g0Var10.c;
            if (i26 > 0) {
                ...
                g0 g0Var11 = i0Var.p;
                g0Var11.h = i26;
                i0Var.H0(fVar2, g0Var11, i1Var2, false);
                i11 = i0Var.p.b;
            }
        }
        if (i0Var.r() > 0) {
            if (i0Var.v ^ i0Var.w) {
                int S02 = i0Var.S0(i11, fVar2, i1Var2, true);
                i13 = i12 + S02;
                i14 = i11 + S02;
                S0 = i0Var.T0(i13, fVar2, i1Var2, false);
            } else {
                int T0 = i0Var.T0(i12, fVar2, i1Var2, true);
                i13 = i12 + T0;
                i14 = i11 + T0;
                S0 = i0Var.S0(i14, fVar2, i1Var2, false);
            }
            i12 = i13 + S0;
            i11 = i14 + S0;
        }
        if (i1Var2.k && i0Var.r() != 0 && !i1Var2.g && i0Var.y0()) {
            ...
            if (i27 > 0) {
                ...
                g0Var12.c = 0;
                g0Var12.a(null);
                i0Var.H0(fVar2, i0Var.p, i1Var2, false);
            }
            if (i28 > 0) {
    ...
    public final void c1(bf.f fVar, g0 g0Var) {
        l1 T;
        l1 T2;
        if (!g0Var.a || g0Var.l) {
            return;
    ...
    public final int g1(int i10, bf.f fVar, i1 i1Var) {
        if (r() == 0 || i10 == 0) {
            return 0;
        }
        G0();
        ...
        g0 g0Var = this.p;
        int H0 = H0(fVar, g0Var, i1Var, false) + g0Var.g;
        if (H0 < 0) {
            return 0;
        }
        if (abs > H0) {
    ...
    public final void j1(int i10) {
        l0 l0Var;
        if (i10 != 0 && i10 != 1) {
            throw new IllegalArgumentException(a2.j(i10, "invalid orientation:"));
        }
        b(null);
    ...
    @Override // f2.v0
    public int m0(int i10, bf.f fVar, i1 i1Var) {
        if (this.o == 1) {
            return 0;
        }
        return g1(i10, fVar, i1Var);
    }
    ...
    public void a1(bf.f fVar, i1 i1Var, b4.v vVar, int i10) {
    }
}
