...
public abstract class x0 {
    ...
    */
    ...
    public static int v(View view) {
        return view.getBottom() + ((y0) view.getLayoutParams()).b.bottom;
    }
    ...
    public static int x(View view) {
        return view.getLeft() - ((y0) view.getLayoutParams()).b.left;
    }
    ...
    public static int y(View view) {
        return view.getRight() + ((y0) view.getLayoutParams()).b.right;
    }

    public static int z(View view) {
        return view.getTop() - ((y0) view.getLayoutParams()).b.top;
    }
    ...
    public void P(View view) {
        ...
        int s10 = s(d(), this.m, this.k, E() + D() + ((ViewGroup.MarginLayoutParams) y0Var).leftMargin + ((ViewGroup.MarginLayoutParams) y0Var).rightMargin + i10, ((ViewGroup.MarginLayoutParams) y0Var).width);
        int s11 = s(e(), this.n, this.l, C() + F() + ((ViewGroup.MarginLayoutParams) y0Var).topMargin + ((ViewGroup.MarginLayoutParams) y0Var).bottomMargin + i11, ((ViewGroup.MarginLayoutParams) y0Var).height);
        if (u0(view, s10, s11, y0Var)) {
    ...
    public final void T(View view, s0.c cVar) {
        ...
        a5.n nVar = this.a;
        if (((ArrayList) nVar.d).contains(U.a)) {
            return;
        }
        RecyclerView recyclerView = this.b;
    ...
    public final void a(View view, int i10, boolean z10) {
        ...
        if (U.s() || U.k()) {
            ...
            int z11 = (indexOfChild == -1 || cVar.I(indexOfChild)) ? -1 : indexOfChild - cVar.z(indexOfChild);
            if (i10 == -1) {
                i10 = this.a.o();
            }
            if (z11 == -1) {
            ...
            if (z11 != i10) {
                ...
                View q6 = x0Var.q(z11);
                if (q6 == null) {
                    throw new IllegalArgumentException("Cannot move a child from non-existing index:" + z11 + x0Var.b.toString());
                }
                x0Var.q(z11);
                x0Var.a.k(z11);
                y0 y0Var2 = (y0) q6.getLayoutParams();
                o1 U2 = RecyclerView.U(q6);
                if (U2.j()) {
                    a0.f fVar2 = (a0.f) x0Var.b.f.b;
                    u1 u1Var2 = (u1) fVar2.get(U2);
                    if (u1Var2 == null) {
                        u1Var2 = u1.a();
                        fVar2.put(U2, u1Var2);
                    }
            ...
            if (k1Var != null && k1Var.e) {
                k1Var.b.getClass();
                if (RecyclerView.S(view) == k1Var.a) {
                    k1Var.f = view;
                }
            }
        }
    ...
    public final void h0(e1 e1Var) {
        ...
        ArrayList arrayList2 = (ArrayList) e1Var.c;
        int size = arrayList.size();
        for (int i10 = size - 1; i10 >= 0; i10--) {
            View view = ((o1) arrayList2.get(i10)).a;
            o1 U = RecyclerView.U(view);
            if (!U.r()) {
                U.q(false);
                if (U.l()) {
    ...
    public final void j0(int i10) {
        if (q(i10) != null) {
            ...
            View childAt = ((RecyclerView) iVar.b).getChildAt(r10);
            if (childAt == null) {
                return;
            }
            if (((c) nVar.c).K(r10)) {
    ...
    */
    ...
    public final boolean u0(View view, int i10, int i11, y0 y0Var) {
        return (!view.isLayoutRequested() && this.g && N(view.getWidth(), i10, ((ViewGroup.MarginLayoutParams) y0Var).width) && N(view.getHeight(), i11, ((ViewGroup.MarginLayoutParams) y0Var).height)) ? false : true;
    }
    ...
    public final void w0(k1 k1Var) {
        k1 k1Var2 = this.e;
        if (k1Var2 != null && k1Var != k1Var2 && k1Var2.e) {
            k1Var2.h();
        }
        this.e = k1Var;
        RecyclerView recyclerView = this.b;
