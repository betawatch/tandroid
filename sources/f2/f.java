        ...
        switch (this.a) {
            ...
            default:
                ...
                for (int size3 = arrayList3.size() - 1; size3 >= 0; size3--) {
                    i12 = Math.min(i12, ((o1) arrayList3.get(size3)).b());
                }
                ...
                while (true) {
                    ...
                    if (size4 < 0) {
                        ...
                        long b10 = (o1Var.b() - i12) * lVar3.D;
                        View view = o1Var.a;
                        ViewPropertyAnimator animate = view.animate();
                        lVar3.y.add(o1Var);
                        animate.alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(lVar3.h()).setStartDelay(b10).setInterpolator(lVar3.h);
                        animate.setUpdateListener(new d(lVar3, o1Var, 1));
                        animate.setListener(new g(lVar3, o1Var, view, animate)).start();
                    }
                }
        }
    }
