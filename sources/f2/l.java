...
public class l extends r1 {
    ...
    public void C(o1 o1Var, k kVar) {
        ...
        this.z.add(o1Var);
        animate.setUpdateListener(new t2(1, this, o1Var));
        ...
        animate.setDuration(j()).setStartDelay(0L).setListener(new h(this, o1Var, i14, view, i15, animate, 0)).start();
    }
    ...
    public void D(o1 o1Var) {
        ...
        animate.setUpdateListener(new d(this, o1Var, 0));
        animate.setListener(new g(this, o1Var, animate, view)).start();
    }

    public final void E(ArrayList arrayList) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ((o1) arrayList.get(size)).a.animate().cancel();
        }
    }
    ...
    public final void H(ArrayList arrayList, o1 o1Var) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ...
            if (J(jVar, o1Var) && jVar.a == null && jVar.b == null) {
    ...
    public final void R(o1 o1Var) {
        ...
        o1Var.a.animate().setInterpolator(E);
        f(o1Var);
    }
    ...
    public void f(o1 o1Var) {
        ...
        while (true) {
            ...
            if (((k) arrayList.get(size)).a == o1Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                v(o1Var);
        ...
        for (int size3 = arrayList4.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                ...
                if (((k) arrayList5.get(size4)).a == o1Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    v(o1Var);
        ...
        if (this.y.remove(o1Var) && BuildVars.DEBUG_VERSION) {
            throw new IllegalStateException("after animation is cancelled, item should not be in mAddAnimations list");
        }
        if (this.B.remove(o1Var) && BuildVars.DEBUG_VERSION) {
            throw new IllegalStateException("after animation is cancelled, item should not be in mChangeAnimations list");
        }
        if (this.z.remove(o1Var) && BuildVars.DEBUG_VERSION) {
    ...
    public void m() {
        ...
        View view3 = ((o1) arrayList7.get(0)).a;
    ...
    public boolean q(o1 o1Var, o1 o1Var2, d5.p pVar, int i10, int i11, int i12, int i13) {
        ...
        this.s.add(new j(o1Var, o1Var2, i10, i11, i12, i13));
        F();
        return true;
    }
    ...
    public boolean r(o1 o1Var, d5.p pVar, int i10, int i11, int i12, int i13) {
        ...
        int translationY = i11 + ((int) o1Var.a.getTranslationY());
        R(o1Var);
        ...
        this.r.add(new k(o1Var, translationX, translationY, i12, i13));
        F();
        return true;
    }
