...
public final class e implements z0, m0, n2.k {
    ...
    public e(x xVar) {
        ...
        this.f = new p(myLooper == null ? Looper.getMainLooper() : myLooper, xVar, new i0.b(19));
        h1 h1Var = new h1();
        this.b = h1Var;
        this.c = new j1();
        n nVar = new n();
    ...
    public final void h(int i10, u2.g0 g0Var, u uVar, c0 c0Var, int i11) {
        a o9 = o(i10, g0Var);
        q(o9, MediaDataController.MAX_STYLE_RUNS_COUNT, new i0.b(o9, uVar, c0Var, i11));
    }
    ...
    public final a m(k1 k1Var, int i10, u2.g0 g0Var) {
        u2.g0 g0Var2 = k1Var.p() ? null : g0Var;
        this.a.getClass();
        long elapsedRealtime = SystemClock.elapsedRealtime();
        boolean z10 = k1Var.equals(this.h.w0()) && i10 == this.h.l0();
        long j3 = 0;
        ...
        } else if (z10 && this.h.k0() == g0Var2.b && this.h.O() == g0Var2.c) {
            j3 = this.h.J0();
        }
    ...
    public final a n(u2.g0 g0Var) {
        this.h.getClass();
        k1 k1Var = g0Var == null ? null : (k1) ((k0) this.d.c).get(g0Var);
        if (g0Var != null && k1Var != null) {
            return m(k1Var, k1Var.g(g0Var.a, this.b).c, g0Var);
        }
        int l02 = this.h.l0();
        k1 w02 = this.h.w0();
        if (l02 >= w02.o()) {
    ...
    public final a o(int i10, u2.g0 g0Var) {
        this.h.getClass();
        if (g0Var != null) {
            return ((k1) ((k0) this.d.c).get(g0Var)) != null ? n(g0Var) : m(k1.a, i10, g0Var);
        }
        k1 w02 = this.h.w0();
        if (i10 >= w02.o()) {
            w02 = k1.a;
    ...
    public final void onPlayerError(u0 u0Var) {
        u2.g0 g0Var;
        a l4 = (!(u0Var instanceof i2.n) || (g0Var = ((i2.n) u0Var).E) == null) ? l() : n(g0Var);
    ...
    public final void onTimelineChanged(k1 k1Var, int i10) {
        ...
        b1Var.getClass();
        n nVar = this.d;
        nVar.d = n.p(b1Var, (i0) nVar.b, (u2.g0) nVar.e, (h1) nVar.a);
        nVar.H(b1Var.w0());
        a l4 = l();
    ...
    public final void r(e0 e0Var, Looper looper) {
        ...
        p pVar = this.f;
        this.f = new p(pVar.d, looper, pVar.a, new cb(16, this, e0Var), pVar.i);
    }
