...
public abstract class u0 {
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, org.telegram.ui.ActionBar.o2 o2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (h()) {
            ...
            BillingController.getInstance().queryProductDetails(Arrays.asList(cVar.a()), new g0(tL_inputStorePaymentPremiumGiftCode, tL_premiumGiftCodeOption, connectionsManager, callback2, callback, o2Var, 0));
            return;
        }
        ...
        connectionsManager2.sendRequest(tL_payments_getPaymentForm, new h0(callback2, messagesController2, tL_inputInvoicePremiumGiftCode, o2Var, callback, 1));
    }
    ...
    public static void m(int i9, ArrayList arrayList) {
        ...
        a.put(Integer.valueOf(i9), new Pair(Long.valueOf(System.currentTimeMillis()), arrayList));
    }
}
