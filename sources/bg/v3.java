...
public class v3 extends k {
    ...
    public v3(Context context, PointF pointF, float f9, float f10, bv0 bv0Var, TLRPC.Document document, Object obj) {
        ...
        this.q0 = new d6(x2Var, 0L, 500L, jr.h);
        this.t0.setAspectFit(true);
        this.t0.setInvalidateAll(true);
        this.t0.setParentView(x2Var);
        ...
        this.t0.setDelegate(new a1.c(this, 11));
        k();
    }
    ...
    public v3(Context context, v3 v3Var, PointF pointF) {
        this(context, pointF, v3Var.getRotation(), v3Var.getScale(), v3Var.r0, v3Var.m0, v3Var.n0);
        if (v3Var.p0) {
            r(false);
        }
    }
