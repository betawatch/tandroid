...
public abstract class n {
    public static SpannableStringBuilder a(String str) {
        try {
            Spanned fromHtml = Build.VERSION.SDK_INT >= 24 ? Html.fromHtml("<inject>" + str + "</inject>", 63, null, new l(new bb.a(10))) : Html.fromHtml("<inject>" + str + "</inject>", null, new l(new bb.a(10)));
            if (fromHtml == null) {
                return null;
            }
            ...
            for (Object obj2 : spans) {
                if (obj2 instanceof URLSpan) {
                    ...
                    if (charSequence.equals(url)) {
                        ...
                        spannableStringBuilder.setSpan(new c51(url, null), spanStart2, spanEnd2, 33);
                    }
                }
            }
            ...
            for (int i12 = 0; i12 < arrayList3.size(); i12++) {
                ...
                qi0.c(spannableStringBuilder, fromHtml.getSpanStart(mVar3), fromHtml.getSpanEnd(mVar3), mVar3.a == 3);
            }
