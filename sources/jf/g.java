...
public final class g {
    ...
    public g(File file, e eVar, ie.i iVar, int i10, int i11, boolean z10, int i12) {
        ...
        File file3 = new File(file2, a4.w.q(sb2, i12 != 0 ? l1.k(i12, "_fitz") : "", ".pcache2"));
        this.m = file3;
    ...
    /* JADX WARN: Type inference failed for: r0v16, types: [android.graphics.drawable.BitmapDrawable, jf.e] */
    /* JADX WARN: Type inference failed for: r0v23, types: [android.graphics.drawable.BitmapDrawable, jf.e] */
    /* JADX WARN: Type inference failed for: r0v29, types: [android.graphics.drawable.BitmapDrawable, jf.e] */
    /* JADX WARN: Type inference failed for: r0v3, types: [android.graphics.drawable.BitmapDrawable, jf.e] */
    /* JADX WARN: Type inference failed for: r2v0, types: [android.graphics.drawable.BitmapDrawable, jf.e] */
    /*
    ...
    public final void b() {
        ...
        if (this.m.exists()) {
            ...
            try {
                ...
                B.a(this.c, this.b);
                j2 j2Var = B;
                bitmapArr = (Bitmap[]) j2Var.d;
                c0[] c0VarArr = (c0[]) j2Var.c;
        ...
        B.a(this.c, this.b);
        j2 j2Var2 = B;
        bitmapArr = (Bitmap[]) j2Var2.d;
        c0[] c0VarArr2 = (c0[]) j2Var2.c;
        countDownLatchArr = new CountDownLatch[y];
                ...
                if (this.q || this.k) {
                    ...
                    try {
                        if (this.e.size() != 0) {
                            ...
                            byte[] e11 = e(fVar);
                            randomAccessFile.readFully(e11, 0, fVar.b);
                            if (this.r) {
                                this.s = null;
                                randomAccessFile.close();
                            } else {
                            ...
                            BitmapFactory.decodeByteArray(e11, 0, fVar.b, this.t);
                            if (z10) {
