...
public final /* synthetic */ class b implements g, b2, MessagesController.ErrorDelegate, MessagesStorage.LongCallback {
    ...
    */
    public void d(Exception exc) {
        ...
        if (this.b) {
            ...
            new Thread(new r3(22, cVar, countDownLatch)).start();
        ...
        switch (this.a) {
            ...
            case 3:
                ...
                if (!TextUtils.isEmpty(trim) && !TextUtils.isEmpty(AndroidUtilities.translitSafe(trim.toString()))) {
                    ...
                    c2 c2Var2 = new c2(context2, 3, z12 ? null : new lh.b());
                    c2Var2.q(250L);
