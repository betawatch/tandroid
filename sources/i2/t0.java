...
public final class t0 {
    ...
    public final x2.v j(float f7, b2.k1 k1Var, boolean z10) {
        ...
        for (int i23 = 0; i23 < fVarArr.length; i23++) {
            int i24 = iArr5[i23];
            o1VarArr[i23] = new u2.o1((b2.l1[]) e2.d0.S(i24, l1VarArr[i23]));
        ...
        while (true) {
            ...
            if (2 == iArr9[i26] && o1VarArr[i26].a > 0) {
                z11 = true;
                break;
            }
            i26++;
        ...
        if ((iVar.A || j3 == null) && o1Var5.a != 2) {
            int i28 = 12;
            iArr = iArr9;
            pair = x2.p.j(4, tVar2, iArr6, new r5.e(iVar, i28), new kb1(i28));
        } else {
            iArr = iArr9;
            pair = l1Var;
        }
        ...
        if (o1Var5.a == 2) {
            ...
            pair2 = x2.p.j(3, tVar2, iArr6, new s50(iVar, str2, obj, 10), new kb1(15));
        }
        if (pair2 != 0) {
        ...
        while (i30 < i25) {
            int i31 = iArr[i30];
            if (i31 == 2 || i31 == 1 || i31 == i29 || i31 == i27) {
                i11 = i30;
                o1Var = o1Var5;
            } else {
                ...
                if (o1Var5.a == 2) {
                    ...
                    while (i32 < o1Var6.a) {
                        ...
                        while (i36 < a10.a) {
                            u2.o1 o1Var8 = o1Var6;
                            if (hg.c.d(iArr11[i36], iVar.t0)) {
                                i12 = i36;
                                x2.g gVar2 = new x2.g(a10.d[i36], iArr11[i12]);
                                if (gVar != 0) {
                                    iArr3 = iArr10;
        ...
        for (int i39 = 0; i39 < i37; i39++) {
            ...
            if (m1Var != null) {
                ...
                e9.i0 i0Var = m1Var.b;
                qVarArr[i39] = (i0Var.isEmpty() || o1VarArr2[i39].b(l1Var6) == -1) ? l1Var : new x2.q(l1Var6, y7.f(i0Var));
            }
        }
        int i40 = tVar2.a;
        ...
        while (i45 < qVarArr.length) {
            ...
            if (qVar4 == 0) {
                ...
                while (i46 < iArr12.length) {
                    x2.t tVar3 = tVar2;
                    long j11 = qVar4.a.d[iArr12[i46]].j;
                    long[] jArr2 = jArr[i45];
                    if (j11 == -1) {
                        j11 = 0;
                    }
            ...
            if (qVar5 != 0) {
                ...
                if (iArr16.length != 0) {
                    if (iArr16.length == 1) {
                        ...
                        long j13 = 25000;
                        bVar = new x2.b(qVar5.a, iArr16, cVar3, 10000, j13, j13, (e9.i0) i57.get(i58));
                    }
                    rVarArr[i58] = bVar;
                }
            }
            ...
            while (true) {
                if (i62 < tVar6.a) {
                    ...
                    if (i63 == 1 && rVar != null && rVar.length() == 1) {
                        if (x2.p.i(iVar, iArr6[i62][tVar6.c[i62].b(rVar.b())][rVar.h(0)], rVar.m())) {
                            i60++;
                            i61 = i62;
                        }
                    }
        ...
        while (true) {
            ...
            while (i68 < o1Var10.a) {
                ...
                f0Var2.b(new r1(a11, z18, iArr18, zArr));
                i68++;
                listArr = listArr3;
                o1Var10 = o1Var11;
            }
        ...
        for (int i79 = 0; i79 < o1Var12.a; i79++) {
            ...
            f0Var2.b(new r1(a12, false, iArr19, new boolean[a12.a]));
        }
