...
public final class o0 implements Handler.Callback, u2.c0, h1, a3.y {
    ...
    */
    public final void A0() {
        ...
        long l4 = t0Var.e ? t0Var.a.l() : -9223372036854775807L;
        if (l4 != -9223372036854775807L) {
            ...
            if (l4 != this.V.s) {
                g1 g1Var = this.V;
                this.V = z(g1Var.b, l4, g1Var.c, l4, true, 5);
            }
        } else {
            a3.q qVar = this.y;
        ...
        i iVar = this.J;
        long m10 = m(g1Var7.a, g1Var7.b.a, g1Var7.s);
        long j12 = this.V.r;
    ...
    public final void D() {
        ...
        if (A(this.H.l)) {
            t0 t0Var = this.H.l;
            long p5 = p(!t0Var.e ? 0L : t0Var.a.d());
            t0 t0Var2 = this.H.i;
            ...
            p0 p0Var = new p0(kVar, p5, f7, this.a0, j3);
            c10 = this.f.c(p0Var);
            t0 t0Var3 = this.H.i;
            if (!c10 && t0Var3.e && p5 < 500000 && this.x > 0) {
                t0Var3.a.i(this.V.s);
                c10 = this.f.c(p0Var);
            }
        } else {
    ...
    public final void F() {
        ...
        if (z10) {
            e0 e0Var = this.G.b;
            e0Var.j.c(new x1(9, e0Var, l0Var));
    ...
    public final long Y(u2.f0 f0Var, long j3, boolean z10, boolean z11) {
        ...
        if (z10 || t0Var != t0Var2 || (t0Var2 != null && t0Var2.p + j3 < 0)) {
            ...
            if (t0Var2 != null) {
                ...
                l(v0Var.j.e(), new boolean[n1VarArr.length]);
                t0Var2.h = true;
            }
        }
        h();
    ...
    */
    public final void j() {
        ...
        if (this.V.a.p() || !this.I.k) {
            ...
            v0 v0Var5 = this.H;
            if (!this.Z && this.O && !this.s0 && !e() && (t0Var6 = v0Var5.k) != null && t0Var6 == v0Var5.j && (t0Var7 = t0Var6.m) != null && t0Var7.e) {
                v0Var5.k = t0Var7;
                v0Var5.l();
                e2.d.h(v0Var5.k);
                n1[] n1VarArr3 = this.a;
                                    ...
                                    while (true) {
                                        if (i20 < n1VarArr4.length) {
                                            ...
                                            if (t0Var13.e || this.k0 >= t0Var13.e()) {
                                                ...
                                                if (t0Var18.e && ((z21 && this.r0 != j10) || t0Var18.a.l() != j10)) {
                                                    this.r0 = j10;
    ...
    */
    ...
    public final void x(u2.d0 d0Var) {
        ...
        if (t0Var2 != null && t0Var2.a == d0Var) {
            ...
            if (t0Var2 == v0Var.i) {
                R(t0Var2.g.b);
                l(v0Var.j.e(), new boolean[this.a.length]);
                t0Var2.h = true;
                g1 g1Var2 = this.V;
    ...
    public final g1 z(u2.f0 f0Var, long j3, long j10, long j11, boolean z10, int i10) {
        ...
        g1 g1Var2 = this.V;
        return g1Var2.d(f0Var, j3, j10, j11, p(g1Var2.q), o1Var2, vVar3, list2);
    }
