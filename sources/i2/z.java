        ...
        switch (this.a) {
            ...
            case 4:
                ...
                if (boVar.A1 != null) {
                    ...
                    boVar.A1.setTranslationY(wl.D(520.0f, r3[1] - r2.getTop(), this.b));
                ...
                if (arrayList != null) {
                    ...
                    if (!wyVar.getMessagesController().isPromoDialog(dialog.id, false)) {
                        ...
                        if (wyVar.V2 == 0) {
                            if (addDialogToFolder == 2) {
                                ...
                                if (i12 == 0) {
                                    ...
                                    if (!SharedConfig.archiveHidden && vyVar.c.L0() == 0) {
                                        wyVar.e2 = true;
                                        vyVar.a.w0(0, -AndroidUtilities.dp(SharedConfig.useThreeLinesLayout ? 76.0f : 70.0f), null);
                                    }
                                }
                                i10 = ((o2) wyVar).currentAccount;
                            ...
                            if (Y3 != null) {
                                Y3.l(dialog.id, z10 ? 2 : 3, null, new wm(uyVar, dialog, i11, 26));
                            }
                        }
