...
public final /* synthetic */ class t implements e2.m, MessagesStorage.BooleanCallback, rc0, ImageReceiver.ImageReceiverDelegate, d5, bl0, al0, a2, dd0, wk0, cl0 {
    public final /* synthetic */ int a;
    public final /* synthetic */ int b;
    public final /* synthetic */ Object c;

    public /* synthetic */ t(int i10, Object obj, int i11) {
        this.a = i11;
        this.b = i10;
        this.c = obj;
    }
    ...
    public void J(int i10, int i11, boolean z10) {
        switch (this.a) {
            case 6:
                AndroidUtilities.runOnUIThread(new hg.n(i10, this.b, (no) this.c, 8), 16L);
                break;
            default:
                AndroidUtilities.runOnUIThread(new hg.n(i10, this.b, (jo) this.c, 9), 16L);
                break;
        }
    }
    ...
    public boolean a(int i10, View view) {
        ...
        ek0Var.B(fk0Var, ((dk0) view).e, true, false);
        return true;
    }
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        ...
        if (this.b == f8Var.b) {
            ...
            if (b8Var.getCustomPaddingRight() != dp) {
                ValueAnimator ofInt = ValueAnimator.ofInt(b8Var.getCustomPaddingRight(), dp);
                k8Var.S0 = ofInt;
                if (dp == 0) {
            ...
            if (k8Var.i0.getTag() != null) {
                k8Var.j0.setImageBitmap(bitmap);
            }
        }
    }
        ...
        switch (this.a) {
            case 10:
                ...
                if (!arrayList.isEmpty()) {
                    MessagesController.getInstance(this.b).openByUserName("spambot", (n2) g.h(1, arrayList), 1);
                    break;
                }
                break;
            case 11:
    ...
    public /* synthetic */ t(j2.a aVar, int i10, b2.a1 a1Var, b2.a1 a1Var2) {
        this.a = 2;
        this.c = aVar;
        this.b = i10;
    }
    ...
    public void run(boolean z10) {
        ...
        int i10 = this.b;
        if (i10 == 15 && ChatObject.isChannel(coVar.e)) {
    ...
    public /* synthetic */ t(nj njVar, int i10, boolean z10) {
        this.a = 3;
        this.c = njVar;
        this.b = i10;
    }
