...
public final class m1 {
    ...
    public final f d(s0 s0Var) {
        u2.d1 d1Var;
        if (s0Var != null && (d1Var = s0Var.c[this.b]) != null) {
            f fVar = this.a;
            if (fVar.r == d1Var) {
                return fVar;
            }
            f fVar2 = this.c;
            if (fVar2 != null && fVar2.r == d1Var) {
                return fVar2;
            }
        }
        return null;
    ...
    */
    public final boolean e(s0 s0Var, f fVar) {
        if (fVar != null) {
            u2.d1[] d1VarArr = s0Var.c;
            int i10 = this.b;
            u2.d1 d1Var = d1VarArr[i10];
            u2.d1 d1Var2 = fVar.r;
            if (d1Var2 != null) {
                if (d1Var2 == d1Var) {
                    if (d1Var != null && !fVar.k()) {
                        s0 s0Var2 = s0Var.m;
                        if (s0Var.g.g) {
                            if (s0Var2 != null) {
                                if (s0Var2.e) {
                ...
                s0 s0Var3 = s0Var.m;
                if (s0Var3 == null || s0Var3.c[i10] != fVar.r) {
                    return false;
                }
            }
        }
    ...
    public final int j(f fVar, s0 s0Var, x2.v vVar, a3.q qVar) {
        ...
        u2.d1[] d1VarArr = s0Var.c;
        int i11 = this.b;
        boolean z10 = d1Var != d1VarArr[i11];
        ...
        if (!b10 || z10) {
            if (!fVar.y) {
                ...
                u2.d1 d1Var2 = s0Var.c[i11];
                d1Var2.getClass();
                fVar.y(sVarArr, d1Var2, s0Var.e(), s0Var.p, s0Var.g.a);
                return 3;
            }
            if (!fVar.l()) {
                return 0;
