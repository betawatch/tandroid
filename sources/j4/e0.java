    ...
    public final int m(c3.p pVar, c3.s sVar) {
        ...
        if (this.o) {
            ...
            if (length != -1 && !z11 && !yVar.d) {
                ...
                if (yVar.f) {
                    ...
                    if (yVar.e) {
                        ...
                        yVar.i = b0Var.c(yVar.h) - b0Var.b(j10);
                        yVar.a(pVar);
                        return 0;
                    }
            ...
            if (this.p) {
                ...
                if (j13 != -9223372036854775807L) {
                    ...
                    z10 = false;
                    i13 = 1;
                    h3.a aVar = new h3.a(new rb.a(5), new a5.a(this.t, yVar.b), j13, j13 + 1, 0L, length, 188L, 940);
                    this.l = aVar;
                    this.m.G(aVar.a);
                } else {
                    i10 = i14;
        ...
        while (true) {
            ...
            if (a12 >= 188) {
                ...
                h0 h0Var = (j14 & 16) != 0 ? (h0) sparseArray.get(i31) : null;
                if (h0Var == null) {
                    vVar2.J(i27);
                    return r12;
                }
            ...
            if (read == -1) {
                for (int i35 = 0; i35 < sparseArray.size(); i35++) {
                    h0 h0Var2 = (h0) sparseArray.valueAt(i35);
                    if (h0Var2 instanceof x) {
                        x xVar = (x) h0Var2;
                        boolean z14 = !z11 || xVar.e();
                        if (xVar.c == 3 && xVar.j == -1 && ((!z11 || !(xVar.a instanceof k)) && z14)) {
                            xVar.a(1, new e2.v());
                        }
                    }
                }
