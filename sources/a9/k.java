...
public abstract class k extends h implements List, RandomAccess, j$.util.List {
    public static final i b = new i(m.d, 0);
    ...
    public k subList(int i10, int i11) {
        s1.b(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? m.d : new j(this, i10, i12);
    }
