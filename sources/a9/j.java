...
public final class j implements c {
    ...
    public final t b(v vVar) {
        z9.b g10 = g(vVar);
        return g10 == null ? new t(t.c, t.d) : g10 instanceof t ? (t) g10 : new t(null, g10);
    }
        ...
        for (b bVar : this.a.keySet()) {
            for (m mVar : bVar.c) {
                ...
                if (z10 && !hashMap2.containsKey(vVar)) {
                    ...
                    rVar.a.addAll(set);
                    hashMap2.put(vVar, rVar);
                } else if (hashMap.containsKey(vVar)) {
                    continue;
                } else {
                    int i10 = mVar.b;
                    if (i10 == 1) {
                        throw new n("Unsatisfied dependency for component " + bVar + ": " + vVar);
                    }
                    if (i10 != 2) {
                        hashMap.put(vVar, new t(t.c, t.d));
                    }
                }
            }
        }
    ...
    public final ArrayList j(ArrayList arrayList) {
        ...
        while (i10 < size) {
            ...
            b bVar = (b) obj;
            if (bVar.e == 0) {
                z9.b bVar2 = (z9.b) this.a.get(bVar);
                for (v vVar : bVar.b) {
                    HashMap hashMap = this.b;
    ...
    public final ArrayList k() {
        ...
        for (Map.Entry entry2 : hashMap2.entrySet()) {
            if (hashMap.containsKey(entry2.getKey())) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new a1.e(3, rVar, (z9.b) it.next()));
                }
            } else {
