...
public final class l implements z, r4.r {
    ...
    */
    public final long A(d5.r[] rVarArr, boolean[] zArr, c1[] c1VarArr, boolean[] zArr2, long j10) {
        ...
        while (true) {
            ...
            if (rVar2 != null) {
                ...
                while (true) {
                    r[] rVarArr4 = this.F;
                    if (i20 < rVarArr4.length) {
                        r rVar3 = rVarArr4[i20];
                        rVar3.d();
                        if (rVar3.U.b(a2) != -1) {
                            iArr4[i19] = i20;
                            break;
        ...
        d5.r[] rVarArr5 = new d5.r[length4];
        r[] rVarArr6 = new r[this.F.length];
        int i21 = length3;
        int i22 = 0;
        int i23 = 0;
        boolean z14 = false;
        while (i22 < this.F.length) {
            ...
            while (true) {
                ...
                rVarArr5[i25] = iArr4[i25] == i22 ? rVarArr[i25] : null;
                i25++;
                c1VarArr4 = c1VarArr2;
            }
            r rVar4 = this.F[i22];
            ...
            while (i28 < length4) {
                n nVar = (n) r27[i28];
                if (nVar == null || (rVarArr5[i28] != null && zArr[i28])) {
                    i18 = i28;
                    q0Var = q0Var2;
                } else {
                    i18 = i28;
            ...
            if (!z14) {
                ...
                while (i10 < length4) {
                    ...
                    if (rVar8 == null) {
                        ...
                        if (r27[i31] == 0) {
                            rVar4.Q++;
                            n nVar2 = new n(rVar4, b10);
                            r27[i31] = nVar2;
                            zArr2[i31] = z15;
                            if (rVar4.W != null) {
                                nVar2.b();
                                if (!z16) {
                                    q qVar = rVar4.H[rVar4.W[b10]];
                ...
                if (rVar4.Q != 0) {
                    ...
                    boolean z17 = true;
                    if (arrayList.isEmpty() || d0.a(rVar7, rVar6)) {
                        iArr = iArr3;
                        rVarArr2 = rVarArr6;
                        i11 = i21;
                        i12 = i24;
                        ...
                        if (rVar4.e0) {
                            ...
                            iArr2 = iArr4;
                            rVar = rVar4;
                            rVar9.b(j10, j11, -9223372036854775807L, rVar4.A, iVar2.a(q6, j10));
                            if (rVar9.l() != iVar3.h.a(q6.d)) {
                                z17 = true;
                            } else {
                                z17 = true;
                            }
                ...
                if (!z13) {
                    ...
                    if (i36 == 0) {
                        ...
                        if (!z16) {
                            r[] rVarArr8 = this.G;
                            if (rVarArr8.length != 0 && rVar == rVarArr8[0]) {
                            }
                        }
        ...
        r[] rVarArr9 = (r[]) d0.J(i23, rVarArr6);
        this.G = rVarArr9;
        this.w.getClass();
        this.I = new ha.c(rVarArr9, 24);
        return j10;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x008f, code lost:
        ...
        if ((((r4.b) r9.g.d.get(r18)) != null ? !r4.b.a(r4, r13) : false) != false) goto L25;
     */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean c(Uri uri, p2.u uVar, boolean z10) {
        long j10;
        int i10;
        int u10;
        boolean z11;
    ...
    public final long f(long j10, j3.j2 j2Var) {
        ...
        while (true) {
            ...
            if (rVar.M == 2) {
                ...
                int c3 = iVar.q.c();
                Uri[] uriArr = iVar.e;
                r4.j a2 = (c3 >= uriArr.length || c3 == -1) ? null : cVar.a(uriArr[iVar.q.l()], true);
                if (a2 != null) {
                    q8.z zVar = a2.r;
                    if (!zVar.isEmpty() && a2.c) {
                        long j11 = a2.h - cVar.y;
                        long j12 = j10 - j11;
                        int c6 = d0.c(zVar, Long.valueOf(j12), true);
                        long j13 = ((r4.g) zVar.get(c6)).e;
                        return j2Var.a(j12, j13, c6 != zVar.size() - 1 ? ((r4.g) zVar.get(c6 + 1)).e : j13) + j11;
                    }
                }
            } else {
                i10++;
    ...
    public final void n(y yVar, long j10) {
        ...
        if (isEmpty) {
            ...
            while (true) {
                ...
                t0 t0Var2 = ((r4.l) list4.get(i14)).b;
                int i16 = t0Var2.H;
                String str = t0Var2.r;
                if (i16 > 0 || d0.o(2, str) != null) {
                    iArr[i14] = 2;
                    i15++;
                } else if (d0.o(1, str) != null) {
                    iArr[i14] = 1;
                    i13++;
                } else {
                    iArr[i14] = -1;
            ...
            if (i15 > 0) {
                ...
                if (z10 && z16) {
                    ...
                    if (n10 <= 0) {
                        ...
                        arrayList3.add(new j1("main", t0VarArr2));
                        if (n11 > 0 && (t0Var != null || list.isEmpty())) {
                            arrayList3.add(new j1("main:audio", e(t0VarArr3[0], t0Var, false)));
                        }
                        List list6 = mVar.k;
                        if (list6 != null) {
                            for (int i19 = 0; i19 < list6.size(); i19++) {
                                arrayList3.add(new j1(l1.k(i19, "main:cc:"), (t0) list6.get(i19)));
                            }
                        }
                    } else {
                        ...
                        arrayList3.add(new j1("main", t0VarArr4));
                    }
                    s0 s0Var2 = new s0();
                    s0Var2.a = "ID3";
                    s0Var2.o = "application/id3";
                    j1 j1Var = new j1("main:id3", new t0(s0Var2));
                    arrayList3.add(j1Var);
                    d.x((j1[]) arrayList3.toArray(new j1[0]), arrayList3.indexOf(j1Var));
                }
            } else {
                z11 = z14;
                i11 = size;
            ...
            if (z10) {
                ...
                j1 j1Var2 = new j1("main:id3", new t0(s0Var22));
                arrayList32.add(j1Var2);
                d.x((j1[]) arrayList32.toArray(new j1[0]), arrayList32.indexOf(j1Var2));
            }
        }
        ...
        while (i21 < list.size()) {
            List list7 = list;
            String str3 = ((r4.k) list7.get(i21)).c;
            if (hashSet.add(str3)) {
                arrayList4.clear();
                arrayList5.clear();
                arrayList6.clear();
                ...
                for (int i22 = 0; i22 < list7.size(); i22++) {
                    String str4 = ((r4.k) list7.get(i22)).c;
                    int i23 = d0.a;
                    if (str3.equals(str4)) {
                        r4.k kVar = (r4.k) list7.get(i22);
                        arrayList6.add(Integer.valueOf(i22));
                        Uri uri = kVar.a;
                        t0 t0Var4 = kVar.b;
                        arrayList4.add(uri);
                        arrayList5.add(t0Var4);
                        z17 &= d0.n(1, t0Var4.r) == 1;
                    }
                }
                ...
                arrayList2.add(p7.e(arrayList6));
                arrayList.add(d10);
                if (z10 && z17) {
                    d10.x(new j1[]{new j1(concat, (t0[]) arrayList5.toArray(new t0[0]))}, new int[0]);
                }
            } else {
                i10 = i21;
                list = list7;
        ...
        for (int i25 = 0; i25 < list2.size(); i25++) {
            r4.k kVar2 = (r4.k) list2.get(i25);
            StringBuilder o11 = l1.o(i25, "subtitle:", ":");
            String str5 = kVar2.c;
            t0 t0Var5 = kVar2.b;
            o11.append(str5);
            ...
            arrayList.add(d11);
            d11.x(new j1[]{new j1(sb2, t0Var5)}, new int[0]);
        }
