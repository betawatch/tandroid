...
public final class t2 extends View {
    ...
    public t2(Context context) {
        ...
        this.G = true;
        this.d = new org.telegram.ui.Cells.f1(context, new r2(this));
        paint2.setColor(-1);
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        s2 s2Var = this.H;
        float d = this.w.d(s2Var != null ? s2Var.get() : this.E.c, false);
            ...
            if (f10 != 1.0f) {
                ...
                if (z4) {
                    ...
                    if (f11 != 1.0f) {
                        ...
                        nr nrVar = nr.f;
                        canvas.translate(nrVar.getInterpolation(this.r) * dp4, rectF.top);
                        canvas.drawPath(path, this.a);
                        canvas.restore();
                        float f13 = (d - d10) / (d11 - d10);
                        float f14 = dp2 * 1.5f;
                        a(nrVar.getInterpolation(this.r) * AndroidUtilities.dp(32.0f), k7.n.a(e2.c.w(1.0f, f13, rectF.height(), rectF.top), rectF.top + f12, rectF.bottom - Math.min(f14, f12)), AndroidUtilities.lerp(AndroidUtilities.dp(12.0f), AndroidUtilities.lerp(Math.min(f14, f12), f12, f13), this.r), canvas, false);
                        if (this.G && this.r != 0.0f && this.v && this.B != null) {
                            cg.p1 p1Var = this.B;
                            float f15 = p1Var.c.g.a;
                            a(getWidth() / 2.0f, getHeight() / 2.0f, p1Var.getCurrentBrush().h() * e2.c.u(f15, 0.043945312f, d, 0.00390625f * f15) * this.B.getCurrentBrush().g(), canvas, true);
                        }
                        if (this.n != 0.0f) {
                            canvas.restore();
                            return;
                ...
                nr nrVar2 = nr.f;
                canvas.translate(nrVar2.getInterpolation(this.r) * dp42, rectF3.top);
                canvas.drawPath(path2, this.a);
                canvas.restore();
                float f132 = (d - d10) / (d11 - d10);
                float f142 = dp22 * 1.5f;
                a(nrVar2.getInterpolation(this.r) * AndroidUtilities.dp(32.0f), k7.n.a(e2.c.w(1.0f, f132, rectF3.height(), rectF3.top), rectF3.top + f122, rectF3.bottom - Math.min(f142, f122)), AndroidUtilities.lerp(AndroidUtilities.dp(12.0f), AndroidUtilities.lerp(Math.min(f142, f122), f122, f132), this.r), canvas, false);
                if (this.G) {
                    cg.p1 p1Var2 = this.B;
                    float f152 = p1Var2.c.g.a;
                    a(getWidth() / 2.0f, getHeight() / 2.0f, p1Var2.getCurrentBrush().h() * e2.c.u(f152, 0.043945312f, d, 0.00390625f * f152) * this.B.getCurrentBrush().g(), canvas, true);
                }
                if (this.n != 0.0f) {
                }
            }
        ...
        nr nrVar22 = nr.f;
        canvas.translate(nrVar22.getInterpolation(this.r) * dp422, rectF32.top);
        canvas.drawPath(path22, this.a);
        canvas.restore();
        float f1322 = (d - d10) / (d11 - d10);
        float f1422 = dp222 * 1.5f;
        a(nrVar22.getInterpolation(this.r) * AndroidUtilities.dp(32.0f), k7.n.a(e2.c.w(1.0f, f1322, rectF32.height(), rectF32.top), rectF32.top + f1222, rectF32.bottom - Math.min(f1422, f1222)), AndroidUtilities.lerp(AndroidUtilities.dp(12.0f), AndroidUtilities.lerp(Math.min(f1422, f1222), f1222, f1322), this.r), canvas, false);
        if (this.G) {
        }
        if (this.n != 0.0f) {
        }
