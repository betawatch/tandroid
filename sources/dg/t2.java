...
public final class t2 extends View {
    ...
    */
    public final void onDraw(Canvas canvas) {
            ...
            if (f10 != 1.0f) {
                ...
                if (z4) {
                    ...
                    if (f11 != 1.0f) {
                        ...
                        mr mrVar = mr.f;
                        canvas.translate(mrVar.getInterpolation(this.r) * dp4, rectF.top);
                        canvas.drawPath(path, this.a);
                        canvas.restore();
                        float f13 = (d - d10) / (d11 - d10);
                        float f14 = dp2 * 1.5f;
                        a(mrVar.getInterpolation(this.r) * AndroidUtilities.dp(32.0f), k7.n.a(e2.c.w(1.0f, f13, rectF.height(), rectF.top), rectF.top + f12, rectF.bottom - Math.min(f14, f12)), AndroidUtilities.lerp(AndroidUtilities.dp(12.0f), AndroidUtilities.lerp(Math.min(f14, f12), f12, f13), this.r), canvas, false);
                ...
                mr mrVar2 = mr.f;
                canvas.translate(mrVar2.getInterpolation(this.r) * dp42, rectF3.top);
                canvas.drawPath(path2, this.a);
                canvas.restore();
                float f132 = (d - d10) / (d11 - d10);
                float f142 = dp22 * 1.5f;
                a(mrVar2.getInterpolation(this.r) * AndroidUtilities.dp(32.0f), k7.n.a(e2.c.w(1.0f, f132, rectF3.height(), rectF3.top), rectF3.top + f122, rectF3.bottom - Math.min(f142, f122)), AndroidUtilities.lerp(AndroidUtilities.dp(12.0f), AndroidUtilities.lerp(Math.min(f142, f122), f122, f132), this.r), canvas, false);
                if (this.G) {
                    cg.p1 p1Var2 = this.B;
        ...
        mr mrVar22 = mr.f;
        canvas.translate(mrVar22.getInterpolation(this.r) * dp422, rectF32.top);
        canvas.drawPath(path22, this.a);
        canvas.restore();
        float f1322 = (d - d10) / (d11 - d10);
        float f1422 = dp222 * 1.5f;
        a(mrVar22.getInterpolation(this.r) * AndroidUtilities.dp(32.0f), k7.n.a(e2.c.w(1.0f, f1322, rectF32.height(), rectF32.top), rectF32.top + f1222, rectF32.bottom - Math.min(f1422, f1222)), AndroidUtilities.lerp(AndroidUtilities.dp(12.0f), AndroidUtilities.lerp(Math.min(f1422, f1222), f1222, f1322), this.r), canvas, false);
        if (this.G) {
        }
        if (this.n != 0.0f) {
        }
