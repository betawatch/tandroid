...
public final class q3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public q3(ContextThemeWrapper contextThemeWrapper, f6 f6Var) {
        ...
        this.a = -1;
        nr nrVar = nr.h;
        this.b = new z5(0.0f, (View) null, 0L, 420L, nrVar);
        this.c = new z5(0.0f, (View) null, 0L, 420L, nrVar);
        ...
        t2Var.setValueOverride(new a3.c(this, 10));
        t2Var.setTranslationX(-AndroidUtilities.dp(18.0f));
        t2Var.setAlpha(0.0f);
    ...
    */
    ...
    public static List k(ArrayList arrayList) {
        ...
        arrayList2.add((m3) kh.a2.i(1, arrayList));
        return arrayList2;
    }
    ...
    public final void a() {
        ...
        if (o3Var.h) {
            ...
            AndroidUtilities.runOnUIThread(new ag.d(o3Var, 23), 350L);
    ...
    */
    ...
    public final void f() {
        ...
        textView.animate().alpha(0.0f).scaleX(0.7f).scaleY(0.7f).setDuration(240L).setInterpolator(nr.h).start();
    }
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, sq0 sq0Var) {
        ib.c cVar;
        ...
        this.G = i10;
        this.W = null;
        j3 j3Var = new j3(this, i10, sq0Var, 0);
        this.x = true;
        mb.d dVar = new mb.d();
        dVar.b = true;
        dVar.c = true;
        ...
        a2.g(a10).addOnSuccessListener(new a1.c(j3Var, 17)).addOnFailureListener(new l3(this, bitmap, i10, sq0Var, j3Var, 0));
        if (this.W == null) {
            kb.b bVar = kb.b.b;
            ...
            new ImageLabelerImpl((cb.f) dVar2.a.F(bVar), (Executor) dVar2.b.a.get(), new y5.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new a1.c(this, 18)).addOnFailureListener(new androidx.emoji2.text.w(25));
        }
            ...
            public final void run() {
                ...
                if (z10) {
                    ...
                    if (document3 != null) {
                        ...
                        tL_message.id = 1;
                        o3 o3Var6 = q3Var.T;
                        String absolutePath = u6.w(UserConfig.selectedAccount, "webm").getAbsolutePath();
    ...
    public void setOutlineVisible(boolean z4) {
        ...
        this.f0 = z4;
        this.e0.animate().alpha(z4 ? 1.0f : 0.0f).translationX(z4 ? 0.0f : AndroidUtilities.dp(-18.0f)).setInterpolator(nr.h).setDuration(320L).start();
        if (getParent() instanceof View) {
            ((View) getParent()).invalidate();
        }
        if (Build.VERSION.SDK_INT >= 29) {
