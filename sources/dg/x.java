...
public final class x extends FrameLayout {
    ...
    public x(Context context, b6 b6Var) {
        ...
        final int i10 = 0;
        frameLayout.setOnClickListener(new View.OnClickListener(this) { // from class: dg.v
        ...
        imageView.setColorFilter(f6.v0(f6.j5, b6Var));
        ...
        final int i11 = 1;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: dg.v
            public final /* synthetic */ x b;
    ...
    public final void a(Runnable runnable) {
        ...
        spannableStringBuilder.setSpan(new wz0(vz0Var, 0), 0, spannableStringBuilder.length(), 33);
        uVar.setText(spannableStringBuilder);
        this.b.setOnClickListener(new w(0, runnable));
    }
