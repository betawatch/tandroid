...
public final class s1 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 1:
                ...
                if (xVar != null) {
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), ((a6) ((org.telegram.ui.c1) xVar).b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                } else {
    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        switch (this.a) {
            ...
            case 4:
                f6 f6Var = (f6) this.d;
                kf.b0 b0Var = (kf.b0) this.c;
                kf.b0 b0Var2 = (kf.b0) this.b;
        ...
        switch (this.a) {
            ...
            case 9:
                ...
                if (photoViewer.E0.getVisibility() != 8) {
                    ...
                    pb1Var.layout(dp, pb1Var.getTop(), photoViewer.E0.getMeasuredWidth() + dp, photoViewer.E0.getMeasuredHeight() + photoViewer.E0.getTop());
                    break;
                }
                break;
            default:
