    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.a) {
            ...
            case 3:
                ...
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new androidx.car.app.utils.b((a5) this.b, tLObject, (TL_stars.getResaleStarGifts) this.c, 17));
                break;
            case 5:
            ...
            case 21:
                ...
                break;
            case 22:
                AndroidUtilities.runOnUIThread(new androidx.car.app.utils.c((l8) this.b, tL_error, tLObject, (Calendar) this.c, 24));
                break;
            case 23:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.u1((bd) this.b, tLObject, (i6) this.c, 10));
                break;
            case 24:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.u1((me) this.b, tLObject, (Context) this.c, 12));
                break;
            case 25:
                zn znVar = (zn) this.b;
                ...
                if (tLObject instanceof TLRPC.messages_Messages) {
                    ...
                    AndroidUtilities.runOnUIThread(new cf(znVar, !messages_messages.messages.isEmpty() ? ((TLRPC.messages_Messages) tLObject2).offset_id_offset - messages_messages.offset_id_offset : ((TLRPC.messages_Messages) tLObject2).offset_id_offset, 5));
                    break;
                }
                break;
            case 26:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.u1((zn) this.b, tLObject, (TLRPC.User) this.c, 20));
                break;
            case 27:
                zn znVar2 = (zn) this.b;
                ...
                break;
            case 28:
                AndroidUtilities.runOnUIThread(new kh(this.b, (Object) tLObject, (Object) tL_error, this.c, 0));
                break;
            default:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.u1((cm) this.b, tLObject, (MessageObject) this.c, 23));
                break;
        }
    }
}
