    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (z10) {
            if (Build.VERSION.SDK_INT >= 29) {
                jVar.C.u(motionEvent.getRawX(1), motionEvent.getRawY(1), fArr2);
            } else {
                z10 = false;
            }
        }
                ...
                if (actionMasked == 2) {
                    ...
                    if (i10 == 3) {
                        ...
                        if (jVar.s || Math.abs(f14) > AndroidUtilities.dp(2.0f) || Math.abs(f15) > AndroidUtilities.dp(2.0f)) {
                            ...
                            int[] r10 = jVar.C.r(jVar);
                            float a2 = n6.a(r10[0], r10[1], jVar.b, jVar.c);
                            float a10 = n6.a(r10[0], r10[1], f10, f11);
                            float f16 = 0.0f;
                            if (a2 > 0.0f) {
                                jVar.j(a10 / a2);
                            }
                            int i11 = this.d;
                            if (i11 == 1) {
                                atan2 = Math.atan2(r10[1] - f11, r10[0] - f10);
                            } else {
                                if (i11 == 2) {
                                    atan2 = Math.atan2(f11 - r10[1], f10 - r10[0]);
                                }
