    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.a) {
            case 4:
                ...
                ((k01) this.b).e(canvas, ((xc0) this.c).getX() - AndroidUtilities.dp(50.0f), getHeight() / 2.0f);
                break;
            case 5:
                canvas.save();
                z5 z5Var = (z5) this.b;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.a) {
            case 0:
                ...
                float interpolation = layout2 == null ? 0.0f : mr.f.getInterpolation(e1Var.f1);
            ...
            case 8:
                ...
                if (layout3 != null) {
                    ...
                    float interpolation2 = layout4 == null ? 0.0f : mr.f.getInterpolation(c5Var.X0);
