    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
                ...
                if (view.isEnabled() && !beVar.K && !keVar.H0.K) {
                    ...
                    if (keVar.I0 <= currentTime) {
                        if (keVar.U0 >= MessagesController.getInstance(i15).starsRevenueWithdrawalMin) {
                            ...
                            twoStepVerificationActivity.s0(new ud(keVar, ga1Var, twoStepVerificationActivity, i12));
                            break;
                        } else {
                            qc.a0(ga1Var).L(keVar.getContext().getResources().getDrawable(R.drawable.star_small_inner).mutate(), AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("BotStarsWithdrawMinLimit", (int) MessagesController.getInstance(i15).starsRevenueWithdrawalMin, new Object[0]), new od(keVar, i15, i14))).j();
                            break;
                        }
                    } else {
            ...
            case 11:
                n40 n40Var = (n40) obj2;
                n40Var.n = i15;
                n40Var.b.d(view.getLeft(), false);
                n40Var.c.d(view.getRight(), false);
            ...
            case 12:
                ...
                TextView textView = se0Var.n;
                ArrayList arrayList2 = se0Var.J;
                org.telegram.ui.ActionBar.p2 p2Var2 = se0Var.r;
                int i18 = se0Var.C;
            ...
            case 13:
                ...
                p2Var3.getMessagesController().addUserToChat(chat.id, p2Var3.getUserConfig().getCurrentUser(), 0, null, p2Var3, new i80(20, gt0Var, chat));
                break;
            case 14:
                ((j41) obj2).run();
            ...
            case 18:
                ...
                bundle.putLong("dialog_id", ((x31) saveToGallerySettingsActivity.s.get(i15)).c.dialogId);
                bundle.putInt(TeXSymbolParser.TYPE_ATTR, saveToGallerySettingsActivity.a);
                saveToGallerySettingsActivity.presentFragment(new SaveToGallerySettingsActivity(bundle));
                break;
            case 19:
                vx vxVar = (vx) obj;
                q61 q61Var = ((o51) obj2).c;
                if (!vxVar.e && !UserConfig.getInstance(q61Var.S).isPremium()) {
                    ...
                    while (true) {
                        ...
                        if (i23 >= m51Var.getChildCount()) {
                            num = null;
                            view2 = null;
                        } else if ((m51Var.getChildAt(i23) instanceof t51) && (R = RecyclerView.R((view2 = m51Var.getChildAt(i23)))) >= 0 && q61Var.v0.get(R) == i15) {
                    ...
                    mv.W(null, vxVar.b, false, null, null);
                    q61Var.y0.add(Long.valueOf(vxVar.b.id));
            ...
            default:
                ...
                ((o8) ((View) obj2)).u(org.telegram.ui.web.l1.a().a, true);
