...
public class u3 extends LinearLayout {
    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.a) {
            case 7:
                if (!(getParent() instanceof do0)) {
                    return super.drawChild(canvas, view, j10);
                }
                do0 do0Var = (do0) getParent();
                canvas.save();
                LinearLayout linearLayout = do0Var.b;
                Path path = do0Var.n;
                if (view != null && do0.e(view)) {
                    ...
                    boolean z4 = childAt != null && do0.e(childAt);
                    boolean z10 = childAt2 != null && do0.e(childAt2);
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(view.getX(), Math.max(do0Var.getScrollY() - AndroidUtilities.dp(16.0f), view.getY() + linearLayout.getY()), view.getX() + view.getWidth(), Math.min(AndroidUtilities.dp(16.0f) + do0Var.getScrollY() + do0Var.getHeight(), view.getY() + linearLayout.getY() + view.getHeight()));
                    if (z4 && z10) {
                    ...
                    if (!z4 && !z10) {
                        ...
                        path.rewind();
                        path.addRoundRect(rectF, do0Var.d, Path.Direction.CW);
                        canvas.clipPath(path);
                    } else if (!z10) {
                        path.rewind();
                        path.addRoundRect(rectF, do0Var.e, Path.Direction.CW);
                        canvas.clipPath(path);
                    }
                }
