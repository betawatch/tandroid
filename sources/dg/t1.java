    ...
    public final void dispatchDraw(Canvas canvas) {
            ...
            if (i16 != i11 || this.U1) {
                ...
                while (i17 < childCount) {
                    ...
                    if (childAt3 instanceof org.telegram.ui.Cells.s1) {
                        ...
                        if (childAt3.getY() <= getHeight() && childAt3.getY() + childAt3.getHeight() >= f10 && s1Var3.getVisibility() != i10 && s1Var3.getVisibility() != 8 && (currentMessagesGroup = s1Var3.getCurrentMessagesGroup()) != null && ((i16 != 0 || currentMessagesGroup.messages.size() != z4) && ((i16 != z4 || currentMessagesGroup.transitionParams.drawBackgroundForDeletedItems) && ((i16 != 0 || !s1Var3.getMessageObject().deleted) && ((i16 != z4 || s1Var3.getMessageObject().deleted) && ((i16 != i11 || s1Var3.lc) && (i16 == i11 || !s1Var3.lc))))))) {
        ...
        if (size3 > 0) {
            ...
            while (i28 < size3) {
                ...
                boolean z12 = s1Var7.getCurrentPosition() != null && (s1Var7.getCurrentPosition().flags & z11) == 0;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (s1Var != null) {
            ...
            if (avatarImage != null) {
                ...
                if (!s1Var.j() || (b11 = o4Var.o0.T(view).b()) < 0) {
                    f11 = 0.0f;
                } else {
                ...
                int top2 = (int) ((z4 ? view.getTop() : view.getY()) + s1Var.getLayoutHeight() + s1Var.getTransitionParams().i0);
                int measuredHeight = getMeasuredHeight() - getPaddingBottom();
                boolean z10 = (s1Var.j1 || s1Var.k1) && checkBoxTranslation == f11;
                ...
                if (!s1Var.j()) {
                    int bottom = z4 ? s1Var.getBottom() : (int) (s1Var.getY() + s1Var.getMeasuredHeight() + s1Var.getTransitionParams().i0);
                    if (dp > bottom) {
                        dp = bottom;
                    }
                }
