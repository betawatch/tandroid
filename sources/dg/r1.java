    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i11) {
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new ag.d(o4Var, 22), 60L);
                break;
            case 1:
                gh.f fVar = (gh.f) obj3;
            ...
            case 2:
                ...
                aa1 aa1Var = ((gh.g) obj3).V;
                if (aa1Var != null) {
                    arrayList3.add(i51.C(AndroidUtilities.dp(12.0f)));
                    arrayList3.add(i51.h(0, 0, aa1Var));
                    break;
                }
                break;
            case 3:
            ...
            case 8:
                ...
                break;
            case 9:
                ((kh.g2) obj3).U((ArrayList) obj, (w51) obj2);
                break;
            case 10:
                kh.m3 m3Var = (kh.m3) obj3;
                ...
                if (l7Var != null) {
                    ...
                    if (l7Var4 != null) {
                        ...
                        while (i26 < size2) {
                            ...
                            J3.f = r14;
                            J3.r = z4;
                            J3.h = m3Var.n && (m3Var.e != or0Var.d || savedStarGift.pinned_to_top);
                            arrayList6.add(J3);
                            i25--;
                            if (i25 == 0) {
                                i25 = 3;
                    ...
                    if (or0Var.d == m3Var.e) {
                        ...
                        if (or0Var.c == UserConfig.getInstance(m3Var.b).getClientUserId()) {
                            int v02 = j6.v0(j6.z6, m3Var.c);
                            String string = LocaleController.getString(R.string.ProfileGiftsInfo);
                            int dp3 = AndroidUtilities.dp(24.0f);
                            int i29 = kh.s3.a;
                            i51 J4 = i51.J(kh.s3.class);
                            J4.l = string;
                            J4.z = 17;
                            J4.B = v02;
                            J4.A = 14.0f;
                    ...
                    if (!arrayList6.isEmpty()) {
                        arrayList6.add(0, i51.C(AndroidUtilities.dp(m3Var.F ? 42.0f : 12.0f)));
                    }
                    if (m3Var.f.getSpanCount() != max) {
                        AndroidUtilities.runOnUIThread(new kh.m2(m3Var, max, i19));
                    }
                    or0Var.o();
                    or0Var.post(new e3.h(or0Var, 29));
                    break;
                }
                break;
            case 11:
                kh.r3 r3Var = (kh.r3) obj3;
                ...
                if (l7Var6 != null) {
                    ...
                    if (l7Var6.i && arrayList9.isEmpty()) {
                        ...
                        while (i31 < size3) {
                            ...
                            if (!savedStarGift2.collection_id.contains(Integer.valueOf(r3Var.U))) {
                                int i32 = kh.w1.a;
            ...
            case 12:
                ...
                boolean z10 = arrayList10.isEmpty() && !a5Var.t;
                if (q5Var.x != z10) {
                    q5Var.x = z10;
                    q5Var.w.setVisibility(0);
                    q5Var.w.animate().alpha(z10 ? 1.0f : 0.0f).scaleX(z10 ? 1.0f : 0.95f).scaleY(z10 ? 1.0f : 0.95f).setInterpolator(mr.h).setDuration(320L).setListener(new g4(q5Var, z10, 1)).start();
                    break;
                }
                break;
            case 13:
                p5.T((p5) obj3, (ArrayList) obj);
                break;
            case 14:
            ...
            case 25:
                ...
                if (string2 != null) {
                    try {
                        ...
                        Collections.sort(arrayList26, new eu(14));
