...
public final class d0 extends LinearLayout {
    ...
    public d0(e0 e0Var, Context context) {
        ...
        this.a = c0Var;
        c0Var.a(0);
        addView(c0Var, c6.p(-1, -2, 0.0f, 0, 0, 0, 0, 16));
        c0 c0Var2 = new c0(e0Var, context);
        this.b = c0Var2;
        c0Var2.a(1);
        addView(c0Var2, c6.p(-1, -2, 0.0f, 0, 0, 0, 0, 16));
        c0 c0Var3 = new c0(e0Var, context);
        this.c = c0Var3;
        c0Var3.a(2);
        addView(c0Var3, c6.p(-1, -2, 0.0f, 0, 0, 0, 0, 16));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(0);
        linearLayout.setGravity(21);
        addView(linearLayout, c6.c(64.0f, -1));
        TextView textView = new TextView(context);
        textView.setTextColor(-1711276033);
        textView.setTextSize(1, 16.0f);
        textView.setText(LocaleController.getString(R.string.PaintPaletteSlidersHexColor).toUpperCase());
        textView.setTypeface(AndroidUtilities.bold());
        linearLayout.addView(textView, c6.k(0.0f, 0.0f, 8.0f, 0.0f, -2, -2));
