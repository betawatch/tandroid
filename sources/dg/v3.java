...
public final class v3 extends FrameLayout {
    ...
    public v3(y3 y3Var, Context context, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                super(context);
                mr mrVar = mr.h;
                this.c = new z5(this, 0L, 350L, mrVar);
                this.d = new z5(this, 0L, 350L, mrVar);
                break;
            default:
                this.b = y3Var;
                this.c = new Path();
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v3(a70 a70Var, Context context) {
        super(context);
        this.a = 9;
        this.b = a70Var;
        this.d = new RectF();
