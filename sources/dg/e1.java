...
public final class e1 {
    ...
    public e1(int i10) {
        ...
        int i13 = 0;
        while (i13 < o) {
            i13 = yh.d((int) sharedPreferences.getLong(l.d.j(i13, "color_"), ((Integer) m.get(i13)).intValue()), i13, 1, this.b);
        }
        while (true) {
            if (i12 >= m.a.size()) {
                ...
                hashMap.put(Integer.valueOf(i12), Integer.valueOf((int) sharedPreferences.getLong(l.d.j(i12, "brush_color_"), ((m) r1.get(i12)).c())));
                i12++;
            }
        }
    }
    ...
    public final void g() {
        if (!this.d.isEmpty() || this.e) {
            ...
            if (!this.d.isEmpty()) {
                int i10 = 0;
                while (i10 < o) {
                    edit.putLong(l.d.j(i10, "color_"), ((Integer) (i10 < this.d.size() ? this.d : m).get(i10)).intValue());
                    i10++;
                }
