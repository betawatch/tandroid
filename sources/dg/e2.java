...
public abstract class e2 extends sl0 {
    ...
    public static void x1(float f10, float f11, float f12, int i10, Canvas canvas) {
        ...
        path.lineTo((float) kh.a2.a(-1.5707963267948966d, rectF.width() / 2.0f, rectF.centerX()), (float) ((Math.sin(-1.5707963267948966d) * (rectF.height() / 2.0f)) + rectF.centerY()));
        path.moveTo(rectF.centerX(), rectF.centerY());
        path.lineTo((float) kh.a2.a(4.71238898038469d, rectF.width() / 2.0f, rectF.centerX()), (float) ((Math.sin(4.71238898038469d) * (rectF.height() / 2.0f)) + rectF.centerY()));
    ...
    public final void y1(float f10, boolean z4) {
        float interpolation = z4 ? nr.g.getInterpolation(f10) : nr.i.getInterpolation(f10);
