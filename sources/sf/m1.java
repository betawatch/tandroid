...
public final class m1 extends FrameLayout {
    ...
    public m1(Context context, c6 c6Var, boolean z10) {
        ...
        addView(sVar, f6.d(-1, -2.0f, 7, z11 ? i10 : 64.0f, 7.0f, z11 ? 64.0f : i10, 0.0f));
        if (z10) {
            ...
            addView(imageView, f6.e(50, 50, (LocaleController.isRTL ? 3 : 5) | 112));
        } else {
            this.e = null;
        }
    ...
    public final void a(r1 r1Var, String str, boolean z10) {
        ...
        TLRPC.Photo photo2;
        String str3 = str;
        this.h = r1Var != null ? r1Var.g : false;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (str3 != null && str3.length() > 0 && !str3.startsWith("/")) {
            str3 = "/".concat(str3);
        }
        spannableStringBuilder.append((CharSequence) "/").append((CharSequence) r1Var.b);
        ...
        if (messageObject != null) {
            ...
            CharSequence charSequence = r1Var.e.caption;
            if (TextUtils.isEmpty(charSequence)) {
                charSequence = r1Var.e.messageText;
            }
            ...
            TLRPC.Message message = r1Var.e.messageOwner;
            if (message != null) {
        ...
        if (r1Var.a() > 1) {
            ...
            org.telegram.ui.Components.b0 b0Var = new org.telegram.ui.Components.b0(a2);
            int dp2 = (int) (((zz0) b0Var.c).c + AndroidUtilities.dp(10.0f));
            this.n[0] = dp2;
        ...
        if (media != null && (photo2 = media.photo) != null) {
        ...
        } else if (media != null && media.document != null && (r1Var.e.isVideo() || r1Var.e.isSticker())) {
            ...
            imageReceiver.setImage(ImageLocation.getForObject(closestPhotoSizeWithSize3, media.webpage.photo), "36_36", r1Var.e.strippedThumb, closestPhotoSizeWithSize3 != null ? closestPhotoSizeWithSize3.size : 0L, (String) null, media.webpage, 0);
            imageReceiver.setRoundRadius(AndroidUtilities.dp(4.0f));
        }
        this.r = z10;
        invalidate();
