...
public final class v1 {
    public static volatile v1[] e = new v1[4];
    ...
    public static String f(TLRPC.TL_timezone tL_timezone) {
        ...
        int i11 = abs / 60;
        int i12 = abs % 60;
        StringBuilder n10 = com.google.android.recaptcha.internal.a.n(concat);
        n10.append(i11 < 10 ? "0" : "");
        n10.append(i11);
        StringBuilder n11 = com.google.android.recaptcha.internal.a.n(u3.c.k(n10.toString(), ":"));
        n11.append(i12 < 10 ? "0" : "");
        n11.append(i12);
        return n11.toString();
    }
    ...
    */
    ...
    public final void g() {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_help_getTimezonesList, new qe1(11, this, mainSettings));
    }
}
