...
public final class h implements o5.f {
    public static final s5.b k = new s5.b("RemoteMediaClient", null);
    ...
    public h(s5.n nVar) {
        ...
        this.a = new Object();
        this.b = new v0(Looper.getMainLooper(), 1);
                ...
                switch (string.hashCode()) {
                    case -1830647528:
                        if (string.equals("LOAD_CANCELLED")) {
                            pVar2.b(optLong, 2101, s5.n.f(jSONObject));
                            break;
                        }
                        break;
                    case -1790231854:
                        if (string.equals("QUEUE_ITEMS")) {
                            ...
                            if (nVar.h != null) {
                                ...
                                o5.o[] oVarArr = new o5.o[jSONArray.length()];
                                for (int i12 = 0; i12 < jSONArray.length(); i12++) {
                                    oVarArr[i12] = new o1.a(jSONArray.getJSONObject(i12)).v();
                                }
                    ...
                    case -1125000185:
                        if (string.equals("INVALID_REQUEST")) {
                            ...
                            while (it2.hasNext()) {
                                ((s5.p) it2.next()).b(optLong, 2001, s5.n.f(jSONObject));
                            }
                            break;
                        }
                        break;
                    case -262628938:
                        if (string.equals("LOAD_FAILED")) {
                            pVar2.b(optLong, 2100, s5.n.f(jSONObject));
                            break;
                        }
                        break;
                    case 66247144:
                        if (string.equals("ERROR")) {
                            ...
                            while (it3.hasNext()) {
                                ((s5.p) it3.next()).b(optLong, 2100, s5.n.f(jSONObject));
                            }
                            if (nVar.h == null) {
                                break;
                            } else {
                    ...
                    case 154411710:
                        if (string.equals("QUEUE_CHANGE")) {
                            ...
                            if (nVar.h != null) {
                                ...
                                int[] m11 = s5.n.m(jSONObject.getJSONArray("itemIds"));
                                    ...
                                    switch (string2.hashCode()) {
                                        ...
                                        case -1785516855:
                                            if (string2.equals("UPDATE")) {
                                                int[] m12 = s5.n.m(jSONObject.getJSONArray("itemIds"));
                                                z5.l.i(m12, "A list of item IDs is expected in a QUEUE UPDATE message.");
                                                JSONArray optJSONArray = jSONObject.optJSONArray("reorderItemIds");
                                                if (optJSONArray != null) {
                                                    ArrayList c6 = s5.a.c(m12);
                                                    int optInt2 = jSONObject.optInt("insertBefore", 0);
                                                    int[] m13 = s5.n.m(optJSONArray);
                                                    z5.l.h(m13);
                                                    ArrayList c10 = s5.a.c(m13);
                                                    Iterator it7 = ((h) nVar.h.b).i.iterator();
                                                    while (it7.hasNext()) {
                                                        ((g) it7.next()).m(c6, c10, optInt2);
                                                    }
                                                    break;
                                                } else {
                    ...
                    case 431600379:
                        if (string.equals("INVALID_PLAYER_STATE")) {
                            ...
                            while (it10.hasNext()) {
                                ((s5.p) it10.next()).b(optLong, 2100, s5.n.f(jSONObject));
                            }
                            break;
                        }
                        break;
                    case 823510221:
                        if (string.equals("MEDIA_STATUS")) {
                            ...
                            if (jSONArray2.length() > 0) {
                                ...
                                boolean c11 = pVar2.c(optLong);
                                if (pVar.d()) {
                                    if (pVar.c(optLong)) {
                                    }
                                    i10 = 1;
                                    if (!c11 && (qVar = nVar.f) != null) {
                                    ...
                                    o5.q qVar2 = new o5.q(null, 0L, 0, 0.0d, 0, 0, 0L, 0L, 0.0d, false, null, 0, 0, null, 0, null, false, null, null, null, null);
                                ...
                                if (!r32.d() || r32.c(optLong)) {
                                    ...
                                    o5.q qVar22 = new o5.q(null, 0L, 0, 0.0d, 0, 0, 0L, 0L, 0.0d, false, null, 0, 0, null, 0, null, false, null, null, null, null);
                                    ...
                                    o5.q qVar222 = new o5.q(null, 0L, 0, 0.0d, 0, 0, 0L, 0L, 0.0d, false, null, 0, 0, null, 0, null, false, null, null, null, null);
                            ...
                            while (it11.hasNext()) {
                                ((s5.p) it11.next()).b(optLong, 0, null);
                            }
                            break;
                        }
                        break;
                    case 2107149050:
                        if (string.equals("QUEUE_ITEM_IDS")) {
                            ...
                            if (nVar.h != null && (m10 = s5.n.m(jSONObject.getJSONArray("itemIds"))) != null) {
