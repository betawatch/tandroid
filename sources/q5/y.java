...
public abstract class y {
    ...
    static {
        ...
        d = cVar8;
        e = new y5.c[]{cVar, cVar2, cVar3, cVar4, cVar5, cVar6, cVar7, cVar8, new y5.c("relay_casting_set_remote_casting_mode", 1L), new y5.c("get_relay_access_token", 1L), new y5.c("get_cast_settings", 1L), new y5.c("set_bundle_setting", 1L), new y5.c("get_client_updated_info", 1L)};
    }
    ...
    public static String a(String str) {
        ...
        return c0.G(new c0(str, null, false, 1));
    }
}
