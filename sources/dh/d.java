...
public final class d extends FrameLayout {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(z31 z31Var, Context context, int i10, String str, CharSequence charSequence) {
        super(context);
        f6 f6Var;
        f6 f6Var2;
        f6 f6Var3;
        ...
        int i11 = j6.G6;
        f6Var = ((g3) z31Var).resourcesProvider;
        ...
        f6Var2 = ((g3) z31Var).resourcesProvider;
        ...
        int i12 = j6.Pi;
        f6Var3 = ((g3) z31Var).resourcesProvider;
        e90Var.setTextColor(j6.v0(i12, f6Var3));
        int i13 = j6.gc;
        f6Var4 = ((g3) z31Var).resourcesProvider;
        e90Var.setLinkTextColor(j6.v0(i13, f6Var4));
        ...
        addView(e90Var, b6.d(-2, -2.0f, z4 ? 5 : 3, (z4 ? 27 : 68) - 4, 18.0f, (z4 ? 68 : 27) - 4, 0.0f));
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(p31 p31Var, Context context, int i10, String str, CharSequence charSequence) {
        super(context);
        f6 f6Var;
        f6 f6Var2;
        f6 f6Var3;
        ...
        Drawable mutate = getContext().getResources().getDrawable(i10).mutate();
        int i11 = j6.G6;
        f6Var = ((g3) p31Var).resourcesProvider;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(i11, f6Var), PorterDuff.Mode.MULTIPLY));
        imageView.setImageDrawable(mutate);
        addView(imageView, b6.d(24, 24.0f, z4 ? 5 : 3, z4 ? 0.0f : 27.0f, 6.0f, z4 ? 27.0f : 0.0f, 0.0f));
        TextView textView = new TextView(getContext());
        textView.setText(str);
        f6Var2 = ((g3) p31Var).resourcesProvider;
        textView.setTextColor(j6.v0(i11, f6Var2));
        yh.p(14.0f, 1, textView);
        addView(textView, b6.d(-2, -2.0f, z4 ? 5 : 3, z4 ? 27.0f : 68.0f, 0.0f, z4 ? 68.0f : 27.0f, 0.0f));
        e90 e90Var = new e90(getContext(), null);
        ...
        e90Var.setTextSize(1, 14.0f);
        int i12 = j6.Pi;
        f6Var3 = ((g3) p31Var).resourcesProvider;
        e90Var.setTextColor(j6.v0(i12, f6Var3));
        int i13 = j6.gc;
        f6Var4 = ((g3) p31Var).resourcesProvider;
        e90Var.setLinkTextColor(j6.v0(i13, f6Var4));
        e90Var.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        addView(e90Var, b6.d(-2, -2.0f, z4 ? 5 : 3, z4 ? 27.0f : 68.0f, 18.0f, z4 ? 68.0f : 27.0f, 0.0f));
    }
    ...
    public d(Context context, int i10, String str, CharSequence charSequence, f6 f6Var) {
        ...
        int i12 = j6.gc;
        e90Var.setLinkTextColor(j6.v0(i12, f6Var));
        e90Var.setText(str);
        linearLayout.addView(e90Var, b6.t(-1, -2, 55, 0, 0, 0, 2));
        e90 e90Var2 = new e90(context, null);
        e90Var2.setTextSize(1, 14.0f);
        e90Var2.setTextColor(j6.v0(j6.y6, f6Var));
        e90Var2.setLinkTextColor(j6.v0(i12, f6Var));
        e90Var2.setText(charSequence);
        linearLayout.addView(e90Var2, b6.t(-1, -2, 55, 0, 0, 0, 0));
    }
