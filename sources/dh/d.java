    ...
    */
    ...
    public final NinePatchDrawable a(int i10, boolean z10) {
        ...
        if (this.A == null || this.B != j3) {
            this.B = j3;
            NinePatchDrawable b10 = e8.b(null, cVar.b, this.l, this.m, Color.alpha(i10) == 255 ? i10 : 1, new a(i10, this, z10));
            this.A = b10;
    ...
    public final void c(Canvas canvas, gh.a aVar) {
        ...
        if (Build.VERSION.SDK_INT >= 29 && (aVar instanceof gh.d)) {
            gh.d dVar = (gh.d) aVar;
