...
public final class f extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
    ...
    public f(Activity activity, f6 f6Var, zn znVar) {
        ...
        this.F = new xd.a(0, new a1.c(this, i10), mrVar, 380L, false);
        this.d = znVar;
        ...
        bVar.setLinkTextColor(j6.v0(j6.gc, f6Var));
        ...
        this.b = eVar;
        int i11 = j6.Vh;
        eVar.setBackground(j6.f0(j6.v0(i11, f6Var), 1, -1));
        d6.a(eVar);
        g gVar = new g(getContext(), 36);
        this.c = gVar;
        gVar.setBackground(j6.f0(j6.v0(i11, f6Var), 1, -1));
    ...
    public static void a(f fVar) {
        ...
        int i10 = j6.A6;
        zn znVar = fVar.d;
        k5Var.setTextColor(i0.a.d(fVar.F.e, j6.v0(i10, znVar.getResourceProvider()), j6.v0(j6.p7, znVar.getResourceProvider())));
    }
    ...
    public final boolean onPreDraw() {
        ...
        if (s1Var2 != null) {
            ...
            if (this.n.isAttachedToWindow() && this.r == id2 && (aVar = (s1Var = this.n).X5) != null && s1Var.k6) {
