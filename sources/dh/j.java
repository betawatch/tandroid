...
public final class j extends Drawable implements Animator.AnimatorListener {
    ...
    public static PointF f(float f10, float f11, float f12, float f13, float f14, float f15, boolean z10) {
        ...
        float d = p.d(f18, f16, sqrt, f10);
        float d10 = p.d(f18, f17, sqrt, f11);
    ...
    public final void e(Canvas canvas, boolean z10, int i10) {
        ...
        if (bVar != null && !z10) {
            ...
            if (jVar.N != -1) {
                ...
                mb mbVar = jVar.S;
                float min = (mbVar == null || !mbVar.top) ? Math.min(centerY, f16) - AndroidUtilities.dp(15) : Math.max(centerY, f16) + AndroidUtilities.dp(15);
                ...
                if (dVar.e == null) {
                    final int i22 = 1;
                    b bVar2 = new b(new a() { // from class: dh.c
                        @Override // dh.a
                        public final void l(Canvas canvas3, int i23) {
                            float f20;
                            switch (i22) {
                                case 0:
                                    d dVar2 = dVar;
                                    ...
                                    if (paint != null) {
                                        ...
                                        Paint L2 = s1Var2.L2("paintChatActionBackground");
                                        int alpha2 = L2.getAlpha();
                                        L2.setAlpha((int) ((Q2 ? alpha2 : 229.5f) * f23));
                                        canvas3.drawRoundRect(rectF3, dp4, dp4, L2);
                                        L2.setAlpha(alpha2);
                                    }
                                    if (Q2 || paint != null) {
                                        int alpha3 = g6.h2.getAlpha();
                                        g6.h2.setAlpha((int) (alpha3 * f23));
        ...
        float f21 = !z10 ? 1.0f - jVar.D : i10 / 255.0f;
            ...
            while (i24 < dVarArr.length) {
                if (!(i23 == 0 && i24 == jVar.N) && (i23 != i14 || i24 == jVar.N)) {
                    ...
                    if (f27 <= 0.0f || dVar2.h == null) {
                        ...
                        i13 = i12;
                        float D = y1.D(8, 2, dVar2.h.getWidth());
                        ...
                        if (dVar2.f == null) {
                            ...
                            if (!jVar2.P) {
                                dVar2.g = jVar2.H;
                                final int i25 = 0;
                                b bVar4 = new b(new a() { // from class: dh.c
                                    @Override // dh.a
                                    public final void l(Canvas canvas3, int i232) {
                                        float f202;
                                        switch (i25) {
                                            case 0:
                                                d dVar22 = dVar2;
                                                ...
                                                if (paint2 != null) {
                                                    ...
                                                    Paint L2 = s1Var2.L2("paintChatActionBackground");
                                                    int alpha2 = L2.getAlpha();
                                                    L2.setAlpha((int) ((Q2 ? alpha2 : 229.5f) * f232));
                                                    canvas3.drawRoundRect(rectF32, dp42, dp42, L2);
                                                    L2.setAlpha(alpha2);
                                                }
                                                if (Q2 || paint2 != null) {
                                                    int alpha3 = g6.h2.getAlpha();
                                                    g6.h2.setAlpha((int) (alpha3 * f232));
