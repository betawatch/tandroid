...
public final /* synthetic */ class s implements q, d7, b2, ff.p, MessagesController.ErrorDelegate, ng1 {
    public final /* synthetic */ int a;
    public final /* synthetic */ boolean b;
    public final /* synthetic */ Object c;

    public /* synthetic */ s(int i9, Object obj, boolean z10) {
        this.a = i9;
        this.c = obj;
        this.b = z10;
    }
    ...
    public void f(c2 c2Var, int i9) {
        switch (this.a) {
            case 2:
                y6.U((y6) this.c, this.b);
                break;
            case 3:
            default:
                o50 o50Var = ((r40) this.c).b;
                o50Var.W0.toggleRecord(null, 0);
                o50Var.k1().j(this.b ? 101 : 40, 0L, null);
                break;
            case 4:
                qn qnVar = (qn) this.c;
                ak akVar = qnVar.U;
    ...
    public boolean run(TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "INVITE_REQUEST_SENT".equals(tL_error.text)) {
            p70Var.setOnDismissListener(new l70(0, p70Var, this.b));
        }
        p70Var.dismiss();
        return false;
    }
