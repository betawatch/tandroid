...
public final class n extends a6.a {
    ...
    public final JSONObject b() {
        ...
        try {
            ...
            String b10 = t7.b(Integer.valueOf(this.f));
            if (b10 != null) {
    ...
    public final boolean equals(Object obj) {
        ...
        n nVar = (n) obj;
        return TextUtils.equals(this.a, nVar.a) && TextUtils.equals(this.b, nVar.b) && this.c == nVar.c && TextUtils.equals(this.d, nVar.d) && z5.l.l(this.e, nVar.e) && this.f == nVar.f && z5.l.l(this.h, nVar.h) && this.n == nVar.n && this.r == nVar.r && this.s == nVar.s;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeInt(i12);
        List list = this.h;
        com.google.android.gms.internal.cast.o.p(parcel, 8, list == null ? null : DesugarCollections.unmodifiableList(list));
        int i13 = this.n;
