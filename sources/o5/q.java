    ...
    */
    public final int b(int i10, JSONObject jSONObject) {
        ...
        if (optJSONObject3 != null) {
                ...
                if (i29 != 1) {
                    ...
                    if (arrayList6.isEmpty()) {
                        ...
                        if (optJSONObject != null) {
                            ...
                            String a10 = s5.a.a("breakId", optJSONObject);
                            String a11 = s5.a.a("breakClipId", optJSONObject);
                    ...
                    if (optJSONObject != null && optJSONObject.has("currentBreakTime") && optJSONObject.has("currentBreakClipTime")) {
                        try {
                            ...
                            Pattern pattern32 = s5.a.a;
                            long j152 = j142 * 1000;
                            long j162 = optJSONObject.getLong("currentBreakClipTime") * 1000;
                            String a102 = s5.a.a("breakId", optJSONObject);
                            String a112 = s5.a.a("breakClipId", optJSONObject);
                            optLong = optJSONObject.optLong("whenSkippable", -1L);
                            if (optLong != -1) {
                                optLong *= 1000;
                            }
                        ...
                        if (jSONObject2.has("queueData")) {
                            ...
                            if (jSONObject5 == null) {
                                ...
                                String a12 = s5.a.a("id", jSONObject5);
                                String a13 = s5.a.a("entity", jSONObject5);
                                ...
                                if (optJSONObject4 != null) {
                                    ...
                                    if (hashCode2 != 6924225) {
                                        ...
                                        i22 = 1;
                                        String a14 = s5.a.a("title", optJSONObject4);
                                        ...
                                        if (optJSONArray2 == null) {
                                            ...
                                            t5.a.c(arrayList4, optJSONArray2);
                                        } else {
                                            arrayList4 = null;
                                        }
                                        str2 = a13;
                                    ...
                                    i22 = 0;
                                    String a142 = s5.a.a("title", optJSONObject4);
                                    optJSONArray = optJSONObject4.optJSONArray("sections");
                                    if (optJSONArray == null) {
                                    }
                                    str = a12;
            ...
            if (jSONObject2.has("repeatMode")) {
                ...
                int intValue2 = a16 == null ? this.B : a16.intValue();
                if (this.B != intValue2) {
                    this.B = intValue2;
                    z10 = true;
    ...
    public final boolean equals(Object obj) {
        ...
        if (this != obj) {
            if (obj instanceof q) {
                q qVar = (q) obj;
                if ((this.A == null) == (qVar.A == null) && this.b == qVar.b && this.c == qVar.c && this.d == qVar.d && this.e == qVar.e && this.f == qVar.f && this.h == qVar.h && this.r == qVar.r && this.s == qVar.s && this.w == qVar.w && this.x == qVar.x && this.B == qVar.B && Arrays.equals(this.v, qVar.v) && s5.a.d(Long.valueOf(this.n), Long.valueOf(qVar.n)) && s5.a.d(this.C, qVar.C) && s5.a.d(this.a, qVar.a) && (((jSONObject = this.A) == null || (jSONObject2 = qVar.A) == null || g6.c.a(jSONObject, jSONObject2)) && this.D == qVar.D && s5.a.d(this.E, qVar.E) && s5.a.d(this.F, qVar.F) && s5.a.d(this.G, qVar.G) && z5.l.l(this.H, qVar.H) && this.I == qVar.I)) {
                }
            }
            return false;
        }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeInt(i15);
        com.google.android.gms.internal.cast.o.l(parcel, 15, this.y);
        int i16 = this.B;
