...
public abstract class k extends Service implements c {
    ...
    private i8.d zzh = new i8.d(new fa.c(this, 20));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0019, code lost:
        ...
        if (r1.equals(h8.k.BIND_LISTENER_INTENT_ACTION) != false) goto L28;
     */
    ...
    */
    ...
    @Override // h8.c
    public void onChannelClosed(b bVar, int i9, int i10) {
    }
    ...
    @Override // h8.c
    public void onInputClosed(b bVar, int i9, int i10) {
    }

    public abstract void onMessageReceived(g gVar);

    @Override // h8.c
    public void onOutputClosed(b bVar, int i9, int i10) {
    }
    ...
    public void onChannelClosed(d dVar, int i9, int i10) {
    }

    public void onChannelOpened(d dVar) {
    }

    public void onInputClosed(d dVar, int i9, int i10) {
    }

    public void onOutputClosed(d dVar, int i9, int i10) {
    }
