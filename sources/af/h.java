...
public final class h {
    ...
    public void e() {
        ...
        arrayList.clear();
        if (RecyclerView.P0) {
            androidx.datastore.preferences.protobuf.i iVar = ((RecyclerView) this.h).p0;
            int[] iArr = (int[]) iVar.d;
            if (iArr != null) {
                Arrays.fill(iArr, -1);
            }
    ...
    public l1 j(int i10, long j10) {
        ...
        if (l1Var == null) {
            ...
            if (view == null) {
                ...
                f2.c cVar = (f2.c) dVar.c;
                int indexOfChild = ((RecyclerView) ((bb.b) dVar.b).b).indexOfChild(view);
                if (indexOfChild < 0) {
                    throw new IllegalArgumentException("view is not a child, cannot hide " + view);
                }
                if (!cVar.x(indexOfChild)) {
                    throw new RuntimeException("trying to unhide a view that was not hidden" + view);
                }
                cVar.t(indexOfChild);
                dVar.C(view);
                d dVar2 = recyclerView.e;
                f2.c cVar2 = (f2.c) dVar2.c;
                int indexOfChild2 = ((RecyclerView) ((bb.b) dVar2.b).b).indexOfChild(view);
                int u10 = (indexOfChild2 == -1 || cVar2.x(indexOfChild2)) ? -1 : indexOfChild2 - cVar2.u(indexOfChild2);
                if (u10 == -1) {
                    throw new IllegalStateException("layout index should not be -1 after unhiding a view:" + U2 + recyclerView.C());
                }
                recyclerView.e.l(u10);
                i(view);
                U2.a(8224);
                l1Var3 = U2;
            }
