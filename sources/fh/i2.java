...
public final class i2 extends hq {
    ...
    public static void c(Path path, float f10, final boolean z10) {
        Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: fh.h2
        ...
        float f13 = e2.c.f((Float) callbackReturn.run(Float.valueOf(46.56f)), f10);
        float dp = AndroidUtilities.dp(48.28f * f10);
        Float valueOf = Float.valueOf(48.0f);
        path.cubicTo(f13, dp, e2.c.f((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(47.68f * f10), e2.c.f((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(46.5f * f10));
    ...
    public final void d(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop, boolean z10, boolean z11) {
        ...
        if (stargiftattributebackdrop == null) {
            ...
            paint.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f), new int[]{org.telegram.ui.ActionBar.f6.b(z12 ? 0.07f : 0.05f, (z12 ? -0.15f : -0.1f) - (z11 ? 0.125f : 0.0f), stargiftattributebackdrop.center_color | (-16777216)), org.telegram.ui.ActionBar.f6.b(z12 ? 0.07f : 0.05f, (z12 ? -0.15f : -0.1f) - (z11 ? 0.125f : 0.0f), stargiftattributebackdrop.edge_color | (-16777216))}, new float[]{z12 ? 1.0f : 0.0f, z12 ? 0.0f : 1.0f}, Shader.TileMode.CLAMP));
        }
    }
    ...
    public final void e(int i9, CharSequence charSequence, boolean z10) {
        this.b = new nz0(charSequence, i9, z10 ? AndroidUtilities.bold() : null);
    }
}
