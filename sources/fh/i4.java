...
public final class i4 extends org.telegram.ui.ActionBar.f3 {
    ...
    public i4(Context context, long j10, TL_stars.SavedStarGift savedStarGift, org.telegram.ui.ActionBar.b6 b6Var, Utilities.Callback0Return callback0Return) {
        ...
        TextView b11 = g7.i6.b(context, 14.0f, org.telegram.ui.ActionBar.f6.y6, false, b6Var);
        ...
        h4 h4Var = new h4(context, this.currentAccount, 0, false, new bg.y0(1, this, G), new b5.d(19, this, dVar), null, b6Var);
        h4Var.setSpanCount(3);
        h4Var.setOverScrollMode(2);
        h4Var.setScrollEnabled(false);
        linearLayout.addView(h4Var, g7.e6.k(11.0f, 0.0f, 11.0f, 0.0f, -1, -2));
