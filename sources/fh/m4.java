...
public final /* synthetic */ class m4 implements Utilities.Callback2 {
    ...
    public /* synthetic */ m4(g6 g6Var, String[] strArr, ArrayList arrayList, int i9) {
        this.a = i9;
        this.b = g6Var;
        this.c = strArr;
        this.d = arrayList;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i9) {
            case 0:
                ...
                p5 p5Var = g6Var.d;
                boolean isEmpty = p5Var.l.isEmpty();
                ...
                while (i10 < size) {
                    ...
                    boolean contains = p5Var.l.contains(Long.valueOf(stargiftattributepattern.document.id));
                    boolean z10 = !contains;
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.l0.w(" ", lowerCase, stargiftattributepattern.name.toLowerCase()) || org.telegram.messenger.l0.w(" ", translitSafe, stargiftattributepattern.name.toLowerCase())) {
                        Integer num = (Integer) p5Var.o.get(Long.valueOf(stargiftattributepattern.document.id));
                        int intValue = num == null ? 0 : num.intValue();
                        int i11 = m5.a;
                        l41 J = l41.J(m5.class);
                ...
                if (arrayList2.isEmpty()) {
                    arrayList2.add(e5.a(LocaleController.getString(R.string.Gift2ResaleFiltersSymbolEmpty)));
                    break;
                }
                break;
            case 1:
            ...
            default:
                ...
                p5 p5Var3 = g6Var.d;
                boolean isEmpty3 = p5Var3.j.isEmpty();
                ...
                while (i14 < size3) {
                    ...
                    boolean contains3 = p5Var3.j.contains(Long.valueOf(stargiftattributemodel.document.id));
                    boolean z12 = !contains3;
                    if (TextUtils.isEmpty(lowerCase3) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase3) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe3) || org.telegram.messenger.l0.w(str4, lowerCase3, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.l0.w(str4, translitSafe3, stargiftattributemodel.name.toLowerCase())) {
                        str3 = str4;
                        Integer num3 = (Integer) p5Var3.m.get(Long.valueOf(stargiftattributemodel.document.id));
                        int intValue3 = num3 == null ? 0 : num3.intValue();
                        int i15 = j5.a;
                        l41 J3 = l41.J(j5.class);
                ...
                if (arrayList4.isEmpty()) {
                    arrayList4.add(e5.a(LocaleController.getString(R.string.Gift2ResaleFiltersModelEmpty)));
                    break;
                }
                break;
        }
