...
public final class d3 extends e71 {
    ...
    public final void a(ArrayList arrayList) {
        ...
        if (currentPage != null) {
            int f10 = currentPage.d ? l7Var.f(currentPage.e.d) + 1 : 0;
            vq0Var.n.e(0.0f, f10, f10);
        }
    ...
    public final void b(View view, int i9, int i10) {
        ...
        if (i10 == 0) {
            ...
            if (i11 < 0) {
                l7Var.getClass();
            } else if (i11 < l7Var.d().size()) {
                n7Var = l7Var.e(((TL_stars.TL_starGiftCollection) l7Var.d().get(i11)).collection_id);
                z10 = true;
            }
            n7Var = null;
            z10 = true;
        ...
        if (linearLayout != null) {
            linearLayout.setVisibility(y3Var.a.e.h() ? 0 : 8);
        }
    ...
    public final View d(int i9) {
        ...
        return new y3(this.c, this.a, this.b);
    }
    ...
    public final int f(int i9) {
        ...
        return ((TL_stars.TL_starGiftCollection) this.c.e.d().get(i9 - 1)).collection_id;
    }
    ...
    public final CharSequence g(int i9) {
        ...
        TL_stars.TL_starGiftCollection tL_starGiftCollection = (TL_stars.TL_starGiftCollection) this.c.e.d().get(i9 - 1);
