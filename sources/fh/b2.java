...
public final class b2 extends Drawable {
    ...
    public b2(ViewGroup viewGroup, org.telegram.ui.ActionBar.b6 b6Var, boolean z10) {
        ...
        this.q = paint3;
        this.r = new org.telegram.ui.Components.y5(new o1(this, 1), 320L, gr.h);
    ...
    public final void a(boolean z10) {
        if (this.t != z10) {
            ...
            Paint paint = this.c;
            if (z10) {
                paint.setShadowLayer(AndroidUtilities.dp(1.66f), 0.0f, AndroidUtilities.dp(0.33f), org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.a6, this.b));
            } else {
    ...
    public final void b(Canvas canvas, float f10) {
        ...
        if (stargiftattributebackdrop != null) {
            ...
            if (this.j == null || this.i != lerp) {
                ...
                int i9 = stargiftattributebackdrop2.center_color | (-16777216);
                this.j = new RadialGradient(0.0f, 0.0f, f12, new int[]{i9, i9, stargiftattributebackdrop2.edge_color | (-16777216)}, new float[]{0.0f, 0.0f, 1.0f}, Shader.TileMode.CLAMP);
            }
        ...
        org.telegram.ui.ActionBar.b6 b6Var2 = this.b;
        final int v02 = org.telegram.ui.ActionBar.f6.v0(i10, b6Var2);
        int i11 = org.telegram.ui.ActionBar.f6.d6;
        final int v03 = org.telegram.ui.ActionBar.f6.v0(i11, b6Var2);
        final int i12 = 0;
        boolean z11 = this.s == ((float) AndroidUtilities.dp(11.0f)) && v02 == org.telegram.ui.ActionBar.f6.w0(null, i10, false) && v03 == org.telegram.ui.ActionBar.f6.w0(null, i11, false);
        boolean z12 = this.g;
        a(z12 && !z11);
        if (z11) {
            if (C == null) {
            ...
            if (this.h != null) {
                if (z12) {
                    j2 j2Var = C;
                    if (j2Var.b == null || j2Var.h != v02) {
                        j2Var.h = v02;
                        Bitmap[] bitmapArr = j2Var.a;
                        float[] fArr = j2Var.g;
                        final float dp = AndroidUtilities.dp(1.66f);
                        final float dp2 = AndroidUtilities.dp(0.33f);
                        j2Var.b = g7.z5.b(bitmapArr, fArr, dp, dp2, 0, new og.f() { // from class: og.e
                            @Override // og.f
                    ...
                    NinePatchDrawable ninePatchDrawable2 = j2Var.b;
                    ff.s.h(ninePatchDrawable2, rect);
                ...
                if (z12) {
                    j2 j2Var2 = C;
                    if (j2Var2.f == null || (j2Var2.j != v03 && j2Var2.k != v02)) {
                        j2Var2.j = v03;
                        j2Var2.k = v02;
                        Bitmap[] bitmapArr2 = j2Var2.e;
                        float[] fArr2 = j2Var2.g;
                        final float dp3 = AndroidUtilities.dp(1.66f);
                        final float dp4 = AndroidUtilities.dp(0.33f);
                        j2Var2.f = g7.z5.b(bitmapArr2, fArr2, dp3, dp4, v03, new og.f() { // from class: og.e
                            @Override // og.f
                    ...
                    ninePatchDrawable = j2Var2.f;
                } else {
                    j2 j2Var3 = C;
                    if (j2Var3.d == null || j2Var3.i != v03) {
                        j2Var3.i = v03;
                        final float f14 = 0.0f;
                        final float f15 = 0.0f;
                        j2Var3.d = g7.z5.b(j2Var3.c, j2Var3.g, 0.0f, 0.0f, v03, new og.f() { // from class: og.e
                            @Override // og.f
                            public final void a(Canvas canvas3, RectF rectF2, float[] fArr22) {
                                Path path = new Path();
                                path.addRoundRect(rectF2, fArr22, Path.Direction.CW);
                                ...
                                float f132 = f14;
                                if (f132 > 0.0f) {
                                    paint2.setShadowLayer(f132, 0.0f, f15, i12);
                                }
                                canvas3.drawPath(path, paint2);
                                if (f132 > 0.0f) {
                                    paint2.clearShadowLayer();
                    ...
                    ninePatchDrawable = j2Var3.d;
                }
                ff.s.h(ninePatchDrawable, rect);
        ...
        int[] iArr = this.m;
        a2 a2Var = this.l;
        boolean z13 = (iArr == null && (this.h == null || a2Var.d())) ? false : true;
        if (z13) {
            canvas2.save();
            Path path = this.f;
            path.rewind();
        ...
        if (this.h == null || a2Var.d()) {
            b6Var = b6Var2;
        } else {
            int i13 = this.h.pattern_color | (-16777216);
            canvas2.save();
            canvas2.translate(bounds.centerX(), bounds.centerY());
            int i14 = Build.VERSION.SDK_INT;
            if (i14 >= 29) {
                Drawable drawable = a2Var.f[0];
                f11 = 1.0f;
                if (drawable != null && a2Var.d.c == 1.0f && (drawable instanceof org.telegram.ui.Components.k5)) {
                        ...
                        if (bitmap != null) {
                            ...
                            if (this.B != i13 || z10) {
                                ...
                                if (i14 >= 29) {
                                    ...
                                    paint3.setColorFilter(new BlendModeColorFilter(i13, blendMode));
                                } else {
                                    this.A.setColorFilter(new PorterDuffColorFilter(i13, PorterDuff.Mode.SRC_IN));
                                }
                            }
                            if (f10 < 1.0f) {
                                bitmap2 = bitmap;
                                gh.y0.b(canvas2, 2, this.A, bitmap2, bounds.width(), bounds.height(), 1.0f - f10);
                            } else {
                                bitmap2 = bitmap;
                            }
                            if (f10 > 0.0f) {
                                canvas2.translate(0.0f, AndroidUtilities.dp(-31.0f));
                                gh.y0.b(canvas2, 0, this.A, bitmap2, bounds.width(), bounds.height(), f10);
                            }
                            canvas2 = canvas;
                            canvas2.restore();
                        }
            ...
            a2Var.k(Integer.valueOf(i13));
            if (f10 < f11) {
                canvas2 = canvas;
                gh.y0.a(canvas2, 2, a2Var, bounds.width(), bounds.height(), f11 - f10, 1.0f);
            } else {
                canvas2 = canvas;
            }
            if (f10 > 0.0f) {
                canvas2.translate(0.0f, AndroidUtilities.dp(-31.0f));
                gh.y0.a(canvas2, 0, a2Var, bounds.width(), bounds.height(), f10, 1.0f);
            }
            canvas2.restore();
        }
        if (z13) {
        ...
        if (e10 > 0.0f) {
            ...
            if (i16 == 0) {
                Integer num = this.x;
                paint4.setColor(num != null ? num.intValue() : org.telegram.ui.ActionBar.f6.v0(this.w, b6Var));
            ...
            if (i16 == 1) {
                Integer num2 = this.x;
                paint4.setColor(num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.f6.v0(this.w, b6Var3));
