...
public abstract class h {
    ...
    static {
        ...
        f = j.i(new jr(0.7f, -0.6f, 0.4f, 1.0f), 0, 200, 560, false);
        g = j.i(new jr(0.7f, -0.6f, 0.4f, 1.0f), 200, 400, 560, true);
        ...
        jr jrVar = jr.h;
        j = j.i(jrVar, 0, 320, 560, false);
        k = j.i(jrVar, 40, 320, 560, false);
        l = j.i(new DecelerateInterpolator(), 0, MediaDataController.MAX_LINKS_COUNT, 560, false);
        m = j.i(jrVar, 0, 460, 560, false);
        n = j.i(jrVar, 0, 325, 560, false);
        ...
        q = j.i(jrVar, 60, 320, 560, false);
        r = j.i(jrVar, 90, 380, 560, false);
        s = j.i(jrVar, 110, 440, 560, false);
