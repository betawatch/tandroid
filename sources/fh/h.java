...
public final /* synthetic */ class h implements Runnable {
        ...
        switch (i10) {
            case 0:
                ...
                if (n2Var != null && n2Var.getParentActivity() != null) {
                    if (tL_error != null) {
                        y4.f0(i11, tL_error, n2Var, tL_messages_hideChatJoinRequest, new Object[0]);
                        break;
                    } else {
                        ...
                        if (z10) {
                            qb qbVar = new qb(n2Var.getParentActivity(), n2Var.getResourceProvider());
                            ...
                            spannableStringBuilder.setSpan(new k41(AndroidUtilities.bold()), indexOf, firstName.length() + indexOf, 18);
                            qbVar.b.setText(spannableStringBuilder);
                            if (arrayList2.isEmpty()) {
                                ec.g(n2Var, qbVar, 2750).j();
                            } else {
                                ec.f(vVar.h, qbVar, 2750).j();
                            }
                        }
                        z n10 = n2Var.getActionBar().n();
    ...
    public /* synthetic */ h(File file, ArrayList arrayList, n2 n2Var, rn rnVar, TLRPC.Document document, boolean z10, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        this.e = file;
        this.b = arrayList;
        this.c = n2Var;
        this.f = rnVar;
    ...
    public /* synthetic */ h(zf1 zf1Var, TLRPC.TL_error tL_error, boolean z10, TLObject tLObject, byte[] bArr, String str, TL_account.passwordInputSettings passwordinputsettings) {
        this.e = zf1Var;
        this.b = tL_error;
        this.d = z10;
        this.c = tLObject;
