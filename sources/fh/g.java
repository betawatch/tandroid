...
public final /* synthetic */ class g implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                ((SendMessagesHelper) this.c).lambda$requestUrlAuth$37((TLRPC.TL_messages_requestUrlAuth) this.d, (rn) this.e, (String) this.f, this.b, tLObject, tL_error);
                break;
            case 3:
                ((SendMessagesHelper) this.c).lambda$sendEditRichMessageRequest$26(this.b, (MessageObject) this.d, (TLRPC.TL_messages_editMessage) this.e, (n2) this.f, tLObject, tL_error);
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new h((zf1) this.c, tL_error, this.b, tLObject, (byte[]) this.d, (String) this.e, (TL_account.passwordInputSettings) this.f));
                break;
            default:
    ...
    public /* synthetic */ g(SendMessagesHelper sendMessagesHelper, TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth, rn rnVar, String str, boolean z10) {
        this.a = 2;
