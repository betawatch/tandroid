...
public abstract class d extends IntentService {
    ...
    */
    public final boolean c(String str, Intent intent, c cVar) {
        String message;
        boolean b10;
    ...
    public final void onHandleIntent(Intent intent) {
        ...
        while (true) {
            ...
            boolean z10 = true;
            boolean z11 = !b10 || c.a(this.searchActionVerificationServiceConnection);
            if (this.dbg) {
                Log.d(TAG, "GSA app com.google.android.googlequicksearchbox installed: " + b10 + " connected " + c.a(this.searchActionVerificationServiceConnection));
            }
            ...
            if (this.dbg) {
                Log.d(TAG, "AssistantGo app com.google.android.apps.assistant installed: " + b11 + " connected " + c.a(this.assistantGoVerificationServiceConnection));
            }
    ...
    public void postForegroundNotification() {
        b.d();
        NotificationChannel b10 = b.b(getApplicationContext().getResources().getString(R.drawable.$avd_flip__0));
