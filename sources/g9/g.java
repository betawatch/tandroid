...
public final class g {
    ...
    public static String e(List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            try {
                jSONArray.put(new JSONObject(n.a.h(list.get(i10))));
            ...
            if (length != 0) {
                ...
                try {
                    try {
                        ...
                        try {
                            HashMap a2 = a(f9.h.j(fileInputStream));
                        ...
                        th = th;
                        closeable = length;
                        f9.h.c(closeable, "Failed to close user metadata file.");
                        throw th;
                    }
                } catch (Exception e11) {
    ...
    public final String d(String str) {
        ...
        String e11 = s3.c.e("No userId set for session ", str);
        if (Log.isLoggable("FirebaseCrashlytics", 3)) {
