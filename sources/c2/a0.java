...
public final class a0 {
    ...
    public final fa.c b(a0 a0Var) {
        ...
        return new fa.c((p) this.w.get(str), 7);
    }
    ...
    public final boolean d() {
        ...
        return TextUtils.equals(((ComponentName) ((android.support.v4.media.c) c().d).b).getPackageName(), "android") && m("android.media.intent.category.LIVE_AUDIO") && !m("android.media.intent.category.LIVE_VIDEO");
    }
    ...
    */
    ...
    public final void j(int i9) {
        ...
        c0.b();
        e c10 = c0.c();
        int min = Math.min(this.q, Math.max(0, i9));
