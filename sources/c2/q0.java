...
public class q0 extends r0 implements i0 {
    ...
    public void A() {
        ...
        this.C = true;
        mediaRouter.addCallback(this.y, h0Var, (this.B ? 1 : 0) | 2);
    }
    ...
    public void C(p0 p0Var) {
        MediaRouter.UserRouteInfo userRouteInfo = p0Var.b;
        b0 b0Var = p0Var.a;
        userRouteInfo.setName(b0Var.d);
        userRouteInfo.setPlaybackType(b0Var.l);
        userRouteInfo.setPlaybackStream(b0Var.m);
        userRouteInfo.setVolume(b0Var.p);
        userRouteInfo.setVolumeMax(b0Var.q);
        userRouteInfo.setVolumeHandling((!b0Var.e() || d0.g()) ? b0Var.o : 0);
    ...
    public final s d(String str) {
        int p10 = p(str);
        if (p10 >= 0) {
            return new n0(((o0) this.D.get(p10)).a);
        }
        return null;
    }
    ...
    public final int o(MediaRouter.RouteInfo routeInfo) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            if (((o0) arrayList.get(i10)).a == routeInfo) {
                return i10;
            }
        }
        return -1;
    ...
    public final int p(String str) {
        ...
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (((o0) arrayList.get(i10)).b.equals(str)) {
                return i10;
            }
        }
        return -1;
    ...
    public final int q(b0 b0Var) {
        ...
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (((p0) arrayList.get(i10)).a == b0Var) {
                return i10;
            }
        }
        return -1;
    ...
    public boolean t(o0 o0Var) {
        return o0Var.a.isConnecting();
    }

    public void u(o0 o0Var, m mVar) {
        MediaRouter.RouteInfo routeInfo = o0Var.a;
    ...
    public final void v(b0 b0Var) {
        ...
        if (c3 == this) {
            ...
            if (o10 < 0 || !((o0) this.D.get(o10)).b.equals(b0Var.b)) {
                return;
            }
            b0Var.l();
            return;
    ...
    public final void w(b0 b0Var) {
        ...
        MediaRouter.UserRouteInfo userRouteInfo = ((p0) this.E.remove(q10)).b;
    ...
    public final void y() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            n nVar = ((o0) arrayList2.get(i10)).c;
            if (nVar == null) {
