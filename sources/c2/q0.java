...
public class q0 extends r0 implements i0 {
    ...
    public void A() {
        ...
        this.B = true;
        mediaRouter.addCallback(this.y, h0Var, (this.A ? 1 : 0) | 2);
    }
    ...
    public final s d(String str) {
        int p10 = p(str);
        if (p10 >= 0) {
            return new n0(((o0) this.C.get(p10)).a);
        }
        return null;
    }
    ...
    public final void v(b0 b0Var) {
        ...
        if (c3 == this) {
            ...
            if (o10 < 0 || !((o0) this.C.get(o10)).b.equals(b0Var.b)) {
                return;
            }
            b0Var.l();
            return;
    ...
    public final void w(b0 b0Var) {
        ...
        MediaRouter.UserRouteInfo userRouteInfo = ((p0) this.D.remove(q6)).b;
