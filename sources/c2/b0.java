...
public final class b0 {
    ...
    public final za.c b(b0 b0Var) {
        ...
        return new za.c((q) this.w.get(str), 7);
    }
    ...
    public final boolean d() {
        ...
        if (b0Var == this || this.n == 3) {
            return true;
        }
        return TextUtils.equals(((ComponentName) ((m5.i) c().d).b).getPackageName(), "android") && m("android.media.intent.category.LIVE_AUDIO") && !m("android.media.intent.category.LIVE_VIDEO");
    }
    ...
    */
    public final int i(n nVar) {
        ...
        boolean z10 = c3.size() != this.v.size();
        if (!c3.isEmpty()) {
            e c6 = d0.c();
            int size = c3.size();
            int i14 = 0;
            while (i14 < size) {
                ...
                i14++;
                c6.getClass();
                String str = (String) c6.k.get(new q0.b(((ComponentName) this.a.d.b).flattenToShortString(), (String) obj));
                ArrayList arrayList3 = c6.j;
        ...
        if (e()) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (this.v.get(i10) != this) {
                    sb2.append(((b0) this.v.get(i10)).c);
                }
            }
            sb2.append(']');
        }
