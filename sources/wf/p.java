...
public final class p extends g {
    ...
    public final void K() {
        if (g.y1) {
            int length = ((xf.d) this.e0).a.length;
            ...
            if (j10 > 0) {
                ...
                if (f10 != this.i0) {
                    ...
                    ValueAnimator e6 = g.e(this.g0, this.i0, new d0(this, 13));
                    this.a0 = e6;
                    e6.start();
                }
            }
    ...
    public final void k(Canvas canvas) {
        ...
        int min = Math.min(((xf.d) this.e0).b.length - 1, this.D + i13 + 2);
        int i14 = 0;
        while (true) {
            arrayList = this.d;
            ...
            if (this.p0 != max || !z4) {
                ...
                while (i16 < arrayList.size()) {
                    ...
                    if (fVar.n || fVar.o != 0.0f) {
                        long[] jArr = fVar.a.a;
                        float f26 = (((f18 - f11) * ((xf.d) this.e0).b[max]) + (f11 / f12)) - f20;
                        i11 = min;
                        i12 = max;
        ...
        if (z4) {
            ...
            while (i22 < arrayList.size()) {
                ...
                if (z10 || fVar2.o != 0.0f) {
                    ...
                    float f28 = (((f18 - f11) * ((xf.d) this.e0).b[this.p0]) + (f11 / f12)) - f20;
    ...
    public final void n(Canvas canvas) {
        ...
        xf.b bVar = this.e0;
        if (bVar != null) {
            int length = ((xf.d) bVar).b.length;
            ArrayList arrayList = this.d;
            int size = arrayList.size();
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ((yf.f) arrayList.get(i12)).j = 0;
            }
            ...
            int i13 = 0;
            while (i13 < length) {
                float f11 = ((xf.d) this.e0).b[i13] * this.z0;
                int i14 = 0;
                while (true) {
                    f10 = 0.0f;
                    if (i14 >= size) {
                ...
                if (i13 % max == 0) {
                    ...
                    while (i15 < size) {
                        ...
                        if (fVar2.n || fVar2.o != f10) {
                            float f13 = g.y1 ? this.g0 : ((xf.d) this.e0).e;
                            long[] jArr3 = this.A1;
                            i10 = i13;
            ...
            xf.b bVar2 = this.e0;
            float f16 = ((xf.d) bVar2).b.length < 2 ? 1.0f : ((xf.d) bVar2).b[1] * this.z0;
    ...
    public final long r(int i10, int i11) {
        return ((xf.d) this.e0).m.rMaxQ(i10, i11);
    }
    ...
    @Override // wf.g
    public final void z() {
        int length = ((xf.a) ((xf.d) this.e0).d.get(0)).a.length;
        int size = ((xf.d) this.e0).d.size();
        ((xf.d) this.e0).l = new long[length];
        for (int i10 = 0; i10 < length; i10++) {
            ((xf.d) this.e0).l[i10] = 0;
            for (int i11 = 0; i11 < size; i11++) {
                if (((yf.h) this.d.get(i11)).n) {
                    xf.b bVar = this.e0;
                    long[] jArr = ((xf.d) bVar).l;
                    jArr[i10] = jArr[i10] + ((xf.a) ((xf.d) bVar).d.get(i11)).a[i10];
                }
            }
        }
        xf.b bVar2 = this.e0;
        ((xf.d) bVar2).m = new SegmentTree(((xf.d) bVar2).l);
        super.z();
    }
