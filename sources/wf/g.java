...
public abstract class g extends View implements i {
    ...
    /* JADX WARN: Type inference failed for: r1v10, types: [wf.b] */
    /* JADX WARN: Type inference failed for: r1v9, types: [wf.b] */
    public g(Context context, g6 g6Var) {
        ...
        this.I0 = new ValueAnimator.AnimatorUpdateListener(this) { // from class: wf.b
        ...
        this.J0 = new ValueAnimator.AnimatorUpdateListener(this) { // from class: wf.b
            public final /* synthetic */ g b;
    ...
    public final void F() {
        ...
        if (f11 != f12) {
            ...
            if (f13 > 1.0f) {
                ...
                float f14 = this.Q0;
                this.v = (pr.g.getInterpolation(f13) * (f12 - f14)) + f14;
            }
            invalidate();
        }
        if (this.M0) {
            ...
            if (f15 != f16) {
                ...
                if (f17 > 1.0f) {
                    ...
                    float f18 = this.R0;
                    this.w = (pr.g.getInterpolation(f17) * (f16 - f18)) + f18;
                }
                invalidate();
            }
        }
    ...
    public final void G() {
        int i10 = this.u0 ? k6.Zi : k6.Yi;
        g6 g6Var = this.T0;
        int v02 = k6.v0(i10, g6Var);
        this.K.setColor(v02);
        this.L.setColor(k6.v0(this.u0 ? k6.Zi : k6.Yi, g6Var));
        ...
        this.P.setColor(k6.v0(k6.d6, g6Var));
    ...
    public yf.d f(int i10, long j10, long j11) {
        return new yf.d(j10, j11, this.M0, this.e0.h, i10, this.K, this.L);
    }
    ...
    public void j(Canvas canvas) {
        ...
        while (true) {
            ...
            int i15 = ((yf.b) arrayList.get(this.k0)).a;
            if (i15 == 0) {
                i15 = 1;
            }
    ...
    */
    public void l(Canvas canvas, yf.d dVar) {
        float f10;
        int i10;
        int i11;
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void p(Canvas canvas, yf.d dVar) {
        float f10;
        int i10;
        int i11;
        TextPaint textPaint;
    ...
    public long r(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            if (((yf.f) arrayList.get(i12)).n) {
                long rMaxQ = ((yf.f) arrayList.get(i12)).a.b.rMaxQ(i10, i11);
                if (rMaxQ > j10) {
                    j10 = rMaxQ;
                }
            }
    ...
    public long s(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            if (((yf.f) arrayList.get(i12)).n) {
                long rMinQ = ((yf.f) arrayList.get(i12)).a.b.rMinQ(i10, i11);
                if (rMinQ < j10) {
                    j10 = rMinQ;
                }
            }
        ...
        while (true) {
            ...
            if (fVar.n && fVar.o != 1.0f) {
                ...
                if (valueAnimator4 == null || !valueAnimator4.isRunning()) {
                    final int i12 = 0;
                    ValueAnimator e6 = e(fVar.o, 1.0f, new ValueAnimator.AnimatorUpdateListener(this) { // from class: wf.c
                        public final /* synthetic */ g b;
            ...
            if (!fVar.n && fVar.o != 0.0f && ((valueAnimator = fVar.i) == null || !valueAnimator.isRunning())) {
                final int i13 = 1;
                ValueAnimator e10 = e(fVar.o, 0.0f, new ValueAnimator.AnimatorUpdateListener(this) { // from class: wf.c
                    public final /* synthetic */ g b;
