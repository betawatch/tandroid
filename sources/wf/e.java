...
public final class e extends FrameLayout {
    ...
    public e(Context context) {
        ...
        final int i10 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: wf.c
        ...
        final int i11 = 1;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: wf.c
            public final /* synthetic */ e b;
    ...
    public final void a(Canvas canvas, int i10, float f9, int i11, int i12, boolean z10, Paint paint) {
        ...
        int cos = (i11 / 2) + ((int) (Math.cos(Math.toRadians(90.0f - ((i10 * 5) + f9))) * dp));
    ...
    public final void b(float f9) {
        ...
        this.f = String.format("%.1fº", Float.valueOf(f9));
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            a(canvas3, i10, f9, width, height, i10 == floor || (i10 == 0 && floor == -1), (i10 < floor || (i10 == 0 && f9 < 0.0f)) ? paint : paint2);
            int i11 = i10;
            if (i11 != 0) {
                int i12 = -i11;
                a(canvas3, i12, f9, width, height, i12 == floor + 1, i12 > floor ? paint : paint2);
            }
            i10 = i11 + 1;
            canvas = canvas3;
        }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 2) {
                float max = Math.max(-45.0f, Math.min(45.0f, this.n + ((float) ((((this.s - x4) / AndroidUtilities.density) / 3.141592653589793d) / 1.649999976158142d))));
    ...
    public void setMirrored(boolean z10) {
        this.e.setColorFilter(z10 ? new PorterDuffColorFilter(g6.w0(null, g6.zf, false), PorterDuff.Mode.MULTIPLY) : null);
    }

    public void setRotated(boolean z10) {
        this.d.setColorFilter(z10 ? new PorterDuffColorFilter(g6.w0(null, g6.zf, false), PorterDuff.Mode.MULTIPLY) : null);
    }
