...
public abstract class j {
    ...
    public static void a(String str, g gVar, List list, SpannableStringBuilder spannableStringBuilder, List list2) {
            ...
            case 7:
                ...
                for (int i13 = 0; i13 < arrayList.size(); i13++) {
                    if ("rt".equals(((f) arrayList.get(i13)).a.a)) {
                        ...
                        spannableStringBuilder.setSpan(new u(25), i11, i14, 33);
        ...
        for (int i16 = 0; i16 < b10.size(); i16++) {
            ...
            if (((i17 == -1 && cVar.m == -1) ? -1 : (i17 == 1 ? (char) 1 : (char) 0) | (cVar.m == 1 ? (char) 2 : (char) 0)) != -1) {
                int i18 = cVar.l;
                v8.a(new StyleSpan((i18 == -1 && cVar.m == -1) ? -1 : (i18 == 1 ? 1 : 0) | (cVar.m == 1 ? 2 : 0)), spannableStringBuilder, i10, length);
            }
            if (cVar.j == 1) {
            ...
            if (cVar.g) {
                ...
                v8.a(new ForegroundColorSpan(cVar.f), spannableStringBuilder, i10, length);
            }
            if (cVar.i) {
                if (!cVar.i) {
                    throw new IllegalStateException("Background color not defined.");
                }
                v8.a(new BackgroundColorSpan(cVar.h), spannableStringBuilder, i10, length);
            }
            if (cVar.e != null) {
                v8.a(new TypefaceSpan(cVar.e), spannableStringBuilder, i10, length);
            }
            int i19 = cVar.n;
            if (i19 == 1) {
                v8.a(new AbsoluteSizeSpan((int) cVar.o, true), spannableStringBuilder, i10, length);
            } else if (i19 == 2) {
                v8.a(new RelativeSizeSpan(cVar.o), spannableStringBuilder, i10, length);
            } else if (i19 == 3) {
                v8.a(new RelativeSizeSpan(cVar.o / 100.0f), spannableStringBuilder, i10, length);
            }
            if (cVar.q) {
                spannableStringBuilder.setSpan(new db.a(25), i10, length, 33);
            }
        }
    }
    ...
    public static d d(String str, Matcher matcher, w wVar, ArrayList arrayList) {
        ...
        try {
            ...
            iVar.c = f(str, sb.toString(), arrayList);
