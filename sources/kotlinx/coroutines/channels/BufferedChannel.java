...
public class BufferedChannel implements Channel {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x003a, code lost:
        ...
        r0 = kotlinx.coroutines.internal.InlineList.plus-FjFbRPM(r0, r4);
    ...
    */
    ...
    public final ChannelSegment findSegmentReceive(long j, ChannelSegment channelSegment) {
        ...
        if (SegmentOrClosed.isClosed-impl(findSegmentInternal)) {
            ...
            channelSegment = (ChannelSegment) SegmentOrClosed.getSegment-impl(findSegmentInternal);
            if (!isRendezvousOrUnlimited() && j <= getBufferEndCounter() / BufferedChannelKt.SEGMENT_SIZE) {
                ...
                while (true) {
                    ...
                    if (segment3.id >= channelSegment.id || !channelSegment.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, segment3, channelSegment)) {
    ...
    */
    public String toString() {
        ...
        if (i != 2) {
            str = i == 3 ? "cancelled," : "closed,";
            sb2.append("capacity=" + this.capacity + ',');
            sb2.append("data=[");
            listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new ChannelSegment[]{receiveSegment$FU.get(this), sendSegment$FU.get(this), bufferEndSegment$FU.get(this)});
            ...
            loop2: do {
                ...
                while (true) {
                    ...
                    if (element$kotlinx_coroutines_core != null) {
                        ...
                        sb.append(obj);
                        sb.append(',');
                        sb.append(element$kotlinx_coroutines_core);
                        sb.append("),");
                    } else {
                        sb = new StringBuilder();
                        sb.append(obj);
