    ...
    private final void resumeImpl(Object obj, int i, Function1 function1) {
        ...
        while (true) {
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj2, resumedState((NotCompleted) obj2, obj3, i2, function12, null))) {
                    detachChildIfNonResuable();
                    dispatchResume(i2);
                    return;
                } else {
                ...
                if (obj2 instanceof CancelledContinuation) {
                    ...
                    if (cancelledContinuation.makeResumed()) {
                        if (function13 != null) {
                            callOnCancellation(function13, cancelledContinuation.cause);
                            return;
                        }
                        return;
                    }
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function1 function1) {
        ...
        while (true) {
            ...
            if (obj3 instanceof NotCompleted) {
                ...
                Object obj5 = obj2;
                Function1 function12 = function1;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj3, resumedState((NotCompleted) obj3, obj4, this.resumeMode, function12, obj5))) {
                    detachChildIfNonResuable();
