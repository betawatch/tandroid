...
public abstract class CancellableKt {
    ...
    public static final void startCoroutineCancellable(Continuation continuation, Continuation continuation2) {
        ...
        try {
            ...
            Result.Companion companion = Result.Companion;
            DispatchedContinuationKt.resumeCancellableWith$default(intercepted, Result.constructor-impl(Unit.INSTANCE), null, 2, null);
        } catch (Throwable th) {
    ...
    public static final void startCoroutineCancellable(Function2 function2, Object obj, Continuation continuation, Function1 function1) {
        ...
        try {
            ...
            Result.Companion companion = Result.Companion;
            DispatchedContinuationKt.resumeCancellableWith(intercepted, Result.constructor-impl(Unit.INSTANCE), function1);
        } catch (Throwable th) {
