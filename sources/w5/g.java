    ...
    */
    public static int b(Context context, int i10) {
            ...
            synchronized (z5.l.a) {
                try {
                    if (!z5.l.b) {
                        z5.l.b = true;
                        try {
                            bundle = i6.b.a(context).a.getPackageManager().getApplicationInfo(context.getPackageName(), 128).metaData;
                        } catch (PackageManager.NameNotFoundException e10) {
                            Log.wtf("MetadataValueReader", "This should never happen.", e10);
                        }
                        if (bundle != null) {
                            bundle.getString("com.google.app.id");
                            z5.l.c = bundle.getInt("com.google.android.gms.version");
                        }
                    }
                } finally {
                }
        ...
        try {
            if (!g6.b.f(context)) {
                if (g6.b.d == null) {
                    g6.b.d = Boolean.valueOf(context.getPackageManager().hasSystemFeature("android.hardware.type.iot") || context.getPackageManager().hasSystemFeature("android.hardware.type.embedded"));
                }
                if (!g6.b.d.booleanValue()) {
                    z10 = true;
                    z5.l.b(i10 < 0);
