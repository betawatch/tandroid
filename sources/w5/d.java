...
public final class d extends e {
    ...
    public final void h(Context context, int i10, PendingIntent pendingIntent) {
        ...
        String f9 = i10 == 6 ? q.f(context, "common_google_play_services_resolution_required_title") : q.d(context, i10);
        if (f9 == null) {
            f9 = context.getResources().getString(org.telegram.messenger.beta.R.string.common_google_play_services_notification_ticker);
        }
        String e10 = (i10 == 6 || i10 == 19) ? q.e(context, "common_google_play_services_resolution_required_text", q.a(context)) : q.c(context, i10);
        ...
        if (g6.b.b == null) {
            g6.b.b = Boolean.valueOf(packageManager.hasSystemFeature("android.hardware.type.watch"));
        }
        if (g6.b.b.booleanValue()) {
