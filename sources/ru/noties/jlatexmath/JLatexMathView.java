...
public class JLatexMathView extends View {
    ...
    private static float alignment(int i10, float f9) {
        if (i10 == 0) {
            return 0.0f;
        }
        return 1 == i10 ? f9 / 2.0f : f9;
    }
