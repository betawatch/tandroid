...
public final class k1 extends FrameLayout {
    ...
    public k1(Context context, g6 g6Var) {
        ...
        addView(textView, c6.d(-1, -2.0f, 7, z4 ? 40.0f : 78.0f, 10.33f, z4 ? 78.0f : 40.0f, 0.0f));
        TextView textView2 = new TextView(context);
        this.d = textView2;
        textView2.setLines(2);
        textView2.setEllipsize(truncateAt);
        org.telegram.ui.b.l(k6.z6, g6Var, textView2, 1, 15.0f);
        boolean z10 = LocaleController.isRTL;
        addView(textView2, c6.d(-1, -2.0f, 7, z10 ? 40.0f : 78.0f, 32.0f, z10 ? 78.0f : 40.0f, 0.0f));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.s) {
            Paint T0 = k6.T0("paintDivider", this.n);
            if (T0 == null) {
                T0 = k6.k0;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        paint.setColor(k6.l1(0.85f, k6.v0(k6.z6, this.n)));
        Path path = this.f;
        path.rewind();
