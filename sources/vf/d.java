...
public final class d {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, vf.d] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public d(long j10, long j11, boolean z10, float f9, int i10, TextPaint textPaint, TextPaint textPaint2) {
        long j12;
        float f10;
        int i11;
        long max;
        ...
        if (z10) {
            ...
            if (j15 == 0) {
                ...
                if (j15 >= 6) {
                    ...
                    boolean z11 = f10 / f9 >= 1.0f;
                    i12 = 0;
                    d dVar = obj;
                    while (i12 < i11) {
                        long j17 = ((long) (i12 * f10)) + j12;
                        dVar.a[i12] = j17;
                        dVar.b[i12] = dVar.b(0, textPaint, j17, i10);
                        if (f9 > 0.0f) {
                            float f12 = dVar.a[i12] / f9;
                            if (z11) {
                                long j18 = (long) f12;
                                if (f12 - j18 < 0.01f || i10 == 1 || i10 == 2) {
        ...
        if (j10 > 100) {
            ...
            if ((j10 / 5) % 10.0f != 0.0f) {
                ...
                if (j14 < 6) {
                    ...
                    boolean z12 = ((float) max2) / f9 < 1.0f;
                    i14 = 1;
                    while (i14 < i13) {
                        long j20 = i14 * max2;
                        obj.a[i14] = j20;
                        ...
                        if (f9 > 0.0f) {
                            float f13 = obj.a[i14] / f9;
                            if (z12) {
                                long j22 = (long) f13;
                                if (f13 - j22 < 0.01f || i10 == 1 || i10 == 2) {
