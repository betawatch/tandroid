...
public final class l0 extends p2 {
    ...
    public final void X(int i10, boolean z4, final Runnable runnable) {
        ...
        if (!this.H && i10 == e0 && z4) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Allow), new c2(this) { // from class: vf.j0
                ...
                public final void j(d2 d2Var2, int i13) {
                    switch (i12) {
                        case 0:
                            this.b.H = true;
                            runnable.run();
        ...
        alertDialog$Builder2.k(LocaleController.getString(R.string.Allow), new c2(this) { // from class: vf.j0
            ...
            @Override // org.telegram.ui.ActionBar.c2
            public final void j(d2 d2Var22, int i13) {
                switch (i11) {
                    case 0:
                        this.b.H = true;
                        runnable.run();
    ...
    public final void b0() {
        ...
        if (z4 != (e6 || this.x || longSparseArray.size() > 0)) {
            ...
            this.s.animate().alpha(z10 ? 1.0f : 0.0f).translationY(z10 ? 0.0f : AndroidUtilities.dp(8.0f)).setDuration(320L).setInterpolator(prVar).start();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        int i11 = k6.G6;
        editTextBoldCursor2.setTextColor(k6.w0(null, i11, false));
        ...
        this.f.setCursorColor(k6.w0(null, i11, false));
        this.f.setCursorSize(AndroidUtilities.dp(19.0f));
        this.f.setCursorWidth(1.5f);
        this.f.setOnEditorActionListener(new mh.j(this, 1));
        this.f.addTextChangedListener(new eh.c(this, 18));
