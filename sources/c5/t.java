...
public final /* synthetic */ class t implements Callable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:100:0x00b6, code lost:
        ...
        r0 = r2.s(c5.f0.h, 107, "Service has been reset to null.", r5);
     */
    /*
    ...
    */
    private final Object a() {
        ...
        android.support.v4.media.c cVar3 = (android.support.v4.media.c) this.d;
        Exception exc = null;
        if (!cVar2.n()) {
            h hVar = f0.h;
            cVar2.y(2, 7, hVar);
        ...
        if (!cVar2.r) {
            ...
            c0Var.a(hVar2, new r(vVar2, vVar2));
            return null;
        }
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList();
        String str = ((q) ((com.google.android.gms.internal.play_billing.r) cVar3.b).get(0)).b;
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    ...
                    if (c12 == null) {
                        lVar = cVar2.s(f0.n, 44, "queryProductDetailsAsync got empty product details response.", null);
                        break;
                    }
                    if (c12.containsKey("DETAILS_LIST")) {
                        ArrayList<String> stringArrayList = c12.getStringArrayList("DETAILS_LIST");
                        if (stringArrayList == null) {
                            lVar = cVar2.s(f0.n, 46, "queryProductDetailsAsync got null response list", null);
                            break;
                        }
                        ...
                        while (i17 < size3) {
                            ...
                            try {
                                ...
                                lVar = cVar2.s(f0.a(6, "Error trying to decode SkuDetails."), 47, "Got a JSON exception trying to decode ProductDetails. \n Exception: ", e);
                            }
                        }
                        ...
                        try {
                            ...
                            lVar = cVar2.s(f0.a(6, "Error trying to decode SkuDetails."), 47, "Got a JSON exception trying to decode UnfetchedProduct. \n Exception: ", e7);
                        }
                    } else {
                        ...
                        lVar = a2 != 0 ? cVar2.s(f0.a(a2, f7), 23, k0.h(a2, "getSkuDetails() failed for queryProductDetailsAsync. Response code: "), null) : cVar2.s(f0.a(6, f7), 45, "getSkuDetails() returned a bundle with neither an error nor a product detail list for queryProductDetailsAsync.", null);
                    }
                } catch (DeadObjectException e10) {
                    e = e10;
                    lVar = cVar2.s(f0.h, i10, "queryProductDetailsAsync got a remote exception (try to reconnect).", e);
                    c0Var.a(f0.a(lVar.a, (String) lVar.d), new r((ArrayList) lVar.b, (ArrayList) lVar.c));
                    return null;
                } catch (Exception e11) {
                    e = e11;
                    lVar = cVar2.s(f0.f, i10, "queryProductDetailsAsync got a remote exception (try to reconnect).", e);
                    c0Var.a(f0.a(lVar.a, (String) lVar.d), new r((ArrayList) lVar.b, (ArrayList) lVar.c));
                    return null;
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:93:0x008c, code lost:
        ...
        r0 = r2.x(c5.f0.h, 107, "Service has been reset to null", r3);
     */
    ...
    */
    private final Object b() {
        ...
        if (!cVar2.n()) {
            ...
            o oVar = (o) this.c;
            com.google.android.gms.internal.play_billing.p pVar = com.google.android.gms.internal.play_billing.r.b;
            oVar.a(hVar, com.google.android.gms.internal.play_billing.v.e);
            return null;
        }
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            o oVar2 = (o) this.c;
            com.google.android.gms.internal.play_billing.p pVar2 = com.google.android.gms.internal.play_billing.r.b;
            oVar2.a(hVar2, com.google.android.gms.internal.play_billing.v.e);
            return null;
        }
                        ...
                        while (true) {
                            try {
                                try {
                                    ...
                                    e = e;
                                    x10 = cVar2.x(f0.h, 52, "Got exception trying to get purchases try to reconnect", e);
                                    list = (List) x10.a;
                                    if (list != null) {
                                    }
                                    return exc;
                                    ...
                                    e = e7;
                                    x10 = cVar2.x(f0.f, 52, "Got exception trying to get purchases try to reconnect", e);
                                    list = (List) x10.a;
                                    if (list != null) {
                                    }
                                    return exc;
                ...
                if (b12 == null) {
                    ...
                    for (int i11 = 0; i11 < stringArrayList5.size(); i11++) {
                        ...
                        try {
                            ...
                            x10 = cVar2.x(f0.f, 51, "Got an exception trying to decode the purchase!", e10);
                        }
                    }
                    if (z11) {
                        cVar2.y(26, 9, hVar3);
                    ...
                    if (TextUtils.isEmpty(str2)) {
                        x10 = new n4.y(f0.g, arrayList, false);
                        break;
                    }
                    exc2 = exc;
                }
                        ...
                        try {
                            if (cVar == null) {
                                ...
                                try {
                                    ...
                                    e = e7;
                                    exc = e;
                                    cVar2.g(jVar, str2, f0.f, 29, "Error consuming purchase!", exc);
                                    return null;
                                }
                            }
                            if (cVar2.n) {
