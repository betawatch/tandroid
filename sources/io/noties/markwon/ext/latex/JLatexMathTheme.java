...
public abstract class JLatexMathTheme {
    ...
    public static class Builder {
        ...
        static /* synthetic */ Padding access$1000(Builder builder) {
            builder.getClass();
            return null;
        }

        static /* synthetic */ BackgroundProvider access$300(Builder builder) {
            builder.getClass();
            return null;
        }

        static /* synthetic */ BackgroundProvider access$400(Builder builder) {
            builder.getClass();
            return null;
        }

        static /* synthetic */ BackgroundProvider access$500(Builder builder) {
            builder.getClass();
            return null;
        }

        static /* synthetic */ Padding access$800(Builder builder) {
            builder.getClass();
            return null;
        }

        static /* synthetic */ Padding access$900(Builder builder) {
            builder.getClass();
            return null;
        }
