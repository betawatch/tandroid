...
public abstract class d {
    ...
    */
    public static void b(nb.a aVar, rb.b bVar, rb.e eVar, int i10, b bVar2) {
        char c3;
        char c6;
        byte[][] bArr;
        int i11;
        ...
        while (true) {
            ...
            iArr3[i42] = iArr3[i42] ^ aVar3.a[i42];
            i42++;
        }
        if (aVar2.b != 15) {
            throw new r("should not happen but we got: " + aVar2.b);
        }
        int i43 = 0;
        while (true) {
            int i44 = aVar2.b;
        ...
        if (i25 >= 7) {
            ...
            if (aVar4.b != 18) {
                throw new r("should not happen but we got: " + aVar4.b);
            }
            int i46 = 17;
                        ...
                        if (i10 != -1) {
                            switch (i10) {
                                ...
                                case 7:
                                    ...
                                    break;
                                default:
                                    throw new IllegalArgumentException(l1.k(i10, "Invalid mask pattern: "));
                            }
                        }
        ...
        throw new r("Not all bits consumed: " + i52 + '/' + aVar.b);
    }
