...
public abstract class h1 {
    ...
    static {
        int i9 = 0;
        a = new x0(Class.class, new l0().nullSafe(), i9);
        b = new x0(BitSet.class, new w0().nullSafe(), i9);
        z0 z0Var = new z0();
        c = new a1();
        ...
        int i10 = 0;
        h = new x0(AtomicInteger.class, new e1().nullSafe(), i10);
        i = new x0(AtomicBoolean.class, new f1().nullSafe(), i10);
        j = new x0(AtomicIntegerArray.class, new b0().nullSafe(), i10);
        k = new c0();
        new d0();
        new e0();
        ...
        o = new j0();
        int i11 = 0;
        p = new x0(String.class, g0Var, i11);
        q = new x0(StringBuilder.class, new k0(), i11);
        r = new x0(StringBuffer.class, new m0(), i11);
        s = new x0(URL.class, new n0(), i11);
        t = new x0(URI.class, new o0(), i11);
        u = new x0(InetAddress.class, new p0(), 1);
        int i12 = 0;
        v = new x0(UUID.class, new q0(), i12);
        w = new x0(Currency.class, new r0().nullSafe(), i12);
        x = new p(new s0(), 2);
