...
public final class f extends i {
                ...
                if (z10) {
                    if (i10 == 3) {
                        ...
                        if (i12 != -1 && i11 != (i12 + 1) % 4) {
                            h();
                            f5.a.K("Cea708Decoder", "Sequence number discontinuity. previous=" + this.i + " current=" + i11);
                        }
                        this.i = i11;
                        int i13 = r9 & 63;
                        if (i13 == 0) {
    ...
    public final void f() {
        ...
        if (vVar.e != (vVar.d * 2) - 1) {
            f5.a.n("Cea708Decoder", "DtvCcPacket ended prematurely; size is " + ((this.o.d * 2) - 1) + ", but current index is " + this.o.e + " (sequence number " + this.o.c + ");");
        }
        v vVar2 = this.o;
        byte[] bArr = vVar2.b;
        int i12 = vVar2.e;
                ...
                if (eVar2.d) {
                    ...
                    if (!eVar2.c || (arrayList2.isEmpty() && eVar2.b.length() == 0)) {
                        ...
                        if (i15 != 0) {
                            ...
                            int i19 = eVar2.o;
                            dVar = new d(spannableStringBuilder, alignment2, f12, i12, f11, i18, i19 == e.x, i19, eVar2.e);
                        }
                        ...
                        int i192 = eVar2.o;
                        dVar = new d(spannableStringBuilder, alignment22, f122, i12, f112, i18, i192 == e.x, i192, eVar2.e);
                    }
                    if (dVar != null) {
                        arrayList.add(dVar);
                    }
