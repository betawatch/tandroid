...
public final class b {
    ...
    public final t4.b c(int i10) {
        ...
        if (i17 != 1) {
            f9 = i17 != 2 ? u3.c.c(i11, 32.0f, 0.8f, 0.1f) : u3.c.c(32 - length2, 32.0f, 0.8f, 0.1f);
        } else {
            f9 = 0.5f;
        }
        int i18 = this.d;
        ...
        return new t4.b(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, null, null, i18, 1, TLObject.FLAG_31, f9, i17, TLObject.FLAG_31, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, TLObject.FLAG_31, 0.0f);
    }
