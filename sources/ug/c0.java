...
public final class c0 extends FrameLayout {
    ...
    public c0(Context context, f6 f6Var) {
        ...
        frameLayout.addView(w9Var, a6.d(24, 24.0f, z11 ? 5 : 3, z11 ? 0.0f : 12.0f, 0.0f, z11 ? 12.0f : 0.0f, 0.0f));
        boolean z12 = LocaleController.isRTL;
        frameLayout.addView(a14, a6.d(-2, -2.0f, (z12 ? 5 : 3) | 16, z12 ? 0.0f : 29.0f, 0.0f, z12 ? 29.0f : 0.0f, 0.0f));
        ...
        frameLayout2.addView(w9Var2, a6.d(24, 24.0f, z13 ? 5 : 3, z13 ? 0.0f : 12.0f, 0.0f, z13 ? 12.0f : 0.0f, 0.0f));
        boolean z14 = LocaleController.isRTL;
        frameLayout2.addView(a15, a6.d(-2, -2.0f, (z14 ? 5 : 3) | 16, z14 ? 0.0f : 29.0f, 0.0f, z14 ? 29.0f : 0.0f, 0.0f));
        ...
        addView(b0Var, a6.c(-2.0f, -1));
        b0Var.setOutlineProvider(new bi.g(19));
    ...
    public final TextView a(String str, boolean z10) {
        ...
        f6 f6Var = this.n;
        if (z10) {
            textView = new m90(getContext(), f6Var);
            textView.setLinkTextColor(j6.v0(j6.J6, f6Var));
        } else {
            textView = new TextView(getContext());
        }
        em.n(z10 ? j6.m5 : j6.j5, f6Var, textView, 1, 14.0f);
        if (!z10) {
