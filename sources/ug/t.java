...
public final class t extends FrameLayout {
    ...
    public t(Context context, f6 f6Var) {
        ...
        final int i11 = 0;
        frameLayout.setOnClickListener(new View.OnClickListener(this) { // from class: ug.s
        ...
        final int i12 = 1;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: ug.s
            public final /* synthetic */ t b;
    ...
    public final void a(Runnable runnable) {
        ...
        this.b.setOnClickListener(new ai.v(4, runnable));
    }
