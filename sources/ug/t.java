...
public abstract class t {
    ...
    public static void a(long j3, List list, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        connectionsManager.sendRequest(tL_premium_applyBoost, new c5(callback2, messagesController, callback), 66);
    }
    ...
    public static void d(MessageObject messageObject, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        connectionsManager.sendRequest(tL_payments_getGiveawayInfo, new p(callback2, callback, 1));
    }
    ...
    public static int j(int i10, TLRPC.Chat chat, Utilities.Callback callback) {
        ...
        return connectionsManager.sendRequest(tL_payments_getPremiumGiftCodeOptions, new hg.u(chat, i10, callback, 9));
    }
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, n2 n2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (h()) {
            ...
            BillingController.getInstance().queryProductDetails(Arrays.asList(aVar.a()), new org.telegram.ui.Components.e1(tL_inputStorePaymentPremiumGiftCode, tL_premiumGiftCodeOption, connectionsManager, callback2, callback, n2Var, 2));
            return;
        }
        ...
        JSONObject p5 = k3.p(n2Var.getResourceProvider(), false);
        if (p5 != null) {
