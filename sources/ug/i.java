...
public final class i extends RecyclerView {
    ...
    public final void C0(int i10, TLRPC.InputGroupCall inputGroupCall) {
        int i11;
        f fVar = this.Q0;
        if (fVar.d && (i11 = fVar.e) != -1 && fVar.f != null) {
            GroupCallMessagesController.getInstance(i11).unsubscribeFromCallMessages(fVar.f.id, fVar);
        }
        fVar.e = i10;
        fVar.f = inputGroupCall;
        if (fVar.d) {
            fVar.c = GroupCallMessagesController.getInstance(i10).getCallMessages(fVar.f.id);
            fVar.l();
            GroupCallMessagesController.getInstance(i10).subscribeToCallMessages(fVar.f.id, fVar);
        }
    }
            ...
            while (true) {
                ...
                if (childAt instanceof d) {
                    ...
                    if (dVar.getVisibility() == 0) {
                        ...
                        b bVar = dVar.w;
                        if (bVar == null ? false : ((RectF) bVar.c).contains(x10, y11)) {
                            z10 = true;
                            break;
                        }
                    } else {
