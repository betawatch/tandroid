...
public final class j extends LinearLayout implements a6 {
    ...
    public j(Context context, f6 f6Var, boolean z10) {
        ...
        if (LocaleController.isRTL) {
            ...
            addView(f7, w7.a6.p(0, -2, 1.0f, 23, 20, 0, z10 ? 12 : 16, 0));
            addView(frameLayout, w7.a6.t(28, 28, 21, 0, 0, z10 ? 9 : 14, 0));
        } else {
            addView(frameLayout, w7.a6.t(28, 28, 19, z10 ? 9 : 14, 0, 0, 0));
            addView(f7, w7.a6.p(0, -2, 1.0f, 23, z10 ? 12 : 16, 0, 20, 0));
