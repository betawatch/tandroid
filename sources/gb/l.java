...
public final class l extends lb.a {
    ...
    public final void F(int i10) {
        ...
        throw new IllegalStateException("Expected " + hg.k0.E(i10) + " but was " + hg.k0.E(x()) + H());
    }
    ...
    public final double o() {
        int x10 = x();
        if (x10 != 7 && x10 != 6) {
            throw new IllegalStateException("Expected " + hg.k0.E(7) + " but was " + hg.k0.E(x10) + H());
        }
        double q6 = ((db.m) J()).q();
        if (Double.isNaN(q6) || Double.isInfinite(q6)) {
            throw new lb.c("JSON forbids NaN and infinities: " + q6);
        }
        K();
        int i10 = this.F;
        if (i10 > 0) {
    ...
    public final String v() {
        int x10 = x();
        if (x10 != 6 && x10 != 7) {
            throw new IllegalStateException("Expected " + hg.k0.E(6) + " but was " + hg.k0.E(x10) + H());
        }
        String n10 = ((db.m) K()).n();
        int i10 = this.F;
        if (i10 > 0) {
    ...
    public final int x() {
        ...
        if (J2 instanceof db.m) {
            Serializable serializable = ((db.m) J2).a;
        ...
        if (J2 instanceof db.k) {
            return 9;
        }
        if (J2 == J) {
            throw new IllegalStateException("JsonReader is closed");
        }
        throw new lb.c("Custom JsonElement subclass " + J2.getClass().getName() + " is not supported");
    }
}
