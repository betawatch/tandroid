...
public class c1 implements c3.h0 {
    public b2.s A;
    public b2.s B;
    public long C;
    public boolean E;
    ...
    public boolean w;
    public boolean z;
    public final hi.c0 b = new hi.c0();
    ...
    public final a5.a c = new a5.a(new gg.g0(29));
    ...
    public c1(y2.d dVar, n2.n nVar, n2.j jVar) {
        this.d = nVar;
        this.e = jVar;
        this.a = new qo0(dVar);
    }

    public final void A(b2.s sVar, of.b bVar) {
        b2.s sVar2;
        b2.s sVar3 = this.g;
    ...
    public final int C(of.b bVar, h2.h hVar, int i10, boolean z10) {
        int i11;
        boolean z11 = (i10 & 2) != 0;
        hi.c0 c0Var = this.b;
        synchronized (this) {
        ...
        if (i11 == -4 && !hVar.isEndOfStream()) {
            ...
            if ((i10 & 4) == 0) {
                if (z12) {
                    qo0 qo0Var = this.a;
                    qo0.f((z0) qo0Var.f, hVar, this.b, (e2.v) qo0Var.d);
                } else {
                    qo0 qo0Var2 = this.a;
                    qo0Var2.f = qo0.f((z0) qo0Var2.f, hVar, this.b, (e2.v) qo0Var2.d);
                }
            }
            if (!z12) {
                this.s++;
    ...
    public final void D(boolean z10) {
        qo0 qo0Var = this.a;
        qo0Var.a((z0) qo0Var.e);
        z0 z0Var = (z0) qo0Var.e;
        int i10 = qo0Var.a;
        e2.d.g(((y2.a) z0Var.c) == null);
        z0Var.a = 0L;
        z0Var.b = i10;
        z0 z0Var2 = (z0) qo0Var.e;
        qo0Var.f = z0Var2;
        qo0Var.g = z0Var2;
        qo0Var.b = 0L;
        ((y2.d) qo0Var.c).b();
        ...
        for (int i11 = 0; i11 < sparseArray.size(); i11++) {
            ((gg.g0) aVar.d).accept(sparseArray.valueAt(i11));
        }
        aVar.b = -1;
        sparseArray.clear();
        if (z10) {
    ...
    /* JADX WARN: Type inference failed for: r5v26, types: [java.lang.Object, u2.b1] */
    @Override // c3.h0
            ...
            try {
                ...
                if (!Objects.equals(p5, this.B)) {
                    if (!(((SparseArray) this.c.c).size() == 0)) {
                        ...
                        if (((a1) sparseArray.valueAt(sparseArray.size() - 1)).a.equals(p5)) {
                            SparseArray sparseArray2 = (SparseArray) this.c.c;
                            this.B = ((a1) sparseArray2.valueAt(sparseArray2.size() - 1)).a;
                            boolean z11 = this.D;
                            b2.s sVar2 = this.B;
    ...
    */
    ...
    public final int e(b2.k kVar, int i10, boolean z10) {
        qo0 qo0Var = this.a;
        int c10 = qo0Var.c(i10);
        z0 z0Var = (z0) qo0Var.g;
        y2.a aVar = (y2.a) z0Var.c;
        int read = kVar.read(aVar.a, ((int) (qo0Var.b - z0Var.a)) + aVar.b, c10);
        if (read == -1) {
            if (z10) {
                return -1;
            }
        ...
        long j3 = qo0Var.b + read;
        qo0Var.b = j3;
        z0 z0Var2 = (z0) qo0Var.g;
        if (j3 == z0Var2.b) {
            qo0Var.g = (z0) z0Var2.d;
        }
        return read;
    }
    ...
    public final void f(e2.v vVar, int i10, int i11) {
        while (true) {
            ...
            z0 z0Var = (z0) qo0Var.g;
            y2.a aVar = (y2.a) z0Var.c;
            vVar.h(((int) (qo0Var.b - z0Var.a)) + aVar.b, c10, aVar.a);
            i10 -= c10;
            long j3 = qo0Var.b + c10;
            qo0Var.b = j3;
            z0 z0Var2 = (z0) qo0Var.g;
            if (j3 == z0Var2.b) {
                qo0Var.g = (z0) z0Var2.d;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0080, code lost:
        ...
        if (((u2.a1) r9.valueAt(r9.size() - 1)).a.equals(r8.B) == false) goto L23;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final synchronized void g(long j3, int i10, long j10, int i11, c3.g0 g0Var) {
        try {
            ...
            if (sparseArray2.size() > 0) {
                ...
                e2.d.b(i13 >= keyAt);
                if (keyAt == i13) {
                    ((gg.g0) aVar.d).accept(sparseArray2.valueAt(sparseArray2.size() - 1));
                }
            }
            sparseArray2.append(i13, a1Var);
            int i14 = this.p + 1;
            this.p = i14;
            int i15 = this.i;
            if (i14 == i15) {
    ...
    public final long i(int i10) {
        ...
        while (i15 < sparseArray.size() - 1) {
            ...
            ((gg.g0) aVar.d).accept(sparseArray.valueAt(i15));
    ...
    public final long m(int i10) {
        ...
        for (int size = sparseArray.size() - 1; size >= 0 && i10 < sparseArray.keyAt(size); size--) {
            ((gg.g0) aVar.d).accept(sparseArray.valueAt(size));
    ...
    public final void n(int i10) {
        ...
        if (m10 != 0) {
            z0 z0Var = (z0) qo0Var.e;
            if (m10 != z0Var.a) {
                while (qo0Var.b > z0Var.b) {
                    z0Var = (z0) z0Var.d;
                }
                z0 z0Var2 = (z0) z0Var.d;
                z0Var2.getClass();
                qo0Var.a(z0Var2);
                z0 z0Var3 = new z0(z0Var.b, i11);
                z0Var.d = z0Var3;
                if (qo0Var.b == z0Var.b) {
                    z0Var = z0Var3;
                }
                qo0Var.g = z0Var;
                if (((z0) qo0Var.f) == z0Var2) {
                    qo0Var.f = z0Var3;
                    return;
                }
                return;
