...
public final class v0 implements d0, c3.q, y2.h, y2.k, a1 {
    ...
    public v0(Uri uri, g2.h hVar, lf.h hVar2, n2.m mVar, n2.j jVar, qb.b bVar, a5.a aVar, x0 x0Var, y2.d dVar, String str, int i10, b2.s sVar, long j3, z2.a aVar2) {
        this.a = uri;
        this.b = hVar;
        this.c = mVar;
        this.f = jVar;
    ...
    public final void B() {
        ...
        this.d0 = f();
        this.x.f(s0Var, this, this.d.L3(this.U));
    }
    ...
    public final void S(y2.j jVar, long j3, long j10, boolean z10) {
        ...
        t tVar = new t(j10);
        this.d.getClass();
        this.e.o(tVar, 1, -1, null, 0, null, s0Var.r, this.S);
        if (z10) {
            return;
        }
        for (b1 b1Var : this.K) {
    ...
    public final long h(long j3) {
        ...
        if (i10 != 7 && (this.e0 || mVar.d())) {
            ...
            for (int i11 = 0; i11 < length; i11++) {
                b1 b1Var = this.K[i11];
                if (b1Var.t() != 0 || !z11) {
                    if (!(this.P ? b1Var.F(b1Var.q) : b1Var.G(j3, this.e0)) && (zArr[i11] || !this.O)) {
                        z10 = false;
                        break;
                    }
                }
    ...
    */
    ...
    public final long r(x2.s[] sVarArr, boolean[] zArr, c1[] c1VarArr, boolean[] zArr2, long j3) {
        ...
        for (int i14 = 0; i14 < sVarArr.length; i14++) {
            if (c1VarArr[i14] == null && (sVar = sVarArr[i14]) != null) {
                e2.d.g(sVar.length() == 1);
                e2.d.g(sVar.h(0) == 0);
                int b10 = p1Var.b(sVar.b());
                e2.d.g(!zArr3[b10]);
                this.Y++;
                zArr3[b10] = true;
                this.X = sVar.m().x | this.X;
                c1VarArr[i14] = new t0(this, b10);
                zArr2[i14] = true;
                if (!z10) {
                    b1 b1Var = this.K[b10];
                    z10 = (b1Var.t() == 0 || b1Var.G(j3, true)) ? false : true;
                }
            }
        }
        if (this.Y == 0) {
    ...
    public final c3.h0 z(u0 u0Var) {
        ...
        if (this.M) {
            e2.a.n("ProgressiveMediaPeriod", "Extractor added new track (id=" + u0Var.a + ") after finishing tracks.");
            return new c3.n();
        }
        n2.m mVar = this.c;
        mVar.getClass();
        b1 b1Var = new b1(this.n, mVar, this.f);
        b1Var.f = this;
        int i11 = length + 1;
