...
public final class p0 extends l {
    ...
    public final d0 c(f0 f0Var, y2.d dVar, long j3) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            ((List) this.l.get(i10)).add(new o0(a2, d0VarArr[i10]));
        }
        return new n0(this.o, this.q[b10], d0VarArr);
    }
    ...
    public final void o(d0 d0Var) {
        ...
        while (true) {
            ...
            d0 d0Var2 = zArr[i10] ? ((o1) d0VarArr[i10]).a : d0VarArr[i10];
            int i11 = 0;
            while (true) {
                if (i11 >= list.size()) {
                    break;
                }
                if (((o0) list.get(i11)).b.equals(d0Var2)) {
                    list.remove(i11);
                    break;
                }
                i11++;
            ...
            a aVar = aVarArr[i10];
            d0[] d0VarArr2 = n0Var.a;
            aVar.o(zArr[i10] ? ((o1) d0VarArr2[i10]).a : d0VarArr2[i10]);
            i10++;
        }
    }
    ...
    public final f0 u(Object obj, f0 f0Var) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            if (((o0) list.get(i10)).a.equals(f0Var)) {
                return ((o0) ((List) arrayList.get(0)).get(i10)).a;
            }
        }
        return null;
    }
