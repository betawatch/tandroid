...
public class b1 implements c3.h0 {
    ...
    /* JADX WARN: Type inference failed for: r5v26, types: [java.lang.Object, u2.a1] */
    @Override // c3.h0
            ...
            try {
                ...
                if (!Objects.equals(p5, this.B)) {
                    if (!(((SparseArray) this.c.c).size() == 0)) {
                        ...
                        if (((z0) sparseArray.valueAt(sparseArray.size() - 1)).a.equals(p5)) {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0080, code lost:
        ...
        if (((u2.z0) r9.valueAt(r9.size() - 1)).a.equals(r8.B) == false) goto L23;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
