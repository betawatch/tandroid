...
public class z0 implements c3.h0 {
    ...
    public final a5.a c = new a5.a(new s0.b(23));
    ...
    public final int C(n4.y yVar, h2.h hVar, int i10, boolean z10) {
        ...
        if (i11 == -4 && !hVar.isEndOfStream()) {
            ...
            if ((i10 & 4) == 0) {
                if (z12) {
                    ho0 ho0Var = this.a;
                    ho0.f((w0) ho0Var.f, hVar, this.b, (e2.v) ho0Var.d);
                } else {
                    ho0 ho0Var2 = this.a;
                    ho0Var2.f = ho0.f((w0) ho0Var2.f, hVar, this.b, (e2.v) ho0Var2.d);
                }
            }
            if (!z12) {
                this.s++;
    ...
    /* JADX WARN: Type inference failed for: r5v26, types: [java.lang.Object, u2.y0] */
    @Override // c3.h0
            ...
            try {
                ...
                if (!Objects.equals(p5, this.B)) {
                    if (!(((SparseArray) this.c.c).size() == 0)) {
                        ...
                        if (((x0) sparseArray.valueAt(sparseArray.size() - 1)).a.equals(p5)) {
                            SparseArray sparseArray2 = (SparseArray) this.c.c;
                            this.B = ((x0) sparseArray2.valueAt(sparseArray2.size() - 1)).a;
                            boolean z11 = this.D;
                            b2.s sVar2 = this.B;
    ...
    */
    ...
    public final int e(b2.k kVar, int i10, boolean z10) {
        ...
        w0 w0Var = (w0) ho0Var.g;
        y2.a aVar = (y2.a) w0Var.c;
        int read = kVar.read(aVar.a, ((int) (ho0Var.b - w0Var.a)) + aVar.b, c10);
        if (read == -1) {
            if (z10) {
                return -1;
            }
        ...
        ho0Var.b = j3;
        w0 w0Var2 = (w0) ho0Var.g;
        if (j3 == w0Var2.b) {
            ho0Var.g = (w0) w0Var2.d;
        }
        return read;
    }
    ...
    public final void f(e2.v vVar, int i10, int i11) {
        while (true) {
            ...
            w0 w0Var = (w0) ho0Var.g;
            y2.a aVar = (y2.a) w0Var.c;
            vVar.h(((int) (ho0Var.b - w0Var.a)) + aVar.b, c10, aVar.a);
            i10 -= c10;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0080, code lost:
        ...
        if (((u2.x0) r9.valueAt(r9.size() - 1)).a.equals(r8.B) == false) goto L23;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    public final void n(int i10) {
        ...
        if (m10 != 0) {
            w0 w0Var = (w0) ho0Var.e;
            if (m10 != w0Var.a) {
                while (ho0Var.b > w0Var.b) {
                    w0Var = (w0) w0Var.d;
                }
                w0 w0Var2 = (w0) w0Var.d;
                w0Var2.getClass();
                ho0Var.a(w0Var2);
                w0 w0Var3 = new w0(w0Var.b, i11);
                w0Var.d = w0Var3;
                if (ho0Var.b == w0Var.b) {
                    w0Var = w0Var3;
                }
                ho0Var.g = w0Var;
                if (((w0) ho0Var.f) == w0Var2) {
                    ho0Var.f = w0Var3;
                    return;
                }
                return;
