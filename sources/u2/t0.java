...
public final class t0 implements d0, c3.q, y2.h, y2.k, y0 {
    ...
    public final void B() {
        q0 q0Var = new q0(this, this.a, this.b, this.y, this, this.E);
        if (this.N) {
            e2.d.g(v());
            long j3 = this.S;
        ...
        this.d0 = f();
        this.x.f(q0Var, this, this.d.L3(this.U));
    }
    ...
    public final void V(y2.j jVar, long j3, long j10, boolean z10) {
        ...
        t tVar = new t(j10);
        this.d.getClass();
        this.e.o(tVar, 1, -1, null, 0, null, q0Var.r, this.S);
        if (z10) {
            return;
        }
        for (z0 z0Var : this.K) {
    ...
    public final long h(long j3) {
        ...
        if (i10 != 7 && (this.e0 || mVar.d())) {
            ...
            for (int i11 = 0; i11 < length; i11++) {
                z0 z0Var = this.K[i11];
                if (z0Var.t() != 0 || !z11) {
                    if (!(this.P ? z0Var.F(z0Var.q) : z0Var.G(j3, this.e0)) && (zArr[i11] || !this.O)) {
                        z10 = false;
                        break;
                    }
                }
    ...
    */
    public final k4.d n(y2.j jVar, long j3, long j10, IOException iOException, int i10) {
        ...
        if (!(iOException instanceof b2.s0) && !(iOException instanceof FileNotFoundException) && !(iOException instanceof g2.u) && !(iOException instanceof y2.l)) {
            ...
            k4.d dVar2 = dVar;
            this.e.q(tVar, 1, -1, null, 0, null, q0Var.r, this.S, iOException, !dVar2.a());
            return dVar2;
        }
        ...
        k4.d dVar22 = dVar;
        this.e.q(tVar, 1, -1, null, 0, null, q0Var.r, this.S, iOException, !dVar22.a());
        return dVar22;
    }
    ...
    public final void o(y2.j jVar, long j3, long j10, int i10) {
        ...
        this.e.s(tVar, 1, -1, null, 0, null, q0Var.r, this.S, i10);
    }
    ...
    public final long p(x2.r[] rVarArr, boolean[] zArr, a1[] a1VarArr, boolean[] zArr2, long j3) {
        ...
        for (int i14 = 0; i14 < rVarArr.length; i14++) {
            if (a1VarArr[i14] == null && (rVar = rVarArr[i14]) != null) {
                ...
                if (!z10) {
                    z0 z0Var = this.K[b10];
                    z10 = (z0Var.t() == 0 || z0Var.G(j3, true)) ? false : true;
                }
            }
        }
        if (this.Y == 0) {
    ...
    public final void q(y2.j jVar, long j3, long j10) {
        ...
        t tVar = new t(j10);
        this.d.getClass();
        this.e.p(tVar, 1, -1, null, 0, null, q0Var.r, this.S);
        this.e0 = true;
        c0 c0Var = this.I;
        c0Var.getClass();
        c0Var.v(this);
    ...
    public final c3.h0 z(s0 s0Var) {
        ...
        if (this.M) {
            e2.a.n("ProgressiveMediaPeriod", "Extractor added new track (id=" + s0Var.a + ") after finishing tracks.");
            return new c3.n();
        }
        n2.m mVar = this.c;
        mVar.getClass();
        z0 z0Var = new z0(this.n, mVar, this.f);
        z0Var.f = this;
        int i11 = length + 1;
