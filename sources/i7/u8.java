...
public abstract class u8 {
    ...
    public static final w0.d a(CharSequence charSequence, String str) {
        ...
        if (!hd.j.h(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION")) {
            return new w0.c(charSequence, str);
        }
        int i10 = y0.a.c;
        String obj = charSequence != null ? charSequence.toString() : null;
        try {
            if (!hd.j.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION")) {
                throw new z0.a();
            }
            int i11 = y0.a.c;
            return p8.a(str, obj);
    ...
    public static final w0.i b(CharSequence charSequence, String str) {
        ...
        if (!hd.j.h(str, "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION")) {
