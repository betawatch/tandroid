...
public final /* synthetic */ class a5 implements Runnable {
    ...
    public /* synthetic */ a5(v5 v5Var, TLObject tLObject, int i10) {
        this.a = i10;
        this.b = v5Var;
        this.c = tLObject;
    }
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                if (!arrayList2.isEmpty()) {
                    final int i13 = 0;
                    Runnable runnable = new Runnable() { // from class: xh.d5
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i13) {
                                case 0:
                                    ...
                                    while (true) {
                                        ...
                                        if (i14 >= arrayList5.size()) {
                                            ...
                                            billingController.queryProductDetails(arrayList4, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: xh.i4
                                                ...
                                                public final void onProductDetailsResponse(final c5.h hVar, final List list) {
                                                    switch (i15) {
                                                        case 0:
                                                            ...
                                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: xh.k4
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i16 >= arrayList7.size()) {
                                            ...
                                            billingController2.queryProductDetails(arrayList6, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: xh.i4
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final c5.h hVar, final List list) {
                                                    switch (i17) {
                                                        case 0:
                                ...
                                default:
                                    ...
                                    while (true) {
                                        ...
                                        if (i18 >= arrayList9.size()) {
                                            ...
                                            billingController3.queryProductDetails(arrayList8, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: xh.i4
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final c5.h hVar, final List list) {
                                                    switch (i19) {
                                                        case 0:
            ...
            case 3:
                ...
                if (!arrayList5.isEmpty()) {
                    final int i15 = 1;
                    Runnable runnable2 = new Runnable() { // from class: xh.d5
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i15) {
                                case 0:
                                    ...
                                    while (true) {
                                        ...
                                        if (i142 >= arrayList52.size()) {
                                            ...
                                            billingController.queryProductDetails(arrayList42, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: xh.i4
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final c5.h hVar, final List list) {
                                                    switch (i152) {
                                                        case 0:
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i16 >= arrayList7.size()) {
                                            ...
                                            final int i17 = 2;
                                            final v5 v5Var5 = v5Var4;
                                            billingController2.queryProductDetails(arrayList62, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: xh.i4
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final c5.h hVar, final List list) {
                                                    switch (i17) {
                                                        case 0:
            ...
            case 4:
                ...
                if (!arrayList8.isEmpty()) {
                    final int i17 = 2;
                    Runnable runnable3 = new Runnable() { // from class: xh.d5
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i17) {
                                case 0:
                                ...
                                default:
                                    ...
                                    while (true) {
                                        ...
                                        if (i18 >= arrayList92.size()) {
                                            ...
                                            final int i19 = 0;
                                            final v5 v5Var6 = v5Var5;
                                            billingController3.queryProductDetails(arrayList82, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: xh.i4
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final c5.h hVar, final List list) {
                                                    switch (i19) {
                                                        case 0:
