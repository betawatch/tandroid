...
public final class e0 extends org.telegram.ui.ActionBar.h3 {
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, eo eoVar, final org.telegram.ui.ActionBar.f6 f6Var, int i11, Utilities.Callback callback) {
        ...
        final int i12 = 0;
        boolean z11 = canManageMonoForum || v5.y(i10, true).j();
        ...
        if (canManageMonoForum) {
            ...
            w7.c6.a(aVar);
            aVar.setOnClickListener(new View.OnClickListener(this) { // from class: xh.b0
                ...
                public final void onClick(View view) {
                    switch (i12) {
                        ...
                        default:
                            e0 e0Var = this.b;
                            org.telegram.ui.Components.d5.T(context, e0Var.I, new th.e(e0Var, 9), f6Var, 0).a.show();
                            break;
                    }
                }
            });
        ...
        f7.addView(textView, w7.a6.p(-1, -1, 1.0f, 119, 22, 0, 22, 0));
        ...
        f7.addView(imageView, w7.a6.p(48, 48, 0.0f, 21, 0, 0, 6, 0));
        ...
        linearLayout.addView(f10, w7.a6.l(1.0f, -1, -2));
        ...
        f10.addView(hd0Var, w7.a6.k(18.0f, 0.0f, 18.0f, 0.0f, -1, 58));
        ...
        f10.addView(textView2, w7.a6.t(-1, -2, 55, 33, 4, 33, 0));
        ...
        hd0Var2.e(c0Var);
        hd0Var2.addView(c0Var, w7.a6.d(-1, -2.0f, 48, 0.0f, 0.0f, 48.0f, 0.0f));
        w7.c6.b(hd0Var2, 0.02f, 1.2f);
        final int i16 = 1;
        hd0Var2.setOnClickListener(new View.OnClickListener(this) { // from class: xh.b0
            public final /* synthetic */ e0 b;
        ...
        f10.addView(hd0Var2, w7.a6.k(18.0f, 24.0f, 18.0f, 0.0f, -1, 58));
        ...
        f10.addView(textView3, w7.a6.t(-1, -2, 55, 33, 4, 33, 24));
        ...
        if (aVar3 != null) {
            z10 = false;
            q(yf.a.i(aVar3.b, aVar3.a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z10 = false;
    ...
    public final yf.a p() {
        return this.H.a == yf.b.b ? this.G : this.E;
    }
    ...
    public final void q(yf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (z13) {
            ...
            v40 v40Var = this.e;
            if (v40Var != null) {
                v40Var.a(this.H.a == bVar3 ? 0 : 1, z12);
            }
            yf.b bVar4 = this.H.a;
        ...
        if (z13 || z14 || z15) {
            ...
            if (i14 != 0) {
                ...
                dVar.g(z7.V0(z16, LocaleController.formatString(i15, objArr3), z16 ? this.M : this.L), z12, true);
            }
            n(z12);
        }
        if (z13 || z14) {
