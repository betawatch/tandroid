...
public final class v2 extends FrameLayout {
    ...
    public v2(Context context) {
        ...
        addView(frameLayout, w7.a6.d(-1, -1.0f, 119, 6.0f, 6.0f, 6.0f, 6.0f));
        ...
        this.b = frameLayout2;
        wh.e1 e1Var = new wh.e1(frameLayout2, null, false);
        this.a = e1Var;
        frameLayout2.setBackground(e1Var);
        e1Var.s = AndroidUtilities.dp(18.0f);
        e1Var.u = false;
        frameLayout.addView(frameLayout2, w7.a6.e(-1, -1, 119));
        frameLayout2.setAlpha(0.0f);
        frameLayout2.setScaleX(0.6f);
        frameLayout2.setScaleY(0.6f);
        w9 w9Var = new w9(context);
        this.c = w9Var;
        frameLayout2.addView(w9Var, w7.a6.e(52, 52, 17));
        ...
        addView(textView, w7.a6.d(-2, 15.33f, 51, 2.0f, 0.0f, 2.0f, 0.0f));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.e = frameLayout3;
        frameLayout3.setAlpha(0.0f);
        addView(frameLayout3, w7.a6.d(20, 20.0f, 53, 2.0f, 0.0f, 2.0f, 0.0f));
        ImageView imageView2 = new ImageView(context);
        this.f = imageView2;
        imageView2.setImageResource(R.drawable.msg_close);
        imageView2.setScaleType(ImageView.ScaleType.CENTER);
        frameLayout3.addView(imageView2, w7.a6.e(12, 12, 17));
        b(false, false);
    }
    ...
    public final void a(TL_stars.StarGift starGift, boolean z10) {
        ...
        if (starGift != null) {
            ...
            z7.Z0(this.c.getImageReceiver(), stargiftattributemodel.document, 52);
            ...
            String G0 = di.m.G0(starGift.craft_chance_permille);
    ...
    public final void b(final boolean z10, boolean z11) {
        ...
        wr wrVar = wr.h;
        final int i10 = 0;
        alpha.setInterpolator(wrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: xh.u2
        ...
        final int i11 = 1;
        textView.animate().alpha(z10 ? 1.0f : 0.0f).setInterpolator(wrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: xh.u2
            public final /* synthetic */ v2 b;
        ...
        final int i12 = 2;
        frameLayout2.animate().alpha(z10 ? 1.0f : 0.0f).setInterpolator(wrVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: xh.u2
            public final /* synthetic */ v2 b;
