...
public final /* synthetic */ class l2 implements View.OnClickListener {
    ...
    public /* synthetic */ l2(x2 x2Var, int i10) {
        this.a = i10;
        this.b = x2Var;
    }
        ...
        switch (i10) {
                ...
                if (x2Var2.getAlpha() >= 1.0f && !x2Var2.h0) {
                    if (x2Var2.j0) {
                        ...
                        if (!arrayList.isEmpty() && x2Var2.e0 != null) {
                            ...
                            x2Var2.h0 = true;
                            x2Var2.j0 = false;
                            bi.x4 x4Var = x2Var2.T;
                            if (x4Var != null) {
                                x4Var.e(true);
                                x2Var2.T = null;
                            }
                            textView.setText("");
                            x2Var2.L.setText(LocaleController.formatString(R.string.GiftCraftProgressSuccessChance, di.m.G0(x2Var2.getGiftsSuccessChance())));
                            ...
                            x2Var2.e0.run(arrayList2, new bi.k6(21, x2Var2, arrayList2), new x(x2Var2, 3));
                            break;
                        } else {
            ...
            default:
                ...
                if (starGift5 != null && !v2Var7.n) {
                    ...
                    x2Var.f0.run(new nj0(19, x2Var, v2Var7), Boolean.valueOf(z10));
                    break;
                }
                break;
        }
