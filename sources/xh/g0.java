        ...
        if (j3 >= 0) {
            ...
            if (user != null) {
                ...
                if (arrayList3.size() == arrayList2.size()) {
                    ...
                    for (i11 = 0; i11 < this.J; i11 = com.google.android.gms.internal.vision.e2.d(i11, i11, 1, arrayList)) {
                    }
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (i10 < arrayList2.size()) {
            ...
            int i11 = i10;
            float A = org.telegram.messenger.a2.A(f12, g0Var.n, (f12 - g0Var.e) * d, clamp012);
            int i12 = f0Var2.g;
            float f19 = 1.6f;
            if (i12 != 0) {
                if (i12 != 1) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            f0 f0Var4 = this.M;
            if (f0Var4 != null) {
                nf.f.s(getContext(), "https://t.me/nft/" + f0Var4.e);
                this.M.m.c(false);
                this.M = null;
            }
