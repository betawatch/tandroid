...
public abstract class j0 {
    ...
    public static void b(Canvas canvas, int i10, Paint paint, Bitmap bitmap, float f7, float f10, float f11) {
        ...
        while (true) {
            ...
            e0.i0.b((float[]) i0Var.c, i12, 0.0f, 0.0f, width, height);
            i12++;
        }
        while (true) {
            float[] fArr = a[i10];
            ...
            float f18 = f14 * 1.0f;
            int i13 = i11 / 4;
            e0.i0.b((float[]) i0Var.b, i13, AndroidUtilities.dp(f16) - (AndroidUtilities.dp(f18) / 2.0f), AndroidUtilities.dp(f17) - (AndroidUtilities.dp(f18) / 2.0f), (AndroidUtilities.dp(f18) / 2.0f) + AndroidUtilities.dp(f16), (AndroidUtilities.dp(f18) / 2.0f) + AndroidUtilities.dp(f17));
    ...
    public static void c(Canvas canvas, org.telegram.ui.Components.n5 n5Var, int i10, float f7, float f10, RectF rectF, float f11) {
        ...
        for (int i13 = 54; i12 < i13; i13 = 54) {
            ...
            if (i12 == 18 || i12 == 19 || i12 == 6 || i12 == 7) {
                f13 = wr.i.getInterpolation(f13);
            }
            float[] fArr3 = fArr;
            float a2 = com.google.android.gms.internal.vision.e2.a(1.0f, f15, AndroidUtilities.dp(12.0f), f47);
            if (f13 < 1.0f) {
                f46 = AndroidUtilities.lerp(f18, f46, wr.i.getInterpolation(f13));
                a2 = AndroidUtilities.lerp(f19, a2, f13);
                dpf27 = AndroidUtilities.lerp(AndroidUtilities.dpf2(8.0f), dpf27, f13);
            }
            if (a2 > f51 + AndroidUtilities.dp(8.0f)) {
                f45 = 1.0f;
                f14 = 1.0f - Utilities.clamp01((((a2 - max) - f12) - AndroidUtilities.dp(8.0f)) / AndroidUtilities.dp(56.0f));
            } else {
                f45 = 1.0f;
                f14 = 1.0f;
            }
            float clamp013 = (f45 - Utilities.clamp01(v7.a7.a(f21, f23, f46, a2) / (max2 * 2.0f))) * f11 * 0.5f * f14;
            if (f13 < 1.0f) {
                clamp013 = AndroidUtilities.lerp(0.0f, clamp013, f13);
            }
            n5Var.setBounds((int) (f46 - dpf27), (int) (a2 - dpf27), (int) (f46 + dpf27), (int) (a2 + dpf27));
