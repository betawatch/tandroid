...
public final class h4 extends bb {
    ...
    public static void P(h4 h4Var, g4 g4Var) {
        o70 F = o70.F(h4Var.container, h4Var.resourcesProvider, h4Var.a0);
    ...
    public static void Q(h4 h4Var, g4 g4Var, int i10) {
        ...
        if (obj instanceof TL_stars.StarGift) {
            ...
            if (z10 && (starGift instanceof TL_stars.TL_starGiftUnique)) {
                ...
                t5.x(h4Var.currentAccount, bVar).H(tL_starGiftUnique, clientUserId, null, true, new vo0(h4Var, b2Var2, bVar, tL_starGiftUnique, clientUserId));
                return;
            }
            if (!z10) {
    ...
    public static void R(h4 h4Var, g4 g4Var, Context context) {
        ...
        o70 o70Var = new o70(h4Var.container, h4Var.resourcesProvider, h4Var.b0, false, true, false);
        o70Var.t = false;
        o70Var.Y = true;
        o70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        o70Var.R = true;
        o70Var.p = new ii.h(o70Var, 8);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.f);
        Collections.sort(arrayList, new a4(g4Var, 2));
        int i10 = 0;
        c4 c4Var = new c4(context, h4Var.currentAccount, 0, false, new w3(strArr, g4Var, arrayList, i10), new x3(g4Var, o70Var, i10), null, h4Var.resourcesProvider);
        c4Var.Y2.r = false;
    ...
    public static void S(h4 h4Var, g4 g4Var, Context context) {
        ...
        o70 o70Var = new o70(h4Var.container, h4Var.resourcesProvider, h4Var.d0, false, true, false);
        o70Var.t = false;
        o70Var.Y = true;
        o70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        o70Var.R = true;
        o70Var.p = new ii.h(o70Var, 7);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.h);
        Collections.sort(arrayList, new a4(g4Var, 1));
        int i10 = 2;
        e4 e4Var = new e4(context, h4Var.currentAccount, 0, false, new w3(strArr, g4Var, arrayList, i10), new x3(g4Var, o70Var, i10), null, h4Var.resourcesProvider);
        e4Var.Y2.r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
    ...
    public static void W(h4 h4Var, g4 g4Var, Context context) {
        ...
        o70 o70Var = new o70(h4Var.container, h4Var.resourcesProvider, h4Var.c0, false, true, false);
        o70Var.t = false;
        o70Var.Y = true;
        o70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        o70Var.R = true;
        o70Var.p = new ii.h(o70Var, 6);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.g);
        Collections.sort(arrayList, new a4(g4Var, 0));
        int i10 = 1;
        d4 d4Var = new d4(context, h4Var.currentAccount, 0, false, new w3(strArr, g4Var, arrayList, i10), new x3(g4Var, o70Var, i10), null, h4Var.resourcesProvider);
        d4Var.Y2.r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
