...
public final class v extends za implements GiftAuctionController.OnAuctionUpdateListener {
    ...
    public static final pz0[] q0 = new pz0[1];
    ...
    public v(Context context, f6 f6Var, long j3, TL_stars.StarGift starGift, Runnable runnable) {
        ...
        if (auction2 != null && auction2.previewAttributes != null) {
            ...
            int i24 = j6.J6;
            c90Var3.setTextColor(j6.v0(i24, f6Var));
            c90Var3.setLinkTextColor(j6.v0(i24, f6Var));
    ...
    */
    public final void V(boolean z10) {
        ...
        if (auction2 != null && (tL_starGiftAuctionStateFinished = auction2.auctionStateFinished) != null) {
            ...
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(y7.X0(false, hg.k0.k(this.m0.auctionStateFinished.average_price, ',', new StringBuilder("⭐️ ")), 0.8f, null));
        ...
        if (auction3 != null) {
            ...
            pz0 pz0Var = this.g0;
            if (i10 != i11) {
                pz0Var.setText(LocaleController.getString(R.string.Gift2AuctionTableCurrentQuantity));
                xcVar3.setText(LocaleController.formatNumber(i11, ','));
            } else {
                pz0Var.setText(LocaleController.getString(R.string.Gift2AuctionTableCurrentAvailability));
            ...
            c90Var2.setTextColor(j6.v0(j6.q7, this.resourcesProvider));
