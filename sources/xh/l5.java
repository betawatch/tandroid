...
public final class l5 {
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        ConnectionsManager.getInstance(i13).sendRequest(updatestargiftcollection, new j5(this, i11));
    }
    ...
    public final void i() {
        ...
        this.i = ConnectionsManager.getInstance(i10).sendRequest(getstargiftcollections, new j5(this, 0));
    }
    ...
    public final void k(int i10, TL_stars.SavedStarGift savedStarGift) {
            ...
            if (!arrayList2.isEmpty()) {
                ...
                while (i11 < arrayList2.size()) {
                    ...
                    while (true) {
                        ...
                        if (v5.k(savedStarGift2, (TL_stars.SavedStarGift) arrayList.get(i12))) {
        ...
        ConnectionsManager.getInstance(i13).sendRequest(updatestargiftcollection, new j5(this, i14));
        NotificationCenter.getInstance(i13).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(j3), e);
    }
    ...
    public final void l(TL_stars.SavedStarGift savedStarGift, int i10, boolean z10) {
        ...
        while (it.hasNext()) {
            ((n5) it.next()).n(savedStarGift, i10, z10);
        }
        n5 n5Var = this.g;
        if (n5Var != null) {
    ...
    public final void m(TL_stars.SavedStarGift savedStarGift, boolean z10) {
        Iterator it = this.h.values().iterator();
        while (it.hasNext()) {
            ((n5) it.next()).o(savedStarGift, z10);
        }
        n5 n5Var = this.g;
        if (n5Var != null) {
