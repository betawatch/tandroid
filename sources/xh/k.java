...
public final class k extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public k(Context context, e6 e6Var) {
        ...
        this.c = p6Var;
        int i10 = j6.G6;
        p6Var.setTextColor(j6.v0(i10, e6Var));
        ...
        this.d = p6Var2;
        p6Var2.setTextColor(j6.v0(j6.y6, e6Var));
        ...
        p6Var3.setTextColor(j6.v0(i10, e6Var));
    ...
    public final void a(long j3, boolean z10) {
        this.d.c(v7.X0(false, org.telegram.messenger.q.i((int) j3, ',', new StringBuilder("⭐️")), 0.78f, this.e), z10, true);
    }
