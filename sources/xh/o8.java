...
public abstract class o8 extends View {
    ...
    public o8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.b0 = new Path();
        this.c0 = 0.0f;
        this.f0 = new le.b(this, wrVar, 320L);
        this.a = f6Var;
    ...
    public final void a(float f7) {
        ...
        int value = getValue();
        this.l0.addListener(new o00(this, f7, value));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        l8Var.g(rectF2);
        float f11 = this.c0;
        l8Var.h = (f11 * 15.0f) + 1.0f;
        l8Var.j = (int) (l8Var.b.size() * ((f11 * 0.85f) + 0.15f));
        l8Var.d();
        canvas.save();
