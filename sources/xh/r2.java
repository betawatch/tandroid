...
public abstract class r2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public r2(int i10, long j3, Context context, org.telegram.ui.ActionBar.n2 n2Var, e6 e6Var) {
        super(context);
        int i11;
        String str;
        this.H = -1;
        nr0 nr0Var = (nr0) this;
        this.N = new t1(nr0Var, 2);
        this.O = new le.b(0, new v1(nr0Var), qr.h, 380L, true);
        this.Q = AndroidUtilities.displaySize.y;
        this.a = n2Var;
        this.b = i10;
        if (DialogObject.isEncryptedDialog(j3)) {
            TLRPC.EncryptedChat l4 = org.telegram.messenger.y0.l(MessagesController.getInstance(i10), j3);
            if (l4 != null) {
                this.c = l4.user_id;
            } else {
                this.c = j3;
        ...
        int i12 = 1;
        m5 G = u5.y(i10, false).G(this.c, true);
        this.d = G;
        l5 F = u5.y(i10, false).F(this.c, true);
        this.e = F;
        F.g = G;
        G.o = true;
        ...
        G.a();
        this.f = e6Var;
        w1 w1Var = new w1(nr0Var, context, n2Var);
        this.h = w1Var;
        w1Var.setAllowDisallowInterceptTouch(true);
        w1Var.setAdapter(new x1(nr0Var, i10, e6Var));
        addView(w1Var, x5.e(-1, -1, 119));
        h81 n10 = w1Var.n(10, true);
        this.n = n10;
        int i13 = i6.Gh;
        int i14 = i6.G6;
        int i15 = i6.Eh;
        ...
        n10.r = 12;
        n10.setPreTabClick(new v1(nr0Var));
        n10.setOnTabLongClick(new org.telegram.ui.Components.d2(nr0Var, i10, n2Var, context, e6Var, 5));
        addView(n10, x5.e(-1, 42, 48));
        fh.c cVar = new fh.c();
        int i18 = i6.d6;
        cVar.a(i6.v0(i18, e6Var));
        ah.c cVar2 = new ah.c(cVar);
        ai.x5 x5Var = new ai.x5(context);
        ch.d c10 = cVar2.c(x5Var, new dh.b(i18, e6Var), false);
        ...
        linearLayout.setBackground(i6.Y(i6.v0(i6.i6, e6Var), 24, 24));
        ...
        this.E = textView;
        vl.o(i6.j5, e6Var, textView, 1, 14.0f);
        ...
        linearLayout.setOnClickListener(new va(nr0Var, n2Var, i10, 19));
        Boolean bool = G.h;
        if (bool != null) {
        ...
        if (z10) {
            ...
            if (j10 >= 0) {
                ...
                SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(org.telegram.messenger.y0.h(R.string.ProfileGiftsAdd, new StringBuilder("+ ")));
                ...
                x5Var.setOnClickListener(new uq0(nr0Var, z10, i10, i12));
        ...
        SpannableStringBuilder spannableStringBuilder22 = new SpannableStringBuilder(org.telegram.messenger.y0.h(R.string.ProfileGiftsAdd, new StringBuilder("+ ")));
    ...
    public int getBottomOffset() {
        float translationY = this.r.getTranslationY() - org.telegram.messenger.y0.B(this.x, Math.max(AndroidUtilities.dp(240.0f), this.Q) + (-r0.getTop()), 1);
    ...
    public int getGiftsCount() {
        ...
        if (currentPage == null || (m5Var = currentPage.e) == m5Var2) {
            if (m5Var2 != null && (i10 = m5Var2.n) > 0) {
                return i10;
            }
        } else if (m5Var != null && (i11 = m5Var.n) > 0) {
            return i11;
        }
        int i12 = this.b;
        long j3 = this.c;
    ...
    public long getLastEmojisHash() {
        long j3 = 0;
        m5 m5Var = this.d;
        if (m5Var != null && !m5Var.l.isEmpty()) {
            HashSet hashSet = new HashSet();
            int i10 = 0;
            for (int i11 = 0; i10 < 3 && i11 < m5Var.l.size(); i11++) {
                TLRPC.Document document = ((TL_stars.SavedStarGift) m5Var.l.get(i11)).gift.getDocument();
                if (document != null) {
    ...
    public final void h(String str, Utilities.Callback callback) {
        ...
        z1Var.lineYFix = true;
        z1Var.setOnEditorActionListener(new a2(z1Var, callback, b2VarArr, currentFocus));
        ...
        z1Var.setTextColor(i6.v0(i6.j5, e6Var));
        ...
        z1Var.setLineColors(i6.v0(i6.k6, e6Var), i6.v0(i6.l6, e6Var), i6.v0(i6.p7, e6Var));
    ...
    public final boolean k(int i10) {
        ...
        if (i11 >= 0) {
            l5 l5Var = this.e;
            if (i11 < l5Var.d().size()) {
                m5 e = (i11 < 0 || i11 >= l5Var.d().size()) ? null : l5Var.e(((TL_stars.TL_starGiftCollection) l5Var.d().get(i11)).collection_id);
                if (e != null) {
                    return e.l.isEmpty();
                }
            }
    ...
    public final void l() {
        ...
        float B = nextPositionAlpha + org.telegram.messenger.y0.B(this.x, (-frameLayout.getTop()) + this.Q, 1);
        ...
        if (viewPages != null) {
            for (View view : viewPages) {
                if (view != null) {
                    ...
                    e6 e6Var2 = n2Var.c;
                    if (n2Var.s != null) {
                        n2Var.w.setTextColor(i6.v0(i6.G6, e6Var2));
                        TextView textView = n2Var.x;
                        int i11 = i6.Oh;
                        textView.setTextColor(i6.v0(i11, e6Var2));
                        n2Var.x.setBackground(i6.Y(i6.l1(0.1f, i6.v0(i11, e6Var2)), 4, 4));
                    } else {
                        n2Var.F.setTextColor(i6.v0(i6.G6, e6Var2));
                        n2Var.G.setTextColor(i6.v0(i6.y6, e6Var2));
                        n2Var.H.j();
                    }
                }
            }
        }
        this.E.setTextColor(i6.v0(i6.j5, e6Var));
        this.y.setBackground(i6.Y(i6.v0(i6.i6, e6Var), 24, 24));
    }
