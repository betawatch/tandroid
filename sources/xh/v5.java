...
public final class v5 {
    ...
    public static void e(String str) {
        ...
        com.google.android.gms.internal.vision.e2.o(R.string.UnknownErrorCode, new Object[]{str}, (R == null || R.visibleDialog != null) ? wc.X() : wc.a0(R), R.raw.error, 36);
    }
    ...
    public final void H(TL_stars.StarGift starGift, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getPaymentForm, new wh.s3(5, this, callback));
    }
    ...
    public final void K(long j3, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(getstargiftupgradepreview, new org.telegram.messenger.voip.h(this, j3, callback, 4));
    }
    ...
    public final void M(TL_stars.InputSavedStarGift inputSavedStarGift, Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(getsavedstargift, new l9(this, d2Var, inputSavedStarGift, callback, 17));
    }
    ...
    public final void W() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_getStarsSubscriptions, new v4(this, 1));
    }
    ...
    public final void X(int i10) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getStarsTransactions, new di.k4(this, i10, 7));
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:118:0x0637  */
    /* JADX WARN: Removed duplicated region for block: B:121:0x063a  */
    ...
    */
    public final void Y(MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, Runnable runnable, Utilities.Callback callback) {
        ...
        if (!this.e) {
            r(new te(this, runnable, messageObject, inputInvoice, tL_payments_paymentFormStars, callback, 18));
            return;
        }
        ...
        s31 s31Var2 = new s31(this, zArr, callback);
        org.telegram.ui.ActionBar.h3 i20 = em.i(1, context2, I, false);
        ...
        if (messageObject == null || (message2 = messageObject.messageOwner) == null || !(message2.media instanceof TLRPC.TL_messageMediaPaidMedia)) {
            ...
            if (webDocument != null) {
                ...
                frameLayout2.addView(w9Var, w7.a6.e(80, 80, 48));
                viewGroup.addView(frameLayout2, w7.a6.e(80, 87, 17));
                ...
                j10 = j14;
                textView.setText(z7.R0(hc.b.l((int) j14, ',', new StringBuilder("XTR ")), 0.85f, null));
                i12 = 0;
                ...
                frameLayout3.addView(textView, w7.a6.q(-2, 16, 119));
                frameLayout2.addView(frameLayout3, w7.a6.a(-2.0f, 18.66f, 81));
                n7 n7Var = new n7(context2, i19, I);
                w7.c6.a(n7Var);
                n7Var.setOnClickListener(new h6(n7Var, i12));
                viewGroup.addView(n7Var, w7.a6.d(-2, -2.0f, 53, 0.0f, 0.0f, -8.0f, 0.0f));
                f7.addView(viewGroup, w7.a6.q(i11, 117, 7));
                TextView g10 = org.telegram.messenger.a2.g(context2, r22, 20.0f);
                ...
                g10.setGravity(17);
                f7.addView(g10, w7.a6.t(-2, -2, 1, 0, webDocument == null ? -8 : 8, 0, 0));
                if (webDocument != null) {
                    LinearLayout f10 = em.f(context2, i12);
                    ...
                    g9Var.r(user3);
                    w9Var2.e(user3, g9Var);
                    f10.addView(w9Var2, w7.a6.n(28, 28));
                    ...
                    f10.addView(textView2, w7.a6.t(-2, -2, 16, 6, 0, 10, 0));
                    f7.addView(f10, w7.a6.t(-2, 28, 1, 0, 8, 0, 2));
                }
                TextView g11 = org.telegram.messenger.a2.g(context2, r22, 14.0f);
                    ...
                    if (dialogId >= 0) {
                        ...
                        if (user4 != null && user4.bot) {
                            ...
                            if (i14 != 0) {
                                ...
                                objArr[r22] = str2;
                                formatPluralString2 = LocaleController.formatPluralString(str3, i23, objArr);
                                j11 = j15;
                            } else {
                                j11 = j10;
                                if (i22 == 0) {
                                    ...
                                    objArr2[r22] = str2;
                                    formatPluralString2 = LocaleController.formatPluralString(str3, i24, objArr2);
                                } else {
                                    ...
                                    if (i22 == r22) {
                                        ...
                                        c10 = 2;
                                        formatPluralString = LocaleController.formatPluralString("StarsConfirmPurchaseMedia_Photos", i22, new Object[i12]);
                                    }
                                    String string = i14 == r22 ? LocaleController.getString(R.string.StarsConfirmPurchaseMedia_SingleVideo) : LocaleController.formatPluralString("StarsConfirmPurchaseMedia_Videos", i14, new Object[i12]);
                                    Object[] objArr3 = new Object[3];
                                    objArr3[i12] = formatPluralString;
                                    objArr3[r22] = string;
                                    objArr3[c10] = str2;
                                    formatPluralString2 = LocaleController.formatPluralString(str5, i25, objArr3);
                                }
                            }
                ...
                g11.setGravity(17);
                f7.addView(g11, w7.a6.t(-2, -2, 1, 0, 6, 0, 18));
                bi.d dVar = new bi.d(context2, I, r22);
                if (i10 <= 0) {
                    dVar.g(z7.Q0(AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("StarsConfirmSubscriptionButton", (int) j11))), i12, r22);
                } else {
                    dVar.g(z7.Q0(AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("StarsConfirmPurchaseButton", (int) j11))), i12, r22);
                }
                f7.addView(dVar, w7.a6.c(48.0f, -1));
                m90 m90Var = new m90(context2, I);
                m90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, I));
                m90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
                m90Var.setTextSize(r22, 14.0f);
                m90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i10 <= 0 ? R.string.StarsConfirmSubscriptionTOS : R.string.StarsConfirmPurchaseTOS), new ci.a(context2, 8)));
                m90Var.setGravity(17);
                f7.addView(m90Var, w7.a6.k(0.0f, 12.0f, 0.0f, 2.0f, -1, -2));
                org.telegram.ui.ActionBar.h3 h3Var2 = h3Var;
                h3Var2.customView = f7;
                dVar.setOnClickListener(new wh.r(w4Var, h3Var2, dVar, 3));
                h3Var2.setOnDismissListener(new gg.o(s31Var, 10));
            ...
            g9Var2.r(user3);
            w9Var3.e(user3, g9Var2);
            viewGroup.addView(w9Var3, w7.a6.e(80, 80, 17));
        } else {
            ...
            viewGroup.addView(d7Var2, w7.a6.e(i16, i16, i15));
        }
        j10 = j14;
        r22 = 1;
        i11 = -1;
        i12 = 0;
        n7 n7Var2 = new n7(context2, i19, I);
        w7.c6.a(n7Var2);
        n7Var2.setOnClickListener(new h6(n7Var2, i12));
        viewGroup.addView(n7Var2, w7.a6.d(-2, -2.0f, 53, 0.0f, 0.0f, -8.0f, 0.0f));
        f7.addView(viewGroup, w7.a6.q(i11, 117, 7));
        TextView g102 = org.telegram.messenger.a2.g(context2, r22, 20.0f);
        ...
        g102.setGravity(17);
        f7.addView(g102, w7.a6.t(-2, -2, 1, 0, webDocument == null ? -8 : 8, 0, 0));
        if (webDocument != null) {
        }
        TextView g112 = org.telegram.messenger.a2.g(context2, r22, 14.0f);
        ...
        g112.setMaxWidth(bi.x4.a(g112.getText(), g112.getPaint()));
        g112.setGravity(17);
        f7.addView(g112, w7.a6.t(-2, -2, 1, 0, 6, 0, 18));
        bi.d dVar2 = new bi.d(context2, I, r22);
        if (i10 <= 0) {
        }
        f7.addView(dVar2, w7.a6.c(48.0f, -1));
        m90 m90Var2 = new m90(context2, I);
        m90Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, I));
        m90Var2.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, I));
        m90Var2.setTextSize(r22, 14.0f);
        m90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(i10 <= 0 ? R.string.StarsConfirmSubscriptionTOS : R.string.StarsConfirmPurchaseTOS), new ci.a(context2, 8)));
        m90Var2.setGravity(17);
        f7.addView(m90Var2, w7.a6.k(0.0f, 12.0f, 0.0f, 2.0f, -1, -2));
        org.telegram.ui.ActionBar.h3 h3Var22 = h3Var;
        h3Var22.customView = f7;
        dVar2.setOnClickListener(new wh.r(w4Var, h3Var22, dVar2, 3));
        h3Var22.setOnDismissListener(new gg.o(s31Var, 10));
    ...
    public final void Z(final String str, final TLRPC.ChatInvite chatInvite, final Utilities.Callback2 callback2) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: xh.h4
            ...
            public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: xh.n4
                    ...
                    public final void run() {
                        ...
                        String str6 = str4;
                        org.telegram.ui.ActionBar.p2 R = LaunchActivity.R();
                        wc a02 = !AndroidUtilities.hasDialogOnTop(R) ? wc.a0(R) : wc.X();
                        int i10 = 0;
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 == null || !"BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                ...
                                com.google.android.gms.internal.vision.e2.o(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, a02, R.raw.error, 36);
                                return;
                                ...
                                boolean[] zArr = {false};
                                o7 o7Var = new o7(context3, f6Var2, j11, 1, chatInvite3.title, new ac0((Object) v5Var2, (Object) zArr, str6, (Object) chatInvite3, (Object) callback23, 29), 0L);
                        ...
                        Utilities.stageQueue.postRunnable(new s4(v5Var2, tL_payments_paymentResult, i10));
    ...
    public final void a0(final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: xh.g5
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                final v5 v5Var = v5.this;
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: xh.i5
                    ...
                    */
                    public final void run() {
                        ...
                        if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                            if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                                if (!MessagesController.getInstance(v5Var2.a).starsPurchaseAvailable()) {
                                    ...
                                    boolean[] zArr = {false};
                                    o7 o7Var = new o7(context3, f6Var2, j14, 0, str6, new te(v5Var2, zArr, messageObject3, inputInvoice3, tL_payments_paymentFormStars3, callback3, 20), j15);
                                    o7Var.setOnDismissListener(new org.telegram.ui.ActionBar.m3(callback3, zArr));
                                    o7Var.show();
                                    return;
                                }
                            }
                            if (tL_error2 != null && "FORM_EXPIRED".equals(tL_error2.text)) {
                                TLRPC.TL_payments_getPaymentForm tL_payments_getPaymentForm = new TLRPC.TL_payments_getPaymentForm();
                                JSONObject p5 = di.n3.p(f6Var2, false);
                                if (p5 != null) {
                                    TLRPC.TL_dataJSON tL_dataJSON = new TLRPC.TL_dataJSON();
                                    tL_payments_getPaymentForm.theme_params = tL_dataJSON;
                                    tL_dataJSON.data = p5.toString();
                                ...
                                ConnectionsManager.getInstance(v5Var2.a).sendRequest(tL_payments_getPaymentForm, new ze(v5Var2, messageObject3, inputInvoice3, callback3, X, 14));
                                return;
                            }
                            wc wcVar = X;
                            callback3.run(Boolean.FALSE);
                            com.google.android.gms.internal.vision.e2.o(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, wcVar, R.raw.error, 36);
                        ...
                        Utilities.stageQueue.postRunnable(new s4(v5Var2, (TLRPC.TL_payments_paymentResult) tLObject2, 4));
    ...
    */
    public final void d(MessageObject messageObject) {
        ...
        if (r5Var2 == null || r5Var2.g <= 0 || !r5Var2.m || r5Var2.n || r5Var2.o) {
            ...
            jcVar.c.setText(AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("PaidMessageSentSubtitle", Math.max(0, (int) r5Var4.h))));
            jcVar.a.d();
            return;
        }
        z10 = true;
    ...
    public final u5 d0(final MessageObject messageObject, final eo eoVar, final long j3, boolean z10, boolean z11, final Long l4) {
        ...
        if (z11 && y3.e && y3.q(false, false, null).amount <= 0) {
            ...
            final int i11 = 0;
            new o7(t10, eoVar.getResourceProvider(), j3, 5, str, new Runnable(this) { // from class: xh.y4
                ...
                public final void run() {
                    switch (i11) {
                        case 0:
                            this.b.d0(messageObject, eoVar, j3, true, true, l4);
                            break;
                        default:
                            this.b.d0(messageObject, eoVar, j3, true, true, l4);
                            break;
        ...
        if (z11 && y3.e && y3.q(false, false, null).amount < j11) {
            ...
            long a10 = eoVar.a();
            if (a10 >= j10) {
                str2 = UserObject.getForcedFirstName(eoVar.getMessagesController().getUser(Long.valueOf(a10)));
            } else {
                TLRPC.Chat chat2 = eoVar.getMessagesController().getChat(Long.valueOf(-a10));
                str2 = chat2 != null ? chat2.title : "";
            }
            final int i12 = 1;
            new o7(t10, eoVar.getResourceProvider(), j11, 5, str2, new Runnable(v5Var) { // from class: xh.y4
                public final /* synthetic */ v5 b;
                ...
                public final void run() {
                    switch (i12) {
                        case 0:
                            this.b.d0(messageObject, eoVar, j11, true, true, l4);
                            break;
                        default:
                            this.b.d0(messageObject, eoVar, j11, true, true, l4);
                            break;
        ...
        if (!u5Var4.i && !u5Var4.j) {
            ...
            jcVar.c.a();
            jcVar.c.c(AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsSentText", (int) u5Var4.h, new Object[0])), true, true);
            if (u5Var4.m) {
                u5Var4.f.b = 5000L;
    ...
    public final void g(final long j3, final TLObject tLObject, final TLRPC.TL_textWithEntities tL_textWithEntities, final Utilities.Callback2 callback2) {
        ...
        if ((z10 || (tLObject instanceof TLRPC.TL_premiumGiftCodeOption)) && context2 != null) {
            ...
            ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: xh.m4
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: xh.o4
                        @Override // java.lang.Runnable
                        public final void run() {
                            ...
                            v5 v5Var2 = v5.this;
                            ConnectionsManager.getInstance(v5Var2.a).sendRequest(tL_payments_sendStarsForm, new q4(v5Var2, callback23, context3, f6Var, j11, str, j10, tLObject3, tL_textWithEntities2));
                        }
                    });
                }
            });
    ...
    public final void h(TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z10, Utilities.Callback2 callback2) {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_sendStarsForm, new q4(this, callback2, context2, I, j10, name, tL_payments_paymentFormStarGift, starGift, j3));
    }
    ...
    public final void i(final TL_stars.StarGift starGift, final boolean z10, final boolean z11, final long j3, final TLRPC.TL_textWithEntities tL_textWithEntities, final wh.m4 m4Var) {
        ...
        if (!this.e) {
            r(new Runnable() { // from class: xh.f4
                @Override // java.lang.Runnable
                public final void run() {
                    v5 v5Var = v5.this;
                    boolean z12 = v5Var.e;
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: xh.g4
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                final v5 v5Var = v5.this;
                ...
                final long j10 = j3;
                final TLRPC.TL_textWithEntities tL_textWithEntities2 = tL_textWithEntities;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: xh.p4
                    @Override // java.lang.Runnable
                    public final void run() {
                        TLObject tLObject2 = tLObject;
                        ...
                        connectionsManager.sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: xh.u4
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(final TLObject tLObject3, final TLRPC.TL_error tL_error3) {
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: xh.d4
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        int i11;
                                        String str4;
                                        ...
                                        if (!z21) {
                                            if (tL_error4 != null && "BALANCE_TOO_LOW".equals(tL_error4.text)) {
                                                if (!MessagesController.getInstance(v5Var4.a).starsPurchaseAvailable()) {
                                                    ...
                                                    boolean[] zArr = {false};
                                                    o7 o7Var = new o7(context6, f6Var4, j15, 6, str5, new gc(v5Var4, zArr, starGift5, z19, z20, j16, tL_textWithEntities5, m4Var5), 0L);
                                            ...
                                            m4Var5.run(Boolean.FALSE, null);
                                            com.google.android.gms.internal.vision.e2.o(R.string.UnknownErrorCode, new Object[]{tL_error4 != null ? tL_error4.text : "FAILED_SEND_STARS"}, X, R.raw.error, 36);
                                            return;
                                        }
                                        Utilities.stageQueue.postRunnable(new s4(v5Var4, (TLRPC.TL_payments_paymentResult) tLObject4, i12));
                                        v5Var4.D = false;
                                        v5Var4.E = true;
                                        v5Var4.G = 0L;
                                        v5Var4.V();
                                        ...
                                        if (j16 < 0) {
                                            ...
                                            profileActivity2.whenFullyVisible(new org.telegram.messenger.voip.g(profileActivity2, starGift5, spannableStringBuilder, j15, str4, 13));
    ...
    public final void i0(final long j3, final long j10, boolean z10, final boolean z11) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(togglenopaidmessagesexception, new RequestDelegate() { // from class: xh.z4
            @Override // org.telegram.tgnet.RequestDelegate
        ...
        if (chatInvite != null && chatInvite.subscription_pricing != null) {
            ...
            if (context2 != null) {
                ...
                if (i15 == 2592000) {
                    ...
                    i10 = i13;
                    g11.setText(AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsSubscribeTextTest", (int) tL_starsSubscriptionPricing.amount, chatInvite.title, i15 == 300 ? "5 minutes" : "a minute")));
                }
                g11.setMaxWidth(bi.x4.a(g11.getText(), g11.getPaint()));
                g11.setGravity(17);
    ...
    public final void l0(final MessageObject messageObject, final long j3, final Runnable runnable, final boolean z10) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_editMessage, new RequestDelegate() { // from class: xh.f5
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public final TL_stars.StarsAmount q(boolean z10, boolean z11, Runnable runnable) {
        if (((!this.e || System.currentTimeMillis() - this.c > 60000) && !this.d) || z11) {
            ...
            ConnectionsManager.getInstance(this.a).sendRequest(tL_payments_getStarsStatus, new wh.s3(6, this, runnable));
        }
        if (!z10 || this.g <= 0) {
            return this.f;
        }
        yf.a m10 = yf.a.m(this.f);
        return yf.a.g(Math.max(0L, m10.a() - this.g), m10.a).o();
    }
    ...
    public final yf.a s() {
        yf.a l4 = yf.a.l(p());
        if (l4 == null) {
            return yf.a.i(0L, this.b ? yf.b.b : yf.b.a);
        }
        return l4;
    }
    ...
    public final ArrayList u() {
        ...
        this.k = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stars.TL_payments_getStarsGiftOptions(), new v4(this, 3));
        return this.m;
    }
    ...
    public final ArrayList v() {
        ...
        this.n = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stars.TL_payments_getStarsGiveawayOptions(), new v4(this, 4));
        return this.p;
    }
    ...
    public final ArrayList z() {
        ...
        this.h = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stars.TL_payments_getStarsTopupOptions(), new v4(this, 2));
        return this.j;
    }
}
