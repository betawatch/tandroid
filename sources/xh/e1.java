...
public final class e1 extends Drawable {
    ...
    public e1(ViewGroup viewGroup, e6 e6Var, boolean z10) {
        ...
        this.q = paint3;
        this.r = new c6(new rg.w1(this, 15), 320L, qr.h);
    ...
    */
    public final void b(Canvas canvas, float f7) {
        ...
        int i11 = i6.a6;
        e6 e6Var2 = this.b;
        final int v02 = i6.v0(i11, e6Var2);
        int i12 = i6.d6;
        final int v03 = i6.v0(i12, e6Var2);
        final int i13 = 0;
        ...
        if (this.h == null || d1Var.d()) {
            ...
            if (i15 >= 29) {
                ...
                f10 = 1.0f;
                if (drawable != null && d1Var.d.c == 1.0f && (drawable instanceof o5)) {
                    o5 o5Var = (o5) drawable;
                    ai.l4 l4Var = o5Var.k;
                    long i16 = o5Var.i();
                    if (l4Var != null) {
                        e6Var = e6Var2;
            ...
            if (f7 < f10) {
                canvas2 = canvas;
                yh.j0.a(canvas2, 2, d1Var, bounds.width(), bounds.height(), f10 - f7, 1.0f);
            } else {
                canvas2 = canvas;
            }
            if (f7 > 0.0f) {
                canvas2.translate(0.0f, AndroidUtilities.dp(-31.0f));
                yh.j0.a(canvas2, 0, d1Var, bounds.width(), bounds.height(), f7, 1.0f);
            }
            canvas2.restore();
        }
        if (z13) {
        ...
        if (e > 0.0f) {
            ...
            if (i17 == 0) {
                Integer num = this.x;
                paint4.setColor(num != null ? num.intValue() : i6.v0(this.w, e6Var));
            ...
            if (i17 == 1) {
                Integer num2 = this.x;
                paint4.setColor(num2 != null ? num2.intValue() : i6.v0(this.w, e6Var3));
