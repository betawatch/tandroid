...
public final class j2 extends View {
    ...
    public final void a(int i10, CharSequence charSequence) {
        ...
        if (this.f) {
            ...
            g90Var.e(this.e, 0, 0.0f, 0.0f);
            StaticLayout staticLayout = this.e;
            staticLayout.getSelectionPath(0, staticLayout.getText().length(), g90Var);
            g90Var.a();
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.e != null) {
            ...
            Paint paint = this.c;
            g90 g90Var = this.b;
            canvas.drawPath(g90Var, paint);
            int l1 = org.telegram.ui.ActionBar.j6.l1(0.35f, -16777216);
            Paint paint2 = this.d;
            paint2.setColor(l1);
            canvas.drawPath(g90Var, paint2);
            this.e.draw(canvas);
            canvas.restore();
        }
    }
