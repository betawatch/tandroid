...
public final class a extends i51 {
    ...
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        spannableStringBuilder.setSpan(new x5(auction.giftDocumentId, j6.s2.getFontMetricsInt()), 0, spannableStringBuilder.length(), 33);
        ...
        qz0 qz0Var = new qz0(bVar.getContext(), bVar.a);
        qz0Var.a(spannableStringBuilder).setFilled(true);
        qz0Var.k(LocaleController.getString(R.string.Gift2AuctionsAcquiredRecipient), bVar.b, DialogObject.getPeerDialogId(tL_StarGiftAuctionAcquiredGift.peer), new uh.i(3, bVar, onClickListener));
