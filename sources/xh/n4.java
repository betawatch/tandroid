    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i12) {
            case 0:
                ...
                arrayList.add(y51.j(-1, z4Var.h0));
                if (sendPaidMessagesStars <= 0) {
                    arrayList.add(y51.j(-2, z4Var.s0));
                ...
                if (starGift != null) {
                    if (!starGift.can_upgrade || z13) {
                        ...
                        y51 i14 = y51.i(2, w7.X0(false, LocaleController.formatString(z13 ? R.string.Gift2UpgradeSelf : R.string.Gift2Upgrade, Integer.valueOf((int) starGift.upgrade_stars)), 0.78f, null));
                        i14.K(z4Var.q0);
                        arrayList.add(i14);
                        if (z12) {
                        ...
                        y51 A = y51.A(-5, replaceArrows);
                        A.g = (z11 || z12) ? false : true;
                        arrayList.add(A);
                    }
                    y51 i15 = y51.i(1, LocaleController.getString(z13 ? R.string.Gift2HideSelf : R.string.Gift2Hide));
                    i15.K(z4Var.p0);
                    arrayList.add(i15);
                    if (z13) {
                        ...
                        arrayList.add(y51.A(-6, formatString));
                        if (frameLayout != null) {
                            ...
                            arrayList.add(y51.j(-43, frameLayout));
                            arrayList.add(y51.A(-44, replaceArrows2));
                        }
                    }
                    ...
                    if (sendPaidMessagesStars <= 0) {
                        arrayList.add(y51.A(-3, LocaleController.formatString(R.string.Gift2MessagePremiumInfo, str)));
                    }
                    if (kVar != null && (kVar.c != null || kVar.d != null)) {
                        y51 i17 = y51.i(3, w7.X0(false, LocaleController.formatString(R.string.Gift2MessageStars, Integer.valueOf((int) kVar.g())), 0.78f, null));
                        i17.K(z4Var.r0);
                        arrayList.add(i17);
