...
public final class n5 implements o5 {
    ...
    public final void a() {
        ...
        int sendRequest = ConnectionsManager.getInstance(i10).sendRequest(getsavedstargifts, new bi.f2(this, r2, z10, 8));
        this.m = sendRequest;
    ...
    public final void j(ArrayList arrayList, TL_stars.StarGift starGift) {
        ...
        if (starGift != null) {
            ...
            ConnectionsManager.getInstance(i10).sendRequest(getsavedstargift, new bi.c2(this, 25));
        }
    }
    ...
    public final void l() {
        ...
        if (!z10) {
            ...
            ConnectionsManager.getInstance(i11).sendRequest(togglestargiftspinnedtotop, new bi.g1(4), 64);
            return;
        }
        ...
        if (savedStarGift != null) {
            ...
            if (contains) {
                if (!z10) {
                    ...
                    if (this.e && !this.c) {
                        Collections.sort(arrayList, new sg.p(12));
                    }
                ...
                if (h.size() + 1 <= MessagesController.getInstance(i10).stargiftsPinnedToTopLimit) {
                    ...
                    while (h.size() > 0 && h.size() + 1 > MessagesController.getInstance(i10).stargiftsPinnedToTopLimit) {
                        ((TL_stars.SavedStarGift) hc.b.z(1, h)).pinned_to_top = false;
                    }
                    z12 = true;
                }
                h.add(savedStarGift);
