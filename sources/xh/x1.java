...
public final class x1 extends b81 {
    ...
    public final void a(ArrayList arrayList) {
        ...
        if (currentPage != null) {
            int f7 = currentPage.d ? m5Var.f(currentPage.e.d) + 1 : 0;
            or0Var.n.e(0.0f, f7, f7);
        }
    ...
    public final void b(View view, int i10, int i11) {
        ...
        if (i11 == 0) {
            ...
            if (i12 < 0) {
                m5Var.getClass();
            } else if (i12 < m5Var.d().size()) {
                n5Var = m5Var.e(((TL_stars.TL_starGiftCollection) m5Var.d().get(i12)).collection_id);
                z10 = true;
            }
            n5Var = null;
            z10 = true;
        ...
        if (linearLayout != null) {
            linearLayout.setVisibility(n2Var.a.e.h() ? 0 : 8);
        }
    ...
    public final View d(int i10) {
        ...
        return new n2(this.c, this.a, this.b);
    }
