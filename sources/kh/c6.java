...
public final class c6 extends FrameLayout {
    public float a;
    public float b;
    public final /* synthetic */ xf.s0 c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        ya yaVar = this.d;
        xf.q1 q1Var = yaVar.w1;
        Paint paint = yaVar.u1;
        Paint paint2 = yaVar.t1;
        Paint paint3 = yaVar.v1;
        barView = yaVar.getBarView();
        RectF rectF = AndroidUtilities.rectTmp;
        int left = barView.getLeft();
        h5 h5Var = yaVar.s1;
        rectF.set(AndroidUtilities.lerp(left, h5Var.getLeft(), yaVar.z1), AndroidUtilities.lerp(barView.getTop(), h5Var.getTop(), yaVar.z1), AndroidUtilities.lerp(barView.getRight(), h5Var.getRight(), yaVar.z1), AndroidUtilities.lerp(barView.getBottom(), h5Var.getBottom(), yaVar.z1));
        float lerp = AndroidUtilities.lerp(AndroidUtilities.dp(32.0f), AndroidUtilities.dp(24.0f), yaVar.z1);
        canvas2.drawRoundRect(rectF, lerp, lerp, yaVar.A1);
        if (barView.getChildCount() < 1 || yaVar.z1 == 1.0f) {
            return;
        }
        canvas2.save();
        ...
        if (childAt.getAlpha() != 0.0f) {
            ...
            paint2.setAlpha((int) (childAt.getAlpha() * (1.0f - yaVar.z1) * 255.0f));
            ...
            View view = childAt;
            if (i10 != -1) {
                ViewGroup viewGroup = i10 == 0 ? yaVar.g1 : i10 == 2 ? yaVar.h1 : null;
            ...
            if (h5Var != null && h5Var.getChildCount() > 0) {
                ...
                x10 = AndroidUtilities.lerp(x10, (childAt3.getWidth() / 2.0f) + childAt3.getX() + (h5Var.getX() - barView.getLeft()), yaVar.z1);
                y10 = AndroidUtilities.lerp(y10, (childAt3.getHeight() / 2.0f) + childAt3.getY() + (h5Var.getY() - barView.getTop()), yaVar.z1);
                i9 = i0.a.d(yaVar.z1, q1Var.a, this.c.b(0));
            }
            float f10 = x10;
            float f11 = y10;
            ...
            if (h5Var != null && h5Var.getChildCount() > 0) {
                ...
                min = AndroidUtilities.lerp(min, (Math.min((childAt4.getWidth() - childAt4.getPaddingLeft()) - childAt4.getPaddingRight(), (childAt4.getHeight() - childAt4.getPaddingTop()) - childAt4.getPaddingBottom()) / 2.0f) - AndroidUtilities.dp(2.0f), yaVar.z1);
            }
            float f12 = min;
            ...
            if (h5Var != null && h5Var.getSelectedColorIndex() != 0) {
                dp = AndroidUtilities.lerp(f12 - AndroidUtilities.dp(3.0f), AndroidUtilities.dp(2.0f) + f12, yaVar.z1);
            }
            yf.i1.x1(f10, f11, dp, paint.getColor(), canvas2);
            if (h5Var != null && h5Var.getSelectedColorIndex() == 0) {
                paint3.setAlpha((int) (view.getAlpha() * paint3.getAlpha() * yaVar.z1));
                canvas2.drawCircle(f10, f11, j3.r0.C(1.0f, yaVar.z1, paint3.getStrokeWidth() + AndroidUtilities.dp(3.0f), f12), paint3);
            }
        }
        canvas2.restore();
    }
