...
public final /* synthetic */ class x implements Runnable {
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                new d6((Context) obj3, this.b, ((GiftAuctionController.Auction) obj2).gift, null, this.c, (Runnable) obj, false, false).show();
                break;
            case 1:
                lh.a0 a0Var = (lh.a0) obj2;
                TLObject tLObject = (TLObject) obj;
                int i13 = ((lh.b0) obj3).a;
                ...
                if (tLObject instanceof TL_stars.StarsStatus) {
                    ...
                    zArr3[i12] = z4;
                    a0Var.c[i12] = z4 ? null : starsStatus.next_offset;
            ...
            case 2:
                ...
                int i14 = this.b;
                ConnectionsManager.getInstance(i14).sendRequest(tL_fulfillStarsSubscription, new lh.u(dVar, (org.telegram.ui.ActionBar.g3[]) obj, i14, this.c, 1));
                break;
            case 3:
                t6 t6Var = (t6) obj3;
            ...
            default:
                ...
                if (user == null) {
                    if (chat == null) {
                        ...
                        s1Var.U8[i12].k(i16, chat);
                        s1Var.T8[i12].setForUserOrChat(chat, s1Var.U8[i12]);
                        break;
                    }
                } else {
                    s1Var.U8[i12].m(i16, user);
                    s1Var.T8[i12].setForUserOrChat(user, s1Var.U8[i12]);
                    break;
                }
        }
    }
