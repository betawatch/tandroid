...
public final class e extends FrameLayout {
    ...
    public e(Context context, GiftAuctionController.Auction auction) {
        ...
        this.e = paint;
        this.f = new kf.p(new gg.f(this, 20));
        this.h = new lq(R.drawable.filled_gift_sell_24, 0);
        this.n = new lq[1];
        this.d = auction;
    ...
    public final void b(boolean z4) {
        ...
        String l10 = kf.k0.l(auction.auctionUserState.bid_amount, ',', new StringBuilder("⭐️"));
        boolean isOutbid = auction.getBidStatus().isOutbid();
        lq[] lqVarArr = this.n;
        k6 k6Var = this.c;
        if (isOutbid) {
            k6Var.c(ja.X0(false, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveBidOutbid, l10)), 0.66f, lqVarArr), z4, true);
            k6Var.setTextColor(j6.w0(null, j6.q7, false));
        } else {
            k6Var.c(ja.X0(false, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveBidActive, l10, Integer.valueOf(auction.getApproximatedMyPlace()))), 0.66f, lqVarArr), z4, true);
            k6Var.setTextColor(j6.w0(null, j6.G6, false));
        }
    }
