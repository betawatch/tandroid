...
public final /* synthetic */ class o3 implements RequestDelegate {
    public final /* synthetic */ int a;
    public final /* synthetic */ boolean b;
    public final /* synthetic */ Object c;

    public /* synthetic */ o3(int i9, Object obj, boolean z10) {
        this.a = i9;
        this.c = obj;
        this.b = z10;
    }
        ...
        switch (i9) {
            ...
            case 3:
                ...
                if (tLObject != null) {
                    ...
                    if (tL_messages_affectedFoundMessages.offset != 0) {
                        ...
                        i9Var.getConnectionsManager().sendRequest(tL_messages_deletePhoneCallHistory, new o3(i10, i9Var, z10));
                        break;
                    }
                }
                break;
            ...
            case 5:
                ...
                if (!(tLObject instanceof TLRPC.Updates)) {
                    AndroidUtilities.runOnUIThread(new bo(hoVar, i10));
                    break;
                } else {
            ...
            case 6:
                AndroidUtilities.runOnUIThread(new bg.d((vo) obj, tL_error, tLObject, this.b, 11));
                break;
            case 7:
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.video.e((hd0) obj, tL_error, tLObject, z10));
                break;
            case 8:
                AndroidUtilities.runOnUIThread(new bg.d((t60) obj, tL_error, tLObject, this.b, 20));
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new bg.d((jm0) obj, tL_error, tLObject, this.b, 21));
                break;
            case 10:
                AndroidUtilities.runOnUIThread(new bg.d((co0) obj, tL_error, tLObject, this.b, 24));
                break;
            case 11:
                zp0 zp0Var = (zp0) obj;
                if (tLObject != null) {
                    AndroidUtilities.runOnUIThread(new np0(zp0Var, tLObject, z10, i11));
                    break;
                }
                break;
            case 12:
                AndroidUtilities.runOnUIThread(new bg.d((ag1) obj, tL_error, tLObject, this.b, 26));
                break;
            default:
