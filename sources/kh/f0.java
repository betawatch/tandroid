...
public final class f0 extends sa implements GiftAuctionController.OnAuctionUpdateListener {
    ...
    public f0(Context context, f6 f6Var, long j10, TL_stars.StarGift starGift, Runnable runnable) {
        ...
        c3.setOnClickListener(new View.OnClickListener(this) { // from class: kh.z
            ...
            public final void onClick(View view) {
                switch (i14) {
                    case 0:
                        new eg.o1(this.b.getContext(), 40, (f6) null).show();
                        break;
                    default:
                        this.b.T();
                        break;
        ...
        if (auction2 == null || auction2.previewAttributes == null) {
            ...
            h9.setOnClickListener(new View.OnClickListener(this) { // from class: kh.z
                public final /* synthetic */ f0 b;
            ...
            int i23 = j6.J6;
            f90Var3.setTextColor(j6.v0(i23, f6Var));
            f90Var3.setLinkTextColor(j6.v0(i23, f6Var));
            ...
            com.google.android.gms.common.api.internal.r rVar = new com.google.android.gms.common.api.internal.r(lf.d.c(this.j0.previewAttributes, TL_stars.starGiftAttributeModel.class));
            ...
            for (int i24 = 0; i24 < 3; i24++) {
                ...
                if (stargiftattributemodel != null) {
                    ...
                    spannableStringBuilder2.setSpan(new org.telegram.ui.Components.u5(stargiftattributemodel.document, f90Var3.getPaint().getFontMetricsInt()), i24, i24 + 1, 33);
                }
            }
    ...
    public static /* synthetic */ void P(f0 f0Var, boolean[] zArr, f6 f6Var) {
        if (zArr[0]) {
            return;
        }
        zArr[0] = true;
    ...
    public static /* synthetic */ void R(f0 f0Var, Context context, f6 f6Var) {
    ...
    */
    public final void V(boolean z4) {
        ...
        if (auction2 != null && (tL_starGiftAuctionStateFinished = auction2.auctionStateFinished) != null) {
            ...
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(ja.X0(false, kf.k0.l(this.j0.auctionStateFinished.average_price, ',', new StringBuilder("⭐️ ")), 0.8f, null));
        ...
        if (auction3 != null) {
            ...
            if (i12 <= 0) {
                ...
                f90Var.setText(TextUtils.concat(AndroidUtilities.replaceArrows(LocaleController.formatPluralSpannable("Gift2AuctionsItemsBought2", i12, this.k0), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f))));
            } else {
            ...
            f90Var2.setTextColor(j6.v0(j6.q7, this.resourcesProvider));
