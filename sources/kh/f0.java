...
public final class f0 extends sa implements GiftAuctionController.OnAuctionUpdateListener {
    ...
    public f0(Context context, org.telegram.ui.ActionBar.f6 f6Var, long j10, TL_stars.StarGift starGift, Runnable runnable) {
        ...
        b0 b0Var = new b0(context, this.currentAccount, f6Var);
        b0Var.U = true;
        ...
        frameLayout.addView(b0Var, k7.b6.d(130, 130.0f, 17, 0.0f, 18.0f, 0.0f, 14.0f));
        ...
        this.e0 = new a0(this, new ph.f3[1], frameLayout2, 0);
        TableRow c3 = sz0Var.c(LocaleController.getString(R.string.GiftValueAveragePrice), "", null, scVarArr);
        this.f0 = c3;
        final int i14 = 1;
        c3.setOnClickListener(new View.OnClickListener(this) { // from class: kh.z
            ...
            public final void onClick(View view) {
                switch (i14) {
                    case 0:
                        new eg.o1(this.b.getContext(), 40, (org.telegram.ui.ActionBar.f6) null).show();
                        break;
                    default:
                        this.b.T();
                        break;
        ...
        if (auction2 == null || auction2.previewAttributes == null) {
            ...
            z4 = false;
            Object[] objArr3 = 0;
            d0 d0Var = new d0(this, context, f6Var, new v(this, 0), new dg.m(i22), new dg.m(i22), new dg.m(i22), new dg.m(i22), new dg.m(i22), new dg.m(i22));
            ...
            TextView i23 = yh.i(this.X, textView2, k7.b6.d(-2, 26.0f, 81, 16.0f, 0.0f, 16.0f, 77.0f), context);
            i23.setTypeface(AndroidUtilities.bold());
            i23.setTextSize(1, 21.0f);
            i23.setText(str2);
            i23.setGravity(17);
            i23.setTextColor(-1);
            TextView i24 = yh.i(this.X, i23, k7.b6.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 40.0f), context);
            i24.setTextSize(1, 13.0f);
            i24.setText(AndroidUtilities.replaceArrows(LocaleController.getString(R.string.Gift2AuctionLearnMore2), false, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)));
            i24.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
            i24.setGravity(17);
            i24.setTextColor(-1342177281);
            final Object[] objArr4 = objArr3 == true ? 1 : 0;
            i24.setOnClickListener(new View.OnClickListener(this) { // from class: kh.z
                public final /* synthetic */ f0 b;
            ...
            k7.d6.b(i24, 0.02f, 1.5f);
            this.X.addView(i24, k7.b6.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 12.0f));
            ...
            int i25 = j6.J6;
            e90Var3.setTextColor(j6.v0(i25, f6Var));
            e90Var3.setLinkTextColor(j6.v0(i25, f6Var));
            ...
            for (int i26 = 0; i26 < 3; i26++) {
                ...
                if (stargiftattributemodel != null) {
                    ...
                    spannableStringBuilder2.setSpan(new org.telegram.ui.Components.u5(stargiftattributemodel.document, e90Var3.getPaint().getFontMetricsInt()), i26, i26 + 1, 33);
                }
            }
        ...
        this.W.addView(this.i0, k7.b6.k(16.0f, 0.0f, 14.0f, 18.0f, -1, -2));
        V(z4);
    }

    public static /* synthetic */ void P(f0 f0Var, boolean[] zArr, org.telegram.ui.ActionBar.f6 f6Var) {
        if (zArr[0]) {
            return;
        }
        zArr[0] = true;
    ...
    public static /* synthetic */ void R(f0 f0Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
    ...
    public static void U(Context context, TL_stars.StarGift starGift, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        zv0Var.a.l(LocaleController.formatPluralString("GiftAuctionInfo1Header", i11, Integer.valueOf(i11)), false);
        int i12 = starGift.gifts_per_round;
        zv0Var.b.setText(LocaleController.formatPluralString("GiftAuctionInfo1Text", i12, Integer.valueOf(i12)));
        ...
        zv0Var2.a.l(LocaleController.getString(R.string.GiftAuctionInfo2Header), false);
        zv0Var2.b.setText(LocaleController.formatPluralString("GiftAuctionInfo2Text", starGift.gifts_per_round, new Object[0]));
        ...
        zv0Var3.a.l(LocaleController.getString(R.string.GiftAuctionInfo3Header), false);
        zv0Var3.b.setText(LocaleController.getString(R.string.GiftAuctionInfo3Text));
    ...
    */
    public final void V(boolean z4) {
        ...
        if (auction2 != null && (tL_starGiftAuctionStateFinished = auction2.auctionStateFinished) != null) {
            ...
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(ja.X0(false, a2.l(this.j0.auctionStateFinished.average_price, ',', new StringBuilder("⭐️ ")), 0.8f, null));
        ...
        if (auction3 != null) {
            ...
            if (i12 <= 0) {
                ...
                e90Var.setText(TextUtils.concat(AndroidUtilities.replaceArrows(LocaleController.formatPluralSpannable("Gift2AuctionsItemsBought2", i12, this.k0), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f))));
            } else {
            ...
            e90Var2.setTextColor(j6.v0(j6.q7, this.resourcesProvider));
