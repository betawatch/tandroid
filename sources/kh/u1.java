...
public final class u1 extends Drawable {
    ...
    public u1(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        ...
        this.q = paint3;
        this.r = new org.telegram.ui.Components.z5(new ef.e(this, 25), 320L, nr.h);
            ...
            if (this.h != null) {
                if (z11) {
                    ...
                    if (c2Var.b == null || c2Var.h != v02) {
                        ...
                        c2Var.b = t7.b(bitmapArr, fArr, dp, dp2, 0, new tg.e() { // from class: tg.d
                            @Override // tg.e
                ...
                if (z11) {
                    ...
                    if (c2Var2.f == null || (c2Var2.j != v03 && c2Var2.k != v02)) {
                        ...
                        c2Var2.f = t7.b(bitmapArr2, fArr2, dp3, dp4, v03, new tg.e() { // from class: tg.d
                            @Override // tg.e
                    ...
                    if (c2Var3.d == null || c2Var3.i != v03) {
                        ...
                        c2Var3.d = t7.b(c2Var3.c, c2Var3.g, 0.0f, 0.0f, v03, new tg.e() { // from class: tg.d
                            @Override // tg.e
                            public final void a(Canvas canvas3, RectF rectF2, float[] fArr22) {
                                Path path = new Path();
                                path.addRoundRect(rectF2, fArr22, Path.Direction.CW);
