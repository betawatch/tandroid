...
public final class v3 extends org.telegram.ui.ActionBar.g3 {
    ...
    public v3(Context context, long j10, TL_stars.SavedStarGift savedStarGift, f6 f6Var, Utilities.Callback0Return callback0Return) {
        ...
        u3 u3Var = new u3(context, this.currentAccount, 0, false, new dh.v(2, this, G), new c1.b(25, this, dVar), null, f6Var);
        u3Var.setSpanCount(3);
        u3Var.setOverScrollMode(2);
        u3Var.setScrollEnabled(false);
        linearLayout.addView(u3Var, k7.b6.k(11.0f, 0.0f, 11.0f, 0.0f, -1, -2));
