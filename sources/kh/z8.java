...
public final class z8 extends FrameLayout {
    ...
    public static void a(z8 z8Var, boolean z10) {
        ArrayList arrayList = (ArrayList) z8Var.c;
        ArrayList arrayList2 = (ArrayList) z8Var.b;
        ...
        if (z10) {
            ...
            z8Var.e = animatorSet2;
            animatorSet2.setDuration(150L);
            ((AnimatorSet) z8Var.e).playTogether(arrayList3);
            ((AnimatorSet) z8Var.e).addListener(new uc0(z8Var, 2));
    ...
    public void b(String str) {
        ...
        ye yeVar2 = new ye(this, length, i9);
        this.f = yeVar2;
        AndroidUtilities.runOnUIThread(yeVar2, 1500L);
        for (int i11 = 0; i11 < length; i11++) {
            TextView textView5 = (TextView) arrayList2.get(i11);
            Property property5 = View.TRANSLATION_X;
            arrayList3.add(ObjectAnimator.ofFloat(textView5, (Property<TextView, Float>) property5, c(i11)));
            ...
            arrayList3.add(ObjectAnimator.ofFloat(textView6, (Property<TextView, Float>) property5, c(i11)));
        ...
        ((AnimatorSet) this.e).addListener(new uc0(this, 0));
    ...
    public void d(boolean z10) {
        ...
        textView.setLayoutParams(g7.e6.d(-1, -2.0f, 23, (z11 || !z10) ? 22.0f : 53.0f, 0.0f, (z11 && z10) ? 53.0f : 22.0f, 0.0f));
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.a) {
            case 0:
                ...
                paint.setColor(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.d7, (org.telegram.ui.ActionBar.b6) this.b));
