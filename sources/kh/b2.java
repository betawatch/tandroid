...
public final class b2 extends pq {
    ...
    public static void c(Path path, float f10, final boolean z4) {
        ...
        float f13 = a2.f((Float) callbackReturn.run(Float.valueOf(46.56f)), f10);
        float dp = AndroidUtilities.dp(48.28f * f10);
        Float valueOf = Float.valueOf(48.0f);
        path.cubicTo(f13, dp, a2.f((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(47.68f * f10), a2.f((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(46.5f * f10));
