...
public class u7 extends View {
    ...
    public u7(Context context, int i9) {
        ...
        this.c = 1.0f;
        gr grVar = gr.h;
        this.f = new org.telegram.ui.Components.y5(this, 0L, 320L, grVar);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i9 == 0) {
            ...
            float f12 = this.b;
            float f13 = f11 - f12;
            double d10 = f13 != 0.0f ? (f13 * this.d) + f12 : 0.0f;
            float e10 = this.F.e(d10 > 0.25d);
            canvas.save();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            float f10 = this.c;
            float f11 = this.b;
            float z11 = f10 - f11 != 0.0f ? e2.c.z(f10, f11, this.d, f11) : 0.0f;
            ...
            float f12 = this.c;
            float f13 = this.b;
            float z12 = f12 - f13 != 0.0f ? e2.c.z(f12, f13, this.d, f13) : 0.0f;
            if (z10) {
    ...
    public final void e(float f10) {
        ...
        if (!TextUtils.equals(i6Var.g, str)) {
            i6Var.b();
            i6Var.k(0.3f, this.e ? 320L : 40L, gr.h);
            i6Var.q(str, true, true);
        }
        if (this.a == 1) {
            this.n.setColor(s2.f(f10));
        }
        invalidate();
    }
