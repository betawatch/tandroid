...
public final class q extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public q(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.e = new mq[1];
        setOrientation(0);
        ...
        this.d = k6Var2;
        k6Var2.setTextColor(j6.v0(j6.y6, f6Var));
    ...
    public final void a(long j10, boolean z4) {
        this.d.c(ja.X0(false, a2.l((int) j10, ',', new StringBuilder("⭐️")), 0.78f, this.e), z4, true);
    }
