...
public final class a extends View {
    ...
    public final void onMeasure(int i9, int i10) {
        ...
        if (View.MeasureSpec.getMode(i9) == Integer.MIN_VALUE) {
            setMeasuredDimension((int) Math.min(AndroidUtilities.dp(12.0f) + AndroidUtilities.dp(30.0f) + getPaddingLeft() + this.f + AndroidUtilities.dp(8.0f) + this.s + getPaddingRight(), View.MeasureSpec.getSize(i9)), AndroidUtilities.dp(48.0f));
