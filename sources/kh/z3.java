...
public final /* synthetic */ class z3 implements Utilities.Callback2 {
    ...
    public /* synthetic */ z3(q5 q5Var, String[] strArr, ArrayList arrayList, int i10) {
        this.a = i10;
        this.b = q5Var;
        this.c = strArr;
        this.d = arrayList;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                ...
                a5 a5Var = q5Var.d;
                boolean isEmpty = a5Var.l.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = a5Var.l.contains(Long.valueOf(stargiftattributepattern.document.id));
                    boolean z4 = !contains;
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.y3.w(" ", lowerCase, stargiftattributepattern.name.toLowerCase()) || org.telegram.messenger.y3.w(" ", translitSafe, stargiftattributepattern.name.toLowerCase())) {
                        Integer num = (Integer) a5Var.o.get(Long.valueOf(stargiftattributepattern.document.id));
                        int intValue = num == null ? 0 : num.intValue();
                        int i12 = x4.a;
                        i51 J = i51.J(x4.class);
                ...
                if (arrayList2.isEmpty()) {
                    arrayList2.add(p4.a(LocaleController.getString(R.string.Gift2ResaleFiltersSymbolEmpty)));
                    break;
                }
                break;
            case 1:
            ...
            default:
                ...
                a5 a5Var3 = q5Var.d;
                boolean isEmpty3 = a5Var3.j.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = a5Var3.j.contains(Long.valueOf(stargiftattributemodel.document.id));
                    ...
                    if (TextUtils.isEmpty(lowerCase3) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase3) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe3) || org.telegram.messenger.y3.w(str4, lowerCase3, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.y3.w(str4, translitSafe3, stargiftattributemodel.name.toLowerCase())) {
                        str3 = str4;
                        Integer num3 = (Integer) a5Var3.m.get(Long.valueOf(stargiftattributemodel.document.id));
                        int intValue3 = num3 == null ? 0 : num3.intValue();
                        int i16 = u4.a;
                        i51 J3 = i51.J(u4.class);
                ...
                if (arrayList4.isEmpty()) {
                    arrayList4.add(p4.a(LocaleController.getString(R.string.Gift2ResaleFiltersModelEmpty)));
                    break;
                }
                break;
        }
