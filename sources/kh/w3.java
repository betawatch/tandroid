...
public final class w3 extends org.telegram.ui.ActionBar.g3 {
    public long b;

    public w3(Context context, long j10, TL_stars.SavedStarGift savedStarGift, org.telegram.ui.ActionBar.f6 f6Var, Utilities.Callback0Return callback0Return) {
        ...
        TextView b11 = k7.f6.b(context, 14.0f, j6.y6, false, f6Var);
        ...
        v3 v3Var = new v3(context, this.currentAccount, 0, false, new dh.v(2, this, G), new c1.b(25, this, dVar), null, f6Var);
        v3Var.setSpanCount(3);
        v3Var.setOverScrollMode(2);
        v3Var.setScrollEnabled(false);
        linearLayout.addView(v3Var, k7.b6.k(11.0f, 0.0f, 11.0f, 0.0f, -1, -2));
