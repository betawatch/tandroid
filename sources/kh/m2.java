...
public final class m2 extends View {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF2 = this.x;
        RectF rectF3 = this.w;
        RectF rectF4 = i9 <= 0 ? rectF3 : i9 == 1 ? rectF2 : rectF;
        ...
        if (staticLayout != null) {
            canvas.save();
            canvas.translate((rectF3.left + AndroidUtilities.dp(12.0f)) - this.e, e2.c.A(rectF3.height(), this.c.getHeight(), 2.0f, rectF3.top));
        ...
        if (this.f != null) {
            canvas.save();
            canvas.translate((rectF2.left + AndroidUtilities.dp(12.0f)) - this.n, e2.c.A(rectF2.height(), this.f.getHeight(), 2.0f, rectF2.top));
        ...
        if (this.r != null) {
            canvas.save();
            canvas.translate((rectF.left + AndroidUtilities.dp(12.0f)) - this.v, e2.c.A(rectF.height(), this.r.getHeight(), 2.0f, rectF.top));
