...
public final class t9 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public t9(Context context, int i9, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        j1(context);
        this.b.setAdapter(new p8(this, context, 0));
    ...
    public static int d1(t9 t9Var, TLRPC.Chat chat) {
        Integer num;
        int i9;
        TLRPC.ChatFull chatFull = MessagesController.getInstance(t9Var.currentAccount).getChatFull(chat.id);
    ...
    public final void dismiss() {
        ...
        if (callback != null) {
            ...
            if (i9 == 3) {
                ...
                r9Var = i9 == 2 ? new r9(i9, this.currentAccount, arrayList) : new r9(i9, this.currentAccount, (ArrayList) null);
            }
            this.Q.run(r9Var);
            this.Q = null;
        }
    ...
    public final void f1() {
        ...
        for (View view : this.b.getViewPages()) {
            if ((view instanceof n9) && (f9Var = ((n9) view).x) != null) {
                AndroidUtilities.hideKeyboard(f9Var.a);
            }
        }
    }
    ...
    public final void g1(r9 r9Var, Runnable runnable, boolean z10) {
        ...
        if (arrayList.isEmpty() || z10) {
            ...
            d dVar = view instanceof n9 ? ((n9) view).v : null;
            if (dVar != null) {
                dVar.setLoading(true);
            }
            w8 w8Var = this.P;
            if (w8Var != null) {
                w8Var.d(r9Var, this.w, this.x, this.y, this.C, this.c, this.D, new o8(0, dVar, runnable), new f1(dVar, 11));
                return;
            } else {
                runnable.run();
                return;
    ...
    public final void j1(Context context) {
        ...
        this.containerView.addView(this.b, g7.e6.e(-1, -1, 119));
    }
    ...
    public t9(Context context, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        this.V = false;
        j1(context);
        this.b.setAdapter(new p8(this, context, 1));
    }
}
