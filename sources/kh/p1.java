...
public final class p1 extends View {
    public boolean a;
    public final int b;
    public org.telegram.ui.Components.k5 c;
    public final q1 d;
    ...
    public final void a(TLRPC.Document document, boolean z10) {
        ...
        org.telegram.ui.Components.k5 k5Var = this.c;
        if (k5Var != null) {
            k5Var.o(this);
        }
        if (document == null) {
        ...
        this.f = document.id;
        int i9 = n2.C;
        org.telegram.ui.Components.k5 m10 = org.telegram.ui.Components.k5.m(this.b, LiteMode.isEnabled(z10 ? 1 : LiteMode.FLAG_ANIMATED_EMOJI_KEYBOARD) ? 3 : 13, document);
        this.c = m10;
        if (this.s) {
            m10.a(this);
        }
