...
public final /* synthetic */ class w4 implements Runnable {
    ...
    public final /* synthetic */ yf.j c;

    public /* synthetic */ w4(g6 g6Var, yf.j jVar, int i9) {
        this.a = i9;
        this.b = g6Var;
        this.c = jVar;
    }
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (!z10) {
                    ...
                    final int i9 = 0;
                    textView.setOnClickListener(new View.OnClickListener() { // from class: kh.b5
                        ...
                        public final void onClick(View view) {
                            ...
                            switch (i9) {
                                case 0:
                                    yf.j jVar3 = jVar;
                                    boolean z11 = jVar3 instanceof yf.b2;
                                    g6 g6Var2 = g6Var;
                                    if (z11) {
                                        mb mbVar = ((ya) g6Var2).w2.Y0;
                                        if (mbVar != null) {
                                            mbVar.B();
                                        }
                                    } else {
                                ...
                                case 1:
                                    ...
                                    g6Var3.getClass();
                                    try {
                                        ((yf.v2) jVar4).getEditText().onTextContextMenuItem(android.R.id.pasteAsPlainText);
                                    } catch (Exception e10) {
                                        FileLog.e(e10);
                                    }
                                ...
                                case 3:
                                    ...
                                    g6Var5.D0(null, true);
                                    yf.j jVar5 = jVar;
                                    g6Var5.L0((yf.s0) jVar5, new bg.y0(8, g6Var5, jVar5));
                                ...
                                case 5:
                                    ...
                                    if (jVar6 instanceof yf.n2) {
                                        ((yf.n2) jVar6).r(true);
                                    } else if (jVar6 instanceof yf.a2) {
                                        ((yf.a2) jVar6).r(true);
                                    } else if (jVar6 instanceof yf.b2) {
                                        yf.b2 b2Var = (yf.b2) jVar6;
                                        b2Var.n0 = !b2Var.n0;
                                        b2Var.invalidate();
                                    } else {
                                        ((yf.x1) jVar6).r(true);
                                ...
                                default:
                                    ...
                                    yf.j jVar7 = jVar;
                                    if (jVar7 != null) {
                                        PointF Q0 = g6Var9.Q0(jVar7);
                                        if (jVar7 instanceof yf.n2) {
                                            yf.j n2Var = new yf.n2(g6Var9.getContext(), (yf.n2) jVar7, Q0);
                                            n2Var.setDelegate(g6Var9);
                                            a6Var2.addView(n2Var);
                                            g6Var9.g0();
                                            jVar2 = n2Var;
                                        } else if (jVar7 instanceof yf.v2) {
                                            yf.v2 v2Var = new yf.v2(g6Var9.getContext(), (yf.v2) jVar7, Q0);
                                            v2Var.setDelegate(g6Var9);
                                            v2Var.setMaxWidth(g6Var9.N1 - AndroidUtilities.dp(32.0f));
                                            a6Var2.addView(v2Var, g7.e6.c(-2.0f, -2));
                                            g6Var9.g0();
                                            jVar2 = v2Var;
                                        }
                                        g6Var9.B0(jVar2);
                ...
                if (jVar instanceof yf.v2) {
                    ...
                    if ((!j5Var.c() || j5Var.d) && g6Var.p2 <= 0) {
                        textView2.setTag(1);
                        textView2.setText(LocaleController.getString(R.string.PaintEdit));
                        final int i10 = 2;
                        textView2.setOnClickListener(new View.OnClickListener() { // from class: kh.b5
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                yf.j jVar2;
                                switch (i10) {
                    ...
                    final int i12 = 3;
                    h02.setOnClickListener(new View.OnClickListener() { // from class: kh.b5
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            yf.j jVar2;
                            switch (i12) {
                    ...
                    final int i13 = 4;
                    h03.setOnClickListener(new View.OnClickListener() { // from class: kh.b5
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            yf.j jVar2;
                            switch (i13) {
                ...
                if ((jVar instanceof yf.n2) || (jVar instanceof yf.b2) || (jVar instanceof yf.x1) || (jVar instanceof yf.a2)) {
                    ...
                    final int i14 = 5;
                    h04.setOnClickListener(new View.OnClickListener() { // from class: kh.b5
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            yf.j jVar2;
                            switch (i14) {
                ...
                if (a6Var.indexOfChild(jVar) != a6Var.getChildCount() - 1 && !(jVar instanceof yf.a2)) {
                    ...
                    final int i15 = 6;
                    textView3.setOnClickListener(new View.OnClickListener() { // from class: kh.b5
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            yf.j jVar2;
                            switch (i15) {
                                case 0:
                                    yf.j jVar3 = jVar;
                                    boolean z112 = jVar3 instanceof yf.b2;
                                    g6 g6Var2 = g6Var;
                                    if (z112) {
                                        mb mbVar = ((ya) g6Var2).w2.Y0;
                                        if (mbVar != null) {
                    ...
                    final int i16 = 7;
                    textView4.setOnClickListener(new View.OnClickListener() { // from class: kh.b5
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            yf.j jVar2;
                            switch (i16) {
                ...
                while (i17 < linearLayout.getChildCount()) {
                    ...
                    int v02 = org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.i6, u5Var);
                    int i18 = 8;
                    int i19 = i17 == 0 ? 8 : 0;
                    int i20 = i17 == linearLayout.getChildCount() - 1 ? 8 : 0;
                    int i21 = i17 == linearLayout.getChildCount() - 1 ? 8 : 0;
                    if (i17 != 0) {
                        i18 = 0;
                    }
                    childAt.setBackground(org.telegram.ui.ActionBar.f6.a0(v02, i19, i20, i21, i18));
                    i17++;
                }
