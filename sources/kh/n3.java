...
public final class n3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public n3(or0 or0Var, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (or0Var.d != this.e) {
            ...
            this.y.addView(this.B, k7.b6.e(-2, -2, 17));
            ...
            this.D.setTextColor(j6.v0(j6.y6, f6Var));
            ...
            final int i11 = 1;
            this.E.setOnClickListener(new View.OnClickListener(this) { // from class: kh.c3
            ...
            addView(this.y, k7.b6.d(-1, -1.0f, 119, 0.0f, -12.0f, 0.0f, 0.0f));
        ...
        this.s.addView(this.v, k7.b6.e(-2, -2, 17));
        ...
        this.v.addView(this.w, k7.b6.t(-2, -2, 1, 0, 12, 0, 0));
        ...
        final int i13 = 0;
        this.x.setOnClickListener(new View.OnClickListener(this) { // from class: kh.c3
            public final /* synthetic */ n3 b;
        ...
        k7.d6.a(this.x);
        this.v.addView(this.x, k7.b6.t(-2, -2, 1, 0, 8, 0, 0));
        addView(this.s, k7.b6.e(-1, -1, 119));
