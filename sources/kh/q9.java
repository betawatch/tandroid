...
public abstract class q9 extends ScrollView {
    ...
    public q9(Context context, org.telegram.ui.ActionBar.b6 b6Var, c9 c9Var) {
        ...
        gr grVar = gr.h;
        this.r = new org.telegram.ui.Components.y5(this, 0L, 300L, grVar);
        ...
        this.v = paint;
        this.w = new Matrix();
        this.x = new org.telegram.ui.Components.y5(this, 0L, 300L, grVar);
        ...
        AndroidUtilities.setScrollViewEdgeEffectColor(this, org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.d6, false));
        ...
        int i9 = org.telegram.ui.ActionBar.f6.Yh;
        gVar.setCursorColor(org.telegram.ui.ActionBar.f6.v0(i9, b6Var));
        gVar.setHandlesColor(org.telegram.ui.ActionBar.f6.v0(i9, b6Var));
        ...
        this.b = (int) gVar.getPaint().measureText(LocaleController.getString(R.string.Search));
