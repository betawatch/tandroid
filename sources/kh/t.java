...
public final /* synthetic */ class t implements Utilities.Callback2 {
            ...
            case 0:
                ...
                if (auction != null) {
                    ...
                    if (j12 != peerDialogId && j12 != 0 && peerDialogId != 0) {
                        ...
                        alertDialog$Builder.k(LocaleController.getString(R.string.Continue), new gg.f(xVar, 20));
    ...
    public /* synthetic */ t(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, long j10, Runnable runnable) {
        this.d = context;
        this.e = f6Var;
        this.b = i10;
        this.c = j10;
