...
public final class m3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public m3(or0 or0Var, int i10, f6 f6Var) {
        ...
        if (or0Var.d != this.e) {
            ...
            final int i11 = 1;
            this.E.setOnClickListener(new View.OnClickListener(this) { // from class: kh.b3
        ...
        final int i13 = 0;
        this.x.setOnClickListener(new View.OnClickListener(this) { // from class: kh.b3
            public final /* synthetic */ m3 b;
