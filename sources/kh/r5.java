...
public final /* synthetic */ class r5 implements Utilities.Callback2 {
    public final /* synthetic */ int a;
    public final /* synthetic */ d6 b;

    public /* synthetic */ r5(d6 d6Var, int i10) {
        this.a = i10;
        this.b = d6Var;
    }
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i12) {
            case 0:
                ...
                eg.n nVar = d6Var.b0;
                FrameLayout frameLayout = d6Var.l0;
                boolean z10 = d6Var.X;
                boolean z11 = d6Var.Y;
                TL_stars.StarGift starGift = d6Var.Z;
                String str = d6Var.c0;
                boolean z12 = d6Var.U;
                int i13 = d6Var.V;
                ...
                arrayList.add(i51.j(-1, d6Var.e0));
                if (sendPaidMessagesStars <= 0) {
                    arrayList.add(i51.j(-2, d6Var.p0));
                ...
                if (starGift != null) {
                    if (!starGift.can_upgrade || z12) {
                        ...
                        i51 i14 = i51.i(2, ja.X0(false, LocaleController.formatString(z12 ? R.string.Gift2UpgradeSelf : R.string.Gift2Upgrade, Integer.valueOf((int) starGift.upgrade_stars)), 0.78f, null));
                        i14.K(d6Var.n0);
                        arrayList.add(i14);
                        if (z11) {
                            ...
                            replaceArrows = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(formatString2, new t5(d6Var, 2)), z4);
                        }
                        i51 A = i51.A(-5, replaceArrows);
                        A.g = (z10 || z11) ? false : true;
                        arrayList.add(A);
                    }
                    i51 i15 = i51.i(1, LocaleController.getString(z12 ? R.string.Gift2HideSelf : R.string.Gift2Hide));
                    i15.K(d6Var.m0);
                    arrayList.add(i15);
                    if (z12) {
                        ...
                        if (frameLayout != null) {
                            ...
                            CharSequence replaceArrows2 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("Gift2AuctionInfoLearnMore2", i16, objArr), new t5(d6Var, 3)), i10);
                    ...
                    if (nVar != null && (nVar.c != null || nVar.d != null)) {
                        i51 i17 = i51.i(3, ja.X0(false, LocaleController.formatString(R.string.Gift2MessageStars, Integer.valueOf((int) nVar.g())), 0.78f, null));
                        i17.K(d6Var.o0);
                        arrayList.add(i17);
            ...
            default:
                ...
                TL_stars.StarGift starGift2 = d6Var.Z;
                y5 y5Var = d6Var.p0;
