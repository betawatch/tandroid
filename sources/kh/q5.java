...
public final class q5 extends sa {
    ...
    public q5(final Context context, String str, final p5 p5Var) {
        ...
        final int i10 = 0;
        s4Var2.setOnClickListener(new View.OnClickListener(this) { // from class: kh.j5
        ...
        final int i11 = 1;
        s4Var3.setOnClickListener(new View.OnClickListener(this) { // from class: kh.j5
            public final /* synthetic */ q5 b;
        ...
        final int i12 = 2;
        s4Var4.setOnClickListener(new View.OnClickListener(this) { // from class: kh.j5
            public final /* synthetic */ q5 b;
    ...
    public static void R(q5 q5Var, p5 p5Var, Context context) {
        ...
        o70Var.R = true;
        o70Var.p = new g3(o70Var, 6);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(b5Var.f);
        Collections.sort(arrayList, new g5(p5Var, 2));
        int i10 = 0;
        k5 k5Var = new k5(context, q5Var.currentAccount, 0, false, new c5(strArr, p5Var, arrayList, i10), new d5(p5Var, o70Var, i10), null, q5Var.resourcesProvider);
        k5Var.V2.r = false;
        ...
        vtVar.addTextChangedListener(new cg.b0(4, strArr, k5Var));
        if (arrayList.size() > 8) {
    ...
    public static void S(q5 q5Var, p5 p5Var, Context context) {
        ...
        o70 o70Var = new o70(q5Var.container, q5Var.resourcesProvider, q5Var.a0, false, true, false);
        o70Var.t = false;
        o70Var.Y = true;
        o70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        o70Var.R = true;
        o70Var.p = new g3(o70Var, 5);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(b5Var.h);
        Collections.sort(arrayList, new g5(p5Var, 1));
        int i10 = 2;
        m5 m5Var = new m5(context, q5Var.currentAccount, 0, false, new c5(strArr, p5Var, arrayList, i10), new d5(p5Var, o70Var, i10), null, q5Var.resourcesProvider);
        m5Var.V2.r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        vtVar.setBackground(null);
        frameLayout.addView(vtVar, k7.b6.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        vtVar.addTextChangedListener(new cg.b0(6, strArr, m5Var));
        if (arrayList.size() > 8) {
            o70Var.r(frameLayout, k7.b6.n(-1, 44));
            o70Var.k();
        }
    ...
    public static void W(q5 q5Var, p5 p5Var, Context context) {
        ...
        o70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        o70Var.R = true;
        o70Var.p = new g3(o70Var, 4);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(b5Var.g);
        Collections.sort(arrayList, new g5(p5Var, 0));
        int i10 = 1;
        l5 l5Var = new l5(context, q5Var.currentAccount, 0, false, new c5(strArr, p5Var, arrayList, i10), new d5(p5Var, o70Var, i10), null, q5Var.resourcesProvider);
        l5Var.V2.r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        vtVar.setBackground(null);
        frameLayout.addView(vtVar, k7.b6.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        vtVar.addTextChangedListener(new cg.b0(5, strArr, l5Var));
        if (arrayList.size() > 8) {
            o70Var.r(frameLayout, k7.b6.n(-1, 44));
            o70Var.k();
        }
    ...
    public final void Z() {
        ...
        while (true) {
            ...
            if ((childAt instanceof t00) && (R = RecyclerView.R(childAt) - 1) >= 0 && (G = this.f0.G(R)) != null) {
                if (G.d < 10) {
                    z4 = true;
                } else {
                    z10 = true;
