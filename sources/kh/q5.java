...
public class q5 extends org.telegram.ui.ActionBar.p2 implements xd.b {
    ...
    public q5(long j10, String str, long j11, f6 f6Var) {
        super(null);
        this.a = new xd.a(0, this, mr.h, 380L, false);
        this.H = true;
        this.b = j10;
        this.c = str;
    ...
    public static void V(q5 q5Var, Context context) {
        ...
        if (q5Var.H && !a5Var.h.isEmpty()) {
            ...
            p70Var.R = true;
            p70Var.p = new f3(p70Var, 1);
            String[] strArr = {""};
            ArrayList arrayList = new ArrayList(a5Var.h);
            Collections.sort(arrayList, new y3(q5Var, 0));
            m4 m4Var = new m4(q5Var, new z3(q5Var, strArr, arrayList, 0), new a4(q5Var, p70Var, 0), null);
            m4Var.V2.r = false;
            ...
            utVar.addTextChangedListener(new cg.b0(1, strArr, m4Var));
            if (arrayList.size() > 8) {
    ...
    public static void W(q5 q5Var, Context context) {
        a5 a5Var = q5Var.d;
        if (q5Var.H && !a5Var.f.isEmpty()) {
            p70 p70Var = new p70(q5Var, q5Var.D, false, false);
            p70Var.t = false;
            p70Var.Y = true;
            p70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
            p70Var.R = true;
            p70Var.p = new f3(p70Var, 3);
            String[] strArr = {""};
            ArrayList arrayList = new ArrayList(a5Var.f);
            Collections.sort(arrayList, new y3(q5Var, 2));
            k4 k4Var = new k4(q5Var, new z3(q5Var, strArr, arrayList, 2), new a4(q5Var, p70Var, 2), null);
            k4Var.V2.r = false;
            FrameLayout frameLayout = new FrameLayout(context);
            ImageView imageView = new ImageView(context);
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            ...
            utVar.setBackground(null);
            frameLayout.addView(utVar, k7.b6.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
            utVar.addTextChangedListener(new cg.b0(2, strArr, k4Var));
            if (arrayList.size() > 8) {
                p70Var.r(frameLayout, k7.b6.n(-1, 44));
                p70Var.k();
            }
    ...
    public static void X(q5 q5Var, Context context) {
        a5 a5Var = q5Var.d;
        if (q5Var.H && !a5Var.g.isEmpty()) {
            p70 p70Var = new p70(q5Var, q5Var.E, false, false);
            p70Var.t = false;
            p70Var.Y = true;
            p70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
            p70Var.R = true;
            p70Var.p = new f3(p70Var, 2);
            String[] strArr = {""};
            ArrayList arrayList = new ArrayList(a5Var.g);
            Collections.sort(arrayList, new y3(q5Var, 1));
            l4 l4Var = new l4(q5Var, new z3(q5Var, strArr, arrayList, 1), new a4(q5Var, p70Var, 1), null);
            l4Var.V2.r = false;
            FrameLayout frameLayout = new FrameLayout(context);
            ImageView imageView = new ImageView(context);
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            ...
            utVar.setBackground(null);
            frameLayout.addView(utVar, k7.b6.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
            utVar.addTextChangedListener(new cg.b0(3, strArr, l4Var));
            if (arrayList.size() > 8) {
                p70Var.r(frameLayout, k7.b6.n(-1, 44));
                p70Var.k();
            }
    ...
    public static void Y(q5 q5Var, i51 i51Var) {
        ...
        if (obj instanceof TL_stars.TL_starGiftUnique) {
            ...
            lh.g5 g5Var = new lh.g5(q5Var.getParentActivity(), q5Var.currentAccount, q5Var.b, q5Var.resourceProvider, null);
    ...
    public final View createView(final Context context) {
        ...
        j4 j4Var = new j4(this, new dg.r1(this, 12), new d4(this), new d4(this));
        this.n = j4Var;
        j4Var.V2.r = false;
        j4Var.setSpanCount(3);
        this.n.j(new eg.f2(this, 4));
        this.n.setPadding(0, AndroidUtilities.dp(45.0f), 0, AndroidUtilities.dp(101.0f));
        this.n.setClipToPadding(false);
        i4Var.addView(this.n, k7.b6.d(-1, -1.0f, 119, 7.33f, 0.0f, 7.33f, -45.0f));
        i4Var.addView(this.actionBar);
        final int i12 = 0;
        View.OnClickListener onClickListener = new View.OnClickListener(this) { // from class: kh.e4
        ...
        s4Var.addView(f10, k7.b6.e(-1, -2, 23));
        ...
        i4Var.addView(this.w, k7.b6.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, -45.0f));
        ...
        i4Var.addView(this.y, k7.b6.e(-1, 47, 55));
        ...
        final int i15 = 0;
        this.s.setOnClickListener(new View.OnClickListener(this) { // from class: kh.f4
            public final /* synthetic */ q5 b;
                ...
                switch (i15) {
                    ...
                    default:
                        ...
                        if (q5Var.H) {
                            ...
                            H.c(R.drawable.menu_sort_value, LocaleController.getString(z4.b.a), new b4(q5Var, 3), false);
                            H.c(R.drawable.menu_sort_date, LocaleController.getString(z4.c.a), new b4(q5Var, 4), false);
                            H.c(R.drawable.menu_sort_number, LocaleController.getString(z4.d.a), new b4(q5Var, 5), false);
                            H.k();
                            boolean z10 = !a5Var2.r;
                            String string = LocaleController.getString(R.string.GiftResaleFilterAllListings);
                            final int i16 = 0;
                            final kp kpVar2 = kpVar;
                            H.i(new Runnable() { // from class: kh.c4
                            ...
                            }, LocaleController.getString(R.string.GiftResaleFilterForStarsOnly), a5Var2.r);
                            H.t = false;
                            H.Y = true;
        ...
        i4Var.addView(this.s, k7.b6.d(-2, 52.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        ...
        i4Var.addView(this.r, k7.b6.d(-2, 60.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        ...
        final int i16 = 1;
        this.r.setOnClickListener(new View.OnClickListener(this) { // from class: kh.e4
            public final /* synthetic */ q5 b;
        ...
        this.C = r4Var;
        r4Var.setSorting(this.d.p);
        this.B.addView(this.C, k7.b6.t(-2, -2, 16, 0, 0, 6, 0));
        final int i17 = 1;
        this.C.setOnClickListener(new View.OnClickListener(this) { // from class: kh.f4
            public final /* synthetic */ q5 b;
        ...
        final int i18 = 0;
        this.D.setOnClickListener(new View.OnClickListener(this) { // from class: kh.x3
            public final /* synthetic */ q5 b;
        ...
        final int i19 = 1;
        this.E.setOnClickListener(new View.OnClickListener(this) { // from class: kh.x3
            public final /* synthetic */ q5 b;
        ...
        final int i20 = 2;
        this.F.setOnClickListener(new View.OnClickListener(this) { // from class: kh.x3
            public final /* synthetic */ q5 b;
    ...
    public final void d0(boolean z4, boolean z10) {
        ...
        this.h.animate().translationY(z4 ? 0.0f : -AndroidUtilities.dp(45.0f)).setInterpolator(mrVar).setDuration(420L).start();
        this.n.animate().translationY(z4 ? 0.0f : -AndroidUtilities.dp(39.0f)).setInterpolator(mrVar).setDuration(420L).start();
    }
    ...
    public final void e0(boolean z4) {
        ...
        HashSet hashSet2 = a5Var.k;
        ArrayList arrayList2 = a5Var.g;
        HashSet hashSet3 = a5Var.j;
        ArrayList arrayList3 = a5Var.f;
        if (i10 > 12) {
            d0(true, true);
        }
        j4 j4Var = this.n;
        ...
        if ((a5Var.t || a5Var.e > 0) && (!hashSet3.isEmpty() || !hashSet2.isEmpty() || !hashSet.isEmpty())) {
            z10 = true;
        }
        this.a.a(z10, true);
    }
