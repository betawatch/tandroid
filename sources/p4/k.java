...
public final class k extends h3 {
    ...
    public static String p(q qVar) {
        ...
        if ((qVar instanceof g) && (routingController = ((g) qVar).g) != null) {
    ...
    public final void f(n nVar) {
        ...
        z zVar = x.c().u;
        boolean z10 = zVar == null ? false : zVar.d;
        if (nVar == null) {
            nVar = new n(r.c, false);
        }
        nVar.a();
    ...
    public final MediaRoute2Info o(String str) {
        ...
        while (i10 < size) {
            ...
            i10++;
            MediaRoute2Info f7 = ja0.f(obj);
            if (TextUtils.equals(f7.getId(), str)) {
                return f7;
            }
        }
        return null;
    ...
    public final void q() {
        ...
        while (it.hasNext()) {
            MediaRoute2Info f7 = ja0.f(it.next());
            if (f7 != null && !arraySet.contains(f7) && !f7.isSystemRoute()) {
                arraySet.add(f7);
                arrayList.add(f7);
            }
        }
        ...
        while (i11 < size) {
            ...
            i11++;
            MediaRoute2Info f10 = ja0.f(obj);
            Bundle extras = f10.getExtras();
            if (extras == null || extras.getString("androidx.mediarouter.media.KEY_ORIGINAL_ROUTE_ID") == null) {
                Log.w("MR2Provider", "Cannot find the original route Id. route=" + f10);
            } else {
                arrayMap.put(f10.getId(), extras.getString("androidx.mediarouter.media.KEY_ORIGINAL_ROUTE_ID"));
            }
        }
        ...
        while (i12 < size2) {
            ...
            i12++;
            MediaRoute2Info f11 = ja0.f(obj2);
            m w10 = g0.f.w(f11);
            if (f11 != null) {
                arrayList3.add(w10);
            }
    ...
    public final void r(MediaRouter2.RoutingController routingController) {
        ...
        int i10 = 0;
        m w10 = g0.f.w(ja0.f(selectedRoutes.get(0)));
        Bundle controlHints = routingController.getControlHints();
        ...
        ArrayList arrayList2 = new ArrayList();
        List<m> list = (List) pVar.c;
        if (!list.isEmpty()) {
            for (m mVar2 : list) {
                String d = mVar2.d();
                arrayList2.add(new o(mVar2, h.contains(d) ? 3 : 1, h11.contains(d), h10.contains(d), true));
            }
        }
        gVar.o = b10;
