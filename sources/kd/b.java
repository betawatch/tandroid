...
public class b {
    ...
    public final h b(long j10) {
        ...
        loop0: while (true) {
            dVar.getClass();
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = nd.d.a;
        ...
        h hVar3 = (h) dVar;
        loop2: for (h hVar4 = hVar3; hVar4 != null; hVar4 = (h) ((nd.d) nd.d.b.get(hVar4))) {
            ...
            if (!z10 || andIncrement < atomicLongFieldUpdater2.get(this) || !hVar.k(i10, l10, d.g)) {
                while (true) {
                    ...
                    if (!(l11 instanceof j2)) {
                        ...
                        if (hVar.k(i10, l11, new j((j2) l11))) {
                            break loop0;
                        }
    ...
    */
    public final String toString() {
        ...
        sb2.append("data=[");
        List c10 = qc.h.c(g.get(this), f.get(this), h.get(this));
