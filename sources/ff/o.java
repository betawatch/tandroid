...
public abstract class o {
    public static SpannableStringBuilder a(String str) {
        try {
            Spanned fromHtml = Build.VERSION.SDK_INT >= 24 ? Html.fromHtml("<inject>" + str + "</inject>", 63, null, new m(new d7.u(8))) : Html.fromHtml("<inject>" + str + "</inject>", null, new m(new d7.u(8)));
            if (fromHtml == null) {
                return null;
            }
            ...
            for (Object obj2 : spans) {
                if (obj2 instanceof URLSpan) {
                    ...
                    if (charSequence.equals(url)) {
                        ...
                        spannableStringBuilder.setSpan(new r41(url, null), spanStart2, spanEnd2, 33);
                    }
                }
            }
            ...
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                ...
                spannableStringBuilder.setSpan(new CodeHighlighting.Span(true, 0, null, nVar2.b, spannableStringBuilder.subSequence(spanStart3, spanEnd3).toString()), spanStart3, spanEnd3, 33);
            }
            for (int i11 = 0; i11 < arrayList3.size(); i11++) {
                n nVar3 = (n) arrayList3.get(i11);
                fi0.c(spannableStringBuilder, fromHtml.getSpanStart(nVar3), fromHtml.getSpanEnd(nVar3), nVar3.a == 3);
            }
