...
public final class w0 extends n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void Y() {
        z3 z3Var;
        v0 v0Var = this.n;
        if (v0Var == null || (z3Var = this.s) == null) {
            return;
        }
        if (this.x == null) {
        ...
        z3 z3Var2 = this.s;
        TLRPC.GeoPoint geoPoint = this.x;
        z3Var2.n(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(geoPoint.lat, geoPoint._long, 0L, min * i10, min * 240, 15, min)), s3.c.d(i10, "_240"), this.r, null);
    }
    ...
    public final View createView(Context context) {
        ...
        this.f.addTextChangedListener(new ch.e(this, 18));
