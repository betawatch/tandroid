    ...
    public b1(Context context, c6 c6Var) {
        ...
        for (int i11 = 7; i10 < i11; i11 = 7) {
            if (i10 == 0) {
                ...
                this.h[i10].setTextColor(g6.v0(g6.z6, c6Var));
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    ...
                    this.n[i10][i12].setTextColor(g6.v0(g6.z6, c6Var));
                    this.n[i10][i12].setGravity(LocaleController.isRTL ? 3 : 5);
                    this.s.addView(this.n[i10][i12], z5.i(-1.0f, -1.0f, 119, 0.0f, 0.0f, 20.0f, 0.0f));
                }
                for (int i13 = 0; i13 < 2; i13++) {
                    this.c[i13] = new TextView(context);
                    this.c[i13].setTextSize(1, 14.0f);
                    this.c[i13].setTextColor(g6.v0(g6.z6, c6Var));
                    this.c[i13].setGravity(LocaleController.isRTL ? 3 : 5);
                    this.s.addView(this.c[i13], z5.i(-1.0f, -1.0f, 119, 0.0f, 0.0f, 20.0f, 0.0f));
                }
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(g6.v0(g6.z6, c6Var), PorterDuff.Mode.SRC_IN));
                this.s.addView(imageView, z5.h(20.0f, 20.0f, 8388629));
                this.v.addView(this.s, new LinearLayout.LayoutParams(z5.z(-1.0f), z5.z(-1.0f), Gravity.getAbsoluteGravity(119, LocaleController.isRTL ? 1 : 0)));
                ...
                int i14 = g6.o6;
                int v02 = g6.v0(i14, c6Var);
                a(v02);
                int l1 = g6.l1(0.1f, v02);
                int v03 = g6.v0(i14, c6Var);
                a(v03);
                int l12 = g6.l1(0.22f, v03);
                rpVar.setBackground(g6.i0(dp, dp, dp, dp, l1, l12, l12));
                int v04 = g6.v0(i14, c6Var);
                a(v04);
                ...
                for (int i15 = 0; i15 < 2; i15++) {
                    ...
                    this.n[i10][i15].setTextColor(g6.v0(g6.z6, c6Var));
                    this.n[i10][i15].setGravity(LocaleController.isRTL ? 3 : 5);
                    frameLayout2.addView(this.n[i10][i15], z5.e(-1, -1, 119));
                }
                if (LocaleController.isRTL) {
                    g10.addView(frameLayout2, z5.q(-2, -1, 51));
                    g10.addView(this.h[i10], z5.q(-1, -1, 53));
                } else {
                    g10.addView(this.h[i10], z5.q(-2, -1, 51));
                    g10.addView(frameLayout2, z5.q(-1, -1, 53));
                }
                this.f[i10] = g10;
                addView(g10, z5.u(-1.0f, -2.0f, 51, 18.0f, i10 == 1 ? 1.0f : 11.66f, 28.0f, i10 == 6 ? 16.66f : 0.0f));
            }
            i10++;
        }
    ...
    */
    public final void b(TL_account.TL_businessWorkHours tL_businessWorkHours, boolean z10, boolean z11, boolean z12) {
        ...
        if (!tL_businessWorkHours.weekly_open.isEmpty()) {
            ...
            TLRPC.TL_timezone a2 = t1.b(UserConfig.selectedAccount).a(tL_businessWorkHours.timezone_id);
            ...
            if (z14) {
                ...
                textViewArr3[1].animate().alpha((z18 || !z19) ? 0.0f : 1.0f).setDuration(320L).setInterpolator(erVar).start();
                textViewArr[0][0].animate().alpha(z18 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(erVar).start();
                textViewArr[0][1].animate().alpha(z18 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(erVar).start();
                imageView.animate().rotation(z18 ? 180.0f : 0.0f).setDuration(320L).setInterpolator(erVar).start();
            } else {
                    ...
                    if (i26 < textViewArr4.length) {
                        if (i11 != 0 || z18) {
                            if ((i26 == i22) == z19) {
                                f11 = 1.0f;
                                if (this.y) {
                                    textViewArr4[i26].animate().alpha(f11).setDuration(320L).setInterpolator(er.h).start();
                                } else {
            ...
            rpVar.c(LocaleController.getString(!z19 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
            this.y = false;
            ArrayList[] Z = y0.Z(new ArrayList(tL_businessWorkHours.weekly_open));
            ...
            textView.setTextColor(g6.v0(!z15 ? g6.l8 : g6.p7, this.a));
            int i38 = this.x;
            i14 = this.w;
            this.w = 1;
            this.x = 0;
                        ...
                        if (i41 < (i39 == 0 ? 2 : 1)) {
                            ...
                            if (i39 == 0 && !z16 && i41 == 1) {
                                ...
                                if (z22) {
                                    ...
                                    textView2.setText(LocaleController.getString(R.string.BusinessHoursProfileClose));
                                } else if (y0.c0(arrayListArr4[i40])) {
            ...
            f10 = 6.0f;
            layoutParams.topMargin = AndroidUtilities.dp((this.w <= 2 || rpVar.getVisibility() == 0) ? 6.0f : 12.0f);
            if (this.w <= 2 && rpVar.getVisibility() != 0) {
                f10 = 12.0f;
            }
            layoutParams.bottomMargin = AndroidUtilities.dp(f10);
            layoutParams.gravity = ((this.w <= 2 || rpVar.getVisibility() == 0) ? 16 : 80) | (!LocaleController.isRTL ? 3 : 5);
        ...
        this.v.setTranslationX(!z13 ? AndroidUtilities.dp(11.0f) : 0.0f);
        TLRPC.TL_timezone a22 = t1.b(UserConfig.selectedAccount).a(tL_businessWorkHours.timezone_id);
        ...
        rpVar2.c(LocaleController.getString(!z19 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
        this.y = false;
        ArrayList[] Z3 = y0.Z(new ArrayList(tL_businessWorkHours.weekly_open));
        ...
        textView3.setTextColor(g6.v0(!z15 ? g6.l8 : g6.p7, this.a));
        int i382 = this.x;
        i14 = this.w;
        this.w = 1;
        this.x = 0;
        ...
        f10 = 6.0f;
        layoutParams2.topMargin = AndroidUtilities.dp((this.w <= 2 || rpVar2.getVisibility() == 0) ? 6.0f : 12.0f);
        if (this.w <= 2) {
            f10 = 12.0f;
        }
        layoutParams2.bottomMargin = AndroidUtilities.dp(f10);
        layoutParams2.gravity = ((this.w <= 2 || rpVar2.getVisibility() == 0) ? 16 : 80) | (!LocaleController.isRTL ? 3 : 5);
        if (i14 == this.w) {
        }
        requestLayout();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!this.B) {
            ...
            if (i12 > 2 || rpVar.getVisibility() == 0) {
                dp = AndroidUtilities.dp(rpVar.getVisibility() == 0 ? 21.0f : 0.0f) + AndroidUtilities.dp(15.0f) + this.x;
            } else {
                dp = 0;
            }
            i11 = View.MeasureSpec.makeMeasureSpec(Math.max(dp2, dp) + (this.A ? 1 : 0), TLObject.FLAG_30);
        }
