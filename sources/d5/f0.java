...
public abstract class f0 {
    ...
    public static String B(int i9) {
        switch (i9) {
            ...
            default:
                return i9 >= 10000 ? r0.m(i9, "custom (", ")") : "?";
        }
    }
    ...
    */
    public static int C(Uri uri, String str) {
        ...
        if (str == null) {
            ...
            if (scheme == null || !g7.b0.a("rtsp", scheme)) {
                String lastPathSegment = uri.getLastPathSegment();
                if (lastPathSegment != null) {
                    int lastIndexOf = lastPathSegment.lastIndexOf(46);
                    if (lastIndexOf >= 0) {
                        String b10 = g7.b0.b(lastPathSegment.substring(lastIndexOf + 1));
                        b10.getClass();
                        switch (b10) {
                            case "ism":
                            case "isml":
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: d5.f0.C(android.net.Uri, java.lang.String):int");
    }
    ...
    public static void G(int i9, int i10, int i11, ArrayList arrayList) {
        ArrayDeque arrayDeque = new ArrayDeque();
        for (int i12 = (i10 - i9) - 1; i12 >= 0; i12--) {
            arrayDeque.addFirst(arrayList.remove(i9 + i12));
        }
    ...
    public static String I(String str) {
        ...
        while (true) {
            ...
            if (b10.startsWith(strArr2[i9])) {
                return strArr2[i9 + 1] + b10.substring(strArr2[i9].length());
            }
            i9 += 2;
        }
    }
    ...
    public static void N(int i9, int i10, ArrayList arrayList) {
    ...
    public static int c(List list, Long l10, boolean z10) {
        ...
        return z10 ? Math.max(0, i9) : i9;
    }

    public static int d(int[] iArr, int i9, boolean z10, boolean z11) {
        int i10;
        int i11;
    ...
    public static Point p(Context context) {
        ...
        if (display.getDisplayId() == 0 && F(context)) {
            String A = i9 < 28 ? A("sys.display-size") : A("vendor.display-size");
    ...
    public static int u(int i9) {
        ...
        if (i9 != 16) {
            return i9 != 24 ? i9 != 32 ? 0 : 805306368 : TLObject.FLAG_29;
        }
        return 2;
    }

    public static t0 v(int i9, int i10, int i11) {
        s0 s0Var = new s0();
        s0Var.o = "audio/raw";
        s0Var.B = i10;
        s0Var.C = i11;
