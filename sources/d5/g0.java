...
public abstract class g0 {
    ...
    public static String A(String str) {
        try {
            ...
            a.p("Util", "Failed to read system property ".concat(str), e9);
            return null;
        }
    }
    ...
    public static String B(int i10) {
        switch (i10) {
            ...
            default:
                return i10 >= 10000 ? i0.a.l(i10, "custom (", ")") : "?";
        }
    }
    ...
    */
    public static int C(Uri uri) {
        ...
        char c10 = 3;
        if (scheme != null && h7.d0.a("rtsp", scheme)) {
            return 3;
        }
        ...
        if (lastPathSegment != null) {
            ...
            if (lastIndexOf >= 0) {
                String b10 = h7.d0.b(lastPathSegment.substring(lastIndexOf + 1));
                b10.getClass();
                switch (b10.hashCode()) {
                    case 104579:
                        if (b10.equals("ism")) {
    ...
    public static String I(String str) {
        ...
        if (str4 != null) {
            StringBuilder o10 = com.google.android.recaptcha.internal.a.o(str4);
            o10.append(b10.substring(str2.length()));
            b10 = o10.toString();
            str2 = str4;
        }
