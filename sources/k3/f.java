...
public final class f implements a2, h0, n3.g {
    ...
    public f(y yVar) {
        ...
        this.f = new m(myLooper == null ? Looper.getMainLooper() : myLooper, yVar, new d3(19));
        p2 p2Var = new p2();
        this.b = p2Var;
        this.c = new q2();
        c2 c2Var = new c2();
    ...
    public final a e(r2 r2Var, int i10, c0 c0Var) {
        c0 c0Var2 = r2Var.p() ? null : c0Var;
        this.a.getClass();
        long elapsedRealtime = SystemClock.elapsedRealtime();
        boolean z10 = r2Var.equals(this.h.A()) && i10 == this.h.x();
        long j10 = 0;
        if (c0Var2 == null || !c0Var2.a()) {
            if (z10) {
                j10 = this.h.q();
            } else if (!r2Var.p()) {
                j10 = d0.S(r2Var.m(i10, this.c, 0L).x);
            }
    ...
    public final void g(int i10, c0 c0Var, p pVar, l4.x xVar) {
        a j10 = j(i10, c0Var);
        l(j10, MediaDataController.MAX_STYLE_RUNS_COUNT, new d3(j10, pVar, xVar, 25));
    }
    ...
    public final a i(c0 c0Var) {
        this.h.getClass();
        r2 r2Var = c0Var == null ? null : (r2) ((q0) this.d.c).get(c0Var);
        if (c0Var != null && r2Var != null) {
            return e(r2Var, r2Var.g(c0Var.a, this.b).c, c0Var);
        }
        int x4 = this.h.x();
        r2 A = this.h.A();
        if (x4 >= A.o()) {
    ...
    public final a j(int i10, c0 c0Var) {
        this.h.getClass();
        if (c0Var != null) {
            return ((r2) ((q0) this.d.c).get(c0Var)) != null ? i(c0Var) : e(r2.a, i10, c0Var);
        }
        r2 A = this.h.A();
        if (i10 >= A.o()) {
            A = r2.a;
    ...
    public final void m(j3.c2 c2Var, Looper looper) {
        f5.a.i(this.h == null || ((z) this.d.b).isEmpty());
        c2Var.getClass();
        this.h = c2Var;
        this.n = this.a.a(looper, null);
        m mVar = this.f;
        this.f = new m(mVar.d, looper, mVar.a, new s(27, this, c2Var));
    }
    ...
    public final void onPlayerError(v1 v1Var) {
        l4.a0 a0Var;
        a d = (!(v1Var instanceof j3.n) || (a0Var = ((j3.n) v1Var).n) == null) ? d() : i(new c0(a0Var));
    ...
    public final void onTimelineChanged(r2 r2Var, int i10) {
        ...
        c2Var.getClass();
        c2 c2Var2 = this.d;
        c2Var2.d = c2.o(c2Var, (z) c2Var2.b, (c0) c2Var2.e, (p2) c2Var2.a);
        c2Var2.E(c2Var.A());
        a d = d();
        l(d, 0, new d(d, i10));
    }
