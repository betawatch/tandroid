...
public final class s0 extends i {
    ...
    public s0(y2 y2Var, Context context) {
        super(y2Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
    ...
    public s0(w0 w0Var, Context context) {
        super(w0Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
    ...
    public s0(x2 x2Var, Context context) {
        super(x2Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
    ...
    public s0(a2 a2Var, Context context) {
        super(a2Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
    ...
    public s0(h1 h1Var, Context context) {
        super(h1Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
