    ...
    */
    ...
    public final void d(int i10, final String str) {
        ...
        if (isEmpty) {
            ...
            final int i11 = 0;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) { // from class: qg.r0
            ...
            final int i12 = 1;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName2, 0, false, new Utilities.Callback(this) { // from class: qg.r0
                public final /* synthetic */ s0 b;
