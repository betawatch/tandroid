...
public class v0 extends View {
    ...
    public v0(Context context, float f7) {
        super(context);
        this.b = "";
    ...
    */
    ...
    public final void d(int i10, final String str) {
        ...
        if (isEmpty) {
            ...
            final int i11 = 0;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) { // from class: qg.u0
                ...
                public final void run(Object obj) {
                    switch (i11) {
                        case 0:
                            ...
                            v0Var.getClass();
                            String str2 = str;
                            TLRPC.Document b10 = v0.b(str2, (TLRPC.TL_messages_stickerSet) obj);
                            v0Var.v = b10;
                            v0Var.r.setImage(ImageLocation.getForDocument(b10), "80_80", v0.c(str2), null, null, 0);
                            v0Var.s.setImage(ImageLocation.getForDocument(v0Var.w), "80_80", ImageLocation.getForDocument(v0Var.v), "80_80", null, null, v0.c(str2), 0L, null, null, 0);
                            break;
                        default:
                            v0 v0Var2 = this.b;
                            v0Var2.getClass();
                            String str3 = str;
                            TLRPC.Document b11 = v0.b(str3, (TLRPC.TL_messages_stickerSet) obj);
                            v0Var2.w = b11;
                            if (b11 != null) {
                                v0Var2.s.setImage(ImageLocation.getForDocument(b11), "80_80", ImageLocation.getForDocument(v0Var2.v), "80_80", null, null, v0.c(str3), 0L, null, null, 0);
                                break;
                            }
                            break;
                    }
            ...
            final int i12 = 1;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName2, 0, false, new Utilities.Callback(this) { // from class: qg.u0
                public final /* synthetic */ v0 b;
