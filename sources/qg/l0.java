...
public final class l0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (st0Var.c2 != null) {
            ...
            st0Var.c2.q(lerp);
            st0Var.c2.setBounds(rect);
            st0Var.c2.draw(canvas2);
        } else {
        ...
        if (childAt.getAlpha() != 0.0f) {
            ...
            View view = childAt;
            if (i11 != -1) {
                ViewGroup viewGroup = i11 == 0 ? st0Var.t1 : i11 == 2 ? st0Var.u1 : null;
                ...
                x10 = AndroidUtilities.lerp(x10, (((childAt2.getWidth() - childAt2.getPaddingLeft()) - childAt2.getPaddingRight()) / 2.0f) + childAt2.getX() + childAt2.getPaddingLeft(), st0Var.i1);
                y3 = AndroidUtilities.lerp(y3, (((childAt2.getHeight() - childAt2.getPaddingTop()) - childAt2.getPaddingBottom()) / 2.0f) + childAt2.getY() + childAt2.getPaddingTop(), st0Var.i1);
            }
            if (k0Var != null && k0Var.getChildCount() > 0) {
                ...
                i10 = i0.a.d(st0Var.N1, t1Var.a, st0Var.V1.b(0));
            }
            float f7 = x10;
            float f10 = y3;
