...
public final class m2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public m2(ContextThemeWrapper contextThemeWrapper, e6 e6Var) {
        ...
        this.a = -1;
        qr qrVar = qr.h;
        this.b = new org.telegram.ui.Components.e6(0.0f, (View) null, 0L, 420L, qrVar);
        this.c = new org.telegram.ui.Components.e6(0.0f, (View) null, 0L, 420L, qrVar);
    ...
    */
    public static void c(j2 j2Var, int i10, int i11) {
        Bitmap bitmap;
        i2 i2Var;
        boolean z10;
        float f7;
        ...
        while (true) {
            ...
            i2 i2Var8 = (i2) arrayList5.get(i19);
            if (path2.isEmpty()) {
        ...
        while (true) {
            ...
            i2 i2Var9 = (i2) arrayList6.get(i20);
            if (path3.isEmpty()) {
    ...
    public final void a() {
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    switch (i12) {
                        case 0:
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: qg.f2
        ...
        SendMessagesHelper.getInstance(i10).sendSticker(k2Var.f.document, null, k2Var.i, null, null, null, null, null, true, 0, 0, false, null, null, 0L, 0L, null);
        ci.t0 t0Var = this.d0;
        if (t0Var != null) {
            t0Var.setProgress(1.0f);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 != NotificationCenter.fileNewChunkAvailable) {
            if (i10 == NotificationCenter.filePreparingFailed && (k2Var = this.W) != null && objArr[0] == k2Var.r) {
                h();
                return;
            }
            return;
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.H != null && this.N != null) {
            ...
            while (true) {
                ...
                boolean z10 = j2VarArr[i10] == j3 && motionEvent.getAction() != 3;
                if (z10 && !this.H[i10].b) {
    ...
    public final Bitmap e(Bitmap bitmap) {
        ...
        if (j2Var != null) {
            ...
            if (j2Var.f != null && this.L) {
                ...
                Matrix matrix = new Matrix();
                j2 j2Var3 = this.E;
                matrix.postRotate(j2Var3.c, j2Var3.a().getWidth() / 2.0f, this.E.a().getHeight() / 2.0f);
                if ((this.E.c / 90) % 2 != 0) {
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, pr0 pr0Var) {
        ...
        if (EmuDetector.with(getContext()).detect()) {
            ...
            new Canvas(l2Var.a).drawRect(0.0f, 0.0f, l2Var.d, l2Var.e, j6.Jl);
        ...
        if (this.c0 == null) {
            ...
            new ImageLabelerImpl((qb.e) dVar2.a.O0(aVar), (Executor) dVar2.b.a.get(), new k6.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new k2.v(this, 25)).addOnFailureListener(new wk0(26));
        }
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z10, final long j3, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: qg.h2
            ...
            public final void run() {
                ...
                boolean z11 = callback3 == null || (k2Var = m2Var.W) == null || !k2Var.o;
                if (z11) {
                    k2 k2Var2 = m2Var.W;
                    if (k2Var2 != null) {
                        k2Var2.a();
                ...
                if (z11) {
                    ...
                    if (document3 != null) {
                        ...
                        m2Var.W.f = new TLRPC.TL_messageMediaDocument();
                        TLRPC.TL_messageMediaDocument tL_messageMediaDocument = m2Var.W.f;
                        ...
                        m2Var.W.r = new MessageObject(UserConfig.selectedAccount, (TLRPC.Message) tL_message, (MessageObject) null, false, false);
                        m2Var.W.r.videoEditedInfo = videoEditedInfo2;
                        MediaController.getInstance().scheduleVideoConvert(m2Var.W.r, false, false, false);
                    } else {
                ...
                if (callback3 == null) {
                    if (m2Var.d0 == null) {
                        m2Var.d0 = new ci.t0(m2Var.getContext(), LocaleController.getString(R.string.PreparingSticker));
                    }
                    m2Var.d0.setOnCancelListener(new d2(m2Var, 0));
                    if (m2Var.d0.getParent() == null) {
                        m2Var.addView(m2Var.d0, y5.e(-1, -1, 17));
                    }
                    ci.t0 t0Var = m2Var.d0;
                    t0Var.E = true;
                    t0Var.invalidate();
                }
            }
