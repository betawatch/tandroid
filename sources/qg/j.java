...
public abstract class j extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [qg.e] */
    ...
    public j(Context context, PointF pointF) {
        ...
        this.E = false;
        final int i10 = 0;
        this.I = new Runnable(this) { // from class: qg.e
        ...
        this.S = 0;
        final int i11 = 1;
        this.T = new Runnable(this) { // from class: qg.e
            public final /* synthetic */ j b;
        ...
        final int i12 = 2;
        this.U = new Runnable(this) { // from class: qg.e
            public final /* synthetic */ j b;
    ...
    public final boolean c(float f7, float f10, boolean z10, float f11, float f12) {
        ...
        if (getParent() != null) {
            ...
            if (((float) Math.hypot(f15, f16)) > (this.n ? 6.0f : 16.0f) || z10) {
                ...
                h hVar5 = this.F;
                if (hVar5 != null) {
                    hVar5.A(wh.b((float) getHeight(), 2.0f, scaleX, this.G.y) < ((float) AndroidUtilities.dp(66.0f)));
    ...
    public final void f(float f7) {
        ...
        if (!z10 && !this.c0) {
            ...
            while (true) {
                ...
                if (Math.abs(intValue - f7) < 4.0f) {
                    if (this.M != intValue) {
                        ...
                        ai1 ai1Var2 = new ai1(this, intValue, 1);
                        this.N = ai1Var2;
                        AndroidUtilities.runOnUIThread(ai1Var2, 250L);
                    }
                }
            }
        } else if (z10) {
            if (Math.abs(this.L - f7) >= 12.0f || this.c0) {
                ...
                ai1 ai1Var3 = this.N;
                if (ai1Var3 != null) {
                    AndroidUtilities.cancelRunOnUIThread(ai1Var3);
                    this.N = null;
                }
