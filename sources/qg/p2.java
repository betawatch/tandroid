...
public final class p2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public p2(ContextThemeWrapper contextThemeWrapper, f6 f6Var) {
    ...
    */
    public static void c(m2 m2Var, int i10, int i11) {
        Bitmap bitmap;
        l2 l2Var;
        boolean z10;
        float f7;
        ...
        if (m2Var.c != 0) {
            ...
            matrix.postRotate(m2Var.c, m2Var.b().getWidth() / 2.0f, m2Var.d.getHeight() / 2.0f);
            if ((m2Var.c / 90) % 2 != 0) {
                float height2 = (m2Var.b().getHeight() - m2Var.b().getWidth()) / 2.0f;
                matrix.postTranslate(height2, -height2);
            }
            matrix.postScale(rectF.width() / f10, rectF.height() / f11);
            canvas.drawBitmap(m2Var.b(), matrix, new Paint(3));
        } else {
            canvas.drawBitmap(m2Var.b(), (Rect) null, rectF, new Paint(3));
        }
        ...
        while (i13 < height3) {
            ...
            if (i14 == 0) {
                ...
                if (!z12 || iArr[i15] == 0) {
                    ...
                    i12 = i16;
                    l2Var3 = new l2(min, width3, width2);
                }
                if (l2Var2 == null && z13 && iArr[i12] != 0) {
                    l2Var2 = new l2(min, width3, width2);
                }
            } else {
                f7 = f10;
            }
            ...
            if (z14) {
                l2 l2Var4 = z11 ? new l2(min, width3, width2) : l2Var3;
                if (l2Var2 != null) {
                    arrayList.add(l2Var2);
                }
                if (l2Var4 != null) {
                    arrayList2.add(l2Var4);
                }
                l2Var2 = null;
                l2Var3 = null;
            }
        ...
        while (i17 < height3) {
            ...
            if (z16) {
                ...
                if (z17 && iArr[width4] != 0) {
                    l2Var6 = new l2(min, height4, height5);
                }
                if (l2Var7 == null && z18 && iArr[width5] != 0) {
                    l2Var = new l2(min, height4, height5);
                    int i18 = height3;
                    ...
                    if (z10) {
                        ...
                        if (l2Var6 != null) {
                            arrayList4.add(l2Var6);
                        }
                        l2Var = null;
                        l2Var6 = null;
                    }
                    l2Var5 = (z19 || !z16) ? l2Var : new l2(min, height4, height5);
                    i17++;
                    f11 = f15;
                    createBitmap = bitmap;
                    height3 = i18;
        ...
        while (true) {
            ...
            l2 l2Var8 = (l2) arrayList5.get(i19);
            if (path2.isEmpty()) {
                path2.moveTo(((Point) l2Var8).x, ((Point) l2Var8).y);
            } else {
                path2.lineTo(((Point) l2Var8).x, ((Point) l2Var8).y);
            }
            i19 += 2;
        }
        Path path3 = new Path();
        ...
        while (true) {
            ...
            l2 l2Var9 = (l2) arrayList6.get(i20);
            if (path3.isEmpty()) {
                path3.moveTo(((Point) l2Var9).x, ((Point) l2Var9).y);
            } else {
                path3.lineTo(((Point) l2Var9).x, ((Point) l2Var9).y);
            }
            i20 += 2;
        }
        path.reset();
        ...
        Paint paint = m2Var.r;
        Paint paint2 = m2Var.q;
        Paint paint3 = m2Var.p;
        Paint paint4 = m2Var.s;
        PathMeasure pathMeasure = new PathMeasure();
        pathMeasure.setPath(path, true);
        float length = pathMeasure.getLength();
        int ceil = (int) Math.ceil(length / AndroidUtilities.dp(2.0f));
        m2Var.n = ceil;
        m2Var.o = new float[ceil * 2];
    ...
    public static List k(ArrayList arrayList) {
        ...
        arrayList2.add((l2) hg.k0.h(1, arrayList));
        return arrayList2;
    }
    ...
    public final void a() {
        ...
        if (n2Var.m != null) {
            ...
            AndroidUtilities.runOnUIThread(new p91(11), 250L);
            return;
        }
        final int i12 = 0;
        if (n2Var.k != null) {
            TLRPC.TL_stickers_replaceSticker tL_stickers_replaceSticker = new TLRPC.TL_stickers_replaceSticker();
            tL_stickers_replaceSticker.sticker = MediaDataController.getInputStickerSetItem(n2Var.k, n2Var.c).document;
            tL_stickers_replaceSticker.new_sticker = n2Var.e;
            ConnectionsManager.getInstance(i10).sendRequest(tL_stickers_replaceSticker, new RequestDelegate(this) { // from class: qg.h2
                                    ...
                                    switch (i13) {
                                        case 0:
                                            ...
                                            if (z13) {
                                                ...
                                                ci.t0 t0Var = p2Var2.d0;
                                                if (t0Var != null) {
                                                    t0Var.setProgress(1.0f);
                                                }
                                                final int i16 = 1;
                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: qg.j2
                                                    @Override // java.lang.Runnable
                                                    public final void run() {
                                                        int i17 = i16;
                                                        n2 n2Var4 = n2Var3;
                                                        ...
                                                        switch (i17) {
                                                            case 0:
                                                                ...
                                                                TLRPC.Document document = n2Var4.f.document;
                                                                String str = n2Var4.l;
                                                                ...
                                                                break;
                                                            case 1:
                                                                NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject3, n2Var4.f.document, n2Var4.l, Boolean.TRUE);
                                                                p2Var3.h();
                                                                break;
                                                            default:
                                                                ...
                                                                TLRPC.Document document2 = n2Var4.f.document;
                                                                String str2 = n2Var4.l;
                                            ...
                                            Utilities.Callback callback = n2Var3.n;
                                            if (callback != null) {
                                        ...
                                        case 1:
                                                    ...
                                                    public final void run() {
                                                        ...
                                                        switch (i172) {
                                                            case 0:
                                                                ...
                                                                TLRPC.Document document = n2Var42.f.document;
                                                                String str = n2Var42.l;
                                                                Boolean bool = Boolean.FALSE;
                                                                notificationCenter.postNotificationNameOnUIThread(i182, bool, tLObject32, document, str, bool);
                                                                p2Var32.h();
                                                                break;
                                                            case 1:
                                                                NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, n2Var42.f.document, n2Var42.l, Boolean.TRUE);
                                                                p2Var32.h();
                                                                break;
                                                            default:
                                                                NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                int i19 = NotificationCenter.customStickerCreated;
                                                                TLRPC.Document document2 = n2Var42.f.document;
                                                                String str2 = n2Var42.l;
                                                                Boolean bool2 = Boolean.FALSE;
                                            ...
                                            Utilities.Callback callback2 = n2Var4.n;
                                            if (callback2 != null) {
                                        ...
                                        default:
                                            ...
                                            Utilities.Callback callback3 = n2Var5.n;
                                            if (callback3 != null) {
                                ...
                                public final void run() {
                                    ...
                                    switch (i15) {
                                        case 0:
                                            ...
                                            Utilities.Callback callback = n2Var32.n;
                                            if (callback != null) {
                                                callback.run(Boolean.valueOf(z10));
                                                n2Var32.n = null;
                                                break;
                                ...
                                public final void run() {
                                    ...
                                    switch (i17) {
                                        ...
                                        case 1:
                                                    ...
                                                    public final void run() {
                                                        ...
                                                        switch (i1722) {
                                                            case 0:
                                                                ...
                                                                TLRPC.Document document = n2Var422.f.document;
                                                                String str = n2Var422.l;
                                                                Boolean bool = Boolean.FALSE;
                                                                notificationCenter.postNotificationNameOnUIThread(i1822, bool, tLObject32, document, str, bool);
                                                                p2Var322.h();
                                                                break;
                                                            case 1:
                                                                NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, n2Var422.f.document, n2Var422.l, Boolean.TRUE);
                                                                p2Var322.h();
                                                                break;
                                                            default:
                                                                NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                int i192 = NotificationCenter.customStickerCreated;
                                                                TLRPC.Document document2 = n2Var422.f.document;
                                                                String str2 = n2Var422.l;
                                                                Boolean bool2 = Boolean.FALSE;
                                                                notificationCenter2.postNotificationNameOnUIThread(i192, bool2, tLObject32, document2, str2, bool2);
                                                                p2Var322.h();
                                                                break;
                                            ...
                                            Utilities.Callback callback2 = n2Var42.n;
                                            if (callback2 != null) {
                                                callback2.run(Boolean.valueOf(z11));
                                                n2Var42.n = null;
                                                break;
        ...
        if (n2Var.d != null) {
            ...
            ConnectionsManager.getInstance(i10).sendRequest(tL_stickers_createStickerSet, new RequestDelegate(this) { // from class: qg.h2
                public final /* synthetic */ p2 b;
        ...
        if (n2Var.i == 0) {
            if (n2Var.j != null) {
                ...
                tL_stickers_addStickerToSet.stickerset = MediaDataController.getInputStickerSet(n2Var.j);
                tL_stickers_addStickerToSet.sticker = n2Var.e;
                final int i13 = 2;
                ConnectionsManager.getInstance(i10).sendRequest(tL_stickers_addStickerToSet, new RequestDelegate(this) { // from class: qg.h2
                    public final /* synthetic */ p2 b;
                                    ...
                                    public final void run() {
                                        ...
                                        switch (i132) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback2 = n2Var32.n;
                                                if (callback2 != null) {
                                            ...
                                            case 1:
                                                ...
                                                Utilities.Callback callback22 = n2Var42.n;
                                                if (callback22 != null) {
        ...
        SendMessagesHelper.getInstance(i10).sendSticker(n2Var.f.document, null, n2Var.i, null, null, null, null, null, true, 0, 0, false, null, null, 0L, 0L, null);
        ci.t0 t0Var = this.d0;
        if (t0Var != null) {
            t0Var.setProgress(1.0f);
        }
        AndroidUtilities.runOnUIThread(new v(this, i10, i11), 450L);
        Utilities.Callback callback2 = n2Var.n;
        if (callback2 != null) {
        ...
        if (this.H != null) {
            ...
            while (true) {
                ...
                if (m2Var != null) {
                    ...
                    Bitmap bitmap3 = m2Var.g;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                        m2Var.g = null;
                    }
                    Bitmap bitmap4 = m2Var.f;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                        m2Var.f = null;
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            n2 n2Var2 = this.W;
            if (n2Var2 == null || !str.equalsIgnoreCase(n2Var2.b)) {
                return;
            }
            n2 n2Var3 = this.W;
            n2Var3.g = inputFile;
            ...
            tL_inputMediaUploadedDocument.file = n2Var3.g;
            if (n2Var3.s != null) {
            ...
            ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tL_messages_uploadMedia, new bj1(1, this, n2Var3), 2);
            return;
        }
        if (i10 == NotificationCenter.fileUploadProgressChanged) {
            String str2 = (String) objArr[0];
            n2 n2Var4 = this.W;
            if (n2Var4 == null || !str2.equalsIgnoreCase(n2Var4.b)) {
                return;
            }
            ...
            if (longValue2 > 0) {
                n2 n2Var5 = this.W;
                n2Var5.u = Utilities.clamp(longValue / longValue2, 1.0f, n2Var5.u);
                ci.t0 t0Var = this.d0;
                if (t0Var != null) {
        ...
        if (i10 == NotificationCenter.fileUploadFailed) {
            ...
            n2 n2Var6 = this.W;
            if (n2Var6 == null || !str3.equalsIgnoreCase(n2Var6.b)) {
                return;
            }
            h();
            return;
        ...
        if (i10 == NotificationCenter.filePreparingStarted) {
            n2 n2Var7 = this.W;
            if (n2Var7 != null && objArr[0] == n2Var7.r) {
        ...
        if (i10 != NotificationCenter.fileNewChunkAvailable) {
            if (i10 == NotificationCenter.filePreparingFailed && (n2Var = this.W) != null && objArr[0] == n2Var.r) {
                h();
                return;
            }
            return;
        ...
        n2 n2Var8 = this.W;
        if (n2Var8 != null && objArr[0] == n2Var8.r) {
            ...
            n2 n2Var9 = this.W;
            n2Var9.t = Math.max(n2Var9.t, floatValue);
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.H != null && this.N != null) {
            ...
            while (true) {
                ...
                boolean z10 = m2VarArr[i10] == j3 && motionEvent.getAction() != 3;
                if (z10 && !this.H[i10].b) {
    ...
    public final Bitmap e(Bitmap bitmap) {
        ...
        if (m2Var != null) {
            ...
            if (m2Var.f != null && this.L) {
                ...
                Matrix matrix = new Matrix();
                m2 m2Var3 = this.E;
                matrix.postRotate(m2Var3.c, m2Var3.a().getWidth() / 2.0f, this.E.a().getHeight() / 2.0f);
                if ((this.E.c / 90) % 2 != 0) {
                ...
                for (m2 m2Var : m2VarArr) {
                    if (m2Var != null && m2Var == this.E) {
                        if (this.F > 0.0f) {
                            ...
                            canvas.save();
                            canvas.clipPath(m2Var.t.k0);
                            if (m2Var.t.I != null) {
                                Paint paint = z10 ? m2Var.q : m2Var.p;
                                paint.setAlpha((int) (e * 255.0f));
                                paint.setStrokeWidth(AndroidUtilities.dp(r4));
                                canvas.drawPath(m2Var.l, paint);
                                if (m2Var.t.k0 != null && z10) {
                                    canvas.clipPath(m2Var.l);
                                    paint.setStrokeWidth(AndroidUtilities.dp(r4 * 2.0f));
                                    canvas.drawPath(m2Var.t.k0, paint);
                                }
                            }
                            canvas.restore();
                            return;
    ...
    public y01 getThanosEffect() {
        ...
        if (this.S == null) {
            y01 y01Var = new y01(getContext(), new g2(this, 1));
            this.S = y01Var;
            addView(y01Var, x5.c(-1.0f, -1));
        }
        return this.S;
    }
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, qr0 qr0Var) {
        wb.c cVar;
        ...
        this.J = i10;
        this.c0 = null;
        r4 r4Var = new r4(this, i10, qr0Var, 4);
        this.x = true;
        ac.d dVar = new ac.d();
        dVar.b = true;
        dVar.c = true;
        ...
        if (EmuDetector.with(getContext()).detect()) {
            ...
            new Canvas(o2Var.a).drawRect(0.0f, 0.0f, o2Var.d, o2Var.e, j6.Jl);
        ...
        a2.g(a10).addOnSuccessListener(new k2.v(r4Var, 24)).addOnFailureListener(new org.telegram.ui.Components.d2(this, bitmap, i10, qr0Var, r4Var, 4));
        if (this.c0 == null) {
            yb.a aVar = yb.a.b;
            ...
            new ImageLabelerImpl((qb.e) dVar2.a.O0(aVar), (Executor) dVar2.b.a.get(), new k6.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new k2.v(this, 25)).addOnFailureListener(new bs0(24));
        }
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z10, final long j3, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: qg.k2
            @Override // java.lang.Runnable
            public final void run() {
                n2 n2Var;
                p2 p2Var = p2.this;
                Utilities.Callback callback3 = callback;
                boolean z11 = callback3 == null || (n2Var = p2Var.W) == null || !n2Var.o;
                if (z11) {
                    n2 n2Var2 = p2Var.W;
                    if (n2Var2 != null) {
                        n2Var2.a();
                    ...
                    n2 n2Var3 = new n2();
                    n2Var3.p = new ArrayList();
                    n2Var3.q = new ArrayList();
                    n2Var3.t = 0.0f;
                    n2Var3.u = 0.0f;
                    p2Var.W = n2Var3;
                }
                ...
                n2Var4.b = str4;
                n2Var4.a = str4;
                n2Var4.d = charSequence;
                n2Var4.h = z10;
                n2Var4.i = j3;
                n2Var4.j = stickerSet;
                n2Var4.k = document;
                VideoEditedInfo videoEditedInfo2 = videoEditedInfo;
                n2Var4.s = videoEditedInfo2;
                n2Var4.l = str3;
                n2Var4.n = callback3;
                n2Var4.m = callback2;
                ArrayList arrayList = n2Var4.q;
                if (!TextUtils.isEmpty(str4)) {
                    n2Var4.p.add(new File(n2Var4.b));
                }
                if (!TextUtils.isEmpty(n2Var4.a) && !TextUtils.equals(n2Var4.a, n2Var4.b)) {
                    arrayList.add(new File(n2Var4.a));
                }
                if (!TextUtils.isEmpty(n2Var4.l)) {
                    arrayList.add(new File(n2Var4.l));
                }
                if (z11) {
                    TLRPC.Document document3 = document2;
                    if (document3 != null) {
                        n2 n2Var5 = p2Var.W;
                        n2Var5.e = MediaDataController.getInputStickerSetItem(document3, n2Var5.c);
                        p2Var.W.f = new TLRPC.TL_messageMediaDocument();
                        TLRPC.TL_messageMediaDocument tL_messageMediaDocument = p2Var.W.f;
                        ...
                        p2Var.W.r.videoEditedInfo = videoEditedInfo2;
                        MediaController.getInstance().scheduleVideoConvert(p2Var.W.r, false, false, false);
                    } else {
                        FileLoader.getInstance(p2Var.a).uploadFile(str4, false, true, 67108864);
                    }
                } else {
                    p2Var.a();
                }
                if (callback3 == null) {
                    if (p2Var.d0 == null) {
                        p2Var.d0 = new ci.t0(p2Var.getContext(), LocaleController.getString(R.string.PreparingSticker));
                    }
                    p2Var.d0.setOnCancelListener(new g2(p2Var, 0));
                    if (p2Var.d0.getParent() == null) {
                        p2Var.addView(p2Var.d0, x5.e(-1, -1, 17));
                    }
                    ci.t0 t0Var = p2Var.d0;
                    t0Var.E = true;
                    t0Var.invalidate();
                }
            }
