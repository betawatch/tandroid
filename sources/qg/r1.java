...
public class r1 extends ViewGroup {
    ...
    public r1(Context context) {
        ...
        addView(textView, a6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 0.0f, 8.0f, 0.0f, 0.0f));
        ...
        addView(textView2, a6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 80, 0.0f, 0.0f, 0.0f, 8.0f));
        ...
        addView(textView3, a6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 80, 0.0f, 0.0f, 0.0f, 8.0f));
    ...
    */
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        r1 r1Var = this.E;
        Paint paint = r1Var != null ? r1Var.y : this.y;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i14 + this.f;
        int measuredWidth = tpVar.getMeasuredWidth() + AndroidUtilities.dp(i15 + 24);
        TextView textView2 = this.d;
        ...
        if (textView4.getVisibility() == 0) {
            rect.set(textView5.getMeasuredWidth() + getPaddingLeft() + tpVar.getMeasuredWidth() + AndroidUtilities.dp(i15 + 6), AndroidUtilities.dp(2.0f) + getPaddingTop(), 0, 0);
            b(textView4);
        }
        ...
        b(textView2);
        rect.set(getPaddingLeft() + tpVar.getMeasuredWidth() + AndroidUtilities.dp(f7) + (textView2.getVisibility() == 0 ? AndroidUtilities.dp(6.0f) + textView2.getMeasuredWidth() : 0), (getMeasuredHeight() - textView3.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
        b(textView3);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(size - tpVar.getMeasuredWidth(), TLObject.FLAG_31);
        ...
        this.b.measure(View.MeasureSpec.makeMeasureSpec((size - tpVar.getMeasuredWidth()) - textView.getMeasuredWidth(), TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(dp, TLObject.FLAG_31));
        TextView textView2 = this.r;
        if (textView2.getVisibility() == 0) {
            textView2.measure(View.MeasureSpec.makeMeasureSpec((size - tpVar.getMeasuredWidth()) - textView.getMeasuredWidth(), TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(dp, TLObject.FLAG_31));
        } else {
        ...
        int makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(size - tpVar.getMeasuredWidth(), TLObject.FLAG_31);
        ...
        int d = em.d(6.0f, (size - tpVar.getMeasuredWidth()) - (textView3.getVisibility() == 0 ? textView3.getMeasuredWidth() : 0), TLObject.FLAG_31);
    ...
    public void setProgressDelegate(up upVar) {
        this.a.setProgressDelegate(upVar);
    }
}
