    ...
    */
    public static void e(Canvas canvas, float f10, float f11, float[] fArr, float f12, boolean z4, Paint paint) {
        ...
        if (z4) {
            if (z10) {
                canvas.save();
                if (canvas.clipRect(0.0f, 0.0f, f10, o.a((fArr[0] * 2.0f) + 0.0f, 0.0f, f11))) {
                    float f21 = fArr[0];
            ...
            canvas.save();
            if (canvas.clipRect(0.0f, 0.0f, f22, o.a((fArr[0] * 2.0f) + 0.0f, 0.0f, f11))) {
                f13 = 0.0f;
            ...
            canvas.restore();
            canvas.save();
            if (canvas.clipRect(f22, f13, f10, o.a((fArr[0] * 2.0f) + f13, f13, f11))) {
        ...
        if (z10) {
            canvas.save();
            if (canvas.clipRect(0.0f, o.a(f11 - (fArr[4] * 2.0f), 0.0f, f11), f10, f11)) {
                float f23 = 0.0f - f20;
                float f24 = fArr[4];
        ...
        canvas.save();
        if (canvas.clipRect(0.0f, o.a(f11 - (fArr[4] * 2.0f), 0.0f, f11), f25, f11)) {
            float f26 = 0.0f - f20;
            canvas.drawRoundRect(f26, f26, f10 + f20, f11 - f20, fArr[6], fArr[7], paint);
        }
        canvas.restore();
        canvas.save();
        if (canvas.clipRect(f25, o.a(f11 - (fArr[4] * 2.0f), 0.0f, f11), f10, f11)) {
            float f27 = 0.0f - f20;
    ...
    public final void c(Canvas canvas, tg.a aVar) {
        ...
        if (aVar instanceof tg.b) {
            ...
            int l1 = k6.l1(this.j / 255.0f, this.e);
            if (Color.alpha(l1) > 0) {
                Paint paint2 = this.r;
                paint2.setColor(l1);
        ...
        if (Build.VERSION.SDK_INT >= 29 && (aVar instanceof tg.d)) {
            tg.d dVar = (tg.d) aVar;
        ...
        int l12 = k6.l1(i10 / 255.0f, this.e);
    ...
    public final void g(Canvas canvas) {
        int l1 = k6.l1(this.j / 255.0f, this.f);
        int l12 = k6.l1(this.j / 255.0f, this.g);
