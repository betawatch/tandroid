...
public final class p1 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public p1(Context context) {
        ...
        this.e = view;
        final int i10 = 0;
        view.setOnClickListener(new View.OnClickListener(this) { // from class: qg.l1
        ...
        final int i11 = 1;
        kj0Var.setOnClickListener(new View.OnClickListener(this) { // from class: qg.l1
            public final /* synthetic */ p1 b;
        ...
        addView(kj0Var, y5.d(28, 28.0f, 16, 0.0f, 0.0f, 16.0f, 0.0f));
        ImageView imageView = new ImageView(context);
        this.c = imageView;
        imageView.setImageResource(R.drawable.msg_text_outlined);
        imageView.setPadding(AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f));
        final int i12 = 2;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: qg.l1
            public final /* synthetic */ p1 b;
        ...
        final int i13 = 3;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: qg.l1
            public final /* synthetic */ p1 b;
        ...
        final int i14 = 4;
        o1Var.setOnClickListener(new View.OnClickListener(this) { // from class: qg.l1
            public final /* synthetic */ p1 b;
    ...
    public final void d(int i10, boolean z10) {
        ...
        while (true) {
            ...
            if (i11 == m1Var4.a && this.a == m1Var4.b) {
                m1Var3 = m1Var4;
                break;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < getChildCount(); i12++) {
            ...
            o1 o1Var = this.f;
            if (childAt == o1Var) {
                o1Var.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_31));
            } else {
