...
public final class n2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public n2(ContextThemeWrapper contextThemeWrapper, f6 f6Var) {
        ...
        this.a = -1;
        qr qrVar = qr.h;
        this.b = new d6(0.0f, (View) null, 0L, 420L, qrVar);
        this.c = new d6(0.0f, (View) null, 0L, 420L, qrVar);
    ...
    */
    ...
    public final void a() {
        ...
        if (l2Var.m != null) {
            ...
            AndroidUtilities.runOnUIThread(new u21(13), 250L);
            return;
        }
        final int i12 = 0;
        if (l2Var.k != null) {
                ...
                public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                    switch (i12) {
                        case 0:
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: qg.g2
                                    ...
                                    switch (i13) {
                                        case 0:
                                            ...
                                            if (z13) {
                                                ...
                                                ci.t0 t0Var = n2Var2.d0;
                                                if (t0Var != null) {
                                                    t0Var.setProgress(1.0f);
                                                }
                                                final int i16 = 1;
                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: qg.h2
                                                    @Override // java.lang.Runnable
                                                    public final void run() {
                                                        int i17 = i16;
                                                        l2 l2Var4 = l2Var3;
        ...
        if (l2Var.h) {
            ...
            AndroidUtilities.runOnUIThread(new org.telegram.ui.web.r0(l2Var, 17), 350L);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tL_messages_uploadMedia, new bj1(1, this, l2Var3), 2);
            return;
        }
    ...
    */
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, pr0 pr0Var) {
        ...
        if (this.c0 == null) {
            ...
            nVar.c = n7.b;
            qb.m.a.execute(new com.google.android.gms.internal.cast.p(gaVar, new a5.a(nVar, 1), p7.c, gaVar.b(), 7));
            new ImageLabelerImpl((qb.e) dVar2.a.O0(aVar), (Executor) dVar2.b.a.get(), new k6.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new k2.v(this, 25)).addOnFailureListener(new q9.p(2));
        }
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z10, final long j3, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: qg.i2
            @Override // java.lang.Runnable
            public final void run() {
                l2 l2Var;
                n2 n2Var = n2.this;
