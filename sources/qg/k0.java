...
public class k0 extends ab implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void R(k0 k0Var, ArrayList arrayList, int i10, TLRPC.TL_messages_inactiveChats tL_messages_inactiveChats) {
        ...
        k0Var.M1();
        if (k0Var.l0 >= 0 && i11 != 0) {
            ((s4.c0) vl0Var.getLayoutManager()).h1(k0Var.l0 + 1, i11);
        }
        if (k0Var.M0 == null) {
        ...
        if (k0Var.j0) {
            ...
            if (canApplyBoost.canApply) {
                ...
                if (canApplyBoost2.alreadyActive && canApplyBoost2.boostedNow) {
                    AndroidUtilities.runOnUIThread(new x(k0Var, i11), canApplyBoost2.needSelector ? 300L : 0L);
                    return;
                }
                return;
            }
            if (canApplyBoost.alreadyActive && sg.s.i() && !k0Var.c0.isMaxLvl) {
                sg.i.i(k0Var.a0, k0Var);
                return;
            } else {
                k0Var.dismiss();
                return;
    ...
    public static void V(k0 k0Var, Context context) {
        ...
        if (canApplyBoost.empty) {
            ...
            d2 d2Var = alertDialog$Builder.a;
            d2Var.R = string;
            d2Var.T = AndroidUtilities.replaceTags(LocaleController.getString(k0Var.x1() ? R.string.PremiumNeededForBoostingGroup : R.string.PremiumNeededForBoosting));
            alertDialog$Builder.k(LocaleController.getString(R.string.CheckPhoneNumberYes), new y(k0Var, i12));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new js0(i13));
        ...
        alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), new js0(i11));
        ...
        if (view instanceof g4) {
            if (k0Var.Y || !((i10 = k0Var.h0) == 11 || i10 == 34)) {
                ...
                if (object instanceof TLRPC.User) {
                    ...
                    (MessagesController.getInstance(k0Var.currentAccount).premiumFeaturesBlocked() ? new wc((FrameLayout) k0Var.containerView, k0Var.resourcesProvider).Q(R.raw.star_premium_2, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserBlockedNonPremium, forcedFirstName))) : new wc((FrameLayout) k0Var.containerView, k0Var.resourcesProvider).J(R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserBlockedNonPremium, forcedFirstName)), LocaleController.getString(R.string.UserBlockedNonPremiumButton), new x(k0Var, 0))).j();
                }
            }
        }
    }
    ...
    public final boolean B1() {
        ...
        if (k0Var.e0) {
            ...
            j0Var.d.addView(j0Var.a, a6.o(-2, -2, 1.0f, 0));
            ...
            j0Var.addView(j0Var.a, indexOfChild3, a6.t(-2, -2, 1, 0, 22, 0, 0));
        }
        ...
        j0Var.addView(j0Var.b, indexOfChild, a6.t(-2, -2, 1, 24, -2, 24, 17));
    ...
    public final void D1(ArrayList arrayList) {
        ...
        if (arrayList.size() == 1) {
            ...
            if (this.v0) {
                d2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", R.string.RevokeLinkAlertChannel, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + ChatObject.getPublicUsername(chat), chat.title));
            } else {
                d2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", R.string.RevokeLinkAlert, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + ChatObject.getPublicUsername(chat), chat.title));
            }
        } else if (this.v0) {
    ...
    public final void E1(HashMap hashMap) {
        ...
        if (hashMap2 == null && !arrayList.isEmpty()) {
            ...
            d5.c0(this.currentAccount, arrayList3, 1, new org.telegram.ui.web.y1(this, 4));
            return;
        }
        Iterator it2 = hashSet.iterator();
        boolean z10 = false;
    ...
    public final void F(aw0 aw0Var) {
        ...
        this.E0.r.setOnClickListener(new w71(12, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        p2 p2Var = this.n;
        p2 lastFragment = p2Var.getParentLayout().getLastFragment();
        if (lastFragment instanceof yg.s) {
            List fragmentStack = p2Var.getParentLayout().getFragmentStack();
            p2 p2Var2 = fragmentStack.size() >= 2 ? (p2) r6.g(2, fragmentStack) : null;
            p2 p2Var3 = fragmentStack.size() >= 3 ? (p2) r6.g(3, fragmentStack) : null;
            r6 = fragmentStack.size() >= 4 ? (p2) r6.g(4, fragmentStack) : null;
            if (p2Var2 instanceof yo) {
                ((ActionBarLayout) p2Var.getParentLayout()).a0(p2Var2, false);
            }
            dismiss();
            if (!booleanValue) {
                lastFragment.finishFragment();
                sg.i.f(p2Var3, chat, false);
                return;
            } else {
        ...
        if ((lastFragment instanceof eo) && booleanValue) {
            sg.i.f(lastFragment, chat, true);
            return;
        }
        if ((lastFragment instanceof cd) && booleanValue) {
            List fragmentStack2 = p2Var.getParentLayout().getFragmentStack();
            ArrayList arrayList = new ArrayList();
            for (int size = fragmentStack2.size() - 2; size >= 0; size--) {
                p2 p2Var4 = (p2) fragmentStack2.get(size);
                if ((p2Var4 instanceof eo) || (p2Var4 instanceof wy)) {
                    r6 = p2Var4;
                    break;
                }
            ...
            while (i12 < size2) {
                ...
                i12++;
                ((ActionBarLayout) p2Var.getParentLayout()).a0((p2) obj, false);
            }
    ...
    public final void m1(final p90 p90Var, boolean z10) {
        if (!p90Var.c() || z10) {
            ...
            final int i11 = 0;
            Utilities.Callback<TL_stories.TL_premium_myBoosts> callback = new Utilities.Callback(this) { // from class: qg.z
                ...
                public final void run(Object obj) {
                    switch (i11) {
                        case 0:
                            MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.a0, new t8(this.b, p90Var, (TL_stories.TL_premium_myBoosts) obj, 2));
                            break;
                        default:
                            ...
                            if (startsWith) {
                                ...
                                if (intValue <= 5) {
                                    AndroidUtilities.runOnUIThread(new org.telegram.ui.web.x1(10, this.b, p90Var2), intValue * 1000);
                                    break;
                                } else {
                                    sg.i.g(intValue);
                                }
            ...
            final int i12 = 1;
            boostsController.applyBoost(j3, i10, callback, new Utilities.Callback(this) { // from class: qg.z
                public final /* synthetic */ k0 b;
    ...
    public final void z1() {
        ...
        i0Var.b++;
        i0Var.a = w7.q.a((i10 - r3) / i11, 0.0f, 1.0f);
        i0Var.W = true;
        i0Var.a0 = i0Var.n;
        i0Var.g(i10, true);
