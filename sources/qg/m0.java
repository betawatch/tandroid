...
public final class m0 {
    ...
    public ra.a a() {
        ...
        if (str.isEmpty()) {
            return new ra.a((String) this.c, this.b, (String) this.d, (String) this.e, ((Long) this.f).longValue(), ((Long) this.g).longValue(), (String) this.h);
        }
    ...
    public void c() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ((o0.b) this.f).c((s4.a) arrayList.get(i10));
        }
        m(arrayList);
        this.b = 0;
    }
    ...
    public void d() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (i11 == 1) {
                ...
                bVar.c(aVar);
                bVar.m(aVar.b, aVar.d, aVar.c);
            } else if (i11 == 8) {
                bVar.c(aVar);
                bVar.y(aVar.b, aVar.d);
            }
        }
        m(arrayList);
        this.b = 0;
    ...
    */
    public void l() {
        ...
        while (true) {
            ...
            int i14 = size + 1;
            m0 m0Var = (m0) gVar.b;
            c5.b0 b0Var2 = (c5.b0) m0Var.c;
            s4.a aVar2 = (s4.a) arrayList.get(size);
            s4.a aVar3 = (s4.a) arrayList.get(i14);
            int i15 = aVar3.a;
            if (i15 == 1) {
                int i16 = aVar2.d;
                int i17 = aVar3.b;
                ...
                int i22 = aVar2.d;
                if (i21 < i22) {
                    if (aVar3.b == i21 && aVar3.d == i22 - i21) {
                        z11 = false;
                        z12 = true;
                    } else {
                        z11 = false;
                ...
                } else if (aVar3.b == i22 + 1 && aVar3.d == i21 - i22) {
                    z11 = true;
                    z12 = true;
                } else {
                    z11 = true;
                ...
                if (i25 <= i26) {
                    ...
                    if (i25 < i27) {
                        obj = null;
                        s4.a j11 = m0Var.j(2, i25 + 1, null, i27 - i25);
                ...
                if (i36 < i37) {
                    ...
                    if (i36 < i37 + i38) {
                        aVar3.d = i38 - 1;
                        j3 = m0Var.j(4, aVar2.b, aVar3.c, 1);
                        i12 = aVar2.b;
                        i13 = aVar3.b;
                        if (i12 > i13) {
                            aVar3.b = i13 + 1;
                            ...
                            if (i12 < i39) {
                                int i40 = i39 - i12;
                                j10 = m0Var.j(4, i12 + 1, aVar3.c, i40);
                                aVar3.d -= i40;
                                arrayList.set(i14, aVar2);
                                if (aVar3.d > 0) {
                                    arrayList.set(size, aVar3);
        ...
        int i41 = 0;
        while (i41 < size2) {
            s4.a aVar4 = (s4.a) arrayList.get(i41);
            int i42 = aVar4.a;
            if (i42 == 1) {
                k(aVar4);
            } else if (i42 == i11) {
                ...
                while (i45 < i44) {
                    RecyclerView recyclerView = (RecyclerView) bVar.a;
                    s4.c1 L = recyclerView.L(i45, true);
                    if (L != null) {
                    }
                    L = null;
                    if (L != null || b(i45)) {
                ...
                while (i47 < i48) {
                    ...
                    s4.c1 L2 = recyclerView2.L(i47, true);
                    if (L2 != null) {
                    }
                    L2 = null;
                    if (L2 != null || b(i47)) {
                        if (c12 == 0) {
                            e(j(4, i49, aVar4.c, i50));
                            i49 = i47;
                            i50 = 0;
                        }
                        c12 = 1;
    ...
    */
    public String n() {
        ...
        re.b bVar = re.b.e;
        if (i) {
            o0.b bVar2 = (o0.b) this.f;
            if (bVar2 == null) {
                try {
                    o0.b bVar3 = new o0.b();
                    bVar3.a = new SoftReference(new String[3]);
                    this.f = bVar3;
                } catch (Throwable unused) {
                    i = false;
                }
            } else {
                String[] strArr = (String[]) ((SoftReference) bVar2.a).get();
                if (strArr != null) {
                    str = strArr[0];
                    if (str == null) {
                    ...
                    if (i) {
                        o0.b bVar4 = (o0.b) this.f;
                        String[] strArr2 = (String[]) ((SoftReference) bVar4.a).get();
                        if (strArr2 == null) {
                            strArr2 = new String[3];
                            bVar4.a = new SoftReference(strArr2);
                        }
                        strArr2[0] = str;
                    }
                    return str;
