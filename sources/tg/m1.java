...
public class m1 extends ab implements NotificationCenter.NotificationCenterDelegate {
    ...
    public m1(Context context, int i10, BirthdayController.BirthdayState birthdayState, int i11, f6 f6Var) {
        ...
        h1Var.b.setHintText(LocaleController.getString((!hashSet.isEmpty() || i11 == 1 || i11 == 2 || i11 == 3 || i11 == 4) ? R.string.Search : R.string.GiftPremiumUsersSearchHint), false);
        ...
        if (i11 == 4) {
            ...
            viewGroup4.addView(o20Var, y5.f(-2.0f, 87, i18, 0, i18, 0));
        }
    ...
    public static void Q(m1 m1Var, int i10, f6 f6Var, int i11, View view) {
        ...
        if (view instanceof xg.l) {
            ...
            if (z10 != z11) {
                ...
                o20Var.animate().alpha(z11 ? 1.0f : 0.0f).translationY(z11 ? 0.0f : AndroidUtilities.dp(12.0f)).setInterpolator(qr.h).setDuration(320L).withEndAction(!z11 ? new a1(m1Var, true ? 1 : 0) : null).start();
                ug.g gVar = m1Var.p0;
                boolean z12 = !z11;
                if (gVar.y != z12) {
                    gVar.y = z12;
    ...
    public static void S(final m1 m1Var, final TLRPC.User user, View view) {
        ...
        final int i11 = 1;
        F.c(R.drawable.msg_openprofile, LocaleController.getString(R.string.OpenProfile), new Runnable(m1Var) { // from class: tg.d1
            public final /* synthetic */ m1 b;
    ...
    public static void U(m1 m1Var, String str) {
        ...
        m1Var.x0 = ConnectionsManager.getInstance(m1Var.currentAccount).sendRequest(tL_contacts_search, new m8(m1Var, 21));
    }
    ...
    public static m1 e0(int i10, BirthdayController.BirthdayState birthdayState) {
        ...
        f1 f1Var2 = new f1(R.getContext(), R.getCurrentAccount(), birthdayState, i10, R.getResourceProvider());
        if (!AndroidUtilities.isTablet() && !AndroidUtilities.hasDialogOnTop(R)) {
            f1Var2.makeAttached(R);
        }
        R.showDialog(f1Var2);
        G0 = f1Var2;
        return f1Var2;
    ...
    public final ug.f Y(ug.f fVar) {
        int i10 = this.X;
        if (i10 != 4) {
            fVar.n = i10 == 3 ? null : new vy0(19, this, fVar.c);
            return fVar;
        }
        ...
        final int i11 = 0;
        ?? r22 = new View.OnClickListener(this) { // from class: tg.c1
            public final /* synthetic */ m1 b;
        ...
        final int i12 = 1;
        ?? r32 = new View.OnClickListener(this) { // from class: tg.c1
            public final /* synthetic */ m1 b;
    ...
    public final void g0(boolean z10) {
        ...
        j1Var.setEnabled(hashSet.size() > 0);
    }
    ...
    public final void h0(boolean z10, boolean z11) {
        ...
        if (isEmpty) {
            ...
            if (arrayList4.isEmpty()) {
                ...
                if (!arrayList5.isEmpty()) {
                    ...
                    if (fVar != null && arrayList3.size() > 0 && !hashSet3.isEmpty()) {
                        ...
                        vy0 vy0Var = new vy0(18, this, arrayList3);
                        fVar.h = string4;
                        fVar.m = vy0Var;
                    }
                }
            ...
            if (fVar != null) {
                ...
                vy0 vy0Var2 = new vy0(18, this, arrayList3);
                fVar.h = string42;
                fVar.m = vy0Var2;
            }
        } else {
