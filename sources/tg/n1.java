...
public class n1 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public n1(Context context, int i10, BirthdayController.BirthdayState birthdayState, int i11, f6 f6Var) {
        ...
        q20Var.setBackgroundColor(j6.v0(i12, f6Var));
        if (i11 == 4) {
        ...
        if (i11 == 4) {
            ...
            viewGroup4.addView(q20Var, x5.f(-2.0f, 87, i18, 0, i18, 0));
        }
        ...
        if (view instanceof xg.l) {
            ...
            if (i10 == 0 || i10 == 2) {
                if (UserObject.areGiftsDisabled(j3)) {
                    new vc(n1Var.container, f6Var).Q(R.raw.error, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserDisallowedGifts, DialogObject.getShortName(j3)))).j();
                    return;
                }
            ...
            if (z10 != z11) {
                ...
                q20Var.animate().alpha(z11 ? 1.0f : 0.0f).translationY(z11 ? 0.0f : AndroidUtilities.dp(12.0f)).setInterpolator(qr.h).setDuration(320L).withEndAction(!z11 ? new b1(n1Var, true ? 1 : 0) : null).start();
                ug.g gVar = n1Var.p0;
                boolean z12 = !z11;
                if (gVar.y != z12) {
                    gVar.y = z12;
                        ...
                        if (user2 != null) {
                            ...
                            if (o2Var != null) {
                                ...
                                if (U != null) {
                                    ...
                                    U.showAsSheet(new bo(bundle2), m2Var);
                                    break;
                                }
                            }
                        }
    ...
    public final ug.f Y(ug.f fVar) {
        int i10 = this.X;
        if (i10 != 4) {
            fVar.n = i10 == 3 ? null : new xy0(19, this, fVar.c);
            return fVar;
        }
    ...
    */
    public final void h0(boolean z10, boolean z11) {
        ...
        if (isEmpty) {
            if (this.E0 && i14 == 3) {
                if (this.y0 == null) {
                    pq pqVar = new pq(j6.K(AndroidUtilities.dp(46.0f), j6.v0(j6.Oh, this.resourcesProvider)), getContext().getResources().getDrawable(R.drawable.mini_gram_72).mutate());
            ...
            if (arrayList4.isEmpty()) {
                ...
                if (!arrayList5.isEmpty()) {
                    ...
                    if (fVar != null && arrayList3.size() > 0 && !hashSet3.isEmpty()) {
                        ...
                        xy0 xy0Var = new xy0(18, this, arrayList3);
                        fVar.h = string4;
                        fVar.m = xy0Var;
                    }
                }
            ...
            if (fVar != null) {
                ...
                xy0 xy0Var2 = new xy0(18, this, arrayList3);
                fVar.h = string42;
                fVar.m = xy0Var2;
            }
        } else {
    ...
    public final void i0(boolean r10, boolean r11) {
        ...
        L8:
            ...
            if (r5 == 0) goto L54
            int r5 = androidx.recyclerview.widget.RecyclerView.S(r4)
            int r6 = r5 + (-1)
            if (r6 < 0) goto L54
