...
public abstract class t {
    ...
    public static void d(MessageObject messageObject, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        connectionsManager.sendRequest(tL_payments_getGiveawayInfo, new q(callback2, callback, 1));
    }
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, o2 o2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (h()) {
            ...
            BillingController.getInstance().queryProductDetails(Arrays.asList(aVar.a()), new org.telegram.ui.Components.d1(tL_inputStorePaymentPremiumGiftCode, tL_premiumGiftCodeOption, connectionsManager, callback2, callback, o2Var, 2));
            return;
        }
        ...
        JSONObject p5 = k3.p(o2Var.getResourceProvider(), false);
        if (p5 != null) {
        ...
        connectionsManager2.sendRequest(tL_payments_getPaymentForm, new kd(callback2, messagesController2, tL_inputInvoicePremiumGiftCode, o2Var, callback, 13));
    }
