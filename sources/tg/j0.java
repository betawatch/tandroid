...
public final class j0 extends rg.k1 {
    ...
    public final void W(ub1 ub1Var) {
        ...
        ub1Var.addView(view, y5.k(0.0f, arrayList.size() == 1 ? 28.0f : 34.0f, 0.0f, arrayList.size() == 1 ? 9.0f : 14.0f, -1, arrayList.size() == 1 ? 94 : 83));
    }
