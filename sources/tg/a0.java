...
public final class a0 extends ab implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void Q(a0 a0Var, n2 n2Var, View view) {
        ...
        if (view instanceof vg.u) {
            ...
            if (a0Var.j0 == selectedType2 && (eVar = a0Var.r0) != null) {
                ((z0) eVar.b).V(3, a0Var.e0);
                ((m) eVar.c).b.E(1);
            }
        ...
        gVar.setFormatter(new s0.b(12));
        gVar.setOnValueChangedListener(u4Var);
        hVar.setMinValue(0);
        hVar.setMaxValue(11);
        hVar.setValue(0);
        hVar.setFormatter(new s0.b(13));
            ...
            if (!Y()) {
                ...
                if (i11 != i10 || this.i0 == 0) {
                    ...
                    if (Y()) {
                        ...
                        sb2.append(this.h0 != 3 ? org.telegram.messenger.l0.g(R.string.BoostingStoriesFeaturesAndTerms, new StringBuilder("\n\n")) : "");
