...
public final class a0 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void P(a0 a0Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j3, n2 n2Var) {
        int i10;
        String str;
        ...
        if (i11 == 3) {
            ...
            ConnectionsManager.getInstance(i16).sendRequest(tL_payments_getPaymentForm, new ai.t5(y3, m0Var, tL_inputInvoiceStars, 26));
            return;
        }
        int i19 = 5;
        if (a0Var.i0 == 1) {
                ...
                if (tL_premiumGiftCodeOption.months == a0Var.l0 && arrayList3.size() > 0) {
                    if (s.h()) {
                        ...
                        if (tL_premiumGiftCodeOption.store_product == null) {
                            ...
                            alertDialog$Builder2.k(LocaleController.getString("OK", R.string.OK), new s9.b(i19));
            ...
            if (tL_premiumGiftCodeOption3.months == a0Var.l0) {
                if (s.h()) {
                    ...
                    if (tL_premiumGiftCodeOption3.store_product == null) {
                        ...
                        alertDialog$Builder3.h(LocaleController.getString("Cancel", R.string.Cancel), new s9.b(i19));
                ...
                connectionsManager2.sendRequest(tL_payments_getPaymentForm2, new kd(vVar3, messagesController2, tL_inputInvoicePremiumGiftCode, n2Var, vVar2, 12));
                return;
            }
            i23++;
            str2 = str2;
    ...
    public static void Q(a0 a0Var, n2 n2Var, View view) {
        ...
        c4 c4Var = new c4(context, c5Var2, dd0Var, gVar, hVar);
        ...
        in0Var.setOnClickListener(new org.telegram.ui.Components.m0(calendar, dd0Var, gVar, hVar, uVar, a3Var));
        a3Var.b(c4Var);
        f3 f3Var = a3Var.a;
        f3Var.show();
        int i21 = c5Var.b;
    ...
    */
    public final void a0(boolean z10, boolean z11) {
        ...
        if (i14 == 3) {
            ...
            if (!Y()) {
                i10 = 3;
                arrayList.add(ug.a.c(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.BoostingStoriesFeaturesAndTerms), j6.gc, 0, new t(this, i10), this.resourcesProvider), true));
                i11 = this.h0;
                int i34 = vg.d.s;
                if (i11 != i10 || this.i0 == 0) {
                    ...
                    if (Y()) {
                        ...
                        sb2.append(this.h0 != 3 ? org.telegram.messenger.q.h(R.string.BoostingStoriesFeaturesAndTerms, new StringBuilder("\n\n")) : "");
                        arrayList.add(ug.a.c(AndroidUtilities.replaceSingleTag(sb2.toString(), j6.gc, 0, new t(this, 4), this.resourcesProvider), true));
                    }
                }
                bVar = this.g0;
                if (bVar != null && z11) {
