...
public final class b0 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public b0(o2 o2Var, long j3, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        super(o2Var, false);
        ...
        this.d.setOnItemClickListener(new o6(23, this, o2Var));
        ...
        this.q0 = aVar;
        aVar.setOnClickListener(new jr(this, prepaidGiveaway, j3, o2Var));
        Z(false);
    ...
    public static void P(b0 b0Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j3, o2 o2Var) {
        int i10;
        String str;
        ...
        if (b0Var.Y()) {
            ...
            c2Var.R = string;
            c2Var.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.BoostingStartGiveawayConfirmText));
            alertDialog$Builder.k(LocaleController.getString(R.string.Start), new r5.d(t2Var, 7));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new t0.a(6));
        ...
        if (i11 == 3) {
            ...
            int i15 = vg.u.s;
            boolean z10 = i14 == 1;
            v5 y3 = v5.y(b0Var.currentAccount, false);
            int l4 = t.l(b0Var.m0);
            ...
            ConnectionsManager.getInstance(i16).sendRequest(tL_payments_getPaymentForm, new t5(y3, m0Var, tL_inputInvoiceStars, 26));
            return;
        }
        if (b0Var.i0 == 1) {
                ...
                if (tL_premiumGiftCodeOption.months == b0Var.l0 && arrayList3.size() > 0) {
                    if (t.h()) {
                        ...
                        if (tL_premiumGiftCodeOption.store_product == null) {
                            ...
                            c2Var2.R = string2;
                            c2Var2.T = AndroidUtilities.replaceTags(LocaleController.formatPluralString("BoostingReduceUsersTextPlural", i21, join));
                            alertDialog$Builder2.k(LocaleController.getString("OK", R.string.OK), new t0.a(i13));
                            alertDialog$Builder2.o();
                            return;
                        }
                    }
                    aVar.b(true);
                    t.k(arrayList3, tL_premiumGiftCodeOption, b0Var.b0, null, o2Var, new w(b0Var, 0), new w(b0Var, 1));
                    return;
                }
            }
            return;
            ...
            if (tL_premiumGiftCodeOption3.months == b0Var.l0) {
                if (t.h()) {
                    ...
                    if (tL_premiumGiftCodeOption3.store_product == null) {
                        ...
                        c2 c2Var3 = alertDialog$Builder3.a;
                        c2Var3.R = string3;
                        c2Var3.T = AndroidUtilities.replaceTags(LocaleController.formatPluralString("BoostingReduceQuantityTextPlural", i27, formatPluralString, Integer.valueOf(i28)));
                        alertDialog$Builder3.k(LocaleController.getString("Reduce", R.string.Reduce), new d(1, wVar, tL_premiumGiftCodeOption5));
                        alertDialog$Builder3.h(LocaleController.getString("Cancel", R.string.Cancel), new t0.a(i13));
                ...
                if (t.h()) {
                    ...
                    BillingController.getInstance().queryProductDetails(Arrays.asList(aVar3.a()), new org.telegram.ui.Components.d1(tL_inputStorePaymentPremiumGiveaway, tL_premiumGiftCodeOption3, connectionsManager, wVar3, wVar2, o2Var, 3));
                    return;
                }
                ...
                JSONObject p10 = k3.p(o2Var.getResourceProvider(), false);
                if (p10 != null) {
                ...
                connectionsManager2.sendRequest(tL_payments_getPaymentForm2, new kd(wVar3, messagesController2, tL_inputInvoicePremiumGiftCode, o2Var, wVar2, 12));
                return;
            }
        }
    }

    public static void Q(b0 b0Var, o2 o2Var, View view) {
        a5 a5Var;
        o0.a aVar;
        ...
        uc0Var.setTag("DAY");
        uc0Var.setFormatter(new z20(currentTimeMillis, calendar, i17, 1));
        u4 u4Var = new u4(a4Var, iVar, jVar, i19, i20, uc0Var);
        uc0Var.setOnValueChangedListener(u4Var);
        iVar.setMinValue(0);
        iVar.setMaxValue(23);
        linearLayout.addView(iVar, x5.l(0.2f, 0, 270));
        iVar.setFormatter(new t0.a(4));
        iVar.setOnValueChangedListener(u4Var);
        jVar.setMinValue(0);
        jVar.setMaxValue(11);
        jVar.setValue(0);
        jVar.setFormatter(new t0.a(5));
        ...
        jn0Var.setPadding(AndroidUtilities.dp(34.0f), 0, AndroidUtilities.dp(34.0f), 0);
        jn0Var.setGravity(17);
        jn0Var.setTextColor(a5Var.g);
        jn0Var.setTextSize(1, 14.0f);
        jn0Var.setTypeface(AndroidUtilities.bold());
        jn0Var.setBackground(z5.e(new float[]{8.0f}, a5Var.h));
        jn0Var.setText(LocaleController.getString("BoostingConfirm", R.string.BoostingConfirm));
        a4Var.addView(jn0Var, x5.t(-1, 48, 83, 16, 15, 16, 16));
        jn0Var.setOnClickListener(new org.telegram.ui.Components.m0(calendar, uc0Var, iVar, jVar, vVar, b3Var));
        b3Var.b(a4Var);
        g3 g3Var = b3Var.a;
        g3Var.show();
        int i21 = a5Var.b;
    ...
    */
    public final void a0(boolean z10, boolean z11) {
        ...
        if (i14 == 3) {
            ...
            if (!Y()) {
                i10 = 3;
                arrayList.add(ug.a.c(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.BoostingStoriesFeaturesAndTerms), j6.gc, 0, new u(this, i10), this.resourcesProvider), true));
                i11 = this.h0;
                int i34 = vg.d.s;
                if (i11 != i10 || this.i0 == 0) {
                    ...
                    if (Y()) {
                        ...
                        arrayList.add(ug.a.c(AndroidUtilities.replaceSingleTag(sb2.toString(), j6.gc, 0, new u(this, 4), this.resourcesProvider), true));
                    }
                }
                bVar = this.g0;
                if (bVar != null && z11) {
