...
public abstract class l {
    ...
    public static void d(Handler handler) {
        ...
        if (myLooper != handler.getLooper()) {
            throw new IllegalStateException(pa.j("Must be called on ", handler.getLooper().getThread().getName(), " thread, but got ", myLooper != null ? myLooper.getThread().getName() : "null current looper", "."));
        }
    }
