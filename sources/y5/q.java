...
public abstract class q {
    ...
    public static String a(Context context) {
        ...
        try {
            Context context2 = h6.b.a(context).a;
    ...
    public static String c(Context context, int i10) {
        ...
        if (i10 == 2) {
            return f6.b.f(context) ? resources.getString(org.telegram.messenger.beta.R.string.common_google_play_services_wear_update_text) : resources.getString(org.telegram.messenger.beta.R.string.common_google_play_services_update_text, a2);
        }
        if (i10 == 3) {
    ...
    public static String f(Context context, String str) {
        ...
        synchronized (kVar) {
            try {
                Locale locale = h7.w.a(context.getResources().getConfiguration()).a.get(0);
                if (!locale.equals(b)) {
                    kVar.clear();
                    b = locale;
                }
