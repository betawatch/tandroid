...
public class e {
    ...
    public Intent b(Context context, String str, int i9) {
        if (i9 != 1 && i9 != 2) {
            if (i9 != 3) {
                return null;
            }
        ...
        if (context != null && e6.b.f(context)) {
            int i11 = k0.a;
        ...
        if (context != null) {
            try {
                sb2.append(g6.c.a(context).b(0, context.getPackageName()).versionCode);
            } catch (PackageManager.NameNotFoundException unused) {
            }
        }
