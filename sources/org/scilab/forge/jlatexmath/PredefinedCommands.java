...
final class PredefinedCommands {
    static {
        ...
        MacroInfo.Commands.put("big", new PredefMacroInfo(ImageReceiver.DEFAULT_CROSSFADE_DURATION, 1));
        ...
        MacroInfo.Commands.put("hphantom", new PredefMacroInfo(MessagesStorage.LAST_DB_VERSION, 1));
        ...
        MacroInfo.Commands.put("jlmTextitbf", new PredefMacroInfo(VoIPService.ID_INCOMING_CALL_PRENOTIFICATION, 1));
        ...
        MacroInfo.Commands.put("sc", new PredefMacroInfo(MediaDataController.MAX_LINKS_COUNT, 0));
