...
public class FontInfo {
    ...
    public int[] getExtension(char c) {
        HashMap hashMap = this.unicode;
        if (hashMap == null) {
            return this.extensions[c];
        }
        return this.extensions[((Character) hashMap.get(Character.valueOf(c))).charValue()];
    }
    ...
    public float[] getMetrics(char c) {
        ...
        return this.metrics[((Character) hashMap.get(Character.valueOf(c))).charValue()];
    }
    ...
    public CharFont getNextLarger(char c) {
        ...
        return this.nextLarger[((Character) hashMap.get(Character.valueOf(c))).charValue()];
    }
