...
public class FontInfo {
    ...
    public int[] getExtension(char c) {
        ...
        return this.extensions[hashMap.get(Character.valueOf(c)).charValue()];
    }
    ...
    public float[] getMetrics(char c) {
        ...
        return this.metrics[hashMap.get(Character.valueOf(c)).charValue()];
    }
    ...
    public CharFont getNextLarger(char c) {
        ...
        return this.nextLarger[hashMap.get(Character.valueOf(c)).charValue()];
    }
