...
public class XLeftRightArrowFactory {
    ...
    public static Box create(TeXEnvironment teXEnvironment, float f9) {
        float f10 = 0.0f;
        if (Float.isInfinite(f9) || Float.isNaN(f9) || f9 < 0.0f) {
            f9 = 0.0f;
        }
        float min = Math.min(f9, 4096.0f);
        ...
        while (true) {
            if (f10 >= (min - width3) - width2) {
                horizontalBox2.add(new ScaleBox(createBox3, (r4 - f10) / createBox3.getWidth(), 1.0d));
    ...
    public static Box create(boolean z10, TeXEnvironment teXEnvironment, float f9) {
        float f10;
        float min = Math.min((Float.isInfinite(f9) || Float.isNaN(f9) || f9 < 0.0f) ? 0.0f : f9, 4096.0f);
        ...
        float width4 = (f10 - f11) / createBox2.getWidth();
        float f12 = (-2.0f) * width4;
        horizontalBox.add(new SpaceAtom(5, f12, 0.0f, 0.0f).createBox(teXEnvironment));
        ...
        if (z10) {
            ...
            horizontalBox.add(new SpaceAtom(5, f12 - 2.0f, 0.0f, 0.0f).createBox(teXEnvironment));
