...
public class XLeftRightArrowFactory {
    ...
    public static Box create(boolean z10, TeXEnvironment teXEnvironment, float f7) {
        float f10;
        float min = Math.min((Float.isInfinite(f7) || Float.isNaN(f7) || f7 < 0.0f) ? 0.0f : f7, 4096.0f);
