...
public class DefaultTeXFont implements TeXFont {
    ...
    private Char getChar(char c10, CharFont[] charFontArr, int i9) {
        ...
        return charFont == null ? getDefaultChar(c10, i9) : getChar(new CharFont((char) (charFont.c + i10), charFont.fontId), i9);
    }
    ...
    public static float getSizeFactor(int i9) {
        ...
        return i9 < 4 ? generalSettings.get("textfactor").floatValue() : i9 < 6 ? generalSettings.get("scriptfactor").floatValue() : generalSettings.get("scriptscriptfactor").floatValue();
    }
    ...
    public Char getDefaultChar(char c10, int i9) {
        return (c10 < '0' || c10 > '9') ? (c10 < 'a' || c10 > 'z') ? getChar(c10, defaultTextStyleMappings[1], i9) : getChar(c10, defaultTextStyleMappings[2], i9) : getChar(c10, defaultTextStyleMappings[0], i9);
    }
    ...
    public float getKern(CharFont charFont, CharFont charFont2, int i9) {
        ...
        if (i10 == charFont2.fontId) {
            return fontInfo[i10].getKern(charFont.c, charFont2.c, getSizeFactor(i9) * TeXFormula.PIXELS_PER_POINT);
        }
        return 0.0f;
    }
    ...
    public CharFont getLigature(CharFont charFont, CharFont charFont2) {
        ...
        if (i9 == charFont2.fontId) {
            return fontInfo[i9].getLigature(charFont.c, charFont2.c);
        }
        return null;
    }
    ...
    public Char getNextLarger(Char r52, int i9) {
        ...
        return new Char(nextLarger.c, fontInfo[nextLarger.fontId].getFont(), nextLarger.fontId, getMetrics(nextLarger, getSizeFactor(i9)));
    }
    ...
    public float getSpace(int i9) {
        return fontInfo[generalSettings.get(DefaultTeXFontParser.SPACEFONTID_ATTR).intValue()].getSpace(getSizeFactor(i9) * TeXFormula.PIXELS_PER_POINT);
    }
    ...
    public Char getChar(CharFont charFont, int i9) {
        ...
        if (z10 && charFont.fontId == charFont.boldFontId) {
            ...
            charFont = new CharFont(charFont.c, i10, i9);
        }
        if (this.isRoman) {
        ...
        return new Char(charFont.c, fontInfo2.getFont(), i10, getMetrics(charFont, this.factor * sizeFactor));
    }
