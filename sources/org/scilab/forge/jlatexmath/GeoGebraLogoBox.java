...
public class GeoGebraLogoBox extends Box {
    ...
    public GeoGebraLogoBox(float f9, float f10) {
        this.depth = 0.0f;
        this.height = f10;
        this.width = f9;
        this.shift = 0.0f;
    ...
    private static void drawCircle(Graphics2D graphics2D, float f9, float f10) {
    ...
    public void draw(Graphics2D graphics2D, float f9, float f10) {
        ...
        graphics2D.translate(w.d(f11, 0.25f, 2.15f, f9), f10 - (f11 * 0.81395346f));
