...
public class OverUnderBox extends Box {
    ...
    public OverUnderBox(Box box, Box box2, Box box3, float f10, boolean z4) {
        ...
        float f11 = 0.0f;
        this.height = box.height + (z4 ? box2.getWidth() : 0.0f) + ((!z4 || box3 == null) ? 0.0f : box3.height + box3.depth + f10);
        float width = box.depth + (z4 ? 0.0f : box2.getWidth());
        if (!z4 && box3 != null) {
    ...
    public void draw(Graphics2D graphics2D, float f10, float f11) {
        ...
        graphics2D.translate(((this.del.getHeight() + this.del.depth) * 0.75d) + f10, f12);
        graphics2D.rotate(1.5707963267948966d);
        this.del.draw(graphics2D, 0.0f, 0.0f);
