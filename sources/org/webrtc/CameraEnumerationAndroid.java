...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size(NotificationCenter.audioRecordTooShort, 120), new Size(NotificationCenter.profileMusicUpdated, NotificationCenter.audioRecordTooShort), new Size(NotificationCenter.nearEarEvent, NotificationCenter.profileMusicUpdated), new Size(400, NotificationCenter.profileMusicUpdated), new Size(480, NotificationCenter.nearEarEvent), new Size(640, 360), new Size(640, 480), new Size(768, 480), new Size(854, 480), new Size(800, 600), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, 600), new Size(1280, 720), new Size(1280, 1024), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)));
    ...
    public static class CaptureFormat {
        ...
        public int hashCode() {
            return (((this.width * 65497) + this.height) * NotificationCenter.didSetNewTheme) + 1 + this.framerate.hashCode();
        }
    }
