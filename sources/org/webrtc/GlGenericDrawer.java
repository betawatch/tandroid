...
public class GlGenericDrawer implements RendererCommon.GlDrawer {
    ...
    public static String createFragmentShaderString(String str, int i10, boolean z4) {
    ...
    private void prepareShader(int i10, float[] fArr, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        if (z4) {
            GLES20.glUniform1f(this.texelLocation[i10][0], i17 == 1 ? 1.0f / i11 : 0.0f);
            GLES20.glUniform1f(this.texelLocation[i10][1], i17 == 2 ? 1.0f / i12 : 0.0f);
        }
    ...
    public GlShader createShader(int i10, boolean z4) {
        return new GlShader(this.vertexShader, createFragmentShaderString(this.genericFragmentSource, i10, z4));
    }

    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawOes(int i10, int i11, int i12, int i13, int i14, float[] fArr, int i15, int i16, int i17, int i18, int i19, int i20, boolean z4) {
        if (!z4) {
    ...
    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawRgb(int i10, int i11, int i12, int i13, int i14, float[] fArr, int i15, int i16, int i17, int i18, int i19, int i20, boolean z4) {
    ...
    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawYuv(int[] iArr, int i10, int i11, int i12, int i13, float[] fArr, int i14, int i15, int i16, int i17, int i18, int i19, boolean z4) {
        if (!z4 || i10 <= 0 || i11 <= 0) {
        ...
        prepareShader(1, this.renderMatrix, i12 != i10 ? i24 : i25, i12 != i10 ? i25 : i24, i14, i15, i18, i19, 1);
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, this.renderTexture[1]);
        GLES20.glBindFramebuffer(36160, this.renderFrameBuffer[0]);
        GLES20.glFramebufferTexture2D(36160, 36064, 3553, this.renderTexture[0], 0);
        ...
        GLES20.glBindFramebuffer(36160, 0);
        GLES20.glViewport(i16, i17, i18, i19);
        prepareShader(1, fArr, i12 != i10 ? i24 : i25, i12 != i10 ? i25 : i24, i14, i15, i18, i19, 2);
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, this.renderTexture[0]);
        GLES20.glDrawArrays(5, 0, 4);
    }
