...
class Camera1Session implements CameraSession {
    ...
    private Camera1Session(CameraSession.Events events, boolean z10, Context context, SurfaceTextureHelper surfaceTextureHelper, int i10, Camera camera, Camera.CameraInfo cameraInfo, CameraEnumerationAndroid.CaptureFormat captureFormat, long j3) {
    ...
    public int getFrameOrientation() {
        int orientation = d2.W != null ? 0 : this.orientationHelper.getOrientation();
    ...
    public /* synthetic */ void lambda$listenForTextureFrames$0(VideoFrame videoFrame) {
        ...
        VideoFrame videoFrame2 = new VideoFrame(c.a((TextureBufferImpl) videoFrame.getBuffer(), this.info.facing == 1, 0), getFrameOrientation(), videoFrame.getTimestampNs());
        this.events.onFrameCaptured(this, videoFrame2);
        videoFrame2.release();
    }

    private void listenForBytebufferFrames() {
        this.camera.setPreviewCallbackWithBuffer(new 2());
    }
