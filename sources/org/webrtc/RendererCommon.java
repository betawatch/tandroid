...
public class RendererCommon {
    ...
    public static class VideoLayoutMeasure {
        ...
        */
        public Point measure(boolean z10, int i10, int i11, int i12, int i13) {
            ...
            Point displaySize = RendererCommon.getDisplaySize(((f9 > 1.0f ? 1 : (f9 == 1.0f ? 0 : -1)) > 0) == ((f10 > 1.0f ? 1 : (f10 == 1.0f ? 0 : -1)) > 0) ? this.visibleFractionMatchOrientation : this.visibleFractionMismatchOrientation, f9, defaultSize, defaultSize2);
            if (!z10) {
    ...
    public static Point getDisplaySize(ScalingType scalingType, float f9, int i10, int i11) {
        return getDisplaySize(convertScalingTypeToVisibleFraction(scalingType), f9, i10, i11);
    }

    public static float[] getLayoutMatrix(boolean z10, float f9, float f10) {
        float f11;
        float f12;
        if (f10 > f9) {
            f12 = f9 / f10;
    ...
    public static Point getDisplaySize(float f9, float f10, int i10, int i11) {
        return (f9 == 0.0f || f10 == 0.0f) ? new Point(i10, i11) : new Point(Math.min(i10, Math.round((i11 / f9) * f10)), Math.min(i11, Math.round((i10 / f9) / f10)));
    }
}
