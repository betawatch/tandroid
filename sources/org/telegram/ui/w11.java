...
public final class w11 extends org.telegram.ui.Components.vl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        switch (i13) {
            ...
            case 5:
                ...
                x11Var.setChecked(SharedConfig.currentProxy == proxyInfo);
                boolean contains = arrayList.contains(arrayList2.get(i10 - proxyListActivity.n));
                x11Var.h = contains;
                x11Var.f.a(contains, false);
    ...
    public final void w(s4.c1 c1Var, int i10, List list) {
        ...
        if (i12 == 5 && !list.isEmpty()) {
            x11 x11Var = (x11) view;
            if (list.contains(1) && (contains = arrayList.contains(proxyListActivity.G.get(i10 - proxyListActivity.n))) != x11Var.h) {
                x11Var.h = contains;
                x11Var.f.a(contains, true);
            }
            if (list.contains(2)) {
