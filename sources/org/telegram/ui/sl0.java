...
public final class sl0 extends FrameLayout {
    ...
    public /* synthetic */ sl0(Context context, EditTextBoldCursor editTextBoldCursor, int i10) {
        super(context);
        this.a = i10;
    ...
    public final void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            default:
                super.onMeasure(i10, i11);
                org.telegram.ui.Components.ri0 ri0Var = ((org.telegram.ui.Components.yh0) this.d).h;
                float measuredHeight = (r0.f / 768.0f) * ((org.telegram.ui.Components.ce) this.b).getMeasuredHeight();
