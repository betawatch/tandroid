...
public abstract class g31 extends FrameLayout {
    ...
    public final void b() {
        ...
        if (SharedConfig.animationsEnabled()) {
            ...
            this.h.setInterpolator(org.telegram.ui.Components.er.f);
            this.h.start();
            return;
        }
        this.e = 0.0f;
    ...
    public final void g() {
        ...
        ix ixVar = this.a;
        if (ixVar != null) {
            ixVar.setPreviewOpenedProgress(this.e);
        }
        invalidate();
    }
        ...
        if (motionEvent != null && motionEvent.getAction() == 0) {
            ...
            if (this.E) {
                ...
                if (f11 >= getMeasuredWidth() / 3.0f || (xVelocity >= 3500.0f && xVelocity >= yVelocity)) {
                    ...
                    this.h = ofFloat;
                    ofFloat.addUpdateListener(new d31(this, 2));
                    this.h.addListener(new f31(this, i10));
                    this.h.setDuration(250L);
                    this.h.setInterpolator(org.telegram.ui.Components.er.f);
                    this.h.start();
    ...
    public void setTransitionPaddingBottom(int i10) {
        ...
        if (com.google.android.recaptcha.internal.a.u(ixVar)) {
            float f10 = i10;
            ixVar.T0 = f10;
            ixVar.h.setTranslationY(((-f10) - ixVar.a1) - ixVar.Z0);
        }
    }
