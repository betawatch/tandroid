...
public final class e70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View createView(Context context) {
        ...
        frameLayout.addView(this.f, h7.z5.c(-1.0f, -1));
        ...
        this.f.addView(frameLayout2, h7.z5.l(50.0f, -1, -1));
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.FIT_XY);
        frameLayout2.addView(imageView, h7.z5.c(-1.0f, -1));
        n0 n0Var = new n0(this, context, 8);
        this.d = n0Var;
        n0Var.setBackgroundColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false));
        this.f.addView(this.d, h7.z5.l(50.0f, -1, -1));
        LinearLayout linearLayout2 = new LinearLayout(context);
        this.e = linearLayout2;
        linearLayout2.setOrientation(1);
        this.e.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
        this.d.addView(this.e, h7.z5.e(-2, -2, 17));
        ...
        this.e.addView(this.b, h7.z5.q(-2, -2, 1));
        TextView textView2 = new TextView(context);
        this.a = textView2;
        textView2.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, i10, false));
        this.a.setLinkTextColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.J6, false));
        this.a.setTextSize(1, 16.0f);
        this.a.setLinksClickable(true);
        this.a.setClickable(true);
        this.a.setGravity(17);
        this.a.setMovementMethod(new org.telegram.ui.Components.av(1));
        this.e.addView(this.a, h7.z5.e(-2, -2, 1));
        TextView textView3 = new TextView(context);
        this.c = textView3;
        textView3.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, i10, false));
        this.c.setGravity(17);
        this.c.setTextSize(1, 32.0f);
        this.d.addView(this.c, h7.z5.c(-2.0f, -2));
        ...
        if (encryptedChat != null) {
            ...
            if (indexOf != -1) {
                spannableStringBuilder.setSpan(new org.telegram.ui.Components.t41(LocaleController.getString(R.string.EncryptionKeyLink), null), indexOf, indexOf + 12, 33);
            }
        ...
        this.c.setTag(Integer.valueOf(org.telegram.ui.ActionBar.g6.Me));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.d, 1, null, null, null, null, org.telegram.ui.ActionBar.g6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 2, null, null, null, null, org.telegram.ui.ActionBar.g6.J6));
        return arrayList;
    }
