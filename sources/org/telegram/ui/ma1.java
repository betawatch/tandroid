...
public final class ma1 extends LinearLayout {
    ...
    public final void b() {
        ...
        while (true) {
            ...
            this.c[i10].setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.z6, false));
    ...
    public void setData(oa1 oa1Var) {
        TextView[] textViewArr = this.a;
        textViewArr[0].setText(oa1Var.b);
        textViewArr[1].setText(oa1Var.f);
        textViewArr[2].setText(oa1Var.j);
        textViewArr[3].setText(oa1Var.n);
        TextView[] textViewArr2 = this.b;
        textViewArr2[0].setText(oa1Var.c);
        textViewArr2[0].setTag(Integer.valueOf(oa1Var.d ? org.telegram.ui.ActionBar.h6.x6 : org.telegram.ui.ActionBar.h6.p7));
        textViewArr2[1].setText(oa1Var.g);
        textViewArr2[1].setTag(Integer.valueOf(oa1Var.h ? org.telegram.ui.ActionBar.h6.x6 : org.telegram.ui.ActionBar.h6.p7));
        textViewArr2[2].setText(oa1Var.k);
        textViewArr2[2].setTag(Integer.valueOf(oa1Var.l ? org.telegram.ui.ActionBar.h6.x6 : org.telegram.ui.ActionBar.h6.p7));
        textViewArr2[3].setText(oa1Var.o);
        textViewArr2[3].setTag(Integer.valueOf(oa1Var.p ? org.telegram.ui.ActionBar.h6.x6 : org.telegram.ui.ActionBar.h6.p7));
        TextView[] textViewArr3 = this.c;
        textViewArr3[0].setText(oa1Var.a);
        textViewArr3[1].setText(oa1Var.e);
        textViewArr3[2].setText(oa1Var.i);
        textViewArr3[3].setText(oa1Var.m);
        b();
    }
}
