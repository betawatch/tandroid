    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockparagraph != null) {
            ...
            if (this.f.text instanceof TL_iv.textMath) {
                ...
                k4 k4Var = this.b;
                a2 = (k4Var == null || !k4Var.C) ? Layout.Alignment.ALIGN_NORMAL : org.telegram.ui.Components.tv0.a();
            }
            Layout.Alignment alignment = a2;
            TL_iv.RichText richText = this.f.text;
            d70 d70Var2 = this.a;
            d70Var2.getClass();
            f3 p6 = m4.p(d70Var2, this, null, richText, (size - AndroidUtilities.dp(18)) - this.d, this.e, this.f, alignment, 0, this.b);
            this.c = p6;
            if (p6 != null) {
