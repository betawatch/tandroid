...
public final class lg1 implements org.telegram.ui.Components.jl0 {
    ...
    public final void d(int i10, View view) {
        ...
        if (((ng1) arrayList.get(i10)).a == 1) {
            Bundle bundle = new Bundle();
            bundle.putLong("chat_id", -og1Var.c);
