...
public abstract class gu0 extends NestedScrollView {
    ...
    public gu0(Context context, ju0 ju0Var, FrameLayout frameLayout) {
        ...
        o1.k kVar = new o1.k(ju0Var, o1.h.n, 0.0f);
        this.a0 = kVar;
        kVar.u.b(100.0f);
        kVar.j = 1.0f;
        kVar.b(new nd0(this, i10));
    ...
    */
    public final void H(int i10, int i11) {
        ...
        if (i10 != 0 && i11 != 0) {
            ju0 ju0Var = this.n0;
            TextView currentView = ju0Var.getCurrentView();
