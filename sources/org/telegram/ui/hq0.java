    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                org.telegram.ui.Components.sf0.l0.k(true, true);
                break;
            case 1:
            ...
            case 7:
                ...
                break;
            case 8:
                org.telegram.ui.Components.ge0 ge0Var = this.b.y1;
                uf.e eVar = ge0Var.c;
                eVar.b(0.0f);
            ...
            case 21:
                ...
                if (photoViewer19.r0.isEnabled() && AndroidUtilities.checkInlinePermissions(photoViewer19.y) && !org.telegram.ui.Components.sf0.l0.L && photoViewer19.L3) {
                    if (!photoViewer19.p4) {
                        photoViewer19.G3 = false;
                        photoViewer19.h3();
                        break;
                    } else {
                        ht0 ht0Var = photoViewer19.b0;
                        if (ht0Var != null) {
                            if ((!ht0Var.x || !"inapp".equals(MessagesController.getInstance(ht0Var.a).youtubePipType)) && photoViewer19.b0.e()) {
                                photoViewer19.G3 = false;
            ...
            case 25:
                ...
                if (!photoViewer23.Q4.isPopupShown()) {
                    ...
                    if (m61Var2 != null && photoViewer23.Q4.videoWasPlaying) {
                        m61Var2.D();
                        break;
                    }
                } else {
                    ...
                    videoAds.videoWasPlaying = m61Var3 != null ? m61Var3.z() : true;
            ...
            case 26:
                ...
                org.telegram.ui.ActionBar.n2 n2Var = photoViewer24.i4;
                if (n2Var != null) {
