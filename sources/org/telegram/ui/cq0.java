...
public final class cq0 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean a0;
    public final yh.n5 b;
    public i0.b b0;
    public final yh.n5 c;
    public yf.b0 c0;
    public j0 d;
    ...
    public cq0() {
        ...
        this.w = new org.telegram.ui.ActionBar.g5(0, false, false, this.resourceProvider);
        this.x = new org.telegram.ui.ActionBar.g5(0, false, true, this.resourceProvider);
    }
    ...
    public static void U(cq0 cq0Var, boolean[] zArr, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, ap0 ap0Var, yh.d3 d3Var, nf.e eVar) {
        zArr[0] = true;
        eVar.d();
        yh.v5.x(cq0Var.currentAccount, d3Var.a).h(d3Var.b, tL_starGiftUnique, j3, null, true, new ai.m0(18, eVar, ap0Var));
    }
    ...
    */
    public final void E0() {
        ...
        if (this.H != null) {
            ...
            if (z10) {
                ...
                wp0 wp0Var = this.h;
                if (wp0Var.h >= 0) {
                    org.telegram.ui.Components.vc.a0(this.H).L(xp0.a(this.currentAccount, this.h.h), LocaleController.getString(z11 ? R.string.ChannelColorApplied : R.string.UserColorApplied)).j();
                } else {
                    if (wp0Var.s == null) {
                        return;
                    }
                    org.telegram.ui.Components.vc a02 = org.telegram.ui.Components.vc.a0(this.H);
                    ...
                    if (arrayList == null || arrayList.isEmpty()) {
                        ...
                        xp0Var = new xp0(tL_peerColorCollectible.gift_emoji_id, intValue, arrayList.size() >= 2 ? arrayList.get(1).intValue() | (-16777216) : intValue, arrayList.size() >= 3 ? arrayList.get(2).intValue() | (-16777216) : intValue);
                    }
                    a02.L(xp0Var, LocaleController.getString(z11 ? R.string.ChannelColorApplied : R.string.UserColorApplied)).j();
                }
                this.H = null;
            }
            if (this.V) {
                ...
                wp0 wp0Var2 = this.n;
                if (wp0Var2.h >= 0) {
                    org.telegram.ui.Components.vc.a0(this.H).L(xp0.c(this.currentAccount, this.n.h), LocaleController.getString(z11 ? R.string.ChannelProfileColorApplied : R.string.UserProfileColorApplied)).j();
                } else if (wp0Var2.n != 0) {
                    org.telegram.ui.Components.vc a03 = org.telegram.ui.Components.vc.a0(this.H);
                    TLRPC.Document f7 = org.telegram.ui.Components.o5.f(this.currentAccount, this.n.n);
                    ...
                    a03.getClass();
                    org.telegram.ui.Components.wb wbVar = new org.telegram.ui.Components.wb(a03.W(), a03.c);
                    ...
                    org.telegram.messenger.w1.o(z11 ? R.string.ChannelProfileColorResetApplied : R.string.UserProfileColorResetApplied, org.telegram.ui.Components.vc.a0(this.H), R.raw.contact_check, 36);
                }
            }
            this.H = null;
        }
    ...
    public final void F0() {
        ...
        fp0 fp0Var = this.e;
        if (fp0Var != null) {
            fp0Var.a = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.a7, fp0Var.b);
            fp0Var.a();
            fp0Var.invalidate();
        }
        G0();
    ...
    public final void G0() {
        ...
        if (this.M != null) {
            ci.i1 i1Var = this.I;
            float a2 = w7.p.a(((i1Var == null ? 0.0f : i1Var.getPositionAnimated()) - 0.333333f) / 0.333333f, 0.0f, 1.0f);
    ...
    public final View createView(Context context) {
        ...
        this.c0 = new yf.b0(context, new zo0(this, i11));
        ...
        this.O = frameLayout;
        frameLayout.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.cp0
        ...
        this.P = frameLayout2;
        frameLayout2.addView(this.O, w7.x5.d(-1, 64.0f, 80, 4.0f, 0.0f, 4.0f, 0.0f));
        ...
        if (dVar2 != null && C0 != null && C0 != this.R) {
            this.R = C0;
            n7.a1 a1Var = C0.e;
            dVar2.g((CharSequence) a1Var.b, false, true);
            this.Q.f((SpannableStringBuilder) a1Var.c, false);
        }
        j0Var.addView(this.P, w7.x5.e(-1, -2, 80));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.L = frameLayout3;
        j0Var.addView(frameLayout3, w7.x5.e(-1, -2, 55));
        boolean z10 = this.a;
        if (z10) {
            ...
            this.M = qzVar;
            qzVar.setTabs(LocaleController.getString(z10 ? R.string.ChannelColorTabProfile : R.string.UserColorTabProfile), LocaleController.getString(z10 ? R.string.ChannelColorTabName : R.string.UserColorTabName));
            this.M.r = new ap0(this, i10);
            G0();
        ...
        this.J.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.cp0
            public final /* synthetic */ cq0 b;
        ...
        this.K.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.cp0
            public final /* synthetic */ cq0 b;
        ...
        fp0 fp0Var3 = this.e;
        fp0Var3.getClass();
        fp0Var3.a = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.a7, fp0Var3.b);
        fp0Var3.a();
        fp0Var3.invalidate();
        z0();
        ...
        zo0 zo0Var = new zo0(this, i10);
        WeakHashMap weakHashMap = r0.i0.a;
        r0.a0.j(view2, zo0Var);
        return this.d;
    }
    ...
    public final boolean onBackPressed(boolean z10) {
        ...
        if (z10 && getVisibleDialog() == null) {
            ...
            showDialog(c2Var);
            ((TextView) c2Var.d(-2)).setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.q7));
        }
        return false;
    }
