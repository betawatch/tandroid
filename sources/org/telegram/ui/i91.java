...
public final class i91 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40, fh0, le.d {
    public org.telegram.ui.Components.g9 E;
    public org.telegram.ui.Components.v9 F;
    ...
    public org.telegram.ui.Components.s61 c;
    public ci.s6 d;
    ...
    public org.telegram.ui.Cells.a4 s;
    ...
    public static boolean U(i91 i91Var, org.telegram.ui.Components.w51 w51Var, View view) {
        Object obj = w51Var.G;
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            ei.k3.j(i91Var.currentAccount, ((TLRPC.TL_attachMenuBot) obj).bot_id, new v81(i91Var, 0));
            return true;
        }
        if (w51Var.G(org.telegram.ui.Cells.x6.class)) {
            Object obj2 = w51Var.G;
            ...
            if (!TextUtils.isEmpty(str)) {
                org.telegram.ui.Components.v70 H = org.telegram.ui.Components.v70.H(i91Var, view);
                H.c(R.drawable.msg_link2, LocaleController.getString(R.string.CopyLink), new w81(0, i91Var, str), false);
                H.W(i91Var.c.W0(view, false));
                H.Z();
                return true;
            }
        }
    ...
    public static /* synthetic */ void V(i91 i91Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        ...
        ConnectionsManager.getInstance(i91Var.currentAccount).sendRequest(tL_messages_toggleBotInAttachMenu, new dc0(23, i91Var, tL_attachMenuBot), 66);
    }
    ...
    public static /* synthetic */ void W(i91 i91Var) {
        ...
        u40Var.o((userProfilePhoto == null || userProfilePhoto.photo_big == null || (userProfilePhoto instanceof TLRPC.TL_userProfilePhotoEmpty)) ? false : true, new v81(i91Var, 4), new ci.f1(6), 0);
    }
    ...
    */
    public static void Z(i91 i91Var) {
        ...
        String string15 = LocaleController.getString(ci.d1.q(i91Var.getParentActivity()) ? "DebugMenuDualOff" : "DebugMenuDualOn");
    ...
    public static void b0(i91 i91Var, ArrayList arrayList) {
        ...
        if (q0Var != null && q0Var.getTag() != null) {
            arrayList.add(org.telegram.ui.Components.w51.C(org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()));
            a91 a91Var = i91Var.h;
            ...
            if (a91Var.w) {
                ...
                while (i13 < size) {
                    ...
                    org.telegram.ui.Components.w51 J = org.telegram.ui.Components.w51.J(org.telegram.ui.Cells.x6.class);
                    J.l = charSequence;
                    J.G = (i11) obj;
                    arrayList.add(J);
                    i12 = i14;
                ...
                arrayList.add(org.telegram.ui.Components.w51.q(LocaleController.getString(R.string.SettingsFaqSearchTitle)));
                ...
                while (i11 < size2) {
                    ...
                    org.telegram.ui.Components.w51 J2 = org.telegram.ui.Components.w51.J(org.telegram.ui.Cells.x6.class);
                    J2.l = charSequence2;
            ...
            if (!arrayList5.isEmpty()) {
                arrayList.add(org.telegram.ui.Components.w51.q(LocaleController.getString(R.string.SettingsRecent)));
                ...
                while (i18 < size3) {
                    ...
                    if (obj3 instanceof i11) {
                        ...
                        org.telegram.ui.Components.w51 J3 = org.telegram.ui.Components.w51.J(org.telegram.ui.Cells.x6.class);
                        J3.l = str;
                        J3.G = i11Var;
                        arrayList.add(J3);
                        ...
                        org.telegram.ui.Components.w51 J4 = org.telegram.ui.Components.w51.J(org.telegram.ui.Cells.x6.class);
                        J4.l = str2;
            ...
            while (i11 < size4) {
                ...
                org.telegram.ui.Components.w51 J5 = org.telegram.ui.Components.w51.J(org.telegram.ui.Cells.x6.class);
                J5.l = str3;
        ...
        org.telegram.ui.Components.w51 w51Var = new org.telegram.ui.Components.w51(-4);
        w51Var.c = frameLayout;
        w51Var.z = 188;
        ...
        if (set.contains("PREMIUM_GRACE")) {
            ...
            arrayList.add(g91.a(LocaleController.formatString(R.string.CheckPhoneNumber, org.telegram.messenger.rk.h(new StringBuilder("+"), i91Var.getUserConfig().getCurrentUser().phone, gf.b.c())), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.CheckPhoneNumberInfo), new v81(i91Var, i23)), LocaleController.getString(R.string.CheckPhoneNumberNo), new x81(i91Var, i23), yh.y3.g2(LocaleController.getString(R.string.CheckPhoneNumberYes2)), new x81(i91Var, 2)));
            arrayList.add(org.telegram.ui.Components.w51.B(null));
        ...
        if (arrayList3.size() > 0) {
            ...
            for (int i24 = 0; i24 < arrayList3.size(); i24++) {
                ...
                int i25 = c91.a;
                org.telegram.ui.Components.w51 J6 = org.telegram.ui.Components.w51.J(c91.class);
                J6.d = i24;
                J6.z = intValue;
                arrayList.add(J6);
            }
        ...
        if (i91Var.getMessagesController().starsPurchaseAvailable()) {
            yh.u5 y3 = yh.u5.y(i91Var.currentAccount, false);
            arrayList.add(e91.a(12, -1071598, -1608430, R.drawable.settings_stars, LocaleController.getString(R.string.TelegramStars), null, (!y3.e || y3.p().amount <= 0) ? "" : yh.w7.J0(y3.p(), 0.85f, ' ')));
        }
        yh.u5.y(i91Var.currentAccount, true).p();
        if (ApplicationLoader.isBetaBuild() || ApplicationLoader.isStandaloneBuild() || ApplicationLoader.isHuaweiStoreBuild() || (yh.u5.y(i91Var.currentAccount, true).e && (yh.u5.y(i91Var.currentAccount, true).O(0) || yh.u5.y(i91Var.currentAccount, true).p().positive()))) {
            yh.u5 y10 = yh.u5.y(i91Var.currentAccount, true);
        ...
        if (attachMenuBots != null && (arrayList2 = attachMenuBots.bots) != null && !arrayList2.isEmpty()) {
            ...
            while (i11 < size5) {
                ...
                if (tL_attachMenuBot2.show_in_side_menu && tL_attachMenuBot2.bot_id == 1985737506) {
                    ...
                    org.telegram.ui.Components.w51 J7 = org.telegram.ui.Components.w51.J(e91.class);
        ...
        if (((org.telegram.ui.Components.w51) hg.k0.g(1, arrayList)).a != 7) {
            arrayList.add(org.telegram.ui.Components.w51.B(null));
        }
        ...
        arrayList.add(org.telegram.ui.Components.w51.B(null));
        arrayList.add(org.telegram.ui.Components.w51.t("Beta"));
        ...
        arrayList.add(org.telegram.ui.Components.w51.l(i91Var.L));
    }
    ...
    public static void d0(i91 i91Var, int i10) {
        ...
        try {
            ...
            if (i10 == 18) {
                w7.y.a((LaunchActivity) i91Var.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
            ...
            if (i10 != 20) {
                ...
                if (i10 == 23) {
                    boolean q6 = ci.d1.q(i91Var.getParentActivity());
    ...
    public static /* synthetic */ void e0(i91 i91Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            ...
            i91Var.U = i91Var.getConnectionsManager().sendRequest(tL_photos_uploadProfilePhoto, new dc0(22, i91Var, str));
        }
        i91Var.actionBar.n().requestLayout();
    }

    public static void f0(i91 i91Var, org.telegram.ui.Components.w51 w51Var) {
        Object obj = w51Var.G;
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            TLRPC.TL_attachMenuBot tL_attachMenuBot = (TLRPC.TL_attachMenuBot) obj;
            if (tL_attachMenuBot.inactive || tL_attachMenuBot.side_menu_disclaimer_needed) {
                lj1.a(i91Var.getParentActivity(), new ai.g3(10, i91Var, tL_attachMenuBot), null);
                return;
            } else {
                LaunchActivity.C0(LaunchActivity.G1, i91Var.currentAccount, tL_attachMenuBot, null, true);
            }
        ...
        switch (w51Var.d) {
            ...
            case 16:
                ...
                break;
            case 17:
                i91Var.showDialog(org.telegram.ui.Components.d5.U(i91Var, i91Var.resourceProvider));
                break;
            case 18:
                nf.f.s(i91Var.getParentActivity(), LocaleController.getString(R.string.TelegramFaqUrl));
                break;
            case 19:
                nf.f.s(i91Var.getParentActivity(), LocaleController.getString(R.string.PrivacyPolicyUrl));
                break;
            case 20:
            ...
            case 23:
                if (!MessagesController.getInstance(i91Var.currentAccount).isFrozen()) {
                    nf.f.s(i91Var.getParentActivity(), LocaleController.getString(R.string.TelegramFeaturesUrl));
                    break;
                } else {
            ...
            case 24:
                i91Var.presentFragment(new o41(null));
                break;
        }
    }
    ...
    public final void B(float f7) {
        org.telegram.ui.Cells.a4 a4Var = this.s;
        if (a4Var == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.h = a91Var;
        a91Var.G();
        org.telegram.ui.Components.s61 s61Var = new org.telegram.ui.Components.s61(this, new b5(this, 26), new z81(this), new z81(this));
        this.c = s61Var;
        s61Var.Y2.r = false;
        s61Var.q1();
        ...
        org.telegram.ui.Components.s61 s61Var2 = this.c;
        x8 x8Var = this.b;
        Objects.requireNonNull(s61Var2);
        this.Y = new ah.o(s61Var2, x8Var, new w8(s61Var2, 0));
        this.c.D0(new v81(this, 2));
        ...
        this.F = v9Var;
        v9Var.setRoundRadius(AndroidUtilities.dp(90.0f));
        this.y.addView(this.F, w7.y5.d(90, 90.0f, 49, 0.0f, 15.0f, 0.0f, 0.0f));
        org.telegram.ui.Cells.a4 a4Var = new org.telegram.ui.Cells.a4(this, context);
        this.s = a4Var;
        ...
        TextView h = org.telegram.ui.Cells.c1.h(this.x, this.J, w7.y5.d(-1, -2.0f, 49, 16.0f, 126.33299f, 16.0f, 0.0f), context);
        this.K = h;
        h.setTextSize(1, 13.0f);
        this.K.setGravity(17);
        this.K.setSingleLine();
        this.K.setEllipsize(truncateAt);
        TextView h10 = org.telegram.ui.Cells.c1.h(this.x, this.K, w7.y5.d(-1, -2.0f, 49, 0.0f, 156.0f, 0.0f, 0.0f), context);
        this.L = h10;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.updateInterfaces) {
            ...
            if (i10 != NotificationCenter.newSuggestionsAvailable || (s61Var = this.c) == null) {
                return;
            }
            s61Var.Y2.N(true);
        }
    ...
    public final void n0(boolean z10, boolean z11) {
        ...
        if (z10) {
            this.s.setVisibility(0);
            this.r.playTogether(ObjectAnimator.ofFloat(this.s, (Property<org.telegram.ui.Cells.a4, Float>) View.ALPHA, 1.0f));
        } else {
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this.s, (Property<org.telegram.ui.Cells.a4, Float>) View.ALPHA, 0.0f));
        }
