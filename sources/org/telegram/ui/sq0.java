...
public final class sq0 extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        uq0 uq0Var = this.d;
        if (uq0Var.J == null) {
            return TextUtils.isEmpty(uq0Var.v) ? c1Var.f == 3 : c1Var.b() < uq0Var.f.size();
        }
        return true;
    }
    ...
    public final int h() {
        ...
        if (!uq0Var.f.isEmpty()) {
            return uq0Var.f.size() + (!uq0Var.s ? 1 : 0);
        }
        if (!TextUtils.isEmpty(uq0Var.v) || uq0Var.n.isEmpty()) {
            return 0;
        }
        return uq0Var.n.size() + 2;
    }
    ...
    public final int j(int i10) {
        ...
        return uq0Var.f.isEmpty() ? i10 == uq0Var.n.size() ? 4 : 3 : i10 < uq0Var.f.size() ? 0 : 1;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        uq0 uq0Var = this.d;
        MediaController.AlbumEntry albumEntry = uq0Var.J;
        ArrayList arrayList = uq0Var.n;
        ArrayList arrayList2 = uq0Var.c;
        HashMap hashMap = uq0Var.b;
        int i11 = c1Var.f;
        View view = c1Var.a;
        if (i11 == 0) {
            ...
            if (albumEntry != null) {
                ...
                t5Var.b(uq0Var.e ? arrayList2.indexOf(Integer.valueOf(photoEntry.imageId)) : -1, hashMap.containsKey(Integer.valueOf(photoEntry.imageId)), false);
                ...
                t5Var.b(uq0Var.e ? arrayList2.indexOf(searchImage.id) : -1, hashMap.containsKey(searchImage.id), false);
                L1 = PhotoViewer.L1(searchImage.getPathToAttach());
            }
            imageView.getImageReceiver().setVisible(!L1, true);
            t5Var.getCheckBox().setVisibility((uq0Var.T != 0 || L1) ? 8 : 0);
            return;
        }
        if (i11 == 1) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 == 1) {
                ...
                viewGroup2 = s8Var;
                if (z10) {
                    s8Var.a.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, uq0Var.v0, false));
                    s8Var.e.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.rg, false), PorterDuff.Mode.MULTIPLY));
                    viewGroup2 = s8Var;
                }
            }
        ...
        t5Var.getCheckFrame().setVisibility(uq0Var.T != 0 ? 8 : 0);
        viewGroup2 = t5Var;
