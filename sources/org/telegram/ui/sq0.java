...
public final /* synthetic */ class sq0 implements Utilities.Callback {
        ...
        switch (this.a) {
            case 0:
                ...
                try {
                    ...
                    photoViewer.q5.post(new mq0(photoViewer, i11));
                    break;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            case 2:
                ...
                ofFloat.addUpdateListener(new lq0(photoViewer2, i11));
                ...
                ofFloat2.addUpdateListener(new lq0(photoViewer2, i12));
                ...
                AndroidUtilities.updateViewShow(ft0Var.v1, (ft0Var.e2 || ft0Var.d2) ? false : true, false, 1.0f, true, null);
                AndroidUtilities.updateViewShow(ft0Var.t1, (ft0Var.e2 || ft0Var.d2) ? false : true, false, 1.0f, true, null);
                AndroidUtilities.updateViewShow(ft0Var.x1, ft0Var.e2 || ft0Var.d2, false, 1.0f, true, null);
                AndroidUtilities.updateViewShow(ft0Var.w1, ft0Var.e2 || ft0Var.d2, false, 1.0f, true, null);
                break;
            case 3:
                ...
                if (!photoViewer3.n5.b.K && (i10 = photoViewer3.M4) >= 0 && i10 < photoViewer3.d7.size() && (photoViewer3.d7.get(photoViewer3.M4) instanceof MediaController.PhotoEntry)) {
                    org.telegram.ui.Components.of0 of0Var = photoViewer3.n5;
                    ph.d3 d3Var = of0Var.h;
                    if (d3Var != null) {
                        d3Var.dismiss();
                        of0Var.h = null;
                    }
                    photoViewer3.n5.b.setLoading(true);
                    Utilities.globalQueue.postRunnable(new a30(photoViewer3, photoEntry, (MediaController.PhotoEntry) photoViewer3.d7.get(photoViewer3.M4), PhotoViewer.y1(), 19));
                    break;
                }
                break;
            case 4:
            ...
            case 5:
                ...
                if (frameLayout != null && frameLayout.getVisibility() != 8) {
                    photoViewer5.N7.setTranslationY(photoViewer5.M0.getTranslationY() - (photoViewer5.R1.getAlpha() * kh.a2.c(46.0f, photoViewer5.R1.getEditTextHeight(), 0)));
                }
                photoViewer5.b1.setTranslationY(photoViewer5.R1.getAlpha() * (-kh.a2.c(46.0f, num2.intValue(), 0)));
                photoViewer5.c1.setTranslationY(photoViewer5.R1.getAlpha() * (-kh.a2.c(46.0f, num2.intValue(), 0)));
                photoViewer5.d1.setTranslationY(photoViewer5.R1.getAlpha() * (-kh.a2.c(46.0f, num2.intValue(), 0)));
