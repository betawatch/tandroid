    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (i20 != i21) {
            ...
            org.telegram.ui.ActionBar.n1 n1Var = ar0Var.m0;
            if (n1Var != null && n1Var.isShowing()) {
                ar0Var.m0.d(true);
            }
        }
        int childCount = getChildCount();
        int emojiPadding = (ar0Var.d0 == null || ar0Var.Z.getParent() != this || AndroidUtilities.dp(20.0f) < 0 || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : ar0Var.d0.getEmojiPadding();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.x0 = true;
        int dp = ((size2 - AndroidUtilities.dp(4.0f)) - AndroidUtilities.dp(4.0f)) / ar0Var.g0;
        ar0Var.R = dp;
        if (this.y0 != dp) {
            this.y0 = dp;
        ...
        if (ar0Var.Y) {
            ...
            ar0Var.M.y1(Math.max(1, ((ar0Var.g0 - 1) * AndroidUtilities.dp(2.0f)) + (ar0Var.R * ar0Var.g0)));
        }
        this.x0 = false;
        ...
        int R = R();
        if (AndroidUtilities.dp(20.0f) >= 0 && !AndroidUtilities.isInMultiwindow && ar0Var.d0 != null && ar0Var.Z.getParent() == this) {
            size4 -= ar0Var.d0.getEmojiPadding();
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size4, TLObject.FLAG_30);
        }
        int i12 = size4;
        int i13 = makeMeasureSpec;
        if (R > AndroidUtilities.dp(20.0f) && (juVar = ar0Var.d0) != null) {
            this.x0 = true;
            juVar.j();
            this.x0 = false;
        }
        org.telegram.ui.Components.ju juVar2 = ar0Var.d0;
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                org.telegram.ui.Components.ju juVar3 = ar0Var.d0;
