...
public final class mq0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        oq0 oq0Var = this.H;
        BitmapDrawable bitmapDrawable = oq0Var.b;
        if (bitmapDrawable != null) {
            try {
                int i10 = this.x;
                int i11 = this.y;
                bitmapDrawable.setBounds(i10, i11, this.v + i10, this.w + i11);
                oq0Var.b.draw(canvas);
            } catch (Throwable th2) {
                FileLog.e(th2);
            }
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.F = dp;
        if (this.E == 0 || dp == 0 || (bitmap = (oq0Var = this.H).a) == null) {
            return;
        }
        ...
        float height = oq0Var.a.getHeight();
        int i14 = this.E;
        float f17 = i14 / width;
        int i15 = this.F;
        if (f17 > i15 / height) {
