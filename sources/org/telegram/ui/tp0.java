...
public final class tp0 extends FrameLayout {
    ...
    public final int a() {
        ...
        if (i12 >= 0) {
            ...
            return (peerColors == null || (color = peerColors.getColor(up0Var.h)) == null) ? bq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.r8[0]) : color.getColor1();
        }
    ...
    public final void b(boolean z10) {
        ...
        if (j3 != 0) {
            ...
            n5Var.g(null, z10);
            if (this.b == null) {
                this.b = new org.telegram.ui.Components.t01(LocaleController.getString(up0Var.p0.a ? R.string.ChannelReplyIconOff : R.string.UserReplyIconOff), 16.0f, null);
            }
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (t01Var != null) {
            t01Var.c((getMeasuredWidth() - this.b.l()) - AndroidUtilities.dp(19.0f), getMeasuredHeight() / 2.0f, 1.0f, this.d.p0.getThemedColor(org.telegram.ui.ActionBar.j6.q6), canvas);
        } else {
            n5Var.draw(canvas);
        }
    }
