...
public final class v50 {
    ...
    public final x50[] c = new x50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.c6 i = new org.telegram.ui.Components.c6(new i10(this, 7), 320, org.telegram.ui.Components.qr.h, 0);
    ...
    public v50() {
        ...
        while (true) {
            ...
            if (i10 >= x50VarArr.length) {
                ...
                this.e = h01Var;
                this.f = new org.telegram.ui.Components.h01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        h01Var.p = f7 - AndroidUtilities.dp(132.0f);
        ...
        float l4 = h01Var.l() + AndroidUtilities.dp(86.0f) + AndroidUtilities.dp(14.0f);
        ...
        h01Var2.c(f14 - (h01Var2.l() / 2.0f), dp / 2.0f, AndroidUtilities.lerp(1.0f, 0.75f, e) * (1.0f - f10), -1, canvas);
        ...
        AndroidUtilities.lerpCentered(rectF2, rectF3, f10, rectF3);
        boolean z11 = x50VarArr[3].b(canvas, rectF3, f10) ? true : z10;
        if (f10 > 0.0f) {
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            x50 x50Var = this.c[i10];
            String str = strArr == null ? null : strArr[i10];
            w50 w50Var = x50Var.k;
            boolean z10 = x50Var.f;
            x50Var.f = str != null;
            if (str != null && (x50Var.d == null || !TextUtils.equals(x50Var.l, str))) {
                org.telegram.ui.Components.o5 o5Var = x50Var.d;
                if (o5Var != null) {
                    o5Var.p(w50Var);
                }
                x50Var.c = Emoji.getEmojiDrawable(str);
