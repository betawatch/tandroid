...
public final class bf0 extends org.telegram.ui.Components.gw0 {
    ...
    */
    public bf0(xg0 xg0Var, Context context) {
        super(context);
        int i10;
        this.y = xg0Var;
        this.x = new ze0(this, 1);
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                ee0 ee0Var = new ee0(this, context, 1);
                this.a = ee0Var;
                ee0Var.b(6, 1);
                for (gs gsVar : ee0Var.f) {
                ...
                addView(this.a, w7.y5.t(-2, 42, 1, 0, 32, 0, 0));
                ...
                oVar.setMaxLines(2);
                oVar.setOnClickListener(new k60(this, 6));
                FrameLayout frameLayout2 = new FrameLayout(context);
                frameLayout2.addView(oVar, w7.y5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        ...
        ee0 ee0Var2 = new ee0(this, context, 1);
        this.a = ee0Var2;
        ee0Var2.b(6, 1);
        while (r12 < r11) {
        }
        ...
        oVar2.setMaxLines(2);
        oVar2.setOnClickListener(new k60(this, 6));
        FrameLayout frameLayout22 = new FrameLayout(context);
        frameLayout22.addView(oVar2, w7.y5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        addView(frameLayout22, w7.y5.l(1.0f, -1, 0));
        n7.z0.k(oVar2);
    }
    ...
    @Override // org.telegram.ui.Components.gw0
    public final void j() {
        AndroidUtilities.runOnUIThread(new ze0(this, 0), xg0.t0);
    }
