...
public final class cd1 extends org.telegram.ui.Components.sl0 {
    public final Context c;
    public final /* synthetic */ ed1 d;

    public cd1(Context context, ed1 ed1Var) {
        this.d = ed1Var;
        this.c = context;
    }
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        ed1 ed1Var = this.d;
        k5Var.setPattern((TLRPC.TL_wallPaper) ed1Var.R0.get(i10));
        k5Var.getImageReceiver().setColorFilter(new PorterDuffColorFilter(ed1Var.g1, ed1Var.p1));
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (i11 == 0 || ed1Var.i1 < 0.0f) {
                k5Var.getImageReceiver().setBlendMode(null);
                return;
            }
            ImageReceiver imageReceiver = ed1Var.u0.getImageReceiver();
