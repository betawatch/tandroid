...
public final /* synthetic */ class rv implements View.OnClickListener {
    ...
    public /* synthetic */ rv(oy oyVar, int i10) {
        this.a = i10;
        this.b = oyVar;
    }
        ...
        switch (this.a) {
            case 0:
                ...
                if (oyVar.a4() && (arrayList = oyVar.A2) != null && !arrayList.isEmpty() && oyVar.getParentActivity() != null) {
                    ...
                    zw zwVar = oyVar.y1;
                    CharSequence fieldText = zwVar != null ? zwVar.getFieldText() : photoEntry.caption;
            ...
            case 5:
                ...
                if (oyVar6.z2 != null && !arrayList4.isEmpty()) {
                    ArrayList arrayList5 = new ArrayList();
                    for (int i11 = 0; i11 < arrayList4.size(); i11++) {
                        arrayList5.add(MessagesStorage.TopicKey.of(((Long) arrayList4.get(i11)).longValue(), 0L));
                    }
                    oyVar6.z2.w(oyVar6, arrayList5, oyVar6.y1.getFieldText(), false, oyVar6.G2, oyVar6.H2, oyVar6.I2, null);
                    break;
                }
                break;
            case 6:
            ...
            case 15:
                oy oyVar10 = this.b;
                oyVar10.showDialog(org.telegram.ui.Components.z4.m(oyVar10.getParentActivity(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new uv(oyVar10, 1), new mv(oyVar10, 17), false, false, oyVar10.getResourceProvider()).a);
                break;
            case 16:
                oy.C0(this.b);
                break;
