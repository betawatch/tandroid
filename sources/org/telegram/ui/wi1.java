...
public final class wi1 implements di0 {
    ...
    public final void a(final Canvas canvas) {
        ...
        if (i10 != i11) {
            ...
            y3 = (ml0Var.getY() + (t1Var.getY() + t1Var.getRadialProgress().a.centerY())) - uiVar.getY();
            x10 = (ml0Var.getX() + (t1Var.getX() + t1Var.getRadialProgress().a.centerX())) - uiVar.getX();
        }
        this.k = x10;
        this.l = y3;
        ...
        if (recordCircle != null) {
            ...
            org.telegram.ui.Components.z9 z9Var2 = recordCircle.n;
            f7 = x11;
            ...
            canvas.save();
            float f20 = ((z9Var2.t * 1.4f) + 0.878f) * chatActivityEnterView.g4 * f19 * interpolation3 * f17;
            canvas.scale(f20, f20, f12, f14);
            z9Var2.a(f12, f14, canvas, z9Var2.d);
            canvas.restore();
            float f21 = ((z9Var.t * 1.4f) + 0.926f) * chatActivityEnterView.g4 * f19 * interpolation3 * f17;
            canvas.save();
            canvas.scale(f21, f21, f12, f14);
            z9Var.a(f12, f14, canvas, z9Var.d);
            canvas.restore();
        } else {
            f7 = x11;
        }
        ...
        final float f23 = f7;
        t1Var.q2(canvas, interpolation, new Runnable() { // from class: org.telegram.ui.ui1
            ...
            public final void run() {
                ...
                Drawable drawable;
                wi1 wi1Var = wi1.this;
                RadialProgress2 radialProgress = wi1Var.a.getRadialProgress();
                ...
                ChatActivityEnterView.RecordCircle recordCircle2 = wi1Var.g;
                if (recordCircle2 != null) {
                    ...
                    if (z10) {
                        ...
                        canvas2 = canvas3;
                        f24 = f31;
                        rect.set(org.telegram.messenger.wl.w(2, i14, drawable), org.telegram.messenger.wl.e(2, i15, drawable), org.telegram.messenger.wl.B(2, i14, drawable), org.telegram.messenger.wl.z(2, i15, drawable));
                        if (drawable2 != null) {
                            drawable2.setBounds(org.telegram.messenger.wl.w(2, i14, drawable2), org.telegram.messenger.wl.e(2, i15, drawable2), org.telegram.messenger.wl.B(2, i14, drawable2), org.telegram.messenger.wl.z(2, i15, drawable2));
                        }
                    } else {
                        canvas2 = canvas3;
                        f24 = f31;
