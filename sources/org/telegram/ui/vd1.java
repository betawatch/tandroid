...
public final class vd1 extends org.telegram.ui.Components.rl0 {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (j(i10) == 4) {
            ...
            TLRPC.Chat chat = (TLRPC.Chat) yd1Var.f.get(i10 - this.f);
            g4Var.e(chat, chat.title, (String) yd1Var.h.get(i10 - this.f), i10 != this.h - 1);
            g4Var.c(yd1Var.w.contains(Long.valueOf(chat.id)), false);
        }
    }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 1) {
            if (i10 == 2) {
                ...
                org.telegram.ui.Components.nq nqVar = new org.telegram.ui.Components.nq(new ColorDrawable(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.a7, false)), org.telegram.ui.ActionBar.j6.V0(viewGroup.getContext(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.b7));
                nqVar.w = true;
            ...
            maVar.addView(textView, k7.b6.d(-1, -2.0f, 51, 52.0f, 75.0f, 52.0f, 0.0f));
            TextView textView2 = new TextView(context);
            maVar.a = textView2;
            textView2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.g9, false));
            textView2.setTextSize(1, 14.0f);
            textView2.setGravity(17);
            maVar.addView(textView2, k7.b6.d(-1, -2.0f, 51, 36.0f, 110.0f, 36.0f, 0.0f));
            ...
            maVar.addView(v3Var, k7.b6.d(-2, -2.0f, 49, 0.0f, 12.0f, 0.0f, 6.0f));
            ...
            yd1Var.x = maVar;
            int i12 = yd1Var.D;
            yd1Var.x.setMessageText(i12 == 0 ? LocaleController.getString(R.string.TooManyCommunitiesHintJoin) : i12 == 1 ? LocaleController.getString(R.string.TooManyCommunitiesHintEdit) : LocaleController.getString(R.string.TooManyCommunitiesHintCreate));
            ...
            yd1Var.x.setLayoutParams(w0Var);
            view = maVar;
        }
