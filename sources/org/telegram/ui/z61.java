...
public final class z61 extends FrameLayout {
    ...
    public z61(Activity activity, boolean z10) {
        ...
        linearLayout.addView(textView, i7.f6.t(-1, -2, 0, 0, 0, z10 ? 64 : 0, 0));
        TextView textView2 = new TextView(activity);
        this.c = textView2;
        textView2.setTextSize(2, 13.0f);
        textView2.setGravity(3);
        textView2.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.y6, false));
        linearLayout.addView(textView2, i7.f6.t(-1, -2, 0, 0, 4, z10 ? 64 : 0, 0));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.g6.k0);
        }
    }
