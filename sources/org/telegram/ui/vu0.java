...
public class vu0 {
            ...
            if (hypot <= 1.005f || this.n) {
                ...
                if (z4) {
                    ...
                    if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                        ...
                        uu0 uu0Var3 = this.d;
                        mediaController.setTextureView(uu0Var3.b, uu0Var3.c, uu0Var3.a, true);
                        ...
                        ru0 ru0Var = this.E;
                        if (ru0Var != null) {
                            this.d.d.setImageBitmap(ru0Var.f0().getBitmap((int) this.z, (int) this.y));
    ...
    public final void d() {
        if (this.C == null && this.n) {
            ...
            this.C.setInterpolator(org.telegram.ui.Components.nr.f);
            this.C.start();
        }
    }
