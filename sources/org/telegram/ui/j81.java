...
public final class j81 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public j81(SessionsActivity sessionsActivity, Context context) {
        ...
        this.a = w9Var;
        addView(w9Var, w7.x5.d(120, 120.0f, 1, 0.0f, 16.0f, 0.0f, 0.0f));
        hVar.j = false;
        hVar.n = 1.2f;
        ...
        d90Var.setGravity(1);
        d90Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        ...
        d90Var.setHighlightColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.K6, false));
        ...
        pkVar.setOnClickListener(new z31(this, 5));
        addView(pkVar, w7.x5.d(-1, 48.0f, 80, 16.0f, 15.0f, 16.0f, 16.0f));
        b();
    }
    ...
    public static void a(j81 j81Var) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && sessionsActivity.getParentActivity().checkSelfPermission("android.permission.CAMERA") != 0) {
            ...
            u9.e0(sessionsActivity.getParentActivity(), 2, new h81(sessionsActivity));
        }
    }
