...
public class zo0 extends View {
    ...
    public final void c(MessagesController.PeerColor peerColor, boolean z10) {
        ...
        if (peerColor == null) {
            this.d = true;
            int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.s8, d6Var);
            this.f = v02;
            this.e = v02;
        } else {
    ...
    public int getActionBarButtonColor() {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.b;
        return i0.a.d(this.c, org.telegram.ui.ActionBar.h6.v0(i10, d6Var), this.d ? org.telegram.ui.ActionBar.h6.v0(i10, d6Var) : -1);
    }

    public int getColor() {
        return i0.a.d(this.c, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.s8, this.b), i0.a.d(0.75f, this.h.c, this.n.c));
    }

    public int getTabsViewBackgroundColor() {
        int i10 = org.telegram.ui.ActionBar.h6.s8;
        org.telegram.ui.ActionBar.d6 d6Var = this.b;
        int v02 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(i10, d6Var)) > 0.721f ? org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.v8, d6Var) : org.telegram.ui.ActionBar.h6.b(0.08f, -0.08f, org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        org.telegram.ui.Components.h5 h5Var = this.h;
        int i11 = h5Var.c;
        org.telegram.ui.Components.h5 h5Var2 = this.n;
        return i0.a.d(this.c, v02, AndroidUtilities.computePerceivedBrightness(i0.a.d(0.75f, i11, h5Var2.c)) > 0.721f ? org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.v6, d6Var) : org.telegram.ui.ActionBar.h6.b(0.08f, -0.08f, i0.a.d(0.75f, h5Var.c, h5Var2.c)));
    }

    @Override // android.view.View
    public final void onMeasure(int i10, int i11) {
        if (!this.F) {
            i11 = org.telegram.messenger.ok.C(230.0f, AndroidUtilities.statusBarHeight, TLObject.FLAG_30);
        }
