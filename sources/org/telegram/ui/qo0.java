...
public final class qo0 extends org.telegram.ui.Components.h51 {
    ...
    static {
        org.telegram.ui.Components.h51.setup(new qo0());
    }
    ...
    public final void bindView(View view, org.telegram.ui.Components.i51 i51Var, boolean z4, org.telegram.ui.Components.w51 w51Var, org.telegram.ui.Components.g61 g61Var) {
        ...
        ro0Var.a = savedStarGift.gift.id;
        ro0Var.setPadding(0, 0, 0, 0);
        ro0Var.c(savedStarGift.gift.getDocument(), savedStarGift.gift);
        ro0Var.b = (TL_stars.starGiftAttributeBackdrop) lh.t7.l(savedStarGift.gift.attributes, TL_stars.starGiftAttributeBackdrop.class);
        ro0Var.c = (TL_stars.starGiftAttributePattern) lh.t7.l(savedStarGift.gift.attributes, TL_stars.starGiftAttributePattern.class);
        u1Var.d(ro0Var.b);
        u1Var.e(ro0Var.c);
        if (y1Var != null) {
            y1Var.setBackdrop(ro0Var.b);
