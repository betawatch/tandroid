...
public final class bc1 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.a) {
            ...
            case 18:
                ...
                float d = q1Var.c.d(q1Var.b, false);
                double d10 = d;
            ...
            case 9:
                ...
                if (motionEvent.getAction() == 0) {
                    ...
                    if (view2 != null) {
                        ...
                        if (i10 != indexOfChild) {
                            org.telegram.ui.Components.ym0 ym0Var = scrollSlidingTextTabStrip.b;
                    ...
                    if (view3 != null) {
                        final int i12 = 0;
                        view3.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.wm0
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i12) {
                                    case 0:
                                        bc1 bc1Var = this.b;
                                        bc1Var.invalidate();
                                        ((ScrollSlidingTextTabStrip) bc1Var.b).invalidate();
                                        break;
                                    default:
                                        bc1 bc1Var2 = this.b;
                                        bc1Var2.invalidate();
                                        ((ScrollSlidingTextTabStrip) bc1Var2.b).invalidate();
                                        break;
                                }
                            }
                    ...
                    if (view4 != null) {
                        final int i13 = 1;
                        view4.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.wm0
                            public final /* synthetic */ bc1 b;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.a) {
            case 5:
                if (view == ((org.telegram.ui.Components.e9) this.b).a) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 8:
                org.telegram.ui.Components.vm0 vm0Var = (org.telegram.ui.Components.vm0) this.b;
                if (view instanceof org.telegram.ui.Components.px0) {
                    ((org.telegram.ui.Components.px0) view).a(vm0Var.i0);
                }
                if (view == vm0Var.s) {
                    return true;
                }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.a) {
            case 16:
                ...
                accessibilityNodeInfo.setVisibleToUser(((si1) this.b).B0);
                break;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                break;
        ...
        switch (this.a) {
            case 6:
                ...
                for (int i15 = 0; i15 < getChildCount(); i15++) {
                    ...
                    if (childAt != ((org.telegram.ui.Components.aw) this.b).s.F && childAt != null) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                LinearLayout linearLayout2 = d2Var.n0;
                if (linearLayout2 != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) d2Var.n0.getLayoutParams();
                    paddingRight += d2Var.n0.getMeasuredWidth() + marginLayoutParams2.leftMargin + marginLayoutParams2.rightMargin;
                }
                LinearLayout linearLayout3 = d2Var.o0;
                if (linearLayout3 != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams3 = (ViewGroup.MarginLayoutParams) d2Var.o0.getLayoutParams();
                    paddingRight += d2Var.o0.getMeasuredWidth() + marginLayoutParams3.leftMargin + marginLayoutParams3.rightMargin;
                }
                d2Var.k0 = Math.max(0, size2 - paddingRight);
                super.onMeasure(i10, i11);
                break;
            case 3:
                int size3 = View.MeasureSpec.getSize(i10);
                int paddingRight2 = getPaddingRight() + getPaddingLeft();
                ii.b4 b4Var = (ii.b4) this.b;
            ...
            case 4:
                ...
                break;
            case 6:
                super.onMeasure(Math.max(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(((org.telegram.ui.Components.aw) this.b).b.getChildCount() * 32), TLObject.FLAG_30)), i11);
                break;
            case 11:
                super.onMeasure(i10, i11);
            ...
            case 14:
                ...
                if (i12 != 0) {
                    ...
                    if (((PhotoViewer) this.b).j1.getVisibility() == 0) {
                        int max = Math.max(0, (min - AndroidUtilities.dp(((PhotoViewer) this.b).Y7 < 2 ? 48 : 64)) / 2);
            ...
            case 15:
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams7 = (ViewGroup.MarginLayoutParams) gh1Var.c.getLayoutParams();
                int i15 = 0;
                int dp = AndroidUtilities.dp(8.0f) + (gh1Var.a.getVisibility() == 8 ? AndroidUtilities.statusBarHeight : 0);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ bc1(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
