...
public abstract class e71 extends Dialog {
    ...
    public e71(i71 i71Var, Context context, Runnable runnable, View view, r61 r61Var, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        org.telegram.ui.ActionBar.w0.c(true, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil1Hour), false, f6Var).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.b71
        ...
        final int i11 = 1;
        org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil2Hours), false, f6Var).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.b71
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                switch (i11) {
                    case 0:
        ...
        final int i12 = 2;
        org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil8Hours), false, f6Var).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.b71
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                switch (i12) {
                    case 0:
        ...
        final int i13 = 3;
        org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil2Days), false, f6Var).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.b71
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                switch (i13) {
                    case 0:
        ...
        if (window != null) {
            ...
            z10 = true;
            j0Var.setOnApplyWindowInsetsListener(new x41(x51Var, 1 == true ? 1 : 0));
    ...
    public static /* synthetic */ WindowInsets b(x51 x51Var, View view, WindowInsets windowInsets) {
        view.requestLayout();
    ...
    public final void d(final boolean z10, a71 a71Var, final a71 a71Var2, final boolean z11) {
        ...
        this.K = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.c71
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                e71 e71Var = e71.this;
                e71Var.I = floatValue;
                AndroidUtilities.lerp(e71Var.c, e71Var.d, floatValue, e71Var.e);
                e71Var.s.invalidate();
                boolean z12 = z10;
                if (!z12) {
    ...
    */
    public final void e(Integer num) {
        ...
        Rect rect = this.c;
        if (num != null) {
            y51 y51Var = ((x51) this).S;
            i71 i71Var = y51Var.e;
            if (i71Var.n1 != null && y51Var.d != null) {
                rect.set(i71Var.o1);
                z10 = true;
                this.x = z10;
                int[] iArr = this.G;
                ...
                d(false, new a71(this, num, 0), new a71(this, num, 1), !z10);
                c(false);
            }
        }
        z10 = false;
