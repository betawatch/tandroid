...
public final class bq0 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean a0;
    public final zh.j5 b;
    public i0.c b0;
    public final zh.j5 c;
    public yf.c0 c0;
    public j0 d;
    ...
    public bq0() {
        ...
        if (Build.VERSION.SDK_INT < 31 || !SharedConfig.chatBlurEnabled()) {
            ...
            this.h0 = bVar5;
            bVar5.f = LiteMode.isEnabled(262144);
        }
        bVar3.c = bVar;
        bVar3.b = bVar2;
        bVar4.c = bVar;
    ...
    public static void U(bq0 bq0Var, boolean[] zArr, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, zo0 zo0Var, zh.a3 a3Var, of.e eVar) {
        zArr[0] = true;
        eVar.d();
        zh.s5.x(bq0Var.currentAccount, a3Var.a).h(a3Var.b, tL_starGiftUnique, j3, null, true, new bi.f0(18, eVar, zo0Var));
    }
    ...
    */
    public final void E0() {
        ...
        if (this.H != null) {
            ...
            if (z10) {
                ...
                vp0 vp0Var = this.h;
                if (vp0Var.h >= 0) {
                    org.telegram.ui.Components.yc.a0(this.H).L(wp0.a(this.currentAccount, this.h.h), LocaleController.getString(z11 ? R.string.ChannelColorApplied : R.string.UserColorApplied)).j();
                } else {
                    if (vp0Var.s == null) {
                        return;
                    }
                    ...
                    if (arrayList == null || arrayList.isEmpty()) {
                        ...
                        wp0Var = new wp0(tL_peerColorCollectible.gift_emoji_id, intValue, arrayList.size() >= 2 ? arrayList.get(1).intValue() | (-16777216) : intValue, arrayList.size() >= 3 ? arrayList.get(2).intValue() | (-16777216) : intValue);
                    }
                    a02.L(wp0Var, LocaleController.getString(z11 ? R.string.ChannelColorApplied : R.string.UserColorApplied)).j();
                }
                this.H = null;
            }
            if (this.V) {
                ...
                vp0 vp0Var2 = this.n;
                if (vp0Var2.h >= 0) {
                    org.telegram.ui.Components.yc.a0(this.H).L(wp0.c(this.currentAccount, this.n.h), LocaleController.getString(z11 ? R.string.ChannelProfileColorApplied : R.string.UserProfileColorApplied)).j();
                } else if (vp0Var2.n != 0) {
                    ...
                    org.telegram.messenger.w1.o(z11 ? R.string.ChannelProfileColorResetApplied : R.string.UserProfileColorResetApplied, org.telegram.ui.Components.yc.a0(this.H), R.raw.contact_check, 36);
                }
            }
            this.H = null;
        }
    ...
    public final View createView(Context context) {
            ...
            public final void onClick(View view) {
                ...
                switch (i13) {
                    ...
                    default:
                        ...
                        bq0Var2.Z.setInterpolator(org.telegram.ui.Components.jt.e);
                        bq0Var2.Z.start();
        ...
        View view = this.O;
        dh.d c10 = this.E.c(view, null, false);
