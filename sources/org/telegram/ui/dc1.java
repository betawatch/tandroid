...
public final class dc1 extends LinearLayout {
    ...
    public /* synthetic */ dc1(Context context) {
        super(context);
        this.a = 0;
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.a) {
            case 12:
                ...
                break;
            case 18:
                xh.p1 p1Var = (xh.p1) this.b;
                RectF rectF = p1Var.h;
                RectF rectF2 = p1Var.f;
                ...
                float d = p1Var.c.d(p1Var.b, false);
                double d10 = d;
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i12) {
                                    case 0:
                                        dc1 dc1Var = this.b;
                                        dc1Var.invalidate();
                                        ((ScrollSlidingTextTabStrip) dc1Var.b).invalidate();
                                        break;
                                    default:
                                        dc1 dc1Var2 = this.b;
                                        dc1Var2.invalidate();
                                        ((ScrollSlidingTextTabStrip) dc1Var2.b).invalidate();
                                        break;
                                }
                            }
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.a) {
            case 5:
                if (view == ((org.telegram.ui.Components.c9) this.b).a) {
                    return true;
                }
            ...
            case 8:
                ...
                if (view instanceof org.telegram.ui.Components.ex0) {
                    ((org.telegram.ui.Components.ex0) view).a(jm0Var.i0);
                }
                if (view == jm0Var.s) {
                    return true;
                }
            ...
            case 13:
                ...
                if (view == n70Var.b && n70Var.x != null) {
                    int measuredHeight = n70Var.s.getMeasuredHeight();
                    n70Var.x.setBounds(0, measuredHeight, getMeasuredWidth(), n70Var.x.getIntrinsicHeight() + measuredHeight);
                    n70Var.x.draw(canvas);
                }
                return drawChild;
            case 17:
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.a) {
            case 16:
                ...
                accessibilityNodeInfo.setVisibleToUser(((ti1) this.b).B0);
                break;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                break;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            ...
            case 15:
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams7 = (ViewGroup.MarginLayoutParams) ih1Var.c.getLayoutParams();
                int i15 = 0;
                int dp = AndroidUtilities.dp(8.0f) + (ih1Var.a.getVisibility() == 8 ? AndroidUtilities.statusBarHeight : 0);
    ...
    public void setVisibility(int i10) {
        switch (this.a) {
            case 10:
                ...
                org.telegram.ui.Components.u9 u9Var = zw0Var.b;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ dc1(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
