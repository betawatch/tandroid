...
public class tz0 extends org.telegram.ui.Components.p9 implements org.telegram.ui.Components.nv0 {
    ...
    public boolean U;
    public float V;
    public org.telegram.ui.Components.vh0 W;
    public boolean a0;
    public float b0;
    public Runnable c0;
    ...
    public final void invalidate() {
        super.invalidate();
        org.telegram.ui.Components.vh0 vh0Var = this.W;
        if (vh0Var != null) {
            vh0Var.invalidate();
        }
    ...
    public final void onDraw(Canvas canvas) {
        org.telegram.ui.Components.mh0 mh0Var;
        boolean z4;
        float f10;
        float f11;
        char c3;
        ...
        org.telegram.ui.Components.vh0 vh0Var = this.W;
        boolean z10 = vh0Var != null && vh0Var.getVisibility() == 0 && this.J && this.E > 0.0f;
        if (z10) {
            org.telegram.ui.Components.mh0 blurDrawer = this.W.getBlurDrawer();
            mh0Var = blurDrawer;
            z10 = blurDrawer != null;
        } else {
            mh0Var = null;
        ...
        if (z4) {
            ...
            float f25 = y10 * f10;
            mh0Var.f(canvas, this, f16 - f25, f24 - f25, true, (this.D || mh0Var.a || this.W.getRealPosition() == 0) ? 1.0f - this.E : 1.0f, f12);
        }
        canvas.restore();
    }
    ...
    public void setAvatarsViewPager(org.telegram.ui.Components.vh0 vh0Var) {
        this.W = vh0Var;
    }
