...
public final /* synthetic */ class be0 implements Runnable {
    ...
    public /* synthetic */ be0(fe0 fe0Var, TLRPC.TL_error tL_error, String str, String str2, TLObject tLObject) {
        this.b = fe0Var;
        this.c = tL_error;
        this.d = str;
        this.e = str2;
        ...
        switch (i11) {
            ...
            default:
                ...
                if (tL_error != null && ("SRP_ID_INVALID".equals(tL_error.text) || "NEW_SALT_INVALID".equals(tL_error.text))) {
                    ...
                    ConnectionsManager.getInstance(i10).sendRequest(getpassword, new ee0(fe0Var, str2, str, i12), 8);
                    break;
                } else {
                    ...
                    if (!(tLObject instanceof TLRPC.auth_Authorization)) {
                        if (tL_error != null) {
                            ...
                            if (!tL_error.text.startsWith("FLOOD_WAIT")) {
                                ...
                                pg0Var.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue < 60 ? LocaleController.formatPluralString("Seconds", intValue, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue / 60, new Object[0])));
                                break;
                            }
                        }
                    } else {
    ...
    public /* synthetic */ be0(fe0 fe0Var, TLRPC.TL_error tL_error, TLObject tLObject, String str, String str2) {
        this.b = fe0Var;
        this.c = tL_error;
        this.f = tLObject;
        this.d = str;
