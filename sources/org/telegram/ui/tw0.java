    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 >= i12 && i10 < premiumPreviewFragment.r) {
            ((lw0) view).a((bx0) premiumPreviewFragment.b.get(i10 - i12), i10 != premiumPreviewFragment.r - 1);
            return;
        }
        int i13 = premiumPreviewFragment.v;
        if (i10 >= i13 && i10 < premiumPreviewFragment.w) {
            ((lw0) view).a((bx0) premiumPreviewFragment.c.get(i10 - i13), i10 != premiumPreviewFragment.w - 1);
            return;
        }
        String str3 = "";
        ...
        if (!z10) {
            e9Var2.setTextColor(org.telegram.ui.ActionBar.h6.l1(0.75f, -1));
            e9Var2.getTextView().setLinkTextColor(-1);
            e9Var2.setLinkTextRippleColor(Integer.valueOf(org.telegram.ui.ActionBar.h6.l1(0.15f, -1)));
        }
        e9Var2.setFixedSize(0);
        if (i10 == premiumPreviewFragment.H) {
            e9Var2.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ShowAdsInfo), new il0(this, 23)), true));
            return;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 7:
                ...
                break;
            case 8:
                d6Var = ((org.telegram.ui.ActionBar.m2) this.c).resourceProvider;
