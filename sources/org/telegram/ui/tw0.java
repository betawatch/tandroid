    ...
    */
    public final void v(f2.n1 n1Var, int i10) {
        ...
        if (i24 == 0) {
            ...
            y9Var.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.g6.G6));
            if (i10 == privacyControlActivity.O) {
                ...
                if (i23 == 10) {
                    y9Var.c(LocaleController.getString(R.string.PrivateMessagesExceptions), formatPluralString, false, false);
                } else if (i23 == 0 || i23 == 4 || i23 == 9 || i23 == 14) {
                    y9Var.c(LocaleController.getString(R.string.AlwaysShareWith), formatPluralString, false, privacyControlActivity.P != -1);
                } else {
                    y9Var.c(LocaleController.getString(R.string.AlwaysAllow), formatPluralString, false, privacyControlActivity.P != -1);
                }
                if (i23 == 12) {
                    y9Var.setEnabled(!privacyControlActivity.u0());
                    return;
                }
                return;
            }
            if (i10 != privacyControlActivity.P) {
                if (i10 == privacyControlActivity.X) {
                    ...
                    y9Var.c(LocaleController.getString(R.string.PrivacyP2P2), ContactsController.getInstance(i11).getLoadingPrivacyInfo(3) ? LocaleController.getString(R.string.Loading) : PrivacySettingsActivity.x0(3, privacyControlActivity.getAccountInstance()), false, false);
                    return;
                } else {
                    if (i10 == privacyControlActivity.a0) {
                        y9Var.b(LocaleController.getString(privacyControlActivity.getUserConfig().isPremium() ? R.string.PrivacyLastSeenPremiumForPremium : R.string.PrivacyLastSeenPremium), false);
                        y9Var.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.g6.n6));
                        return;
                    }
                    return;
                }
            ...
            if (i23 == 0 || i23 == 4 || i23 == 9 || i23 == 14) {
                y9Var.c(LocaleController.getString(R.string.NeverShareWith), formatPluralString2, false, false);
            } else {
                y9Var.c(LocaleController.getString(R.string.NeverAllow), formatPluralString2, false, false);
            }
            if (i23 == 12) {
                y9Var.setEnabled(!privacyControlActivity.u0());
                return;
        ...
        if (i24 == 1) {
            ...
            if (i10 == privacyControlActivity.M) {
                y8Var.setText(LocaleController.getString(R.string.PrivateMessagesChargePriceInfo));
            } else {
                ...
                if (i10 == i34 && i23 == 10) {
                    ...
                    y8Var.setText(AndroidUtilities.replaceSingleTag(string, new Runnable(this) { // from class: org.telegram.ui.qw0
                        ...
                        public final void run() {
                            switch (i35) {
                                ...
                                default:
                                    ...
                                    privacyControlActivity2.showDialog(org.telegram.ui.Components.c5.m(privacyControlActivity2.getParentActivity(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new rw0(tw0Var, 1), null, false, false, privacyControlActivity2.getResourceProvider()).a);
                                    break;
                            }
                        }
                    }));
                } else if (i10 == i34 && i23 == 8) {
                    y8Var.setText(LocaleController.getString(R.string.PrivacyVoiceMessagesInfo));
                } else {
                    i12 = privacyControlActivity.setBirthdayRow;
                    if (i10 == i12) {
                        y8Var.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.PrivacyBirthdaySet), new Runnable(this) { // from class: org.telegram.ui.qw0
                            public final /* synthetic */ tw0 b;
                        ...
                        if (i23 == 6) {
                            if (privacyControlActivity.E == 1 && privacyControlActivity.F == 1) {
                                y8Var.setText(LocaleController.getString(R.string.PrivacyPhoneInfo3));
                            } else {
                                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                                Locale locale = Locale.ENGLISH;
                                String e10 = u3.c.e("https://t.me/+", privacyControlActivity.getUserConfig().getClientPhone());
                                SpannableString spannableString = new SpannableString(e10);
                                spannableString.setSpan(new sw0(this, e10), 0, e10.length(), 33);
                            ...
                            y8Var.setText(LocaleController.getString(R.string.PrivacyForwardsInfo));
                        } else if (i23 == 4) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyProfilePhotoInfo));
                        } else if (i23 == 9) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyBioInfo3));
                        } else if (i23 == 14) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyMusicInfo3));
                        } else if (i23 == 11) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyBirthdayInfo));
                        } else if (i23 == 12) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyGiftsInfo));
                        } else if (i23 == 3) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyCallsP2PHelp));
                        } else if (i23 == 2) {
                            y8Var.setText(LocaleController.getString(R.string.WhoCanCallMeInfo));
                        } else if (i23 == 1) {
                            y8Var.setText(LocaleController.getString(R.string.WhoCanAddMeInfo));
                        } else {
                            y8Var.setText(LocaleController.getString(R.string.CustomHelp));
                        }
                    } else if (i10 == privacyControlActivity.Q) {
                        if (i23 == 6) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyPhoneInfo2));
                        } else if (i23 == 5) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyForwardsInfo2));
                        } else if (i23 == 4) {
                            int i36 = privacyControlActivity.E;
                            if (i36 == 2) {
                                y8Var.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PrivacyProfilePhotoInfo5)));
                            } else if (i36 == 0) {
                                y8Var.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PrivacyProfilePhotoInfo3)));
                            } else {
                                y8Var.setText(LocaleController.getString(R.string.PrivacyProfilePhotoInfo4));
                            }
                        } else if (i23 == 3) {
                            y8Var.setText(LocaleController.getString(R.string.CustomP2PInfo));
                        } else if (i23 == 9) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyBioInfo));
                        } else if (i23 == 14) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyMusicInfo));
                        } else if (i23 == 11) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyBirthdayInfo3));
                        } else if (i23 == 2) {
                            y8Var.setText(LocaleController.getString(R.string.CustomCallInfo));
                        } else if (i23 == 1) {
                            y8Var.setText(LocaleController.getString(R.string.CustomShareInfo));
                        } else if (i23 == 12) {
                            y8Var.setText(LocaleController.getString(R.string.CustomShareGiftsInfo));
                        } else if (i23 == 8) {
                            y8Var.setText(LocaleController.getString(R.string.PrivacyVoiceMessagesInfo2));
                        } else if (i23 == 10) {
                            y8Var.setText(LocaleController.getString(R.string.PrivateMessagesExceptionsInfo));
                        } else {
                            y8Var.setText(LocaleController.getString(R.string.CustomShareSettingsHelp));
                        }
                    } else if (i10 == privacyControlActivity.V) {
                        y8Var.setText(LocaleController.getString(R.string.PhotoForRestDescription));
                    } else if (i10 == privacyControlActivity.Z) {
                        y8Var.setText(LocaleController.getString(R.string.HideReadTimeInfo));
                    } else if (i10 == privacyControlActivity.b0) {
                        y8Var.setText(LocaleController.getString(privacyControlActivity.getUserConfig().isPremium() ? R.string.PrivacyLastSeenPremiumInfoForPremium : R.string.PrivacyLastSeenPremiumInfo));
                    } else if (i10 == privacyControlActivity.f0) {
                        y8Var.setText(LocaleController.formatString(R.string.PrivateMessagesPriceInfo, ph.j.G0(privacyControlActivity.getMessagesController().starsPaidMessageCommissionPermille), String.valueOf(((int) (((privacyControlActivity.H * (privacyControlActivity.getMessagesController().starsPaidMessageCommissionPermille / 1000.0f)) / 1000.0d) * privacyControlActivity.getMessagesController().starsUsdWithdrawRate1000)) / 100.0d)));
                    } else if (i10 == privacyControlActivity.g0) {
                        SpannableString spannableString2 = new SpannableString(ImageLoader.AUTOPLAY_FILTER);
                        org.telegram.ui.Components.iq iqVar = new org.telegram.ui.Components.iq(R.drawable.msg_input_gift, 0);
                        iqVar.setScale(0.583f, 0.583f);
                        spannableString2.setSpan(iqVar, 0, 1, 33);
                        y8Var.setText(LocaleController.formatSpannable(R.string.PrivacyGiftsShowIconInfo, spannableString2));
                    } else if (i10 == privacyControlActivity.m0) {
                        y8Var.setText(LocaleController.getString(R.string.PrivacyGiftsTypeInfo));
                    }
                }
            }
        ...
        if (i24 == 2) {
            ...
            if (i10 != privacyControlActivity.J) {
                if (i10 == privacyControlActivity.N) {
                    if (i23 == 10) {
                        k4Var.setText(LocaleController.getString(R.string.PrivateMessagesExceptionsHeader));
                        return;
                    } else {
                        k4Var.setText(LocaleController.getString(R.string.AddExceptions));
                        return;
                    }
                }
                if (i10 == privacyControlActivity.W) {
                    k4Var.setText(LocaleController.getString(R.string.PrivacyP2PHeader));
                    return;
                }
                if (i10 == privacyControlActivity.R) {
                    k4Var.setText(LocaleController.getString(R.string.PrivacyPhoneTitle2));
                    return;
                }
                if (i10 == privacyControlActivity.d0) {
                    k4Var.setText(LocaleController.getString(R.string.PrivateMessagesPriceHeader));
                    return;
                }
                i13 = privacyControlActivity.giftTypesHeaderRow;
                if (i10 == i13) {
                    k4Var.setText(LocaleController.getString(R.string.PrivacyGiftsTypeHeader));
                    return;
                }
                return;
            }
            if (i23 == 6) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyPhoneTitle));
                return;
            }
            if (i23 == 5) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyForwardsTitle));
                return;
            }
            if (i23 == 4) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyProfilePhotoTitle));
                return;
            }
            if (i23 == 9) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyBioTitle));
                return;
            }
            if (i23 == 14) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyMusicTitle));
                return;
            }
            if (i23 == 3) {
                k4Var.setText(LocaleController.getString(R.string.P2PEnabledWith));
                return;
            }
            if (i23 == 2) {
                k4Var.setText(LocaleController.getString(R.string.WhoCanCallMe));
                return;
            }
            if (i23 == 1) {
                k4Var.setText(LocaleController.getString(R.string.WhoCanAddMe));
                return;
            }
            if (i23 == 8) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyVoiceMessagesTitle));
                return;
            }
            if (i23 == 10) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyMessagesTitle));
                return;
            }
            if (i23 == 11) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyBirthdayTitle));
                return;
            } else if (i23 == 12) {
                k4Var.setText(LocaleController.getString(R.string.PrivacyGiftsTitle));
                return;
            } else {
                k4Var.setText(LocaleController.getString(R.string.LastSeenTitle));
                return;
            }
        }
        if (i24 != 3) {
            if (i24 != 8) {
                ...
                if (i10 == i22) {
                    int[] a2 = org.telegram.ui.Cells.v7.a((int) privacyControlActivity.getMessagesController().starsPaidMessageAmountMax, new int[]{1, 10, 50, 100, 200, MediaDataController.MAX_LINKS_COUNT, 400, 500, MediaDataController.MAX_STYLE_RUNS_COUNT, 2500, 5000, 7500, 9000, 10000});
                    zk0 zk0Var = new zk0(this, i25);
                    org.telegram.ui.Cells.u7 u7Var = new org.telegram.ui.Cells.u7();
                    u7Var.c = a2;
                    u7Var.d = 20;
                    u7Var.e = zk0Var;
                    v7Var.d((int) Utilities.clamp(privacyControlActivity.H, privacyControlActivity.getMessagesController().starsPaidMessageAmountMax, 1L), u7Var, new rw0(this, r8 ? 1 : 0));
                    return;
                }
                return;
            }
            ...
            if (i10 == i20) {
                q8Var.f(LocaleController.getString(R.string.HideReadTime), privacyControlActivity.x0, false);
                return;
            }
            i21 = privacyControlActivity.showGiftIconRow;
            if (i10 == i21) {
                q8Var.f(LocaleController.getString(R.string.PrivacyGiftsShowIcon), privacyControlActivity.z0, false);
                return;
            }
            if (i10 == privacyControlActivity.h0) {
                q8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypeUnlimited), privacyControlActivity.B0, true);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.B0) {
                    i27 = R.drawable.permission_locked;
                }
                q8Var.setCheckBoxIcon(i27);
                return;
            }
            if (i10 == privacyControlActivity.i0) {
                q8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypeLimited), privacyControlActivity.D0, true);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.D0) {
                    i28 = R.drawable.permission_locked;
                }
                q8Var.setCheckBoxIcon(i28);
                return;
            }
            if (i10 == privacyControlActivity.j0) {
                q8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypeUnique), privacyControlActivity.F0, true);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.F0) {
                    i29 = R.drawable.permission_locked;
                }
                q8Var.setCheckBoxIcon(i29);
                return;
            }
            if (i10 == privacyControlActivity.k0) {
                q8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypeFromChannels), privacyControlActivity.H0, true);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.H0) {
                    i30 = R.drawable.permission_locked;
                }
                q8Var.setCheckBoxIcon(i30);
                return;
            }
            if (i10 == privacyControlActivity.l0) {
                q8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypePremium), privacyControlActivity.J0, false);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.J0) {
                    i31 = R.drawable.permission_locked;
                }
                q8Var.setCheckBoxIcon(i31);
                return;
            }
            return;
        }
        org.telegram.ui.Cells.h6 h6Var = (org.telegram.ui.Cells.h6) view;
        h6Var.setRadioIcon(null);
        ...
        if (i10 != i14 && i10 != privacyControlActivity.K) {
            ...
            if (i10 != i19 && i10 != privacyControlActivity.c0) {
                if (i10 == privacyControlActivity.T) {
                    h6Var.c(LocaleController.getString(R.string.LastSeenContacts), privacyControlActivity.F == 1, false);
                } else if (i10 == privacyControlActivity.S) {
                    h6Var.c(LocaleController.getString(R.string.LastSeenEverybody), privacyControlActivity.F == 0, true);
                }
                if (i23 != 12) {
                    h6Var.b(null, !privacyControlActivity.u0());
                    return;
                }
                return;
            }
        ...
        if (i10 == i15) {
            if (i23 == 3) {
                h6Var.c(LocaleController.getString(R.string.P2PEverybody), privacyControlActivity.E == 0, true);
            } else {
                h6Var.c(LocaleController.getString(R.string.LastSeenEverybody), privacyControlActivity.E == 0, true);
            }
            ...
            if ((i23 == 8 && !privacyControlActivity.getUserConfig().isPremium()) || (i23 == 10 && !privacyControlActivity.getMessagesController().newNoncontactPeersRequirePremiumWithoutOwnpremium && !privacyControlActivity.getUserConfig().isPremium())) {
                h6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            if (i23 == 3) {
                ...
                h6Var.c(string2, z10, (i18 == -1 && privacyControlActivity.c0 == -1) ? false : true);
            } else if (i23 == 10) {
                ...
                h6Var.c(string3, z11, (i17 == -1 && privacyControlActivity.c0 == -1) ? false : true);
            } else {
                ...
                h6Var.c(string4, z12, (i16 == -1 && privacyControlActivity.c0 == -1) ? false : true);
            }
        } else if (i10 == privacyControlActivity.c0) {
            if (i23 == 10 && !privacyControlActivity.getUserConfig().isPremium()) {
                h6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            h6Var.c(LocaleController.getString(R.string.PrivateMessagesChargePrice), privacyControlActivity.E == 3, false);
        } else {
            if ((i23 == 8 && !privacyControlActivity.getUserConfig().isPremium()) || (i23 == 10 && !privacyControlActivity.getMessagesController().newNoncontactPeersRequirePremiumWithoutOwnpremium && !privacyControlActivity.getUserConfig().isPremium())) {
                h6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            if (i23 == 3) {
                h6Var.c(LocaleController.getString(R.string.P2PNobody), privacyControlActivity.E == 1, false);
            } else {
                h6Var.c(LocaleController.getString(R.string.LastSeenNobody), privacyControlActivity.E == 1, false);
            }
        }
        if (i23 != 12) {
        }
    ...
    public final f2.n1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 6:
                ...
                privacyControlActivity.q0 = m8Var;
                ...
                privacyControlActivity.p0 = new org.telegram.ui.Components.xi0(R.raw.camera_outline, "" + R.raw.camera_outline, AndroidUtilities.dp(50.0f), AndroidUtilities.dp(50.0f), false, null);
                ...
                break;
            case 7:
                privacyControlActivity.r0 = new org.telegram.ui.Components.t9(privacyControlActivity.getParentActivity());
                privacyControlActivity.s0 = new fs(this, privacyControlActivity.getParentActivity());
                TLRPC.PhotoSize photoSize = privacyControlActivity.t0;
                if (photoSize != null) {
                    TLRPC.Photo photo = privacyControlActivity.u0;
                    if (photo != null) {
                        org.telegram.ui.Components.t9 t9Var = privacyControlActivity.r0;
                        ...
                        org.telegram.ui.Components.t9 t9Var2 = privacyControlActivity.r0;
                ...
                privacyControlActivity.s0.addView(privacyControlActivity.r0, i7.f6.d(30, 30.0f, 16, 21.0f, 0.0f, 21.0f, 0.0f));
                ...
                fs fsVar = privacyControlActivity.s0;
