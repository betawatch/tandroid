    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i60Var.d2 != 1.0f) {
            if (i60Var.X2 != null && i60Var.b3) {
                ...
                float f7 = (1.0f - i60Var.d2) * measuredHeight;
                ...
                i60Var.X2.getAvatarImageView().r(i10, i10, i11, i11);
                ...
                canvas.restore();
            } else if (i60Var.a3 != null && i60Var.Z2 == null && i60Var.O2) {
                canvas.save();
                float measuredHeight2 = (i60Var.a3.getAvatarImageView().getMeasuredHeight() / 2.0f) * (getMeasuredHeight() / i60Var.a3.getAvatarImageView().getMeasuredHeight());
                float f11 = (1.0f - i60Var.d2) * measuredHeight2;
                float dp2 = AndroidUtilities.dp(13.0f);
                float f12 = i60Var.d2;
                int i12 = (int) ((dp2 * f12) + f11);
                int i13 = (int) ((1.0f - f12) * measuredHeight2);
                i60Var.a3.getAvatarImageView().getImageReceiver().setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                i60Var.a3.getAvatarImageView().r(i12, i12, i13, i13);
                i60Var.a3.getAvatarImageView().getImageReceiver().draw(canvas);
                i60Var.a3.getAvatarImageView().setRoundRadius(i60Var.a3.getAvatarImageView().getMeasuredHeight() / 2);
                canvas.restore();
            }
        }
        c40Var.setAlpha(i60Var.d2);
        Path path = this.c;
        path.reset();
