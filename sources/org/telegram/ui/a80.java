...
public final class a80 extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    ...
    public a80(c80 c80Var, Context context, org.telegram.ui.ActionBar.x1 x1Var) {
        super(context);
        this.f = c80Var;
        this.a = new Paint(1);
        this.b = new Path();
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.l1(0.6f, c80Var.getThemedColor(i10)), PorterDuff.Mode.SRC_IN));
        ...
        fVar.addTextChangedListener(new z70(this));
        if (Build.VERSION.SDK_INT >= 35) {
            fVar.setLocalePreferredLineHeightForMinimumUsed(false);
        }
        fVar.setTextColor(c80Var.getThemedColor(i10));
        fVar.setHintTextColor(c80Var.getThemedColor(org.telegram.ui.ActionBar.j6.H6));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        c80 c80Var = this.f;
        paint.setColor(c80Var.getThemedColor(i10));
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f), getWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f) + c80Var.b.e + AndroidUtilities.dp(3.0f));
        Path path = this.b;
        path.rewind();
        path.addRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), Path.Direction.CW);
        GradientDrawable gradientDrawable = this.e;
        if (gradientDrawable != null) {
            gradientDrawable.setBounds(0, 0, getWidth(), Math.min(getHeight(), AndroidUtilities.dp(24.0f) + ((int) c80Var.b.e)));
            this.e.draw(canvas);
        }
        canvas.save();
