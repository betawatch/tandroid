...
public class ContactsActivity extends org.telegram.ui.ActionBar.p2 implements le.d, NotificationCenter.NotificationCenterDelegate, eh0, oh.d {
    ...
    public final int a;
    public org.telegram.ui.ActionBar.d2 a0;
    public final le.b b;
    public boolean b0;
    public final le.b c;
    public boolean c0;
    ...
    public org.telegram.ui.ActionBar.i2 h0;
    public String i0;
    public boolean j0;
    public long k0;
    public boolean l0;
    ...
    public org.telegram.ui.Components.h20 w;
    public zg.k w0;
    public boolean x;
    ...
    public ContactsActivity(Bundle bundle) {
        ...
        this.b = new le.b(0, this, wrVar, 350L, false);
        ...
        if (i10 >= 31) {
            this.t0 = new zg.e(false);
            this.u0 = new eh.d(null);
            this.v0 = new eh.d(null);
        } else {
            this.t0 = null;
            this.u0 = null;
            this.v0 = null;
    ...
    public static void U(ContactsActivity contactsActivity, int i10, View view, int i11) {
        ...
        if (adapter == atVar) {
            ...
            at atVar2 = contactsActivity.r;
            int size = atVar2.d.size();
            int size2 = atVar2.H.size();
            fg.d2 d2Var = atVar2.f;
        ...
        if ((view instanceof ViewGroup) && (((ViewGroup) view).getChildAt(0) instanceof org.telegram.ui.Components.yq)) {
            org.telegram.ui.Components.h20 h20Var = contactsActivity.w;
            if (h20Var != null) {
                h20Var.performClick();
                return;
            }
        ...
        if (!iVar.i() && (view instanceof org.telegram.ui.Cells.bb)) {
        ...
        if ((contactsActivity.G && i10 == 0) || S != 0) {
            ...
            if (O instanceof ContactsController.Contact) {
                ...
                alertDialog$Builder.k(LocaleController.getString(R.string.OK), new org.telegram.ui.Components.km(17, contactsActivity, str2));
    ...
    public static void d0(ContactsActivity contactsActivity) {
        ...
        while (true) {
            ...
            if (R == 0) {
                ...
                org.telegram.ui.Components.vl0 vl0Var = contactsActivity.f;
                X.a(rect, childAt, vl0Var, vl0Var.t0);
    ...
    public static void e0(ContactsActivity contactsActivity) {
        ...
        h20Var.e((!contactsActivity.x || contactsActivity.F || btVar.I) ? false : true, true);
    }
    ...
    public final boolean S(MotionEvent motionEvent, boolean z10) {
        ...
        return vl0Var == null || vl0Var.getFastScroll() == null || !this.f.getFastScroll().n;
    }
    ...
    public final View createView(Context context) {
        ...
        if (this.I) {
            ...
            this.e0.setImageDrawable(new org.telegram.ui.ActionBar.i2(true));
            ...
            this.e0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.xs
            ...
            j3.addView(this.e0, w7.a6.q(54, 54, 16));
        }
        ...
        j3.addView(this.f0, w7.a6.m(1.0f, 0, -1, this.I ? 18 : 72, 0, 0));
        int i13 = 2;
        this.f0.setOnTouchListener(new ai.h(i13));
        ...
        this.f = new org.telegram.ui.Components.vl0(context, null);
        this.r = new at(this, context, this.d0, this.V, this.O, this.N);
        int i14 = 3;
        if (this.T != 0) {
        ...
        bt btVar = new bt(this, context, this.G ? 1 : 0, this.H, this.d0, i10);
        this.d = btVar;
        if (this.s == null) {
            i13 = 0;
        } else if (this.v) {
        ...
        this.w0 = new zg.k(vl0Var, w8Var, new ys(vl0Var, i11));
        this.f.C0(new vs(this, i12));
        ...
        this.y.addView(this.e, w7.a6.d(-1, -1.0f, 119, 12.0f, 64.0f, 12.0f, 0.0f));
        s4.j jVar = new s4.j();
        jVar.C = false;
        jVar.n(150L);
        jVar.m = false;
        ...
        org.telegram.ui.Components.yk0 yk0Var = new org.telegram.ui.Components.yk0(this.f, this.n);
        this.h = yk0Var;
        ...
        this.y.addView(this.Z, w7.a6.d(-1, 52.0f, 48, 6.0f, 0.0f, 6.0f, 0.0f));
        this.f.setEmptyView(this.e);
        org.telegram.ui.Components.vl0 vl0Var4 = this.f;
        vl0Var4.Y1 = true;
        vl0Var4.Z1 = 0;
        vl0Var4.setOnItemClickListener(new i2.s(this, i10, 9));
        this.f.setOnItemLongClickListener(new ws(this));
        this.f.setOnScrollListener(new ct(this));
        if (!this.L && !this.K) {
            org.telegram.ui.Components.h20 h20Var = new org.telegram.ui.Components.h20(context, this.resourceProvider, false);
            this.w = h20Var;
            this.y.addView(h20Var, org.telegram.ui.Components.h20.b());
            this.w.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.xs
                public final /* synthetic */ ContactsActivity b;
            ...
            this.w.c.getAnimatedDrawable().M(this.w.c.getAnimatedDrawable().e[0] - 1);
        ...
        this.Y = s7Var;
        s7Var.b(false, false);
        this.y.addView(this.Y, w7.a6.e(-1, 5, 48));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (((MessagesController.UPDATE_MASK_AVATAR & intValue) != 0 || (MessagesController.UPDATE_MASK_NAME & intValue) != 0 || (MessagesController.UPDATE_MASK_STATUS & intValue) != 0) && (vl0Var = this.f) != null) {
            int childCount = vl0Var.getChildCount();
    ...
    public final void f0(boolean z10) {
        ...
        if (z10 && this.b0) {
            showDialog(org.telegram.ui.Components.d5.w(parentActivity, new us(this, 1)).a);
            return;
        }
    ...
    public final void g0() {
        zg.e eVar;
        if (Build.VERSION.SDK_INT < 31 || (eVar = this.t0) == null) {
            return;
        }
        ...
        eVar.g(this.I ? 2 : 1, this.x0);
        eVar.e(this.w0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, TLObject.FLAG_19, new Class[]{org.telegram.ui.Cells.r4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.bb.class}, new String[]{"nameTextView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.bb.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.bb.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.bb.class}, null, org.telegram.ui.ActionBar.j6.r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 262148, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 262148, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.o6));
        ...
        org.telegram.ui.Components.h20 h20Var = this.w;
        if (h20Var != null) {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.j6.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.i1}, null, org.telegram.ui.ActionBar.j6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.j6.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f1}, null, org.telegram.ui.ActionBar.j6.z9));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.j6.class}, org.telegram.ui.ActionBar.j6.Q0, null, null, org.telegram.ui.ActionBar.j6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.j6.class}, org.telegram.ui.ActionBar.j6.P0, null, null, org.telegram.ui.ActionBar.j6.p6));
        TextPaint[] textPaintArr = org.telegram.ui.ActionBar.j6.B0;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.j6.class}, null, new Paint[]{textPaintArr[0], textPaintArr[1], org.telegram.ui.ActionBar.j6.D0}, null, -1, null, org.telegram.ui.ActionBar.j6.X8));
        TextPaint[] textPaintArr2 = org.telegram.ui.ActionBar.j6.C0;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 0, new Class[]{org.telegram.ui.Cells.j6.class}, null, new Paint[]{textPaintArr2[0], textPaintArr2[1], org.telegram.ui.ActionBar.j6.E0}, null, -1, null, org.telegram.ui.ActionBar.j6.Z8));
        return arrayList;
    }
    ...
    public final void h0() {
        ...
        if (jx0Var != null) {
            jx0Var.b(Math.max(this.q0 + this.n0, this.r0), false);
        }
    }
    ...
    public final void i0() {
        org.telegram.ui.Components.h20 h20Var = this.w;
        if (h20Var != null) {
            h20Var.setTranslationY(((-this.q0) - this.o0) - this.p0);
        }
    }
    ...
    public final void k0() {
        org.telegram.ui.Components.h20.d(this.g0, (1.0f - this.c.e) * (1.0f - this.b.e));
    }

    public final void l0() {
        bt btVar = this.d;
        boolean z10 = btVar != null && btVar.I;
    ...
    public final void m0() {
        ...
        bt btVar = this.d;
        org.telegram.ui.Components.h20.d(this.s, f7 * ((btVar == null || btVar.I) ? 0.0f : 1.0f));
    }
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (parentActivity.checkSelfPermission("android.permission.READ_CONTACTS") != 0) {
            ...
            org.telegram.ui.ActionBar.d2 d2Var = org.telegram.ui.Components.d5.w(parentActivity, new us(this, 0)).a;
            this.a0 = d2Var;
            showDialog(d2Var);
        }
    }
    ...
    public final void onDialogDismiss(Dialog dialog) {
        ...
        if (d2Var == null || dialog != d2Var || getParentActivity() == null || !this.b0) {
            return;
        }
        f0(false);
    }
    ...
    public final void r0(ViewGroup viewGroup) {
        ...
        if (z11) {
            ...
            if (!(viewGroup instanceof org.telegram.ui.Cells.j6)) {
                return;
            }
