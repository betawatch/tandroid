...
public final class fu extends org.telegram.ui.Components.ll0 {
    public final Context c;
    public final /* synthetic */ DataAutoDownloadActivity d;

    public fu(DataAutoDownloadActivity dataAutoDownloadActivity, Context context) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i23 == 0) {
            ...
            if (i10 == i11) {
                ...
                x8Var.setTag(Integer.valueOf(preset.enabled ? org.telegram.ui.ActionBar.h6.f6 : org.telegram.ui.ActionBar.h6.e6));
                x8Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, preset.enabled ? org.telegram.ui.ActionBar.h6.f6 : org.telegram.ui.ActionBar.h6.e6, false));
                return;
            }
            return;
        }
        ...
        if (i23 == 3) {
            dataAutoDownloadActivity.m0((org.telegram.ui.Components.tv0) view);
            return;
        }
        int i25 = -1;
        if (i23 != 4) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            tv0Var.setCallback(new eu(this, 0));
            view = tv0Var;
        }
