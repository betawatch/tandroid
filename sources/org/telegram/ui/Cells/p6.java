...
public class p6 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.v9 f;
    ...
    public p6(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        addView(o6Var, w7.y5.i(f7, f7, 8388627, 10.0f, 0.0f, 0.0f, 0.0f));
        if (i10 == 1) {
        ...
        addView(j5Var, w7.y5.i(-1.0f, -2.0f, 55, f11, i10 == 1 ? 24.0f : 19.0f, 20.0f, 0.0f));
        if (z11) {
    ...
    */
    public final void c(TLRPC.User user, TLRPC.Chat chat, TLRPC.Reaction reaction, boolean z10, long j3, TL_stories.StoryItem storyItem, boolean z11, boolean z12, boolean z13) {
        ...
        if (user == null) {
            ...
            org.telegram.ui.Components.v9 v9Var3 = this.h;
            if (storyItem == null) {
            }
            j10 = j3;
            if (j10 != 0) {
        ...
        this.c.h(ImageLocation.getForUserOrChat(i11, user2, 1), "50_50", g9Var2, user2);
        org.telegram.ui.Components.v9 v9Var22 = this.f;
        if (!z10) {
            if (v9Var22 != null) {
                v9Var22.setAnimatedEmojiDrawable(null);
            }
            Drawable mutate = getContext().getDrawable(R.drawable.media_like_active).mutate();
            v9Var22.setColorFilter(new PorterDuffColorFilter(-53704, PorterDuff.Mode.MULTIPLY));
            v9Var22.setImageDrawable(mutate);
            ...
            if (d.f != null) {
                ...
                if (v9Var22 != null) {
                    if (tL_availableReaction != null) {
                        v9Var22.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.j6.a7, 1.0f), tL_availableReaction);
                        z15 = true;
                    } else {
                        v9Var22.setImageDrawable(null);
                        z15 = false;
                    }
                    v9Var22.setColorFilter(null);
                } else {
                    z15 = false;
                }
            } else {
                ...
                if (v9Var22 != null) {
                    v9Var22.setAnimatedEmojiDrawable(p5Var);
                }
                z15 = true;
            }
        ...
        org.telegram.ui.Components.v9 v9Var32 = this.h;
        if (storyItem == null) {
            this.n = storyItem.id;
            if (v9Var32 != null) {
                ...
                if (messageMedia == null || (photo = messageMedia.photo) == null) {
                    if (messageMedia != null && (document = messageMedia.document) != null) {
                        v9Var = v9Var32;
                        v9Var.j(ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 35, false, null, true), storyItem.media.document), "22_35", null, null, -1, storyItem);
                    }
                    v9Var32.setRoundRadius(AndroidUtilities.dp(3.33f));
                } else {
                    v9Var = v9Var32;
                    v9Var.j(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(photo.sizes, 35, false, null, true), storyItem.media.photo), "22_35", null, null, -1, storyItem);
                }
                v9Var32 = v9Var;
                v9Var32.setRoundRadius(AndroidUtilities.dp(3.33f));
            }
