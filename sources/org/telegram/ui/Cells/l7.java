        ...
        switch (this.a) {
            ...
            case 19:
                ...
                if (ll0Var2.j2) {
                    ...
                    ll0Var2.M0(0.0f, ll0Var2.m2[0]);
                } else {
                    dp = AndroidUtilities.dp(12.0f);
                    ll0Var2.M0(0.0f, ll0Var2.getMeasuredHeight() - ll0Var2.m2[1]);
                }
                ll0Var2.h2.d.x0.scrollBy(0, dp);
                if (ll0Var2.i2) {
            ...
            case 24:
                ...
                View view = yw0Var.s;
                if (view == null) {
                    yw0Var.c.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).start();
                    return;
                }
                if (view.getVisibility() != 0) {
                    yw0Var.s.setVisibility(0);
                    yw0Var.s.setAlpha(0.0f);
                }
                yw0Var.s.animate().setListener(null).cancel();
                yw0Var.s.animate().alpha(1.0f).setDuration(150L).start();
                return;
            case 25:
