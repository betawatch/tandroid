        ...
        public void calculate() {
            ...
            for (int i41 = 0; i41 < size; i41++) {
                ...
                if (groupedMessagePosition14.maxX == this.maxX || (groupedMessagePosition14.flags & 2) != 0) {
                    groupedMessagePosition14.spanSize += NotificationCenter.userIsPremiumBlockedUpadted;
                }
            ...
            for (int i45 = 0; i45 < size; i45++) {
                ...
                if (groupedMessagePosition15.minX == 0) {
                    groupedMessagePosition15.spanSize += NotificationCenter.userIsPremiumBlockedUpadted;
                }
