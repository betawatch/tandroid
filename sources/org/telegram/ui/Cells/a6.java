...
public final class a6 implements l2 {
    ...
    public final void c() {
        ...
        n2Var.getOrCreateStoryViewer().F(this.b, null, arrayList2, 0, null, null, new jh.b7(this.c), false);
    }
    ...
    public final void e(p2 p2Var) {
        ...
        if (n2Var.getMessagesController().getStoriesController().I(p2Var.getDialogId())) {
            ...
            n2Var.getOrCreateStoryViewer().D(n2Var.getContext(), p2Var.getDialogId(), new jh.b7(this.c));
        }
    }
