...
public final class w extends FrameLayout implements Checkable {
    ...
    public w(Context context, boolean z10) {
        ...
        if (z10) {
            ...
            lh0Var2.setMinWidth(dp);
            lh0Var2.setMinimumWidth(dp);
    ...
    public final void a(boolean z10, boolean z11, boolean z12) {
        ...
        org.telegram.ui.q qVar = ((org.telegram.ui.p) z1Var.b).d;
        TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) z1Var.c;
        a0.h hVar = qVar.a;
        if (z10) {
            a(false, false, false);
    ...
    */
    public final void b(TLRPC.StickerSetCovered stickerSetCovered, boolean z10) {
        ...
        if (document == null) {
            ...
            org.telegram.ui.Components.n9 n9Var2 = this.d;
            if (document2 == null) {
            }
        }
        document2 = document;
        org.telegram.ui.Components.n9 n9Var22 = this.d;
        if (document2 == null) {
        }
    }
    ...
    public final void c(boolean z10) {
        if (this.a) {
            ...
            if (!z10) {
                ...
                lh0Var.setVisibility(this.w ? 4 : 0);
                lh0Var.setAlpha(f11);
                lh0Var.setScaleX(f11);
                lh0Var.setScaleY(f11);
                return;
            }
            this.n = z11 ? lh0Var2 : lh0Var;
            ...
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(lh0Var2, (Property<lh0, Float>) property, f10);
            Property property2 = View.SCALE_X;
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(lh0Var2, (Property<lh0, Float>) property2, f10);
            float[] fArr = {f10};
            Property property3 = View.SCALE_Y;
            animatorSet3.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(lh0Var2, (Property<lh0, Float>) property3, fArr), ObjectAnimator.ofFloat(lh0Var, (Property<lh0, Float>) property, f11), ObjectAnimator.ofFloat(lh0Var, (Property<lh0, Float>) property2, f11), ObjectAnimator.ofFloat(lh0Var, (Property<lh0, Float>) property3, f11));
            this.r.addListener(new lh.h9(this, 13));
