...
public final class w extends FrameLayout implements Checkable {
    ...
    public w(Context context, boolean z4) {
        ...
        if (z4) {
            ...
            this.e = ei0Var2;
            ei0Var2.setAllCaps(false);
            ei0Var2.setMinWidth(dp);
            ei0Var2.setMinimumWidth(dp);
            ei0Var2.setTextSize(1, 14.0f);
            int i10 = org.telegram.ui.ActionBar.j6.Rh;
            ei0Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
            ei0Var2.setText(LocaleController.getString(R.string.StickersRemove));
            ei0Var2.setBackground(org.telegram.ui.ActionBar.j6.G0(AndroidUtilities.dp(3.0f), org.telegram.ui.ActionBar.j6.w0(null, i10, false)));
            ei0Var2.setTypeface(AndroidUtilities.bold());
            k7.h6.a(ei0Var2, 8.0f, 0.0f, 8.0f, 0.0f);
            ei0Var2.setOutlineProvider(null);
            addView(ei0Var2, k7.b6.i(-2.0f, 28.0f, 8388661, 0.0f, 18.0f, 14.0f, 0.0f));
            a aVar = new a(this, 2);
            ei0Var.setOnClickListener(aVar);
            ei0Var2.setOnClickListener(aVar);
            c(false);
        } else {
            this.f = null;
            this.e = null;
    ...
    */
    ...
    public final void c(boolean z4) {
        if (this.a) {
            ...
            ei0 ei0Var2 = this.e;
            if (!z4) {
                ei0Var2.setVisibility(z10 ? 0 : 4);
                ei0Var2.setAlpha(f10);
                ei0Var2.setScaleX(f10);
                ei0Var2.setScaleY(f10);
                ei0Var.setVisibility(this.w ? 4 : 0);
                ei0Var.setAlpha(f11);
                ei0Var.setScaleX(f11);
                ei0Var.setScaleY(f11);
                return;
            }
            this.n = z10 ? ei0Var2 : ei0Var;
            ei0Var.setVisibility(0);
            ei0Var2.setVisibility(0);
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.r = animatorSet2;
            animatorSet2.setDuration(250L);
            AnimatorSet animatorSet3 = this.r;
            Property property = View.ALPHA;
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(ei0Var2, (Property<ei0, Float>) property, f10);
            Property property2 = View.SCALE_X;
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(ei0Var2, (Property<ei0, Float>) property2, f10);
            float[] fArr = {f10};
            Property property3 = View.SCALE_Y;
            animatorSet3.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(ei0Var2, (Property<ei0, Float>) property3, fArr), ObjectAnimator.ofFloat(ei0Var, (Property<ei0, Float>) property, f11), ObjectAnimator.ofFloat(ei0Var, (Property<ei0, Float>) property2, f11), ObjectAnimator.ofFloat(ei0Var, (Property<ei0, Float>) property3, f11));
            this.r.addListener(new org.telegram.ui.s5(this, r2));
