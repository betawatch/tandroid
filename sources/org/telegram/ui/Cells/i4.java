...
public final class i4 implements DownloadController.FileDownloadProgressListener {
    ...
    public i4(t1 t1Var, MessageObject messageObject, TLRPC.MessageExtendedMedia messageExtendedMedia, boolean z10, int i10, int i11) {
        ...
        if (this.x) {
            int i12 = this.J;
            this.K = i12;
            this.L = new h01(AndroidUtilities.formatLongDuration(i12), 12.0f, null);
        }
    ...
    public final void c(TLRPC.MessageExtendedMedia messageExtendedMedia, MessageObject messageObject) {
        ...
        if (z10) {
            this.h = true;
            this.v = null;
            this.f.setImage(ImageLocation.getForObject(((TLRPC.TL_messageExtendedMediaPreview) messageExtendedMedia).thumb, messageObject.messageOwner), p6.t(k10, "_b2"), null, null, messageObject, 0);
