...
public final class i4 {
    ...
    public i4(s1 s1Var) {
        this.a = s1Var;
        this.l = gh.j.e(s1Var);
        this.j = new org.telegram.ui.Components.d6(s1Var, 0L, 350L, jr.h);
        this.n = new uc(s1Var);
    }
    ...
    public final void b(Canvas canvas) {
        ...
        while (true) {
            ...
            ImageReceiver imageReceiver = h4Var.f;
            ...
            float f19 = e11;
            s1 s1Var3 = s1Var2;
            imageReceiver.setImageCoords(i11 + i12, i13 + i14, h4Var.c - i12, h4Var.d - i14);
            imageReceiver.draw(canvas2);
            if (imageReceiver.getAnimation() != null) {
                imageReceiver.getAnimation().getClass();
                int round = Math.round(0 / 1000.0f);
                if (!h4Var.x && h4Var.G != (max = Math.max(0, h4Var.F - round))) {
                    h4Var.G = max;
                    h4Var.H = new zz0(AndroidUtilities.formatLongDuration(max), 12.0f, null);
                }
            }
            if (f19 > 0.0f) {
                float min = Math.min(this.d + h4Var.a, f15);
                float min2 = Math.min(this.e + h4Var.b, f14);
                f17 = Math.max(this.d + h4Var.c, f17);
                f16 = Math.max(this.e + h4Var.d, f16);
                RectF rectF2 = AndroidUtilities.rectTmp;
                float f20 = h4Var.a + this.d;
                int i15 = this.e;
                rectF2.set(f20, h4Var.b + i15, r9 + h4Var.c, i15 + h4Var.d);
                path3.addRoundRect(rectF2, h4Var.s, Path.Direction.CW);
                f14 = min2;
                f15 = min;
            }
        ...
        while (true) {
            ...
            h4 h4Var2 = (h4) arrayList.get(i18);
            if (h4Var2.H != null) {
                float dp = AndroidUtilities.dp(11.4f) + h4Var2.H.c;
                float dp2 = AndroidUtilities.dp(17.0f);
                float dp3 = AndroidUtilities.dp(5.0f);
                float f24 = this.d + h4Var2.a + dp3;
                float f25 = this.e + h4Var2.b + dp3;
                ...
                if (this.r == null || rectF.right <= ((this.d + this.g) - (AndroidUtilities.dp(11.32f) + this.r.c)) - dp3 || rectF.top > this.e + dp3) {
                    ...
                    h4Var2.H.c(this.d + h4Var2.a + dp3 + AndroidUtilities.dp(5.66f), this.e + h4Var2.b + dp3 + f26, 1.0f, -1, canvas2);
                    canvas2.restore();
                    i18++;
                    f23 = f13;
                }
        ...
        if (this.q == null || f22 <= 0.0f) {
            ...
            float f27 = this.d;
            float f28 = this.g;
            float A = com.google.android.recaptcha.internal.a.A(f28, dp4, 2.0f, f27);
            f10 = 11.32f;
            float f29 = this.e;
            f11 = 5.0f;
            float f30 = this.h;
            f12 = 17.0f;
            rectF.set(A, com.google.android.recaptcha.internal.a.A(f30, dp5, 2.0f, f29), j7.l1.c(f28, dp4, 2.0f, f27), j7.l1.c(f30, dp5, 2.0f, f29));
            path.rewind();
            float f31 = dp5 / 2.0f;
            ...
            path2 = path;
            this.q.c((((this.g / 2.0f) + this.d) - (dp4 / 2.0f)) + AndroidUtilities.dp(14.0f), this.e + (this.h / 2.0f), f9, -1, canvas2);
            canvas2.restore();
            if (s1Var.getDelegate() == null || !s1Var.getDelegate().c1(5, s1Var)) {
                c90 c90Var = this.k;
                if (c90Var != null && !c90Var.c() && !this.k.b()) {
                    this.k.a();
                }
            } else {
                c90 c90Var2 = this.k;
                if (c90Var2 == null) {
                    ...
                    c90 c90Var4 = this.k;
                    c90Var4.C = true;
                    c90Var4.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                } else if (c90Var2.b() || this.k.c()) {
                    c90 c90Var5 = this.k;
                    c90Var5.b = -1L;
                    c90Var5.c = -1L;
                }
    ...
    public final void c(Canvas canvas, float f9) {
        ...
        while (true) {
            ...
            h4 h4Var = (h4) arrayList.get(i14);
            if (h4Var.f.hasImageSet() && h4Var.f.getBitmap() != null) {
                i15 |= 1 << i14;
            }
            i14++;
        }
        ...
        if (bitmap == null || this.z != id2 || this.y != i15 || this.A != max || this.B != max2) {
            ...
            for (int i16 = 0; i16 < arrayList.size(); i16++) {
                h4 h4Var2 = (h4) arrayList.get(i16);
                h4Var2.f.setImageCoords(h4Var2.a, h4Var2.b, h4Var2.c - r4, h4Var2.d - r7);
                h4Var2.f.draw(canvas2);
            }
    ...
    public final h4 d(float f9, float f10) {
        ...
        while (true) {
            ...
            if (((h4) arrayList.get(i10)).f.isInsideImage(f9, f10)) {
    ...
    public final boolean f(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (d != null) {
                ...
                if (radialProgress2.i.q != 4 && radialProgress2.a.contains(x4, y8)) {
                    z11 = true;
                    this.p = z11;
                }
            }
            ...
            if (d10 != null) {
                ...
                if (radialProgress22.i.q != 4 && radialProgress22.a.contains(x4, y8)) {
                    z10 = true;
                    h4Var = this.o;
                    if (h4Var != null && h4Var == d10) {
                        ...
                        if (s1Var.getDelegate() != null && motionEvent.getAction() == 1) {
                            ...
                            if (this.p || !z10 || d10.C.i.q != 3 || messageObject == null) {
                                ...
                                h4 h4Var2 = this.o;
                                ImageReceiver imageReceiver = h4Var2.f;
            ...
            if (h4Var != null) {
                ...
                if (s1Var.getDelegate() != null) {
                    ...
                    h4 h4Var22 = this.o;
                    ImageReceiver imageReceiver2 = h4Var22.f;
    ...
    */
    public final void g(MessageObject messageObject) {
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            if (i4Var.b == null) {
                g4 g4Var = new g4();
                g4Var.a = new ArrayList();
                g4Var.b = new ArrayList();
                g4Var.c = new HashMap();
                g4Var.h = 800;
                g4Var.i = 814.0f;
                i4Var.b = g4Var;
            ...
            i4Var.b.a.clear();
            i4Var.b.a.addAll(tL_messageMediaPaidMedia2.extended_media);
            g4 g4Var2 = i4Var.b;
            float f13 = g4Var2.i;
            ArrayList arrayList2 = g4Var2.b;
            arrayList2.clear();
            HashMap hashMap = g4Var2.c;
            hashMap.clear();
            g4Var2.e = 0;
            ArrayList arrayList3 = g4Var2.a;
            ...
            if (size == 0) {
                ...
                int min = (int) (dp2 / (Math.min(point.x, point.y) / g4Var2.h));
                ...
                if (size == 1) {
                            ...
                            if (size == 2) {
                                ...
                                if (sb3.equals("ww") && f19 > f18 * 1.4d) {
                                    ...
                                    if (f21 - f22 < 0.2d) {
                                        ...
                                        groupedMessagePosition4.set(0, 0, 0, 0, g4Var2.h, round, 7);
                                        groupedMessagePosition5.set(0, 0, 1, 1, g4Var2.h, round, 11);
                                    }
                                }
                                ...
                                if (sb2.charAt(0) == 'n') {
                                    ...
                                    float min4 = Math.min(f13 * 0.5f, Math.round((g4Var2.h * f27) / (groupedMessagePosition8.aspectRatio + f27)));
                                    float f28 = f13 - min4;
                                    int max2 = (int) Math.max(min, Math.min(g4Var2.h * 0.5f, Math.round(Math.min(groupedMessagePosition8.aspectRatio * min4, groupedMessagePosition7.aspectRatio * f28))));
                                    int round3 = Math.round(Math.min((groupedMessagePosition6.aspectRatio * f13) + i13, g4Var2.h - max2));
                                    ...
                                    float round4 = Math.round(Math.min(g4Var2.h / groupedMessagePosition6.aspectRatio, 0.66f * f13)) / f13;
                                    groupedMessagePosition6.set(0, 1, 0, 0, g4Var2.h, round4, 7);
                                    int i17 = g4Var2.h / 2;
                                    float f31 = i17;
                                ...
                                if (sb2.charAt(0) == 'w') {
                                    float round5 = Math.round(Math.min(g4Var2.h / groupedMessagePosition9.aspectRatio, f13 * 0.66f)) / f13;
                                    groupedMessagePosition9.set(0, 2, 0, 0, g4Var2.h, round5, 7);
                                    float round6 = Math.round(g4Var2.h / ((groupedMessagePosition10.aspectRatio + groupedMessagePosition11.aspectRatio) + groupedMessagePosition12.aspectRatio));
                                    float f33 = min;
                                    int max3 = (int) Math.max(f33, Math.min(g4Var2.h * 0.4f, groupedMessagePosition10.aspectRatio * round6));
                                    int max4 = (int) Math.max(Math.max(f33, g4Var2.h * 0.33f), groupedMessagePosition12.aspectRatio * round6);
                                    int i18 = (g4Var2.h - max3) - max4;
                                    ...
                                    int round7 = Math.round(Math.min((groupedMessagePosition9.aspectRatio * f13) + i13, g4Var2.h - max5));
                                    ...
                                    groupedMessagePosition11.spanSize = g4Var2.h;
                    ...
                    for (int i23 = 1; i23 < size2; i23++) {
                        int i24 = size2 - i23;
                        if (i23 <= 3 && i24 <= 3) {
                            float a2 = g4Var2.a(fArr2, 0, i23);
                            float a10 = g4Var2.a(fArr2, i23, size2);
                            f4 f4Var = new f4();
                            f4Var.a = new int[]{i23, i24};
                            f4Var.b = new float[]{a2, a10};
                            ...
                            if (i26 < i27) {
                                ...
                                if (i25 <= 3) {
                                    if (i26 <= (f19 < 0.85f ? 4 : 3) && i28 <= 3) {
                                        float a11 = g4Var2.a(fArr2, 0, i25);
                                        int i29 = i25 + i26;
                                        float a12 = g4Var2.a(fArr2, i25, i29);
                                        float a13 = g4Var2.a(fArr2, i29, size2);
                                        f4 f4Var2 = new f4();
                                        f4Var2.a = new int[]{i25, i26, i28};
                                        i11 = i25;
                                        f4Var2.b = new float[]{a11, a12, a13};
                                        arrayList4.add(f4Var2);
                                        i26++;
                                        i25 = i11;
                                    }
                                }
                                ...
                                while (true) {
                                    ...
                                    if (i33 < i34) {
                                        ...
                                        if (i30 > 3 || i31 > 3 || i33 > 3 || i35 > 3) {
                                            ...
                                            i10 = i32;
                                            float a14 = g4Var2.a(fArr2, 0, i30);
                                            int i36 = i30 + i31;
                                            float a15 = g4Var2.a(fArr2, i30, i36);
                                            int i37 = i36 + i33;
                                            float a16 = g4Var2.a(fArr2, i36, i37);
                                            float a17 = g4Var2.a(fArr2, i37, size2);
                                            f4 f4Var3 = new f4();
                                            f4Var3.a = new int[]{i30, i31, i33, i35};
                                            f4Var3.b = new float[]{a14, a15, a16, a17};
                    ...
                    float f38 = (g4Var2.h / 3) * 4;
                    f4 f4Var4 = null;
                    float f39 = 0.0f;
                    int i38 = 0;
                    while (i38 < arrayList4.size()) {
                        f4 f4Var5 = (f4) arrayList4.get(i38);
                        float f40 = Float.MAX_VALUE;
                        float f41 = f38;
                        float f42 = 0.0f;
                        int i39 = 0;
                        while (true) {
                            float[] fArr3 = f4Var5.b;
                            fArr = fArr2;
                            if (i39 >= fArr3.length) {
                                break;
                            }
                    ...
                    if (f4Var4 == null) {
                        ...
                        while (i42 < iArr2.length) {
                            int i44 = iArr2[i42];
                            float f44 = f4Var4.b[i42];
                            int i45 = g4Var2.h;
                            int i46 = i44 - 1;
                            g4Var2.e = Math.max(g4Var2.e, i46);
                ...
                for (int i51 = 0; i51 < size; i51++) {
                    ...
                    if (groupedMessagePosition15.maxX == g4Var2.e || (groupedMessagePosition15.flags & 2) != 0) {
                ...
                while (i55 < size) {
                    ...
                    g4Var2.e = Math.max(g4Var2.e, (int) groupedMessagePosition16.maxX);
                    g4Var2.f = Math.max(g4Var2.f, (int) groupedMessagePosition16.maxY);
            ...
            if (i74 > 0) {
                ...
                if (AndroidUtilities.isTablet()) {
                    i4Var.f = AndroidUtilities.getMinTabletSide() - AndroidUtilities.dp(122.0f);
                    messageObject2 = messageObject;
                } else {
                    messageObject2 = messageObject;
                    i4Var.f = Math.min(s1Var.getParentWidth(), AndroidUtilities.displaySize.y) - AndroidUtilities.dp((s1Var.M0(messageObject2) ? 10 : 0) + 64);
                }
                if (s1Var.z3()) {
                    i4Var.f -= AndroidUtilities.dp(52.0f);
                }
            }
            ...
            while (true) {
                ...
                h4 h4Var = i75 >= arrayList.size() ? null : (h4) arrayList.get(i75);
                if (h4Var == null) {
                    g4 g4Var3 = i4Var.b;
                    if (messageExtendedMedia2 == null) {
                        ...
                        groupedMessagePosition = (MessageObject.GroupedMessagePosition) g4Var3.c.get(messageExtendedMedia2);
                    }
                    h4 h4Var2 = new h4(i4Var.a, messageObject2, messageExtendedMedia2, tL_messageMediaPaidMedia3.extended_media.size() != 1, (int) ((groupedMessagePosition.pw / 1000.0f) * i4Var.f), (int) (groupedMessagePosition.ph * i4Var.b.i));
                    String str = messageExtendedMedia2.attachPath;
                    if (str != null) {
                        h4Var2.B = str;
                    } else if (tL_messageMediaPaidMedia3.extended_media.size() == 1) {
                        TLRPC.Message message2 = messageObject2.messageOwner;
                        h4Var2.B = message2 != null ? message2.attachPath : null;
                    }
                    if (!TextUtils.isEmpty(h4Var2.B)) {
                        DownloadController.getInstance(s1Var.E7).addLoadingFileObserver(h4Var2.B, messageObject2, h4Var2);
                        if (messageObject2.isSending()) {
                            h4Var2.C.o(messageExtendedMedia2.uploadProgress, false);
                        }
                    }
                    if (s1Var.I0 && !h4Var2.I) {
                        h4Var2.I = true;
                        h4Var2.f.onAttachedToWindow();
                    }
                    arrayList.add(h4Var2);
                } else {
                    h4Var.c(messageExtendedMedia2, messageObject2);
                }
                i75++;
            }
            int size8 = tL_messageMediaPaidMedia3.extended_media.size();
            while (size8 < arrayList.size()) {
                h4 h4Var3 = size8 >= arrayList.size() ? null : (h4) arrayList.get(size8);
                if (h4Var3 != null) {
                    if (h4Var3.I) {
                        h4Var3.I = false;
                        h4Var3.f.onDetachedFromWindow();
                    }
            ...
            h(messageObject);
            g4 g4Var4 = i4Var.b;
            i4Var.g = (int) ((g4Var4.d / 1000.0f) * i4Var.f);
            i4Var.h = (int) (g4Var4.g * g4Var4.i);
            if (i4Var.i) {
                zz0 zz0Var = new zz0(jh.ia.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContent", (int) tL_messageMediaPaidMedia3.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                i4Var.q = zz0Var;
                if (zz0Var.c > i4Var.g - AndroidUtilities.dp(30.0f)) {
                    i4Var.q = new zz0(jh.ia.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContentShort", (int) tL_messageMediaPaidMedia3.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                }
            }
            if (i4Var.r == null || i4Var.s != tL_messageMediaPaidMedia3.stars_amount) {
                long j10 = tL_messageMediaPaidMedia3.stars_amount;
                i4Var.s = j10;
                i4Var.r = new zz0(jh.ia.R0(LocaleController.formatPluralStringComma("PaidMediaPrice", (int) j10), 0.9f, null), 12.0f, AndroidUtilities.bold());
            }
        }
    }
    ...
    public final void h(MessageObject messageObject) {
        ...
        g4 g4Var = this.b;
        this.g = (int) ((g4Var.d / 1000.0f) * f9 * this.f);
        this.h = (int) (g4Var.g * g4Var.i);
        this.i = false;
        ...
        while (true) {
            ...
            if (messageExtendedMedia == null) {
                ...
                groupedMessagePosition = (MessageObject.GroupedMessagePosition) g4Var2.c.get(messageExtendedMedia);
            }
            if (groupedMessagePosition == null) {
                ...
                float f10 = (groupedMessagePosition.left / 1000.0f) * f9;
                float f11 = this.f;
                int i13 = (int) (f10 * f11);
                z10 = z12;
                ...
                float f13 = this.b.i;
                int i14 = (int) (f12 * f13);
                int i15 = (int) ((groupedMessagePosition.pw / 1000.0f) * f9 * f11);
        ...
        if (this.i) {
            ...
            if (tL_messageMediaPaidMedia != null) {
                ...
                this.q = zz0Var;
                if (zz0Var.c > this.g - AndroidUtilities.dp(30.0f)) {
                    this.q = new zz0(jh.ia.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContentShort", (int) tL_messageMediaPaidMedia.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                }
            }
        }
    }
