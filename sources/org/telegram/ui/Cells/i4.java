...
public final class i4 implements DownloadController.FileDownloadProgressListener {
    ...
    public final void c(TLRPC.MessageExtendedMedia messageExtendedMedia, MessageObject messageObject) {
        ...
        if (z4) {
            this.h = true;
            this.v = null;
            this.f.setImage(ImageLocation.getForObject(((TLRPC.TL_messageExtendedMediaPreview) messageExtendedMedia).thumb, messageObject.messageOwner), vh.w2.k(h, "_b2"), null, null, messageObject, 0);
