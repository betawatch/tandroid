    ...
    public void set(TLRPC.RequestPeerType requestPeerType) {
        ...
        if (this.a != requestPeerType) {
                ...
                if (bool5 == null || !bool5.booleanValue()) {
                    ...
                    if (tL_chatAdminRights != null) {
                        ...
                        if (arrayList2.size() == 1) {
                            arrayList.add(o6.a(TextUtils.concat(replaceTags2, " ", ((o6) arrayList2.get(0)).b)));
                            ...
                            for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                                ...
                                valueOf.append((CharSequence) ((o6) arrayList2.get(i12)).b.toString().toLowerCase());
                            }
                            valueOf.append((CharSequence) ".");
                            arrayList.add(o6.a(valueOf));
                        }
                    }
                }
            }
            ...
            while (i14 < size) {
                ...
                m6Var.setBackgroundColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false));
                m6Var.setOrientation(0);
                ImageView imageView = new ImageView(context);
                imageView.setScaleType(ImageView.ScaleType.CENTER);
                imageView.setImageResource(o6Var.a <= 0 ? R.drawable.list_check : R.drawable.list_circle);
