...
public class n6 extends FrameLayout {
    ...
    public n6(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        addView(k5Var, w7.x5.i(-1.0f, -2.0f, 55, f11, i10 == 1 ? 24.0f : 19.0f, 20.0f, 0.0f));
        if (z11) {
            ...
            if (d.f != null) {
                ...
                if (u9Var22 != null) {
                    if (tL_availableReaction != null) {
                        u9Var22.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.j6.a7, 1.0f), tL_availableReaction);
                        z15 = true;
                    } else {
                ...
                o5Var.setColorFilter(org.telegram.ui.ActionBar.j6.n0(f6Var));
                if (u9Var22 != null) {
        ...
        if (storyItem == null) {
            ...
            if (j3 <= 0) {
                ...
                if (j10 != 0) {
                    ...
                    spannableStringBuilder.append(ac0Var.a(getContext(), f6Var));
