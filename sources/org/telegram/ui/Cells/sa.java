...
public class sa extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.x5 {
    ...
    public final void b(int i10, int i11) {
        ...
        if (LocaleController.isRTL) {
            ...
            f9 = (checkBoxSquare != null ? 18 : 0) + 28;
        }
    ...
    public final void g(bk0 bk0Var, CharSequence charSequence, boolean z10) {
        String string;
        Object user;
        boolean z11 = bk0Var.e;
        int i10 = this.L;
        if (z11) {
            int i11 = bk0Var.c;
            string = (i11 > 0 || !bk0Var.f) ? i11 <= 0 ? LocaleController.getString(R.string.NotificationEnabled) : LocaleController.getString(R.string.NotificationDisabled) : LocaleController.getString(R.string.NotificationEnabledAutomatically);
        } else {
            boolean z12 = bk0Var.b;
            int i12 = bk0Var.c;
            int i13 = bk0Var.a;
            boolean z13 = true;
        ...
        if (DialogObject.isEncryptedDialog(bk0Var.d)) {
            TLRPC.EncryptedChat p10 = org.telegram.messenger.x3.p(MessagesController.getInstance(i10), bk0Var.d);
            if (p10 == null || (user = MessagesController.getInstance(i10).getUser(Long.valueOf(p10.user_id))) == null) {
                return;
            }
        ...
        if (DialogObject.isUserDialog(bk0Var.d)) {
            Object user2 = MessagesController.getInstance(i10).getUser(Long.valueOf(bk0Var.d));
            if (user2 != null) {
        ...
        Object chat = MessagesController.getInstance(i10).getChat(Long.valueOf(-bk0Var.d));
        if (chat != null) {
    ...
    public final void h(int i10, w41 w41Var, boolean z10) {
        ...
        if (user != null) {
            d(user, null, !TextUtils.isEmpty(publicUsername) ? u3.c.e("@", publicUsername) : user.bot ? LocaleController.getString(R.string.Bot) : user.contact ? LocaleController.getString(R.string.FilterContact) : LocaleController.getString(R.string.FilterNonContact), z10);
        }
    }
    ...
    */
    public final void j(int i10) {
        ...
        org.telegram.ui.Components.e9 e9Var = this.A;
        if (z13) {
            ...
            if (user != null) {
                ...
                if (chat == null) {
                    ...
                    if (charSequence3 != null) {
                        str2 = null;
                        e9Var.n(this.F, charSequence3.toString(), null);
                    } else {
                        str2 = null;
                        e9Var.n(this.F, "#", null);
                    }
                    ...
                    y3Var.setRoundRadius(!this.R ? AndroidUtilities.dp(12.777778f) : (chat == null || !chat.forum) ? AndroidUtilities.dp(24.0f) : AndroidUtilities.dp(14.0f));
    ...
    public void setCallCellStyle(int i10) {
        ...
        boolean z10 = LocaleController.isRTL;
        h5Var.setLayoutParams(i7.f6.d(-1, 20.0f, (z10 ? 5 : 3) | 48, z10 ? 30.0f : i10 + 66, 10.0f, z10 ? i10 + 66 : 30.0f, 0.0f));
        org.telegram.ui.ActionBar.h5 h5Var2 = this.c;
        h5Var2.setTextSize(13);
        boolean z11 = LocaleController.isRTL;
        h5Var2.setLayoutParams(i7.f6.d(-1, 20.0f, (z11 ? 5 : 3) | 48, z11 ? 30.0f : i10 + 66, 32.0f, z11 ? i10 + 66 : 30.0f, 0.0f));
        int dp = AndroidUtilities.dp(22.0f);
        lh.y3 y3Var = this.a;
        y3Var.setRoundRadius(dp);
        boolean z12 = LocaleController.isRTL;
        y3Var.setLayoutParams(i7.f6.d(44, 44.0f, (z12 ? 5 : 3) | 48, z12 ? 0.0f : i10 + 8, 6.0f, z12 ? i10 + 8 : 0.0f, 0.0f));
        hp hpVar = this.e;
        if (hpVar != null) {
            boolean z13 = LocaleController.isRTL;
            hpVar.setLayoutParams(i7.f6.d(24, 24.0f, (z13 ? 5 : 3) | 48, z13 ? 0.0f : i10 + 37, 32.0f, z13 ? i10 + 37 : 0.0f, 0.0f));
        }
    }
    ...
    public void setCloseIcon(View.OnClickListener onClickListener) {
        ...
        if (this.x == null) {
            ...
            boolean z10 = LocaleController.isRTL;
            addView(imageView4, i7.f6.d(30, 30.0f, (z10 ? 3 : 5) | 16, z10 ? 14.0f : 0.0f, 0.0f, z10 ? 0.0f : 14.0f, 0.0f));
        }
    ...
    public sa(int i10, int i11, Context context, org.telegram.ui.ActionBar.c6 c6Var, boolean z10, boolean z11) {
        ...
        this.w = new org.telegram.ui.Components.n5(AndroidUtilities.dp(20.0f), h5Var);
