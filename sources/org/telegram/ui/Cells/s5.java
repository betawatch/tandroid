...
public final class s5 extends FrameLayout {
    ...
    public final void b(int i10, boolean z4, boolean z10) {
        ...
        if (this.x) {
            ...
            if (z10) {
                ...
                this.G = animatorSet2;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(n5Var, (Property<n5, Float>) View.SCALE_X, z4 ? 0.787f : 1.0f), ObjectAnimator.ofFloat(n5Var, (Property<n5, Float>) View.SCALE_Y, z4 ? 0.787f : 1.0f));
                this.G.setDuration(200L);
                this.G.addListener(new dg.w2(15, this, z4));
                this.G.start();
            } else {
                n5Var.setScaleX(z4 ? 0.787f : 1.0f);
                n5Var.setScaleY(z4 ? 0.787f : 1.0f);
            }
        }
    ...
    public final void clearAnimation() {
        ...
        if (animatorSet != null) {
            ...
            this.G = null;
            kp kpVar = this.d;
            float f10 = kpVar.a.q ? 0.787f : 1.0f;
            n5 n5Var = this.b;
            n5Var.setScaleX(f10);
            n5Var.setScaleY(kpVar.a.q ? 0.787f : 1.0f);
        }
    }
    ...
    public final void d(MediaController.PhotoEntry photoEntry, boolean z4, boolean z10, boolean z11, boolean z12) {
        ...
        o5Var.getImageReceiver().setVisible(!z15, true);
        this.d.setAlpha(z15 ? 0.0f : 1.0f);
        p5Var.setAlpha(z15 ? 0.0f : 1.0f);
        requestLayout();
    ...
    */
    public final void e(MediaController.SearchImage searchImage) {
        ...
        this.E = searchImage;
        this.r = false;
        Drawable drawable = this.C ? org.telegram.ui.ActionBar.j6.R4 : getResources().getDrawable(R.drawable.nophotos);
    ...
    public final void g(boolean z4) {
        ...
        if (z4 || kpVar.getAlpha() != 0.0f) {
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(p5Var, (Property<p5, Float>) property, fArr), ObjectAnimator.ofFloat(kpVar, (Property<kp, Float>) property, z4 ? 1.0f : 0.0f));
            this.n.addListener(new org.telegram.ui.u5(this, 7));
            this.n.start();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        o5 o5Var = this.a;
        if (!z4 && this.b.getScaleX() == 1.0f && o5Var.getImageReceiver().hasNotThumb() && o5Var.getImageReceiver().getCurrentAlpha() == 1.0f && (((photoEntry = this.D) == null || !PhotoViewer.L1(photoEntry.path)) && ((searchImage = this.E) == null || !PhotoViewer.L1(searchImage.getPathToAttach())))) {
            return;
        }
