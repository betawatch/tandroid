...
public class d7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public d7(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        addView(kpVar, k7.b6.d(24, 24.0f, 49, 19.0f, i10 == 2 ? -40.0f : 42.0f, 0.0f, 0.0f));
    ...
    public final void c(long j10, boolean z4, CharSequence charSequence) {
        ...
        if (j10 == Long.MAX_VALUE) {
            qVar.setText(a());
            if (this.f == null) {
                this.f = new c7(getContext(), p9Var, true, f6Var);
            }
    ...
    public final void d(TLRPC.TL_forumTopic tL_forumTopic, boolean z4, boolean z10) {
        ...
        if (z10) {
            ...
            kVar.a(1.0f);
            jVar2.u = kVar;
            jVar2.b(new o1.g() { // from class: org.telegram.ui.Cells.z6
                @Override // o1.g
                public final void a(o1.h hVar, float f10, float f11) {
                    float f12 = f10 / 1000.0f;
                    d7 d7Var = d7.this;
                    org.telegram.ui.ActionBar.k5 k5Var2 = d7Var.c;
                    k5Var2.setAlpha(f12);
                    gg.q qVar = d7Var.b;
                    float f13 = 1.0f - f12;
                    qVar.setAlpha(f13);
            ...
            jVar2.a(new o1.f() { // from class: org.telegram.ui.Cells.a7
                @Override // o1.f
                public final void a(o1.h hVar, boolean z13, float f10, float f11) {
                    d7.this.c.setTag(R.id.spring_tag, null);
                }
            });
