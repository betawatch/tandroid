...
public final class n3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a(TLRPC.StickerSetCovered stickerSetCovered, boolean z4, boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            animatorSet3.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(textView2, (Property<TextView, Float>) property3, fArr3), ObjectAnimator.ofFloat(fi0Var, (Property<fi0, Float>) property, (this.s || this.v) ? 0.0f : 1.0f), ObjectAnimator.ofFloat(fi0Var, (Property<fi0, Float>) property2, (this.s || this.v) ? 0.0f : 1.0f), ObjectAnimator.ofFloat(c1Var, (Property<eg.c1, Float>) property3, !this.v ? 0.0f : 1.0f), ObjectAnimator.ofFloat(c1Var, (Property<eg.c1, Float>) property2, !this.v ? 0.0f : 1.0f), ObjectAnimator.ofFloat(c1Var, (Property<eg.c1, Float>) property3, !this.v ? 0.0f : 1.0f));
            this.n.addListener(new l3(this));
