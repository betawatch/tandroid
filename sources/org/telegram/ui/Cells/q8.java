...
public class q8 extends FrameLayout {
    ...
    public final void c(int i10, int i11) {
        if (this.C == null) {
            ...
            addView(this.C, i7.f6.d(29, 29.0f, (LocaleController.isRTL ? 5 : 3) | 16, 19.0f, 0.0f, 19.0f, 0.0f));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f) {
            ...
            if (G != null) {
                if (this.C != null) {
                    canvas.drawLine(LocaleController.isRTL ? 0.0f : this.A, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? this.A : 0), getMeasuredHeight() - 1, G);
                } else {
    ...
    public q8(int i10, Context context, org.telegram.ui.ActionBar.c6 c6Var, boolean z10) {
        ...
        this.c = textView;
        org.telegram.ui.b.m(z10 ? org.telegram.ui.ActionBar.g6.j5 : org.telegram.ui.ActionBar.g6.G6, c6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.d = textView2;
        org.telegram.ui.b.m(z10 ? org.telegram.ui.ActionBar.g6.J5 : org.telegram.ui.ActionBar.g6.z6, c6Var, textView2, 1, 13.0f);
