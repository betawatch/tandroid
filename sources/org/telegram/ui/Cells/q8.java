...
public final class q8 extends FrameLayout {
    ...
    public final void a(Runnable runnable, String str, boolean z4) {
        if (this.f == null) {
            ...
            gn gnVar = new gn(getContext(), 6);
            this.r = gnVar;
            gnVar.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.i6, false), 2, -1));
            addView(this.r, k7.b6.e(76, -1, LocaleController.isRTL ? 3 : 5));
        }
        this.h.setText(str);
        this.n.animate().cancel();
        this.n.animate().rotation(z4 ? 0.0f : 180.0f).setDuration(340L).setInterpolator(mr.h).start();
