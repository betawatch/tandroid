...
public abstract class gb extends FrameLayout {
    ...
    public final void c(int i10, boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            animatorSet2.playTogether(ObjectAnimator.ofFloat(y5Var, "scaleX", z10 ? 0.8875f : 1.0f), ObjectAnimator.ofFloat(y5Var, "scaleY", z10 ? 0.8875f : 1.0f));
            fbVar.f.setDuration(200L);
            fbVar.f.addListener(new ai.n(25, fbVar, z10));
            fbVar.f.start();
        } else {
            y5Var.setScaleX(z10 ? 0.8875f : 1.0f);
            y5Var.setScaleY(z10 ? 0.8875f : 1.0f);
        }
        fbVar.invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        int i12 = 0;
        if (this.d == 1) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.a, TLObject.FLAG_30), ul.C(6.0f, this.a, TLObject.FLAG_30));
