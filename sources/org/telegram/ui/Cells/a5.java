...
public abstract class a5 extends FrameLayout {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.a.measure(View.MeasureSpec.makeMeasureSpec(i0.a.d(8.0f, measuredWidth - textView.getMeasuredWidth(), AndroidUtilities.dp(10.0f)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), TLObject.FLAG_30));
        this.c.measure(rl.d(20.0f, getMeasuredWidth(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), TLObject.FLAG_30));
    }
