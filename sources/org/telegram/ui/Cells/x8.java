...
public class x8 extends FrameLayout {
    ...
    public final void c(int i10, int i11) {
        if (this.G == null) {
            ...
            addView(this.G, w7.a6.d(29, 29.0f, (LocaleController.isRTL ? 5 : 3) | 16, 19.0f, 0.0f, 19.0f, 0.0f));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f) {
            ...
            if (F != null) {
                if (this.G != null) {
                    canvas.drawLine(LocaleController.isRTL ? 0.0f : this.E, getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? this.E : 0), getMeasuredHeight() - 1, F);
                } else {
    ...
    public x8(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        this.c = textView;
        em.n(z10 ? org.telegram.ui.ActionBar.j6.j5 : org.telegram.ui.ActionBar.j6.G6, f6Var, textView, 1, 16.0f);
        textView.setLines(1);
        ...
        this.d = textView2;
        em.n(z10 ? org.telegram.ui.ActionBar.j6.J5 : org.telegram.ui.ActionBar.j6.z6, f6Var, textView2, 1, 13.0f);
