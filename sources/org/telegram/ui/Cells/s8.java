...
public class s8 extends FrameLayout {
    ...
    public final void h(int i10) {
        ...
        if (i10 <= 0) {
            ...
            i5Var.i(new dp0(i10, getContext(), this.E, false));
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z11) {
            dp = (getMeasuredWidth() - i5Var2.getMeasuredWidth()) - AndroidUtilities.dp(bj0Var.getVisibility() == 0 ? this.s : this.n);
        } else {
        ...
        if (i5Var3.getVisibility() == 0) {
            ...
            int dp4 = AndroidUtilities.dp(1.0f) + ul.y(f7, (i14 - i5Var2.getTextHeight()) - i5Var3.getTextHeight(), 2);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            i5Var3.measure(ul.d(this.n + 71, size, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_30));
            i5Var.measure(ul.d(this.n + 71, size, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_30));
    ...
    public final void v() {
        org.telegram.ui.ActionBar.i5 i5Var = this.a;
        int intValue = i5Var.getTag() instanceof Integer ? ((Integer) i5Var.getTag()).intValue() : org.telegram.ui.ActionBar.h6.G6;
        org.telegram.ui.ActionBar.d6 d6Var = this.E;
    ...
    public s8(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
    ...
    public s8(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        super(context);
        this.s = 58;
        this.v = 50;
        this.w = 16;
        ...
        this.a = i5Var;
        i5Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.j5 : org.telegram.ui.ActionBar.h6.G6, d6Var));
        i5Var.setTextSize(16);
        i5Var.setGravity(LocaleController.isRTL ? 5 : 3);
        i5Var.setImportantForAccessibility(2);
        addView(i5Var, w7.x5.c(-1.0f, -2));
        org.telegram.ui.ActionBar.i5 i5Var2 = new org.telegram.ui.ActionBar.i5(context);
        this.b = i5Var2;
        i5Var2.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.p5 : org.telegram.ui.ActionBar.h6.y6, d6Var));
        i5Var2.setTextSize(13);
        i5Var2.setGravity(LocaleController.isRTL ? 5 : 3);
        i5Var2.setImportantForAccessibility(2);
        addView(i5Var2, w7.x5.c(-1.0f, -2));
        ...
        i5Var3.q0 = 18;
        i5Var3.m();
        i5Var3.setTextColor(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.n5 : org.telegram.ui.ActionBar.h6.I6, d6Var));
        ...
        bj0Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(z10 ? org.telegram.ui.ActionBar.h6.J5 : org.telegram.ui.ActionBar.h6.m6, d6Var), PorterDuff.Mode.SRC_IN));
        addView(bj0Var);
