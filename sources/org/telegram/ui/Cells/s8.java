...
public class s8 extends FrameLayout {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (j5Var3.getVisibility() == 0) {
            ...
            int dp4 = AndroidUtilities.dp(1.0f) + rk.z(f7, (i14 - j5Var2.getTextHeight()) - j5Var3.getTextHeight(), 2);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            j5Var3.measure(rk.c(this.n + 71, size, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_30));
            j5Var.measure(rk.c(this.n + 71, size, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_30));
            o6Var.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.dp(this.n + 103)) - j5Var3.getTextWidth(), LocaleController.isRTL ? TLObject.FLAG_31 : TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_30));
            ...
            int max = Math.max(o6Var.d(), j5Var2.getTextWidth());
