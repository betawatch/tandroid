...
public final class a2 extends FrameLayout {
    ...
    public final void g() {
        ...
        if (z10) {
            ...
            y1Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.k5 : org.telegram.ui.ActionBar.j6.J6, f6Var));
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (i13 == 3) {
            ...
            if (z1Var != null) {
                ...
                measuredWidth2 = rk.D(11.0f, z1Var.getMeasuredWidth(), measuredWidth2);
            }
            if (view2.getLayoutParams().width == -1) {
                view2.measure(rk.c(8.0f, (measuredWidth - ((int) Math.abs(view2.getTranslationX()))) - measuredWidth2, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), TLObject.FLAG_31));
            } else {
                view2.measure(rk.c(8.0f, (measuredWidth - ((int) Math.abs(view2.getTranslationX()))) - measuredWidth2, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), TLObject.FLAG_31));
            }
            org.telegram.ui.Components.v9 v9Var = this.w;
            if (v9Var != null) {
                v9Var.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(34.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(34.0f), TLObject.FLAG_30));
            }
            float f10 = i12;
    ...
    public a2(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        this(i10, 17, context, f6Var, false);
    }

    public a2(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.b = f6Var;
        this.y = i10;
        this.H = z10;
        ...
        if (z10) {
            ...
            y1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
        ...
        if (i10 == 6) {
            ...
            addView(v9Var, w7.y5.i(34.0f, 34.0f, 8388627, 56.0f, 0.0f, 0.0f, 0.0f));
        }
        g();
    }
}
