...
public final class f7 extends FrameLayout {
    ...
    public f7(Context context, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        this.c = textView;
        ll.n(org.telegram.ui.ActionBar.f6.j5, b6Var, textView, 1, 12.0f);
        textView.setMaxLines(2);
        textView.setGravity(49);
        textView.setLines(2);
        textView.setEllipsize(TextUtils.TruncateAt.END);
        addView(textView, g7.e6.d(-1, -2.0f, 51, 6.0f, 66.0f, 6.0f, 0.0f));
        this.b = new c7(this, b6Var, 1);
    ...
    public final void onMeasure(int i9, int i10) {
        super.onMeasure(i9, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(103.0f), TLObject.FLAG_30));
    }
