...
public class DialogsHintCell extends FrameLayout {
    ...
    public void setAvatars(int i, ArrayList arrayList) {
        ...
        this.avatarsImageView.getLayoutParams().width = min <= 1 ? AndroidUtilities.dp(36.0f) : AndroidUtilities.dp(((min - 1) * 18) + 30);
        if (z) {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, TLObject.FLAG_31));
        LinearLayout linearLayout = this.contentView;
