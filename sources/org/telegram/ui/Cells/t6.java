...
public final class t6 extends FrameLayout {
        ...
        if (z10) {
            ...
            for (int i10 = 0; i10 < strArr.length; i10++) {
                if (i10 != 0) {
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.G6, false), PorterDuff.Mode.MULTIPLY));
                    spannableStringBuilder.setSpan(new s6(mutate), spannableStringBuilder.length() - 2, spannableStringBuilder.length() - 1, 33);
                }
            ...
            if (strArr != null) {
                ...
                for (int i11 = 0; i11 < strArr.length; i11++) {
                    if (i11 != 0) {
                        ...
                        mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.z6, false), PorterDuff.Mode.MULTIPLY));
                        spannableStringBuilder2.setSpan(new s6(mutate2), spannableStringBuilder2.length() - 2, spannableStringBuilder2.length() - 1, 33);
                    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.dp(this.e), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.dp(this.e) : 0), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.g6.k0);
        }
    }
