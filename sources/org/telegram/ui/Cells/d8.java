...
public class d8 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, wf.c {
    ...
    public d8(Context context, org.telegram.ui.ActionBar.b6 b6Var, boolean z10) {
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.f6.b0(AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.q5, b6Var)));
    ...
    public final void a(boolean z10) {
        ...
        if (z10) {
            imageView.animate().alpha(0.0f).scaleX(0.4f).scaleY(0.4f).setDuration(200L).setInterpolator(gr.f).start();
        } else {
            imageView.setAlpha(0.0f);
        }
    }
    ...
    public final void c(boolean z10) {
        ...
        if (!z10) {
            ...
            imageView.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(200L).setInterpolator(gr.f).start();
        }
    }
    ...
    public final void d(TLRPC.Document document, SendMessagesHelper.ImportingSticker importingSticker, Object obj, String str, boolean z10, boolean z11) {
        ...
        this.G = 0;
        this.F.setBackground(org.telegram.ui.ActionBar.f6.b0(AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.q5, false)));
        if (z11) {
            c(false);
        } else {
            a(false);
        ...
        if (importingSticker != null) {
            ...
            if (importingSticker.validated) {
                ...
                i9 = 4;
                z12 = true;
                c8Var.setImage(ImageLocation.getForPath(importingSticker.path), "80_80", null, null, DocumentObject.getSvgRectThumb(org.telegram.ui.ActionBar.f6.i5, 1.0f), 0L, importingSticker.animated ? "tgs" : null, 0, 1);
            } else {
                textView = textView2;
                i9 = 4;
                z12 = true;
                c8Var.setImage(null, null, null, null, DocumentObject.getSvgRectThumb(org.telegram.ui.ActionBar.f6.i5, 1.0f), 0L, importingSticker.animated ? "tgs" : null, 0, 1);
            }
            if (str != null) {
            ...
            if (document != null) {
                ...
                boolean z13 = this.B;
                int i10 = z13 ? org.telegram.ui.ActionBar.f6.c7 : org.telegram.ui.ActionBar.f6.a7;
                float f10 = z13 ? 0.2f : 1.0f;
                org.telegram.ui.ActionBar.b6 b6Var = this.I;
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, i10, f10, 1.0f, b6Var);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.c != null) {
            int i9 = 0;
            while (true) {
                if (i9 >= this.c.attributes.size()) {
                    break;
                }
                TLRPC.DocumentAttribute documentAttribute = this.c.attributes.get(i9);
                if (documentAttribute instanceof TLRPC.TL_documentAttributeSticker) {
