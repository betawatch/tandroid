...
public final class z2 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.c9 n;
    public boolean r;
    ...
    public z2(Context context) {
        ...
        s5Var.setMaxLines(5);
        linearLayout.addView(s5Var, g7.e6.o(-2, -2, 0.0f, (LocaleController.isRTL ? 5 : 3) | 48));
        ...
        addView(imageView, g7.e6.d(16, 16.0f, (LocaleController.isRTL ? 3 : 5) | 16, 4.0f, 0.0f, 4.0f, 0.0f));
    ...
    public final void a(int i9, ArrayList arrayList) {
        ...
        org.telegram.ui.Components.c9 c9Var = this.n;
        boolean z10 = min != c9Var.a.n;
        if (min <= 1) {
        ...
        c9Var.setCount(min);
        c9Var.setVisibility(min <= 0 ? 8 : 0);
        c9Var.getLayoutParams().width = min <= 1 ? AndroidUtilities.dp(36.0f) : AndroidUtilities.dp(e2.c.e(min, 1, 18, 30));
        if (z10) {
        ...
        if (arrayList != null) {
            int i10 = 0;
            while (i10 < 3) {
                c9Var.b(i10, i10 >= arrayList.size() ? null : (TLObject) arrayList.get(i10), i9);
                i10++;
            }
        }
        c9Var.a(false);
    ...
    public final void c(CharSequence charSequence, CharSequence charSequence2, boolean z10, boolean z11) {
        ...
        this.b.setPadding(i10, 0, dp, 0);
        d();
    }

    public final void d() {
        this.c.setTextColor(org.telegram.ui.ActionBar.f6.w0(null, this.r ? org.telegram.ui.ActionBar.f6.q7 : org.telegram.ui.ActionBar.f6.G6, false));
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.v5.c(null, org.telegram.ui.ActionBar.v5.b(org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.v5.a, false))));
    }

    @Override // android.widget.FrameLayout, android.view.View
    public final void onMeasure(int i9, int i10) {
        super.onMeasure(i9, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, TLObject.FLAG_31));
        ...
        super.onMeasure(i9, View.MeasureSpec.makeMeasureSpec(getPaddingBottom() + getPaddingTop() + linearLayout.getMeasuredHeight(), TLObject.FLAG_30));
