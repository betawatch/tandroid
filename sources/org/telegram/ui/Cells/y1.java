...
public final class y1 extends FrameLayout {
    ...
    public final boolean b() {
        kp kpVar = this.r;
        return kpVar != null ? kpVar.a.q : this.n.h;
    }
    ...
    public final void d(org.telegram.ui.a aVar, org.telegram.messenger.video.g gVar) {
        if (aVar == null) {
            ...
            if (this.F == null) {
                ...
                addView(this.F, k7.b6.e(-1, -1, 119));
            }
        ...
        if (this.G == null) {
            ...
            this.G = view4;
            addView(view4, k7.b6.e(56, -1, LocaleController.isRTL ? 5 : 3));
        }
    ...
    public final void e(CharSequence charSequence, String str, boolean z4, boolean z10, boolean z11) {
        if (this.E) {
            v1 v1Var = this.d;
            v1Var.c(Emoji.replaceEmoji(charSequence, v1Var.getPaint().getFontMetricsInt(), false), z11, true);
        } else {
    ...
    public final void g() {
        ...
        if (z4) {
            ...
            w1Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.k5 : org.telegram.ui.ActionBar.j6.J6, f6Var));
        }
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (this.s == null) {
            ...
            addView(this.s, k7.b6.e(16, 16, 16));
        }
        f();
        this.s.animate().cancel();
        this.s.animate().rotation(bool.booleanValue() ? 0.0f : 180.0f).setDuration(340L).setInterpolator(mr.h).start();
    }
    ...
    public y1(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        super(context);
        this.b = f6Var;
        this.y = i10;
        this.E = z4;
        ...
        if (z4) {
            ...
            v1Var.setTag(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0((i10 == 1 || i10 == 5) ? org.telegram.ui.ActionBar.j6.j5 : org.telegram.ui.ActionBar.j6.G6, f6Var)));
            ...
            if (i10 == 3) {
                v1Var.setGravity(19);
                addView(v1Var, k7.b6.d(-1, -2.0f, 19, 29.0f, 0.0f, 0.0f, 0.0f));
                ...
                if (i10 == 2) {
                    ...
                    addView(v1Var, k7.b6.d(-1, -2.0f, (z11 ? 5 : 3) | 16, z11 ? 8 : 29, 0.0f, z11 ? 29 : 8, 0.0f));
                } else {
                    int i12 = a() ? 56 : 46;
                    i12 = i10 == 7 ? i12 + 39 : i12;
                    boolean z12 = LocaleController.isRTL;
                    addView(v1Var, k7.b6.d(-1, -2.0f, (z12 ? 5 : 3) | 16, z12 ? i11 : (i11 - 17) + i12, 0.0f, z12 ? (i11 - 17) + i12 : i11, 0.0f));
                }
            }
            this.e = v1Var;
        } else {
            ...
            if (i10 == 3) {
                w1Var.setGravity(19);
                addView(w1Var, k7.b6.d(-1, -2.0f, 19, 29.0f, 0.0f, 0.0f, 0.0f));
                w1Var.setPadding(0, 0, 0, AndroidUtilities.dp(3.0f));
            } else {
                w1Var.setGravity((LocaleController.isRTL ? 5 : 3) | 16);
                if (i10 == 2) {
                    boolean z13 = LocaleController.isRTL;
                    addView(w1Var, k7.b6.d(-1, -2.0f, (z13 ? 5 : 3) | 16, z13 ? 8 : 29, 0.0f, z13 ? 29 : 8, 0.0f));
                } else {
                    int i13 = a() ? 56 : 46;
                    i13 = i10 == 7 ? i13 + 39 : i13;
                    int i14 = a() ? -2 : -1;
                    boolean z14 = LocaleController.isRTL;
                    addView(w1Var, k7.b6.d(i14, -2.0f, (z14 ? 5 : 3) | 16, z14 ? i11 : (i11 - 17) + i13, 0.0f, z14 ? (i11 - 17) + i13 : i11, 0.0f));
                }
            }
            this.e = w1Var;
        }
        ...
        float f10 = i11;
        addView(textView, k7.b6.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, f10, 0.0f, f10, 0.0f));
        if (a()) {
            ...
            addView(kpVar, k7.b6.d(21, f11, (z15 ? 5 : 3) | 48, z15 ? 0 : i11, 16.0f, z15 ? i11 : 0, 0.0f));
        } else {
            if (i10 != 1 && i10 != 5) {
                z10 = false;
            }
            CheckBoxSquare checkBoxSquare = new CheckBoxSquare(context, f6Var, z10);
            ...
            if (i10 == 5) {
                ...
                addView(checkBoxSquare, k7.b6.d(18, f12, (z16 ? 5 : 3) | 16, z16 ? 0 : i11, 0.0f, z16 ? i11 : 0, 0.0f));
            } else if (i10 == 3) {
                addView(checkBoxSquare, k7.b6.d(18, 18, 51, 0.0f, 15.0f, 0.0f, 0.0f));
            } else if (i10 == 2) {
                addView(checkBoxSquare, k7.b6.d(18, 18, (LocaleController.isRTL ? 5 : 3) | 48, 0.0f, 15.0f, 0.0f, 0.0f));
            } else {
                float f13 = 18;
                boolean z17 = LocaleController.isRTL;
                addView(checkBoxSquare, k7.b6.d(18, f13, (z17 ? 5 : 3) | 48, z17 ? 0 : i11, 16.0f, z17 ? i11 : 0, 0.0f));
            }
        }
        if (i10 == 6) {
            x1 x1Var = new x1(this, context, R.drawable.msg_folders_groups);
            this.v = x1Var;
            addView(x1Var, k7.b6.i(-2.0f, -2.0f, 8388629, f10, 0.0f, i11 - 11, 0.0f));
        } else if (i10 == 8) {
            x1 x1Var2 = new x1(this, context, 0);
            this.v = x1Var2;
            addView(x1Var2, k7.b6.i(-2.0f, -2.0f, 8388629, f10, 0.0f, i11 - 11, 0.0f));
        } else if (i10 == 7) {
            ...
            addView(p9Var, k7.b6.i(34.0f, 34.0f, 8388627, 56.0f, 0.0f, 0.0f, 0.0f));
        }
        g();
    }
}
