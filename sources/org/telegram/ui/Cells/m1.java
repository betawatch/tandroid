    ...
    public m1(int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                this.d = new org.telegram.ui.Components.d6(new nh.m6(this, 29), 350L, jr.h, 0);
                break;
            default:
    ...
    public final void draw(Canvas canvas) {
        switch (this.a) {
            case 0:
                ...
                break;
            default:
                float e10 = ((org.telegram.ui.Components.d6) this.d).e(true);
                ...
                path.rewind();
                float f10 = f9 / 2.0f;
                path.moveTo(centerX - AndroidUtilities.lerp(f10, (-f9) / 2.0f, e10), centerY);
