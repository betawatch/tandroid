...
public class m9 extends z9 {
    ...
    public final void O() {
        if (y()) {
            ...
            if (i10 >= 0) {
                ...
                this.a = ((x9) arrayList.get(this.y0)).getX();
                this.b = ((x9) arrayList.get(this.y0)).getY();
            }
        }
    }
    ...
    public final void P() {
        if (y()) {
            ...
            if (i10 >= 0) {
                ...
                this.a = ((x9) arrayList.get(this.v0)).getX();
                this.b = ((x9) arrayList.get(this.v0)).getY();
            }
        }
    }
            ...
            if (i11 <= ((l9) this.W).getTop() || i11 >= ((l9) this.W).getBottom()) {
                ...
                while (true) {
                    ...
                    if (g0(this.F.getChildAt(i12))) {
                        l9 l9Var = (l9) this.F.getChildAt(i12);
                        if (i11 > l9Var.getTop() && i11 < l9Var.getBottom()) {
                            int d02 = d0((int) (i10 - l9Var.getX()), (int) (i11 - l9Var.getY()), l9Var);
                            if (d02 >= 0) {
                                h0((l9) this.W, l9Var, d02);
                                this.W = l9Var;
                                return true;
                            }
                        }
                ...
                int d03 = d0((int) (i10 - ((l9) this.W).getX()), (int) (i11 - ((l9) this.W).getY()), (l9) this.W);
                if (d03 != i13 && d03 >= 0) {
                    l9 l9Var2 = (l9) this.W;
                    h0(l9Var2, l9Var2, d03);
                    return true;
                }
            }
        }
    ...
    public final void a0(Canvas canvas, l9 l9Var, int i10) {
        ...
        if (e02 == i13 && e02 == this.x0) {
            ...
            int i15 = this.y0;
            if (i14 == i15 && i14 == i10) {
                i(canvas, x9Var.getLayout(), this.w0, i12, true, true, 0.0f);
                return;
            }
            if (i10 == i14) {
                i(canvas, x9Var.getLayout(), this.w0, length, true, false, 0.0f);
                return;
            }
            int i16 = i12;
            if (i10 == i15) {
    ...
    public final boolean b0() {
        ...
        if (y() && this.W != null && this.u0 == this.x0 && (i10 = this.v0) == this.y0) {
            ...
            arrayList.clear();
            ((l9) this.W).fillTextLayoutBlocks(arrayList);
            if (!arrayList.isEmpty() && i10 < arrayList.size() && (length = ((x9) arrayList.get(i10)).getLayout().getText().length()) > 0 && (this.w0 > 0 || this.z0 < length)) {
    ...
    public final CharSequence t(l9 l9Var, boolean z4) {
        ...
        return (arrayList.isEmpty() || i10 < 0 || i10 >= arrayList.size()) ? "" : ((x9) arrayList.get(i10)).getLayout().getText();
    }
    ...
    public final void h0(l9 l9Var, l9 l9Var2, int i10) {
        ...
        for (int i16 = 0; i16 < size; i16++) {
            X((x9) arrayList.get(i16), e02, i16);
        }
    }
    ...
    public final void j(int i10, p9 p9Var, boolean z4) {
        ...
        p9Var.b = ((x9) arrayList.get(i11)).getLayout();
    ...
    public final boolean k0(l9 l9Var, int i10, int i11, int i12) {
        ...
        if (!arrayList.isEmpty() && i10 >= 0 && i10 < arrayList.size()) {
            this.a = ((x9) arrayList.get(i10)).getX();
            this.b = ((x9) arrayList.get(i10)).getY();
        } else if (!arrayList.isEmpty()) {
            this.a = ((x9) arrayList.get(0)).getX();
            this.b = ((x9) arrayList.get(0)).getY();
        }
        y9 y9Var = this.C;
        if (y9Var != null) {
            y9Var.setVisibility(0);
    ...
    public final int l(int i10, int i11, int i12, int i13, u9 u9Var, boolean z4) {
        ...
        if (l9Var != null) {
            ...
            if (i16 >= 0 && i16 < arrayList.size()) {
                Layout layout = ((x9) arrayList.get(i16)).getLayout();
                if (i14 < 0) {
                    i14 = 1;
                }
                if (i15 < 0) {
    ...
    public final void l0(View view, int i10, int i11) {
        if (view instanceof l9) {
            ...
            ArrayList arrayList = this.F0;
            this.c = ((x9) arrayList.get(d02)).getX();
        ...
        if (s9VarArr != null && s9VarArr.length > 0) {
            ...
            for (s9 s9Var : s9VarArr) {
                ...
                if (spanStart >= 0 && spanEnd > spanStart) {
                    CharSequence charSequence8 = s9Var.a;
