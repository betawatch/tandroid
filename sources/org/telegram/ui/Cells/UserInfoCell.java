...
public class UserInfoCell extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i < this.rows.size()) {
            ...
            float dp2 = (((width - (this.width / f)) + AndroidUtilities.dp(f2)) + this.rowsKeysWidth) - row.key.getCurrentWidth();
            float dp3 = (width - (this.width / f)) + AndroidUtilities.dp(f2) + this.rowsKeysWidth + AndroidUtilities.dp(7.66f);
            int i2 = i;
