...
public final class ia implements k1, ah.k, me.a, qg.y1, com.google.android.gms.common.api.internal.o, s4.e0, n5.b, v0.i, com.google.android.gms.common.api.internal.s {
    ...
    public void b(Canvas canvas) {
        switch (this.a) {
            case 1:
                vi viVar = (vi) this.b;
                canvas.drawColor(viVar.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
            ...
            default:
                ...
                canvas.drawColor(iq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
                if (SharedConfig.chatBlurEnabled()) {
    ...
    public void g(za.a0 a0Var) {
        ((l5.r) ((i5.f) ((pa.b) this.b).get())).a("FIREBASE_APPQUALITY_SESSION", new i5.c("json"), new r5.d(this, 28)).a(new i5.a(null, a0Var, i5.d.a, null), new j2.e(18));
    }
    ...
    public void m(ah.a aVar) {
        switch (this.a) {
            case 1:
                aVar.a(((vi) this.b).getThemedColor(org.telegram.ui.ActionBar.j6.d6));
                aVar.b(SharedConfig.chatBlurEnabled());
                break;
            default:
                aVar.a(((iq0) this.b).getThemedColor(org.telegram.ui.ActionBar.j6.d6));
                aVar.b(SharedConfig.chatBlurEnabled());
                break;
        }
    }
    ...
    public boolean needClickAt(View view, float f7, float f10) {
        ...
        float f11 = -dp;
        i61Var.g.inset(f11, f11);
        boolean contains = i61Var.g.contains(f7, f10);
        float f12 = dp;
        i61Var.g.inset(f12, f12);
        return contains;
    }
    ...
    public void onClickAt(View view, float f7, float f10) {
        Runnable runnable = ((i61) this.b).j;
        if (runnable != null) {
            runnable.run();
        }
    }
