...
public final class ga extends FrameLayout {
    ...
    public final void d() {
        ...
        float f7 = this.s;
        addView(textView, w7.a6.d(-1, -1.0f, i11, f7, 0.0f, f7, 0.0f));
        int i12 = LocaleController.isRTL ? 3 : 5;
        org.telegram.ui.Components.o6 o6Var = this.c;
        o6Var.setGravity(i12 | 16);
        removeView(o6Var);
        addView(o6Var, w7.a6.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, f7, 0.0f, f7, 0.0f));
        View view = this.d;
        removeView(view);
        addView(view, w7.a6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 16, 21.0f, 0.0f, 21.0f, 0.0f));
        View view2 = this.f;
        removeView(view2);
        addView(view2, w7.a6.d(-2, -2.0f, (LocaleController.isRTL ? 3 : 5) | 16, f7, 0.0f, f7, 0.0f));
    }
    ...
    public org.telegram.ui.Components.w9 getValueBackupImageView() {
        if (this.e == null) {
            ...
            this.e = w9Var;
            float f7 = this.s - 4;
            addView(w9Var, w7.a6.d(24, 24.0f, (LocaleController.isRTL ? 3 : 5) | 16, f7, 0.0f, f7, 0.0f));
        }
        return this.e;
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (o6Var.getVisibility() == 0) {
            ...
            measuredWidth = this.H ? em.v(8.0f, o6Var.getMeasuredWidth(), i12) : (measuredWidth - o6Var.getMeasuredWidth()) - AndroidUtilities.dp(8.0f);
            if (imageView.getVisibility() == 0) {
    ...
    public void setIcon(int i10) {
        ...
        kj0Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.m6, this.a), PorterDuff.Mode.MULTIPLY));
    ...
    public ga(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        kj0Var.setVisibility(8);
        addView(kj0Var, w7.a6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 16, 16.0f, 0.0f, 16.0f, 0.0f));
        ImageView imageView = new ImageView(context);
        this.f = imageView;
        imageView.setScaleType(scaleType);
        imageView.setVisibility(4);
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, f6Var), mode));
        addView(imageView, w7.a6.d(-2, -2.0f, (LocaleController.isRTL ? 3 : 5) | 16, f7, 0.0f, f7, 0.0f));
    }
}
