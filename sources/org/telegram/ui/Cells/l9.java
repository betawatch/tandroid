...
public class l9 extends y9 {
    ...
    public final void O() {
        if (y()) {
            ...
            if (i10 >= 0) {
                f2.i0 i0Var = this.E0;
                k9 k9Var = i0Var != null ? (k9) i0Var.m(i10) : i10 < this.F.getChildCount() ? (k9) this.F.getChildAt(this.x0) : null;
                if (k9Var == null) {
                    this.W = null;
                    return;
                }
                ...
                this.a = ((w9) arrayList.get(this.y0)).getX();
                this.b = ((w9) arrayList.get(this.y0)).getY();
            }
        }
    }
    ...
    public final void P() {
        if (y()) {
            ...
            if (i10 >= 0) {
                f2.i0 i0Var = this.E0;
                k9 k9Var = i0Var != null ? (k9) i0Var.m(i10) : this.x0 < this.F.getChildCount() ? (k9) this.F.getChildAt(this.u0) : null;
                if (k9Var == null) {
                    this.W = null;
                    return;
                }
                ...
                this.a = ((w9) arrayList.get(this.v0)).getX();
                this.b = ((w9) arrayList.get(this.v0)).getY();
            }
        }
    }
            ...
            if (i11 <= ((k9) this.W).getTop() || i11 >= ((k9) this.W).getBottom()) {
                ...
                while (true) {
                    ...
                    if (g0(this.F.getChildAt(i12))) {
                        k9 k9Var = (k9) this.F.getChildAt(i12);
                        if (i11 > k9Var.getTop() && i11 < k9Var.getBottom()) {
                            int d02 = d0((int) (i10 - k9Var.getX()), (int) (i11 - k9Var.getY()), k9Var);
                            if (d02 >= 0) {
                                h0((k9) this.W, k9Var, d02);
                                this.W = k9Var;
                                return true;
                            }
                        }
                ...
                int d03 = d0((int) (i10 - ((k9) this.W).getX()), (int) (i11 - ((k9) this.W).getY()), (k9) this.W);
                if (d03 != i13 && d03 >= 0) {
                    k9 k9Var2 = (k9) this.W;
                    h0(k9Var2, k9Var2, d03);
                    return true;
                }
            }
        }
    ...
    public final void a0(Canvas canvas, k9 k9Var, int i10) {
        ...
        if (e02 == i13 && e02 == this.x0) {
            ...
            int i15 = this.y0;
            if (i14 == i15 && i14 == i10) {
                i(canvas, w9Var.getLayout(), this.w0, i12, true, true, 0.0f);
                return;
            }
            if (i10 == i14) {
                i(canvas, w9Var.getLayout(), this.w0, length, true, false, 0.0f);
                return;
            }
            int i16 = i12;
            if (i10 == i15) {
    ...
    public final boolean b0() {
        ...
        if (y() && this.W != null && this.u0 == this.x0 && (i10 = this.v0) == this.y0) {
            ...
            arrayList.clear();
            ((k9) this.W).fillTextLayoutBlocks(arrayList);
            if (!arrayList.isEmpty() && i10 < arrayList.size() && (length = ((w9) arrayList.get(i10)).getLayout().getText().length()) > 0 && (this.w0 > 0 || this.z0 < length)) {
    ...
    public final CharSequence t(k9 k9Var, boolean z4) {
        ...
        arrayList.clear();
        k9Var.fillTextLayoutBlocks(arrayList);
        int i10 = z4 ? this.A0 : this.J0 ? this.v0 : this.y0;
        return (arrayList.isEmpty() || i10 < 0 || i10 >= arrayList.size()) ? "" : ((w9) arrayList.get(i10)).getLayout().getText();
    }
    ...
    public final void h0(k9 k9Var, k9 k9Var2, int i10) {
        ...
        for (int i16 = 0; i16 < size; i16++) {
            X((w9) arrayList.get(i16), e02, i16);
        }
    }
    ...
    public final void j(int i10, o9 o9Var, boolean z4) {
        ...
        arrayList.clear();
        o9Var.e = null;
        k9 k9Var = (k9) (z4 ? this.X : this.W);
        if (k9Var == null) {
            o9Var.b = null;
            return;
        }
        k9Var.fillTextLayoutBlocks(arrayList);
        int i11 = z4 ? this.A0 : this.J0 ? this.v0 : this.y0;
        if (i11 < 0 || i11 >= arrayList.size()) {
            o9Var.b = null;
            return;
        }
        o9Var.b = ((w9) arrayList.get(i11)).getLayout();
    ...
    public final boolean k0(k9 k9Var, int i10, int i11, int i12) {
        ...
        if (!arrayList.isEmpty() && i10 >= 0 && i10 < arrayList.size()) {
            this.a = ((w9) arrayList.get(i10)).getX();
            this.b = ((w9) arrayList.get(i10)).getY();
        } else if (!arrayList.isEmpty()) {
            this.a = ((w9) arrayList.get(0)).getX();
            this.b = ((w9) arrayList.get(0)).getY();
        }
        x9 x9Var = this.C;
        if (x9Var != null) {
            x9Var.setVisibility(0);
    ...
    public final int l(int i10, int i11, int i12, int i13, t9 t9Var, boolean z4) {
        ...
        if (k9Var != null) {
            ...
            arrayList.clear();
            k9Var.fillTextLayoutBlocks(arrayList);
            int i16 = z4 ? this.A0 : this.J0 ? this.v0 : this.y0;
            if (i16 >= 0 && i16 < arrayList.size()) {
                Layout layout = ((w9) arrayList.get(i16)).getLayout();
                if (i14 < 0) {
                    i14 = 1;
                }
                if (i15 < 0) {
    ...
    public final void l0(View view, int i10, int i11) {
        if (view instanceof k9) {
            ...
            ArrayList arrayList = this.F0;
            this.c = ((w9) arrayList.get(d02)).getX();
        ...
        if (r9VarArr != null && r9VarArr.length > 0) {
            ...
            for (r9 r9Var : r9VarArr) {
                ...
                if (spanStart >= 0 && spanEnd > spanStart) {
                    CharSequence charSequence8 = r9Var.a;
