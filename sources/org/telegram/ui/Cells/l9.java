...
public abstract class l9 extends x9 {
    ...
    public final boolean D() {
        ...
        CharSequence s10;
        String str;
        if (!this.z0 || (s9Var = this.W) == null || ((s1) s9Var).getMessageObject() == null || (richMessageLayout = ((s1) this.W).getMessageObject().richLayout) == null || richMessageLayout.textBlocks.isEmpty() || (s10 = s()) == null || s10.length() == 0) {
            return false;
        }
        try {
    ...
    public final void Z(MessageObject messageObject, RichMessageLayout richMessageLayout, Canvas canvas) {
        s9 s9Var;
        Canvas canvas2;
        if (!this.z0 || richMessageLayout == null || (s9Var = this.W) == null || ((s1) s9Var).getMessageObject() == null || ((s1) this.W).getMessageObject().getId() != messageObject.getId()) {
            return;
        }
    ...
    public final void j(int i10, n9 n9Var, boolean z10) {
        ...
        MessageObject messageObject = s1Var.getMessageObject();
        if (this.v0) {
            n9Var.b = s1Var.getDescriptionlayout();
            n9Var.c = 0.0f;
            n9Var.d = 0.0f;
            n9Var.a = 0;
            return;
        ...
        if (this.x0) {
            n9Var.b = s1Var.getFactCheckLayout();
            n9Var.c = 0.0f;
            n9Var.d = 0.0f;
            n9Var.a = 0;
            return;
        ...
        if (this.z0) {
            ...
            n9Var.b = richMessageLayout.textBlocks.get(r4).getLayout();
            n9Var.c = r9.getY();
            n9Var.d = r9.getX();
            n9Var.a = richMessageLayout.textBlockCharOffsets.get(r4).intValue();
            return;
        }
        if (s1Var.P2()) {
            MessageObject.TextLayoutBlocks captionLayout = s1Var.getCaptionLayout();
            if (captionLayout.textLayoutBlocks.size() == 1) {
                n9Var.b = captionLayout.textLayoutBlocks.get(0).textLayout;
                n9Var.c = r9.padTop;
                MessageObject.TextLayoutBlock textLayoutBlock = captionLayout.textLayoutBlocks.get(0);
                float f9 = -(textLayoutBlock.isRtl() ? ((int) Math.ceil(captionLayout.textXOffset)) - (textLayoutBlock.quote ? AndroidUtilities.dp(10.0f) : 0) : 0);
                n9Var.d = f9;
            ...
            for (int i11 = 0; i11 < captionLayout.textLayoutBlocks.size(); i11++) {
                ...
                if (i12 >= 0 && i12 <= textLayoutBlock2.textLayout.getText().length()) {
                    n9Var.b = textLayoutBlock2.textLayout;
                    n9Var.c = textLayoutBlock2.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock2.padTop;
                    ...
                    n9Var.a = textLayoutBlock2.charactersOffset;
                    return;
                }
            }
            n9Var.b = null;
        ...
        if (arrayList.size() == 1) {
            n9Var.b = messageObject.textLayoutBlocks.get(0).textLayout;
            n9Var.c = r9.padTop;
        ...
        for (int i13 = 0; i13 < messageObject.textLayoutBlocks.size(); i13++) {
            ...
            if (i14 >= 0 && i14 <= textLayoutBlock4.textLayout.getText().length()) {
                n9Var.b = textLayoutBlock4.textLayout;
                n9Var.c = textLayoutBlock4.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock4.padTop;
                ...
                n9Var.a = textLayoutBlock4.charactersOffset;
                return;
            }
        }
        n9Var.b = null;
        ...
        if (z11) {
            ...
            if (!z12) {
                if (z13) {
                    ...
                    if (richMessageLayout != null && !richMessageLayout.textBlocks.isEmpty()) {
                        v9 v9Var = (v9) j7.l1.i(1, richMessageLayout.textBlocks);
                        Layout layout2 = v9Var.getLayout();
                    ...
                    if (!z10 ? this.v0 : this.w0) {
                        ...
                        if (!z10 ? this.x0 : this.y0) {
                            if (!z10 ? !this.z0 : !this.A0) {
                                ...
                                if (!s1Var.P2()) {
                                    ...
                                    while (true) {
                                        ...
                                        float f11 = i17;
                                        if (f11 < textLayoutBlock3.textYOffset(messageObject.textLayoutBlocks) || f11 > textLayoutBlock3.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock3.padTop + textLayoutBlock3.height(r1Var)) {
                                            i18++;
                                        } else {
                                            n9Var.b = textLayoutBlock3.textLayout;
                                            n9Var.c = textLayoutBlock3.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock3.padTop;
                                            ...
                                            n9Var.a = textLayoutBlock3.charactersOffset;
                                        }
                                    }
                                } else {
                                    MessageObject.TextLayoutBlocks captionLayout = s1Var.getCaptionLayout();
                                    ...
                                    while (true) {
                                        ...
                                        float f13 = i17;
                                        if (f13 < textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) || f13 > textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop + textLayoutBlock4.height(r1Var)) {
                                            i19++;
                                        } else {
                                            n9Var.b = textLayoutBlock4.textLayout;
                                            n9Var.c = textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop;
                                            ...
                                            n9Var.d = f14;
                                            if (textLayoutBlock4.code && !textLayoutBlock4.quote) {
                                                n9Var.d = f14 + AndroidUtilities.dp(8.0f);
                                            }
                                            n9Var.a = textLayoutBlock4.charactersOffset;
                                        }
                                    }
                                ...
                                if (richMessageLayout2 == null || richMessageLayout2.textBlocks.isEmpty()) {
                                    ...
                                    for (int i24 = 0; i24 < richMessageLayout2.textBlocks.size(); i24++) {
                                        v9 v9Var2 = richMessageLayout2.textBlocks.get(i24);
                                        int y8 = v9Var2.getY();
                                        int height = v9Var2.getLayout().getHeight() + y8;
                                        int x4 = v9Var2.getX();
                                        int width = v9Var2.getLayout().getWidth() + x4;
                                        boolean z14 = i17 >= y8 && i17 < height;
                                        boolean z15 = i16 >= x4 && i16 < width;
                                        v9Var2.getLayout().getText();
                                        if (z14) {
                                            if (x4 <= i16 && x4 > i20) {
                                                i20 = x4;
                                                i21 = i24;
                                            }
                                            int min = z15 ? 0 : Math.min(Math.abs(i16 - x4), Math.abs(i16 - width));
                                            if (min < i23) {
                                                i23 = min;
                                                i22 = i24;
                                            }
                                    ...
                                    if (i21 < 0) {
                                        ...
                                        for (int i26 = 0; i26 < richMessageLayout2.textBlocks.size(); i26++) {
                                            v9 v9Var3 = richMessageLayout2.textBlocks.get(i26);
                                            int y10 = v9Var3.getY();
                                            int min2 = Math.min(Math.abs(i17 - y10), Math.abs(i17 - (v9Var3.getLayout().getHeight() + y10)));
                                            if (min2 < i25) {
                                                i21 = i26;
                                                i25 = min2;
                                            }
                                    ...
                                    n9Var.b = richMessageLayout2.textBlocks.get(i21).getLayout();
                                    n9Var.c = r2.getY();
                                    n9Var.d = r2.getX();
                                    n9Var.a = richMessageLayout2.textBlockCharOffsets.get(i21).intValue();
                                }
                            }
                            layout = n9Var.b;
                            if (layout != null) {
                            ...
                            while (true) {
                                ...
                                float f15 = i17;
                                if (f15 > n9Var.c + layout.getLineTop(i28) && f15 < n9Var.c + layout.getLineBottom(i28)) {
                                    break;
                                }
                                i28++;
                            }
                            if (i28 >= 0) {
                                return layout.getOffsetForHorizontal(i28, i27) + n9Var.a;
                            }
                            return i15;
                        }
                        n9Var.b = s1Var.getFactCheckLayout();
