...
public class k6 extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r20v0, types: [android.view.View, org.telegram.ui.Cells.k6] */
    ...
    */
    public final void c(TLRPC.User user, TLRPC.Chat chat, TLRPC.Reaction reaction, boolean z10, long j10, TL_stories.StoryItem storyItem, boolean z11, boolean z12, boolean z13) {
        ...
        if (user == null) {
            ...
            this.c.h(ImageLocation.getForUserOrChat(i11, user2, 1), "50_50", y8Var2, user2);
            org.telegram.ui.Components.n9 n9Var2 = this.f;
            if (!z10) {
            }
        ...
        this.c.h(ImageLocation.getForUserOrChat(i11, user2, 1), "50_50", y8Var2, user2);
        org.telegram.ui.Components.n9 n9Var22 = this.f;
        if (!z10) {
            if (n9Var22 != null) {
                n9Var22.setAnimatedEmojiDrawable(null);
            }
            Drawable mutate = getContext().getDrawable(R.drawable.media_like_active).mutate();
            n9Var22.setColorFilter(new PorterDuffColorFilter(-53704, PorterDuff.Mode.MULTIPLY));
            n9Var22.setImageDrawable(mutate);
            ...
            if (d.f != null) {
                ...
                if (n9Var22 != null) {
                    if (tL_availableReaction != null) {
                        n9Var22.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.g6.a7, 1.0f), tL_availableReaction);
                        z15 = true;
                    } else {
                        n9Var22.setImageDrawable(null);
                        z15 = false;
                    }
                    n9Var22.setColorFilter(null);
                } else {
                    z15 = false;
                }
            } else {
                org.telegram.ui.Components.k5 k5Var = new org.telegram.ui.Components.k5(0, i11, d.g);
                k5Var.setColorFilter(org.telegram.ui.ActionBar.g6.n0(c6Var));
                if (n9Var22 != null) {
                    n9Var22.setAnimatedEmojiDrawable(k5Var);
                }
                z15 = true;
            }
        ...
        org.telegram.ui.Components.n9 n9Var32 = this.h;
        if (storyItem == null) {
            this.n = storyItem.id;
            if (n9Var32 != null) {
                ...
                if (messageMedia == null || (photo = messageMedia.photo) == null) {
                    ...
                    n9Var32.setRoundRadius(AndroidUtilities.dp(3.33f));
                } else {
                    n9Var = n9Var32;
            ...
            if (j10 <= 0) {
                j11 = storyItem.date;
                if (j11 != 0) {
                    StringBuilder f12 = s3.c.f(formatString, " ");
                ...
                if (j11 != 0) {
                    ...
                    lb0 lb0Var = storyItem != null ? z11 ? F : E : z12 ? C : D;
                    ...
                    if (z11 || storyItem == null) {
                        ...
                        if (!TextUtils.isEmpty(storyItem.caption)) {
                            ...
                            ps psVar = new ps();
                            psVar.c = 2.33333f;
                            psVar.b = AndroidUtilities.dp(5.0f);
                    ...
                    if (!z11 && storyItem != null && (storyFwdHeader = storyItem.fwd_from) != null && storyFwdHeader.modified) {
                        ...
                        ps psVar2 = new ps();
                        psVar2.c = 2.33333f;
                        psVar2.b = AndroidUtilities.dp(5.0f);
