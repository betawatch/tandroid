...
public final /* synthetic */ class ua implements View.OnClickListener {
    ...
    public /* synthetic */ ua(zn znVar, TLRPC.User user, String str, boolean z10, int i10) {
        this.d = znVar;
        this.e = str;
        this.b = z10;
        this.c = i10;
    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            case 0:
                ...
                xc.a0(uyVar).M(LocaleController.getString(z10 ? R.string.UnconfirmedAuthConfirmedBot : R.string.UnconfirmedAuthConfirmed), replaceSingleTag, R.raw.contact_check).j();
            ...
            default:
                ...
                if (znVar.getParentActivity() != null) {
                    ...
                    f3Var.show();
                    textView2.setOnClickListener(new org.telegram.ui.Components.d3(f3Var, i13));
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ ua(uy uyVar, boolean z10, int i10, ArrayList arrayList) {
        this.d = uyVar;
        this.b = z10;
        this.c = i10;
        this.e = arrayList;
