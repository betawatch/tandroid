    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            case 0:
                ...
                vc.a0(uyVar).M(LocaleController.getString(z10 ? R.string.UnconfirmedAuthConfirmedBot : R.string.UnconfirmedAuthConfirmed), replaceSingleTag, R.raw.contact_check).j();
            ...
            default:
                ...
                if (boVar.getParentActivity() != null) {
                    ...
                    f3Var.show();
                    textView2.setOnClickListener(new org.telegram.ui.Components.c3(f3Var, i13));
                    break;
                }
                break;
        }
