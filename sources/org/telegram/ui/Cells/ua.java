...
public class ua extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.a6 {
    ...
    public final void h(int i10, i51 i51Var, boolean z4) {
        ...
        if (user != null) {
            d(user, null, !TextUtils.isEmpty(publicUsername) ? vh.w2.e("@", publicUsername) : user.bot ? LocaleController.getString(R.string.Bot) : user.contact ? LocaleController.getString(R.string.FilterContact) : LocaleController.getString(R.string.FilterNonContact), z4);
        }
    }
    ...
    */
                    ...
                    if (user == null && MessagesController.getInstance(i12).isPremiumUser(user) && !MessagesController.getInstance(i12).premiumFeaturesBlocked()) {
                        if (DialogObject.getEmojiStatusDocumentId(user.emoji_status) != 0) {
                            ...
                            if (this.s == null) {
                                ...
                                sa saVar = new sa(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(14.0f), this.s);
                                this.s = saVar;
                                saVar.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z9, f6Var), PorterDuff.Mode.MULTIPLY));
                            }
                            k5Var2.i(this.s);
                        }
    ...
    public void setCallCellStyle(int i10) {
        ...
        if (kpVar != null) {
            ...
            kpVar.setLayoutParams(k7.b6.d(24, 24.0f, (z12 ? 5 : 3) | 48, z12 ? 0.0f : i10 + 37, 32.0f, z12 ? i10 + 37 : 0.0f, 0.0f));
        }
    }
