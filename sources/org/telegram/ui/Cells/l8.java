...
public class l8 extends FrameLayout {
    ...
    public final void k(String str, boolean z10, int i10, int i11, boolean z11) {
        ...
        if (this.f == null) {
            ...
            addView(this.f, h7.z5.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
        }
        Switch r132 = this.f;
        if (r132 != null) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.j6 j6Var = this.c;
        int max = ((i14 - Math.max(textHeight, j6Var.getTextHeight())) / 2) + 1;
        int dp2 = LocaleController.isRTL ? AndroidUtilities.dp(this.n - 6) : (i15 - j6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.n - 6);
        if (this.y && !LocaleController.isRTL) {
            dp2 = (i15 - j6Var.getMeasuredWidth()) - AndroidUtilities.dp(this.n);
        }
        ...
        if (z11) {
            dp = (getMeasuredWidth() - h5Var2.getMeasuredWidth()) - AndroidUtilities.dp(ri0Var.getVisibility() == 0 ? this.s : this.n);
        } else {
            dp = AndroidUtilities.dp(ri0Var.getVisibility() == 0 ? this.s : this.n);
        }
        org.telegram.ui.ActionBar.h5 h5Var3 = this.b;
        if (h5Var3.getVisibility() == 0) {
            float f10 = this.v > 50 ? 4 : 2;
            int dp4 = AndroidUtilities.dp(1.0f) + rl.x(f10, (i14 - h5Var2.getTextHeight()) - h5Var3.getTextHeight(), 2);
        ...
        if (ri0Var.getVisibility() == 0) {
            int dp7 = AndroidUtilities.dp(1.0f) + ((((i14 - ri0Var.getMeasuredHeight()) / 2) + AndroidUtilities.dp(this.v > 50 ? 0.0f : 2.0f)) - ri0Var.getPaddingTop());
            int dp8 = !LocaleController.isRTL ? AndroidUtilities.dp(this.w) : (i15 - ri0Var.getMeasuredWidth()) - AndroidUtilities.dp(this.w);
            ri0Var.layout(dp8, dp7, ri0Var.getMeasuredWidth() + dp8, ri0Var.getMeasuredHeight() + dp7);
        }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            h5Var3.measure(rl.d(this.n + 71, size, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_30));
            h5Var.measure(rl.d(this.n + 71, size, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_30));
        ...
        ri0 ri0Var = this.e;
        if (ri0Var.getVisibility() == 0) {
            ri0Var.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(dp, TLObject.FLAG_31));
        }
        ImageView imageView = this.h;
        if (imageView.getVisibility() == 0) {
    ...
    public final void s(CharSequence charSequence, CharSequence charSequence2, boolean z10, int i10, boolean z11) {
        ...
        if (charSequence2 != null) {
            int max = (int) Math.max(1.0f, AndroidUtilities.displaySize.x - ((lh.w3.g(charSequence, h5Var.getTextPaint()) + AndroidUtilities.dp(this.s)) + AndroidUtilities.dp(16.0f)));
            this.I = charSequence2;
    ...
    public final void v() {
        ...
        if (ri0Var.getTag() instanceof Integer) {
            int intValue2 = ((Integer) ri0Var.getTag()).intValue();
            ...
            ri0Var.setColorFilter(new PorterDuffColorFilter(v03, PorterDuff.Mode.SRC_IN));
        }
    ...
    public l8(int i10, Context context, org.telegram.ui.ActionBar.c6 c6Var, boolean z10, boolean z11) {
        ...
        this.c = j6Var;
        j6Var.setTextColor(org.telegram.ui.ActionBar.g6.v0(z10 ? org.telegram.ui.ActionBar.g6.n5 : org.telegram.ui.ActionBar.g6.I6, c6Var));
        ...
        ri0Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.v0(z10 ? org.telegram.ui.ActionBar.g6.J5 : org.telegram.ui.ActionBar.g6.m6, c6Var), PorterDuff.Mode.SRC_IN));
        addView(ri0Var);
