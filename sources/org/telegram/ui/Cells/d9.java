...
public class d9 extends FrameLayout {
    ...
    public final void b(Drawable drawable, String str) {
        ...
        vh.n nVar = this.a;
        if (z10) {
            ((ViewGroup.MarginLayoutParams) nVar.getLayoutParams()).leftMargin = dp;
        } else {
            ((ViewGroup.MarginLayoutParams) nVar.getLayoutParams()).rightMargin = dp;
        }
        nVar.requestLayout();
    }
    ...
    public final void e() {
        ...
        nVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, f6Var));
        nVar.invalidate();
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!z10) {
            ...
            vh.n nVar = this.a;
            z10 = nVar.a(x11 - nVar.getLeft(), ((int) motionEvent.getY()) - nVar.getTop()) != null;
        }
        if (z10) {
            return true;
        }
    ...
    public d9(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        boolean z12 = z10 || z11;
        this.h = z12;
        vh.n nVar = new vh.n(context, f6Var, true);
        this.a = nVar;
        final int i11 = 0;
        nVar.setOnLinkLongPressListener(new m90(this) { // from class: org.telegram.ui.Cells.b9
        ...
        this.b = c9Var;
        final int i12 = 1;
        c9Var.setOnLinkLongPressListener(new m90(this) { // from class: org.telegram.ui.Cells.b9
            public final /* synthetic */ d9 b;
        ...
        if (z10) {
            float f10 = i10;
            addView(c9Var, w7.y5.d(-1, -2.0f, (LocaleController.isRTL ? 5 : 3) | 80, f10, 32.0f, f10, 4.0f));
        } else {
            float f11 = i10;
            addView(c9Var, w7.y5.d(-1, -2.0f, LocaleController.isRTL ? 5 : 3, f11, 32.0f, f11, 4.0f));
        }
        c9 c9Var2 = new c9(this, context, f6Var, 1);
        this.c = c9Var2;
        final int i13 = 2;
        c9Var2.setOnLinkLongPressListener(new m90(this) { // from class: org.telegram.ui.Cells.b9
            public final /* synthetic */ d9 b;
        ...
        if (z10) {
            float f12 = i10;
            addView(c9Var2, w7.y5.d(-1, -2.0f, (LocaleController.isRTL ? 5 : 3) | 80, f12, 32.0f, f12, 4.0f));
        } else {
            float f13 = i10;
            addView(c9Var2, w7.y5.d(-1, -2.0f, LocaleController.isRTL ? 5 : 3, f13, 32.0f, f13, 4.0f));
        }
        e();
