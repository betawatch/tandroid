...
public class d9 extends FrameLayout {
    ...
    public d9(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
    ...
    public final void e() {
        ...
        oVar.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, d6Var));
        oVar.invalidate();
        int a10 = a(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        c9 c9Var = this.b;
        c9Var.setLinkTextColor(a10);
        int i11 = org.telegram.ui.ActionBar.h6.z6;
        c9Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
    ...
    public d9(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        super(context);
        this.n = d6Var;
        boolean z12 = z10 || z11;
        this.h = z12;
        vh.o oVar = new vh.o(context, d6Var, true);
        this.a = oVar;
        final int i11 = 0;
        oVar.setOnLinkLongPressListener(new c90(this) { // from class: org.telegram.ui.Cells.b9
        ...
        c9 c9Var = new c9(this, context, d6Var, 0);
        this.b = c9Var;
        final int i12 = 1;
        c9Var.setOnLinkLongPressListener(new c90(this) { // from class: org.telegram.ui.Cells.b9
            public final /* synthetic */ d9 b;
        ...
        if (z10) {
            float f10 = i10;
            addView(c9Var, w7.x5.d(-1, -2.0f, (LocaleController.isRTL ? 5 : 3) | 80, f10, 32.0f, f10, 4.0f));
        } else {
            float f11 = i10;
            addView(c9Var, w7.x5.d(-1, -2.0f, LocaleController.isRTL ? 5 : 3, f11, 32.0f, f11, 4.0f));
        }
        c9 c9Var2 = new c9(this, context, d6Var, 1);
        this.c = c9Var2;
        final int i13 = 2;
        c9Var2.setOnLinkLongPressListener(new c90(this) { // from class: org.telegram.ui.Cells.b9
            public final /* synthetic */ d9 b;
        ...
        if (z10) {
            float f12 = i10;
            addView(c9Var2, w7.x5.d(-1, -2.0f, (LocaleController.isRTL ? 5 : 3) | 80, f12, 32.0f, f12, 4.0f));
        } else {
            float f13 = i10;
            addView(c9Var2, w7.x5.d(-1, -2.0f, LocaleController.isRTL ? 5 : 3, f13, 32.0f, f13, 4.0f));
        }
        e();
