...
public final class d9 extends FrameLayout {
    ...
    public final void c() {
        ...
        layoutParams.leftMargin = AndroidUtilities.dp(z12 ? i9 : 64.0f);
        layoutParams.rightMargin = AndroidUtilities.dp(LocaleController.isRTL ? 64.0f : i9);
        textView2.setLayoutParams(layoutParams);
        textView.setGravity(LocaleController.isRTL ? 5 : 3);
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) textView.getLayoutParams();
        boolean z13 = LocaleController.isRTL;
        layoutParams2.gravity = (z13 ? 5 : 3) | 48;
        layoutParams2.leftMargin = AndroidUtilities.dp(z13 ? i9 : 64.0f);
        layoutParams2.rightMargin = AndroidUtilities.dp(LocaleController.isRTL ? 64.0f : i9);
    ...
    public final void onMeasure(int i9, int i10) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i9), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(this.b.getVisibility() == 0 ? 64.0f : this.e) + (this.d ? 1 : 0), TLObject.FLAG_30));
    }
