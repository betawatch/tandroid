...
public class k9 extends x9 {
    ...
    public final void O() {
        if (y()) {
            ...
            if (i10 >= 0) {
                f2.j0 j0Var = this.E0;
                j9 j9Var = j0Var != null ? (j9) j0Var.m(i10) : i10 < this.F.getChildCount() ? (j9) this.F.getChildAt(this.x0) : null;
                if (j9Var == null) {
                    this.W = null;
                    return;
                }
                ...
                this.a = ((v9) arrayList.get(this.y0)).getX();
                this.b = ((v9) arrayList.get(this.y0)).getY();
            }
        }
    }
    ...
    public final void P() {
        if (y()) {
            ...
            if (i10 >= 0) {
                f2.j0 j0Var = this.E0;
                j9 j9Var = j0Var != null ? (j9) j0Var.m(i10) : this.x0 < this.F.getChildCount() ? (j9) this.F.getChildAt(this.u0) : null;
                if (j9Var == null) {
                    this.W = null;
                    return;
                }
                ...
                this.a = ((v9) arrayList.get(this.v0)).getX();
                this.b = ((v9) arrayList.get(this.v0)).getY();
            }
        }
    }
            ...
            if (i11 <= ((j9) this.W).getTop() || i11 >= ((j9) this.W).getBottom()) {
                ...
                while (true) {
                    ...
                    if (g0(this.F.getChildAt(i12))) {
                        j9 j9Var = (j9) this.F.getChildAt(i12);
                        if (i11 > j9Var.getTop() && i11 < j9Var.getBottom()) {
                            int d02 = d0((int) (i10 - j9Var.getX()), (int) (i11 - j9Var.getY()), j9Var);
                            if (d02 >= 0) {
                                h0((j9) this.W, j9Var, d02);
                                this.W = j9Var;
                                return true;
                            }
                        }
                ...
                int d03 = d0((int) (i10 - ((j9) this.W).getX()), (int) (i11 - ((j9) this.W).getY()), (j9) this.W);
                if (d03 != i13 && d03 >= 0) {
                    j9 j9Var2 = (j9) this.W;
                    h0(j9Var2, j9Var2, d03);
                    return true;
                }
            }
        }
    ...
    public final void a0(Canvas canvas, j9 j9Var, int i10) {
        ...
        if (e02 == i13 && e02 == this.x0) {
            ...
            int i15 = this.y0;
            if (i14 == i15 && i14 == i10) {
                i(canvas, v9Var.getLayout(), this.w0, i12, true, true, 0.0f);
                return;
            }
            if (i10 == i14) {
                i(canvas, v9Var.getLayout(), this.w0, length, true, false, 0.0f);
                return;
            }
            int i16 = i12;
            if (i10 == i15) {
    ...
    public final boolean b0() {
        ...
        if (y() && this.W != null && this.u0 == this.x0 && (i10 = this.v0) == this.y0) {
            ...
            arrayList.clear();
            ((j9) this.W).fillTextLayoutBlocks(arrayList);
            if (!arrayList.isEmpty() && i10 < arrayList.size() && (length = ((v9) arrayList.get(i10)).getLayout().getText().length()) > 0 && (this.w0 > 0 || this.z0 < length)) {
    ...
    public final CharSequence t(j9 j9Var, boolean z10) {
        ...
        return (arrayList.isEmpty() || i10 < 0 || i10 >= arrayList.size()) ? "" : ((v9) arrayList.get(i10)).getLayout().getText();
    }
    ...
    public final void h0(j9 j9Var, j9 j9Var2, int i10) {
        ...
        for (int i16 = 0; i16 < size; i16++) {
            X((v9) arrayList.get(i16), e02, i16);
        }
    }
    ...
    public final void j(int i10, n9 n9Var, boolean z10) {
        ...
        n9Var.b = ((v9) arrayList.get(i11)).getLayout();
        n9Var.e = ((v9) arrayList.get(i11)).getSelectionBounds();
        n9Var.c = 0.0f;
        n9Var.d = 0.0f;
    }
    ...
    public final boolean k0(j9 j9Var, int i10, int i11, int i12) {
        ...
        if (!arrayList.isEmpty() && i10 >= 0 && i10 < arrayList.size()) {
            this.a = ((v9) arrayList.get(i10)).getX();
            this.b = ((v9) arrayList.get(i10)).getY();
        } else if (!arrayList.isEmpty()) {
            this.a = ((v9) arrayList.get(0)).getX();
            this.b = ((v9) arrayList.get(0)).getY();
        }
        w9 w9Var = this.C;
        if (w9Var != null) {
            w9Var.setVisibility(0);
    ...
    public final int l(int i10, int i11, int i12, int i13, s9 s9Var, boolean z10) {
        ...
        if (j9Var != null) {
            ...
            if (i16 >= 0 && i16 < arrayList.size()) {
                Layout layout = ((v9) arrayList.get(i16)).getLayout();
                if (i14 < 0) {
                    i14 = 1;
                }
                if (i15 < 0) {
    ...
    public final void l0(View view, int i10, int i11) {
        if (view instanceof j9) {
            ...
            ArrayList arrayList = this.F0;
            this.c = ((v9) arrayList.get(d02)).getX();
        ...
        if (q9VarArr != null && q9VarArr.length > 0) {
            ...
            for (q9 q9Var : q9VarArr) {
                ...
                if (spanStart >= 0 && spanEnd > spanStart) {
                    CharSequence charSequence8 = q9Var.a;
