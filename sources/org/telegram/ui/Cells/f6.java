...
public final class f6 extends a0 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.x5 {
    ...
    public final org.telegram.ui.Components.n5 o0;
    public final org.telegram.ui.Components.n5 p0;
    public final lh.h7 q0;
    ...
    public f6(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        this.i0 = new org.telegram.ui.Components.d6(this, 0L, 350L, jr.h);
        jr jrVar = jr.f;
        this.q0 = new lh.h7(null, false);
        this.r0 = new RectF();
        this.u0 = new uc(this);
        this.v0 = new RectF();
        this.D0 = true;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            Paint G = (!this.A0 || c6Var == null) ? null : c6Var.G("paintDivider");
            if (G == null) {
        ...
        if (this.N) {
            a0.o(this.O, this.P, org.telegram.ui.ActionBar.g6.a1);
            org.telegram.ui.ActionBar.g6.a1.draw(canvas2);
        }
        StaticLayout staticLayout = this.M;
        if (staticLayout != null) {
            boolean z11 = LocaleController.isRTL;
            org.telegram.ui.Components.n5 n5Var = this.o0;
            if (z11) {
                ceil = (int) (staticLayout.getLineRight(0) + this.K + AndroidUtilities.dp(6.0f));
            } else if (staticLayout.getLineLeft(0) == 0.0f) {
                ceil = (this.K - AndroidUtilities.dp(3.0f)) - n5Var.s;
            } else {
                f12 = 6.0f;
                ceil = (int) ((((this.K + this.Q) - Math.ceil(this.M.getLineWidth(0))) - AndroidUtilities.dp(3.0f)) - n5Var.s);
                a0.p(n5Var, ceil, ((this.M.getHeight() - n5Var.s) / 2.0f) + this.L);
                n5Var.draw(canvas2);
                canvas2.save();
                ...
                org.telegram.ui.Components.n5 n5Var2 = this.p0;
                a0.p(n5Var2, !z12 ? this.M.getLineLeft(0) == 0.0f ? (this.K - AndroidUtilities.dp(3.0f)) - n5Var2.s : (int) ((((this.K + this.Q) - Math.ceil(this.M.getLineWidth(0))) - AndroidUtilities.dp(3.0f)) - n5Var2.s) : (int) (this.M.getLineRight(0) + this.K + AndroidUtilities.dp(f12)), ((this.M.getHeight() - n5Var2.s) / 2.0f) + this.L);
                n5Var2.draw(canvas2);
            }
            f12 = 6.0f;
            a0.p(n5Var, ceil, ((this.M.getHeight() - n5Var.s) / 2.0f) + this.L);
            ...
            org.telegram.ui.Components.n5 n5Var22 = this.p0;
            a0.p(n5Var22, !z122 ? this.M.getLineLeft(0) == 0.0f ? (this.K - AndroidUtilities.dp(3.0f)) - n5Var22.s : (int) ((((this.K + this.Q) - Math.ceil(this.M.getLineWidth(0))) - AndroidUtilities.dp(3.0f)) - n5Var22.s) : (int) (this.M.getLineRight(0) + this.K + AndroidUtilities.dp(f12)), ((this.M.getHeight() - n5Var22.s) / 2.0f) + this.L);
            n5Var22.draw(canvas2);
        }
        if (this.x == null || this.s0 == null || this.t0 == null) {
            ...
            float dp3 = LocaleController.isRTL ? AndroidUtilities.dp(12.0f) : org.telegram.messenger.x3.B(12.0f, getWidth(), dp);
            int i10 = this.L;
            f9 = 2.0f;
            RectF rectF = this.r0;
            ...
            float f14 = f13 / 2.0f;
            canvas2.drawRoundRect(rectF2, f14, f14, this.t0);
            this.s0.c(AndroidUtilities.dp(6.33f), f14, 1.0f, v02, canvas);
            canvas2 = canvas;
            canvas2.restore();
        }
        if (this.n0 != null) {
        ...
        if (staticLayout2 != null) {
            ...
            f10 = 23.0f;
            f11 = 4.0f;
            canvas2.drawRoundRect(rectF3, f15, f15, MessagesController.getInstance(this.J).isDialogMuted(this.D, 0L) ? org.telegram.ui.ActionBar.g6.y0 : org.telegram.ui.ActionBar.g6.w0);
            canvas2.save();
        ...
        if (this.S != null) {
            ...
            adVar.g.setColor(w02);
            z zVar = adVar.e;
            if (zVar != null) {
                org.telegram.ui.ActionBar.g6.B1(zVar, w03, true);
            }
            RectF rectF4 = AndroidUtilities.rectTmp;
            rectF4.set(this.T, i11, this.S.getWidth() + r4, AndroidUtilities.dp(f10) + i11);
            ...
            ad adVar3 = this.R;
            adVar3.n = true;
            adVar3.c(canvas2, adVar3.g);
            z zVar2 = adVar3.e;
            if (zVar2 != null) {
                zVar2.draw(canvas2);
            }
            canvas2.save();
            canvas2.translate(this.T, AndroidUtilities.dp(f11) + i11);
            this.S.draw(canvas2);
            canvas2.restore();
        }
        boolean z13 = this.f;
        ...
        if (!z13) {
            ...
            if (chat == null || !chat.monoforum) {
                TLRPC.User user = this.y;
                if (user != null) {
                    lh.l7.h(user.id, canvas2, imageReceiver, h7Var);
                } else if (chat != null) {
                    if (ChatObject.isCommunity(chat)) {
                        Drawable drawable = org.telegram.ui.ActionBar.g6.S0;
                        RectF rectF5 = h7Var.F;
                        RectF rectF6 = h7Var.F;
                        jf.r.a(canvas2, drawable, rectF5.centerX(), rectF6.centerY(), rectF6.width());
                    }
                    lh.l7.h(-this.A.id, canvas2, imageReceiver, h7Var);
                } else {
                ...
                le0Var.a((int) rectF7.centerX(), (int) rectF8.centerY(), (int) (rectF8.width() / f9));
                canvas2.save();
        ...
        if (e10 > 0.0f) {
            ...
            canvas2.drawCircle(centerX, centerY, AndroidUtilities.dp(11.33f) * e10, org.telegram.ui.ActionBar.g6.t0);
            if (this.K0 == null) {
                this.K0 = new cg.r1(org.telegram.ui.ActionBar.g6.Lj, org.telegram.ui.ActionBar.g6.Mj, -1, -1, this.w);
            }
            ...
            this.L0.setBounds((int) (centerX - (((r3.getIntrinsicWidth() / f9) * 0.875f) * e10)), (int) (centerY - (((this.L0.getIntrinsicHeight() / f9) * 0.875f) * e10)), (int) (((this.L0.getIntrinsicWidth() / f9) * 0.875f * e10) + centerX), (int) (((this.L0.getIntrinsicHeight() / f9) * 0.875f * e10) + centerY));
        ...
        paint2.setColor(w04);
        float height = (getHeight() + dp9) / f9;
        RectF rectF9 = this.G0;
        rectF9.set(dp8, (getHeight() - dp9) / f9, dp7 + dp8, height);
        canvas2.save();
        float a10 = this.E0.a(0.06f);
        canvas2.scale(a10, a10, rectF9.centerX(), rectF9.centerY());
        canvas2.drawRoundRect(rectF9, rectF9.height() / f9, rectF9.height() / f9, paint2);
        this.H0.c(AndroidUtilities.dp(14.0f) + dp8, getHeight() / f9, 1.0f, -1, canvas);
        canvas.restore();
    }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (((this.y == null && this.A == null) || !this.q0.a(motionEvent, this)) && ((adVar = this.R) == null || !adVar.b(motionEvent))) {
    ...
    public final void r() {
        ...
        if (this.x != null) {
            if (this.s0 == null) {
                ...
                this.s0 = new zz0(append, 12.0f, null);
            }
            if (this.t0 == null) {
                this.t0 = new Paint(1);
            }
        ...
        if (chat3 != null) {
            ...
            if (chat3.monoforum) {
                ...
                if (chat4 != null) {
                    ...
                    spannableStringBuilder.setSpan(new o00(LocaleController.getString(R.string.MonoforumSpan), org.telegram.ui.ActionBar.g6.y6, c6Var), length, spannableStringBuilder.length(), 33);
        ...
        if (TextUtils.isEmpty(replaceNewLines)) {
            ...
            replaceNewLines = (user3 == null || TextUtils.isEmpty(user3.phone)) ? LocaleController.getString(R.string.HiddenName) : org.telegram.messenger.x3.k(new StringBuilder("+"), this.y.phone, qe.b.c());
        }
        if (this.A0) {
            if (this.B0 == null) {
        ...
        float dp4 = this.Q - AndroidUtilities.dp(f10);
        ...
        if (TextUtils.isEmpty(charSequence)) {
            ...
            i11 = i13;
            this.n0 = new StaticLayout(TextUtils.ellipsize(charSequence, textPaint4, i13 - AndroidUtilities.dp(f10), truncateAt), textPaint4, i13, alignment, 1.0f, 0.0f, false);
        ...
        if (LocaleController.isRTL) {
            ...
            if (staticLayout != null && staticLayout.getLineCount() > 0 && this.n0.getLineLeft(0) == f9) {
    ...
    */
    public final void u(int i10) {
        ...
        ImageReceiver imageReceiver = this.r;
        int i12 = this.J;
        org.telegram.ui.Components.e9 e9Var = this.s;
        ...
        if (user3 != null) {
            ...
            if (chat != null) {
                ...
                if (chatPhoto != null) {
                    ...
                    if (drawable4 != null) {
                        ...
                        if (chat.monoforum) {
                            ...
                            yf.d.n(i12, chat, e9Var, imageReceiver);
                        }
                        fileLocation3 = fileLocation;
                    }
                }
                ...
                ContactsController.Contact contact = this.C;
                if (contact != null) {
                    e9Var.n(0L, contact.first_name, contact.last_name);
                    imageReceiver.setImage(null, null, e9Var, null, null, 0);
                } else {
                    e9Var.n(0L, null, null);
                    imageReceiver.setImage(null, null, e9Var, null, null, 0);
                }
            }
        }
        ...
        if (i10 != 0) {
            ...
            if ((!z10 && (MessagesController.UPDATE_MASK_NAME & i10) != 0 && this.y != null) || ((MessagesController.UPDATE_MASK_CHAT_NAME & i10) != 0 && this.A != null)) {
                if (this.y != null) {
                    ...
                    TLRPC.Chat chat3 = this.A;
                    i11 = chat3.monoforum ? yf.d.i(chat3, i12, false) : chat3.title;
                }
        ...
        if (user5 != null) {
            ...
            if (chat4 != null) {
                this.E = chat4.monoforum ? yf.d.i(chat4, i12, false) : chat4.title;
            }
        }
    ...
    public final void v(boolean z10, TLRPC.User user, TLRPC.Chat chat, boolean z11) {
        boolean z12 = LocaleController.isRTL;
        org.telegram.ui.Components.n5 n5Var = this.p0;
        n5Var.a = z12;
        boolean z13 = this.D0;
        org.telegram.ui.ActionBar.c6 c6Var = this.w;
        if (z13 && z10) {
            n5Var.g(new jq(org.telegram.ui.ActionBar.g6.f1, org.telegram.ui.ActionBar.g6.i1, 0, 0), z11);
            n5Var.k(null);
            ...
            n5Var.k(Integer.valueOf(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.z9, c6Var)));
        ...
        org.telegram.ui.Components.n5 n5Var2 = this.o0;
        if (botVerificationIcon == 0 || this.H) {
            n5Var2.g(null, z11);
        } else {
            n5Var2.j(botVerificationIcon, z11);
        }
        n5Var2.k(Integer.valueOf(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.z9, c6Var)));
    }
