...
public final class u8 extends org.telegram.ui.Components.r6 {
    ...
    public final void b(Object obj, float f7) {
        switch (this.b) {
            ...
            case 11:
                ...
                RectF rectF = hVar.v;
                RectF rectF2 = hVar.s;
                float interpolation = 1.0f - uh.f.p.getInterpolation(f7);
                float interpolation2 = (uh.f.h.getInterpolation(hVar.G) - uh.f.i.getInterpolation(hVar.G)) * AndroidUtilities.dp(13.0f);
                RectF rectF3 = hVar.n;
                RectF rectF4 = hVar.h;
                rectF3.set(rectF4);
                rectF3.offset(0.0f, -interpolation2);
                float g10 = uh.h.g(rectF3.height(), (AndroidUtilities.dp(2.0f) * interpolation) + AndroidUtilities.dp(uh.g.b), uh.f.l.getInterpolation(hVar.G)) / 2.0f;
                uh.e eVar = uh.f.m;
                ...
                float interpolation4 = ((rectF4.bottom - g10) - 1.0f) - (uh.f.n.getInterpolation(hVar.G) * ((AndroidUtilities.dp(6.0f) * interpolation) + AndroidUtilities.dp(38.0f)));
                RectF rectF5 = hVar.r;
                ...
                if (hVar.Q && !hVar.M) {
                    float g12 = uh.h.g(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(3.0f), uh.f.o.getInterpolation(hVar.G));
                    ...
                    if (z10) {
                        PointF f12 = uh.h.f(rectF3.centerX(), rectF3.centerY(), (rectF3.height() / 2.0f) + g12, (rectF5.height() / 2.0f) + rectF5.left, rectF5.centerY(), (rectF5.height() / 2.0f) + g12, true);
                        if (f12 != null) {
                            centerX = f12.x;
                            f11 = f12.y;
                        } else {
                    ...
                    if (z11) {
                        PointF f14 = uh.h.f(rectF3.centerX(), rectF3.centerY(), (rectF3.height() / 2.0f) + g12, rectF5.right - (rectF5.height() / 2.0f), rectF5.centerY(), (rectF5.height() / 2.0f) + g12, false);
                        if (f14 != null) {
                            centerX2 = f14.x;
                            f13 = f14.y;
                        } else {
                    ...
                    if (hVar.Q) {
                        ...
                        float b12 = z10 ? uh.h.b(rectF2.centerX(), rectF2.centerY(), (rectF5.height() / 2.0f) + rectF5.left, rectF5.centerY()) : -90.0f;
                        float j3 = uh.h.j(b11);
                        float f15 = b12;
                        ...
                        RectF rectF6 = uh.h.b0;
                        float f16 = rectF5.left;
                        rectF6.set(f16, rectF5.top, rectF5.height() + f16, rectF5.bottom);
                        hVar.a(path, rectF6, uh.h.j(f15), -90.0f, false, false);
                        path.lineTo(rectF5.right - (rectF5.height() / 2.0f), rectF5.top);
                        float b13 = z11 ? uh.h.b(rectF.centerX(), rectF.centerY(), rectF5.right - (rectF5.height() / 2.0f), rectF5.centerY()) : -90.0f;
                        rectF6.set(rectF5.right - rectF5.height(), rectF5.top, rectF5.right, rectF5.bottom);
                        hVar.a(path, rectF6, -90.0f, uh.h.j(b13), false, false);
                        if (!z11) {
                            path.lineTo(rectF.centerX(), rectF5.bottom);
                        }
                        hVar.a(path, rectF, b13, uh.h.j(b10), true, true);
                        path.close();
                    }
                }
                hVar.invalidateSelf();
    ...
    public final Object get(Object obj) {
        switch (this.b) {
            ...
            case 10:
                return Float.valueOf(((n61) obj).E);
            case 11:
