...
public final class fa extends FrameLayout {
    ...
    public final void d() {
        ...
        removeView(p6Var);
        addView(p6Var, w7.x5.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, f7, 0.0f, f7, 0.0f));
        View view = this.d;
        removeView(view);
    ...
    public org.telegram.ui.Components.w9 getValueBackupImageView() {
        if (this.e == null) {
            ...
            this.e = w9Var;
            float f7 = this.s - 4;
            addView(w9Var, w7.x5.d(24, 24.0f, (LocaleController.isRTL ? 3 : 5) | 16, f7, 0.0f, f7, 0.0f));
        }
        return this.e;
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (p6Var.getVisibility() == 0) {
            ...
            measuredWidth = this.H ? ul.w(8.0f, p6Var.getMeasuredWidth(), i12) : (measuredWidth - p6Var.getMeasuredWidth()) - AndroidUtilities.dp(8.0f);
            if (imageView.getVisibility() == 0) {
    ...
    public void setIcon(int i10) {
        ...
        bj0Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.m6, this.a), PorterDuff.Mode.MULTIPLY));
