...
public final class fa extends FrameLayout {
    ...
    public final void d() {
        ...
        removeView(o6Var);
        addView(o6Var, w7.y5.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, f7, 0.0f, f7, 0.0f));
        View view = this.d;
        removeView(view);
    ...
    public org.telegram.ui.Components.v9 getValueBackupImageView() {
        if (this.e == null) {
            ...
            this.e = v9Var;
            float f7 = this.s - 4;
            addView(v9Var, w7.y5.d(24, 24.0f, (LocaleController.isRTL ? 3 : 5) | 16, f7, 0.0f, f7, 0.0f));
        }
        return this.e;
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        org.telegram.ui.Components.v9 v9Var = this.e;
        if (v9Var != null) {
            v9Var.measure(View.MeasureSpec.makeMeasureSpec(v9Var.getLayoutParams().height, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(this.e.getLayoutParams().width, TLObject.FLAG_30));
            if (this.H) {
        ...
        if (o6Var.getVisibility() == 0) {
            ...
            measuredWidth = this.H ? rk.x(8.0f, o6Var.getMeasuredWidth(), i12) : (measuredWidth - o6Var.getMeasuredWidth()) - AndroidUtilities.dp(8.0f);
            if (imageView.getVisibility() == 0) {
    ...
    public fa(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        kj0Var.setVisibility(8);
        addView(kj0Var, w7.y5.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 16, 16.0f, 0.0f, 16.0f, 0.0f));
