...
public final /* synthetic */ class pa implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            case 0:
                ...
                SpannableStringBuilder replaceSingleTag = AndroidUtilities.replaceSingleTag(string, i13, 0, new g(oyVar, 10));
                SpannableString spannableString = new SpannableString(">");
                mq mqVar = new mq(R.drawable.attach_arrow_right, 0);
                mqVar.setOverrideColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
                ...
                qc.a0(oyVar).M(LocaleController.getString(z4 ? R.string.UnconfirmedAuthConfirmedBot : R.string.UnconfirmedAuthConfirmed), replaceSingleTag, R.raw.contact_check).j();
    ...
    public /* synthetic */ pa(oy oyVar, boolean z4, int i10, ArrayList arrayList) {
        this.d = oyVar;
        this.b = z4;
        this.c = i10;
        this.e = arrayList;
