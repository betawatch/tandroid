...
public final class k8 extends FrameLayout {
    ...
    public k8(Context context, boolean z10, boolean z11, org.telegram.ui.ActionBar.c6 c6Var, boolean z12) {
        ...
        this.a = textView;
        org.telegram.messenger.x3.t(textView, z12 ? a(0.6f) : org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Te, c6Var), 1, 15.0f);
        ...
        if (z11) {
            d = i7.f6.i(-2.0f, -2.0f, 8388659, z10 ? 5.0f : 15.0f, 5.0f, z10 ? 15.0f : 25.0f, 0.0f);
        } else {
            d = i7.f6.d(-2, -2.0f, 51, z10 ? 5.0f : 15.0f, 5.0f, z10 ? 15.0f : 25.0f, 0.0f);
        }
        ...
        int a10 = z12 ? a(0.08f) : org.telegram.ui.ActionBar.g6.l1(0.24f, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Te, c6Var));
        i10.setBackground(org.telegram.ui.ActionBar.g6.i0(dp, dp, dp, dp, a2, a10, a10));
        i10.setGravity(17);
        ...
        addView(textView2, z11 ? i7.f6.i(-2.0f, -2.0f, 8388661, 12.0f, 6.0f, 17.0f, 0.0f) : i7.f6.d(-2, -2.0f, 53, 12.0f, 6.0f, 17.0f, 0.0f));
        ...
        if (z11) {
            d10 = i7.f6.i(24.0f, 24.0f, 8388661, 0.0f, 0.0f, z10 ? 0.0f : 10.0f, 0.0f);
        } else {
            d10 = i7.f6.d(24, 24.0f, 53, 0.0f, 0.0f, z10 ? 0.0f : 10.0f, 0.0f);
        }
    ...
    public final void f() {
        ...
        if (this.r != null) {
            ...
            try {
                spannableStringBuilder.setSpan(new hq(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Ue, c6Var)), 0, this.s, 33);
                spannableStringBuilder.setSpan(new hq(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Te, c6Var)), this.s, this.r.length(), 33);
            } catch (Exception unused) {
            }
    ...
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (view == this.b) {
            i11 = org.telegram.messenger.x3.C(16.0f, this.a.getMeasuredWidth(), i11);
        }
