...
public class r9 extends ea {
    ...
    public final void B(int i10, int i11, boolean z10, float f7, float f10, z9 z9Var) {
        q9 q9Var = (q9) z9Var;
        if (!z10 || q9Var != this.W || f10 != f7) {
            super.B(i10, i11, z10, f7, f10, q9Var);
        } else if (this.j) {
            this.u = i10;
        } else {
            this.v = i10;
    ...
    public final void M(z9 z9Var, z9 z9Var2) {
        ...
        arrayList.clear();
        q9Var.fillTextLayoutBlocks(arrayList);
        int size = arrayList.size();
        this.D0.put(e02, size);
        for (int i11 = 0; i11 < size; i11++) {
            X((ca) arrayList.get(i11), e02, i11);
        }
    }
    ...
    public final void O() {
        if (y()) {
            ...
            if (i10 >= 0) {
                s4.c0 c0Var = this.E0;
                q9 q9Var = c0Var != null ? (q9) c0Var.m(i10) : i10 < this.F.getChildCount() ? (q9) this.F.getChildAt(this.x0) : null;
                if (q9Var == null) {
                    this.W = null;
                    return;
                }
                ...
                this.v = this.z0;
                CharSequence t10 = t(q9Var, false);
                if (this.v > t10.length()) {
                    this.v = t10.length();
                }
                ArrayList arrayList = this.F0;
                arrayList.clear();
                ((q9) this.W).fillTextLayoutBlocks(arrayList);
                int i11 = this.y0;
                if (i11 < 0 || i11 >= arrayList.size()) {
                    return;
                }
                this.a = ((ca) arrayList.get(this.y0)).getX();
                this.b = ((ca) arrayList.get(this.y0)).getY();
            }
        }
    }
    ...
    public final void P() {
        if (y()) {
            ...
            if (i10 >= 0) {
                s4.c0 c0Var = this.E0;
                q9 q9Var = c0Var != null ? (q9) c0Var.m(i10) : this.x0 < this.F.getChildCount() ? (q9) this.F.getChildAt(this.u0) : null;
                if (q9Var == null) {
                    this.W = null;
                    return;
                }
                ...
                this.a = ((ca) arrayList.get(this.v0)).getX();
                this.b = ((ca) arrayList.get(this.v0)).getY();
            }
        }
    }
    ...
    public final boolean Q(int i10, int i11) {
        if (this.Z) {
            if (i11 <= ((q9) this.W).getTop() || i11 >= ((q9) this.W).getBottom()) {
                ...
                while (true) {
                    ...
                    if (g0(this.F.getChildAt(i12))) {
                        q9 q9Var = (q9) this.F.getChildAt(i12);
                        if (i11 > q9Var.getTop() && i11 < q9Var.getBottom()) {
                            int d02 = d0((int) (i10 - q9Var.getX()), (int) (i11 - q9Var.getY()), q9Var);
                            if (d02 >= 0) {
                                h0((q9) this.W, q9Var, d02);
                                this.W = q9Var;
                                return true;
                            }
                        }
                ...
                int d03 = d0((int) (i10 - ((q9) this.W).getX()), (int) (i11 - ((q9) this.W).getY()), (q9) this.W);
                if (d03 != i13 && d03 >= 0) {
                    q9 q9Var2 = (q9) this.W;
                    h0(q9Var2, q9Var2, d03);
                    return true;
                }
            }
        }
    ...
    public final void X(ca caVar, int i10, int i11) {
        int i12 = i10 + (i11 << 16);
        this.B0.put(i12, Z(caVar.getText()));
        CharSequence prefix = caVar.getPrefix();
    ...
    public final void a0(Canvas canvas, q9 q9Var, int i10) {
        ca caVar;
        ...
        arrayList.clear();
        q9Var.fillTextLayoutBlocks(arrayList);
        if (i10 < 0 || i10 >= arrayList.size() || (caVar = (ca) arrayList.get(i10)) == null || caVar.getLayout() == null || caVar.getLayout().getText() == null) {
            return;
        }
        int i12 = this.z0;
        int length = caVar.getLayout().getText().length();
        if (i12 > length) {
            i12 = length;
        }
        int i13 = this.u0;
        if (e02 == i13 && e02 == this.x0) {
            ...
            int i15 = this.y0;
            if (i14 == i15 && i14 == i10) {
                i(canvas, caVar.getLayout(), this.w0, i12, true, true, 0.0f);
                return;
            }
            if (i10 == i14) {
                i(canvas, caVar.getLayout(), this.w0, length, true, false, 0.0f);
                return;
            }
            int i16 = i12;
            if (i10 == i15) {
                i(canvas, caVar.getLayout(), 0, i16, false, true, 0.0f);
                return;
            } else {
                if (i10 <= i14 || i10 >= i15) {
                    return;
                }
                i(canvas, caVar.getLayout(), 0, length, false, false, 0.0f);
                return;
            }
        }
        int i17 = i12;
        ...
        if (e02 == i18 && this.y0 == i10) {
            i(canvas, caVar.getLayout(), 0, i17, false, true, 0.0f);
            return;
        }
    ...
    public final boolean b0() {
        ...
        if (y() && this.W != null && this.u0 == this.x0 && (i10 = this.v0) == this.y0) {
            ...
            arrayList.clear();
            ((q9) this.W).fillTextLayoutBlocks(arrayList);
            if (!arrayList.isEmpty() && i10 < arrayList.size() && (length = ((ca) arrayList.get(i10)).getLayout().getText().length()) > 0 && (this.w0 > 0 || this.z0 < length)) {
                return k0((q9) this.W, i10, 0, length);
            }
        }
        return false;
    }
    ...
    public final boolean c0(int i10, int i11, q9 q9Var) {
        int i12;
        int i13;
        int i14;
        int e02 = e0(q9Var);
    ...
    public final int d0(int i10, int i11, q9 q9Var) {
        int i12 = 0;
        if (q9Var instanceof ViewGroup) {
            ViewGroup viewGroup = (ViewGroup) q9Var;
            for (int i13 = 0; i13 < viewGroup.getChildCount(); i13++) {
                View childAt = viewGroup.getChildAt(i13);
                if (childAt instanceof q9) {
                    float f7 = i11;
                    if (f7 > childAt.getY() && f7 < childAt.getY() + childAt.getHeight()) {
                        return d0((int) (i10 - childAt.getX()), (int) (f7 - childAt.getY()), (q9) childAt);
                    }
                }
            }
        }
        ...
        while (true) {
            ...
            ca caVar = (ca) arrayList.get(size);
            int y3 = caVar.getY();
            int height = caVar.getLayout().getHeight() + y3;
        ...
        int row = ((ca) arrayList.get(size)).getRow();
        if (row > 0 && i12 < AndroidUtilities.dp(24.0f)) {
            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                ca caVar2 = (ca) arrayList.get(size2);
                if (caVar2.getRow() == row) {
                    int x10 = caVar2.getX();
                    int width = caVar2.getLayout().getWidth() + caVar2.getX();
    ...
    public final int e0(q9 q9Var) {
        ...
        if (parent != null) {
            return this.E != null ? RecyclerView.S(view) : viewGroup.indexOfChild(view);
        }
        return -1;
    }
    ...
    public final CharSequence t(q9 q9Var, boolean z10) {
        ArrayList arrayList = this.F0;
        arrayList.clear();
        q9Var.fillTextLayoutBlocks(arrayList);
        int i10 = z10 ? this.A0 : this.J0 ? this.v0 : this.y0;
        return (arrayList.isEmpty() || i10 < 0 || i10 >= arrayList.size()) ? "" : ((ca) arrayList.get(i10)).getLayout().getText();
    }
    ...
    public final boolean g0(View view) {
        ...
        ArrayList arrayList = this.F0;
        arrayList.clear();
        ((q9) view).fillTextLayoutBlocks(arrayList);
        if (view instanceof org.telegram.ui.t2) {
            return true;
        }
        return !arrayList.isEmpty();
    }

    public final void h0(q9 q9Var, q9 q9Var2, int i10) {
        int i11;
        int e02 = e0(q9Var2);
        int e03 = q9Var != null ? e0(q9Var) : -1;
        x();
        ...
        ArrayList arrayList = this.F0;
        arrayList.clear();
        q9Var2.fillTextLayoutBlocks(arrayList);
        int size = arrayList.size();
        this.D0.put(e02, size);
        for (int i16 = 0; i16 < size; i16++) {
            X((ca) arrayList.get(i16), e02, i16);
        }
    }

    public final void i0(q9 q9Var, int i10) {
        ArrayList arrayList = this.F0;
        arrayList.clear();
        q9Var.fillTextLayoutBlocks(arrayList);
        int size = arrayList.size();
        ...
        for (int i11 = 0; i11 < size; i11++) {
            X((ca) arrayList.get(i11), i10, i11);
        }
    }
    ...
    public final void j(int i10, u9 u9Var, boolean z10) {
        ...
        u9Var.b = ((ca) arrayList.get(i11)).getLayout();
        u9Var.e = ((ca) arrayList.get(i11)).getSelectionBounds();
        u9Var.c = 0.0f;
        u9Var.d = 0.0f;
    }
    ...
    public final boolean k0(q9 q9Var, int i10, int i11, int i12) {
        int e02 = e0(q9Var);
        if (e02 < 0 || i11 == i12) {
            return false;
        }
        ...
        if (!arrayList.isEmpty() && i10 >= 0 && i10 < arrayList.size()) {
            this.a = ((ca) arrayList.get(i10)).getX();
            this.b = ((ca) arrayList.get(i10)).getY();
        } else if (!arrayList.isEmpty()) {
            this.a = ((ca) arrayList.get(0)).getX();
            this.b = ((ca) arrayList.get(0)).getY();
        }
        da daVar = this.C;
        if (daVar != null) {
            daVar.setVisibility(0);
    ...
    public final int l(int i10, int i11, int i12, int i13, z9 z9Var, boolean z10) {
        ...
        if (q9Var != null) {
            ...
            if (i16 >= 0 && i16 < arrayList.size()) {
                Layout layout = ((ca) arrayList.get(i16)).getLayout();
                if (i14 < 0) {
                    i14 = 1;
                }
                if (i15 < 0) {
    ...
    public final void l0(View view, int i10, int i11) {
        if (view instanceof q9) {
            ...
            ArrayList arrayList = this.F0;
            this.c = ((ca) arrayList.get(d02)).getX();
            this.d = ((ca) arrayList.get(this.A0)).getY();
        }
    }
    ...
    public final int n() {
        if (this.W != null) {
            ...
            if (i10 >= 0 && i10 < arrayList.size()) {
                Layout layout = ((ca) arrayList.get(i10)).getLayout();
    ...
    public final CharSequence s() {
        ...
        x9[] x9VarArr = (x9[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length() - 1, x9.class);
        if (x9VarArr != null && x9VarArr.length > 0) {
            Arrays.sort(x9VarArr, new p1(spannableStringBuilder, 1));
            for (x9 x9Var : x9VarArr) {
                int spanStart = spannableStringBuilder.getSpanStart(x9Var);
                int spanEnd = spannableStringBuilder.getSpanEnd(x9Var);
                if (spanStart >= 0 && spanEnd > spanStart) {
                    CharSequence charSequence8 = x9Var.a;
        ...
        for (t9 t9Var : (t9[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length() - 1, t9.class)) {
            spannableStringBuilder.delete(spannableStringBuilder.getSpanStart(t9Var), spannableStringBuilder.getSpanEnd(t9Var));
        }
