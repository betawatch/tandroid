...
public final class e6 {
    ...
    public static /* synthetic */ void a(e6 e6Var, TLObject tLObject, MessagesStorage messagesStorage, long j10, int i10, ArrayList arrayList) {
        ArrayList arrayList2 = e6Var.d;
        int i11 = e6Var.a;
        ...
        if (i10 == e6Var.e && !messages_messages.messages.isEmpty()) {
            arrayList2.clear();
            Collections.sort(arrayList, Comparator$-CC.comparingInt(new kf.d(13)));
            TLRPC.Message message = (TLRPC.Message) kf.k0.i(1, messages_messages.messages);
    ...
    public static /* synthetic */ void b(e6 e6Var, int i10, ArrayList arrayList, long j10, int i11, MessagesStorage messagesStorage) {
        int i12 = e6Var.a;
        ArrayList arrayList2 = e6Var.d;
        if (i10 != e6Var.e) {
            return;
        ...
        if (!arrayList.isEmpty()) {
            arrayList2.clear();
            Collections.sort(arrayList, Comparator$-CC.comparingInt(new kf.d(12)));
        ...
        ConnectionsManager.getInstance(i12).sendRequest(tL_channels_getMessages, new jd(e6Var, messagesStorage, j10, i10, arrayList));
    }
