...
public class e6 extends FrameLayout implements yy0, le.d {
    ...
    public e6(Context context, int i10, View.OnClickListener onClickListener, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (onClickListener != null) {
            ...
            addView(d6Var, w7.y5.d(-1, -2.0f, (z10 ? 5 : 3) | 16, z10 ? i11 : 54.0f, 0.0f, !z10 ? i11 : 54.0f, 0.0f));
            ...
            final int i13 = 0;
            npVar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Cells.c6
            ...
            addView(d6Var, w7.y5.d(-1, -2.0f, (z13 ? 5 : 3) | 16, z13 ? i14 : 19.0f, 0.0f, z13 ? 19.0f : i14, 0.0f));
        }
        if (i10 == 1) {
            ah ahVar = new ah(context);
            this.y = ahVar;
            ahVar.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.m6, f6Var), PorterDuff.Mode.SRC_IN));
            ahVar.j(yg.e, false);
            ...
            final int i16 = 1;
            ahVar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Cells.c6
                public final /* synthetic */ e6 b;
    ...
    public final qh.d b() {
        ...
        if (d6Var != null) {
            ...
            d6Var.setLayoutParams(w7.y5.d(-1, -2.0f, i11, f10, 0.0f, f7, 0.0f));
        }
        return this.e;
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        d6Var.measure(rk.c(this.E != null ? r9.intValue() : this.n == null ? 42 : imageView == null ? 70 : ahVar != null ? 144 : 122, (size - getPaddingLeft()) - getPaddingRight(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(0, 0));
