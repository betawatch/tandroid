...
public final class o2 {
    ...
    */
    public final boolean a() {
        ...
        r2 r2Var = this.q;
        int i12 = r2Var.C0;
        TLRPC.Dialog dialog = (TLRPC.Dialog) MessagesController.getInstance(i12).dialogs_dict.f(r2Var.E0);
        if (dialog == null) {
            if (r2Var.g1 == 3) {
                long j11 = this.a;
                long j12 = r2Var.E0;
        ...
        MessageObject messageObject = r2Var.c1;
        int hashCode = messageObject == null ? 0 : r2Var.c1.hashCode() + messageObject.getId();
        ...
        if (r2Var.Q()) {
            int[] forumUnreadCount = MessagesController.getInstance(i12).getTopicsController().getForumUnreadCount(-r2Var.E0);
        ...
        if (!r2Var.Q() && (r2Var.K0 || r2Var.M)) {
            ...
            if (!TextUtils.isEmpty(messagesController.getPrintingString(j14, topicId3, true))) {
                ...
                if (r2Var.Q()) {
                    ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(i12).getTopicsController().getTopics(-r2Var.E0);
                    ...
                    if (!r2Var.M) {
                        ...
                        z4 = false;
                        if (r2Var.K0) {
                            z10 = MediaDataController.getInstance(i12).getDraftVoice(r2Var.E0, 0L) != null;
                            draft = !z10 ? MediaDataController.getInstance(i12).getDraft(r2Var.E0, 0L) : null;
                            if (draft == null) {
                            }
                            TLRPC.Chat chat = r2Var.d2;
                            if (chat == null) {
                            }
                            isTranslatingDialog = MessagesController.getInstance(i12).getTranslateController().isTranslatingDialog(r2Var.E0);
                    ...
                    TLRPC.Chat chat22 = r2Var.d2;
                    z11 = chat22 == null && chat22.call_active && chat22.call_not_empty;
                    isTranslatingDialog = MessagesController.getInstance(i12).getTranslateController().isTranslatingDialog(r2Var.E0);
                    if (this.h != measuredWidth && this.b == hashCode && this.c == isTranslatingDialog && this.a == r2Var.E0 && this.d == dialog.isFolder && this.e == j10 && Objects.equals(this.g, num) && this.i == i10 && i11 == this.f && this.j == r2Var.x3 && this.k == z11 && r2Var.h2 == z10) {
                        return z4;
                    }
                    if (this.a != r2Var.E0) {
