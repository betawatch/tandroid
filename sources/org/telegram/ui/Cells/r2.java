...
public final class r2 extends FrameLayout {
    ...
    public final void b() {
        ...
        if (textView2.getVisibility() == 0) {
            ...
            d = h7.z5.d(-1, -1.0f, (z10 ? 5 : 3) | 48, z10 ? 23.0f : 61.0f, 0.0f, z10 ? 61.0f : 23.0f, 0.0f);
        } else {
            boolean z11 = LocaleController.isRTL;
            d = h7.z5.d(-1, -1.0f, (z11 ? 5 : 3) | 48, z11 ? 61.0f : 23.0f, 0.0f, z11 ? 23.0f : 61.0f, 0.0f);
        }
        textView.setLayoutParams(d);
        RadioButton radioButton = this.d;
        if (textView2.getVisibility() == 0) {
            d10 = h7.z5.d(22, 22.0f, (LocaleController.isRTL ? 5 : 3) | 48, 20.0f, 15.0f, 20.0f, 0.0f);
        } else {
            d10 = h7.z5.d(22, 22.0f, (LocaleController.isRTL ? 3 : 5) | 48, 20.0f, 15.0f, 20.0f, 0.0f);
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (textView.getVisibility() == 0) {
            ...
            dp = rl.u(12.0f, textView.getMeasuredWidth(), dp);
        }
