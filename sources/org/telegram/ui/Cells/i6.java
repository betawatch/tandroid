...
public final class i6 extends a0 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.z5 {
    public final np A0;
    public boolean B0;
    ...
    public i6(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.N = UserConfig.selectedAccount;
        this.f0 = AndroidUtilities.dp(19.0f);
        this.m0 = new org.telegram.ui.Components.e6(this, 0L, 350L, qr.h);
        qr qrVar = qr.f;
        ...
        this.s = new org.telegram.ui.Components.h9((org.telegram.ui.ActionBar.e6) null);
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            Paint G = (!this.E0 || e6Var == null) ? null : e6Var.G("paintDivider");
            if (G == null) {
        ...
        if (this.x == null || this.w0 == null || this.x0 == null) {
            ...
            float dp3 = LocaleController.isRTL ? AndroidUtilities.dp(12.0f) : org.telegram.messenger.q.C(12.0f, getWidth(), dp);
            int i10 = this.P;
            f7 = 2.0f;
            RectF rectF = this.v0;
    ...
    */
    ...
    public final void r() {
        ...
        if (chat3 != null) {
            ...
            if (chat3.monoforum) {
                ...
                if (chat4 != null) {
                    ...
                    spannableStringBuilder.setSpan(new e10(LocaleController.getString(R.string.MonoforumSpan), org.telegram.ui.ActionBar.j6.y6, e6Var), length, spannableStringBuilder.length(), 33);
        ...
        if (TextUtils.isEmpty(replaceNewLines)) {
            ...
            replaceNewLines = (user3 == null || TextUtils.isEmpty(user3.phone)) ? LocaleController.getString(R.string.HiddenName) : wh.g(new StringBuilder("+"), this.y.phone, gf.b.c());
        }
        if (this.E0) {
            if (this.F0 == null) {
            ...
            if (this.F != null) {
                this.F0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Z8, e6Var));
            } else {
                this.F0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.X8, e6Var));
            }
            textPaint = this.F0;
        } else {
        ...
        if (this.G != null) {
            ...
            this.U = wh.z(32.0f, measureText, this.U);
        }
        ...
        if (this.E0) {
            ...
            if (textPaint4 == org.telegram.ui.ActionBar.j6.Q0) {
                this.G0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.A6, e6Var));
            } else if (textPaint4 == org.telegram.ui.ActionBar.j6.P0) {
                this.G0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.p6, e6Var));
            }
            textPaint4 = this.G0;
        }
    ...
    */
    public final void u(int i10) {
        ...
        ImageReceiver imageReceiver = this.r;
        int i12 = this.N;
        org.telegram.ui.Components.h9 h9Var = this.s;
        ...
        if (user3 != null) {
            ...
            if (chat != null) {
                ...
                if (chatPhoto != null) {
                    ...
                    if (drawable4 != null) {
                        ...
                        if (chat.monoforum) {
                            ...
                            ng.d.n(i12, chat, h9Var, imageReceiver);
                        }
                        fileLocation3 = fileLocation;
                    }
                }
                ...
                ContactsController.Contact contact = this.G;
                if (contact != null) {
                    h9Var.n(0L, contact.first_name, contact.last_name);
                    imageReceiver.setImage(null, null, h9Var, null, null, 0);
                } else {
                    h9Var.n(0L, null, null);
                    imageReceiver.setImage(null, null, h9Var, null, null, 0);
                }
            }
        }
    ...
    public final void v(boolean z10, TLRPC.User user, TLRPC.Chat chat, boolean z11) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.w;
        if (z13 && z10) {
            o5Var.g(new pq(org.telegram.ui.ActionBar.j6.f1, org.telegram.ui.ActionBar.j6.i1, 0, 0), z11);
            o5Var.k(null);
