...
public final class r3 extends FrameLayout {
    ...
    public r3(int i10, Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4, boolean z10) {
        super(context);
        ...
        this.b = textView;
        org.telegram.ui.b.w(org.telegram.ui.ActionBar.k6.Se, g6Var, textView, 1, 17.0f);
        TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
        textView.setEllipsize(truncateAt);
        textView.setSingleLine(true);
        addView(textView, z4 ? k7.c6.i(-2.0f, -2.0f, 8388659, i10, 8.0f, 40.0f, 0.0f) : k7.c6.d(-2, -2.0f, 51, i10, 8.0f, 40.0f, 0.0f));
        TextView textView2 = new TextView(context);
        this.c = textView2;
        org.telegram.ui.b.l(org.telegram.ui.ActionBar.k6.We, g6Var, textView2, 1, 13.0f);
        textView2.setEllipsize(truncateAt);
        textView2.setSingleLine(true);
        addView(textView2, z4 ? k7.c6.i(-2.0f, -2.0f, 8388659, i10, 30.0f, 100.0f, 0.0f) : k7.c6.d(-2, -2.0f, 51, i10, 30.0f, 100.0f, 0.0f));
        if (z10) {
            gi0 gi0Var = new gi0(context);
            this.d = gi0Var;
            gi0Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Sh, g6Var));
            gi0Var.setText(LocaleController.getString(R.string.Add));
            addView(gi0Var, z4 ? k7.c6.i(-2.0f, 28.0f, 8388661, 0.0f, 16.0f, 14.0f, 0.0f) : k7.c6.d(-2, 28.0f, 53, 0.0f, 16.0f, 14.0f, 0.0f));
            TextView textView3 = new TextView(context);
            this.e = textView3;
            textView3.setGravity(17);
            org.telegram.ui.b.w(org.telegram.ui.ActionBar.k6.Rh, g6Var, textView3, 1, 14.0f);
            textView3.setText(LocaleController.getString(R.string.StickersRemove));
            addView(textView3, z4 ? k7.c6.i(-2.0f, 28.0f, 8388661, 0.0f, 16.0f, 14.0f, 0.0f) : k7.c6.d(-2, 28.0f, 53, 0.0f, 16.0f, 14.0f, 0.0f));
        }
    ...
    public static void a(ArrayList arrayList, sl0 sl0Var, org.telegram.ui.ActionBar.l6 l6Var) {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(null, 0, null, null, null, l6Var, org.telegram.ui.ActionBar.k6.q6));
    ...
    public final void c(TLRPC.StickerSetCovered stickerSetCovered, boolean z4, boolean z10, int i10, int i11, boolean z11) {
        ...
        if (this.a) {
            ...
            animatorSet3.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(textView2, (Property<TextView, Float>) property3, fArr3), ObjectAnimator.ofFloat(gi0Var, (Property<gi0, Float>) property, this.r ? 0.0f : 1.0f), ObjectAnimator.ofFloat(gi0Var, (Property<gi0, Float>) property2, this.r ? 0.0f : 1.0f), ObjectAnimator.ofFloat(gi0Var, (Property<gi0, Float>) property3, this.r ? 0.0f : 1.0f));
    ...
    public final void d() {
        if (this.a) {
            int i10 = org.telegram.ui.ActionBar.k6.Nh;
            org.telegram.ui.ActionBar.g6 g6Var = this.F;
            int v02 = org.telegram.ui.ActionBar.k6.v0(i10, g6Var);
            gi0 gi0Var = this.d;
            gi0Var.setProgressColor(v02);
            int v03 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Oh, g6Var);
            org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Qh, g6Var);
            gi0Var.setBackground(org.telegram.ui.ActionBar.a6.e(new float[]{14.0f}, v03));
        }
        e();
        f();
    }
    ...
    public final void e() {
        if (this.B != 0) {
            ...
            try {
                ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.q6, this.F));
                int i10 = this.y;
    ...
    public final void f() {
        ...
        if (this.C != null) {
            ...
            try {
                spannableStringBuilder.setSpan(new nq(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.q6, g6Var)), 0, this.D, 33);
                spannableStringBuilder.setSpan(new nq(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.We, g6Var)), this.D, this.C.length(), 33);
            } catch (Exception unused) {
            }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z4 || this.E != 0.0f) {
            if (z4) {
                ...
                if (f10 != 1.0f) {
                    ...
                    int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Th, g6Var);
                    Paint paint = this.x;
                    paint.setColor(v02);
            ...
            int v022 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Th, g6Var);
            Paint paint2 = this.x;
        ...
        if (this.n) {
            canvas.drawLine(0.0f, 0.0f, getWidth(), 0.0f, org.telegram.ui.ActionBar.k6.T0("paintDivider", g6Var));
        }
    }
