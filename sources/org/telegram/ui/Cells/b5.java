...
public final class b5 extends FrameLayout {
    ...
    public b5(int i9, int i10, Context context, org.telegram.ui.ActionBar.b6 b6Var, boolean z10) {
        ...
        this.d = b6Var;
        this.D = org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.y6, b6Var);
        this.E = org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.n6, b6Var);
        this.F = i10;
        ...
        addView(z4Var, g7.e6.d(46, 46.0f, (z11 ? 5 : 3) | 48, z11 ? 0.0f : i9 + 7, 8.0f, z11 ? i9 + 7 : 0.0f, 0.0f));
        ...
        addView(h5Var, g7.e6.d(-1, 20.0f, (z12 ? 5 : 3) | 48, z12 ? 46.0f : i10 + 68, 11.5f, z12 ? i10 + 68 : 46.0f, 0.0f));
        ...
        addView(h5Var2, g7.e6.d(-1, 20.0f, (z13 ? 5 : 3) | 48, z13 ? 28.0f : i10 + 68, 34.5f, z13 ? i10 + 68 : 28.0f, 0.0f));
        if (z10) {
    ...
    public final void b(TLObject tLObject, CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        ...
        if (imageView != null) {
            ...
            boolean z11 = LocaleController.isRTL;
            h5Var2.setLayoutParams(g7.e6.d(-1, 20.0f, (z11 ? 5 : 3) | 48, z11 ? d ? 46 : 28 : i9 + 68, (charSequence2 == null || charSequence2.length() > 0) ? 11.5f : 20.5f, LocaleController.isRTL ? i9 + 68 : d ? 46 : 28, 0.0f));
            boolean z12 = LocaleController.isRTL;
            int i10 = (z12 ? 5 : 3) | 48;
            float f12 = z12 ? d ? 46 : 28 : i9 + 68;
            if (z12) {
                f11 = i9 + 68;
            } else {
                f11 = d ? 46 : 28;
            }
            h5Var.setLayoutParams(g7.e6.d(-1, 20.0f, i10, f12, 34.5f, f11, 0.0f));
        } else {
            ImageView imageView2 = this.h;
            if (imageView2 != null) {
                boolean z13 = imageView2.getVisibility() == 0;
                boolean z14 = LocaleController.isRTL;
                h5Var2.setLayoutParams(g7.e6.d(-1, 20.0f, (z14 ? 5 : 3) | 48, z14 ? z13 ? 54 : 28 : i9 + 68, (charSequence2 == null || charSequence2.length() > 0) ? 11.5f : 20.5f, LocaleController.isRTL ? i9 + 68 : z13 ? 54 : 28, 0.0f));
                boolean z15 = LocaleController.isRTL;
                int i11 = (z15 ? 5 : 3) | 48;
                float f13 = z15 ? z13 ? 54 : 28 : i9 + 68;
                if (z15) {
                    f10 = i9 + 68;
                } else {
                    f10 = z13 ? 54 : 28;
                }
                h5Var.setLayoutParams(g7.e6.d(-1, 20.0f, i11, f13, 34.5f, f10, 0.0f));
            }
        }
        this.B = z10;
    ...
    */
    public final void c(int i9) {
        ...
        if (!z10) {
            ...
            if (i9 != 0) {
                boolean z12 = (i9 & MessagesController.UPDATE_MASK_AVATAR) != 0 && (((fileLocation = this.y) != null && fileLocation3 == null) || ((fileLocation == null && fileLocation3 != null) || !(fileLocation == null || (fileLocation.volume_id == fileLocation3.volume_id && fileLocation.local_id == fileLocation3.local_id))));
                if (z12 || this.s != null || (r12 = this.w) == null || (i9 & MessagesController.UPDATE_MASK_NAME) == 0) {
                    str = null;
                } else {
                    str = chat.title;
                }
        ...
        if (i9 != 0) {
            boolean z13 = (i9 & MessagesController.UPDATE_MASK_AVATAR) != 0 && (((fileLocation2 = this.y) != null && fileLocation4 == null) || ((fileLocation2 == null && fileLocation4 != null) || !(fileLocation2 == null || (fileLocation2.volume_id == fileLocation4.volume_id && fileLocation2.local_id == fileLocation4.local_id))));
            if (!z13 && (i9 & MessagesController.UPDATE_MASK_STATUS) != 0) {
                TLRPC.UserStatus userStatus2 = user.status;
                if ((userStatus2 != null ? userStatus2.expires : 0) != this.x) {
                    z13 = true;
                }
            }
            if (z13 || this.s != null || this.w == null || (i9 & MessagesController.UPDATE_MASK_NAME) == 0) {
                str2 = null;
            } else {
        ...
        if (this.v != null) {
            ...
            if (user.bot) {
                ...
                h5Var2.setTextColor(this.D);
                h5Var2.l(LocaleController.formatUserStatus(i10, user), false);
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.B) {
            int i9 = this.G;
            if (i9 >= 0) {
                org.telegram.ui.ActionBar.f6.l0.setColor(org.telegram.ui.ActionBar.f6.v0(i9, this.d));
            }
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.dp(68.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.dp(68.0f) : 0), getMeasuredHeight() - 1, this.G >= 0 ? org.telegram.ui.ActionBar.f6.l0 : org.telegram.ui.ActionBar.f6.k0);
        }
    }

    @Override // android.widget.FrameLayout, android.view.View
    public final void onMeasure(int i9, int i10) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i9), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f) + (this.B ? 1 : 0), TLObject.FLAG_30));
    }
    ...
    public void setCustomRightImage(int i9) {
        ...
        this.h.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.mg, this.d), PorterDuff.Mode.MULTIPLY));
        addView(this.h, g7.e6.e(52, 64, (LocaleController.isRTL ? 3 : 5) | 48));
    }
