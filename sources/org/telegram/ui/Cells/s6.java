...
public final class s6 extends LinearLayout {
    ...
    public void set(TLRPC.RequestPeerType requestPeerType) {
        ...
        if (this.a != requestPeerType) {
                ...
                if (bool5 == null || !bool5.booleanValue()) {
                    ...
                    if (tL_chatAdminRights != null) {
                        ...
                        if (tL_chatAdminRights.change_info) {
                            c1.t(z10 ? LocaleController.getString(R.string.EditAdminChangeChannelInfo) : LocaleController.getString(R.string.EditAdminChangeGroupInfo), 1, arrayList2);
                        }
                        ...
                        if (tL_chatAdminRights.delete_messages) {
                            c1.t(LocaleController.getString(z10 ? R.string.EditAdminDeleteMessages : R.string.EditAdminGroupDeleteMessages), 1, arrayList2);
                        }
                        ...
                        if (arrayList2.size() == 1) {
                            arrayList.add(t6.a(TextUtils.concat(replaceTags2, " ", ((t6) arrayList2.get(0)).b)));
                            ...
                            for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                                ...
                                valueOf.append((CharSequence) ((t6) arrayList2.get(i12)).b.toString().toLowerCase());
                            }
                            valueOf.append((CharSequence) ".");
            ...
            n4Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
            ...
            while (i14 < size) {
                ...
                r6Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false));
                r6Var.setOrientation(0);
                ImageView imageView = new ImageView(context);
                imageView.setScaleType(ImageView.ScaleType.CENTER);
                imageView.setImageResource(t6Var.a <= 0 ? R.drawable.list_check : R.drawable.list_circle);
                ...
                r6Var.addView(imageView, w7.y5.p(20, 20, 0.0f, 51, (t6Var.a * 16) + 17, -1, 0, 0));
                TextView textView = new TextView(context);
                textView.setTextSize(1, 14.0f);
                textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.z6, false));
                textView.setSingleLine(false);
                textView.setText(t6Var.b);
                r6Var.addView(textView, w7.y5.t(-1, -2, 1, 6, 4, 24, 4));
                addView(r6Var, w7.y5.n(-1, -2));
            }
