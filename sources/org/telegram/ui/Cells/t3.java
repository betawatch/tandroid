...
public final class t3 extends FrameLayout {
    ...
    public t3(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            addView(hi0Var, z10 ? w7.y5.i(-2.0f, 28.0f, 8388661, 0.0f, 16.0f, 14.0f, 0.0f) : w7.y5.d(-2, 28.0f, 53, 0.0f, 16.0f, 14.0f, 0.0f));
    ...
    public static void a(ArrayList arrayList, vl0 vl0Var, org.telegram.ui.ActionBar.k6 k6Var) {
        arrayList.add(new org.telegram.ui.ActionBar.l6(vl0Var, 4, new Class[]{t3.class}, new String[]{"nameTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Se));
        int i10 = org.telegram.ui.ActionBar.j6.We;
        arrayList.add(new org.telegram.ui.ActionBar.l6(vl0Var, 4, new Class[]{t3.class}, new String[]{"infoTextView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(vl0Var, 4, new Class[]{t3.class}, new String[]{"addButton"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Sh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(vl0Var, 4, new Class[]{t3.class}, new String[]{"delButton"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Rh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(vl0Var, 0, new Class[]{t3.class}, null, null, null, org.telegram.ui.ActionBar.j6.Th));
        arrayList.add(new org.telegram.ui.ActionBar.l6(vl0Var, 0, new Class[]{t3.class}, org.telegram.ui.ActionBar.j6.k0, null, null, org.telegram.ui.ActionBar.j6.d7));
    ...
    public final void c(TLRPC.StickerSetCovered stickerSetCovered, boolean z10, boolean z11, int i10, int i11, boolean z12) {
        ...
        if (this.a) {
            ...
            animatorSet3.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(textView2, (Property<TextView, Float>) property3, fArr3), ObjectAnimator.ofFloat(hi0Var, (Property<hi0, Float>) property, this.r ? 0.0f : 1.0f), ObjectAnimator.ofFloat(hi0Var, (Property<hi0, Float>) property2, this.r ? 0.0f : 1.0f), ObjectAnimator.ofFloat(hi0Var, (Property<hi0, Float>) property3, this.r ? 0.0f : 1.0f));
    ...
    public final void d() {
        if (this.a) {
            ...
            hi0Var.setBackground(org.telegram.ui.ActionBar.y5.e(new float[]{14.0f}, v03));
        }
        e();
        f();
    }
