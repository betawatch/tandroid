...
public final class r5 extends FrameLayout {
    ...
    public final void b(int i10, boolean z10, boolean z11) {
        ...
        if (this.x) {
            ...
            if (z11) {
                ...
                this.F = animatorSet2;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(m5Var, (Property<m5, Float>) View.SCALE_X, z10 ? 0.787f : 1.0f), ObjectAnimator.ofFloat(m5Var, (Property<m5, Float>) View.SCALE_Y, z10 ? 0.787f : 1.0f));
                this.F.setDuration(200L);
                this.F.addListener(new bg.z2(23, this, z10));
                this.F.start();
            } else {
                m5Var.setScaleX(z10 ? 0.787f : 1.0f);
                m5Var.setScaleY(z10 ? 0.787f : 1.0f);
            }
        }
    ...
    public final void clearAnimation() {
        ...
        if (animatorSet != null) {
            ...
            this.F = null;
            hp hpVar = this.d;
            float f9 = hpVar.a.q ? 0.787f : 1.0f;
            m5 m5Var = this.b;
            m5Var.setScaleX(f9);
            m5Var.setScaleY(hpVar.a.q ? 0.787f : 1.0f);
        }
    }
    ...
    public final void d(MediaController.PhotoEntry photoEntry, boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        n5Var.getImageReceiver().setVisible(!z16, true);
        this.d.setAlpha(z16 ? 0.0f : 1.0f);
        o5Var.setAlpha(z16 ? 0.0f : 1.0f);
        requestLayout();
    ...
    */
    public final void e(MediaController.SearchImage searchImage) {
        ...
        n5 n5Var2 = this.a;
        if (photoSize != null) {
            n5Var2.h(ImageLocation.getForPhoto(photoSize, searchImage.photo), null, drawable, searchImage);
        } else {
            TLRPC.PhotoSize photoSize2 = searchImage.photoSize;
            if (photoSize2 != null) {
                n5Var2.h(ImageLocation.getForPhoto(photoSize2, searchImage.photo), "80_80", drawable, searchImage);
            } else {
                String str = searchImage.thumbPath;
                if (str != null) {
                    n5Var2.f(str, null, drawable);
                } else {
                    if (TextUtils.isEmpty(searchImage.thumbUrl)) {
                        ...
                        if (document != null) {
                            ...
                            if (documentVideoThumb != null) {
                                n5Var2.k(ImageLocation.getForDocument(documentVideoThumb, searchImage.document), null, ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(searchImage.document.thumbs, 90), searchImage.document), "52_52", -1L, null, searchImage, 1);
                                n5Var = n5Var2;
                            } else {
                                n5Var = n5Var2;
                                n5Var.h(ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(searchImage.document.thumbs, 320), searchImage.document), null, drawable, searchImage);
                            }
                        } else {
                            n5Var = n5Var2;
                            n5Var.setImageDrawable(drawable);
                        }
                        boolean L1 = PhotoViewer.L1(searchImage.getPathToAttach());
                        n5Var.getImageReceiver().setVisible(!L1, true);
                    ...
                    n5Var2.h(forPath, null, drawable, searchImage);
                }
            }
        }
        n5Var = n5Var2;
        boolean L12 = PhotoViewer.L1(searchImage.getPathToAttach());
        n5Var.getImageReceiver().setVisible(!L12, true);
    ...
    public final void g(boolean z10) {
        ...
        if (z10 || hpVar.getAlpha() != 0.0f) {
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(o5Var, (Property<o5, Float>) property, fArr), ObjectAnimator.ofFloat(hpVar, (Property<hp, Float>) property, z10 ? 1.0f : 0.0f));
            this.n.addListener(new nh.q5(this, 16));
            this.n.start();
        }
    }
    ...
    public final void h(boolean z10) {
        n5 n5Var;
        m5 m5Var = this.b;
        if (m5Var == null || (n5Var = this.a) == null || n5Var.getMeasuredHeight() <= 0 || n5Var.getMeasuredWidth() <= 0) {
            return;
        }
        if (z10) {
            if (this.I == null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        n5 n5Var = this.a;
        if (!z10 && this.b.getScaleX() == 1.0f && n5Var.getImageReceiver().hasNotThumb() && n5Var.getImageReceiver().getCurrentAlpha() == 1.0f && (((photoEntry = this.C) == null || !PhotoViewer.L1(photoEntry.path)) && ((searchImage = this.D) == null || !PhotoViewer.L1(searchImage.getPathToAttach())))) {
            return;
        }
