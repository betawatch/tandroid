...
public final class db extends FrameLayout {
    ...
    public final void a(Object obj, Object obj2) {
        ...
        if (obj instanceof TLRPC.TL_wallPaper) {
            ...
            if (wallPaperSettings.third_background_color != 0) {
                ...
                if (tL_wallPaper.settings.intensity >= 0 || !org.telegram.ui.ActionBar.j6.I.q()) {
                    z5Var2.setBackground(lc0Var);
                    if (Build.VERSION.SDK_INT >= 29) {
                        z5Var2.getImageReceiver().setBlendMode(BlendMode.SOFT_LIGHT);
                    }
                } else {
                    z5Var2.getImageReceiver().setGradientBitmap(lc0Var.k);
                }
        ...
        if (!(obj instanceof ej1)) {
            if (obj instanceof fj1) {
                ...
                if (file2 != null) {
                    ...
                    z5Var2.setImageResource(fj1Var.c);
                    return;
                }
            }
        ...
        int i11 = ej1Var.c;
        int i12 = ej1Var.b;
        if (file3 == null && ej1Var.g == null && !"d".equals(ej1Var.a)) {
            z5Var2.setImageBitmap(null);
            if (ej1Var.k) {
                z5Var2.setBackground(new lc0(true, ej1Var.b, ej1Var.c, ej1Var.d, ej1Var.e));
                return;
            } else if (i11 != 0) {
        ...
        if (i10 != 0) {
            lc0 lc0Var2 = new lc0(true, ej1Var.b, ej1Var.c, ej1Var.d, ej1Var.e);
            if (ej1Var.h >= 0.0f) {
                z5Var2.setBackground(new lc0(true, ej1Var.b, ej1Var.c, ej1Var.d, ej1Var.e));
                if (Build.VERSION.SDK_INT >= 29) {
                    z5Var2.getImageReceiver().setBlendMode(BlendMode.SOFT_LIGHT);
                ...
                z5Var2.getImageReceiver().setGradientBitmap(lc0Var2.k);
            }
            patternColor = lc0.g(i12, i11, i10, ej1Var.e);
        } else {
            patternColor = AndroidUtilities.getPatternColor(i12);
        }
        int i13 = patternColor;
        if ("d".equals(ej1Var.a)) {
            if (ej1Var.m == null) {
                ej1Var.m = SvgHelper.getBitmap(R.raw.default_pattern, 100, 180, -16777216);
            }
            z5Var2.setImageBitmap(ej1Var.m);
            z5Var2.getImageReceiver().setAlpha(Math.abs(ej1Var.h));
            return;
        }
        if (file3 != null) {
        ...
        TLRPC.PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(ej1Var.g.document.thumbs, 100);
        z5Var2.k(ImageLocation.getForDocument(closestPhotoSizeWithSize5, ej1Var.g.document), "180_180", null, null, closestPhotoSizeWithSize5 != null ? closestPhotoSizeWithSize5.size : ej1Var.g.document.size, "jpg", ej1Var.g, 1);
        z5Var2.getImageReceiver().setAlpha(Math.abs(ej1Var.h));
