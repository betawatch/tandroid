...
public final class db extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public db(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.commonChatsLoaded && ((Long) objArr[0]).longValue() == this.c) {
            ...
            if (cbVar == null || count <= 0) {
                ...
                cbVar.b = new f01(LocaleController.formatPluralString("Groups", count, new Object[0]), 12.0f, AndroidUtilities.bold());
                int min = Math.min(3, this.I.chats.size());
                org.telegram.ui.Components.j9 j9Var = this.G;
                j9Var.k(min);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            rectF2.set(dp4, f14, dp5 + (z10 ? j9Var.A + (drawable.getIntrinsicWidth() * 0.8f) + AndroidUtilities.dp(5.0f) : 0.0f), cbVar.b.j() + f14);
            if (this.n == cbVar) {
                RectF rectF3 = this.y;
                rectF3.set(rectF2);
            ...
            f01Var4.c(dp3, cbVar.b.j() / 2.0f, 1.0f, -1, canvas);
            if (z10) {
                canvas.save();
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), org.telegram.messenger.z0.b(16.0f, (int) this.J, 0));
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (ycVar2.h) {
                ...
                if ((U instanceof xn) && (mjVar = ((xn) U).a1) != null) {
                    mjVar.e(true, false);
                }
            } else if (ycVar.h) {
