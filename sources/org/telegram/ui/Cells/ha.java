...
public final class ha extends yk0 {
    ...
    public final void v(f2.o1 o1Var, int i10) {
        ...
        ThemesHorizontalListCell$InnerThemeView themesHorizontalListCell$InnerThemeView = (ThemesHorizontalListCell$InnerThemeView) o1Var.a;
        ia iaVar = this.d;
    ...
    public final f2.o1 x(ViewGroup viewGroup, int i10) {
        return new lk0(new ThemesHorizontalListCell$InnerThemeView(this.d, this.c));
    }
}
