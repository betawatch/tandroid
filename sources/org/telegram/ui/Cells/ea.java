...
public abstract class ea {
    ...
    /* JADX WARN: Type inference failed for: r5v7, types: [org.telegram.ui.Cells.p9] */
    public ea() {
        new w9().a = 0.0f;
    ...
    public static void a(ea eaVar, int i10) {
        ...
        int i11;
        u9 u9Var = eaVar.a0;
        if (Build.VERSION.SDK_INT < 28 || eaVar.W == null || eaVar.k || !eaVar.i || eaVar.C == null) {
            return;
        }
        int i12 = eaVar.j ? eaVar.u : eaVar.v;
        eaVar.j(i12, u9Var, false);
        Layout layout = u9Var.b;
        if (layout == null) {
            return;
        }
        int lineForOffset = layout.getLineForOffset(Utilities.clamp(i12 - u9Var.a, layout.getText().length(), 0));
        int lineBottom = layout.getLineBottom(lineForOffset) - layout.getLineTop(lineForOffset);
        int[] m10 = eaVar.m();
        int lineTop = (int) (((((layout.getLineTop(lineForOffset) + eaVar.b) + m10[1]) - lineBottom) - AndroidUtilities.dp(8.0f)) + u9Var.c);
        Object obj = eaVar.W;
        if (obj instanceof org.telegram.ui.t2) {
            i11 = m10[0];
            lineRight = ((View) obj).getMeasuredWidth() + i11;
        } else {
            int lineLeft = (int) (layout.getLineLeft(lineForOffset) + m10[0] + eaVar.a + u9Var.d);
            lineRight = (int) (layout.getLineRight(lineForOffset) + m10[0] + eaVar.a + u9Var.d);
            i11 = lineLeft;
        }
        if (i10 < i11) {
            i10 = i11;
        ...
        if (eaVar.I != f7) {
            eaVar.I = f7;
            eaVar.J = (f7 - eaVar.H) / 200.0f;
        }
        float f10 = i10;
        if (eaVar.L != f10) {
            eaVar.L = f10;
            eaVar.M = (f10 - eaVar.K) / 100.0f;
        }
        if (eaVar.G == null) {
        ...
        float f12 = eaVar.I;
        if (f11 != f12) {
            eaVar.H = (eaVar.J * 16.0f) + f11;
        }
        float f13 = eaVar.J;
        if (f13 > 0.0f && eaVar.H > f12) {
            eaVar.H = f12;
        } else if (f13 < 0.0f && eaVar.H < f12) {
            eaVar.H = f12;
        }
        float f14 = eaVar.K;
        float f15 = eaVar.L;
        if (f14 != f15) {
            eaVar.K = (eaVar.M * 16.0f) + f14;
        }
        float f16 = eaVar.M;
        if (f16 > 0.0f && eaVar.K > f15) {
            eaVar.K = f15;
        } else if (f16 < 0.0f && eaVar.K < f15) {
            eaVar.K = f15;
        }
    ...
    public final boolean N(MotionEvent motionEvent) {
        ...
        if (!rect.contains(this.s, this.t) || this.X == null) {
            ...
            eaVar = this;
            int l4 = eaVar.l(i20, i17, this.c, this.d, this.X, true);
            ...
            if (l4 >= 0 && l4 < t10.length() && t10.charAt(l4) != '\n') {
                AndroidUtilities.cancelRunOnUIThread(l9Var);
                AndroidUtilities.runOnUIThread(l9Var, eaVar.l);
                eaVar.z = true;
            }
        }
        return eaVar.z;
    ...
    */
    public final void U() {
        ...
        if (i11 >= 23) {
            if (!this.i && y() && d()) {
                if (!this.P) {
                    if (this.Y == null) {
                        org.telegram.ui.ActionBar.i4 i4Var = new org.telegram.ui.ActionBar.i4(this.C.getContext(), m4.q0.e(callback), this.C, new org.telegram.ui.ActionBar.x4(this.C.getContext(), this.C, 1, r(), null));
                        this.Y = i4Var;
            ...
            if (this.o0 == null) {
                ...
                this.o0.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Cells.j9
                    ...
                    public final boolean onTouch(View view, MotionEvent motionEvent) {
                        ...
                        ea eaVar = ea.this;
                        eaVar.getClass();
                        if (motionEvent.getActionMasked() != 0 || (n1Var = eaVar.n0) == null || !n1Var.isShowing()) {
                            return false;
                        }
                        view.getHitRect(eaVar.q0);
                        return false;
                    }
                });
    ...
    public final void h(Layout layout, int i10, int i11, int i12, boolean z10, boolean z11, float f7) {
        ...
        if (y9Var.a < layout.getLineBottom(i10)) {
            int lineTop = layout.getLineTop(i10);
            float lineBottom = layout.getLineBottom(i10) - lineTop;
            f11 = lineTop;
            f10 = lineBottom / (y9Var.a - f11);
        } else {
            f10 = 1.0f;
            f11 = 0.0f;
        }
        ...
        while (true) {
            ...
            RectF rectF = (RectF) y9Var.b.get(i14);
    ...
    */
    public final void i(Canvas canvas, Layout layout, int i10, int i11, boolean z10, boolean z11, float f7) {
        ...
        if (lineForOffset == lineForOffset2) {
            ...
            if (layout.getParagraphDirection(lineForOffset) == -1 || lineEnd <= 0) {
                ...
                if (i12 > 0 && i12 < text.length() && !Character.isWhitespace(text.charAt(i17 - 2))) {
                    ...
                    i16 = clamp;
                    eaVar = this;
                    eaVar.h(layout, i14, layout.getLineStart(i14), clamp2, true, !z11, f7);
                }
            }
            rect = null;
            h(layout, lineForOffset, clamp, i12, !z10, true, f7);
        ...
        uqVar.a();
        canvas.drawPath(uqVar, eaVar.o);
        if (z12) {
            canvas.restore();
            canvas.drawPath(path, eaVar.p);
        }
    }
