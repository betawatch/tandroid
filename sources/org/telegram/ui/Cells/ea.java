    ...
    public final void U() {
        ...
        if (i11 >= 23) {
            if (!this.i && y() && d()) {
                if (!this.P) {
                    if (this.Y == null) {
                        org.telegram.ui.ActionBar.h4 h4Var = new org.telegram.ui.ActionBar.h4(this.C.getContext(), y7.b(callback), this.C, new org.telegram.ui.ActionBar.w4(this.C.getContext(), this.C, 1, r(), null));
                        this.Y = h4Var;
