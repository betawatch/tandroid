...
public final class ea extends FrameLayout {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (aj0Var.getVisibility() == 0) {
            ...
            if (this.H) {
                i12 = vl.w(8.0f, aj0Var.getMeasuredWidth(), i12);
            }
        }
        org.telegram.ui.Components.u9 u9Var = this.e;
        if (u9Var != null) {
            ...
            if (this.H) {
                i12 = vl.w(8.0f, this.e.getMeasuredWidth(), i12);
            }
        }
        org.telegram.ui.Components.n6 n6Var = this.c;
        if (n6Var.getVisibility() == 0) {
            ...
            measuredWidth = this.H ? vl.w(8.0f, n6Var.getMeasuredWidth(), i12) : (measuredWidth - n6Var.getMeasuredWidth()) - AndroidUtilities.dp(8.0f);
            if (imageView.getVisibility() == 0) {
    ...
    public void setIcon(int i10) {
        ...
        aj0Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.m6, this.a), PorterDuff.Mode.MULTIPLY));
