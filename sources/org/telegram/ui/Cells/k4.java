...
public final class k4 {
    ...
    public k4(u1 u1Var) {
        this.a = u1Var;
        this.l = vh.g.e(u1Var);
        this.j = new org.telegram.ui.Components.e6(u1Var, 0L, 350L, qr.h);
        this.n = new yc(u1Var);
    }
    ...
    public final void b(Canvas canvas) {
        ...
        if (this.q == null || f22 <= 0.0f) {
            ...
            float f30 = this.h;
            f12 = 17.0f;
            rectF.set(A, com.google.android.gms.internal.vision.e2.A(f30, dp5, 2.0f, f29), org.telegram.messenger.q.b(f28, dp4, 2.0f, f27), org.telegram.messenger.q.b(f30, dp5, 2.0f, f29));
            path.rewind();
            float f31 = dp5 / 2.0f;
            ...
            if (u1Var.getDelegate() == null || !u1Var.getDelegate().c1(5, u1Var)) {
                p90 p90Var = this.k;
                if (p90Var != null && !p90Var.c() && !this.k.b()) {
                    this.k.a();
                }
            } else {
                p90 p90Var2 = this.k;
                if (p90Var2 == null) {
                    ...
                    p90 p90Var4 = this.k;
                    p90Var4.C = true;
                    p90Var4.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                } else if (p90Var2.b() || this.k.c()) {
                    p90 p90Var5 = this.k;
                    p90Var5.b = -1L;
                    p90Var5.c = -1L;
                }
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            if (i74 > 0) {
                ...
                if (AndroidUtilities.isTablet()) {
                    ...
                    messageObject2 = messageObject;
                    k4Var.f = Math.min(u1Var.getParentWidth(), AndroidUtilities.displaySize.y) - AndroidUtilities.dp((u1Var.M0(messageObject2) ? 10 : 0) + 64);
                }
                if (u1Var.z3()) {
            ...
            if (k4Var.i) {
                v01 v01Var = new v01(yh.v7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContent", (int) tL_messageMediaPaidMedia3.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                k4Var.q = v01Var;
                if (v01Var.c > k4Var.g - AndroidUtilities.dp(30.0f)) {
                    k4Var.q = new v01(yh.v7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContentShort", (int) tL_messageMediaPaidMedia3.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                }
            }
            if (k4Var.r == null || k4Var.s != tL_messageMediaPaidMedia3.stars_amount) {
                long j3 = tL_messageMediaPaidMedia3.stars_amount;
                k4Var.s = j3;
                k4Var.r = new v01(yh.v7.R0(LocaleController.formatPluralStringComma("PaidMediaPrice", (int) j3), 0.9f, null), 12.0f, AndroidUtilities.bold());
            }
        }
    }
    ...
    public final void h(MessageObject messageObject) {
        ...
        if (this.i) {
            ...
            if (tL_messageMediaPaidMedia != null) {
                v01 v01Var = new v01(yh.v7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContent", (int) tL_messageMediaPaidMedia.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                this.q = v01Var;
                if (v01Var.c > this.g - AndroidUtilities.dp(30.0f)) {
                    this.q = new v01(yh.v7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContentShort", (int) tL_messageMediaPaidMedia.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                }
            }
        }
    }
