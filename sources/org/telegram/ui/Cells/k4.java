...
public final class k4 {
    ...
    public k4(t1 t1Var) {
        this.a = t1Var;
        this.l = uh.g.e(t1Var);
        this.j = new org.telegram.ui.Components.d6(t1Var, 0L, 350L, wr.h);
        this.n = new xc(t1Var);
    }
    ...
    public final void b(Canvas canvas) {
        ...
        if (this.q == null || f22 <= 0.0f) {
            ...
            float f30 = this.h;
            f12 = 17.0f;
            rectF.set(A, com.google.android.gms.internal.vision.e2.A(f30, dp5, 2.0f, f29), org.telegram.messenger.a2.a(f28, dp4, 2.0f, f27), org.telegram.messenger.a2.a(f30, dp5, 2.0f, f29));
            path.rewind();
            float f31 = dp5 / 2.0f;
            ...
            if (t1Var.getDelegate() == null || !t1Var.getDelegate().c1(5, t1Var)) {
                q90 q90Var = this.k;
                if (q90Var != null && !q90Var.c() && !this.k.b()) {
                    this.k.a();
                }
            } else {
                q90 q90Var2 = this.k;
                if (q90Var2 == null) {
                    ...
                    q90 q90Var4 = this.k;
                    q90Var4.C = true;
                    q90Var4.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                } else if (q90Var2.b() || this.k.c()) {
                    q90 q90Var5 = this.k;
                    q90Var5.b = -1L;
                    q90Var5.c = -1L;
                }
    ...
    */
    public final void g(MessageObject messageObject) {
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            if (k4Var.i) {
                t01 t01Var = new t01(xh.z7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContent", (int) tL_messageMediaPaidMedia3.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                k4Var.q = t01Var;
                if (t01Var.c > k4Var.g - AndroidUtilities.dp(30.0f)) {
                    k4Var.q = new t01(xh.z7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContentShort", (int) tL_messageMediaPaidMedia3.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                }
            }
            if (k4Var.r == null || k4Var.s != tL_messageMediaPaidMedia3.stars_amount) {
                long j3 = tL_messageMediaPaidMedia3.stars_amount;
                k4Var.s = j3;
                k4Var.r = new t01(xh.z7.R0(LocaleController.formatPluralStringComma("PaidMediaPrice", (int) j3), 0.9f, null), 12.0f, AndroidUtilities.bold());
            }
        }
    }
        ...
        if (this.i) {
            ...
            if (tL_messageMediaPaidMedia != null) {
                ...
                if (t01Var.c > this.g - AndroidUtilities.dp(30.0f)) {
                    this.q = new t01(xh.z7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContentShort", (int) tL_messageMediaPaidMedia.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                }
            }
        }
    }
