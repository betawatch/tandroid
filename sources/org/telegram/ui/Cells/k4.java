...
public final class k4 {
    ...
    public k4(t1 t1Var) {
        this.a = t1Var;
        this.l = vh.g.e(t1Var);
        this.j = new org.telegram.ui.Components.c6(t1Var, 0L, 350L, qr.h);
        this.n = new wc(t1Var);
    }
    ...
    public final void b(Canvas canvas) {
        ...
        boolean z10 = this.i;
        org.telegram.ui.Components.c6 c6Var = this.j;
        float e = c6Var.e(z10);
        float e7 = c6Var.e(this.i);
        t1 t1Var2 = this.a;
        ...
        while (true) {
            ...
            if (f19 > 0.0f) {
                float min = Math.min(this.d + j4Var.a, f15);
                float min2 = Math.min(this.e + j4Var.b, f14);
                f17 = Math.max(this.d + j4Var.c, f17);
        ...
        if (f23 > 0.0f) {
            ...
            this.l.c(canvas, t1Var4, i16, i17, 1.0f, t1Var4.pe);
            canvas2 = canvas;
            t1Var = t1Var4;
            canvas2.restore();
            canvas2.restore();
        ...
        if (this.q == null || f22 <= 0.0f) {
            ...
            float f30 = this.h;
            f12 = 17.0f;
            rectF.set(A, com.google.android.gms.internal.vision.e2.A(f30, dp5, 2.0f, f29), org.telegram.messenger.y0.a(f28, dp4, 2.0f, f27), org.telegram.messenger.y0.a(f30, dp5, 2.0f, f29));
            path.rewind();
            float f31 = dp5 / 2.0f;
            ...
            if (t1Var.getDelegate() == null || !t1Var.getDelegate().c1(5, t1Var)) {
                g90 g90Var = this.k;
                if (g90Var != null && !g90Var.c() && !this.k.b()) {
                    this.k.a();
                }
            } else {
                g90 g90Var2 = this.k;
                if (g90Var2 == null) {
                    ...
                    g90 g90Var4 = this.k;
                    g90Var4.C = true;
                    g90Var4.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                } else if (g90Var2.b() || this.k.c()) {
                    g90 g90Var5 = this.k;
                    g90Var5.b = -1L;
                    g90Var5.c = -1L;
                }
    ...
    */
    public final void g(MessageObject messageObject) {
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaPaidMedia) {
                        ...
                        if (size == 2 || size == 3 || size == 4) {
                            if (size == 2) {
                                ...
                                if (sb2.charAt(0) == 'n') {
                                    ...
                                    float min4 = Math.min(f13 * 0.5f, Math.round((i4Var2.h * f27) / (groupedMessagePosition8.aspectRatio + f27)));
                                    float f28 = f13 - min4;
                                    int max2 = (int) Math.max(min, Math.min(i4Var2.h * 0.5f, Math.round(Math.min(groupedMessagePosition8.aspectRatio * min4, groupedMessagePosition7.aspectRatio * f28))));
                                    int round3 = Math.round(Math.min((groupedMessagePosition6.aspectRatio * f13) + i13, i4Var2.h - max2));
                                    ...
                                    float round4 = Math.round(Math.min(i4Var2.h / groupedMessagePosition6.aspectRatio, 0.66f * f13)) / f13;
                                ...
                                if (sb2.charAt(0) == 'w') {
                                    float round5 = Math.round(Math.min(i4Var2.h / groupedMessagePosition9.aspectRatio, f13 * 0.66f)) / f13;
                                    ...
                                    float f33 = min;
                                    int max3 = (int) Math.max(f33, Math.min(i4Var2.h * 0.4f, groupedMessagePosition10.aspectRatio * round6));
                                    int max4 = (int) Math.max(Math.max(f33, i4Var2.h * 0.33f), groupedMessagePosition12.aspectRatio * round6);
                                    ...
                                    int round7 = Math.round(Math.min((groupedMessagePosition9.aspectRatio * f13) + i13, i4Var2.h - max5));
            ...
            while (true) {
                ...
                if (j4Var == null) {
                    ...
                    if (!TextUtils.isEmpty(j4Var2.F)) {
                        DownloadController.getInstance(t1Var.I7).addLoadingFileObserver(j4Var2.F, messageObject2, j4Var2);
                        if (messageObject2.isSending()) {
                            j4Var2.G.o(messageExtendedMedia2.uploadProgress, false);
                        }
                    }
                    if (t1Var.M0 && !j4Var2.M) {
                        j4Var2.M = true;
            ...
            if (k4Var.i) {
                g01 g01Var = new g01(yh.x7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContent", (int) tL_messageMediaPaidMedia3.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                k4Var.q = g01Var;
                if (g01Var.c > k4Var.g - AndroidUtilities.dp(30.0f)) {
                    k4Var.q = new g01(yh.x7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContentShort", (int) tL_messageMediaPaidMedia3.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                }
            }
            if (k4Var.r == null || k4Var.s != tL_messageMediaPaidMedia3.stars_amount) {
                long j3 = tL_messageMediaPaidMedia3.stars_amount;
                k4Var.s = j3;
                k4Var.r = new g01(yh.x7.R0(LocaleController.formatPluralStringComma("PaidMediaPrice", (int) j3), 0.9f, null), 12.0f, AndroidUtilities.bold());
            }
        }
    }
    ...
    public final void h(MessageObject messageObject) {
        ...
        if (this.i) {
            ...
            if (tL_messageMediaPaidMedia != null) {
                ...
                this.q = g01Var;
                if (g01Var.c > this.g - AndroidUtilities.dp(30.0f)) {
                    this.q = new g01(yh.x7.X0(false, LocaleController.formatPluralStringComma("UnlockPaidContentShort", (int) tL_messageMediaPaidMedia.stars_amount), 0.7f, null), 14.0f, AndroidUtilities.bold());
                }
            }
        }
    }
