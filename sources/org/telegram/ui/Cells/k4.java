...
public final class k4 implements DownloadController.FileDownloadProgressListener {
    ...
    public final void c(TLRPC.MessageExtendedMedia messageExtendedMedia, MessageObject messageObject) {
        ...
        if (z10) {
            this.h = true;
            this.v = null;
            this.f.setImage(ImageLocation.getForObject(((TLRPC.TL_messageExtendedMediaPreview) messageExtendedMedia).thumb, messageObject.messageOwner), v7.j0.s(k10, "_b2"), null, null, messageObject, 0);
