...
public final class p8 extends FrameLayout {
    ...
    public p8(Context context) {
        ...
        addView(textView, i7.f6.d(-2, -1.0f, (z10 ? 5 : 3) | 48, z10 ? 64.0f : 21.0f, 0.0f, z10 ? 21.0f : 64.0f, 0.0f));
        TextView textView2 = new TextView(context);
        this.c = textView2;
        org.telegram.ui.b.m(org.telegram.ui.ActionBar.g6.z6, null, textView2, 1, 13.0f);
        ...
        addView(textView2, i7.f6.d(-2, -2.0f, (z11 ? 5 : 3) | 48, z11 ? 64.0f : 21.0f, 35.0f, z11 ? 21.0f : 64.0f, 0.0f));
    ...
    public final void a(Runnable runnable, String str, boolean z10) {
        if (this.f == null) {
            ...
            this.f.addView(this.h, i7.f6.c(20.0f, -2));
            ...
            this.f.addView(this.n, i7.f6.q(16, 16, 16));
            this.f.setClipChildren(false);
            setClipChildren(false);
            addView(this.f, i7.f6.e(-2, -2, 16));
            fn fnVar = new fn(getContext(), 7);
            this.r = fnVar;
            fnVar.setBackground(org.telegram.ui.ActionBar.g6.f0(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.i6, false), 2, -1));
            addView(this.r, i7.f6.e(76, -1, LocaleController.isRTL ? 3 : 5));
        }
        this.h.setText(str);
        this.n.animate().cancel();
        this.n.animate().rotation(z10 ? 0.0f : 180.0f).setDuration(340L).setInterpolator(jr.h).start();
