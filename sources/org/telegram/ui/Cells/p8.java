...
public final class p8 extends FrameLayout {
    ...
    public p8(Context context, boolean z10, boolean z11, org.telegram.ui.ActionBar.d6 d6Var, boolean z12) {
        super(context);
        ...
        this.a = textView;
        org.telegram.messenger.z0.q(textView, z12 ? a(0.6f) : org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Te, d6Var), 1, 15.0f);
    ...
    public final void f() {
        ...
        if (this.r != null) {
            ...
            try {
                spannableStringBuilder.setSpan(new oq(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Ue, d6Var)), 0, this.s, 33);
                spannableStringBuilder.setSpan(new oq(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Te, d6Var)), this.s, this.r.length(), 33);
            } catch (Exception unused) {
            }
    ...
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (view == this.b) {
            i11 = org.telegram.messenger.z0.C(16.0f, this.a.getMeasuredWidth(), i11);
        }
