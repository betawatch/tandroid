...
public class q9 extends da {
    ...
    public final void O() {
        if (y()) {
            ...
            if (i10 >= 0) {
                s4.c0 c0Var = this.E0;
                p9 p9Var = c0Var != null ? (p9) c0Var.m(i10) : i10 < this.F.getChildCount() ? (p9) this.F.getChildAt(this.x0) : null;
                if (p9Var == null) {
                    this.W = null;
                    return;
                }
                ...
                this.a = ((ba) arrayList.get(this.y0)).getX();
                this.b = ((ba) arrayList.get(this.y0)).getY();
            }
        }
    }
    ...
    public final void P() {
        if (y()) {
            ...
            if (i10 >= 0) {
                s4.c0 c0Var = this.E0;
                p9 p9Var = c0Var != null ? (p9) c0Var.m(i10) : this.x0 < this.F.getChildCount() ? (p9) this.F.getChildAt(this.u0) : null;
                if (p9Var == null) {
                    this.W = null;
                    return;
                }
                ...
                this.a = ((ba) arrayList.get(this.v0)).getX();
                this.b = ((ba) arrayList.get(this.v0)).getY();
            }
        }
    }
            ...
            if (i11 <= ((p9) this.W).getTop() || i11 >= ((p9) this.W).getBottom()) {
                ...
                while (true) {
                    ...
                    if (g0(this.F.getChildAt(i12))) {
                        p9 p9Var = (p9) this.F.getChildAt(i12);
                        if (i11 > p9Var.getTop() && i11 < p9Var.getBottom()) {
                            int d02 = d0((int) (i10 - p9Var.getX()), (int) (i11 - p9Var.getY()), p9Var);
                            if (d02 >= 0) {
                                h0((p9) this.W, p9Var, d02);
                                this.W = p9Var;
                                return true;
                            }
                        }
                ...
                int d03 = d0((int) (i10 - ((p9) this.W).getX()), (int) (i11 - ((p9) this.W).getY()), (p9) this.W);
                if (d03 != i13 && d03 >= 0) {
                    p9 p9Var2 = (p9) this.W;
                    h0(p9Var2, p9Var2, d03);
                    return true;
                }
            }
        }
    ...
    public final void a0(Canvas canvas, p9 p9Var, int i10) {
        ...
        if (e02 == i13 && e02 == this.x0) {
            ...
            int i15 = this.y0;
            if (i14 == i15 && i14 == i10) {
                i(canvas, baVar.getLayout(), this.w0, i12, true, true, 0.0f);
                return;
            }
            if (i10 == i14) {
                i(canvas, baVar.getLayout(), this.w0, length, true, false, 0.0f);
                return;
            }
            int i16 = i12;
            if (i10 == i15) {
    ...
    public final boolean b0() {
        ...
        if (y() && this.W != null && this.u0 == this.x0 && (i10 = this.v0) == this.y0) {
            ...
            arrayList.clear();
            ((p9) this.W).fillTextLayoutBlocks(arrayList);
            if (!arrayList.isEmpty() && i10 < arrayList.size() && (length = ((ba) arrayList.get(i10)).getLayout().getText().length()) > 0 && (this.w0 > 0 || this.z0 < length)) {
    ...
    public final CharSequence t(p9 p9Var, boolean z10) {
        ...
        return (arrayList.isEmpty() || i10 < 0 || i10 >= arrayList.size()) ? "" : ((ba) arrayList.get(i10)).getLayout().getText();
    }
    ...
    public final void h0(p9 p9Var, p9 p9Var2, int i10) {
        ...
        for (int i16 = 0; i16 < size; i16++) {
            X((ba) arrayList.get(i16), e02, i16);
        }
    }
    ...
    public final void j(int i10, t9 t9Var, boolean z10) {
        ...
        t9Var.b = ((ba) arrayList.get(i11)).getLayout();
        t9Var.e = ((ba) arrayList.get(i11)).getSelectionBounds();
        t9Var.c = 0.0f;
        t9Var.d = 0.0f;
    }
    ...
    public final boolean k0(p9 p9Var, int i10, int i11, int i12) {
        ...
        if (!arrayList.isEmpty() && i10 >= 0 && i10 < arrayList.size()) {
            this.a = ((ba) arrayList.get(i10)).getX();
            this.b = ((ba) arrayList.get(i10)).getY();
        } else if (!arrayList.isEmpty()) {
            this.a = ((ba) arrayList.get(0)).getX();
            this.b = ((ba) arrayList.get(0)).getY();
        }
        ca caVar = this.C;
        if (caVar != null) {
            caVar.setVisibility(0);
    ...
    public final int l(int i10, int i11, int i12, int i13, y9 y9Var, boolean z10) {
        ...
        if (p9Var != null) {
            ...
            if (i16 >= 0 && i16 < arrayList.size()) {
                Layout layout = ((ba) arrayList.get(i16)).getLayout();
                if (i14 < 0) {
                    i14 = 1;
                }
                if (i15 < 0) {
    ...
    public final void l0(View view, int i10, int i11) {
        if (view instanceof p9) {
            ...
            ArrayList arrayList = this.F0;
            this.c = ((ba) arrayList.get(d02)).getX();
        ...
        if (w9VarArr != null && w9VarArr.length > 0) {
            ...
            for (w9 w9Var : w9VarArr) {
                ...
                if (spanStart >= 0 && spanEnd > spanStart) {
                    CharSequence charSequence8 = w9Var.a;
