...
public class c6 extends FrameLayout implements oy0, xd.b {
    ...
    public c6(Context context, int i10, View.OnClickListener onClickListener, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (onClickListener != null) {
            ...
            this.r = lpVar;
            lpVar.b(-1, i12, org.telegram.ui.ActionBar.j6.k7);
            ...
            addView(lpVar, k7.b6.d(48, 48.0f, (LocaleController.isRTL ? 5 : 3) | 48, 6.0f, 2.0f, 6.0f, 0.0f));
            final int i13 = 0;
            lpVar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Cells.b6
    ...
    public final void m(boolean z4, boolean z10) {
        ...
        lpVar.setTag(z4 ? 1 : null);
        ImageView imageView = this.h;
        if (!z10) {
            lpVar.setAlpha(z4 ? 1.0f : 0.0f);
        ...
        animatorSet2.playTogether(ObjectAnimator.ofFloat(lpVar, (Property<lp, Float>) property, fArr), ObjectAnimator.ofFloat(imageView, (Property<ImageView, Float>) property, z4 ? 0.0f : 1.0f));
                ...
                if (childAt == imageView) {
                    ...
                    if (childAt == imageView2) {
                        ...
                        if (childAt == k5Var) {
                            ...
                            lp lpVar = this.r;
                            if (childAt == lpVar) {
                                lpVar.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(48.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(48.0f), TLObject.FLAG_30));
                            } else {
