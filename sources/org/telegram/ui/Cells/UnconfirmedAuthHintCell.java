...
public class UnconfirmedAuthHintCell extends FrameLayout {
    ...
    public static /* synthetic */ void $r8$lambda$ZEICsbdb9MQnlCJ70APeGLR_RYQ(final BaseFragment baseFragment, boolean z, int i, ArrayList arrayList, View view) {
        ...
        BulletinFactory.of(baseFragment).createSimpleBulletin(R.raw.contact_check, LocaleController.getString(z ? R.string.UnconfirmedAuthConfirmedBot : R.string.UnconfirmedAuthConfirmed), replaceSingleTag).show();
