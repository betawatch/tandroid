...
public class GraySectionCell extends FrameLayout implements Theme.Colorable {
    ...
    public GraySectionCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout.LayoutParams createFrame = LayoutHelper.createFrame(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, f, 0.0f, f, 0.0f);
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(this.layerHeight), TLObject.FLAG_30));
    }
