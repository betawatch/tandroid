...
public final class q3 extends FrameLayout {
    ...
    public q3(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4, boolean z10) {
        ...
        if (z10) {
            ...
            addView(fi0Var, z4 ? k7.b6.i(-2.0f, 28.0f, 8388661, 0.0f, 16.0f, 14.0f, 0.0f) : k7.b6.d(-2, 28.0f, 53, 0.0f, 16.0f, 14.0f, 0.0f));
    ...
    public static void a(ArrayList arrayList, rl0 rl0Var, org.telegram.ui.ActionBar.k6 k6Var) {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(rl0Var, 0, new Class[]{q3.class}, org.telegram.ui.ActionBar.j6.k0, null, null, org.telegram.ui.ActionBar.j6.d7));
    ...
    public final void c(TLRPC.StickerSetCovered stickerSetCovered, boolean z4, boolean z10, int i10, int i11, boolean z11) {
        ...
        if (this.a) {
            ...
            animatorSet3.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(textView2, (Property<TextView, Float>) property3, fArr3), ObjectAnimator.ofFloat(fi0Var, (Property<fi0, Float>) property, this.r ? 0.0f : 1.0f), ObjectAnimator.ofFloat(fi0Var, (Property<fi0, Float>) property2, this.r ? 0.0f : 1.0f), ObjectAnimator.ofFloat(fi0Var, (Property<fi0, Float>) property3, this.r ? 0.0f : 1.0f));
    ...
    public final void f() {
        ...
        if (this.C != null) {
            ...
            try {
                spannableStringBuilder.setSpan(new kq(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.q6, f6Var)), 0, this.D, 33);
                spannableStringBuilder.setSpan(new kq(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.We, f6Var)), this.D, this.C.length(), 33);
            } catch (Exception unused) {
            }
