...
public abstract class t9 extends fa {
    ...
    public final boolean D() {
        ...
        CharSequence s10;
        String str;
        if (!this.z0 || (aaVar = this.W) == null || ((t1) aaVar).getMessageObject() == null || (richMessageLayout = ((t1) this.W).getMessageObject().richLayout) == null || richMessageLayout.textBlocks.isEmpty() || (s10 = s()) == null || s10.length() == 0) {
            return false;
        }
        try {
    ...
    public final void F(boolean z10) {
        ...
        int i10 = 1;
        ofFloat.addUpdateListener(new org.telegram.ui.ActionBar.s2(t1Var, id2, i10));
    ...
    public final void Z(MessageObject messageObject, RichMessageLayout richMessageLayout, Canvas canvas) {
        aa aaVar;
        Canvas canvas2;
        if (!this.z0 || richMessageLayout == null || (aaVar = this.W) == null || ((t1) aaVar).getMessageObject() == null || ((t1) this.W).getMessageObject().getId() != messageObject.getId()) {
            return;
        }
    ...
    public final void j(int i10, v9 v9Var, boolean z10) {
        ...
        MessageObject messageObject = t1Var.getMessageObject();
        if (this.v0) {
            v9Var.b = t1Var.getDescriptionlayout();
            v9Var.c = 0.0f;
            v9Var.d = 0.0f;
            v9Var.a = 0;
            return;
        ...
        if (this.x0) {
            v9Var.b = t1Var.getFactCheckLayout();
            v9Var.c = 0.0f;
            v9Var.d = 0.0f;
            v9Var.a = 0;
            return;
        ...
        if (this.z0) {
            ...
            v9Var.b = richMessageLayout.textBlocks.get(r4).getLayout();
            v9Var.c = r9.getY();
            v9Var.d = r9.getX();
            v9Var.a = richMessageLayout.textBlockCharOffsets.get(r4).intValue();
            return;
        }
        if (t1Var.P2()) {
            MessageObject.TextLayoutBlocks captionLayout = t1Var.getCaptionLayout();
            if (captionLayout.textLayoutBlocks.size() == 1) {
                v9Var.b = captionLayout.textLayoutBlocks.get(0).textLayout;
                v9Var.c = r9.padTop;
            ...
            for (int i11 = 0; i11 < captionLayout.textLayoutBlocks.size(); i11++) {
                ...
                if (i12 >= 0 && i12 <= textLayoutBlock2.textLayout.getText().length()) {
                    v9Var.b = textLayoutBlock2.textLayout;
                    v9Var.c = textLayoutBlock2.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock2.padTop;
                    ...
                    v9Var.a = textLayoutBlock2.charactersOffset;
                    return;
                }
            }
            v9Var.b = null;
        ...
        if (arrayList.size() == 1) {
            v9Var.b = messageObject.textLayoutBlocks.get(0).textLayout;
            v9Var.c = r9.padTop;
        ...
        for (int i13 = 0; i13 < messageObject.textLayoutBlocks.size(); i13++) {
            ...
            if (i14 >= 0 && i14 <= textLayoutBlock4.textLayout.getText().length()) {
                v9Var.b = textLayoutBlock4.textLayout;
                v9Var.c = textLayoutBlock4.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock4.padTop;
                ...
                v9Var.a = textLayoutBlock4.charactersOffset;
                return;
            }
        }
        v9Var.b = null;
        ...
        if (z11) {
            ...
            if (!z12) {
                if (z13) {
                    ...
                    if (richMessageLayout != null && !richMessageLayout.textBlocks.isEmpty()) {
                        da daVar = (da) hc.b.i(1, richMessageLayout.textBlocks);
                        Layout layout2 = daVar.getLayout();
                    ...
                    if (!z10 ? this.v0 : this.w0) {
                        ...
                        if (!z10 ? this.x0 : this.y0) {
                            if (!z10 ? !this.z0 : !this.A0) {
                                ...
                                if (!t1Var.P2()) {
                                    ...
                                    while (true) {
                                        ...
                                        if (f11 < textLayoutBlock3.textYOffset(messageObject.textLayoutBlocks) || f11 > textLayoutBlock3.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock3.padTop + textLayoutBlock3.height(s1Var)) {
                                            ...
                                            v9Var.b = textLayoutBlock3.textLayout;
                                            v9Var.c = textLayoutBlock3.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock3.padTop;
                                            ...
                                            v9Var.a = textLayoutBlock3.charactersOffset;
                                        }
                                    }
                                } else {
                                    MessageObject.TextLayoutBlocks captionLayout = t1Var.getCaptionLayout();
                                    ...
                                    while (true) {
                                        ...
                                        if (f13 < textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) || f13 > textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop + textLayoutBlock4.height(s1Var)) {
                                            ...
                                            v9Var.b = textLayoutBlock4.textLayout;
                                            v9Var.c = textLayoutBlock4.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock4.padTop;
                                            ...
                                            v9Var.d = f14;
                                            if (textLayoutBlock4.code && !textLayoutBlock4.quote) {
                                                v9Var.d = f14 + AndroidUtilities.dp(8.0f);
                                            }
                                            v9Var.a = textLayoutBlock4.charactersOffset;
                                        }
                                    }
                                ...
                                if (richMessageLayout2 == null || richMessageLayout2.textBlocks.isEmpty()) {
                                    ...
                                    for (int i24 = 0; i24 < richMessageLayout2.textBlocks.size(); i24++) {
                                        da daVar2 = richMessageLayout2.textBlocks.get(i24);
                                        int y3 = daVar2.getY();
                                        int height = daVar2.getLayout().getHeight() + y3;
                                        int x10 = daVar2.getX();
                                        int width = daVar2.getLayout().getWidth() + x10;
                                        boolean z14 = i17 >= y3 && i17 < height;
                                        boolean z15 = i16 >= x10 && i16 < width;
                                        daVar2.getLayout().getText();
                                        if (z14) {
                                            if (x10 <= i16 && x10 > i20) {
                                                i20 = x10;
                                                i21 = i24;
                                    ...
                                    if (i21 < 0) {
                                        ...
                                        for (int i26 = 0; i26 < richMessageLayout2.textBlocks.size(); i26++) {
                                            da daVar3 = richMessageLayout2.textBlocks.get(i26);
                                            int y10 = daVar3.getY();
                                            int min2 = Math.min(Math.abs(i17 - y10), Math.abs(i17 - (daVar3.getLayout().getHeight() + y10)));
                                            if (min2 < i25) {
                                                i21 = i26;
                                                i25 = min2;
                                            }
                                    ...
                                    v9Var.b = richMessageLayout2.textBlocks.get(i21).getLayout();
                                    v9Var.c = r2.getY();
                                    v9Var.d = r2.getX();
                                    v9Var.a = richMessageLayout2.textBlockCharOffsets.get(i21).intValue();
                                }
                            }
                            layout = v9Var.b;
                            if (layout != null) {
                            ...
                            while (true) {
                                ...
                                float f15 = i17;
                                if (f15 > v9Var.c + layout.getLineTop(i28) && f15 < v9Var.c + layout.getLineBottom(i28)) {
                                    break;
                                }
                                i28++;
                            }
                            if (i28 >= 0) {
                                return layout.getOffsetForHorizontal(i28, i27) + v9Var.a;
                            }
                            return i15;
                        }
                        v9Var.b = t1Var.getFactCheckLayout();
