...
public final class w1 extends f90 {
    ...
    /* JADX WARN: Type inference failed for: r7v0, types: [android.widget.TextView, java.lang.Object, org.telegram.ui.Cells.w1, org.telegram.ui.Components.f90] */
            ...
            case 2:
                if (charSequence != 0) {
                    ...
                    if (indexOf >= 0) {
                        ...
                        charSequence.setSpan(new ForegroundColorSpan(((org.telegram.ui.qa) this.J).e.getThemedColor(org.telegram.ui.ActionBar.j6.p7)), 0, indexOf, 33);
                    }
            ...
            case 3:
                ...
                if (charSequence != 0) {
                    ...
                    if (indexOf2 >= 0) {
                        ...
                        charSequence.setSpan(new ForegroundColorSpan(pdVar.getThemedColor(org.telegram.ui.ActionBar.j6.p7)), 0, indexOf2, 33);
                    }
                    f51[] f51VarArr2 = (f51[]) charSequence.getSpans(0, charSequence.length(), f51.class);
                    EditTextBoldCursor editTextBoldCursor = pdVar.w;
                    String obj = (editTextBoldCursor == null || editTextBoldCursor.getText() == null) ? "" : pdVar.w.getText().toString();
