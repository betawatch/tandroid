...
public final class bb extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bb(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.E = Y;
        Y.setCallback(this);
        j9Var.p = AndroidUtilities.dp(50.0f);
        j9Var.o = AndroidUtilities.dp(13.0f);
        j9Var.x = false;
        j9Var.s = AndroidUtilities.dp(13.0f);
        ...
        if (userFull != null) {
            ...
            if (max > 0) {
                ...
                for (int i12 = 0; i12 < Math.min(3, this.I.chats.size()); i12++) {
                    j9Var.l(i12, this.I.chats.get(i12), i11);
                }
                j9Var.b(true, true);
            } else {
                this.I = null;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (d6Var != null) {
            d6Var.m(x10, f11, measuredWidth, i10);
        } else {
            org.telegram.ui.ActionBar.h6.q(x10, f11, measuredWidth, i10);
        }
        float f12 = 16.0f;
        ...
        while (true) {
            ...
            rectF2.set(dp4, f14, dp5 + (z10 ? j9Var.A + (drawable.getIntrinsicWidth() * 0.8f) + AndroidUtilities.dp(5.0f) : 0.0f), abVar.b.j() + f14);
            if (this.n == abVar) {
                RectF rectF3 = this.y;
                rectF3.set(rectF2);
