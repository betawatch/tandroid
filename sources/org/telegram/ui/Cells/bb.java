...
public class bb extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.y5 {
    ...
    public final void g(nk0 nk0Var, CharSequence charSequence, boolean z10) {
        ...
        if (DialogObject.isEncryptedDialog(nk0Var.d)) {
            TLRPC.EncryptedChat l4 = org.telegram.messenger.z0.l(MessagesController.getInstance(i10), nk0Var.d);
    ...
    */
    public final void j(int i10) {
            ...
            if (user != null) {
                ...
                if (chat == null) {
                    ...
                    if (charSequence == null) {
                        ...
                        String str4 = this.L;
                        if (str4 != null) {
                            charSequence = AndroidUtilities.highlightText(charSequence, str4, d6Var);
                        }
                        if (charSequence != null) {
                            try {
                                z11 = false;
                        ...
                        String str5 = this.L;
                        if (str5 != null) {
                            charSequence4 = AndroidUtilities.highlightText(charSequence4, str5, d6Var);
                        }
                    ...
                    if (user == null && MessagesController.getInstance(i12).isPremiumUser(user) && !MessagesController.getInstance(i12).premiumFeaturesBlocked()) {
                        if (DialogObject.getEmojiStatusDocumentId(user.emoji_status) != 0) {
                            ...
                            if (this.s == null) {
                                ...
                                this.s = zaVar;
                                zaVar.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.z9, d6Var), PorterDuff.Mode.MULTIPLY));
                            }
                            i5Var2.i(this.s);
                        }
                    ...
                    i5Var2.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, d6Var));
                }
                h9Var.k(i12, chat);
            }
        }
        ...
        y5Var.setRoundRadius(!this.V ? AndroidUtilities.dp(12.777778f) : (chat == null || !chat.forum) ? AndroidUtilities.dp(24.0f) : AndroidUtilities.dp(14.0f));
        i5Var2.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, d6Var2));
    }
    ...
    public void setCallCellStyle(int i10) {
        ...
        boolean z10 = LocaleController.isRTL;
        i5Var.setLayoutParams(w7.x5.d(-1, 20.0f, (z10 ? 5 : 3) | 48, z10 ? 30.0f : i10 + 66, 10.0f, z10 ? i10 + 66 : 30.0f, 0.0f));
        org.telegram.ui.ActionBar.i5 i5Var2 = this.c;
        i5Var2.setTextSize(13);
        boolean z11 = LocaleController.isRTL;
        i5Var2.setLayoutParams(w7.x5.d(-1, 20.0f, (z11 ? 5 : 3) | 48, z11 ? 30.0f : i10 + 66, 32.0f, z11 ? i10 + 66 : 30.0f, 0.0f));
        int dp = AndroidUtilities.dp(22.0f);
        ai.y5 y5Var = this.a;
        y5Var.setRoundRadius(dp);
        boolean z12 = LocaleController.isRTL;
        y5Var.setLayoutParams(w7.x5.d(44, 44.0f, (z12 ? 5 : 3) | 48, z12 ? 0.0f : i10 + 8, 6.0f, z12 ? i10 + 8 : 0.0f, 0.0f));
        op opVar = this.e;
        if (opVar != null) {
            boolean z13 = LocaleController.isRTL;
            opVar.setLayoutParams(w7.x5.d(24, 24.0f, (z13 ? 5 : 3) | 48, z13 ? 0.0f : i10 + 37, 32.0f, z13 ? i10 + 37 : 0.0f, 0.0f));
        }
    }
    ...
    public bb(int i10, int i11, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11) {
        super(context);
        int i12;
        int i13;
        float f7;
        ...
        if (z11) {
            ...
            q3.p(org.telegram.ui.ActionBar.h6.Sh, d6Var, textView, 1, 14.0f);
            textView.setBackground(org.telegram.ui.ActionBar.x5.f(new float[]{14.0f}, org.telegram.ui.ActionBar.h6.Oh));
        ...
        boolean z13 = LocaleController.isRTL;
        addView(y5Var, w7.x5.d(46, 46.0f, (z13 ? 5 : 3) | 48, z13 ? 0.0f : i10 + 7, 6.0f, z13 ? i10 + 7 : 0.0f, 0.0f));
        ...
        addView(i5Var, w7.x5.d(-1, 20.0f, i15, f10, 10.0f, f7, 0.0f));
        ...
        addView(i5Var2, w7.x5.d(-1, 20.0f, (z15 ? 5 : 3) | 48, z15 ? i12 + 28 : i10 + 64, 32.0f, z15 ? i10 + 64 : i12 + 28, 0.0f));
        ...
        if (i11 == 2) {
            ...
            addView(opVar, w7.x5.d(24, 24.0f, (z18 ? 5 : 3) | 48, z18 ? 0.0f : i10 + 24, 36.0f, z18 ? i10 + 24 : 0.0f, 0.0f));
        } else if (i11 == 3) {
