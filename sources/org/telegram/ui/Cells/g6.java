...
public final class g6 extends a0 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.a6 {
    ...
    public g6(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.j0 = new org.telegram.ui.Components.z5(this, 0L, 350L, mr.h);
        mr mrVar = mr.f;
    ...
    */
            ...
            if (chat == null || !chat.monoforum) {
                ...
                if (user != null) {
                    ...
                    if (ChatObject.isCommunity(chat)) {
                        ...
                        kf.r.a(canvas2, drawable, rectF5.centerX(), rectF6.centerY(), rectF6.width());
                    }
                ...
                ue0Var.a((int) rectF7.centerX(), (int) rectF8.centerY(), (int) (rectF8.width() / f10));
                canvas2.save();
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (kpVar.a.q) {
            ...
            accessibilityNodeInfo.setChecked(kpVar.a.q);
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (kpVar != null) {
            ...
            kpVar.layout(dp, dp2, kpVar.getMeasuredWidth() + dp, kpVar.getMeasuredHeight() + dp2);
        }
        if (z4) {
            r();
        }
    ...
    */
    ...
    public final void r() {
        ...
        if (this.x != null) {
            if (this.t0 == null) {
                ...
                lq lqVar = new lq(R.drawable.ic_ab_other, 0);
                lqVar.setScale(0.55f, 0.55f);
                lqVar.spaceScaleX = 0.7f;
                lqVar.translate(-AndroidUtilities.dp(2.0f), 0.0f);
                append.setSpan(lqVar, append.length() - 1, append.length(), 33);
        ...
        if (chat3 != null) {
            ...
            if (chat3.monoforum) {
                ...
                if (chat4 != null) {
                    ...
                    spannableStringBuilder.setSpan(new b10(LocaleController.getString(R.string.MonoforumSpan), org.telegram.ui.ActionBar.j6.y6, f6Var), length, spannableStringBuilder.length(), 33);
    ...
    public void setOnSponsoredOptionsClick(Utilities.Callback2<g6, TLRPC.TL_sponsoredPeer> callback2) {
        this.A0 = callback2;
    }
    ...
    */
    ...
    public final void v(boolean z4, TLRPC.User user, TLRPC.Chat chat, boolean z10) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.w;
        if (z12 && z4) {
            j5Var.g(new mq(org.telegram.ui.ActionBar.j6.f1, org.telegram.ui.ActionBar.j6.i1, 0, 0), z10);
            j5Var.k(null);
