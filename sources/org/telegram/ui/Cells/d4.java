...
public final class d4 {
    ...
    public float c;
    public boolean e;
    public final org.telegram.ui.Components.aa f;
    public final org.telegram.ui.Components.aa g;
    public boolean h;
    public int i;
    public float d = 0.0f;
    public float j = 0.0f;
    ...
    public final void a(Canvas canvas, float f7, float f10, View view) {
        if (LiteMode.isEnabled(512)) {
            ...
            if (this.e || this.d != 0.0f) {
                ...
                boolean z10 = this.h;
                org.telegram.ui.Components.aa aaVar = this.f;
                if (!z10) {
                    int i10 = this.i;
                    if (i10 != 1) {
                        float f12 = this.j;
                        if (f12 != 1.0f) {
                            ...
                            aaVar.d.setColor(i0.a.k(i0.a.d(this.j, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.qg, false), org.telegram.ui.ActionBar.j6.w0(null, this.i != 2 ? org.telegram.ui.ActionBar.j6.sg : org.telegram.ui.ActionBar.j6.pg, false)), 38));
                        }
                    }
                    if (i10 == 1) {
                        float f14 = this.j;
                ...
                aaVar.e(this.a, 1.0f);
                Paint paint = aaVar.d;
                aaVar.a(f7, f10, canvas, paint);
                float f16 = this.a;
                org.telegram.ui.Components.aa aaVar2 = this.g;
                aaVar2.e(f16, 1.0f);
                aaVar2.a(f7, f10, canvas, paint);
                canvas.restore();
            }
            if (this.d != 0.0f) {
                view.invalidate();
