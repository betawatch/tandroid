...
public class d4 extends FrameLayout {
    ...
    public final yi0 h;
    public final yi0 n;
    public final org.telegram.ui.Components.m5 r;
    public final org.telegram.ui.Components.m5 s;
    public Drawable v;
    public Drawable w;
    public final y3 x;
    public final org.telegram.ui.Components.f9 y;
    ...
    public d4(Context context) {
            ...
            public final void run() {
                ...
                switch (i11) {
                    case 0:
                        ...
                        yi0 yi0Var = d4Var.h;
                        yi0Var.S(0, null);
                        d4Var.f.setAnimation(yi0Var);
                        break;
                    case 1:
                        d4 d4Var2 = this.b;
                        bj0 bj0Var = d4Var2.f;
                        yi0 yi0Var2 = d4Var2.n;
        ...
        this.y = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.f6) null);
        setClipChildren(false);
        org.telegram.ui.Components.u9 u9Var = new org.telegram.ui.Components.u9(context);
        this.b = u9Var;
        u9Var.setRoundRadius(AndroidUtilities.dp(24.0f));
        boolean z10 = LocaleController.isRTL;
        addView(u9Var, w7.x5.d(46, 46.0f, (z10 ? 5 : 3) | 48, z10 ? 0.0f : 11.0f, 6.0f, z10 ? 11.0f : 0.0f, 0.0f));
        ...
        addView(k5Var, w7.x5.d(-1, 20.0f, (z12 ? 5 : 3) | 48, z12 ? 54.0f : 67.0f, 10.0f, z12 ? 67.0f : 54.0f, 0.0f));
        this.r = new org.telegram.ui.Components.m5(AndroidUtilities.dp(20.0f), 9, k5Var, false);
        this.s = new org.telegram.ui.Components.m5(AndroidUtilities.dp(20.0f), 9, k5Var, false);
        ...
        addView(k5Var2, w7.x5.d(-1, 60.0f, (LocaleController.isRTL ? 5 : 3) | 48, 14.0f, 32.0f, 14.0f, 0.0f));
        yi0 yi0Var = new yi0(R.raw.voice_outlined2, AndroidUtilities.dp(34.0f), AndroidUtilities.dp(32.0f), true, null);
        this.h = yi0Var;
        this.n = new yi0(R.raw.hand_1, AndroidUtilities.dp(34.0f), AndroidUtilities.dp(32.0f), true, null);
        ...
        bj0Var.setBackground(f02);
        bj0Var.setImportantForAccessibility(2);
        addView(bj0Var, w7.x5.d(48, -1.0f, (LocaleController.isRTL ? 3 : 5) | 16, 6.0f, 0.0f, 6.0f, 0.0f));
        bj0Var.setOnClickListener(new a(this, i10));
    ...
    */
    public final void a(boolean z10, boolean z11) {
        ...
        org.telegram.ui.ActionBar.k5[] k5VarArr = this.d;
        if (!c12) {
            k5VarArr[c10].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, this.T, false));
        }
        boolean c13 = c();
        ...
        if (c13) {
            if (isEmpty && !this.b0) {
                if (this.G != null) {
                    k5VarArr[c10].k(LocaleController.getString(R.string.TapToAddPhotoOrBio));
                } else {
                    k5VarArr[c10].k(LocaleController.getString(R.string.TapToAddPhotoOrDescription));
                }
                k5VarArr[c10].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, this.T, false));
            } else if (isEmpty) {
                if (this.G != null) {
                    k5VarArr[c10].k(LocaleController.getString(R.string.TapToAddBio));
                } else {
                    k5VarArr[c10].k(LocaleController.getString(R.string.TapToAddDescription));
                }
                k5VarArr[c10].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, this.T, false));
            } else if (this.b0) {
                k5VarArr[c10].k(LocaleController.getString(R.string.ThisIsYou));
                k5VarArr[c10].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.pg, false));
            } else {
                k5VarArr[c10].k(LocaleController.getString(R.string.TapToAddPhoto));
                k5VarArr[c10].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, this.T, false));
            }
            if (isEmpty) {
                ...
                k5Var.l(AndroidUtilities.replaceNewLines(this.F.about), false);
            ...
            k5VarArr[c10].k(AndroidUtilities.replaceNewLines(this.F.about));
            k5Var.l("", false);
        }
        ...
        if (!z10 || this.L != w02 || z22) {
            if (z10) {
                ...
                if (!c()) {
                    ...
                    if (z10) {
                        ...
                        if (i10 == 0) {
                            int i14 = 0;
                            while (i14 < k5VarArr.length) {
                                arrayList.add(ObjectAnimator.ofFloat(k5VarArr[i14], (Property<org.telegram.ui.ActionBar.k5, Float>) property2, i14 == i10 ? 0.0f : AndroidUtilities.dp(-2.0f)));
                                arrayList.add(ObjectAnimator.ofFloat(k5VarArr[i14], (Property<org.telegram.ui.ActionBar.k5, Float>) property, i14 == i10 ? 1.0f : 0.0f));
                                i14++;
                            }
                            f7 = 0.0f;
                        } else {
                            ...
                            while (i15 < k5VarArr.length) {
                                org.telegram.ui.ActionBar.k5 k5Var3 = k5VarArr[i15];
                                if (i15 == i10) {
                                    dp = 0.0f;
                                } else {
            ...
            this.L = w02;
            bj0Var.setColorFilter(new PorterDuffColorFilter(w02, PorterDuff.Mode.SRC_IN));
            org.telegram.ui.ActionBar.j6.B1(bj0Var.getDrawable(), w02 & 620756991, true);
        }
        arrayList = null;
        if (i10 == 1) {
        }
    ...
    public final void e(AccountInstance accountInstance, TLRPC.GroupCallParticipant groupCallParticipant, ChatObject.Call call, long j3, TLRPC.FileLocation fileLocation, boolean z10) {
        ...
        org.telegram.ui.Components.u9 u9Var = this.b;
        org.telegram.ui.Components.f9 f9Var = this.y;
        org.telegram.ui.Components.m5 m5Var = this.s;
        if (peerId > 0) {
        ...
        org.telegram.ui.Components.m5 m5Var2 = this.r;
    ...
    public int getClipHeight() {
        org.telegram.ui.ActionBar.k5 k5Var = this.e;
        if (TextUtils.isEmpty(k5Var.getText()) || !this.b0) {
            k5Var = this.d[4];
        }
    ...
    public void setProgressToAvatarPreview(float f7) {
        ...
        if (!c10 || f7 <= 0.0f) {
            ...
            for (int i10 = 0; i10 < k5VarArr.length; i10++) {
                if (TextUtils.isEmpty(k5VarArr[4].getText()) || k5VarArr[4].getLineCount() <= 1) {
                    k5VarArr[i10].setTranslationX((LocaleController.isRTL ? AndroidUtilities.dp(53.0f) : -AndroidUtilities.dp(53.0f)) * f7);
                    k5VarArr[i10].h(0, 0);
                } else {
                    k5VarArr[i10].h(AndroidUtilities.dp(92.0f), LocaleController.isRTL ? AndroidUtilities.dp(48.0f) : AndroidUtilities.dp(53.0f));
                    k5VarArr[i10].setFullAlpha(f7);
            ...
            float f10 = 1.0f - f7;
            k5Var.setTranslationX((LocaleController.isRTL ? -AndroidUtilities.dp(53.0f) : AndroidUtilities.dp(53.0f)) * f10);
            k5Var.setVisibility(0);
            k5Var.setAlpha(f7);
            k5VarArr[4].setAlpha(f10);
        ...
        bj0Var.setScaleX(f12);
        bj0Var.setScaleY(f12);
        invalidate();
    }
