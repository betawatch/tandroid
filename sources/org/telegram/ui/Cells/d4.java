...
public final class d4 extends FrameLayout {
    ...
    public static org.telegram.ui.Components.y8 a(boolean z10) {
        ...
        y8Var.g(8);
        y8Var.p = z10 ? 0.8f : 1.1f;
        y8Var.i(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.T7, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.a8, false));
        return y8Var;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (e9 > 0.0f) {
            ...
            canvas.drawCircle(width, height, AndroidUtilities.dp(10.0f) * e9, paint);
            if (this.P == null) {
                Drawable mutate = getContext().getResources().getDrawable(R.drawable.msg_mini_lock2).mutate();
                this.P = mutate;
                mutate.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
            }
            this.P.setBounds((int) (width - (((r2.getIntrinsicWidth() / 2.0f) * 0.875f) * e9)), (int) (height - (((this.P.getIntrinsicHeight() / 2.0f) * 0.875f) * e9)), (int) (((this.P.getIntrinsicWidth() / 2.0f) * 0.875f * e9) + width), (int) (((this.P.getIntrinsicHeight() / 2.0f) * 0.875f * e9) + height));
            this.P.setAlpha((int) (e9 * 255.0f));
            this.P.draw(canvas);
            canvas.restore();
        }
    }
    ...
    */
    public final void f(int i10) {
        ...
        if (z10) {
            ...
            ViewGroup.LayoutParams layoutParams3 = n9Var.getLayoutParams();
            ViewGroup.LayoutParams layoutParams4 = n9Var.getLayoutParams();
            int dp2 = AndroidUtilities.dp(46.0f);
            layoutParams4.height = dp2;
            layoutParams3.width = dp2;
            if (bpVar != null) {
                FrameLayout.LayoutParams layoutParams5 = (FrameLayout.LayoutParams) bpVar.getLayoutParams();
                int dp3 = AndroidUtilities.dp(29.0f);
                int i12 = this.B;
                layoutParams5.topMargin = dp3 + i12;
                if (LocaleController.isRTL) {
                    ((FrameLayout.LayoutParams) bpVar.getLayoutParams()).rightMargin = AndroidUtilities.dp(40.0f) + i12;
                } else {
                    ((FrameLayout.LayoutParams) bpVar.getLayoutParams()).leftMargin = AndroidUtilities.dp(40.0f) + i12;
                }
            }
            Object obj2 = this.f;
            ...
            if (!z12) {
                ...
                n9Var.e(chat2, y8Var);
                chat = chat2;
                n9Var.setRoundRadius(AndroidUtilities.dp((chat == null && chat.forum) ? 14.0f : 24.0f));
                charSequence = this.n;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float e9 = this.J.e(this.K);
        org.telegram.ui.ActionBar.c6 c6Var = this.I;
        if (e9 <= 0.0f && this.v == 2 && (this.D || this.E > 0.0f)) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        bp bpVar = this.d;
        if (bpVar != null ? bpVar.a.q : this.D) {
