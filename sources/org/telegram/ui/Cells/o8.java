...
public final class o8 extends FrameLayout {
    ...
    public o8(Context context, boolean z10, boolean z11, org.telegram.ui.ActionBar.e6 e6Var, boolean z12) {
        ...
        this.a = textView;
        org.telegram.messenger.y0.q(textView, z12 ? a(0.6f) : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Te, e6Var), 1, 15.0f);
        ...
        if (z11) {
            d = w7.x5.i(-2.0f, -2.0f, 8388659, z10 ? 5.0f : 15.0f, 5.0f, z10 ? 15.0f : 25.0f, 0.0f);
        } else {
            d = w7.x5.d(-2, -2.0f, 51, z10 ? 5.0f : 15.0f, 5.0f, z10 ? 15.0f : 25.0f, 0.0f);
        }
        ...
        this.c = h;
        h.setTextColor(z12 ? a(0.6f) : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Te, e6Var));
        h.setTextSize(1, 11.0f);
        h.setTypeface(AndroidUtilities.bold());
        h.setEllipsize(truncateAt);
        h.setPadding(AndroidUtilities.dp(6.0f), 0, AndroidUtilities.dp(6.33f), 0);
        int dp = AndroidUtilities.dp(9.0f);
        int a2 = z12 ? a(0.05f) : org.telegram.ui.ActionBar.i6.l1(0.1f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Te, e6Var));
        int a10 = z12 ? a(0.08f) : org.telegram.ui.ActionBar.i6.l1(0.24f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Te, e6Var));
        ...
        this.b = textView2;
        textView2.setTextColor(z12 ? a(0.6f) : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Te, e6Var));
        textView2.setTextSize(1, 12.0f);
        textView2.setEllipsize(truncateAt);
        textView2.setSingleLine(true);
        textView2.setVisibility(4);
        addView(textView2, z11 ? w7.x5.i(-2.0f, -2.0f, 8388661, 12.0f, 6.0f, 17.0f, 0.0f) : w7.x5.d(-2, -2.0f, 53, 12.0f, 6.0f, 17.0f, 0.0f));
        ImageView imageView = new ImageView(context);
        this.d = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setColorFilter(new PorterDuffColorFilter(z12 ? a(0.6f) : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Ve, e6Var), PorterDuff.Mode.MULTIPLY));
        imageView.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.i6, e6Var), 3, -1));
        if (z11) {
            d10 = w7.x5.i(24.0f, 24.0f, 8388661, 0.0f, 0.0f, z10 ? 0.0f : 10.0f, 0.0f);
        } else {
            d10 = w7.x5.d(24, 24.0f, 53, 0.0f, 0.0f, z10 ? 0.0f : 10.0f, 0.0f);
        }
    ...
    public final void f() {
        ...
        if (this.r != null) {
            ...
            try {
                spannableStringBuilder.setSpan(new nq(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Ue, e6Var)), 0, this.s, 33);
                spannableStringBuilder.setSpan(new nq(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Te, e6Var)), this.s, this.r.length(), 33);
            } catch (Exception unused) {
            }
    ...
    public final void measureChildWithMargins(View view, int i10, int i11, int i12, int i13) {
        if (view == this.b) {
            i11 = org.telegram.messenger.y0.C(16.0f, this.a.getMeasuredWidth(), i11);
        }
