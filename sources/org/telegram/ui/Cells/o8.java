...
public final class o8 extends FrameLayout {
    ...
    public o8(Context context) {
        ...
        this.c = textView2;
        rl.l(org.telegram.ui.ActionBar.g6.z6, null, textView2, 1, 13.0f);
        ...
        addView(r22, h7.z5.d(37, 40.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
    }
    ...
    public final void a(Runnable runnable, String str, boolean z10) {
        if (this.f == null) {
            ...
            this.f.addView(this.h, h7.z5.c(20.0f, -2));
            ...
            this.f.addView(this.n, h7.z5.q(16, 16, 16));
            this.f.setClipChildren(false);
            setClipChildren(false);
            addView(this.f, h7.z5.e(-2, -2, 16));
            zm zmVar = new zm(getContext(), 8);
            this.r = zmVar;
            zmVar.setBackground(org.telegram.ui.ActionBar.g6.f0(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.i6, false), 2, -1));
            addView(this.r, h7.z5.e(76, -1, LocaleController.isRTL ? 3 : 5));
        }
        this.h.setText(str);
        this.n.animate().cancel();
        this.n.animate().rotation(z10 ? 0.0f : 180.0f).setDuration(340L).setInterpolator(er.h).start();
