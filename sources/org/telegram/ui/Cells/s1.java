...
public final class s1 {
    ...
    */
    public final boolean f() {
        ...
        if (arrayList2 != arrayList3) {
            ...
            if (arrayList2 != null && arrayList3 != null && arrayList2.size() == this.I0.size()) {
                for (int i13 = 0; i13 < this.I0.size(); i13++) {
                    String charSequence = t1Var.u7.textLayoutBlocks.get(i13).textLayout == null ? null : t1Var.u7.textLayoutBlocks.get(i13).textLayout.getText().toString();
                    String charSequence2 = ((MessageObject.TextLayoutBlock) this.I0.get(i13)).textLayout == null ? null : ((MessageObject.TextLayoutBlock) this.I0.get(i13)).textLayout.getText().toString();
                    if ((charSequence != null || charSequence2 == null) && ((charSequence == null || charSequence2 != null) && charSequence.equals(charSequence2))) {
                        org.telegram.ui.Components.p5 p5Var = t1Var.lc;
                        if (p5Var != null) {
                            StaticLayout staticLayout2 = t1Var.u7.textLayoutBlocks.get(i13).textLayout;
                            StaticLayout staticLayout3 = ((MessageObject.TextLayoutBlock) this.I0.get(i13)).textLayout;
                            ...
                            if (staticLayout3 != null && (r5Var = (org.telegram.ui.Components.r5) hashMap.remove(staticLayout3)) != null) {
                                ...
                                for (int i14 = 0; i14 < arrayList4.size(); i14++) {
                                    ((org.telegram.ui.Components.o5) arrayList4.get(i14)).c = staticLayout2;
                                }
                ...
                if (z16) {
                    ...
                    this.H0 = arrayList5;
                    this.N0 = this.o2;
                    this.O0 = org.telegram.ui.Components.t5.update(0, (View) t1Var, this.O0, (ArrayList<MessageObject.TextLayoutBlock>) arrayList5, true);
                    t1Var.lc = org.telegram.ui.Components.t5.update(0, t1Var, t1Var.lc, t1Var.u7.textLayoutBlocks);
                    z10 = true;
                } else {
                    t1Var.lc = org.telegram.ui.Components.t5.update(0, t1Var, t1Var.lc, t1Var.u7.textLayoutBlocks);
                }
        ...
        RichMessageLayout richMessageLayout2 = t1Var.u7.richLayout;
        ...
        if (richMessageLayout2 != this.M0) {
            ej0 ej0Var = t1Var.de;
            boolean z17 = ej0Var != null && ej0Var.h;
            ...
            if (z17) {
                RichMessageLayout richMessageLayout4 = t1Var.u7.richLayout;
        ...
        StaticLayout staticLayout4 = t1Var.z9;
        if (staticLayout4 != this.E2) {
            ...
            if (!TextUtils.equals(text, staticLayout5 != null ? staticLayout5.getText() : null)) {
                ...
                this.J2 = this.I2;
                this.S0 = org.telegram.ui.Components.t5.update(0, (View) t1Var, false, this.S0, true, staticLayout6);
                z10 = true;
            }
        }
        boolean z18 = t1Var.Wc;
        if (z18 && !this.Z0 && t1Var.kb != null) {
            String string = LocaleController.getString("EditedMessage", R.string.EditedMessage);
            CharSequence text2 = t1Var.kb.getText();
            int indexOf = text2.toString().indexOf(string);
            if (indexOf >= 0) {
                if (indexOf == 0) {
                    TextPaint textPaint = org.telegram.ui.ActionBar.f6.T2;
                    int dp = AndroidUtilities.dp(100.0f) + t1Var.mb;
                    ...
                    spannableStringBuilder.setSpan(new xy(z13), 0, string.length(), 0);
                    this.V0 = new StaticLayout(spannableStringBuilder, org.telegram.ui.ActionBar.f6.T2, AndroidUtilities.dp(100.0f) + t1Var.mb, alignment, 1.0f, 0.0f, false);
                    this.Y0 = t1Var.lb - this.X0;
                } else {
                    this.Y0 = 0;
                    this.U0 = null;
                    this.V0 = this.i2;
            ...
            t1Var.y3 = null;
        } else if (!z18 && this.Z0 && t1Var.kb != null) {
            this.V0 = this.i2;
            int i15 = t1Var.lb;
            int i16 = this.X0;
            this.Y0 = i15 - i16;
        ...
        this.z1 = false;
        if ((t1Var.T != null) != this.z) {
            this.z1 = true;
            z10 = true;
        }
        this.L2 = false;
        if ((t1Var.u7.type == 27 && (o0Var = t1Var.v) != null && o0Var.d()) != this.K2) {
            this.L2 = true;
            z10 = true;
        }
        this.D1 = false;
        ...
        MessageObject.TextLayoutBlocks textLayoutBlocks = t1Var.Y3;
        ...
        if (textLayoutBlocks != textLayoutBlocks2) {
            ...
            MessageObject.TextLayoutBlocks textLayoutBlocks3 = t1Var.Y3;
            String charSequence4 = textLayoutBlocks3 == null ? null : textLayoutBlocks3.text.toString();
            if (this.E0 != t1Var.C8 || this.d1 != z19) {
                MessageObject.TextLayoutBlocks textLayoutBlocks4 = t1Var.Y3;
                int i25 = textLayoutBlocks4 == null ? 0 : textLayoutBlocks4.textWidth;
            ...
            if ((charSequence4 == null) == (charSequence3 == null) && (charSequence3 == null || charSequence3.equals(charSequence4))) {
                t1Var.n4();
                float f13 = this.e;
                if (f13 != t1Var.l4 || this.f != t1Var.m4) {
                    this.s0 = true;
                    this.q0 = f13;
                    this.r0 = this.f;
                    z10 = true;
            ...
            this.O0 = org.telegram.ui.Components.t5.update(0, t1Var, (org.telegram.ui.Components.p5) null, textLayoutBlocks6 == null ? null : textLayoutBlocks6.textLayoutBlocks);
            org.telegram.ui.Components.p5 p5Var2 = t1Var.lc;
            MessageObject.TextLayoutBlocks textLayoutBlocks7 = t1Var.Y3;
            t1Var.lc = org.telegram.ui.Components.t5.update(0, t1Var, p5Var2, textLayoutBlocks7 == null ? null : textLayoutBlocks7.textLayoutBlocks);
            if (this.E0 != t1Var.C8 || this.d1 != z19) {
                this.s0 = true;
                this.q0 = this.e;
                this.r0 = this.f;
            ...
            t1Var.n4();
            float f14 = this.e;
            if (f14 != t1Var.l4 || this.f != t1Var.m4) {
                this.s0 = true;
                this.q0 = f14;
                this.r0 = this.f;
                z10 = true;
        ...
        int i28 = t1Var.G1;
        if (i28 == 5 || i28 == 3 || i28 == 1) {
            float f15 = t1Var.G4;
            float f16 = this.S1;
            if (f15 != f16 || t1Var.H4 != this.T1) {
                this.U1 = f16;
                this.V1 = this.T1;
                this.W1 = true;
                z10 = true;
        ...
        if ((this.G != null || t1Var.Rb != null) && this.E != t1Var.getRepliesCount()) {
            this.H = this.G;
            this.F = true;
            t1Var.y3 = null;
            z11 = true;
        ...
        if (t1Var.V8 != null && this.M != t1Var.getRepliesCount()) {
            StaticLayout staticLayout7 = this.T;
            if (staticLayout7 == null || TextUtils.equals(staticLayout7.getText(), t1Var.V8.getText())) {
                this.V = null;
            } else {
                this.V = this.T;
            }
        ...
        if (!TextUtils.equals(this.e0, t1Var.b7)) {
            this.c0 = true;
            this.d0 = t1Var.Sa;
            z10 = true;
        }
        if (this.e1 == t1Var.rb) {
            ...
            if (this.e2 == t1Var.f4()) {
                if (z11 || (Math.abs(t1Var.nb - this.f1) > 1 && this.E0 == t1Var.C8)) {
                    this.h1 = true;
                    this.W0 = this.X0;
                    this.g1 = this.f1;
                    this.K = this.L;
                ...
                if (messageObject2 != null || this.w2 == messageObject2.needDrawForwarded()) {
                    ...
                    if (t1Var.u7.isRoundVideo()) {
                        float dp2 = t1Var.I8 - AndroidUtilities.dp(28 - (t1Var.F ? 2 : 0));
                        if (!s0Var.s) {
                            dp2 -= s0Var.p;
                        }
                        float f17 = this.q;
                    ...
                    if ((messageObject3 == null && messageObject3.translated) != this.i3 || t1Var.F2 == null || (staticLayout = this.j3) == null) {
                        return z10;
                    }
                    this.k3 = staticLayout;
                    this.l3 = org.telegram.ui.Components.t5.update(0, (View) t1Var, false, this.l3, staticLayout);
                    return true;
                }
                this.t2 = true;
    ...
    */
    public final int g() {
        ...
        t1 t1Var = this.m3;
        boolean z12 = true;
        if (!t1Var.u7.isOutOwner()) {
            if (!t1Var.u7.isSending() && !t1Var.u7.isEditing()) {
                z12 = false;
            }
            return (z12 ? 4 : 0) | (t1Var.u7.isSendError() ? 8 : 0);
        }
        if (t1Var.u7.isSending() || t1Var.u7.isEditing()) {
            i9 = 0;
            z12 = false;
            ...
            if (t1Var.u7.isSendError()) {
                ...
                return (!z12 ? 2 : 0) | i9 | (z10 ? 4 : 0) | (z11 ? 8 : 0);
            }
            if (t1Var.u7.isSent()) {
                MessageObject messageObject2 = t1Var.u7;
                i9 = (messageObject2.scheduled || messageObject2.isUnread()) ? 0 : 1;
            } else {
                i9 = 0;
                z12 = false;
            }
    ...
    public final void h() {
        ...
        org.telegram.ui.ActionBar.d5 d5Var2 = t1Var.p8;
        if (d5Var2 != null) {
    ...
    public final void i() {
        ...
        staticLayoutArr2[0] = staticLayout;
        staticLayoutArr2[1] = staticLayoutArr[1];
        this.w2 = t1Var.u7.needDrawForwarded();
        this.A2 = t1Var.eb;
        int i9 = t1Var.Hc;
        this.v2 = i9;
        this.H2 = i9;
    ...
    public final void j() {
        ...
        this.C0 = false;
        this.b1 = null;
        org.telegram.ui.Components.t5.release(t1Var, this.O0);
        this.O0 = null;
        this.s0 = false;
        this.J1 = false;
        this.M1.clear();
        ...
        ArrayList arrayList2 = s0Var.w;
        for (int i9 = 0; i9 < arrayList2.size(); i9++) {
            ((hg.p0) arrayList2.get(i9)).b();
        }
        arrayList2.clear();
        s0Var.j = false;
        s0Var.k = false;
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ((hg.p0) arrayList.get(i10)).c = 0;
        }
        this.k3 = null;
        org.telegram.ui.Components.t5.release(t1Var, this.l3);
    }
}
