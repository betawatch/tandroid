...
public final class n0 {
    ...
    public n0(int i10, u1 u1Var, TLObject[] tLObjectArr, int i11) {
        ...
        if (c(this.o) == null) {
            ...
            this.k = new w01(hg.k0.h(i11, "+"), 9.33f, AndroidUtilities.bold());
        }
    }
    ...
    public final void b(Canvas canvas, int i10, float f7) {
        ...
        if (this.f != null) {
            ...
            if (length <= 1) {
                ...
                textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.y6, u1Var.Id));
            }
        ...
        w01 w01Var = this.k;
        if (w01Var != null) {
            w01Var.p = i10 - AndroidUtilities.dp(32.0f);
            Drawable drawable = this.h;
            float l4 = (f10 - (w01Var.l() + AndroidUtilities.dp(drawable != null ? 17.0f : 8.0f))) / 2.0f;
            float dp = AndroidUtilities.dp(54.0f) + AndroidUtilities.dp(4.165f);
            boolean z10 = this.g;
            if (drawable != null) {
                drawable.setBounds((int) ((z10 ? w01Var.l() + AndroidUtilities.dp(1.33f) : 0.0f) + l4 + AndroidUtilities.dp(3.0f)), (int) rk.b(drawable.getIntrinsicHeight(), 2.0f, 0.625f, dp), (int) ((drawable.getIntrinsicWidth() * 0.625f) + (z10 ? AndroidUtilities.dp(1.33f) + w01Var.l() : 0.0f) + l4 + AndroidUtilities.dp(3.0f)), (int) a4.a.e(drawable.getIntrinsicHeight(), 2.0f, 0.625f, dp));
    ...
    public n0(int i10, u1 u1Var, TLObject tLObject) {
        ...
        if (c(tLObject) == null) {
            ...
            this.k = new w01(c(tLObject), 9.33f, AndroidUtilities.bold());
        }
    }
}
