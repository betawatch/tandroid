...
public final class n0 {
    ...
    public n0(int i10, s1 s1Var, TLObject[] tLObjectArr, int i11) {
        ...
        this.b = new org.telegram.ui.Components.e9[3];
        for (int i12 = 0; i12 < 3; i12++) {
            this.c[i12] = new ImageReceiver(s1Var);
            this.c[i12].setParentView(s1Var);
            this.c[i12].setRoundRadius(AndroidUtilities.dp(54.0f));
            this.b[i12] = new org.telegram.ui.Components.e9((org.telegram.ui.ActionBar.c6) null);
        ...
        if (c(this.o) == null) {
            ...
            this.k = new zz0(j7.l1.k(i11, "+"), 9.33f, AndroidUtilities.bold());
        }
    }
    ...
    public final void b(Canvas canvas, int i10, float f9) {
        ...
        if (staticLayout == null || staticLayout.getWidth() != i10) {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                this.f = bw0.c(this.e, textPaint, i10, Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, i10 - AndroidUtilities.dp(16.0f), 2, false);
            }
        }
        if (this.f != null) {
            canvas.save();
        ...
        zz0 zz0Var = this.k;
        if (zz0Var != null) {
            zz0Var.p = i10 - AndroidUtilities.dp(32.0f);
            Drawable drawable = this.h;
            float l10 = (f10 - (zz0Var.l() + AndroidUtilities.dp(drawable != null ? 17.0f : 8.0f))) / 2.0f;
            float dp = AndroidUtilities.dp(54.0f) + AndroidUtilities.dp(4.165f);
            boolean z10 = this.g;
            if (drawable != null) {
                drawable.setBounds((int) ((z10 ? zz0Var.l() + AndroidUtilities.dp(1.33f) : 0.0f) + l10 + AndroidUtilities.dp(3.0f)), (int) org.telegram.messenger.x3.A(drawable.getIntrinsicHeight(), 2.0f, 0.625f, dp), (int) ((drawable.getIntrinsicWidth() * 0.625f) + (z10 ? AndroidUtilities.dp(1.33f) + zz0Var.l() : 0.0f) + l10 + AndroidUtilities.dp(3.0f)), (int) u3.c.c(drawable.getIntrinsicHeight(), 2.0f, 0.625f, dp));
                drawable.draw(canvas);
            }
            this.k.c(l10 + AndroidUtilities.dp(!z10 ? 12.66f : 4.0f), dp, f9, -1, canvas);
        }
        canvas.restore();
    }
    ...
    public n0(int i10, s1 s1Var, TLObject tLObject) {
        ...
        org.telegram.ui.Components.e9[] e9VarArr = {r3};
        this.b = e9VarArr;
        ...
        if (c(tLObject) == null) {
            ...
            this.k = new zz0(c(tLObject), 9.33f, AndroidUtilities.bold());
        }
    }
}
