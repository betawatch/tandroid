...
public final class n0 {
    ...
    public n0(int i10, t1 t1Var, TLObject[] tLObjectArr, int i11) {
        ...
        if (c(this.o) == null) {
            ...
            this.k = new t01(hc.b.j(i11, "+"), 9.33f, AndroidUtilities.bold());
        }
    }
    ...
    public final void b(Canvas canvas, int i10, float f7) {
        ...
        t01 t01Var = this.k;
        if (t01Var != null) {
            t01Var.p = i10 - AndroidUtilities.dp(32.0f);
            Drawable drawable = this.h;
            float l4 = (f10 - (t01Var.l() + AndroidUtilities.dp(drawable != null ? 17.0f : 8.0f))) / 2.0f;
            float dp = AndroidUtilities.dp(54.0f) + AndroidUtilities.dp(4.165f);
            boolean z10 = this.g;
            if (drawable != null) {
                drawable.setBounds((int) ((z10 ? t01Var.l() + AndroidUtilities.dp(1.33f) : 0.0f) + l4 + AndroidUtilities.dp(3.0f)), (int) em.c(drawable.getIntrinsicHeight(), 2.0f, 0.625f, dp), (int) ((drawable.getIntrinsicWidth() * 0.625f) + (z10 ? AndroidUtilities.dp(1.33f) + t01Var.l() : 0.0f) + l4 + AndroidUtilities.dp(3.0f)), (int) a4.a.e(drawable.getIntrinsicHeight(), 2.0f, 0.625f, dp));
    ...
    public n0(int i10, t1 t1Var, TLObject tLObject) {
        ...
        if (c(tLObject) == null) {
            ...
            this.k = new t01(c(tLObject), 9.33f, AndroidUtilities.bold());
        }
    }
}
