...
public class m6 extends FrameLayout {
    ...
    public m6(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4, boolean z10) {
        ...
        this.b = i11;
        this.v = f6Var;
        this.y = new k6(this, f6Var);
        setLayoutParams(new f2.w0(-1, AndroidUtilities.dp(50.0f)));
        int i12 = i10 == 1 ? 48 : 34;
        l6 l6Var = new l6(this, context, i10);
        this.c = l6Var;
        float f10 = i12;
        l6Var.setRoundRadius(AndroidUtilities.dp(f10));
        addView(l6Var, k7.b6.i(f10, f10, 8388627, 10.0f, 0.0f, 0.0f, 0.0f));
        if (i10 == 1) {
    ...
    /* JADX WARN: Type inference failed for: r20v0, types: [android.view.View, org.telegram.ui.Cells.m6] */
    ...
    public final void c(TLRPC.User user, TLRPC.Chat chat, TLRPC.Reaction reaction, boolean z4, long j10, TL_stories.StoryItem storyItem, boolean z10, boolean z11, boolean z12) {
        ...
        if (storyItem == null) {
            ...
            if (j10 <= 0) {
                j11 = storyItem.date;
                if (j11 != 0) {
                    StringBuilder f12 = vh.w2.f(formatString, " ");
                ...
                if (j11 != 0) {
                    ...
                    cc0 cc0Var = storyItem != null ? z10 ? G : F : z11 ? D : E;
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                    spannableStringBuilder.append(cc0Var.a(getContext(), f6Var));
                    ...
                    if (z10 || storyItem == null) {
                        ...
                        if (!TextUtils.isEmpty(storyItem.caption)) {
                            ...
                            ys ysVar = new ys();
                            ysVar.c = 2.33333f;
                            ysVar.b = AndroidUtilities.dp(5.0f);
                            spannableStringBuilder.setSpan(ysVar, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 33);
                            spannableStringBuilder.append((CharSequence) "\u2004");
                    ...
                    if (!z10 && storyItem != null && (storyFwdHeader = storyItem.fwd_from) != null && storyFwdHeader.modified) {
                        ...
                        ys ysVar2 = new ys();
                        ysVar2.c = 2.33333f;
                        ysVar2.b = AndroidUtilities.dp(5.0f);
                        spannableStringBuilder.setSpan(ysVar2, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 33);
                        spannableStringBuilder.append((CharSequence) "\u2004");
