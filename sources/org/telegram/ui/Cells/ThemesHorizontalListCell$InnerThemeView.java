...
class ThemesHorizontalListCell$InnerThemeView extends FrameLayout {
    ...
    public final void a() {
        ...
        if (i11 != 0 && f6Var2.J != 0) {
            ...
            nb0 nb0Var = new nb0(true, o11, f6Var3.I, f6Var3.J, f6Var3.K);
        ...
        if (this.b.o() == 0 && this.b.P && this.K == null) {
            nb0 Q = org.telegram.ui.ActionBar.g6.Q(100, 200);
            this.K = Q;
    ...
    public final boolean c() {
        ...
        try {
            ...
            while (true) {
                try {
                    int read = fileInputStream.read(ia.e3);
                    if (read == -1) {
                        break;
                    }
                    int i11 = i10;
        ...
        ConnectionsManager.getInstance(f6Var5.A).sendRequest(getwallpaper, new RequestDelegate() { // from class: org.telegram.ui.Cells.fa
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                int i17 = ThemesHorizontalListCell$InnerThemeView.U;
                AndroidUtilities.runOnUIThread(new ga(0, ThemesHorizontalListCell$InnerThemeView.this, tLObject));
            }
        });
        return false;
    }
    ...
    public final void d(boolean z10) {
        ...
        this.F = this.A;
        int i12 = 0;
        org.telegram.ui.ActionBar.e6 k10 = this.b.k(false);
        if (k10 != null) {
            i12 = k10.c;
            i11 = k10.e;
            if (i11 == 0) {
    ...
    public final void onAttachedToWindow() {
        ...
        ia iaVar = this.T;
        this.a.a(this.b == (iaVar.b3 == 1 ? org.telegram.ui.ActionBar.g6.J : org.telegram.ui.ActionBar.g6.A0()), false);
        org.telegram.ui.ActionBar.f6 f6Var = this.b;
        if (f6Var == null || (tL_theme = f6Var.B) == null || f6Var.Q) {
            return;
        }
        if (iaVar.V2.containsKey(FileLoader.getAttachFileName(tL_theme.document)) || iaVar.W2.containsKey(this.b)) {
            return;
        }
        this.b.Q = true;
        this.v = 0.0f;
