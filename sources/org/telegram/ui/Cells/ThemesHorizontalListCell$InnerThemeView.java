...
class ThemesHorizontalListCell$InnerThemeView extends FrameLayout {
    ...
    public final void a() {
        ...
        int i9 = (e6Var.O && e6Var.U == org.telegram.ui.ActionBar.f6.n) ? -1 : e6Var.M;
        ...
        this.M = null;
        this.K = null;
        org.telegram.ui.ActionBar.e6 e6Var2 = this.b;
        int i10 = e6Var2.I;
        if (i10 != 0 && e6Var2.J != 0) {
            int o9 = this.b.o();
            org.telegram.ui.ActionBar.e6 e6Var3 = this.b;
            ...
            dArr = AndroidUtilities.rgbToHsv(Color.red(this.b.o()), Color.green(this.b.o()), Color.blue(this.b.o()));
        } else if (e6Var2.L > 0 || e6Var2.c != null) {
            float dp = AndroidUtilities.dp(76.0f);
            float dp2 = AndroidUtilities.dp(97.0f);
            org.telegram.ui.ActionBar.e6 e6Var4 = this.b;
            Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(dp, dp2, e6Var4.c, e6Var4.b, e6Var4.L);
    ...
    public final boolean c() {
        ...
        try {
            ...
            while (true) {
                try {
                    int read = fileInputStream.read(ma.e3);
                    if (read == -1) {
                        break;
                    }
                    int i10 = i9;
        ...
        org.telegram.ui.ActionBar.e6 e6Var3 = this.b;
        if (e6Var3.c == null || e6Var3.f || new File(this.b.c).exists()) {
            this.b.P = true;
            return true;
        }
        ...
        org.telegram.ui.ActionBar.e6 e6Var4 = this.b;
        hashMap.put(e6Var4, e6Var4.e);
        TL_account.getWallPaper getwallpaper = new TL_account.getWallPaper();
        TLRPC.TL_inputWallPaperSlug tL_inputWallPaperSlug = new TLRPC.TL_inputWallPaperSlug();
        org.telegram.ui.ActionBar.e6 e6Var5 = this.b;
        tL_inputWallPaperSlug.slug = e6Var5.e;
        getwallpaper.wallpaper = tL_inputWallPaperSlug;
        ConnectionsManager.getInstance(e6Var5.A).sendRequest(getwallpaper, new RequestDelegate() { // from class: org.telegram.ui.Cells.ja
    ...
    public final void d(boolean z10) {
        ...
        this.F = this.A;
        int i11 = 0;
        org.telegram.ui.ActionBar.d6 k10 = this.b.k(false);
        if (k10 != null) {
            i11 = k10.c;
            i10 = k10.e;
            if (i10 == 0) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.b;
        this.w = org.telegram.ui.ActionBar.f6.B(e6Var, i11, (e6Var.O && e6Var.U == org.telegram.ui.ActionBar.f6.n) ? -1 : e6Var.M);
        org.telegram.ui.ActionBar.e6 e6Var2 = this.b;
        this.x = org.telegram.ui.ActionBar.f6.B(e6Var2, i10, e6Var2.p());
        org.telegram.ui.ActionBar.e6 e6Var3 = this.b;
        this.y = org.telegram.ui.ActionBar.f6.B(e6Var3, i9, e6Var3.o());
        this.A = this.x;
        this.B = this.b.U;
    ...
    public final void onAttachedToWindow() {
        ...
        ma maVar = this.T;
        this.a.a(this.b == (maVar.b3 == 1 ? org.telegram.ui.ActionBar.f6.J : org.telegram.ui.ActionBar.f6.A0()), false);
        org.telegram.ui.ActionBar.e6 e6Var = this.b;
        if (e6Var == null || (tL_theme = e6Var.B) == null || e6Var.Q) {
            return;
        }
        if (maVar.V2.containsKey(FileLoader.getAttachFileName(tL_theme.document)) || maVar.W2.containsKey(this.b)) {
            return;
        }
        this.b.Q = true;
        this.v = 0.0f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (tL_theme == null || (tL_theme.document != null && e6Var.Q)) {
            ...
            org.telegram.ui.ActionBar.e6 e6Var2 = this.b;
            if (e6Var2.T != 0) {
                if ("Day".equals(e6Var2.a) || "Arctic Blue".equals(this.b.a)) {
                    radioButton.b(-5000269, b(this.F, this.A));
                    org.telegram.ui.ActionBar.f6.X1.setColor(733001146);
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(f10), AndroidUtilities.dp(f10), org.telegram.ui.ActionBar.f6.X1);
                }
            } else if (this.N) {
        ...
        if ((tL_theme2 == null || e6Var3.Q) && this.v <= 0.0f) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.e != null && (e6Var = this.b) != null && (e6Var.B == null || e6Var.Q)) {
            ma maVar = this.T;
            if (maVar.b3 == 0) {
