...
public class ab extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.a6 {
    ...
    public final void g(vk0 vk0Var, CharSequence charSequence, boolean z10) {
        ...
        if (z11) {
            int i11 = vk0Var.c;
            string = (i11 > 0 || !vk0Var.f) ? i11 <= 0 ? LocaleController.getString(R.string.NotificationEnabled) : LocaleController.getString(R.string.NotificationDisabled) : LocaleController.getString(R.string.NotificationEnabledAutomatically);
        } else {
            boolean z12 = vk0Var.b;
            int i12 = vk0Var.c;
            int i13 = vk0Var.a;
            boolean z13 = true;
        ...
        if (DialogObject.isEncryptedDialog(vk0Var.d)) {
            TLRPC.EncryptedChat m10 = org.telegram.messenger.w1.m(MessagesController.getInstance(i10), vk0Var.d);
        ...
        if (DialogObject.isUserDialog(vk0Var.d)) {
            Object user2 = MessagesController.getInstance(i10).getUser(Long.valueOf(vk0Var.d));
            if (user2 != null) {
        ...
        Object chat = MessagesController.getInstance(i10).getChat(Long.valueOf(-vk0Var.d));
        if (chat != null) {
    ...
    public final void h(int i10, j51 j51Var, boolean z10) {
        long j3 = j51Var.x;
        if (j3 <= 0) {
        ...
        if (user != null) {
            d(user, null, !TextUtils.isEmpty(publicUsername) ? p6.i("@", publicUsername) : user.bot ? LocaleController.getString(R.string.Bot) : user.contact ? LocaleController.getString(R.string.FilterContact) : LocaleController.getString(R.string.FilterNonContact), z10);
        }
    }
    ...
    */
            ...
            if (user != null) {
                ...
                if (chat == null) {
                    ...
                    if (botVerificationIcon != 0) {
                        ...
                        m5Var.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z9, f6Var)));
                        k5Var2.setLeftDrawable(m5Var);
                    }
                    if (user == null && MessagesController.getInstance(i12).isPremiumUser(user) && !MessagesController.getInstance(i12).premiumFeaturesBlocked()) {
                        if (DialogObject.getEmojiStatusDocumentId(user.emoji_status) != 0) {
                            ...
                            m5Var2.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z9, f6Var)));
                            k5Var2.i(m5Var2);
                        } else {
                            if (this.s == null) {
                                ...
                                this.s = yaVar;
                                yaVar.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z9, f6Var), PorterDuff.Mode.MULTIPLY));
                            }
                            k5Var2.i(this.s);
                        }
    ...
    public void setCallCellStyle(int i10) {
        ...
        boolean z10 = LocaleController.isRTL;
        k5Var.setLayoutParams(w7.x5.d(-1, 20.0f, (z10 ? 5 : 3) | 48, z10 ? 30.0f : i10 + 66, 10.0f, z10 ? i10 + 66 : 30.0f, 0.0f));
        org.telegram.ui.ActionBar.k5 k5Var2 = this.c;
        k5Var2.setTextSize(13);
        boolean z11 = LocaleController.isRTL;
        k5Var2.setLayoutParams(w7.x5.d(-1, 20.0f, (z11 ? 5 : 3) | 48, z11 ? 30.0f : i10 + 66, 32.0f, z11 ? i10 + 66 : 30.0f, 0.0f));
    ...
    public ab(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        super(context);
        int i12;
        int i13;
        float f7;
        ...
        addView(k5Var, w7.x5.d(-1, 20.0f, i15, f10, 10.0f, f7, 0.0f));
        this.v = new org.telegram.ui.Components.m5(AndroidUtilities.dp(20.0f), k5Var);
        this.w = new org.telegram.ui.Components.m5(AndroidUtilities.dp(20.0f), k5Var);
        ...
        addView(k5Var2, w7.x5.d(-1, 20.0f, (z15 ? 5 : 3) | 48, z15 ? i12 + 28 : i10 + 64, 32.0f, z15 ? i10 + 64 : i12 + 28, 0.0f));
