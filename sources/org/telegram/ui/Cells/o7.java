...
public final class o7 extends FrameLayout {
    ...
    public o7(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        addView(npVar, w7.y5.d(24, 24.0f, (z10 ? 5 : 3) | 48, z10 ? 0.0f : 44.0f, 44.0f, z10 ? 44.0f : 0.0f, 0.0f));
        if (i10 == 1) {
    ...
    public final void g(int i10, int i11, int i12) {
        ...
        if (i14 == 0) {
            ...
            for (int i15 = 0; i15 < arrayList3.size(); i15++) {
                ...
                while (it.hasNext()) {
                    ((vh.g) it.next()).j(i13, ((i11 - this.F) - i12) + f7, sqrt, false);
                }
            }
        } else if (i14 == 1) {
            int size = arrayList.size();
            ...
            while (i16 < size) {
                ...
                i16++;
                ((vh.g) obj).j(i13, i11 - this.Q, sqrt, false);
            }
        } else if (i14 == 2) {
            ...
            while (i17 < size2) {
                ...
                i17++;
                ((vh.g) obj2).j(i13, i11 - this.T, sqrt, false);
            }
        }
            ...
            if (i18 != this.N) {
                if (i18 == 0) {
                    for (int i19 = 0; i19 < arrayList3.size(); i19++) {
                        ...
                        while (it2.hasNext()) {
                            ((vh.g) it2.next()).j(r12.getBounds().centerX(), r12.getBounds().centerY(), sqrt, false);
                        }
                    }
                } else if (i18 == 1) {
                    ...
                    while (i20 < size3) {
                        ...
                        i20++;
                        ((vh.g) obj3).j(r12.getBounds().centerX(), r12.getBounds().centerY(), sqrt, false);
                    }
                } else if (i18 == 2) {
                    ...
                    while (i21 < size4) {
                        ...
                        i21++;
                        ((vh.g) obj4).j(r12.getBounds().centerX(), r12.getBounds().centerY(), sqrt, false);
                    }
                }
            }
        }
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (staticLayout3.getLineCount() > 0) {
                    ...
                    if (list != null) {
                        ...
                        while (it.hasNext()) {
                            Rect bounds = ((vh.g) it.next()).getBounds();
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaWebPage) {
            ...
            if (webPage instanceof TLRPC.TL_webPage) {
                                                    ...
                                                    try {
                                                        ...
                                                        if (!(messageEntity3 instanceof TLRPC.TL_messageEntitySpoiler) || i26 > i33 || i27 < i32) {
                                                            ...
                                                            try {
                                                                e11Var.a |= 256;
                                                                arrayList2 = arrayList7;
                                                                valueOf.setSpan(new f11(e11Var, 0), Math.max(i26, i32), Math.min(i27, i33) + i28, 33);
                                                            } catch (Exception e7) {
                                                                e = e7;
                                                                str2 = str7;
                                                                str3 = str9;
                ...
                if (i12 != 1) {
                    ...
                    this.h0 = u1.u2(stringForMessageListDate, textPaint3, ceil, ceil, 0, 1);
                ...
                if (spannableStringBuilder2 == null) {
                    try {
                        i14 = max;
                        try {
                            this.U = u1.u2(spannableStringBuilder2, textPaint4, size, size, 0, max);
                            if (this.R != null) {
                            ...
                            setMeasuredDimension(View.MeasureSpec.getSize(i10), org.telegram.messenger.l0.y(17.0f, i39, AndroidUtilities.dp(76.0f)) + (this.y ? 1 : 0));
                        }
                    } catch (Exception e16) {
                        e = e16;
                        i14 = max;
                ...
                if (staticLayout != null) {
                    int i40 = this.Q;
                    this.W = i40;
                    int C = org.telegram.messenger.l0.C(5.0f, staticLayout.getLineBottom(staticLayout.getLineCount() - 1), i40);
                    this.Q = C;
                    this.T = C;
                }
                if (!arrayList6.isEmpty()) {
                ...
                int B = LocaleController.isRTL ? org.telegram.messenger.l0.B(10.0f, View.MeasureSpec.getSize(i10), dp2) : AndroidUtilities.dp(10.0f);
                ...
                if (staticLayout3 != null || staticLayout3.getLineCount() == 0) {
                    ...
                    f11 = 5.0f;
                    i17 = org.telegram.messenger.l0.C(5.0f, staticLayout11.getLineBottom(staticLayout11.getLineCount() - i15), i17);
                }
                staticLayout4 = this.R;
                if (staticLayout4 != null && staticLayout4.getLineCount() != 0) {
                    StaticLayout staticLayout12 = this.R;
                    i17 = org.telegram.messenger.l0.C(f11, staticLayout12.getLineBottom(staticLayout12.getLineCount() - i15), i17);
                }
                staticLayout5 = this.U;
                if (staticLayout5 != null && staticLayout5.getLineCount() != 0) {
                    StaticLayout staticLayout13 = this.U;
                    i17 = org.telegram.messenger.l0.C(f11, staticLayout13.getLineBottom(staticLayout13.getLineCount() - i15), i17);
                    if (this.R != null) {
                ...
                if (this.j0 != null) {
                    ...
                    i392 = org.telegram.messenger.l0.C(f11, staticLayout15.getLineBottom(staticLayout15.getLineCount() - i15), i392);
                }
                this.w.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), TLObject.FLAG_30));
                setMeasuredDimension(View.MeasureSpec.getSize(i10), org.telegram.messenger.l0.y(17.0f, i392, AndroidUtilities.dp(76.0f)) + (this.y ? 1 : 0));
            }
        }
        str = null;
        str2 = null;
        ...
        if (staticLayout4 != null) {
            ...
            i17 = org.telegram.messenger.l0.C(f11, staticLayout122.getLineBottom(staticLayout122.getLineCount() - i15), i17);
        }
        staticLayout5 = this.U;
        if (staticLayout5 != null) {
            StaticLayout staticLayout132 = this.U;
            i17 = org.telegram.messenger.l0.C(f11, staticLayout132.getLineBottom(staticLayout132.getLineCount() - i15), i17);
            if (this.R != null) {
            }
        }
        while (i18 < arrayList5.size()) {
        ...
        this.w.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(24.0f), TLObject.FLAG_30));
        setMeasuredDimension(View.MeasureSpec.getSize(i10), org.telegram.messenger.l0.y(17.0f, i3922, AndroidUtilities.dp(76.0f)) + (this.y ? 1 : 0));
    }
                            ...
                            if (motionEvent.getAction() == 0) {
                                ...
                                if (sparseArray.get(i13, null) != null) {
                                    ...
                                    while (true) {
                                        ...
                                        if (gVar.getBounds().contains(x10 - dp, (y3 - this.F) - i14)) {
                                            e();
                                            this.M = gVar;
                                            this.N = 0;
                                            break;
                ...
                if (motionEvent.getAction() == 0) {
                    ...
                    if (staticLayout2 != null && x10 >= dp2 && x10 <= staticLayout2.getWidth() + dp2 && y3 >= (i11 = this.Q) && y3 <= this.R.getHeight() + i11) {
                        ...
                        while (true) {
                            ...
                            i15++;
                            vh.g gVar2 = (vh.g) obj;
                            if (gVar2.getBounds().contains(x10 - dp2, y3 - this.Q)) {
                                this.M = gVar2;
                                this.N = 1;
                                z10 = true;
                                z11 = true;
                    ...
                    if (staticLayout3 != null && x10 >= dp2 && x10 <= staticLayout3.getWidth() + dp2 && y3 >= (i10 = this.T) && y3 <= this.U.getHeight() + i10) {
                        ...
                        while (i16 < size2) {
                            ...
                            i16++;
                            vh.g gVar3 = (vh.g) obj2;
                            if (gVar3.getBounds().contains(x10 - dp2, y3 - this.T)) {
                                this.M = gVar3;
                                this.N = 2;
                                z10 = true;
                                z11 = true;
