...
public final class x0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        w0 w0Var = this.a;
        w0Var.b(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.g7, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.h7, false));
        RectF rectF = this.c;
        ...
        org.telegram.ui.ActionBar.g6.X1.setColor(Color.argb((int) (w0Var.getProgress() * 43.0f), red, green, blue));
        ...
        org.telegram.ui.ActionBar.g6.t0.setColor(Color.argb((int) ((1.0f - w0Var.getProgress()) * 31.0f), red, green, blue));
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.g6.t0);
        boolean z10 = this.b;
        ...
        for (int i11 = 2; i10 < i11; i11 = 2) {
            ...
            org.telegram.ui.ActionBar.g6.t0.setColor(Color.argb(i10 == 0 ? 204 : 90, red, green, blue));
            canvas.drawCircle(AndroidUtilities.dp(22.0f), dp, AndroidUtilities.dp(11.0f), org.telegram.ui.ActionBar.g6.t0);
            int i12 = 0;
            while (true) {
                if (i12 < (z10 ? 3 : 2)) {
                    org.telegram.ui.ActionBar.g6.t0.setColor(Color.argb(i12 == 0 ? 204 : 90, red, green, blue));
                    if (z10) {
                        float f9 = i12 * 7;
                        rectF.set(AndroidUtilities.dp(41.0f), dp - AndroidUtilities.dp(8.3f - f9), getMeasuredWidth() - AndroidUtilities.dp(i12 != 0 ? 48.0f : 72.0f), dp - AndroidUtilities.dp(5.3f - f9));
                        canvas.drawRoundRect(rectF, AndroidUtilities.dpf2(1.5f), AndroidUtilities.dpf2(1.5f), org.telegram.ui.ActionBar.g6.t0);
                    } else {
                        int i13 = i12 * 10;
