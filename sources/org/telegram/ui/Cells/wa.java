...
public abstract class wa extends FrameLayout {
    ...
    public final void c(int i10, boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            animatorSet2.playTogether(ObjectAnimator.ofFloat(y3Var, "scaleX", z10 ? 0.8875f : 1.0f), ObjectAnimator.ofFloat(y3Var, "scaleY", z10 ? 0.8875f : 1.0f));
            vaVar.f.setDuration(200L);
            vaVar.f.addListener(new bg.z2(25, vaVar, z10));
            vaVar.f.start();
        } else {
            y3Var.setScaleX(z10 ? 0.8875f : 1.0f);
            y3Var.setScaleY(z10 ? 0.8875f : 1.0f);
        }
        vaVar.invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int dp = size - AndroidUtilities.dp(com.google.android.recaptcha.internal.a.f(this.d, 1, 6, 28));
        int i13 = dp / this.d;
        int i14 = this.h;
