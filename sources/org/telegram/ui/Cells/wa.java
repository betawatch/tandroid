...
public final class wa extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public wa(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
    ...
    public final va a(CharSequence charSequence, String str, boolean z4) {
        ArrayList arrayList = this.h;
        if (!arrayList.isEmpty()) {
            this.G += AndroidUtilities.dp(7.0f);
        }
        va vaVar = new va(str, charSequence, z4);
        arrayList.add(vaVar);
        this.G += AndroidUtilities.dp(14.0f);
        this.s = Math.max(this.s, vaVar.a.c);
        this.v = Math.max(this.v, vaVar.b.c + (z4 ? AndroidUtilities.dp(38.0f) : 0));
        return vaVar;
    }
    ...
    public final void b(long j10, TLRPC.PeerSettings peerSettings) {
        ...
        if (user == null || user.verified || UserObject.isService(user.id)) {
            ...
            lq lqVar = new lq(R.drawable.filled_info, 0);
            lqVar.setScale(0.55f, -0.55f);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.commonChatsLoaded && ((Long) objArr[0]).longValue() == this.c) {
            ...
            va vaVar = this.n;
            if (vaVar == null || count <= 0) {
                b(this.c, MessagesController.getInstance(i13).getPeerSettings(this.c));
                requestLayout();
            } else {
                vaVar.b = new k01(LocaleController.formatPluralString("Groups", count, new Object[0]), 12.0f, AndroidUtilities.bold());
                int min = Math.min(3, this.F.chats.size());
                org.telegram.ui.Components.c9 c9Var = this.D;
                c9Var.k(min);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            float dp5 = (width - (this.H / 2.0f)) + AndroidUtilities.dp(16.0f) + this.s + AndroidUtilities.dp(7.66f) + vaVar.b.c;
            org.telegram.ui.Components.c9 c9Var = this.D;
            Drawable drawable = this.E;
            rectF2.set(dp4, f15, dp5 + (z4 ? c9Var.A + (drawable.getIntrinsicWidth() * 0.8f) + AndroidUtilities.dp(5.0f) : 0.0f), vaVar.b.j() + f15);
            if (this.n == vaVar) {
                RectF rectF3 = this.y;
                rectF3.set(rectF2);
                rectF3.inset(-AndroidUtilities.dp(4.0f), -AndroidUtilities.dp(2.0f));
                float a10 = this.C.a(f11);
                canvas.scale(a10, a10, rectF3.centerX(), vaVar.b.j() / 2.0f);
                z zVar = this.B;
                if (zVar != null) {
            ...
            k01Var4.c(dp3, vaVar.b.j() / 2.0f, 1.0f, -1, canvas);
            if (z4) {
                canvas.save();
                canvas.translate((width - (this.H / 2.0f)) + AndroidUtilities.dp(16.0f) + this.s + AndroidUtilities.dp(7.66f) + vaVar.b.c + AndroidUtilities.dp(4.0f), AndroidUtilities.dp(1.0f));
                c9Var.i(canvas);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (rcVar2.h) {
                ...
                if ((U instanceof zn) && (njVar = ((zn) U).X0) != null) {
                    njVar.e(true, false);
                }
            } else if (rcVar.h) {
