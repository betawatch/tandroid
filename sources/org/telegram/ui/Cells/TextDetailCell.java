...
public class TextDetailCell extends FrameLayout {
    ...
    public TextDetailCell(Context context, int i, Theme.ResourcesProvider resourcesProvider, boolean z, boolean z2) {
        ...
        spoilersTextView.setOnLinkLongPressListener(new LinkSpanDrawable.LinksTextView.OnLinkPress() { // from class: org.telegram.ui.Cells.TextDetailCell$$ExternalSyntheticLambda0
            ...
            public final void run(ClickableSpan clickableSpan) {
                TextDetailCell.$r8$lambda$83xd1Ik7Tped6omL3O_en0xt5uk(TextDetailCell.this, clickableSpan);
            }
        });
        ...
        linksTextView.setOnLinkLongPressListener(new LinkSpanDrawable.LinksTextView.OnLinkPress() { // from class: org.telegram.ui.Cells.TextDetailCell$$ExternalSyntheticLambda1
            @Override // org.telegram.ui.Components.LinkSpanDrawable.LinksTextView.OnLinkPress
            public final void run(ClickableSpan clickableSpan) {
                TextDetailCell.$r8$lambda$Lqqs9QkEf_XSQbdvK9DQ68T2tG8(TextDetailCell.this, clickableSpan);
            }
        });
        if (z2) {
            setMinimumHeight(AndroidUtilities.dp(60.0f));
        ...
        linksTextView2.setOnLinkLongPressListener(new LinkSpanDrawable.LinksTextView.OnLinkPress() { // from class: org.telegram.ui.Cells.TextDetailCell$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.Components.LinkSpanDrawable.LinksTextView.OnLinkPress
            public final void run(ClickableSpan clickableSpan) {
                TextDetailCell.$r8$lambda$goIaOAzvIxxiQNJjhHu0nvK11YY(TextDetailCell.this, clickableSpan);
            }
        });
    ...
    public static /* synthetic */ void $r8$lambda$83xd1Ik7Tped6omL3O_en0xt5uk(TextDetailCell textDetailCell, ClickableSpan clickableSpan) {
    ...
    public static /* synthetic */ void $r8$lambda$Lqqs9QkEf_XSQbdvK9DQ68T2tG8(TextDetailCell textDetailCell, ClickableSpan clickableSpan) {
        textDetailCell.getClass();
        if (clickableSpan != null) {
            try {
                textDetailCell.performHapticFeedback(0, 1);
    ...
    public static /* synthetic */ void $r8$lambda$goIaOAzvIxxiQNJjhHu0nvK11YY(TextDetailCell textDetailCell, ClickableSpan clickableSpan) {
        textDetailCell.getClass();
        if (clickableSpan != null) {
            try {
                textDetailCell.performHapticFeedback(0, 1);
