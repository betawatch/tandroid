...
public final class n8 extends FrameLayout {
    ...
    public n8(Context context, int i10) {
        ...
        addView(w9Var, w7.x5.d(40, 40.0f, (z10 ? 5 : 3) | 48, z10 ? 0.0f : 13.0f, 9.0f, z10 ? 13.0f : 0.0f, 0.0f));
        if (i10 != 0) {
            ...
            if (i10 == 1) {
                ...
                addView(opVar, w7.x5.i(24.0f, 24.0f, 8388611, 34.0f, 30.0f, 0.0f, 0.0f));
            } else if (i10 == 3) {
        ...
        textView.setBackground(org.telegram.ui.ActionBar.x5.d(new float[]{14.0f}, org.telegram.ui.ActionBar.h6.w0(null, i12, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Qh, false)));
        ...
        textView2.setBackground(org.telegram.ui.ActionBar.x5.d(new float[]{14.0f}, 0, org.telegram.ui.ActionBar.h6.w0(null, i12, false) & 452984831));
        ...
        p0Var.a(LocaleController.getString(R.string.Unlock), new h8(this, 0), false);
        try {
        ...
        this.c = textView3;
        ul.s(textView3, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.z6, false), 1, 13.0f, 1);
    ...
    public final void c(final boolean z10) {
        ...
        if (this.a == 1) {
            ...
            rr rrVar = lt.a;
            duration.setInterpolator(rrVar).withEndAction(new Runnable(this) { // from class: org.telegram.ui.Cells.i8
            ...
            if (this.w) {
                ...
                frameLayout.animate().alpha(fArr[1]).scaleX(fArr2[1]).scaleY(fArr2[1]).setDuration(200L).setInterpolator(rrVar).withEndAction(new Runnable(this) { // from class: org.telegram.ui.Cells.i8
                    public final /* synthetic */ n8 b;
                ...
                imageView2.animate().alpha(fArr[1]).scaleX(fArr2[1]).scaleY(fArr2[1]).setDuration(200L).setInterpolator(rrVar).withEndAction(new Runnable(this) { // from class: org.telegram.ui.Cells.i8
                    public final /* synthetic */ n8 b;
    ...
    public final void d(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            if (tL_messages_stickerSet2.set.thumb_document_id != 0) {
                org.telegram.ui.Components.q5.h(UserConfig.selectedAccount).b(tL_messages_stickerSet2.set.thumb_document_id, new org.telegram.ui.Components.n5() { // from class: org.telegram.ui.Cells.j8
    ...
    public final void e(int i10) {
        ...
        if (i10 == 1) {
            ...
            p0Var.a(LocaleController.getString(R.string.Restore), new h8(this, 0), false);
        }
