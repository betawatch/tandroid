...
public final class n8 extends FrameLayout {
    ...
    public n8(Context context, int i10) {
        ...
        addView(v9Var, w7.y5.d(40, 40.0f, (z10 ? 5 : 3) | 48, z10 ? 0.0f : 13.0f, 9.0f, z10 ? 13.0f : 0.0f, 0.0f));
        if (i10 != 0) {
        ...
        this.c = textView3;
        rk.t(textView3, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.z6, false), 1, 13.0f, 1);
    ...
    public final void c(final boolean z10) {
        ...
        if (this.a == 1) {
            ...
            qr qrVar = kt.a;
            duration.setInterpolator(qrVar).withEndAction(new Runnable(this) { // from class: org.telegram.ui.Cells.i8
            ...
            if (this.w) {
                ...
                frameLayout.animate().alpha(fArr[1]).scaleX(fArr2[1]).scaleY(fArr2[1]).setDuration(200L).setInterpolator(qrVar).withEndAction(new Runnable(this) { // from class: org.telegram.ui.Cells.i8
                    public final /* synthetic */ n8 b;
                ...
                imageView2.animate().alpha(fArr[1]).scaleX(fArr2[1]).scaleY(fArr2[1]).setDuration(200L).setInterpolator(qrVar).withEndAction(new Runnable(this) { // from class: org.telegram.ui.Cells.i8
                    public final /* synthetic */ n8 b;
    ...
    public final void d(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            if (tL_messages_stickerSet2.set.thumb_document_id != 0) {
                org.telegram.ui.Components.p5.h(UserConfig.selectedAccount).b(tL_messages_stickerSet2.set.thumb_document_id, new org.telegram.ui.Components.m5() { // from class: org.telegram.ui.Cells.j8
                    ...
                    public final void a(TLRPC.Document document2) {
                        AndroidUtilities.runOnUIThread(new oa(7, n8.this, document2));
                    }
                });
            }
        } else {
            ...
            if (z14 && (MessageObject.isAnimatedStickerDocument(document, true) || MessageObject.isVideoSticker(document))) {
                if (svgThumb != null) {
                    v9Var.n(ImageLocation.getForDocument(document), concat, svgThumb, tL_messages_stickerSet);
                    tL_messages_stickerSet2 = tL_messages_stickerSet;
                } else {
                    v9Var.j(ImageLocation.getForDocument(document), concat, forDocument, null, 0, tL_messages_stickerSet);
                    tL_messages_stickerSet2 = tL_messages_stickerSet;
                }
                if (MessageObject.isTextColorEmoji(document)) {
                    v9Var.setColorFilter(org.telegram.ui.ActionBar.j6.v3);
                }
            } else {
                tL_messages_stickerSet2 = tL_messages_stickerSet;
                if (forDocument == null || forDocument.imageType != 1) {
                    v9Var.i(forDocument, concat, "webp", svgThumb, tL_messages_stickerSet2);
                } else {
                    v9Var.i(forDocument, concat, "tgs", svgThumb, tL_messages_stickerSet2);
                }
            }
        }
        if (this.s) {
