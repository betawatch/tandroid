...
public final class t extends ml0 implements NotificationCenter.NotificationCenterDelegate {
    public ArrayList X2;
    public s4.c0 Y2;
    public int Z2;
    ...
    public final void w1() {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if (w7.e6.a((gb0) arrayList.get(i11))) {
