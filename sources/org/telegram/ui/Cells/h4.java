...
public final class h4 extends FrameLayout {
    ...
    public h4(Context context, int i10, int i11, boolean z10) {
    ...
    public final void c(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            v9Var.setScaleX(f7);
            v9Var.setScaleY(this.H ? 0.82f : 1.0f);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (e > 0.0f) {
            org.telegram.ui.Components.v9 v9Var = this.a;
            float height = (v9Var.getHeight() / 2.0f) + v9Var.getY() + AndroidUtilities.dp(18.0f);
            float width = (v9Var.getWidth() / 2.0f) + v9Var.getX() + AndroidUtilities.dp(18.0f);
            canvas.save();
    ...
    */
    public final void f(int i10) {
        ...
        if (z10) {
            ...
            ViewGroup.LayoutParams layoutParams = v9Var.getLayoutParams();
            ViewGroup.LayoutParams layoutParams2 = v9Var.getLayoutParams();
            ...
            ViewGroup.LayoutParams layoutParams3 = v9Var.getLayoutParams();
            ViewGroup.LayoutParams layoutParams4 = v9Var.getLayoutParams();
            ...
            if (!z12) {
                ...
                v9Var.e(chat2, g9Var);
                chat = chat2;
                v9Var.setRoundRadius(AndroidUtilities.dp((chat == null && chat.forum) ? 14.0f : 24.0f));
                charSequence = this.n;
            ...
            if (this.n == null) {
                if (user.bot) {
                    ...
                    j5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i16, f6Var));
                    ...
                    j5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i17, f6Var));
                    ...
                    j5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i18, f6Var));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (e <= 0.0f && this.v == 2 && (this.H || this.I > 0.0f)) {
            ...
            paint.setColor(v02);
            org.telegram.ui.Components.v9 v9Var = this.a;
            canvas.drawCircle((v9Var.getMeasuredWidth() / 2) + v9Var.getLeft(), (v9Var.getMeasuredHeight() / 2) + v9Var.getTop(), (AndroidUtilities.dp(4.0f) * this.I) + AndroidUtilities.dp(18.0f), paint);
        }
        if (this.E) {
    ...
    public h4(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        super(context);
        this.w = UserConfig.selectedAccount;
        this.N = new org.telegram.ui.Components.d6(this, 0L, 350L, qr.h);
        this.M = f6Var;
        this.v = i10;
        this.K = z11;
        this.E = false;
        ...
        addView(v9Var, w7.y5.d(46, 46.0f, (z12 ? 5 : 3) | 48, z12 ? 0.0f : i11 + 13, 6.0f, z12 ? i11 + 13 : 0.0f, 0.0f));
        ai.a6 a6Var = new ai.a6(context, 1);
        this.b = a6Var;
        NotificationCenter.listenEmojiLoading(a6Var);
        a6Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(z11 ? org.telegram.ui.ActionBar.j6.ng : org.telegram.ui.ActionBar.j6.G6, f6Var));
