...
public final class h4 implements DownloadController.FileDownloadProgressListener {
    ...
    public final void c(TLRPC.MessageExtendedMedia messageExtendedMedia, MessageObject messageObject) {
        ...
        if (z10) {
            this.h = true;
            this.v = null;
            this.f.setImage(ImageLocation.getForObject(((TLRPC.TL_messageExtendedMediaPreview) messageExtendedMedia).thumb, messageObject.messageOwner), u3.c.k(k9, "_b2"), null, null, messageObject, 0);
        ...
        if (messageExtendedMedia instanceof TLRPC.TL_messageExtendedMedia) {
            ...
            if (messageMedia instanceof TLRPC.TL_messageMediaPhoto) {
                ...
                this.f.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, tL_messageMediaPhoto.photo), k9, ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaPhoto.photo.sizes, Math.min(i10, i11) / 100, false, closestPhotoSizeWithSize, false), tL_messageMediaPhoto.photo), k9, 0L, null, messageObject, 0);
                return;
            }
            if (messageMedia instanceof TLRPC.TL_messageMediaDocument) {
                ...
                if (z14 || !z13 || (document = tL_messageMediaDocument.document) == null) {
                    ...
                    if (document2 != null) {
                        ...
                        this.f.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize2, tL_messageMediaDocument.document), k9, ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaDocument.document.thumbs, Math.min(i10, i11), false, closestPhotoSizeWithSize2, false), tL_messageMediaDocument.document), k9, 0L, null, messageObject, 0);
                        return;
                    }
                    return;
                }
