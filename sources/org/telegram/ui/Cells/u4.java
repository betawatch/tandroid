...
public final class u4 extends FrameLayout {
    ...
    public u4(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.a = p6Var;
        qr qrVar = qr.h;
        p6Var.b(0.4f, 350L, qrVar);
        p6Var.setScaleProperty(0.6f);
        p6Var.setTextSize(AndroidUtilities.dp(16.0f));
        p6Var.setEllipsizeByGradient(true);
        p6Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, e6Var));
        ...
        p6Var2.b(0.4f, 350L, qrVar);
        p6Var2.setTextSize(AndroidUtilities.dp(14.0f));
        p6Var2.setEllipsizeByGradient(true);
        p6Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.A6, e6Var));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.translate(AndroidUtilities.dp(2.0f), wh.A(56.0f, getMeasuredHeight(), 2));
        x.draw(canvas);
        canvas.restore();
        super.onDraw(canvas);
        if (this.e) {
