...
public final class p2 {
    ...
    */
    public final boolean a() {
        ...
        s2 s2Var = this.q;
        int i12 = s2Var.F0;
        TLRPC.Dialog dialog = (TLRPC.Dialog) MessagesController.getInstance(i12).dialogs_dict.f(s2Var.H0);
        if (dialog == null) {
            if (s2Var.j1 == 3) {
                long j10 = this.a;
                long j11 = s2Var.H0;
            ...
            if (!TextUtils.isEmpty(messagesController.getPrintingString(j13, topicId3, true))) {
                ...
                if (s2Var.Q()) {
                    ...
                    if (!s2Var.P) {
                        ...
                        z10 = false;
                        if (s2Var.N0) {
                            z11 = MediaDataController.getInstance(i12).getDraftVoice(s2Var.H0, 0L) != null;
                            draft = !z11 ? MediaDataController.getInstance(i12).getDraft(s2Var.H0, 0L) : null;
                            if (draft == null) {
                            }
                            TLRPC.Chat chat = s2Var.g2;
                            if (chat == null) {
                            }
                            isTranslatingDialog = MessagesController.getInstance(i12).getTranslateController().isTranslatingDialog(s2Var.H0);
                    ...
                    isTranslatingDialog = MessagesController.getInstance(i12).getTranslateController().isTranslatingDialog(s2Var.H0);
                    if (this.h != measuredWidth && this.b == hashCode && this.c == isTranslatingDialog && this.a == s2Var.H0 && this.d == dialog.isFolder && this.e == j3 && Objects.equals(this.g, num) && this.i == i10 && i11 == this.f && this.j == s2Var.A3 && this.k == z12 && s2Var.k2 == z11) {
                        return z10;
                    }
                    if (this.a != s2Var.H0) {
