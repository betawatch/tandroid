...
public final class cb extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public cb(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
    ...
    public final void b(long j3, TLRPC.PeerSettings peerSettings) {
        ...
        this.J += AndroidUtilities.dp(14.0f);
        h01 h01Var = new h01(DialogObject.getName(j3), 14.0f, AndroidUtilities.bold());
        this.d = h01Var;
        this.J = h01Var.j() + AndroidUtilities.dp(3.0f) + this.J;
        int i11 = this.a;
        h01 h01Var2 = new h01(LocaleController.getString(ContactsController.getInstance(i11).isContact(j3) ? R.string.ContactInfoIsContact : R.string.ContactInfoIsNotContact), 14.0f, null);
        this.e = h01Var2;
        this.J = h01Var2.j() + AndroidUtilities.dp(11.0f) + this.J;
        ...
        if (user == null || user.verified || UserObject.isService(user.id)) {
            ...
            this.f = new h01(spannableStringBuilder, 12.0f, null);
            ...
            this.f = new h01(spannableStringBuilder2, 12.0f, null);
            ...
            h01 h01Var3 = new h01(spannableStringBuilder2, 12.0f, null);
            Layout.Alignment alignment = Layout.Alignment.ALIGN_CENTER;
            h01Var3.a();
            h01Var3.n(5);
            Point point = AndroidUtilities.displaySize;
            h01Var3.q(Math.min(point.x, point.y) * 0.5f);
            h01Var3.s(this);
            this.f = h01Var3;
            this.J = this.f.j() + AndroidUtilities.dp(12.0f) + AndroidUtilities.dp(15.33f) + this.J;
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.commonChatsLoaded && ((Long) objArr[0]).longValue() == this.c) {
            ...
            if (bbVar == null || count <= 0) {
                ...
                bbVar.b = new h01(LocaleController.formatPluralString("Groups", count, new Object[0]), 12.0f, AndroidUtilities.bold());
                int min = Math.min(3, this.I.chats.size());
                org.telegram.ui.Components.h9 h9Var = this.G;
                h9Var.k(min);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f6Var != null) {
            f6Var.m(x10, f11, measuredWidth, i10);
        } else {
        ...
        h01 h01Var = this.d;
        h01Var.p = this.K - AndroidUtilities.dp(32.0f);
        h01Var.c(width - (this.d.l() / 2.0f), this.d.j() / 2.0f, 1.0f, -1, canvas);
        canvas.translate(0.0f, this.d.j() + AndroidUtilities.dp(3.0f));
        float j3 = dp + this.d.j() + AndroidUtilities.dp(3.0f);
        h01 h01Var2 = this.e;
        h01Var2.p = this.K - AndroidUtilities.dp(32.0f);
        h01Var2.c(width - (this.e.l() / 2.0f), this.e.j() / 2.0f, 0.7f, -1, canvas);
        ...
        while (true) {
            ...
            float f15 = dp2 - h01Var3.c;
            float dp3 = (width - (this.K / 2.0f)) + AndroidUtilities.dp(16.0f) + this.s + AndroidUtilities.dp(7.66f);
            h01Var3.p = (dp3 - f15) - AndroidUtilities.dp(7.66f);
            h01Var3.c(f15, h01Var3.j() / 2.0f, 0.7f, -1, canvas);
            ...
            h01 h01Var4 = bbVar.b;
            h01Var4.p = (((this.K / 2.0f) + width) - AndroidUtilities.dp(8.0f)) - dp3;
            h01Var4.c(dp3, bbVar.b.j() / 2.0f, 1.0f, -1, canvas);
            if (z10) {
                canvas.save();
        ...
        if (this.f != null) {
            ...
            h01 h01Var5 = this.f;
            if (h01Var5.f > 1) {
                h01Var5.c(width - (h01Var5.l() / 2.0f), 0.0f, 0.7f, -1, canvas);
            } else {
                h01Var5.p = this.K - AndroidUtilities.dp(32.0f);
                h01Var5.c(width - (this.f.l() / 2.0f), this.f.j() / 2.0f, 0.7f, -1, canvas);
            }
        }
        canvas.restore();
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (wcVar2.h) {
                ...
                if ((U instanceof bo) && (qjVar = ((bo) U).a1) != null) {
                    qjVar.e(true, false);
                }
            } else if (wcVar.h) {
