...
public class StickerSetNameCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLRPC.FLAG_30), View.MeasureSpec.makeMeasureSpec(this.empty ? 1 : AndroidUtilities.dp(27.0f), TLRPC.FLAG_30));
    }
