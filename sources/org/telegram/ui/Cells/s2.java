...
public final class s2 extends a0 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.C) {
            canvas2 = canvas;
            canvas2.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.f6.u0);
        } else {
            canvas2 = canvas;
        }
        if (this.s != null) {
        ...
        if (this.A) {
            a0.o(this.v, AndroidUtilities.dp(16.5f), org.telegram.ui.ActionBar.f6.f1);
            a0.o(this.v, AndroidUtilities.dp(16.5f), org.telegram.ui.ActionBar.f6.i1);
            org.telegram.ui.ActionBar.f6.f1.draw(canvas2);
            org.telegram.ui.ActionBar.f6.i1.draw(canvas2);
        }
        this.h.draw(canvas2);
    }
    ...
    */
    public final void onLayout(boolean z10, int i9, int i10, int i11, int i12) {
        ...
        if (z10) {
            ...
            TextPaint textPaint2 = org.telegram.ui.ActionBar.f6.B0[0];
            TextPaint textPaint3 = org.telegram.ui.ActionBar.f6.F0[0];
            this.A = false;
            TLRPC.RecentMeUrl recentMeUrl = this.f;
            if (recentMeUrl instanceof TLRPC.TL_recentMeUrlChat) {
                TLRPC.Chat chat = MessagesController.getInstance(i15).getChat(Long.valueOf(this.f.chat_id));
                ...
                str = chat.title;
                z8Var.k(i15, chat);
                imageReceiver.setForUserOrChat(chat, z8Var, this.f);
            } else if (recentMeUrl instanceof TLRPC.TL_recentMeUrlUser) {
                TLRPC.User user = MessagesController.getInstance(i15).getUser(Long.valueOf(this.f.user_id));
                if (LocaleController.isRTL) {
                    this.r = AndroidUtilities.dp(14.0f);
                } else {
                ...
                z8Var.m(i15, user);
                imageReceiver.setForUserOrChat(user, z8Var, this.f);
                ...
                z8Var.n(5L, str2, null);
                imageReceiver.setImage(ImageLocation.getForDocument(this.f.set.cover), null, z8Var, null, this.f, 0);
                str = str2;
                ...
                if (chat2 != null) {
                    ...
                    imageReceiver.setForUserOrChat(chat3, z8Var, recentMeUrl2);
                    str = str3;
                } else {
                    String str4 = chatInvite.title;
                    z8Var.n(5L, str4, null);
                    imageReceiver.setImage(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(this.f.chat_invite.photo.sizes, 50), this.f.chat_invite.photo), "50_50", z8Var, null, this.f, 0);
                    str = str4;
                }
                if (LocaleController.isRTL) {
                    getMeasuredWidth();
                ...
                imageReceiver.setImage(null, null, z8Var, null, this.f, 0);
                str = "Url";
            } else {
                imageReceiver.setImage(null, null, z8Var, null, recentMeUrl, 0);
                str = "";
            }
            String str5 = MessagesController.getInstance(i15).linkPrefix + "/" + this.f.url;
            ...
            int i16 = measuredWidth - dp;
            if (this.A) {
                int intrinsicWidth = org.telegram.ui.ActionBar.f6.f1.getIntrinsicWidth() + AndroidUtilities.dp(6.0f);
                i16 -= intrinsicWidth;
                if (LocaleController.isRTL) {
            ...
            if (LocaleController.isRTL) {
                ...
                if (staticLayout != null && staticLayout.getLineCount() > 0) {
                    ...
                    if (this.A) {
                        this.v = (int) ((((i13 - ceil) + this.r) - AndroidUtilities.dp(6.0f)) - org.telegram.ui.ActionBar.f6.f1.getIntrinsicWidth());
                    }
                    if (lineLeft == 0.0f) {
                        double d = i13;
                        if (ceil < d) {
            ...
            if (staticLayout4 == null || staticLayout4.getLineCount() <= 0 || this.y.getLineRight(0) != i14) {
                return;
            }
            double ceil4 = Math.ceil(this.y.getLineWidth(0));
            double d11 = i14;
            if (ceil4 < d11) {
                this.x = (int) (this.x - (d11 - ceil4));
            }
        }
    }
