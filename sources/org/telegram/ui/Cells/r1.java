...
public final class r1 {
    ...
    */
    public final boolean f() {
        ...
        if (arrayList2 != arrayList3) {
            ...
            if (arrayList2 != null && arrayList3 != null && arrayList2.size() == this.I0.size()) {
                for (int i14 = 0; i14 < this.I0.size(); i14++) {
                    String charSequence = s1Var.v7.textLayoutBlocks.get(i14).textLayout == null ? null : s1Var.v7.textLayoutBlocks.get(i14).textLayout.getText().toString();
                    ...
                    if ((charSequence != null || charSequence2 == null) && ((charSequence == null || charSequence2 != null) && charSequence.equals(charSequence2))) {
                        org.telegram.ui.Components.q5 q5Var = s1Var.mc;
                        if (q5Var != null) {
                            StaticLayout staticLayout2 = s1Var.v7.textLayoutBlocks.get(i14).textLayout;
                ...
                if (z15) {
                    ...
                    this.H0 = arrayList5;
                    this.N0 = this.o2;
                    this.O0 = org.telegram.ui.Components.u5.update(0, (View) s1Var, this.O0, (ArrayList<MessageObject.TextLayoutBlock>) arrayList5, true);
                    s1Var.mc = org.telegram.ui.Components.u5.update(0, s1Var, s1Var.mc, s1Var.v7.textLayoutBlocks);
                    z4 = true;
                } else {
                    s1Var.mc = org.telegram.ui.Components.u5.update(0, s1Var, s1Var.mc, s1Var.v7.textLayoutBlocks);
                }
        ...
        RichMessageLayout richMessageLayout2 = s1Var.v7.richLayout;
        ...
        if (richMessageLayout2 != this.M0) {
            mj0 mj0Var = s1Var.ee;
            boolean z16 = mj0Var != null && mj0Var.h;
            ...
            if (z16) {
                RichMessageLayout richMessageLayout4 = s1Var.v7.richLayout;
        ...
        StaticLayout staticLayout4 = s1Var.A9;
        if (staticLayout4 != this.E2) {
            ...
            if (!TextUtils.equals(text, staticLayout5 != null ? staticLayout5.getText() : null)) {
                ...
                this.J2 = this.I2;
                this.S0 = org.telegram.ui.Components.u5.update(0, (View) s1Var, false, this.S0, true, staticLayout6);
                z4 = true;
            }
        }
        boolean z17 = s1Var.Xc;
        if (z17 && !this.Z0 && s1Var.lb != null) {
            String string = LocaleController.getString("EditedMessage", R.string.EditedMessage);
            CharSequence text2 = s1Var.lb.getText();
            int indexOf = text2.toString().indexOf(string);
            if (indexOf >= 0) {
                if (indexOf == 0) {
                    TextPaint textPaint = org.telegram.ui.ActionBar.j6.T2;
                    int dp = AndroidUtilities.dp(100.0f) + s1Var.nb;
                    ...
                    this.V0 = new StaticLayout(spannableStringBuilder, org.telegram.ui.ActionBar.j6.T2, AndroidUtilities.dp(100.0f) + s1Var.nb, alignment, 1.0f, 0.0f, false);
                    this.Y0 = s1Var.mb - this.X0;
                } else {
                    this.Y0 = 0;
                    this.U0 = null;
                    this.V0 = this.i2;
            ...
            s1Var.z3 = null;
        } else if (!z17 && this.Z0 && s1Var.lb != null) {
            this.V0 = this.i2;
            int i16 = s1Var.mb;
            int i17 = this.X0;
            this.Y0 = i16 - i17;
        ...
        this.z1 = false;
        if ((s1Var.U != null) != this.z) {
            this.z1 = true;
            z4 = true;
        }
        this.L2 = false;
        if ((s1Var.v7.type == 27 && (o0Var = s1Var.v) != null && o0Var.d()) != this.K2) {
            this.L2 = true;
            z4 = true;
        }
        this.D1 = false;
        ...
        MessageObject.TextLayoutBlocks textLayoutBlocks = s1Var.Z3;
        ...
        if (textLayoutBlocks != textLayoutBlocks2) {
            ...
            MessageObject.TextLayoutBlocks textLayoutBlocks3 = s1Var.Z3;
            String charSequence4 = textLayoutBlocks3 == null ? null : textLayoutBlocks3.text.toString();
            if (this.E0 != s1Var.D8 || this.d1 != z18) {
                MessageObject.TextLayoutBlocks textLayoutBlocks4 = s1Var.Z3;
            ...
            if ((charSequence4 == null) == (charSequence3 == null) && (charSequence3 == null || charSequence3.equals(charSequence4))) {
                s1Var.n4();
                float f13 = this.e;
                if (f13 != s1Var.m4 || this.f != s1Var.n4) {
                    this.s0 = true;
                    this.q0 = f13;
                    this.r0 = this.f;
                    z4 = true;
            ...
            this.O0 = org.telegram.ui.Components.u5.update(0, s1Var, (org.telegram.ui.Components.q5) null, textLayoutBlocks6 == null ? null : textLayoutBlocks6.textLayoutBlocks);
            org.telegram.ui.Components.q5 q5Var2 = s1Var.mc;
            MessageObject.TextLayoutBlocks textLayoutBlocks7 = s1Var.Z3;
            s1Var.mc = org.telegram.ui.Components.u5.update(0, s1Var, q5Var2, textLayoutBlocks7 == null ? null : textLayoutBlocks7.textLayoutBlocks);
            if (this.E0 != s1Var.D8 || this.d1 != z18) {
                this.s0 = true;
                this.q0 = this.e;
                this.r0 = this.f;
            ...
            s1Var.n4();
            float f14 = this.e;
            if (f14 != s1Var.m4 || this.f != s1Var.n4) {
                this.s0 = true;
                this.q0 = f14;
                this.r0 = this.f;
                z4 = true;
        ...
        if ((this.G != null || s1Var.Sb != null) && this.E != s1Var.getRepliesCount()) {
            this.H = this.G;
            this.F = true;
            s1Var.z3 = null;
            z10 = true;
        ...
        if (s1Var.W8 != null && this.M != s1Var.getRepliesCount()) {
            StaticLayout staticLayout7 = this.T;
            if (staticLayout7 == null || TextUtils.equals(staticLayout7.getText(), s1Var.W8.getText())) {
                this.V = null;
            } else {
                this.V = this.T;
            }
        ...
        if (!TextUtils.equals(this.e0, s1Var.c7)) {
            this.c0 = true;
            this.d0 = s1Var.Ta;
            z4 = true;
        }
        if (this.e1 == s1Var.sb) {
            ...
            if (this.e2 == s1Var.f4()) {
                if (z10 || (Math.abs(s1Var.ob - this.f1) > 1 && this.E0 == s1Var.D8)) {
                    this.h1 = true;
                    this.W0 = this.X0;
                    this.g1 = this.f1;
                    this.K = this.L;
                ...
                if (messageObject2 != null || this.w2 == messageObject2.needDrawForwarded()) {
                    ...
                    if (s1Var.v7.isRoundVideo()) {
                        float dp2 = s1Var.J8 - AndroidUtilities.dp(28 - (s1Var.G ? 2 : 0));
                        if (!r0Var.s) {
                            dp2 -= r0Var.p;
                        }
                        float f17 = this.q;
                    ...
                    if ((messageObject3 == null && messageObject3.translated) != this.i3 || s1Var.G2 == null || (staticLayout = this.j3) == null) {
                        return z4;
                    }
                    this.k3 = staticLayout;
                    this.l3 = org.telegram.ui.Components.u5.update(0, (View) s1Var, false, this.l3, staticLayout);
                    return true;
                }
                this.t2 = true;
    ...
    */
    public final int g() {
        ...
        s1 s1Var = this.m3;
        boolean z11 = true;
        if (!s1Var.v7.isOutOwner()) {
            if (!s1Var.v7.isSending() && !s1Var.v7.isEditing()) {
                z11 = false;
            }
            return (z11 ? 4 : 0) | (s1Var.v7.isSendError() ? 8 : 0);
        }
        if (s1Var.v7.isSending() || s1Var.v7.isEditing()) {
            i10 = 0;
            z11 = false;
    ...
    public final void h() {
        ...
        org.telegram.ui.ActionBar.g5 g5Var = s1Var.q8;
        if (g5Var != null) {
        ...
        org.telegram.ui.ActionBar.g5 g5Var2 = s1Var.q8;
        if (g5Var2 != null) {
    ...
    public final void i() {
        ...
        staticLayoutArr2[0] = staticLayout;
        staticLayoutArr2[1] = staticLayoutArr[1];
        this.w2 = s1Var.v7.needDrawForwarded();
        this.A2 = s1Var.fb;
        int i10 = s1Var.Ic;
        this.v2 = i10;
        this.H2 = i10;
    ...
    public final void j() {
        ...
        this.C0 = false;
        this.b1 = null;
        org.telegram.ui.Components.u5.release(s1Var, this.O0);
        this.O0 = null;
        this.s0 = false;
        this.J1 = false;
        this.M1.clear();
        ...
        this.k3 = null;
        org.telegram.ui.Components.u5.release(s1Var, this.l3);
    }
}
