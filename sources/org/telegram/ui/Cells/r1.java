...
public final class r1 {
    ...
    */
    public final boolean f() {
            ...
            if (arrayList2 != null && arrayList3 != null && arrayList2.size() == this.I0.size()) {
                for (int i14 = 0; i14 < this.I0.size(); i14++) {
                    ...
                    if ((charSequence != null || charSequence2 == null) && ((charSequence == null || charSequence2 != null) && charSequence.equals(charSequence2))) {
                        org.telegram.ui.Components.u5 u5Var = s1Var.lc;
                        if (u5Var != null) {
                ...
                if (z16) {
                    ...
                    this.H0 = arrayList5;
                    this.N0 = this.o2;
                    this.O0 = org.telegram.ui.Components.y5.update(0, (View) s1Var, this.O0, (ArrayList<MessageObject.TextLayoutBlock>) arrayList5, true);
                    s1Var.lc = org.telegram.ui.Components.y5.update(0, s1Var, s1Var.lc, s1Var.u7.textLayoutBlocks);
                    z10 = true;
                } else {
                    s1Var.lc = org.telegram.ui.Components.y5.update(0, s1Var, s1Var.lc, s1Var.u7.textLayoutBlocks);
                }
        ...
        if (richMessageLayout2 != this.M0) {
            cj0 cj0Var = s1Var.de;
            boolean z17 = cj0Var != null && cj0Var.h;
        ...
        if (staticLayout4 != this.E2) {
            ...
            if (!TextUtils.equals(text, staticLayout5 != null ? staticLayout5.getText() : null)) {
                ...
                this.J2 = this.I2;
                this.S0 = org.telegram.ui.Components.y5.update(0, (View) s1Var, false, this.S0, true, staticLayout6);
                z10 = true;
            }
        }
        ...
        if (z18 && !this.Z0 && s1Var.kb != null) {
            ...
            if (indexOf >= 0) {
                if (indexOf == 0) {
                    ...
                    spannableStringBuilder.setSpan(new gz(z13), 0, string.length(), 0);
        ...
        if (textLayoutBlocks != textLayoutBlocks2) {
            ...
            if ((charSequence4 == null) == (charSequence3 == null) && (charSequence3 == null || charSequence3.equals(charSequence4))) {
                s1Var.n4();
                float f12 = this.e;
                if (f12 != s1Var.l4 || this.f != s1Var.m4) {
                    this.s0 = true;
                    this.q0 = f12;
                    this.r0 = this.f;
                    z10 = true;
            ...
            this.O0 = org.telegram.ui.Components.y5.update(0, s1Var, (org.telegram.ui.Components.u5) null, textLayoutBlocks6 == null ? null : textLayoutBlocks6.textLayoutBlocks);
            org.telegram.ui.Components.u5 u5Var2 = s1Var.lc;
            MessageObject.TextLayoutBlocks textLayoutBlocks7 = s1Var.Y3;
            s1Var.lc = org.telegram.ui.Components.y5.update(0, s1Var, u5Var2, textLayoutBlocks7 == null ? null : textLayoutBlocks7.textLayoutBlocks);
            if (this.E0 != s1Var.C8 || this.d1 != z19) {
                this.s0 = true;
                this.q0 = this.e;
                this.r0 = this.f;
        ...
        if (this.e1 == s1Var.rb) {
            ...
            if (this.e2 == s1Var.f4()) {
                ...
                if (messageObject2 != null || this.w2 == messageObject2.needDrawForwarded()) {
                    ...
                    this.l3 = org.telegram.ui.Components.y5.update(0, (View) s1Var, false, this.l3, staticLayout);
                    return true;
                }
                this.t2 = true;
    ...
    */
    ...
    public final void h() {
        ...
        this.a = x2Var.getImageX();
        this.b = x2Var.getImageY();
        this.c = x2Var.getImageWidth();
        this.d = x2Var.getImageHeight();
        System.arraycopy(x2Var.getRoundRadius(), 0, this.t0, 0, 4);
    ...
    public final void j() {
        ...
        if (this.f0) {
            ...
            if (f9 != 0.0f) {
                float f10 = this.p0;
                if (f10 != 0.0f) {
                    x2Var.setImageCoords(this.m0, this.n0, f9, f10);
                }
            }
        }
        if (this.B0) {
            x2Var.setRoundRadius(this.A0);
        }
        this.m0 = 0.0f;
        this.n0 = 0.0f;
        this.o0 = 0.0f;
        ...
        this.C0 = false;
        this.b1 = null;
        org.telegram.ui.Components.y5.release(s1Var, this.O0);
        this.O0 = null;
        this.s0 = false;
        this.J1 = false;
        this.M1.clear();
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            ((kg.o0) arrayList.get(i11)).c = 0;
        }
        this.k3 = null;
        org.telegram.ui.Components.y5.release(s1Var, this.l3);
    }
}
