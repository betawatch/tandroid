...
public class j7 extends FrameLayout implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b(Canvas canvas) {
        ...
        if (this.U == 1) {
            this.a0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.A6, e6Var));
        }
        ...
        if (this.M != null) {
            this.b0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, e6Var));
            canvas.save();
        ...
        if (this.H != null) {
            org.telegram.ui.ActionBar.j6.g3.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, e6Var));
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(this.d ? org.telegram.ui.ActionBar.j6.jd : org.telegram.ui.ActionBar.j6.id, e6Var);
        RadialProgress2 radialProgress2 = this.T;
        ...
        if (this.c) {
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getHeight() - 1, (getWidth() - AndroidUtilities.dp(72.0f)) - getPaddingRight(), getHeight() - 1, org.telegram.ui.ActionBar.j6.T0("paintDivider", e6Var));
            } else {
                canvas.drawLine(AndroidUtilities.dp(72.0f), getHeight() - 1, getWidth() - getPaddingRight(), getHeight() - 1, org.telegram.ui.ActionBar.j6.T0("paintDivider", e6Var));
            }
        }
    }
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        if (i13 == 1) {
            ...
            this.V = u1.u2(stringForMessageListDate, textPaint2, ceil, ceil, 0, 1);
        ...
        if (i13 == 1) {
            ...
            if (i13 == 1) {
                ...
                setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(56.0f) + (this.M != null ? AndroidUtilities.dp(18.0f) : 0) + (this.c ? 1 : 0));
                int C = LocaleController.isRTL ? org.telegram.messenger.q.C(8.0f, View.MeasureSpec.getSize(i10), AndroidUtilities.dp(52.0f)) : AndroidUtilities.dp(8.0f);
                int dp3 = AndroidUtilities.dp(f7) + C;
                this.h = dp3;
                int dp22 = AndroidUtilities.dp(6.0f);
                this.n = dp22;
                this.T.q(dp3, dp22, AndroidUtilities.dp(48.0f) + C, AndroidUtilities.dp(50.0f));
                measureChildWithMargins(this.b, i10, 0, i11, 0);
                if (this.M == null) {
            ...
            int dp32 = AndroidUtilities.dp(f7) + C;
            this.h = dp32;
            int dp222 = AndroidUtilities.dp(6.0f);
            this.n = dp222;
            this.T.q(dp32, dp222, AndroidUtilities.dp(48.0f) + C, AndroidUtilities.dp(50.0f));
            measureChildWithMargins(this.b, i10, 0, i11, 0);
            if (this.M == null) {
            }
        }
        ...
        int dp322 = AndroidUtilities.dp(f7) + C;
        this.h = dp322;
        int dp2222 = AndroidUtilities.dp(6.0f);
        this.n = dp2222;
        this.T.q(dp322, dp2222, AndroidUtilities.dp(48.0f) + C, AndroidUtilities.dp(50.0f));
        measureChildWithMargins(this.b, i10, 0, i11, 0);
        if (this.M == null) {
        }
    }
    ...
    */
    ...
    public j7(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        addView(npVar, w7.y5.d(24, 24.0f, (z10 ? 5 : 3) | 48, z10 ? 0.0f : 38.1f, 32.1f, z10 ? 6.0f : 0.0f, 0.0f));
        if (i10 == 1) {
        ...
        if (e6Var != null) {
            ...
            textPaint3.setColor(e6Var.G0(org.telegram.ui.ActionBar.j6.G6));
        }
    }
