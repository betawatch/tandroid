...
public final class k5 extends org.telegram.ui.Components.w9 implements DownloadController.FileDownloadProgressListener {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.Q;
        sd1 sd1Var = this.T;
        float f7 = sd1Var.a.d.l1;
        this.a.setBlendMode(null);
        vd1 vd1Var4 = sd1Var.a.d;
        if (vd1Var4.b == 2) {
            i10 = vd1Var4.Z0;
        } else {
            ...
            if (i10 == 0) {
                    ...
                    if (i12 == 0) {
                        ...
                        if (vd1Var2.b == 2) {
                            ...
                            if (i14 == 0) {
                                ...
                                vd1 vd1Var5 = sd1Var.a.d;
                                int i17 = vd1Var5.b != 2 ? vd1Var5.h1 : vd1Var5.s.n;
                                int i18 = vd1Var5.k1;
                                if (i13 != 0) {
                                    this.K = null;
                                    this.R = null;
                                    ...
                                    if (i15 != 0) {
                                        ...
                                        if (f7 < 0.0f) {
                                            ...
                                            if (Build.VERSION.SDK_INT >= 29) {
                                                ...
                                                this.a.setColorFilter(new PorterDuffColorFilter(sd1Var.a.d.j1, PorterDuff.Mode.SRC_IN));
                                            }
                                        }
                                    } else {
                        ...
                        vd1 vd1Var52 = sd1Var.a.d;
                        if (vd1Var52.b != 2) {
                        }
                        int i182 = vd1Var52.k1;
                        if (i13 != 0) {
                        }
                        lc0Var = this.R;
                        if (lc0Var == null) {
                ...
                vd1 vd1Var522 = sd1Var.a.d;
                if (vd1Var522.b != 2) {
                }
                int i1822 = vd1Var522.k1;
                if (i13 != 0) {
                }
                lc0Var = this.R;
                if (lc0Var == null) {
        ...
        vd1 vd1Var5222 = sd1Var.a.d;
        if (vd1Var5222.b != 2) {
        }
        int i18222 = vd1Var5222.k1;
        if (i13 != 0) {
        }
        lc0Var = this.R;
        if (lc0Var == null) {
