...
public abstract class TextSelectionHelper {
    ...
    */
            ...
            if (this.popupLayout == null) {
                ...
                this.popupLayout.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Cells.TextSelectionHelper$$ExternalSyntheticLambda10
                    ...
                    public final boolean onTouch(View view, MotionEvent motionEvent) {
                        ...
                        lambda$showActions$2 = TextSelectionHelper.this.lambda$showActions$2(view, motionEvent);
                        return lambda$showActions$2;
                    }
                });
                ...
                if (canCut()) {
                    ...
                    textView3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Cells.TextSelectionHelper$$ExternalSyntheticLambda12
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            TextSelectionHelper.this.lambda$showActions$4(view);
                        }
                    });
                ...
                if (canPaste()) {
                    ...
                    textView4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Cells.TextSelectionHelper$$ExternalSyntheticLambda13
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            TextSelectionHelper.this.lambda$showActions$5(view);
                        }
                    });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showActions$5(View view) {
        onPasteAction();
        hideActions();
    }
    ...
    class 4 implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            menu.add(0, android.R.id.cut, 4, android.R.string.cut);
            menu.add(0, android.R.id.paste, 5, android.R.string.paste);
            return true;
        }
        ...
        public boolean onPrepareActionMode(ActionMode actionMode, final Menu menu) {
            ...
            if (findItem2 != null) {
                findItem2.setVisible(TextSelectionHelper.this.canCut());
            }
    ...
    */
    ...
    public static class ChatListTextSelectionHelper extends TextSelectionHelper {
        ...
        private void fillLayoutForCoords(int i, int i2, ChatMessageCell chatMessageCell, LayoutBlock layoutBlock, boolean z) {
            ...
            if (!z ? this.isRich : this.maybeIsRich) {
                ...
                while (true) {
                    if (i5 >= richMessageLayout.textBlocks.size()) {
                        break;
                    }
                    TextLayoutBlock textLayoutBlock = richMessageLayout.textBlocks.get(i5);
                    int y = textLayoutBlock.getY();
                    int height = textLayoutBlock.getLayout().getHeight() + y;
                    if (i2 >= y && i2 < height) {
                        int x = textLayoutBlock.getX();
                        int width = textLayoutBlock.getLayout().getWidth() + x;
                        if (i >= x && i < width) {
                            i4 = i5;
                            break;
                        }
                        int min = Math.min(Math.abs(i - x), Math.abs(i - width));
                        if (min < i6) {
                            i4 = i5;
                            i6 = min;
                        }
                ...
                if (i4 < 0) {
                    int i7 = 0;
                    while (r2 < richMessageLayout.textBlocks.size()) {
                        TextLayoutBlock textLayoutBlock2 = richMessageLayout.textBlocks.get(r2);
                ...
                layoutBlock.layout = richMessageLayout.textBlocks.get(i4).getLayout();
                layoutBlock.yOffset = r9.getY();
                layoutBlock.xOffset = r9.getX();
                layoutBlock.charOffset = richMessageLayout.textBlockCharOffsets.get(i4).intValue();
                return;
            }
            if (chatMessageCell.hasCaptionLayout()) {
                MessageObject.TextLayoutBlocks captionLayout = chatMessageCell.getCaptionLayout();
                for (int i8 = 0; i8 < captionLayout.textLayoutBlocks.size(); i8++) {
                    MessageObject.TextLayoutBlock textLayoutBlock3 = captionLayout.textLayoutBlocks.get(i8);
                    float f = i2;
            ...
            for (int i3 = 0; i3 < richMessageLayout.textBlocks.size(); i3++) {
                ...
                if (layout != null && layout.getText() != null) {
                    ...
                    if (clamp != clamp2) {
                        ...
                        drawSelection(canvas, layout, clamp, clamp2, z, z2, 0.0f);
                        canvas.restore();
                    }
                }
            }
    ...
    public static class ArticleTextSelectionHelper extends TextSelectionHelper {
            ...
            if (replaceCopyTextSpannableArr != null && replaceCopyTextSpannableArr.length > 0) {
                Arrays.sort(replaceCopyTextSpannableArr, new Comparator() { // from class: org.telegram.ui.Cells.TextSelectionHelper$ArticleTextSelectionHelper$$ExternalSyntheticLambda0
                    ...
                    public final int compare(Object obj, Object obj2) {
                        int lambda$getSelectedText$0;
                        lambda$getSelectedText$0 = TextSelectionHelper.ArticleTextSelectionHelper.lambda$getSelectedText$0(spannableStringBuilder, (TextSelectionHelper.ReplaceCopyTextSpannable) obj, (TextSelectionHelper.ReplaceCopyTextSpannable) obj2);
                        return lambda$getSelectedText$0;
                    }
                });
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ int lambda$getSelectedText$0(SpannableStringBuilder spannableStringBuilder, ReplaceCopyTextSpannable replaceCopyTextSpannable, ReplaceCopyTextSpannable replaceCopyTextSpannable2) {
