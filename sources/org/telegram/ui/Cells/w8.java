...
public final class w8 extends FrameLayout {
    ...
    public w8(Context context) {
        ...
        addView(textView, w7.a6.d(-2, -1.0f, (z10 ? 5 : 3) | 48, z10 ? 64.0f : 21.0f, 0.0f, z10 ? 21.0f : 64.0f, 0.0f));
        TextView textView2 = new TextView(context);
        this.c = textView2;
        em.n(org.telegram.ui.ActionBar.j6.z6, null, textView2, 1, 13.0f);
        ...
        addView(textView2, w7.a6.d(-2, -2.0f, (z11 ? 5 : 3) | 48, z11 ? 64.0f : 21.0f, 35.0f, z11 ? 21.0f : 64.0f, 0.0f));
    ...
    public final void a(Runnable runnable, String str, boolean z10) {
        if (this.f == null) {
            ...
            this.f.addView(this.h, w7.a6.c(20.0f, -2));
            ...
            this.f.addView(this.n, w7.a6.q(16, 16, 16));
            this.f.setClipChildren(false);
            setClipChildren(false);
            addView(this.f, w7.a6.e(-2, -2, 16));
            qn qnVar = new qn(getContext(), 8);
            this.r = qnVar;
            qnVar.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.i6, false), 2, -1));
            addView(this.r, w7.a6.e(76, -1, LocaleController.isRTL ? 3 : 5));
        }
        this.h.setText(str);
        this.n.animate().cancel();
        this.n.animate().rotation(z10 ? 0.0f : 180.0f).setDuration(340L).setInterpolator(wr.h).start();
