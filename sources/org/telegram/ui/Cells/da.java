...
public final class da extends View {
    ...
    public final boolean b(MotionEvent motionEvent) {
        ...
        if (eaVar.y() && !eaVar.i) {
            ...
            } else if (action == 1 && System.currentTimeMillis() - this.d < 200 && v7.z6.b((int) this.b, (int) this.c, (int) motionEvent.getX(), (int) motionEvent.getY()) < eaVar.m) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (eaVar.y()) {
            ...
            if (z9Var != null) {
                ...
                z9 z9Var2 = eaVar.W;
                MessageObject messageObject = z9Var2 instanceof t1 ? ((t1) z9Var2).getMessageObject() : null;
                if (messageObject == null || !messageObject.isOutOwner()) {
                    paint.setColor(eaVar.u(org.telegram.ui.ActionBar.h6.vf));
                } else {
