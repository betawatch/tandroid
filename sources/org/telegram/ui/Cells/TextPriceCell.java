...
public class TextPriceCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth / 2, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), TLObject.FLAG_30));
        this.textView.measure(View.MeasureSpec.makeMeasureSpec((measuredWidth - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.dp(8.0f), TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), TLObject.FLAG_30));
    }
