...
public class g7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public g7(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        qr qrVar = qr.h;
        this.E = new org.telegram.ui.Components.e6(this, 0L, 350L, qrVar);
        this.G = new org.telegram.ui.Components.e6(this, 0L, 350L, qrVar);
        this.K = new Paint();
        this.y = e6Var;
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(this.F ? org.telegram.ui.ActionBar.j6.C6 : org.telegram.ui.ActionBar.j6.j5, e6Var));
        ...
        this.c = j5Var;
        j5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.j5, e6Var));
        ...
        npVar.setProgressDelegate(new la(this, 5));
        addView(npVar, w7.y5.d(24, 24.0f, 49, 19.0f, i10 == 2 ? -40.0f : 42.0f, 0.0f, 0.0f));
        setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, e6Var), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f)));
    }
    ...
    public final void c(long j3, boolean z10, CharSequence charSequence) {
        ...
        if (j3 == Long.MAX_VALUE) {
            p4Var.setText(a());
            if (this.f == null) {
                this.f = new f7(getContext(), w9Var, true, e6Var);
            }
        ...
        if (view == w9Var && this.n != 2 && (user = this.h) != null && !MessagesController.isSupportUser(user)) {
            ...
            if (e > 0.0f) {
                ...
                if (this.M != null) {
                    ...
                    int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.h5, e6Var2);
                    Paint paint = this.K;
                    paint.setColor(v02);
                    canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, paint);
                    rectF.inset(AndroidUtilities.dp(1.33f), AndroidUtilities.dp(1.33f));
                    paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.B5, e6Var2));
                    canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, paint);
                    v01Var = this.M;
                    if (v01Var == null) {
                        e6Var = e6Var2;
                ...
                this.M = new v01(yh.v7.R0(sb2.toString(), 0.65f, null), 9.33f, AndroidUtilities.bold());
                v01 v01Var22 = this.M;
                ...
                int v022 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.h5, e6Var2);
                Paint paint2 = this.K;
                paint2.setColor(v022);
                canvas.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, paint2);
                rectF2.inset(AndroidUtilities.dp(1.33f), AndroidUtilities.dp(1.33f));
                paint2.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.B5, e6Var2));
                canvas.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, paint2);
                v01Var = this.M;
                if (v01Var == null) {
                }
            ...
            if (e7 > f7) {
                ...
                canvas.save();
                org.telegram.ui.ActionBar.j6.t0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.d6, e6Var));
                float f14 = right;
                float f15 = bottom;
                ...
                if (!user2.self && !user2.bot) {
                    ...
                    if ((userStatus != null && userStatus.expires > ConnectionsManager.getInstance(i10).getCurrentTime()) || MessagesController.getInstance(i10).onlinePrivacy.containsKey(Long.valueOf(this.h.id))) {
                        ...
                        if (!z10 || this.r != f7) {
                            ...
                            org.telegram.ui.ActionBar.j6.t0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.T8, e6Var));
