...
public final class j6 extends a0 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.z5 {
    ...
    public j6(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.m0 = new org.telegram.ui.Components.d6(this, 0L, 350L, qr.h);
        qr qrVar = qr.f;
    ...
    */
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.k0) {
            sb2.append(", ");
            c1.o(R.string.AccDescrVerified, "\n", sb2);
        }
        if (this.r0 != null) {
            if (sb2.length() > 0) {
                sb2.append(", ");
    ...
    */
    ...
    public final void r() {
        ...
        if (TextUtils.isEmpty(replaceNewLines)) {
            ...
            replaceNewLines = (user3 == null || TextUtils.isEmpty(user3.phone)) ? LocaleController.getString(R.string.HiddenName) : rk.h(new StringBuilder("+"), this.y.phone, gf.b.c());
        }
        if (this.E0) {
            if (this.F0 == null) {
        ...
        if (this.G != null) {
            ...
            this.U = rk.x(32.0f, measureText, this.U);
        }
    ...
    */
                ...
                if (chatPhoto != null) {
                    ...
                    if (drawable4 != null) {
                        ...
                        if (chat.monoforum) {
                            ...
                            ng.d.n(i12, chat, g9Var, imageReceiver);
                        }
                        fileLocation3 = fileLocation;
                    }
                }
    ...
    public final void v(boolean z10, TLRPC.User user, TLRPC.Chat chat, boolean z11) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.w;
        if (z13 && z10) {
            n5Var.g(new pq(org.telegram.ui.ActionBar.j6.f1, org.telegram.ui.ActionBar.j6.i1, 0, 0), z11);
            n5Var.k(null);
