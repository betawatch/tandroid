...
public final class j6 extends a0 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.a6 {
    ...
    public final org.telegram.ui.Components.n5 s0;
    public final org.telegram.ui.Components.n5 t0;
    public final zh.x5 u0;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            Paint F = (!this.E0 || f6Var == null) ? null : f6Var.F("paintDivider");
            if (F == null) {
        ...
        if (staticLayout != null) {
            ...
            org.telegram.ui.Components.n5 n5Var = this.s0;
            if (z11) {
                ceil = (int) (staticLayout.getLineRight(0) + this.O + AndroidUtilities.dp(6.0f));
            } else if (staticLayout.getLineLeft(0) == 0.0f) {
                ceil = (this.O - AndroidUtilities.dp(3.0f)) - n5Var.s;
            } else {
                f12 = 6.0f;
                ceil = (int) ((((this.O + this.U) - Math.ceil(this.Q.getLineWidth(0))) - AndroidUtilities.dp(3.0f)) - n5Var.s);
                a0.p(n5Var, ceil, ((this.Q.getHeight() - n5Var.s) / 2.0f) + this.P);
                n5Var.draw(canvas2);
                canvas2.save();
                ...
                org.telegram.ui.Components.n5 n5Var2 = this.t0;
                a0.p(n5Var2, !z12 ? this.Q.getLineLeft(0) == 0.0f ? (this.O - AndroidUtilities.dp(3.0f)) - n5Var2.s : (int) ((((this.O + this.U) - Math.ceil(this.Q.getLineWidth(0))) - AndroidUtilities.dp(3.0f)) - n5Var2.s) : (int) (this.Q.getLineRight(0) + this.O + AndroidUtilities.dp(f12)), ((this.Q.getHeight() - n5Var2.s) / 2.0f) + this.P);
                n5Var2.draw(canvas2);
            }
            f12 = 6.0f;
            a0.p(n5Var, ceil, ((this.Q.getHeight() - n5Var.s) / 2.0f) + this.P);
            ...
            org.telegram.ui.Components.n5 n5Var22 = this.t0;
            a0.p(n5Var22, !z122 ? this.Q.getLineLeft(0) == 0.0f ? (this.O - AndroidUtilities.dp(3.0f)) - n5Var22.s : (int) ((((this.O + this.U) - Math.ceil(this.Q.getLineWidth(0))) - AndroidUtilities.dp(3.0f)) - n5Var22.s) : (int) (this.Q.getLineRight(0) + this.O + AndroidUtilities.dp(f12)), ((this.Q.getHeight() - n5Var22.s) / 2.0f) + this.P);
        ...
        if (this.x == null || this.w0 == null || this.x0 == null) {
            ...
            float dp3 = LocaleController.isRTL ? AndroidUtilities.dp(12.0f) : org.telegram.messenger.a2.B(12.0f, getWidth(), dp);
            int i10 = this.P;
            f7 = 2.0f;
            RectF rectF = this.v0;
        ...
        if (!z13) {
            ...
            if (chat == null || !chat.monoforum) {
                TLRPC.User user = this.y;
                if (user != null) {
                    zh.a6.h(user.id, canvas2, imageReceiver, x5Var);
                } else if (chat != null) {
                    if (ChatObject.isCommunity(chat)) {
                        Drawable drawable = org.telegram.ui.ActionBar.j6.S0;
                        RectF rectF5 = x5Var.F;
                        RectF rectF6 = x5Var.F;
                        xf.p.a(canvas2, drawable, rectF5.centerX(), rectF6.centerY(), rectF6.width());
                    }
                    zh.a6.h(-this.E.id, canvas2, imageReceiver, x5Var);
                } else {
                    imageReceiver.setImageCoords(x5Var.F);
                ...
                ze0 ze0Var = this.h;
                RectF rectF7 = x5Var.F;
                RectF rectF8 = x5Var.F;
                ze0Var.a((int) rectF7.centerX(), (int) rectF8.centerY(), (int) (rectF8.width() / f7));
                canvas2.save();
        ...
        if (e > 0.0f) {
            ...
            canvas2.drawCircle(centerX, centerY, AndroidUtilities.dp(11.33f) * e, org.telegram.ui.ActionBar.j6.t0);
            if (this.O0 == null) {
                this.O0 = new qg.c1(org.telegram.ui.ActionBar.j6.Lj, org.telegram.ui.ActionBar.j6.Mj, -1, -1, this.w);
            }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (((this.y == null && this.E == null) || !this.u0.a(motionEvent, this)) && ((edVar = this.V) == null || !edVar.b(motionEvent))) {
    ...
    public final void r() {
        ...
        if (chat3 != null) {
            ...
            if (chat3.monoforum) {
                ...
                if (chat4 != null) {
                    ...
                    spannableStringBuilder.setSpan(new g10(LocaleController.getString(R.string.MonoforumSpan), org.telegram.ui.ActionBar.j6.y6, f6Var), length, spannableStringBuilder.length(), 33);
        ...
        if (TextUtils.isEmpty(replaceNewLines)) {
            ...
            replaceNewLines = (user3 == null || TextUtils.isEmpty(user3.phone)) ? LocaleController.getString(R.string.HiddenName) : org.telegram.messenger.a2.j(new StringBuilder("+"), this.y.phone, gf.b.c());
        }
        if (this.E0) {
            if (this.F0 == null) {
    ...
    */
    public final void u(int i10) {
        ...
        ImageReceiver imageReceiver = this.r;
        int i12 = this.N;
        org.telegram.ui.Components.g9 g9Var = this.s;
        ...
        if (user3 != null) {
            ...
            if (chat != null) {
                ...
                if (chatPhoto != null) {
                    ...
                    if (drawable4 != null) {
                        ...
                        if (chat.monoforum) {
                            ...
                            mg.d.n(i12, chat, g9Var, imageReceiver);
                        }
                        fileLocation3 = fileLocation;
                    }
                }
                ...
                ContactsController.Contact contact = this.G;
                if (contact != null) {
                    g9Var.n(0L, contact.first_name, contact.last_name);
                    imageReceiver.setImage(null, null, g9Var, null, null, 0);
                } else {
                    g9Var.n(0L, null, null);
                    imageReceiver.setImage(null, null, g9Var, null, null, 0);
                }
            }
        }
        ...
        if (i10 != 0) {
            ...
            if ((!z10 && (MessagesController.UPDATE_MASK_NAME & i10) != 0 && this.y != null) || ((MessagesController.UPDATE_MASK_CHAT_NAME & i10) != 0 && this.E != null)) {
                if (this.y != null) {
                    ...
                    TLRPC.Chat chat3 = this.E;
                    i11 = chat3.monoforum ? mg.d.i(chat3, i12, false) : chat3.title;
                }
        ...
        if (user5 != null) {
            ...
            if (chat4 != null) {
                this.I = chat4.monoforum ? mg.d.i(chat4, i12, false) : chat4.title;
            }
        }
    ...
    public final void v(boolean z10, TLRPC.User user, TLRPC.Chat chat, boolean z11) {
        boolean z12 = LocaleController.isRTL;
        org.telegram.ui.Components.n5 n5Var = this.t0;
        n5Var.a = z12;
        boolean z13 = this.H0;
        org.telegram.ui.ActionBar.f6 f6Var = this.w;
        if (z13 && z10) {
            n5Var.g(new vq(org.telegram.ui.ActionBar.j6.f1, org.telegram.ui.ActionBar.j6.i1, 0, 0), z11);
            n5Var.k(null);
            ...
            n5Var.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z9, f6Var)));
        ...
        org.telegram.ui.Components.n5 n5Var2 = this.s0;
        if (botVerificationIcon == 0 || this.L) {
            n5Var2.g(null, z11);
        } else {
            n5Var2.j(botVerificationIcon, z11);
        }
        n5Var2.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z9, f6Var)));
    }
