...
public abstract class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            String str = NotificationCenter.suggestedFiltersLoaded + "_" + NotificationCenter.suggestedFiltersLoaded;
            ...
            if (obj instanceof TLRPC.TL_wallPaper) {
                ...
                TLRPC.PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.dp(NotificationCenter.suggestedFiltersLoaded));
            ...
            if (obj instanceof MediaController.SearchImage) {
                ...
                if (photo != null) {
                    ...
                    TLRPC.PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.dp(NotificationCenter.suggestedFiltersLoaded));
