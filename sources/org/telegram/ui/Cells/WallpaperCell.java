...
public abstract class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            String str = NotificationCenter.needDeleteDialog + "_" + NotificationCenter.needDeleteDialog;
            ...
            if (obj instanceof TLRPC.TL_wallPaper) {
                ...
                TLRPC.PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.dp(NotificationCenter.needDeleteDialog));
                ...
                if (colorWallpaper.path != null || colorWallpaper.pattern != null || "d".equals(colorWallpaper.slug)) {
                    ...
                    if ("d".equals(colorWallpaper.slug)) {
                        if (colorWallpaper.defaultCache == null) {
                            colorWallpaper.defaultCache = SvgHelper.getBitmap(R.raw.default_pattern, 100, NotificationCenter.needDeleteDialog, -16777216);
                        }
            ...
            if (obj instanceof MediaController.SearchImage) {
                ...
                if (photo != null) {
                    ...
                    TLRPC.PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.dp(NotificationCenter.needDeleteDialog));
