...
public final class l4 {
    ...
    public final void b(Canvas canvas) {
        ...
        boolean z10 = this.i;
        org.telegram.ui.Components.d6 d6Var = this.j;
        float e = d6Var.e(z10);
        float e7 = d6Var.e(this.i);
        u1 u1Var2 = this.a;
        ...
        while (true) {
            ...
            ImageReceiver imageReceiver = k4Var.f;
            ...
            float f19 = e7;
            u1 u1Var3 = u1Var2;
            imageReceiver.setImageCoords(i11 + i12, i13 + i14, k4Var.c - i12, k4Var.d - i14);
            ...
            if (f19 > 0.0f) {
                float min = Math.min(this.d + k4Var.a, f15);
                float min2 = Math.min(this.e + k4Var.b, f14);
                f17 = Math.max(this.d + k4Var.c, f17);
                f16 = Math.max(this.e + k4Var.d, f16);
                RectF rectF2 = AndroidUtilities.rectTmp;
                float f20 = k4Var.a + this.d;
                int i15 = this.e;
                rectF2.set(f20, k4Var.b + i15, r9 + k4Var.c, i15 + k4Var.d);
                path3.addRoundRect(rectF2, k4Var.s, Path.Direction.CW);
                f14 = min2;
                f15 = min;
            }
        ...
        while (true) {
            ...
            k4 k4Var2 = (k4) arrayList.get(i18);
            if (k4Var2.L != null) {
                float dp = AndroidUtilities.dp(11.4f) + k4Var2.L.c;
                float dp2 = AndroidUtilities.dp(17.0f);
                float dp3 = AndroidUtilities.dp(5.0f);
                float f24 = this.d + k4Var2.a + dp3;
                float f25 = this.e + k4Var2.b + dp3;
                ...
                if (this.r == null || rectF.right <= ((this.d + this.g) - (AndroidUtilities.dp(11.32f) + this.r.c)) - dp3 || rectF.top > this.e + dp3) {
                    ...
                    k4Var2.L.c(this.d + k4Var2.a + dp3 + AndroidUtilities.dp(5.66f), this.e + k4Var2.b + dp3 + f26, 1.0f, -1, canvas2);
                    canvas2.restore();
                    i18++;
                    f23 = f13;
                }
        ...
        if (this.q == null || f22 <= 0.0f) {
            ...
            float f30 = this.h;
            f12 = 17.0f;
            rectF.set(A, com.google.android.gms.internal.vision.e2.A(f30, dp5, 2.0f, f29), org.telegram.messenger.l0.a(f28, dp4, 2.0f, f27), org.telegram.messenger.l0.a(f30, dp5, 2.0f, f29));
            path.rewind();
            float f31 = dp5 / 2.0f;
    ...
    public final void c(Canvas canvas, float f7) {
        ...
        while (true) {
            ...
            k4 k4Var = (k4) arrayList.get(i14);
            if (k4Var.f.hasImageSet() && k4Var.f.getBitmap() != null) {
                i15 |= 1 << i14;
            }
            i14++;
        }
        ...
        if (bitmap == null || this.z != id2 || this.y != i15 || this.A != max || this.B != max2) {
            ...
            for (int i16 = 0; i16 < arrayList.size(); i16++) {
                k4 k4Var2 = (k4) arrayList.get(i16);
                k4Var2.f.setImageCoords(k4Var2.a, k4Var2.b, k4Var2.c - r4, k4Var2.d - r7);
                k4Var2.f.draw(canvas2);
            }
    ...
    public final k4 d(float f7, float f10) {
        ...
        while (true) {
            ...
            if (((k4) arrayList.get(i10)).f.isInsideImage(f7, f10)) {
        ...
        if (motionEvent.getAction() == 0) {
                    ...
                    if (k4Var != null && k4Var == d10) {
                        ...
                        if (u1Var.getDelegate() != null && motionEvent.getAction() == 1) {
                            ...
                            if (this.p || !z10 || d10.G.i.q != 3 || messageObject == null) {
                                ...
                                k4 k4Var2 = this.o;
                                ImageReceiver imageReceiver = k4Var2.f;
            ...
            if (k4Var != null) {
                ...
                if (u1Var.getDelegate() != null) {
                    ...
                    k4 k4Var22 = this.o;
                    ImageReceiver imageReceiver2 = k4Var22.f;
    ...
    */
    public final void g(MessageObject messageObject) {
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            if (l4Var.b == null) {
                j4 j4Var = new j4();
                j4Var.a = new ArrayList();
                j4Var.b = new ArrayList();
                j4Var.c = new HashMap();
                j4Var.h = 800;
                j4Var.i = 814.0f;
                l4Var.b = j4Var;
            ...
            l4Var.b.a.clear();
            l4Var.b.a.addAll(tL_messageMediaPaidMedia2.extended_media);
            j4 j4Var2 = l4Var.b;
            float f13 = j4Var2.i;
            ArrayList arrayList2 = j4Var2.b;
            arrayList2.clear();
            HashMap hashMap = j4Var2.c;
            hashMap.clear();
            j4Var2.e = 0;
            ArrayList arrayList3 = j4Var2.a;
            ...
            if (size == 0) {
                ...
                int min = (int) (dp2 / (Math.min(point.x, point.y) / j4Var2.h));
                ...
                if (size == 1) {
                            ...
                            if (size == 2) {
                                ...
                                if (sb3.equals("ww") && f19 > f18 * 1.4d) {
                                    ...
                                    if (f21 - f22 < 0.2d) {
                                        ...
                                        groupedMessagePosition4.set(0, 0, 0, 0, j4Var2.h, round, 7);
                                        groupedMessagePosition5.set(0, 0, 1, 1, j4Var2.h, round, 11);
                                    }
                                }
                                ...
                                if (sb2.charAt(0) == 'n') {
                                    ...
                                    float min4 = Math.min(f13 * 0.5f, Math.round((j4Var2.h * f27) / (groupedMessagePosition8.aspectRatio + f27)));
                                    float f28 = f13 - min4;
                                    int max2 = (int) Math.max(min, Math.min(j4Var2.h * 0.5f, Math.round(Math.min(groupedMessagePosition8.aspectRatio * min4, groupedMessagePosition7.aspectRatio * f28))));
                                    int round3 = Math.round(Math.min((groupedMessagePosition6.aspectRatio * f13) + i13, j4Var2.h - max2));
                                    ...
                                    float round4 = Math.round(Math.min(j4Var2.h / groupedMessagePosition6.aspectRatio, 0.66f * f13)) / f13;
                                    groupedMessagePosition6.set(0, 1, 0, 0, j4Var2.h, round4, 7);
                                    int i17 = j4Var2.h / 2;
                                    float f31 = i17;
                                ...
                                if (sb2.charAt(0) == 'w') {
                                    float round5 = Math.round(Math.min(j4Var2.h / groupedMessagePosition9.aspectRatio, f13 * 0.66f)) / f13;
                                    groupedMessagePosition9.set(0, 2, 0, 0, j4Var2.h, round5, 7);
                                    float round6 = Math.round(j4Var2.h / ((groupedMessagePosition10.aspectRatio + groupedMessagePosition11.aspectRatio) + groupedMessagePosition12.aspectRatio));
                                    float f33 = min;
                                    int max3 = (int) Math.max(f33, Math.min(j4Var2.h * 0.4f, groupedMessagePosition10.aspectRatio * round6));
                                    int max4 = (int) Math.max(Math.max(f33, j4Var2.h * 0.33f), groupedMessagePosition12.aspectRatio * round6);
                                    int i18 = (j4Var2.h - max3) - max4;
                                    ...
                                    int round7 = Math.round(Math.min((groupedMessagePosition9.aspectRatio * f13) + i13, j4Var2.h - max5));
                                    ...
                                    groupedMessagePosition11.spanSize = j4Var2.h;
                    ...
                    for (int i23 = 1; i23 < size2; i23++) {
                        int i24 = size2 - i23;
                        if (i23 <= 3 && i24 <= 3) {
                            float a2 = j4Var2.a(fArr2, 0, i23);
                            float a10 = j4Var2.a(fArr2, i23, size2);
                            i4 i4Var = new i4();
                            i4Var.a = new int[]{i23, i24};
                            i4Var.b = new float[]{a2, a10};
                            arrayList4.add(i4Var);
                        }
                    }
                    int i25 = 1;
                    while (i25 < size2 - 1) {
                            ...
                            if (i26 < i27) {
                                ...
                                if (i25 <= 3) {
                                    if (i26 <= (f19 < 0.85f ? 4 : 3) && i28 <= 3) {
                                        float a11 = j4Var2.a(fArr2, 0, i25);
                                        int i29 = i25 + i26;
                                        float a12 = j4Var2.a(fArr2, i25, i29);
                                        float a13 = j4Var2.a(fArr2, i29, size2);
                                        i4 i4Var2 = new i4();
                                        i4Var2.a = new int[]{i25, i26, i28};
                                        i11 = i25;
                                        i4Var2.b = new float[]{a11, a12, a13};
                                        arrayList4.add(i4Var2);
                                        i26++;
                                        i25 = i11;
                                    }
                                }
                                ...
                                while (true) {
                                    ...
                                    if (i33 < i34) {
                                        ...
                                        if (i30 > 3 || i31 > 3 || i33 > 3 || i35 > 3) {
                                            ...
                                            i10 = i32;
                                            float a14 = j4Var2.a(fArr2, 0, i30);
                                            int i36 = i30 + i31;
                                            float a15 = j4Var2.a(fArr2, i30, i36);
                                            int i37 = i36 + i33;
                                            float a16 = j4Var2.a(fArr2, i36, i37);
                                            float a17 = j4Var2.a(fArr2, i37, size2);
                                            i4 i4Var3 = new i4();
                                            i4Var3.a = new int[]{i30, i31, i33, i35};
                                            i4Var3.b = new float[]{a14, a15, a16, a17};
                                            arrayList4.add(i4Var3);
                                        }
                                        i33++;
                                        i32 = i10;
                                    }
                    ...
                    float f38 = (j4Var2.h / 3) * 4;
                    i4 i4Var4 = null;
                    float f39 = 0.0f;
                    int i38 = 0;
                    while (i38 < arrayList4.size()) {
                        i4 i4Var5 = (i4) arrayList4.get(i38);
                        float f40 = Float.MAX_VALUE;
                        float f41 = f38;
                        float f42 = 0.0f;
                        int i39 = 0;
                        while (true) {
                            float[] fArr3 = i4Var5.b;
                            fArr = fArr2;
                            if (i39 >= fArr3.length) {
                                break;
                            }
                    ...
                    if (i4Var4 == null) {
                        ...
                        while (i42 < iArr2.length) {
                            int i44 = iArr2[i42];
                            float f44 = i4Var4.b[i42];
                            int i45 = j4Var2.h;
                            int i46 = i44 - 1;
                            j4Var2.e = Math.max(j4Var2.e, i46);
                ...
                for (int i51 = 0; i51 < size; i51++) {
                    ...
                    if (groupedMessagePosition15.maxX == j4Var2.e || (groupedMessagePosition15.flags & 2) != 0) {
                ...
                while (i55 < size) {
                    ...
                    j4Var2.e = Math.max(j4Var2.e, (int) groupedMessagePosition16.maxX);
                    j4Var2.f = Math.max(j4Var2.f, (int) groupedMessagePosition16.maxY);
            ...
            if (i74 > 0) {
                ...
                if (AndroidUtilities.isTablet()) {
                    l4Var.f = AndroidUtilities.getMinTabletSide() - AndroidUtilities.dp(122.0f);
                    messageObject2 = messageObject;
                } else {
                    messageObject2 = messageObject;
                    l4Var.f = Math.min(u1Var.getParentWidth(), AndroidUtilities.displaySize.y) - AndroidUtilities.dp((u1Var.M0(messageObject2) ? 10 : 0) + 64);
                }
                if (u1Var.z3()) {
                    l4Var.f -= AndroidUtilities.dp(52.0f);
                }
            }
            ...
            while (true) {
                ...
                k4 k4Var = i75 >= arrayList.size() ? null : (k4) arrayList.get(i75);
                if (k4Var == null) {
                    j4 j4Var3 = l4Var.b;
                    if (messageExtendedMedia2 == null) {
                        ...
                        groupedMessagePosition = (MessageObject.GroupedMessagePosition) j4Var3.c.get(messageExtendedMedia2);
                    }
                    k4 k4Var2 = new k4(l4Var.a, messageObject2, messageExtendedMedia2, tL_messageMediaPaidMedia3.extended_media.size() != 1, (int) ((groupedMessagePosition.pw / 1000.0f) * l4Var.f), (int) (groupedMessagePosition.ph * l4Var.b.i));
                    String str = messageExtendedMedia2.attachPath;
                    if (str != null) {
                        k4Var2.F = str;
                    } else if (tL_messageMediaPaidMedia3.extended_media.size() == 1) {
                        TLRPC.Message message2 = messageObject2.messageOwner;
                        k4Var2.F = message2 != null ? message2.attachPath : null;
                    }
                    if (!TextUtils.isEmpty(k4Var2.F)) {
                        DownloadController.getInstance(u1Var.I7).addLoadingFileObserver(k4Var2.F, messageObject2, k4Var2);
                        if (messageObject2.isSending()) {
                            k4Var2.G.o(messageExtendedMedia2.uploadProgress, false);
                        }
                    }
                    if (u1Var.M0 && !k4Var2.M) {
                        k4Var2.M = true;
                        k4Var2.f.onAttachedToWindow();
                    }
                    arrayList.add(k4Var2);
                } else {
                    k4Var.c(messageExtendedMedia2, messageObject2);
                }
                i75++;
            }
            int size8 = tL_messageMediaPaidMedia3.extended_media.size();
            while (size8 < arrayList.size()) {
                k4 k4Var3 = size8 >= arrayList.size() ? null : (k4) arrayList.get(size8);
                if (k4Var3 != null) {
                    if (k4Var3.M) {
                        k4Var3.M = false;
                        k4Var3.f.onDetachedFromWindow();
                    }
    ...
    public final void h(MessageObject messageObject) {
        ...
        int i10;
        u1 u1Var = this.a;
        boolean z12 = u1Var.Lc > 0 || (u1Var.u1 && !TextUtils.isEmpty(messageObject.caption));
        boolean z13 = ((u1Var.u1 || TextUtils.isEmpty(messageObject.caption)) && u1Var.N.s && !u1Var.j9) ? false : true;
        int i11 = this.m;
        if (i11 > 0) {
            f7 = 1000.0f / this.b.d;
            this.f = i11;
        ...
        j4 j4Var = this.b;
        this.g = (int) ((j4Var.d / 1000.0f) * f7 * this.f);
        this.h = (int) (j4Var.g * j4Var.i);
        this.i = false;
        ...
        while (true) {
            ...
            if (messageExtendedMedia == null) {
                ...
                groupedMessagePosition = (MessageObject.GroupedMessagePosition) j4Var2.c.get(messageExtendedMedia);
            }
