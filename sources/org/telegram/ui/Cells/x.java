...
public final class x extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public x(Context context, int i10, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        addView(imageView, i7.f6.d(42, 42.0f, (LocaleController.isRTL ? 3 : 5) | 16, 5.0f, 0.0f, 5.0f, 0.0f));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        try {
            ...
            if (this.E == 1) {
                replace = new SpannableStringBuilder(replace).append(' ').append((CharSequence) this.F).append(' ').append(h10.d(this.w, true, 2, null));
            }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean z10 = true;
        boolean z11 = this.C >= 0 && x4 >= (dp2 = this.c + (dp = AndroidUtilities.dp(27.0f))) && x4 <= dp2 + dp3 && y8 >= (i10 = this.d + dp) && y8 <= i10 + dp3;
