...
public final /* synthetic */ class va implements View.OnClickListener {
    ...
    public /* synthetic */ va(xn xnVar, TLRPC.User user, String str, boolean z10, int i10) {
        this.d = xnVar;
        this.e = str;
        this.b = z10;
        this.c = i10;
    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            case 0:
                ...
                SpannableStringBuilder replaceSingleTag = AndroidUtilities.replaceSingleTag(string, i13, 0, new g(ryVar, 10));
                ...
                xc.a0(ryVar).M(LocaleController.getString(z10 ? R.string.UnconfirmedAuthConfirmedBot : R.string.UnconfirmedAuthConfirmed), replaceSingleTag, R.raw.contact_check).j();
    ...
    public /* synthetic */ va(ry ryVar, boolean z10, int i10, ArrayList arrayList) {
        this.d = ryVar;
        this.b = z10;
        this.c = i10;
        this.e = arrayList;
