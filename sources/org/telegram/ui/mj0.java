...
public final class mj0 implements Choreographer.FrameCallback {
    ...
    public static void b(Canvas canvas, Layout layout, int i10, float f10, lj0 lj0Var) {
        ...
        lj0 huVar = lj0Var != null ? lj0Var : new hu(layout, 24);
    ...
    public final void doFrame(long j10) {
        if (this.h) {
            ...
            if (this.r != 0) {
                ...
                if (this.b.isEmpty() || f11 <= 0.0f) {
                    ...
                    while (true) {
                        ...
                        Layout layout = ((kj0) this.b.get(this.d)).getLayout();
            ...
            for (int i12 = 0; i12 < size2; i12++) {
                View parentView = ((kj0) this.b.get(i12)).getParentView();
                if (parentView != null && parentView != view) {
    ...
    public final void e() {
        kj0 kj0Var;
        int i10 = this.d;
        View parentView = (i10 < 0 || i10 >= this.b.size() || (kj0Var = (kj0) this.b.get(this.d)) == null) ? null : kj0Var.getParentView();
        if (parentView != null) {
    ...
    public final boolean f() {
        if (!this.b.isEmpty()) {
            ...
            Layout layout = null;
            while (size >= 0) {
                layout = ((kj0) this.b.get(size)).getLayout();
                if (layout != null && layout.getLineCount() > 0) {
                    break;
                }
                size--;
    ...
    public final boolean g(kj0 kj0Var) {
        Layout layout;
        return d(kj0Var) == this.d && (layout = kj0Var.getLayout()) != null && this.e < layout.getLineCount();
    }
    ...
    public final void l(List list) {
        ...
        if (!this.b.isEmpty() && this.d >= this.b.size()) {
            int size = this.b.size() - 1;
            this.d = size;
            Layout layout = ((kj0) this.b.get(size)).getLayout();
        ...
        if (list.isEmpty()) {
            ...
            while (i10 < this.b.size()) {
                Layout layout2 = ((kj0) this.b.get(i10)).getLayout();
                if (layout2 != null) {
