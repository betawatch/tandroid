...
public abstract class j71 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
        ...
        if (z5Var != null) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.o51
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    j71Var.s1.set((int) org.telegram.messenger.wl.c(j71Var.s1.width(), 2.0f, scaleX, r0.centerX()), (int) org.telegram.messenger.wl.c(j71Var.s1.height(), 2.0f, scaleX, j71Var.s1.centerY()), (int) a4.a.e(j71Var.s1.width(), 2.0f, scaleX, j71Var.s1.centerX()), (int) a4.a.e(j71Var.s1.height(), 2.0f, scaleX, j71Var.s1.centerY()));
                    j71Var.invalidate();
                    if (floatValue > 0.85f) {
                        boolean[] zArr2 = zArr;
                        if (zArr2[0]) {
    ...
    public final void z(boolean z10, boolean z11) {
        ...
        this.E1.start();
        org.telegram.messenger.wl.q(((View) g61Var.getParent()).animate().translationY((this.F1 && z11) ? -AndroidUtilities.dp(36.0f) : 0.0f).setUpdateListener(new l51(this, 1)), org.telegram.ui.Components.pr.f, 160L);
        if (this.F1 && z11) {
