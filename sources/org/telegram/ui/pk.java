...
public final class pk extends TextView {
    ...
    public /* synthetic */ pk(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
    ...
    public void draw(Canvas canvas) {
        switch (this.a) {
            case 1:
                ...
                ((FragmentContextView) this.b).K.a(AndroidUtilities.dp(16.0f), canvas, rectF, this);
                break;
            case 2:
            default:
                super.draw(canvas);
            ...
            case 3:
                ...
                org.telegram.ui.Components.voip.h hVar = c81Var.c;
                if (hVar.g <= 1.0f) {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                if (LocaleController.isRTL) {
                    ((org.telegram.ui.Components.u31) this.b).b.setPivotX(getMeasuredWidth());
                    break;
                }
                break;
            case 6:
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.a) {
            case 1:
                ...
                ((FragmentContextView) this.b).K.f = getWidth();
                break;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                break;
    ...
    public void setVisibility(int i10) {
        switch (this.a) {
            case 1:
                ...
                if (i10 != 0) {
                    a(0);
                    ((FragmentContextView) this.b).J = 0;
                    break;
                }
                break;
            default:
