...
public final class lb1 extends org.telegram.ui.Components.rl0 {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i23 == 1) {
            ...
            if (i10 == themeActivity.V) {
                aaVar.c(LocaleController.getString("AutoNightUpdateLocation", R.string.AutoNightUpdateLocation), org.telegram.ui.ActionBar.j6.w, false, false);
                return;
            }
            ...
            if (i10 == themeActivity.H) {
                ...
                aaVar.c(LocaleController.getString(R.string.SearchEngine), org.telegram.ui.web.l1.a().a, themeActivity.M0, false);
                return;
            } else {
        ...
        if (i23 == 2) {
            ...
            if (i10 == themeActivity.c0) {
                a9Var.setText(LocaleController.formatString("AutoNightBrightnessInfo", R.string.AutoNightBrightnessInfo, Integer.valueOf((int) (org.telegram.ui.ActionBar.j6.q * 100.0f))));
                return;
            }
        ...
        if (i23 == 4) {
            ...
            if (i10 == themeActivity.O) {
                faVar.a(LocaleController.getString("AutoNightDisabled", R.string.AutoNightDisabled), org.telegram.ui.ActionBar.j6.o == 0, true);
                return;
            }
            if (i10 == themeActivity.P) {
                faVar.a(LocaleController.getString("AutoNightScheduled", R.string.AutoNightScheduled), org.telegram.ui.ActionBar.j6.o == 1, true);
                return;
            } else if (i10 == themeActivity.Q) {
                faVar.a(LocaleController.getString("AutoNightAdaptive", R.string.AutoNightAdaptive), org.telegram.ui.ActionBar.j6.o == 2, themeActivity.R != -1);
                return;
            } else {
                if (i10 == themeActivity.R) {
                    faVar.a(LocaleController.getString("AutoNightSystemDefault", R.string.AutoNightSystemDefault), org.telegram.ui.ActionBar.j6.o == 3, false);
                    return;
                }
                return;
            }
        ...
        if (i23 == 7) {
            ...
            if (i10 == themeActivity.U) {
                s8Var.f(LocaleController.getString("AutoNightLocation", R.string.AutoNightLocation), org.telegram.ui.ActionBar.j6.p, true);
                return;
            }
        ...
        switch (i23) {
            ...
            case 12:
                ...
                if (indexOf != -1) {
                    ((f2.i0) sl0Var.getLayoutManager()).h1(indexOf, (themeActivity.b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                    break;
                }
                break;
        }
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [android.view.View, android.view.ViewGroup, android.widget.LinearLayout, java.lang.Object, org.telegram.ui.hb1] */
    /* JADX WARN: Type inference failed for: r2v28 */
    /* JADX WARN: Type inference failed for: r2v29, types: [org.telegram.ui.oo0] */
    @Override // f2.o0
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 4:
                ...
                faVar.addView(textView, k7.b6.d(-1, -1.0f, (z4 ? 5 : 3) | 48, z4 ? 71.0f : 21.0f, 0.0f, z4 ? 21.0f : 23.0f, 0.0f));
                ...
                faVar.addView(imageView, k7.b6.d(19, 14.0f, (LocaleController.isRTL ? 3 : 5) | 16, 23.0f, 0.0f, 23.0f, 0.0f));
                j5Var = faVar;
                break;
            case 5:
            ...
            case 9:
                ...
                while (true) {
                    ...
                    if (i14 >= x0VarArr.length) {
                        ...
                        x0VarArr[i14] = x0Var;
                        faVar.addView(((org.telegram.ui.Cells.x0[]) faVar.b)[i14], k7.b6.m(0.5f, -1, -1, i14 == 1 ? 10 : 0, 0, 0));
                        ((org.telegram.ui.Cells.x0[]) faVar.b)[i14].setOnClickListener(new nh.a2(3, faVar, z10));
                        i14++;
                    }
                }
                break;
            ...
            case 11:
                this.d = true;
                ib1 ib1Var = new ib1(this, this.c, themeActivity, themeActivity.f, themeActivity.e, themeActivity.d);
                themeActivity.c = ib1Var;
                ...
                break;
            case 12:
                jb1 jb1Var = new jb1(context, 0, f6Var);
            ...
            case 16:
                ...
                View kb1Var = new kb1(context, e5Var, 0);
                kb1Var.setImportantForAccessibility(4);
                j5Var = kb1Var;
                break;
            case 17:
                View cvVar = new cv(themeActivity.f, context, themeActivity);
            ...
            case 21:
                ...
                faVar = new oo0(i13, 0L, this.c, themeActivity.getResourceProvider());
                j5Var = faVar;
                break;
        }
    ...
    public final void y(f2.l1 l1Var) {
        if (l1Var.f == 4) {
            ((org.telegram.ui.Cells.fa) l1Var.a).setTypeChecked(l1Var.b() == org.telegram.ui.ActionBar.j6.o);
        }
    }
}
