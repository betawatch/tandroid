...
public final class ag1 extends org.telegram.ui.Cells.s2 {
    public boolean W4;
    public int X4;
    ...
    public final /* synthetic */ dg1 h5;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ag1(dg1 dg1Var, Context context, boolean z10) {
        super(context, z10);
        this.h5 = dg1Var;
        this.X4 = -1;
        this.x = false;
        this.I = dg1Var.isInPreviewMode() ? 11 : 50;
        this.U = 24.0f;
        this.J = 64;
        this.K = 76;
        this.n1 = true;
    ...
    public final void f0() {
        ...
        dg1 dg1Var = this.h5;
        if (z10) {
            ((ng.c) drawable).a(i0.a.d(this.f5, dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.R9), dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.L7)));
        }
        Drawable[] drawableArr = this.h0;
        if (drawableArr != null) {
            Drawable drawable2 = drawableArr[0];
            if (drawable2 instanceof ng.c) {
                ((ng.c) drawable2).a(i0.a.d(this.f5, dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.R9), dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.L7)));
            }
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        ci.q3 q3Var;
        dg1 dg1Var = this.h5;
        if (dg1Var.getMessagesController().isMonoForum(-dg1Var.a)) {
            super.onDraw(canvas);
            return;
        }
        ...
        canvas.drawColor(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
        super.onDraw(canvas);
        canvas.restore();
        canvas.save();
    ...
    public void setTopicIcon(TLRPC.TL_forumTopic tL_forumTopic) {
        ...
        dg1 dg1Var = this.h5;
        if (tL_forumTopic != null && this != dg1Var.b1) {
        ...
        if (tL_forumTopic != null && tL_forumTopic.id == 1) {
            ...
            setForumIcon(ng.d.c(getContext(), 1.0f, dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ac), false));
