                ...
                if (!hh1Var.M) {
                    ...
                    if (i10 != 0) {
                        if (i10 != 1) {
                            ...
                            try {
                                hh1Var.f0[6].P((int) ((Math.min(1.0f, hh1Var.n.getLayout().getLineWidth(0) / hh1Var.n.getWidth()) * 142.0f) + 18.0f));
                                hh1Var.a.d();
                                break;
                            } catch (Exception e) {
                                FileLog.e(e);
