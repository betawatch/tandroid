...
public final class lr extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int y0;
    public org.telegram.ui.Components.h00 y1;
    public int z0;
    ...
    public static /* synthetic */ void U(lr lrVar, long j10) {
        if (j10 != 0) {
            lrVar.J = j10;
            lrVar.r = MessagesController.getInstance(lrVar.currentAccount).getChat(Long.valueOf(j10));
            lrVar.u0();
        }
    }
    ...
    */
    public static void V(final lr lrVar, View view, int i10) {
        ...
        i14 = 0;
        final int i15 = 1;
        boolean z15 = lrVar.c.getAdapter() == lrVar.a;
        if (i10 == lrVar.d1) {
            boolean z16 = !lrVar.r1;
            lrVar.r1 = z16;
            ...
            lrVar.A0(w02);
            lrVar.a.m(lrVar.f1);
        } else if (i10 == lrVar.e1) {
            boolean z17 = !lrVar.s1;
            lrVar.s1 = z17;
            ((org.telegram.ui.Cells.p8) view).setChecked(z17);
            AndroidUtilities.updateVisibleRows(lrVar.c);
            er w03 = lrVar.w0();
            lrVar.B0();
            lrVar.A0(w03);
            ...
            boolean z18 = !lrVar.u1;
            lrVar.u1 = z18;
            ((org.telegram.ui.Cells.p8) view).setChecked(z18);
            AndroidUtilities.updateVisibleRows(lrVar.c);
            er w04 = lrVar.w0();
            lrVar.B0();
            lrVar.A0(w04);
            ...
            if (lrVar.p0(i10)) {
                ...
                if (i10 == lrVar.R) {
                    lrVar.A.send_photos = !r15.send_photos;
                } else if (i10 == lrVar.S) {
                    lrVar.A.send_videos = !r14.send_videos;
                } else if (i10 == lrVar.T) {
                    ...
                    lrVar.A.send_audios = !r14.send_audios;
                } else if (i10 == lrVar.V) {
                    lrVar.A.send_docs = !r14.send_docs;
                } else if (i10 == lrVar.W) {
                    lrVar.A.send_voices = !r14.send_voices;
                } else if (i10 == lrVar.X) {
                    lrVar.A.send_roundvideos = !r14.send_roundvideos;
                } else if (i10 == lrVar.Y) {
                    if (lrVar.A.send_plain && (m10 = lrVar.d.m(lrVar.P)) != null) {
                        AndroidUtilities.shakeViewSpring(m10);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        lrVar.A.embed_links = !r14.embed_links;
                    }
                } else if (i10 == lrVar.Z) {
                    lrVar.A.send_polls = !r14.send_polls;
                } else if (i10 == lrVar.g0) {
                    lrVar.A.send_reactions = !r14.send_reactions;
                }
                ...
                boolean z20 = !o8Var.d.h;
                lrVar.n1 = z20;
                o8Var.setChecked(z20);
                AndroidUtilities.updateVisibleRows(lrVar.c);
                er w06 = lrVar.w0();
                lrVar.B0();
                lrVar.A0(w06);
                ...
                if (i10 == lrVar.v0) {
                    ...
                    if (i13 == 1) {
                        ...
                        lr lrVar3 = new lr(bundle2);
                        lrVar3.i1 = new zq(lrVar);
                        lrVar3.x0(lrVar.s);
                        lrVar.presentFragment(lrVar3);
                        return;
                    }
                    if (i13 == 2) {
                        Bundle h = a9.p.h("addToGroup", true);
                        h.putLong(z14 ? "channelId" : "chatId", lrVar.r.id);
                ...
                if (i10 == lrVar.r0) {
                    lrVar.presentFragment(new qb(lrVar.r));
                    return;
                }
                if (i10 == lrVar.t0) {
                    ...
                    if (lrVar.s == null || !ChatObject.canUserDoAdminAction(lrVar.r, 13) || lrVar.s0) {
                        return;
                    }
                    lrVar.s0 = true;
                    final boolean z21 = lrVar.s.antispam;
                    ...
                    lrVar.getConnectionsManager().sendRequest(tL_channels_toggleAntiSpam, new RequestDelegate(lrVar) { // from class: org.telegram.ui.hq
                        ...
                        public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                            switch (i14) {
                                case 0:
                                    final lr lrVar4 = this.b;
                                    if (tLObject3 != null) {
                                        lrVar4.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        lrVar4.getMessagesController().putChatFull(lrVar4.s);
                                    }
                                                ...
                                                switch (i16) {
                                                    case 0:
                                                        ...
                                                        if (lrVar5.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = lrVar5.s;
                                                            boolean z24 = z23;
                                                            chatFull7.antispam = z24;
                                                            org.telegram.ui.Cells.l8 l8Var3 = l8Var2;
                                                            l8Var3.setChecked(z24);
                                                            l8Var3.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(lrVar5.r, 13) || ((chatFull5 = lrVar5.s) != null && chatFull5.antispam && lrVar5.l0() < lrVar5.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                    ...
                                                    default:
                                                        ...
                                                        if (lrVar6.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull8 = lrVar6.s;
                                                            boolean z25 = z23;
                                                            chatFull8.participants_hidden = z25;
                                                            org.telegram.ui.Cells.l8 l8Var4 = l8Var2;
                                                            l8Var4.setChecked(z25);
                                                            l8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(lrVar6.r, 2) || ((chatFull6 = lrVar6.s) != null && chatFull6.participants_hidden && lrVar6.l0() < lrVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                    ...
                                    break;
                                default:
                                    final lr lrVar5 = this.b;
                                    if (tLObject3 != null) {
                                        lrVar5.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        lrVar5.getMessagesController().putChatFull(lrVar5.s);
                                    }
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i17 = 1;
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.kq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        lr lrVar52 = lrVar5;
                                                        if (lrVar52.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = lrVar52.s;
                                                            boolean z242 = z24;
                                                            chatFull7.antispam = z242;
                                                            org.telegram.ui.Cells.l8 l8Var32 = l8Var3;
                                                            l8Var32.setChecked(z242);
                                                            l8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(lrVar52.r, 13) || ((chatFull5 = lrVar52.s) != null && chatFull5.antispam && lrVar52.l0() < lrVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.mc.a0(lrVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                ...
                if (i10 == lrVar.F0) {
                    ...
                    if (lrVar.s == null || !ChatObject.canUserDoAdminAction(lrVar.r, 2) || lrVar.E0) {
                        return;
                    }
                    lrVar.E0 = true;
                    final boolean z23 = lrVar.s.participants_hidden;
                    ...
                    l8Var2.setChecked(z24);
                    Switch checkBox = l8Var2.getCheckBox();
                    if (!ChatObject.canUserDoAdminAction(lrVar.r, 2) || ((chatFull = lrVar.s) != null && !chatFull.participants_hidden && lrVar.l0() < lrVar.getMessagesController().hiddenMembersGroupSizeMin)) {
                        i14 = R.drawable.permission_locked;
                    }
                    checkBox.setIcon(i14);
                    lrVar.getConnectionsManager().sendRequest(tL_channels_toggleParticipantsHidden, new RequestDelegate(lrVar) { // from class: org.telegram.ui.hq
                        public final /* synthetic */ lr b;
                        ...
                        public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                            switch (i15) {
                                case 0:
                                    ...
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i16 = 0;
                                        final org.telegram.ui.Cells.l8 l8Var22 = l8Var2;
                                                ...
                                                switch (i16) {
                                                    case 0:
                                                        ...
                                                        if (lrVar52.getParentActivity() != null) {
                                                            ...
                                                            boolean z242 = z232;
                                                            chatFull7.antispam = z242;
                                                            org.telegram.ui.Cells.l8 l8Var32 = l8Var22;
                                                            l8Var32.setChecked(z242);
                                                            l8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(lrVar52.r, 13) || ((chatFull52 = lrVar52.s) != null && chatFull52.antispam && lrVar52.l0() < lrVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.mc.a0(lrVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                                                        ...
                                                        if (lrVar6.getParentActivity() != null) {
                                                            ...
                                                            boolean z25 = z232;
                                                            chatFull8.participants_hidden = z25;
                                                            org.telegram.ui.Cells.l8 l8Var4 = l8Var22;
                                                            l8Var4.setChecked(z25);
                                                            l8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(lrVar6.r, 2) || ((chatFull6 = lrVar6.s) != null && chatFull6.participants_hidden && lrVar6.l0() < lrVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.mc.a0(lrVar6).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                ...
                if (i10 == lrVar.H0) {
                    ...
                    tL_messages_editChatDefaultBannedRights.peer = MessagesController.getInputPeer(lrVar.r);
                    TLRPC.Chat chat = lrVar.r;
                    if (chat.default_banned_rights == null) {
                        chat.default_banned_rights = new TLRPC.TL_chatBannedRights();
                    }
                    TLRPC.TL_chatBannedRights tL_chatBannedRights4 = lrVar.r.default_banned_rights;
                    tL_messages_editChatDefaultBannedRights.banned_rights = tL_chatBannedRights4;
                    tL_chatBannedRights4.edit_rank = !l8Var3.b();
                    lrVar.getConnectionsManager().sendRequestTyped(tL_messages_editChatDefaultBannedRights, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.iq
                    ...
                    if (i10 == lrVar.p0) {
                        ...
                        if ((i10 > lrVar.O && i10 <= Math.max(lrVar.h0, lrVar.c0)) || i10 == lrVar.i0) {
                            org.telegram.ui.Cells.o8 o8Var2 = (org.telegram.ui.Cells.o8) view;
                            boolean isEnabled = o8Var2.isEnabled();
                            Switch r42 = o8Var2.d;
                            if (isEnabled) {
                                if (r42.B != null) {
                                    if (ChatObject.isPublic(lrVar.r) && (i10 == lrVar.e0 || i10 == lrVar.c0)) {
                                        org.telegram.messenger.y1.r(R.string.EditCantEditPermissionsPublic, org.telegram.ui.Components.mc.a0(lrVar), null);
                                        return;
                                    } else if (ChatObject.isDiscussionGroup(lrVar.currentAccount, lrVar.J) && (i10 == lrVar.e0 || i10 == lrVar.c0)) {
                                ...
                                o8Var2.setChecked(!r42.h);
                                if (i10 == lrVar.c0) {
                                    lrVar.A.change_info = !r0.change_info;
                                    return;
                                }
                                if (i10 == lrVar.i0) {
                                    lrVar.A.manage_linked_peers = !r0.manage_linked_peers;
                                    return;
                                }
                                if (i10 == lrVar.d0) {
                                    lrVar.A.invite_users = !r0.invite_users;
                                    return;
                                }
                                if (i10 == lrVar.h0) {
                                    lrVar.A.manage_topics = !r0.manage_topics;
                                    return;
                                }
                                if (i10 == lrVar.e0) {
                                    lrVar.A.pin_messages = !r0.pin_messages;
                                    return;
                                }
                                if (i10 == lrVar.f0) {
                                    lrVar.A.edit_rank = !r0.edit_rank;
                                    return;
                                }
                                if (i10 == lrVar.P) {
                                    lrVar.A.send_plain = !r1.send_plain;
                                    int i16 = lrVar.Y;
                                    if (i16 >= 0) {
                                        lrVar.a.m(i16);
                                    }
                                ...
                                if (i10 == lrVar.b0) {
                                    lrVar.A.embed_links = !r0.embed_links;
                                    return;
                                } else {
                                    if (i10 == lrVar.Z) {
                                        lrVar.A.send_polls = !r0.send_polls;
                                        return;
                                    }
                                    return;
                                }
                ...
                if (z15) {
                    ...
                    if (E instanceof TLRPC.User) {
                        ...
                        while (true) {
                            ...
                            tLObject2 = (TLObject) (i18 == 0 ? hVar2 : i18 == 1 ? lrVar.H : hVar).f(j13);
                            if (tLObject2 != null) {
                                break;
                            } else {
                                i18++;
                    ...
                    if (E2 instanceof TLRPC.User) {
                        ...
                        if (i12 != 0) {
                            ...
                            if (i12 != 3 && i12 != 1) {
                                if (ChatObject.isChannel(lrVar.r)) {
                                    lrVar.getMessagesController().deleteParticipantFromChat(lrVar.J, lrVar.getMessagesController().getUser(Long.valueOf(j11)));
                                    dr drVar = lrVar.i1;
                                    if (drVar != null) {
                                        drVar.d(j11);
                                    }
                            ...
                            if (i12 == 1) {
                                ...
                                if (!z11) {
                                    ...
                                    z13 = z11;
                                    i19 = 1;
                                    lrVar.t0(j12, tLObject, tL_chatAdminRights, tL_chatBannedRights, str2, z13, i12 != i19 ? 0 : 1, i12 != i19 || i12 == 3);
                                    return;
                                }
                                if ((tLObject instanceof TLRPC.TL_channelParticipantAdmin) || (tLObject instanceof TLRPC.TL_chatParticipantAdmin)) {
                                    TLRPC.User user2 = lrVar.getMessagesController().getUser(Long.valueOf(j11));
                                    ...
                                    alertDialog$Builder.k(LocaleController.getString("OK", R.string.OK), new jq(lrVar, user2, tLObject, tL_chatAdminRights, tL_chatBannedRights, str, z11));
                        ...
                        boolean z27 = z11;
                        if (i13 == 1) {
                            canBlockUsers = j15 != lrVar.getUserConfig().getClientUserId() && (lrVar.r.creator || z27);
                        } else {
                            if (i13 != 0 && i13 != 3) {
                                z12 = false;
                                if (i13 != 0 || ((i13 != 1 && z10) || (i13 == 2 && i12 == 0))) {
                                    if (j15 != lrVar.getUserConfig().getClientUserId()) {
                                        return;
                                    }
                                    ...
                                    lrVar.presentFragment(new ProfileActivity(bundle4, null));
                                    return;
                                }
                                ...
                                dq dqVar = new dq(j15, lrVar.J, tL_chatAdminRights, lrVar.A, tL_chatBannedRights, str, i13 == i11 ? 0 : 1, z12, tLObject == null, null);
                                dqVar.T0 = new oq(lrVar, tLObject);
                                lrVar.presentFragment(dqVar);
                                return;
                            }
                            canBlockUsers = ChatObject.canBlockUsers(lrVar.r);
                        }
                        z12 = canBlockUsers;
                        if (i13 != 0) {
                        }
    ...
    public static void W(lr lrVar, TLRPC.ChannelParticipant channelParticipant, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights) {
        int i10 = 0;
        while (i10 < 3) {
            TLObject tLObject = (TLObject) (i10 == 0 ? lrVar.I : i10 == 1 ? lrVar.H : lrVar.G).f(MessageObject.getPeerId(channelParticipant.peer));
    ...
    public static void c0(lr lrVar, TLRPC.User user) {
        ...
        UndoView undoView = lrVar.n;
        long j10 = -lrVar.J;
        boolean z12 = lrVar.v;
        undoView.m(j10, user, z12 ? 9 : 10);
        lrVar.r.creator = false;
        int i10 = 0;
        boolean z13 = false;
        while (i10 < 3) {
            boolean z14 = true;
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        org.telegram.ui.Components.h00 h00Var2 = this.y1;
        h00Var2.w = false;
        h00Var2.setUseHeaderOffset(false);
        org.telegram.ui.Components.h00 h00Var3 = this.y1;
        int i12 = org.telegram.ui.ActionBar.g6.G8;
        int i13 = org.telegram.ui.ActionBar.g6.i6;
        h00Var3.f(i12, i13, i13);
        frameLayout3.addView(this.y1, h7.z5.d(-1, -1.0f, 0, 12.0f, 30.0f, 12.0f, 0.0f));
    ...
    */
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 16, new Class[]{org.telegram.ui.Cells.j4.class, org.telegram.ui.Cells.y4.class, org.telegram.ui.Cells.v4.class, org.telegram.ui.Cells.o8.class, org.telegram.ui.Cells.x9.class, org.telegram.ui.Components.dv0.class}, null, null, null, org.telegram.ui.ActionBar.g6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 32, new Class[]{org.telegram.ui.Cells.w6.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.x9.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.o8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.o8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.o8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.o8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.g6.y6;
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.g6.n6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 262144, new Class[]{org.telegram.ui.Cells.v4.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 262144, new Class[]{org.telegram.ui.Cells.v4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.m6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 262144, new Class[]{org.telegram.ui.Cells.v4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.u6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 262144, new Class[]{org.telegram.ui.Cells.v4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.v6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Components.iw0.class}, new String[]{"title"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Components.iw0.class}, new String[]{"subtitle"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.c, 0, new Class[]{org.telegram.ui.Cells.y4.class}, null, org.telegram.ui.ActionBar.g6.r0, null, org.telegram.ui.ActionBar.g6.J7));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        if (i13 != 2) {
            ...
            if (i13 == 3 && ChatObject.canBlockUsers(this.r)) {
                lrVar = this;
                H.c(R.drawable.msg_permissions, LocaleController.getString(R.string.ChannelEditPermissions), new gh.k1(lrVar, j13, tL_chatBannedRights, str, tLObject, 9), false);
                final int i14 = 0;
                H.c(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), new Runnable(lrVar) { // from class: org.telegram.ui.fq
                    public final /* synthetic */ lr b;
                    ...
                    public final void run() {
                        switch (i14) {
                            ...
                            case 1:
                                ...
                                long j14 = j13;
                                lrVar2.i0(j14);
                                lrVar2.getMessagesController().addUserToChat(lrVar2.J, lrVar2.getMessagesController().getUser(Long.valueOf(j14)), 0, null, lrVar2, null);
                                break;
                            case 2:
                                this.b.i0(j13);
                                break;
                            default:
                                ...
                                long j16 = j13;
                                messagesController.setUserAdminRole(j15, messagesController2.getUser(Long.valueOf(j16)), new TLRPC.TL_chatAdminRights(), "", !lrVar3.v, lrVar3, false, false, null, null);
                                lrVar3.v0(j16);
                                break;
                        }
                    }
                ...
                String str3 = str;
                lrVar = this;
                if (i13 == 0 && ChatObject.canBlockUsers(lrVar.r)) {
                    if (ChatObject.canAddUsers(lrVar.r) && j10 > 0 && !ChatObject.isCommunity(lrVar.r)) {
                        final int i15 = 1;
                        H.c(R.drawable.msg_contact_add, LocaleController.getString(z15 ? R.string.ChannelAddToChannel : R.string.ChannelAddToGroup), new Runnable(lrVar) { // from class: org.telegram.ui.fq
                            public final /* synthetic */ lr b;
                ...
                } else if (i13 == 1 && ChatObject.canAddAdmins(lrVar.r) && z11) {
                    if (lrVar.r.creator || !(tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                        j11 = j13;
                        H.c(R.drawable.msg_admins, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), new gh.k1(lrVar, j11, tL_chatAdminRights2, str3, tLObject, 10), false);
                    } else {
                        j11 = j13;
                    }
                    final int i17 = 3;
                    H.c(R.drawable.msg_remove, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), new Runnable(lrVar) { // from class: org.telegram.ui.fq
                        public final /* synthetic */ lr b;
        ...
        long j14 = j12;
        org.telegram.ui.Components.b70 H2 = org.telegram.ui.Components.b70.H(this, view);
        H2.W(this.c.V0(view, false));
        H2.l(R.drawable.msg_admins, LocaleController.getString(z19 ? R.string.EditAdminRights : R.string.SetAsAdmin), new ti(nqVar, 11), z12);
        H2.l(R.drawable.msg_permissions, LocaleController.getString("ChangePermissions", R.string.ChangePermissions), new yf(this, tLObject, user, nqVar, 8), z22);
        ...
        H2.m(z23, i18, LocaleController.getString(str2, i12), true, new e5.u(this, user, j14, 19));
        H2.S = 190;
        H2.Z();
        return true;
    }
    ...
    public final void onResume() {
        ...
        org.telegram.ui.Components.iw0 iw0Var = this.b;
        if (iw0Var != null) {
    ...
    public final void r0() {
        ...
        if (ChatObject.isChannel(this.r)) {
            ...
            for (int i14 = 0; i14 < s02.size(); i14++) {
                arrayList6.add(null);
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest((TLObject) s02.get(i14), new gf.j0(arrayList6, i14, atomicInteger, s02, lqVar, 6)), this.classGuid);
            }
            return;
        }
        this.M = false;
    ...
    */
    ...
    public final void v0(long j10) {
        ...
        f2.q0 adapter = this.c.getAdapter();
        kr krVar = this.e;
        if (adapter == krVar) {
            pf.j1 j1Var = krVar.h;
    ...
    public final er w0() {
        ...
        erVar.j = this.U0;
        erVar.l.clear();
        erVar.l.addAll(this.C);
        erVar.h = this.R0;
        erVar.g = this.Q0;
        erVar.m.clear();
        erVar.m.addAll(this.D);
        erVar.e = this.A0;
        erVar.f = this.B0;
        erVar.k.clear();
        erVar.k.addAll(this.B);
        erVar.f(erVar.c);
        return erVar;
    }
    ...
    public final void y0(int i10) {
        ...
        this.c.getViewTreeObserver().addOnPreDrawListener(new pq(this, (org.telegram.ui.Components.h00) view, i10, 0));
    }
