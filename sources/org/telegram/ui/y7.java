    ...
    public final void onClick(View view) {
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                if (((l81) this.b).a.getImageReceiver().getLottieAnimation() != null && !((l81) this.b).a.getImageReceiver().getLottieAnimation().k0) {
                    ((l81) this.b).a.getImageReceiver().getLottieAnimation().N(0, false, false);
                    ((l81) this.b).a.getImageReceiver().getLottieAnimation().H(false);
                    break;
                }
                break;
            default:
