...
public final class je0 extends org.telegram.ui.Components.vv0 {
    ...
    public String v;
    public String w;
    public final org.telegram.ui.Components.bd0 x;
    ...
    */
    public je0(pg0 pg0Var, Context context) {
        super(context);
        int i10;
        this.y = pg0Var;
        setOrientation(1);
        ...
        this.e = jj0Var;
        jj0Var.f(R.raw.tsv_setup_intro, 120, 120, null);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                editTextBoldCursor.setOnFocusChangeListener(new sd(this, 4));
                ...
                addView(bd0Var, k7.b6.t(-1, -2, 1, 16, 32, 16, 0));
                ...
                frameLayout2.addView(textView3, k7.b6.d(-1, 56.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
                addView(frameLayout2, k7.b6.q(-1, -1, 80));
                n7.qa.V(textView3);
                textView3.setOnClickListener(new ib0(4, this, context));
            }
        }
        i10 = 8;
        frameLayout.setVisibility(i10);
        ...
        addView(textView4, k7.b6.d(-1, -2.0f, 1, 32.0f, 16.0f, 32.0f, 0.0f));
        ...
        editTextBoldCursor2.setOnFocusChangeListener(new sd(this, 4));
        ...
        addView(bd0Var2, k7.b6.t(-1, -2, 1, 16, 32, 16, 0));
        ...
        frameLayout22.addView(textView32, k7.b6.d(-1, 56.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        addView(frameLayout22, k7.b6.q(-1, -1, 80));
        n7.qa.V(textView32);
        textView32.setOnClickListener(new ib0(4, this, context));
    }
    ...
    public final void h(String str) {
        ...
        if (obj.length() != 0) {
            ...
            pg0.U0(pg0Var, this.x, true);
        }
    }

    @Override // org.telegram.ui.Components.vv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new d10(this, 19), pg0.q0);
    }
