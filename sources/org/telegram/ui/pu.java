...
public final class pu extends FrameLayout {
    ...
    public pu(av avVar, Context context) {
        super(context);
        setBackgroundColor(avVar.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
        ImageView imageView = new ImageView(context);
        this.a = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        addView(imageView, w7.y5.d(28, 28.0f, (LocaleController.isRTL ? 5 : 3) | 16, 18.0f, 0.0f, 18.0f, 0.0f));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(0);
        linearLayout.setWeightSum(2.0f);
        addView(linearLayout, w7.y5.i(-1.0f, -2.0f, (LocaleController.isRTL ? 5 : 3) | 16, 64.0f, 0.0f, 20.0f, 0.0f));
        ...
        textView.setTextColor(avVar.getThemedColor(i10));
        ...
        imageView2.setColorFilter(new PorterDuffColorFilter(avVar.getThemedColor(i10), PorterDuff.Mode.MULTIPLY));
        ...
        textView2.setTextColor(avVar.getThemedColor(org.telegram.ui.ActionBar.j6.o6));
