...
public final class t80 extends org.telegram.ui.Components.ul0 {
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        switch (i14) {
            case 0:
                ...
                if (!z11) {
                    if (!languageSelectActivity.h.isEmpty() && i13 >= 0 && i13 < languageSelectActivity.h.size()) {
                        ...
                        if (!languageSelectActivity.h.isEmpty()) {
                            i13 = com.google.android.gms.internal.vision.e2.e(1, i13, languageSelectActivity.h);
                        }
                ...
                if (localeInfo != null) {
                    if (localeInfo.isLocal()) {
                        h9Var.b(String.format("%1$s (%2$s)", localeInfo.name, LocaleController.getString(R.string.LanguageCustom)), localeInfo.nameEnglish, !z10);
                    } else {
                        h9Var.b(localeInfo.name, localeInfo.nameEnglish, !z10);
                    }
                }
                h9Var.setChecked(localeInfo == LocaleController.getInstance().getCurrentLocaleInfo());
                break;
            case 1:
                if (!z11) {
                    i13--;
                ...
                if (!isEmpty && i13 == languageSelectActivity.h.size()) {
                    c7Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.b7));
                    break;
                } else {
                    c7Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.b7));
                    break;
                }
            case 2:
                ...
                TextView textView2 = x8Var.c;
                boolean z13 = x8Var.H;
                boolean z14 = LocaleController.isRTL;
                if (z13 != z14) {
                    x8Var.H = z14;
                    textView2.setGravity((z14 ? 5 : 3) | 16);
                    x8Var.removeView(textView2);
                    boolean z15 = LocaleController.isRTL;
                    x8Var.addView(textView2, w7.a6.d(-1, -1.0f, (z15 ? 5 : 3) | 48, z15 ? 70.0f : x8Var.E, 0.0f, z15 ? x8Var.E : 70.0f, 0.0f));
                    textView.setGravity(LocaleController.isRTL ? 5 : 3);
                    x8Var.removeView(textView);
                    boolean z16 = LocaleController.isRTL;
                    x8Var.addView(textView, w7.a6.d(-2, -2.0f, (z16 ? 5 : 3) | 48, z16 ? 64.0f : x8Var.E, 36.0f, z16 ? x8Var.E : 64.0f, 0.0f));
                    x8Var.removeView(view2);
                    x8Var.addView(view2, w7.a6.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
                }
                ...
                if (i13 != i11) {
                    ...
                    if (i13 == i12) {
                        ...
                        x8Var.f(string, g02, z12);
                        x8Var.setCheckBoxIcon(languageSelectActivity.getUserConfig().isPremium() ? 0 : R.drawable.permission_locked);
                        break;
                    }
                } else {
                    x8Var.f(LocaleController.getString(R.string.ShowTranslateButton), languageSelectActivity.h0(), true);
            ...
            case 4:
                    ...
                    if (Y.size() != 0) {
                        if (Y.size() != 1) {
                            ...
                            while (it.hasNext()) {
                                ...
                                String y3 = org.telegram.ui.Components.i41.y(org.telegram.ui.Components.i41.D(str, zArr, null));
                                if (y3 != null) {
                                    sb3.append(y3);
                                    z17 = false;
                                }
                            ...
                            charSequence = org.telegram.ui.Components.i41.y(org.telegram.ui.Components.i41.D((String) Y.iterator().next(), zArr, null));
                        }
                    } else {
                        charSequence = "";
                    }
                ...
                gaVar.c(string2, charSequence, true, false);
                break;
            case 5:
                ((org.telegram.ui.Cells.ga) view).d();
                break;
            case 6:
                org.telegram.ui.Cells.f9 f9Var = (org.telegram.ui.Cells.f9) view;
                org.telegram.ui.Cells.x1 x1Var = f9Var.a;
                boolean z18 = f9Var.n;
                ...
                if (i13 != languageSelectActivity.n) {
                    f9Var.setTopPadding(0);
                    f9Var.setBottomPadding(16);
                    break;
                } else {
                    f9Var.setText(LocaleController.getString(R.string.TranslateMessagesInfo1));
                    f9Var.setTopPadding(11);
                    f9Var.setBottomPadding(16);
                    break;
                }
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        Context context = this.c;
        if (i10 != 0) {
            view = i10 != 2 ? i10 != 3 ? (i10 == 4 || i10 == 5) ? new org.telegram.ui.Cells.ga(context) : i10 != 6 ? new org.telegram.ui.Cells.c7(context, (org.telegram.ui.Cells.r6) null) : new org.telegram.ui.Cells.f9(context) : new org.telegram.ui.Cells.m4(context) : new org.telegram.ui.Cells.x8(context);
        } else {
            org.telegram.ui.Cells.h9 h9Var = new org.telegram.ui.Cells.h9(context);
            h9Var.e = 50;
            h9Var.r = 21;
            ...
            h9Var.addView(textView, w7.a6.d(-1, -1.0f, (z10 ? 5 : 3) | 48, z10 ? 21 : 64.0f, 0.0f, z10 ? 64.0f : 21, 0.0f));
            ...
            h9Var.addView(textView2, w7.a6.d(-2, -2.0f, (z11 ? 5 : 3) | 48, z11 ? 21 : 64.0f, 36.0f, z11 ? 64.0f : 21, 0.0f));
            ...
            h9Var.addView(radioButton, w7.a6.d(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
            h9Var.n = LocaleController.isRTL;
