...
public final class v71 extends org.telegram.ui.Components.za implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public v71(org.telegram.ui.ActionBar.o2 o2Var, long j3, int i10, org.telegram.ui.Components.rc rcVar) {
        super(r2, o2Var, new org.telegram.ui.Components.ya(r3));
        ...
        this.a0 = new HashMap();
        this.b0 = i10;
        ai.d9 A = MessagesController.getInstance(o2Var.getCurrentAccount()).getStoriesController().A(j3, 1, -1, true);
        this.Z = A;
        A.p(30, false);
        ...
        dVar.setOnClickListener(new xy0(3, this, rcVar));
        ...
        this.d.setOnItemLongClickListener(new nl0(this, 18));
        this.d.setOnScrollListener(new u71(this));
        this.d0.N(true);
    }
