...
public class lq extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public boolean A0;
    public int B0;
    public int C0;
    public int D0;
    ...
    public lq(long j3, long j10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, TLRPC.TL_chatBannedRights tL_chatBannedRights2, String str, int i10, boolean z10, boolean z11, String str2) {
        super(null);
        boolean z12;
    ...
    public static void U(lq lqVar, long j3) {
        if (j3 != 0) {
            lqVar.s = j3;
            lqVar.w = MessagesController.getInstance(lqVar.currentAccount).getChat(Long.valueOf(j3));
            lqVar.r0(true);
        }
    }

    public static void V(final lq lqVar, org.telegram.ui.ActionBar.a3 a3Var, View view) {
        Runnable runnable;
        int intValue = ((Integer) view.getTag()).intValue();
        if (intValue == 0) {
            lqVar.O.until_date = 0;
            lqVar.a.m(lqVar.M0);
        } else if (intValue == 1) {
            lqVar.O.until_date = ConnectionsManager.getInstance(lqVar.currentAccount).getCurrentTime() + 86400;
            lqVar.a.m(lqVar.M0);
        } else if (intValue == 2) {
            lqVar.O.until_date = ConnectionsManager.getInstance(lqVar.currentAccount).getCurrentTime() + 604800;
            lqVar.a.m(lqVar.M0);
        } else if (intValue == 3) {
            lqVar.O.until_date = ConnectionsManager.getInstance(lqVar.currentAccount).getCurrentTime() + 2592000;
            lqVar.a.m(lqVar.M0);
        } else if (intValue == 4) {
                        ...
                        try {
                            TimePickerDialog timePickerDialog = new TimePickerDialog(lqVar2.getParentActivity(), new TimePickerDialog.OnTimeSetListener() { // from class: org.telegram.ui.hq
                                ...
                                public final void onTimeSet(TimePicker timePicker, int i13, int i14) {
                                    lq lqVar3 = lq.this;
                                    lqVar3.O.until_date = (i14 * 60) + (i13 * 3600) + time;
                                    lqVar3.a.m(lqVar3.M0);
                                }
                            }, 0, 0, true);
    ...
    public static /* synthetic */ boolean W(lq lqVar, TLRPC.TL_error tL_error) {
        ...
        if (!ChatObject.isChannel(lqVar.w)) {
            rg.j0 j0Var = new rg.j0(11, lqVar.currentAccount, lqVar.getParentActivity(), lqVar, lqVar.getResourceProvider());
            ArrayList arrayList = new ArrayList();
            arrayList.add(lqVar.v);
            j0Var.I1(lqVar.w, arrayList, null, null, null);
            j0Var.show();
        }
        return false;
    }
    ...
    */
    public static void X(lq lqVar, Context context, View view, int i10) {
        ...
        TLRPC.TL_chatBannedRights tL_chatBannedRights2 = lqVar.P;
        int i11 = lqVar.y;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = lqVar.M;
        if (lqVar.I || (lqVar.w.creator && i11 == 0 && i10 == lqVar.e0)) {
            boolean z15 = false;
            if (i10 == lqVar.z0) {
                if (!(view instanceof org.telegram.ui.Cells.w8) || ((org.telegram.ui.Cells.w8) view).isEnabled()) {
                    ...
                    lqVar.a.m(lqVar.z0);
                    if (lqVar.A0) {
                        lqVar.a.s(lqVar.z0 + 1, 10);
                        return;
                    } else {
                        lqVar.a.t(lqVar.z0 + 1, 10);
                        return;
                    }
                }
                return;
            ...
            if (i10 == i12) {
                if (!(view instanceof org.telegram.ui.Cells.w8) || ((org.telegram.ui.Cells.w8) view).isEnabled()) {
                    ...
                    lqVar.a.m(lqVar.N0);
                    if (lqVar.O0) {
                        lqVar.a.s(lqVar.N0 + 1, 3);
                        return;
                    } else {
                        lqVar.a.t(lqVar.N0 + 1, 3);
                        return;
                    }
                }
                return;
            ...
            if (i10 == i13) {
                if (!(view instanceof org.telegram.ui.Cells.w8) || ((org.telegram.ui.Cells.w8) view).isEnabled()) {
                    ...
                    lqVar.a.m(lqVar.S0);
                    if (lqVar.T0) {
                        lqVar.a.s(lqVar.S0 + 1, 3);
                        return;
                    } else {
                        lqVar.a.t(lqVar.S0 + 1, 3);
                        return;
                    }
                }
                return;
            ...
            if (i10 == lqVar.p0) {
                if (i11 == 0) {
                    MessagesController.getInstance(lqVar.currentAccount).setUserAdminRole(lqVar.s, lqVar.v, new TLRPC.TL_chatAdminRights(), lqVar.S, lqVar.E, lqVar.getFragmentForAlert(0), lqVar.Z0, false, null, null);
                    iq iqVar = lqVar.X0;
                    if (iqVar != null) {
                        iqVar.b(0, tL_chatAdminRights, lqVar.O, lqVar.S);
                    }
            ...
            if (i10 == lqVar.M0) {
                ...
                for (int i16 = 5; i15 < i16; i16 = 5) {
                    ...
                    y2VarArr[i15].setBackgroundDrawable(org.telegram.ui.ActionBar.h6.K0(false));
            ...
            if (view instanceof org.telegram.ui.Cells.z1) {
                ...
                int i18 = lqVar.U0;
                if (i10 == i18 || i10 == lqVar.V0 || i10 == lqVar.W0) {
                    if (i10 == i18) {
                ...
                if (i10 == lqVar.B0) {
                    ...
                    if ((lqVar.O.send_plain || tL_chatBannedRights2.send_plain) && (m10 = lqVar.c.m(lqVar.y0)) != null) {
                        AndroidUtilities.shakeViewSpring(m10);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        TLRPC.TL_chatBannedRights tL_chatBannedRights12 = lqVar.O;
                        z15 = !tL_chatBannedRights12.embed_links;
                        tL_chatBannedRights12.embed_links = z15;
                    }
                } else if (i10 == lqVar.I0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights13 = lqVar.O;
            ...
            if (view instanceof org.telegram.ui.Cells.w8) {
                ...
                if (!w8Var.isEnabled()) {
                    if (i11 == 2 || i11 == 0) {
                        if ((i10 != lqVar.X || tL_chatBannedRights2 == null || tL_chatBannedRights2.change_info) && ((i10 != lqVar.h0 || tL_chatBannedRights2 == null || tL_chatBannedRights2.pin_messages) && (i10 != lqVar.i0 || tL_chatBannedRights2 == null || tL_chatBannedRights2.edit_rank))) {
                            return;
                        }
                ...
                if (i10 == lqVar.W) {
                    z16 = !lqVar.K;
                    lqVar.K = z16;
                    TLRPC.TL_chatAdminRights tL_chatAdminRights2 = lqVar.N;
                    ...
                    while (i19 < childCount) {
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.w8) {
                            ...
                            if (z17) {
                                ...
                                i19++;
                                z15 = false;
                            } else if ((R != lqVar.X || tL_chatBannedRights2.change_info) && ((R != lqVar.h0 || tL_chatBannedRights2.pin_messages) && (R != lqVar.i0 || tL_chatBannedRights2.edit_rank))) {
                                org.telegram.ui.Cells.w8 w8Var3 = (org.telegram.ui.Cells.w8) childAt;
                                w8Var3.setChecked(z15);
                                w8Var3.b(R == lqVar.W, true);
                            } else {
                    ...
                    lqVar.a.l();
                    org.telegram.ui.Components.p6 p6Var = lqVar.f;
                    if (p6Var != null) {
                        ...
                        p6Var.c(sb2.toString(), true, lqVar.K);
                    }
                    ValueAnimator valueAnimator = lqVar.c1;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        lqVar.c1 = null;
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(lqVar.J, lqVar.K ? 1.0f : 0.0f);
                    lqVar.c1 = ofFloat;
                    ofFloat.addUpdateListener(new cq(lqVar, 1));
                    lqVar.c1.setDuration((long) (Math.abs(lqVar.J - (lqVar.K ? 1.0f : 0.0f)) * 200.0f));
                    lqVar.c1.start();
                } else if (i10 == lqVar.X) {
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights14 = lqVar.O;
                    ...
                    org.telegram.ui.Components.e5.v0(lqVar, LocaleController.getString(R.string.ApproveNewMembersTitle), AndroidUtilities.replaceTags(LocaleController.formatString(z16 ? z14 ? R.string.ApproveNewMembersDisabledMessageChannel : R.string.ApproveNewMembersDisabledMessageGroup : z14 ? R.string.ApproveNewMembersMessageChannel : R.string.ApproveNewMembersMessageGroup, DialogObject.getShortName(user))), LocaleController.getString(!z16 ? R.string.ApproveNewMembersEnable : R.string.ApproveNewMembersDisable), false, new bq(lqVar, !z16 ? user.id : 0L, 1));
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights15 = lqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights16 = lqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights17 = lqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights18 = lqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights19 = lqVar.O;
                        z16 = !tL_chatBannedRights19.edit_rank;
                        tL_chatBannedRights19.edit_rank = z16;
                    }
                } else if (i11 == 1 && (tL_chatBannedRights = lqVar.O) != null) {
                    if (i10 == lqVar.y0) {
    ...
    public static void Y(lq lqVar, TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, TLRPC.TL_channels_editCreator tL_channels_editCreator) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            if (inputCheckPasswordSRP == null) {
                ...
                b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, lqVar.w.title, UserObject.getFirstName(user)));
                alertDialog$Builder.k(LocaleController.getString(R.string.EditAdminTransferChangeOwner), new aq(lqVar, i11));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                lqVar.showDialog(b2Var);
                return;
            }
            return;
        }
        if (!"PASSWORD_MISSING".equals(tL_error.text) && !tL_error.text.startsWith("PASSWORD_TOO_FRESH_") && !tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
            if ("SRP_ID_INVALID".equals(tL_error.text)) {
                ConnectionsManager.getInstance(lqVar.currentAccount).sendRequest(new TL_account.getPassword(), new mo(i10, lqVar, twoStepVerificationActivity), 8);
                return;
            }
            if (!tL_error.text.equals("CHANNELS_TOO_MUCH")) {
                ...
                org.telegram.ui.Components.e5.h0(tL_error, lqVar, z10, lqVar.F, tL_channels_editCreator);
                return;
            }
            if (lqVar.getParentActivity() == null || AccountInstance.getInstance(lqVar.currentAccount).getUserConfig().isPremium()) {
                lqVar.presentFragment(new le1(1));
                return;
            } else {
                lqVar.showDialog(new rg.j0(5, lqVar.currentAccount, lqVar.getParentActivity(), lqVar, null));
                return;
            }
        }
        if (twoStepVerificationActivity != null) {
        ...
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, i12, false), mode));
        ...
        lqVar.showDialog(b2Var2);
    }

    public static void Z(lq lqVar, long j3) {
        TLRPC.ChatFull chatFull = lqVar.x;
        long j10 = chatFull != null ? chatFull.guard_bot_id : 0L;
        TLRPC.User user = j10 != 0 ? lqVar.getMessagesController().getUser(Long.valueOf(j10)) : null;
        if (user != null && j3 != 0 && user.id != j3) {
            new org.telegram.ui.Components.x30(lqVar.getParentActivity(), lqVar.resourceProvider, user, lqVar.v, new bq(lqVar, j3, 0)).show();
            return;
        }
        lqVar.n = j3;
        lqVar.r = true;
    ...
    public static /* synthetic */ void a0(lq lqVar, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, long j3) {
        if (j3 != 0) {
            lqVar.s = j3;
            lqVar.w = MessagesController.getInstance(lqVar.currentAccount).getChat(Long.valueOf(j3));
    ...
    public static void f0(lq lqVar, View view) {
        if (view instanceof org.telegram.ui.Cells.m4) {
            ...
            int i10 = codePointCount < 0 ? org.telegram.ui.ActionBar.h6.p7 : org.telegram.ui.ActionBar.h6.A6;
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new po(this, 4));
        boolean z10 = false;
        ...
        u7Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.a7, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        e eVar = new e(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 16, new Class[]{org.telegram.ui.Cells.ab.class, org.telegram.ui.Cells.fa.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.d9.class, org.telegram.ui.Cells.d6.class}, null, null, null, org.telegram.ui.ActionBar.h6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        int i11 = org.telegram.ui.ActionBar.h6.p7;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 262144, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 262144, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.m6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.h6.z6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.V6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 4, new Class[]{org.telegram.ui.Cells.d6.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, TLObject.FLAG_23, new Class[]{org.telegram.ui.Cells.d6.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.H6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.y6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.n6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, null, org.telegram.ui.ActionBar.h6.r0, null, org.telegram.ui.ActionBar.h6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.j5));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.q5));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 8192, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"radioButton"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.D5));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 16384, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"radioButton"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.E5));
        return arrayList;
    }
    ...
    */
    public final void r0(boolean z10) {
        ...
        TLRPC.User user = lqVar.v;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = lqVar.M;
        if (z10 && z11 && !lqVar.L && tL_chatAdminRights.manage_linked_peers && tL_chatAdminRights.change_info) {
            org.telegram.ui.Components.e5.v0(lqVar, LocaleController.getString(R.string.CommunityMakeAdminTitle), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.CommunityMakeAdminMessage, DialogObject.getShortName(user))), LocaleController.getString(R.string.CommunityMakeAdminPromote), false, new dq(lqVar, r6));
            return;
        }
        if (lqVar.v0 != -1 && (str = lqVar.S) != null && str.codePointCount(0, str.length()) > 16) {
            lqVar.b.x0(lqVar.v0);
            Vibrator vibrator = (Vibrator) lqVar.getParentActivity().getSystemService("vibrator");
            if (vibrator != null) {
                vibrator.vibrate(200L);
            }
            s4.c1 K = lqVar.b.K(lqVar.v0);
            if (K != null) {
        ...
        if (i10 == 0) {
            int i12 = lqVar.X0 == null ? 1 : 0;
            lqVar.t0(true);
            MessagesController.getInstance(lqVar.currentAccount).setUserAdminRole(lqVar.s, lqVar.v, lqVar.M, lqVar.S, lqVar.E, lqVar, (!lqVar.Z0 || z11) ? 0 : 1, false, null, new dq(lqVar, i11), new aq(lqVar, 8));
            lqVar = lqVar;
            r6 = i12;
        } else {
            if (i10 == 1) {
                ...
                MessagesController.getInstance(lqVar.currentAccount).setParticipantBannedRole(lqVar.s, lqVar.v, null, lqVar.O, lqVar.E, lqVar.getFragmentForAlert(1));
                TLRPC.TL_chatBannedRights tL_chatBannedRights = lqVar.O;
                ...
                iq iqVar = lqVar.X0;
                if (iqVar != null) {
                    iqVar.b(i11, tL_chatAdminRights, tL_chatBannedRights, lqVar.S);
                }
            } else if (i10 == 2) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(lqVar.getParentActivity());
                String string = lqVar.K ? LocaleController.getString(R.string.AddBotAdmin) : LocaleController.getString(R.string.AddBot);
                org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.a;
                b2Var.R = string;
                boolean z13 = ChatObject.isChannel(lqVar.w) && !lqVar.w.megagroup;
                TLRPC.Chat chat = lqVar.w;
                String str4 = chat != null ? chat.title : "";
                b2Var.T = AndroidUtilities.replaceTags(lqVar.K ? z13 ? LocaleController.formatString(R.string.AddBotMessageAdminChannel, str4) : LocaleController.formatString(R.string.AddBotMessageAdminGroup, str4) : LocaleController.formatString(R.string.AddMembersAlertNamesText, UserObject.getUserName(user), str4));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                alertDialog$Builder.k(LocaleController.getString(lqVar.K ? R.string.AddAsAdmin : R.string.AddBot), new aq(lqVar, r6));
                lqVar.showDialog(b2Var);
                r6 = 0;
            }
        }
