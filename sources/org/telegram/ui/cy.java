...
public final class cy implements org.telegram.ui.Components.v40 {
    ...
    public final void I(boolean z4, boolean z10) {
        ...
        oy oyVar = this.a;
        org.telegram.ui.Components.ic icVar = oyVar.b4;
        if (icVar != null) {
            icVar.b();
            oyVar.b4 = null;
        }
        ...
        if (z4) {
            p9Var.setImageBitmap(oyVar.Y3.r);
        } else {
        ...
        org.telegram.ui.Components.ic b10 = org.telegram.ui.Components.qc.a0(oyVar).b(zbVar, -1);
        oyVar.b4 = b10;
        b10.r = false;
        b10.i(false);
        org.telegram.ui.Components.ic icVar2 = oyVar.b4;
        icVar2.s = true;
        icVar2.j();
    }
    ...
    public final ju0 getCloseIntoObject() {
        ...
        ju0Var.i = 0;
        ju0Var.h = ju0Var.a.getRoundRadius();
        ju0Var.k = p9Var2.getScaleX();
        return ju0Var;
    }
