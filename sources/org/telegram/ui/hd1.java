...
public final class hd1 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.hn s;
    ...
    public hd1(org.telegram.ui.ActionBar.i6 i6Var, org.telegram.ui.ActionBar.h6 h6Var, boolean z4) {
        ...
        this.G = i6Var;
        this.H = h6Var;
        this.I = h6Var != null ? h6Var.r : i6Var.C;
        this.currentAccount = h6Var != null ? h6Var.t : i6Var.B;
        this.F = z4;
    }

    public static /* synthetic */ void V(hd1 hd1Var, TLRPC.TL_theme tL_theme) {
        try {
            hd1Var.r.dismiss();
            hd1Var.r = null;
        } catch (Exception e) {
    ...
    public static /* synthetic */ void W(hd1 hd1Var, TLRPC.TL_error tL_error, TL_account.updateTheme updatetheme) {
        try {
            hd1Var.r.dismiss();
            hd1Var.r = null;
        } catch (Exception e) {
    ...
    public static /* synthetic */ void X(hd1 hd1Var, String str) {
        ...
        hd1Var.y = ConnectionsManager.getInstance(hd1Var.currentAccount).sendRequest(createtheme, new sb0(25, hd1Var, str), 2);
    }

    public static void Y(hd1 hd1Var) {
        org.telegram.ui.ActionBar.i6 i6Var = hd1Var.G;
        TLRPC.TL_theme tL_theme = hd1Var.I;
        if (hd1Var.Z(hd1Var.a.getText().toString(), true) && hd1Var.getParentActivity() != null) {
            if (hd1Var.b.length() == 0) {
            ...
            if (hd1Var.F) {
                ...
                hd1Var.r = d2Var;
                d2Var.setOnCancelListener(new fd1());
                hd1Var.r.show();
                String obj = hd1Var.b.getText().toString();
                tL_theme.title = obj;
                i6Var.a = obj;
                i6Var.C.slug = hd1Var.a.getText().toString();
            ...
            String obj2 = hd1Var.a.getText().toString();
            String obj3 = hd1Var.b.getText().toString();
            if (str2.equals(obj2) && str4.equals(obj3)) {
                hd1Var.finishFragment();
                return;
            }
            hd1Var.r = new org.telegram.ui.ActionBar.d2(hd1Var.getParentActivity(), 3, null);
            ...
            hd1Var.r.setOnCancelListener(new lh.w(hd1Var, sendRequest, 9));
            hd1Var.r.show();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        linearLayout2.addView(this.x, k7.b6.n(-1, -2));
        ...
        this.x.addView(this.b, k7.b6.k(23.0f, 0.0f, 23.0f, 0.0f, -1, 50));
        this.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.dd1
            ...
            public final boolean onEditorAction(TextView textView, int i14, KeyEvent keyEvent) {
                ...
                switch (i11) {
                    case 0:
                        hd1 hd1Var = this.b;
                        if (i14 == 6) {
                            AndroidUtilities.hideKeyboard(hd1Var.b);
                            return true;
                        }
                        hd1Var.getClass();
                        return false;
        ...
        this.s = hnVar;
        this.x.addView(hnVar, new LinearLayout.LayoutParams(-1, 1));
        LinearLayout linearLayout4 = new LinearLayout(context);
        linearLayout4.setOrientation(0);
        this.x.addView(linearLayout4, k7.b6.k(23.0f, 0.0f, 23.0f, 0.0f, -1, 50));
        ...
        linearLayout4.addView(this.w, k7.b6.n(-2, 50));
        ...
        linearLayout4.addView(this.a, k7.b6.n(-1, 50));
        this.a.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.dd1
            public final /* synthetic */ hd1 b;
        ...
        this.a.addTextChangedListener(new gd1(this));
        if (z4) {
        ...
        a9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, i14, i15));
        this.e.setVisibility(8);
        ...
        if (z4) {
            ...
            linearLayout2.addView(this.n, k7.b6.n(-1, -2));
        } else {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.n, 32, new Class[]{org.telegram.ui.Cells.a9.class}, null, null, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.B6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.n, 0, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.e, 262144, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.p7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.e, 262144, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.w6));
        int i13 = org.telegram.ui.ActionBar.j6.G6;
        ...
        org.telegram.ui.Components.hn hnVar = this.s;
