...
public final class o30 extends jh.b {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.voip.u2 u2Var = j60Var.r;
        org.telegram.ui.Components.voip.u2 u2Var2 = j60Var.v;
        Matrix matrix3 = j60Var.S0;
        org.telegram.ui.Components.ba baVar6 = j60Var.N0;
        org.telegram.ui.Components.ba baVar7 = j60Var.M0;
        RectF rectF2 = j60Var.v0;
        Paint paint5 = j60Var.T0;
        RadialProgressView radialProgressView5 = j60Var.e0;
        q40 q40Var = j60Var.T;
        int[] iArr = j60Var.X1;
        org.telegram.ui.Components.voip.u2 u2Var3 = j60Var.w;
        ...
        if (i60Var5 != null && i60Var5.i == 3) {
            ...
            if (Math.abs(radialProgressView5.n) < 360.0f) {
                ...
                baVar6.e(j60Var.O0, 1.0f);
                baVar7.e(j60Var.O0, 1.0f);
                if (j60Var.M1 != null) {
                }
                canvas2 = canvas;
                paint2 = paint6;
            ...
            if (z10) {
                ...
                if (!j60Var.W1 || (i60Var3 = j60Var.N1) == null) {
                    ...
                    j60Var.n.a(i14, i13);
                    j60Var.f.a(i14, i13);
                    org.telegram.ui.Components.voip.u2 u2Var4 = j60Var.s;
                    int i20 = org.telegram.ui.ActionBar.j6.Dg;
                    u2Var4.a(org.telegram.ui.ActionBar.j6.w0(null, i20, false), org.telegram.ui.ActionBar.j6.w0(null, i20, false));
                    j60Var.h.a(i13, i15);
                }
            ...
            if (j60Var.M1 != null || j60Var.N1 == null || j60Var.r1()) {
                ...
                if (i22 == 3 || j60Var.M1.i == 3) {
                    ...
                    float y3 = (int) (u2Var3.getY() + AndroidUtilities.dp(25.0f));
                    Matrix matrix4 = matrix;
                    matrix4.setTranslate(measuredWidth2, y3);
                    j60Var.R0.setLocalMatrix(matrix4);
                    paint3.setAlpha(76);
                    canvas.save();
                    canvas.scale(u2Var3.getScaleX() * 1.0f, u2Var3.getScaleY() * 1.0f, measuredWidth2, y3);
                    canvas.save();
            ...
            while (i10 < 2) {
                ...
                if (i10 == 0 && j60Var.M1 != null) {
                    ...
                    float y10 = (int) (u2Var3.getY() + AndroidUtilities.dp(f12));
                    matrix2.setTranslate(measuredWidth3, y10);
                    j60Var.R0.setLocalMatrix(matrix2);
                    paint2.setAlpha((int) (j60Var.V0 * 76.0f * f15));
                    canvas2.save();
                    canvas2.scale(u2Var3.getScaleX() * 1.0f, u2Var3.getScaleX() * 1.0f, measuredWidth3, y10);
                    canvas2.save();
                    ...
                    canvas2.restore();
                    if (q40Var != null) {
                        paint2.setAlpha((int) (q40Var.getAlpha() * 255.0f));
                        float x12 = q40Var.getX() - getX();
                        float y11 = q40Var.getY() - getY();
                        rectF.set(x12, y11, q40Var.getMeasuredWidth() + x12, q40Var.getMeasuredHeight() + y11);
                        canvas2.save();
                        canvas2.scale(q40Var.getScaleX(), q40Var.getScaleY(), rectF.centerX(), rectF.centerY());
                    ...
                    if (j60Var.r1()) {
                        ...
                        baVar4 = baVar7;
                        baVar3 = baVar6;
                        u2Var.a(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.w0(null, i24, false), org.telegram.ui.ActionBar.j6.w0(null, i23, false), j60Var.U1, 1.0f), offsetColor2);
                        u2Var2.a(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.w0(null, i24, false), org.telegram.ui.ActionBar.j6.w0(null, i23, false), j60Var.U1, 1.0f), offsetColor2);
                    }
                    float measuredWidth32 = (int) ((u2Var3.getMeasuredWidth() / 2.0f) + u2Var3.getX());
                    float y102 = (int) (u2Var3.getY() + AndroidUtilities.dp(f12));
                    matrix2.setTranslate(measuredWidth32, y102);
                    j60Var.R0.setLocalMatrix(matrix2);
                    paint2.setAlpha((int) (j60Var.V0 * 76.0f * f15));
                    canvas2.save();
                    canvas2.scale(u2Var3.getScaleX() * 1.0f, u2Var3.getScaleX() * 1.0f, measuredWidth32, y102);
                    canvas2.save();
                    ...
                    canvas2.restore();
                    if (q40Var != null && q40Var.getVisibility() == 0) {
                        paint2.setAlpha((int) (q40Var.getAlpha() * 255.0f));
                        float x122 = q40Var.getX() - getX();
                        float y112 = q40Var.getY() - getY();
                        rectF.set(x122, y112, q40Var.getMeasuredWidth() + x122, q40Var.getMeasuredHeight() + y112);
                        canvas2.save();
                        canvas2.scale(q40Var.getScaleX(), q40Var.getScaleY(), rectF.centerX(), rectF.centerY());
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(f17), AndroidUtilities.dp(f17), paint2);
                        canvas2.restore();
