...
public final class t70 extends DispatchQueue {
    ...
    public float r;
    public long s;
    public final org.telegram.ui.Components.kh0 v;
    public final z5 w;
    public final /* synthetic */ u70 x;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public t70(u70 u70Var, SurfaceTexture surfaceTexture) {
        super("EGLThread");
        this.x = u70Var;
        this.n = new int[24];
        this.v = new org.telegram.ui.Components.kh0(24);
        this.w = new z5(this, 7);
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            ...
            u70 u70Var = this.x;
            if (!this.b.eglChooseConfig(this.c, EmuDetector.with(u70Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                ...
                if (eglCreateContext == null) {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            c(new org.telegram.ui.Components.kh0(25), 22, false);
                            c(this.v, 23, false);
                            ...
                            u70Var.G = System.currentTimeMillis() - 1000;
                            z4 = true;
                        } else {
                            if (BuildVars.LOGS_ENABLED) {
