...
public final /* synthetic */ class oq0 implements Runnable {
    ...
    public /* synthetic */ oq0(PhotoViewer photoViewer, int i10) {
        this.a = i10;
        this.b = photoViewer;
    }
        ...
        switch (this.a) {
            ...
            case 21:
                ...
                if (photoViewer19.s0.isEnabled() && AndroidUtilities.checkInlinePermissions(photoViewer19.y) && !org.telegram.ui.Components.ng0.m0.M && photoViewer19.M3) {
                    if (!photoViewer19.q4) {
                        ...
                        pt0 pt0Var = photoViewer19.c0;
                        if (pt0Var != null) {
                            if ((!pt0Var.x || !"inapp".equals(MessagesController.getInstance(pt0Var.a).youtubePipType)) && photoViewer19.c0.e()) {
                                photoViewer19.H3 = false;
            ...
            case 25:
                ...
                if (!photoViewer23.R4.isPopupShown()) {
                    ...
                    if (k71Var2 != null && photoViewer23.R4.videoWasPlaying) {
                        k71Var2.C();
                        break;
                    }
                } else {
                    ...
                    videoAds.videoWasPlaying = k71Var3 != null ? k71Var3.y() : true;
