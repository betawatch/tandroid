...
public final class ne0 extends org.telegram.ui.Components.gw0 {
    ...
    public final org.telegram.ui.Components.id0[] a;
    ...
    public ne0(xg0 xg0Var, Context context, int i10) {
        ...
        this.a = new org.telegram.ui.Components.id0[i11];
        ...
        while (i12 < this.b.length) {
            ...
            this.a[i12] = id0Var;
            id0Var.setText(LocaleController.getString(i10 == 0 ? i12 == 0 ? R.string.PleaseEnterNewFirstPasswordHint : R.string.PleaseEnterNewSecondPasswordHint : R.string.PasswordHintPlaceholder));
            ...
            editTextBoldCursor.addTextChangedListener(new me0(this, z10));
            this.b[i12].setOnFocusChangeListener(new pd(id0Var, 3));
            if (z10) {
                ...
                final int i13 = 0;
                imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.je0
                    ...
                    public final void onClick(View view) {
                        switch (i13) {
                            case 0:
                                ne0 ne0Var = this.b;
                                ImageView imageView2 = ne0Var.f;
                                EditTextBoldCursor[] editTextBoldCursorArr = ne0Var.b;
                                ne0Var.y = !ne0Var.y;
                                for (int i14 = 0; i14 < editTextBoldCursorArr.length; i14++) {
                                    ...
                                    editTextBoldCursorArr[i14].setInputType((ne0Var.y ? 144 : 128) | 1);
                                    editTextBoldCursorArr[i14].setSelection(selectionStart, selectionEnd);
                                }
                                imageView2.setTag(Boolean.valueOf(ne0Var.y));
                                imageView2.setColorFilter(org.telegram.ui.ActionBar.j6.w0(null, ne0Var.y ? org.telegram.ui.ActionBar.j6.l6 : org.telegram.ui.ActionBar.j6.H6, false));
                                break;
                            default:
                                ne0 ne0Var2 = this.b;
                                if (ne0Var2.x == 0) {
                ...
                id0Var.addView(this.b[i12], w7.y5.c(-2.0f, -1));
            }
            id0Var.e(this.b[i12]);
            addView(id0Var, w7.y5.t(-1, -2, 1, 16, 16, 16, 0));
            this.b[i12].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.ke0
        ...
        n7.z0.k(textView3);
        final int i14 = 1;
        textView3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.je0
            public final /* synthetic */ ne0 b;
                ...
                switch (i14) {
                    case 0:
                        ...
                        for (int i142 = 0; i142 < editTextBoldCursorArr.length; i142++) {
                            ...
                            editTextBoldCursorArr[i142].setInputType((ne0Var.y ? 144 : 128) | 1);
    ...
    @Override // org.telegram.ui.Components.gw0
    public final void j() {
        AndroidUtilities.runOnUIThread(new g10(this, 18), xg0.t0);
    }
    ...
    public final void n() {
        ...
        for (org.telegram.ui.Components.id0 id0Var : this.a) {
            id0Var.f();
        }
