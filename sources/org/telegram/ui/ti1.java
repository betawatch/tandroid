...
public final class ti1 implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate, rf.a {
    ...
    public static void w(Activity activity, int i10) {
        ...
        ti1Var3.x = e3Var;
        oi1Var.addView(e3Var, w7.x5.c(220.0f, -1));
        ...
        ti1Var3.Z.addView(ti1Var3.b0, w7.x5.e(-1, -2, 17));
        ...
        while (i15 < 4) {
            ...
            ti1Var3.N.addView(u9VarArr[i15], w7.x5.k(i15 == 0 ? 0.0f : 6.0f, 0.0f, 0.0f, 0.0f, 25, 25));
            i15++;
        }
        ...
        int i16 = ti1Var3.a;
        t0Var.b.h(ImageLocation.getForUserOrChat(i16, user, 0), null, f9Var, user);
        ...
        if (sharedState != null && sharedState.getUser() != null && sharedState.isConference() && sharedState.getGroupCall() != null) {
            ...
            if (groupParticipants != null || i19 > 0) {
                ...
                org.telegram.ui.Components.h9 h9Var = si1Var.b;
                h9Var.k(min);
                int i20 = 0;
                while (i20 < min) {
                ...
                if (max == 1 && (groupParticipants == null || groupParticipants.size() == 0 || (groupParticipants.size() == 1 && DialogObject.getPeerDialogId(groupParticipants.get(0).peer) == j10))) {
                    ...
                    si1Var.c = new org.telegram.ui.Components.h01(LocaleController.formatPluralStringComma("Participants", max), 14.0f, AndroidUtilities.bold());
        ...
        oi1Var.addView(ti1Var3.y, w7.x5.d(204, 204.0f, 1, 0.0f, 93.0f, 0.0f, 0.0f));
        ...
        oi1Var.addView(ti1Var3.j0, w7.x5.e(-1, -2, 80));
        float f7 = AndroidUtilities.isTablet() ? 100 : 27;
        oi1Var.addView(ti1Var3.e0, w7.x5.d(-1, 186.0f, 80, f7, 0.0f, f7, 0.0f));
    ...
    /* JADX WARN: Type inference failed for: r0v25, types: [org.telegram.ui.Components.u9] */
    /* JADX WARN: Type inference failed for: r0v26, types: [android.view.View] */
    /* JADX WARN: Type inference failed for: r0v28, types: [org.telegram.ui.Components.u9] */
    /* JADX WARN: Type inference failed for: r0v29, types: [org.telegram.ui.Components.u9] */
    ...
    /* JADX WARN: Type inference failed for: r5v7, types: [org.telegram.ui.Components.o5] */
    /* JADX WARN: Type inference failed for: r5v9 */
    /* JADX WARN: Type inference failed for: r6v0, types: [org.telegram.ui.Components.u9[]] */
    /*
    ...
    public final void E(boolean z10) {
        ...
        while (true) {
            ...
            if (emojiDrawable != null) {
                ...
                if (z13) {
                    ...
                    org.telegram.ui.Components.x5[] x5VarArr = (org.telegram.ui.Components.x5[]) spannable.getSpans(z12 ? 1 : 0, spannable.length(), org.telegram.ui.Components.x5.class);
                    if (emojiSpanArr != null) {
                        if ((iArr[z12 ? 1 : 0] - emojiSpanArr.length) - (x5VarArr == null ? 0 : x5VarArr.length) <= 0) {
                    ...
                    if (document == null) {
                        ...
                        if ((drawable instanceof org.telegram.ui.Components.o5) && ((org.telegram.ui.Components.o5) drawable).i() == document.id) {
                            r52 = (org.telegram.ui.Components.o5) drawableArr[i11];
                        } else {
                            org.telegram.ui.Components.o5 o5Var = new org.telegram.ui.Components.o5(21, i12, document);
                            drawableArr[i11] = o5Var;
                            r52 = o5Var;
                        }
                        r52.r(strArr[i11]);
        ...
        for (int i16 = 0; i16 < 4; i16++) {
            ...
            if (drawable2 instanceof Emoji.EmojiDrawable) {
                ...
                if ((drawable2 instanceof org.telegram.ui.Components.o5) && (l4Var = ((org.telegram.ui.Components.o5) drawable2).k) != null) {
            ...
            for (int i17 = 0; i17 < 4; i17++) {
                if (r62[i17].getVisibility() != 0) {
                    ...
                    if (z10) {
                        ...
                        org.telegram.messenger.wl.q(r62[i17].animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), org.telegram.ui.Components.qr.k, 250L);
                    }
                }
            }
    ...
    */
                ...
                if (i15 == 4) {
                    ...
                    if (TextUtils.equals(lastError, Instance.ERROR_UNKNOWN)) {
                        ...
                        if (this.U0) {
                            ...
                            org.telegram.ui.ActionBar.z3 z3Var = new org.telegram.ui.ActionBar.z3(this.b, 0, null);
                            boolean[] zArr2 = new boolean[3];
                            z3Var.R = LocaleController.getString(R.string.VoipFailed);
                            z3Var.T = AndroidUtilities.replaceTags(formatString);
                            ...
                            tv0 tv0Var = new tv0(18, this, zArr);
                            z3Var.l0 = string2;
                            z3Var.m0 = tv0Var;
                            z3Var.show();
                            for (int i16 = 0; i16 < 3; i16++) {
                                if (zArr2[i16] && (textView = (TextView) z3Var.d(-(i16 + 1))) != null) {
                                    textView.setTextColor(z3Var.e(org.telegram.ui.ActionBar.j6.q7));
                                }
                            }
                            z3Var.setCanceledOnTouchOutside(true);
                            z3Var.setOnDismissListener(new ei.e0(this, zArr, 12));
                        } else {
                        ...
                        case 11:
                            ...
                            if (!z21 || this.G0) {
                                ...
                                if (this.x0) {
                                    ...
                                    AndroidUtilities.runOnUIThread(new qb1(15, this, sharedInstance), 2L);
                                } else {
                                ...
                                if (this.C0) {
                                    ...
                                    org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.f;
                                    duration.setInterpolator(qrVar).setListener(new org.telegram.ui.Components.aa(this.O)).start();
                                    this.N.animate().scaleX(1.0f).scaleY(1.0f).translationY(0.0f).setInterpolator(qrVar).setDuration(250L).start();
                                    this.R.animate().alpha(0.0f).scaleY(0.7f).scaleX(0.7f).translationY(-AndroidUtilities.dp(120.0f)).setListener(new org.telegram.ui.Components.aa(this.O)).setDuration(250L).setInterpolator(qrVar).start();
                                }
                                for (org.telegram.ui.Components.u9 u9Var : this.V) {
                                    u9Var.animate().alpha(0.0f).scaleX(0.0f).scaleY(0.0f).setInterpolator(org.telegram.ui.Components.qr.f).setDuration(250L).start();
                                }
                                ...
                                org.telegram.ui.Components.qr qrVar2 = org.telegram.ui.Components.qr.f;
                                org.telegram.messenger.wl.q(alpha, qrVar2, 250L);
                                ...
                                if (!z19 && this.e0.getTag() != null) {
                                    ...
                                    if (this.y.getVisibility() == 0 && this.C0) {
                                        ...
                                        if (layout != null && (lineCount = layout.getLineCount()) > 2) {
                                            dp2 = hg.k0.g(lineCount, 2, AndroidUtilities.dp(20.0f), dp2);
                                        }
                                    }
    ...
    public final void p() {
        ...
        if (sf.c.a(this.b) <= 0) {
            org.telegram.ui.Components.c5.B(this.b, new bi1(this, 0), true).o();
            return;
        }
        if (this.G0 || n1 == null) {
            return;
    ...
    public final void y(CharSequence charSequence) {
        ...
        z3Var.R = LocaleController.getString(R.string.VoipFailed);
        z3Var.T = charSequence;
        z3Var.l0 = LocaleController.getString(R.string.OK);
        z3Var.m0 = null;
        z3Var.show();
        for (int i10 = 0; i10 < 3; i10++) {
            if (zArr[i10] && (textView = (TextView) z3Var.d(-(i10 + 1))) != null) {
                textView.setTextColor(z3Var.e(org.telegram.ui.ActionBar.j6.q7));
            }
        }
        z3Var.setCanceledOnTouchOutside(true);
        z3Var.setOnDismissListener(new r5(this, 19));
    }
