    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.a) {
            case 0:
                ...
                if (!s9Var.Z() || view != s9Var.c) {
                    return drawChild;
                }
                float min = Math.min(1.0f, Math.max(0.0f, (SystemClock.elapsedRealtime() - s9Var.G) / 75.0f));
                if (min < 1.0f) {
                ...
                paint2.setAlpha((int) (Math.max(0.0f, 1.0f - s9Var.y) * 255.0f));
                canvas.drawRect(f14, f12, f15, f13, paint2);
                int lerp = AndroidUtilities.lerp(0, AndroidUtilities.dp(4.0f), Math.min(1.0f, s9Var.y * 20.0f));
                int i15 = lerp / 2;
                int lerp2 = AndroidUtilities.lerp(Math.min(i9, i10), AndroidUtilities.dp(20.0f), Math.min(1.2f, (float) Math.pow(s9Var.y, 1.7999999523162842d)));
                paint.setAlpha((int) (Math.min(1.0f, s9Var.y) * 255.0f));
                path.reset();
                int i16 = i12 + lerp2;
                path.arcTo(a(i11, i16, i15), 0.0f, 180.0f);
                float f16 = lerp * 1.5f;
                int i17 = (int) (f14 + f16);
                int i18 = (int) (f12 + f16);
                int i19 = lerp * 2;
                ...
                int i20 = i11 + lerp2;
                path.arcTo(a(i20, i12, i15), 270.0f, 180.0f);
                path.lineTo(i11 + i15, i12 + i15);
                ...
                int i22 = i14 - lerp2;
                path.arcTo(a(i22, i12, i15), 270.0f, -180.0f);
                path.arcTo(a(i21, i18, lerp), 270.0f, 90.0f);
                path.close();
                canvas.drawPath(path, paint);
                path.reset();
                int i23 = i13 - lerp2;
                path.arcTo(a(i11, i23, i15), 0.0f, -180.0f);
                int i24 = (int) (f13 - f16);
        ...
        switch (this.a) {
            case 0:
                ...
                if (i15 == 0) {
                    ...
                    if (cameraView != null) {
                        cameraView.layout(0, 0, cameraView.getMeasuredWidth(), s9Var.c.getMeasuredHeight());
                    }
                    s9Var.f.setTextSize(0, i14 / 22);
                    s9Var.f.setPadding(0, 0, 0, i14 / 15);
                    int i16 = (int) (i14 * 0.65f);
                    s9Var.a.layout(AndroidUtilities.dp(36.0f), i16, s9Var.a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), s9Var.a.getMeasuredHeight() + i16);
                } else {
                    ...
                    if (cameraView2 != null) {
                        cameraView2.layout(0, 0, cameraView2.getMeasuredWidth(), s9Var.c.getMeasuredHeight());
                    }
                    int min = (int) (Math.min(i13, i14) / 1.5f);
                    if (i15 == 1) {
                        measuredHeight = ((i14 - min) / 2) - s9Var.a.getMeasuredHeight();
                    ...
                    s9Var.a.layout(AndroidUtilities.dp(36.0f), i17, s9Var.a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), s9Var.a.getMeasuredHeight() + i17);
                    if (i15 == 3) {
                        int C = org.telegram.messenger.l0.C(8.0f, s9Var.a.getMeasuredHeight(), i17);
                        s9Var.b.layout(AndroidUtilities.dp(36.0f), C, s9Var.b.getMeasuredWidth() + AndroidUtilities.dp(36.0f), s9Var.b.getMeasuredHeight() + C);
                    }
                    s9Var.f.layout(0, getMeasuredHeight() - s9Var.f.getMeasuredHeight(), getMeasuredWidth(), getMeasuredHeight());
                    int measuredWidth2 = (i13 / 2) - (s9Var.r.getMeasuredWidth() / 2);
                    int dp2 = AndroidUtilities.dp(80.0f) + j3.r0.d(i14, min, 2, min);
                    ImageView imageView = s9Var.r;
                    imageView.layout(measuredWidth2, dp2, imageView.getMeasuredWidth() + measuredWidth2, s9Var.r.getMeasuredHeight() + dp2);
                }
                if (i15 != 3) {
                    int i18 = (int) (i14 * 0.74f);
                    int i19 = (int) (i13 * 0.05f);
                    TextView textView = s9Var.b;
                    textView.layout(i19, i18, textView.getMeasuredWidth() + i19, s9Var.b.getMeasuredHeight() + i18);
                }
                s9Var.g0();
                break;
            default:
                ...
                h6Var.layout(0, 0, h6Var.getMeasuredWidth(), ag1Var.y.getMeasuredHeight());
                org.telegram.ui.Components.e90 e90Var = (org.telegram.ui.Components.e90) this.b;
        ...
        switch (this.a) {
            case 0:
                ...
                if (i11 == 0) {
                    ...
                    s9Var.f.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                    s9Var.r.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f), TLObject.FLAG_30));
                }
                s9Var.a.measure(org.telegram.messenger.ll.d(72.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                if (i11 == 3) {
                    s9Var.b.measure(org.telegram.messenger.ll.d(72.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                } else {
                    s9Var.b.measure(View.MeasureSpec.makeMeasureSpec((int) (size * 0.9f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                }
            ...
            default:
                ...
                kVar2.measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), i10);
                kh.h6 h6Var = ag1Var.y;
                ...
                h6Var.measure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(3.0f) + kVar3.getMeasuredHeight(), TLObject.FLAG_30));
                ((org.telegram.ui.Components.e90) this.b).measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), i10);
