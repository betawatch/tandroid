...
public final class zy extends FrameLayout {
    ...
    public zy(az azVar, Context context) {
        ...
        if (i11 == 0) {
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) azVar.getParentActivity().getLayoutInflater().inflate(R.layout.shortcut_widget_item, (ViewGroup) null);
            ...
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) azVar.getParentActivity().getLayoutInflater().inflate(R.layout.contacts_widget_item, (ViewGroup) null);
        ...
        a();
        this.e = org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.b7);
    }
        ...
        if (i12 == 0) {
            ...
            while (i16 < i14) {
                if (arrayList.isEmpty()) {
                    dialog2 = i16 < azVar.getMessagesController().dialogsServerOnly.size() ? azVar.getMessagesController().dialogsServerOnly.get(i16) : null;
                    j3 = 0;
                } else if (i16 < arrayList.size()) {
                    j3 = 0;
                    TLRPC.Dialog dialog3 = (TLRPC.Dialog) azVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i16)).longValue());
                    if (dialog3 == null) {
                ...
                if (dialog2 == null) {
                    ...
                    if (DialogObject.isUserDialog(dialog2.id)) {
                        user2 = azVar.getMessagesController().getUser(Long.valueOf(dialog2.id));
                        if (user2 != null) {
                            ...
                            if (UserObject.isReplyUser(user2) || UserObject.isUserSelf(user2) || (userProfilePhoto2 = user2.photo) == null || (fileLocation2 = userProfilePhoto2.photo_small) == null) {
                                ...
                                if (fileLocation2.volume_id != j3 && fileLocation2.local_id != 0) {
                                    ...
                                    if (fileLocation2 == null) {
                                        try {
                                            decodeFile2 = BitmapFactory.decodeFile(azVar.getFileLoader().getPathToAttach(fileLocation2, r12).toString());
                                        } catch (Throwable th2) {
                                            th = th2;
                                            c10 = 1;
                                            FileLog.e(th);
                                            ArrayList arrayList2 = (ArrayList) azVar.getMessagesController().dialogMessage.f(dialog2.id);
                                            if (arrayList2 != null) {
                                            }
                                    ...
                                    ArrayList arrayList22 = (ArrayList) azVar.getMessagesController().dialogMessage.f(dialog2.id);
                                    messageObject = (arrayList22 != null || arrayList22.size() <= 0) ? null : (MessageObject) arrayList22.get(i15);
                                    if (messageObject == null) {
                                        long fromChatId = messageObject.getFromChatId();
                                        if (fromChatId > j3) {
                                            user3 = azVar.getMessagesController().getUser(Long.valueOf(fromChatId));
                                            chat3 = null;
                                        } else {
                                            chat3 = azVar.getMessagesController().getChat(Long.valueOf(-fromChatId));
                                            user3 = null;
                                        }
                                                    ...
                                                    if (charSequence5 != null) {
                                                        ...
                                                        if (messageObject.messageOwner.media == null || messageObject.isMediaEmpty()) {
                                                            ...
                                                            if (messageMedia2 instanceof TLRPC.TL_messageMediaPoll) {
                                                                j10 = a4.a.q("📊 \u2068", ((TLRPC.TL_messageMediaPoll) messageMedia2).poll.question.text, "\u2069");
                                                            } else if (messageMedia2 instanceof TLRPC.TL_messageMediaGame) {
                                                                j10 = a4.a.q("🎮 \u2068", messageMedia2.game.title, "\u2069");
                                                            } else {
                                                                j10 = messageObject.type == 14 ? org.telegram.ui.Cells.q3.j("🎧 \u2068", messageObject.getMusicAuthor(), " - ", messageObject.getMusicTitle(), "\u2069") : messageObject.messageText.toString();
                                                                c12 = '\n';
                                                            }
                                    ...
                                    if (dialog2.unread_count <= 0) {
                                        ...
                                        if (azVar.getMessagesController().isDialogMuted(dialog2.id, j3)) {
                        ...
                        ArrayList arrayList222 = (ArrayList) azVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        i11 = i16;
                        TLRPC.Chat chat4 = azVar.getMessagesController().getChat(Long.valueOf(-dialog2.id));
                        if (chat4 != null) {
                            str2 = chat4.title;
                            ...
                            if (chatPhoto == null || (fileLocation2 = chatPhoto.photo_small) == null || fileLocation2.volume_id == j3 || fileLocation2.local_id == 0) {
                                ...
                                ArrayList arrayList2222 = (ArrayList) azVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        ArrayList arrayList22222 = (ArrayList) azVar.getMessagesController().dialogMessage.f(dialog2.id);
            ...
            while (true) {
                ...
                for (int i19 = 2; i18 < i19; i19 = 2) {
                    int i20 = (i17 * 2) + i18;
                    if (arrayList.isEmpty()) {
                        if (i20 < azVar.getMediaDataController().hints.size()) {
                            long j11 = azVar.getMediaDataController().hints.get(i20).peer.user_id;
                            dialog = (TLRPC.Dialog) azVar.getMessagesController().dialogs_dict.f(j11);
                            if (dialog == null) {
                        ...
                        if (i20 < arrayList.size()) {
                            dialog = (TLRPC.Dialog) azVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i20)).longValue());
                            if (dialog == null) {
                                dialog = new TLRPC.TL_dialog();
                    ...
                    if (dialog == null) {
                        ...
                        if (DialogObject.isUserDialog(dialog.id)) {
                            user = azVar.getMessagesController().getUser(Long.valueOf(dialog.id));
                            ...
                            TLRPC.Chat chat5 = azVar.getMessagesController().getChat(Long.valueOf(-dialog.id));
                        ...
                        if (fileLocation != null) {
                            try {
                                decodeFile = BitmapFactory.decodeFile(azVar.getFileLoader().getPathToAttach(fileLocation, true).toString());
                            } catch (Throwable th3) {
                                th = th3;
                                FileLog.e(th);
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        az azVar = this.r;
        c5Var = ((org.telegram.ui.ActionBar.n2) azVar).parentLayout;
        ...
        while (i10 < 2) {
            ...
            if (drawable2 != null) {
                if (i10 == 1 && this.d != null) {
                    c5Var2 = ((org.telegram.ui.ActionBar.n2) azVar).parentLayout;
                    if (c5Var2 != null) {
