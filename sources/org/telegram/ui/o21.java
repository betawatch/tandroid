...
public final class o21 extends org.telegram.ui.ActionBar.n2 {
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        this.c = new k21(context);
        l21 l21Var = new l21(context, this.c, this.resourceProvider, true);
        this.b = l21Var;
        this.actionBar.setAdaptiveBackground(l21Var);
                                ...
                                if (i13 >= editTextBoldCursorArr.length) {
                                    ...
                                    if ((i12 != 1 || i13 != 4) && (i12 != 2 || (i13 != 2 && i13 != 3))) {
                                        ...
                                        if (TextUtils.isEmpty(str)) {
                                            o21Var.a[i13].setText((CharSequence) null);
                                        } else {
                                            try {
                                                o21Var.a[i13].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                o21Var.a[i13].setText(str);
                                            }
                                        }
                                    }
                                    i13++;
        ...
        for (int i12 = 0; i12 < 3; i12++) {
            ...
            if (i12 == 0) {
                l6VarArr[i12].c(LocaleController.getString(R.string.UseProxySocks5), e == this.v, true);
            } else if (i12 == 1) {
                l6VarArr[i12].c(LocaleController.getString(R.string.UseProxyTelegram), e == this.v, true);
            } else {
                l6VarArr[i12].c(LocaleController.getString(R.string.UseProxyWeb), e == this.v, false);
            }
            this.c.addView(l6VarArr[i12], w7.y5.n(-1, 50));
        ...
        c7VarArr[0] = c7Var;
        this.c.addView(c7Var, w7.y5.n(-1, -2));
        ...
        while (i14 < i13) {
            ...
            if (i14 == 0) {
                ...
                this.a[i14].addTextChangedListener(new m21(this, 0));
            } else if (i14 == 1) {
                this.a[i14].setInputType(2);
                this.a[i14].addTextChangedListener(new m21(this, 1));
            } else if (i14 == 3) {
            ...
            if (i14 == 4) {
                this.a[i14].addTextChangedListener(new m21(this, 2));
            }
        ...
        for (int i16 = 0; i16 < 2; i16++) {
            ...
            this.c.addView(f9VarArr[i16], w7.y5.n(-1, -2));
        }
                            ...
                            while (true) {
                                ...
                                if (i132 >= editTextBoldCursorArr.length) {
                                    ...
                                    if ((i122 != 1 || i132 != 4) && (i122 != 2 || (i132 != 2 && i132 != 3))) {
                                        ...
                                        if (TextUtils.isEmpty(str)) {
                                            o21Var.a[i132].setText((CharSequence) null);
                                        } else {
                                            try {
                                                o21Var.a[i132].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                o21Var.a[i132].setText(str);
                                            }
                                        }
                                    }
                                    i132++;
        ...
        c7VarArr[2] = c7Var2;
        this.c.addView(c7Var2, 1, w7.y5.n(-1, -2));
        c7VarArr[2].setVisibility(8);
        ...
        c7VarArr[1] = c7Var3;
        this.c.addView(c7Var3, w7.y5.n(-1, -2));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(faVar, TLObject.FLAG_28, null, null, null, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.n, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i13));
        ...
        if (this.a != null) {
            ...
            while (true) {
                ...
                arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, wy0Var, org.telegram.ui.ActionBar.j6.k6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, wy0Var, org.telegram.ui.ActionBar.j6.l6));
