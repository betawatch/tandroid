...
public final class fr0 extends org.telegram.ui.Components.qv0 {
    ...
    */
    public final boolean Z() {
        ...
        if (!ir0Var.w) {
            if (Math.abs(gr0VarArr[1].getTranslationX()) < 1.0f) {
                gr0VarArr[0].setTranslationX(r2.getMeasuredWidth() * (ir0Var.v ? -1 : 1));
                gr0VarArr[1].setTranslationX(0.0f);
                animatorSet = ir0Var.r;
                if (animatorSet != null) {
                }
                ir0Var.s = false;
            }
        ...
        if (Math.abs(gr0VarArr[0].getTranslationX()) < 1.0f) {
            gr0VarArr[0].setTranslationX(0.0f);
            gr0VarArr[1].setTranslationX(gr0VarArr[0].getMeasuredWidth() * (ir0Var.v ? 1 : -1));
            animatorSet = ir0Var.r;
            if (animatorSet != null) {
                animatorSet.cancel();
                ir0Var.r = null;
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        ir0 ir0Var = this.D0;
        int emojiPadding = (dp < 0 || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : ir0Var.d.getEmojiPadding();
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        if (AndroidUtilities.dp(20.0f) < 0) {
            ...
            size2 -= ir0Var.d.getEmojiPadding();
            ...
            while (true) {
                gr0VarArr = ir0Var.n;
                if (i13 < gr0VarArr.length) {
                    break;
                }
                gr0 gr0Var = gr0VarArr[i13];
                if (gr0Var != null && (ml0Var = gr0Var.d) != null) {
            ...
            for (i14 = 0; i14 < childCount; i14++) {
                ...
                if (childAt != null && childAt.getVisibility() != 8) {
                    kVar3 = ((org.telegram.ui.ActionBar.o2) ir0Var).actionBar;
                    if (childAt != kVar3) {
                        org.telegram.ui.Components.ju juVar = ir0Var.d;
                        if (juVar == null || !juVar.l(childAt)) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.x0 && !this.y0) {
            ...
            if (this.x0 && (((z10 = ir0Var.v) && x10 > 0) || (!z10 && x10 < 0))) {
                if (!a0(motionEvent, x10 < 0)) {
                    this.y0 = true;
                    this.x0 = false;
                    gr0VarArr[0].setTranslationX(0.0f);
                    gr0VarArr[1].setTranslationX(ir0Var.v ? gr0VarArr[0].getMeasuredWidth() : -gr0VarArr[0].getMeasuredWidth());
            ...
            this.B0.computeCurrentVelocity(MediaDataController.MAX_STYLE_RUNS_COUNT, ir0Var.x);
            ...
            if (this.x0) {
                ...
                ir0Var.r = new AnimatorSet();
                boolean z11 = Math.abs(x11) < ((float) gr0VarArr[0].getMeasuredWidth()) / 3.0f && (Math.abs(f7) < 3500.0f || Math.abs(f7) < Math.abs(f10));
                ir0Var.w = z11;
                Property property = View.TRANSLATION_X;
                if (z11) {
                    measuredWidth = Math.abs(x11);
                    if (ir0Var.v) {
                        ir0Var.r.playTogether(ObjectAnimator.ofFloat(gr0VarArr[0], (Property<gr0, Float>) property, 0.0f), ObjectAnimator.ofFloat(gr0VarArr[1], (Property<gr0, Float>) property, r1.getMeasuredWidth()));
                    } else {
                        ir0Var.r.playTogether(ObjectAnimator.ofFloat(gr0VarArr[0], (Property<gr0, Float>) property, 0.0f), ObjectAnimator.ofFloat(gr0VarArr[1], (Property<gr0, Float>) property, -r1.getMeasuredWidth()));
                    }
                } else {
                    ...
                    if (ir0Var.v) {
                        ir0Var.r.playTogether(ObjectAnimator.ofFloat(gr0VarArr[0], (Property<gr0, Float>) property, -r9.getMeasuredWidth()), ObjectAnimator.ofFloat(gr0VarArr[1], (Property<gr0, Float>) property, 0.0f));
                    } else {
                        ir0Var.r.playTogether(ObjectAnimator.ofFloat(gr0VarArr[0], (Property<gr0, Float>) property, r9.getMeasuredWidth()), ObjectAnimator.ofFloat(gr0VarArr[1], (Property<gr0, Float>) property, 0.0f));
                    }
                }
                ir0Var.r.setInterpolator(ir0.y);
                ...
                ir0Var.r.setDuration(Math.max(ImageReceiver.DEFAULT_CROSSFADE_DURATION, Math.min(Math.abs(f7) > 0.0f ? Math.round(Math.abs(distanceInfluenceForSnapDuration / r4) * 1000.0f) * 4 : (int) (((measuredWidth / getMeasuredWidth()) + 1.0f) * 100.0f), 600)));
                ir0Var.r.addListener(new er0(this, 0));
                ir0Var.r.start();
                ir0Var.s = true;
                this.x0 = false;
            } else {
