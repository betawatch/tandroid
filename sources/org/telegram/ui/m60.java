...
public final class m60 extends org.telegram.ui.Components.jk0 {
        ...
        if (o60Var.L || o60Var.K || z10) {
            ...
            if (z10) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    if (DialogObject.isUserDialog(dialog.id) && !hashSet.contains(Long.valueOf(dialog.id)) && (user = o60Var.getMessagesController().getUser(Long.valueOf(dialog.id))) != null && !UserObject.isDeleted(user) && !UserObject.isUserSelf(user) && !UserObject.isBot(user) && !UserObject.isService(dialog.id) && !MessagesController.isSupportUser(user)) {
                        this.r.add(user);
                ...
                for (int i12 = 0; i12 < size2; i12++) {
                    ...
                    if (DialogObject.isChatDialog(dialog2.id) && (chat = o60Var.getMessagesController().getChat(Long.valueOf(-dialog2.id))) != null && chat.migrated_to == null && (!ChatObject.isChannel(chat) || chat.megagroup)) {
                        this.r.add(chat);
                    }
                }
            }
            Collections.sort(this.r, new i60());
            TLObject tLObject = null;
            int i13 = 0;
            while (i13 < this.r.size()) {
                TLObject tLObject2 = (TLObject) this.r.get(i13);
                if (tLObject != null) {
                    String a2 = i60.a(tLObject);
                    String substring = TextUtils.isEmpty(a2) ? "" : a2.substring(0, 1);
                    String a3 = i60.a(tLObject2);
                ...
                String a10 = i60.a(tLObject2);
                arrayList2.add(i13, new n60(TextUtils.isEmpty(a10) ? "" : a10.substring(0, 1)));
                i13++;
                tLObject = tLObject2;
            }
        }
    ...
    public final boolean D(f2.o1 o1Var) {
        ...
        return !(object instanceof TLRPC.User) || o60Var.F.h(((TLRPC.User) object).id) < 0;
    }
    ...
    public final void v(f2.o1 o1Var, int i10) {
            ...
            if (this.n) {
                ...
                if (i12 >= 0 && i12 < arrayList.size()) {
                    ...
                    if (tLObject2 instanceof n60) {
                        s3Var.setText(((n60) tLObject2).a.toUpperCase());
                    }
                }
            }
            if (i10 == this.v) {
        ...
        if (this.n) {
            ...
            if (i10 == this.x) {
                d4Var.r = true;
                d4Var.f = "premium";
                d4Var.a.setImageDrawable(org.telegram.ui.Cells.d4.b(d4Var.getContext(), false));
                d4Var.b.l(LocaleController.getString(R.string.PrivacyPremium), false);
                org.telegram.ui.ActionBar.h5 h5Var = d4Var.c;
            ...
            if (i10 == this.y) {
                ...
                d4Var.b.l(LocaleController.getString(R.string.PrivacyMiniapps), false);
                org.telegram.ui.ActionBar.h5 h5Var2 = d4Var.c;
