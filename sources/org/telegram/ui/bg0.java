...
public final class bg0 extends org.telegram.ui.Components.vv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public bg0(yg0 yg0Var, Context context, int i10) {
        super(context);
        ViewGroup viewGroup;
        this.s0 = yg0Var;
        this.U = new Object();
        ...
        String string = yg0Var.F != 1 ? null : LocaleController.getString(R.string.CancelAccountReset);
        if (i10 == 11) {
            ...
            yf0 yf0Var = new yf0(this, context, 0);
            this.f = yf0Var;
            ...
            if (i10 == 3) {
                ...
                if (i10 != 11) {
                    yf0 yf0Var2 = new yf0(this, context, 1);
                    this.f = yf0Var2;
                    addView(yf0Var2, w7.x5.t(-2, 42, 1, 0, 32, 0, 0));
                }
                if (i10 == 3) {
                ...
                n2Var.setTextColor(yg0Var.getThemedColor(i11));
                ...
                final int i12 = 0;
                n2Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.wf0
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (i12) {
                                ...
                                if (bg0Var.V <= 0 || bg0Var.R == null) {
                                    ...
                                    if (i14 != 4 && i14 != 2 && i14 != 17 && i14 != 16 && i14 != 11 && i14 != 15) {
                                        if (i14 == 3) {
                                            ...
                                            NotificationCenter.getGlobalInstance().removeObserver(bg0Var, NotificationCenter.didReceiveSmsCode);
                                            bg0Var.c0 = false;
                                            bg0Var.v();
                                            bg0Var.i0 = false;
                                            bg0Var.x();
                                        ...
                                        bundle.putString("phone", bg0Var.b);
                                        bundle.putString("ephone", bg0Var.e);
                                        bundle.putString("phoneFormated", bg0Var.d);
                                        bundle.putInt("prevType", bg0Var.f0);
                                        bg0Var.s();
                                        TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                                        tL_auth_resendCode.phone_number = bg0Var.d;
                                        tL_auth_resendCode.phone_code_hash = bg0Var.c;
                                        i13 = ((org.telegram.ui.ActionBar.o2) bg0Var.s0).currentAccount;
                                        ConnectionsManager.getInstance(i13).sendRequest(tL_auth_resendCode, new tf0(bg0Var, bundle, 0), 10);
                                        break;
                                    }
                                }
                                break;
                            default:
                                ...
                                bg0Var2.getClass();
                                try {
                                    bg0Var2.getContext().startActivity(new Intent("android.intent.action.VIEW", Uri.parse(bg0Var2.n0)));
                                    break;
                                } catch (Exception e) {
                                    FileLog.e(e);
                                }
                ...
                this.y = frameLayout4;
                zf0 zf0Var = new zf0(this, context, 0);
                this.v = zf0Var;
                zf0Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
                ...
                zf0Var.setGravity(51);
                final int i13 = 1;
                zf0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.wf0
                    public final /* synthetic */ bg0 b;
                            ...
                            case 1:
                                ...
                                if (bg0Var.V <= 0 || bg0Var.R == null) {
                                    ...
                                    if (i14 != 4 && i14 != 2 && i14 != 17 && i14 != 16 && i14 != 11 && i14 != 15) {
                                        ...
                                        tL_auth_resendCode.phone_number = bg0Var.d;
                                        tL_auth_resendCode.phone_code_hash = bg0Var.c;
                                        i132 = ((org.telegram.ui.ActionBar.o2) bg0Var.s0).currentAccount;
                                        ConnectionsManager.getInstance(i132).sendRequest(tL_auth_resendCode, new tf0(bg0Var, bundle, 0), 10);
                                        break;
                                    }
                                }
                                break;
                ...
                frameLayout4.addView(zf0Var, w7.x5.e(-2, -2, 49));
                he0 he0Var = new he0(context, 1);
                this.w = he0Var;
                if (i10 == 15) {
                    Animation loadAnimation = AnimationUtils.loadAnimation(context, R.anim.text_in);
                    Interpolator interpolator = org.telegram.ui.Components.kt.e;
                    ...
                    frameLayout4.addView(zf0Var2, w7.x5.e(-1, -2, 17));
                    he0Var.addView(frameLayout4, w7.x5.e(-2, -2, 17));
                } else {
                    Animation loadAnimation3 = AnimationUtils.loadAnimation(context, R.anim.scale_in);
                    Interpolator interpolator2 = org.telegram.ui.Components.qr.f;
                    loadAnimation3.setInterpolator(interpolator2);
                    he0Var.setInAnimation(loadAnimation3);
                    ...
                    he0Var.setOutAnimation(loadAnimation4);
                    ...
                    final int i14 = 2;
                    linearLayout2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.wf0
                        public final /* synthetic */ bg0 b;
                    ...
                    he0Var.addView(linearLayout2, w7.x5.c(52.0f, -1));
                ...
                he0Var.addView(textView7, w7.x5.e(-2, -2, 17));
                if (viewGroup != null) {
                    FrameLayout frameLayout5 = new FrameLayout(context);
                    frameLayout5.addView(he0Var, w7.x5.d(i10 == 15 ? -1 : -2, -2.0f, 81, 0.0f, 0.0f, 0.0f, 32.0f));
                    addView(frameLayout5, w7.x5.l(1.0f, -1, 0));
                } else {
                    viewGroup.addView(he0Var, w7.x5.d(-2, -2.0f, 81, 0.0f, 0.0f, 0.0f, 32.0f));
                }
                n7.a1.j(he0Var);
                if (i10 == 15) {
                    this.x.setOnClickListener(new uv(20, this, context));
                    return;
                }
                return;
            }
        ...
        n2Var2.setTextColor(yg0Var.getThemedColor(i112));
        ...
        final int i122 = 0;
        n2Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.wf0
            public final /* synthetic */ bg0 b;
        ...
        zf0 zf0Var3 = new zf0(this, context, 0);
        this.v = zf0Var3;
        zf0Var3.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, i112, false));
        zf0Var3.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        zf0Var3.setPadding(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(14.0f), AndroidUtilities.dp(16.0f));
        zf0Var3.setTextSize(1, 15.0f);
        zf0Var3.setGravity(51);
        final int i132 = 1;
        zf0Var3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.wf0
            public final /* synthetic */ bg0 b;
                    ...
                    case 1:
                        ...
                        if (bg0Var.V <= 0 || bg0Var.R == null) {
                            ...
                            if (i142 != 4 && i142 != 2 && i142 != 17 && i142 != 16 && i142 != 11 && i142 != 15) {
                                ...
                                tL_auth_resendCode.phone_number = bg0Var.d;
                                tL_auth_resendCode.phone_code_hash = bg0Var.c;
                                i1322 = ((org.telegram.ui.ActionBar.o2) bg0Var.s0).currentAccount;
                                ConnectionsManager.getInstance(i1322).sendRequest(tL_auth_resendCode, new tf0(bg0Var, bundle, 0), 10);
                                break;
                            }
                        }
                        break;
        ...
        frameLayout42.addView(zf0Var3, w7.x5.e(-2, -2, 49));
        he0 he0Var2 = new he0(context, 1);
        this.w = he0Var2;
        if (i10 == 15) {
        }
        ...
        he0Var2.addView(textView72, w7.x5.e(-2, -2, 17));
        if (viewGroup != null) {
        }
        n7.a1.j(he0Var2);
        if (i10 == 15) {
    ...
    public static /* synthetic */ void o(bg0 bg0Var, Context context) {
        try {
            ...
            sb2.append(str);
            sb2.append(bg0Var.s0.e ? " #paidauth" : "");
            ...
            sb3.append("\n");
            sb3.append("Issue: ");
            sb3.append(bg0Var.s0.e ? "no_otp" : "no_otp_paid");
            sb3.append("\n");
            if (!TextUtils.isEmpty(bg0Var.e0)) {
                sb3.append("Error: ");
                sb3.append(bg0Var.e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            bg0Var.s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }

    public static void r(org.telegram.ui.Components.yi0 yi0Var) {
        if (yi0Var != null) {
            yi0Var.Q(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.P9, false), "Bubble");
            int i10 = org.telegram.ui.ActionBar.j6.G6;
            yi0Var.Q(org.telegram.ui.ActionBar.j6.w0(null, i10, false), "Phone");
            yi0Var.Q(org.telegram.ui.ActionBar.j6.w0(null, i10, false), "Note");
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (yi0Var2.a0 != yi0Var2.e[0] - 1) {
            yi0Var2.t0 = new uf0(this, i10, 0);
            return;
        }
        yi0Var.t0 = new of0(this, 3);
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            c2Var.R = string;
            c2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.b));
            alertDialog$Builder.k(LocaleController.getString(R.string.Close), null);
            alertDialog$Builder.h(LocaleController.getString(R.string.Edit), new qf0(this, i11));
            yg0Var.showDialog(c2Var);
            return false;
        }
        this.d0 = false;
        z(true);
    ...
    public final void h(String str) {
        ...
        if (i15 < 1 || i15 > 4 || !fsVar.e) {
            ...
            if (i17 == 2) {
                ...
                int length2 = isVarArr2.length;
                while (i14 < length2) {
                    isVarArr2[i14].j(0.0f);
                    i14++;
                }
            ...
            w();
            fsVar.e = true;
            is[] isVarArr3 = fsVar.f;
            int length3 = isVarArr3.length;
            while (i14 < length3) {
                isVarArr3[i14].j(0.0f);
                i14++;
            }
    ...
    public final void j() {
        ...
        AndroidUtilities.runOnUIThread(new of0(this, 0), yg0.t0);
    }
    ...
    public final void l(Bundle bundle) {
        ...
        if (this.H != null) {
            bundle.putBundle(hg.k0.i(i10, "smsview_params_"), this.H);
        }
        int i11 = this.V;
        if (i11 != 0) {
    ...
    */
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (i19 == 15) {
            ...
            if (i19 == 2) {
                ...
                if (z10) {
                    AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.sh(23));
                }
            }
        }
        this.H = bundle;
        ...
        for (is isVar : this.f.f) {
            isVar.setShowSoftInputOnFocusCompat(!a() || AndroidUtilities.isAccessibilityTouchExplorationEnabled());
            isVar.addTextChangedListener(new l0(this, 9));
            isVar.setOnFocusChangeListener(new qd(this, i17));
        }
        int i20 = this.h0;
        if (i20 == 17) {
        ...
        if (this.s0.i1()) {
            ...
            if (indexOf != -1 && lastIndexOf != -1 && indexOf != lastIndexOf) {
                ...
                replaceTags.setSpan(new org.telegram.ui.Components.n51("tg://settings/change_number", (org.telegram.ui.Components.p01) null), indexOf, lastIndexOf - 1, 33);
            }
        } else {
            int i21 = this.f0;
            if (i21 == 1) {
                ...
                if (i21 != 4) {
                    ...
                    if (i12 != 1) {
                        ...
                        if (i12 == 2) {
                            ...
                            zf0 zf0Var3 = this.x;
                            if (zf0Var3 != null) {
                                zf0Var3.setVisibility(this.V < 1000 ? 0 : 8);
                            }
                        ...
                        if (i12 == i10) {
                            ...
                            zf0 zf0Var4 = this.x;
                            if (zf0Var4 != null) {
                                zf0Var4.setVisibility(this.V < 1000 ? 0 : 8);
                            }
                            u();
                        }
                        if (i12 == 11) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        fs fsVar = this.f;
        if (fsVar == null || (isVarArr = fsVar.f) == null) {
            return;
        }
    ...
    public final void q(Runnable runnable) {
        ...
        while (true) {
            ...
            if (i10 >= fsVar.f.length) {
                fsVar.postDelayed(new oa0(20, this, runnable), (r2.length * 75) + 400);
                return;
            } else {
                fsVar.postDelayed(new uf0(this, i10, 2), i10 * 75);
                i10++;
            }
        }
    }
    ...
    public final void y() {
        ...
        AndroidUtilities.shakeViewSpring(fsVar, this.f0 == 11 ? 3.5f : 10.0f, new of0(this, 7));
        of0 of0Var = this.r0;
    ...
    public final void z(boolean z10) {
        ...
        if (this.Q) {
            ...
            yi0Var.K(0);
            yi0Var.S(yi0Var.e[0] - 1, new of0(this, 1));
        }
    }
}
