...
public final class bg1 extends org.telegram.ui.Cells.r2 {
    ...
    public final void f0() {
        ...
        eg1 eg1Var = this.h5;
        if (z10) {
            ((ng.c) drawable).a(i0.a.d(this.f5, eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.R9), eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.L7)));
        }
        Drawable[] drawableArr = this.h0;
        if (drawableArr != null) {
            Drawable drawable2 = drawableArr[0];
            if (drawable2 instanceof ng.c) {
                ((ng.c) drawable2).a(i0.a.d(this.f5, eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.R9), eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.L7)));
            }
        }
        invalidate();
    }
    ...
    public final void g0(boolean z10) {
        ...
        this.g5 = ofFloat;
        ofFloat.addUpdateListener(new a21(this, 18));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawColor(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.d6));
        super.onDraw(canvas);
        canvas.restore();
        canvas.save();
    ...
    public void setAnimatedEmojiDrawable(org.telegram.ui.Components.o5 o5Var) {
        ...
        if (o5Var2 != null && this.b5) {
            o5Var2.o(this);
        }
        if (o5Var != null) {
            o5Var.setColorFilter(org.telegram.ui.ActionBar.i6.v3);
        }
        this.Z4 = o5Var;
        if (o5Var == null || !this.b5) {
            return;
        }
        o5Var.a(this);
    }
    ...
    public void setTopicIcon(TLRPC.TL_forumTopic tL_forumTopic) {
        ...
        if (tL_forumTopic != null && tL_forumTopic.id == 1) {
            ...
            setForumIcon(ng.d.c(getContext(), 1.0f, eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.Ac), false));
            ...
            if (o5Var == null || o5Var.i() != tL_forumTopic.icon_emoji_id) {
                ...
                setAnimatedEmojiDrawable(new org.telegram.ui.Components.o5(i11, i10, tL_forumTopic.icon_emoji_id));
            }
        }
