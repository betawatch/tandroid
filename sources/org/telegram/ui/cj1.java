...
public final class cj1 implements ci0 {
    ...
    public final void a(final Canvas canvas) {
        ...
        final float y10 = recordCircle == null ? 0.0f : (recordCircle.getY() + recordCircle.K) - xiVar.getY();
        ...
        if (i10 != i11) {
            ...
            y3 = (vl0Var.getY() + (t1Var.getY() + t1Var.getRadialProgress().a.centerY())) - xiVar.getY();
            x10 = (vl0Var.getX() + (t1Var.getX() + t1Var.getRadialProgress().a.centerX())) - xiVar.getX();
        }
        this.k = x10;
        this.l = y3;
        float interpolation = org.telegram.ui.Components.wr.f.getInterpolation(f10);
        float interpolation2 = org.telegram.ui.Components.wr.h.getInterpolation(f10);
        ...
        if (recordCircle != null) {
            ...
            f7 = x11;
            float interpolation3 = org.telegram.ui.Components.wr.g.getInterpolation(recordCircle.H);
        ...
        final float f23 = f7;
        t1Var.q2(canvas, interpolation, new Runnable() { // from class: org.telegram.ui.aj1
            ...
            public final void run() {
                ...
                Drawable drawable;
                cj1 cj1Var = cj1.this;
                RadialProgress2 radialProgress = cj1Var.a.getRadialProgress();
                ...
                ChatActivityEnterView.RecordCircle recordCircle2 = cj1Var.g;
                if (recordCircle2 != null) {
                    ...
                    if (z10) {
                        ...
                        canvas2 = canvas3;
                        f24 = f31;
                        rect.set(org.telegram.messenger.em.w(2, i14, drawable), org.telegram.messenger.em.e(2, i15, drawable), org.telegram.messenger.em.B(2, i14, drawable), org.telegram.messenger.em.z(2, i15, drawable));
                        if (drawable2 != null) {
                            drawable2.setBounds(org.telegram.messenger.em.w(2, i14, drawable2), org.telegram.messenger.em.e(2, i15, drawable2), org.telegram.messenger.em.B(2, i14, drawable2), org.telegram.messenger.em.z(2, i15, drawable2));
                        }
                    } else {
                        canvas2 = canvas3;
                        f24 = f31;
