...
public final class qw0 extends LinearLayout {
    ...
    public qw0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        mw0 mw0Var = new mw0(this, context, premiumPreviewFragment.e0 ? 1 : 0, i10 == 1 ? 1 : 0, context);
        this.d = mw0Var;
        ...
        nw0Var.setSelectorTransformer(new q0.a() { // from class: org.telegram.ui.kw0
            @Override // q0.a
            public final void accept(Object obj) {
                Canvas canvas = (Canvas) obj;
                nw0 nw0Var2 = qw0.this.e;
                View pressedChildView = nw0Var2.getPressedChildView();
                int b10 = pressedChildView == null ? -1 : nw0Var2.T(pressedChildView).b();
                Path path2 = path;
                path2.rewind();
    ...
    */
    public final void a() {
        ...
        if (premiumPreviewFragment.getMediaDataController().getPremiumPromo() != null) {
            ...
            while (i10 < size) {
                ...
                sw0 sw0Var = new sw0(tL_premiumSubscriptionOption2);
                ...
                if (tL_premiumSubscriptionOption2.current) {
                    premiumPreviewFragment.f = sw0Var;
                }
                if (BuildVars.useInvoiceBilling() && sw0Var.i() > j10) {
                    j10 = sw0Var.i();
                }
            }
        } else {
        ...
        if (BuildVars.useInvoiceBilling()) {
            ...
            while (i12 < size3) {
                ...
                i12++;
                sw0 sw0Var3 = (sw0) obj2;
                sw0Var3.f = BillingController.PREMIUM_PRODUCT_DETAILS;
                if (sw0Var3.i() > j11) {
                    j11 = sw0Var3.i();
                }
                sw0Var3.a();
            ...
            if (z4) {
                ...
                while (i13 < arrayList.size()) {
                    sw0 sw0Var4 = (sw0) arrayList.get(i13);
                    sw0Var4.a();
                    if (sw0Var4.g == null) {
        ...
        if (premiumPreviewFragment.e == -1) {
            ...
            while (true) {
                ...
                if (((sw0) arrayList.get(i15)).a.months == 12) {
    ...
    public final void b() {
        ...
        nw0 nw0Var = this.e;
        if (!z10 || !z4) {
            nw0Var.setVisibility(z4 ? 8 : 0);
            this.f = true;
        } else if (nw0Var.getVisibility() == 0 && z4 && this.h == z4) {
            ValueAnimator duration = ValueAnimator.ofFloat(1.0f, 0.0f).setDuration(250L);
            duration.addUpdateListener(new lw0(this, nw0Var, duration, r2));
