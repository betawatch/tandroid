...
public final class ah0 extends org.telegram.ui.Components.g6 {
    ...
    public ah0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.L = kVar2;
        kVar.u = org.telegram.ui.Cells.c1.l(1.0f, 1500.0f, 0.75f);
    ...
    public static void m(ah0 ah0Var, float f7, boolean z10, boolean z11) {
        View view;
        o1.k kVar = ah0Var.L;
        float f10 = Float.MAX_VALUE;
        if (ah0Var.getChildCount() != 0) {
            float f11 = -3.4028235E38f;
            boolean z12 = false;
            float f12 = Float.MAX_VALUE;
            for (int i10 = 0; i10 < ah0Var.getChildCount(); i10++) {
                View childAt = ah0Var.getChildAt(i10);
        ...
        if (ah0Var.getChildCount() == 0) {
            ...
            view = null;
            for (int i11 = 0; i11 < ah0Var.getChildCount(); i11++) {
                View childAt2 = ah0Var.getChildAt(i11);
        ...
        if (view != null) {
            ah0Var.O = view;
            int childCount2 = ah0Var.getChildCount();
            for (int i13 = 0; i13 < childCount2; i13++) {
                View childAt4 = ah0Var.getChildAt(i13);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < childCount3; i18++) {
            ...
            if (childAt2 instanceof zg0) {
                ((oh.b) ((zg0) childAt2)).setTextSizeDp(f14);
            }
        }
