...
public final class r81 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public r81(SessionsActivity sessionsActivity, Context context) {
        ...
        hVar.j = false;
        hVar.n = 1.2f;
        u9Var.setOnClickListener(new y7(this, 2));
        int i10 = org.telegram.ui.ActionBar.i6.G6;
        org.telegram.ui.ActionBar.i6.w0(null, i10, false);
        int i11 = org.telegram.ui.ActionBar.i6.d6;
        org.telegram.ui.ActionBar.i6.w0(null, i11, false);
        ...
        c90Var.setGravity(1);
        c90Var.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
        ...
        c90Var.setHighlightColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.K6, false));
        ...
        if (indexOf != -1 && indexOf2 != -1 && indexOf != indexOf2) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.m51(LocaleController.getString(R.string.AuthAnotherClientDownloadClientUrl), (org.telegram.ui.Components.o01) null), indexOf, indexOf2 - 1, 33);
        }
        ...
        if (indexOf3 != -1 && indexOf4 != -1 && indexOf3 != indexOf4) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.m51(LocaleController.getString(R.string.AuthAnotherWebClientUrl), (org.telegram.ui.Components.o01) null), indexOf3, indexOf4 - 1, 33);
        }
        ...
        skVar.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Sh, false));
        ...
        skVar.setBackground(org.telegram.ui.ActionBar.i6.i0(dp, dp, dp, dp, w02, w03, w03));
        skVar.setOnClickListener(new h41(this, 5));
        addView(skVar, w7.x5.d(-1, 48.0f, 80, 16.0f, 15.0f, 16.0f, 16.0f));
        b();
    }

    public static void a(r81 r81Var) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && sessionsActivity.getParentActivity().checkSelfPermission("android.permission.CAMERA") != 0) {
            ...
            u9.e0(sessionsActivity.getParentActivity(), 2, new p81(sessionsActivity));
        }
    }
