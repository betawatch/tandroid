...
public final class k30 extends kh.b {
    public final OvershootInterpolator d;
    public int e;
    public final /* synthetic */ f60 f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k30(f60 f60Var, LaunchActivity launchActivity) {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i15;
        f60 f60Var = this.f;
        Paint paint4 = f60Var.J1;
        org.telegram.ui.Components.voip.v2 v2Var = f60Var.r;
        org.telegram.ui.Components.voip.v2 v2Var2 = f60Var.v;
        Matrix matrix3 = f60Var.S0;
        org.telegram.ui.Components.ba baVar6 = f60Var.N0;
        org.telegram.ui.Components.ba baVar7 = f60Var.M0;
        RectF rectF2 = f60Var.v0;
        Paint paint5 = f60Var.T0;
        RadialProgressView radialProgressView5 = f60Var.e0;
        m40 m40Var = f60Var.T;
        int[] iArr = f60Var.X1;
        org.telegram.ui.Components.voip.v2 v2Var3 = f60Var.w;
        Paint paint6 = f60Var.I1;
        if (f60Var.l2 && f60Var.g2) {
            return;
        }
        int measuredWidth = (getMeasuredWidth() - getMeasuredHeight()) / 2;
        long elapsedRealtime = SystemClock.elapsedRealtime();
        long j3 = elapsedRealtime - f60Var.O1;
        f60Var.O1 = elapsedRealtime;
        if (j3 > 20) {
            j3 = 17;
        }
        long j10 = j3;
        e60 e60Var4 = f60Var.N1;
        if (e60Var4 != null) {
            e60Var4.b(0, measuredWidth, getMeasuredHeight(), j10, f60Var.O0);
        }
        ...
        e60 e60Var5 = f60Var.M1;
        if (e60Var5 != null && e60Var5.i == 3) {
            radialProgressView5.H = true;
            if (Math.abs(radialProgressView5.n) < 360.0f) {
                z10 = false;
                if (z10) {
                }
                float interpolation = (this.d.getInterpolation(f60Var.P1) * f7) + 0.4f;
                baVar6.e(f60Var.O0, 1.0f);
                baVar7.e(f60Var.O0, 1.0f);
                if (f60Var.M1 != null) {
                }
                canvas2 = canvas;
                paint2 = paint6;
        ...
        } else if (e60Var5 != null && (e60Var = f60Var.N1) != null && e60Var.i == 3) {
            radialProgressView5.H = true;
            ...
            if (z10) {
                float f24 = f60Var.L1;
                if (f24 != 1.0f) {
                    e60 e60Var6 = f60Var.M1;
                    if (e60Var6 == null || e60Var6.i != 3) {
                        f60Var.L1 = (j10 / 180.0f) + f24;
                    } else {
                        f60Var.L1 = (j10 / 100.0f) + f24;
                    }
                    if (f60Var.L1 >= 1.0f) {
                        f60Var.L1 = 1.0f;
                        f60Var.M1 = null;
                        e60 e60Var7 = f60Var.N1;
                        if (e60Var7 != null && e60Var7.i == 3) {
                            radialProgressView5.H = false;
                        }
                    }
                    f60Var.W1 = true;
                }
                if (!f60Var.W1 || (e60Var3 = f60Var.N1) == null) {
                    paint = paint4;
                    matrix = matrix3;
                    ...
                    f60Var.W1 = false;
                    e60 e60Var8 = f60Var.M1;
                    if (e60Var8 != null) {
                        f60.S(f60Var, e60Var8.i, iArr);
                        int i16 = iArr[0];
                        int i17 = iArr[1];
                        z11 = z10;
                        int i18 = iArr[2];
                        ...
                        int i19 = iArr[3];
                        matrix = matrix3;
                        f60.S(f60Var, f60Var.N1.i, iArr);
                        paint = paint4;
                        i12 = i0.a.d(f60Var.L1, i16, iArr[0]);
                        i13 = i0.a.d(f60Var.L1, i17, iArr[1]);
                        i14 = i0.a.d(f60Var.L1, i18, iArr[2]);
                        i15 = i0.a.d(f60Var.L1, i19, iArr[3]);
                    } else {
                        paint = paint4;
                        matrix = matrix3;
                        radialProgressView = radialProgressView5;
                        z11 = z10;
                        f60.S(f60Var, e60Var3.i, iArr);
                        i12 = iArr[0];
                        i13 = iArr[1];
                        i14 = iArr[2];
                        i15 = iArr[3];
                    ...
                    f60Var.n.a(i14, i13);
                    f60Var.f.a(i14, i13);
                    org.telegram.ui.Components.voip.v2 v2Var4 = f60Var.s;
                    int i20 = org.telegram.ui.ActionBar.h6.Dg;
                    v2Var4.a(org.telegram.ui.ActionBar.h6.w0(null, i20, false), org.telegram.ui.ActionBar.h6.w0(null, i20, false));
                    f60Var.h.a(i13, i15);
                }
                e60 e60Var9 = f60Var.N1;
                if (e60Var9 != null) {
                    int i21 = e60Var9.i;
                    z12 = i21 == 1 || i21 == 0 || f60.p1(i21);
                    i11 = 3;
                    if (f60Var.N1.i != 3) {
                        z13 = true;
                        if (f60Var.M1 == null && (e60Var2 = f60Var.N1) != null && e60Var2.i == i11) {
                            float f25 = f60Var.P1 - (j10 / 180.0f);
                            f60Var.P1 = f25;
                            if (f25 < f10) {
                                f60Var.P1 = 0.0f;
                            }
            ...
            float interpolation2 = (this.d.getInterpolation(f60Var.P1) * f7) + 0.4f;
            baVar6.e(f60Var.O0, 1.0f);
            baVar7.e(f60Var.O0, 1.0f);
            if (f60Var.M1 != null || f60Var.N1 == null || f60Var.r1()) {
                canvas2 = canvas;
                paint2 = paint6;
                radialProgressView2 = radialProgressView;
                matrix2 = matrix;
                ...
                e60 e60Var10 = f60Var.N1;
                f11 = 25.909092f;
                int i22 = e60Var10.i;
                f12 = 25.0f;
                if (i22 == 3 || f60Var.M1.i == 3) {
                    if (i22 == 3) {
                        f19 = f60Var.L1;
                        paint3 = paint6;
                        paint3.setShader(f60Var.M1.g);
                        f18 = 1.0f;
                    } else {
                        paint3 = paint6;
                        f18 = 1.0f;
                        float f34 = 1.0f - f60Var.L1;
                        paint3.setShader(e60Var10.g);
                        f19 = f34;
                    }
                    int offsetColor = AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.kg, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Kg, false), f60Var.U1, f18);
                    Paint paint7 = paint;
                    ...
                    f60Var.R0.setLocalMatrix(matrix4);
                    paint3.setAlpha(76);
                    canvas.save();
                    canvas.scale(v2Var3.getScaleX() * 1.0f, v2Var3.getScaleY() * 1.0f, measuredWidth2, y3);
                    canvas.save();
                    float x10 = com.google.android.gms.internal.vision.e2.x(0.807f, f60Var.O0, 0.5f, 0.878f) * f60Var.Q1;
                    ...
                    if (f60Var.a1 != null) {
                        canvas.save();
                        float B = com.google.android.gms.internal.vision.e2.B(0.807f, f60Var.O0, 0.878f, interpolation2);
                        canvas.scale(B, B, measuredWidth2, y3);
                        baVar6.a(measuredWidth2, y3, canvas, paint3);
                        canvas.restore();
                        canvas.save();
                        float B2 = com.google.android.gms.internal.vision.e2.B(0.704f, f60Var.O0, 0.926f, interpolation2);
            ...
            while (i10 < 2) {
                ...
                if (i10 == 0 && f60Var.M1 != null) {
                    if (!f60Var.r1()) {
                        paint2.setShader(f60Var.M1.g);
                    }
                    f14 = 1.0f - f60Var.L1;
                    if (f60Var.M1.i == 3) {
                    ...
                    f60Var.R0.setLocalMatrix(matrix2);
                    paint2.setAlpha((int) (f60Var.V0 * 76.0f * f15));
                    canvas2.save();
                    canvas2.scale(v2Var3.getScaleX() * 1.0f, v2Var3.getScaleX() * 1.0f, measuredWidth3, y10);
                    canvas2.save();
                    float x11 = com.google.android.gms.internal.vision.e2.x(f60Var.O0, 0.807f, 0.5f, 0.878f);
                    float f35 = f60Var.Q1;
                    ...
                    paint2.setAlpha((int) (f60Var.V0 * paint2.getAlpha()));
                    ...
                    if (m40Var != null) {
                        ...
                        float x12 = m40Var.getX() - getX();
                        float y11 = m40Var.getY() - getY();
                        rectF.set(x12, y11, m40Var.getMeasuredWidth() + x12, m40Var.getMeasuredHeight() + y11);
                        canvas2.save();
                    ...
                    if (paint2.getShader() == null || f60Var.r1()) {
                        f15 = f14;
                        f16 = dp2;
                    } else {
                        f15 = f14;
                        f16 = dp2;
                        paint2.setColor(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.kg, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Kg, false), f60Var.U1, 1.0f));
                    }
                    if (f60Var.r1()) {
                        ...
                        radialProgressView4 = radialProgressView2;
                        int offsetColor2 = AndroidUtilities.getOffsetColor(w02, org.telegram.ui.ActionBar.h6.w0(null, i23, false), f60Var.U1, 1.0f);
                        paint2.setColor(offsetColor2);
                        paint2.setShader(null);
                        int i24 = org.telegram.ui.ActionBar.h6.kg;
                        baVar4 = baVar7;
                        baVar3 = baVar6;
                        v2Var.a(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.h6.w0(null, i24, false), org.telegram.ui.ActionBar.h6.w0(null, i23, false), f60Var.U1, 1.0f), offsetColor2);
                        v2Var2.a(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.h6.w0(null, i24, false), org.telegram.ui.ActionBar.h6.w0(null, i23, false), f60Var.U1, 1.0f), offsetColor2);
                    }
                    ...
                    canvas2.save();
                    float x112 = com.google.android.gms.internal.vision.e2.x(f60Var.O0, 0.807f, 0.5f, 0.878f);
                    float f352 = f60Var.Q1;
                    canvas2.scale(f352 * x112, f352 * x112, measuredWidth32, y102);
                    if (i10 != 1 && !f60Var.r1() && LiteMode.isEnabled(512)) {
                        canvas2.save();
                        canvas2.scale(1.2f, 1.2f, measuredWidth32, y102);
                        int alpha = paint5.getAlpha();
                        paint5.setAlpha((int) ((1.0f - f60Var.z3.e) * f60Var.V0 * alpha));
                    ...
                    if (!f60Var.r1()) {
                        baVar2 = baVar4;
                        baVar5 = baVar3;
                    } else if (f60Var.V0 > 0.0f) {
                        canvas2.save();
                        float x13 = com.google.android.gms.internal.vision.e2.x(f60Var.O0, 0.807f, interpolation2, 0.878f);
                        canvas2.scale(x13, x13, measuredWidth32, y102);
                        baVar5 = baVar3;
                        baVar5.a(measuredWidth32, y102, canvas2, paint2);
                        canvas2.restore();
                        canvas2.save();
                        float x14 = com.google.android.gms.internal.vision.e2.x(f60Var.O0, 0.704f, interpolation2, 0.926f);
                    ...
                    if (f60.F3) {
                        ...
                        paint2.setAlpha((int) (f60Var.W0 * 255.0f));
                    } else {
                        paint2.setAlpha((int) (f60Var.W0 * f15 * 255.0f));
                    }
                    ...
                    if (m40Var != null && m40Var.getVisibility() == 0) {
                        paint2.setAlpha((int) (m40Var.getAlpha() * 255.0f));
                        float x122 = m40Var.getX() - getX();
                        float y112 = m40Var.getY() - getY();
                        rectF.set(x122, y112, m40Var.getMeasuredWidth() + x122, m40Var.getMeasuredHeight() + y112);
                        canvas2.save();
                        canvas2.scale(m40Var.getScaleX(), m40Var.getScaleY(), rectF.centerX(), rectF.centerY());
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(f17), AndroidUtilities.dp(f17), paint2);
                        canvas2.restore();
        ...
        float interpolation22 = (this.d.getInterpolation(f60Var.P1) * f7) + 0.4f;
        baVar6.e(f60Var.O0, 1.0f);
        baVar7.e(f60Var.O0, 1.0f);
        if (f60Var.M1 != null) {
        }
