...
public final class p70 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new org.telegram.ui.Components.z51(this, 17));
        ...
        frameLayout.addView(this.f, k7.c6.c(-1.0f, -1));
        ...
        this.f.addView(frameLayout2, k7.c6.l(50.0f, -1, -1));
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.FIT_XY);
        frameLayout2.addView(imageView, k7.c6.c(-1.0f, -1));
        l0 l0Var = new l0(this, context, 8);
        this.d = l0Var;
        l0Var.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.d6, false));
        this.f.addView(this.d, k7.c6.l(50.0f, -1, -1));
        LinearLayout linearLayout2 = new LinearLayout(context);
        this.e = linearLayout2;
        linearLayout2.setOrientation(1);
        this.e.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
        this.d.addView(this.e, k7.c6.e(-2, -2, 17));
        ...
        this.e.addView(this.b, k7.c6.q(-2, -2, 1));
        TextView textView2 = new TextView(context);
        this.a = textView2;
        textView2.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, i10, false));
        this.a.setLinkTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.J6, false));
        this.a.setTextSize(1, 16.0f);
        this.a.setLinksClickable(true);
        this.a.setClickable(true);
        this.a.setGravity(17);
        this.a.setMovementMethod(new org.telegram.ui.Components.mv(1));
        this.e.addView(this.a, k7.c6.e(-2, -2, 1));
        TextView textView3 = new TextView(context);
        this.c = textView3;
        textView3.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, i10, false));
        this.c.setGravity(17);
        this.c.setTextSize(1, 32.0f);
        this.d.addView(this.c, k7.c6.c(-2.0f, -2));
        ...
        this.c.setTag(Integer.valueOf(org.telegram.ui.ActionBar.k6.Me));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 1, null, null, null, null, org.telegram.ui.ActionBar.k6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.a, 2, null, null, null, null, org.telegram.ui.ActionBar.k6.J6));
        return arrayList;
    }
