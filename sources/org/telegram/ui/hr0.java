...
public final class hr0 extends org.telegram.ui.ActionBar.n2 {
    public static final org.telegram.ui.Components.vr0 y = new org.telegram.ui.Components.vr0(4);
    public final cr0 a;
    public final cr0 b;
    ...
    public hr0(HashMap hashMap, ArrayList arrayList, int i10, boolean z10, zn znVar) {
        ...
        this.f = new Paint();
        this.n = new fr0[2];
        this.a = new cr0(0, null, hashMap, arrayList, i10, z10, znVar, false);
        this.b = new cr0(1, null, hashMap, arrayList, i10, z10, znVar, false);
    }
    ...
    public static void h0(hr0 hr0Var, String str) {
        hr0Var.c.getSearchField().setText(str);
        hr0Var.c.getSearchField().setSelection(str.length());
        hr0Var.actionBar.w();
    }
    ...
    public final View createView(Context context) {
        ...
        while (true) {
            ...
            fr0Var4.b = (FrameLayout) fr0Var4.a.getFragmentView();
            fr0VarArr[i14].d.setClipToPadding(false);
            fr0 fr0Var5 = fr0VarArr[i14];
            fr0Var5.c = fr0Var5.a.getActionBar();
            fr0 fr0Var6 = fr0VarArr[i14];
            fr0Var6.addView(fr0Var6.b, w7.y5.c(-1.0f, -1));
            fr0 fr0Var7 = fr0VarArr[i14];
            fr0Var7.addView(fr0Var7.c, w7.y5.c(-2.0f, -1));
            fr0VarArr[i14].c.setVisibility(8);
        ...
        er0Var.addView(cr0Var.a0, w7.y5.d(60, 60.0f, 85, 0.0f, 0.0f, 12.0f, 10.0f));
        er0Var.addView(cr0Var.b0, w7.y5.d(42, 24.0f, 85, 0.0f, 0.0f, -2.0f, 9.0f));
