...
public class CommunityInviteOnlySheet extends BottomSheetWithRecyclerListView {
    ...
    protected RecyclerListView.SelectionAdapter createAdapter(RecyclerListView recyclerListView) {
        UniversalAdapter universalAdapter = new UniversalAdapter(this.recyclerListView, getContext(), this.currentAccount, 0, true, new Utilities.Callback2() { // from class: org.telegram.ui.community.sheet.CommunityInviteOnlySheet$$ExternalSyntheticLambda2
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                CommunityInviteOnlySheet.this.fillItems((ArrayList) obj, (UniversalAdapter) obj2);
            }
