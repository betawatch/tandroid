...
public class CommunityPendingRequestCell extends FrameLayout implements Theme.Colorable {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (Build.VERSION.SDK_INT >= 31 && this.sourceRenderNode != null && view == this.avatarView) {
            ...
            int left = this.avatarView.getLeft() - dp;
            int top = this.avatarView.getTop() - dp;
            int dp2 = AndroidUtilities.dp(52.0f) + (dp * 2);
            RecordingCanvas beginRecording = this.sourceRenderNode.beginRecording(dp2, dp2);
            beginRecording.translate(-left, -top);
            beginRecording.drawColor(Theme.getColor(Theme.key_windowBackgroundWhite, this.resourcesProvider));
            beginRecording.save();
            float f = dp2 / 2.0f;
            beginRecording.scale(1.125f, 1.125f, f, f);
            super.drawChild(beginRecording, view, j);
            beginRecording.restore();
            beginRecording.drawColor(TLObject.FLAG_29);
    ...
    public void set(TLRPC.Chat chat, TLRPC.ChatFull chatFull, TLRPC.User user, ClickDelegate clickDelegate, boolean z, boolean z2) {
        ...
        this.subtitleView.setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.CommunityPendingRequestSuggestedGroup, DialogObject.getShortName(user)), Theme.getColor(Theme.key_telegram_color_text), new Runnable() { // from class: org.telegram.ui.community.cells.CommunityPendingRequestCell$$ExternalSyntheticLambda4
    ...
    public static class Factory extends UItem.UItemFactory {
        ...
        public static UItem asPendingRequest(TLRPC.Chat chat, TLRPC.ChatFull chatFull, TLRPC.User user, boolean z, ClickDelegate clickDelegate, boolean z2) {
            ...
            ofFactory.object = new Data(chat, user, chatFull, z);
            ofFactory.object2 = clickDelegate;
            ofFactory.hideDivider = !z2;
            return ofFactory;
        }
    }
}
