...
public class CommunityRequestsCell extends LinearLayout implements Theme.Colorable {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(this.mini ? 44.0f : 50.0f), TLObject.FLAG_30));
    }
    ...
    public static class Factory extends UItem.UItemFactory {
        ...
        public static UItem of(int i, IconBackgroundColors iconBackgroundColors, int i2, CharSequence charSequence, CharSequence charSequence2, boolean z) {
            ...
            ofFactory.longValue = (iconBackgroundColors.top & 4294967295L) | (iconBackgroundColors.bottom << 32);
            ofFactory.accent = z;
            return ofFactory;
        }
    }
