...
public final class w5 extends o20 implements NotificationCenter.NotificationCenterDelegate {
    public final long P;
    public final int Q;
        ...
        if (view instanceof yg.b) {
            ...
            if (!z10 || boost.stars <= 0) {
                ...
                if (((z11 || z10) && boost.user_id >= 0) || boost.unclaimed) {
                    ...
                    new tg.d0(w5Var, tL_payments_checkedGiftCode, boost.used_gift_slug).show();
                } else if (z10 && boost.user_id == -1) {
                    org.telegram.ui.Components.yb ybVar = new org.telegram.ui.Components.yb(w5Var.getParentActivity(), w5Var.getResourceProvider());
                    ...
                    org.telegram.ui.Components.qc.g(w5Var, ybVar, 2750).j();
                } else if (!z11 && !z10) {
                    w5Var.presentFragment(ProfileActivity.m4(bVar.getDialogId()));
                }
            } else {
                yh.w7.e1(context, w5Var.Q, w5Var.P, boost, w5Var.getResourceProvider());
            }
        }
        if (view instanceof org.telegram.ui.Cells.s8) {
            tg.o.m(w5Var, w5Var.resourceProvider, j3, null);
        }
        if (view instanceof yg.c) {
            tg.o.m(w5Var, w5Var.resourceProvider, j3, ((yg.c) view).getPrepaidGiveaway());
        }
    ...
    public final void F0(boolean z10) {
        ...
        q5Var.addView(this.R != null ? this.c0 : new View(q5Var.getContext()), w7.x5.d(-1, this.R != null ? -2.0f : 110.0f, 0, 8.0f, 46.0f, 8.0f, 33.0f));
    ...
    public final View createView(Context context) {
        ...
        this.c.setOnItemClickListener(new ai.n6(3, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (!booleanValue) {
            finishFragment();
            if ((n2Var2 instanceof ProfileActivity) || (n2Var2 instanceof xn)) {
