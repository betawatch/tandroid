...
public final class te0 extends org.telegram.ui.Components.wv0 {
    ...
    */
    public te0(og0 og0Var, Context context) {
        super(context);
        int i10;
        this.y = og0Var;
        this.x = new re0(this, 1);
        setOrientation(1);
    ...
    @Override // org.telegram.ui.Components.wv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new re0(this, 0), og0.q0);
    }
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
            ...
            t01Var.c = i10;
            valueOf.setSpan(new org.telegram.ui.Components.u01(t01Var, 0), indexOf, i10, 0);
        }
