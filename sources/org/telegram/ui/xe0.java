...
public final class xe0 extends org.telegram.ui.Components.ev0 {
    ...
    public final org.telegram.ui.Components.w80 f;
    ...
    */
    public xe0(ig0 ig0Var, Context context) {
        ...
        this.c = textView3;
        org.telegram.ui.Cells.pa.m(18.0f, 1, textView3);
        textView3.setText(LocaleController.getString(ig0Var.B != 3 ? R.string.EnterNewEmail : R.string.AddEmailTitle));
        textView3.setGravity(17);
        textView3.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        addView(textView3, h7.z5.d(-1, -2.0f, 1, 32.0f, 16.0f, 32.0f, 0.0f));
        org.telegram.ui.Components.p80 p80Var2 = new org.telegram.ui.Components.p80(context, null);
        this.d = p80Var2;
        p80Var2.setTextSize(1, 14.0f);
        p80Var2.setGravity(17);
        p80Var2.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        p80Var2.setText(LocaleController.getString(R.string.AddEmailSubtitle));
        addView(p80Var2, h7.z5.t(-2, -2, 1, 32, 8, 32, 0));
        org.telegram.ui.Components.jc0 jc0Var2 = new org.telegram.ui.Components.jc0(context, null);
        this.a = jc0Var2;
        jc0Var2.setText(LocaleController.getString(ig0Var.B != 3 ? R.string.YourNewEmail : R.string.YourEmail));
        ...
        editTextBoldCursor2.setOnFocusChangeListener(new ld(this, 7));
        ...
        editTextBoldCursor2.setOnEditorActionListener(new fa(this, 7));
        addView(jc0Var2, h7.z5.k(16.0f, 24.0f, 16.0f, 0.0f, -1, 58));
        ...
        spannableStringBuilder2.setSpan(new org.telegram.ui.Components.zy(3), 1, 2, 33);
        ...
        frameLayout22.addView(textView22, h7.z5.d(-2, -2.0f, 83, 0.0f, 0.0f, 0.0f, 24.0f));
        frameLayout22.addView(w80Var2, h7.z5.d(-2, 16.0f, 83, 0.0f, 0.0f, 0.0f, 70.0f));
        w80Var2.setMeasureAfter(textView22);
        addView(frameLayout22, h7.z5.n(-1, -2));
        i6.q2(frameLayout22);
        frameLayout22.setOnClickListener(new u50(this, 8));
    }
    ...
    public final void h(String str) {
        ...
        if (googleSignInAccount2 != null) {
            ...
            ConnectionsManager.getInstance(i11).sendRequest(verifyemail, new z9(this, bundle, verifyemail, 21), 10);
            return;
        }
        ...
        ConnectionsManager.getInstance(i10).sendRequest(sendverifyemailcode, new z9(this, bundle, sendverifyemailcode, 22), 10);
    }

    @Override // org.telegram.ui.Components.ev0
    public final void j() {
        AndroidUtilities.runOnUIThread(new ve0(this, 0), ig0.p0);
    }
    ...
    public final void o() {
        org.telegram.ui.Components.jc0 jc0Var = this.a;
        ig0 ig0Var = this.A;
