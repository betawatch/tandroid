...
public final class r6 extends View {
    ...
    public /* synthetic */ r6(Context context) {
        super(context);
    }

    public void a() {
        this.b.setShader(new LinearGradient(0.0f, 0.0f, getWidth(), 0.0f, new int[]{0, ((pg.x) this.e).f}, (float[]) null, Shader.TileMode.CLAMP));
    }
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.a) {
            ...
            default:
                ...
                qg.l1.x1(canvas, rectF2, AndroidUtilities.dp(6.0f));
                canvas.restore();
                rectF2.set(dp, f7, getWidth() - dp, f10);
                ...
                qg.l1.y1(max, height, strokeWidth, i0.a.k(xVar.f, (int) (this.d * 255.0f)), canvas);
                break;
        }
    }
    ...
    public r6(pg.x xVar, Context context) {
        super(context);
        this.e = xVar;
        this.b = new Paint(1);
