...
public final class r61 extends View {
    ...
    public r61(i71 i71Var, Context context) {
        super(context);
        this.V = i71Var;
        this.a = false;
        this.b = false;
    ...
    public final void b() {
        ...
        if (q61Var != null) {
            q61Var.h = false;
            q61Var.n = -1;
            if (q61Var.a != 2 || (paint = q61Var.x) == null) {
                return;
            }
        ...
        int i10 = rg.b1.L;
        this.J = new q61(this, context);
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(16.66f), TLObject.FLAG_30);
        this.J.measure(makeMeasureSpec, makeMeasureSpec);
        q61 q61Var2 = this.J;
        q61Var2.layout(0, 0, q61Var2.getMeasuredWidth(), this.J.getMeasuredHeight());
    }

    public final void c(TLRPC.Document document, k61 k61Var) {
        this.d = document;
        a(k61Var);
    ...
    public final void e(boolean z10, boolean z11) {
        ...
        this.I = ofFloat;
        ofFloat.addUpdateListener(new o61(this, 2));
        this.I.addListener(new p61(this, 2));
    ...
    public final void f() {
        ...
        this.I = ofFloat;
        ofFloat.addUpdateListener(new o61(this, 1));
        this.I.addListener(new p61(this, 1));
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.H) {
            ...
            if (drawable instanceof org.telegram.ui.Components.o5) {
                ...
                ai.l4 l4Var = ((org.telegram.ui.Components.o5) this.E).k;
                if (l4Var != null) {
    ...
    public void setDrawable(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (z10 && drawable2 != null && (drawable2 instanceof org.telegram.ui.Components.o5)) {
                ((org.telegram.ui.Components.o5) drawable2).p(w50Var);
            }
            this.E = drawable;
            if (this.H && (drawable instanceof org.telegram.ui.Components.o5)) {
                ((org.telegram.ui.Components.o5) drawable).b(w50Var);
            }
        }
    }
    ...
    public void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            this.I = ofFloat;
            ofFloat.addUpdateListener(new o61(this, 0));
            this.I.addListener(new p61(this, 0));
            this.I.setInterpolator(new OvershootInterpolator(5.0f));
            this.I.setDuration(350L);
            this.I.start();
        }
