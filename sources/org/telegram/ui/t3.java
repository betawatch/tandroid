...
public final class t3 implements ku0 {
    ...
    public final boolean a(int i10) {
        return i10 < this.b.size() && i10 >= 0 && k4.g(this.a, get(i10));
    }
    ...
    public final boolean e(int i10) {
        if (i10 < this.b.size() && i10 >= 0 && !k4.g(this.a, get(i10))) {
            l4 l4Var = this.c.r0[0].c;
            TL_iv.PageBlock pageBlock = get(i10);
            l4Var.getClass();
            if (l4.I(pageBlock) == 5) {
                return true;
    ...
    public final void h(TL_iv.PageBlock pageBlock) {
        n4 n4Var = this.c;
        int childCount = n4Var.r0[0].b.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = n4Var.r0[0].b.getChildAt(i10);
    ...
    public final CharSequence i(int i10) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockPhoto) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                spannableStringBuilder.setSpan(new s3(this, str, 0), 0, str.length(), 34);
                if (spannableStringBuilder == null) {
                    return spannableStringBuilder;
                }
                n4 n4Var = this.c;
                n4Var.getClass();
                TL_iv.RichText w10 = n4.w(2, pageBlock);
                CharSequence C = n4.C(n4Var, this.a, null, w10, w10, pageBlock, -AndroidUtilities.dp(100.0f));
                ...
                if (o01VarArr != null && o01VarArr.length > 0) {
                    for (int i11 = 0; i11 < o01VarArr.length; i11++) {
                        spannableStringBuilder2.setSpan(new s3(this, o01VarArr[i11].b, 1), spannable.getSpanStart(o01VarArr[i11]), spannable.getSpanEnd(o01VarArr[i11]), 33);
                    }
                }
