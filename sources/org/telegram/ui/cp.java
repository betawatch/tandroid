...
public final class cp extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.v80 b;
    public int c;
    ...
    public final void a() {
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 3) {
            n9Var.i(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(2)), "104_104", "tgs", this.b, tL_messages_stickerSet);
        } else {
