...
public final class cp extends f2.b0 {
    ...
    public /* synthetic */ cp(Object obj, int i10) {
        this.d = i10;
        this.e = obj;
    }
    ...
    public final int e(RecyclerView recyclerView, f2.m1 m1Var) {
        switch (this.d) {
            ...
            default:
                ...
                if (!lVar.T.D.z1 || !lVar.v.L(m1Var.b())) {
                    break;
                } else {
                    lVar.f.setItemAnimator(lVar.n);
                    break;
                }
                break;
        }
    ...
    public final boolean n(RecyclerView recyclerView, f2.m1 m1Var, f2.m1 m1Var2) {
        ...
        switch (this.d) {
            case 0:
                if (m1Var.f == m1Var2.f) {
                    ...
                    if (!(view instanceof ma) || ((ma) view).D) {
                        ...
                        TLRPC.TL_username tL_username = (TLRPC.TL_username) arrayList2.get(i13);
                        arrayList2.set(i13, (TLRPC.TL_username) arrayList2.get(i14));
                        arrayList2.set(i14, tL_username);
                        bpVar.p(b10, b11);
            ...
            case 5:
                ...
                return true;
            default:
                ph.g gVar = ((ph.l) this.e).v;
                if (!gVar.L(m1Var.b()) || !gVar.L(m1Var2.b())) {
                    return false;
                }
                int b24 = m1Var.b();
                int b25 = m1Var2.b();
                ArrayList arrayList7 = gVar.n;
                oh.l6 l6Var = gVar.e;
                if (l6Var != null && b24 >= 0 && b24 < l6Var.i.size() && b25 >= 0 && b25 < gVar.e.i.size()) {
                    if (gVar.e instanceof oh.d6) {
                        arrayList = new ArrayList();
                        for (int i26 = 0; i26 < gVar.e.i.size(); i26++) {
                            arrayList.add(Integer.valueOf(((MessageObject) gVar.e.i.get(i26)).getId()));
                        }
                    } else {
                        arrayList = new ArrayList(gVar.e.g);
                    }
                    if (!gVar.r) {
                        arrayList7.clear();
                    ...
                    MessageObject messageObject3 = (MessageObject) gVar.e.i.get(b24);
    ...
    public void p(f2.m1 m1Var, int i10) {
        ...
        switch (this.d) {
            ...
            case 6:
                ...
                if (i10 == 0) {
                    ph.g gVar = lVar.v;
                    ArrayList arrayList5 = gVar.n;
                    oh.l6 l6Var = gVar.e;
                    if (l6Var != null && gVar.r) {
                        if (l6Var instanceof oh.d6) {
                            arrayList = new ArrayList();
                            for (int i13 = 0; i13 < gVar.e.i.size(); i13++) {
                                arrayList.add(Integer.valueOf(((MessageObject) gVar.e.i.get(i13)).getId()));
                            }
                        } else {
                            arrayList = l6Var.g;
                        }
                        boolean z4 = arrayList5.size() != arrayList.size();
                        if (!z4) {
                            int i14 = 0;
                            while (true) {
