...
public final class wz0 extends View implements org.telegram.ui.Components.fh0 {
    ...
    */
    public wz0(ProfileActivity profileActivity, Context context) {
        ...
        if (lVar.getOccupyStatusBar()) {
            ...
            if (!z10) {
                ...
                ofFloat.addListener(new e50(this, 22));
            }
        }
        i10 = 0;
        this.a = i10;
        ...
        ofFloat2.setInterpolator(org.telegram.ui.Components.jr.j);
        ofFloat2.addUpdateListener(new g3(this, 28));
        ofFloat2.addListener(new e50(this, 22));
    }
    ...
    public final void e(float f9, boolean z10) {
        ...
        this.e.setAlpha(i10);
        this.f.setAlpha(i10);
        this.r.setAlpha((int) (66.0f * f9));
        this.s.setAlpha((int) (85.0f * f9));
        this.v.setAlpha(i10);
        this.C = f9;
        if (!z10) {
            this.B = f9;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (realCount <= 1 || realCount > 20) {
            ...
            z10 = false;
            while (i16 < realCount) {
                int dp2 = (x4 * i16) + AndroidUtilities.dp((i16 * 2) + 5);
                int i17 = this.G;
                RectF rectF = this.d;
                if (i16 != i17 || Math.abs(this.F - f12) <= 1.0E-4f) {
                    paint = paint3;
                    fArr3 = fArr;
                    i10 = realCount;
                    i11 = 85;
                    if (i16 != this.I) {
                        ...
                        f10 = profileActivity.j0.getCurrentItemProgress();
                        this.H = f10;
                        if ((f10 > 0.0f || !profileActivity.j0.J()) && this.J <= 0.0f) {
                            j10 = j11;
                        } else {
                            float f13 = this.J;
                            int i18 = this.K;
                            j10 = j11;
                            float f14 = ((i18 * j10) / 500.0f) + f13;
                            this.J = f14;
                            if (f14 > 1.0f) {
                                this.J = 1.0f;
                                this.K = i18 * (-1);
                        ...
                        rectF.set(dp2, i15, dp2 + x4, AndroidUtilities.dp(2.0f) + i15);
                    ...
                    f10 = 1.0f;
                    float f15 = dp2;
                    rectF.set(f15, i15, (x4 * f10) + f15, AndroidUtilities.dp(2.0f) + i15);
                    if (i16 != this.I) {
                        this.D[i16] = 0.75f;
                    } else if (profileActivity.w0 == 3) {
                        paint4.setAlpha((int) (AndroidUtilities.lerp(i11, 255, org.telegram.ui.Components.jr.j.getInterpolation(this.D[i16])) * this.C));
                    }
                    ...
                    i10 = realCount;
                    float f19 = dp2 + x4;
                    canvas.clipRect((x4 * f16) + f17, f18, f19, AndroidUtilities.dp(2.0f) + i15);
                ...
                z10 = true;
                float f152 = dp2;
                rectF.set(f152, i15, (x4 * f10) + f152, AndroidUtilities.dp(2.0f) + i15);
                if (i16 != this.I) {
                }
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), i16 != this.I ? paint : paint4);
                i16++;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        int currentActionBarHeight = org.telegram.ui.ActionBar.l.getCurrentActionBarHeight() + this.a;
        Rect rect = this.b;
