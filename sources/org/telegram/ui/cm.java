...
public final class cm implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(sendAnimationData, ylVar, sendAnimationData.x, iArr[0] + (sendAnimationData.fromPreview ? 0.0f : photoImage.getCenterX())), animatorSet2);
