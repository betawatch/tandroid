...
public final class gc1 extends org.telegram.ui.Components.kl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i23 == 1) {
            ...
            if (i10 == themeActivity.Y) {
                eaVar.c(LocaleController.getString("AutoNightUpdateLocation", R.string.AutoNightUpdateLocation), org.telegram.ui.ActionBar.i6.w, false, false);
                return;
            }
        ...
        if (i23 == 4) {
            ...
            if (i10 == themeActivity.R) {
                kaVar.a(LocaleController.getString("AutoNightDisabled", R.string.AutoNightDisabled), org.telegram.ui.ActionBar.i6.o == 0, true);
                return;
            }
            if (i10 == themeActivity.S) {
                kaVar.a(LocaleController.getString("AutoNightScheduled", R.string.AutoNightScheduled), org.telegram.ui.ActionBar.i6.o == 1, true);
                return;
            } else if (i10 == themeActivity.T) {
                kaVar.a(LocaleController.getString("AutoNightAdaptive", R.string.AutoNightAdaptive), org.telegram.ui.ActionBar.i6.o == 2, themeActivity.U != -1);
                return;
            } else {
                if (i10 == themeActivity.U) {
                    kaVar.a(LocaleController.getString("AutoNightSystemDefault", R.string.AutoNightSystemDefault), org.telegram.ui.ActionBar.i6.o == 3, false);
                    return;
                }
                return;
            }
        ...
        switch (i23) {
            case 10:
                ...
                if (i10 != i21) {
                    ...
                    String z02 = z10 ? org.telegram.ui.ActionBar.i6.z0() : LocaleController.getString("AutoNightThemeOff", R.string.AutoNightThemeOff);
                    if (z10) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 4:
                ...
                kaVar.addView(textView, w7.x5.d(-1, -1.0f, (z10 ? 5 : 3) | 48, z10 ? 71.0f : 21.0f, 0.0f, z10 ? 21.0f : 23.0f, 0.0f));
                ...
                kaVar.addView(imageView, w7.x5.d(19, 14.0f, (LocaleController.isRTL ? 3 : 5) | 16, 23.0f, 0.0f, 23.0f, 0.0f));
                j5Var = kaVar;
                break;
            case 5:
                ...
                break;
            case 6:
                j5Var = new bc1(this, context);
                break;
            case 7:
                j5Var = new org.telegram.ui.Cells.w8(context);
                break;
            case 8:
                j5Var = new hc1(themeActivity, context);
                break;
            case 9:
                kaVar = new cc1(context);
                ...
                while (true) {
                    ...
                    if (i14 >= y0VarArr.length) {
                        ...
                        y0VarArr[i14] = y0Var;
                        kaVar.addView(((org.telegram.ui.Cells.y0[]) kaVar.b)[i14], w7.x5.m(0.5f, -1, -1, i14 == 1 ? 10 : 0, 0, 0));
            ...
            case 11:
                ...
                break;
            case 12:
                ec1 ec1Var = new ec1(context, 0, e6Var);
                ...
                ec1Var.setOnItemLongClickListener(new rv0(12, this, ic1Var));
                ec1Var.setLayoutParams(new s4.p0(-1, AndroidUtilities.dp(62.0f)));
                j5Var = ec1Var;
                break;
            case 13:
                j5Var = new wb1(themeActivity, context);
                break;
            case 14:
            case 18:
            default:
            ...
            case 15:
                ...
                org.telegram.ui.Components.ty0 ty0Var = new org.telegram.ui.Components.ty0(context);
                Paint paint = new Paint(1);
                ty0Var.a = paint;
                ty0Var.b = new Paint(1);
                Paint paint2 = new Paint(1);
                ty0Var.c = paint2;
                Paint paint3 = new Paint(1);
                ty0Var.d = paint3;
                ty0Var.e = new RectF();
                ty0Var.h = new String[]{LocaleController.getString(R.string.SwipeSettingsPin), LocaleController.getString(R.string.SwipeSettingsRead), LocaleController.getString(R.string.SwipeSettingsArchive), LocaleController.getString(R.string.SwipeSettingsMute), LocaleController.getString(R.string.SwipeSettingsDelete), LocaleController.getString(R.string.SwipeSettingsFolders)};
                ty0Var.n = new int[]{r14, r14, r14, r14, org.telegram.ui.ActionBar.i6.Y5, org.telegram.ui.ActionBar.i6.d9};
                ty0Var.r = new org.telegram.ui.Components.xi0[6];
                ty0Var.v = new org.telegram.ui.Components.aj0[2];
                ty0Var.x = 1.0f;
                ...
                org.telegram.ui.Components.sy0 sy0Var = new org.telegram.ui.Components.sy0(ty0Var, context);
                ty0Var.f = sy0Var;
                sy0Var.setMinValue(0);
                sy0Var.setDrawDividers(false);
                boolean isEmpty = MessagesController.getInstance(i11).dialogFilters.isEmpty();
                sy0Var.setMaxValue(isEmpty ? 4 : 5);
                sy0Var.setAllItemsCount(isEmpty ? 5 : 6);
                sy0Var.setWrapSelectorWheel(true);
                sy0Var.setFormatter(new org.telegram.ui.Components.ry0(ty0Var));
                sy0Var.setOnValueChangedListener(new org.telegram.ui.Components.ry0(ty0Var));
                sy0Var.setImportantForAccessibility(2);
                sy0Var.setValue(SharedConfig.getChatSwipeAction(i11));
                ty0Var.addView(sy0Var, w7.x5.d(132, -1.0f, 5, 21.0f, 0.0f, 21.0f, 0.0f));
                ty0Var.setWillNotDraw(false);
                ty0Var.s = 0;
                for (int i16 = 0; i16 < 2; i16++) {
                    ty0Var.v[i16] = new org.telegram.ui.Components.aj0(context);
                    ty0Var.addView(ty0Var.v[i16], w7.x5.d(28, 28.0f, 21, 0.0f, 0.0f, 184.0f, 0.0f));
                }
                org.telegram.ui.Components.xi0 a2 = ty0Var.a(ty0Var.f.getValue());
                if (a2 != null) {
                    ty0Var.v[0].setImageDrawable(a2);
                    a2.M(a2.e[0] - 1);
                }
                AndroidUtilities.updateViewVisibilityAnimated(ty0Var.v[0], true, 0.5f, false);
                AndroidUtilities.updateViewVisibilityAnimated(ty0Var.v[1], false, 0.5f, false);
                ty0Var.w = ty0Var.f.getValue() != 5 ? 0.0f : 1.0f;
                ty0Var.F = ty0Var.f.getValue();
                j5Var = ty0Var;
                break;
            case 16:
                ...
                break;
            case 17:
                View fvVar = new fv(themeActivity.f, context, themeActivity);
            ...
            case 21:
                ...
                kaVar = new fp0(i13, 0L, this.c, themeActivity.getResourceProvider());
                j5Var = kaVar;
                break;
        }
    ...
    public final void y(s4.c1 c1Var) {
        if (c1Var.f == 4) {
            ((org.telegram.ui.Cells.ka) c1Var.a).setTypeChecked(c1Var.b() == org.telegram.ui.ActionBar.i6.o);
        }
    }
}
