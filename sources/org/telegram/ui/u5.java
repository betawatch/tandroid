...
public final class u5 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 2:
                ...
                float z10 = u31Var.z(true);
                float lerp = AndroidUtilities.lerp(0, AndroidUtilities.dp(12.0f), w7.p.a(z10 / AndroidUtilities.dpf2(24.0f), 0.0f, 1.0f));
                u31Var.x.setTranslationY(Math.max(AndroidUtilities.statusBarHeight, z10));
                boolean z11 = z10 <= ((float) AndroidUtilities.statusBarHeight) / 2.0f;
                Boolean bool = (Boolean) this.b;
                if (bool == null || bool.booleanValue() != z11) {
                    this.b = Boolean.valueOf(z11);
                    AndroidUtilities.setLightStatusBar(u31Var.getWindow(), AndroidUtilities.computePerceivedBrightness(z11 ? u31Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5) : org.telegram.ui.ActionBar.h6.v(u31Var.getThemedColor(org.telegram.ui.ActionBar.h6.s8), 855638016)) > 0.721f);
                }
                u31Var.topBulletinContainer.setTranslationY(Math.max(u31Var.topBulletinContainer.getHeight() + AndroidUtilities.dp(56.0f) + AndroidUtilities.statusBarHeight, z10) + getTranslationY() + ((-r3.getTop()) - u31Var.topBulletinContainer.getHeight()));
                path.rewind();
            ...
            case 7:
                ...
                if (tVar != null) {
                    canvas.drawRoundRect(rectF3, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), ((w5) ((z0) tVar).b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                } else {
            ...
            case 9:
                ...
                drawable.setBounds(0, org.telegram.messenger.ul.D(2.0f, i10 + i14, 1), getMeasuredWidth(), getMeasuredHeight());
            ...
            case 11:
                ...
                paint7.setColor(y3Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5));
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        switch (this.a) {
            case 6:
                ...
                matrix.postTranslate((photoImage.getCenterX() + (cell.getX() + a1Var.getX())) - ((b6Var.y0 * max) / 2.0f), (photoImage.getCenterY() + (cell.getY() + a1Var.getY())) - ((b6Var.z0 * max) / 2.0f));
        ...
        switch (this.a) {
            ...
            case 7:
                ...
                if (getChildCount() == 2) {
                    ...
                    int max = Math.max(ig0Var2.getMeasuredWidth(), p6Var.getMeasuredWidth() + AndroidUtilities.dp(24.0f) + (textView.getVisibility() == 0 ? textView.getMeasuredWidth() + AndroidUtilities.dp(24.0f) : 0));
                    ...
                    if (limitPreviewView.P) {
                        ...
                        int clamp = (int) Utilities.clamp(size * limitPreviewView.a, size - Math.max(ig0Var.getMeasuredWidth(), (limitPreviewView.O.getMeasuredWidth() + AndroidUtilities.dp(24.0f)) + (p6Var2.getVisibility() == 0 ? p6Var2.getMeasuredWidth() + AndroidUtilities.dp(24.0f) : 0)), max);
    ...
    public void setTranslationY(float f7) {
        switch (this.a) {
            case 2:
                ...
                org.telegram.ui.Components.u31 u31Var = (org.telegram.ui.Components.u31) this.e;
                u31Var.topBulletinContainer.setTranslationY(Math.max(u31Var.topBulletinContainer.getHeight() + AndroidUtilities.dp(56.0f) + AndroidUtilities.statusBarHeight, u31Var.z(true)) + ((-r1.getTop()) - u31Var.topBulletinContainer.getHeight()) + f7);
                break;
            case 3:
                super.setTranslationY(f7);
                PhotoViewer photoViewer = (PhotoViewer) this.e;
    ...
    public u5(org.telegram.ui.Components.u31 u31Var, Context context) {
        ...
        this.d = paint;
        paint.setColor(u31Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5));
