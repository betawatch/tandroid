...
public final class sr extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(sr srVar, long j3) {
        if (j3 != 0) {
            srVar.N = j3;
            srVar.r = MessagesController.getInstance(srVar.currentAccount).getChat(Long.valueOf(j3));
            srVar.u0();
        }
    }
    ...
    */
    public static void V(final sr srVar, View view, int i10) {
        ...
        i14 = 0;
        final int i15 = 1;
        boolean z15 = srVar.c.getAdapter() == srVar.a;
        if (i10 == srVar.h1) {
            boolean z16 = !srVar.v1;
            srVar.v1 = z16;
            ...
            srVar.A0(w02);
            srVar.a.m(srVar.j1);
        } else if (i10 == srVar.i1) {
            boolean z17 = !srVar.w1;
            srVar.w1 = z17;
            ...
            srVar.A0(w03);
            srVar.a.m(srVar.j1);
        } else if (i10 == srVar.n0) {
            boolean z18 = !srVar.y1;
            srVar.y1 = z18;
            ...
            if (srVar.p0(i10)) {
                ...
                if (i10 == srVar.V) {
                    srVar.E.send_photos = !r15.send_photos;
                } else if (i10 == srVar.W) {
                    srVar.E.send_videos = !r14.send_videos;
                } else if (i10 == srVar.X) {
                    ...
                    srVar.E.send_audios = !r14.send_audios;
                } else if (i10 == srVar.Z) {
                    srVar.E.send_docs = !r14.send_docs;
                } else if (i10 == srVar.a0) {
                    srVar.E.send_voices = !r14.send_voices;
                } else if (i10 == srVar.b0) {
                    srVar.E.send_roundvideos = !r14.send_roundvideos;
                } else if (i10 == srVar.c0) {
                    if (srVar.E.send_plain && (m10 = srVar.d.m(srVar.T)) != null) {
                        AndroidUtilities.shakeViewSpring(m10);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        srVar.E.embed_links = !r14.embed_links;
                    }
                } else if (i10 == srVar.d0) {
                    srVar.E.send_polls = !r14.send_polls;
                } else if (i10 == srVar.k0) {
                    srVar.E.send_reactions = !r14.send_reactions;
                }
                ...
                if (i10 == srVar.z0) {
                    if (i13 == 0 || i13 == 3) {
                        ...
                        sr srVar2 = new sr(bundle);
                        srVar2.x0(srVar.s);
                        TLRPC.TL_chatBannedRights tL_chatBannedRights3 = srVar.E;
                        if (tL_chatBannedRights3 != null) {
                            srVar2.E = tL_chatBannedRights3;
                        }
                        srVar2.m1 = new gr(srVar);
                        srVar.presentFragment(srVar2);
                        return;
                    }
                    if (i13 == 1) {
                        Bundle bundle2 = new Bundle();
                        bundle2.putLong("chat_id", srVar.N);
                        bundle2.putInt(TeXSymbolParser.TYPE_ATTR, 2);
                        bundle2.putInt("selectType", 1);
                        sr srVar3 = new sr(bundle2);
                        srVar3.m1 = new hr(srVar);
                        srVar3.x0(srVar.s);
                        srVar.presentFragment(srVar3);
                        return;
                    }
                    if (i13 == 2) {
                        Bundle i16 = a4.a.i("addToGroup", true);
                        i16.putLong(z14 ? "channelId" : "chatId", srVar.r.id);
                        ...
                        e70Var.J = iVar;
                        e70Var.x = new jr(srVar, e70Var);
                        srVar.presentFragment(e70Var);
                        return;
                    }
                    return;
                }
                if (i10 == srVar.v0) {
                    srVar.presentFragment(new vb(srVar.r));
                    return;
                }
                if (i10 == srVar.x0) {
                    final org.telegram.ui.Cells.s8 s8Var = (org.telegram.ui.Cells.s8) view;
                    TLRPC.ChatFull chatFull3 = srVar.s;
                    if (chatFull3 != null && !chatFull3.antispam && srVar.l0() < srVar.getMessagesController().telegramAntispamGroupSizeMin) {
                        org.telegram.ui.Components.xc.a0(srVar).Q(R.raw.msg_antispam, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelAntiSpamForbidden", srVar.getMessagesController().telegramAntispamGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (srVar.s == null || !ChatObject.canUserDoAdminAction(srVar.r, 13) || srVar.w0) {
                        return;
                    }
                    srVar.w0 = true;
                    final boolean z21 = srVar.s.antispam;
                    TLRPC.TL_channels_toggleAntiSpam tL_channels_toggleAntiSpam = new TLRPC.TL_channels_toggleAntiSpam();
                    tL_channels_toggleAntiSpam.channel = srVar.getMessagesController().getInputChannel(srVar.N);
                    ...
                    s8Var.getCheckBox().setIcon((ChatObject.canUserDoAdminAction(srVar.r, 13) && ((chatFull2 = srVar.s) == null || chatFull2.antispam || srVar.l0() >= srVar.getMessagesController().telegramAntispamGroupSizeMin)) ? 0 : R.drawable.permission_locked);
                    srVar.getConnectionsManager().sendRequest(tL_channels_toggleAntiSpam, new RequestDelegate(srVar) { // from class: org.telegram.ui.rq
                        ...
                        public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                            switch (i14) {
                                case 0:
                                    final sr srVar4 = this.b;
                                    if (tLObject3 != null) {
                                        srVar4.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        srVar4.getMessagesController().putChatFull(srVar4.s);
                                    }
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.uq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        sr srVar5 = srVar4;
                                                        if (srVar5.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = srVar5.s;
                                                            boolean z24 = z23;
                                                            chatFull7.antispam = z24;
                                                            org.telegram.ui.Cells.s8 s8Var3 = s8Var2;
                                                            s8Var3.setChecked(z24);
                                                            s8Var3.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(srVar5.r, 13) || ((chatFull5 = srVar5.s) != null && chatFull5.antispam && srVar5.l0() < srVar5.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.xc.a0(srVar5).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                                                        sr srVar6 = srVar4;
                                                        if (srVar6.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull8 = srVar6.s;
                                                            boolean z25 = z23;
                                                            chatFull8.participants_hidden = z25;
                                                            org.telegram.ui.Cells.s8 s8Var4 = s8Var2;
                                                            s8Var4.setChecked(z25);
                                                            s8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(srVar6.r, 2) || ((chatFull6 = srVar6.s) != null && chatFull6.participants_hidden && srVar6.l0() < srVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.xc.a0(srVar6).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                }
                                    ...
                                    break;
                                default:
                                    final sr srVar5 = this.b;
                                    if (tLObject3 != null) {
                                        srVar5.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        srVar5.getMessagesController().putChatFull(srVar5.s);
                                    }
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i18 = 1;
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.uq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i18) {
                                                    case 0:
                                                        sr srVar52 = srVar5;
                                                        if (srVar52.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = srVar52.s;
                                                            boolean z242 = z24;
                                                            chatFull7.antispam = z242;
                                                            org.telegram.ui.Cells.s8 s8Var32 = s8Var3;
                                                            s8Var32.setChecked(z242);
                                                            s8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(srVar52.r, 13) || ((chatFull5 = srVar52.s) != null && chatFull5.antispam && srVar52.l0() < srVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.xc.a0(srVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                ...
                if (i10 == srVar.J0) {
                    ...
                    if (srVar.l0() < srVar.getMessagesController().hiddenMembersGroupSizeMin) {
                        org.telegram.ui.Components.xc.a0(srVar).Q(R.raw.contacts_sync_off, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelHiddenMembersForbidden", srVar.getMessagesController().hiddenMembersGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (srVar.s == null || !ChatObject.canUserDoAdminAction(srVar.r, 2) || srVar.I0) {
                        return;
                    }
                    srVar.I0 = true;
                    final boolean z23 = srVar.s.participants_hidden;
                    ...
                    tL_channels_toggleParticipantsHidden.channel = srVar.getMessagesController().getInputChannel(srVar.N);
                    ...
                    if (!ChatObject.canUserDoAdminAction(srVar.r, 2) || ((chatFull = srVar.s) != null && !chatFull.participants_hidden && srVar.l0() < srVar.getMessagesController().hiddenMembersGroupSizeMin)) {
                        i14 = R.drawable.permission_locked;
                    }
                    checkBox.setIcon(i14);
                    srVar.getConnectionsManager().sendRequest(tL_channels_toggleParticipantsHidden, new RequestDelegate(srVar) { // from class: org.telegram.ui.rq
                        public final /* synthetic */ sr b;
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        ...
                                                        if (srVar52.getParentActivity() != null) {
                                                            ...
                                                            s8Var32.setChecked(z242);
                                                            s8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(srVar52.r, 13) || ((chatFull52 = srVar52.s) != null && chatFull52.antispam && srVar52.l0() < srVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.xc.a0(srVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                ...
                if (i10 == srVar.L0) {
                    ...
                    tL_messages_editChatDefaultBannedRights.peer = MessagesController.getInputPeer(srVar.r);
                    TLRPC.Chat chat = srVar.r;
                    if (chat.default_banned_rights == null) {
                        chat.default_banned_rights = new TLRPC.TL_chatBannedRights();
                    }
                    TLRPC.TL_chatBannedRights tL_chatBannedRights4 = srVar.r.default_banned_rights;
                    tL_messages_editChatDefaultBannedRights.banned_rights = tL_chatBannedRights4;
                    tL_chatBannedRights4.edit_rank = !s8Var3.b();
                    srVar.getConnectionsManager().sendRequestTyped(tL_messages_editChatDefaultBannedRights, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.sq
                        ...
                        public final void run(Object obj, Object obj2) {
                            ...
                            sr srVar4 = sr.this;
                            if (updates != null) {
                                srVar4.getMessagesController().processUpdates(updates, false);
                                return;
                            }
                            srVar4.getClass();
                            if (tL_error != null) {
                                s8Var3.setChecked(b10);
                                org.telegram.ui.Components.xc.a0(srVar4).d0(tL_error, false);
                            }
                        }
                    });
                } else {
                    if (i10 == srVar.B0) {
                        ...
                        bundle3.putLong("chat_id", srVar.N);
                        bundle3.putInt(TeXSymbolParser.TYPE_ATTR, 0);
                        sr srVar4 = new sr(bundle3);
                        srVar4.x0(srVar.s);
                        srVar.presentFragment(srVar4);
                        return;
                    }
                    if (i10 == srVar.t0) {
                        srVar.showDialog(new kr(srVar, srVar.getParentActivity(), srVar));
                    } else {
                        if (i10 == srVar.A0) {
                            if (srVar.s != null) {
                                ai0 ai0Var = new ai0(srVar.N, 0L, 0);
                                TLRPC.ChatFull chatFull6 = srVar.s;
                                ai0Var.g0(chatFull6, chatFull6.exported_invite);
                                srVar.presentFragment(ai0Var);
                                return;
                            }
                            return;
                        }
                        if ((i10 > srVar.S && i10 <= Math.max(srVar.l0, srVar.g0)) || i10 == srVar.m0) {
                            org.telegram.ui.Cells.w8 w8Var2 = (org.telegram.ui.Cells.w8) view;
                            boolean isEnabled = w8Var2.isEnabled();
                            Switch r42 = w8Var2.d;
                            if (isEnabled) {
                                if (r42.F != null) {
                                    if (ChatObject.isPublic(srVar.r) && (i10 == srVar.i0 || i10 == srVar.g0)) {
                                        org.telegram.messenger.rk.p(R.string.EditCantEditPermissionsPublic, org.telegram.ui.Components.xc.a0(srVar), null);
                                        return;
                                    } else if (ChatObject.isDiscussionGroup(srVar.currentAccount, srVar.N) && (i10 == srVar.i0 || i10 == srVar.g0)) {
                                        org.telegram.messenger.rk.p(R.string.EditCantEditPermissionsDiscussion, org.telegram.ui.Components.xc.a0(srVar), null);
                                        return;
                                    } else {
                                        org.telegram.ui.Components.xc.a0(srVar).t(LocaleController.getString("EditCantEditPermissions", R.string.EditCantEditPermissions), null).j();
                                        return;
                                    }
                                }
                                if (i10 == srVar.U) {
                                ...
                                if (i10 == srVar.g0) {
                                    srVar.E.change_info = !r0.change_info;
                                    return;
                                }
                                if (i10 == srVar.m0) {
                                    srVar.E.manage_linked_peers = !r0.manage_linked_peers;
                                    return;
                                }
                                if (i10 == srVar.h0) {
                                    srVar.E.invite_users = !r0.invite_users;
                                    return;
                                }
                                if (i10 == srVar.l0) {
                                    srVar.E.manage_topics = !r0.manage_topics;
                                    return;
                                }
                                if (i10 == srVar.i0) {
                                    srVar.E.pin_messages = !r0.pin_messages;
                                    return;
                                }
                                if (i10 == srVar.j0) {
                                    srVar.E.edit_rank = !r0.edit_rank;
                                    return;
                                }
                                if (i10 == srVar.T) {
                                    srVar.E.send_plain = !r1.send_plain;
                                    int i17 = srVar.c0;
                                    if (i17 >= 0) {
                                        srVar.a.m(i17);
                                    }
                                ...
                                if (i10 == srVar.e0) {
                                    TLRPC.TL_chatBannedRights tL_chatBannedRights5 = srVar.E;
                                ...
                                if (i10 == srVar.f0) {
                                    srVar.E.embed_links = !r0.embed_links;
                                    return;
                                } else {
                                    if (i10 == srVar.d0) {
                                        srVar.E.send_polls = !r0.send_polls;
                                        return;
                                    }
                                    return;
                                }
                ...
                if (z15) {
                    TLObject E = srVar.e.E(i10);
                    if (E instanceof TLRPC.User) {
                        TLRPC.User user = (TLRPC.User) E;
                        srVar.getMessagesController().putUser(user, false);
                        long j12 = user.id;
                        int i19 = 0;
                        while (true) {
                            if (i19 >= 3) {
                            ...
                            tLObject2 = (TLObject) (i19 == 0 ? iVar2 : i19 == 1 ? srVar.L : iVar).f(j12);
                            if (tLObject2 != null) {
                                break;
                            } else {
                                i19++;
                    ...
                    if (E2 instanceof TLRPC.User) {
                        ...
                        if (i12 != 0) {
                            ...
                            if (i12 != 3 && i12 != 1) {
                                if (ChatObject.isChannel(srVar.r)) {
                                    srVar.getMessagesController().deleteParticipantFromChat(srVar.N, srVar.getMessagesController().getUser(Long.valueOf(j10)));
                                    lr lrVar = srVar.m1;
                                    if (lrVar != null) {
                                        lrVar.d(j10);
                                    }
                            ...
                            if (i12 == 1) {
                                ...
                                if (!z11) {
                                    ...
                                    z13 = z11;
                                    i20 = 1;
                                    srVar.t0(j11, tLObject, tL_chatAdminRights, tL_chatBannedRights, str2, z13, i12 != i20 ? 0 : 1, i12 != i20 || i12 == 3);
                                    return;
                                }
                                if ((tLObject instanceof TLRPC.TL_channelParticipantAdmin) || (tLObject instanceof TLRPC.TL_chatParticipantAdmin)) {
                                    TLRPC.User user2 = srVar.getMessagesController().getUser(Long.valueOf(j10));
                                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(srVar.getParentActivity());
                                    ...
                                    alertDialog$Builder.k(LocaleController.getString("OK", R.string.OK), new tq(srVar, user2, tLObject, tL_chatAdminRights, tL_chatBannedRights, str, z11));
                                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                                    srVar.showDialog(b2Var);
                                    return;
                                }
                                j11 = j10;
                                str2 = str;
                        ...
                        boolean z27 = z11;
                        if (i13 == 1) {
                            canBlockUsers = j14 != srVar.getUserConfig().getClientUserId() && (srVar.r.creator || z27);
                        } else {
                            if (i13 != 0 && i13 != 3) {
                                z12 = false;
                                if (i13 != 0 || ((i13 != 1 && z10) || (i13 == 2 && i12 == 0))) {
                                    if (j14 != srVar.getUserConfig().getClientUserId()) {
                                        return;
                                    }
                                    ...
                                    srVar.presentFragment(new ProfileActivity(bundle4, null));
                                    return;
                                }
                                ...
                                nq nqVar = new nq(j14, srVar.N, tL_chatAdminRights, srVar.E, tL_chatBannedRights, str, i13 == i11 ? 0 : 1, z12, tLObject == null, null);
                                nqVar.X0 = new yq(srVar, tLObject);
                                srVar.presentFragment(nqVar);
                                return;
                            }
                            canBlockUsers = ChatObject.canBlockUsers(srVar.r);
                        }
                        z12 = canBlockUsers;
                        if (i13 != 0) {
                        }
    ...
    public static void W(sr srVar, TLRPC.ChannelParticipant channelParticipant, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights) {
        int i10 = 0;
        while (i10 < 3) {
            TLObject tLObject = (TLObject) (i10 == 0 ? srVar.M : i10 == 1 ? srVar.L : srVar.K).f(MessageObject.getPeerId(channelParticipant.peer));
    ...
    public static void c0(sr srVar, TLRPC.User user) {
        ...
        UndoView undoView = srVar.n;
        long j3 = -srVar.N;
        boolean z12 = srVar.v;
        undoView.m(j3, user, z12 ? 9 : 10);
        srVar.r.creator = false;
        int i10 = 0;
        boolean z13 = false;
        while (i10 < 3) {
            boolean z14 = true;
    ...
    public final void A0(mr mrVar) {
        ...
        while (true) {
            ...
            i11 = RecyclerView.S(this.c.getChildAt(i10));
            if (i11 != -1) {
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        this.c.setOnItemClickListener(new qq(this, 3));
        this.c.setOnItemLongClickListener(new qq(this, 4));
        if (this.f != null) {
    ...
    */
    public final boolean g0(boolean z10) {
        if (!this.P) {
            ...
            if (z10) {
                ...
                alertDialog$Builder.k(LocaleController.getString("ApplyTheme", R.string.ApplyTheme), new qq(this, 1));
                alertDialog$Builder.h(LocaleController.getString("PassportDiscard", R.string.PassportDiscard), new qq(this, 2));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.n4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.w3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f7));
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.c5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.y6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.c5.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.c5.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.n6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 262144, new Class[]{org.telegram.ui.Cells.z4.class}, new String[]{"textView"}, null, null, -1, null, i11));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        if (i13 != 2) {
            ...
            if (i13 == 3 && ChatObject.canBlockUsers(this.r)) {
                ...
                final int i14 = 0;
                H.c(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), new Runnable(srVar) { // from class: org.telegram.ui.pq
                    public final /* synthetic */ sr b;
                ...
                String str3 = str;
                srVar = this;
                if (i13 == 0 && ChatObject.canBlockUsers(srVar.r)) {
                    if (ChatObject.canAddUsers(srVar.r) && j3 > 0 && !ChatObject.isCommunity(srVar.r)) {
                        final int i15 = 1;
                        H.c(R.drawable.msg_contact_add, LocaleController.getString(z15 ? R.string.ChannelAddToChannel : R.string.ChannelAddToGroup), new Runnable(srVar) { // from class: org.telegram.ui.pq
                            public final /* synthetic */ sr b;
                ...
                } else if (i13 == 1 && ChatObject.canAddAdmins(srVar.r) && z11) {
                    if (srVar.r.creator || !(tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                        j10 = j12;
                        H.c(R.drawable.msg_admins, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), new org.telegram.messenger.voip.f(srVar, j10, (TLObject) tL_chatAdminRights2, str3, tLObject, 2), false);
                    } else {
                        j10 = j12;
                    }
                    final int i17 = 3;
                    H.c(R.drawable.msg_remove, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), new Runnable(srVar) { // from class: org.telegram.ui.pq
                        public final /* synthetic */ sr b;
    ...
    public final void r0() {
        ...
        if (ChatObject.isChannel(this.r)) {
            ...
            for (int i14 = 0; i14 < s02.size(); i14++) {
                arrayList6.add(null);
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest((TLObject) s02.get(i14), new ai.ya(arrayList6, i14, atomicInteger, s02, vqVar)), this.classGuid);
            }
            return;
        }
        this.Q = false;
    ...
    public final void t0(long j3, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z10, int i10, boolean z11) {
        nq nqVar = new nq(j3, this.N, tL_chatAdminRights, this.E, tL_chatBannedRights, str, i10, z10, tLObject == null, null);
    ...
    */
    public final void u0() {
        ...
        if (i10 == 3) {
            ...
            if (chat.creator && !ChatObject.isChannel(chat) && ((this.p1 != this.q1 || this.y1) && this.s != null)) {
                MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.N, this, new qq(this, 0));
                return;
            }
    ...
    public final mr w0() {
        ...
        mrVar.j = this.Y0;
        mrVar.l.clear();
        mrVar.l.addAll(this.G);
        mrVar.h = this.V0;
        mrVar.g = this.U0;
        mrVar.m.clear();
        mrVar.m.addAll(this.H);
        mrVar.e = this.E0;
        mrVar.f = this.F0;
        mrVar.k.clear();
        mrVar.k.addAll(this.F);
        mrVar.f(mrVar.c);
        return mrVar;
    }
    ...
    public final void y0(int i10) {
        ...
        this.c.getViewTreeObserver().addOnPreDrawListener(new zq(this, (org.telegram.ui.Components.t00) view, i10, 0));
    }
