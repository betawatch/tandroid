...
public final class ui0 extends org.telegram.ui.Components.ll0 {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        bj0 bj0Var3 = this.b3;
        ti0 ti0Var = bj0Var3.G;
        int measuredHeight = ti0Var.getMeasuredHeight();
        ui0 ui0Var3 = bj0Var3.K;
        int childCount = ui0Var3.getChildCount();
        boolean z10 = false;
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = ui0Var3.getChildAt(i10);
            if (childAt instanceof org.telegram.ui.Cells.t1) {
                org.telegram.ui.Cells.t1 t1Var2 = (org.telegram.ui.Cells.t1) childAt;
                RectF rectF = hh.k.h;
                hh.k.c(t1Var2, ti0Var, rectF);
                float f7 = rectF.top;
                int i11 = (int) f7;
                ...
                t1Var2.b4(i12, measuredHeight2 - i12, measuredHeight, f7, f7, ti0Var.getMeasuredWidth(), ti0Var.getMeasuredHeight(), 0, 0, 0);
            }
        }
        boolean z11 = true;
            ...
            if (i14 != 2 || ui0Var3.X1) {
                ...
                while (i21 < arrayList.size()) {
                    ...
                    if (groupedMessages2 == null) {
                        ...
                        float f14 = f11;
                        if (f13 > AndroidUtilities.dp(20.0f) + ui0Var3.getMeasuredHeight()) {
                            f13 = AndroidUtilities.dp(20.0f) + ui0Var3.getMeasuredHeight();
                        }
                        float f15 = f13;
                        ...
                        if (z12) {
                            ...
                            for (int i22 = 0; i22 < childCount2; i22++) {
                                View childAt4 = ui0Var2.getChildAt(i22);
        ...
        while (i23 < childCount3) {
            ...
            if (!(childAt5 instanceof org.telegram.ui.Cells.t1) || ((currentMessagesGroup2 = (t1Var = (org.telegram.ui.Cells.t1) childAt5).getCurrentMessagesGroup()) != null && currentMessagesGroup2 == groupedMessages3)) {
                ...
                if (currentMessagesGroup2 == null) {
                    ...
                    bj0Var = bj0Var4;
                    bj0Var.j(canvas, boundsLeft, y11, boundsRight, y12);
                } else {
                    bj0Var = bj0Var4;
                }
        ...
        while (i24 < 3) {
            ...
            if (i24 != 2 || ui0Var4.X1) {
                ...
                while (i25 < childCount3) {
                    View childAt6 = ui0Var4.getChildAt(i25);
                    if (childAt6 instanceof org.telegram.ui.Cells.t1) {
                        org.telegram.ui.Cells.t1 t1Var5 = (org.telegram.ui.Cells.t1) childAt6;
                        if (childAt6.getY() <= ui0Var4.getHeight() && childAt6.getY() + childAt6.getHeight() >= 0.0f && (currentMessagesGroup = t1Var5.getCurrentMessagesGroup()) != null) {
                            int i26 = i24 == 0 ? 1 : 1;
                ...
                for (int i31 = 0; i31 < arrayList2.size(); i31++) {
                    ...
                    if (f19 > AndroidUtilities.dp(20.0f) + ui0Var4.getMeasuredHeight()) {
                        f19 = AndroidUtilities.dp(20.0f) + ui0Var4.getMeasuredHeight();
                    }
                    bj0Var5.j(canvas, f16, f17, f18, f19);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        org.telegram.ui.Cells.t1 t1Var;
        bj0 bj0Var = this.b3;
        if (bj0Var.w && ((view == (t1Var = bj0Var.Q) && t1Var != null && t1Var.getCurrentPosition() == null) || view == bj0Var.X)) {
            return false;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        bj0 bj0Var = this.b3;
        int dp = AndroidUtilities.dp(bj0Var.N.isEmpty() ? -6.0f : 48.0f);
        ViewGroup viewGroup = bj0Var.Z;
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(Math.max(0, ((AndroidUtilities.displaySize.y - (dp + (viewGroup == null ? 0 : viewGroup.getMeasuredHeight()))) - AndroidUtilities.dp(8.0f)) - bj0Var.e.b), TLObject.FLAG_31));
        int max = Math.max(AndroidUtilities.dp(12.0f) + (bj0Var.m0 ? bj0Var.Y : bj0Var.W.l()), -((AndroidUtilities.dp(7.0f) + bj0Var.o0[0]) - getMeasuredWidth()));
        float max2 = Math.max(1, getMeasuredWidth() - max) / Math.max(1, ((getMeasuredWidth() - max) - AndroidUtilities.dp(8.0f)) + Math.max(0, bj0Var.O - ((getMeasuredWidth() - max) - AndroidUtilities.dp((bj0Var.P.i() ? 0 : 40) + 8))));
