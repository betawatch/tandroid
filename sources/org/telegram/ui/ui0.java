        ...
        if (cj0Var.w && (t1Var = cj0Var.Q) != null && t1Var.getCurrentPosition() == null) {
            ...
            if (cj0Var.S != null) {
                ...
                if (cj0Var.E >= 0.001f) {
                    ...
                    canvas2.saveLayerAlpha(cj0Var.S.getX() + cj0Var.S.getPaddingLeft(), 0.0f, ((cj0Var.S.getX() + cj0Var.S.getPaddingLeft()) + cj0Var.S.getWidth()) - cj0Var.S.getPaddingRight(), cj0Var.S.getHeight(), (int) org.telegram.messenger.vl.u(cj0Var.E, 0.1f, 1.0f, 255.0f), 31);
                    ...
                    paint.setAlpha((int) org.telegram.messenger.vl.u(cj0Var.E, 0.1f, 1.0f, paint.getAlpha()));
