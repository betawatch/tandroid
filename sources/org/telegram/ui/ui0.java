...
public final class ui0 extends org.telegram.ui.Components.bw0 {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        Rect rect = cj0Var.u0;
        vi0 vi0Var = cj0Var.K;
        if (cj0Var.w && (u1Var = cj0Var.Q) != null && u1Var.getCurrentPosition() == null) {
            if (cj0Var.x) {
                org.telegram.ui.Components.pf pfVar = cj0Var.S;
                if (pfVar != null) {
                    pfVar.setAlpha(0.0f);
                }
                cj0Var.x = false;
            ...
            org.telegram.ui.Components.pf pfVar2 = cj0Var.S;
            if (pfVar2 != null) {
                int[] iArr3 = this.w0;
            ...
            if (cj0Var.S != null) {
                ...
                if (cj0Var.E >= 0.001f) {
                    ...
                    canvas2.saveLayerAlpha(cj0Var.S.getX() + cj0Var.S.getPaddingLeft(), 0.0f, ((cj0Var.S.getX() + cj0Var.S.getPaddingLeft()) + cj0Var.S.getWidth()) - cj0Var.S.getPaddingRight(), cj0Var.S.getHeight(), (int) org.telegram.messenger.wh.x(cj0Var.E, 0.1f, 1.0f, 255.0f), 31);
                    ...
                    paint.setAlpha((int) org.telegram.messenger.wh.x(cj0Var.E, 0.1f, 1.0f, paint.getAlpha()));
            ...
            if (u1Var2 == null) {
                ...
                org.telegram.ui.Cells.t1 transitionParams = cj0Var.Q.getTransitionParams();
        ...
        if (cj0Var.w) {
            if (cj0Var.y) {
                org.telegram.ui.Components.ug ugVar = cj0Var.W;
                if (ugVar != null) {
                    ugVar.setAlpha(0.0f);
                }
                c10 = 0;
