...
public final class mp extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bp q0;
    public org.telegram.ui.Components.vr r;
    ...
    */
    public final void Y() {
        ...
        boolean z12;
        final mp mpVar = this;
        AndroidUtilities.runOnUIThread(mpVar.q0, 200L);
        boolean z13 = true;
        if (mpVar.getParentActivity() != null) {
            String publicUsername = ChatObject.getPublicUsername(mpVar.X, true);
            if (mpVar.V || (((publicUsername != null || mpVar.a.length() == 0) && (publicUsername == null || publicUsername.equalsIgnoreCase(mpVar.a.getText().toString()))) || mpVar.a.length() == 0 || mpVar.k0)) {
                if (publicUsername == null) {
                    publicUsername = "";
                }
                String obj = mpVar.V ? "" : mpVar.a.getText().toString();
                if (publicUsername.equals(obj)) {
                    if (!mpVar.V || (arrayList = mpVar.X.usernames) == null || arrayList.isEmpty()) {
                        z10 = true;
                    } else if (mpVar.t0) {
                        z10 = false;
                    } else {
                        mpVar.t0 = true;
                        boolean z14 = false;
                        for (int i10 = 0; i10 < mpVar.X.usernames.size(); i10++) {
                            TLRPC.TL_username tL_username = mpVar.X.usernames.get(i10);
                        ...
                        if (z14) {
                            ...
                            tL_channels_deactivateAllUsernames.channel = MessagesController.getInputChannel(mpVar.X);
                            mpVar.getConnectionsManager().sendRequest(tL_channels_deactivateAllUsernames, new zo(mpVar, 1));
                        } else {
                            mpVar.t0 = false;
                        }
                        z10 = !z14;
                    ...
                    if (z10) {
                        ...
                        if (chat.noforwards != mpVar.b0) {
                            if (!ChatObject.isChannel(chat)) {
                                mpVar.a0(true);
                                final int i11 = 2;
                                mpVar.getMessagesController().convertToMegaGroup(mpVar.getParentActivity(), mpVar.Z, mpVar, new MessagesStorage.LongCallback(mpVar) { // from class: org.telegram.ui.ap
                                        ...
                                        switch (i11) {
                                            case 0:
                                                ...
                                                if (j3 == 0) {
                                                    ...
                                                    mpVar2.Z = j3;
                                                    mpVar2.X = mpVar2.getMessagesController().getChat(Long.valueOf(j3));
                                                    mpVar2.Y();
                                                    break;
                                                }
                                            case 1:
                                                ...
                                                if (j3 == 0) {
                                                    ...
                                                    mpVar3.Z = j3;
                                                    mpVar3.X = mpVar3.getMessagesController().getChat(Long.valueOf(j3));
                                                    mpVar3.Y();
                                                    break;
                                                }
                                            default:
                                                ...
                                                if (j3 == 0) {
                                                    ...
                                                    mpVar4.Z = j3;
                                                    mpVar4.X = mpVar4.getMessagesController().getChat(Long.valueOf(j3));
                                                    MessagesController messagesController = mpVar4.getMessagesController();
                                                    long j10 = -mpVar4.Z;
                                                    TLRPC.Chat chat2 = mpVar4.X;
                                                    boolean z15 = mpVar4.b0;
                                ...
                                if (mpVar.U != null) {
                                    if (mpVar.getParentActivity() != null) {
                                        if (!mpVar.a0 && !ChatObject.isChannel(mpVar.X)) {
                                            ip ipVar = mpVar.U;
                                            if (ipVar.f || ipVar.h) {
                                                final int i12 = 0;
                                                mpVar.getMessagesController().convertToMegaGroup(mpVar.getParentActivity(), mpVar.Z, mpVar, new MessagesStorage.LongCallback(mpVar) { // from class: org.telegram.ui.ap
                                        ...
                                        if (mpVar.X.join_to_send != mpVar.U.f) {
                                            MessagesController messagesController = mpVar.getMessagesController();
                                            long j3 = mpVar.Z;
                                            TLRPC.Chat chat2 = mpVar.X;
                                            boolean z15 = mpVar.U.f;
                                            chat2.join_to_send = z15;
                                            messagesController.toggleChatJoinToSend(j3, z15, null, null);
                                        }
                                        if (mpVar.X.join_request != mpVar.U.h || mpVar.W) {
                                            MessagesController messagesController2 = mpVar.getMessagesController();
                                            long j10 = mpVar.Z;
                                            TLRPC.Chat chat3 = mpVar.X;
                                            boolean z16 = mpVar.U.h;
                                            chat3.join_request = z16;
                                            messagesController2.toggleChatJoinRequest(j10, 0L, z16, mpVar.W, false, null, null);
                                        }
                                    }
                                    z13 = false;
                                }
                            ...
                            MessagesController messagesController3 = mpVar.getMessagesController();
                            long j11 = -mpVar.Z;
                            TLRPC.Chat chat4 = mpVar.X;
                            boolean z17 = mpVar.b0;
                ...
                } else if (ChatObject.isChannel(mpVar.X)) {
                    mpVar.getMessagesController().updateChannelUserName(mpVar, mpVar.Z, obj, new bp(mpVar, 1), new bp(mpVar, 2));
                    mpVar = mpVar;
                } else {
                    final int i13 = 1;
                    mpVar.getMessagesController().convertToMegaGroup(mpVar.getParentActivity(), mpVar.Z, mpVar, new MessagesStorage.LongCallback(mpVar) { // from class: org.telegram.ui.ap
                            ...
                            switch (i13) {
                                case 0:
                                    ...
                                    if (j32 == 0) {
                                        ...
                                        mpVar2.Z = j32;
                                        mpVar2.X = mpVar2.getMessagesController().getChat(Long.valueOf(j32));
                                        mpVar2.Y();
                                        break;
                                    }
                                case 1:
                                    ...
                                    if (j32 == 0) {
                                        ...
                                        mpVar3.Z = j32;
                                        mpVar3.X = mpVar3.getMessagesController().getChat(Long.valueOf(j32));
                                        mpVar3.Y();
                                        break;
                                    }
                                default:
                                    ...
                                    if (j32 == 0) {
                                        ...
                                        mpVar4.Z = j32;
                                        mpVar4.X = mpVar4.getMessagesController().getChat(Long.valueOf(j32));
                                        MessagesController messagesController4 = mpVar4.getMessagesController();
                                        long j102 = -mpVar4.Z;
                                        TLRPC.Chat chat22 = mpVar4.X;
                                        boolean z152 = mpVar4.b0;
                ...
                Vibrator vibrator = (Vibrator) mpVar.getParentActivity().getSystemService("vibrator");
                if (vibrator != null) {
                    vibrator.vibrate(200L);
                }
                AndroidUtilities.shakeView(mpVar.f);
                mpVar.a0(false);
            }
        }
        z11 = false;
    ...
    public final void a0(boolean z10) {
        ...
        if (this.r != null) {
            ...
            this.r0.setInterpolator(org.telegram.ui.Components.wr.f);
            this.r0.start();
        }
    }
    ...
    public final void b0() {
        ...
        if (this.V || this.c0 || !getUserConfig().isPremium()) {
            ...
            gp gpVar = this.f;
            gpVar.setVisibility((this.V || gpVar.a.length() == 0) ? 8 : 0);
        ...
        ip ipVar = this.U;
        if (ipVar != null) {
            ipVar.setVisibility((!this.a0 || this.V) ? 0 : 8);
            ip ipVar2 = this.U;
            TLRPC.ChatFull chatFull2 = this.Y;
            ipVar2.c((chatFull2 == null || chatFull2.linked_chat_id == 0 || this.a0) ? false : true);
        }
        lp lpVar = this.K;
        if (lpVar != null) {
    ...
    public final View createView(Context context) {
        ...
        this.r = vrVar;
        this.n = n10.i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), vrVar);
        this.h = new zd(context);
        ep epVar = new ep(this, context, this.h, this.resourceProvider);
        this.fragmentView = epVar;
        epVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.a7, false));
        ...
        this.h.addView(this.s, w7.a6.n(-1, -2));
        ...
        this.s.addView(this.w, w7.a6.n(-1, -2));
        this.w.setOnClickListener(new dp(this, i10));
        ...
        this.s.addView(this.v, w7.a6.n(-1, -2));
        ...
        this.h.addView(this.y, w7.a6.n(-1, -2));
        ...
        this.y.addView(this.E, w7.a6.k(23.0f, 7.0f, 23.0f, 0.0f, -1, 36));
        ...
        this.E.addView(this.b, w7.a6.n(-2, 36));
        int i14 = 3;
        ...
        this.E.addView(this.a, w7.a6.n(-1, 36));
        this.a.addTextChangedListener(new m0(this, i14));
        LinearLayout linearLayout4 = new LinearLayout(context);
        this.F = linearLayout4;
        linearLayout4.setOrientation(1);
        this.y.addView(this.F, w7.a6.n(-1, -2));
        ...
        this.h.addView(this.f, w7.a6.n(-2, -2));
        ...
        this.h.addView(this.c, w7.a6.n(-1, -2));
        ...
        this.h.addView(this.x, w7.a6.n(-1, -2));
        ...
        this.H.setOnClickListener(new dp(this, i14));
        ...
        ipVar.c((chatFull == null || chatFull.linked_chat_id == 0 || this.a0) ? false : true);
        ip ipVar2 = this.U;
        TLRPC.ChatFull chatFull2 = this.Y;
        org.telegram.ui.Cells.f9 f9Var3 = ipVar2.e;
        boolean isChannelAndNotMegaGroup = ChatObject.isChannelAndNotMegaGroup(ipVar2.n);
        boolean isPublic = ChatObject.isPublic(ipVar2.n);
        if (chatFull2 == null || chatFull2.guard_bot_id == 0) {
            ...
            f9Var3.setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(isChannelAndNotMegaGroup ? R.string.ChannelSettingsJoinRequestInfoManagedBy : isPublic ? R.string.GroupPublicSettingsJoinRequestInfoManagedBy : R.string.GroupPrivateSettingsJoinRequestInfoManagedBy, "@" + DialogObject.getPublicUsername(MessagesController.getInstance(UserConfig.selectedAccount).getUser(Long.valueOf(chatFull2.guard_bot_id)))), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.il, false), new org.telegram.ui.Components.hy(15, chatFull2, this)));
        }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(t2Var, TLObject.FLAG_23, null, null, null, null, i15));
    ...
    */
    public final boolean onFragmentCreate() {
        ...
        if ((z10 && !ChatObject.isPublic(chat2)) || (this.V && this.X.creator)) {
            ...
            getConnectionsManager().sendRequest(tL_channels_checkUsername, new zo(this, 3));
        }
