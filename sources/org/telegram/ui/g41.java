...
public final class g41 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(g41 g41Var, View view, int i10) {
        ...
        int i11 = 0;
        boolean z10 = g41Var.b.getAdapter() == g41Var.c;
        if (!z10 || (arrayList = g41Var.f) == null) {
            int i12 = g41Var.e;
            if (i12 >= 0 && i10 > i12) {
                i10--;
            }
            language = (i10 < 0 || i10 >= g41Var.h.size()) ? null : (TranslateController.Language) g41Var.h.get(i10);
        } else {
        ...
        if (g41Var.r.contains(str)) {
            Collection.-EL.removeIf(g41Var.r, new t80(str, 2));
        } else {
            g41Var.r.add(str);
        }
        if (g41Var.r.size() == 1 && g41Var.r.contains(currentLocaleInfo.pluralLangCode)) {
            a0(null, null);
        } else {
            a0(g41Var.r, Boolean.TRUE);
        }
        if (z10) {
            int i13 = 0;
            while (i11 < g41Var.f.size()) {
                if (TextUtils.equals(str, ((TranslateController.Language) g41Var.f.get(i11)).code)) {
                    g41Var.Z(i13);
                }
                i11++;
                i13++;
    ...
    public static void V(boolean z10) {
        ...
        if (MessagesController.getGlobalMainSettings().getInt("translate_button_restricted_languages_version", 0) != 2 || (z10 && !z11)) {
            ...
            final int i12 = 1;
            Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.e41
            ...
            }, new Utilities.Callback() { // from class: org.telegram.ui.e41
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    switch (i12) {
                        case 0:
    ...
    public final View createView(Context context) {
        ...
        this.a = new f41(this, context, false);
        this.c = new f41(this, context, true);
