...
public final class m10 extends org.telegram.ui.Components.rl0 {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        if (l1Var.f == 0) {
            ...
            r2Var.p2 = i10 != h() - 1;
            r2Var.getViewTreeObserver().addOnPreDrawListener(new org.telegram.ui.Components.fk(this, r2Var, messageObject, r2Var.getMessage() != null && r2Var.getMessage().getId() == messageObject.getId(), 1));
        }
    }
