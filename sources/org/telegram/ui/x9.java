...
public final /* synthetic */ class x9 implements RequestDelegate {
    ...
    public /* synthetic */ x9(Object obj, Object obj2, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
        this.d = obj3;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i11) {
            case 0:
                AndroidUtilities.runOnUIThread(new eg.k0(obj3, obj2, tL_error, tLObject, obj, 21));
                break;
            case 1:
            ...
            case 2:
                AndroidUtilities.runOnUIThread(new eg.k0(obj3, obj2, tL_error, tLObject, obj, 24));
                break;
            case 3:
            ...
            case 4:
                ...
                AndroidUtilities.runOnUIThread(new ig(tnVar, 17), jArr[0] > 0 ? Math.max(0L, 300 - (SystemClock.elapsedRealtime() - jArr[0])) : 0L);
                break;
            case 5:
                tn tnVar2 = (tn) obj3;
                TLRPC.TL_messages_editMessage tL_messages_editMessage = (TLRPC.TL_messages_editMessage) obj;
                AndroidUtilities.runOnUIThread(new lg((org.telegram.ui.ActionBar.c2[]) obj2, i13));
                if (tL_error != null) {
            ...
            case 6:
                AndroidUtilities.runOnUIThread(new eg.k0(obj3, obj2, tL_error, tLObject, obj, 27));
                break;
            case 7:
            ...
            case 8:
                ...
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new hv((fy) obj3, (TLRPC.TL_attachMenuBot) obj2, (LaunchActivity) obj, i13));
                break;
            case 10:
            ...
            case 14:
                ...
                if (Objects.equals(b70Var.h, (String) obj2) && (tLObject instanceof TLRPC.TL_messages_foundStickerSets)) {
                    ...
                    i10 = ((org.telegram.ui.ActionBar.o2) c70Var).currentAccount;
                    ArrayList<TLRPC.TL_messages_stickerSet> stickerSets = MediaDataController.getInstance(i10).getStickerSets(c70Var.c0());
            ...
            case 25:
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = t91.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), pi0Var.r.i, false);
    ...
    public /* synthetic */ x9(Object obj, TLObject tLObject, String str, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = tLObject;
        this.c = str;
