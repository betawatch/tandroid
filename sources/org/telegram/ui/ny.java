...
public final class ny extends FrameLayout {
    ...
    public ny(oy oyVar, Context context) {
        ...
        if (i11 == 0) {
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) oyVar.getParentActivity().getLayoutInflater().inflate(R.layout.shortcut_widget_item, (ViewGroup) null);
                linearLayout.addView(this.n[i10], i7.f6.n(-1, -2));
                i10++;
            }
            ...
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) oyVar.getParentActivity().getLayoutInflater().inflate(R.layout.contacts_widget_item, (ViewGroup) null);
                linearLayout.addView(this.n[i10], i7.f6.n(160, -2));
                i10++;
            }
        ...
        a();
        this.e = org.telegram.ui.ActionBar.g6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.g6.b7);
    }
        ...
        if (i12 == 0) {
            ...
            while (i16 < i14) {
                if (arrayList.isEmpty()) {
                    dialog2 = i16 < oyVar.getMessagesController().dialogsServerOnly.size() ? oyVar.getMessagesController().dialogsServerOnly.get(i16) : null;
                    j10 = 0;
                } else if (i16 < arrayList.size()) {
                    j10 = 0;
                    TLRPC.Dialog dialog3 = (TLRPC.Dialog) oyVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i16)).longValue());
                    if (dialog3 == null) {
                ...
                if (dialog2 == null) {
                    ...
                    if (DialogObject.isUserDialog(dialog2.id)) {
                        user2 = oyVar.getMessagesController().getUser(Long.valueOf(dialog2.id));
                        if (user2 != null) {
                            ...
                            if (UserObject.isReplyUser(user2) || UserObject.isUserSelf(user2) || (userProfilePhoto2 = user2.photo) == null || (fileLocation2 = userProfilePhoto2.photo_small) == null) {
                                ...
                                if (fileLocation2.volume_id != j10 && fileLocation2.local_id != 0) {
                                    ...
                                    if (fileLocation2 == null) {
                                        try {
                                            decodeFile2 = BitmapFactory.decodeFile(oyVar.getFileLoader().getPathToAttach(fileLocation2, r12).toString());
                                        } catch (Throwable th2) {
                                            th = th2;
                                            c3 = 1;
                                            FileLog.e(th);
                                            ArrayList arrayList2 = (ArrayList) oyVar.getMessagesController().dialogMessage.f(dialog2.id);
                                            if (arrayList2 != null) {
                                            }
                                    ...
                                    if (decodeFile2 != null) {
                                        if (user2 != null) {
                                            org.telegram.ui.Components.e9 e9Var3 = new org.telegram.ui.Components.e9(i15, user2);
                                            ...
                                            e9Var2 = new org.telegram.ui.Components.e9(chat2);
                                        }
                                        e9Var2.setBounds(i15, i15, dp, dp);
                                        e9Var2.draw(canvas2);
                                        canvas = canvas2;
                                        c3 = 1;
                                    } else {
                                    ...
                                    ArrayList arrayList22 = (ArrayList) oyVar.getMessagesController().dialogMessage.f(dialog2.id);
                                    messageObject = (arrayList22 != null || arrayList22.size() <= 0) ? null : (MessageObject) arrayList22.get(i15);
                                    if (messageObject == null) {
                                        long fromChatId = messageObject.getFromChatId();
                                        if (fromChatId > j10) {
                                            user3 = oyVar.getMessagesController().getUser(Long.valueOf(fromChatId));
                                            chat3 = null;
                                        } else {
                                            chat3 = oyVar.getMessagesController().getChat(Long.valueOf(-fromChatId));
                                            user3 = null;
                                        }
                                            ...
                                            if (chat2 == null || chat2.id <= j10 || chat3 != null || (ChatObject.isChannel(chat2) && !ChatObject.isMegagroup(chat2))) {
                                                ...
                                                if ((messageMedia instanceof TLRPC.TL_messageMediaPhoto) && (messageMedia.photo instanceof TLRPC.TL_photoEmpty) && messageMedia.ttl_seconds != 0) {
                                                    ...
                                                    if (messageMedia instanceof TLRPC.TL_messageMediaPoll) {
                                                        ...
                                                        charSequence = j7.l1.n("🎧 ", messageObject.getMusicAuthor(), " - ", messageObject.getMusicTitle());
                                                    } else {
                                                    ...
                                                    if (charSequence5 != null) {
                                                        ...
                                                        if (messageObject.messageOwner.media == null || messageObject.isMediaEmpty()) {
                                                            ...
                                                            if (messageMedia2 instanceof TLRPC.TL_messageMediaPoll) {
                                                                j11 = a4.w.n("📊 \u2068", ((TLRPC.TL_messageMediaPoll) messageMedia2).poll.question.text, "\u2069");
                                                            } else if (messageMedia2 instanceof TLRPC.TL_messageMediaGame) {
                                                                j11 = a4.w.n("🎮 \u2068", messageMedia2.game.title, "\u2069");
                                                            } else {
                                                                j11 = messageObject.type == 14 ? th.j("🎧 \u2068", messageObject.getMusicAuthor(), " - ", messageObject.getMusicTitle(), "\u2069") : messageObject.messageText.toString();
                                                                c10 = '\n';
                                                            }
                                                            String replace = j11.replace(c10, ' ');
                                                            Object[] objArr3 = new Object[2];
                                                            objArr3[0] = replace;
                                                            objArr3[c3] = string;
                                                            SpannableStringBuilder valueOf2 = SpannableStringBuilder.valueOf(String.format("%2$s: \u2068%1$s\u2069", objArr3));
                                                            try {
                                                                valueOf2.setSpan(new org.telegram.ui.Components.a10(org.telegram.ui.ActionBar.g6.o9, null), string.length() + 2, valueOf2.length(), 33);
                                                                spannableStringBuilder = valueOf2;
                                                            } catch (Exception e10) {
                                                                FileLog.e(e10);
                                                                spannableStringBuilder = valueOf2;
                                                            }
                                                            spannableStringBuilder.setSpan(new org.telegram.ui.Components.a10(org.telegram.ui.ActionBar.g6.k9, null), 0, string.length() + 1, 33);
                                    ...
                                    if (dialog2.unread_count <= 0) {
                                        ...
                                        if (oyVar.getMessagesController().isDialogMuted(dialog2.id, j10)) {
                        ...
                        ArrayList arrayList222 = (ArrayList) oyVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        i11 = i16;
                        TLRPC.Chat chat4 = oyVar.getMessagesController().getChat(Long.valueOf(-dialog2.id));
                        if (chat4 != null) {
                            str2 = chat4.title;
                            ...
                            if (chatPhoto == null || (fileLocation2 = chatPhoto.photo_small) == null || fileLocation2.volume_id == j10 || fileLocation2.local_id == 0) {
                                ...
                                ArrayList arrayList2222 = (ArrayList) oyVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        ArrayList arrayList22222 = (ArrayList) oyVar.getMessagesController().dialogMessage.f(dialog2.id);
            ...
            while (true) {
                ...
                for (int i19 = 2; i18 < i19; i19 = 2) {
                    int i20 = (i17 * 2) + i18;
                    if (arrayList.isEmpty()) {
                        if (i20 < oyVar.getMediaDataController().hints.size()) {
                            long j12 = oyVar.getMediaDataController().hints.get(i20).peer.user_id;
                            dialog = (TLRPC.Dialog) oyVar.getMessagesController().dialogs_dict.f(j12);
                            if (dialog == null) {
                        ...
                        if (i20 < arrayList.size()) {
                            dialog = (TLRPC.Dialog) oyVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i20)).longValue());
                            if (dialog == null) {
                                dialog = new TLRPC.TL_dialog();
                    ...
                    if (dialog == null) {
                        ...
                        if (DialogObject.isUserDialog(dialog.id)) {
                            user = oyVar.getMessagesController().getUser(Long.valueOf(dialog.id));
                            ...
                            TLRPC.Chat chat5 = oyVar.getMessagesController().getChat(Long.valueOf(-dialog.id));
                        ...
                        if (fileLocation != null) {
                            try {
                                decodeFile = BitmapFactory.decodeFile(oyVar.getFileLoader().getPathToAttach(fileLocation, true).toString());
                            } catch (Throwable th3) {
                                th = th3;
                                FileLog.e(th);
                        ...
                        if (decodeFile == null) {
                            if (user != null) {
                                ...
                                e9Var = new org.telegram.ui.Components.e9(chat);
                            }
                            e9Var.setBounds(0, 0, dp3, dp3);
                            e9Var.draw(canvas3);
                        } else {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (s02 != drawable && s02 != null) {
            if (org.telegram.ui.ActionBar.g6.sl != null) {
                ...
                org.telegram.ui.Components.r9 r9Var2 = this.a;
                if (r9Var2 != null) {
                    r9Var2.dispose();
                    this.a = null;
                }
        ...
        oy oyVar = this.r;
        b5Var = ((org.telegram.ui.ActionBar.o2) oyVar).parentLayout;
        ...
        while (i10 < 2) {
            ...
            if (drawable2 != null) {
                if (i10 == 1 && this.d != null) {
                    b5Var2 = ((org.telegram.ui.ActionBar.o2) oyVar).parentLayout;
                    if (b5Var2 != null) {
                        ...
                        if (!(drawable2 instanceof ColorDrawable) || (drawable2 instanceof GradientDrawable) || (drawable2 instanceof org.telegram.ui.Components.yb0)) {
                            ...
                            if (drawable2 instanceof org.telegram.ui.Components.s9) {
                                drawable2.draw(canvas);
                            } else {
                                this.a = ((org.telegram.ui.Components.s9) drawable2).c(canvas, this);
                            }
