    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.a) {
            case 0:
                ...
                if (!w9Var.a0() || view != w9Var.c) {
                    return drawChild;
                }
                float min = Math.min(1.0f, Math.max(0.0f, (SystemClock.elapsedRealtime() - w9Var.K) / 75.0f));
                if (min < 1.0f) {
                ...
                if (w9Var.a0 < 1.0f) {
                    ...
                    AndroidUtilities.lerp(w9Var.b0, rectF3, w9Var.a0, rectF3);
                }
                ...
                paint2.setAlpha((int) (Math.max(0.0f, 1.0f - w9Var.y) * 255.0f));
                canvas.drawRect(f13, f11, f14, f12, paint2);
                int lerp = AndroidUtilities.lerp(0, AndroidUtilities.dp(4.0f), Math.min(1.0f, w9Var.y * 20.0f));
                int i16 = lerp / 2;
                int lerp2 = AndroidUtilities.lerp(Math.min(i10, i11), AndroidUtilities.dp(20.0f), Math.min(1.2f, (float) Math.pow(w9Var.y, 1.7999999523162842d)));
                paint.setAlpha((int) (Math.min(1.0f, w9Var.y) * 255.0f));
                path.reset();
                int i17 = i13 + lerp2;
        ...
        switch (this.a) {
            case 0:
                ...
                if (i16 == 0) {
                    ...
                    if (cameraView != null) {
                        cameraView.layout(0, 0, cameraView.getMeasuredWidth(), w9Var.c.getMeasuredHeight());
                    }
                    w9Var.f.setTextSize(0, i15 / 22);
                    w9Var.f.setPadding(0, 0, 0, i15 / 15);
                    int i17 = (int) (i15 * 0.65f);
                    w9Var.a.layout(AndroidUtilities.dp(36.0f), i17, w9Var.a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), w9Var.a.getMeasuredHeight() + i17);
                } else {
                    ...
                    if (cameraView2 != null) {
                        cameraView2.layout(0, 0, cameraView2.getMeasuredWidth(), w9Var.c.getMeasuredHeight());
                    }
                    int min = (int) (Math.min(i14, i15) / 1.5f);
                    if (i16 == 1) {
                        measuredHeight = ((i15 - min) / 2) - w9Var.a.getMeasuredHeight();
                    ...
                    if (i16 == 3) {
                        int C = org.telegram.messenger.w1.C(8.0f, w9Var.a.getMeasuredHeight(), i18);
                ...
                if (i16 != 3) {
                    ...
                    textView.layout(i20, i19, textView.getMeasuredWidth() + i20, w9Var.b.getMeasuredHeight() + i19);
                }
                w9Var.h0();
                break;
            default:
                ...
                org.telegram.ui.Components.v90 v90Var = (org.telegram.ui.Components.v90) this.b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            case 0:
                ...
                w9Var.a.measure(org.telegram.messenger.wl.d(72.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                if (i12 == 3) {
                    w9Var.b.measure(org.telegram.messenger.wl.d(72.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                } else {
            ...
            default:
                ...
                ((org.telegram.ui.Components.v90) this.b).measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), i11);
