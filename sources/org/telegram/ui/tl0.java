...
public final class tl0 extends org.telegram.ui.Components.xl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i15 != 1) {
            if (i15 != 2) {
                if (i15 != 3) {
                    ...
                    ul0 ul0Var = (ul0) view;
                    ul0Var.a.f(R.raw.utyan_passcode, 100, 100, null);
                    ul0Var.a.d();
                    return;
                }
                ...
                n4Var.setHeight(46);
                if (i10 == passcodeActivity.I) {
                    n4Var.setText(LocaleController.getString(R.string.ScreenCaptureHeader));
                    return;
                }
                return;
            }
        ...
        if (i10 == i12) {
            ...
            if (SharedConfig.passcodeHash.isEmpty()) {
                ...
                faVar.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i16, false));
                return;
            } else {
        ...
        if (i10 == i13) {
            ...
            faVar.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i19, false));
            return;
        }
        i14 = passcodeActivity.disablePasscodeRow;
        if (i10 == i14) {
            ...
            faVar.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i20, false));
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            x8Var = new org.telegram.ui.Cells.n4(context);
        } else if (i10 != 4) {
            x8Var = new org.telegram.ui.Cells.f9(context);
        } else {
            x8Var = new ul0(context);
            x8Var.setTag(-33024);
        }
        return new org.telegram.ui.Components.il0(x8Var);
    }
}
