...
public final class vr extends org.telegram.ui.Components.ul0 {
    ...
    public final TLObject E(int i10) {
        ...
        if (size != 0) {
            ...
            if (i11 > i10) {
                ...
                return (TLObject) d2Var.g.get(i10 - 1);
            }
            i10 -= i11;
        }
    ...
    public final void F(String str) {
        ...
        fg.d2 d2Var = this.h;
        wr wrVar = this.y;
        d2Var.g(null, wrVar.O != 0, false, true, false, ChatObject.isChannel(wrVar.r) ? this.y.N : 0L, false, this.y.O, 0);
        l();
    ...
    public final void l() {
        ...
        wr wrVar = this.y;
        if (wrVar.o1 && (y1Var = wrVar.c) != null) {
            ...
            if (adapter != vrVar) {
                ...
                wrVar.c.setFastScrollVisible(false);
                wrVar.c.setVerticalScrollBarEnabled(true);
            }
        }
        super.l();
    }
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (!z11) {
            if (E instanceof TLRPC.ChannelParticipant) {
                ...
                if (peerId >= 0) {
                    TLRPC.User user = wrVar.getMessagesController().getUser(Long.valueOf(peerId));
                    tLObject2 = user;
                    if (user != null) {
                ...
                tLObject2 = wrVar.getMessagesController().getUser(Long.valueOf(((TLRPC.ChatParticipant) E).user_id));
            }
        }
        publicUsername = null;
        tLObject = tLObject2;
        fg.d2 d2Var22 = this.h;
        size = d2Var22.g.size();
        if (size != 0) {
        }
        str = null;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(2, 2, this.c, null, wrVar.e1 == 0);
            b5Var.G = true;
