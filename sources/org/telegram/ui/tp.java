...
public final class tp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a(Canvas canvas, qj qjVar, float f10, float f11) {
        ...
        tqVar2.H = qjVar;
        RectF rectF3 = tqVar2.f;
        float dp = AndroidUtilities.dp(110.0f) * f10;
        if (dp < AndroidUtilities.dp(8.0f)) {
            return;
        }
        float f22 = f10 < 0.2f ? 5.0f * f10 * f11 : f11;
        org.telegram.ui.ActionBar.j6.q(0.0f, qjVar.getMeasuredHeight() - dp, this.c, qjVar.getMeasuredHeight());
        ...
        if (!this.O && f15 > 0.0f) {
            ...
            if (this.U && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.nq) && (((org.telegram.ui.Components.nq) imageReceiver2.getDrawable()).b instanceof org.telegram.ui.Components.n80)) {
                ((org.telegram.ui.Components.n80) ((org.telegram.ui.Components.nq) imageReceiver2.getDrawable()).b).i = f10;
            }
            if (this.H <= 0.0f || !this.Y) {
                ...
                tqVar3.e(tqVar3.s);
                canvas2.scale(f54, f54, (tqVar3.s / 2.0f) + tqVar3.A + AndroidUtilities.dp(12.0f) + f17, (A2 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                ...
                if (f56 != 1.0f) {
                    ...
                    if (i20 == 0 || i20 == 1) {
                        ...
                        f21 = 14.0f;
                        tqVar3.e(tqVar3.s);
                        float dp14 = (tqVar3.x - AndroidUtilities.dp(f55 * 2.0f)) / 2.0f;
                        float f57 = tqVar3.B;
                        rectF2.set(f57, dp14, tqVar3.s + f57 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f58 = f56 * 2.0f;
                        if (f58 > 1.0f) {
                            f58 = 1.0f;
                        }
                        float dp15 = (tqVar3.x - AndroidUtilities.dp(f55 * 2.0f)) / 2.0f;
                        int i21 = tqVar3.s;
                        int i22 = tqVar3.r;
                        if (i21 == i22) {
                            w10 = i21;
                    ...
                    f21 = 14.0f;
                    tqVar3.e(tqVar3.s);
                    float dp16 = (tqVar3.x - AndroidUtilities.dp(f55 * 2.0f)) / 2.0f;
                    float f60 = tqVar3.B;
                    rectF2.set(f60, dp16, tqVar3.s + f60 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                ...
                float f61 = this.H;
                tqVar3.e(tqVar3.s);
                canvas2.scale(f61, f61, (tqVar3.s / 2.0f) + tqVar3.A + AndroidUtilities.dp(12.0f) + f17, (A2 - AndroidUtilities.dp(f20)) + AndroidUtilities.dp(f21));
    ...
    public final void g(final View view, boolean z4) {
        ...
        if (!z4) {
            ...
            final int i13 = 4;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.rp
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.rp
            public final /* synthetic */ tp b;
        ...
        ofFloat2.setInterpolator(org.telegram.ui.Components.nr.h);
        ofFloat2.setDuration(250L);
        this.I = 0.0f;
        ValueAnimator ofFloat3 = ValueAnimator.ofFloat(0.0f, 1.0f);
        ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.rp
            public final /* synthetic */ tp b;
        ...
        org.telegram.ui.Components.nr nrVar = org.telegram.ui.Components.nr.j;
        ofFloat3.setInterpolator(nrVar);
        ofFloat3.setDuration(180L);
        ValueAnimator ofFloat4 = ValueAnimator.ofFloat(1.0f, -0.5f);
        ofFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.rp
            public final /* synthetic */ tp b;
        ...
        final int i14 = 3;
        ofFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.rp
            public final /* synthetic */ tp b;
        ...
        ofFloat5.setInterpolator(nrVar);
