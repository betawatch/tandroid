...
public final class f3 implements org.telegram.ui.Cells.v9, aj0, org.telegram.ui.Components.uy0 {
    ...
    public org.telegram.ui.Components.s80 e;
    public org.telegram.ui.Components.s80 f;
    ...
    public final void draw(Canvas canvas, View view) {
        ...
        if (s80Var2 != null) {
            canvas.drawPath(s80Var2, m4.u1);
        }
        org.telegram.ui.Components.s80 s80Var3 = this.e;
        if (s80Var3 != null) {
            canvas.drawPath(s80Var3, m4.t1);
        }
        org.telegram.ui.Components.s80 s80Var4 = this.f;
        if (s80Var4 != null) {
            canvas.drawPath(s80Var4, m4.v1);
        }
        ...
        if (d70Var.d == this && d70Var.b == null && d70Var.h) {
            ...
            canvas.drawRect((-AndroidUtilities.dp(2.0f)) + f9, 0.0f, f9 + width + AndroidUtilities.dp(2.0f), this.d.getHeight(), m4.s1);
        }
