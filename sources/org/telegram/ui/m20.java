...
public class m20 extends org.telegram.ui.Components.pc0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (!n20Var.f) {
            if (n20Var.h) {
                float f10 = n20Var.n + 0.016f;
                n20Var.n = f10;
                if (f10 > 3.0f) {
                    n20Var.h = false;
                }
            } else {
                float f11 = n20Var.n - 0.016f;
                n20Var.n = f11;
                if (f11 < 1.0f) {
                    n20Var.h = true;
                }
        ...
        View m9 = n20Var.c.getLayoutManager() != null ? n20Var.c.getLayoutManager().m(0) : null;
        n20Var.r = m9 != null ? m9.getBottom() : 0;
        kVar = ((org.telegram.ui.ActionBar.p2) n20Var).actionBar;
        int dp = AndroidUtilities.dp(16.0f) + kVar.getBottom();
        float f12 = 1.0f - ((n20Var.r - dp) / (n20Var.G - dp));
        n20Var.v = f12;
        n20Var.v = Utilities.clamp(f12, 1.0f, 0.0f);
        ...
        float f13 = n20Var.x;
        n20Var.x = 0.0f;
        if (n20Var.r < AndroidUtilities.dp(30.0f) + dp2) {
            n20Var.x = ((AndroidUtilities.dp(30.0f) + dp2) - n20Var.r) / AndroidUtilities.dp(30.0f);
        }
        if (n20Var.E) {
            n20Var.x = 1.0f;
            n20Var.v = 1.0f;
        ...
        float dp3 = AndroidUtilities.dp(16.0f) + (i10 - ((measuredHeight2 + measuredHeight) - n20Var.F));
        ...
        ((org.telegram.ui.Components.f90) aVar.c).setAlpha(f15);
        ...
        float f16 = n20Var.v;
        textView.setTranslationX((1.0f - org.telegram.ui.Components.mr.h.getInterpolation(1.0f - (f16 > 0.3f ? (f16 - 0.3f) / 0.7f : 0.0f))) * dp4);
        if (!n20Var.f) {
            invalidate();
        }
        n20Var.a.d(0, (-getMeasuredWidth()) * 0.1f * n20Var.n, 0, getMeasuredWidth(), 0.0f, getMeasuredHeight());
        if (n20Var.J) {
            int themedColor = n20Var.getThemedColor(org.telegram.ui.ActionBar.j6.a7);
            Paint paint2 = this.E0;
            paint2.setColor(themedColor);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), paint2);
        } else {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), n20Var.a.f);
        }
        int d = i0.a.d(f15, n20Var.getThemedColor(org.telegram.ui.ActionBar.j6.j5), n20Var.getThemedColor(n20Var.J ? org.telegram.ui.ActionBar.j6.G6 : org.telegram.ui.ActionBar.j6.Tj));
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((!rectF2.contains(motionEvent.getX(), motionEvent.getY()) && !this.B0) || n20Var.c.H1 || (layout = f90Var.getLayout()) == null) {
            f10 = 1.0f;
        } else {
            ...
            if (text instanceof Spanned) {
                ...
                if (clickableSpanArr != null && clickableSpanArr.length > 0 && n20Var.x < 1.0f) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.A0) && !n20Var.c.H1 && isClickable && n20Var.x < f10) {
        ...
        if ((rectF2.contains(motionEvent.getX(), motionEvent.getY()) || this.C0) && !n20Var.c.H1 && n20Var.x < f10) {
    ...
    @Override // org.telegram.ui.Components.pc0, org.telegram.ui.Components.qv0
    ...
    @Override // org.telegram.ui.Components.pc0, android.widget.FrameLayout, android.view.View
    /*
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        n20 n20Var = this.G0;
        kg.a aVar = n20Var.y;
        n20Var.E = View.MeasureSpec.getSize(i10) > View.MeasureSpec.getSize(i11);
        e5Var = ((org.telegram.ui.ActionBar.p2) n20Var).parentLayout;
        if (e5Var != null) {
            e5Var2 = ((org.telegram.ui.ActionBar.p2) n20Var).parentLayout;
            if (((ActionBarLayout) e5Var2).J0) {
                i12 = 0;
                n20Var.F = i12;
                aVar.measure(i10, View.MeasureSpec.makeMeasureSpec(0, 0));
                ViewGroup.LayoutParams layoutParams = n20Var.e.getLayoutParams();
                i13 = n20Var.B;
                if (i13 <= 0) {
                ...
                if (i0Var instanceof org.telegram.ui.Components.pz) {
                    ...
                    pzVar.p1();
                    ((org.telegram.ui.Components.pz) n20Var.C).S = 0;
                }
        ...
        n20Var.F = i12;
        aVar.measure(i10, View.MeasureSpec.makeMeasureSpec(0, 0));
        ViewGroup.LayoutParams layoutParams2 = n20Var.e.getLayoutParams();
        i13 = n20Var.B;
        if (i13 <= 0) {
        }
