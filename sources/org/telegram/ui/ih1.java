    ...
    */
            ...
            if (chat == null || ChatObject.isMegagroup(chat)) {
                ...
                if (!TextUtils.isEmpty(this.h)) {
                    ...
                    if (!lowerCase2.startsWith(lowerCase)) {
                        charSequence = charSequence2;
                        if (!org.telegram.messenger.z0.w(" ", lowerCase, lowerCase2) && !translitSafe2.startsWith(translitSafe) && !org.telegram.messenger.z0.w(" ", translitSafe, translitSafe2)) {
                        }
                        long j10 = chat.id;
    ...
    public final void W(org.telegram.ui.Components.h51 h51Var, View view) {
        ...
        if (i10 != 2) {
            if (h51Var.a == 12) {
                finishFragment();
                eh1Var.run(getMessagesController().getChat(Long.valueOf(-h51Var.x)));
                return;
            }
            return;
        }
