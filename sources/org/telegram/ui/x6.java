...
public final class x6 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean f;
    public boolean h;
    public org.telegram.ui.Components.dp n;
    ...
    public x6(Context context, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        addView(textView, g7.e6.d(-1, -1.0f, (z10 ? 5 : 3) | 48, z10 ? 21.0f : 72.0f, 0.0f, z10 ? 72.0f : 21.0f, 0.0f));
        ...
        addView(j6Var, g7.e6.d(-2, -1.0f, (z11 ? 3 : 5) | 48, z11 ? 21.0f : 72.0f, 0.0f, z11 ? 72.0f : 21.0f, 0.0f));
        org.telegram.ui.Components.o9 o9Var = new org.telegram.ui.Components.o9(context);
        this.e = o9Var;
        o9Var.getAvatarDrawable().p = 0.8f;
    ...
    public final void onMeasure(int i9, int i10) {
        setMeasuredDimension(View.MeasureSpec.getSize(i9), AndroidUtilities.dp(50.0f) + (this.f ? 1 : 0));
        int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.dp(34.0f);
        int i11 = measuredWidth / 2;
        org.telegram.ui.Components.o9 o9Var = this.e;
        if (o9Var.getVisibility() == 0) {
            o9Var.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(38.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(38.0f), TLObject.FLAG_30));
        }
        org.telegram.ui.Components.j6 j6Var = this.d;
        ...
        org.telegram.ui.Components.dp dpVar = this.n;
        if (dpVar != null) {
