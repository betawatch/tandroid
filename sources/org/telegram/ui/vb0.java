...
public final /* synthetic */ class vb0 implements RequestDelegate {
    ...
    */
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.a) {
            case 0:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.vn0((wb0) this.b, tLObject, (HashSet) this.c, tL_error, 16));
                break;
            case 1:
                ...
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.vn0((ue0) this.b, tLObject, (String) this.c, tL_error, 19));
                break;
            case 3:
            ...
            case 4:
                ...
                break;
            case 5:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.vn0((pg0) this.b, tL_error, tLObject, (String) this.c, 23));
                break;
            case 6:
            ...
            case 10:
                ...
                break;
            case 11:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.vn0((oo0) this.b, tLObject, tL_error, (TL_account.getTmpPassword) this.c, 27));
                break;
            case 12:
                AndroidUtilities.runOnUIThread(new wr0((kw0) this.b, tL_error, tLObject, (TL_stars.updatePaidMessagesPrice) this.c, 2));
                break;
            case 13:
                AndroidUtilities.runOnUIThread(new wr0((PrivacyControlActivity) this.b, tL_error, tLObject, (boolean[]) this.c));
                break;
            case 14:
                AndroidUtilities.runOnUIThread(new ix0(3, (PrivacySettingsActivity) this.b, (org.telegram.ui.Cells.w8) this.c));
                break;
            case 15:
                AndroidUtilities.runOnUIThread(new wr0((ProfileActivity) this.b, tLObject, tL_error, (int[]) this.c, 6));
                break;
            case 16:
                AndroidUtilities.runOnUIThread(new wr0((ProfileActivity) this.b, tLObject, (TLRPC.TL_username) this.c, tL_error, 7));
                break;
            case 17:
                AndroidUtilities.runOnUIThread(new wr0((ProfileActivity) this.b, tL_error, tLObject, (String) this.c, 9));
                break;
            case 18:
                AndroidUtilities.runOnUIThread(new wr0((j01) this.b, tLObject, (TLRPC.TL_username) this.c, tL_error, 11));
                break;
            case 19:
            ...
            case 20:
                ...
                break;
            case 21:
                AndroidUtilities.runOnUIThread(new wr0((j81) this.b, tLObject, tL_error, (l9) this.c, 14));
                break;
            case 22:
                AndroidUtilities.runOnUIThread(new wr0((z81) this.b, tL_error, tLObject, (String) this.c, 15));
                break;
            case 23:
                ...
                if (tL_error == null) {
                    if (tLObject instanceof TL_stats.TL_statsGraph) {
                        ...
                        try {
                            ...
                            str = str2;
                            AndroidUtilities.runOnUIThread(new wr0(ea1Var, str3, str, callback0Return, 17));
                            return;
                        }
                    } else {
                        str2 = null;
            ...
            case 27:
                ...
                break;
            case 28:
                AndroidUtilities.runOnUIThread(new wr0((zg1) this.b, tLObject, (String) this.c, tL_error, 20));
                break;
            default:
