        ...
        switch (this.a) {
            ...
            case 6:
                ...
                if (u9Var5.f.getTag() != null) {
                    ...
                    u9Var5.f.animate().setDuration(200L).alpha(0.0f).setInterpolator(org.telegram.ui.Components.wr.f).start();
                    break;
                }
                break;
            case 7:
            ...
            default:
                ...
                if (f7 != f10) {
                    ...
                    u9Var7.W.setInterpolator(org.telegram.ui.Components.wr.f);
                    u9Var7.W.start();
                    o1.k kVar = u9Var7.Z;
                    if (kVar != null) {
                        kVar.c();
