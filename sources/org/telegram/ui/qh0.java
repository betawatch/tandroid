...
public final class qh0 extends FrameLayout {
    ...
    public boolean H;
    public boolean I;
    public final org.telegram.ui.Components.w11 J;
    ...
    public qh0(th0 th0Var, Context context) {
        super(context);
        this.K = th0Var;
        this.s = new Paint(1);
        ...
        this.w = new RectF();
        this.E = 1.0f;
        this.J = new org.telegram.ui.Components.w11();
        ...
        imageView.setColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Uh, false));
        imageView.setOnClickListener(new h60(this, 9));
    ...
    public final int a(float f7, int i10) {
        ...
        if (tL_chatInviteExported != null && tL_chatInviteExported.subscription_pricing != null) {
            return org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.uj, false);
        }
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.ka, false);
        }
        if (i10 != 1) {
            return i10 == 2 ? org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.oa, false) : i10 == 4 ? org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.V8, false) : org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Oh, false);
        }
        if (f7 > 0.5f) {
            return i0.a.d(1.0f - ((f7 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.na, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.oa, false));
        }
        return i0.a.d(1.0f - (f7 / 0.5f), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.oa, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.ka, false));
    }
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            SpannableStringBuilder X0 = yh.w7.X0(false, hg.c.k(tL_chatInviteExported.subscription_pricing.amount, ',', new StringBuilder("⭐️ ")), 0.75f, null);
        ...
        if (!isEmpty) {
            ...
            i11 = ((org.telegram.ui.ActionBar.n2) th0Var).currentAccount;
            ...
            if (i15 > 0 && i14 == 0 && !tL_chatInviteExported.expired && !tL_chatInviteExported.revoked) {
                ...
                if (tL_chatInviteExported.requested > 0) {
                    if (tL_chatInviteExported.usage > 0) {
                        formatPluralString = w.c.g(formatPluralString, ", ");
                    }
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((th0Var.n0 * 1000) + System.currentTimeMillis());
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z11 || tL_chatInviteExported2.revoked) {
            ...
            if (i12 > 0 || tL_chatInviteExported2.usage_limit > 0) {
                if (i12 > 0) {
                    long currentTimeMillis = (th0Var.n0 * 1000) + System.currentTimeMillis();
        ...
        if (!z12) {
            ...
            if (tL_chatInviteExported.subscription_pricing == null) {
                th0Var.a0.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                th0Var.a0.draw(canvas2);
            } else if (tL_chatInviteExported.revoked) {
                th0Var.Z.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                th0Var.Z.draw(canvas2);
            } else {
                th0Var.Y.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                th0Var.Y.draw(canvas2);
            }
            if (this.H) {
                return;
            }
            canvas2.drawLine(AndroidUtilities.dp(70.0f), getMeasuredHeight() - 1, AndroidUtilities.dp(23.0f) + getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.h6.k0);
            return;
        }
        if (z12) {
            f10 = this.F;
        ...
        z10 = ((org.telegram.ui.ActionBar.n2) th0Var).isPaused;
        if (!z10) {
            invalidate();
        }
        this.F = f14;
