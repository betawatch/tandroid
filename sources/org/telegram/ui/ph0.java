...
public final class ph0 extends FrameLayout {
    ...
    public ph0(sh0 sh0Var, Context context) {
        super(context);
        this.K = sh0Var;
        this.s = new Paint(1);
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            SpannableStringBuilder X0 = yh.w7.X0(false, org.telegram.messenger.f0.h(tL_chatInviteExported.subscription_pricing.amount, ',', new StringBuilder("⭐️ ")), 0.75f, null);
        ...
        if (!isEmpty) {
            ...
            i11 = ((org.telegram.ui.ActionBar.m2) sh0Var).currentAccount;
            ...
            if (i15 > 0 && i14 == 0 && !tL_chatInviteExported.expired && !tL_chatInviteExported.revoked) {
                ...
                if (tL_chatInviteExported.requested > 0) {
                    if (tL_chatInviteExported.usage > 0) {
                        formatPluralString = v7.j.t(formatPluralString, ", ");
                    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z11 || tL_chatInviteExported2.revoked) {
            ...
            if (i12 > 0 || tL_chatInviteExported2.usage_limit > 0) {
                if (i12 > 0) {
                    long currentTimeMillis = (sh0Var.n0 * 1000) + System.currentTimeMillis();
        ...
        if (!z12) {
            ...
            if (tL_chatInviteExported.subscription_pricing == null) {
                sh0Var.a0.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                sh0Var.a0.draw(canvas2);
            } else if (tL_chatInviteExported.revoked) {
                sh0Var.Z.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                sh0Var.Z.draw(canvas2);
            } else {
                sh0Var.Y.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                sh0Var.Y.draw(canvas2);
            }
            if (this.H) {
                return;
            }
        ...
        z10 = ((org.telegram.ui.ActionBar.m2) sh0Var).isPaused;
        if (!z10) {
            invalidate();
        }
        this.F = f14;
