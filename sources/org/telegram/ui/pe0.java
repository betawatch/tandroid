...
public final class pe0 extends org.telegram.ui.Components.vv0 {
    ...
    */
    public pe0(og0 og0Var, Context context, int i10) {
        super(context);
        boolean z4;
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                z4 = false;
                kj0Var.setVisibility(!z4 ? 8 : 0);
                addView(kj0Var, k7.c6.t(95, 95, 1, 0, 10, 0, 5));
                                    ...
                                    if (bundle != null && (tL_auth_sentCode = pe0Var2.Q) != null) {
                                        ...
                                        if (i15 != 4 && i15 != 2 && i15 != 11 && i15 != 15) {
                                            if (i15 == 3) {
                                                ...
                                                if (!pe0Var2.O && !pe0Var2.J && !og0Var2.l0) {
                                                    pe0Var2.J = true;
                                                    qf0Var.invalidate();
                                                    ...
                                                    final int i16 = 1;
                                                    og0Var2.n1(ConnectionsManager.getInstance(i14).sendRequest(tL_auth_resendCode, new RequestDelegate() { // from class: org.telegram.ui.je0
                ...
                final int i14 = 1;
                o2Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ne0
                    public final /* synthetic */ pe0 b;
                                        ...
                                        if (i15 != 4 && i15 != 2 && i15 != 11 && i15 != 15) {
                                            if (i15 == 3) {
                                                ...
                                                if (!pe0Var2.O && !pe0Var2.J && !og0Var2.l0) {
                                                    ...
                                                    final int i16 = 1;
                                                    og0Var2.n1(ConnectionsManager.getInstance(i142).sendRequest(tL_auth_resendCode, new RequestDelegate() { // from class: org.telegram.ui.je0
                                                        @Override // org.telegram.tgnet.RequestDelegate
                                                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                                            switch (i16) {
                                                                case 0:
                ...
                final int i15 = 2;
                qf0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ne0
                    public final /* synthetic */ pe0 b;
        ...
        final int i142 = 1;
        o2Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ne0
            public final /* synthetic */ pe0 b;
                                ...
                                if (i152 != 4 && i152 != 2 && i152 != 11 && i152 != 15) {
                                    if (i152 == 3) {
                                        ...
                                        if (!pe0Var2.O && !pe0Var2.J && !og0Var2.l0) {
                                            ...
                                            final int i16 = 1;
                                            og0Var2.n1(ConnectionsManager.getInstance(i1422).sendRequest(tL_auth_resendCode, new RequestDelegate() { // from class: org.telegram.ui.je0
                                                @Override // org.telegram.tgnet.RequestDelegate
                                                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                                    switch (i16) {
                                                        case 0:
        ...
        final int i152 = 2;
        qf0Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ne0
            public final /* synthetic */ pe0 b;
    ...
    @Override // org.telegram.ui.Components.vv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new me0(this, 3), og0.q0);
    }
