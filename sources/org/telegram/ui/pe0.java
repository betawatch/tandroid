                        ...
                        switch (i12) {
                            ...
                            case 1:
                                ...
                                if (tL_error2 != null) {
                                    ...
                                    if (yg0Var.getParentActivity() != null) {
                                        ...
                                        alertDialog$Builder.k(LocaleController.getString(R.string.Continue), new z10(17, re0Var2, tL_auth_passwordRecovery));
                            ...
                            default:
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    ...
                                    i11 = ((org.telegram.ui.ActionBar.n2) yg0Var2).currentAccount;
                                    ...
                                    re0Var2.postDelayed(new r80(18, re0Var2, tLObject2), 150L);
                                    break;
                                }
                                break;
                        }
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            ...
                            case 1:
                                ...
                                if (tL_error2 != null) {
                                    ...
                                    if (yg0Var.getParentActivity() != null) {
                                        ...
                                        b2Var.T = formatSpannable;
                                        b2Var.R = LocaleController.getString("RestoreEmailSentTitle", R.string.RestoreEmailSentTitle);
                                        alertDialog$Builder.k(LocaleController.getString(R.string.Continue), new z10(17, re0Var22, tL_auth_passwordRecovery));
                                        Dialog showDialog = yg0Var.showDialog(b2Var);
                                        if (showDialog != null) {
                                            showDialog.setCanceledOnTouchOutside(false);
                                            showDialog.setCancelable(false);
                            ...
                            default:
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i112 = ((org.telegram.ui.ActionBar.n2) yg0Var2).currentAccount;
                                    ...
                                    yg0Var2.v1(false, true);
                                    re0Var22.postDelayed(new r80(18, re0Var22, tLObject2), 150L);
                                    break;
                                }
                                break;
                        }
