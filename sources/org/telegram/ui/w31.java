...
public final class w31 extends FrameLayout {
    ...
    public w31(b41 b41Var, Context context) {
        super(context);
        this.e = b41Var;
        this.a = new org.telegram.ui.Components.e6(this, 250L, org.telegram.ui.Components.qr.h);
        this.c = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (i12 < length) {
            ...
            if (view == null) {
                ...
                float clamp = Utilities.clamp(1.0f - Math.abs(a41Var.getTranslationX() / a41Var.getMeasuredWidth()), 1.0f, f7);
                float f10 = this.b;
        ...
        canvas.drawRoundRect(rectF, lerp, lerp, b41Var.c);
        canvas.save();
        Path path = this.c;
        path.rewind();
        ...
        if (bool == null || bool.booleanValue() != z10) {
            boolean z11 = AndroidUtilities.computePerceivedBrightness(b41Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) > 0.721f;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(b41Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f;
