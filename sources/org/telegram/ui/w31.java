...
public final class w31 extends org.telegram.ui.Components.ll0 {
    ...
    public final int h() {
        ...
        x31 x31Var = this.e;
        if (!z10) {
            return x31Var.h.size() + (x31Var.e >= 0 ? 1 : 0);
        }
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (!z11) {
            ...
            z10 = false;
        } else if (i10 >= 0 && i10 < x31Var.f.size()) {
            language = (TranslateController.Language) x31Var.f.get(i10);
        }
        if (language == null) {
            return;
        }
        ...
        y8Var.setChecked(x31Var.r.contains(language.code));
    }
