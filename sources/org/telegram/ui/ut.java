...
public final class ut {
    ...
    public View h;
    public boolean i;
    public org.telegram.ui.Components.t11 j;
    ...
    public static /* synthetic */ void a(ut utVar, Bitmap bitmap, Bitmap bitmap2) {
        fh.b bVar = utVar.s;
        Paint paint = utVar.N;
    ...
    public static int d(ut utVar, int i10) {
        return org.telegram.ui.ActionBar.j6.v0(i10, utVar.c0);
    }
    ...
    public static boolean h(ut utVar, ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        boolean z12 = (MessageObject.isVoted(d) || d.poll.closed || utVar.l.c()) ? false : true;
        boolean z13 = !z12 && MessageObject.canUnvote(d);
        if (z11) {
            qh.q qVar2 = new qh.q(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), utVar.r, utVar.c0);
            org.telegram.ui.Components.n70 n70Var = new org.telegram.ui.Components.n70(actionBarPopupWindow$ActionBarPopupWindowLayout, utVar.c0);
            int b10 = actionBarPopupWindow$ActionBarPopupWindowLayout.b(n70Var.B);
            int i10 = org.telegram.ui.ActionBar.j6.E8;
            n70Var.T(org.telegram.ui.ActionBar.j6.l1(0.06f, org.telegram.ui.ActionBar.j6.v0(i10, utVar.c0)));
            ah.c cVar = utVar.t;
            dh.e k10 = eh.b.k(utVar.c0);
            ...
            n70Var.k();
            MessageObject z14 = utVar.l.z();
            Activity activity = utVar.w;
            if ((activity instanceof LaunchActivity) && z14 != null) {
                ...
                if (o2Var != null) {
                    ...
                    qVar.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.I5, utVar.c0), 12, 0));
                    ...
                    org.telegram.ui.ActionBar.l1 l1Var = new org.telegram.ui.ActionBar.l1(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), utVar.c0);
                    l1Var.setTag(R.id.fit_width_tag, 1);
                    l1Var.setColor(org.telegram.ui.ActionBar.j6.l1(0.06f, org.telegram.ui.ActionBar.j6.v0(i10, utVar.c0)));
            ...
            qVar.setOnClickListener(new ci.o4(actionBarPopupWindow$ActionBarPopupWindowLayout, b10, 17));
            actionBarPopupWindow$ActionBarPopupWindowLayout.addView(qVar);
            org.telegram.ui.ActionBar.l1 l1Var2 = new org.telegram.ui.ActionBar.l1(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), utVar.c0);
            l1Var2.setTag(R.id.fit_width_tag, 1);
            l1Var2.setColor(org.telegram.ui.ActionBar.j6.l1(0.06f, org.telegram.ui.ActionBar.j6.v0(i10, utVar.c0)));
        ...
        if (z12) {
            f7 = 0.06f;
            org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.msg_select, LocaleController.getString(R.string.PollSubmitVotesNoCaps), false, utVar.c0).setOnClickListener(new jt(utVar, 2));
        } else {
            f7 = 0.06f;
        }
        if (z13) {
            actionBarPopupWindow$ActionBarPopupWindowLayout2 = actionBarPopupWindow$ActionBarPopupWindowLayout;
            org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout2, R.drawable.msg_unvote, LocaleController.getString(R.string.Unvote), false, utVar.c0).setOnClickListener(new jt(utVar, 3));
        } else {
            actionBarPopupWindow$ActionBarPopupWindowLayout2 = actionBarPopupWindow$ActionBarPopupWindowLayout;
        }
        if (!z11 && (z12 || z13)) {
            org.telegram.ui.ActionBar.l1 l1Var3 = new org.telegram.ui.ActionBar.l1(actionBarPopupWindow$ActionBarPopupWindowLayout2.getContext(), utVar.c0);
            l1Var3.setTag(R.id.fit_width_tag, 1);
            l1Var3.setColor(org.telegram.ui.ActionBar.j6.l1(f7, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.E8, utVar.c0)));
                ...
                if (top > y3 || bottom < y3 || left > x10 || right < x10) {
                    ...
                    if (z10) {
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.e2) {
                            ...
                            if ((childAt instanceof org.telegram.ui.Components.ny0) && (((org.telegram.ui.Components.ny0) childAt).b instanceof org.telegram.ui.Components.o5)) {
                                imageReceiver.setRoundRadius(0);
                            }
                            i10 = -1;
                        } else {
    ...
    */
    public final boolean s(MotionEvent motionEvent, org.telegram.ui.Components.ml0 ml0Var, Object obj, st stVar, org.telegram.ui.ActionBar.f6 f6Var) {
        int i10;
        int i11;
        st stVar2;
        View view;
        ...
        st stVar3 = this.l;
        if ((stVar3 == null || stVar3.h()) && (this.j != null || this.E)) {
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3 || motionEvent.getAction() == 6) {
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.br0(23, ml0Var, obj), 150L);
                org.telegram.ui.Components.t11 t11Var = this.j;
                if (t11Var != null) {
                                    ...
                                    if (z10) {
                                        ...
                                        if (i10 != -1 && childAt != this.h) {
                                            ...
                                            if (!(view2 instanceof org.telegram.ui.Cells.f8)) {
                                                ...
                                                st stVar4 = this.l;
                                                t(sticker, stickerPath, findAnimatedEmojiEmoticon, stVar4 != null ? stVar4.F(false) : null, null, i10, f8Var.y, f8Var.getParentObject(), f6Var, 0);
                                                ...
                                                st stVar5 = this.l;
                                                t(sticker2, null, findAnimatedEmojiEmoticon2, stVar5 != null ? stVar5.F(false) : null, null, i10, false, d8Var.getParentObject(), f6Var, 0);
                                                ...
                                                st stVar6 = this.l;
                                                t(document2, null, null, stVar6 != null ? stVar6.F(true) : null, e2Var2.getBotInlineResult(), i10, false, e2Var2.getBotInlineResult() != null ? e2Var2.getInlineBot() : e2Var2.getParentObject(), f6Var, 0);
                                                if (i10 != 1 || this.m) {
                                            ...
                                            } else if (view2 instanceof org.telegram.ui.Components.ny0) {
                                                Drawable drawable = ((org.telegram.ui.Components.ny0) view2).b;
        ...
        if (i10 == 0 || i10 == 2 || i10 == 3) {
            ...
            if (document != null) {
                ...
                if (inputStickerSet != null || i10 == 2) {
                    ...
                    AndroidUtilities.runOnUIThread(qtVar2, i11 > 0 ? i11 : 1300L);
                }
    ...
    public final boolean y(View view) {
        ...
        String findAnimatedEmojiEmoticon = MessageObject.findAnimatedEmojiEmoticon(f8Var.getSticker(), null, Integer.valueOf(this.r));
        st stVar = this.l;
        t(sticker, stickerPath, findAnimatedEmojiEmoticon, stVar != null ? stVar.F(false) : null, null, 0, f8Var.y, f8Var.getParentObject(), this.c0, 0);
        qt qtVar = this.U;
        AndroidUtilities.cancelRunOnUIThread(qtVar);
