...
public final class sy extends org.telegram.ui.Components.ga implements ai.s9 {
    ...
    public final void A1(boolean z10, org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (r2Var != null) {
            ...
            w0(0, top, org.telegram.ui.Components.qr.g);
            if (z10) {
                wyVar.d1 = true;
            } else {
                B1();
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f16 > 0.0f) {
            canvas2.clipRect(0, 0, AndroidUtilities.lerp(getMeasuredWidth(), AndroidUtilities.dp(n41.getRightPaddingSize()), this.i3), getMeasuredHeight());
            ...
            canvas2.drawRect(0.0f, 0.0f, AndroidUtilities.dp(n41.getRightPaddingSize()), getMeasuredHeight(), paint3);
            paint = paint3;
            int alpha = org.telegram.ui.ActionBar.j6.k0.getAlpha();
            org.telegram.ui.ActionBar.j6.k0.setAlpha((int) (this.i3 * alpha));
            canvas2 = canvas;
            canvas2.drawRect(AndroidUtilities.dp(n41.getRightPaddingSize()), 0.0f, AndroidUtilities.dp(n41.getRightPaddingSize()) - 1, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.k0);
        ...
        wy wyVar2 = this.u3;
        float f17 = wyVar2.E ? 0.0f : wyVar2.N;
        ...
        while (i20 < getChildCount()) {
            ...
            if (childAt2 instanceof org.telegram.ui.Cells.r2) {
                ...
                if (AndroidUtilities.isTablet()) {
                    paint2 = paint;
                    r2Var4.setDialogSelected(r2Var4.getDialogId() == wyVar2.p2.dialogId);
                } else {
                    paint2 = paint;
                }
                ...
                if (this.d3 && r2Var4.b0(0, true) && (S = RecyclerView.S(r2Var4)) >= 0) {
                    getAdapter().m(S);
                }
                if (r2Var4.getDialogId() == wyVar.F3.getCurrentFragmetDialogId()) {
                    r2Var3 = r2Var4;
                    r2Var = r2Var3;
                } else {
                    r2Var = r2Var4;
        ...
        if (r2Var3 != null) {
            ...
            float interpolation = org.telegram.ui.Components.qr.f.getInterpolation(this.p3);
        ...
        if (this.m3 != null) {
            ...
            for (int i21 = 0; i21 < this.m3.size(); i21++) {
                ...
                this.l3.getClass();
                int T2 = RecyclerView.T(view3);
                if (T2 < i19 && view3.getTop() > f7) {
                    f7 = view3.getTop();
                }
                if (T2 > i18 && view3.getBottom() < f24) {
                    f24 = view3.getBottom();
                }
            }
        ...
        org.telegram.ui.Cells.r2 r2Var6 = wyVar3.W0;
        if (r2Var6 != null && (ad0Var = wyVar3.V0) != null) {
            int measuredHeight = (wyVar3.W0.getMeasuredHeight() / 2) + r2Var6.getTop();
            ...
            float measuredWidth = ((view5.getMeasuredWidth() + r12) * ad0Var.h) - org.telegram.messenger.w1.D(62.0f, 3, dp);
            int i24 = dp / 2;
            ...
            float f29 = ad0Var.g;
            int u10 = (int) (f29 < 0.5f ? org.telegram.messenger.wl.u(f29, 0.5f, 1.0f, 35.0f) : ((f29 - 0.5f) * 35.0f) / 0.5f);
            float f30 = u10;
            float f31 = 360 - (u10 * 2);
        ...
        if (this.s3 == null) {
            i10 = ((org.telegram.ui.ActionBar.o2) wyVar3).currentAccount;
    ...
    public final void onDraw(Canvas canvas) {
        vy vyVar = this.g3;
        if (vyVar.n != null && wy.z4 != 0.0f) {
            int paddingTop = getPaddingTop();
            if (paddingTop != 0) {
                canvas.save();
                canvas.translate(0.0f, paddingTop);
            }
            vyVar.n.c(canvas, true);
            if (paddingTop != 0) {
                canvas.restore();
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int L0 = vyVar.c.L0();
        wy wyVar = this.u3;
        if (L0 != -1 && vyVar.e.y == 0 && vyVar.c.y < 0 && vyVar.a.getScrollState() != 1) {
            s4.c1 L = vyVar.a.L(L0);
            if (L != null) {
                int top = L.a.getTop();
                if (vyVar.s == 0 && wyVar.Z3() && vyVar.v == 2) {
                    L0 = Math.max(1, L0);
                }
                this.f3 = true;
                vyVar.c.h1(L0, (int) ((top - this.h3) + wyVar.x3 + 0));
                this.f3 = false;
            }
        } else if (L0 == -1 && this.e3) {
            vyVar.c.h1((vyVar.s == 0 && wyVar.Z3()) ? 1 : 0, (int) wyVar.N);
        }
        this.f3 = true;
        ...
        float f7 = ksVar != null ? ksVar.getMetadata().c.a : 0.0f;
        ...
        if (dp2 != this.Y2 || n32 != getPaddingBottom()) {
            ...
            if (wyVar.K) {
                vyVar.w.setPaddingTop(dp2 - AndroidUtilities.dp(81.0f));
            } else {
                vyVar.w.setPaddingTop(dp2);
            }
        ...
        this.f3 = false;
        if (this.e3 && wyVar.getMessagesController().dialogsLoaded) {
            if (vyVar.s == 0 && wyVar.Z3()) {
                this.f3 = true;
        ...
        if (wyVar.l2 || dp2 == 0 || (vyVarArr = wyVar.e0) == null || vyVarArr.length <= 1 || wyVar.l3 || (animatorSet = wyVar.f3) == null) {
            return;
        }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 1 || action == 3) {
            ...
            if (yVar.y != 0) {
                ...
                if (uyVar.e) {
                    uyVar.f = true;
                    if (yVar.g(null, 4) != 0 && (c1Var = vyVar.f.d) != null) {
                        View view = c1Var.a;
                                ...
                                if (dialog != null) {
                                    if (ChatObject.isCommunity(wyVar.getMessagesController().getChat(Long.valueOf(-dialogId)))) {
                                        ...
                                        if (SharedConfig.getChatSwipeAction(i10) == 1) {
                                            ...
                                            wyVar.r4(arrayList2, 101, true, false, null);
                                        } else {
                                            ...
                                            if (SharedConfig.getChatSwipeAction(i11) != 3) {
                                                ...
                                                if (SharedConfig.getChatSwipeAction(i12) == 0) {
                                                    ...
                                                    if (SharedConfig.getChatSwipeAction(i13) == 4) {
                                                        ...
                                                        wyVar.r4(arrayList4, 102, true, false, null);
                                                    }
                                                }
                                                ...
                                                wyVar.O2 = !MessagesController.getInstance(i14).isDialogMuted(dialogId, 0L) ? 1 : 0;
                                                wyVar.P2 = wyVar.O2 > 0 ? 0 : 1;
                                                wyVar.r4(arrayList5, 104, true, false, null);
                                            } else {
        ...
        if (vyVar.s == 0 && ((action == 1 || action == 3) && vyVar.v == 2 && wyVar.Z3() && ((s4.c0) getLayoutManager()).L0() == 0)) {
            int paddingTop = getPaddingTop();
            ...
            if (Q3 != null) {
                ...
                long currentTimeMillis = System.currentTimeMillis() - wyVar.c3;
                ...
                if (getViewOffset() != 0.0f) {
                    ...
                    ofFloat.setDuration(Math.max(100L, (long) org.telegram.messenger.wl.c(getViewOffset(), AndroidUtilities.dp(72.0f), 120.0f, 350.0f)));
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void z1(ox oxVar, float f7, boolean z10) {
        wy wyVar;
        org.telegram.ui.Components.ml0 ml0Var = oxVar == null ? this.l3 : this;
        if (ml0Var == null) {
            this.l3 = oxVar;
            return;
        }
        ...
        while (true) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.r2) {
                ...
                if (r2Var3.getDialogId() == wyVar.F3.getCurrentFragmetDialogId()) {
                    r2Var = r2Var3;
                }
        ...
        if (r2Var != null) {
            if (oxVar != null) {
                oxVar.setPadding(getPaddingLeft(), this.Y2, getPaddingLeft(), getPaddingBottom());
                int F = ((gg.m) oxVar.getAdapter()).F(r2Var.getDialogId());
                int top = (int) ((r2Var.getTop() - ml0Var.getPaddingTop()) + f7);
                if (F >= 0) {
                    vy vyVar = this.g3;
                    if (vyVar.s == 0 && vyVar.v == 2 && wyVar.Z3()) {
                        z11 = true;
                    }
                    ...
                    ((s4.c0) oxVar.getLayoutManager()).h1(F, top);
                }
            }
