...
public final class sy extends org.telegram.ui.Components.ha implements zh.q5 {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f16 > 0.0f) {
            canvas2.clipRect(0, 0, AndroidUtilities.lerp(getMeasuredWidth(), AndroidUtilities.dp(r41.getRightPaddingSize()), this.i3), getMeasuredHeight());
            ...
            canvas2.drawRect(0.0f, 0.0f, AndroidUtilities.dp(r41.getRightPaddingSize()), getMeasuredHeight(), paint3);
            paint = paint3;
            int alpha = org.telegram.ui.ActionBar.j6.k0.getAlpha();
            org.telegram.ui.ActionBar.j6.k0.setAlpha((int) (this.i3 * alpha));
            canvas2 = canvas;
            canvas2.drawRect(AndroidUtilities.dp(r41.getRightPaddingSize()), 0.0f, AndroidUtilities.dp(r41.getRightPaddingSize()) - 1, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.k0);
        ...
        if (r2Var3 != null) {
            ...
            float interpolation = org.telegram.ui.Components.wr.f.getInterpolation(this.p3);
        ...
        if (getItemAnimator() != null && getItemAnimator().k()) {
            ...
            for (int i23 = 0; i23 < getChildCount(); i23++) {
                ...
                if (((childAt3 instanceof org.telegram.ui.Cells.r2) && ((org.telegram.ui.Cells.r2) childAt3).r) || ((childAt3 instanceof fg.l) && ((fg.l) childAt3).a)) {
        ...
        if (r2Var6 != null && (jd0Var = wyVar3.V0) != null) {
            ...
            float measuredWidth = ((view5.getMeasuredWidth() + r12) * jd0Var.h) - org.telegram.messenger.a2.D(62.0f, 3, dp);
            int i24 = dp / 2;
            ...
            float f29 = jd0Var.g;
            int u10 = (int) (f29 < 0.5f ? org.telegram.messenger.em.u(f29, 0.5f, 1.0f, 35.0f) : ((f29 - 0.5f) * 35.0f) / 0.5f);
            float f30 = u10;
            float f31 = 360 - (u10 * 2);
        ...
        if (this.s3 == null) {
            i10 = ((org.telegram.ui.ActionBar.p2) wyVar3).currentAccount;
            zh.c8[] c8VarArr = zh.c8.f;
            if (c8VarArr[i10] == null) {
                c8VarArr[i10] = new zh.c8(i10);
            }
            this.s3 = c8VarArr[i10];
        }
        this.s3.a(this);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f7 = qsVar != null ? qsVar.getMetadata().c.a : 0.0f;
        ...
        if (dp2 != this.Y2 || n32 != getPaddingBottom()) {
            ...
            for (int i13 = 0; i13 < getChildCount(); i13++) {
                if (getChildAt(i13) instanceof fg.l) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 1 || action == 3) {
            ...
            if (yVar.y != 0) {
                ...
                if (uyVar.e) {
                    uyVar.f = true;
                    if (yVar.f(null, 4) != 0 && (c1Var = vyVar.f.d) != null) {
                        View view = c1Var.a;
        ...
        if (vyVar.s == 0 && ((action == 1 || action == 3) && vyVar.v == 2 && wyVar.Z3() && ((s4.c0) getLayoutManager()).L0() == 0)) {
            ...
            if (Q3 != null) {
                ...
                if (getViewOffset() != 0.0f) {
                    ...
                    ofFloat.setDuration(Math.max(100L, (long) org.telegram.messenger.em.c(getViewOffset(), AndroidUtilities.dp(72.0f), 120.0f, 350.0f)));
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void x1(ox oxVar, float f7, boolean z10) {
        wy wyVar;
        org.telegram.ui.Components.vl0 vl0Var = oxVar == null ? this.l3 : this;
        if (vl0Var == null) {
            this.l3 = oxVar;
            return;
        }
        ...
        if (r2Var != null) {
            if (oxVar != null) {
                ...
                int F = ((fg.m) oxVar.getAdapter()).F(r2Var.getDialogId());
                int top = (int) ((r2Var.getTop() - vl0Var.getPaddingTop()) + f7);
                if (F >= 0) {
                    vy vyVar = this.g3;
            ...
            int F2 = ((fg.m) getAdapter()).F(r2Var.getDialogId());
    ...
    public final void y1(boolean z10, org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (r2Var != null) {
            ...
            v0(0, top, org.telegram.ui.Components.wr.g);
            if (z10) {
                wyVar.d1 = true;
            } else {
                z1();
