...
public final class e40 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (d40Var.i1) {
            for (int i14 = 0; i14 < d40Var.getChildCount(); i14++) {
                childAt = d40Var.getChildAt(i14);
        ...
        if (childAt != null && (tVar = j60Var.Z2) != null && tVar.v && !j60Var.F2) {
            ...
            int i15 = rect.left;
            if (i15 < (-d40Var.getMeasuredWidth())) {
                i15 += d40Var.getMeasuredWidth() * 2;
            } else if (i15 > d40Var.getMeasuredWidth()) {
                i15 -= d40Var.getMeasuredWidth() * 2;
            }
