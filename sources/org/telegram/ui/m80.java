...
public final /* synthetic */ class m80 implements Runnable {
    ...
    public /* synthetic */ m80(int i10, Object obj, Object obj2) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
    }
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                if (str.trim().toLowerCase().length() == 0) {
                    AndroidUtilities.runOnUIThread(new m80(i13, languageSelectActivity2, new ArrayList()));
                    break;
                } else {
                    ...
                    AndroidUtilities.runOnUIThread(new m80(i13, languageSelectActivity2, arrayList));
                    break;
                }
                break;
            case 2:
            ...
            case 14:
                ...
                if (gLSurfaceView.getWidth() != 0 && gLSurfaceView.getHeight() != 0) {
                    ...
                    AndroidUtilities.runOnUIThread(new sq(cd0Var, createBitmap2, gLSurfaceView, i12));
                    break;
                }
                break;
            case 15:
            ...
            case 20:
                ...
                if (fileLocation != null) {
                    Utilities.cacheClearQueue.postRunnable(new m80(i12, bf0Var, fileLocation));
                    break;
                }
                break;
            case 21:
            ...
            case 23:
                ...
                alertDialog$Builder.a.setOnDismissListener(new pf0(tf0Var, i13));
            ...
            case 26:
                ...
                while (true) {
                    ...
                    if (i17 >= asVarArr2.length) {
                        runnable3.run();
                        yrVar.e = false;
                        break;
                    } else {
                        asVarArr2[i17].l(0.0f);
                        i17++;
                    }
                }
            case 27:
