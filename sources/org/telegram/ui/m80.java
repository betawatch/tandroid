...
public final class m80 extends org.telegram.ui.Components.ql0 {
    ...
    */
    public final void v(f2.l1 l1Var, int i10) {
        ...
        switch (i14) {
            case 0:
                ...
                if (!z10) {
                    if (!languageSelectActivity.h.isEmpty() && i13 >= 0 && i13 < languageSelectActivity.h.size()) {
                        ...
                        if (!languageSelectActivity.h.isEmpty()) {
                            i13 = ai.e(1, i13, languageSelectActivity.h);
                        }
                ...
                if (localeInfo != null) {
                    if (localeInfo.isLocal()) {
                        b9Var.b(String.format("%1$s (%2$s)", localeInfo.name, LocaleController.getString(R.string.LanguageCustom)), localeInfo.nameEnglish, !z4);
                    } else {
                        b9Var.b(localeInfo.name, localeInfo.nameEnglish, !z4);
                    }
                }
                b9Var.setChecked(localeInfo == LocaleController.getInstance().getCurrentLocaleInfo());
                break;
            case 1:
                if (!z10) {
                    i13--;
                ...
                if (!isEmpty && i13 == languageSelectActivity.h.size()) {
                    y6Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.b7));
                    break;
                } else {
                    y6Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.b7));
                    break;
                }
            case 2:
                org.telegram.ui.Cells.r8 r8Var = (org.telegram.ui.Cells.r8) view;
                View view2 = r8Var.e;
                TextView textView = r8Var.d;
                TextView textView2 = r8Var.c;
                boolean z12 = r8Var.E;
                boolean z13 = LocaleController.isRTL;
                if (z12 != z13) {
                    r8Var.E = z13;
                    textView2.setGravity((z13 ? 5 : 3) | 16);
                    r8Var.removeView(textView2);
                    boolean z14 = LocaleController.isRTL;
                    r8Var.addView(textView2, k7.b6.d(-1, -1.0f, (z14 ? 5 : 3) | 48, z14 ? 70.0f : r8Var.B, 0.0f, z14 ? r8Var.B : 70.0f, 0.0f));
                    textView.setGravity(LocaleController.isRTL ? 5 : 3);
                    r8Var.removeView(textView);
                    boolean z15 = LocaleController.isRTL;
                    r8Var.addView(textView, k7.b6.d(-2, -2.0f, (z15 ? 5 : 3) | 48, z15 ? 64.0f : r8Var.B, 36.0f, z15 ? r8Var.B : 64.0f, 0.0f));
                    r8Var.removeView(view2);
                    r8Var.addView(view2, k7.b6.d(37, 20.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
                }
                ...
                if (i13 != i11) {
                    ...
                    if (i13 == i12) {
                        ...
                        r8Var.f(string, g02, z11);
                        r8Var.setCheckBoxIcon(languageSelectActivity.getUserConfig().isPremium() ? 0 : R.drawable.permission_locked);
                        break;
                    }
                } else {
                    r8Var.f(LocaleController.getString(R.string.ShowTranslateButton), languageSelectActivity.h0(), true);
            ...
            case 4:
                ...
                z9Var.c(string2, charSequence, true, false);
                break;
            case 5:
                ((org.telegram.ui.Cells.z9) view).d();
                break;
            case 6:
                org.telegram.ui.Cells.z8 z8Var = (org.telegram.ui.Cells.z8) view;
                org.telegram.ui.Cells.w1 w1Var = z8Var.a;
                boolean z17 = z8Var.n;
                boolean z18 = LocaleController.isRTL;
                if (z17 != z18) {
                    z8Var.n = z18;
                    w1Var.setGravity(z18 ? 5 : 3);
                ...
                if (i13 != languageSelectActivity.n) {
                    z8Var.setTopPadding(0);
                    z8Var.setBottomPadding(16);
                    break;
                } else {
                    z8Var.setText(LocaleController.getString(R.string.TranslateMessagesInfo1));
                    z8Var.setTopPadding(11);
                    z8Var.setBottomPadding(16);
                    break;
                }
        }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        Context context = this.c;
        if (i10 != 0) {
            view = i10 != 2 ? i10 != 3 ? (i10 == 4 || i10 == 5) ? new org.telegram.ui.Cells.z9(context) : i10 != 6 ? new org.telegram.ui.Cells.y6(context, (b) null) : new org.telegram.ui.Cells.z8(context) : new org.telegram.ui.Cells.l4(context) : new org.telegram.ui.Cells.r8(context);
        } else {
            ...
            b9Var.addView(textView, k7.b6.d(-1, -1.0f, (z4 ? 5 : 3) | 48, z4 ? 21 : 64.0f, 0.0f, z4 ? 64.0f : 21, 0.0f));
            ...
            b9Var.addView(textView2, k7.b6.d(-2, -2.0f, (z10 ? 5 : 3) | 48, z10 ? 21 : 64.0f, 36.0f, z10 ? 64.0f : 21, 0.0f));
            ...
            b9Var.addView(radioButton, k7.b6.d(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
            b9Var.n = LocaleController.isRTL;
            b9Var.setClipChildren(false);
            view = b9Var;
        }
