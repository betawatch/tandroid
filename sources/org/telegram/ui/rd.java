    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (!rnVar.gb && (f01Var = f01VarArr[0]) != null) {
                    f01VarArr[0] = null;
                    if (rnVar.r0 == f01Var) {
                        rnVar.r0 = null;
                    }
            ...
            case 4:
                ...
                rnVar2.v1.setTranslationY(s1Var.getTimeY() + ((r0[1] - r3.getTop()) - AndroidUtilities.dp(120.0f)));
                rnVar2.v1.n(0.0f, ((((-AndroidUtilities.dp(16.0f)) + r0[0]) + s1Var.nb) + s1Var.lb) - (s1Var.ob / 2.0f));
                rnVar2.v1.v();
                break;
            case 5:
            ...
            case 6:
                ...
                rnVar3.getClass();
                if (iArr[0] != 0) {
                    rnVar3.getConnectionsManager().cancelRequest(iArr[0], true);
                    iArr[0] = 0;
                    break;
                }
                break;
            ...
            case 8:
                rn rnVar4 = (rn) obj2;
                we.e.p(rnVar4.getParentActivity(), Uri.parse(((TLRPC.TL_bankCardOpenUrl) obj).url), rnVar4.b8 == 0, false);
                break;
            case 9:
            ...
            case 14:
                ...
                if (rnVar6.getParentActivity() != null) {
                    ...
                    rnVar6.G0.setTranslationY(AndroidUtilities.dp(10.0f) + ((view.getTop() - rnVar6.va) - rnVar6.T0.getHeight()));
                    rnVar6.T0.addView(rnVar6.G0, h7.z5.e(-1, 100, 87));
                    lh.w3 w3Var = rnVar6.G0;
                    w3Var.h0 = new gf(rnVar6, 7);
                    w3Var.v();
                    org.telegram.ui.Components.y30.v.b();
                    break;
                }
                break;
            case 15:
            ...
            case 16:
                ...
                rn rnVar7 = ((mi) obj2).s;
                MessageObject messageObject3 = (MessageObject) rnVar7.k6[0].get(messageObject2.getId());
                if (messageObject3 != null && messageObject3 != messageObject2) {
                    MessageObject messageObject4 = (MessageObject) rnVar7.k6[0].get(messageObject2.getId());
            ...
            case 17:
                ...
                break;
            case 18:
                lh.w3 w3Var2 = (lh.w3) obj;
                rn rnVar9 = ((dn) obj2).a;
                rnVar9.T0.removeView(w3Var2);
                if (w3Var2 == rnVar9.w1) {
                    rnVar9.w1 = null;
                    break;
                }
            ...
            case 21:
                ...
                xoVar.d0 = xoVar.getConnectionsManager().sendRequest(tL_channels_checkUsername, new z9(xoVar, str2, tL_channels_checkUsername, 6), 2);
                break;
            case 22:
                xo xoVar2 = (xo) obj2;
                ...
                xoVar2.Y = z10;
                if (!z10 && xoVar2.getUserConfig().isPremium() && !xoVar2.Z && xoVar2.x != null) {
                    xoVar2.Z = true;
                    xoVar2.b0();
            ...
            default:
                lr lrVar = (lr) obj2;
                lrVar.getClass();
                lrVar.getMessagesController().loadFullChat(((TLRPC.Updates) obj).chats.get(0).id, 0, true);
                break;
        }
    }
}
