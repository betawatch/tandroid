...
public final /* synthetic */ class j90 implements Runnable {
    ...
    public /* synthetic */ j90(LaunchActivity launchActivity, org.telegram.ui.ActionBar.o2 o2Var, int i10, TLRPC.User user, TLRPC.TL_messages_botApp tL_messages_botApp, AtomicBoolean atomicBoolean, String str, boolean z10, boolean z11, boolean z12, boolean z13) {
    ...
    public final void run() {
        ...
        if (launchActivity.P() == null || launchActivity.P().m(b10) == null) {
            ...
            p2Var.w(!z11);
            if (z12) {
                p2Var.x(true, false, p2Var.a0);
            }
            p2Var.w0 = false;
            p2Var.g0 = launchActivity;
            p2Var.s(o2Var, b10);
            p2Var.show();
            if (tL_messages_botApp.inactive || this.v) {
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.ui.web.y(11, p2Var, (z13 && tL_attachMenuBot.show_in_attach_menu) ? LocaleController.formatString(R.string.BotAttachMenuShortcatAddedAttachAndSide, user2.first_name) : z13 ? LocaleController.formatString(R.string.BotAttachMenuShortcatAddedSide, user2.first_name) : LocaleController.formatString(R.string.BotAttachMenuShortcatAddedAttach, user2.first_name)), 200L);
            }
        }
    }
}
