...
public final /* synthetic */ class j90 implements Runnable {
    ...
    public final /* synthetic */ org.telegram.ui.ActionBar.m2 w;
        ...
        switch (i10) {
            case 0:
                ...
                if (z10) {
                    ...
                    if (!tL_messages_chats.chats.isEmpty()) {
                        ...
                        org.telegram.ui.ActionBar.m2 m2Var = this.w;
                        Bundle bundle = this.c;
                        if (m2Var == null || MessagesController.getInstance(this.x).checkCanOpenChat(bundle, m2Var)) {
            ...
            default:
                ...
                if (!((ActionBarLayout) O).P(new wn(bundle2))) {
                    ...
                    iArr[0] = ConnectionsManager.getInstance(launchActivity2.O).sendRequest(tL_channels_getChannels, new org.telegram.messenger.i1(launchActivity2, this.e, this.f, l11, this.h, this.n, this.r, this.s, this.v, this.w, this.x, bundle2));
                    break;
                }
                break;
        }
