...
public final class d11 extends FrameLayout {
    ...
    public Drawable e;
    public final org.telegram.ui.Components.hp f;
    public boolean h;
    public boolean n;
    public int r;
    ...
    public d11(ProxyListActivity proxyListActivity, Context context) {
        ...
        addView(textView, i7.f6.d(-2, -2.0f, (z10 ? 5 : 3) | 48, z10 ? 56 : 21, 10.0f, z10 ? 21 : 56, 0.0f));
        ...
        addView(textView2, i7.f6.d(-2, -2.0f, (z11 ? 5 : 3) | 48, z11 ? 56 : 21, 35.0f, z11 ? 21 : 56, 0.0f));
        ...
        addView(imageView, i7.f6.d(48, 48.0f, (LocaleController.isRTL ? 3 : 5) | 48, 8.0f, 8.0f, 8.0f, 0.0f));
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            duration.addUpdateListener(new ag(this, dp, 4));
        ...
        float f9 = dp2 + dp;
        org.telegram.ui.Components.hp hpVar = this.f;
        hpVar.setTranslationX(f9);
        imageView.setVisibility(z10 ? 8 : 0);
        imageView.setAlpha(1.0f);
        imageView.setScaleX(1.0f);
        imageView.setScaleY(1.0f);
        hpVar.setVisibility(z10 ? 0 : 8);
        hpVar.setAlpha(1.0f);
    ...
    public final void b() {
        ...
        if (proxyInfo == proxyInfo2) {
            ...
            if (proxyListActivity.d) {
                ...
                this.r = org.telegram.ui.ActionBar.g6.w0(null, i10, false);
        ...
        if (proxyInfo2.checking) {
            ...
            i10 = org.telegram.ui.ActionBar.g6.w6;
        } else {
            textView.setText(LocaleController.getString(R.string.Unavailable));
            i10 = org.telegram.ui.ActionBar.g6.p7;
        }
        this.r = org.telegram.ui.ActionBar.g6.w0(null, i10, false);
        textView.setTag(Integer.valueOf(i10));
        textView.setTextColor(this.r);
