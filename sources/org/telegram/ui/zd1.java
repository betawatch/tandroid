...
public final /* synthetic */ class zd1 implements Runnable {
    ...
    public /* synthetic */ zd1(ae1 ae1Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = ae1Var;
        this.c = str;
        this.d = i10;
    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                int i10 = this.d;
                ae1Var.getClass();
                Utilities.searchQueue.postRunnable(new zd1(ae1Var, str, i10, 1));
                break;
            default:
                ae1 ae1Var2 = this.b;
                String str2 = this.c;
                int i11 = this.d;
                be1 be1Var = ae1Var2.h;
                ...
                if (lowerCase.length() != 0) {
                        ...
                        while (true) {
                            ...
                            if (publicUsername != null) {
                                ...
                                while (i13 < i12) {
                                    ...
                                    if (!z4) {
                                        arrayList2.add(chat);
                                        arrayList3.add((String) be1Var.h.get(i14));
                                    }
                                }
                                if (!z4) {
                                }
                    ...
                    AndroidUtilities.runOnUIThread(new dt(ae1Var2, i11, arrayList2, arrayList3, 11));
                    break;
                } else {
                    AndroidUtilities.runOnUIThread(new dt(ae1Var2, i11, str3, str3, 11));
                    break;
                }
                break;
        }
