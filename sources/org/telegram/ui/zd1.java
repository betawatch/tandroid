...
public final class zd1 extends Dialog {
    ...
    public zd1(Activity activity, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.b = wd1Var;
        int i10 = 6;
        wd1Var.setOnClickListener(new v31(this, i10));
        tg.b bVar = new tg.b();
        this.B = bVar;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (i10) {
                    ...
                    default:
                        zd1 zd1Var2 = this.b;
                        zd1Var2.getClass();
                        zd1Var2.y = ((Float) valueAnimator3.getAnimatedValue()).floatValue();
                        break;
                }
            }
        });
        this.a0.addListener(new androidx.fragment.app.g(this, z4, qv0Var, 12));
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator32) {
                switch (i11) {
                    ...
                    default:
                        zd1 zd1Var2 = this.b;
                        zd1Var2.getClass();
                        zd1Var2.y = ((Float) valueAnimator32.getAnimatedValue()).floatValue();
                        break;
                }
            }
        });
        this.b0.addListener(new vd1(i10, this, z4));
    ...
    public final void c(boolean z4) {
        ...
        if (z4 && (qk0Var = this.M) != null && qk0Var.getReactionsWindow() != null && !this.M.getReactionsWindow().q) {
            this.M.e();
            return;
        }
        if (this.X) {
