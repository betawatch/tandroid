...
public abstract class th1 extends org.telegram.ui.ActionBar.n2 {
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (rh1Var != null) {
                org.telegram.ui.ActionBar.n2 n2Var = rh1Var.a;
                if (n2Var.fragmentView != null) {
                    ...
                    rh1Var.f = f11;
                    boolean z12 = f11 > f10;
                    if (!rh1Var.d && r10 > 0.0f && z10 && n2Var.fragmentView != null) {
                        n2Var.onResume();
                        rh1Var.d = true;
                    }
    ...
    public View createView(Context context) {
        ...
        this.b = new k0((zg0) this, context, 13);
        ...
        this.c.setAdapter(new bw0(this, context, 3));
        this.b.addView(this.c, w7.x5.c(-1.0f, -1));
        k0 k0Var = this.b;
        this.fragmentView = k0Var;
        nl0 nl0Var = new nl0(this, 26);
        WeakHashMap weakHashMap = r0.i0.a;
        r0.a0.j(k0Var, nl0Var);
