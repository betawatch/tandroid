...
public final /* synthetic */ class th1 implements Runnable {
    ...
    public /* synthetic */ th1(uh1 uh1Var, String str, boolean z10, boolean z11, int i10) {
        this.a = i10;
        this.b = uh1Var;
        this.c = str;
        this.d = z10;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                boolean z13 = this.e;
                uh1Var.getClass();
                AndroidUtilities.runOnUIThread(new th1(uh1Var, str4, z12, z13, 1));
                break;
            case 1:
                uh1 uh1Var2 = this.b;
                String str5 = this.c;
                boolean z14 = this.d;
                boolean z15 = this.e;
                uh1Var2.f.g(str5, true, z14, z14, uh1Var2.v.G, 0L, false, 0, 0);
                DispatchQueue dispatchQueue = Utilities.searchQueue;
                th1 th1Var = new th1(uh1Var2, str5, z15, z14, 2);
                uh1Var2.h = th1Var;
                dispatchQueue.postRunnable(th1Var);
                break;
            default:
                uh1 uh1Var3 = this.b;
                String str6 = this.c;
                boolean z16 = this.d;
                boolean z17 = this.e;
                ArrayList arrayList2 = uh1Var3.r;
                ...
                if (lowerCase.length() != 0) {
                                ...
                                while (i14 < 3) {
                                    ...
                                    if (str8 != null) {
                                        if (!str8.startsWith(str7)) {
                                            i10 = i14;
                                            if (org.telegram.messenger.wh.u(" ", str7, str8)) {
                                            }
                                        }
                                        c11 = 1;
                    ...
                    AndroidUtilities.runOnUIThread(new xd1(uh1Var3, arrayList3, arrayList4, 6));
                    break;
                } else {
                    AndroidUtilities.runOnUIThread(new xd1(uh1Var3, new ArrayList(), new ArrayList(), 6));
                    break;
                }
        }
    }
