...
public final class mf0 extends org.telegram.ui.Components.gw0 {
    ...
    public final org.telegram.ui.Components.s90 f;
    ...
    */
    public mf0(xg0 xg0Var, Context context) {
        super(context);
        int i10;
        this.E = xg0Var;
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                l90Var.setText(LocaleController.getString(R.string.AddEmailSubtitle));
                addView(l90Var, w7.y5.t(-2, -2, 1, 32, 8, 32, 0));
                org.telegram.ui.Components.id0 id0Var = new org.telegram.ui.Components.id0(context, null);
                this.a = id0Var;
                id0Var.setText(LocaleController.getString(xg0Var.F != 3 ? R.string.YourNewEmail : R.string.YourEmail));
                ...
                addView(id0Var, w7.y5.k(16.0f, 24.0f, 16.0f, 0.0f, -1, 58));
                ...
                frameLayout2.addView(s90Var, w7.y5.d(-2, 16.0f, 83, 0.0f, 0.0f, 0.0f, 70.0f));
                s90Var.setMeasureAfter(textView2);
        ...
        org.telegram.ui.Components.l90 l90Var2 = new org.telegram.ui.Components.l90(context, null);
        this.d = l90Var2;
        l90Var2.setTextSize(1, 14.0f);
        l90Var2.setGravity(17);
        l90Var2.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        l90Var2.setText(LocaleController.getString(R.string.AddEmailSubtitle));
        addView(l90Var2, w7.y5.t(-2, -2, 1, 32, 8, 32, 0));
        org.telegram.ui.Components.id0 id0Var2 = new org.telegram.ui.Components.id0(context, null);
        this.a = id0Var2;
        id0Var2.setText(LocaleController.getString(xg0Var.F != 3 ? R.string.YourNewEmail : R.string.YourEmail));
        ...
        addView(id0Var2, w7.y5.k(16.0f, 24.0f, 16.0f, 0.0f, -1, 58));
        ...
        frameLayout22.addView(s90Var2, w7.y5.d(-2, 16.0f, 83, 0.0f, 0.0f, 0.0f, 70.0f));
        s90Var2.setMeasureAfter(textView22);
    ...
    @Override // org.telegram.ui.Components.gw0
    public final void j() {
        AndroidUtilities.runOnUIThread(new kf0(this, 0), xg0.t0);
    }
    ...
    public final void o() {
        org.telegram.ui.Components.id0 id0Var = this.a;
        xg0 xg0Var = this.E;
