...
public final class g extends ViewGroup {
    ...
    public void draw(Canvas canvas) {
        switch (this.a) {
            case 1:
                if (!((org.telegram.ui.Components.mg0) this.b).j0) {
                    canvas.save();
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        switch (this.a) {
            case 0:
                ...
                break;
            case 1:
                org.telegram.ui.Components.mg0 mg0Var = (org.telegram.ui.Components.mg0) this.b;
                mg0Var.e.layout(0, 0, mg0Var.E, mg0Var.F);
                break;
            case 2:
            ...
            case 3:
                ...
                if (i12 <= i13) {
                    ...
                    int measuredWidth10 = (i45 - wg1Var.a.getMeasuredWidth()) / 2;
                    org.telegram.ui.Components.jj0 jj0Var10 = wg1Var.a;
                    jj0Var10.layout(measuredWidth10, i47, jj0Var10.getMeasuredWidth() + measuredWidth10, wg1Var.a.getMeasuredHeight() + i47);
                    int C3 = org.telegram.messenger.y3.C(16.0f, wg1Var.a.getMeasuredHeight(), i47);
                    TextView textView18 = wg1Var.c;
                    textView18.layout(0, C3, textView18.getMeasuredWidth(), wg1Var.c.getMeasuredHeight() + C3);
                    int C4 = org.telegram.messenger.y3.C(12.0f, wg1Var.c.getMeasuredHeight(), C3);
                    ih.s sVar = wg1Var.d;
                    sVar.layout(0, C4, sVar.getMeasuredWidth(), wg1Var.d.getMeasuredHeight() + C4);
                    int measuredWidth11 = (i45 - wg1Var.b.getMeasuredWidth()) / 2;
                    int measuredHeight7 = (i46 - wg1Var.b.getMeasuredHeight()) - AndroidUtilities.dp(48.0f);
                    TextView textView19 = wg1Var.b;
                    textView19.layout(measuredWidth11, measuredHeight7, textView19.getMeasuredWidth() + measuredWidth11, wg1Var.b.getMeasuredHeight() + measuredHeight7);
                    break;
                } else {
                    int measuredHeight8 = (i46 - wg1Var.a.getMeasuredHeight()) / 2;
                    org.telegram.ui.Components.jj0 jj0Var11 = wg1Var.a;
                    jj0Var11.layout(0, measuredHeight8, jj0Var11.getMeasuredWidth(), wg1Var.a.getMeasuredHeight() + measuredHeight8);
                    float f27 = i45;
                    float f28 = 0.4f * f27;
                    int i48 = (int) f28;
                    float f29 = i46;
                    int i49 = (int) (0.22f * f29);
                    TextView textView20 = wg1Var.c;
                    textView20.layout(i48, i49, textView20.getMeasuredWidth() + i48, wg1Var.c.getMeasuredHeight() + i49);
                    int i50 = (int) (0.39f * f29);
                    ih.s sVar2 = wg1Var.d;
                    sVar2.layout(i48, i50, sVar2.getMeasuredWidth() + i48, wg1Var.d.getMeasuredHeight() + i50);
                    int x16 = (int) e2.c.x(f27 * 0.6f, wg1Var.b.getMeasuredWidth(), 2.0f, f28);
                    int i51 = (int) (f29 * 0.64f);
                    TextView textView21 = wg1Var.b;
                    textView21.layout(x16, i51, textView21.getMeasuredWidth() + x16, wg1Var.b.getMeasuredHeight() + i51);
                    break;
                }
            default:
                UsersSelectActivity usersSelectActivity = (UsersSelectActivity) this.b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                org.telegram.ui.Components.mg0 mg0Var = (org.telegram.ui.Components.mg0) this.b;
                mg0Var.e.measure(View.MeasureSpec.makeMeasureSpec(mg0Var.E, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(mg0Var.F, TLObject.FLAG_30));
                break;
            case 2:
                setMeasuredDimension(View.MeasureSpec.getSize(i10), View.MeasureSpec.getSize(i11));
                org.telegram.ui.Components.voip.g1 g1Var = (org.telegram.ui.Components.voip.g1) this.b;
            ...
            case 3:
                ...
                if (size3 > size4) {
                    float f13 = size3;
                    wg1Var.a.measure(View.MeasureSpec.makeMeasureSpec((int) (0.45f * f13), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) (size4 * 0.68f), TLObject.FLAG_30));
                    int i17 = (int) (f13 * 0.6f);
                    wg1Var.c.measure(View.MeasureSpec.makeMeasureSpec(i17, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size4, 0));
                    wg1Var.d.measure(View.MeasureSpec.makeMeasureSpec(i17, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size4, 0));
                    wg1Var.e.measure(View.MeasureSpec.makeMeasureSpec(i17, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size4, 0));
                    wg1Var.b.measure(View.MeasureSpec.makeMeasureSpec(i17, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(42.0f), TLObject.FLAG_30));
                } else {
                    float f14 = wg1Var.L == 7 ? 160 : 140;
                    wg1Var.a.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f14), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(f14), TLObject.FLAG_30));
                    wg1Var.c.measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size4, 0));
                    wg1Var.d.measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size4, 0));
                    wg1Var.e.measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size4, 0));
                    wg1Var.b.measure(b.d(48.0f, size3, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f), TLObject.FLAG_30));
                }
