...
public final /* synthetic */ class vq0 implements Runnable {
    ...
    public /* synthetic */ vq0(Object obj, Object obj2, boolean z4, int i10) {
        this.a = i10;
        this.c = obj;
        this.d = obj2;
        this.b = z4;
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                if (jh0Var != null) {
                    org.telegram.ui.Components.gh0 j10 = org.telegram.ui.Components.jh0.j(7, jh0Var.a);
                    if (j10 != null && j10.s) {
                        j10.s = false;
                        jh0Var.invalidate();
                    }
                    if (zArr[0]) {
                        org.telegram.ui.Components.jh0 jh0Var2 = profileActivity.X;
                        jh0Var2.F = true;
                        jh0Var2.o(7, false);
                        profileActivity.X.o(9, true);
                        org.telegram.ui.Components.jh0 jh0Var3 = profileActivity.X;
                        if (jh0Var3.F) {
                            jh0Var3.F = false;
                            jh0Var3.d();
                            return;
                                ...
                                if (file5.exists() && !file5.isDirectory()) {
                                    ...
                                    try {
                                        try {
                                            ...
                                            AndroidUtilities.runOnUIThread(new a30(d2Var, zArr2, activity, file, 26));
                                            return;
                                        }
                                    } catch (Throwable th2) {
                                        th = th2;
            ...
            case 3:
                z31.P((z31) this.c, this.b, (org.telegram.ui.Components.i80) this.d);
                return;
            case 4:
                    ...
                    while (i15 < size) {
                        ...
                        if (!"fqv01SQemVIBAAAApND8LDRUhRU".equals(wallPaper.slug)) {
                            if ((wallPaper instanceof TLRPC.TL_wallPaper) && !(wallPaper.document instanceof TLRPC.TL_documentEmpty)) {
                                ...
                                mi1 mi1Var = (i16 == 0 || (i11 = wallPaperSettings4.third_background_color) == 0) ? new mi1(wallPaperSettings4.background_color, i16, null, wallPaperSettings4.rotation) : new mi1(null, wallPaperSettings4.background_color, i16, i11, wallPaperSettings4.fourth_background_color);
            ...
            case 6:
                ...
                arrayList4.clear();
                org.telegram.ui.web.l1.a().getClass();
            ...
            case 8:
                ...
                sQLiteCursor.dispose();
                AndroidUtilities.runOnUIThread(new kg1(18, callback, arrayList6));
                return;
            case 9:
            ...
            case 12:
                ...
                return;
            case 13:
                vh.r3 r3Var = (vh.r3) this.c;
                vh.i5 i5Var = (vh.i5) this.d;
                boolean z10 = this.b;
                boolean z11 = !z10;
                vh.k5 k5Var = i5Var.v;
                ...
                while (it.hasNext()) {
                    ...
                    vh.l5 m9 = k5Var.m(pagetablecell);
                    if (m9 == null) {
                        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(vh.z5.h(pagetablecell));
                        boolean z12 = spannableStringBuilder.length() > 0 && (vh.x5.q(0, spannableStringBuilder.length(), spannableStringBuilder) & 1) != 0;
                        vh.z5.l(pagetablecell, z11);
                        if (!z10 && spannableStringBuilder.length() > 0) {
                            vh.x5.o(spannableStringBuilder, 0, spannableStringBuilder.length(), 1, true, null);
                        } else if (z10 && z12) {
                            vh.x5.o(spannableStringBuilder, 0, spannableStringBuilder.length(), 1, false, null);
                        }
                        vh.z5.d(pagetablecell, spannableStringBuilder);
                    } else if (m9.b != null) {
                        SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(m9.a.getText());
                        boolean z13 = spannableStringBuilder2.length() > 0 && (vh.x5.q(0, spannableStringBuilder2.length(), spannableStringBuilder2) & 1) != 0;
                        vh.z5.l(m9.b, z11);
                        if (z10) {
                            if (z13) {
                                vh.x5.o(spannableStringBuilder2, 0, spannableStringBuilder2.length(), 1, false, null);
                            }
                        } else if (spannableStringBuilder2.length() > 0) {
                            vh.x5.o(spannableStringBuilder2, 0, spannableStringBuilder2.length(), 1, true, null);
                        }
                        vh.z5.d(m9.b, spannableStringBuilder2);
                        m9.b(m9.b);
                    }
                }
                k5Var.invalidate();
            ...
            default:
                ...
                vh.q3 q3Var = (vh.q3) this.d;
                q3Var.f.o3(true);
                vh.d4.k(p2Var, this.b, new vh.a4(q3Var, 2));
                return;
        }
    }

    public /* synthetic */ vq0(Object obj, boolean z4, Object obj2, int i10) {
        this.a = i10;
        this.c = obj;
        this.b = z4;
        this.d = obj2;
