...
public final class i51 extends Dialog {
    ...
    public final void d() {
        ...
        if (u1Var != null) {
            ...
            i0.b bVar2 = this.e;
            this.G = org.telegram.messenger.q.y(((height - bVar2.b) - bVar2.d) - this.O.getHeight(), this.K, 2.0f, f10);
            if (!this.J) {
                this.J = true;
    ...
    public final void show() {
        if (AndroidUtilities.isSafeToShow(getContext())) {
            ...
            AndroidUtilities.makeGlobalBlurBitmap(new nj0(8, this, u1Var), 14.0f);
            this.W = true;
            c(true, null);
            ue ueVar = this.X;
            if (ueVar != null) {
