...
public final class i51 extends Dialog {
    ...
    public float s;
    public float v;
    public org.telegram.ui.Components.g71 w;
    public ci.f4 x;
    public TextView y;
    ...
    public final void c(boolean z10, d51 d51Var) {
        ...
        this.d0.addListener(new androidx.fragment.app.g(this, z10, d51Var, i10));
        ...
        this.e0 = ofFloat2;
        int i11 = 7;
        ofFloat2.addUpdateListener(new a21(this, i11));
        this.e0.addListener(new h70(i11, this, z10));
    ...
    public final void d() {
        ...
        if (t1Var != null) {
            ...
            i0.b bVar2 = this.e;
            this.G = org.telegram.messenger.y0.y(((height - bVar2.b) - bVar2.d) - this.O.getHeight(), this.K, 2.0f, f10);
            if (!this.J) {
                this.J = true;
    ...
    public final void dismiss() {
        ...
        org.telegram.ui.Components.g71 g71Var = this.w;
        if (g71Var != null) {
            g71Var.B();
            this.w.H();
            this.w = null;
