        ...
        if ((view instanceof org.telegram.ui.Cells.t1) && (avatarImage = (t1Var = (org.telegram.ui.Cells.t1) view).getAvatarImage()) != null) {
            ...
            if (!z11) {
                ...
                if (RecyclerView.R(t1Var) != -1) {
                    ...
                    if (t1Var.j() && (b10 = wbVar.E.T(view).b()) >= 0) {
                        if (wbVar.E.K(b10 + 1) != null) {
                            avatarImage.setVisible(false, false);
                            return drawChild;
                        }
                    }
                    ...
                    int measuredHeight = wbVar.E.getMeasuredHeight() - wbVar.E.getPaddingBottom();
                    if (layoutHeight > measuredHeight) {
                        layoutHeight = measuredHeight;
                    }
                    if (t1Var.h() && (r13 = wbVar.E.T(view).b()) >= 0) {
                        int i10 = 0;
                        while (i10 < 20) {
                            i10++;
                            int b11 = b11 - 1;
                            s4.c1 K = wbVar.E.K(b11);
                            if (K == null) {
                                break;
                            }
                            View view2 = K.a;
                ...
                while (true) {
                    ...
                    if (i15 < sbVar.d) {
                        if (i15 < sbVar.f || i15 >= sbVar.h) {
                            ...
                            ArrayList arrayList = sbVar.n.s0;
