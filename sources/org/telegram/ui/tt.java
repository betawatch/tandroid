...
public final class tt extends org.telegram.ui.Components.xa {
    ...
    public tt(Activity activity, HashSet hashSet) {
        ...
        i7.h6.a(imageView);
        final int i10 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.st
        ...
        org.telegram.ui.Components.y80 a2 = i7.j6.a(activity, 20.0f, i11, true, this.resourcesProvider);
        a2.setText(LocaleController.getString(R.string.GroupCallCreateTitle));
        a2.setGravity(17);
        f9.addView(a2, i7.f6.t(-1, -2, 1, 2, 0, 2, 4));
        org.telegram.ui.Components.y80 a10 = i7.j6.a(activity, 14.0f, i11, false, this.resourcesProvider);
        ...
        final int i12 = 1;
        dVar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.st
            public final /* synthetic */ tt b;
        ...
        final int i13 = 2;
        dVar2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.st
            public final /* synthetic */ tt b;
        ...
        jl0Var.setPadding(i14, 0, i14, AndroidUtilities.dp(76.0f));
    }
    ...
    public static void Q(tt ttVar, TLObject tLObject, nh.d dVar, boolean z10, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (!(tLObject instanceof TLRPC.Updates)) {
            ...
            ttVar.dismiss();
            org.telegram.ui.Components.voip.h2.h(LaunchActivity.C1, ttVar.currentAccount, tL_inputGroupCall, z10, groupcall.call, hashSet);
            return;
        }
        ...
        ttVar.dismiss();
        org.telegram.ui.Components.voip.h2.h(LaunchActivity.C1, ttVar.currentAccount, tL_inputGroupCall2, z10, groupCall2, hashSet);
    }
