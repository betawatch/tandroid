...
public final class rw0 extends FrameLayout {
    public boolean a;
    public boolean b;
    ...
    public rw0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        super(context);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        cx0Var.d.b.p = (((getMeasuredWidth() * 0.1f) * premiumPreviewFragment.b0) + (premiumPreviewFragment.U.c.getX() + cx0Var.getX())) / getMeasuredWidth();
        cx0 cx0Var2 = premiumPreviewFragment.U;
        cx0Var2.d.b.q = (premiumPreviewFragment.U.c.getY() + cx0Var2.getY()) / getMeasuredHeight();
        if (!premiumPreviewFragment.Z) {
            invalidate();
        ...
        if (z10) {
            ...
            if (premiumPreviewFragment.q0 > 0.0f) {
                ...
                if (kVar6 != null) {
                    paint.setColor(i0.a.d(premiumPreviewFragment.q0, premiumPreviewFragment.getThemedColor(i11), premiumPreviewFragment.getThemedColor(org.telegram.ui.ActionBar.h6.d6)));
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        cx0 cx0Var = premiumPreviewFragment.U;
        cx0Var.d.b.p = (premiumPreviewFragment.U.d.getX() + cx0Var.getX()) / getMeasuredWidth();
        cx0 cx0Var2 = premiumPreviewFragment.U;
        cx0Var2.d.b.q = (premiumPreviewFragment.U.d.getY() + cx0Var2.getY()) / getMeasuredHeight();
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        for (int i15 = 0; i15 < arrayList2.size(); i15++) {
            premiumPreviewFragment.L.a((dx0) arrayList2.get(i15), false);
            ...
            ((dx0) arrayList2.get(i15)).e = i14;
            i14 += premiumPreviewFragment.L.getMeasuredHeight();
        }
        for (int i16 = 0; i16 < arrayList.size(); i16++) {
            premiumPreviewFragment.L.a((dx0) arrayList.get(i16), false);
            premiumPreviewFragment.L.measure(View.MeasureSpec.makeMeasureSpec(i10, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i11, TLObject.FLAG_31));
            ((dx0) arrayList.get(i16)).e = i14;
            i14 += premiumPreviewFragment.L.getMeasuredHeight();
        }
