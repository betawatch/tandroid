...
public class ig1 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.eh, eh0 {
    ...
    public org.telegram.ui.Components.u81 a1;
    ...
    public int e1;
    public org.telegram.ui.Components.jo f;
    public org.telegram.ui.ActionBar.w0 f0;
    public final zg.e f1;
    ...
    public final eh.d h1;
    public org.telegram.ui.ActionBar.w0 i0;
    public final zg.a i1;
    public org.telegram.ui.ActionBar.g1 j0;
    public zg.k j1;
    ...
    public ig1(Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT < 31) {
            ...
            this.g1 = null;
            this.h1 = null;
            this.i1 = new zg.a(cVar);
            return;
        }
        this.f1 = new zg.e(false);
        this.g1 = new eh.d(null);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0042, code lost:
        ...
        if (((org.telegram.ui.ig1) r0).a == (-r6.a())) goto L13;
     */
    /*
    ...
    */
    public static void I0(eo eoVar) {
        ...
        if (eoVar.getParentLayout().getFragmentStack().size() > 1) {
            org.telegram.ui.ActionBar.p2 p2Var = (org.telegram.ui.ActionBar.p2) eoVar.getParentLayout().getFragmentStack().get(eoVar.getParentLayout().getFragmentStack().size() - 2);
            if (p2Var instanceof ig1) {
            }
        }
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", -eoVar.a());
        ((ActionBarLayout) eoVar.getParentLayout()).c(eoVar.getParentLayout().getFragmentStack().size() - 1, new ig1(bundle));
        eoVar.ja = true;
    ...
    public static boolean U(ig1 ig1Var, TLRPC.TL_error tL_error) {
        ...
        MessagesController.getNotificationsSettings(ig1Var.currentAccount).edit().putLong("dialog_join_requested_time_" + (-ig1Var.a), System.currentTimeMillis()).commit();
        ...
        int i10 = org.telegram.ui.Components.q80.r;
    ...
    public static void V(ig1 ig1Var, View view) {
        ...
        long j10 = -j3;
        long peerDialogId = tL_forumTopic == null ? 0L : ig1Var.getMessagesController().isMonoForum(j10) ? DialogObject.getPeerDialogId(tL_forumTopic.from_id) : tL_forumTopic.id;
        if (ig1Var.t0) {
            jg1 jg1Var = ig1Var.v;
            if (jg1Var != null) {
                lg1 lg1Var = jg1Var.a;
                Bundle bundle = new Bundle();
                og1 og1Var = lg1Var.a;
                bundle.putLong("dialog_id", og1Var.c);
                bundle.putLong("topic_id", tL_forumTopic.id);
                bundle.putBoolean("exception", true);
                c21 c21Var = new c21(bundle, null);
                c21Var.r = new fz0(12, lg1Var, tL_forumTopic);
                og1Var.presentFragment(c21Var);
            }
            wy wyVar = ig1Var.L0;
            if (wyVar != null) {
                wyVar.O3(j10, peerDialogId, true, ig1Var);
                return;
            }
            return;
        }
        ...
        if (ig1Var.inPreviewMode && AndroidUtilities.isTablet()) {
            for (org.telegram.ui.ActionBar.p2 p2Var : ig1Var.getParentLayout().getFragmentStack()) {
                if (p2Var instanceof wy) {
                    wy wyVar2 = (wy) p2Var;
                    if (wyVar2.h4()) {
                        MessagesStorage.TopicKey topicKey = wyVar2.p2;
            ...
            ig1Var.Q0 = peerDialogId;
            ig1Var.U0(false, false);
        }
        mg.d.m(ig1Var, j3, tL_forumTopic, 0);
    }

    public static /* synthetic */ boolean W(ig1 ig1Var, View view, float f7) {
        if (ig1Var.t0 || ig1Var.getParentLayout() == null || ((ActionBarLayout) ig1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(ig1 ig1Var) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            if (i10 == 0) {
                ...
                viewGroup = eg1Var != null ? eg1Var.U : null;
            }
            if (viewGroup != null) {
        ...
        if (t50Var != null && Build.VERSION.SDK_INT >= 23) {
            t50Var.setForeground(new ColorDrawable(i0.a.k(ig1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6), 100)));
        }
        ig1Var.P0();
    }
    ...
    public static void b0(ig1 ig1Var, boolean z10) {
        ...
        int i10 = 0;
        if (ig1Var.a1 == null) {
            org.telegram.ui.Components.u81 n10 = ig1Var.r0.n(8, false);
            ig1Var.a1 = n10;
            if (ig1Var.M0 != null) {
                n10.setBackgroundColor(ig1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
            }
            ig1Var.e.addView(ig1Var.a1, w7.a6.c(44.0f, -1));
        }
        ig1Var.Y0 = ValueAnimator.ofFloat(ig1Var.W, z10 ? 1.0f : 0.0f);
        AndroidUtilities.updateViewVisibilityAnimated(ig1Var.r0, false, 1.0f, true);
        wy wyVar = ig1Var.M0;
        if (wyVar != null && (qxVar = wyVar.F3) != null) {
            qxVar.M = !z10;
        }
        ig1Var.Z0 = !z10 && ig1Var.r0.getVisibility() == 0 && ig1Var.r0.getAlpha() == 1.0f;
        ig1Var.Y0.addUpdateListener(new f21(ig1Var, 17));
        ig1Var.r0.setVisibility(0);
        if (z10) {
            AndroidUtilities.requestAdjustResize(ig1Var.getParentActivity(), ig1Var.classGuid);
            ig1Var.Q0(false);
        } else {
            ig1Var.q0.setVisibility(0);
        }
        ig1Var.Y0.addListener(new rf1(ig1Var, z10, i10));
        ig1Var.Y0.setDuration(200L);
        ig1Var.Y0.setInterpolator(org.telegram.ui.Components.wr.f);
        ig1Var.Y0.start();
    ...
    public final void A0() {
        ...
        if (this.D0 != null) {
            ...
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((zf1) arrayList.get(0)).c != null && ((zf1) arrayList.get(0)).c.id == 1)) {
    ...
    public final void B0() {
        ...
        if (wyVar != null) {
            ...
            float c10 = (qsVar != null ? qsVar.c(dp) : 0.0f) + 0.0f;
            ...
            if (qsVar2 != null) {
                ...
                qsVar2.setTranslationY(c10 - ((qsVar3 != null ? qsVar3.getMetadata().c.a : 0.0f) * dp2));
                org.telegram.ui.Components.qs qsVar4 = this.U0;
                int dp3 = AndroidUtilities.dp(14.0f);
                int dp4 = AndroidUtilities.dp(7.0f);
                r2 = qsVar4.c(AndroidUtilities.lerp(dp3, dp4, this.M0.J1 != null ? r5.getMetadata().c.a : 0.0f)) + c10;
            } else {
                r2 = c10;
            }
        } else {
            org.telegram.ui.Components.qs qsVar5 = this.U0;
            if (qsVar5 != null) {
                r2 = 0.0f + qsVar5.c(AndroidUtilities.dp(14.0f));
            }
        }
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            d2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, this.s.findTopic(this.a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void M0(org.telegram.ui.Cells.r2 r2Var) {
        ...
        int b10 = r32[0].b(uoVar.f);
        uoVar.o = 1;
        long j3 = this.a;
        long j10 = -j3;
        uoVar.d(j10, tL_forumTopic.id, null);
        if (ChatObject.canManageTopics(g())) {
            ...
            g1Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.if1
                ...
                public final void onClick(View view) {
                    switch (i10) {
                        case 0:
                            ...
                            ig1Var.C0 = true;
                            ig1Var.N0 = true;
                            ig1Var.s.pinTopic(ig1Var.a, tL_forumTopic.id, !r0.pinned, ig1Var);
                            ig1Var.finishPreviewFragment();
                            break;
                        case 1:
                            ig1 ig1Var2 = this.b;
                            ig1Var2.N0 = true;
                            TopicsController topicsController = ig1Var2.s;
                            long j11 = ig1Var2.a;
        ...
        if (ChatObject.canManageTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            g1Var3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.if1
                public final /* synthetic */ ig1 b;
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            final int i12 = 2;
            g1Var4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.if1
                public final /* synthetic */ ig1 b;
        ...
        eo eoVar = new eo(w.f.e(j3, "chat_id"));
        mg.d.a(eoVar, MessagesStorage.TopicKey.of(j10, isMonoForum ? DialogObject.getPeerDialogId(r2Var.N.from_id) : r2Var.N.id));
    ...
    public final void N0(View view) {
        ...
        fg1Var.V(hashSet.contains(Integer.valueOf(i10)), true);
        ...
        if (!this.actionBar.a(null)) {
            ...
            j10.addView(this.c0, w7.a6.m(1.0f, 0, -1, 72, 0, 0));
            this.c0.setOnTouchListener(new jf1(0));
    ...
    */
    public final void O0(boolean z10) {
        ...
        boolean v = org.telegram.messenger.a2.v("dialog_bar_report", j11, notificationsSettings, false);
        boolean v9 = org.telegram.messenger.a2.v("dialog_bar_block", j11, notificationsSettings, false);
        boolean z15 = this.t0;
        if (z15) {
            j3 = 0;
            if (this.w0) {
            ...
            org.telegram.ui.Components.jo joVar = this.f;
            if (joVar != null && joVar.getLayoutParams() != null) {
        ...
        if (chat != null && ChatObject.isNotInChat(chat) && j12 > j3 && System.currentTimeMillis() - j12 < 120000) {
            ...
            if (!z14 || (!v9 && !v)) {
                ...
                if (this.V != z11) {
                    ...
                    if (z16) {
                        this.o0.animate().translationY(z11 ? 0.0f : AndroidUtilities.dp(53.0f)).setListener(new rf1(this, z11, 1));
                    } else {
    ...
    public final void S0(float f7) {
        ...
        org.telegram.ui.Components.u81 u81Var = this.a1;
        if (u81Var != null) {
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        if (topics != null) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (zf1Var != null && (tL_forumTopic = zf1Var.c) != null && tL_forumTopic.hidden) {
                    this.x++;
                }
            }
            tf1 tf1Var = this.N;
            if (tf1Var != null) {
                if (tf1Var.getItemAnimator() != (z10 ? this.I0 : null)) {
    ...
    @Override // org.telegram.ui.Components.eh, org.telegram.ui.Components.y50
    public final long a() {
        return -this.a;
    }
    ...
    public final View createView(Context context) {
        ...
        wy wyVar = this.M0;
        final int i10 = 0;
        this.c1 = (wyVar == null || !wyVar.W) ? 0 : AndroidUtilities.dp(72.0f);
        wy wyVar2 = this.M0;
        this.d1 = (wyVar2 == null || !wyVar2.W) ? 0 : AndroidUtilities.dp(64.0f);
        pf1 pf1Var = new pf1(this, context);
        this.d = pf1Var;
        this.fragmentView = pf1Var;
        pf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.d6));
        ...
        final int i12 = 2;
        this.actionBar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
            public final /* synthetic */ ig1 b;
            ...
            public final void onClick(View view) {
                ...
                switch (i12) {
                    case 0:
                        ig1 ig1Var = this.b;
                        ig1Var.presentFragment(ef1.a0(ig1Var.a, 0L));
                        break;
                    case 1:
                        ig1 ig1Var2 = this.b;
                        ig1Var2.getMessagesController().hidePeerSettingsBar(-ig1Var2.a, null, ig1Var2.g());
                        ig1Var2.O0(false);
                        break;
                    case 2:
                        ig1 ig1Var3 = this.b;
                    ...
                    default:
                        wy wyVar3 = this.b.M0;
                        if (wyVar3 != null && (w0Var = wyVar3.j0) != null) {
                            w0Var.performClick();
                            break;
                        }
                        break;
        ...
        if (this.M0 != null) {
            ...
            this.p0 = a2;
            a2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
                public final /* synthetic */ ig1 b;
        ...
        org.telegram.ui.Components.jo joVar2 = this.f;
        long j3 = -this.a;
        joVar2.b = j3 < 0;
        joVar2.setClipChildren(false);
        this.actionBar.addView(this.f, 0, w7.a6.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.t0) {
        ...
        this.j1 = new zg.k(tf1Var, viewGroup, new v8(tf1Var2, i12));
        ...
        this.N.setOnScrollListener(new lf1(this, i11));
        tf1 tf1Var4 = this.N;
        tf1Var4.Y1 = true;
        tf1Var4.Z1 = 0;
        ...
        this.N.setOnScrollListener(new lf1(this, i12));
        tf1 tf1Var5 = this.N;
        ...
        this.h.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
            public final /* synthetic */ ig1 b;
            ...
            public final void onClick(View view) {
                ...
                switch (i10) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        wy wyVar32 = this.b.M0;
                        if (wyVar32 != null && (w0Var2 = wyVar32.j0) != null) {
                            w0Var2.performClick();
                            break;
                        }
                        break;
        ...
        imageView2.setBackground(org.telegram.ui.ActionBar.z5.c(null, org.telegram.ui.ActionBar.z5.b(getThemedColor(i16))));
        ...
        this.o0.addView(this.W0, w7.a6.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        this.W0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
            public final /* synthetic */ ig1 b;
        ...
        this.e.addView(this.r0, w7.a6.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        eg1 eg1Var2 = this.r0;
        int i17 = org.telegram.ui.ActionBar.j6.d6;
        eg1Var2.setBackgroundColor(getThemedColor(i17));
        ...
        this.U0.setOnAnimatedHeightChangedListener(new gf1(this, i10));
        ...
        final int i18 = 3;
        this.P0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
            public final /* synthetic */ ig1 b;
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (p2Var instanceof wy) {
                    wy wyVar4 = (wy) p2Var;
                    if (wyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = wyVar4.p2;
    ...
    public final void x0() {
        zg.e eVar;
        if (Build.VERSION.SDK_INT < 31 || (eVar = this.f1) == null) {
            return;
        }
        int dp = AndroidUtilities.dp(48.0f);
        int dp2 = AndroidUtilities.dp(48.0f) + ((int) this.U0.c(AndroidUtilities.dp(14.0f)));
        wy wyVar = this.M0;
        View view = wyVar != null ? wyVar.fragmentView : this.fragmentView;
        org.telegram.ui.ActionBar.l actionBar = wyVar != null ? wyVar.getActionBar() : this.actionBar;
        ...
        eVar.g(this.M0 != null ? 2 : 1, this.k1);
        eVar.e(this.j1, view.getMeasuredWidth(), view.getMeasuredHeight());
    }
    ...
    public final void z0(boolean z10) {
        ...
        if (this.H0 != null && ((str = this.y0) != null || this.z0)) {
            org.telegram.ui.Components.voip.e2.l(chat, str, false, Boolean.valueOf(!r1.call.rtmp_stream), getParentActivity(), this, getAccountInstance());
            this.y0 = null;
            this.z0 = false;
        } else {
    ...
    @Override // org.telegram.ui.Components.eh
    public final /* synthetic */ void E(int i10, int i11, int i12, int i13, boolean z10, boolean z11) {
    }
}
