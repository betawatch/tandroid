...
public final class ig1 implements org.telegram.ui.Components.ml0 {
    ...
    public final void d(int i10, View view) {
        ...
        if (((kg1) arrayList.get(i10)).a == 1) {
            Bundle bundle = new Bundle();
            bundle.putLong("chat_id", -lg1Var.c);
