...
public final class sz0 extends org.telegram.ui.Components.qv0 implements r0.n {
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        if (viewGroup == profileActivity.a) {
            ...
            if (i11 >= 0) {
                if (z4) {
                    org.telegram.ui.Components.tl0 currentListView2 = profileActivity.L.getCurrentListView();
                    iArr[1] = i11;
                    if (top > 0) {
                        iArr[1] = 0;
                    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.k50 k50Var = profileActivity.u0;
        Paint paint = profileActivity.n2;
        tg.d dVar = profileActivity.k6;
        ...
        if (Build.VERSION.SDK_INT >= 31 && eVar != null) {
            ...
            if (dVar != null && !dVar.n) {
                ...
                a2.drawColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.a7, profileActivity.w0));
        ...
        paint.setColor(org.telegram.ui.ActionBar.k6.v0(i10, profileActivity.w0));
        if (profileActivity.a.getVisibility() == 0) {
            int v02 = org.telegram.ui.ActionBar.k6.v0(i10, profileActivity.w0);
        ...
        canvas.translate(oy0Var != null ? oy0Var.getTranslationX() : 0.0f, 0.0f);
        int v03 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.d6, profileActivity.w0);
        int i13 = profileActivity.i6;
        oy0 oy0Var2 = profileActivity.a;
        AndroidUtilities.drawNavigationBarProtection(canvas, this, v03, i13, oy0Var2 != null ? oy0Var2.getAlpha() : 0.0f);
        canvas.restore();
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        ProfileActivity profileActivity = this.A0;
        dz0 dz0Var = profileActivity.S4;
        if (dz0Var.n) {
            return dz0Var.g(motionEvent);
        }
        uz0 uz0Var = profileActivity.L;
        if (uz0Var != null && (rt0Var = (rt0VarArr = uz0Var.h0)[0]) != null && rt0Var.h.getFastScroll() != null && rt0VarArr[0].h.getFastScroll().n) {
            uz0 uz0Var2 = profileActivity.L;
            if (uz0Var2.d) {
                return uz0Var2.O(motionEvent);
            }
        }
        uz0 uz0Var3 = profileActivity.L;
        if (uz0Var3 == null || !uz0Var3.H(motionEvent)) {
    ...
    public final void j(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ...
        try {
            if (viewGroup == profileActivity.a && profileActivity.N) {
                org.telegram.ui.Components.tl0 currentListView = profileActivity.L.getCurrentListView();
            ...
            FileLog.e(th2);
            AndroidUtilities.runOnUIThread(new rz0(this, 1));
        }
    }
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        ProfileActivity profileActivity = this.A0;
        org.telegram.ui.Components.or[] orVarArr2 = profileActivity.H;
        org.telegram.ui.Components.or[] orVarArr3 = profileActivity.G;
        ...
        org.telegram.ui.Components.tl0 tl0Var = profileActivity.b;
        if (tl0Var != null) {
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) tl0Var.getLayoutParams();
        ...
        if (profileActivity.z0 == getMeasuredWidth() && profileActivity.A0 == getMeasuredHeight()) {
            ...
            while (i15 < i18) {
                ...
                if (j10 == 13) {
                    ...
                    f2.m1 g10 = profileActivity.d.g(null, j10);
                    View view2 = g10.a;
            ...
            orVarArr = orVarArr2;
            org.telegram.ui.Components.ax0 ax0Var = profileActivity.M;
            if (ax0Var != null) {
                ((FrameLayout.LayoutParams) ax0Var.getLayoutParams()).topMargin = profileActivity.T3() + AndroidUtilities.statusBarHeight;
            }
        }
        if (profileActivity.d5 != null) {
            org.telegram.ui.ActionBar.l5 l5Var = l5VarArr[c3];
            l5Var.setRightPadding(l5Var.getMeasuredWidth() - profileActivity.d5.o().getTitleTextView().getMeasuredWidth());
        }
        ...
        if (!z14 && ((z13 = profileActivity.k1) || (profileActivity.D1 && profileActivity.G1 == 2))) {
            ...
            if (z13) {
                ...
                if (gm0Var != null) {
                    gm0Var.b(Color.argb(179, 255, 255, 255));
                }
                ...
                if (bz0Var != null) {
                    bz0Var.setExpandProgress(1.0f);
                }
                mh.t0 t0Var = profileActivity.s0;
                if (t0Var != null) {
                    t0Var.setExpandProgress(1.0f);
                }
                org.telegram.ui.Components.lh0 lh0Var = profileActivity.X;
                if (lh0Var != null) {
                    lh0Var.setParentExpanded(1.0f);
                }
                org.telegram.ui.Components.ei0 ei0Var = profileActivity.Z;
                if (ei0Var != null) {
                    ei0Var.setParentExpanded(1.0f);
                }
                org.telegram.ui.Components.kw0 kw0Var = profileActivity.Q;
                if (kw0Var != null) {
                    kw0Var.setParentExpanded(1.0f);
                }
                c10 = 0;
            ...
            oy0 oy0Var2 = profileActivity.a;
            oy0Var2.layout(0, i16, oy0Var2.getMeasuredWidth(), profileActivity.a.getMeasuredHeight() + i16);
            this.v0 = false;
            ...
            if (view == null && (view = profileActivity.a.getChildAt(0)) != null) {
                oy0 oy0Var3 = profileActivity.a;
                View F = oy0Var3.F(view);
                f2.m1 T = F == null ? null : oy0Var3.T(F);
                i12 = T.b();
                if (i12 == -1 && (i12 = T.g) == -1) {
                    i12 = T.c;
                }
                    ...
                    if (i21 >= 0) {
                        ...
                        if ((z4 && profileActivity.l2) || view == null) {
                            ...
                            if (z11) {
                                measureChildWithMargins(profileActivity.a, i10, 0, i11, 0);
                                try {
                                    oy0 oy0Var4 = profileActivity.a;
                                    oy0Var4.layout(0, i16, oy0Var4.getMeasuredWidth(), profileActivity.a.getMeasuredHeight() + i16);
                                } catch (Exception e6) {
                                    FileLog.e(e6);
                                }
                            }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        ProfileActivity profileActivity = this.A0;
        ug.c.c(profileActivity.m6, profileActivity.fragmentView);
