        ...
        if (((Item) this.items.get(i)).viewType == 1) {
            ...
            dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.SaveToGallerySettingsActivity$$ExternalSyntheticLambda3
                ...
                public final boolean didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i3, TopicsFragment topicsFragment) {
                    ...
                    lambda$createView$0 = SaveToGallerySettingsActivity.this.lambda$createView$0(dialogsActivity2, arrayList, charSequence, z, z2, i3, topicsFragment);
    ...
    private class Adapter extends AdapterWithDiffUtils {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (((Item) SaveToGallerySettingsActivity.this.items.get(i)).viewType == 7) {
                ...
                textInfoPrivacyCell.setText(((Item) saveToGallerySettingsActivity.items.get(i)).title);
                return;
            }
            ...
            if (((Item) SaveToGallerySettingsActivity.this.items.get(i)).viewType == 2) {
                ...
                userCell.setData(userOrChat, str2, dialogException.createDescription(((BaseFragment) SaveToGallerySettingsActivity.this).currentAccount), 0, i == SaveToGallerySettingsActivity.this.items.size() - 1 || ((Item) SaveToGallerySettingsActivity.this.items.get(i + 1)).viewType == 2);
            }
        }
