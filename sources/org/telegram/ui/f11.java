...
public final class f11 extends FrameLayout {
    ...
    public final void a(MessagesController.PeerColor peerColor, boolean z10) {
        ...
        if (peerColor != null) {
            ...
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.z0)) > 0.8f) {
                this.G = -1;
                this.H = -1;
            } else if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.z0)) < 0.2f) {
                this.G = org.telegram.ui.ActionBar.h6.l1(0.5f, org.telegram.ui.ActionBar.h6.b(0.02f, 0.25f, org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.z0)));
                this.H = org.telegram.ui.ActionBar.h6.l1(0.35f, org.telegram.ui.ActionBar.h6.b(0.02f, 0.25f, org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.z0)));
            } else {
                this.G = up0.w0(org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.z0));
                this.H = org.telegram.ui.ActionBar.h6.l1(0.15f, up0.w0(org.telegram.ui.ActionBar.h6.v0(i11, profileActivity.z0)));
            }
        }
        if (!z10) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, profileActivity.z0));
