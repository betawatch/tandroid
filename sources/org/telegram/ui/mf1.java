...
public final class mf1 extends org.telegram.ui.Components.qv0 {
    public boolean w0;
    public final Paint x0;
    public final /* synthetic */ fg1 y0;
    ...
    public final void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            ...
            if (fg1Var.g1 != null) {
                ...
                fg1Var.g1.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (fg1Var.isInPreviewMode()) {
            int themedColor = fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6);
            Paint paint = this.x0;
        ...
        if (fg1Var.M0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6), fg1Var.e1);
        }
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == kVar && !fg1Var.isInPreviewMode()) {
            kVar2 = ((org.telegram.ui.ActionBar.o2) fg1Var).actionBar;
            float y3 = kVar2.getY();
            kVar3 = ((org.telegram.ui.ActionBar.o2) fg1Var).actionBar;
            float height = kVar3.getHeight();
            org.telegram.ui.Components.i81 i81Var = fg1Var.a1;
            int measuredHeight = (int) (y3 + ((int) ((((i81Var == null || i81Var.getVisibility() == 8) ? 0.0f : fg1Var.a1.getMeasuredHeight()) * fg1Var.W) + height)));
            ((ActionBarLayout) fg1Var.getParentLayout()).p(canvas, (int) ((1.0f - fg1Var.W) * 255.0f), measuredHeight);
            float f7 = fg1Var.W;
            if (f7 > 0.0f) {
                if (f7 < 1.0f) {
                    int alpha = org.telegram.ui.ActionBar.j6.k0.getAlpha();
                    org.telegram.ui.ActionBar.j6.k0.setAlpha((int) (alpha * fg1Var.W));
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (t41Var != null) {
            this.w0 = true;
            ViewGroup.LayoutParams layoutParams = t41Var.getLayoutParams();
            int dp = AndroidUtilities.dp(51.0f);
            int i13 = fg1Var.e1;
            layoutParams.height = dp + i13;
            fg1Var.o0.setPadding(0, 0, 0, i13);
            this.w0 = false;
        }
        int i14 = 0;
