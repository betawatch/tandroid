...
public final class fw0 extends LinearLayout {
    ...
    public fw0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        bw0 bw0Var = new bw0(this, context, premiumPreviewFragment.d0 ? 1 : 0, i10 == 1 ? 1 : 0, context);
        this.d = bw0Var;
    ...
    */
    public final void a() {
        ...
        if (premiumPreviewFragment.e == -1) {
            ...
            while (true) {
                ...
                if (((hw0) arrayList.get(i15)).a.months == 12) {
    ...
    public final void b() {
        ...
        if (i10 == 0) {
            ...
            org.telegram.messenger.y1.p((premiumPreviewFragment.getUserConfig().isPremium() || premiumPreviewFragment.l0) ? R.string.TelegramPremiumSubscribedSubtitle : R.string.TelegramPremiumSubtitle, textView2);
        } else if (i10 == 1) {
            ...
            org.telegram.messenger.y1.p((premiumPreviewFragment.getUserConfig().isPremium() || premiumPreviewFragment.l0) ? R.string.TelegramBusinessSubscribedSubtitleTemp : R.string.TelegramBusinessSubtitleTemp, textView2);
        }
