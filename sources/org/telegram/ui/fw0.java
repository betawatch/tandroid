...
public final class fw0 extends LinearLayout {
    ...
    public fw0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        this.c = frameLayout;
        int i9 = premiumPreviewFragment.c0;
        int i10 = i9 == 1 ? 175 : 190;
        addView(frameLayout, g7.e6.q(i10, i10, 1));
        bw0 bw0Var = new bw0(this, context, premiumPreviewFragment.d0 ? 1 : 0, i9 == 1 ? 1 : 0, context);
        this.d = bw0Var;
        ...
        addView(textView, g7.e6.p(-2, -2, 0.0f, 1, 16, i9 == 1 ? 8 : 20, 16, 0));
        ...
        cw0Var.setSelectorTransformer(new q0.a() { // from class: org.telegram.ui.zv0
            @Override // q0.a
            public final void accept(Object obj) {
                Canvas canvas = (Canvas) obj;
                cw0 cw0Var2 = fw0.this.e;
                View pressedChildView = cw0Var2.getPressedChildView();
                int b10 = pressedChildView == null ? -1 : cw0Var2.T(pressedChildView).b();
                Path path2 = path;
                path2.rewind();
    ...
    */
    public final void a() {
        ...
        if (premiumPreviewFragment.getMediaDataController().getPremiumPromo() != null) {
            ...
            int i9 = 0;
            while (i9 < size) {
                TLRPC.TL_premiumSubscriptionOption tL_premiumSubscriptionOption = arrayList2.get(i9);
                i9++;
                ...
                hw0 hw0Var = new hw0(tL_premiumSubscriptionOption2);
                arrayList.add(hw0Var);
                if (premiumPreviewFragment.f0 && tL_premiumSubscriptionOption2.months == 12) {
                    premiumPreviewFragment.e = arrayList.size() - 1;
                }
                if (tL_premiumSubscriptionOption2.current) {
                    premiumPreviewFragment.f = hw0Var;
                }
                if (BuildVars.useInvoiceBilling() && hw0Var.i() > j10) {
                    j10 = hw0Var.i();
                }
            }
        } else {
        ...
        if (BuildVars.useInvoiceBilling()) {
            ...
            while (i11 < size3) {
                ...
                hw0Var3.f = BillingController.PREMIUM_PRODUCT_DETAILS;
                if (hw0Var3.i() > j11) {
                    j11 = hw0Var3.i();
                }
                hw0Var3.a();
            ...
            if (z10) {
                ...
                while (i12 < arrayList.size()) {
                    hw0 hw0Var4 = (hw0) arrayList.get(i12);
                    hw0Var4.a();
                    if (hw0Var4.g == null) {
        ...
        if (premiumPreviewFragment.e == -1) {
            ...
            while (true) {
                ...
                if (((hw0) arrayList.get(i14)).a.months == 12) {
                    premiumPreviewFragment.e = i14;
                    break;
                }
                i14++;
            }
        ...
        premiumPreviewFragment.s0(false);
        this.e.getAdapter().l();
    }
    ...
    public final void b() {
        ...
        if (i9 == 0) {
            textView.setText(LocaleController.getString(premiumPreviewFragment.l0 ? R.string.TelegramPremiumSubscribedTitle : R.string.TelegramPremium));
            org.telegram.messenger.l0.m((premiumPreviewFragment.getUserConfig().isPremium() || premiumPreviewFragment.l0) ? R.string.TelegramPremiumSubscribedSubtitle : R.string.TelegramPremiumSubtitle, textView2);
        } else if (i9 == 1) {
            textView.setText(LocaleController.getString(premiumPreviewFragment.l0 ? R.string.TelegramPremiumSubscribedTitle : R.string.TelegramBusiness));
            org.telegram.messenger.l0.m((premiumPreviewFragment.getUserConfig().isPremium() || premiumPreviewFragment.l0) ? R.string.TelegramBusinessSubscribedSubtitleTemp : R.string.TelegramBusinessSubtitleTemp, textView2);
        }
        ...
        boolean z10 = premiumPreviewFragment.l0 || BuildVars.IS_BILLING_UNAVAILABLE || premiumPreviewFragment.d.size() <= 1;
        boolean z11 = this.f;
        int i10 = 8;
        cw0 cw0Var = this.e;
        if (!z11 || !z10) {
            ...
            duration.addUpdateListener(new aw0(this, cw0Var, duration, r2));
            duration.addListener(new org.telegram.ui.Components.su0(i10, this, cw0Var));
