...
public final class fw0 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        qw0Var.d.b.p = (((getMeasuredWidth() * 0.1f) * premiumPreviewFragment.Y) + (premiumPreviewFragment.R.c.getX() + qw0Var.getX())) / getMeasuredWidth();
        qw0 qw0Var2 = premiumPreviewFragment.R;
        qw0Var2.d.b.q = (premiumPreviewFragment.R.c.getY() + qw0Var2.getY()) / getMeasuredHeight();
        if (!premiumPreviewFragment.W) {
            invalidate();
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        qw0 qw0Var = premiumPreviewFragment.R;
        qw0Var.d.b.p = (premiumPreviewFragment.R.d.getX() + qw0Var.getX()) / getMeasuredWidth();
        qw0 qw0Var2 = premiumPreviewFragment.R;
        qw0Var2.d.b.q = (premiumPreviewFragment.R.d.getY() + qw0Var2.getY()) / getMeasuredHeight();
    }
