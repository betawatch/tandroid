...
public final class ys0 implements nt {
    ...
    public ys0(PhotoViewer photoViewer, String str, VideoEditedInfo videoEditedInfo, MediaController.PhotoEntry photoEntry, boolean z10, int i10, int i11, boolean z11) {
        this.h = photoViewer;
        this.a = str;
    ...
    public final void f(CharSequence charSequence, String str, dt dtVar) {
        ...
        photoViewer.w7 = true;
        R();
        photoViewer.p5.p(this.a, this.b, str, charSequence, false, 0L, null, null, photoViewer.v1(), this.c.thumbPath, dtVar, null);
    }
    ...
    public final boolean y() {
        ...
        if (uu0Var != null) {
            return (uu0Var.P() && photoViewer.l4 == null) ? false : true;
        }
        return false;
    }
