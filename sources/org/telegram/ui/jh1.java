...
public abstract class jh1 extends org.telegram.ui.ActionBar.p2 {
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (hh1Var != null) {
                org.telegram.ui.ActionBar.p2 p2Var = hh1Var.a;
                if (p2Var.fragmentView != null) {
                    ...
                    hh1Var.f = f12;
                    boolean z11 = f12 > f11;
                    if (!hh1Var.d && r10 > 0.0f && z4 && p2Var.fragmentView != null) {
                        p2Var.onResume();
                        hh1Var.d = true;
                    }
                    if (!hh1Var.e && ((f11 == 0.0f || f11 == 1.0f) && f11 != f12 && Math.abs(f11 - f12) != 1.0f)) {
                    ...
                    if (hh1Var.e && (f12 == 0.0f || f12 == 1.0f)) {
                        p2Var.onTransitionAnimationEnd(z11, false);
                        hh1Var.e = false;
                    }
                    if (!hh1Var.c && f12 >= 1.0f) {
                        p2Var.onBecomeFullyVisible();
                        hh1Var.c = true;
                    }
                    if (hh1Var.c && ((f12 == 0.0f && !z10) || r10 == 0.0f)) {
                        p2Var.onBecomeFullyHidden();
                        hh1Var.c = false;
                    }
                    if (hh1Var.d && ((f12 == 0.0f && !z4) || r10 == 0.0f)) {
                        p2Var.onPause();
                        hh1Var.d = false;
                    }
                }
    ...
    public final org.telegram.ui.ActionBar.p2 X() {
        ...
        hh1 hh1Var = (hh1) this.a.get(ih1Var.getCurrentPosition());
        if (hh1Var != null) {
            return hh1Var.a;
        }
        return null;
    ...
    public final void setTitleOverlayText(String str, int i10, Runnable runnable) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (hh1Var != null) {
                hh1Var.a.setTitleOverlayText(str, i10, runnable);
            }
        }
    }
