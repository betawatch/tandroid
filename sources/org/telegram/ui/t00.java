...
public final class t00 extends org.telegram.ui.Cells.m4 {
    ...
    */
    public t00(f10 f10Var, Context context) {
        ...
        org.telegram.messenger.vl.l(f10Var.getUserConfig().isPremium() ? R.string.FolderTagNoColor : R.string.FolderTagNoColorPremium, textView, 5);
        ...
        this.s = s00Var;
        this.w = new org.telegram.ui.Components.f5(s00Var, 320L, org.telegram.ui.Components.qr.h, 0);
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (z11 != this.x) {
            ...
            s00Var.animate().alpha(z11 ? 0.0f : 1.0f).setDuration(320L).setInterpolator(qrVar).start();
        }
    }
