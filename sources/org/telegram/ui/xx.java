...
public final class xx extends mu0 {
    ...
    public final wu0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ry ryVar = this.b;
        org.telegram.ui.Components.mq0 mq0Var = ryVar.G2;
        org.telegram.ui.Components.w9 f7 = mq0Var != null ? mq0Var.f(i10) : null;
        if (f7 == null) {
            return null;
        }
        int[] iArr = new int[2];
    ...
    public final boolean b() {
        ...
        while (i10 < size) {
            ...
            if (DialogObject.isEncryptedDialog(longValue) || ryVar.getMessagesController().getSendPaidMessagesStars(longValue) > 0) {
                return false;
            }
        }
        return true;
    ...
    public final CharSequence b0(int i10) {
        ...
        if (size == 1) {
            return LocaleController.getString(((MediaController.PhotoEntry) ryVar.D2.get(0)).isVideo ? R.string.AttachVideo : R.string.AttachPhoto);
        }
