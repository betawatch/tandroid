...
public final /* synthetic */ class nx0 implements Runnable {
    ...
    public /* synthetic */ nx0(ProfileActivity profileActivity, TLRPC.User user, int i10) {
        this.a = i10;
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                if (profileActivity2.getParentActivity() != null) {
                    ...
                    org.telegram.ui.Components.voip.f2.n(user2, false, userFull != null && userFull.video_calls_available, profileActivity2.getParentActivity(), profileActivity2.s2, profileActivity2.getAccountInstance());
                    break;
                }
                break;
            case 2:
                ...
                if (profileActivity3.getParentActivity() != null) {
                    ...
                    org.telegram.ui.Components.voip.f2.n(user3, true, userFull2 != null && userFull2.video_calls_available, profileActivity3.getParentActivity(), profileActivity3.s2, profileActivity3.getAccountInstance());
                    break;
                }
                break;
            case 3:
