...
public abstract class su0 {
    ...
    public su0(PhotoViewer photoViewer, View view) {
        this.s = photoViewer;
        ...
        while (true) {
            ...
            if (i10 >= fArr.length) {
                ...
                this.r = fg0Var;
                fg0Var.h = 200;
                this.q = new org.telegram.ui.Components.qq(photoViewer.y.getDrawable(R.drawable.circle_big).mutate(), fg0Var);
                return;
            }
            this.m[i10] = 1.0f;
            fArr[i10] = 1.0f;
    ...
    public final void a() {
        ...
        if (z10 != this.p) {
            this.p = z10;
            qs0 qs0Var = (qs0) this;
            PhotoViewer photoViewer = qs0Var.t;
            if (qs0Var == photoViewer.W0[0]) {
                photoViewer.q3();
            }
        }
    }
    ...
    public final void c(Canvas canvas) {
        ...
        if (i14 >= 0) {
            ...
            if (i14 < drawableArr2.length + 2) {
                ...
                if (drawable != null) {
                    if (this.k != -2) {
                        drawable.setAlpha((int) org.telegram.messenger.z0.A(1.0f, this.l, 255.0f, f10));
                    } else {
