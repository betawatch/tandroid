...
public final class vp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.d6 j0;
    ...
    public vp(int i10, View view, long j3, int i11, int i12, long j10, org.telegram.ui.ActionBar.d6 d6Var) {
    ...
    public final void a(Canvas canvas, rj rjVar, float f7, float f10) {
        int i10;
        int i11;
        RectF rectF;
        int i12;
        ...
        org.telegram.ui.ActionBar.h6.q(0.0f, rjVar.getMeasuredHeight() - dp, this.c, rjVar.getMeasuredHeight());
        int i16 = org.telegram.ui.ActionBar.h6.ic;
        org.telegram.ui.ActionBar.d6 d6Var = this.j0;
        int v02 = org.telegram.ui.ActionBar.h6.v0(i16, d6Var);
        TextPaint textPaint3 = this.f;
        textPaint3.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.h6.v0(i16, d6Var);
        Paint paint2 = this.e;
        paint2.setColor(v03);
        ...
        org.telegram.ui.ActionBar.h6.h2.setAlpha((int) (alpha2 * f21));
        ...
        if ((f7 < 1.0f || this.Q >= 1.0f) && (f7 >= 1.0f || this.Q != 1.0f)) {
            ...
            if (currentTimeMillis - this.P > 100) {
                try {
                    rjVar.performHapticFeedback(3, 2);
        ...
        if (f26 < 1.0f || this.R) {
            ...
            if (this.W) {
                ...
                if (d6Var != null ? d6Var.p0() : org.telegram.ui.ActionBar.h6.a1()) {
                    int alpha6 = org.telegram.ui.ActionBar.h6.h2.getAlpha();
                    org.telegram.ui.ActionBar.h6.h2.setAlpha((int) (alpha6 * f12));
                    float f39 = this.d;
                    canvas2.drawRoundRect(rectF4, f39, f39, org.telegram.ui.ActionBar.h6.h2);
                    org.telegram.ui.ActionBar.h6.h2.setAlpha(alpha6);
                }
            }
        ...
        if (this.s == null || this.K <= 0.0f) {
            ...
            if (d6Var != null ? d6Var.p0() : org.telegram.ui.ActionBar.h6.a1()) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.h6.h2);
            }
            canvas2.save();
        ...
        if (!this.R && f14 > 0.0f) {
            ...
            if (this.X && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.qq) && (((org.telegram.ui.Components.qq) imageReceiver2.getDrawable()).b instanceof org.telegram.ui.Components.m80)) {
                ((org.telegram.ui.Components.m80) ((org.telegram.ui.Components.qq) imageReceiver2.getDrawable()).b).i = f7;
            }
            if (this.K <= 0.0f || !this.b0) {
                ...
                wqVar3.e(wqVar3.s);
                canvas2.scale(f53, f53, (wqVar3.s / 2.0f) + wqVar3.A + AndroidUtilities.dp(12.0f) + f16, (a10 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                ...
                float f60 = this.K;
                wqVar3.e(wqVar3.s);
                canvas2.scale(f60, f60, (wqVar3.s / 2.0f) + wqVar3.A + AndroidUtilities.dp(12.0f) + f16, (a10 - AndroidUtilities.dp(f19)) + AndroidUtilities.dp(f20));
        ...
        org.telegram.ui.ActionBar.h6.h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Xk, this.j0);
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (i13) {
                        case 0:
                            vp vpVar = this.b;
                            vpVar.getClass();
                            vpVar.K = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            vpVar.T.invalidate();
                            break;
                        case 1:
                            vp vpVar2 = this.b;
                            vpVar2.getClass();
                            vpVar2.L = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            break;
                        case 2:
                            vp vpVar3 = this.b;
                            vpVar3.getClass();
                            vpVar3.L = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            break;
                        case 3:
                            vp vpVar4 = this.b;
                        ...
                        default:
                            vp vpVar5 = this.b;
                            vpVar5.getClass();
                            vpVar5.K = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            vpVar5.T.invalidate();
                            view.invalidate();
                            break;
                    }
    ...
    public final void j() {
        ...
        if (i12 == 1) {
            ...
            if (q5Var3 == null || q5Var3.i() != tL_forumTopic.icon_emoji_id) {
                ...
                this.k0 = q5Var5;
                q5Var5.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.ic, d6Var), PorterDuff.Mode.SRC_IN));
            }
