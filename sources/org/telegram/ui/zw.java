...
public final class zw extends s4.c0 {
    ...
    public final void f0() {
        ...
        if (vyVar.a.getScrollState() != 1) {
            ...
            this.K = ofFloat;
            ofFloat.addUpdateListener(new ai.x(21, this, vyVar));
            this.K.addListener(new org.telegram.ui.Components.w81(this, 16));
    ...
    public final int o0(int i10, of.e eVar, s4.z0 z0Var) {
        ...
        if (!syVar.X1) {
            ...
            if (i10 > 0 && wyVar.T != 0.0f) {
                kVar7 = ((org.telegram.ui.ActionBar.o2) wyVar).actionBar;
                if (kVar7 != null) {
                    kVar8 = ((org.telegram.ui.ActionBar.o2) wyVar).actionBar;
                }
                    ...
                    if (wyVar.X2 == 0 && wyVar.getMessagesController().hasHiddenArchive() && vyVar.v == 2) {
                        ...
                        if ((i11 == 0 || (z10 && !wyVar.F3.c())) && i10 < 0) {
                            ...
                            if (m12 != null && L0 < 10) {
                                ...
                                while (i11 < L0) {
                                    dx dxVar = vyVar.d;
                                    if (((gg.k) dxVar.M.get(i11)).a == 0) {
                                        if (!((gg.k) dxVar.M.get(i11)).f || dxVar.J) {
