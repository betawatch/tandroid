...
public final /* synthetic */ class hi1 implements org.telegram.ui.ActionBar.c2, iy {
    public final /* synthetic */ ji1 a;

    public /* synthetic */ hi1(ji1 ji1Var) {
        this.a = ji1Var;
    }
    ...
    public void i(org.telegram.ui.ActionBar.d2 d2Var, int i10) {
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof mi1) {
                ...
                TLRPC.WallPaper wallPaper = mi1Var.l;
                if (wallPaper == null || wallPaper.id >= 0) {
                    valueAt = wallPaper;
                } else {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(mi1Var.l.id);
                    wallpapersListActivity.c0.remove(mi1Var);
                    wallpapersListActivity.a0.remove(mi1Var.a());
                }
            }
            if (valueAt instanceof TLRPC.WallPaper) {
                ...
                if (str != null && str.equals(wallpapersListActivity.P)) {
                    wallpapersListActivity.P = org.telegram.ui.ActionBar.j6.d1() ? "t" : "d";
