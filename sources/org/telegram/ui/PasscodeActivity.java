...
public class PasscodeActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.hd0 f;
    private int fingerprintRow;
    public EditTextBoldCursor h;
    public de0 n;
    public TextView r;
    public ImageView s;
    public org.telegram.ui.Components.as v;
    ...
    public static /* synthetic */ void U(PasscodeActivity passcodeActivity, org.telegram.ui.Components.dd0 dd0Var, int i10) {
    ...
    public static void V(PasscodeActivity passcodeActivity, View view, int i10) {
        if (view.isEnabled()) {
            if (i10 == passcodeActivity.disablePasscodeRow) {
                ...
                d2Var.R = string;
                d2Var.T = LocaleController.getString(R.string.DisablePasscodeConfirmMessage);
            ...
            if (i10 != passcodeActivity.autoLockRow) {
                if (i10 == passcodeActivity.fingerprintRow) {
                    ...
                    if (i10 == passcodeActivity.J) {
                        ...
                        org.telegram.ui.Components.d5.u0(passcodeActivity, null, LocaleController.getString(R.string.ScreenCaptureAlert), null);
                        return;
                    }
                    return;
                }
            ...
            d2Var2.R = string2;
            org.telegram.ui.Components.dd0 dd0Var = new org.telegram.ui.Components.dd0(passcodeActivity.getParentActivity(), null);
            dd0Var.setMinValue(0);
            dd0Var.setMaxValue(4);
            ...
            dd0Var.setFormatter(new org.telegram.ui.Components.gp0(27));
            alertDialog$Builder2.n(dd0Var);
            alertDialog$Builder2.h(LocaleController.getString(R.string.Done), new fg.e2(passcodeActivity, dd0Var, i10, 13));
    ...
    public final void a0(Runnable runnable) {
        ...
        while (true) {
            ...
            if (i10 >= hsVarArr.length) {
                de0Var.postDelayed(new ak0(2, this, runnable), (hsVarArr.length * 75) + 350);
                return;
            } else {
                hs hsVar = hsVarArr[i10];
                hsVar.postDelayed(new nl0(hsVar, 0), i10 * 75);
                i10++;
            }
        }
    }
    ...
    */
    public final View createView(Context context) {
        ...
        if (i12 == 0) {
            ...
            scrollView.addView(frameLayout2, w7.a6.c(-2.0f, -1));
            scrollView.setFillViewport(true);
            frameLayout = scrollView;
        }
        org.telegram.ui.Components.fa0 fa0Var = new org.telegram.ui.Components.fa0(this, context, frameLayout, 1);
        fa0Var.setDelegate(new rd0(1, this));
        this.fragmentView = fa0Var;
        fa0Var.addView(frameLayout, w7.a6.l(1.0f, -1, 0));
        org.telegram.ui.Components.as asVar = new org.telegram.ui.Components.as(context);
        this.v = asVar;
        asVar.setVisibility(c0() ? 0 : 8);
        fa0Var.addView(this.v, w7.a6.n(-1, 230));
        if (i12 == 0) {
            ...
            if (lVar != null) {
                ...
                this.actionBar.setActionBarMenuOnItemClick(new ol0(this, g1Var));
            }
            FrameLayout frameLayout3 = new FrameLayout(context);
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(1);
            linearLayout.setGravity(1);
            frameLayout2.addView(linearLayout, w7.a6.c(-1.0f, -1));
            ...
            if (!AndroidUtilities.isSmallScreen()) {
                ...
                if (point.x < point.y) {
                    ...
                    linearLayout.addView(this.a, w7.a6.q(120, 120, 1));
                    ...
                    frameLayout2.addView(textView2, w7.a6.d(-1, 56.0f, 81, 0.0f, 0.0f, 0.0f, 16.0f));
                    og.u0.e(textView2);
                    ...
                    frameLayout2.addView(this.r, w7.a6.d(-2, -2.0f, 81, 0.0f, 0.0f, 0.0f, 16.0f));
                    ...
                    linearLayout2.addView(this.h, w7.a6.l(1.0f, 0, -2));
                    ...
                    this.h.addTextChangedListener(new og.x(4, this, atomicBoolean));
                    this.s.setOnClickListener(new ow(20, this, atomicBoolean));
                    linearLayout2.addView(this.s, w7.a6.u(24.0f, 24.0f, 0, 0.0f, 0.0f, 14.0f, 0.0f));
                    this.f.addView(linearLayout2, w7.a6.c(-2.0f, -1));
                    frameLayout3.addView(this.f, w7.a6.t(-1, -2, 1, 32, 0, 32, 0));
                    this.h.setOnEditorActionListener(new ja(this, 8));
                    this.h.addTextChangedListener(new pl0(this, 0));
                    this.h.setCustomSelectionActionModeCallback(new hi.f1(3));
                    de0 de0Var = new de0(this, context, 2);
                    this.n = de0Var;
                    de0Var.b(4, 10);
                    for (hs hsVar : this.n.f) {
                        hsVar.setShowSoftInputOnFocusCompat(!c0());
                        hsVar.setTransformationMethod(PasswordTransformationMethod.getInstance());
                        hsVar.setTextSize(1, 24.0f);
                        hsVar.addTextChangedListener(new pl0(this, 1));
                        hsVar.setOnFocusChangeListener(new di.z1(this, hsVar, 3));
                    }
                    frameLayout3.addView(this.n, w7.a6.d(-2, -2.0f, 1, 40.0f, 10.0f, 40.0f, 0.0f));
                    linearLayout.addView(frameLayout3, w7.a6.t(-1, -2, 1, 0, 32, 0, 72));
                    if (i12 == 1) {
                    ...
                    this.w = h20Var;
                    og.u0.e(h20Var);
                    frameLayout2.addView(this.w, w7.a6.d(56, 56.0f, (!LocaleController.isRTL ? 3 : 5) | 80, 20.0f, 0.0f, 20.0f, 14.0f));
                    ...
                    s31Var.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.O9, false));
                    s31Var.setDrawBackground(false);
                    this.w.setContentDescription(LocaleController.getString(R.string.Next));
                    this.w.addView(s31Var, w7.a6.e(56, 56, 17));
                    org.telegram.ui.Components.h20 h20Var2 = this.w;
                    h20Var2.a(h20Var2);
                    l0();
                }
            }
            ...
            this.e = d11Var2;
            d11Var2.setFactory(new sg0(context, 1));
            this.e.setInAnimation(context, R.anim.alpha_in);
            this.e.setOutAnimation(context, R.anim.alpha_out);
            linearLayout.addView(this.e, w7.a6.t(-2, -2, 1, 20, 8, 20, 0));
            ...
            frameLayout2.addView(textView22, w7.a6.d(-1, 56.0f, 81, 0.0f, 0.0f, 0.0f, 16.0f));
            og.u0.e(textView22);
            ...
            linearLayout22.addView(this.h, w7.a6.l(1.0f, 0, -2));
            ...
            this.h.addTextChangedListener(new og.x(4, this, atomicBoolean2));
            this.s.setOnClickListener(new ow(20, this, atomicBoolean2));
            linearLayout22.addView(this.s, w7.a6.u(24.0f, 24.0f, 0, 0.0f, 0.0f, 14.0f, 0.0f));
            this.f.addView(linearLayout22, w7.a6.c(-2.0f, -1));
            frameLayout3.addView(this.f, w7.a6.t(-1, -2, 1, 32, 0, 32, 0));
            this.h.setOnEditorActionListener(new ja(this, 8));
            this.h.addTextChangedListener(new pl0(this, 0));
            this.h.setCustomSelectionActionModeCallback(new hi.f1(3));
            ...
            org.telegram.ui.Components.h20 h20Var3 = new org.telegram.ui.Components.h20(context, this.resourceProvider, false);
            this.w = h20Var3;
            og.u0.e(h20Var3);
            frameLayout2.addView(this.w, w7.a6.d(56, 56.0f, (!LocaleController.isRTL ? 3 : 5) | 80, 20.0f, 0.0f, 20.0f, 14.0f));
            this.w.setOnClickListener(new l60(this, 13));
            ...
            s31Var2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.O9, false));
            s31Var2.setDrawBackground(false);
            this.w.setContentDescription(LocaleController.getString(R.string.Next));
            this.w.addView(s31Var2, w7.a6.e(56, 56, 17));
            org.telegram.ui.Components.h20 h20Var22 = this.w;
            h20Var22.a(h20Var22);
            l0();
        }
    ...
    public final void f0() {
        ...
        AndroidUtilities.shakeViewSpring(e0() ? this.n : this.f, e0() ? 10.0f : 4.0f, new ll0(this, 2));
    }
    ...
    public final void g0() {
        ...
        if (i11 == 1) {
            ...
            for (hs hsVar2 : this.n.f) {
                hsVar2.clearFocus();
                AndroidUtilities.hideKeyboard(hsVar2);
            }
            this.v.setEditText(null);
            a0(new ml0(this, isEmpty, i10));
            return;
        }
        if (i11 == 2) {
            ...
            this.h.clearFocus();
            AndroidUtilities.hideKeyboard(this.h);
            hs[] hsVarArr = this.n.f;
            int length2 = hsVarArr.length;
            while (i10 < length2) {
                hs hsVar5 = hsVarArr[i10];
                hsVar5.clearFocus();
                AndroidUtilities.hideKeyboard(hsVar5);
                i10++;
            }
            this.v.setEditText(null);
            a0(new ll0(this, 1));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 16, new Class[]{org.telegram.ui.Cells.x8.class, org.telegram.ui.Cells.ga.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 262144, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 262144, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.E6));
    ...
    public final void i0(boolean z10, boolean z11) {
        ...
        duration.setInterpolator(z10 ? org.telegram.ui.Components.wr.f : org.telegram.ui.Components.pt.e);
        duration.addUpdateListener(new d3(this, 19));
        duration.addListener(new org.telegram.ui.Components.yo(28, this, z10));
        duration.start();
    }
    ...
    public final void m0() {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 23 && new aa.a(new androidx.biometric.s(ApplicationLoader.applicationContext, 0)).f(15) == 0 && AndroidUtilities.isKeyguardSecure()) {
                int i10 = this.L;
                this.L = i10 + 1;
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        de0 de0Var = this.n;
        if (de0Var == null || (hsVarArr = de0Var.f) == null) {
            return;
        }
