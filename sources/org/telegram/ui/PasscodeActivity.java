...
public class PasscodeActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.ad0 f;
    ...
    public static /* synthetic */ void U(PasscodeActivity passcodeActivity, org.telegram.ui.Components.wc0 wc0Var, int i10) {
    ...
    public static void V(PasscodeActivity passcodeActivity, View view, int i10) {
        if (view.isEnabled()) {
            ...
            wc0Var.setFormatter(new al0(i11));
    ...
    */
    public final View createView(Context context) {
        ...
        org.telegram.ui.Components.x90 x90Var = new org.telegram.ui.Components.x90(this, context, frameLayout, 1);
        x90Var.setDelegate(new jd0(1, this));
        this.fragmentView = x90Var;
        x90Var.addView(frameLayout, k7.b6.l(1.0f, -1, 0));
        org.telegram.ui.Components.sr srVar = new org.telegram.ui.Components.sr(context);
        this.v = srVar;
        srVar.setVisibility(c0() ? 0 : 8);
        x90Var.addView(this.v, k7.b6.n(-1, 230));
        if (i12 == 0) {
            ...
            fl0 fl0Var = new fl0(this, context);
            this.b = fl0Var;
            sl0Var2.setAdapter(fl0Var);
            ...
            if (kVar != null) {
                ...
                this.actionBar.setActionBarMenuOnItemClick(new cl0(this, g1Var));
            }
            ...
            if (!AndroidUtilities.isSmallScreen()) {
                ...
                if (point.x < point.y) {
                    ...
                    this.e = u01Var;
                    u01Var.setFactory(new ig0(context, 1));
                    ...
                    textView2.setOnClickListener(new e60(context, 12));
                    ...
                    this.s.setOnClickListener(new gb0(8, this, atomicBoolean));
                    ...
                    this.h.addTextChangedListener(new dl0(this, 0));
                    this.h.setCustomSelectionActionModeCallback(new org.telegram.ui.ActionBar.j0(2));
                    vd0 vd0Var = new vd0(this, context, 2);
                    this.n = vd0Var;
                    vd0Var.b(4, 10);
                    for (bs bsVar : this.n.f) {
                        bsVar.setShowSoftInputOnFocusCompat(!c0());
                        bsVar.setTransformationMethod(PasswordTransformationMethod.getInstance());
                        bsVar.setTextSize(1, 24.0f);
                        bsVar.addTextChangedListener(new dl0(this, 1));
                        bsVar.setOnFocusChangeListener(new lh.n8(this, bsVar, 3));
                    }
                    ...
                    this.w.setOnClickListener(new e60(this, 13));
            ...
            this.e = u01Var2;
            u01Var2.setFactory(new ig0(context, 1));
            this.e.setInAnimation(context, R.anim.alpha_in);
            this.e.setOutAnimation(context, R.anim.alpha_out);
            linearLayout.addView(this.e, k7.b6.t(-2, -2, 1, 20, 8, 20, 0));
            ...
            textView22.setOnClickListener(new e60(context, 12));
            ...
            this.s.setOnClickListener(new gb0(8, this, atomicBoolean2));
            ...
            this.h.addTextChangedListener(new dl0(this, 0));
            this.h.setCustomSelectionActionModeCallback(new org.telegram.ui.ActionBar.j0(2));
            vd0 vd0Var2 = new vd0(this, context, 2);
            this.n = vd0Var2;
            vd0Var2.b(4, 10);
            while (r10 < r5) {
            }
    ...
    public final void f0() {
        ...
        AndroidUtilities.shakeViewSpring(e0() ? this.n : this.f, e0() ? 10.0f : 4.0f, new yk0(this, 2));
    }
    ...
    public final void g0() {
        ...
        if (i11 == 2) {
            ...
            this.h.clearFocus();
            AndroidUtilities.hideKeyboard(this.h);
            bs[] bsVarArr = this.n.f;
            int length2 = bsVarArr.length;
            while (i10 < length2) {
                bs bsVar5 = bsVarArr[i10];
                bsVar5.clearFocus();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 16, new Class[]{org.telegram.ui.Cells.s8.class, org.telegram.ui.Cells.aa.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 262144, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 262144, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.E6));
    ...
    public final void i0(boolean z4, boolean z10) {
        ...
        duration.setInterpolator(z4 ? org.telegram.ui.Components.nr.f : org.telegram.ui.Components.gt.e);
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        vd0 vd0Var = this.n;
        if (vd0Var == null || (bsVarArr = vd0Var.f) == null) {
            return;
        }
