...
public final class q21 extends View {
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.F != null) {
            ...
            w21 w21Var = g21Var.a;
            w21Var.c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    */
    public final void b(int i10, int i11) {
        ...
        if ((TextUtils.isEmpty(this.G) && !this.r) || TextUtils.isEmpty(this.I)) {
            AndroidUtilities.runOnUIThread(new n21(this, 1));
            return;
        }
        ...
        int B = org.telegram.messenger.ok.B(20.0f, 2, createBitmap.getWidth());
        if (!this.r) {
            int i17 = 0;
            for (int i18 = 2; i17 <= i18; i18 = 2) {
                ...
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(v7.j.g(" ", upperCase));
                if (!this.H) {
                ...
                if (i17 > 1 || measureText <= B) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.p21
                        ...
                        public final void run() {
                            q21 q21Var = q21.this;
                            Bitmap bitmap2 = q21Var.h;
                            q21Var.h = createBitmap.extractAlpha();
                            if (!q21Var.S) {
                                q21Var.x.d(0.0f, true);
                            }
                            q21Var.S = false;
                            Bitmap bitmap3 = q21Var.n;
                            if (bitmap3 != null) {
                                bitmap3.recycle();
                            }
                            q21Var.n = bitmap2;
                            ...
                            if (g21Var != null) {
                                ...
                                float f14 = width3;
                                w21 w21Var = g21Var.a;
                                w21Var.c.set((int) (f13 - f12), (int) (f14 - f12), (int) (f13 + f12), (int) (f14 + f12));
                                w21Var.E.requestLayout();
                                q21Var.M = true;
                            }
                            q21Var.invalidate();
        ...
        int B22 = org.telegram.messenger.ok.B(f7, i12, i10);
