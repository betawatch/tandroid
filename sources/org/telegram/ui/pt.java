...
public final class pt {
    ...
    public static int d(pt ptVar, int i10) {
        return org.telegram.ui.ActionBar.h6.v0(i10, ptVar.c0);
    }
    ...
    public static boolean h(pt ptVar, ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        boolean z12 = (MessageObject.isVoted(d) || d.poll.closed || ptVar.l.c()) ? false : true;
        boolean z13 = !z12 && MessageObject.canUnvote(d);
        if (z11) {
            qh.q qVar2 = new qh.q(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ptVar.r, ptVar.c0);
            ...
            o70Var.T(org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(i10, ptVar.c0)));
            ah.c cVar = ptVar.t;
            dh.e k10 = eh.b.k(ptVar.c0);
            ...
            if ((activity instanceof LaunchActivity) && A != null) {
                ...
                if (n2Var != null) {
                    ...
                    qVar.setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.I5, ptVar.c0), 12, 0));
                    ...
                    org.telegram.ui.ActionBar.k1 k1Var = new org.telegram.ui.ActionBar.k1(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ptVar.c0);
                    k1Var.setTag(R.id.fit_width_tag, 1);
                    k1Var.setColor(org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(i10, ptVar.c0)));
            ...
            qVar.setOnClickListener(new ci.n4(actionBarPopupWindow$ActionBarPopupWindowLayout, b10, 17));
            actionBarPopupWindow$ActionBarPopupWindowLayout.addView(qVar);
            org.telegram.ui.ActionBar.k1 k1Var2 = new org.telegram.ui.ActionBar.k1(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ptVar.c0);
            k1Var2.setTag(R.id.fit_width_tag, 1);
            k1Var2.setColor(org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(i10, ptVar.c0)));
        ...
        if (z12) {
            f7 = 0.06f;
            org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.msg_select, LocaleController.getString(R.string.PollSubmitVotesNoCaps), false, ptVar.c0).setOnClickListener(new ct(ptVar, 2));
        } else {
            f7 = 0.06f;
        }
        if (z13) {
            actionBarPopupWindow$ActionBarPopupWindowLayout2 = actionBarPopupWindow$ActionBarPopupWindowLayout;
            org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout2, R.drawable.msg_unvote, LocaleController.getString(R.string.Unvote), false, ptVar.c0).setOnClickListener(new ct(ptVar, 3));
        } else {
            actionBarPopupWindow$ActionBarPopupWindowLayout2 = actionBarPopupWindow$ActionBarPopupWindowLayout;
        }
        if (!z11 && (z12 || z13)) {
            org.telegram.ui.ActionBar.k1 k1Var3 = new org.telegram.ui.ActionBar.k1(actionBarPopupWindow$ActionBarPopupWindowLayout2.getContext(), ptVar.c0);
            k1Var3.setTag(R.id.fit_width_tag, 1);
            k1Var3.setColor(org.telegram.ui.ActionBar.h6.l1(f7, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.E8, ptVar.c0)));
    ...
    */
    public final boolean s(MotionEvent motionEvent, org.telegram.ui.Components.ml0 ml0Var, Object obj, nt ntVar, org.telegram.ui.ActionBar.d6 d6Var) {
        int i10;
        int i11;
        nt ntVar2;
        View view;
        ...
        if ((ntVar3 == null || ntVar3.i()) && (this.j != null || this.E)) {
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3 || motionEvent.getAction() == 6) {
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.ar0(23, ml0Var, obj), 150L);
                                    ...
                                    if (z10) {
                                        ...
                                        if (i10 != -1 && childAt != this.h) {
                                            ...
                                            if (!(view2 instanceof org.telegram.ui.Cells.g8)) {
                                                ...
                                                nt ntVar4 = this.l;
                                                t(sticker, stickerPath, findAnimatedEmojiEmoticon, ntVar4 != null ? ntVar4.G(false) : null, null, i10, g8Var.y, g8Var.getParentObject(), d6Var, 0);
                                                ...
                                                nt ntVar5 = this.l;
                                                t(sticker2, null, findAnimatedEmojiEmoticon2, ntVar5 != null ? ntVar5.G(false) : null, null, i10, false, e8Var.getParentObject(), d6Var, 0);
                                                ...
                                                nt ntVar6 = this.l;
                                                t(document2, null, null, ntVar6 != null ? ntVar6.G(true) : null, e2Var2.getBotInlineResult(), i10, false, e2Var2.getBotInlineResult() != null ? e2Var2.getInlineBot() : e2Var2.getParentObject(), d6Var, 0);
                                                if (i10 != 1 || this.m) {
    ...
    public final boolean y(View view) {
        ...
        String findAnimatedEmojiEmoticon = MessageObject.findAnimatedEmojiEmoticon(g8Var.getSticker(), null, Integer.valueOf(this.r));
        nt ntVar = this.l;
        t(sticker, stickerPath, findAnimatedEmojiEmoticon, ntVar != null ? ntVar.G(false) : null, null, 0, g8Var.y, g8Var.getParentObject(), this.c0, 0);
        lt ltVar = this.U;
        AndroidUtilities.cancelRunOnUIThread(ltVar);
