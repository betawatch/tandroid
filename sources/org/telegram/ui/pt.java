...
public final class pt {
    ...
    public static /* synthetic */ void a(pt ptVar, Bitmap bitmap, Bitmap bitmap2) {
        sg.b bVar = ptVar.s;
        Paint paint = ptVar.N;
    ...
    public static int d(pt ptVar, int i10) {
        return org.telegram.ui.ActionBar.j6.v0(i10, ptVar.c0);
    }
    ...
    public static boolean h(pt ptVar, ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        boolean z11 = (MessageObject.isVoted(e) || e.poll.closed || ptVar.l.c()) ? false : true;
        boolean z12 = !z11 && MessageObject.canUnvote(e);
        if (z10) {
            dh.u uVar2 = new dh.u(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ptVar.r, ptVar.c0);
            org.telegram.ui.Components.o70 o70Var = new org.telegram.ui.Components.o70(actionBarPopupWindow$ActionBarPopupWindowLayout, ptVar.c0);
            int b10 = actionBarPopupWindow$ActionBarPopupWindowLayout.b(o70Var.B);
            int i10 = org.telegram.ui.ActionBar.j6.E8;
            o70Var.T(org.telegram.ui.ActionBar.j6.l1(0.06f, org.telegram.ui.ActionBar.j6.v0(i10, ptVar.c0)));
            ng.a aVar = ptVar.t;
            qg.d j10 = rg.b.j(ptVar.c0);
            org.telegram.ui.ActionBar.p2 p2Var = null;
            LinearLayout linearLayout = o70Var.B;
            ...
            o70Var.k();
            MessageObject z13 = ptVar.l.z();
            Activity activity = ptVar.w;
            if ((activity instanceof LaunchActivity) && z13 != null) {
                ...
                if (p2Var != null) {
                    ...
                    uVar.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.I5, ptVar.c0), 12, 0));
                    ...
                    org.telegram.ui.ActionBar.m1 m1Var = new org.telegram.ui.ActionBar.m1(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ptVar.c0);
                    m1Var.setTag(R.id.fit_width_tag, 1);
                    m1Var.setColor(org.telegram.ui.ActionBar.j6.l1(0.06f, org.telegram.ui.ActionBar.j6.v0(i10, ptVar.c0)));
            ...
            uVar.setOnClickListener(new lh.y0(actionBarPopupWindow$ActionBarPopupWindowLayout, b10, 14));
            actionBarPopupWindow$ActionBarPopupWindowLayout.addView(uVar);
            org.telegram.ui.ActionBar.m1 m1Var2 = new org.telegram.ui.ActionBar.m1(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), ptVar.c0);
            m1Var2.setTag(R.id.fit_width_tag, 1);
            m1Var2.setColor(org.telegram.ui.ActionBar.j6.l1(0.06f, org.telegram.ui.ActionBar.j6.v0(i10, ptVar.c0)));
        ...
        if (z11) {
            f10 = 0.06f;
            org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.msg_select, LocaleController.getString(R.string.PollSubmitVotesNoCaps), false, ptVar.c0).setOnClickListener(new dt(ptVar, 2));
        } else {
            f10 = 0.06f;
        }
        if (z12) {
            actionBarPopupWindow$ActionBarPopupWindowLayout2 = actionBarPopupWindow$ActionBarPopupWindowLayout;
            org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout2, R.drawable.msg_unvote, LocaleController.getString(R.string.Unvote), false, ptVar.c0).setOnClickListener(new dt(ptVar, 3));
        } else {
            actionBarPopupWindow$ActionBarPopupWindowLayout2 = actionBarPopupWindow$ActionBarPopupWindowLayout;
        }
        if (!z10 && (z11 || z12)) {
            org.telegram.ui.ActionBar.m1 m1Var3 = new org.telegram.ui.ActionBar.m1(actionBarPopupWindow$ActionBarPopupWindowLayout2.getContext(), ptVar.c0);
            m1Var3.setTag(R.id.fit_width_tag, 1);
            m1Var3.setColor(org.telegram.ui.ActionBar.j6.l1(f10, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.E8, ptVar.c0)));
    ...
    public final void n() {
        ...
        pg1 pg1Var = this.O;
        if (pg1Var != null) {
            pg1Var.animate().alpha(0.0f).translationY(AndroidUtilities.dp(56.0f)).setDuration(150L).setInterpolator(org.telegram.ui.Components.nr.f).start();
        }
        FrameLayout frameLayout = this.Q;
        if (frameLayout != null) {
            frameLayout.animate().alpha(0.0f).setDuration(150L).scaleX(0.6f).scaleY(0.6f).setInterpolator(org.telegram.ui.Components.nr.f).start();
        }
    ...
    */
    public final boolean s(MotionEvent motionEvent, org.telegram.ui.Components.sl0 sl0Var, Object obj, nt ntVar, org.telegram.ui.ActionBar.f6 f6Var) {
        int i10;
        int i11;
        nt ntVar2;
        View view;
        ...
        nt ntVar3 = this.l;
        if ((ntVar3 == null || ntVar3.i()) && (this.j != null || this.E)) {
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3 || motionEvent.getAction() == 6) {
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.k41(11, sl0Var, obj), 150L);
                ct ctVar = this.j;
                if (ctVar != null) {
                                ...
                                if (top > y10 || bottom < y10 || left > x10 || right < x10) {
                                    ...
                                    if (z4) {
                                        ...
                                        if (childAt instanceof org.telegram.ui.Cells.e2) {
                                            ...
                                            if (childAt instanceof org.telegram.ui.Components.dv) {
                                                imageReceiver.setRoundRadius(0);
                                            } else if (!(childAt instanceof org.telegram.ui.Components.sy) || ((org.telegram.ui.Components.sy) childAt).getSpan() == null) {
                                                i10 = -1;
                                            } else {
                                        ...
                                        if (i10 != -1 && childAt != this.h) {
                                            ...
                                            if (!(view2 instanceof org.telegram.ui.Cells.d8)) {
                                                ...
                                                nt ntVar4 = this.l;
                                                t(sticker, stickerPath, findAnimatedEmojiEmoticon, ntVar4 != null ? ntVar4.G(false) : null, null, i10, d8Var.y, d8Var.getParentObject(), f6Var, 0);
                                                ...
                                                nt ntVar5 = this.l;
                                                t(sticker2, null, findAnimatedEmojiEmoticon2, ntVar5 != null ? ntVar5.G(false) : null, null, i10, false, b8Var.getParentObject(), f6Var, 0);
                                                ...
                                                nt ntVar6 = this.l;
                                                t(document2, null, null, ntVar6 != null ? ntVar6.G(true) : null, e2Var2.getBotInlineResult(), i10, false, e2Var2.getBotInlineResult() != null ? e2Var2.getInlineBot() : e2Var2.getParentObject(), f6Var, 0);
                                                if (i10 != 1 || this.m) {
                                                    e2Var2.setScaled(true);
                                                }
                                            } else if (view2 instanceof org.telegram.ui.Components.dv) {
                                                TLRPC.Document document3 = ((org.telegram.ui.Components.dv) view2).getDocument();
                                                if (document3 != null) {
        ...
        if (i10 == 0 || i10 == 2 || i10 == 3) {
            ...
            if (document != null) {
                ...
                if (inputStickerSet != null || i10 == 2) {
                    ...
                    AndroidUtilities.runOnUIThread(ltVar2, i11 > 0 ? i11 : 1300L);
                }
                ...
                if (importingSticker != null) {
                    ...
                    if (importingSticker.videoEditedInfo != null) {
                        if (this.C == null) {
                            org.telegram.ui.Components.hd0 hd0Var = new org.telegram.ui.Components.hd0(this.z.getContext());
                            this.C = hd0Var;
                            this.z.addView(hd0Var, new FrameLayout.LayoutParams(512, 512));
                        }
                        z10 = false;
    ...
    public final boolean y(View view) {
        ...
        String findAnimatedEmojiEmoticon = MessageObject.findAnimatedEmojiEmoticon(d8Var.getSticker(), null, Integer.valueOf(this.r));
        nt ntVar = this.l;
        t(sticker, stickerPath, findAnimatedEmojiEmoticon, ntVar != null ? ntVar.G(false) : null, null, 0, d8Var.y, d8Var.getParentObject(), this.c0, 0);
        lt ltVar = this.U;
        AndroidUtilities.cancelRunOnUIThread(ltVar);
