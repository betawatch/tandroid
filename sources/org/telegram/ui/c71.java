...
public abstract class c71 extends Dialog {
    ...
    public c71(g71 g71Var, Context context, Runnable runnable, View view, p61 p61Var, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        j0 j0Var = new j0(v51Var, context, 22);
        this.s = j0Var;
        setContentView(j0Var, new ViewGroup.LayoutParams(-1, -1));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        linearLayout.addView(new s50(v51Var, context, 9), w7.y5.t(160, 160, 17, 0, 0, 0, 16));
        ...
        org.telegram.ui.ActionBar.v0.c(true, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil1Hour), false, e6Var).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.z61
        ...
        final int i11 = 1;
        org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil2Hours), false, e6Var).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.z61
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                switch (i11) {
                    case 0:
        ...
        final int i12 = 2;
        org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil8Hours), false, e6Var).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.z61
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                switch (i12) {
                    case 0:
        ...
        final int i13 = 3;
        org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil2Days), false, e6Var).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.z61
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                switch (i13) {
                    case 0:
        ...
        j0Var.addView(linearLayout, w7.y5.e(-2, -2, 17));
        ...
        if (window != null) {
            ...
            z10 = true;
            j0Var.setOnApplyWindowInsetsListener(new v41(v51Var, 1 == true ? 1 : 0));
        ...
        if (document != null) {
            ...
            if ((p61Var.E instanceof org.telegram.ui.Components.q5) && (MessageObject.isTextColorEmoji(document2) || ((org.telegram.ui.Components.q5) p61Var.E).c())) {
                if (!MessageObject.isTextColorEmoji(document2)) {
                    org.telegram.ui.Components.q5 q5Var = (org.telegram.ui.Components.q5) p61Var.E;
                    SparseArray sparseArray = org.telegram.ui.Components.q5.q;
                    if (q5Var == null || !q5Var.l()) {
                        colorFilter = org.telegram.ui.ActionBar.j6.n0(e6Var);
                        imageReceiver.setColorFilter(colorFilter);
                    }
                }
                colorFilter = g71Var.k1;
                imageReceiver.setColorFilter(colorFilter);
            }
        }
    ...
    public static /* synthetic */ WindowInsets b(v51 v51Var, View view, WindowInsets windowInsets) {
        view.requestLayout();
    ...
    public final void c(boolean z10) {
        ...
        this.N = ofFloat;
        ofFloat.addUpdateListener(new i21(this, 9));
    ...
    public final void d(final boolean z10, y61 y61Var, final y61 y61Var2, final boolean z11) {
        ...
        this.K = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.a71
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                c71 c71Var = c71.this;
                c71Var.I = floatValue;
                AndroidUtilities.lerp(c71Var.c, c71Var.d, floatValue, c71Var.e);
                c71Var.s.invalidate();
                boolean z12 = z10;
                if (!z12) {
    ...
    */
    public final void e(Integer num) {
        ...
        Rect rect = this.c;
        if (num != null) {
            w51 w51Var = ((v51) this).S;
            g71 g71Var = w51Var.e;
            if (g71Var.n1 != null && w51Var.d != null) {
                rect.set(g71Var.o1);
                z10 = true;
                this.x = z10;
                int[] iArr = this.G;
                ...
                d(false, new y61(this, num, 0), new y61(this, num, 1), !z10);
                c(false);
            }
        }
        z10 = false;
