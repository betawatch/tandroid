...
public final class c80 extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    ...
    public c80(e80 e80Var, Context context, org.telegram.ui.ActionBar.x1 x1Var) {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.l1(0.6f, e80Var.getThemedColor(i10)), PorterDuff.Mode.SRC_IN));
        ...
        fVar.setTextColor(e80Var.getThemedColor(i10));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        rectF.set(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f), getWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f) + e80Var.b.e + AndroidUtilities.dp(3.0f));
        Path path = this.b;
        path.rewind();
        path.addRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), Path.Direction.CW);
        GradientDrawable gradientDrawable = this.e;
        if (gradientDrawable != null) {
            gradientDrawable.setBounds(0, 0, getWidth(), Math.min(getHeight(), AndroidUtilities.dp(24.0f) + ((int) e80Var.b.e)));
            this.e.draw(canvas);
        }
        canvas.save();
