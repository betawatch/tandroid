...
public final class ow0 extends Dialog {
    ...
    public ow0(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f = i1Var;
        i1Var.setAdapter(new kw0(this, activity, i10));
    ...
    public final void b(boolean z10, dw0 dw0Var) {
        ...
        this.f0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.ew0
        ...
        this.f0.addListener(new androidx.fragment.app.g(this, z10, dw0Var, 9));
        ...
        this.g0 = ofFloat2;
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.ew0
            public final /* synthetic */ ow0 b;
        ...
        this.g0.addListener(new j70(4, this, z10));
