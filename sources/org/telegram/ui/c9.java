...
public final class c9 implements org.telegram.ui.Components.fb {
    ...
    public /* synthetic */ c9(Object obj, int i10) {
        this.a = i10;
        this.b = obj;
    }
    ...
    public final void c(float f10) {
        switch (this.a) {
            ...
            case 4:
                ...
                UndoView undoView = qyVar.v0[0];
                if (undoView == null || undoView.getVisibility() != 0) {
                    qyVar.r1 = Math.max(0.0f, (f10 - qyVar.d4) - qyVar.g4);
                    qyVar.X4();
                    break;
                }
                break;
    ...
    public final int f(int i10) {
        ...
        switch (this.a) {
            case 0:
                ...
                break;
            case 1:
                return ((dd) this.b).L.getMeasuredHeight();
            case 2:
                zn znVar = (zn) this.b;
                if (i10 == 1) {
                    return 0;
                }
                return Math.round(znVar.P.getInputBubbleHeight() + AndroidUtilities.dp(16.0f) + znVar.W8(org.telegram.ui.Components.s21.c) + znVar.v.c());
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.b;
            ...
            case 4:
                qy qyVar = (qy) this.b;
                return qyVar.U2 != 0 ? AndroidUtilities.dp(60.0f) + qyVar.d4 : qyVar.n3();
            case 5:
                i12 = ((xg0) this.b).I;
            ...
            case 6:
                ...
                if (!photoViewer.O4) {
                    ...
                    org.telegram.ui.Components.y30 y30Var = photoViewer.i1;
                    return (y30Var == null || !y30Var.c()) ? i13 : (AndroidUtilities.isTablet() || photoViewer.b0.getMeasuredHeight() > photoViewer.b0.getMeasuredWidth()) ? (int) ((photoViewer.i1.getAlpha() * photoViewer.i1.getHeight()) + i13) : i13;
                }
    ...
    public final int h(int i10) {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                max2 = (int) Math.max(0.0f, znVar.q9);
                break;
            case 3:
                return 0;
            case 4:
                ...
                pw pwVar = qyVar.w0;
                int measuredHeight2 = i12 + ((pwVar == null || pwVar.getVisibility() != 0) ? 0 : qyVar.w0.getMeasuredHeight());
                org.telegram.ui.Components.is isVar = qyVar.G1;
                int height = measuredHeight2 + (isVar != null ? isVar.getHeight() : 0);
                ix ixVar = qyVar.B0;
