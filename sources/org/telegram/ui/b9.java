    ...
    public final void c(float f7) {
        switch (this.a) {
            ...
            case 4:
                ...
                UndoView undoView = wyVar.y0[0];
                if (undoView == null || undoView.getVisibility() != 0) {
                    wyVar.u1 = Math.max(0.0f, (f7 - wyVar.f4) - wyVar.i4);
                    wyVar.X4();
                    break;
                }
                break;
    ...
    public final int f(int i10) {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                return Math.round(boVar.S.getInputBubbleHeight() + AndroidUtilities.dp(16.0f) + boVar.W8(org.telegram.ui.Components.u21.c) + boVar.v.c());
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.b;
            ...
            case 4:
                wy wyVar = (wy) this.b;
                return wyVar.X2 != 0 ? AndroidUtilities.dp(60.0f) + wyVar.f4 : wyVar.n3();
            case 5:
                i12 = ((gh0) this.b).L;
                i11 = AndroidUtilities.dp(64.0f);
                break;
            case 6:
                PhotoViewer photoViewer = ((xu0) this.b).E0;
                int i13 = 0;
                if (!photoViewer.R4) {
                ...
                return (dt0Var2 == null || !dt0Var2.L.c()) ? i13 + photoViewer.P0.getHeight() : i13;
            case 7:
    ...
    public final int h(int i10) {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                max2 = (int) Math.max(0.0f, boVar.t9);
                break;
            case 3:
                return 0;
            case 4:
            ...
            case 5:
                return 0;
            case 6:
                return org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight + ((int) (((xu0) this.b).E0.V1.getAlpha() * r4.V1.getEditTextHeight()));
            case 7:
                return 0;
            case 8:
