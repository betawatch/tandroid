    ...
    public class WidgetPreviewCell extends FrameLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            while (i < 2) {
                ...
                if (drawable != null) {
                    drawable.setAlpha((i != 1 || this.oldBackgroundDrawable == null || ((BaseFragment) EditWidgetActivity.this).parentLayout == null) ? NotificationCenter.locationPermissionGranted : (int) (255.0f * themeAnimationValue));
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLRPC.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(264.0f), TLRPC.FLAG_30));
        }
            ...
            public void onItemClick(int i2) {
                if (i2 == -1) {
                    if (EditWidgetActivity.this.delegate == null) {
                        ...
                        EditWidgetActivity.this.lambda$onBackPressed$355();
                        return;
                    }
                }
