...
public final class f4 extends org.telegram.ui.Components.kl0 {
    ...
    public static int I(TL_iv.PageBlock pageBlock) {
        ...
        if ((pageBlock instanceof TL_iv.pageBlockHeader) || h4.K(pageBlock)) {
            return 1;
        }
    ...
    public final void E(TL_iv.PageBlock pageBlock, f4 f4Var) {
        ...
        if ((pageBlock instanceof TL_iv.pageBlockVideo) && e4.g(f4Var.E, pageBlock)) {
            ...
            TLRPC.Document a2 = e4.a(this.E, pageblockvideo.video_id);
            if (a2 != null) {
        ...
        if (!(pageBlock instanceof TL_iv.pageBlockCollage)) {
            if (pageBlock instanceof TL_iv.pageBlockCover) {
                E(((TL_iv.pageBlockCover) pageBlock).cover, f4Var);
                return;
            }
            return;
        }
    ...
    /*  JADX ERROR: Type inference failed
        ...
        */
    public final void F(org.telegram.ui.f4 r24, org.telegram.tgnet.tl.TL_iv.PageBlock r25, int r26, int r27, int r28) {
        /*
            Method dump skipped, instructions count: 1543
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.f4.F(org.telegram.ui.f4, org.telegram.tgnet.tl.TL_iv$PageBlock, int, int, int):void");
    }
    ...
    */
    public final void H(int i10, s4.c1 c1Var, TL_iv.PageBlock pageBlock, int i11, int i12, boolean z10) {
        ...
        TL_iv.PageBlock pageBlock2 = z12 ? ((TL_iv.pageBlockCover) pageBlock).cover : pageBlock instanceof v3 ? ((v3) pageBlock).b : pageBlock;
        if (i10 == 92) {
            ((z1) c1Var.a).setBlock((TL_iv.pageBlockMath) pageBlock2);
            return;
        }
        if (i10 == 100) {
        ...
        switch (i10) {
            case 0:
                ((b2) c1Var.a).setBlock((TL_iv.pageBlockParagraph) pageBlock2);
                break;
            case 1:
                ((v1) c1Var.a).setBlock(pageBlock2);
                break;
            case 2:
                break;
            case 3:
                ...
                TL_iv.pageBlockEmbed pageblockembed2 = s1Var.v;
                s1Var.v = pageblockembed;
                r1 r1Var = s1Var.a;
                if (r1Var != null) {
                    photo = null;
                    r10 = 0;
                    r1Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.d6, false));
                } else {
                    photo = null;
                    r10 = 0;
                }
                TL_iv.pageBlockEmbed pageblockembed3 = s1Var.v;
                if (pageblockembed2 != pageblockembed3) {
                    s1Var.s = r10;
                    r1 r1Var2 = s1Var.a;
                    if (r1Var2 != 0) {
                        if (pageblockembed3.allow_scrolling) {
                            r1Var2.setVerticalScrollBarEnabled(true);
                            s1Var.a.setHorizontalScrollBarEnabled(true);
                        } else {
                            r1Var2.setVerticalScrollBarEnabled(r10);
                            s1Var.a.setHorizontalScrollBarEnabled(r10);
                        }
                    }
                    s1Var.r = r10;
                    r1 r1Var3 = s1Var.a;
                    if (r1Var3 != null) {
                        try {
                            r1Var3.loadUrl("about:blank");
                        } catch (Exception e) {
                            FileLog.e(e);
                        }
                    }
                    try {
                        TL_iv.pageBlockEmbed pageblockembed4 = s1Var.v;
                        ...
                        if (str2 != null) {
                            ...
                            org.telegram.ui.Components.c91 c91Var = s1Var.b;
                            if (c91Var != null) {
                            ...
                            if (s1Var.b.g(pageblockembed.url, j3 != 0 ? e4.e(s1Var.w.E, j3) : photo, s1Var.w.E, null, false)) {
                                r1 r1Var5 = s1Var.a;
                                if (r1Var5 != null) {
                                    r1Var5.setVisibility(4);
                                    s1Var.a.stopLoading();
                                    s1Var.a.loadUrl("about:blank");
                                }
                                org.telegram.ui.Components.c91 c91Var2 = s1Var.b;
                                if (c91Var2 != null) {
                                    c91Var2.setVisibility(0);
                                }
                            } else {
                                r1 r1Var6 = s1Var.a;
                                if (r1Var6 != null) {
                                    r1Var6.setVisibility(0);
                                    HashMap hashMap = new HashMap();
                                    hashMap.put("Referer", ApplicationLoader.applicationContext.getPackageName());
                                    s1Var.a.loadUrl(s1Var.v.url, hashMap);
                                }
                                org.telegram.ui.Components.c91 c91Var3 = s1Var.b;
                                if (c91Var3 != null) {
                                    c91Var3.setVisibility(4);
                                    s1Var.b.g(null, null, null, null, false);
                                }
                            }
                        }
                ...
                break;
            case 4:
                ((r2) c1Var.a).setBlock((TL_iv.pageBlockSubtitle) pageBlock2);
                break;
            case 5:
                w2 w2Var = (w2) c1Var.a;
                TL_iv.pageBlockVideo pageblockvideo = (TL_iv.pageBlockVideo) pageBlock2;
                w2Var.b(pageblockvideo, (x2) this.L.y.f(pageblockvideo.video_id), z10, i11 == 0);
                TL_iv.pageBlockChannel pageblockchannel = this.F;
                c1 c1Var2 = w2Var.s;
                w2Var.N = pageBlock;
                if (pageblockchannel != null && z12) {
                    c1Var2.setBlock(pageblockchannel);
                    c1Var2.setVisibility(0);
                    break;
                }
                break;
            case 6:
                ((g2) c1Var.a).setBlock((TL_iv.pageBlockPullquote) pageBlock2);
                break;
            case 7:
                ((b1) c1Var.a).setBlock((TL_iv.pageBlockBlockquote) pageBlock2);
                break;
            case 8:
                p2 p2Var = (p2) c1Var.a;
                p2Var.d = (TL_iv.pageBlockSlideshow) pageBlock2;
                p2Var.b.g();
                k2 k2Var = p2Var.a;
                k2Var.x(0, false);
                k2Var.forceLayout();
            ...
            case 9:
                c2 c2Var = (c2) c1Var.a;
                c2Var.a((TL_iv.pageBlockPhoto) pageBlock2, this.E, z10, i11 == 0);
                c2Var.setParentBlock(pageBlock);
                break;
            case 10:
                ((a1) c1Var.a).setBlock((TL_iv.pageBlockAuthorDate) pageBlock2);
                break;
            case 11:
                ((u2) c1Var.a).setBlock((TL_iv.pageBlockTitle) pageBlock2);
                break;
            case 12:
                ((x1) c1Var.a).setBlock((x3) pageBlock2);
                break;
            case 13:
                ((u1) c1Var.a).setBlock((TL_iv.pageBlockFooter) pageBlock2);
                break;
            case 14:
                ((f2) c1Var.a).setBlock((TL_iv.pageBlockPreformatted) pageBlock2);
                break;
            case 15:
                ((q2) c1Var.a).setBlock((TL_iv.pageBlockSubheader) pageBlock2);
                break;
            case 16:
                ((t1) c1Var.a).setBlock((TL_iv.pageBlockEmbedPost) pageBlock2);
                break;
            case 17:
                j1 j1Var = (j1) c1Var.a;
                TL_iv.pageBlockCollage pageblockcollage = (TL_iv.pageBlockCollage) pageBlock2;
                if (j1Var.s != pageblockcollage) {
                    j1Var.s = pageblockcollage;
                    i1 i1Var2 = j1Var.v;
                    int i15 = i1Var2.c;
                    ArrayList arrayList = i1Var2.a;
                    arrayList.clear();
                    HashMap hashMap2 = i1Var2.b;
                    hashMap2.clear();
                    j1 j1Var2 = i1Var2.d;
                    TL_iv.pageBlockCollage pageblockcollage2 = j1Var2.s;
                    f4 f4Var = j1Var2.w;
                    ...
                    if (size > 1) {
                        ...
                        float f13 = 1.0f;
                        while (i16 < size) {
                            TL_iv.PageBlock pageBlock3 = j1Var2.s.items.get(i16);
                            if (pageBlock3 instanceof TL_iv.pageBlockPhoto) {
                                TLRPC.Photo e10 = e4.e(f4Var.E, ((TL_iv.pageBlockPhoto) pageBlock3).photo_id);
                                if (e10 == null) {
                                    i16++;
                                } else {
                                ...
                                if ((pageBlock3 instanceof TL_iv.pageBlockVideo) && (a2 = e4.a(f4Var.E, ((TL_iv.pageBlockVideo) pageBlock3).video_id)) != null) {
                        ...
                        if (z13 || !(size == 2 || size == 3 || size == 4)) {
                            ...
                            for (int i18 = 1; i18 < size2; i18++) {
                                int i19 = size2 - i18;
                                if (i18 <= 3 && i19 <= 3) {
                                    float a10 = i1Var2.a(fArr, 0, i18);
                                    float a11 = i1Var2.a(fArr, i18, size2);
                                    h1 h1Var = new h1();
                                    h1Var.a = new int[]{i18, i19};
                                    h1Var.b = new float[]{a10, a11};
                                    ...
                                    if (i21 < i22) {
                                        ...
                                        if (i20 <= 3) {
                                            if (i21 <= (f16 < 0.85f ? 4 : 3) && i23 <= 3) {
                                                float a12 = i1Var2.a(fArr, 0, i20);
                                                int i24 = i20 + i21;
                                                float a13 = i1Var2.a(fArr, i20, i24);
                                                float a14 = i1Var2.a(fArr, i24, size2);
                                                h1 h1Var2 = new h1();
                                                h1Var2.a = new int[]{i20, i21, i23};
                                                i14 = i15;
                                                h1Var2.b = new float[]{a12, a13, a14};
                                        ...
                                        while (true) {
                                            ...
                                            if (i29 < i30) {
                                                ...
                                                if (i26 > 3 || i27 > 3 || i29 > 3 || i31 > 3) {
                                                    ...
                                                    float a15 = i1Var2.a(fArr, 0, i26);
                                                    int i32 = i26 + i27;
                                                    float a16 = i1Var2.a(fArr, i26, i32);
                                                    i13 = i28;
                                                    int i33 = i32 + i29;
                                                    float a17 = i1Var2.a(fArr, i32, i33);
                                                    float a18 = i1Var2.a(fArr, i33, size2);
                                                    h1 h1Var3 = new h1();
                                                    h1Var3.a = new int[]{i26, i27, i29, i31};
                                                    i1Var = i1Var2;
                                                    h1Var3.b = new float[]{a15, a16, a17, a18};
                            ...
                            while (i34 < arrayList2.size()) {
                                h1 h1Var5 = (h1) arrayList2.get(i34);
                                float f19 = Float.MAX_VALUE;
                                int i35 = 0;
                                float f20 = 0.0f;
                                while (true) {
                                    float[] fArr2 = h1Var5.b;
                                    float f21 = f17;
                                    if (i35 < fArr2.length) {
                                        float f22 = fArr2[i35];
                                        f20 += f22;
                            ...
                            if (sb3.equals("ww")) {
                                if (f16 > f15 * 1.4d) {
                                    ...
                                    if (f24 - f25 < 0.2d) {
                                        ...
                                        groupedMessagePosition5.set(0, 0, 0, 0, i1Var2.c, round, 7);
                                        groupedMessagePosition6.set(0, 0, 1, 1, i1Var2.c, round, 11);
                                    }
                                }
                                str = sb3;
                            } else {
                            ...
                            if (sb2.charAt(0) == 'n') {
                                ...
                                groupedMessagePosition7.set(0, 1, 0, 0, i1Var2.c, round4, 7);
                                int i49 = i15 / 2;
                                float f31 = i49;
                            ...
                            if (sb2.charAt(0) == 'w') {
                                ...
                                groupedMessagePosition10.set(0, 2, 0, 0, i1Var2.c, round5, 7);
                ...
                j1Var.b.l();
                j1Var.a.setGlowColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.d6, false));
                j1Var.requestLayout();
                break;
            case 18:
                ((c1) c1Var.a).setBlock((TL_iv.pageBlockChannel) pageBlock2);
                break;
            case 19:
                z0 z0Var = (z0) c1Var.a;
                ...
                z0Var.h = z11;
                org.telegram.ui.Components.bo0 bo0Var = z0Var.f;
                ...
                bo0Var.h(w02, w03, org.telegram.ui.ActionBar.i6.w0(null, i52, false), org.telegram.ui.ActionBar.i6.w0(null, i52, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.wd, false));
                z0Var.a(false);
                z0Var.requestLayout();
                break;
            case 20:
                ((w1) c1Var.a).setBlock((TL_iv.pageBlockKicker) pageBlock2);
                break;
            case 21:
                ((a2) c1Var.a).setBlock((z3) pageBlock2);
                break;
            case 22:
                y1 y1Var = (y1) c1Var.a;
                TL_iv.pageBlockMap pageblockmap = (TL_iv.pageBlockMap) pageBlock2;
                z11 = i11 == 0;
                y1Var.x = pageblockmap;
                y1Var.h = z11;
                y1Var.requestLayout();
                break;
            case 23:
                ...
                h2Var.n = (b4) pageBlock2;
                h2Var.r = webPage;
                h2Var.requestLayout();
                break;
            case 24:
                ((l1) c1Var.a).setBlock((TL_iv.pageBlockDetails) pageBlock2);
                break;
            case 25:
                ((t2) c1Var.a).setBlock((TL_iv.pageBlockTable) pageBlock2);
                break;
            case 26:
                ((i2) c1Var.a).setBlock((TL_iv.pageBlockRelatedArticles) pageBlock2);
                break;
            case 27:
                break;
        }
    ...
    public final boolean J(v3 v3Var) {
        TL_iv.PageBlock z10 = h4.z(v3Var.a);
        ...
        v3 v3Var2 = (v3) z10;
        TL_iv.PageBlock z11 = h4.z(v3Var2.b);
    ...
    public final void K(TL_iv.PageBlock pageBlock) {
        ...
        if (pageBlock instanceof x3) {
            ...
            TL_iv.RichText richText2 = x3Var.e;
            if (richText2 != null) {
                L(null, richText2);
                G(x3Var.e, x3Var);
                return;
        ...
        if (pageBlock instanceof z3) {
            ...
            TL_iv.RichText richText3 = z3Var.e;
            if (richText3 != null) {
                L(null, richText3);
                G(z3Var.e, z3Var);
                return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 2147483646) {
            ...
            switch (i10) {
                case 0:
                    view = new b2(context, h4Var, this);
                    break;
                case 1:
                    view = new v1(context, h4Var, this);
                    break;
                case 2:
                    view = new m1(context);
                    break;
                case 3:
                    view = new s1(h4Var, context, this);
                    break;
                case 4:
                    view = new r2(context, h4Var, this);
                    break;
                case 5:
                    w2Var = new w2(context, h4Var, this, 0);
                    view = w2Var;
                    break;
                case 6:
                    view = new g2(context, h4Var, this);
                    break;
                case 7:
                    view = new b1(context, h4Var, this);
                    break;
                case 8:
                    view = new p2(h4Var, context, this);
                    break;
                case 9:
                    w2Var = new c2(context, h4Var, this, 0);
                    view = w2Var;
                    break;
                case 10:
                    view = new a1(context, h4Var, this);
                    break;
                case 11:
                    view = new u2(context, h4Var, this);
                    break;
                case 12:
                    view = new x1(context, h4Var, this);
                    break;
                case 13:
                    view = new u1(context, h4Var, this);
                    break;
                case 14:
                    view = new f2(context, h4Var, this);
                    break;
                case 15:
                    view = new q2(context, h4Var, this);
                    break;
                case 16:
                    view = new t1(context, h4Var, this);
                    break;
                case 17:
                    view = new j1(h4Var, context, this);
                    break;
                case 18:
                    w2Var = new c1(context, h4Var, this, 0);
                    view = w2Var;
                    break;
                case 19:
                    view = new z0(context, h4Var, this);
                    break;
                case 20:
                    view = new w1(context, h4Var, this);
                    break;
                case 21:
                    view = new a2(context, h4Var, this);
                    break;
                case 22:
                    view = new y1(context, h4Var, this);
                    break;
                case 23:
                    view = new h2(context, h4Var, this);
                    break;
                case 24:
                    view = new l1(context, h4Var, this);
                    break;
                case 25:
                    view = new t2(context, h4Var, this);
                    break;
                case 26:
                    view = new i2(context, h4Var, this);
                    break;
                case 27:
                    View k1Var = new k1(context);
                    new RectF();
                    k1Var.setImportantForAccessibility(2);
                    view = k1Var;
                    break;
                case 28:
                    view = new j2(context, h4Var);
                    break;
                default:
                    switch (i10) {
                        case 90:
                            w2Var = new o3(h4Var, context, false);
                            view = w2Var;
                            break;
                        case 91:
                            view = new o3(h4Var, context, true);
                            break;
                        case 92:
                            view = new z1(context, h4Var);
                            break;
                        default:
            ...
            View knVar = new org.telegram.ui.Components.kn(context, 8);
            knVar.setImportantForAccessibility(2);
            view = knVar;
        }
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i10 == 90 || i10 == 91) {
            ...
            textView.setTextColor(h4Var.a());
            textView2.setTextColor(h4Var.a());
