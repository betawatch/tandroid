...
public final class gg0 extends org.telegram.ui.Components.gw0 {
    ...
    public gg0(xg0 xg0Var, Context context) {
        ...
        addView(rVarArr[0], w7.y5.t(-1, -2, 55, 0, 0, 0, 6));
        ...
        addView(rVarArr[1], w7.y5.t(-1, -2, 55, 0, 0, 0, 6));
    ...
    public static /* synthetic */ void o(gg0 gg0Var, String str, String str2, String str3) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    TelephonyManager telephonyManager = (TelephonyManager) gg0Var.getContext().getSystemService(TelephonyManager.class);
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        ei.l3 l3Var = new ei.l3(this, string, str, string2, i11, 27);
