...
public final class rm0 implements en0 {
    ...
    public final void c(TLRPC.TL_secureRequiredType tL_secureRequiredType, String str, String str2, TLRPC.TL_secureRequiredType tL_secureRequiredType2, String str3, ArrayList arrayList, SecureDocument secureDocument, ArrayList arrayList2, SecureDocument secureDocument2, SecureDocument secureDocument3, Runnable runnable, o0.a aVar) {
        ...
        if (!isEmpty) {
            ...
            cf.c k12 = on0Var.k1(AndroidUtilities.getStringBytes(str2));
        ...
        if (tL_secureRequiredType2 != null) {
            ...
            if (!TextUtils.isEmpty(str3)) {
                ...
                cf.c k13 = on0Var.k1(AndroidUtilities.getStringBytes(str3));
            ...
            if (!z10) {
                ...
                ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue, new qm0(this, aVar, str, savesecurevalue, tL_secureRequiredType2, tL_secureRequiredType, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, runnable, this, tL_inputSecureValue2));
            }
        ...
        savesecurevalue2.secure_secret_id = on0Var.b1;
        i10 = ((org.telegram.ui.ActionBar.n2) on0Var).currentAccount;
        ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue2, new qm0(this, aVar, str, savesecurevalue2, tL_secureRequiredType2, tL_secureRequiredType, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, runnable, this, tL_inputSecureValue2));
    }
}
