...
public final class rm0 extends org.telegram.ui.Components.mv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public rm0(vm0 vm0Var, Context context, int i10) {
        ...
        org.telegram.messenger.x3.t(textView2, org.telegram.ui.ActionBar.g6.w0(null, i12, false), 1, 18.0f);
        ...
        if (i10 == 3) {
            ...
            addView(frameLayout, i7.f6.q(-2, -2, LocaleController.isRTL ? 5 : 3));
            ImageView imageView = new ImageView(context);
            imageView.setImageResource(R.drawable.phone_activate);
            boolean z10 = LocaleController.isRTL;
            if (z10) {
                frameLayout.addView(imageView, i7.f6.d(64, 76.0f, 19, 2.0f, 2.0f, 0.0f, 0.0f));
                frameLayout.addView(textView, i7.f6.d(-1, -2.0f, LocaleController.isRTL ? 5 : 3, 82.0f, 0.0f, 0.0f, 0.0f));
            } else {
                frameLayout.addView(textView, i7.f6.d(-1, -2.0f, z10 ? 5 : 3, 0.0f, 0.0f, 82.0f, 0.0f));
        ...
        this.n = rVar;
        rVar.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, i11, false));
        rVar.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        if (i10 == 3) {
            rVar.setTextSize(1, 14.0f);
            addView(rVar, i7.f6.q(-2, -2, LocaleController.isRTL ? 5 : 3));
            ...
            addView(sm0Var, i7.f6.k(0.0f, 12.0f, 0.0f, 0.0f, -1, 3));
        } else {
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.K) {
            ...
            while (i16 < this.K) {
                ...
                this.c.addView(this.d[i16], i7.f6.t(34, 36, 1, 0, 0, i16 != this.K - 1 ? 7 : 0, 0));
                this.d[i16].addTextChangedListener(new pm0(this, i16));
                this.d[i16].setOnKeyListener(new View.OnKeyListener() { // from class: org.telegram.ui.nm0
                    ...
                    public final boolean onKey(View view, int i18, KeyEvent keyEvent) {
                        ...
                        int i20 = i19 - 1;
                        EditTextBoldCursor editTextBoldCursor2 = rm0Var.d[i20];
                        editTextBoldCursor2.setSelection(editTextBoldCursor2.length());
                        rm0Var.d[i20].requestFocus();
                        rm0Var.d[i20].dispatchKeyEvent(keyEvent);
                        return true;
                    }
                });
                this.d[i16].setOnEditorActionListener(new da(this, 9));
                i16++;
            }
        }
        sm0 sm0Var = this.s;
        if (sm0Var != null) {
            sm0Var.setVisibility(this.I != 0 ? 0 : 8);
        }
        if (this.a == null) {
            return;
        }
        String k9 = org.telegram.messenger.x3.k(new StringBuilder("+"), this.a, qe.b.c());
        if (i12 == 2) {
        ...
        if (i12 == i10 && ((i11 = this.I) == 4 || i11 == 3)) {
            ...
            objArr[0] = 2;
            objArr[1] = 0;
            rVar.setText(LocaleController.formatString("CallText", i20, objArr));
            om0Var.setVisibility(this.y < 1000 ? 0 : 8);
            rVar.setVisibility(this.y < 1000 ? 8 : 0);
            q();
            return;
        }
        if (i12 != 4 || this.I != 2) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (vm0Var.o0 - dp < dp2) {
            ...
            setMeasuredDimension(getMeasuredWidth(), Math.min(vm0Var.o0, dp3));
        }
    }
    ...
    public final void p() {
        ...
        this.w.schedule(new nh.g2(this, 3), 0L, 1000L);
    }
