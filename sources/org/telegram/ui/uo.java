...
public class uo extends org.telegram.ui.ActionBar.n2 implements org.telegram.ui.Components.t40, NotificationCenter.NotificationCenterDelegate {
    ...
    public static void U(uo uoVar, FrameLayout frameLayout, View view) {
        if (!uoVar.G0) {
            ...
            org.telegram.ui.Components.xc.a0(uoVar).Q(R.raw.topics, 36, (chatFull == null || chatFull.linked_chat_id == 0) ? AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelTopicsForbidden", uoVar.getMessagesController().forumUpgradeParticipantsMin, new Object[0])) : AndroidUtilities.replaceTags(LocaleController.getString("ChannelTopicsDiscussionForbidden", R.string.ChannelTopicsDiscussionForbidden))).j();
            try {
        ...
        mzVar.a = j3;
        mzVar.setResourceProvider(uoVar.resourceProvider);
        ...
        mzVar.d = z11;
        mzVar.f = m0Var;
        uoVar.presentFragment(mzVar);
    }

    public static /* synthetic */ void V(uo uoVar) {
        uoVar.v0 = null;
        long j3 = uoVar.C0;
        if (j3 == 0) {
            MessagesController.getInstance(uoVar.currentAccount).changeChatAvatar(uoVar.w0, null, null, null, null, 0.0d, null, null, null, null);
        } else {
    ...
    public static void X(uo uoVar, org.telegram.ui.ActionBar.b2 b2Var, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, long j3, ChannelBoostsController.CanApplyBoost canApplyBoost) {
        b2Var.dismiss();
        if (uoVar.getParentActivity() == null) {
            return;
        }
        rg.j0 j0Var = new rg.j0(35, uoVar.currentAccount, uoVar.getParentActivity(), uoVar, uoVar.getResourceProvider());
    ...
    public static void Y(uo uoVar) {
        int i10 = uoVar.currentAccount;
        long j3 = uoVar.C0;
        TL_bots.botVerifierSettings botverifiersettings = uoVar.E0.bot_info.verifier_settings;
    ...
    public static /* synthetic */ void a0(uo uoVar) {
        uoVar.O0 = true;
    ...
    */
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ro(this, 0));
        id idVar = new id(i15, context, this);
        idVar.setOnTouchListener(new bi.d(9));
        ...
        ydVar.addView(this.d, w7.y5.n(-1, -2));
        ...
        if (this.D0 != null || ChatObject.canChangeChatInfo(this.x0)) {
            ...
            frameLayout2.addView(z5Var2, w7.y5.d(64, 64.0f, (z12 ? 5 : 3) | 48, z12 ? 0.0f : 16.0f, 12.0f, z12 ? 16.0f : 0.0f, 8.0f));
            Paint paint = new Paint(1);
            paint.setColor(1426063360);
            ci.s6 s6Var = new ci.s6(this, context, paint, i16);
            this.f = s6Var;
            boolean z13 = LocaleController.isRTL;
            frameLayout2.addView(s6Var, w7.y5.d(64, 64.0f, (z13 ? 5 : 3) | 48, z13 ? 0.0f : 16.0f, 12.0f, z13 ? 16.0f : 0.0f, 8.0f));
                ...
                public final void onClick(View view) {
                    switch (i15) {
                        case 0:
                            ...
                            bundle.putLong("chat_id", uoVar3.w0);
                            bundle.putInt(TeXSymbolParser.TYPE_ATTR, 1);
                            sr srVar = new sr(bundle);
                            srVar.x0(uoVar3.y0);
                            uoVar3.presentFragment(srVar);
                            break;
                        case 1:
                            uo uoVar4 = this.b;
                            qo qoVar = uoVar4.Q0;
                            ...
                            if (!uoVar4.s.h()) {
                                ...
                                TLRPC.User user2 = j3 == 0 ? null : uoVar4.getMessagesController().getUser(Long.valueOf(j3));
                                if (user2 == null) {
                                    TLRPC.Chat chat3 = uoVar4.getMessagesController().getChat(Long.valueOf(uoVar4.w0));
                                    TLRPC.ChatPhoto chatPhoto = chat3.photo;
                                    if (chatPhoto != null && chatPhoto.photo_big != null) {
                                        PhotoViewer.t1().J2(null, uoVar4, null);
                                        TLRPC.ChatPhoto chatPhoto2 = chat3.photo;
                                        int i17 = chatPhoto2.dc_id;
                                        if (i17 != 0) {
                                            chatPhoto2.photo_big.dc_id = i17;
                                        }
                                        TLRPC.ChatFull chatFull5 = uoVar4.y0;
                                        if (chatFull5 != null) {
                                            TLRPC.Photo photo = chatFull5.chat_photo;
                                            if ((photo instanceof TLRPC.TL_photo) && !photo.video_sizes.isEmpty()) {
                                                imageLocation = ImageLocation.getForPhoto(uoVar4.y0.chat_photo.video_sizes.get(0), uoVar4.y0.chat_photo);
                                            }
                                        }
                                        PhotoViewer.t1().e2(null, chat3.photo.photo_big, null, imageLocation, null, null, null, 0, qoVar, null, 0L, 0L, 0L, true, null, null);
                                        break;
                                    }
                                } else {
                                    ...
                                    if (userProfilePhoto != null && userProfilePhoto.photo_big != null) {
                                        ...
                                        PhotoViewer.t1().e2(null, user2.photo.photo_big, null, null, null, null, null, 0, qoVar, null, 0L, 0L, 0L, true, null, null);
                                        break;
                                    }
                                }
                            }
                        ...
                        case 4:
                            uo uoVar7 = this.b;
                            uoVar7.presentFragment(new ei.e4(-uoVar7.w0));
                            break;
                        case 5:
                            uo uoVar8 = this.b;
                            uoVar8.getClass();
                            uoVar8.presentFragment(new vb(uoVar8.x0));
                            break;
                        case 6:
                            uo uoVar9 = this.b;
                        ...
                        case 7:
                            ...
                            bundle3.putLong("bot_id", uoVar10.C0);
                            uoVar10.presentFragment(new ra(bundle3));
                            break;
                        case 8:
                            uo uoVar11 = this.b;
                            uoVar11.presentFragment(new ei.l(uoVar11.C0));
                            break;
                        case 9:
                            nf.f.s(view.getContext(), "https://t.me/BotFather?start=" + uo.g0(this.b.D0) + "-intro");
                            break;
                        case 10:
                            nf.f.s(view.getContext(), "https://t.me/BotFather?start=" + uo.g0(this.b.D0) + "-commands");
                            break;
                        case 11:
                            nf.f.s(view.getContext(), "https://t.me/BotFather?start=" + uo.g0(this.b.D0));
                            break;
                        case 12:
                            this.b.i0();
                            break;
                        ...
                        case 16:
                            ...
                            ipVar.P = new ArrayList();
                            ipVar.c0 = true;
                            ipVar.f0 = new ArrayList();
                            ipVar.o0 = new HashMap();
                            ipVar.q0 = new xo(ipVar, 5);
                            ipVar.t0 = false;
                            ipVar.Z = j10;
                            ipVar.n0 = z15;
                            TLRPC.ChatFull chatFull7 = uoVar14.y0;
                            ipVar.Y = chatFull7;
                            if (chatFull7 != null) {
                            ...
                            uoVar14.presentFragment(ipVar);
                            break;
                        case 17:
                            uo uoVar15 = this.b;
                            long j11 = uoVar15.w0;
                            up upVar = new up(null);
                            upVar.v = new ArrayList();
                            boolean z16 = false;
                            upVar.O = false;
                            upVar.P = false;
                            upVar.E = j11;
                            TLRPC.Chat chat4 = upVar.getMessagesController().getChat(Long.valueOf(j11));
                            upVar.f = chat4;
                            if (ChatObject.isChannel(chat4) && !upVar.f.megagroup) {
                                z16 = true;
                            }
                            upVar.s = z16;
                            upVar.h = uoVar15.y0;
                            uoVar15.presentFragment(upVar);
                            break;
                        case 18:
                            uo uoVar16 = this.b;
                            tw0 tw0Var = new tw0(uoVar16.w0);
                            tw0Var.v = new lo(uoVar16, 4);
                            uoVar16.presentFragment(tw0Var);
                            break;
                        case 19:
                            uo.Z(this.b);
                            break;
                        case 20:
                            uo uoVar17 = this.b;
                            s60 s60Var = new s60(-uoVar17.x0.id);
                            s60Var.c = uoVar17.L0;
                            s60Var.l0 = uoVar17;
                            uoVar17.presentFragment(s60Var);
                            break;
                        case 21:
                            uo uoVar18 = this.b;
                            uoVar18.getClass();
                            Bundle bundle4 = new Bundle();
                            bundle4.putLong("chat_id", uoVar18.w0);
                            bundle4.putInt(TeXSymbolParser.TYPE_ATTR, ((uoVar18.I0 || uoVar18.x0.gigagroup) && !ChatObject.isCommunity(uoVar18.x0)) ? 0 : 3);
                            sr srVar3 = new sr(bundle4);
                            srVar3.x0(uoVar18.y0);
                            uoVar18.presentFragment(srVar3);
                            break;
                        case 22:
                            uo uoVar19 = this.b;
                        ...
                        case 23:
                            uo uoVar20 = this.b;
                            if (ChatObject.isChannelAndNotMegaGroup(uoVar20.x0)) {
                                uoVar20.presentFragment(new zg.q(uoVar20.w0, uoVar20.y0));
                                break;
                            } else {
                                Bundle bundle5 = new Bundle();
                                bundle5.putLong("chat_id", uoVar20.w0);
                                bq bqVar = new bq(bundle5);
                                bqVar.d = new ArrayList();
                                bqVar.r = new ArrayList();
                                bqVar.v = -1;
                                bqVar.F = new ArrayList();
                                long j12 = bundle5.getLong("chat_id", 0L);
                                bqVar.c = j12;
                                TLRPC.ChatFull chatFull9 = uoVar20.y0;
                                bqVar.b = chatFull9;
                                if (chatFull9 != null) {
                                    if (bqVar.a == null) {
                                        bqVar.a = bqVar.getMessagesController().getChat(Long.valueOf(j12));
                                    }
                                    bqVar.d = new ArrayList();
                                    ...
                                    if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
                                        ...
                                        for (int i19 = 0; i19 < tL_chatReactionsSome.reactions.size(); i19++) {
                                            if (tL_chatReactionsSome.reactions.get(i19) instanceof TLRPC.TL_reactionEmoji) {
                                                bqVar.d.add(((TLRPC.TL_reactionEmoji) tL_chatReactionsSome.reactions.get(i19)).emoticon);
                                            }
                                        }
                                        bqVar.w = 1;
                                    }
                                }
                                uoVar20.presentFragment(bqVar);
                                break;
                            }
                        default:
                            uo uoVar21 = this.b;
                            ...
                            bundle6.putLong("chat_id", uoVar21.w0);
                            bundle6.putLong("welcome_messages_chat_id", uoVar21.w0);
                            uoVar21.presentFragment(new zn(bundle6));
                            break;
                    }
                }
            });
            ...
            frameLayout2.addView(z5Var3, w7.y5.d(64, 64.0f, (z15 ? 5 : 3) | 48, z15 ? 0.0f : 16.0f, 12.0f, z15 ? 16.0f : 0.0f, 12.0f));
        }
        org.telegram.ui.Components.ju juVar2 = new org.telegram.ui.Components.ju(context, idVar, this);
        this.v = juVar2;
        long j3 = this.C0;
        if (j3 != 0) {
        ...
        frameLayout2.addView(juVar5, w7.y5.d(-1, -2.0f, 16, z16 ? 5.0f : 96.0f, 0.0f, z16 ? 96.0f : 5.0f, 0.0f));
        LinearLayout linearLayout2 = new LinearLayout(context);
        this.y = linearLayout2;
        linearLayout2.setOrientation(1);
        ydVar.addView(this.y, w7.y5.n(-1, -2));
        final int i17 = 12;
        if (this.D0 != null || ChatObject.canChangeChatInfo(this.x0)) {
            so soVar = new so(context);
            this.b0 = soVar;
            soVar.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.K0(false));
            this.b0.e(org.telegram.ui.ActionBar.j6.v6, org.telegram.ui.ActionBar.j6.u6);
            this.b0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.eo
                public final /* synthetic */ uo b;
                ...
                public final void onClick(View view) {
                    switch (i17) {
                        ...
                        case 1:
                            ...
                            if (!uoVar4.s.h()) {
                                ImageLocation imageLocation = null;
                                TLRPC.User user2 = j32 == 0 ? null : uoVar4.getMessagesController().getUser(Long.valueOf(j32));
                                if (user2 == null) {
                                    TLRPC.Chat chat32 = uoVar4.getMessagesController().getChat(Long.valueOf(uoVar4.w0));
                                    ...
                                    if (chatPhoto != null && chatPhoto.photo_big != null) {
                                        ...
                                        PhotoViewer.t1().e2(null, chat32.photo.photo_big, null, imageLocation, null, null, null, 0, qoVar, null, 0L, 0L, 0L, true, null, null);
                                        break;
                                    }
                                } else {
                                    TLRPC.UserProfilePhoto userProfilePhoto = user2.photo;
        ...
        if (chat4 != null) {
                    ...
                    public final void onClick(View view) {
                        switch (i19) {
                            ...
                            case 17:
                                ...
                                upVar.P = false;
                                upVar.E = j11;
                                TLRPC.Chat chat42 = upVar.getMessagesController().getChat(Long.valueOf(j11));
                                upVar.f = chat42;
                                if (ChatObject.isChannel(chat42) && !upVar.f.megagroup) {
                                    z162 = true;
                                }
                                upVar.s = z162;
                                upVar.h = uoVar15.y0;
                                        ...
                                        if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
                                            ...
                                            for (int i192 = 0; i192 < tL_chatReactionsSome.reactions.size(); i192++) {
                                                if (tL_chatReactionsSome.reactions.get(i192) instanceof TLRPC.TL_reactionEmoji) {
                                                    bqVar.d.add(((TLRPC.TL_reactionEmoji) tL_chatReactionsSome.reactions.get(i192)).emoticon);
                                                }
                                            }
                                            bqVar.w = 1;
                                        }
            ...
            if (ChatObject.isChannelAndNotMegaGroup(this.x0) && this.I0 && ChatObject.canUserDoAdminAction(this.x0, 1)) {
                ...
                final int i22 = 18;
                this.K.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.eo
                    public final /* synthetic */ uo b;
            ...
            if (ChatObject.isChannelAndNotMegaGroup(this.x0) && ChatObject.canChangeChatInfo(this.x0)) {
                ...
                final int i23 = 19;
                this.L.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.eo
                    public final /* synthetic */ uo b;
                        ...
                        switch (i24) {
                            case 0:
                                ...
                                if (tL_premium_boostsStatus == null) {
                                    ...
                                    uoVar3.M.getCheckBox().setIcon(tL_premium_boostsStatus.level < uoVar3.getMessagesController().channelAutotranslationLevelMin ? R.drawable.permission_locked : 0);
                                    break;
                                }
                            default:
            ...
            if (ChatObject.isMegagroup(uoVar.x0) && ChatObject.hasAdminRights(uoVar.x0) && !ChatObject.isCommunity(uoVar.x0)) {
                final int i25 = 1;
                MessagesController.getInstance(uoVar.currentAccount).getBoostsController().getBoostsStats(-uoVar.x0.id, new e2.h(uoVar) { // from class: org.telegram.ui.jo
                    public final /* synthetic */ uo b;
                ...
                hp0 hp0Var2 = new hp0(uoVar.currentAccount, -uoVar.x0.id, context4, uoVar.getResourceProvider());
                uoVar.L = hp0Var2;
                hp0Var2.setBackground(org.telegram.ui.ActionBar.j6.K0(true));
                uoVar.F.addView(uoVar.L, w7.y5.n(-1, -2));
                final int i26 = 20;
                uoVar.L.setOnClickListener(new View.OnClickListener(uoVar) { // from class: org.telegram.ui.eo
                    public final /* synthetic */ uo b;
            ...
            if (!uoVar.I0 && uoVar.x0.creator) {
                ...
                i10 = 6;
                uoVar.Q.setOnClickListener(new sf(i10, uoVar, frameLayout));
            } else {
                context2 = context;
                i10 = 6;
            }
        ...
        org.telegram.ui.ActionBar.z n10 = uoVar.actionBar.n();
        if (uoVar.D0 != null || ChatObject.canChangeChatInfo(uoVar.x0) || uoVar.N != null) {
        ...
        if (uoVar.H == null && uoVar.N == null && uoVar.I == null && uoVar.J == null && uoVar.Q == null) {
            i12 = 12;
        } else {
            i12 = 12;
        ...
        if (uoVar.D0 != null) {
            ...
            final int i36 = 7;
            uoVar.l0.setOnClickListener(new View.OnClickListener(uoVar) { // from class: org.telegram.ui.eo
                public final /* synthetic */ uo b;
            ...
            final int i37 = 9;
            uoVar.p0.setOnClickListener(new View.OnClickListener(uoVar) { // from class: org.telegram.ui.eo
                public final /* synthetic */ uo b;
            ...
            final int i38 = 10;
            uoVar.q0.setOnClickListener(new View.OnClickListener(uoVar) { // from class: org.telegram.ui.eo
                public final /* synthetic */ uo b;
            ...
            final int i39 = 11;
            uoVar.r0.setOnClickListener(new View.OnClickListener(uoVar) { // from class: org.telegram.ui.eo
                public final /* synthetic */ uo b;
        ...
        if (chat6 != null) {
            ...
            if (indexOf != -1) {
                valueOf.setSpan(new to(0), indexOf, indexOf + 10, 33);
            }
            ...
            if (user2.bot && user2.bot_can_edit) {
                ...
                final int i42 = 0;
                uoVar.m0.setOnClickListener(new View.OnClickListener(uoVar) { // from class: org.telegram.ui.go
                    public final /* synthetic */ uo b;
                        ...
                        switch (i42) {
                            case 0:
                                ...
                                if (g11.h(j11, false) != null) {
                                    uoVar3.presentFragment(new yh.g(1, j11));
                                    break;
                                }
                                break;
                            default:
                                ...
                                if (g11.h(j12, false) != null) {
                                    uoVar4.presentFragment(new yh.g(0, j12));
                                    break;
                                }
                                break;
                        }
                ...
                uoVar.n0.setOnClickListener(new View.OnClickListener(uoVar) { // from class: org.telegram.ui.go
                    public final /* synthetic */ uo b;
                ...
                chat = uoVar.x0;
                i13 = 14;
                if ((chat == null && chat.creator) || ((user = uoVar.D0) != null && user.bot && user.bot_can_edit)) {
                    final long j11 = chat != null ? chat.linked_community_id : uoVar.D0.linked_community_id;
                    final long j12 = chat != null ? -chat.id : uoVar.D0.id;
                    final boolean z17 = uoVar.D0 != null;
                    if (j11 != 0) {
                        gi.b bVar = new gi.b(context2, uoVar.resourceProvider);
                        uoVar.h0 = bVar;
                        bVar.a(uoVar.currentAccount, uoVar.getMessagesController().getChat(Long.valueOf(j11)));
                        final int i45 = 0;
                        uoVar.h0.setBackground(org.telegram.ui.ActionBar.j6.K0(false));
                        uoVar.h0.setOnClickListener(new View.OnClickListener(uoVar) { // from class: org.telegram.ui.ho
                            public final /* synthetic */ uo b;
                            ...
                            public final void onClick(View view) {
                                switch (i45) {
                                    case 0:
                                        uo uoVar3 = this.b;
                                        MessagesController messagesController = uoVar3.getMessagesController();
                                        long j13 = j11;
                                    ...
                                    default:
                                        ...
                                        uoVar4.presentFragment(new fi.f(bundle));
                                        break;
                                }
                            }
                        });
                        ...
                        final int i47 = 1;
                        uoVar2.g0.setOnClickListener(new View.OnClickListener(uoVar2) { // from class: org.telegram.ui.ho
                            public final /* synthetic */ uo b;
                ...
                if (chat2 != null && chat2.creator) {
                    ...
                    if (uoVar2.D0 == null) {
                        ...
                        uoVar2.d0.b(LocaleController.getString(R.string.ChannelDelete), false);
                    } else {
                        uoVar2.d0.b(LocaleController.getString(R.string.DeleteAndExitButton), false);
                    }
                    uoVar2.c0.addView(uoVar2.d0, w7.y5.c(f7, -1));
                    uoVar2.d0.setOnClickListener(new View.OnClickListener(uoVar2) { // from class: org.telegram.ui.eo
                        public final /* synthetic */ uo b;
                        ...
                        public final void onClick(View view) {
                            switch (i13) {
                                ...
                                case 1:
                                    ...
                                    if (!uoVar4.s.h()) {
                                        ImageLocation imageLocation = null;
                                        TLRPC.User user22 = j32 == 0 ? null : uoVar4.getMessagesController().getUser(Long.valueOf(j32));
                                        if (user22 == null) {
                                            TLRPC.Chat chat32 = uoVar4.getMessagesController().getChat(Long.valueOf(uoVar4.w0));
                                            TLRPC.ChatPhoto chatPhoto = chat32.photo;
                                            if (chatPhoto != null && chatPhoto.photo_big != null) {
                                            ...
                                            if (userProfilePhoto != null && userProfilePhoto.photo_big != null) {
                                                ...
                                                PhotoViewer.t1().e2(null, user22.photo.photo_big, null, null, null, null, null, 0, qoVar, null, 0L, 0L, 0L, true, null, null);
                                                break;
                                            }
                                        }
                                    }
                                ...
                                case 17:
                                    ...
                                    upVar.P = false;
                                    upVar.E = j112;
                                    TLRPC.Chat chat42 = upVar.getMessagesController().getChat(Long.valueOf(j112));
                                    upVar.f = chat42;
                                    if (ChatObject.isChannel(chat42) && !upVar.f.megagroup) {
                                        z162 = true;
                                    }
                                ...
                                case 23:
                                    ...
                                    if (ChatObject.isChannelAndNotMegaGroup(uoVar20.x0)) {
                                        ...
                                        if (chatFull9 != null) {
                                            if (bqVar.a == null) {
                                                bqVar.a = bqVar.getMessagesController().getChat(Long.valueOf(j122));
                                            }
                                            bqVar.d = new ArrayList();
                                            TLRPC.ChatReactions chatReactions = chatFull9.available_reactions;
                                            if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
                ...
                uoVar2.c = undoView;
                idVar.addView(undoView, w7.y5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
                org.telegram.ui.Components.ju juVar6 = uoVar2.v;
                TLRPC.User user3 = uoVar2.D0;
                juVar6.setText(Emoji.replaceEmoji(user3 == null ? ContactsController.formatName(user3) : uoVar2.x0.title, uoVar2.v.getEditText().getPaint().getFontMetricsInt(), true));
                org.telegram.ui.Components.ju juVar7 = uoVar2.v;
                juVar7.setSelection(juVar7.n());
                chatFull = uoVar2.y0;
                if (chatFull == null) {
                    uoVar2.E.setText(chatFull.about);
                } else {
                    TLRPC.UserFull userFull4 = uoVar2.E0;
                    if (userFull4 != null) {
                        uoVar2.E.setText(userFull4.about);
                    }
                }
                uoVar2.k0();
                uoVar2.p0(true, false);
                return uoVar2.fragmentView;
            }
        }
        num2 = num;
        chat = uoVar.x0;
        ...
        uoVar2.c = undoView2;
        idVar.addView(undoView2, w7.y5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        org.telegram.ui.Components.ju juVar62 = uoVar2.v;
        TLRPC.User user32 = uoVar2.D0;
        juVar62.setText(Emoji.replaceEmoji(user32 == null ? ContactsController.formatName(user32) : uoVar2.x0.title, uoVar2.v.getEditText().getPaint().getFontMetricsInt(), true));
        org.telegram.ui.Components.ju juVar72 = uoVar2.v;
    ...
    */
    ...
    public final void i0() {
        this.s.o(this.v0 != null, new mo(this, 0), new r5(this, 5), 0);
        this.R0.M(0);
        this.R0.P(43);
        this.b0.e.d();
    }
    ...
    public final void j0() {
        ...
        if (this.D0 != null) {
            ...
            this.b.setOnCancelListener(new ca(this, getConnectionsManager().sendRequest(setbotinfo, new oo(i10, this, setbotinfo)), 2));
            this.b.show();
            return;
        }
        if (!ChatObject.isChannel(this.x0) && (!this.J0 || this.F0)) {
            getMessagesController().convertToMegaGroup(getParentActivity(), this.w0, this, new lo(this, 5));
            return;
        }
        ...
        if (this.s.h()) {
            ...
            this.b = b2Var;
            b2Var.setOnCancelListener(new og(this, r0));
            this.b.show();
            return;
        }
        ...
        if (z12 != chat.forum || this.H0 != chat.forum_tabs) {
            ...
            if (this.F0 && !this.H0) {
                ...
                while (i10 < fragmentStack.size()) {
                    if ((fragmentStack.get(i10) instanceof zn) && ((zn) fragmentStack.get(i10)).getArguments().getLong("chat_id") == this.w0) {
    ...
    public final void q0() {
        ...
        while (i10 < fragmentStack.size()) {
            if (fragmentStack.get(i10) instanceof zn) {
                ...
                if (znVar.getArguments().getLong("chat_id") == this.w0) {
