...
public final class b31 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(b31 b31Var, View view, int i10) {
        ...
        if (!z10 || (arrayList = b31Var.f) == null) {
            ...
            language = (i10 < 0 || i10 >= b31Var.h.size()) ? null : (TranslateController.Language) b31Var.h.get(i10);
        } else {
        ...
        if (b31Var.r.contains(str)) {
            Collection.-EL.removeIf(b31Var.r, new z70(str, 2));
        } else {
            b31Var.r.add(str);
        }
        if (b31Var.r.size() == 1 && b31Var.r.contains(currentLocaleInfo.pluralLangCode)) {
            ...
            a0(b31Var.r, Boolean.TRUE);
        }
        if (z10) {
            int i13 = 0;
            while (i11 < b31Var.f.size()) {
                if (TextUtils.equals(str, ((TranslateController.Language) b31Var.f.get(i11)).code)) {
                    b31Var.Z(i13);
                }
                i11++;
                i13++;
    ...
    public final void Z(int i10) {
        ...
        for (int i11 = 0; i11 < this.b.getChildCount(); i11++) {
            f2.n1 T = this.b.T(this.b.getChildAt(i11));
    ...
    public final View createView(Context context) {
        ...
        this.b.setOnItemClickListener(new d21(this, 1));
