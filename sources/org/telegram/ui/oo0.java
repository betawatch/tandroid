...
public final class oo0 extends AsyncTask {
    ...
    */
    public final Object doInBackground(Object[] objArr) {
        ...
        try {
            if (yo0Var.C0.native_params != null) {
                try {
                    string = new JSONObject(yo0Var.C0.native_params.data).getString("tokenize_url");
                    if (string != null) {
                        try {
                ...
                httpURLConnection = (HttpURLConnection) (string == null ? new URL(string) : yo0Var.C0.invoice.test ? new URL("https://tgb-playground.smart-glocal.com/cds/v1/tokenize/card") : new URL("https://tgb.smart-glocal.com/cds/v1/tokenize/card")).openConnection();
                ...
                httpURLConnection.setRequestProperty("X-PUBLIC-TOKEN", yo0Var.j0);
