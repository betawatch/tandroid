...
public final class xx0 extends org.telegram.ui.Components.vl0 {
    ...
    public final int j(int i10) {
        ...
        return (i10 == yx0Var.h || i10 == yx0Var.v) ? 1 : 0;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 == 0) {
            ...
            long keyAt = yx0Var.getMessagesController().blockePeers.keyAt(i10 - yx0Var.r);
            ...
            if (keyAt <= 0) {
                ...
                if (chat != null) {
                    ...
                    b5Var.b(chat, null, i13 != 0 ? LocaleController.formatPluralString("Members", i13, new Object[0]) : chat.has_geo ? LocaleController.getString(R.string.MegaLocation) : !ChatObject.isPublic(chat) ? LocaleController.getString(R.string.MegaPrivate) : LocaleController.getString(R.string.MegaPublic), i10 != yx0Var.s - 1);
                    return;
                }
                return;
            }
            ...
            if (user != null) {
                ...
                b5Var.b(user, null, string, i10 != yx0Var.s - 1);
                return;
            }
            return;
        }
