    ...
    public final void run() {
        ...
        if (launchActivity.P() == null || launchActivity.P().k(b10) == null) {
            ...
            if (tL_messages_botApp.inactive || this.v) {
                ...
                AndroidUtilities.runOnUIThread(new ci.b9(18, k3Var, (z13 && tL_attachMenuBot.show_in_attach_menu) ? LocaleController.formatString(R.string.BotAttachMenuShortcatAddedAttachAndSide, user2.first_name) : z13 ? LocaleController.formatString(R.string.BotAttachMenuShortcatAddedSide, user2.first_name) : LocaleController.formatString(R.string.BotAttachMenuShortcatAddedAttach, user2.first_name)), 200L);
            }
        }
    }
}
