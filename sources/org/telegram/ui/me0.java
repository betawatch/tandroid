...
public final class me0 extends org.telegram.ui.Components.ev0 {
    ...
    */
    public me0(ig0 ig0Var, Context context) {
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                addView(this.a, h7.z5.t(-2, 42, 1, 0, 32, 0, 0));
        ...
        od0 od0Var2 = new od0(this, context, 1);
        this.a = od0Var2;
        od0Var2.b(6, 1);
        while (r12 < r11) {
        }
        ...
        sVar2.setMaxLines(2);
        sVar2.setOnClickListener(new u50(this, 6));
        FrameLayout frameLayout22 = new FrameLayout(context);
        frameLayout22.addView(sVar2, h7.z5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        addView(frameLayout22, h7.z5.l(1.0f, -1, 0));
        i6.q2(sVar2);
    }
    ...
    public final void h(String str) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_auth_checkRecoveryPassword, new v80(6, this, code), 10);
    }

    @Override // org.telegram.ui.Components.ev0
    public final void j() {
        AndroidUtilities.runOnUIThread(new ke0(this, 0), ig0.p0);
    }
