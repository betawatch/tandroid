...
public final class d80 extends DispatchQueue {
    ...
    public float r;
    public long s;
    public final org.telegram.ui.Components.bn0 v;
    public final w5 w;
    public final /* synthetic */ f80 x;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d80(f80 f80Var, SurfaceTexture surfaceTexture) {
        super("EGLThread");
        this.x = f80Var;
        this.n = new int[24];
        this.v = new org.telegram.ui.Components.bn0(23);
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            ...
            f80 f80Var = this.x;
            if (!this.b.eglChooseConfig(this.c, EmuDetector.with(f80Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                ...
                if (eglCreateContext == null) {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            c(new org.telegram.ui.Components.bn0(24), 22, false);
                            c(this.v, 23, false);
                            ...
                            f80Var.J = System.currentTimeMillis() - 1000;
                            z10 = true;
                        } else {
                            if (BuildVars.LOGS_ENABLED) {
