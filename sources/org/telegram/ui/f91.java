...
public final class f91 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40, dh0, le.d {
    ...
    public org.telegram.ui.Components.e61 c;
    public ci.s6 d;
    ...
    public static boolean U(f91 f91Var, org.telegram.ui.Components.i51 i51Var, View view) {
        Object obj = i51Var.G;
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            ei.k3.j(f91Var.currentAccount, ((TLRPC.TL_attachMenuBot) obj).bot_id, new s81(f91Var, 0));
            return true;
        }
        if (i51Var.G(org.telegram.ui.Cells.v6.class)) {
            Object obj2 = i51Var.G;
            String str = obj2 instanceof j11 ? ((j11) obj2).h : obj2 instanceof MessagesController.FaqSearchResult ? ((MessagesController.FaqSearchResult) obj2).url : null;
            if (!TextUtils.isEmpty(str)) {
                org.telegram.ui.Components.n70 H = org.telegram.ui.Components.n70.H(f91Var, view);
                H.c(R.drawable.msg_link2, LocaleController.getString(R.string.CopyLink), new iy0(24, f91Var, str), false);
                H.W(f91Var.c.V0(view, false));
                H.Z();
                return true;
            }
        }
    ...
    public static /* synthetic */ void V(f91 f91Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        TLRPC.TL_messages_toggleBotInAttachMenu tL_messages_toggleBotInAttachMenu = new TLRPC.TL_messages_toggleBotInAttachMenu();
        tL_messages_toggleBotInAttachMenu.bot = MessagesController.getInstance(f91Var.currentAccount).getInputUser(tL_attachMenuBot.bot_id);
        tL_messages_toggleBotInAttachMenu.enabled = true;
        tL_messages_toggleBotInAttachMenu.write_allowed = true;
        ConnectionsManager.getInstance(f91Var.currentAccount).sendRequest(tL_messages_toggleBotInAttachMenu, new bc0(23, f91Var, tL_attachMenuBot), 66);
    }

    public static /* synthetic */ void W(f91 f91Var) {
        TLRPC.User user = MessagesController.getInstance(f91Var.currentAccount).getUser(Long.valueOf(UserConfig.getInstance(f91Var.currentAccount).getClientUserId()));
        if (user == null) {
            user = UserConfig.getInstance(f91Var.currentAccount).getCurrentUser();
        }
        if (user == null) {
            return;
        }
        org.telegram.ui.Components.u40 u40Var = f91Var.n;
        TLRPC.UserProfilePhoto userProfilePhoto = user.photo;
        u40Var.o((userProfilePhoto == null || userProfilePhoto.photo_big == null || (userProfilePhoto instanceof TLRPC.TL_userProfilePhotoEmpty)) ? false : true, new s81(f91Var, 4), new ci.f1(6), 0);
    }

    public static /* synthetic */ void X(f91 f91Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        tL_attachMenuBot.side_menu_disclaimer_needed = false;
        tL_attachMenuBot.inactive = false;
        LaunchActivity.C0(LaunchActivity.G1, f91Var.currentAccount, tL_attachMenuBot, null, true);
        MediaDataController.getInstance(f91Var.currentAccount).updateAttachMenuBotsInCache();
    }
    ...
    */
    public static void Z(f91 f91Var) {
        String str;
        int i10;
        String string;
        String str2;
        ...
        if (i12 < 2 && !BuildVars.DEBUG_PRIVATE_VERSION) {
            try {
                Toast.makeText(f91Var.getParentActivity(), LocaleController.getString(R.string.DebugMenuLongPress), 0).show();
                return;
            } catch (Exception e) {
                FileLog.e(e);
                return;
        ...
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(f91Var.getParentActivity(), 0, f91Var.resourceProvider);
        ...
        String string15 = LocaleController.getString(ci.d1.q(f91Var.getParentActivity()) ? "DebugMenuDualOff" : "DebugMenuDualOn");
        ...
        String str19 = !SharedConfig.isUsingCamera2(f91Var.currentAccount) ? "Use Camera 2 API" : "Use old Camera 1 API";
        ...
        if (SharedConfig.canBlurChat()) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                alertDialog$Builder.f(charSequenceArr, new uv(f91Var, 3));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                f91Var.showDialog(b2Var);
            }
        } else {
            str4 = string2;
        }
        ...
        alertDialog$Builder.f(charSequenceArr2, new uv(f91Var, 3));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
        f91Var.showDialog(b2Var);
    }

    public static /* synthetic */ void a0(f91 f91Var, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        f91Var.actionBar.getTitlesContainer().setAlpha(floatValue);
        f91Var.d.setAlpha(floatValue);
    }

    public static void b0(f91 f91Var, ArrayList arrayList) {
        int i10;
        ArrayList<TLRPC.TL_attachMenuBot> arrayList2;
        ArrayList arrayList3 = f91Var.R;
        org.telegram.ui.ActionBar.q0 q0Var = f91Var.e.F;
        int i11 = 0;
        if (q0Var != null && q0Var.getTag() != null) {
            ...
            x81 x81Var = f91Var.h;
            ArrayList arrayList4 = x81Var.d;
            ArrayList arrayList5 = x81Var.v;
            if (x81Var.w) {
                ArrayList arrayList6 = x81Var.r;
                ...
                while (i13 < size) {
                    ...
                    i13++;
                    int i14 = i12 + 1;
                    CharSequence charSequence = (CharSequence) x81Var.n.get(i12);
                    int i15 = org.telegram.ui.Cells.v6.a;
                    org.telegram.ui.Components.i51 J = org.telegram.ui.Components.i51.J(org.telegram.ui.Cells.v6.class);
                    J.l = charSequence;
                    J.G = (j11) obj;
                    arrayList.add(J);
                    i12 = i14;
                ...
                ArrayList arrayList7 = x81Var.s;
                int size2 = arrayList7.size();
                while (i11 < size2) {
                    Object obj2 = arrayList7.get(i11);
                    i11++;
                    int i16 = i12 + 1;
                    CharSequence charSequence2 = (CharSequence) x81Var.n.get(i12);
                    int i17 = org.telegram.ui.Cells.v6.a;
                    org.telegram.ui.Components.i51 J2 = org.telegram.ui.Components.i51.J(org.telegram.ui.Cells.v6.class);
                    J2.l = charSequence2;
            ...
            if (!arrayList5.isEmpty()) {
                ...
                while (i18 < size3) {
                    ...
                    i18++;
                    if (obj3 instanceof j11) {
                        j11 j11Var = (j11) obj3;
                        String str = j11Var.a;
                        int i19 = org.telegram.ui.Cells.v6.a;
                        org.telegram.ui.Components.i51 J3 = org.telegram.ui.Components.i51.J(org.telegram.ui.Cells.v6.class);
                        J3.l = str;
                        J3.G = j11Var;
                        arrayList.add(J3);
                        ...
                        org.telegram.ui.Components.i51 J4 = org.telegram.ui.Components.i51.J(org.telegram.ui.Cells.v6.class);
                        J4.l = str2;
            ...
            while (i11 < size4) {
                ...
                org.telegram.ui.Components.i51 J5 = org.telegram.ui.Components.i51.J(org.telegram.ui.Cells.v6.class);
                J5.l = str3;
        ...
        FrameLayout frameLayout = f91Var.x;
        ...
        while (true) {
            ...
            if (UserConfig.getInstance(i22).isClientActivated() && f91Var.currentAccount != i22) {
                arrayList3.add(Integer.valueOf(i22));
            }
            i22++;
        }
        Collections.sort(arrayList3, new df(29));
        Set<String> set = f91Var.getMessagesController().pendingSuggestions;
        int i23 = 1;
        if (set.contains("PREMIUM_GRACE")) {
            arrayList.add(d91.a(LocaleController.getString(R.string.GraceSuggestionTitle), LocaleController.getString(R.string.GraceSuggestionMessage), null, null, LocaleController.getString(R.string.GraceSuggestionButton), new t81(f91Var, i11)));
            arrayList.add(org.telegram.ui.Components.i51.B(null));
        } else if (set.contains("VALIDATE_PHONE_NUMBER") && f91Var.getUserConfig().getCurrentUser() != null) {
            arrayList.add(d91.a(LocaleController.formatString(R.string.CheckPhoneNumber, org.telegram.messenger.vl.h(new StringBuilder("+"), f91Var.getUserConfig().getCurrentUser().phone, gf.b.c())), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.CheckPhoneNumberInfo), new s81(f91Var, i23)), LocaleController.getString(R.string.CheckPhoneNumberNo), new t81(f91Var, i23), yh.z3.g2(LocaleController.getString(R.string.CheckPhoneNumberYes2)), new t81(f91Var, 2)));
            arrayList.add(org.telegram.ui.Components.i51.B(null));
        } else if (set.contains("VALIDATE_PASSWORD")) {
            arrayList.add(d91.a(LocaleController.getString(R.string.YourPasswordHeader), LocaleController.getString(R.string.YourPasswordRemember), LocaleController.getString(R.string.YourPasswordRememberNo), new t81(f91Var, 3), LocaleController.getString(R.string.YourPasswordRememberYes), new t81(f91Var, i10)));
            arrayList.add(org.telegram.ui.Components.i51.B(null));
        }
        if (arrayList3.size() > 0) {
            ...
            for (int i24 = 0; i24 < arrayList3.size(); i24++) {
                ...
                int i25 = z81.a;
                org.telegram.ui.Components.i51 J6 = org.telegram.ui.Components.i51.J(z81.class);
                J6.d = i24;
                J6.z = intValue;
                arrayList.add(J6);
            }
        ...
        arrayList.add(b91.a(1, -14899731, -15431455, R.drawable.settings_account, LocaleController.getString(R.string.SettingsAccount), LocaleController.getString(R.string.SettingsAccountInfo), null));
        arrayList.add(b91.a(2, -1007845, -1996271, R.drawable.settings_chat, LocaleController.getString(R.string.SettingsChat), LocaleController.getString(R.string.SettingsChatInfo), null));
        arrayList.add(b91.a(3, -11154873, -14175180, R.drawable.settings_privacy, LocaleController.getString(R.string.SettingsPrivacySecurity), LocaleController.getString(R.string.SettingsPrivacySecurityInfo), null));
        arrayList.add(b91.a(5, -765355, -2148011, R.drawable.settings_sounds, LocaleController.getString(R.string.SettingsNotifications), LocaleController.getString(R.string.SettingsNotificationsInfo), null));
        arrayList.add(b91.a(6, -11565578, -13276952, R.drawable.settings_data, LocaleController.getString(R.string.SettingsData), LocaleController.getString(R.string.SettingsDataInfo), null));
        arrayList.add(b91.a(7, -14899731, -15497247, R.drawable.settings_folders, LocaleController.getString(R.string.SettingsFolders), LocaleController.getString(R.string.SettingsFoldersInfo), null));
        arrayList.add(b91.a(8, -13451058, -14836538, R.drawable.settings_devices, LocaleController.getString(R.string.SettingsDevices), LocaleController.getString(R.string.SettingsDevicesInfo), null));
        arrayList.add(b91.a(9, -881871, -1940716, R.drawable.settings_power, LocaleController.getString(R.string.SettingsPowerSaving), LocaleController.getString(R.string.SettingsPowerSavingInfo), null));
        arrayList.add(b91.a(10, -3903756, -6335009, R.drawable.settings_language, LocaleController.getString(R.string.SettingsLanguage), LocaleController.getCurrentLanguageName(), null));
        arrayList.add(org.telegram.ui.Components.i51.B(null));
        if (!f91Var.getMessagesController().premiumFeaturesBlocked()) {
            arrayList.add(b91.a(11, -4826625, -10388225, R.drawable.settings_premium, LocaleController.getString(R.string.TelegramPremium), null, null));
        }
        CharSequence charSequence3 = "";
        if (f91Var.getMessagesController().starsPurchaseAvailable()) {
            yh.u5 y3 = yh.u5.y(f91Var.currentAccount, false);
            arrayList.add(b91.a(12, -1071598, -1608430, R.drawable.settings_stars, LocaleController.getString(R.string.TelegramStars), null, (!y3.e || y3.p().amount <= 0) ? "" : yh.x7.J0(y3.p(), 0.85f, ' ')));
        }
        yh.u5.y(f91Var.currentAccount, true).p();
        if (ApplicationLoader.isBetaBuild() || ApplicationLoader.isStandaloneBuild() || ApplicationLoader.isHuaweiStoreBuild() || (yh.u5.y(f91Var.currentAccount, true).e && (yh.u5.y(f91Var.currentAccount, true).O(0) || yh.u5.y(f91Var.currentAccount, true).p().positive()))) {
            yh.u5 y10 = yh.u5.y(f91Var.currentAccount, true);
            long j3 = y10.p().amount;
            int i26 = R.drawable.settings_gram_24;
            String string = LocaleController.getString(R.string.MyTON);
            if (y10.e && j3 > 0) {
                charSequence3 = yh.x7.J0(y10.p(), 0.85f, ' ');
            }
            arrayList.add(b91.a(13, -14965523, -15431455, i26, string, null, charSequence3));
        }
        ...
        if (attachMenuBots != null && (arrayList2 = attachMenuBots.bots) != null && !arrayList2.isEmpty()) {
            ...
            while (i11 < size5) {
                ...
                if (tL_attachMenuBot2.show_in_side_menu && tL_attachMenuBot2.bot_id == 1985737506) {
                    ...
                    org.telegram.ui.Components.i51 J7 = org.telegram.ui.Components.i51.J(b91.class);
        ...
        if (!f91Var.getMessagesController().premiumFeaturesBlocked()) {
            arrayList.add(b91.a(15, -765355, -2148011, R.drawable.settings_business, LocaleController.getString(R.string.TelegramBusiness), null, null));
        }
        if (!f91Var.getMessagesController().premiumPurchaseBlocked()) {
            arrayList.add(b91.a(16, -816335, -1940716, R.drawable.settings_gift, LocaleController.getString(R.string.SendAGift), null, null));
        }
        if (((org.telegram.ui.Components.i51) hg.c.h(1, arrayList)).a != 7) {
            arrayList.add(org.telegram.ui.Components.i51.B(null));
        }
        com.google.android.gms.internal.vision.e2.n(R.string.SettingsHelp, arrayList);
        arrayList.add(b91.a(17, -1007845, -1996271, R.drawable.settings_ask, LocaleController.getString(R.string.AskAQuestion), null, null));
        arrayList.add(b91.a(18, -14965523, -15431455, R.drawable.settings_faq, LocaleController.getString(R.string.TelegramFAQ), null, null));
        arrayList.add(b91.a(23, -3903756, -6335009, R.drawable.settings_features, LocaleController.getString(R.string.TelegramFeatures), null, null));
        arrayList.add(b91.a(19, -11154873, -14175180, R.drawable.settings_policy, LocaleController.getString(R.string.PrivacyPolicy), null, null));
        if (BuildVars.LOGS_ENABLED || BuildVars.DEBUG_PRIVATE_VERSION) {
            arrayList.add(org.telegram.ui.Components.i51.B(null));
            com.google.android.gms.internal.vision.e2.n(R.string.SettingsDebug, arrayList);
            arrayList.add(b91.a(20, -11154873, -14175180, 0, LocaleController.getString(R.string.DebugSendLogs), null, null));
            arrayList.add(b91.a(21, -11154873, -14175180, 0, LocaleController.getString(R.string.DebugSendLastLogs), null, null));
            arrayList.add(b91.a(22, -765355, -2148011, 0, LocaleController.getString(R.string.DebugClearLogs), null, null));
        }
        arrayList.add(org.telegram.ui.Components.i51.l(f91Var.L));
    }

    public static /* synthetic */ void c0(f91 f91Var, TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        f91Var.U = -1;
        if (tL_error == null) {
            TLRPC.User user = f91Var.getMessagesController().getUser(Long.valueOf(f91Var.getUserConfig().getClientUserId()));
            if (user == null) {
                user = f91Var.getUserConfig().getCurrentUser();
                if (user == null) {
                    return;
                } else {
                    f91Var.getMessagesController().putUser(user, false);
                }
            } else {
                f91Var.getUserConfig().setCurrentUser(user);
            }
            ...
            if (closestPhotoSizeWithSize != null && f91Var.v != null) {
                FileLoader.getInstance(f91Var.currentAccount).getPathToAttach(f91Var.v, true).renameTo(FileLoader.getInstance(f91Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize, true));
                StringBuilder sb2 = new StringBuilder();
                sb2.append(f91Var.v.volume_id);
                sb2.append("_");
                String o9 = a4.a.o(f91Var.v.local_id, "@90_90", sb2);
                StringBuilder sb3 = new StringBuilder();
                sb3.append(closestPhotoSizeWithSize.location.volume_id);
                sb3.append("_");
                ImageLoader.getInstance().replaceImageInCache(o9, a4.a.o(closestPhotoSizeWithSize.location.local_id, "@90_90", sb3), ImageLocation.getForUserOrChat(f91Var.currentAccount, user, 1), false);
            }
            if (closestVideoSizeWithSize != null && str != null) {
                new File(str).renameTo(FileLoader.getInstance(f91Var.currentAccount).getPathToAttach(closestVideoSizeWithSize, "mp4", true));
            } else if (closestPhotoSizeWithSize2 != null && f91Var.w != null) {
                FileLoader.getInstance(f91Var.currentAccount).getPathToAttach(f91Var.w, true).renameTo(FileLoader.getInstance(f91Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize2, true));
            }
            f91Var.getMessagesController().getDialogPhotos(user.id).addPhotoAtStart(tL_photos_photo.photo);
            ArrayList arrayList2 = new ArrayList();
            arrayList2.add(user);
            f91Var.getMessagesStorage().putUsersAndChats(arrayList2, null, false, true);
            TLRPC.UserFull userFull = f91Var.getMessagesController().getUserFull(f91Var.getUserConfig().getClientUserId());
            if (userFull != null) {
                userFull.profile_photo = tL_photos_photo.photo;
                f91Var.getMessagesStorage().updateUserInfo(userFull, false);
            }
            f91Var.m0(user);
        }
        f91Var.v = null;
        f91Var.w = null;
        f91Var.n0(false, true);
        f91Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.updateInterfaces, Integer.valueOf(MessagesController.UPDATE_MASK_ALL));
        f91Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.mainUserInfoChanged, new Object[0]);
        f91Var.getUserConfig().saveConfig(true);
    }

    public static void d0(f91 f91Var, int i10) {
        long j3;
        Long l4;
        int i11 = 1;
        int i12 = 0;
        if (i10 == 0) {
            f91Var.getUserConfig().syncContacts = true;
            f91Var.getUserConfig().saveConfig(false);
            f91Var.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            f91Var.getContactsController().loadContacts(false, 0L);
            return;
        }
        if (i10 == 2) {
            f91Var.getContactsController().resetImportedContacts();
            return;
        }
        if (i10 == 3) {
            f91Var.getMessagesController().forceResetDialogs();
            return;
        }
        if (i10 == 4) {
        ...
        if (i10 == 6) {
            f91Var.getMessagesStorage().clearSentMedia();
            SharedConfig.setNoSoundHintShowed(false);
            org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(org.telegram.messenger.y0.d(MessagesController.getGlobalMainSettings().edit().remove("archivehint").remove("proximityhint").remove("archivehint_l"), "searchpostsnew", "speedhint", "gifhint", "reminderhint"), "soundHint", "themehint", "bganimationhint", "filterhint"), "n_0", "storyprvhint", "storyhint", "storyhint2"), "storydualhint", "storysvddualhint", "stories_camera", "dualcam"), "dualmatrix", "dual_available", "archivehint", "askNotificationsAfter"), "askNotificationsDuration", "viewoncehint", "voicepausehint", "taptostorysoundhint"), "nothanos", "voiceoncehint", "savedhint", "savedsearchhint"), "savedsearchtaghint", "newppsms", "monetizationadshint", "seekSpeedHintShowed"), "unsupport_video/av01", "statusgiftpage", "multistorieshint", "trimvoicehint"), "taptostoryhighlighthint", "proxycheckstatusip", "callmiconstart", "showchattagsinfo").remove("language_showed2").remove("aihintshown").remove("savedmsgschatshint").apply();
            w7.w5.a();
            SharedPrefsHelper.cleanupAccount(f91Var.currentAccount);
            MessagesController.getEmojiSettings(f91Var.currentAccount).edit().remove("featured_hidden").remove("emoji_featured_hidden").commit();
            ...
            ChatThemeController.getInstance(f91Var.currentAccount).clearCache();
            f91Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            f41.W();
            pg.s0.e(f91Var.currentAccount).a();
            SharedPreferences mainSettings = f91Var.getMessagesController().getMainSettings();
            SharedPreferences.Editor edit = mainSettings.edit();
            org.telegram.messenger.y0.d(edit, "peerColors", "profilePeerColors", "boostingappearance", "bizbothint").remove("movecaptionhint");
            ...
            edit.apply();
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(f91Var.currentAccount).edit();
            for (String str2 : MessagesController.getNotificationsSettings(f91Var.currentAccount).getAll().keySet()) {
        ...
        if (i10 == 7) {
            org.telegram.ui.Components.voip.f2.i(f91Var.getParentActivity());
            return;
        }
        if (i10 == 8) {
        ...
        if (i10 == 9) {
            ((LaunchActivity) f91Var.getParentActivity()).z(true);
            return;
        }
        if (i10 == 10) {
            f91Var.getMessagesStorage().readAllDialogs(-1);
            return;
        }
        if (i10 == 11) {
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(f91Var.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 == 18) {
                w7.x.a((LaunchActivity) f91Var.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
                f91Var.getMessagesController().loadAppConfig();
                TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                f91Var.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new u81(f91Var, i12));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                ...
                if (i10 == 23) {
                    boolean q6 = ci.d1.q(f91Var.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Toast.makeText(f91Var.getParentActivity(), LocaleController.getString(!q6 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i12 < f91Var.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.n2) f91Var.getParentLayout().getFragmentStack().get(i12)).clearSheets();
                        i12++;
                    }
                    return;
                }
                ...
                if (i10 == 27) {
                    f91Var.getMediaDataController().loadAttachMenuBots(false, true);
                    return;
                }
                if (i10 == 28) {
                    SharedConfig.toggleUseCamera2(f91Var.currentAccount);
                    return;
                }
                if (i10 == 29) {
                    ei.r.b();
                ...
                if (i10 == 35) {
                    MessagesController.getInstance(f91Var.currentAccount).loadAppConfig(true);
                    return;
                }
                if (i10 == 36) {
            ...
            f91Var.showDialog(new y81(f91Var, f91Var.getParentActivity(), sb3.toString()));
        } catch (Exception unused) {
        }
    }

    public static /* synthetic */ void e0(f91 f91Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            TLRPC.FileLocation fileLocation = photoSize.location;
            f91Var.v = fileLocation;
            f91Var.w = photoSize2.location;
            f91Var.F.h(ImageLocation.getForLocal(fileLocation), "90_90", f91Var.E, null);
            f91Var.n0(true, false);
        } else {
            if (f91Var.v == null) {
                return;
            }
            ...
            f91Var.U = f91Var.getConnectionsManager().sendRequest(tL_photos_uploadProfilePhoto, new bc0(22, f91Var, str));
        }
        f91Var.actionBar.n().requestLayout();
    }

    public static void f0(f91 f91Var, org.telegram.ui.Components.i51 i51Var) {
        Object obj = i51Var.G;
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            TLRPC.TL_attachMenuBot tL_attachMenuBot = (TLRPC.TL_attachMenuBot) obj;
            if (tL_attachMenuBot.inactive || tL_attachMenuBot.side_menu_disclaimer_needed) {
                mj1.a(f91Var.getParentActivity(), new ai.g3(10, f91Var, tL_attachMenuBot), null);
                return;
            } else {
                LaunchActivity.C0(LaunchActivity.G1, f91Var.currentAccount, tL_attachMenuBot, null, true);
            }
        }
        if (i51Var.G(z81.class)) {
            int i10 = i51Var.z;
            LaunchActivity launchActivity = LaunchActivity.G1;
            if (launchActivity != null) {
        ...
        if (i51Var.G(org.telegram.ui.Cells.v6.class)) {
            ...
            if (obj2 instanceof j11) {
                j11 j11Var = (j11) obj2;
                org.telegram.ui.ActionBar.d5 parentLayout = f91Var.getParentLayout();
                j11Var.b.run();
                AndroidUtilities.scrollToFragmentRow(parentLayout, j11Var.c);
            } else if (obj2 instanceof MessagesController.FaqSearchResult) {
                NotificationCenter.getInstance(f91Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.openArticle, f91Var.h.E, ((MessagesController.FaqSearchResult) obj2).url);
            }
        ...
        switch (i51Var.d) {
            case 1:
                f91Var.l0(new UserInfoActivity());
                break;
            case 2:
                f91Var.l0(new ThemeActivity(0));
                break;
            case 3:
                f91Var.l0(new PrivacySettingsActivity());
                break;
            case 5:
                f91Var.l0(new NotificationsSettingsActivity());
                break;
            case 6:
                f91Var.l0(new DataSettingsActivity());
                break;
            case 7:
                f91Var.l0(new FiltersSetupActivity());
                break;
            case 8:
                f91Var.l0(new SessionsActivity(0));
                break;
            case 9:
                f91Var.l0(new nc0());
                break;
            case 10:
                f91Var.l0(new LanguageSelectActivity());
                break;
            case 11:
                f91Var.l0(new PremiumPreviewFragment(0, "settings"));
                break;
            case 12:
                f91Var.l0(new yh.x7());
                break;
            case 13:
                ...
                break;
            case 15:
                f91Var.l0(new PremiumPreviewFragment(1, "settings"));
                break;
            case 16:
                tg.n1.e0(0, BirthdayController.getInstance(UserConfig.selectedAccount).getState());
                break;
            case 17:
                f91Var.showDialog(org.telegram.ui.Components.c5.U(f91Var, f91Var.resourceProvider));
                break;
            case 18:
                nf.f.s(f91Var.getParentActivity(), LocaleController.getString(R.string.TelegramFaqUrl));
                break;
            case 19:
                nf.f.s(f91Var.getParentActivity(), LocaleController.getString(R.string.PrivacyPolicyUrl));
                break;
            case 20:
                ProfileActivity.H4(f91Var.getParentActivity(), false);
                break;
            case 21:
                ProfileActivity.H4(f91Var.getParentActivity(), true);
                break;
            case 22:
                FileLog.cleanupLogs();
                break;
            case 23:
                if (!MessagesController.getInstance(f91Var.currentAccount).isFrozen()) {
                    nf.f.s(f91Var.getParentActivity(), LocaleController.getString(R.string.TelegramFeaturesUrl));
                    break;
                } else {
                    b.b(f91Var.currentAccount);
                    break;
                }
        }
    }
    ...
    public final View createView(Context context) {
        ...
        int i10 = 0;
        this.actionBar.setActionBarMenuOnItemClick(new w81(this, i10));
        ...
        x81 x81Var = new x81(this, this, context);
        this.h = x81Var;
        x81Var.G();
        org.telegram.ui.Components.e61 e61Var = new org.telegram.ui.Components.e61(this, new b5(this, 26), new v81(this), new v81(this));
        this.c = e61Var;
        e61Var.Y2.r = false;
        e61Var.p1();
        ...
        this.c.j(new h3(this, 28));
        org.telegram.ui.Components.e61 e61Var2 = this.c;
        w8 w8Var = this.b;
        Objects.requireNonNull(e61Var2);
        this.Y = new ah.n(e61Var2, w8Var, new v8(e61Var2, i10));
        this.c.C0(new s81(this, 2));
        this.b.addView(this.c, w7.x5.e(-1, -1, 119));
        ci.s6 s6Var = new ci.s6(this, context);
        this.d = s6Var;
        this.b.addView(s6Var, w7.x5.e(-1, 200, 48));
        ...
        this.y.setOnClickListener(new t81(this, 5));
        w7.z5.a(this.y);
        ...
        TextView f7 = org.telegram.ui.Cells.q3.f(this.x, this.J, w7.x5.d(-1, -2.0f, 49, 16.0f, 126.33299f, 16.0f, 0.0f), context);
        this.K = f7;
        f7.setTextSize(1, 13.0f);
        this.K.setGravity(17);
        this.K.setSingleLine();
        this.K.setEllipsize(truncateAt);
        TextView f10 = org.telegram.ui.Cells.q3.f(this.x, this.K, w7.x5.d(-1, -2.0f, 49, 0.0f, 156.0f, 0.0f, 0.0f), context);
        this.L = f10;
        ...
        this.L.setBackground(org.telegram.ui.ActionBar.i6.f0(getThemedColor(org.telegram.ui.ActionBar.i6.i6), 2, -1));
        this.L.setOnClickListener(new t81(this, 6));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        org.telegram.ui.Components.e61 e61Var;
        ...
        if (i10 == NotificationCenter.updateInterfaces) {
            ...
            if (i10 != NotificationCenter.newSuggestionsAvailable || (e61Var = this.c) == null) {
                return;
            }
            e61Var.Y2.N(true);
        }
    ...
    public final void n0(boolean z10, boolean z11) {
        ...
        this.r.addListener(new h70(9, this, z10));
        this.r.start();
    }
    ...
    */
    public final void o0(boolean z10, boolean z11) {
        ...
        if (q0Var == null || q0Var.getTag() == null) {
            ...
            if (this.P == z12 || z10) {
                ...
                this.Q = ofFloat;
                ofFloat.addUpdateListener(new a21(this, 11));
                this.Q.setInterpolator(org.telegram.ui.Components.qr.h);
    ...
    public final void p0() {
        ...
        this.N.setBackground(new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{org.telegram.ui.ActionBar.i6.l1(0.0f, themedColor), themedColor}));
        this.d.invalidate();
        this.c.invalidate();
    }
    ...
    public f91(Bundle bundle) {
        super(bundle);
        this.a = new le.b(0, this, org.telegram.ui.Components.qr.h, 350L, false);
        this.O = 0;
