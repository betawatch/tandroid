...
public final class f91 implements TextWatcher {
    ...
    public final /* synthetic */ org.telegram.ui.Components.bd0 d;
    ...
    */
    public final void afterTextChanged(Editable editable) {
        double d;
        org.telegram.ui.Components.bd0 bd0Var = this.d;
        int i10 = this.b;
        ...
        try {
            ...
            try {
                ...
                if (d > d10) {
                    ...
                    int i11 = -iArr[0];
                    iArr[0] = i11;
                    AndroidUtilities.shakeViewSpring(bd0Var, i11);
                    ...
                    int i12 = -iArr[0];
                    iArr[0] = i12;
                    AndroidUtilities.shakeViewSpring(bd0Var, i12);
                }
                ...
                editTextBoldCursor.setSelection(editTextBoldCursor.getText().length());
                this.a = false;
                bd0Var.c(editTextBoldCursor.isFocused(), !TextUtils.isEmpty(editTextBoldCursor.getText()));
