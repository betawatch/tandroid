...
public final class f91 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40, eh0, le.d {
    ...
    public static boolean U(f91 f91Var, org.telegram.ui.Components.x51 x51Var, View view) {
        Object obj = x51Var.G;
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            ei.k3.j(f91Var.currentAccount, ((TLRPC.TL_attachMenuBot) obj).bot_id, new r81(f91Var, 0));
            return true;
        }
        if (x51Var.G(org.telegram.ui.Cells.w6.class)) {
            Object obj2 = x51Var.G;
            String str = obj2 instanceof i11 ? ((i11) obj2).h : obj2 instanceof MessagesController.FaqSearchResult ? ((MessagesController.FaqSearchResult) obj2).url : null;
            if (!TextUtils.isEmpty(str)) {
                org.telegram.ui.Components.w70 H = org.telegram.ui.Components.w70.H(f91Var, view);
                H.c(R.drawable.msg_link2, LocaleController.getString(R.string.CopyLink), new cy0(28, f91Var, str), false);
                H.W(f91Var.c.W0(view, false));
                H.Z();
                return true;
            }
        }
    ...
    public static /* synthetic */ void V(f91 f91Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        ...
        ConnectionsManager.getInstance(f91Var.currentAccount).sendRequest(tL_messages_toggleBotInAttachMenu, new cc0(23, f91Var, tL_attachMenuBot), 66);
    }
    ...
    public static /* synthetic */ void W(f91 f91Var) {
        ...
        u40Var.o((userProfilePhoto == null || userProfilePhoto.photo_big == null || (userProfilePhoto instanceof TLRPC.TL_userProfilePhotoEmpty)) ? false : true, new r81(f91Var, 4), new ci.f1(6), 0);
    }
    ...
    */
    public static void Z(f91 f91Var) {
        ...
        if (SharedConfig.canBlurChat()) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                alertDialog$Builder.f(charSequenceArr, new vv(f91Var, 3));
        ...
        alertDialog$Builder.f(charSequenceArr2, new vv(f91Var, 3));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
        f91Var.showDialog(b2Var);
    }
    ...
    public static void b0(f91 f91Var, ArrayList arrayList) {
        ...
        if (q0Var != null && q0Var.getTag() != null) {
            ...
            w81 w81Var = f91Var.h;
            ArrayList arrayList4 = w81Var.d;
            ArrayList arrayList5 = w81Var.v;
            if (w81Var.w) {
                ArrayList arrayList6 = w81Var.r;
                ...
                while (i13 < size) {
                    ...
                    i13++;
                    int i14 = i12 + 1;
                    CharSequence charSequence = (CharSequence) w81Var.n.get(i12);
                ...
                ArrayList arrayList7 = w81Var.s;
                int size2 = arrayList7.size();
                while (i11 < size2) {
                    Object obj2 = arrayList7.get(i11);
                    i11++;
                    int i16 = i12 + 1;
                    CharSequence charSequence2 = (CharSequence) w81Var.n.get(i12);
        ...
        if (set.contains("PREMIUM_GRACE")) {
            arrayList.add(d91.a(LocaleController.getString(R.string.GraceSuggestionTitle), LocaleController.getString(R.string.GraceSuggestionMessage), null, null, LocaleController.getString(R.string.GraceSuggestionButton), new s81(f91Var, i11)));
            ...
            arrayList.add(d91.a(LocaleController.formatString(R.string.CheckPhoneNumber, org.telegram.messenger.wh.g(new StringBuilder("+"), f91Var.getUserConfig().getCurrentUser().phone, gf.b.c())), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.CheckPhoneNumberInfo), new r81(f91Var, i23)), LocaleController.getString(R.string.CheckPhoneNumberNo), new s81(f91Var, i23), yh.y3.g2(LocaleController.getString(R.string.CheckPhoneNumberYes2)), new s81(f91Var, 2)));
            arrayList.add(org.telegram.ui.Components.x51.B(null));
        } else if (set.contains("VALIDATE_PASSWORD")) {
            arrayList.add(d91.a(LocaleController.getString(R.string.YourPasswordHeader), LocaleController.getString(R.string.YourPasswordRemember), LocaleController.getString(R.string.YourPasswordRememberNo), new s81(f91Var, 3), LocaleController.getString(R.string.YourPasswordRememberYes), new s81(f91Var, i10)));
            arrayList.add(org.telegram.ui.Components.x51.B(null));
        }
        if (arrayList3.size() > 0) {
            ...
            for (int i24 = 0; i24 < arrayList3.size(); i24++) {
                ...
                int i25 = z81.a;
                org.telegram.ui.Components.x51 J6 = org.telegram.ui.Components.x51.J(z81.class);
                J6.d = i24;
                J6.z = intValue;
                arrayList.add(J6);
            }
        ...
        if (f91Var.getMessagesController().starsPurchaseAvailable()) {
            yh.t5 y3 = yh.t5.y(f91Var.currentAccount, false);
            arrayList.add(b91.a(12, -1071598, -1608430, R.drawable.settings_stars, LocaleController.getString(R.string.TelegramStars), null, (!y3.e || y3.p().amount <= 0) ? "" : yh.v7.J0(y3.p(), 0.85f, ' ')));
        }
        yh.t5.y(f91Var.currentAccount, true).p();
        if (ApplicationLoader.isBetaBuild() || ApplicationLoader.isStandaloneBuild() || ApplicationLoader.isHuaweiStoreBuild() || (yh.t5.y(f91Var.currentAccount, true).e && (yh.t5.y(f91Var.currentAccount, true).O(0) || yh.t5.y(f91Var.currentAccount, true).p().positive()))) {
            yh.t5 y10 = yh.t5.y(f91Var.currentAccount, true);
            long j3 = y10.p().amount;
            int i26 = R.drawable.settings_gram_24;
            String string = LocaleController.getString(R.string.MyTON);
            if (y10.e && j3 > 0) {
                charSequence3 = yh.v7.J0(y10.p(), 0.85f, ' ');
            }
        ...
        if (attachMenuBots != null && (arrayList2 = attachMenuBots.bots) != null && !arrayList2.isEmpty()) {
            ...
            while (i11 < size5) {
                ...
                if (tL_attachMenuBot2.show_in_side_menu && tL_attachMenuBot2.bot_id == 1985737506) {
                    ...
                    org.telegram.ui.Components.x51 J7 = org.telegram.ui.Components.x51.J(b91.class);
        ...
        if (((org.telegram.ui.Components.x51) hg.k0.g(1, arrayList)).a != 7) {
            arrayList.add(org.telegram.ui.Components.x51.B(null));
        }
        ...
        arrayList.add(org.telegram.ui.Components.x51.l(f91Var.L));
    }
    ...
    public static /* synthetic */ void c0(f91 f91Var, TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        ...
        if (tL_error == null) {
            ...
            if (closestPhotoSizeWithSize != null && f91Var.v != null) {
                ...
                sb2.append("_");
                String n10 = a4.a.n(f91Var.v.local_id, "@90_90", sb2);
                StringBuilder sb3 = new StringBuilder();
                sb3.append(closestPhotoSizeWithSize.location.volume_id);
                sb3.append("_");
                ImageLoader.getInstance().replaceImageInCache(n10, a4.a.n(closestPhotoSizeWithSize.location.local_id, "@90_90", sb3), ImageLocation.getForUserOrChat(f91Var.currentAccount, user, 1), false);
            }
    ...
    public static void d0(f91 f91Var, int i10) {
        ...
        if (i10 == 6) {
            ...
            e41.W();
            pg.u0.e(f91Var.currentAccount).a();
        ...
        try {
            ...
            if (i10 == 18) {
                w7.y.a((LaunchActivity) f91Var.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
                ...
                f91Var.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new t81(f91Var, i12));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
    ...
    public static /* synthetic */ void e0(f91 f91Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            ...
            f91Var.U = f91Var.getConnectionsManager().sendRequest(tL_photos_uploadProfilePhoto, new cc0(22, f91Var, str));
        }
        f91Var.actionBar.n().requestLayout();
    }

    public static void f0(f91 f91Var, org.telegram.ui.Components.x51 x51Var) {
        Object obj = x51Var.G;
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            TLRPC.TL_attachMenuBot tL_attachMenuBot = (TLRPC.TL_attachMenuBot) obj;
            if (tL_attachMenuBot.inactive || tL_attachMenuBot.side_menu_disclaimer_needed) {
                kj1.a(f91Var.getParentActivity(), new ai.g3(10, f91Var, tL_attachMenuBot), null);
                return;
            } else {
                LaunchActivity.C0(LaunchActivity.G1, f91Var.currentAccount, tL_attachMenuBot, null, true);
            }
        }
        if (x51Var.G(z81.class)) {
            int i10 = x51Var.z;
            LaunchActivity launchActivity = LaunchActivity.G1;
            if (launchActivity != null) {
        ...
        if (x51Var.G(org.telegram.ui.Cells.w6.class)) {
            ...
            if (obj2 instanceof i11) {
                ...
                i11Var.b.run();
                AndroidUtilities.scrollToFragmentRow(parentLayout, i11Var.c);
        ...
        switch (x51Var.d) {
            ...
            case 16:
                ...
                break;
            case 17:
                f91Var.showDialog(org.telegram.ui.Components.e5.U(f91Var, f91Var.resourceProvider));
                break;
            case 18:
    ...
    public final View createView(Context context) {
        this.b = new x8(this, context, 7);
        this.actionBar.setBackButtonImage(R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.L();
        this.actionBar.setTitle(LocaleController.getString(R.string.Settings));
        int i10 = 0;
        this.actionBar.setActionBarMenuOnItemClick(new v81(this, i10));
        ...
        w81 w81Var = new w81(this, this, context);
        this.h = w81Var;
        w81Var.G();
        org.telegram.ui.Components.t61 t61Var = new org.telegram.ui.Components.t61(this, new b5(this, 26), new u81(this), new u81(this));
        this.c = t61Var;
        t61Var.Y2.r = false;
        t61Var.q1();
        ...
        this.Y = new ah.o(t61Var2, x8Var, new w8(t61Var2, i10));
        this.c.D0(new r81(this, 2));
        this.b.addView(this.c, w7.y5.e(-1, -1, 119));
        ci.s6 s6Var = new ci.s6(this, context);
        this.d = s6Var;
        this.b.addView(s6Var, w7.y5.e(-1, 200, 48));
        ...
        this.y.setOnClickListener(new s81(this, 5));
        w7.a6.a(this.y);
        ...
        this.y.addView(this.F, w7.y5.d(90, 90.0f, 49, 0.0f, 15.0f, 0.0f, 0.0f));
        ...
        this.y.addView(this.s, w7.y5.d(90, 90.0f, 49, 0.0f, 15.0f, 0.0f, 0.0f));
        n0(false, false);
        ...
        this.y.addView(this.G, w7.y5.d(34, 34.0f, 49, 32.0f, 75.0f, 0.0f, 0.0f));
        w7.a6.a(this.G);
        ...
        TextView g10 = org.telegram.ui.Cells.c1.g(this.x, this.J, w7.y5.d(-1, -2.0f, 49, 16.0f, 126.33299f, 16.0f, 0.0f), context);
        this.K = g10;
        g10.setTextSize(1, 13.0f);
        this.K.setGravity(17);
        this.K.setSingleLine();
        this.K.setEllipsize(truncateAt);
        TextView g11 = org.telegram.ui.Cells.c1.g(this.x, this.K, w7.y5.d(-1, -2.0f, 49, 0.0f, 156.0f, 0.0f, 0.0f), context);
        this.L = g11;
        ...
        this.L.setOnClickListener(new s81(this, 6));
        ...
        r0.a0.j(x8Var2, u81Var);
        x8 x8Var3 = this.b;
        this.fragmentView = x8Var3;
        return x8Var3;
    }
    ...
    public final void o0(boolean z10, boolean z11) {
        ...
        if (q0Var == null || q0Var.getTag() == null) {
            ...
            if (this.P == z12 || z10) {
                ...
                this.Q = ofFloat;
                ofFloat.addUpdateListener(new i21(this, 10));
