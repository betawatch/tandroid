...
public final class y8 extends org.telegram.ui.Components.qv0 {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.w0) {
            case 0:
                ...
                if (Build.VERSION.SDK_INT >= 31 && iVar != null) {
                    ...
                    if (dVar2 != null && !dVar2.n) {
                        ...
                        a2.drawColor(m9Var.getThemedColor(org.telegram.ui.ActionBar.j6.a7));
                    ...
                    if (dVar != null && !dVar.n) {
                        ...
                        a10.drawColor(m9Var.getThemedColor(org.telegram.ui.ActionBar.j6.a7));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar.b(a10, -2);
                        }
                        dVar.b();
            ...
            case 3:
                ...
                ah.i iVar2 = contactsActivity.t0;
            ...
            case 7:
                ...
                if (Build.VERSION.SDK_INT >= 31 && iVar3 != null) {
                    ...
                    if (dVar6 != null && !dVar6.n) {
                        ...
                        a13.drawColor(g91Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar3.b(a13, -3);
                        }
                        dVar6.b();
                    ...
                    if (dVar5 != null && !dVar5.n) {
                        ...
                        a14.drawColor(g91Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar3.b(a14, -2);
                        }
                        dVar5.b();
                ...
                super.dispatchDraw(canvas);
                if (!g91Var.M) {
                    AndroidUtilities.drawNavigationBarProtection(canvas, this, g91Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6), g91Var.S);
                    break;
                }
                break;
            case 8:
                ...
                if (Build.VERSION.SDK_INT >= 31 && iVar4 != null) {
                    ...
                    if (dVar8 != null && !dVar8.n) {
                        ...
                        a15.drawColor(ab1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar4.b(a15, -3);
                        }
                        dVar8.b();
                    ...
                    if (dVar7 != null && !dVar7.n) {
                        ...
                        a16.drawColor(ab1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
                        if (SharedConfig.chatBlurEnabled()) {
                            iVar4.b(a16, -2);
                        }
                        dVar7.b();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.w0) {
            case 1:
                if (motionEvent.getY() < ((org.telegram.ui.Components.pb0) this.x0).T) {
                    return false;
                }
    ...
    public Drawable getNewDrawable() {
        switch (this.w0) {
            case 1:
                Drawable d = ((zn) ((org.telegram.ui.Components.pb0) this.x0).c0.F).d();
                if (d == null) {
                    break;
                }
                break;
    ...
    public org.telegram.ui.ActionBar.f6 getResourceProvider() {
        switch (this.w0) {
            case 2:
                return ((org.telegram.ui.Components.c01) this.x0).c;
            default:
    ...
    */
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.w0) {
            ...
            case 3:
                ...
                break;
            case 4:
                zb0 zb0Var = (zb0) this.x0;
                int scrollY = zb0Var.J.getScrollY();
                super.onLayout(z10, i10, i11, i12, i13);
                if (scrollY != zb0Var.J.getScrollY()) {
                    zb0Var.J.setTranslationY(r11.getScrollY() - scrollY);
                    zb0Var.J.animate().cancel();
                    zb0Var.J.animate().translationY(0.0f).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.q1.w).start();
                    break;
                }
                break;
            case 6:
                    ...
                    if (childAt.getVisibility() != 8) {
                        ...
                        if (i23 == 1) {
                            ...
                            if (i22 != 16) {
                                ...
                                if (popupNotificationActivity.b.v0(childAt)) {
                                    int measuredHeight2 = getMeasuredHeight();
                                    if (emojiPadding != 0) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.w0) {
            case 0:
                m9 m9Var = (m9) this.x0;
                kVar = ((org.telegram.ui.ActionBar.o2) m9Var).actionBar;
                measureChildWithMargins(kVar, i10, 0, i11, 0);
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) m9Var.M.getLayoutParams();
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) m9Var.b.getLayoutParams();
                kVar3 = ((org.telegram.ui.ActionBar.o2) m9Var).actionBar;
                marginLayoutParams2.topMargin = kVar3.getMeasuredHeight();
                ViewGroup.MarginLayoutParams marginLayoutParams3 = (ViewGroup.MarginLayoutParams) m9Var.r.getLayoutParams();
                kVar4 = ((org.telegram.ui.ActionBar.o2) m9Var).actionBar;
            ...
            case 2:
                super.onMeasure(i10, i11);
                setMeasuredDimension(View.MeasureSpec.getSize(i10), ((org.telegram.ui.Components.c01) this.x0).d.getMeasuredHeight() + AndroidUtilities.dp(24.0f));
                break;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.x0;
                kVar5 = ((org.telegram.ui.ActionBar.o2) contactsActivity).actionBar;
                ...
                kVar6 = ((org.telegram.ui.ActionBar.o2) contactsActivity).actionBar;
                ...
                kVar7 = ((org.telegram.ui.ActionBar.o2) contactsActivity).actionBar;
            ...
            case 4:
                ...
                zb0Var.H.setVisibility(this.f > AndroidUtilities.dp(20.0f) ? 8 : 0);
                break;
            case 5:
                yg0 yg0Var = (yg0) this.x0;
                ViewGroup.MarginLayoutParams marginLayoutParams6 = (ViewGroup.MarginLayoutParams) yg0Var.N.getLayoutParams();
                int dp = yg0Var.h1() ? AndroidUtilities.dp(226.0f) : 0;
                ...
                if (ocVar == null || !ocVar.l) {
                    ...
                    super.onMeasure(i10, i11);
                    marginLayoutParams6.bottomMargin = org.telegram.messenger.wl.D(10.0f, org.telegram.ui.Components.oc.w.e.getMeasuredHeight() + AndroidUtilities.dp(14.0f), dp);
                }
                int i13 = AndroidUtilities.isTablet() ? 0 : AndroidUtilities.statusBarHeight;
                ((ViewGroup.MarginLayoutParams) yg0Var.U.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i13;
                ((ViewGroup.MarginLayoutParams) yg0Var.W.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i13;
                ((ViewGroup.MarginLayoutParams) yg0Var.V.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i13;
                TextView textView = yg0Var.f0;
                if (textView != null) {
                    ((ViewGroup.MarginLayoutParams) textView.getLayoutParams()).topMargin = AndroidUtilities.dp(16.0f) + i13;
                }
                if (R() > AndroidUtilities.dp(20.0f) && yg0Var.c.getVisibility() != 8 && !AndroidUtilities.isAccessibilityTouchExplorationEnabled() && !yg0Var.a0) {
                    ValueAnimator valueAnimator = yg0Var.d;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                    }
                    yg0Var.c.setVisibility(8);
                }
                super.onMeasure(i10, i11);
                break;
            case 6:
            ...
            case 9:
                ...
                kVar9 = ((org.telegram.ui.ActionBar.o2) h4Var).actionBar;
                ...
                kVar10 = ((org.telegram.ui.ActionBar.o2) h4Var).actionBar;
                ...
                kVar11 = ((org.telegram.ui.ActionBar.o2) h4Var).actionBar;
