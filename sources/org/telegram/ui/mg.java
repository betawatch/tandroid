...
public final /* synthetic */ class mg implements Utilities.Callback2 {
    ...
    public /* synthetic */ mg(bo boVar, zi ziVar, org.telegram.ui.Cells.t1 t1Var, String str, CharacterStyle characterStyle) {
        this.b = boVar;
        this.d = ziVar;
        this.c = t1Var;
        this.e = str;
        ...
        switch (this.a) {
            case 0:
                ...
                if (j3 != 0) {
                    bool = bool2;
                    z12 = false;
                    I.c(z10 ? R.drawable.msg_channel : R.drawable.msg_discussion, LocaleController.getString(z10 ? R.string.ViewChannel : R.string.SendMessage), new ke(boVar, j3, 3), false);
                } else {
                    bool = bool2;
                    z12 = false;
                }
                boolean z13 = z10;
                I.c(R.drawable.msg_copy, LocaleController.getString(R.string.ProfileCopyUsername), new xe(boVar, am0Var, str, 1), z12);
                if (bool.booleanValue()) {
                    I.c(R.drawable.outline_gram_24, LocaleController.getString(R.string.BuyUsernameOnFragment), new re(boVar, str, 11), z12);
                }
                I.k();
                if (j3 != 0) {
                    I.n(tLObject, LocaleController.getString(z11 ? R.string.ViewProfile : z13 ? R.string.ViewChannelProfile : R.string.ViewGroupProfile), new ke(boVar, j3, 4));
                } else {
                ...
                if (boVar2.zb == ajVar) {
                    ...
                    if (messages_messages != null) {
                        ...
                        if (richMessage != null && (message = messageObject.messageOwner) != null) {
                            ...
                            nn nnVar = boVar2.oc;
                            if (nnVar != null && (t1Var = this.c) != null) {
    ...
    public /* synthetic */ mg(bo boVar, aj ajVar, int[] iArr, org.telegram.ui.Cells.t1 t1Var, MessageObject messageObject) {
        this.b = boVar;
        this.d = ajVar;
        this.e = iArr;
        this.c = t1Var;
