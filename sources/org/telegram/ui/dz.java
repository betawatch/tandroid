    ...
    */
    ...
    public final void c() {
        ...
        while (true) {
            ...
            if (((cz) arrayList.get(i10)).j != null) {
                ((cz) arrayList.get(i10)).j.d(this.G);
            }
            i10++;
        }
    }
                ...
                while (true) {
                    ...
                    if (i13 >= arrayList2.size()) {
                        if (z10 && z14 && i14 > 0) {
                            ...
                            ConnectionsManager.getInstance(this.b).sendRequest(tL_messages_getStickerSet, new mo(18, this, messageObject));
                            return false;
                        }
                        if (i14 >= 4) {
                            return false;
                        ...
                        czVar.i = z15;
                        if (!z15) {
                            czVar.f = ((random.nextInt() % 101) / 100.0f) * (f7 / 4.0f);
                            czVar.g = ((random.nextInt() % 101) / 100.0f) * (f10 / 4.0f);
                        }
                        czVar.p = i10;
                        czVar.q = document2;
                        czVar.m = z12;
                        czVar.r.setAllowStartAnimation(true);
                        czVar.r.setAllowLottieVibration(z10);
                        ...
                        if (premiumStickerAnimation == null) {
                            ...
                            czVar.r.setImage(forDocument, sb2.toString(), null, "tgs", this.c, 1);
                            czVar.r.setDelegate(new bz(this, czVar, z10, messageObject));
                            ...
                            czVar.r.setImage(forDocument2, sb3.toString(), null, "tgs", this.c, 1);
                        }
                    ...
                    if (((cz) arrayList2.get(i13)).p == i10) {
                        i14++;
                        if (!z15 && (((cz) arrayList2.get(i13)).r.getLottieAnimation() == null || ((cz) arrayList2.get(i13)).r.getLottieAnimation().y())) {
                            return false;
                        }
                    }
    ...
    public final void e(Canvas canvas) {
        ...
        while (i10 < this.F.size()) {
            ...
            if (this.a != null) {
                ...
                while (true) {
                    ...
                    if (messageObject == null || messageObject.getId() != czVar.p) {
                        ...
                        if (czVar.i && (childAt instanceof org.telegram.ui.Cells.t1)) {
                            ...
                            float f14 = f12 / 2.0f;
                            f7 = 3.0f;
                            czVar.a = Utilities.clamp(timeX - f14, AndroidUtilities.displaySize.x - f12, 0.0f);
                            czVar.b = (t1Var2.getTimeY() + y3) - f14;
                        } else {
                            f7 = 3.0f;
                            if (czVar.h) {
                                czVar.a = imageReceiver.getImageX() + x10;
                                czVar.b = imageReceiver.getImageY() + y3;
                            } else {
                ...
                if (!czVar.c || czVar.e + f10 < this.a.s9 || f10 > this.H.getMeasuredHeight() - this.a.Aa) {
                    czVar.n = true;
                }
                if (czVar.h) {
                    float f15 = czVar.e / 2.0f;
            ...
            boolean z12 = !czVar.l && czVar.n;
            if (!z12) {
                if (!czVar.h || czVar.i) {
                    zg.d dVar = czVar.j;
                    if (dVar != null) {
                        float f17 = czVar.a + czVar.f;
                        float f18 = czVar.b + czVar.g;
                        float f19 = czVar.d * f7;
                        dVar.e((int) f17, (int) f18, (int) (f17 + f19), (int) (f18 + f19));
                        czVar.j.b(canvas);
                    } else {
                        ImageReceiver imageReceiver2 = czVar.r;
                        float f20 = czVar.a + czVar.f;
                        float f21 = czVar.b + czVar.g;
                        float f22 = czVar.d * f7;
                    ...
                    float f26 = (((f23 / 2.0f) + czVar.b) - (f24 / 2.0f)) - (0.00279f * f24);
                    if (czVar.m) {
                        czVar.r.setImageCoords(((czVar.a + czVar.d) - f24) + f25, f26, f24, f24);
                    } else {
                        czVar.r.setImageCoords(czVar.a - f25, f26, f24, f24);
                    }
                    if (czVar.m) {
                        czVar.r.draw(canvas);
                    } else {
            ...
            zg.d dVar2 = czVar.j;
            boolean c10 = dVar2 != null ? dVar2.c() : czVar.l && czVar.r.getLottieAnimation() != null && czVar.r.getLottieAnimation().a0 >= czVar.r.getLottieAnimation().e[0] + (-2);
            if (czVar.o == 1.0f || c10 || z12) {
                cz czVar2 = (cz) this.F.remove(i10);
                if (czVar.h && czVar.r.getLottieAnimation() != null) {
                    czVar2.r.getLottieAnimation().N(0, true, true);
                }
                ...
                i10--;
            } else if (czVar.r.getLottieAnimation() != null && czVar.r.getLottieAnimation().k0) {
                czVar.l = true;
            } else if (czVar.r.getLottieAnimation() != null && !czVar.r.getLottieAnimation().k0) {
                czVar.r.getLottieAnimation().N(0, true, false);
                czVar.r.getLottieAnimation().start();
            }
            i10++;
        }
    ...
    public final void j() {
        ...
        while (true) {
            ...
            if (((cz) arrayList.get(i10)).j != null) {
                ((cz) arrayList.get(i10)).j.f(this.G);
            }
            i10++;
        }
    }
    ...
    public final void l(org.telegram.ui.Cells.t1 t1Var, xn xnVar, boolean z10) {
        ...
        if (t1Var.getMessageObject().isPremiumSticker() || xnVar.f != null) {
            ...
            if ((printingStringType == null || printingStringType.intValue() != 5) && this.E == null && o9) {
                org.telegram.ui.Components.qc qcVar = org.telegram.ui.Components.qc.w;
                if ((qcVar == null || !qcVar.l) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.b).getClientUserId() != xnVar.f.id) {
                    SharedConfig.updateEmojiInteractionsHintCount(SharedConfig.emojiInteractionsHintCount - 1);
                    org.telegram.ui.Components.zw0 zw0Var = new org.telegram.ui.Components.zw0(xnVar.getParentActivity(), null, 1, -1, t1Var.getMessageObject().isAnimatedAnimatedEmoji() ? t1Var.getMessageObject().getDocument() : MediaDataController.getInstance(this.b).getEmojiAnimatedSticker(t1Var.getMessageObject().getStickerEmoji()), xnVar.getResourceProvider());
                    ...
                    i9.s sVar = new i9.s(this, org.telegram.ui.Components.qc.g(xnVar, zw0Var, 2750), z11, 23);
                    this.E = sVar;
    ...
    public final void p(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, MessageObject messageObject) {
        ...
        ocVar.a = new hw(6, this, messageObject);
