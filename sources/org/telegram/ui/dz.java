...
public final /* synthetic */ class dz implements View.OnClickListener {
    ...
    public /* synthetic */ dz(jz jzVar, int i9) {
        this.a = i9;
        this.b = jzVar;
    }
        ...
        switch (this.a) {
            case 0:
                ...
                if (str != null) {
                    ...
                    org.telegram.messenger.ll.o(R.string.LinkCopied, org.telegram.ui.Components.oc.a0(jzVar.r));
                    break;
                }
                break;
            case 1:
                jz jzVar2 = this.b;
                FrameLayout frameLayout = jzVar2.a;
                ...
                float[] fArr = jzVar2.y;
                if (jzVar2.x == null && jzVar2.s != null) {
                    ...
                    FrameLayout overlayContainerView = jzVar2.r.getParentLayout().getOverlayContainerView();
                    if (overlayContainerView != null) {
                        ...
                        jzVar2.x.setOutsideTouchable(true);
                        jzVar2.x.setFocusable(true);
                        jzVar2.x.setBackgroundDrawable(new ColorDrawable(0));
                        jzVar2.x.setAnimationStyle(R.style.PopupContextAnimation);
                        jzVar2.x.setInputMethodMode(2);
                        jzVar2.x.setSoftInputMode(0);
                        ...
                        jzVar2.x.showAtLocation(overlayContainerView, 0, (int) (overlayContainerView.getX() + ((overlayContainerView.getMeasuredWidth() - actionBarPopupWindow$ActionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.dp(16.0f)) + f11), (int) (overlayContainerView.getY() + f10 + frameLayout.getMeasuredHeight()));
                        break;
                    }
                }
                break;
            case 2:
                jz jzVar3 = this.b;
                String str2 = jzVar3.s;
                if (str2 != null) {
                    AndroidUtilities.addToClipboard(str2);
                    org.telegram.messenger.ll.o(R.string.LinkCopied, org.telegram.ui.Components.oc.a0(jzVar3.r));
                    break;
                }
                break;
            case 3:
                ...
                if (jzVar4.s != null) {
                    try {
                        ...
                        intent.putExtra("android.intent.extra.TEXT", jzVar4.s);
                        jzVar4.r.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(R.string.InviteToGroupByLink)), 500);
                        break;
                    } catch (Exception e10) {
                        FileLog.e(e10);
                        return;
            ...
            case 4:
                jz jzVar5 = this.b;
                org.telegram.ui.ActionBar.o1 o1Var2 = jzVar5.x;
                if (o1Var2 != null) {
                    o1Var2.d(true);
                }
                lz lzVar = jzVar5.A.c;
                ...
                if (tL_exportedChatlistInvite != null && tL_exportedChatlistInvite.url != null) {
                    ...
                    alertDialog$Builder.a.E = org.telegram.ui.ActionBar.f6.H5;
                    ...
                    editTextBoldCursor.setHint(lzVar.c.name);
                    editTextBoldCursor.setHintTextColor(org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.t5, false));
                    ...
                    int i11 = 0;
                    editTextBoldCursor.setOnEditorActionListener(new gz(alertDialog$Builder, i11));
                    editTextBoldCursor.addTextChangedListener(new iz(i11, editTextBoldCursor));
            ...
            case 5:
                jz jzVar6 = this.b;
                org.telegram.ui.ActionBar.o1 o1Var3 = jzVar6.x;
                if (o1Var3 != null) {
                    o1Var3.d(true);
                }
                if (jzVar6.s != null) {
                    org.telegram.ui.Components.wh0 wh0Var = new org.telegram.ui.Components.wh0(jzVar6.getContext(), LocaleController.getString(R.string.InviteByQRCode), jzVar6.s, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
            ...
            default:
                jz jzVar7 = this.b;
                org.telegram.ui.ActionBar.o1 o1Var4 = jzVar7.x;
                if (o1Var4 != null) {
                    o1Var4.d(true);
                }
                ...
                lz lzVar2 = jzVar7.A.c;
                tL_inputChatlistDialogFilter.filter_id = lzVar2.c.id;
