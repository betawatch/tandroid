...
public final class hb1 extends LinearLayout {
    ...
    public /* synthetic */ hb1(Context context) {
        super(context);
        this.a = 0;
    }
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i12) {
                                    case 0:
                                        hb1 hb1Var = this.b;
                                        hb1Var.invalidate();
                                        ((ScrollSlidingTextTabStrip) hb1Var.b).invalidate();
                                        break;
                                    default:
                                        hb1 hb1Var2 = this.b;
                                        hb1Var2.invalidate();
                                        ((ScrollSlidingTextTabStrip) hb1Var2.b).invalidate();
                                        break;
                                }
                            }
    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.a) {
            ...
            case 14:
                ...
                if (view == e70Var.b && e70Var.x != null) {
                    int measuredHeight = e70Var.s.getMeasuredHeight();
                    e70Var.x.setBounds(0, measuredHeight, getMeasuredWidth(), e70Var.x.getIntrinsicHeight() + measuredHeight);
                    e70Var.x.draw(canvas);
                }
                return drawChild;
            default:
                return super.drawChild(canvas, view, j10);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.a) {
            case 17:
                ...
                accessibilityNodeInfo.setVisibleToUser(((ai1) this.b).y0);
                break;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                break;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        switch (this.a) {
            case 5:
                return org.telegram.ui.ActionBar.w4.b((org.telegram.ui.ActionBar.w4) this.b);
            default:
        ...
        switch (this.a) {
            case 7:
                ...
                for (int i15 = 0; i15 < getChildCount(); i15++) {
                    ...
                    if (childAt != ((org.telegram.ui.Components.vv) this.b).s.C && childAt != null) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            case 0:
                ...
                break;
            case 5:
                org.telegram.ui.ActionBar.w4 w4Var = (org.telegram.ui.ActionBar.w4) this.b;
                ...
                break;
            case 7:
                super.onMeasure(Math.max(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(((org.telegram.ui.Components.vv) this.b).b.getChildCount() * 32), TLObject.FLAG_30)), i11);
                break;
            case 12:
                super.onMeasure(i10, i11);
            ...
            case 16:
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) og1Var.c.getLayoutParams();
                int i15 = 0;
                int dp = AndroidUtilities.dp(8.0f) + (og1Var.a.getVisibility() == 8 ? AndroidUtilities.statusBarHeight : 0);
            ...
            case 19:
                ...
                LinearLayout linearLayout = y1Var.j0;
                if (linearLayout != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) y1Var.j0.getLayoutParams();
                    paddingRight += y1Var.j0.getMeasuredWidth() + marginLayoutParams2.leftMargin + marginLayoutParams2.rightMargin;
                }
                LinearLayout linearLayout2 = y1Var.k0;
                if (linearLayout2 != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams3 = (ViewGroup.MarginLayoutParams) y1Var.k0.getLayoutParams();
                    paddingRight += y1Var.k0.getMeasuredWidth() + marginLayoutParams3.leftMargin + marginLayoutParams3.rightMargin;
                }
                LinearLayout linearLayout3 = y1Var.l0;
                if (linearLayout3 != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams4 = (ViewGroup.MarginLayoutParams) y1Var.l0.getLayoutParams();
                    paddingRight += y1Var.l0.getMeasuredWidth() + marginLayoutParams4.leftMargin + marginLayoutParams4.rightMargin;
                }
                y1Var.h0 = Math.max(0, size4 - paddingRight);
                super.onMeasure(i10, i11);
                break;
            case 20:
                int size5 = View.MeasureSpec.getSize(i10);
                int paddingRight2 = getPaddingRight() + getPaddingLeft();
                vh.v3 v3Var = (vh.v3) this.b;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ hb1(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
