    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        if (lerp >= 0.7f && !this.a) {
            ...
            if (jd0Var.o0 != null) {
                ...
                animatorSet.playTogether(ObjectAnimator.ofFloat(jd0Var2.o0, (Property<FrameLayout, Float>) View.SCALE_X, 0.0f, 1.0f), ObjectAnimator.ofFloat(jd0Var2.o0, (Property<FrameLayout, Float>) View.SCALE_Y, 0.0f, 1.0f), ObjectAnimator.ofFloat(jd0Var2.o0, (Property<FrameLayout, Float>) View.ALPHA, 0.0f, 1.0f));
