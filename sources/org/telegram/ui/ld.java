...
public final class ld extends org.telegram.ui.Components.qv0 {
    ...
    public /* synthetic */ ld(int i10, Context context, org.telegram.ui.ActionBar.p2 p2Var) {
        super(context, null);
        this.t0 = i10;
        this.v0 = p2Var;
    }
    ...
    */
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int i24;
        int i25;
        org.telegram.ui.Components.cu cuVar2;
        int measuredHeight3;
        int measuredHeight4;
        int i26;
        int i27;
        ...
        int i30;
        int i31;
        org.telegram.ui.Components.cu cuVar3;
        int measuredHeight5;
        int measuredHeight6;
        int i32;
        int i33;
        ...
        switch (this.t0) {
            case 0:
                ...
                int R = R();
                int emojiPadding = (R > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : pdVar.c.getEmojiPadding();
            ...
            case 1:
                ...
                int R2 = R();
                int emojiPadding2 = (R2 > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : roVar.v.getEmojiPadding();
                ...
                break;
            case 2:
                g70 g70Var = (g70) this.v0;
                int childCount3 = getChildCount();
                int R3 = R();
                int emojiPadding3 = (R3 > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : g70Var.c.getEmojiPadding();
                    ...
                    if (childAt3.getVisibility() != 8) {
                        ...
                        if (i49 == 1) {
                            ...
                            if (i48 == 16) {
                                ...
                                cuVar3 = g70Var.c;
                                if (cuVar3 != null && cuVar3.l(childAt3)) {
                                    if (AndroidUtilities.isTablet()) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.t0) {
            case 0:
                ...
                pd pdVar = (pd) this.v0;
                kVar = ((org.telegram.ui.ActionBar.p2) pdVar).actionBar;
                ...
                for (int i12 = 0; i12 < childCount; i12++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8) {
                        kVar2 = ((org.telegram.ui.ActionBar.p2) pdVar).actionBar;
                        if (childAt != kVar2) {
            ...
            case 1:
                ...
                ro roVar = (ro) this.v0;
                kVar3 = ((org.telegram.ui.ActionBar.p2) roVar).actionBar;
                ...
                for (int i13 = 0; i13 < childCount2; i13++) {
                    ...
                    if (childAt2 != null && childAt2.getVisibility() != 8) {
                        kVar4 = ((org.telegram.ui.ActionBar.p2) roVar).actionBar;
                        if (childAt2 != kVar4) {
            ...
            case 2:
                ...
                g70 g70Var = (g70) this.v0;
                kVar5 = ((org.telegram.ui.ActionBar.p2) g70Var).actionBar;
                measureChildWithMargins(kVar5, i10, 0, i11, 0);
                if (R() > AndroidUtilities.dp(20.0f)) {
                    org.telegram.ui.Components.cu cuVar3 = g70Var.c;
                    if (!cuVar3.e) {
                        this.u0 = true;
                        cuVar3.j();
                        this.u0 = false;
                ...
                for (int i14 = 0; i14 < childCount3; i14++) {
                    ...
                    if (childAt3 != null && childAt3.getVisibility() != 8) {
                        kVar6 = ((org.telegram.ui.ActionBar.p2) g70Var).actionBar;
                        if (childAt3 != kVar6) {
                            org.telegram.ui.Components.cu cuVar4 = g70Var.c;
