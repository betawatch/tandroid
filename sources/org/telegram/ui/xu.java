...
public final class xu extends org.telegram.ui.Components.sa {
    ...
    public xu(y6 y6Var, r6 r6Var, hh.b bVar, g5.b bVar2) {
        ...
        wu wuVar = new wu(getContext(), r6Var.a, bVar2);
        this.T = wuVar;
        ...
        while (i11 < i10) {
            ...
            if (j11 > j10) {
                ...
                org.telegram.ui.Components.jx0 jx0Var = new org.telegram.ui.Components.jx0();
                ...
                jx0VarArr[i11] = jx0Var;
                org.telegram.ui.Components.jx0 jx0Var2 = this.X[i11];
                jx0Var2.e = j11;
                jx0Var2.a = i9;
                ...
                z1Var2.setTextColor(org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.j5, false));
                int i12 = org.telegram.ui.ActionBar.f6.k7;
                org.telegram.ui.Components.dp dpVar = z1Var2.r;
                if (dpVar != null) {
                    dpVar.b(i9, i9, i12);
                }
        ...
        wuVar2.B = bVar;
        wuVar2.invalidate();
        wuVar2.c = new float[jx0VarArr2.length];
        wuVar2.d = new float[jx0VarArr2.length];
        wuVar2.e = new float[jx0VarArr2.length];
        wuVar2.c(false);
        if (wuVar2.y > 1) {
            wuVar2.f = 0.0f;
        } else {
    ...
    public final void Q() {
        ...
        this.W = j6Var;
        j6Var.a.setOnClickListener(new a(this, 19));
        wu wuVar = this.T;
        if (wuVar != null) {
