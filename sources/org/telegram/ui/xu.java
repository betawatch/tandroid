...
public final class xu extends org.telegram.ui.Components.vl0 {
    ...
    public final void y1() {
        ...
        while (true) {
            ...
            float[] fArr = this.d3;
            if (i19 >= length) {
                Arrays.sort(this.g3, new org.telegram.ui.Components.m9(13));
    ...
    public final void z1(boolean z10) {
        ...
        while (true) {
            ...
            if (j11 > j10 || z11) {
                ...
                int i17 = bv.f[i15];
                int[] iArr = bv.d[i15];
                arrayList3.add(new su(i14, i17, iArr[0], iArr[1], j11 == j10 ? LocaleController.getString(bv.h[i15]) : TextUtils.concat(LocaleController.getString(bv.h[i15]), "  ", spannableString3), AndroidUtilities.formatFileSize(j11)));
            }
            i14++;
            j3 = j10;
            i13 = 1;
