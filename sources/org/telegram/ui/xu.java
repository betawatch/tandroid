...
public final class xu extends org.telegram.ui.Components.ml0 {
    ...
    public xu(bv bvVar, Activity activity) {
        ...
        ki.b.a(this, bvVar.h, bvVar.n, AndroidUtilities.dp(42.0f) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight());
    }
    ...
    public final void A1() {
        ...
        while (true) {
            ...
            wuVar.b = z10;
            wuVar.e = x13;
            wuVar.g = recivedItemsCount;
            wuVar.f = z12;
            wuVar.h = sentItemsCount;
            wuVarArr2[i19] = wuVar;
            wuVarArr[i19] = wuVar;
            fArr[i19] = x12 / this.j3;
            i19++;
        }
    }
    ...
    public final void B1(boolean z10) {
        ...
        arrayList2.clear();
        int i12 = 0;
        arrayList2.add(new su(0, false));
        int i13 = 1;
        long j3 = 0;
        String formatString = this.j3 > 0 ? LocaleController.formatString(R.string.YourNetworkUsageSince, LocaleController.getInstance().getFormatterStats().format(y1())) : LocaleController.formatString(R.string.NoNetworkUsageSince, LocaleController.getInstance().getFormatterStats().format(y1()));
        ...
        while (true) {
            ...
            if (j11 > j10 || z11) {
                ...
                ru ruVar = new ru();
                ruVar.a = 0.1d;
                spannableString3.setSpan(ruVar, 0, spannableString3.length(), 33);
                int i17 = bv.v[i15];
                int[] iArr = bv.r[i15];
                arrayList3.add(new su(i14, i17, iArr[0], iArr[1], j11 == j10 ? LocaleController.getString(bv.w[i15]) : TextUtils.concat(LocaleController.getString(bv.w[i15]), "  ", spannableString3), AndroidUtilities.formatFileSize(j11)));
            }
            i14++;
            j3 = j10;
            i13 = 1;
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i19 < arrayList3.size()) {
                int i20 = ((su) arrayList3.get(i19)).h;
                if (i20 < 0 || this.i3[i20]) {
                    spannableString = spannableString4;
                    spannableString2 = spannableString5;
                } else {
                    wu wuVar2 = this.g3[i20];
                    int[] iArr2 = bv.x;
                    int i21 = wuVar2.d;
                    int i22 = wuVar2.g;
                    int i23 = wuVar2.h;
                    ...
                    if (i24 == 0) {
                        if (j14 > j12 || i23 > 0) {
                            i19++;
                            arrayList3.add(i19, su.b(LocaleController.formatPluralStringComma("OutgoingCallsCount", i23), AndroidUtilities.formatFileSize(j14)));
                        }
                        if (j13 > j12 || i22 > 0) {
                            i19++;
                            arrayList3.add(i19, su.b(LocaleController.formatPluralStringComma("IncomingCallsCount", i22), AndroidUtilities.formatFileSize(j13)));
                        }
                    } else if (i24 != 1) {
                        if (j14 > j12 || i23 > 0) {
                            i19++;
                            arrayList3.add(i19, su.b(TextUtils.concat(spannableString, " ", AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("FilesSentCount", i23))), AndroidUtilities.formatFileSize(j14)));
                        }
                        if (j13 > j12 || i22 > 0) {
                            i19++;
                            arrayList3.add(i19, su.b(TextUtils.concat(spannableString2, " ", AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("FilesReceivedCount", i22))), AndroidUtilities.formatFileSize(j13)));
                        }
                    } else {
                        if (j14 > j12 || i23 > 0) {
                            i19++;
                            arrayList3.add(i19, su.b(TextUtils.concat(spannableString, " ", LocaleController.getString(R.string.BytesSent)), AndroidUtilities.formatFileSize(j14)));
                        }
                        if (j13 > j12 || i22 > 0) {
                            i19++;
                            arrayList3.add(i19, su.b(TextUtils.concat(spannableString2, " ", LocaleController.getString(R.string.BytesReceived)), AndroidUtilities.formatFileSize(j13)));
                            i19++;
        ...
        if (!this.m3) {
            ...
            arrayList2.add(new su(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.l3)));
            arrayList2.add(new su(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.k3)));
        }
        if (arrayList3.isEmpty()) {
            i10 = 3;
        } else {
        ...
        if (this.Y2 != 0) {
            if (arrayList3.isEmpty()) {
                arrayList2.add(new su(i10, false));
            }
