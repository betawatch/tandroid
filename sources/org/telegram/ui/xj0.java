...
public final class xj0 implements Choreographer.FrameCallback {
    ...
    public static void b(Canvas canvas, Layout layout, int i10, float f7, wj0 wj0Var) {
        ...
        wj0 fuVar = wj0Var != null ? wj0Var : new fu(layout, 25);
    ...
    public final void doFrame(long j3) {
        if (this.h) {
            ...
            if (this.r != 0) {
                ...
                if (this.b.isEmpty() || f10 <= 0.0f) {
                    ...
                    while (true) {
                        ...
                        Layout layout = ((vj0) this.b.get(this.d)).getLayout();
            ...
            for (int i12 = 0; i12 < size2; i12++) {
                View parentView = ((vj0) this.b.get(i12)).getParentView();
                if (parentView != null && parentView != view) {
    ...
    public final void e() {
        vj0 vj0Var;
        int i10 = this.d;
        View parentView = (i10 < 0 || i10 >= this.b.size() || (vj0Var = (vj0) this.b.get(this.d)) == null) ? null : vj0Var.getParentView();
        if (parentView != null) {
    ...
    public final boolean f() {
        if (!this.b.isEmpty()) {
            ...
            Layout layout = null;
            while (size >= 0) {
                layout = ((vj0) this.b.get(size)).getLayout();
                if (layout != null && layout.getLineCount() > 0) {
                    break;
                }
                size--;
    ...
    public final boolean g(vj0 vj0Var) {
        Layout layout;
        return d(vj0Var) == this.d && (layout = vj0Var.getLayout()) != null && this.e < layout.getLineCount();
    }
    ...
    public final void l(List list) {
        ...
        if (!this.b.isEmpty() && this.d >= this.b.size()) {
            int size = this.b.size() - 1;
            this.d = size;
            Layout layout = ((vj0) this.b.get(size)).getLayout();
        ...
        if (list.isEmpty()) {
            ...
            while (i10 < this.b.size()) {
                Layout layout2 = ((vj0) this.b.get(i10)).getLayout();
                if (layout2 != null) {
