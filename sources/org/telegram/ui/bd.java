...
public final class bd extends FrameLayout {
    ...
    public final void a(String str, boolean z4) {
        ...
        while (true) {
            ...
            if (!TextUtils.equals(this.s, ipVar.a()) && (!TextUtils.isEmpty(str) || !ipVar.a.a)) {
                z10 = false;
            }
            ipVar.d = z10;
            if (z10) {
    ...
    public void setGalleryWallpaper(TLRPC.WallPaper wallPaper) {
        ...
        if (this.v != null) {
            ...
            if ((arrayList.isEmpty() || ((org.telegram.ui.Components.ip) arrayList.get(0)).a.a) && this.f) {
                arrayList.add(0, new org.telegram.ui.Components.ip(org.telegram.ui.ActionBar.e4.a(this.a)));
                this.h.l();
            }
        }
    }
