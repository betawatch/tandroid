...
public abstract class c61 extends org.telegram.ui.Components.wl0 {
    ...
    */
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        sparseArray.clear();
        boolean z11 = a71Var.P1 > 0 && SystemClock.elapsedRealtime() - a71Var.P1 < a71Var.g() && a71Var.M1 != null && a71Var.N1 >= 0;
        if (this.d3 != null) {
            int i14 = 0;
            boolean z12 = false;
            while (i14 < getChildCount()) {
                ...
                if (childAt instanceof j61) {
                    ...
                    if (j61Var.isPressed()) {
                        float f7 = j61Var.N;
                        if (f7 != 1.0f && i15 != i12) {
                            j61Var.N = Utilities.clamp(f7 + 0.16f, 1.0f, 0.0f);
                            j61Var.invalidate();
                        }
                    }
                    int i16 = j61Var.c;
                    int y3 = a71Var.w1 ? (int) childAt.getY() : childAt.getTop();
                    ...
                    if (j61Var.w != null) {
                        ...
                        boolean z14 = z10;
                        view = childAt;
                        canvas2.scale(i17 == 2 ? -1.0f : 1.0f, i17 == 2 ? -1.0f : 1.0f, j61Var.getWidth() / 2.0f, j61Var.getHeight() / 2.0f);
                        canvas2.rotate((i16 % 4) * 90, j61Var.getWidth() / 2.0f, j61Var.getHeight() / 2.0f);
                        collectionParticles.a(canvas2, j61Var.w.intValue());
                        canvas2.restore();
                        z12 = z14;
                    } else {
                        i10 = i14;
                    ...
                    if ((z15 || j61Var.M || j61Var.S > 0.0f) && !j61Var.b) {
                        if (z15 || j61Var.M) {
                            float f10 = j61Var.R;
                            if (f10 < 1.0f) {
                                j61Var.R = ((1000.0f / AndroidUtilities.screenRefreshRate) / 240.0f) + f10;
                                invalidate();
                            }
                        }
                        if (!j61Var.L && !j61Var.M) {
                            float f11 = j61Var.R;
                            if (f11 > 0.0f) {
                                j61Var.R = f11 - ((1000.0f / AndroidUtilities.screenRefreshRate) / 240.0f);
                                invalidate();
                            }
                        }
                    ...
                    i61 i61Var = j61Var.J;
                    if (i61Var != null && i61Var.getVisibility() == 0 && j61Var.J.getImageReceiver() == null && (imageReceiver = j61Var.r) != null) {
                        j61Var.J.setImageReceiver(imageReceiver);
                    }
                } else {
                    i10 = i14;
                    view = childAt;
        ...
        for (int i22 = 0; i22 < getChildCount(); i22++) {
            ...
            if (childAt2 instanceof j61) {
                ...
                if (i61Var2 != null && i61Var2.getVisibility() == 0) {
                    ...
                    ImageReceiver imageReceiver2 = drawable2 instanceof org.telegram.ui.Components.q5 ? ((org.telegram.ui.Components.q5) drawable2).k : j61Var3.h;
                    i61 i61Var3 = j61Var3.J;
                    if (!i61Var3.h) {
                        i61Var3.setImageReceiver(imageReceiver2);
                    }
                ...
                if (j61Var3.K != null) {
                    ...
                    float f16 = dp3;
                    canvas2.translate((int) ((j61Var3.getX() + j61Var3.getMeasuredWidth()) - f16), (int) ((j61Var3.getY() + j61Var3.getMeasuredHeight()) - f16));
