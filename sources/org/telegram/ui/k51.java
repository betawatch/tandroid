...
public final class k51 extends Dialog {
    ...
    public final void c(boolean z10, f51 f51Var) {
        ...
        this.d0 = ofFloat;
        int i10 = 11;
        ofFloat.addUpdateListener(new ah.l0(i10, this, z10));
        this.d0.addListener(new ah.r0(this, z10, f51Var, i10));
        ...
        this.e0.addListener(new e50(8, this, z10));
    ...
    public final void d() {
        ...
        if (t1Var != null) {
            ...
            i0.c cVar2 = this.e;
            this.G = org.telegram.messenger.w1.y(((height - cVar2.b) - cVar2.d) - this.O.getHeight(), this.K, 2.0f, f10);
            if (!this.J) {
                this.J = true;
