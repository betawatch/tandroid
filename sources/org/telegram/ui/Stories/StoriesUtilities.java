...
public abstract class StoriesUtilities {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:68:0x0181, code lost:
        ...
        if (r11.stories.get(r6).close_friends != false) goto L78;
     */
            ...
            if (peerStories == null || peerStories.stories.size() == 1) {
                ...
                if (i <= 1) {
                    ...
                    while (i3 < i) {
                        ...
                        int i4 = i3;
                        int i5 = max;
                        drawSegment(canvas, rectF, paint5, f5, f6, avatarStoryParams, z);
                ...
                drawSegment(canvas, rectF2, paint10, -90.0f, 90.0f, avatarStoryParams, z);
                drawSegment(canvas, rectF2, paint10, 90.0f, 270.0f, avatarStoryParams, z);
