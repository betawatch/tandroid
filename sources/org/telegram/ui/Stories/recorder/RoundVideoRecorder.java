...
public abstract class RoundVideoRecorder extends FrameLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.shadowPaint.setShadowLayer(AndroidUtilities.dp(2.0f), 0.0f, AndroidUtilities.dp(0.66f), Theme.multAlpha(TLObject.FLAG_29, this.alpha));
        ...
        if (this.recordingStarted > 0) {
            ...
            this.progressPaint.setShadowLayer(AndroidUtilities.dp(1.0f), 0.0f, AndroidUtilities.dp(0.33f), Theme.multAlpha(TLObject.FLAG_29, this.alpha));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.cameraView.measure(View.MeasureSpec.makeMeasureSpec(min, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(min, TLObject.FLAG_30));
