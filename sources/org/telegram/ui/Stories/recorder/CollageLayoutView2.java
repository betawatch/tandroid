...
public abstract class CollageLayoutView2 extends FrameLayout implements ItemOptions.ScrimView {
    ...
    */
            ...
            if (f5 < getMeasuredHeight()) {
                ...
                for (i = 0; i < this.parts.size(); i++) {
                    ...
                    if (f9 > 0.0f) {
                        ...
                        this.highlightPaint.setAlpha(NotificationCenter.didApplyNewTheme);
    ...
    public void onLongPress() {
        ...
        makeOptions.setFixedWidth(NotificationCenter.factCheckLoaded).add(R.drawable.menu_camera_retake, LocaleController.getString(R.string.StoreCollageRetake), new Runnable() { // from class: org.telegram.ui.Stories.recorder.CollageLayoutView2$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
        ...
        }).addSpaceGap().addView(frameLayout, LayoutHelper.createLinear(NotificationCenter.factCheckLoaded, -2)).setOnDismiss(new Runnable() { // from class: org.telegram.ui.Stories.recorder.CollageLayoutView2$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
