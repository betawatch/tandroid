...
public abstract class CaptionStory extends CaptionContainerView {
    ...
    public void drawOver(Canvas canvas, RectF rectF) {
        ...
        if (this.currentRecorder != null) {
            ...
            float sin = (((float) Math.sin(((System.currentTimeMillis() - this.startTime) / 900.0f) * 3.141592653589793d)) + 1.0f) / 2.0f;
            ...
            if (paint3 != null) {
                paint = paint3;
                f = f7;
                canvas.saveLayerAlpha(rectF.left, rectF.top, rectF.right, rectF.bottom, NotificationCenter.invalidateMotionBackground, 31);
            } else {
                paint = paint3;
                f = f7;
            }
