...
public class RecordControl extends View implements FlashViews.Invertable {
    ...
    */
    protected void onDraw(Canvas canvas) {
        ...
        this.mainPaint.setAlpha(NotificationCenter.needCheckSystemBarColors);
        RectF rectF4 = rectF;
        ...
        if ((f24 > 0.0f) && (f5 > 0.0f)) {
            this.outlinePaint.setAlpha(NotificationCenter.needCheckSystemBarColors);
            rectF2 = rectF4;
        ...
        if (f13 > 0.0f) {
            this.redPaint.setAlpha(NotificationCenter.needCheckSystemBarColors);
