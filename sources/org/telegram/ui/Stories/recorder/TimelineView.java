    ...
    */
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (f45 < 1.0f) {
            ...
            this.timelineIcon.setAlpha(NotificationCenter.didUpdatePremiumGiftStickers);
        ...
        if (f45 > 0.0f) {
            ...
            if (f124 > 0.0f) {
                ...
                if (f125 < 1.0f) {
                    ...
                    f19 = f5;
                    canvas4 = canvas5;
                    canvas.saveLayerAlpha(0.0f, 0.0f, this.w, this.h, NotificationCenter.didReplacedPhotoInMemCache, 31);
    ...
    private void drawRegion(Canvas canvas, Paint paint, float f, float f2, float f3, float f4, float f5) {
        ...
        this.regionHandlePaint.setAlpha(NotificationCenter.didReplacedPhotoInMemCache);
        paint2.setAlpha(i);
        float f6 = f + f2;
