...
public class TimelineView extends View {
    ...
    */
    ...
    private void drawRegion(Canvas canvas, Paint paint, float f, float f2, float f3, float f4, float f5) {
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, this.w, this.h, NotificationCenter.goingToPreviewTheme, 31);
        int i = (int) (255.0f * f5);
        ...
        this.regionHandlePaint.setAlpha(NotificationCenter.goingToPreviewTheme);
        paint2.setAlpha(i);
        float f6 = f + f2;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (f42 < 1.0f) {
            ...
            if (this.blurManager.hasRenderNode()) {
                ...
                this.timelineIcon.setAlpha(NotificationCenter.storiesLimitUpdate);
        ...
        if (f42 > 0.0f) {
            ...
            if (f126 > 0.0f) {
                ...
                if (blurManager3 != null && blurManager3.hasRenderNode()) {
                    ...
                    multAlpha = Theme.multAlpha(TLObject.FLAG_30, f126);
                } else {
                    paint4 = paint3;
