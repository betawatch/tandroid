...
public abstract class CaptionContainerView extends FrameLayout {
    ...
    public void drawBackground(Canvas canvas, RectF rectF, float f, float f2, View view) {
        ...
        this.backgroundPaint.setAlpha((int) (this.blurPaint == null ? 128.0f : f2 * AndroidUtilities.lerp(128, NotificationCenter.recordStartError, this.keyboardT)));
    ...
    public void drawHint(Canvas canvas, Runnable runnable) {
        if (!customBlur()) {
            ...
            EditTextCaption editText = this.editText.getEditText();
            canvas.saveLayerAlpha(0.0f, 0.0f, editText.getWidth(), editText.getHeight(), NotificationCenter.locationPermissionGranted, 31);
            runnable.run();
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, this.hintTextBitmap.getWidth(), this.hintTextBitmap.getHeight(), NotificationCenter.locationPermissionGranted, 31);
