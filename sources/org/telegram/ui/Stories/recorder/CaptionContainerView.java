    ...
    */
    ...
    public void drawHint(Canvas canvas, Runnable runnable) {
        if (customBlur()) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.hintTextBitmap.getWidth(), this.hintTextBitmap.getHeight(), NotificationCenter.didReplacedPhotoInMemCache, 31);
        ...
        EditTextCaption editText = this.editText.getEditText();
        canvas.saveLayerAlpha(0.0f, 0.0f, editText.getWidth(), editText.getHeight(), NotificationCenter.didReplacedPhotoInMemCache, 31);
        runnable.run();
