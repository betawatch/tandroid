...
public abstract class CaptionContainerView extends FrameLayout {
    ...
    public CaptionContainerView(Context context, FrameLayout frameLayout, SizeNotifierFrameLayout sizeNotifierFrameLayout, FrameLayout frameLayout2, final Theme.ResourcesProvider resourcesProvider, final BlurringShader.BlurManager blurManager) {
        ...
        this.textChangeRunnable = new Runnable() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView$$ExternalSyntheticLambda0
            ...
            public final void run() {
                CaptionContainerView.this.onTextChange();
            }
        };
        ...
        this.updateShowKeyboard = new Runnable() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                r0.updateShowKeyboard(CaptionContainerView.this.toKeyboardShow, true);
            }
        };
        ...
        float f = 0.0f;
        strokeDrawable.setColorProvider(new BlurredBackgroundColorProviderThemed(resourcesProvider, i, f) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.1
        ...
        strokeDrawable2.setColorProvider(new BlurredBackgroundColorProviderThemed(resourcesProvider, i, f) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.2
            @Override // org.telegram.ui.Components.blur3.drawable.color.BlurredBackgroundColorProviderThemed
            public boolean isDark() {
                return true;
            }
        ...
        EditTextEmoji editTextEmoji = new EditTextEmoji(context, sizeNotifierFrameLayout, null, getEditTextStyle(), true, new DarkThemeResourceProvider()) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.3
            ...
            protected void createEmojiView() {
                ...
                if (emojiView != null) {
                    ...
                    emojiView.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.3.1
            ...
            */
                    ...
                    if (this.blurredBackgroundDrawable == null) {
                        ...
                        if (Build.VERSION.SDK_INT >= 31 && rootWindowInsets != null) {
                            ...
                            if (roundedCorner2 == null) {
                                ...
                                colorProvider.setRadius(AndroidUtilities.dp(29.0f), AndroidUtilities.dp(29.0f), i2, i3, true);
                        ...
                        colorProvider2.setRadius(AndroidUtilities.dp(29.0f), AndroidUtilities.dp(29.0f), i2, i3, true);
                        this.blurredBackgroundDrawable.enableInAppKeyboardOptimization();
                        this.blurredBackgroundDrawable.setThickness(AndroidUtilities.dp(32.0f));
                        this.blurredBackgroundDrawable.setIntensity(0.4f);
                    }
            ...
            protected boolean onScrollYChange(int i2) {
                ...
                CaptionContainerView.this.scrollAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.3.2
        ...
        editTextEmoji.getEditText().addTextChangedListener(new 4());
        ...
        this.applyButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView$$ExternalSyntheticLambda4
            ...
            public final void onClick(View view) {
                CaptionContainerView.this.done();
            }
        });
    ...
    class 4 implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void createMentionsContainer() {
        ...
        this.mentionContainer.withDelegate(new MentionsContainerView.Delegate() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.6
        ...
        if (z2) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView$$ExternalSyntheticLambda5
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    CaptionContainerView.$r8$lambda$COvKjtoO1oTZZYcVT8CGOK_z6hI(CaptionContainerView.this, valueAnimator2);
                }
            });
            if (!z) {
                this.editText.getEditText().setAllowDrawCursor(false);
            }
            this.keyboardAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.7
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    if (!z) {
    ...
    public static /* synthetic */ void $r8$lambda$COvKjtoO1oTZZYcVT8CGOK_z6hI(CaptionContainerView captionContainerView, ValueAnimator valueAnimator) {
    ...
    */
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (isAtTop()) {
            if (!this.collapsed) {
                float lerp = AndroidUtilities.lerp(AndroidUtilities.dpf2(-1.0f), AndroidUtilities.dpf2(1.0f), this.keyboardT);
                EditTextCaption editText = this.editText.getEditText();
            ...
            float f2 = dp2;
            float f3 = dp3;
            this.bounds.set(f2, f3, getWidth() - dp2, dp3 + i);
            this.clickBounds.set(f2, f3, getWidth() - dp2, r5 + AndroidUtilities.dp(24.0f));
        } else {
            float lerp2 = (AndroidUtilities.lerp(AndroidUtilities.dpf2(1.0f), AndroidUtilities.dpf2(-1.0f), this.keyboardT) + f) - i;
            if (Math.abs(this.lastHeightTranslation - lerp2) >= 1.0f && !this.collapsed) {
                EditTextCaption editText2 = this.editText.getEditText();
                this.lastHeightTranslation = lerp2;
                editText2.setTranslationY(lerp2);
            }
            this.bounds.set(dp2, (getHeight() - dp3) - i, getWidth() - dp2, getHeight() - dp3);
        ...
        float lerp3 = AndroidUtilities.lerp(AndroidUtilities.dp(21.0f), 0, this.keyboardT * (1.0f - forceRound()));
        BlurredBackgroundDrawableViewFactory blurredBackgroundDrawableViewFactory = this.factoryForMentions;
        if (blurredBackgroundDrawableViewFactory != null) {
            if (this.backgroundForCaptionField == null) {
                this.backgroundForCaptionField = blurredBackgroundDrawableViewFactory.create(this).setColorProvider(BlurredBackgroundProviderImpl.photoViewer(this.resourcesProvider)).setPadding(AndroidUtilities.dp(5.0f)).setRadius(AndroidUtilities.dp(22.0f));
            }
            ...
            drawBlur(this.backgroundBlur, canvas, this.bounds, lerp3, false, 0.0f, 0.0f, true, 1.0f);
            this.backgroundPaint.setAlpha(AndroidUtilities.lerp(38, 64, this.keyboardT));
            canvas.drawRoundRect(this.bounds, lerp3, lerp3, this.backgroundPaint);
        } else {
            ...
            if (paints == null || paints[1] == null) {
                ...
                if (paint != null) {
                    canvas.drawRoundRect(this.bounds, lerp3, lerp3, paint);
                }
                Paint paint2 = paints[1];
                if (paint2 != null) {
                    canvas.drawRoundRect(this.bounds, lerp3, lerp3, paint2);
                }
        ...
        invalidateDrawOver2();
        if (f5 > 0.0f) {
            canvas.saveLayerAlpha(this.bounds, NotificationCenter.didReceiveSmsCode, 31);
        }
        drawReply(canvas);
        ...
        if (f5 > 0.0f) {
            ...
            RectF rectF2 = this.bounds;
            float distance = MathUtils.distance(rectF2.left, rectF2.top, dp, dp4);
            RectF rectF3 = this.bounds;
            float max = Math.max(distance, MathUtils.distance(rectF3.left, rectF3.bottom, dp, dp4));
            RectF rectF4 = this.bounds;
            float distance2 = MathUtils.distance(rectF4.right, rectF4.top, dp, dp4);
            RectF rectF5 = this.bounds;
            float max2 = Math.max(max, Math.max(distance2, MathUtils.distance(rectF5.right, rectF5.bottom, dp, dp4))) * f5;
            ...
            canvas.save();
            canvas.drawRoundRect(this.bounds, lerp3, lerp3, this.collapsePaint);
            canvas.restore();
            canvas.restore();
            canvas.saveLayerAlpha(this.bounds, NotificationCenter.didReceiveSmsCode, 31);
            ...
            canvas.save();
            canvas.drawRoundRect(this.bounds, lerp3, lerp3, this.collapseOutPaint);
            canvas.restore();
            canvas.restore();
        ...
        if (this.factoryForMentions == null) {
            ...
            this.clipPath.addRoundRect(this.bounds, lerp3, lerp3, Path.Direction.CW);
            canvas.save();
            canvas.clipPath(this.clipPath);
            StrokeDrawable strokeDrawable = this.strokeDrawable;
            strokeDrawable.radius = lerp3;
    ...
    public void drawHint(Canvas canvas, Runnable runnable) {
        if (customBlur()) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.hintTextBitmap.getWidth(), this.hintTextBitmap.getHeight(), NotificationCenter.didReceiveSmsCode, 31);
            ...
            canvas.save();
            this.hintTextBitmapPaint.setAlpha(NotificationCenter.didStartedCall);
        ...
        EditTextCaption editText = this.editText.getEditText();
        canvas.saveLayerAlpha(0.0f, 0.0f, editText.getWidth(), editText.getHeight(), NotificationCenter.didReceiveSmsCode, 31);
        runnable.run();
    ...
    public void drawBackground(Canvas canvas, RectF rectF, float f, float f2, View view) {
        ...
        this.backgroundPaint.setAlpha((int) (this.blurPaint == null ? 128.0f : f2 * AndroidUtilities.lerp(128, NotificationCenter.messagePlayingGoingToStop, this.keyboardT)));
