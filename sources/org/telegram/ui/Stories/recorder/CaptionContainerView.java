...
public abstract class CaptionContainerView extends FrameLayout {
    ...
    public void drawHint(Canvas canvas, Runnable runnable) {
        if (!customBlur()) {
            ...
            EditTextCaption editText = this.editText.getEditText();
            canvas.saveLayerAlpha(0.0f, 0.0f, editText.getWidth(), editText.getHeight(), NotificationCenter.reloadInterface, 31);
            runnable.run();
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, this.hintTextBitmap.getWidth(), this.hintTextBitmap.getHeight(), NotificationCenter.reloadInterface, 31);
    ...
    */
    protected void dispatchDraw(Canvas canvas) {
        ...
        invalidateDrawOver2();
        if (f7 > 0.0f) {
            canvas.saveLayerAlpha(this.bounds, NotificationCenter.reloadInterface, 31);
        }
        drawReply(canvas);
