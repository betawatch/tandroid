...
public abstract class CaptionContainerView extends FrameLayout {
    ...
    class 4 implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    CaptionContainerView.4.this.lambda$afterTextChanged$0();
                }
            });
        }
    ...
    private void drawReply(Canvas canvas) {
        ...
        if (paint2 != null) {
            ...
            canvas.saveLayerAlpha(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, NotificationCenter.invalidateMotionBackground, 31);
        }
    ...
    */
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (isAtTop()) {
            ...
            float lerp2 = (AndroidUtilities.lerp(AndroidUtilities.dpf2(1.0f), AndroidUtilities.dpf2(-1.0f), this.keyboardT) + f2) - i2;
        ...
        if (f6 > 0.0f) {
            ...
            float max2 = Math.max(max, Math.max(distance2, MathUtils.distance(rectF5.right, rectF5.bottom, dp, dp4))) * f6;
    ...
    public void drawHint(Canvas canvas, Runnable runnable) {
        if (customBlur()) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.hintTextBitmap.getWidth(), this.hintTextBitmap.getHeight(), NotificationCenter.invalidateMotionBackground, 31);
            ...
            canvas.save();
            this.hintTextBitmapPaint.setAlpha(NotificationCenter.groupCallUpdated);
        ...
        EditTextCaption editText = this.editText.getEditText();
        canvas.saveLayerAlpha(0.0f, 0.0f, editText.getWidth(), editText.getHeight(), NotificationCenter.invalidateMotionBackground, 31);
        runnable.run();
    ...
    public void drawBackground(Canvas canvas, RectF rectF, float f, float f2, View view) {
        ...
        this.backgroundPaint.setAlpha((int) (this.blurPaint == null ? 128.0f : f2 * AndroidUtilities.lerp(128, NotificationCenter.recordProgressChanged, this.keyboardT)));
