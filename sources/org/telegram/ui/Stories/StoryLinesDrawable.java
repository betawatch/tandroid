...
public class StoryLinesDrawable {
    ...
    public void draw(Canvas canvas, int i, int i2, float f, int i3, float f2, float f3, boolean z, boolean z2, float f4) {
        ...
        if (f8 > 0.0f) {
            ...
            canvas.translate(((i6 - storyLinesDrawable.zoomHintLayoutWidth) / 2.0f) - storyLinesDrawable.zoomHintLayoutLeft, AndroidUtilities.lerp(AndroidUtilities.dp(4.0f), AndroidUtilities.dp(16.0f), f8));
            ...
            if (dp3 <= i6) {
                ...
                if (f10 >= 0.0f && f3 > 0.0f) {
                    ...
                    if (i8 > i2 || i8 != i2) {
                        ...
                        i4 = dp;
                        f6 = min;
                        rectF.set(dp3, 0.0f, f10, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i8 ? 1 : 0) * f8));
                        if (z3) {
                        ...
                        if (f8 > 0.0f) {
                            int i9 = i8 - i2;
                            rectF.left = Utilities.clamp(AndroidUtilities.lerp(rectF.left, (i9 * i) + AndroidUtilities.dp(5.0f), f8), i - AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
                            rectF.right = Utilities.clamp(AndroidUtilities.lerp(rectF.right, ((i9 + 1) * i) - AndroidUtilities.dp(5.0f), f8), i - AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
                        }
                        canvas.drawRoundRect(rectF, lerp2, lerp2, paint2);
                        f7 = f9;
                    }
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    rectF2.set(dp3, 0.0f, f10, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i8 ? 1 : 0) * f8));
                    if (f8 > 0.0f) {
                        int i10 = i8 - i2;
                        rectF2.left = Utilities.clamp(AndroidUtilities.lerp(rectF2.left, (i10 * i) + AndroidUtilities.dp(5.0f), f8), i - AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
                        rectF2.right = Utilities.clamp(AndroidUtilities.lerp(rectF2.right, ((i10 + 1) * i) - AndroidUtilities.dp(5.0f), f8), i - AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
                    }
                    ...
                    canvas.drawRoundRect(rectF2, lerp2, lerp2, paint);
                    i8++;
