...
public final class vk0 extends org.telegram.ui.Components.ul0 {
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i38 == 0) {
            ...
            if (i10 == notificationsSettingsActivity.x) {
                n4Var.setText(LocaleController.getString("NotificationsForChats", R.string.NotificationsForChats));
                return;
            }
            if (i10 == notificationsSettingsActivity.E) {
                n4Var.setText(LocaleController.getString("InAppNotifications", R.string.InAppNotifications));
                return;
            }
            if (i10 == notificationsSettingsActivity.K) {
                n4Var.setText(LocaleController.getString("Events", R.string.Events));
                return;
            }
            if (i10 == notificationsSettingsActivity.M) {
                n4Var.setText(LocaleController.getString("NotificationsOther", R.string.NotificationsOther));
                return;
            }
            if (i10 == notificationsSettingsActivity.S) {
                n4Var.setText(LocaleController.getString("Reset", R.string.Reset));
                return;
            }
            if (i10 == notificationsSettingsActivity.G) {
                n4Var.setText(LocaleController.getString("VoipNotificationSettings", R.string.VoipNotificationSettings));
                return;
            } else if (i10 == notificationsSettingsActivity.N) {
                n4Var.setText(LocaleController.getString("BadgeNumber", R.string.BadgeNumber));
                return;
            } else {
                if (i10 == notificationsSettingsActivity.r) {
                    n4Var.setText(LocaleController.getString("ShowNotificationsFor", R.string.ShowNotificationsFor));
                    return;
                }
                return;
            }
        ...
        if (i10 == i26) {
            ...
            if (i10 != i27) {
                ...
                k5Var.b(str, sb2, i32, z11, i33, false, i10 != i36, false);
            }
        ...
        if (z10) {
            ...
            i36 = notificationsSettingsActivity.reactionsRow;
            k5Var.b(str, sb22, i32, z11, i33, false, i10 != i36, false);
        }
        str = string;
        i33 = 0;
        ...
        i36 = notificationsSettingsActivity.reactionsRow;
        k5Var.b(str, sb222, i32, z11, i33, false, i10 != i36, false);
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            n4Var = new org.telegram.ui.Cells.x8(context, f6Var2);
        } else if (i10 == 2) {
            n4Var = new org.telegram.ui.Cells.e9(context);
        } else if (i10 == 3) {
            f6Var3 = ((org.telegram.ui.ActionBar.n2) notificationsSettingsActivity).resourceProvider;
            n4Var = new org.telegram.ui.Cells.k5(21, 64, this.c, f6Var3, true);
        } else if (i10 == 4) {
            ...
            n4Var = new org.telegram.ui.Cells.f9(context, f6Var5);
        } else {
            f6Var4 = ((org.telegram.ui.ActionBar.n2) notificationsSettingsActivity).resourceProvider;
            n4Var = new org.telegram.ui.Cells.fa(context, 0, f6Var4);
        }
