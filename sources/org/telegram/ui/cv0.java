...
public final class cv0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        if (SharedConfig.messageSeenHintCount > 0 && qnVar.T0.getKeyboardHeight() < AndroidUtilities.dp(20.0f)) {
            org.telegram.ui.Components.gc t10 = new org.telegram.ui.Components.oc(org.telegram.ui.Components.cb.a(iv0Var.getContext()), iv0Var.b).t(AndroidUtilities.replaceTags(LocaleController.getString(R.string.MessageSeenTooltipMessage)), null);
            qnVar.j1 = t10;
            t10.j = 4000;
            t10.j();
