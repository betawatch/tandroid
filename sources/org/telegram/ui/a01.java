...
public final class a01 extends org.telegram.ui.Components.aw0 implements r0.m {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.translate(wy0Var != null ? wy0Var.getTranslationX() : 0.0f, 0.0f);
        int v03 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, profileActivity.z0);
        int i13 = profileActivity.l6;
        wy0 wy0Var2 = profileActivity.a;
        AndroidUtilities.drawNavigationBarProtection(canvas, this, v03, i13, wy0Var2 != null ? wy0Var2.getAlpha() : 0.0f);
        canvas.restore();
    }
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        if (profileActivity.g5 != null) {
            ...
            h5Var.setRightPadding(h5Var.getMeasuredWidth() - profileActivity.g5.n().getTitleTextView().getMeasuredWidth());
        }
        ...
        if (!z15 && ((z14 = profileActivity.n1) || (profileActivity.G1 && profileActivity.J1 == 2))) {
            ...
            wy0 wy0Var2 = profileActivity.a;
            wy0Var2.layout(0, i16, wy0Var2.getMeasuredWidth(), profileActivity.a.getMeasuredHeight() + i16);
            this.y0 = false;
            ...
            if (view == null && (view = profileActivity.a.getChildAt(0)) != null) {
                wy0 wy0Var3 = profileActivity.a;
                View F = wy0Var3.F(view);
                s4.c1 T = F == null ? null : wy0Var3.T(F);
                i12 = T.b();
                if (i12 == -1 && (i12 = T.g) == -1) {
                    i12 = T.c;
                }
                    ...
                    if (i21 >= 0) {
                        ...
                        if ((z10 && profileActivity.o2) || view == null) {
                            ...
                            if (z12) {
                                measureChildWithMargins(profileActivity.a, i10, 0, i11, 0);
                                try {
                                    wy0 wy0Var4 = profileActivity.a;
                                    wy0Var4.layout(0, i16, wy0Var4.getMeasuredWidth(), profileActivity.a.getMeasuredHeight() + i16);
                                } catch (Exception e) {
                                    FileLog.e(e);
                                }
                            }
