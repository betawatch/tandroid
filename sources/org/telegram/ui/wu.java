...
public final class wu extends LinearLayout {
    public final ta1 a;
    public f2.k0 b;
    public final org.telegram.ui.Components.yo c;
    public final org.telegram.ui.Components.oi0 d;
    public final org.telegram.ui.Cells.l8 e;
    public final org.telegram.ui.Cells.l8 f;
    ...
    public wu(int i10, Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        if (i10 == 0) {
            ...
            this.e = l8Var;
            l8Var.setBackground(org.telegram.ui.ActionBar.g6.f0(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.i6, false), 2, -1));
            l8Var.w = 21;
        ...
        if (!MediaDataController.getInstance(n2Var.getCurrentAccount()).defaultEmojiThemes.isEmpty()) {
            ...
            if (i10 == 0) {
                ...
                zoVar.c = org.telegram.ui.ActionBar.g6.f1() ? 0 : 2;
                arrayList.add(zoVar);
            }
            yoVar.d = arrayList;
            yoVar.l();
    ...
    public final void a() {
        ...
        if (i10 == 0 || i10 == -1) {
            ...
            if (l8Var != null) {
                org.telegram.ui.ActionBar.g6.B1(l8Var.getBackground(), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.i6, false), true);
                l8Var.e(-1, org.telegram.ui.ActionBar.g6.q6);
            }
            org.telegram.ui.Cells.l8 l8Var2 = this.f;
            if (l8Var2 != null) {
                l8Var2.setBackground(org.telegram.ui.ActionBar.g6.g0(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.i6, false)));
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.yo yoVar = this.c;
        if (yoVar.d != null) {
            for (int i13 = 0; i13 < yoVar.d.size(); i13++) {
                ((org.telegram.ui.Components.zo) yoVar.d.get(i13)).c = this.v;
            }
    ...
    public final void d() {
        ...
        while (true) {
            ...
            TLRPC.TL_theme tL_theme = ((org.telegram.ui.ActionBar.a4) ((org.telegram.ui.Components.zo) yoVar.d.get(i10)).a.f.get(this.v)).b;
            org.telegram.ui.ActionBar.f6 j10 = ((org.telegram.ui.Components.zo) yoVar.d.get(i10)).a.j(this.v);
            if (tL_theme != null) {
                if (org.telegram.ui.ActionBar.g6.I.a.equals(org.telegram.ui.ActionBar.g6.q0(tL_theme.settings.get(((org.telegram.ui.ActionBar.a4) ((org.telegram.ui.Components.zo) yoVar.d.get(i10)).a.f.get(this.v)).d)))) {
                ...
                if (j10 != null) {
                    if (org.telegram.ui.ActionBar.g6.I.a.equals(j10.m())) {
                        if (((org.telegram.ui.ActionBar.a4) ((org.telegram.ui.Components.zo) yoVar.d.get(i10)).a.f.get(this.v)).e == org.telegram.ui.ActionBar.g6.I.U) {
                            this.r = i10;
                            break;
                        }
                    } else {
        ...
        if (this.r == -1 && this.s != 3) {
            this.r = yoVar.d.size() - 1;
        }
        int i11 = 0;
        while (i11 < yoVar.d.size()) {
            ((org.telegram.ui.Components.zo) yoVar.d.get(i11)).d = i11 == this.r;
            i11++;
        }
        yoVar.E(this.r);
    }
