...
public final class wu extends org.telegram.ui.Components.yl0 {
    ...
    public wu(av avVar, Activity activity) {
        ...
        iVar = ((org.telegram.ui.ActionBar.n2) avVar).glassEngine;
        iVar.a(this);
        ...
        li.b.a(this, avVar.h, avVar.n, AndroidUtilities.dp(42.0f) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight());
    }
    ...
    public final void B1(boolean z10) {
        ...
        while (true) {
            ...
            if (j11 > j10 || z11) {
                ...
                int i17 = av.v[i15];
                int[] iArr = av.r[i15];
                arrayList3.add(new ru(i14, i17, iArr[0], iArr[1], j11 == j10 ? LocaleController.getString(av.w[i15]) : TextUtils.concat(LocaleController.getString(av.w[i15]), "  ", spannableString3), AndroidUtilities.formatFileSize(j11)));
            }
            i14++;
            j3 = j10;
            i13 = 1;
