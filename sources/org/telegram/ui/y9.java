...
public final class y9 extends org.telegram.ui.ActionBar.n2 {
    ...
    public static void U(y9 y9Var) {
        ...
        if (currentUser == null || y9Var.b.getText() == null || y9Var.a.getText() == null) {
            return;
        }
        String obj = y9Var.a.getText().toString();
        String obj2 = y9Var.b.getText().toString();
    ...
    public final View createView(Context context) {
        ...
        linearLayout.addView(this.a, h7.z5.k(24.0f, 24.0f, 24.0f, 0.0f, -1, 36));
        final int i16 = 0;
        this.a.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.w9
        ...
        linearLayout.addView(this.b, h7.z5.k(24.0f, 16.0f, 24.0f, 0.0f, -1, 36));
        final int i17 = 1;
        this.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.w9
            public final /* synthetic */ y9 b;
                ...
                switch (i17) {
                    case 0:
                        if (i172 == 5) {
                            ...
                            y9Var.b.requestFocus();
                            x9 x9Var52 = y9Var.b;
                            x9Var52.setSelection(x9Var52.length());
                            break;
                        }
                        break;
                    default:
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        x9 x9Var2 = this.a;
        int i11 = org.telegram.ui.ActionBar.g6.H6;
        arrayList.add(new org.telegram.ui.ActionBar.i6(x9Var2, TLObject.FLAG_23, null, null, null, null, i11));
        x9 x9Var3 = this.a;
