...
public class iv0 {
    ...
    public iv0(ViewGroup viewGroup, ViewGroup viewGroup2) {
        ...
        if (motionEvent.getActionMasked() == 0 || motionEvent.getActionMasked() == 5) {
            ...
            if (hypot <= 1.005f || this.n) {
                ...
                if (hv0Var != null || z10) {
                    ...
                    i13 = -1;
                    hv0 hv0Var2 = new hv0(this, viewGroup2.getContext());
                    this.d = hv0Var2;
                    hv0Var2.setFocusable(false);
                ...
                if (z10) {
                    ...
                    if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                        ...
                        hv0 hv0Var3 = this.d;
                        mediaController.setTextureView(hv0Var3.b, hv0Var3.c, hv0Var3.a, true);
                        ...
                        ev0 ev0Var = this.E;
                        if (ev0Var != null) {
                            this.d.d.setImageBitmap(ev0Var.j0().getBitmap((int) this.z, (int) this.y));
    ...
    public final void b() {
        ...
        hv0 hv0Var = this.d;
        if (hv0Var != null && hv0Var.getParent() != null) {
    ...
    public final void d() {
        if (this.C == null && this.n) {
            ...
            this.C.addListener(new wq0(this, 10));
