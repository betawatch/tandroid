...
public final class mg0 extends FrameLayout {
    ...
    public final View d;
    public final View e;
    public final org.telegram.ui.Components.g31 f;
    ...
    public mg0(Context context, ViewGroup viewGroup, View view, String str, final wg0 wg0Var) {
        ...
        final int i13 = 1;
        f11.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.kg0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view4) {
                switch (i13) {
                    case 0:
    ...
    public final void b() {
        ...
        org.telegram.ui.Components.g31 g31Var = this.f;
        g31Var.setColor(w02);
