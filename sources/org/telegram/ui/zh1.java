...
public final class zh1 {
    ...
    public final String b() {
        ...
        if (lowerCase == null || lowerCase3 == null) {
            if (lowerCase != null) {
                String y8 = a4.w.y(lowerCase2, "-", lowerCase);
                if (this.g != null) {
                    StringBuilder f9 = u3.c.f(y8, "&rotation=");
                    f9.append(AndroidUtilities.getWallpaperRotation(this.f, true));
                    lowerCase2 = f9.toString();
                } else {
            ...
            lowerCase2 = a4.w.q(sb2, "~", lowerCase4);
        } else {
            lowerCase2 = lowerCase2 + "~" + lowerCase + "~" + lowerCase3;
        }
        if (this.g == null) {
            return a4.w.o(MessagesController.getInstance(UserConfig.selectedAccount).linkPrefix, "/bg/", lowerCase2, new StringBuilder("https://"));
        }
        ...
        return this.j ? u3.c.k(str, "&mode=motion") : str;
    }
