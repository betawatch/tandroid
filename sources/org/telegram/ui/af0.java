...
public final class af0 extends org.telegram.ui.Components.fw0 {
    ...
    */
    public af0(xg0 xg0Var, Context context) {
        super(context);
        int i10;
        this.y = xg0Var;
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                for (hs hsVar : de0Var.f) {
                    ...
                    hsVar.addTextChangedListener(new m0(this, 8));
                    hsVar.setOnFocusChangeListener(new qd(this, 6));
                }
                addView(this.a, w7.a6.t(-2, 42, 1, 0, 32, 0, 0));
                ...
                oVar.setMaxLines(2);
                oVar.setOnClickListener(new l60(this, 6));
                FrameLayout frameLayout2 = new FrameLayout(context);
                frameLayout2.addView(oVar, w7.a6.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        ...
        oVar2.setMaxLines(2);
        oVar2.setOnClickListener(new l60(this, 6));
        FrameLayout frameLayout22 = new FrameLayout(context);
        frameLayout22.addView(oVar2, w7.a6.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        addView(frameLayout22, w7.a6.l(1.0f, -1, 0));
        og.u0.e(oVar2);
    }
    ...
    @Override // org.telegram.ui.Components.fw0
    public final void j() {
        AndroidUtilities.runOnUIThread(new ye0(this, 0), xg0.t0);
    }
