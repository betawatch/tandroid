...
public final class lz extends LinearLayout {
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.x9 x9Var2 = this.c;
        ...
        if (z11) {
            ...
            frameLayout.animate().scaleX(z10 ? 0.0f : 1.0f).scaleY(z10 ? 0.0f : 1.0f).alpha(z10 ? 0.0f : 1.0f).setInterpolator(prVar).setDuration(320L).start();
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.r, z10 ? 1.0f : 0.0f);
            this.n = ofFloat;
            ofFloat.addUpdateListener(new c3(this, 11));
            this.n.addListener(new to(28, this, z10));
            ...
            x9Var2.invalidate();
            x9Var.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.r, org.telegram.ui.ActionBar.j6.v0(i10, f6Var), org.telegram.ui.ActionBar.j6.v0(i11, f6Var)), mode));
            x9Var.invalidate();
        }
        if (z10) {
            x9Var = x9Var2;
