...
public final class pu0 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i9) {
        ...
        if (i9 == 1) {
            ...
            if (xu0Var.H && xu0Var.a.getAlpha() != 1.0f) {
                int i21 = 0;
                ...
                if (i21 <= 0) {
                    ...
                    for (int i22 = xu0Var.j0; i22 < xu0Var.j0 + xu0Var.y; i22++) {
                        f2.q1 K = xu0Var.c.K(i22);
                        if (K != null) {
                            View view = K.a;
            ...
            ArrayList arrayList = new ArrayList(xu0Var.n);
            int i24 = 0;
            while (i24 < charSequenceArr.length) {
                if (!TextUtils.isEmpty(org.telegram.ui.Components.jn.X(charSequenceArr[i24]))) {
                    CharSequence[] charSequenceArr5 = new CharSequence[1];
                    charSequenceArr5[i16] = org.telegram.ui.Components.jn.X(charSequenceArr[i24]);
            ...
            if (qnVar.c()) {
                ...
                xu0Var.a0.b(tL_messageMediaPoll);
                xu0Var.finishFragment();
            }
        }
    }
