...
public final class bt0 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        if (bitmap != null || photoViewer.o1) {
            photoViewer.z1.b(bitmap, photoViewer.z4.getOrientation(), photoViewer.Z1 != 1, false, photoViewer.A1, photoViewer.o1 ? (org.telegram.ui.Components.w61) photoViewer.y2 : null, xt0Var.c);
            photoViewer.z1.a();
            int bitmapWidth = photoViewer.z4.getBitmapWidth();
            int bitmapHeight = photoViewer.z4.getBitmapHeight();
            MediaController.CropState cropState = xt0Var.c;
            if (cropState != null) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer.R0, (Property<org.telegram.ui.Components.xf0, Float>) View.TRANSLATION_Y, AndroidUtilities.dp(48.0f), 0.0f), ObjectAnimator.ofFloat(photoViewer, org.telegram.ui.Components.n6.g, 0.0f, 1.0f), ObjectAnimator.ofFloat(photoViewer.z1, (Property<org.telegram.ui.Components.ye0, Float>) View.ALPHA, 0.0f, 1.0f));
        photoViewer.m6.setDuration(200L);
        photoViewer.m6.addListener(new ls0(this, 1));
