...
public final class ry extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a() {
        ...
        this.s.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.w0(null, i10, false), PorterDuff.Mode.SRC_IN));
    ...
    public final void b() {
        ...
        while (true) {
            ...
            hashMap.put(((qy) arrayList.get(i11)).c, (qy) arrayList.get(i11));
    ...
    public final void c() {
        ...
        while (true) {
            ...
            j10 += ((qy) arrayList.get(i10)).a;
            j11 += ((qy) arrayList.get(i10)).b;
            i10++;
        }
        if (j10 == 0) {
            this.e = 1.0f;
