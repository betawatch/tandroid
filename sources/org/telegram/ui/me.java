...
public final /* synthetic */ class me implements Runnable {
    ...
    public /* synthetic */ me(rn rnVar, MessageObject messageObject, int i10) {
        this.a = i10;
        this.b = rnVar;
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                messageObject2.messageOwner.destroyTimeMillis = rnVar.getConnectionsManager().getCurrentTimeMillis() + (i11 * 1000);
                if (rnVar.h == null) {
            ...
            case 3:
                ...
                rnVar3.Xa(messageObject3.getReplyMsgId(), messageObject3.messageOwner.id, true, messageObject3.getDialogId() == rnVar3.H6 ? 1 : 0, false, 0, null, ((TLRPC.TL_messageActionPollAppendAnswer) messageObject3.messageOwner.action).answer.option, null);
                break;
            case 4:
                rn rnVar4 = this.b;
                rnVar4.getClass();
                MessageObject messageObject4 = this.c;
                rnVar4.Xa(messageObject4.getReplyMsgId(), messageObject4.messageOwner.id, true, messageObject4.getDialogId() == rnVar4.H6 ? 1 : 0, false, 0, null, null, null);
                break;
            case 5:
                rn rnVar5 = this.b;
                rnVar5.getClass();
                MessageObject messageObject5 = this.c;
                rnVar5.j(messageObject5.getReplyMsgId(), messageObject5.messageOwner.id, true, messageObject5.getDialogId() == rnVar5.H6 ? 1 : 0, false, 0);
                break;
            case 6:
                rn rnVar6 = this.b;
                rnVar6.getClass();
            ...
            case 7:
                rn rnVar7 = this.b;
                rnVar7.getMessagesController().pinMessage(rnVar7.e, rnVar7.f, this.c.getId(), true, false, false);
                rnVar7.w3 = null;
                break;
            default:
                rn rnVar8 = this.b;
