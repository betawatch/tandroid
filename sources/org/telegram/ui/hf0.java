...
public final /* synthetic */ class hf0 implements Runnable {
    ...
    public /* synthetic */ hf0(KeyEvent.Callback callback, TLObject tLObject, Object obj, int i10) {
        this.a = i10;
        this.b = callback;
        this.c = tLObject;
        this.d = obj;
        ...
        switch (this.a) {
            case 0:
                ...
                if (tL_error == null) {
                    ...
                    i15 = ((org.telegram.ui.ActionBar.p2) ng0Var).currentAccount;
                    ...
                    ng0Var.getMessagesController().removeSuggestion(0L, "VALIDATE_PHONE_NUMBER");
                    if (i24 == 3) {
                        AndroidUtilities.endIncomingCall();
                    }
                    rf0Var.q(new ef0(rf0Var, 5));
                    break;
                } else {
                    rf0Var.b0 = tL_error.text;
                    rf0Var.a0 = false;
            ...
            case 1:
                ...
                rf0Var2.p0.g1(bundle, tL_auth_sentCode, true);
                break;
            case 2:
                ...
                ph.d dVar = wf0Var.b;
                ng0 ng0Var2 = wf0Var.v;
                wf0Var.s = -1;
                if (tLObject3 instanceof TLRPC.auth_SentCode) {
                    wf0Var.f = false;
                    dVar.setLoading(false);
                    org.telegram.ui.ActionBar.e5 parentLayout = ng0Var2.getParentLayout();
                    if (parentLayout != null && parentLayout.getFragmentStack() != null) {
                        List fragmentStack = parentLayout.getFragmentStack();
                        org.telegram.ui.ActionBar.p2 p2Var = fragmentStack.isEmpty() ? null : (org.telegram.ui.ActionBar.p2) yh.k(1, fragmentStack);
                        ...
                        while (i29 < size) {
                            ...
                            if ((p2Var2 instanceof jo0) && p2Var2 != p2Var) {
                        ...
                        if (p2Var instanceof jo0) {
                            ...
                            ng0Var2.g1(wf0Var.d, (TLRPC.auth_SentCode) tLObject3, z10);
                            break;
                        }
                    }
                    z10 = true;
                    ...
                    if (str2 == null || !str2.startsWith("FLOOD_WAIT_")) {
                        ...
                        if (str3 == null || !"PHONE_CODE_EXPIRED".equalsIgnoreCase(str3)) {
                            wf0Var.e = tL_error2.text;
                            wf0Var.f = false;
                            dVar.setLoading(false);
                            new org.telegram.ui.Components.qc(ng0Var2.W, null).H(R.raw.error, LocaleController.formatString(R.string.UnknownErrorCode, tL_error2.text));
                            break;
                        } else {
                        ...
                        AndroidUtilities.runOnUIThread(new tf0(wf0Var, 2), Integer.parseInt(tL_error2.text.substring(11)) * MediaDataController.MAX_STYLE_RUNS_COUNT);
                        break;
                    }
                }
                break;
            case 3:
                wf0 wf0Var2 = (wf0) this.b;
                ...
                ng0 ng0Var3 = wf0Var2.v;
                ng0Var3.e = true;
                ng0 ng0Var4 = (ng0) LaunchActivity.N();
                if (ng0Var4 == null) {
                    i16 = ((org.telegram.ui.ActionBar.p2) ng0Var3).currentAccount;
                    ng0Var4 = new ng0(i16);
                    org.telegram.ui.ActionBar.p2 U = LaunchActivity.U();
                    if (U != null) {
                        U.presentFragment(ng0Var4);
                    }
                }
                ng0Var4.q1(tL_inputStorePaymentAuthCode.phone_number, tL_updateSentPhoneCode.sent_code);
                break;
            case 4:
            ...
            case 5:
                ...
                if (tL_error3 != null) {
                    ...
                    ph0 ph0Var2 = ph0Var.p0.a;
                    int i31 = 0;
                    while (true) {
                        ArrayList arrayList5 = ph0Var2.g0;
            ...
            case 6:
                AndroidUtilities.runOnUIThread(new fe0(15, (org.telegram.ui.Components.vk) this.c, MessagesStorage.getInstance(((sj0) this.b).currentAccount).getUser(((TLRPC.TL_contact) this.d).user_id)));
                break;
            case 7:
                sj0.m((sj0) this.b, (TLObject) this.c, (org.telegram.ui.Components.vk) this.d);
                break;
            case 8:
                ...
                if (lowerCase.length() == 0) {
                    AndroidUtilities.runOnUIThread(new a30(gk0Var, new ArrayList(), new ArrayList(), new ArrayList(), 16));
                    break;
                } else {
                    ...
                    while (i33 < arrayList6.size()) {
                        jk0 jk0Var = (jk0) arrayList6.get(i33);
                        if (DialogObject.isEncryptedDialog(jk0Var.d)) {
                            TLRPC.EncryptedChat n10 = org.telegram.messenger.y3.n(notificationsCustomSettingsActivity.getMessagesController(), jk0Var.d);
                            if (n10 != null) {
                                strArr = strArr2;
                                c3 = 0;
                            ...
                            if (DialogObject.isUserDialog(jk0Var.d)) {
                                TLRPC.User user3 = notificationsCustomSettingsActivity.getMessagesController().getUser(Long.valueOf(jk0Var.d));
                                ...
                                TLRPC.Chat chat2 = notificationsCustomSettingsActivity.getMessagesController().getChat(Long.valueOf(-jk0Var.d));
                                if (chat2 != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new a30(gk0Var, arrayList8, arrayList9, arrayList7, 16));
                    break;
                }
                break;
            case 9:
            ...
            case 10:
                ...
                if (tL_error4 == null) {
                    ...
                    alertDialog$Builder.k(LocaleController.getString(R.string.OK), new tl0(i22, dn0Var, tL_auth_passwordRecovery));
                    Dialog showDialog = dn0Var.showDialog(alertDialog$Builder.a);
                    if (showDialog != null) {
                    ...
                    dn0Var.M1(LocaleController.getString(R.string.AppName), tL_error4.text);
                    break;
                }
                break;
            case 11:
                ((rm0) this.b).D(((TLRPC.TL_error) this.d).text, (String) this.c);
                break;
            case 12:
                ...
                secureRandom.setSeed(dn0Var2.G.secure_random);
                TL_account.updatePasswordSettings updatepasswordsettings = new TL_account.updatePasswordSettings();
                TL_account.Password password = dn0Var2.G;
                ...
                byte[] p12 = dn0.p1();
                dn0Var2.Z0 = p12;
                dn0Var2.Y0 = Utilities.bytesToLong(Utilities.computeSHA256(p12));
                TLRPC.SecurePasswordKdfAlgo securePasswordKdfAlgo = dn0Var2.G.new_secure_algo;
                if (securePasswordKdfAlgo instanceof TLRPC.TL_securePasswordKdfAlgoPBKDF2HMACSHA512iter100000) {
                    ...
                    dn0Var2.b1 = computePBKDF2;
                    byte[] bArr2 = new byte[32];
                    System.arraycopy(computePBKDF2, 0, bArr2, 0, 32);
                    byte[] bArr3 = new byte[16];
                    System.arraycopy(dn0Var2.b1, 32, bArr3, 0, 16);
                    byte[] bArr4 = dn0Var2.Z0;
                    ...
                    tL_secureSecretSettings.secure_secret = dn0Var2.Z0;
                    tL_secureSecretSettings.secure_secret_id = dn0Var2.Y0;
                    passwordinputsettings.flags |= 4;
                }
                i18 = ((org.telegram.ui.ActionBar.p2) dn0Var2).currentAccount;
                ConnectionsManager.getInstance(i18).sendRequest(updatepasswordsettings, new nm0(pm0Var, i22));
                break;
            case 13:
                ...
                int i34 = zm0Var.I;
                dn0 dn0Var3 = zm0Var.N;
                dn0Var3.x1();
                zm0Var.G = false;
                if (tL_error5 == null) {
                    zm0Var.s();
                    zm0Var.r();
                    ((gm0) dn0Var3.y1).c(dn0Var3.B, (String) dn0Var3.p1.get("phone"), null, null, null, null, null, null, null, null, new nl0(dn0Var3, 6), null);
                    break;
                } else {
                    zm0Var.H = tL_error5.text;
                    if ((i34 == 3 && ((i21 = zm0Var.J) == 4 || i21 == 2)) || ((i34 == 2 && ((i19 = zm0Var.J) == 4 || i19 == 3)) || (i34 == 4 && zm0Var.J == 2))) {
                        zm0Var.q();
                    }
                    if (i34 == 2) {
                        AndroidUtilities.setWaitingForSms(true);
                        NotificationCenter.getGlobalInstance().addObserver(zm0Var, NotificationCenter.didReceiveSmsCode);
                    } else if (i34 == 3) {
                        AndroidUtilities.setWaitingForCall(true);
                        NotificationCenter.getGlobalInstance().addObserver(zm0Var, NotificationCenter.didReceiveCall);
                    }
                    zm0Var.F = true;
                    if (i34 != 3) {
                        i20 = ((org.telegram.ui.ActionBar.p2) dn0Var3).currentAccount;
                        org.telegram.ui.Components.z4.f0(i20, tL_error5, dn0Var3, verifyphone, new Object[0]);
                    }
                    dn0Var3.N1(true, false);
                    if (!tL_error5.text.contains("PHONE_CODE_EMPTY") && !tL_error5.text.contains("PHONE_CODE_INVALID")) {
                        if (tL_error5.text.contains("PHONE_CODE_EXPIRED")) {
                            zm0Var.c(true);
                            dn0Var3.K1(null, 0, true);
                            break;
                        }
                    } else {
                        int i35 = 0;
                        while (true) {
                            EditTextBoldCursor[] editTextBoldCursorArr = zm0Var.d;
                ...
                break;
            case 14:
                jo0.U((jo0) this.b, (TL_account.Password) this.d, (byte[]) this.c);
                break;
            case 15:
                jo0.b0((jo0) this.b, (TLRPC.TL_error) this.d, (TLRPC.TL_payments_sendPaymentForm) this.c);
                break;
            case 16:
            ...
            case 18:
                ...
                AndroidUtilities.runOnUIThread(mq0Var, 800L);
                break;
            case 19:
            ...
            case 20:
                ...
                ot0 ot0Var2 = (ot0) this.d;
                int[] iArr = (int[]) this.c;
                PhotoViewer photoViewer4 = ot0Var.d;
                if (photoViewer4.y != null && ot0Var2 == photoViewer4.t8) {
                    photoViewer4.t8 = null;
                    photoViewer4.m8 = iArr[5];
                    photoViewer4.e8 = iArr[4];
                    photoViewer4.f8 = iArr[7];
                    float f10 = photoViewer4.c8 / 8;
                    PhotoViewer photoViewer5 = ot0Var.d;
                    photoViewer4.n8 = (long) ((f10 * photoViewer5.e8) / 1000.0f);
                    if (photoViewer5.g8) {
                        PhotoViewer photoViewer6 = ot0Var.d;
                        photoViewer6.X7 = iArr[8];
                        photoViewer6.D3();
                        if (ot0Var.d.U7 > ot0Var.d.V7 - 1) {
                            PhotoViewer photoViewer7 = ot0Var.d;
                            photoViewer7.U7 = photoViewer7.V7 - 1;
                        }
                        PhotoViewer photoViewer8 = ot0Var.d;
                        if (!photoViewer8.G4) {
                            org.telegram.ui.Components.u61 u61Var = photoViewer8.g1;
                            boolean z12 = photoViewer8.V7 > 1;
                            PhotoViewer photoViewer9 = ot0Var.d;
                            u61Var.a(Math.min(photoViewer9.a8, ot0Var.d.b8), z12, photoViewer9.r);
                        }
                        if (BuildVars.LOGS_ENABLED) {
                            StringBuilder sb = new StringBuilder("compressionsCount = ");
                            sb.append(ot0Var.d.V7);
                            sb.append(" w = ");
                            sb.append(ot0Var.d.Y7);
                            sb.append(" h = ");
                            sb.append(ot0Var.d.Z7);
                            sb.append(" r = ");
                            kh.a2.t(ot0Var.d.X7, sb);
                        }
                        ot0Var.d.K7.invalidate();
                    } else {
                        PhotoViewer photoViewer10 = ot0Var.d;
                        if (!photoViewer10.G4) {
                            photoViewer10.g1.a(Math.min(photoViewer10.a8, ot0Var.d.b8), false, photoViewer10.r);
                        }
                        ot0Var.d.V7 = 0;
                    }
                    ot0Var.d.B3();
            ...
            case 21:
                ...
                MessageObject messageObject = rv0Var.E;
            ...
            case 24:
                ...
                org.telegram.ui.Components.zn znVar = (org.telegram.ui.Components.zn) this.d;
                xn xnVar2 = (xn) this.c;
                org.telegram.ui.Components.vn vnVar = znVar.e;
                ViewGroup viewGroup = (ViewGroup) xnVar2.fragmentView;
                RectF rectF = ug.i.h;
                ug.i.c(vnVar, viewGroup, rectF);
                profileActivity2.L5 = rectF.left;
                profileActivity2.N3();
                break;
            case 25:
                org.telegram.ui.Components.qc.D((sb) this.b, (TLRPC.User) this.d, ((TLRPC.Chat) this.c).title).j();
                break;
            case 26:
                ...
                ah.d dVar2 = secretMediaViewer.e;
                if (dVar2 != null) {
                    dVar2.setLayerType(0, null);
            ...
            case 27:
                ...
                SessionsActivity sessionsActivity = w71Var.c0;
                if (tL_error7 == null) {
            ...
            case 28:
                ...
                SessionsActivity sessionsActivity2 = x71Var.a;
                if (tL_error8 == null) {
            ...
            default:
                ...
                try {
                    ...
                    z71Var.c.getConnectionsManager().sendRequest(tL_auth_acceptLoginToken, new sb0(21, z71Var, m9Var));
                    break;
                } catch (Exception e) {
                    FileLog.e("Failed to pass qr code auth", e);
                    AndroidUtilities.runOnUIThread(new y71(z71Var, i23));
                    m9Var.run();
                }
        }
    }

    public /* synthetic */ hf0(Object obj, Object obj2, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = obj2;
        this.c = obj3;
