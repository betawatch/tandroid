...
public final class l8 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(l8 l8Var, TLRPC.TL_error tL_error, TLObject tLObject, Calendar calendar) {
        ...
        if (tL_error == null) {
            ...
            for (int i10 = 0; i10 < tL_messages_searchResultsCalendar.periods.size(); i10++) {
                ...
                j8 j8Var = new j8();
                j8Var.a = new MessageObject(l8Var.currentAccount, tL_messages_searchResultsCalendar.messages.get(i10), false, false);
                ...
                if (sparseArray2.get(i13, null) == null || !((j8) sparseArray2.get(i13, null)).g) {
            ...
            if (tL_messages_searchResultsCalendar.messages.isEmpty()) {
                ...
                l8Var.S = ((TLRPC.Message) kf.k0.i(1, tL_messages_searchResultsCalendar.messages)).id;
                l8Var.Q = false;
                l8Var.p0();
            }
            if (l8Var.V) {
    ...
    public final View createView(Context context) {
        ...
        if (z4) {
            ...
            final int i13 = 0;
            this.h.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.x7
                ...
                public final void onClick(View view) {
                    switch (i13) {
                        ...
                        default:
                            ...
                            int i14 = l8Var2.i0;
                            if (i14 != 0) {
                                org.telegram.ui.Components.z4.r(l8Var2, i14, l8Var2.getMessagesController().getUser(Long.valueOf(l8Var2.x)), null, false, new z7(l8Var2), null);
                                break;
                            } else {
                                if (l8Var2.L == null) {
                                    org.telegram.ui.Components.l40 l40Var = new org.telegram.ui.Components.l40(l8Var2.a.getContext(), 8);
                                    l8Var2.L = l40Var;
                                    l40Var.setExtraTranslationY(AndroidUtilities.dp(24.0f));
                                    l8Var2.a.addView(l8Var2.L, k7.b6.d(-2, -2.0f, 51, 19.0f, 0.0f, 19.0f, 0.0f));
            ...
            final int i14 = 1;
            this.n.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.x7
                public final /* synthetic */ l8 b;
                ...
                public final void onClick(View view) {
                    switch (i14) {
                        ...
                        default:
                            ...
                            int i142 = l8Var2.i0;
                            if (i142 != 0) {
                                org.telegram.ui.Components.z4.r(l8Var2, i142, l8Var2.getMessagesController().getUser(Long.valueOf(l8Var2.x)), null, false, new z7(l8Var2), null);
                                break;
                            } else {
                                if (l8Var2.L == null) {
                                    org.telegram.ui.Components.l40 l40Var = new org.telegram.ui.Components.l40(l8Var2.a.getContext(), 8);
    ...
    public final void r0() {
        ...
        for (int i10 = 0; i10 < this.c0.i.size(); i10++) {
            ...
            j8Var.b.add(Integer.valueOf(messageObject.getId()));
            j8Var.a = messageObject;
            j8Var.h = (int) (calendar.getTimeInMillis() / 1000);
    ...
    public final void s0(i8 i8Var, boolean z4) {
        ...
        if (this.M == 0 || this.N == 0) {
            SparseArray sparseArray = i8Var.w;
            for (int i12 = 0; i12 < sparseArray.size(); i12++) {
                i8Var.c(sparseArray.keyAt(i12), 0, 0, false, z4);
            }
            return;
        }
        if (i8Var.n == null) {
        ...
        boolean z10 = false;
        if (!z4) {
            SparseArray sparseArray2 = i8Var.w;
            int i13 = 0;
            while (i13 < sparseArray2.size()) {
                i8Var.c(sparseArray2.keyAt(i13), 0, 0, false, z10);
                i13++;
                z10 = false;
            }
        }
        ...
        int i16 = -1;
        int i17 = 0;
        for (int i18 = 0; i18 < i8Var.d; i18++) {
            j8 j8Var = (j8) i8Var.n.get(i18, null);
        ...
        int i19 = i17;
        if (i15 == -1 || i16 == -1) {
            i8Var.c(i19, 0, 0, false, z4);
        } else {
            i8Var.c(i19, i15, i16, true, z4);
        }
    }
    ...
    public final void t0() {
        ...
        this.n.animate().alpha(0.0f).translationY(-AndroidUtilities.dp(20.0f)).setDuration(150L).setListener(new org.telegram.ui.Components.m00(this.n)).start();
