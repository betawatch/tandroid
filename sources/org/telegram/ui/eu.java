...
public final class eu extends org.telegram.ui.Components.za {
    ...
    public boolean c0;
    public org.telegram.ui.Components.x51 d0;

    public eu(Activity activity, HashSet hashSet) {
        ...
        w7.z5.a(imageView);
        final int i10 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.du
        ...
        org.telegram.ui.Components.c90 a2 = w7.b6.a(activity, 20.0f, i11, true, this.resourcesProvider);
        a2.setText(LocaleController.getString(R.string.GroupCallCreateTitle));
        a2.setGravity(17);
        f7.addView(a2, w7.x5.t(-1, -2, 1, 2, 0, 2, 4));
        org.telegram.ui.Components.c90 a10 = w7.b6.a(activity, 14.0f, i11, false, this.resourcesProvider);
        ...
        org.telegram.ui.Components.x51 x51Var = this.d0;
        if (x51Var != null) {
            x51Var.N(false);
        }
        s4.j jVar = new s4.j();
        ...
        final int i12 = 1;
        dVar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.du
            public final /* synthetic */ eu b;
        ...
        final int i13 = 2;
        dVar2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.du
            public final /* synthetic */ eu b;
        ...
        ml0Var.setPadding(i14, 0, i14, AndroidUtilities.dp(76.0f));
    }

    public static void Q(eu euVar, TLObject tLObject, ci.d dVar, boolean z10, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (!(tLObject instanceof TLRPC.Updates)) {
            if (!(tLObject instanceof TL_phone.groupCall)) {
                if (tL_error != null) {
                    org.telegram.ui.Cells.p6.q(euVar.topBulletinContainer, euVar.resourcesProvider, tL_error, false);
                    return;
                }
                return;
            }
            TL_phone.groupCall groupcall = (TL_phone.groupCall) tLObject;
            MessagesController.getInstance(euVar.currentAccount).putUsers(groupcall.users, false);
            MessagesController.getInstance(euVar.currentAccount).putChats(groupcall.chats, false);
            ...
            euVar.dismiss();
            org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, euVar.currentAccount, tL_inputGroupCall, z10, groupcall.call, hashSet);
            return;
        }
        TLRPC.Updates updates = (TLRPC.Updates) tLObject;
        MessagesController.getInstance(euVar.currentAccount).putUsers(updates.users, false);
        MessagesController.getInstance(euVar.currentAccount).putChats(updates.chats, false);
        ...
        Utilities.stageQueue.postRunnable(new org.telegram.ui.Components.br0(26, euVar, updates));
        ...
        euVar.dismiss();
        org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, euVar.currentAccount, tL_inputGroupCall2, z10, groupCall2, hashSet);
    }

    public static void R(eu euVar, ArrayList arrayList) {
        arrayList.add(org.telegram.ui.Components.j51.k(euVar.X));
        arrayList.add(org.telegram.ui.Components.j51.B(null));
        ArrayList arrayList2 = euVar.a0;
        ...
        for (int i10 = 0; i10 < arrayList2.size(); i10++) {
            ...
            l4.getClass();
            TLRPC.User user = MessagesController.getInstance(euVar.currentAccount).getUser(l4);
            if (user == null) {
                return;
            }
            int i11 = xg.k.a;
            org.telegram.ui.Components.j51 J = org.telegram.ui.Components.j51.J(xg.k.class);
            J.G = user;
            J.K(euVar.b0.contains(l4));
            arrayList.add(J);
        }
    }
    ...
    public final org.telegram.ui.Components.ll0 v(org.telegram.ui.Components.ml0 ml0Var) {
        org.telegram.ui.Components.x51 x51Var = new org.telegram.ui.Components.x51(ml0Var, getContext(), this.currentAccount, 0, true, new b5(this, 10), this.resourcesProvider);
        this.d0 = x51Var;
        return x51Var;
    }
