...
public class SearchAdapterHelper {
            ...
            if (j != 0) {
                ...
                arrayList2.add(new Pair(tL_channels_getParticipants, new RequestDelegate() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda0
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        SearchAdapterHelper.$r8$lambda$8nMTsF0cRgFdXzeKoWWyiu9bcAQ(SearchAdapterHelper.this, str, z7, tLObject, tL_error);
                    }
                }));
            } else {
                z7 = z4;
        ...
        if (z) {
            if (str.length() > 0) {
                ...
                arrayList2.add(new Pair(tL_contacts_search, new RequestDelegate() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda1
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        SearchAdapterHelper.$r8$lambda$twGuWATPsTaEk9ejBR2vR_Tfgu8(SearchAdapterHelper.this, i2, z2, z5, z3, z7, j2, str, tLObject, tL_error);
                    }
                }));
            } else {
                this.globalSearch.clear();
        ...
        while (i3 < arrayList2.size()) {
            ...
            atomicInteger2.set(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda2
                ...
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    SearchAdapterHelper.$r8$lambda$4LfToSZ7_7zZ5yOfzMj4basnOVg(SearchAdapterHelper.this, arrayList5, i6, atomicInteger2, atomicInteger3, arrayList6, i2, runnable, tLObject2, tL_error);
                }
            }));
    ...
    public static /* synthetic */ void $r8$lambda$8nMTsF0cRgFdXzeKoWWyiu9bcAQ(SearchAdapterHelper searchAdapterHelper, String str, boolean z, TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public static /* synthetic */ void $r8$lambda$twGuWATPsTaEk9ejBR2vR_Tfgu8(SearchAdapterHelper searchAdapterHelper, int i, boolean z, boolean z2, boolean z3, boolean z4, long j, String str, TLObject tLObject, TLRPC.TL_error tL_error) {
        TLRPC.Chat chat;
        TLRPC.User user;
    ...
    public static /* synthetic */ void $r8$lambda$4LfToSZ7_7zZ5yOfzMj4basnOVg(final SearchAdapterHelper searchAdapterHelper, final ArrayList arrayList, final int i, final AtomicInteger atomicInteger, final AtomicInteger atomicInteger2, final ArrayList arrayList2, final int i2, final Runnable runnable, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        searchAdapterHelper.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda6
            ...
            public final void run() {
                SearchAdapterHelper.$r8$lambda$KEM9tdvcm39o4s0VbGsImX_uFMg(SearchAdapterHelper.this, arrayList, i, tLObject, tL_error, atomicInteger, atomicInteger2, arrayList2, i2, runnable);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$KEM9tdvcm39o4s0VbGsImX_uFMg(SearchAdapterHelper searchAdapterHelper, ArrayList arrayList, int i, TLObject tLObject, TLRPC.TL_error tL_error, AtomicInteger atomicInteger, AtomicInteger atomicInteger2, ArrayList arrayList2, int i2, Runnable runnable) {
        searchAdapterHelper.getClass();
        arrayList.set(i, new Pair(tLObject, tL_error));
        Integer valueOf = Integer.valueOf(atomicInteger.get());
        if (searchAdapterHelper.pendingRequestIds.contains(valueOf)) {
            searchAdapterHelper.pendingRequestIds.remove(valueOf);
    ...
    public boolean loadRecentHashtags() {
        ...
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                SearchAdapterHelper.$r8$lambda$haNYPVrlkJo4mVsc9IvRACWptRI(SearchAdapterHelper.this);
            }
        });
        return false;
    }

    public static /* synthetic */ void $r8$lambda$haNYPVrlkJo4mVsc9IvRACWptRI(final SearchAdapterHelper searchAdapterHelper) {
        searchAdapterHelper.getClass();
        try {
            SQLiteCursor queryFinalized = MessagesStorage.getInstance(searchAdapterHelper.currentAccount).getDatabase().queryFinalized("SELECT id, date FROM hashtag_recent_v2 WHERE 1", new Object[0]);
    ...
    private void putRecentHashtags(final ArrayList arrayList) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                SearchAdapterHelper.$r8$lambda$yYrJXyB58tDVkco8WH5pegNwkNg(SearchAdapterHelper.this, arrayList);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$yYrJXyB58tDVkco8WH5pegNwkNg(SearchAdapterHelper searchAdapterHelper, ArrayList arrayList) {
        int i;
        searchAdapterHelper.getClass();
        try {
            MessagesStorage.getInstance(searchAdapterHelper.currentAccount).getDatabase().beginTransaction();
            SQLitePreparedStatement executeFast = MessagesStorage.getInstance(searchAdapterHelper.currentAccount).getDatabase().executeFast("REPLACE INTO hashtag_recent_v2 VALUES(?, ?)");
            int i2 = 0;
            while (true) {
            ...
            if (arrayList.size() > 100) {
                SQLitePreparedStatement executeFast2 = MessagesStorage.getInstance(searchAdapterHelper.currentAccount).getDatabase().executeFast("DELETE FROM hashtag_recent_v2 WHERE id = ?");
    ...
    public void clearRecentHashtags() {
        ...
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.Adapters.SearchAdapterHelper$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                SearchAdapterHelper.$r8$lambda$op9OD6mP0NzCaMyD4RoNNN3tvF8(SearchAdapterHelper.this);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$op9OD6mP0NzCaMyD4RoNNN3tvF8(SearchAdapterHelper searchAdapterHelper) {
        searchAdapterHelper.getClass();
        try {
    ...
    public void setHashtags(ArrayList arrayList, HashMap hashMap) {
