...
public final class j51 extends org.telegram.ui.Cells.u1 {
        ...
        if (paint != null) {
            ...
            if (f7 > 0.0f) {
                if (l51Var.Q) {
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Qe.e(l51Var.Q), 1.0f - l51Var.s));
    ...
    public final void d2(Canvas canvas, float f7, Integer num) {
        ...
        int i10 = -this.N.c;
        l51 l51Var = this.Te;
        canvas.translate(AndroidUtilities.lerp(0, i10, l51Var.s), AndroidUtilities.lerp(l51Var.O.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), r0.p, l51Var.s));
        super.d2(canvas, (1.0f - l51Var.s) * f7, num);
        canvas.restore();
    }
    ...
    public final void m2(float f7, Canvas canvas, boolean z10) {
        ...
        if (l51Var.S) {
            ...
            canvas.translate(((this.Ie.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.rb) * l51Var.s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, l51Var.s, rectF);
            U3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (l51Var.s <= 0.0f || !l51Var.Q) {
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            }
            this.we = 1.0f - l51Var.s;
        } else {
            canvas2 = canvas;
        }
        S1(canvas2);
        if (l51Var.S && l51Var.s > 0.0f && l51Var.Q) {
            canvas2.restore();
        }
    }
