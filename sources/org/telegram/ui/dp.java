...
public final class dp extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public Boolean p0;
    public boolean q0;
    public org.telegram.ui.Components.mr r;
    ...
    */
    public final void Y() {
        ...
        boolean z11;
        final dp dpVar = this;
        AndroidUtilities.runOnUIThread(dpVar.n0, 200L);
        boolean z12 = true;
        if (dpVar.getParentActivity() != null) {
            String publicUsername = ChatObject.getPublicUsername(dpVar.U, true);
            if (dpVar.S || (((publicUsername != null || dpVar.a.length() == 0) && (publicUsername == null || publicUsername.equalsIgnoreCase(dpVar.a.getText().toString()))) || dpVar.a.length() == 0 || dpVar.h0)) {
                if (publicUsername == null) {
                    publicUsername = "";
                }
                String obj = dpVar.S ? "" : dpVar.a.getText().toString();
                if (publicUsername.equals(obj)) {
                    if (!dpVar.S || (arrayList = dpVar.U.usernames) == null || arrayList.isEmpty()) {
                        z4 = true;
                    } else if (dpVar.q0) {
                        z4 = false;
                    } else {
                        dpVar.q0 = true;
                        boolean z13 = false;
                        for (int i10 = 0; i10 < dpVar.U.usernames.size(); i10++) {
                            TLRPC.TL_username tL_username = dpVar.U.usernames.get(i10);
                        ...
                        if (z13) {
                            ...
                            tL_channels_deactivateAllUsernames.channel = MessagesController.getInputChannel(dpVar.U);
                            dpVar.getConnectionsManager().sendRequest(tL_channels_deactivateAllUsernames, new qo(dpVar, 1));
                        } else {
                            dpVar.q0 = false;
                        }
                        z4 = !z13;
                    ...
                    if (z4) {
                        ...
                        if (chat.noforwards != dpVar.Y) {
                            if (!ChatObject.isChannel(chat)) {
                                dpVar.a0(true);
                                final int i11 = 2;
                                dpVar.getMessagesController().convertToMegaGroup(dpVar.getParentActivity(), dpVar.W, dpVar, new MessagesStorage.LongCallback(dpVar) { // from class: org.telegram.ui.ro
                                        ...
                                        switch (i11) {
                                            case 0:
                                                ...
                                                if (j10 == 0) {
                                                    ...
                                                    dpVar2.W = j10;
                                                    dpVar2.U = dpVar2.getMessagesController().getChat(Long.valueOf(j10));
                                                    dpVar2.Y();
                                                    break;
                                                }
                                            case 1:
                                                ...
                                                if (j10 == 0) {
                                                    ...
                                                    dpVar3.W = j10;
                                                    dpVar3.U = dpVar3.getMessagesController().getChat(Long.valueOf(j10));
                                                    dpVar3.Y();
                                                    break;
                                                }
                                            default:
                                                ...
                                                if (j10 == 0) {
                                                    ...
                                                    dpVar4.W = j10;
                                                    dpVar4.U = dpVar4.getMessagesController().getChat(Long.valueOf(j10));
                                                    MessagesController messagesController = dpVar4.getMessagesController();
                                                    long j11 = -dpVar4.W;
                                                    TLRPC.Chat chat2 = dpVar4.U;
                                                    boolean z14 = dpVar4.Y;
                                ...
                                if (dpVar.R != null) {
                                    if (dpVar.getParentActivity() != null) {
                                        if (!dpVar.X && !ChatObject.isChannel(dpVar.U)) {
                                            zo zoVar = dpVar.R;
                                            if (zoVar.f || zoVar.h) {
                                                final int i12 = 0;
                                                dpVar.getMessagesController().convertToMegaGroup(dpVar.getParentActivity(), dpVar.W, dpVar, new MessagesStorage.LongCallback(dpVar) { // from class: org.telegram.ui.ro
                                        ...
                                        if (dpVar.U.join_to_send != dpVar.R.f) {
                                            MessagesController messagesController = dpVar.getMessagesController();
                                            long j10 = dpVar.W;
                                            TLRPC.Chat chat2 = dpVar.U;
                                            boolean z14 = dpVar.R.f;
                                            chat2.join_to_send = z14;
                                            messagesController.toggleChatJoinToSend(j10, z14, null, null);
                                        }
                                        if (dpVar.U.join_request != dpVar.R.h || dpVar.T) {
                                            MessagesController messagesController2 = dpVar.getMessagesController();
                                            long j11 = dpVar.W;
                                            TLRPC.Chat chat3 = dpVar.U;
                                            boolean z15 = dpVar.R.h;
                                            chat3.join_request = z15;
                                            messagesController2.toggleChatJoinRequest(j11, 0L, z15, dpVar.T, false, null, null);
                                        }
                                    }
                                    z12 = false;
                                }
                            ...
                            MessagesController messagesController3 = dpVar.getMessagesController();
                            long j12 = -dpVar.W;
                            TLRPC.Chat chat4 = dpVar.U;
                            boolean z16 = dpVar.Y;
                ...
                } else if (ChatObject.isChannel(dpVar.U)) {
                    dpVar.getMessagesController().updateChannelUserName(dpVar, dpVar.W, obj, new so(dpVar, 1), new so(dpVar, 2));
                    dpVar = dpVar;
                } else {
                    final int i13 = 1;
                    dpVar.getMessagesController().convertToMegaGroup(dpVar.getParentActivity(), dpVar.W, dpVar, new MessagesStorage.LongCallback(dpVar) { // from class: org.telegram.ui.ro
                            ...
                            switch (i13) {
                                case 0:
                                    ...
                                    if (j102 == 0) {
                                        ...
                                        dpVar2.W = j102;
                                        dpVar2.U = dpVar2.getMessagesController().getChat(Long.valueOf(j102));
                                        dpVar2.Y();
                                        break;
                                    }
                                case 1:
                                    ...
                                    if (j102 == 0) {
                                        ...
                                        dpVar3.W = j102;
                                        dpVar3.U = dpVar3.getMessagesController().getChat(Long.valueOf(j102));
                                        dpVar3.Y();
                                        break;
                                    }
                                default:
                                    ...
                                    if (j102 == 0) {
                                        ...
                                        dpVar4.W = j102;
                                        dpVar4.U = dpVar4.getMessagesController().getChat(Long.valueOf(j102));
                                        MessagesController messagesController4 = dpVar4.getMessagesController();
                                        long j112 = -dpVar4.W;
                                        TLRPC.Chat chat22 = dpVar4.U;
                                        boolean z142 = dpVar4.Y;
                ...
                Vibrator vibrator = (Vibrator) dpVar.getParentActivity().getSystemService("vibrator");
                if (vibrator != null) {
                    vibrator.vibrate(200L);
                }
                AndroidUtilities.shakeView(dpVar.f);
                dpVar.a0(false);
            }
        }
        z10 = false;
    ...
    public final void a0(boolean z4) {
        ...
        if (this.r != null) {
            ...
            this.o0.setInterpolator(org.telegram.ui.Components.nr.f);
            this.o0.start();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.r = mrVar;
        this.n = n10.i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), mrVar);
        this.h = new dg.u3(context);
        vo voVar = new vo(this, context, this.h, this.resourceProvider);
        this.fragmentView = voVar;
        voVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.a7, false));
        ...
        int i15 = 3;
        this.a.addTextChangedListener(new n0(this, i15));
        ...
        this.E.setOnClickListener(new uo(this, i15));
        ...
        if (chatFull2 == null || chatFull2.guard_bot_id == 0) {
            ...
            a9Var3.setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(isChannelAndNotMegaGroup ? R.string.ChannelSettingsJoinRequestInfoManagedBy : isPublic ? R.string.GroupPublicSettingsJoinRequestInfoManagedBy : R.string.GroupPrivateSettingsJoinRequestInfoManagedBy, "@" + DialogObject.getPublicUsername(MessagesController.getInstance(UserConfig.selectedAccount).getUser(Long.valueOf(chatFull2.guard_bot_id)))), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.il, false), new org.telegram.ui.Components.i80(i12, chatFull2, this)));
        }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 262144, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.F6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f, 262144, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.w6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 32, new Class[]{org.telegram.ui.Cells.a9.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 262144, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 262144, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, i13));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b0, 32, new Class[]{org.telegram.ui.Cells.a9.class}, null, null, null, i10));
