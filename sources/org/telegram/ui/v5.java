...
public final class v5 extends a20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View createView(Context context) {
        ...
        this.c.setOnItemClickListener(new cg.x0(5, this, context));
        Activity parentActivity = getParentActivity();
        LinearLayout linearLayout = new LinearLayout(parentActivity);
        this.b0 = linearLayout;
        linearLayout.setOrientation(1);
        this.b0.addView(new jh.m1(parentActivity), h7.z5.t(100, 100, 17, 0, 120, 0, 0));
        ((ViewGroup) this.fragmentView).addView(this.b0, h7.z5.e(-1, -2, 17));
