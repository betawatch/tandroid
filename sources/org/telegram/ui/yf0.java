...
public final class yf0 extends org.telegram.ui.Components.vv0 {
    ...
    public static /* synthetic */ void o(yf0 yf0Var, String str, String str2, String str3) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    TelephonyManager telephonyManager = (TelephonyManager) yf0Var.getContext().getSystemService(TelephonyManager.class);
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        this.a.setOnClickListener(new kh.t3(this, string4, string5, string2, 12));
        ph.d dVar = this.b;
