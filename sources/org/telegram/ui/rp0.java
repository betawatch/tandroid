...
public final class rp0 extends View {
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.f != null) {
            ...
            while (true) {
                ...
                Path path = qp0Var.e;
                canvas.save();
                float a2 = qp0Var.l.a(0.05f);
                RectF rectF = qp0Var.p;
                ...
                if (qp0Var.g) {
                    ...
                    canvas.drawRoundRect(rectF2, AndroidUtilities.dp(2.33f), AndroidUtilities.dp(2.33f), qp0Var.c);
                    canvas.restore();
                }
                float e = qp0Var.n.e(qp0Var.m);
                if (e > 0.0f) {
                    Paint paint = rp0Var.b;
                    Paint paint2 = rp0Var.b;
                    paint.setStrokeWidth(AndroidUtilities.dpf2(2.0f));
                    paint2.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, rp0Var.a));
                ...
                if (qp0Var.h) {
                    if (rp0Var.e) {
                        ...
                        qp0Var.k.setBounds((int) org.telegram.messenger.ul.c(qp0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) org.telegram.messenger.ul.c(qp0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()), (int) a4.a.e(qp0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) a4.a.e(qp0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()));
                        qp0Var.k.draw(canvas);
                    } else {
                        if (qp0Var.i == null) {
                            qp0Var.i = new Path();
                        }
                        if (qp0Var.j == null) {
                            ...
                            qp0Var.j = paint3;
                            paint3.setColor(-1);
                            qp0Var.j.setStyle(Paint.Style.STROKE);
                            qp0Var.j.setStrokeCap(Paint.Cap.ROUND);
                        }
                        qp0Var.j.setStrokeWidth(AndroidUtilities.dp(2.0f));
                        qp0Var.i.rewind();
                        float lerp = AndroidUtilities.lerp(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(4.0f), e);
                        qp0Var.i.moveTo(rectF.centerX() - lerp, rectF.centerY() - lerp);
                        qp0Var.i.lineTo(rectF.centerX() + lerp, rectF.centerY() + lerp);
                        qp0Var.i.moveTo(rectF.centerX() + lerp, rectF.centerY() - lerp);
                        qp0Var.i.lineTo(rectF.centerX() - lerp, rectF.centerY() + lerp);
                        canvas.drawPath(qp0Var.i, qp0Var.j);
                    }
                }
                canvas.restore();
                i10++;
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f != null) {
            ...
            while (true) {
                ...
                if (qp0VarArr[i10].q.contains(motionEvent.getX(), motionEvent.getY())) {
                    qp0Var = this.f[i10];
                    break;
                }
                i10++;
            ...
            if (motionEvent.getAction() != 0) {
                ...
                if (qp0Var3 != qp0Var) {
                    ...
                    if (this.w != null && qp0Var != null && (callback2 = this.v) != null) {
                        callback2.run(Integer.valueOf(qp0Var.o));
                    }
                    this.w = qp0Var;
                    return true;
                }
            } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                if (motionEvent.getAction() == 1 && (qp0Var2 = this.w) != null && (callback = this.v) != null) {
                    callback.run(Integer.valueOf(qp0Var2.o));
                }
                if (this.f != null) {
                    int i11 = 0;
                    while (true) {
                        qp0[] qp0VarArr2 = this.f;
                        if (i11 >= qp0VarArr2.length) {
                            break;
                        }
                        qp0VarArr2[i11].l.c(false);
                        i11++;
                    }
                }
                this.w = null;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        qp0[] qp0VarArr = this.f;
        if (qp0VarArr == null || qp0VarArr.length != size2) {
            this.f = new qp0[size2];
            int i16 = 0;
            while (i16 < size2) {
                this.f[i16] = new qp0(this);
                if (i13 == i15) {
                    qp0 qp0Var = this.f[i16];
                    int i17 = this.h[i16];
                    qp0Var.o = i17;
                    qp0Var.h = i17 < 0;
                    if (i17 < 0) {
        ...
        if (this.f != null) {
            ...
            for (int i18 = 0; i18 < this.f.length; i18++) {
                ...
                qp0 qp0Var2 = this.f[i18];
                boolean z10 = qp0Var2.o == this.s;
                qp0Var2.m = z10;
                qp0Var2.n.f(z10, true);
                qp0Var2.r.invalidate();
                if (i18 % i14 == i14 - 1) {
                    f14 += min + min3;
                    f13 = f12;
                } else {
