...
public final class qu0 extends vh.o {
    public final org.telegram.ui.Cells.ba R;
    public ArrayList S;
    public boolean T;
    public Layout U;
    public org.telegram.ui.Components.u5 V;
    public boolean W;
    public org.telegram.ui.Components.o90 a0;
    public Layout b0;
    public Path c0;

    public qu0(Context context, ou0 ou0Var, org.telegram.ui.Cells.ba baVar, final Utilities.Callback2 callback2, final Utilities.Callback3 callback3) {
        super(context);
        setClearLinkOnLongPress(false);
        setDisablePaddingsOffsetY(false);
        final int i10 = 0;
        this.x = new org.telegram.ui.Components.j90(this) { // from class: org.telegram.ui.pu0
            ...
            public final void a(ClickableSpan clickableSpan) {
                switch (i10) {
                    ...
                    default:
                        ...
                        qu0 qu0Var2 = this.b;
                        callback32.run(clickableSpan, qu0Var2, new sl0(qu0Var2, 21));
                        break;
                }
            }
        };
        final int i11 = 1;
        this.y = new org.telegram.ui.Components.j90(this) { // from class: org.telegram.ui.pu0
            public final /* synthetic */ qu0 b;
    ...
    public final void onDraw(Canvas canvas) {
        org.telegram.ui.Cells.ba baVar = this.R;
        if (baVar != null && baVar.y()) {
            canvas.save();
            canvas.translate(getPaddingLeft(), getPaddingTop());
            if (baVar != null && getStaticTextLayout() != null && baVar.u0 == this) {
                baVar.X(canvas);
            }
            canvas.restore();
        }
        ...
        if (this.U != getLayout()) {
            ...
            this.T = z10;
            w7.f6.a(this, 16.0f, 8.0f, (z10 ? 32 : 0) + 16, 8.0f);
            this.U = getLayout();
        }
    }
