...
public final class f80 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View createView(Context context) {
        ...
        bj0Var.setContentDescription(LocaleController.getString(org.telegram.ui.ActionBar.j6.A0().q() ? R.string.AccDescrSwitchToDayTheme : R.string.AccDescrSwitchToNightTheme));
        bj0Var.setAnimation(this.v);
        frameLayout.setOnClickListener(new uv(11, this, bj0Var));
        ...
        int i10 = 0;
        textureView.setSurfaceTextureListener(new b80(this, i10));
        z4.g gVar = new z4.g(context);
        this.d = gVar;
        gVar.setAdapter(new e80(this, i10));
        ...
        final int i11 = 0;
        this.n.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.a80
                ...
                switch (i11) {
                    ...
                    default:
                        ...
                        if (!f80Var2.y && f80Var2.L != null) {
                            ...
                            LocaleController.getInstance().applyLanguage(f80Var2.L, true, false, f80Var2.c);
                            break;
                        }
                        break;
                }
        ...
        final int i12 = 1;
        this.f.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.a80
            public final /* synthetic */ f80 b;
