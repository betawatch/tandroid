...
public final class e7 extends org.telegram.ui.Components.q81 {
    ...
    public final void b(View view, int i10, int i11) {
        ...
        yl0Var.setAdapter(((s7) arrayList.get(i10)).c);
        ...
        yl0Var.setTag(Integer.valueOf(((s7) arrayList.get(i10)).b));
    }
    ...
    public final View d(int i10) {
        ...
        t7 t7Var = this.e;
        if (i10 == 1) {
            yl0Var.setPadding(AndroidUtilities.dp(2.0f), t7Var.s, 0, t7Var.v);
        } else {
            yl0Var.setPadding(0, t7Var.s, 0, t7Var.v);
        }
