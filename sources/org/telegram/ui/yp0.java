...
public final class yp0 extends org.telegram.ui.Components.pv0 {
    public int w0;
    public boolean x0;
    public final /* synthetic */ dq0 y0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public yp0(dq0 dq0Var, Context context) {
        super(context, null);
        this.y0 = dq0Var;
    }
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int emojiPadding = (AndroidUtilities.dp(20.0f) < 0 || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : dq0Var.M.getEmojiPadding();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (dp < 0) {
            ...
            size2 -= dq0Var.M.getEmojiPadding();
