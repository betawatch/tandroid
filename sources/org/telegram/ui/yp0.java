    ...
    */
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (i20 != i21) {
            ...
            org.telegram.ui.ActionBar.p1 p1Var = fq0Var.j0;
            if (p1Var != null && p1Var.isShowing()) {
                fq0Var.j0.d(true);
            }
        }
        int childCount = getChildCount();
        int emojiPadding = (fq0Var.a0 == null || fq0Var.W.getParent() != this || AndroidUtilities.dp(20.0f) < 0 || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : fq0Var.a0.getEmojiPadding();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.u0 = true;
        int dp = ((size2 - AndroidUtilities.dp(4.0f)) - AndroidUtilities.dp(4.0f)) / fq0Var.d0;
        fq0Var.O = dp;
        if (this.v0 != dp) {
            this.v0 = dp;
        ...
        if (fq0Var.V) {
            ...
            fq0Var.J.y1(Math.max(1, ((fq0Var.d0 - 1) * AndroidUtilities.dp(2.0f)) + (fq0Var.O * fq0Var.d0)));
        }
        this.u0 = false;
        ...
        int R = R();
        if (AndroidUtilities.dp(20.0f) >= 0 && !AndroidUtilities.isInMultiwindow && fq0Var.a0 != null && fq0Var.W.getParent() == this) {
            size4 -= fq0Var.a0.getEmojiPadding();
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size4, TLObject.FLAG_30);
        }
        int i12 = size4;
        int i13 = makeMeasureSpec;
        if (R > AndroidUtilities.dp(20.0f) && (duVar = fq0Var.a0) != null) {
            this.u0 = true;
            duVar.j();
            this.u0 = false;
        }
        org.telegram.ui.Components.du duVar2 = fq0Var.a0;
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                org.telegram.ui.Components.du duVar3 = fq0Var.a0;
