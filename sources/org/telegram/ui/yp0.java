            ...
            while (true) {
                ...
                if (xp0Var.h) {
                    if (yp0Var.e) {
                        ...
                        xp0Var.k.setBounds((int) org.telegram.messenger.vl.c(xp0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) org.telegram.messenger.vl.c(xp0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()), (int) a4.a.e(xp0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) a4.a.e(xp0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()));
