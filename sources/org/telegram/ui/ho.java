...
public final class ho extends Drawable {
    ...
    public static ho d(Drawable drawable, TLRPC.WallPaper wallPaper, boolean z10) {
        ...
        if (drawable instanceof ho) {
            ...
            boolean z11 = hoVar.a;
            TLRPC.WallPaper wallPaper2 = hoVar.g;
            String str = wallPaper.uploadingImage;
    ...
    public final Drawable c(boolean z10) {
        ...
        gg.h1 h1Var = this.e;
        return (!z10 || h1Var.getStaticThumb() == null) ? h1Var.getThumb() != null ? h1Var.getThumb() : h1Var.getDrawable() != null ? h1Var.getDrawable() : h1Var.getStaticThumb() : h1Var.getStaticThumb();
    }
