...
public final class wb extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final zg.a f;
    public ImageView f0;
    public org.telegram.ui.ActionBar.l5 g0;
    public final pe.b h;
    public k0 h0;
    public m4 i0;
    ...
    public wb(TLRPC.Chat chat) {
        ...
        if (Build.VERSION.SDK_INT < 31 || !SharedConfig.chatBlurEnabled()) {
            ...
            this.c = null;
            this.d = null;
            this.e = new zg.a(eVar);
            this.f = new zg.a(eVar);
        } else {
            zg.e eVar2 = new zg.e(false);
            this.n = eVar2;
    ...
    public static void A0(wb wbVar, TLRPC.TL_messages_exportedChatInvite tL_messages_exportedChatInvite, HashMap hashMap) {
        ...
        org.telegram.ui.Components.a70 a70Var = new org.telegram.ui.Components.a70(wbVar.b0.getContext(), (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInvite.invite, chatFull, hashMap, wbVar, chatFull.id, false, ChatObject.isChannel(chat));
        a70Var.j0 = new jb(wbVar);
        a70Var.show();
    }

    public static void K0(wb wbVar) {
        if (wbVar.E == null || wbVar.r0.isEmpty()) {
            return;
        }
        wbVar.G.h1(wbVar.s0.size() - 1, (-100000) - wbVar.E.getPaddingTop());
    }
    ...
    public static void U(wb wbVar, TLRPC.TL_channels_adminLogResults tL_channels_adminLogResults) {
        ...
        for (int i11 = 0; i11 < tL_channels_adminLogResults.events.size(); i11++) {
            ...
            if (iVar.h(tL_channelAdminLogEvent.id) < 0) {
                ...
                wbVar.S = Math.min(wbVar.S, tL_channelAdminLogEvent.id);
                MessageObject messageObject2 = new MessageObject(wbVar.currentAccount, tL_channelAdminLogEvent, (ArrayList<MessageObject>) arrayList, (HashMap<String, ArrayList<MessageObject>>) wbVar.q0, wbVar.s, wbVar.X, false);
        ...
        for (int size = arrayList.size(); size < arrayList.size(); size++) {
            ...
            if (messageObject3 != null && messageObject3.contentType != 0 && messageObject3.getRealId() >= 0) {
                wbVar.p0.k(messageObject3, messageObject3.getRealId());
            }
        ...
        if (!arrayList2.isEmpty()) {
            MediaDataController.getInstance(wbVar.currentAccount).loadReplyMessagesForMessages(arrayList2, -wbVar.s.id, 0, 0L, new ya(wbVar, 1), wbVar.getClassGuid(), null);
        }
        wbVar.R0();
        wbVar.v0 = false;
        if (!z10) {
        ...
        AndroidUtilities.updateViewVisibilityAnimated(wbVar.w, false, 0.3f, true);
        ...
        if (w0Var != null) {
            if (wbVar.s0.isEmpty() && TextUtils.isEmpty(wbVar.z0)) {
                i10 = 8;
            }
    ...
    public static void V(wb wbVar, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, View view, float f7, float f10) {
        ...
        while (i11 < size) {
            if (arrayList4.get(i11) == null) {
                ...
                g1Var.setOnClickListener(new cb(wbVar, i11, arrayList4, num, 0));
            }
            i11++;
            arrayList4 = arrayList;
        }
        fb fbVar = new fb(0, wbVar.b0.getContext(), wbVar);
    ...
    */
    public static void W(wb wbVar, int i10, ArrayList arrayList, Integer num) {
        ...
        File file;
        TLRPC.User user;
        if (wbVar.c0 == null || i10 >= arrayList.size()) {
            return;
        }
        int intValue = num.intValue();
        TLRPC.Chat chat2 = wbVar.s;
        gb gbVar = wbVar.J0;
        if (gbVar != null) {
            gbVar.dismiss();
        }
        MessageObject messageObject = wbVar.c0;
        if (messageObject == null) {
            return;
        }
        if (intValue == 3) {
            ...
            org.telegram.messenger.em.o(R.string.MessageCopied, org.telegram.ui.Components.wc.a0(wbVar));
        } else if (intValue == 4) {
            ...
            if (str == null || str.length() == 0) {
                str = wbVar.getFileLoader().getPathToMessage(wbVar.c0.messageOwner).toString();
            }
            int i11 = wbVar.c0.type;
            if (i11 == 3 || i11 == 1) {
                ...
                MediaController.saveFile(str, wbVar.getParentActivity(), wbVar.c0.type == 3 ? 1 : 0, null, null);
            }
        } else if (intValue == 5) {
            String str2 = messageObject.messageOwner.attachPath;
            if (str2 != null && str2.length() != 0) {
                file = new File(wbVar.c0.messageOwner.attachPath);
            }
            file = null;
            if (file == null) {
                File pathToMessage = wbVar.getFileLoader().getPathToMessage(wbVar.c0.messageOwner);
                ...
                if (file.getName().toLowerCase().endsWith("attheme")) {
                    ...
                    if (a0Var != null) {
                        if (a0Var.N0() < wbVar.G.B() - 1) {
                            int L0 = wbVar.G.L0();
                            wbVar.k0 = L0;
                            org.telegram.ui.Components.fl0 fl0Var = (org.telegram.ui.Components.fl0) wbVar.E.K(L0);
                            if (fl0Var != null) {
                    ...
                    org.telegram.ui.ActionBar.i6 u10 = org.telegram.ui.ActionBar.j6.u(file, wbVar.c0.getDocumentName(), null, true);
                    if (u10 != null) {
            ...
            if (str3 == null || str3.length() == 0) {
                str3 = wbVar.getFileLoader().getPathToMessage(wbVar.c0.messageOwner).toString();
            }
            Intent intent = new Intent("android.intent.action.SEND");
            intent.setType(wbVar.c0.getDocument().mime_type);
            ...
            switch (intValue) {
                case 9:
                    wbVar.showDialog(new org.telegram.ui.Components.hy0(wbVar.getParentActivity(), wbVar, wbVar.c0.getInputStickerSet(), null, null, null));
                    break;
                case 10:
                    ...
                    String documentFileName = FileLoader.getDocumentFileName(wbVar.c0.getDocument());
                    if (TextUtils.isEmpty(documentFileName)) {
                        documentFileName = wbVar.c0.getFileName();
                    }
                    String str4 = wbVar.c0.messageOwner.attachPath;
                    if (str4 != null && str4.length() > 0 && !w.f.o(str4)) {
                        str4 = null;
                    }
                    if (str4 == null || str4.length() == 0) {
                        str4 = wbVar.getFileLoader().getPathToMessage(wbVar.c0.messageOwner).toString();
                    }
                    MediaController.saveFile(str4, wbVar.getParentActivity(), wbVar.c0.isMusic() ? 3 : 2, documentFileName, wbVar.c0.getDocument() != null ? wbVar.c0.getDocument().mime_type : "");
                    break;
                case 11:
                    MessagesController.getInstance(wbVar.currentAccount).saveGif(wbVar.c0, messageObject.getDocument());
                    break;
                default:
                    switch (intValue) {
                        case 15:
                            Bundle bundle = new Bundle();
                            bundle.putLong("user_id", wbVar.c0.messageOwner.media.user_id);
                            bundle.putString("phone", wbVar.c0.messageOwner.media.phone_number);
                            bundle.putBoolean("addContact", true);
                            wbVar.presentFragment(new ts(bundle));
                            break;
                        case 16:
                            AndroidUtilities.addToClipboard(messageObject.messageOwner.media.phone_number);
                            org.telegram.messenger.em.o(R.string.PhoneCopied, org.telegram.ui.Components.wc.a0(wbVar));
                            break;
                        case 17:
                            try {
                                Intent intent2 = new Intent("android.intent.action.DIAL", Uri.parse("tel:" + wbVar.c0.messageOwner.media.phone_number));
                        ...
                        default:
                            switch (intValue) {
                                case 33:
                                    if (wbVar.d0 != null) {
                                        TLRPC.User user3 = wbVar.getMessagesController().getUser(Long.valueOf(DialogObject.getPeerDialogId(wbVar.d0.peer)));
                                        TLRPC.ChannelParticipant channelParticipant = wbVar.d0;
                                        if (channelParticipant.banned_rights == null) {
                                            channelParticipant.banned_rights = new TLRPC.TL_chatBannedRights();
                                        }
                                        TLRPC.TL_chatBannedRights tL_chatBannedRights = wbVar.d0.banned_rights;
                                        ...
                                        wbVar.getMessagesController().setParticipantBannedRole(chat2.id, user3, null, wbVar.d0.banned_rights, true, wbVar.getFragmentForAlert(1), new n(13, wbVar, user3));
                                        break;
                                    }
                                    break;
                                case 34:
                                    ...
                                    tL_channels_reportAntiSpamFalsePositive.msg_id = wbVar.c0.getRealId();
                                    wbVar.getConnectionsManager().sendRequest(tL_channels_reportAntiSpamFalsePositive, new sa(wbVar, 3));
                                    break;
                                case 35:
                                    wbVar.getMessagesController().deleteParticipantFromChat(chat2.id, wbVar.getMessagesController().getInputPeer(wbVar.c0.messageOwner.from_id), false, false, (Runnable) new ya(wbVar, 2));
                                    if ((wbVar.c0.messageOwner.from_id instanceof TLRPC.TL_peerUser) && org.telegram.ui.Components.wc.a(wbVar) && (user = wbVar.getMessagesController().getUser(Long.valueOf(wbVar.c0.messageOwner.from_id.user_id))) != null) {
                                        org.telegram.ui.Components.wc.D(wbVar, user, chat2.title).j();
                                        break;
                                    }
                                    break;
                            }
            ...
            if (str5 == null || str5.length() == 0) {
                str5 = wbVar.getFileLoader().getPathToMessage(wbVar.c0.messageOwner).toString();
            }
    ...
    public static void X(wb wbVar, int i10) {
        ...
        if (w7.c0.a(i10, 2)) {
            ...
            if (i12 >= 29) {
                if (dVar2 != null) {
                    ...
                    rectF.set(0.0f, 0.0f, wbVar.b0.getMeasuredWidth(), wbVar.E.getY() + wbVar.E.getPaddingTop());
            ...
            int measuredWidth = wbVar.b0.getMeasuredWidth();
        ...
        if (eVar.e(new xa(tbVar, 0), wbVar.b0.getWidth(), wbVar.b0.getHeight())) {
            if (dVar != null) {
                dVar.e();
            }
            if (dVar2 != null) {
    ...
    public static void Y(wb wbVar, TLRPC.TL_channels_adminLogResults tL_channels_adminLogResults) {
        ...
        for (int i10 = 0; i10 < tL_channels_adminLogResults.events.size(); i10++) {
            ...
            if (iVar.h(tL_channelAdminLogEvent2.id) < 0) {
                ...
                wbVar.S = Math.min(wbVar.S, tL_channelAdminLogEvent2.id);
                MessageObject messageObject = new MessageObject(wbVar.currentAccount, tL_channelAdminLogEvent2, (ArrayList<MessageObject>) arrayList, (HashMap<String, ArrayList<MessageObject>>) hashMap, wbVar.s, wbVar.X, false);
    ...
    public static void Z(wb wbVar, TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        if (tL_error == null) {
            ...
            wbVar.x0 = tL_channels_channelParticipants.participants;
    ...
    */
    public static void p0(wb wbVar, Bundle bundle, long j3) {
        TLRPC.Chat chat = wbVar.s;
        if (!chat.megagroup || wbVar.x0 == null || !ChatObject.canBlockUsers(chat)) {
            return;
        }
        int i10 = 0;
        while (true) {
            if (i10 >= wbVar.x0.size()) {
                break;
            }
            TLRPC.ChannelParticipant channelParticipant = (TLRPC.ChannelParticipant) wbVar.x0.get(i10);
    ...
    public final MessageObject N0(long j3, long j10, ArrayList arrayList, boolean z10, boolean z11) {
        ...
        if (z11 && arrayList.size() > 1) {
            q11 S0 = S0(messageObject.messageText);
            if (S0 == null) {
                S0 = new q11(LocaleController.getString(z10 ? R.string.EventLogDeletedMultipleMessagesHide : R.string.EventLogDeletedMultipleMessagesShow));
        ...
        MessageObject messageObject2 = arrayList.size() > 0 ? (MessageObject) hc.b.i(1, arrayList) : null;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x0285, code lost:
        ...
        org.telegram.ui.Cells.r6.n(org.telegram.messenger.R.drawable.msg_notspam, 34, r9, r6);
        r3 = null;
        r0.add(null);
        r9.add(null);
        r6.add(null);
    ...
    */
            ...
            if (i10 == 6) {
                ...
                if (getParentActivity() != null) {
                    ...
                    if (messageObject2.type == 0 || messageObject2.caption != null) {
                        ...
                        org.telegram.ui.Cells.r6.n(R.drawable.msg_copy, 3, arrayList5, arrayList4);
                    }
                    if (c10 == 1) {
                        ...
                        if (tL_channelAdminLogEvent4 == null || !(tL_channelAdminLogEvent4.action instanceof TLRPC.TL_channelAdminLogEventActionChangeEmojiStickerSet)) {
                            ...
                            if (tL_channelAdminLogEvent4 != null && (tL_channelAdminLogEvent4.action instanceof TLRPC.TL_channelAdminLogEventActionChangeHistoryTTL) && ChatObject.canUserDoAdminAction(chat2, 13)) {
                                org.telegram.ui.Components.iq iqVar = new org.telegram.ui.Components.iq(getParentActivity(), chat2);
                                iqVar.v = new eb(this);
                                showDialog(iqVar);
                            }
                        } else {
                        ...
                        if (c10 == 3) {
                            ...
                            if ((messageMedia instanceof TLRPC.TL_messageMediaWebPage) && MessageObject.isNewGifDocument(messageMedia.webpage.document)) {
                                ...
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_gif, arrayList5, arrayList4, 11);
                            }
                        } else if (c10 != 4) {
                            Integer num3 = num;
                            if (c10 == 5) {
                                arrayList3.add(LocaleController.getString(R.string.ApplyLocalizationFile));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_language, arrayList5, arrayList4, 5);
                                arrayList3.add(LocaleController.getString(R.string.SaveToDownloads));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_download, arrayList5, arrayList4, num3);
                                arrayList3.add(LocaleController.getString(R.string.ShareFile));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_share, arrayList5, arrayList4, 6);
                            } else if (c10 == '\n') {
                                arrayList3.add(LocaleController.getString(R.string.ApplyThemeFile));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_theme, arrayList5, arrayList4, 5);
                                arrayList3.add(LocaleController.getString(R.string.SaveToDownloads));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_download, arrayList5, arrayList4, num3);
                                arrayList3.add(LocaleController.getString(R.string.ShareFile));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_share, arrayList5, arrayList4, 6);
                                ...
                                org.telegram.ui.Cells.r6.n(R.drawable.msg_gallery, 7, arrayList5, arrayList4);
                                arrayList3.add(LocaleController.getString(R.string.SaveToDownloads));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_download, arrayList5, arrayList4, num3);
                                arrayList3.add(LocaleController.getString(R.string.ShareFile));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_share, arrayList5, arrayList4, 6);
                                ...
                                org.telegram.ui.Cells.r6.n(R.drawable.msg_sticker, 9, arrayList5, arrayList4);
                            } else if (c10 == '\b') {
                                ...
                                if (user3 != null && user3.id != UserConfig.getInstance(this.currentAccount).getClientUserId() && ContactsController.getInstance(this.currentAccount).contactsDict.get(Long.valueOf(user3.id)) == null) {
                                    ...
                                    org.telegram.ui.Cells.r6.n(R.drawable.msg_addcontact, 15, arrayList5, arrayList4);
                                }
                                if (!TextUtils.isEmpty(this.c0.messageOwner.media.phone_number)) {
                                    arrayList3.add(LocaleController.getString(R.string.Copy));
                                    org.telegram.ui.Cells.r6.n(R.drawable.msg_copy, 16, arrayList5, arrayList4);
                                    arrayList3.add(LocaleController.getString(R.string.Call));
                                    org.telegram.ui.Cells.r6.n(R.drawable.msg_calls, 17, arrayList5, arrayList4);
                                }
                            }
                        } else if (this.c0.isVideo()) {
                            arrayList3.add(LocaleController.getString(R.string.SaveToGallery));
                            org.telegram.ui.Cells.r6.o(R.drawable.msg_gallery, arrayList5, arrayList4, num2);
                            arrayList3.add(LocaleController.getString(R.string.ShareFile));
                            org.telegram.ui.Cells.r6.o(R.drawable.msg_share, arrayList5, arrayList4, 6);
                        } else if (this.c0.isMusic()) {
                            arrayList3.add(LocaleController.getString(R.string.SaveToMusic));
                            org.telegram.ui.Cells.r6.o(R.drawable.msg_download, arrayList5, arrayList4, num);
                            arrayList3.add(LocaleController.getString(R.string.ShareFile));
                            org.telegram.ui.Cells.r6.o(R.drawable.msg_share, arrayList5, arrayList4, 6);
                        } else {
                            Integer num4 = num;
                            if (this.c0.getDocument() != null) {
                                ...
                                arrayList3.add(LocaleController.getString(R.string.SaveToDownloads));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_download, arrayList5, arrayList4, num4);
                                arrayList3.add(LocaleController.getString(R.string.ShareFile));
                                org.telegram.ui.Cells.r6.o(R.drawable.msg_share, arrayList5, arrayList4, 6);
                            } else {
                                arrayList3.add(LocaleController.getString(R.string.SaveToGallery));
    ...
    public final TextureView Q0(boolean z10) {
        ...
        if (this.h0 == null) {
            ...
            if (z10) {
                this.h0.addView(this.i0, w7.a6.c(-1.0f, -1));
            }
            TextureView textureView = new TextureView(getParentActivity());
            this.j0 = textureView;
            textureView.setOpaque(false);
            this.i0.addView(this.j0, w7.a6.c(-1.0f, -1));
        }
        ...
        while (true) {
            ...
            if (j3 == j10 || arrayList3.isEmpty()) {
                ...
                if (!arrayList6.isEmpty()) {
                    MessageObject messageObject4 = (MessageObject) hc.b.i(1, arrayList6);
    ...
    */
                ...
                if (L0 >= i12 && L0 < sbVar.h) {
                    ...
                    if (messageObject3.contentType != 1 && messageObject3.getRealId() != 0 && !messageObject3.isSponsored()) {
                        ...
                        if (indexOf == -1) {
                            ...
                            vbVar.d = max;
                            vbVar.c = false;
                            yk0Var.c(indexOf2, max, false, false);
                            return;
                        }
                        return;
                    }
    ...
    public final View createView(Context context) {
        ...
        this.b0.addView(this.L, w7.a6.e(-1, -2, 17));
        this.L.setOnTouchListener(new ai.h(7));
        LinearLayout linearLayout = new LinearLayout(context);
        this.N = linearLayout;
        linearLayout.setBackground(new org.telegram.ui.ActionBar.w5(this.P, this.b0, AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.j6.f2));
        ...
        yk0Var.i = this.P0;
        this.b0.addView(this.E, w7.a6.c(-1.0f, -1));
        ...
        this.a0 = fVar;
        fVar.setup(aVar3);
        this.a0.setFadeZoneTop(AndroidUtilities.dp(2.0f) + org.telegram.ui.ActionBar.l.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight);
        ...
        this.b0.addView(this.a0, w7.a6.c(-1.0f, -1));
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.w = frameLayout2;
        frameLayout2.setVisibility(4);
        this.b0.addView(this.w, w7.a6.e(-1, -1, 51));
        View view = new View(context);
        this.x = view;
        view.setBackground(new org.telegram.ui.ActionBar.w5(this.x, this.b0, AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.f2));
        this.w.addView(this.x, w7.a6.e(36, 36, 17));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.y = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(28.0f));
        this.y.setProgressColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        this.w.addView(this.y, w7.a6.e(32, 32, 17));
        org.telegram.ui.Cells.w0 w0Var = new org.telegram.ui.Cells.w0(context);
        this.Q = w0Var;
        w0Var.setAlpha(0.0f);
        this.Q.setImportantForAccessibility(2);
        this.b0.addView(this.Q, w7.a6.d(-2, -2.0f, 49, 0.0f, 4.0f, 0.0f, 0.0f));
        ...
        ih.e eVar2 = this.K;
        bh.d c10 = eVar2.n.c(eVar2, null, false);
        c10.n(eVar2.r);
        c10.p(AndroidUtilities.dp(22.0f));
        c10.o(AndroidUtilities.dp(6.0f));
        eVar2.s = c10;
        this.b0.addView(this.K, w7.a6.d(-1, 56.0f, 80, 54.0f, 0.0f, 0.0f, 3.0f));
            ...
            public final void onClick(View view2) {
                switch (i15) {
                    case 0:
                        wb wbVar = this.b;
                        if (wbVar.getParentActivity() != null) {
                            org.telegram.ui.Components.i0 i0Var = new org.telegram.ui.Components.i0(wbVar, wbVar.y0, wbVar.A0, wbVar.s.megagroup);
                            i0Var.S(wbVar.x0);
                            i0Var.g0 = new za(wbVar);
                    ...
                    default:
                        ...
                        if (wbVar3.getParentActivity() != null) {
                            ...
                            wbVar3.showDialog(org.telegram.ui.Components.d5.p(wbVar3.getParentActivity(), new wa(wbVar3, 0), null).a);
                            break;
                        }
                        break;
                }
        ...
        this.K.d(false);
        final int i16 = 1;
        this.K.b[4] = new View.OnClickListener(this) { // from class: org.telegram.ui.db
            public final /* synthetic */ wb b;
        ...
        this.b0.addView(this.e0, w7.a6.e(-1, 51, 80));
        ...
        this.e0.addView(this.f0, w7.a6.e(48, 48, 53));
        final int i17 = 2;
        this.f0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.db
            public final /* synthetic */ wb b;
        ...
        this.g0 = l5Var;
        l5Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.ye, false));
        this.g0.setTextSize(15);
        this.g0.setTypeface(AndroidUtilities.bold());
        this.e0.addView(this.g0, w7.a6.d(-1, -2.0f, 19, 108.0f, 0.0f, 0.0f, 0.0f));
        this.I.D(true);
        ...
        this.b0.addView(this.F, w7.a6.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        c1();
