...
public final /* synthetic */ class qf0 implements Runnable {
    ...
    public /* synthetic */ qf0(KeyEvent.Callback callback, TLObject tLObject, Object obj, int i10) {
        this.a = i10;
        this.b = callback;
        this.c = tLObject;
        this.d = obj;
        ...
        switch (this.a) {
            case 0:
                ...
                if (tL_error == null) {
                    ...
                    i15 = ((org.telegram.ui.ActionBar.n2) xg0Var).currentAccount;
                    ...
                    ag0Var.q(new nf0(ag0Var, 5));
                    break;
                } else {
                    ag0Var.e0 = tL_error.text;
                    ag0Var.d0 = false;
            ...
            case 1:
                ...
                ag0Var2.s0.g1(bundle, tL_auth_sentCode, true);
                break;
            case 2:
                ...
                ci.d dVar = gg0Var.b;
                xg0 xg0Var2 = gg0Var.v;
                gg0Var.s = -1;
                if (tLObject3 instanceof TLRPC.auth_SentCode) {
                    gg0Var.f = false;
                    dVar.setLoading(false);
                    org.telegram.ui.ActionBar.d5 parentLayout = xg0Var2.getParentLayout();
                    if (parentLayout != null && parentLayout.getFragmentStack() != null) {
                        ...
                        if (n2Var instanceof xo0) {
                            ...
                            xg0Var2.g1(gg0Var.d, (TLRPC.auth_SentCode) tLObject3, z11);
                            break;
                        }
                    }
                    z11 = true;
                    ...
                    if (str2 == null || !str2.startsWith("FLOOD_WAIT_")) {
                        ...
                        if (str3 == null || !"PHONE_CODE_EXPIRED".equalsIgnoreCase(str3)) {
                            gg0Var.e = tL_error2.text;
                            gg0Var.f = false;
                            dVar.setLoading(false);
                            new org.telegram.ui.Components.xc(xg0Var2.Z, null).H(R.raw.error, LocaleController.formatString(R.string.UnknownErrorCode, tL_error2.text));
                            break;
                        } else {
                        ...
                        AndroidUtilities.runOnUIThread(new cg0(gg0Var, 2), Integer.parseInt(tL_error2.text.substring(11)) * MediaDataController.MAX_STYLE_RUNS_COUNT);
                        break;
                    }
                }
                break;
            case 3:
                ...
                xg0 xg0Var3 = gg0Var2.v;
                xg0Var3.e = true;
                xg0 xg0Var4 = (xg0) LaunchActivity.N();
                if (xg0Var4 == null) {
                    i16 = ((org.telegram.ui.ActionBar.n2) xg0Var3).currentAccount;
                    xg0Var4 = new xg0(i16);
            ...
            case 6:
                AndroidUtilities.runOnUIThread(new ak0(1, (nj0) this.c, MessagesStorage.getInstance(((ek0) this.b).currentAccount).getUser(((TLRPC.TL_contact) this.d).user_id)));
                break;
            case 7:
            ...
            case 8:
                ...
                if (lowerCase.length() == 0) {
                    AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.wn0(sk0Var, new ArrayList(), new ArrayList(), new ArrayList(), 25));
                    break;
                } else {
                    ...
                    while (i33 < arrayList6.size()) {
                        ...
                        if (DialogObject.isEncryptedDialog(vk0Var.d)) {
                            TLRPC.EncryptedChat m10 = org.telegram.messenger.q.m(notificationsCustomSettingsActivity.getMessagesController(), vk0Var.d);
                            if (m10 != null) {
                                strArr = strArr2;
                                c10 = 0;
                            ...
                            if (DialogObject.isUserDialog(vk0Var.d)) {
                                ...
                                if (user3 != null && !user3.deleted) {
                                    ...
                                    while (i17 < i32) {
                                        ...
                                        if ((str7 == null || !(str7.startsWith(str6) || org.telegram.messenger.wh.u(" ", str6, strArr3[0]))) && (translitString == null || !(translitString.startsWith(str6) || org.telegram.messenger.wh.u(" ", str6, translitString)))) {
                    ...
                    AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.wn0(sk0Var, arrayList8, arrayList9, arrayList7, 25));
                    break;
                }
                break;
            case 9:
                ...
                if (photoViewer4.y != null && ju0Var2 == photoViewer4.x8) {
                    ...
                    if (photoViewer5.k8) {
                        ...
                        if (!photoViewer8.J4) {
                            ...
                            h71Var.a(Math.min(photoViewer9.e8, ju0Var.d.f8), z13, photoViewer9.r);
                        }
                        if (BuildVars.LOGS_ENABLED) {
                            ...
                            sb2.append(" r = ");
                            org.telegram.messenger.q.o(ju0Var.d.b8, sb2);
                        }
            ...
            case 22:
                ...
                if (tL_error6 != null) {
                    ...
                    org.telegram.messenger.wh.o(R.string.UnknownError, org.telegram.ui.Components.xc.a0(premiumPreviewFragment), null);
                    break;
                }
                break;
            case 23:
            ...
            case 27:
                ...
                SessionsActivity sessionsActivity = l81Var.f0;
                if (tL_error7 == null) {
            ...
            case 28:
                ...
                SessionsActivity sessionsActivity2 = m81Var.a;
                if (tL_error8 == null) {
            ...
            default:
                ...
                try {
                    ...
                    o81Var.c.getConnectionsManager().sendRequest(tL_auth_acceptLoginToken, new cc0(21, o81Var, m9Var));
                    break;
                } catch (Exception e) {
                    FileLog.e("Failed to pass qr code auth", e);
                    AndroidUtilities.runOnUIThread(new n81(o81Var, i23));
                    m9Var.run();
                }
        }
    }

    public /* synthetic */ qf0(Object obj, Object obj2, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = obj2;
        this.c = obj3;
