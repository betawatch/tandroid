...
public class eg1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.ah, dh0 {
    ...
    public eg1(Bundle bundle) {
        ...
        this.V0 = true ^ org.telegram.messenger.y0.v("topics_end_reached_", j3, getUserConfig().getPreferences(), false);
        fh.c cVar = new fh.c();
    ...
    */
    public static void I0(bo boVar) {
        ...
        if (boVar.getParentLayout().getFragmentStack().size() > 1) {
            org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) boVar.getParentLayout().getFragmentStack().get(boVar.getParentLayout().getFragmentStack().size() - 2);
            if (n2Var instanceof eg1) {
            }
        }
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", -boVar.a());
        ((ActionBarLayout) boVar.getParentLayout()).c(boVar.getParentLayout().getFragmentStack().size() - 1, new eg1(bundle));
        boVar.ja = true;
    ...
    public static boolean U(eg1 eg1Var, TLRPC.TL_error tL_error) {
        ...
        org.telegram.ui.Components.g80.w(parentActivity, eg1Var, org.telegram.ui.Components.vc.a0(eg1Var), isChannelAndNotMegaGroup);
        eg1Var.O0(true);
        return false;
    }
    ...
    public static void V(eg1 eg1Var, View view) {
        ...
        if (eg1Var.t0) {
            ...
            if (fg1Var != null) {
                ...
                x11 x11Var = new x11(bundle, null);
                x11Var.r = new rv0(16, hg1Var, tL_forumTopic);
                kg1Var.presentFragment(x11Var);
            }
            uy uyVar = eg1Var.L0;
            if (uyVar != null) {
        ...
        ng.d.m(eg1Var, j3, tL_forumTopic, 0);
    }
    ...
    public static void X(eg1 eg1Var) {
        ...
        if (kVar != null) {
            kVar.E(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.G8), true);
            eg1Var.actionBar.F(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.E8), false, true);
            eg1Var.actionBar.F(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.F8), true, true);
            eg1Var.actionBar.G(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.I5), true);
        }
        s50 s50Var = eg1Var.P0;
        if (s50Var != null && Build.VERSION.SDK_INT >= 23) {
            s50Var.setForeground(new ColorDrawable(i0.a.k(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.d6), 100)));
        }
        eg1Var.P0();
    }
    ...
    public static void b0(eg1 eg1Var, boolean z10) {
        ...
        if (eg1Var.a1 == null) {
            ...
            eg1Var.a1 = n10;
            if (eg1Var.M0 != null) {
                n10.setBackgroundColor(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.d6));
            }
        ...
        eg1Var.Y0.addUpdateListener(new a21(eg1Var, 17));
        ...
        eg1Var.Y0.setInterpolator(org.telegram.ui.Components.qr.f);
        eg1Var.Y0.start();
    ...
    public final void J0(int i10) {
        if (this.M != i10) {
            this.M = i10;
            this.L.setTextColorKey(i10 == 0 ? org.telegram.ui.ActionBar.i6.Ae : org.telegram.ui.ActionBar.i6.q7);
    ...
    public final void M0(org.telegram.ui.Cells.r2 r2Var) {
        ...
        org.telegram.ui.Components.po poVar = new org.telegram.ui.Components.po(getParentActivity(), this.currentAccount, r32[0].getSwipeBack(), false, new kf1(this, tL_forumTopic), getResourceProvider());
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            f1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.i6.p7));
            f1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.q7));
        ...
        bo boVar = new bo(w.c.e(j3, "chat_id"));
        ng.d.a(boVar, MessagesStorage.TopicKey.of(j10, isMonoForum ? DialogObject.getPeerDialogId(r2Var.N.from_id) : r2Var.N.id));
    ...
    public final void N0(View view) {
        ...
        if (!this.actionBar.a(null)) {
            ...
            this.c0.setTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.y8));
    ...
    */
    public final void O0(boolean z10) {
        ...
        boolean v = org.telegram.messenger.y0.v("dialog_bar_report", j11, notificationsSettings, false);
        boolean v9 = org.telegram.messenger.y0.v("dialog_bar_block", j11, notificationsSettings, false);
        boolean z15 = this.t0;
        if (z15) {
            j3 = 0;
            if (this.w0) {
    ...
    public final void P0() {
        ...
        t51Var.setBackgroundColor(getThemedColor(i10));
    ...
    public final void S0(float f7) {
        this.W = f7;
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.i6.v8);
        ...
        this.actionBar.A(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.i6.t8), getThemedColor(org.telegram.ui.ActionBar.i6.z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.i6.s8), getThemedColor(org.telegram.ui.ActionBar.i6.d6)));
        }
        float f10 = 1.0f - f7;
    ...
    @Override // org.telegram.ui.Components.ah, org.telegram.ui.Components.o50
    public final long a() {
        return -this.a;
    }
    ...
    public final View createView(Context context) {
        ...
        lf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.d6));
        ...
        this.j1 = new ah.n(pf1Var, viewGroup, new v8(pf1Var2, i12));
        ...
        this.N.setOnItemClickListener(new a31(this, 9));
        ...
        textView.setTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.y6));
        ...
        int i16 = org.telegram.ui.ActionBar.i6.de;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 0, null, null, null, xy0Var, i10));
    ...
    public final boolean isLightStatusBar() {
        int themedColor = getThemedColor(this.s0 ? org.telegram.ui.ActionBar.i6.d6 : org.telegram.ui.ActionBar.i6.s8);
        if (this.actionBar.s()) {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.i6.w8);
        }
    ...
    public final void z0(boolean z10) {
        ...
        if (this.H0 != null && ((str = this.y0) != null || this.z0)) {
            ...
            org.telegram.messenger.y0.o(R.string.LinkHashExpired, org.telegram.ui.Components.vc.a0(this), R.raw.linkbroken, 36);
            this.y0 = null;
        }
    }
