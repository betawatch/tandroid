...
public final class e2 extends FrameLayout implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.r9 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (imageReceiver.hasBitmapImage() && imageReceiver.getCurrentAlpha() == 1.0f) {
            ...
            canvas2 = canvas;
            canvas2.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX2(), imageReceiver.getImageY2(), j4.o1);
        }
        ...
        if (i23 == 1) {
            ...
            if (i23 != 2) {
                ...
                if (pageblockphoto != null) {
                    this.L = g4.d(pageblockphoto.photo_id, this.O);
                    ...
                    if (i23 != 0 || (i22 = this.N.level) <= 0) {
                        ...
                        this.s = i15;
                        i14 = org.telegram.messenger.em.v(18.0f, i15, i12);
                        dp = i14;
                    }
                    TLRPC.Photo photo = this.L;
                    h4 h4Var2 = this.b;
                    if (photo == null || (this.H == null && !(photo instanceof org.telegram.ui.web.j2))) {
                        i16 = i13;
                    } else {
                        ...
                        if (photo2 instanceof org.telegram.ui.web.j2) {
                            org.telegram.ui.web.j2 j2Var = (org.telegram.ui.web.j2) photo2;
                            i17 = j2Var.d;
                            i18 = j2Var.e;
                        } else {
                            int i25 = photoSize.w;
                        ...
                        if (i23 == 0) {
                            ...
                            this.K = "80_80_b";
                            j4 j4Var = (j4) this.a;
                            this.T = (DownloadController.getInstance(j4Var.X).getCurrentDownloadMask() & 1) == 0;
                            if (!this.Q) {
                                if (this.L instanceof org.telegram.ui.web.j2) {
                                    this.T = true;
                                    imageReceiver.setStrippedLocation(null);
                                    org.telegram.ui.web.k2.g((org.telegram.ui.web.j2) this.L, imageReceiver, new mu0(this, 9));
                                } else {
                                    File pathToAttach = FileLoader.getInstance(j4Var.X).getPathToAttach(this.H, true);
                                    if (this.T || pathToAttach.exists()) {
                                        imageReceiver.setStrippedLocation(null);
                                        imageReceiver.setImage(ImageLocation.getForPhoto(this.H, this.L), this.I, ImageLocation.getForPhoto(this.J, this.L), this.K, this.H.size, null, h4Var2 != null ? h4Var2.E : null, 1);
                                    } else {
                                        imageReceiver.setStrippedLocation(ImageLocation.getForPhoto(this.H, this.L));
                                        imageReceiver.setImage(null, this.I, ImageLocation.getForPhoto(this.J, this.L), this.K, this.H.size, null, h4Var2 != null ? h4Var2.E : null, 1);
                                    }
                                }
                            }
                            float f11 = dp2;
                        ...
                        this.K = "80_80_b";
                        j4 j4Var2 = (j4) this.a;
                        this.T = (DownloadController.getInstance(j4Var2.X).getCurrentDownloadMask() & 1) == 0;
                        if (!this.Q) {
                        }
                        float f112 = dp2;
                    ...
                    if (i23 == 0) {
                        TL_iv.pageBlockPhoto pageblockphoto2 = this.N;
                        c3 q6 = j4.q(this.a, this, null, pageblockphoto2.caption.text, dp, imageHeight3, pageblockphoto2, this.b);
                        this.c = q6;
                        if (q6 != null) {
                        ...
                        h4Var = h4Var2;
                        c3 p5 = j4.p(this.a, this, null, pageblockphoto3.caption.credit, dp, this.v + this.w, pageblockphoto3, (h4Var2 == null || !h4Var2.G) ? Layout.Alignment.ALIGN_NORMAL : org.telegram.ui.Components.uw0.a(), 0, this.b);
                        this.d = p5;
                    ...
                    i24 = (i23 == 2 || ((this.P instanceof TL_iv.pageBlockCover) && h4Var != null && (arrayList = h4Var.e) != null && arrayList.size() > 1 && (arrayList.get(1) instanceof TL_iv.pageBlockChannel))) ? i16 : AndroidUtilities.dp(8.0f) + i16;
                    c3 c3Var = this.c;
                    if (c3Var != null) {
                        c3Var.s = this.s;
                        c3Var.v = this.v;
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (visibility != 0 || y3 <= e1Var.getTranslationY() || y3 >= e1Var.getTranslationY() + AndroidUtilities.dp(39.0f)) {
            ...
            if (!this.E && this.G == 0) {
                if (!j4.l(this.a, this.b, motionEvent, this, this.c, this.s, this.v)) {
                    if (!j4.l(this.a, this.b, motionEvent, this, this.d, this.s, this.v + this.w) && !super.onTouchEvent(motionEvent)) {
                        return false;
                    }
                }
            }
