...
public final class eu0 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (i10 < this.s.U7) {
            ...
            canvas.drawCircle(i14, dp, i10 == this.s.T7 ? AndroidUtilities.dp(6.0f) : this.c / 2, this.a);
            if (i10 != 0) {
                canvas.drawRect((i10 == this.s.T7 + 1 ? AndroidUtilities.dpf2(2.0f) : 0.0f) + (((i14 - (this.c / 2)) - this.d) - this.f), dp - AndroidUtilities.dp(1.0f), (r2 + this.f) - (i10 == this.s.T7 ? AndroidUtilities.dpf2(2.0f) : 0.0f), AndroidUtilities.dp(2.0f) + dp, this.a);
            }
            i10++;
        }
