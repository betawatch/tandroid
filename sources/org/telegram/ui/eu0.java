...
public final /* synthetic */ class eu0 implements Runnable {
    ...
    public /* synthetic */ eu0(Object obj, int i10) {
        this.a = i10;
        this.b = obj;
    }
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) uu0Var.a.N0.getLayoutParams();
                ((WindowManager) ApplicationLoader.applicationContext.getSystemService("window")).getDefaultDisplay().getRotation();
                int A = org.telegram.messenger.ok.A(34.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
                PhotoViewer photoViewer = uu0Var.a;
                ...
                FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) uu0Var.a.O0.getLayoutParams();
                int A2 = org.telegram.messenger.ok.A(40.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
                PhotoViewer photoViewer2 = uu0Var.a;
            ...
            case 7:
                ...
                View view = i4Var2.O;
                if (view != null) {
                    i4Var2.P.addView(view, w7.y5.c(-1.0f, -1));
                    t1Var.x.P.setVisibility(0);
                    break;
                }
                break;
            case 8:
                nf.f.s(((q1) this.b).a.getContext(), "https://play.google.com/store/apps/details?id=com.google.android.webview");
                break;
            case 9:
            ...
            case 11:
                ...
                if (m3Var != null && (vVar = m3Var.b) != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new ai.s1(g4Var, i20, iArr, iArr2));
                    break;
                }
                break;
            case 12:
            ...
            case 26:
                ...
                break;
            case 27:
                ((org.telegram.ui.ActionBar.m1) this.b).dismiss();
                break;
            case 28:
                ((l6) this.b).run(Boolean.FALSE, null);
                break;
            default:
                ci.x5 x5Var = (ci.x5) this.b;
                i13 = ((org.telegram.ui.ActionBar.m2) ((wn) x5Var.e)).currentAccount;
                NotificationCenter.getInstance(i13).onAnimationFinish(x5Var.b);
                break;
        }
    }
}
