...
public final class q extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void W() {
        ...
        this.I = true;
        org.telegram.ui.Components.tz tzVar = this.c;
        if (tzVar != null && !this.n) {
            tzVar.b();
        }
        p pVar = this.b;
        if (pVar != null) {
        ...
        tL_messages_getArchivedStickers.offset_id = arrayList.isEmpty() ? 0L : ((TLRPC.StickerSetCovered) hc.b.i(1, arrayList)).set.id;
    ...
    public final View createView(Context context) {
        ...
        frameLayout.addView(this.c, w7.a6.c(-1.0f, -1));
        if (this.I) {
            this.c.b();
        } else {
            this.c.c();
        ...
        this.e.setOnScrollListener(new j3(this, i11));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 != NotificationCenter.needAddArchivedStickers) {
            if (i10 != NotificationCenter.stickersDidLoad || (vl0Var = this.e) == null) {
                return;
            }
