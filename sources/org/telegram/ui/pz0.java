...
public final class pz0 implements org.telegram.ui.Components.ll0 {
    ...
    public static void a(pz0 pz0Var, Context context, int i10) {
        ...
        int i18 = 0;
        if (i10 == 0) {
            pz0Var.c.getUserConfig().syncContacts = true;
            pz0Var.c.getUserConfig().saveConfig(false);
            pz0Var.c.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            pz0Var.c.getContactsController().loadContacts(false, 0L);
            return;
        }
        if (i10 == 2) {
            pz0Var.c.getContactsController().resetImportedContacts();
            return;
        }
        if (i10 == 3) {
            pz0Var.c.getMessagesController().forceResetDialogs();
            return;
        }
        if (i10 == 4) {
        ...
        if (i10 == 6) {
            pz0Var.c.getMessagesStorage().clearSentMedia();
            ...
            w7.z5.a();
            i13 = ((org.telegram.ui.ActionBar.p2) pz0Var.c).currentAccount;
            ...
            i14 = ((org.telegram.ui.ActionBar.p2) pz0Var.c).currentAccount;
            ChatThemeController.getInstance(i14).clearCache();
            pz0Var.c.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            k41.W();
            i15 = ((org.telegram.ui.ActionBar.p2) pz0Var.c).currentAccount;
            og.x0.e(i15).a();
            SharedPreferences mainSettings = pz0Var.c.getMessagesController().getMainSettings();
            ...
            edit.apply();
            i16 = ((org.telegram.ui.ActionBar.p2) pz0Var.c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i16).edit();
            i17 = ((org.telegram.ui.ActionBar.p2) pz0Var.c).currentAccount;
        ...
        if (i10 == 7) {
            org.telegram.ui.Components.voip.e2.i(pz0Var.c.getParentActivity());
            return;
        }
        if (i10 == 8) {
        ...
        if (i10 == 9) {
            ((LaunchActivity) pz0Var.c.getParentActivity()).z(true);
            return;
        }
        if (i10 == 10) {
            pz0Var.c.getMessagesStorage().readAllDialogs(-1);
            return;
        }
        if (i10 == 11) {
        ...
        if (i10 == 13) {
            Set<String> set = pz0Var.c.getMessagesController().pendingSuggestions;
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(pz0Var.c.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 == 18) {
                w7.n.a((LaunchActivity) pz0Var.c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
                pz0Var.c.getMessagesController().loadAppConfig();
                TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                pz0Var.c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new mz0(pz0Var, i18));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(pz0Var.c.getParentActivity(), 0, pz0Var.c.z0);
                ...
                if (i10 == 23) {
                    boolean q6 = bi.i1.q(pz0Var.c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Toast.makeText(pz0Var.c.getParentActivity(), LocaleController.getString(!q6 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i18 < pz0Var.c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.p2) pz0Var.c.getParentLayout().getFragmentStack().get(i18)).clearSheets();
                        i18++;
                    }
                    return;
                }
                ...
                if (i10 == 27) {
                    pz0Var.c.getMediaDataController().loadAttachMenuBots(false, true);
                    return;
                }
                if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.p2) pz0Var.c).currentAccount;
                ...
                if (i10 == 35) {
                    i11 = ((org.telegram.ui.ActionBar.p2) pz0Var.c).currentAccount;
            ...
            ProfileActivity.S0(pz0Var.c, MediaController.VIDEO_MIME_TYPE, sb3);
            ProfileActivity.S0(pz0Var.c, "video/hevc", sb3);
            ProfileActivity.S0(pz0Var.c, "video/x-vnd.on2.vp8", sb3);
            ProfileActivity.S0(pz0Var.c, "video/x-vnd.on2.vp9", sb3);
            pz0Var.c.showDialog(new oz0(pz0Var, pz0Var.c.getParentActivity(), sb3.toString()));
    ...
    public final boolean d(int i10, View view) {
        ...
        if (i10 != profileActivity.z3) {
            ...
            try {
                ...
                org.telegram.ui.Components.wc.a0(profileActivity).i(LocaleController.getString(R.string.BirthdayCopied)).j();
                return true;
            } catch (Exception e) {
                FileLog.e(e);
                return true;
        ...
        String string15 = LocaleController.getString(bi.i1.q(profileActivity.getParentActivity()) ? "DebugMenuDualOff" : "DebugMenuDualOn");
        ...
        if (SharedConfig.canBlurChat()) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                alertDialog$Builder.f(charSequenceArr, new kg.j(11, this, this.b));
                alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
        ...
        alertDialog$Builder.f(charSequenceArr2, new kg.j(11, this, this.b));
        alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
        profileActivity.showDialog(d2Var);
        return true;
    }
