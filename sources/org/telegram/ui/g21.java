...
public final class g21 extends org.telegram.ui.Components.kl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        switch (i13) {
            ...
            case 5:
                ...
                h21Var.setChecked(SharedConfig.currentProxy == proxyInfo);
                boolean contains = arrayList.contains(arrayList2.get(i10 - proxyListActivity.n));
                h21Var.h = contains;
                h21Var.f.a(contains, false);
    ...
    public final void w(s4.c1 c1Var, int i10, List list) {
        ...
        if (i12 == 5 && !list.isEmpty()) {
            h21 h21Var = (h21) view;
            if (list.contains(1) && (contains = arrayList.contains(proxyListActivity.G.get(i10 - proxyListActivity.n))) != h21Var.h) {
                h21Var.h = contains;
                h21Var.f.a(contains, true);
            }
            if (list.contains(2)) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            a7Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.d6, false));
        } else if (i10 == 2) {
