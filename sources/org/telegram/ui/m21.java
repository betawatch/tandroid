...
public final class m21 extends FrameLayout {
    public final TextView a;
    public final TextView b;
    public final ImageView c;
    public SharedConfig.ProxyInfo d;
    public Drawable e;
    public final org.telegram.ui.Components.tp f;
    public boolean h;
    public boolean n;
    public int r;
    ...
    public m21(ProxyListActivity proxyListActivity, Context context) {
        super(context);
        ...
        addView(textView, w7.a6.d(-2, -2.0f, (z10 ? 5 : 3) | 48, z10 ? 56 : 21, 10.0f, z10 ? 21 : 56, 0.0f));
        ...
        addView(textView2, w7.a6.d(-2, -2.0f, (z11 ? 5 : 3) | 48, z11 ? 56 : 21, 35.0f, z11 ? 21 : 56, 0.0f));
        ...
        addView(imageView, w7.a6.d(48, 48.0f, (LocaleController.isRTL ? 3 : 5) | 48, 8.0f, 8.0f, 8.0f, 0.0f));
        ...
        addView(tpVar, w7.a6.d(24, 24.0f, (LocaleController.isRTL ? 5 : 3) | 16, 16.0f, 0.0f, 8.0f, 0.0f));
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            duration.addUpdateListener(new og(this, dp, 4));
            duration.addListener(new iw0(2, this, z10));
            duration.start();
            return;
        }
        if (!z10) {
        ...
        float f7 = dp2 + dp;
        org.telegram.ui.Components.tp tpVar = this.f;
        tpVar.setTranslationX(f7);
        imageView.setVisibility(z10 ? 8 : 0);
        imageView.setAlpha(1.0f);
        imageView.setScaleX(1.0f);
        imageView.setScaleY(1.0f);
        tpVar.setVisibility(z10 ? 0 : 8);
        tpVar.setAlpha(1.0f);
        tpVar.setScaleX(1.0f);
        tpVar.setScaleY(1.0f);
    }
    ...
    */
    public final void b() {
            ...
            if (proxyListActivity.d) {
                ...
                if (i11 == 3 || i11 == 5) {
                    ...
                    if (proxyInfo2.ping != 0) {
                        ...
                        org.telegram.messenger.em.l(R.string.Connected, ", ", sb2);
        ...
        if (proxyInfo2.checking) {
            ...
            if (proxyInfo2.ping != 0) {
                ...
                org.telegram.messenger.em.l(R.string.Available, ", ", sb3);
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), TLObject.FLAG_30), org.telegram.messenger.em.C(64.0f, 1, TLObject.FLAG_30));
    }
