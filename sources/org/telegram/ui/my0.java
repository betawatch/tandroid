    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (sz0Var != null) {
            if (sz0Var.C()) {
                ...
                if (sz0Var2.z1 && sz0Var2.getClosestTab() == 13) {
                    return false;
                }
            }
            if (profileActivity.L.C()) {
                sz0 sz0Var3 = profileActivity.L;
                if (sz0Var3.z1 && (sz0Var3.getClosestTab() == 8 || org.telegram.ui.Components.yu0.w0(profileActivity.L.getClosestTab()))) {
                    return false;
                }
            }
        ...
        if ((action == 1 || action == 3) && (m9 = profileActivity.c.m(0)) != null) {
            ...
            if (profileActivity.l2) {
                if (!profileActivity.m2) {
                    profileActivity.a.v0(0, m9.getTop() - profileActivity.T3(), org.telegram.ui.Components.nr.h);
                    return onTouchEvent;
                }
                int currentActionBarHeight2 = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
                kVar = ((org.telegram.ui.ActionBar.p2) profileActivity).actionBar;
                profileActivity.a.v0(0, ((m9.getTop() - profileActivity.a.getMeasuredWidth()) - profileActivity.O3()) + currentActionBarHeight2 + (kVar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0), org.telegram.ui.Components.nr.h);
                return onTouchEvent;
            }
            ...
            if (z4) {
                ...
                if (f10 > 0.0f && ((f10 < profileActivity.T3() * 0.6f || profileActivity.f2 < -1000.0f) && profileActivity.N1 > profileActivity.O3() * 0.6f)) {
                    profileActivity.a.v0(0, (int) (profileActivity.N1 - profileActivity.O3()), org.telegram.ui.Components.nr.h);
                    return onTouchEvent;
                }
            }
            if (z4) {
                ...
                if (f11 > 0.0f && f11 < profileActivity.O3() * 0.6f) {
                    profileActivity.a.v0(0, (int) (profileActivity.O3() - profileActivity.N1), org.telegram.ui.Components.nr.h);
                    return onTouchEvent;
                }
            }
            if (!z4) {
                ...
                if (f12 > 0.0f && profileActivity.f2 < -1000.0f) {
                    profileActivity.a.v0(0, (int) f12, org.telegram.ui.Components.nr.h);
                    return onTouchEvent;
                }
            }
