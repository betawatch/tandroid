...
public class y60 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate, xd.b, View.OnClickListener, ch.d {
    ...
    public y60(Bundle bundle) {
        ...
        this.b = new xd.c(3, this, nrVar, 350L);
        this.c = new xd.a(4, this, nrVar, 350L, false);
        this.W = new a0.h();
    ...
    public static void U(y60 y60Var, Context context, View view, int i10) {
        ...
        int i12 = 0;
        if (i10 == w60Var.w) {
            int i13 = y60Var.currentAccount;
            org.telegram.ui.ActionBar.f6 f6Var = y60Var.resourceProvider;
            o60 o60Var = new o60(y60Var, i12);
            org.telegram.ui.ActionBar.d2 d2Var = new org.telegram.ui.ActionBar.d2(context, 3, null);
            d2Var.q(500L);
            TL_phone.createConferenceCall createconferencecall = new TL_phone.createConferenceCall();
            createconferencecall.random_id = Utilities.random.nextInt();
            ConnectionsManager.getInstance(i13).sendRequest(createconferencecall, new lf.i0(i13, d2Var, context, f6Var, o60Var, 5));
            return;
        }
        if (i10 == 0 && w60Var.C != 0 && !w60Var.n) {
            org.telegram.ui.Components.de0 de0Var = new org.telegram.ui.Components.de0(context, y60Var, y60Var.F, y60Var.D, j11 != 0);
            y60Var.a0 = de0Var;
        ...
        if (view instanceof org.telegram.ui.Cells.g4) {
            ...
            if (g4Var.r) {
                ...
                if (n30Var == null) {
                    org.telegram.ui.Components.n30 n30Var2 = new org.telegram.ui.Components.n30(y60Var.f.r.getContext(), "premium");
                    y60Var.U = n30Var2;
                    y60Var.h.a(n30Var2);
            ...
            if (g4Var.s) {
                ...
                if (n30Var3 == null) {
                    org.telegram.ui.Components.n30 n30Var4 = new org.telegram.ui.Components.n30(y60Var.f.r.getContext(), "miniapps");
                    y60Var.V = n30Var4;
                    y60Var.h.a(n30Var4);
            ...
            if (hVar == null || hVar.h(j10) < 0) {
                if (g4Var.L) {
                    ...
                    String userName = j10 >= 0 ? UserObject.getUserName(MessagesController.getInstance(y60Var.currentAccount).getUser(Long.valueOf(j10))) : "";
                    (MessagesController.getInstance(y60Var.currentAccount).premiumFeaturesBlocked() ? org.telegram.ui.Components.qc.a0(y60Var).Q(R.raw.star_premium_2, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserBlockedNonPremium, userName))) : org.telegram.ui.Components.qc.a0(y60Var).J(R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserBlockedNonPremium, userName)), LocaleController.getString(R.string.UserBlockedNonPremiumButton), new o60(y60Var, 2))).j();
                    return;
                }
                ...
                if (n30Var5 != null) {
                    ...
                    org.telegram.ui.Components.n30 n30Var6 = new org.telegram.ui.Components.n30(y60Var.f.r.getContext(), object);
                    y60Var.h.a(n30Var6);
    ...
    public static void Z(y60 y60Var) {
        ...
        y60Var.c.a(!y60Var.W.i(), true);
    }

    public static void a0(y60 y60Var, Canvas canvas, RectF rectF, Paint paint) {
        sg.d dVar;
        canvas.drawRect(rectF, paint);
        if (Build.VERSION.SDK_INT < 29 || !SharedConfig.chatBlurEnabled() || (dVar = y60Var.n0) == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.h = q60Var;
        q60Var.setDelegate(new n60(this, i10));
        this.h.getSpansContainer().setOnClickListener(new p60(this, i10));
        q60 q60Var2 = this.h;
        this.W = q60Var2.b;
        this.X = q60Var2.c;
        r0();
        this.f.r.setOnEditorActionListener(new ha(this, 4));
        this.f.r.setOnKeyListener(new r60(i10, this));
        ...
        float f10 = -this.a;
        l0Var.addView(sl0Var3, k7.b6.d(-1, -1.0f, 119, 0.0f, f10, 0.0f, f10));
        ...
        if (!z12) {
            l0Var.addView(this.y, org.telegram.ui.Components.z10.b());
        }
        this.y.setOnClickListener(new p60(this, i11));
        ...
        if (z12) {
            ...
            dVar.setOnClickListener(new p60(this, i13));
            ...
            dVar2.setOnClickListener(new p60(this, i16));
        ...
        l0Var.addView(this.f, k7.b6.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        l0Var.addView(this.h);
        org.telegram.ui.Components.sl0 sl0Var5 = this.n;
        Objects.requireNonNull(sl0Var5);
        this.o0 = new ng.k(sl0Var5, l0Var, new ts(sl0Var5, i10));
        this.n.C0(new o60(this, i16));
    ...
    */
                ...
                if (this.e0 != (this.V == null) && hashSet.size() == hashSet2.size()) {
                    ...
                    if (z10) {
                        if (z4) {
                            ...
                            alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new n60(this, 1));
                            alertDialog$Builder.h(LocaleController.getString(R.string.PassportDiscard), new n60(this, 2));
    ...
    public final void h0() {
        ...
        if (z10Var != null) {
            z10Var.setTranslationY(-Math.max(this.j0, this.k0));
        }
    }
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.g4) {
                ...
                if (RecyclerView.R(childAt) == this.v.v) {
                    ((org.telegram.ui.Cells.u3) childAt).b((this.U == null && this.W.i()) ? "" : LocaleController.getString(R.string.DeselectAll), new p60(this, 4));
                }
            }
        }
    }
            ...
            if (!z4) {
                ...
                if (this.B) {
                    ...
                    if (this.L || this.M) {
                        u60 u60Var = this.w;
                        if (u60Var != null) {
                            u60Var.b(arrayList2, this.U != null, this.V != null);
                        }
                        finishFragment();
                        return true;
                    }
                ...
                if (!ChatObject.isChannel(chat)) {
                    ...
                    z1VarArr[0].setOnClickListener(new q20(z1VarArr, i12));
    ...
    public final void q0(int i10) {
        ...
        AndroidUtilities.doOnPreDraw(this.n, new org.telegram.ui.Components.hm(this, i10, 14));
    }
    ...
    public final void r0() {
        ...
        if (this.O || ((w60Var = this.v) != null && w60Var.D == 0)) {
