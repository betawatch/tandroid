...
public final class mt0 implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        ...
        lu0 lu0Var = this.d;
        int abs = (int) Math.abs(this.c - lu0Var.a.getImageX());
        float imageY = lu0Var.a.getImageY();
        float f15 = this.e;
        int abs2 = (int) Math.abs(f15 - imageY);
        if (lu0Var.a.isAspectFit()) {
            abs = 0;
        }
        int[] iArr = new int[2];
        lu0Var.d.getLocationInWindow(iArr);
        float f16 = lu0Var.c + f15;
        int i11 = (int) ((iArr[1] - f16) + lu0Var.j);
        if (i11 < 0) {
            i11 = 0;
        }
        int height = (int) (((f16 + layoutParams.height) - (lu0Var.d.getHeight() + r10)) + lu0Var.i);
        if (height < 0) {
            height = 0;
        }
        ...
        org.telegram.ui.Components.ky0 ky0Var = new org.telegram.ui.Components.ky0(this, clippingImageViewArr, this.h, this.n, this.f, 21);
        photoViewer.m4 = ky0Var;
        if (photoViewer.i2) {
            ky0Var.run();
            photoViewer.m4 = null;
            ...
            for (int i14 = 0; i14 < clippingImageViewArr.length; i14++) {
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(clippingImageViewArr[i14], org.telegram.ui.Components.n6.f, 0.0f, 1.0f);
                if (i14 == 0) {
            ...
            du0 du0Var = photoViewer.b0;
            Property property = View.ALPHA;
            arrayList.add(ObjectAnimator.ofFloat(du0Var, (Property<du0, Float>) property, 0.0f, 1.0f));
