...
public final class ha1 extends LinearLayout {
    ...
    public void setData(ja1 ja1Var) {
        TextView[] textViewArr = this.a;
        textViewArr[0].setText(ja1Var.b);
        textViewArr[1].setText(ja1Var.f);
        textViewArr[2].setText(ja1Var.j);
        textViewArr[3].setText(ja1Var.n);
        TextView[] textViewArr2 = this.b;
        textViewArr2[0].setText(ja1Var.c);
        textViewArr2[0].setTag(Integer.valueOf(ja1Var.d ? org.telegram.ui.ActionBar.k6.x6 : org.telegram.ui.ActionBar.k6.p7));
        textViewArr2[1].setText(ja1Var.g);
        textViewArr2[1].setTag(Integer.valueOf(ja1Var.h ? org.telegram.ui.ActionBar.k6.x6 : org.telegram.ui.ActionBar.k6.p7));
        textViewArr2[2].setText(ja1Var.k);
        textViewArr2[2].setTag(Integer.valueOf(ja1Var.l ? org.telegram.ui.ActionBar.k6.x6 : org.telegram.ui.ActionBar.k6.p7));
        textViewArr2[3].setText(ja1Var.o);
        textViewArr2[3].setTag(Integer.valueOf(ja1Var.p ? org.telegram.ui.ActionBar.k6.x6 : org.telegram.ui.ActionBar.k6.p7));
        TextView[] textViewArr3 = this.c;
        textViewArr3[0].setText(ja1Var.a);
        textViewArr3[1].setText(ja1Var.e);
        textViewArr3[2].setText(ja1Var.i);
        textViewArr3[3].setText(ja1Var.m);
        b();
    }
}
