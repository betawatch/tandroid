...
public final class oc1 implements org.telegram.ui.ActionBar.d6 {
    ...
    public Matrix v;
    public final /* synthetic */ od1 w;
    public final /* synthetic */ od1 x;
    ...
    public final Paint G(String str) {
        ...
        switch (str) {
            ...
            default:
                ...
                return d6Var != null ? d6Var.G(str) : org.telegram.ui.ActionBar.h6.S0(str);
        }
    }
    ...
    public final boolean a() {
        fd1 fd1Var = this.x.p1;
        if (fd1Var != null) {
            return fd1Var.a();
        }
        fd1 fd1Var2 = this.w.p1;
        if (fd1Var2 != null) {
            return fd1Var2.a();
        }
        org.telegram.ui.ActionBar.d6 d6Var = this.a;
        return d6Var != null ? d6Var.a() : org.telegram.ui.ActionBar.h6.I.q();
    }

    public final void b(Drawable drawable, Drawable drawable2, Float f7) {
        int i10 = org.telegram.ui.ActionBar.h6.lc;
        int G0 = G0(i10);
        int G02 = G0(org.telegram.ui.ActionBar.h6.mc);
        if (drawable == null) {
            drawable = drawable2;
        }
        ...
        if ((z10 || (drawable instanceof BitmapDrawable)) && SharedConfig.getDevicePerformanceClass() != 0 && LiteMode.isEnabled(32)) {
            ...
            textPaint2.linkColor = G0(org.telegram.ui.ActionBar.h6.jc);
        }
        Paint paint = this.c;
        paint.setColor(G0);
        Paint paint2 = this.d;
    ...
    public final int g1(int i10) {
        org.telegram.ui.ActionBar.d6 d6Var = this.a;
        return d6Var != null ? d6Var.g1(i10) : G0(i10);
    }
