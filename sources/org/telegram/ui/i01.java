...
public final class i01 extends FrameLayout {
    ...
    public final void a(MessagesController.PeerColor peerColor, boolean z10) {
        ...
        if (peerColor != null) {
            this.c = true;
            this.e = peerColor.getBgColor1(org.telegram.ui.ActionBar.f6.I.q());
            ...
            if (i9 != 0) {
                ...
                this.C = zo0.t0(this.e);
                this.D = org.telegram.ui.ActionBar.f6.l1(0.15f, zo0.t0(this.e));
            }
        } else {
            profileActivity.Y0 = this.a;
            this.c = false;
            int i10 = org.telegram.ui.ActionBar.f6.s8;
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.f6.v0(i10, profileActivity.v0)) > 0.8f) {
                this.C = -1;
                this.D = -1;
            } else if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.f6.v0(i10, profileActivity.v0)) < 0.2f) {
                this.C = org.telegram.ui.ActionBar.f6.l1(0.5f, org.telegram.ui.ActionBar.f6.b(0.02f, 0.25f, org.telegram.ui.ActionBar.f6.v0(i10, profileActivity.v0)));
                this.D = org.telegram.ui.ActionBar.f6.l1(0.35f, org.telegram.ui.ActionBar.f6.b(0.02f, 0.25f, org.telegram.ui.ActionBar.f6.v0(i10, profileActivity.v0)));
            } else {
                this.C = zo0.t0(org.telegram.ui.ActionBar.f6.v0(i10, profileActivity.v0));
                this.D = org.telegram.ui.ActionBar.f6.l1(0.15f, zo0.t0(org.telegram.ui.ActionBar.f6.v0(i10, profileActivity.v0)));
            }
        }
        if (!z10) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i9 = (int) ((1.0f - profileActivity.A5) * f11);
        Paint paint3 = this.b;
        if (i9 != 0) {
            ...
            if (pg0Var != null) {
                int i10 = this.D;
                boolean z10 = this.c;
                if (pg0Var.O == null || pg0Var.M != i10 || pg0Var.N != z10) {
                    pg0Var.M = i10;
                    pg0Var.N = z10;
                    pg0Var.g();
                }
            ...
            if (e10 < 1.0f) {
                paint2 = paint3;
                canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), i9, paint2);
            } else {
                paint2 = paint3;
            }
            if (e10 > 0.0f) {
                ...
                paint = paint2;
                canvas2 = canvas;
                canvas2.drawRect(0.0f, 0.0f, getMeasuredWidth(), i9, paint4);
            } else {
                canvas2 = canvas;
                paint = paint2;
            }
            if (this.G) {
                ...
                if (!z11) {
                    if (i5Var != null) {
                        ...
                        if ((drawable instanceof org.telegram.ui.Components.k5) && (z2Var = ((org.telegram.ui.Components.k5) drawable).k) != null && z2Var.hasImageLoaded()) {
                            this.H = true;
                        }
                    }
                    z12 = false;
                ...
                if ((!profileActivity.C1 || profileActivity.F1 != 2) && e11 > 0.0f && profileActivity.U != null) {
                    canvas2.save();
                    canvas2.clipRect(0, 0, getMeasuredWidth(), i9);
                    ...
                    float A = e2.c.A(kVar5.getHeight(), f14, 2.0f, profileActivity.U3() + f14);
                    ...
                    if (obj != null && (zVar = (actionBar = ((org.telegram.ui.ActionBar.o2) obj).getActionBar()).A) != null) {
        ...
        if (i9 == f11 || profileActivity.C1) {
            return;
        }
        paint.setColor(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.d6, profileActivity.v0));
        this.I.set(0, i9, getMeasuredWidth(), (int) f11);
