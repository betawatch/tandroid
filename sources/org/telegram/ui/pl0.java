...
public final class pl0 extends FrameLayout {
    ...
    public /* synthetic */ pl0(Context context, EditTextBoldCursor editTextBoldCursor, int i10) {
        super(context);
        this.a = i10;
    ...
    public final void onMeasure(int i10, int i11) {
        switch (this.a) {
                        ...
                        while (true) {
                            if (i12 < lineCount) {
                                if (((StaticLayout) this.b).getLineLeft(i12) != 0.0f) {
                                    ...
                                    f9 = Math.max(f9, ((StaticLayout) this.b).getLineWidth(i12));
                                    if (i12 == lineCount - 1) {
                                        this.c = size - f9;
                                    }
                                    i12++;
            ...
            default:
                super.onMeasure(i10, i11);
                org.telegram.ui.Components.aj0 aj0Var = ((org.telegram.ui.Components.gi0) this.d).h;
                float measuredHeight = (r0.f / 768.0f) * ((org.telegram.ui.Components.je) this.b).getMeasuredHeight();
