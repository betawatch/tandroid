...
public final class f60 extends FrameLayout {
    ...
    public final void a(double d, boolean z10) {
        ...
        if (z10) {
            ...
            if (groupCallParticipant.volume == 0) {
                ...
                i60Var.d1(true);
                i60Var.x1(groupCallParticipant, peerId, i60Var.Q0() ? 0 : 5);
            } else {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        fArr[1] = dp2;
        fArr[0] = dp2;
        float dp3 = AndroidUtilities.dp(6.0f) * (f60Var.n < AndroidUtilities.dp(12.0f) ? Math.max(0.0f, (f60Var.n - AndroidUtilities.dp(6.0f)) / AndroidUtilities.dp(6.0f)) : 1.0f);
        fArr[5] = dp3;
        fArr[4] = dp3;
        fArr[3] = dp3;
        fArr[2] = dp3;
        float f12 = f60Var.n;
        float measuredHeight = f60Var.getMeasuredHeight();
        RectF rectF = f60Var.y;
        ...
        org.telegram.ui.Components.lj0 lj0Var = f60Var.a;
