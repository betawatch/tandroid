...
public final class b41 extends org.telegram.ui.ActionBar.f3 {
        ...
        if (context != null) {
            ...
            if (z10) {
                ...
                if (z11) {
                    ...
                    tL_reportMessage.option = bArr;
                    tL_messages_report = tL_reportMessage;
                    ConnectionsManager.getInstance(i10).sendRequestTyped(tL_messages_report, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.r31
                        @Override // org.telegram.messenger.Utilities.Callback2
                        public final void run(Object obj, Object obj2) {
                            b41.m(context, e6Var, z10, z11, j3, arrayList, zArr, callback, xcVar, (TLRPC.ReportResult) obj);
                        }
                    });
                }
    ...
    public static void N(zn znVar, MessageObject messageObject, org.telegram.ui.ActionBar.e6 e6Var) {
        int currentAccount = znVar.getCurrentAccount();
        Activity parentActivity = znVar.getParentActivity();
        long a2 = znVar.a();
        if (parentActivity == null) {
    ...
    public static void m(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10, boolean z11, long j3, ArrayList arrayList, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.Components.xc xcVar, TLRPC.ReportResult reportResult) {
        ...
        if (z12) {
            ...
            View[] viewPages = b41Var.b.getViewPages();
            View view = viewPages[0];
            if (view instanceof a41) {
                ((a41) view).a(0);
                b41Var.containerView.post(new cy0(21, viewPages, tL_reportResultAddComment));
            }
        ...
        b41Var.s = new s31(zArr, callback, xcVar);
    ...
    public static void n(b41 b41Var, TLObject tLObject, CharSequence charSequence, TLRPC.TL_error tL_error, byte[] bArr, String str) {
        ...
        x31 x31Var2;
        ci.d dVar;
        ci.i1 i1Var = b41Var.b;
        if ((i1Var.getCurrentView() instanceof a41) && (dVar = ((a41) i1Var.getCurrentView()).s) != null) {
        ...
        if (tLObject == null) {
            if (tL_error != null) {
                if (!b41Var.d && "MESSAGE_ID_REQUIRED".equals(tL_error.text)) {
                    ...
                    x31 x31Var3 = b41Var.s;
                    if (x31Var3 != null) {
                        x31Var3.c();
                    }
                } else if ("AD_EXPIRED".equals(tL_error.text) && (x31Var = b41Var.s) != null) {
                    x31Var.a();
                }
                b41Var.dismiss();
                return;
        ...
        if (!z10 && !(tLObject instanceof TLRPC.TL_reportResultChooseOption) && !(tLObject instanceof TLRPC.TL_reportResultAddComment)) {
            ...
            if (((tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) || (tLObject instanceof TLRPC.TL_reportResultReported)) && (x31Var2 = b41Var.s) != null) {
                x31Var2.a();
                b41Var.dismiss();
                return;
            }
        ...
        if (a41Var != null) {
            ...
            if (tLObject instanceof TLRPC.TL_reportResultChooseOption) {
                a41Var.b = null;
                a41Var.c = (TLRPC.TL_reportResultChooseOption) tLObject;
                a41Var.d = null;
                t61Var.Y2.N(false);
            } else if (tLObject instanceof TLRPC.TL_reportResultAddComment) {
                a41Var.b((TLRPC.TL_reportResultAddComment) tLObject);
            } else if (z10) {
                a41Var.b = (TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject;
                a41Var.c = null;
                a41Var.d = null;
                t61Var.Y2.N(false);
            }
    ...
    public final void O(TLRPC.TL_channels_sponsoredMessageReportResultChooseOption tL_channels_sponsoredMessageReportResultChooseOption) {
        ...
        if (view instanceof a41) {
            ((a41) view).a(0);
            this.containerView.post(new cy0(20, viewPages, tL_channels_sponsoredMessageReportResultChooseOption));
        }
        View view2 = viewPages[1];
        if (view2 instanceof a41) {
            ((a41) view2).a(1);
    ...
    public final void P(TLRPC.TL_reportResultChooseOption tL_reportResultChooseOption) {
        ...
        if (view instanceof a41) {
            ((a41) view).a(0);
            this.containerView.post(new cy0(22, viewPages, tL_reportResultChooseOption));
        }
        View view2 = viewPages[1];
        if (view2 instanceof a41) {
            ((a41) view2).a(1);
    ...
    public final boolean canDismissWithSwipe() {
        if (this.b.getCurrentView() instanceof a41) {
            return !((a41) r0).f.canScrollVertically(-1);
        }
        return true;
    }
    ...
    public final void onBackPressed() {
        z31 z31Var;
        ci.i1 i1Var = this.b;
        if ((i1Var.getCurrentView() instanceof a41) && (z31Var = ((a41) i1Var.getCurrentView()).n) != null) {
    ...
    public b41(boolean z10, Context context, org.telegram.ui.ActionBar.e6 e6Var, long j3, boolean z11, boolean z12, ArrayList arrayList, byte[] bArr) {
        ...
        fixNavigationBar(org.telegram.ui.ActionBar.j6.v0(i10, e6Var));
