...
public final class z2 extends View implements org.telegram.ui.Cells.j9, i3 {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(m4.i(R.string.AccDescrIVTitle, m4.j(this.e, this.f, f3Var)));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblocktitle != null) {
            ...
            k4 k4Var = this.f;
            f3 p10 = m4.p(d70Var2, this, null, richText, dp, 0, pageblocktitle2, (k4Var == null || !k4Var.C) ? Layout.Alignment.ALIGN_NORMAL : org.telegram.ui.Components.bw0.a(), 0, this.f);
            this.a = p10;
            if (p10 != null) {
                d70Var.getClass();
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        return m4.l(this.e, this.f, motionEvent, this, this.a, this.c, this.d) || super.onTouchEvent(motionEvent);
    }
