...
public final class sy0 implements org.telegram.ui.Components.kl0 {
    public int a = 0;
    public final /* synthetic */ Context b;
    public final /* synthetic */ ProfileActivity c;

    public sy0(ProfileActivity profileActivity, Context context) {
        this.c = profileActivity;
        this.b = context;
    }

    public static void a(sy0 sy0Var, Context context, int i10) {
        int i11;
        int i12;
        long j10;
        Long l10;
        ...
        int i18 = 0;
        if (i10 == 0) {
            sy0Var.c.getUserConfig().syncContacts = true;
            sy0Var.c.getUserConfig().saveConfig(false);
            sy0Var.c.getContactsController().forceImportContacts();
            return;
        }
        long j11 = 0;
        if (i10 == 1) {
            sy0Var.c.getContactsController().loadContacts(false, 0L);
            return;
        }
        if (i10 == 2) {
            sy0Var.c.getContactsController().resetImportedContacts();
            return;
        }
        if (i10 == 3) {
            sy0Var.c.getMessagesController().forceResetDialogs();
            return;
        }
        if (i10 == 4) {
        ...
        if (i10 == 6) {
            sy0Var.c.getMessagesStorage().clearSentMedia();
            ...
            k7.a6.a();
            i13 = ((org.telegram.ui.ActionBar.p2) sy0Var.c).currentAccount;
            ...
            i14 = ((org.telegram.ui.ActionBar.p2) sy0Var.c).currentAccount;
            ChatThemeController.getInstance(i14).clearCache();
            sy0Var.c.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            n31.W();
            i15 = ((org.telegram.ui.ActionBar.p2) sy0Var.c).currentAccount;
            cg.f1.e(i15).a();
            SharedPreferences mainSettings = sy0Var.c.getMessagesController().getMainSettings();
            ...
            edit.apply();
            i16 = ((org.telegram.ui.ActionBar.p2) sy0Var.c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i16).edit();
            i17 = ((org.telegram.ui.ActionBar.p2) sy0Var.c).currentAccount;
        ...
        if (i10 == 7) {
            org.telegram.ui.Components.voip.f2.j(sy0Var.c.getParentActivity());
            return;
        }
        if (i10 == 8) {
        ...
        if (i10 == 9) {
            ((LaunchActivity) sy0Var.c.getParentActivity()).z(true);
            return;
        }
        if (i10 == 10) {
            sy0Var.c.getMessagesStorage().readAllDialogs(-1);
            return;
        }
        if (i10 == 11) {
        ...
        if (i10 == 13) {
            Set<String> set = sy0Var.c.getMessagesController().pendingSuggestions;
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(sy0Var.c.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 == 18) {
                k7.x8.a((LaunchActivity) sy0Var.c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
                sy0Var.c.getMessagesController().loadAppConfig();
                TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                sy0Var.c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new py0(sy0Var, i18));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(sy0Var.c.getParentActivity(), 0, sy0Var.c.w0);
                ...
                if (i10 == 23) {
                    boolean q10 = ph.v0.q(sy0Var.c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q10).apply();
                    Toast.makeText(sy0Var.c.getParentActivity(), LocaleController.getString(!q10 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i18 < sy0Var.c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.p2) sy0Var.c.getParentLayout().getFragmentStack().get(i18)).clearSheets();
                        i18++;
                    }
                    return;
                }
                ...
                if (i10 == 27) {
                    sy0Var.c.getMediaDataController().loadAttachMenuBots(false, true);
                    return;
                }
                if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.p2) sy0Var.c).currentAccount;
                ...
                if (i10 == 35) {
                    i11 = ((org.telegram.ui.ActionBar.p2) sy0Var.c).currentAccount;
            ...
            ProfileActivity.S0(sy0Var.c, MediaController.VIDEO_MIME_TYPE, sb2);
            ProfileActivity.S0(sy0Var.c, "video/hevc", sb2);
            ProfileActivity.S0(sy0Var.c, "video/x-vnd.on2.vp8", sb2);
            ProfileActivity.S0(sy0Var.c, "video/x-vnd.on2.vp9", sb2);
            sy0Var.c.showDialog(new ry0(sy0Var, sy0Var.c.getParentActivity(), sb2.toString()));
