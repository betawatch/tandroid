...
public class MessageSuggestionOfferSheet extends BottomSheet {
    ...
    public /* synthetic */ void lambda$new$5(Context context, Theme.ResourcesProvider resourcesProvider, View view) {
        AlertsCreator.createSuggestedMessageDatePickerDialog(context, this.selectedTime, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Stars.MessageSuggestionOfferSheet$$ExternalSyntheticLambda9
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCurrencyChanged$7() {
        Browser.openUrl(getContext(), LocaleController.getString(R.string.StarsSuggestionTermsLink));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onCurrencyChanged$8() {
    ...
    private void onCurrencyChanged(boolean z) {
        ...
        if (amountUtils$Currency == amountUtils$Currency2) {
            ...
            if (linksTextView != null) {
                ...
                runnable = new Runnable() { // from class: org.telegram.ui.Stars.MessageSuggestionOfferSheet$$ExternalSyntheticLambda7
            ...
            if (linksTextView != null) {
                ...
                runnable = new Runnable() { // from class: org.telegram.ui.Stars.MessageSuggestionOfferSheet$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
