...
public class StarsController {
    ...
    public static /* synthetic */ void $r8$lambda$_CaaQE60qTIO-9s-LAkjRqiU8go() {
    }
    ...
    public TL_stars.StarsAmount getBalance(boolean z, final Runnable runnable, boolean z2) {
        if (((!this.balanceLoaded || System.currentTimeMillis() - this.lastBalanceLoaded > 60000) && !this.balanceLoading) || z2) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getStarsStatus, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda28
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.$r8$lambda$jB3uWSbVFhI6C4YE7w1k_ZogJk8(StarsController.this, runnable, tLObject, tL_error);
                }
            });
        }
        if (z && this.minus > 0) {
    ...
    public static /* synthetic */ void $r8$lambda$jB3uWSbVFhI6C4YE7w1k_ZogJk8(final StarsController starsController, final Runnable runnable, final TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda52
            ...
            public final void run() {
                StarsController.$r8$lambda$eg3uiHI8e_tLwG9HJYQ0IHgdm1Q(StarsController.this, tLObject, runnable);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$eg3uiHI8e_tLwG9HJYQ0IHgdm1Q(StarsController starsController, TLObject tLObject, Runnable runnable) {
        boolean z;
        boolean z2;
    ...
    public ArrayList getOptions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_stars.TL_payments_getStarsTopupOptions(), new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda33
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$6JEx8_TrfbXFHKbKcMqJfI7YAVM(StarsController.this, tLObject, tL_error);
            }
        });
        return this.options;
    }

    public static /* synthetic */ void $r8$lambda$6JEx8_TrfbXFHKbKcMqJfI7YAVM(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda61
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$UWon6LcgZn-ftrsCWmL7Ghso3DE(StarsController.this, tLObject);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$UWon6LcgZn-ftrsCWmL7Ghso3DE(final StarsController starsController, TLObject tLObject) {
        starsController.getClass();
        ...
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda63
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$HvmJ62FicKm0RQQVOBWgWPj4zdg(StarsController.this, arrayList2);
            }
        };
    ...
    public static /* synthetic */ void $r8$lambda$HvmJ62FicKm0RQQVOBWgWPj4zdg(final StarsController starsController, final ArrayList arrayList) {
        starsController.getClass();
    ...
    public static /* synthetic */ void $r8$lambda$aQBbLDlxm68EHY-JOylDwiuZWnc(final StarsController starsController, final ArrayList arrayList, final BillingResult billingResult, final List list) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda90
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$5LJK0nJQfKZ1qdJ3Q9pENaAIdQU(StarsController.this, billingResult, list, arrayList);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$5LJK0nJQfKZ1qdJ3Q9pENaAIdQU(StarsController starsController, BillingResult billingResult, List list, ArrayList arrayList) {
    ...
    public ArrayList getGiftOptions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_stars.TL_payments_getStarsGiftOptions(), new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda60
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$XR9EsXeH550JhyzqVdx4zkR-fw8(StarsController.this, tLObject, tL_error);
            }
        });
        return this.giftOptions;
    }

    public static /* synthetic */ void $r8$lambda$XR9EsXeH550JhyzqVdx4zkR-fw8(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda73
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$Z3IUMcJD6ICp3OAQh79f9ZaY7nU(StarsController.this, tLObject);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$Z3IUMcJD6ICp3OAQh79f9ZaY7nU(final StarsController starsController, TLObject tLObject) {
        starsController.getClass();
        ArrayList arrayList = new ArrayList();
        final ArrayList arrayList2 = new ArrayList();
        if (tLObject instanceof Vector) {
        ...
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda84
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$E2pgljsMpDTlGFSzrWlQyTVBVlc(StarsController.this, arrayList2);
            }
        };
        if (!BillingController.getInstance().isReady()) {
            BillingController.getInstance().whenSetuped(runnable);
    ...
    public static /* synthetic */ void $r8$lambda$E2pgljsMpDTlGFSzrWlQyTVBVlc(final StarsController starsController, final ArrayList arrayList) {
        starsController.getClass();
        ArrayList arrayList2 = new ArrayList();
        for (int i = 0; i < arrayList.size(); i++) {
    ...
    public static /* synthetic */ void $r8$lambda$oYKWwxdPXz_VU7-9ULkKrCY2CoY(final StarsController starsController, final ArrayList arrayList, final BillingResult billingResult, final List list) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda127
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$vhRt34eLrCGVvMcX2z3ExcJ1rdE(StarsController.this, billingResult, list, arrayList);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$vhRt34eLrCGVvMcX2z3ExcJ1rdE(StarsController starsController, BillingResult billingResult, List list, ArrayList arrayList) {
    ...
    public ArrayList getGiveawayOptions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_stars.TL_payments_getStarsGiveawayOptions(), new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda62
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$zSf1Ixy5O01ZT_aMdOi-A1Xo-0w(StarsController.this, tLObject, tL_error);
            }
        });
        return this.giveawayOptions;
    }

    public static /* synthetic */ void $r8$lambda$zSf1Ixy5O01ZT_aMdOi-A1Xo-0w(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda88
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$ZOpfiq4HTYapQjLnzatqZWszlsM(StarsController.this, tLObject);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$ZOpfiq4HTYapQjLnzatqZWszlsM(final StarsController starsController, TLObject tLObject) {
        starsController.getClass();
        ArrayList arrayList = new ArrayList();
        final ArrayList arrayList2 = new ArrayList();
        if (tLObject instanceof Vector) {
        ...
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda92
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$Qobo3ysRaIGdmaNh6nsqCdiX_R4(StarsController.this, arrayList2);
            }
        };
        if (!BillingController.getInstance().isReady()) {
            BillingController.getInstance().whenSetuped(runnable);
    ...
    public static /* synthetic */ void $r8$lambda$Qobo3ysRaIGdmaNh6nsqCdiX_R4(final StarsController starsController, final ArrayList arrayList) {
        starsController.getClass();
        ArrayList arrayList2 = new ArrayList();
        for (int i = 0; i < arrayList.size(); i++) {
    ...
    public static /* synthetic */ void $r8$lambda$AN3SoZ-PVLKKLVvX4-h4MoI67qE(final StarsController starsController, final ArrayList arrayList, final BillingResult billingResult, final List list) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda135
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$FCCrCbIFwIK9MP9FxmwCAw9tliw(StarsController.this, billingResult, list, arrayList);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$FCCrCbIFwIK9MP9FxmwCAw9tliw(StarsController starsController, BillingResult billingResult, List list, ArrayList arrayList) {
    ...
    public void loadTransactions(final int i) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getStarsTransactions, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda43
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$rNofGyji6emKcqkdemp_5_zNgOs(StarsController.this, i, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$rNofGyji6emKcqkdemp_5_zNgOs(final StarsController starsController, final int i, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda57
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$0bmoQrHCgPb1sopt2TC7WXuHkEA(StarsController.this, i, tLObject);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$0bmoQrHCgPb1sopt2TC7WXuHkEA(StarsController starsController, int i, TLObject tLObject) {
    ...
    public void loadSubscriptions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_getStarsSubscriptions, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda27
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$DRcRo4H7xRsZHcu9fbSAa2BDsy8(StarsController.this, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$DRcRo4H7xRsZHcu9fbSAa2BDsy8(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda59
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$j2kZ3-TUVuqEfHIbcjteQk233Uk(StarsController.this, tLObject);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$j2kZ3-TUVuqEfHIbcjteQk233Uk(StarsController starsController, TLObject tLObject) {
        starsController.subscriptionsLoading = false;
        if (tLObject instanceof TL_stars.StarsStatus) {
            TL_stars.StarsStatus starsStatus = (TL_stars.StarsStatus) tLObject;
            MessagesController.getInstance(starsController.currentAccount).putUsers(starsStatus.users, false);
    ...
    public void loadInsufficientSubscriptions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_getStarsSubscriptions, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda23
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$MJdSoWK4CTwte4cus4ccMb8rD-8(StarsController.this, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$MJdSoWK4CTwte4cus4ccMb8rD-8(final StarsController starsController, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda48
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$GItNK2oXeWkweaBadMq7oAZDbbc(StarsController.this, tLObject);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$GItNK2oXeWkweaBadMq7oAZDbbc(StarsController starsController, TLObject tLObject) {
    ...
    public void showStarsTopup(final Activity activity, final long j, final String str) {
        if (!balanceAvailable()) {
            getBalance(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda34
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.this.showStarsTopupInternal(activity, j, str);
                }
            });
        } else {
    ...
    public void showStarsTopupInternal(Activity activity, long j, String str) {
        if (getBalance().amount >= j || j <= 0) {
            ...
            BulletinFactory.of(safeLastFragment).createSimpleBulletin(R.raw.stars_topup, LocaleController.getString(R.string.StarsTopupLinkEnough), LocaleController.getString(R.string.StarsTopupLinkTopupAnyway), new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda47
                @Override // java.lang.Runnable
                public final void run() {
        ...
        new StarsIntroActivity.StarsNeededSheet(activity, null, j, 4, str, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda46
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$_CaaQE60qTIO-9s-LAkjRqiU8go();
            }
        }, 0L).show();
    }
    ...
    public void buy(final Activity activity, final TL_stars.TL_starsTopupOption tL_starsTopupOption, final Utilities.Callback2 callback2, TLRPC.InputPeer inputPeer) {
        ...
        if ((BuildVars.useInvoiceBilling() || !BillingController.getInstance().isReady()) && !isInvoiceBillingDisabled) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda71
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.$r8$lambda$URwfflcKYUwRheceH-B4mKvlQYc(StarsController.this, callback2, tL_inputInvoiceStars, tLObject, tL_error);
                }
            });
            return;
        }
        ...
        BillingController.getInstance().queryProductDetails(Arrays.asList(build), new BillingController.ProductDetailsResponseListenerLegacy() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda72
            ...
            public final void onProductDetailsResponse(BillingResult billingResult, List list) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda79
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$DErIybbYfQ854cklBZI8aDA5518(list, r2, r3, r4, r5);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void $r8$lambda$URwfflcKYUwRheceH-B4mKvlQYc(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda78
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$FRim_ui_250cBn8YUlO_9lsnwXQ(StarsController.this, tL_error, callback2, tLObject, tL_inputInvoiceStars);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$FRim_ui_250cBn8YUlO_9lsnwXQ(StarsController starsController, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, TLObject tLObject, TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars) {
        starsController.getClass();
        if (tL_error != null) {
            if (callback2 != null) {
        ...
        paymentFormActivity.setPaymentFormCallback(new PaymentFormActivity.PaymentFormCallback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda110
            @Override // org.telegram.ui.PaymentFormActivity.PaymentFormCallback
            public final void onInvoiceStatusChanged(PaymentFormActivity.InvoiceStatus invoiceStatus) {
                StarsController.$r8$lambda$wJQar96j6YtvG_3jhJiROy7mhts(Utilities.Callback2.this, invoiceStatus);
            }
        });
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
    ...
    public static /* synthetic */ void $r8$lambda$DErIybbYfQ854cklBZI8aDA5518(List list, final Utilities.Callback2 callback2, TLRPC.TL_inputStorePaymentStarsTopup tL_inputStorePaymentStarsTopup, TL_stars.TL_starsTopupOption tL_starsTopupOption, Activity activity) {
        if (list.isEmpty()) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda99
                @Override // java.lang.Runnable
                public final void run() {
                    Utilities.Callback2.this.run(Boolean.FALSE, "PRODUCT_NOT_FOUND");
                }
            });
            return;
        }
        ...
        if (oneTimePurchaseOfferDetails == null) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda100
                @Override // java.lang.Runnable
                public final void run() {
                    Utilities.Callback2.this.run(Boolean.FALSE, "PRODUCT_NO_ONETIME_OFFER_DETAILS");
                }
            });
            return;
        }
        ...
        BillingController.getInstance().addResultListener(productDetails.getProductId(), new Consumer() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda101
            ...
            public final void accept(Object obj) {
                StarsController.$r8$lambda$qQaSoh4tsDlXULA6tHmBOxJ7qqw(Utilities.Callback2.this, (BillingResult) obj);
            }
        });
        BillingController.getInstance().setOnCanceled(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda102
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$N4Q4pfKNiiMlcRy-DII8I9qqz4Y(Utilities.Callback2.this);
            }
        });
    ...
    public static /* synthetic */ void $r8$lambda$qQaSoh4tsDlXULA6tHmBOxJ7qqw(final Utilities.Callback2 callback2, BillingResult billingResult) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda115
            @Override // java.lang.Runnable
            public final void run() {
                Utilities.Callback2.this.run(Boolean.valueOf(z), responseCodeString);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$N4Q4pfKNiiMlcRy-DII8I9qqz4Y(final Utilities.Callback2 callback2) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda120
            @Override // java.lang.Runnable
            public final void run() {
                Utilities.Callback2.this.run(Boolean.FALSE, null);
            }
        });
    }
    ...
    public void buyGift(final Activity activity, final TL_stars.TL_starsGiftOption tL_starsGiftOption, long j, final Utilities.Callback2 callback2) {
        ...
        if (BuildVars.useInvoiceBilling() || !BillingController.getInstance().isReady()) {
            ...
            tL_payments_getPaymentForm.invoice = tL_inputInvoiceStars;
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda106
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.$r8$lambda$eEu9W2xMXiItx0hDmsXYC1aIeN0(StarsController.this, callback2, tL_inputInvoiceStars, tLObject, tL_error);
                }
            });
            return;
        }
    ...
    public static /* synthetic */ void $r8$lambda$eEu9W2xMXiItx0hDmsXYC1aIeN0(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda126
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$1i1nlBO3X5J4gM1KgJFtNOWaWEE(StarsController.this, tL_error, callback2, tLObject, tL_inputInvoiceStars);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$1i1nlBO3X5J4gM1KgJFtNOWaWEE(StarsController starsController, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, TLObject tLObject, TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars) {
        starsController.getClass();
        if (tL_error != null) {
            if (callback2 != null) {
                callback2.run(Boolean.FALSE, tL_error.text);
        ...
        paymentFormActivity.setPaymentFormCallback(new PaymentFormActivity.PaymentFormCallback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda134
            @Override // org.telegram.ui.PaymentFormActivity.PaymentFormCallback
            public final void onInvoiceStatusChanged(PaymentFormActivity.InvoiceStatus invoiceStatus) {
                StarsController.$r8$lambda$aUXHaEjBJoTRLw17pXrAHfsMUDo(Utilities.Callback2.this, invoiceStatus);
            }
        });
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
        if (lastFragment == null) {
    ...
    public static /* synthetic */ void $r8$lambda$rUfOOF0ayxBt89EjAUQcYfCsfIU(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputStorePaymentStarsGift tL_inputStorePaymentStarsGift, final TL_stars.TL_starsGiftOption tL_starsGiftOption, final Activity activity, final BillingResult billingResult, final List list) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda131
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$EuTKw3x_fs3wYPpUoRfB97rlpD8(StarsController.this, list, callback2, tL_inputStorePaymentStarsGift, tL_starsGiftOption, billingResult, activity);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$EuTKw3x_fs3wYPpUoRfB97rlpD8(StarsController starsController, final List list, final Utilities.Callback2 callback2, final TLRPC.TL_inputStorePaymentStarsGift tL_inputStorePaymentStarsGift, TL_stars.TL_starsGiftOption tL_starsGiftOption, final BillingResult billingResult, final Activity activity) {
        starsController.getClass();
        if (list.isEmpty()) {
        ...
        ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_payments_canPurchaseStore, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda138
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda153
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$b7n4Xkga8tF3q667jc3QykwqdNI(TLObject.this, r2, r3, r4, r5, r6, r7, tL_error);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void $r8$lambda$b7n4Xkga8tF3q667jc3QykwqdNI(TLObject tLObject, ProductDetails productDetails, final BillingResult billingResult, final Utilities.Callback2 callback2, Activity activity, TLRPC.TL_inputStorePaymentStarsGift tL_inputStorePaymentStarsGift, List list, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.TL_boolTrue) {
            BillingController.getInstance().addResultListener(productDetails.getProductId(), new Consumer() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda10
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    StarsController.$r8$lambda$nG0zK4QkjDCJo3pETctNU0vmKhI(BillingResult.this, callback2, (BillingResult) obj);
                }
            });
            BillingController.getInstance().setOnCanceled(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
        ...
        if (BuildVars.useInvoiceBilling() || !BillingController.getInstance().isReady() || tL_starsGiveawayOption.store_product == null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda87
                ...
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    StarsController.$r8$lambda$JXQG-lRm1HTbT0yavfgmbYhrmng(StarsController.this, callback2, tL_inputInvoiceStars, tLObject2, tL_error);
                }
            });
            return;
        }
    ...
    public static /* synthetic */ void $r8$lambda$JXQG-lRm1HTbT0yavfgmbYhrmng(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda104
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$jEBDH9KYUsN2YaBlBVAMkOI1ZDo(StarsController.this, tL_error, callback2, tLObject, tL_inputInvoiceStars);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$jEBDH9KYUsN2YaBlBVAMkOI1ZDo(StarsController starsController, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, TLObject tLObject, TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars) {
        starsController.getClass();
        if (tL_error != null) {
            if (callback2 != null) {
                callback2.run(Boolean.FALSE, tL_error.text);
        ...
        paymentFormActivity.setPaymentFormCallback(new PaymentFormActivity.PaymentFormCallback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda121
            @Override // org.telegram.ui.PaymentFormActivity.PaymentFormCallback
            public final void onInvoiceStatusChanged(PaymentFormActivity.InvoiceStatus invoiceStatus) {
                StarsController.$r8$lambda$0CbP5pj7F7P1HDfgSiiePMUv7Lo(Utilities.Callback2.this, invoiceStatus);
            }
        });
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
        if (lastFragment == null) {
    ...
    public static /* synthetic */ void $r8$lambda$z-Mx6ZT729rZf200ZLOgAnJ-Z6E(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputStorePaymentStarsGiveaway tL_inputStorePaymentStarsGiveaway, final Activity activity, final BillingResult billingResult, final List list) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda109
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$QyeXIYYWo68_mwcW4Tp3-NZSXNU(StarsController.this, list, callback2, tL_inputStorePaymentStarsGiveaway, billingResult, activity);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$QyeXIYYWo68_mwcW4Tp3-NZSXNU(StarsController starsController, final List list, final Utilities.Callback2 callback2, final TLRPC.TL_inputStorePaymentStarsGiveaway tL_inputStorePaymentStarsGiveaway, final BillingResult billingResult, final Activity activity) {
        starsController.getClass();
        if (list.isEmpty()) {
        ...
        ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_payments_canPurchaseStore, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda125
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda142
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$qE9Zs7WyGEKPaMBs3-dblGFThSk(TLObject.this, r2, r3, r4, r5, r6, r7, tL_error);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void $r8$lambda$qE9Zs7WyGEKPaMBs3-dblGFThSk(TLObject tLObject, ProductDetails productDetails, final BillingResult billingResult, final Utilities.Callback2 callback2, Activity activity, TLRPC.TL_inputStorePaymentStarsGiveaway tL_inputStorePaymentStarsGiveaway, List list, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.TL_boolTrue) {
            BillingController.getInstance().addResultListener(productDetails.getProductId(), new Consumer() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda151
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    StarsController.$r8$lambda$91WsDiYUJPjolDzHHV177eWySrw(BillingResult.this, callback2, (BillingResult) obj);
                }
            });
            BillingController.getInstance().setOnCanceled(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda152
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public Runnable pay(final MessageObject messageObject, final Runnable runnable) {
        ...
        final int sendRequest = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda65
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$8S9fwiWKQY64lRcnVMPHf2SOWYU(StarsController.this, messageObject, tL_inputInvoiceMessage, runnable, tLObject, tL_error);
            }
        });
        return new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda66
            @Override // java.lang.Runnable
            public final void run() {
                ConnectionsManager.getInstance(StarsController.this.currentAccount).cancelRequest(sendRequest, true);
            }
        };
    }

    public static /* synthetic */ void $r8$lambda$8S9fwiWKQY64lRcnVMPHf2SOWYU(final StarsController starsController, final MessageObject messageObject, final TLRPC.TL_inputInvoiceMessage tL_inputInvoiceMessage, final Runnable runnable, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda77
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$gF8ltFeuI57iYH_Gifz-SnPd6VE(StarsController.this, tLObject, messageObject, tL_inputInvoiceMessage, runnable, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$gF8ltFeuI57iYH_Gifz-SnPd6VE(StarsController starsController, TLObject tLObject, MessageObject messageObject, TLRPC.TL_inputInvoiceMessage tL_inputInvoiceMessage, Runnable runnable, TLRPC.TL_error tL_error) {
        starsController.getClass();
            ...
            if (context2 != null) {
                if (!balanceAvailable()) {
                    getBalance(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda29
                        @Override // java.lang.Runnable
                        public final void run() {
                            StarsController.$r8$lambda$JQtYXydnbvYbfSPPiy7NMNT1UkI(StarsController.this, runnable, messageObject, inputInvoice, tL_payments_paymentFormStars, callback);
                        }
                    });
                    return;
                }
                ...
                final long j3 = j;
                final long j4 = j2;
                StarsIntroActivity.openConfirmPurchaseSheet(context2, resourceProvider, this.currentAccount, messageObject, j3, str2, j4, tL_payments_paymentFormStars.photo, i2, new Utilities.Callback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda30
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        StarsController.$r8$lambda$1EOvTkJw3L653tBUEcQg-rPyEWs(StarsController.this, j4, zArr, callback, context2, resourceProvider, z, str, messageObject, inputInvoice, tL_payments_paymentFormStars, i2, j3, (Utilities.Callback) obj);
                    }
                }, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda31
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$dDVmgm-PFHBhm3NQ591YnR9aR8s(StarsController.this, zArr, callback);
                    }
                });
            }
        }
    ...
    public static /* synthetic */ void $r8$lambda$JQtYXydnbvYbfSPPiy7NMNT1UkI(StarsController starsController, Runnable runnable, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, Utilities.Callback callback) {
    ...
    public static /* synthetic */ void $r8$lambda$1EOvTkJw3L653tBUEcQg-rPyEWs(final StarsController starsController, long j, final boolean[] zArr, final Utilities.Callback callback, Context context, Theme.ResourcesProvider resourcesProvider, boolean z, String str, final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final int i, long j2, final Utilities.Callback callback2) {
        if (starsController.balance.amount < j) {
            ...
            StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, z ? 9 : 0, str, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda49
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.$r8$lambda$FRZeScknA6YrbNU1kriAH6bC2Vk(StarsController.this, zArr2, messageObject, inputInvoice, tL_payments_paymentFormStars, zArr, i, callback, callback2);
                }
            }, j2);
            starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda50
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    StarsController.$r8$lambda$epO9vC2rP7V1A3hOQ8jrQFbUOok(StarsController.this, callback2, zArr2, zArr, callback, dialogInterface);
                }
            });
            starsNeededSheet.show();
            return;
        }
        starsController.payAfterConfirmed(messageObject, inputInvoice, tL_payments_paymentFormStars, new Utilities.Callback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda51
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                StarsController.$r8$lambda$o3rsUqG2k0w1hFkXcP03hws9edI(StarsController.this, i, callback2, zArr, callback, (Boolean) obj);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$FRZeScknA6YrbNU1kriAH6bC2Vk(final StarsController starsController, boolean[] zArr, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final boolean[] zArr2, final int i, final Utilities.Callback callback, final Utilities.Callback callback2) {
        starsController.getClass();
        zArr[0] = true;
        starsController.payAfterConfirmed(messageObject, inputInvoice, tL_payments_paymentFormStars, new Utilities.Callback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda70
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                StarsController.$r8$lambda$zcOFQ6YN5Xq-O0Jcn6o9mWXitk0(StarsController.this, zArr2, i, callback, callback2, (Boolean) obj);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$zcOFQ6YN5Xq-O0Jcn6o9mWXitk0(StarsController starsController, boolean[] zArr, int i, Utilities.Callback callback, Utilities.Callback callback2, Boolean bool) {
        starsController.getClass();
        zArr[0] = true;
        if (i > 0) {
    ...
    public static /* synthetic */ void $r8$lambda$epO9vC2rP7V1A3hOQ8jrQFbUOok(StarsController starsController, Utilities.Callback callback, boolean[] zArr, boolean[] zArr2, Utilities.Callback callback2, DialogInterface dialogInterface) {
        starsController.getClass();
    ...
    public static /* synthetic */ void $r8$lambda$o3rsUqG2k0w1hFkXcP03hws9edI(StarsController starsController, int i, Utilities.Callback callback, boolean[] zArr, Utilities.Callback callback2, Boolean bool) {
        if (i > 0) {
            starsController.invalidateSubscriptions(true);
        } else {
            starsController.getClass();
    ...
    public static /* synthetic */ void $r8$lambda$dDVmgm-PFHBhm3NQ591YnR9aR8s(StarsController starsController, boolean[] zArr, Utilities.Callback callback) {
        starsController.paymentFormOpened = false;
        if (zArr[0] || callback == null) {
            return;
        }
    ...
    public void subscribeTo(final String str, final TLRPC.ChatInvite chatInvite, final Utilities.Callback2 callback2) {
        ...
        final boolean[] zArr = {false};
        StarsIntroActivity.openStarsChannelInviteSheet(context2, resourceProvider, i, chatInvite, new Utilities.Callback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda80
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                StarsController.$r8$lambda$zHrlS10JfmXFgJaYqG_4POoUuEk(StarsController.this, j, i, zArr, callback2, context2, resourceProvider, chatInvite, str, (Utilities.Callback) obj);
            }
        }, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda81
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$fRendxPcUDz5_yMV2wx4wdPgGMQ(StarsController.this, zArr, callback2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$zHrlS10JfmXFgJaYqG_4POoUuEk(final StarsController starsController, long j, int i, final boolean[] zArr, final Utilities.Callback2 callback2, Context context, Theme.ResourcesProvider resourcesProvider, final TLRPC.ChatInvite chatInvite, final String str, final Utilities.Callback callback) {
        if (starsController.balance.amount < j) {
            ...
            StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, 1, chatInvite.title, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda111
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.$r8$lambda$kbAD7BpEa74bhP6cw7ZRffBjcCw(StarsController.this, zArr2, str, chatInvite, zArr, callback2, callback);
                }
            }, 0L);
            starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda112
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    StarsController.$r8$lambda$zZFuAwHulTIC84UqBuyIl9rmHug(StarsController.this, callback, zArr2, zArr, callback2, dialogInterface);
                }
            });
            starsNeededSheet.show();
            return;
        }
        starsController.payAfterConfirmed(str, chatInvite, new Utilities.Callback2() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda113
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                StarsController.$r8$lambda$yV6q7CdJK6WXDtnzZld0gtRFjbE(Utilities.Callback.this, zArr, callback2, (Long) obj, (Boolean) obj2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$kbAD7BpEa74bhP6cw7ZRffBjcCw(StarsController starsController, boolean[] zArr, String str, TLRPC.ChatInvite chatInvite, final boolean[] zArr2, final Utilities.Callback2 callback2, final Utilities.Callback callback) {
        starsController.getClass();
        zArr[0] = true;
        starsController.payAfterConfirmed(str, chatInvite, new Utilities.Callback2() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda128
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                StarsController.$r8$lambda$znJy1AHu4aZaErIcGD--MC8oLPo(zArr2, callback2, callback, (Long) obj, (Boolean) obj2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$znJy1AHu4aZaErIcGD--MC8oLPo(boolean[] zArr, Utilities.Callback2 callback2, Utilities.Callback callback, Long l, Boolean bool) {
        zArr[0] = true;
        if (callback2 != null) {
    ...
    public static /* synthetic */ void $r8$lambda$zZFuAwHulTIC84UqBuyIl9rmHug(StarsController starsController, Utilities.Callback callback, boolean[] zArr, boolean[] zArr2, Utilities.Callback2 callback2, DialogInterface dialogInterface) {
        starsController.getClass();
        if (callback == null || zArr[0]) {
            return;
        }
    ...
    public static /* synthetic */ void $r8$lambda$fRendxPcUDz5_yMV2wx4wdPgGMQ(StarsController starsController, boolean[] zArr, Utilities.Callback2 callback2) {
        starsController.paymentFormOpened = false;
        if (zArr[0] || callback2 == null) {
            return;
        }
    ...
    public void payAfterConfirmed(final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda75
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$MuwfEWSST-OAT5rSjAcAunaYPTQ(StarsController.this, callback, messageObject, context, j2, str2, i2, str3, inputInvoice, j3, resourceProvider, tL_payments_paymentFormStars, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$MuwfEWSST-OAT5rSjAcAunaYPTQ(final StarsController starsController, final Utilities.Callback callback, final MessageObject messageObject, final Context context, final long j, final String str, final int i, final String str2, final TLRPC.InputInvoice inputInvoice, final long j2, final Theme.ResourcesProvider resourcesProvider, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda82
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$N82GEYp3BvEwTa0iV0yywKpdhxo(StarsController.this, tLObject, callback, messageObject, context, j, str, i, str2, inputInvoice, j2, tL_error, resourcesProvider, tL_payments_paymentFormStars);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$N82GEYp3BvEwTa0iV0yywKpdhxo(final StarsController starsController, TLObject tLObject, final Utilities.Callback callback, final MessageObject messageObject, Context context, long j, String str, int i, String str2, final TLRPC.InputInvoice inputInvoice, long j2, TLRPC.TL_error tL_error, Theme.ResourcesProvider resourcesProvider, final TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars) {
        ...
        if (tLObject instanceof TLRPC.TL_payments_paymentResult) {
            ...
            Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda93
                @Override // java.lang.Runnable
                public final void run() {
                    MessagesController.getInstance(StarsController.this.currentAccount).processUpdates(tL_payments_paymentResult.updates, false);
                }
            });
            if (messageObject != null && (message = messageObject.messageOwner) != null && (message.media instanceof TLRPC.TL_messageMediaPaidMedia)) {
                ...
                global.createSimpleBulletin(R.raw.stars_send, LocaleController.getString(R.string.StarsBotSubscriptionCompleted), AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsBotSubscriptionCompletedInfo", (int) j, str2, str))).show();
            } else {
        ...
        if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
            if (!MessagesController.getInstance(starsController.currentAccount).starsPurchaseAvailable()) {
                ...
                StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, 0, str, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda94
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$T6t5kJP4MDEAl-bMFZ889IevwSM(StarsController.this, zArr, messageObject, inputInvoice, tL_payments_paymentFormStars, callback);
                    }
                }, j2);
                starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda95
                    @Override // android.content.DialogInterface.OnDismissListener
                    public final void onDismiss(DialogInterface dialogInterface) {
                        StarsController.$r8$lambda$deJyltirXToTnmOnXJMSLHPFZRA(Utilities.Callback.this, zArr, dialogInterface);
                    }
                });
                starsNeededSheet.show();
                return;
        ...
        ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda96
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                StarsController.$r8$lambda$Jp_pZ0iyoWyrcwBpITHC6YsXiM4(StarsController.this, messageObject, inputInvoice, callback, bulletinFactory, tLObject2, tL_error2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$T6t5kJP4MDEAl-bMFZ889IevwSM(StarsController starsController, boolean[] zArr, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, final Utilities.Callback callback) {
        starsController.getClass();
        zArr[0] = true;
        starsController.payAfterConfirmed(messageObject, inputInvoice, tL_payments_paymentFormStars, new Utilities.Callback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda130
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                StarsController.$r8$lambda$-RZjEMxvYCtyuSt_61udmFKLPfw(Utilities.Callback.this, (Boolean) obj);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$-RZjEMxvYCtyuSt_61udmFKLPfw(Utilities.Callback callback, Boolean bool) {
        if (callback != null) {
            callback.run(bool);
        }
    }
    ...
    public static /* synthetic */ void $r8$lambda$Jp_pZ0iyoWyrcwBpITHC6YsXiM4(final StarsController starsController, final MessageObject messageObject, final TLRPC.InputInvoice inputInvoice, final Utilities.Callback callback, final BulletinFactory bulletinFactory, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda114
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$Vs_ywekFO1Ckzhs1kuEDghnu2GI(StarsController.this, tLObject, messageObject, inputInvoice, callback, bulletinFactory, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$Vs_ywekFO1Ckzhs1kuEDghnu2GI(StarsController starsController, TLObject tLObject, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, Utilities.Callback callback, BulletinFactory bulletinFactory, TLRPC.TL_error tL_error) {
        starsController.getClass();
        if (tLObject instanceof TLRPC.TL_payments_paymentFormStars) {
    ...
    private void payAfterConfirmed(final String str, final TLRPC.ChatInvite chatInvite, final Utilities.Callback2 callback2) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda118
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$BbneXcS265i5fG2WwiwTs5BnoVA(StarsController.this, callback2, j, str2, context, resourceProvider, chatInvite, str, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$BbneXcS265i5fG2WwiwTs5BnoVA(final StarsController starsController, final Utilities.Callback2 callback2, final long j, final String str, final Context context, final Theme.ResourcesProvider resourcesProvider, final TLRPC.ChatInvite chatInvite, final String str2, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda139
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$jrXc0sNvoUY9F9rtaL-pzfu-CEo(StarsController.this, tLObject, callback2, j, str, tL_error, context, resourcesProvider, chatInvite, str2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$jrXc0sNvoUY9F9rtaL-pzfu-CEo(final StarsController starsController, TLObject tLObject, final Utilities.Callback2 callback2, long j, String str, TLRPC.TL_error tL_error, Context context, Theme.ResourcesProvider resourcesProvider, final TLRPC.ChatInvite chatInvite, final String str2) {
        starsController.paymentFormOpened = false;
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
        BulletinFactory of = !AndroidUtilities.hasDialogOnTop(lastFragment) ? BulletinFactory.of(lastFragment) : BulletinFactory.global();
        if (tLObject instanceof TLRPC.TL_payments_paymentResult) {
            final TLRPC.TL_payments_paymentResult tL_payments_paymentResult = (TLRPC.TL_payments_paymentResult) tLObject;
            Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda146
                @Override // java.lang.Runnable
                public final void run() {
                    MessagesController.getInstance(StarsController.this.currentAccount).processUpdates(tL_payments_paymentResult.updates, false);
                }
        ...
        if (tL_error == null || !"BALANCE_TOO_LOW".equals(tL_error.text)) {
            ...
            final boolean[] zArr = {false};
            StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, 1, chatInvite.title, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda147
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.$r8$lambda$J8fuZu3TkOxx51WJIp3a5Afzpw0(StarsController.this, zArr, str2, chatInvite, callback2);
                }
            }, 0L);
            starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda148
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    StarsController.$r8$lambda$6oxdMonxiNsfmY_HYNH-PjtUF7I(Utilities.Callback2.this, zArr, dialogInterface);
                }
            });
            starsNeededSheet.show();
        }
    ...
    public static /* synthetic */ void $r8$lambda$J8fuZu3TkOxx51WJIp3a5Afzpw0(StarsController starsController, boolean[] zArr, String str, TLRPC.ChatInvite chatInvite, final Utilities.Callback2 callback2) {
        starsController.getClass();
        zArr[0] = true;
        starsController.payAfterConfirmed(str, chatInvite, new Utilities.Callback2() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda3
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                StarsController.$r8$lambda$wNJonyjdy-9Z4FZ9RC6-80nAQhM(Utilities.Callback2.this, (Long) obj, (Boolean) obj2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$wNJonyjdy-9Z4FZ9RC6-80nAQhM(Utilities.Callback2 callback2, Long l, Boolean bool) {
        if (callback2 != null) {
            callback2.run(l, bool);
        }
    }

    public static /* synthetic */ void $r8$lambda$6oxdMonxiNsfmY_HYNH-PjtUF7I(Utilities.Callback2 callback2, boolean[] zArr, DialogInterface dialogInterface) {
    ...
    private void updateMediaPrice(final MessageObject messageObject, final long j, final Runnable runnable, final boolean z) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editMessage, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda69
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$w5Ky-g7LhyEWFTO-58ygUdFZPKY(StarsController.this, runnable, z, dialogId, id, messageObject, j, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$w5Ky-g7LhyEWFTO-58ygUdFZPKY(final StarsController starsController, final Runnable runnable, final boolean z, final long j, final int i, final MessageObject messageObject, final long j2, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda89
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$zZquM3yVVoCgyvKEhybrB3BleR0(StarsController.this, tLObject, runnable, tL_error, z, j, i, messageObject, j2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$zZquM3yVVoCgyvKEhybrB3BleR0(final StarsController starsController, final TLObject tLObject, final Runnable runnable, TLRPC.TL_error tL_error, boolean z, long j, int i, final MessageObject messageObject, final long j2) {
        starsController.getClass();
        if (tLObject instanceof TLRPC.Updates) {
            Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda97
                @Override // java.lang.Runnable
                public final void run() {
                    MessagesController.getInstance(StarsController.this.currentAccount).processUpdates((TLRPC.Updates) tLObject, false);
                }
            });
            runnable.run();
        } else {
            if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && !z) {
                ...
                ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_messages_getScheduledMessages, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda98
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                        StarsController.$r8$lambda$s-7R69qiUn6Ln9T19z4-bwvx0HY(StarsController.this, messageObject, j2, runnable, tLObject2, tL_error2);
                    }
                });
                return;
            }
    ...
    public static /* synthetic */ void $r8$lambda$s-7R69qiUn6Ln9T19z4-bwvx0HY(final StarsController starsController, final MessageObject messageObject, final long j, final Runnable runnable, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda119
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$QUXqqFn5RfiPGM1aldJNCXrri_w(StarsController.this, tLObject, messageObject, j, runnable);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$QUXqqFn5RfiPGM1aldJNCXrri_w(StarsController starsController, TLObject tLObject, MessageObject messageObject, long j, Runnable runnable) {
        starsController.getClass();
        ...
        public void commit() {
            ...
            if (starsController.balanceAvailable() && starsController.getBalance(false) < j) {
                ...
                new StarsIntroActivity.StarsNeededSheet(context, this.chatActivity.getResourceProvider(), j, 5, str2, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$PendingPaidReactions$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.this.sendPaidReaction(r0.messageObject, r0.chatActivity, j, true, true, StarsController.PendingPaidReactions.this.peer);
                    }
                }, 0L).show();
                return;
            }
            ...
            connectionsManager.sendRequest(tL_messages_sendPaidReaction, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$PendingPaidReactions$$ExternalSyntheticLambda3
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.PendingPaidReactions.$r8$lambda$Kkskxseamhr0bj594yocnYsr9Lw(StarsController.PendingPaidReactions.this, messagesController, j, tLObject, tL_error);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$Kkskxseamhr0bj594yocnYsr9Lw(final PendingPaidReactions pendingPaidReactions, final MessagesController messagesController, final long j, final TLObject tLObject, final TLRPC.TL_error tL_error) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$PendingPaidReactions$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.PendingPaidReactions.$r8$lambda$kgS4hCJGCf5srCZESTQuQaVxgpA(StarsController.PendingPaidReactions.this, tLObject, messagesController, tL_error, j);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$kgS4hCJGCf5srCZESTQuQaVxgpA(final PendingPaidReactions pendingPaidReactions, final TLObject tLObject, final MessagesController messagesController, TLRPC.TL_error tL_error, final long j) {
            String str;
            pendingPaidReactions.getClass();
            if (tLObject != null) {
            ...
            if (tL_error != null) {
                ...
                if ("BALANCE_TOO_LOW".equals(tL_error.text)) {
                    if (pendingPaidReactions.message.did >= 0) {
                        str = UserObject.getForcedFirstName(pendingPaidReactions.chatActivity.getMessagesController().getUser(Long.valueOf(pendingPaidReactions.message.did)));
                    } else {
                    ...
                    new StarsIntroActivity.StarsNeededSheet(context, pendingPaidReactions.chatActivity.getResourceProvider(), j, 5, str2, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$PendingPaidReactions$$ExternalSyntheticLambda6
                        @Override // java.lang.Runnable
                        public final void run() {
                            StarsController.this.sendPaidReaction(r0.messageObject, r0.chatActivity, j, true, true, StarsController.PendingPaidReactions.this.peer);
                        }
    ...
    public PendingPaidReactions sendPaidReaction(final MessageObject messageObject, final ChatActivity chatActivity, final long j, boolean z, boolean z2, final Long l) {
        ...
        if (z2 && starsController2.balanceAvailable() && starsController2.getBalance(false) <= 0) {
            ...
            new StarsIntroActivity.StarsNeededSheet(context, chatActivity.getResourceProvider(), j, 5, str, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda41
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.this.sendPaidReaction(messageObject, chatActivity, j, true, true, l);
                }
            }, 0L).show();
            return null;
        }
        ...
        if (pendingPaidReactions == null || !pendingPaidReactions.message.equals(from)) {
            ...
            j3 = j;
            PendingPaidReactions pendingPaidReactions3 = starsController.new PendingPaidReactions(from, messageObject, chatActivity, ConnectionsManager.getInstance(this.currentAccount).getCurrentTime(), z);
        ...
        if (starsController.currentPendingReactions.amount + j3 > MessagesController.getInstance(starsController.currentAccount).starsPaidReactionAmountMax) {
            ...
            starsController.currentPendingReactions = starsController.new PendingPaidReactions(from, messageObject, chatActivity, ConnectionsManager.getInstance(starsController.currentAccount).getCurrentTime(), z);
        }
        ...
        if (z2 && starsController2.balanceAvailable() && starsController2.getBalance(false) < j4) {
            ...
            new StarsIntroActivity.StarsNeededSheet(context, chatActivity.getResourceProvider(), j4, 5, str, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda42
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.this.sendPaidReaction(messageObject, chatActivity, j4, true, true, l);
                }
            }, 0L).show();
            return null;
        }
    ...
    public void loadStarGifts() {
        ...
        if (!this.giftsLoaded || System.currentTimeMillis() - this.giftsRemoteTime >= 60000) {
            ...
            if (!this.giftsCacheLoaded) {
                getStarGiftsCached(new Utilities.Callback5() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda0
                    @Override // org.telegram.messenger.Utilities.Callback5
                    public final void run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                        StarsController.$r8$lambda$yDo8SPv83PDjdDT8jSf4OT6lyDs(StarsController.this, (ArrayList) obj, (Integer) obj2, (Long) obj3, (ArrayList) obj4, (ArrayList) obj5);
                    }
                });
            } else {
                getStarGiftsRemote(this.giftsHash, new Utilities.Callback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda1
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        StarsController.$r8$lambda$kiFbuDeLtfLxTFNKSyshr7haojU(StarsController.this, (TL_stars.StarGifts) obj);
                    }
                });
            }
        }
    ...
    public static /* synthetic */ void $r8$lambda$yDo8SPv83PDjdDT8jSf4OT6lyDs(StarsController starsController, ArrayList arrayList, Integer num, Long l, ArrayList arrayList2, ArrayList arrayList3) {
        ...
        Collections.sort(starsController.birthdaySortedGifts, Comparator$-EL.thenComparingInt(Comparator$-CC.comparingInt(new ToIntFunction() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda24
            @Override // java.util.function.ToIntFunction
            public final int applyAsInt(Object obj) {
                return StarsController.$r8$lambda$Us9pnX4ICTEIGHoYchoexwVRQpM((TL_stars.StarGift) obj);
            }
        }), new ToIntFunction() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda25
            @Override // java.util.function.ToIntFunction
            public final int applyAsInt(Object obj) {
                return StarsController.$r8$lambda$LJA61Htjvl--sb7cft-FmMy3Rd8((TL_stars.StarGift) obj);
            }
        }));
        starsController.sortedGifts.clear();
        starsController.sortedGifts.addAll(starsController.gifts);
        Collections.sort(starsController.sortedGifts, Comparator$-CC.comparingInt(new ToIntFunction() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda26
            @Override // java.util.function.ToIntFunction
            public final int applyAsInt(Object obj) {
    ...
    public static /* synthetic */ int $r8$lambda$LJA61Htjvl--sb7cft-FmMy3Rd8(TL_stars.StarGift starGift) {
    ...
    public static /* synthetic */ void $r8$lambda$kiFbuDeLtfLxTFNKSyshr7haojU(StarsController starsController, TL_stars.StarGifts starGifts) {
        starsController.giftsLoading = false;
        ...
        if (starGifts instanceof TL_stars.TL_starGifts) {
            ...
            starsController.birthdaySortedGifts.clear();
            starsController.birthdaySortedGifts.addAll(starsController.gifts);
            Collections.sort(starsController.birthdaySortedGifts, Comparator$-EL.thenComparingInt(Comparator$-CC.comparingInt(new ToIntFunction() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda37
                @Override // java.util.function.ToIntFunction
                public final int applyAsInt(Object obj) {
            ...
            starsController.sortedGifts.clear();
            starsController.sortedGifts.addAll(starsController.gifts);
            Collections.sort(starsController.sortedGifts, Comparator$-CC.comparingInt(new ToIntFunction() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda39
                @Override // java.util.function.ToIntFunction
                public final int applyAsInt(Object obj) {
        ...
        if (starGifts instanceof TL_stars.TL_starGiftsNotModified) {
            ...
            starsController.giftsRemoteTime = currentTimeMillis;
            starsController.saveStarGiftsCached(arrayList, i, currentTimeMillis);
        }
    }
    ...
    private void getStarGiftsCached(final Utilities.Callback5 callback5) {
        ...
        messagesStorage.getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda40
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$ZHYZOMS4eAs0Ttd0VV1OF6XD8Cw(MessagesStorage.this, arrayList3, arrayList2, arrayList, callback5);
            }
        });
    }
    ...
    */
        ...
        try {
            try {
                    ...
                    try {
                        try {
                            ...
                            if (byteBufferValue != null) {
                                ...
                                i2 = (int) sQLiteCursor.longValue(1);
                            ...
                            if (sQLiteCursor == null) {
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda53
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        Utilities.Callback5.this.run(arrayList, Integer.valueOf(i), Long.valueOf(j), arrayList7, arrayList6);
                                    }
                                });
                            }
                            j = j3;
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda53
                                @Override // java.lang.Runnable
                                public final void run() {
                                    Utilities.Callback5.this.run(arrayList, Integer.valueOf(i), Long.valueOf(j), arrayList72, arrayList62);
                                }
                            });
                        }
                    } catch (Exception e2) {
                ...
                if (arrayList9.isEmpty()) {
                    ...
                    try {
                        join = TextUtils.join(",", arrayList9);
                        arrayList4 = arrayList2;
                    } catch (Exception e3) {
                        e = e3;
                        arrayList4 = arrayList2;
                    ...
                    try {
                        messagesStorage.getChatsInternal(join, arrayList4);
                    } catch (Exception e4) {
                        e = e4;
                        exc = e;
                        arrayList5 = arrayList3;
                ...
                try {
                    if (arrayList8.isEmpty()) {
                        ...
                        arrayList5 = arrayList3;
                        try {
                            messagesStorage.getUsersInternal(arrayList8, (ArrayList<TLRPC.User>) arrayList5);
                        } catch (Exception e5) {
                            e = e5;
                            exc = e;
                            i3 = i2;
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda53
                @Override // java.lang.Runnable
                public final void run() {
                    Utilities.Callback5.this.run(arrayList, Integer.valueOf(i), Long.valueOf(j), arrayList722, arrayList622);
                }
            });
        } finally {
        }
    ...
    private void saveStarGiftsCached(final ArrayList arrayList, final int i, final long j) {
        final MessagesStorage messagesStorage = MessagesStorage.getInstance(this.currentAccount);
        messagesStorage.getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda56
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$BsMauLOcbyhrhsDCcNl4lgwEei0(MessagesStorage.this, arrayList, i, j);
            }
        });
    }
    ...
    private void getStarGiftsRemote(int i, final Utilities.Callback callback) {
        ...
        getstargifts.hash = i;
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(getstargifts, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda32
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda55
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$EOwRo-6RAibLoJMYmUqnoGU6u10(TLObject.this, r2);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void $r8$lambda$EOwRo-6RAibLoJMYmUqnoGU6u10(TLObject tLObject, Utilities.Callback callback) {
    ...
    public Runnable getStarGift(final long j, final Utilities.Callback callback) {
        ...
        notificationCenterDelegateArr[0] = new NotificationCenter.NotificationCenterDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda67
            @Override // org.telegram.messenger.NotificationCenter.NotificationCenterDelegate
            public final void didReceivedNotification(int i, int i2, Object[] objArr) {
                StarsController.$r8$lambda$9g2PRtNLFoFx8i07jM4c9fOJ04c(StarsController.this, zArr, j, notificationCenterDelegateArr, callback, i, i2, objArr);
            }
        };
        ...
        return new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda68
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$v4TRXFP4gJcTOzhWTOPLUVS1nhk(StarsController.this, zArr, notificationCenterDelegateArr);
            }
        };
    }

    public static /* synthetic */ void $r8$lambda$9g2PRtNLFoFx8i07jM4c9fOJ04c(StarsController starsController, boolean[] zArr, long j, NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr, Utilities.Callback callback, int i, int i2, Object[] objArr) {
        int i3;
    ...
    public static /* synthetic */ void $r8$lambda$v4TRXFP4gJcTOzhWTOPLUVS1nhk(StarsController starsController, boolean[] zArr, NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr) {
        starsController.getClass();
        zArr[0] = true;
    ...
    public void buyPremiumGift(final long j, final Object obj, final TLRPC.TL_textWithEntities tL_textWithEntities, final Utilities.Callback2 callback2) {
        ...
        if ((z || (obj instanceof TLRPC.TL_premiumGiftCodeOption)) && context2 != null) {
            if (!balanceAvailable()) {
                getBalance(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda132
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$uoBewVkLtm0TZ5i1ukNhA4c3qik(StarsController.this, callback2, j, obj, tL_textWithEntities);
                    }
                });
                return;
            }
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda133
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.$r8$lambda$ORTyUYwwiux6gPqSiF14ITk8l0U(StarsController.this, callback2, tL_inputInvoicePremiumGiftStars, context2, resourceProvider, name, j, obj, tL_textWithEntities, tLObject, tL_error);
                }
            });
        }
    }

    public static /* synthetic */ void $r8$lambda$uoBewVkLtm0TZ5i1ukNhA4c3qik(StarsController starsController, Utilities.Callback2 callback2, long j, Object obj, TLRPC.TL_textWithEntities tL_textWithEntities) {
        if (!starsController.balanceAvailable()) {
            starsController.bulletinError("NO_BALANCE");
            if (callback2 != null) {
                callback2.run(Boolean.FALSE, null);
    ...
    public static /* synthetic */ void $r8$lambda$ORTyUYwwiux6gPqSiF14ITk8l0U(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputInvoicePremiumGiftStars tL_inputInvoicePremiumGiftStars, final Context context, final Theme.ResourcesProvider resourcesProvider, final String str, final long j, final Object obj, final TLRPC.TL_textWithEntities tL_textWithEntities, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda140
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$7FYlwkzBQ6cxAtQ8PJltXft8vzs(StarsController.this, tLObject, tL_error, callback2, tL_inputInvoicePremiumGiftStars, context, resourcesProvider, str, j, obj, tL_textWithEntities);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$7FYlwkzBQ6cxAtQ8PJltXft8vzs(final StarsController starsController, TLObject tLObject, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, TLRPC.TL_inputInvoicePremiumGiftStars tL_inputInvoicePremiumGiftStars, final Context context, final Theme.ResourcesProvider resourcesProvider, final String str, final long j, final Object obj, final TLRPC.TL_textWithEntities tL_textWithEntities) {
        starsController.getClass();
        if (!(tLObject instanceof TLRPC.TL_payments_paymentFormStars)) {
            starsController.bulletinError(tL_error, "NO_PAYMENT_FORM");
            callback2.run(Boolean.FALSE, null);
        ...
        ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda149
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                StarsController.$r8$lambda$SgzQxyLplUyP3m1plPBcfwQZe6o(StarsController.this, callback2, context, resourcesProvider, j2, str, j, obj, tL_textWithEntities, tLObject2, tL_error2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$SgzQxyLplUyP3m1plPBcfwQZe6o(final StarsController starsController, final Utilities.Callback2 callback2, final Context context, final Theme.ResourcesProvider resourcesProvider, final long j, final String str, final long j2, final Object obj, final TLRPC.TL_textWithEntities tL_textWithEntities, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$h9YnBLbWJreqUu_hoKaVDjDWfOo(StarsController.this, tLObject, tL_error, callback2, context, resourcesProvider, j, str, j2, obj, tL_textWithEntities);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$h9YnBLbWJreqUu_hoKaVDjDWfOo(final StarsController starsController, TLObject tLObject, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, Context context, Theme.ResourcesProvider resourcesProvider, long j, String str, final long j2, final Object obj, final TLRPC.TL_textWithEntities tL_textWithEntities) {
        starsController.getClass();
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
        BulletinFactory global = (lastFragment == null || lastFragment.visibleDialog != null) ? BulletinFactory.global() : BulletinFactory.of(lastFragment);
        if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
            if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                if (!MessagesController.getInstance(starsController.currentAccount).starsPurchaseAvailable()) {
                    ...
                    final boolean[] zArr = {false};
                    StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, 6, str, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda19
                        @Override // java.lang.Runnable
                        public final void run() {
                            StarsController.$r8$lambda$PTFsip6v49tfC3_Z0SWdmaRCQyc(StarsController.this, zArr, j2, obj, tL_textWithEntities, callback2);
                        }
                    }, 0L);
                    starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda20
                        @Override // android.content.DialogInterface.OnDismissListener
                        public final void onDismiss(DialogInterface dialogInterface) {
                            StarsController.$r8$lambda$siQ4nEhnubXG2m33E6fPnGuzL5s(Utilities.Callback2.this, zArr, dialogInterface);
                        }
                    });
                    starsNeededSheet.show();
                    return;
        ...
        final TLRPC.TL_payments_paymentResult tL_payments_paymentResult = (TLRPC.TL_payments_paymentResult) tLObject;
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
                MessagesController.getInstance(StarsController.this.currentAccount).processUpdates(tL_payments_paymentResult.updates, false);
            }
    ...
    public static /* synthetic */ void $r8$lambda$PTFsip6v49tfC3_Z0SWdmaRCQyc(StarsController starsController, boolean[] zArr, long j, Object obj, TLRPC.TL_textWithEntities tL_textWithEntities, Utilities.Callback2 callback2) {
        starsController.getClass();
        zArr[0] = true;
        starsController.buyPremiumGift(j, obj, tL_textWithEntities, callback2);
    }
    ...
    public void buyStarGift(final TL_stars.StarGift starGift, final boolean z, final boolean z2, final long j, final TLRPC.TL_textWithEntities tL_textWithEntities, final Utilities.Callback2 callback2) {
        ...
        if (!balanceAvailable()) {
            getBalance(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda116
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.$r8$lambda$JzUJAo6YXgqIt22IsdThn_DQ6lU(StarsController.this, callback2, starGift, z, z2, j, tL_textWithEntities);
                }
            });
            return;
        }
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda117
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$lpDexVxIhqG0MCvTdMrK8ad0mrY(StarsController.this, callback2, tL_inputInvoiceStarGift, context2, resourceProvider, name, starGift, z, z2, j, tL_textWithEntities, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$JzUJAo6YXgqIt22IsdThn_DQ6lU(StarsController starsController, Utilities.Callback2 callback2, TL_stars.StarGift starGift, boolean z, boolean z2, long j, TLRPC.TL_textWithEntities tL_textWithEntities) {
        if (!starsController.balanceAvailable()) {
            starsController.bulletinError("NO_BALANCE");
            if (callback2 != null) {
                callback2.run(Boolean.FALSE, null);
    ...
    public static /* synthetic */ void $r8$lambda$lpDexVxIhqG0MCvTdMrK8ad0mrY(final StarsController starsController, final Utilities.Callback2 callback2, final TLRPC.TL_inputInvoiceStarGift tL_inputInvoiceStarGift, final Context context, final Theme.ResourcesProvider resourcesProvider, final String str, final TL_stars.StarGift starGift, final boolean z, final boolean z2, final long j, final TLRPC.TL_textWithEntities tL_textWithEntities, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda141
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$L1Im6MTpBfr9oKzasG9SqKi0FlI(StarsController.this, tLObject, tL_error, callback2, tL_inputInvoiceStarGift, context, resourcesProvider, str, starGift, z, z2, j, tL_textWithEntities);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$L1Im6MTpBfr9oKzasG9SqKi0FlI(final StarsController starsController, TLObject tLObject, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, TLRPC.TL_inputInvoiceStarGift tL_inputInvoiceStarGift, final Context context, final Theme.ResourcesProvider resourcesProvider, final String str, final TL_stars.StarGift starGift, final boolean z, final boolean z2, final long j, final TLRPC.TL_textWithEntities tL_textWithEntities) {
        starsController.getClass();
        ...
        ConnectionsManager.getInstance(starsController.currentAccount).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda150
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                StarsController.$r8$lambda$CNQ41l37SdswbgSGQ-7busCmyUU(StarsController.this, callback2, context, resourcesProvider, j2, str, starGift, z, z2, j, tL_textWithEntities, tLObject2, tL_error2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$CNQ41l37SdswbgSGQ-7busCmyUU(final StarsController starsController, final Utilities.Callback2 callback2, final Context context, final Theme.ResourcesProvider resourcesProvider, final long j, final String str, final TL_stars.StarGift starGift, final boolean z, final boolean z2, final long j2, final TLRPC.TL_textWithEntities tL_textWithEntities, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$QPuFJ6ifrK_25Bjgcttx4BfPUjo(StarsController.this, tLObject, tL_error, callback2, context, resourcesProvider, j, str, starGift, z, z2, j2, tL_textWithEntities);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$QPuFJ6ifrK_25Bjgcttx4BfPUjo(final StarsController starsController, TLObject tLObject, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, Context context, Theme.ResourcesProvider resourcesProvider, final long j, final String str, final TL_stars.StarGift starGift, final boolean z, final boolean z2, final long j2, final TLRPC.TL_textWithEntities tL_textWithEntities) {
        starsController.getClass();
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
        BulletinFactory global = (lastFragment == null || lastFragment.visibleDialog != null) ? BulletinFactory.global() : BulletinFactory.of(lastFragment);
        ...
        if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
            if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                if (!MessagesController.getInstance(starsController.currentAccount).starsPurchaseAvailable()) {
                    ...
                    final boolean[] zArr = {false};
                    StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, 6, str, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda14
                        @Override // java.lang.Runnable
                        public final void run() {
                            StarsController.$r8$lambda$PQN-sam9xP1WQU53sMyKAJHppp0(StarsController.this, zArr, starGift, z, z2, j2, tL_textWithEntities, callback2);
                        }
                    }, 0L);
                    starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda15
                        @Override // android.content.DialogInterface.OnDismissListener
                        public final void onDismiss(DialogInterface dialogInterface) {
                            StarsController.$r8$lambda$nadFl9CkQFfHIYek7Zj3-B51CGo(Utilities.Callback2.this, zArr, dialogInterface);
                        }
                    });
                    starsNeededSheet.show();
                    return;
        ...
        final TLRPC.TL_payments_paymentResult tL_payments_paymentResult = (TLRPC.TL_payments_paymentResult) tLObject;
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
                MessagesController.getInstance(StarsController.this.currentAccount).processUpdates(tL_payments_paymentResult.updates, false);
            }
        ...
        if (j2 < 0) {
            ...
            profileActivity2.whenFullyVisible(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda17
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.$r8$lambda$fWK7pRtgbDU4eEQo4WaFH2Dh_Hc(ProfileActivity.this, starGift, spannableStringBuilder2, j, str);
                }
            });
            ...
            notificationCenter.postNotificationName(i2, valueOf, bool);
            ...
            of3.whenFullyVisible(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda18
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.$r8$lambda$LJYDPBim4bmVx1r6VTziltdUj4w(ChatActivity.this, starGift, spannableStringBuilder3, j);
                }
            });
            lastFragment.presentFragment(of3);
        }
        MessagesController.getInstance(starsController.currentAccount).getMainSettings().edit().putBoolean("show_gift_for_" + j2, true).putBoolean(Calendar.getInstance().get(1) + "show_gift_for_" + j2, true).apply();
        LaunchActivity launchActivity = LaunchActivity.instance;
        if (launchActivity == null || launchActivity.getFireworksOverlay() == null) {
    ...
    public static /* synthetic */ void $r8$lambda$PQN-sam9xP1WQU53sMyKAJHppp0(StarsController starsController, boolean[] zArr, TL_stars.StarGift starGift, boolean z, boolean z2, long j, TLRPC.TL_textWithEntities tL_textWithEntities, Utilities.Callback2 callback2) {
        starsController.getClass();
        zArr[0] = true;
        starsController.buyStarGift(starGift, z, z2, j, tL_textWithEntities, callback2);
    }

    public static /* synthetic */ void $r8$lambda$nadFl9CkQFfHIYek7Zj3-B51CGo(Utilities.Callback2 callback2, boolean[] zArr, DialogInterface dialogInterface) {
        if (callback2 == null || zArr[0]) {
            return;
        }
        callback2.run(Boolean.FALSE, null);
    ...
    public static /* synthetic */ void $r8$lambda$fWK7pRtgbDU4eEQo4WaFH2Dh_Hc(final ProfileActivity profileActivity, TL_stars.StarGift starGift, CharSequence charSequence, long j, String str) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$z2Cz6VDLPoS8iBsgp4ssRzpFdH4(ProfileActivity.this);
            }
        }, 200L);
    ...
    public void getResellingGiftForm(final TL_stars.StarGift starGift, final long j, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z, final Utilities.Callback callback) {
        ...
        if (!balanceAvailable()) {
            getBalance(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda107
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.$r8$lambda$FrIE6lBmfM1k7us_BodGqm1lTLQ(StarsController.this, callback, starGift, j);
                }
            });
            return;
        }
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda108
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$6jX9-Dab3_DzikP78lhmkp-Rwv8(StarsController.this, callback, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$FrIE6lBmfM1k7us_BodGqm1lTLQ(StarsController starsController, Utilities.Callback callback, TL_stars.StarGift starGift, long j) {
        if (!starsController.balanceAvailable()) {
            starsController.bulletinError("NO_BALANCE");
            if (callback != null) {
                callback.run(null);
    ...
    public static /* synthetic */ void $r8$lambda$6jX9-Dab3_DzikP78lhmkp-Rwv8(final StarsController starsController, final Utilities.Callback callback, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda129
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$JOmo2jJGWZwvx-npyxfGlcSKZAs(StarsController.this, tLObject, tL_error, callback);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$JOmo2jJGWZwvx-npyxfGlcSKZAs(StarsController starsController, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback callback) {
        starsController.getClass();
        if (!(tLObject instanceof TLRPC.TL_payments_paymentFormStarGift)) {
            starsController.bulletinError(tL_error, "NO_PAYMENT_FORM");
            callback.run(null);
    ...
    public void buyResellingGift(final TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, final TL_stars.StarGift starGift, final long j, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z, final Utilities.Callback2 callback2) {
        ...
        if (!balanceAvailable()) {
            getBalance(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda143
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.$r8$lambda$GGFoqgCTDi67QW1O8m9QU0_l6Ps(StarsController.this, callback2, tL_payments_paymentFormStarGift, starGift, j);
                }
            });
            return;
        }
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_sendStarsForm, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda144
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$ITW2Iik_5IqionYfy7LcMZuGRcw(StarsController.this, callback2, context2, resourceProvider, j2, name, tL_payments_paymentFormStarGift, starGift, j, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$GGFoqgCTDi67QW1O8m9QU0_l6Ps(StarsController starsController, Utilities.Callback2 callback2, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j) {
        if (!starsController.balanceAvailable()) {
            starsController.bulletinError("NO_BALANCE");
            if (callback2 != null) {
                callback2.run(Boolean.FALSE, null);
    ...
    public static /* synthetic */ void $r8$lambda$ITW2Iik_5IqionYfy7LcMZuGRcw(final StarsController starsController, final Utilities.Callback2 callback2, final Context context, final Theme.ResourcesProvider resourcesProvider, final long j, final String str, final TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, final TL_stars.StarGift starGift, final long j2, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda145
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$fXJcu2qs2wlpY-9WM2rbVqxxwlQ(StarsController.this, tLObject, tL_error, callback2, context, resourcesProvider, j, str, tL_payments_paymentFormStarGift, starGift, j2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$fXJcu2qs2wlpY-9WM2rbVqxxwlQ(final StarsController starsController, TLObject tLObject, TLRPC.TL_error tL_error, final Utilities.Callback2 callback2, Context context, Theme.ResourcesProvider resourcesProvider, long j, String str, final TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, final TL_stars.StarGift starGift, final long j2) {
        starsController.getClass();
        BaseFragment lastFragment = LaunchActivity.getLastFragment();
        BulletinFactory global = (lastFragment == null || lastFragment.visibleDialog != null) ? BulletinFactory.global() : BulletinFactory.of(lastFragment);
        if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
            if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                if (!MessagesController.getInstance(starsController.currentAccount).starsPurchaseAvailable()) {
                    ...
                    final boolean[] zArr = {false};
                    StarsIntroActivity.StarsNeededSheet starsNeededSheet = new StarsIntroActivity.StarsNeededSheet(context, resourcesProvider, j, 6, str, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            StarsController.$r8$lambda$TgT3MynLYPKE6ZVb0tkBZKyVo_E(StarsController.this, zArr, tL_payments_paymentFormStarGift, starGift, j2, callback2);
                        }
                    }, 0L);
                    starsNeededSheet.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda5
                        @Override // android.content.DialogInterface.OnDismissListener
                        public final void onDismiss(DialogInterface dialogInterface) {
                            StarsController.$r8$lambda$NmzP04uKlI6aUI9IW1aocwMcmCo(Utilities.Callback2.this, zArr, dialogInterface);
                        }
                    });
                    starsNeededSheet.show();
                    return;
        ...
        final TLRPC.TL_payments_paymentResult tL_payments_paymentResult = (TLRPC.TL_payments_paymentResult) tLObject;
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                MessagesController.getInstance(StarsController.this.currentAccount).processUpdates(tL_payments_paymentResult.updates, false);
            }
    ...
    public static /* synthetic */ void $r8$lambda$TgT3MynLYPKE6ZVb0tkBZKyVo_E(StarsController starsController, boolean[] zArr, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j, Utilities.Callback2 callback2) {
        starsController.getClass();
        zArr[0] = true;
        starsController.buyResellingGift(tL_payments_paymentFormStarGift, starGift, j, callback2);
    }
    ...
    public static class GiftsCollections {
        ...
        private long getHash(ArrayList arrayList) {
            ...
            while (i < size) {
                ...
                i++;
                j = MediaDataController.calcHash(j, ((TL_stars.TL_starGiftCollection) obj).hash);
            }
            return j;
        }
        ...
        public void load() {
            ...
            this.currentRequestId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(getstargiftcollections, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$GiftsCollections$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.GiftsCollections.$r8$lambda$aXrbr1JBcQidsThBar62rNr0UU4(StarsController.GiftsCollections.this, tLObject, tL_error);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$aXrbr1JBcQidsThBar62rNr0UU4(final GiftsCollections giftsCollections, final TLObject tLObject, TLRPC.TL_error tL_error) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$GiftsCollections$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.GiftsCollections.$r8$lambda$Dnzr_JXYKqlwh8B_GBWlD-1wbyE(StarsController.GiftsCollections.this, tLObject);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$Dnzr_JXYKqlwh8B_GBWlD-1wbyE(GiftsCollections giftsCollections, TLObject tLObject) {
            giftsCollections.getClass();
        ...
        public void createCollection(String str, final Utilities.Callback callback) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(createstargiftcollection, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$GiftsCollections$$ExternalSyntheticLambda3
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.GiftsCollections.$r8$lambda$SCsYlD92hx-096-soRSGr9X0nBw(StarsController.GiftsCollections.this, tL_starGiftCollection, giftsList, callback, tLObject, tL_error);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$SCsYlD92hx-096-soRSGr9X0nBw(final GiftsCollections giftsCollections, final TL_stars.TL_starGiftCollection tL_starGiftCollection, final GiftsList giftsList, final Utilities.Callback callback, final TLObject tLObject, final TLRPC.TL_error tL_error) {
            giftsCollections.getClass();
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$GiftsCollections$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.GiftsCollections.$r8$lambda$kd36xzXEc7kF_1tdd9bSploiBx4(StarsController.GiftsCollections.this, tLObject, tL_starGiftCollection, giftsList, callback, tL_error);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$kd36xzXEc7kF_1tdd9bSploiBx4(GiftsCollections giftsCollections, TLObject tLObject, TL_stars.TL_starGiftCollection tL_starGiftCollection, GiftsList giftsList, Utilities.Callback callback, TLRPC.TL_error tL_error) {
        ...
        public void addGifts(int i, ArrayList arrayList, boolean z) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(updatestargiftcollection, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$GiftsCollections$$ExternalSyntheticLambda2
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.GiftsCollections.$r8$lambda$um1AjQkJ_a0-ixht96VU4tDpU28(StarsController.GiftsCollections.this, tLObject, tL_error);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$um1AjQkJ_a0-ixht96VU4tDpU28(final GiftsCollections giftsCollections, final TLObject tLObject, TLRPC.TL_error tL_error) {
            giftsCollections.getClass();
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$GiftsCollections$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.GiftsCollections.$r8$lambda$pvMIToO-xiuZkBXBsVlwzFF6B5k(StarsController.GiftsCollections.this, tLObject);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$pvMIToO-xiuZkBXBsVlwzFF6B5k(GiftsCollections giftsCollections, TLObject tLObject) {
            giftsCollections.getClass();
            if (tLObject instanceof TL_stars.TL_starGiftCollection) {
                TL_stars.TL_starGiftCollection tL_starGiftCollection = (TL_stars.TL_starGiftCollection) tLObject;
                int indexOf = giftsCollections.indexOf(tL_starGiftCollection.collection_id);
                if (indexOf >= 0) {
                    giftsCollections.collections.set(indexOf, tL_starGiftCollection);
                }
            }
        }
        ...
        public void removeGifts(int i, ArrayList arrayList) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(updatestargiftcollection, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$GiftsCollections$$ExternalSyntheticLambda4
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.GiftsCollections.$r8$lambda$jKD92iaTyY7atUl36R5VfP0J7UI(StarsController.GiftsCollections.this, tLObject, tL_error);
                }
            });
            NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.dialogId), listById);
        }

        public static /* synthetic */ void $r8$lambda$jKD92iaTyY7atUl36R5VfP0J7UI(final GiftsCollections giftsCollections, final TLObject tLObject, TLRPC.TL_error tL_error) {
            giftsCollections.getClass();
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$GiftsCollections$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.GiftsCollections.$r8$lambda$tcJZg-sb9xFBZmPvhenrngFaCy0(StarsController.GiftsCollections.this, tLObject);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$tcJZg-sb9xFBZmPvhenrngFaCy0(GiftsCollections giftsCollections, TLObject tLObject) {
            giftsCollections.getClass();
            if (tLObject instanceof TL_stars.TL_starGiftCollection) {
                TL_stars.TL_starGiftCollection tL_starGiftCollection = (TL_stars.TL_starGiftCollection) tLObject;
                int indexOf = giftsCollections.indexOf(tL_starGiftCollection.collection_id);
    ...
    public static class GiftsList implements IGiftsList {
        ...
        public void load() {
            ...
            int sendRequest = ConnectionsManager.getInstance(this.currentAccount).sendRequest(getsavedstargifts, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$GiftsList$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StarsController.GiftsList.$r8$lambda$R44KHcXsMh8b5yAcsAjehxmwKqs(StarsController.GiftsList.this, r2, z, tLObject, tL_error);
                }
            });
        ...
        public static /* synthetic */ void $r8$lambda$R44KHcXsMh8b5yAcsAjehxmwKqs(final GiftsList giftsList, final int[] iArr, final boolean z, final TLObject tLObject, TLRPC.TL_error tL_error) {
            giftsList.getClass();
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$GiftsList$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.GiftsList.$r8$lambda$9qiI7tKVicfQoc42OBZn5RKwC7c(StarsController.GiftsList.this, iArr, tLObject, z);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$9qiI7tKVicfQoc42OBZn5RKwC7c(GiftsList giftsList, int[] iArr, TLObject tLObject, boolean z) {
            giftsList.getClass();
        ...
        public void processCrafting(ArrayList arrayList, TL_stars.StarGift starGift) {
            ...
            if (starGift != null) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(getsavedstargift, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$GiftsList$$ExternalSyntheticLambda4
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        StarsController.GiftsList.$r8$lambda$F3q15Ifbe9YMY263ylRnEnIoFhY(StarsController.GiftsList.this, tLObject, tL_error);
                    }
                });
            }
        }

        public static /* synthetic */ void $r8$lambda$F3q15Ifbe9YMY263ylRnEnIoFhY(final GiftsList giftsList, final TLObject tLObject, TLRPC.TL_error tL_error) {
            giftsList.getClass();
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$GiftsList$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.GiftsList.$r8$lambda$WQGmiNfeSLcmsvyVb6XruwNq8TQ(StarsController.GiftsList.this, tLObject);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$WQGmiNfeSLcmsvyVb6XruwNq8TQ(GiftsList giftsList, TLObject tLObject) {
            giftsList.getClass();
            if (tLObject instanceof TL_stars.TL_payments_savedStarGifts) {
                TL_stars.TL_payments_savedStarGifts tL_payments_savedStarGifts = (TL_stars.TL_payments_savedStarGifts) tLObject;
                MessagesController.getInstance(giftsList.currentAccount).putUsers(tL_payments_savedStarGifts.users, false);
    ...
    public void getStarGiftPreview(final long j, final Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(getstargiftupgradepreview, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda85
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$sX6keYetb5L2e1ZX7Bvp_YppqqQ(StarsController.this, j, callback, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$sX6keYetb5L2e1ZX7Bvp_YppqqQ(final StarsController starsController, final long j, final Utilities.Callback callback, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda103
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$flACazvr-JHdB4UgEvu7ji4HAfQ(StarsController.this, tLObject, j, callback);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$flACazvr-JHdB4UgEvu7ji4HAfQ(StarsController starsController, TLObject tLObject, long j, Utilities.Callback callback) {
        starsController.getClass();
    ...
    public void getUserStarGift(final TL_stars.InputSavedStarGift inputSavedStarGift, final Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(getsavedstargift, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda58
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$TH4WPTAX62ZDRWN6kpStZqRLvxs(StarsController.this, alertDialog, inputSavedStarGift, callback, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$TH4WPTAX62ZDRWN6kpStZqRLvxs(final StarsController starsController, final AlertDialog alertDialog, final TL_stars.InputSavedStarGift inputSavedStarGift, final Utilities.Callback callback, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda74
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$mgTD02bkLunGcg52Og0OFxe2Fl4(StarsController.this, alertDialog, tLObject, inputSavedStarGift, callback);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$mgTD02bkLunGcg52Og0OFxe2Fl4(StarsController starsController, AlertDialog alertDialog, TLObject tLObject, TL_stars.InputSavedStarGift inputSavedStarGift, Utilities.Callback callback) {
    ...
    public void getPaidRevenue(long j, long j2, final Utilities.Callback callback) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(getpaidmessagesrevenue, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda54
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda76
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$tqy42fpvzOBY6_NH5yWEoodkogw(TLObject.this, r2);
                    }
                });
            }
        });
    ...
    public void stopPaidMessages(final long j, final long j2, boolean z, final boolean z2) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(togglenopaidmessagesexception, new RequestDelegate() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda45
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                StarsController.$r8$lambda$Sa4se0wMPExGS1bSwo9z7ofUhbs(StarsController.this, j2, j, z2, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$Sa4se0wMPExGS1bSwo9z7ofUhbs(final StarsController starsController, final long j, final long j2, final boolean z, final TLObject tLObject, TLRPC.TL_error tL_error) {
        starsController.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda64
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$QEvEEyUL6sSBRUtpNRsU7uZZ2d8(StarsController.this, tLObject, j, j2, z);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$QEvEEyUL6sSBRUtpNRsU7uZZ2d8(StarsController starsController, TLObject tLObject, long j, long j2, boolean z) {
    ...
    class PaidMessagesToast {
        ...
        public PaidMessagesToast(BaseFragment baseFragment, long j) {
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.Stars.StarsController$PaidMessagesToast$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.PaidMessagesToast.this.send();
                }
            };
            ...
            undoButton.setUndoAction(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$PaidMessagesToast$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.PaidMessagesToast.this.undo();
                }
            });
            ...
            Bulletin create = BulletinFactory.of(baseFragment).create(twoLineAnimatedLottieLayout, -1);
            this.bulletin = create;
            create.hideAfterBottomSheet = false;
            create.show(true);
            create.setOnHideListener(new Runnable() { // from class: org.telegram.ui.Stars.StarsController$PaidMessagesToast$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    StarsController.PaidMessagesToast.this.send();
                }
    ...
    */
    public void showPaidMessageToast(long j, MessageObject messageObject, long j2, Utilities.Callback callback, Runnable runnable, boolean z) {
        ...
        if (this.currentPaidMessagesToast != null) {
            if (safeLastFragment != null && !safeLastFragment.isRemovingFromStack()) {
                ...
                if (paidMessagesToast2.dialogId == j) {
                }
            }
    ...
    public void beforeSendingMessage(MessageObject messageObject) {
        ...
        final boolean needsUndoButton = needsUndoButton(messageObject, j);
        final int id = messageObject.getId();
        if (needsUndoButton) {
            this.sendingPaidMessagesIds.add(Integer.valueOf(id));
        }
        showPaidMessageToast(messageObject.getDialogId(), messageObject, j, new Utilities.Callback() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda35
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                StarsController.$r8$lambda$uXH8rQE2M6SGRR7Olan2U9YZxt4(StarsController.this, needsUndoButton, (HashSet) obj);
            }
        }, new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda36
            @Override // java.lang.Runnable
            public final void run() {
                StarsController.$r8$lambda$Bt5QekNXuVf6Q6STPhcXwlZhQQA(StarsController.this, needsUndoButton, id);
            }
        }, needsUndoButton);
    }

    public static /* synthetic */ void $r8$lambda$uXH8rQE2M6SGRR7Olan2U9YZxt4(StarsController starsController, boolean z, HashSet hashSet) {
        if (z) {
    ...
    public static /* synthetic */ void $r8$lambda$Bt5QekNXuVf6Q6STPhcXwlZhQQA(StarsController starsController, boolean z, int i) {
        if (!z) {
            starsController.getClass();
            return;
        }
    ...
    public boolean beforeSendingFinalRequest(TLObject tLObject, ArrayList arrayList, final Runnable runnable) {
        ...
        while (i < size) {
            ...
            if (this.sendingPaidMessagesIds.remove(Integer.valueOf(id))) {
                this.postponedPaidMessages.put(Integer.valueOf(id), new Runnable() { // from class: org.telegram.ui.Stars.StarsController$$ExternalSyntheticLambda44
                    @Override // java.lang.Runnable
                    public final void run() {
                        StarsController.$r8$lambda$RDudJPa6DBaAEl1U8xbN5ZNekVQ(StarsController.this, hashSet, runnable);
                    }
                });
                z = true;
            }
    ...
    public static /* synthetic */ void $r8$lambda$RDudJPa6DBaAEl1U8xbN5ZNekVQ(StarsController starsController, HashSet hashSet, Runnable runnable) {
        starsController.getClass();
