...
public final /* synthetic */ class gz implements View.OnClickListener {
    ...
    public /* synthetic */ gz(mz mzVar, int i10) {
        this.a = i10;
        this.b = mzVar;
    }
        ...
        switch (this.a) {
            case 0:
                ...
                if (str != null) {
                    ...
                    org.telegram.messenger.rl.m(R.string.LinkCopied, org.telegram.ui.Components.mc.a0(mzVar.r));
                    break;
                }
                break;
            case 1:
                mz mzVar2 = this.b;
                FrameLayout frameLayout = mzVar2.a;
                ...
                float[] fArr = mzVar2.y;
                if (mzVar2.x == null && mzVar2.s != null) {
                    ...
                    FrameLayout overlayContainerView = mzVar2.r.getParentLayout().getOverlayContainerView();
                    if (overlayContainerView != null) {
                        ...
                        mzVar2.x.setOutsideTouchable(true);
                        mzVar2.x.setFocusable(true);
                        mzVar2.x.setBackgroundDrawable(new ColorDrawable(0));
                        mzVar2.x.setAnimationStyle(R.style.PopupContextAnimation);
                        mzVar2.x.setInputMethodMode(2);
                        mzVar2.x.setSoftInputMode(0);
                        ...
                        mzVar2.x.showAtLocation(overlayContainerView, 0, (int) (overlayContainerView.getX() + ((overlayContainerView.getMeasuredWidth() - actionBarPopupWindow$ActionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.dp(16.0f)) + f11), (int) (overlayContainerView.getY() + f10 + frameLayout.getMeasuredHeight()));
                        break;
                    }
                }
                break;
            case 2:
                mz mzVar3 = this.b;
                String str2 = mzVar3.s;
                if (str2 != null) {
                    AndroidUtilities.addToClipboard(str2);
                    org.telegram.messenger.rl.m(R.string.LinkCopied, org.telegram.ui.Components.mc.a0(mzVar3.r));
                    break;
                }
                break;
            case 3:
                ...
                if (mzVar4.s != null) {
                    try {
                        ...
                        intent.putExtra("android.intent.extra.TEXT", mzVar4.s);
                        mzVar4.r.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(R.string.InviteToGroupByLink)), 500);
                        break;
                    } catch (Exception e9) {
                        FileLog.e(e9);
                        return;
            ...
            case 4:
                mz mzVar5 = this.b;
                org.telegram.ui.ActionBar.n1 n1Var2 = mzVar5.x;
                if (n1Var2 != null) {
                    n1Var2.d(true);
                }
                oz ozVar = mzVar5.A.c;
                ...
                if (tL_exportedChatlistInvite != null && tL_exportedChatlistInvite.url != null) {
                    ...
                    editTextBoldCursor.setHint(ozVar.c.name);
            ...
            case 5:
                mz mzVar6 = this.b;
                org.telegram.ui.ActionBar.n1 n1Var3 = mzVar6.x;
                if (n1Var3 != null) {
                    n1Var3.d(true);
                }
                if (mzVar6.s != null) {
                    org.telegram.ui.Components.yh0 yh0Var = new org.telegram.ui.Components.yh0(mzVar6.getContext(), LocaleController.getString(R.string.InviteByQRCode), mzVar6.s, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
            ...
            default:
                mz mzVar7 = this.b;
                org.telegram.ui.ActionBar.n1 n1Var4 = mzVar7.x;
                if (n1Var4 != null) {
                    n1Var4.d(true);
                }
                ...
                oz ozVar2 = mzVar7.A.c;
                tL_inputChatlistDialogFilter.filter_id = ozVar2.c.id;
