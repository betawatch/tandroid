...
public final /* synthetic */ class xq0 implements Runnable {
    ...
    public /* synthetic */ xq0(wr0 wr0Var, int[] iArr, int[] iArr2, boolean z4, boolean z10, boolean z11) {
        this.e = wr0Var;
        this.f = iArr;
        this.h = iArr2;
        this.b = z4;
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                photoViewer.d = new jt0(photoViewer, photoViewer.d, messageObject, orientation, this.c, this.d);
                photoViewer.m1.l();
            ...
            default:
                ...
                int i13 = ((int[]) obj)[0];
                if (i12 == i13) {
                    bu0 bu0Var = wr0Var.b.b0;
                    boolean z10 = this.b;
                    int i14 = (this.c ? 1 : 0) + (z10 ? 1 : 0);
                    boolean z11 = this.d;
                    new org.telegram.ui.Components.qc(bu0Var, null).m(i14 + (z11 ? 1 : 0) > 1 ? org.telegram.ui.Components.pc.v : z11 ? i13 > 1 ? org.telegram.ui.Components.pc.s : org.telegram.ui.Components.pc.r : z10 ? i13 > 1 ? org.telegram.ui.Components.pc.n : org.telegram.ui.Components.pc.h : i13 > 1 ? org.telegram.ui.Components.pc.f : org.telegram.ui.Components.pc.e, i13, -115203550, -1, null).j();
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ xq0(PhotoViewer photoViewer, File file, boolean z4, MessageObject messageObject, boolean z10, boolean z11) {
        this.e = photoViewer;
        this.f = file;
        this.b = z4;
