...
public final class xq0 extends org.telegram.ui.Components.pv0 {
    public int A0;
    public VelocityTracker B0;
    public boolean C0;
    public final /* synthetic */ ar0 D0;
    public int w0;
    public boolean x0;
    public boolean y0;
    public int z0;
    ...
    public xq0(ar0 ar0Var, Context context) {
        super(context, null);
        this.D0 = ar0Var;
    }
    ...
    */
    public final boolean Z() {
        ...
        if (!ar0Var.w) {
            if (Math.abs(yq0VarArr[1].getTranslationX()) < 1.0f) {
                yq0VarArr[0].setTranslationX(r2.getMeasuredWidth() * (ar0Var.v ? -1 : 1));
                yq0VarArr[1].setTranslationX(0.0f);
                animatorSet = ar0Var.r;
                if (animatorSet != null) {
                }
                ar0Var.s = false;
            }
        ...
        if (Math.abs(yq0VarArr[0].getTranslationX()) < 1.0f) {
            yq0VarArr[0].setTranslationX(0.0f);
            yq0VarArr[1].setTranslationX(yq0VarArr[0].getMeasuredWidth() * (ar0Var.v ? 1 : -1));
            animatorSet = ar0Var.r;
            if (animatorSet != null) {
                animatorSet.cancel();
                ar0Var.r = null;
    ...
    public final boolean a0(MotionEvent motionEvent, boolean z10) {
        ...
        ar0 ar0Var = this.D0;
        yq0[] yq0VarArr = ar0Var.n;
        ScrollSlidingTextTabStrip scrollSlidingTextTabStrip = ar0Var.h;
        ...
        ar0Var.h.setEnabled(false);
        yq0 yq0Var = yq0VarArr[1];
        yq0Var.e = i10;
        yq0Var.setVisibility(0);
        ar0Var.v = z10;
        ar0Var.j0(true);
        if (z10) {
            yq0VarArr[1].setTranslationX(yq0VarArr[0].getMeasuredWidth());
            return true;
        }
        yq0VarArr[1].setTranslationX(-yq0VarArr[0].getMeasuredWidth());
        return true;
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        ar0 ar0Var = this.D0;
        int emojiPadding = (dp < 0 || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : ar0Var.d.getEmojiPadding();
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        if (AndroidUtilities.dp(20.0f) < 0) {
            ...
            size2 -= ar0Var.d.getEmojiPadding();
            ...
            while (true) {
                yq0VarArr = ar0Var.n;
                if (i13 < yq0VarArr.length) {
                    break;
                }
                yq0 yq0Var = yq0VarArr[i13];
                if (yq0Var != null && (ml0Var = yq0Var.d) != null) {
                    ml0Var.setPadding(AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f) + measuredHeight, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f));
                }
                i13++;
            }
            this.C0 = false;
            ...
            for (i14 = 0; i14 < childCount; i14++) {
                ...
                if (childAt != null && childAt.getVisibility() != 8) {
                    kVar3 = ((org.telegram.ui.ActionBar.n2) ar0Var).actionBar;
                    if (childAt != kVar3) {
                        org.telegram.ui.Components.ku kuVar = ar0Var.d;
                        if (kuVar == null || !kuVar.l(childAt)) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        ar0 ar0Var = this.D0;
        yq0[] yq0VarArr = ar0Var.n;
        c5Var = ((org.telegram.ui.ActionBar.n2) ar0Var).parentLayout;
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.x0 && !this.y0) {
            ...
            if (this.x0 && (((z10 = ar0Var.v) && x10 > 0) || (!z10 && x10 < 0))) {
                if (!a0(motionEvent, x10 < 0)) {
                    this.y0 = true;
                    this.x0 = false;
                    yq0VarArr[0].setTranslationX(0.0f);
                    yq0VarArr[1].setTranslationX(ar0Var.v ? yq0VarArr[0].getMeasuredWidth() : -yq0VarArr[0].getMeasuredWidth());
                    ar0Var.h.j(0.0f, yq0VarArr[1].e);
                }
            }
            if (!this.y0 || this.x0) {
                if (this.x0) {
                    yq0VarArr[0].setTranslationX(x10);
                    if (ar0Var.v) {
                        yq0VarArr[1].setTranslationX(yq0VarArr[0].getMeasuredWidth() + x10);
                    } else {
                        yq0VarArr[1].setTranslationX(x10 - yq0VarArr[0].getMeasuredWidth());
                    }
                    ar0Var.h.j(Math.abs(x10) / yq0VarArr[0].getMeasuredWidth(), yq0VarArr[1].e);
                }
            ...
            this.B0.computeCurrentVelocity(MediaDataController.MAX_STYLE_RUNS_COUNT, ar0Var.x);
            ...
            if (this.x0) {
                float x11 = yq0VarArr[0].getX();
                ar0Var.r = new AnimatorSet();
                boolean z11 = Math.abs(x11) < ((float) yq0VarArr[0].getMeasuredWidth()) / 3.0f && (Math.abs(f7) < 3500.0f || Math.abs(f7) < Math.abs(f10));
                ar0Var.w = z11;
                Property property = View.TRANSLATION_X;
                if (z11) {
                    measuredWidth = Math.abs(x11);
                    if (ar0Var.v) {
                        ar0Var.r.playTogether(ObjectAnimator.ofFloat(yq0VarArr[0], (Property<yq0, Float>) property, 0.0f), ObjectAnimator.ofFloat(yq0VarArr[1], (Property<yq0, Float>) property, r1.getMeasuredWidth()));
                    } else {
                        ar0Var.r.playTogether(ObjectAnimator.ofFloat(yq0VarArr[0], (Property<yq0, Float>) property, 0.0f), ObjectAnimator.ofFloat(yq0VarArr[1], (Property<yq0, Float>) property, -r1.getMeasuredWidth()));
                    }
                } else {
                    measuredWidth = yq0VarArr[0].getMeasuredWidth() - Math.abs(x11);
                    if (ar0Var.v) {
                        ar0Var.r.playTogether(ObjectAnimator.ofFloat(yq0VarArr[0], (Property<yq0, Float>) property, -r9.getMeasuredWidth()), ObjectAnimator.ofFloat(yq0VarArr[1], (Property<yq0, Float>) property, 0.0f));
                    } else {
                        ar0Var.r.playTogether(ObjectAnimator.ofFloat(yq0VarArr[0], (Property<yq0, Float>) property, r9.getMeasuredWidth()), ObjectAnimator.ofFloat(yq0VarArr[1], (Property<yq0, Float>) property, 0.0f));
                    }
                }
                ar0Var.r.setInterpolator(ar0.y);
                ...
                ar0Var.r.setDuration(Math.max(ImageReceiver.DEFAULT_CROSSFADE_DURATION, Math.min(Math.abs(f7) > 0.0f ? Math.round(Math.abs(distanceInfluenceForSnapDuration / r4) * 1000.0f) * 4 : (int) (((measuredWidth / getMeasuredWidth()) + 1.0f) * 100.0f), 600)));
                ar0Var.r.addListener(new wq0(this, 0));
                ar0Var.r.start();
                ar0Var.s = true;
                this.x0 = false;
            } else {
