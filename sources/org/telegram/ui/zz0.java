...
public final class zz0 extends org.telegram.ui.Components.yu0 {
    ...
    public final void M0(float f10) {
        ...
        if (zz0Var != null && profileActivity.p1) {
            if (profileActivity.q5[0] != null) {
                profileActivity.q5[0].setTranslationX(zz0Var.f0(8, true));
            }
    ...
    */
    ...
    public final void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(new sz0(this, 1));
    }
