...
public final class zz0 extends tu0 {
    ...
    /* JADX WARN: Type inference failed for: r1v7, types: [org.telegram.ui.Components.v9] */
    ...
    public final dv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ...
        if (fileLocation != null) {
            ...
            if (profileActivity.Y.getScaleX() <= 0.96f || !z11) {
                ...
                pz0 pz0Var3 = profileActivity.n0;
                if (pz0Var3 != null) {
                    int realCount = pz0Var3.getRealCount();
                    i11 = 0;
                    while (i11 < realCount) {
                ...
                if (i11 >= 0 && (pz0Var = profileActivity.n0) != null && pz0Var.getVisibility() == 0) {
                    if (i11 != profileActivity.n0.getRealPosition() && (ai0Var = (pz0Var2 = profileActivity.n0).D0) != null) {
                        pz0Var2.x(ai0Var.j() + i11, false);
                    }
                    ?? currentItemView = profileActivity.n0.getCurrentItemView();
                    if (currentItemView != 0) {
                        oz0Var = currentItemView;
                        z12 = true;
                        int[] iArr = new int[2];
                        oz0Var.getLocationInWindow(iArr);
                        dv0 dv0Var2 = new dv0();
                        dv0Var2.b = iArr[0];
                        dv0Var2.c = iArr[1];
                        dv0Var2.d = oz0Var;
                        ImageReceiver imageReceiver = oz0Var.getImageReceiver();
                        dv0Var2.a = imageReceiver;
                        ...
                        dv0Var2.e = imageReceiver.getBitmapSafe();
                        dv0Var2.g = -1L;
                        dv0Var2.h = oz0Var.getImageReceiver().getRoundRadius(true);
                        dv0Var2.k = !z12 ? 1.0f : profileActivity.Y.getScaleX();
                        dv0Var2.p = profileActivity.e1 != profileActivity.getUserConfig().clientUserId;
                ...
                z12 = false;
                int[] iArr2 = new int[2];
                oz0Var.getLocationInWindow(iArr2);
                dv0 dv0Var22 = new dv0();
                dv0Var22.b = iArr2[0];
                dv0Var22.c = iArr2[1];
                dv0Var22.d = oz0Var;
                ImageReceiver imageReceiver2 = oz0Var.getImageReceiver();
                dv0Var22.a = imageReceiver2;
                j3 = profileActivity.e1;
                if (j3 == 0) {
                }
                dv0Var22.e = imageReceiver2.getBitmapSafe();
                dv0Var22.g = -1L;
                dv0Var22.h = oz0Var.getImageReceiver().getRoundRadius(true);
                dv0Var22.k = !z12 ? 1.0f : profileActivity.Y.getScaleX();
                dv0Var22.p = profileActivity.e1 != profileActivity.getUserConfig().clientUserId;
                if (!z12) {
                    z13 = true;
                }
                dv0Var22.r = z13;
