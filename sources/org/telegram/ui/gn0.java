...
public final class gn0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    public final TextView a;
    public final TextView b;
    public final org.telegram.ui.Components.w9 c;
    public final org.telegram.ui.Components.cj0 d;
    public int e;
    ...
    public final void a(boolean z10) {
        ...
        org.telegram.ui.Components.cj0 cj0Var = this.d;
        if (isEmpty) {
            cj0Var.d(null, false, false);
            return;
        }
        ...
        if (str != null) {
            ...
            cj0Var.d(getResources().getDrawable(R.drawable.circle), true, z10);
            cj0Var.e(fileProgress != null ? fileProgress.floatValue() : 0.0f, false);
            invalidate();
            return;
        }
        if (exists) {
        ...
        cj0Var.d(getResources().getDrawable(R.drawable.circle), true, z10);
        cj0Var.e(fileProgress2 != null ? fileProgress2.floatValue() : 0.0f, z10);
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), TLObject.FLAG_30), org.telegram.messenger.ul.C(64.0f, 1, TLObject.FLAG_30));
    }
