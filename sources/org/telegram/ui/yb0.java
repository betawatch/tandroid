...
public final class yb0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public final int a;
    public final long b;
    public org.telegram.ui.Components.fw0 c;
    ...
    public final void Y(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        ...
        vb0 vb0Var = this.f;
        if (vb0Var != null) {
            vb0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false));
        ...
        wb0 wb0Var = this.r;
        if (wb0Var != null) {
            wb0Var.setVisibility(tL_chatInviteExported.subscription_pricing != null ? 0 : 8);
    ...
    public final View createView(Context context) {
        ...
        int i11 = 3;
        this.actionBar.setActionBarMenuOnItemClick(new v70(this, i11));
        ...
        final int i12 = 0;
        this.M.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.rb0
            ...
            public final void onClick(View view) {
                ...
                switch (i12) {
                    case 0:
                        ...
                        long j10 = yb0Var.b;
                        ArrayList arrayList = yb0Var.R;
                        ArrayList arrayList2 = yb0Var.P;
                        if (!yb0Var.V) {
                            int selectedIndex = yb0Var.d.getSelectedIndex();
                            if (selectedIndex < arrayList2.size() && ((Integer) arrayList2.get(selectedIndex)).intValue() < 0) {
                                AndroidUtilities.shakeView(yb0Var.w);
                                Vibrator vibrator = (Vibrator) yb0Var.w.getContext().getSystemService("vibrator");
                                if (vibrator != null) {
                                ...
                                if (w8Var != null && w8Var.e.h) {
                                    try {
                                        j3 = Long.parseLong(yb0Var.r.b.getText().toString());
                                    } catch (Exception e) {
                                        FileLog.e(e);
                                    }
                                    i13 = yb0Var.a;
                                    if (i13 != 0) {
                                        org.telegram.ui.ActionBar.b2 b2Var = yb0Var.U;
                                        if (b2Var != null) {
                                            b2Var.dismiss();
                                        }
                                        yb0Var.V = true;
                                        org.telegram.ui.ActionBar.b2 b2Var2 = new org.telegram.ui.ActionBar.b2(yb0Var.getParentActivity(), 3, null);
                                        yb0Var.U = b2Var2;
                                        b2Var2.q(500L);
                                        TLRPC.TL_messages_exportChatInvite tL_messages_exportChatInvite = new TLRPC.TL_messages_exportChatInvite();
                                        tL_messages_exportChatInvite.peer = yb0Var.getMessagesController().getInputPeer(-j10);
                                        tL_messages_exportChatInvite.legacy_revoke_permanent = false;
                                        int selectedIndex2 = yb0Var.d.getSelectedIndex();
                                        tL_messages_exportChatInvite.flags |= 1;
                                        if (selectedIndex2 < arrayList2.size()) {
                                            tL_messages_exportChatInvite.expire_date = yb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList2.get(selectedIndex2)).intValue();
                                        } else {
                                            tL_messages_exportChatInvite.expire_date = 0;
                                        }
                                        int selectedIndex3 = yb0Var.c.getSelectedIndex();
                                        ...
                                        vb0 vb0Var2 = yb0Var.f;
                                        boolean z12 = vb0Var2 != null && vb0Var2.e.h;
                                        tL_messages_exportChatInvite.request_needed = z12;
                                        if (z12) {
                                            tL_messages_exportChatInvite.usage_limit = 0;
                                        }
                                        String obj2 = yb0Var.K.getText().toString();
                                        ...
                                        if (j3 > 0) {
                                            ...
                                            tL_starsSubscriptionPricing.period = yb0Var.getConnectionsManager().isTestBackend() ? 300 : 2592000;
                                            tL_messages_exportChatInvite.subscription_pricing.amount = j3;
                                        }
                                        final int i14 = 0;
                                        yb0Var.getConnectionsManager().sendRequest(tL_messages_exportChatInvite, new RequestDelegate() { // from class: org.telegram.ui.pb0
                                            @Override // org.telegram.tgnet.RequestDelegate
                                            public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                                                switch (i14) {
                                                    case 0:
                                                        final int i15 = 0;
                                                        final yb0 yb0Var2 = yb0Var;
                                                            ...
                                                            public final void run() {
                                                                switch (i15) {
                                                                    case 0:
                                                                        yb0 yb0Var3 = yb0Var2;
                                                                        yb0Var3.V = false;
                                                                        org.telegram.ui.ActionBar.b2 b2Var3 = yb0Var3.U;
                                                                        if (b2Var3 != null) {
                                                                            b2Var3.dismiss();
                                                                        }
                                                                        TLRPC.TL_error tL_error2 = tL_error;
                                                                        if (tL_error2 != null) {
                                                                            org.telegram.ui.Components.e5.u0(yb0Var3, null, tL_error2.text, null);
                                                                            break;
                                                                        } else {
                                                                            xb0 xb0Var = yb0Var3.T;
                                                                            if (xb0Var != null) {
                                                                                xb0Var.c(tLObject);
                                                                            }
                                                                            yb0Var3.finishFragment();
                                                                            break;
                                                                        }
                                                                    default:
                                                                        yb0 yb0Var4 = yb0Var2;
                                                                        yb0Var4.V = false;
                                                                        org.telegram.ui.ActionBar.b2 b2Var4 = yb0Var4.U;
                                                                        if (b2Var4 != null) {
                                                                            b2Var4.dismiss();
                                                                        }
                                                                        TLRPC.TL_error tL_error3 = tL_error;
                                                                        if (tL_error3 != null) {
                                                                            org.telegram.ui.Components.e5.u0(yb0Var4, null, tL_error3.text, null);
                                                                            break;
                                                                        } else {
                                                                            TLObject tLObject2 = tLObject;
                                                                            if (tLObject2 instanceof TLRPC.TL_messages_exportedChatInvite) {
                                                                                yb0Var4.e = (TLRPC.TL_chatInviteExported) ((TLRPC.TL_messages_exportedChatInvite) tLObject2).invite;
                                                                            }
                                                                            xb0 xb0Var2 = yb0Var4.T;
                                                                            if (xb0Var2 != null) {
                                                                                xb0Var2.b(yb0Var4.e, tLObject2);
                                                                            }
                                                                            yb0Var4.finishFragment();
                                                                            break;
                                                                        }
                                                                }
                                                            }
                                                    ...
                                                    default:
                                                        final int i16 = 1;
                                                        final yb0 yb0Var3 = yb0Var;
                                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.qb0
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                switch (i16) {
                                                                    case 0:
                                                                        yb0 yb0Var32 = yb0Var3;
                                                                        yb0Var32.V = false;
                                                                        org.telegram.ui.ActionBar.b2 b2Var3 = yb0Var32.U;
                                                                        if (b2Var3 != null) {
                                                                            b2Var3.dismiss();
                                                                        }
                                                                        TLRPC.TL_error tL_error2 = tL_error;
                                                                        if (tL_error2 != null) {
                                                                            org.telegram.ui.Components.e5.u0(yb0Var32, null, tL_error2.text, null);
                                                                            break;
                                                                        } else {
                                                                            xb0 xb0Var = yb0Var32.T;
                                                                            if (xb0Var != null) {
                                                                                xb0Var.c(tLObject);
                                                                            }
                                                                            yb0Var32.finishFragment();
                                                                            break;
                                                                        }
                                                                    default:
                                                                        yb0 yb0Var4 = yb0Var3;
                                        ...
                                        org.telegram.ui.ActionBar.b2 b2Var3 = yb0Var.U;
                                        if (b2Var3 != null) {
                                            b2Var3.dismiss();
                                        }
                                        TLRPC.TL_messages_editExportedChatInvite tL_messages_editExportedChatInvite = new TLRPC.TL_messages_editExportedChatInvite();
                                        tL_messages_editExportedChatInvite.link = yb0Var.e.link;
                                        tL_messages_editExportedChatInvite.revoked = false;
                                        tL_messages_editExportedChatInvite.peer = yb0Var.getMessagesController().getInputPeer(-j10);
                                        int selectedIndex4 = yb0Var.d.getSelectedIndex();
                                        if (selectedIndex4 < arrayList2.size()) {
                                            if (yb0Var.W != ((Integer) arrayList2.get(selectedIndex4)).intValue()) {
                                                tL_messages_editExportedChatInvite.flags |= 1;
                                                tL_messages_editExportedChatInvite.expire_date = yb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList2.get(selectedIndex4)).intValue();
                                                z10 = true;
                                            }
                                            z10 = false;
                                        } else {
                                        ...
                                        if (selectedIndex5 < arrayList.size()) {
                                            ...
                                            obj = yb0Var.K.getText().toString();
                                            if (!TextUtils.equals(yb0Var.e.title, obj)) {
                                            ...
                                            if (!z10) {
                                                yb0Var.V = true;
                                                org.telegram.ui.ActionBar.b2 b2Var4 = new org.telegram.ui.ActionBar.b2(yb0Var.getParentActivity(), 3, null);
                                                yb0Var.U = b2Var4;
                                                b2Var4.q(500L);
                                                final int i16 = 1;
                                                yb0Var.getConnectionsManager().sendRequest(tL_messages_editExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.pb0
                                                    @Override // org.telegram.tgnet.RequestDelegate
                                                    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                                                        switch (i16) {
                                                            case 0:
                                                                ...
                                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.qb0
                                                                    ...
                                                                    public final void run() {
                                                                        switch (i152) {
                                                                            case 0:
                                                                                yb0 yb0Var32 = yb0Var2;
                                                                                yb0Var32.V = false;
                                                                                org.telegram.ui.ActionBar.b2 b2Var32 = yb0Var32.U;
                                                                                if (b2Var32 != null) {
                                                                                    b2Var32.dismiss();
                                                                                }
                                                                                TLRPC.TL_error tL_error2 = tL_error;
                                                                            ...
                                                                            default:
                                                                                yb0 yb0Var4 = yb0Var2;
                                                                                yb0Var4.V = false;
                                                                                org.telegram.ui.ActionBar.b2 b2Var42 = yb0Var4.U;
                                                                                if (b2Var42 != null) {
                                                                                    b2Var42.dismiss();
                                                                                }
                                                                                TLRPC.TL_error tL_error3 = tL_error;
                    ...
                    default:
                        yb0 yb0Var2 = this.b;
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(yb0Var2.getParentActivity());
                        ...
                        alertDialog$Builder.k(LocaleController.getString(R.string.RevokeButton), new ob0(yb0Var2, 1));
                        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                        yb0Var2.showDialog(alertDialog$Builder.a);
                        break;
                }
            }
        });
        ...
        tb0Var.addView(this.w, w7.y5.n(-1, 50));
        ...
        this.c = fw0Var2;
        fw0Var2.setCallback(new ob0(this, i11));
        X();
        tb0Var.addView(this.c);
        ...
        vb0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
        ...
        tb0Var.addView(this.f, w7.y5.n(-1, 56));
        ...
        if (chat == null || chat.username == null) {
            ...
            if ((this.e == null && ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3))) && chatFull != null && chatFull.paid_media_allowed) || ((tL_chatInviteExported = this.e) != null && tL_chatInviteExported.subscription_pricing != null)) {
                ...
                tb0Var.addView(this.n, w7.y5.n(-1, 48));
                TextView textView3 = new TextView(context);
                this.s = textView3;
                textView3.setTextSize(1, 16.0f);
                this.s.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.A6, false));
                wb0 wb0Var = new wb0(this, context, LocaleController.getString(getConnectionsManager().isTestBackend() ? R.string.RequireMonthlyFeePriceHintTest5Minutes : R.string.RequireMonthlyFeePriceHint), this.resourceProvider);
                this.r = wb0Var;
                wb0Var.b.setInputType(2);
                ...
                org.telegram.ui.Cells.h3 h3Var = wb0Var2.b;
                ...
                org.telegram.ui.Cells.h3 h3Var2 = wb0Var3.b;
                ...
                tb0Var.addView(this.r, w7.y5.n(-1, 48));
        ...
        ub0Var3.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
        this.K.setLines(1);
        this.K.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        this.K.setSingleLine();
        ub0 ub0Var4 = this.K;
        int i16 = org.telegram.ui.ActionBar.j6.G6;
        ub0Var4.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i16, false));
        ...
        if (i10 == 1) {
            ...
            final int i17 = 1;
            this.I.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.rb0
                public final /* synthetic */ yb0 b;
                ...
                public final void onClick(View view) {
                    ...
                    switch (i17) {
                        case 0:
                            final yb0 yb0Var = this.b;
                            long j10 = yb0Var.b;
                            ArrayList arrayList2 = yb0Var.R;
                            ArrayList arrayList22 = yb0Var.P;
                            if (!yb0Var.V) {
                                int selectedIndex = yb0Var.d.getSelectedIndex();
                                if (selectedIndex < arrayList22.size() && ((Integer) arrayList22.get(selectedIndex)).intValue() < 0) {
                                    ...
                                    org.telegram.ui.Cells.w8 w8Var2 = yb0Var.n;
                                    if (w8Var2 != null && w8Var2.e.h) {
                                        try {
                                            j32 = Long.parseLong(yb0Var.r.b.getText().toString());
                                        } catch (Exception e) {
                                            FileLog.e(e);
                                        }
                                        i132 = yb0Var.a;
                                        if (i132 != 0) {
                                            ...
                                            if (selectedIndex2 < arrayList22.size()) {
                                                tL_messages_exportChatInvite.expire_date = yb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList22.get(selectedIndex2)).intValue();
                                            } else {
                                                tL_messages_exportChatInvite.expire_date = 0;
                                            }
                                            int selectedIndex3 = yb0Var.c.getSelectedIndex();
                                            ...
                                            vb0 vb0Var22 = yb0Var.f;
                                            boolean z12 = vb0Var22 != null && vb0Var22.e.h;
                                            tL_messages_exportChatInvite.request_needed = z12;
                                            if (z12) {
                                                tL_messages_exportChatInvite.usage_limit = 0;
                                            }
                                            ...
                                            if (selectedIndex4 < arrayList22.size()) {
                                                if (yb0Var.W != ((Integer) arrayList22.get(selectedIndex4)).intValue()) {
                                                    tL_messages_editExportedChatInvite.flags |= 1;
                                                    tL_messages_editExportedChatInvite.expire_date = yb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList22.get(selectedIndex4)).intValue();
                                                    z102 = true;
                                                }
                                                z102 = false;
                                            } else {
        ...
        x8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i18, false));
