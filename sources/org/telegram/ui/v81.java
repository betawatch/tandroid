...
public final class v81 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.x40, vg0, xd.b {
    ...
    public final xd.a a;
    public lh.j4 b;
    public org.telegram.ui.Components.h61 c;
    public fg.i0 d;
    ...
    public static /* synthetic */ void V(v81 v81Var) {
        ...
        org.telegram.ui.Components.y40 y40Var = v81Var.n;
        TLRPC.UserProfilePhoto userProfilePhoto = user.photo;
        y40Var.o((userProfilePhoto == null || userProfilePhoto.photo_big == null || (userProfilePhoto instanceof TLRPC.TL_userProfilePhotoEmpty)) ? false : true, new j81(v81Var, 4), new eg.c0(6), 0);
    }

    public static /* synthetic */ void W(v81 v81Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
    ...
    */
    public static void Y(v81 v81Var) {
        String str;
        int i10;
        String string;
        String str2;
        ...
        if (i12 < 2 && !BuildVars.DEBUG_PRIVATE_VERSION) {
            try {
                Toast.makeText(v81Var.getParentActivity(), LocaleController.getString(R.string.DebugMenuLongPress), 0).show();
                return;
            } catch (Exception e6) {
                FileLog.e(e6);
                return;
        ...
        String string15 = LocaleController.getString(qh.v0.q(v81Var.getParentActivity()) ? "DebugMenuDualOff" : "DebugMenuDualOn");
        ...
        String str19 = !SharedConfig.isUsingCamera2(v81Var.currentAccount) ? "Use Camera 2 API" : "Use old Camera 1 API";
        ...
        if (SharedConfig.canBlurChat()) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                alertDialog$Builder.f(charSequenceArr, new rv(v81Var, 3));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                v81Var.showDialog(d2Var);
            }
        } else {
            str4 = string2;
        }
        ...
        alertDialog$Builder.f(charSequenceArr2, new rv(v81Var, 3));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
        v81Var.showDialog(d2Var);
    }

    public static /* synthetic */ void Z(v81 v81Var, ValueAnimator valueAnimator) {
    ...
    public static void a0(v81 v81Var, ArrayList arrayList) {
        ...
        org.telegram.ui.ActionBar.r0 r0Var = v81Var.e.C;
        int i11 = 0;
        if (r0Var != null && r0Var.getTag() != null) {
            ...
            if (n81Var.w) {
                ...
                while (i13 < size) {
                    ...
                    i13++;
                    int i14 = i12 + 1;
                    CharSequence charSequence = (CharSequence) n81Var.n.get(i12);
                ...
                ArrayList arrayList7 = n81Var.s;
                int size2 = arrayList7.size();
                while (i11 < size2) {
                    Object obj2 = arrayList7.get(i11);
                    i11++;
                    int i16 = i12 + 1;
                    CharSequence charSequence2 = (CharSequence) n81Var.n.get(i12);
        ...
        FrameLayout frameLayout = v81Var.x;
        ...
        while (true) {
            ...
            if (UserConfig.getInstance(i22).isClientActivated() && v81Var.currentAccount != i22) {
        ...
        if (set.contains("PREMIUM_GRACE")) {
            arrayList.add(t81.a(LocaleController.getString(R.string.GraceSuggestionTitle), LocaleController.getString(R.string.GraceSuggestionMessage), null, null, LocaleController.getString(R.string.GraceSuggestionButton), new k81(v81Var, i11)));
            ...
            arrayList.add(t81.a(LocaleController.formatString(R.string.CheckPhoneNumber, org.telegram.messenger.y3.j(new StringBuilder("+"), v81Var.getUserConfig().getCurrentUser().phone, se.b.c())), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.CheckPhoneNumberInfo), new j81(v81Var, i23)), LocaleController.getString(R.string.CheckPhoneNumberNo), new k81(v81Var, i23), mh.g5.g2(LocaleController.getString(R.string.CheckPhoneNumberYes2)), new k81(v81Var, 2)));
            arrayList.add(org.telegram.ui.Components.h51.B(null));
        } else if (set.contains("VALIDATE_PASSWORD")) {
            arrayList.add(t81.a(LocaleController.getString(R.string.YourPasswordHeader), LocaleController.getString(R.string.YourPasswordRemember), LocaleController.getString(R.string.YourPasswordRememberNo), new k81(v81Var, 3), LocaleController.getString(R.string.YourPasswordRememberYes), new k81(v81Var, i10)));
            arrayList.add(org.telegram.ui.Components.h51.B(null));
        }
        ...
        if (v81Var.getMessagesController().starsPurchaseAvailable()) {
            ...
            arrayList.add(r81.a(12, -1071598, -1608430, R.drawable.settings_stars, LocaleController.getString(R.string.TelegramStars), null, (!y10.e || y10.p().amount <= 0) ? "" : mh.ja.J0(y10.p(), 0.85f, ' ')));
        }
        mh.t7.y(v81Var.currentAccount, true).p();
        if (ApplicationLoader.isBetaBuild() || ApplicationLoader.isStandaloneBuild() || ApplicationLoader.isHuaweiStoreBuild() || (mh.t7.y(v81Var.currentAccount, true).e && (mh.t7.y(v81Var.currentAccount, true).O(0) || mh.t7.y(v81Var.currentAccount, true).p().positive()))) {
            ...
            arrayList.add(r81.a(13, -14965523, -15431455, i26, string, null, charSequence3));
        }
        ...
        if (((org.telegram.ui.Components.h51) l.d.i(1, arrayList)).a != 7) {
            arrayList.add(org.telegram.ui.Components.h51.B(null));
        }
    ...
    public static /* synthetic */ void b0(v81 v81Var, TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        v81Var.R = -1;
        if (tL_error == null) {
            ...
            } else if (closestPhotoSizeWithSize2 != null && v81Var.w != null) {
                FileLoader.getInstance(v81Var.currentAccount).getPathToAttach(v81Var.w, true).renameTo(FileLoader.getInstance(v81Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize2, true));
            }
            v81Var.getMessagesController().getDialogPhotos(user.id).addPhotoAtStart(tL_photos_photo.photo);
    ...
    public static void c0(v81 v81Var, int i10) {
        ...
        if (i10 == 6) {
            ...
            for (String str2 : MessagesController.getNotificationsSettings(v81Var.currentAccount).getAll().keySet()) {
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(v81Var.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 == 19) {
                ...
                v81Var.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new l81(v81Var, i12));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                ...
                if (i10 == 23) {
                    ...
                    Toast.makeText(v81Var.getParentActivity(), LocaleController.getString(!q10 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i12 < v81Var.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.p2) v81Var.getParentLayout().getFragmentStack().get(i12)).clearSheets();
                        i12++;
                    }
                    return;
                }
    ...
    public static /* synthetic */ void d0(v81 v81Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            TLRPC.FileLocation fileLocation = photoSize.location;
            v81Var.v = fileLocation;
            v81Var.w = photoSize2.location;
    ...
    public static /* synthetic */ void f0(v81 v81Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
    ...
    public final View createView(Context context) {
        ...
        this.c.j(new l3(this, 28));
        org.telegram.ui.Components.h61 h61Var2 = this.c;
        lh.j4 j4Var = this.b;
        Objects.requireNonNull(h61Var2);
        this.V = new og.k(h61Var2, j4Var, new x8(h61Var2, 0));
        this.c.C0(new j81(this, 2));
        ...
        this.y.setOnClickListener(new k81(this, 5));
        k7.e6.a(this.y);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.updateInterfaces) {
            ...
            if (i10 != NotificationCenter.newSuggestionsAvailable || (h61Var = this.c) == null) {
                return;
            }
            h61Var.V2.N(true);
        }
    ...
    public final void o0(boolean z4, boolean z10) {
        ...
        if (r0Var == null || r0Var.getTag() == null) {
            ...
            if (this.M == z11 || z4) {
                ...
                this.N = ofFloat;
                ofFloat.addUpdateListener(new n11(this, 11));
