...
public final class eo0 extends AsyncTask {
    ...
    */
    public final Object doInBackground(Object[] objArr) {
        ...
        try {
            if (oo0Var.C0.native_params != null) {
                try {
                    string = new JSONObject(oo0Var.C0.native_params.data).getString("tokenize_url");
                    if (string != null) {
                        try {
                ...
                httpURLConnection = (HttpURLConnection) (string == null ? new URL(string) : oo0Var.C0.invoice.test ? new URL("https://tgb-playground.smart-glocal.com/cds/v1/tokenize/card") : new URL("https://tgb.smart-glocal.com/cds/v1/tokenize/card")).openConnection();
                ...
                httpURLConnection.setRequestProperty("X-PUBLIC-TOKEN", oo0Var.j0);
