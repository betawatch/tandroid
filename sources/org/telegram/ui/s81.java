...
public final class s81 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public s81(SessionsActivity sessionsActivity, Context context) {
        super(context);
        ...
        this.a = u9Var;
        addView(u9Var, w7.x5.d(120, 120.0f, 1, 0.0f, 16.0f, 0.0f, 0.0f));
        hVar.j = false;
        hVar.n = 1.2f;
        u9Var.setOnClickListener(new a8(this, 2));
        ...
        addView(c90Var, w7.x5.d(-1, -2.0f, 0, 36.0f, 152.0f, 36.0f, 0.0f));
        c90Var.setGravity(1);
        ...
        c90Var.setHighlightColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.K6, false));
        ...
        if (indexOf != -1 && indexOf2 != -1 && indexOf != indexOf2) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.n51(LocaleController.getString(R.string.AuthAnotherClientDownloadClientUrl), (org.telegram.ui.Components.p01) null), indexOf, indexOf2 - 1, 33);
        }
        ...
        if (indexOf3 != -1 && indexOf4 != -1 && indexOf3 != indexOf4) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.n51(LocaleController.getString(R.string.AuthAnotherWebClientUrl), (org.telegram.ui.Components.p01) null), indexOf3, indexOf4 - 1, 33);
        }
        ...
        tkVar.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Sh, false));
        ...
        tkVar.setBackground(org.telegram.ui.ActionBar.j6.i0(dp, dp, dp, dp, w02, w03, w03));
        tkVar.setOnClickListener(new i41(this, 5));
        addView(tkVar, w7.x5.d(-1, 48.0f, 80, 16.0f, 15.0f, 16.0f, 16.0f));
        b();
    }
    ...
    public static void a(s81 s81Var) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && sessionsActivity.getParentActivity().checkSelfPermission("android.permission.CAMERA") != 0) {
            ...
            w9.e0(sessionsActivity.getParentActivity(), 2, new q81(sessionsActivity));
        }
    }
    ...
    public final void b() {
        ...
        if (stickerSetByName == null) {
            i12 = ((org.telegram.ui.ActionBar.o2) sessionsActivity).currentAccount;
        ...
        if (document == null) {
            ...
            u9Var.i(forDocument, "130_130", "tgs", svgThumb, tL_messages_stickerSet);
    ...
    public final void onAttachedToWindow() {
        ...
        b();
        i10 = ((org.telegram.ui.ActionBar.o2) this.d).currentAccount;
