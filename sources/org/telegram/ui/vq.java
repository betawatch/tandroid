        ...
        switch (i18) {
                ...
                while (i24 < arrayList3.size()) {
                    ...
                    if (tL_channels_getParticipants == null || tL_channels_channelParticipants == null) {
                        ...
                        if (i11 == 2) {
                            ...
                            if (i11 == 2) {
                                ...
                                while (i27 < size3) {
                                    ...
                                    if (tLObject instanceof TLRPC.ChannelParticipant) {
                                        ...
                                        if (iVar3.f(peerId) != null || iVar2.f(peerId) != null || (i21 == 1 && peerId > 0 && UserObject.isDeleted(srVar.getMessagesController().getUser(Long.valueOf(peerId))))) {
                            ...
                            if ((i11 != 0 || i11 == 3 || i11 == 2) && (chat = srVar.r) != null && chat.megagroup) {
                                chatFull = srVar.s;
            ...
            case 5:
                ...
                try {
                    ...
                    if ("APP_VERSION_OUTDATED".equals(tL_error.text)) {
                        org.telegram.ui.ActionBar.b2 x02 = org.telegram.ui.Components.d5.x0(externalActionActivity, LocaleController.getString(R.string.UpdateAppAlert), true);
                        if (x02 != null) {
            ...
            case 19:
                ...
                if (tLObject6 != null) {
                    ...
                    if (!TwoStepVerificationActivity.i0(password, false)) {
                        org.telegram.ui.Components.d5.x0(hc0Var.a, LocaleController.getString(R.string.UpdateAppAlert), true);
                    }
                    cc0 cc0Var = new cc0(hc0Var, str2, 0);
                    if (!password.has_password) {
                        ih1 ih1Var = new ih1(TextUtils.isEmpty(password.email_unconfirmed_pattern) ? 6 : 5, password);
                        ih1Var.j0 = cc0Var;
                        hc0Var.n(ih1Var, false);
                        break;
                    } else {
                        TwoStepVerificationActivity twoStepVerificationActivity = new TwoStepVerificationActivity();
                        twoStepVerificationActivity.I = password;
                        twoStepVerificationActivity.J = false;
                        hc0Var.n(twoStepVerificationActivity, false);
                        cc0Var.run();
                        break;
                    }
                }
            ...
            case 20:
                ...
                if (tLObject7 instanceof TLRPC.TL_users_userFull) {
                    ...
                    ec0Var.getMessagesController().putUsers(tL_users_userFull.users, false);
                    ec0Var.getMessagesController().putChats(tL_users_userFull.chats, false);
                    userFull = tL_users_userFull.full_user;
                } else {
                    userFull = null;
                }
                org.telegram.ui.Components.voip.f2.m(user2, false, userFull != null && userFull.video_calls_available, ec0Var.getParentActivity(), userFull, ec0Var.getAccountInstance());
                break;
            case 21:
                kd0 kd0Var = (kd0) obj3;
                GLSurfaceView gLSurfaceView = (GLSurfaceView) obj;
                ImageView imageView = new ImageView(kd0Var.getParentActivity());
                ...
                AndroidUtilities.runOnUIThread(new vq(kd0Var, viewGroup, gLSurfaceView, 22), 100L);
                break;
            case 22:
                kd0 kd0Var2 = (kd0) obj3;
            ...
            case 23:
                ...
                b2VarArr[0] = null;
                kd0Var3.F0.b(tL_messageMediaVenue, 4, true, 0, 0L);
                kd0Var3.finishFragment();
                break;
            case 24:
                yg0 yg0Var = (yg0) obj3;
                yg0Var.getClass();
                yg0Var.g1((Bundle) obj2, (TLRPC.auth_SentCode) ((TLObject) obj), true);
                break;
            case 25:
            ...
            case 26:
                ...
                yg0 yg0Var2 = ((ie0) obj3).W;
                if (!(tLObject8 instanceof TL_account.TL_emailVerified) || yg0Var2.F != 3) {
                    if (!(tLObject8 instanceof TL_account.TL_emailVerifiedLogin)) {
                        if (tLObject8 instanceof TLRPC.TL_auth_authorization) {
                            yg0Var2.o1((TLRPC.TL_auth_authorization) tLObject8, false);
                            break;
                        }
                    } else {
                        yg0Var2.g1(bundle, ((TL_account.TL_emailVerifiedLogin) tLObject8).sent_code, true);
                        break;
                    }
                } else {
                    yg0Var2.finishFragment();
                    yg0Var2.d0.run();
                    break;
                }
                break;
                            ...
                            if (!tL_error3.text.contains("PHONE_CODE_EXPIRED")) {
                                if (!tL_error3.text.contains("FIRSTNAME_INVALID")) {
                                    if (!tL_error3.text.contains("LASTNAME_INVALID")) {
                                        yg0Var3.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), tL_error3.text);
                                        break;
                                    } else {
                                        yg0Var3.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("InvalidLastName", R.string.InvalidLastName));
                                        break;
                                    }
                                } else {
                                    yg0Var3.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("InvalidFirstName", R.string.InvalidFirstName));
                                    break;
                                }
                            } else {
                                jf0Var.c(true);
                                yg0Var3.u1(0, true, null, true);
                                yg0Var3.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("CodeExpired", R.string.CodeExpired));
                                break;
                            }
                        } else {
                            yg0Var3.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("InvalidCode", R.string.InvalidCode));
                            break;
                        }
                    } else {
                        yg0Var3.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("InvalidPhoneNumber", R.string.InvalidPhoneNumber));
                        break;
                    }
                } else {
                    jf0Var.o();
                    yg0Var3.v1(false, true);
                    jf0Var.postDelayed(new r80(20, jf0Var, tLObject9), 150L);
                    break;
                }
                break;
            case 28:
                jf0 jf0Var2 = (jf0) obj3;
                TLRPC.FileLocation fileLocation = ((TLRPC.PhotoSize) obj2).location;
                jf0Var2.M = fileLocation;
                jf0Var2.N = ((TLRPC.PhotoSize) obj).location;
                jf0Var2.e.h(ImageLocation.getForLocal(fileLocation), "50_50", jf0Var2.f, null);
                break;
            default:
                bg0 bg0Var = (bg0) obj3;
                ...
                int i30 = bg0Var.f0;
                yg0 yg0Var4 = bg0Var.s0;
                bg0Var.z(false);
                bg0Var.d0 = false;
                if (tL_error4 != null) {
                    bg0Var.e0 = tL_error4.text;
                    if ((i30 == 3 && ((i17 = bg0Var.g0) == 4 || i17 == 2 || i17 == 17 || i17 == 16)) || ((i30 == 2 && ((i15 = bg0Var.g0) == 4 || i15 == 3)) || (i30 == 4 && ((i14 = bg0Var.g0) == 2 || i14 == 17 || i14 == 16)))) {
                        bg0Var.u();
                    }
                    if (i30 == 15) {
                    ...
                    bg0Var.c0 = true;
                    if (i30 != 3) {
                        i16 = ((org.telegram.ui.ActionBar.n2) yg0Var4).currentAccount;
                        org.telegram.ui.Components.d5.f0(i16, tL_error4, yg0Var4, confirmphone, new Object[0]);
                    }
                    ...
                    Activity parentActivity = yg0Var4.getParentActivity();
                    if (parentActivity != null) {
                        bg0Var.q(new r80(23, bg0Var, parentActivity));
                        break;
                    }
                }
                break;
