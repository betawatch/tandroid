...
public final class wc1 implements org.telegram.ui.ActionBar.e6 {
    ...
    public final Paint G(String str) {
        ...
        switch (str) {
            ...
            default:
                ...
                return e6Var != null ? e6Var.G(str) : org.telegram.ui.ActionBar.i6.S0(str);
        }
    }
    ...
    public final void b(Drawable drawable, Drawable drawable2, Float f7) {
        ...
        if ((z10 || (drawable instanceof BitmapDrawable)) && SharedConfig.getDevicePerformanceClass() != 0 && LiteMode.isEnabled(32)) {
            Bitmap bitmap = z10 ? ((org.telegram.ui.Components.cc0) drawable).k : drawable instanceof BitmapDrawable ? ((BitmapDrawable) drawable).getBitmap() : null;
            if (this.r != bitmap) {
                this.r = bitmap;
            ...
            textPaint2.linkColor = G0(org.telegram.ui.ActionBar.i6.jc);
        }
        Paint paint = this.c;
        paint.setColor(G0);
        Paint paint2 = this.d;
        ...
        if (z10) {
            if (((org.telegram.ui.Components.cc0) drawable).q >= 0.0f) {
        ...
        if (z10) {
            float f10 = ((org.telegram.ui.Components.cc0) drawable).q;
            if (f7 != null) {
                f10 = f7.floatValue();
            }
            if (f10 >= 0.0f) {
    ...
    public final int g1(int i10) {
        org.telegram.ui.ActionBar.e6 e6Var = this.a;
        return e6Var != null ? e6Var.g1(i10) : G0(i10);
    }
