...
public final class g50 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            d60Var.a1.call.join_muted = false;
            d60.F0(d60Var);
            return;
        }
        if (i10 == 2) {
            d60Var.a1.call.join_muted = true;
            d60.F0(d60Var);
            return;
        }
        if (i10 == 3) {
        ...
        if (i10 == 4) {
            ...
            a2Var.o(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.hg, false));
            return;
        }
        if (i10 == 9) {
            d60Var.m1.callOnClick();
            return;
        }
        if (i10 == 5) {
            ...
            int w04 = org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.ug, false);
            org.telegram.ui.ActionBar.a2 a2Var2 = alertDialog$Builder2.a;
            a2Var2.i(w04);
            a2Var2.show();
            a2Var2.o(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.ng, false));
            return;
        }
        if (i10 == 7) {
            d60Var.l0 = true;
            d60Var.u1.setVisibility(0);
            d60Var.v1.setVisibility(0);
            d60Var.n1.setVisibility(8);
            d60Var.x1.setVisibility(8);
            d60Var.y1.setVisibility(8);
            d60Var.w1.setVisibility(8);
            d60Var.r1.setVisibility(8);
            d60Var.o1.setVisibility(8);
            d60Var.s1.setVisibility(8);
            d60Var.t1.setVisibility(8);
            d60Var.k0.setVisibility(8);
            ...
            u0Var.b.measure(org.telegram.messenger.ok.c(40.0f, AndroidUtilities.displaySize.x, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, TLObject.FLAG_31));
            u0Var.O(true, true);
            return;
        }
        if (i10 == 6) {
            ...
            alertDialog$Builder3.a.I = org.telegram.ui.ActionBar.h6.pg;
            if (ChatObject.isChannelOrGiga(d60Var.Z0)) {
            ...
            if (!TextUtils.isEmpty(d60Var.a1.call.title)) {
                editTextBoldCursor.setText(d60Var.a1.call.title);
            ...
            int w05 = org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.fg, false);
            ...
            a2Var3.show();
            a2Var3.o(org.telegram.ui.ActionBar.h6.w0(null, i11, false));
        ...
        if (sharedInstance.hasEarpiece()) {
            ...
            org.telegram.ui.Cells.c1.m(sharedInstance.isHeadsetPlugged() ? R.drawable.msg_voice_headphones : R.drawable.msg_voice_phone, 1, arrayList2, arrayList3);
        }
        ...
        org.telegram.ui.ActionBar.e3 e3Var = new org.telegram.ui.ActionBar.e3(1, (Context) this.a, (org.telegram.ui.ActionBar.d6) null, false);
        ...
        int i13 = org.telegram.ui.ActionBar.h6.kg;
        e3Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
        e3Var.fixNavigationBar(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
        int i14 = sharedInstance.getCurrentAudioRoute() == 1 ? 0 : sharedInstance.getCurrentAudioRoute() == 0 ? 1 : 2;
        e3Var.show();
        e3Var.setTitleColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.ng, false));
        for (int i15 = 0; i15 < e3Var.getItemViews().size(); i15++) {
            org.telegram.ui.ActionBar.x2 x2Var = e3Var.getItemViews().get(i15);
            if (i15 == i14) {
                w02 = org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.pg, false);
                x2Var.f = true;
            } else {
            ...
            x2Var.setBackground(org.telegram.ui.ActionBar.h6.f0(i0.a.k(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.hg, false), 12), 2, -1));
        }
    }
}
