    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                if (photoViewer4.F2 != null || ((iu0Var = photoViewer4.f0) != null && iu0Var.x)) {
                    if (!photoViewer4.r1) {
                        ...
                        if (this.b.h5) {
                            ...
                            if (Math.abs(elapsedRealtime - this.b.S3) >= 500) {
                                ...
                                iu0 iu0Var2 = photoViewer5.f0;
                                if (iu0Var2 != null && iu0Var2.x) {
            ...
            default:
                ...
                if (!org.telegram.ui.Components.pg0.p0.P) {
                    ...
                    try {
                        if (photoViewer16.D2) {
                            ...
                            if (drawable instanceof BitmapDrawable) {
                                ...
                                AndroidUtilities.getBitmapFromSurface(photoViewer16.C2, createBitmap, new ak0(22, this, n6Var));
                            }
                        } else {
                    ...
                    if (org.telegram.ui.Components.pg0.x(false, photoViewer16.y, null, n6Var, photoViewer16.U, photoViewer16.V, photoViewer16.K3)) {
                        org.telegram.ui.Components.pg0.w(photoViewer16);
                    }
                    photoViewer16.K3 = true;
                    if (!photoViewer16.D2) {
                        photoViewer16.w3.setVisibility(4);
                        st0 st0Var = photoViewer16.y2;
                        if (st0Var != null) {
                            st0Var.removeView(photoViewer16.B2);
                            photoViewer16.y2.removeView(photoViewer16.C2);
                            break;
                        }
                    } else {
                        st0 st0Var2 = photoViewer16.y2;
                        if (st0Var2 != null) {
                            st0Var2.removeView(photoViewer16.B2);
                            photoViewer16.y2.removeView(photoViewer16.C2);
                        }
