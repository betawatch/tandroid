...
public final class at0 extends AnimatorListenerAdapter {
    ...
    public /* synthetic */ at0(PhotoViewer photoViewer, boolean z4, int i10) {
        this.a = i10;
        this.c = photoViewer;
        this.b = z4;
    }
            ...
            default:
                if (animator.equals(photoViewer.Q7)) {
                    ...
                    if (z4) {
                        ...
                        nu0 nu0Var = photoViewer.K7;
                        Property property = View.TRANSLATION_Y;
                        animatorSet.playTogether(ObjectAnimator.ofFloat(nu0Var, (Property<nu0, Float>) property, 0.0f), ObjectAnimator.ofFloat(photoViewer.L7, (Property<org.telegram.ui.Components.zf0, Float>) property, 0.0f));
                    } else {
                        if (photoViewer.P4) {
                        ...
                        animatorSet2.playTogether(ObjectAnimator.ofFloat(q1Var, (Property<eg.q1, Float>) property2, 0.0f), ObjectAnimator.ofFloat(photoViewer.M0, (Property<eg.q1, Float>) View.ALPHA, 1.0f), ObjectAnimator.ofFloat(photoViewer.P0, (Property<org.telegram.ui.Components.rp0, Float>) property2, 0.0f));
                    }
                    photoViewer.Q7.addListener(new ns0(this, 7));
