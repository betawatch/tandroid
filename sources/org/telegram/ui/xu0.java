        ...
        if (i10 == 1) {
            ...
            if (fv0Var.a0) {
                ...
                if (xnVar.c()) {
                    ...
                    fv0Var.b0.a(tL_messageMediaToDo);
                    fv0Var.finishFragment();
                    return;
                }
            }
            if (fv0Var.I && fv0Var.a.getAlpha() != 1.0f) {
                int i22 = 0;
                ...
                if (i22 <= 0) {
                    ...
                    for (int i23 = fv0Var.k0; i23 < fv0Var.k0 + fv0Var.y; i23++) {
                        f2.l1 K = fv0Var.c.K(i23);
                        if (K != null) {
                            View view = K.a;
            ...
            ArrayList arrayList = new ArrayList(fv0Var.n);
            int i25 = 0;
            while (i25 < charSequenceArr.length) {
                if (!TextUtils.isEmpty(org.telegram.ui.Components.qn.Y(charSequenceArr[i25]))) {
                    CharSequence[] charSequenceArr5 = new CharSequence[1];
                    charSequenceArr5[i17] = org.telegram.ui.Components.qn.Y(charSequenceArr[i25]);
            ...
            if (xnVar.c()) {
                ...
                fv0Var.b0.a(tL_messageMediaPoll);
                fv0Var.finishFragment();
            }
        }
    }
