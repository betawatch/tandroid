...
public final class xu0 extends org.telegram.ui.Components.rv0 {
    ...
    public xu0(PhotoViewer photoViewer, Activity activity, Activity activity2) {
    ...
    public final void Z() {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (photoViewer.u4 == 1 || photoViewer.o6 == 1) {
                ...
                this.D0.add(new Rect(0, org.telegram.messenger.wl.y(200.0f, measuredHeight, 2), AndroidUtilities.dp(100.0f), (AndroidUtilities.dp(200.0f) + measuredHeight) / 2));
                this.D0.add(new Rect(measuredWidth - AndroidUtilities.dp(100.0f), org.telegram.messenger.wl.y(200.0f, measuredHeight, 2), measuredWidth, (AndroidUtilities.dp(200.0f) + measuredHeight) / 2));
            }
    ...
    public final void draw(Canvas canvas) {
        ...
        int measuredHeight = ((int) ((photoViewer.a6 - 1.0f) * ku0Var.getWebView().getMeasuredHeight())) / 2;
        org.telegram.ui.Components.x61 x61Var = photoViewer.z1;
        if (x61Var != null && x61Var.j) {
            x61Var.setBounds(photoViewer.f0.getLeft(), (photoViewer.f0.getWebView().getTop() - measuredHeight) + ((int) (photoViewer.Y5 / photoViewer.a6)), photoViewer.f0.getRight(), photoViewer.f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.a6)));
            photoViewer.z1.draw(canvas);
        }
        org.telegram.ui.Components.lo0 lo0Var = photoViewer.A1;
    ...
    public final void onAttachedToWindow() {
        ...
        org.telegram.ui.Components.oc.a(this, new b9(this, 6));
    }
    ...
    public final void onDraw(Canvas canvas) {
        org.telegram.ui.Components.w7 w7Var;
        Canvas canvas2;
        Drawable[] drawableArr = PhotoViewer.U8;
        PhotoViewer photoViewer = this.E0;
        photoViewer.U1(canvas);
        if (AndroidUtilities.statusBarHeight == 0 || (w7Var = photoViewer.F) == null) {
            return;
        }
        int alpha = (int) (w7Var.getAlpha() * 255.0f * 0.498f);
        Paint paint = this.A0;
    ...
    */
                ...
                if (i22 == 1) {
                    ...
                    if (i23 != 16) {
                        ...
                        if (childAt != dt0Var.M) {
                            ...
                            } else if (dt0Var.f.l(childAt) || photoViewer.V1.f.l(childAt)) {
                                ...
                                if (childAt == photoViewer.e1 || childAt == photoViewer.f1 || childAt == photoViewer.g1) {
                                    ...
                                    if (arrayList == null || !arrayList.contains(childAt)) {
                                        ...
                                        if (arrayList2 != null && arrayList2.contains(childAt)) {
                                            ...
                                            int top2 = (frameLayout2 == null || frameLayout2.getVisibility() != 0) ? photoViewer.P0.getTop() : photoViewer.R7.getTop();
                                            ...
                                            measuredHeight = childAt.getMeasuredHeight();
                                        } else if (childAt == photoViewer.R7) {
                                            ...
                                            i19 = org.telegram.messenger.wl.v(31.0f, photoViewer.P0.getHeight(), i19);
                                        }
                                    } else {
                                        FrameLayout frameLayout3 = photoViewer.R7;
                                        int top3 = (frameLayout3 == null || frameLayout3.getVisibility() != 0) ? photoViewer.P0.getTop() - AndroidUtilities.dp(50.0f) : photoViewer.R7.getTop();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (xu0Var.getLayoutParams().height > 0) {
            size2 = xu0Var.getLayoutParams().height;
        }
        int i15 = size2;
        xu0Var.setMeasuredDimension(size, i15);
        PhotoViewer photoViewer = xu0Var.E0;
        boolean z10 = true;
        if (!photoViewer.r1) {
            xu0Var.B0 = true;
            if (photoViewer.i2) {
        ...
        if (v30Var == null || v30Var.getVisibility() == 8) {
            ...
            i12 = i10;
            xu0Var.measureChildWithMargins(photoViewer.l1, i12, 0, i11, 0);
        ...
        mv0 mv0Var = photoViewer.i3;
        if (mv0Var != null) {
            mv0Var.e = size;
            mv0Var.f = i15;
        }
        int paddingLeft = size - (xu0Var.getPaddingLeft() + xu0Var.getPaddingRight());
        int paddingBottom = i15 - xu0Var.getPaddingBottom();
        int childCount = xu0Var.getChildCount();
        int i17 = 0;
        while (i17 < childCount) {
            View childAt = xu0Var.getChildAt(i17);
            if (childAt.getVisibility() != 8 && childAt != photoViewer.l1) {
                ut0 ut0Var = photoViewer.y2;
                if (childAt == ut0Var) {
                    ...
                    xu0Var.measureChildWithMargins(childAt, i12, 0, i11, 0);
                }
            }
            i17++;
            z10 = true;
