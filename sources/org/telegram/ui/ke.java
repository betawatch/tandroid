...
public final class ke extends LinearLayout {
    ...
    public void set(je jeVar) {
        ...
        int indexOf;
        this.e.setText(jeVar.c);
        int i11 = 0;
        while (i11 < 2) {
            String str = i11 == 0 ? jeVar.b : jeVar.h;
            long j10 = i11 == 0 ? jeVar.e : jeVar.j;
            ...
            if (i11 == 0 && !jeVar.a) {
                ...
                if (equalsIgnoreCase) {
                    String format = this.f.format(jeVar.d / 1.0E9d);
                    ...
                    if ("XTR".equalsIgnoreCase(str)) {
                        if (i10 == 0) {
                            ...
                            spannableStringBuilder2.append((CharSequence) lh.ja.J0(jeVar.i, 0.8f, ' '));
                        }
                ...
                this.d[i10].setText("≈" + BillingController.getInstance().formatCurrency(j10, jeVar.f));
                i11 = i10 + 1;
            } else {
                linearLayoutArr[i11].setVisibility(8);
            }
