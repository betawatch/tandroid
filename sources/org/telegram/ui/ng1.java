...
public final /* synthetic */ class ng1 implements Runnable {
    ...
    public /* synthetic */ ng1(og1 og1Var, String str, boolean z10, boolean z11, int i10) {
        this.a = i10;
        this.b = og1Var;
        this.c = str;
        this.d = z10;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                boolean z13 = this.e;
                og1Var.getClass();
                AndroidUtilities.runOnUIThread(new ng1(og1Var, str4, z12, z13, 1));
                break;
            case 1:
                og1 og1Var2 = this.b;
                String str5 = this.c;
                boolean z14 = this.d;
                boolean z15 = this.e;
                og1Var2.f.g(str5, true, z14, z14, og1Var2.v.C, 0L, false, 0, 0);
                DispatchQueue dispatchQueue = Utilities.searchQueue;
                ng1 ng1Var = new ng1(og1Var2, str5, z15, z14, 2);
                og1Var2.h = ng1Var;
            ...
            default:
                ...
                boolean z16 = this.d;
                boolean z17 = this.e;
                ArrayList arrayList2 = og1Var3.r;
                                ...
                                while (i14 < 3) {
                                    ...
                                    if (str8 != null) {
                                        if (!str8.startsWith(str7)) {
                                            i10 = i14;
                                            if (org.telegram.messenger.y1.x(" ", str7, str8)) {
                                            }
                                        }
                                        c11 = 1;
                                        ...
                                        if (c11 == 0) {
                                            if (c11 != 1) {
                                                str3 = str;
                                                arrayList4.add(AndroidUtilities.generateSearchName(s3.c.e("@", str2), str3, "@" + str7));
                                            } else if (z18) {
