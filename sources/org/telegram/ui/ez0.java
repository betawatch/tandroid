...
public final class ez0 implements org.telegram.ui.Components.cl0 {
    public int a = 0;
    ...
    public static void a(ez0 ez0Var, Context context, int i10) {
        ...
        int i18 = 0;
        if (i10 == 0) {
            ez0Var.c.getUserConfig().syncContacts = true;
            ez0Var.c.getUserConfig().saveConfig(false);
            ez0Var.c.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            ez0Var.c.getContactsController().loadContacts(false, 0L);
            return;
        }
        if (i10 == 2) {
            ez0Var.c.getContactsController().resetImportedContacts();
            return;
        }
        if (i10 == 3) {
            ez0Var.c.getMessagesController().forceResetDialogs();
            return;
        }
        if (i10 == 4) {
        ...
        if (i10 == 6) {
            ...
            edit.apply();
            i16 = ((org.telegram.ui.ActionBar.n2) ez0Var.c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i16).edit();
            i17 = ((org.telegram.ui.ActionBar.n2) ez0Var.c).currentAccount;
        ...
        if (i10 == 7) {
            org.telegram.ui.Components.voip.f2.i(ez0Var.c.getParentActivity());
            return;
        }
        if (i10 == 8) {
        ...
        if (i10 == 9) {
            ((LaunchActivity) ez0Var.c.getParentActivity()).z(true);
            return;
        }
        if (i10 == 10) {
            ez0Var.c.getMessagesStorage().readAllDialogs(-1);
            return;
        }
        if (i10 == 11) {
        ...
        if (i10 == 13) {
            Set<String> set = ez0Var.c.getMessagesController().pendingSuggestions;
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(ez0Var.c.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 == 18) {
                w7.x.a((LaunchActivity) ez0Var.c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
                ez0Var.c.getMessagesController().loadAppConfig();
                TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                ez0Var.c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new bz0(ez0Var, i18));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(ez0Var.c.getParentActivity(), 0, ez0Var.c.z0);
                ...
                if (i10 == 23) {
                    boolean q6 = ci.d1.q(ez0Var.c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Toast.makeText(ez0Var.c.getParentActivity(), LocaleController.getString(!q6 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i18 < ez0Var.c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.n2) ez0Var.c.getParentLayout().getFragmentStack().get(i18)).clearSheets();
                        i18++;
                    }
                    return;
                }
                ...
                if (i10 == 27) {
                    ez0Var.c.getMediaDataController().loadAttachMenuBots(false, true);
                    return;
                }
                if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.n2) ez0Var.c).currentAccount;
                ...
                if (i10 == 35) {
                    i11 = ((org.telegram.ui.ActionBar.n2) ez0Var.c).currentAccount;
            ...
            ProfileActivity.S0(ez0Var.c, MediaController.VIDEO_MIME_TYPE, sb3);
            ProfileActivity.S0(ez0Var.c, "video/hevc", sb3);
            ProfileActivity.S0(ez0Var.c, "video/x-vnd.on2.vp8", sb3);
            ProfileActivity.S0(ez0Var.c, "video/x-vnd.on2.vp9", sb3);
            ez0Var.c.showDialog(new dz0(ez0Var, ez0Var.c.getParentActivity(), sb3.toString()));
