...
public final class t5 extends FrameLayout {
        ...
        switch (this.a) {
            ...
            case 5:
                ...
                if (od1Var.M1) {
                    float f7 = od1Var.n1;
                    if (f7 > 0.0f) {
                        paint2.setColor(i0.a.k(-16777216, (int) (f7 * 255.0f * od1Var.o1)));
            ...
            case 7:
                ...
                if (!limitPreviewView.P) {
                    paint5.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.a7, d6Var));
                } else if (limitPreviewView.c0 || limitPreviewView.R) {
                    paint5.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.i6, d6Var));
                } else {
            ...
            case 8:
                ...
                paint6.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Ii, (org.telegram.ui.ActionBar.d6) this.b));
            ...
            case 9:
                ...
                int i14 = x0Var.M;
                i10 = ((org.telegram.ui.ActionBar.e3) x0Var).backgroundPaddingTop;
                drawable.setBounds(0, org.telegram.messenger.ok.D(2.0f, i10 + i14, 1), getMeasuredWidth(), getMeasuredHeight());
                drawable2 = ((org.telegram.ui.ActionBar.e3) x0Var).shadowDrawable;
            ...
            case 11:
                ...
                i11 = ((org.telegram.ui.ActionBar.e3) x3Var).backgroundPaddingLeft;
                int width = getWidth();
                i12 = ((org.telegram.ui.ActionBar.e3) x3Var).backgroundPaddingLeft;
                rectF5.set(i11, d11, width - i12, getHeight() + dp2);
                Paint paint7 = (Paint) this.c;
                paint7.setColor(x3Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5));
        ...
        switch (this.a) {
            ...
            case 11:
                ...
                if (motionEvent.getAction() == 0 && motionEvent.getY() < d()) {
                    viewGroup = ((org.telegram.ui.ActionBar.e3) x3Var).containerView;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        switch (this.a) {
            case 6:
                ...
                matrix.postScale((b6Var.y0 / b6Var.w0.getWidth()) * max, (b6Var.z0 / b6Var.w0.getHeight()) * max);
                matrix.postTranslate((photoImage.getCenterX() + (cell.getX() + y0Var.getX())) - ((b6Var.y0 * max) / 2.0f), (photoImage.getCenterY() + (cell.getY() + y0Var.getY())) - ((b6Var.z0 * max) / 2.0f));
                b6Var.w0.setTransform(matrix);
                canvas.save();
                path.rewind();
                AndroidUtilities.rectTmp.set(photoImage.getImageX() + cell.getX() + y0Var.getX(), photoImage.getImageY() + cell.getY() + y0Var.getY(), photoImage.getImageX2() + cell.getX() + y0Var.getX(), photoImage.getImageY2() + cell.getY() + y0Var.getY());
        ...
        switch (this.a) {
            case 3:
                ...
                if (photoViewer.H0.getVisibility() != 8) {
                    ...
                    ub1Var.layout(dp, ub1Var.getTop(), photoViewer.H0.getMeasuredWidth() + dp, photoViewer.H0.getMeasuredHeight() + photoViewer.H0.getTop());
                    break;
                }
                break;
            case 6:
                ...
                int i14 = 0;
                for (int i15 = 0; i15 < y0Var.getChildCount(); i15++) {
                    View childAt = y0Var.getChildAt(i15);
                ...
                y0Var.layout(-measuredWidth, 0, y0Var.getMeasuredWidth() - measuredWidth, y0Var.getMeasuredHeight());
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            ...
            case 6:
                ...
                TextureView textureView = b6Var.w0;
                if (textureView != null) {
                    textureView.measure(View.MeasureSpec.makeMeasureSpec(y0Var.getMeasuredWidth(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(y0Var.getMeasuredHeight(), TLObject.FLAG_30));
                }
                int measuredWidth = y0Var.getMeasuredWidth();
                int i13 = 0;
                for (int i14 = 0; i14 < y0Var.getChildCount(); i14++) {
                    View childAt = y0Var.getChildAt(i14);
                    int left2 = childAt.getLeft();
                    int right = childAt.getRight();
                    if (childAt instanceof org.telegram.ui.Cells.u1) {
                        org.telegram.ui.Cells.u1 u1Var = (org.telegram.ui.Cells.u1) childAt;
                ...
                setMeasuredDimension(i13 - measuredWidth, y0Var.getMeasuredHeight());
                break;
            case 7:
                org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.b;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.e;
            ...
            case 9:
                ...
                i12 = ((org.telegram.ui.ActionBar.e3) x0Var).backgroundPaddingTop;
                x0Var.L = i12 + size3;
                super.onMeasure(i10, i11);
                x0Var.y();
                break;
    ...
    public t5(rg.f0 f0Var, Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.e = f0Var;
        this.b = d6Var;
        this.c = new rg.z0(org.telegram.ui.ActionBar.h6.Lj, org.telegram.ui.ActionBar.h6.Mj, -1, -1, d6Var);
        Paint paint = new Paint(1);
        this.d = paint;
