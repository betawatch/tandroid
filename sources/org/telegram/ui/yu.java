...
public final class yu extends org.telegram.ui.Components.xa {
    ...
    public yu(x6 x6Var, q6 q6Var, kh.b bVar, oc.i iVar) {
        ...
        xu xuVar = new xu(getContext(), q6Var.a, iVar);
        this.T = xuVar;
        ...
        while (i12 < i11) {
            ...
            if (j11 > j10) {
                ...
                org.telegram.ui.Components.ux0 ux0Var = new org.telegram.ui.Components.ux0();
                ...
                ux0VarArr[i12] = ux0Var;
                org.telegram.ui.Components.ux0 ux0Var2 = this.X[i12];
                ux0Var2.e = j11;
                ux0Var2.a = i10;
                ...
                org.telegram.ui.Components.hp hpVar = y1Var2.r;
                if (hpVar != null) {
                    hpVar.b(i10, i10, i13);
                }
        ...
        xuVar2.B = bVar;
        xuVar2.invalidate();
        xuVar2.c = new float[ux0VarArr2.length];
        xuVar2.d = new float[ux0VarArr2.length];
        xuVar2.e = new float[ux0VarArr2.length];
        xuVar2.c(false);
        if (xuVar2.y > 1) {
            xuVar2.f = 0.0f;
        } else {
        ...
        org.telegram.ui.Components.sa saVar = this.s;
        if (saVar != null) {
