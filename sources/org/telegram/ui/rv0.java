...
public class rv0 {
            ...
            if (hypot <= 1.005f || this.n) {
                ...
                if (z10) {
                    ...
                    if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                        ...
                        qv0 qv0Var3 = this.d;
                        mediaController.setTextureView(qv0Var3.b, qv0Var3.c, qv0Var3.a, true);
                        ...
                        nv0 nv0Var = this.E;
                        if (nv0Var != null) {
                            this.d.d.setImageBitmap(nv0Var.g0().getBitmap((int) this.z, (int) this.y));
    ...
    public final void d() {
        if (this.C == null && this.n) {
            ...
            this.C.setInterpolator(org.telegram.ui.Components.wr.f);
            this.C.start();
        }
    }
