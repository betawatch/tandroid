...
public final class rv0 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (zv0Var.L && zv0Var.a.getAlpha() != 1.0f) {
                int i22 = 0;
                ...
                if (i22 <= 0) {
                    ...
                    for (int i23 = zv0Var.n0; i23 < zv0Var.n0 + zv0Var.y; i23++) {
                        s4.c1 K = zv0Var.c.K(i23);
                        if (K != null) {
                            View view = K.a;
            ...
            ArrayList arrayList = new ArrayList(zv0Var.n);
            int i25 = 0;
            while (i25 < charSequenceArr.length) {
                if (!TextUtils.isEmpty(org.telegram.ui.Components.tn.Y(charSequenceArr[i25]))) {
                    CharSequence[] charSequenceArr5 = new CharSequence[1];
                    charSequenceArr5[i17] = org.telegram.ui.Components.tn.Y(charSequenceArr[i25]);
            ...
            if (coVar.c()) {
                ...
                zv0Var.e0.b(tL_messageMediaPoll);
                zv0Var.finishFragment();
            }
        }
    }
