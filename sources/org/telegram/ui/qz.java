...
public final /* synthetic */ class qz implements View.OnClickListener {
    ...
    public /* synthetic */ qz(wz wzVar, int i10) {
        this.a = i10;
        this.b = wzVar;
    }
    ...
    public final void onClick(View view) {
        switch (this.a) {
            ...
            case 1:
                ...
                if (wzVar2.x == null && wzVar2.s != null) {
                    ...
                    if (overlayContainerView != null) {
                        ...
                        wzVar2.x.showAtLocation(overlayContainerView, 0, (int) (overlayContainerView.getX() + ((overlayContainerView.getMeasuredWidth() - actionBarPopupWindow$ActionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.dp(16.0f)) + f10), (int) (overlayContainerView.getY() + f7 + frameLayout.getMeasuredHeight()));
                        break;
                    }
                }
                break;
            ...
            case 4:
                wz wzVar5 = this.b;
                org.telegram.ui.ActionBar.m1 m1Var2 = wzVar5.x;
                if (m1Var2 != null) {
                    m1Var2.d(true);
                }
                yz yzVar = wzVar5.E.c;
            ...
            case 5:
                wz wzVar6 = this.b;
                org.telegram.ui.ActionBar.m1 m1Var3 = wzVar6.x;
                if (m1Var3 != null) {
                    m1Var3.d(true);
                }
                if (wzVar6.s != null) {
            ...
            default:
                wz wzVar7 = this.b;
                org.telegram.ui.ActionBar.m1 m1Var4 = wzVar7.x;
                if (m1Var4 != null) {
                    m1Var4.d(true);
                }
