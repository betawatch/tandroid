...
public class q20 extends org.telegram.ui.Components.vc0 {
    public boolean C0;
    public boolean D0;
    public boolean E0;
    public boolean F0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        ((org.telegram.ui.Components.l90) o20Var.c).setAlpha(f14);
        ...
        setLightStatusBar(org.telegram.ui.ActionBar.j6.v(org.telegram.ui.ActionBar.j6.v0(i11, e6Var), paint.getColor()));
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float x11 = l90Var.getX() + x10;
        float y3 = l90Var.getY() + o20Var.getY();
        RectF rectF2 = AndroidUtilities.rectTmp;
        rectF2.set(x11, y3, l90Var.getMeasuredWidth() + x11, l90Var.getMeasuredHeight() + y3);
        if ((!rectF2.contains(motionEvent.getX(), motionEvent.getY()) && !this.D0) || r20Var.c.K1 || (layout = l90Var.getLayout()) == null) {
            f7 = 1.0f;
        } else {
            ...
            if (text instanceof Spanned) {
                ...
                if (clickableSpanArr != null && clickableSpanArr.length > 0 && r20Var.x < 1.0f) {
                    ...
                    l90Var.dispatchTouchEvent(motionEvent);
                    return true;
                }
            }
        }
    ...
    @Override // org.telegram.ui.Components.vc0, org.telegram.ui.Components.bw0
