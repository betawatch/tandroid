...
public final /* synthetic */ class hl0 implements Utilities.Callback {
    ...
    public /* synthetic */ hl0(i71 i71Var, String str, boolean z10, ArrayList arrayList, HashMap hashMap, ArrayList arrayList2, LinkedHashSet linkedHashSet, LinkedHashSet linkedHashSet2, ArrayList arrayList3, ArrayList arrayList4, boolean z11) {
        this.e = i71Var;
        this.b = str;
        this.c = z10;
        this.f = arrayList;
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.t51
                    ...
                    public final void run() {
                        ...
                        while (i10 < size) {
                            ...
                            i10++;
                            i71Var2.C1.addAll((ArrayList) obj2);
                        }
                        i71Var2.q0.E(true ^ z13);
                    }
                });
                break;
        }
    ...
    public /* synthetic */ hl0(int[] iArr, TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth, org.telegram.ui.ActionBar.g3 g3Var, boolean z10, String str, TLRPC.UrlAuthResult urlAuthResult, String[] strArr, boolean z11, org.telegram.ui.web.d1 d1Var, String str2, org.telegram.ui.ActionBar.f6 f6Var) {
        this.e = iArr;
