...
public final class nh0 extends FrameLayout {
    ...
    public final int a(float f10, int i10) {
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.ka, false);
        }
        if (i10 != 1) {
            return i10 == 2 ? org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.oa, false) : i10 == 4 ? org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.V8, false) : org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.Oh, false);
        }
        if (f10 > 0.5f) {
            return i0.a.d(1.0f - ((f10 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.na, false), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.oa, false));
        }
        return i0.a.d(1.0f - (f10 / 0.5f), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.oa, false), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.ka, false));
    }
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
            ...
            if (i15 > 0 && i14 == 0 && !tL_chatInviteExported.expired && !tL_chatInviteExported.revoked) {
                ...
                if (tL_chatInviteExported.requested > 0) {
                    if (tL_chatInviteExported.usage > 0) {
                        formatPluralString = w.c.e(formatPluralString, ", ");
                    }
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((qh0Var.k0 * 1000) + System.currentTimeMillis());
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10 || tL_chatInviteExported2.revoked) {
            ...
            if (i12 > 0 || tL_chatInviteExported2.usage_limit > 0) {
                if (i12 > 0) {
                    long currentTimeMillis = (qh0Var.k0 * 1000) + System.currentTimeMillis();
        ...
        if (!z11) {
            ...
            if (tL_chatInviteExported.subscription_pricing == null) {
                qh0Var.X.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                qh0Var.X.draw(canvas2);
            } else if (tL_chatInviteExported.revoked) {
                qh0Var.W.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                qh0Var.W.draw(canvas2);
            } else {
                qh0Var.V.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                qh0Var.V.draw(canvas2);
            }
            if (this.E) {
                return;
            }
            canvas2.drawLine(AndroidUtilities.dp(70.0f), getMeasuredHeight() - 1, AndroidUtilities.dp(23.0f) + getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.k6.k0);
            return;
        }
        if (z11) {
            f11 = this.C;
        ...
        z4 = ((org.telegram.ui.ActionBar.p2) qh0Var).isPaused;
        if (!z4) {
            invalidate();
        }
        this.C = f15;
