...
public final class nt0 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        photoViewer.o6 = -1;
        photoViewer.e0.invalidate();
        yu0 yu0Var = photoViewer.i7;
        if (yu0Var != null) {
            PhotoViewer photoViewer2 = yu0Var.d;
            photoViewer2.d = yu0Var.c;
        ...
        if (photoViewer.i2) {
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.Q1, (Property<ju0, Float>) property, 0.0f));
        }
        ...
        if (photoViewer.e1.getTag() != null) {
            ...
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.e1, (Property<org.telegram.ui.ActionBar.j0, Float>) property2, 1.0f));
        }
        ...
        if (photoViewer.g1.getTag() != null) {
            ...
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.g1, (Property<rs0, Float>) property2, 1.0f));
        }
        ...
        animatorSet.addListener(new mt0(this, i11));
        animatorSet.start();
    }
}
