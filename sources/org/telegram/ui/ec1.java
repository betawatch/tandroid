...
public final class ec1 extends org.telegram.ui.Components.rl0 {
    public boolean U2;
    public float V2;
    public final /* synthetic */ jd1 W2;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ec1(Context context, jd1 jd1Var) {
        super(context, null);
        this.W2 = jd1Var;
    }
    ...
    public final boolean F0(View view) {
        ec1 ec1Var = this.W2.r0;
        View F = ec1Var.F(view);
        f2.l1 T = F == null ? null : ec1Var.T(F);
        return T == null || T.f != 2;
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view instanceof org.telegram.ui.Cells.s1) {
            ...
            if (avatarImage != null) {
                ...
                if (s1Var.n3() && (r11 = jd1Var.r0.T(view)) != null) {
                    int i10 = 0;
                    while (i10 < 20) {
                        i10++;
                        f2.l1 T2 = jd1Var.r0.K(T2.b() + 1);
                        if (T2 == null) {
                            break;
                        }
                        View view2 = T2.a;
    ...
    public final void g1(View view, float f10, float f11, boolean z4) {
        if (z4 && (view instanceof org.telegram.ui.Cells.s1) && !((org.telegram.ui.Cells.s1) view).i3(f10)) {
            return;
        }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        jd1 jd1Var = this.W2;
        if (action == 1) {
            if (!jd1Var.o0 && (jd1Var.y1 instanceof ui1) && jd1Var.I0[0].getVisibility() == 0) {
