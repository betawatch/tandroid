    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 1) {
            ...
            if (DialogObject.isUserDialog(longValue)) {
                f4Var.e(fzVar.getMessagesController().getUser(l4), null, null, i10 != fzVar.r - 1);
                return;
            } else {
                f4Var.e(fzVar.getMessagesController().getChat(Long.valueOf(-longValue)), null, null, i10 != fzVar.r - 1);
                return;
            }
        }
        ...
        r8Var.n(LocaleController.getString(R.string.SelectChats), new org.telegram.ui.Components.pq(drawable, drawable2), fzVar.n != -1);
