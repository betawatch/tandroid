...
public class cz implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.Components.tl0 E;
    public final long F;
    public final long G;
    public HashMap H;
    public final xn a;
    ...
    */
    ...
    public final void c() {
        ...
        while (true) {
            ...
            if (((bz) arrayList.get(i10)).j != null) {
                ((bz) arrayList.get(i10)).j.d(this.D);
            }
            i10++;
        }
    }
            ...
            if (z14 || ((arrayList != null && !arrayList.isEmpty()) || z13)) {
                ...
                while (true) {
                    ...
                    if (i13 >= arrayList2.size()) {
                        ...
                        bzVar.i = z14;
                        if (!z14) {
                            bzVar.f = ((random.nextInt() % 101) / 100.0f) * (f10 / 4.0f);
                            bzVar.g = ((random.nextInt() % 101) / 100.0f) * (f11 / 4.0f);
                        }
                        bzVar.p = i10;
                        bzVar.q = document2;
                        bzVar.m = z11;
                        bzVar.r.setAllowStartAnimation(true);
                        bzVar.r.setAllowLottieVibration(z4);
                        ...
                        if (premiumStickerAnimation == null) {
                            ...
                            bzVar.r.setImage(forDocument, sb.toString(), null, "tgs", this.c, 1);
                            bzVar.r.setDelegate(new az(this, bzVar, z4, messageObject));
                            ...
                            bzVar.r.setImage(forDocument2, sb2.toString(), null, "tgs", this.c, 1);
                        }
                    ...
                    if (((bz) arrayList2.get(i13)).p == i10) {
                        i14++;
                        if (!z14 && (((bz) arrayList2.get(i13)).r.getLottieAnimation() == null || ((bz) arrayList2.get(i13)).r.getLottieAnimation().w())) {
                            return false;
                        }
                    }
    ...
    public final void e(Canvas canvas) {
        ...
        while (i10 < this.C.size()) {
            ...
            if (this.a != null) {
                ...
                while (true) {
                    ...
                    if (messageObject == null || messageObject.getId() != bzVar.p) {
                        ...
                        if (bzVar.i && (childAt instanceof org.telegram.ui.Cells.t1)) {
                            ...
                            float f15 = f13 / 2.0f;
                            f10 = 3.0f;
                            bzVar.a = Utilities.clamp(timeX - f15, AndroidUtilities.displaySize.x - f13, 0.0f);
                            bzVar.b = (t1Var2.getTimeY() + y10) - f15;
                        } else {
                            f10 = 3.0f;
                            if (bzVar.h) {
                                bzVar.a = imageReceiver.getImageX() + x10;
                                bzVar.b = imageReceiver.getImageY() + y10;
                            } else {
                ...
                if (!bzVar.c || bzVar.e + f11 < this.a.p9 || f11 > this.E.getMeasuredHeight() - this.a.xa) {
                    bzVar.n = true;
                }
                if (bzVar.h) {
            ...
            boolean z11 = !bzVar.l && bzVar.n;
            if (!z11) {
                if (!bzVar.h || bzVar.i) {
                    ng.d dVar = bzVar.j;
                    if (dVar != null) {
                        float f18 = bzVar.a + bzVar.f;
                        float f19 = bzVar.b + bzVar.g;
                        float f20 = bzVar.d * f10;
                        dVar.e((int) f18, (int) f19, (int) (f18 + f20), (int) (f19 + f20));
                        bzVar.j.b(canvas);
                    } else {
                        ImageReceiver imageReceiver2 = bzVar.r;
                        float f21 = bzVar.a + bzVar.f;
                        float f22 = bzVar.b + bzVar.g;
                        float f23 = bzVar.d * f10;
                    ...
                    float f27 = (((f24 / 2.0f) + bzVar.b) - (f25 / 2.0f)) - (0.00279f * f25);
                    if (bzVar.m) {
                        bzVar.r.setImageCoords(((bzVar.a + bzVar.d) - f25) + f26, f27, f25, f25);
                    } else {
                        bzVar.r.setImageCoords(bzVar.a - f26, f27, f25, f25);
                    }
                    if (bzVar.m) {
                        bzVar.r.draw(canvas);
                    } else {
            ...
            ng.d dVar2 = bzVar.j;
            boolean c3 = dVar2 != null ? dVar2.c() : bzVar.l && bzVar.r.getLottieAnimation() != null && bzVar.r.getLottieAnimation().Y >= bzVar.r.getLottieAnimation().e[0] + (-2);
            if (bzVar.o == 1.0f || c3 || z11) {
                bz bzVar2 = (bz) this.C.remove(i10);
                if (bzVar.h && bzVar.r.getLottieAnimation() != null) {
                    bzVar2.r.getLottieAnimation().L(0, true, true);
                }
                ...
                i10--;
            } else if (bzVar.r.getLottieAnimation() != null && bzVar.r.getLottieAnimation().i0) {
                bzVar.l = true;
            } else if (bzVar.r.getLottieAnimation() != null && !bzVar.r.getLottieAnimation().i0) {
                bzVar.r.getLottieAnimation().L(0, true, false);
                bzVar.r.getLottieAnimation().start();
            }
            i10++;
        }
    ...
    public final void j() {
        ...
        while (true) {
            ...
            if (((bz) arrayList.get(i10)).j != null) {
                ((bz) arrayList.get(i10)).j.f(this.D);
            }
            i10++;
        }
    }
        ...
        if (t1Var.getMessageObject().isPremiumSticker() || xnVar.f != null) {
            ...
            if ((printingStringType == null || printingStringType.intValue() != 5) && this.B == null && o10) {
                ...
                if ((icVar == null || !icVar.l) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.b).getClientUserId() != xnVar.f.id) {
                    ...
                    zy zyVar = new zy(i10, this, org.telegram.ui.Components.ic.g(xnVar, cx0Var, 2750));
                    this.B = zyVar;
    ...
    public final void p(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, MessageObject messageObject) {
        ...
        org.telegram.ui.Components.cx0 cx0Var = new org.telegram.ui.Components.cx0(this.D.getContext(), null, 1, -1, messageObject.getDocument(), xnVar.getResourceProvider());
        cx0Var.b.setText(tL_messages_stickerSet.set.title);
        cx0Var.c.setText(LocaleController.getString(R.string.PremiumStickerTooltip));
        ...
        gcVar.a = new org.telegram.ui.Components.l41(23, this, messageObject);
        gcVar.e(LocaleController.getString(R.string.ViewAction));
        org.telegram.ui.Components.ic g10 = org.telegram.ui.Components.ic.g(xnVar, cx0Var, 2750);
        g10.b = messageObject.getId();
        g10.j();
    }

    public cz(xn xnVar, FrameLayout frameLayout, org.telegram.ui.Components.tl0 tl0Var, int i10, long j10, long j11) {
        this.a = xnVar;
        this.D = frameLayout;
        this.E = tl0Var;
        this.b = i10;
