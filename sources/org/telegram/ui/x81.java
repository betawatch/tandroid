...
public final class x81 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.u40, yg0, le.e {
    ...
    public static boolean U(x81 x81Var, org.telegram.ui.Components.h51 h51Var, View view) {
        Object obj = h51Var.G;
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            ei.k3.j(x81Var.currentAccount, ((TLRPC.TL_attachMenuBot) obj).bot_id, new k81(x81Var, 0));
            return true;
        }
        if (h51Var.G(org.telegram.ui.Cells.v6.class)) {
            ...
            if (!TextUtils.isEmpty(str)) {
                org.telegram.ui.Components.o70 H = org.telegram.ui.Components.o70.H(x81Var, view);
                H.c(R.drawable.msg_link2, LocaleController.getString(R.string.CopyLink), new by0(24, x81Var, str), false);
                H.W(x81Var.c.V0(view, false));
                H.Z();
                return true;
            }
        }
    ...
    public static /* synthetic */ void V(x81 x81Var) {
        TLRPC.User user = MessagesController.getInstance(x81Var.currentAccount).getUser(Long.valueOf(UserConfig.getInstance(x81Var.currentAccount).getClientUserId()));
        if (user == null) {
            user = UserConfig.getInstance(x81Var.currentAccount).getCurrentUser();
        }
        if (user == null) {
            return;
        }
        org.telegram.ui.Components.v40 v40Var = x81Var.n;
        TLRPC.UserProfilePhoto userProfilePhoto = user.photo;
        v40Var.o((userProfilePhoto == null || userProfilePhoto.photo_big == null || (userProfilePhoto instanceof TLRPC.TL_userProfilePhotoEmpty)) ? false : true, new k81(x81Var, 4), new ci.f1(6), 0);
    }

    public static /* synthetic */ void W(x81 x81Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        tL_attachMenuBot.side_menu_disclaimer_needed = false;
        tL_attachMenuBot.inactive = false;
        LaunchActivity.C0(LaunchActivity.G1, x81Var.currentAccount, tL_attachMenuBot, null, true);
        MediaDataController.getInstance(x81Var.currentAccount).updateAttachMenuBotsInCache();
    }

    public static /* synthetic */ void X(x81 x81Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        TLRPC.TL_messages_toggleBotInAttachMenu tL_messages_toggleBotInAttachMenu = new TLRPC.TL_messages_toggleBotInAttachMenu();
        tL_messages_toggleBotInAttachMenu.bot = MessagesController.getInstance(x81Var.currentAccount).getInputUser(tL_attachMenuBot.bot_id);
        tL_messages_toggleBotInAttachMenu.enabled = true;
        tL_messages_toggleBotInAttachMenu.write_allowed = true;
        ConnectionsManager.getInstance(x81Var.currentAccount).sendRequest(tL_messages_toggleBotInAttachMenu, new wb0(23, x81Var, tL_attachMenuBot), 66);
    }
    ...
    */
    public static void Z(x81 x81Var) {
        String str;
        int i10;
        String string;
        String str2;
        ...
        if (i12 < 2 && !BuildVars.DEBUG_PRIVATE_VERSION) {
            try {
                Toast.makeText(x81Var.getParentActivity(), LocaleController.getString(R.string.DebugMenuLongPress), 0).show();
                return;
            } catch (Exception e) {
                FileLog.e(e);
                return;
        ...
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(x81Var.getParentActivity(), 0, x81Var.resourceProvider);
        ...
        String str14 = (!z11 || org.telegram.ui.Components.x50.c()) ? null : !SharedConfig.bigCameraForRound ? "Force big camera for round" : "Disable big camera for round";
        String string15 = LocaleController.getString(ci.d1.q(x81Var.getParentActivity()) ? "DebugMenuDualOff" : "DebugMenuDualOn");
        ...
        String str19 = !SharedConfig.isUsingCamera2(x81Var.currentAccount) ? "Use Camera 2 API" : "Use old Camera 1 API";
        ...
        if (SharedConfig.canBlurChat()) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                alertDialog$Builder.f(charSequenceArr, new rv(x81Var, 3));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                x81Var.showDialog(b2Var);
            }
        } else {
            str4 = string2;
        }
        ...
        alertDialog$Builder.f(charSequenceArr2, new rv(x81Var, 3));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
        x81Var.showDialog(b2Var);
    }

    public static /* synthetic */ void a0(x81 x81Var, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        x81Var.actionBar.getTitlesContainer().setAlpha(floatValue);
        x81Var.d.setAlpha(floatValue);
    }

    public static void b0(x81 x81Var, ArrayList arrayList) {
        int i10;
        ArrayList<TLRPC.TL_attachMenuBot> arrayList2;
        ArrayList arrayList3 = x81Var.R;
        org.telegram.ui.ActionBar.q0 q0Var = x81Var.e.F;
        int i11 = 0;
        if (q0Var != null && q0Var.getTag() != null) {
            ...
            p81 p81Var = x81Var.h;
            ArrayList arrayList4 = p81Var.d;
            ArrayList arrayList5 = p81Var.v;
            if (p81Var.w) {
                ArrayList arrayList6 = p81Var.r;
                ...
                while (i13 < size) {
                    ...
                    i13++;
                    int i14 = i12 + 1;
                    CharSequence charSequence = (CharSequence) p81Var.n.get(i12);
                ...
                ArrayList arrayList7 = p81Var.s;
                int size2 = arrayList7.size();
                while (i11 < size2) {
                    Object obj2 = arrayList7.get(i11);
                    i11++;
                    int i16 = i12 + 1;
                    CharSequence charSequence2 = (CharSequence) p81Var.n.get(i12);
        ...
        FrameLayout frameLayout = x81Var.x;
        ...
        while (true) {
            ...
            if (UserConfig.getInstance(i22).isClientActivated() && x81Var.currentAccount != i22) {
                arrayList3.add(Integer.valueOf(i22));
            }
            i22++;
        }
        Collections.sort(arrayList3, new df(29));
        Set<String> set = x81Var.getMessagesController().pendingSuggestions;
        int i23 = 1;
        if (set.contains("PREMIUM_GRACE")) {
            arrayList.add(v81.a(LocaleController.getString(R.string.GraceSuggestionTitle), LocaleController.getString(R.string.GraceSuggestionMessage), null, null, LocaleController.getString(R.string.GraceSuggestionButton), new l81(x81Var, i11)));
            arrayList.add(org.telegram.ui.Components.h51.B(null));
        } else if (set.contains("VALIDATE_PHONE_NUMBER") && x81Var.getUserConfig().getCurrentUser() != null) {
            arrayList.add(v81.a(LocaleController.formatString(R.string.CheckPhoneNumber, org.telegram.messenger.ul.h(new StringBuilder("+"), x81Var.getUserConfig().getCurrentUser().phone, gf.b.c())), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.CheckPhoneNumberInfo), new k81(x81Var, i23)), LocaleController.getString(R.string.CheckPhoneNumberNo), new l81(x81Var, i23), yh.y3.g2(LocaleController.getString(R.string.CheckPhoneNumberYes2)), new l81(x81Var, 2)));
            arrayList.add(org.telegram.ui.Components.h51.B(null));
        } else if (set.contains("VALIDATE_PASSWORD")) {
            arrayList.add(v81.a(LocaleController.getString(R.string.YourPasswordHeader), LocaleController.getString(R.string.YourPasswordRemember), LocaleController.getString(R.string.YourPasswordRememberNo), new l81(x81Var, 3), LocaleController.getString(R.string.YourPasswordRememberYes), new l81(x81Var, i10)));
            arrayList.add(org.telegram.ui.Components.h51.B(null));
        }
        if (arrayList3.size() > 0) {
            ...
            for (int i24 = 0; i24 < arrayList3.size(); i24++) {
                ...
                int i25 = r81.a;
                org.telegram.ui.Components.h51 J6 = org.telegram.ui.Components.h51.J(r81.class);
                J6.d = i24;
                J6.z = intValue;
                arrayList.add(J6);
            }
        ...
        arrayList.add(t81.a(1, -14899731, -15431455, R.drawable.settings_account, LocaleController.getString(R.string.SettingsAccount), LocaleController.getString(R.string.SettingsAccountInfo), null));
        arrayList.add(t81.a(2, -1007845, -1996271, R.drawable.settings_chat, LocaleController.getString(R.string.SettingsChat), LocaleController.getString(R.string.SettingsChatInfo), null));
        arrayList.add(t81.a(3, -11154873, -14175180, R.drawable.settings_privacy, LocaleController.getString(R.string.SettingsPrivacySecurity), LocaleController.getString(R.string.SettingsPrivacySecurityInfo), null));
        arrayList.add(t81.a(5, -765355, -2148011, R.drawable.settings_sounds, LocaleController.getString(R.string.SettingsNotifications), LocaleController.getString(R.string.SettingsNotificationsInfo), null));
        arrayList.add(t81.a(6, -11565578, -13276952, R.drawable.settings_data, LocaleController.getString(R.string.SettingsData), LocaleController.getString(R.string.SettingsDataInfo), null));
        arrayList.add(t81.a(7, -14899731, -15497247, R.drawable.settings_folders, LocaleController.getString(R.string.SettingsFolders), LocaleController.getString(R.string.SettingsFoldersInfo), null));
        arrayList.add(t81.a(8, -13451058, -14836538, R.drawable.settings_devices, LocaleController.getString(R.string.SettingsDevices), LocaleController.getString(R.string.SettingsDevicesInfo), null));
        arrayList.add(t81.a(9, -881871, -1940716, R.drawable.settings_power, LocaleController.getString(R.string.SettingsPowerSaving), LocaleController.getString(R.string.SettingsPowerSavingInfo), null));
        arrayList.add(t81.a(10, -3903756, -6335009, R.drawable.settings_language, LocaleController.getString(R.string.SettingsLanguage), LocaleController.getCurrentLanguageName(), null));
        arrayList.add(org.telegram.ui.Components.h51.B(null));
        if (!x81Var.getMessagesController().premiumFeaturesBlocked()) {
            arrayList.add(t81.a(11, -4826625, -10388225, R.drawable.settings_premium, LocaleController.getString(R.string.TelegramPremium), null, null));
        }
        CharSequence charSequence3 = "";
        if (x81Var.getMessagesController().starsPurchaseAvailable()) {
            yh.t5 y3 = yh.t5.y(x81Var.currentAccount, false);
            arrayList.add(t81.a(12, -1071598, -1608430, R.drawable.settings_stars, LocaleController.getString(R.string.TelegramStars), null, (!y3.e || y3.p().amount <= 0) ? "" : yh.w7.J0(y3.p(), 0.85f, ' ')));
        }
        yh.t5.y(x81Var.currentAccount, true).p();
        if (ApplicationLoader.isBetaBuild() || ApplicationLoader.isStandaloneBuild() || ApplicationLoader.isHuaweiStoreBuild() || (yh.t5.y(x81Var.currentAccount, true).e && (yh.t5.y(x81Var.currentAccount, true).O(0) || yh.t5.y(x81Var.currentAccount, true).p().positive()))) {
            yh.t5 y10 = yh.t5.y(x81Var.currentAccount, true);
            long j3 = y10.p().amount;
            int i26 = R.drawable.settings_gram_24;
            String string = LocaleController.getString(R.string.MyTON);
            if (y10.e && j3 > 0) {
                charSequence3 = yh.w7.J0(y10.p(), 0.85f, ' ');
            }
            arrayList.add(t81.a(13, -14965523, -15431455, i26, string, null, charSequence3));
        }
        ...
        if (attachMenuBots != null && (arrayList2 = attachMenuBots.bots) != null && !arrayList2.isEmpty()) {
            ...
            while (i11 < size5) {
                ...
                if (tL_attachMenuBot2.show_in_side_menu && tL_attachMenuBot2.bot_id == 1985737506) {
                    ...
                    org.telegram.ui.Components.h51 J7 = org.telegram.ui.Components.h51.J(t81.class);
        ...
        if (!x81Var.getMessagesController().premiumFeaturesBlocked()) {
            arrayList.add(t81.a(15, -765355, -2148011, R.drawable.settings_business, LocaleController.getString(R.string.TelegramBusiness), null, null));
        }
        if (!x81Var.getMessagesController().premiumPurchaseBlocked()) {
            arrayList.add(t81.a(16, -816335, -1940716, R.drawable.settings_gift, LocaleController.getString(R.string.SendAGift), null, null));
        }
        if (((org.telegram.ui.Components.h51) hg.c.h(1, arrayList)).a != 7) {
            arrayList.add(org.telegram.ui.Components.h51.B(null));
        }
        com.google.android.gms.internal.vision.e2.n(R.string.SettingsHelp, arrayList);
        arrayList.add(t81.a(17, -1007845, -1996271, R.drawable.settings_ask, LocaleController.getString(R.string.AskAQuestion), null, null));
        arrayList.add(t81.a(18, -14965523, -15431455, R.drawable.settings_faq, LocaleController.getString(R.string.TelegramFAQ), null, null));
        arrayList.add(t81.a(23, -3903756, -6335009, R.drawable.settings_features, LocaleController.getString(R.string.TelegramFeatures), null, null));
        arrayList.add(t81.a(19, -11154873, -14175180, R.drawable.settings_policy, LocaleController.getString(R.string.PrivacyPolicy), null, null));
        if (BuildVars.LOGS_ENABLED || BuildVars.DEBUG_PRIVATE_VERSION) {
            arrayList.add(org.telegram.ui.Components.h51.B(null));
            com.google.android.gms.internal.vision.e2.n(R.string.SettingsDebug, arrayList);
            arrayList.add(t81.a(20, -11154873, -14175180, 0, LocaleController.getString(R.string.DebugSendLogs), null, null));
            arrayList.add(t81.a(21, -11154873, -14175180, 0, LocaleController.getString(R.string.DebugSendLastLogs), null, null));
            arrayList.add(t81.a(22, -765355, -2148011, 0, LocaleController.getString(R.string.DebugClearLogs), null, null));
        }
        arrayList.add(org.telegram.ui.Components.h51.l(x81Var.L));
    }

    public static /* synthetic */ void c0(x81 x81Var, TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        x81Var.U = -1;
        if (tL_error == null) {
            TLRPC.User user = x81Var.getMessagesController().getUser(Long.valueOf(x81Var.getUserConfig().getClientUserId()));
            if (user == null) {
                user = x81Var.getUserConfig().getCurrentUser();
                if (user == null) {
                    return;
                } else {
                    x81Var.getMessagesController().putUser(user, false);
                }
            } else {
                x81Var.getUserConfig().setCurrentUser(user);
            }
            ...
            if (closestPhotoSizeWithSize != null && x81Var.v != null) {
                FileLoader.getInstance(x81Var.currentAccount).getPathToAttach(x81Var.v, true).renameTo(FileLoader.getInstance(x81Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize, true));
                StringBuilder sb2 = new StringBuilder();
                sb2.append(x81Var.v.volume_id);
                sb2.append("_");
                String o9 = a4.a.o(x81Var.v.local_id, "@90_90", sb2);
                StringBuilder sb3 = new StringBuilder();
                sb3.append(closestPhotoSizeWithSize.location.volume_id);
                sb3.append("_");
                ImageLoader.getInstance().replaceImageInCache(o9, a4.a.o(closestPhotoSizeWithSize.location.local_id, "@90_90", sb3), ImageLocation.getForUserOrChat(x81Var.currentAccount, user, 1), false);
            }
            if (closestVideoSizeWithSize != null && str != null) {
                new File(str).renameTo(FileLoader.getInstance(x81Var.currentAccount).getPathToAttach(closestVideoSizeWithSize, "mp4", true));
            } else if (closestPhotoSizeWithSize2 != null && x81Var.w != null) {
                FileLoader.getInstance(x81Var.currentAccount).getPathToAttach(x81Var.w, true).renameTo(FileLoader.getInstance(x81Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize2, true));
            }
            x81Var.getMessagesController().getDialogPhotos(user.id).addPhotoAtStart(tL_photos_photo.photo);
            ArrayList arrayList2 = new ArrayList();
            arrayList2.add(user);
            x81Var.getMessagesStorage().putUsersAndChats(arrayList2, null, false, true);
            TLRPC.UserFull userFull = x81Var.getMessagesController().getUserFull(x81Var.getUserConfig().getClientUserId());
            if (userFull != null) {
                userFull.profile_photo = tL_photos_photo.photo;
                x81Var.getMessagesStorage().updateUserInfo(userFull, false);
            }
            x81Var.m0(user);
        }
        x81Var.v = null;
        x81Var.w = null;
        x81Var.n0(false, true);
        x81Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.updateInterfaces, Integer.valueOf(MessagesController.UPDATE_MASK_ALL));
        x81Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.mainUserInfoChanged, new Object[0]);
        x81Var.getUserConfig().saveConfig(true);
    }

    public static void d0(x81 x81Var, int i10) {
        long j3;
        Long l4;
        int i11 = 1;
        int i12 = 0;
        if (i10 == 0) {
            x81Var.getUserConfig().syncContacts = true;
            x81Var.getUserConfig().saveConfig(false);
            x81Var.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            x81Var.getContactsController().loadContacts(false, 0L);
            return;
        }
        if (i10 == 2) {
            x81Var.getContactsController().resetImportedContacts();
            return;
        }
        if (i10 == 3) {
            x81Var.getMessagesController().forceResetDialogs();
            return;
        }
        if (i10 == 4) {
        ...
        if (i10 == 6) {
            x81Var.getMessagesStorage().clearSentMedia();
            SharedConfig.setNoSoundHintShowed(false);
            org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(org.telegram.messenger.z0.d(MessagesController.getGlobalMainSettings().edit().remove("archivehint").remove("proximityhint").remove("archivehint_l"), "searchpostsnew", "speedhint", "gifhint", "reminderhint"), "soundHint", "themehint", "bganimationhint", "filterhint"), "n_0", "storyprvhint", "storyhint", "storyhint2"), "storydualhint", "storysvddualhint", "stories_camera", "dualcam"), "dualmatrix", "dual_available", "archivehint", "askNotificationsAfter"), "askNotificationsDuration", "viewoncehint", "voicepausehint", "taptostorysoundhint"), "nothanos", "voiceoncehint", "savedhint", "savedsearchhint"), "savedsearchtaghint", "newppsms", "monetizationadshint", "seekSpeedHintShowed"), "unsupport_video/av01", "statusgiftpage", "multistorieshint", "trimvoicehint"), "taptostoryhighlighthint", "proxycheckstatusip", "callmiconstart", "showchattagsinfo").remove("language_showed2").remove("aihintshown").remove("savedmsgschatshint").apply();
            w7.w5.a();
            SharedPrefsHelper.cleanupAccount(x81Var.currentAccount);
            MessagesController.getEmojiSettings(x81Var.currentAccount).edit().remove("featured_hidden").remove("emoji_featured_hidden").commit();
            ...
            ChatThemeController.getInstance(x81Var.currentAccount).clearCache();
            x81Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            x31.W();
            pg.t0.e(x81Var.currentAccount).a();
            SharedPreferences mainSettings = x81Var.getMessagesController().getMainSettings();
            SharedPreferences.Editor edit = mainSettings.edit();
            org.telegram.messenger.z0.d(edit, "peerColors", "profilePeerColors", "boostingappearance", "bizbothint").remove("movecaptionhint");
            ...
            edit.apply();
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(x81Var.currentAccount).edit();
            for (String str2 : MessagesController.getNotificationsSettings(x81Var.currentAccount).getAll().keySet()) {
        ...
        if (i10 == 7) {
            org.telegram.ui.Components.voip.f2.i(x81Var.getParentActivity());
            return;
        }
        if (i10 == 8) {
        ...
        if (i10 == 9) {
            ((LaunchActivity) x81Var.getParentActivity()).z(true);
            return;
        }
        if (i10 == 10) {
            x81Var.getMessagesStorage().readAllDialogs(-1);
            return;
        }
        if (i10 == 11) {
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(x81Var.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
                SharedConfig.toggleForceDisableTabletMode();
                Activity parentActivity = x81Var.getParentActivity();
            ...
            if (i10 == 18) {
                w7.x.a((LaunchActivity) x81Var.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
                x81Var.getMessagesController().loadAppConfig();
                TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                x81Var.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new m81(x81Var, i12));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                ...
                if (i10 == 23) {
                    boolean q6 = ci.d1.q(x81Var.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Toast.makeText(x81Var.getParentActivity(), LocaleController.getString(!q6 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i12 < x81Var.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.n2) x81Var.getParentLayout().getFragmentStack().get(i12)).clearSheets();
                        i12++;
                    }
                    return;
                }
                ...
                if (i10 == 27) {
                    x81Var.getMediaDataController().loadAttachMenuBots(false, true);
                    return;
                }
                if (i10 == 28) {
                    SharedConfig.toggleUseCamera2(x81Var.currentAccount);
                    return;
                }
                if (i10 == 29) {
                    ei.r.b();
                ...
                if (i10 == 35) {
                    MessagesController.getInstance(x81Var.currentAccount).loadAppConfig(true);
                    return;
                }
                if (i10 == 36) {
            ...
            x81Var.showDialog(new q81(x81Var, x81Var.getParentActivity(), sb3.toString()));
        } catch (Exception unused) {
        }
    }

    public static /* synthetic */ void e0(x81 x81Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            TLRPC.FileLocation fileLocation = photoSize.location;
            x81Var.v = fileLocation;
            x81Var.w = photoSize2.location;
            x81Var.F.h(ImageLocation.getForLocal(fileLocation), "90_90", x81Var.E, null);
            x81Var.n0(true, false);
        } else {
            if (x81Var.v == null) {
                return;
            }
            ...
            x81Var.U = x81Var.getConnectionsManager().sendRequest(tL_photos_uploadProfilePhoto, new wb0(22, x81Var, str));
        }
        x81Var.actionBar.n().requestLayout();
    }

    public static void f0(x81 x81Var, org.telegram.ui.Components.h51 h51Var) {
        Object obj = h51Var.G;
        if (obj instanceof TLRPC.TL_attachMenuBot) {
            TLRPC.TL_attachMenuBot tL_attachMenuBot = (TLRPC.TL_attachMenuBot) obj;
            if (tL_attachMenuBot.inactive || tL_attachMenuBot.side_menu_disclaimer_needed) {
                ej1.a(x81Var.getParentActivity(), new dt(17, x81Var, tL_attachMenuBot), null);
                return;
            } else {
                LaunchActivity.C0(LaunchActivity.G1, x81Var.currentAccount, tL_attachMenuBot, null, true);
            }
        ...
        if (h51Var.G(org.telegram.ui.Cells.v6.class)) {
            ...
            if (obj2 instanceof b11) {
                b11 b11Var = (b11) obj2;
                org.telegram.ui.ActionBar.c5 parentLayout = x81Var.getParentLayout();
                b11Var.b.run();
                AndroidUtilities.scrollToFragmentRow(parentLayout, b11Var.c);
            } else if (obj2 instanceof MessagesController.FaqSearchResult) {
                NotificationCenter.getInstance(x81Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.openArticle, x81Var.h.E, ((MessagesController.FaqSearchResult) obj2).url);
            }
        ...
        switch (h51Var.d) {
            case 1:
                x81Var.l0(new UserInfoActivity());
                break;
            case 2:
                x81Var.l0(new ThemeActivity(0));
                break;
            case 3:
                x81Var.l0(new PrivacySettingsActivity());
                break;
            case 5:
                x81Var.l0(new NotificationsSettingsActivity());
                break;
            case 6:
                x81Var.l0(new DataSettingsActivity());
                break;
            case 7:
                x81Var.l0(new FiltersSetupActivity());
                break;
            case 8:
                x81Var.l0(new SessionsActivity(0));
                break;
            case 9:
                x81Var.l0(new ic0());
                break;
            case 10:
                x81Var.l0(new LanguageSelectActivity());
                break;
            case 11:
                x81Var.l0(new PremiumPreviewFragment(0, "settings"));
                break;
            case 12:
                x81Var.l0(new yh.w7());
                break;
            case 13:
                ...
                break;
            case 15:
                x81Var.l0(new PremiumPreviewFragment(1, "settings"));
                break;
            case 16:
                tg.n1.e0(0, BirthdayController.getInstance(UserConfig.selectedAccount).getState());
                break;
            case 17:
                x81Var.showDialog(org.telegram.ui.Components.e5.U(x81Var, x81Var.resourceProvider));
                break;
            case 18:
                nf.f.s(x81Var.getParentActivity(), LocaleController.getString(R.string.TelegramFaqUrl));
                break;
            case 19:
                nf.f.s(x81Var.getParentActivity(), LocaleController.getString(R.string.PrivacyPolicyUrl));
                break;
            case 20:
                ProfileActivity.H4(x81Var.getParentActivity(), false);
                break;
            case 21:
                ProfileActivity.H4(x81Var.getParentActivity(), true);
                break;
            case 22:
                FileLog.cleanupLogs();
                break;
            case 23:
                if (!MessagesController.getInstance(x81Var.currentAccount).isFrozen()) {
                    nf.f.s(x81Var.getParentActivity(), LocaleController.getString(R.string.TelegramFeaturesUrl));
                    break;
                } else {
                    b.b(x81Var.currentAccount);
                    break;
                }
        }
    }
    ...
    public final View createView(Context context) {
        ...
        int i10 = 0;
        this.actionBar.setActionBarMenuOnItemClick(new o81(this, i10));
        ...
        p81 p81Var = new p81(this, this, context);
        this.h = p81Var;
        p81Var.G();
        org.telegram.ui.Components.d61 d61Var = new org.telegram.ui.Components.d61(this, new c5(this, 26), new n81(this), new n81(this));
        this.c = d61Var;
        d61Var.Y2.r = false;
        d61Var.p1();
        ...
        this.Y = new ah.n(d61Var2, w8Var, new v8(d61Var2, i10));
        this.c.C0(new k81(this, 2));
        ...
        this.y.setOnClickListener(new l81(this, 5));
        w7.z5.a(this.y);
        ...
        this.G = frameLayout2;
        frameLayout2.setBackground(org.telegram.ui.ActionBar.h6.K(AndroidUtilities.dp(32.0f), getThemedColor(org.telegram.ui.ActionBar.h6.a7)));
        ...
        this.L.setOnClickListener(new l81(this, 6));
    ...
    public final void j0() {
        ...
        le.c cVar = this.a;
        org.telegram.ui.Components.z10.d(v0Var, 1.0f - cVar.e);
    ...
    public final void n0(boolean z10, boolean z11) {
        ...
        this.r.addListener(new e70(9, this, z10));
        this.r.start();
    }
    ...
    */
    public final void o0(boolean z10, boolean z11) {
        ...
        if (q0Var == null || q0Var.getTag() == null) {
            ...
            if (this.P == z12 || z10) {
                ...
                this.Q = ofFloat;
                ofFloat.addUpdateListener(new s11(this, 11));
    ...
    public final void p0() {
        ...
        this.b.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.a7));
        this.J.setTextColor(getThemedColor(i10));
        this.K.setTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.y6));
        this.e.N();
