...
public final class wh0 extends FrameLayout {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            SpannableStringBuilder X0 = yh.v7.X0(false, org.telegram.messenger.q.i(tL_chatInviteExported.subscription_pricing.amount, ',', new StringBuilder("⭐️ ")), 0.75f, null);
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        z10 = ((org.telegram.ui.ActionBar.n2) zh0Var).isPaused;
        if (!z10) {
            invalidate();
        }
        this.F = f14;
