    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.a) {
            case 0:
                ...
                float min = Math.min(1.0f, Math.max(0.0f, (SystemClock.elapsedRealtime() - v9Var.H) / 75.0f));
                if (min < 1.0f) {
        ...
        switch (this.a) {
            case 0:
                ...
                if (i16 == 0) {
                    ...
                    if (i16 == 3) {
                        int C = org.telegram.messenger.y3.C(8.0f, v9Var.a.getMeasuredHeight(), i18);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            case 0:
                ...
                v9Var.a.measure(b.d(72.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                if (i12 == 3) {
                    v9Var.b.measure(b.d(72.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                } else {
