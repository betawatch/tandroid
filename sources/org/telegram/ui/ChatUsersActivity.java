    ...
    */
    ...
    public boolean createMenuForParticipant(final TLObject tLObject, boolean z, View view) {
        ...
        if (this.type == 2) {
            ...
            addIf.addIf(z12, i5, (CharSequence) LocaleController.getString(str3, i3), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
