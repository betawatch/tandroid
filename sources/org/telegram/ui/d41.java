...
public abstract class d41 extends FrameLayout {
    ...
    public static void f(org.telegram.ui.ActionBar.m2 m2Var, org.telegram.ui.ActionBar.m2 m2Var2, float f7) {
        ...
        int measuredWidth = m2Var != null ? m2Var.getFragmentView().getMeasuredWidth() : m2Var2.getFragmentView().getMeasuredWidth();
        if (m2Var != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        this.P.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.w8, false));
        if (max == 1.0f) {
            canvas.save();
        } else {
    ...
    public void setTransitionPaddingBottom(int i10) {
        ...
        if (com.google.android.gms.internal.vision.e2.u(rxVar)) {
            float f7 = i10;
            rxVar.X0 = f7;
            rxVar.h.setTranslationY(((-f7) - rxVar.e1) - rxVar.d1);
        }
    }
