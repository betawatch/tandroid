    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (((e41) arrayList.get(i10)).a != 7) {
            ...
            if (((e41) arrayList.get(i10)).a == 2) {
                ...
                vaVar.d(userOrChat, str, dialogException.createDescription(i11), i10 == arrayList.size() - 1 || ((e41) arrayList.get(i10 + 1)).a == 2);
                return;
            }
            return;
        }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                linearLayout.addView(ko0Var, k7.c6.t(-1, 38, 0, 5, 0, 5, 4));
                long j10 = saveToGallerySettingsActivity.X().limitVideo;
                ...
                ko0Var.setProgress(((float) j10) > ((float) SaveToGallerySettingsHelper.DEFAULT_VIDEO_LIMIT) * 0.7f ? w.c.c(j10 - SaveToGallerySettingsHelper.DEFAULT_VIDEO_LIMIT, 4089446400L, 0.3f, 0.7f) : ((j10 - 524288) / 104333312) * 0.7f);
                ko0Var.w.X(ko0Var.getProgress(), false);
