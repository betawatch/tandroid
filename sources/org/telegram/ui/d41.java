...
public final class d41 extends org.telegram.ui.Cells.s1 {
        ...
        if (paint != null) {
            ...
            if (f9 > 0.0f) {
                if (f41Var.M) {
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Le.e(f41Var.M), 1.0f - f41Var.s));
    ...
    public final void d2(Canvas canvas, float f9, Integer num) {
        ...
        int i10 = -this.J.c;
        f41 f41Var = this.Oe;
        canvas.translate(AndroidUtilities.lerp(0, i10, f41Var.s), AndroidUtilities.lerp(f41Var.K.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), r0.p, f41Var.s));
        super.d2(canvas, (1.0f - f41Var.s) * f9, num);
        canvas.restore();
    }
    ...
    public final void m2(float f9, Canvas canvas, boolean z10) {
        ...
        if (f41Var.O) {
            ...
            canvas.translate(((this.De.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.nb) * f41Var.s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, f41Var.s, rectF);
            U3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (f41Var.s <= 0.0f || !f41Var.M) {
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            }
            this.re = 1.0f - f41Var.s;
        } else {
            canvas2 = canvas;
        }
        S1(canvas2);
        if (f41Var.O && f41Var.s > 0.0f && f41Var.M) {
            canvas2.restore();
        }
    }
