...
public final class hu0 implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        ...
        fv0 fv0Var = this.d;
        int abs = (int) Math.abs(this.c - fv0Var.a.getImageX());
        float imageY = fv0Var.a.getImageY();
        float f14 = this.e;
        int abs2 = (int) Math.abs(f14 - imageY);
        if (fv0Var.a.isAspectFit()) {
            abs = 0;
        }
        int[] iArr = new int[2];
        fv0Var.d.getLocationInWindow(iArr);
        float f15 = fv0Var.c + f14;
        int i11 = (int) ((iArr[1] - f15) + fv0Var.j);
        if (i11 < 0) {
            i11 = 0;
        }
        int height = (int) (((f15 + layoutParams.height) - (fv0Var.d.getHeight() + r10)) + fv0Var.i);
        if (height < 0) {
            height = 0;
        }
        ...
        i90 i90Var = new i90(this, clippingImageViewArr, this.h, this.n, this.f, 15);
        photoViewer.p4 = i90Var;
        if (photoViewer.l2) {
            i90Var.run();
            photoViewer.p4 = null;
            ...
            arrayList.add(ObjectAnimator.ofFloat(xu0Var, (Property<xu0, Float>) property, 0.0f, 1.0f));
