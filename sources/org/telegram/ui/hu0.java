...
public abstract class hu0 extends NestedScrollView {
    ...
    public hu0(Context context, ku0 ku0Var, FrameLayout frameLayout) {
        super(context);
        ...
        o1.k kVar = new o1.k(ku0Var, o1.h.n, 0.0f);
        this.a0 = kVar;
        kVar.u.b(100.0f);
        kVar.j = 1.0f;
        kVar.b(new od0(this, i10));
    ...
    */
    public final void H(int i10, int i11) {
        ...
        if (i10 != 0 && i11 != 0) {
            ku0 ku0Var = this.n0;
            TextView currentView = ku0Var.getCurrentView();
