...
public final class gg1 implements org.telegram.ui.Components.kl0 {
    ...
    public final void d(int i10, View view) {
        ...
        if (((ig1) arrayList.get(i10)).a == 1) {
            Bundle bundle = new Bundle();
            bundle.putLong("chat_id", -jg1Var.c);
