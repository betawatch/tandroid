...
public final class u41 extends org.telegram.ui.Cells.t1 {
        ...
        if (paint != null) {
            ...
            if (f10 > 0.0f) {
                if (w41Var.N) {
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Me.e(w41Var.N), 1.0f - w41Var.s));
    ...
    public final void d2(Canvas canvas, float f10, Integer num) {
        ...
        int i10 = -this.K.c;
        w41 w41Var = this.Pe;
        canvas.translate(AndroidUtilities.lerp(0, i10, w41Var.s), AndroidUtilities.lerp(w41Var.L.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), r0.p, w41Var.s));
        super.d2(canvas, (1.0f - w41Var.s) * f10, num);
        canvas.restore();
    }
    ...
    public final void m2(float f10, Canvas canvas, boolean z4) {
        ...
        if (w41Var.P) {
            ...
            canvas.translate(((this.Ee.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.ob) * w41Var.s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z4) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, w41Var.s, rectF);
            U3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (w41Var.s <= 0.0f || !w41Var.N) {
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            }
            this.se = 1.0f - w41Var.s;
        } else {
            canvas2 = canvas;
        }
        S1(canvas2);
        if (w41Var.P && w41Var.s > 0.0f && w41Var.N) {
            canvas2.restore();
        }
    }
