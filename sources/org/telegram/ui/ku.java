...
public final class ku extends FrameLayout {
    ...
    public ku(vu vuVar, Context context) {
        super(context);
        setBackgroundColor(vuVar.getThemedColor(org.telegram.ui.ActionBar.h6.d6));
        ...
        textView.setTextColor(vuVar.getThemedColor(i10));
        ...
        imageView2.setColorFilter(new PorterDuffColorFilter(vuVar.getThemedColor(i10), PorterDuff.Mode.MULTIPLY));
        ...
        textView2.setTextColor(vuVar.getThemedColor(org.telegram.ui.ActionBar.h6.o6));
