    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i10 >= i12 && i10 < premiumPreviewFragment.r) {
            ((nw0) view).a((dx0) premiumPreviewFragment.b.get(i10 - i12), i10 != premiumPreviewFragment.r - 1);
            return;
        }
        int i13 = premiumPreviewFragment.v;
        if (i10 >= i13 && i10 < premiumPreviewFragment.w) {
            ((nw0) view).a((dx0) premiumPreviewFragment.c.get(i10 - i13), i10 != premiumPreviewFragment.w - 1);
            return;
        }
        String str3 = "";
        ...
        if (!z10) {
            f9Var2.setTextColor(org.telegram.ui.ActionBar.h6.l1(0.75f, -1));
            f9Var2.getTextView().setLinkTextColor(-1);
            f9Var2.setLinkTextRippleColor(Integer.valueOf(org.telegram.ui.ActionBar.h6.l1(0.15f, -1)));
        }
        f9Var2.setFixedSize(0);
        if (i10 == premiumPreviewFragment.H) {
            f9Var2.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ShowAdsInfo), new jl0(this, 23)), true));
            return;
        }
        ...
        while (i15 < length) {
            ...
            if (messageEntity2 instanceof TLRPC.TL_messageEntityBotCommand) {
                ...
                if ((messageEntity2 instanceof TLRPC.TL_messageEntityHashtag) || (messageEntity2 instanceof TLRPC.TL_messageEntityMention) || (messageEntity2 instanceof TLRPC.TL_messageEntityCashtag)) {
                    ...
                    spannableString.setSpan(new org.telegram.ui.Components.n51(org.telegram.ui.Cells.q3.i("mailto:", str), n01Var), n01Var.b, n01Var.c, 33);
                    ...
                    spannableString.setSpan(new org.telegram.ui.Components.l51(org.telegram.ui.Cells.q3.i("card:", str), n01Var), n01Var.b, n01Var.c, 33);
                } else if (messageEntity2 instanceof TLRPC.TL_messageEntityPhone) {
                    String d = gf.b.d(str, z11);
                    if (str.startsWith("+")) {
                        d = org.telegram.ui.Cells.q3.i("+", d);
                    }
                    spannableString.setSpan(new org.telegram.ui.Components.j51(org.telegram.ui.Cells.q3.i("tel:", d), n01Var), n01Var.b, n01Var.c, 33);
