...
public abstract class ba1 extends FrameLayout {
    ...
    public ba1(Context context, int i10, ig.f fVar, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        final int i11 = 0;
        cVar.d.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.x91
        ...
        this.b.setDateSelectionListener(new nl0(this, 19));
        this.b.t0.d(false, false);
        this.b.t0.setOnTouchListener(new org.telegram.ui.Components.vk0());
        final int i13 = 1;
        this.b.t0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.x91
            public final /* synthetic */ ba1 b;
        ...
        final int i14 = 2;
        this.c.t0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.x91
            public final /* synthetic */ ba1 b;
    ...
    public final ValueAnimator a(long j3, boolean z10) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.y91
    ...
    public final void d() {
        ...
        if (da1Var != null && (bVar = da1Var.d) != null && (arrayList = bVar.d) != null && arrayList.size() > 1) {
            for (int i10 = 0; i10 < this.r.d.d.size(); i10++) {
                ...
                if (i10 < arrayList2.size()) {
                    org.telegram.ui.Components.t00 t00Var = ((aa1) arrayList2.get(i10)).a;
                    t00Var.getClass();
        ...
        this.e.setProgressColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.h6, false));
        this.f.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.s5, false));
    }
    ...
    public final void e(da1 da1Var, boolean z10) {
        ...
        kg.e eVar = gVar.t0;
        boolean z13 = da1Var.n;
        eVar.a = z13;
        cVar.c(!z13);
        if (da1Var.d == null && da1Var.f != null) {
        ...
        cVar.setUseWeekInterval(da1Var.o);
        gVar.t0.setUseWeek(da1Var.o);
        kg.e eVar2 = gVar.t0;
        ...
        if (size > 1) {
            for (int i10 = 0; i10 < size; i10++) {
                ...
                t00Var.setOnTouchListener(new org.telegram.ui.Components.vk0());
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (((jg.a) bVar.d.get(i12)).c.equals(((jg.a) this.r.d.d.get(i10)).c)) {
                        boolean z12 = ((aa1) arrayList.get(i10)).a.b;
                        ((kg.f) arrayList2.get(i12)).n = z12;
                        ((kg.f) arrayList2.get(i12)).o = z12 ? 1.0f : 0.0f;
                        ((aa1) arrayList.get(i10)).a.c = true;
                        ((aa1) arrayList.get(i10)).a.animate().alpha(1.0f).start();
                        if (z12) {
                            i11++;
                        }
                        z11 = true;
                ...
                if (!z11) {
                    ((aa1) arrayList.get(i10)).a.c = false;
                    ((aa1) arrayList.get(i10)).a.animate().alpha(0.0f).start();
                }
                i10++;
            }
            if (i11 == 0) {
                for (int i13 = 0; i13 < this.r.d.d.size(); i13++) {
                    ((aa1) arrayList.get(i13)).a.c = true;
                    ((aa1) arrayList.get(i13)).a.animate().alpha(1.0f).start();
                }
                return;
            }
        }
    ...
    public final void h(boolean z10) {
        jg.b bVar;
        da1 da1Var = this.r;
        if (da1Var == null || (bVar = da1Var.d) == null || bVar.a == null) {
            return;
        }
        kg.c cVar = this.d;
        ...
        if (z10) {
            ...
            while (i10 < size) {
                ...
                i10++;
                aa1 aa1Var = (aa1) obj;
                aa1Var.a.animate().alpha(1.0f).start();
                aa1Var.a.c = true;
            }
            a2.start();
            return;
