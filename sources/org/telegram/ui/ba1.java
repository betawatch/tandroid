...
public final class ba1 extends LinearLayout {
    ...
    public final void b() {
        ...
        while (true) {
            ...
            this.c[i10].setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.z6, false));
    ...
    public void setData(da1 da1Var) {
        TextView[] textViewArr = this.a;
        textViewArr[0].setText(da1Var.b);
        textViewArr[1].setText(da1Var.f);
        textViewArr[2].setText(da1Var.j);
        textViewArr[3].setText(da1Var.n);
        TextView[] textViewArr2 = this.b;
        textViewArr2[0].setText(da1Var.c);
        textViewArr2[0].setTag(Integer.valueOf(da1Var.d ? org.telegram.ui.ActionBar.k6.x6 : org.telegram.ui.ActionBar.k6.p7));
        textViewArr2[1].setText(da1Var.g);
        textViewArr2[1].setTag(Integer.valueOf(da1Var.h ? org.telegram.ui.ActionBar.k6.x6 : org.telegram.ui.ActionBar.k6.p7));
        textViewArr2[2].setText(da1Var.k);
        textViewArr2[2].setTag(Integer.valueOf(da1Var.l ? org.telegram.ui.ActionBar.k6.x6 : org.telegram.ui.ActionBar.k6.p7));
        textViewArr2[3].setText(da1Var.o);
        textViewArr2[3].setTag(Integer.valueOf(da1Var.p ? org.telegram.ui.ActionBar.k6.x6 : org.telegram.ui.ActionBar.k6.p7));
        TextView[] textViewArr3 = this.c;
        textViewArr3[0].setText(da1Var.a);
        textViewArr3[1].setText(da1Var.e);
        textViewArr3[2].setText(da1Var.i);
        textViewArr3[3].setText(da1Var.m);
        b();
    }
}
