...
public final class uq0 extends org.telegram.ui.Components.qv0 {
    ...
    public boolean x0;
    public int y0;
    public final /* synthetic */ cr0 z0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public uq0(cr0 cr0Var, Context context) {
        super(context, null);
        this.z0 = cr0Var;
    }
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int emojiPadding = (cr0Var.d0 == null || cr0Var.Z.getParent() != this || AndroidUtilities.dp(20.0f) < 0 || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : cr0Var.d0.getEmojiPadding();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.x0 = true;
        int dp = ((size2 - AndroidUtilities.dp(4.0f)) - AndroidUtilities.dp(4.0f)) / cr0Var.g0;
        cr0Var.R = dp;
        if (this.y0 != dp) {
            this.y0 = dp;
            AndroidUtilities.runOnUIThread(new sl0(this, 12));
        }
        if (cr0Var.Y) {
            cr0Var.M.y1(1);
        } else {
            cr0Var.M.y1(Math.max(1, ((cr0Var.g0 - 1) * AndroidUtilities.dp(2.0f)) + (cr0Var.R * cr0Var.g0)));
        }
        this.x0 = false;
        ...
        int R = R();
        if (AndroidUtilities.dp(20.0f) >= 0 && !AndroidUtilities.isInMultiwindow && cr0Var.d0 != null && cr0Var.Z.getParent() == this) {
            size4 -= cr0Var.d0.getEmojiPadding();
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size4, TLObject.FLAG_30);
        }
        int i12 = size4;
        int i13 = makeMeasureSpec;
        if (R > AndroidUtilities.dp(20.0f) && (juVar = cr0Var.d0) != null) {
            this.x0 = true;
            juVar.j();
            this.x0 = false;
        }
        ...
        if (juVar2 != null && juVar2.e) {
            cr0Var.fragmentView.setTranslationY(0.0f);
            cr0Var.K.setTranslationY(0.0f);
            cr0Var.N.setTranslationY(0.0f);
        }
        int childCount = getChildCount();
        for (int i14 = 0; i14 < childCount; i14++) {
            View childAt = getChildAt(i14);
            if (childAt != null && childAt.getVisibility() != 8) {
                org.telegram.ui.Components.ju juVar3 = cr0Var.d0;
