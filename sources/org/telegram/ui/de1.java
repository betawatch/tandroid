...
public final class de1 extends org.telegram.ui.Components.zu0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (we1Var.isInPreviewMode()) {
            int themedColor = we1Var.getThemedColor(org.telegram.ui.ActionBar.g6.d6);
            Paint paint = this.t0;
        ...
        if (we1Var.I0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, we1Var.getThemedColor(org.telegram.ui.ActionBar.g6.d6), we1Var.a1);
        }
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view == kVar && !we1Var.isInPreviewMode()) {
            kVar2 = ((org.telegram.ui.ActionBar.n2) we1Var).actionBar;
            float y10 = kVar2.getY();
            kVar3 = ((org.telegram.ui.ActionBar.n2) we1Var).actionBar;
            ...
            if (f10 > 0.0f) {
                if (f10 < 1.0f) {
                    ...
                    org.telegram.ui.ActionBar.g6.k0.setAlpha((int) (alpha * we1Var.S));
                    ...
                    canvas.drawLine(0.0f, f12, getMeasuredWidth(), f12, org.telegram.ui.ActionBar.g6.k0);
                }
            }
        }
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z71Var != null) {
            ...
            we1Var.k0.setPadding(0, 0, 0, i13);
            this.s0 = false;
        }
        int i14 = 0;
