...
public class kq extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public kq(long j3, long j10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, TLRPC.TL_chatBannedRights tL_chatBannedRights2, String str, int i10, boolean z10, boolean z11, String str2) {
        super(null);
        boolean z12;
    ...
    public static void U(kq kqVar, long j3) {
        if (j3 != 0) {
            kqVar.s = j3;
            kqVar.w = MessagesController.getInstance(kqVar.currentAccount).getChat(Long.valueOf(j3));
            kqVar.r0(true);
        }
    }

    public static void V(final kq kqVar, org.telegram.ui.ActionBar.z2 z2Var, View view) {
        Runnable runnable;
        int intValue = ((Integer) view.getTag()).intValue();
        if (intValue == 0) {
            kqVar.O.until_date = 0;
            kqVar.a.m(kqVar.M0);
        } else if (intValue == 1) {
            kqVar.O.until_date = ConnectionsManager.getInstance(kqVar.currentAccount).getCurrentTime() + 86400;
            kqVar.a.m(kqVar.M0);
        } else if (intValue == 2) {
            kqVar.O.until_date = ConnectionsManager.getInstance(kqVar.currentAccount).getCurrentTime() + 604800;
            kqVar.a.m(kqVar.M0);
        } else if (intValue == 3) {
            kqVar.O.until_date = ConnectionsManager.getInstance(kqVar.currentAccount).getCurrentTime() + 2592000;
            kqVar.a.m(kqVar.M0);
        } else if (intValue == 4) {
                        ...
                        try {
                            TimePickerDialog timePickerDialog = new TimePickerDialog(kqVar2.getParentActivity(), new TimePickerDialog.OnTimeSetListener() { // from class: org.telegram.ui.gq
                                ...
                                public final void onTimeSet(TimePicker timePicker, int i13, int i14) {
                                    kq kqVar3 = kq.this;
                                    kqVar3.O.until_date = (i14 * 60) + (i13 * 3600) + time;
                                    kqVar3.a.m(kqVar3.M0);
                                }
                            }, 0, 0, true);
    ...
    public static /* synthetic */ boolean W(kq kqVar, TLRPC.TL_error tL_error) {
        ...
        if (!ChatObject.isChannel(kqVar.w)) {
            rg.j0 j0Var = new rg.j0(11, kqVar.currentAccount, kqVar.getParentActivity(), kqVar, kqVar.getResourceProvider());
            ArrayList arrayList = new ArrayList();
            arrayList.add(kqVar.v);
            j0Var.I1(kqVar.w, arrayList, null, null, null);
            j0Var.show();
        }
        return false;
    }
    ...
    */
    public static void X(kq kqVar, Context context, View view, int i10) {
        ...
        TLRPC.TL_chatBannedRights tL_chatBannedRights2 = kqVar.P;
        int i11 = kqVar.y;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = kqVar.M;
        if (kqVar.I || (kqVar.w.creator && i11 == 0 && i10 == kqVar.e0)) {
            boolean z15 = false;
            if (i10 == kqVar.z0) {
                if (!(view instanceof org.telegram.ui.Cells.v8) || ((org.telegram.ui.Cells.v8) view).isEnabled()) {
                    ...
                    kqVar.a.m(kqVar.z0);
                    if (kqVar.A0) {
                        kqVar.a.s(kqVar.z0 + 1, 10);
                        return;
                    } else {
                        kqVar.a.t(kqVar.z0 + 1, 10);
                        return;
                    }
                }
                return;
            ...
            if (i10 == i12) {
                if (!(view instanceof org.telegram.ui.Cells.v8) || ((org.telegram.ui.Cells.v8) view).isEnabled()) {
                    ...
                    kqVar.a.m(kqVar.N0);
                    if (kqVar.O0) {
                        kqVar.a.s(kqVar.N0 + 1, 3);
                        return;
                    } else {
                        kqVar.a.t(kqVar.N0 + 1, 3);
                        return;
                    }
                }
                return;
            ...
            if (i10 == i13) {
                if (!(view instanceof org.telegram.ui.Cells.v8) || ((org.telegram.ui.Cells.v8) view).isEnabled()) {
                    ...
                    kqVar.a.m(kqVar.S0);
                    if (kqVar.T0) {
                        kqVar.a.s(kqVar.S0 + 1, 3);
                        return;
                    } else {
                        kqVar.a.t(kqVar.S0 + 1, 3);
                        return;
                    }
                }
                return;
            ...
            if (i10 == kqVar.p0) {
                if (i11 == 0) {
                    MessagesController.getInstance(kqVar.currentAccount).setUserAdminRole(kqVar.s, kqVar.v, new TLRPC.TL_chatAdminRights(), kqVar.S, kqVar.E, kqVar.getFragmentForAlert(0), kqVar.Z0, false, null, null);
                    hq hqVar = kqVar.X0;
                    if (hqVar != null) {
                        hqVar.b(0, tL_chatAdminRights, kqVar.O, kqVar.S);
                    }
            ...
            if (i10 == kqVar.M0) {
                ...
                for (int i16 = 5; i15 < i16; i16 = 5) {
                    ...
                    x2VarArr[i15].setBackgroundDrawable(org.telegram.ui.ActionBar.h6.K0(false));
            ...
            if (view instanceof org.telegram.ui.Cells.a2) {
                ...
                int i18 = kqVar.U0;
                if (i10 == i18 || i10 == kqVar.V0 || i10 == kqVar.W0) {
                    if (i10 == i18) {
                ...
                if (a2Var.r.b != null) {
                    if (i11 != 2) {
                        ...
                        a2Var2.R = string;
                        a2Var2.T = LocaleController.getString(R.string.UserRestrictionsCantModifyDisabled);
                ...
                if (i10 == kqVar.B0) {
                    ...
                    if ((kqVar.O.send_plain || tL_chatBannedRights2.send_plain) && (m10 = kqVar.c.m(kqVar.y0)) != null) {
                        AndroidUtilities.shakeViewSpring(m10);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        TLRPC.TL_chatBannedRights tL_chatBannedRights12 = kqVar.O;
                        z15 = !tL_chatBannedRights12.embed_links;
                        tL_chatBannedRights12.embed_links = z15;
                    }
                } else if (i10 == kqVar.I0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights13 = kqVar.O;
            ...
            if (view instanceof org.telegram.ui.Cells.v8) {
                ...
                if (r12.F != null) {
                    if (i11 != 2) {
                        ...
                        a2Var3.R = string2;
                        a2Var3.T = LocaleController.getString(R.string.UserRestrictionsCantModifyDisabled);
                ...
                if (!v8Var.isEnabled()) {
                    if (i11 == 2 || i11 == 0) {
                        if ((i10 != kqVar.X || tL_chatBannedRights2 == null || tL_chatBannedRights2.change_info) && ((i10 != kqVar.h0 || tL_chatBannedRights2 == null || tL_chatBannedRights2.pin_messages) && (i10 != kqVar.i0 || tL_chatBannedRights2 == null || tL_chatBannedRights2.edit_rank))) {
                            return;
                        }
                        ...
                        org.telegram.ui.ActionBar.a2 a2Var4 = alertDialog$Builder3.a;
                        a2Var4.R = string3;
                        a2Var4.T = LocaleController.getString(R.string.UserRestrictionsCantModifyEnabled);
                ...
                if (i10 == kqVar.W) {
                    z16 = !kqVar.K;
                    kqVar.K = z16;
                    TLRPC.TL_chatAdminRights tL_chatAdminRights2 = kqVar.N;
                    ...
                    while (i19 < childCount) {
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.v8) {
                            ...
                            if (z17) {
                                ...
                                i19++;
                                z15 = false;
                            } else if ((R != kqVar.X || tL_chatBannedRights2.change_info) && ((R != kqVar.h0 || tL_chatBannedRights2.pin_messages) && (R != kqVar.i0 || tL_chatBannedRights2.edit_rank))) {
                                org.telegram.ui.Cells.v8 v8Var3 = (org.telegram.ui.Cells.v8) childAt;
                                v8Var3.setChecked(z15);
                                v8Var3.b(R == kqVar.W, true);
                            } else {
                    ...
                    kqVar.a.l();
                    org.telegram.ui.Components.p6 p6Var = kqVar.f;
                    if (p6Var != null) {
                        ...
                        p6Var.c(sb2.toString(), true, kqVar.K);
                    }
                    ValueAnimator valueAnimator = kqVar.c1;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        kqVar.c1 = null;
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(kqVar.J, kqVar.K ? 1.0f : 0.0f);
                    kqVar.c1 = ofFloat;
                    ofFloat.addUpdateListener(new bq(kqVar, 1));
                    kqVar.c1.setDuration((long) (Math.abs(kqVar.J - (kqVar.K ? 1.0f : 0.0f)) * 200.0f));
                    kqVar.c1.start();
                } else if (i10 == kqVar.X) {
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights14 = kqVar.O;
                    ...
                    org.telegram.ui.Components.e5.v0(kqVar, LocaleController.getString(R.string.ApproveNewMembersTitle), AndroidUtilities.replaceTags(LocaleController.formatString(z16 ? z14 ? R.string.ApproveNewMembersDisabledMessageChannel : R.string.ApproveNewMembersDisabledMessageGroup : z14 ? R.string.ApproveNewMembersMessageChannel : R.string.ApproveNewMembersMessageGroup, DialogObject.getShortName(user))), LocaleController.getString(!z16 ? R.string.ApproveNewMembersEnable : R.string.ApproveNewMembersDisable), false, new aq(kqVar, !z16 ? user.id : 0L, 1));
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights15 = kqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights16 = kqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights17 = kqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights18 = kqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights19 = kqVar.O;
                        z16 = !tL_chatBannedRights19.edit_rank;
                        tL_chatBannedRights19.edit_rank = z16;
                    }
                } else if (i11 == 1 && (tL_chatBannedRights = kqVar.O) != null) {
                    if (i10 == kqVar.y0) {
    ...
    public static void Y(kq kqVar, TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, TLRPC.TL_channels_editCreator tL_channels_editCreator) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            if (inputCheckPasswordSRP == null) {
                ...
                a2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, kqVar.w.title, UserObject.getFirstName(user)));
                alertDialog$Builder.k(LocaleController.getString(R.string.EditAdminTransferChangeOwner), new zp(kqVar, i11));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                kqVar.showDialog(a2Var);
                return;
            }
            return;
        }
        if (!"PASSWORD_MISSING".equals(tL_error.text) && !tL_error.text.startsWith("PASSWORD_TOO_FRESH_") && !tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
            ...
            if (!tL_error.text.equals("CHANNELS_TOO_MUCH")) {
                ...
                org.telegram.ui.Components.e5.h0(tL_error, kqVar, z10, kqVar.F, tL_channels_editCreator);
                return;
            }
            if (kqVar.getParentActivity() == null || AccountInstance.getInstance(kqVar.currentAccount).getUserConfig().isPremium()) {
                kqVar.presentFragment(new le1(1));
                return;
            } else {
                kqVar.showDialog(new rg.j0(5, kqVar.currentAccount, kqVar.getParentActivity(), kqVar, null));
                return;
            }
        }
        if (twoStepVerificationActivity != null) {
        ...
        kqVar.showDialog(a2Var2);
    }

    public static void Z(kq kqVar, long j3) {
    ...
    public static /* synthetic */ void a0(kq kqVar, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, long j3) {
        if (j3 != 0) {
            kqVar.s = j3;
            kqVar.w = MessagesController.getInstance(kqVar.currentAccount).getChat(Long.valueOf(j3));
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new oo(this, 4));
        boolean z10 = false;
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        e eVar = new e(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 16, new Class[]{org.telegram.ui.Cells.ya.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.c9.class, org.telegram.ui.Cells.d6.class}, null, null, null, org.telegram.ui.ActionBar.h6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.m6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.h6.z6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.V6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.y6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.n6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, null, org.telegram.ui.ActionBar.h6.r0, null, org.telegram.ui.ActionBar.h6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.j5));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.q5));
        ...
        if (i10 != 2) {
            if (!(i10 == 1 ? this.R.equals(ChatObject.getBannedRightsString(this.O)) : this.T.equals(this.S))) {
                ...
                if (z10) {
                    ...
                    org.telegram.ui.ActionBar.a2 a2Var = alertDialog$Builder.a;
                    a2Var.R = string;
                    a2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("UserRestrictionsApplyChangesText", R.string.UserRestrictionsApplyChangesText, MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.s)).title));
    ...
    */
    public final void r0(boolean z10) {
        ...
        TLRPC.User user = kqVar.v;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = kqVar.M;
        if (z10 && z11 && !kqVar.L && tL_chatAdminRights.manage_linked_peers && tL_chatAdminRights.change_info) {
            org.telegram.ui.Components.e5.v0(kqVar, LocaleController.getString(R.string.CommunityMakeAdminTitle), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.CommunityMakeAdminMessage, DialogObject.getShortName(user))), LocaleController.getString(R.string.CommunityMakeAdminPromote), false, new cq(kqVar, r6));
            return;
        }
        if (kqVar.v0 != -1 && (str = kqVar.S) != null && str.codePointCount(0, str.length()) > 16) {
            kqVar.b.x0(kqVar.v0);
            Vibrator vibrator = (Vibrator) kqVar.getParentActivity().getSystemService("vibrator");
            if (vibrator != null) {
                vibrator.vibrate(200L);
            }
            s4.c1 K = kqVar.b.K(kqVar.v0);
            if (K != null) {
        ...
        if (i10 == 0) {
            int i12 = kqVar.X0 == null ? 1 : 0;
            kqVar.t0(true);
            MessagesController.getInstance(kqVar.currentAccount).setUserAdminRole(kqVar.s, kqVar.v, kqVar.M, kqVar.S, kqVar.E, kqVar, (!kqVar.Z0 || z11) ? 0 : 1, false, null, new cq(kqVar, i11), new zp(kqVar, 8));
            kqVar = kqVar;
            r6 = i12;
        } else {
            if (i10 == 1) {
                ...
                MessagesController.getInstance(kqVar.currentAccount).setParticipantBannedRole(kqVar.s, kqVar.v, null, kqVar.O, kqVar.E, kqVar.getFragmentForAlert(1));
                TLRPC.TL_chatBannedRights tL_chatBannedRights = kqVar.O;
                ...
                hq hqVar = kqVar.X0;
                if (hqVar != null) {
                    hqVar.b(i11, tL_chatAdminRights, tL_chatBannedRights, kqVar.S);
                }
            } else if (i10 == 2) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(kqVar.getParentActivity());
                String string = kqVar.K ? LocaleController.getString(R.string.AddBotAdmin) : LocaleController.getString(R.string.AddBot);
                org.telegram.ui.ActionBar.a2 a2Var = alertDialog$Builder.a;
                a2Var.R = string;
                boolean z13 = ChatObject.isChannel(kqVar.w) && !kqVar.w.megagroup;
                TLRPC.Chat chat = kqVar.w;
                String str4 = chat != null ? chat.title : "";
                a2Var.T = AndroidUtilities.replaceTags(kqVar.K ? z13 ? LocaleController.formatString(R.string.AddBotMessageAdminChannel, str4) : LocaleController.formatString(R.string.AddBotMessageAdminGroup, str4) : LocaleController.formatString(R.string.AddMembersAlertNamesText, UserObject.getUserName(user), str4));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                alertDialog$Builder.k(LocaleController.getString(kqVar.K ? R.string.AddAsAdmin : R.string.AddBot), new zp(kqVar, r6));
                kqVar.showDialog(a2Var);
                r6 = 0;
            }
        }
