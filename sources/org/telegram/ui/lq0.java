...
public final class lq0 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    public final boolean E;
    public final bo F;
    public int G;
    public boolean H;
    public org.telegram.ui.ActionBar.o1 I;
    ...
    public lq0(int i10, boolean z10, boolean z11, bo boVar) {
        super(null);
        this.b = new HashMap();
    ...
    public static void U(lq0 lq0Var, MediaController.AlbumEntry albumEntry) {
        if (albumEntry != null) {
            cr0 cr0Var = new cr0(0, albumEntry, lq0Var.b, lq0Var.c, lq0Var.w, lq0Var.E, lq0Var.F, false);
        ...
        if (!lq0Var.y) {
            cr0 cr0Var2 = new cr0(0, albumEntry, hashMap, arrayList, lq0Var.w, lq0Var.E, lq0Var.F, false);
            Editable text2 = lq0Var.M.getText();
            lq0Var.a = text2;
            cr0Var2.d = text2;
            org.telegram.ui.Components.ju juVar2 = cr0Var2.d0;
            if (juVar2 != null) {
                juVar2.setText(text2);
            }
            cr0Var2.s0 = new eq0(lq0Var, hashMap, arrayList);
            cr0Var2.f0(lq0Var.G, lq0Var.H);
            lq0Var.presentFragment(cr0Var2);
            return;
        }
        ir0 ir0Var = new ir0(hashMap, arrayList, lq0Var.w, lq0Var.E, lq0Var.F);
        Editable text3 = lq0Var.M.getText();
        lq0Var.a = text3;
        cr0 cr0Var3 = ir0Var.a;
        if (cr0Var3 != null) {
            cr0Var3.d = text3;
            org.telegram.ui.Components.ju juVar3 = cr0Var3.d0;
            if (juVar3 != null) {
                juVar3.setText(text3);
            }
        }
        iq0 iq0Var = new iq0(lq0Var, hashMap, arrayList);
        cr0 cr0Var4 = ir0Var.a;
        cr0Var4.s0 = iq0Var;
        cr0 cr0Var5 = ir0Var.b;
        cr0Var5.s0 = iq0Var;
        cr0Var4.t0 = new hr0(ir0Var, 0);
        cr0Var5.t0 = new hr0(ir0Var, 1);
        int i10 = lq0Var.G;
        boolean z10 = lq0Var.H;
        cr0Var4.f0(i10, z10);
        ir0Var.b.f0(i10, z10);
        lq0Var.presentFragment(ir0Var);
    }
    ...
    public final View createView(Context context) {
        ...
        u50 u50Var = new u50(this, context, i12);
        this.Q = u50Var;
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        org.telegram.ui.Components.ml0 ml0Var = this.h;
        if (ml0Var != null) {
            ml0Var.getViewTreeObserver().addOnPreDrawListener(new g7(this, 4));
        }
    }
