...
public final class l50 extends org.telegram.ui.Components.rl0 {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        boolean z10;
        e60 e60Var = this.V2;
        boolean z11 = e60Var.U.K != Float.MAX_VALUE;
        LongSparseIntArray longSparseIntArray = this.U2;
        longSparseIntArray.clear();
        for (int i11 = 0; i11 < e60Var.y2.size(); i11++) {
            longSparseIntArray.put(e60Var.y2.keyAt(i11), 1);
        }
        e60Var.y2.clear();
                ...
                if (i13 == 3 || i13 == 4 || i13 == 5 || i13 == 6 || i13 == 7) {
                    ...
                    if (i13 == 1) {
                        ...
                        if (view instanceof org.telegram.ui.Cells.d4) {
                            ...
                            i10 = i12;
                            z10 = z12;
                            e60Var.y2.append(d4Var.getPeerId(), 1);
        ...
        if (z11) {
            ...
            f12 = (f12 * f14) + ((1.0f - f14) * s50Var.J);
        } else {
            f10 = f11;
        }
        if (f11 != Float.MAX_VALUE) {
            e60Var.s0.set((getMeasuredWidth() - (AndroidUtilities.isTablet() ? Math.min(AndroidUtilities.dp(420.0f), getMeasuredWidth()) : getMeasuredWidth())) >> 1, f10, getMeasuredWidth() - r3, Math.min(getMeasuredHeight() - getTranslationY(), f12));
            canvas.drawRoundRect(e60Var.s0, AndroidUtilities.dp(13.0f), AndroidUtilities.dp(13.0f), e60Var.z0);
        }
        canvas.save();
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        hashSet2.clear();
        hashSet2.addAll(s50Var.q);
        hashSet.clear();
        hashSet.addAll(s50Var.p);
        s50Var.J = 0.0f;
        ...
        if (getVisibility() != i10) {
            for (int i11 = 0; i11 < getChildCount(); i11++) {
                ...
                if (childAt instanceof org.telegram.ui.Components.voip.l) {
                    e60.N(this.V2, (org.telegram.ui.Components.voip.l) childAt, childAt.isAttachedToWindow() && i10 == 0);
                }
            }
        }
