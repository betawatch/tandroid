        ...
        if (this.d3 != null) {
            ...
            while (i14 < getChildCount()) {
                ...
                if (childAt instanceof s61) {
                    ...
                    if (s61Var.w != null) {
                        yh.i8 collectionParticles = j71Var.getCollectionParticles();
                        i10 = i14;
                        boolean z13 = z12;
                    ...
                    if ((z15 || s61Var.M || s61Var.S > 0.0f) && !s61Var.b) {
                        ...
                        s61Var.S = Utilities.clamp(s61Var.L ? org.telegram.ui.Components.qr.h.getInterpolation(s61Var.R) : 1.0f - org.telegram.ui.Components.qr.h.getInterpolation(1.0f - s61Var.R), 1.0f, 0.0f);
                    ...
                    if (arrayList5 == null) {
                        arrayList3 = !arrayList.isEmpty() ? (ArrayList) hg.k0.x(1, arrayList) : new ArrayList();
                ...
                if (z11 && view != null) {
                    ...
                    List list = j71.Z1;
                    if (S == i18 - 1) {
                        float interpolation = org.telegram.ui.Components.qr.g.getInterpolation(w7.q.a((SystemClock.elapsedRealtime() - j71Var.P1) / 200.0f, 0.0f, 1.0f));
        ...
        while (true) {
            ...
            while (true) {
                if (i20 >= arrayList6.size()) {
                    ...
                    if (((k61) arrayList6.get(i20)).M == S2) {
            ...
            if (k61Var == null) {
                if (arrayList2.isEmpty()) {
                    ...
                    k61Var = (k61) hg.k0.x(1, arrayList2);
                }
                k61Var.M = S2;
                k61Var.e();
            }
        ...
        for (int i22 = 0; i22 < getChildCount(); i22++) {
            ...
            if (childAt2 instanceof s61) {
                ...
                if (r61Var2 != null && r61Var2.getVisibility() == 0) {
                    ...
                    ImageReceiver imageReceiver2 = drawable2 instanceof org.telegram.ui.Components.p5 ? ((org.telegram.ui.Components.p5) drawable2).k : s61Var3.h;
