...
public final class am0 implements RequestDelegate {
    ...
    public final void a(final TLRPC.TL_error tL_error, final TLRPC.TL_secureValue tL_secureValue, final TLRPC.TL_secureValue tL_secureValue2) {
        bm0 bm0Var = this.p;
        final boolean z10 = bm0Var.b;
        final int i10 = bm0Var.c;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.zl0
            ...
            public final void run() {
                ...
                if (tL_error2 != null) {
                    ...
                    i11 = ((org.telegram.ui.ActionBar.n2) xm0Var2).currentAccount;
                    org.telegram.ui.Components.y4.f0(i11, tL_error2, xm0Var2, savesecurevalue, str4);
                    return;
                }
                boolean z11 = z10;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            ...
            if (equals) {
                ...
                ConnectionsManager.getInstance(i11).sendRequest(sendverifyemailcode, new cg.e0(this, this.b, this.e, this.n, this.a, 13));
                return;
            }
            am0Var = this;
            if (tL_error.text.equals("PHONE_VERIFICATION_NEEDED")) {
                AndroidUtilities.runOnUIThread(new bf0(am0Var.a, tL_error, str, 11));
                return;
            }
        } else {
            am0Var = this;
        }
        if (tL_error != null || (tL_inputSecureValue = am0Var.o) == null) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue, new v80(11, this, (TLRPC.TL_secureValue) tLObject));
    }
}
