...
public final class i70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.u40 {
    ...
    public static /* synthetic */ void U(i70 i70Var, ArrayList arrayList, ArrayList arrayList2, CountDownLatch countDownLatch) {
        arrayList.addAll(MessagesStorage.getInstance(i70Var.currentAccount).getUsers(arrayList2));
    ...
    public final void Z(boolean z10, boolean z11) {
        ...
        this.h.addListener(new e70(i10, this, z10));
        this.h.start();
    }
    ...
    */
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new po(this, 27));
        ...
        hdVar.addView(ub1Var, w7.x5.c(-1.0f, -1));
        ...
        ub1Var.addView(this.s, w7.x5.k(9.0f, 0.0f, 9.0f, 0.0f, -1, -2));
        ...
        frameLayout2.addView(y5Var2, w7.x5.d(64, 64.0f, (z10 ? 5 : 3) | 48, z10 ? 0.0f : 16.0f, 16.0f, z10 ? 16.0f : 0.0f, 16.0f));
        ...
        this.e.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.c70
            ...
            public final void onClick(View view) {
                switch (i12) {
                    case 0:
                        i70 i70Var = this.b;
                        i70Var.N.o(i70Var.y != null, new d10(i70Var, 8), new s5(i70Var, 7), 0);
                        i70Var.R.M(0);
                        i70Var.R.P(43);
                        i70Var.f.d();
                        break;
                    default:
                        i70 i70Var2 = this.b;
                        if (!i70Var2.M) {
                            if (i70Var2.c.a.length() != 0) {
                                i70Var2.M = true;
                                AndroidUtilities.hideKeyboard(i70Var2.c);
                                i70Var2.c.setEnabled(false);
                                if (!i70Var2.N.h()) {
                                    org.telegram.ui.Components.z10 z10Var = i70Var2.v;
                                    if (z10Var != null) {
                                        z10Var.f(true, true);
                                    }
                                    i70Var2.V = i70Var2.getMessagesController().createChat(i70Var2.c.getText().toString(), i70Var2.K, null, i70Var2.P, i70Var2.S, i70Var2.U, i70Var2.T, i70Var2.W, i70Var2);
                                    break;
                                } else {
                                    i70Var2.L = true;
                                    break;
                                ...
                                Vibrator vibrator = (Vibrator) i70Var2.getParentActivity().getSystemService("vibrator");
                                if (vibrator != null) {
                                    vibrator.vibrate(200L);
                                }
                                AndroidUtilities.shakeView(i70Var2.c);
                                break;
                            }
                        }
                        break;
        ...
        this.R = new org.telegram.ui.Components.yi0(R.raw.camera, AndroidUtilities.dp(60.0f), AndroidUtilities.dp(60.0f), false, null);
        ...
        frameLayout4.addView(idVar2, w7.x5.d(64, 64.0f, (z12 ? 5 : 3) | 48, z12 ? 0.0f : 15.0f, 16.0f, z12 ? 15.0f : 0.0f, 16.0f));
        ...
        frameLayout5.addView(jdVar2, w7.x5.d(64, 64.0f, (z13 ? 5 : 3) | 48, z13 ? 0.0f : 16.0f, 16.0f, z13 ? 16.0f : 0.0f, 16.0f));
        Z(false, false);
        ...
        frameLayout6.addView(kuVar5, w7.x5.d(-1, -2.0f, 16, z14 ? 5.0f : 96.0f, 0.0f, z14 ? 96.0f : 5.0f, 0.0f));
        ...
        this.a = g70Var;
        ml0Var2.setAdapter(g70Var);
        this.b.setLayoutManager(this.X);
        this.b.setVerticalScrollBarEnabled(false);
        this.b.setVerticalScrollbarPosition(LocaleController.isRTL ? 1 : 2);
        ub1Var.addView(this.b, w7.x5.n(-1, -1));
        this.b.setOnScrollListener(new i3(this, 14));
        this.b.setOnItemClickListener(new d70(this));
        ...
        this.v.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.c70
            public final /* synthetic */ i70 b;
                    ...
                    default:
                        ...
                        if (!i70Var2.M) {
                            if (i70Var2.c.a.length() != 0) {
                                ...
                                i70Var2.c.setEnabled(false);
                                if (!i70Var2.N.h()) {
                                    org.telegram.ui.Components.z10 z10Var2 = i70Var2.v;
                                    if (z10Var2 != null) {
                                        z10Var2.f(true, true);
                                    }
                                    i70Var2.V = i70Var2.getMessagesController().createChat(i70Var2.c.getText().toString(), i70Var2.K, null, i70Var2.P, i70Var2.S, i70Var2.U, i70Var2.T, i70Var2.W, i70Var2);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, org.telegram.ui.ActionBar.h6.b7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 48, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i10));
    ...
    public final boolean onFragmentCreate() {
        ...
        if (arrayList.isEmpty()) {
            ...
            i70Var = this;
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new org.telegram.ui.Components.jn0(i70Var, arrayList2, arrayList, countDownLatch, 11));
            try {
        ...
        i70Var.W = getUserConfig().getGlobalTTl() * 60;
