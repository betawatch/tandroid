...
public final class lx0 extends org.telegram.ui.Components.ql0 {
    ...
    */
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i24 == 0) {
            ...
            z9Var.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.j6.G6));
            if (i10 == privacyControlActivity.P) {
                ...
                if (i23 == 10) {
                    z9Var.c(LocaleController.getString(R.string.PrivateMessagesExceptions), formatPluralString, false, false);
                } else if (i23 == 0 || i23 == 4 || i23 == 9 || i23 == 14) {
                    z9Var.c(LocaleController.getString(R.string.AlwaysShareWith), formatPluralString, false, privacyControlActivity.Q != -1);
                } else {
                    z9Var.c(LocaleController.getString(R.string.AlwaysAllow), formatPluralString, false, privacyControlActivity.Q != -1);
                }
                if (i23 == 12) {
                    z9Var.setEnabled(!privacyControlActivity.u0());
                    return;
                }
                return;
            }
            if (i10 != privacyControlActivity.Q) {
                if (i10 == privacyControlActivity.Y) {
                    ...
                    z9Var.c(LocaleController.getString(R.string.PrivacyP2P2), ContactsController.getInstance(i11).getLoadingPrivacyInfo(3) ? LocaleController.getString(R.string.Loading) : PrivacySettingsActivity.x0(3, privacyControlActivity.getAccountInstance()), false, false);
                    return;
                } else {
                    if (i10 == privacyControlActivity.b0) {
                        z9Var.b(LocaleController.getString(privacyControlActivity.getUserConfig().isPremium() ? R.string.PrivacyLastSeenPremiumForPremium : R.string.PrivacyLastSeenPremium), false);
                        z9Var.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.j6.n6));
                        return;
                    }
                    return;
                }
            ...
            if (i23 == 0 || i23 == 4 || i23 == 9 || i23 == 14) {
                z9Var.c(LocaleController.getString(R.string.NeverShareWith), formatPluralString2, false, false);
            } else {
                z9Var.c(LocaleController.getString(R.string.NeverAllow), formatPluralString2, false, false);
            }
            if (i23 == 12) {
                z9Var.setEnabled(!privacyControlActivity.u0());
                return;
        ...
        if (i24 == 1) {
            ...
            if (i10 == privacyControlActivity.N) {
                z8Var.setText(LocaleController.getString(R.string.PrivateMessagesChargePriceInfo));
            } else {
                ...
                if (i10 == i34 && i23 == 10) {
                    ...
                    z8Var.setText(AndroidUtilities.replaceSingleTag(string, new Runnable(this) { // from class: org.telegram.ui.ix0
                    ...
                    z8Var.setText(LocaleController.getString(R.string.PrivacyVoiceMessagesInfo));
                } else {
                    i12 = privacyControlActivity.setBirthdayRow;
                    if (i10 == i12) {
                        z8Var.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.PrivacyBirthdaySet), new Runnable(this) { // from class: org.telegram.ui.ix0
                            public final /* synthetic */ lx0 b;
                        ...
                        if (i23 == 6) {
                            if (privacyControlActivity.F == 1 && privacyControlActivity.G == 1) {
                                z8Var.setText(LocaleController.getString(R.string.PrivacyPhoneInfo3));
                            } else {
                                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                                Locale locale = Locale.ENGLISH;
                                String e = vh.w2.e("https://t.me/+", privacyControlActivity.getUserConfig().getClientPhone());
                                SpannableString spannableString = new SpannableString(e);
                                spannableString.setSpan(new kx0(this, e), 0, e.length(), 33);
                            ...
                            z8Var.setText(LocaleController.getString(R.string.PrivacyForwardsInfo));
                        } else if (i23 == 4) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyProfilePhotoInfo));
                        } else if (i23 == 9) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyBioInfo3));
                        } else if (i23 == 14) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyMusicInfo3));
                        } else if (i23 == 11) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyBirthdayInfo));
                        } else if (i23 == 12) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyGiftsInfo));
                        } else if (i23 == 3) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyCallsP2PHelp));
                        } else if (i23 == 2) {
                            z8Var.setText(LocaleController.getString(R.string.WhoCanCallMeInfo));
                        } else if (i23 == 1) {
                            z8Var.setText(LocaleController.getString(R.string.WhoCanAddMeInfo));
                        } else {
                            z8Var.setText(LocaleController.getString(R.string.CustomHelp));
                        }
                    } else if (i10 == privacyControlActivity.R) {
                        if (i23 == 6) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyPhoneInfo2));
                        } else if (i23 == 5) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyForwardsInfo2));
                        } else if (i23 == 4) {
                            int i36 = privacyControlActivity.F;
                            if (i36 == 2) {
                                z8Var.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PrivacyProfilePhotoInfo5)));
                            } else if (i36 == 0) {
                                z8Var.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.PrivacyProfilePhotoInfo3)));
                            } else {
                                z8Var.setText(LocaleController.getString(R.string.PrivacyProfilePhotoInfo4));
                            }
                        } else if (i23 == 3) {
                            z8Var.setText(LocaleController.getString(R.string.CustomP2PInfo));
                        } else if (i23 == 9) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyBioInfo));
                        } else if (i23 == 14) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyMusicInfo));
                        } else if (i23 == 11) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyBirthdayInfo3));
                        } else if (i23 == 2) {
                            z8Var.setText(LocaleController.getString(R.string.CustomCallInfo));
                        } else if (i23 == 1) {
                            z8Var.setText(LocaleController.getString(R.string.CustomShareInfo));
                        } else if (i23 == 12) {
                            z8Var.setText(LocaleController.getString(R.string.CustomShareGiftsInfo));
                        } else if (i23 == 8) {
                            z8Var.setText(LocaleController.getString(R.string.PrivacyVoiceMessagesInfo2));
                        } else if (i23 == 10) {
                            z8Var.setText(LocaleController.getString(R.string.PrivateMessagesExceptionsInfo));
                        } else {
                            z8Var.setText(LocaleController.getString(R.string.CustomShareSettingsHelp));
                        }
                    } else if (i10 == privacyControlActivity.W) {
                        z8Var.setText(LocaleController.getString(R.string.PhotoForRestDescription));
                    } else if (i10 == privacyControlActivity.a0) {
                        z8Var.setText(LocaleController.getString(R.string.HideReadTimeInfo));
                    } else if (i10 == privacyControlActivity.c0) {
                        z8Var.setText(LocaleController.getString(privacyControlActivity.getUserConfig().isPremium() ? R.string.PrivacyLastSeenPremiumInfoForPremium : R.string.PrivacyLastSeenPremiumInfo));
                    } else if (i10 == privacyControlActivity.g0) {
                        z8Var.setText(LocaleController.formatString(R.string.PrivateMessagesPriceInfo, rh.j.G0(privacyControlActivity.getMessagesController().starsPaidMessageCommissionPermille), String.valueOf(((int) (((privacyControlActivity.I * (privacyControlActivity.getMessagesController().starsPaidMessageCommissionPermille / 1000.0f)) / 1000.0d) * privacyControlActivity.getMessagesController().starsUsdWithdrawRate1000)) / 100.0d)));
                    } else if (i10 == privacyControlActivity.h0) {
                        SpannableString spannableString2 = new SpannableString(ImageLoader.AUTOPLAY_FILTER);
                        org.telegram.ui.Components.lq lqVar = new org.telegram.ui.Components.lq(R.drawable.msg_input_gift, 0);
                        lqVar.setScale(0.583f, 0.583f);
                        spannableString2.setSpan(lqVar, 0, 1, 33);
                        z8Var.setText(LocaleController.formatSpannable(R.string.PrivacyGiftsShowIconInfo, spannableString2));
                    } else if (i10 == privacyControlActivity.n0) {
                        z8Var.setText(LocaleController.getString(R.string.PrivacyGiftsTypeInfo));
                    }
                }
            }
        ...
        if (i24 != 3) {
            if (i24 != 8) {
                ...
                if (i10 == i22) {
                    int[] a2 = org.telegram.ui.Cells.w7.a((int) privacyControlActivity.getMessagesController().starsPaidMessageAmountMax, new int[]{1, 10, 50, 100, 200, MediaDataController.MAX_LINKS_COUNT, 400, 500, MediaDataController.MAX_STYLE_RUNS_COUNT, 2500, 5000, 7500, 9000, 10000});
                    kl0 kl0Var = new kl0(this, i25);
                    org.telegram.ui.Cells.v7 v7Var = new org.telegram.ui.Cells.v7();
                    v7Var.c = a2;
                    v7Var.d = 20;
                    v7Var.e = kl0Var;
                    w7Var.d((int) Utilities.clamp(privacyControlActivity.I, privacyControlActivity.getMessagesController().starsPaidMessageAmountMax, 1L), v7Var, new jx0(this, r8 ? 1 : 0));
                    return;
                }
                return;
            }
            ...
            if (i10 == i20) {
                r8Var.f(LocaleController.getString(R.string.HideReadTime), privacyControlActivity.y0, false);
                return;
            }
            i21 = privacyControlActivity.showGiftIconRow;
            if (i10 == i21) {
                r8Var.f(LocaleController.getString(R.string.PrivacyGiftsShowIcon), privacyControlActivity.A0, false);
                return;
            }
            if (i10 == privacyControlActivity.i0) {
                r8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypeUnlimited), privacyControlActivity.C0, true);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.C0) {
                    i27 = R.drawable.permission_locked;
                }
                r8Var.setCheckBoxIcon(i27);
                return;
            }
            if (i10 == privacyControlActivity.j0) {
                r8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypeLimited), privacyControlActivity.E0, true);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.E0) {
                    i28 = R.drawable.permission_locked;
                }
                r8Var.setCheckBoxIcon(i28);
                return;
            }
            if (i10 == privacyControlActivity.k0) {
                r8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypeUnique), privacyControlActivity.G0, true);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.G0) {
                    i29 = R.drawable.permission_locked;
                }
                r8Var.setCheckBoxIcon(i29);
                return;
            }
            if (i10 == privacyControlActivity.l0) {
                r8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypeFromChannels), privacyControlActivity.I0, true);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.I0) {
                    i30 = R.drawable.permission_locked;
                }
                r8Var.setCheckBoxIcon(i30);
                return;
            }
            if (i10 == privacyControlActivity.m0) {
                r8Var.f(LocaleController.getString(R.string.PrivacyGiftsTypePremium), privacyControlActivity.K0, false);
                if (!privacyControlActivity.getUserConfig().isPremium() && privacyControlActivity.K0) {
                    i31 = R.drawable.permission_locked;
                }
                r8Var.setCheckBoxIcon(i31);
                return;
            }
            return;
        }
        org.telegram.ui.Cells.i6 i6Var = (org.telegram.ui.Cells.i6) view;
        i6Var.setRadioIcon(null);
        ...
        if (i10 != i14 && i10 != privacyControlActivity.L) {
            ...
            if (i10 != i19 && i10 != privacyControlActivity.d0) {
                if (i10 == privacyControlActivity.U) {
                    i6Var.c(LocaleController.getString(R.string.LastSeenContacts), privacyControlActivity.G == 1, false);
                } else if (i10 == privacyControlActivity.T) {
                    i6Var.c(LocaleController.getString(R.string.LastSeenEverybody), privacyControlActivity.G == 0, true);
                }
                if (i23 != 12) {
                    i6Var.b(null, !privacyControlActivity.u0());
                    return;
                }
                return;
            }
        ...
        if (i10 == i15) {
            if (i23 == 3) {
                i6Var.c(LocaleController.getString(R.string.P2PEverybody), privacyControlActivity.F == 0, true);
            } else {
                i6Var.c(LocaleController.getString(R.string.LastSeenEverybody), privacyControlActivity.F == 0, true);
            }
            ...
            if ((i23 == 8 && !privacyControlActivity.getUserConfig().isPremium()) || (i23 == 10 && !privacyControlActivity.getMessagesController().newNoncontactPeersRequirePremiumWithoutOwnpremium && !privacyControlActivity.getUserConfig().isPremium())) {
                i6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            if (i23 == 3) {
                ...
                i6Var.c(string2, z4, (i18 == -1 && privacyControlActivity.d0 == -1) ? false : true);
            } else if (i23 == 10) {
                ...
                i6Var.c(string3, z10, (i17 == -1 && privacyControlActivity.d0 == -1) ? false : true);
            } else {
                ...
                i6Var.c(string4, z11, (i16 == -1 && privacyControlActivity.d0 == -1) ? false : true);
            }
        } else if (i10 == privacyControlActivity.d0) {
            if (i23 == 10 && !privacyControlActivity.getUserConfig().isPremium()) {
                i6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            i6Var.c(LocaleController.getString(R.string.PrivateMessagesChargePrice), privacyControlActivity.F == 3, false);
        } else {
            if ((i23 == 8 && !privacyControlActivity.getUserConfig().isPremium()) || (i23 == 10 && !privacyControlActivity.getMessagesController().newNoncontactPeersRequirePremiumWithoutOwnpremium && !privacyControlActivity.getUserConfig().isPremium())) {
                i6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            if (i23 == 3) {
                i6Var.c(LocaleController.getString(R.string.P2PNobody), privacyControlActivity.F == 1, false);
            } else {
                i6Var.c(LocaleController.getString(R.string.LastSeenNobody), privacyControlActivity.F == 1, false);
            }
        }
        if (i23 != 12) {
        }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                view = new org.telegram.ui.Cells.i6(context, null);
                break;
            case 4:
            ...
            default:
                ...
                break;
            case 6:
                org.telegram.ui.Cells.n8 n8Var = new org.telegram.ui.Cells.n8(privacyControlActivity.getParentActivity());
                privacyControlActivity.r0 = n8Var;
                if (privacyControlActivity.u0 == null) {
                    n8Var.m(R.drawable.msg_addphoto, LocaleController.formatString(R.string.SetPhotoForRest, new Object[0]), false);
                } else {
                    n8Var.m(R.drawable.msg_addphoto, LocaleController.formatString("UpdatePhotoForRest", R.string.UpdatePhotoForRest, new Object[0]), true);
                }
                privacyControlActivity.r0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.K0(false));
                privacyControlActivity.r0.e(org.telegram.ui.ActionBar.j6.v6, org.telegram.ui.ActionBar.j6.u6);
                privacyControlActivity.q0 = new org.telegram.ui.Components.gj0(R.raw.camera_outline, AndroidUtilities.dp(50.0f), AndroidUtilities.dp(50.0f), false, null);
            ...
            case 7:
                ...
                privacyControlActivity.t0 = new ns(this, privacyControlActivity.getParentActivity());
                ...
                privacyControlActivity.t0.addView(privacyControlActivity.s0, k7.b6.d(30, 30.0f, 16, 21.0f, 0.0f, 21.0f, 0.0f));
                ...
                privacyControlActivity.t0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.K0(false));
                ns nsVar = privacyControlActivity.t0;
            ...
            case 8:
                ...
                view = new org.telegram.ui.Cells.r8(context, f6Var);
                break;
            case 9:
                f6Var2 = ((org.telegram.ui.ActionBar.p2) privacyControlActivity).resourceProvider;
                view = new org.telegram.ui.Cells.w7(context, f6Var2);
                break;
            case 10:
                ...
                dVar.setOnClickListener(new g60(this, 24));
