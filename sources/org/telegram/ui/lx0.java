    ...
    public lx0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        ix0Var.setSelectorTransformer(new q0.a() { // from class: org.telegram.ui.fx0
            ...
            public final void accept(Object obj) {
                ...
                int b10 = pressedChildView == null ? -1 : ix0Var2.U(pressedChildView).b();
                Path path2 = path;
                path2.rewind();
    ...
    */
    ...
    public final void b() {
        ...
        if (i10 == 0) {
            ...
            org.telegram.messenger.w1.n((premiumPreviewFragment.getUserConfig().isPremium() || premiumPreviewFragment.p0) ? R.string.TelegramPremiumSubscribedSubtitle : R.string.TelegramPremiumSubtitle, textView2);
        } else if (i10 == 1) {
            ...
            org.telegram.messenger.w1.n((premiumPreviewFragment.getUserConfig().isPremium() || premiumPreviewFragment.p0) ? R.string.TelegramBusinessSubscribedSubtitleTemp : R.string.TelegramBusinessSubtitleTemp, textView2);
        }
