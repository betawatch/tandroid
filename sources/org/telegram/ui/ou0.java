...
public abstract class ou0 extends NestedScrollView {
    ...
    public ou0(Context context, ru0 ru0Var, FrameLayout frameLayout) {
        ...
        o1.k kVar = new o1.k(ru0Var, o1.h.n, 0.0f);
        this.a0 = kVar;
        kVar.u.b(100.0f);
        kVar.j = 1.0f;
    ...
    */
    public final void H(int i10, int i11) {
        ...
        if (i10 != 0 && i11 != 0) {
            ru0 ru0Var = this.n0;
            TextView currentView = ru0Var.getCurrentView();
    ...
    public final void i(int i10, int i11, int i12, int i13, int[] iArr, int i14, int[] iArr2) {
        float f7;
        if (i13 != 0) {
            int round = Math.round((1.0f - Math.abs((-this.c0) / (this.o0.getTop() - (org.telegram.ui.ActionBar.l.getCurrentActionBarHeight() + (C() ? AndroidUtilities.statusBarHeight : 0))))) * i13);
            if (round != 0) {
                boolean z10 = this.b0;
                ru0 ru0Var = this.n0;
                if (z10) {
