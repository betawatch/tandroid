...
public class ou0 {
        ...
        if (motionEvent.getActionMasked() == 0 || motionEvent.getActionMasked() == 5) {
            ...
            if (hypot <= 1.005f || this.n) {
                ...
                if (z10) {
                    ...
                    this.i = z11;
                    if (z11 && this.k == null) {
                        eh.j e9 = eh.j.e(this.d);
                        this.k = e9;
                        if (e9 != null) {
                            e9.k.put(this.d, Integer.valueOf(i10));
                        }
                    }
                    ...
                    if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                        ...
                        nu0 nu0Var3 = this.d;
                        mediaController.setTextureView(nu0Var3.b, nu0Var3.c, nu0Var3.a, true);
                        ...
                        ku0 ku0Var = this.E;
                        if (ku0Var != null) {
                            this.d.d.setImageBitmap(ku0Var.K().getBitmap((int) this.z, (int) this.y));
    ...
    public final void d() {
        if (this.C == null && this.n) {
            ...
            this.C.setInterpolator(org.telegram.ui.Components.er.f);
            this.C.start();
        }
    }
