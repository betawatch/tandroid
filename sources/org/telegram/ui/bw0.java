...
public final class bw0 extends bg.i {
    ...
    public final void g() {
        ...
        if (premiumPreviewFragment.n0 == null && BuildVars.DEBUG_PRIVATE_VERSION) {
            ...
            bg.j jVar2 = aVar.c;
            qn0Var2.setProgress(jVar2 == null ? 0.0f : jVar2.w / 2.0f);
            ...
            bg.j jVar3 = aVar.c;
            qn0Var3.setProgress(jVar3 == null ? 0.0f : jVar3.x);
            ...
            qn0Var5.setProgress(hh.m.b / 2.0f);
            ...
            premiumPreviewFragment.Z.addView(premiumPreviewFragment.n0, h7.z5.e(-1, -1, 80));
