...
public final class bw0 extends org.telegram.ui.Cells.u1 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        dw0 dw0Var = this.Le;
        rectF.top = AndroidUtilities.lerp(dp, dw0Var.V ? -AndroidUtilities.dp(3.0f) : 0.0f, dw0Var.y) + f7;
        float f10 = rectF.bottom;
        boolean z10 = dw0Var.V;
        float dp2 = AndroidUtilities.dp(3.0f);
        if (!z10) {
            dp2 = AndroidUtilities.lerp(dp2, 0.0f, dw0Var.y);
        }
        ...
        Paint paint = this.He;
        paint.setColor(0);
        paint.setShadowLayer(AndroidUtilities.dp(2.0f), 0.0f, AndroidUtilities.dp(0.66f), org.telegram.ui.ActionBar.h6.l1(dw0Var.y * 0.2f, -16777216));
