...
public class bw0 extends FrameLayout {
    ...
    public bw0(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
    ...
    public final void a(rw0 rw0Var, boolean z4) {
        boolean isPremium = UserConfig.getInstance(UserConfig.selectedAccount).isPremium();
        ImageView imageView = this.d;
        if (isPremium && rw0Var.a == 12 && rw0Var.b == R.drawable.filled_premium_status2) {
        ...
        this.f = rw0Var;
        this.a.l(rw0Var.c, false);
        this.b.setText(rw0Var.d);
        this.c.setImageResource(rw0Var.b);
        this.e = z4;
    }
