...
public final class se1 extends org.telegram.ui.Components.qv0 {
    ...
    public final void J(Canvas canvas, float f10, Rect rect, Paint paint, boolean z4) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            ...
            if (mf1Var.d1 != null) {
                ...
                mf1Var.d1.I(canvas, rect.left, rect.top + f10, rect.right, rect.bottom + f10);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (mf1Var.isInPreviewMode()) {
            int themedColor = mf1Var.getThemedColor(org.telegram.ui.ActionBar.k6.d6);
            Paint paint = this.u0;
        ...
        if (mf1Var.J0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, mf1Var.getThemedColor(org.telegram.ui.ActionBar.k6.d6), mf1Var.b1);
        }
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view == kVar && !mf1Var.isInPreviewMode()) {
            ...
            int measuredHeight = (int) (y10 + ((int) ((((l81Var == null || l81Var.getVisibility() == 8) ? 0.0f : mf1Var.X0.getMeasuredHeight()) * mf1Var.T) + height)));
            ((ActionBarLayout) mf1Var.getParentLayout()).p(canvas, (int) ((1.0f - mf1Var.T) * 255.0f), measuredHeight);
            float f10 = mf1Var.T;
            if (f10 > 0.0f) {
                if (f10 < 1.0f) {
                    int alpha = org.telegram.ui.ActionBar.k6.k0.getAlpha();
                    org.telegram.ui.ActionBar.k6.k0.setAlpha((int) (alpha * mf1Var.T));
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (c51Var != null) {
            ...
            mf1Var.l0.setPadding(0, 0, 0, i13);
            this.t0 = false;
        }
        int i14 = 0;
