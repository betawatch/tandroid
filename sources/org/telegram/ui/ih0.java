...
public final class ih0 extends org.telegram.ui.Components.f6 {
    ...
    public ih0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.L = kVar2;
        kVar.u = org.telegram.ui.Cells.c1.m(1.0f, 1500.0f, 0.75f);
        ...
        kVar2.u = lVar3;
        this.P = new HashSet();
        this.Q = new le.b(0, new fu(this, 23), org.telegram.ui.Components.qr.h, 380L, false);
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            ...
            ((oh.b) ((org.telegram.ui.Components.e6) n10.a).a).setVisualWidth(n10.b().width());
        }
    }
