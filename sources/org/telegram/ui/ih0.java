...
public final class ih0 extends org.telegram.ui.Components.e6 {
    ...
    public ih0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        ...
        this.L = kVar2;
        kVar.u = org.telegram.ui.Cells.p6.l(1.0f, 1500.0f, 0.75f);
        ...
        kVar2.u = lVar3;
        this.P = new HashSet();
        this.Q = new le.b(0, new gu(this, 23), org.telegram.ui.Components.qr.h, 380L, false);
        this.R = new me.b(new g(this, 25));
        this.s = f6Var;
    }

    public static void k(ih0 ih0Var, View view, float f7, float f10) {
        float f11;
        float f12;
    ...
    public static void m(ih0 ih0Var, float f7, boolean z10, boolean z11) {
        View view;
        o1.k kVar = ih0Var.L;
        float f10 = Float.MAX_VALUE;
        if (ih0Var.getChildCount() != 0) {
            float f11 = -3.4028235E38f;
            boolean z12 = false;
            float f12 = Float.MAX_VALUE;
            for (int i10 = 0; i10 < ih0Var.getChildCount(); i10++) {
                View childAt = ih0Var.getChildAt(i10);
        ...
        if (ih0Var.getChildCount() == 0) {
            ...
            view = null;
            for (int i11 = 0; i11 < ih0Var.getChildCount(); i11++) {
                View childAt2 = ih0Var.getChildAt(i11);
        ...
        if (z10) {
            int childCount = ih0Var.getChildCount();
            int i12 = 0;
            while (true) {
                if (i12 >= childCount) {
                    break;
                }
                View childAt3 = ih0Var.getChildAt(i12);
        ...
        if (view != null) {
            ih0Var.O = view;
            int childCount2 = ih0Var.getChildCount();
            for (int i13 = 0; i13 < childCount2; i13++) {
                View childAt4 = ih0Var.getChildAt(i13);
    ...
    public void setSkipDrawSelector(boolean z10) {
        this.I = z10;
        if (z10) {
            this.J.setColor(org.telegram.ui.ActionBar.j6.l1(0.09f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.al, this.s)));
        }
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            le.g n10 = this.c.n(i10);
            ((oh.b) ((org.telegram.ui.Components.d6) n10.a).a).setVisualWidth(n10.b().width());
        }
    }
    ...
    @Override // org.telegram.ui.Components.e6, android.widget.LinearLayout, android.view.View
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < childCount3; i18++) {
            ...
            if (childAt2 instanceof hh0) {
                ((oh.b) ((hh0) childAt2)).setTextSizeDp(f14);
            }
        }
