...
public final class ae1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ae1(org.telegram.ui.ActionBar.i6 i6Var, org.telegram.ui.ActionBar.g6 g6Var, boolean z10) {
        super(null);
        this.J = i6Var;
        this.K = g6Var;
        this.L = g6Var != null ? g6Var.r : i6Var.F;
        this.currentAccount = g6Var != null ? g6Var.t : i6Var.E;
        this.I = z10;
    }

    public static /* synthetic */ void V(ae1 ae1Var, TLRPC.TL_theme tL_theme) {
        try {
            ae1Var.r.dismiss();
            ae1Var.r = null;
        } catch (Exception e) {
        ...
        org.telegram.ui.ActionBar.j6.C1(ae1Var.J, ae1Var.K, tL_theme, ae1Var.currentAccount, false);
        ae1Var.finishFragment();
    }

    public static /* synthetic */ void W(ae1 ae1Var, TLRPC.TL_error tL_error, TL_account.updateTheme updatetheme) {
        try {
            ae1Var.r.dismiss();
            ae1Var.r = null;
        } catch (Exception e) {
        ...
        org.telegram.ui.Components.e5.f0(ae1Var.currentAccount, tL_error, ae1Var, updatetheme, new Object[0]);
    }

    public static /* synthetic */ void X(ae1 ae1Var, String str) {
        ...
        ae1Var.y = ConnectionsManager.getInstance(ae1Var.currentAccount).sendRequest(createtheme, new cc0(25, ae1Var, str), 2);
    }

    public static void Y(ae1 ae1Var) {
        org.telegram.ui.ActionBar.i6 i6Var = ae1Var.J;
        TLRPC.TL_theme tL_theme = ae1Var.L;
        if (ae1Var.Z(ae1Var.a.getText().toString(), true) && ae1Var.getParentActivity() != null) {
            if (ae1Var.b.length() == 0) {
                org.telegram.ui.Components.e5.u0(ae1Var, LocaleController.getString(R.string.Theme), LocaleController.getString(R.string.ThemeNameInvalid), null);
                return;
            }
            if (ae1Var.I) {
                ...
                ae1Var.r = b2Var;
                b2Var.setOnCancelListener(new yd1());
                ae1Var.r.show();
                String obj = ae1Var.b.getText().toString();
                tL_theme.title = obj;
                i6Var.a = obj;
                i6Var.F.slug = ae1Var.a.getText().toString();
            ...
            String obj2 = ae1Var.a.getText().toString();
            String obj3 = ae1Var.b.getText().toString();
            if (str2.equals(obj2) && str4.equals(obj3)) {
                ae1Var.finishFragment();
                return;
            }
            ae1Var.r = new org.telegram.ui.ActionBar.b2(ae1Var.getParentActivity(), 3, null);
            ...
            int sendRequest = ConnectionsManager.getInstance(ae1Var.currentAccount).sendRequest(updatetheme, new cc0(26, ae1Var, updatetheme), 2);
            ConnectionsManager.getInstance(ae1Var.currentAccount).bindRequestToGuid(sendRequest, ae1Var.classGuid);
            ae1Var.r.setOnCancelListener(new ca(ae1Var, sendRequest, 8));
            ae1Var.r.show();
        }
    }
    ...
    public final boolean Z(String str, boolean z10) {
        ...
        if (!z10) {
            ...
            this.E = str;
            x81 x81Var2 = new x81(6, this, str);
            this.F = x81Var2;
            AndroidUtilities.runOnUIThread(x81Var2, 300L);
        }
        return true;
    }
    ...
    public final View createView(Context context) {
        ...
        this.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.wd1
            ...
            public final boolean onEditorAction(TextView textView, int i14, KeyEvent keyEvent) {
                ...
                switch (i11) {
                    case 0:
                        ae1 ae1Var = this.b;
                        if (i14 == 6) {
                            AndroidUtilities.hideKeyboard(ae1Var.b);
                            return true;
                        }
                        ae1Var.getClass();
                        return false;
        ...
        this.a.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.wd1
            public final /* synthetic */ ae1 b;
        ...
        this.a.addTextChangedListener(new zd1(this));
        if (z10) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (i6Var2 == i6Var && g6Var2 == g6Var && (b2Var2 = this.r) != null) {
                try {
                    b2Var2.dismiss();
                    this.r = null;
                } catch (Exception e) {
        ...
        if (i10 == NotificationCenter.themeUploadError) {
            ...
            if (i6Var3 == i6Var && g6Var3 == g6Var && (b2Var = this.r) != null) {
                try {
                    b2Var.dismiss();
                    this.r = null;
                } catch (Exception e7) {
