...
public final class ke1 extends Dialog {
    public final fh.b E;
    public final ah.c F;
    ...
    public ke1(Activity activity, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.a0 = false;
        this.a = e6Var;
        he1 he1Var = new he1(this, activity, 0);
        this.b = he1Var;
        int i10 = 6;
        he1Var.setOnClickListener(new g41(this, i10));
        fh.b bVar = new fh.b();
        this.E = bVar;
        ah.c cVar = new ah.c(bVar);
        this.F = cVar;
        cVar.f = new hh.k(he1Var);
        cVar.g = he1Var;
        he1 he1Var2 = new he1(this, activity, 1);
        this.c = he1Var2;
        he1Var2.setClipToPadding(false);
        he1Var.addView(he1Var2, w7.y5.e(-1, -1, 119));
        ci.i1 i1Var = new ci.i1(this, activity, 8);
        this.e = i1Var;
        int i11 = 2;
        i1Var.setAdapter(new iw0(this, activity, i11));
        he1Var2.addView(i1Var, w7.y5.e(-1, -1, 119));
        he1 he1Var3 = new he1(this, activity, i11);
        this.d = he1Var3;
        he1Var2.addView(he1Var3, w7.y5.e(-1, -1, 119));
        ...
        he1Var2.addView(cc0Var, w7.y5.e(-1, 66, 80));
        cc0Var.setOnTabClick(new s3(i1Var, 22));
        ...
        org.telegram.messenger.wh.k(R.string.TodoMenuHint, textView, 17);
        he1Var2.addView(textView, w7.y5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 66.0f));
        jw0 jw0Var = new jw0(this, i10);
        WeakHashMap weakHashMap = r0.i0.a;
        r0.a0.j(he1Var, jw0Var);
    }
    ...
    public final void b(boolean z10, org.telegram.ui.Components.es0 es0Var) {
        ...
        this.d0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.de1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (i10) {
                    ...
                    default:
                        ke1 ke1Var2 = this.b;
                        ke1Var2.getClass();
                        ke1Var2.y = ((Float) valueAnimator3.getAnimatedValue()).floatValue();
                        break;
                }
            }
        });
        this.d0.addListener(new androidx.fragment.app.g(this, z10, es0Var, 11));
        ...
        this.e0 = ofFloat2;
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.de1
            public final /* synthetic */ ke1 b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator32) {
                switch (i11) {
                    ...
                    default:
                        ke1 ke1Var2 = this.b;
                        ke1Var2.getClass();
                        ke1Var2.y = ((Float) valueAnimator32.getAnimatedValue()).floatValue();
                        break;
                }
            }
        });
        this.e0.addListener(new h70(10, this, z10));
    ...
    public final void c(boolean z10) {
        ...
        this.b0 = !z10;
        d();
        b(false, new org.telegram.ui.Components.es0(11, this, z11));
        this.b.invalidate();
    }
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.T = he1Var2.getMeasuredWidth() - (this.S.getX() - lerp2);
            this.S.setTranslationY(((this.J.getY() + this.J.getHeight()) - this.S.getTop()) - he1Var2.getTop());
        ...
        if (this.Q != null) {
            ...
            this.R = he1Var2.getMeasuredWidth() - (this.Q.getX() - lerp2);
            this.Q.setTranslationY(((this.I.getY() + ((int) G2)) - this.Q.getTop()) - he1Var2.getTop());
        ...
        if (this.P != null) {
            ...
            this.P.setTranslationY(Math.max(0.0f, ((this.J.getY() - this.P.getHeight()) + AndroidUtilities.dp(22.0f)) - he1Var2.getTop()));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        he1 he1Var = this.b;
        setContentView(he1Var, layoutParams);
        ...
        he1Var.setSystemUiVisibility(1284);
        AndroidUtilities.setLightNavigationBar(he1Var, !org.telegram.ui.ActionBar.j6.I.q());
    }
