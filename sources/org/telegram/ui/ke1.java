...
public final class ke1 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            String obj = oe1Var.e.getText() == null ? null : oe1Var.e.getText().toString();
            if (TextUtils.isEmpty(obj)) {
                Vibrator vibrator = (Vibrator) oe1Var.getParentActivity().getSystemService("vibrator");
                if (vibrator != null) {
                    vibrator.vibrate(200L);
                }
                AndroidUtilities.shakeView(oe1Var.e);
                return;
            }
            if (oe1Var.r) {
                return;
            ...
            tL_messages_createForumTopic.peer = oe1Var.getMessagesController().getInputPeer(oe1Var.a);
        ...
        if (i10 == 2) {
            String obj2 = oe1Var.e.getText() != null ? oe1Var.e.getText().toString() : null;
            ...
            if (!oe1Var.w.title.equals(obj2) || oe1Var.w.icon_emoji_id != oe1Var.b) {
                TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic = new TL_forum.TL_messages_editForumTopic();
                tL_messages_editForumTopic.peer = oe1Var.getMessagesController().getInputPeer(oe1Var.a);
                TLRPC.TL_forumTopic tL_forumTopic = oe1Var.w;
                ...
                long j11 = oe1Var.w.icon_emoji_id;
                long j12 = oe1Var.b;
                if (j11 != j12) {
            ...
            if (oe1Var.d != null) {
                TLRPC.TL_forumTopic tL_forumTopic2 = oe1Var.w;
                if (tL_forumTopic2.id == 1 && (!r12.d.h) != tL_forumTopic2.hidden) {
                    ...
                    tL_messages_editForumTopic2.peer = oe1Var.getMessagesController().getInputPeer(oe1Var.a);
                    tL_messages_editForumTopic2.topic_id = oe1Var.w.id;
            ...
            TLRPC.TL_forumTopic tL_forumTopic3 = oe1Var.w;
            long j13 = oe1Var.b;
            ...
            oe1Var.getMessagesController().getTopicsController().onTopicEdited(oe1Var.a, oe1Var.w);
            oe1Var.finishFragment();
        }
    }
}
