...
public class PrivacySettingsActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void V(PrivacySettingsActivity privacySettingsActivity, Context context, View view, int i10) {
        ...
        if (view.isEnabled()) {
            ...
            if (i10 == privacySettingsActivity.blockedRow) {
                privacySettingsActivity.presentFragment(new hy0());
                return;
            }
            ...
            if (i10 == privacySettingsActivity.deleteAccountRow) {
                ...
                while (i12 < 6) {
                    ...
                    k6Var.setOnClickListener(new tv(28, privacySettingsActivity, alertDialog$Builder));
                    i12++;
                }
            ...
            if (i10 == privacySettingsActivity.passwordRow) {
                ...
                if (!password3.has_password) {
                    privacySettingsActivity.presentFragment(new hh1(TextUtils.isEmpty(password3.email_unconfirmed_pattern) ? 6 : 5, privacySettingsActivity.d));
                    return;
                }
            ...
            if (i10 == privacySettingsActivity.contactsSuggestRow) {
                ...
                alertDialog$Builder4.k(LocaleController.getString("MuteDisable", R.string.MuteDisable), new qv0(4, privacySettingsActivity, w8Var));
            ...
            if (i10 == privacySettingsActivity.secretMapRow) {
                org.telegram.ui.Components.e5.s0(privacySettingsActivity.getParentActivity(), privacySettingsActivity.currentAccount, new by0(privacySettingsActivity, 0), false, null);
                return;
            }
            if (i10 != privacySettingsActivity.paymentsClearRow) {
                if (i10 == privacySettingsActivity.G) {
                    privacySettingsActivity.presentFragment(new pn0(5, 0L, "", "", (String) null, (String) null, (String) null, (TL_account.authorizationForm) null, (TL_account.Password) null));
                    return;
                } else {
                    if (i10 == privacySettingsActivity.H) {
                        privacySettingsActivity.presentFragment(new fi.u());
                        return;
                    }
                    return;
                }
            ...
            while (i14 < 2) {
                ...
                z1Var.setOnClickListener(new l60(privacySettingsActivity, 25));
                i14++;
            }
    ...
    public static SpannableStringBuilder u0(PrivacySettingsActivity privacySettingsActivity, String str) {
        if (privacySettingsActivity.c0 == null) {
            ...
            org.telegram.ui.Components.p5 p5Var = new org.telegram.ui.Components.p5(AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), sg.d1.d().f);
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new o70(this, 22));
        org.telegram.ui.ActionBar.d5 d5Var = this.parentLayout;
        if (d5Var != null && ((ActionBarLayout) d5Var).N0) {
            this.actionBar.setBackButtonImage(R.drawable.ic_ab_close);
        }
        this.a = new dy0(this, context);
        ...
        this.b.setLayoutManager(new hg.b0(i10, false, 16));
        this.b.setVerticalScrollBarEnabled(false);
        this.b.setLayoutAnimation(null);
        this.b.setItemAnimator(null);
        frameLayout.addView(this.b, w7.x5.c(-1.0f, -1));
        this.b.setAdapter(this.a);
        this.b.setOnItemClickListener(new bi.x5(21, this, context));
        fi.s.d(getParentActivity(), this.currentAccount, new t3(this, 16));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 != NotificationCenter.didUpdateGlobalAutoDeleteTimer || (dy0Var = this.a) == null) {
            return;
        }
        dy0Var.m(this.autoDeleteMesages);
    }

    @Override // org.telegram.ui.ActionBar.n2
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 16, new Class[]{org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.w8.class}, null, null, null, org.telegram.ui.ActionBar.j6.d6));
    ...
    */
    public final void onFragmentDestroy() {
        ...
        if (z13 != this.U) {
            ...
            getConnectionsManager().sendRequest(tL_contacts_toggleTopPeers, new bi.c7(8));
            z10 = true;
        }
        TLRPC.GlobalPrivacySettings globalPrivacySettings = getContactsController().getGlobalPrivacySettings();
        if (globalPrivacySettings != null) {
