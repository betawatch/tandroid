...
public class PrivacySettingsActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void V(PrivacySettingsActivity privacySettingsActivity, Context context, View view, int i10) {
        ...
        if (view.isEnabled()) {
            ...
            if (i10 == privacySettingsActivity.blockedRow) {
                privacySettingsActivity.presentFragment(new ky0());
                return;
            }
            ...
            if (i10 == privacySettingsActivity.deleteAccountRow) {
                ...
                while (i12 < 6) {
                    ...
                    m6Var.setOnClickListener(new ow(25, privacySettingsActivity, alertDialog$Builder));
                    i12++;
                }
            ...
            if (i10 == privacySettingsActivity.passwordRow) {
                ...
                if (!password3.has_password) {
                    privacySettingsActivity.presentFragment(new mh1(TextUtils.isEmpty(password3.email_unconfirmed_pattern) ? 6 : 5, privacySettingsActivity.d));
                    return;
                }
            ...
            if (i10 == privacySettingsActivity.contactsSuggestRow) {
                ...
                alertDialog$Builder4.k(LocaleController.getString("MuteDisable", R.string.MuteDisable), new l80(29, privacySettingsActivity, x8Var));
            ...
            if (i10 == privacySettingsActivity.secretMapRow) {
                org.telegram.ui.Components.d5.s0(privacySettingsActivity.getParentActivity(), privacySettingsActivity.currentAccount, new cy0(privacySettingsActivity, 0), false, null);
                return;
            }
            if (i10 != privacySettingsActivity.paymentsClearRow) {
                if (i10 == privacySettingsActivity.G) {
                    privacySettingsActivity.presentFragment(new on0(5, 0L, "", "", (String) null, (String) null, (String) null, (TL_account.authorizationForm) null, (TL_account.Password) null));
                    return;
                } else {
                    if (i10 == privacySettingsActivity.H) {
                        privacySettingsActivity.presentFragment(new di.x());
                        return;
                    }
                    return;
                }
            ...
            while (i14 < 2) {
                ...
                linearLayout2.addView(z1Var, w7.a6.n(-1, 50));
    ...
    public static SpannableStringBuilder u0(PrivacySettingsActivity privacySettingsActivity, String str) {
        if (privacySettingsActivity.c0 == null) {
            ...
            org.telegram.ui.Components.o5 o5Var = new org.telegram.ui.Components.o5(AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), qg.d1.d().f);
    ...
    public final View createView(Context context) {
        ...
        this.b.setLayoutManager(new fg.a0(i10, false, 16));
        this.b.setVerticalScrollBarEnabled(false);
        this.b.setLayoutAnimation(null);
        this.b.setItemAnimator(null);
        frameLayout.addView(this.b, w7.a6.c(-1.0f, -1));
        this.b.setAdapter(this.a);
        this.b.setOnItemClickListener(new ai.b0(20, this, context));
        di.u.d(getParentActivity(), this.currentAccount, new u3(this, 16));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 != NotificationCenter.didUpdateGlobalAutoDeleteTimer || (gy0Var = this.a) == null) {
            return;
        }
        gy0Var.m(this.autoDeleteMesages);
    }

    @Override // org.telegram.ui.ActionBar.p2
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 16, new Class[]{org.telegram.ui.Cells.ga.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.x8.class}, null, null, null, org.telegram.ui.ActionBar.j6.d6));
    ...
    */
    public final void onFragmentDestroy() {
        ...
        if (z13 != this.U) {
            ...
            getConnectionsManager().sendRequest(tL_contacts_toggleTopPeers, new bi.g1(4));
            z10 = true;
        }
        TLRPC.GlobalPrivacySettings globalPrivacySettings = getContactsController().getGlobalPrivacySettings();
        if (globalPrivacySettings != null) {
