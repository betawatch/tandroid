...
public final class qe0 extends org.telegram.ui.Components.gw0 {
    ...
    public String v;
    public String w;
    public final org.telegram.ui.Components.id0 x;
    ...
    */
    public qe0(xg0 xg0Var, Context context) {
        super(context);
        int i10;
        this.y = xg0Var;
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                addView(id0Var, w7.y5.t(-1, -2, 1, 16, 32, 16, 0));
        ...
        addView(id0Var2, w7.y5.t(-1, -2, 1, 16, 32, 16, 0));
    ...
    @Override // org.telegram.ui.Components.gw0
    public final void j() {
        AndroidUtilities.runOnUIThread(new g10(this, 19), xg0.t0);
    }
