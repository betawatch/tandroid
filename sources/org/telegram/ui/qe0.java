...
public final class qe0 extends org.telegram.ui.Components.mv0 {
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", R.string.ResetAccountInfo, LocaleController.addNbsp(qe.b.c().b("+" + this.r)))));
        o();
