...
public class wo extends org.telegram.ui.ActionBar.n2 implements org.telegram.ui.Components.t40, NotificationCenter.NotificationCenterDelegate {
    ...
    public static void U(wo woVar, FrameLayout frameLayout, View view) {
        if (!woVar.G0) {
            TLRPC.ChatFull chatFull = woVar.y0;
            org.telegram.ui.Components.vc.a0(woVar).Q(R.raw.topics, 36, (chatFull == null || chatFull.linked_chat_id == 0) ? AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelTopicsForbidden", woVar.getMessagesController().forumUpgradeParticipantsMin, new Object[0])) : AndroidUtilities.replaceTags(LocaleController.getString("ChannelTopicsDiscussionForbidden", R.string.ChannelTopicsDiscussionForbidden))).j();
            try {
        ...
        mzVar.a = j3;
        mzVar.setResourceProvider(woVar.resourceProvider);
        boolean z10 = woVar.F0;
        boolean z11 = woVar.H0;
        ai.m0 m0Var = new ai.m0(8, woVar, view);
        mzVar.c = z10;
        mzVar.d = z11;
        mzVar.f = m0Var;
        woVar.presentFragment(mzVar);
    }

    public static /* synthetic */ void V(wo woVar) {
        woVar.v0 = null;
        long j3 = woVar.C0;
        if (j3 == 0) {
            MessagesController.getInstance(woVar.currentAccount).changeChatAvatar(woVar.w0, null, null, null, null, 0.0d, null, null, null, null);
        } else {
            TLRPC.TL_photos_updateProfilePhoto tL_photos_updateProfilePhoto = new TLRPC.TL_photos_updateProfilePhoto();
            tL_photos_updateProfilePhoto.bot = woVar.getMessagesController().getInputUser(j3);
            tL_photos_updateProfilePhoto.flags |= 2;
            tL_photos_updateProfilePhoto.id = new TLRPC.TL_inputPhotoEmpty();
            woVar.getConnectionsManager().sendRequest(tL_photos_updateProfilePhoto, new mo(woVar, 2));
        }
        woVar.n0(false, true);
        ai.z5 z5Var = woVar.e;
        org.telegram.ui.Components.f9 f9Var = woVar.r;
        Object obj = woVar.D0;
        if (obj == null) {
            obj = woVar.x0;
        }
        z5Var.h(null, null, f9Var, obj);
        woVar.R0.M(0);
        woVar.b0.e.d();
    }

    public static void X(wo woVar, org.telegram.ui.ActionBar.b2 b2Var, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, long j3, ChannelBoostsController.CanApplyBoost canApplyBoost) {
        b2Var.dismiss();
        if (woVar.getParentActivity() == null) {
            return;
        }
        rg.j0 j0Var = new rg.j0(35, woVar.currentAccount, woVar.getParentActivity(), woVar, woVar.getResourceProvider());
        ...
        if (chat != null) {
            j0Var.Q0 = new uh(8, woVar, chat);
        }
        woVar.showDialog(j0Var);
    }

    public static void Y(wo woVar) {
        int i10 = woVar.currentAccount;
        long j3 = woVar.C0;
        TL_bots.botVerifierSettings botverifiersettings = woVar.E0.bot_info.verifier_settings;
        org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
        if (U == null) {
            return;
        }
        Bundle e = org.telegram.messenger.y0.e(16, "onlySelect", "dialogsType", true);
    ...
    public static void Z(wo woVar) {
        ad adVar = new ad(-woVar.x0.id);
        adVar.l0 = woVar;
        woVar.presentFragment(adVar);
        MessagesController.getInstance(woVar.currentAccount).getMainSettings().edit().putInt("boostingappearance", MessagesController.getInstance(woVar.currentAccount).getMainSettings().getInt("boostingappearance", 0) + 1).apply();
    }

    public static /* synthetic */ void a0(wo woVar) {
        woVar.O0 = true;
        NotificationCenter.getInstance(woVar.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.updateInterfaces, Integer.valueOf(MessagesController.UPDATE_MASK_AVATAR));
    }
    ...
    */
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new to(this, 0));
        hd hdVar = new hd(i15, context, this);
        hdVar.setOnTouchListener(new bi.d(9));
        this.fragmentView = hdVar;
        hdVar.setBackgroundColor(org.telegram.ui.ActionBar.i6.u0(org.telegram.ui.ActionBar.i6.a7));
        ...
        ai.z5 z5Var = new ai.z5(this, context, 6);
        this.e = z5Var;
        z5Var.setRoundRadius(this.F0 ? AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(32.0f));
        int i16 = 5;
        if (this.D0 != null || ChatObject.canChangeChatInfo(this.x0)) {
            ai.z5 z5Var2 = this.e;
            boolean z12 = LocaleController.isRTL;
            frameLayout2.addView(z5Var2, w7.x5.d(64, 64.0f, (z12 ? 5 : 3) | 48, z12 ? 0.0f : 16.0f, 12.0f, z12 ? 16.0f : 0.0f, 8.0f));
            Paint paint = new Paint(1);
            paint.setColor(1426063360);
            ci.s6 s6Var = new ci.s6(this, context, paint, i16);
            this.f = s6Var;
            boolean z13 = LocaleController.isRTL;
            frameLayout2.addView(s6Var, w7.x5.d(64, 64.0f, (z13 ? 5 : 3) | 48, z13 ? 0.0f : 16.0f, 12.0f, z13 ? 16.0f : 0.0f, 8.0f));
            ...
            n0(false, false);
            this.d.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.go
                ...
                public final void onClick(View view) {
                    switch (i15) {
                        case 0:
                            ...
                            bundle.putLong("chat_id", woVar3.w0);
                            bundle.putInt(TeXSymbolParser.TYPE_ATTR, 1);
                            ur urVar = new ur(bundle);
                            urVar.x0(woVar3.y0);
                            woVar3.presentFragment(urVar);
                            break;
                        case 1:
                            wo woVar4 = this.b;
                            so soVar = woVar4.Q0;
                            ...
                            if (!woVar4.s.h()) {
                                ...
                                TLRPC.User user2 = j3 == 0 ? null : woVar4.getMessagesController().getUser(Long.valueOf(j3));
                                if (user2 == null) {
                                    TLRPC.Chat chat3 = woVar4.getMessagesController().getChat(Long.valueOf(woVar4.w0));
                                    TLRPC.ChatPhoto chatPhoto = chat3.photo;
                                    if (chatPhoto != null && chatPhoto.photo_big != null) {
                                        PhotoViewer.t1().J2(null, woVar4, null);
                                        TLRPC.ChatPhoto chatPhoto2 = chat3.photo;
                                        int i17 = chatPhoto2.dc_id;
                                        if (i17 != 0) {
                                            chatPhoto2.photo_big.dc_id = i17;
                                        }
                                        TLRPC.ChatFull chatFull5 = woVar4.y0;
                                        if (chatFull5 != null) {
                                            TLRPC.Photo photo = chatFull5.chat_photo;
                                            if ((photo instanceof TLRPC.TL_photo) && !photo.video_sizes.isEmpty()) {
                                                imageLocation = ImageLocation.getForPhoto(woVar4.y0.chat_photo.video_sizes.get(0), woVar4.y0.chat_photo);
                                            }
                                        }
                                        PhotoViewer.t1().e2(null, chat3.photo.photo_big, null, imageLocation, null, null, null, 0, soVar, null, 0L, 0L, 0L, true, null, null);
                                        break;
                                    }
                                } else {
                                    ...
                                    if (userProfilePhoto != null && userProfilePhoto.photo_big != null) {
                                        ...
                                        PhotoViewer.t1().e2(null, user2.photo.photo_big, null, null, null, null, null, 0, soVar, null, 0L, 0L, 0L, true, null, null);
                                        break;
                                    }
                                }
                            }
                        ...
                        case 2:
                            ...
                            bundle2.putLong("chat_id", woVar5.w0);
                            bundle2.putInt(TeXSymbolParser.TYPE_ATTR, 2);
                            ur urVar2 = new ur(bundle2);
                            urVar2.x0(woVar5.y0);
                            woVar5.presentFragment(urVar2);
                            break;
                        case 3:
                            wo woVar6 = this.b;
                            woVar6.presentFragment(new zh0(woVar6.w0));
                            break;
                        case 4:
                            wo woVar7 = this.b;
                            woVar7.presentFragment(new ei.e4(-woVar7.w0));
                            break;
                        case 5:
                            wo woVar8 = this.b;
                            woVar8.getClass();
                            woVar8.presentFragment(new ub(woVar8.x0));
                            break;
                        case 6:
                            wo woVar9 = this.b;
                            woVar9.presentFragment(za1.d0(woVar9.x0, false));
                            break;
                        case 7:
                            wo woVar10 = this.b;
                            woVar10.getClass();
                            Bundle bundle3 = new Bundle();
                            bundle3.putLong("bot_id", woVar10.C0);
                            woVar10.presentFragment(new qa(bundle3));
                            break;
                        case 8:
                            wo woVar11 = this.b;
                            woVar11.presentFragment(new ei.l(woVar11.C0));
                            break;
                        case 9:
                            nf.f.s(view.getContext(), "https://t.me/BotFather?start=" + wo.g0(this.b.D0) + "-intro");
                            break;
                        case 10:
                            nf.f.s(view.getContext(), "https://t.me/BotFather?start=" + wo.g0(this.b.D0) + "-commands");
                            break;
                        case 11:
                            nf.f.s(view.getContext(), "https://t.me/BotFather?start=" + wo.g0(this.b.D0));
                            break;
                        case 12:
                            this.b.i0();
                            break;
                        ...
                        case 14:
                            wo woVar12 = this.b;
                            org.telegram.ui.Components.c5.s(woVar12, false, woVar12.x0, null, false, true, true, false, new no(woVar12, 7));
                            break;
                        case 15:
                            wo woVar13 = this.b;
                            if (AndroidUtilities.isMapsInstalled(woVar13)) {
                                id0 id0Var = new id0(4);
                                id0Var.e0 = -woVar13.w0;
                                TLRPC.ChatFull chatFull6 = woVar13.y0;
                                if (chatFull6 != null) {
                                ...
                                id0Var.F0 = new no(woVar13, 6);
                                woVar13.presentFragment(id0Var);
                                break;
                            }
                            break;
                        case 16:
                            wo woVar14 = this.b;
                            long j10 = woVar14.w0;
                            org.telegram.ui.Cells.r8 r8Var7 = woVar14.H;
                            boolean z15 = r8Var7 != null && r8Var7.getVisibility() == 0;
                            kp kpVar = new kp(null);
                            kpVar.M = new ArrayList();
                            kpVar.N = new ArrayList();
                            kpVar.P = new ArrayList();
                            kpVar.c0 = true;
                            kpVar.f0 = new ArrayList();
                            kpVar.o0 = new HashMap();
                            kpVar.q0 = new zo(kpVar, 5);
                            kpVar.t0 = false;
                            kpVar.Z = j10;
                            kpVar.n0 = z15;
                            TLRPC.ChatFull chatFull7 = woVar14.y0;
                            kpVar.Y = chatFull7;
                            if (chatFull7 != null) {
                            ...
                            woVar14.presentFragment(kpVar);
                            break;
                        case 17:
                            wo woVar15 = this.b;
                            long j11 = woVar15.w0;
                            wp wpVar = new wp(null);
                            wpVar.v = new ArrayList();
                            boolean z16 = false;
                            wpVar.O = false;
                            wpVar.P = false;
                            wpVar.E = j11;
                            TLRPC.Chat chat4 = wpVar.getMessagesController().getChat(Long.valueOf(j11));
                            wpVar.f = chat4;
                            if (ChatObject.isChannel(chat4) && !wpVar.f.megagroup) {
                                z16 = true;
                            }
                            wpVar.s = z16;
                            wpVar.h = woVar15.y0;
                            woVar15.presentFragment(wpVar);
                            break;
                        case 18:
                            wo woVar16 = this.b;
                            tw0 tw0Var = new tw0(woVar16.w0);
                            tw0Var.v = new no(woVar16, 4);
                            woVar16.presentFragment(tw0Var);
                            break;
                        case 19:
                            wo.Z(this.b);
                            break;
                        case 20:
                            wo woVar17 = this.b;
                            s60 s60Var = new s60(-woVar17.x0.id);
                            s60Var.c = woVar17.L0;
                            s60Var.l0 = woVar17;
                            woVar17.presentFragment(s60Var);
                            break;
                        case 21:
                            wo woVar18 = this.b;
                            woVar18.getClass();
                            Bundle bundle4 = new Bundle();
                            bundle4.putLong("chat_id", woVar18.w0);
                            bundle4.putInt(TeXSymbolParser.TYPE_ATTR, ((woVar18.I0 || woVar18.x0.gigagroup) && !ChatObject.isCommunity(woVar18.x0)) ? 0 : 3);
                            ur urVar3 = new ur(bundle4);
                            urVar3.x0(woVar18.y0);
                            woVar18.presentFragment(urVar3);
                            break;
                        case 22:
                            wo woVar19 = this.b;
                            yh0 yh0Var = new yh0(woVar19.w0, 0L, 0);
                            TLRPC.ChatFull chatFull8 = woVar19.y0;
                            yh0Var.g0(chatFull8, chatFull8.exported_invite);
                            woVar19.presentFragment(yh0Var);
                            break;
                        case 23:
                            wo woVar20 = this.b;
                            if (ChatObject.isChannelAndNotMegaGroup(woVar20.x0)) {
                                woVar20.presentFragment(new zg.q(woVar20.w0, woVar20.y0));
                                break;
                            } else {
                                Bundle bundle5 = new Bundle();
                                bundle5.putLong("chat_id", woVar20.w0);
                                dq dqVar = new dq(bundle5);
                                dqVar.d = new ArrayList();
                                dqVar.r = new ArrayList();
                                dqVar.v = -1;
                                dqVar.F = new ArrayList();
                                long j12 = bundle5.getLong("chat_id", 0L);
                                dqVar.c = j12;
                                TLRPC.ChatFull chatFull9 = woVar20.y0;
                                dqVar.b = chatFull9;
                                if (chatFull9 != null) {
                                    if (dqVar.a == null) {
                                        dqVar.a = dqVar.getMessagesController().getChat(Long.valueOf(j12));
                                    }
                                    dqVar.d = new ArrayList();
                                    ...
                                    if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
                                        ...
                                        for (int i19 = 0; i19 < tL_chatReactionsSome.reactions.size(); i19++) {
                                            if (tL_chatReactionsSome.reactions.get(i19) instanceof TLRPC.TL_reactionEmoji) {
                                                dqVar.d.add(((TLRPC.TL_reactionEmoji) tL_chatReactionsSome.reactions.get(i19)).emoticon);
                                            }
                                        }
                                        dqVar.w = 1;
                                    }
                                }
                                woVar20.presentFragment(dqVar);
                                break;
                            }
                        default:
                            wo woVar21 = this.b;
                            ...
                            bundle6.putLong("chat_id", woVar21.w0);
                            bundle6.putLong("welcome_messages_chat_id", woVar21.w0);
                            woVar21.presentFragment(new bo(bundle6));
                            break;
                    }
                }
            });
            ...
            frameLayout2.addView(z5Var3, w7.x5.d(64, 64.0f, (z15 ? 5 : 3) | 48, z15 ? 0.0f : 16.0f, 12.0f, z15 ? 16.0f : 0.0f, 12.0f));
        }
        org.telegram.ui.Components.ju juVar2 = new org.telegram.ui.Components.ju(context, hdVar, this);
        this.v = juVar2;
        long j3 = this.C0;
        if (j3 != 0) {
            juVar2.setHint(LocaleController.getString(R.string.BotName));
        } else if (this.I0) {
            juVar2.setHint(LocaleController.getString("EnterChannelName", R.string.EnterChannelName));
        } else {
            juVar2.setHint(LocaleController.getString("GroupName", R.string.GroupName));
        }
        org.telegram.ui.Components.ju juVar3 = this.v;
        TLRPC.Chat chat3 = this.x0;
        juVar3.setEnabled(chat3 != null || ChatObject.canChangeChatInfo(chat3));
        org.telegram.ui.Components.ju juVar4 = this.v;
        juVar4.setFocusable(juVar4.isEnabled());
        ...
        org.telegram.ui.Components.ju juVar5 = this.v;
        boolean z16 = LocaleController.isRTL;
        frameLayout2.addView(juVar5, w7.x5.d(-1, -2.0f, 16, z16 ? 5.0f : 96.0f, 0.0f, z16 ? 96.0f : 5.0f, 0.0f));
        ...
        if (this.D0 != null || ChatObject.canChangeChatInfo(this.x0)) {
            ...
            this.b0 = uoVar;
            uoVar.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(false));
            this.b0.e(org.telegram.ui.ActionBar.i6.v6, org.telegram.ui.ActionBar.i6.u6);
            this.b0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
                ...
                public final void onClick(View view) {
                    switch (i17) {
                        ...
                        case 1:
                            ...
                            if (!woVar4.s.h()) {
                                ImageLocation imageLocation = null;
                                TLRPC.User user2 = j32 == 0 ? null : woVar4.getMessagesController().getUser(Long.valueOf(j32));
                                if (user2 == null) {
                                    TLRPC.Chat chat32 = woVar4.getMessagesController().getChat(Long.valueOf(woVar4.w0));
                                    ...
                                    if (chatPhoto != null && chatPhoto.photo_big != null) {
                                        ...
                                        PhotoViewer.t1().e2(null, chat32.photo.photo_big, null, imageLocation, null, null, null, 0, soVar, null, 0L, 0L, 0L, true, null, null);
                                        break;
                                    }
                                } else {
                                    TLRPC.UserProfilePhoto userProfilePhoto = user2.photo;
        ...
        this.E.setHintTextColor(org.telegram.ui.ActionBar.i6.u0(org.telegram.ui.ActionBar.i6.H6));
        EditTextBoldCursor editTextBoldCursor2 = this.E;
        int i18 = org.telegram.ui.ActionBar.i6.G6;
        editTextBoldCursor2.setTextColor(org.telegram.ui.ActionBar.i6.u0(i18));
        ...
        this.E.setCursorColor(org.telegram.ui.ActionBar.i6.u0(i18));
        ...
        if (chat4 != null) {
            if (chat4.megagroup && ((chatFull4 = this.y0) == null || chatFull4.can_set_location)) {
                ...
                this.H = r8Var7;
                r8Var7.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(true));
                this.F.addView(this.H, w7.x5.n(-1, -2));
                final int i19 = 15;
                this.H.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.go
                    public final /* synthetic */ wo b;
                    ...
                    public final void onClick(View view) {
                        switch (i19) {
                            ...
                            case 16:
                                wo woVar14 = this.b;
                                long j10 = woVar14.w0;
                                org.telegram.ui.Cells.r8 r8Var72 = woVar14.H;
                            ...
                            case 17:
                                ...
                                wpVar.P = false;
                                wpVar.E = j11;
                                TLRPC.Chat chat42 = wpVar.getMessagesController().getChat(Long.valueOf(j11));
                                wpVar.f = chat42;
                                if (ChatObject.isChannel(chat42) && !wpVar.f.megagroup) {
                                    z162 = true;
                                }
                                wpVar.s = z162;
                                wpVar.h = woVar15.y0;
                                        ...
                                        if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
                                            ...
                                            for (int i192 = 0; i192 < tL_chatReactionsSome.reactions.size(); i192++) {
                                                if (tL_chatReactionsSome.reactions.get(i192) instanceof TLRPC.TL_reactionEmoji) {
                                                    dqVar.d.add(((TLRPC.TL_reactionEmoji) tL_chatReactionsSome.reactions.get(i192)).emoticon);
                                                }
                                            }
                                            dqVar.w = 1;
                                        }
            ...
            if (this.x0.creator && ((chatFull3 = this.y0) == null || chatFull3.can_set_username)) {
                ...
                this.I = r8Var8;
                r8Var8.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(true));
                this.F.addView(this.I, w7.x5.n(-1, -2));
                final int i20 = 16;
                this.I.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.go
                    public final /* synthetic */ wo b;
            ...
            if (ChatObject.isChannel(this.x0) && ((this.I0 && ChatObject.canUserDoAdminAction(this.x0, 1)) || (!this.I0 && ChatObject.canUserDoAdminAction(this.x0, 0)))) {
                ...
                this.J = r8Var9;
                r8Var9.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(true));
                this.F.addView(this.J, w7.x5.n(-1, -2));
                final int i21 = 17;
                this.J.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.go
                    public final /* synthetic */ wo b;
            ...
            if (ChatObject.isChannelAndNotMegaGroup(this.x0) && this.I0 && ChatObject.canUserDoAdminAction(this.x0, 1)) {
                ...
                this.K = r8Var10;
                r8Var10.setBackground(org.telegram.ui.ActionBar.i6.K0(true));
                ...
                final int i22 = 18;
                this.K.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.go
                    public final /* synthetic */ wo b;
            ...
            if (ChatObject.isChannelAndNotMegaGroup(this.x0) && ChatObject.canChangeChatInfo(this.x0)) {
                ...
                this.L = fp0Var;
                fp0Var.setBackground(org.telegram.ui.ActionBar.i6.K0(true));
                this.F.addView(this.L, w7.x5.n(-1, -2));
                final int i23 = 19;
                this.L.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.go
                    public final /* synthetic */ wo b;
            ...
            if (!ChatObject.isChannelAndNotMegaGroup(this.x0) || ChatObject.isCommunity(this.x0)) {
                ...
                context4 = context;
                this.M = r8Var11;
                r8Var11.setBackground(org.telegram.ui.ActionBar.i6.K0(true));
                this.M.l(R.drawable.msg_translate, LocaleController.getString(R.string.ChannelAutotranslation), this.x0.autotranslation);
                final int i24 = 0;
                getMessagesController().getBoostsController().getBoostsStats(j10, new e2.h(this) { // from class: org.telegram.ui.lo
                    public final /* synthetic */ wo b;
                        ...
                        switch (i24) {
                            case 0:
                                ...
                                if (tL_premium_boostsStatus == null) {
                                    ...
                                    woVar3.M.getCheckBox().setIcon(tL_premium_boostsStatus.level < woVar3.getMessagesController().channelAutotranslationLevelMin ? R.drawable.permission_locked : 0);
                                    break;
                                }
                            default:
                ...
                frameLayout = frameLayout2;
                woVar = this;
                this.M.setOnClickListener(new ho(this, new boolean[]{false}, j10, 0));
            }
            if (!woVar.I0 && ChatObject.canBlockUsers(woVar.x0) && (ChatObject.isChannel(woVar.x0) || woVar.x0.creator)) {
                org.telegram.ui.Cells.r8 r8Var12 = new org.telegram.ui.Cells.r8(context4);
                woVar.N = r8Var12;
                r8Var12.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(true));
                woVar.F.addView(woVar.N, w7.x5.n(-1, -2));
                i11 = 5;
                woVar.N.setOnClickListener(new rf(i11, woVar, context4));
            } else {
                i11 = 5;
            }
            if (ChatObject.isMegagroup(woVar.x0) && ChatObject.hasAdminRights(woVar.x0) && !ChatObject.isCommunity(woVar.x0)) {
                final int i25 = 1;
                MessagesController.getInstance(woVar.currentAccount).getBoostsController().getBoostsStats(-woVar.x0.id, new e2.h(woVar) { // from class: org.telegram.ui.lo
                    public final /* synthetic */ wo b;
                ...
                fp0 fp0Var2 = new fp0(woVar.currentAccount, -woVar.x0.id, context4, woVar.getResourceProvider());
                woVar.L = fp0Var2;
                fp0Var2.setBackground(org.telegram.ui.ActionBar.i6.K0(true));
                woVar.F.addView(woVar.L, w7.x5.n(-1, -2));
                final int i26 = 20;
                woVar.L.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                    public final /* synthetic */ wo b;
            ...
            if (!woVar.I0 && woVar.x0.creator) {
                org.telegram.ui.Cells.r8 r8Var13 = new org.telegram.ui.Cells.r8(23, context, null, false, true);
                context2 = context;
                woVar.Q = r8Var13;
                r8Var13.setBackground(org.telegram.ui.ActionBar.i6.K0(true));
                woVar.Q.l(R.drawable.msg_topics, LocaleController.getString(R.string.ChannelTopics), woVar.F0);
                woVar.Q.getCheckBox().setIcon(woVar.G0 ? 0 : R.drawable.permission_locked);
                woVar.F.addView(woVar.Q, w7.x5.c(-2.0f, -1));
                i10 = 6;
                woVar.Q.setOnClickListener(new rf(i10, woVar, frameLayout));
            } else {
                context2 = context;
                i10 = 6;
            }
        ...
        org.telegram.ui.ActionBar.z n10 = woVar.actionBar.n();
        if (woVar.D0 != null || ChatObject.canChangeChatInfo(woVar.x0) || woVar.N != null) {
        ...
        if (woVar.H == null && woVar.N == null && woVar.I == null && woVar.J == null && woVar.Q == null) {
            i12 = 12;
        } else {
            i12 = 12;
            org.telegram.ui.Cells.e9 e9Var = new org.telegram.ui.Cells.e9(context2, 12, woVar.resourceProvider);
            woVar.P = e9Var;
            if (woVar.Q != null) {
            ...
            xdVar.addView(woVar.P, w7.x5.n(-1, -2));
        }
        LinearLayout linearLayout4 = new LinearLayout(context2);
        woVar.R = linearLayout4;
        linearLayout4.setOrientation(1);
        xdVar.addView(woVar.R, w7.x5.n(-1, -2));
        final int i27 = 8;
        if (woVar.x0 != null) {
            org.telegram.ui.Cells.r8 r8Var14 = new org.telegram.ui.Cells.r8(context2);
            woVar.X = r8Var14;
            r8Var14.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            org.telegram.ui.Cells.r8 r8Var15 = woVar.X;
            if (!ChatObject.isChannel(woVar.x0)) {
                TLRPC.Chat chat5 = woVar.x0;
                if (!chat5.creator && (!ChatObject.hasAdminRights(chat5) || !ChatObject.canChangeChatInfo(woVar.x0))) {
                    i14 = 8;
                    r8Var15.setVisibility(i14);
                    final int i28 = 21;
                    woVar.X.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                        public final /* synthetic */ wo b;
                    ...
                    woVar.V = r8Var16;
                    r8Var16.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                    final int i29 = 22;
                    woVar.V.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                        public final /* synthetic */ wo b;
                    ...
                    woVar.O = r8Var17;
                    r8Var17.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                    final int i30 = 23;
                    woVar.O.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                        public final /* synthetic */ wo b;
                    ...
                    if (ChatObject.canUserDoAdminAction(woVar.x0, 28)) {
                        org.telegram.ui.Cells.r8 r8Var18 = new org.telegram.ui.Cells.r8(context2);
                        woVar.f0 = r8Var18;
                        r8Var18.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                        final int i31 = 24;
                        woVar.f0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                            public final /* synthetic */ wo b;
                    ...
                    woVar.W = r8Var19;
                    final int i32 = 0;
                    r8Var19.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                    woVar.W.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                        public final /* synthetic */ wo b;
                    ...
                    woVar.T = r8Var20;
                    r8Var20.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(false));
                    final int i33 = 2;
                    woVar.T.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                        public final /* synthetic */ wo b;
                    ...
                    if (ChatObject.isChannelAndNotMegaGroup(woVar.x0)) {
                        org.telegram.ui.Cells.r8 r8Var21 = new org.telegram.ui.Cells.r8(context2);
                        woVar.U = r8Var21;
                        r8Var21.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                        final int i34 = 3;
                        woVar.U.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                            public final /* synthetic */ wo b;
                    ...
                    woVar.Z.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                    final int i35 = 4;
                    woVar.Z.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                        public final /* synthetic */ wo b;
                    ...
                    if (!ChatObject.isChannel(woVar.x0) || woVar.x0.gigagroup) {
                        ...
                        woVar.Y.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                        woVar.Y.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                            public final /* synthetic */ wo b;
                    ...
                    if (ChatObject.isBoostSupported(woVar.x0)) {
                        ...
                        woVar.a0.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                        woVar.a0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                            public final /* synthetic */ wo b;
                    ...
                    woVar.R.addView(woVar.O, w7.x5.n(-1, -2));
                    r8Var = woVar.f0;
                    if (r8Var != null) {
                        woVar.R.addView(r8Var, w7.x5.n(-1, -2));
                    }
                    if (!woVar.I0 && !woVar.x0.gigagroup) {
                        woVar.R.addView(woVar.X, w7.x5.n(-1, -2));
                    }
                    if (!woVar.I0) {
                        woVar.R.addView(woVar.V, w7.x5.n(-1, -2));
                    }
                    woVar.R.addView(woVar.W, w7.x5.n(-1, -2));
                    woVar.R.addView(woVar.T, w7.x5.n(-1, -2));
                    r8Var2 = woVar.U;
                    if (r8Var2 != null && (chatFull2 = woVar.y0) != null && chatFull2.requests_pending > 0) {
                        woVar.R.addView(r8Var2, w7.x5.n(-1, -2));
                    }
                    if (woVar.I0) {
                        woVar.R.addView(woVar.V, w7.x5.n(-1, -2));
                    }
                    ...
                    r8Var3 = woVar.a0;
                    if (r8Var3 != null) {
                        woVar.R.addView(r8Var3, w7.x5.n(-1, -2));
                    }
                    r8Var4 = woVar.Y;
                    if (r8Var4 != null) {
                        woVar.R.addView(r8Var4, w7.x5.n(-1, -2));
                    }
                    r8Var5 = woVar.Z;
                    if (r8Var5 != null) {
                        woVar.R.addView(r8Var5, w7.x5.n(-1, -2));
                    }
                    if (woVar.Z != null && woVar.getMessagesController().starrefConnectAllowed && ChatObject.isChannelAndNotMegaGroup(woVar.x0)) {
                        woVar.Z.setVisibility(0);
                    }
                    r8Var6 = woVar.Y;
                    if (r8Var6 != null) {
                        org.telegram.ui.Cells.r8 r8Var25 = woVar.Z;
            ...
            woVar.V = r8Var162;
            r8Var162.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            final int i292 = 22;
            woVar.V.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
            ...
            woVar.O = r8Var172;
            r8Var172.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            final int i302 = 23;
            woVar.O.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
            ...
            woVar.W = r8Var192;
            final int i322 = 0;
            r8Var192.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            woVar.W.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
            ...
            woVar.T = r8Var202;
            r8Var202.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(false));
            final int i332 = 2;
            woVar.T.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
        ...
        if (woVar.D0 != null) {
            ...
            woVar.l0 = r8Var26;
            r8Var26.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            woVar.l0.setPrioritizeTitleOverValue(true);
            woVar.R.addView(woVar.l0, w7.x5.n(-1, -2));
            final int i36 = 7;
            woVar.l0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
            ...
            woVar.o0 = r8Var27;
            r8Var27.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            woVar.o0.q(d0(LocaleController.getString(R.string.AffiliateProgramBot)), charSequence, R.drawable.msg_shareout, true);
            woVar.R.addView(woVar.o0, w7.x5.n(-1, -2));
            woVar.o0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
            ...
            woVar.o0.f(45, woVar.E0 == null, false);
            TLRPC.UserFull userFull = woVar.E0;
            if (userFull != null) {
                org.telegram.ui.Cells.r8 r8Var28 = woVar.o0;
            ...
            if (!woVar.getMessagesController().starrefProgramAllowed) {
                woVar.o0.setVisibility(8);
            }
            org.telegram.ui.Cells.r8 r8Var29 = new org.telegram.ui.Cells.r8(context2);
            woVar.p0 = r8Var29;
            r8Var29.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            woVar.p0.m(R.drawable.msg_log, LocaleController.getString(R.string.BotEditIntro), true);
            woVar.R.addView(woVar.p0, w7.x5.n(-1, -2));
            final int i37 = 9;
            woVar.p0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
            ...
            woVar.q0 = r8Var30;
            r8Var30.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            woVar.q0.m(R.drawable.msg_media, LocaleController.getString(R.string.BotEditCommands), true);
            woVar.R.addView(woVar.q0, w7.x5.n(-1, -2));
            final int i38 = 10;
            woVar.q0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
            ...
            woVar.r0 = r8Var31;
            r8Var31.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
            woVar.r0.m(R.drawable.msg_bot, LocaleController.getString(R.string.BotChangeSettings), true);
            woVar.R.addView(woVar.r0, w7.x5.n(-1, -2));
            final int i39 = 11;
            woVar.r0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
        ...
        if (chat6 != null) {
        ...
        } else if (woVar.D0 != null) {
            woVar.s0 = new org.telegram.ui.Cells.e9(context2, i12, woVar.resourceProvider);
            String string = LocaleController.getString(R.string.BotManageInfo);
            SpannableString valueOf = SpannableString.valueOf(string);
            int indexOf = string.indexOf("@BotFather");
            if (indexOf != -1) {
                valueOf.setSpan(new vo(0), indexOf, indexOf + 10, 33);
            }
            woVar.s0.setText(valueOf);
            xdVar.addView(woVar.s0, w7.x5.n(-1, -2));
            ...
            woVar.u0.m(R.drawable.menu_factcheck, LocaleController.getString(R.string.BotVerifyAccounts), false);
            org.telegram.ui.Cells.r8 r8Var33 = woVar.u0;
            int i40 = org.telegram.ui.ActionBar.i6.q6;
            r8Var33.e(i40, i40);
            xdVar.addView(woVar.u0, w7.x5.n(-1, -2));
            final int i41 = 13;
            woVar.u0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.go
                public final /* synthetic */ wo b;
            ...
            org.telegram.ui.Cells.e9 e9Var2 = new org.telegram.ui.Cells.e9(context2, i12, woVar.resourceProvider);
            woVar.t0 = e9Var2;
            e9Var2.setFixedSize(i12);
            xdVar.addView(woVar.t0, w7.x5.n(-1, -2));
            org.telegram.ui.Cells.r8 r8Var34 = woVar.u0;
            TLRPC.UserFull userFull2 = woVar.E0;
            r8Var34.setVisibility((userFull2 == null || (botInfo2 = userFull2.bot_info) == null || botInfo2.verifier_settings == null) ? 8 : 0);
            org.telegram.ui.Cells.e9 e9Var3 = woVar.t0;
            TLRPC.UserFull userFull3 = woVar.E0;
            e9Var3.setVisibility((userFull3 == null || (botInfo = userFull3.bot_info) == null || botInfo.verifier_settings == null) ? 8 : 0);
            TLRPC.User user2 = woVar.D0;
            if (user2.bot && user2.bot_can_edit) {
                LinearLayout linearLayout5 = new LinearLayout(context2);
                woVar.S = linearLayout5;
                linearLayout5.setOrientation(1);
                xdVar.addView(woVar.S, w7.x5.n(-1, -2));
                ...
                woVar.S.addView(m4Var, w7.x5.n(-1, -2));
                ...
                woVar.m0.setPrioritizeTitleOverValue(true);
                woVar.S.addView(woVar.m0, w7.x5.n(-1, -2));
                final yh.o g11 = yh.o.g(woVar.currentAccount);
                final int i42 = 0;
                woVar.m0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.io
                    public final /* synthetic */ wo b;
                        ...
                        switch (i42) {
                            case 0:
                                ...
                                if (g11.h(j11, false) != null) {
                                    woVar3.presentFragment(new yh.g(1, j11));
                                    break;
                                }
                                break;
                            default:
                                ...
                                if (g11.h(j12, false) != null) {
                                    woVar4.presentFragment(new yh.g(0, j12));
                                    break;
                                }
                                break;
                        }
                ...
                if (g11.m(j3)) {
                    ...
                    woVar.m0.q(LocaleController.getString(R.string.BotBalanceTON), spannableStringBuilder, R.drawable.outline_gram_24, true);
                } else {
                    SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder("x");
                    spannableStringBuilder2.setSpan(new org.telegram.ui.Components.h90(AndroidUtilities.dp(30.0f), woVar.m0.c), 0, spannableStringBuilder2.length(), 33);
                    woVar.m0.q(LocaleController.getString(R.string.BotBalanceTON), spannableStringBuilder2, R.drawable.outline_gram_24, false);
                }
                woVar.m0.setVisibility(g11.b(j3) ? 0 : 8);
                org.telegram.ui.Cells.r8 r8Var36 = new org.telegram.ui.Cells.r8(context2);
                woVar.n0 = r8Var36;
                r8Var36.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                final int i44 = 1;
                woVar.n0.setPrioritizeTitleOverValue(true);
                woVar.S.addView(woVar.n0, w7.x5.n(-1, -2));
                woVar.n0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.io
                    public final /* synthetic */ wo b;
                ...
                if (g11.h(j3, false) != null) {
                    org.telegram.ui.Cells.r8 r8Var37 = woVar.n0;
                    ...
                    if (g11.c(j3).amount <= 0) {
                        ...
                        z10 = false;
                        X0 = yh.x7.X0(false, TextUtils.concat("XTR", yh.x7.K0(g11.c(j3), 0.85f, ' ')), 0.85f, null);
                    }
                    ...
                    spannableStringBuilder3.setSpan(new org.telegram.ui.Components.h90(AndroidUtilities.dp(30.0f), woVar.n0.c), 0, spannableStringBuilder3.length(), 33);
                    woVar.n0.q(LocaleController.getString(R.string.BotBalanceStars), spannableStringBuilder3, R.drawable.menu_premium_main, false);
                }
                woVar.n0.setVisibility(g11.a(j3) ? 0 : 8);
                org.telegram.ui.Cells.e9 e9Var4 = new org.telegram.ui.Cells.e9(context2, 12, woVar.getResourceProvider());
                e9Var4.setFixedSize(12);
                num2 = num;
                e9Var4.setTag(R.id.fit_width_tag, num2);
                xdVar.addView(e9Var4, w7.x5.n(-1, 12));
                woVar.S.setVisibility((woVar.n0.getVisibility() == 0 || woVar.m0.getVisibility() == 0) ? 0 : 8);
                chat = woVar.x0;
                i13 = 14;
                if ((chat == null && chat.creator) || ((user = woVar.D0) != null && user.bot && user.bot_can_edit)) {
                    final long j11 = chat != null ? chat.linked_community_id : woVar.D0.linked_community_id;
                    final long j12 = chat != null ? -chat.id : woVar.D0.id;
                    final boolean z17 = woVar.D0 != null;
                    if (j11 != 0) {
                        gi.b bVar = new gi.b(context2, woVar.resourceProvider);
                        woVar.h0 = bVar;
                        bVar.a(woVar.currentAccount, woVar.getMessagesController().getChat(Long.valueOf(j11)));
                        final int i45 = 0;
                        woVar.h0.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                        woVar.h0.setOnClickListener(new View.OnClickListener(woVar) { // from class: org.telegram.ui.jo
                            public final /* synthetic */ wo b;
                            ...
                            public final void onClick(View view) {
                                switch (i45) {
                                    case 0:
                                        wo woVar3 = this.b;
                                        MessagesController messagesController = woVar3.getMessagesController();
                                        long j13 = j11;
                                        if (!ChatObject.hasAdminRights(messagesController.getChat(Long.valueOf(j13)))) {
                                            woVar3.showDialog(new fi.k0(woVar3, j13, null, null));
                                            break;
                                        } else {
                                            woVar3.presentFragment(new fi.p(w.c.e(j13, "community_id")));
                                            break;
                                        }
                                    default:
                                        wo woVar4 = this.b;
                                        ...
                                        woVar4.presentFragment(new fi.f(bundle));
                                        break;
                                }
                            }
                        });
                        xdVar.addView(woVar.h0, w7.x5.n(-1, -2));
                        org.telegram.ui.Cells.r8 r8Var38 = new org.telegram.ui.Cells.r8(context2);
                        woVar.j0 = r8Var38;
                        r8Var38.m(R.drawable.outline_community_remove_24, LocaleController.getString(z17 ? R.string.CommunityRemoveBotFromCommunity : woVar.I0 ? R.string.CommunityRemoveChannelFromCommunity : R.string.CommunityRemoveGroupFromCommunity), false);
                        org.telegram.ui.Cells.r8 r8Var39 = woVar.j0;
                        int i46 = org.telegram.ui.ActionBar.i6.p7;
                        r8Var39.e(i46, i46);
                        woVar.j0.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                        org.telegram.ui.Cells.r8 r8Var40 = woVar.j0;
                        woVar2 = woVar;
                        f7 = -2.0f;
                        context3 = context;
                        r8Var40.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ko
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                String string3 = LocaleController.getString(R.string.CommunityMenuRemoveFromCommunity);
                                wo woVar3 = wo.this;
                                org.telegram.ui.Components.c5.v0(woVar3, string3, LocaleController.getString(z17 ? R.string.CommunityMenuRemoveBotFromCommunityConfirm : woVar3.I0 ? R.string.CommunityMenuRemoveChannelFromCommunityConfirm : R.string.CommunityMenuRemoveGroupFromCommunityConfirm), LocaleController.getString(R.string.Remove), true, new ro(woVar3, j12, j11, 0));
                            }
                        });
                        xdVar.addView(woVar2.j0, w7.x5.n(-1, -2));
                        org.telegram.ui.Cells.e9 e9Var5 = new org.telegram.ui.Cells.e9(context3, 12, woVar2.getResourceProvider());
                        woVar2.k0 = e9Var5;
                        e9Var5.setFixedSize(14);
                        woVar2.k0.setTag(R.id.fit_width_tag, num2);
                        xdVar.addView(woVar2.k0, w7.x5.n(-1, 14));
                    } else {
                        woVar2 = woVar;
                        f7 = -2.0f;
                        context3 = context2;
                        ...
                        woVar2.g0 = r8Var41;
                        r8Var41.e(org.telegram.ui.ActionBar.i6.v6, org.telegram.ui.ActionBar.i6.u6);
                        woVar2.g0.setTextColor(org.telegram.ui.ActionBar.i6.u0(org.telegram.ui.ActionBar.i6.il));
                        woVar2.g0.setBackground(org.telegram.ui.ActionBar.i6.K0(false));
                        woVar2.g0.m(R.drawable.msg_groups, LocaleController.getString(z17 ? R.string.CommunityAddBotToCommunity : woVar2.I0 ? R.string.CommunityAddChannelToCommunity : R.string.CommunityAddGroupToCommunity), false);
                        final int i47 = 1;
                        woVar2.g0.setOnClickListener(new View.OnClickListener(woVar2) { // from class: org.telegram.ui.jo
                            public final /* synthetic */ wo b;
                        ...
                        org.telegram.ui.Cells.e9 e9Var6 = new org.telegram.ui.Cells.e9(context3, 12, woVar2.resourceProvider);
                        woVar2.i0 = e9Var6;
                        e9Var6.setText(LocaleController.getString(z17 ? R.string.CommunityAddBotToCommunityInfo : woVar2.I0 ? R.string.CommunityAddChannelToCommunityInfo : R.string.CommunityAddGroupToCommunityInfo));
                        xdVar.addView(woVar2.g0, w7.x5.n(-1, -2));
                        xdVar.addView(woVar2.i0, w7.x5.n(-1, -2));
                    }
                } else {
                    woVar2 = woVar;
                    f7 = -2.0f;
                ...
                if (chat2 != null && chat2.creator) {
                    ...
                    woVar2.d0.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(false));
                    if (woVar2.D0 == null) {
                        woVar2.d0.b(LocaleController.getString(R.string.DeleteBot), false);
                    } else if (woVar2.I0) {
                        woVar2.d0.b(LocaleController.getString(R.string.ChannelDelete), false);
                    } else {
                        woVar2.d0.b(LocaleController.getString(R.string.DeleteAndExitButton), false);
                    }
                    woVar2.c0.addView(woVar2.d0, w7.x5.c(f7, -1));
                    woVar2.d0.setOnClickListener(new View.OnClickListener(woVar2) { // from class: org.telegram.ui.go
                        public final /* synthetic */ wo b;
                        ...
                        public final void onClick(View view) {
                            switch (i13) {
                                ...
                                case 1:
                                    ...
                                    if (!woVar4.s.h()) {
                                        ImageLocation imageLocation = null;
                                        TLRPC.User user22 = j32 == 0 ? null : woVar4.getMessagesController().getUser(Long.valueOf(j32));
                                        if (user22 == null) {
                                            TLRPC.Chat chat32 = woVar4.getMessagesController().getChat(Long.valueOf(woVar4.w0));
                                            TLRPC.ChatPhoto chatPhoto = chat32.photo;
                                            if (chatPhoto != null && chatPhoto.photo_big != null) {
                                            ...
                                            if (userProfilePhoto != null && userProfilePhoto.photo_big != null) {
                                                ...
                                                PhotoViewer.t1().e2(null, user22.photo.photo_big, null, null, null, null, null, 0, soVar, null, 0L, 0L, 0L, true, null, null);
                                                break;
                                            }
                                        }
                                    }
                                ...
                                case 17:
                                    ...
                                    wpVar.P = false;
                                    wpVar.E = j112;
                                    TLRPC.Chat chat42 = wpVar.getMessagesController().getChat(Long.valueOf(j112));
                                    wpVar.f = chat42;
                                    if (ChatObject.isChannel(chat42) && !wpVar.f.megagroup) {
                                        z162 = true;
                                    }
                                ...
                                case 23:
                                    ...
                                    if (ChatObject.isChannelAndNotMegaGroup(woVar20.x0)) {
                                        ...
                                        if (chatFull9 != null) {
                                            if (dqVar.a == null) {
                                                dqVar.a = dqVar.getMessagesController().getChat(Long.valueOf(j122));
                                            }
                                            dqVar.d = new ArrayList();
                                            TLRPC.ChatReactions chatReactions = chatFull9.available_reactions;
                                            if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
                ...
                org.telegram.ui.Components.ju juVar6 = woVar2.v;
                TLRPC.User user3 = woVar2.D0;
                juVar6.setText(Emoji.replaceEmoji(user3 == null ? ContactsController.formatName(user3) : woVar2.x0.title, woVar2.v.getEditText().getPaint().getFontMetricsInt(), true));
                org.telegram.ui.Components.ju juVar7 = woVar2.v;
                juVar7.setSelection(juVar7.n());
                chatFull = woVar2.y0;
                if (chatFull == null) {
                    woVar2.E.setText(chatFull.about);
                } else {
                    TLRPC.UserFull userFull4 = woVar2.E0;
                    if (userFull4 != null) {
                        woVar2.E.setText(userFull4.about);
                    }
                }
                woVar2.k0();
                woVar2.p0(true, false);
                return woVar2.fragmentView;
            }
        }
        num2 = num;
        chat = woVar.x0;
        ...
        org.telegram.ui.Components.ju juVar62 = woVar2.v;
        TLRPC.User user32 = woVar2.D0;
        juVar62.setText(Emoji.replaceEmoji(user32 == null ? ContactsController.formatName(user32) : woVar2.x0.title, woVar2.v.getEditText().getPaint().getFontMetricsInt(), true));
        org.telegram.ui.Components.ju juVar72 = woVar2.v;
        juVar72.setSelection(juVar72.n());
        chatFull = woVar2.y0;
        if (chatFull == null) {
        }
        woVar2.k0();
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (((Long) objArr[0]).longValue() == j3) {
            if (this.n0 != null) {
                ...
                this.n0.u(yh.x7.X0(false, TextUtils.concat("XTR", yh.x7.J0(g10.c(j3), 0.8f, ' ')), 0.85f, null), true);
    ...
    public final boolean e0(boolean z10) {
        ...
        if (this.C0 != 0) {
            ...
            org.telegram.ui.Components.ju juVar2 = this.v;
            if ((juVar2 == null || this.D0.first_name.equals(juVar2.getText().toString())) && ((editTextBoldCursor2 = this.E) == null || str3.equals(editTextBoldCursor2.getText().toString()))) {
                return true;
            }
            if (z10) {
                ...
                alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new no(this, 0));
                alertDialog$Builder.h(LocaleController.getString(R.string.PassportDiscard), new no(this, 1));
            ...
            if ((chatFull == null || !ChatObject.isChannel(this.x0) || this.y0.hidden_prehistory == this.J0) && (((juVar = this.v) == null || this.x0.title.equals(juVar.getText().toString())) && (((editTextBoldCursor = this.E) == null || str3.equals(editTextBoldCursor.getText().toString())) && this.F0 == this.x0.forum))) {
                return true;
            }
            if (z10) {
                ...
                alertDialog$Builder2.k(LocaleController.getString("ApplyTheme", R.string.ApplyTheme), new no(this, 2));
                alertDialog$Builder2.h(LocaleController.getString("PassportDiscard", R.string.PassportDiscard), new no(this, 3));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(uoVar, 4096, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.b0, 4, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.u6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.b0, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.v6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.W, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.V, 4096, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.V, 4, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.V, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i12));
        org.telegram.ui.Cells.r8 r8Var = this.U;
        if (r8Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.k6(r8Var, 4096, null, null, null, null, i10));
            arrayList.add(new org.telegram.ui.ActionBar.k6(this.U, 4, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
            arrayList.add(new org.telegram.ui.ActionBar.k6(this.U, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i12));
        }
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.X, 4096, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.X, 4, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.X, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.Y, 4096, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.Y, 4, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.N, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.H, 4096, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(juVar, TLObject.FLAG_23, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.v, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.k6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.v, 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.l6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.E, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.E, TLObject.FLAG_23, null, null, null, null, i14));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.y, 1, null, null, null, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.F, 1, null, null, null, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c0, 1, null, null, null, null, i15));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.G, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.P, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.e0, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d0, 4096, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d0, 4, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.p7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 4096, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 4, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.Fi));
        int i17 = org.telegram.ui.ActionBar.i6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i17));
        int i18 = org.telegram.ui.ActionBar.i6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i18));
        ...
        if (r8Var2 != null) {
            arrayList.add(new org.telegram.ui.ActionBar.k6(r8Var2, 4096, null, null, null, null, i10));
        ...
        if (r8Var3 != null) {
            ...
            arrayList.add(new org.telegram.ui.ActionBar.k6(this.a0, 4, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
            arrayList.add(new org.telegram.ui.ActionBar.k6(this.a0, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i12));
        }
        return arrayList;
    }
    ...
    public final void h0() {
        ...
        getConnectionsManager().sendRequest(tL_messages_getExportedChatInvites, new mo(this, 0));
    }

    public final void i0() {
        this.s.o(this.v0 != null, new oo(this, 0), new r5(this, 5), 0);
        this.R0.M(0);
        this.R0.P(43);
        this.b0.e.d();
    }
    ...
    public final void j0() {
        ...
        if (this.D0 != null) {
            ...
            this.b.setOnCancelListener(new ba(this, getConnectionsManager().sendRequest(setbotinfo, new qo(i10, this, setbotinfo)), 2));
            this.b.show();
            return;
        }
        if (!ChatObject.isChannel(this.x0) && (!this.J0 || this.F0)) {
            getMessagesController().convertToMegaGroup(getParentActivity(), this.w0, this, new no(this, 5));
            return;
        }
        ...
        if (z12 != chat.forum || this.H0 != chat.forum_tabs) {
            ...
            if (this.F0 && !this.H0) {
                ...
                while (i10 < fragmentStack.size()) {
                    if ((fragmentStack.get(i10) instanceof bo) && ((bo) fragmentStack.get(i10)).getArguments().getLong("chat_id") == this.w0) {
    ...
    */
    public final void k0() {
        ...
        this.D0 = user;
        this.x0 = chat;
        org.telegram.ui.Components.f9 f9Var = this.r;
        if (user == null ? chat.photo == null : user.photo == null) {
            this.e.setImageDrawable(f9Var);
        } else {
    ...
    public final void l0(TLRPC.ChatFull chatFull) {
        org.telegram.ui.Components.o5 n10;
        this.y0 = chatFull;
        if (chatFull != null) {
            if (this.x0 == null) {
                ...
                if (chatReactions instanceof TLRPC.TL_chatReactionsSome) {
                    ...
                    while (i10 < size) {
                        ...
                        if (reaction2 instanceof TLRPC.TL_reactionEmoji) {
                            ...
                            if (tL_availableReaction != null) {
                                n10 = org.telegram.ui.Components.o5.m(UserConfig.selectedAccount, org.telegram.ui.Components.o5.g(), tL_availableReaction.activate_animation);
                            }
                        } else {
                            n10 = reaction2 instanceof TLRPC.TL_reactionCustomEmoji ? org.telegram.ui.Components.o5.n(UserConfig.selectedAccount, ((TLRPC.TL_reactionCustomEmoji) reaction2).document_id, null, org.telegram.ui.Components.o5.g()) : null;
                        }
                        if (n10 != null) {
                            arrayList2.add(n10);
                            n10.b(null);
                    ...
                    for (TLRPC.TL_availableReaction tL_availableReaction2 : MediaDataController.getInstance(UserConfig.selectedAccount).getEnabledReactionsList()) {
                        if (tL_availableReaction2 != null) {
                            org.telegram.ui.Components.o5 m10 = org.telegram.ui.Components.o5.m(UserConfig.selectedAccount, org.telegram.ui.Components.o5.g(), tL_availableReaction2.activate_animation);
                            arrayList2.add(m10);
                            m10.b(null);
                        }
                    }
    ...
    public final void n0(boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(radialProgressView, (Property<RadialProgressView, Float>) property, 1.0f), ObjectAnimator.ofFloat(this.f, (Property<ci.s6, Float>) property, 1.0f));
        } else {
            RadialProgressView radialProgressView2 = this.n;
            Property property2 = View.ALPHA;
            animatorSet2.playTogether(ObjectAnimator.ofFloat(radialProgressView2, (Property<RadialProgressView, Float>) property2, 0.0f), ObjectAnimator.ofFloat(this.f, (Property<ci.s6, Float>) property2, 0.0f));
        }
    ...
    public final void o0() {
        ...
        if (fp0Var != null) {
            ...
            fp0Var.v = z10;
            fp0Var.r = new org.telegram.ui.Components.g01(Emoji.replaceEmoji(chat.title, org.telegram.ui.ActionBar.i6.o2.getFontMetricsInt(), false), 13.0f, AndroidUtilities.bold());
            ...
            if (peerColor instanceof TLRPC.TL_peerColorCollectible) {
                ...
                fp0Var.r.o(i13);
                paint.setColor(org.telegram.ui.ActionBar.i6.l1(0.1f, i13));
            ...
            if (colorId < 7) {
                int i14 = org.telegram.ui.ActionBar.i6.r8[colorId];
                fp0Var.s = i14;
                v02 = org.telegram.ui.ActionBar.i6.v0(i14, e6Var);
            } else {
                ...
                if (color != null) {
                    ...
                    int i15 = org.telegram.ui.ActionBar.i6.r8[0];
                    fp0Var.s = i15;
                    v02 = org.telegram.ui.ActionBar.i6.v0(i15, e6Var);
                }
            }
            fp0Var.r.o(v02);
    ...
    */
    public final boolean onFragmentCreate() {
        ...
        if (chat == null) {
            ...
            f9Var2.n(5L, this.x0.title, null);
            ...
            f9Var2.n(5L, this.D0.first_name, null);
            this.I0 = false;
            this.F0 = false;
            this.H0 = false;
            this.G0 = false;
    ...
    public final void onPause() {
        ...
        while (i10 < size) {
            ...
            i10++;
            ((org.telegram.ui.Components.o5) obj).p(null);
        }
        org.telegram.ui.Components.ju juVar = this.v;
        if (juVar != null) {
            juVar.r();
        ...
        if (this.N != null) {
            ...
            if (this.N.getAlpha() <= 0.0f && !z14) {
                ...
                if (z11) {
                    ...
                    this.S0.setInterpolator(org.telegram.ui.Components.qr.h);
                    this.S0.start();
                } else {
                ...
                if (!this.I0 || ChatObject.isCommunity(this.x0)) {
                    ...
                    if (!chat3.gigagroup || ChatObject.isCommunity(chat3)) {
                        ...
                        if (tL_chatBannedRights != null) {
                            ...
                            i10 = ur.n0(tL_chatBannedRights) + i27;
    ...
    public final void q0() {
        ...
        int i10 = 0;
        while (i10 < fragmentStack.size()) {
            if (fragmentStack.get(i10) instanceof bo) {
                bo boVar = (bo) fragmentStack.get(i10);
                if (boVar.getArguments().getLong("chat_id") == this.w0) {
                    ((ActionBarLayout) getParentLayout()).a0(boVar, false);
                    boVar.clearViews();
                    ((ActionBarLayout) getParentLayout()).c(i10, boVar);
                    if (!this.H0) {
                        Bundle bundle = new Bundle();
                        bundle.putLong("chat_id", this.w0);
    ...
    public final void t0(Long l4) {
        ...
        this.K.s(LocaleController.getString(R.string.PostSuggestions), yh.x7.X0(false, LocaleController.formatString(R.string.PostSuggestionsStars, Long.valueOf(j3)), 0.66f, null), false, R.drawable.msg_markunread, true);
    }
