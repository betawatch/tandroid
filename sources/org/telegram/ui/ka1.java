...
public abstract class ka1 extends FrameLayout {
    ...
    public ka1(Context context, int i10, ig.f fVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.d = cVar;
        cVar.d.setOnTouchListener(new org.telegram.ui.Components.vk0());
        final int i11 = 0;
        cVar.d.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ga1
        ...
        if (i10 == 1) {
            this.b = new ig.k(getContext(), f6Var);
            ig.k kVar = new ig.k(getContext(), f6Var);
            this.c = kVar;
            kVar.t0.y = true;
        } else if (i10 == 2) {
            this.b = new ig.p(getContext(), f6Var);
        ...
        this.b.setDateSelectionListener(new nl0(this, 20));
        this.b.t0.d(false, false);
        this.b.t0.setOnTouchListener(new org.telegram.ui.Components.vk0());
        final int i13 = 1;
        this.b.t0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ga1
            public final /* synthetic */ ka1 b;
        ...
        final int i14 = 2;
        this.c.t0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ga1
            public final /* synthetic */ ka1 b;
    ...
    public final ValueAnimator a(long j3, boolean z10) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ha1
    ...
    public final void d() {
        ...
        if (ma1Var != null && (bVar = ma1Var.d) != null && (arrayList = bVar.d) != null && arrayList.size() > 1) {
            for (int i10 = 0; i10 < this.r.d.d.size(); i10++) {
                int w02 = (((jg.a) this.r.d.d.get(i10)).g < 0 || !org.telegram.ui.ActionBar.j6.c1(((jg.a) this.r.d.d.get(i10)).g)) ? i0.a.f(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false)) < 0.5d ? ((jg.a) this.r.d.d.get(i10)).i : ((jg.a) this.r.d.d.get(i10)).h : org.telegram.ui.ActionBar.j6.w0(null, ((jg.a) this.r.d.d.get(i10)).g, false);
                ArrayList arrayList2 = this.n;
                if (i10 < arrayList2.size()) {
                    org.telegram.ui.Components.s00 s00Var = ((ja1) arrayList2.get(i10)).a;
                    s00Var.getClass();
    ...
    public final void e(ma1 ma1Var, boolean z10) {
        ...
        kg.e eVar = gVar.t0;
        boolean z13 = ma1Var.n;
        eVar.a = z13;
        cVar.c(!z13);
        if (ma1Var.d == null && ma1Var.f != null) {
        ...
        cVar.setUseWeekInterval(ma1Var.o);
        gVar.t0.setUseWeek(ma1Var.o);
        kg.e eVar2 = gVar.t0;
        ...
        if (size > 1) {
            for (int i10 = 0; i10 < size; i10++) {
                ...
                s00Var.setOnTouchListener(new org.telegram.ui.Components.vk0());
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (((jg.a) bVar.d.get(i12)).c.equals(((jg.a) this.r.d.d.get(i10)).c)) {
                        boolean z12 = ((ja1) arrayList.get(i10)).a.b;
                        ((kg.f) arrayList2.get(i12)).n = z12;
                        ((kg.f) arrayList2.get(i12)).o = z12 ? 1.0f : 0.0f;
                        ((ja1) arrayList.get(i10)).a.c = true;
                        ((ja1) arrayList.get(i10)).a.animate().alpha(1.0f).start();
                        if (z12) {
                            i11++;
                        }
                        z11 = true;
                ...
                if (!z11) {
                    ((ja1) arrayList.get(i10)).a.c = false;
                    ((ja1) arrayList.get(i10)).a.animate().alpha(0.0f).start();
                }
                i10++;
            }
            if (i11 == 0) {
                for (int i13 = 0; i13 < this.r.d.d.size(); i13++) {
                    ((ja1) arrayList.get(i13)).a.c = true;
                    ((ja1) arrayList.get(i13)).a.animate().alpha(1.0f).start();
                }
                return;
            }
        }
    ...
    public final void h(boolean z10) {
        jg.b bVar;
        ma1 ma1Var = this.r;
        if (ma1Var == null || (bVar = ma1Var.d) == null || bVar.a == null) {
            return;
        }
        kg.c cVar = this.d;
        ...
        if (z10) {
            ...
            while (i10 < size) {
                ...
                i10++;
                ja1 ja1Var = (ja1) obj;
                ja1Var.a.animate().alpha(1.0f).start();
                ja1Var.a.c = true;
            }
            a2.start();
            return;
