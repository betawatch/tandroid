...
public final class iz extends LinearLayout {
    ...
    public iz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.a = f6Var;
        setOrientation(0);
        ...
        this.c = p9Var;
        p9Var.setImageDrawable(new org.telegram.ui.Components.gj0(R.raw.topics_tabs, AndroidUtilities.dp(160.0f), AndroidUtilities.dp(160.0f)));
        ...
        this.f = p9Var2;
        p9Var2.setImageDrawable(new org.telegram.ui.Components.gj0(R.raw.topics_list, AndroidUtilities.dp(160.0f), AndroidUtilities.dp(160.0f)));
    ...
    public final void a(boolean z4, boolean z10) {
        ...
        if (z10) {
            ...
            alpha.setInterpolator(mrVar).setDuration(320L).start();
            frameLayout.animate().scaleX(z4 ? 0.0f : 1.0f).scaleY(z4 ? 0.0f : 1.0f).alpha(z4 ? 0.0f : 1.0f).setInterpolator(mrVar).setDuration(320L).start();
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.r, z4 ? 1.0f : 0.0f);
            this.n = ofFloat;
            ofFloat.addUpdateListener(new g3(this, 11));
            this.n.addListener(new org.telegram.ui.Components.m00(19, this, z4));
            this.n.setInterpolator(mrVar);
