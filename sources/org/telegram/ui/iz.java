...
public final class iz extends LinearLayout {
    ...
    public iz(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.a = d6Var;
        setOrientation(0);
        ...
        this.c = w9Var;
        w9Var.setImageDrawable(new org.telegram.ui.Components.yi0(R.raw.topics_tabs, AndroidUtilities.dp(160.0f), AndroidUtilities.dp(160.0f)));
        frameLayout.addView(w9Var, w7.x5.d(160, 160.0f, 49, 0.0f, 12.33f, 0.0f, 0.0f));
        ...
        frameLayout3.setBackground(org.telegram.ui.ActionBar.h6.b0(dp, org.telegram.ui.ActionBar.h6.v0(i11, d6Var)));
        ...
        this.f = w9Var2;
        w9Var2.setImageDrawable(new org.telegram.ui.Components.yi0(R.raw.topics_list, AndroidUtilities.dp(160.0f), AndroidUtilities.dp(160.0f)));
        frameLayout4.addView(w9Var2, w7.x5.d(160, 160.0f, 49, 0.0f, 12.33f, 0.0f, 0.0f));
        ...
        frameLayout6.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(13.0f), org.telegram.ui.ActionBar.h6.v0(i11, d6Var)));
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            int i11 = org.telegram.ui.ActionBar.h6.Oh;
            int d = i0.a.d(this.r, v02, org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
            PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
            w9Var2.setColorFilter(new PorterDuffColorFilter(d, mode));
            w9Var2.invalidate();
            w9Var.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.r, org.telegram.ui.ActionBar.h6.v0(i10, d6Var), org.telegram.ui.ActionBar.h6.v0(i11, d6Var)), mode));
            w9Var.invalidate();
        }
        if (z10) {
            w9Var = w9Var2;
        }
        org.telegram.ui.Components.yi0 lottieAnimation = w9Var.getImageReceiver().getLottieAnimation();
