    ...
    */
                ...
                while (true) {
                    ...
                    if (i13 >= arrayList2.size()) {
                        ...
                        if (z10 && !z13 && UserConfig.getInstance(this.b).clientUserId != this.I) {
                            int i19 = this.r;
                            if (i19 != 0 && i19 != i10 && (ejVar = this.y) != null) {
    ...
    public final void e(Canvas canvas) {
        ...
        while (i10 < this.F.size()) {
            ...
            zg.d dVar2 = hzVar.j;
            boolean c10 = dVar2 != null ? dVar2.c() : hzVar.l && hzVar.r.getLottieAnimation() != null && hzVar.r.getLottieAnimation().a0 >= hzVar.r.getLottieAnimation().e[0] + (-2);
            if (hzVar.o == 1.0f || c10 || z12) {
                ...
                i10--;
            } else if (hzVar.r.getLottieAnimation() != null && hzVar.r.getLottieAnimation().k0) {
                hzVar.l = true;
            } else if (hzVar.r.getLottieAnimation() != null && !hzVar.r.getLottieAnimation().k0) {
        ...
        if (t1Var.getMessageObject().isPremiumSticker() || boVar.f != null) {
            ...
            if ((printingStringType == null || printingStringType.intValue() != 5) && this.E == null && o9) {
                ...
                if ((ocVar == null || !ocVar.l) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.b).getClientUserId() != boVar.f.id) {
                    ...
                    i9.s sVar = new i9.s(this, org.telegram.ui.Components.oc.g(boVar, bx0Var, 2750), z11, 23);
                    this.E = sVar;
    ...
    public final void p(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, MessageObject messageObject) {
        ...
        mcVar.a = new mw(6, this, messageObject);
