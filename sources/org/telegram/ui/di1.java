...
public final class di1 extends ViewGroup {
    ...
    public final void a(org.telegram.ui.Components.w30 w30Var, boolean z10) {
        ...
        bi.t2 t2Var = usersSelectActivity.c;
        ...
        if (z10) {
            ...
            arrayList.clear();
            arrayList.add(ObjectAnimator.ofFloat(this.d, (Property<org.telegram.ui.Components.w30, Float>) View.SCALE_X, 0.01f, 1.0f));
            arrayList.add(ObjectAnimator.ofFloat(this.d, (Property<org.telegram.ui.Components.w30, Float>) View.SCALE_Y, 0.01f, 1.0f));
            arrayList.add(ObjectAnimator.ofFloat(this.d, (Property<org.telegram.ui.Components.w30, Float>) View.ALPHA, 0.0f, 1.0f));
        }
        addView(w30Var);
    }
    ...
    public final void b(org.telegram.ui.Components.w30 w30Var) {
        ...
        ArrayList arrayList = this.c;
        arrayList.clear();
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.w30, Float>) View.SCALE_X, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.w30, Float>) View.SCALE_Y, 1.0f, 0.01f));
        ...
        if (!this.b) {
            ...
            if (this.a != null) {
                ...
                if (usersSelectActivity.c.getTranslationX() != f11) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.c, (Property<bi.t2, Float>) property2, f11));
                }
                float translationY = usersSelectActivity.c.getTranslationY();
                float f12 = usersSelectActivity.Q;
                if (translationY != f12) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.c, (Property<bi.t2, Float>) property, f12));
                }
