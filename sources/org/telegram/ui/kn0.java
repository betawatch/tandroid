...
public final class kn0 extends org.telegram.ui.Components.fw0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public kn0(on0 on0Var, Context context, int i10) {
        ...
        org.telegram.messenger.a2.q(textView2, org.telegram.ui.ActionBar.j6.w0(null, i12, false), 1, 18.0f);
        ...
        if (i10 == 3) {
            ...
            addView(frameLayout, w7.a6.q(-2, -2, LocaleController.isRTL ? 5 : 3));
            ImageView imageView = new ImageView(context);
            imageView.setImageResource(R.drawable.phone_activate);
            boolean z10 = LocaleController.isRTL;
            if (z10) {
                frameLayout.addView(imageView, w7.a6.d(64, 76.0f, 19, 2.0f, 2.0f, 0.0f, 0.0f));
                frameLayout.addView(textView, w7.a6.d(-1, -2.0f, LocaleController.isRTL ? 5 : 3, 82.0f, 0.0f, 0.0f, 0.0f));
            } else {
                frameLayout.addView(textView, w7.a6.d(-1, -2.0f, z10 ? 5 : 3, 0.0f, 0.0f, 82.0f, 0.0f));
        ...
        this.n = hVar;
        hVar.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        hVar.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        if (i10 == 3) {
            hVar.setTextSize(1, 14.0f);
            addView(hVar, w7.a6.q(-2, -2, LocaleController.isRTL ? 5 : 3));
            ...
            addView(ln0Var, w7.a6.k(0.0f, 12.0f, 0.0f, 0.0f, -1, 3));
        } else {
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.O) {
            ...
            while (i16 < this.O) {
                ...
                this.c.addView(this.d[i16], w7.a6.t(34, 36, 1, 0, 0, i16 != this.O - 1 ? 7 : 0, 0));
        ...
        String j3 = org.telegram.messenger.a2.j(new StringBuilder("+"), this.a, gf.b.c());
        if (i12 == 2) {
        ...
        if (i12 == i10 && ((i11 = this.M) == 4 || i11 == 3)) {
            ...
            objArr[0] = 2;
            objArr[1] = 0;
            hVar.setText(LocaleController.formatString("CallText", i20, objArr));
            hn0Var.setVisibility(this.y < 1000 ? 0 : 8);
            hVar.setVisibility(this.y < 1000 ? 8 : 0);
            q();
            return;
        }
        if (i12 != 4 || this.M != 2) {
    ...
    public final void p() {
        ...
        this.w.schedule(new bi.b3(this, 4), 0L, 1000L);
    }
