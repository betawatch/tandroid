...
public final class re0 extends org.telegram.ui.Components.fw0 {
    ...
    */
    public re0(qg0 qg0Var, Context context, int i10) {
        super(context);
        boolean z10;
        ...
        this.O = new Object();
        this.P = 60000;
        this.U = new oe0(this, 1);
        this.V = new oe0(this, 2);
        this.W = -3.0f;
        this.a = i10;
        boolean z11 = i10 != 16;
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                d6Var = ((org.telegram.ui.ActionBar.m2) qg0Var).resourceProvider;
                ...
                final int i12 = 0;
                textView3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.pe0
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (i12) {
                            case 0:
                                re0 re0Var = this.b;
                                ci.h2 h2Var2 = re0Var.c;
                                try {
                                    charSequence = ((ClipboardManager) re0Var.getContext().getSystemService("clipboard")).getPrimaryClip().getItemAt(0).coerceToText(re0Var.getContext());
                                } catch (Exception e) {
                                    FileLog.e(e);
                                    charSequence = null;
                                }
                            ...
                            default:
                                ...
                                qg0 qg0Var2 = re0Var2.a0;
                                rf0 rf0Var = re0Var2.v;
                                if (re0Var2.P <= 0 || re0Var2.N == null) {
                                    Bundle bundle = re0Var2.S;
                                    if (bundle != null && (tL_auth_sentCode = re0Var2.T) != null) {
                                        qg0Var2.g1(bundle, tL_auth_sentCode, true);
                                        break;
                                    } else {
                                        int i15 = re0Var2.E;
                                        if (i15 != 4 && i15 != 2 && i15 != 11 && i15 != 15) {
                                            if (i15 == 3) {
                                                ...
                                                if (!re0Var2.R && !re0Var2.M && !qg0Var2.o0) {
                                                    re0Var2.M = true;
                                                    rf0Var.invalidate();
                                                    rf0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.I6, false));
                                                    final Bundle bundle2 = new Bundle();
                                                    bundle2.putString("phone", re0Var2.J);
                                                    bundle2.putString("ephone", re0Var2.I);
                                                    bundle2.putString("phoneFormated", re0Var2.G);
                                                    re0Var2.R = true;
                                                    TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                                                    tL_auth_resendCode.phone_number = re0Var2.G;
                                                    tL_auth_resendCode.phone_code_hash = re0Var2.H;
                                                    i14 = ((org.telegram.ui.ActionBar.m2) qg0Var2).currentAccount;
                                                    final int i16 = 1;
                                                    qg0Var2.n1(ConnectionsManager.getInstance(i14).sendRequest(tL_auth_resendCode, new RequestDelegate() { // from class: org.telegram.ui.le0
                                                        @Override // org.telegram.tgnet.RequestDelegate
                                                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                                            switch (i16) {
                                                                case 0:
                                                                    AndroidUtilities.runOnUIThread(new ne0(re0Var2, tLObject, bundle2, tL_error));
                                                                    break;
                                                                default:
                                                                    AndroidUtilities.runOnUIThread(new ne0(re0Var2, tL_error, bundle2, tLObject));
                                                                    break;
                                                            }
                                                        }
                                                    }, 10), true);
                                            ...
                                            bundle3.putString("phone", re0Var2.J);
                                            bundle3.putString("ephone", re0Var2.I);
                                            bundle3.putString("phoneFormated", re0Var2.G);
                                            bundle3.putInt("prevType", re0Var2.a);
                                            TLRPC.TL_auth_resendCode tL_auth_resendCode2 = new TLRPC.TL_auth_resendCode();
                                            tL_auth_resendCode2.phone_number = re0Var2.G;
                                            tL_auth_resendCode2.phone_code_hash = re0Var2.H;
                                            i13 = ((org.telegram.ui.ActionBar.m2) qg0Var2).currentAccount;
                                            final int i18 = 0;
                                            ConnectionsManager.getInstance(i13).sendRequest(tL_auth_resendCode2, new RequestDelegate() { // from class: org.telegram.ui.le0
                                                @Override // org.telegram.tgnet.RequestDelegate
                                                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                                    switch (i18) {
                                                        case 0:
                                                            AndroidUtilities.runOnUIThread(new ne0(re0Var2, tLObject, bundle3, tL_error));
                                                            break;
                                                        default:
                                                            AndroidUtilities.runOnUIThread(new ne0(re0Var2, tL_error, bundle3, tLObject));
                                                            break;
                                                    }
                                                }
                                            }, 10);
                ...
                org.telegram.ui.Components.voip.o2 o2Var = new org.telegram.ui.Components.voip.o2(qg0Var, context);
                this.d = o2Var;
                int i13 = org.telegram.ui.ActionBar.h6.I6;
                o2Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
                o2Var.setTextColor(qg0Var.getThemedColor(i13));
                ...
                final int i14 = 1;
                o2Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.pe0
                    public final /* synthetic */ re0 b;
                                        ...
                                        if (i15 != 4 && i15 != 2 && i15 != 11 && i15 != 15) {
                                            if (i15 == 3) {
                                                ...
                                                if (!re0Var2.R && !re0Var2.M && !qg0Var2.o0) {
                                                    ...
                                                    tL_auth_resendCode.phone_number = re0Var2.G;
                                                    tL_auth_resendCode.phone_code_hash = re0Var2.H;
                                                    i142 = ((org.telegram.ui.ActionBar.m2) qg0Var2).currentAccount;
                                                    final int i16 = 1;
                                                    qg0Var2.n1(ConnectionsManager.getInstance(i142).sendRequest(tL_auth_resendCode, new RequestDelegate() { // from class: org.telegram.ui.le0
                                                        @Override // org.telegram.tgnet.RequestDelegate
                                                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                                            switch (i16) {
                                                                case 0:
                                            ...
                                            tL_auth_resendCode2.phone_number = re0Var2.G;
                                            tL_auth_resendCode2.phone_code_hash = re0Var2.H;
                                            i132 = ((org.telegram.ui.ActionBar.m2) qg0Var2).currentAccount;
                                            final int i18 = 0;
                                            ConnectionsManager.getInstance(i132).sendRequest(tL_auth_resendCode2, new RequestDelegate() { // from class: org.telegram.ui.le0
                                                @Override // org.telegram.tgnet.RequestDelegate
                                                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                                    switch (i18) {
                                                        case 0:
                ...
                addView(o2Var, w7.y5.t(-2, -2, 1, 0, 18, 0, 0));
                ...
                textView4.setTextColor(qg0Var.getThemedColor(org.telegram.ui.ActionBar.h6.p7));
                ...
                textView5.setTextColor(qg0Var.getThemedColor(org.telegram.ui.ActionBar.h6.y6));
                textView5.setTextSize(1, 13.0f);
                frameLayout.addView(textView5, w7.y5.d(-1, -2.0f, 119, 16.0f, 8.0f, 16.0f, 8.0f));
                rf0 rf0Var = new rf0(this, context);
                this.v = rf0Var;
                rf0Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, i13, false));
                ...
                rf0Var.setTextSize(1, 15.0f);
                rf0Var.setGravity(19);
                final int i15 = 2;
                rf0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.pe0
                    public final /* synthetic */ re0 b;
                                        ...
                                        if (i152 != 4 && i152 != 2 && i152 != 11 && i152 != 15) {
                                            if (i152 == 3) {
                                                ...
                                                if (!re0Var2.R && !re0Var2.M && !qg0Var2.o0) {
                                                    re0Var2.M = true;
                                                    rf0Var2.invalidate();
                                                    rf0Var2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.I6, false));
                                                    final Bundle bundle2 = new Bundle();
                                                    bundle2.putString("phone", re0Var2.J);
                                                    bundle2.putString("ephone", re0Var2.I);
                                                    bundle2.putString("phoneFormated", re0Var2.G);
                ...
                frameLayout2.addView(rf0Var, w7.y5.d(-1, 56.0f, 80, 6.0f, 0.0f, 60.0f, 28.0f));
        ...
        final int i122 = 0;
        textView32.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.pe0
            public final /* synthetic */ re0 b;
        ...
        org.telegram.ui.Components.voip.o2 o2Var2 = new org.telegram.ui.Components.voip.o2(qg0Var, context);
        this.d = o2Var2;
        int i132 = org.telegram.ui.ActionBar.h6.I6;
        o2Var2.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, i132, false));
        o2Var2.setTextColor(qg0Var.getThemedColor(i132));
        ...
        final int i142 = 1;
        o2Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.pe0
            public final /* synthetic */ re0 b;
                                ...
                                if (i152 != 4 && i152 != 2 && i152 != 11 && i152 != 15) {
                                    if (i152 == 3) {
                                        ...
                                        if (!re0Var2.R && !re0Var2.M && !qg0Var2.o0) {
                                            ...
                                            tL_auth_resendCode.phone_number = re0Var2.G;
                                            tL_auth_resendCode.phone_code_hash = re0Var2.H;
                                            i1422 = ((org.telegram.ui.ActionBar.m2) qg0Var2).currentAccount;
                                            final int i16 = 1;
                                            qg0Var2.n1(ConnectionsManager.getInstance(i1422).sendRequest(tL_auth_resendCode, new RequestDelegate() { // from class: org.telegram.ui.le0
                                                @Override // org.telegram.tgnet.RequestDelegate
                                                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                                    switch (i16) {
                                                        case 0:
                                    ...
                                    tL_auth_resendCode2.phone_number = re0Var2.G;
                                    tL_auth_resendCode2.phone_code_hash = re0Var2.H;
                                    i1322 = ((org.telegram.ui.ActionBar.m2) qg0Var2).currentAccount;
                                    final int i18 = 0;
                                    ConnectionsManager.getInstance(i1322).sendRequest(tL_auth_resendCode2, new RequestDelegate() { // from class: org.telegram.ui.le0
                                        @Override // org.telegram.tgnet.RequestDelegate
                                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                            switch (i18) {
                                                case 0:
        ...
        addView(o2Var2, w7.y5.t(-2, -2, 1, 0, 18, 0, 0));
        ...
        textView42.setTextColor(qg0Var.getThemedColor(org.telegram.ui.ActionBar.h6.p7));
        ...
        textView52.setTextColor(qg0Var.getThemedColor(org.telegram.ui.ActionBar.h6.y6));
        textView52.setTextSize(1, 13.0f);
        frameLayout3.addView(textView52, w7.y5.d(-1, -2.0f, 119, 16.0f, 8.0f, 16.0f, 8.0f));
        rf0 rf0Var2 = new rf0(this, context);
        this.v = rf0Var2;
        rf0Var2.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, i132, false));
        ...
        rf0Var2.setTextSize(1, 15.0f);
        rf0Var2.setGravity(19);
        final int i152 = 2;
        rf0Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.pe0
            public final /* synthetic */ re0 b;
                                ...
                                if (i1522 != 4 && i1522 != 2 && i1522 != 11 && i1522 != 15) {
                                    if (i1522 == 3) {
                                        ...
                                        if (!re0Var2.R && !re0Var2.M && !qg0Var2.o0) {
                                            re0Var2.M = true;
                                            rf0Var22.invalidate();
                                            rf0Var22.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.I6, false));
                                            final Bundle bundle2 = new Bundle();
                                            bundle2.putString("phone", re0Var2.J);
                                            bundle2.putString("ephone", re0Var2.I);
                                            bundle2.putString("phoneFormated", re0Var2.G);
        ...
        frameLayout22.addView(rf0Var2, w7.y5.d(-1, 56.0f, 80, 6.0f, 0.0f, 60.0f, 28.0f));
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle == null) {
            ...
            rf0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.I6, false));
            int i10 = this.E;
            rf0Var.setText(AndroidUtilities.replaceArrows(LocaleController.getString(i10 == 17 ? R.string.ReturnEnteringPhrase : i10 == 16 ? R.string.ReturnEnteringWord : i10 == 3 ? R.string.ReturnPhoneCall : R.string.ReturnEnteringSMS), true, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f)));
            return;
        }
        ci.h2 h2Var = this.c;
        h2Var.setText("");
        ...
        rf0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
        int i13 = this.E;
        ...
        rf0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
        rf0Var.setTag(R.id.color_key_tag, Integer.valueOf(i12));
    ...
    public final void n() {
        ...
        qg0 qg0Var = this.a0;
        this.n.setTextColor(qg0Var.getThemedColor(i10));
        this.r.setTextColor(qg0Var.getThemedColor(org.telegram.ui.ActionBar.h6.D6));
        int themedColor = qg0Var.getThemedColor(i10);
        ci.h2 h2Var = this.c;
        h2Var.setTextColor(themedColor);
        h2Var.setCursorColor(qg0Var.getThemedColor(org.telegram.ui.ActionBar.h6.l6));
