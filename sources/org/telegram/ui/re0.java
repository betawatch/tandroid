...
public final class re0 extends org.telegram.ui.Components.vv0 {
    ...
    public String v;
    public String w;
    public final org.telegram.ui.Components.yc0 x;
    ...
    */
    public re0(yg0 yg0Var, Context context) {
        super(context);
        int i10;
        this.y = yg0Var;
        setOrientation(1);
        ...
        this.e = bj0Var;
        bj0Var.f(R.raw.tsv_setup_intro, 120, 120, null);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                this.x = yc0Var;
                yc0Var.setText(LocaleController.getString(R.string.EnterPassword));
                ...
                editTextBoldCursor.setOnFocusChangeListener(new qd(this, 4));
                yc0Var.e(editTextBoldCursor);
                yc0Var.addView(editTextBoldCursor, w7.x5.e(-1, -2, 48));
                editTextBoldCursor.setOnEditorActionListener(new ka(this, 5));
                addView(yc0Var, w7.x5.t(-1, -2, 1, 16, 32, 16, 0));
                ...
                frameLayout2.addView(textView3, w7.x5.d(-1, 56.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
                addView(frameLayout2, w7.x5.q(-1, -1, 80));
                n7.a1.j(textView3);
                textView3.setOnClickListener(new uv(19, this, context));
            }
        }
        i10 = 8;
        frameLayout.setVisibility(i10);
        ...
        this.d = textView4;
        com.google.android.gms.internal.vision.e2.l(18.0f, 1, textView4);
        ...
        addView(textView4, w7.x5.d(-1, -2.0f, 1, 32.0f, 16.0f, 32.0f, 0.0f));
        ...
        this.x = yc0Var2;
        yc0Var2.setText(LocaleController.getString(R.string.EnterPassword));
        ...
        editTextBoldCursor2.setOnFocusChangeListener(new qd(this, 4));
        yc0Var2.e(editTextBoldCursor2);
        yc0Var2.addView(editTextBoldCursor2, w7.x5.e(-1, -2, 48));
        editTextBoldCursor2.setOnEditorActionListener(new ka(this, 5));
        addView(yc0Var2, w7.x5.t(-1, -2, 1, 16, 32, 16, 0));
        ...
        frameLayout22.addView(textView32, w7.x5.d(-1, 56.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        addView(frameLayout22, w7.x5.q(-1, -1, 80));
        n7.a1.j(textView32);
        textView32.setOnClickListener(new uv(19, this, context));
    }
    ...
    public final void h(String str) {
        ...
        if (obj.length() != 0) {
            ...
            yg0.U0(yg0Var, this.x, true);
        }
    }

    @Override // org.telegram.ui.Components.vv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new i10(this, 19), yg0.t0);
    }
    ...
    public final void n() {
        ...
        this.b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.D6, false));
        ...
        this.c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        this.x.f();
    }
}
