...
public final class u81 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public u81(SessionsActivity sessionsActivity, Context context) {
        ...
        this.a = v9Var;
        addView(v9Var, w7.y5.d(120, 120.0f, 1, 0.0f, 16.0f, 0.0f, 0.0f));
        hVar.j = false;
        hVar.n = 1.2f;
        v9Var.setOnClickListener(new z7(this, 2));
        ...
        n90Var.setHighlightColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.K6, false));
        ...
        if (indexOf != -1 && indexOf2 != -1 && indexOf != indexOf2) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.c61(LocaleController.getString(R.string.AuthAnotherClientDownloadClientUrl), (org.telegram.ui.Components.e11) null), indexOf, indexOf2 - 1, 33);
        }
        ...
        if (indexOf3 != -1 && indexOf4 != -1 && indexOf3 != indexOf4) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.c61(LocaleController.getString(R.string.AuthAnotherWebClientUrl), (org.telegram.ui.Components.e11) null), indexOf3, indexOf4 - 1, 33);
        }
        ...
        addView(skVar, w7.y5.d(-1, 48.0f, 80, 16.0f, 15.0f, 16.0f, 16.0f));
        b();
    }
    ...
    public static void a(u81 u81Var) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && sessionsActivity.getParentActivity().checkSelfPermission("android.permission.CAMERA") != 0) {
            ...
            v9.e0(sessionsActivity.getParentActivity(), 2, new s81(sessionsActivity));
        }
    }
    ...
    public final void b() {
        ...
        if (document == null) {
            ...
            v9Var.i(forDocument, "130_130", "tgs", svgThumb, tL_messages_stickerSet);
