...
public final /* synthetic */ class pf implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (i11) {
            case 0:
                ...
                Long l4 = (Long) obj;
                if (eoVar.R3 == 1) {
                    org.telegram.ui.Components.d5.M(eoVar.getParentActivity(), eoVar.T5, new a7(eoVar, botInlineResult, l4, i12), eoVar.ea);
                    break;
                } else {
            ...
            case 2:
                ...
                if (tL_statsPollStats != null) {
                    if (tL_statsPollStats.votes_graph instanceof TL_stats.TL_statsGraphError) {
                        ...
                        new sh.g(eoVar2.getParentActivity(), eoVar2.ea, tL_statsPollStats).show();
                        break;
                    }
                }
                break;
            ...
            case 4:
                ...
                if (j2Var != null) {
                    ...
                    gg.k2.f(i10).k(j2Var.a, str);
                }
                eoVar4.Q3 = str;
                eoVar4.a1.setTitle(str);
                break;
            case 5:
                ...
                eo eoVar5 = ((pn) obj3).a;
                if (eoVar5.f7()) {
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(messageObject2.getDiceEmoji(), eoVar5.T5, eoVar5.n5, eoVar5.X3, null, false, null, null, null, true, 0, 0, null, false);
            ...
            case 6:
                ...
                if (((Boolean) obj).booleanValue()) {
                    while (i13 < eoVar6.x0.getChildCount()) {
                        View childAt = eoVar6.x0.getChildAt(i13);
            ...
            case 8:
                ...
                ((pn) obj3).a.getMessagesController().rejectSuggestedMessage(DialogObject.getPeerDialogId(message.peer_id), message.id, (String) obj);
                break;
            case 9:
                ho hoVar = (ho) obj3;
                hoVar.f.t(((cg.a) obj).b, ((TLRPC.WallPaper) obj2).settings.intensity);
                View view = hoVar.b;
                if (view != null) {
                    view.invalidate();
                    break;
            ...
            case 10:
                ...
                of3.sendMessageChatArguments = eoVar8 != null ? eoVar8.C8() : null;
            ...
            case 11:
                ...
                ((eo) obj3).g5 = (MessageSuggestionParams) obj;
                boolean G1 = yiVar.G1(0, true, 0, yiVar.s1(), yiVar.N0);
                org.telegram.ui.Components.of ofVar = yiVar.h0;
                if (ofVar != null) {
                    ofVar.h(!G1);
                    yiVar.h0 = null;
                    break;
            ...
            case 12:
                ...
                break;
            case 13:
                org.telegram.ui.Components.ll llVar = ((org.telegram.ui.Components.il) obj3).b;
                llVar.x0.b(((org.telegram.ui.Components.kl) obj2).c, llVar.y0, true, 0, ((Long) obj).longValue());
            ...
            case 16:
                ...
                MediaDataController.getInstance(rzVar.c1).getEmojiSuggestions(rzVar.W0, ryVar.v, false, new androidx.car.app.utils.a((Object) qyVar, (String) obj2, obj, 26), null, SharedConfig.suggestAnimatedEmoji || UserConfig.getInstance(rzVar.c1).isPremium(), false, true, 25);
                break;
            case 17:
                ArrayList arrayList2 = (ArrayList) obj2;
                Runnable runnable = (Runnable) obj;
                org.telegram.ui.Components.ry ryVar2 = ((org.telegram.ui.Components.qy) obj3).a;
                if (ConnectionsManager.getInstance(ryVar2.F.c1).getConnectionState() != 3) {
                    runnable.run();
                    break;
                } else {
            ...
            case 18:
                ...
                while (i13 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(kzVar.w.Q.c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
                        arrayList = stickerSet != null ? stickerSet.documents : null;
                    } else {
                        arrayList = stickerSetCovered.covers;
                    }
                    if (arrayList != null && !arrayList.isEmpty()) {
                        kzVar.n.add(new org.telegram.ui.Components.jy(stickerSetCovered, arrayList));
                    }
                }
                runnable2.run();
                break;
            case 19:
                ...
                if (k10Var.a0 != null || (k10Var.Z instanceof TL_chatlists.TL_chatlists_chatlistInviteAlready)) {
                    org.telegram.ui.Components.pc M = org.telegram.ui.Components.wc.a0(p2Var).M(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkUpdatedTitle, k10Var.f0)), arrayList4.size() <= 0 ? LocaleController.formatPluralString("FolderLinkUpdatedSubtitle", k10Var.h0.size(), new Object[0]) : LocaleController.formatPluralString("FolderLinkUpdatedJoinedSubtitle", arrayList4.size(), new Object[0]), R.raw.folder_in);
                    M.j = 5000;
                    M.j();
                    break;
                } else {
                    org.telegram.ui.Components.pc M2 = org.telegram.ui.Components.wc.a0(p2Var).M(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkAddedTitle, k10Var.f0)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList4.size(), new Object[0]), R.raw.contact_check);
                    M2.j = 5000;
                    M2.j();
                    break;
                }
            ...
            case 21:
                ...
                if (((Boolean) obj).booleanValue()) {
                    ...
                    if (U != null) {
                        org.telegram.ui.Components.wc.a0(U).P(R.raw.chats_infotip, AndroidUtilities.replaceArrows(AndroidUtilities.premiumText(LocaleController.getString(R.string.SensitiveContentSettingsToast), new org.telegram.ui.Components.rd(i12, U)), true)).k(true);
                    }
            ...
            default:
                ...
                ArrayList arrayList5 = sj0Var.f0;
                arrayList5.clear();
                if (list != null) {
                    for (TLRPC.User user2 : list) {
                        if (user2 != null && !hashSet.contains(Long.valueOf(user2.id)) && sj0Var.R(user2)) {
                ...
                if (bool2 == null || !bool2.booleanValue()) {
                    ...
                    nj0 nj0Var = new nj0(i13, sj0Var, hashSet);
    ...
    public /* synthetic */ pf(org.telegram.ui.Components.yi yiVar, eo eoVar) {
        this.a = 11;
        this.c = yiVar;
        this.b = eoVar;
    }
