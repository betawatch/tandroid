...
public final class ub1 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.a) {
            ...
            case 18:
                ...
                Paint paint = q1Var.n;
                paint.setColor(org.telegram.ui.ActionBar.h6.l1(0.1f, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.c6, false)));
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i12) {
                                    case 0:
                                        ub1 ub1Var = this.b;
                                        ub1Var.invalidate();
                                        ((ScrollSlidingTextTabStrip) ub1Var.b).invalidate();
                                        break;
                                    default:
                                        ub1 ub1Var2 = this.b;
                                        ub1Var2.invalidate();
                                        ((ScrollSlidingTextTabStrip) ub1Var2.b).invalidate();
                                        break;
                                }
                            }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.a) {
            case 16:
                ...
                accessibilityNodeInfo.setVisibleToUser(((mi1) this.b).B0);
                break;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                break;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                LinearLayout linearLayout2 = e2Var.n0;
                if (linearLayout2 != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) e2Var.n0.getLayoutParams();
                    paddingRight += e2Var.n0.getMeasuredWidth() + marginLayoutParams2.leftMargin + marginLayoutParams2.rightMargin;
                }
                LinearLayout linearLayout3 = e2Var.o0;
                if (linearLayout3 != null) {
                    ...
                    ViewGroup.MarginLayoutParams marginLayoutParams3 = (ViewGroup.MarginLayoutParams) e2Var.o0.getLayoutParams();
                    paddingRight += e2Var.o0.getMeasuredWidth() + marginLayoutParams3.leftMargin + marginLayoutParams3.rightMargin;
                }
                e2Var.k0 = Math.max(0, size2 - paddingRight);
                super.onMeasure(i10, i11);
                break;
            case 3:
                int size3 = View.MeasureSpec.getSize(i10);
                int paddingRight2 = getPaddingRight() + getPaddingLeft();
                ii.c4 c4Var = (ii.c4) this.b;
            ...
            case 15:
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams7 = (ViewGroup.MarginLayoutParams) zg1Var.c.getLayoutParams();
                int i15 = 0;
                int dp = AndroidUtilities.dp(8.0f) + (zg1Var.a.getVisibility() == 8 ? AndroidUtilities.statusBarHeight : 0);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ub1(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
