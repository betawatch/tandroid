...
public final class z21 extends View {
    ...
    public String R;
    public boolean S;
    public final org.telegram.ui.Components.kc0 a;
    ...
    */
    public final void b(int i10, int i11) {
        ...
        if ((TextUtils.isEmpty(this.G) && !this.r) || TextUtils.isEmpty(this.I)) {
            AndroidUtilities.runOnUIThread(new w21(this, 1));
            return;
        }
                ...
                if (i17 > 1 || measureText <= B) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.y21
                        ...
                        public final void run() {
                            z21 z21Var = z21.this;
                            Bitmap bitmap2 = z21Var.h;
                            z21Var.h = createBitmap.extractAlpha();
                            if (!z21Var.S) {
                                z21Var.x.d(0.0f, true);
                            }
                            z21Var.S = false;
                            Bitmap bitmap3 = z21Var.n;
                            if (bitmap3 != null) {
                                bitmap3.recycle();
                            }
                            z21Var.n = bitmap2;
