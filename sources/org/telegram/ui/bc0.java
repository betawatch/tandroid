...
public final /* synthetic */ class bc0 implements RequestDelegate {
    ...
    */
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.a) {
            case 0:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.jn0((cc0) this.b, tLObject, (HashSet) this.c, tL_error, 16));
                break;
            case 1:
                ...
                if (tLObject != null && !(((TLRPC.auth_SentCode) tLObject).type instanceof TLRPC.TL_auth_sentCodeTypeFirebaseSms)) {
                    AndroidUtilities.runOnUIThread(new xq(wg0Var, bundle, tLObject, 24));
                    break;
                } else {
                ...
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.jn0((af0) this.b, tLObject, (String) this.c, tL_error, 19));
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new xq((zf0) this.b, tL_error, (TL_account.confirmPhone) this.c, 29));
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new pf0((KeyEvent.Callback) this.b, tLObject, this.c, 4));
                break;
            case 5:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.jn0((vg0) this.b, tL_error, tLObject, (String) this.c, 23));
                break;
            case 6:
            ...
            case 9:
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_validatedRequestedInfo)) {
                    ...
                    AndroidUtilities.runOnUIThread(new ml0(8, wo0Var, (TLRPC.TL_payments_validatedRequestedInfo) tLObject));
                    break;
                }
            case 10:
                ...
                if (tLObject == null) {
                    ...
                    if (callback == null) {
                        ...
                        AndroidUtilities.runOnUIThread(new ml0(9, wo0Var2, messageArr));
                        break;
                    } else {
                ...
                break;
            case 11:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.jn0((wo0) this.b, tLObject, tL_error, (TL_account.getTmpPassword) this.c, 27));
                break;
            case 12:
            ...
            case 13:
                ...
                break;
            case 14:
                AndroidUtilities.runOnUIThread(new ml0(27, (PrivacySettingsActivity) this.b, (org.telegram.ui.Cells.w8) this.c));
                break;
            case 15:
            ...
            case 19:
                ...
                break;
            case 20:
                AndroidUtilities.runOnUIThread(new pf0((n81) this.b, tL_error, (TLRPC.TL_authorization) this.c, 28));
                break;
            case 21:
                AndroidUtilities.runOnUIThread(new es0((p81) this.b, tLObject, tL_error, (l9) this.c, 14));
                break;
            case 22:
                AndroidUtilities.runOnUIThread(new es0((f91) this.b, tL_error, tLObject, (String) this.c, 15));
                break;
            case 23:
                AndroidUtilities.runOnUIThread(new iy0(25, (f91) this.b, (TLRPC.TL_attachMenuBot) this.c));
                break;
            case 24:
                    ...
                    if (tLObject instanceof TL_stats.TL_statsGraph) {
                        try {
                            ...
                            try {
                                ...
                                str = str2;
                                AndroidUtilities.runOnUIThread(new es0(la1Var, str3, str, callback0Return, 17));
                                return;
                            }
            ...
            case 26:
                ...
                if (!(tLObject instanceof TLRPC.TL_theme)) {
                    ...
                    AndroidUtilities.runOnUIThread(new pb1(3, be1Var, (TLRPC.TL_theme) tLObject));
                    break;
                }
            case 27:
