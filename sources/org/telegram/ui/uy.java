...
public final class uy extends LinearLayout {
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.o9 o9Var2 = this.c;
        ...
        if (z11) {
            ...
            frameLayout.animate().scaleX(z10 ? 0.0f : 1.0f).scaleY(z10 ? 0.0f : 1.0f).alpha(z10 ? 0.0f : 1.0f).setInterpolator(grVar).setDuration(320L).start();
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.r, z10 ? 1.0f : 0.0f);
            this.n = ofFloat;
            ofFloat.addUpdateListener(new f3(this, 11));
            this.n.addListener(new org.telegram.ui.Components.u9(27, this, z10));
            this.n.setInterpolator(grVar);
            ...
            int i10 = org.telegram.ui.ActionBar.f6.Oh;
            int d = i0.a.d(this.r, v02, org.telegram.ui.ActionBar.f6.v0(i10, b6Var));
            PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
            o9Var2.setColorFilter(new PorterDuffColorFilter(d, mode));
            o9Var2.invalidate();
            o9Var.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.r, org.telegram.ui.ActionBar.f6.v0(i9, b6Var), org.telegram.ui.ActionBar.f6.v0(i10, b6Var)), mode));
            o9Var.invalidate();
        }
        if (z10) {
            o9Var = o9Var2;
