...
public final class uy extends s4.v {
    ...
    public final long d(RecyclerView recyclerView, int i10, float f7, float f10) {
        ...
        if (i10 == 8 && (r2Var = (wyVar = this.h).X0) != null) {
            AndroidUtilities.runOnUIThread(new kh(1, r2Var), this.g.x.e);
            wyVar.X0 = null;
        }
    ...
    */
    public final int e(RecyclerView recyclerView, s4.c1 c1Var) {
        ...
        if (!vyVar.x.k()) {
            wy wyVar = this.h;
            e5Var = ((org.telegram.ui.ActionBar.o2) wyVar).parentLayout;
            if (e5Var != null) {
                e5Var2 = ((org.telegram.ui.ActionBar.o2) wyVar).parentLayout;
            }
                    ...
                    if (view2 instanceof org.telegram.ui.Cells.r2) {
                        ...
                        if (kVar.t(null)) {
                            ...
                            if (uwVar != null && uwVar.getVisibility() == 0) {
                                i18 = ((org.telegram.ui.ActionBar.o2) wyVar).currentAccount;
                            }
                            if (wyVar.c1) {
                                    ...
                                    if (wyVar.V2 == 0) {
                                        ...
                                        if (!ChatObject.isCommunity(i13, dialogId)) {
                                            ...
                                            if (SharedConfig.getChatSwipeAction(i14) != 3) {
                                                i15 = ((org.telegram.ui.ActionBar.o2) wyVar).currentAccount;
                                                if (SharedConfig.getChatSwipeAction(i15) != 1) {
                                                    i16 = ((org.telegram.ui.ActionBar.o2) wyVar).currentAccount;
                                                    if (SharedConfig.getChatSwipeAction(i16) != 0) {
                                                        i17 = ((org.telegram.ui.ActionBar.o2) wyVar).currentAccount;
                                                    }
                                                }
                                            }
                                        }
    ...
    public final void q(s4.c1 c1Var) {
        ...
        org.telegram.ui.Components.ad0 ad0Var2 = wyVar.V0;
        ad0Var2.d = zVar;
        ad0Var2.h = 0.0f;
        ad0Var2.g = 0.0f;
