...
public final class mz0 implements org.telegram.ui.Components.bl0 {
    ...
    public static void a(mz0 mz0Var, Context context, int i10) {
        int i11;
        int i12;
        long j3;
        Long l4;
        ...
        if (i10 == 7) {
            org.telegram.ui.Components.voip.f2.i(mz0Var.c.getParentActivity());
            return;
        }
        if (i10 == 8) {
        ...
        try {
            ...
            if (i10 == 18) {
                w7.x.a((LaunchActivity) mz0Var.c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
            ...
            if (i10 != 20) {
                ...
                if (i10 == 23) {
                    boolean q6 = ci.d1.q(mz0Var.c.getParentActivity());
