...
public final class xg0 extends org.telegram.ui.Components.b6 {
    ...
    public xg0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        ...
        jVar2.u = kVar3;
        this.M = new HashSet();
        this.N = new xd.a(0, new fu(this, 22), org.telegram.ui.Components.nr.h, 380L, false);
        this.O = new yd.b(new h(this, 25));
        this.s = f6Var;
    }

    public static void k(xg0 xg0Var, View view, float f10, float f11) {
        float f12;
        float f13;
    ...
    public static void m(xg0 xg0Var, float f10, boolean z4, boolean z10) {
        View view;
        o1.j jVar = xg0Var.I;
        float f11 = Float.MAX_VALUE;
        if (xg0Var.getChildCount() != 0) {
            float f12 = -3.4028235E38f;
            boolean z11 = false;
            float f13 = Float.MAX_VALUE;
            for (int i10 = 0; i10 < xg0Var.getChildCount(); i10++) {
                View childAt = xg0Var.getChildAt(i10);
        ...
        if (xg0Var.getChildCount() == 0) {
            ...
            view = null;
            for (int i11 = 0; i11 < xg0Var.getChildCount(); i11++) {
                View childAt2 = xg0Var.getChildAt(i11);
        ...
        if (z4) {
            int childCount = xg0Var.getChildCount();
            int i12 = 0;
            while (true) {
                if (i12 >= childCount) {
                    break;
                }
                View childAt3 = xg0Var.getChildAt(i12);
        ...
        if (view != null) {
            xg0Var.L = view;
            int childCount2 = xg0Var.getChildCount();
            for (int i13 = 0; i13 < childCount2; i13++) {
                View childAt4 = xg0Var.getChildAt(i13);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < childCount3; i18++) {
            ...
            if (childAt2 instanceof wg0) {
                ((bh.b) ((wg0) childAt2)).setTextSizeDp(f15);
            }
        }
