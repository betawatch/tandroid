        ...
        switch (this.a) {
            ...
            case 3:
                ...
                for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                    ((yh.a) arrayList2.get(i10)).a.delete();
                }
                AndroidUtilities.runOnUIThread(new n(6, y6Var, d2Var));
                return;
            case 4:
                r7 r7Var = (r7) this.d;
                ...
                try {
                    try {
                        ...
                        try {
                            try {
                                mediaMetadataRetriever2.setDataSource(r7Var.getContext(), Uri.fromFile(aVar.a));
                            ...
                            str2 = str;
                            AndroidUtilities.runOnUIThread(new bi.ya(r7Var, aVar, tL_documentAttributeAudio, str2, str7, 8));
                            return;
                        }
                        try {
            ...
            case 7:
                ...
                org.telegram.messenger.em.o(R.string.LinkCopied, new org.telegram.ui.Components.wc(h3Var.topBulletinContainer, f6Var));
                return;
            case 8:
            ...
            case 11:
                ...
                ndVar.b0 = false;
                org.telegram.ui.Components.f90 f90Var = ndVar.P;
            ...
            case 12:
                ...
                return;
            case 13:
                ((fb1) this.d).showDialog(le.d0((Context) this.b, (org.telegram.ui.ActionBar.f6) this.c, false));
                return;
            case 14:
                AndroidUtilities.runOnUIThread(new n(24, (ua) this.c, ((eo) this.d).getMessagesStorage().getUser(((TLRPC.TL_contact) this.b).user_id)));
                return;
            case 15:
                eo.J0((eo) this.d, (TLRPC.User) this.b, (TLRPC.EmojiStatus) this.c);
                return;
            case 16:
                eo eoVar2 = (eo) this.d;
                org.telegram.ui.Components.km0 km0Var = (org.telegram.ui.Components.km0) this.b;
                TLRPC.User user = (TLRPC.User) this.c;
                eoVar2.getClass();
                km0Var.dismiss();
                eoVar2.presentFragment(ProfileActivity.m4(user.id));
                return;
            case 17:
                eo eoVar3 = (eo) this.d;
                ...
                w70Var.u();
                ek0 ek0Var = new ek0(eoVar3.getParentActivity(), eoVar3);
                ek0Var.v(str8, false);
                ek0Var.show();
                return;
            case 18:
                ...
                org.telegram.ui.Components.d5.T(eoVar4.getParentActivity(), suggestedPost != null ? suggestedPost.schedule_date : 0L, new a7(eoVar4, suggestedPost, (MessageObject) this.c, 5), eoVar4.getResourceProvider(), 0).a.show();
                return;
            case 19:
                eo.f0((eo) this.d, (yf.a) this.b, (Runnable) this.c);
                return;
            case 20:
                eo.l0((eo) this.d, (TLObject) this.b, (TLRPC.User) this.c);
                return;
            case 21:
                org.telegram.ui.Components.d5.f0(r0.currentAccount, (TLRPC.TL_error) this.b, (eo) this.d, (TLRPC.TL_messages_editMessage) this.c, new Object[0]);
                return;
            case 22:
                eo eoVar5 = (eo) this.d;
                MessagesStorage messagesStorage = (MessagesStorage) this.b;
                CountDownLatch countDownLatch = (CountDownLatch) this.c;
                eoVar5.f = messagesStorage.getUser(eoVar5.h.user_id);
            ...
            case 23:
                ...
                if (tLObject5 instanceof TLRPC.TL_photos_photo) {
                    ...
                    eo eoVar6 = gmVar.a.Q;
                    eoVar6.getMessagesController().putUsers(tL_photos_photo.users, false);
                    TLRPC.User user2 = eoVar6.getMessagesController().getUser(Long.valueOf(eoVar6.getUserConfig().clientUserId));
                    if ((tL_photos_photo.photo instanceof TLRPC.TL_photo) && user2 != null) {
                        xf.e0.a(messageObject.messageOwner.action.photo, user2, false);
                        eoVar6.getUserConfig().setCurrentUser(user2);
                        eoVar6.getUserConfig().saveConfig(true);
                        org.telegram.ui.Components.wc.a0(eoVar6).V(Collections.singletonList(user2), AndroidUtilities.replaceTags(LocaleController.getString(R.string.ApplyAvatarHintTitle)), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ApplyAvatarHint), new fj(fmVar, 5)), null).j();
                    }
                }
                messageObject.settingAvatar = false;
                return;
            case 24:
                pn.a((pn) this.d, (org.telegram.ui.Cells.t1) this.b, (TLRPC.Document) this.c);
                return;
            case 25:
                ((pn) this.d).u((org.telegram.ui.Cells.t1) this.b, (TLRPC.User) this.c);
                return;
            case 26:
                ((pn) this.d).p((org.telegram.ui.Cells.t1) this.b, (TLRPC.Chat) this.c, 0, false);
                return;
            case 27:
                yo yoVar = (yo) this.d;
                ...
                yoVar.getClass();
                if (tL_error3 == null) {
                    yoVar.y0.invitesCount = ((TLRPC.TL_messages_exportedChatInvites) tLObject6).count;
                    yoVar.getMessagesStorage().saveChatLinksCount(yoVar.w0, yoVar.y0.invitesCount);
                    yoVar.p0(false, false);
                    return;
                }
                return;
            case 28:
                ...
                if (lowerCase.length() == 0) {
                    AndroidUtilities.runOnUIThread(new s1(xpVar, new ArrayList(), new ArrayList(), 29));
                    return;
                }
                ...
                while (i12 < arrayList3.size()) {
                    ...
                    while (true) {
                        if (i13 < i11) {
                            ...
                            if (lowerCase2.startsWith(str11) || org.telegram.messenger.a2.w(" ", str11, lowerCase2) || (translitString2 != null && (translitString2.startsWith(str11) || org.telegram.messenger.a2.w(" ", str11, translitString2)))) {
                            ...
                            if (r32 != 0) {
                                if (r32 == 1) {
                                    ...
                                    arrayList5.add(AndroidUtilities.generateSearchName(org.telegram.ui.Cells.r6.i("@", str10), null, "@" + str11));
                                }
                                arrayList4.add(chat);
                            } else {
                                i13++;
                ...
                AndroidUtilities.runOnUIThread(new s1(xpVar, arrayList4, arrayList5, 29));
                return;
            default:
                xp.E((xp) this.d, (ArrayList) this.b, (ArrayList) this.c);
                return;
        }
    }

    public /* synthetic */ s1(eo eoVar, org.telegram.ui.Components.w70 w70Var, String str) {
        this.a = 17;
        this.d = eoVar;
        this.c = w70Var;
        this.b = str;
