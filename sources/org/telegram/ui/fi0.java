...
public final class fi0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public fi0(Context context) {
        ...
        if (LocaleController.isRTL) {
            addView(w9Var, w7.a6.d(34, 34.0f, 21, 0.0f, 0.0f, 10.0f, 0.0f));
            addView(l5Var, w7.a6.d(-2, -2.0f, 53, 8.0f, 5.33f, 55.0f, 0.0f));
            addView(textView, w7.a6.d(-2, -2.0f, 53, 13.0f, 19.0f, 55.0f, 0.0f));
        } else {
            addView(w9Var, w7.a6.d(34, 34.0f, 19, 10.0f, 0.0f, 0.0f, 0.0f));
            addView(l5Var, w7.a6.d(-2, -2.0f, 51, 55.0f, 5.33f, 8.0f, 0.0f));
            addView(textView, w7.a6.d(-2, -2.0f, 51, 55.0f, 19.0f, 13.0f, 0.0f));
        }
    }
    ...
    public final void a(TLObject tLObject, boolean z10, int i10) {
        ...
        if (tLObject != null) {
            ...
            this.b.h(ImageLocation.getForUserOrChat(i11, tLObject, 1), "50_50", g9Var, tLObject);
