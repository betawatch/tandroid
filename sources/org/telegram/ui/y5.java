...
public final class y5 extends l20 implements NotificationCenter.NotificationCenterDelegate {
    public final long M;
    public final int N;
        ...
        if (view instanceof lg.b) {
            ...
            if (!z4 || boost.stars <= 0) {
                ...
                if (((z10 || z4) && boost.user_id >= 0) || boost.unclaimed) {
                    ...
                    tL_payments_checkedGiftCode.from_id = MessagesController.getInstance(UserConfig.selectedAccount).getPeer(-y5Var.d0.id);
                    int i11 = boost.date;
                    ...
                    new gg.e1(y5Var, tL_payments_checkedGiftCode, boost.used_gift_slug).show();
                ...
                lh.ja.e1(context, y5Var.N, y5Var.M, boost, y5Var.getResourceProvider());
            }
        }
        if (view instanceof org.telegram.ui.Cells.o8) {
            gg.x.m(y5Var, y5Var.resourceProvider, j10, null);
        }
        if (view instanceof lg.c) {
            gg.x.m(y5Var, y5Var.resourceProvider, j10, ((lg.c) view).getPrepaidGiveaway());
        }
        if (((x5) y5Var.X.get(i10)).a == 9) {
            y5Var.E0(Boolean.valueOf(y5Var.Y == 1));
        }
    }
    ...
    public final void F0(boolean z4) {
        ...
        t5 t5Var = new t5(getParentActivity());
        t5Var.addView(this.O != null ? this.Z : new View(t5Var.getContext()), k7.b6.d(-1, this.O != null ? -2.0f : 110.0f, 0, 8.0f, 46.0f, 8.0f, 33.0f));
        m0(string, replaceTags, t5Var, new w5(this, getParentActivity()));
    }
    ...
    public final void G0(boolean z4) {
        ...
        arrayList.clear();
        arrayList.add(new x5(14, false));
        if (this.O != null) {
            arrayList.add(new x5(16, LocaleController.getString(R.string.StatisticOverview)));
            arrayList.add(new x5(0, false));
            arrayList.add(new x5(2, false));
            if (this.O.prepaid_giveaways.size() > 0) {
                ...
                while (i10 < this.O.prepaid_giveaways.size()) {
                    ...
                    x5 x5Var = new x5(11, true);
                    x5Var.e = prepaidGiveaway;
                    x5Var.f = z10;
                    arrayList.add(x5Var);
                    i10++;
                }
            ...
            if (i11 == 0) {
                ...
                if (arrayList3.isEmpty()) {
                    arrayList.add(new x5(8, false));
                    arrayList.add(new x5(2, false));
                } else {
                    int i12 = 0;
                    while (i12 < arrayList3.size()) {
                        arrayList.add(new x5((TL_stories.Boost) arrayList3.get(i12), i12 == arrayList3.size() - 1 && !this.T, this.Y));
                        i12++;
                    }
                    if (this.T) {
                        arrayList.add(new x5(9, true));
                    } else {
                        arrayList.add(new x5(7, false));
                    }
                    arrayList.add(new x5(6, LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? R.string.BoostersInfoDescription : R.string.BoostersInfoGroupDescription)));
                }
            } else {
                ...
                if (arrayList4.isEmpty()) {
                    ...
                    while (i13 < arrayList4.size()) {
                        arrayList.add(new x5((TL_stories.Boost) arrayList4.get(i13), i13 == arrayList4.size() - 1 && !this.V, this.Y));
                        i13++;
                    }
                    if (this.V) {
                        arrayList.add(new x5(9, true));
            ...
            if (MessagesController.getInstance(this.N).giveawayGiftsPurchaseAvailable && ChatObject.hasAdminRights(chat)) {
                arrayList.add(new x5(6, LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? R.string.BoostingShareThisLink : R.string.BoostingShareThisLinkGroup)));
                arrayList.add(new x5(10, true));
                arrayList.add(new x5(6, LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? R.string.BoostingGetMoreBoosts2 : R.string.BoostingGetMoreBoostsGroup)));
            } else {
                arrayList.add(new x5(6, ""));
            }
            arrayList.add(new x5(15, false));
        }
        r5 r5Var = this.a0;
        if (z4) {
