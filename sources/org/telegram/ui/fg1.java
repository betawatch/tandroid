...
public class fg1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.bh, fh0 {
    ...
    public org.telegram.ui.Components.w61 L;
    public uy L0;
    public int M;
    public uy M0;
    public qf1 N;
    ...
    public org.telegram.ui.Components.y81 a1;
    ...
    public fg1(Bundle bundle) {
        ...
        this.V0 = true ^ org.telegram.messenger.l0.u("topics_end_reached_", j3, getUserConfig().getPreferences(), false);
        fh.c cVar = new fh.c();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0042, code lost:
        ...
        if (((org.telegram.ui.fg1) r0).a == (-r6.a())) goto L13;
     */
    /*
    ...
    */
    public static void I0(zn znVar) {
        ...
        ((ActionBarLayout) znVar.getParentLayout()).c(znVar.getParentLayout().getFragmentStack().size() - 1, new fg1(bundle));
        znVar.ja = true;
    ...
    public static boolean U(fg1 fg1Var, TLRPC.TL_error tL_error) {
        ...
        MessagesController.getNotificationsSettings(fg1Var.currentAccount).edit().putLong("dialog_join_requested_time_" + (-fg1Var.a), System.currentTimeMillis()).commit();
        ...
        org.telegram.ui.Components.r80.w(parentActivity, fg1Var, org.telegram.ui.Components.xc.a0(fg1Var), isChannelAndNotMegaGroup);
        fg1Var.O0(true);
        return false;
    }
    ...
    public static void V(fg1 fg1Var, View view) {
        ...
        long j10 = -j3;
        long peerDialogId = tL_forumTopic == null ? 0L : fg1Var.getMessagesController().isMonoForum(j10) ? DialogObject.getPeerDialogId(tL_forumTopic.from_id) : tL_forumTopic.id;
        if (fg1Var.t0) {
            gg1 gg1Var = fg1Var.v;
            if (gg1Var != null) {
                ig1 ig1Var = gg1Var.a;
                Bundle bundle = new Bundle();
                lg1 lg1Var = ig1Var.a;
                bundle.putLong("dialog_id", lg1Var.c);
                bundle.putLong("topic_id", tL_forumTopic.id);
                bundle.putBoolean("exception", true);
                w11 w11Var = new w11(bundle, null);
                w11Var.r = new rv0(17, ig1Var, tL_forumTopic);
                lg1Var.presentFragment(w11Var);
            }
            uy uyVar = fg1Var.L0;
            if (uyVar != null) {
                uyVar.O3(j10, peerDialogId, true, fg1Var);
                return;
            }
            return;
        }
        ...
        if (fg1Var.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            fg1Var.Q0 = peerDialogId;
            fg1Var.U0(false, false);
        }
        ng.d.m(fg1Var, j3, tL_forumTopic, 0);
    }

    public static /* synthetic */ boolean W(fg1 fg1Var, View view, float f7) {
        if (fg1Var.t0 || fg1Var.getParentLayout() == null || ((ActionBarLayout) fg1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(fg1 fg1Var) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            if (i10 == 0) {
                ...
                viewGroup = bg1Var != null ? bg1Var.V : null;
            }
            if (viewGroup != null) {
        ...
        if (kVar != null) {
            kVar.D(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.G8), true);
            fg1Var.actionBar.E(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.E8), false, true);
            fg1Var.actionBar.E(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.F8), true, true);
            fg1Var.actionBar.F(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.I5), true);
        }
        s50 s50Var = fg1Var.P0;
        if (s50Var != null && Build.VERSION.SDK_INT >= 23) {
            s50Var.setForeground(new ColorDrawable(i0.a.k(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6), 100)));
        }
        fg1Var.P0();
    }
    ...
    public static void b0(fg1 fg1Var, boolean z10) {
        ...
        int i10 = 0;
        if (fg1Var.a1 == null) {
            org.telegram.ui.Components.y81 n10 = fg1Var.r0.n(8, false);
            fg1Var.a1 = n10;
            if (fg1Var.M0 != null) {
                n10.setBackgroundColor(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
            }
            fg1Var.e.addView(fg1Var.a1, w7.y5.c(44.0f, -1));
        }
        fg1Var.Y0 = ValueAnimator.ofFloat(fg1Var.W, z10 ? 1.0f : 0.0f);
        AndroidUtilities.updateViewVisibilityAnimated(fg1Var.r0, false, 1.0f, true);
        uy uyVar = fg1Var.M0;
        if (uyVar != null && (oxVar = uyVar.F3) != null) {
            oxVar.M = !z10;
        }
        fg1Var.Z0 = !z10 && fg1Var.r0.getVisibility() == 0 && fg1Var.r0.getAlpha() == 1.0f;
        fg1Var.Y0.addUpdateListener(new i21(fg1Var, 16));
        fg1Var.r0.setVisibility(0);
        if (z10) {
            AndroidUtilities.requestAdjustResize(fg1Var.getParentActivity(), fg1Var.classGuid);
            fg1Var.Q0(false);
        } else {
            fg1Var.q0.setVisibility(0);
        }
        fg1Var.Y0.addListener(new of1(fg1Var, z10, i10));
        fg1Var.Y0.setDuration(200L);
        fg1Var.Y0.setInterpolator(org.telegram.ui.Components.qr.f);
        fg1Var.Y0.start();
    ...
    public final void A0() {
        ...
        if (this.D0 != null) {
            ...
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((wf1) arrayList.get(0)).c != null && ((wf1) arrayList.get(0)).c.id == 1)) {
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new ja0(15));
        b2Var.show();
    ...
    public final void M0(org.telegram.ui.Cells.s2 s2Var) {
        ...
        if (ChatObject.canManageTopics(g())) {
            ...
            f1Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
                ...
                public final void onClick(View view) {
                    switch (i10) {
                        case 0:
                            ...
                            fg1Var.C0 = true;
                            fg1Var.N0 = true;
                            fg1Var.s.pinTopic(fg1Var.a, tL_forumTopic.id, !r0.pinned, fg1Var);
                            fg1Var.finishPreviewFragment();
                            break;
                        case 1:
                            fg1 fg1Var2 = this.b;
                            fg1Var2.N0 = true;
                            TopicsController topicsController = fg1Var2.s;
                            long j11 = fg1Var2.a;
        ...
        if (ChatObject.canManageTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            f1Var3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
                public final /* synthetic */ fg1 b;
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            final int i12 = 2;
            f1Var4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
                public final /* synthetic */ fg1 b;
        ...
        zn znVar = new zn(v7.j0.e(j3, "chat_id"));
    ...
    public final void N0(View view) {
        ...
        cg1Var.V(hashSet.contains(Integer.valueOf(i10)), true);
        ...
        if (!this.actionBar.a(null)) {
            ...
            this.c0.setOnTouchListener(new gf1(0));
    ...
    */
    public final void O0(boolean z10) {
        ...
        boolean u10 = org.telegram.messenger.l0.u("dialog_bar_report", j11, notificationsSettings, false);
        boolean u11 = org.telegram.messenger.l0.u("dialog_bar_block", j11, notificationsSettings, false);
        boolean z15 = this.t0;
        if (z15) {
            j3 = 0;
            if (this.w0) {
        ...
        if (chat != null && ChatObject.isNotInChat(chat) && j12 > j3 && System.currentTimeMillis() - j12 < 120000) {
            ...
            if (!z14 || (!u11 && !u10)) {
                ...
                if (this.V != z11) {
                    ...
                    if (z16) {
                        this.o0.animate().translationY(z11 ? 0.0f : AndroidUtilities.dp(53.0f)).setListener(new of1(this, z11, 1));
                    } else {
    ...
    public final void P0() {
        ...
        u41Var.setBackgroundColor(getThemedColor(i10));
    ...
    public final void S0(float f7) {
        ...
        org.telegram.ui.Components.y81 y81Var = this.a1;
        if (y81Var != null) {
            y81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
            this.a1.setAlpha(f7);
        }
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        if (topics != null) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (wf1Var != null && (tL_forumTopic = wf1Var.c) != null && tL_forumTopic.hidden) {
                    this.x++;
                }
            }
            qf1 qf1Var = this.N;
            if (qf1Var != null) {
                if (qf1Var.getItemAnimator() != (z10 ? this.I0 : null)) {
    ...
    public final View createView(Context context) {
        ...
        mf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.d6));
        ...
        final int i12 = 2;
        this.actionBar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.cf1
            public final /* synthetic */ fg1 b;
            ...
            public final void onClick(View view) {
                ...
                switch (i12) {
                    case 0:
                        fg1 fg1Var = this.b;
                        fg1Var.presentFragment(bf1.a0(fg1Var.a, 0L));
                        break;
                    case 1:
                        fg1 fg1Var2 = this.b;
                        fg1Var2.getMessagesController().hidePeerSettingsBar(-fg1Var2.a, null, fg1Var2.g());
                        fg1Var2.O0(false);
                        break;
                    case 2:
                        fg1 fg1Var3 = this.b;
        ...
        if (this.M0 != null) {
            ...
            this.p0 = a2;
            a2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.cf1
                public final /* synthetic */ fg1 b;
        ...
        this.j1 = new ah.o(qf1Var, viewGroup, new w8(qf1Var2, i12));
        ...
        this.N.setOnScrollListener(new if1(this, i11));
        qf1 qf1Var4 = this.N;
        qf1Var4.Y1 = true;
        qf1Var4.Z1 = 0;
        org.telegram.ui.Components.dl0 dl0Var = new org.telegram.ui.Components.dl0(qf1Var4, true);
        this.K0 = dl0Var;
        this.N.setItemsEnterAnimator(dl0Var);
        this.N.setOnItemClickListener(new a31(this, 10));
        this.N.setOnItemLongClickListener(new ef1(this));
        this.N.setOnScrollListener(new if1(this, i12));
        qf1 qf1Var5 = this.N;
        ...
        this.h.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.cf1
            public final /* synthetic */ fg1 b;
        ...
        vf1Var.addView(textView, w7.y5.d(-2, -2.0f, 81, z10 ? 72.0f : 32.0f, 0.0f, z10 ? 32.0f : 72.0f, 32.0f));
        this.n = vf1Var;
        ...
        this.o0 = new u41(context, 7);
        org.telegram.ui.Components.w61 w61Var = new org.telegram.ui.Components.w61(context);
        this.L = w61Var;
        this.o0.addView(w61Var);
        ...
        this.W0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.cf1
            public final /* synthetic */ fg1 b;
        ...
        bg1Var2.setBackgroundColor(getThemedColor(i17));
        ...
        this.U0.setOnAnimatedHeightChangedListener(new df1(this, i10));
        ...
        final int i18 = 3;
        this.P0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.cf1
            public final /* synthetic */ fg1 b;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        bg1 bg1Var = this.r0;
        if (bg1Var != null && (yl0Var = bg1Var.V) != null) {
