...
public class fg1 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.ah, fh0 {
    ...
    public org.telegram.ui.Components.i81 a1;
    ...
    */
    public static void I0(bo boVar) {
        ...
        if (boVar.getParentLayout().getFragmentStack().size() > 1) {
            org.telegram.ui.ActionBar.o2 o2Var = (org.telegram.ui.ActionBar.o2) boVar.getParentLayout().getFragmentStack().get(boVar.getParentLayout().getFragmentStack().size() - 2);
            if (o2Var instanceof fg1) {
            }
        }
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", -boVar.a());
        ((ActionBarLayout) boVar.getParentLayout()).c(boVar.getParentLayout().getFragmentStack().size() - 1, new fg1(bundle));
        boVar.ja = true;
    ...
    public static void V(fg1 fg1Var, View view) {
        ...
        if (fg1Var.t0) {
            ...
            if (gg1Var != null) {
                ...
                y11Var.r = new tv0(16, ig1Var, tL_forumTopic);
                lg1Var.presentFragment(y11Var);
            }
            wy wyVar = fg1Var.L0;
            if (wyVar != null) {
                wyVar.O3(j10, peerDialogId, true, fg1Var);
                return;
            }
            return;
        }
    ...
    public static void X(fg1 fg1Var) {
        ...
        if (u50Var != null && Build.VERSION.SDK_INT >= 23) {
            u50Var.setForeground(new ColorDrawable(i0.a.k(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6), 100)));
        }
        fg1Var.P0();
    }
    ...
    public static void b0(fg1 fg1Var, boolean z10) {
        ...
        int i10 = 0;
        if (fg1Var.a1 == null) {
            org.telegram.ui.Components.i81 n10 = fg1Var.r0.n(8, false);
            fg1Var.a1 = n10;
            if (fg1Var.M0 != null) {
                n10.setBackgroundColor(fg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
            }
            fg1Var.e.addView(fg1Var.a1, w7.x5.c(44.0f, -1));
        }
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            c2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, this.s.findTopic(this.a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void M0(org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (ChatObject.canManageTopics(g())) {
            ...
            g1Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
        ...
        if (ChatObject.canManageTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            g1Var3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
                public final /* synthetic */ fg1 b;
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            final int i12 = 2;
            g1Var4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ff1
                public final /* synthetic */ fg1 b;
        ...
        bo boVar = new bo(w.f.e(j3, "chat_id"));
    ...
    */
    ...
    public final void S0(float f7) {
        ...
        org.telegram.ui.Components.i81 i81Var = this.a1;
        if (i81Var != null) {
    ...
    public final View createView(Context context) {
        ...
        if (!this.t0) {
            this.f.getAvatarImageView().setOnClickListener(new a8(this, i14));
        }
        ...
        this.j1 = new ah.o(qf1Var, viewGroup, new x8(qf1Var2, i12));
        ...
        vf1Var.addView(textView, w7.x5.d(-2, -2.0f, 81, z10 ? 72.0f : 32.0f, 0.0f, z10 ? 32.0f : 72.0f, 32.0f));
        this.n = vf1Var;
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            u50Var.setForeground(new ColorDrawable(i0.a.k(getThemedColor(i17), 100)));
        }
    ...
    public final void x0() {
        ...
        org.telegram.ui.ActionBar.k actionBar = wyVar != null ? wyVar.getActionBar() : this.actionBar;
