...
public final class oy extends FrameLayout {
    ...
    public oy(py pyVar, Context context) {
        ...
        g10.addView(v0Var, h7.z5.t(-2, -2, 17, 0, 0, 0, 4));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        linearLayout.setBackgroundResource(R.drawable.widget_bg);
        g10.addView(linearLayout, h7.z5.t(-2, -2, 17, 10, 0, 10, 0));
        pyVar.d = new ImageView(context);
        int i11 = pyVar.w;
        if (i11 == 0) {
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) pyVar.getParentActivity().getLayoutInflater().inflate(R.layout.shortcut_widget_item, (ViewGroup) null);
                linearLayout.addView(this.n[i10], h7.z5.n(-1, -2));
                i10++;
            }
            ...
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) pyVar.getParentActivity().getLayoutInflater().inflate(R.layout.contacts_widget_item, (ViewGroup) null);
                linearLayout.addView(this.n[i10], h7.z5.n(160, -2));
                i10++;
            }
        ...
        if (i12 == 0) {
            ...
            while (i16 < i14) {
                if (arrayList.isEmpty()) {
                    dialog2 = i16 < pyVar.getMessagesController().dialogsServerOnly.size() ? pyVar.getMessagesController().dialogsServerOnly.get(i16) : null;
                    j10 = 0;
                } else if (i16 < arrayList.size()) {
                    j10 = 0;
                    TLRPC.Dialog dialog3 = (TLRPC.Dialog) pyVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i16)).longValue());
                    if (dialog3 == null) {
                ...
                if (dialog2 == null) {
                    ...
                    if (DialogObject.isUserDialog(dialog2.id)) {
                        user2 = pyVar.getMessagesController().getUser(Long.valueOf(dialog2.id));
                        if (user2 != null) {
                            ...
                            if (UserObject.isReplyUser(user2) || UserObject.isUserSelf(user2) || (userProfilePhoto2 = user2.photo) == null || (fileLocation2 = userProfilePhoto2.photo_small) == null) {
                                ...
                                if (fileLocation2.volume_id != j10 && fileLocation2.local_id != 0) {
                                    ...
                                    if (fileLocation2 == null) {
                                        try {
                                            decodeFile2 = BitmapFactory.decodeFile(pyVar.getFileLoader().getPathToAttach(fileLocation2, r12).toString());
                                        } catch (Throwable th) {
                                            th = th;
                                            c10 = 1;
                                            FileLog.e(th);
                                            ArrayList arrayList2 = (ArrayList) pyVar.getMessagesController().dialogMessage.f(dialog2.id);
                                            if (arrayList2 != null) {
                                            }
                                    ...
                                    if (decodeFile2 != null) {
                                        if (user2 != null) {
                                            org.telegram.ui.Components.y8 y8Var3 = new org.telegram.ui.Components.y8(i15, user2);
                                            ...
                                            y8Var2 = new org.telegram.ui.Components.y8(chat2);
                                        }
                                        y8Var2.setBounds(i15, i15, dp, dp);
                                        y8Var2.draw(canvas2);
                                        canvas = canvas2;
                                        c10 = 1;
                                    } else {
                                    ...
                                    ArrayList arrayList22 = (ArrayList) pyVar.getMessagesController().dialogMessage.f(dialog2.id);
                                    messageObject = (arrayList22 != null || arrayList22.size() <= 0) ? null : (MessageObject) arrayList22.get(i15);
                                    if (messageObject == null) {
                                        long fromChatId = messageObject.getFromChatId();
                                        if (fromChatId > j10) {
                                            user3 = pyVar.getMessagesController().getUser(Long.valueOf(fromChatId));
                                            chat3 = null;
                                        } else {
                                            chat3 = pyVar.getMessagesController().getChat(Long.valueOf(-fromChatId));
                                            user3 = null;
                                        }
                                            ...
                                            if (chat2 == null || chat2.id <= j10 || chat3 != null || (ChatObject.isChannel(chat2) && !ChatObject.isMegagroup(chat2))) {
                                                ...
                                                try {
                                                    if (charSequence5 != null) {
                                                        ...
                                                        o11.append(charSequence6.replace('\n', ' '));
                                                        Object[] objArr = new Object[2];
                                                        objArr[0] = o11.toString();
                                                        objArr[c10] = string;
                                                        ...
                                                        if (messageObject.messageOwner.media == null || messageObject.isMediaEmpty()) {
                                                            ...
                                                            if (messageMedia2 instanceof TLRPC.TL_messageMediaPoll) {
                                                                j11 = a9.p.m("📊 \u2068", ((TLRPC.TL_messageMediaPoll) messageMedia2).poll.question.text, "\u2069");
                                                            } else if (messageMedia2 instanceof TLRPC.TL_messageMediaGame) {
                                                                j11 = a9.p.m("🎮 \u2068", messageMedia2.game.title, "\u2069");
                                                            } else {
                                                                j11 = messageObject.type == 14 ? org.telegram.ui.Cells.pa.j("🎧 \u2068", messageObject.getMusicAuthor(), " - ", messageObject.getMusicTitle(), "\u2069") : messageObject.messageText.toString();
                                                                c12 = '\n';
                                                            }
                                                            String replace = j11.replace(c12, ' ');
                                                            Object[] objArr3 = new Object[2];
                                                            objArr3[0] = replace;
                                                            objArr3[c10] = string;
                                                            SpannableStringBuilder valueOf2 = SpannableStringBuilder.valueOf(String.format("%2$s: \u2068%1$s\u2069", objArr3));
                                                            try {
                                                                valueOf2.setSpan(new org.telegram.ui.Components.s00(org.telegram.ui.ActionBar.g6.o9, null), string.length() + 2, valueOf2.length(), 33);
                                                                spannableStringBuilder = valueOf2;
                                                            } catch (Exception e9) {
                                                                FileLog.e(e9);
                                                                spannableStringBuilder = valueOf2;
                                                            }
                                                            spannableStringBuilder.setSpan(new org.telegram.ui.Components.s00(org.telegram.ui.ActionBar.g6.k9, null), 0, string.length() + 1, 33);
                                    ...
                                    if (dialog2.unread_count <= 0) {
                                        ...
                                        if (pyVar.getMessagesController().isDialogMuted(dialog2.id, j10)) {
                        ...
                        ArrayList arrayList222 = (ArrayList) pyVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        i11 = i16;
                        TLRPC.Chat chat4 = pyVar.getMessagesController().getChat(Long.valueOf(-dialog2.id));
                        if (chat4 != null) {
                            str2 = chat4.title;
                            ...
                            if (chatPhoto == null || (fileLocation2 = chatPhoto.photo_small) == null || fileLocation2.volume_id == j10 || fileLocation2.local_id == 0) {
                                ...
                                ArrayList arrayList2222 = (ArrayList) pyVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        ArrayList arrayList22222 = (ArrayList) pyVar.getMessagesController().dialogMessage.f(dialog2.id);
            ...
            while (true) {
                ...
                for (int i19 = 2; i18 < i19; i19 = 2) {
                    int i20 = (i17 * 2) + i18;
                    if (arrayList.isEmpty()) {
                        if (i20 < pyVar.getMediaDataController().hints.size()) {
                            long j12 = pyVar.getMediaDataController().hints.get(i20).peer.user_id;
                            dialog = (TLRPC.Dialog) pyVar.getMessagesController().dialogs_dict.f(j12);
                            if (dialog == null) {
                        ...
                        if (i20 < arrayList.size()) {
                            dialog = (TLRPC.Dialog) pyVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i20)).longValue());
                            if (dialog == null) {
                                dialog = new TLRPC.TL_dialog();
                    ...
                    if (dialog == null) {
                        ...
                        if (DialogObject.isUserDialog(dialog.id)) {
                            user = pyVar.getMessagesController().getUser(Long.valueOf(dialog.id));
                            ...
                            TLRPC.Chat chat5 = pyVar.getMessagesController().getChat(Long.valueOf(-dialog.id));
                        ...
                        if (fileLocation != null) {
                            try {
                                decodeFile = BitmapFactory.decodeFile(pyVar.getFileLoader().getPathToAttach(fileLocation, true).toString());
                            } catch (Throwable th2) {
                                th = th2;
                                FileLog.e(th);
                        ...
                        if (decodeFile == null) {
                            if (user != null) {
                                ...
                                y8Var = new org.telegram.ui.Components.y8(chat);
                            }
                            y8Var.setBounds(0, 0, dp3, dp3);
                            y8Var.draw(canvas3);
                        } else {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (s02 != drawable && s02 != null) {
            if (org.telegram.ui.ActionBar.g6.sl != null) {
                ...
                org.telegram.ui.Components.l9 l9Var2 = this.a;
                if (l9Var2 != null) {
                    l9Var2.dispose();
                    this.a = null;
                }
        ...
        py pyVar = this.r;
        b5Var = ((org.telegram.ui.ActionBar.n2) pyVar).parentLayout;
        ...
        while (i10 < 2) {
            ...
            if (drawable2 != null) {
                if (i10 == 1 && this.d != null) {
                    b5Var2 = ((org.telegram.ui.ActionBar.n2) pyVar).parentLayout;
                    if (b5Var2 != null) {
                        ...
                        if (!(drawable2 instanceof ColorDrawable) || (drawable2 instanceof GradientDrawable) || (drawable2 instanceof org.telegram.ui.Components.nb0)) {
                            ...
                            if (drawable2 instanceof org.telegram.ui.Components.m9) {
                                ...
                                this.a = ((org.telegram.ui.Components.m9) drawable2).c(canvas, this);
                            }
