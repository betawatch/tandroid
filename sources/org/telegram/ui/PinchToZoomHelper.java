...
public class PinchToZoomHelper {
    ...
    static /* synthetic */ float access$1216(PinchToZoomHelper pinchToZoomHelper, float f) {
        float f2 = pinchToZoomHelper.progressToFullView + f;
        pinchToZoomHelper.progressToFullView = f2;
        return f2;
    }

    static /* synthetic */ float access$416(PinchToZoomHelper pinchToZoomHelper, float f) {
