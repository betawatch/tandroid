...
public final class p6 extends View {
    ...
    public /* synthetic */ p6(Context context) {
        super(context);
    }

    public void a() {
        this.b.setShader(new LinearGradient(0.0f, 0.0f, getWidth(), 0.0f, new int[]{0, ((xf.x) this.e).f}, (float[]) null, Shader.TileMode.CLAMP));
    }

    public void b(float f10) {
        float dp = AndroidUtilities.dp(6.0f);
        float a2 = g7.n.a(((f10 - dp) + (AndroidUtilities.dp(13.0f) - (this.c.getStrokeWidth() / 2.0f))) / (getWidth() - (dp * 2.0f)), 0.0f, 1.0f);
        this.d = a2;
        xf.x xVar = (xf.x) this.e;
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.a) {
            ...
            default:
                ...
                yf.i1.x1(max, height, strokeWidth, i0.a.k(xVar.f, (int) (this.d * 255.0f)), canvas);
                break;
        }
    }
