...
public final /* synthetic */ class zb0 implements Runnable {
    ...
    public /* synthetic */ zb0(ProfileActivity profileActivity, int i10) {
        this.a = i10;
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new zb0(this.b, 0), 200L);
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new zb0(this.b, 1), 200L);
                break;
            case 4:
