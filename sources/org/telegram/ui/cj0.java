...
public final class cj0 extends org.telegram.ui.Components.ll0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i15 == 0) {
            ...
            int i16 = ej0Var.I;
            MessageObject messageObject = (i10 < i16 || i10 >= ej0Var.J) ? null : (MessageObject) ej0Var.x.get(i10 - i16);
            long dialogId = MessageObject.getDialogId(messageObject.messageOwner);
            if (messageObject.isStory()) {
                TLObject user2 = DialogObject.isUserDialog(dialogId) ? ej0Var.getMessagesController().getUser(Long.valueOf(dialogId)) : ej0Var.getMessagesController().getChat(Long.valueOf(-dialogId));
            ...
            if (DialogObject.isUserDialog(dialogId)) {
                ...
                TLRPC.Chat chat = ej0Var.getMessagesController().getChat(Long.valueOf(-dialogId));
            ...
            if (user != null) {
                b5Var.b(user, null, str, i10 != ej0Var.J - 1);
                return;
            }
            return;
        }
        ...
        TLRPC.ChatFull chatFull = ej0Var2.a;
        ...
        textViewArr[3].setText(AndroidUtilities.formatWholeNumber(Math.max(0, i12 - ej0Var2.U), 0));
