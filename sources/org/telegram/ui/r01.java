...
public final class r01 extends org.telegram.ui.Components.iv0 {
    ...
    public final void D0(SparseArray sparseArray) {
        ...
        if (profileActivity.s1) {
            ...
            char c10 = (org.telegram.ui.Components.iv0.w0(selectedTab) || selectedTab == 8) ? (char) 0 : selectedTab == 9 ? (char) 1 : (char) 65535;
            if (c10 >= 0) {
                if (c10 == 0) {
    ...
    public final void M0(float f7) {
        ...
        if (r01Var != null && profileActivity.s1) {
            if (profileActivity.t5[0] != null) {
                profileActivity.t5[0].setTranslationX(r01Var.f0(8, true));
            }
    ...
    */
    public final void b1(boolean z10) {
        ...
        if (profileActivity.s1) {
            ...
            if (!z10) {
                ...
                animate.translationY(f7).setDuration(320L).setInterpolator(org.telegram.ui.Components.wr.h).setUpdateListener(new d3(this, 27)).start();
            }
            f7 = 0.0f;
            animate.translationY(f7).setDuration(320L).setInterpolator(org.telegram.ui.Components.wr.h).setUpdateListener(new d3(this, 27)).start();
        }
    ...
    public final void v1(boolean z10) {
        ...
        if (z11 && !profileActivity.w1 && this.I0.d(14)) {
            if (!this.f2 && (i11 = profileActivity.u1) > 0 && wr0Var != null) {
                this.f2 = true;
                wr0Var.M = i11;
                wr0Var.e();
            }
        ...
        if (!profileActivity.t1 || !profileActivity.w1 || this.f2 || (i10 = profileActivity.u1) <= 0 || wr0Var == null) {
            return;
        }
        this.f2 = true;
        wr0Var.M = i10;
