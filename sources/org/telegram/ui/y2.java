...
public final class y2 extends FrameLayout implements org.telegram.ui.Components.mz0, org.telegram.ui.Cells.k9 {
    public final p70 a;
    public final l4 b;
    public final x2 c;
    public f3 d;
    ...
    public y2(Context context, p70 p70Var, l4 l4Var) {
        super(context);
        this.v = new androidx.emoji2.text.n(this);
        this.a = p70Var;
        this.b = l4Var;
        x2 x2Var = new x2(this, context, p70Var);
        this.c = x2Var;
        float f10 = 18;
        x2Var.setPadding(AndroidUtilities.dp(f10), 0, AndroidUtilities.dp(f10), 0);
        x2Var.setClipToPadding(false);
        addView(x2Var, k7.b6.c(-2.0f, -1));
        org.telegram.ui.Components.nz0 nz0Var = new org.telegram.ui.Components.nz0(context, this, ((n4) p70Var).L0);
        this.e = nz0Var;
        nz0Var.setOrientation(0);
        nz0Var.setRowOrderPreserved(true);
        x2Var.addView(nz0Var, new FrameLayout.LayoutParams(-2, -2));
    ...
    public final org.telegram.ui.Components.fz0 createTextLayout(TL_iv.pageTableCell pagetablecell, int i10) {
        ...
        return n4.p(this.a, this, null, pagetablecell.text, i10, -1, this.s, pagetablecell.align_right ? Layout.Alignment.ALIGN_OPPOSITE : pagetablecell.align_center ? Layout.Alignment.ALIGN_CENTER : Layout.Alignment.ALIGN_NORMAL, 0, this.b);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        n4.u(canvas, p70Var, this.s, getMeasuredHeight());
    }
    ...
    public final void onLayoutChild(org.telegram.ui.Components.fz0 fz0Var, int i10, int i11) {
        if (!(fz0Var instanceof f3)) {
            return;
        }
        p70 p70Var = this.a;
        if (p70Var.B.isEmpty() || p70Var.C == null) {
            return;
        }
        f3 f3Var = (f3) fz0Var;
        ...
        int i12 = 0;
        while (true) {
            int indexOf = lowerCase.indexOf(p70Var.C, i12);
            if (indexOf < 0) {
                return;
            }
            int length = p70Var.C.length() + indexOf;
            if (indexOf == 0 || AndroidUtilities.isPunctuationCharacter(lowerCase.charAt(indexOf - 1))) {
                HashMap hashMap = this.b.y;
                String str = p70Var.C + this.s + f3Var.r + indexOf;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblocktable != null) {
            ...
            f3 p10 = n4.p(this.a, this, null, pageblocktable2.title, i15, 0, pageblocktable2, Layout.Alignment.ALIGN_CENTER, 0, this.b);
            this.d = p10;
            if (p10 != null) {
            ...
            i12 = org.telegram.messenger.y3.C(8.0f, x2Var.getMeasuredHeight(), i13);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (i10 < childCount) {
            ...
            if (fz0Var instanceof f3) {
                ...
                if (n4.l(this.a, this.b, motionEvent3, this, f3Var, d.b() + (x2Var.getPaddingLeft() - x2Var.getScrollX()) + this.f, d.c() + this.h)) {
                    return true;
                }
            } else {
        ...
        return n4.l(this.a, this.b, motionEvent4, this, this.d, this.n, 0) || super.onTouchEvent(motionEvent4);
    }
    ...
    public void setBlock(TL_iv.pageBlockTable pageblocktable) {
        ...
        l4 l4Var = this.b;
        nz0Var.setRtl(l4Var != null && l4Var.D);
