...
public final class y2 extends FrameLayout implements org.telegram.ui.Components.bz0, org.telegram.ui.Cells.j9 {
    ...
    public final x2 c;
    public f3 d;
    public final org.telegram.ui.Components.cz0 e;
    public int f;
    public int h;
    public int n;
    public boolean r;
    ...
    public final void a() {
        ...
        org.telegram.ui.Components.cz0 cz0Var = this.e;
        int childCount = cz0Var.getChildCount();
        for (int i11 = 0; i11 < childCount; i11++) {
            org.telegram.ui.Components.vy0 d = cz0Var.d(i11);
            org.telegram.ui.Components.uy0 uy0Var = d.b;
            if (uy0Var != null) {
                uy0Var.setX((AndroidUtilities.dp(18.0f) + (d.b() + this.f)) - this.c.getScrollX());
                d.b.setY(d.c() + this.h);
                d.b.setRow(d.j + 10);
                d.r = i10;
                i10++;
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            org.telegram.ui.Components.uy0 uy0Var = cz0Var.d(i10).b;
            if (uy0Var != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblocktable != null) {
            ...
            f3 p10 = m4.p(this.a, this, null, pageblocktable2.title, i15, 0, pageblocktable2, Layout.Alignment.ALIGN_CENTER, 0, this.b);
            this.d = p10;
            if (p10 != null) {
    ...
    public void setBlock(TL_iv.pageBlockTable pageblocktable) {
        ...
        cz0Var.G.clear();
        cz0Var.g();
        cz0Var.setDrawLines(this.s.bordered);
        cz0Var.setStriped(this.s.striped);
        k4 k4Var = this.b;
        cz0Var.setRtl(k4Var != null && k4Var.C);
