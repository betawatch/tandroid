...
public final class y2 extends FrameLayout implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.r9 {
    ...
    public final void c(z2 z2Var) {
        ...
        Bitmap bitmap3;
        z2 z2Var2 = this.M;
        if (z2Var2 != null && (bitmap2 = z2Var.b) != null && (bitmap3 = z2Var2.b) != null && bitmap2 != bitmap3) {
            bitmap3.recycle();
            this.M.b = null;
        }
        z2 z2Var3 = this.M;
        if (z2Var3 != null && z2Var.b == null && (bitmap = z2Var3.b) != null) {
            z2Var.a = z2Var3.a;
            z2Var.b = bitmap;
        }
        this.M = z2Var;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!imageReceiver.hasBitmapImage() || imageReceiver.getCurrentAlpha() != 1.0f) {
            canvas.drawRect(imageReceiver.getDrawRegion(), j4.o1);
        }
            ...
            if (i22 != 2) {
                ...
                if (pageblockvideo == null) {
                    if (i22 != 0 || (i21 = pageblockvideo.level) <= 0) {
                        ...
                        this.x = i16;
                        i15 = org.telegram.messenger.em.v(18.0f, i16, i12);
                        dp = i15;
                    }
                                    ...
                                    if (this.P) {
                                        ...
                                        if (z2Var == null || z2Var.b == null) {
                                            ...
                                            if (this.R || pathToAttach.exists() || pathToAttach2.exists()) {
                                                ...
                                                imageReceiver.setImage(null, null, ImageLocation.getForDocument(this.O), "200_200_pframe", ImageLocation.getForDocument(closestPhotoSizeWithSize, this.O), "80_80_b", null, this.O.size, null, h4Var2.E, 1);
                                            } else {
                                                imageReceiver.setStrippedLocation(ImageLocation.getForDocument(this.O));
                                                imageReceiver.setImage(null, null, null, null, ImageLocation.getForDocument(closestPhotoSizeWithSize, this.O), "80_80_b", null, this.O.size, null, h4Var2.E, 1);
                                            }
                                        } else {
                                            imageReceiver.setStrippedLocation(null);
                                        ...
                                        imageReceiver.setStrippedLocation(null);
                                        imageReceiver.setImage(null, null, ImageLocation.getForDocument(closestPhotoSizeWithSize, this.O), "80_80_b", 0L, null, h4Var2 != null ? h4Var2.E : null, 1);
                                    }
                                }
                    ...
                    if (i22 == 0) {
                        TL_iv.pageBlockVideo pageblockvideo2 = this.L;
                        c3 q6 = j4.q(this.a, this, null, pageblockvideo2.caption.text, dp, imageHeight3, pageblockvideo2, this.b);
                        this.c = q6;
                        if (q6 != null) {
                            int height = this.c.d.getHeight() + AndroidUtilities.dp(4.0f);
                            this.E = height;
                            i17 = org.telegram.messenger.a2.C(4.0f, height, i17);
                            c3 c3Var = this.c;
                            c3Var.s = this.x;
                            c3Var.v = this.y;
                        }
                        ...
                        h4Var = h4Var2;
                        c3 p5 = j4.p(this.a, this, null, pageblockvideo3.caption.credit, dp, 0, pageblockvideo3, (h4Var2 == null || !h4Var2.G) ? Layout.Alignment.ALIGN_NORMAL : org.telegram.ui.Components.uw0.a(), 0, this.b);
                        this.d = p5;
                        if (p5 != null) {
                            i17 = this.d.d.getHeight() + AndroidUtilities.dp(4.0f) + i27;
                            c3 c3Var2 = this.d;
                            c3Var2.s = this.x;
                            c3Var2.v = this.y + this.E;
                        } else {
                            i17 = i27;
                        }
                    } else {
                    ...
                    if ((this.N instanceof TL_iv.pageBlockCover) && h4Var != null) {
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        h4 h4Var = this.b;
        if (visibility != 0 || y3 <= e1Var.getTranslationY() || y3 >= e1Var.getTranslationY() + AndroidUtilities.dp(39.0f)) {
            ...
            if (!this.H && this.J == 0) {
                if (!j4.l(this.a, this.b, motionEvent, this, this.c, this.x, this.y)) {
                    if (!j4.l(this.a, this.b, motionEvent, this, this.d, this.x, this.y + this.E) && !super.onTouchEvent(motionEvent)) {
                        return false;
                    }
                }
            }
        } else if (h4Var != null && h4Var.F != null) {
