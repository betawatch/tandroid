...
public final class l80 extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    ...
    public l80(n80 n80Var, Context context, org.telegram.ui.ActionBar.w1 w1Var) {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.l1(0.6f, n80Var.getThemedColor(i10)), PorterDuff.Mode.SRC_IN));
        ...
        h2Var.setTextColor(n80Var.getThemedColor(i10));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        rectF.set(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f), getWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f) + n80Var.b.e + AndroidUtilities.dp(3.0f));
        Path path = this.b;
        path.rewind();
        path.addRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), Path.Direction.CW);
        GradientDrawable gradientDrawable = this.e;
        if (gradientDrawable != null) {
            gradientDrawable.setBounds(0, 0, getWidth(), Math.min(getHeight(), AndroidUtilities.dp(24.0f) + ((int) n80Var.b.e)));
            this.e.draw(canvas);
        }
        canvas.save();
