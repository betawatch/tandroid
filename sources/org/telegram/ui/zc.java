...
public final class zc extends FrameLayout {
    ...
    public final void a(String str, boolean z10) {
        ...
        while (true) {
            ...
            if (!TextUtils.equals(this.s, kpVar.a()) && (!TextUtils.isEmpty(str) || !kpVar.a.a)) {
                z11 = false;
            }
            kpVar.d = z11;
            if (z11) {
    ...
    public void setGalleryWallpaper(TLRPC.WallPaper wallPaper) {
        ...
        if (this.v != null) {
            ...
            if ((arrayList.isEmpty() || ((org.telegram.ui.Components.kp) arrayList.get(0)).a.a) && this.f) {
                arrayList.add(0, new org.telegram.ui.Components.kp(org.telegram.ui.ActionBar.d4.a(this.a)));
                this.h.l();
            }
        }
    }
