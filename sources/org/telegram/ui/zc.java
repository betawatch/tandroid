...
public final class zc extends FrameLayout {
    ...
    public final void a(String str, boolean z10) {
        ...
        for (int i12 = 0; i12 < fc1Var.getChildCount(); i12++) {
            ...
            if ((childAt instanceof org.telegram.ui.Components.k21) && (S = RecyclerView.S(childAt)) >= 0 && S < arrayList.size()) {
                ((org.telegram.ui.Components.k21) childAt).g(((org.telegram.ui.Components.lp) arrayList.get(S)).d, true);
            }
        }
    }
