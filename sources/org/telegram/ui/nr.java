...
public final class nr extends Drawable {
    ...
    public nr(Context context, int i9, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        Path path = new Path();
        this.i = path;
        this.m = new org.telegram.ui.Components.y5(new ri(this, 12), 320L, org.telegram.ui.Components.gr.h, 0);
    ...
    public final void draw(Canvas canvas) {
        ...
        float d9 = i6Var2.d() + (i6Var2.g() * dp2);
        int saveCount = canvas.getSaveCount();
        Rect bounds = getBounds();
        if (d > 0.0f || d9 > 0.0f || e10 > 0.0f) {
            canvas2 = canvas;
        ...
        if (e10 > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.Oh, this.a);
            int i11 = this.k;
