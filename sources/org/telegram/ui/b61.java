    ...
    public final boolean c(float f7, float f10, int i10, View view) {
        ...
        if (i12 != 11 && i12 != 13 && l71Var.h1) {
            ...
            if (z10 && (i12 == 1 || i12 == 8)) {
                ...
                u61 u61Var = (u61) view;
                if (!u61Var.s && !UserConfig.getInstance(i11).isPremium()) {
                ...
                if (u61Var.s) {
                    ...
                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i11).getReactionsMap().get(l71Var.S0.x.f);
                    if (tL_availableReaction != null) {
                        l71Var.V0.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, null, 0L, "tgs", l71Var.S0.x, 0);
                    }
                } else {
            ...
            if (z10) {
                ...
                if (u61Var2.e != null && (i12 == 0 || i12 == 12 || i12 == 9 || i12 == 10)) {
                    ...
                    a61 a61Var = new a61(this, this.b, l71Var.T1, l71Var, u61Var2, this.c, view, tL_starGiftUnique);
                    l71Var.X0 = a61Var;
                    a61Var.show();
                    try {
