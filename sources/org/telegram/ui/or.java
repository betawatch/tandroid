...
public final class or extends org.telegram.ui.Components.xl0 {
    ...
    */
    public final boolean D(s4.c1 c1Var) {
        ...
        if (i10 != 16) {
            ...
            if (i10 == 0) {
                Object currentObject = ((org.telegram.ui.Cells.c5) c1Var.a).getCurrentObject();
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        switch (i15) {
                    ...
                    if (chat == null) {
                        if (i14 != 3) {
                            if (i14 != 0) {
                                if (i14 != 1) {
                                    if (i14 == 2) {
                                        c5Var.b(chat, null, (!z10 || i16 == 0) ? null : LocaleController.formatJoined(i16), i10 != i12 + (-1));
                                        break;
                                    }
                                } else {
                                    if (!z14) {
                                        ...
                                        c5Var.b(chat, null, charSequence2, i10 == i12 + (-1));
                                        break;
                                    } else {
                                ...
                                c5Var.b(chat, null, (!z13 || (user2 = srVar.getMessagesController().getUser(Long.valueOf(j11))) == null) ? null : LocaleController.formatString(R.string.UserRemovedBy, UserObject.getUserName(user2)), i10 != i12 + (-1));
                                break;
                            }
                        } else {
                            ...
                            c5Var.b(chat, null, sb2, i10 != i12 + (-1));
                            break;
                        }
                    }
                } else {
                                    ...
                                    if (i10 != srVar.K0) {
                                        if (i10 != srVar.M0) {
                                            if (i10 != srVar.u0) {
                                                if (i10 != srVar.R0) {
                                                    if (i10 == srVar.j1) {
                                                        f9Var.setText(LocaleController.getString(srVar.v1 ? R.string.ChannelSignProfilesInfo : R.string.ChannelSignInfo));
                                                        break;
                                                    }
                                                } else if (!srVar.r1) {
            ...
            case 2:
                ...
                z4Var.a(org.telegram.ui.ActionBar.j6.m6, org.telegram.ui.ActionBar.j6.G6);
                if (i10 != srVar.z0) {
                    if (i10 != srVar.v0) {
                        if (i10 != srVar.A0) {
                            if (i10 == srVar.t0) {
                                z4Var.a(org.telegram.ui.ActionBar.j6.v6, org.telegram.ui.ActionBar.j6.u6);
                                z4Var.b(LocaleController.getString("BroadcastGroupConvert", R.string.BroadcastGroupConvert), R.drawable.msg_channel, 5, false);
                                break;
                            }
                        } else {
                            z4Var.a(org.telegram.ui.ActionBar.j6.v6, org.telegram.ui.ActionBar.j6.u6);
                            ...
                            z4Var.b(LocaleController.getString("ChannelInviteViaLink", R.string.ChannelInviteViaLink), R.drawable.msg_link2, 5, z20);
                            break;
                        }
                    } else {
                        z4Var.b(LocaleController.getString(R.string.EventLog), R.drawable.msg_log, 5, srVar.x0 > srVar.v0);
                        break;
                    }
                } else if (i14 != 3) {
                    if (i14 != 0) {
                        if (i14 != 1) {
                            if (i14 == 2) {
                                ...
                                if (!z17) {
                                    z4Var.b(LocaleController.getString(R.string.AddMember), R.drawable.msg_contact_add, 5, z19);
                                    break;
                                } else {
                                    z4Var.b(LocaleController.getString(R.string.AddSubscriber), R.drawable.msg_contact_add, 5, z19);
                                    break;
                                }
                            }
                        } else {
                            z4Var.a(org.telegram.ui.ActionBar.j6.v6, org.telegram.ui.ActionBar.j6.u6);
                            z4Var.b(LocaleController.getString("ChannelAddAdmin", R.string.ChannelAddAdmin), R.drawable.msg_admin_add, 5, !srVar.Q || srVar.R);
                            break;
                        }
                    } else {
                        z4Var.b(LocaleController.getString("ChannelBlockUser", R.string.ChannelBlockUser), R.drawable.msg_user_remove, 5, false);
                        break;
                    }
                } else {
                    z4Var.a(org.telegram.ui.ActionBar.j6.v6, org.telegram.ui.ActionBar.j6.u6);
                    z4Var.b(LocaleController.getString("ChannelAddException", R.string.ChannelAddException), R.drawable.msg_contact_add, 5, srVar.E0 != -1);
                    break;
                }
                break;
            case 5:
                ...
                if (i10 != srVar.D0) {
                    if (i10 != srVar.S) {
                        if (i10 != srVar.N0) {
                            if (i10 != srVar.s0) {
                                if (i10 == srVar.p0) {
                                    n4Var.setText(LocaleController.getString(R.string.GroupMessagesPriceHeader));
                                    break;
                                }
                            } else {
                                n4Var.setText(LocaleController.getString(R.string.BroadcastGroup));
                                break;
                            }
                        } else {
                            n4Var.setText(LocaleController.getString(R.string.Slowmode));
                            break;
                        }
                    } else {
                        n4Var.setText(LocaleController.getString(z16 ? R.string.CommunityPermissionsHeader : R.string.ChannelPermissionsHeader));
                        break;
                    }
                } else if (i14 != 0) {
                    n4Var.setText(LocaleController.getString(R.string.ChannelRestrictedUsers));
                    break;
                } else {
                    TLRPC.ChatFull chatFull3 = srVar.s;
                    int size = chatFull3 != null ? chatFull3.kicked_count : arrayList.size();
                    if (size == 0) {
                        n4Var.setText(LocaleController.getString(R.string.ChannelBlockedUsers));
                        break;
                    } else {
                        n4Var.setText(LocaleController.formatPluralString("RemovedUser", size, new Object[0]));
                        break;
                    }
                }
                break;
            ...
            case 14:
                ...
                if (i10 == srVar.g0) {
                    w8Var.d(LocaleController.getString(z16 ? R.string.CommunityAdminRightEditCommunityName : R.string.UserRestrictionsChangeInfo), (srVar.E.change_info || ChatObject.isPublic(srVar.r)) ? false : true, srVar.l0 != -1, z39);
                } else if (i10 == srVar.m0) {
                    w8Var.d(LocaleController.getString(R.string.CommunityAdminRightEditGroupList), !srVar.E.manage_linked_peers, false, z39);
                } else if (i10 == srVar.h0) {
                    w8Var.d(LocaleController.getString("UserRestrictionsInviteUsers", R.string.UserRestrictionsInviteUsers), !srVar.E.invite_users, true, z39);
                } else if (i10 == srVar.i0) {
                    w8Var.d(LocaleController.getString(R.string.UserRestrictionsPinMessages), (srVar.E.pin_messages || ChatObject.isPublic(srVar.r)) ? false : true, true, z39);
                } else if (i10 == srVar.j0) {
                    w8Var.d(LocaleController.getString(R.string.UserRestrictionsEditTags), !srVar.E.edit_rank, true, z39);
                } else if (i10 == srVar.T) {
                    w8Var.d(LocaleController.getString("UserRestrictionsSendText", R.string.UserRestrictionsSendText), !srVar.E.send_plain, true, z39);
                } else if (i10 == srVar.Q0) {
                    w8Var.d(LocaleController.getString(R.string.GroupNotRestrictBoosters), srVar.r1, false, z39);
                    ...
                    w8Var.a(new i9.s(this, w8Var, false, 22), a4.a.m(n02, "/10"), !srVar.l1);
                } else if (i10 == srVar.e0) {
                    w8Var.d(LocaleController.getString("UserRestrictionsSendStickers", R.string.UserRestrictionsSendStickers), !srVar.E.send_stickers, true, z39);
                } else if (i10 == srVar.f0) {
                    w8Var.d(LocaleController.getString("UserRestrictionsEmbedLinks", R.string.UserRestrictionsEmbedLinks), !srVar.E.embed_links, true, z39);
                } else if (i10 == srVar.d0) {
                    w8Var.d(LocaleController.getString("UserRestrictionsSendPollsShort", R.string.UserRestrictionsSendPollsShort), !srVar.E.send_polls, true, false);
                } else if (i10 == srVar.l0) {
                    w8Var.d(LocaleController.getString("CreateTopicsPermission", R.string.CreateTopicsPermission), !srVar.E.manage_topics, false, z39);
                }
                ...
                if (i10 != srVar.Z0) {
                    if (i10 != srVar.W0) {
                        if (i10 != srVar.T0) {
                            ...
                            w3Var.setText(LocaleController.getString("ChannelContacts", R.string.ChannelContacts));
                            break;
                        } else {
                            w3Var.setText(LocaleController.getString("GroupContacts", R.string.GroupContacts));
                            break;
                        }
                    } else {
                        w3Var.setText(LocaleController.getString("ChannelBots", R.string.ChannelBots));
                        break;
                    }
                } else if (ChatObject.isChannel(srVar.r) && !srVar.r.megagroup) {
                    w3Var.setText(LocaleController.getString("ChannelOtherSubscribers", R.string.ChannelOtherSubscribers));
                    break;
                } else {
                    w3Var.setText(LocaleController.getString("ChannelOtherMembers", R.string.ChannelOtherMembers));
                    break;
                }
                break;
            case 11:
            ...
            case 12:
                ...
                if (i10 != srVar.x0) {
                    if (i10 != srVar.J0) {
                        ...
                        s8Var.getCheckBox().setIcon((ChatObject.canUserDoAdminAction(srVar.r, 2) && ((chatFull = srVar.s) == null || chatFull.participants_hidden || srVar.l0() >= srVar.getMessagesController().hiddenMembersGroupSizeMin)) ? 0 : R.drawable.permission_locked);
            ...
            case 16:
                ...
                if (i10 != srVar.h1) {
                    if (i10 != srVar.i1) {
                        if (i10 == srVar.n0) {
                            x8Var.f(LocaleController.getString(R.string.GroupMessagesChargePrice), srVar.y1, false);
                            break;
                        }
                    } else {
                        x8Var.f(LocaleController.getString(R.string.ChannelSignMessagesWithProfile), srVar.w1, false);
                        break;
                    }
                } else {
            ...
            case 17:
                ...
                if (i10 == srVar.q0) {
                    int[] a2 = org.telegram.ui.Cells.a8.a((int) srVar.getMessagesController().starsPaidMessageAmountMax, new int[]{1, 10, 50, 100, 200, MediaDataController.MAX_LINKS_COUNT, 400, 500, MediaDataController.MAX_STYLE_RUNS_COUNT, 2500, 5000, 7500, 9000, 10000});
                    int clamp = (int) Utilities.clamp(srVar.A1, srVar.getMessagesController().starsPaidMessageAmountMax, 1L);
                    m4.q0 q0Var = new m4.q0(27);
                    org.telegram.ui.Cells.z7 z7Var = new org.telegram.ui.Cells.z7();
                    z7Var.c = a2;
                    z7Var.d = 20;
                    z7Var.e = q0Var;
                    a8Var.d(clamp, z7Var, new s3(this, 3));
                    break;
                }
                break;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                int i11 = srVar.O;
                org.telegram.ui.Cells.c5 c5Var = new org.telegram.ui.Cells.c5((i11 == 0 || i11 == 3) ? 7 : 6, (i11 == 0 || i11 == 3) ? 6 : 2, this.c, null, srVar.e1 == 0);
            ...
            case 1:
                ...
                break;
            case 2:
                view = new org.telegram.ui.Cells.z4(context);
                break;
            case 3:
            ...
            case 11:
                ...
                break;
            case 12:
                org.telegram.ui.Cells.s8 s8Var = new org.telegram.ui.Cells.s8(23, this.c, srVar.getResourceProvider(), false, true);
                s8Var.v = 50;
                view = s8Var;
                break;
            case 13:
            ...
            case 15:
                ...
                gw0Var2.setCallback(new nr(this, 2));
                view2 = gw0Var2;
                view = view2;
                break;
            case 16:
                view = new org.telegram.ui.Cells.x8(context, srVar.getResourceProvider());
                break;
            case 17:
                view = new org.telegram.ui.Cells.a8(context, srVar.getResourceProvider());
                break;
        }
