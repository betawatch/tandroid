    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                do0 do0Var = paymentFormActivity$TelegramWebviewProxy.a;
                if (do0Var.getParentActivity() != null && str5.equals("payment_form_submit")) {
                    try {
                        JSONObject jSONObject = new JSONObject(str6);
                        do0Var.s0 = jSONObject.getJSONObject("credentials").toString();
                        do0Var.t0 = jSONObject.getString("title");
                    } catch (Throwable th) {
                        do0Var.s0 = str6;
                        FileLog.e(th);
                    }
            ...
            case 3:
                ...
                for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                    ((ih.a) arrayList2.get(i10)).a.delete();
                }
            ...
            case 4:
                ...
                try {
                    ...
                    try {
                        try {
                            mediaMetadataRetriever.setDataSource(s7Var.getContext(), Uri.fromFile(aVar.a));
                        ...
                        str2 = str;
                        AndroidUtilities.runOnUIThread(new cg.k0(s7Var, aVar, tL_documentAttributeAudio, str2, str7, 20));
                        return;
                    }
                    try {
            ...
            case 7:
                ...
                return;
            case 8:
                na.X((na) this.d, (org.telegram.ui.ActionBar.b2) this.b, (TLRPC.User) this.c);
                return;
            case 9:
                qb.Z((qb) this.d, (TLRPC.TL_error) this.b, (TLObject) this.c);
                return;
            case 10:
                vc vcVar = (vc) this.d;
            ...
            case 12:
                ...
                return;
            case 13:
                ((q91) this.d).showDialog(fe.d0((Context) this.b, (org.telegram.ui.ActionBar.c6) this.c, false));
                return;
            case 14:
                AndroidUtilities.runOnUIThread(new rd(3, (hh.i2) this.c, ((rn) this.d).getMessagesStorage().getUser(((TLRPC.TL_contact) this.b).user_id)));
                return;
            case 15:
                rn.J0((rn) this.d, (TLRPC.User) this.b, (TLRPC.EmojiStatus) this.c);
                return;
            case 16:
                rn rnVar2 = (rn) this.d;
                org.telegram.ui.Components.ol0 ol0Var = (org.telegram.ui.Components.ol0) this.b;
                TLRPC.User user = (TLRPC.User) this.c;
                rnVar2.getClass();
                ol0Var.dismiss();
                rnVar2.presentFragment(ProfileActivity.m4(user.id));
                return;
            case 17:
                rn rnVar3 = (rn) this.d;
            ...
            case 18:
                ...
                org.telegram.ui.Components.y4.T(rnVar4.getParentActivity(), suggestedPost != null ? suggestedPost.schedule_date : 0L, new b7(rnVar4, suggestedPost, (MessageObject) this.c, 5), rnVar4.getResourceProvider(), 0).a.show();
                return;
            case 19:
                rn.f0((rn) this.d, (hf.a) this.b, (Runnable) this.c);
                return;
            case 20:
                rn.l0((rn) this.d, (TLObject) this.b, (TLRPC.User) this.c);
                return;
            case 21:
                org.telegram.ui.Components.y4.f0(r0.currentAccount, (TLRPC.TL_error) this.b, (rn) this.d, (TLRPC.TL_messages_editMessage) this.c, new Object[0]);
                return;
            case 22:
                rn rnVar5 = (rn) this.d;
                MessagesStorage messagesStorage = (MessagesStorage) this.b;
                CountDownLatch countDownLatch = (CountDownLatch) this.c;
                rnVar5.f = messagesStorage.getUser(rnVar5.h.user_id);
            ...
            case 23:
                ...
                if (tLObject5 instanceof TLRPC.TL_photos_photo) {
                    ...
                    rn rnVar6 = ulVar.a.M;
                    rnVar6.getMessagesController().putUsers(tL_photos_photo.users, false);
                    TLRPC.User user2 = rnVar6.getMessagesController().getUser(Long.valueOf(rnVar6.getUserConfig().clientUserId));
                    if ((tL_photos_photo.photo instanceof TLRPC.TL_photo) && user2 != null) {
                        gf.l0.a(messageObject.messageOwner.action.photo, user2, false);
                        rnVar6.getUserConfig().setCurrentUser(user2);
                        rnVar6.getUserConfig().saveConfig(true);
                        org.telegram.ui.Components.mc.a0(rnVar6).V(Collections.singletonList(user2), AndroidUtilities.replaceTags(LocaleController.getString(R.string.ApplyAvatarHintTitle)), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ApplyAvatarHint), new ti(tlVar, 5)), null).j();
                    }
                }
                messageObject.settingAvatar = false;
                return;
            case 24:
                dn.a((dn) this.d, (org.telegram.ui.Cells.s1) this.b, (TLRPC.Document) this.c);
                return;
            case 25:
                ((dn) this.d).n((org.telegram.ui.Cells.s1) this.b, (TLRPC.User) this.c);
                return;
            case 26:
                ((dn) this.d).m((org.telegram.ui.Cells.s1) this.b, (TLRPC.Chat) this.c, 0, false);
                return;
            case 27:
                jo joVar = (jo) this.d;
                ...
                joVar.getClass();
                if (tL_error3 == null) {
                    joVar.u0.invitesCount = ((TLRPC.TL_messages_exportedChatInvites) tLObject6).count;
                    joVar.getMessagesStorage().saveChatLinksCount(joVar.s0, joVar.u0.invitesCount);
            ...
            case 28:
                ...
                while (i12 < arrayList3.size()) {
                    ...
                    while (true) {
                        if (i13 < i11) {
                            ...
                            if (lowerCase2.startsWith(str11) || org.telegram.messenger.y1.x(" ", str11, lowerCase2) || (translitString2 != null && (translitString2.startsWith(str11) || org.telegram.messenger.y1.x(" ", str11, translitString2)))) {
                            ...
                            if (r32 != 0) {
                                if (r32 == 1) {
                                    ...
                                    arrayList5.add(AndroidUtilities.generateSearchName(s3.c.e("@", str10), null, "@" + str11));
                                }
                                arrayList4.add(chat);
                            } else {
                                i13++;
                ...
                return;
            default:
                ip.E((ip) this.d, (ArrayList) this.b, (ArrayList) this.c);
                return;
        }
    }

    public /* synthetic */ u1(rn rnVar, org.telegram.ui.Components.b70 b70Var, String str) {
        this.a = 17;
        this.d = rnVar;
        this.c = b70Var;
        this.b = str;
