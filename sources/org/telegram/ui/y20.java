...
public final class y20 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        if (s50Var.r1() && !s50Var.W0.isScheduled()) {
            ...
            if (j30Var != null && j30Var.b && (AndroidUtilities.isTablet() || s50.B3 == s50Var.q1())) {
                s50Var.e1(null);
                if (s50.B3) {
                    AndroidUtilities.runOnUIThread(new r00(this, 5), 200L);
                }
                s50Var.e0.setRequestedOrientation(-1);
                return;
            }
            ...
            if (s50Var.q1()) {
                s50Var.e0.setRequestedOrientation(6);
                return;
            } else {
                s50Var.e0.setRequestedOrientation(1);
                return;
        ...
        if (i12 == 5) {
            ...
            final int i13 = 0;
            accountInstance.getConnectionsManager().sendRequest(startscheduledgroupcall, new RequestDelegate(this) { // from class: org.telegram.ui.x20
                    ...
                    switch (i13) {
                        case 0:
                            ...
                            if (tLObject == null) {
                                ...
                                y20Var.b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                break;
                            }
                        default:
                            y20 y20Var2 = this.b;
                            if (tLObject == null) {
                                ...
                                y20Var2.b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                break;
                            }
                    }
                }
        ...
        if (i12 == 7 || i12 == 6) {
            if (i12 == 6 && (x30Var = s50Var.j0) != null) {
                x30Var.b(true);
            }
            ...
            final int i14 = 1;
            accountInstance.getConnectionsManager().sendRequest(togglegroupcallstartsubscription, new RequestDelegate(this) { // from class: org.telegram.ui.x20
                public final /* synthetic */ y20 b;
        ...
        if (i15 != 2 && i15 != 4) {
            try {
                if (i15 != 0) {
                    ...
                    if (Build.VERSION.SDK_INT >= 23 && (launchActivity = s50Var.e0) != null && launchActivity.checkSelfPermission("android.permission.RECORD_AUDIO") != 0) {
        ...
        oi0Var.N(i16);
        oi0Var.P(i16 - 1, this.a);
        w20Var.setAnimation(oi0Var);
        oi0Var.K(i11);
        w20Var.d();
        if (s50Var.B1 == 2) {
            long peerId = MessageObject.getPeerId(((TLRPC.GroupCallParticipant) s50Var.W0.participants.f(MessageObject.getPeerId(s50Var.w0))).peer);
