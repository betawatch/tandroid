...
public final class dl implements org.telegram.ui.Components.rk0 {
    ...
    */
    public final void h(View view, zg.p0 p0Var, boolean z10, boolean z11) {
        ...
        if (znVar.a() == znVar.getUserConfig().getClientUserId() && !znVar.getUserConfig().isPremium()) {
            new rg.x0((org.telegram.ui.ActionBar.n2) znVar, 24, true).show();
            znVar.z7(false);
            return;
        }
        boolean contains = znVar.ab.getSelectedReactions().contains(p0Var);
        ...
        while (i12 < sparseArrayArr.length) {
            ...
            while (i15 < sparseArrayArr[i12].size()) {
                ...
                if (messageObject2.hasReaction(p0Var) == contains) {
                    ...
                    i10 = i12;
                    i11 = i15;
                    znVar.ab(znVar.q8(messageObject2.getId(), false), messageObject, null, null, 0.0f, 0.0f, p0Var, false, false, false, true);
                    if (!z12) {
                        i14++;
                    }
                } else {
        ...
        if (i13 > 0) {
            ...
            org.telegram.ui.Components.xc.a0(znVar).y(i13, f7, null).k(true);
        }
    }
