...
public abstract class ai1 extends org.telegram.ui.ActionBar.n2 {
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (yh1Var != null) {
                org.telegram.ui.ActionBar.n2 n2Var = yh1Var.a;
                if (n2Var.fragmentView != null) {
                    ...
                    yh1Var.f = f11;
                    boolean z12 = f11 > f10;
                    if (!yh1Var.d && r10 > 0.0f && z10 && n2Var.fragmentView != null) {
                        n2Var.onResume();
                        yh1Var.d = true;
                    }
                    if (!yh1Var.e && ((f10 == 0.0f || f10 == 1.0f) && f10 != f11 && Math.abs(f10 - f11) != 1.0f)) {
                    ...
                    if (yh1Var.e && (f11 == 0.0f || f11 == 1.0f)) {
                        n2Var.onTransitionAnimationEnd(z12, false);
                        yh1Var.e = false;
                    }
                    if (!yh1Var.c && f11 >= 1.0f) {
                        n2Var.onBecomeFullyVisible();
                        yh1Var.c = true;
                    }
                    if (yh1Var.c && ((f11 == 0.0f && !z11) || r10 == 0.0f)) {
                        n2Var.onBecomeFullyHidden();
                        yh1Var.c = false;
                    }
                    if (yh1Var.d && ((f11 == 0.0f && !z10) || r10 == 0.0f)) {
                        n2Var.onPause();
                        yh1Var.d = false;
                    }
                }
    ...
    public final org.telegram.ui.ActionBar.n2 X() {
        ...
        yh1 yh1Var = (yh1) this.a.get(zh1Var.getCurrentPosition());
        if (yh1Var != null) {
            return yh1Var.a;
        }
        return null;
    ...
    public View createView(Context context) {
        ...
        this.b = new j0((gh0) this, context, 12);
    ...
    public final void setTitleOverlayText(String str, int i10, Runnable runnable) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (yh1Var != null) {
                yh1Var.a.setTitleOverlayText(str, i10, runnable);
            }
        }
    }
