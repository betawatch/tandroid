...
public final class g80 extends FrameLayout implements org.telegram.ui.ActionBar.y5 {
    ...
    public g80(i80 i80Var, Context context, org.telegram.ui.ActionBar.v1 v1Var) {
        super(context);
        this.f = i80Var;
        this.a = new Paint(1);
        this.b = new Path();
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.l1(0.6f, i80Var.getThemedColor(i10)), PorterDuff.Mode.SRC_IN));
        ...
        h2Var.addTextChangedListener(new f80(this));
        if (Build.VERSION.SDK_INT >= 35) {
            h2Var.setLocalePreferredLineHeightForMinimumUsed(false);
        }
        h2Var.setTextColor(i80Var.getThemedColor(i10));
        h2Var.setHintTextColor(i80Var.getThemedColor(org.telegram.ui.ActionBar.h6.H6));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        i80 i80Var = this.f;
        paint.setColor(i80Var.getThemedColor(i10));
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f), getWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(3.0f) + i80Var.b.e + AndroidUtilities.dp(3.0f));
        Path path = this.b;
        path.rewind();
        path.addRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), Path.Direction.CW);
        GradientDrawable gradientDrawable = this.e;
        if (gradientDrawable != null) {
            gradientDrawable.setBounds(0, 0, getWidth(), Math.min(getHeight(), AndroidUtilities.dp(24.0f) + ((int) i80Var.b.e)));
            this.e.draw(canvas);
        }
        canvas.save();
