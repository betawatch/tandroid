...
public final class t61 extends org.telegram.ui.Components.ul0 {
    public int c;
    public int d;
    public int h;
    ...
    public final void E(boolean z10) {
        ...
        j71Var.H1 = ofFloat;
        ofFloat.addUpdateListener(new q51(j71Var, z12, i11));
    ...
    public final int j(int i10) {
        ...
        if (i10 > this.d && (i10 - r5) - 1 < arrayList2.size() && (j71Var.W == 13 || ((zg.o0) j71Var.A1.get((i10 - this.d) - 1)).g != 0)) {
            return 3;
        }
        int i12 = this.h;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 4) {
            if (i16 == 3) {
                ...
                if (arrayList2 == null || i10 < 0 || i10 >= arrayList2.size()) {
                    ...
                    zg.o0 o0Var2 = (zg.o0) j71Var.A1.get(i10);
                    s61Var2.x = o0Var2;
                    long j3 = o0Var2.g;
                    if (j3 == 0) {
                        boolean contains2 = j71Var.J.contains(o0Var2);
                        s61Var2.y = true;
                        s61Var2.setDrawable(Emoji.getEmojiDrawable(o0Var2.f));
                ...
                if (l4 == null && document == null) {
                    ...
                    if (document != null) {
                        s61Var2.e = new org.telegram.ui.Components.y5(document, (Paint.FontMetricsInt) null);
                        s61Var2.d = document;
                        ...
                        s61Var2.e = y5Var;
                        s61Var2.d = y5Var.document;
                        contains = hashSet.contains(l4);
                    }
                    org.telegram.ui.Components.p5 p5Var = (org.telegram.ui.Components.p5) w51Var.d3.get(s61Var2.e.getDocumentId());
                    if (p5Var == null) {
                        cacheType = j71Var.getCacheType();
                        p5Var = org.telegram.ui.Components.p5.n(i15, s61Var2.e.getDocumentId(), null, cacheType);
                        w51Var.d3.put(s61Var2.e.getDocumentId(), p5Var);
                    }
        ...
        if (arrayList4 == null || i10 < 0 || i10 >= arrayList4.size()) {
            ...
            if (arrayList5 == null || i10 < (i12 = this.c) || i10 - i12 >= arrayList5.size()) {
                ...
                o0Var = (zg.o0) j71Var.B1.get(i10 - this.c);
            }
        } else {
            o0Var = (zg.o0) j71Var.A1.get(i10);
        }
        if (s61Var3.h == null) {
        ...
        s61Var3.x = o0Var;
        s61Var3.y = false;
        s61Var3.d(j71Var.J.contains(o0Var), false);
        s61Var3.b = false;
        s61Var3.invalidate();
        if (i14 == 13) {
            s61Var3.setDrawable(Emoji.getEmojiDrawable(o0Var.f));
        } else if (o0Var.b || o0Var.f == null) {
            s61Var3.s = false;
            s61Var3.e = new org.telegram.ui.Components.y5(o0Var.g, (Paint.FontMetricsInt) null);
            s61Var3.d = null;
            s61Var3.h.clearImage();
            imageReceiver.clearImage();
            org.telegram.ui.Components.p5 p5Var2 = (org.telegram.ui.Components.p5) w51Var.d3.get(s61Var3.e.getDocumentId());
            if (p5Var2 == null) {
                cacheType2 = j71Var.getCacheType();
                p5Var2 = org.telegram.ui.Components.p5.n(i15, s61Var3.e.getDocumentId(), null, cacheType2);
                w51Var.d3.put(s61Var3.e.getDocumentId(), p5Var2);
            }
            ...
            if (tL_availableReaction != null) {
                ...
                if (LiteMode.isEnabled(LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS)) {
                    zg.o0 o0Var3 = o0Var;
                    s61Var3.h.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", ImageLocation.getForDocument(tL_availableReaction.select_animation), "30_30_firstframe", null, null, svgThumb, 0L, "tgs", o0Var3, 0);
                    o0Var = o0Var3;
                } else {
                    s61Var3.h.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_firstframe", null, null, svgThumb, 0L, "tgs", o0Var, 0);
                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        return new org.telegram.ui.Components.fl0(s61Var);
    }
}
