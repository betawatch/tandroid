...
public final class du0 extends org.telegram.ui.Components.sv0 {
    ...
    public final void draw(Canvas canvas) {
        ...
        org.telegram.ui.Components.a71 a71Var = photoViewer.w1;
        if (a71Var != null && a71Var.j) {
            a71Var.setBounds(photoViewer.c0.getLeft(), (photoViewer.c0.getWebView().getTop() - measuredHeight) + ((int) (photoViewer.V5 / photoViewer.X5)), photoViewer.c0.getRight(), photoViewer.c0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.V5 / photoViewer.X5)));
            photoViewer.w1.draw(canvas);
        }
        org.telegram.ui.Components.po0 po0Var = photoViewer.x1;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int alpha = (int) (k1Var.getAlpha() * 255.0f * 0.498f);
        Paint paint = this.x0;
    ...
    */
                ...
                if (i22 == 1) {
                    ...
                    if (i23 != 16) {
                        ...
                        if (childAt != hs0Var.J) {
                            ...
                            } else if (hs0Var.f.l(childAt) || photoViewer.S1.f.l(childAt)) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i15 = size2;
        du0Var.setMeasuredDimension(size, i15);
        ...
        if (z30Var == null || z30Var.getVisibility() == 8) {
            ...
            i12 = i10;
            du0Var.measureChildWithMargins(photoViewer.i1, i12, 0, i11, 0);
        ...
        while (i17 < childCount) {
            ...
            if (childAt.getVisibility() != 8 && childAt != photoViewer.i1) {
                ...
                if (childAt == zs0Var) {
                    ...
                    du0Var.measureChildWithMargins(childAt, i12, 0, i11, 0);
                }
            }
            i17++;
            z4 = true;
