...
public final class zg0 extends org.telegram.ui.Components.b6 {
    ...
    public zg0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.E = new d10(this, 26);
        this.G = new Paint(1);
        new ArrayList();
        new ArrayList();
        o1.c cVar = o1.h.s;
        ...
        this.I = jVar2;
        jVar.u = ai.m(1.0f, 1500.0f, 0.75f);
        ...
        jVar2.u = kVar3;
        this.M = new HashSet();
        this.N = new xd.a(0, new hu(this, 22), org.telegram.ui.Components.mr.h, 380L, false);
        this.O = new yd.b(new h(this, 25));
        this.s = f6Var;
    }

    public static void k(zg0 zg0Var, View view, float f10, float f11) {
        float f12;
        float f13;
    ...
    public static void m(zg0 zg0Var, float f10, boolean z4, boolean z10) {
        View view;
        o1.j jVar = zg0Var.I;
        float f11 = Float.MAX_VALUE;
        if (zg0Var.getChildCount() != 0) {
            float f12 = -3.4028235E38f;
            boolean z11 = false;
            float f13 = Float.MAX_VALUE;
            for (int i10 = 0; i10 < zg0Var.getChildCount(); i10++) {
                View childAt = zg0Var.getChildAt(i10);
        ...
        if (zg0Var.getChildCount() == 0) {
            ...
            view = null;
            for (int i11 = 0; i11 < zg0Var.getChildCount(); i11++) {
                View childAt2 = zg0Var.getChildAt(i11);
        ...
        if (z4) {
            ...
            while (true) {
                ...
                View childAt3 = zg0Var.getChildAt(i12);
                if (childAt3.getVisibility() == 0 && (childAt3 instanceof bh.b) && ((bh.b) childAt3).h.f) {
                    view2 = childAt3;
                    break;
                }
                i12++;
        ...
        if (view != null) {
            zg0Var.L = view;
            int childCount2 = zg0Var.getChildCount();
            for (int i13 = 0; i13 < childCount2; i13++) {
                View childAt4 = zg0Var.getChildAt(i13);
                if (childAt4 instanceof bh.b) {
                    ((bh.b) childAt4).e(childAt4 == view, true);
                }
            }
            if (z10) {
    ...
    public void setSkipDrawSelector(boolean z4) {
        this.F = z4;
        if (z4) {
            this.G.setColor(org.telegram.ui.ActionBar.j6.l1(0.09f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.al, this.s)));
        }
        int childCount = getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = getChildAt(i10);
            if (childAt.getVisibility() == 0 && (childAt instanceof bh.b)) {
                ((bh.b) childAt).setSkipDrawSelector(z4);
            }
        }
        invalidate();
    }
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            ...
            ((bh.b) ((org.telegram.ui.Components.a6) n10.a).a).setVisualWidth(n10.b().width());
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < childCount3; i18++) {
            ...
            if (childAt2 instanceof yg0) {
                ((bh.b) ((yg0) childAt2)).setTextSizeDp(f15);
            }
        }
