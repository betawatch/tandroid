...
public final class zg0 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a() {
        ...
        if (tL_messages_stickerSet == null || tL_messages_stickerSet.documents.size() < 4) {
            ...
            this.a.i(ImageLocation.getForDocument(document), "104_104", "tgs", DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.f6.a7, 1.0f), tL_messages_stickerSet);
        }
    }
