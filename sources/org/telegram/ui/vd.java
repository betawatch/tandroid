        ...
        switch (this.a) {
            case 0:
                if (tL_error == null) {
                    ...
                    AndroidUtilities.runOnUIThread(new rt0(tL_error, 22));
                    break;
                }
                break;
            case 1:
                        ...
                        switch (i10) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    s91 f02 = ga1.f0(tL_payments_starsRevenueStats.top_hours_graph, LocaleController.getString(R.string.MonetizationGraphImpressions), 0, false);
                                    ke keVar3 = keVar2;
                                    keVar3.l1 = f02;
                                    ...
                                    keVar3.m1 = ga1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    s91 s91Var = keVar3.l1;
                                    if (s91Var != null) {
                                        s91Var.n = true;
                                    }
                                    keVar3.g1 = tL_payments_starsRevenueStats.usd_rate;
                                    keVar3.g0(true, tL_payments_starsRevenueStats.status);
                                    keVar3.Z0.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.nr.h).withEndAction(new pd(keVar3, 6)).start();
                                    keVar3.a0();
                                    break;
                                }
                                break;
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    keVar32.m1 = ga1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    s91 s91Var = keVar32.l1;
                                    if (s91Var != null) {
                                        s91Var.n = true;
                                    }
                                    keVar32.g1 = tL_payments_starsRevenueStats.usd_rate;
                                    keVar32.g0(true, tL_payments_starsRevenueStats.status);
                                    keVar32.Z0.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.nr.h).withEndAction(new pd(keVar32, 6)).start();
                                    keVar32.a0();
                                    break;
                                }
                                break;
