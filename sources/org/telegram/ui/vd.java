                        ...
                        switch (i10) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    leVar3.p1 = ab1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    ma1 ma1Var = leVar3.o1;
                                    if (ma1Var != null) {
                                        ma1Var.n = true;
                                    }
                                    leVar3.j1 = tL_payments_starsRevenueStats.usd_rate;
                                    leVar3.g0(true, tL_payments_starsRevenueStats.status);
                                    leVar3.c1.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.qr.h).withEndAction(new pd(leVar3, 6)).start();
                                    leVar3.a0();
                                    break;
                                }
                                break;
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    leVar32.p1 = ab1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    ma1 ma1Var = leVar32.o1;
                                    if (ma1Var != null) {
                                        ma1Var.n = true;
                                    }
                                    leVar32.j1 = tL_payments_starsRevenueStats.usd_rate;
                                    leVar32.g0(true, tL_payments_starsRevenueStats.status);
                                    leVar32.c1.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.qr.h).withEndAction(new pd(leVar32, 6)).start();
                                    leVar32.a0();
                                    break;
                                }
                                break;
