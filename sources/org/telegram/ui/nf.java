...
public final /* synthetic */ class nf implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (i11) {
            case 0:
                ...
                Long l4 = (Long) obj;
                if (boVar.R3 == 1) {
                    org.telegram.ui.Components.c5.M(boVar.getParentActivity(), boVar.T5, new b7(boVar, botInlineResult, l4, i13), boVar.ea);
                    break;
                } else {
            ...
            case 1:
                bo.q1((bo) obj3, (i41[]) obj2, (org.telegram.ui.Components.n70) obj);
                break;
            case 2:
                bo boVar2 = (bo) obj3;
                ...
                if (tL_statsPollStats != null) {
                    if (tL_statsPollStats.votes_graph instanceof TL_stats.TL_statsGraphError) {
                        org.telegram.messenger.y0.o(R.string.PollStatsWillLater, org.telegram.ui.Components.vc.a0(boVar2), R.raw.timer_toast, 24);
                        break;
                    } else {
            ...
            case 4:
                ...
                bo boVar4 = ((nj) obj3).b;
                if (b2Var != null) {
                    i10 = ((org.telegram.ui.ActionBar.n2) boVar4).currentAccount;
            ...
            case 19:
                ...
                if (c10Var.a0 != null || (c10Var.Z instanceof TL_chatlists.TL_chatlists_chatlistInviteAlready)) {
                    org.telegram.ui.Components.oc M = org.telegram.ui.Components.vc.a0(n2Var).M(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkUpdatedTitle, c10Var.f0)), arrayList4.size() <= 0 ? LocaleController.formatPluralString("FolderLinkUpdatedSubtitle", c10Var.h0.size(), new Object[0]) : LocaleController.formatPluralString("FolderLinkUpdatedJoinedSubtitle", arrayList4.size(), new Object[0]), R.raw.folder_in);
                    M.j = 5000;
                    M.j();
                    break;
                } else {
                    org.telegram.ui.Components.oc M2 = org.telegram.ui.Components.vc.a0(n2Var).M(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FolderLinkAddedTitle, c10Var.f0)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList4.size(), new Object[0]), R.raw.contact_check);
                    M2.j = 5000;
                    M2.j();
                    break;
                }
            ...
            case 25:
                ...
                if (!((Boolean) obj).booleanValue()) {
                    uyVar.showDialog(new fk0(activity, !org.telegram.ui.Components.de0.c(), new gw(activity, 0)));
                    break;
                }
                break;
            case 26:
            ...
            case 27:
                ...
                AndroidUtilities.adjustSaturationColorMatrix(colorMatrix3, org.telegram.ui.ActionBar.i6.I.q() ? 0.05f : 0.25f);
                AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix3, org.telegram.ui.ActionBar.i6.I.q() ? -0.02f : -0.04f);
            ...
            default:
                ...
                ArrayList arrayList5 = rj0Var.f0;
                arrayList5.clear();
                if (list != null) {
                    for (TLRPC.User user2 : list) {
                        if (user2 != null && !hashSet.contains(Long.valueOf(user2.id)) && rj0Var.R(user2)) {
                            arrayList5.add(user2);
                            hashSet.add(Long.valueOf(user2.id));
                        }
                    }
                }
                Boolean bool2 = rj0Var.r0;
                if (bool2 == null || !bool2.booleanValue()) {
                    rj0Var.U(true, true);
                    break;
                } else {
                    mj0 mj0Var = new mj0(i14, rj0Var, hashSet);
                    MessagesController messagesController2 = MessagesController.getInstance(UserConfig.selectedAccount);
                    ConnectionsManager connectionsManager = ConnectionsManager.getInstance(UserConfig.selectedAccount);
                    if (str2 == null || str2.isEmpty()) {
                        AndroidUtilities.runOnUIThread(new rg.w1(mj0Var, 5));
                    } else {
                        TLRPC.TL_contacts_search tL_contacts_search = new TLRPC.TL_contacts_search();
                        tL_contacts_search.q = str2;
                        tL_contacts_search.limit = 50;
                        i14 = connectionsManager.sendRequest(tL_contacts_search, new cj1(i12, messagesController2, mj0Var));
                    }
                    rj0Var.m0 = i14;
                    break;
                }
    ...
    public /* synthetic */ nf(org.telegram.ui.Components.vi viVar, bo boVar) {
        this.a = 11;
        this.c = viVar;
        this.b = boVar;
    }
