...
public final class fi1 implements th0 {
    ...
    public final org.telegram.ui.Components.tl0 b;
    ...
    public final void a(final Canvas canvas) {
        ...
        if (i10 != i11) {
            ...
            y10 = (tl0Var.getY() + (t1Var.getY() + t1Var.getRadialProgress().a.centerY())) - liVar.getY();
            x10 = (tl0Var.getX() + (t1Var.getX() + t1Var.getRadialProgress().a.centerX())) - liVar.getX();
        }
        this.k = x10;
        this.l = y10;
        ...
        final float f24 = f10;
        t1Var.q2(canvas, interpolation, new Runnable() { // from class: org.telegram.ui.di1
            ...
            public final void run() {
                ...
                Drawable drawable;
                fi1 fi1Var = fi1.this;
                RadialProgress2 radialProgress = fi1Var.a.getRadialProgress();
                ...
                ChatActivityEnterView.RecordCircle recordCircle2 = fi1Var.g;
