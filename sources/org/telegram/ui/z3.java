...
public final class z3 implements org.telegram.ui.ActionBar.j2, org.telegram.ui.ActionBar.s3 {
    ...
    @Override // org.telegram.ui.ActionBar.j2, android.content.DialogInterface
    ...
    public final void f() {
        ...
        this.y.addListener(new lh.h9(this, 6));
        this.y.setInterpolator(org.telegram.ui.Components.er.h);
    ...
    */
    public final org.telegram.ui.Components.mc getBulletinFactory() {
        ...
        if (m4Var.q0[0].f()) {
            if (m4Var.q0[0].getWebView() != null) {
                ...
                return new org.telegram.ui.Components.mc(frameLayout, null);
            }
            return null;
        }
        q3 q3Var = m4Var.q0[0];
    ...
    public final int getNavigationBarColor(int i10) {
        ...
        o0 o0Var = this.G.d0;
        if (o0Var != null) {
            j10 = i0.b.d(o0Var.T, j10, o0Var.x);
        }
        return i0.b.d(min, i10, j10);
    }
    ...
    public final void i() {
        org.telegram.ui.ActionBar.h3 h3Var = this.e;
        y3 y3Var = this.c;
        AndroidUtilities.setLightStatusBar(h3Var != null ? h3Var.b : y3Var, isAttachedLightStatusBar());
        ...
        int navigationBarColor = h3Var2.a.getNavigationBarColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.a7, false));
    ...
    public final boolean isAttachedLightStatusBar() {
        ...
        if (this.B && min > 0.25f) {
            if (SharedConfig.adaptableColorInBrowser) {
                m4 m4Var = this.G;
                d = i0.b.d(1.0f - (m4Var.q0[0].getVisibility() == 0 ? 1.0f - (m4Var.q0[0].getTranslationX() / m4Var.q0[0].getWidth()) : 0.0f), m4Var.q0[0].getActionBarColor(), m4Var.q0[1].getActionBarColor());
            } else {
    ...
    public final int j() {
        ...
        m4 m4Var = this.G;
        return i0.b.d(1.0f - (m4Var.q0[0].getVisibility() != 0 ? 0.0f : 1.0f - (m4Var.q0[0].getTranslationX() / m4Var.q0[0].getWidth())), m4Var.q0[0].getBackgroundColor(), m4Var.q0[1].getBackgroundColor());
    }

    public final int k() {
        int dp = AndroidUtilities.dp(16.0f);
        View view = this.d;
        return org.telegram.messenger.y1.A(20.0f, l(), dp + (view == null ? AndroidUtilities.displaySize.y : view.getHeight()));
    }
    ...
    public final int l() {
        ...
        return i10 + ((int) (m4Var.q0[1].getAlpha() * m4Var.q0[1].getListTop() * f10));
    }
