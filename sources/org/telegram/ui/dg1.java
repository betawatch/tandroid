...
public class dg1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.bh, eh0 {
    ...
    public org.telegram.ui.Components.w81 a1;
    ...
    public int e1;
    public org.telegram.ui.Components.eo f;
    public org.telegram.ui.ActionBar.v0 f0;
    public final ah.i f1;
    ...
    public dg1(Bundle bundle) {
        ...
        this.V0 = true ^ org.telegram.messenger.q.x("topics_end_reached_", j3, getUserConfig().getPreferences(), false);
        fh.c cVar = new fh.c();
        ...
        if (Build.VERSION.SDK_INT < 31) {
            ...
            this.g1 = null;
            this.h1 = null;
            this.i1 = new ah.c(cVar);
            return;
        }
        this.f1 = new ah.i(false);
        this.g1 = new fh.d(null);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0042, code lost:
        ...
        if (((org.telegram.ui.dg1) r0).a == (-r6.a())) goto L13;
     */
    /*
    ...
    */
    public static void I0(zn znVar) {
        ...
        if (znVar.getParentLayout().getFragmentStack().size() > 1) {
            org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) znVar.getParentLayout().getFragmentStack().get(znVar.getParentLayout().getFragmentStack().size() - 2);
            if (n2Var instanceof dg1) {
            }
        }
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", -znVar.a());
        ((ActionBarLayout) znVar.getParentLayout()).c(znVar.getParentLayout().getFragmentStack().size() - 1, new dg1(bundle));
        znVar.ja = true;
    ...
    public static boolean U(dg1 dg1Var, TLRPC.TL_error tL_error) {
        ...
        MessagesController.getNotificationsSettings(dg1Var.currentAccount).edit().putLong("dialog_join_requested_time_" + (-dg1Var.a), System.currentTimeMillis()).commit();
        ...
        int i10 = org.telegram.ui.Components.p80.r;
        org.telegram.ui.Components.p80.w(parentActivity, dg1Var, org.telegram.ui.Components.xc.a0(dg1Var), isChannelAndNotMegaGroup);
        dg1Var.O0(true);
        return false;
    }
    ...
    public static void V(dg1 dg1Var, View view) {
        ...
        long j10 = -j3;
        long peerDialogId = tL_forumTopic == null ? 0L : dg1Var.getMessagesController().isMonoForum(j10) ? DialogObject.getPeerDialogId(tL_forumTopic.from_id) : tL_forumTopic.id;
        if (dg1Var.t0) {
            eg1 eg1Var = dg1Var.v;
            if (eg1Var != null) {
                gg1 gg1Var = eg1Var.a;
                Bundle bundle = new Bundle();
                jg1 jg1Var = gg1Var.a;
                bundle.putLong("dialog_id", jg1Var.c);
                bundle.putLong("topic_id", tL_forumTopic.id);
                bundle.putBoolean("exception", true);
                w11 w11Var = new w11(bundle, null);
                w11Var.r = new rv0(17, gg1Var, tL_forumTopic);
                jg1Var.presentFragment(w11Var);
            }
            uy uyVar = dg1Var.L0;
            if (uyVar != null) {
                uyVar.O3(j10, peerDialogId, true, dg1Var);
                return;
            }
            return;
        }
        ...
        if (dg1Var.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            dg1Var.Q0 = peerDialogId;
            dg1Var.U0(false, false);
        }
        ng.d.m(dg1Var, j3, tL_forumTopic, 0);
    }

    public static /* synthetic */ boolean W(dg1 dg1Var, View view, float f7) {
        if (dg1Var.t0 || dg1Var.getParentLayout() == null || ((ActionBarLayout) dg1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(dg1 dg1Var) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            if (i10 == 0) {
                ...
                viewGroup = zf1Var != null ? zf1Var.V : null;
            }
            if (viewGroup != null) {
        ...
        if (kVar != null) {
            kVar.E(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.G8), true);
            dg1Var.actionBar.F(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.E8), false, true);
            dg1Var.actionBar.F(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.F8), true, true);
            dg1Var.actionBar.G(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.I5), true);
        }
        s50 s50Var = dg1Var.P0;
        if (s50Var != null && Build.VERSION.SDK_INT >= 23) {
            s50Var.setForeground(new ColorDrawable(i0.a.k(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6), 100)));
        }
        dg1Var.P0();
    }
    ...
    public static void b0(dg1 dg1Var, boolean z10) {
        ...
        int i10 = 0;
        if (dg1Var.a1 == null) {
            org.telegram.ui.Components.w81 n10 = dg1Var.r0.n(8, false);
            dg1Var.a1 = n10;
            if (dg1Var.M0 != null) {
                n10.setBackgroundColor(dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
            }
            dg1Var.e.addView(dg1Var.a1, w7.y5.c(44.0f, -1));
        }
        dg1Var.Y0 = ValueAnimator.ofFloat(dg1Var.W, z10 ? 1.0f : 0.0f);
        AndroidUtilities.updateViewVisibilityAnimated(dg1Var.r0, false, 1.0f, true);
        uy uyVar = dg1Var.M0;
        if (uyVar != null && (oxVar = uyVar.F3) != null) {
            oxVar.M = !z10;
        }
        dg1Var.Z0 = !z10 && dg1Var.r0.getVisibility() == 0 && dg1Var.r0.getAlpha() == 1.0f;
        dg1Var.Y0.addUpdateListener(new i21(dg1Var, 16));
        dg1Var.r0.setVisibility(0);
        if (z10) {
            AndroidUtilities.requestAdjustResize(dg1Var.getParentActivity(), dg1Var.classGuid);
            dg1Var.Q0(false);
        } else {
            dg1Var.q0.setVisibility(0);
        }
        dg1Var.Y0.addListener(new mf1(dg1Var, z10, i10));
        dg1Var.Y0.setDuration(200L);
        dg1Var.Y0.setInterpolator(org.telegram.ui.Components.qr.f);
        dg1Var.Y0.start();
    ...
    public final void A0() {
        ...
        if (this.D0 != null) {
            ...
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((uf1) arrayList.get(0)).c != null && ((uf1) arrayList.get(0)).c.id == 1)) {
    ...
    public final void B0() {
        ...
        if (uyVar != null) {
            ...
            float c10 = (ksVar != null ? ksVar.c(dp) : 0.0f) + 0.0f;
            ...
            if (ksVar2 != null) {
                ...
                ksVar2.setTranslationY(c10 - ((ksVar3 != null ? ksVar3.getMetadata().c.a : 0.0f) * dp2));
                org.telegram.ui.Components.ks ksVar4 = this.U0;
                int dp3 = AndroidUtilities.dp(14.0f);
                int dp4 = AndroidUtilities.dp(7.0f);
                r2 = ksVar4.c(AndroidUtilities.lerp(dp3, dp4, this.M0.J1 != null ? r5.getMetadata().c.a : 0.0f)) + c10;
            } else {
                r2 = c10;
            }
        } else {
            org.telegram.ui.Components.ks ksVar5 = this.U0;
            if (ksVar5 != null) {
                r2 = 0.0f + ksVar5.c(AndroidUtilities.dp(14.0f));
            }
        }
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new wk0(9));
        b2Var.show();
    ...
    @Override // org.telegram.ui.Components.bh
    ...
    public final void M0(org.telegram.ui.Cells.s2 s2Var) {
        ...
        int b10 = r32[0].b(poVar.f);
        poVar.o = 1;
        long j3 = this.a;
        long j10 = -j3;
        poVar.d(j10, tL_forumTopic.id, null);
        if (ChatObject.canManageTopics(g())) {
            ...
            f1Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.df1
                ...
                public final void onClick(View view) {
                    switch (i10) {
                        case 0:
                            ...
                            dg1Var.C0 = true;
                            dg1Var.N0 = true;
                            dg1Var.s.pinTopic(dg1Var.a, tL_forumTopic.id, !r0.pinned, dg1Var);
                            dg1Var.finishPreviewFragment();
                            break;
                        case 1:
                            dg1 dg1Var2 = this.b;
                            dg1Var2.N0 = true;
                            TopicsController topicsController = dg1Var2.s;
                            long j11 = dg1Var2.a;
        ...
        if (ChatObject.canManageTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            f1Var3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.df1
                public final /* synthetic */ dg1 b;
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            final int i12 = 2;
            f1Var4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.df1
                public final /* synthetic */ dg1 b;
        ...
        zn znVar = new zn(t8.b.f(j3, "chat_id"));
        ng.d.a(znVar, MessagesStorage.TopicKey.of(j10, isMonoForum ? DialogObject.getPeerDialogId(s2Var.N.from_id) : s2Var.N.id));
    ...
    public final void N0(View view) {
        ...
        ag1Var.V(hashSet.contains(Integer.valueOf(i10)), true);
        ...
        if (!this.actionBar.a(null)) {
            ...
            j10.addView(this.c0, w7.y5.m(1.0f, 0, -1, 72, 0, 0));
            this.c0.setOnTouchListener(new ef1(0));
    ...
    */
    public final void O0(boolean z10) {
        ...
        boolean x10 = org.telegram.messenger.q.x("dialog_bar_report", j11, notificationsSettings, false);
        boolean x11 = org.telegram.messenger.q.x("dialog_bar_block", j11, notificationsSettings, false);
        boolean z15 = this.t0;
        if (z15) {
            j3 = 0;
            if (this.w0) {
            ...
            org.telegram.ui.Components.eo eoVar = this.f;
            if (eoVar != null && eoVar.getLayoutParams() != null) {
        ...
        if (chat != null && ChatObject.isNotInChat(chat) && j12 > j3 && System.currentTimeMillis() - j12 < 120000) {
            ...
            if (!z14 || (!x11 && !x10)) {
                ...
                if (this.V != z11) {
                    ...
                    if (z16) {
                        this.o0.animate().translationY(z11 ? 0.0f : AndroidUtilities.dp(53.0f)).setListener(new mf1(this, z11, 1));
                    } else {
    ...
    public final void P0() {
        ...
        r41Var.setBackgroundColor(getThemedColor(i10));
    ...
    public final void S0(float f7) {
        ...
        this.actionBar.A(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.t8), getThemedColor(org.telegram.ui.ActionBar.j6.z8)), false);
        if (!this.inPreviewMode) {
        ...
        org.telegram.ui.Components.w81 w81Var = this.a1;
        if (w81Var != null) {
            w81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
            this.a1.setAlpha(f7);
        }
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        if (topics != null) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (uf1Var != null && (tL_forumTopic = uf1Var.c) != null && tL_forumTopic.hidden) {
                    this.x++;
                }
            }
            of1 of1Var = this.N;
            if (of1Var != null) {
                if (of1Var.getItemAnimator() != (z10 ? this.I0 : null)) {
    ...
    @Override // org.telegram.ui.Components.bh, org.telegram.ui.Components.n50
    public final long a() {
        return -this.a;
    }
    ...
    public final View createView(Context context) {
        ...
        kf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.d6));
        ...
        final int i12 = 2;
        this.actionBar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.af1
            public final /* synthetic */ dg1 b;
            ...
            public final void onClick(View view) {
                ...
                switch (i12) {
                    case 0:
                        dg1 dg1Var = this.b;
                        dg1Var.presentFragment(ze1.a0(dg1Var.a, 0L));
                        break;
                    case 1:
                        dg1 dg1Var2 = this.b;
                        dg1Var2.getMessagesController().hidePeerSettingsBar(-dg1Var2.a, null, dg1Var2.g());
                        dg1Var2.O0(false);
                        break;
                    case 2:
                        dg1 dg1Var3 = this.b;
        ...
        if (this.M0 != null) {
            ...
            this.p0 = a2;
            a2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.af1
                public final /* synthetic */ dg1 b;
        ...
        this.T = v0Var.d(14, 0, new org.telegram.ui.Components.ij0(R.raw.boosts, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f)), LocaleController.getString(R.string.BoostingBoostGroupMenu), true, false, v0Var.m0);
        int i14 = 3;
        ...
        org.telegram.ui.Components.eo eoVar2 = this.f;
        long j3 = -this.a;
        eoVar2.b = j3 < 0;
        eoVar2.setClipChildren(false);
        this.actionBar.addView(this.f, 0, w7.y5.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.t0) {
            this.f.getAvatarImageView().setOnClickListener(new z7(this, i14));
        }
        ...
        this.j1 = new ah.o(of1Var, viewGroup, new w8(of1Var2, i12));
        this.N.D0(new bf1(this, 5));
        ...
        this.N.setOnScrollListener(new gf1(this, i11));
        of1 of1Var4 = this.N;
        of1Var4.Y1 = true;
        of1Var4.Z1 = 0;
        org.telegram.ui.Components.bl0 bl0Var = new org.telegram.ui.Components.bl0(of1Var4, true);
        this.K0 = bl0Var;
        ...
        this.N.setOnScrollListener(new gf1(this, i12));
        of1 of1Var5 = this.N;
        ...
        this.h.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.af1
            public final /* synthetic */ dg1 b;
        ...
        tf1Var.addView(textView, w7.y5.d(-2, -2.0f, 81, z10 ? 72.0f : 32.0f, 0.0f, z10 ? 32.0f : 72.0f, 32.0f));
        this.n = tf1Var;
        ...
        this.o0.addView(this.n0, w7.y5.e(30, 30, 17));
        ...
        this.o0.addView(this.W0, w7.y5.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        this.W0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.af1
            public final /* synthetic */ dg1 b;
        ...
        this.e = j0Var;
        if (this.M0 == null) {
            this.d.addView(j0Var, w7.y5.e(-1, -1, 119));
        }
        zf1 zf1Var = new zf1(this, context);
        this.r0 = zf1Var;
        zf1Var.setVisibility(8);
        this.e.addView(this.r0, w7.y5.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        zf1 zf1Var2 = this.r0;
        int i17 = org.telegram.ui.ActionBar.j6.d6;
        zf1Var2.setBackgroundColor(getThemedColor(i17));
        ...
        this.U0.setOnAnimatedHeightChangedListener(new bf1(this, i10));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            s50Var.setForeground(new ColorDrawable(i0.a.k(getThemedColor(i17), 100)));
        }
        this.P0.setFocusable(false);
        this.P0.setImportantForAccessibility(2);
        final int i18 = 3;
        this.P0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.af1
            public final /* synthetic */ dg1 b;
        ...
        if (ChatObject.isBoostSupported(g())) {
            getMessagesController().getBoostsController().getBoostsStats(j3, new yb(this, 5));
        }
        View view = this.fragmentView;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        zf1 zf1Var = this.r0;
        if (zf1Var != null && (wl0Var = zf1Var.V) != null) {
    ...
    public final void x0() {
        ah.i iVar;
        if (Build.VERSION.SDK_INT < 31 || (iVar = this.f1) == null) {
            return;
        }
        ...
        iVar.g(this.M0 != null ? 2 : 1, this.k1);
        iVar.e(this.j1, view.getMeasuredWidth(), view.getMeasuredHeight());
    }

    @Override // org.telegram.ui.Components.bh
    public final org.telegram.ui.Components.bw0 y() {
        return this.d;
    }
    ...
    public final void z0(boolean z10) {
        ...
        if (this.H0 != null && ((str = this.y0) != null || this.z0)) {
            ...
            org.telegram.messenger.q.q(R.string.LinkHashExpired, org.telegram.ui.Components.xc.a0(this), R.raw.linkbroken, 36);
            this.y0 = null;
        }
    }
