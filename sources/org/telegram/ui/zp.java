...
public final class zp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean b0;
    public int c;
    public final org.telegram.ui.Components.vq c0;
    public float d;
    public final int[] d0;
    ...
    public org.telegram.ui.Components.o5 k0;
    ...
    public zp(int i10, View view, long j3, int i11, int i12, long j10, org.telegram.ui.ActionBar.e6 e6Var) {
    ...
    public final void a(Canvas canvas, uj ujVar, float f7, float f10) {
        ...
        if (this.a0 != ujVar) {
            this.a0 = ujVar;
            org.telegram.ui.Components.o5 o5Var = this.k0;
            if (o5Var != null) {
                o5Var.a(ujVar);
            }
        }
        ...
        org.telegram.ui.ActionBar.i6.q(0.0f, ujVar.getMeasuredHeight() - dp, this.c, ujVar.getMeasuredHeight());
        int i16 = org.telegram.ui.ActionBar.i6.ic;
        ...
        int v03 = org.telegram.ui.ActionBar.i6.v0(i16, e6Var);
        Paint paint2 = this.e;
        paint2.setColor(v03);
        this.h.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Vd, e6Var));
        ...
        org.telegram.ui.ActionBar.i6.h2.setAlpha((int) (alpha2 * f21));
        ...
        if (f26 < 1.0f || this.R) {
            ...
            if (this.W) {
                ...
                if (e6Var != null ? e6Var.p0() : org.telegram.ui.ActionBar.i6.a1()) {
                    ...
                    org.telegram.ui.ActionBar.i6.h2.setAlpha((int) (alpha6 * f12));
                    float f39 = this.d;
                    canvas2.drawRoundRect(rectF4, f39, f39, org.telegram.ui.ActionBar.i6.h2);
            ...
            canvas2.restore();
            if (this.R) {
                float a2 = org.telegram.ui.Cells.q3.a(f13 - AndroidUtilities.dp(2.0f), this.K, (1.0f - this.K) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f7)) - f14), f17);
        ...
        if (this.s == null || this.K <= 0.0f) {
            ...
            if (e6Var != null ? e6Var.p0() : org.telegram.ui.ActionBar.i6.a1()) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.i6.h2);
            }
            canvas2.save();
        ...
        if (!this.R && f14 > 0.0f) {
            float a10 = org.telegram.ui.Cells.q3.a((-f18) + AndroidUtilities.dp(4.0f), this.K, (1.0f - this.K) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f7)) - f14), f17);
            org.telegram.ui.Components.o5 o5Var2 = this.k0;
            if (o5Var2 == null || (imageReceiver = o5Var2.k) == null) {
            ...
            if (this.X && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.pq) && (((org.telegram.ui.Components.pq) imageReceiver2.getDrawable()).b instanceof org.telegram.ui.Components.l80)) {
                ((org.telegram.ui.Components.l80) ((org.telegram.ui.Components.pq) imageReceiver2.getDrawable()).b).i = f7;
            }
            if (this.K <= 0.0f || !this.b0) {
                ...
                vqVar3.e(vqVar3.s);
                canvas2.scale(f53, f53, (vqVar3.s / 2.0f) + vqVar3.A + AndroidUtilities.dp(12.0f) + f16, (a10 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                ...
                if (f55 != 1.0f) {
                    ...
                    if (i20 == 0 || i20 == 1) {
                        ...
                        f20 = 14.0f;
                        vqVar3.e(vqVar3.s);
                        float dp14 = (vqVar3.x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                        float f56 = vqVar3.B;
                        rectF2.set(f56, dp14, vqVar3.s + f56 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f57 = f55 * 2.0f;
                        if (f57 > 1.0f) {
                            f57 = 1.0f;
                        }
                        float dp15 = (vqVar3.x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                        int i21 = vqVar3.s;
                        int i22 = vqVar3.r;
                        if (i21 == i22) {
                            z10 = i21;
                    ...
                    f20 = 14.0f;
                    vqVar3.e(vqVar3.s);
                    float dp16 = (vqVar3.x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                    float f59 = vqVar3.B;
                    rectF2.set(f59, dp16, vqVar3.s + f59 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                ...
                float f60 = this.K;
                vqVar3.e(vqVar3.s);
                canvas2.scale(f60, f60, (vqVar3.s / 2.0f) + vqVar3.A + AndroidUtilities.dp(12.0f) + f16, (a10 - AndroidUtilities.dp(f19)) + AndroidUtilities.dp(f20));
        ...
        org.telegram.ui.ActionBar.i6.h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Xk, this.j0);
    ...
    public final void f() {
        ...
        org.telegram.ui.Components.o5 o5Var = this.k0;
        if (o5Var != null && (view = this.a0) != null) {
            o5Var.a(view);
        }
    ...
    public final void g(final View view, boolean z10) {
        ...
        if (!z10) {
            ...
            final int i13 = 4;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.xp
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.xp
            public final /* synthetic */ zp b;
        ...
        ofFloat2.setInterpolator(org.telegram.ui.Components.qr.h);
        ofFloat2.setDuration(250L);
        this.L = 0.0f;
        ValueAnimator ofFloat3 = ValueAnimator.ofFloat(0.0f, 1.0f);
        ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.xp
            public final /* synthetic */ zp b;
        ...
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.j;
        ofFloat3.setInterpolator(qrVar);
        ofFloat3.setDuration(180L);
        ValueAnimator ofFloat4 = ValueAnimator.ofFloat(1.0f, -0.5f);
        ofFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.xp
            public final /* synthetic */ zp b;
        ...
        final int i14 = 3;
        ofFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.xp
            public final /* synthetic */ zp b;
        ...
        ofFloat5.setInterpolator(qrVar);
        ofFloat5.setDuration(100L);
        AnimatorSet animatorSet3 = new AnimatorSet();
        this.J = animatorSet3;
        animatorSet3.addListener(new ai.z(15, this, view));
    ...
    public final void j() {
        ...
        if (i12 == 1) {
            View view3 = this.a0;
            if (view3 != null && (o5Var2 = this.k0) != null) {
                o5Var2.o(view3);
            }
            this.k0 = null;
            imageReceiver.setImageBitmap(ng.d.c(this.T.getContext(), 1.0f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Ac, e6Var), true));
        } else if (tL_forumTopic.icon_emoji_id != 0) {
            org.telegram.ui.Components.o5 o5Var3 = this.k0;
            if (o5Var3 == null || o5Var3.i() != tL_forumTopic.icon_emoji_id) {
                org.telegram.ui.Components.o5 o5Var4 = this.k0;
                if (o5Var4 != null && (view = this.a0) != null) {
                    o5Var4.o(view);
                }
                org.telegram.ui.Components.o5 o5Var5 = new org.telegram.ui.Components.o5(22, i10, tL_forumTopic.icon_emoji_id);
                this.k0 = o5Var5;
                o5Var5.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.ic, e6Var), PorterDuff.Mode.SRC_IN));
            }
            org.telegram.ui.Components.o5 o5Var6 = this.k0;
            if (o5Var6 != null && (view2 = this.a0) != null) {
                o5Var6.a(view2);
            }
            imageReceiver.setImageBitmap((Bitmap) null);
        } else {
            View view4 = this.a0;
            if (view4 != null && (o5Var = this.k0) != null) {
                o5Var.o(view4);
            }
            this.k0 = null;
