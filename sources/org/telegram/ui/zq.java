...
public final /* synthetic */ class zq implements Utilities.Callback {
    ...
    public /* synthetic */ zq(int i10, long j3, Activity activity, ArrayList arrayList, HashMap hashMap, Utilities.Callback callback, org.telegram.ui.ActionBar.e6 e6Var) {
        this.b = i10;
        this.d = arrayList;
        this.c = j3;
        this.e = activity;
            ...
            default:
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.l1
                    ...
                    public final void run() {
                        ...
                        new yh.m7(activity2, e6Var, j13, 13, DialogObject.getShortName(i12, longValue2), new a2(callback2, hashMap2, 0), longValue2).show();
                    }
                };
