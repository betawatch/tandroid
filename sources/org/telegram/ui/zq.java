        ...
        while (true) {
            ...
            if (tLObject instanceof TLRPC.ChannelParticipant) {
                if (MessageObject.getPeerId(((TLRPC.ChannelParticipant) tLObject).peer) == j10) {
                    ...
                    tL_channelParticipantAdmin.inviter_id = rrVar.getUserConfig().getClientUserId();
                    if (j10 > 0) {
                ...
                int indexOf = rrVar.s.participants.participants.indexOf(chatParticipant);
                if (indexOf >= 0) {
                    rrVar.s.participants.participants.set(indexOf, tL_chatParticipantAdmin);
                }
                rrVar.r0();
            }
            i12++;
