...
public final class ue0 extends org.telegram.ui.Components.fw0 {
    ...
    */
    public ue0(qg0 qg0Var, Context context) {
        super(context);
        int i10;
        this.y = qg0Var;
        this.x = new se0(this, 1);
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                xd0 xd0Var = new xd0(this, context, 1);
                this.a = xd0Var;
                xd0Var.b(6, 1);
                for (as asVar : xd0Var.f) {
                    asVar.setShowSoftInputOnFocusCompat(AndroidUtilities.isAccessibilityTouchExplorationEnabled());
                    asVar.addTextChangedListener(new m0(this, 8));
                    asVar.setOnFocusChangeListener(new od(this, 6));
                }
                ...
                nVar.setMaxLines(2);
                nVar.setOnClickListener(new f60(this, 6));
                FrameLayout frameLayout2 = new FrameLayout(context);
                frameLayout2.addView(nVar, w7.y5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        ...
        xd0 xd0Var2 = new xd0(this, context, 1);
        this.a = xd0Var2;
        xd0Var2.b(6, 1);
        while (r12 < r11) {
        }
        ...
        nVar2.setMaxLines(2);
        nVar2.setOnClickListener(new f60(this, 6));
        FrameLayout frameLayout22 = new FrameLayout(context);
        frameLayout22.addView(nVar2, w7.y5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
    ...
    @Override // org.telegram.ui.Components.fw0
    public final void j() {
        AndroidUtilities.runOnUIThread(new se0(this, 0), qg0.t0);
    }
