...
public final class se0 extends org.telegram.ui.Components.vv0 {
    ...
    */
    public se0(ng0 ng0Var, Context context) {
        super(context);
        int i10;
        this.y = ng0Var;
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                addView(textView2, k7.b6.t(-2, -2, 1, 12, 8, 12, 0));
                vd0 vd0Var = new vd0(this, context, 1);
                this.a = vd0Var;
                vd0Var.b(6, 1);
                for (bs bsVar : vd0Var.f) {
                    bsVar.setShowSoftInputOnFocusCompat(AndroidUtilities.isAccessibilityTouchExplorationEnabled());
                    bsVar.addTextChangedListener(new n0(this, 8));
                    bsVar.setOnFocusChangeListener(new qd(this, 6));
                }
                addView(this.a, k7.b6.t(-2, 42, 1, 0, 32, 0, 0));
                ...
                sVar.setMaxLines(2);
                sVar.setOnClickListener(new e60(this, 6));
                FrameLayout frameLayout2 = new FrameLayout(context);
                frameLayout2.addView(sVar, k7.b6.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        ...
        addView(textView22, k7.b6.t(-2, -2, 1, 12, 8, 12, 0));
        vd0 vd0Var2 = new vd0(this, context, 1);
        this.a = vd0Var2;
        vd0Var2.b(6, 1);
        while (r12 < r11) {
        }
        ...
        sVar2.setMaxLines(2);
        sVar2.setOnClickListener(new e60(this, 6));
        FrameLayout frameLayout22 = new FrameLayout(context);
        frameLayout22.addView(sVar2, k7.b6.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        addView(frameLayout22, k7.b6.l(1.0f, -1, 0));
        n7.qa.N0(sVar2);
    }
    ...
    @Override // org.telegram.ui.Components.vv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new qe0(this, 0), ng0.q0);
    }
