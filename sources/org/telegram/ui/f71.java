...
public abstract class f71 extends Dialog {
    ...
    public f71(j71 j71Var, Context context, Runnable runnable, View view, s61 s61Var, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        j0 j0Var = new j0(y51Var, context, 22);
        this.s = j0Var;
        setContentView(j0Var, new ViewGroup.LayoutParams(-1, -1));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        linearLayout.addView(new s50(y51Var, context, 9), w7.y5.t(160, 160, 17, 0, 0, 0, 16));
        ...
        org.telegram.ui.ActionBar.v0.c(false, true, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntilOther), false, f6Var).setOnClickListener(new vy0(2, y51Var, context));
        ...
        if (window != null) {
            ...
            z10 = true;
            j0Var.setOnApplyWindowInsetsListener(new y41(y51Var, 1 == true ? 1 : 0));
        ...
        if (document != null) {
            ...
            if ((s61Var.E instanceof org.telegram.ui.Components.p5) && (MessageObject.isTextColorEmoji(document2) || ((org.telegram.ui.Components.p5) s61Var.E).c())) {
                if (!MessageObject.isTextColorEmoji(document2)) {
                    org.telegram.ui.Components.p5 p5Var = (org.telegram.ui.Components.p5) s61Var.E;
