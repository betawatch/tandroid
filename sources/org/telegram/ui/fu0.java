...
public abstract class fu0 {
    public final View i;
    public boolean p;
    public final org.telegram.ui.Components.nq q;
    public final org.telegram.ui.Components.mg0 r;
    ...
    public fu0(PhotoViewer photoViewer, View view) {
        ...
        while (true) {
            ...
            if (i10 >= fArr.length) {
                ...
                this.r = mg0Var;
                mg0Var.h = 200;
                this.q = new org.telegram.ui.Components.nq(photoViewer.y.getDrawable(R.drawable.circle_big).mutate(), mg0Var);
                return;
            }
            this.m[i10] = 1.0f;
            fArr[i10] = 1.0f;
    ...
    public final void a() {
        ...
        if (z4 != this.p) {
            this.p = z4;
            bs0 bs0Var = (bs0) this;
            PhotoViewer photoViewer = bs0Var.t;
    ...
    public final void d(int i10, boolean z4, boolean z10) {
        ...
        View view = this.i;
        org.telegram.ui.Components.mg0 mg0Var = this.r;
        if (mg0Var != null) {
