...
public class StickersActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void U(StickersActivity stickersActivity, org.telegram.ui.Components.i51 i51Var, View view) {
        ...
        if (obj instanceof TLRPC.TL_messages_stickerSet) {
            ...
            stickersActivity.showDialog(new org.telegram.ui.Components.lv(stickersActivity, stickersActivity.getParentActivity(), stickersActivity.getResourceProvider(), arrayList2));
        }
        if (obj instanceof TLRPC.StickerSetCovered) {
            ...
            stickersActivity.showDialog(new org.telegram.ui.Components.lv(stickersActivity, stickersActivity.getParentActivity(), stickersActivity.getResourceProvider(), arrayList3));
            return;
        }
        switch (i51Var.d) {
            case 1:
            ...
            case 3:
                ...
                break;
            case 4:
                stickersActivity.presentFragment(new b31());
                break;
            case 5:
                org.telegram.ui.Components.p70 H = org.telegram.ui.Components.p70.H(stickersActivity, view);
                H.i(new dh(4, view), LocaleController.getString(R.string.SuggestStickersAll), SharedConfig.suggestStickers == 0);
                H.i(new dh(5, view), LocaleController.getString(R.string.SuggestStickersInstalled), SharedConfig.suggestStickers == 1);
                H.i(new dh(6, view), LocaleController.getString(R.string.SuggestStickersNone), SharedConfig.suggestStickers == 2);
                H.Z();
                break;
            case 6:
                SharedConfig.toggleBigEmoji();
                ((org.telegram.ui.Cells.r8) view).setChecked(SharedConfig.allowBigEmoji);
                break;
            case 7:
                SharedConfig.toggleUpdateStickersOrderOnSend();
                ((org.telegram.ui.Cells.r8) view).setChecked(SharedConfig.updateStickersOrderOnSend);
                break;
            case 9:
                SharedConfig.toggleSuggestAnimatedEmoji();
                ((org.telegram.ui.Cells.r8) view).setChecked(SharedConfig.suggestAnimatedEmoji);
                break;
        }
    }

    public static void V(StickersActivity stickersActivity, ArrayList arrayList) {
        pa1 pa1Var = stickersActivity.y;
        ArrayList arrayList2 = new ArrayList();
        ...
        AndroidUtilities.cancelRunOnUIThread(pa1Var);
        AndroidUtilities.runOnUIThread(pa1Var, 1000L);
    }
    ...
    public static void X(StickersActivity stickersActivity, View view) {
        ...
        TLRPC.StickerSetCovered stickerSet = n3Var.getStickerSet();
    ...
    public static void Z(StickersActivity stickersActivity, View view) {
        ...
        if (!(viewGroup.getParent() instanceof org.telegram.ui.Cells.j8) || (stickersSet = (j8Var = (org.telegram.ui.Cells.j8) viewGroup.getParent()).getStickersSet()) == null || stickersSet.set == null) {
            return;
        }
        int i10 = 0;
        if (j8Var.y != view) {
    ...
    public static void b0(StickersActivity stickersActivity, View view) {
        if (view instanceof org.telegram.ui.Cells.z9) {
            ...
            if (doubleTapReaction != null) {
                if (doubleTapReaction.startsWith("animated_")) {
                    try {
                        ...
                        n10.a(z9Var.getValueBackupImageView());
                        z9Var.getValueBackupImageView().setImageDrawable(n10);
                        return;
                ...
                if (tL_availableReaction != null) {
                    z9Var.getValueBackupImageView().getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.center_icon), "100_100_lastreactframe", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.j6.a7, 1.0f), "webp", tL_availableReaction, 1);
                }
            }
        }
    }
    ...
    public static void c0(final StickersActivity stickersActivity, ArrayList arrayList, org.telegram.ui.Components.w51 w51Var) {
        ...
        if (i11 == 0) {
            ...
            if (i11 == 1) {
                ai.A(R.string.ArchivedMasksInfo, arrayList);
            }
        }
        if (i11 == 0) {
            arrayList.size();
            ...
            i51Var2.k = i16;
            i51Var2.l = string2;
            i51Var2.F = new y3(stickersActivity, 19);
            ...
            arrayList.add(i19);
            ai.A(R.string.DynamicPackOrderInfo, arrayList);
        }
        if (i11 == 5) {
            ...
            arrayList.add(i20);
            ai.A(R.string.SuggestAnimatedEmojiInfo, arrayList);
        }
        if (stickersActivity.e.size() > 0) {
            w51Var.U();
            if (i11 == 5 || (!stickersActivity.f.isEmpty() && i11 == 0)) {
                ai.q(i11 == 5 ? R.string.ChooseStickerMyEmojiPacks : R.string.ChooseStickerMyStickerSets, arrayList);
            }
            w51Var.M();
            ...
            for (int size3 = arrayList4.size(); i21 < size3; size3 = size3) {
                ...
                i21++;
                TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                int i22 = org.telegram.ui.Cells.i8.a;
                org.telegram.ui.Components.i51 J = org.telegram.ui.Components.i51.J(org.telegram.ui.Cells.i8.class);
                J.G = tL_messages_stickerSet;
                J.D = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.qa1
                    ...
                    public final void onClick(View view) {
                        switch (i12) {
                            case 0:
                                if (view != null && (view.getParent() instanceof org.telegram.ui.Cells.j8)) {
                                    org.telegram.ui.Cells.j8 j8Var = (org.telegram.ui.Cells.j8) view.getParent();
                                    final TLRPC.TL_messages_stickerSet stickersSet = j8Var.getStickersSet();
                                    final StickersActivity stickersActivity2 = this.b;
                                    org.telegram.ui.Components.p70 H = org.telegram.ui.Components.p70.H(stickersActivity2, j8Var);
                                    final int i23 = 0;
                                    H.c(R.drawable.msg_archive, LocaleController.getString(R.string.StickersHide), new Runnable() { // from class: org.telegram.ui.ra1
                                    ...
                                    final int i24 = 1;
                                    H.l(R.drawable.msg_link, LocaleController.getString(R.string.StickersCopy), new Runnable() { // from class: org.telegram.ui.ra1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i24) {
                                                case 0:
                                    ...
                                    H.c(R.drawable.msg_reorder, LocaleController.getString(R.string.StickersReorder), new b11(15, stickersActivity2, j8Var), false);
                                    final int i25 = 2;
                                    H.l(R.drawable.msg_share, LocaleController.getString(R.string.StickersShare), new Runnable() { // from class: org.telegram.ui.ra1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i25) {
                                                case 0:
                                    ...
                                    final int i26 = 3;
                                    H.m(!stickersSet.set.official, R.drawable.msg_delete, LocaleController.getString(R.string.StickersRemove), true, new Runnable() { // from class: org.telegram.ui.ra1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i26) {
                                                case 0:
                ...
                J.E = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.qa1
                    public final /* synthetic */ StickersActivity b;
            ...
            if (i11 != 1 && i11 != 5) {
                ...
                ai.A(R.string.MasksInfo, arrayList);
            }
        } else {
            charSequence = null;
        }
        ...
        if (i11 == 5 && !stickersActivity.f.isEmpty()) {
            ...
            ai.q(i11 == 5 ? R.string.FeaturedEmojiPacks : R.string.FeaturedStickers, arrayList);
            ...
            while (i12 < size4) {
                ...
                int i23 = org.telegram.ui.Cells.m3.a;
                org.telegram.ui.Components.i51 J2 = org.telegram.ui.Components.i51.J(org.telegram.ui.Cells.m3.class);
                J2.G = stickerSetCovered;
                J2.D = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.qa1
                    public final /* synthetic */ StickersActivity b;
    ...
    public static void d0(StickersActivity stickersActivity, int i10) {
        ...
        if (i10 == 2) {
            ...
            N0.p0 = new vv0(stickersActivity, i12);
            N0.show();
            return;
        }
        if (i10 == 0 || i10 == 1) {
    ...
    public final View createView(Context context) {
        ...
        final int i11 = 0;
        org.telegram.ui.Components.g61 g61Var = new org.telegram.ui.Components.g61(this, new Utilities.Callback2(this) { // from class: org.telegram.ui.sa1
            public final /* synthetic */ StickersActivity b;
        ...
        this.a.setTag(7);
        final int i12 = 1;
        this.a.A1(new Utilities.Callback2(this) { // from class: org.telegram.ui.sa1
            public final /* synthetic */ StickersActivity b;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 16, new Class[]{org.telegram.ui.Cells.j8.class, org.telegram.ui.Cells.z9.class, org.telegram.ui.Cells.r8.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 0, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 0, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 0, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 196608, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"optionsButton"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Vh));
        int i13 = org.telegram.ui.ActionBar.j6.Uh;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 0, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"optionsButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 0, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"reorderButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 8192, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"checkBox"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 16384, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.k7));
    ...
    public final void i0() {
        ...
        org.telegram.ui.Components.ic.g(this, new org.telegram.ui.Components.vl0(getParentActivity(), LocaleController.getString(R.string.StickersReorderHint)), 3250).j();
    }
    ...
    public final void n0(org.telegram.ui.Cells.j8 j8Var) {
        TLRPC.TL_messages_stickerSet stickersSet = j8Var.getStickersSet();
        if (stickersSet == null) {
            return;
        }
