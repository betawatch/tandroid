...
public class StickersActivity extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.e41 d;
    ...
    public StickersActivity(int i10, ArrayList arrayList) {
        ...
        this.x = new HashSet();
        this.y = new u91(this, 0);
        this.v = i10;
        this.w = arrayList;
    }

    public static void U(StickersActivity stickersActivity, org.telegram.ui.Components.w41 w41Var, View view) {
        ...
        if (obj instanceof TLRPC.TL_messages_stickerSet) {
            ...
            if (stickerSet == null || !stickerSet.emojis) {
                stickersActivity.showDialog(new org.telegram.ui.Components.nx0(stickersActivity.getParentActivity(), stickersActivity, null, tL_messages_stickerSet, null, null));
                return;
            }
            ...
            stickersActivity.showDialog(new org.telegram.ui.Components.jv(stickersActivity, stickersActivity.getParentActivity(), stickersActivity.getResourceProvider(), arrayList2));
        }
        if (obj instanceof TLRPC.StickerSetCovered) {
            ...
            if (i10 != 5) {
                stickersActivity.showDialog(new org.telegram.ui.Components.nx0(stickersActivity.getParentActivity(), stickersActivity, tL_inputStickerSetID2, null, null, null));
                return;
            }
            ArrayList arrayList3 = new ArrayList(1);
            arrayList3.add(tL_inputStickerSetID2);
            stickersActivity.showDialog(new org.telegram.ui.Components.jv(stickersActivity, stickersActivity.getParentActivity(), stickersActivity.getResourceProvider(), arrayList3));
            return;
        }
        switch (w41Var.d) {
            case 1:
            case 8:
                if (i10 == 5) {
                    ...
                    stickersActivity.showDialog(new org.telegram.ui.Components.jv(stickersActivity, stickersActivity.getParentActivity(), stickersActivity.getResourceProvider(), arrayList4));
                    break;
                } else {
                    org.telegram.ui.Components.e41 e41Var = new org.telegram.ui.Components.e41(stickersActivity.getParentActivity(), stickersActivity, new org.telegram.ui.Components.s41(stickersActivity.getParentActivity(), new z91(stickersActivity), new TLRPC.StickerSetCovered[10], new LongSparseArray(), new LongSparseArray(), null, null), null);
                    stickersActivity.d = e41Var;
                    e41Var.show();
                    break;
                }
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                stickersActivity.presentFragment(new i21());
                break;
            case 5:
                org.telegram.ui.Components.j70 H = org.telegram.ui.Components.j70.H(stickersActivity, view);
                H.i(new wg(4, view), LocaleController.getString(R.string.SuggestStickersAll), SharedConfig.suggestStickers == 0);
                H.i(new wg(5, view), LocaleController.getString(R.string.SuggestStickersInstalled), SharedConfig.suggestStickers == 1);
                H.i(new wg(6, view), LocaleController.getString(R.string.SuggestStickersNone), SharedConfig.suggestStickers == 2);
                H.Z();
                break;
            case 6:
                SharedConfig.toggleBigEmoji();
                ((org.telegram.ui.Cells.q8) view).setChecked(SharedConfig.allowBigEmoji);
                break;
            case 7:
                SharedConfig.toggleUpdateStickersOrderOnSend();
                ((org.telegram.ui.Cells.q8) view).setChecked(SharedConfig.updateStickersOrderOnSend);
                break;
            case 9:
                SharedConfig.toggleSuggestAnimatedEmoji();
                ((org.telegram.ui.Cells.q8) view).setChecked(SharedConfig.suggestAnimatedEmoji);
                break;
        }
    }

    public static void V(StickersActivity stickersActivity, ArrayList arrayList) {
        u91 u91Var = stickersActivity.y;
        ArrayList arrayList2 = new ArrayList();
        ...
        while (i10 < size) {
            ...
            i10++;
            Object obj2 = ((org.telegram.ui.Components.w41) obj).G;
        ...
        AndroidUtilities.cancelRunOnUIThread(u91Var);
        AndroidUtilities.runOnUIThread(u91Var, 1000L);
    }
    ...
    public static void Z(StickersActivity stickersActivity, View view) {
        ...
        if (!(viewGroup.getParent() instanceof org.telegram.ui.Cells.i8) || (stickersSet = (i8Var = (org.telegram.ui.Cells.i8) viewGroup.getParent()).getStickersSet()) == null || stickersSet.set == null) {
            return;
        }
        int i10 = 0;
        if (i8Var.y != view) {
            if (i8Var.A == view) {
                ...
                if (i8Var.B == view) {
                    stickersActivity.showDialog(new cg.p1((org.telegram.ui.ActionBar.o2) stickersActivity, 11, false));
                    return;
                }
                return;
            }
            ...
            if (doubleTapReaction != null) {
                if (doubleTapReaction.startsWith("animated_")) {
                    try {
                        ...
                        n10.a(y9Var.getValueBackupImageView());
                        y9Var.getValueBackupImageView().setImageDrawable(n10);
                        return;
                ...
                if (tL_availableReaction != null) {
                    y9Var.getValueBackupImageView().getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.center_icon), "100_100_lastreactframe", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.g6.a7, 1.0f), "webp", tL_availableReaction, 1);
                }
            }
        }
    }

    public static void c0(final StickersActivity stickersActivity, ArrayList arrayList, org.telegram.ui.Components.k51 k51Var) {
        final int i10;
        ...
        org.telegram.ui.Components.u51 u51Var = stickersActivity.a;
        if (u51Var == null || (!u51Var.Y2 && !stickersActivity.s && stickersActivity.r <= 0)) {
            if (i11 == 5) {
        ...
        if (i11 == 0) {
            ...
            arrayList.add(org.telegram.ui.Components.w41.d(1, R.drawable.msg2_trending, LocaleController.getString(R.string.FeaturedStickers), size > 0 ? LocaleController.formatNumber(size, ',') : ""));
            if (archivedStickersCount > 0) {
                stickersActivity.archivedRow = arrayList.size();
                if (i11 == 0) {
                    arrayList.add(org.telegram.ui.Components.w41.d(2, R.drawable.msg2_archived_stickers, LocaleController.getString(R.string.ArchivedStickers), LocaleController.formatNumber(archivedStickersCount, ',')));
                } else {
                    arrayList.add(org.telegram.ui.Components.w41.f(LocaleController.getString(i11 == 5 ? R.string.ArchivedEmojiPacks : R.string.ArchivedMasks), LocaleController.formatNumber(archivedStickersCount, ','), 2));
                }
            }
            arrayList.size();
            ...
            org.telegram.ui.Components.w41 w41Var = new org.telegram.ui.Components.w41(43);
            w41Var.d = 3;
            w41Var.k = i15;
            w41Var.l = string;
            w41Var.m = formatNumber;
            ...
            if (i11 == 1) {
                th.A(R.string.ArchivedMasksInfo, arrayList);
            }
        }
        if (i11 == 0) {
            arrayList.size();
            ...
            org.telegram.ui.Components.w41 w41Var2 = new org.telegram.ui.Components.w41(43);
            w41Var2.d = 4;
            w41Var2.k = i16;
            w41Var2.l = string2;
            w41Var2.F = new x3(stickersActivity, 19);
            arrayList.add(w41Var2);
            arrayList.add(org.telegram.ui.Components.w41.B(stickersActivity.h0(LocaleController.getString(i11 == 5 ? R.string.EmojiBotInfo : R.string.StickersBotInfo))));
            arrayList.add(org.telegram.ui.Components.w41.t(LocaleController.getString(R.string.StickersSettings)));
            ...
            org.telegram.ui.Components.w41 w41Var3 = new org.telegram.ui.Components.w41(43);
            w41Var3.d = 5;
            w41Var3.l = string3;
            w41Var3.m = string4;
            arrayList.add(w41Var3);
            stickersActivity.largeEmojiRow = arrayList.size();
            org.telegram.ui.Components.w41 i18 = org.telegram.ui.Components.w41.i(6, LocaleController.getString(R.string.LargeEmoji));
            i18.K(SharedConfig.allowBigEmoji);
            arrayList.add(i18);
            stickersActivity.dynamicPackOrder = arrayList.size();
            org.telegram.ui.Components.w41 i19 = org.telegram.ui.Components.w41.i(7, LocaleController.getString(R.string.DynamicPackOrder));
            i19.K(SharedConfig.updateStickersOrderOnSend);
            arrayList.add(i19);
            th.A(R.string.DynamicPackOrderInfo, arrayList);
        }
        if (i11 == 5) {
            org.telegram.ui.Components.w41 i20 = org.telegram.ui.Components.w41.i(9, LocaleController.getString(R.string.SuggestAnimatedEmoji));
            i20.K(SharedConfig.suggestAnimatedEmoji);
            arrayList.add(i20);
            th.A(R.string.SuggestAnimatedEmojiInfo, arrayList);
        }
        if (stickersActivity.e.size() > 0) {
            k51Var.U();
            if (i11 == 5 || (!stickersActivity.f.isEmpty() && i11 == 0)) {
                th.p(i11 == 5 ? R.string.ChooseStickerMyEmojiPacks : R.string.ChooseStickerMyStickerSets, arrayList);
            }
            k51Var.M();
            ...
            for (int size3 = arrayList4.size(); i21 < size3; size3 = size3) {
                ...
                i21++;
                TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                int i22 = org.telegram.ui.Cells.h8.a;
                org.telegram.ui.Components.w41 J = org.telegram.ui.Components.w41.J(org.telegram.ui.Cells.h8.class);
                J.G = tL_messages_stickerSet;
                J.D = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.v91
                    ...
                    public final void onClick(View view) {
                        switch (i12) {
                            case 0:
                                if (view != null && (view.getParent() instanceof org.telegram.ui.Cells.i8)) {
                                    org.telegram.ui.Cells.i8 i8Var = (org.telegram.ui.Cells.i8) view.getParent();
                                    final TLRPC.TL_messages_stickerSet stickersSet = i8Var.getStickersSet();
                                    final StickersActivity stickersActivity2 = this.b;
                                    org.telegram.ui.Components.j70 H = org.telegram.ui.Components.j70.H(stickersActivity2, i8Var);
                                    final int i23 = 0;
                                    H.c(R.drawable.msg_archive, LocaleController.getString(R.string.StickersHide), new Runnable() { // from class: org.telegram.ui.w91
                                            ...
                                            switch (i23) {
                                                ...
                                                case 1:
                                                    ...
                                                    try {
                                                        ...
                                                        org.telegram.ui.Components.tc.j(stickersActivity3).j();
                                                        break;
                                                    } catch (Exception e10) {
                                                        FileLog.e(e10);
                                                        return;
                                    ...
                                    final int i24 = 1;
                                    H.l(R.drawable.msg_link, LocaleController.getString(R.string.StickersCopy), new Runnable() { // from class: org.telegram.ui.w91
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i24) {
                                                case 0:
                                    ...
                                    H.c(R.drawable.msg_reorder, LocaleController.getString(R.string.StickersReorder), new t31(7, stickersActivity2, i8Var), false);
                                    final int i25 = 2;
                                    H.l(R.drawable.msg_share, LocaleController.getString(R.string.StickersShare), new Runnable() { // from class: org.telegram.ui.w91
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i25) {
                                                case 0:
                                    ...
                                    final int i26 = 3;
                                    H.m(!stickersSet.set.official, R.drawable.msg_delete, LocaleController.getString(R.string.StickersRemove), true, new Runnable() { // from class: org.telegram.ui.w91
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i26) {
                                                case 0:
                ...
                J.E = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.v91
                    public final /* synthetic */ StickersActivity b;
            ...
            if (i11 != 1 && i11 != 5) {
                ...
                th.A(R.string.MasksInfo, arrayList);
            }
        } else {
            charSequence = null;
        }
        ...
        if (i11 == 5 && !stickersActivity.f.isEmpty()) {
            if (stickersActivity.e.size() > 0) {
                arrayList.add(org.telegram.ui.Components.w41.B(charSequence));
            }
            th.p(i11 == 5 ? R.string.FeaturedEmojiPacks : R.string.FeaturedStickers, arrayList);
            ...
            while (i12 < size4) {
                ...
                int i23 = org.telegram.ui.Cells.l3.a;
                org.telegram.ui.Components.w41 J2 = org.telegram.ui.Components.w41.J(org.telegram.ui.Cells.l3.class);
                J2.G = stickerSetCovered;
                J2.D = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.v91
                    public final /* synthetic */ StickersActivity b;
            ...
            if (z10) {
                org.telegram.ui.Components.w41 c3 = org.telegram.ui.Components.w41.c(8, R.drawable.msg2_trending, LocaleController.getString(R.string.ShowMoreEmojiPacks));
                c3.q = true;
                arrayList.add(c3);
            }
        }
    ...
    public static void d0(StickersActivity stickersActivity, int i10) {
        ...
        if (i10 == 2) {
            ...
            org.telegram.ui.Components.dq0 N0 = org.telegram.ui.Components.dq0.N0(stickersActivity.fragmentView.getContext(), null, sb3, false, sb3);
            N0.o0 = new fv0(stickersActivity, i12);
            N0.show();
            return;
        }
        if (i10 == 0 || i10 == 1) {
                    ...
                    if (!stickersActivity.x.contains(Long.valueOf(tL_messages_stickerSet3.set.id))) {
                        ...
                        if (i10 == 1) {
                            ...
                            try {
                                ...
                                org.telegram.ui.Components.tc.j(stickersActivity2).j();
                            } catch (Exception e11) {
                                FileLog.e(e11);
                            }
                        } else if (i10 == 4) {
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new al0(this, 19));
        ...
        final int i11 = 0;
        org.telegram.ui.Components.u51 u51Var = new org.telegram.ui.Components.u51(this, new Utilities.Callback2(this) { // from class: org.telegram.ui.x91
            public final /* synthetic */ StickersActivity b;
            ...
            public final void run(Object obj, Object obj2) {
                switch (i11) {
                    case 0:
                        StickersActivity.c0(this.b, (ArrayList) obj, (org.telegram.ui.Components.k51) obj2);
                        break;
                    default:
        ...
        this.a.setTag(7);
        final int i12 = 1;
        this.a.B1(new Utilities.Callback2(this) { // from class: org.telegram.ui.x91
            public final /* synthetic */ StickersActivity b;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 16, new Class[]{org.telegram.ui.Cells.i8.class, org.telegram.ui.Cells.y9.class, org.telegram.ui.Cells.q8.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(lVar, 512, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.actionBar, 1048576, null, null, null, null, org.telegram.ui.ActionBar.g6.w8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 0, new Class[]{org.telegram.ui.Cells.y9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 0, new Class[]{org.telegram.ui.Cells.i8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 0, new Class[]{org.telegram.ui.Cells.i8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 196608, new Class[]{org.telegram.ui.Cells.i8.class}, new String[]{"optionsButton"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.Vh));
        int i13 = org.telegram.ui.ActionBar.g6.Uh;
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 0, new Class[]{org.telegram.ui.Cells.i8.class}, new String[]{"optionsButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 0, new Class[]{org.telegram.ui.Cells.i8.class}, new String[]{"reorderButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 8192, new Class[]{org.telegram.ui.Cells.i8.class}, new String[]{"checkBox"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 16384, new Class[]{org.telegram.ui.Cells.i8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.k7));
        org.telegram.ui.Components.e41 e41Var = this.d;
        if (e41Var != null) {
            arrayList.addAll(e41Var.getThemeDescriptions());
        }
        return arrayList;
    }
    ...
    public final CharSequence h0(String str) {
        ...
        if (indexOf != -1) {
            try {
                ...
                spannableStringBuilder.setSpan(new org.telegram.ui.Components.k4(this, 5), indexOf, indexOf + 9, 18);
    ...
    public final void i0() {
        ...
        org.telegram.ui.Components.mc.g(this, new org.telegram.ui.Components.ml0(getParentActivity(), LocaleController.getString(R.string.StickersReorderHint)), 3250).j();
    }
    ...
    public final String l0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        sb2.append("/");
        return String.format(locale, a4.w.q(sb2, tL_messages_stickerSet.set.emojis ? "addemoji" : "addstickers", "/%s"), tL_messages_stickerSet.set.short_name);
    }
    ...
    public final void m0() {
        if (this.s) {
            ...
            while (i11 < this.e.size()) {
                i11 = a4.w.g(((TLRPC.TL_messages_stickerSet) this.e.get(i11)).set.id, tL_messages_reorderStickerSets.order, i11, 1);
            }
            ...
            if (SharedConfig.updateStickersOrderOnSend) {
                SharedConfig.toggleUpdateStickersOrderOnSend();
                org.telegram.ui.Components.tc.a0(this).M(LocaleController.getString(R.string.DynamicPackOrderOff), LocaleController.getString(R.string.DynamicPackOrderOffInfo), R.raw.filter_reorder).j();
                this.a.U2.N(true);
            }
        }
    }

    public final void n0(org.telegram.ui.Cells.i8 i8Var) {
        TLRPC.TL_messages_stickerSet stickersSet = i8Var.getStickersSet();
        if (stickersSet == null) {
            return;
        }
