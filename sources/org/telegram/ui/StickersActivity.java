...
public class StickersActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
        ...
        if (view instanceof org.telegram.ui.Cells.ga) {
            ...
            if (doubleTapReaction != null) {
                ...
                if (tL_availableReaction != null) {
                    gaVar.getValueBackupImageView().getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.center_icon), "100_100_lastreactframe", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.j6.a7, 1.0f), "webp", tL_availableReaction, 1);
                }
            }
        }
    }
    ...
    public static void c0(final StickersActivity stickersActivity, ArrayList arrayList, org.telegram.ui.Components.j61 j61Var) {
        ...
        if (stickersActivity.e.size() > 0) {
            ...
            if (i11 == 5 || (!stickersActivity.f.isEmpty() && i11 == 0)) {
                com.google.android.gms.internal.vision.e2.m(i11 == 5 ? R.string.ChooseStickerMyEmojiPacks : R.string.ChooseStickerMyStickerSets, arrayList);
            }
            j61Var.M();
            ...
            for (int size3 = arrayList4.size(); i21 < size3; size3 = size3) {
                ...
                J.D = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.hb1
                        ...
                        switch (i12) {
                            case 0:
                                if (view != null && (view.getParent() instanceof org.telegram.ui.Cells.n8)) {
                                    ...
                                    final int i23 = 0;
                                    H.c(R.drawable.msg_archive, LocaleController.getString(R.string.StickersHide), new Runnable() { // from class: org.telegram.ui.ib1
                                    ...
                                    final int i24 = 1;
                                    H.l(R.drawable.msg_link, LocaleController.getString(R.string.StickersCopy), new Runnable() { // from class: org.telegram.ui.ib1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i24) {
                                                case 0:
                                    ...
                                    final int i25 = 2;
                                    H.l(R.drawable.msg_share, LocaleController.getString(R.string.StickersShare), new Runnable() { // from class: org.telegram.ui.ib1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i25) {
                                                case 0:
                                    ...
                                    final int i26 = 3;
                                    H.m(!stickersSet.set.official, R.drawable.msg_delete, LocaleController.getString(R.string.StickersRemove), true, new Runnable() { // from class: org.telegram.ui.ib1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            switch (i26) {
                                                case 0:
                ...
                J.E = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.hb1
                    public final /* synthetic */ StickersActivity b;
        ...
        if (i11 == 5 && !stickersActivity.f.isEmpty()) {
            ...
            com.google.android.gms.internal.vision.e2.m(i11 == 5 ? R.string.FeaturedEmojiPacks : R.string.FeaturedStickers, arrayList);
            ...
            while (i12 < size4) {
                ...
                J2.D = new View.OnClickListener(stickersActivity) { // from class: org.telegram.ui.hb1
                    public final /* synthetic */ StickersActivity b;
    ...
    public final View createView(Context context) {
        ...
        j3.addView(this.c, w7.a6.m(1.0f, 0, -1, 72, 0, 0));
        ...
        final int i11 = 0;
        org.telegram.ui.Components.r61 r61Var = new org.telegram.ui.Components.r61(this, new Utilities.Callback2(this) { // from class: org.telegram.ui.jb1
            public final /* synthetic */ StickersActivity b;
        ...
        this.a.setTag(7);
        final int i12 = 1;
        this.a.A1(new Utilities.Callback2(this) { // from class: org.telegram.ui.jb1
            public final /* synthetic */ StickersActivity b;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 16, new Class[]{org.telegram.ui.Cells.n8.class, org.telegram.ui.Cells.ga.class, org.telegram.ui.Cells.x8.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.a, 0, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"textView"}, null, null, -1, null, i12));
    ...
    public final void m0() {
        if (this.s) {
            ...
            while (i11 < this.e.size()) {
                i11 = com.google.android.gms.internal.vision.e2.f(((TLRPC.TL_messages_stickerSet) this.e.get(i11)).set.id, tL_messages_reorderStickerSets.order, i11, 1);
            }
