...
public class StickersActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void U(StickersActivity stickersActivity, org.telegram.ui.Components.h51 h51Var, View view) {
        ...
        switch (h51Var.d) {
            ...
            case 5:
                ...
                H.i(new jh(4, view), LocaleController.getString(R.string.SuggestStickersAll), SharedConfig.suggestStickers == 0);
                H.i(new jh(5, view), LocaleController.getString(R.string.SuggestStickersInstalled), SharedConfig.suggestStickers == 1);
                H.i(new jh(6, view), LocaleController.getString(R.string.SuggestStickersNone), SharedConfig.suggestStickers == 2);
                H.Z();
                break;
            case 6:
    ...
    public static void c0(final StickersActivity stickersActivity, ArrayList arrayList, org.telegram.ui.Components.v51 v51Var) {
        ...
        if (stickersActivity.e.size() > 0) {
            ...
            if (i11 == 5 || (!stickersActivity.f.isEmpty() && i11 == 0)) {
                i2.g.p(i11 == 5 ? R.string.ChooseStickerMyEmojiPacks : R.string.ChooseStickerMyStickerSets, arrayList);
            }
            v51Var.M();
        ...
        if (i11 == 5 && !stickersActivity.f.isEmpty()) {
            ...
            i2.g.p(i11 == 5 ? R.string.FeaturedEmojiPacks : R.string.FeaturedStickers, arrayList);
    ...
    public static void d0(StickersActivity stickersActivity, int i10) {
        ...
        if (i10 == 2) {
            ...
            N0.s0 = new iw0(stickersActivity, i12);
            N0.show();
            return;
        }
        if (i10 == 0 || i10 == 1) {
    ...
    public final View createView(Context context) {
        ...
        final int i11 = 0;
        org.telegram.ui.Components.d61 d61Var = new org.telegram.ui.Components.d61(this, new Utilities.Callback2(this) { // from class: org.telegram.ui.fb1
            public final /* synthetic */ StickersActivity b;
        ...
        this.a.setTag(7);
        final int i12 = 1;
        this.a.A1(new Utilities.Callback2(this) { // from class: org.telegram.ui.fb1
            public final /* synthetic */ StickersActivity b;
