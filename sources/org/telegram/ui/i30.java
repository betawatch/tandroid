...
public final class i30 extends xg.c {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i15;
        c60 c60Var = this.f;
        Paint paint4 = c60Var.G1;
        org.telegram.ui.Components.voip.v2 v2Var = c60Var.r;
        org.telegram.ui.Components.voip.v2 v2Var2 = c60Var.v;
        Matrix matrix3 = c60Var.P0;
        org.telegram.ui.Components.u9 u9Var6 = c60Var.K0;
        org.telegram.ui.Components.u9 u9Var7 = c60Var.J0;
        RectF rectF2 = c60Var.s0;
        Paint paint5 = c60Var.Q0;
        RadialProgressView radialProgressView5 = c60Var.b0;
        k40 k40Var = c60Var.Q;
        int[] iArr = c60Var.U1;
        org.telegram.ui.Components.voip.v2 v2Var3 = c60Var.w;
        Paint paint6 = c60Var.F1;
        if (c60Var.i2 && c60Var.d2) {
            return;
        }
        int measuredWidth = (getMeasuredWidth() - getMeasuredHeight()) / 2;
        long elapsedRealtime = SystemClock.elapsedRealtime();
        long j10 = elapsedRealtime - c60Var.L1;
        c60Var.L1 = elapsedRealtime;
        if (j10 > 20) {
            j10 = 17;
        }
        long j11 = j10;
        b60 b60Var4 = c60Var.K1;
        if (b60Var4 != null) {
            b60Var4.b(0, measuredWidth, getMeasuredHeight(), j11, c60Var.L0);
        }
        ...
        b60 b60Var5 = c60Var.J1;
        if (b60Var5 != null && b60Var5.i == 3) {
            radialProgressView5.E = true;
            if (Math.abs(radialProgressView5.n) < 360.0f) {
                z4 = false;
                if (z4) {
                }
                float interpolation = (this.d.getInterpolation(c60Var.M1) * f10) + 0.4f;
                u9Var6.e(c60Var.L0, 1.0f);
                u9Var7.e(c60Var.L0, 1.0f);
                if (c60Var.J1 != null) {
                }
                canvas2 = canvas;
                paint2 = paint6;
        ...
        } else if (b60Var5 != null && (b60Var = c60Var.K1) != null && b60Var.i == 3) {
            radialProgressView5.E = true;
            ...
            if (z4) {
                float f25 = c60Var.I1;
                if (f25 != 1.0f) {
                    b60 b60Var6 = c60Var.J1;
                    if (b60Var6 == null || b60Var6.i != 3) {
                        c60Var.I1 = (j11 / 180.0f) + f25;
                    } else {
                        c60Var.I1 = (j11 / 100.0f) + f25;
                    }
                    if (c60Var.I1 >= 1.0f) {
                        c60Var.I1 = 1.0f;
                        c60Var.J1 = null;
                        b60 b60Var7 = c60Var.K1;
                        if (b60Var7 != null && b60Var7.i == 3) {
                            radialProgressView5.E = false;
                        }
                    }
                    c60Var.T1 = true;
                }
                if (!c60Var.T1 || (b60Var3 = c60Var.K1) == null) {
                    paint = paint4;
                    matrix = matrix3;
                    ...
                    c60Var.T1 = false;
                    b60 b60Var8 = c60Var.J1;
                    if (b60Var8 != null) {
                        c60.S(c60Var, b60Var8.i, iArr);
                        int i16 = iArr[0];
                        int i17 = iArr[1];
                        z10 = z4;
                        int i18 = iArr[2];
                        ...
                        int i19 = iArr[3];
                        matrix = matrix3;
                        c60.S(c60Var, c60Var.K1.i, iArr);
                        paint = paint4;
                        i12 = i0.a.d(c60Var.I1, i16, iArr[0]);
                        i13 = i0.a.d(c60Var.I1, i17, iArr[1]);
                        i14 = i0.a.d(c60Var.I1, i18, iArr[2]);
                        i15 = i0.a.d(c60Var.I1, i19, iArr[3]);
                    } else {
                        paint = paint4;
                        matrix = matrix3;
                        radialProgressView = radialProgressView5;
                        z10 = z4;
                        c60.S(c60Var, b60Var3.i, iArr);
                        i12 = iArr[0];
                        i13 = iArr[1];
                        i14 = iArr[2];
                        i15 = iArr[3];
                    ...
                    c60Var.n.a(i14, i13);
                    c60Var.f.a(i14, i13);
                    org.telegram.ui.Components.voip.v2 v2Var4 = c60Var.s;
                ...
                b60 b60Var9 = c60Var.K1;
                if (b60Var9 != null) {
                    int i21 = b60Var9.i;
                    z11 = i21 == 1 || i21 == 0 || c60.p1(i21);
                    i11 = 3;
                    if (c60Var.K1.i != 3) {
                        z12 = true;
                        if (c60Var.J1 == null && (b60Var2 = c60Var.K1) != null && b60Var2.i == i11) {
                            float f26 = c60Var.M1 - (j11 / 180.0f);
                            c60Var.M1 = f26;
                            if (f26 < f11) {
                                c60Var.M1 = 0.0f;
                            }
            ...
            float interpolation2 = (this.d.getInterpolation(c60Var.M1) * f10) + 0.4f;
            u9Var6.e(c60Var.L0, 1.0f);
            u9Var7.e(c60Var.L0, 1.0f);
            if (c60Var.J1 != null || c60Var.K1 == null || c60Var.r1()) {
                canvas2 = canvas;
                paint2 = paint6;
                radialProgressView2 = radialProgressView;
                matrix2 = matrix;
                ...
                b60 b60Var10 = c60Var.K1;
                f12 = 25.909092f;
                int i22 = b60Var10.i;
                f13 = 25.0f;
                if (i22 == 3 || c60Var.J1.i == 3) {
                    if (i22 == 3) {
                        f20 = c60Var.I1;
                        paint3 = paint6;
                        paint3.setShader(c60Var.J1.g);
                        f19 = 1.0f;
                    } else {
                        paint3 = paint6;
                        f19 = 1.0f;
                        float f35 = 1.0f - c60Var.I1;
                        paint3.setShader(b60Var10.g);
                        f20 = f35;
                    }
                    int offsetColor = AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.kg, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Kg, false), c60Var.R1, f19);
                    Paint paint7 = paint;
                    ...
                    c60Var.O0.setLocalMatrix(matrix4);
                    paint3.setAlpha(76);
                    canvas.save();
                    canvas.scale(v2Var3.getScaleX() * 1.0f, v2Var3.getScaleY() * 1.0f, measuredWidth2, y10);
                    canvas.save();
                    float u10 = e2.c.u(0.807f, c60Var.L0, 0.5f, 0.878f) * c60Var.N1;
                    ...
                    if (c60Var.X0 != null) {
                        canvas.save();
                        float y11 = e2.c.y(0.807f, c60Var.L0, 0.878f, interpolation2);
                        canvas.scale(y11, y11, measuredWidth2, y10);
                        u9Var6.a(measuredWidth2, y10, canvas, paint3);
                        canvas.restore();
                        canvas.save();
                        float y12 = e2.c.y(0.704f, c60Var.L0, 0.926f, interpolation2);
            ...
            while (i10 < 2) {
                ...
                if (i10 == 0 && c60Var.J1 != null) {
                    if (!c60Var.r1()) {
                        paint2.setShader(c60Var.J1.g);
                    }
                    f15 = 1.0f - c60Var.I1;
                    if (c60Var.J1.i == 3) {
                    ...
                    c60Var.O0.setLocalMatrix(matrix2);
                    paint2.setAlpha((int) (c60Var.S0 * 76.0f * f16));
                    canvas2.save();
                    canvas2.scale(v2Var3.getScaleX() * 1.0f, v2Var3.getScaleX() * 1.0f, measuredWidth3, y13);
                    canvas2.save();
                    float u11 = e2.c.u(c60Var.L0, 0.807f, 0.5f, 0.878f);
                    float f36 = c60Var.N1;
                    ...
                    paint2.setAlpha((int) (c60Var.S0 * paint2.getAlpha()));
                    ...
                    if (k40Var != null) {
                        ...
                        float x10 = k40Var.getX() - getX();
                        float y14 = k40Var.getY() - getY();
                        rectF.set(x10, y14, k40Var.getMeasuredWidth() + x10, k40Var.getMeasuredHeight() + y14);
                        canvas2.save();
                    ...
                    if (paint2.getShader() == null || c60Var.r1()) {
                        f16 = f15;
                        f17 = dp2;
                    } else {
                        f16 = f15;
                        f17 = dp2;
                        paint2.setColor(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.kg, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Kg, false), c60Var.R1, 1.0f));
                    }
                    if (c60Var.r1()) {
                        ...
                        radialProgressView4 = radialProgressView2;
                        int offsetColor2 = AndroidUtilities.getOffsetColor(w02, org.telegram.ui.ActionBar.j6.w0(null, i23, false), c60Var.R1, 1.0f);
                        paint2.setColor(offsetColor2);
                        paint2.setShader(null);
                        int i24 = org.telegram.ui.ActionBar.j6.kg;
                        u9Var4 = u9Var7;
                        u9Var3 = u9Var6;
                        v2Var.a(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.w0(null, i24, false), org.telegram.ui.ActionBar.j6.w0(null, i23, false), c60Var.R1, 1.0f), offsetColor2);
                        v2Var2.a(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.w0(null, i24, false), org.telegram.ui.ActionBar.j6.w0(null, i23, false), c60Var.R1, 1.0f), offsetColor2);
                    }
                    ...
                    canvas2.save();
                    float u112 = e2.c.u(c60Var.L0, 0.807f, 0.5f, 0.878f);
                    float f362 = c60Var.N1;
                    canvas2.scale(f362 * u112, f362 * u112, measuredWidth32, y132);
                    if (i10 != 1 && !c60Var.r1() && LiteMode.isEnabled(512)) {
                        canvas2.save();
                        canvas2.scale(1.2f, 1.2f, measuredWidth32, y132);
                        int alpha = paint5.getAlpha();
                        paint5.setAlpha((int) ((1.0f - c60Var.w3.e) * c60Var.S0 * alpha));
                    ...
                    if (!c60Var.r1()) {
                        u9Var2 = u9Var4;
                        u9Var5 = u9Var3;
                    } else if (c60Var.S0 > 0.0f) {
                        canvas2.save();
                        float u12 = e2.c.u(c60Var.L0, 0.807f, interpolation2, 0.878f);
                        canvas2.scale(u12, u12, measuredWidth32, y132);
                        u9Var5 = u9Var3;
                        u9Var5.a(measuredWidth32, y132, canvas2, paint2);
                        canvas2.restore();
                        canvas2.save();
                        float u13 = e2.c.u(c60Var.L0, 0.704f, interpolation2, 0.926f);
                    ...
                    if (c60.C3) {
                        ...
                        paint2.setAlpha((int) (c60Var.T0 * 255.0f));
                    } else {
                        paint2.setAlpha((int) (c60Var.T0 * f16 * 255.0f));
                    }
                    ...
                    if (k40Var != null && k40Var.getVisibility() == 0) {
                        paint2.setAlpha((int) (k40Var.getAlpha() * 255.0f));
                        float x102 = k40Var.getX() - getX();
                        float y142 = k40Var.getY() - getY();
                        rectF.set(x102, y142, k40Var.getMeasuredWidth() + x102, k40Var.getMeasuredHeight() + y142);
                        canvas2.save();
                        canvas2.scale(k40Var.getScaleX(), k40Var.getScaleY(), rectF.centerX(), rectF.centerY());
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(f18), AndroidUtilities.dp(f18), paint2);
                        canvas2.restore();
        ...
        float interpolation22 = (this.d.getInterpolation(c60Var.M1) * f10) + 0.4f;
        u9Var6.e(c60Var.L0, 1.0f);
        u9Var7.e(c60Var.L0, 1.0f);
        if (c60Var.J1 != null) {
        }
