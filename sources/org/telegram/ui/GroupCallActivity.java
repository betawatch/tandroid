...
public class GroupCallActivity extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener, FactorAnimator.Target {
    ...
    public static class WeavingState {
        ...
        public void update(int i, int i2, int i3, long j, float f) {
            ...
            if (f3 == 0.0f || this.time >= f3) {
                this.duration = Utilities.random.nextInt(NotificationCenter.channelRecommendationsLoaded) + 1500;
                this.time = 0.0f;
    ...
    public void lambda$new$3() {
        ...
        if (groupVoipInviteAlert != null) {
            groupVoipInviteAlert.lambda$new$3();
        }
    ...
    */
    ...
    private GroupCallActivity(final Activity activity, final AccountInstance accountInstance, final ChatObject.Call call, final TLRPC.Chat chat, TLRPC.InputPeer inputPeer, boolean z, String str) {
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == 0 && GroupCallActivity.this.scrollOffsetY != 0.0f && motionEvent.getY() < GroupCallActivity.this.scrollOffsetY - AndroidUtilities.dp(37.0f) && GroupCallActivity.this.actionBar.getAlpha() == 0.0f && !GroupCallActivity.this.avatarsPreviewShowed) {
                    ...
                    if (groupCallActivity.previewDialog == null && !groupCallActivity.renderersContainer.inFullscreenMode) {
                        GroupCallActivity.this.lambda$new$3();
                        return true;
                    }
                }
                            ...
                            while (i12 < i7) {
                                ...
                                if (i12 != 0 || GroupCallActivity.this.prevState == null) {
                                    if (i12 == i13 && GroupCallActivity.this.currentState != null) {
                                        ...
                                        if (GroupCallActivity.isLandscapeMode) {
                                            if (i12 == 0) {
                                                GroupCallActivity.this.paint.setAlpha(NotificationCenter.cameraInitied);
                                            } else {
        ...
        if (inputPeer != null) {
            ...
            this.scheduleTimerContainer.addView(numberPicker, LayoutHelper.createLinear(0, NotificationCenter.proxySettingsChanged, 0.5f));
            ...
            this.scheduleTimerContainer.addView(numberPicker2, LayoutHelper.createLinear(0, NotificationCenter.proxySettingsChanged, 0.2f));
            ...
            this.scheduleTimerContainer.addView(numberPicker3, LayoutHelper.createLinear(0, NotificationCenter.proxySettingsChanged, 0.3f));
        ...
        this.containerView.addView(frameLayout4, LayoutHelper.createFrame(-1, NotificationCenter.channelRecommendationsLoaded, 87));
    ...
    public /* synthetic */ void lambda$new$24(Activity activity, final ChatObject.Call call, View view, int i, float f, float f2) {
        ...
        if (view instanceof GroupCallInvitedCell) {
            ...
            if (!isConference()) {
                ...
                this.parentActivity.lambda$runLinkRequest$101(new ProfileActivity(bundle));
                lambda$new$3();
                return;
            }
    ...
    */
    public void updateMuteButton(int i, boolean z) {
        ...
        if (i == 7) {
            ...
            customEndFrame5 = this.bigMicDrawable.setCustomEndFrame(NotificationCenter.savedReactionTagsUpdate);
        } else if (i == 6) {
            ...
            if (i == 5) {
                ...
                if (i == 0) {
                            ...
                            if (z) {
                                if (customEndFrame) {
                                    if (i == 5) {
                                        ...
                                        this.bigMicDrawable.setCurrentFrame(NotificationCenter.topicsDidLoaded);
                                    } else if (i == 0) {
                                        int i3 = this.muteButtonState;
                                        if (i3 == 5) {
                                            this.bigMicDrawable.setCurrentFrame(376);
                                            ...
                                            this.bigMicDrawable.setCurrentFrame(NotificationCenter.savedReactionTagsUpdate);
                                        } else if (i3 == 2) {
                                        ...
                                        if (i4 == 7) {
                                            this.bigMicDrawable.setCurrentFrame(NotificationCenter.newLocationAvailable);
                                        } else if (i4 == 6) {
                    ...
                    if (z5) {
                        ...
                        if (i6 == 7) {
                            customEndFrame2 = this.bigMicDrawable.setCustomEndFrame(NotificationCenter.topicsDidLoaded);
                        } else if (i6 == 6) {
                            customEndFrame2 = this.bigMicDrawable.setCustomEndFrame(NotificationCenter.newLocationAvailable);
                        } else if (i6 == 1) {
    ...
    public void processSelectedOption(TLRPC.GroupCallParticipant groupCallParticipant, final long j, int i) {
        ...
        if (i == 6) {
            ...
            this.parentActivity.lambda$runLinkRequest$101(new ChatActivity(bundle));
            lambda$new$3();
            return;
        }
        if (i == 8) {
            ...
            this.parentActivity.lambda$runLinkRequest$101(new ChatActivity(bundle2));
            lambda$new$3();
            return;
        }
        if (i == 7) {
    ...
    */
    ...
    public static final class EmojiSlot {
        ...
        public boolean draw(Canvas canvas, RectF rectF, float f) {
            ...
            canvas.saveLayerAlpha(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, NotificationCenter.cameraInitied, 31);
            ...
            if (this.loaded && this.real != null && this.realThumb != null && this.realAllowed) {
                ...
                if (f < 1.0f) {
                    ...
                    this.realThumb.setAlpha(NotificationCenter.cameraInitied);
                    canvas.restore();
                }
                if (f > 0.0f) {
                    canvas.save();
                    ...
                    this.real.setAlpha(NotificationCenter.cameraInitied);
                    canvas.restore();
                }
            } else {
                canvas.save();
                ...
                this.pool[1].setAlpha(NotificationCenter.cameraInitied);
                canvas.restore();
            }
            this.rectF.set(rectF);
            ...
            this.pool[0].setAlpha(NotificationCenter.cameraInitied);
            canvas.restore();
            if (f3 >= 1.0f) {
