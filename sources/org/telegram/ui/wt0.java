...
public final class wt0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public wt0(Activity activity) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.b.addView(this.c[i10], i7.f6.e(-1, -2, 19));
        }
        ...
        this.a.addView(o6Var, i7.f6.d(-1, 20.0f, 51, 16.0f, 0.0f, 0.0f, 0.0f));
    }
    ...
    public final void a(CharSequence charSequence, boolean z10) {
        ...
        if (z11 != z12) {
            ...
            if (z10) {
                ...
                arrayList.add(ObjectAnimator.ofFloat(dVar, (Property<bh.d, Float>) property, isEmpty ? 0.0f : AndroidUtilities.dp(-12.0f)));
                arrayList.add(ObjectAnimator.ofFloat(dVar, (Property<bh.d, Float>) View.SCALE_X, !isEmpty ? 0.87f : 1.0f));
                arrayList.add(ObjectAnimator.ofFloat(dVar, (Property<bh.d, Float>) View.SCALE_Y, isEmpty ? 1.0f : 0.87f));
                AnimatorSet animatorSet2 = new AnimatorSet();
                this.f = animatorSet2;
                animatorSet2.playTogether(arrayList);
                this.f.setInterpolator(org.telegram.ui.Components.jr.h);
                this.f.start();
            } else {
    ...
    public final void d(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.e = animatorSet2;
        animatorSet2.playTogether(arrayList);
        this.e.addListener(new e50(this, 17));
        this.e.setDuration(320L);
        this.e.setInterpolator(org.telegram.ui.Components.jr.h);
        this.e.start();
    }
