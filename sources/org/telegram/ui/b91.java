...
public final class b91 extends LinearLayout {
    ...
    public b91(ContextThemeWrapper contextThemeWrapper, final ir0 ir0Var) {
        ...
        this.a = new org.telegram.ui.ActionBar.e1[]{r3, r3, r2, r2, r2};
        setOrientation(1);
        ...
        c10.c(-328966, -328966);
        final int i10 = 0;
        c10.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.a91
            ...
            public final void onClick(View view) {
                ...
                switch (i11) {
                    case 0:
                        PhotoViewer photoViewer = ir0Var2.a;
                        Drawable[] drawableArr = PhotoViewer.U8;
                        photoViewer.D0(true, true, 0.2f);
                        break;
                    case 1:
                        PhotoViewer photoViewer2 = ir0Var2.a;
                        Drawable[] drawableArr2 = PhotoViewer.U8;
                        photoViewer2.D0(true, true, 0.5f);
                        break;
                    case 2:
                        PhotoViewer photoViewer3 = ir0Var2.a;
                        Drawable[] drawableArr3 = PhotoViewer.U8;
                        photoViewer3.D0(true, true, 1.0f);
                        break;
                    case 3:
                        PhotoViewer photoViewer4 = ir0Var2.a;
                        Drawable[] drawableArr4 = PhotoViewer.U8;
                        photoViewer4.D0(true, true, 1.5f);
                        break;
                    default:
                        PhotoViewer photoViewer5 = ir0Var2.a;
        ...
        c11.c(-328966, -328966);
        final int i11 = 1;
        c11.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.a91
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i11;
                ir0 ir0Var2 = ir0Var;
        ...
        c12.c(-328966, -328966);
        final int i12 = 2;
        c12.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.a91
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i12;
                ir0 ir0Var2 = ir0Var;
        ...
        c13.c(-328966, -328966);
        final int i13 = 3;
        c13.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.a91
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i13;
                ir0 ir0Var2 = ir0Var;
        ...
        c14.c(-328966, -328966);
        final int i14 = 4;
        c14.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.a91
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i14;
                ir0 ir0Var2 = ir0Var;
