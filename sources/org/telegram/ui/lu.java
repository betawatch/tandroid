        ...
        switch (this.a) {
            ...
            case 1:
                ...
                if (bool != null && bool.booleanValue()) {
                    uyVar.getMessagesController().addUserToChat(this.b, uyVar.getMessagesController().getUser(Long.valueOf(uyVar.H)), 0, null, uyVar, false, runnable, new mf(8, runnable));
                    break;
                } else {
                    runnable.run();
                    break;
