...
public final class lu extends FrameLayout {
    ...
    public lu(wu wuVar, Context context) {
        super(context);
        setBackgroundColor(wuVar.getThemedColor(org.telegram.ui.ActionBar.h6.d6));
        ...
        textView.setTextColor(wuVar.getThemedColor(i10));
        ...
        imageView2.setColorFilter(new PorterDuffColorFilter(wuVar.getThemedColor(i10), PorterDuff.Mode.MULTIPLY));
        ...
        textView2.setTextColor(wuVar.getThemedColor(org.telegram.ui.ActionBar.h6.o6));
