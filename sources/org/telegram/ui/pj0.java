...
public final /* synthetic */ class pj0 implements Utilities.Callback {
    ...
    public /* synthetic */ pj0(int i10, Object obj, Object obj2) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
    }
        ...
        switch (i10) {
            case 0:
                ...
                if (list != null) {
                    for (TLRPC.User user : list) {
                        if (user != null && !hashSet.contains(Long.valueOf(user.id)) && uj0Var.R(user)) {
                            uj0Var.f0.add(user);
            ...
            case 1:
                ...
                if (user2 == null) {
                    ...
                    fk0Var.v.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag("This phone number is not on Telegram. **Invite >**", new fj0(i14, fk0Var, str)), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)));
                } else {
                    Drawable mutate = fk0Var.getContext().getResources().getDrawable(R.drawable.msg_text_check).mutate();
                    mutate.setColorFilter(new PorterDuffColorFilter(fk0Var.getThemedColor(org.telegram.ui.ActionBar.j6.v6), PorterDuff.Mode.SRC_IN));
                    fk0Var.R.setImageDrawable(mutate);
                    if (user2.contact) {
                        fk0Var.v.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag("This phone number is already in your contacts. **View >**", new fj0(i12, fk0Var, user2)), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)));
                    } else {
            ...
            case 2:
                ...
                if (tL_messages_stickerSet != null && tL_messages_stickerSet.set != null) {
                    for (int i15 = 0; i15 < arrayList.size(); i15++) {
                        ...
                        document = null;
                        if (document != null) {
                            v9VarArr[i15].l(ImageLocation.getForDocument(document), "40_40", ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 40), document), "40_40", Emoji.getEmojiBigDrawable(str2), null);
                        }
                    }
                    break;
                }
            ...
            case 8:
                ...
                l51Var.n.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
                l51Var.r = new Matrix();
                break;
            case 9:
            ...
            case 15:
                ...
                int i19 = k5Var.a;
                updatestargiftcollection.peer = MessagesController.getInstance(i19).getInputPeer(k5Var.b);
            ...
            case 16:
                ...
                AndroidUtilities.runOnUIThread(new xh.q4(i13, user3), 250L);
