...
public final class q51 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (x61Var.n()) {
            AndroidUtilities.rectTmp.set((width - (x61Var.X0 * width)) + getPaddingLeft(), e2.c.w(1.0f, x61Var.Y0, height, getPaddingTop()), ((width2 - width) * x61Var.X0) + getPaddingLeft() + width, getPaddingTop() + height);
        } else {
            AndroidUtilities.rectTmp.set((width - (x61Var.X0 * width)) + getPaddingLeft(), getPaddingTop(), ((width2 - width) * x61Var.X0) + getPaddingLeft() + width, (height * x61Var.Y0) + getPaddingTop());
        }
        Path path = this.a;
        path.rewind();
