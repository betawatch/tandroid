    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (i12 < length) {
            ...
            if (view == null) {
                ...
                float clamp = Utilities.clamp(1.0f - Math.abs(c41Var.getTranslationX() / c41Var.getMeasuredWidth()), 1.0f, f7);
                float f10 = this.b;
                ...
                if (c41Var.getVisibility() == 0) {
                    ...
                    while (true) {
                        ...
                        f61Var.X2.getClass();
                        if (x51Var.G(s4.o0.H(childAt2)).a == 28) {
        ...
        canvas.drawRoundRect(rectF, lerp, lerp, d41Var.c);
        canvas.save();
        Path path = this.c;
        path.rewind();
        ...
        if (bool == null || bool.booleanValue() != z10) {
            boolean z11 = AndroidUtilities.computePerceivedBrightness(d41Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) > 0.721f;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(d41Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f;
