...
import org.telegram.ui.ChatActivity$$ExternalSyntheticLambda283;
...
public class BotWebViewSheet extends Dialog implements NotificationCenter.NotificationCenterDelegate, BottomSheetTabsOverlay.Sheet {
        ...
        public void onSharedTo(ArrayList arrayList) {
            ...
            BotWebViewSheet.this.showBulletin(new Utilities.CallbackReturn() { // from class: org.telegram.ui.bots.BotWebViewSheet$3$$ExternalSyntheticLambda6
                ...
                public final Object run(Object obj) {
                    ...
                    lambda$onSharedTo$0 = BotWebViewSheet.3.lambda$onSharedTo$0(formatString, (BulletinFactory) obj);
    ...
    public BotWebViewSheet(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (!AndroidUtilities.isTablet()) {
                    ...
                    if (point.x > point.y) {
                        ...
                        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(size + AndroidUtilities.dp(24.0f), 1073741824));
                    }
                }
                i3 = (size2 / 5) * 2;
                if (i3 < 0) {
        ...
        FrameLayout.LayoutParams createFrame3 = LayoutHelper.createFrame(-1, NotificationCenter.storyQualityUpdate, 55);
    ...
    public void openOptions() {
        ...
        if (botDownloads.hasFiles()) {
            ...
            makeSwipeback.add(R.drawable.msg_arrow_back, LocaleController.getString(R.string.Back), new ChatActivity$$ExternalSyntheticLambda283(makeOptions));
    ...
    private void updateDownloadBulletin() {
        ...
        if (current == null) {
            ...
            if (bulletin3 == null || !bulletin3.isShowing()) {
                ...
                Bulletin make = Bulletin.make(frameLayout, downloadBulletin2, 5000);
        ...
        for (Map.Entry entry : this.fileItems.entrySet()) {
            ...
            if (fileDownload.isDownloading()) {
                ...
                if (((Long) progress.second).longValue() > 0) {
                    ...
                    longValue = ((Long) progress.first).longValue();
                }
            } else {
                longValue = fileDownload.size;
            }
            str = AndroidUtilities.formatFileSize(longValue);
            actionBarMenuSubItem.setSubtext(str);
            if (!fileDownload.isDownloading()) {
            }
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda11
    ...
    */
    protected void onCreate(Bundle bundle) {
        ...
        if (i2 < 30) {
            ...
            attributes.flags = !this.fullscreen ? i4 | 512 : i3 & (-515);
        ...
        attributes2.flags = !this.fullscreen ? i42 | 512 : i32 & (-515);
    ...
    */
    public void requestWebView(BaseFragment baseFragment, WebViewRequestProps webViewRequestProps) {
        ...
        if ((user4 != null && user4.verified) || (userFull != null && (user = userFull.user) != null && user.verified)) {
            ...
            this.verifiedDrawable.setAlpha(NotificationCenter.didSetNewWallpapper);
        ...
        if (botFullscreenButtons != null) {
            botFullscreenButtons.setName(UserObject.getUserName(user4), user4 != null && user4.verified);
        }
        ...
        if (!this.fromTab) {
            if (userFull != null) {
                ...
                MessagesController.getInstance(this.currentAccount).loadFullUser(user4, 0, true, new Utilities.Callback() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda3
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
