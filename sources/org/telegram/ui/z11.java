...
public final class z11 extends org.telegram.ui.ActionBar.p2 {
    ...
    public z11() {
        ...
        this.C = true;
        this.I = new s11(this);
        this.G = new SharedConfig.ProxyInfo(sf.a.g);
        this.F = true;
    }
    ...
    public final void U(boolean z4) {
        ...
        boolean z10 = this.v != 3 ? !(editTextBoldCursor.length() == 0 || Utilities.parseInt((CharSequence) this.a[1].getText().toString()).intValue() == 0) : !(TextUtils.isEmpty(sf.j.i(editTextBoldCursor.getText().toString())) || sf.j.d(this.a[4].getText().toString()) == null);
        if (this.C != z10) {
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        w11 w11Var = new w11(context, this.c, this.resourceProvider, true);
        this.b = w11Var;
        this.actionBar.setAdaptiveBackground(w11Var);
        ...
        final int i11 = 0;
        View.OnClickListener onClickListener = new View.OnClickListener(this) { // from class: org.telegram.ui.t11
            ...
            public final void onClick(View view) {
                ...
                switch (i11) {
                    case 0:
                        this.b.V(sf.a.d(((Integer) view.getTag()).intValue()), true, null);
                        break;
                    default:
                        z11 z11Var = this.b;
                        sf.a aVar = z11Var.w;
                                ...
                                if (i13 >= editTextBoldCursorArr.length) {
                                    ...
                                    if ((i12 != 1 || i13 != 4) && (i12 != 2 || (i13 != 2 && i13 != 3))) {
                                        ...
                                        if (TextUtils.isEmpty(str)) {
                                            z11Var.a[i13].setText((CharSequence) null);
                                        } else {
                                            try {
                                                z11Var.a[i13].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                z11Var.a[i13].setText(str);
                                            }
                                        }
                                    }
                                    i13++;
        ...
        while (i14 < i13) {
            ...
            if (i14 == 0) {
                ...
                this.a[i14].addTextChangedListener(new x11(this, 0));
            } else if (i14 == 1) {
                this.a[i14].setInputType(2);
                this.a[i14].addTextChangedListener(new x11(this, 1));
            } else if (i14 == 3) {
            ...
            if (i14 == 4) {
                this.a[i14].addTextChangedListener(new x11(this, 2));
            }
        ...
        final int i18 = 1;
        this.n.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.t11
            public final /* synthetic */ z11 b;
                            ...
                            while (true) {
                                ...
                                if (i132 >= editTextBoldCursorArr.length) {
                                    ...
                                    if ((i122 != 1 || i132 != 4) && (i122 != 2 || (i132 != 2 && i132 != 3))) {
                                        ...
                                        if (TextUtils.isEmpty(str)) {
                                            z11Var.a[i132].setText((CharSequence) null);
                                        } else {
                                            try {
                                                z11Var.a[i132].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                z11Var.a[i132].setText(str);
                                            }
                                        }
                                    }
                                    i132++;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        if (this.a != null) {
            ...
            while (true) {
                ...
                arrayList.add(new org.telegram.ui.ActionBar.m6(null, 0, null, null, null, ey0Var, org.telegram.ui.ActionBar.k6.k6));
                arrayList.add(new org.telegram.ui.ActionBar.m6(null, 0, null, null, null, ey0Var, org.telegram.ui.ActionBar.k6.l6));
