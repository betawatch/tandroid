...
public final class z11 extends FrameLayout {
    ...
    public z11(ProxyListActivity proxyListActivity, Context context) {
        super(context);
        ...
        imageView.setOnClickListener(new h60(this, 26));
        ...
        addView(opVar, w7.x5.d(24, 24.0f, (LocaleController.isRTL ? 5 : 3) | 16, 16.0f, 0.0f, 8.0f, 0.0f));
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            duration.addListener(new e70(6, this, z10));
            duration.start();
            return;
        }
        if (!z10) {
    ...
    public final void b() {
            ...
            if (proxyListActivity.d) {
                ...
                if (i11 == 3 || i11 == 5) {
                    ...
                    if (proxyInfo2.ping != 0) {
                        ...
                        org.telegram.messenger.ul.m(R.string.Connected, ", ", sb2);
                ...
                this.r = org.telegram.ui.ActionBar.h6.w0(null, i10, false);
        ...
        if (proxyInfo2.checking) {
            ...
            if (proxyInfo2.ping != 0) {
                ...
                org.telegram.messenger.ul.m(R.string.Available, ", ", sb3);
            ...
            i10 = org.telegram.ui.ActionBar.h6.w6;
        } else {
            textView.setText(LocaleController.getString(R.string.Unavailable));
            i10 = org.telegram.ui.ActionBar.h6.p7;
        }
        this.r = org.telegram.ui.ActionBar.h6.w0(null, i10, false);
        textView.setTag(Integer.valueOf(i10));
        textView.setTextColor(this.r);
