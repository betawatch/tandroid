...
public abstract class y00 extends FrameLayout {
    ...
    public y00(Context context, org.telegram.ui.ActionBar.n2 n2Var, int i10, int i11) {
        ...
        addView(q6Var, w7.x5.d(-1, 20.0f, 55, z10 ? 56.0f : 64.0f, 10.33f, z10 ? 64.0f : 56.0f, 0.0f));
        ...
        q6Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.z6, false));
        q6Var2.setGravity(LocaleController.isRTL ? 5 : 3);
        boolean z11 = LocaleController.isRTL;
        addView(q6Var2, w7.x5.d(-1, 16.0f, 55, z11 ? 56.0f : 64.0f, 33.33f, z11 ? 64.0f : 56.0f, 0.0f));
    ...
    public final void a() {
        ...
        ConnectionsManager.getInstance(this.b).sendRequest(tL_chatlists_deleteExportedInvite, new ro(21, this, x00Var));
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.s) {
            ...
            this.w.addListener(new to(29, this, z12));
