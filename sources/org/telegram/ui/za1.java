...
public final class za1 extends org.telegram.ui.ActionBar.f3 {
    ...
    public static /* synthetic */ void m(za1 za1Var, ry ryVar) {
    ...
    public static void n(ry ryVar) {
        if (b == null) {
            za1 za1Var = new za1(ryVar.getParentActivity(), false);
            Activity parentActivity = ryVar.getParentActivity();
            LinearLayout f7 = org.telegram.messenger.z0.f(parentActivity, 1);
            org.telegram.ui.Components.yw0 yw0Var = new org.telegram.ui.Components.yw0(parentActivity, za1Var.currentAccount);
            ...
            textView3.setOnClickListener(new py0(8, za1Var, ryVar));
            ScrollView scrollView = new ScrollView(parentActivity);
            scrollView.addView(f7);
            za1Var.setCustomView(scrollView);
            b = za1Var;
            za1Var.show();
        }
    }
