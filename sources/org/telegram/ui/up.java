...
public final class up implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View X;
    public boolean Y;
    public final org.telegram.ui.Components.vq Z;
    public int a;
    public final int[] a0;
    public int b;
    public final int b0;
    ...
    public final org.telegram.ui.ActionBar.g6 g0;
    public final TextPaint h;
    public org.telegram.ui.Components.l5 h0;
    ...
    public up(int i10, View view, long j10, int i11, int i12, long j11, org.telegram.ui.ActionBar.g6 g6Var) {
    ...
    public final void a(Canvas canvas, qj qjVar, float f10, float f11) {
        ...
        if (this.X != qjVar) {
            this.X = qjVar;
            org.telegram.ui.Components.l5 l5Var = this.h0;
            if (l5Var != null) {
                l5Var.a(qjVar);
            }
        }
        org.telegram.ui.Components.vq vqVar2 = this.Z;
        vqVar2.H = qjVar;
        ...
        org.telegram.ui.ActionBar.k6.q(0.0f, qjVar.getMeasuredHeight() - dp, this.c, qjVar.getMeasuredHeight());
        int i16 = org.telegram.ui.ActionBar.k6.ic;
        org.telegram.ui.ActionBar.g6 g6Var = this.g0;
        int v02 = org.telegram.ui.ActionBar.k6.v0(i16, g6Var);
        TextPaint textPaint3 = this.f;
        textPaint3.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.k6.v0(i16, g6Var);
        Paint paint2 = this.e;
        paint2.setColor(v03);
        this.h.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Vd, g6Var));
        ...
        } else if (f10 != 1.0f && this.J) {
            this.J = false;
            g(qjVar, false);
        }
        float f23 = this.c / 2.0f;
        float f24 = this.I * (-AndroidUtilities.dp(4.0f));
        float f25 = this.O ? dp - f24 : dp;
        float f26 = f25 / 2.0f;
        float max = Math.max(0.0f, Math.min(this.d, (f26 - (AndroidUtilities.dp(16.0f) * f10)) - AndroidUtilities.dp(4.0f)));
        float max2 = (1.0f - this.H) * ((Math.max(0.0f, Math.min(this.d * f10, f26 - (AndroidUtilities.dp(8.0f) * f10))) * 2.0f) - AndroidUtilities.dp2(16.0f));
        ...
        if (f27 < 1.0f || this.O) {
            ...
            float f29 = -f25;
            float f30 = f25;
            float dp3 = (this.H * (AndroidUtilities.dp(56.0f) + f29)) + ((1.0f - this.H) * (-AndroidUtilities.dp(8.0f)));
            ...
            if (this.T) {
                ...
                if (g6Var != null ? g6Var.o0() : org.telegram.ui.ActionBar.k6.a1()) {
                    ...
                    org.telegram.ui.ActionBar.k6.h2.setAlpha((int) (alpha6 * f13));
                    float f40 = this.d;
                    canvas2.drawRoundRect(rectF4, f40, f40, org.telegram.ui.ActionBar.k6.h2);
                    org.telegram.ui.ActionBar.k6.h2.setAlpha(alpha6);
                }
            }
            float w11 = e2.c.w(1.0f, f10, AndroidUtilities.dp(8.0f), f14 + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(36.0f) * this.H);
            canvas2.save();
            ...
            canvas2.scale(dp5, dp5, f23, w11 - AndroidUtilities.dp(20.0f));
            canvas2.translate(f23 - AndroidUtilities.dp2(12.0f), w11 - AndroidUtilities.dp(12.0f));
            f17 = f23;
            i13 = i10;
            f18 = f24;
            f19 = f30;
            ...
            canvas2.restore();
            if (this.O) {
                float A = e2.c.A(f14 - AndroidUtilities.dp(2.0f), this.H, (1.0f - this.H) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f10)) - f15), f18);
                paint2.setAlpha(alpha4);
                canvas2.save();
                canvas2.scale(f10, f10, f17, AndroidUtilities.dp(28.0f) + A);
        ...
        if (this.s == null || this.H <= 0.0f) {
            ...
            float dp13 = (((1.0f - this.H) * AndroidUtilities.dp(20.0f)) - (AndroidUtilities.dp(f12) * this.H)) + f18;
            ...
            if (g6Var != null ? g6Var.o0() : org.telegram.ui.ActionBar.k6.a1()) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.k6.h2);
            }
            canvas2.save();
        ...
        if (!this.O && f15 > 0.0f) {
            float A2 = e2.c.A((-f19) + AndroidUtilities.dp(4.0f), this.H, (1.0f - this.H) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f10)) - f15), f18);
            org.telegram.ui.Components.l5 l5Var2 = this.h0;
            if (l5Var2 == null || (imageReceiver = l5Var2.k) == null) {
            ...
            float f53 = f15;
            imageReceiver2.setImageCoords(f17 - f52, A2, f53, f53);
            if (this.U && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.pq) && (((org.telegram.ui.Components.pq) imageReceiver2.getDrawable()).b instanceof org.telegram.ui.Components.o80)) {
                ((org.telegram.ui.Components.o80) ((org.telegram.ui.Components.pq) imageReceiver2.getDrawable()).b).i = f10;
            }
            if (this.H <= 0.0f || !this.Y) {
                ...
                vqVar3.e(vqVar3.s);
                canvas2.scale(f54, f54, (vqVar3.s / 2.0f) + vqVar3.A + AndroidUtilities.dp(12.0f) + f17, (A2 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas2.translate(AndroidUtilities.dp(12.0f) + f17, A2 - AndroidUtilities.dp(6.0f));
                float f55 = vqVar3.C;
                float f56 = vqVar3.l;
                if (f56 != 1.0f) {
                    f20 = 6.0f;
                    ...
                    if (i20 == 0 || i20 == 1) {
                        ...
                        f21 = 14.0f;
                        vqVar3.e(vqVar3.s);
                        float dp14 = (vqVar3.x - AndroidUtilities.dp(f55 * 2.0f)) / 2.0f;
                        float f57 = vqVar3.B;
                        rectF2.set(f57, dp14, vqVar3.s + f57 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f58 = f56 * 2.0f;
                        if (f58 > 1.0f) {
                            f58 = 1.0f;
                        }
                        float dp15 = (vqVar3.x - AndroidUtilities.dp(f55 * 2.0f)) / 2.0f;
                        int i21 = vqVar3.s;
                        int i22 = vqVar3.r;
                        if (i21 == i22) {
                            w10 = i21;
                            ...
                            f21 = 14.0f;
                            w10 = e2.c.w(1.0f, f58, i22, i21 * f58);
                        }
                        vqVar3.e(w10);
                        float f59 = vqVar3.B;
                        rectF2 = rectF;
                        rectF2.set(f59, dp15, w10 + f59 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp15);
                    }
                } else {
                    rectF2 = rectF;
                    f20 = 6.0f;
                    f21 = 14.0f;
                    vqVar3.e(vqVar3.s);
                    float dp16 = (vqVar3.x - AndroidUtilities.dp(f55 * 2.0f)) / 2.0f;
                    float f60 = vqVar3.B;
                    rectF2.set(f60, dp16, vqVar3.s + f60 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                ...
                float f61 = this.H;
                vqVar3.e(vqVar3.s);
                canvas2.scale(f61, f61, (vqVar3.s / 2.0f) + vqVar3.A + AndroidUtilities.dp(12.0f) + f17, (A2 - AndroidUtilities.dp(f20)) + AndroidUtilities.dp(f21));
                canvas2.translate(AndroidUtilities.dp(12.0f) + f17, A2 - AndroidUtilities.dp(f20));
                vqVar3.a(canvas2);
                canvas2.restore();
            }
        ...
        org.telegram.ui.ActionBar.k6.h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Xk, this.g0);
        ...
        if (this.w != null) {
            ...
            if (f11 > 0.0f) {
                ...
                float dp = ((1.0f - this.H) * AndroidUtilities.dp(10.0f)) + (((i11 - i10) - this.w.getHeight()) / 2.0f) + i10;
                canvas.save();
                canvas.translate((this.c - this.B) / 2.0f, dp);
                this.w.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final Paint d(String str) {
        org.telegram.ui.ActionBar.g6 g6Var = this.g0;
        Paint F = g6Var != null ? g6Var.F(str) : null;
        return F != null ? F : org.telegram.ui.ActionBar.k6.S0(str);
    }

    @Override // org.telegram.messenger.NotificationCenter.NotificationCenterDelegate
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TLRPC.Dialog dialog;
        if (this.W == 0 || (dialog = (TLRPC.Dialog) MessagesController.getInstance(this.b0).dialogs_dict.f(this.W)) == null) {
            return;
        }
    ...
    public final void f() {
        ...
        NotificationCenter.getInstance(this.b0).addObserver(this, NotificationCenter.updateInterfaces);
    }
    ...
    public final void g(final View view, boolean z4) {
        ...
        if (!z4) {
            ...
            final int i13 = 4;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.sp
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (i13) {
                        case 0:
                            up upVar = this.b;
                            upVar.getClass();
                            upVar.H = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            upVar.Q.invalidate();
                            break;
                        case 1:
                            up upVar2 = this.b;
                            upVar2.getClass();
                            upVar2.I = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            break;
                        case 2:
                            up upVar3 = this.b;
                            upVar3.getClass();
                            upVar3.I = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            break;
                        case 3:
                            up upVar4 = this.b;
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.sp
            public final /* synthetic */ up b;
        ...
        ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.sp
            public final /* synthetic */ up b;
        ...
        final int i14 = 3;
        ofFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.sp
            public final /* synthetic */ up b;
        ...
        this.G = animatorSet3;
        animatorSet3.addListener(new eg.w2(12, this, view));
        AnimatorSet animatorSet4 = new AnimatorSet();
        animatorSet4.playSequentially(ofFloat3, ofFloat4, ofFloat5);
        this.G.playTogether(ofFloat2, animatorSet4);
        this.G.start();
    }
    ...
    public final void h() {
        this.S = false;
        this.E = null;
        TLRPC.Dialog c3 = c(this.f0, this.c0, this.d0, true, this.a0);
        if (c3 == null) {
            this.D = null;
            this.T = false;
            this.O = true;
        ...
        this.D = chat;
        if (chat == null) {
            this.D = MessagesController.getInstance(i10).getChat(Long.valueOf(c3.id));
        }
    ...
    public final void j() {
        ...
        if (topics == null || topics.size() <= 1) {
            ...
            for (int i11 = 0; i11 < topics.size(); i11++) {
                ...
                if (tL_forumTopic2.id != this.e0 && !tL_forumTopic2.hidden && tL_forumTopic2.unread_count > 0 && (tL_forumTopic == null || ((message = tL_forumTopic2.topMessage) != null && (message2 = tL_forumTopic.topMessage) != null && message.date > message2.date))) {
        ...
        if (i12 == 1) {
            View view3 = this.X;
            if (view3 != null && (l5Var2 = this.h0) != null) {
                l5Var2.o(view3);
            }
            this.h0 = null;
            imageReceiver.setImageBitmap(bg.e.c(this.Q.getContext(), 1.0f, org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Ac, g6Var), true));
        } else if (tL_forumTopic.icon_emoji_id != 0) {
            org.telegram.ui.Components.l5 l5Var3 = this.h0;
            if (l5Var3 == null || l5Var3.i() != tL_forumTopic.icon_emoji_id) {
                org.telegram.ui.Components.l5 l5Var4 = this.h0;
                ...
                this.h0 = l5Var5;
                l5Var5.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.ic, g6Var), PorterDuff.Mode.SRC_IN));
            }
            org.telegram.ui.Components.l5 l5Var6 = this.h0;
            ...
            View view4 = this.X;
            if (view4 != null && (l5Var = this.h0) != null) {
                l5Var.o(view4);
            }
            this.h0 = null;
            imageReceiver.setImageBitmap(bg.e.e(tL_forumTopic));
        }
