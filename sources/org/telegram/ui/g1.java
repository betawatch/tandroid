...
public final class g1 extends FrameLayout implements org.telegram.ui.Cells.k9 {
    ...
    public g1(Context context, p70 p70Var, l4 l4Var, int i10) {
        super(context);
        ...
        textView.setOnClickListener(new org.telegram.messenger.video.g(8, this, p70Var));
        ImageView imageView = new ImageView(context);
        this.e = imageView;
        imageView.setImageResource(R.drawable.list_check);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        addView(imageView, k7.b6.e(39, 39, 53));
        org.telegram.ui.Components.qq qqVar = new org.telegram.ui.Components.qq(context, 0);
        this.c = qqVar;
        addView(qqVar, k7.b6.e(39, 39, 53));
    }
    ...
    public final void a(int i10, boolean z4) {
        ...
        org.telegram.ui.Components.qq qqVar = this.c;
        TextView textView = this.d;
        if (!z4) {
            textView.setAlpha(i10 == 0 ? 1.0f : 0.0f);
            textView.setScaleX(i10 == 0 ? 1.0f : 0.1f);
            textView.setScaleY(i10 == 0 ? 1.0f : 0.1f);
            qqVar.setAlpha(i10 == 1 ? 1.0f : 0.0f);
            qqVar.setScaleX(i10 == 1 ? 1.0f : 0.1f);
            qqVar.setScaleY(i10 == 1 ? 1.0f : 0.1f);
        ...
        animatorSet2.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property3, f10), ObjectAnimator.ofFloat(qqVar, (Property<org.telegram.ui.Components.qq, Float>) property, i10 == 1 ? 1.0f : 0.0f), ObjectAnimator.ofFloat(qqVar, (Property<org.telegram.ui.Components.qq, Float>) property2, i10 == 1 ? 1.0f : 0.1f), ObjectAnimator.ofFloat(qqVar, (Property<org.telegram.ui.Components.qq, Float>) property3, i10 == 1 ? 1.0f : 0.1f), ObjectAnimator.ofFloat(imageView, (Property<ImageView, Float>) property, i10 == 2 ? 1.0f : 0.0f), ObjectAnimator.ofFloat(imageView, (Property<ImageView, Float>) property2, i10 == 2 ? 1.0f : 0.1f), ObjectAnimator.ofFloat(imageView, (Property<ImageView, Float>) property3, i10 == 2 ? 1.0f : 0.1f));
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(n4.i(R.string.AccDescrChannel, n4.j(this.a, this.b, f3Var)));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockchannel != null) {
            ...
            this.h = n4.p(this.a, this, str, null, dp, this.s, pageblockchannel2, alignmentArr.length >= 5 ? alignmentArr[3] : Layout.Alignment.ALIGN_NORMAL, 1, this.b);
            int i12 = this.r;
            l4 l4Var = this.b;
            if (l4Var == null || !l4Var.D) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        return n4.l(this.a, this.b, motionEvent, this, this.h, this.r, this.s) || super.onTouchEvent(motionEvent);
    }
    ...
    public void setBlock(TL_iv.pageBlockChannel pageblockchannel) {
        ...
        TLRPC.Chat chat = MessagesController.getInstance(((n4) p70Var).U).getChat(Long.valueOf(pageblockchannel.channel.id));
        if (chat == null || chat.min) {
            ...
            if (!p70Var.r && ChatObject.isPublic(chat2)) {
                ...
                ConnectionsManager.getInstance(i12).sendRequest(tL_contacts_resolveUsername, new nh.b8(p70Var, this.b, i12, this, 1));
            }
            a(1, false);
        } else {
            p70Var.n = chat;
