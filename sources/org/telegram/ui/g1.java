...
public final class g1 extends FrameLayout implements org.telegram.ui.Cells.i9 {
    ...
    public final void a(int i10, boolean z10) {
        ...
        org.telegram.ui.Components.hq hqVar = this.c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockchannel != null) {
            ...
            Layout.Alignment[] alignmentArr = org.telegram.ui.Components.tv0.a;
    ...
    public void setBlock(TL_iv.pageBlockChannel pageblockchannel) {
        ...
        if (chat == null || chat.min) {
            ...
            if (!d70Var.r && ChatObject.isPublic(chat2)) {
                ...
                ConnectionsManager.getInstance(i12).sendRequest(tL_contacts_resolveUsername, new jh.b8(d70Var, this.b, i12, this, 2));
            }
            a(1, false);
        } else {
            d70Var.n = chat;
