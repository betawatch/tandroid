...
public final class s70 extends org.telegram.ui.Components.kl0 {
    ...
    public static void E(s70 s70Var, String str) {
        ...
        if (t70Var.N) {
            if (TextUtils.isEmpty(str)) {
                ...
                t70Var.d.setBackgroundColor(t70Var.getThemedColor(org.telegram.ui.ActionBar.i6.d6));
            }
        }
        if (s70Var.n != 0) {
        ...
        kw kwVar2 = new kw(22, s70Var, str);
        s70Var.f = kwVar2;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (indexOf != -1) {
            ...
            spannableString.setSpan(new org.telegram.ui.Components.e10(org.telegram.ui.ActionBar.i6.q6, resourceProvider), indexOf, lowerCase.length() + indexOf, 0);
        ...
        if (indexOf2 != -1) {
            ...
            spannableString2.setSpan(new org.telegram.ui.Components.e10(org.telegram.ui.ActionBar.i6.q6, resourceProvider), length, lowerCase.length() + length, 0);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            org.telegram.ui.Components.pq pqVar = new org.telegram.ui.Components.pq(new ColorDrawable(t70Var.getThemedColor(org.telegram.ui.ActionBar.i6.a7)), org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.b7));
            pqVar.w = true;
