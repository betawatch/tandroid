...
public final class s70 extends ViewGroup {
    ...
    public org.telegram.ui.Components.a30 e;
    public int f;
    ...
    public final void a(org.telegram.ui.Components.a30 a30Var) {
        ...
        arrayList.clear();
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.a30, Float>) View.SCALE_X, 1.0f, 0.75f));
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.a30, Float>) View.SCALE_Y, 1.0f, 0.75f));
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.a30, Float>) View.ALPHA, 1.0f, 0.0f));
        requestLayout();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (childAt instanceof org.telegram.ui.Components.a30) {
                ...
                if (!this.b) {
                    org.telegram.ui.Components.a30 a30Var = this.e;
                    if (childAt == a30Var) {
        ...
        if (AndroidUtilities.isTablet()) {
            x8 = AndroidUtilities.dp(372.0f) / 3;
        } else {
            Point point = AndroidUtilities.displaySize;
            x8 = org.telegram.messenger.rl.x(158.0f, Math.min(point.x, point.y), 3);
        }
        int dp5 = i13 > 0 ? AndroidUtilities.dp(34.0f) + i13 : 0;
        t70 t70Var = this.h;
        boolean z10 = dp5 > t70Var.x - AndroidUtilities.dp(12.0f);
        if (dp - i14 < x8 && !z10) {
            dp2 += AndroidUtilities.dp(34.0f);
            i13 = Math.max(i13, dp2);
            i14 = 0;
        }
        boolean z11 = (i13 > 0 ? AndroidUtilities.dp(34.0f) + i13 : 0) > t70Var.x - AndroidUtilities.dp(12.0f);
        if (!this.b) {
        ...
        if (z11) {
            max = t70Var.x - AndroidUtilities.dp(12.0f);
        } else {
            max = Math.max(AndroidUtilities.dp(37.0f), Math.min(i13 > 0 ? AndroidUtilities.dp(31.0f) + i13 : 0, t70Var.x - AndroidUtilities.dp(12.0f)));
        }
        t70Var.b.a(max);
        r70 r70Var = t70Var.d;
        if (r70Var != null) {
            int max2 = Math.max(0, childCount - (this.e != null ? 1 : 0));
            float d = i0.a.d(6.0f, i13, 0);
            float f12 = i14;
            boolean z12 = max2 <= 0;
            float f13 = 0.0f;
            ViewPropertyAnimator scaleY = r70Var.c.animate().alpha(z12 ? 1.0f : 0.0f).scaleX(z12 ? 1.0f : 0.5f).scaleY(z12 ? 1.0f : 0.5f);
            org.telegram.ui.Components.er erVar = org.telegram.ui.Components.er.h;
            org.telegram.messenger.rl.o(scaleY, erVar, 320L);
            ViewPropertyAnimator translationY = r70Var.d.animate().translationY(z11 ? ((r70Var.getHeight() - r70Var.getPaddingTop()) - r70Var.getPaddingBottom()) - AndroidUtilities.dp(44.0f) : d);
            if (z11) {
                f13 = AndroidUtilities.dp(-36.0f);
            } else if (max2 > 0) {
                f13 = Math.max(-AndroidUtilities.dp(36.0f), f12 - AndroidUtilities.dp(46.0f));
            }
            translationY.translationX(f13).setInterpolator(erVar).setDuration(320L).start();
            r70Var.f.e.post(new e0(r70Var, d, i16));
        }
