...
public final class pg1 extends ViewGroup {
    ...
    public final void a(org.telegram.ui.Components.a30 a30Var, boolean z10) {
        ...
        gg.g gVar = usersSelectActivity.c;
    ...
    public final void b(org.telegram.ui.Components.a30 a30Var) {
        ...
        ArrayList arrayList = this.c;
        arrayList.clear();
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.a30, Float>) View.SCALE_X, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.a30, Float>) View.SCALE_Y, 1.0f, 0.01f));
        ...
        if (!this.b) {
            ...
            if (this.a != null) {
                ...
                if (usersSelectActivity.c.getTranslationX() != f12) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.c, (Property<gg.g, Float>) property2, f12));
                }
                float translationY = usersSelectActivity.c.getTranslationY();
                float f13 = usersSelectActivity.M;
                if (translationY != f13) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.c, (Property<gg.g, Float>) property, f13));
                }
