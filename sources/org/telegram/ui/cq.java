...
public final class cq extends s4.h0 {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            return new org.telegram.ui.Components.wk0(new org.telegram.ui.Cells.e9(context));
        }
        if (i10 == 1) {
            return new org.telegram.ui.Components.wk0(new org.telegram.ui.Cells.l4(context, 23));
        }
        if (i10 != 3) {
