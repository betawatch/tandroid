...
public final class as extends Drawable {
    ...
    public final org.telegram.ui.Components.m6 g;
    ...
    public as(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        Path path = new Path();
        this.i = path;
        this.m = new org.telegram.ui.Components.c6(new ej(this, 12), 320L, org.telegram.ui.Components.qr.h, 0);
    ...
    public final void draw(Canvas canvas) {
        ...
        float d = m6Var.d() + (m6Var.g() * dp);
        float dp2 = AndroidUtilities.dp(5.0f);
        org.telegram.ui.Components.m6 m6Var2 = this.g;
        float d10 = m6Var2.d() + (m6Var2.g() * dp2);
        ...
        if (d * f15 > 0.0f) {
            ...
            m6Var.w = (int) (m6Var.g() * 255.0f * f15);
            float f16 = f7 / 2.0f;
