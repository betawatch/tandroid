...
public final class n11 extends org.telegram.ui.Components.rl0 {
    public final Context c;
    public final /* synthetic */ ProxyListActivity d;

    public n11(ProxyListActivity proxyListActivity, Context context) {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        switch (i14) {
            ...
            case 5:
                ...
                o11Var.setProxy(proxyInfo);
                o11Var.setChecked(SharedConfig.currentProxy == proxyInfo);
                boolean contains = arrayList.contains(arrayList2.get(i10 - proxyListActivity.r));
                o11Var.h = contains;
                o11Var.f.a(contains, false);
                o11Var.a(!arrayList.isEmpty(), false);
                break;
            case 6:
                if (i10 == proxyListActivity.x) {
    ...
    public final void w(f2.l1 l1Var, int i10, List list) {
        ...
        if (i13 == 5 && !list.isEmpty()) {
            o11 o11Var = (o11) view;
            if (list.contains(1) && (contains = arrayList.contains(proxyListActivity.F.get(i10 - proxyListActivity.r))) != o11Var.h) {
                o11Var.h = contains;
                o11Var.f.a(contains, true);
            }
            if (list.contains(2)) {
                o11Var.a(!arrayList.isEmpty(), true);
                return;
            }
            return;
        }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            z6Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false));
        } else if (i10 == 2) {
