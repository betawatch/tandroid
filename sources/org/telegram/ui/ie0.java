...
public final /* synthetic */ class ie0 implements RequestDelegate {
    ...
    public /* synthetic */ ie0(pe0 pe0Var, TLRPC.TL_auth_signIn tL_auth_signIn, int i10) {
        this.a = i10;
        this.b = pe0Var;
                            ...
                            case 0:
                                ...
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.contains("SESSION_PASSWORD_NEEDED")) {
                                        ...
                                        ConnectionsManager.getInstance(i11).sendRequest(getpassword, new ie0(pe0Var2, tL_auth_signIn2, 1), 10);
                                        pe0Var2.r();
                                    }
                                } else {
                                    pe0Var2.O = false;
                    ...
                    public final void run() {
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                int i12 = pe0Var22.a;
                                lg.f fVar = pe0Var22.c;
                                og0 og0Var = pe0Var22.U;
                                og0Var.k1(false, true);
                                TLRPC.TL_error tL_error2 = tL_error;
                                ...
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.contains("SESSION_PASSWORD_NEEDED")) {
                                        ...
                                        ConnectionsManager.getInstance(i112).sendRequest(getpassword, new ie0(pe0Var22, tL_auth_signIn22, 1), 10);
                                        pe0Var22.r();
                                    }
                                } else {
                                    pe0Var22.O = false;
