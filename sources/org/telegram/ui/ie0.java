...
public final class ie0 extends org.telegram.ui.Components.wv0 {
    ...
    public String v;
    public String w;
    public final org.telegram.ui.Components.cd0 x;
    ...
    */
    public ie0(og0 og0Var, Context context) {
        super(context);
        int i10;
        this.y = og0Var;
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                editTextBoldCursor.setOnEditorActionListener(new ha(this, 5));
                addView(cd0Var, k7.c6.t(-1, -2, 1, 16, 32, 16, 0));
                ...
                frameLayout2.addView(textView3, k7.c6.d(-1, 56.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
                addView(frameLayout2, k7.c6.q(-1, -1, 80));
                n7.qa.M0(textView3);
                textView3.setOnClickListener(new hb0(4, this, context));
            }
        }
        i10 = 8;
        frameLayout.setVisibility(i10);
        ...
        addView(textView4, k7.c6.d(-1, -2.0f, 1, 32.0f, 16.0f, 32.0f, 0.0f));
        ...
        editTextBoldCursor2.setOnEditorActionListener(new ha(this, 5));
        addView(cd0Var2, k7.c6.t(-1, -2, 1, 16, 32, 16, 0));
        ...
        frameLayout22.addView(textView32, k7.c6.d(-1, 56.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        addView(frameLayout22, k7.c6.q(-1, -1, 80));
        n7.qa.M0(textView32);
        textView32.setOnClickListener(new hb0(4, this, context));
    }
    ...
    public final void h(String str) {
        ...
        if (obj.length() != 0) {
            ...
            og0.U0(og0Var, this.x, true);
        }
    }

    @Override // org.telegram.ui.Components.wv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new c10(this, 19), og0.q0);
    }
    ...
    public final void n() {
        ...
        this.b.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.D6, false));
        ...
        this.c.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.q6, false));
        this.x.f();
    }
}
