...
public final /* synthetic */ class ie0 implements RequestDelegate {
    ...
    public /* synthetic */ ie0(ke0 ke0Var, int i10) {
        this.a = i10;
        this.b = ke0Var;
    }
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                ke0Var2.getClass();
                                if (tL_error2 == null) {
                                    ke0Var2.n = (TL_account.Password) tLObject2;
                                    ke0Var2.h(null);
                                    break;
                                }
                                break;
                            case 1:
                                rg0 rg0Var = ke0Var2.y;
                                ...
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        ...
                                        rg0Var.l1(LocaleController.getString(R.string.WrongCodeTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue < 60 ? LocaleController.formatPluralString("Seconds", intValue, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue / 60, new Object[0])));
                                        break;
                                    }
                                } else {
                            ...
                            default:
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    ...
                                    ConnectionsManager.getInstance(i11).sendRequest(getpassword, new ie0(ke0Var2, i13), 8);
                                    break;
                                    ...
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                            ...
                                            rg0Var2.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue2 < 60 ? LocaleController.formatPluralString("Seconds", intValue2, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue2 / 60, new Object[0])));
                                            break;
                                        }
                                    } else if (rg0Var2.getParentActivity() != null) {
                                        ke0Var2.a.setText("");
                                        rg0.U0(rg0Var2, ke0Var2.x, true);
                                        break;
                                    }
                                } else {
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                ke0Var22.getClass();
                                if (tL_error2 == null) {
                                    ke0Var22.n = (TL_account.Password) tLObject2;
                                    ke0Var22.h(null);
                                    break;
                                }
                                break;
                            case 1:
                                rg0 rg0Var = ke0Var22.y;
                                rg0Var.k1(false, true);
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        rg0Var.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), tL_error2.text);
                                ...
                                break;
                            default:
                                rg0 rg0Var2 = ke0Var22.y;
                                ke0Var22.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i112 = ((org.telegram.ui.ActionBar.n2) rg0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i112).sendRequest(getpassword, new ie0(ke0Var22, i13), 8);
                                    break;
                                } else if (!(tLObject2 instanceof TLRPC.TL_auth_authorization)) {
                                    rg0Var2.k1(false, true);
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        ...
                                        ke0Var22.a.setText("");
                                        rg0.U0(rg0Var2, ke0Var22.x, true);
                                        break;
                                    }
                                } else {
                                    rg0Var2.v1(false, true);
