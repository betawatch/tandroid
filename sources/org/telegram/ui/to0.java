...
public final class to0 implements TextWatcher {
    ...
    */
    public final void afterTextChanged(Editable editable) {
        ...
        boolean z10 = true;
        EditTextBoldCursor editTextBoldCursor = yo0Var.f[1];
        ...
        yo0Var.o0 = true;
        yo0Var.f[1].setTextColor(yo0Var.getThemedColor(org.telegram.ui.ActionBar.j6.G6));
        if (sb2.length() > 4) {
            sb2.setLength(4);
        }
        if (sb2.length() < 2) {
        ...
        if (!this.b) {
            if (sb2.length() == 1) {
                ...
                if (intValue2 > 12 || intValue2 == 0) {
                    yo0Var.f[1].setTextColor(yo0Var.getThemedColor(org.telegram.ui.ActionBar.j6.p7));
                } else {
                    z10 = false;
                }
                selectionStart++;
        ...
        if (sb2.length() == 4 && i13 == 2) {
            ...
            boolean z11 = UserConfig.getInstance(i10).getClientPhone().startsWith("7") || ((xtVar = yo0Var.A0) != null && xtVar.c.equals("7"));
        ...
        if (intValue5 > 12 || intValue5 == 0) {
            yo0Var.f[1].setTextColor(yo0Var.getThemedColor(org.telegram.ui.ActionBar.j6.p7));
            if (!z10 && sb2.length() == 4) {
                yo0Var.f[yo0Var.i0 ? (char) 2 : (char) 3].requestFocus();
            }
            if (sb2.length() == 2) {
