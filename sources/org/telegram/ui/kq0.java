...
public final class kq0 extends org.telegram.ui.ActionBar.p2 {
    ...
    public kq0(HashMap hashMap, ArrayList arrayList, int i10, boolean z4, xn xnVar) {
        ...
        this.f = new Paint();
        this.n = new iq0[2];
        this.a = new fq0(0, null, hashMap, arrayList, i10, z4, xnVar, false);
        this.b = new fq0(1, null, hashMap, arrayList, i10, z4, xnVar, false);
    }
    ...
    public static void h0(kq0 kq0Var, String str) {
        kq0Var.c.getSearchField().setText(str);
        kq0Var.c.getSearchField().setSelection(str.length());
        kq0Var.actionBar.w();
    }
    ...
    public final View createView(Context context) {
        ...
        int i13 = 0;
        while (i13 < 4) {
            View view = i13 != 0 ? i13 != 1 ? i13 != 2 ? fq0Var.Z : fq0Var.Y : fq0Var.X : fq0Var.W;
        ...
        while (true) {
            ...
            iq0Var4.b = (FrameLayout) iq0Var4.a.getFragmentView();
            iq0VarArr[i14].d.setClipToPadding(false);
            iq0 iq0Var5 = iq0VarArr[i14];
            iq0Var5.c = iq0Var5.a.getActionBar();
            iq0 iq0Var6 = iq0VarArr[i14];
            iq0Var6.addView(iq0Var6.b, k7.b6.c(-1.0f, -1));
            iq0 iq0Var7 = iq0VarArr[i14];
            iq0Var7.addView(iq0Var7.c, k7.b6.c(-2.0f, -1));
            iq0VarArr[i14].c.setVisibility(8);
