    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 == 1) {
            ...
            if (i10 == ai0Var.s) {
                if (ai0Var.o0 && j3 == ai0Var.getAccountInstance().getUserConfig().clientUserId) {
                    n4Var.setText(LocaleController.getString(R.string.PublicLink));
                    return;
                } else if (j3 == ai0Var.getAccountInstance().getUserConfig().clientUserId) {
                    n4Var.setText(LocaleController.getString(R.string.ChannelInviteLinkTitle));
                    return;
                } else {
                    n4Var.setText(LocaleController.getString(R.string.PermanentLinkForThisAdmin));
                    return;
                }
            }
            if (i10 == ai0Var.L) {
                n4Var.setText(LocaleController.getString(R.string.RevokedLinks));
                return;
            } else if (i10 == ai0Var.P) {
                n4Var.setText(LocaleController.getString(R.string.LinksCreatedByThisAdmin));
                return;
            } else {
                if (i10 == ai0Var.S) {
                    n4Var.setText(LocaleController.getString(R.string.LinksCreatedByOtherAdmins));
                    return;
                }
                return;
            }
        ...
        if (i12 == 3) {
            ...
            g2Var.b.setImageDrawable(pqVar);
            g2Var.c = z11;
            return;
        }
        if (i12 != 5) {
                ...
                case 10:
                    ...
                    if (i10 != ai0Var.Q) {
                        ...
                        if (i10 != ai0Var.V - 1) {
                            ...
                            user = user2;
                            if (user == null) {
                                c5Var.b(user, ContactsController.formatName(user.first_name, user.last_name), LocaleController.formatPluralString("InviteLinkCount", i11, new Object[0]), z10);
                                break;
                            }
                        } else {
                            i11 = i13;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 3:
                ...
                view = new org.telegram.ui.Cells.g2(context, 64, f6Var);
                break;
            case 4:
            ...
            case 9:
                ...
                break;
            case 10:
                view = new org.telegram.ui.Cells.c5(8, 6, this.c, null, false);
                break;
            case 11:
            ...
            default:
                ...
                th0Var.addView(new sh0(context), w7.y5.d(-2, -2.0f, 49, 0.0f, 10.0f, 0.0f, 0.0f));
                ...
                th0Var.addView(textView, w7.y5.d(-1, -2.0f, 51, 52.0f, 143.0f, 52.0f, 18.0f));
                th0Var.setTag(-33024);
                view = th0Var;
                break;
        }
