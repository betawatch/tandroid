...
public final class zh0 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(zh0 zh0Var, TLRPC.TL_chatInviteExported tL_chatInviteExported, TLRPC.TL_error tL_error, TLObject tLObject, boolean z10) {
        ...
        if (tL_error == null) {
            ...
            if (tL_messages_exportedChatInvites.invites.size() <= 0 || !zh0Var.g0) {
                ...
                org.telegram.ui.Components.bl0 bl0Var = zh0Var.h0;
                if (bl0Var != null && !zh0Var.isPaused) {
                    bl0Var.b(i13 + 1);
                }
                z11 = false;
            }
    ...
    */
    public static /* synthetic */ void V(zh0 zh0Var, TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        zh0Var.e0 = true;
        zh0Var.b0 = false;
        if (arrayList.size() > 0 && (bl0Var = zh0Var.h0) != null && !zh0Var.isPaused && zh0Var.g0) {
            bl0Var.b(i12 + 1);
        }
        if (zh0Var.b0) {
        }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 16, new Class[]{org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.g2.class, org.telegram.ui.Components.e90.class, wh0.class}, null, null, null, i10));
