...
public final class p80 extends ActionBarPopupWindow$ActionBarPopupWindowLayout {
    ...
    public final org.telegram.ui.Components.s00 b0;
    public int c0;
    public final CacheByChatsController d0;
    public n80 e0;
    public ArrayList f0;
    public final org.telegram.ui.ActionBar.p2 g0;
    ...
    public p80(Context context, org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        this.a0 = arrayList;
        this.g0 = p2Var;
        this.d0 = p2Var.getMessagesController().getCacheByChatsController();
        setFitItems(true);
        ...
        for (int i11 = 0; i11 < this.a0.size(); i11++) {
            ((o80) this.a0.get(i11)).a.setOnClickListener(new bi.j5(this, ((o80) this.a0.get(i11)).b, 18));
        }
    ...
    public final void f() {
        if (this.f0 != null) {
            ((org.telegram.ui.Components.j9) this.b0.d).setTranslationX((3 - Math.min(3, this.f0.size())) * AndroidUtilities.dp(12.0f));
        }
    }
