...
public final class p80 extends ActionBarPopupWindow$ActionBarPopupWindowLayout {
    ...
    public p80(Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        for (int i11 = 0; i11 < this.a0.size(); i11++) {
            ((o80) this.a0.get(i11)).a.setOnClickListener(new di.o4(this, ((o80) this.a0.get(i11)).b, 18));
        }
    ...
    public final void f() {
        if (this.f0 != null) {
            ((org.telegram.ui.Components.l9) this.b0.d).setTranslationX((3 - Math.min(3, this.f0.size())) * AndroidUtilities.dp(12.0f));
        }
    }
