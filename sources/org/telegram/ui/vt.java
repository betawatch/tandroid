...
public final class vt extends org.telegram.ui.Components.qa {
    ...
    public vt(Activity activity, HashSet hashSet) {
        ...
        frameLayout.addView(f10, h7.z5.e(-1, -1, 119));
        ...
        h7.b6.a(imageView);
        final int i10 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ut
        ...
        f10.addView(frameLayout2, h7.z5.t(80, 80, 1, 2, 21, 2, 13));
        int i11 = org.telegram.ui.ActionBar.g6.G6;
        org.telegram.ui.Components.p80 a2 = h7.d6.a(activity, 20.0f, i11, true, this.resourcesProvider);
        a2.setText(LocaleController.getString(R.string.GroupCallCreateTitle));
        a2.setGravity(17);
        f10.addView(a2, h7.z5.t(-1, -2, 1, 2, 0, 2, 4));
        org.telegram.ui.Components.p80 a3 = h7.d6.a(activity, 14.0f, i11, false, this.resourcesProvider);
        ...
        f10.addView(a3, h7.z5.t(-1, -2, 1, 2, 0, 2, 23));
        ...
        LinearLayout f11 = org.telegram.messenger.y1.f(activity, 0);
        ...
        frameLayout3.addView(f11, h7.z5.e(-1, -2, 87));
        ...
        f11.addView(dVar, h7.z5.p(-1, 48, 1.0f, 119, 0, 0, 6, 0));
        final int i12 = 1;
        dVar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ut
            public final /* synthetic */ vt b;
        ...
        f11.addView(dVar2, h7.z5.p(-1, 48, 1.0f, 119, 6, 0, 0, 0));
        final int i13 = 2;
        dVar2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ut
            public final /* synthetic */ vt b;
    ...
    public static void R(vt vtVar, ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < arrayList2.size(); i10++) {
            ...
            int i11 = gg.n.a;
            org.telegram.ui.Components.n41 J = org.telegram.ui.Components.n41.J(gg.n.class);
            J.G = user;
            J.K(vtVar.X.contains(l10));
            arrayList.add(J);
        }
    }
