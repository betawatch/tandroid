...
public final /* synthetic */ class z90 implements ky {
    ...
    public /* synthetic */ z90(LaunchActivity launchActivity, String str, int i10, TLRPC.User user) {
        ...
        switch (i12) {
            case 0:
                ...
                if (MessagesController.getInstance(i13).checkCanOpenChat(i14, qyVar)) {
                    ...
                    ((ActionBarLayout) launchActivity.O()).S(new wn(i14), true, false);
                    break;
                }
                break;
            default:
                ...
                if (MessagesController.getInstance(i13).checkCanOpenChat(i15, qyVar)) {
                    NotificationCenter.getInstance(i13).lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
                    ((ActionBarLayout) launchActivity.O()).S(new wn(i15), true, false);
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ z90(LaunchActivity launchActivity, TLRPC.User user, String str, int i10) {
        this.b = launchActivity;
        this.e = user;
        this.c = str;
        this.d = i10;
