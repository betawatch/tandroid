...
public final class vi0 extends org.telegram.ui.Components.qv0 {
    public final n20 A0;
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        Rect rect = dj0Var.u0;
        wi0 wi0Var = dj0Var.K;
        if (dj0Var.w && (t1Var = dj0Var.Q) != null && t1Var.getCurrentPosition() == null) {
            if (dj0Var.x) {
                org.telegram.ui.Components.of ofVar = dj0Var.S;
                if (ofVar != null) {
                    ofVar.setAlpha(0.0f);
                }
                dj0Var.x = false;
            ...
            org.telegram.ui.Components.of ofVar2 = dj0Var.S;
            if (ofVar2 != null) {
                int[] iArr3 = this.w0;
            ...
            if (dj0Var.S != null) {
                ...
                if (dj0Var.E >= 0.001f) {
                    ...
                    canvas2.saveLayerAlpha(dj0Var.S.getX() + dj0Var.S.getPaddingLeft(), 0.0f, ((dj0Var.S.getX() + dj0Var.S.getPaddingLeft()) + dj0Var.S.getWidth()) - dj0Var.S.getPaddingRight(), dj0Var.S.getHeight(), (int) org.telegram.messenger.wl.u(dj0Var.E, 0.1f, 1.0f, 255.0f), 31);
                    ...
                    paint.setAlpha((int) org.telegram.messenger.wl.u(dj0Var.E, 0.1f, 1.0f, paint.getAlpha()));
            ...
            if (t1Var2 == null) {
                ...
                org.telegram.ui.Cells.s1 transitionParams = dj0Var.Q.getTransitionParams();
        ...
        if (dj0Var.w) {
            if (dj0Var.y) {
                org.telegram.ui.Components.tg tgVar = dj0Var.W;
                if (tgVar != null) {
                    tgVar.setAlpha(0.0f);
                }
                c10 = 0;
        ...
        if (dj0Var.l0 != null) {
            if (dj0Var.J == null) {
                dj0Var.J = new org.telegram.ui.Components.m5(AndroidUtilities.dp(24.0f), 23, this, false);
            }
