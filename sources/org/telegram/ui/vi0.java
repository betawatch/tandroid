...
public final class vi0 extends org.telegram.ui.Components.wl0 {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.u1) {
                ...
                u1Var2.b4(i12, measuredHeight2 - i12, measuredHeight, f7, f7, ui0Var.getMeasuredWidth(), ui0Var.getMeasuredHeight(), 0, 0, 0);
            }
        }
        boolean z11 = true;
            ...
            if (i24 != 2 || vi0Var4.X1) {
                ...
                while (i25 < childCount3) {
                    ...
                    if (childAt6 instanceof org.telegram.ui.Cells.u1) {
                        ...
                        if (childAt6.getY() <= vi0Var4.getHeight() && childAt6.getY() + childAt6.getHeight() >= 0.0f && (currentMessagesGroup = u1Var5.getCurrentMessagesGroup()) != null) {
                            int i26 = i24 == 0 ? 1 : 1;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        org.telegram.ui.Cells.u1 u1Var;
        cj0 cj0Var = this.b3;
        if (cj0Var.w && ((view == (u1Var = cj0Var.Q) && u1Var != null && u1Var.getCurrentPosition() == null) || view == cj0Var.X)) {
            return false;
        }
