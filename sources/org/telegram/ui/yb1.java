...
public final class yb1 extends org.telegram.ui.Components.ll0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i23 == 1) {
            ...
            if (i10 == themeActivity.Y) {
                faVar.c(LocaleController.getString("AutoNightUpdateLocation", R.string.AutoNightUpdateLocation), org.telegram.ui.ActionBar.h6.w, false, false);
                return;
            }
            ...
            if (i10 == themeActivity.K) {
                ...
                faVar.c(LocaleController.getString(R.string.SearchEngine), org.telegram.ui.web.n1.a().a, themeActivity.P0, false);
                return;
            } else {
        ...
        if (i23 == 2) {
            ...
            if (i10 == themeActivity.f0) {
                f9Var.setText(LocaleController.formatString("AutoNightBrightnessInfo", R.string.AutoNightBrightnessInfo, Integer.valueOf((int) (org.telegram.ui.ActionBar.h6.q * 100.0f))));
                return;
            }
        ...
        if (i23 == 4) {
            ...
            if (i10 == themeActivity.R) {
                laVar.a(LocaleController.getString("AutoNightDisabled", R.string.AutoNightDisabled), org.telegram.ui.ActionBar.h6.o == 0, true);
                return;
            }
            if (i10 == themeActivity.S) {
                laVar.a(LocaleController.getString("AutoNightScheduled", R.string.AutoNightScheduled), org.telegram.ui.ActionBar.h6.o == 1, true);
                return;
            } else if (i10 == themeActivity.T) {
                laVar.a(LocaleController.getString("AutoNightAdaptive", R.string.AutoNightAdaptive), org.telegram.ui.ActionBar.h6.o == 2, themeActivity.U != -1);
                return;
            } else {
                if (i10 == themeActivity.U) {
                    laVar.a(LocaleController.getString("AutoNightSystemDefault", R.string.AutoNightSystemDefault), org.telegram.ui.ActionBar.h6.o == 3, false);
                    return;
                }
                return;
            }
        ...
        if (i23 == 7) {
            ...
            if (i10 == themeActivity.X) {
                x8Var.f(LocaleController.getString("AutoNightLocation", R.string.AutoNightLocation), org.telegram.ui.ActionBar.h6.p, true);
                return;
            }
    ...
    /* JADX WARN: Type inference failed for: r2v29, types: [org.telegram.ui.zo0] */
    @Override // s4.h0
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 4:
                ...
                laVar.addView(textView, w7.x5.d(-1, -1.0f, (z10 ? 5 : 3) | 48, z10 ? 71.0f : 21.0f, 0.0f, z10 ? 21.0f : 23.0f, 0.0f));
                ...
                laVar.addView(imageView, w7.x5.d(19, 14.0f, (LocaleController.isRTL ? 3 : 5) | 16, 23.0f, 0.0f, 23.0f, 0.0f));
                j5Var = laVar;
                break;
            case 5:
            ...
            case 9:
                ...
                while (true) {
                    ...
                    if (i14 >= y0VarArr.length) {
                        ...
                        y0VarArr[i14] = y0Var;
                        laVar.addView(((org.telegram.ui.Cells.y0[]) laVar.b)[i14], w7.x5.m(0.5f, -1, -1, i14 == 1 ? 10 : 0, 0, 0));
                        ((org.telegram.ui.Cells.y0[]) laVar.b)[i14].setOnClickListener(new ai.j3(3, laVar, z11));
                        i14++;
                    }
                }
                break;
            ...
            case 15:
                ...
                sy0Var.n = new int[]{r14, r14, r14, r14, org.telegram.ui.ActionBar.h6.Y5, org.telegram.ui.ActionBar.h6.d9};
                sy0Var.r = new org.telegram.ui.Components.yi0[6];
                sy0Var.v = new org.telegram.ui.Components.bj0[2];
                sy0Var.x = 1.0f;
                ...
                for (int i16 = 0; i16 < 2; i16++) {
                    sy0Var.v[i16] = new org.telegram.ui.Components.bj0(context);
                    sy0Var.addView(sy0Var.v[i16], w7.x5.d(28, 28.0f, 21, 0.0f, 0.0f, 184.0f, 0.0f));
                }
                org.telegram.ui.Components.yi0 a2 = sy0Var.a(sy0Var.f.getValue());
                if (a2 != null) {
            ...
            case 16:
                ...
                View xb1Var = new xb1(context, c5Var, 0);
            ...
            case 21:
                ...
                laVar = new zo0(i13, 0L, this.c, themeActivity.getResourceProvider());
                j5Var = laVar;
                break;
        }
    ...
    public final void y(s4.c1 c1Var) {
        if (c1Var.f == 4) {
            ((org.telegram.ui.Cells.la) c1Var.a).setTypeChecked(c1Var.b() == org.telegram.ui.ActionBar.h6.o);
        }
    }
}
