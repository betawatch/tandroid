...
public final class zm0 extends org.telegram.ui.Components.vv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public zm0(dn0 dn0Var, Context context, int i10) {
        super(context);
        this.N = dn0Var;
        this.x = new Object();
        this.y = 60000;
        ...
        org.telegram.messenger.y3.t(textView2, org.telegram.ui.ActionBar.j6.w0(null, i12, false), 1, 18.0f);
        ...
        if (i10 == 3) {
            ...
            addView(frameLayout, k7.b6.q(-2, -2, LocaleController.isRTL ? 5 : 3));
            ImageView imageView = new ImageView(context);
            imageView.setImageResource(R.drawable.phone_activate);
            boolean z4 = LocaleController.isRTL;
            if (z4) {
                frameLayout.addView(imageView, k7.b6.d(64, 76.0f, 19, 2.0f, 2.0f, 0.0f, 0.0f));
                frameLayout.addView(textView, k7.b6.d(-1, -2.0f, LocaleController.isRTL ? 5 : 3, 82.0f, 0.0f, 0.0f, 0.0f));
            } else {
                frameLayout.addView(textView, k7.b6.d(-1, -2.0f, z4 ? 5 : 3, 0.0f, 0.0f, 82.0f, 0.0f));
        ...
        this.n = qVar;
        qVar.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        qVar.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        if (i10 == 3) {
            qVar.setTextSize(1, 14.0f);
            addView(qVar, k7.b6.q(-2, -2, LocaleController.isRTL ? 5 : 3));
            ...
            addView(an0Var, k7.b6.k(0.0f, 12.0f, 0.0f, 0.0f, -1, 3));
        } else {
        ...
        this.r = wm0Var;
        wm0Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        wm0Var.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        wm0Var.setPadding(0, AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(10.0f));
        wm0Var.setTextSize(1, 15.0f);
        wm0Var.setGravity(49);
        if (i10 == 1) {
            wm0Var.setText(LocaleController.getString(R.string.DidNotGetTheCodeSms));
        } else {
            wm0Var.setText(LocaleController.getString(R.string.DidNotGetTheCode));
        }
        addView(wm0Var, k7.b6.q(-2, -2, 49));
        wm0Var.setOnClickListener(new e60(this, 16));
    }
    ...
    public final boolean c(boolean z4) {
        ...
        if (!z4) {
            ...
            alertDialog$Builder.h(LocaleController.getString(R.string.Stop), new um0(this, 1));
    ...
    public final void h(String str) {
        ...
        dn0Var.y1();
        i10 = ((org.telegram.ui.ActionBar.p2) dn0Var).currentAccount;
        ConnectionsManager.getInstance(i10).sendRequest(verifyphone, new sb0(8, this, verifyphone), 2);
    }
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.L) {
            ...
            while (i16 < this.L) {
                ...
                this.c.addView(this.d[i16], k7.b6.t(34, 36, 1, 0, 0, i16 != this.L - 1 ? 7 : 0, 0));
                this.d[i16].addTextChangedListener(new xm0(this, i16));
                this.d[i16].setOnKeyListener(new View.OnKeyListener() { // from class: org.telegram.ui.vm0
                    ...
                    public final boolean onKey(View view, int i18, KeyEvent keyEvent) {
                        ...
                        EditTextBoldCursor[] editTextBoldCursorArr3 = zm0Var.d;
                        int i19 = i16;
                        if (editTextBoldCursorArr3[i19].length() != 0 || i19 <= 0) {
                            return false;
                        }
                        int i20 = i19 - 1;
                        EditTextBoldCursor editTextBoldCursor2 = zm0Var.d[i20];
                        editTextBoldCursor2.setSelection(editTextBoldCursor2.length());
                        zm0Var.d[i20].requestFocus();
                        zm0Var.d[i20].dispatchKeyEvent(keyEvent);
                        return true;
                    }
                });
        ...
        an0 an0Var = this.s;
        if (an0Var != null) {
            an0Var.setVisibility(this.J != 0 ? 0 : 8);
        }
        if (this.a == null) {
            return;
        }
        ...
        if (i12 == i10 && ((i11 = this.J) == 4 || i11 == 3)) {
            ...
            wm0Var.setVisibility(this.y < 1000 ? 0 : 8);
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        wm0 wm0Var = this.r;
        if (wm0Var.getVisibility() == 0) {
            int measuredHeight2 = wm0Var.getMeasuredHeight();
            i14 = (measuredHeight + bottom) - measuredHeight2;
            wm0Var.layout(wm0Var.getLeft(), i14, wm0Var.getRight(), measuredHeight2 + i14);
        } else {
            gg.q qVar = this.n;
        ...
        int d = kh.a2.d(i14 - bottom, measuredHeight4, 2, bottom);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (dn0Var.p0 - dp < dp2) {
            ...
            setMeasuredDimension(getMeasuredWidth(), Math.min(dn0Var.p0, dp3));
        }
    }
    ...
    public final void p() {
        ...
        this.w.schedule(new org.telegram.ui.Components.g50(this, 2), 0L, 1000L);
    }
    ...
    public final void q() {
        ...
        this.v = timer;
        timer.schedule(new ym0(this), 0L, 1000L);
    }
