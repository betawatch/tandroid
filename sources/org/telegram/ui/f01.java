...
public class f01 extends org.telegram.ui.Components.w9 implements org.telegram.ui.Components.mv0 {
    ...
    public boolean a0;
    public float b0;
    public org.telegram.ui.Components.ph0 c0;
    public boolean d0;
    public float e0;
    public Runnable f0;
    ...
    public org.telegram.ui.Components.bh getPrevFragment() {
        return null;
    }
    ...
    public final void invalidate() {
        super.invalidate();
        org.telegram.ui.Components.ph0 ph0Var = this.c0;
        if (ph0Var != null) {
            ph0Var.invalidate();
        }
    ...
    public final void onDraw(Canvas canvas) {
        org.telegram.ui.Components.gh0 gh0Var;
        boolean z10;
        float f7;
        float f10;
        char c10;
        ...
        org.telegram.ui.Components.ph0 ph0Var = this.c0;
        boolean z11 = ph0Var != null && ph0Var.getVisibility() == 0 && this.M && this.H > 0.0f;
        if (z11) {
            org.telegram.ui.Components.gh0 blurDrawer = this.c0.getBlurDrawer();
            gh0Var = blurDrawer;
            z11 = blurDrawer != null;
        } else {
            gh0Var = null;
        }
        float A = org.telegram.messenger.z0.A(1.0f, this.V, this.e0, (1.0f - this.b0) * (this.d0 ? (int) AndroidUtilities.dpf2(3.5f) : 0.0f));
        ...
        if (z10) {
            ...
            float f24 = A * f7;
            gh0Var.f(canvas, this, f15 - f24, f23 - f24, true, (this.G || gh0Var.a || this.c0.getRealPosition() == 0) ? 1.0f - this.H : 1.0f, f11);
        }
        canvas.restore();
    }
    ...
    public void setAvatarsViewPager(org.telegram.ui.Components.ph0 ph0Var) {
        this.c0 = ph0Var;
    }
