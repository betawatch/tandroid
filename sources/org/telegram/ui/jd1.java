...
public final class jd1 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void V(jd1 jd1Var, TLRPC.TL_theme tL_theme) {
        try {
            jd1Var.r.dismiss();
            jd1Var.r = null;
        } catch (Exception e6) {
    ...
    public static /* synthetic */ void W(jd1 jd1Var, TLRPC.TL_error tL_error, TL_account.updateTheme updatetheme) {
        try {
            jd1Var.r.dismiss();
            jd1Var.r = null;
        } catch (Exception e6) {
    ...
    public static /* synthetic */ void X(jd1 jd1Var, String str) {
        ...
        jd1Var.y = ConnectionsManager.getInstance(jd1Var.currentAccount).sendRequest(createtheme, new tb0(25, jd1Var, str), 2);
    }

    public static void Y(jd1 jd1Var) {
        org.telegram.ui.ActionBar.j6 j6Var = jd1Var.G;
        TLRPC.TL_theme tL_theme = jd1Var.I;
        if (jd1Var.Z(jd1Var.a.getText().toString(), true) && jd1Var.getParentActivity() != null) {
            if (jd1Var.b.length() == 0) {
            ...
            if (jd1Var.F) {
                ...
                jd1Var.r = d2Var;
                d2Var.setOnCancelListener(new hd1());
                jd1Var.r.show();
                String obj = jd1Var.b.getText().toString();
                tL_theme.title = obj;
                j6Var.a = obj;
                j6Var.C.slug = jd1Var.a.getText().toString();
            ...
            String obj2 = jd1Var.a.getText().toString();
            String obj3 = jd1Var.b.getText().toString();
            if (str2.equals(obj2) && str4.equals(obj3)) {
                jd1Var.finishFragment();
                return;
            }
            jd1Var.r = new org.telegram.ui.ActionBar.d2(jd1Var.getParentActivity(), 3, null);
            ...
            jd1Var.r.setOnCancelListener(new mh.v(jd1Var, sendRequest, 9));
            jd1Var.r.show();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.fd1
            ...
            public final boolean onEditorAction(TextView textView, int i14, KeyEvent keyEvent) {
                ...
                switch (i11) {
                    case 0:
                        jd1 jd1Var = this.b;
                        if (i14 == 6) {
                            AndroidUtilities.hideKeyboard(jd1Var.b);
                            return true;
                        }
                        jd1Var.getClass();
                        return false;
        ...
        this.a.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.fd1
            public final /* synthetic */ jd1 b;
        ...
        this.a.addTextChangedListener(new id1(this));
        if (z4) {
