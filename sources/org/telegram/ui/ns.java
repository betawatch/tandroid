...
public final class ns extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.u40 {
    ...
    public static /* synthetic */ void U(ns nsVar, TL_account.TL_birthday tL_birthday) {
        ...
        tL_users_suggestBirthday.id = nsVar.getMessagesController().getInputUser(nsVar.H);
    ...
    public static void X(ns nsVar, TLRPC.PhotoSize photoSize, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.PhotoSize photoSize2, TLRPC.VideoSize videoSize, double d, boolean z10) {
        ...
        if (inputFile == null && inputFile2 == null) {
            nsVar.e.h(ImageLocation.getForLocal(nsVar.Q), "50_50", nsVar.n, nsVar.getMessagesController().getUser(Long.valueOf(nsVar.H)));
            if (nsVar.S == 2) {
                nsVar.e0(true, false);
            } else {
    ...
    public final View createView(Context context) {
        ...
        this.d = i3Var3;
        i3Var3.b.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.gc));
                ...
                public final void onClick(View view) {
                    switch (i11) {
                        case 0:
                            ...
                            v40Var.o(z12, fVar, new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.gs
                        ...
                        default:
                            ...
                            v40Var2.o(z13, fVar2, new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.gs
                                @Override // android.content.DialogInterface.OnDismissListener
                                public final void onDismiss(DialogInterface dialogInterface) {
                                    switch (i19) {
                                        case 0:
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(i3Var, TLObject.FLAG_23, null, null, null, null, i11));
