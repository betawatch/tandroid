...
public final class tc1 extends org.telegram.ui.Components.p9 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z4) {
            ...
            if ((drawable instanceof ColorDrawable) || (drawable instanceof GradientDrawable) || (drawable instanceof org.telegram.ui.Components.fc0)) {
                ...
                if (((BitmapDrawable) drawable).getTileModeX() == Shader.TileMode.REPEAT) {
                    ...
                    int ceil = (int) Math.ceil(this.D.getIntrinsicWidth() * max * ed1Var.v1);
                    int ceil2 = (int) Math.ceil(this.D.getIntrinsicHeight() * max * ed1Var.v1);
        ...
        if (ed1Var.X1) {
            if (!ed1Var.c.isFinished() && ed1Var.c.computeScrollOffset()) {
                if (ed1Var.c.getStartX() < ed1Var.T1 && ed1Var.c.getStartX() > 0) {
                    ed1Var.U1 = ed1Var.c.getCurrX();
                }
                ed1Var.V0();
                invalidate();
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ed1 ed1Var = this.H;
        org.telegram.ui.Components.p81 p81Var = ed1Var.s1;
        ...
        if (ed1Var.Y1 != measuredWidth2) {
            ed1Var.X1 = false;
            if (ed1Var.z1 != null) {
                int measuredHeight2 = (int) ((getMeasuredHeight() / ed1Var.z1.getHeight()) * r1.getWidth());
                if (measuredHeight2 - getMeasuredWidth() > 100) {
                    ed1Var.X1 = true;
                    ed1Var.W1 = (int) ((ed1Var.z1.getHeight() / getMeasuredHeight()) * getMeasuredWidth());
