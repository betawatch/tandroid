...
public final class pv extends org.telegram.ui.ActionBar.o2 {
    ...
    public final View createView(Context context) {
        ...
        for (int i10 = 0; i10 < ovVarArr.length; i10++) {
            ...
            if (i10 == 0) {
                ...
                wyVar.M3();
                gy gyVar = wyVar.C0;
                ovVar2.e = gyVar != null ? gyVar.W : null;
            } else if (i10 == 1) {
            ...
            ovVar6.addView(ovVar6.b, w7.x5.c(-1.0f, -1));
            AndroidUtilities.removeFromParent(ovVarArr[i10].c);
            ov ovVar7 = ovVarArr[i10];
            ovVar7.addView(ovVar7.c, w7.x5.c(-2.0f, -1));
            ovVarArr[i10].c.setVisibility(8);
            int i11 = 0;
            while (i11 < 2) {
                org.telegram.ui.Components.ml0 ml0Var = i11 == 0 ? ovVarArr[i10].d : ovVarArr[i10].e;
                if (ml0Var != null) {
    ...
    public final void m0(boolean z10) {
        ...
        int i11 = 0;
        while (i11 < 2) {
            org.telegram.ui.Components.ml0 ml0Var = i11 == 0 ? ovVarArr[z10 ? 1 : 0].d : ovVarArr[z10 ? 1 : 0].e;
            if (ml0Var != null) {
                ml0Var.getAdapter();
