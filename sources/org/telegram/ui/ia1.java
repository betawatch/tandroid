...
public final class ia1 extends LinearLayout {
    ...
    public void setData(ka1 ka1Var) {
        TextView[] textViewArr = this.a;
        textViewArr[0].setText(ka1Var.b);
        textViewArr[1].setText(ka1Var.f);
        textViewArr[2].setText(ka1Var.j);
        textViewArr[3].setText(ka1Var.n);
        TextView[] textViewArr2 = this.b;
        textViewArr2[0].setText(ka1Var.c);
        textViewArr2[0].setTag(Integer.valueOf(ka1Var.d ? org.telegram.ui.ActionBar.j6.x6 : org.telegram.ui.ActionBar.j6.p7));
        textViewArr2[1].setText(ka1Var.g);
        textViewArr2[1].setTag(Integer.valueOf(ka1Var.h ? org.telegram.ui.ActionBar.j6.x6 : org.telegram.ui.ActionBar.j6.p7));
        textViewArr2[2].setText(ka1Var.k);
        textViewArr2[2].setTag(Integer.valueOf(ka1Var.l ? org.telegram.ui.ActionBar.j6.x6 : org.telegram.ui.ActionBar.j6.p7));
        textViewArr2[3].setText(ka1Var.o);
        textViewArr2[3].setTag(Integer.valueOf(ka1Var.p ? org.telegram.ui.ActionBar.j6.x6 : org.telegram.ui.ActionBar.j6.p7));
        TextView[] textViewArr3 = this.c;
        textViewArr3[0].setText(ka1Var.a);
        textViewArr3[1].setText(ka1Var.e);
        textViewArr3[2].setText(ka1Var.i);
        textViewArr3[3].setText(ka1Var.m);
        b();
    }
}
