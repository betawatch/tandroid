...
public class g70 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, le.d, View.OnClickListener, ph.d {
    ...
    public static void U(g70 g70Var, Context context, View view, int i10) {
        ...
        int i12 = 0;
        if (i10 == e70Var.w) {
            int i13 = g70Var.currentAccount;
            org.telegram.ui.ActionBar.f6 f6Var = g70Var.resourceProvider;
            w60 w60Var = new w60(g70Var, i12);
            org.telegram.ui.ActionBar.c2 c2Var = new org.telegram.ui.ActionBar.c2(context, 3, null);
            c2Var.q(500L);
            TL_phone.createConferenceCall createconferencecall = new TL_phone.createConferenceCall();
            createconferencecall.random_id = Utilities.random.nextInt();
            ConnectionsManager.getInstance(i13).sendRequest(createconferencecall, new ai.ya(i13, c2Var, context, f6Var, w60Var, 3));
            return;
        }
        if (i10 == 0 && e70Var.F != 0 && !e70Var.n) {
            org.telegram.ui.Components.ae0 ae0Var = new org.telegram.ui.Components.ae0(context, g70Var, g70Var.I, g70Var.G, j10 != 0);
            g70Var.d0 = ae0Var;
        ...
        if (view instanceof org.telegram.ui.Cells.f4) {
            ...
            if (f4Var.r) {
                ...
                if (m30Var == null) {
                    org.telegram.ui.Components.m30 m30Var2 = new org.telegram.ui.Components.m30(g70Var.f.r.getContext(), "premium");
                    g70Var.X = m30Var2;
                    g70Var.h.a(m30Var2);
            ...
            if (f4Var.s) {
                ...
                if (m30Var3 == null) {
                    org.telegram.ui.Components.m30 m30Var4 = new org.telegram.ui.Components.m30(g70Var.f.r.getContext(), "miniapps");
                    g70Var.Y = m30Var4;
                    g70Var.h.a(m30Var4);
            ...
            if (iVar == null || iVar.h(j3) < 0) {
                ...
                if (f4Var.O) {
                    ...
                    String userName = j3 >= 0 ? UserObject.getUserName(MessagesController.getInstance(g70Var.currentAccount).getUser(Long.valueOf(j3))) : "";
                    (MessagesController.getInstance(g70Var.currentAccount).premiumFeaturesBlocked() ? org.telegram.ui.Components.vc.a0(g70Var).Q(R.raw.star_premium_2, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserBlockedNonPremium, userName))) : org.telegram.ui.Components.vc.a0(g70Var).J(R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserBlockedNonPremium, userName)), LocaleController.getString(R.string.UserBlockedNonPremiumButton), new w60(g70Var, i14))).j();
                    return;
                }
                ...
                if (m30Var5 != null) {
                        ...
                        if (g70Var.R && user.bot) {
                            ...
                            if (j10 != 0) {
                                ...
                                if (canAddAdmins) {
                                    ...
                                    alertDialog$Builder2.k(LocaleController.getString(R.string.AddAsAdmin), new f20(i14, g70Var, user));
                    ...
                    org.telegram.ui.Components.m30 m30Var6 = new org.telegram.ui.Components.m30(g70Var.f.r.getContext(), object);
                    g70Var.h.a(m30Var6);
    ...
    public static void Z(g70 g70Var) {
        ...
        g70Var.c.a(!g70Var.Z.i(), true);
    }

    public static void a0(g70 g70Var, Canvas canvas, RectF rectF, Paint paint) {
        fh.d dVar;
        canvas.drawRect(rectF, paint);
        if (Build.VERSION.SDK_INT < 29 || !SharedConfig.chatBlurEnabled() || (dVar = g70Var.q0) == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.h = y60Var;
        y60Var.setDelegate(new v60(this, i10));
        this.h.getSpansContainer().setOnClickListener(new x60(this, i10));
        y60 y60Var2 = this.h;
        this.Z = y60Var2.b;
        this.a0 = y60Var2.c;
        r0();
        this.f.r.setOnEditorActionListener(new ka(this, 4));
        this.f.r.setOnKeyListener(new z60(i10, this));
        ...
        float f7 = -this.a;
        j0Var.addView(ml0Var3, w7.x5.d(-1, -1.0f, 119, 0.0f, f7, 0.0f, f7));
        ...
        this.y.setOnClickListener(new x60(this, i11));
        ...
        if (z13) {
            ...
            dVar.setOnClickListener(new x60(this, i13));
            ...
            dVar2.setOnClickListener(new x60(this, i16));
        ...
        this.r0 = new ah.o(ml0Var5, j0Var, new zs(ml0Var5, i10));
        this.n.D0(new w60(this, i16));
    ...
    */
                ...
                if (this.h0 != (this.Y == null) && hashSet.size() == hashSet2.size()) {
                    ...
                    if (z11) {
                        if (z10) {
                            ...
                            alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new v60(this, 1));
                            alertDialog$Builder.h(LocaleController.getString(R.string.PassportDiscard), new v60(this, 2));
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.f4) {
                ...
                if (RecyclerView.S(childAt) == this.v.v) {
                    ((org.telegram.ui.Cells.u3) childAt).b((this.X == null && this.Z.i()) ? "" : LocaleController.getString(R.string.DeselectAll), new x60(this, 4));
                }
            }
        }
    }
            ...
            if (!z10) {
                ...
                if (this.E) {
                    ...
                    if (this.O || this.P) {
                        c70 c70Var = this.w;
                        if (c70Var != null) {
                            c70Var.b(arrayList2, this.X != null, this.Y != null);
                        }
                        finishFragment();
                        return true;
                    }
                ...
                if (this.Z.m() > 5) {
                    ...
                    c2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.AddMembersAlertNamesText, sb2, chat != null ? chat.title : ""));
                }
                ...
                if (!ChatObject.isChannel(chat)) {
                    ...
                    z1VarArr[0].setOnClickListener(new y20(z1VarArr, i12));
    ...
    public final void r0() {
        ...
        if (this.R || ((e70Var = this.v) != null && e70Var.G == 0)) {
