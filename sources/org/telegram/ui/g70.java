...
public final class g70 extends DispatchQueue {
    ...
    public g70(i70 i70Var, SurfaceTexture surfaceTexture) {
        ...
        this.w = new v5(this, 7);
        this.a = surfaceTexture;
    }

    public final void b(int i9, int i10, int i11, boolean z10) {
        Drawable drawable = this.x.getParentActivity().getResources().getDrawable(i9);
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            ...
            i70 i70Var = this.x;
            if (!this.b.eglChooseConfig(this.c, EmuDetector.with(i70Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                ...
                if (eglCreateContext == null) {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            b(R.drawable.intro_powerful_mask, 17, org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.d6, false), false);
