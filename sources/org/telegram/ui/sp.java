...
public final class sp extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public long E;
    public int F;
    public int G;
    public int H;
    ...
    public static /* synthetic */ void U(sp spVar, org.telegram.ui.ActionBar.b2[] b2VarArr) {
        try {
            b2VarArr[0].dismiss();
        ...
        AndroidUtilities.runOnUIThread(new hp(spVar, 2), 1000L);
        if (spVar.s) {
            return;
        }
    ...
    public static /* synthetic */ void W(sp spVar, org.telegram.ui.ActionBar.b2[] b2VarArr, TLRPC.Chat chat, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        Boolean bool = Boolean.FALSE;
        notificationCenter.lambda$postNotificationNameOnUIThread$1(i10, spVar.h, 0, bool, bool);
        AndroidUtilities.runOnUIThread(new hp(spVar, 1), 1000L);
        if (n2Var == null) {
            spVar.finishFragment();
        } else {
    ...
    public final void Y(TLRPC.Chat chat, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        if (!ChatObject.isChannel(chat)) {
            getMessagesController().convertToMegaGroup(getParentActivity(), chat.id, this, new u(16, this, n2Var));
            return;
        }
        ...
        AndroidUtilities.runOnUIThread(new ip(this, b2VarArr, getConnectionsManager().sendRequest(tL_channels_setDiscussionGroup, new ai.p3(this, b2VarArr, chat, n2Var, 5), 64), 1), 500L);
    }
    ...
    public final void a0(TLRPC.Chat chat, boolean z10) {
        ...
        if (chatFull == null) {
            if (z10) {
                ...
                AndroidUtilities.runOnUIThread(new hp(this, i10), 500L);
                return;
            }
            return;
        }
        ...
        if (chatFull.hidden_prehistory) {
            formatString = org.telegram.messenger.z0.h(R.string.DiscussionLinkGroupAlertHistory, w.c.h(formatString, "\n\n"));
        }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 16, new Class[]{org.telegram.ui.Cells.b5.class, org.telegram.ui.Cells.y4.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.y6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{mp.class}, new String[]{"messageTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.g9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 262144, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.m6));
