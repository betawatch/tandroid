...
public final class sp extends org.telegram.ui.Components.k80 {
    ...
    public final boolean a(boolean z10, org.telegram.ui.Components.i80 i80Var) {
        ...
        wpVar.P = true;
        e(new uh(15, this, i80Var), new ai.s4(this, this.w, z10, i80Var, 15));
        return true;
    }
    ...
    public final boolean b(boolean z10, org.telegram.ui.Components.j80 j80Var) {
        ...
        wpVar.O = true;
        e(new uh(15, this, j80Var), new ai.s4(this, this.w, z10, j80Var, 14));
        return true;
    }
    ...
    public final void e(uh uhVar, Runnable runnable) {
        ...
        if (ChatObject.isChannel(wpVar.f)) {
            ...
            wpVar.getMessagesController().convertToMegaGroup(wpVar.getParentActivity(), this.w.id, wpVar, new x5(15, this, runnable), uhVar);
        }
    }
}
