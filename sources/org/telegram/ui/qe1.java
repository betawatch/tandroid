...
public final /* synthetic */ class qe1 implements Runnable {
    ...
    public /* synthetic */ qe1(re1 re1Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = re1Var;
        this.c = str;
        this.d = i10;
    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                int i10 = this.d;
                re1Var.getClass();
                Utilities.searchQueue.postRunnable(new qe1(re1Var, str, i10, 1));
                break;
            default:
                re1 re1Var2 = this.b;
                String str2 = this.c;
                int i11 = this.d;
                se1 se1Var = re1Var2.h;
                ...
                if (lowerCase.length() != 0) {
                            ...
                            if (publicUsername != null) {
                                ...
                                while (i13 < i12) {
                                    ...
                                    if (!lowerCase2.startsWith(str4)) {
                                        int i16 = i13;
                                        if (!org.telegram.messenger.wh.u(" ", str4, lowerCase2)) {
                                            i13 = i16 + 1;
                                        }
                                    }
                                    z10 = true;
                                    if (!z10) {
                                        arrayList2.add(chat);
                                        arrayList3.add((String) se1Var.h.get(i14));
                                    }
                                }
                                if (!z10) {
                                }
                    ...
                    AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.h21(re1Var2, i11, arrayList2, arrayList3, 12));
                    break;
                } else {
                    AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.h21(re1Var2, i11, str3, str3, 12));
                    break;
                }
                break;
        }
