...
public final class qe1 extends org.telegram.ui.Components.qv0 {
    ...
    public final void J(Canvas canvas, float f10, Rect rect, Paint paint, boolean z4) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            ...
            if (kf1Var.d1 != null) {
                ...
                kf1Var.d1.X(canvas, rect.left, rect.top + f10, rect.right, rect.bottom + f10);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        kf1 kf1Var = this.v0;
        sg.d dVar = kf1Var.e1;
        sg.d dVar2 = kf1Var.d1;
        ng.e eVar = kf1Var.c1;
        if (Build.VERSION.SDK_INT >= 31 && eVar != null) {
            kf1Var.x0();
            oy oyVar = kf1Var.J0;
            int measuredWidth = oyVar != null ? oyVar.fragmentView.getMeasuredWidth() : getMeasuredWidth();
            oy oyVar2 = kf1Var.J0;
            int measuredHeight = oyVar2 != null ? oyVar2.fragmentView.getMeasuredHeight() : getMeasuredHeight();
        ...
        if (kf1Var.isInPreviewMode()) {
            int themedColor = kf1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6);
            Paint paint = this.u0;
        ...
        if (kf1Var.J0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, kf1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6), kf1Var.b1);
        }
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view == kVar && !kf1Var.isInPreviewMode()) {
            ...
            int measuredHeight = (int) (y10 + ((int) ((((k81Var == null || k81Var.getVisibility() == 8) ? 0.0f : kf1Var.X0.getMeasuredHeight()) * kf1Var.T) + height)));
            ((ActionBarLayout) kf1Var.getParentLayout()).p(canvas, (int) ((1.0f - kf1Var.T) * 255.0f), measuredHeight);
            float f10 = kf1Var.T;
            if (f10 > 0.0f) {
                if (f10 < 1.0f) {
                    int alpha = org.telegram.ui.ActionBar.j6.k0.getAlpha();
                    org.telegram.ui.ActionBar.j6.k0.setAlpha((int) (alpha * kf1Var.T));
                    ...
                    canvas.drawLine(0.0f, f12, getMeasuredWidth(), f12, org.telegram.ui.ActionBar.j6.k0);
                }
            }
        }
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (a51Var != null) {
            ...
            kf1Var.l0.setPadding(0, 0, 0, i13);
            this.t0 = false;
        }
        int i14 = 0;
