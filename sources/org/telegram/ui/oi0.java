            ...
            case 1:
                ...
                if (!dj0Var.g0 || dj0Var.h0) {
                    ...
                    if (dj0Var.F.getWidth() > 0) {
                        int[] iArr = {org.telegram.messenger.wl.D(6.0f, dj0Var.W.getWidth() - dj0Var.W.l(), r2), 0};
                        ...
                        if (frameLayout != null) {
                            frameLayout.setX(hg.k0.f(6.0f, (dj0Var.X.l() + iArr[0]) - dj0Var.d0.getMeasuredWidth(), 0));
