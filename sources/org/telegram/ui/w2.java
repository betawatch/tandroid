...
public final class w2 extends FrameLayout implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.p9 {
    ...
    public w2(Context context, w70 w70Var, f4 f4Var, int i10) {
        super(context);
        this.a = w70Var;
        this.b = f4Var;
        ...
        this.K = DownloadController.getInstance(((h4) w70Var).X).generateObserverTag();
    ...
    public final void b(TL_iv.pageBlockVideo pageblockvideo, x2 x2Var, boolean z10, boolean z11) {
        ...
        if (pageblockvideo2 != null && (videoPlayerHolderBase = (w70Var = this.a).w) != null && w70Var.x == this) {
            a0.i iVar = w70Var.y;
    ...
    public final void c(x2 x2Var) {
        ...
        Bitmap bitmap3;
        x2 x2Var2 = this.M;
        if (x2Var2 != null && (bitmap2 = x2Var.b) != null && (bitmap3 = x2Var2.b) != null && bitmap2 != bitmap3) {
            bitmap3.recycle();
            this.M.b = null;
        }
        x2 x2Var3 = this.M;
        if (x2Var3 != null && x2Var.b == null && (bitmap = x2Var3.b) != null) {
            x2Var.a = x2Var3.a;
            x2Var.b = bitmap;
        }
        this.M = x2Var;
    ...
    public final void d() {
        ...
        if (this.U) {
            ...
            w70 w70Var = this.a;
            if (pageblockvideo != null && (videoPlayerHolderBase = w70Var.w) != null && w70Var.x == this) {
                a0.i iVar = w70Var.y;
            ...
            DownloadController.getInstance(((h4) w70Var).X).removeLoadingFileObserver(this);
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!imageReceiver.hasBitmapImage() || imageReceiver.getCurrentAlpha() != 1.0f) {
            canvas.drawRect(imageReceiver.getDrawRegion(), h4.o1);
        }
        ...
        h4.u(canvas, w70Var, this.L, getMeasuredHeight());
        super.onDraw(canvas);
        ...
        if (i22 == 1) {
            ...
            if (i22 != 2) {
                ...
                if (pageblockvideo == null) {
                                    ...
                                    if (this.P) {
                                        ...
                                        if (x2Var == null || x2Var.b == null) {
                                            ...
                                            if (this.R || pathToAttach.exists() || pathToAttach2.exists()) {
                                                ...
                                                imageReceiver.setImage(null, null, ImageLocation.getForDocument(this.O), "200_200_pframe", ImageLocation.getForDocument(closestPhotoSizeWithSize, this.O), "80_80_b", null, this.O.size, null, f4Var2.E, 1);
                                            } else {
                                                imageReceiver.setStrippedLocation(ImageLocation.getForDocument(this.O));
                                                imageReceiver.setImage(null, null, null, null, ImageLocation.getForDocument(closestPhotoSizeWithSize, this.O), "80_80_b", null, this.O.size, null, f4Var2.E, 1);
                                            }
                                        } else {
                                            imageReceiver.setStrippedLocation(null);
                                        ...
                                        imageReceiver.setStrippedLocation(null);
                                        imageReceiver.setImage(null, null, ImageLocation.getForDocument(closestPhotoSizeWithSize, this.O), "80_80_b", 0L, null, f4Var2 != null ? f4Var2.E : null, 1);
                                    }
                                }
                    ...
                    if (i22 == 0) {
                        TL_iv.pageBlockVideo pageblockvideo2 = this.L;
                        a3 q6 = h4.q(this.a, this, null, pageblockvideo2.caption.text, dp, imageHeight3, pageblockvideo2, this.b);
                        this.c = q6;
                        if (q6 != null) {
                        ...
                        f4Var = f4Var2;
                        a3 p5 = h4.p(this.a, this, null, pageblockvideo3.caption.credit, dp, 0, pageblockvideo3, (f4Var2 == null || !f4Var2.G) ? Layout.Alignment.ALIGN_NORMAL : org.telegram.ui.Components.kw0.a(), 0, this.b);
                        this.d = p5;
                        if (p5 != null) {
                            i17 = this.d.d.getHeight() + AndroidUtilities.dp(4.0f) + i27;
                            a3 a3Var2 = this.d;
                            a3Var2.s = this.x;
                            a3Var2.v = this.y + this.E;
                        } else {
                            i17 = i27;
                        }
                    } else {
                    ...
                    if ((this.N instanceof TL_iv.pageBlockCover) && f4Var != null) {
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (visibility != 0 || y3 <= c1Var.getTranslationY() || y3 >= c1Var.getTranslationY() + AndroidUtilities.dp(39.0f)) {
            ...
            if (!this.H && this.J == 0) {
                if (!h4.l(this.a, this.b, motionEvent, this, this.c, this.x, this.y)) {
                    if (!h4.l(this.a, this.b, motionEvent, this, this.d, this.x, this.y + this.E) && !super.onTouchEvent(motionEvent)) {
                        return false;
                    }
                }
            }
