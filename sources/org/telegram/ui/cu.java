...
public final class cu extends org.telegram.ui.Components.za {
    ...
    public cu(Activity activity, HashSet hashSet) {
        ...
        LinearLayout f10 = org.telegram.messenger.y0.f(activity, 0);
    ...
    public static void Q(cu cuVar, TLObject tLObject, ci.d dVar, boolean z10, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (!(tLObject instanceof TLRPC.Updates)) {
            if (!(tLObject instanceof TL_phone.groupCall)) {
                if (tL_error != null) {
                    org.telegram.ui.Cells.q3.r(cuVar.topBulletinContainer, cuVar.resourcesProvider, tL_error, false);
                    return;
                }
                return;
            }
            ...
            cuVar.dismiss();
            org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, cuVar.currentAccount, tL_inputGroupCall, z10, groupcall.call, hashSet);
            return;
        }
        ...
        cuVar.dismiss();
        org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, cuVar.currentAccount, tL_inputGroupCall2, z10, groupCall2, hashSet);
    }
