...
public final class cu extends org.telegram.ui.Components.sa {
    ...
    public cu(Activity activity, HashSet hashSet) {
        ...
        org.telegram.ui.Components.f90 a2 = k7.f6.a(activity, 20.0f, i11, true, this.resourcesProvider);
        a2.setText(LocaleController.getString(R.string.GroupCallCreateTitle));
        a2.setGravity(17);
        h.addView(a2, k7.b6.t(-1, -2, 1, 2, 0, 2, 4));
        org.telegram.ui.Components.f90 a10 = k7.f6.a(activity, 14.0f, i11, false, this.resourcesProvider);
        ...
        rl0Var.setPadding(i14, 0, i14, AndroidUtilities.dp(76.0f));
    }
    ...
    public static void Q(cu cuVar, TLObject tLObject, ph.d dVar, boolean z4, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (!(tLObject instanceof TLRPC.Updates)) {
            ...
            cuVar.dismiss();
            org.telegram.ui.Components.voip.f2.g(LaunchActivity.D1, cuVar.currentAccount, tL_inputGroupCall, z4, groupcall.call, hashSet);
            return;
        }
        ...
        cuVar.dismiss();
        org.telegram.ui.Components.voip.f2.g(LaunchActivity.D1, cuVar.currentAccount, tL_inputGroupCall2, z4, groupCall2, hashSet);
    }
    ...
    public final void S(boolean z4) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(createconferencecall, new yd(this, dVar, z4, hashSet, 4));
    }
