...
public final class yw0 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float dp3 = AndroidUtilities.dp(24.0f) + AndroidUtilities.dp(premiumPreviewFragment.U.e.getVisibility() == 0 ? 24.0f : 16.0f) + (i10 - ((premiumPreviewFragment.U.getMeasuredHeight() + kVar3.getMeasuredHeight()) - premiumPreviewFragment.X));
        kVar4 = ((org.telegram.ui.ActionBar.n2) premiumPreviewFragment).actionBar;
        float max = Math.max((((((kVar4.getMeasuredHeight() - premiumPreviewFragment.X) - premiumPreviewFragment.U.a.getMeasuredHeight()) / 2.0f) + premiumPreviewFragment.X) - premiumPreviewFragment.U.getTop()) - premiumPreviewFragment.U.a.getTop(), dp3);
        ...
        premiumPreviewFragment.U.a.setTranslationX((1.0f - org.telegram.ui.Components.qr.h.getInterpolation(1.0f - (f15 > 0.3f ? (f15 - 0.3f) / 0.7f : 0.0f))) * dp5);
        jx0 jx0Var = premiumPreviewFragment.U;
        jx0Var.d.b.p = (((getMeasuredWidth() * 0.1f) * premiumPreviewFragment.b0) + (premiumPreviewFragment.U.c.getX() + jx0Var.getX())) / getMeasuredWidth();
        jx0 jx0Var2 = premiumPreviewFragment.U;
        jx0Var2.d.b.q = (premiumPreviewFragment.U.c.getY() + jx0Var2.getY()) / getMeasuredHeight();
        if (!premiumPreviewFragment.Z) {
            invalidate();
        ...
        if (z10) {
            ...
            r11 = 0;
            canvas2 = canvas;
            canvas2.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), z0Var.f);
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        jx0 jx0Var = premiumPreviewFragment.U;
        jx0Var.d.b.p = (premiumPreviewFragment.U.d.getX() + jx0Var.getX()) / getMeasuredWidth();
        jx0 jx0Var2 = premiumPreviewFragment.U;
        jx0Var2.d.b.q = (premiumPreviewFragment.U.d.getY() + jx0Var2.getY()) / getMeasuredHeight();
    }
