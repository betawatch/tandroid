...
public final class be1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public be1(org.telegram.ui.ActionBar.h6 h6Var, org.telegram.ui.ActionBar.g6 g6Var, boolean z10) {
        ...
        this.J = h6Var;
        this.K = g6Var;
        this.L = g6Var != null ? g6Var.r : h6Var.F;
        this.currentAccount = g6Var != null ? g6Var.t : h6Var.E;
        this.I = z10;
    }
    ...
    public static void Y(be1 be1Var) {
        ...
        if (be1Var.Z(be1Var.a.getText().toString(), true) && be1Var.getParentActivity() != null) {
            ...
            if (be1Var.I) {
                ...
                tL_theme.title = obj;
                h6Var.a = obj;
                h6Var.F.slug = be1Var.a.getText().toString();
    ...
    public final boolean Z(String str, boolean z10) {
        ...
        if (str != null) {
            if (str.startsWith("_") || str.endsWith("_")) {
                a0(org.telegram.ui.ActionBar.i6.p7, LocaleController.getString(R.string.SetUrlInvalid));
                return false;
            }
            for (int i10 = 0; i10 < str.length(); i10++) {
                ...
                if (i10 == 0 && charAt >= '0' && charAt <= '9') {
                    ...
                    a0(org.telegram.ui.ActionBar.i6.p7, LocaleController.getString(R.string.SetUrlInvalidStartNumber));
                    return false;
                }
        ...
        if (str == null || str.length() < 5) {
            ...
            a0(org.telegram.ui.ActionBar.i6.p7, LocaleController.getString(R.string.SetUrlInvalidShort));
            return false;
        }
        if (str.length() > 64) {
            if (z10) {
            ...
            a0(org.telegram.ui.ActionBar.i6.p7, LocaleController.getString(R.string.SetUrlInvalidLong));
            return false;
        }
        if (!z10) {
            ...
            if (str.equals(str2)) {
                a0(org.telegram.ui.ActionBar.i6.w6, LocaleController.formatString("SetUrlAvailable", R.string.SetUrlAvailable, str));
                return true;
            }
    ...
    public final void a0(int i10, String str) {
        ...
        if (isEmpty) {
            ...
            if (z10) {
                this.d.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.i6.b7));
                return;
            } else {
                this.d.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.b7));
                return;
            }
        }
        ...
        if (z10) {
            this.d.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(getParentActivity(), R.drawable.greydivider_top, org.telegram.ui.ActionBar.i6.b7));
        } else {
    ...
    public final View createView(Context context) {
        ...
        this.s = knVar;
        this.x.addView(knVar, new LinearLayout.LayoutParams(-1, 1));
        ...
        this.w.setHintTextColor(org.telegram.ui.ActionBar.i6.w0(null, i12, false));
        this.w.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
        ...
        int i15 = org.telegram.ui.ActionBar.i6.b7;
        e9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, i14, i15));
        this.e.setVisibility(8);
        ...
        if (z10) {
            this.d.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider, i15));
            ...
            this.n.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, i15));
            linearLayout2.addView(this.n, w7.x5.n(-1, -2));
        } else {
            this.d.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, i15));
        }
        TLRPC.TL_theme tL_theme = this.L;
        if (tL_theme != null) {
            this.G = true;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (h6Var2 == h6Var && g6Var2 == g6Var && (b2Var2 = this.r) != null) {
                try {
                    b2Var2.dismiss();
                    this.r = null;
                } catch (Exception e) {
        ...
        if (i10 == NotificationCenter.themeUploadError) {
            ...
            if (h6Var3 == h6Var && g6Var3 == g6Var && (b2Var = this.r) != null) {
                try {
                    b2Var.dismiss();
                    this.r = null;
                } catch (Exception e7) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i11));
        int i12 = org.telegram.ui.ActionBar.i6.B6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.e, 262144, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.p7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.e, 262144, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.w6));
        int i13 = org.telegram.ui.ActionBar.i6.G6;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.h, TLObject.FLAG_28, null, null, null, null, org.telegram.ui.ActionBar.i6.i6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.h, TLObject.FLAG_28, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.a, 4, null, null, null, null, i13));
        EditTextBoldCursor editTextBoldCursor = this.a;
        int i14 = org.telegram.ui.ActionBar.i6.H6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(editTextBoldCursor, TLObject.FLAG_23, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.a, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.k6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.a, 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.l6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.a, 4, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.a, TLObject.FLAG_23, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.a, 16777216, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.b, 4, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.b, TLObject.FLAG_23, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.b, 16777216, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.w, 4, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.w, TLObject.FLAG_23, null, null, null, null, i14));
        org.telegram.ui.Components.kn knVar = this.s;
        Paint paint = org.telegram.ui.ActionBar.i6.k0;
        int i15 = org.telegram.ui.ActionBar.i6.d7;
        arrayList.add(new org.telegram.ui.ActionBar.k6(knVar, 0, null, paint, null, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.s, 1, null, org.telegram.ui.ActionBar.i6.k0, null, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.m3, org.telegram.ui.ActionBar.i6.q3}, null, org.telegram.ui.ActionBar.i6.ra));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.n3, org.telegram.ui.ActionBar.i6.r3}, null, org.telegram.ui.ActionBar.i6.dc));
        org.telegram.ui.Cells.ja jaVar = this.f;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, org.telegram.ui.ActionBar.i6.q3.y, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.o3, org.telegram.ui.ActionBar.i6.s3}, null, org.telegram.ui.ActionBar.i6.Aa));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.o3, org.telegram.ui.ActionBar.i6.s3}, null, org.telegram.ui.ActionBar.i6.Da));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.o3, org.telegram.ui.ActionBar.i6.s3}, null, org.telegram.ui.ActionBar.i6.Ea));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.o3, org.telegram.ui.ActionBar.i6.s3}, null, org.telegram.ui.ActionBar.i6.Fa));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.p3, org.telegram.ui.ActionBar.i6.t3}, null, org.telegram.ui.ActionBar.i6.Ba));
        org.telegram.ui.Cells.ja jaVar2 = this.f;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, org.telegram.ui.ActionBar.i6.s3.y, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.ec));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.fc));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.y3}, null, org.telegram.ui.ActionBar.i6.Ja));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.z3}, null, org.telegram.ui.ActionBar.i6.Ka));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.A3, org.telegram.ui.ActionBar.i6.C3}, null, org.telegram.ui.ActionBar.i6.La));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.B3, org.telegram.ui.ActionBar.i6.D3}, null, org.telegram.ui.ActionBar.i6.Ma));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, new Drawable[]{org.telegram.ui.ActionBar.i6.F3, org.telegram.ui.ActionBar.i6.G3}, null, org.telegram.ui.ActionBar.i6.sc));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.Uc));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.ab));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.Wc));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.cb));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.Yc));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.db));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.ad));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.fb));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.nd));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.sb));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.od));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.nb));
        return arrayList;
    }
