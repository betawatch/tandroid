...
public final /* synthetic */ class d6 implements Runnable {
    ...
    public /* synthetic */ d6(z6 z6Var, int i10) {
        this.a = i10;
        this.b = z6Var;
    }
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < longSparseArray.size(); i10++) {
                    ...
                    arrayList.add(s6Var);
                    if (z6Var2.getMessagesController().getUserOrChat(((s6) arrayList.get(i10)).a) == null) {
                        long j3 = s6Var.a;
                        if (j3 > 0) {
            ...
            default:
                z6 z6Var3 = this.b;
                z6Var3.f = z6.q0(5, FileLoader.checkDirectory(4));
                if (!z6.l0) {
                    z6Var3.n = z6.q0(4, FileLoader.checkDirectory(4));
                    if (!z6.l0) {
                        long q02 = z6.q0(0, FileLoader.checkDirectory(0));
                        z6Var3.x = q02;
                        z6Var3.x = z6.q0(0, FileLoader.checkDirectory(100)) + q02;
                        if (!z6.l0) {
                            long q03 = z6.q0(0, FileLoader.checkDirectory(2));
                            z6Var3.y = q03;
                            z6Var3.y = z6.q0(0, FileLoader.checkDirectory(101)) + q03;
                            if (!z6.l0) {
                                ...
                                if (!z6.l0) {
                                    ...
                                    z6Var3.r = q05;
                                    z6Var3.r = z6.q0(1, FileLoader.checkDirectory(5)) + q05;
                                    if (!z6.l0) {
                                        long q06 = z6.q0(2, FileLoader.checkDirectory(3));
                                        z6Var3.w = q06;
                                        z6Var3.w = z6.q0(2, FileLoader.checkDirectory(5)) + q06;
                                        if (!z6.l0) {
                                            z6Var3.F = z6.q0(0, new File(FileLoader.checkDirectory(4), "acache"));
                                            if (!z6.l0) {
                                                z6Var3.h = z6.q0(3, FileLoader.checkDirectory(4));
                                                if (!z6.l0) {
                                                    z6Var3.F += z6Var3.h;
                                                    z6Var3.s = z6.q0(0, FileLoader.checkDirectory(1));
                                                    z6Var3.v = z6.q0(0, FileLoader.checkDirectory(6));
                                                    if (!z6.l0) {
                                                        long j10 = z6Var3.f + z6Var3.n + z6Var3.y + z6Var3.E + z6Var3.s + z6Var3.x + z6Var3.r + z6Var3.w + z6Var3.v + z6Var3.F;
                                                        z6.n0 = Long.valueOf(j10);
                                                        z6Var3.G = j10;
                                                        ...
                                                        try {
                                                            ...
                                                            z6Var3.H = statFs.getBlockCountLong() * blockSizeLong;
                                                            z6Var3.I = availableBlocksLong * blockSizeLong;
                                                        } catch (Exception e) {
                                                            FileLog.e(e);
                                                        }
                                                        AndroidUtilities.runOnUIThread(new d6(z6Var3, 0));
                                                        z6Var3.getFileLoader().getFileDatabase().getQueue().postRunnable(new d6(z6Var3, 1));
                                                        break;
                                                    }
                                                }
                                            }
