...
public final /* synthetic */ class n90 implements Runnable {
    ...
    public /* synthetic */ n90(LaunchActivity launchActivity, Bundle bundle, Long l4, int[] iArr, ma0 ma0Var, boolean z10, nf.e eVar, Long l10, Integer num, Integer num2, byte[] bArr, org.telegram.ui.ActionBar.n2 n2Var, int i10) {
        ...
        switch (i10) {
            ...
            default:
                ...
                if (!((ActionBarLayout) O).P(new bo(bundle2))) {
                    ...
                    iArr[0] = ConnectionsManager.getInstance(launchActivity2.O).sendRequest(tL_channels_getChannels, new org.telegram.messenger.h1(launchActivity2, this.e, this.f, l11, this.h, this.n, this.r, this.s, this.v, this.w, this.x, bundle2));
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ n90(LaunchActivity launchActivity, ma0 ma0Var, TLObject tLObject, boolean z10, Long l4, nf.e eVar, Long l10, Integer num, Integer num2, byte[] bArr, org.telegram.ui.ActionBar.n2 n2Var, int i10, Bundle bundle) {
        this.b = launchActivity;
        this.e = ma0Var;
        this.y = tLObject;
        this.f = z10;
