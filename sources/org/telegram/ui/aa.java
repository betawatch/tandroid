    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i11) {
                ...
                if (tL_error != null) {
                    if (!"USERNAME_NOT_MODIFIED".equals(tL_error.text)) {
                        if (!"USERNAME_PURCHASE_AVAILABLE".equals(tL_error.text) && !"USERNAME_INVALID".equals(tL_error.text)) {
                            AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.l5((Object) qaVar, (Object) a2Var, (Object) tL_error, (Object) updateusername, 4));
                            break;
                        } else {
            ...
            case 2:
                ...
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new org.telegram.ui.ActionBar.l5(obj3, obj2, tLObject, obj, 6));
                break;
            case 4:
                wn wnVar = (wn) obj3;
                long[] jArr = (long[]) obj;
                AndroidUtilities.cancelRunOnUIThread((org.telegram.ui.ActionBar.l5) obj2);
                wnVar.d5.messageOwner.voiceTranscriptionRated = true;
                wnVar.getMessagesStorage().updateMessageVoiceTranscriptionOpen(wnVar.d5.getDialogId(), wnVar.d5.getId(), wnVar.d5.messageOwner);
                AndroidUtilities.runOnUIThread(new rg(wnVar, 17), jArr[0] > 0 ? Math.max(0L, 300 - (SystemClock.elapsedRealtime() - jArr[0])) : 0L);
                break;
            case 5:
                wn wnVar2 = (wn) obj3;
                    ...
                    while (true) {
                        if (i14 < updates.updates.size()) {
                            ...
                            if (update instanceof TL_update.TL_updateGroupCall) {
                                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.vn0(d60Var, chat, inputPeer, (TL_update.TL_updateGroupCall) update, 7));
                            } else {
                                i14++;
                            }
                        }
            ...
            case 14:
                ...
                if (Objects.equals(n70Var.h, (String) obj2) && (tLObject instanceof TLRPC.TL_messages_foundStickerSets)) {
                    ...
                    i10 = ((org.telegram.ui.ActionBar.m2) o70Var).currentAccount;
                    ...
                    AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.vn0(n70Var, arrayList, arrayList3, str, 12));
                    break;
                }
                break;
            case 15:
                Pattern pattern = LaunchActivity.B1;
                AndroidUtilities.runOnUIThread(new c90(obj3, tLObject, obj, obj2, tL_error, 2));
                break;
            case 16:
            ...
            case 19:
                ...
                break;
            case 20:
                AndroidUtilities.runOnUIThread(new c90((KeyEvent.Callback) obj3, tLObject, obj2, tL_error, (TLObject) obj, 6));
                break;
            case 21:
                AndroidUtilities.runOnUIThread(new c90((KeyEvent.Callback) obj3, tLObject, obj2, tL_error, (TLObject) obj, 8));
                break;
            case 22:
                AndroidUtilities.runOnUIThread(new c90((KeyEvent.Callback) obj3, tLObject, obj2, tL_error, (TLObject) obj, 7));
                break;
            case 23:
            ...
            case 25:
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.vn0(bj0Var, bVar, str4, ra1Var, 24));
                break;
            case 26:
                ...
                break;
            case 27:
                AndroidUtilities.runOnUIThread(new c90(obj3, tL_error, obj2, (Object) tLObject, obj, 13));
                break;
            case 28:
                AndroidUtilities.runOnUIThread(new c90(obj3, tL_error, tLObject, obj2, obj, 14));
                break;
            default:
                oo0 oo0Var = (oo0) obj3;
                xi0 xi0Var = (xi0) obj2;
