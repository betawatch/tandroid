...
public final class ur extends Drawable {
    ...
    public ur(Context context, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        Path path = new Path();
        this.i = path;
        this.m = new org.telegram.ui.Components.z5(new zi(this, 12), 320L, org.telegram.ui.Components.pr.h, 0);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (e6 > 0.0f) {
            canvas2.save();
            int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Oh, this.a);
            int i12 = this.k;
