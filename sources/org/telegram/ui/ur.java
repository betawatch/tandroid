...
public final class ur extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public int A0;
    public long A1;
    public int B0;
    public boolean B1;
    ...
    public static /* synthetic */ void U(ur urVar, long j3) {
        if (j3 != 0) {
            urVar.N = j3;
            urVar.r = MessagesController.getInstance(urVar.currentAccount).getChat(Long.valueOf(j3));
            urVar.u0();
        }
    }
    ...
    */
    public static void V(final ur urVar, View view, int i10) {
        ...
        i14 = 0;
        final int i15 = 1;
        boolean z15 = urVar.c.getAdapter() == urVar.a;
        if (i10 == urVar.h1) {
            boolean z16 = !urVar.v1;
            urVar.v1 = z16;
            ...
            urVar.A0(w02);
            urVar.a.m(urVar.j1);
        } else if (i10 == urVar.i1) {
            boolean z17 = !urVar.w1;
            urVar.w1 = z17;
            ...
            urVar.A0(w03);
            urVar.a.m(urVar.j1);
        } else if (i10 == urVar.n0) {
            boolean z18 = !urVar.y1;
            urVar.y1 = z18;
            ...
            if (urVar.p0(i10)) {
                ...
                if (i10 == urVar.V) {
                    urVar.E.send_photos = !r15.send_photos;
                } else if (i10 == urVar.W) {
                    urVar.E.send_videos = !r14.send_videos;
                } else if (i10 == urVar.X) {
                    ...
                    urVar.E.send_audios = !r14.send_audios;
                } else if (i10 == urVar.Z) {
                    urVar.E.send_docs = !r14.send_docs;
                } else if (i10 == urVar.a0) {
                    urVar.E.send_voices = !r14.send_voices;
                } else if (i10 == urVar.b0) {
                    urVar.E.send_roundvideos = !r14.send_roundvideos;
                } else if (i10 == urVar.c0) {
                    if (urVar.E.send_plain && (m10 = urVar.d.m(urVar.T)) != null) {
                        AndroidUtilities.shakeViewSpring(m10);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        urVar.E.embed_links = !r14.embed_links;
                    }
                } else if (i10 == urVar.d0) {
                    urVar.E.send_polls = !r14.send_polls;
                } else if (i10 == urVar.k0) {
                    urVar.E.send_reactions = !r14.send_reactions;
                }
                ...
                if (i10 == urVar.z0) {
                    if (i13 == 0 || i13 == 3) {
                        ...
                        ur urVar2 = new ur(bundle);
                        urVar2.x0(urVar.s);
                        TLRPC.TL_chatBannedRights tL_chatBannedRights3 = urVar.E;
                        if (tL_chatBannedRights3 != null) {
                            urVar2.E = tL_chatBannedRights3;
                        }
                        urVar2.m1 = new ir(urVar);
                        urVar.presentFragment(urVar2);
                        return;
                    }
                    if (i13 == 1) {
                        Bundle bundle2 = new Bundle();
                        bundle2.putLong("chat_id", urVar.N);
                        bundle2.putInt(TeXSymbolParser.TYPE_ATTR, 2);
                        bundle2.putInt("selectType", 1);
                        ur urVar3 = new ur(bundle2);
                        urVar3.m1 = new jr(urVar);
                        urVar3.x0(urVar.s);
                        urVar.presentFragment(urVar3);
                        return;
                    }
                    if (i13 == 2) {
                        Bundle i16 = a4.a.i("addToGroup", true);
                        i16.putLong(z14 ? "channelId" : "chatId", urVar.r.id);
                        ...
                        e70Var.J = iVar;
                        e70Var.x = new lr(urVar, e70Var);
                        urVar.presentFragment(e70Var);
                        return;
                    }
                    return;
                }
                if (i10 == urVar.v0) {
                    urVar.presentFragment(new ub(urVar.r));
                    return;
                }
                if (i10 == urVar.x0) {
                    final org.telegram.ui.Cells.r8 r8Var = (org.telegram.ui.Cells.r8) view;
                    TLRPC.ChatFull chatFull3 = urVar.s;
                    if (chatFull3 != null && !chatFull3.antispam && urVar.l0() < urVar.getMessagesController().telegramAntispamGroupSizeMin) {
                        org.telegram.ui.Components.vc.a0(urVar).Q(R.raw.msg_antispam, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelAntiSpamForbidden", urVar.getMessagesController().telegramAntispamGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (urVar.s == null || !ChatObject.canUserDoAdminAction(urVar.r, 13) || urVar.w0) {
                        return;
                    }
                    urVar.w0 = true;
                    final boolean z21 = urVar.s.antispam;
                    TLRPC.TL_channels_toggleAntiSpam tL_channels_toggleAntiSpam = new TLRPC.TL_channels_toggleAntiSpam();
                    tL_channels_toggleAntiSpam.channel = urVar.getMessagesController().getInputChannel(urVar.N);
                    ...
                    urVar.getConnectionsManager().sendRequest(tL_channels_toggleAntiSpam, new RequestDelegate(urVar) { // from class: org.telegram.ui.tq
                        ...
                        public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                            switch (i14) {
                                case 0:
                                    final ur urVar4 = this.b;
                                    if (tLObject3 != null) {
                                        urVar4.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        urVar4.getMessagesController().putChatFull(urVar4.s);
                                    }
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.wq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        ur urVar5 = urVar4;
                                                        if (urVar5.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = urVar5.s;
                                                            boolean z24 = z23;
                                                            chatFull7.antispam = z24;
                                                            org.telegram.ui.Cells.r8 r8Var3 = r8Var2;
                                                            r8Var3.setChecked(z24);
                                                            r8Var3.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(urVar5.r, 13) || ((chatFull5 = urVar5.s) != null && chatFull5.antispam && urVar5.l0() < urVar5.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.vc.a0(urVar5).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                                                        ur urVar6 = urVar4;
                                                        if (urVar6.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull8 = urVar6.s;
                                                            boolean z25 = z23;
                                                            chatFull8.participants_hidden = z25;
                                                            org.telegram.ui.Cells.r8 r8Var4 = r8Var2;
                                                            r8Var4.setChecked(z25);
                                                            r8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(urVar6.r, 2) || ((chatFull6 = urVar6.s) != null && chatFull6.participants_hidden && urVar6.l0() < urVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.vc.a0(urVar6).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                }
                                    ...
                                    break;
                                default:
                                    final ur urVar5 = this.b;
                                    if (tLObject3 != null) {
                                        urVar5.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        urVar5.getMessagesController().putChatFull(urVar5.s);
                                    }
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i18 = 1;
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.wq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i18) {
                                                    case 0:
                                                        ur urVar52 = urVar5;
                                                        if (urVar52.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = urVar52.s;
                                                            boolean z242 = z24;
                                                            chatFull7.antispam = z242;
                                                            org.telegram.ui.Cells.r8 r8Var32 = r8Var3;
                                                            r8Var32.setChecked(z242);
                                                            r8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(urVar52.r, 13) || ((chatFull5 = urVar52.s) != null && chatFull5.antispam && urVar52.l0() < urVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.vc.a0(urVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                ...
                if (i10 == urVar.J0) {
                    ...
                    if (urVar.l0() < urVar.getMessagesController().hiddenMembersGroupSizeMin) {
                        org.telegram.ui.Components.vc.a0(urVar).Q(R.raw.contacts_sync_off, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelHiddenMembersForbidden", urVar.getMessagesController().hiddenMembersGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (urVar.s == null || !ChatObject.canUserDoAdminAction(urVar.r, 2) || urVar.I0) {
                        return;
                    }
                    urVar.I0 = true;
                    final boolean z23 = urVar.s.participants_hidden;
                    ...
                    tL_channels_toggleParticipantsHidden.channel = urVar.getMessagesController().getInputChannel(urVar.N);
                    ...
                    if (!ChatObject.canUserDoAdminAction(urVar.r, 2) || ((chatFull = urVar.s) != null && !chatFull.participants_hidden && urVar.l0() < urVar.getMessagesController().hiddenMembersGroupSizeMin)) {
                        i14 = R.drawable.permission_locked;
                    }
                    checkBox.setIcon(i14);
                    urVar.getConnectionsManager().sendRequest(tL_channels_toggleParticipantsHidden, new RequestDelegate(urVar) { // from class: org.telegram.ui.tq
                        public final /* synthetic */ ur b;
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        ...
                                                        if (urVar52.getParentActivity() != null) {
                                                            ...
                                                            r8Var32.setChecked(z242);
                                                            r8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(urVar52.r, 13) || ((chatFull52 = urVar52.s) != null && chatFull52.antispam && urVar52.l0() < urVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.vc.a0(urVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                ...
                if (i10 == urVar.L0) {
                    ...
                    tL_messages_editChatDefaultBannedRights.peer = MessagesController.getInputPeer(urVar.r);
                    TLRPC.Chat chat = urVar.r;
                    if (chat.default_banned_rights == null) {
                        chat.default_banned_rights = new TLRPC.TL_chatBannedRights();
                    }
                    TLRPC.TL_chatBannedRights tL_chatBannedRights4 = urVar.r.default_banned_rights;
                    tL_messages_editChatDefaultBannedRights.banned_rights = tL_chatBannedRights4;
                    tL_chatBannedRights4.edit_rank = !r8Var3.b();
                    urVar.getConnectionsManager().sendRequestTyped(tL_messages_editChatDefaultBannedRights, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.uq
                        ...
                        public final void run(Object obj, Object obj2) {
                            ...
                            ur urVar4 = ur.this;
                            if (updates != null) {
                                urVar4.getMessagesController().processUpdates(updates, false);
                                return;
                            }
                            urVar4.getClass();
                            if (tL_error != null) {
                                r8Var3.setChecked(b10);
                                org.telegram.ui.Components.vc.a0(urVar4).d0(tL_error, false);
                            }
                        }
                    });
                } else {
                    if (i10 == urVar.B0) {
                        ...
                        bundle3.putLong("chat_id", urVar.N);
                        bundle3.putInt(TeXSymbolParser.TYPE_ATTR, 0);
                        ur urVar4 = new ur(bundle3);
                        urVar4.x0(urVar.s);
                        urVar.presentFragment(urVar4);
                        return;
                    }
                    if (i10 == urVar.t0) {
                        urVar.showDialog(new mr(urVar, urVar.getParentActivity(), urVar));
                    } else {
                        if (i10 == urVar.A0) {
                            if (urVar.s != null) {
                                yh0 yh0Var = new yh0(urVar.N, 0L, 0);
                                TLRPC.ChatFull chatFull6 = urVar.s;
                                yh0Var.g0(chatFull6, chatFull6.exported_invite);
                                urVar.presentFragment(yh0Var);
                                return;
                            }
                            return;
                        }
                        if ((i10 > urVar.S && i10 <= Math.max(urVar.l0, urVar.g0)) || i10 == urVar.m0) {
                            org.telegram.ui.Cells.v8 v8Var2 = (org.telegram.ui.Cells.v8) view;
                            boolean isEnabled = v8Var2.isEnabled();
                            Switch r42 = v8Var2.d;
                            if (isEnabled) {
                                if (r42.F != null) {
                                    if (ChatObject.isPublic(urVar.r) && (i10 == urVar.i0 || i10 == urVar.g0)) {
                                        org.telegram.messenger.y0.p(R.string.EditCantEditPermissionsPublic, org.telegram.ui.Components.vc.a0(urVar), null);
                                        return;
                                    } else if (ChatObject.isDiscussionGroup(urVar.currentAccount, urVar.N) && (i10 == urVar.i0 || i10 == urVar.g0)) {
                                        org.telegram.messenger.y0.p(R.string.EditCantEditPermissionsDiscussion, org.telegram.ui.Components.vc.a0(urVar), null);
                                        return;
                                    } else {
                                        org.telegram.ui.Components.vc.a0(urVar).t(LocaleController.getString("EditCantEditPermissions", R.string.EditCantEditPermissions), null).j();
                                        return;
                                    }
                                }
                                if (i10 == urVar.U) {
                                ...
                                if (i10 == urVar.g0) {
                                    urVar.E.change_info = !r0.change_info;
                                    return;
                                }
                                if (i10 == urVar.m0) {
                                    urVar.E.manage_linked_peers = !r0.manage_linked_peers;
                                    return;
                                }
                                if (i10 == urVar.h0) {
                                    urVar.E.invite_users = !r0.invite_users;
                                    return;
                                }
                                if (i10 == urVar.l0) {
                                    urVar.E.manage_topics = !r0.manage_topics;
                                    return;
                                }
                                if (i10 == urVar.i0) {
                                    urVar.E.pin_messages = !r0.pin_messages;
                                    return;
                                }
                                if (i10 == urVar.j0) {
                                    urVar.E.edit_rank = !r0.edit_rank;
                                    return;
                                }
                                if (i10 == urVar.T) {
                                    urVar.E.send_plain = !r1.send_plain;
                                    int i17 = urVar.c0;
                                    if (i17 >= 0) {
                                        urVar.a.m(i17);
                                    }
                                ...
                                if (i10 == urVar.e0) {
                                    TLRPC.TL_chatBannedRights tL_chatBannedRights5 = urVar.E;
                                ...
                                if (i10 == urVar.f0) {
                                    urVar.E.embed_links = !r0.embed_links;
                                    return;
                                } else {
                                    if (i10 == urVar.d0) {
                                        urVar.E.send_polls = !r0.send_polls;
                                        return;
                                    }
                                    return;
                                }
                ...
                if (z15) {
                    TLObject E = urVar.e.E(i10);
                    if (E instanceof TLRPC.User) {
                        TLRPC.User user = (TLRPC.User) E;
                        urVar.getMessagesController().putUser(user, false);
                        long j12 = user.id;
                        int i19 = 0;
                        while (true) {
                            if (i19 >= 3) {
                            ...
                            tLObject2 = (TLObject) (i19 == 0 ? iVar2 : i19 == 1 ? urVar.L : iVar).f(j12);
                            if (tLObject2 != null) {
                                break;
                            } else {
                                i19++;
                    ...
                    if (E2 instanceof TLRPC.User) {
                        ...
                        if (i12 != 0) {
                            ...
                            if (i12 != 3 && i12 != 1) {
                                if (ChatObject.isChannel(urVar.r)) {
                                    urVar.getMessagesController().deleteParticipantFromChat(urVar.N, urVar.getMessagesController().getUser(Long.valueOf(j10)));
                                    nr nrVar = urVar.m1;
                                    if (nrVar != null) {
                                        nrVar.d(j10);
                                    }
                            ...
                            if (i12 == 1) {
                                ...
                                if (!z11) {
                                    ...
                                    z13 = z11;
                                    i20 = 1;
                                    urVar.t0(j11, tLObject, tL_chatAdminRights, tL_chatBannedRights, str2, z13, i12 != i20 ? 0 : 1, i12 != i20 || i12 == 3);
                                    return;
                                }
                                if ((tLObject instanceof TLRPC.TL_channelParticipantAdmin) || (tLObject instanceof TLRPC.TL_chatParticipantAdmin)) {
                                    TLRPC.User user2 = urVar.getMessagesController().getUser(Long.valueOf(j10));
                                    ...
                                    alertDialog$Builder.k(LocaleController.getString("OK", R.string.OK), new vq(urVar, user2, tLObject, tL_chatAdminRights, tL_chatBannedRights, str, z11));
                                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                                    urVar.showDialog(b2Var);
                                    return;
                                }
                                j11 = j10;
                                str2 = str;
                        ...
                        boolean z27 = z11;
                        if (i13 == 1) {
                            canBlockUsers = j14 != urVar.getUserConfig().getClientUserId() && (urVar.r.creator || z27);
                        } else {
                            if (i13 != 0 && i13 != 3) {
                                z12 = false;
                                if (i13 != 0 || ((i13 != 1 && z10) || (i13 == 2 && i12 == 0))) {
                                    if (j14 != urVar.getUserConfig().getClientUserId()) {
                                        return;
                                    }
                                    ...
                                    urVar.presentFragment(new ProfileActivity(bundle4, null));
                                    return;
                                }
                                ...
                                pq pqVar = new pq(j14, urVar.N, tL_chatAdminRights, urVar.E, tL_chatBannedRights, str, i13 == i11 ? 0 : 1, z12, tLObject == null, null);
                                pqVar.X0 = new ar(urVar, tLObject);
                                urVar.presentFragment(pqVar);
                                return;
                            }
                            canBlockUsers = ChatObject.canBlockUsers(urVar.r);
                        }
                        z12 = canBlockUsers;
                        if (i13 != 0) {
                        }
    ...
    public static void W(ur urVar, TLRPC.ChannelParticipant channelParticipant, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights) {
        int i10 = 0;
        while (i10 < 3) {
            TLObject tLObject = (TLObject) (i10 == 0 ? urVar.M : i10 == 1 ? urVar.L : urVar.K).f(MessageObject.getPeerId(channelParticipant.peer));
    ...
    public static void c0(ur urVar, TLRPC.User user) {
        ...
        UndoView undoView = urVar.n;
        long j3 = -urVar.N;
        boolean z12 = urVar.v;
        undoView.m(j3, user, z12 ? 9 : 10);
        urVar.r.creator = false;
        int i10 = 0;
        boolean z13 = false;
        while (i10 < 3) {
            boolean z14 = true;
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        org.telegram.ui.Components.yw0 yw0Var = new org.telegram.ui.Components.yw0(context, frameLayout3, 1, null);
        this.b = yw0Var;
        ...
        this.c.setOnItemClickListener(new sq(this, 3));
        this.c.setOnItemLongClickListener(new sq(this, 4));
        if (this.f != null) {
            this.c.setOnScrollListener(new h3(this, 7));
        }
    ...
    */
    public final boolean g0(boolean z10) {
        if (!this.P) {
            ...
            if (z10) {
                ...
                alertDialog$Builder.k(LocaleController.getString("ApplyTheme", R.string.ApplyTheme), new sq(this, 1));
                alertDialog$Builder.h(LocaleController.getString("PassportDiscard", R.string.PassportDiscard), new sq(this, 2));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 16, new Class[]{org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.b5.class, org.telegram.ui.Cells.y4.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Components.tv0.class}, null, null, null, org.telegram.ui.ActionBar.i6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.v3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f7));
        int i11 = org.telegram.ui.ActionBar.i6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.i6.y6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.i6.n6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.Fi));
        int i13 = org.telegram.ui.ActionBar.i6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.i6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.n, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 262144, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Components.yw0.class}, new String[]{"title"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.c, 0, new Class[]{org.telegram.ui.Components.yw0.class}, new String[]{"subtitle"}, null, null, -1, null, i11));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        if (i13 != 2) {
            ...
            if (i13 == 3 && ChatObject.canBlockUsers(this.r)) {
                urVar = this;
                H.c(R.drawable.msg_permissions, LocaleController.getString(R.string.ChannelEditPermissions), new org.telegram.messenger.voip.f(urVar, j12, (TLObject) tL_chatBannedRights, str, tLObject, 1), false);
                final int i14 = 0;
                H.c(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), new Runnable(urVar) { // from class: org.telegram.ui.rq
                    public final /* synthetic */ ur b;
                    ...
                    public final void run() {
                        switch (i14) {
                            ...
                            case 1:
                                ...
                                long j13 = j12;
                                urVar2.i0(j13);
                                urVar2.getMessagesController().addUserToChat(urVar2.N, urVar2.getMessagesController().getUser(Long.valueOf(j13)), 0, null, urVar2, null);
                                break;
                            case 2:
                                this.b.i0(j12);
                                break;
                            default:
                                ...
                                long j15 = j12;
                                messagesController.setUserAdminRole(j14, messagesController2.getUser(Long.valueOf(j15)), new TLRPC.TL_chatAdminRights(), "", !urVar3.v, urVar3, false, false, null, null);
                                urVar3.v0(j15);
                                break;
                        }
                    }
                ...
                String str3 = str;
                urVar = this;
                if (i13 == 0 && ChatObject.canBlockUsers(urVar.r)) {
                    if (ChatObject.canAddUsers(urVar.r) && j3 > 0 && !ChatObject.isCommunity(urVar.r)) {
                        final int i15 = 1;
                        H.c(R.drawable.msg_contact_add, LocaleController.getString(z15 ? R.string.ChannelAddToChannel : R.string.ChannelAddToGroup), new Runnable(urVar) { // from class: org.telegram.ui.rq
                            public final /* synthetic */ ur b;
                ...
                } else if (i13 == 1 && ChatObject.canAddAdmins(urVar.r) && z11) {
                    if (urVar.r.creator || !(tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                        j10 = j12;
                        H.c(R.drawable.msg_admins, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), new org.telegram.messenger.voip.f(urVar, j10, (TLObject) tL_chatAdminRights2, str3, tLObject, 2), false);
                    } else {
                        j10 = j12;
                    }
                    final int i17 = 3;
                    H.c(R.drawable.msg_remove, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), new Runnable(urVar) { // from class: org.telegram.ui.rq
                        public final /* synthetic */ ur b;
        ...
        boolean z22 = z20;
        zq zqVar = new zq(this, j11, i11, tLObject, tL_chatAdminRights, tL_chatBannedRights2, str, z13);
        long j13 = j11;
        org.telegram.ui.Components.n70 H2 = org.telegram.ui.Components.n70.H(this, view);
        H2.W(this.c.V0(view, false));
        H2.l(R.drawable.msg_admins, LocaleController.getString(z19 ? R.string.EditAdminRights : R.string.SetAsAdmin), new dj(zqVar, 11), z12);
        H2.l(R.drawable.msg_permissions, LocaleController.getString("ChangePermissions", R.string.ChangePermissions), new org.telegram.ui.ActionBar.n5((org.telegram.ui.ActionBar.n2) this, tLObject, (TLObject) user, (Object) zqVar, 13), z22);
    ...
    public final void onResume() {
        ...
        org.telegram.ui.Components.yw0 yw0Var = this.b;
        if (yw0Var != null) {
            yw0Var.requestLayout();
        }
    }
    ...
    public final void r0() {
        ...
        if (ChatObject.isChannel(this.r)) {
            ...
            for (int i14 = 0; i14 < s02.size(); i14++) {
                arrayList6.add(null);
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest((TLObject) s02.get(i14), new ai.ya(arrayList6, i14, atomicInteger, s02, xqVar)), this.classGuid);
            }
            return;
        }
        this.Q = false;
    ...
    public final void t0(long j3, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z10, int i10, boolean z11) {
        pq pqVar = new pq(j3, this.N, tL_chatAdminRights, this.E, tL_chatBannedRights, str, i10, z10, tLObject == null, null);
    ...
    */
    public final void u0() {
        ...
        if (i10 == 3) {
            ...
            if (chat.creator && !ChatObject.isChannel(chat) && ((this.p1 != this.q1 || this.y1) && this.s != null)) {
                MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.N, this, new sq(this, 0));
                return;
            }
            ...
            if (z11 != this.x1 || (z11 && this.z1 != this.A1)) {
                ...
                getConnectionsManager().sendRequest(updatepaidmessagesprice, new ai.t7(11));
    ...
    public final or w0() {
        ...
        orVar.j = this.Y0;
        orVar.l.clear();
        orVar.l.addAll(this.G);
        orVar.h = this.V0;
        orVar.g = this.U0;
        orVar.m.clear();
        orVar.m.addAll(this.H);
        orVar.e = this.E0;
        orVar.f = this.F0;
        orVar.k.clear();
        orVar.k.addAll(this.F);
        orVar.f(orVar.c);
        return orVar;
    }
    ...
    public final void y0(int i10) {
        ...
        this.c.getViewTreeObserver().addOnPreDrawListener(new br(this, (org.telegram.ui.Components.t00) view, i10, 0));
    }
