...
public class ThemeSmallPreviewView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ThemeSmallPreviewView(Context context, int i, Theme.ResourcesProvider resourcesProvider, int i2) {
        ...
        this.messageDrawableOut = new MessageDrawable(0, true, false);
        this.messageDrawableIn = new MessageDrawable(0, false, false);
        this.currentType = i2;
    ...
    public void updatePreviewBackground(ThemeDrawable themeDrawable) {
        ...
        if (iTheme != null && iTheme.getThemeId() != 0) {
            ...
            themeDrawable.outBubblePaintSecond.setAlpha(NotificationCenter.didReceiveSmsCode);
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        TextPaint textPaint = new TextPaint(NotificationCenter.messageTranslating);
