...
public final class pr implements Interpolator {
    public static final pr f = new pr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final pr g = new pr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final pr h = new pr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final pr i = new pr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final pr j = new pr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final pr k = new pr(0.34d, 1.56d, 0.64d, 1.0d);
