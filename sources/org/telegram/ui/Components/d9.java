...
public final class d9 extends org.telegram.ui.ActionBar.n2 {
    ...
    public final View createView(Context context) {
        ...
        this.r.setClipChildren(false);
        v8Var.addView(this.r, w7.y5.d(-1, -1.0f, 0, 0.0f, 0.0f, 0.0f, 64.0f));
        ...
        v8Var.addView(this.x, w7.y5.d(-1, 48.0f, 80, 16.0f, 16.0f, 16.0f, 16.0f));
        v8Var.addView(this.y, w7.y5.d(-1, 80.0f, 80, 8.0f, 16.0f, 8.0f, 64.0f));
    ...
    */
    public final void f0() {
        ...
        int i11 = 1;
        if (e0()) {
            new xc(this.y, this.resourceProvider).Q(R.raw.star_premium_2, 36, AndroidUtilities.premiumText(LocaleController.getString(R.string.PremiumAvatarToast), new o8(this, i11))).j();
            return;
        }
        a3 a3Var = this.I;
        if (a3Var != null) {
            ...
            ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = (ChatAttachAlertPhotoLayout) a3Var.b;
            d9 d9Var = (d9) a3Var.c;
            ...
            o20 o20Var = new o20();
            if (z8Var != null) {
                o20Var.d(z8Var.c, z8Var.d, z8Var.e, z8Var.f);
            } else {
                int[] iArr = c0[0];
            ...
            viVar.Z1.C1(7, true, false, 0, 0, 0L, viVar.s1(), false, 0L);
            if (!d9Var.Q) {
