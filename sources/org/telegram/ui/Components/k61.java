...
public class k61 extends View {
    ...
    public final void a(String str, boolean z4) {
        ...
        this.C = ofFloat;
        ofFloat.addUpdateListener(new j61(i10, this));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int v02 = org.telegram.ui.ActionBar.k6.v0(isEnabled() ? this.J : org.telegram.ui.ActionBar.k6.y6, getResourceProvider());
        int i10 = this.F;
        TextPaint textPaint = this.y;
        if (i10 != v02) {
            this.F = v02;
        ...
        int v04 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.tf, getResourceProvider());
        int i12 = this.H;
        Paint paint = this.e;
        if (i12 != v04) {
            this.H = v04;
        ...
        if (getParent() != null) {
            ...
            if (this.n != org.telegram.ui.ActionBar.k6.v0(this.J, getResourceProvider()) || this.B == null) {
