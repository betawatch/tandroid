...
public final class k61 {
    ...
    public static Uri a(int i10, int i11, TLRPC.Document document) {
        StringBuilder o10 = i0.a.o(i10, "?account=", "&id=");
    ...
    public static k61 d(int i10, TLRPC.Document document, TLRPC.Document document2, int i11, boolean z10) {
        ...
        k61Var.a = i10;
        k61Var.g = document;
        k61Var.c = document.id;
        k61Var.d = a(i10, i11, document);
        if (document2 != null) {
            k61Var.h = document2;
            k61Var.e = document2.id;
            k61Var.f = a(i10, i11, document2);
            ...
            if (pathToAttach == null || !pathToAttach.exists()) {
                ...
                if (pathToAttach2 != null && pathToAttach2.exists()) {
                    k61Var.f = Uri.fromFile(pathToAttach2);
                }
            } else {
                k61Var.f = Uri.fromFile(pathToAttach);
            }
        }
        k61Var.m = lowerCase;
        ...
        if (tL_documentAttributeVideo != null) {
            ...
            k61Var.i = tL_documentAttributeVideo.w;
            k61Var.j = tL_documentAttributeVideo.h;
            k61Var.l = j10 / d;
        }
