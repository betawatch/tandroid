    ...
    public void draw(Canvas canvas) {
        ...
        if (i33 == 3 || i33 == 14 || (i33 == 4 && ((i24 = this.nextIcon) == 14 || i24 == 3))) {
            ...
            if (i33 == 10 || this.nextIcon == 10 || i33 == 13) {
                ...
                int i39 = (i38 == 4 || i38 == 6) ? (int) ((1.0f - this.transitionProgress) * 255.0f) : NotificationCenter.goingToPreviewTheme;
                if (i39 != 0) {
                    applyShaderMatrix(false);
        ...
        if (i41 == 15) {
            ...
            if (this.currentIcon == 15) {
                ...
                if (this.currentIcon != 12 || this.nextIcon == 12) {
                    ...
                    this.paint.setAlpha(i12 != i13 ? NotificationCenter.goingToPreviewTheme : (int) (f22 * 255.0f));
                ...
                if (i17 != 0 || i17 == 1 || (i23 = this.nextIcon) == 0 || i23 == 1) {
                    ...
                    if ((i43 == 0 || i43 == i18) && (i17 == 0 || i17 == i18)) {
                        ...
                        i19 = NotificationCenter.goingToPreviewTheme;
                        ...
                        if (i43 == 4) {
                            ...
                            this.paint2.setAlpha(i17 == i43 ? NotificationCenter.goingToPreviewTheme : (int) (this.transitionProgress * 255.0f));
                        }
                        z = true;
                        i19 = NotificationCenter.goingToPreviewTheme;
                    }
                ...
                if (pathArr8 != null) {
                    ...
                    int i49 = this.currentIcon == this.nextIcon ? NotificationCenter.goingToPreviewTheme : (int) (this.transitionProgress * 255.0f);
                    this.paint2.setStyle(Paint.Style.FILL_AND_STROKE);
