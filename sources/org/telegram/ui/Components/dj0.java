        ...
        if (layout != null) {
            ...
            if (text != null && (text instanceof Spannable)) {
                ...
                while (i12 < dj0VarArr2.length) {
                    ...
                    zi0 zi0Var = new zi0(duVar2, layout, spannable, dj0Var);
                    if (dj0Var.a) {
                        int i13 = dj0Var.c;
                        if (i13 == 0 || text.charAt(i13 - 1) == '\n') {
                            if (dj0Var.d != text.length() && text.charAt(dj0Var.d) != '\n') {
                                ...
                                zi0Var = new zi0(duVar2, layout, spannable, dj0VarArr2[i12]);
                            }
                            ...
                            if (z13) {
                                ...
                                if (zi0Var.b()) {
                                    ...
                                    if (i16 - 2 >= 0) {
                                        z10 = true;
                                        if (layout.getLineRight(layout.getLineForOffset(i16 - 1)) - AndroidUtilities.dp(12.0f) > zi0Var.d - (dj0Var2.J != null ? org.telegram.messenger.wh.c(3.333f, 2, AndroidUtilities.dp(23.66f) + r12.c) : org.telegram.messenger.wh.c(3.333f, 2, AndroidUtilities.dp(23.66f)))) {
                                            z11 = true;
                                            if (z14 != z11) {
                                                int i17 = dj0Var2.d;
                                                if (z14) {
