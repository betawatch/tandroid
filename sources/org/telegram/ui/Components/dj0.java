...
public final class dj0 implements LeadingMarginSpan {
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder) {
        ...
        while (true) {
            ...
            cj0 cj0Var = cj0VarArr[i10];
            int spanStart = spannableStringBuilder.getSpanStart(cj0Var);
            int spanEnd = spannableStringBuilder.getSpanEnd(cj0Var);
            treeSet.add(Integer.valueOf(spanStart));
            hashMap.put(Integer.valueOf(spanStart), Integer.valueOf((cj0Var.a.e ? 16 : 1) | (hashMap.containsKey(Integer.valueOf(spanStart)) ? ((Integer) hashMap.get(Integer.valueOf(spanStart))).intValue() : 0)));
            ...
            spannableStringBuilder.removeSpan(cj0Var.a);
            i10++;
        }
    ...
    public static void b(Spannable spannable, int i10, int i11, boolean z10) {
        ...
        if (dj0VarArr == null || dj0VarArr.length <= 0) {
            ...
            cj0 cj0Var = new cj0();
            dj0 dj0Var = new dj0(false, z10, cj0Var);
            cj0Var.a = dj0Var;
            dj0Var.c = clamp;
            dj0Var.d = clamp2;
    ...
    public static int c(Editable editable, int i10, int i11, boolean z10) {
        ...
        cj0 cj0Var = new cj0();
        dj0 dj0Var = new dj0(true, z10, cj0Var);
        cj0Var.a = dj0Var;
        dj0Var.c = clamp;
        dj0Var.d = clamp2;
    ...
    */
    public static ArrayList d(eu euVar, Layout layout, ArrayList arrayList, boolean[] zArr) {
        ...
        if (layout != null) {
            ...
            if (text != null && (text instanceof Spannable)) {
                ...
                dj0[] dj0VarArr2 = (dj0[]) spannable.getSpans(0, spannable.length(), dj0.class);
                ArrayList arrayList2 = arrayList;
                int i12 = 0;
                while (i12 < dj0VarArr2.length) {
                    dj0 dj0Var = dj0VarArr2[i12];
                    boolean z12 = dj0Var.n;
                    zi0 zi0Var = new zi0(euVar2, layout, spannable, dj0Var);
                    if (dj0Var.a) {
                        int i13 = dj0Var.c;
                        if (i13 == 0 || text.charAt(i13 - 1) == '\n') {
                            if (dj0Var.d != text.length() && text.charAt(dj0Var.d) != '\n') {
                                int i14 = dj0Var.d;
                                while (i14 <= text.length() && i14 != text.length() && text.charAt(i14) != '\n') {
                                    i14++;
                                }
                                spannable.removeSpan(dj0VarArr2[i12]);
                                spannable.removeSpan(dj0VarArr2[i12].s);
                                spannable.setSpan(dj0VarArr2[i12], dj0Var.c, i14, 33);
                                spannable.setSpan(dj0VarArr2[i12].s, dj0Var.c, i14, 33);
                                zi0Var = new zi0(euVar2, layout, spannable, dj0VarArr2[i12]);
                            }
                            boolean z13 = spannable instanceof SpannableStringBuilder;
                            dj0 dj0Var2 = zi0Var.e;
                            if (z13) {
                                ...
                                if (zi0Var.b()) {
                                    ...
                                    if (i16 - 2 >= 0) {
                                        z10 = true;
                                        if (layout.getLineRight(layout.getLineForOffset(i16 - 1)) - AndroidUtilities.dp(12.0f) > zi0Var.d - (dj0Var2.J != null ? org.telegram.messenger.f0.D(3.333f, 2, AndroidUtilities.dp(23.66f) + r12.c) : org.telegram.messenger.f0.D(3.333f, 2, AndroidUtilities.dp(23.66f)))) {
                                            z11 = true;
                                            if (z14 != z11) {
                                                int i17 = dj0Var2.d;
                                                if (z14) {
                                                    ...
                                                    charSequence = text;
                                                    dj0VarArr = dj0VarArr2;
                                                } else {
                                                    i11 = i17 + 2;
                                                    boolean z15 = Selection.getSelectionStart(spannableStringBuilder) == dj0Var2.d && Selection.getSelectionStart(spannableStringBuilder) == Selection.getSelectionEnd(spannableStringBuilder);
                                                    int i18 = dj0Var2.d;
                                                    if (dj0Var2.K == null) {
                                                        SpannableString spannableString = new SpannableString("\n");
                                                        dj0Var2.K = spannableString;
                                                        charSequence = text;
                                                        dj0VarArr = dj0VarArr2;
                                                        spannableString.setSpan(new bj0(), 0, dj0Var2.K.length(), 33);
                                                    } else {
                                                        charSequence = text;
                                                        dj0VarArr = dj0VarArr2;
                                                    }
                                                    spannableStringBuilder.insert(i18, (CharSequence) dj0Var2.K);
                                                    if (z15) {
                                                ...
                                                dj0Var2.d = Math.min(i11, spannable.length());
                                                spannable.removeSpan(dj0VarArr[i12]);
                                                spannable.removeSpan(dj0VarArr[i12].s);
                                                spannable.setSpan(dj0VarArr[i12], dj0Var2.c, dj0Var2.d, 33);
                                                spannable.setSpan(dj0VarArr[i12].s, dj0Var2.c, dj0Var2.d, 33);
                                                if (zArr != null) {
                                                    zArr[0] = z10;
                                                }
                                            } else {
                            ...
                            ii.a6 a6Var = dj0Var2.v;
                            if (a6Var != null) {
                                spannable.removeSpan(a6Var);
                            }
                            if (dj0Var2.e && (lineStart = layout.getLineStart(Math.min(layout.getLineForOffset(dj0Var2.c) + 3, layout.getLineCount()))) < (i10 = dj0Var2.d)) {
                                if (dj0Var2.v == null) {
                                    dj0Var2.v = new ii.a6(dj0Var2);
                                }
                                spannable.setSpan(dj0Var2.v, lineStart, i10, 33);
                            }
                        } else {
                            spannable.removeSpan(dj0VarArr2[i12]);
                            spannable.removeSpan(dj0VarArr2[i12].s);
                            ii.a6 a6Var2 = dj0VarArr2[i12].v;
                            if (a6Var2 != null) {
                    ...
                    if (dj0VarArr[i12].n != z12 && zArr != null) {
                        zArr[0] = z10;
                    }
