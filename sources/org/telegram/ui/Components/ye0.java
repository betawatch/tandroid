    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        if (i12 == 0) {
            ...
            if (c10 == 1) {
                ...
                PointF pointF = new PointF(Math.max(width, Math.min(jv0Var.a + width, this.a.x + f18)), Math.max(A, Math.min(f20 + A, this.a.y + f19)));
                float f21 = pointF.x - width;
                float f22 = jv0Var.a;
                this.e = new PointF(f21 / f22, (((f22 - jv0Var.b) / 2.0f) + (pointF.y - A)) / f22);
            } else if (c10 == 2) {
            ...
            if (c11 == 1) {
                ...
                PointF pointF2 = new PointF(Math.max(width2, Math.min(jv0Var.a + width2, this.a.x + f25)), Math.max(A2, Math.min(f27 + A2, this.a.y + f26)));
                float f28 = pointF2.x - width2;
                float f29 = jv0Var.a;
                this.e = new PointF(f28 / f29, (((f29 - jv0Var.b) / 2.0f) + (pointF2.y - A2)) / f29);
            } else if (c11 == 2) {
