    ...
    public void dispatchDraw(Canvas canvas) {
                ...
                if (p6 != 0 && getMessageAlphaEnter() != null) {
                    if (getMessageAlphaEnter().get(p6, null) != null) {
                        ...
                        if (!(childAt instanceof org.telegram.ui.Cells.f7)) {
                            ((org.telegram.ui.Cells.f7) childAt).setEnterAnimationAlpha(f10);
                        } else if (childAt instanceof org.telegram.ui.Cells.e7) {
                            ((org.telegram.ui.Cells.e7) childAt).setEnterAnimationAlpha(f10);
                        }
                    }
                }
                f10 = 1.0f;
        ...
        for (int i27 = 0; i27 < getChildCount(); i27++) {
            ...
            if (childAt4.getTop() > getMeasuredHeight() || childAt4.getBottom() < 0) {
                if (childAt4 instanceof org.telegram.ui.Cells.o7) {
                    org.telegram.ui.Cells.o7 o7Var = (org.telegram.ui.Cells.o7) getChildAt(i27);
                    o7Var.v = null;
                    o7Var.O = 0.0f;
                    o7Var.P = 0;
                ...
                org.telegram.ui.Cells.o7 o7Var2 = (org.telegram.ui.Cells.o7) getChildAt(i27);
                y1(o7Var2);
                ...
                if (messageObject == null || getMessageAlphaEnter() == null) {
                    ...
                    if (getMessageAlphaEnter().get(messageObject.getId(), null) != null) {
                        ...
                        if (z1()) {
                            int a2 = (((f2.v) o7Var2.getLayoutParams()).a() % getColumnsCount()) + i10;
                            int animateToColumnsCount = (getAnimateToColumnsCount() * (((((f2.v) o7Var2.getLayoutParams()).a() - i12) / getColumnsCount()) + i13)) + a2 + this.k3;
                            if (a2 >= 0 && a2 < getAnimateToColumnsCount() && animateToColumnsCount >= 0 && animateToColumnsCount < arrayList4.size()) {
                                float lerp = AndroidUtilities.lerp(1.0f, (((org.telegram.ui.Cells.o7) arrayList4.get(animateToColumnsCount)).getMeasuredWidth() - AndroidUtilities.dpf2(f13)) / (o7Var2.getMeasuredWidth() - AndroidUtilities.dpf2(f13)), getChangeColumnsProgress());
                                float left = o7Var2.getLeft();
                                float top = o7Var2.getTop();
                                float left2 = ((org.telegram.ui.Cells.o7) arrayList4.get(animateToColumnsCount)).getLeft();
                                float top2 = ((org.telegram.ui.Cells.o7) arrayList4.get(animateToColumnsCount)).getTop();
                                ...
                                org.telegram.ui.Cells.o7 o7Var3 = (org.telegram.ui.Cells.o7) arrayList4.get(animateToColumnsCount);
                                ...
                                o7Var2.P = animateToColumnsCount2;
                                hashSet.add((org.telegram.ui.Cells.o7) arrayList4.get(animateToColumnsCount));
        ...
        if (z1() && !arrayList3.isEmpty()) {
            ...
            while (i28 < arrayList3.size()) {
                org.telegram.ui.Cells.o7 o7Var4 = (org.telegram.ui.Cells.o7) arrayList3.get(i28);
                if (hashSet.contains(o7Var4)) {
                    ...
                    o7Var4.O = 0.0f;
                    o7Var4.P = 0;
                    int a3 = ((f2.v) o7Var4.getLayoutParams()).a() % getAnimateToColumnsCount();
                    int i29 = a3 - i10;
                    int a10 = ((((f2.v) o7Var4.getLayoutParams()).a() - i11) / getAnimateToColumnsCount()) - i13;
                    canvas.save();
                    canvas.translate((getChangeColumnsProgress() * a3 * measuredWidth2) + ((1.0f - getChangeColumnsProgress()) * i29 * measuredWidth), (a10 * f18) + f11);
        ...
        if (z1()) {
            ...
            while (i30 < arrayList.size()) {
                org.telegram.ui.Cells.o7 o7Var5 = (org.telegram.ui.Cells.o7) arrayList.get(i30);
                int a11 = ((f2.v) o7Var5.getLayoutParams()).a() % getColumnsCount();
                int a12 = ((((f2.v) o7Var5.getLayoutParams()).a() - i12) / getColumnsCount()) + i13;
                int i31 = a11 + i10;
                canvas.save();
                o7Var5.j(changeColumnsProgress5, !z1());
                canvas.translate((getChangeColumnsProgress() * i31 * measuredWidth4) + ((1.0f - getChangeColumnsProgress()) * a11 * measuredWidth3), (a12 * f19) + f11);
                if (i31 < getAnimateToColumnsCount()) {
                    i14 = i30;
                    canvas.saveLayerAlpha(0.0f, 0.0f, o7Var5.getMeasuredWidth() * changeColumnsProgress4, o7Var5.getMeasuredHeight() * changeColumnsProgress4, (int) ((1.0f - getChangeColumnsProgress()) * f17), 31);
                    o7Var5.draw(canvas);
                    canvas.restore();
                } else {
                    i14 = i30;
            ...
            for (int i32 = 0; i32 < arrayList2.size(); i32++) {
                org.telegram.ui.Cells.o7 o7Var6 = (org.telegram.ui.Cells.o7) arrayList2.get(i32);
                if (o7Var6.v != null) {
                    canvas.save();
                    canvas.translate(o7Var6.getX(), o7Var6.getY());
                    o7Var6.v.j(((o7Var6.getMeasuredWidth() - AndroidUtilities.dp(2.0f)) * o7Var6.x) / (o7Var6.v.getMeasuredWidth() - AndroidUtilities.dp(2.0f)), false);
