...
public final class ww extends qx {
    ...
    public final /* synthetic */ org.telegram.ui.ActionBar.o2 E0;
    ...
    public final void o(int i10, int i11) {
        ...
        if (SharedConfig.updateStickersOrderOnSend) {
            ...
            if (o2Var != null) {
                vc.a0(o2Var).K(R.raw.filter_reorder, LocaleController.getString(R.string.DynamicPackOrderOff), LocaleController.getString(R.string.DynamicPackOrderOffInfo), LocaleController.getString("Settings"), new rd(i16, o2Var)).j();
                return;
            }
