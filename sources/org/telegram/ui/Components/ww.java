...
public final class ww extends qx {
    ...
    public ww(kz kzVar, Context context, org.telegram.ui.ActionBar.e6 e6Var, org.telegram.ui.ActionBar.n2 n2Var, boolean z10) {
    ...
    public final void o(int i10, int i11) {
        ...
        if (SharedConfig.updateStickersOrderOnSend) {
            ...
            if (n2Var != null) {
                vc.a0(n2Var).K(R.raw.filter_reorder, LocaleController.getString(R.string.DynamicPackOrderOff), LocaleController.getString(R.string.DynamicPackOrderOffInfo), LocaleController.getString("Settings"), new rd(i16, n2Var)).j();
                return;
            }
