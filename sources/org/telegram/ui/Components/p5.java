                                ...
                                if (str2 != null) {
                                    ...
                                    if (z11 || !(s || i11 == 14)) {
                                        ...
                                        if ("video/webm".equals(this.e.mime_type)) {
                                            ...
                                            ai.l4 l4Var3 = this.k;
                                            String s10 = v7.j0.s(str4, "_firstframe");
                                            TLRPC.Document document4 = this.e;
                                            l4Var3.setImage(imageLocation3, s10, forDocument2, null, drawable, document4.size, null, document4, 1);
                                        } else {
                                            ai.l4 l4Var4 = this.k;
