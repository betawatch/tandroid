...
public class p5 extends Drawable {
                        ...
                        if (i11 != i10 || i11 == 21) {
                            ...
                            if (emojiDrawable != null) {
                                ...
                                if (str2 != null) {
                                    ...
                                    x2Var.setImage(null, null, imageLocation, str, null, null, drawable, document2.size, null, document2, 1);
                                } else {
                                    ...
                                    if (z11 || !(s || i11 == 14)) {
                                        ...
                                        if ("video/webm".equals(this.e.mime_type)) {
                                            ...
                                            x2Var2.setImage(null, null, forDocument3, str5, forDocument2, null, drawable, document3.size, null, document3, 1);
                                        } else if (MessageObject.isAnimatedStickerDocument(this.e, true)) {
                                            lh.x2 x2Var3 = this.k;
                                            String k9 = u3.c.k(str4, "_firstframe");
                                            TLRPC.Document document4 = this.e;
                                            x2Var3.setImage(imageLocation3, k9, forDocument2, null, drawable, document4.size, null, document4, 1);
                                        } else {
                                            lh.x2 x2Var4 = this.k;
                                            ...
                                            x2Var4.setImage(forDocument4, str6, forDocument2, null, drawable, document5.size, null, document5, 1);
                                        }
                                    } else {
                                        ...
                                        x2Var5.setImage(imageLocation3, str4, forDocument6, str7, forDocument5, null, drawable, document6.size, null, document6, 1);
                                    }
                                }
                                w(this.k);
    ...
    */
    ...
    public final String toString() {
        ...
        TLRPC.Document document = this.e;
        return a4.w.q(sb2, document == null ? BuildConfig.BETA_URL : MessageObject.findAnimatedEmojiEmoticon(document, null), "}");
    }
