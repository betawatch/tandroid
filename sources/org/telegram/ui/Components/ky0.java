...
public final /* synthetic */ class ky0 implements Runnable {
    ...
    public /* synthetic */ ky0(int i10, Object obj, Object obj2, Object obj3, Object obj4, TLRPC.TL_error tL_error) {
        this.a = i10;
        this.b = obj;
        this.f = tL_error;
        this.c = obj2;
    ...
    public final void run() {
        ...
        switch (i18) {
                ...
                if (U != null) {
                    if (tLObject instanceof TLRPC.TL_boolTrue) {
                        ...
                        if (userFull != null) {
                            ...
                            MessagesStorage.getInstance(ly0Var.a).updateUserInfo(userFull, false);
                        }
                        if (tL_error != null && (str = tL_error.text) != null && str.startsWith("FLOOD_WAIT_")) {
                            AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(ly0Var.b.getContext());
            ...
            case 1:
                ...
                if (((MessagesController) obj4).isDialogMuted(x21Var.c, tL_forumTopic.id)) {
                    q70Var.u();
                ...
                if (((TLRPC.TL_error) obj) == null && (tLObject2 instanceof TLRPC.TL_messages_myStickers)) {
                    ...
                    while (i20 < size) {
                        ...
                        if (!stickerSet.emojis && !stickerSet.masks) {
                            ...
                            TLRPC.TL_messages_stickerSet stickerSet2 = MediaDataController.getInstance(qtVar.r).getStickerSet((TLRPC.InputStickerSet) tL_inputStickerSetID, true);
                    ...
                    if (tL_messages_myStickers.sets.size() == tL_messages_getMyStickers.limit) {
                        tL_messages_getMyStickers.offset_id = ((TLRPC.StickerSetCovered) l.d.i(1, tL_messages_myStickers.sets)).set.id;
                        ConnectionsManager.getInstance(qtVar.r).sendRequest(tL_messages_getMyStickers, new org.telegram.ui.ba(qtVar, arrayList, tL_messages_getMyStickers, 7));
                        break;
                    }
                }
                break;
            ...
            case 10:
                ...
                int i21 = xb0Var.b;
                LaunchActivity launchActivity5 = xb0Var.a;
                if (tL_error5 != null) {
                    ...
                    if (tLObject6 instanceof TLRPC.TL_payments_paymentFormStars) {
                        ...
                        mh.t7.y(i21, false).Y(null, tL_inputInvoiceSlug, (TLRPC.TL_payments_paymentFormStars) tLObject6, new org.telegram.ui.qb0(xb0Var, 1), new org.telegram.ui.b90(u5Var, i19));
                        break;
                    } else {
                    ...
                    if (str7 != null) {
                        if (str7.contains("EMAIL_INVALID")) {
                            ...
                            if (tL_error7.text.contains("PHONE_CODE_EXPIRED")) {
                                ...
                                z4.f0(i13, tL_error7, og0Var2, sendverifyemailcode, ef0Var.w);
                                break;
                            }
                        } else {
            ...
            case 15:
                ...
                if (tLObject10 instanceof TLRPC.PaymentForm) {
                    ...
                    lo0Var2.S0 = true;
                    lo0Var2.Z0 = new Utilities.Callback() { // from class: org.telegram.ui.tf0
                    ...
                    lo0Var2.a1 = new Utilities.Callback() { // from class: org.telegram.ui.tf0
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj6) {
                            switch (i19) {
                                case 0:
                    ...
                    lo0Var2.b1 = new org.telegram.ui.i20(xf0Var, i19);
                    og0Var4.presentFragment(lo0Var2);
                    break;
                } else if (tL_error9 != null) {
                    if ("PHONE_CODE_EXPIRED".equalsIgnoreCase(tL_error9.text)) {
                        AndroidUtilities.runOnUIThread(new org.telegram.ui.uf0(xf0Var, i20));
                        break;
                    } else {
            ...
            case 21:
                ...
                PhotoViewer photoViewer = ((org.telegram.ui.mt0) obj5).r;
                photoViewer.m4 = null;
                org.telegram.ui.du0 du0Var = photoViewer.b0;
                if (du0Var != null && photoViewer.d0 != null) {
                    ...
                    org.telegram.ui.lu0 lu0Var = photoViewer.n4;
                    if (lu0Var != null) {
                        lu0Var.a.setVisible(true, true);
                    }
                    org.telegram.ui.lu0 lu0Var2 = photoViewer.o4;
                    if (lu0Var2 != null && !lu0Var2.s) {
                        lu0Var2.a.setVisible(false, true);
                    }
                    if (arrayList4 != null && (i17 = photoViewer.Z1) != 3 && i17 != 1 && ((ju0Var = photoViewer.d) == null || !ju0Var.O())) {
                        photoViewer.R1();
                    }
                    k71 k71Var = photoViewer.C2;
                    if (k71Var != null && k71Var.y() && photoViewer.o1 && !photoViewer.d7.isEmpty()) {
            ...
            case 25:
                ...
                if (tLObject12 instanceof TL_fragment.TL_collectibleInfo) {
                    ...
                    ic w10 = new qc(iz0Var.w, profileActivity2.w0).w(R.drawable.filled_username, AndroidUtilities.withLearnMore(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FragmentChannelUsername, str10, format, formatCurrency, TextUtils.isEmpty(formatCurrency2) ? "" : android.support.v4.media.a.o("(", formatCurrency2, ")"))), new org.telegram.ui.br0(19, profileActivity2, tL_collectibleInfo)));
            ...
            case 26:
                ...
                if (tLObject13 instanceof TL_fragment.TL_collectibleInfo) {
                    org.telegram.ui.e20.a(profileActivity3.getParentActivity(), 1, str11, user3, (TL_fragment.TL_collectibleInfo) tLObject13, profileActivity3.w0);
                    break;
                } else {
                    qc.b0(tL_error15);
                    break;
            ...
            case 28:
                ...
                org.telegram.ui.ActionBar.p2 p2Var2 = s01Var.e;
                if (((String) obj4).equals(s01Var.y)) {
                    if (!s01Var.w && (p2Var2 instanceof ProfileActivity)) {
                        try {
    ...
    public /* synthetic */ ky0(KeyEvent.Callback callback, TLObject tLObject, Object obj, TLRPC.TL_error tL_error, TLObject tLObject2, int i10) {
        this.a = i10;
        this.b = callback;
        this.c = tLObject;
        this.d = obj;
    ...
    public /* synthetic */ ky0(Object obj, Object obj2, Object obj3, Object obj4, Object obj5, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
        this.d = obj3;
    ...
    public /* synthetic */ ky0(Object obj, Object obj2, TLObject tLObject, TLObject tLObject2, TLRPC.TL_error tL_error, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = obj2;
        this.c = tLObject;
    ...
    public /* synthetic */ ky0(org.telegram.ui.bn0 bn0Var, TLRPC.TL_error tL_error, Bundle bundle, TLObject tLObject, TLRPC.TL_auth_resendCode tL_auth_resendCode) {
        this.a = 19;
        this.b = bn0Var;
        this.f = tL_error;
        this.d = bundle;
