    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f11 != 1.0f) {
                ...
                int v = org.telegram.messenger.vl.v(16.0f, AndroidUtilities.dp(21.0f) + AndroidUtilities.dp(132.0f), getMeasuredWidth());
                int dp = AndroidUtilities.dp(21.0f);
                float f13 = dp;
                float y3 = org.telegram.messenger.vl.y(48.0f, getMeasuredHeight(), 2);
        ...
        int v9 = org.telegram.messenger.vl.v(16.0f, AndroidUtilities.dp(21.0f) + AndroidUtilities.dp(132.0f), getMeasuredWidth());
        int dp2 = AndroidUtilities.dp(21.0f);
        float f132 = dp2;
        float y32 = org.telegram.messenger.vl.y(48.0f, getMeasuredHeight(), 2);
