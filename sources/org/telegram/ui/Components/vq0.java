...
public final class vq0 extends kh.v {
    ...
    public final boolean c(MessageObject messageObject) {
        hu0 hu0Var = this.C;
        return hu0Var.V0[(messageObject.getDialogId() > hu0Var.f1 ? 1 : (messageObject.getDialogId() == hu0Var.f1 ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0;
    }
    ...
    public final boolean e(MessageObject messageObject) {
        ...
        NumberTextView numberTextView = hu0Var.w0;
        SparseArray[] sparseArrayArr = hu0Var.V0;
        if (messageObject != null) {
            char c10 = messageObject.getDialogId() == hu0Var.f1 ? (char) 0 : (char) 1;
            if (sparseArrayArr[c10].indexOfKey(messageObject.getId()) < 0) {
                if (sparseArrayArr[1].size() + sparseArrayArr[0].size() < 100) {
                    ...
                    if (hu0Var.y1) {
                        ...
                        AndroidUtilities.hideKeyboard(hu0Var.r1.getParentActivity().getCurrentFocus());
                        int i10 = 8;
                        hu0Var.h0.setVisibility(hu0Var.W0 == 0 ? 0 : 8);
                        org.telegram.ui.ActionBar.v0 v0Var = hu0Var.q0;
                        if (v0Var != null) {
                            v0Var.setVisibility((hu0Var.getClosestTab() == 8 || hu0Var.getClosestTab() == 13) ? 8 : 0);
                        }
                        org.telegram.ui.ActionBar.v0 v0Var2 = hu0Var.r0;
                        if (v0Var2 != null) {
                            v0Var2.setVisibility(8);
                        }
                        org.telegram.ui.ActionBar.v0 v0Var3 = hu0Var.s0;
                        if (v0Var3 != null) {
                            v0Var3.setVisibility(8);
                        }
                        org.telegram.ui.ActionBar.v0 v0Var4 = hu0Var.p0;
                        if (v0Var4 != null) {
        ...
        if (messageObject != null) {
            ...
            if (sparseArrayArr[c10].indexOfKey(messageObject.getId()) >= 0) {
                ...
                if (sparseArrayArr[0].size() == 0 && sparseArrayArr[1].size() == 0) {
                    ...
                    hu0Var.w0.a(sparseArrayArr[1].size() + sparseArrayArr[0].size(), true);
                }
                j();
                return true;
            }
