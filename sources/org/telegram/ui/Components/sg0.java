...
public final class sg0 extends FrameLayout {
        ...
        switch (i10) {
            ...
            case 3:
                ...
                if (!this.b && c61Var.r > 0.0f) {
                    ...
                    super.dispatchDraw(canvas);
                    ((Paint) this.c).setAlpha((int) (c61Var.r * 255.0f));
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.a) {
            case 4:
                ...
                canvas.drawRect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), ((org.telegram.ui.w5) ((org.telegram.ui.a1) limitPreviewView.e0).b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                canvas.restore();
                invalidate();
                return drawChild;
            default:
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 0:
                ...
                int i21 = zg0Var.E;
                i10 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingTop;
                int i22 = (i21 - i10) - dp;
                i11 = ((org.telegram.ui.ActionBar.h3) zg0Var).currentSheetAnimationType;
                if (i11 == 1) {
                    i22 = (int) (zg0Var.b.getTranslationY() + i22);
                }
                int dp2 = AndroidUtilities.dp(20.0f) + i22;
                int dp3 = AndroidUtilities.dp(15.0f) + getMeasuredHeight();
                i12 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingTop;
                int i23 = i12 + dp3;
                ...
                if (i13 + i22 < org.telegram.ui.ActionBar.l.getCurrentActionBarHeight()) {
                    ...
                    i20 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingTop;
                ...
                if (f7 != 1.0f) {
                    ...
                    i16 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingLeft;
                    i17 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingTop;
                    int measuredWidth = getMeasuredWidth();
                    i18 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingLeft;
                    float f10 = measuredWidth - i18;
                    i19 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingTop;
                ...
                org.telegram.ui.ActionBar.j6.t0.setColor(Color.argb((int) (zg0Var.f.getAlpha() * 255.0f), Color.red(w03), Color.green(w03), Color.blue(w03)));
                i14 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingLeft;
                float f11 = i14;
                int measuredWidth2 = getMeasuredWidth();
                i15 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingLeft;
        ...
        switch (this.a) {
            case 0:
                ...
                if (motionEvent.getAction() == 0 && zg0Var.E != 0) {
                    if (motionEvent.getY() < AndroidUtilities.dp(12.0f) + zg0Var.E && zg0Var.f.getAlpha() == 0.0f) {
                        zg0Var.dismiss();
                        return true;
                    }
                }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            case 0:
                ...
                vg0 vg0Var = zg0Var.c;
                tg0 tg0Var = zg0Var.b;
                z10 = ((org.telegram.ui.ActionBar.h3) zg0Var).isFullscreen;
                if (!z10) {
                    this.b = true;
                    i14 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingLeft;
                ...
                for (int i17 = 0; i17 < R; i17++) {
                    if (i17 == 0) {
                        i13 = ((org.telegram.ui.ActionBar.h3) zg0Var).backgroundPaddingLeft;
                        ...
                        M = ((vg0Var.M(i17) - 1) * AndroidUtilities.dp(50.0f)) + AndroidUtilities.dp(32.0f);
                    }
                    dp = M + dp;
                }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.a) {
            case 0:
                return !((zg0) this.d).isDismissed() && super.onTouchEvent(motionEvent);
            default:
