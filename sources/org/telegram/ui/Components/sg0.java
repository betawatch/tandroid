...
public final class sg0 extends nl0 {
    ...
    public final int M(int i10) {
        ...
        vg0 vg0Var = (vg0) this.s.x.get(i10 - 1);
        int b10 = vg0Var.b() + 1;
        if (TextUtils.isEmpty(vg0Var.c) && !vg0Var.e) {
            i11 = 0;
        }
        return b10 + i11;
    }
    ...
    public final Object O(int i10, int i11) {
        ...
        if (i13 >= 0) {
            wg0 wg0Var = this.s;
            if (i13 < wg0Var.x.size() && (i12 = i11 - 1) < ((vg0) wg0Var.x.get(i13)).b()) {
                return Integer.valueOf(Objects.hash(Long.valueOf(DialogObject.getPeerDialogId(((TLRPC.MessagePeerVote) ((vg0) wg0Var.x.get(i13)).b.get(i12)).peer))));
            }
        }
        return -182734;
    }
    ...
    public final int P(int i10, int i11) {
        ...
        return i11 + (-1) < ((vg0) this.s.x.get(i10 + (-1))).b() ? 0 : 3;
    }
    ...
    public final View T(int i10, View view) {
        ...
        wg0 wg0Var = this.s;
        TLRPC.Poll poll = wg0Var.r;
        MessageObject messageObject = wg0Var.n;
        if (view == null) {
            view = new rg0(this, this.r);
        }
        ug0 ug0Var = (ug0) view;
        if (i10 == 0) {
        ...
        view.setAlpha(1.0f);
        vg0 vg0Var = (vg0) wg0Var.x.get(i10 - 1);
        int size = poll.answers.size();
        int i11 = 0;
        for (int i12 = 0; i12 < size; i12++) {
            TLRPC.PollAnswer pollAnswer = poll.answers.get(i12);
            if (Arrays.equals(pollAnswer.option, vg0Var.d) && ((tg0) wg0Var.w.get(vg0Var)) != null) {
                ...
                ug0Var.a(tL_textWithEntities == null ? "" : tL_textWithEntities.text, tL_textWithEntities == null ? null : tL_textWithEntities.entities, wg0Var.P(vg0Var.d), vg0Var.a, vg0Var.a(), false);
    ...
    public final void W(int i10, int i11, f2.l1 l1Var) {
        ...
        if (i12 != 2) {
            ...
            vg0 vg0Var = (vg0) arrayList.get(i10 - 1);
            ((org.telegram.ui.Cells.n8) view).m(R.drawable.arrow_more, LocaleController.formatPluralString("ShowVotes", vg0Var.a - vg0Var.b(), new Object[0]), false);
            return;
        }
        ug0 ug0Var = (ug0) view;
        vg0 vg0Var2 = (vg0) arrayList.get(i10 - 1);
        ArrayList arrayList2 = vg0Var2.b;
        byte[] bArr = vg0Var2.d;
        int size = poll.answers.size();
        for (int i14 = 0; i14 < size; i14++) {
            TLRPC.PollAnswer pollAnswer = poll.answers.get(i14);
            if (Arrays.equals(pollAnswer.option, bArr) && ((tg0) wg0Var.w.get(vg0Var2)) != null) {
                TLRPC.TL_textWithEntities tL_textWithEntities = pollAnswer.text;
                if (messageObject != null && messageObject.translated && (message = messageObject.messageOwner) != null && message.translatedPoll != null) {
                    while (true) {
                ...
                ug0Var.a(tL_textWithEntities == null ? "" : tL_textWithEntities.text, tL_textWithEntities == null ? null : tL_textWithEntities.entities, wg0Var.P(bArr), vg0Var2.a, vg0Var2.a(), false);
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            view = new PollVotesAlert$UserCell(wg0Var, context);
        } else if (i10 == 1) {
            ...
            n8Var.setOffsetFromImage(65);
            n8Var.setBackgroundColor(wg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
            n8Var.e(org.telegram.ui.ActionBar.j6.N6, org.telegram.ui.ActionBar.j6.q6);
            view = n8Var;
        } else {
    ...
    public final void y(f2.l1 l1Var) {
        ...
        if (l1Var.f == 0) {
            ...
            wg0 wg0Var = this.s;
            vg0 vg0Var = (vg0) wg0Var.x.get(S - 1);
            TLRPC.MessagePeerVote messagePeerVote = (TLRPC.MessagePeerVote) vg0Var.b.get(Q);
            TLObject userOrChat = wg0Var.Q().getUserOrChat(DialogObject.getPeerDialogId(messagePeerVote.peer));
            int i10 = messagePeerVote.date;
            boolean z10 = (Q == vg0Var.b() - 1 && TextUtils.isEmpty(vg0Var.c) && !vg0Var.e) ? false : true;
