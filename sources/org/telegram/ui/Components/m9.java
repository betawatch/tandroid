...
public abstract class m9 {
    public static void a(org.telegram.ui.bo boVar, int i10, TLRPC.Chat chat, TLRPC.User user, TLRPC.TL_forumTopic tL_forumTopic, long j3, int i11, int i12) {
        ...
        for (l9 l9Var : parentLayout.getPulledDialogs()) {
            if (tL_forumTopic == null && l9Var.f == j3) {
                return;
            }
            if (tL_forumTopic != null && (tL_forumTopic2 = l9Var.e) != null && tL_forumTopic2.id == tL_forumTopic.id) {
                return;
            }
        }
        l9 l9Var2 = new l9();
        l9Var2.a = org.telegram.ui.bo.class;
        l9Var2.b = i10;
        l9Var2.f = j3;
        l9Var2.h = i12;
        l9Var2.g = i11;
        l9Var2.c = chat;
        l9Var2.d = user;
        l9Var2.e = tL_forumTopic;
        parentLayout.getPulledDialogs().add(l9Var2);
    }
    ...
    */
    public static org.telegram.ui.ActionBar.o1 b(org.telegram.ui.ActionBar.o2 o2Var, View view, long j3, long j10, org.telegram.ui.ActionBar.f6 f6Var) {
        long j11;
        ArrayList arrayList;
        ...
        if (j10 == 0 || ChatObject.isMonoForum(o2Var.getCurrentAccount(), j3)) {
            j11 = 0;
            arrayList = new ArrayList();
            org.telegram.ui.ActionBar.e5 parentLayout2 = o2Var.getParentLayout();
            if (parentLayout2 != null) {
                ...
                if (pulledDialogs != null) {
                    for (int size2 = pulledDialogs.size() - 1; size2 >= 0; size2--) {
                        l9 l9Var3 = (l9) pulledDialogs.get(size2);
                        if (l9Var3.f != j3) {
                            int i18 = 0;
                            while (true) {
                                if (i18 >= arrayList.size()) {
                                    arrayList.add(l9Var3);
                                    break;
                                }
                                if (((l9) arrayList.get(i18)).f == l9Var3.f) {
                                    break;
                                }
                                i18++;
                            }
                ...
                Collections.sort(arrayList, new org.telegram.ui.ff(6));
                ...
                while (i19 < size3) {
                    ...
                    l9 l9Var4 = (l9) arrayList2.get(i19);
                    TLRPC.Chat chat2 = l9Var4.c;
                    TLRPC.User user3 = l9Var4.d;
                    TLRPC.TL_forumTopic tL_forumTopic = l9Var4.e;
                    ...
                    if (chat2 == null && user3 == null) {
                        u9Var.setRoundRadius(0);
                    } else {
                        u9Var.setRoundRadius((chat2 == null || !chat2.forum) ? AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(8.0f));
                    }
                    frameLayout.addView(u9Var, w7.x5.i(32.0f, 32.0f, 8388627, 8.0f, 0.0f, 0.0f, 0.0f));
                    ...
                    if (tL_forumTopic != null) {
                        if (tL_forumTopic.id == 1) {
                            u9Var.setImageDrawable(ng.d.c(fragmentView.getContext(), 1.0f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ac, f6Var), false));
                            i15 = i19;
                        } else if (tL_forumTopic.icon_emoji_id != j11) {
                            i15 = i19;
                            u9Var.setAnimatedEmojiDrawable(new o5(10, o2Var.getCurrentAccount(), tL_forumTopic.icon_emoji_id));
                        } else {
                            i15 = i19;
                        ...
                        i15 = i19;
                        if (chat2 != null) {
                            f9Var.k(o2Var.getCurrentAccount(), chat2);
                            TLRPC.ChatPhoto chatPhoto = chat2.photo;
                            if (chatPhoto != null && (r82 = chatPhoto.strippedBitmap) != 0) {
                                f9Var = r82;
                            }
                            u9Var.h(ImageLocation.getForChat(o2Var.getCurrentAccount(), chat2, 1), "50_50", f9Var, chat2);
                            ...
                            if (l9Var4.a == org.telegram.ui.bo.class && UserObject.isUserSelf(user3)) {
                                ...
                                if (UserObject.isDeleted(user3)) {
                                    ...
                                    f9Var.m(o2Var.getCurrentAccount(), user3);
                                    l9Var = l9Var4;
                                    u9Var.h(ImageLocation.getForUser(o2Var.getCurrentAccount(), user3, 1), "50_50", f9Var, user3);
                                } else {
                                    l9Var = l9Var4;
                                    String userName = UserObject.getUserName(user3);
                                    f9Var.m(o2Var.getCurrentAccount(), user3);
                                    u9Var.h(ImageLocation.getForUser(o2Var.getCurrentAccount(), user3, 1), "50_50", drawable, user3);
                                    str = userName;
                                }
                                ...
                                frameLayout.setOnClickListener(new ai.s0(atomicReference, l9Var, e5Var3, tL_forumTopic, o2Var, 10));
                            ...
                            atomicReference = atomicReference2;
                            frameLayout.setOnClickListener(new ai.s0(atomicReference, l9Var, e5Var32, tL_forumTopic, o2Var, 10));
                            actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.x5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                            if (!z11) {
                            }
                            i19 = i15 + 1;
                            ...
                            l9Var = l9Var4;
                            u9Var.setImageDrawable(parentActivity.getDrawable(R.drawable.msg_viewchats).mutate());
                            u9Var.s(AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f));
                            u9Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.F8, f6Var), PorterDuff.Mode.MULTIPLY));
                            ...
                            atomicReference = atomicReference2;
                            frameLayout.setOnClickListener(new ai.s0(atomicReference, l9Var, e5Var322, tL_forumTopic, o2Var, 10));
                            actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.x5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                            if (!z11) {
                            }
                            i19 = i15 + 1;
                    ...
                    atomicReference = atomicReference2;
                    frameLayout.setOnClickListener(new ai.s0(atomicReference, l9Var, e5Var3222, tL_forumTopic, o2Var, 10));
                    actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.x5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                    if (!z11) {
                    }
                    i19 = i15 + 1;
            ...
            arrayList = new ArrayList();
            org.telegram.ui.ActionBar.e5 parentLayout3 = o2Var.getParentLayout();
            if (parentLayout3 == null) {
                ...
                if (pulledDialogs2 != null) {
                    ...
                    for (int i21 = 0; i21 < pulledDialogs2.size(); i21++) {
                        l9 l9Var5 = (l9) pulledDialogs2.get(i21);
                        if (l9Var5.e != null && r5.id != j10) {
                            int i22 = l9Var5.b;
                            if (i22 >= i16) {
                                i16 = i22;
                            }
                            arrayList.add(l9Var5);
                        }
                    }
                } else {
                    i16 = -1;
                ...
                if (parentLayout3.getFragmentStack().size() <= 1 || !(parentLayout3.getFragmentStack().get(parentLayout3.getFragmentStack().size() - 2) instanceof fg1)) {
                    l9 l9Var6 = new l9();
                    arrayList.add(l9Var6);
                    l9Var6.b = -1;
                    l9Var6.a = fg1.class;
                    l9Var6.c = MessagesController.getInstance(o2Var.getCurrentAccount()).getChat(Long.valueOf(-j3));
                } else {
                    l9 l9Var7 = new l9();
                    arrayList.add(l9Var7);
                    l9Var7.b = i16 + 1;
                    l9Var7.a = org.telegram.ui.wy.class;
                    l9 l9Var8 = new l9();
                    arrayList.add(l9Var8);
                    l9Var8.b = -1;
                    l9Var8.a = fg1.class;
                    l9Var8.c = MessagesController.getInstance(o2Var.getCurrentAccount()).getChat(Long.valueOf(-j3));
                }
