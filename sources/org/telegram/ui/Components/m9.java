    ...
    public static org.telegram.ui.ActionBar.n1 b(org.telegram.ui.ActionBar.n2 n2Var, View view, long j3, long j10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        if (j10 == 0 || ChatObject.isMonoForum(n2Var.getCurrentAccount(), j3)) {
            ...
            if (parentLayout2 != null) {
                ...
                actionBarPopupWindow$ActionBarPopupWindowLayout.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G8, e6Var));
                ...
                while (i19 < size3) {
                    ...
                    if (tL_forumTopic != null) {
                        if (tL_forumTopic.id == 1) {
                            u9Var.setImageDrawable(ng.d.c(fragmentView.getContext(), 1.0f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Ac, e6Var), false));
                            i15 = i19;
                        } else if (tL_forumTopic.icon_emoji_id != j11) {
                            i15 = i19;
                            u9Var.setAnimatedEmojiDrawable(new o5(10, n2Var.getCurrentAccount(), tL_forumTopic.icon_emoji_id));
                        } else {
                            i15 = i19;
                        ...
                        i15 = i19;
                        if (chat2 != null) {
                            f9Var.k(n2Var.getCurrentAccount(), chat2);
                            TLRPC.ChatPhoto chatPhoto = chat2.photo;
                            if (chatPhoto != null && (r82 = chatPhoto.strippedBitmap) != 0) {
                                f9Var = r82;
                            }
                            u9Var.h(ImageLocation.getForChat(n2Var.getCurrentAccount(), chat2, 1), "50_50", f9Var, chat2);
                            ...
                            if (l9Var4.a == org.telegram.ui.bo.class && UserObject.isUserSelf(user3)) {
                                ...
                                if (UserObject.isDeleted(user3)) {
                                    ...
                                    f9Var.m(n2Var.getCurrentAccount(), user3);
                                    l9Var = l9Var4;
                                    u9Var.h(ImageLocation.getForUser(n2Var.getCurrentAccount(), user3, 1), "50_50", f9Var, user3);
                                } else {
                                    l9Var = l9Var4;
                                    String userName = UserObject.getUserName(user3);
                                    f9Var.m(n2Var.getCurrentAccount(), user3);
                                    u9Var.h(ImageLocation.getForUser(n2Var.getCurrentAccount(), user3, 1), "50_50", drawable, user3);
                                    str = userName;
                                }
                                textView.setText(str);
                                z11 = false;
                                z10 = true;
                                frameLayout.setBackground(org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.i6, e6Var), 2, -1));
                                org.telegram.ui.ActionBar.d5 d5Var3 = d5Var;
                                atomicReference = atomicReference2;
                                frameLayout.setOnClickListener(new ai.s0(atomicReference, l9Var, d5Var3, tL_forumTopic, n2Var, 10));
                                actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.x5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                                if (!z11) {
                                    FrameLayout frameLayout2 = new FrameLayout(parentActivity);
                                    frameLayout2.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.H8, e6Var));
                            ...
                            atomicReference = atomicReference2;
                            frameLayout.setOnClickListener(new ai.s0(atomicReference, l9Var, d5Var32, tL_forumTopic, n2Var, 10));
                            actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.x5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                            if (!z11) {
                            }
                            i19 = i15 + 1;
                            ...
                            u9Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.F8, e6Var), PorterDuff.Mode.MULTIPLY));
                            ...
                            atomicReference = atomicReference2;
                            frameLayout.setOnClickListener(new ai.s0(atomicReference, l9Var, d5Var322, tL_forumTopic, n2Var, 10));
                            actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.x5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                            if (!z11) {
                            }
                            i19 = i15 + 1;
                    ...
                    atomicReference = atomicReference2;
                    frameLayout.setOnClickListener(new ai.s0(atomicReference, l9Var, d5Var3222, tL_forumTopic, n2Var, 10));
                    actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.x5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                    if (!z11) {
                    }
                    i19 = i15 + 1;
            ...
            if (parentLayout3 == null) {
                ...
                if (parentLayout3.getFragmentStack().size() <= 1 || !(parentLayout3.getFragmentStack().get(parentLayout3.getFragmentStack().size() - 2) instanceof eg1)) {
                    ...
                    l9Var6.b = -1;
                    l9Var6.a = eg1.class;
                    l9Var6.c = MessagesController.getInstance(n2Var.getCurrentAccount()).getChat(Long.valueOf(-j3));
                } else {
                    l9 l9Var7 = new l9();
                    arrayList.add(l9Var7);
                    l9Var7.b = i16 + 1;
                    l9Var7.a = org.telegram.ui.uy.class;
                    l9 l9Var8 = new l9();
                    arrayList.add(l9Var8);
                    l9Var8.b = -1;
                    l9Var8.a = eg1.class;
                    l9Var8.c = MessagesController.getInstance(n2Var.getCurrentAccount()).getChat(Long.valueOf(-j3));
                }
