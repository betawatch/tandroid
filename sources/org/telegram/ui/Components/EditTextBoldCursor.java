...
public class EditTextBoldCursor extends ut {
    ...
    public final void g() {
        ...
        float f10 = width;
        int i11 = f9 >= f10 - 1.0f ? (width + scrollX) - (i10 - this.mTempRect.right) : (Math.abs(f9) <= 1.0f || (TextUtils.isEmpty(getText()) && ((float) (1048576 - scrollX)) <= f10 + 1.0f && max <= 1.0f)) ? scrollX - this.mTempRect.left : ((int) max) - this.mTempRect.left;
    ...
    /* JADX WARN: Removed duplicated region for block: B:119:0x03a2 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:139:0x0450 A[Catch: all -> 0x03c4, TryCatch #1 {all -> 0x03c4, blocks: (B:120:0x03a2, B:122:0x03a6, B:124:0x03aa, B:126:0x03bc, B:129:0x03cd, B:132:0x03d3, B:134:0x03da, B:136:0x03e2, B:137:0x0408, B:139:0x0450, B:141:0x0453, B:142:0x0458, B:145:0x03f5, B:147:0x03fd, B:149:0x03c9), top: B:119:0x03a2 }] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0347 A[Catch: Exception -> 0x0357, TryCatch #3 {Exception -> 0x0357, blocks: (B:11:0x0343, B:13:0x0347, B:163:0x0359), top: B:10:0x0343 }] */
    /* JADX WARN: Removed duplicated region for block: B:163:0x0359 A[Catch: Exception -> 0x0357, TRY_LEAVE, TryCatch #3 {Exception -> 0x0357, blocks: (B:11:0x0343, B:13:0x0347, B:163:0x0359), top: B:10:0x0343 }] */
    /* JADX WARN: Removed duplicated region for block: B:33:0x0485  */
    /* JADX WARN: Removed duplicated region for block: B:45:0x050d A[Catch: all -> 0x04af, TryCatch #4 {all -> 0x04af, blocks: (B:38:0x048d, B:40:0x0494, B:42:0x049c, B:43:0x04c5, B:45:0x050d, B:47:0x0510, B:48:0x0515, B:51:0x04b2, B:53:0x04ba), top: B:37:0x048d }] */
    ...
    */
    public void onDraw(Canvas canvas) {
        ...
        if (length() == 0 || this.transformHintToHeader) {
            ...
            if ((z13 && this.hintAlpha != 1.0f) || (!z13 && this.hintAlpha != 0.0f)) {
                ...
                if (this.hintVisible) {
                    float f14 = (j10 / 150.0f) + this.hintAlpha;
                    this.hintAlpha = f14;
                    if (f14 > 1.0f) {
                        this.hintAlpha = 1.0f;
                    }
                } else {
                    float f15 = this.hintAlpha - (j10 / 150.0f);
                    this.hintAlpha = f15;
                    if (f15 < 0.0f) {
                        this.hintAlpha = 0.0f;
                    }
            ...
            if (n6Var != null && !TextUtils.isEmpty(n6Var.g) && (this.hintVisible || this.hintAlpha != 0.0f)) {
                if (this.hintAnimatedDrawable2 == null) {
                    n6 n6Var2 = this.hintAnimatedDrawable;
                    n6Var2.H = 0.0f;
                    n6Var2.invalidateSelf();
                    ...
                    canvas2.restore();
                    n6 n6Var3 = this.hintAnimatedDrawable;
                    n6Var3.H = 0.0f;
                    n6Var3.invalidateSelf();
                } else {
                    canvas2.save();
                    ...
                    this.hintAnimatedDrawable2.draw(canvas2);
                    canvas2.restore();
                    n6 n6Var4 = this.hintAnimatedDrawable;
                    n6Var4.H = (this.hintAnimatedDrawable2.d() + AndroidUtilities.dp(2.0f)) - this.rightHintOffset;
                    n6Var4.invalidateSelf();
                }
                ...
                int i15 = lineLeft != 0.0f ? (int) (0 - lineLeft) : 0;
                if (this.supportRtlHint && LocaleController.isRTL) {
                    float scrollX = getScrollX() + i15 + (getMeasuredWidth() - lineWidth);
                    ...
                    float scrollX2 = getScrollX() + i15 + this.hintLayoutOffset;
                ...
                if (this.transformHintToHeader) {
                    float f16 = 1.0f - (this.headerAnimationProgress * 0.3f);
                    if (this.supportRtlHint && LocaleController.isRTL) {
                        float f17 = lineWidth + lineLeft;
                        canvas2.translate(f17 - (f17 * f16), 0.0f);
                    } else if (lineLeft != 0.0f) {
                        canvas2.translate((1.0f - f16) * lineLeft, 0.0f);
                    }
                ...
                if (yx0Var == null || !yx0Var.e) {
                    f9 = 2.0f;
                    f10 = 150.0f;
                    Utilities.Callback2<Canvas, Runnable> callback2 = this.drawHint;
                    if (callback2 != null) {
                        callback2.run(canvas2, new gt(i14, this, canvas2));
                    } else {
                    ...
                    EditTextBoldCursor editTextBoldCursor = yx0Var2.a;
                    if (yx0Var2.e) {
                        float f18 = yx0Var2.h * (yx0Var2.f ? yx0Var2.i : 1.0f - yx0Var2.i);
                        int alpha = paint.getAlpha();
                        if (yx0Var2.d != null) {
                            canvas2.save();
                            canvas2.translate(f18, 0.0f);
                            yx0Var2.d.draw(canvas2);
                            canvas2.restore();
                        }
                        if (yx0Var2.b != null) {
                            float f19 = yx0Var2.f ? 1.0f - yx0Var2.i : yx0Var2.i;
                            canvas2.save();
                            f9 = 2.0f;
                        ...
                        if (yx0Var2.c != null) {
                            float f21 = yx0Var2.f ? yx0Var2.i : 1.0f - yx0Var2.i;
                            canvas2.save();
                            f10 = 150.0f;
                            paint.setAlpha((int) (alpha * (yx0Var2.f ? yx0Var2.i : 1.0f - yx0Var2.i)));
                            canvas2.translate(f18, 0.0f);
                            if (yx0Var2.g) {
                                float f22 = (f21 * 0.1f) + 0.9f;
                                canvas2.scale(f22, f22, f18, editTextBoldCursor.getMeasuredHeight() / f9);
                            }
                            yx0Var2.c.draw(canvas2);
                            canvas2.restore();
                            paint.setAlpha(alpha);
                            canvas2.restore();
                        }
                        ...
                        if (this.allowDrawCursor && z10) {
                            ...
                            if (getVerticalOffsetMethod != null) {
                                if ((getGravity() & 112) != 48) {
                                    ...
                                    rect.bottom = i10;
                                    rect.top = bounds.top;
                                    f11 = this.lineSpacingExtra;
                                    if (f11 != 0.0f && lineForOffset < lineCount - 1) {
                                        rect.bottom = (int) (i10 - f11);
                                    }
                                    int centerY = rect.centerY();
                                    int i16 = this.cursorSize;
                                    rect.top = centerY - (i16 / 2);
                                ...
                                rect.top = centerY2 - (i162 / 2);
                                Rect rect42 = this.rect;
                                rect42.bottom = rect42.top + i162;
                                ...
                                if ((getGravity() & 112) != 48) {
                                    ...
                                    rect.top = centerY22 - (i1622 / 2);
                                    Rect rect422 = this.rect;
                                    rect422.bottom = rect422.top + i1622;
                                ...
                                rect.top = centerY222 - (i16222 / 2);
                                Rect rect4222 = this.rect;
                                rect4222.bottom = rect4222.top + i16222;
                    ...
                    try {
                        ...
                        if (getVerticalOffsetMethod != null) {
                            if ((getGravity() & 112) != 48) {
                                ...
                                f13 = this.lineSpacingExtra;
                                if (f13 != 0.0f && lineForOffset3 < lineCount3 - 1) {
                                    rect2.bottom = (int) (i12 - f13);
                                }
                                int centerY3 = rect2.centerY();
                                int i17 = this.cursorSize;
                                rect2.top = centerY3 - (i17 / 2);
                                Rect rect6 = this.rect;
                                rect6.bottom = rect6.top + i17;
                            ...
                            int i172 = this.cursorSize;
                            rect2.top = centerY32 - (i172 / 2);
                            Rect rect62 = this.rect;
                            rect62.bottom = rect62.top + i172;
                            ...
                            if ((getGravity() & 112) != 48) {
                                ...
                                int i1722 = this.cursorSize;
                                rect2.top = centerY322 - (i1722 / 2);
                                Rect rect622 = this.rect;
                                rect622.bottom = rect622.top + i1722;
                            ...
                            int i17222 = this.cursorSize;
                            rect2.top = centerY3222 - (i17222 / 2);
                            Rect rect6222 = this.rect;
                            rect6222.bottom = rect6222.top + i17222;
                ...
                if (this.lineVisible && this.lineColor != 0) {
                    ...
                    elapsedRealtime = (SystemClock.elapsedRealtime() - this.lineLastUpdateTime) / f10;
                    ...
                    int measuredHeight = !this.lineYFix ? getMeasuredHeight() - AndroidUtilities.dp(f9) : Math.min(Math.max(0, (getPaddingTop() + (getPaddingBottom() + ((getLayout() != null ? 0 : getLayout().getHeight()) - getMeasuredHeight()))) - getScrollY()), AndroidUtilities.dp(f9)) + getScrollY() + ((int) this.lineY);
                    i11 = this.lastTouchX;
                    if (i11 < 0) {
                        i11 = getMeasuredWidth() / 2;
                    }
                    int i18 = i11;
                    int max = Math.max(i18, getMeasuredWidth() - i18) * 2;
                    ...
                    if (f12 <= 0.0f) {
                        float interpolation = jr.j.getInterpolation(f12);
                        ...
                        float f23 = i18;
                        canvas2 = canvas;
                        canvas2.drawRect(Math.max(0.0f, f23 - (this.activeLineWidth / f9)) + getScrollX(), measuredHeight - ((int) (interpolation * AndroidUtilities.dp(f9))), Math.min((this.activeLineWidth / f9) + f23, getMeasuredWidth()) + getScrollX(), measuredHeight, this.activeLinePaint);
                    } else {
                        canvas2 = canvas;
                    }
                }
                ...
                this.ellipsizeMatrix.reset();
                this.ellipsizeMatrix.postScale(-1.0f, 1.0f, this.ellipsizeWidth / f9, 0.0f);
        ...
        if (this.lineVisible) {
            ...
            int measuredHeight2 = !this.lineYFix ? getMeasuredHeight() - AndroidUtilities.dp(f9) : Math.min(Math.max(0, (getPaddingTop() + (getPaddingBottom() + ((getLayout() != null ? 0 : getLayout().getHeight()) - getMeasuredHeight()))) - getScrollY()), AndroidUtilities.dp(f9)) + getScrollY() + ((int) this.lineY);
            i11 = this.lastTouchX;
            if (i11 < 0) {
            }
            int i182 = i11;
            int max2 = Math.max(i182, getMeasuredWidth() - i182) * 2;
            if (this.lineActiveness < 1.0f) {
            }
            f12 = this.lineActiveness;
            if (f12 <= 0.0f) {
    ...
    public void setHintText2(CharSequence charSequence, boolean z10) {
        ...
        if (n6Var != null) {
            n6Var.q(charSequence, !LocaleController.isRTL && z10, true);
        }
    }
    ...
    public void setHintText(CharSequence charSequence, boolean z10, TextPaint textPaint) {
        ...
        if (getMeasuredWidth() == 0 ? false : z10) {
            ...
            if (staticLayout != null && !charSequence6.equals(charSequence5)) {
                ValueAnimator valueAnimator = yx0Var.j;
                ...
                if (indexOf >= 0) {
                    ...
                    if (indexOf != 0) {
                        spannableStringBuilder2.setSpan(new gz(z12), 0, indexOf, 0);
                    }
                    if (charSequence3.length() + indexOf != charSequence2.length()) {
                        spannableStringBuilder2.setSpan(new gz(z12), charSequence3.length() + indexOf, charSequence2.length(), 0);
                    }
                    spannableStringBuilder.setSpan(new gz(z12), indexOf, charSequence3.length() + indexOf, 0);
                    int dp = AndroidUtilities.dp(400.0f);
                    Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                    yx0Var.b = new StaticLayout(spannableStringBuilder, textPaint, dp, alignment, 1.0f, 0.0f, false);
                    ...
                    yx0Var.b = new StaticLayout(charSequence5, textPaint, dp2, alignment2, 1.0f, 0.0f, false);
                    yx0Var.c = new StaticLayout(charSequence6, textPaint, AndroidUtilities.dp(400.0f), alignment2, 1.0f, 0.0f, false);
                    yx0Var.d = null;
                    yx0Var.e = true;
                    yx0Var.g = true;
                    yx0Var.h = 0.0f;
                ...
                yx0Var.j.addListener(new zz(yx0Var, 28));
                yx0Var.j.setDuration(150L);
                yx0Var.j.setInterpolator(jr.f);
                yx0Var.j.start();
            }
        } else {
            yx0 yx0Var2 = this.hintAnimator;
            if (yx0Var2 != null) {
                ValueAnimator valueAnimator2 = yx0Var2.j;
