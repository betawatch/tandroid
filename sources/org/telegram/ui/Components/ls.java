...
public final class ls extends b6 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (fragmentContextView2 != null && ((currentStyle = fragmentContextView2.getCurrentStyle()) == 3 || currentStyle == 1)) {
            ...
            for (int i10 = 0; i10 < entriesCount; i10++) {
                ...
                View view2 = ((a6) n10.a).a;
                float c3 = n10.c();
                if (c3 > 0.0f && (fragmentContextView = this.y) != null && (fragmentContextView == view2 || fragmentContextView.getParent() == view2)) {
                    zc capsuleBlobDrawable = this.y.getCapsuleBlobDrawable();
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        return motionEvent.getAction() == 0 && (bVar = this.s) != null && bVar.getBounds().contains((int) motionEvent.getX(), (int) motionEvent.getY());
    }

    @Override // android.view.ViewGroup
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        FragmentContextView fragmentContextView = this.y;
        boolean z4 = fragmentContextView != null && (fragmentContextView == view || fragmentContextView.getParent() == view);
