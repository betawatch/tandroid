...
public final class dt0 implements ViewTreeObserver.OnPreDrawListener {
    ...
    public /* synthetic */ dt0(KeyEvent.Callback callback, int i10, int i11) {
        this.a = i11;
        this.c = callback;
        this.b = i10;
    }
    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                ...
                iv0Var.k0[i11].getViewTreeObserver().removeOnPreDrawListener(this);
                iv0Var.U(i11);
                break;
            default:
                ...
                for (int i12 = 0; i12 < childCount; i12++) {
                    ...
                    if (R >= i11) {
                        ...
                        int min = (int) ((Math.min(y1Var.getMeasuredHeight(), Math.max(0, childAt.getTop())) / y1Var.getMeasuredHeight()) * 100.0f);
