...
public final class dt0 extends FrameLayout {
    ...
    public dt0(int i10, Context context, boolean z10, org.telegram.ui.ActionBar.c6 c6Var, up0 up0Var) {
        ...
        this.a = e6Var;
        e6Var.setBackground(org.telegram.ui.ActionBar.g6.f0(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.i6, c6Var), 2, -1));
        ...
        p80Var.setLinkTextColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.n6, c6Var));
        p80Var.setLineSpacing(AndroidUtilities.dp(3.0f), 1.0f);
        SpannableStringBuilder premiumText = AndroidUtilities.premiumText(LocaleController.getString(z10 ? R.string.MoreSimilarBotsText : R.string.MoreSimilarText), new up0(up0Var, 4));
        ...
        p80Var.setText(AndroidUtilities.replaceCharSequence("%s", premiumText, spannableString2));
