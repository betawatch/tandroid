...
public abstract class um0 extends HorizontalScrollView {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (dc1Var.getChildAt(i11) instanceof ox0) {
                ...
                if (left != f13 && ox0Var.E) {
                    ...
                    ox0Var.x.addListener(new zk0(3, ox0Var, this));
                    ox0Var.x.start();
                }
                ox0Var.E = false;
                if (this.g0) {
    ...
    public final boolean f(MotionEvent motionEvent) {
        ...
        if (this.U != ceil && e(ceil)) {
            for (int i14 = 0; i14 < dc1Var.getChildCount(); i14++) {
                if (i14 != this.U) {
                    ox0 ox0Var = (ox0) dc1Var.getChildAt(i14);
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.om0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (!z10) {
                        ...
                        float f10 = f7;
                        float childCount2 = (scrollX + f10) / (um0Var.j0 * dc1Var.getChildCount());
