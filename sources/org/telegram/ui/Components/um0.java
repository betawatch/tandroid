...
public final class um0 extends kl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            if (i10 != vm0Var.s) {
                if (i10 == vm0Var.x) {
                    v3Var.c(LocaleController.getString(R.string.RecentlyDownloaded), LocaleController.getString(R.string.Settings), new x70(this, 11));
                    return;
                }
                return;
            }
            ...
            if (!v3Var.getText().equals(string)) {
                v3Var.c(string, LocaleController.getString(vm0Var.H ? R.string.PauseAll : R.string.ResumeAll), new tm0(this));
                return;
            }
        ...
        if (E != null) {
            ...
            if (i11 == 1) {
                rm0 rm0Var = (rm0) view;
                rm0Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.d6, false));
                ...
                p10Var.b = id3;
                j7Var.b(vm0Var.I.c(p10Var), id2 == E.getId());
                z10 = id2 == E.getId();
                if (j7Var.O == z12) {
                    return;
                }
            ...
            if (i11 == 2) {
                ...
                p10Var.b = id5;
                i7Var.e(vm0Var.I.c(p10Var), id4 == E.getId());
                z10 = id4 == E.getId();
                if (i7Var.d0 == z12) {
                    return;
                }
