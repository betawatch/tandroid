...
public final class qe0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f7 != 1.0f) {
            paint.setColor(ze0Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5));
        ...
        int themedColor = ze0Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            ze0 ze0Var = this.d;
            if (ze0Var.w != 0 && motionEvent.getY() < ze0Var.w && ze0Var.e.getAlpha() == 0.0f) {
                ze0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) ze0Var.f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.b = true;
        int dp = AndroidUtilities.dp(80.0f);
        we0 we0Var = ze0Var.b;
        int i15 = we0Var.a.E;
        for (int i16 = 0; i16 < i15; i16++) {
            ViewGroup a2 = we0Var.a(this.c, i16);
        ...
        if (re0Var.getPaddingTop() != i17) {
            re0Var.getPaddingTop();
            re0Var.setPadding(0, i17, 0, 0);
        }
        this.b = false;
