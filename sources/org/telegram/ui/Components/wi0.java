...
public class wi0 extends yi0 {
    ...
    @Override // org.telegram.ui.Components.yi0
    ...
    public final void D(boolean z10) {
        ...
        oy oyVar = new oy(22, rLottieNative, rLottieNative2);
        if (z10) {
            DispatchQueuePoolBackground.execute(oyVar);
        } else {
            Utilities.globalQueue.postRunnable(oyVar);
        }
    }
