...
public final class eh0 extends View {
    ...
    public final bh0 k(int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                j3 = new bh0(this, ch0.n);
                j3.t = true;
                j3.x = 200;
                break;
            case 4:
                j3 = new bh0(this, ch0.r);
                break;
            case 5:
                j3 = new bh0(this, ch0.s);
                this.K = j3;
                j3.t = true;
                j3.x = 500;
                break;
            case 6:
                ...
                break;
            case 7:
                j3 = new bh0(this, ch0.w);
                j3.t = true;
                j3.v = 300;
                break;
            case 8:
                j3 = new bh0(this, ch0.x);
                j3.t = true;
                j3.x = 500;
                break;
            case 9:
                j3 = new bh0(this, ch0.y);
                j3.t = true;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        float f21 = 2.0f;
        while (i13 < size) {
            bh0 bh0Var5 = (bh0) arrayList.get(i13);
            boolean z12 = bh0Var5.p;
            float f22 = max;
            wc wcVar = bh0Var5.b;
            float f23 = f20;
            ...
            if (z12) {
                ...
                c6 c6Var = bh0Var5.e;
                f13 = f18;
                RectF rectF2 = bh0Var5.c;
                float f24 = f19;
                eh0 eh0Var = bh0Var5.y;
                f14 = itemWidth;
                RectF rectF3 = bh0Var5.f;
                i11 = i13;
                RectF rectF4 = bh0Var5.g;
                bh0 bh0Var6 = bh0Var3;
                if (bh0Var5.o) {
                    bh0Var5.a();
                } else {
                    boolean z13 = eh0Var.e;
                    float f25 = eh0Var.N;
                    if (z13) {
                        bh0Var5.n = false;
                        rectF2.set(rectF);
                        ...
                        if (rectF3.isEmpty()) {
                            ...
                            boolean z15 = rectF.right + 1.0f >= ((float) eh0Var.getMeasuredWidth()) - f25;
                            if (z14 && z15) {
                                bh0Var = bh0Var4;
                            } else {
                                z11 = z15;
                                bh0 bh0Var7 = eh0Var.L;
                                if (bh0Var7 != null) {
                                    bh0Var = bh0Var4;
                                } else {
                                    bh0Var = bh0Var4;
                                }
                                bh0 bh0Var8 = eh0Var.M;
                                if (bh0Var8 != null) {
                                }
                                i12 = bh0Var5.a;
                                if (((i12 != 5 && i12 != 6) || eh0Var.H != 0) && ((i12 != 3 && i12 != 2) || eh0Var.H != 1)) {
                                    if (!z14 && (bh0Var2 = eh0Var.L) != null && !bh0Var2.o) {
                                        z11 = true;
                                        z14 = false;
                                    } else if (z11) {
                                        bh0 bh0Var9 = eh0Var.M;
                                        if (bh0Var9 != null) {
                                        }
                                    }
                                    if (!z14) {
                        ...
                        if (this.w != null) {
                            ...
                            rectF5.set(rectF);
                            rectF5.inset((1.0f - wcVar.a(0.04f)) * (rectF.width() / 2.0f), (1.0f - wcVar.a(0.04f)) * (rectF.height() / 2.0f));
        ...
        int i14 = 0;
        while (i14 < size) {
            bh0 bh0Var10 = (bh0) arrayList.get(i14);
            boolean z16 = bh0Var10.p;
            wc wcVar2 = bh0Var10.b;
            RectF rectF6 = bh0Var10.d;
            if (z16) {
                f12 = clamp012;
                i10 = i14;
            } else {
                ...
                rectF7.set(rectF6);
                rectF7.inset((1.0f - wcVar2.a(0.04f)) * (rectF6.width() / 2.0f), (1.0f - wcVar2.a(0.04f)) * (rectF6.height() / 2.0f));
                Paint paint = this.b;
                int alpha = paint.getAlpha();
                float b10 = (int) (bh0Var10.b() * clamp012 * alpha);
                ...
                if (this.S != null) {
                    ...
                    paint2.setAlpha((int) (bh0Var10.b() * f12 * alpha2));
        ...
        if (renderNode2 != null && Build.VERSION.SDK_INT >= 29 && renderNode2.hasDisplayList() && canvas.isHardwareAccelerated()) {
            canvas.save();
            org.telegram.ui.o01 o01Var = this.r;
            if (o01Var != null) {
                View view = (View) o01Var.getParent();
                float x10 = view.getX();
        ...
        if (clamp013 > 0.0f) {
            int i15 = 0;
            while (i15 < size) {
                bh0 bh0Var11 = (bh0) arrayList.get(i15);
                if (bh0Var11 != null) {
                    Rect rect = bh0Var11.h;
                    RectF rectF8 = bh0Var11.d;
                    if (!bh0Var11.p) {
                        ...
                        canvas.save();
                        float b11 = bh0Var11.b() * clamp013;
                        float centerX2 = rectF8.centerX();
                        float centerY = rectF8.centerY();
                        float f30 = a2;
                        f10 = clamp01;
                        float a10 = bh0Var11.b.a(0.04f) * f10;
                        ...
                        float f31 = dp * 0.5f;
                        bh0Var11.l.q(rectF8.width() - AndroidUtilities.dp(f21));
                        bh0Var11.m = bh0Var11.l.b.getLineCount() >= 3 ? 0.75f : bh0Var11.l.b.getLineCount() >= 2 ? 0.85f : 1.0f;
                        float max2 = Math.max(0.0f, AndroidUtilities.dpf2(1.33f) + com.google.android.gms.internal.vision.e2.v(bh0Var11.l.j(), bh0Var11.m, f26, 3.0f));
                        rect.set((int) (centerX3 - f31), (int) max2, (int) (centerX3 + f31), (int) (max2 + dp));
                        yi0 yi0Var = bh0Var11.k;
                        if (yi0Var != null) {
                            yi0Var.setBounds(rect);
                        }
                        Drawable drawable = bh0Var11.i;
                        if (drawable != null) {
                            drawable.setBounds(rect);
                        }
                        Drawable drawable2 = bh0Var11.j;
                        if (drawable2 != null) {
                            drawable2.setBounds(rect);
                        }
                        float j3 = ((rect.bottom + rect.top) - ((bh0Var11.l.j() * bh0Var11.m) / f21)) - AndroidUtilities.dp(4.66f);
                        canvas.save();
                        float f32 = bh0Var11.m;
                        f7 = f26;
                        canvas.scale(f32, f32, centerX2, a4.a.A(bh0Var11.l.j(), bh0Var11.m, 2.0f, j3));
                        h01 h01Var = bh0Var11.l;
                        h01Var.c(centerX2 - (h01Var.l() / 2.0f), j3, b11, d, canvas);
                        canvas.restore();
                        float f33 = bh0Var11.q;
                        if (f33 != 1.0f) {
                            canvas.scale(f33, f33, rect.centerX(), rect.centerY());
                        }
                        float f34 = (1.0f - f30) * b11;
                        float f35 = f30 * b11;
                        yi0 yi0Var2 = bh0Var11.k;
                        if (yi0Var2 == null) {
                            h(canvas, bh0Var11.j, f34);
                            h(canvas, bh0Var11.i, f35);
                        } else if (bh0Var11.a == 1) {
                            h(canvas, bh0Var11.j, f34);
                            h(canvas, bh0Var11.k, f35);
                        } else {
                            h(canvas, yi0Var2, b11);
                        }
                        canvas.restore();
                        if (bh0Var11.x > 0 && System.currentTimeMillis() > bh0Var11.x + bh0Var11.w) {
                            bh0Var11.s = false;
                        }
                        if (bh0Var11.s) {
                            g90 g90Var = bh0Var11.r;
                            if (g90Var == null) {
                                g90 g90Var2 = new g90();
                                bh0Var11.r = g90Var2;
                                g90Var2.setCallback(this);
                                bh0Var11.r.f(org.telegram.ui.ActionBar.j6.l1(0.1f, -1), org.telegram.ui.ActionBar.j6.l1(0.3f, -1), org.telegram.ui.ActionBar.j6.l1(0.35f, -1), org.telegram.ui.ActionBar.j6.l1(0.8f, -1));
                                g90 g90Var3 = bh0Var11.r;
                                g90Var3.C = true;
                                g90Var3.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                            } else if (g90Var.b() || bh0Var11.r.c()) {
                                g90 g90Var4 = bh0Var11.r;
                                f11 = clamp013;
                                g90Var4.b = -1L;
                                g90Var4.c = -1L;
                            }
                            ...
                            f11 = clamp013;
                            g90 g90Var5 = bh0Var11.r;
                            if (g90Var5 != null && !g90Var5.c() && !bh0Var11.r.b()) {
                                bh0Var11.r.a();
                            }
                        }
                        g90 g90Var6 = bh0Var11.r;
                        if (g90Var6 != null) {
                            g90Var6.d(rectF8);
                            bh0Var11.r.h(getRoundRadius());
                            bh0Var11.r.setAlpha((int) (b11 * 255.0f));
                            bh0Var11.r.draw(canvas);
                        }
                        i15++;
                        clamp013 = f11;
                        f26 = f7;
        ...
        if (this.E >= AndroidUtilities.dp(8.0f)) {
            ...
            if (action == 0) {
                ...
                while (true) {
                    ...
                    if (!bh0Var2.o && bh0Var2.d.contains(x10, y3)) {
                        this.W = bh0Var2;
                        this.a0 = x10;
                        this.b0 = y3;
                ...
                if (action == 1 && this.W.d.contains(x10, y3)) {
                    ...
                    if (dh0Var != null) {
                        ...
                        if (i12 == 0) {
                            int i13 = bh0Var5.a;
                            RectF rectF = bh0Var5.d;
                            ProfileActivity.Y(((org.telegram.ui.my0) dh0Var).b, i13, rectF.left, rectF.top);
                        } else {
    ...
    public final void p(bh0 bh0Var, boolean z10) {
        if (!z10) {
            ch0 ch0Var = this.J ? ch0.e : ch0.f;
            bh0Var.d(0, ch0Var.b, ch0Var.c);
            bh0Var.c(LocaleController.getString(ch0Var.a));
        } else if (this.J) {
            ch0 ch0Var2 = ch0.e;
            bh0Var.c(LocaleController.getString(ch0Var2.a));
            bh0Var.d(R.raw.profile_unmuting, ch0Var2.b, ch0Var2.c);
        } else {
            ch0 ch0Var3 = ch0.f;
            bh0Var.c(LocaleController.getString(ch0Var3.a));
            bh0Var.d(R.raw.profile_muting, ch0Var3.b, ch0Var3.c);
        }
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || (drawable instanceof g90);
    }
}
