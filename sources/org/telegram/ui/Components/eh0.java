    ...
    public final void c(vu vuVar, Canvas canvas) {
        ...
        if (canvas.isHardwareAccelerated()) {
            ...
            if (childCount > 0) {
                ...
                NotchInfoUtils.NotchInfo notchInfo = gh0Var.n;
                if (notchInfo != null) {
            ...
            int ilerp = (int) ((1.0f - AndroidUtilities.ilerp(gh0Var.e, 0.5f, 1.0f)) * 255.0f);
            int b10 = h7.n.b(ilerp, 0, 255);
            gh0.a((gh0) vuVar.b, beginRecording);
            this.b.endRecording();
            float f21 = this.f;
            float z10 = com.google.android.recaptcha.internal.a.z(f21, 1.0f, 2.0f, com.google.android.recaptcha.internal.a.x(gh0Var.f, 0.5f, f21, (f21 / 4.0f) + 1.0f));
            ...
            float lerp = AndroidUtilities.lerp(0.0f, AndroidUtilities.dp(7.0f) * f23, 0.0f, 0.5f, gh0Var.e);
            ...
            if (gh0Var.n != null) {
                ...
                NotchInfoUtils.NotchInfo notchInfo2 = gh0Var.n;
                if (notchInfo2.isLikelyCircle) {
                    float min = Math.min(notchInfo2.bounds.width(), gh0Var.n.bounds.height()) / 2.0f;
                    RectF rectF3 = gh0Var.n.bounds;
                    float width2 = rectF3.bottom - (rectF3.width() / 2.0f);
                    beginRecording4.drawCircle(gh0Var.n.bounds.centerX(), width2, min, paint2);
                    path.rewind();
                    float f25 = f10 / 2.0f;
                    path.moveTo(gh0Var.n.bounds.centerX() - f25, width2);
                    path.lineTo(gh0Var.n.bounds.centerX(), min + width2 + f10);
                    path.lineTo(gh0Var.n.bounds.centerX() + f25, width2);
                    path.close();
                    beginRecording4.drawPath(path, paint2);
                } else if (notchInfo2.isAccurate) {
                    beginRecording4.drawPath(notchInfo2.path, paint2);
                } else {
                    float max = Math.max(notchInfo2.bounds.width(), gh0Var.n.bounds.height()) / 2.0f;
                    RectF rectF4 = gh0Var.n.bounds;
                    RectF rectF5 = this.h;
                    rectF5.set(rectF4);
            ...
            NotchInfoUtils.NotchInfo notchInfo3 = gh0Var.n;
            if (notchInfo3 != null) {
            ...
            canvas.restore();
            int b11 = h7.n.b((ilerp * 3) / 4, 0, 255);
            if (b11 < 255) {
