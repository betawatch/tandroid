...
public final class um {
    ...
    public static void a(um umVar, MediaController.PhotoEntry photoEntry) {
        ...
        if (photoEntry.isVideo) {
            umVar.r = AndroidUtilities.formatShortDuration(photoEntry.duration);
        } else {
            umVar.r = null;
        }
        if (umVar.c == null) {
            umVar.c = new ImageReceiver(vmVar.z);
            umVar.d = new ImageReceiver(vmVar.z);
            umVar.c.setDelegate(new km(1, umVar, photoEntry));
        }
        String str = photoEntry.thumbPath;
        if (str != null) {
            umVar.c.setImage(ImageLocation.getForPath(str), null, null, null, org.telegram.ui.ActionBar.j6.R4, 0L, null, null, 0);
            return;
        }
        if (photoEntry.path == null) {
            umVar.c.setImageBitmap(org.telegram.ui.ActionBar.j6.R4);
            return;
        }
        if (photoEntry.isVideo) {
            umVar.c.setImage(ImageLocation.getForPath("vthumb://" + photoEntry.imageId + ":" + photoEntry.path), null, null, null, org.telegram.ui.ActionBar.j6.R4, 0L, null, null, 0);
            umVar.c.setAllowStartAnimation(true);
            return;
        }
        umVar.c.setOrientation(photoEntry.orientation, true);
        umVar.c.setImage(ImageLocation.getForPath("thumb://" + photoEntry.imageId + ":" + photoEntry.path), null, null, null, org.telegram.ui.ActionBar.j6.R4, 0L, null, null, 0);
    }

    public static void b(um umVar, pm pmVar, MessageObject.GroupedMessagePosition groupedMessagePosition, boolean z10) {
        RectF rectF = umVar.q;
        RectF rectF2 = umVar.g;
        if (pmVar == null || groupedMessagePosition == null) {
            ...
            umVar.j = AndroidUtilities.lerp(umVar.j, umVar.k, umVar.e());
            RectF rectF3 = umVar.f;
            if (rectF3 != null) {
                AndroidUtilities.lerp(rectF3, rectF2, umVar.e(), umVar.f);
            }
            umVar.k = 0.0f;
            umVar.h = elapsedRealtime;
            return;
        }
        umVar.i = groupedMessagePosition.flags;
        if (z10) {
            float e = umVar.e();
            RectF rectF4 = umVar.f;
            if (rectF4 != null) {
                AndroidUtilities.lerp(rectF4, rectF2, e, rectF4);
            }
            RectF rectF5 = umVar.p;
            if (rectF5 != null) {
                AndroidUtilities.lerp(rectF5, rectF, e, rectF5);
            }
            umVar.j = AndroidUtilities.lerp(umVar.j, umVar.k, e);
    ...
    */
    public final boolean c(Canvas canvas, boolean z10) {
        ...
        wm wmVar2 = vmVar.z;
        xm xmVar = wmVar2.P;
        float f14 = wmVar2.P.J == this ? wmVar2.G : 0.0f;
        ...
        if (photoEntry == null || !photoEntry.hasSpoiler || photoEntry.isChatPreviewSpoilerRevealed) {
            ...
            if (!this.e && this.d.getBitmap() == null && this.c.getBitmap() != null) {
                ...
                this.d.draw(canvas);
                if (this.s == null) {
                    this.s = uh.g.e(wmVar2);
                }
                uh.g gVar = this.s;
                int width = wmVar2.getWidth();
                int height = wmVar2.getHeight();
                wmVar = wmVar2;
                c10 = 3;
                c11 = 2;
                gVar.c(canvas, wmVar, width, height, 1.0f, false);
                canvas.restore();
                wmVar.invalidate();
                wmVar.invalidate();
            }
            ...
            uh.g gVar2 = this.s;
            int width2 = wmVar2.getWidth();
            int height2 = wmVar2.getHeight();
            wmVar = wmVar2;
            c10 = 3;
            c11 = 2;
            gVar2.c(canvas, wmVar, width2, height2, 1.0f, false);
            canvas.restore();
            wmVar.invalidate();
            wmVar.invalidate();
        }
        ...
        int indexOf = vmVar.k.g.indexOf(this.b) + vmVar.b;
        if (indexOf >= 0) {
            str3 = (indexOf + 1) + "";
        }
        ...
        if (str3 == null || !(this.E == null || (str2 = this.F) == null || !str2.equals(str3))) {
            ...
            f11 = dp3;
            textPaint2.setColor(org.telegram.ui.ActionBar.j6.v0(i17, xmVar.a));
            int length = str3.length();
            float f24 = (length == 0 || length == 1 || length == 2) ? 14.0f : length != 3 ? 8.0f : 10.0f;
            this.B.setTextSize(AndroidUtilities.dp(f24));
            float f25 = i15 / 2.0f;
            f12 = f23;
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.W9, xmVar.a);
            Paint paint2 = this.z;
            paint2.setColor(v02);
            float f26 = (int) f25;
            float f27 = dp4;
            canvas2.drawCircle(f26, f26, f27, paint2);
            int offsetColor = AndroidUtilities.getOffsetColor(-1, org.telegram.ui.ActionBar.j6.v0(i17, xmVar.a), 1.0f, 1.0f);
            Paint paint3 = this.A;
        ...
        if (str4 != null) {
            ...
            if (bitmap3 == null || (str = this.H) == null || !str.equals(str4)) {
                ...
                float intrinsicWidth = xmVar.N.getIntrinsicWidth() + this.C.measureText(str4) + AndroidUtilities.dp(15.0f);
                Drawable drawable = xmVar.N;
                float max = Math.max(dp8, AndroidUtilities.dp(4.0f) + xmVar.N.getIntrinsicHeight());
    ...
    public final RectF f(float f7) {
        ...
        vm vmVar = this.O;
        float f10 = (rectF3.left * vmVar.r) + vmVar.n;
        float f11 = (rectF3.top * vmVar.s) + vmVar.p;
        float width = rectF3.width() * vmVar.r;
        float height = rectF3.height() * vmVar.s;
        if (f7 < 1.0f && (rectF = this.f) != null) {
            f10 = AndroidUtilities.lerp((rectF.left * vmVar.r) + vmVar.n, f10, f7);
            f11 = AndroidUtilities.lerp((this.f.top * vmVar.s) + vmVar.p, f11, f7);
            width = AndroidUtilities.lerp(this.f.width() * vmVar.r, width, f7);
            height = AndroidUtilities.lerp(this.f.height() * vmVar.s, height, f7);
        }
        int i10 = this.i;
        if ((i10 & 4) == 0) {
            int i11 = vmVar.m;
