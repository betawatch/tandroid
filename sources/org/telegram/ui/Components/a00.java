...
public final class a00 {
    ...
    public a00(boolean z4, ph.s6 s6Var) {
        this.g1 = z4;
        this.h1 = s6Var;
                            ...
                            if (h16 != 0 && h17 != 0) {
                                ...
                                if (h19 != 0 && h18 != 0) {
                                    ...
                                    if (h21 != 0 && h20 != 0) {
                                        ...
                                        float[] F = zz.F(arrayList2);
                                        float[] F2 = zz.F(arrayList);
                                        ...
                                        if (F2.length >= 256 && F2.length >= 256 && F2.length >= 256 && F.length >= 256) {
                                            for (int i10 = 0; i10 < 256; i10++) {
                                                float f10 = i10;
                                                int min = (int) Math.min(Math.max(F2[i10] + f10, 0.0f), 255.0f);
                                                int min2 = (int) Math.min(Math.max(F2[i10] + f10, 0.0f), 255.0f);
                                                int min3 = (int) Math.min(Math.max(f10 + F2[i10], 0.0f), 255.0f);
                                                allocateDirect.put((byte) Math.min(Math.max(min3 + F[min3], 0.0f), 255.0f));
                                                allocateDirect.put((byte) Math.min(Math.max(min2 + F[min2], 0.0f), 255.0f));
                                                allocateDirect.put((byte) Math.min(Math.max(min + F[min], 0.0f), 255.0f));
