        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.b8
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i12) {
                    case 0:
                        c8 c8Var = this.b;
                        c8Var.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        c8Var.invalidate();
                        break;
                    default:
                        c8 c8Var2 = this.b;
                        c8Var2.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        c8Var2.invalidate();
                        break;
                }
            }
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.b8
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i10) {
                    case 0:
                        c8 c8Var = this.b;
                        c8Var.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        c8Var.invalidate();
                        break;
                    default:
                        c8 c8Var2 = this.b;
                        c8Var2.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        c8Var2.invalidate();
                        break;
                }
            }
