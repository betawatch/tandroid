...
public final class c8 {
    ...
    public c8() {
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            gp gpVar = new gp();
            gpVarArr[i10] = gpVar;
            gpVar.g = AndroidUtilities.dp(24.0f);
            gpVar.k = 1.0f;
        }
        this.h = new Paint(1);
    }
    ...
    public final void b(Canvas canvas, float f10, float f11) {
        ...
        if (LiteMode.isEnabled(32)) {
            ...
            gp[] gpVarArr = this.a;
            gp gpVar = gpVarArr[0];
            for (int i12 = 0; i12 < gpVar.f; i12 += 2) {
                float[] fArr4 = gpVar.j;
            ...
            for (int i14 = 0; i14 < gpVar2.f; i14 += 2) {
                float[] fArr5 = gpVar2.j;
            ...
            float z10 = com.google.android.recaptcha.internal.a.z(1.0f, this.f, 0.04f, 1.0f);
    ...
    public final void c(Canvas canvas, float f10, float f11, boolean z10, float f12, org.telegram.ui.ActionBar.c6 c6Var) {
        if (LiteMode.isEnabled(32)) {
            ...
            if (z10) {
                ...
                paint.setColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.ie, c6Var));
                paint.setAlpha((int) (i10 * f12));
            }
            b(canvas, f10, f11);
        }
    ...
    public final void e(boolean z10, boolean z11, float[] fArr) {
        ...
        if (LiteMode.isEnabled(32)) {
            ...
            if (this.p > 6) {
                ...
                float f14 = f13 / 6.0f;
                if (f14 > 0.52f) {
                    f12 = org.telegram.ui.Cells.pa.b(f14, 0.4f, f11, f12);
                }
            }
            while (true) {
                fArr2 = this.e;
