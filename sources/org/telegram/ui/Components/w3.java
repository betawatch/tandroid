...
public final class w3 extends LinearLayout {
    ...
    public /* synthetic */ w3(Context context, tc0 tc0Var, tc0 tc0Var2, tc0 tc0Var3, int i10) {
        super(context);
        this.a = i10;
        this.c = tc0Var;
        this.d = tc0Var2;
    ...
    public final void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            case 1:
                ...
                tc0 tc0Var2 = this.c;
                tc0Var2.setItemCount(i13);
                x3Var.setItemCount(i13);
                z3Var.setItemCount(i13);
                tc0Var2.getLayoutParams().height = AndroidUtilities.dp(42.0f) * i13;
            ...
            case 2:
                ...
                tc0 tc0Var3 = this.c;
                tc0Var3.setItemCount(i14);
                d4Var.setItemCount(i14);
                e4Var.setItemCount(i14);
                tc0Var3.getLayoutParams().height = AndroidUtilities.dp(42.0f) * i14;
            ...
            case 3:
                ...
                tc0 tc0Var4 = this.c;
                tc0Var4.setItemCount(i15);
                g4Var.setItemCount(i15);
                h4Var.setItemCount(i15);
                tc0Var4.getLayoutParams().height = AndroidUtilities.dp(42.0f) * i15;
            ...
            case 4:
                ...
                tc0 tc0Var5 = this.c;
                tc0Var5.setItemCount(i16);
                tc0Var5.getLayoutParams().height = AndroidUtilities.dp(42.0f) * i16;
                this.b = false;
                super.onMeasure(i10, i11);
                break;
            default:
                ...
                tc0 tc0Var6 = this.c;
                tc0Var6.setItemCount(i17);
                u4Var.setItemCount(i17);
                v4Var.setItemCount(i17);
                tc0Var6.getLayoutParams().height = AndroidUtilities.dp(42.0f) * i17;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public w3(Activity activity, k4 k4Var, l4 l4Var, tc0 tc0Var) {
        super(activity);
        this.a = 4;
        this.d = k4Var;
        this.e = l4Var;
