            ...
            if (i11 != Integer.MIN_VALUE) {
                ...
                while (i11 < size2) {
                    ...
                    if (arrayList4.get(0) instanceof MessageObject) {
                        ...
                        org.telegram.ui.yu0 yu0Var = ((org.telegram.ui.us0) this.W).a.j7;
            ...
            if (i12 != Integer.MAX_VALUE) {
                while (i12 >= 0) {
                    ...
                    if (arrayList4.get(0) instanceof MessageObject) {
                        ...
                        org.telegram.ui.yu0 yu0Var2 = ((org.telegram.ui.us0) this.W).a.j7;
    ...
    */
    public final void b() {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            boolean z12 = arrayList2.size() > 1 && (cv0Var = ((org.telegram.ui.us0) this.W).a.d) != null && cv0Var.K();
            if (this.h != 0 || z12) {
                this.U = true;
        ...
        if (z13) {
            if (this.U) {
                ...
                if (f7 < 1.0f && this.a0 == null) {
                    ...
                    this.a0.addListener(new d40(this, i20));
                    this.a0.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.c40
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            switch (i20) {
                                case 0:
                                    f40 f40Var = this.b;
                                    f40Var.getClass();
                                    f40Var.c0 = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                                    f40Var.invalidate();
                                    break;
                                default:
                                    f40 f40Var2 = this.b;
                                    f40Var2.getClass();
                                    f40Var2.c0 = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                                    f40Var2.invalidate();
                                    break;
                            }
                        }
                ...
                if (this.c0 > 0.0f && arrayList3.size() > 1) {
                    if (this.b0 == null) {
                        ...
                        final int i21 = 0;
                        this.b0.addListener(new d40(this, i21));
                        this.b0.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.c40
                            public final /* synthetic */ f40 b;
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator22) {
                                switch (i21) {
                                    case 0:
                                        f40 f40Var = this.b;
                                        f40Var.getClass();
                                        f40Var.c0 = ((Float) valueAnimator22.getAnimatedValue()).floatValue();
                                        f40Var.invalidate();
                                        break;
                                    default:
                                        f40 f40Var2 = this.b;
                                        f40Var2.getClass();
                                        f40Var2.c0 = ((Float) valueAnimator22.getAnimatedValue()).floatValue();
                                        f40Var2.invalidate();
                                        break;
                                }
                            }
        ...
        if (!z10) {
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
                ...
                org.telegram.ui.cv0 cv0Var2 = ((org.telegram.ui.us0) this.W).a.d;
    ...
    public final void e() {
        ...
        if (i10 >= 0 && i10 < this.e.size()) {
            ...
            e40 e40Var = this.W;
            if (e40Var != null) {
                PhotoViewer photoViewer = ((org.telegram.ui.us0) e40Var).a;
            ...
            if (i26 >= 0) {
                ...
                if (f13 > 0.0f) {
                    ...
                    if (i26 == this.f) {
                        ...
                        wr wrVar = wr.g;
                        this.E = wrVar.getInterpolation(1.0f - f15);
                        if (this.Q) {
                            float f18 = this.y;
                            if (f18 > 0.0f) {
                            ...
                            this.y = wrVar.getInterpolation(this.x);
