...
public final class gz extends vl0 {
    ...
    public gz(lz lzVar, Context context) {
        ...
        fzVar.Y2.r = false;
        fzVar.setNestedScrollingEnabled(false);
        fzVar.setDrawSelection(false);
        fzVar.setOnTouchListener(new m.c2(this, 3));
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        lz lzVar = this.Q;
        LongSparseArray longSparseArray = lzVar.z1;
        LongSparseArray longSparseArray2 = lzVar.y1;
        int i11 = c1Var.f;
        View view = c1Var.a;
        ...
        if (i11 == 0) {
            ...
            if (!lzVar.j1.contains(document) && !lzVar.k1.contains(document)) {
                z10 = false;
            }
            f8Var.setRecent(z10);
            return;
        ...
        if (i11 == 1) {
            ...
            if (num == null) {
                ...
                int B = org.telegram.messenger.ok.B(82.0f, (int) Math.ceil(num.intValue() / lzVar.y0.d), lzVar.h.getHeight());
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                f2Var = new gg.f2(2, context, lzVar.Z1, z10);
                break;
            case 1:
                f2Var = new org.telegram.ui.Cells.l3(context);
                break;
            case 2:
                f2Var = new org.telegram.ui.Cells.o8(this.h, false, false, lzVar.Z1, lzVar.i2);
                break;
            case 3:
            ...
            case 4:
                ...
                f2Var.setLayoutParams(new s4.p0(-1, lzVar.b1));
                break;
            case 5:
