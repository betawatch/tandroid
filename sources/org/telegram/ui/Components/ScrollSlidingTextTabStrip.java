...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView implements Theme.Colorable {
    ...
    public ScrollSlidingTextTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        2 r9 = new 2(context);
        this.tabsContainer = r9;
        r9.setOrientation(0);
        r9.setPadding(AndroidUtilities.dp(7.0f), 0, AndroidUtilities.dp(7.0f), 0);
        r9.setLayoutParams(new FrameLayout.LayoutParams(-1, -1));
        addView(r9);
        updateColors();
    }

    class 2 extends LinearLayout {
        private float sx;
        private float sy;
    ...
    private void checkBoundsAndClipping() {
        ...
        if (blurredBackgroundDrawable != null) {
            blurredBackgroundDrawable.setAlpha(NotificationCenter.invalidateMotionBackground);
    ...
    public void addTextTab(final int i, CharSequence charSequence, SparseArray sparseArray) {
        ...
        int ceil = ((int) Math.ceil(HintView2.measureCorrectly(r6, textView.getPaint()))) + AndroidUtilities.dp(32.0f);
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.tabsContainer) {
            ...
            float f2 = this.indicatorWidth + f + this.indicatorWidthAnimationDx;
            ...
            this.selectorDrawable.setBounds(getPaddingLeft() + ((int) f) + AndroidUtilities.dp(4.0f), getPaddingTop() + AndroidUtilities.dp(4.0f), (getPaddingLeft() + ((int) f2)) - AndroidUtilities.dp(4.0f), (measuredHeight - getPaddingBottom()) - AndroidUtilities.dp(4.0f));
