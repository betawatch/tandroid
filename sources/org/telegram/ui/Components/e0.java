...
public final class e0 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean X(e0 e0Var, org.telegram.ui.ActionBar.f6 f6Var, Context context) {
        ...
        F.c(R.drawable.msg_calendar2, LocaleController.getString(z10 ? R.string.SetReminder : R.string.ScheduleMessage), new org.telegram.ui.ActionBar.q(e0Var, context, f6Var, 6), false);
        F.Z();
        return true;
    }
    ...
    public static void Y(e0 e0Var, View view) {
        ...
        if (TextUtils.isEmpty(e0Var.s0)) {
            ...
            e0Var2 = e0Var;
            e0Var2.b0(F, linearLayout, true, w31.y(w31.E(e0Var.s0, null, null)), null);
        }
    ...
    public final void m0(Editable editable) {
        ...
        if (LanguageDetector.hasSupport()) {
            LanguageDetector.detectLanguage(editable.toString(), new a(this, i11), new org.telegram.ui.gs(i10));
        }
    }
