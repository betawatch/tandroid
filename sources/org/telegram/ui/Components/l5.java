                                ...
                                if (str2 != null) {
                                    ...
                                    if (z10 || !(s || i11 == 14)) {
                                        ...
                                        if ("video/webm".equals(this.e.mime_type)) {
                                            ...
                                            nh.y2 y2Var3 = this.k;
                                            String k10 = vh.w2.k(str4, "_firstframe");
