...
public abstract class hx0 extends vl0 {
    public static final fx0 x3 = new fx0();
    public static final gx0 y3 = new gx0();
    public float X2;
    public dx0[] Y2;
    public final yw0 Z2;
    public final d6 a3;
    ...
    public hx0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.Y2 = null;
        wr wrVar = wr.h;
        this.a3 = new d6(this, 360L, wrVar);
        Paint paint = new Paint(1);
        this.e3 = paint;
        this.m3 = -1;
        this.o3 = 0.0f;
        this.q3 = true;
        this.r3 = new d6(this, 350L, wrVar);
        this.s3 = new d6(this, 350L, wrVar);
        this.t3 = new RectF();
        this.u3 = new RectF();
        this.v3 = new RectF();
        ...
        x3.fetch(UserConfig.selectedAccount, Integer.valueOf(i10), new bi.ab(this, currentTimeMillis, 2));
    }
    ...
    public static void w1(hx0 hx0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j3) {
        ...
        for (int i10 = 0; i10 < tL_messages_emojiGroups.groups.size(); i10++) {
            ...
            dx0 dx0Var = new dx0();
            dx0Var.c = emojiGroup.icon_emoji_id;
            if (emojiGroup instanceof TLRPC.TL_emojiGroupPremium) {
                dx0Var.a = "premium";
            } else {
                dx0Var.a = TextUtils.concat((CharSequence[]) emojiGroup.emoticons.toArray(new String[0])).toString();
            }
            dx0Var.b = emojiGroup instanceof TLRPC.TL_emojiGroupGreeting;
            dx0Var.d = emojiGroup.title;
            dx0VarArr[i10] = dx0Var;
        }
        hx0Var.Y2 = hx0Var.A1(hx0Var.Y2);
        hx0Var.Z2.l();
        hx0Var.setCategoriesShownT(0.0f);
        hx0Var.F1(hx0Var.q3, System.currentTimeMillis() - j3 > 16);
    }
    ...
    public static void y1(RectF rectF, View view) {
        ...
        if (view instanceof cx0) {
            cx0 cx0Var = (cx0) view;
            f7 = com.google.android.gms.internal.vision.e2.z(1.0f, cx0Var.E, 0.15f, 0.85f) * cx0Var.y;
        }
        float f10 = width * f7;
    ...
    public void D1(int i10) {
        ...
        for (int i11 = 0; i11 < getChildCount(); i11++) {
            ...
            if (childAt instanceof cx0) {
                ((cx0) childAt).l(this.m3 == RecyclerView.R(childAt) - 1, true);
            }
        }
        invalidate();
    }
    ...
    public final void F1(boolean z10, boolean z11) {
        ...
        this.p3.addListener(new zn0(this, 6));
        this.p3.setInterpolator(wr.h);
    ...
    */
    ...
    public dx0 getSelectedCategory() {
        int i10;
        dx0[] dx0VarArr = this.Y2;
        if (dx0VarArr == null || (i10 = this.m3) < 0 || i10 >= dx0VarArr.length) {
            return null;
        }
