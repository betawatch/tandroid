...
public final class ou0 implements org.telegram.ui.Cells.l1 {
    ...
    public final void P0(int i10, org.telegram.ui.Cells.u1 u1Var) {
        if (i10 == 80) {
            org.telegram.ui.ActionBar.m2 m2Var = this.c.s.v1;
            MessageObject messageObject = u1Var.getMessageObject();
            org.telegram.ui.Cells.t8 t8Var = ah0.O;
            if (m2Var == null || m2Var.getParentActivity() == null) {
                return;
            }
            m2Var.showDialog(new ah0(m2Var.getContext(), m2Var.getCurrentAccount(), messageObject, m2Var.getResourceProvider()));
        }
    }
    ...
    @Override // org.telegram.ui.Cells.l1
    public final /* synthetic */ org.telegram.ui.hv0 Y1() {
        return null;
    }
    ...
    public final void n(org.telegram.ui.Cells.u1 u1Var, TLRPC.PollAnswer pollAnswer, TLRPC.MessageMedia messageMedia, int i10) {
        ...
        if (geoPoint != null) {
            if (AndroidUtilities.isMapsInstalled(jv0Var.v1)) {
                ...
                iu0Var.setResourceProvider(d6Var);
                TLRPC.TL_message tL_message = new TLRPC.TL_message();
        ...
        if (MessageObject.isAnyKindOfStickerOrEmoji(messageMedia.document)) {
            org.telegram.ui.nt.q().w(jv0Var.v1.getParentActivity());
        ...
        PhotoViewer.t1().J2(null, jv0Var.v1, d6Var);
