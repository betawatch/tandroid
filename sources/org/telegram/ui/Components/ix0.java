...
public class ix0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (visibility != i10 && i10 == 0) {
            if (this.h) {
                ...
                if (view != null) {
                    view.animate().setListener(null).cancel();
                    view.animate().setListener(new hx0(this, 0)).alpha(0.0f).setDuration(150L).start();
                } else {
        ...
        if (view != null) {
            view.animate().setListener(null).cancel();
            view.animate().setListener(new hx0(this, 1)).alpha(0.0f).setDuration(150L).start();
        } else {
    ...
    public void e(boolean z10, boolean z11) {
        if (this.h != z10) {
            ...
            if (z11) {
                ...
                if (view != null) {
                    view.animate().setListener(null).cancel();
                    view.animate().setListener(new hx0(this, 2)).alpha(0.0f).setDuration(150L).start();
                } else {
                    radialProgressView.animate().alpha(0.0f).scaleY(0.5f).scaleX(0.5f).setDuration(150L).start();
                }
    ...
    public ix0(Context context, View view, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.w = UserConfig.selectedAccount;
        this.y = new org.telegram.ui.Cells.t6(this, 25);
        ...
        this.b = w9Var;
        w9Var.setOnClickListener(new i80(this, 18));
        ...
        ub1Var.addView(n90Var, w7.y5.t(-2, -2, 1, 0, 8, 0, 0));
