...
public abstract class ix0 extends wl0 {
    public static final gx0 x3 = new gx0();
    public static final hx0 y3 = new hx0();
    public float X2;
    public ex0[] Y2;
    public final zw0 Z2;
    public final e6 a3;
    ...
    public ix0(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.Y2 = null;
        qr qrVar = qr.h;
        this.a3 = new e6(this, 360L, qrVar);
        Paint paint = new Paint(1);
        this.e3 = paint;
        this.m3 = -1;
        this.o3 = 0.0f;
        this.q3 = true;
        this.r3 = new e6(this, 350L, qrVar);
        this.s3 = new e6(this, 350L, qrVar);
        this.t3 = new RectF();
        this.u3 = new RectF();
        this.v3 = new RectF();
    ...
    public static void A1(RectF rectF, View view) {
        ...
        if (view instanceof dx0) {
            dx0 dx0Var = (dx0) view;
            f7 = com.google.android.gms.internal.vision.e2.z(1.0f, dx0Var.E, 0.15f, 0.85f) * dx0Var.y;
        }
        float f10 = width * f7;
    ...
    public static void y1(ix0 ix0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j3) {
        ...
        for (int i10 = 0; i10 < tL_messages_emojiGroups.groups.size(); i10++) {
            ...
            ex0 ex0Var = new ex0();
            ex0Var.c = emojiGroup.icon_emoji_id;
            if (emojiGroup instanceof TLRPC.TL_emojiGroupPremium) {
                ex0Var.a = "premium";
            } else {
                ex0Var.a = TextUtils.concat((CharSequence[]) emojiGroup.emoticons.toArray(new String[0])).toString();
            }
            ex0Var.b = emojiGroup instanceof TLRPC.TL_emojiGroupGreeting;
            ex0Var.d = emojiGroup.title;
            ex0VarArr[i10] = ex0Var;
        }
        ix0Var.Y2 = ix0Var.C1(ix0Var.Y2);
        ix0Var.Z2.l();
        ix0Var.setCategoriesShownT(0.0f);
        ix0Var.H1(ix0Var.q3, System.currentTimeMillis() - j3 > 16);
    }
    ...
    public void F1(int i10) {
        ...
        for (int i11 = 0; i11 < getChildCount(); i11++) {
            ...
            if (childAt instanceof dx0) {
                ((dx0) childAt).l(this.m3 == RecyclerView.S(childAt) - 1, true);
            }
        }
        invalidate();
    }
    ...
    public final void H1(boolean z10, boolean z11) {
        ...
        this.p3.addListener(new ed0(this, 17));
    ...
    */
    ...
    public ex0 getSelectedCategory() {
        int i10;
        ex0[] ex0VarArr = this.Y2;
        if (ex0VarArr == null || (i10 = this.m3) < 0 || i10 >= ex0VarArr.length) {
            return null;
        }
