...
public class z5 extends ReplacementSpan {
    ...
    public static /* synthetic */ void a(z5 z5Var, ValueAnimator valueAnimator) {
    ...
    public static boolean access$400(z5 z5Var) {
        return (z5Var.moveAnimator == null && z5Var.scaleAnimator == null) ? false : true;
    }
    ...
    public static /* synthetic */ void b(z5 z5Var, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        z5Var.extraScale = floatValue;
    ...
    public static z5 cloneSpan(z5 z5Var, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (document != null) {
            z5Var2 = new z5(document, z5Var.scale, fontMetricsInt != null ? fontMetricsInt : z5Var.fontMetrics);
        } else {
            z5Var2 = new z5(z5Var.documentId, z5Var.scale, fontMetricsInt != null ? fontMetricsInt : z5Var.fontMetrics);
        }
    ...
    */
    ...
    public float getExtraScale() {
        ...
        if (this.isAdded) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.r5
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    switch (i11) {
                        case 0:
                            z5.b(this.b, valueAnimator2);
                            break;
                        default:
                            z5.a(this.b, valueAnimator2);
                            break;
                    }
                }
            });
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.r5
                public final /* synthetic */ z5 b;
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator22) {
                    switch (i10) {
                        case 0:
                            z5.b(this.b, valueAnimator22);
                            break;
                        default:
                            z5.a(this.b, valueAnimator22);
                            break;
                    }
                }
            });
                ...
                while (i12 < arrayList2.size()) {
                    ...
                    if (u5Var != null) {
                        ...
                        if (z5Var.spanDrawn) {
                            ...
                            float max = (list == null || list.isEmpty() || !u5Var.v) ? 1.0f : Math.max(0.0f, list.get(i10).n);
                            u5Var.r = f12;
                            u5Var.s = max;
                            u5Var.getClass();
                            ...
                            if (q5Var2 == null) {
                                if (u5Var.h != null) {
                                    ...
                                    u5Var.h.setAlpha((int) (u5Var.s * 255.0f * f13));
                                ...
                                q5Var2.setColorFilter(colorFilter == null ? org.telegram.ui.ActionBar.j6.v3 : colorFilter);
                                ...
                                if (extraScale2 != 1.0f || u5Var.d.invert) {
                                    ...
                                    q5 q5Var3 = u5Var.f;
                                    Rect rect2 = u5Var.e;
                                    float f17 = u5Var.s * f13;
                                    ai.l4 l4Var = q5Var3.k;
                                    if (l4Var != null) {
                                        l4Var.setImageCoords(rect2);
                                        q5Var3.k.setAlpha(f17);
                                        q5Var3.k.draw(canvas);
                                    }
                                    canvas.restore();
                                } else {
                                    q5 q5Var4 = u5Var.f;
                                    Rect rect3 = u5Var.e;
                                    float f18 = u5Var.s * f13;
                                    ai.l4 l4Var2 = q5Var4.k;
                                    if (l4Var2 != null) {
                                        l4Var2.setImageCoords(rect3);
                                        q5Var4.k.setAlpha(f18);
                                        q5Var4.k.draw(canvas);
                                    }
                                }
    ...
    public static v5 update(int i10, View view, boolean z10, v5 v5Var, boolean z11, Layout... layoutArr) {
        ...
        while (i15 < layoutArr.length) {
            ...
            if (layout == null || !(layout.getText() instanceof Spanned)) {
                ...
                while (z5VarArr != null && i16 < z5VarArr.length) {
                    ...
                    if (z5Var == null) {
                        ...
                        if (v5Var2 == null) {
                            v5Var2 = new v5();
                            v5Var2.a = new ArrayList();
                            v5Var2.b = new HashMap();
                            v5Var2.c = new ArrayList();
                        }
                        ArrayList arrayList2 = v5Var2.a;
                        int i17 = 0;
                        while (true) {
                            ...
                            if (((u5) arrayList2.get(i17)).d == z5Var && ((u5) arrayList2.get(i17)).c == layout) {
                        ...
                        if (u5Var == 0) {
                            ...
                            if (z5Var.documentAbsolutePath != null) {
                                i12 = i15;
                                u5Var2.f = q5.n(UserConfig.selectedAccount, z5Var.getDocumentId(), z5Var.documentAbsolutePath, i13);
                            } else {
                                i12 = i15;
                                TLRPC.Document document = z5Var.document;
                                if (document != null) {
                                    u5Var2.f = q5.m(UserConfig.selectedAccount, i13, document);
                                } else {
                                    long j3 = z5Var.documentId;
                                    if (j3 != 0) {
                                        u5Var2.f = q5.n(UserConfig.selectedAccount, j3, null, i13);
                                    }
                                }
                            }
                            ...
                            HashMap hashMap = v5Var2.b;
                            x5 x5Var = (x5) hashMap.get(layout);
                            if (x5Var == null) {
                                x5Var = new x5(u5Var2.a, layout);
            ...
            if (v5Var2 != null) {
                ArrayList arrayList3 = v5Var2.a;
                int i19 = 0;
                while (i19 < arrayList3.size()) {
                    if (((u5) arrayList3.get(i19)).c == layout) {
        ...
        if (v5Var2 != null) {
            ArrayList arrayList4 = v5Var2.a;
            int i21 = 0;
            while (i21 < arrayList4.size()) {
                Layout layout2 = ((u5) arrayList4.get(i21)).c;
                int i22 = 0;
                while (true) {
