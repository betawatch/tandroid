...
public class qn0 extends FrameLayout {
    ...
    */
    public final void a(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = qn0Var.e;
        float f11 = i11 / 2.0f;
        float measuredWidth = qn0Var.getMeasuredWidth() - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(qn0Var.R * 1.0f) / 2.0f;
        if (g0 == null) {
            g0 = new Path();
        }
        g0.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= qn0Var.O.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) qn0Var.O.get(i12)).first).floatValue() >= dp3) {
                break;
            } else {
                i12++;
            }
        ...
        int size = qn0Var.O.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) qn0Var.O.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) qn0Var.O.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) qn0Var.O.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= qn0Var.O.size() - 1 || ((Float) ((Pair) qn0Var.O.get(i13)).first).floatValue() - floatValue > dp3) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) qn0Var.O.get(i13)).first).floatValue();
            }
            c11 = 1;
        ...
        if (z10 || this.Q != valueOf.longValue()) {
            ...
            try {
                ...
                for (r41 r41Var : r41VarArr) {
                    if (r41Var != null && r41Var.getURL() != null && r41Var.d != null && r41Var.getURL().startsWith("audio?") && (parseInt = Utilities.parseInt((CharSequence) r41Var.getURL().substring(6))) != null && parseInt.intValue() >= 0) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f18 != f19) {
            if (f18 < f19) {
                f11 = 16.0f;
                f12 = 8.0f;
                float c10 = s3.c.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f18);
                this.B = c10;
                if (c10 > f19) {
                    this.B = f19;
                }
                ...
                f11 = 16.0f;
                f12 = 8.0f;
                float c11 = org.telegram.messenger.rl.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f18);
                this.B = c11;
                if (c11 < f19) {
                    this.B = f19;
                }
        ...
        float f22 = this.D;
        if (f22 < 1.0f) {
            float interpolation = 1.0f - ws.c.getInterpolation(Math.min(1.0f, f22 * 3.0f));
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            float interpolation3 = er.f.getInterpolation(this.V);
            canvas2.save();
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        on0 on0Var = this.J;
        int measuredHeight = (on0Var.getMeasuredHeight() / 2) + dp;
        int dp2 = AndroidUtilities.dp(8.0f) + AndroidUtilities.dp(25.0f) + (this.e / 2) + (this.Q > 600000 ? AndroidUtilities.dp(42.0f) : 0);
        on0Var.layout(dp2, measuredHeight - on0Var.getMeasuredHeight(), on0Var.getMeasuredWidth() + dp2, measuredHeight);
    }
    ...
    public qn0(Context context, org.telegram.ui.ActionBar.c6 c6Var, boolean z10) {
        super(context);
        this.h = new y5(this, 0L, 60L, er.g);
        this.r = -100.0f;
        this.s = -1.0f;
        ...
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.g6.f0(i0.b.k(org.telegram.ui.ActionBar.g6.v0(i10, c6Var), 40), 1, AndroidUtilities.dp(16.0f));
        this.A = f02;
