...
public final class rl implements ev0 {
    ...
    public final boolean a() {
        ...
        if ((i10 == 2 || (o2Var instanceof org.telegram.ui.bo)) && !chatAttachAlertPhotoLayout.s0 && !viVar.V && chatAttachAlertPhotoLayout.P != null && !viVar.G) {
            if (o2Var == null) {
                o2Var = LaunchActivity.R();
            }
            if (o2Var != null && o2Var.getParentActivity() != null) {
                if (!chatAttachAlertPhotoLayout.w0) {
                    org.telegram.messenger.w1.p(R.string.GlobalAttachVideoRestricted, new vc(chatAttachAlertPhotoLayout.P, this.c), null);
                    return false;
                }
                ...
                for (int i11 = 0; i11 < 2; i11++) {
                    chatAttachAlertPhotoLayout.S[i11].animate().alpha(0.0f).translationX(AndroidUtilities.dp(30.0f)).setDuration(150L).setInterpolator(qr.f).start();
                }
                ...
                chatAttachAlertPhotoLayout.q0.animate().alpha(0.0f).setDuration(150L).setInterpolator(qrVar).start();
                org.telegram.ui.ActionBar.o2 o2Var2 = viVar.f0;
                this.a = AndroidUtilities.generateVideoPath((o2Var2 instanceof org.telegram.ui.bo) && ((org.telegram.ui.bo) o2Var2).v());
                ...
                final int i13 = 1;
                CameraController.getInstance().recordVideo(chatAttachAlertPhotoLayout.P.getCameraSessionObject(), this.a, viVar.Q0 != 0, new s(this, 21), new Runnable(this) { // from class: org.telegram.ui.Components.ql
                    public final /* synthetic */ rl b;
                ...
                chatAttachAlertPhotoLayout.k0.a(fv0.b);
    ...
    public final void b() {
        ...
        if (shutterButton.getState() == fv0.b) {
            ...
            if (!chatAttachAlertPhotoLayout.x0) {
                org.telegram.messenger.w1.p(R.string.GlobalAttachPhotoRestricted, new vc(chatAttachAlertPhotoLayout.P, this.c), null);
                return;
            }
            org.telegram.ui.ActionBar.o2 o2Var = viVar.f0;
            File generatePicturePath = AndroidUtilities.generatePicturePath((o2Var instanceof org.telegram.ui.bo) && ((org.telegram.ui.bo) o2Var).v(), null);
            boolean isSameTakePictureOrientation = chatAttachAlertPhotoLayout.P.getCameraSession().isSameTakePictureOrientation();
            chatAttachAlertPhotoLayout.P.getCameraSession().setFlipFront((viVar.f0 instanceof org.telegram.ui.bo) || viVar.Q0 == 2);
            chatAttachAlertPhotoLayout.s0 = CameraController.getInstance().takePicture(generatePicturePath, false, chatAttachAlertPhotoLayout.P.getCameraSessionObject(), new ci.hd(this, generatePicturePath, isSameTakePictureOrientation));
