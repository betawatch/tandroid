...
public final class kt extends org.telegram.ui.ActionBar.h3 {
    public static /* synthetic */ void m(kt ktVar) {
        ktVar.dismiss();
        DownloadController.getInstance(ktVar.currentAccount).clearRecentDownloadedFiles();
    }
    ...
    public static void n(Activity activity, org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        final kt ktVar = new kt(activity, false);
        ktVar.setApplyBottomPadding(false);
        ktVar.setApplyTopPadding(false);
        int i10 = org.telegram.ui.ActionBar.j6.d6;
        ktVar.fixNavigationBar(ktVar.getThemedColor(i10));
        LinearLayout linearLayout = new LinearLayout(activity);
        linearLayout.setOrientation(1);
        FrameLayout frameLayout = new FrameLayout(activity);
        frameLayout.addView(linearLayout);
        ImageView imageView = new ImageView(activity);
        imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(ktVar.getThemedColor(org.telegram.ui.ActionBar.j6.i6), 1, -1));
        imageView.setColorFilter(ktVar.getThemedColor(org.telegram.ui.ActionBar.j6.Ji));
        imageView.setImageResource(R.drawable.ic_layer_close);
        final int i11 = 0;
        imageView.setOnClickListener(new View.OnClickListener(ktVar) { // from class: org.telegram.ui.Components.jt
        ...
        kx0 kx0Var = new kx0(activity, ktVar.currentAccount);
        kx0Var.setStickerNum(9);
        kx0Var.getImageReceiver().setAutoRepeat(1);
        linearLayout.addView(kx0Var, w7.a6.t(110, 110, 1, 0, 26, 0, 0));
        ...
        linearLayout.addView(textView, w7.a6.d(-1, -2.0f, 0, 21.0f, 20.0f, 21.0f, 0.0f));
        ...
        linearLayout.addView(textView2, w7.a6.d(-1, -2.0f, 0, 28.0f, 7.0f, 28.0f, 0.0f));
        ...
        linearLayout.addView(textView3, w7.a6.d(-1, 48.0f, 0, 14.0f, 28.0f, 14.0f, 6.0f));
        ...
        linearLayout.addView(textView4, w7.a6.d(-1, 48.0f, 0, 14.0f, 0.0f, 14.0f, 6.0f));
        NestedScrollView nestedScrollView = new NestedScrollView(activity);
        nestedScrollView.addView(frameLayout);
        ktVar.setCustomView(nestedScrollView);
        textView3.setOnClickListener(new org.telegram.ui.sh(27, ktVar, p2Var));
        final int i14 = 1;
        textView4.setOnClickListener(new View.OnClickListener(ktVar) { // from class: org.telegram.ui.Components.jt
            public final /* synthetic */ kt b;
