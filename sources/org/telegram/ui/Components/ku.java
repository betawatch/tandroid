...
public final class ku implements b91 {
    ...
    public final TextureView a(View view, boolean z4, float f10, int i10, boolean z10) {
        ...
        frameLayout.addView(ouVar.c.getAspectRatioView());
        ouVar.K = false;
        ouVar.J = z10;
        if (activity == null) {
            return null;
    ...
    public final TextureView f(View view, boolean z4, int i10, int i11, boolean z10) {
        ...
        if (z4) {
            ...
            TextureView textureView = new TextureView(ouVar.r);
            if (!mg0.x(false, ouVar.r, null, textureView, i10, i11, false)) {
                return null;
            }
            mg0.m0.R = ouVar;
            return textureView;
    ...
    public final void i(boolean z4, w81 w81Var, float f10, boolean z10) {
        ...
        if (!z4) {
            ...
            if (z10) {
                ou ouVar = this.a;
                ouVar.setOnShowListener(ouVar.O);
                rk0 o10 = mg0.o(f10, false);
            ...
            if (z10) {
                ou ouVar2 = this.a;
                ouVar2.M = 4;
                f3Var = ((org.telegram.ui.ActionBar.g3) ouVar2).backDrawable;
                f3Var.setAlpha(1);
        ...
        if (ouVar3.r != null) {
            try {
                viewGroup3 = ((org.telegram.ui.ActionBar.g3) ouVar3).containerView;
                viewGroup3.setSystemUiVisibility(0);
                ou ouVar4 = this.a;
                int i10 = ouVar4.I;
                if (i10 != -2) {
                    ouVar4.r.setRequestedOrientation(i10);
                }
            } catch (Exception e) {
                FileLog.e(e);
            }
