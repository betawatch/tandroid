...
public final class sf0 extends FrameLayout implements f00, bi.yd {
    ...
    */
    public sf0(Context context, h71 h71Var, Bitmap bitmap, Bitmap bitmap2, int i10, MediaController.SavedFilterState savedFilterState, pd0 pd0Var, int i11, boolean z10, boolean z11, ia iaVar, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        ...
        if (h71Var != null) {
            this.i0 = h71Var;
            h71Var.setDelegate(new kf0(this));
        } else {
            this.j0 = true;
            mf0 mf0Var = new mf0(this, context);
            this.i0 = mf0Var;
            if (z11) {
                addView(mf0Var, w7.a6.e(-1, -1, 51));
            }
            mf0Var.setVisibility(4);
            mf0Var.setSurfaceTextureListener(new nf0(this, z11, iaVar));
        }
        hf0 hf0Var = new hf0(context);
        hf0Var.a = new PointF();
        hf0Var.d = new tv0();
        hf0Var.e = new PointF(0.5f, 0.5f);
        hf0Var.f = 0.15f;
        hf0Var.h = 0.35f;
        hf0Var.r = new RectF();
        hf0Var.x = 1.0f;
        ...
        if (z11) {
            addView(hf0Var, w7.a6.e(-1, -1, 51));
        }
        hf0Var.setDelegate(new kf0(this));
        of0 of0Var = this.W;
        ...
        this.p0 = jf0Var;
        jf0Var.setDelegate(new kf0(this));
        jf0Var.setVisibility(4);
        if (z11) {
            addView(jf0Var, w7.a6.e(-1, -1, 51));
        }
        FrameLayout frameLayout = new FrameLayout(context);
        this.f0 = frameLayout;
        addView(frameLayout, w7.a6.e(-1, (!z11 ? 40 : 0) + 186, 83));
        FrameLayout frameLayout2 = new FrameLayout(context);
        frameLayout2.setBackgroundColor(-16777216);
        frameLayout.addView(frameLayout2, w7.a6.e(-1, 48, 83));
        ...
        TextView f7 = org.telegram.ui.Cells.r6.f(frameLayout2, textView, w7.a6.e(-2, -1, 51), context);
        this.g0 = f7;
        ...
        frameLayout2.addView(f7, w7.a6.e(-2, -1, 53));
        LinearLayout linearLayout = new LinearLayout(context);
        frameLayout2.addView(linearLayout, w7.a6.e(-2, -1, 1));
        ...
        linearLayout.addView(imageView, w7.a6.n(56, 48));
        final int i17 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lf0
            ...
            public final void onClick(View view) {
                switch (i17) {
                    case 0:
                        sf0 sf0Var = this.b;
                        sf0Var.y0 = 0;
                        sf0Var.z0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.zf, sf0Var.I0), PorterDuff.Mode.MULTIPLY));
                        sf0Var.A0.setColorFilter((ColorFilter) null);
                        sf0Var.B0.setColorFilter((ColorFilter) null);
                        sf0Var.f();
                        break;
                    case 1:
                        sf0 sf0Var2 = this.b;
                        sf0Var2.y0 = 1;
                        sf0Var2.z0.setColorFilter((ColorFilter) null);
                        sf0Var2.A0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.zf, sf0Var2.I0), PorterDuff.Mode.MULTIPLY));
                        sf0Var2.B0.setColorFilter((ColorFilter) null);
                        sf0Var2.f();
                        break;
                    case 2:
                        sf0 sf0Var3 = this.b;
                        sf0Var3.y0 = 2;
                        sf0Var3.z0.setColorFilter((ColorFilter) null);
                        sf0Var3.A0.setColorFilter((ColorFilter) null);
                        sf0Var3.B0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.zf, sf0Var3.I0), PorterDuff.Mode.MULTIPLY));
                        sf0Var3.f();
                        break;
                    case 3:
                        sf0 sf0Var4 = this.b;
                        ...
                        sf0Var4.W.f = intValue;
                        int i18 = 0;
                        while (i18 < 4) {
                            sf0Var4.u0[i18].a(i18 == intValue, true);
                            i18++;
                        }
                        sf0Var4.p0.invalidate();
                        break;
                    case 4:
                        sf0 sf0Var5 = this.b;
                        sf0Var5.T = 0;
                        sf0Var5.h();
                        sf0Var5.o0.setVisibility(4);
                        c00 c00Var = sf0Var5.l0;
                        if (c00Var != null) {
                    ...
                    case 5:
                        ...
                        sf0Var6.T = 1;
                        sf0Var6.h();
                        hf0 hf0Var2 = sf0Var6.o0;
                        hf0Var2.setVisibility(0);
                        hf0Var2.setType(1);
                        c00 c00Var2 = sf0Var6.l0;
                        if (c00Var2 != null) {
                    ...
                    default:
                        ...
                        sf0Var7.T = 2;
                        sf0Var7.h();
                        hf0 hf0Var3 = sf0Var7.o0;
                        hf0Var3.setVisibility(0);
                        hf0Var3.setType(0);
                        c00 c00Var3 = sf0Var7.l0;
                        if (c00Var3 != null) {
                            c00Var3.e(false, false, false);
                            break;
                        }
                        break;
                }
        ...
        linearLayout.addView(imageView2, w7.a6.n(56, 48));
        final int i18 = 1;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lf0
            public final /* synthetic */ sf0 b;
            ...
            public final void onClick(View view) {
                switch (i18) {
                    ...
                    case 3:
                        ...
                        int i182 = 0;
                        while (i182 < 4) {
                            sf0Var4.u0[i182].a(i182 == intValue, true);
                            i182++;
                        }
                        sf0Var4.p0.invalidate();
                        break;
        ...
        linearLayout.addView(imageView3, w7.a6.n(56, 48));
        final int i19 = 2;
        imageView3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lf0
            public final /* synthetic */ sf0 b;
        ...
        biVar.setAdapter(new rf0(this, context));
        frameLayout.addView(biVar, w7.a6.e(-1, (!z11 ? 60 : 0) + 120, 51));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.t0 = frameLayout3;
        frameLayout3.setVisibility(4);
        frameLayout.addView(frameLayout3, w7.a6.d(-1, 78.0f, 1, 0.0f, (!z11 ? 40 : 0) + 40, 0.0f, 0.0f));
        LinearLayout linearLayout2 = new LinearLayout(context);
        linearLayout2.setOrientation(0);
        frameLayout3.addView(linearLayout2, w7.a6.e(-2, -2, 1));
        int i20 = 0;
        while (i20 < 4) {
            ...
            frameLayout4.addView(this.u0[i20], w7.a6.e(30, 30, 49));
            ...
            if (i20 == 0) {
                ...
                frameLayout4.addView(textView2, w7.a6.d(-2, -2.0f, 49, 0.0f, 38.0f, 0.0f, 0.0f));
                linearLayout2.addView(frameLayout4, w7.a6.k(i20 == 0 ? 0.0f : 30.0f, 0.0f, 0.0f, 0.0f, -2, -2));
                final int i21 = 3;
                frameLayout4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lf0
                    public final /* synthetic */ sf0 b;
        ...
        this.f0.addView(frameLayout5, w7.a6.d(280, 60.0f, 1, 0.0f, (z11 ? 0 : 40) + 40, 0.0f, 0.0f));
        ...
        frameLayout5.addView(textView3, w7.a6.c(60.0f, 80));
        final int i22 = 4;
        textView3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lf0
            public final /* synthetic */ sf0 b;
        ...
        frameLayout5.addView(textView4, w7.a6.d(80, 80.0f, 51, 100.0f, 0.0f, 0.0f, 0.0f));
        final int i23 = 5;
        textView4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lf0
            public final /* synthetic */ sf0 b;
        ...
        frameLayout5.addView(textView5, w7.a6.d(80, 80.0f, 51, 200.0f, 0.0f, 0.0f, 0.0f));
        final int i24 = 6;
        textView5.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lf0
            public final /* synthetic */ sf0 b;
    ...
    public final boolean d() {
        ...
        of0 of0Var = this.W;
        return savedFilterState != null ? (this.G == savedFilterState.enhanceValue && this.I == savedFilterState.contrastValue && this.P == savedFilterState.highlightsValue && this.H == savedFilterState.exposureValue && this.J == savedFilterState.warmthValue && this.K == savedFilterState.saturationValue && this.R == savedFilterState.vignetteValue && this.Q == savedFilterState.shadowsValue && this.S == savedFilterState.grainValue && this.U == savedFilterState.sharpenValue && this.L == savedFilterState.fadeValue && this.M == savedFilterState.softenSkinValue && this.O == savedFilterState.tintHighlightsColor && this.N == savedFilterState.tintShadowsColor && of0Var.b()) ? false : true : (this.G == 0.0f && this.I == 0.0f && this.P == 0.0f && this.H == 0.0f && this.J == 0.0f && this.K == 0.0f && this.R == 0.0f && this.Q == 0.0f && this.S == 0.0f && this.U == 0.0f && this.L == 0.0f && this.M == 0.0f && this.O == 0 && this.N == 0 && of0Var.b()) ? false : true;
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        pd0 pd0Var = this.v0;
        if (pd0Var != null && view == (textureView = this.i0)) {
            canvas.save();
    ...
    public Bitmap getBitmap() {
        c00 c00Var = this.l0;
        if (c00Var == null || !c00Var.f || !c00Var.isAlive()) {
            return null;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.k0) {
            ...
            tv0Var.a = f14;
            tv0Var.b = f15;
            ((FrameLayout.LayoutParams) hf0Var.getLayoutParams()).height = AndroidUtilities.dp(38.0f) + i12;
            ((FrameLayout.LayoutParams) jf0Var.getLayoutParams()).height = AndroidUtilities.dp(28.0f) + i12;
    ...
    public void setEnhanceValue(float f7) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.w5) && RecyclerView.R(childAt) == this.b) {
