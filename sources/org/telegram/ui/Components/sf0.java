    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 2) {
            ...
            if (i14 < 0) {
                f10 = u3.c.c(i14, i11, 0.5f, 1.0f);
            } else {
                if (i14 > AndroidUtilities.displaySize.x - layoutParams.width) {
                    f10 = org.telegram.messenger.x3.A((i14 - r11) + r10, i11, 0.5f, 1.0f);
                }
            }
        ...
        if (abs > dp) {
            ...
            if (i17 >= 0 || i17 <= (-pipRoundVideoView.h) / 4) {
                if (Math.abs(b11 - i17) > dp) {
                    ...
                    if (i18 <= i19 - i20 || i18 >= i19 - ((i20 / 4) * 3)) {
                        if (pipRoundVideoView.a.getAlpha() != 1.0f) {
                            ...
                            if (z10) {
                                z11 = true;
                                arrayList.add(ObjectAnimator.ofFloat(pipRoundVideoView.a, (Property<sf0, Float>) property, 0.0f));
                                animatorSet.addListener(new uf0(pipRoundVideoView, 1));
                            } else {
                                z11 = true;
                            }
                ...
                edit.putInt("sidex", 1);
                if (pipRoundVideoView.a.getAlpha() != 1.0f) {
                    sf0 sf0Var = pipRoundVideoView.a;
                    float[] fArr = new float[1];
                    fArr[c3] = 1.0f;
                    arrayList.add(ObjectAnimator.ofFloat(sf0Var, (Property<sf0, Float>) property, fArr));
                }
        ...
        edit.putInt("sidex", 0);
        if (pipRoundVideoView.a.getAlpha() != f9) {
            arrayList2.add(ObjectAnimator.ofFloat(pipRoundVideoView.a, (Property<sf0, Float>) property, f9));
        }
