...
public final /* synthetic */ class ay implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (i11) {
            ...
            case 2:
                lz lzVar2 = cyVar.E;
                ArrayList arrayList2 = lzVar2.p1;
                xx xxVar2 = cyVar.s;
                if (xxVar2 != null && (stickerSet2 = xxVar2.b) != null) {
                    xxVar2.f = true;
                    tx txVar = lzVar2.R;
                    int i12 = lzVar2.c1;
                    ArrayList arrayList3 = lzVar2.q1;
                    wx wxVar = lzVar2.P;
                    ...
                    while (true) {
                        if (i13 >= wxVar.getChildCount()) {
                            num = null;
                            view2 = null;
                        } else if (!(wxVar.getChildAt(i13) instanceof zx) || (R = RecyclerView.R((view2 = wxVar.getChildAt(i13)))) < 0 || (i10 = txVar.w.get(R)) < 0 || i10 >= arrayList3.size() || arrayList3.get(i10) == null || cyVar.s == null || ((xx) arrayList3.get(i10)).b.id != cyVar.s.b.id) {
                            i13++;
                        } else {
            ...
            case 3:
                ...
                if (xxVar3 != null && (stickerSet3 = xxVar3.b) != null) {
                    xxVar3.f = false;
                    ArrayList arrayList4 = lzVar3.p1;
                    int i14 = lzVar3.c1;
