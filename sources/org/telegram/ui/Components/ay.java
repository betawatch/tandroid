...
public final class ay extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ay(kz kzVar, Context context) {
        super(context);
        this.E = kzVar;
        bj0 bj0Var = new bj0(context);
        this.a = bj0Var;
        bj0Var.f(R.raw.unlock_icon, 24, 24, null);
        int i10 = org.telegram.ui.ActionBar.j6.Te;
        bj0Var.setColorFilter(kzVar.z(i10));
        addView(bj0Var, w7.x5.i(20.0f, 20.0f, 8388611, 10.0f, 15.0f, 0.0f, 0.0f));
        org.telegram.ui.ActionBar.k5 k5Var = new org.telegram.ui.ActionBar.k5(context);
        this.b = k5Var;
        k5Var.setTextSize(15);
        k5Var.setTextColor(kzVar.z(i10));
        k5Var.setTypeface(AndroidUtilities.bold());
        k5Var.setOnClickListener(new zx(this, 0));
        ...
        addView(k5Var, w7.x5.i(-2.0f, -1.0f, 8388611, 15.0f, 15.0f, 0.0f, 0.0f));
        ...
        frameLayout.setOnClickListener(new zx(this, 1));
        ...
        textView2.setBackground(org.telegram.ui.ActionBar.z5.d(new float[]{16.0f}, kzVar.z(i11), kzVar.z(org.telegram.ui.ActionBar.j6.Qh)));
        textView2.setPadding(AndroidUtilities.dp(14.0f), 0, AndroidUtilities.dp(14.0f), 0);
        textView2.setGravity(17);
        textView2.setOnClickListener(new zx(this, 2));
        ...
        textView3.setBackground(org.telegram.ui.ActionBar.z5.d(new float[]{16.0f}, 0, kzVar.z(i11) & 452984831));
        ...
        textView3.setOnClickListener(new zx(this, 3));
        ...
        p0Var.a(LocaleController.getString(R.string.Unlock), new zx(this, 4), false);
        try {
    ...
    public final void a(boolean z10) {
        ...
        boolean z11 = wxVar.f;
        kz kzVar = this.E;
        int i10 = (this.s.e || UserConfig.getInstance(kzVar.c1).isPremium() || kzVar.U0) ? this.s.g ? z11 || kzVar.p1.contains(Long.valueOf(wxVar.b.id)) ? 3 : 2 : 0 : 1;
        if ((i10 == 0) != (this.x == 0)) {
            requestLayout();
        }
        this.x = i10;
        ...
        bj0 bj0Var = this.a;
        if (!z10) {
            bj0Var.setAlpha(i10 == 1 ? 1.0f : 0.0f);
            bj0Var.setTranslationX(i10 == 1 ? 0.0f : -AndroidUtilities.dp(16.0f));
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(bj0Var, (Property<bj0, Float>) property, fArr);
        float[] fArr2 = new float[1];
        fArr2[c10] = i10 == 1 ? 1.0f : 0.0f;
        Property property2 = FrameLayout.ALPHA;
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(bj0Var, (Property<bj0, Float>) property2, fArr2);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            if (this.n != null && (stickerSetById2 = MediaDataController.getInstance(i12).getStickerSetById(this.n.id)) != null && stickerSetById2.set != null) {
                ...
                if (o2Var == null) {
                    o2Var = new ai.y3(this, 6);
                }
                sv.W(o2Var, stickerSetById2, true, null, new xp(this, 14));
                this.n = null;
            }
            ...
            org.telegram.ui.ActionBar.o2 o2Var2 = kzVar.Y1;
            if (o2Var2 == null) {
                o2Var2 = new ai.y3(this, 6);
            }
            org.telegram.ui.ActionBar.o2 o2Var3 = o2Var2;
            oh ohVar = new oh(27, this, stickerSetById);
            Pattern pattern = sv.V;
            if (o2Var3.getFragmentView() != null) {
                MediaDataController.getInstance(o2Var3.getCurrentAccount()).toggleStickerSet(o2Var3.getFragmentView().getContext(), stickerSetById, 0, o2Var3, true, true, ohVar, false);
            }
            this.r = null;
        }
    }
