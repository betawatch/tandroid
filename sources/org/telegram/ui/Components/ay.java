...
public final /* synthetic */ class ay implements View.OnClickListener {
    ...
    public /* synthetic */ ay(cy cyVar, int i10) {
        this.a = i10;
        this.b = cyVar;
    }
    ...
    public final void onClick(View view) {
        ...
        switch (i11) {
            ...
            case 1:
                ...
                if (textView2 == null || textView2.getVisibility() != 0 || !textView2.isEnabled()) {
                    if (textView == null || textView.getVisibility() != 0 || !textView.isEnabled()) {
                        if (b1Var != null && b1Var.getVisibility() == 0 && b1Var.r.isEnabled()) {
                            b1Var.performClick();
                            break;
                        }
                    } else {
            ...
            case 2:
                mz mzVar2 = cyVar.B;
                ArrayList arrayList2 = mzVar2.m1;
                xx xxVar2 = cyVar.s;
                if (xxVar2 != null && (stickerSet2 = xxVar2.b) != null) {
                    xxVar2.f = true;
                    tx txVar = mzVar2.O;
                    int i12 = mzVar2.Z0;
                    ArrayList arrayList3 = mzVar2.n1;
                    kx kxVar = mzVar2.M;
                    if (!arrayList2.contains(Long.valueOf(stickerSet2.id))) {
                        arrayList2.add(Long.valueOf(cyVar.s.b.id));
                    }
                    cyVar.a(true);
                    int i13 = 0;
                    while (true) {
                        if (i13 >= kxVar.getChildCount()) {
                            num = null;
                            view2 = null;
                        } else if (!(kxVar.getChildAt(i13) instanceof zx) || (R = RecyclerView.R((view2 = kxVar.getChildAt(i13)))) < 0 || (i10 = txVar.w.get(R)) < 0 || i10 >= arrayList3.size() || arrayList3.get(i10) == null || cyVar.s == null || ((xx) arrayList3.get(i10)).b.id != cyVar.s.b.id) {
                            i13++;
                        } else {
                    ...
                    if (cyVar.n == null) {
                        ...
                        TLRPC.StickerSet stickerSet4 = cyVar.s.b;
            ...
            case 3:
                mz mzVar3 = cyVar.B;
                xx xxVar3 = cyVar.s;
                if (xxVar3 != null && (stickerSet3 = xxVar3.b) != null) {
                    xxVar3.f = false;
                    ArrayList arrayList4 = mzVar3.m1;
                    int i14 = mzVar3.Z0;
                    ...
                    if (cyVar.r == null) {
                        ...
                        TLRPC.StickerSet stickerSet6 = cyVar.s.b;
