                ...
                if (xxVar2 != null && (stickerSet2 = xxVar2.b) != null) {
                    ...
                    while (true) {
                        if (i13 >= wxVar.getChildCount()) {
                            num = null;
                            view2 = null;
                        } else if (!(wxVar.getChildAt(i13) instanceof zx) || (S = RecyclerView.S((view2 = wxVar.getChildAt(i13)))) < 0 || (i10 = txVar.w.get(S)) < 0 || i10 >= arrayList3.size() || arrayList3.get(i10) == null || cyVar.s == null || ((xx) arrayList3.get(i10)).b.id != cyVar.s.b.id) {
                            i13++;
                        } else {
