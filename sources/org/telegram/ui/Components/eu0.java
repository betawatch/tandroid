...
public final class eu0 implements org.telegram.ui.Cells.k1 {
    public final /* synthetic */ int a;
    public final /* synthetic */ org.telegram.ui.ActionBar.f6 b;
    public final /* synthetic */ gu0 c;

    public eu0(gu0 gu0Var, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        this.c = gu0Var;
        this.a = i10;
        this.b = f6Var;
    }
    ...
    public final void P0(int i10, org.telegram.ui.Cells.t1 t1Var) {
        if (i10 == 80) {
            org.telegram.ui.ActionBar.o2 o2Var = this.c.s.v1;
            MessageObject messageObject = t1Var.getMessageObject();
            org.telegram.ui.Cells.t8 t8Var = qg0.O;
            if (o2Var == null || o2Var.getParentActivity() == null) {
                return;
            }
            o2Var.showDialog(new qg0(o2Var.getContext(), o2Var.getCurrentAccount(), messageObject, o2Var.getResourceProvider()));
        }
    }
    ...
    public final void n(org.telegram.ui.Cells.t1 t1Var, TLRPC.PollAnswer pollAnswer, TLRPC.MessageMedia messageMedia, int i10) {
        ...
        int i13 = this.a;
        if (geoPoint != null) {
            if (AndroidUtilities.isMapsInstalled(zu0Var.v1)) {
                yt0 yt0Var = new yt0(3);
                yt0Var.setResourceProvider(f6Var);
                TLRPC.TL_message tL_message = new TLRPC.TL_message();
                tL_message.local_id = -1;
                tL_message.peer_id = MessagesController.getInstance(i13).getPeer(zu0Var.j1);
                ...
                yt0Var.O0 = false;
                yt0Var.u0(new MessageObject(UserConfig.selectedAccount, tL_message, false, false));
                zu0Var.v1.presentFragment(yt0Var);
                return;
            }
            return;
        }
        if (MessageObject.isAnyKindOfStickerOrEmoji(messageMedia.document)) {
            org.telegram.ui.ut.q().w(zu0Var.v1.getParentActivity());
            org.telegram.ui.ut.q().v(new zt0(this, tL_messageMediaPoll, pollAnswer, t1Var));
        ...
        if (messageMedia3 != null && messageMedia3.geo == null && ((document3 = messageMedia3.document) == null || MessageObject.isVideoDocument(document3))) {
            ...
            arrayList2.add(new au0(i13, a2, false, true));
            arrayList.add(-2);
        } else {
            i11 = -1;
        }
        if (messageObject.expandedExplanation && (pollResults = tL_messageMediaPoll.results) != null && (messageMedia2 = pollResults.solution_media) != null && messageMedia2.geo == null && ((document2 = messageMedia2.document) == null || MessageObject.isVideoDocument(document2))) {
            ...
            arrayList2.add(new bu0(i13, a10, false, true));
            arrayList.add(-3);
        }
        int i14 = i13;
        ...
        while (i15 < arrayList3.size()) {
            ...
            if (messageMedia4 != null && messageMedia4.geo == null && ((document = messageMedia4.document) == null || MessageObject.isVideoDocument(document))) {
                ...
                i12 = i14;
                message = message2;
                arrayList2.add(new cu0(i12, a11, false, true));
        ...
        PhotoViewer.t1().J2(null, zu0Var.v1, f6Var);
        PhotoViewer.t1().a2(arrayList2, i11, zu0Var.j1, 0L, 0L, new du0(this));
    }
