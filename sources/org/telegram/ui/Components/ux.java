...
public final class ux extends jt {
    ...
    public final void a(Canvas canvas, long j3, int i10, int i11, float f7) {
        ...
        if (!z11) {
            boolean z12 = lzVar.u2 > 0 && SystemClock.elapsedRealtime() - lzVar.u2 < wxVar.w1();
        ...
        if (this.O != null) {
            ...
            while (i11 < this.O.size()) {
                ...
                if (uyVar.getSpan() == null || (q5Var = (q5) lzVar.d2.get(uyVar.d.getDocumentId())) == null) {
                    ...
                    if (lzVar.u2 > 0 && SystemClock.elapsedRealtime() - lzVar.u2 < wxVar2.w1() && lzVar.s2 >= 0 && lzVar.t2 >= 0 && lzVar.u2 > 0) {
                        ...
                        if (i13 >= 0 && i13 < i14) {
                            ...
                            wxVar = wxVar2;
                            float a2 = w7.p.a(com.google.android.gms.internal.vision.e2.v(max, 0.45f, SystemClock.elapsedRealtime() - lzVar.u2, Math.max(400L, Math.min(45, lzVar.t2 - lzVar.s2) * 35)), 0.0f, 1.0f);
                            float f14 = f11;
                            float interpolation = rr.g.getInterpolation(w7.p.a((SystemClock.elapsedRealtime() - lzVar.u2) / max, 0.0f, 1.0f));
                            float f15 = i13;
                            float f16 = i14;
