...
public abstract class ux extends rl0 {
    public boolean U2;
    ...
    */
                ...
                if (kzVar.a2 != null && ixVar != null) {
                    for (i12 = 0; i12 < ixVar.getChildCount(); i12++) {
                        ...
                        if (z4 && childAt != null && RecyclerView.R(childAt) == kzVar.q2 - 1) {
                            float interpolation = mr.g.getInterpolation(k7.n.a((SystemClock.elapsedRealtime() - kzVar.s2) / 140.0f, 0.0f, 1.0f));
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return super.onInterceptTouchEvent(motionEvent) || org.telegram.ui.rt.q().r(motionEvent, this, this.c3.d2, this.m2);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int[] iArr = kzVar.A1;
        qu quVar = kzVar.y1;
        if (kzVar.O1 != null && quVar != null) {
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                if (quVar != null && quVar.isShowing() && !quVar.d) {
                    quVar.dismiss();
                    int i10 = quVar.c.n[0];
                ...
                quVar.c.getLocationOnScreen(iArr);
                int dp = (int) (x10 - (AndroidUtilities.dp(3.0f) + iArr[0]));
                boolean z4 = quVar.d;
                pu puVar = quVar.c;
                if (!z4) {
                    int max = Math.max(0, Math.min(5, dp / (AndroidUtilities.dp(4.0f) + quVar.e)));
                    if (puVar.n[0] != max) {
                        AndroidUtilities.vibrateCursor(puVar);
                        int[] iArr2 = puVar.n;
                        if (iArr2[0] != max) {
                            iArr2[0] = max;
                            puVar.invalidate();
            ...
            if (quVar == null || !quVar.d || quVar.isShowing()) {
                return true;
            }
        }
