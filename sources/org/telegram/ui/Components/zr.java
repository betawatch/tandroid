            ...
            case 0:
                ...
                if (gsVar.b0 != null) {
                    ...
                    if (gsVar.z0) {
                        ...
                        z11.K(i10 == 2);
                        z11.f = gsVar.B0;
                        z11.D = new org.telegram.ui.qf(29, gsVar, v51Var);
                        arrayList.add(z11);
                        if (!gsVar.B0) {
                    ...
                    if (!gsVar.h0 && fsVar2.c()) {
                        if (gsVar.g0) {
                            ...
                            m10.t = gsVar.S();
                            m10.f = gsVar.y0;
                            m10.D = new org.telegram.ui.Cells.wa(gsVar, i11, v51Var, 6);
                            arrayList.add(m10);
                            if (!gsVar.y0) {
                        ...
                        if (gsVar.o0) {
                            ...
                            if (gsVar.q0 == 0) {
                                ...
                                arrayList.add(h51.A(104, AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("CommunityBanFromCommunityInfo", participantJoinedChats != null ? participantJoinedChats.joined_chat_ids.size() : 1, new Object[0]), new as(gsVar, 1)), true)));
                                break;
                            }
                        }
                    }
