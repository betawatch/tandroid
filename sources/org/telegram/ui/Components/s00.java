...
public class s00 extends View {
    ...
    */
    public final r00 a(boolean z10) {
        ...
        try {
            ...
            if (this.h && nextInt == 0) {
                r00Var.a = (byte) 2;
                r00Var.b = (byte) Utilities.random.nextInt(F.length);
            } else if (this.n && Utilities.random.nextBoolean()) {
                r00Var.a = (byte) 2;
                r00Var.b = (byte) Utilities.random.nextInt(G.length);
            } else {
                r00Var.b = (byte) Utilities.random.nextInt(E.length);
            }
            ...
            if (b10 != 0 && b10 != 2) {
                ...
                r00Var.j = com.google.android.gms.internal.vision.e2.B(Utilities.random.nextFloat(), AndroidUtilities.dp(4.0f), AndroidUtilities.dp(1.2f), r00Var.c == 0 ? 1 : -1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (i11 < size) {
                ...
                if (b10 == 1) {
                    ...
                    if (b10 == 2) {
                        ...
                        if (drawable != null) {
                            ...
                            canvas.scale(f11, f11, r00Var.g, r00Var.h);
            ...
            float f13 = r00Var.g;
            float f14 = r00Var.j;
            r00Var.g = (f14 * f12) + f13;
            r00Var.h = (r00Var.k * f12) + r00Var.h;
            if (r00Var.e != 0) {
                float dp = AndroidUtilities.dp(1.0f) * 0.5f;
                if (r00Var.e == 1) {
                    float x10 = com.google.android.gms.internal.vision.e2.x(dp, f12, 0.05f, r00Var.j);
                    r00Var.j = x10;
                    if (x10 >= dp) {
                        r00Var.e = (byte) 2;
                    }
                } else {
                    float f15 = r00Var.j - ((dp * f12) * 0.05f);
                    r00Var.j = f15;
                    if (f15 <= (-dp)) {
                        r00Var.e = (byte) 1;
                    }
            ...
            boolean z10 = f19 < f18;
            if (f19 > f18) {
                r00Var.k = ((AndroidUtilities.dp(1.0f) / 3.0f) * f12 * s00Var2.e) + f19;
            } else {
                r00Var.k = a4.a.e(AndroidUtilities.dp(1.0f), 3.0f, f12, f19);
            }
            if (z10 && r00Var.k > f18) {
                s00Var2.f++;
            }
            byte b11 = r00Var.a;
            if (b11 == 1 || b11 == 2) {
                short s10 = (short) ((f12 * 10.0f) + r00Var.i);
                r00Var.i = s10;
                if (s10 > 360) {
                    r00Var.i = (short) (s10 - 360);
                }
            }
