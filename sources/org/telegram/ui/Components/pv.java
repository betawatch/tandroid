    ...
    public pv(uv uvVar, Context context, boolean z10) {
        ...
        if (z10) {
            ...
            if (UserConfig.getInstance(i11).isPremium()) {
                ...
                this.e = p0Var;
                p0Var.a(LocaleController.getString(R.string.Unlock), new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mv
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (i15) {
                            case 0:
                                ...
                                break;
                            case 1:
                                uv.W(pvVar.n, pvVar.r, true, null, null);
                                pvVar.a(true, true);
                                break;
                            case 2:
                                ai.y3 y3Var = pvVar.n;
                                TLRPC.TL_messages_stickerSet tL_messages_stickerSet = pvVar.r;
                                yp ypVar = new yp(pvVar, 12);
            ...
            textView.setBackground(org.telegram.ui.ActionBar.w5.e(new float[]{14.0f}, uvVar.getThemedColor(i15)));
            textView.setPadding(org.telegram.ui.Cells.c1.c(18.0f, R.string.Add, textView), 0, AndroidUtilities.dp(18.0f), 0);
            textView.setGravity(17);
            textView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mv
                public final /* synthetic */ pv b;
            ...
            textView2.setTextColor(uvVar.getThemedColor(i15));
            textView2.setBackground(org.telegram.ui.ActionBar.h6.Y(uvVar.getThemedColor(i15) & 268435455, 4, 4));
            ...
            textView2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mv
                public final /* synthetic */ pv b;
        ...
        n90Var.setTextColor(uvVar.getThemedColor(org.telegram.ui.ActionBar.h6.j5));
        if (z10) {
        ...
        if (!z10) {
            ...
            textView3.setTextColor(uvVar.getThemedColor(org.telegram.ui.ActionBar.h6.q5));
        ...
        if (z10) {
            ...
            final int i17 = 3;
            u0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mv
                public final /* synthetic */ pv b;
