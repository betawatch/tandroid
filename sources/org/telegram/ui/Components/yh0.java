...
public final class yh0 implements zh0 {
    ...
    public final void c(ev evVar, Canvas canvas) {
        ...
        Paint paint;
        ai0 ai0Var = this.k;
        Paint paint2 = ai0Var.a;
        Path path = ai0Var.b;
        if (canvas.isHardwareAccelerated()) {
            float width = ai0Var.getWidth();
            float height = ai0Var.getHeight();
            RectF rectF = this.g;
            ...
            if (childCount > 0) {
                ...
                NotchInfoUtils.NotchInfo notchInfo = ai0Var.n;
                if (notchInfo != null) {
            ...
            ai0.a((ai0) evVar.b, beginRecording);
            this.b.endRecording();
            float f21 = this.f;
            float w10 = e2.c.w(f21, 1.0f, 2.0f, e2.c.u(ai0Var.f, 0.5f, f21, (f21 / 4.0f) + 1.0f));
            ...
            if (ai0Var.n != null) {
                ...
                NotchInfoUtils.NotchInfo notchInfo2 = ai0Var.n;
                if (notchInfo2.isLikelyCircle) {
                    float min = Math.min(notchInfo2.bounds.width(), ai0Var.n.bounds.height()) / 2.0f;
                    RectF rectF3 = ai0Var.n.bounds;
                    float width2 = rectF3.bottom - (rectF3.width() / 2.0f);
                    beginRecording4.drawCircle(ai0Var.n.bounds.centerX(), width2, min, paint2);
                    path.rewind();
                    float f25 = f10 / 2.0f;
                    path.moveTo(ai0Var.n.bounds.centerX() - f25, width2);
                    path.lineTo(ai0Var.n.bounds.centerX(), min + width2 + f10);
                    path.lineTo(ai0Var.n.bounds.centerX() + f25, width2);
                    path.close();
                    beginRecording4.drawPath(path, paint2);
                } else if (notchInfo2.isAccurate) {
                    beginRecording4.drawPath(notchInfo2.path, paint2);
                } else {
                    float max = Math.max(notchInfo2.bounds.width(), ai0Var.n.bounds.height()) / 2.0f;
                    RectF rectF4 = ai0Var.n.bounds;
                    RectF rectF5 = this.h;
                    rectF5.set(rectF4);
            ...
            NotchInfoUtils.NotchInfo notchInfo3 = ai0Var.n;
            if (notchInfo3 != null) {
