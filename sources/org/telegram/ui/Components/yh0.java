...
public class yh0 extends wp implements NotificationCenter.NotificationCenterDelegate {
    public boolean A0;
    public boolean B0;
    public final vl0 C0;
    public final xh0 D0;
    ...
    public yh0(Context context, org.telegram.ui.ActionBar.k kVar, vl0 vl0Var, org.telegram.ui.q4 q4Var) {
        super(context);
        this.x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
    ...
    public final boolean H(e71 e71Var, ImageLocation imageLocation, ImageLocation imageLocation2, boolean z10) {
    ...
    public final void K() {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt instanceof v9) {
                v9 v9Var = (v9) childAt;
                if (v9Var.getImageReceiver().hasStaticThumb()) {
                    Drawable drawable = v9Var.getImageReceiver().getDrawable();
                            ...
                            if (forPhoto != null) {
                                ...
                                if (imageLocation3 == null) {
                                    ...
                                    if (photo2.video_sizes.isEmpty()) {
                                        ...
                                        if (vectorMarkupVideoSize != null) {
                                            user3 = user;
                                            arrayList11.add(new e71(vectorMarkupVideoSize, user != null && user3.premium, 2));
                                            obj = null;
                                            arrayList9.add(null);
                                            arrayList6.add(null);
                                        } else {
                                ...
                                if (photo2.video_sizes.isEmpty()) {
                                    ...
                                    if (vectorMarkupVideoSize2 != null) {
                                        user = user2;
                                        arrayList11.add(new e71(vectorMarkupVideoSize2, user2 != null && user2.premium, 2));
                                        z12 = false;
                                        arrayList9.add(null);
                                        arrayList6.add(null);
                                    } else {
    ...
    public float getCurrentItemProgress() {
        c6 animation;
        v9 currentItemView = getCurrentItemView();
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (xh0Var != null) {
            ...
            org.telegram.ui.pv0 pv0Var = this.h1;
            th0 th0Var = this.G0;
            if (pv0Var != null && getCurrentItemView() != null) {
                if (action != 0 && this.I0) {
                    org.telegram.ui.pv0 pv0Var2 = this.h1;
                    if (!pv0Var2.n) {
                        pv0Var2.a(MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0), this, getCurrentItemView().getImageReceiver(), null, 0);
                    }
                }
    ...
    public void setAnimatedFileMaybe(c6 c6Var) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof v9) && xh0Var.k(xh0Var.d.indexOf(childAt)) == 0) {
                v9 v9Var = (v9) childAt;
                c6 animation = v9Var.getImageReceiver().getAnimation();
                if (animation != c6Var) {
                    if (animation != null) {
                        animation.w(v9Var);
                    }
                    v9Var.setImageDrawable(c6Var);
                    c6Var.f(this);
                    c6Var.R = true;
                }
            }
    ...
    public void setParentAvatarImage(v9 v9Var) {
        xh0 xh0Var = this.D0;
        if (xh0Var != null) {
            xh0Var.g = v9Var;
        }
    ...
    public yh0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, vl0 vl0Var, org.telegram.ui.m01 m01Var, th0 th0Var, ph0 ph0Var) {
        super(context);
        this.x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.C0 = vl0Var;
        this.z0 = kVar;
        xh0 xh0Var = new xh0(this, getContext(), m01Var);
        this.D0 = xh0Var;
        setAdapter((vp) xh0Var);
        this.y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = th0Var;
        b(new rh0((org.telegram.ui.pz0) this));
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.dialogPhotosLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoadProgressChanged);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.reloadDialogPhotos);
