...
public final class yh0 extends wp {
    ...
    */
    public final Object e(z4.g gVar, int i10) {
        ...
        if (i12 != 0) {
            ...
            if (i12 >= 0 && i12 < arrayList6.size()) {
                ...
                vh0Var.c.o((d71) arrayList5.get(i12), imageLocation, null, (ImageLocation) arrayList3.get(i12), (ImageLocation) arrayList4.get(i12), (imageLocation2 == null || !(imageLocation2.photoSize instanceof TLRPC.TL_photoStrippedSize)) ? null : "b", ((Integer) arrayList2.get(i12)).intValue(), "avatar_" + zh0Var.E0);
            ...
            if (!zh0Var.J0 || imageLocation3 == null) {
                ...
                if (imageLocation3.imageType == 2) {
                    ...
                    if (bitmap == null && arrayList5.get(i12) == null) {
                        ...
                        vh0Var.c.o((d71) arrayList5.get(i12), (ImageLocation) arrayList6.get(i12), str, (ImageLocation) arrayList3.get(i12), zh0Var.K0, null, ((Integer) arrayList2.get(i12)).intValue(), sb3);
                    } else {
                        vh0Var.c.o((d71) arrayList5.get(i12), imageLocation3, null, (ImageLocation) arrayList3.get(i12), (ImageLocation) arrayList4.get(i12), (imageLocation4 == null || !(imageLocation4.photoSize instanceof TLRPC.TL_photoStrippedSize)) ? null : "b", ((Integer) arrayList2.get(i12)).intValue(), sb3);
                    }
                    z10 = z11;
                    if ((i12 >= 0 || i12 >= arrayList.size() || arrayList.get(i12) == null) ? z10 : true) {
                    }
    ...
    @Override // org.telegram.ui.Components.wp
    public final int j() {
        zh0 zh0Var = this.h;
        int size = zh0Var.X0.size();
        if (zh0Var.i1) {
