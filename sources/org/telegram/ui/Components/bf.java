...
public final class bf extends zf {
    ...
    public final void onAttachedToWindow() {
        ...
        if (rnVar == null || rnVar.getParentLayout() == null || !((ActionBarLayout) chatActivityEnterView.K2.getParentLayout()).b) {
    ...
    @Override // org.telegram.ui.Components.zf, org.telegram.ui.Components.lt, org.telegram.ui.Components.EditTextBoldCursor, android.widget.TextView, android.view.View
    ...
    @Override // org.telegram.ui.Components.zf, org.telegram.ui.Components.lt, android.widget.EditText, android.widget.TextView
                ...
                try {
                    ...
                    if (primaryClip != null && primaryClip.getItemCount() >= 1 && primaryClip.getDescription() != null && primaryClip.getDescription().hasMimeType("text/html")) {
                        ...
                        if (!TextUtils.isEmpty(htmlText)) {
                            ...
                            ArrayList z10 = rh.v3.z(htmlText, hashMap);
                            if (!z10.isEmpty()) {
                                if (!rh.u4.f(z10, hashMap)) {
                                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(rh.u4.j(z10, false));
                                    ...
                                    gi0[] gi0VarArr = (gi0[]) chatActivityEnterView.A0.getText().getSpans(max, min, gi0.class);
                                    ...
                                    bfVar.setText(bfVar.getText().replace(max, min, spannableStringBuilder));
    ...
    @Override // org.telegram.ui.Components.zf, org.telegram.ui.Components.EditTextBoldCursor, android.widget.TextView, android.view.View
    ...
    @Override // org.telegram.ui.Components.zf, org.telegram.ui.Components.nt
