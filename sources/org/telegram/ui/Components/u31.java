...
public abstract class u31 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public u31(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        nVar.setText(Emoji.replaceEmoji(charSequence == null ? "" : charSequence.toString(), nVar.getPaint().getFontMetricsInt(), true));
        ...
        d90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.uf));
    ...
    public static void p(u31 u31Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            org.telegram.messenger.w1.p(bool.booleanValue() ? R.string.TranslationFailedAlert1 : R.string.TranslationFailedAlert2, new yc((FrameLayout) u31Var.containerView, u31Var.resourcesProvider), null);
            q31 q31Var = u31Var.x.e;
    ...
    public final void M() {
        ...
        if (this.f && inputPeer != null) {
            ...
            this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new org.telegram.messenger.a(), new bi.f0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.ro(17, this, tL_textWithEntities)));
    }
