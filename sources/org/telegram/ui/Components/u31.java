...
public abstract class u31 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public u31(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        d90Var.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.gc));
        d90Var.setTextIsSelectable(true);
        d90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.h6.uf));
        ...
        textView.setBackground(org.telegram.ui.ActionBar.x5.e(new float[]{24.0f}, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Oh, false)));
        textView.setOnClickListener(new y70(this, 23));
    ...
    public static m31 J(Activity activity, org.telegram.ui.xn xnVar, TLRPC.InputPeer inputPeer, int i10, boolean z10, String str, String str2, CharSequence charSequence, boolean z11, org.telegram.ui.uf ufVar, Runnable runnable) {
    ...
    public static void K(Context context, org.telegram.ui.ActionBar.n2 n2Var, String str, String str2, CharSequence charSequence, org.telegram.ui.j20 j20Var, org.telegram.ui.Cells.g gVar) {
        if (context == null) {
            return;
        }
    ...
    public static void m(u31 u31Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        org.telegram.messenger.z0.p(R.string.TranslationFailedAlert2, new xc((FrameLayout) u31Var.containerView, u31Var.resourcesProvider), null);
        q31 q31Var = u31Var.x.e;
        String str = u31Var.w;
        u31Var.v = str;
        q31Var.setText(E(str, null, null));
        t31Var.D(g31Var);
    }
    ...
    public static void o(u31 u31Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = u31Var.r;
        u31Var.b = null;
    ...
    public static void p(u31 u31Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            org.telegram.messenger.z0.p(bool.booleanValue() ? R.string.TranslationFailedAlert1 : R.string.TranslationFailedAlert2, new xc((FrameLayout) u31Var.containerView, u31Var.resourcesProvider), null);
            q31 q31Var = u31Var.x.e;
            String str2 = u31Var.w;
            u31Var.v = str2;
            q31Var.setText(E(str2, null, null));
            t31Var.D(g31Var);
        }
    }
    ...
    public static boolean u(u31 u31Var) {
        ...
        return f7 >= ((float) ((h31Var.getHeight() - h31Var.getPaddingTop()) - h31Var.getPaddingBottom()));
    }
    ...
    public static void x(String str, String str2, String str3, Utilities.Callback2 callback2) {
        ...
        while (i13 < arrayList.size()) {
            ...
            new k31(str2, str3, (String) arrayList.get(i13), new ei.h1(zArr, arrayList2, i13, callback22, 5)).start();
            i13++;
    ...
    public final void M() {
        ...
        this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.mo(17, this, tL_textWithEntities)));
    }
