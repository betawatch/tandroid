...
public abstract class u31 {
    ...
    public u31(org.telegram.ui.Cells.u1 u1Var, xo0 xo0Var) {
        boolean z10 = false;
        this.r = u1Var;
        this.s = xo0Var;
        ...
        kj0 kj0Var = new kj0(org.telegram.messenger.R.raw.transcribe_out, AndroidUtilities.dp(26.0f), AndroidUtilities.dp(26.0f));
        this.p = kj0Var;
        kj0Var.M(0);
        kj0Var.setCallback(u1Var);
        final int i10 = 0;
        kj0Var.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.s31
        ...
        kj0Var.J(true);
        kj0 kj0Var2 = new kj0(org.telegram.messenger.R.raw.transcribe_in, AndroidUtilities.dp(26.0f), AndroidUtilities.dp(26.0f));
        this.n = kj0Var2;
        kj0Var2.M(0);
        kj0Var2.setCallback(u1Var);
        kj0Var2.R(u1Var);
        final int i11 = 1;
        kj0Var2.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.s31
            public final /* synthetic */ u31 b;
        ...
        this.x = z10;
        qr qrVar = qr.h;
        this.l = new d6(u1Var, 250L, qrVar);
        this.j = new d6(u1Var, 250L, qrVar);
    }
    ...
    public static boolean g(MessageObject messageObject, long j3, String str) {
        try {
            ...
            if (messageObject2 != null && messageObject2.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new p31(str, messageObject2, j3, 0));
                return true;
            }
            return false;
    ...
    public static void w(final MessageObject messageObject, boolean z10, final org.telegram.ui.Cells.l1 l1Var) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_transcribeAudio, new RequestDelegate() { // from class: org.telegram.ui.Components.r31
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (z12) {
                    ...
                    u31.O.put(Long.valueOf(j3), messageObject2);
                ...
                if (z11) {
                    AndroidUtilities.runOnUIThread(new p31(str4, messageObject2, j3, 1), Math.max(0L, 350 - elapsedRealtime2));
                }
            }
    ...
    public final void f(Canvas canvas, float f7) {
        ...
        if (this.y) {
            kj0 kj0Var = this.n;
            kj0Var.setAlpha((int) (this.m * f7));
            kj0Var.draw(canvas);
        } else {
            kj0 kj0Var2 = this.p;
            kj0Var2.setAlpha((int) (this.o * f7));
            kj0Var2.draw(canvas);
        }
    ...
    public final void q(float f7, int i10) {
        ...
        if (z10) {
            kj0 kj0Var = this.n;
            kj0Var.Z = true;
            kj0Var.Q(this.c, "Artboard Outlines");
            kj0Var.o();
            kj0Var.J(true);
            kj0Var.V(0L);
            int alpha = Color.alpha(i10);
            this.m = alpha;
            kj0Var.setAlpha(alpha);
            kj0 kj0Var2 = this.p;
            kj0Var2.Z = true;
            kj0Var2.Q(this.c, "Artboard Outlines");
            kj0Var2.o();
            kj0Var2.J(true);
            kj0Var2.V(0L);
            int alpha2 = Color.alpha(i10);
            this.o = alpha2;
            kj0Var2.setAlpha(alpha2);
        }
        if (this.g == null) {
    ...
    public final void r(boolean z10, boolean z11) {
        this.k = z10;
        xo0 xo0Var = this.s;
        if (!xo0Var.z && z10 && xo0Var.B.c <= 0.0f) {
            xo0Var.A = SystemClock.elapsedRealtime();
        }
        xo0Var.z = z10;
        org.telegram.ui.Cells.u1 u1Var = xo0Var.n;
        if (u1Var != null) {
            u1Var.invalidate();
        }
        d6 d6Var = this.l;
