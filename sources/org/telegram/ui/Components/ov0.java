...
public final class ov0 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ov0(Context context, nv0 nv0Var, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        ag0Var.addView(textView, w7.y5.e(-2, -1, 51));
        ...
        ag0Var.addView(linearLayout, w7.y5.e(-2, -1, 53));
        TextView textView2 = new TextView(context);
        org.telegram.messenger.wh.j(13.0f, 1, textView2);
        ...
        this.containerView.addView(ag0Var, w7.y5.e(-1, 48, 83));
        ...
        final int i13 = 0;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lv0
        ...
        final int i14 = 1;
        linearLayout.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lv0
            public final /* synthetic */ ov0 b;
    ...
    public static void m(ov0 ov0Var) {
        ai.w0 w0Var = ov0Var.b;
        if (w0Var.getChildCount() <= 0) {
            int paddingTop = w0Var.getPaddingTop();
            ov0Var.f = paddingTop;
            w0Var.setTopGlowOffset(paddingTop);
            ov0Var.containerView.invalidate();
            return;
        }
        int i10 = 0;
