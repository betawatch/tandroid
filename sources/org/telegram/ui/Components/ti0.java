...
public abstract class ti0 {
    ...
    public ti0(CharSequence charSequence, CharSequence charSequence2) {
        TextPaint textPaint = new TextPaint(1);
        this.k = textPaint;
        si0 si0Var = new si0();
        si0Var.a = new Path();
        si0Var.b = new Paint(1);
        si0Var.a();
        this.l = si0Var;
        this.n = new Path();
        this.o = 1.0f;
        ...
        this.P = 1.0f;
        this.U = 1.0f;
        this.a0 = new ri0(this, 3);
        this.b0 = new ri0(this, 4);
        this.d0 = new org.telegram.ui.Cells.t6(this, 20);
        this.e0 = false;
    ...
    public final void a(boolean z10) {
        if (this.G != z10) {
            ...
            if (z10) {
                ...
                this.t = ofFloat;
                ofFloat.addUpdateListener(new ri0(this, 0));
            ...
            this.u = ofFloat2;
            ofFloat2.addUpdateListener(new ri0(this, 1));
    ...
    public final void c(Canvas canvas, boolean z10) {
        ...
        boolean z12 = s2Var instanceof ag1;
        ...
        if (width != this.c0) {
            ...
            if (this.U < 0.8f) {
                this.U = 0.8f;
                ceil2 = ci.f4.a(this.S, textPaint);
            }
            int i22 = ceil2;
        ...
        if (z13 != this.r) {
            ...
            this.A = ofFloat2;
            ofFloat2.addUpdateListener(new ri0(this, 2));
            this.A.setInterpolator(qr.j);
        ...
        if (f43 == 0.0f || z11) {
            ...
            int i26 = dp5 >> 1;
            i15 = dp;
            si0Var.setBounds(i24 - dp6, measuredHeight - i26, i24 + dp6, measuredHeight + i26);
            ...
            si0Var.b.setColor(this.G ? paint2.getColor() : org.telegram.ui.ActionBar.j6.w0(null, this.b, false));
            si0Var.draw(canvas);
            canvas.restore();
        } else {
            i15 = dp;
        ...
        if (this.T != null) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.H.getMeasuredWidth(), this.H.getMeasuredHeight(), (int) (org.telegram.messenger.q.A(1.0f, this.o, 255.0f, f12) * this.x), 31);
        ...
        org.telegram.ui.ActionBar.j6.u1.T(0.0f, true);
        if (!org.telegram.ui.ActionBar.j6.C1) {
            ij0 ij0Var = org.telegram.ui.ActionBar.j6.u1;
            ij0Var.Z = true;
            int i28 = this.d;
            ij0Var.Q(org.telegram.ui.ActionBar.j6.w0(null, i28, true), "Arrow1");
            org.telegram.ui.ActionBar.j6.u1.Q(org.telegram.ui.ActionBar.j6.w0(null, i28, true), "Arrow2");
    ...
    public final void e(float f7) {
        ...
        if (this.e && this.X && !this.Y) {
            ...
            ij0Var.Z = true;
            ij0Var.Q(d, "Arrow1");
            org.telegram.ui.ActionBar.j6.u1.Q(d, "Arrow2");
            org.telegram.ui.ActionBar.j6.u1.o();
            org.telegram.ui.ActionBar.j6.C1 = true;
        }
    }
