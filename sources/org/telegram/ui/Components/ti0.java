        ...
        if (layout != null) {
            ...
            if (text != null && (text instanceof Spannable)) {
                ...
                while (i12 < ti0VarArr2.length) {
                    ...
                    pi0 pi0Var = new pi0(euVar2, layout, spannable, ti0Var);
                    if (ti0Var.a) {
                        int i13 = ti0Var.c;
                        if (i13 == 0 || text.charAt(i13 - 1) == '\n') {
                            if (ti0Var.d != text.length() && text.charAt(ti0Var.d) != '\n') {
                                ...
                                pi0Var = new pi0(euVar2, layout, spannable, ti0VarArr2[i12]);
                            }
                            ...
                            if (z13) {
                                ...
                                if (pi0Var.b()) {
                                    ...
                                    if (i16 - 2 >= 0) {
                                        z10 = true;
                                        if (layout.getLineRight(layout.getLineForOffset(i16 - 1)) - AndroidUtilities.dp(12.0f) > pi0Var.d - (ti0Var2.J != null ? org.telegram.messenger.z0.D(3.333f, 2, AndroidUtilities.dp(23.66f) + r12.c) : org.telegram.messenger.z0.D(3.333f, 2, AndroidUtilities.dp(23.66f)))) {
                                            z11 = true;
                                            if (z14 != z11) {
                                                int i17 = ti0Var2.d;
                                                if (z14) {
