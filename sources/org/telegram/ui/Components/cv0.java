...
public final class cv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public cv0(org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        if (n2Var instanceof bh) {
            ...
            if (a2 != n2Var.getUserConfig().getClientUserId()) {
                n2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a2, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.bv0
                    ...
                    public final void run(Object obj) {
                        ...
                        switch (i11) {
                            case 0:
                                cv0 cv0Var = this.b;
                                ArrayList arrayList = cv0Var.x;
                                boolean booleanValue = bool.booleanValue();
                                cv0Var.f = booleanValue;
                                cv0Var.h = true;
                                if (booleanValue) {
                                    int size = arrayList.size();
                                    for (int i12 = 0; i12 < size; i12++) {
                                        ((dv0) arrayList.get(i12)).M();
                                    }
                                    break;
                                }
                                break;
                            default:
                                cv0 cv0Var2 = this.b;
                                ArrayList arrayList2 = cv0Var2.x;
                                boolean booleanValue2 = bool.booleanValue();
                                cv0Var2.f = booleanValue2;
                                cv0Var2.h = true;
                                if (booleanValue2) {
                                    int size2 = arrayList2.size();
                                    for (int i13 = 0; i13 < size2; i13++) {
                                        ((dv0) arrayList2.get(i13)).M();
                                    }
                                    break;
                                }
                                break;
            ...
            if (profileActivity.h1) {
                ...
                if (a10 != n2Var.getUserConfig().getClientUserId()) {
                    n2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a10, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.bv0
                        public final /* synthetic */ cv0 b;
        ...
        int i12 = 0;
        while (true) {
            zu0[] zu0VarArr = this.n;
            if (i12 >= zu0VarArr.length) {
                break;
            }
            zu0VarArr[i12] = new zu0();
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
                ...
                for (int i24 = 0; i24 < arrayList.size(); i24++) {
                    ...
                    if (!messageObject.isEphemeral()) {
                        ...
                        if ((j11 == 0 || j11 == MessageObject.getTopicId(currentAccount, messageObject.messageOwner, true)) && MessageObject.getMedia(messageObject.messageOwner) != null && !messageObject.needDrawBluredPreview() && (mediaType = MediaDataController.getMediaType(messageObject.messageOwner)) != -1 && ((mediaType != 0 || this.n[0].q != 2 || messageObject.isVideo()) && (mediaType != 0 || this.n[0].q != 1 || !messageObject.isVideo()))) {
                            zu0 zu0Var = this.n[mediaType];
                            if (zu0Var.l) {
                                zu0Var.a(messageObject, i23, true, isEncryptedDialog);
                            }
                            if (this.s == 0) {
                            ...
                            if (i23 == 0) {
                                for (int i25 = 0; i25 < this.n[mediaType].e.size(); i25++) {
                                    ((iu0) this.n[mediaType].e.get(i25)).b++;
                                }
                            }
                        }
                    }
        ...
        if (i10 != NotificationCenter.messageReceivedByServer) {
            ...
            if (i10 == NotificationCenter.messagesDeleted) {
                ...
                for (int i28 = 0; i28 < size3; i28++) {
                    ...
                    while (true) {
                        zu0[] zu0VarArr = this.n;
                        if (i29 < zu0VarArr.length) {
                            MessageObject b10 = zu0VarArr[i29].b(((Integer) arrayList3.get(i28)).intValue(), 0);
                            if (b10 != null) {
            ...
            if (i10 != NotificationCenter.replaceMessagesObjects) {
                ...
                if (i10 == NotificationCenter.fileLoaded) {
                    ...
                    int i34 = 0;
                    while (true) {
                        zu0[] zu0VarArr2 = this.n;
                        if (i34 >= zu0VarArr2.length) {
                            break;
                        }
                        arrayList4.addAll(zu0VarArr2[i34].a);
                        i34++;
                    }
            ...
            if (longValue8 == j13 || longValue8 == this.v) {
                ...
                while (i37 < size6) {
                    ...
                    if (j14 == 0 || topicId == j14) {
                        int i38 = 0;
                        while (true) {
                            zu0[] zu0VarArr3 = this.n;
                            if (i38 >= zu0VarArr3.length) {
                                break;
                            }
                            MessageObject messageObject3 = (MessageObject) zu0VarArr3[i38].b[i36].get(id2);
        ...
        while (true) {
            zu0[] zu0VarArr4 = this.n;
            if (i17 >= zu0VarArr4.length) {
                return;
            }
            zu0VarArr4[i17].f(i41, num.intValue(), num2.intValue());
            i17++;
        }
    }
}
