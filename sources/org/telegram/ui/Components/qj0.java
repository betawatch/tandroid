    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
            if (tL_availableReaction.reaction.equals(this.v.f)) {
                u9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.i6.a7, 1.0f), tL_availableReaction);
                u9Var.setVisibility(0);
                imageView.setVisibility(8);
                return;
            }
