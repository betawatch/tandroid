...
public final class qj0 extends FrameLayout {
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        x9 x9Var = this.d;
        if (str == null) {
            x9Var.setAnimatedEmojiDrawable(new q5(0, i10, this.v.g));
        ...
        for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
            if (tL_availableReaction.reaction.equals(this.v.f)) {
                x9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.j6.a7, 1.0f), tL_availableReaction);
                x9Var.setVisibility(0);
                imageView.setVisibility(8);
                return;
            }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        ah.j1 j1Var = this.v;
        if (j1Var != null) {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("AccDescrNumberOfPeopleReactions", this.s, j1Var));
        } else {
