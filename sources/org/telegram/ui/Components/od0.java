...
public final class od0 extends FrameLayout {
    public Bitmap a;
    public HashMap b;
    public boolean c;
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (b10 == 0) {
                ...
                if (z10) {
                    ...
                    if (z11) {
                        imageReceiver.setDelegate(new i2(27));
                    }
                }
                ...
                if ((2 & mediaEntity.subType) != 0) {
                    v9Var2.setScaleX(-1.0f);
                }
                mediaEntity.view = v9Var2;
                v9Var = v9Var2;
            } else if (b10 == 1) {
                ?? nd0Var = new nd0(getContext());
                nd0Var.setBackgroundColor(0);
                nd0Var.setPadding(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f));
                nd0Var.setTextSize(0, mediaEntity.fontSize);
                nd0Var.setTypeface(mediaEntity.textTypeface.d());
                SpannableString spannableString = new SpannableString(Emoji.replaceEmoji(mediaEntity.text, nd0Var.getPaint().getFontMetricsInt(), false));
                ...
                while (i13 < size2) {
                    ...
                    y5 y5Var = new y5(emojiEntity2.document_id, nd0Var.getPaint().getFontMetricsInt());
                ...
                nd0Var.setText(spannableString);
                int i15 = 17;
                ...
                nd0Var.setTextAlignment(i11);
                nd0Var.setHorizontallyScrolling(false);
                nd0Var.setImeOptions(TLObject.FLAG_28);
                nd0Var.setFocusableInTouchMode(true);
                nd0Var.setEnabled(false);
                nd0Var.setInputType(nd0Var.getInputType() | 16384);
                if (i17 >= 23) {
                    nd0Var.setBreakStrategy(0);
                }
                nd0Var.setShadowLayer(0.0f, 0.0f, 0.0f, 0);
                int i20 = mediaEntity.color;
                byte b11 = mediaEntity.subType;
                if (b11 == 0) {
                    nd0Var.setFrameColor(i20);
                    i20 = AndroidUtilities.computePerceivedBrightness(mediaEntity.color) >= 0.721f ? -16777216 : -1;
                } else if (b11 == 1) {
                    nd0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -1728053248 : -1711276033);
                } else if (b11 == 2) {
                    nd0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -16777216 : -1);
                } else {
                    nd0Var.setFrameColor(0);
                }
                nd0Var.setTextColor(i20);
                nd0Var.setCursorColor(i20);
                nd0Var.setHandlesColor(i20);
                nd0Var.setHighlightColor(org.telegram.ui.ActionBar.j6.l1(0.4f, i20));
                mediaEntity.view = nd0Var;
                v9Var = nd0Var;
            } else {
                v9Var = null;
            }
            if (v9Var != null) {
                addView(v9Var);
                v9Var.setRotation((float) (((-mediaEntity.rotation) / 3.141592653589793d) * 180.0d));
                this.b.put(v9Var, mediaEntity);
            }
        }
    }
