...
public final class po0 extends Drawable {
    ...
    public po0(Runnable runnable, boolean z4) {
        ...
        Path path = new Path();
        this.f = path;
        this.g = new l01(LocaleController.getString(R.string.SeekSpeedHint), 14.0f, null);
        Path path2 = new Path();
        this.h = path2;
        Path path3 = new Path();
        this.i = path3;
        ...
        this.l = z5Var;
        z5Var.d(0.0f, true);
        this.m = new z5(runnable, 320L, prVar, 0);
        this.n = new z5(runnable, 200L, prVar, 0);
    ...
    public final void draw(Canvas canvas) {
        ...
        this.c.setColor(org.telegram.ui.ActionBar.k6.l1(f11, -16777216));
        RectF rectF = this.r;
        ...
        this.d.setColor(org.telegram.ui.ActionBar.k6.l1(((((((float) Math.sin(this.t * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, f13) * e6, -1));
        canvas.drawPath(this.h, this.d);
        canvas.translate(AndroidUtilities.dp(10.66f), 0.0f);
        this.d.setColor(org.telegram.ui.ActionBar.k6.l1(((((((float) Math.sin((this.t + 0.17f) * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, f13) * e6, -1));
        canvas.drawPath(this.h, this.d);
        canvas.restore();
        canvas.save();
        canvas.translate(((-AndroidUtilities.dp(28.0f)) / 2.0f) * d10, 0.0f);
        oo0 oo0Var = this.p;
        oo0Var.w = (int) (e6 * 255.0f);
        oo0Var.draw(canvas);
        canvas.restore();
        canvas.save();
        ...
        this.d.setColor(org.telegram.ui.ActionBar.k6.l1(((((((float) Math.sin(this.t * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, d10) * e6, -1));
        canvas.drawPath(this.i, this.d);
        canvas.translate(AndroidUtilities.dp(10.66f), 0.0f);
        this.d.setColor(org.telegram.ui.ActionBar.k6.l1(((((((float) Math.sin((this.t - 0.17f) * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, d10) * e6, -1));
        canvas.drawPath(this.i, this.d);
        canvas.restore();
        canvas.restore();
        ...
        if (e10 > 0.0f) {
            if (this.e == null) {
                ij0 ij0Var = new ij0(R.raw.seek_speed_hint, "" + R.raw.seek_speed_hint, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), true, null);
                this.e = ij0Var;
                ij0Var.H(true);
            ...
            RectF rectF4 = this.r;
            rectF2.set(centerX, height, centerX2, (rectF4.height() * e6) + rectF4.top + AndroidUtilities.dp(11.0f) + dp2);
            canvas.save();
            float f15 = (0.25f * e10) + 0.75f;
            canvas.scale(f15, f15, this.s.centerX(), this.s.top);
            this.c.setColor(org.telegram.ui.ActionBar.k6.l1(e10 * 0.4f, -16777216));
            canvas.save();
