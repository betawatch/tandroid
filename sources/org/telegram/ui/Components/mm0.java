...
public abstract class mm0 extends HorizontalScrollView {
    ...
    public final void a(int i10) {
        ...
        this.f.addListener(new jd0(this, 9));
        this.f.start();
    }
    ...
    public final void c() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof yv) {
                ...
                if (!yvVar.y && z10 && (xi0Var = yvVar.e) != null && !xi0Var.k0 && !z11) {
                    yvVar.e.T(0.0f, true);
                    yvVar.e.start();
                }
                if (yvVar.y != z10) {
                    ...
                    if (z10) {
                        ...
                        rg.b1 b1Var2 = yvVar.f;
                        if (b1Var2 != null && (o5Var = yvVar.w) != null && (l4Var = o5Var.k) != null) {
