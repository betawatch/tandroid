...
public final class fc0 extends Drawable {
    ...
    public fc0() {
        ...
        this.e = new pr(0.33d, 0.0d, 0.0d, 1.0d);
        this.h = 1.0f;
        this.j = new RectF();
        this.m = new Bitmap[3];
        this.n = new Paint(2);
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.save();
        Bitmap e6 = e();
        float f10 = e6 != null ? bounds.top : this.f;
        ...
        boolean z4 = (Build.VERSION.SDK_INT < 28 || this.Q == null || this.k == null || e6 == null) ? false : true;
        int i12 = this.q;
        float f17 = 1.0f;
        Paint paint = this.n;
        Paint paint2 = this.o;
        ...
        if (i12 < 0) {
            ...
            if (e6 != null) {
                if (z10) {
                    ...
                    if (z4) {
                        Paint e11 = this.Q.e(this.k, e6, this.U, (int) (this.L * this.J), this.q, canvas.isHardwareAccelerated());
                        this.Q.d(this.A);
                        this.Q.c(rectF);
                        float f24 = this.I;
            ...
            if (e6 != null) {
                ...
                paint2.setAlpha((int) ((Math.abs(this.q) / 100.0f) * this.L * this.J));
                if (z11) {
                    Paint e12 = this.Q.e(this.k, e6, this.U, (int) (this.L * this.J), this.q, canvas.isHardwareAccelerated());
                    kc0 kc0Var = this.Q;
                    RectF rectF2 = kc0Var.j;
                    rectF2.set(0.0f, 0.0f, kc0Var.g, kc0Var.h);
                    Matrix matrix = kc0Var.i;
    ...
    public final void z() {
        ...
        if (f10 < 1.0f) {
            ...
            if (z4) {
                ...
                pr prVar = this.e;
                if (z12) {
                    float interpolation2 = prVar.getInterpolation(f10);
                    ...
                    float interpolation3 = (this.D != null || this.d) ? this.h : prVar.getInterpolation(this.h);
                    ...
                    interpolation = (this.D != null || this.d) ? this.h : prVar.getInterpolation(this.h);
