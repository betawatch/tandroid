    ...
    public static void showLimitReachedDialogForReactions(final long j, int i, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus) {
        ...
        limitReachedBottomSheet.showStatisticButtonInLink(new Runnable() { // from class: org.telegram.ui.Components.Reactions.ReactionsUtils$$ExternalSyntheticLambda0
            ...
            public final void run() {
                r0.presentFragment(StatisticActivity.create(BaseFragment.this.getMessagesController().getChat(Long.valueOf(-j))));
            }
        });
            ...
            if (chatReactions instanceof TLRPC.TL_chatReactionsSome) {
                ...
                while (i < size) {
                    ...
                    if (reaction2 instanceof TLRPC.TL_reactionEmoji) {
                        ...
                        make = reaction2 instanceof TLRPC.TL_reactionCustomEmoji ? AnimatedEmojiDrawable.make(UserConfig.selectedAccount, AnimatedEmojiDrawable.getCacheTypeForEnterView(), ((TLRPC.TL_reactionCustomEmoji) reaction2).document_id) : null;
                    }
                    if (make != null) {
                        arrayList.add(make);
