...
public final class gh0 extends FrameLayout {
    ...
    public gh0(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 31 || SharedConfig.getDevicePerformanceClass() < 1) {
            ...
            this.c = new eh0(this, SharedConfig.getDevicePerformanceClass() == 2 ? 1.0f : 1.5f);
        }
        setIntensity(15.0f);
    ...
    public static /* synthetic */ void a(gh0 gh0Var, Canvas canvas) {
        canvas.save();
    ...
    public final void draw(Canvas canvas) {
        if (!this.h) {
            ...
            this.c.c(new vu(this, 12), canvas);
        }
    }
