...
public final class gh0 extends View {
    ...
    public gh0(Context context) {
        ...
        this.f = paintArr;
        this.s = new fh0(this, i11);
        this.v = new fh0(this, i10);
        this.w = -1;
        this.F = false;
        this.G = false;
        this.H = false;
    ...
    public static void a(gh0 gh0Var, int i10, int i11, int i12) {
        synchronized (gh0Var.b) {
            try {
                ...
                if (i10 != 2) {
                    Paint[] paintArr = gh0Var.f;
                    Paint paint = paintArr[i10];
                    paintArr[i10] = paintArr[i11];
                    paintArr[i11] = paint;
                } else if (uh0Var2.f) {
                    gh0Var.b(uh0Var2.b, i11);
                }
                if (i12 != -1) {
                    gh0Var.f[i12].setShader(null);
                    uh0 uh0Var3 = gh0Var.c[i12];
    ...
    public final void c(float f7, org.telegram.ui.o01 o01Var, float f10, float f11) {
        ...
        if (eh0Var2 != null) {
            if (o01Var != null) {
                eh0Var2.w = this.M;
                eh0Var2.r = o01Var;
                eh0Var2.s = renderNodeScale / f10;
                eh0Var2.v = -f11;
                eh0Var2.invalidate();
            } else {
                eh0Var2.w = this.M;
                eh0Var2.r = null;
                eh0Var2.s = renderNodeScale;
                eh0Var2.v = -f11;
                eh0Var2.invalidate();
            }
        }
    ...
    */
    public final boolean d() {
        ...
        ph0 ph0Var = this.h;
        boolean z10 = false;
        if (ph0Var != null && ((rv0Var = ph0Var.h1) == null || !rv0Var.n)) {
            int measuredWidth = (int) (ph0Var.getMeasuredWidth() / 6.0f);
            ...
            if (measuredWidth > 0 && i10 > 0) {
                ...
                int length = (!z11 || this.H) ? uh0VarArr.length : 1;
                this.G = false;
                this.H = false;
                int i11 = 0;
                while (true) {
                    ...
                    uh0Var2.b = createBitmap;
                    uh0Var2.a = new Canvas(createBitmap);
                    uh0VarArr[i11] = uh0Var2;
                    if (uh0VarArr[i11].e) {
                        if (length == 1) {
                            this.G = true;
                        } else {
    ...
    public final void f(Canvas canvas, org.telegram.ui.o01 o01Var, float f7, float f10, boolean z10, float f11, float f12) {
        ...
        if (this.a && Build.VERSION.SDK_INT >= 31) {
            if (canvas2.isHardwareAccelerated()) {
                if (o01Var != null || getVisibility() != 0 || getAlpha() <= 0.0f) {
                    if (o01Var != null) {
                        ...
                        o5 o5Var = o01Var.e;
                        g(o5Var != null ? o5Var.k : o01Var.a, beginRecording, f15, f10);
                        if (o01Var.a0 && o01Var.V > 0.0f) {
                            g(o01Var.U, beginRecording, f15, f10);
                        }
                        this.L.endRecording();
                        this.L.setAlpha(f12);
            ...
            if (o01Var != null || AndroidUtilities.makingGlobalBlurBitmap) {
                return;
            }
            this.a = false;
        ...
        if (this.H || this.G || this.F || (this.f[0].getShader() == null && this.f[1].getShader() == null && !this.e)) {
            ...
            if (!this.e && d) {
                this.e = true;
                DispatchQueue dispatchQueue = vh0.a;
