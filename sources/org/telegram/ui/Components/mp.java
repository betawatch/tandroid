...
public final class mp extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public mp(org.telegram.ui.bo boVar, org.telegram.ui.zn znVar) {
        super(1, (Context) boVar.getParentActivity(), (org.telegram.ui.ActionBar.e6) znVar, true);
        String str;
        int i10 = 1;
        this.Q = -1;
        this.d0 = false;
        ...
        int i13 = 3;
        ll0Var.setOnItemClickListener(new j(this, i13));
        ll0Var.setOnScrollListener(new ai.r(this, 25));
        ...
        if (this.f != null) {
            ...
            textView3.setOnClickListener(new org.telegram.ui.rf(this, boVar));
    ...
    public static void o(mp mpVar, View view, int i10) {
        ...
        for (int i11 = 0; i11 < ll0Var.getChildCount(); i11++) {
            u11 u11Var = (u11) ll0Var.getChildAt(i11);
    ...
    public static void q(mp mpVar, wd1 wd1Var) {
        org.telegram.ui.ActionBar.l2 l2Var = new org.telegram.ui.ActionBar.l2();
        l2Var.a = true;
        org.telegram.ui.bo boVar = mpVar.v;
        wd1Var.a.a = boVar.getResourceProvider();
        wd1Var.p1 = new ep(mpVar);
        l2Var.c = new sh(3);
        l2Var.d = new uo(mpVar, 5);
        l2Var.b = new uo(mpVar, 6);
        l2Var.e = true;
        mpVar.X = wd1Var;
        boVar.showAsSheet(wd1Var, l2Var);
    }
    ...
    */
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        int i10 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 32, null, null, new Drawable[]{this.shadowDrawable}, jpVar, org.telegram.ui.ActionBar.i6.h5));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.E, 4, null, null, null, null, org.telegram.ui.ActionBar.i6.j5));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.w, 16, new Class[]{u11.class}, null, null, null, org.telegram.ui.ActionBar.i6.i5));
    ...
    */
    public final void s(boolean z10) {
        ...
        if (d4Var != this.W) {
            ...
            if (chatTheme2 instanceof TLRPC.TL_chatThemeUniqueGift) {
                ...
                if (starGift instanceof TL_stars.TL_starGiftUnique) {
                    ...
                    if (i10 != null && !i10.self) {
                        z12 = d4Var.a;
                        ax0 ax0Var = new ax0(getContext(), null, 1, -1, d4Var.f(), boVar.getResourceProvider());
            ...
            if (i10 != null) {
                z12 = d4Var.a;
                ax0 ax0Var2 = new ax0(getContext(), null, 1, -1, d4Var.f(), boVar.getResourceProvider());
                ax0Var2.c.setVisibility(8);
                TextView textView2 = ax0Var2.b;
                if (z12) {
                }
                textView2.setTypeface(null);
                ocVar = oc.g(boVar, ax0Var2, 2750);
            }
        }
        dismiss();
        if (ocVar != null) {
