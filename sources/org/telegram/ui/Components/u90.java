                            ...
                            if (this.p == 15) {
                                ...
                                if (i21 != 0 || i21 == 1 || (i30 = this.q) == 0 || i30 == 1) {
                                    if ((i21 == 0 || this.q != 1) && !(i21 == 1 && this.q == 0)) {
                                        ...
                                        if (i24 == 0 || this.q != 1) {
                                            interpolation = (i24 == 1 || this.q != 0) ? f22 : f21 < 100.0f ? nr.j.getInterpolation(f21 / 100.0f) * (-5.0f) : f21 < 484.0f ? (nr.j.getInterpolation((f21 - 100.0f) / 384.0f) * 95.0f) - 5.0f : 90.0f;
                                        } else {
                                            interpolation = f21 < 384.0f ? nr.j.getInterpolation(f21 / 384.0f) * 95.0f : f21 < 484.0f ? 95.0f - (nr.j.getInterpolation((f21 - 384.0f) / 100.0f) * f17) : 90.0f;
                                            f21 += 100.0f;
                                        }
                                        ...
                                        org.telegram.ui.ActionBar.j6.x3.b(canvas2, paint2, f21);
