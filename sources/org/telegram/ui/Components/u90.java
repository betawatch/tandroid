...
public final class u90 extends v7.i0 {
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        i11++;
                        boolean z10 = obj instanceof t90;
                        if (z10) {
                            t90 t90Var2 = (t90) obj;
                            if ("summary".equalsIgnoreCase(t90Var2.a.a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(t90Var2.c, sb2);
                                String trim = sb2.toString().trim();
                                pageblockdetails.title = trim.isEmpty() ? new TL_iv.textEmpty() : y90.j(trim);
                            }
                        }
                        if (obj instanceof s90) {
                            arrayList2.add(((s90) obj).a);
                        } else if (z10) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof s90) {
                TL_iv.PageBlock pageBlock = ((s90) obj).a;
    ...
    public final void f(bf.h hVar) {
        ...
        pageblockpreformatted.text = y90.d(y90.j(hVar.k));
        String str = hVar.j;
        if (str == null) {
            str = "";
        }
    ...
    public final void j(bf.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = y90.d(y90.j(lVar.g));
    ...
    public final void k(bf.n nVar) {
        if (!(nVar instanceof we.a)) {
            ...
            pageblockparagraph.text = y90.c(((zc.a) nVar).g);
    ...
    */
            ...
            if (pVar instanceof bf.o) {
                if (z10) {
                    ...
                    if (!arrayDeque.isEmpty()) {
                        ...
                        tL_pageListOrderedItemText.text = y90.d(y90.a(pVar, pageblockorderedlist));
                ...
                tL_pageListOrderedItemText2.text = y90.d(y90.a(pVar, pageblockorderedlist));
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.c.add(new s90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        while (i10 < size) {
            ...
            i10++;
            s90 s90Var = (s90) obj;
            hashMap.put(Integer.valueOf(s90Var.b), s90Var);
        }
        ...
        t90 t90Var = new t90(null, ConnectionsManager.DEFAULT_DATACENTER_ID);
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).b <= s90Var2.b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.b;
                if (i15 >= s90Var2.b) {
                    while (arrayDeque.peek() != t90Var && ((t90) arrayDeque.peek()).b <= i16) {
                        arrayDeque.pop();
                    }
                    t90 t90Var2 = new t90(aVar4, aVar4.d);
                    ((t90) arrayDeque.peek()).c.add(t90Var2);
                    arrayDeque.push(t90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != t90Var && ((t90) arrayDeque.peek()).b <= s90Var2.b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = s90Var2.a;
            ((t90) arrayDeque.peek()).c.add(s90Var2);
        }
        A(0, t90Var.c, this.a);
    }
}
