...
public final class hz extends sl0 {
    public int I;
    public int J;
    public String K;
    ...
    public hz(mz mzVar, Context context) {
        this.N = mzVar;
        this.h = context;
        gz gzVar = new gz(context, mzVar.Z0, new d(this, 12), new hv(this, 3), mzVar.W1);
        this.c = gzVar;
        ...
        gzVar.V2.r = false;
        gzVar.setNestedScrollingEnabled(false);
        gzVar.setDrawSelection(false);
        gzVar.setOnTouchListener(new m.c2(this, 3));
    }
    ...
    public final void v(f2.m1 m1Var, int i10) {
        mz mzVar = this.N;
        LongSparseArray longSparseArray = mzVar.w1;
        LongSparseArray longSparseArray2 = mzVar.v1;
        int i11 = m1Var.f;
        View view = m1Var.a;
        ...
        if (i11 == 0) {
            ...
            if (!mzVar.g1.contains(document) && !mzVar.h1.contains(document)) {
                z4 = false;
            }
            d8Var.setRecent(z4);
            return;
        ...
        if (i11 == 1) {
            ...
            if (num == null) {
                ...
                int z10 = org.telegram.ui.b.z(82.0f, (int) Math.ceil(num.intValue() / mzVar.v0.d), mzVar.h.getHeight());
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                czVar = new cz(1, context, mzVar.W1, z4);
                break;
            case 1:
                czVar = new org.telegram.ui.Cells.k3(context);
                break;
            case 2:
                czVar = new org.telegram.ui.Cells.m8(this.h, false, false, mzVar.W1, mzVar.f2);
                break;
            case 3:
