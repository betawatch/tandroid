...
public abstract class wm0 extends HorizontalScrollView {
    ...
    public wm0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        this.n0 = new Paint();
        this.o0 = true;
        this.p0 = new d6(this, 350L, qrVar);
        this.s0 = new rm0(this, 1);
        this.O = f6Var;
        this.P = z10;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (dc1Var.getChildAt(i11) instanceof qx0) {
                qx0 qx0Var = (qx0) dc1Var.getChildAt(i11);
                float left = qx0Var.getLeft();
                float f13 = qx0Var.y;
                if (left != f13 && qx0Var.E) {
                    qx0Var.b = f13 - qx0Var.getLeft();
                    ValueAnimator valueAnimator = qx0Var.x;
                    if (valueAnimator != null) {
                        valueAnimator.removeAllListeners();
                        qx0Var.x.cancel();
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(qx0Var.b, 0.0f);
                    qx0Var.x = ofFloat;
                    ofFloat.addUpdateListener(new px0(qx0Var, this, i10));
                    qx0Var.x.addListener(new cl0(3, qx0Var, this));
                    qx0Var.x.start();
                }
                qx0Var.E = false;
                if (this.g0) {
                    qx0Var.setTranslationX(com.google.android.gms.internal.vision.e2.z(1.0f, this.i0, i11 * f11, f12) + qx0Var.b);
                } else {
                    qx0Var.setTranslationX(qx0Var.b);
                }
            }
            i11++;
        }
            ...
            if (childAt == null || view == null) {
                ...
                if (childAt != null) {
                    ...
                    if (childAt instanceof qx0) {
                        textWidth = ((qx0) childAt).getTextWidth();
                    }
                    textWidth = 0.0f;
                } else {
                    if (view != null) {
                ...
                textWidth = AndroidUtilities.lerp(childAt instanceof qx0 ? ((qx0) childAt).getTextWidth() : 0.0f, view instanceof qx0 ? ((qx0) view).getTextWidth() : 0.0f, f17);
            }
    ...
    public final boolean f(MotionEvent motionEvent) {
        ...
        if (this.U != ceil && e(ceil)) {
            for (int i14 = 0; i14 < dc1Var.getChildCount(); i14++) {
                if (i14 != this.U) {
                    qx0 qx0Var = (qx0) dc1Var.getChildAt(i14);
                    qx0Var.y = qx0Var.getLeft();
                    qx0Var.E = true;
                    qx0Var.invalidate();
                }
            }
    ...
    public final void i(final float f7, final boolean z10) {
        if (this.f0 != z10) {
            ...
            this.h0 = ofFloat;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.qm0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (!z10) {
                        ...
                        float f10 = f7;
                        float childCount2 = (scrollX + f10) / (wm0Var.j0 * dc1Var.getChildCount());
                        ...
                        wm0Var.l0 = (wm0Var.getScrollX() + f10) - f11;
                    }
                    wm0Var.i0 = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
            ...
            this.h0.addListener(new tm0(this, z10, f7, i10));
            this.h0.start();
            dc1 dc1Var = this.e;
            if (z10) {
                this.g0 = true;
    ...
    */
    public final void n() {
        ...
        while (true) {
            ...
            sparseArray2.put(((qx0) sparseArray.valueAt(i14)).s, (qx0) sparseArray.valueAt(i14));
            i14++;
        }
        sparseArray.clear();
        while (paddingLeft < min) {
            ...
            if (childAt instanceof qx0) {
                ...
                v9 v9Var = qx0Var.e;
                if (qx0Var.a == 2) {
                    Object tag = qx0Var.getTag(R.id.parent_tag);
                    Object tag2 = qx0Var.getTag(R.id.object_tag);
                    Drawable drawable = tag instanceof Drawable ? (Drawable) tag : null;
                    if (tag2 instanceof TLRPC.Document) {
                        v9Var.h(ImageLocation.getForDocument((TLRPC.Document) tag2), !LiteMode.isEnabled(i13) ? "36_36_firstframe" : "36_36_nolimit", null, null);
                    } else {
                    ...
                    if (tag3 instanceof TLRPC.Document) {
                        if (!qx0Var.c) {
                            qx0Var.v = DocumentObject.getSvgThumb((TLRPC.Document) tag3, org.telegram.ui.ActionBar.j6.c7, 0.2f);
                        }
                        ...
                        if (tag4 instanceof TLRPC.TL_messages_stickerSet) {
                            ...
                            if (qx0Var.c) {
                                ...
                                i10 = paddingLeft;
                                i11 = min;
                                qx0Var.v = DocumentObject.getSvgThumb(arrayList, org.telegram.ui.ActionBar.j6.c7, 0.2f, DocumentObject.containsPhotoSizeType(arrayList, "v"));
                            }
                        } else {
                            i10 = paddingLeft;
                            i11 = min;
                    ...
                    if (!qx0Var.c && qx0Var.v == null && document != null) {
                        qx0Var.v = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.c7, 0.2f);
                    }
                    if (forSticker != null) {
                        qx0Var.c = true;
                        SvgHelper.SvgDrawable svgDrawable = qx0Var.v;
                        ...
                        if (str == null || !str.equalsIgnoreCase("v")) {
                            ...
                            if (!(str == null && MessageObject.isAnimatedStickerDocument(document, true)) && (str == null || !str.equalsIgnoreCase("a"))) {
                                if (forSticker.imageType == 1) {
                                    obj = tag4;
                                    v9Var.i(forSticker, str3, "tgs", svgDrawable, obj);
                                } else {
                                    obj = tag4;
                                    v9Var.i(forSticker, str3, "webp", svgDrawable, obj);
                                }
                                obj2 = obj;
                                qx0Var.h.setText(!(obj2 instanceof TLRPC.TL_messages_stickerSet) ? ((TLRPC.TL_messages_stickerSet) obj2).set.title : null);
                            } else if (svgDrawable != null) {
                                v9Var.n(forSticker, str3, svgDrawable, tag4);
                                obj2 = tag4;
                                qx0Var.h.setText(!(obj2 instanceof TLRPC.TL_messages_stickerSet) ? ((TLRPC.TL_messages_stickerSet) obj2).set.title : null);
                            } else {
                                obj3 = tag4;
                                v9Var.j(forSticker, str3, forSticker, null, 0, obj3);
                                obj2 = obj3;
                                qx0Var.h.setText(!(obj2 instanceof TLRPC.TL_messages_stickerSet) ? ((TLRPC.TL_messages_stickerSet) obj2).set.title : null);
                            }
                        }
                        if (str == null) {
                            if (!isEnabled) {
                                v9Var.n(ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 90), document), "40_40", svgDrawable, tag4);
                            } else if (svgDrawable != null) {
                                v9Var.n(ImageLocation.getForDocument(document), str2, svgDrawable, tag4);
                            } else {
                                obj3 = tag4;
                                v9Var.j(ImageLocation.getForDocument(document), str2, forSticker, null, 0, obj3);
                                obj2 = obj3;
                            }
                            obj2 = tag4;
                        } else {
                            ...
                            String str4 = str2;
                            if (svgDrawable != null) {
                                v9Var.n(forSticker, str4, svgDrawable, obj2);
                            } else {
                                v9Var.j(forSticker, str4, null, null, 0, obj2);
                            }
                        }
                        qx0Var.h.setText(!(obj2 instanceof TLRPC.TL_messages_stickerSet) ? ((TLRPC.TL_messages_stickerSet) obj2).set.title : null);
                    }
        ...
        for (int i16 = 0; i16 < sparseArray2.size(); i16++) {
            if (((qx0) sparseArray2.valueAt(i16)) != this.s) {
                ((qx0) sparseArray2.valueAt(i16)).e.setImageDrawable(null);
            }
        }
    }
