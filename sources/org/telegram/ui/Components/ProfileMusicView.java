...
public class ProfileMusicView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(22.0f), TLObject.FLAG_30));
    }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        ...
        int i;
        if (peerColor == null) {
            i = Theme.getColor(Theme.key_actionBarDefault, this.resourcesProvider);
            bgColor2 = i;
        } else {
        ...
        int adaptHSV = Theme.adaptHSV(ColorUtils.blendARGB(i, bgColor2, 0.25f), 0.02f, -0.08f);
        this.backgroundColor = adaptHSV;
        setBackgroundColor(adaptHSV);
        checkTextColor();
    }
