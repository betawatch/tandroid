...
public final class p90 extends Drawable {
    ...
    */
    public final void draw(Canvas canvas) {
        ...
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.j6.v0(this.l, e6Var);
        Integer num2 = this.p;
        int intValue2 = num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.j6.v0(this.m, e6Var);
        Integer num3 = this.q;
        int intValue3 = num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.j6.v0(this.l, e6Var);
        Integer num4 = this.r;
        int intValue4 = num4 != null ? num4.intValue() : org.telegram.ui.ActionBar.j6.v0(this.m, e6Var);
        ...
        float interpolation = this.c > 0 ? 1.0f - qr.g.getInterpolation(Math.min(1.0f, (elapsedRealtime - r8) / 320.0f)) : 0.0f;
        boolean c10 = c();
        boolean z11 = false;
        RectF rectF = this.B;
        if (c10) {
