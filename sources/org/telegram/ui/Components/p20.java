...
public final class p20 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public p20(int i9, Context context, boolean z10) {
        ...
        this.b.b();
        this.c.b();
        mi0 mi0Var = new mi0(R.raw.voice_outlined, "" + R.raw.voice_outlined, AndroidUtilities.dp(22.0f), AndroidUtilities.dp(30.0f), true, null);
        this.C = mi0Var;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z13) {
            ...
            if (f14 != 1.0f) {
                ...
                float interpolation = gr.f.getInterpolation(this.J) * 0.1f;
                float f16 = interpolation + 1.0f;
                pi0 pi0Var = this.B;
                pi0Var.setScaleY(f16);
                pi0Var.setScaleX(f16);
                z10 = this.E;
                if (z10) {
                    long currentTimeMillis = System.currentTimeMillis();
                    if (currentTimeMillis - this.D > 1000) {
                        this.D = currentTimeMillis;
                        float d = aa.d.d(org.telegram.ui.Cells.j2.e(this.F, 100), 0.5f, 100.0f, 0.5f);
                        this.e = d;
                                    ...
                                    if (i10 != 0 || this.n != null) {
                                        ...
                                        if (i10 == 0) {
                                            if (this.v != f26) {
                                                ...
                                                if (o20Var.i == i13) {
                                                    paint.setShader(r12);
                                                    paint.setColor(org.telegram.ui.ActionBar.f6.w0(r12, org.telegram.ui.ActionBar.f6.bh, false));
                                                } else {
                                                    paint.setShader(o20Var.g);
                                                }
                                                t9Var.b = AndroidUtilities.dp(40.0f);
                                                t9Var.a = AndroidUtilities.dp(32.0f);
                                                t9Var2.b = AndroidUtilities.dp(38.0f);
                                                t9Var2.a = AndroidUtilities.dp(33.0f);
                                                if (i10 != i13) {
                                                    f13 = 32.0f;
                                                ...
                                                if (this.y != 0.0f) {
                                                    float min = Math.min((1.0f - this.K) * aa.d.w(this.d, 0.3f, 1.0f, interpolation), 1.3f) * interpolation2;
                                                    canvas.save();
                                                    canvas.scale(min, min, measuredWidth, measuredHeight);
                                                    t9Var.a(measuredWidth, measuredHeight, canvas, paint);
                                                    canvas.restore();
                                                    float min2 = Math.min((1.0f - this.K) * aa.d.w(this.d, 0.26f, 1.0f, interpolation), 1.3f) * interpolation2;
                                                    canvas.save();
                                                    canvas.scale(min2, min2, measuredWidth, measuredHeight);
                                                    t9Var2.a(measuredWidth, measuredHeight, canvas, paint);
                                                    canvas.restore();
                                                }
                                                i13 = 2;
                                                if (i10 == 2) {
        ...
        float interpolation3 = gr.f.getInterpolation(this.J) * 0.1f;
        float f162 = interpolation3 + 1.0f;
        pi0 pi0Var2 = this.B;
        pi0Var2.setScaleY(f162);
        pi0Var2.setScaleX(f162);
        z10 = this.E;
        if (z10) {
        }
        f10 = this.e;
        ...
        float f27222 = 0.0f;
        t9 t9Var322 = this.b;
        t9Var322.e(f24222, f25);
        float f28222 = this.d;
        if (!z10) {
        }
        t9 t9Var2222 = this.c;
        t9Var2222.e(f28222, f29);
        i10 = 0;
        while (i10 < i9) {
        }
        if (this.G) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        j20 j20Var = j20.Z;
        if (j20Var != null) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString(j20Var.w ? R.string.AccDescrCloseMenu : R.string.AccDescrOpenMenu2)));
        }
    }
