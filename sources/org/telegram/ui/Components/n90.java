...
public final class n90 {
    ...
    public final boolean a(Canvas canvas) {
        ...
        if (rect != null || this.h <= 0) {
            ...
            g90 g90Var = (g90) arrayList.get(0);
            RectF rectF = AndroidUtilities.rectTmp;
            g90Var.computeBounds(rectF, false);
            this.m = new Rect((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
            for (int i10 = 1; i10 < this.h; i10++) {
                g90 g90Var2 = (g90) arrayList.get(i10);
                RectF rectF2 = AndroidUtilities.rectTmp;
                g90Var2.computeBounds(rectF2, false);
                Rect rect2 = this.m;
        ...
        if (z10) {
            ...
            float interpolation = wr.f.getInterpolation(Math.min(1.0f, (elapsedRealtime - this.o) / this.q));
    ...
    public final g90 b() {
        ...
        g90 g90Var = !arrayList.isEmpty() ? (g90) arrayList.remove(0) : new g90(0);
        g90Var.c = !this.r;
        g90Var.reset();
