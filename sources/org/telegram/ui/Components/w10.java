...
public final class w10 {
    ...
    public final void a() {
        int i10 = this.i;
        if (i10 == 0) {
            int w02 = org.telegram.ui.ActionBar.i6.w0(null, this.m, false);
            this.j = w02;
            int w03 = org.telegram.ui.ActionBar.i6.w0(null, this.n, false);
            this.k = w03;
            this.g = new RadialGradient(200.0f, 200.0f, 200.0f, new int[]{w02, w03}, (float[]) null, Shader.TileMode.CLAMP);
            return;
        }
        if (i10 == 1) {
            int w04 = org.telegram.ui.ActionBar.i6.w0(null, this.o, false);
            this.j = w04;
            int w05 = org.telegram.ui.ActionBar.i6.w0(null, this.p, false);
            this.k = w05;
            this.g = new RadialGradient(200.0f, 200.0f, 200.0f, new int[]{w04, w05}, (float[]) null, Shader.TileMode.CLAMP);
            return;
        }
        if (i10 == 3) {
            int w06 = org.telegram.ui.ActionBar.i6.w0(null, this.q, false);
            this.j = w06;
            int w07 = org.telegram.ui.ActionBar.i6.w0(null, this.s, false);
            this.l = w07;
            int w08 = org.telegram.ui.ActionBar.i6.w0(null, this.r, false);
            this.k = w08;
    ...
    public final void b(Paint paint) {
        ...
        if (i10 != 0 && i10 != 1 && i10 != 3) {
            ...
            paint.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.bh, false));
        } else {
