...
public final class c01 extends TableLayout {
    ...
    public final TableRow c(CharSequence charSequence, CharSequence charSequence2, b01[] b01VarArr, zc[] zcVarArr) {
        ...
        tableRow.addView(new zz0(this, zcVar, false), new TableRow.LayoutParams(0, -1, 1.0f));
        addView(tableRow);
        if (zcVarArr != null) {
            zcVarArr[0] = zcVar;
        }
    ...
    public final TableRow e(String str, CharSequence charSequence, String str2, Runnable runnable, Integer num) {
        ...
        int i10 = org.telegram.ui.ActionBar.j6.G6;
        org.telegram.ui.ActionBar.f6 f6Var = this.a;
        zcVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
        zcVar.setTextSize(1, 14.0f);
    ...
    public final TableRow j(CharSequence charSequence, int i10, long j3, Runnable runnable, String str, Runnable runnable2) {
        ...
        zcVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
        zcVar.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
        zcVar.setTextSize(1, 14.0f);
        ...
        if (str != null) {
            zcVar.M = new ad(str, runnable2, f6Var);
        }
        zcVar.setText(spannableStringBuilder);
        if (z10) {
            return null;
    ...
    public final TableRow l(String str, final int i10, final long j3, Runnable runnable) {
        ...
        Utilities.Callback<Object[]> callback = new Utilities.Callback() { // from class: org.telegram.ui.Components.yz0
