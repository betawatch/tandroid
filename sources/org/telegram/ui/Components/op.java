...
public final class op extends mw0 {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.a) {
            case 0:
                ...
                float interpolation = mr.i.getInterpolation(min < 0.3f ? min / 0.3f : 1.0f);
                mr mrVar = mr.g;
                float interpolation2 = mrVar.getInterpolation(min < 0.3f ? 0.0f : (min - 0.3f) / 0.7f);
                if (this.d) {
                    dp = e2.c.w(1.0f, interpolation, AndroidUtilities.dp(7.0f) - AndroidUtilities.dp(2.1f), AndroidUtilities.dp(2.1f) * interpolation);
                    dpf2 = (1.0f - mrVar.getInterpolation(this.e / 2.0f)) * AndroidUtilities.dpf2(1.5f);
                } else {
                    dp = ((AndroidUtilities.dp(7.0f) - AndroidUtilities.dp(2.1f)) * interpolation) + ((1.0f - interpolation) * AndroidUtilities.dp(2.1f));
                    dpf2 = AndroidUtilities.dpf2(1.5f) * mr.h.getInterpolation(this.e / 2.0f);
                }
