...
public class p71 extends FrameLayout {
    ...
    */
    public final boolean A(MotionEvent motionEvent) {
        ...
        if (e71Var == null || !e71Var.F) {
            ...
            if (motionEvent != null && motionEvent.getAction() == 0 && m()) {
                ...
                if (!this.y) {
                    if (viewArr[1] != null) {
                        if (x8 < viewArr[1].getTranslationX() + r5.getMeasuredWidth()) {
                            F();
                            this.y = true;
                ...
                } else if (x8 < viewArr[0].getTranslationX() + viewArr[0].getMeasuredWidth()) {
                    this.A = viewArr[0].getTranslationX();
                } else {
                    F();
                    this.y = false;
            ...
            if (this.D || motionEvent == null || (q6 = q(this, motionEvent.getX(), motionEvent.getY())) == null || (!q6.canScrollHorizontally(1) && !q6.canScrollHorizontally(-1))) {
                if (motionEvent != null && motionEvent.getAction() == 0 && !this.D && !this.E) {
                    ...
                    if (this.D) {
                        ...
                        if (this.A == 0.0f) {
                            this.B = Math.abs(x12) < ((float) viewArr[0].getMeasuredWidth()) / 3.0f && (Math.abs(f10) < 3500.0f || Math.abs(f10) < Math.abs(f11));
                        ...
                        if (this.B) {
                            ...
                            f12 = viewArr[0].getMeasuredWidth() - Math.abs(x12);
                            if (this.y) {
                        ...
                        if (this.d < 0) {
                            ...
                            ofFloat.addUpdateListener(new c71(this, i10));
                        ...
                        this.w.addListener(new d71(this, i10));
                        this.w.start();
                        this.x = true;
                        this.D = false;
                        w(false);
    ...
    public final void D(int i10) {
        if (i10 != this.b) {
            ...
            if (valueAnimator == null || this.d != i10) {
                ...
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.M = ofFloat;
                ofFloat.addUpdateListener(new c71(this, i11));
    ...
    public final ValueAnimator H(View view, float f10) {
        ...
        ofFloat.addUpdateListener(new mw0(this, view, 1));
        ofFloat.addListener(new f71(this, view, f10));
        return ofFloat;
    }
    ...
    public final void l() {
        ...
        if (this.D) {
            ...
            if (this.B) {
                ...
                f10 = viewArr[0].getMeasuredWidth() - Math.abs(x8);
                if (this.y) {
    ...
    public final o71 n(int i10, boolean z10) {
        e71 e71Var = new e71(this, getContext(), z10, i10, this.a);
        this.I = e71Var;
        e71Var.r = G();
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() == 0) {
                ...
                if (!rect.contains((int) f10, (int) f11)) {
                    ...
                    if ((childAt instanceof ViewGroup) && (q6 = q((ViewGroup) childAt, f10 - rect.left, f11 - rect.top)) != null) {
                        return q6;
                    }
                }
            }
    ...
    public void setAdapter(g71 g71Var) {
        ...
        if (d == null && this.b != 0) {
            ...
            int h10 = g71Var.h(0);
            iArr[0] = h10;
            viewArr[0] = g71Var.d(h10);
        }
        g71Var.b(viewArr[0], this.b, iArr[0]);
        addView(viewArr[0]);
        viewArr[0].setVisibility(0);
        o(false);
    }
