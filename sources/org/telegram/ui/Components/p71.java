...
public abstract class p71 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public p71(Context context, org.telegram.ui.br0 br0Var) {
        super(context);
        this.n = -1;
        ...
        imageReceiver.setDelegate(new ev(this, 29));
    }
    ...
    */
    public final void c(i71 i71Var, MessageObject messageObject) {
        ...
        if (i71Var.t() > 0) {
            g71 g71Var = null;
            for (int i10 = 0; i10 < i71Var.t(); i10++) {
                ArrayList arrayList = i71Var.u(i10).d;
                ...
                while (i11 < size) {
                    ...
                    i11++;
                    g71 g71Var2 = (g71) obj;
                    if (g71Var == null || ((!g71Var.b() && g71Var2.b()) || (g71Var.b() == g71Var2.b() && g71Var2.i * g71Var2.j < g71Var.i * g71Var.j))) {
                        g71Var = g71Var2;
                    }
                }
            }
            if (g71Var != null && !g71Var.b()) {
                int o10 = i71Var.o();
                e71 u10 = (o10 < 0 || o10 >= i71Var.t()) ? null : i71Var.u(o10);
                if (u10 != null) {
                    g71Var = u10.a();
                }
            }
            ...
            if (g71Var != null && !g71Var.d.equals(this.d)) {
                if (this.a) {
                    a();
                }
                this.d = g71Var.d;
                DispatchQueue dispatchQueue = Utilities.globalQueue;
                m71 m71Var = new m71((org.telegram.ui.ys0) this, g71Var, messageObject, 0);
                this.e = m71Var;
                dispatchQueue.postRunnable(m71Var);
            }
        } else {
            Uri uri = i71Var.C;
            if (uri != null) {
            ...
            if (uri != null && !uri.equals(this.d)) {
                ...
                gp gpVar = new gp((org.telegram.ui.ys0) this, uri, messageObject, 29);
                this.e = gpVar;
                dispatchQueue2.postRunnable(gpVar);
            }
        }
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [java.lang.Runnable, org.telegram.ui.Components.n71] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void e(MessageObject messageObject, final float f10, int i10) {
        ...
        DispatchQueue dispatchQueue = Utilities.globalQueue;
        ?? r52 = new Runnable() { // from class: org.telegram.ui.Components.n71
            @Override // java.lang.Runnable
            public final void run() {
                int i13;
                p71 p71Var = p71.this;
                RectF rectF = p71Var.E;
                if (p71Var.b == null) {
                    p71Var.h = f10;
                    return;
                }
                int max = Math.max(200, AndroidUtilities.dp(100.0f));
                Bitmap q10 = p71Var.b.q(j11, false);
                if (q10 != null) {
                    ...
                    try {
                        ...
                        canvas.drawBitmap(q10, (Rect) null, rectF, p71Var.F);
                ...
                AndroidUtilities.runOnUIThread(new k41(5, p71Var, q10));
            }
        };
        this.f = r52;
