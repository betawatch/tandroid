...
public final /* synthetic */ class gy implements View.OnClickListener {
    public final /* synthetic */ int a;
    public final /* synthetic */ iy b;

    public /* synthetic */ gy(iy iyVar, int i10) {
        this.a = i10;
        this.b = iyVar;
    }
    ...
    public final void onClick(View view) {
        ...
        switch (i11) {
            ...
            case 1:
                ...
                if (textView2 == null || textView2.getVisibility() != 0 || !textView2.isEnabled()) {
                    if (textView == null || textView.getVisibility() != 0 || !textView.isEnabled()) {
                        if (s0Var != null && s0Var.getVisibility() == 0 && s0Var.r.isEnabled()) {
                            s0Var.performClick();
                            break;
                        }
                    } else {
            ...
            case 2:
                rz rzVar2 = iyVar.E;
                ArrayList arrayList2 = rzVar2.p1;
                dy dyVar2 = iyVar.s;
                if (dyVar2 != null && (stickerSet2 = dyVar2.b) != null) {
                    dyVar2.f = true;
                    yx yxVar = rzVar2.R;
                    int i12 = rzVar2.c1;
                    ArrayList arrayList3 = rzVar2.q1;
                    px pxVar = rzVar2.P;
                    if (!arrayList2.contains(Long.valueOf(stickerSet2.id))) {
                        arrayList2.add(Long.valueOf(iyVar.s.b.id));
                    }
                    iyVar.a(true);
                    int i13 = 0;
                    while (true) {
                        if (i13 >= pxVar.getChildCount()) {
                            num = null;
                            view2 = null;
                        } else if (!(pxVar.getChildAt(i13) instanceof fy) || (R = RecyclerView.R((view2 = pxVar.getChildAt(i13)))) < 0 || (i10 = yxVar.w.get(R)) < 0 || i10 >= arrayList3.size() || arrayList3.get(i10) == null || iyVar.s == null || ((dy) arrayList3.get(i10)).b.id != iyVar.s.b.id) {
                            i13++;
                        } else {
                    ...
                    if (iyVar.n == null) {
                        ...
                        TLRPC.StickerSet stickerSet4 = iyVar.s.b;
            ...
            case 3:
                rz rzVar3 = iyVar.E;
                dy dyVar3 = iyVar.s;
                if (dyVar3 != null && (stickerSet3 = dyVar3.b) != null) {
                    dyVar3.f = false;
                    ArrayList arrayList4 = rzVar3.p1;
                    int i14 = rzVar3.c1;
                    ...
                    if (iyVar.r == null) {
                        ...
                        TLRPC.StickerSet stickerSet6 = iyVar.s.b;
