            ...
            if (getViewType() == 24) {
                ...
                if (getViewType() == 18) {
                    ...
                    while (i7 <= getMeasuredHeight()) {
                        ...
                        checkRtl(this.rectF);
                        canvas.drawRoundRect(this.rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint2);
                        this.rectF.set(AndroidUtilities.dp(i8 + 84), AndroidUtilities.dp(20.0f) + i7, AndroidUtilities.dp(i8 + NotificationCenter.groupCallSpeakingUsersUpdated), AndroidUtilities.dp(28.0f) + i7);
                        checkRtl(this.rectF);
                        canvas.drawRoundRect(this.rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint2);
                        this.rectF.set(AndroidUtilities.dp(f6), AndroidUtilities.dp(42.0f) + i7, AndroidUtilities.dp(NotificationCenter.fileUploadProgressChanged), AndroidUtilities.dp(50.0f) + i7);
                        checkRtl(this.rectF);
                        canvas.drawRoundRect(this.rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint2);
