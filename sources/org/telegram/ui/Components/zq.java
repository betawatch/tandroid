...
public abstract class zq {
    public static void a(Context context, final int i10, TLRPC.User user, TLRPC.TL_requestPeerTypeCreateBot tL_requestPeerTypeCreateBot, boolean z4, final Utilities.Callback callback, org.telegram.ui.ActionBar.f6 f6Var, qc qcVar) {
        ...
        TextView i12 = org.telegram.ui.ai.i(linearLayout, textView, k7.b6.t(-1, -2, 55, 16, 0, 16, 8), context);
        org.telegram.ui.b.l(i11, f6Var, i12, 1, 14.0f);
        i12.setText(AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(R.string.CreateManagedBotText, UserObject.getUserName(user)), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var)));
        i12.setGravity(17);
        linearLayout.addView(i12, k7.b6.t(-1, -2, 55, 16, 0, 16, 22));
        org.telegram.ui.Cells.h3 h3Var = new org.telegram.ui.Cells.h3(context, LocaleController.getString(R.string.CreateManagedBotName), false, false, -1, f6Var);
        org.telegram.ui.Cells.f3 f3Var = h3Var.b;
        f3Var.setImeOptions(5);
        int dp = AndroidUtilities.dp(16.0f);
        int i13 = org.telegram.ui.ActionBar.j6.d6;
        h3Var.setBackground(org.telegram.ui.ActionBar.j6.b0(dp, org.telegram.ui.ActionBar.j6.v0(i13, f6Var)));
        h3Var.setText(tL_requestPeerTypeCreateBot.suggested_name);
        linearLayout.addView(h3Var, k7.b6.t(-1, -2, 55, 12, 0, 12, 0));
        org.telegram.ui.Cells.z8 z8Var2 = new org.telegram.ui.Cells.z8(context, f6Var);
        z8Var2.setText(LocaleController.getString(R.string.CreateManagedBotNameInfo));
        linearLayout.addView(z8Var2, k7.b6.n(-1, -2));
        org.telegram.ui.Cells.h3 h3Var2 = new org.telegram.ui.Cells.h3(context, LocaleController.getString(R.string.CreateManagedBotUsername), false, false, 29, f6Var);
        LinearLayout linearLayout2 = new LinearLayout(context);
        linearLayout2.setOrientation(0);
        org.telegram.ui.Cells.f3 f3Var2 = h3Var2.b;
        h3Var2.removeView(f3Var2);
        f3Var2.setHintColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.H6, f6Var));
        f3Var2.setRightText("bot");
        f3Var2.setPadding(0, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(63.0f), AndroidUtilities.dp(15.0f));
        ...
        linearLayout2.addView(f3Var2, k7.b6.p(0, -1, 119.0f, 1, 0, 0, 0, 0));
        h3Var2.addView(linearLayout2, k7.b6.c(-1.0f, -1));
        h3Var2.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(16.0f), org.telegram.ui.ActionBar.j6.v0(i13, f6Var)));
        ...
        h3Var2.setText(str);
        linearLayout.addView(h3Var2, k7.b6.t(-1, -2, 55, 12, 0, 12, 0));
        f3Var.setOnEditorActionListener(new d1(h3Var2, 1));
        org.telegram.ui.Cells.z8 z8Var3 = new org.telegram.ui.Cells.z8(context, f6Var);
        z8Var3.setText(LocaleController.getString(R.string.CreateManagedBotUsernameInfo));
        linearLayout.addView(z8Var3, k7.b6.n(-1, -2));
        ...
        final int[] iArr = {-1};
        int[] iArr2 = {4};
        lh.s6 s6Var = new lh.s6(h3Var2, new int[]{-1}, i10, strArr, new String[1], p10, z8Var3, f6Var, iArr2);
        uq uqVar = new uq(strArr, s6Var, h3Var, iArr2, p10, z4, i10, user, iArr, zArr, callback, o10, f6Var, context);
        f3Var2.addTextChangedListener(new yq(s6Var));
        if (!TextUtils.isEmpty(str)) {
            s6Var.run();
        }
        f3Var2.setOnEditorActionListener(new d1(uqVar, 2));
        dVar.setOnClickListener(new a3(o10, 2));
        p10.setEnabled(false);
        p10.setOnClickListener(new g0(uqVar, 10));
        o10.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Components.vq
