            ...
            default:
                ...
                if (prefIntOrLong != 0) {
                    ...
                    if (user == null) {
                        ...
                        o2Var2.presentFragment(new org.telegram.ui.tn(bundle));
                        break;
                    } else {
                        org.telegram.ui.ActionBar.c2 c2Var2 = new org.telegram.ui.ActionBar.c2(o2Var2.getParentActivity(), 3, null);
                        c2Var2.c0 = false;
                        c2Var2.show();
                        ConnectionsManager.getInstance(currentAccount).sendRequest(new TLRPC.TL_help_getSupport(), new lh.b8(mainSettings, c2Var2, currentAccount, o2Var2, 2));
                        break;
                    }
                }
                user = null;
