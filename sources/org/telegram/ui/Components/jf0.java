...
public final class jf0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        org.telegram.ui.ActionBar.f5 f5Var = org.telegram.ui.ActionBar.g6.k3;
        if (f5Var != null) {
            f5Var.setAlpha((int) (getAlpha() * 255.0f));
            org.telegram.ui.ActionBar.g6.k3.setBounds(AndroidUtilities.dp(1.0f), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(125.0f), AndroidUtilities.dp(125.0f));
            org.telegram.ui.ActionBar.g6.k3.draw(canvas);
            org.telegram.ui.ActionBar.g6.S1.setColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.ra, false));
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 2) {
            ...
            if (i14 < 0) {
                f11 = s3.c.c(i14, i11, 0.5f, 1.0f);
            } else {
                if (i14 > AndroidUtilities.displaySize.x - layoutParams.width) {
                    f11 = org.telegram.messenger.rl.c((i14 - r11) + r10, i11, 0.5f, 1.0f);
                }
            }
        ...
        if (abs > dp) {
            ...
            if (i17 >= 0 || i17 <= (-pipRoundVideoView.h) / 4) {
                if (Math.abs(b11 - i17) > dp) {
                    ...
                    if (i18 <= i19 - i20 || i18 >= i19 - ((i20 / 4) * 3)) {
                        if (pipRoundVideoView.a.getAlpha() != 1.0f) {
                            ...
                            if (z10) {
                                z11 = true;
                                arrayList.add(ObjectAnimator.ofFloat(pipRoundVideoView.a, (Property<jf0, Float>) property, 0.0f));
                ...
                edit.putInt("sidex", 1);
                if (pipRoundVideoView.a.getAlpha() != 1.0f) {
                    jf0 jf0Var = pipRoundVideoView.a;
        ...
        if (pipRoundVideoView.a.getAlpha() != f10) {
            arrayList2.add(ObjectAnimator.ofFloat(pipRoundVideoView.a, (Property<jf0, Float>) property, f10));
        }
