...
public final class e40 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void U(boolean z4, boolean z10) {
        ...
        if (z10) {
            ...
            this.C = ofFloat;
            ofFloat.addUpdateListener(new c40(this, i10));
            this.C.addListener(new d40(this, z4, i10));
    ...
    public final void V(boolean z4, boolean z10) {
        ...
        this.x = ofFloat;
        ofFloat.addUpdateListener(new c40(this, i10));
        this.x.addListener(new d40(this, z4, i10));
        this.x.setDuration(320L);
        this.x.setInterpolator(mrVar);
        this.x.start();
    }
    ...
    public final View createView(Context context) {
        ...
        b40 b40Var = new b40(this, context, new qu0(null), this, new a40(), this.resourceProvider);
        this.n = b40Var;
