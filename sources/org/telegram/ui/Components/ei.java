...
public final class ei implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        if (i12 <= 0 || (i10 = i12 - viVar.L) > 100) {
            o6Var2.animate().alpha(0.0f).scaleX(0.5f).scaleY(0.5f).setDuration(100L).setListener(new q8(this, 5));
            o6Var.setAlpha(0.0f);
            z10 = true;
        } else {
            if (i10 < -9999) {
            ...
            if (i10 < 0) {
                o6Var2.setTextColor(viVar.getThemedColor(org.telegram.ui.ActionBar.j6.p7));
                z10 = false;
            } else {
                o6Var2.setTextColor(viVar.getThemedColor(org.telegram.ui.ActionBar.j6.y6));
                z10 = true;
            }
