    ...
    */
        ...
        if (z10) {
            ...
            if (f11 != 1.0f) {
                ...
                if (this.E >= 0) {
                    ...
                    f7 = 1.0f;
                    if (iArr[dz0Var.getValue()] != this.E) {
    ...
    public final void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (accessibilityEvent.getEventType() == 1) {
            ...
            if (value > dz0Var.getMaxValue() || value < 0) {
                value = 0;
            }
    ...
    public void setBackgroundColor(int i10) {
        ...
        dz0Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.j5, false));
        dz0Var.invalidate();
    }
}
