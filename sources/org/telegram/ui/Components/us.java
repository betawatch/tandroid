...
public abstract class us extends f2.q1 {
    ...
    public final void B(ArrayList arrayList, f2.n1 n1Var) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ...
            if (C(ssVar, n1Var) && ssVar.a == null && ssVar.b == null) {
    ...
    public final void E(f2.n1 n1Var) {
        n1Var.a.animate().setInterpolator(D);
        f(n1Var);
    }

    @Override // f2.u0
    public final boolean c(f2.n1 n1Var, List list) {
        return n1Var.a instanceof org.telegram.ui.Cells.v2;
    }
    ...
    public final void f(f2.n1 n1Var) {
        ...
        while (true) {
            ...
            if (((ts) arrayList.get(size)).a == n1Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                v(n1Var);
        ...
        for (int size3 = arrayList4.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                ...
                if (((ts) arrayList5.get(size4)).a == n1Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    v(n1Var);
    ...
    public final void g() {
        ...
        for (int size4 = arrayList4.size() - 1; size4 >= 0; size4--) {
            ...
            f2.n1 n1Var3 = ssVar.a;
            if (n1Var3 != null) {
                C(ssVar, n1Var3);
            }
            f2.n1 n1Var4 = ssVar.b;
            if (n1Var4 != null) {
                C(ssVar, n1Var4);
            }
        }
        ...
        if (k()) {
            ...
            for (int size9 = arrayList9.size() - 1; size9 >= 0; size9--) {
                ...
                for (int size10 = arrayList10.size() - 1; size10 >= 0; size10--) {
                    ...
                    f2.n1 n1Var6 = ssVar2.a;
                    if (n1Var6 != null) {
                        C(ssVar2, n1Var6);
                    }
                    f2.n1 n1Var7 = ssVar2.b;
                    if (n1Var7 != null) {
                        C(ssVar2, n1Var7);
                    }
    ...
    public final void m() {
        ...
        if (!isEmpty2) {
            ...
            arrayList3.clear();
            final int i13 = 0;
            new Runnable(this) { // from class: org.telegram.ui.Components.os
                    ...
                    switch (i14) {
                        case 0:
                            ...
                            while (true) {
                                ...
                                if (i15 >= size2) {
                                    arrayList7.clear();
                                    usVar.t.remove(arrayList7);
                                    break;
                                } else {
                                    Object obj2 = arrayList7.get(i15);
                                    i15++;
                                    ts tsVar = (ts) obj2;
                                    f2.n1 n1Var2 = tsVar.a;
                                    int i16 = tsVar.b;
                                    int i17 = tsVar.c;
                                    int i18 = tsVar.d;
                                    int i19 = tsVar.e;
                                    ...
                                    org.telegram.ui.Cells.p2 p2Var3 = usVar.z;
                                    if (p2Var3 != null) {
                                        if (usVar.A != Integer.MAX_VALUE) {
                                            int measuredHeight3 = p2Var3.getMeasuredHeight();
                                            int i22 = usVar.A;
                                            usVar.B = measuredHeight3 - i22;
                                            usVar.z.setTopClip(i22);
                                            usVar.z.setBottomClip(usVar.B);
                                        } else if (usVar.B != Integer.MAX_VALUE) {
                                            int measuredHeight4 = p2Var3.getMeasuredHeight() - usVar.B;
                                            usVar.A = measuredHeight4;
                                            usVar.z.setTopClip(measuredHeight4);
                                            usVar.z.setBottomClip(usVar.B);
                                        }
                                    }
                                    ViewPropertyAnimator animate2 = view2.animate();
                                    usVar.w.add(n1Var2);
                                    animate2.setDuration(180L).setListener(new f2.h(usVar, n1Var2, i20, view2, i21, animate2, 1)).start();
                                }
                            }
                        default:
                            ...
                            while (true) {
                                ...
                                if (i23 >= size3) {
                                    arrayList7.clear();
                                    usVar2.u.remove(arrayList7);
                                    break;
                                } else {
                                    Object obj3 = arrayList7.get(i23);
                                    i23++;
                                    ss ssVar = (ss) obj3;
                                    ArrayList arrayList8 = usVar2.y;
                                    f2.n1 n1Var3 = ssVar.a;
                                    f2.n1 n1Var4 = ssVar.b;
                                    if (n1Var3 != null && n1Var4 != null) {
                                        ...
                                        animatorSet.playTogether(ObjectAnimator.ofFloat(view3, (Property<View, Float>) property, 0.0f), ObjectAnimator.ofFloat(n1Var4.a, (Property<View, Float>) property, 1.0f));
                                        arrayList8.add(ssVar.a);
                                        arrayList8.add(ssVar.b);
    ...
    public final void p(f2.n1 n1Var) {
        ...
        if (arrayList.size() > 2) {
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ((f2.n1) arrayList.get(i10)).a.setAlpha(0.0f);
                if (((f2.n1) arrayList.get(i10)).a instanceof org.telegram.ui.Cells.p2) {
                    ((org.telegram.ui.Cells.p2) ((f2.n1) arrayList.get(i10)).a).setMoving(true);
                }
            }
        }
    }
    ...
    public final boolean r(f2.n1 n1Var, a5.e eVar, int i10, int i11, int i12, int i13) {
        ...
        ts tsVar = new ts();
        tsVar.a = n1Var;
        tsVar.b = translationX;
        tsVar.c = translationY;
        tsVar.d = i12;
        tsVar.e = i13;
        this.q.add(tsVar);
        return true;
    ...
    public final void z(ArrayList arrayList) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ((f2.n1) arrayList.get(size)).a.animate().cancel();
        }
    }
}
