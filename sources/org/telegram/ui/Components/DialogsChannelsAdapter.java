...
public abstract class DialogsChannelsAdapter extends UniversalAdapter {
    ...
    public DialogsChannelsAdapter(RecyclerListView recyclerListView, Context context, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.searchMessagesRunnable = new Runnable() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda2
            ...
            public final void run() {
                DialogsChannelsAdapter.this.searchMessages(false);
            }
        };
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (TextUtils.isEmpty(this.query)) {
            ...
            if (arrayList2 != null && !arrayList2.isEmpty()) {
                if (this.myChannels.size() > 5) {
                    arrayList.add(UItem.asGraySection(LocaleController.getString(R.string.SearchMyChannels), LocaleController.getString(this.expandedMyChannels ? R.string.ShowLess : R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda4
        ...
        if (!arrayList5.isEmpty()) {
            if (arrayList5.size() <= 5 || this.messages.isEmpty()) {
                ...
                arrayList.add(UItem.asGraySection(LocaleController.getString(R.string.SearchChannels), LocaleController.getString(this.expandedSearchChannels ? R.string.ShowLess : R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
    ...
    public void searchMessages(final boolean z) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                DialogsChannelsAdapter.$r8$lambda$6K4G3Mr3AB_24DUNRcGrppR6Y9w(DialogsChannelsAdapter.this, i, tL_messages_searchGlobal, z);
            }
        }, z ? 800L : 0L);
        if (z) {
            return;
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_contacts_search, new AiTonesController$$ExternalSyntheticLambda0(), new Utilities.Callback2() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda1
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                DialogsChannelsAdapter.$r8$lambda$dDvGZwBhuOfEuTi4BIGYM0Dlq7c(DialogsChannelsAdapter.this, tL_contacts_search, (TLRPC.TL_contacts_found) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$6K4G3Mr3AB_24DUNRcGrppR6Y9w(final DialogsChannelsAdapter dialogsChannelsAdapter, final int i, final TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, final boolean z) {
        if (i == dialogsChannelsAdapter.searchChannelsId && TextUtils.equals(tL_messages_searchGlobal.q, dialogsChannelsAdapter.query)) {
            ConnectionsManager.getInstance(dialogsChannelsAdapter.currentAccount).sendRequest(tL_messages_searchGlobal, new RequestDelegate() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda6
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    DialogsChannelsAdapter.$r8$lambda$lZ0uXakBByyax4fxqJfu1zNIt60(DialogsChannelsAdapter.this, i, tL_messages_searchGlobal, z, tLObject, tL_error);
                }
            });
        }
    }

    public static /* synthetic */ void $r8$lambda$lZ0uXakBByyax4fxqJfu1zNIt60(final DialogsChannelsAdapter dialogsChannelsAdapter, final int i, final TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, final boolean z, final TLObject tLObject, TLRPC.TL_error tL_error) {
        dialogsChannelsAdapter.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                DialogsChannelsAdapter.$r8$lambda$H0uugsGTBEhreSyR9q7lBmqIXhs(DialogsChannelsAdapter.this, i, tL_messages_searchGlobal, z, tLObject);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$H0uugsGTBEhreSyR9q7lBmqIXhs(DialogsChannelsAdapter dialogsChannelsAdapter, int i, TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, boolean z, TLObject tLObject) {
        if (i == dialogsChannelsAdapter.searchChannelsId && TextUtils.equals(tL_messages_searchGlobal.q, dialogsChannelsAdapter.query)) {
    ...
    public static /* synthetic */ void $r8$lambda$dDvGZwBhuOfEuTi4BIGYM0Dlq7c(DialogsChannelsAdapter dialogsChannelsAdapter, TLRPC.TL_contacts_search tL_contacts_search, TLRPC.TL_contacts_found tL_contacts_found, TLRPC.TL_error tL_error) {
        TLRPC.Chat chat;
        TLRPC.Chat chat2;
        dialogsChannelsAdapter.getClass();
