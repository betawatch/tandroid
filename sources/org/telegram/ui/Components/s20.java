...
public final class s20 {
    ...
    */
    public final boolean a(MotionEvent motionEvent) {
        ...
        if (i11 != 0) {
            if (i11 == 1) {
                ...
                if (!this.q) {
                    if (this.k) {
                        ...
                        boolean onSingleTapUp = r20Var2.onSingleTapUp(motionEvent);
                        if (this.j && (q20Var = this.h) != null) {
                            ((PhotoViewer) q20Var).Z1(motionEvent);
                        }
                        z17 = onSingleTapUp;
                    } else {
                        ...
                        if (Math.abs(yVelocity) > this.d || Math.abs(xVelocity) > this.d) {
                            z17 = r20Var2.onFling(this.n, motionEvent, xVelocity, yVelocity);
                        }
                    }
                    z17 = false;
                }
            ...
            if (this.q) {
                ...
                if (this.l) {
                    ...
                    int i20 = i10;
                    if (i20 > i19) {
                        onScroll = r20Var2.onScroll(this.n, motionEvent, f14, f15);
                        this.r = f12;
                        this.s = f13;
                        z15 = false;
                        this.l = false;
        ...
        q20 q20Var2 = this.h;
        if (q20Var2 != null) {
            PhotoViewer photoViewer = (PhotoViewer) q20Var2;
            ...
            if (motionEvent6 == null || (motionEvent3 = this.p) == null || !hasMessages2 || !this.m) {
                ...
                if (eventTime <= i21 && eventTime >= 40) {
                    ...
                    if ((y3 * y3) + (x11 * x11) < this.c) {
                        ...
                        PhotoViewer photoViewer2 = (PhotoViewer) q20Var3;
                                    ...
                                    if (j11 > A1) {
                                        ...
                                        if (j11 < 0) {
                                            ...
                                            if (z11) {
                                                ...
                                                j71 j71Var = photoViewer2.z1;
                                                r20Var = r20Var2;
                                                long j12 = j71Var.o + 10000;
                                                j71Var.o = j12;
                                                j71Var.p = LocaleController.formatPluralString("Seconds", (int) (j12 / 1000), new Object[0]);
                                                photoViewer2.t2(j10);
                                            ...
                                            return r20Var.onDown(motionEvent) | z10;
                                        }
                                        j10 = j11;
                                    }
                                    z11 = true;
                        ...
                        if (photoViewer2.I6 && ((photoViewer2.a6 != 1.0f || (photoViewer2.Y5 == 0.0f && photoViewer2.X5 == 0.0f)) && photoViewer2.n6 == j3 && photoViewer2.n4 == 0)) {
                            org.telegram.ui.av0 av0Var = photoViewer2.W0[0];
                            if (av0Var == null || !av0Var.p || av0Var.h == -1) {
                                cVar = cVar2;
                            } else {
                                cVar = cVar2;
                            }
                            if (photoViewer2.a6 == 1.0f) {
                                float c10 = org.telegram.messenger.em.c(3.0f, photoViewer2.a6, (motionEvent7.getX() - (photoViewer2.k1(photoViewer2.u4) / 2)) - photoViewer2.X5, motionEvent7.getX() - (photoViewer2.k1(photoViewer2.u4) / 2));
                                float c11 = org.telegram.messenger.em.c(3.0f, photoViewer2.a6, (motionEvent7.getY() - (photoViewer2.i1() / 2)) - photoViewer2.Y5, motionEvent7.getY() - (photoViewer2.i1() / 2));
