...
public final class s20 extends FrameLayout implements org.telegram.ui.Components.voip.m0 {
    ...
    public final void b(boolean z4) {
        t20 t20Var = this.M;
        if (t20Var.r.isDismissed()) {
            return;
        }
        if (z4 && this.v == null) {
            this.v = org.telegram.ui.Components.voip.t.c(t20Var.h, t20Var.n, null, this, null, this.f, t20Var.c, t20Var.r);
        } else {
            if (z4) {
                return;
            }
    ...
    */
    ...
    public final void e(ChatObject.VideoParticipant videoParticipant, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        if (videoParticipant == null) {
            this.E = t20Var.n.d == MessageObject.getPeerId(groupCallParticipant.peer);
        } else {
            ChatObject.VideoParticipant videoParticipant2 = t20Var.n.e;
    ...
    */
        ...
        if (n0Var2.k) {
            ...
            if (!n0Var2.e) {
                ...
                if (!z4) {
                    ...
                    this.K.addListener(new r20(this, w02, w03, i10));
                    this.K.start();
                    return;
                }
    ...
    public final void onAttachedToWindow() {
        ...
        t20 t20Var = this.M;
        org.telegram.ui.c60 c60Var = t20Var.r;
        if (t20Var.s && this.f != null) {
            b(true);
        }
        this.H = true;
        if (c60Var.q2.size() > 0) {
            this.F = (org.telegram.ui.Components.voip.n0) e2.c.g(1, c60Var.q2);
        } else {
