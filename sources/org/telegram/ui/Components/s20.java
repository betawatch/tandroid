...
public final class s20 extends FrameLayout implements org.telegram.ui.Components.voip.o0 {
    ...
    public final void b(boolean z10) {
        ...
        if (z10 && this.v == null) {
            this.v = org.telegram.ui.Components.voip.u.c(t20Var.h, t20Var.n, null, this, null, this.f, t20Var.c, t20Var.r);
        } else {
            if (z10) {
                return;
            }
    ...
    */
    ...
    public final void e(ChatObject.VideoParticipant videoParticipant, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        if (videoParticipant == null) {
            this.H = t20Var.n.d == MessageObject.getPeerId(groupCallParticipant.peer);
        } else {
        ...
        if (p0Var2.k) {
            ...
            if (!p0Var2.e) {
                ...
                if (!z10) {
                    ...
                    this.N = ofFloat;
                    ofFloat.addUpdateListener(new r20(this, i10, w02, i11, w03, 0));
