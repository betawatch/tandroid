...
public final class bv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final long s;
    public long v;
    public final org.telegram.ui.ActionBar.m2 w;
    public boolean y;
    ...
    public bv0(org.telegram.ui.ActionBar.m2 m2Var) {
        ...
        if (m2Var instanceof ch) {
            ...
            if (a2 != m2Var.getUserConfig().getClientUserId()) {
                m2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a2, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.av0
                    ...
                    public final void run(Object obj) {
                        ...
                        switch (i11) {
                            case 0:
                                bv0 bv0Var = this.b;
                                ArrayList arrayList = bv0Var.x;
                                boolean booleanValue = bool.booleanValue();
                                bv0Var.f = booleanValue;
                                bv0Var.h = true;
                                if (booleanValue) {
                                    int size = arrayList.size();
                                    for (int i12 = 0; i12 < size; i12++) {
                                        ((cv0) arrayList.get(i12)).M();
                                    }
                                    break;
                                }
                                break;
                            default:
                                bv0 bv0Var2 = this.b;
                                ArrayList arrayList2 = bv0Var2.x;
                                boolean booleanValue2 = bool.booleanValue();
                                bv0Var2.f = booleanValue2;
                                bv0Var2.h = true;
                                if (booleanValue2) {
                                    int size2 = arrayList2.size();
                                    for (int i13 = 0; i13 < size2; i13++) {
                                        ((cv0) arrayList2.get(i13)).M();
                                    }
                                    break;
                                }
                                break;
            ...
            if (profileActivity.h1) {
                ...
                if (a10 != m2Var.getUserConfig().getClientUserId()) {
                    m2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a10, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.av0
                        public final /* synthetic */ bv0 b;
            ...
            this.r = m2Var.getUserConfig().getClientUserId();
        }
        if (this.v == 0 && DialogObject.isChatDialog(this.r) && (chatFull = m2Var.getMessagesController().getChatFull(-this.r)) != null) {
        ...
        int i12 = 0;
        while (true) {
            yu0[] yu0VarArr = this.n;
            if (i12 >= yu0VarArr.length) {
                break;
            }
            yu0VarArr[i12] = new yu0();
        ...
        a();
        org.telegram.ui.ActionBar.m2 m2Var2 = this.w;
        if (m2Var2 == null) {
            this.E = null;
        } else {
    ...
    public final void a() {
        ...
        m2Var.getMediaDataController().getMediaCounts(this.r, this.s, m2Var.getClassGuid());
        if (this.v != 0) {
            m2Var.getMediaDataController().getMediaCounts(this.v, this.s, m2Var.getClassGuid());
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.didReceiveNewMessages) {
            ...
            if (longValue5 == j10 || longValue5 == this.v) {
                ...
                org.telegram.ui.ActionBar.m2 m2Var = this.w;
                int currentAccount = m2Var != null ? m2Var.getCurrentAccount() : -1;
                for (int i24 = 0; i24 < arrayList.size(); i24++) {
                    ...
                    if (!messageObject.isEphemeral()) {
                        ...
                        if ((j11 == 0 || j11 == MessageObject.getTopicId(currentAccount, messageObject.messageOwner, true)) && MessageObject.getMedia(messageObject.messageOwner) != null && !messageObject.needDrawBluredPreview() && (mediaType = MediaDataController.getMediaType(messageObject.messageOwner)) != -1 && ((mediaType != 0 || this.n[0].q != 2 || messageObject.isVideo()) && (mediaType != 0 || this.n[0].q != 1 || !messageObject.isVideo()))) {
                            yu0 yu0Var = this.n[mediaType];
                            if (yu0Var.l) {
                                yu0Var.a(messageObject, i23, true, isEncryptedDialog);
                            }
                            if (this.s == 0) {
                            ...
                            if (i23 == 0) {
                                for (int i25 = 0; i25 < this.n[mediaType].e.size(); i25++) {
                                    ((hu0) this.n[mediaType].e.get(i25)).b++;
                                }
                            }
                        }
                    }
        ...
        if (i10 != NotificationCenter.messageReceivedByServer) {
            ...
            if (i10 == NotificationCenter.messagesDeleted) {
                ...
                org.telegram.ui.ActionBar.m2 m2Var2 = this.w;
                int currentAccount2 = m2Var2 != null ? m2Var2.getCurrentAccount() : -1;
                ...
                for (int i28 = 0; i28 < size3; i28++) {
                    ...
                    while (true) {
                        yu0[] yu0VarArr = this.n;
                        if (i29 < yu0VarArr.length) {
                            MessageObject b10 = yu0VarArr[i29].b(((Integer) arrayList3.get(i28)).intValue(), 0);
                            if (b10 != null) {
            ...
            if (i10 != NotificationCenter.replaceMessagesObjects) {
                ...
                if (i10 == NotificationCenter.fileLoaded) {
                    ...
                    int i34 = 0;
                    while (true) {
                        yu0[] yu0VarArr2 = this.n;
                        if (i34 >= yu0VarArr2.length) {
                            break;
                        }
                        arrayList4.addAll(yu0VarArr2[i34].a);
                        i34++;
                    }
                ...
                if (i10 == NotificationCenter.savedMessagesDialogsUpdate) {
                    org.telegram.ui.ActionBar.m2 m2Var3 = this.w;
                    boolean z12 = m2Var3 != null && m2Var3.getMessagesController().getSavedMessagesController().containsDialog(this.r);
            ...
            if (longValue8 == j13 || longValue8 == this.v) {
                ...
                org.telegram.ui.ActionBar.m2 m2Var4 = this.w;
                int currentAccount3 = m2Var4 != null ? m2Var4.getCurrentAccount() : -1;
                ...
                while (i37 < size6) {
                    ...
                    if (j14 == 0 || topicId == j14) {
                        int i38 = 0;
                        while (true) {
                            yu0[] yu0VarArr3 = this.n;
                            if (i38 >= yu0VarArr3.length) {
                                break;
                            }
                            MessageObject messageObject3 = (MessageObject) yu0VarArr3[i38].b[i36].get(id2);
        ...
        while (true) {
            yu0[] yu0VarArr4 = this.n;
            if (i17 >= yu0VarArr4.length) {
                return;
            }
            yu0VarArr4[i17].f(i41, num.intValue(), num2.intValue());
            i17++;
        }
    }
}
