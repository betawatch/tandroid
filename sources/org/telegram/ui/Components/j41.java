...
public final /* synthetic */ class j41 implements Runnable {
    ...
    public /* synthetic */ j41(org.telegram.ui.wk wkVar, boolean[] zArr, String str, LinearLayout linearLayout, ArrayList arrayList, String str2, TranslateController translateController, org.telegram.ui.ActionBar.n1 n1Var, ArrayList arrayList2) {
        this.d = wkVar;
        this.e = zArr;
        this.f = str;
        this.n = linearLayout;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                boolean z10 = false;
                if (!zArr[0]) {
                    if (str != null && (y3 = u31.y(u31.E(str, null, null))) != null) {
                    ...
                    linearLayout.addView(new org.telegram.ui.ActionBar.k1(wkVar.getContext(), wkVar.d), w7.x5.n(-1, 8));
