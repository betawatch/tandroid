...
public class qo0 {
    ...
    public final void b(Canvas canvas) {
        ...
        if (size != this.y) {
            ...
            if (size >= 0 && size < this.u.size()) {
                e((c61) ((Pair) this.u.get(this.y)).second);
            }
        }
        if (this.B < 1.0f) {
    ...
    */
    public final void c(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = E;
        float f11 = i11 / 2.0f;
        float f12 = qo0Var.f - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp = AndroidUtilities.dp(qo0Var.x * 1.0f) / 2.0f;
        if (G == null) {
            G = new Path();
        }
        G.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= qo0Var.u.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) qo0Var.u.get(i12)).first).floatValue() >= dp2) {
                break;
            } else {
                i12++;
            }
        ...
        int size = qo0Var.u.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) qo0Var.u.get(size)).first).floatValue() >= dp2) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) qo0Var.u.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) qo0Var.u.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= qo0Var.u.size() - 1 || ((Float) ((Pair) qo0Var.u.get(i13)).first).floatValue() - floatValue > dp2) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) qo0Var.u.get(i13)).first).floatValue();
            }
            c11 = 1;
            ...
            for (c61 c61Var : c61VarArr) {
                try {
                    if (c61Var != null && c61Var.getURL() != null && c61Var.d != null && c61Var.getURL().startsWith("audio?") && (parseInt = Utilities.parseInt((CharSequence) c61Var.getURL().substring(6))) != null && parseInt.intValue() >= 0) {
                        ...
                        this.u.add(new Pair(Float.valueOf((parseInt.intValue() * 1000) / valueOf.longValue()), c61Var));
                    }
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
            Collections.sort(this.u, new org.telegram.ui.df(14));
        } catch (Exception e7) {
            FileLog.e(e7);
            this.u = null;
            this.y = -1;
