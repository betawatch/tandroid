...
public final class k30 extends View implements GestureDetector.OnGestureListener {
    ...
    private ImageReceiver getFreeReceiver() {
        ...
        imageReceiver.setCurrentAccount(((org.telegram.ui.tr0) this.S).a.P);
            ...
            if (i11 != Integer.MIN_VALUE) {
                ...
                while (i11 < size2) {
                    ...
                    if (arrayList4.get(0) instanceof MessageObject) {
                        ...
                        org.telegram.ui.wt0 wt0Var = ((org.telegram.ui.tr0) this.S).a.f7;
                        obj = wt0Var != null ? wt0Var.g() : null;
                    } else {
                        obj = "avatar_" + ((org.telegram.ui.tr0) this.S).a.v5;
                    }
            ...
            if (i12 != Integer.MAX_VALUE) {
                while (i12 >= 0) {
                    ...
                    if (arrayList4.get(0) instanceof MessageObject) {
                        ...
                        org.telegram.ui.wt0 wt0Var2 = ((org.telegram.ui.tr0) this.S).a.f7;
                        sb2 = wt0Var2 != null ? wt0Var2.g() : null;
                    } else {
                        StringBuilder sb3 = new StringBuilder(str2);
                        str = str2;
                        sb3.append(((org.telegram.ui.tr0) this.S).a.v5);
                        sb2 = sb3.toString();
    ...
    */
    public final void b() {
        ...
        PhotoViewer photoViewer = ((org.telegram.ui.tr0) this.S).a;
        int i14 = photoViewer.L4;
        ArrayList arrayList = photoViewer.W6;
        ArrayList arrayList2 = photoViewer.U6;
        org.telegram.ui.wt0 wt0Var = photoViewer.f7;
        List all = wt0Var != null ? wt0Var.getAll() : null;
        int i15 = ((org.telegram.ui.tr0) this.S).a.v;
        this.Q = false;
        long j11 = 0;
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            boolean z12 = arrayList2.size() > 1 && (au0Var = ((org.telegram.ui.tr0) this.S).a.d) != null && au0Var.K();
            if (this.h != 0 || z12) {
                this.Q = true;
        ...
        if (z13) {
            if (this.Q) {
                ...
                if (f10 < 1.0f && this.T == null) {
                    ...
                    this.T.addListener(new i30(this, i20));
                    this.T.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.h30
                ...
                if (this.V > 0.0f && arrayList3.size() > 1) {
                    if (this.U == null) {
                        ...
                        final int i21 = 0;
                        this.U.addListener(new i30(this, i21));
                        this.U.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.h30
                            public final /* synthetic */ k30 b;
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator22) {
                                switch (i21) {
                                    case 0:
                                        k30 k30Var = this.b;
                                        k30Var.getClass();
                                        k30Var.V = ((Float) valueAnimator22.getAnimatedValue()).floatValue();
                                        k30Var.invalidate();
                                        break;
                                    default:
                                        k30 k30Var2 = this.b;
                                        k30Var2.getClass();
                                        k30Var2.V = ((Float) valueAnimator22.getAnimatedValue()).floatValue();
                                        k30Var2.invalidate();
                                        break;
                                }
                            }
        ...
        if (!z10) {
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
                ...
                org.telegram.ui.au0 au0Var2 = ((org.telegram.ui.tr0) this.S).a.d;
    ...
    public final void e() {
        ...
        if (i10 >= 0 && i10 < this.e.size()) {
            ...
            j30 j30Var = this.S;
            if (j30Var != null) {
                PhotoViewer photoViewer = ((org.telegram.ui.tr0) j30Var).a;
    ...
    public final void f() {
        ...
        if (i18 != i19 && i19 >= 0 && i19 < this.d.size()) {
            ...
            if (i17 >= 0) {
                this.N = true;
                ((org.telegram.ui.tr0) this.S).a(i17);
            }
        }
        if (!this.L) {
            this.L = true;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10 || !arrayList.isEmpty()) {
            ...
            float f13 = this.A;
            int i19 = (int) (f11 * f13);
            int i20 = (int) (((((min2 + i19) - i12) / 2) * f13 * (this.B > this.f ? -1 : 1)) + i11);
            ...
            if (i26 >= 0) {
                ...
                if (f14 > 0.0f) {
                    ...
                    if (i26 == this.f) {
                        ...
                        er erVar = er.g;
                        this.A = erVar.getInterpolation(1.0f - f16);
                        if (this.M) {
                            float f19 = this.y;
                            if (f19 > 0.0f) {
                            ...
                            this.y = erVar.getInterpolation(this.x);
                    ...
                    if (param < arrayList4.size()) {
                        if (arrayList2 != null && !arrayList2.isEmpty()) {
                            ...
                            if (i10 != indexOf) {
                                this.x = 1.0f;
                                this.E = true;
                                ((org.telegram.ui.tr0) this.S).a(indexOf);
                                return false;
                            }
                        } else if (all != null && !all.isEmpty()) {
                            ...
                            if (i10 != indexOf2) {
                                this.x = 1.0f;
                                this.E = true;
                                ((org.telegram.ui.tr0) this.S).a(indexOf2);
                                return false;
                            }
                        } else if (arrayList != null && !arrayList.isEmpty()) {
                            ...
                            if (i10 != indexOf3) {
                                this.x = 1.0f;
                                this.E = true;
                                ((org.telegram.ui.tr0) this.S).a(indexOf3);
                                return false;
                            }
                        }
                    }
