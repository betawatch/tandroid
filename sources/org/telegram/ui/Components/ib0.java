...
public final class ib0 extends ll0 {
    public final /* synthetic */ qb0 X2;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ib0(qb0 qb0Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var);
        this.X2 = qb0Var;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        qb0 qb0Var2 = this.X2;
        org.telegram.ui.w8 w8Var = qb0Var2.b;
        boolean z11 = false;
        ...
        int i12 = 0;
        while (i12 < 3) {
            wb0 wb0Var = qb0Var2.c0;
            ArrayList arrayList = wb0Var.E;
            ib0 ib0Var = qb0Var2.f;
            wb0Var.E.clear();
            if (i12 != 2 || ib0Var.X1) {
                int i13 = 0;
                ?? r32 = z11;
                ...
                while (i18 < arrayList.size()) {
                    ...
                    if (groupedMessages2 == null) {
                        ...
                        if (f13 > AndroidUtilities.dp(20.0f) + ib0Var.getMeasuredHeight()) {
                            f13 = AndroidUtilities.dp(20.0f) + ib0Var.getMeasuredHeight();
                        }
                        ...
                        if (z12) {
                            ...
                            for (int i19 = 0; i19 < childCount; i19++) {
                                View childAt4 = ib0Var.getChildAt(i19);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        t1Var.u3(true);
        t1Var.V1(canvas);
        if (t1Var.getCurrentMessagesGroup() == null || ((t1Var.getCurrentPosition() != null && (((t1Var.getCurrentPosition().flags & t1Var.t0()) != 0 && (t1Var.getCurrentPosition().flags & 1) != 0) || (t1Var.getCurrentMessagesGroup() != null && t1Var.getCurrentMessagesGroup().isDocuments))) || t1Var.getTransitionParams().w0)) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        ib0 ib0Var = qb0Var.f;
        if (qb0Var.U) {
            if (ib0Var.computeVerticalScrollRange() > ib0Var.computeVerticalScrollExtent()) {
                qb0Var.postDelayed(new bb0(qb0Var, 0), 0L);
            }
            qb0Var.U = false;
        }
        if (qb0Var.N && i14 == 0) {
