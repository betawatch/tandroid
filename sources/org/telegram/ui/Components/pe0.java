...
public final class pe0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i20 = ye0Var.w;
        i10 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingTop;
        int i21 = i20 - i10;
        int dp = AndroidUtilities.dp(30.0f) + getMeasuredHeight();
        i11 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingTop;
        int i22 = i11 + dp;
        float dp2 = AndroidUtilities.dp(12.0f);
        i12 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingTop;
        if (i12 + i21 < dp2) {
            i19 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingTop;
        ...
        int i24 = i21 + i23;
        int i25 = i22 - i23;
        drawable = ((org.telegram.ui.ActionBar.f3) ye0Var).shadowDrawable;
        drawable.setBounds(0, i24, getMeasuredWidth(), i25);
        drawable2 = ((org.telegram.ui.ActionBar.f3) ye0Var).shadowDrawable;
        drawable2.draw(canvas);
        if (f7 != 1.0f) {
            paint.setColor(ye0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
            i15 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingLeft;
            i16 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingTop;
            float f10 = i16 + i24;
            int measuredWidth = getMeasuredWidth();
            i17 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingLeft;
            float f11 = measuredWidth - i17;
            i18 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingTop;
        ...
        i13 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingLeft;
        float f13 = i13;
        int measuredWidth2 = getMeasuredWidth();
        i14 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingLeft;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ye0 ye0Var = this.d;
        qe0 qe0Var = ye0Var.c;
        i12 = ((org.telegram.ui.ActionBar.f3) ye0Var).backgroundPaddingLeft;
        ...
        ((FrameLayout.LayoutParams) ye0Var.f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.b = true;
