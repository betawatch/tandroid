    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.a) {
            case 0:
                ...
                float interpolation = nr.i.getInterpolation(min < 0.3f ? min / 0.3f : 1.0f);
                nr nrVar = nr.g;
                float interpolation2 = nrVar.getInterpolation(min < 0.3f ? 0.0f : (min - 0.3f) / 0.7f);
                if (this.d) {
                    dp = e2.c.w(1.0f, interpolation, AndroidUtilities.dp(7.0f) - AndroidUtilities.dp(2.1f), AndroidUtilities.dp(2.1f) * interpolation);
                    dpf2 = (1.0f - nrVar.getInterpolation(this.e / 2.0f)) * AndroidUtilities.dpf2(1.5f);
                } else {
