...
public final class w8 extends org.telegram.ui.ActionBar.o2 {
    ...
    public final View createView(Context context) {
        ...
        c40 c40Var = this.P;
        org.telegram.ui.ActionBar.w0 e10 = n10.e(1, (c40Var == null || c40Var.c != 2) ? LocaleController.getString(R.string.SetPhoto) : LocaleController.getString(R.string.SuggestPhoto));
        this.N = e10;
        e10.setBackground(org.telegram.ui.ActionBar.f6.f0(k10, 3, -1));
        this.D.setActionBarMenuOnItemClick(new n8(this, 1));
        this.r = new ta1(this, getParentActivity(), 6);
        o8 o8Var = new o8(this, context);
        o8Var.setFitsSystemWindows(true);
        o8Var.setBackgroundColor(org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.a7, false));
        ...
        this.r.addView(this.S, g7.e6.t(-1, -2, 0, 21, 10, 21, 10));
        gh.h1 h1Var = new gh.h1(this, getParentActivity());
        t8 t8Var = new t8(this, getParentActivity());
        this.F = t8Var;
        h1Var.addView(t8Var);
        this.r.addView(h1Var, g7.e6.t(-1, 48, 0, 12, 0, 12, 0));
        ...
        this.r.addView(this.R, g7.e6.t(-1, -2, 0, 21, 18, 21, 10));
        q8 q8Var = new q8(this, this, getParentActivity(), getThemedColor(i9));
        this.b = q8Var;
        q8Var.N = true;
        q8Var.setAnimationsEnabled(this.fragmentBeginToShow);
        this.b.setClipChildren(false);
        this.r.addView(this.b, g7.e6.t(-1, -1, 0, 12, 0, 12, 12));
        this.r.setClipChildren(false);
        o8Var.addView(this.r, g7.e6.d(-1, -1.0f, 0, 0.0f, 0.0f, 0.0f, 64.0f));
        ...
        } else if (c40Var == null || c40Var.c != 2) {
        ...
        o8Var.addView(this.x, g7.e6.d(-1, 48.0f, 80, 16.0f, 16.0f, 16.0f, 16.0f));
        o8Var.addView(this.y, g7.e6.d(-1, 80.0f, 80, 8.0f, 16.0f, 8.0f, 64.0f));
        o8Var.addView(this.actionBar);
        o8Var.addView(this.D);
        o8Var.addView(this.e, g7.e6.c(-1.0f, -1));
    ...
    */
    public final void e0() {
        ...
        int i10 = 1;
        if (d0()) {
            new oc(this.y, this.resourceProvider).Q(R.raw.star_premium_2, 36, AndroidUtilities.premiumText(LocaleController.getString(R.string.PremiumAvatarToast), new i8(this, i10))).j();
            return;
        }
        g1 g1Var = this.E;
        if (g1Var != null) {
            ...
            z10 z10Var = new z10();
            if (s8Var != null) {
                z10Var.d(s8Var.c, s8Var.d, s8Var.e, s8Var.f);
            } else {
                int[] iArr = Y[0];
                z10Var.d(iArr[0], iArr[1], iArr[2], iArr[3]);
            }
            z10Var.b(0.0f, 0.0f, 800.0f, 800.0f);
            canvas.drawRect(0.0f, 0.0f, 800.0f, 800.0f, z10Var.c);
            ...
            try {
                ...
                e = e11;
                e.printStackTrace();
                int i11 = (int) 120.00001f;
                int i12 = (int) 560.0f;
                imageReceiver = p8Var.getImageReceiver();
                if (imageReceiver.getAnimation() == null) {
                }
                file = new File(FileLoader.getDirectory(i9), SharedConfig.getLastLocalId() + "avatar_background.png");
                file.createNewFile();
            ...
            if (p8Var.getImageReceiver().getAnimation() == null || p8Var.getImageReceiver().getLottieAnimation() != null) {
                ...
                if (p8Var.a == 0) {
                    ...
                    int i13 = p8Var.h.d;
                    if (i13 != 0) {
                        tL_videoSizeEmojiMarkup.background_colors.add(Integer.valueOf(i13));
                    }
                    int i14 = p8Var.h.e;
                    if (i14 != 0) {
                    ...
                    int i16 = p8Var.h.d;
                    if (i16 != 0) {
                        tL_videoSizeStickerMarkup.background_colors.add(Integer.valueOf(i16));
                    }
                    int i17 = p8Var.h.e;
                    if (i17 != 0) {
                ...
                if (f10 != null) {
                    mediaEntity2.viewWidth = i122;
                    mediaEntity2.viewHeight = i122;
            ...
            kiVar.V1.L(7, true, false, 0, 0, 0L, kiVar.s1(), false, 0L);
            if (!w8Var.M) {
    ...
    public final void f0(boolean z10, boolean z11, boolean z12) {
        ...
        this.C.addListener(new org.telegram.ui.ActionBar.g(this, z10, z11, i9));
        if (z12) {
            this.C.setInterpolator(gr.h);
            this.C.setDuration(350L);
            this.C.setStartDelay(150L);
        } else {
            this.C.setInterpolator(gr.f);
    ...
    public final void g0(boolean z10, long j10, TLRPC.Document document) {
        ...
        if (j10 == 0) {
            ...
            this.a.c.getImageReceiver().setImage(ImageLocation.getForDocument(document), "100_100", null, null, DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.f6.m6, 0.2f), 0L, "tgs", document, 0);
        } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x004f, code lost:
        ...
        if (org.telegram.messenger.AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.a7, false)) > 0.721f) goto L21;
     */
    @Override // org.telegram.ui.ActionBar.o2
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    public final void j0(long j10) {
        ...
        p8 p8Var2 = this.a;
        p8Var2.a = j10;
        p8Var2.c.setAnimatedEmojiDrawable(new k5(14, this.currentAccount, j10));
        this.F.w1(s8Var);
    ...
    public final void l0(y8 y8Var) {
        ...
        if (y8Var.getAnimatedEmoji() != null) {
            ...
            p8 p8Var2 = this.a;
            p8Var2.a = i9;
            p8Var2.c.setAnimatedEmojiDrawable(new k5(14, this.currentAccount, i9));
        }
    ...
    public final void m0() {
        ...
        if (this.w != d02) {
            kh.d dVar = this.x;
            this.w = d02;
            dVar.g(d02 ? this.v : this.s, true, true);
        }
    }
