...
public final class f31 extends FrameLayout {
    ...
    public final void d(boolean z10, boolean z11, boolean z12) {
        ...
        if (z10) {
            ...
            c31Var.b.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Oh, this.b));
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (f7 > 0.0f) {
            ...
            n4Var.layout(AndroidUtilities.dp(4.66f) + n90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), i16 - (n4Var.getMeasuredHeight() / 2), n4Var.getMeasuredWidth() + AndroidUtilities.dp(4.66f) + n90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), (n4Var.getMeasuredHeight() / 2) + i16);
        }
