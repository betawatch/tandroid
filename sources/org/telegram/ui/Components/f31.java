...
public abstract class f31 {
    ...
    public f31(org.telegram.ui.Cells.t1 t1Var, jo0 jo0Var) {
        ...
        final int i10 = 0;
        yi0Var.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.d31
        ...
        yi0Var2.R(t1Var);
        final int i11 = 1;
        yi0Var2.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.d31
            public final /* synthetic */ f31 b;
    ...
    public static boolean g(MessageObject messageObject, long j3, String str) {
        try {
            ...
            if (messageObject2 != null && messageObject2.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new a31(str, messageObject2, j3, 0));
                return true;
            }
            return false;
    ...
    public static void w(final MessageObject messageObject, boolean z10, final org.telegram.ui.Cells.k1 k1Var) {
        ...
        if (!z10) {
            ...
            final int i12 = 1;
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.b31
                @Override // java.lang.Runnable
                public final void run() {
                    int i13 = i12;
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_transcribeAudio, new RequestDelegate() { // from class: org.telegram.ui.Components.c31
    ...
    public final void r(boolean z10, boolean z11) {
        this.k = z10;
        jo0 jo0Var = this.s;
        if (!jo0Var.z && z10 && jo0Var.B.c <= 0.0f) {
            jo0Var.A = SystemClock.elapsedRealtime();
        }
        jo0Var.z = z10;
        org.telegram.ui.Cells.t1 t1Var = jo0Var.n;
        if (t1Var != null) {
            t1Var.invalidate();
        }
        c6 c6Var = this.l;
