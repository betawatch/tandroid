...
public class wx extends sm0 {
    ...
    public wx(rz rzVar, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var, rzVar.i2);
        this.D0 = rzVar;
        this.x0 = true;
        this.u0 = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    @Override // org.telegram.ui.Components.sm0, android.widget.HorizontalScrollView, android.view.ViewGroup
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            rz rzVar = this.D0;
            if (rzVar.O0 != null && Math.abs(motionEvent.getRawY() - this.z0) >= this.u0) {
                this.A0 = true;
                this.z0 = motionEvent.getRawY();
                ((c2.a) rzVar.O0).e();
                if (this.v0) {
    ...
    @Override // org.telegram.ui.Components.sm0, android.widget.HorizontalScrollView, android.view.View
        ...
        if (!this.A0) {
            ...
            if (getScrollX() == 0 && translationX == 0.0f) {
                if (this.v0 || this.w0 - motionEvent.getX() >= 0.0f) {
                    if (this.v0 && this.w0 - motionEvent.getX() > 0.0f && exVar.e0) {
                        exVar.i();
                        this.v0 = false;
                    }
                } else if (!exVar.M) {
