...
public final class wx extends ml0 {
    public boolean X2;
    ...
    public wx(lz lzVar, Context context) {
        super(context, null);
        this.f3 = lzVar;
    ...
    public final void J0(Canvas canvas, RectF rectF, long j3) {
        ...
        if (lzVar.d2 != null && wxVar != null) {
            ...
            while (i14 < wxVar.getChildCount()) {
                ...
                if (childAt instanceof uy) {
                    ...
                    if (arrayList4 == null) {
                        arrayList4 = !arrayList.isEmpty() ? (ArrayList) hg.c.z(i13, arrayList) : new ArrayList();
                ...
                if (z11 && childAt != null && RecyclerView.R(childAt) == lzVar.s2 - i13) {
                    z10 = z11;
                    float interpolation = rr.g.getInterpolation(w7.p.a((SystemClock.elapsedRealtime() - lzVar.u2) / 140.0f, f7, 1.0f));
        ...
        while (true) {
            ...
            if (uxVar == null) {
                uxVar = !arrayList2.isEmpty() ? (ux) hg.c.z(1, arrayList2) : new ux(this);
                uxVar.M = i16;
                uxVar.e();
            }
        ...
        if (lzVar.d2 != null && wxVar != null) {
            for (int i12 = 0; i12 < wxVar.getChildCount(); i12++) {
                ...
                if (z10 && childAt != null && RecyclerView.R(childAt) == lzVar.s2 - 1) {
                    float interpolation = rr.g.getInterpolation(w7.p.a((SystemClock.elapsedRealtime() - lzVar.u2) / 140.0f, 0.0f, 1.0f));
            ...
            if (!z10) {
                ...
                if (E != null && vxVar != null) {
                    if (Math.sqrt(Math.pow(y3 - vxVar.b, 2.0d) + Math.pow(x10 - vxVar.a, 2.0d)) < AndroidUtilities.touchSlop * 3.0f && !z12) {
                        lz lzVar = this.f3;
                        if (!lzVar.B1.isShowing() || SystemClock.elapsedRealtime() - vxVar.c < ViewConfiguration.getLongPressTimeout()) {
                            View view = vxVar.d;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        return super.onInterceptTouchEvent(motionEvent) || org.telegram.ui.pt.q().r(motionEvent, this, lzVar.g2, this.p2);
    }
