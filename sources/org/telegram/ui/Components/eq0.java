...
public final /* synthetic */ class eq0 implements Runnable {
    ...
    public /* synthetic */ eq0(hq0 hq0Var, int i10, String str) {
        this.a = 1;
        this.b = hq0Var;
        this.c = i10;
        this.d = str;
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                String str = this.d;
                int i18 = this.c;
                storageQueue.postRunnable(new eq0(hq0Var3, str, i18, 2));
                eq0 eq0Var = new eq0(hq0Var3, i18, str);
                hq0Var3.h = eq0Var;
                AndroidUtilities.runOnUIThread(eq0Var);
                break;
            case 1:
                hq0 hq0Var4 = this.b;
                hq0Var4.h = null;
                ...
                int i20 = this.c;
                if (i20 == i19) {
                    hq0Var4.e.g(this.d, true, true, true, true, 0L, false, 0, i20);
                    break;
                }
                break;
            default:
                ...
                try {
                    ...
                    if (lowerCase.length() == 0) {
                        ...
                        while (queryFinalized.next()) {
                            ...
                            zp0 zp0Var = new zp0();
                            zp0Var.c = queryFinalized.intValue(1);
                            hVar.k(zp0Var, longValue);
                                            ...
                                            if (!stringValue.contains(" " + str3)) {
                                                ...
                                                if (r12 == 0) {
                                                    ...
                                                    if (byteBufferValue != null) {
                                                        ...
                                                        int i27 = i21;
                                                        hq0Var2 = hq0Var5;
                                                        zp0 zp0Var2 = (zp0) hVar.f(TLdeserialize.id);
                                                        ...
                                                        if (r12 == z4) {
                                                            zp0Var2.d = AndroidUtilities.generateSearchName(TLdeserialize.first_name, TLdeserialize.last_name, str3);
                                                        } else {
                                                            zp0Var2.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize), null, "@" + str3);
                                                        }
                                                        zp0Var2.b = TLdeserialize;
                                                        zp0Var2.a.id = TLdeserialize.id;
                                                        i23 = i24 + 1;
                                                    }
                                                } else {
                                                    i25 = i26 + 1;
                                ...
                                for (int i28 = 0; i28 < i22; i28++) {
                                    ...
                                    if (byteBufferValue2 != null) {
                                        ...
                                        if (TLdeserialize2 != null && !ChatObject.isNotInChat(TLdeserialize2) && (!ChatObject.isChannel(TLdeserialize2) || TLdeserialize2.creator || (((tL_chatAdminRights = TLdeserialize2.admin_rights) != null && tL_chatAdminRights.post_messages) || TLdeserialize2.megagroup))) {
                                            zp0 zp0Var3 = (zp0) hVar.f(-TLdeserialize2.id);
                                            zp0Var3.d = AndroidUtilities.generateSearchName(TLdeserialize2.title, null, str4);
                                            zp0Var3.b = TLdeserialize2;
                                            zp0Var3.a.id = -TLdeserialize2.id;
                                            i13++;
                                        }
                                    }
                                }
                        ...
                        for (int i29 = 0; i29 < hVar.m(); i29++) {
                            zp0 zp0Var4 = (zp0) hVar.n(i29);
                            if (zp0Var4.b != null && zp0Var4.d != null) {
                                            ...
                                            if (!stringValue3.contains(" " + str5)) {
                                                ...
                                                if (c3 == 0) {
                                                    ...
                                                    if (byteBufferValue3 != null) {
                                                        ...
                                                        zp0Var5.a.id = TLdeserialize3.id;
                                                        zp0Var5.b = TLdeserialize3;
                                                        if (c3 == 1) {
                                                            zp0Var5.d = AndroidUtilities.generateSearchName(TLdeserialize3.first_name, TLdeserialize3.last_name, str5);
                                                        } else {
                                                            zp0Var5.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize3), null, "@" + str5);
                                                        }
                                                        arrayList3.add(zp0Var5);
                                                    }
                                                } else {
                                                    i30++;
                                                }
    ...
    public /* synthetic */ eq0(hq0 hq0Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = hq0Var;
        this.d = str;
        this.c = i10;
