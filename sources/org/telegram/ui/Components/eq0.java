...
public final class eq0 extends sl0 {
    public final Context c;
    public final ArrayList d = new ArrayList();
    public final a0.h e = new a0.h();
    public final /* synthetic */ mq0 f;

    public eq0(mq0 mq0Var, Context context) {
        this.f = mq0Var;
        this.c = context;
        E();
    }
    ...
    public final void E() {
        ...
        if (mq0Var.W) {
            dq0 dq0Var = new dq0();
            dq0Var.id = Long.MAX_VALUE;
            arrayList.add(dq0Var);
            hVar.k(dq0Var, dq0Var.id);
        }
    ...
    */
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (i12 >= 0) {
            ...
            if (i12 < arrayList.size()) {
                ...
                mq0 mq0Var = this.f;
                TLRPC.TL_forumTopic tL_forumTopic = (TLRPC.TL_forumTopic) mq0Var.S.get(dialog);
                i11 = ((org.telegram.ui.ActionBar.h3) mq0Var).currentAccount;
                e7Var.d(tL_forumTopic, MessagesController.getInstance(i11).isMonoForum(dialog.id), false);
                long j10 = dialog.id;
                e7Var.c(j10, mq0Var.R.h(j10) >= 0, null);
                return;
            }
        }
        dialog = null;
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            cq0Var = new View(context);
            cq0Var.setLayoutParams(new f2.x0(-1, AndroidUtilities.dp((!mq0Var.e0 || mq0Var.l0[1] == null) ? 56.0f : 109.0f)));
        } else {
            g6Var = ((org.telegram.ui.ActionBar.h3) mq0Var).resourcesProvider;
            cq0Var = new cq0(this, context, g6Var);
            cq0Var.setLayoutParams(new f2.x0(-1, AndroidUtilities.dp(100.0f)));
        }
        return new fl0(cq0Var);
    }
}
