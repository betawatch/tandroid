...
public final class eq0 extends ll0 {
    ...
    public eq0(iq0 iq0Var, Context context) {
        this.K = iq0Var;
        this.c = context;
        cq0 cq0Var = new cq0(false);
        this.e = cq0Var;
        cq0Var.a = new k2.u(this, 15);
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (!isEmpty) {
            int i13 = i10 - 1;
            if (i13 < this.d.size()) {
                wp0 wp0Var = (wp0) this.d.get(i13);
                j10 = wp0Var.a.id;
                str2 = wp0Var.d;
                tLObject = null;
            } else {
                i13 -= this.d.size();
                TLObject tLObject3 = (TLObject) cq0Var.d.get(i13);
        ...
        if (i15 < 0 || i10 < i15) {
            ...
            TLObject tLObject4 = ((gg.h0) iq0Var.E0.get(i10 - i15)).a;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            u3Var.setBackgroundColor(iq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.e7));
            ...
            view2.setLayoutParams(new s4.p0(-1, AndroidUtilities.dp((!iq0Var.h0 || iq0Var.o0[1] == null) ? 56.0f : 109.0f)));
            view = view2;
        } else {
