...
public final class fw0 extends View {
    public int E;
    public String[] F;
    public int[] G;
    public Drawable[] H;
    ...
    public fw0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.s = -1;
        this.J = TLObject.FLAG_31;
        qr qrVar = qr.f;
        this.L = new e6(this, 120L, qrVar);
        this.M = new e6(this, 150L, qrVar);
        this.O = e6Var;
        this.b = new Paint(1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i13 >= length) {
                ...
                paint.setColor(i0.a.k(org.telegram.ui.ActionBar.j6.v0(i16, e6Var2), 80));
                float f13 = dp;
                canvas2.drawCircle(f12, f13, AndroidUtilities.dp(d10 * 12.0f), paint);
                paint.setColor(org.telegram.ui.ActionBar.j6.v0(i16, e6Var2));
            ...
            float a2 = w7.q.a((d - f14) + f10, f7, f10);
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.M6, e6Var2);
            int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.N6, e6Var2);
            int i21 = this.J;
            ...
            if (i13 != 0) {
                ...
                if (i25 == -1 || i13 - 1 < i25) {
                    ...
                    int dp2 = (int) (i23 - (AndroidUtilities.dp(3.0f) * w7.q.a(1.0f - Math.min(Math.abs(f15), Math.abs(f17)), 0.0f, 1.0f)));
                    canvas2 = canvas;
                    ...
                    if (this.e != dp4) {
                        i11 = dp3;
                        i10 = i20;
                        paint2.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.dp(6.0f), org.telegram.messenger.wh.B(8.0f, dp4, r12) / (dp4 - 1)}, 0.0f));
                        this.e = dp4;
                    } else {
                        i11 = dp3;
                        i10 = i20;
            ...
            int d12 = i0.a.d(max, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.y6, e6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.n6, e6Var));
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float a2 = w7.q.a(((this.f / 2.0f) + (x10 - this.n)) / (((this.h * 2) + this.r) + r3), 0.0f, this.F.length - 1);
