            ...
            if (i2 == 0 || i2 == 1) {
                ...
                if (this.countAnimationIncrement) {
                    ...
                    if (f9 <= 0.5f) {
                        ...
                        f2 = 1.0f - ((f9 - 0.5f) * 2.0f);
                    }
                    f = (cubicBezierInterpolator.getInterpolation(f2) * 0.1f) + 1.0f;
                } else {
                    f = 1.0f;
                }
                RectF rectF = this.rectF;
                float f10 = this.x;
                rectF.set(f10, dp, f8 + f10 + AndroidUtilities.dp(this.radius - 0.5f), AndroidUtilities.dp(this.radius * 2.0f) + dp);
                canvas.save();
                ...
                if (this.drawBackground && (paint = this.circlePaint) != null) {
                    ...
                    if (this.addServiceGradient && Theme.hasGradientService()) {
                        RectF rectF3 = this.rectF;
                        float f13 = this.radius * AndroidUtilities.density;
                        canvas.drawRoundRect(rectF3, f13, f13, Theme.chat_actionBackgroundGradientDarkenPaint);
                    }
                }
                if (z) {
                    canvas.restore();
                ...
                if (this.countAnimationInLayout != null) {
                    ...
                    canvas.translate(f14, dp2 + (dp3 * (1.0f - f7)));
                    ...
                    if (this.countOldLayout != null) {
                        canvas.save();
                        canvas.translate(this.countLeft, AndroidUtilities.dp(4.0f) + dp + ((z2 ? -AndroidUtilities.dp(13.0f) : AndroidUtilities.dp(13.0f)) * f7));
                    ...
                    if (this.countAnimationStableLayout != null) {
                        canvas.save();
                        canvas.translate(this.countLeft, dp + AndroidUtilities.dp(4.0f));
                        this.textPaint.setAlpha(NotificationCenter.suggestedLangpack);
