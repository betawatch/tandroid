...
public final class d50 {
    ...
    public final int[] k;
    public final c50 c = new c50(R.raw.round_blur_stage_0_frag);
    public final c50 d = new c50(R.raw.round_blur_stage_3_frag);
    public final a50 e = new a50();
    public final b50 f = new b50();
    public int i = 0;
    public final int[] j = new int[1];

    public d50(int i10, int i11) {
        int i12;
        Canvas canvas;
        int i13;
        Bitmap bitmap;
        ...
        for (int i16 = 5; i15 < i16; i16 = 5) {
            ...
            if (i15 == 4) {
                ...
                float c3 = vh.v2.c(i18, this.a, 2.0f, -1.0f);
