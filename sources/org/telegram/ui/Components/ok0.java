...
public final class ok0 extends FrameLayout {
    ...
    public static void a(ok0 ok0Var, zg.o0 o0Var, int i10) {
        ...
        int i11 = qk0Var.J;
        org.telegram.ui.ActionBar.d6 d6Var = qk0Var.k0;
        int i12 = qk0Var.M0;
    ...
    public final void e(zg.o0 o0Var) {
        ...
        if (o0Var2.b) {
            ...
            nk0Var2.getImageReceiver().setImage(ImageLocation.getForDocument(effectDocument), "60_60_firstframe", null, null, this.r ? null : DocumentObject.getSvgThumb(effectDocument, org.telegram.ui.ActionBar.h6.m6, 0.2f), 0L, "tgs", this.e, 0);
            return;
        }
        if (o0Var2.f != null) {
    ...
    public final void f(zg.o0 o0Var, boolean z10) {
        ...
        if (contains != z11) {
            ...
            if (z10) {
                ...
                nk0Var.animate().scaleX(this.I * (this.w ? 0.76f : 1.0f)).scaleY(this.I * (this.w ? 0.76f : 1.0f)).setDuration(240L).setInterpolator(rrVar).start();
            } else {
        ...
        if (this.O) {
            ...
            if (qk0Var.Q == null) {
                ...
                if (!qk0Var.r0 && qk0Var.l0 != null) {
                    ...
                    qk0Var.Q.addListener(new ci.u5(qk0Var, i11));
                    qk0Var.Q.setDuration(150L);
                    qk0Var.Q.setInterpolator(rr.f);
                    qk0Var.Q.start();
                }
