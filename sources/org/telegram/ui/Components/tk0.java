...
public final class tk0 extends View {
    ...
    public tk0(ml0 ml0Var, Context context, int i10) {
        super(context);
        org.telegram.ui.ActionBar.d6 d6Var = ml0Var.p2;
        this.o0 = ml0Var;
        this.a = true;
        this.b = new RectF();
        this.c = new Paint(1);
        ...
        if (layoutManager instanceof s4.c0) {
            ...
            if (c0Var.o == 1) {
                ...
                if (adapter instanceof uk0) {
                    ...
                    float f7 = this.e;
                    int[] iArr = this.W;
                    uk0Var.G(ml0Var, f7, iArr);
                    if (z10) {
                        c0Var.h1(iArr[0], (-iArr[1]) + ml0Var.w1);
                    }
                    String F = uk0Var.F(iArr[0]);
                    if (F == null) {
    ...
    public final void c() {
        ml0 ml0Var = this.o0;
        int i10 = this.R;
        this.S = i10 == 0 ? org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.m7, ml0Var.p2) : i0.a.k(-16777216, 102);
        this.T = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.l7, ml0Var.p2);
        this.c.setColor(this.S);
        TextPaint textPaint = this.H;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.n7, ml0Var.p2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, ml0Var.p2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i11 == 0) {
            ...
            ml0 ml0Var = this.o0;
            f11 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.h6.v0(i12, ml0Var.p2), -1));
            ...
            paint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, ml0Var.p2));
            canvas.save();
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        s4.h0 adapter2 = ml0Var.getAdapter();
        if (this.n && !this.k0 && System.currentTimeMillis() - this.l0 < 150 && (adapter2 instanceof uk0)) {
            ((uk0) adapter2).I();
        }
        this.k0 = false;
        this.n = false;
        this.P = System.currentTimeMillis();
        invalidate();
        if (adapter2 instanceof uk0) {
            ((uk0) adapter2).J(ml0Var);
        }
        b();
        return true;
        return true;
