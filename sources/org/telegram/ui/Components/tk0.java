...
public final class tk0 extends View {
    ...
    public tk0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.b = new Paint(1);
        this.c = new Paint(1);
        this.d = new Paint(1);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z13) {
                ...
                if (v71Var != null) {
                    ...
                    this.V = clamp;
                    v71Var.L((long) (clamp * this.n.p()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.T) {
                ...
                v71 v71Var2 = this.n;
                if (v71Var2 != null) {
                    v71Var2.L((long) (this.s * v71Var2.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.w) {
                v71 v71Var3 = this.n;
                if (v71Var3 != null) {
                    v71Var3.L(Math.max((long) (this.s * v71Var3.p()), ((long) (this.v * this.n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
