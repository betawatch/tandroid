...
public abstract class ew0 extends wk0 {
    public static final cw0 t3 = new cw0();
    public static final dw0 u3 = new dw0();
    public float T2;
    public aw0[] U2;
    public final vv0 V2;
    public final y5 W2;
    ...
    public ew0(Context context, int i9, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        this.k3 = 0.0f;
        this.m3 = true;
        this.n3 = new y5(this, 350L, grVar);
        this.o3 = new y5(this, 350L, grVar);
        this.p3 = new RectF();
        this.q3 = new RectF();
        this.r3 = new RectF();
        ...
        setSelectorDrawableColor(org.telegram.ui.ActionBar.f6.v0(i10, this.l2));
        paint.setColor(org.telegram.ui.ActionBar.f6.v0(i10, this.l2));
        setWillNotDraw(false);
        setOnItemClickListener(new j(this, 15));
        long currentTimeMillis = System.currentTimeMillis();
        t3.fetch(UserConfig.selectedAccount, Integer.valueOf(i9), new kh.e9(this, currentTimeMillis, 2));
    }
    ...
    public static void x1(ew0 ew0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j10) {
        ...
        for (int i9 = 0; i9 < tL_messages_emojiGroups.groups.size(); i9++) {
            ...
            aw0 aw0Var = new aw0();
            aw0Var.c = emojiGroup.icon_emoji_id;
            if (emojiGroup instanceof TLRPC.TL_emojiGroupPremium) {
                aw0Var.a = "premium";
            } else {
                aw0Var.a = TextUtils.concat((CharSequence[]) emojiGroup.emoticons.toArray(new String[0])).toString();
            }
            aw0Var.b = emojiGroup instanceof TLRPC.TL_emojiGroupGreeting;
            aw0Var.d = emojiGroup.title;
            aw0VarArr[i9] = aw0Var;
        }
        ew0Var.U2 = ew0Var.B1(ew0Var.U2);
        ew0Var.V2.l();
        ew0Var.setCategoriesShownT(0.0f);
        ew0Var.G1(ew0Var.m3, System.currentTimeMillis() - j10 > 16);
    }
    ...
    public static void z1(RectF rectF, View view) {
        ...
        if (view instanceof zv0) {
            zv0 zv0Var = (zv0) view;
            f10 = e2.c.z(1.0f, zv0Var.A, 0.15f, 0.85f) * zv0Var.y;
        }
        float f11 = width * f10;
    ...
    public void E1(int i9) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt instanceof zv0) {
                ((zv0) childAt).l(this.i3 == RecyclerView.R(childAt) - 1, true);
            }
        }
        invalidate();
    }
    ...
    public final void G1(boolean z10, boolean z11) {
        ...
        this.l3.addListener(new r60(this, 22));
        this.l3.setInterpolator(gr.h);
    ...
    */
    public final void draw(Canvas canvas) {
        ...
        if (this.Z2 != null) {
            ...
            if (i9 < i10) {
                int z10 = (int) e2.c.z(1.0f, this.k3, AndroidUtilities.dp(32.0f) + getWidth(), i9);
                int z11 = (int) e2.c.z(1.0f, this.k3, AndroidUtilities.dp(32.0f) + getWidth(), i10);
                canvas2 = canvas;
                ...
                int i12 = this.i3;
                y5 y5Var = this.o3;
                float d9 = i12 < 0 ? y5Var.d(i12, false) : y5Var.c;
                if (d > 0.0f) {
                    float f10 = d9 + 1.0f;
                    double d10 = f10;
    ...
    public aw0 getSelectedCategory() {
        int i9;
        aw0[] aw0VarArr = this.U2;
        if (aw0VarArr == null || (i9 = this.i3) < 0 || i9 >= aw0VarArr.length) {
            return null;
        }
        return aw0VarArr[i9];
    }
