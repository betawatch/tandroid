...
public final class ew0 extends View {
    ...
    public ew0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        qr qrVar = qr.f;
        this.L = new d6(this, 120L, qrVar);
        this.M = new d6(this, 150L, qrVar);
        this.O = f6Var;
        this.b = new Paint(1);
            ...
            if (i13 != 0) {
                ...
                if (i25 == -1 || i13 - 1 < i25) {
                    ...
                    if (this.e != dp4) {
                        i11 = dp3;
                        i10 = i20;
                        paint2.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.dp(6.0f), org.telegram.messenger.rk.B(8.0f, dp4, r12) / (dp4 - 1)}, 0.0f));
                        this.e = dp4;
                    } else {
                        i11 = dp3;
                        i10 = i20;
