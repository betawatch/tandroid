    ...
    public final void b(ArrayList arrayList, boolean z10, boolean z11, boolean z12) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (b10 == 0) {
                ...
                ?? qd0Var = new qd0(getContext());
                qd0Var.setBackgroundColor(0);
                qd0Var.setPadding(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f));
                qd0Var.setTextSize(0, mediaEntity.fontSize);
                qd0Var.setTypeface(mediaEntity.textTypeface.d());
                SpannableString spannableString = new SpannableString(Emoji.replaceEmoji(mediaEntity.text, qd0Var.getPaint().getFontMetricsInt(), false));
                ...
                while (i13 < size2) {
                    ...
                    y5 y5Var = new y5(emojiEntity2.document_id, qd0Var.getPaint().getFontMetricsInt());
                ...
                qd0Var.setText(spannableString);
                int i15 = 17;
                ...
                qd0Var.setTextAlignment(i11);
                qd0Var.setHorizontallyScrolling(false);
                qd0Var.setImeOptions(TLObject.FLAG_28);
                qd0Var.setFocusableInTouchMode(true);
                qd0Var.setEnabled(false);
                qd0Var.setInputType(qd0Var.getInputType() | 16384);
                if (i17 >= 23) {
                    qd0Var.setBreakStrategy(0);
                }
                qd0Var.setShadowLayer(0.0f, 0.0f, 0.0f, 0);
                int i20 = mediaEntity.color;
                byte b11 = mediaEntity.subType;
                if (b11 == 0) {
                    qd0Var.setFrameColor(i20);
                    i20 = AndroidUtilities.computePerceivedBrightness(mediaEntity.color) >= 0.721f ? -16777216 : -1;
                } else if (b11 == 1) {
                    qd0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -1728053248 : -1711276033);
                } else if (b11 == 2) {
                    qd0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -16777216 : -1);
                } else {
                    qd0Var.setFrameColor(0);
                }
                qd0Var.setTextColor(i20);
                qd0Var.setCursorColor(i20);
                qd0Var.setHandlesColor(i20);
                qd0Var.setHighlightColor(org.telegram.ui.ActionBar.j6.l1(0.4f, i20));
                mediaEntity.view = qd0Var;
                v9Var = qd0Var;
            } else {
                v9Var = null;
            }
