...
public final class jo0 {
    ...
    */
    public final void c(Canvas canvas, org.telegram.ui.Cells.t1 t1Var) {
        ...
        canvas.restore();
        if (this.M == null) {
            this.M = new io0(new bc0(this, 26));
        }
        float f19 = this.K;
        if (f19 < 0.99f && (fArr = this.G) != null) {
            ...
            if (i18 >= 0 && i18 < fArr.length) {
                ...
                io0Var = this.M;
                ((Paint) io0Var.f).setColor(this.q);
                io0Var.g = rectF;
                float f22 = this.L;
                Paint paint = (Paint) io0Var.f;
                ArrayList arrayList2 = (ArrayList) io0Var.e;
                arrayList = (ArrayList) io0Var.d;
                long currentTimeMillis = System.currentTimeMillis();
                long min2 = Math.min(20L, currentTimeMillis - io0Var.b);
                io0Var.b = currentTimeMillis;
                i11 = 0;
                while (i11 < arrayList.size()) {
                    ho0 ho0Var = (ho0) arrayList.get(i11);
                    float f23 = min2;
                    float f24 = ho0Var.f - (f23 / ho0Var.g);
                    ho0Var.f = f24;
                    if (f24 < 0.0f) {
                        ...
                        float f26 = ho0Var.d;
                        float f27 = ho0Var.c;
                        ho0Var.a = (((f26 * f27) * f23) / 500.0f) + f25;
                        float f28 = ho0Var.b;
                        float f29 = ho0Var.e;
                        ho0Var.b = (((f27 * f29) * f23) / 500.0f) + f28;
                        ho0Var.e = f29 - ((AndroidUtilities.dp(0.33f) * min2) / 500.0f);
                    }
                    i11++;
                }
                if (((RectF) io0Var.g) != null) {
                    int min3 = Math.min(4, io0Var.a - arrayList.size());
                    for (int i19 = 0; i19 < min3; i19++) {
                        ho0 ho0Var2 = arrayList2.isEmpty() ? new ho0() : (ho0) arrayList2.remove(0);
                        RectF rectF2 = (RectF) io0Var.g;
                        ho0Var2.a = (Utilities.random.nextFloat() * rectF2.width()) + rectF2.left;
                        RectF rectF3 = (RectF) io0Var.g;
                        ho0Var2.b = (Utilities.random.nextFloat() * rectF3.height()) + rectF3.top;
                        double nextInt = (Utilities.random.nextInt(200) - 125) * 0.017453292519943295d;
                        ho0Var2.d = ((float) (Math.cos(nextInt) - Math.sin(nextInt))) * 0.8f;
                        ho0Var2.e = ((float) (Math.cos(nextInt) + Math.sin(nextInt))) - 0.2f;
                        ho0Var2.f = 1.0f;
                        ho0Var2.c = AndroidUtilities.dp((Utilities.random.nextFloat() * 7.0f) + 10.0f);
                        ho0Var2.g = AndroidUtilities.lerp(420, 550, Utilities.random.nextFloat());
                        arrayList.add(ho0Var2);
                    }
                }
                for (i12 = 0; i12 < arrayList.size(); i12++) {
                    ho0 ho0Var3 = (ho0) arrayList.get(i12);
                    paint.setAlpha((int) (255.0f * f22 * ho0Var3.f));
                    canvas.drawPoint(ho0Var3.a, ho0Var3.b, paint);
                }
                bc0Var = (bc0) io0Var.c;
                if (bc0Var == null) {
                    bc0Var.run();
        ...
        io0Var.g = rectF;
        float f222 = this.L;
        Paint paint2 = (Paint) io0Var.f;
        ArrayList arrayList22 = (ArrayList) io0Var.e;
        arrayList = (ArrayList) io0Var.d;
        long currentTimeMillis2 = System.currentTimeMillis();
        long min22 = Math.min(20L, currentTimeMillis2 - io0Var.b);
        io0Var.b = currentTimeMillis2;
        i11 = 0;
        while (i11 < arrayList.size()) {
        }
        if (((RectF) io0Var.g) != null) {
