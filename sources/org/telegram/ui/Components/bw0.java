...
public final class bw0 extends ri0 {
    ...
    public bw0(gw0 gw0Var, Context context) {
        super(context);
        org.telegram.ui.ActionBar.c6 c6Var = gw0Var.l2;
        this.D = gw0Var;
        this.w = false;
        this.y = 1.0f;
        k(gw0Var.s3 ? i0.b.k(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Wk, c6Var), (int) 102.0f) : org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Me, c6Var));
    ...
    public final void c() {
        ...
        if (this.y < 1.0f) {
            ...
            this.C = ofFloat;
            ofFloat.addUpdateListener(new yv0(this, 2));
    ...
    public final void l(boolean z10, boolean z11) {
        if (Math.abs(this.s - (z10 ? 1.0f : 0.0f)) > 0.01f) {
            ...
            this.v = ofFloat;
            ofFloat.addUpdateListener(new yv0(this, 1));
    ...
    public final void m(float f10) {
        ...
        if (gw0Var.s3) {
            ...
            k(i0.b.d(this.s, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Me, c6Var), org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Oe, c6Var)));
        }
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(org.telegram.messenger.rl.d(4.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30));
    }
    ...
    public final void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            if (f10 != 0.0f) {
                ...
                this.B = ofFloat;
                ofFloat.addUpdateListener(new yv0(this, 0));
