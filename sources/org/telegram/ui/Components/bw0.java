...
public class bw0 extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    ...
    public bw0(Context context, org.telegram.ui.ActionBar.d5 d5Var) {
        super(context);
        this.a = new Rect();
    ...
    public static void G(bw0 bw0Var, Canvas canvas) {
        if (bw0Var.L != null && org.telegram.ui.ActionBar.j6.G1 && LiteMode.isEnabled(32)) {
            if (bw0Var.K == null) {
                mw0 mw0Var = new mw0(1);
                bw0Var.K = mw0Var;
                mw0Var.g = -1;
                mw0Var.c();
            }
            bw0Var.K.b(canvas, bw0Var.L);
        }
    }
    ...
    */
        ...
        if (!F()) {
            ...
            if (this.d0.getShader() != null) {
                ...
                if (z10) {
                    ...
                    xv0 xv0Var = this.Q;
                    matrix.preScale(xv0Var.d, xv0Var.e);
                    if (this.R != null) {
                        matrix2.setTranslate(0.0f, (f14 - r6.a) - 34.0f);
                        xv0 xv0Var2 = this.R;
                        matrix2.preScale(xv0Var2.d, xv0Var2.e);
                    }
                } else {
                    this.Q.getClass();
                    float f15 = (-f13) + 0.0f;
    ...
    public void S() {
        ...
        post(new es0(1, this, point.x > point.y));
    }
    ...
    public final void W() {
        ...
        xv0 xv0Var = arrayList.size() > 0 ? (xv0) hg.k0.v(1, arrayList) : null;
        if (xv0Var == null) {
            xv0Var = new xv0();
            xv0Var.c = Bitmap.createBitmap(i11, i10, Bitmap.Config.ARGB_8888);
            xv0Var.b = new zv0(xv0Var.c);
        } else {
            xv0Var.c.eraseColor(0);
        }
        float width = xv0Var.c.getWidth() / f10;
        float height = (xv0Var.c.getHeight() - 34) / f7;
        int save = xv0Var.b.save();
        xv0Var.a = getScrollOffset() % 24;
        float f11 = 10.0f * height;
        xv0Var.b.clipRect(1.0f, f11, xv0Var.c.getWidth(), xv0Var.c.getHeight() - 1);
        xv0Var.b.scale(width, height);
        xv0Var.b.translate(0.0f, f11 + xv0Var.a);
        xv0Var.d = 1.0f / width;
        xv0Var.e = 1.0f / height;
        L(xv0Var.b, null);
        try {
            xv0Var.b.restoreToCount(save);
        } catch (Exception e) {
            FileLog.e(e);
        }
        System.currentTimeMillis();
    ...
    public void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            if (arrayList.get(i10) != null) {
                ((xv0) arrayList.get(i10)).c.recycle();
            }
            i10++;
        }
        arrayList.clear();
    ...
    public void setDelegate(aw0 aw0Var) {
        this.n = aw0Var;
    }
