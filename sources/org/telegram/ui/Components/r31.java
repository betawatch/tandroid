...
public abstract class r31 {
    ...
    public r31(org.telegram.ui.Cells.t1 t1Var, ro0 ro0Var) {
        boolean z10 = false;
        this.r = t1Var;
        this.s = ro0Var;
        ...
        final int i10 = 0;
        hj0Var.R(19, new Runnable(this) { // from class: org.telegram.ui.Components.p31
        ...
        hj0Var2.v0 = t1Var;
        final int i11 = 1;
        hj0Var2.R(19, new Runnable(this) { // from class: org.telegram.ui.Components.p31
            public final /* synthetic */ r31 b;
        ...
        this.x = z10;
        wr wrVar = wr.h;
        this.l = new d6(t1Var, 250L, wrVar);
        this.j = new d6(t1Var, 250L, wrVar);
    }
    ...
    public static boolean g(MessageObject messageObject, long j3, String str) {
        try {
            ...
            if (messageObject2 != null && messageObject2.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new m31(str, messageObject2, j3, 0));
                return true;
            }
            return false;
    ...
    public static void u(MessageObject messageObject, boolean z10) {
        ...
        if (z10) {
            AndroidUtilities.runOnUIThread(new uq0(messageObject, 20));
        }
    }
    ...
    public static void w(final MessageObject messageObject, boolean z10, final org.telegram.ui.Cells.k1 k1Var) {
        ...
        if (!z10) {
            ...
            final int i12 = 1;
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.n31
                @Override // java.lang.Runnable
                public final void run() {
                    int i13 = i12;
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_transcribeAudio, new RequestDelegate() { // from class: org.telegram.ui.Components.o31
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (z12) {
                    ...
                    if ((tL_messages_transcribedAudio.flags & 2) != 0) {
                        ...
                        AndroidUtilities.runOnUIThread(new yo0(12, k1Var2, tL_messages_transcribedAudio));
                    }
                    if (r31.O == null) {
                        r31.O = new HashMap();
                    }
                    r31.O.put(Long.valueOf(j3), messageObject2);
                    ...
                    if (tL_error != null && (str = tL_error.text) != null && str.startsWith("FLOOD_WAIT_")) {
                        ...
                        AndroidUtilities.runOnUIThread(new my(messageObject2, k1Var2, i14, 22));
                        return;
                    }
                    j3 = 0;
                    z11 = true;
                ...
                if (z11) {
                    AndroidUtilities.runOnUIThread(new m31(str4, messageObject2, j3, 1), Math.max(0L, 350 - elapsedRealtime2));
                }
            }
    ...
    public final void f(Canvas canvas, float f7) {
        ...
        if (this.y) {
            hj0 hj0Var = this.n;
            hj0Var.setAlpha((int) (this.m * f7));
            hj0Var.draw(canvas);
        } else {
            hj0 hj0Var2 = this.p;
            hj0Var2.setAlpha((int) (this.o * f7));
            hj0Var2.draw(canvas);
        }
    ...
    public final void q(float f7, int i10) {
        ...
        if (z10) {
            hj0 hj0Var = this.n;
            hj0Var.a0 = true;
            hj0Var.Q(this.c, "Artboard Outlines");
            hj0Var.o();
            hj0Var.J(true);
            hj0Var.U(0L);
            ...
            hj0 hj0Var2 = this.p;
            hj0Var2.a0 = true;
            hj0Var2.Q(this.c, "Artboard Outlines");
            hj0Var2.o();
            hj0Var2.J(true);
            hj0Var2.U(0L);
    ...
    public final void r(boolean z10, boolean z11) {
        this.k = z10;
        ro0 ro0Var = this.s;
        if (!ro0Var.z && z10 && ro0Var.B.c <= 0.0f) {
            ro0Var.A = SystemClock.elapsedRealtime();
        }
        ro0Var.z = z10;
        org.telegram.ui.Cells.t1 t1Var = ro0Var.n;
        if (t1Var != null) {
            t1Var.invalidate();
        }
        d6 d6Var = this.l;
