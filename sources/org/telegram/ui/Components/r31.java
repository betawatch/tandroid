...
public abstract class r31 {
    ...
    public r31(org.telegram.ui.Cells.u1 u1Var, vo0 vo0Var) {
        boolean z10 = false;
        this.r = u1Var;
        this.s = vo0Var;
        ...
        final int i10 = 0;
        ij0Var.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.p31
        ...
        ij0Var2.R(u1Var);
        final int i11 = 1;
        ij0Var2.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.p31
            public final /* synthetic */ r31 b;
        ...
        this.x = z10;
        rr rrVar = rr.h;
        this.l = new e6(u1Var, 250L, rrVar);
        this.j = new e6(u1Var, 250L, rrVar);
    }
    ...
    public static void u(MessageObject messageObject, boolean z10) {
        ...
        if (z10) {
            AndroidUtilities.runOnUIThread(new wq0(messageObject, 21));
        }
    }
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (z12) {
                    ...
                    if (tL_error != null && (str = tL_error.text) != null && str.startsWith("FLOOD_WAIT_")) {
                        ...
                        AndroidUtilities.runOnUIThread(new xm(messageObject2, l1Var2, i14, 24));
                        return;
                    }
                    j3 = 0;
                    z11 = true;
    ...
    public final void r(boolean z10, boolean z11) {
        this.k = z10;
        vo0 vo0Var = this.s;
        if (!vo0Var.z && z10 && vo0Var.B.c <= 0.0f) {
            vo0Var.A = SystemClock.elapsedRealtime();
        }
        vo0Var.z = z10;
        org.telegram.ui.Cells.u1 u1Var = vo0Var.n;
        if (u1Var != null) {
            u1Var.invalidate();
        }
        e6 e6Var = this.l;
