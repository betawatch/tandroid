...
public abstract class tg0 extends FrameLayout {
    ...
    public tg0(vg0 vg0Var, Context context) {
        super(context);
        this.d = vg0Var;
        ...
        w1Var.setOnClickListener(new z70(this, 9));
        ...
        addView(w1Var, k7.b6.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 16.0f, 0.0f, 16.0f, 0.0f));
    }
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z4) {
        ...
        SpannableStringBuilder spannableStringBuilder2 = LocaleController.isRTL ? new SpannableStringBuilder(android.support.v4.media.a.l(i10, "% – ")) : new SpannableStringBuilder(kh.a2.k(i10, " – ", "%"));
