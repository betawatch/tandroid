...
public class BlurredBackgroundDrawableRenderNode extends BlurredBackgroundDrawable {
    ...
    private void updateDisplayList() {
        ...
        if (this.liquidGlassEffect != null && Build.VERSION.SDK_INT >= 33) {
            int i = this.boundProps.liquidThickness;
            if (i <= 0) {
                i = AndroidUtilities.dp(11.0f);
            }
            int max = Math.max(Math.min(i, Math.min(this.boundProps.boundsWithPadding.width(), this.boundProps.boundsWithPadding.height()) / 5), 1);
            ...
            liquidGlassEffect.update(0.0f, 0.0f, width, height, fArr[0], fArr[2], fArr[4], fArr[6], max, props.liquidIntensity, props.liquidIndex, this.backgroundColor);
        }
        ...
        if (this.strokeColorTop != 0) {
            ...
            BlurredBackgroundDrawable.drawStroke((Canvas) beginRecording2, 0.0f, 0.0f, width2, height2, props2.radii, props2.strokeWidthTop, true, this.paintStrokeTop);
        }
        if (this.strokeColorBottom != 0) {
            ...
            BlurredBackgroundDrawable.drawStroke((Canvas) beginRecording2, 0.0f, 0.0f, width3, height3, props3.radii, props3.strokeWidthBottom, false, this.paintStrokeBottom);
        }
