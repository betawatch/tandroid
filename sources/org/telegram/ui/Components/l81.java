...
public final class l81 extends View {
    ...
    public final void b(int i10) {
        ...
        this.w = i81Var;
        i81Var.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, Integer.valueOf(i10), null, null);
    }
        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.f) {
                    ...
                    if (k81Var5 != null) {
                        float f15 = this.b;
                        ChatActivityEnterView chatActivityEnterView = ((df) k81Var5).a;
                ...
                if (this.h) {
                    ...
                    if (k81Var6 != null) {
                        float f21 = this.c;
                        ChatActivityEnterView chatActivityEnterView2 = ((df) k81Var6).a;
    ...
    public void setTimeHintView(j81 j81Var) {
        this.P = j81Var;
    }
