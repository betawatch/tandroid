...
public final class ra extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.b == 0.0f) {
            ...
            rectF.set(com.google.android.gms.internal.vision.e2.a(1.0f, this.b, AndroidUtilities.dp(11.0f), dp), 0.0f, AndroidUtilities.dp(5.0f) + dp, AndroidUtilities.dp(5.0f));
        }
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.5f), AndroidUtilities.dp(2.5f), paint);
    }
