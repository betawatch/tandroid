...
public abstract class ra extends View {
    ...
    public ra(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.c = new Paint(1);
        this.h = new e6(this, 0L, 210L, qr.h);
        this.a = e6Var;
        ja0 ja0Var = (ja0) this;
        this.b = new qa[]{new qa(ja0Var, 0, R.raw.msg_stories_saved, 20, 40, LocaleController.getString(R.string.ProfileMyStoriesTab)), new qa(ja0Var, 1, R.raw.msg_stories_archive, 0, 0, LocaleController.getString(R.string.ProfileStoriesArchiveTab))};
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var2 = raVar.a;
        canvas.drawColor(org.telegram.ui.ActionBar.j6.v0(i10, e6Var2));
        ...
        float e = raVar.h.e(raVar.f);
        Paint paint = raVar.c;
        float f13 = 0.0f;
        if (e > 0.0f) {
            f7 = 9.0f;
            f10 = 16.0f;
            paint.setColor(i0.a.k(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, e6Var2), (int) (((Math.abs((Math.floor(raVar.d) + 0.5d) - raVar.d) * 1.2000000476837158d) + 0.4000000059604645d) * 18.0d * e)));
            float f14 = length;
            float f15 = f14 / 2.0f;
            e6Var = e6Var2;
            f11 = 41.0f;
        ...
        while (i11 < qaVarArr.length) {
            ...
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.D6, e6Var3);
            int i13 = org.telegram.ui.ActionBar.j6.G6;
            int d = i0.a.d(min2, v02, org.telegram.ui.ActionBar.j6.v0(i13, e6Var3));
            qaVar.d.setColor(d);
            if (qaVar.m != d) {
                qaVar.m = d;
                f12 = min2;
            ...
            float e7 = qaVar.i.e(f12 > 0.6f);
            if (e < 1.0f) {
                paint.setColor(i0.a.k(org.telegram.ui.ActionBar.j6.v0(i13, e6Var3), (int) ((1.0f - e) * e7 * 18.0f)));
