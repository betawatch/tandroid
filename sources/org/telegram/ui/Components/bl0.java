...
public final class bl0 extends View {
    ...
    public bl0(sl0 sl0Var, Context context, int i10) {
        super(context);
        org.telegram.ui.ActionBar.g6 g6Var = sl0Var.m2;
        this.l0 = sl0Var;
        this.a = true;
        this.b = new RectF();
        this.c = new Paint(1);
        ...
        if (i10 == 0) {
            ...
            this.a0 = mutate;
            mutate.setColorFilter(new PorterDuffColorFilter(i0.a.d(0.1f, org.telegram.ui.ActionBar.k6.v0(i11, g6Var), -1), PorterDuff.Mode.MULTIPLY));
        }
        ...
        if (layoutManager instanceof f2.j0) {
            ...
            if (j0Var.o == 1) {
                ...
                if (adapter instanceof cl0) {
                    ...
                    if (z4) {
                        j0Var.h1(iArr[0], (-iArr[1]) + sl0Var.t1);
                    }
    ...
    public final void c() {
        sl0 sl0Var = this.l0;
        int i10 = this.O;
        this.P = i10 == 0 ? org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.m7, sl0Var.m2) : i0.a.k(-16777216, 102);
        this.Q = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.l7, sl0Var.m2);
        this.c.setColor(this.P);
        TextPaint textPaint = this.E;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.n7, sl0Var.m2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.G6, sl0Var.m2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i11 == 0) {
            ...
            sl0 sl0Var = this.l0;
            f12 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.k6.v0(i12, sl0Var.m2), -1));
            ...
            paint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.G6, sl0Var.m2));
            canvas.save();
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        f2.p0 adapter2 = sl0Var.getAdapter();
