...
public class SwipeGestureSettingsView extends FrameLayout {
    ...
    public SwipeGestureSettingsView(Context context, int i) {
        ...
        addView(this.picker, LayoutHelper.createFrame(NotificationCenter.httpFileDidLoad, -1.0f, 5, 21.0f, 0.0f, 21.0f, 0.0f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (z) {
            ...
            if (f2 != 1.0f) {
                ...
                this.filledPaint.setAlpha(NotificationCenter.needCheckSystemBarColors);
