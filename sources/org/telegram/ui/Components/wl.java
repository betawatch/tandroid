    ...
    public final void a() {
        ...
        while (i11 < size) {
            ...
            if (hashMap2.containsKey(photoEntry)) {
                ...
                em.Q.put(photoEntry, Boolean.valueOf(z10));
            }
            if (z10) {
                int i14 = i12;
                i12 = i13;
        ...
        if (size == 1) {
            ...
            for (int i16 = 1; i16 < size2; i16++) {
                ...
                if (i16 <= 3 && i17 <= 3) {
                    ...
                    vl vlVar = new vl();
                    vlVar.a = new int[]{i16, i17};
                    vlVar.b = new float[]{b10, b11};
                    ...
                    if (i19 < i20) {
                        ...
                        if (i18 <= 3) {
                            if (i19 <= (f14 < 0.85f ? 4 : 3) && i21 <= 3) {
                                ...
                                vl vlVar2 = new vl();
                                vlVar2.a = new int[]{i18, i19, i21};
                                vlVar2.b = new float[]{b12, b13, b14};
                        ...
                        while (true) {
                            ...
                            if (i26 < i27) {
                                ...
                                if (i23 > 3 || i24 > 3 || i26 > 3 || i28 > 3) {
                                    ...
                                    vl vlVar3 = new vl();
                                    vlVar3.a = new int[]{i23, i24, i26, i28};
                                    i10 = size2;
                                    vlVar3.b = new float[]{b15, b16, b17, b18};
            ...
            for (int i31 = 0; i31 < arrayList3.size(); i31++) {
                vl vlVar5 = (vl) arrayList3.get(i31);
                float f16 = Float.MAX_VALUE;
                float f17 = 0.0f;
                int i32 = 0;
                while (true) {
                    float[] fArr2 = vlVar5.b;
                    if (i32 >= fArr2.length) {
                        break;
                    }
                    float f18 = fArr2[i32];
