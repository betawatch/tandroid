...
public abstract class bb extends org.telegram.ui.ActionBar.f3 {
    ...
    */
    ...
    public void I(Canvas canvas, View view) {
        ...
        if (z10) {
            ...
            for (int i11 = 0; i11 < wl0Var.getChildCount(); i11++) {
                ...
                if (S != -1 && S != wl0Var.getAdapter().h() - 1) {
    ...
    public final void K() {
        ...
        this.N = new e6(this.containerView, 0L, 350L, qr.h);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public bb(org.telegram.ui.ActionBar.n2 n2Var, boolean z10, boolean z11, org.telegram.ui.ActionBar.e6 e6Var) {
        this(r0, n2Var, new ab(r1));
        Activity parentActivity = n2Var.getParentActivity();
        ab abVar = new ab();
        abVar.a = z10;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public bb(Context context, org.telegram.ui.ActionBar.n2 n2Var, boolean z10, boolean z11, org.telegram.ui.ActionBar.e6 e6Var) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public bb(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public bb(Context context, org.telegram.ui.ActionBar.n2 n2Var, boolean z10, boolean z11, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        this(context, n2Var, new ab(r0));
        ab abVar = new ab();
        abVar.a = z10;
        abVar.c = false;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public bb(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        this(context, (org.telegram.ui.ActionBar.n2) null, new ab(r0));
        ab abVar = new ab();
        abVar.a = z10;
        abVar.b = 2;
    ...
    public bb(Context context, org.telegram.ui.ActionBar.n2 n2Var, ab abVar) {
        ...
        if (z11) {
            ...
            bw0Var = new wa(this, context, z12, z10);
        }
        wl0 w10 = w(context);
        this.d = w10;
        ...
        if (z10) {
            ...
            setCustomView(bw0Var);
            bw0Var.addView(w10, w7.y5.c(-2.0f, -1));
        } else {
            w10.setAdapter(new za(this, v(w10), context));
            this.containerView = bw0Var;
            xa xaVar = new xa(this, context, bw0Var);
            this.e = xaVar;
            ...
            xaVar.A(getThemedColor(org.telegram.ui.ActionBar.j6.z8), false);
            xaVar.setBackButtonImage(R.drawable.ic_ab_back);
            xaVar.B(getThemedColor(org.telegram.ui.ActionBar.j6.y8), false);
            xaVar.setCastShadows(true);
            xaVar.setTitle(y());
            xaVar.setActionBarMenuOnItemClick(new org.telegram.ui.ro(this, 7));
            bw0Var.addView(w10);
            bw0Var.addView(xaVar, w7.y5.d(-1, -2.0f, 0, 6.0f, 0.0f, 6.0f, 0.0f));
            w10.j(new ai.r(bw0Var, 16));
        }
        if (i10 == 2) {
            K();
        }
