...
public final class y70 extends Drawable {
    ...
    public y70(int i10, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        if (i10 == 0) {
            ...
            j.setColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Jh, c6Var));
            k.setColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Kh, c6Var));
            this.h = k;
            return;
        }
        if (i10 == 1) {
        ...
        m.setColor(-1);
        m.setTextSize(org.telegram.ui.ActionBar.g6.d3.getTextSize() * 0.75f);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.b != null) {
            ...
            canvas.translate(com.google.android.recaptcha.internal.a.A(width, this.c, 2.0f, bounds.left) - this.e, com.google.android.recaptcha.internal.a.A(width, this.d, 2.0f, bounds.top));
            this.b.draw(canvas);
        }
        canvas.restore();
    }
