...
public final class y70 {
    ...
    public y70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
    ...
    public static y70 F(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view) {
        return new y70(viewGroup, f6Var, view, false, false, false);
    }

    public static y70 G(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z10) {
        return new y70(viewGroup, f6Var, view, z10, false, false);
    }

    public static y70 H(org.telegram.ui.ActionBar.n2 n2Var, View view) {
        return new y70(n2Var, view, false, true);
    }

    public static y70 I(org.telegram.ui.ActionBar.n2 n2Var, View view) {
        return new y70(n2Var, view, true, true);
    }
    ...
    public static void a(y70 y70Var, ViewGroup viewGroup) {
        ...
        if (y70Var.L) {
            ...
            y70Var.m0.setInterpolator(qr.h);
        } else {
    ...
    public static void f(y70 y70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = y70Var.d;
        ...
        if (z10 && runnable != null) {
            org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(2, y70Var.e, y70Var.d, false, false);
        ...
        while (i11 < size) {
            ...
            org.telegram.ui.ActionBar.f1 f1Var2 = new org.telegram.ui.ActionBar.f1(2, y70Var.e, y70Var.d, false, false);
            ...
            f1Var2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.r70
    ...
    public final void B() {
        ...
        this.D = noVar;
        noVar.setDispatchKeyEventListener(new n70(this, 0));
        this.A = this.D;
    }
    ...
    public final void M(Runnable runnable) {
        ...
        if (childAt instanceof org.telegram.ui.ActionBar.f1) {
            ...
            f1Var.setOnClickListener(new q70(this, runnable, 2));
        }
    }
    ...
    */
    ...
    public final void b(int i10, Drawable drawable, CharSequence charSequence, int i11, int i12, Runnable runnable) {
        ...
        f1Var.setOnClickListener(new q70(this, runnable, 3));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        f1Var.setOnClickListener(new q70(this, runnable, 4));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        f1Var.setOnClickListener(new q70(this, runnable, 1));
        int i12 = this.S;
        if (i12 <= 0) {
            r(f1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public final void j(boolean z10, int i10, ii.b2 b2Var, CharSequence charSequence, Runnable runnable) {
        ...
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.j6.l1(0.12f, org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
        f1Var.setOnClickListener(new q70(this, runnable, 5));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public y70(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z10, boolean z11, boolean z12) {
        this.i = 5;
        this.o = new float[2];
        this.t = true;
        this.w = true;
    ...
    public y70(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, org.telegram.ui.ActionBar.f6 f6Var) {
        this.i = 5;
        this.o = new float[2];
        this.t = true;
        this.w = true;
