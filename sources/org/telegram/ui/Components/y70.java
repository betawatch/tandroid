...
public final class y70 {
    ...
    public y70(org.telegram.ui.ActionBar.m2 m2Var, View view, boolean z10, boolean z11) {
        ...
        this.f = view;
        this.s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static void a(y70 y70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(w70Var.w, 0.0f);
        y70Var.m0 = ofFloat;
    ...
    public static void f(y70 y70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        v70Var.addView(linearLayout);
        linearLayout.setOrientation(1);
        y70Var.r(v70Var, w7.y5.n(-1, -2));
        float f7 = 0.12f;
        ...
        while (i11 < size) {
            ...
            TLRPC.Photo photo = e9Var.c;
            if (photo == null || (arrayList = photo.sizes) == null) {
                obj = null;
                e1Var2.g(e9Var.b, R.drawable.msg_folders, null);
            } else {
                e1Var2.h(e9Var.b, ImageLocation.getForObject(FileLoader.getClosestPhotoSizeWithSize(e9Var.c.sizes, AndroidUtilities.dp(24.0f), false, FileLoader.getClosestPhotoSizeWithSize(arrayList, 50), true), e9Var.c), "50_50", null, null);
                obj = null;
            }
            e1Var2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.r70
    ...
    public final void B() {
        oo ooVar = new oo(this, this.e, R.drawable.popup_fixed_alert4, this.d, (this.F ? 2 : 0) | (this.E ? 1 : 0) | (this.G ? 0 : 4));
        this.D = ooVar;
        ooVar.setDispatchKeyEventListener(new n70(this, 0));
        this.A = this.D;
    }

    /* JADX WARN: Type inference failed for: r0v1, types: [org.telegram.ui.Components.o70] */
    public final void C() {
        N();
        View view = this.f;
        if (view == null) {
        ...
        this.f0 = new ViewTreeObserver.OnScrollChangedListener() { // from class: org.telegram.ui.Components.o70
            @Override // android.view.ViewTreeObserver.OnScrollChangedListener
            public final void onScrollChanged() {
                t70 t70Var;
                y70 y70Var = y70.this;
                if (y70Var.e0 == null || (t70Var = y70Var.m) == null || !t70Var.isShowing()) {
                    return;
                }
                int[] iArr = new int[2];
                y70Var.e0.getLocationOnScreen(iArr);
                int i10 = iArr[0];
                int[] iArr2 = y70Var.h0;
        ...
        this.g0 = p70Var;
        this.e0.addOnLayoutChangeListener(p70Var);
    }

    public final boolean D() {
        t70 t70Var = this.m;
        return t70Var != null && t70Var.isShowing();
    }
    ...
    public final void N() {
        ...
        if (view != null) {
            ...
            p70 p70Var = this.g0;
            if (p70Var != null) {
                this.e0.removeOnLayoutChangeListener(p70Var);
            }
        }
        this.f0 = null;
        this.g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        t70 t70Var = this.m;
        if (t70Var == null || !t70Var.isShowing() || (view = this.f) == 0 || (viewGroup = this.b) == null || this.A == null || this.D == null) {
            return;
        }
        float[] fArr = this.o;
    ...
    public final void X(float f7) {
        t70 t70Var = this.m;
        if (t70Var != null) {
            t70Var.update((int) this.a0, (int) (this.b0 + f7), -1, -1);
        }
    }
        ...
        while (i10 < this.A.getChildCount()) {
            ...
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ...
                if (actionBarPopupWindow$ActionBarPopupWindowLayout.getItemsCount() > 0) {
                    ...
                    boolean z10 = childAt2 instanceof org.telegram.ui.ActionBar.e1;
                    org.telegram.ui.ActionBar.d6 d6Var = this.d;
                    if (z10) {
                        ((org.telegram.ui.ActionBar.e1) childAt2).k(true, childAt2 == childAt3);
                    } else if ((childAt2 instanceof ec0) || (childAt2 instanceof FrameLayout)) {
                        childAt2.setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.I5, d6Var), 12, childAt2 == childAt3 ? 12 : 0));
                    ...
                    if (childAt3 instanceof org.telegram.ui.ActionBar.e1) {
                        ((org.telegram.ui.ActionBar.e1) childAt3).k(childAt3 == childAt2, true);
                    } else if ((childAt3 instanceof ec0) || (childAt3 instanceof FrameLayout)) {
                        childAt3.setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.I5, d6Var), childAt2 == childAt3 ? 12 : 0, 12));
    ...
    */
    public final void Z() {
        ...
        ViewGroup overlayContainerView = viewGroup == null ? m2Var.getParentLayout().getOverlayContainerView() : viewGroup;
        ...
        if (this.s > 0 || this.u || this.v) {
            w70 w70Var3 = new w70(this, context);
            this.x = w70Var3;
            this.y = new st(i12, w70Var3);
            overlayContainerView.getViewTreeObserver().addOnPreDrawListener(this.y);
            c10 = 0;
            overlayContainerView.addView(this.x, w7.y5.c(-1.0f, -1));
            ...
            this.m0 = ofFloat;
            ofFloat.addUpdateListener(new k6(this, 29));
            this.m0.addListener(new r8(this, 25));
            if (this.L) {
                f11 = f16;
        ...
        if (!this.L || (w70Var2 = this.x) == null || this.N == 0) {
            f12 = f11;
        } else {
            w70Var2.s = (overlayContainerView.getWidth() - this.N) / f10;
            if (this.M == 3) {
        ...
        Rect padding = this.D.getPadding();
        rectF2.set(padding.left, padding.top, this.A.getMeasuredWidth() - padding.right, this.A.getMeasuredHeight() - padding.bottom);
        t70 t70Var = new t70(this, this.A, overlayContainerView);
        this.m = t70Var;
        t70Var.setOnDismissListener(new u70(this, overlayContainerView));
        ...
        if (this.W) {
            ...
            if (this.U || f17 + height2 + this.A.getMeasuredHeight() + AndroidUtilities.dp(16.0f) > i19) {
                ...
                if (!this.V || Math.max(0.0f, f17 + height2) + this.A.getMeasuredHeight() <= fArr[1] + rectF.top || rectF.height() != view.getHeight()) {
                    ...
                    if (this.L && (w70Var = this.x) != null) {
                        float height3 = overlayContainerView.getHeight();
                        float measuredHeight = this.A.getMeasuredHeight();
                        float f18 = rectF.bottom;
                        w70Var.v = (height3 - (measuredHeight + f18)) / f10;
                        w70 w70Var4 = this.x;
                        height = (int) (w70Var4.v + f18);
                        width = (int) (((w70Var4.s + rectF.right) - this.A.getMeasuredWidth()) + AndroidUtilities.dp(4.0f));
                        if (this.M == 3) {
                    ...
                    if (!this.w) {
                        if (m2Var != null && m2Var.getFragmentView() != null) {
                            m2Var.getFragmentView().getRootView().dispatchTouchEvent(AndroidUtilities.emptyMotionEvent());
                        } else if (viewGroup != null) {
                            overlayContainerView.dispatchTouchEvent(AndroidUtilities.emptyMotionEvent());
                        }
                    }
                    if (this.v && this.n != null) {
                        int i20 = org.telegram.ui.ActionBar.h6.E8;
                        org.telegram.ui.ActionBar.d6 d6Var = this.d;
                        T(org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(i20, d6Var)));
                        ch.d c11 = new ah.c(this.n).c(this.A, null, true);
                        c11.o(eh.b.k(d6Var));
                        c11.p(AndroidUtilities.dp(8.0f));
                        c11.j.e = true;
                        c11.q(AndroidUtilities.dp(12.0f));
                        c11.t(width + this.q, height + this.r);
                    ...
                    this.b0 = f20;
                    t70Var2.showAtLocation(overlayContainerView, 0, (int) f19, (int) f20);
                    if (this.w && view != 0) {
                        if (view.getParent() != null) {
                            view.getParent().requestDisallowInterceptTouchEvent(true);
                        }
                        wr wrVar = new wr(new WeakReference(this), 2);
                        this.o0 = wrVar;
                        view.setOnTouchListener(wrVar);
                    }
                    if (this.d0) {
                        C();
                        return;
            ...
            if (this.L) {
                ...
                w70Var.v = (height32 - (measuredHeight2 + f182)) / f10;
                w70 w70Var42 = this.x;
                height = (int) (w70Var42.v + f182);
                width = (int) (((w70Var42.s + rectF.right) - this.A.getMeasuredWidth()) + AndroidUtilities.dp(4.0f));
                if (this.M == 3) {
                }
            }
            if (!this.w) {
            ...
            if (this.v) {
                int i202 = org.telegram.ui.ActionBar.h6.E8;
                org.telegram.ui.ActionBar.d6 d6Var2 = this.d;
                T(org.telegram.ui.ActionBar.h6.l1(0.06f, org.telegram.ui.ActionBar.h6.v0(i202, d6Var2)));
                ch.d c112 = new ah.c(this.n).c(this.A, null, true);
                c112.o(eh.b.k(d6Var2));
                c112.p(AndroidUtilities.dp(8.0f));
                c112.j.e = true;
                c112.q(AndroidUtilities.dp(12.0f));
                c112.t(width + this.q, height + this.r);
            ...
            this.b0 = f202;
            t70Var22.showAtLocation(overlayContainerView, 0, (int) f192, (int) f202);
            if (this.w) {
                if (view.getParent() != null) {
                }
                wr wrVar2 = new wr(new WeakReference(this), 2);
                this.o0 = wrVar2;
                view.setOnTouchListener(wrVar2);
            }
            if (this.d0) {
            }
        } else {
        ...
        t70 t70Var222 = this.m;
        t70Var222.g = this.I;
        float f1922 = width + this.q;
        this.a0 = f1922;
        float f2022 = height + this.r;
        this.b0 = f2022;
        t70Var222.showAtLocation(overlayContainerView, 0, (int) f1922, (int) f2022);
        if (this.w) {
        }
        if (this.d0) {
        }
    ...
    public final void b(int i10, Drawable drawable, CharSequence charSequence, int i11, int i12, Runnable runnable) {
        ...
        Integer num = this.j0;
        org.telegram.ui.ActionBar.d6 d6Var = this.d;
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.h6.v0(i12, d6Var);
        Integer num2 = this.k0;
        e1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        Integer num3 = this.l0;
        e1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(i12, d6Var)));
    ...
    public final void c(int i10, CharSequence charSequence, Runnable runnable, boolean z10) {
        b(i10, null, charSequence, z10 ? org.telegram.ui.ActionBar.h6.p7 : org.telegram.ui.ActionBar.h6.F8, z10 ? org.telegram.ui.ActionBar.h6.p7 : org.telegram.ui.ActionBar.h6.E8, runnable);
    }
    ...
    public final void d(org.telegram.ui.ActionBar.e1 e1Var) {
        ...
        Integer num = this.j0;
        org.telegram.ui.ActionBar.d6 d6Var = this.d;
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.E8, d6Var);
        Integer num2 = this.k0;
        e1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.F8, d6Var));
        e1Var.setSelectorColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.ai, d6Var));
        Integer num3 = this.l0;
        e1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.E8, d6Var)));
        int i10 = this.S;
        if (i10 <= 0) {
            r(e1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        int i12 = org.telegram.ui.ActionBar.h6.F8;
        TLRPC.User currentUser = UserConfig.getInstance(i10).getCurrentUser();
        org.telegram.ui.ActionBar.e1 e1Var = new org.telegram.ui.ActionBar.e1(0, this.e, this.d, false, false);
        e1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        e1Var.setText(UserObject.getUserName(currentUser));
        e1Var.setClipToPadding(false);
        e1Var.a.setPadding((e1Var.d && e1Var.e == null) ? 0 : AndroidUtilities.dp(43.0f), 0, (!e1Var.d && e1Var.e == null) ? 0 : AndroidUtilities.dp(43.0f), 0);
        ...
        e1Var.addView(w9Var, w7.y5.d(34, 34.0f, (LocaleController.isRTL ? 5 : 3) | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.d6 d6Var = this.d;
        if (z10) {
            View view = new View(context);
            view.setBackground(new gh.c(AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Oh, d6Var), AndroidUtilities.dp(34.0f)));
            e1Var.addView(view, w7.y5.b(36.0f, 36.0f, (LocaleController.isRTL ? 5 : 3) | 16, -6.0f, 0.0f, -5.0f, 0.0f));
        }
        Integer num = this.j0;
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.h6.v0(i11, d6Var);
        Integer num2 = this.k0;
        e1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.h6.v0(i12, d6Var));
        Integer num3 = this.l0;
        e1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(i11, d6Var)));
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        if (tLObject instanceof TLRPC.Chat) {
            ...
            e1Var.setSubtext(ChatObject.isChannelAndNotMegaGroup(chat) ? LocaleController.getString(R.string.DiscussChannel) : LocaleController.getString(R.string.AccDescrGroup).toLowerCase());
        ...
        Integer num = this.j0;
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.h6.v0(i10, d6Var);
        Integer num2 = this.k0;
        e1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        Integer num3 = this.l0;
        e1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(i10, d6Var)));
    ...
    public final void j(boolean z10, int i10, ii.c2 c2Var, CharSequence charSequence, Runnable runnable) {
        ...
        int i11 = org.telegram.ui.ActionBar.h6.E8;
        int i12 = org.telegram.ui.ActionBar.h6.F8;
        org.telegram.ui.ActionBar.e1 e1Var = new org.telegram.ui.ActionBar.e1((i10 == 0 && c2Var == null) ? 1 : 2, this.e, this.d, false, false);
        e1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        if (c2Var != null) {
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.messenger.ok.n(org.telegram.ui.ActionBar.h6.q5, d6Var, h, 1, 13.0f);
    ...
    public final void o() {
        ...
        if (!z10) {
            ...
            int i10 = this.X;
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(w7.y5.z(-1.0f), w7.y5.z(i10 > 0 ? i10 / AndroidUtilities.density : -2.0f));
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.j5, this.d));
    ...
    public y70(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view, boolean z10, boolean z11, boolean z12) {
        ...
        this.f = view;
        this.s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, d6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
