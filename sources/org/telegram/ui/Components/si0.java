        ...
        if (layout != null) {
            ...
            if (text != null && (text instanceof Spannable)) {
                ...
                while (i12 < si0VarArr2.length) {
                    ...
                    oi0 oi0Var = new oi0(duVar2, layout, spannable, si0Var);
                    if (si0Var.a) {
                        int i13 = si0Var.c;
                        if (i13 == 0 || text.charAt(i13 - 1) == '\n') {
                            if (si0Var.d != text.length() && text.charAt(si0Var.d) != '\n') {
                                ...
                                oi0Var = new oi0(duVar2, layout, spannable, si0VarArr2[i12]);
                            }
                            ...
                            if (z13) {
                                ...
                                if (oi0Var.b()) {
                                    ...
                                    if (i16 - 2 >= 0) {
                                        z10 = true;
                                        if (layout.getLineRight(layout.getLineForOffset(i16 - 1)) - AndroidUtilities.dp(12.0f) > oi0Var.d - (si0Var2.J != null ? org.telegram.messenger.y0.D(3.333f, 2, AndroidUtilities.dp(23.66f) + r12.c) : org.telegram.messenger.y0.D(3.333f, 2, AndroidUtilities.dp(23.66f)))) {
                                            z11 = true;
                                            if (z14 != z11) {
                                                int i17 = si0Var2.d;
                                                if (z14) {
