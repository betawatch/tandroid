...
public abstract class si0 {
    ...
    public si0(CharSequence charSequence, CharSequence charSequence2) {
        ...
        this.P = 1.0f;
        this.U = 1.0f;
        this.a0 = new qi0(this, 3);
        this.b0 = new qi0(this, 4);
        this.d0 = new org.telegram.ui.Cells.l9(this, 16);
        this.e0 = false;
    ...
    public final void c(Canvas canvas, boolean z10) {
        ...
        boolean z12 = r2Var instanceof fg1;
        ...
        if (f43 == 0.0f || z11) {
            ...
            int i26 = dp5 >> 1;
            i15 = dp;
            ri0Var.setBounds(i24 - dp6, measuredHeight - i26, i24 + dp6, measuredHeight + i26);
            ...
            ri0Var.b.setColor(this.G ? paint2.getColor() : org.telegram.ui.ActionBar.j6.w0(null, this.b, false));
            ri0Var.draw(canvas);
            canvas.restore();
        } else {
            i15 = dp;
        ...
        if (this.T != null) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.H.getMeasuredWidth(), this.H.getMeasuredHeight(), (int) (org.telegram.messenger.a2.A(1.0f, this.o, 255.0f, f12) * this.x), 31);
        ...
        float f56 = this.C;
        float a2 = org.telegram.ui.Cells.r6.a(1.0f - dp7, f56, dp7, f7);
        float f57 = i16 - f23;
        float f58 = 1.0f - f56;
        canvas.translate(f57 * f58, (height3 - f13) * f58);
        canvas.scale(a2, a2, f23, f13);
        org.telegram.ui.ActionBar.j6.u1.S(0.0f, true);
