...
public abstract class v7 extends FrameLayout {
    ...
    public v7(Context context) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            addView(this.a[i10], h7.z5.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.u7
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i12) {
                    case 0:
                        v7 v7Var = this.b;
                        v7Var.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        v7Var.invalidate();
                        break;
                    default:
                        v7 v7Var2 = this.b;
                        v7Var2.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        v7Var2.invalidate();
                        break;
                }
            }
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.u7
            public final /* synthetic */ v7 b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i10) {
                    case 0:
                        v7 v7Var = this.b;
                        v7Var.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        v7Var.invalidate();
                        break;
                    default:
                        v7 v7Var2 = this.b;
                        v7Var2.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        v7Var2.invalidate();
                        break;
                }
            }
