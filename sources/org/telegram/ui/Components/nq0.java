...
public final class nq0 extends vl0 {
    ...
    public final void E() {
        ...
        if (vq0Var.Z) {
            mq0 mq0Var = new mq0();
            mq0Var.id = Long.MAX_VALUE;
            arrayList.add(mq0Var);
            iVar.k(mq0Var, mq0Var.id);
        }
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 >= 0) {
            ...
            if (i12 < arrayList.size()) {
                ...
                vq0 vq0Var = this.f;
                TLRPC.TL_forumTopic tL_forumTopic = (TLRPC.TL_forumTopic) vq0Var.V.get(dialog);
                i11 = ((org.telegram.ui.ActionBar.f3) vq0Var).currentAccount;
                g7Var.d(tL_forumTopic, MessagesController.getInstance(i11).isMonoForum(dialog.id), false);
                long j3 = dialog.id;
                g7Var.c(j3, vq0Var.U.h(j3) >= 0, null);
                return;
            }
        }
        dialog = null;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            lq0Var.setLayoutParams(new s4.p0(-1, AndroidUtilities.dp((!vq0Var.h0 || vq0Var.o0[1] == null) ? 56.0f : 109.0f)));
        } else {
