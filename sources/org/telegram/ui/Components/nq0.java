...
public final /* synthetic */ class nq0 implements Runnable {
    ...
    public /* synthetic */ nq0(qq0 qq0Var, int i10, String str) {
        this.a = 1;
        this.b = qq0Var;
        this.c = i10;
        this.d = str;
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                qq0 qq0Var3 = this.b;
                qq0Var3.f = null;
                i10 = ((org.telegram.ui.ActionBar.e3) qq0Var3.K).currentAccount;
                DispatchQueue storageQueue = MessagesStorage.getInstance(i10).getStorageQueue();
                String str = this.d;
                int i18 = this.c;
                storageQueue.postRunnable(new nq0(qq0Var3, str, i18, 2));
                nq0 nq0Var = new nq0(qq0Var3, i18, str);
                qq0Var3.h = nq0Var;
                AndroidUtilities.runOnUIThread(nq0Var);
                break;
            case 1:
                qq0 qq0Var4 = this.b;
                qq0Var4.h = null;
                ...
                int i20 = this.c;
                if (i20 == i19) {
                    qq0Var4.e.g(this.d, true, true, true, true, 0L, false, 0, i20);
                    break;
                }
                break;
            default:
                ...
                int i21 = this.c;
                qq0 qq0Var5 = this.b;
                uq0 uq0Var2 = qq0Var5.K;
                try {
                    String lowerCase = str2.trim().toLowerCase();
                    if (lowerCase.length() == 0) {
                        qq0Var5.r = -1;
                        AndroidUtilities.runOnUIThread(new xm(qq0Var5, qq0Var5.r, new ArrayList(), 9));
                        break;
                    } else {
                        ...
                        a0.i iVar = new a0.i();
                        i11 = ((org.telegram.ui.ActionBar.e3) uq0Var2).currentAccount;
                        ...
                        while (queryFinalized.next()) {
                            ...
                            iq0 iq0Var = new iq0();
                            iq0Var.c = queryFinalized.intValue(1);
                            iVar.k(iq0Var, longValue);
                        ...
                        if (arrayList.isEmpty()) {
                            ...
                            i16 = ((org.telegram.ui.ActionBar.e3) uq0Var2).currentAccount;
                                            ...
                                            if (!stringValue.contains(" " + str3)) {
                                                ...
                                                if (r12 == 0) {
                                                    ...
                                                    if (byteBufferValue != null) {
                                                        ...
                                                        int i27 = i21;
                                                        qq0Var2 = qq0Var5;
                                                        iq0 iq0Var2 = (iq0) iVar.f(TLdeserialize.id);
                                                        ...
                                                        if (r12 == z10) {
                                                            iq0Var2.d = AndroidUtilities.generateSearchName(TLdeserialize.first_name, TLdeserialize.last_name, str3);
                                                        } else {
                                                            iq0Var2.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize), null, "@" + str3);
                                                        }
                                                        iq0Var2.b = TLdeserialize;
                                                        iq0Var2.a.id = TLdeserialize.id;
                                                        i23 = i24 + 1;
                                                    }
                                                } else {
                                                    i25 = i26 + 1;
                        ...
                        if (!arrayList2.isEmpty()) {
                            i15 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
                                ...
                                for (int i28 = 0; i28 < i22; i28++) {
                                    ...
                                    if (byteBufferValue2 != null) {
                                        ...
                                        if (TLdeserialize2 != null && !ChatObject.isNotInChat(TLdeserialize2) && (!ChatObject.isChannel(TLdeserialize2) || TLdeserialize2.creator || (((tL_chatAdminRights = TLdeserialize2.admin_rights) != null && tL_chatAdminRights.post_messages) || TLdeserialize2.megagroup))) {
                                            iq0 iq0Var3 = (iq0) iVar.f(-TLdeserialize2.id);
                                            iq0Var3.d = AndroidUtilities.generateSearchName(TLdeserialize2.title, null, str4);
                                            iq0Var3.b = TLdeserialize2;
                                            iq0Var3.a.id = -TLdeserialize2.id;
                                            i13++;
                                        }
                                    }
                                }
                        ...
                        for (int i29 = 0; i29 < iVar.m(); i29++) {
                            iq0 iq0Var4 = (iq0) iVar.n(i29);
                            if (iq0Var4.b != null && iq0Var4.d != null) {
                                arrayList3.add(iq0Var4);
                            }
                        }
                                            ...
                                            if (!stringValue3.contains(" " + str5)) {
                                                ...
                                                if (c10 == 0) {
                                                    ...
                                                    if (byteBufferValue3 != null) {
                                                        ...
                                                        iq0Var5.a.id = TLdeserialize3.id;
                                                        iq0Var5.b = TLdeserialize3;
                                                        if (c10 == 1) {
                                                            iq0Var5.d = AndroidUtilities.generateSearchName(TLdeserialize3.first_name, TLdeserialize3.last_name, str5);
                                                        } else {
                                                            iq0Var5.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize3), null, "@" + str5);
                                                        }
                                                        arrayList3.add(iq0Var5);
                                                    }
                                                } else {
                                                    i30++;
                                                }
                        ...
                        Collections.sort(arrayList3, new org.telegram.ui.cf(16));
                        AndroidUtilities.runOnUIThread(new xm(qq0Var, i12, arrayList3, 9));
                        break;
                    }
                } catch (Exception e) {
                    FileLog.e(e);
    ...
    public /* synthetic */ nq0(qq0 qq0Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = qq0Var;
        this.d = str;
        this.c = i10;
