...
public final class r81 extends AsyncTask {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:136:0x0282, code lost:
        ...
        r0 = org.telegram.ui.Components.s81.q0.matcher(r4);
     */
    ...
    */
    public final Object doInBackground(Object[] objArr) {
        ...
        boolean z12 = true;
        String c10 = s81.c(this, str5, null, true);
        if (!isCancelled()) {
            String q6 = a4.w.q(new StringBuilder("video_id="), this.a, "&ps=default&gl=US&hl=en");
            try {
            ...
            if (c10 != null) {
                Matcher matcher = s81.p0.matcher(c10);
                if (matcher.find()) {
                    StringBuilder f9 = u3.c.f(q6, "&sts=");
                    f9.append(c10.substring(matcher.start() + 6, matcher.end()));
                    q6 = f9.toString();
                } else {
                    q6 = u3.c.k(q6, "&sts=");
                }
            ...
            while (true) {
                ...
                s81 s81Var2 = this.e;
                String str7 = "https://www.youtube.com/get_video_info?" + q6 + strArr[i10];
                s81Var2.getClass();
                String c12 = s81.c(this, str7, hashMap, z12);
                if (isCancelled()) {
                    return hashMap;
                }
                if (c12 != null) {
                    ...
                    while (i12 < split.length) {
                        if (split[i12].startsWith("dashmpd")) {
                            ...
                            if (split2.length == i11) {
                                try {
                                    this.c[c11] = URLDecoder.decode(split2[r52], "UTF-8");
                                } catch (Exception e11) {
                                    FileLog.e(e11);
                                }
                            }
        ...
        String str10 = null;
        if (str10 != null) {
            Matcher matcher2 = s81.w0.matcher(str10);
            if (matcher2.find()) {
            ...
            if (str2 == null) {
                ...
                this.e.getClass();
                obj = null;
                String c13 = s81.c(this, str10, null, true);
                if (!isCancelled()) {
                    if (c13 != null) {
                        Matcher matcher3 = s81.r0.matcher(c13);
                        if (matcher3.find()) {
                            str3 = matcher3.group(1);
                        } else {
                            Matcher matcher4 = s81.s0.matcher(c13);
                            if (matcher4.find()) {
                        ...
                        if (str3 != null) {
                            try {
                                str2 = new com.google.firebase.messaging.s(c13).o(str3);
            ...
            if (!TextUtils.isEmpty(str2)) {
                try {
                    AndroidUtilities.runOnUIThread(new ii0(28, this, str2 + str3 + "('" + this.d.substring(3) + "');"));
                    this.b.await();
                } catch (Exception e16) {
                    FileLog.e(e16);
                    z16 = true;
