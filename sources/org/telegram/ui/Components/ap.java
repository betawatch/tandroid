...
public final class ap extends org.telegram.ui.ActionBar.e3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ap(org.telegram.ui.rn rnVar, org.telegram.ui.pn pnVar) {
        ...
        oi0 oi0Var = new oi0(R.raw.sun_outline, "" + R.raw.sun_outline, dp2, dp2, false, null);
        this.B = oi0Var;
        ...
        if (this.f != null) {
            ...
            if (rnVar.i() != null) {
                str = UserObject.getFirstName(rnVar.i());
            } else {
    ...
    public static void m(ap apVar, ChannelBoostsController.CanApplyBoost canApplyBoost) {
        ...
        i1Var.F1(apVar.b0, true);
        i1Var.H1(apVar.v.a());
        i1Var.M0 = new io(apVar, 2);
        i1Var.show();
    }

    public static /* synthetic */ void n(ap apVar, org.telegram.ui.rn rnVar) {
        if (apVar.f == null) {
            apVar.dismiss();
            return;
        }
    ...
    public static void r(ap apVar, nc1 nc1Var) {
        ...
        l2Var.a = true;
        org.telegram.ui.rn rnVar = apVar.v;
        nc1Var.a.a = rnVar.getResourceProvider();
        nc1Var.l1 = new so(apVar);
        l2Var.c = new gc(7);
        l2Var.d = new io(apVar, 5);
        l2Var.b = new io(apVar, 6);
        l2Var.e = true;
        apVar.T = nc1Var;
        ...
        if (b4Var != null) {
            ...
            while (true) {
                if (i10 == arrayList.size()) {
                    ...
                    if (of.b.a(((zo) arrayList.get(i10)).a.c, this.S.c)) {
            ...
            if (i10 != -1) {
                ...
                int min = Math.min(i10, yoVar.d.size() - 1);
                if (z10) {
                    zk0Var.x0(min);
                } else {
                    k0Var.h1(min, 0);
    ...
    public final void D(boolean z10) {
        ...
        lh.bb bbVar = new lh.bb(this, getContext(), z10, canvas, (toVar.getMeasuredWidth() / 2.0f) + f10, (toVar.getMeasuredHeight() / 2.0f) + f11, Math.max(createBitmap.getHeight(), createBitmap.getWidth()) * 0.9f, paint, createBitmap, paint2, f10, f11, 1);
        this.N = bbVar;
        bbVar.setOnTouchListener(new kh.e(16));
        this.O = 0.0f;
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.P = ofFloat;
        ofFloat.addUpdateListener(new mo(this));
        this.P.addListener(new org.telegram.ui.am(this, 19));
        this.P.setDuration(400L);
        this.P.setInterpolator(ws.e);
        this.P.start();
    ...
    public final void E() {
        ...
        if (textView != null) {
            ...
            int k10 = i0.b.k(getThemedColor(org.telegram.ui.ActionBar.g6.Oh), 76);
            textView.setBackground(org.telegram.ui.ActionBar.g6.i0(dp, dp, dp, dp, 0, k10, k10));
        }
        ...
        if (textView2 != null) {
            ...
            int k11 = i0.b.k(getThemedColor(i10), 76);
            textView2.setBackground(org.telegram.ui.ActionBar.g6.i0(dp2, dp2, dp2, dp2, 0, k11, k11));
        }
        int i11 = org.telegram.ui.ActionBar.g6.j5;
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.g6.f0(i0.b.k(getThemedColor(i11), 30), 1, -1);
        ...
        int dp3 = AndroidUtilities.dp(6.0f);
        int k12 = i0.b.k(getThemedColor(i12), 76);
        textView3.setBackground(org.telegram.ui.ActionBar.g6.i0(dp3, dp3, dp3, dp3, 0, k12, k12));
    }
    ...
    */
    public final void F(boolean z10) {
        ...
        zo zoVar = this.I;
        if (zoVar == null || (b4Var = zoVar.a) == null || !b4Var.a) {
            j6Var2.setText(LocaleController.getString(R.string.ChatApplyTheme));
            if (chat != null && (tL_premium_boostsStatus = this.b0) != null && tL_premium_boostsStatus.level < rnVar.getMessagesController().channelWallpaperLevelMin) {
                ...
                if (z12) {
                    ...
                    this.d0.addListener(new org.telegram.ui.go(6, this, z11));
                    this.d0.start();
                }
                AndroidUtilities.updateViewVisibilityAnimated(textView3, false, 0.9f, false, z10);
                AndroidUtilities.updateViewVisibilityAnimated(textView2, false, 0.9f, false, z10);
    ...
    public final void dismiss() {
        ...
        this.v.getClass();
        if (!this.K) {
            org.telegram.ui.pn pnVar = this.n;
            TLRPC.WallPaper wallPaper = pnVar.h;
            if (wallPaper == null) {
                wallPaper = this.f;
            }
            pnVar.i(this.r, wallPaper, true, Boolean.valueOf(this.s), false);
        }
        if (this.J != this.s) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        int i10 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.i6(null, 32, null, null, new Drawable[]{this.shadowDrawable}, xoVar, org.telegram.ui.ActionBar.g6.h5));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.A, 4, null, null, null, null, org.telegram.ui.ActionBar.g6.j5));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.w, 16, new Class[]{b11.class}, null, null, null, org.telegram.ui.ActionBar.g6.i5));
    ...
    */
    public final void t(boolean z10) {
        ...
        if (tL_premium_boostsStatus != null && tL_premium_boostsStatus.level < rnVar.getMessagesController().channelWallpaperLevelMin) {
            rnVar.getMessagesController().getBoostsController().userCanBoostChannel(rnVar.a(), this.b0, new ko(this, i11));
            return;
        }
        ...
        if (b4Var != this.S) {
            ...
            if (chatTheme2 instanceof TLRPC.TL_chatThemeUniqueGift) {
                ...
                if (starGift instanceof TL_stars.TL_starGiftUnique) {
                    ...
                    if (giftThemeUser == 0 && tL_starGiftUnique != null && !z10) {
                        y4.n0(getContext(), this.resourcesProvider, this.currentAccount, tL_starGiftUnique, giftThemeUser, new io(this, i11));
                        return;
                    }
                    ...
                    TLRPC.WallPaper wallPaper = !w() ? null : this.n.h;
                    z11 = b4Var.a;
                    boolean z13 = this.s;
                    if (z11) {
            ...
            if (i10 != null) {
                z12 = b4Var.a;
                kw0 kw0Var2 = new kw0(getContext(), null, 1, -1, b4Var.f(), rnVar.getResourceProvider());
                kw0Var2.c.setVisibility(8);
                TextView textView2 = kw0Var2.b;
                if (z12) {
                }
                textView2.setTypeface(null);
                ecVar = ec.g(rnVar, kw0Var2, 2750);
            }
        }
        dismiss();
        if (ecVar != null) {
    ...
    public final void u() {
        ...
        alertDialog$Builder.k(LocaleController.getString(R.string.ChatThemeSaveDialogApply), new org.telegram.ui.ActionBar.a2(this) { // from class: org.telegram.ui.Components.lo
        ...
        final int i11 = 1;
        alertDialog$Builder.h(LocaleController.getString(R.string.ChatThemeSaveDialogDiscard), new org.telegram.ui.ActionBar.a2(this) { // from class: org.telegram.ui.Components.lo
            public final /* synthetic */ ap b;
    ...
    public final void v() {
        ...
        for (int i10 = 0; i10 < yoVar.d.size(); i10++) {
            ((zo) yoVar.d.get(i10)).c = this.J ? 1 : 0;
        }
        yoVar.l();
    }
    ...
    public final void y(List list) {
        ...
        of.b bVar = b4Var2 != null ? b4Var2.c : null;
        boolean z10 = false;
    ...
    public final void z() {
        ...
        this.L = false;
        this.v.getClass();
        TLRPC.WallPaper wallPaper = w() ? null : this.f;
        org.telegram.ui.ActionBar.b4 b4Var = this.I.a;
        if (b4Var.a) {
