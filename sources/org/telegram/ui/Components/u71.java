...
public final class u71 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float B = org.telegram.messenger.z0.B(10.0f, getMeasuredHeight(), measuredHeight);
        Paint paint2 = this.R;
        canvas.drawLine(dp3, dp4, dp5, B, paint2);
        canvas.drawLine(AndroidUtilities.dp(4.0f) + dp2, AndroidUtilities.dp(10.0f) + measuredHeight, AndroidUtilities.dp(4.0f) + dp2, org.telegram.messenger.z0.B(10.0f, getMeasuredHeight(), measuredHeight), paint2);
        if (this.S) {
            canvas.restore();
            return;
        }
        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.f) {
                    ...
                    if (t71Var5 != null) {
                        float f15 = this.b;
                        ChatActivityEnterView chatActivityEnterView = ((df) t71Var5).a;
                ...
                if (this.h) {
                    ...
                    if (t71Var6 != null) {
                        float f21 = this.c;
                        ChatActivityEnterView chatActivityEnterView2 = ((df) t71Var6).a;
    ...
    public void setTimeHintView(s71 s71Var) {
        this.P = s71Var;
    }
