    ...
    public final void a(ArrayList arrayList) {
        ...
        try {
            ...
            if (sendingMediaInfo.path != null) {
                w71Var.e = new File(FileLoader.getDirectory(4), Utilities.random.nextInt() + ".jpg");
                ...
                loadBitmap.compress(Bitmap.CompressFormat.JPEG, 87, new FileOutputStream(w71Var.e));
                w71Var.d.b(w71Var.e, loadBitmap, true);
            }
        } catch (Throwable th) {
            FileLog.e(th);
        }
