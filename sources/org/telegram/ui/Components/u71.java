...
public abstract class u71 extends View {
    ...
    public u71(Context context) {
        ...
        this.V = paint6;
        this.W = new z5(0.0f, this, 0L, 200L, pr.j);
        this.a0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        ...
        for (int i10 = 0; i10 < this.C.size(); i10++) {
            s71 s71Var = (s71) this.C.get(i10);
            if (s71Var != null && (bitmap = s71Var.a) != null) {
                bitmap.recycle();
            }
        }
        this.C.clear();
    ...
    public final void d(int i10) {
        ...
        this.D = r71Var;
        r71Var.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, Integer.valueOf(i10), null, null);
    }
        ...
        if (isEmpty && this.D == null) {
            ...
            if (!z4) {
                ...
                while (true) {
                    ...
                    if (((s71) arrayList.get(i10)).a == null) {
                        this.b0 = true;
                        break;
                    }
                    i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                s71 s71Var = (s71) arrayList.get(i12);
                Bitmap bitmap = s71Var.a;
                if (bitmap != null) {
                    ...
                    if (f18 != 1.0f) {
                        ...
                        int interpolation = (int) (pr.h.getInterpolation(s71Var.b) * 255.0f);
                        Paint paint = this.N;
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.y != null) {
                    ...
                    if (dp3 != dp && dp2 - dp5 <= x10 && x10 <= dp5 + dp2 && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        t71 t71Var = this.B;
                        if (t71Var != null) {
                            ((com.google.android.gms.common.api.internal.v) t71Var).f(2);
                        }
                        this.r = true;
                        this.v = (int) (x10 - dp2);
                        invalidate();
                    ...
                    if (dp - dp4 <= x10 && x10 <= Math.min(dp + dp4, dp3) && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        t71 t71Var2 = this.B;
                        if (t71Var2 != null) {
                            ((com.google.android.gms.common.api.internal.v) t71Var2).f(0);
                        }
                        this.h = true;
                        this.v = (int) (x10 - dp);
                        invalidate();
                    ...
                    if (dp3 - dp4 <= x10 && x10 <= dp4 + dp3 && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        t71 t71Var3 = this.B;
                        if (t71Var3 != null) {
                            ((com.google.android.gms.common.api.internal.v) t71Var3).f(1);
                        }
                        this.n = true;
                        this.v = (int) (x10 - dp3);
                        invalidate();
                    ...
                    if (dp <= x10 && x10 <= dp3 && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        t71 t71Var4 = this.B;
                        if (t71Var4 != null) {
                            ((com.google.android.gms.common.api.internal.v) t71Var4).f(2);
                        }
                        this.r = true;
                        ...
                        t71 t71Var5 = this.B;
                        if (t71Var5 != null) {
                            com.google.android.gms.common.api.internal.v vVar = (com.google.android.gms.common.api.internal.v) t71Var5;
                ...
                if (this.h) {
                    t71 t71Var6 = this.B;
                    if (t71Var6 != null) {
                        ((com.google.android.gms.common.api.internal.v) t71Var6).g(0);
                    }
                    this.h = false;
                    return true;
                }
                if (this.n) {
                    t71 t71Var7 = this.B;
                    if (t71Var7 != null) {
                        ((com.google.android.gms.common.api.internal.v) t71Var7).g(1);
                    }
                    this.n = false;
                    return true;
                }
                if (this.r) {
                    t71 t71Var8 = this.B;
                    if (t71Var8 != null) {
                        ((com.google.android.gms.common.api.internal.v) t71Var8).g(2);
                    }
                    this.r = false;
                }
                ...
                if (this.r) {
                    ...
                    if (t71Var9 != null) {
                        float f13 = this.s;
                        com.google.android.gms.common.api.internal.v vVar2 = (com.google.android.gms.common.api.internal.v) t71Var9;
                ...
                if (this.h) {
                    ...
                    t71 t71Var10 = this.B;
                    if (t71Var10 != null) {
                        com.google.android.gms.common.api.internal.v vVar3 = (com.google.android.gms.common.api.internal.v) t71Var10;
                        PhotoViewer photoViewer3 = (PhotoViewer) vVar3.d;
                        j71 j71Var = photoViewer3.C2;
                        if (j71Var != null) {
                            if (j71Var.y()) {
                ...
                if (this.n) {
                    ...
                    t71 t71Var11 = this.B;
                    if (t71Var11 != null) {
                        ((com.google.android.gms.common.api.internal.v) t71Var11).h(this.e);
                    }
                    invalidate();
                    return true;
                }
    ...
    public void setRightProgress(float f10) {
        ...
        t71 t71Var = this.B;
        if (t71Var != null) {
            ((com.google.android.gms.common.api.internal.v) t71Var).f(1);
        }
        t71 t71Var2 = this.B;
        if (t71Var2 != null) {
            ((com.google.android.gms.common.api.internal.v) t71Var2).h(this.e);
        }
        t71 t71Var3 = this.B;
        if (t71Var3 != null) {
            ((com.google.android.gms.common.api.internal.v) t71Var3).g(1);
        }
        invalidate();
    }
}
