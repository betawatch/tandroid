...
public final class q91 extends AsyncTask {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:136:0x0282, code lost:
        ...
        r0 = org.telegram.ui.Components.r91.u0.matcher(r4);
     */
    ...
    */
    public final Object doInBackground(Object[] objArr) {
        ...
        boolean z12 = true;
        String c12 = r91.c(this, str5, null, true);
        if (!isCancelled()) {
            ...
            if (c12 != null) {
                Matcher matcher = r91.t0.matcher(c12);
                if (matcher.find()) {
                    StringBuilder h = v7.j0.h(s10, "&sts=");
            ...
            while (true) {
                ...
                r91Var2.getClass();
                String c14 = r91.c(this, str7, hashMap, z12);
                if (isCancelled()) {
                    return hashMap;
                }
                if (c14 != null) {
        ...
        String str10 = null;
        if (str10 != null) {
            Matcher matcher2 = r91.A0.matcher(str10);
            if (matcher2.find()) {
            ...
            if (str2 == null) {
                ...
                this.e.getClass();
                obj = null;
                String c15 = r91.c(this, str10, null, true);
                if (!isCancelled()) {
                    if (c15 != null) {
                        Matcher matcher3 = r91.v0.matcher(c15);
                        if (matcher3.find()) {
                            str3 = matcher3.group(1);
                        } else {
                            Matcher matcher4 = r91.w0.matcher(c15);
                            if (matcher4.find()) {
