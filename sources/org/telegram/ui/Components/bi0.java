...
public class bi0 extends wp implements NotificationCenter.NotificationCenterDelegate {
    public boolean A0;
    public boolean B0;
    public final yl0 C0;
    public final ai0 D0;
    ...
    public final View E(int i10) {
        ...
        ArrayList arrayList = ai0Var.c;
        if (arrayList.size() <= i10 || i10 < 0) {
            return null;
        }
        xh0 xh0Var = (xh0) arrayList.get(i10);
        yh0 yh0Var = xh0Var.b;
        return yh0Var == null ? xh0Var.c : yh0Var;
    }
            ...
            if (imageLocation3 == null || imageLocation3.location.local_id != imageLocation.location.local_id) {
                ...
                if (!isEmpty) {
                    ...
                    if (z10 && (dialogPhotos2 = this.S0) != null) {
                        dialogPhotos2.reset();
                        this.S0.loadAfter(getCurrentItem() - (ai0Var != null ? ai0Var.j() : 0), true);
                    }
                    return true;
                }
    ...
    public final void N(int i10, int i11) {
        ...
        ai0 ai0Var = this.D0;
        if (ai0Var != null) {
            for (int i12 = 0; i12 < ai0Var.c.size(); i12++) {
                if (((xh0) ai0Var.c.get(i12)).c != null) {
                    vh0 vh0Var = ((xh0) ai0Var.c.get(i12)).c;
                    int i13 = this.m1;
                    int i14 = this.n1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        ArrayList arrayList5 = bi0Var2.U0;
        ArrayList arrayList6 = bi0Var2.T0;
        if (i10 != i14) {
            int i15 = NotificationCenter.fileLoaded;
            SparseArray sparseArray = bi0Var2.d1;
            if (i10 == i15) {
            ...
            if (i10 != NotificationCenter.fileLoadProgressChanged) {
                if (i10 == NotificationCenter.reloadDialogPhotos && bi0Var2.c1 == 0 && (dialogPhotos = bi0Var2.S0) != null) {
                    dialogPhotos.reset();
                    MessagesController.DialogPhotos dialogPhotos2 = bi0Var2.S0;
                    int currentItem = bi0Var2.getCurrentItem();
                    ai0 ai0Var = bi0Var2.D0;
                    dialogPhotos2.loadAfter(currentItem - (ai0Var != null ? ai0Var.j() : 0), true);
                    return;
                }
                return;
            }
        ...
        if (bi0Var2.S0 == dialogPhotos3) {
            ArrayList arrayList7 = new ArrayList(dialogPhotos3.photos);
            if (!arrayList7.isEmpty() || !dialogPhotos3.fromCache) {
                bi0Var2.j1 = -1;
                bi0Var2.k1 = -1;
                int i18 = bi0Var2.L0;
                TLRPC.User user4 = MessagesController.getInstance(i18).getUser(Long.valueOf(bi0Var2.E0));
                TLRPC.UserFull userFull = MessagesController.getInstance(i18).getUserFull(bi0Var2.E0);
                ...
                if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                    ...
                    bi0Var2.k1 = arrayList7.size() - 1;
                }
                arrayList5.clear();
                arrayList6.clear();
                ArrayList arrayList8 = bi0Var2.X0;
                arrayList8.clear();
                ArrayList arrayList9 = bi0Var2.W0;
                arrayList9.clear();
                ArrayList arrayList10 = bi0Var2.Y0;
                arrayList10.clear();
                ArrayList arrayList11 = bi0Var2.Z0;
                arrayList11.clear();
                ArrayList arrayList12 = bi0Var2.V0;
                arrayList12.clear();
                ArrayList arrayList13 = bi0Var2.a1;
                arrayList13.clear();
                ArrayList arrayList14 = bi0Var2.b1;
                arrayList14.clear();
                if (DialogObject.isChatDialog(bi0Var2.E0)) {
                    TLRPC.Chat chat = MessagesController.getInstance(i18).getChat(Long.valueOf(-bi0Var2.E0));
                    ...
                    if (imageLocation != null) {
                        ...
                        arrayList5.add(null);
                        TLRPC.ChatFull chatFull = bi0Var2.F0;
                        if (chatFull == null || !FileLoader.isSamePhoto((TLRPC.FileLocation) imageLocation.location, chatFull.chat_photo)) {
                            ...
                            arrayList12.add(bi0Var2.F0.chat_photo);
                            if (bi0Var2.F0.chat_photo.video_sizes.isEmpty()) {
                                z13 = false;
                                arrayList9.add(null);
                                arrayList6.add(null);
                            } else {
                                TLRPC.VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(bi0Var2.F0.chat_photo.video_sizes, MediaDataController.MAX_STYLE_RUNS_COUNT);
                                arrayList9.add(ImageLocation.getForPhoto(closestVideoSizeWithSize, bi0Var2.F0.chat_photo));
                ...
                while (true) {
                    ...
                    if (photo2 == null || (photo2 instanceof TLRPC.TL_photoEmpty) || (arrayList3 = photo2.sizes) == null) {
                        ...
                        if (closestPhotoSizeWithSize2 != null) {
                            ...
                            if (forPhoto != null) {
                                ImageLocation imageLocation3 = bi0Var2.P0;
                                num = num2;
                                if (imageLocation3 == null) {
                                    arrayList14 = arrayList4;
                                    user2 = user;
                                } else if (imageLocation3.photoId != forPhoto.photoId || z10 || bi0Var2.E0 == UserConfig.getInstance(i12).getClientUserId()) {
                                    user2 = user;
                                    arrayList14 = arrayList4;
                                } else {
                                    arrayList5.add(null);
                                    arrayList.add(bi0Var2.P0);
                                    ImageLocation imageLocation4 = bi0Var2.Q0;
                                    ...
                                    if (photo2.video_sizes.isEmpty()) {
                                        ...
                                        if (vectorMarkupVideoSize != null) {
                                            user3 = user;
                                            arrayList11.add(new g71(vectorMarkupVideoSize, user != null && user3.premium, 2));
                                            obj = null;
                                            arrayList9.add(null);
                                            arrayList6.add(null);
                                        } else {
                                ...
                                if (photo2.video_sizes.isEmpty()) {
                                    ...
                                    if (vectorMarkupVideoSize2 != null) {
                                        user = user2;
                                        arrayList11.add(new g71(vectorMarkupVideoSize2, user2 != null && user2.premium, 2));
                                        z12 = false;
                                        arrayList9.add(null);
                                        arrayList6.add(null);
                                    } else {
                ...
                ImageLocation imageLocation5 = bi0Var.q1;
                if (imageLocation5 != null) {
                    bi0Var.A(imageLocation5, bi0Var.r1);
                }
            }
        }
    }
    ...
    public v9 getCurrentItemView() {
        ai0 ai0Var = this.D0;
        if (ai0Var == null || ai0Var.c.isEmpty()) {
            return null;
        }
        return ((xh0) ai0Var.c.get(getCurrentItem())).c;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        sh0 sh0Var = this.p1;
        if (sh0Var != null) {
            sh0Var.setTranslationY(getHeight() - this.p1.getMeasuredHeight());
        }
    }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (ai0Var != null) {
            ...
            if (action == 0) {
                ...
                if (ai0Var.c.size() > 1 && wh0Var != null) {
                    wh0Var.b(motionEvent.getX() < ((float) getWidth()) / 3.0f);
                }
                this.I0 = false;
            } else if (action == 1) {
                if (!this.I0) {
                    ...
                    if (realCount > 1) {
                        if (motionEvent.getX() > getWidth() / 3.0f) {
                            ...
                            i10 = i12 < ai0Var.j() ? (realCount + r0) - 1 : i12;
                        }
                        if (wh0Var != null) {
                            wh0Var.a();
                        }
    ...
    public void setAnimatedFileMaybe(c6 c6Var) {
        ai0 ai0Var;
        if (c6Var == null || (ai0Var = this.D0) == null) {
            return;
        }
        int childCount = getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = getChildAt(i10);
            if ((childAt instanceof v9) && ai0Var.k(ai0Var.d.indexOf(childAt)) == 0) {
                v9 v9Var = (v9) childAt;
    ...
    public bi0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, yl0 yl0Var, org.telegram.ui.m01 m01Var, wh0 wh0Var, sh0 sh0Var) {
        super(context);
        this.x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.k1 = -1;
        this.p1 = sh0Var;
        setPadding(0, 0, 0, sh0Var == null ? 0 : sh0Var.n);
        if (sh0Var != null) {
            sh0Var.setView(this);
        }
        setVisibility(8);
        ...
        this.C0 = yl0Var;
        this.z0 = kVar;
        ai0 ai0Var = new ai0(this, getContext(), m01Var);
        this.D0 = ai0Var;
        setAdapter((vp) ai0Var);
        this.y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = wh0Var;
        b(new uh0((org.telegram.ui.pz0) this));
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.dialogPhotosLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoadProgressChanged);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.reloadDialogPhotos);
