...
public final class bi0 implements ci0 {
    ...
    public final void c(lv lvVar, Canvas canvas) {
        ...
        Paint paint;
        di0 di0Var = this.k;
        Paint paint2 = di0Var.a;
        Path path = di0Var.b;
        if (canvas.isHardwareAccelerated()) {
            float width = di0Var.getWidth();
            float height = di0Var.getHeight();
            RectF rectF = this.g;
            ...
            if (childCount > 0) {
                ...
                NotchInfoUtils.NotchInfo notchInfo = di0Var.n;
                if (notchInfo != null) {
            ...
            di0.a((di0) lvVar.b, beginRecording);
            this.b.endRecording();
            float f20 = this.f;
            ...
            if (di0Var.n != null) {
                ...
                NotchInfoUtils.NotchInfo notchInfo2 = di0Var.n;
                if (notchInfo2.isLikelyCircle) {
                    float min = Math.min(notchInfo2.bounds.width(), di0Var.n.bounds.height()) / 2.0f;
                    RectF rectF3 = di0Var.n.bounds;
                    float width2 = rectF3.bottom - (rectF3.width() / 2.0f);
                    beginRecording4.drawCircle(di0Var.n.bounds.centerX(), width2, min, paint2);
                    path.rewind();
                    float f24 = f7 / 2.0f;
                    path.moveTo(di0Var.n.bounds.centerX() - f24, width2);
                    path.lineTo(di0Var.n.bounds.centerX(), min + width2 + f7);
                    path.lineTo(di0Var.n.bounds.centerX() + f24, width2);
                    path.close();
                    beginRecording4.drawPath(path, paint2);
                } else if (notchInfo2.isAccurate) {
                    beginRecording4.drawPath(notchInfo2.path, paint2);
                } else {
                    float max = Math.max(notchInfo2.bounds.width(), di0Var.n.bounds.height()) / 2.0f;
                    RectF rectF4 = di0Var.n.bounds;
                    RectF rectF5 = this.h;
                    rectF5.set(rectF4);
            ...
            NotchInfoUtils.NotchInfo notchInfo3 = di0Var.n;
            if (notchInfo3 != null) {
