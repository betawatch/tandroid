...
public final class ne0 implements DialogInterface.OnClickListener {
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        Integer num12 = 6;
        se0 se0Var2 = this.a;
        ArrayList arrayList3 = se0Var2.J;
        ArrayList arrayList4 = se0Var2.I;
        Integer num13 = 0;
        if (i10 == 0) {
        ...
        TLRPC.TL_userContact_old2 tL_userContact_old2 = se0Var2.K;
        ...
        try {
            se0Var.r.getParentActivity().startActivity(intent3);
            se0Var.dismiss();
        } catch (Exception e) {
            FileLog.e(e);
        }
