...
public class p6 extends Drawable {
    ...
    */
    public static boolean j(int i10, int i11, CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (!(charSequence instanceof o6) || !(charSequence2 instanceof o6)) {
            return charSequence.charAt(i10) == charSequence2.charAt(i11);
        }
        o6 o6Var = (o6) charSequence;
        CharSequence charSequence4 = null;
        if (i10 >= 0) {
            CharSequence[] charSequenceArr = o6Var.a;
            if (i10 < charSequenceArr.length) {
                charSequence3 = charSequenceArr[i10];
                o6 o6Var2 = (o6) charSequence2;
                if (i11 >= 0) {
                    CharSequence[] charSequenceArr2 = o6Var2.a;
        ...
        if (this.j != null) {
            ...
            while (true) {
                ...
                if (p6Var.getCallback() instanceof View) {
                    z5.release((View) p6Var.getCallback(), m6Var.a);
                }
                i10++;
            }
        }
    ...
    */
    public final void draw(Canvas canvas) {
            ...
            if (f16 != 1.0f) {
                ...
                while (true) {
                    ...
                    if (!this.c || this.E) {
                        ...
                        f13 = 0.0f;
                        f17 = this.d - (f17 + m6Var.f);
                    }
                    float f18 = this.m;
                    float f19 = this.t;
                    if (f19 > f13) {
                        f18 = AndroidUtilities.cascade(f18, i10, m6VarArr.length, f19);
                    }
                    if (i11 >= 0) {
                        m6 m6Var2 = this.j[i11];
                        float f20 = m6Var2.c;
                        if (this.c && !this.E) {
                            f20 = this.h - (f20 + m6Var2.f);
                        }
                        f14 = AndroidUtilities.lerp(f20 - m6Var2.e, f17 - m6Var.e, this.m);
                        a(1.0f);
                        f15 = 0.0f;
                    } else {
                        f14 = f17 - m6Var.e;
                    ...
                    if (i11 < 0) {
                        ...
                        if (f22 > f13) {
                            ...
                            canvas.scale(lerp3, lerp3, m6Var.f / 2.0f, m6Var.b.getHeight() / 2.0f);
                        }
                    }
                    m6Var.a(canvas, i11 >= 0 ? 1.0f : this.m);
                    canvas.restore();
                    i10++;
                }
                int i13 = 0;
                while (true) {
                    m6[] m6VarArr2 = this.j;
                    if (i13 >= m6VarArr2.length) {
                        break;
                    }
                    m6 m6Var3 = m6VarArr2[i13];
                    if (m6Var3.d < 0) {
                        float f23 = this.m;
                        float f24 = this.t;
                        if (f24 > 0.0f) {
                            f23 = AndroidUtilities.cascade(f23, i13, m6VarArr2.length, f24);
                        }
                        float f25 = m6Var3.c;
                        ...
                        boolean z11 = this.c;
                        if (z11 && !this.E) {
                            f25 = this.h - (f25 + m6Var3.f);
                        }
                        float f27 = f25 - m6Var3.e;
                        int i14 = this.b;
                        if ((i14 | (-4)) != -1) {
                            if ((i14 | (-6)) == -1) {
                                f11 = width;
                        ...
                        if (f28 > 0.0f) {
                            ...
                            canvas.scale(lerp4, lerp4, m6Var3.f / 2.0f, m6Var3.b.getHeight() / 2.0f);
                        }
                        m6Var3.a(canvas, f26);
                        canvas.restore();
                    }
        ...
        if (this.f != null) {
            ...
            for (int i15 = 0; i15 < this.f.length; i15++) {
                canvas.save();
                m6 m6Var4 = this.f[i15];
                float f30 = m6Var4.c;
                boolean z12 = this.c;
                if (z12 && !this.E) {
                    f30 = this.d - (f30 + m6Var4.f);
                }
                float f31 = f30 - m6Var4.e;
                int i16 = this.b;
                if ((i16 | (-4)) != -1) {
                    if ((i16 | (-6)) == -1) {
                        f31 += width - this.d;
    ...
    public final void q(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        if (!z12) {
            ...
            if (!charSequence2.equals(this.g)) {
                ...
                this.j = null;
                this.f = new m6[]{new m6(this, h(i13, charSequence2), 0.0f, -1)};
        ...
        n6 n6Var = new n6(this) { // from class: org.telegram.ui.Components.k6
            ...
            public final void d(CharSequence charSequence3) {
                switch (i12) {
                    case 0:
                        p6 p6Var2 = this.b;
                        m6 m6Var2 = new m6(p6Var2, p6Var2.h(i16 - ((int) Math.ceil(p6Var2.d)), charSequence3), p6Var2.d, -1);
                        arrayList.add(m6Var2);
                        p6Var2.d += m6Var2.f;
                        p6Var2.e = Math.max(p6Var2.e, r5.getHeight());
                        break;
                    default:
                        p6 p6Var3 = this.b;
                        m6 m6Var3 = new m6(p6Var3, p6Var3.h(i16 - ((int) Math.ceil(p6Var3.h)), charSequence3), p6Var3.h, -1);
                        arrayList.add(m6Var3);
                        p6Var3.h += m6Var3.f;
                        p6Var3.i = Math.max(p6Var3.i, r5.getHeight());
                        break;
                }
            }
        };
        n6 n6Var2 = new n6(this) { // from class: org.telegram.ui.Components.k6
            public final /* synthetic */ p6 b;
        ...
        CharSequence o6Var = this.y ? new o6(this.k) : this.k;
        CharSequence o6Var2 = this.y ? new o6(this.g) : this.g;
        if (this.F) {
            i(n6Var2, o6Var, 0, o6Var.length());
            i(n6Var, o6Var2, 0, o6Var2.length());
        } else if (this.z) {
            int min = Math.min(o6Var2.length(), o6Var.length());
            if (this.A) {
                ArrayList arrayList3 = new ArrayList();
                int i17 = 1;
                int i18 = 0;
                for (int i19 = 0; i19 <= min; i19++) {
                    int length = (o6Var2.length() - i19) - 1;
                    int length2 = (o6Var.length() - i19) - 1;
                    int i20 = (length < 0 || length2 < 0 || !j(length, length2, o6Var2, o6Var)) ? 0 : 1;
                    if (i14 != i20 || i19 == min) {
                        int i21 = i19 - i18;
                        if (i21 > 0) {
                ...
                int length3 = o6Var2.length() - min;
                int length4 = o6Var.length() - min;
                if (length3 > 0) {
                    i(n6Var, o6Var2.subSequence(0, length3), 0, length3);
                }
                if (length4 > 0) {
                    i(n6Var2, o6Var.subSequence(0, length4), 0, length4);
                }
                ...
                while (size >= 0) {
                    ...
                    if ((size % 2 == 0 ? 1 : 0) == i17) {
                        i11 = size;
                        if (o6Var2.length() > o6Var.length()) {
                            daVar.d(o6Var2.subSequence(length3, length3 + intValue));
                        } else {
                            daVar.d(o6Var.subSequence(length4, length4 + intValue));
                        }
                    } else {
                        i11 = size;
                        int i22 = length3 + intValue;
                        i(n6Var, o6Var2.subSequence(length3, i22), length3, i22);
                        int i23 = length4 + intValue;
                        i(n6Var2, o6Var.subSequence(length4, i23), length4, i23);
                    }
                    length3 += intValue;
                    length4 += intValue;
                    size = i11 - 1;
                ...
                int i25 = 0;
                while (i24 <= min) {
                    boolean z14 = i24 < min && j(i24, i24, o6Var2, o6Var);
                    if (z13 != z14 || i24 == min) {
                        if (i24 - i25 > 0) {
                            if (z13) {
                                i(daVar, o6Var2.subSequence(i25, i24), i25, i24);
                            } else {
                                i(n6Var, o6Var2.subSequence(i25, i24), i25, i24);
                                i(n6Var2, o6Var.subSequence(i25, i24), i25, i24);
                            }
                        }
                        i25 = i24;
                        z13 = z14;
                ...
                if (o6Var2.length() - min > 0) {
                    i(n6Var, o6Var2.subSequence(min, o6Var2.length()), min, o6Var2.length());
                }
                if (o6Var.length() - min > 0) {
                    i(n6Var2, o6Var.subSequence(min, o6Var.length()), min, o6Var.length());
                }
            }
        } else {
            int min2 = Math.min(o6Var2.length(), o6Var.length());
            boolean z15 = true;
            int i26 = 0;
            int i27 = 0;
            int i28 = 0;
            int i29 = 0;
            while (i26 <= min2) {
                boolean z16 = i26 < min2 && j(i26, i27, o6Var2, o6Var);
                if (z15 != z16 || i26 == min2) {
                    if (i26 == min2) {
                        i26 = o6Var2.length();
                        i27 = o6Var.length();
                    ...
                    if (i30 > 0 || i31 > 0) {
                        if (i30 == i31 && z17) {
                            daVar.d(o6Var2.subSequence(i28, i26));
                        } else {
                            if (i30 > 0) {
                                i(n6Var, o6Var2.subSequence(i28, i26), i28, i26);
                            }
                            if (i31 > 0) {
                                i(n6Var2, o6Var.subSequence(i29, i27), i29, i27);
                            }
                        }
                    }
                    i28 = i26;
        ...
        if (this.j != null) {
            ...
            while (true) {
                m6[] m6VarArr2 = this.j;
                if (i32 >= m6VarArr2.length) {
                    break;
                }
                m6 m6Var2 = m6VarArr2[i32];
                p6 p6Var2 = m6Var2.g;
                if (p6Var2.getCallback() instanceof View) {
                    z5.release((View) p6Var2.getCallback(), m6Var2.a);
                }
                i32++;
            }
        }
        this.j = null;
        m6[] m6VarArr3 = this.f;
        if (m6VarArr3 == null || m6VarArr3.length != arrayList.size()) {
            this.f = new m6[arrayList.size()];
        }
        arrayList.toArray(this.f);
        c();
        m6[] m6VarArr4 = this.j;
        if (m6VarArr4 == null || m6VarArr4.length != arrayList2.size()) {
            this.j = new m6[arrayList2.size()];
        }
        ...
        this.o.addUpdateListener(new l6(this, 0));
        this.o.addListener(new j6(this, 1));
    ...
    public final void s(int i10, boolean z10) {
        ...
        this.S = ofFloat;
        ofFloat.addUpdateListener(new di.d5(this, this.a.getColor(), i10, 2));
        ...
        if (Math.abs(textSize - f7) > 0.5f) {
            ...
            if (this.f != null) {
                ...
                while (true) {
                    ...
                    StaticLayout h = h(i10 - ((int) Math.ceil(Math.min(this.d, this.h))), m6VarArr[i12].b.getText());
                    m6[] m6VarArr2 = this.f;
                    m6 m6Var = m6VarArr2[i12];
                    m6VarArr2[i12] = new m6(this, h, m6Var.c, m6Var.d);
            ...
            if (this.j != null) {
                ...
                while (true) {
                    ...
                    StaticLayout h10 = h(i10 - ((int) Math.ceil(Math.min(this.d, this.h))), m6VarArr3[i11].b.getText());
                    m6[] m6VarArr4 = this.j;
                    m6 m6Var2 = m6VarArr4[i11];
                    m6VarArr4[i11] = new m6(this, h10, m6Var2.c, m6Var2.d);
