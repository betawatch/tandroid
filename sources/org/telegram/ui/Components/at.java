...
public abstract class at extends s4.f1 {
    ...
    public final void B(ArrayList arrayList, s4.c1 c1Var) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ...
            if (C(ysVar, c1Var) && ysVar.a == null && ysVar.b == null) {
    ...
    public final void f(s4.c1 c1Var) {
        ...
        while (true) {
            ...
            if (((zs) arrayList.get(size)).a == c1Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                v(c1Var);
        ...
        for (int size3 = arrayList4.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                ...
                if (((zs) arrayList5.get(size4)).a == c1Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    v(c1Var);
    ...
    public final void g() {
        ...
        for (int size4 = arrayList4.size() - 1; size4 >= 0; size4--) {
            ...
            s4.c1 c1Var3 = ysVar.a;
            if (c1Var3 != null) {
                C(ysVar, c1Var3);
            }
            s4.c1 c1Var4 = ysVar.b;
            if (c1Var4 != null) {
                C(ysVar, c1Var4);
            }
        }
        ...
        if (k()) {
            ...
            for (int size9 = arrayList9.size() - 1; size9 >= 0; size9--) {
                ...
                for (int size10 = arrayList10.size() - 1; size10 >= 0; size10--) {
                    ...
                    s4.c1 c1Var6 = ysVar2.a;
                    if (c1Var6 != null) {
                        C(ysVar2, c1Var6);
                    }
                    s4.c1 c1Var7 = ysVar2.b;
                    if (c1Var7 != null) {
                        C(ysVar2, c1Var7);
                    }
    ...
    public final void m() {
        ...
        while (i11 < size) {
            ...
            if (view instanceof org.telegram.ui.Cells.r2) {
                ...
                animate.setDuration(180L).alpha(0.0f).setListener(new ws(this, c1Var, animate, view)).start();
            }
                        ...
                        case 0:
                            ...
                            while (true) {
                                ...
                                if (i15 >= size2) {
                                    ...
                                    atVar.w.add(c1Var2);
                                    animate2.setDuration(180L).setListener(new xs(atVar, c1Var2, i20, view2, i21, animate2, 0)).start();
                                }
                            }
                        default:
