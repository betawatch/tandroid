...
public final class bf0 {
    ...
    public final float[] a() {
        ...
        float f13 = this.e;
        int i10 = 5;
        float[] fArr = {-0.001f, f9 / 100.0f, 0.0f, f9 / 100.0f, 0.25f, f10, 0.5f, f11, 0.75f, f12, 1.0f, f13 / 100.0f, 1.001f, f13 / 100.0f};
        int i11 = 100;
        ...
        while (i12 < i10) {
            ...
            while (i18 < i11) {
                ...
                float f23 = f22 * f22;
                float f24 = f23 * f22;
                float z10 = ((((((f16 * 3.0f) - f14) - (f18 * 3.0f)) + f20) * f24) + ((((f18 * 4.0f) + ((f14 * 2.0f) - (f16 * 5.0f))) - f20) * f23) + com.google.android.recaptcha.internal.a.z(f18, f14, f22, f16 * 2.0f)) * 0.5f;
                float max = Math.max(0.0f, Math.min(1.0f, ((((((f17 * 3.0f) - f15) - (f19 * 3.0f)) + f21) * f24) + ((((4.0f * f19) + ((2.0f * f15) - (5.0f * f17))) - f21) * f23) + com.google.android.recaptcha.internal.a.z(f19, f15, f22, f17 * 2.0f)) * 0.5f));
                if (z10 > f14) {
