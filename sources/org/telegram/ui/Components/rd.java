...
public final /* synthetic */ class rd implements Runnable {
    ...
    public /* synthetic */ rd(gg ggVar, Object obj, MediaController.PhotoEntry photoEntry, boolean z10, int i10, int i11, boolean z11, Long l4, String str, Object obj2) {
        this.r = ggVar;
        this.b = obj;
        this.s = photoEntry;
        this.c = z10;
            ...
            default:
                ...
                if (z13) {
                    ...
                    if (z12) {
                        ...
                        SendMessagesHelper.prepareSendingMedia(accountInstance, arrayList, j3, messageObject, threadMessage4, null, chatActivityEnterView.U2, false, false, chatActivityEnterView.Y1, z14, i12, i11, 0, false, null, xnVar != null ? xnVar.C8() : null, chatActivityEnterView.S4, z15, l4.longValue(), chatActivityEnterView.getSendMonoForumPeerId(), chatActivityEnterView.getSendMessageSuggestionParams());
                        z10 = z14;
                        i12 = i12;
                    } else {
                        ...
                        sendMessagesHelper.sendSticker(document, str2, j10, charSequence2, videoEditedInfo, messageObject2, threadMessage3, storyItem, chatActivityEnterView.U2, null, z14, i12, i11, false, obj2, xnVar != null ? xnVar.C8() : null, l4.longValue(), chatActivityEnterView.getSendMonoForumPeerId(), chatActivityEnterView.getSendMessageSuggestionParams(), z15);
                        z10 = z14;
                        i12 = i12;
                    ...
                    if (obj instanceof TLRPC.BotInlineResult) {
                        ...
                        if (storyItem2 == null) {
                            ...
                            SendMessagesHelper.prepareSendingBotContextResult(xnVar2, accountInstance2, botInlineResult, hashMap, j11, messageObject3, threadMessage2, null, chatActivityEnterView.U2, z10, i12, 0, xnVar != null ? xnVar.C8() : null, l4.longValue(), chatActivityEnterView.getSendMonoForumPeerId());
                            z10 = z10;
                            i12 = i12;
                        } else {
                            ...
                            sendMessagesHelper2.sendSticker(document2, str2, j12, messageObject4, threadMessage, storyItem2, chatActivityEnterView.U2, null, z10, i12, i11, false, obj2, xnVar != null ? xnVar.C8() : null, l4.longValue(), chatActivityEnterView.getSendMonoForumPeerId(), chatActivityEnterView.getSendMessageSuggestionParams());
                        }
                        if (chatActivityEnterView.Q1 != 0) {
