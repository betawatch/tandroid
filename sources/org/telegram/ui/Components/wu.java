...
public final class wu extends View {
    ...
    public wu(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.v = new RectF();
        qr qrVar = qr.h;
        this.w = new e6(this, 125L, qrVar);
        this.x = new e6(this, 125L, qrVar);
        this.F = -1;
        this.G = true;
        this.y = e6Var;
    ...
    public final void a() {
        ...
        org.telegram.ui.ActionBar.j6.w1(org.telegram.ui.ActionBar.j6.v0(i10, e6Var), this.c);
        org.telegram.ui.ActionBar.j6.w1(org.telegram.ui.ActionBar.j6.v0(i10, e6Var), this.d);
        CompoundEmoji.setPlaceholderColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Me, e6Var));
    }
    ...
    public final void onDraw(Canvas canvas) {
        wu wuVar = this;
        int measuredWidth = wuVar.getMeasuredWidth();
        int measuredHeight = wuVar.getMeasuredHeight() - AndroidUtilities.dp(2.0f);
        Drawable drawable = wuVar.c;
        boolean z10 = false;
        drawable.setBounds(0, 0, measuredWidth, measuredHeight);
        drawable.draw(canvas);
        int dp = wuVar.h - AndroidUtilities.dp(9.0f);
        int measuredHeight2 = wuVar.getMeasuredHeight() - AndroidUtilities.dp(6.34f);
        int dp2 = AndroidUtilities.dp(9.0f) + wuVar.h;
        int measuredHeight3 = wuVar.getMeasuredHeight();
        Drawable drawable2 = wuVar.d;
        ...
        if (wuVar.e != null) {
            ...
            int i12 = 0;
            while (i12 < 2) {
                float d10 = (i12 == 0 ? e6Var2 : wuVar.x).d(iArr[i12], z10);
                ...
                paint.setColor(org.telegram.ui.ActionBar.j6.l1(AndroidUtilities.lerp(f7, 0.5f, max), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, e6Var)));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint);
                int i13 = 0;
                while (i13 < 5) {
                    i13++;
