...
public final class eu extends ih.s {
    public final b90 O;
    public f90 P;
    public boolean Q;
    public boolean R;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (b90Var != null) {
            ...
            if (a2 != null && motionEvent.getAction() == 0) {
                f90 f90Var = new f90(a2, null, motionEvent.getX(), motionEvent.getY(), 0);
                this.P = f90Var;
                ...
                AndroidUtilities.runOnUIThread(new vp(this, f90Var, a2), ViewConfiguration.getLongPressTimeout());
                return true;
            }
