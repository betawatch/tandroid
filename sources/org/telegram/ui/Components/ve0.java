...
public final class ve0 {
    ...
    public final ViewGroup a(Context context, int i10) {
        ...
        if (z11) {
            ...
            we0Var2.addView(textView, w7.y5.d(-1, -1.0f, i16, f7, 10.0f, f10, 0.0f));
            ...
            we0Var2.addView(textView2, w7.y5.d(-2, -2.0f, i17, f11, 35.0f, f12, 0.0f));
            ...
            we0Var2.addView(imageView, w7.y5.d(-2, -2.0f, (z15 ? 5 : 3) | 48, z15 ? 0.0f : 20.0f, 20.0f, z15 ? 20.0f : 0.0f, 0.0f));
            we0Var = we0Var2;
            if (!z12) {
                ...
                we0Var2.addView(r92, w7.y5.d(37, 40.0f, (LocaleController.isRTL ? 3 : 5) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
                we0Var = we0Var2;
            }
        } else {
            ...
            if (arrayList2.size() == 1 && arrayList.size() == 0) {
                ...
                if (userStatus == null || userStatus.expires == 0) {
                    ...
                    i11 = ((org.telegram.ui.ActionBar.f3) ye0Var).currentAccount;
            ...
            i12 = ((org.telegram.ui.ActionBar.f3) ye0Var).currentAccount;
            h9Var.m(i12, tL_userContact_old2);
            w9 w9Var = new w9(context);
            w9Var.setRoundRadius(AndroidUtilities.dp(40.0f));
            w9Var.e(tL_userContact_old2, h9Var);
            xe0Var.addView(w9Var, w7.y5.t(80, 80, 49, 0, 32, 0, 0));
            TextView textView3 = new TextView(context);
            org.telegram.messenger.wh.j(17.0f, 1, textView3);
            ...
            xe0Var.addView(textView3, w7.y5.t(-2, -2, 49, 10, 10, 10, str != null ? 0 : 27));
            we0Var = xe0Var;
            if (str != null) {
                ...
                g10.setText(str);
                xe0Var.addView(g10, w7.y5.t(-2, -2, 49, 10, 3, 10, z10 ? 27 : 11));
                we0Var = xe0Var;
            }
        }
        if (z11) {
