...
public final class ve0 implements DialogInterface.OnClickListener {
    public final /* synthetic */ af0 a;

    public ve0(af0 af0Var) {
        this.a = af0Var;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        Integer num12 = 6;
        af0 af0Var2 = this.a;
        ArrayList arrayList3 = af0Var2.M;
        ArrayList arrayList4 = af0Var2.L;
        Integer num13 = 0;
        if (i10 == 0) {
        ...
        TLRPC.TL_userContact_old2 tL_userContact_old2 = af0Var2.N;
        ...
        try {
            af0Var.r.getParentActivity().startActivity(intent3);
            af0Var.dismiss();
        } catch (Exception e) {
            FileLog.e(e);
        }
