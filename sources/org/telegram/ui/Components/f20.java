    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!z4) {
            ...
            if (this.a != null) {
                ...
                this.a.addListener(new e20(this, 0));
                this.f = NotificationCenter.getInstance(g20Var.a).setAnimationInProgress(this.f, null);
                this.a.start();
                this.b = true;
            } else {
                this.h = dp5;
        ...
        int i15 = this.n;
        g20Var.e = i15 > 0 ? AndroidUtilities.dp(40.0f) + i15 : 0;
