...
public final class i71 {
    ...
    public final void a(Canvas canvas, View view) {
        ...
        if (this.t != dp) {
            ...
            if (f25 < dp) {
                c10 = 0;
                float e7 = a4.a.e(j3, 60.0f, AndroidUtilities.dp(1.0f), f25);
                this.t = e7;
                if (e7 > dp) {
                    this.t = dp;
                }
    ...
    */
    public final void b(Canvas canvas, RectF rectF, Paint paint) {
        ...
        char c11;
        i71 i71Var = this;
        float dp = AndroidUtilities.dp(AndroidUtilities.lerp(2, 1, i71Var.y));
        ArrayList arrayList = i71Var.F;
        if (arrayList == null || arrayList.isEmpty()) {
            canvas.drawRoundRect(rectF, dp, dp, paint);
            return;
        }
        float f7 = rectF.bottom;
        float lerp = AndroidUtilities.lerp(S / 2.0f, 0.0f, i71Var.y) + i71Var.z;
        float lerp2 = AndroidUtilities.lerp(i71Var.h - (S / 2.0f), i71Var.v.getWidth() - (i71Var.z * 2.0f), i71Var.y) + i71Var.z;
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(i71Var.I * 1.0f) / 2.0f;
        if (U == null) {
            U = new Path();
        }
        U.reset();
        ...
        while (true) {
            i10 = -1;
            if (i11 >= i71Var.F.size()) {
                i11 = -1;
                break;
            } else if (((Float) ((Pair) i71Var.F.get(i11)).first).floatValue() >= dp3) {
                break;
            } else {
                i11++;
            }
        ...
        int size = i71Var.F.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) i71Var.F.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i12) {
            if (i13 == i11) {
                ...
                c10 = 1;
                floatValue = ((Float) ((Pair) i71Var.F.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i12 ? 1.0f : ((Float) ((Pair) i71Var.F.get(i13)).first).floatValue();
            while (i13 != i12 && i13 != 0 && i13 < i71Var.F.size() - 1 && ((Float) ((Pair) i71Var.F.get(i13)).first).floatValue() - floatValue <= dp3) {
                i13++;
                floatValue2 = ((Float) ((Pair) i71Var.F.get(i13)).first).floatValue();
            }
