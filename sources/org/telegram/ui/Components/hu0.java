...
public final class hu0 extends s4.v {
    ...
    public final int e(RecyclerView recyclerView, s4.c1 c1Var) {
        ...
        int l4 = s4.v.l(0, 0);
        zu0 zu0Var = this.d.x;
        return (!zu0Var.C1 || recyclerView.getAdapter() == zu0Var.S || (r10 = r(c1Var)) == null || !r10.pinned) ? l4 : s4.v.l(3, 0);
    }
    ...
    public final void p(s4.c1 c1Var, int i10) {
        ...
        ju0 ju0Var = this.d;
        kq0 kq0Var = ju0Var.n;
        if (c1Var != null && (rt0Var = ju0Var.s) != null) {
            rt0Var.e1(false);
        }
        if (i10 == 0) {
    ...
    public final SavedMessagesController.SavedDialog r(s4.c1 c1Var) {
        ...
        if (c1Var != null && (b10 = c1Var.b()) >= 0) {
            ju0 ju0Var = this.d;
            if (b10 < ju0Var.f.size()) {
                return (SavedMessagesController.SavedDialog) ju0Var.f.get(b10);
            }
        }
        return null;
    }
