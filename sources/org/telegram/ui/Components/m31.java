...
public final class m31 extends Thread {
    public final /* synthetic */ String a;
    public final /* synthetic */ String b;
    public final /* synthetic */ String c;
    public final /* synthetic */ Utilities.Callback2 d;

    public m31(String str, String str2, String str3, Utilities.Callback2 callback2) {
        this.a = str;
        this.b = str2;
        this.c = str3;
        this.d = callback2;
    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                httpURLConnection.setRequestProperty("User-Agent", w31.R[(int) Math.round(Math.random() * 5)]);
                ...
                AndroidUtilities.runOnUIThread(new br0(11, callback2, str3));
            } catch (Exception e) {
                e = e;
                try {
                ...
                if (httpURLConnection != null) {
                    try {
                        ...
                        AndroidUtilities.runOnUIThread(new kq0(callback2, 21));
                        return;
                    }
                }
                AndroidUtilities.runOnUIThread(new tr0(3, callback2, z10));
            }
        } catch (Exception e10) {
            e = e10;
