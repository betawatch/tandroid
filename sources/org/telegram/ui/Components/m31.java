...
public final class m31 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    /* JADX WARN: Type inference failed for: r3v9, types: [org.telegram.ui.Components.z21] */
    /* JADX WARN: Type inference failed for: r4v3, types: [org.telegram.ui.Components.z21] */
    public m31(Activity activity, org.telegram.ui.zn znVar, int i10, long j3, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.n = !org.telegram.messenger.q.x("topics_end_reached_", j10, UserConfig.getInstance(i10).getPreferences(), false);
        ...
        final int i11 = 0;
        a31 a31Var = new a31(this, activity, i10, new Utilities.Callback2(this) { // from class: org.telegram.ui.Components.z21
                    ...
                    case 0:
                        ...
                        if (topics != null) {
                            ...
                            while (i16 < size) {
                                ...
                                if (m31Var.e0.contains(Integer.valueOf(tL_forumTopic2.id))) {
                                    size = i18;
                                    i16 = i12;
                                } else {
                        ...
                        if (topics != null && !topics.isEmpty() && !topicsController2.endIsReached(j17) && m31Var.n) {
                    ...
                    default:
                        ...
                        if (topics2 != null) {
                            ...
                            while (i21 < size2) {
                                ...
                                if (m31Var.e0.contains(Integer.valueOf(tL_forumTopic4.id))) {
                                    chat2 = chat3;
                                    size2 = i22;
                                    user3 = user;
                                } else {
                        ...
                        if (topics2 != null && !topics2.isEmpty() && !topicsController.endIsReached(j20) && m31Var.n) {
                            int i24 = k31.a;
        ...
        this.s = a31Var;
        final int i12 = 1;
        a31Var.C1(new Utilities.Callback2(this) { // from class: org.telegram.ui.Components.z21
            public final /* synthetic */ m31 b;
        ...
        frameLayout.addView(a31Var, w7.y5.d(-1, -1.0f, 119, 41.0f, 0.0f, 0.0f, 0.0f));
        a31Var.j(new b31(this, 0));
        if (isBotForumWithEditableTopics) {
            l31 l31Var = new l31(activity, i10, e6Var);
            this.v = l31Var;
            l31Var.c(true, false, this.V == 0);
            final int i13 = 2;
            l31Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.v21
                public final /* synthetic */ m31 b;
            ...
            viewGroup.addView(l31Var, w7.y5.d(64, 42.0f, 51, 0.0f, 48.0f, 0.0f, 0.0f));
        } else {
            viewGroup = frameLayout2;
            this.v = null;
        }
        ...
        c31 c31Var = new c31(activity, i10, new Utilities.Callback2(this) { // from class: org.telegram.ui.Components.z21
            public final /* synthetic */ m31 b;
        ...
        this.G = c31Var;
        final int i15 = 1;
        c31Var.C1(new Utilities.Callback2(this) { // from class: org.telegram.ui.Components.z21
            public final /* synthetic */ m31 b;
        ...
        viewGroup2.addView(c31Var, w7.y5.d(-1, -1.0f, 119, 0.0f, isBotForumWithEditableTopics ? 90.0f : 48.0f, 0.0f, 0.0f));
        c31Var.j(new b31(this, 1));
        final int i16 = 0;
        ImageView i17 = i(activity, R.drawable.menu_sidebar_left, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.v21
            public final /* synthetic */ m31 b;
        ...
        this.y = i17;
        final int i18 = 0;
        ImageView i19 = i(activity, R.drawable.menu_sidebar_left, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.v21
            public final /* synthetic */ m31 b;
        ...
        final int i20 = 1;
        ImageView i21 = i(activity, R.drawable.msg_select, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.v21
            public final /* synthetic */ m31 b;
        ...
        this.w = i21;
        final int i22 = 1;
        ImageView i23 = i(activity, R.drawable.msg_select, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.v21
            public final /* synthetic */ m31 b;
        ...
        this.P = x10;
        i19.setImageResource(x10 ? R.drawable.menu_sidebar_top : R.drawable.menu_sidebar_bottom);
        f(false);
        g();
        n();
        o();
    ...
    public static void a(m31 m31Var, x51 x51Var) {
        if (m31Var.e) {
            Utilities.Callback2 callback2 = m31Var.c0;
            if (callback2 != null) {
        ...
        Utilities.Callback2 callback22 = m31Var.a0;
        if (callback22 != null) {
    ...
    public static void b(m31 m31Var, ArrayList arrayList) {
        long j3 = m31Var.c;
        TopicsController topicsController = MessagesController.getInstance(m31Var.b).getTopicsController();
    ...
    public static boolean c(final m31 m31Var, x51 x51Var, View view) {
        ...
        if (ChatObject.isMonoForum(chat)) {
            ...
            if (user2 == null || !ChatObject.canBlockUsers(chat3)) {
                ...
                y3.setVisibility(8);
                w70Var2 = I;
                MessagesController.getInstance(i12).checkIsInChat(true, chat3, user2, new s21(m31Var, y3, I, j10, user2, chat3));
            }
            w70Var = w70Var2;
            e6Var = e6Var2;
            r62 = 1;
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                ...
                I.c(z11 ? R.drawable.msg_unpin : R.drawable.msg_pin, LocaleController.getString(z11 ? R.string.DialogUnpin : R.string.DialogPin), new wn0(m31Var, I, messagesController, tL_forumTopic), false);
                if (tL_forumTopic.pinned) {
                    I.c(R.drawable.tabs_reorder, LocaleController.getString(R.string.FilterReorder), new t21(m31Var, i13), false);
                }
            }
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(m31Var) { // from class: org.telegram.ui.Components.u21
                    public final /* synthetic */ m31 b;
                    ...
                    public final void run() {
                        ...
                        switch (i14) {
                            case 0:
                                w70Var3.u();
                                m31Var2.h.presentFragment(ze1.a0(-m31Var2.c, tL_forumTopic2.id));
                                break;
                            case 1:
                                m31Var2.getClass();
                                w70Var3.u();
                                MessagesController.getInstance(m31Var2.b).getTopicsController().toggleCloseTopic(-m31Var2.c, tL_forumTopic2.id, true ^ tL_forumTopic2.closed);
                                break;
                            default:
                                w70Var3.u();
                                ...
                                if (hashSet.size() == 1) {
                                    z12 = false;
                                    b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, MessagesController.getInstance(m31Var3.b).getTopicsController().findTopic(-m31Var3.c, ((Integer) arrayList.get(0)).intValue()).title);
                                } else {
                                    z12 = false;
            ...
            b10 = 0;
            w70Var = I;
            w70Var.c(isDialogMuted ? R.drawable.msg_unmute : R.drawable.msg_mute, LocaleController.getString(isDialogMuted ? R.string.Unmute : R.string.Mute), new ai.m3(m31Var, messagesController, tL_forumTopic, I, J, 25), false);
            if (!ChatObject.canManageTopic(i12, chat4, tL_forumTopic) || UserObject.isBotForum(user)) {
                ...
                w70Var.c(i14, string, new Runnable(m31Var) { // from class: org.telegram.ui.Components.u21
                    public final /* synthetic */ m31 b;
            ...
            if (ChatObject.canDeleteTopic(i12, chat4, tL_forumTopic)) {
                w70Var.c(R.drawable.msg_delete, LocaleController.getPluralString("DeleteTopics", z10 ? 1 : 0), new Runnable(m31Var) { // from class: org.telegram.ui.Components.u21
                    public final /* synthetic */ m31 b;
    ...
    public i31 getCurrentTabsPosition() {
        return this.Q ? i31.b : this.P ? i31.c : i31.a;
    }
    ...
    public final void h() {
        ...
        if (this.P) {
            frameLayout.setTranslationY(((getMeasuredHeight() - AndroidUtilities.dp(50.0f)) - this.M) + AndroidUtilities.lerp(AndroidUtilities.dp(43.0f), 0, j(i31.c)));
        } else {
            frameLayout.setTranslationY(this.N + AndroidUtilities.lerp(-AndroidUtilities.dp(43.0f), 0, j(i31.a)));
        }
    }
    ...
    public final float j(i31 i31Var) {
        ...
        if (i31Var == i31.b) {
            ...
            if ((i31Var != i31.a || this.P) && !(i31Var == i31.c && this.P)) {
                return 0.0f;
            }
            f7 = 1.0f - this.R;
        }
    ...
    public final boolean k() {
        if (this.R <= 0.5f) {
            ...
            while (true) {
                ...
                x51 G = a31Var.Y2.G(RecyclerView.S(a31Var.getChildAt(i10)));
                if (G != null && G.r) {
                    return true;
                }
                i10++;
            ...
            while (true) {
                c31 c31Var = this.G;
                if (i11 >= c31Var.getChildCount()) {
                    break;
                }
                x51 G2 = c31Var.Y2.G(RecyclerView.S(c31Var.getChildAt(i11)));
                if (G2 != null && G2.r) {
                    return true;
                }
                i11++;
    ...
    public final void n() {
        ...
        int d = i0.a.d(1.0f - this.R, v02, org.telegram.ui.ActionBar.j6.v0(i11, e6Var));
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.y.setColorFilter(new PorterDuffColorFilter(d, mode));
        this.E.setColorFilter(new PorterDuffColorFilter(i0.a.d(this.R, org.telegram.ui.ActionBar.j6.v0(i10, e6Var), org.telegram.ui.ActionBar.j6.v0(i11, e6Var)), mode));
        this.w.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, e6Var), mode));
        this.x.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, e6Var), mode));
        invalidate();
    }
