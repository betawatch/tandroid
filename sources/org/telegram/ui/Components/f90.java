            ...
            if (this.u) {
                ...
                if (i41 != 2) {
                    if (f10 <= 0.5f) {
                        ...
                        float z11 = com.google.android.recaptcha.internal.a.z(dp7, dp, f12, dp);
                        if (f43 > 0.0f) {
                ...
                float z12 = com.google.android.recaptcha.internal.a.z(dp, dp5, f11, dp5);
                float z13 = com.google.android.recaptcha.internal.a.z(dp7, dp6, f11, dp6);
                float f49 = centerX3;
                float dp12 = f49 - ((AndroidUtilities.dp(8.0f) * f10) * this.h);
                dp3 = f49 + (AndroidUtilities.dp(8.0f) * f10 * this.h);
                dp7 = z13 - ((AndroidUtilities.dp(8.0f) * f10) * this.h);
                dp5 = z12;
                dp2 = dp12;
                dp6 = z13;
            } else {
                            ...
                            if (this.p == 15) {
                                ...
                                if (i21 != 0 || i21 == 1 || (i30 = this.q) == 0 || i30 == 1) {
                                    if ((i21 == 0 || this.q != 1) && !(i21 == 1 && this.q == 0)) {
                                        ...
                                        a(true);
                                        canvas2.save();
                                        canvas2.translate(com.google.android.recaptcha.internal.a.z(1.0f, f20, AndroidUtilities.dp(1.0f), rect.centerX()), rect.centerY());
                                        f21 = f20 * 500.0f;
                                        i24 = this.p;
                                        f22 = i24 != 1 ? 90.0f : 0.0f;
                                        if (i24 == 0 || this.q != 1) {
                                            interpolation = (i24 == 1 || this.q != 0) ? f22 : f21 < 100.0f ? er.j.getInterpolation(f21 / 100.0f) * (-5.0f) : f21 < 484.0f ? (er.j.getInterpolation((f21 - 100.0f) / 384.0f) * 95.0f) - 5.0f : 90.0f;
                                        } else {
                                            interpolation = f21 < 384.0f ? er.j.getInterpolation(f21 / 384.0f) * 95.0f : f21 < 484.0f ? 95.0f - (er.j.getInterpolation((f21 - 384.0f) / 100.0f) * f17) : 90.0f;
                                            f21 += 100.0f;
                                        }
                                        ...
                                        org.telegram.ui.ActionBar.g6.x3.b(canvas2, paint2, f21);
