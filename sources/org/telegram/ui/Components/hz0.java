...
public final class hz0 {
    ...
    public final void a(Canvas canvas, View view, boolean z4) {
        ...
        boolean z12 = i13 == i14;
        boolean z13 = this.q + this.l == oz0Var.B;
        int dp = AndroidUtilities.dp(8.0f);
        boolean z14 = this.c.header;
        if (z14 || (oz0Var.E && this.a.a.b.a % 2 == 0)) {
            int i15 = this.p;
            if (i15 == 0 && this.q == 0) {
                float f10 = dp;
                fArr[1] = f10;
            ...
            if (z11) {
                ...
                canvas2.drawRect(i15, this.q, i15 + this.k, r4 + this.l, nz0Var.getHeaderPaint());
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.drawRect(i15, this.q, this.k + i15, r1 + this.l, nz0Var.getStripPaint());
            }
        }
        if (z4 && this.b != null) {
            canvas2.save();
            canvas2.translate(b(), c());
            if (this.r >= 0 && (m9Var = oz0Var.a) != null) {
                m9Var.a0(canvas2, (org.telegram.ui.Cells.l9) oz0Var.getParent().getParent(), this.r);
            }
    ...
    */
    public final void d(int i10, int i11, boolean z4) {
        ...
        if (this.c != null) {
            gz0 gz0Var = this.b;
            if (gz0Var != null) {
                Layout layout = gz0Var.getLayout();
                ...
                if (!z4) {
                    ...
                    oz0 oz0Var = this.s;
                    e(oz0Var.L.createTextLayout(this.c, this.k - (oz0Var.v * 2)));
                    this.m = this.f + oz0Var.r + oz0Var.s;
                }
                f();
            }
            g();
    ...
    public final void e(gz0 gz0Var) {
        this.b = gz0Var;
        Layout layout = gz0Var != null ? gz0Var.getLayout() : null;
        int i10 = 0;
        if (layout == null) {
            this.i = 0;
            this.e = 0;
    ...
    public final void f() {
        ...
        oz0 oz0Var = this.s;
        if (z4) {
            this.g = ((this.k - this.e) - oz0Var.v) + i10;
