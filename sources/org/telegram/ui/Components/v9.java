...
public final class v9 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a(boolean z10) {
        ...
        if (z10) {
            ...
            this.h.playTogether(ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property3, 0.1f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property2, 0.1f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property, 0.0f), ObjectAnimator.ofFloat(d2Var2, (Property<fh.d2, Float>) property3, 1.0f), ObjectAnimator.ofFloat(d2Var2, (Property<fh.d2, Float>) property2, 1.0f), ObjectAnimator.ofFloat(d2Var2, (Property<fh.d2, Float>) property, 1.0f));
        } else {
            textView.setVisibility(0);
            d2Var.setEnabled(true);
            this.h.playTogether(ObjectAnimator.ofFloat(d2Var2, (Property<fh.d2, Float>) property3, 0.1f), ObjectAnimator.ofFloat(d2Var2, (Property<fh.d2, Float>) property2, 0.1f), ObjectAnimator.ofFloat(d2Var2, (Property<fh.d2, Float>) property, 0.0f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property3, 1.0f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property2, 1.0f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property, 1.0f));
        }
        this.h.addListener(new u9(i9, this, z10));
