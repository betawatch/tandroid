...
public final class zz {
            ...
            if (h11 != 0 && h12 != 0) {
                ...
                if (xzVar.a() && j()) {
                    ...
                    if (h13 != 0 && h14 != 0) {
                        ...
                        GLES20.glAttachShader(this.o0, h14);
                        ...
                        if (h15 != 0 && h16 != 0) {
                            ...
                            GLES20.glAttachShader(this.y0, h16);
                            ...
                            if (h17 != 0 && h18 != 0) {
                                ...
                                if (h20 != 0 && h19 != 0) {
                                    ...
                                    GLES20.glAttachShader(this.p, h19);
                                    ...
                                    if (h22 != 0 && h21 != 0) {
                                        ...
                                        float[] g10 = o0.b.g(arrayList2);
                                        float[] g11 = o0.b.g(arrayList);
                                        ...
                                        if (g11.length >= 256 && g11.length >= 256 && g11.length >= 256 && g10.length >= 256) {
                                            for (int i10 = 0; i10 < 256; i10++) {
                                                float f7 = i10;
                                                int min = (int) Math.min(Math.max(g11[i10] + f7, 0.0f), 255.0f);
                                                int min2 = (int) Math.min(Math.max(g11[i10] + f7, 0.0f), 255.0f);
                                                int min3 = (int) Math.min(Math.max(f7 + g11[i10], 0.0f), 255.0f);
                                                allocateDirect.put((byte) Math.min(Math.max(min3 + g10[min3], 0.0f), 255.0f));
                                                allocateDirect.put((byte) Math.min(Math.max(min2 + g10[min2], 0.0f), 255.0f));
                                                allocateDirect.put((byte) Math.min(Math.max(min + g10[min], 0.0f), 255.0f));
    ...
    public final void c() {
        ...
        if (yzVar == null || yzVar.b()) {
            ...
            boolean c10 = this.f1.c();
            GLES20.glUniform1f(this.i0, c10 ? 0.0f : 1.0f);
            if (c10) {
    ...
    public final void d() {
        ...
        if (z11) {
            ...
            GLES20.glVertexAttribPointer(iArr4[c10], 2, 5126, false, 8, (Buffer) this.a1);
            int[] iArr5 = this.I;
            GLES20.glEnableVertexAttribArray(iArr5[c10]);
            GLES20.glVertexAttribPointer(iArr5[c10], 2, 5126, false, 8, (Buffer) (z10 ? this.b1 : this.Z0));
    ...
    public final void f() {
        ...
        if (z10 || z11) {
            float f7 = i10 * 0.006f;
            if (this.e == null || Math.abs(this.f - f7) > 1.0E-4d) {
                xz xzVar = this.e;
    ...
    public final boolean j() {
        ...
        boolean z11 = this.g1;
        String str2 = z11 ? "#extension GL_OES_EGL_image_external : require" : "";
        String str3 = z11 ? "samplerExternalOES" : "sampler2D";
        int[] iArr = new int[1];
        int i12 = 0;
        while (true) {
            int i13 = a2;
            ...
            if (i12 >= (z11 ? 2 : 1)) {
                ...
                if (z12) {
                    ...
                    if (i10 == 0 && i11 != 0) {
                        ...
                        GLES20.glAttachShader(glCreateProgram2, h11);
                        GLES20.glAttachShader(this.u, h12);
            ...
            GLES20.glAttachShader(iArr2[i12], h14);
