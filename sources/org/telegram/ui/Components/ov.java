...
public final class ov extends FrameLayout {
    ...
    public ov(tv tvVar, Context context, boolean z10) {
        ...
        if (z10) {
            ...
            textView.setBackground(org.telegram.ui.ActionBar.w5.e(new float[]{14.0f}, tvVar.getThemedColor(i15)));
        ...
        n90Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(i16, d6Var2));
        n90Var.setTextColor(tvVar.getThemedColor(org.telegram.ui.ActionBar.h6.j5));
        if (z10) {
        ...
        if (z10) {
            ...
            final int i17 = 3;
            u0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.lv
                public final /* synthetic */ ov b;
