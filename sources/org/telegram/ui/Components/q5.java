                                ...
                                if (str2 != null) {
                                    ...
                                    if (z11 || !(s || i11 == 14)) {
                                        ...
                                        if ("video/webm".equals(this.e.mime_type)) {
                                            ...
                                            ai.l4 l4Var3 = this.k;
                                            String v9 = t8.b.v(str4, "_firstframe");
                                            TLRPC.Document document4 = this.e;
                                            l4Var3.setImage(imageLocation3, v9, forDocument2, null, drawable, document4.size, null, document4, 1);
                                        } else {
                                            ai.l4 l4Var4 = this.k;
