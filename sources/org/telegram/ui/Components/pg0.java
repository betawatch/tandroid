    ...
    public final void draw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f7 < 1.0f) {
                ...
                float interpolation = f11 >= 100.0f ? wr.j.getInterpolation(f11 / 100.0f) * (-5.0f) : f11 < 484.0f ? (wr.j.getInterpolation((f11 - 100.0f) / 384.0f) * 95.0f) - 5.0f : 90.0f;
                int i11 = this.b;
                canvas2.scale((i11 * 1.45f) / AndroidUtilities.dp(28.0f), (i11 * 1.5f) / AndroidUtilities.dp(28.0f));
                canvas2.rotate(interpolation);
                ie0Var = org.telegram.ui.ActionBar.j6.x3;
                if (ie0Var != null) {
                    Paint paint = this.a;
                    ie0Var.b(canvas2, paint, f11);
