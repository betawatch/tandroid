                ...
                if (i16 == 0) {
                    if (this.useLinkPaintColor && (paint instanceof TextPaint)) {
                        ...
                        if (this.usePaintColor) {
                            ...
                            if (i15 != 1) {
                                if (i15 == 2) {
                                    int d = l.d.d(i14, i12, 2, i12);
                                    Drawable drawable2 = this.drawable;
                                    i17 = d - (drawable2 != null ? drawable2.getBounds().height() / 2 : 0);
                                } else if (i15 == 0) {
                                    int i18 = i14 - i12;
                                    int i19 = this.size;
                                    if (i19 == 0) {
                                    ...
                                    i17 = l.d.d(i18, i19, 2, i12) + AndroidUtilities.dp(this.topOffset);
                                }
                            }
                        ...
                        i16 = org.telegram.ui.ActionBar.k6.w0(null, this.colorKey, false);
                    }
                }
                z4 = false;
                if (this.drawableColor != i16) {
