...
public final class c9 extends org.telegram.ui.ActionBar.o2 {
    ...
    public final View createView(Context context) {
        ...
        int k10 = i0.a.k(-1, 60);
        this.H.B(-1, false);
        hg.k0.x(false, this.H);
        this.H.setAllowOverlayTitle(false);
        this.H.A(k10, false);
        org.telegram.ui.ActionBar.a0 n10 = this.H.n();
        n10.setClipChildren(false);
        s40 s40Var = this.T;
        org.telegram.ui.ActionBar.w0 e = n10.e(1, (s40Var == null || s40Var.c != 2) ? LocaleController.getString(R.string.SetPhoto) : LocaleController.getString(R.string.SuggestPhoto));
        this.R = e;
        ...
        u8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.a7, false));
        ...
        this.J = z8Var;
        v7Var.addView(z8Var);
        this.r.addView(v7Var, w7.x5.t(-1, 48, 0, 12, 0, 12, 0));
        ...
        this.r.setClipChildren(false);
        u8Var.addView(this.r, w7.x5.d(-1, -1.0f, 0, 0.0f, 0.0f, 0.0f, 64.0f));
        ...
        u8Var.addView(this.x, w7.x5.d(-1, 48.0f, 80, 16.0f, 16.0f, 16.0f, 16.0f));
        u8Var.addView(this.y, w7.x5.d(-1, 80.0f, 80, 8.0f, 16.0f, 8.0f, 64.0f));
    ...
    public final boolean e0() {
        ...
        v8 v8Var = this.a;
        y8 y8Var = v8Var.h;
        return (y8Var != null && y8Var.b) || v8Var.n;
    }
    ...
    */
    public final void f0() {
        ...
        int i11 = 1;
        if (e0()) {
            new vc(this.y, this.resourceProvider).Q(R.raw.star_premium_2, 36, AndroidUtilities.premiumText(LocaleController.getString(R.string.PremiumAvatarToast), new n8(this, i11))).j();
            return;
        }
        mf mfVar = this.I;
        if (mfVar != null) {
            ...
            y8 y8Var = v8Var.h;
            long j3 = v8Var.a;
            TLRPC.Document document2 = v8Var.b;
            ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = (ChatAttachAlertPhotoLayout) mfVar.b;
            c9 c9Var = (c9) mfVar.c;
            ...
            o20 o20Var = new o20();
            if (y8Var != null) {
                o20Var.d(y8Var.c, y8Var.d, y8Var.e, y8Var.f);
            } else {
                int[] iArr = c0[0];
            ...
            try {
                ...
                int i13 = (int) 560.0f;
                imageReceiver = v8Var.getImageReceiver();
                ...
                if (v8Var.getImageReceiver().getAnimation() == null) {
                }
                ...
                videoEditedInfo2.endTime = v8Var.getDuration();
            ...
            if (v8Var.getImageReceiver().getAnimation() == null || v8Var.getImageReceiver().getLottieAnimation() != null) {
                photoEntry = new MediaController.PhotoEntry(0, 0, 0L, file2.getPath(), 0, false, 0, 0, 0L);
                photoEntry.thumbPath = file.getPath();
                if (v8Var.a == 0) {
                    TLRPC.TL_videoSizeEmojiMarkup tL_videoSizeEmojiMarkup = new TLRPC.TL_videoSizeEmojiMarkup();
                    tL_videoSizeEmojiMarkup.emoji_id = v8Var.a;
                    tL_videoSizeEmojiMarkup.background_colors.add(Integer.valueOf(v8Var.h.c));
                    int i14 = v8Var.h.d;
                    if (i14 != 0) {
                    ...
                    tL_videoSizeStickerMarkup.background_colors.add(Integer.valueOf(v8Var.h.c));
                    int i17 = v8Var.h.d;
                    if (i17 != 0) {
                ...
                videoEditedInfo22.endTime = v8Var.getDuration();
                ...
                f7 = document != null ? o5.f(UserConfig.selectedAccount, j3) : document;
                if (f7 != null) {
            ...
            viVar.Z1.B1(7, true, false, 0, 0, 0L, viVar.s1(), false, 0L);
            if (!c9Var.Q) {
    ...
    */
    public final boolean isLightStatusBar() {
        boolean z10;
        v8 v8Var = this.a;
        if (v8Var != null && (v8Var.v || (v8Var.w >= 0.0f && v8Var.h != null))) {
            y8 y8Var = v8Var.h;
            int i10 = y8Var.c;
            int i11 = y8Var.d;
            if (i11 != 0) {
        ...
        if (this.Z != z10) {
            ...
            if (this.actionBar.getAlpha() == 0.0f) {
                ...
                this.b0 = ofFloat;
                ofFloat.addUpdateListener(new i6(this, 3));
                this.b0.setDuration(150L).start();
            }
        }
        q8 q8Var = this.S;
        if (q8Var != null) {
            AndroidUtilities.setLightStatusBar(q8Var, z10);
        }
        return z10;
    }
    ...
    public final void k0(long j3) {
        ...
        v8 v8Var2 = this.a;
        v8Var2.a = j3;
        v8Var2.c.setAnimatedEmojiDrawable(new o5(14, this.currentAccount, j3));
        this.J.x1(y8Var);
    ...
    public final void l0(TLRPC.VideoSize videoSize) {
        y8 y8Var = new y8();
        y8Var.c = i0.a.k(videoSize.background_colors.get(0).intValue(), 255);
        y8Var.d = videoSize.background_colors.size() > 1 ? i0.a.k(videoSize.background_colors.get(1).intValue(), 255) : 0;
        y8Var.e = videoSize.background_colors.size() > 2 ? i0.a.k(videoSize.background_colors.get(2).intValue(), 255) : 0;
        y8Var.f = videoSize.background_colors.size() > 3 ? i0.a.k(videoSize.background_colors.get(3).intValue(), 255) : 0;
        this.a.b(y8Var, false);
        n0();
    ...
    public final void m0(e9 e9Var) {
        ...
        if (e9Var.getAnimatedEmoji() != null) {
            ...
            v8 v8Var2 = this.a;
            v8Var2.a = i10;
            v8Var2.c.setAnimatedEmojiDrawable(new o5(14, this.currentAccount, i10));
        }
