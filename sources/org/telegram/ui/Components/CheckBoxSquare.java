...
public class CheckBoxSquare extends View {
    ...
    public CheckBoxSquare(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        ...
        boolean z10 = this.r;
        this.s = z10 ? org.telegram.ui.ActionBar.j6.y5 : org.telegram.ui.ActionBar.j6.Y6;
        this.v = z10 ? org.telegram.ui.ActionBar.j6.w5 : org.telegram.ui.ActionBar.j6.W6;
        this.w = z10 ? org.telegram.ui.ActionBar.j6.x5 : org.telegram.ui.ActionBar.j6.X6;
        this.a = new RectF();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f12 <= 0.5f) {
            f11 = f12 / 0.5f;
            org.telegram.ui.ActionBar.j6.p0.setColor(Color.rgb(Color.red(v02) + ((int) ((Color.red(v03) - Color.red(v02)) * f11)), Color.green(v02) + ((int) ((Color.green(v03) - Color.green(v02)) * f11)), Color.blue(v02) + ((int) ((Color.blue(v03) - Color.blue(v02)) * f11))));
            f10 = f11;
        } else {
        ...
        if (this.d > 0.5f) {
            ...
            float f13 = 1.0f - f10;
            canvas2.drawLine(AndroidUtilities.dp(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dp(7.0f) - (AndroidUtilities.dp(3.0f) * f13)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.dp(3.0f) * f13)), org.telegram.ui.ActionBar.j6.o0);
            canvas2.drawLine((int) AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) ((AndroidUtilities.dp(7.0f) * f13) + AndroidUtilities.dpf2(7.0f)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.dp(7.0f) * f13)), org.telegram.ui.ActionBar.j6.o0);
        }
