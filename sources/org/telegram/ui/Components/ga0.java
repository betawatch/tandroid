...
public final class ga0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ga0(int i10, Context context, org.telegram.ui.ActionBar.c6 c6Var, ArrayList arrayList, int i11) {
        ...
        if (arrayList.size() > 1) {
            ...
            for (int i12 = 0; k41VarArr != null && i12 < k41VarArr.length; i12++) {
                int spanStart = replaceTags.getSpanStart(k41VarArr[i12]);
                int spanEnd = replaceTags.getSpanEnd(k41VarArr[i12]);
                replaceTags.removeSpan(k41VarArr[i12]);
                replaceTags.setSpan(new fa0(0, this), spanStart, spanEnd, 33);
            }
            return;
        }
        if (arrayList.size() != 1) {
        ...
        if (str == null || document == null) {
            ...
            this.f = t80Var;
            t80Var.l = org.telegram.ui.ActionBar.g6.G8;
            t80Var.m = org.telegram.ui.ActionBar.g6.i6;
            t80Var.j(4.0f);
            return;
        }
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        this.H = ofFloat;
        ofFloat.addUpdateListener(new ig.y(8, this, z10));
