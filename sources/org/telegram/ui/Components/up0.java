...
public final /* synthetic */ class up0 implements Runnable {
    ...
    public /* synthetic */ up0(Object obj, int i10) {
        this.a = i10;
        this.b = obj;
    }
    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                org.telegram.ui.ActionBar.n2 n2Var = ((ps0) obj).f.r1;
                if (n2Var != null) {
            ...
            case 5:
                ...
                if (qt0Var.h) {
                    ...
                    qt0Var.x.r1.getMessagesController().getSavedMessagesController().updatePinnedOrder(arrayList4);
                    break;
                }
                break;
            case 6:
            ...
            case 11:
                ...
                wx0Var.B = null;
                ux0 ux0Var = wx0Var.c;
                if (ux0Var != null && ux0Var.getEditField() != null && wx0Var.c.getFieldText() != null) {
                    int selectionStart = wx0Var.c.getEditField().getSelectionStart();
                    int selectionEnd = wx0Var.c.getEditField().getSelectionEnd();
                    if (selectionStart != selectionEnd) {
                        ...
                        CharSequence fieldText = wx0Var.c.getFieldText();
                        ...
                        if (emojiSpanArr == null || emojiSpanArr.length <= 0 || !SharedConfig.suggestAnimatedEmoji || !UserConfig.getInstance(i12).isPremium()) {
                            ...
                            if ((t5VarArr == null || t5VarArr.length == 0) && selectionEnd < 52) {
                                ...
                                if (substring != null) {
                                    String str = wx0Var.D;
                                    if (str == null || wx0Var.C != 1 || !str.equals(substring) || wx0Var.x || (arrayList = wx0Var.w) == null || arrayList.isEmpty()) {
                                        int i13 = wx0Var.E + 1;
                                        wx0Var.E = i13;
                                        long currentTimeMillis = System.currentTimeMillis();
                                        if (wx0Var.F == null || Math.abs(currentTimeMillis - wx0Var.H) > 360) {
                                            wx0Var.H = currentTimeMillis;
                                        ...
                                        wx0Var.G = new ag.k0(wx0Var, currentKeyboardLanguage, substring, i13, 26);
                                        ArrayList arrayList5 = wx0Var.w;
                            ...
                            if (emojiSpan != null) {
                                ...
                                if (selectionStart == spanEnd) {
                                    ...
                                    if (substring2 != null) {
                                        ...
                                        if (str2 == null || wx0Var.C != 2 || !str2.equals(substring2) || wx0Var.x || (arrayList2 = wx0Var.w) == null || arrayList2.isEmpty()) {
                                            int i14 = wx0Var.E + 1;
                                            wx0Var.E = i14;
                                            ...
                                            wx0Var.G = new km(wx0Var, substring2, i14, 21);
                                            ArrayList arrayList6 = wx0Var.w;
            ...
            case 14:
                ...
                break;
            case 15:
                ArrayList arrayList7 = ((c01) obj).a;
            ...
            case 16:
                b11 b11Var = (b11) obj;
                b11Var.F = null;
                b11Var.D.animate().scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(er.f).start();
                break;
            case 17:
                g11 g11Var = (g11) obj;
            ...
            case 18:
                i11 i11Var = (i11) obj;
                Utilities.Callback callback = i11Var.b;
                if (callback != null) {
                    callback.run(Long.valueOf(i11Var.a.s));
                    break;
                }
                break;
            case 19:
                d21 d21Var = ((u11) obj).b;
                if (d21Var.k()) {
                    d21Var.l();
                    break;
                }
            ...
            case 22:
                ...
                break;
            case 23:
                ((l31) obj).c.setVisibility(8);
                break;
            case 24:
                ((org.telegram.ui.pk) obj).c.presentFragment(new org.telegram.ui.a31());
                break;
            case 25:
