...
public final class ne extends FrameLayout {
    ...
    public final boolean drawChild(final Canvas canvas, final View view, final long j3) {
        ...
        if (view != null && view == chatActivityEnterView.E0) {
            return chatActivityEnterView.f0(canvas, new Utilities.Callback0Return() { // from class: org.telegram.ui.Components.me
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (f7 != null) {
                ...
                childAt.animate().translationX(0.0f).setDuration(150L).setInterpolator(rr.f).start();
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ChatActivityEnterView chatActivityEnterView = this.a;
        le.f fVar = chatActivityEnterView.f5;
        if (fVar.e > 0.0f) {
            fVar.a(max);
        } else {
            fVar.c(max);
