...
public abstract class xw0 extends ml0 {
    public static final vw0 x3 = new vw0();
    public static final ww0 y3 = new ww0();
    public float X2;
    public tw0[] Y2;
    public final ow0 Z2;
    public final c6 a3;
    ...
    public static void A1(RectF rectF, View view) {
        ...
        if (view instanceof sw0) {
            sw0 sw0Var = (sw0) view;
            f7 = com.google.android.gms.internal.vision.e2.z(1.0f, sw0Var.E, 0.15f, 0.85f) * sw0Var.y;
        }
        float f10 = width * f7;
    ...
    public static void y1(xw0 xw0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j3) {
        ...
        xw0Var.H1(xw0Var.q3, System.currentTimeMillis() - j3 > 16);
    }
    ...
    public void F1(int i10) {
        ...
        for (int i11 = 0; i11 < getChildCount(); i11++) {
            ...
            if (childAt instanceof sw0) {
                ((sw0) childAt).l(this.m3 == RecyclerView.S(childAt) - 1, true);
            }
        }
        invalidate();
    }
    ...
    */
    ...
    public tw0 getSelectedCategory() {
        int i10;
        tw0[] tw0VarArr = this.Y2;
        if (tw0VarArr == null || (i10 = this.m3) < 0 || i10 >= tw0VarArr.length) {
            return null;
        }
