...
public abstract class xw0 extends sl0 {
    ...
    public xw0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.l3 = 0.0f;
        this.n3 = true;
        this.o3 = new z5(this, 350L, nrVar);
        this.p3 = new z5(this, 350L, nrVar);
        this.q3 = new RectF();
        this.r3 = new RectF();
        this.s3 = new RectF();
    ...
    public static void x1(xw0 xw0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j10) {
        ...
        xw0Var.G1(xw0Var.n3, System.currentTimeMillis() - j10 > 16);
    }
    ...
    public final void G1(boolean z4, boolean z10) {
        ...
        this.m3.addListener(new nd0(this, 15));
        this.m3.setInterpolator(nr.h);
