...
public final class dk0 extends FrameLayout {
    ...
    public static void a(dk0 dk0Var, zg.p0 p0Var, int i10) {
        ...
        int i11 = fk0Var.J;
        org.telegram.ui.ActionBar.e6 e6Var = fk0Var.k0;
        int i12 = fk0Var.M0;
        ...
        rg.b1 b1Var2 = dk0Var.f;
        if (b1Var2 != null) {
            b1Var2.setVisibility(dk0Var.H ? 0 : 8);
        }
        dk0Var.d();
        dk0Var.e = p0Var;
        dk0Var.r = p0Var.a || (p0Var.f != null && ((fk0Var.q() || fk0Var.G0) && LiteMode.isEnabled(LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS)));
        if (i12 == 4 || dk0Var.e.b) {
            dk0Var.r = false;
        }
        ...
        if (p0Var3.a || p0Var3.f != null) {
            ...
            o5 o5Var = new o5(4, fk0Var.J, dk0Var.e.g);
            o5 o5Var2 = new o5(3, fk0Var.J, dk0Var.e.g);
            if (i12 == 1 || i12 == 2 || i12 == 4) {
                PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
                o5Var.setColorFilter(new PorterDuffColorFilter(-1, mode));
                o5Var2.setColorFilter(new PorterDuffColorFilter(-1, mode));
            } else {
                int i13 = org.telegram.ui.ActionBar.i6.v6;
                int v02 = org.telegram.ui.ActionBar.i6.v0(i13, e6Var);
                PorterDuff.Mode mode2 = PorterDuff.Mode.SRC_IN;
                o5Var.setColorFilter(new PorterDuffColorFilter(v02, mode2));
                o5Var2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i13, e6Var), mode2));
            }
            ck0Var.setAnimatedEmojiDrawable(o5Var);
            ck0Var3.setAnimatedEmojiDrawable(o5Var2);
            rg.b1 b1Var4 = dk0Var.f;
            if (b1Var4 != null) {
                b1Var4.setAnimatedEmojiDrawable(o5Var2);
            }
        }
    ...
    public final void b() {
        ck0 ck0Var = this.b;
        o5 o5Var = ck0Var.e;
        ImageReceiver imageReceiver = o5Var != null ? o5Var.k : ck0Var.a;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.w && this.x) {
            ...
            zg.p0 p0Var = this.e;
            fk0 fk0Var = this.P;
            canvas.drawCircle(measuredWidth, measuredHeight, measuredWidth2, (p0Var == null || !p0Var.a) ? fk0Var.H0 : fk0Var.I0);
        }
        o5 o5Var = this.b.e;
    ...
    public final void e(zg.p0 p0Var) {
        ...
        if (i10 == 4 && p0Var != null && p0Var.f != null) {
            ck0Var.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(p0Var.f));
            ck0Var2.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(p0Var.f));
            return;
        }
        zg.p0 p0Var2 = this.e;
        if (p0Var2.b) {
            TLRPC.Document effectDocument = MessagesController.getInstance(fk0Var.J).getEffectDocument(this.e.g);
            ck0Var2.getImageReceiver().setImage(ImageLocation.getForDocument(effectDocument), "60_60_firstframe", null, null, this.r ? null : DocumentObject.getSvgThumb(effectDocument, org.telegram.ui.ActionBar.i6.m6, 0.2f), 0L, "tgs", this.e, 0);
            return;
        }
        if (p0Var2.f != null) {
            ...
            if (tL_availableReaction2 != null) {
                ...
                if (!LiteMode.isEnabled(LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS) || i10 == 4) {
                    ...
                    if (SharedConfig.getDevicePerformanceClass() <= 0 || i10 == 4) {
                        ...
                        ck0Var.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.appear_animation), "30_30_nolimit", null, null, svgThumb, 0L, "tgs", p0Var, 0);
                        ck0Var2.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_firstframe", null, null, this.r ? null : svgThumb, 0L, "tgs", this.e, 0);
                    }
                } else {
                    tL_availableReaction = tL_availableReaction2;
                    ck0Var.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction2.appear_animation), "30_30_nolimit", null, null, svgThumb, 0L, "tgs", p0Var, 0);
                ...
                MediaDataController.getInstance(fk0Var.J).preloadImage(imageReceiver, ImageLocation.getForDocument(tL_availableReaction.around_animation), zg.l0.a());
            }
            rg.b1 b1Var = this.f;
            if (b1Var != null) {
    ...
    public final void f(zg.p0 p0Var, boolean z10) {
        ...
        if (contains != z11) {
            ...
            if (z10) {
                ...
                ck0Var.animate().scaleX(this.I * (this.w ? 0.76f : 1.0f)).scaleY(this.I * (this.w ? 0.76f : 1.0f)).setDuration(240L).setInterpolator(qrVar).start();
            } else {
        ...
        if (this.O) {
            ...
            if (fk0Var.Q == null) {
                ...
                if (action == 0) {
                    ...
                    if (this.h == 1.0f && !this.H && (i10 = fk0Var.M0) != 3 && i10 != 4 && i10 != 5 && ((ek0Var = fk0Var.g0) == null || ek0Var.j())) {
                ...
                if (motionEvent.getAction() == 1 && this.N && ((fk0Var.l0 == null || fk0Var.n0 > 0.8f) && fk0Var.g0 != null)) {
                    ...
                    if (System.currentTimeMillis() - fk0Var.s0 > 300) {
                        ...
                        fk0Var.g0.h(this, this.e, fk0Var.n0 > 0.8f, false);
                    }
                }
                if (!fk0Var.r0 && fk0Var.l0 != null) {
                    ...
                    fk0Var.Q.addListener(new ci.v5(fk0Var, i11));
                    fk0Var.Q.setDuration(150L);
                    fk0Var.Q.setInterpolator(qr.f);
                    fk0Var.Q.start();
                }
