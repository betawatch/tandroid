...
public final class ty0 extends FrameLayout {
    ...
    public final void c(int i10) {
        xi0[] xi0VarArr = this.r;
        if (xi0VarArr[i10] != null) {
            int d = i0.a.d(0.9f, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.d6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.c9, false));
            int w02 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.e9, false);
            if (i10 != 2) {
                xi0VarArr[i10].setColorFilter(new PorterDuffColorFilter(w02, PorterDuff.Mode.SRC_IN));
                return;
            }
            xi0VarArr[i10].Q(d, "Arrow");
            xi0VarArr[i10].Q(w02, "Box2");
            xi0VarArr[i10].Q(w02, "Box1");
        }
    }
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f11 != 1.0f) {
                ...
                int w10 = org.telegram.messenger.vl.w(16.0f, AndroidUtilities.dp(21.0f) + AndroidUtilities.dp(132.0f), getMeasuredWidth());
                int dp = AndroidUtilities.dp(21.0f);
                float f13 = dp;
                float y3 = org.telegram.messenger.vl.y(48.0f, getMeasuredHeight(), 2);
                rectF.set(f13, y3, w10, getMeasuredHeight() - r9);
                if (this.E >= 0) {
                    this.E = iArr[sy0Var.getValue()];
                    this.x = 1.0f;
                    f7 = 1.0f;
                    this.y = i0.a.d(0.9f, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.d6, false), org.telegram.ui.ActionBar.i6.w0(null, this.E, false));
                } else {
                    f7 = 1.0f;
                    if (iArr[sy0Var.getValue()] != this.E) {
                        this.y = i0.a.d(this.x, this.y, i0.a.d(0.9f, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.d6, false), org.telegram.ui.ActionBar.i6.w0(null, this.E, false)));
                        this.x = 0.0f;
                        this.E = iArr[sy0Var.getValue()];
                    }
                }
                ...
                paint3.setColor(i0.a.d(this.x, i11, i0.a.d(0.9f, org.telegram.ui.ActionBar.i6.w0(null, i12, false), org.telegram.ui.ActionBar.i6.w0(null, this.E, false))));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint3);
                paint3.setColor(org.telegram.ui.ActionBar.i6.w0(null, i12, false));
                paint3.setAlpha(255);
                ...
                paint3.setColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
                paint3.setAlpha(60);
        ...
        int i102 = org.telegram.ui.ActionBar.i6.M6;
        paint.setColor(org.telegram.ui.ActionBar.i6.w0(null, i102, false));
        paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, i102, false));
        int w102 = org.telegram.messenger.vl.w(16.0f, AndroidUtilities.dp(21.0f) + AndroidUtilities.dp(132.0f), getMeasuredWidth());
        ...
        int i112 = this.y;
        int i122 = org.telegram.ui.ActionBar.i6.d6;
        paint3.setColor(i0.a.d(this.x, i112, i0.a.d(0.9f, org.telegram.ui.ActionBar.i6.w0(null, i122, false), org.telegram.ui.ActionBar.i6.w0(null, this.E, false))));
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint3);
        paint3.setColor(org.telegram.ui.ActionBar.i6.w0(null, i122, false));
        paint3.setAlpha(255);
        ...
        canvas.save();
        canvas.clipRect(rectF);
        paint3.setColor(org.telegram.ui.ActionBar.i6.w0(null, i102, false));
        paint3.setAlpha(60);
        canvas.drawCircle(rectF.left + 0.0f, rectF.centerY(), AndroidUtilities.dp(15.0f), paint3);
    ...
    public final void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (accessibilityEvent.getEventType() == 1) {
            int value = sy0Var.getValue() + 1;
            if (value > sy0Var.getMaxValue() || value < 0) {
                value = 0;
            }
    ...
    public void setBackgroundColor(int i10) {
        ...
        sy0Var.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.j5, false));
        sy0Var.invalidate();
    }
}
