...
public final class v71 extends View {
    ...
    public v71(Context context) {
        ...
        paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.a7, false));
        this.L = 0;
        t71 t71Var = this.P;
        if (t71Var != null) {
            t71Var.b();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float B = org.telegram.messenger.y0.B(10.0f, getMeasuredHeight(), measuredHeight);
        Paint paint2 = this.R;
        canvas.drawLine(dp3, dp4, dp5, B, paint2);
        canvas.drawLine(AndroidUtilities.dp(4.0f) + dp2, AndroidUtilities.dp(10.0f) + measuredHeight, AndroidUtilities.dp(4.0f) + dp2, org.telegram.messenger.y0.B(10.0f, getMeasuredHeight(), measuredHeight), paint2);
        if (this.S) {
            canvas.restore();
            return;
        }
        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.f) {
                    ...
                    if (u71Var5 != null) {
                        float f15 = this.b;
                        ChatActivityEnterView chatActivityEnterView = ((bf) u71Var5).a;
                ...
                if (this.h) {
                    ...
                    if (u71Var6 != null) {
                        float f21 = this.c;
                        ChatActivityEnterView chatActivityEnterView2 = ((bf) u71Var6).a;
