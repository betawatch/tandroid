...
public abstract class v71 extends View {
    ...
    public final void a() {
        ...
        for (int i10 = 0; i10 < this.C.size(); i10++) {
            ...
            if (t71Var != null && (bitmap = t71Var.a) != null) {
                bitmap.recycle();
            }
        }
        this.C.clear();
        ...
        if (isEmpty && this.D == null) {
            ...
            if (!z4) {
                ...
                while (true) {
                    ...
                    if (((t71) arrayList.get(i10)).a == null) {
                        this.b0 = true;
                        break;
                    }
                    i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f18 != 1.0f) {
                        ...
                        int interpolation = (int) (pr.h.getInterpolation(t71Var.b) * 255.0f);
                        Paint paint = this.N;
        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.h) {
                    u71 u71Var6 = this.B;
                    if (u71Var6 != null) {
                        ((com.google.android.gms.common.api.internal.v) u71Var6).g(0);
                    }
                    this.h = false;
                    return true;
                }
                if (this.n) {
                    u71 u71Var7 = this.B;
                    if (u71Var7 != null) {
                        ((com.google.android.gms.common.api.internal.v) u71Var7).g(1);
                    }
                    this.n = false;
                    return true;
                }
                if (this.r) {
                    u71 u71Var8 = this.B;
                    if (u71Var8 != null) {
                        ((com.google.android.gms.common.api.internal.v) u71Var8).g(2);
                    }
                    this.r = false;
                }
                ...
                if (this.r) {
                    ...
                    if (u71Var9 != null) {
                        float f13 = this.s;
                        com.google.android.gms.common.api.internal.v vVar2 = (com.google.android.gms.common.api.internal.v) u71Var9;
                ...
                if (this.h) {
                    ...
                    u71 u71Var10 = this.B;
                    if (u71Var10 != null) {
                        com.google.android.gms.common.api.internal.v vVar3 = (com.google.android.gms.common.api.internal.v) u71Var10;
                ...
                if (this.n) {
                    ...
                    u71 u71Var11 = this.B;
                    if (u71Var11 != null) {
                        ((com.google.android.gms.common.api.internal.v) u71Var11).h(this.e);
                    }
                    invalidate();
                    return true;
                }
    ...
    public void setRightProgress(float f10) {
        ...
        u71 u71Var2 = this.B;
        if (u71Var2 != null) {
            ((com.google.android.gms.common.api.internal.v) u71Var2).h(this.e);
        }
        u71 u71Var3 = this.B;
        if (u71Var3 != null) {
