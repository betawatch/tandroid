...
public final class qz0 {
    ...
    public final void a(Canvas canvas, View view, boolean z10) {
        ...
        boolean z13 = i13 == i14;
        boolean z14 = this.q + this.l == xz0Var.E;
        int dp = AndroidUtilities.dp(8.0f);
        boolean z15 = this.c.header;
        if (z15 || (xz0Var.H && this.a.a.b.a % 2 == 0)) {
            int i15 = this.p;
            if (i15 == 0 && this.q == 0) {
                float f7 = dp;
                fArr[1] = f7;
            ...
            if (z12) {
                ...
                canvas2.drawRect(i15, this.q, i15 + this.k, r4 + this.l, wz0Var.getHeaderPaint());
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.drawRect(i15, this.q, this.k + i15, r1 + this.l, wz0Var.getStripPaint());
            }
        }
        if (z10 && this.b != null) {
            canvas2.save();
            canvas2.translate(b(), c());
            if (this.r >= 0 && (r9Var = xz0Var.a) != null) {
                r9Var.a0(canvas2, (org.telegram.ui.Cells.q9) xz0Var.getParent().getParent(), this.r);
            }
    ...
    */
    public final void d(int i10, int i11, boolean z10) {
        ...
        if (this.c != null) {
            pz0 pz0Var = this.b;
            if (pz0Var != null) {
                Layout layout = pz0Var.getLayout();
                ...
                if (!z10) {
                    ...
                    xz0 xz0Var = this.s;
                    e(xz0Var.O.createTextLayout(this.c, this.k - (xz0Var.v * 2)));
                    this.m = this.f + xz0Var.r + xz0Var.s;
                }
                f();
            }
            g();
    ...
    public final void e(pz0 pz0Var) {
        this.b = pz0Var;
        Layout layout = pz0Var != null ? pz0Var.getLayout() : null;
        int i10 = 0;
        if (layout == null) {
            this.i = 0;
            this.e = 0;
    ...
    public final void f() {
        ...
        xz0 xz0Var = this.s;
        if (z10) {
            this.g = ((this.k - this.e) - xz0Var.v) + i10;
