...
public final class qz0 extends TableLayout {
    ...
    public final void b(CharSequence charSequence, ArrayList arrayList) {
        ...
        w5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.a));
    ...
    public final TableRow c(CharSequence charSequence, CharSequence charSequence2, pz0[] pz0VarArr, xc[] xcVarArr) {
        ...
        xcVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.a));
        ...
        tableRow.addView(new nz0(this, xcVar, false), new TableRow.LayoutParams(0, -1, 1.0f));
        addView(tableRow);
        if (xcVarArr != null) {
            xcVarArr[0] = xcVar;
        }
    ...
    public final TableRow e(String str, CharSequence charSequence, String str2, Runnable runnable, Integer num) {
        ...
        int i10 = org.telegram.ui.ActionBar.j6.G6;
        org.telegram.ui.ActionBar.f6 f6Var = this.a;
        xcVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
        xcVar.setTextSize(1, 14.0f);
    ...
    public final TableRow j(CharSequence charSequence, int i10, long j3, Runnable runnable, String str, Runnable runnable2) {
        ...
        xcVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
        xcVar.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
        xcVar.setTextSize(1, 14.0f);
        ...
        if (str != null) {
            xcVar.M = new yc(str, runnable2, f6Var);
        }
        xcVar.setText(spannableStringBuilder);
        if (z10) {
            return null;
    ...
    public final TableRow l(String str, final int i10, final long j3, Runnable runnable) {
        ...
        Utilities.Callback<Object[]> callback = new Utilities.Callback() { // from class: org.telegram.ui.Components.mz0
