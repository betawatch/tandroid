...
public final class qz0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z4 || this.c) {
            ...
            float f13 = tz0Var.h;
            rectF.set(f13, f13, getWidth() - tz0Var.h, (tz0Var.h * AndroidUtilities.dp(this.c ? -1.0f : 1.0f)) + getHeight());
            if (!this.e) {
                rectF.right += tz0Var.f;
            }
            ...
            float f14 = tz0Var.h;
            canvas2 = canvas;
            canvas2.drawRect(f14, f14, getWidth() - tz0Var.h, getHeight() + tz0Var.h, tz0Var.e);
        }
