    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (floatValue2 > 0.0f) {
            ...
            if (this.usePremiumCounter) {
                ...
                canvas.drawRoundRect(rectF2, dpf26, dpf26, PremiumGradient.getInstance().getMainGradientPaint());
                int dpf27 = (int) (dpf22 - AndroidUtilities.dpf2(7.0f));
                int dpf28 = (int) (dpf23 - AndroidUtilities.dpf2(7.0f));
                this.premiumStarDrawable.setBounds(dpf27, dpf28, AndroidUtilities.dp(14.0f) + dpf27, AndroidUtilities.dp(14.0f) + dpf28);
