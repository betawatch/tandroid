...
public class GlassTabView extends FrameLayout implements FactorAnimator.Target {
    ...
    public void updateColorsLottie() {
        this.colorDefault = ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_glass_defaultIcon, this.resourcesProvider), NotificationCenter.channelStarsUpdated);
        this.colorSelected = ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_chat_messagePanelSend, this.resourcesProvider), NotificationCenter.cameraInitied);
        updateColors();
        invalidate();
    }
    ...
    public static GlassTabView createLottie(Context context, Theme.ResourcesProvider resourcesProvider, int i, int i2) {
        ...
        glassTabView.colorSelected = ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_chat_messagePanelSend, resourcesProvider), NotificationCenter.cameraInitied);
        glassTabView.updateColors();
        return glassTabView;
    }
