...
public class st extends EditTextBoldCursor implements org.telegram.ui.ActionBar.u4 {
    ...
    public static /* synthetic */ void i(st stVar) {
    ...
    public static void j(st stVar, int i10, int i11, int i12, int i13) {
        ...
        try {
            text.setSpan(new d10(text.subSequence(i10, i11).toString(), h01Var, tL_messageEntityFormattedDate), i10, i11, 33);
    ...
    public static /* synthetic */ void k(st stVar, int i10, int i11, Runnable runnable, String str) {
        Editable text = stVar.getText();
    ...
    public void addStyle(int i10, int i11, int i12) {
        ...
        h01 h01Var = new h01();
        h01Var.a = i10;
        MediaDataController.addStyleToText(new i01(h01Var, 0), i11, min, text, true);
        if ((i10 & 256) != 0) {
            invalidateSpoilers();
        }
    ...
    public final void l(i01 i01Var) {
        ...
        if (i01Var == null) {
            ...
            for (int i11 = 0; i11 < qi0VarArr.length; i11++) {
                ...
                text.removeSpan(qi0VarArr[i11].s);
    ...
    public void makeSelectedDate() {
        ...
        qc0Var2.setFormatter(new eg.n2(calendar, i21, 3));
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [org.telegram.ui.Cells.i9] */
    /* JADX WARN: Type inference failed for: r3v0, types: [org.telegram.ui.Components.EditTextBoldCursor, org.telegram.ui.Components.st] */
    @Override // org.telegram.ui.Components.EditTextBoldCursor, android.view.View
    ...
    public void translateSelected() {
        ...
        v31 v31Var = new v31(getContext(), U != null ? U.getResourceProvider() : null);
    ...
    public void showInputDialog(String str, String str2, String str3, boolean z10, boolean z11, rt rtVar) {
        ...
        mVar.setText(str4);
        mVar.setTextColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.j5, this.resourcesProvider));
        ...
        mVar.setLineColors(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.k6, this.resourcesProvider), org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.l6, this.resourcesProvider), org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.p7, this.resourcesProvider));
        mVar.setImeOptions(6);
        mVar.setBackgroundDrawable(null);
        mVar.requestFocus();
        mVar.setPadding(0, 0, 0, 0);
        mVar.setHighlightColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.uf, this.resourcesProvider));
        mVar.setHandlesColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.vf, this.resourcesProvider));
        ...
        jVar.run();
        f2Var.n(frameLayout);
        f2Var.k(LocaleController.getString(R.string.OK), new j1(19, rtVar, mVar));
        ...
        if (z11) {
            ...
            f2Var.o().setOnShowListener(new ot(1, mVar));
        }
