...
public final class zz0 {
    ...
    public final float b() {
        ...
        for (int i10 = 0; i10 < this.b.getLineCount(); i10++) {
            f9 = Math.max(f9, this.b.getLineWidth(i10));
        }
        return f9;
    }
    ...
    public final void c(float f9, float f10, float f11, int i10, Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(f9, f10 - (this.f > 1 ? 0.0f : this.b.getHeight() / 2.0f));
        d(canvas);
        canvas.restore();
    ...
    public final void d(Canvas canvas) {
        ...
        if (f9 >= 0.0f && this.c > f9) {
            canvas.saveLayerAlpha(0.0f, -this.t, f9 - 1.0f, r0.getHeight() + this.t, 255, 31);
        }
        canvas.save();
    ...
    public final float l() {
        float f9 = this.p;
        return f9 >= 0.0f ? Math.min(f9, this.c) : this.c;
    }
    ...
    public final void s(View view) {
        ...
        view.addOnAttachStateChangeListener(new ia(i10, this, view));
    }
