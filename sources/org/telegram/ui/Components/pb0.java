...
public final class pb0 extends vl0 {
    public final /* synthetic */ xb0 X2;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public pb0(xb0 xb0Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var);
        this.X2 = xb0Var;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        xb0 xb0Var2 = this.X2;
        org.telegram.ui.x8 x8Var = xb0Var2.b;
        boolean z11 = false;
        ...
        int i12 = 0;
        while (i12 < 3) {
            dc0 dc0Var = xb0Var2.c0;
            ArrayList arrayList = dc0Var.E;
            pb0 pb0Var = xb0Var2.f;
            dc0Var.E.clear();
            if (i12 != 2 || pb0Var.X1) {
                int i13 = 0;
                ?? r32 = z11;
                ...
                while (i18 < arrayList.size()) {
                    ...
                    if (groupedMessages2 == null) {
                        ...
                        if (f13 > AndroidUtilities.dp(20.0f) + pb0Var.getMeasuredHeight()) {
                            f13 = AndroidUtilities.dp(20.0f) + pb0Var.getMeasuredHeight();
                        }
                        ...
                        if (z12) {
                            ...
                            for (int i19 = 0; i19 < childCount; i19++) {
                                View childAt4 = pb0Var.getChildAt(i19);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        pb0 pb0Var = xb0Var.f;
        if (xb0Var.U) {
            if (pb0Var.computeVerticalScrollRange() > pb0Var.computeVerticalScrollExtent()) {
                xb0Var.postDelayed(new ib0(xb0Var, 0), 0L);
            }
            xb0Var.U = false;
        }
        if (xb0Var.N && i14 == 0) {
