...
public abstract class vm0 extends HorizontalScrollView {
    ...
    public vm0(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        this.n0 = new Paint();
        this.o0 = true;
        this.p0 = new e6(this, 350L, qrVar);
        this.s0 = new qm0(this, 1);
        this.O = e6Var;
        this.P = z10;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            bc1Var = this.e;
            if (i11 >= bc1Var.getChildCount()) {
                break;
            }
            if (bc1Var.getChildAt(i11) instanceof px0) {
                px0 px0Var = (px0) bc1Var.getChildAt(i11);
                float left = px0Var.getLeft();
                float f13 = px0Var.y;
                if (left != f13 && px0Var.E) {
                    px0Var.b = f13 - px0Var.getLeft();
                    ValueAnimator valueAnimator = px0Var.x;
                    if (valueAnimator != null) {
                        valueAnimator.removeAllListeners();
                        px0Var.x.cancel();
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(px0Var.b, 0.0f);
                    px0Var.x = ofFloat;
                    ofFloat.addUpdateListener(new ox0(px0Var, this, i10));
                    px0Var.x.addListener(new al0(3, px0Var, this));
                    px0Var.x.start();
                }
                px0Var.E = false;
                if (this.g0) {
                    px0Var.setTranslationX(com.google.android.gms.internal.vision.e2.z(1.0f, this.i0, i11 * f11, f12) + px0Var.b);
                } else {
                    px0Var.setTranslationX(px0Var.b);
                }
            }
            i11++;
        }
        ...
        if (isInEditMode() || this.x == 0 || this.J < 0) {
            ...
            View view = null;
            View childAt = (floor < 0 || floor >= bc1Var.getChildCount()) ? null : bc1Var.getChildAt(floor);
            if (ceil >= 0 && ceil < bc1Var.getChildCount()) {
                view = bc1Var.getChildAt(ceil);
            }
            float f16 = f14 / 2.0f;
            if (childAt == null || view == null) {
                ...
                if (childAt != null) {
                    ...
                    if (childAt instanceof px0) {
                        textWidth = ((px0) childAt).getTextWidth();
                    }
                    textWidth = 0.0f;
                } else {
                    if (view != null) {
                ...
                textWidth = AndroidUtilities.lerp(childAt instanceof px0 ? ((px0) childAt).getTextWidth() : 0.0f, view instanceof px0 ? ((px0) view).getTextWidth() : 0.0f, f17);
            }
        ...
        Paint paint2 = this.H;
        paint2.setColor(i12);
        canvas2.drawRect(0.0f, f14 - this.M, bc1Var.getWidth(), f14, paint2);
    }
    ...
    public final boolean f(MotionEvent motionEvent) {
            ...
            if (this.s != null) {
                ...
                if (i10 != i11) {
                    ...
                    for (int i12 = 0; i12 < bc1Var.getChildCount(); i12++) {
                        bc1Var.getChildAt(i12).setTag(R.id.index_tag, Integer.valueOf(i12));
                    }
                }
        ...
        if (this.U != ceil && e(ceil)) {
            for (int i14 = 0; i14 < bc1Var.getChildCount(); i14++) {
                if (i14 != this.U) {
                    px0 px0Var = (px0) bc1Var.getChildAt(i14);
                    px0Var.y = px0Var.getLeft();
                    px0Var.E = true;
                    px0Var.invalidate();
                }
            }
            ...
            this.U = ceil;
            bc1Var.removeView(this.s);
            bc1Var.addView(this.s, this.U);
            invalidate();
        }
    ...
    public final void h() {
        ...
        if (hashMap != null) {
            ...
            while (it.hasNext()) {
                bc1Var.removeView((View) ((Map.Entry) it.next()).getValue());
            }
            this.n.clear();
        }
    ...
    public final void i(final float f7, final boolean z10) {
        if (this.f0 != z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.pm0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (!z10) {
                        ...
                        float f10 = f7;
                        float childCount2 = (scrollX + f10) / (vm0Var.j0 * bc1Var.getChildCount());
                        ...
                        vm0Var.l0 = (vm0Var.getScrollX() + f10) - f11;
                    }
                    vm0Var.i0 = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                    for (int i11 = 0; i11 < bc1Var.getChildCount(); i11++) {
                        bc1Var.getChildAt(i11).invalidate();
                    }
                    bc1Var.invalidate();
                    vm0Var.p();
                }
            });
            this.h0.addListener(new sm0(this, z10, f7, i10));
            this.h0.start();
            bc1 bc1Var = this.e;
            if (z10) {
                this.g0 = true;
            ...
            if (z10) {
                float childCount = this.j0 * bc1Var.getChildCount() * ((getScrollX() + f7) / (this.k0 * bc1Var.getChildCount()));
    ...
    */
    public final void n() {
        ...
        bc1 bc1Var2 = this.e;
        int paddingLeft = (int) ((scrollX - bc1Var2.getPaddingLeft()) / f10);
        int i13 = 1;
        int min = Math.min(bc1Var2.getChildCount(), ((int) Math.ceil(getMeasuredWidth() / f10)) + paddingLeft + 1);
        if (this.g0) {
            paddingLeft -= 2;
            min += 2;
            if (paddingLeft < 0) {
            ...
            if (min > bc1Var2.getChildCount()) {
                min = bc1Var2.getChildCount();
            }
        }
        ...
        while (true) {
            ...
            sparseArray2.put(((px0) sparseArray.valueAt(i14)).s, (px0) sparseArray.valueAt(i14));
            i14++;
        }
        sparseArray.clear();
        while (paddingLeft < min) {
            View childAt = bc1Var2.getChildAt(paddingLeft);
            if (childAt instanceof px0) {
                px0 px0Var = (px0) childAt;
                int i15 = px0Var.s;
                w9 w9Var = px0Var.e;
                if (px0Var.a == 2) {
                    Object tag = px0Var.getTag(R.id.parent_tag);
                    Object tag2 = px0Var.getTag(R.id.object_tag);
                    ...
                    if (tag3 instanceof TLRPC.Document) {
                        if (!px0Var.c) {
                            px0Var.v = DocumentObject.getSvgThumb((TLRPC.Document) tag3, org.telegram.ui.ActionBar.j6.c7, 0.2f);
                        }
                        ...
                        if (tag4 instanceof TLRPC.TL_messages_stickerSet) {
                            ...
                            if (px0Var.c) {
                                ...
                                i10 = paddingLeft;
                                i11 = min;
                                px0Var.v = DocumentObject.getSvgThumb(arrayList, org.telegram.ui.ActionBar.j6.c7, 0.2f, DocumentObject.containsPhotoSizeType(arrayList, "v"));
                            }
                        } else {
                            i10 = paddingLeft;
                            i11 = min;
                    ...
                    if (!px0Var.c && px0Var.v == null && document != null) {
                        px0Var.v = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.c7, 0.2f);
                    }
                    if (forSticker != null) {
                        px0Var.c = true;
                        SvgHelper.SvgDrawable svgDrawable = px0Var.v;
                        ...
                        if (str == null || !str.equalsIgnoreCase("v")) {
                            ...
                            if (!(str == null && MessageObject.isAnimatedStickerDocument(document, true)) && (str == null || !str.equalsIgnoreCase("a"))) {
                                ...
                                obj2 = obj;
                                px0Var.h.setText(!(obj2 instanceof TLRPC.TL_messages_stickerSet) ? ((TLRPC.TL_messages_stickerSet) obj2).set.title : null);
        ...
        for (int i16 = 0; i16 < sparseArray2.size(); i16++) {
            if (((px0) sparseArray2.valueAt(i16)) != this.s) {
                ((px0) sparseArray2.valueAt(i16)).e.setImageDrawable(null);
            }
        }
    }
