    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            if (!v3Var.getText().equals(string)) {
                v3Var.c(string, LocaleController.getString(wm0Var.H ? R.string.PauseAll : R.string.ResumeAll), new um0(this));
                return;
            }
        ...
        if (E != null) {
            ...
            if (i11 == 1) {
                sm0 sm0Var = (sm0) view;
                sm0Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.d6, false));
                ...
                m10Var.a = j7Var.getMessage().getDialogId();
                m10Var.b = id3;
                j7Var.b(wm0Var.I.c(m10Var), id2 == E.getId());
                z10 = id2 == E.getId();
                if (j7Var.O == z12) {
                    return;
                }
            ...
            if (i11 == 2) {
                ...
                m10Var.a = i7Var.getMessage().getDialogId();
                m10Var.b = id5;
                i7Var.e(wm0Var.I.c(m10Var), id4 == E.getId());
                z10 = id4 == E.getId();
                if (i7Var.d0 == z12) {
                    return;
                }
