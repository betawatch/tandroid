...
public class vu0 extends su0 {
    ...
    public final void N() {
        ...
        int[] iArr = yu0Var.m1;
        if ((!z10 || (yu0Var.k1 && d9Var.g() > 1)) && this.s.g() > 0 && !yu0Var.v0()) {
            if (this.s.g() < 5) {
                iArr[1] = this.s.g();
    ...
    public final int O() {
        ...
        dt0 dt0Var = yu0Var.H;
        int[] iArr = yu0Var.m1;
        return this == dt0Var ? iArr[0] : yu0.u(yu0Var, this) != -1 ? iArr[1] : yu0Var.q1;
    }
    ...
    @Override // org.telegram.ui.Components.su0, s4.h0
    public final int h() {
        if (this.s == null) {
            return 0;
        }
    ...
    public void l() {
        if (this.s != null) {
            ...
            if (yu0Var.r0()) {
                ...
                arrayList.clear();
                ArrayList E = MessagesController.getInstance(this.s.c).getStoriesController().E(yu0Var.j1);
                if (E != null) {
                    arrayList.addAll(E);
                }
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        if (this.s != null && c1Var.f == 19) {
            ...
            if (view instanceof org.telegram.ui.Cells.t7) {
                ...
                yu0 yu0Var = this.F;
                t7Var.setReorder(yu0Var.r0() || t7Var.f0);
                t7Var.h = yu0Var.t0();
                t7Var.k(messageObject, O(), false);
                if (!yu0Var.C1 || messageObject == null) {
                    t7Var.i(false, false);
                } else {
                    t7Var.i(yu0Var.Z0[(messageObject.getDialogId() > yu0Var.j1 ? 1 : (messageObject.getDialogId() == yu0Var.j1 ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0, true);
                }
    ...
    public vu0(yu0 yu0Var, Context context, int i10, boolean z10) {
        ...
        if (!TextUtils.isEmpty(yu0Var.getStoriesHashtag())) {
            ...
            if (i10 > 0) {
                this.s = n2Var.getMessagesController().getStoriesController().A(yu0Var.j1, 0, i10, true);
            } else {
                this.s = n2Var.getMessagesController().getStoriesController().A(yu0Var.j1, z11 ? 4 : z10 ? 1 : 0, -1, true);
            }
        } else {
            this.s = null;
        }
        ...
        if (d9Var != null) {
            this.v = d9Var.o();
            this.w = new tu0(this, n2Var.getMessagesController().getStoriesController(), yu0Var.j1, this.s.c);
        }
        N();
    }
