...
public class s40 extends FrameLayout {
    ...
    public final void a() {
        ...
        boolean z10 = this.r;
        addView(imageView2, w7.a6.d(34, 34.0f, 21, 0.0f, z10 ? 3.0f : 0.0f, 0.0f, z10 ? 0.0f : 3.0f));
    ...
    public final void b(boolean z10) {
        ...
        if (z11) {
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<s40, Float>) property, 1.0f, 0.0f), ObjectAnimator.ofFloat(this, (Property<s40, Float>) View.SCALE_Y, 1.0f, 0.5f), ObjectAnimator.ofFloat(this, (Property<s40, Float>) View.SCALE_X, 1.0f, 0.5f));
            this.f.setDuration(150L);
            this.f.setInterpolator(wr.f);
        } else {
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<s40, Float>) property, 0.0f));
            this.f.setDuration(300L);
        }
        this.f.addListener(new q40(this, i10));
        this.f.start();
    }
    ...
    public final void d() {
        ...
        int i10 = this.n;
        hVar.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp((i10 == 7 || i10 == 8) ? 6.0f : 3.0f), -366530760));
    }
    ...
    */
        ...
        if ((i14 != 5 || i11 != this.v || this.d != t1Var) && (i14 == 5 || ((i14 != 0 || getTag() == null) && this.d != t1Var))) {
            ...
            if (i14 == 0) {
                ...
                if (i12 > AndroidUtilities.dp(10.0f) + getMeasuredHeight() && i17 <= (imageHeight / 4) + measuredHeight) {
                    ...
                    if (i14 == 5) {
                        int g10 = hc.b.g(19.1f, forwardNameCenterX - (getMeasuredWidth() / 2), 0);
                        setTranslationX(g10);
                        dp3 += g10;
                    ...
                    AnimatorSet animatorSet2 = new AnimatorSet();
                    this.f = animatorSet2;
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<s40, Float>) View.ALPHA, 0.0f, 1.0f));
                    this.f.addListener(new q40(this, i13));
                    this.f.setDuration(300L);
                    this.f.start();
                    return true;
                }
                ...
                if (i14 == 5) {
                    ...
                    if (messageObject != null && (MessageObject.getMedia(messageObject) instanceof TLRPC.TL_messageMediaPoll)) {
                        ...
                        if (MessageObject.isVoted(tL_messageMediaPoll) && !MessageObject.isVoteResultsIsNotEmpty(tL_messageMediaPoll)) {
                            ...
                            if (!poll.closed && poll.hide_results_until_close) {
                                hVar.setText(LocaleController.getString(R.string.PollResultsWillLater));
                                measure(View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31));
                    ...
                    if (num.intValue() == -1) {
                        hVar.setText(LocaleController.getString(R.string.PollSelectOption));
                        measure(View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31));
                        forwardNameCenterX = i10;
                    ...
                    String str = this.s;
                    if (str == null) {
                        hVar.setText(LocaleController.getString(R.string.HidAccount));
                    } else {
                        hVar.setText(str);
                    }
                    measure(View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31));
                    ...
                    if (currentUser == null || currentUser.id != 0) {
                        ...
                        dp = org.telegram.messenger.em.D(50.0f, t1Var.getMeasuredHeight() - Math.max(0, t1Var.getBottom() - view.getMeasuredHeight()), i16);
                    }
                    i12 = dp;
                    if (!z11) {
                    }
    ...
    public final void f(View view, boolean z10) {
        ...
        if (z11) {
            ...
            this.f.playTogether(ObjectAnimator.ofFloat(this, (Property<s40, Float>) property, 0.0f, 1.0f), ObjectAnimator.ofFloat(this, (Property<s40, Float>) View.SCALE_Y, 0.5f, 1.0f), ObjectAnimator.ofFloat(this, (Property<s40, Float>) View.SCALE_X, 0.5f, 1.0f));
            this.f.setDuration(350L);
            this.f.setInterpolator(wr.h);
        } else {
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<s40, Float>) property, 0.0f, 1.0f));
            this.f.setDuration(300L);
        }
        this.f.addListener(new q40(this, i10));
        this.f.start();
    ...
    */
    public final void g(View view) {
        ...
        if (i12 == 4) {
            ...
            dp = org.telegram.messenger.a2.C(10.0f, getMeasuredHeight() + view.getMeasuredHeight(), dp);
        } else if (i12 == 7 || (i12 == 8 && z10)) {
            dp = org.telegram.messenger.a2.C(8.0f, getMeasuredHeight() + view.getMeasuredHeight(), dp);
        } else if (i12 == 8) {
    ...
    public s40(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        if (i10 == 3) {
            hVar.setGravity(19);
            hVar.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.qf, f6Var)));
            ...
            hVar.setGravity(51);
            hVar.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.qf, f6Var)));
        ...
        if (i10 == 0) {
            ...
            addView(this.b, w7.a6.d(38, 34.0f, 51, 7.0f, 7.0f, 0.0f, 0.0f));
        }
