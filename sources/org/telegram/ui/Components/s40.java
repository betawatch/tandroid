...
public final class s40 implements ji {
    ...
    public final void G1(int i10, boolean z4, boolean z10, int i11, int i12, long j10, boolean z11, boolean z12, long j11) {
        li liVar;
        x40 x40Var = this.a;
        org.telegram.ui.ActionBar.p2 p2Var = x40Var.a;
        if (p2Var == null || p2Var.getParentActivity() == null || (liVar = x40Var.c) == null) {
            return;
        }
        if (i10 != 8 && i10 != 7) {
        ...
        ArrayList<Object> selectedPhotosOrder = x40Var.c.g0.getSelectedPhotosOrder();
