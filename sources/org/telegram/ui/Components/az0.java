...
public final class az0 {
    ...
    public az0(org.telegram.ui.ActionBar.f6 f6Var) {
        this.a = f6Var;
    }
    ...
    public final void b(MessageObject messageObject) {
        ...
        if (aVar != null && !aVar.k()) {
            arrayList.add(new zy0(new u01(LocaleController.getString(R.string.SuggestionOfferInfoPrice), textPaint), new u01(LocaleController.bold(of2.amount.f()), textPaint)));
        }
        if (suggestedPost.schedule_date > 0) {
            arrayList.add(new zy0(new u01(LocaleController.getString(R.string.SuggestionOfferInfoTime), textPaint), new u01(LocaleController.bold(LocaleController.formatDateTime(suggestedPost.schedule_date, true)), textPaint)));
        }
        ...
        while (i11 < size) {
            ...
            i11++;
            zy0 zy0Var = (zy0) obj;
            f10 = Math.max(f10, zy0Var.a.l());
            f11 = Math.max(f11, zy0Var.b.l());
            int j3 = ((int) zy0Var.a.j()) + this.g;
            this.g = j3;
