...
public final class wz extends DispatchQueue {
    ...
    public static void b(wz wzVar) {
        ...
        if (wzVar.f) {
            wzVar.c();
            if (wzVar.x) {
                wzVar.w.updateTexImage();
                wzVar.w.getTransformMatrix(wzVar.y);
                wzVar.g();
                wzVar.x = false;
                a00 a00Var = wzVar.J;
                a00Var.P0 = wzVar.y;
            ...
            if (wzVar.Z) {
                if (wzVar.h && ((zzVar = wzVar.J.f1) == null || zzVar.b())) {
                    GLES20.glViewport(0, 0, wzVar.n, wzVar.r);
                    ...
                    if (floatBuffer == null) {
                        floatBuffer = wzVar.J.a1;
                    }
                    GLES20.glVertexAttribPointer(i10, 2, 5126, false, 8, (Buffer) floatBuffer);
                    GLES20.glEnableVertexAttribArray(wzVar.P);
                    GLES20.glVertexAttribPointer(wzVar.P, 2, 5126, false, 8, (Buffer) wzVar.J.b1);
                    GLES20.glUniformMatrix4fv(wzVar.Q, 1, false, wzVar.y, 0);
                    GLES20.glDrawArrays(5, 0, 4);
                    wzVar.b.eglSwapBuffers(wzVar.c, wzVar.e);
                    pa paVar = wzVar.I;
                    if (paVar != null) {
                        paVar.a(wzVar.y, wzVar.E[0], wzVar.W, wzVar.X);
                        return;
                    }
                    return;
                }
                if (wzVar.b0 == null || wzVar.F) {
                                ...
                                if (h != 0 && h10 != 0) {
                                    ...
                                    if (h(null)) {
                                        ...
                                        if (this.b0 != null) {
                                            ...
                                            AndroidUtilities.runOnUIThread(new tz(this, i12));
                                        }
