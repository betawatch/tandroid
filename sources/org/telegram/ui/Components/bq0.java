...
public final class bq0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        wl0 wl0Var = uq0Var.E;
        rq0 rq0Var = uq0Var.L;
        org.telegram.ui.ActionBar.k kVar = uq0Var.z0;
        long longValue = ((Long) objArr[0]).longValue();
        TLRPC.Dialog dialog = this.a;
        if (longValue != (-dialog.id)) {
            return;
        }
        ArrayList arrayList = rq0Var.f;
        AtomicReference atomicReference = this.b;
        if (arrayList == null) {
            i22 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
        }
        if (atomicReference.get() != null) {
            z10 = false;
            i12 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
            rq0Var.f = MessagesController.getInstance(i12).getTopicsController().getTopics(-dialog.id);
            i13 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
            rq0Var.d = UserObject.isBotForum(i13, dialog.id);
            i14 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
            rq0Var.e = UserObject.isBotForumWithEditableTopics(i14, dialog.id);
            if (z10) {
                rq0Var.l();
            }
            if (rq0Var.f != null) {
                i21 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
            ...
            if (UserObject.isBotForum(i15, dialog.id)) {
                i20 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
                ...
                i16 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
                if (ChatObject.isMonoForum(i16, dialog.id)) {
                    i18 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
                    i19 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
                    kVar.setTitle(ng.d.i(MessagesController.getInstance(i19).getChat(Long.valueOf(-dialog.id)), i18, false));
                    kVar.setSubtitle(LocaleController.getString(R.string.SelectChat));
                } else {
                    i17 = ((org.telegram.ui.ActionBar.e3) uq0Var).currentAccount;
            ...
            kVar3.u = lVar;
            uq0Var.B0 = kVar3;
            kVar3.b(new mp0(this, this.c, iArr, 1));
            uq0Var.B0.a(new hb(this, 5));
            uq0Var.B0.f();
            if (atomicReference.get() != null) {
