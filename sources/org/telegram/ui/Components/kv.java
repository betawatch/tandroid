...
public final class kv extends FrameLayout {
        ...
        if (vVar == null) {
            ...
            for (int i10 = 0; i10 < vVar.getChildCount(); i10++) {
                ...
                if (childAt instanceof lv) {
                    z5VarArr2[i10] = ((lv) childAt).c;
                }
            }
            z5VarArr = z5VarArr2;
        }
        uvVar.b = z5.update(3, this, z5VarArr, (LongSparseArray<q5>) uvVar.b);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            int themedColor = uvVar.getThemedColor(i10);
            Paint paint = this.a;
            ...
            if (bool == null || z10 != bool.booleanValue()) {
                ...
                boolean z11 = AndroidUtilities.computePerceivedBrightness(uvVar.getThemedColor(i10)) > 0.721f;
                boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v(uvVar.getThemedColor(org.telegram.ui.ActionBar.h6.s8), 855638016)) > 0.721f;
                if (!z10) {
                    z11 = z12;
                }
                AndroidUtilities.setLightStatusBar(uvVar, z11);
            }
            org.telegram.ui.ActionBar.h6.t0.setColor(uvVar.getThemedColor(org.telegram.ui.ActionBar.h6.Ii));
            org.telegram.ui.ActionBar.h6.t0.setAlpha((int) (w7.q.a(lerp / AndroidUtilities.dp(f7), 0.0f, 1.0f) * org.telegram.ui.ActionBar.h6.t0.getAlpha()));
            ...
            uvVar.r.setVisibility((vVar.canScrollVertically(1) || uvVar.w.getVisibility() == 0) ? 0 : 4);
            if (vVar != null) {
                canvas2.save();
                ...
                while (i12 < vVar.getChildCount()) {
                    ...
                    if (childAt instanceof lv) {
                        ...
                        if (uvVar.b != null && (z5Var = lvVar.c) != null) {
                            q5 q5Var = (q5) uvVar.b.get(z5Var.getDocumentId());
                            if (q5Var != null) {
                ...
                while (true) {
                    ...
                    while (true) {
                        if (i14 >= arrayList5.size()) {
                            ...
                            if (((jv) arrayList5.get(i14)).M == R) {
                                jvVar = (jv) arrayList5.get(i14);
                    ...
                    jvVar2.a(canvas3, currentTimeMillis, getMeasuredWidth(), view.getMeasuredHeight() - view.getPaddingBottom(), 1.0f);
                    canvas2 = canvas3;
                    canvas2.restore();
                    i13++;
                }
                for (int i15 = 0; i15 < arrayList5.size(); i15++) {
                    if (arrayList2.size() < 3) {
                        arrayList2.add((jv) arrayList5.get(i15));
                        ((jv) arrayList5.get(i15)).N = null;
                        ((jv) arrayList5.get(i15)).k();
                    } else {
                        ((jv) arrayList5.get(i15)).f();
                    }
                }
                arrayList5.clear();
                canvas2.restore();
