...
public final class la {
    ...
    public final void b(Canvas canvas, boolean z10) {
        ...
        if (!isHardwareAccelerated) {
            canvas.drawColor(num != null ? num.intValue() : haVar.i);
            return;
        }
        RenderNode renderNode = (RenderNode) haVar.l;
        if (!renderNode.hasDisplayList()) {
            RenderNode renderNode2 = (RenderNode) haVar.k;
            renderNode.setPosition(0, 0, renderNode2.getWidth(), renderNode2.getHeight());
            RecordingCanvas beginRecording = renderNode.beginRecording();
            beginRecording.drawColor(num != null ? num.intValue() : haVar.i);
    ...
    public final Paint[] d() {
        ...
        if (c10 != null && z10) {
            c10.setAlpha((int) org.telegram.messenger.y0.A(1.0f, this.f, 255.0f, 1.0f));
        }
        if (paint != null) {
    ...
    public final void f(int i10, int i11, boolean z10) {
        ...
        matrix.reset();
        ha haVar = this.a;
        View view2 = haVar != null ? z10 ? haVar.j : haVar.b : null;
        if (haVar != null) {
