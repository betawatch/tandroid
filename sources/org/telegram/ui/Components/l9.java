...
public abstract class l9 {
    public static void a(org.telegram.ui.tn tnVar, int i10, TLRPC.Chat chat, TLRPC.User user, TLRPC.TL_forumTopic tL_forumTopic, long j10, int i11, int i12) {
        ...
        for (k9 k9Var : parentLayout.getPulledDialogs()) {
            if (tL_forumTopic == null && k9Var.f == j10) {
                return;
            }
            if (tL_forumTopic != null && (tL_forumTopic2 = k9Var.e) != null && tL_forumTopic2.id == tL_forumTopic.id) {
                return;
            }
        }
        k9 k9Var2 = new k9();
        k9Var2.a = org.telegram.ui.tn.class;
        k9Var2.b = i10;
        k9Var2.f = j10;
        k9Var2.h = i12;
        k9Var2.g = i11;
        k9Var2.c = chat;
        k9Var2.d = user;
        k9Var2.e = tL_forumTopic;
        parentLayout.getPulledDialogs().add(k9Var2);
    }
    ...
    */
    public static org.telegram.ui.ActionBar.o1 b(org.telegram.ui.ActionBar.o2 o2Var, View view, long j10, long j11, org.telegram.ui.ActionBar.c6 c6Var) {
        long j12;
        ArrayList arrayList;
        ...
        if (j11 == 0 || ChatObject.isMonoForum(o2Var.getCurrentAccount(), j10)) {
            ...
            if (parentLayout2 != null) {
                ...
                if (fragmentStack != null) {
                    ...
                    int i17 = 0;
                    while (i17 < size) {
                        org.telegram.ui.ActionBar.o2 o2Var2 = (org.telegram.ui.ActionBar.o2) fragmentStack.get(i17);
                ...
                if (pulledDialogs != null) {
                    for (int size2 = pulledDialogs.size() - 1; size2 >= 0; size2--) {
                        k9 k9Var3 = (k9) pulledDialogs.get(size2);
                        if (k9Var3.f != j10) {
                            int i18 = 0;
                            while (true) {
                                ...
                                if (((k9) arrayList.get(i18)).f == k9Var3.f) {
                                    break;
                                }
                                i18++;
                            }
                ...
                Collections.sort(arrayList, new lh.e4(20));
                ...
                while (i19 < size3) {
                    ...
                    k9 k9Var4 = (k9) arrayList2.get(i19);
                    TLRPC.Chat chat2 = k9Var4.c;
                    TLRPC.User user3 = k9Var4.d;
                    TLRPC.TL_forumTopic tL_forumTopic = k9Var4.e;
                    ...
                    if (chat2 == null && user3 == null) {
                        t9Var.setRoundRadius(0);
                    } else {
                        t9Var.setRoundRadius((chat2 == null || !chat2.forum) ? AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(8.0f));
                    }
                    frameLayout.addView(t9Var, i7.f6.i(32.0f, 32.0f, 8388627, 8.0f, 0.0f, 0.0f, 0.0f));
                    ...
                    frameLayout.addView(textView, i7.f6.i(-1.0f, -2.0f, 8388627, 52.0f, 0.0f, 8.0f, 0.0f));
                    e9 e9Var = new e9((org.telegram.ui.ActionBar.c6) null);
                    e9Var.p = 0.8f;
                    if (tL_forumTopic != null) {
                        if (tL_forumTopic.id == 1) {
                            t9Var.setImageDrawable(yf.d.c(fragmentView.getContext(), 1.0f, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Ac, c6Var), false));
                            i15 = i19;
                        } else if (tL_forumTopic.icon_emoji_id != j12) {
                            i15 = i19;
                            t9Var.setAnimatedEmojiDrawable(new p5(10, o2Var.getCurrentAccount(), tL_forumTopic.icon_emoji_id));
                        } else {
                            i15 = i19;
                        ...
                        i15 = i19;
                        if (chat2 != null) {
                            e9Var.k(o2Var.getCurrentAccount(), chat2);
                            TLRPC.ChatPhoto chatPhoto = chat2.photo;
                            if (chatPhoto != null && (r82 = chatPhoto.strippedBitmap) != 0) {
                                e9Var = r82;
                            }
                            t9Var.h(ImageLocation.getForChat(o2Var.getCurrentAccount(), chat2, 1), "50_50", e9Var, chat2);
                            ...
                            if (k9Var4.a == org.telegram.ui.tn.class && UserObject.isUserSelf(user3)) {
                                ...
                                if (UserObject.isDeleted(user3)) {
                                    ...
                                    e9Var.m(o2Var.getCurrentAccount(), user3);
                                    k9Var = k9Var4;
                                    t9Var.h(ImageLocation.getForUser(o2Var.getCurrentAccount(), user3, 1), "50_50", e9Var, user3);
                                } else {
                                    k9Var = k9Var4;
                                    String userName = UserObject.getUserName(user3);
                                    e9Var.m(o2Var.getCurrentAccount(), user3);
                                    t9Var.h(ImageLocation.getForUser(o2Var.getCurrentAccount(), user3, 1), "50_50", drawable, user3);
                                    str = userName;
                                }
                                ...
                                frameLayout.setOnClickListener(new lh.b0(atomicReference, k9Var, b5Var3, tL_forumTopic, o2Var, 9));
                                actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, i7.f6.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                                if (!z11) {
                                    ...
                                    actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout2, i7.f6.n(-1, 8));
                                }
                                i19 = i15 + 1;
                            ...
                            atomicReference = atomicReference2;
                            frameLayout.setOnClickListener(new lh.b0(atomicReference, k9Var, b5Var32, tL_forumTopic, o2Var, 9));
                            actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, i7.f6.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                            if (!z11) {
                            }
                            i19 = i15 + 1;
                            ...
                            k9Var = k9Var4;
                            t9Var.setImageDrawable(parentActivity.getDrawable(R.drawable.msg_viewchats).mutate());
                            t9Var.s(AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f));
                            t9Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.F8, c6Var), PorterDuff.Mode.MULTIPLY));
                            ...
                            atomicReference = atomicReference2;
                            frameLayout.setOnClickListener(new lh.b0(atomicReference, k9Var, b5Var322, tL_forumTopic, o2Var, 9));
                            actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, i7.f6.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                            if (!z11) {
                            }
                            i19 = i15 + 1;
                    ...
                    atomicReference = atomicReference2;
                    frameLayout.setOnClickListener(new lh.b0(atomicReference, k9Var, b5Var3222, tL_forumTopic, o2Var, 9));
                    actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, i7.f6.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                    if (!z11) {
                    }
                    i19 = i15 + 1;
            ...
            if (parentLayout3 == null) {
                ...
                if (pulledDialogs2 != null) {
                    ...
                    for (int i21 = 0; i21 < pulledDialogs2.size(); i21++) {
                        k9 k9Var5 = (k9) pulledDialogs2.get(i21);
                        if (k9Var5.e != null && r5.id != j11) {
                            int i22 = k9Var5.b;
                            if (i22 >= i16) {
                                i16 = i22;
                            }
                            arrayList.add(k9Var5);
                        }
                    }
                } else {
                    i16 = -1;
                }
                if (parentLayout3.getFragmentStack().size() <= 1 || !(parentLayout3.getFragmentStack().get(parentLayout3.getFragmentStack().size() - 2) instanceof ze1)) {
                    k9 k9Var6 = new k9();
                    arrayList.add(k9Var6);
                    k9Var6.b = -1;
                    k9Var6.a = ze1.class;
                    k9Var6.c = MessagesController.getInstance(o2Var.getCurrentAccount()).getChat(Long.valueOf(-j10));
                } else {
                    k9 k9Var7 = new k9();
                    arrayList.add(k9Var7);
                    k9Var7.b = i16 + 1;
                    k9Var7.a = org.telegram.ui.fy.class;
                    k9 k9Var8 = new k9();
                    arrayList.add(k9Var8);
                    k9Var8.b = -1;
                    k9Var8.a = ze1.class;
                    k9Var8.c = MessagesController.getInstance(o2Var.getCurrentAccount()).getChat(Long.valueOf(-j10));
                }
                Collections.sort(arrayList, new lh.e4(21));
            }
        }
        b5Var = parentLayout;
        arrayList2 = arrayList;
