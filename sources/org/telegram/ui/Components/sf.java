    ...
    */
    public final void afterTextChanged(Editable editable) {
        ...
        if (numberTextView2 != null) {
            numberTextView2.animate().alpha(0.0f).scaleX(0.5f).scaleY(0.5f).setDuration(100L).setListener(new j6(this, 5));
        }
        z10 = true;
        if (chatActivityEnterView.p3 != z10) {
        }
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        boolean z10 = (egVar == null ? MessagesController.getGlobalEmojiSettings().getInt("selected_page", 0) : egVar.getCurrentPage()) != 0 && (chatActivityEnterView.I2 || chatActivityEnterView.J2);
        ...
        if (chatActivityEnterView.Y2 != null && !chatActivityEnterView.Q2) {
            ...
            chatActivityEnterView.Y2.f1(charSequence, i11 > i13 || i12 - i11 > 2, false);
        }
