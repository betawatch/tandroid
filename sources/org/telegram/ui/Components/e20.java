    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!z10) {
            ...
            if (this.a != null) {
                ...
                this.a.addListener(new d20(this, 0));
                this.f = NotificationCenter.getInstance(f20Var.a).setAnimationInProgress(this.f, null);
                this.a.start();
                this.b = true;
            } else {
                this.h = dp5;
        ...
        int i15 = this.n;
        f20Var.e = i15 > 0 ? AndroidUtilities.dp(40.0f) + i15 : 0;
