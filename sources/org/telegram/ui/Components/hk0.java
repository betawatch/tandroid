...
public final class hk0 extends View {
    ...
    public hk0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.b = new Paint(1);
        this.c = new Paint(1);
        this.d = new Paint(1);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z13) {
                ...
                if (f71Var != null) {
                    ...
                    this.V = clamp;
                    f71Var.L((long) (clamp * this.n.p()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.T) {
                ...
                f71 f71Var2 = this.n;
                if (f71Var2 != null) {
                    f71Var2.L((long) (this.s * f71Var2.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.w) {
                f71 f71Var3 = this.n;
                if (f71Var3 != null) {
                    f71Var3.L(Math.max((long) (this.s * f71Var3.p()), ((long) (this.v * this.n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
