...
public final class hk0 extends View {
    ...
    public hk0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.b = new Paint(1);
        this.c = new Paint(1);
        this.d = new Paint(1);
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        if (e > 0.0f) {
            ...
            gg0 gg0Var3 = gg0Var;
            gg0Var3.setBounds(0, (-dp8) / 2, dp8, dp8 / 2);
            gg0Var3.g = (int) (e * 255.0f);
            gg0Var3.draw(canvas);
            canvas.restore();
            if (e7 > 0.0f) {
                canvas.save();
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z13) {
                ...
                if (h71Var != null) {
                    ...
                    this.V = clamp;
                    h71Var.L((long) (clamp * this.n.p()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.T) {
                ...
                h71 h71Var2 = this.n;
                if (h71Var2 != null) {
                    h71Var2.L((long) (this.s * h71Var2.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.w) {
                h71 h71Var3 = this.n;
                if (h71Var3 != null) {
                    h71Var3.L(Math.max((long) (this.s * h71Var3.p()), ((long) (this.v * this.n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
