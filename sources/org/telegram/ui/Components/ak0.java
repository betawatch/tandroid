...
public final class ak0 extends FrameLayout {
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        v9 v9Var = this.d;
        if (str == null) {
            v9Var.setAnimatedEmojiDrawable(new p5(0, i10, this.v.g));
        ...
        for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
            if (tL_availableReaction.reaction.equals(this.v.f)) {
                v9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.j6.a7, 1.0f), tL_availableReaction);
                v9Var.setVisibility(0);
                imageView.setVisibility(8);
                return;
            }
