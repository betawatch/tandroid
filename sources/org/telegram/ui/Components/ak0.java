...
public final class ak0 extends FrameLayout {
    ...
    public ak0(Context context, org.telegram.ui.ActionBar.e6 e6Var, int i10, MessageObject messageObject, TLRPC.ReactionCount reactionCount, boolean z10) {
        super(context);
        ...
        sj0 sj0Var = new sj0(this, context, e6Var);
        this.e = sj0Var;
        s4.c0 c0Var = new s4.c0();
        sj0Var.setLayoutManager(c0Var);
        if (Build.VERSION.SDK_INT >= 29) {
            sj0Var.setVerticalScrollbarThumbDrawable(new ColorDrawable(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.i6, false)));
        }
        tj0 tj0Var = new tj0(this, i10, context, e6Var, z10);
        this.f = tj0Var;
        sj0Var.setAdapter(tj0Var);
        sj0Var.setOnItemClickListener(new j(this, 10));
        sj0Var.setOnItemLongClickListener(new lv(this, 14));
        sj0Var.j(new uj0(this, c0Var));
        sj0Var.setVerticalScrollBarEnabled(true);
        sj0Var.setAlpha(0.0f);
        addView(sj0Var, w7.y5.c(-1.0f, -1));
        vj0 vj0Var = new vj0(this, context, e6Var);
        this.h = vj0Var;
        vj0Var.f(org.telegram.ui.ActionBar.j6.G8, org.telegram.ui.ActionBar.j6.i6, -1);
        vj0Var.setIsSingleCell(true);
        vj0Var.setItemsCount(this.a);
        ...
        vj0Var.setViewType(arrayList.isEmpty() ? 16 : 23);
    }

    public static /* synthetic */ void a(ak0 ak0Var, TLObject tLObject) {
        ArrayList arrayList = ak0Var.H;
        LongSparseArray longSparseArray = ak0Var.r;
        ArrayList arrayList2 = ak0Var.n;
        int i10 = ak0Var.b;
        ...
        if (!ak0Var.w) {
            ...
            duration.addUpdateListener(new q70(ak0Var, 5));
            duration.addListener(new ed0(ak0Var, 7));
            duration.start();
            ak0Var.j();
            ak0Var.w = true;
        }
    ...
    public final void h(List list) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                TLObject tLObject = pj0Var.a;
                if (pj0Var.c > 0) {
                    int i10 = 0;
                    while (true) {
                        if (i10 < arrayList.size()) {
                            TLRPC.MessagePeerReaction messagePeerReaction = (TLRPC.MessagePeerReaction) arrayList.get(i10);
                            if (messagePeerReaction != null && messagePeerReaction.date <= 0 && MessageObject.getPeerId(messagePeerReaction.peer_id) == pj0Var.b) {
                                messagePeerReaction.date = pj0Var.c;
        ...
        while (it2.hasNext()) {
            ...
            if (((ArrayList) longSparseArray.get(j3)) == null) {
                ...
                tL_messagePeerReaction.date = pj0Var2.c;
    ...
    public final void i() {
        ...
        arrayList.addAll(arrayList2);
        cb0 cb0Var = new cb0(this.b, getContext(), this.K, arrayList2, 1);
        this.J = cb0Var;
        cb0Var.K = false;
    }
    ...
    public final void j() {
        if (this.y != null) {
            ...
            cb0 cb0Var = this.J;
            if (cb0Var != null) {
                dp = org.telegram.messenger.q.D(8.0f, cb0Var.getMeasuredHeight(), dp);
            }
            sj0 sj0Var = this.e;
