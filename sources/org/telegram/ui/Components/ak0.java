...
public final class ak0 extends FrameLayout {
    ...
    public ak0(Context context, org.telegram.ui.ActionBar.d6 d6Var, int i10, MessageObject messageObject, TLRPC.ReactionCount reactionCount, boolean z10) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            sj0Var.setVerticalScrollbarThumbDrawable(new ColorDrawable(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.i6, false)));
        }
        ...
        this.h = vj0Var;
        vj0Var.f(org.telegram.ui.ActionBar.h6.G8, org.telegram.ui.ActionBar.h6.i6, -1);
    ...
    public final void i() {
        ...
        arrayList.addAll(arrayList2);
        fb0 fb0Var = new fb0(this.b, getContext(), this.K, arrayList2, 1);
        this.J = fb0Var;
        fb0Var.K = false;
    }
