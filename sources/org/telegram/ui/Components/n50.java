...
public final class n50 extends DispatchQueue {
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 != 0) {
            if (i10 == 1) {
                finish();
                if (this.y && ((!((z11 = (obj = message.obj) instanceof q50)) || ((q50) obj).c != -2) && (v50Var = this.H.d1) != null)) {
            ...
            AndroidUtilities.runOnUIThread(new xm(this.H, i13, this.n[0], i14));
            c();
            c60 c60Var5 = this.H;
        ...
        if (this.f) {
            ...
            if (this.y) {
                ...
                c60 c60Var8 = this.H;
                v50 v50Var2 = c60Var8.d1;
                j50 j50Var = c60Var8.f0;
                ...
                v50Var2.F0 = true;
                int i17 = MessagesController.getInstance(v50Var2.H0.f).roundVideoSize;
                int i18 = MessagesController.getInstance(v50Var2.H0.f).roundVideoBitrate * 1024;
                AndroidUtilities.runOnUIThread(new th(i11));
                v50Var2.a = j50Var;
                v50Var2.d = i17;
                v50Var2.e = i17;
                v50Var2.f = i18;
            ...
            if (c60Var10.d1 != null && ((c60Var10.f1 == 0 && z12) || (this.H.f1 == 1 && z13))) {
                c60 c60Var11 = this.H;
                v50 v50Var3 = c60Var11.d1;
                SurfaceTexture surfaceTexture2 = this.n[c60Var11.f1];
                c60 c60Var12 = this.H;
                if (c60Var12.u0) {
                    i15 = c60Var12.f1;
                }
                v50Var3.f(surfaceTexture2, Integer.valueOf(i15), System.nanoTime());
            }
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            if (j3 == 0 || j10 == 0) {
                                ...
                                for (final int i13 = 0; i13 < 2; i13++) {
                                    ...
                                    AndroidUtilities.runOnUIThread(new xm(c60Var, i13, surfaceTextureArr[i13], i10));
                                }
                                if (BuildVars.LOGS_ENABLED) {
