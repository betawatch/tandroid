...
public final class n50 extends DispatchQueue {
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 != 0) {
            ...
            if (i10 != 2) {
                ...
                float f13 = f7 + 0.5f;
                float f14 = f10 + 0.5f;
                w50Var2.z0 = org.telegram.messenger.vl.i(ByteBuffer.allocateDirect(32));
            ...
            float f19 = f15 + 0.5f;
            float f20 = f16 + 0.5f;
            w50Var5.z0 = org.telegram.messenger.vl.i(ByteBuffer.allocateDirect(32));
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.vl.t(this.b, new StringBuilder("InstantCamera eglGetDisplay failed "));
            }
            finish();
            ...
            if (!this.b.eglChooseConfig(this.c, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 0, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    org.telegram.messenger.vl.t(this.b, new StringBuilder("InstantCamera eglChooseConfig failed "));
                }
                finish();
            } else if (iArr[0] > 0) {
                ...
                if (eglCreateContext == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.vl.t(this.b, new StringBuilder("InstantCamera eglCreateContext failed "));
                    }
                    finish();
                } else {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.vl.t(this.b, new StringBuilder("InstantCamera createWindowSurface failed "));
                            }
                            finish();
                            ...
                            FloatBuffer i11 = org.telegram.messenger.vl.i(ByteBuffer.allocateDirect(48));
                            w50Var.y0 = i11;
                            i11.put(fArr).position(0);
                            FloatBuffer i12 = org.telegram.messenger.vl.i(ByteBuffer.allocateDirect(32));
                            w50Var.z0 = i12;
                                ...
                                for (final int i13 = 0; i13 < 2; i13++) {
                                    ...
                                    surfaceTexture2.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.telegram.ui.Components.l50
                                        ...
                                        public final void onFrameAvailable(SurfaceTexture surfaceTexture3) {
                                            ...
                                            int i14 = i13;
                                            n50Var.H.R = true;
                                            n50Var.requestRender(i14 == 0, i14 == 1);
                                        }
                                    });
                                    AndroidUtilities.runOnUIThread(new wm(w50Var, i13, surfaceTextureArr[i13], i10));
                                }
                                if (BuildVars.LOGS_ENABLED) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.vl.t(this.b, new StringBuilder("InstantCamera eglMakeCurrent failed "));
                            }
                            finish();
                        }
                    } else {
            ...
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.vl.t(this.b, new StringBuilder("InstantCamera eglInitialize failed "));
            }
            finish();
        }
        this.f = z10;
