...
public abstract class d11 extends View {
    public boolean E;
    public float F;
    public Animator G;
    public yq0 H;
    ...
    public final void a() {
        ...
        ofFloat.addUpdateListener(new c11(this, 0));
        ofFloat.addListener(new gd0(this, 22));
        this.G = ofFloat;
        ofFloat.start();
    }
    ...
    public final void c() {
        ...
        ofFloat.addUpdateListener(new c11(this, 1));
        ofFloat.setDuration(210L);
        ofFloat.setInterpolator(new DecelerateInterpolator());
        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
        ofFloat2.addUpdateListener(new c11(this, 2));
        ofFloat2.setStartDelay(600L);
        ofFloat2.setDuration(250L);
        ValueAnimator ofFloat3 = ValueAnimator.ofFloat(1.0f, 0.0f);
        ofFloat3.setStartDelay(500L);
        ofFloat3.addUpdateListener(new c11(this, 3));
        qr qrVar = qr.g;
        ofFloat3.setInterpolator(qrVar);
        ofFloat3.setDuration(500L);
        ValueAnimator ofFloat4 = ValueAnimator.ofFloat(1.0f, 0.0f);
        ofFloat4.setStartDelay(400L);
        ofFloat4.addUpdateListener(new c11(this, 4));
