        ...
        if (l1Var.f == 12) {
            ...
            if (document != null) {
                ...
                if (view instanceof org.telegram.ui.Cells.d2) {
                    ...
                    if (yu0Var.z1) {
                        d2Var.c(yu0Var.W0[(messageObject.getDialogId() > yu0Var.g1 ? 1 : (messageObject.getDialogId() == yu0Var.g1 ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0, !yu0Var.Y0);
                    } else {
