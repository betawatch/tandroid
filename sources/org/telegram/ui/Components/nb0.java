...
public final class nb0 extends Drawable {
    ...
    public nb0() {
        ...
        this.e = new er(0.33d, 0.0d, 0.0d, 1.0d);
        this.h = 1.0f;
        this.j = new RectF();
        this.m = new Bitmap[3];
        this.n = new Paint(2);
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.save();
        Bitmap e9 = e();
        float f10 = e9 != null ? bounds.top : this.f;
        ...
        boolean z10 = (Build.VERSION.SDK_INT < 28 || this.Q == null || this.k == null || e9 == null) ? false : true;
        int i12 = this.q;
        float f17 = 1.0f;
        Paint paint = this.n;
        Paint paint2 = this.o;
        ...
        if (i12 < 0) {
            ...
            if (e9 != null) {
                if (z11) {
                    ...
                    if (this.u != null) {
                        Bitmap e10 = e();
                        pg.a aVar = this.b0;
                        if (aVar.a(e10) || this.c0 == null || this.d0 != i13) {
                            ...
                            Utilities.applyAlphaInvert(e10, this.c0, i13);
                        }
                        aVar.b(e10);
                    }
                    float width4 = e9.getWidth();
                    float height4 = e9.getHeight();
                    ...
                    this.A.reset();
                    float width5 = e9.getWidth();
                    float height5 = e9.getHeight();
                    ...
                    if (z10) {
                        Paint e11 = this.Q.e(this.k, e9, this.U, (int) (this.L * this.J), this.q, canvas.isHardwareAccelerated());
                        this.Q.d(this.A);
                        this.Q.c(rectF);
                        float f24 = this.I;
            ...
            if (e9 != null) {
                float width6 = e9.getWidth();
                float height6 = e9.getHeight();
                ...
                paint2.setAlpha((int) ((Math.abs(this.q) / 100.0f) * this.L * this.J));
                if (z12) {
                    Paint e12 = this.Q.e(this.k, e9, this.U, (int) (this.L * this.J), this.q, canvas.isHardwareAccelerated());
                    sb0 sb0Var = this.Q;
                    RectF rectF2 = sb0Var.j;
                    rectF2.set(0.0f, 0.0f, sb0Var.g, sb0Var.h);
                    Matrix matrix = sb0Var.i;
                    matrix.setRectToRect(rectF2, rectF, Matrix.ScaleToFit.FILL);
                    sb0Var.d(matrix);
                    this.Q.c(rectF);
                    canvas.drawRect(rectF, e12);
                } else {
                    canvas.drawBitmap(e9, (Rect) null, rectF, paint2);
                }
