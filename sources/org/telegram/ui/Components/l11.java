    ...
    public final void g() {
        ...
        if (this.b.get()) {
            ...
            while (i14 < this.T.size()) {
                k11 k11Var = (k11) this.T.get(i14);
                if (k11Var.d) {
                    ArrayList arrayList = this.T;
                    int i15 = 0;
                    for (int i16 = 0; i16 < arrayList.size(); i16++) {
                        i15 += ((k11) arrayList.get(i16)).u;
                    }
                    float f7 = k11Var.u;
                    float f10 = f7 / i15;
                    int[] iArr = k11Var.B;
                    ...
                    int i18 = k11Var.E.a ? 120000 : devicePerformanceClass != 1 ? devicePerformanceClass != 2 ? 30000 : 120000 : 60000;
                    if (k11Var.D) {
                        i18 /= 2;
                    }
                    float max = Math.max(AndroidUtilities.dpf2(0.4f), 1.0f);
                    k11Var.s = Utilities.clamp((int) ((r4 * i17) / (max * max)), (int) (i18 * f10), 10);
                    float f11 = i17;
                    float f12 = f11 / f7;
                    int round = (int) Math.round(Math.sqrt(r4 / f12));
                    k11Var.w = round;
                    k11Var.v = Math.round(k11Var.s / round);
                    while (true) {
                        i10 = k11Var.v;
                        i11 = k11Var.w;
                        i12 = i10 * i11;
                    ...
                    k11Var.s = i12;
                    k11Var.x = Math.max(f11 / i10, f7 / i11);
                    GLES20.glGenBuffers(2, iArr, i13);
                    for (int i19 = 0; i19 < 2; i19++) {
                        GLES20.glBindBuffer(34962, iArr[i19]);
                        GLES20.glBufferData(34962, k11Var.s * 28, null, 35048);
                    }
                    if (k11Var.e != null) {
                        this.U.add(k11Var);
                    }
                ...
                int i20 = k11Var.u;
                int i21 = k11Var.t;
                Matrix matrix = k11Var.r;
                l11 l11Var = k11Var.E;
                long nanoTime = System.nanoTime();
                double d = k11Var.b < 0 ? 0.0d : (nanoTime - r7) / 1.0E9d;
                k11Var.b = nanoTime;
                if (k11Var.n && !k11Var.o) {
                    matrix.reset();
                    matrix.postScale(i21, i20);
                    matrix.postTranslate(k11Var.i, k11Var.j);
                    k11Var.c();
                }
                k11Var.c = (float) ((f13 * d) + k11Var.c);
                GLES20.glUniformMatrix3fv(l11Var.x, 1, false, k11Var.p, 0);
                GLES20.glUniform1f(l11Var.y, k11Var.d ? 1.0f : 0.0f);
                GLES20.glUniform1f(l11Var.E, k11Var.c);
                GLES20.glUniform1f(l11Var.F, ((float) d) * f13);
                GLES20.glUniform1f(l11Var.G, k11Var.s);
                GLES20.glUniform3f(l11Var.I, k11Var.v, k11Var.w, k11Var.x);
                GLES20.glUniform2f(l11Var.P, k11Var.g, k11Var.h);
                GLES20.glUniform1f(l11Var.Q, z10 ? 0.8f : 1.0f);
                GLES20.glUniform1f(l11Var.R, z10 ? 1.0f : 0.6f);
                GLES20.glUniform2f(l11Var.J, i21, i20);
                GLES20.glUniform1f(l11Var.K, k11Var.y);
                GLES20.glUniform2f(l11Var.L, 0.0f, 0.0f);
                GLES20.glUniform1f(l11Var.N, k11Var.k);
                GLES20.glUniform1f(l11Var.O, k11Var.l);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, k11Var.A[0]);
                GLES20.glUniform1i(l11Var.M, 0);
                GLES20.glBindBuffer(34962, iArr2[k11Var.z]);
                ...
                GLES30.glBindBufferBase(35982, 0, iArr2[1 - k11Var.z]);
                GLES20.glVertexAttribPointer(0, 2, 5126, false, 28, 0);
                GLES20.glEnableVertexAttribArray(0);
                GLES20.glVertexAttribPointer(1, 2, 5126, false, 28, 8);
                GLES20.glEnableVertexAttribArray(1);
                ...
                GLES20.glDrawArrays(0, 0, k11Var.s);
                GLES30.glEndTransformFeedback();
                GLES20.glBindBuffer(34962, 0);
                GLES20.glBindBuffer(35982, 0);
                k11Var.d = false;
                k11Var.z = 1 - k11Var.z;
                if (k11Var.c > k11Var.l + (k11Var.D ? 2.0f : 0.9f)) {
                    k11Var.a();
                    this.T.remove(i14);
                ...
                if (glGetError == 0) {
                    try {
                        ...
                        for (int i22 = 0; i22 < this.U.size(); i22++) {
                            AndroidUtilities.runOnUIThread(((k11) this.U.get(i22)).e);
                        }
                        this.U.clear();
                        for (int i23 = 0; i23 < this.T.size(); i23++) {
                            ((k11) this.T.get(i23)).a();
                        }
                        this.T.clear();
            ...
            for (int i24 = 0; i24 < this.U.size(); i24++) {
                AndroidUtilities.runOnUIThread(((k11) this.U.get(i24)).e);
            }
            this.U.clear();
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 == 4) {
            while (i11 < arrayList.size()) {
                ...
                k11Var.g += message.arg1;
                k11Var.h += message.arg2;
                i11++;
            }
            return;
        }
