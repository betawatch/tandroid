        ...
        if (action == 0) {
            ...
            if (motionEvent.getAction() == 1 && !this.c && themeEditorView.l == null) {
                ...
                if (AndroidUtilities.isTablet()) {
                    b5Var = launchActivity.r0;
                    if (b5Var != null && b5Var.getFragmentStack().isEmpty()) {
                        b5Var = null;
                    }
                    if (b5Var == null) {
                        b5Var = launchActivity.s0;
                        if (b5Var != null) {
                        }
                    }
                    if (b5Var == null) {
                    ...
                    if (b5Var != null) {
                        org.telegram.ui.ActionBar.m2 m2Var = !b5Var.getFragmentStack().isEmpty() ? (org.telegram.ui.ActionBar.m2) b5Var.getFragmentStack().get(b5Var.getFragmentStack().size() - 1) : null;
                        if (m2Var != null && (themeDescriptions = m2Var.getThemeDescriptions()) != null) {
                            ...
                            editorAlert.setOnDismissListener(new ci.f1(i12));
                            ...
                            if (themeEditorView.b != null) {
                                ...
                                try {
                                    animatorSet.playTogether(ObjectAnimator.ofFloat(themeEditorView.a, (Property<l11, Float>) property, 1.0f, 0.0f), ObjectAnimator.ofFloat(themeEditorView.a, (Property<l11, Float>) View.SCALE_X, 1.0f, 0.0f), ObjectAnimator.ofFloat(themeEditorView.a, (Property<l11, Float>) View.SCALE_Y, 1.0f, 0.0f));
                                    animatorSet.setInterpolator(themeEditorView.i);
                                    animatorSet.setDuration(150L);
                                    animatorSet.addListener(new n11(themeEditorView, 0));
                                    animatorSet.start();
                                ...
                                if (this.c) {
                                    ...
                                    if (motionEvent.getAction() == 2) {
                                        ...
                                        int i13 = (int) (layoutParams.x + f10);
                                        layoutParams.x = i13;
                                        ...
                                        if (i17 < 0) {
                                            f7 = a4.a.e(i17, i14, 0.5f, 1.0f);
                                        } else {
                                            if (i17 > AndroidUtilities.displaySize.x - layoutParams.width) {
                                                f7 = org.telegram.messenger.ok.b((i17 - r9) + r8, i14, 0.5f, 1.0f);
                                            }
                                        }
                                        ...
                                        if (Math.abs(b10 - themeEditorView.g.x) <= dp || ((i10 = themeEditorView.g.x) < 0 && i10 > (-i11) / 4)) {
                                            ...
                                            if (themeEditorView.a.getAlpha() != 1.0f) {
                                                arrayList.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<l11, Float>) property, 1.0f));
                                            }
                                            ...
                                            if (Math.abs(b11 - i10) > dp) {
                                                ...
                                                if (i21 <= i22 - i11 || i21 >= i22 - ((i11 / 4) * 3)) {
                                                    ...
                                                    if (arrayList != null) {
                                                        ...
                                                        if (z10) {
                                                            z11 = true;
                                                            arrayList.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<l11, Float>) property, 0.0f));
                                                            animatorSet2.addListener(new n11(themeEditorView, 1 == true ? 1 : 0));
                                                        } else {
                                                            z11 = true;
                                                        }
                                            ...
                                            edit.putInt("sidex", 1);
                                            if (themeEditorView.a.getAlpha() != 1.0f) {
                                                arrayList2.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<l11, Float>) property, 1.0f));
                                            }
