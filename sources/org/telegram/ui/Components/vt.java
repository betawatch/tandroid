...
public class vt extends EditTextBoldCursor implements org.telegram.ui.ActionBar.x4 {
    ...
    public static /* synthetic */ void i(vt vtVar) {
    ...
    public static void j(vt vtVar, int i10, int i11, int i12, int i13) {
        ...
        try {
            text.setSpan(new h10(text.subSequence(i10, i11).toString(), s01Var, tL_messageEntityFormattedDate), i10, i11, 33);
    ...
    public static /* synthetic */ void k(vt vtVar, int i10, int i11, Runnable runnable, String str) {
        Editable text = vtVar.getText();
    ...
    public final void l(t01 t01Var) {
        ...
        if (t01Var == null) {
            ...
            for (int i11 = 0; i11 < zi0VarArr.length; i11++) {
                ...
                text.removeSpan(zi0VarArr[i11].s);
    ...
    public void makeSelectedDate() {
        ...
        wc0Var2.setFormatter(new gg.m2(calendar, i21, 4));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        while (true) {
            ...
            if (((AccessibilityNodeInfo.AccessibilityAction) cVar.a).getId() == 268435456) {
                eVar.a.removeAction((AccessibilityNodeInfo.AccessibilityAction) cVar.a);
                break;
            }
            i10++;
        }
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [org.telegram.ui.Cells.k9] */
    /* JADX WARN: Type inference failed for: r3v0, types: [org.telegram.ui.Components.EditTextBoldCursor, org.telegram.ui.Components.vt] */
    @Override // org.telegram.ui.Components.EditTextBoldCursor, android.view.View
    ...
    public void translateSelected() {
        ...
        g41Var.a0 = new qt(this, i10, selectionEnd);
        g41Var.show();
    ...
    public void showInputDialog(String str, String str2, String str3, boolean z4, boolean z10, ut utVar) {
        ...
        jVar.run();
        g2Var.n(frameLayout);
        g2Var.k(LocaleController.getString(R.string.OK), new o1(18, utVar, nVar));
        ...
        if (z10) {
            ...
            g2Var.o().setOnShowListener(new rt(1, nVar));
        }
