    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 7) {
            if (view instanceof org.telegram.ui.Cells.k7) {
                ...
                if (jv0Var.C1) {
                    k7Var.b(sparseArrayArr[(messageObject.getDialogId() > j3 ? 1 : (messageObject.getDialogId() == j3 ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0, !jv0Var.b1);
                    return;
                } else {
        ...
        if (i11 == 10 && (view instanceof org.telegram.ui.Cells.j7)) {
            ...
            if (jv0Var.C1) {
                j7Var.e(sparseArrayArr[(messageObject2.getDialogId() > j3 ? 1 : (messageObject2.getDialogId() == j3 ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject2.getId()) >= 0, !jv0Var.b1);
            } else {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 7) {
            ...
            if (i10 == 8) {
                ...
                if (i10 == 9) {
                    wt0 M = jv0.M(i11, jv0Var.j1, context, d6Var);
