...
public final class g71 extends Drawable implements v5, w6, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public final void draw(Canvas canvas) {
        ...
        if (f71Var != null) {
            float f14 = width * 2;
            f71Var.setRoundRadius((int) (0.13f * f14));
            f71Var.setImageCoords(centerX - width, centerY - width, f14, f14);
            f71Var.draw(canvas);
        }
    }
        ...
        if (obj != null && g71.class == obj.getClass()) {
            ...
            if (this.b == g71Var.b) {
                ...
                if (i10 == o20Var2.d && o20Var.e == o20Var2.e && o20Var.f == o20Var2.f && o20Var.g == o20Var2.g) {
                    ...
                    if (tL_videoSizeStickerMarkup2 != null && (tL_videoSizeStickerMarkup = g71Var.w) != null && tL_videoSizeStickerMarkup2.stickerset.id == tL_videoSizeStickerMarkup.stickerset.id && tL_videoSizeStickerMarkup2.sticker_id == tL_videoSizeStickerMarkup.sticker_id) {
                        return true;
                    }
                }
            }
