...
public final class g30 extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void a(g30 g30Var, Context context) {
        if (VoIPService.getSharedInstance() == null) {
            return;
        }
        VoIPService.getSharedInstance().toggleSpeakerphoneOrShowRouteSheet(g30Var.getContext(), Build.VERSION.SDK_INT < 23 || Settings.canDrawOverlays(context));
    }

    public static void b(g30 g30Var, Context context) {
        org.telegram.ui.d60.t1(g30Var.getContext(), new e30(context, 0), Build.VERSION.SDK_INT < 23 || Settings.canDrawOverlays(context), false);
    }
    ...
    public final void d(boolean z4) {
        ...
        if (isBluetoothOn) {
            z10 = z4;
            w2Var2.c(R.drawable.calls_bluetooth, -1, 0, 0.1f, true, LocaleController.getString(R.string.VoipAudioRoutingBluetooth), false, z10);
        } else {
            z10 = z4;
            if (z11) {
                w2Var2.c(R.drawable.calls_speaker, -1, 0, 0.3f, true, LocaleController.getString(R.string.VoipSpeaker), false, z10);
            } else if (sharedInstance.isHeadsetPlugged()) {
                w2Var2.c(R.drawable.calls_headphones, -1, 0, 0.1f, true, LocaleController.getString(R.string.VoipAudioRoutingHeadset), false, z10);
            } else {
                w2Var2.c(R.drawable.calls_speaker, -1, 0, 0.1f, true, LocaleController.getString(R.string.VoipSpeaker), false, z10);
            }
        }
        if (sharedInstance.mutedByAdmin()) {
            w2Var.c(R.drawable.calls_unmute, -1, i0.a.k(-1, 76), 0.1f, true, LocaleController.getString(R.string.VoipMutedByAdminShort), true, z10);
        } else {
            w2Var.c(R.drawable.calls_unmute, -1, i0.a.k(-1, (int) ((sharedInstance.isMicMute() ? 0.3f : 0.15f) * 255.0f)), 0.1f, true, LocaleController.getString(sharedInstance.isMicMute() ? R.string.VoipUnmute : R.string.VoipMute), sharedInstance.isMicMute(), z10);
        }
        invalidate();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (sharedInstance != null && sharedInstance.groupCall != null) {
            ...
            z8Var.i(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.p8[z8.e(chat != null ? chat.id : 0L)], false), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.q8[z8.e(chat != null ? chat.id : 0L)], false));
            z8Var.k(i10, chat);
            if (chat != null) {
            ...
            if (f10 != 1.0f) {
                ...
                if (z4) {
                    ...
                    if (f12 != 1.0f) {
                        ...
                        invalidate();
                        if (this.w) {
                            int d = i0.a.d(1.0f - this.B, org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.ch, false), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.eh, false));
                            int d10 = i0.a.d(1.0f - this.B, org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.dh, false), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.fh, false));
                            int d11 = i0.a.d(this.C, d, org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.gh, false));
                            int d12 = i0.a.d(this.C, d10, org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.hh, false));
                            this.w = false;
                            int i12 = this.r;
                            if (i12 == 0) {
