...
public final class wr {
    ...
    public final void a(Canvas canvas, int i10) {
        ...
        while (true) {
            ...
            dp = org.telegram.messenger.rl.u(4.0f, vrVar.e, dp);
            if (dp < 0) {
                break;
            }
            if (LocaleController.isRTL) {
                canvas.translate(-vrVar.e, 0.0f);
                vrVar.a(canvas);
                canvas.translate(-AndroidUtilities.dp(4.0f), 0.0f);
            } else {
                vrVar.a(canvas);
                canvas.translate(AndroidUtilities.dp(4.0f) + vrVar.e, 0.0f);
            }
            i11++;
        }
        if (i11 < arrayList.size()) {
            ...
            if (vrVar2 == null || vrVar2.a != size) {
                ...
                pz0 pz0Var2 = vrVar3.c;
                vrVar3.e = dp2 + ((int) pz0Var2.c);
                pz0Var2.j();
                vrVar3.d = org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.n8, false);
                this.d = vrVar3;
            }
            if (LocaleController.isRTL) {
