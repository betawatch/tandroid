...
public final class wr implements Interpolator {
    public static final wr f = new wr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final wr g = new wr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final wr h = new wr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final wr i = new wr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final wr j = new wr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final wr k = new wr(0.34d, 1.56d, 0.64d, 1.0d);
