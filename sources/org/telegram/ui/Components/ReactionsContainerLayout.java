...
public class ReactionsContainerLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ReactionsContainerLayout(final int i, BaseFragment baseFragment, Context context, int i2, Theme.ResourcesProvider resourcesProvider) {
            ...
            public void getItemOffsets(android.graphics.Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                    ...
                    if (childAdapterPosition != ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                        ...
                        i4 = (ReactionsContainerLayout.this.showUnlockPremiumButton() || ReactionsContainerLayout.this.showCustomEmojiReaction()) ? AndroidUtilities.dp(2.0f) : AndroidUtilities.dp(6.0f);
                    }
                }
                rect2.right = i4;
            }
        ...
        recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$$ExternalSyntheticLambda0
            ...
            public final void onItemClick(View view, int i4) {
                ReactionsContainerLayout.this.lambda$new$0(view, i4);
            }
        });
        recyclerListView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$$ExternalSyntheticLambda1
            ...
            public final boolean onItemClick(View view, int i4) {
                ...
                lambda$new$1 = ReactionsContainerLayout.this.lambda$new$1(i, view, i4);
                return lambda$new$1;
            }
        });
    ...
    private void drawBubbles(Canvas canvas, float f, float f2, float f3, int i) {
        ...
        canvas.restore();
        this.shadow.setAlpha(NotificationCenter.goingToPreviewTheme);
        this.bgPaint.setAlpha(NotificationCenter.goingToPreviewTheme);
    }
    ...
    */
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (z) {
            ...
            if (f10 != 1.0f) {
                max = Math.min(1.0f, f10 + (min / 220.0f));
                ...
                if (this.type != 1) {
                    ...
                    drawable.setBounds((int) ((paddingLeft + ((width3 + rect.right) * f5)) - rect.left), (getPaddingTop() - this.shadowPad.top) - i2, (int) (((getWidth() - getPaddingRight()) + this.shadowPad.right) * max3), (getHeight() - getPaddingBottom()) + this.shadowPad.bottom + i2);
                    this.shadow.draw(canvas);
                }
                ...
                if (this.skipDraw) {
                    ...
                    if (this.type == 1 || this.delegate.drawBackground()) {
                        ...
                        f6 = f12;
                        i = 5;
                        this.delegate.drawRoundRect(canvas, this.rect, this.radius, getX(), getY(), NotificationCenter.goingToPreviewTheme, false);
                    } else {
                ...
                if (!this.skipDraw && this.reactionsWindow != null) {
                    ...
                    canvas.save();
                    drawBubbles(canvas, f, max2, f2, clamp3);
                    canvas.restore();
                    return;
                }
                ...
                drawBubbles(canvas, f, max2, f2, NotificationCenter.goingToPreviewTheme);
                invalidate();
            }
        }
        if (!z) {
            ...
            if (f18 != 0.0f) {
                max = Math.max(0.0f, f18 - (min / 220.0f));
                this.flipVerticalProgress = max;
                invalidate();
            }
        }
    ...
    public void drawBubbles(Canvas canvas) {
        ...
        drawBubbles(canvas, this.bigCircleRadius * max, max, this.smallCircleRadius * max, this.type == 5 ? NotificationCenter.goingToPreviewTheme : (int) (Utilities.clamp(this.customEmojiReactionsEnterProgress / 0.2f, 1.0f, 0.0f) * (1.0f - this.customEmojiReactionsEnterProgress) * 255.0f));
    }
