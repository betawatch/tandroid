...
public final class bd {
    ...
    public bd(dd ddVar) {
        ...
        this.f = new e6(ddVar, 650L, qrVar);
        qr qrVar2 = qr.g;
        this.h = new e6(ddVar, 0L, 150L, qrVar2);
        this.i = 1.0f;
        this.j = new e6(ddVar, 0L, 150L, qrVar2);
        o6 o6Var = new o6(false, true, true, false);
        this.k = o6Var;
        this.m = new e6(ddVar, 0L, 150L, qrVar2);
        this.o = new e6(ddVar, 0L, 200L, qrVar);
        o6Var.r(-1);
    ...
    public final void a(Canvas canvas, float f7, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, float f18) {
        ...
        if (bitmap != null) {
            ...
            while (floor <= ceil) {
                ...
                int max = (int) (Math.max(0.0f, Math.min(1.0f, AndroidUtilities.lerp(1.0f, Math.min(v7.z6.a(a2, sin2, f11, f12) / AndroidUtilities.dpf2(64.0f), 1.0f), f17) * com.google.android.gms.internal.vision.e2.B((float) (Math.sin(sin * 3.141592653589793d) - 1.0d), 0.25f, 1.0f, abs * 0.65f * f18))) * 255.0f);
                Paint paint = this.a;
                paint.setAlpha(max);
                float f25 = dpf2;
