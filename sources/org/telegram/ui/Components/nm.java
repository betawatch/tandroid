...
public final class nm {
    ...
    public static void a(nm nmVar, MediaController.PhotoEntry photoEntry) {
        ...
        if (nmVar.c == null) {
            ...
            nmVar.c.setDelegate(new o1(14, nmVar, photoEntry));
        }
        String str = photoEntry.thumbPath;
        if (str != null) {
            nmVar.c.setImage(ImageLocation.getForPath(str), null, null, null, org.telegram.ui.ActionBar.k6.R4, 0L, null, null, 0);
            return;
        }
        if (photoEntry.path == null) {
            nmVar.c.setImageBitmap(org.telegram.ui.ActionBar.k6.R4);
            return;
        }
        if (photoEntry.isVideo) {
            nmVar.c.setImage(ImageLocation.getForPath("vthumb://" + photoEntry.imageId + ":" + photoEntry.path), null, null, null, org.telegram.ui.ActionBar.k6.R4, 0L, null, null, 0);
            nmVar.c.setAllowStartAnimation(true);
            return;
        }
        nmVar.c.setOrientation(photoEntry.orientation, true);
        nmVar.c.setImage(ImageLocation.getForPath("thumb://" + photoEntry.imageId + ":" + photoEntry.path), null, null, null, org.telegram.ui.ActionBar.k6.R4, 0L, null, null, 0);
    }
    ...
    public static void b(nm nmVar, im imVar, MessageObject.GroupedMessagePosition groupedMessagePosition, boolean z4) {
        ...
        if (z4) {
            ...
            if (rectF4 != null) {
                AndroidUtilities.lerp(rectF4, rectF2, e6, rectF4);
            }
            RectF rectF5 = nmVar.p;
            if (rectF5 != null) {
                AndroidUtilities.lerp(rectF5, rectF, e6, rectF5);
            }
            nmVar.j = AndroidUtilities.lerp(nmVar.j, nmVar.k, e6);
    ...
    */
    public final boolean c(Canvas canvas, boolean z4) {
        ...
        pm pmVar2 = omVar.z;
        qm qmVar = pmVar2.M;
        float f15 = pmVar2.M.G == this ? pmVar2.D : 0.0f;
        float lerp = AndroidUtilities.lerp(this.j, this.k, e6);
        if (lerp <= 0.0f) {
            return false;
        }
        RectF d = d();
        ...
        if (e6 < 1.0f && (rectF = this.p) != null) {
            f16 = AndroidUtilities.lerp(rectF.left, f16, e6);
            f17 = AndroidUtilities.lerp(this.p.top, f17, e6);
            f18 = AndroidUtilities.lerp(this.p.right, f18, e6);
            f19 = AndroidUtilities.lerp(this.p.bottom, f19, e6);
        }
        ...
        if (photoEntry == null || !photoEntry.hasSpoiler || photoEntry.isChatPreviewSpoilerRevealed) {
            ...
            if (!this.e && this.d.getBitmap() == null && this.c.getBitmap() != null) {
                ...
                c3 = 3;
                c10 = 2;
                jVar.c(canvas, pmVar, width, height, 1.0f, false);
                canvas.restore();
                pmVar.invalidate();
                pmVar.invalidate();
            }
            ...
            c3 = 3;
            c10 = 2;
            jVar2.c(canvas, pmVar, width2, height2, 1.0f, false);
            canvas.restore();
            pmVar.invalidate();
            pmVar.invalidate();
        }
        ...
        if (str3 == null || !(this.E == null || (str2 = this.F) == null || !str2.equals(str3))) {
            ...
            int i17 = org.telegram.ui.ActionBar.k6.V9;
            f12 = dp3;
            textPaint2.setColor(org.telegram.ui.ActionBar.k6.v0(i17, qmVar.a));
            int length = str3.length();
            float f25 = (length == 0 || length == 1 || length == 2) ? 14.0f : length != 3 ? 8.0f : 10.0f;
            this.B.setTextSize(AndroidUtilities.dp(f25));
            float f26 = i15 / 2.0f;
            f13 = f24;
            int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.W9, qmVar.a);
            Paint paint2 = this.z;
            paint2.setColor(v02);
            float f27 = (int) f26;
            float f28 = dp4;
            canvas2.drawCircle(f27, f27, f28, paint2);
            int offsetColor = AndroidUtilities.getOffsetColor(-1, org.telegram.ui.ActionBar.k6.v0(i17, qmVar.a), 1.0f, 1.0f);
            Paint paint3 = this.A;
        ...
        if (str4 != null) {
            ...
            if (bitmap3 == null || (str = this.H) == null || !str.equals(str4)) {
                ...
                float intrinsicWidth = qmVar.K.getIntrinsicWidth() + this.C.measureText(str4) + AndroidUtilities.dp(15.0f);
                Drawable drawable = qmVar.K;
                float max = Math.max(dp8, AndroidUtilities.dp(4.0f) + qmVar.K.getIntrinsicHeight());
                ...
                canvas3.drawRoundRect(rectF3, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), org.telegram.ui.ActionBar.k6.i2);
    ...
    public final RectF f(float f10) {
        ...
        om omVar = this.O;
        float f11 = (rectF3.left * omVar.r) + omVar.n;
        float f12 = (rectF3.top * omVar.s) + omVar.p;
        float width = rectF3.width() * omVar.r;
        float height = rectF3.height() * omVar.s;
        if (f10 < 1.0f && (rectF = this.f) != null) {
            f11 = AndroidUtilities.lerp((rectF.left * omVar.r) + omVar.n, f11, f10);
            f12 = AndroidUtilities.lerp((this.f.top * omVar.s) + omVar.p, f12, f10);
            width = AndroidUtilities.lerp(this.f.width() * omVar.r, width, f10);
            height = AndroidUtilities.lerp(this.f.height() * omVar.s, height, f10);
        }
        int i10 = this.i;
        if ((i10 & 4) == 0) {
            int i11 = omVar.m;
