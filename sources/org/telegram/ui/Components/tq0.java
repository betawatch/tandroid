...
public final class tq0 extends Drawable {
    public long a = 0;
        ...
        while (true) {
            ...
            if (f7 >= 0.0f) {
                ...
                if (i14 == i15 || i14 == i12) {
                    ...
                    D = org.telegram.messenger.em.D(3.0f, i16, dp6);
                    i10 = dp5;
                } else if (i14 == i11) {
                    ...
                    D = org.telegram.messenger.em.D(2.0f, i16, dp7);
                } else if (i14 == 2) {
                    i10 = AndroidUtilities.dp(5.0f * f10);
                    dp = AndroidUtilities.dp(f10 * 18.0f);
                    ...
                    D = org.telegram.messenger.em.D(2.0f, i16, dp8);
                } else if (i14 == i13) {
                    ...
                    dp3 = (intrinsicHeight / 2) + intrinsicHeight2;
                    i10 = dp9;
                    D = org.telegram.messenger.em.D(7.0f, i16, dp10);
                } else {
                    i10 = AndroidUtilities.dp(5.0f * f10);
                    dp = AndroidUtilities.dp(f10 * 18.0f);
                    ...
                    dp3 = ((intrinsicHeight / 2) + intrinsicHeight2) - AndroidUtilities.dp(7.0f);
                    D = org.telegram.messenger.em.D(42.0f, i16, dp11);
                }
                float f11 = fArr[i17];
                int y3 = (int) ((f11 < 0.5f ? f11 / 0.5f : org.telegram.messenger.a2.y(f11, 0.5f, 0.5f, 1.0f)) * 255.0f);
