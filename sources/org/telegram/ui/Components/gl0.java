...
public final class gl0 {
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.c6 c6Var, int i10) {
        ...
        if (messageObject == null) {
            ...
            this.A = v02;
            this.z = v02;
            this.x = org.telegram.ui.ActionBar.g6.l1(a2 ? 0.12f : 0.1f, v02);
            this.C = h();
        ...
        if (i10 != 4 || (message4 = messageObject.messageOwner) == null || MessageObject.getMedia(message4) == null || !(MessageObject.getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaContact)) {
            ...
            if (i10 != 0 && (messageObject.overrideLinkColor >= 0 || (messageObject.messageOwner != null && (((messageObject.isFromUser() || DialogObject.isEncryptedDialog(messageObject.getDialogId())) && user2 != null) || ((messageObject.isFromChannel() && chat != null) || (((message3 = messageObject.messageOwner) != null && (messageFwdHeader3 = message3.fwd_from) != null && messageFwdHeader3.from_id != null) || (messageObject.isSponsored() && (peerColor2 = messageObject.sponsoredColor) != null && peerColor2.color != -1))))))) {
                ...
                this.x = org.telegram.ui.ActionBar.g6.l1(0.1f, this.z);
                this.y = this.z;
                ...
                this.A = v04;
                this.z = v04;
                this.x = org.telegram.ui.ActionBar.g6.l1(0.1f, v04);
                this.y = org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Wc, c6Var);
            } else {
                ...
                m(messageObject.replyMessageObject, i14, c6Var);
                this.x = org.telegram.ui.ActionBar.g6.l1(0.1f, this.z);
                this.y = this.z;
            }
        } else {
        ...
        if (messageObject.shouldDrawWithoutBackground()) {
            ...
            this.z = -1;
            this.x = 0;
            this.y = org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Xc, c6Var);
        } else if (messageObject.isOutOwner() || i10 == 2) {
            if (i10 != 2 || messageObject.isOutOwner()) {
                int v05 = org.telegram.ui.ActionBar.g6.v0((this.i || this.j) ? org.telegram.ui.ActionBar.g6.bb : org.telegram.ui.ActionBar.g6.ab, c6Var);
                this.B = v05;
                this.A = v05;
                this.z = v05;
            } else {
                int v06 = org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.pk, c6Var);
                this.B = v06;
                this.A = v06;
                this.z = v06;
            }
            if (this.j) {
                this.R = true;
                this.z = org.telegram.ui.ActionBar.g6.l1(0.2f, this.z);
                this.A = org.telegram.ui.ActionBar.g6.l1(0.5f, this.A);
            } else if (this.i) {
                this.R = true;
                this.z = org.telegram.ui.ActionBar.g6.l1(0.35f, this.z);
            }
            this.x = org.telegram.ui.ActionBar.g6.l1(a2 ? 0.12f : 0.1f, this.B);
            this.y = org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.cb, c6Var);
        }
    ...
    public final void d(Canvas canvas, RectF rectF, float f10, boolean z10, boolean z11) {
        ...
        i5 i5Var;
        if (!z11) {
            int l1 = org.telegram.ui.ActionBar.g6.l1(f10, this.E.a(this.x, false));
            Paint paint = this.g;
            paint.setColor(l1);
            float[] fArr = this.e;
            if (gf.m0.c(fArr)) {
            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof k5) && (y2Var = ((k5) drawable).k) != null && y2Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (i10 != 0 || (i5Var = this.u) == null || this.w == 0) {
                            i5Var = this.t;
                        }
                        fl0 fl0Var = fl0VarArr[i10];
                        if (!fl0Var.e || z10) {
                            i5Var.v = (int) ((i5Var == this.u ? 1.0f : 0.3f) * 255.0f * fl0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(fl0Var.a);
                            float dp2 = AndroidUtilities.dp(fl0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * fl0Var.c * e9;
    ...
    */
    public final void e(Canvas canvas, RectF rectF, float f10) {
        ...
        int l1 = org.telegram.ui.ActionBar.g6.l1(f10, a2);
        Paint paint = this.b;
        paint.setColor(l1);
        float e9 = this.M.e(this.S);
        float e10 = this.J.e(this.i);
        float e11 = this.K.e(this.j);
        RectF rectF2 = this.a;
        if (e9 > 0.0f && !this.i) {
            ...
            rectF2.set(rectF.left, (AndroidUtilities.lerp(0.0f, 1.0f - er.i.getInterpolation(h7.n.a(((Math.max(pow, 0.5f) + 1.5f) % 3.5f) * 0.5f, 0.0f, 1.0f)), e9) * rectF.height()) + rectF.top, rectF.left + AndroidUtilities.dp(6.0f), (AndroidUtilities.lerp(1.0f, 1.0f - er.g.getInterpolation(h7.n.a((((pow + 1.5f) % 3.5f) - 1.5f) * 0.5f, 0.0f, 1.0f)), e9) * rectF.height()) + rectF.top);
        ...
        int l12 = org.telegram.ui.ActionBar.g6.l1(f10, a2);
        int h = i0.b.h(org.telegram.ui.ActionBar.g6.l1(e10 * f10, a3), l12);
        int h10 = this.j ? i0.b.h(org.telegram.ui.ActionBar.g6.l1(f10 * e11, a10), l12) : 0;
    ...
    public final void f(Canvas canvas, RectF rectF, float f10, float f11, float f12, float f13) {
        ...
        this.h.f(org.telegram.ui.ActionBar.g6.l1(0.1f, this.z), org.telegram.ui.ActionBar.g6.l1(0.3f, this.z), org.telegram.ui.ActionBar.g6.l1(0.3f, this.z), org.telegram.ui.ActionBar.g6.l1(1.25f, this.z));
        this.h.d(rectF);
        this.h.i(fArr);
    ...
    public final void i() {
        ...
        float e9 = this.M.e(this.S);
        this.T = (Math.min(30L, currentTimeMillis - this.V) * e9) + this.T;
        this.U = (Math.min(30L, currentTimeMillis - this.V) * e9) + this.U;
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        this.y = i11;
        this.x = org.telegram.ui.ActionBar.g6.l1(0.1f, i11);
    ...
    public final void m(MessageObject messageObject, int i10, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        if (i10 < 7) {
            int v02 = org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.r8[i10], c6Var);
            this.B = v02;
            this.A = v02;
            this.z = v02;
            this.j = false;
        ...
        if (color == null) {
            int v03 = org.telegram.ui.ActionBar.g6.v0((messageObject == null || !messageObject.isOutOwner()) ? org.telegram.ui.ActionBar.g6.Uc : org.telegram.ui.ActionBar.g6.ab, c6Var);
            this.B = v03;
            this.A = v03;
            this.z = v03;
            this.j = false;
    ...
    public final int o(org.telegram.ui.ActionBar.c6 c6Var) {
        View view;
        int i10 = org.telegram.ui.ActionBar.g6.q7;
        this.y = org.telegram.ui.ActionBar.g6.v0(i10, c6Var);
        this.z = org.telegram.ui.ActionBar.g6.v0(i10, c6Var);
        this.i = false;
        this.j = false;
        this.x = org.telegram.ui.ActionBar.g6.l1(0.1f, org.telegram.ui.ActionBar.g6.v0(i10, c6Var));
        if (this.v != 0 && this.t == null && (view = this.D) != null) {
            this.t = new i5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.s1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.s1) view).I0) {
                this.t.a();
    ...
    public final void q(int i10, boolean z10) {
        ...
        this.A = i10;
        this.z = i10;
        this.x = org.telegram.ui.ActionBar.g6.l1(z10 ? 0.12f : 0.1f, i10);
        this.C = i10;
    }
}
