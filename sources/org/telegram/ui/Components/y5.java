...
public class y5 extends ReplacementSpan {
    ...
    */
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f9, int i12, int i13, int i14, Paint paint) {
        ...
        this.spanDrawn = true;
        float f10 = (this.measuredSize / 2.0f) + f9;
        ...
        if (this.animateChanges) {
            ...
            this.moveAnimator.setInterpolator(jr.f);
    ...
    public float getExtraScale() {
        ...
        if (this.isAdded) {
            ...
            this.scaleAnimator.setInterpolator(jr.f);
                    ...
                    if (t5Var != null) {
                        ...
                        if (y5Var.spanDrawn) {
                            ...
                            if (p5Var2 == null) {
                                ...
                                p5Var2.setColorFilter(colorFilter == null ? org.telegram.ui.ActionBar.g6.v3 : colorFilter);
    ...
    public y5(TLRPC.Document document, float f9, Paint.FontMetricsInt fontMetricsInt) {
        this(document.id, f9, fontMetricsInt);
        this.document = document;
    }
                        ...
                        if (t5Var == 0) {
                            ...
                            if (y5Var.documentAbsolutePath != null) {
                                ...
                                if (document != null) {
                                    ...
                                    if (j10 != 0) {
                                        t5Var2.f = p5.n(UserConfig.selectedAccount, j10, null, i13);
                                    }
                                }
                            }
