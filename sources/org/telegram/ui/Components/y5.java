...
public class y5 extends ReplacementSpan {
    ...
    public static /* synthetic */ void a(y5 y5Var, ValueAnimator valueAnimator) {
    ...
    public static boolean access$400(y5 y5Var) {
        return (y5Var.moveAnimator == null && y5Var.scaleAnimator == null) ? false : true;
    }
    ...
    public static /* synthetic */ void b(y5 y5Var, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        y5Var.extraScale = floatValue;
    ...
    public static boolean c(Layout layout, int i10, int i11) {
        if (layout.getText() instanceof Spanned) {
            d11[] d11VarArr = (d11[]) ((Spanned) layout.getText()).getSpans(Math.max(0, i10), Math.min(layout.getText().length() - 1, i11), d11.class);
            for (int i12 = 0; d11VarArr != null && i12 < d11VarArr.length; i12++) {
                d11 d11Var = d11VarArr[i12];
    ...
    public static y5 cloneSpan(y5 y5Var, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (document != null) {
            y5Var2 = new y5(document, y5Var.scale, fontMetricsInt != null ? fontMetricsInt : y5Var.fontMetrics);
        } else {
            y5Var2 = new y5(y5Var.documentId, y5Var.scale, fontMetricsInt != null ? fontMetricsInt : y5Var.fontMetrics);
        }
    ...
    public static void drawAnimatedEmojis(Canvas canvas, Layout layout, u5 u5Var, float f7, List<vh.h> list, float f10, float f11, float f12, float f13) {
        drawAnimatedEmojis(canvas, layout, u5Var, f7, list, f10, f11, f12, f13, null);
    }
    ...
    */
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        if (this.animateChanges) {
            ...
            ofFloat.addUpdateListener(new r5(this, f12, f11, f14, f10, 0));
            this.moveAnimator.addListener(new s5(this, 2));
    ...
    public float getExtraScale() {
        ...
        if (this.isAdded) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.q5
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    switch (i11) {
                        case 0:
                            y5.b(this.b, valueAnimator2);
                            break;
                        default:
                            y5.a(this.b, valueAnimator2);
                            break;
                    }
                }
            });
            this.scaleAnimator.addListener(new s5(this, i11));
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.q5
                public final /* synthetic */ y5 b;
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator22) {
                    switch (i10) {
                        case 0:
                            y5.b(this.b, valueAnimator22);
                            break;
                        default:
                            y5.a(this.b, valueAnimator22);
                            break;
                    }
                }
            });
            this.scaleAnimator.addListener(new s5(this, i10));
            this.scaleAnimator.setInterpolator(qr.f);
            this.scaleAnimator.setDuration(130L);
            this.scaleAnimator.start();
        }
    ...
    public static void drawAnimatedEmojis(Canvas canvas, Layout layout, u5 u5Var, float f7, List<vh.h> list, float f10, float f11, float f12, float f13, ColorFilter colorFilter) {
        boolean z10;
        if (canvas == null || layout == null || u5Var == null) {
            return;
        }
        ArrayList arrayList = u5Var.c;
        int i10 = 0;
                ...
                while (i12 < arrayList2.size()) {
                    ...
                    if (t5Var != null) {
                        ...
                        if (y5Var.spanDrawn) {
                            ...
                            t5Var.e.set((int) (f15 - f14), (int) (f16 - f14), (int) (f15 + f14), (int) (f16 + f14));
                            float max = (list == null || list.isEmpty() || !t5Var.v) ? 1.0f : Math.max(0.0f, list.get(i10).n);
                            t5Var.r = f12;
                            t5Var.s = max;
                            t5Var.getClass();
                            ...
                            if (p5Var2 == null) {
                                if (t5Var.h != null) {
                                    ...
                                    t5Var.h.setAlpha((int) (t5Var.s * 255.0f * f13));
                                    t5Var.h.setBounds(t5Var.e);
                                    if (extraScale != 1.0f || t5Var.d.invert) {
                                        canvas.save();
                                        canvas.scale((t5Var.d.invert ? -1 : 1) * extraScale, extraScale, t5Var.e.centerX(), t5Var.e.centerY());
                                        t5Var.h.draw(canvas);
                                        canvas.restore();
                                    } else {
                                        t5Var.h.draw(canvas);
                                ...
                                p5Var2.setColorFilter(colorFilter == null ? org.telegram.ui.ActionBar.j6.v3 : colorFilter);
                                t5Var.f.q(currentTimeMillis);
                                float extraScale2 = t5Var.d.getExtraScale();
                                if (extraScale2 != 1.0f || t5Var.d.invert) {
                                    canvas.save();
                                    canvas.scale((t5Var.d.invert ? -1 : 1) * extraScale2, extraScale2, t5Var.e.centerX(), t5Var.e.centerY());
                                    p5 p5Var3 = t5Var.f;
                                    Rect rect2 = t5Var.e;
                                    float f17 = t5Var.s * f13;
                                    ai.l4 l4Var = p5Var3.k;
                                    if (l4Var != null) {
                                        l4Var.setImageCoords(rect2);
                                        p5Var3.k.setAlpha(f17);
                                        p5Var3.k.draw(canvas);
                                    }
                                    canvas.restore();
                                } else {
                                    p5 p5Var4 = t5Var.f;
                                    Rect rect3 = t5Var.e;
                                    float f18 = t5Var.s * f13;
                                    ai.l4 l4Var2 = p5Var4.k;
                                    if (l4Var2 != null) {
                                        l4Var2.setImageCoords(rect3);
                                        p5Var4.k.setAlpha(f18);
                                        p5Var4.k.draw(canvas);
                                    }
                                }
    ...
    public y5(TLRPC.Document document, float f7, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (characterStyleArr != null && characterStyleArr.length > 0 && ((y5VarArr = (y5[]) spanned.getSpans(0, spanned.length(), y5.class)) == null || y5VarArr.length > 0)) {
            ...
            for (int i11 = 0; i11 < characterStyleArr.length; i11++) {
                ...
                if (characterStyle != null && (characterStyle instanceof y5)) {
                    ...
                    cloneSpan.scale = y5Var.scale * f7;
    ...
    public y5(long j3, Paint.FontMetricsInt fontMetricsInt) {
    ...
    public static void release(View view, u5 u5Var) {
        ...
        while (u5Var.a.size() > 0) {
            u5Var.b(0);
        }
    }

    public y5(long j3, float f7, Paint.FontMetricsInt fontMetricsInt) {
        this.extraScale = 1.0f;
        this.full = false;
        this.top = false;
        this.invert = false;
    ...
    public static u5 update(int i10, View view, boolean z10, u5 u5Var, boolean z11, Layout... layoutArr) {
        ...
        while (i15 < layoutArr.length) {
            ...
            if (layout == null || !(layout.getText() instanceof Spanned)) {
                ...
                while (y5VarArr != null && i16 < y5VarArr.length) {
                    ...
                    if (y5Var == null) {
                        ...
                        if (u5Var2 == null) {
                            u5Var2 = new u5();
                            u5Var2.a = new ArrayList();
                            u5Var2.b = new HashMap();
                            u5Var2.c = new ArrayList();
                        }
                        ArrayList arrayList2 = u5Var2.a;
                        int i17 = 0;
                        while (true) {
                            ...
                            if (((t5) arrayList2.get(i17)).d == y5Var && ((t5) arrayList2.get(i17)).c == layout) {
                        ...
                        if (t5Var == 0) {
                            ...
                            if (y5Var.documentAbsolutePath != null) {
                                i12 = i15;
                                t5Var2.f = p5.n(UserConfig.selectedAccount, y5Var.getDocumentId(), y5Var.documentAbsolutePath, i13);
                            } else {
                                i12 = i15;
                                TLRPC.Document document = y5Var.document;
                                if (document != null) {
                                    t5Var2.f = p5.m(UserConfig.selectedAccount, i13, document);
                                } else {
                                    long j3 = y5Var.documentId;
                                    if (j3 != 0) {
                                        t5Var2.f = p5.n(UserConfig.selectedAccount, j3, null, i13);
                                    }
                                }
                            }
                            ...
                            HashMap hashMap = u5Var2.b;
                            w5 w5Var = (w5) hashMap.get(layout);
                            if (w5Var == null) {
                                w5Var = new w5(t5Var2.a, layout);
            ...
            if (u5Var2 != null) {
                ArrayList arrayList3 = u5Var2.a;
                int i19 = 0;
                while (i19 < arrayList3.size()) {
                    if (((t5) arrayList3.get(i19)).c == layout) {
        ...
        if (u5Var2 != null) {
            ArrayList arrayList4 = u5Var2.a;
            int i21 = 0;
            while (i21 < arrayList4.size()) {
                Layout layout2 = ((t5) arrayList4.get(i21)).c;
                int i22 = 0;
                while (true) {
