...
public class y5 extends ReplacementSpan {
    ...
    public static void drawAnimatedEmojis(Canvas canvas, Layout layout, u5 u5Var, float f7, List<uh.h> list, float f10, float f11, float f12, float f13) {
    ...
    */
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        if (this.animateChanges) {
            ...
            this.moveAnimator.setInterpolator(wr.f);
    ...
    public float getExtraScale() {
        ...
        if (this.isAdded) {
            ...
            this.scaleAnimator.setInterpolator(wr.f);
    ...
    public static void drawAnimatedEmojis(Canvas canvas, Layout layout, u5 u5Var, float f7, List<uh.h> list, float f10, float f11, float f12, float f13, ColorFilter colorFilter) {
        boolean z10;
                        ...
                        if (y5Var.spanDrawn) {
                            ...
                            if (p5Var2 == null) {
                                ...
                                if (extraScale2 != 1.0f || t5Var.d.invert) {
                                    ...
                                    gg.h1 h1Var = p5Var3.k;
                                    if (h1Var != null) {
                                        h1Var.setImageCoords(rect2);
                                    ...
                                    gg.h1 h1Var2 = p5Var4.k;
                                    if (h1Var2 != null) {
                                        h1Var2.setImageCoords(rect3);
