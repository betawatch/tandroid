...
public final class vg extends f6 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (fragmentContextView3 == null || !((currentStyle = fragmentContextView3.getCurrentStyle()) == 3 || currentStyle == 1)) {
            ...
            for (int i10 = 0; i10 < entriesCount; i10++) {
                ...
                float c3 = n10.c();
                if (c3 > 0.0f && ((fragmentContextView2 = this.x) == view || fragmentContextView2.getParent() == view)) {
                    cd capsuleBlobDrawable = this.x.getCapsuleBlobDrawable();
        ...
        while (i12 < entriesCount2) {
            ...
            if (min > 0.0f && (!z10 || (fragmentContextView = this.x) == null || (fragmentContextView != view2 && fragmentContextView.getParent() != view2))) {
                ...
                org.telegram.ui.ActionBar.g6.k0.setAlpha((int) (alpha * min));
                float f9 = 1.0f - min;
                canvas2.drawLine(getPaddingLeft() + (AndroidUtilities.dp(16.0f) * f9), paddingTop2, getWidth() - ((AndroidUtilities.dp(16.0f) * f9) + getPaddingRight()), paddingTop2, org.telegram.ui.ActionBar.g6.k0);
    ...
    public final void j() {
        ...
        if (dVar != null) {
            ...
            this.s.setBounds(getPaddingLeft() - AndroidUtilities.dp(7.0f), 0, AndroidUtilities.dp(7.0f) + (getMeasuredWidth() - getPaddingRight()), getPaddingBottom() + getPaddingTop() + ((int) f9));
            this.s.p(Math.min(AndroidUtilities.dp(18.0f), f9 / 2.0f));
        }
    }
