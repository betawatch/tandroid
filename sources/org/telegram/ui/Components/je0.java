...
public final class je0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f10 != 1.0f) {
            paint.setColor(se0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
        ...
        int themedColor = se0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            se0 se0Var = this.d;
            if (se0Var.w != 0 && motionEvent.getY() < se0Var.w && se0Var.e.getAlpha() == 0.0f) {
                se0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) se0Var.f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.b = true;
        int dp = AndroidUtilities.dp(80.0f);
        pe0 pe0Var = se0Var.b;
        int i15 = pe0Var.a.B;
        for (int i16 = 0; i16 < i15; i16++) {
            ViewGroup a2 = pe0Var.a(this.c, i16);
        ...
        if (ke0Var.getPaddingTop() != i17) {
            ke0Var.getPaddingTop();
            ke0Var.setPadding(0, i17, 0, 0);
        }
        this.b = false;
