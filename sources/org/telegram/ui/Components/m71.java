...
public abstract class m71 extends View implements NotificationCenter.NotificationCenterDelegate {
    public int E;
    ...
    public final org.telegram.ui.kr0 M;
    public org.telegram.ui.bu0 N;
    public double O;
    public boolean P;
    ...
    public m71(Context context, org.telegram.ui.kr0 kr0Var) {
        super(context);
        this.n = -1;
        ...
        imageReceiver.setDelegate(new mv(this, 29));
    }
    ...
    public final void a() {
        ...
        Utilities.globalQueue.postRunnable(new i71(this, 0));
        setVisibility(4);
        this.w = null;
        this.G = null;
        invalidate();
    ...
    */
    public final void c(f71 f71Var, MessageObject messageObject) {
        ...
        if (f71Var.t() > 0) {
            d71 d71Var = null;
            for (int i10 = 0; i10 < f71Var.t(); i10++) {
                ArrayList arrayList = f71Var.u(i10).d;
                ...
                while (i11 < size) {
                    ...
                    i11++;
                    d71 d71Var2 = (d71) obj;
                    if (d71Var == null || ((!d71Var.b() && d71Var2.b()) || (d71Var.b() == d71Var2.b() && d71Var2.i * d71Var2.j < d71Var.i * d71Var.j))) {
                        d71Var = d71Var2;
                    }
                }
            }
            if (d71Var != null && !d71Var.b()) {
                int o9 = f71Var.o();
                b71 u10 = (o9 < 0 || o9 >= f71Var.t()) ? null : f71Var.u(o9);
                if (u10 != null) {
                    d71Var = u10.a();
                }
            }
            ...
            if (d71Var != null && !d71Var.d.equals(this.d)) {
                if (this.a) {
                    a();
                }
                this.d = d71Var.d;
                DispatchQueue dispatchQueue = Utilities.globalQueue;
                fr0 fr0Var = new fr0((org.telegram.ui.ft0) this, d71Var, messageObject, 13);
                this.e = fr0Var;
            ...
            if (uri != null && !uri.equals(this.d)) {
                ...
                fr0 fr0Var2 = new fr0((org.telegram.ui.ft0) this, uri, messageObject, 12);
                this.e = fr0Var2;
    ...
    public final void d(File file) {
        try {
            ...
            while (true) {
                ...
                if (readLine == null) {
                    Collections.sort(arrayList, Comparator$-CC.comparingDouble(new j71(0)));
                    this.a0 = j3;
                    this.b0 = i10;
                    this.c0 = i11;
                    this.d0 = arrayList;
                ...
                if (readLine.startsWith("file=mtproto:")) {
                    ...
                    if (split.length == 3) {
                        arrayList.add(new l71(Integer.parseInt(split[1]), Integer.parseInt(split[2]), Double.parseDouble(split[0])));
                    }
                }
            }
        } catch (Exception e) {
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [java.lang.Runnable, org.telegram.ui.Components.k71] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void e(MessageObject messageObject, final float f7, int i10) {
        ...
        DispatchQueue dispatchQueue = Utilities.globalQueue;
        ?? r52 = new Runnable() { // from class: org.telegram.ui.Components.k71
            @Override // java.lang.Runnable
            public final void run() {
                int i13;
                m71 m71Var = m71.this;
                RectF rectF = m71Var.H;
                if (m71Var.b == null) {
                    m71Var.h = f7;
                    return;
                }
                int max = Math.max(200, AndroidUtilities.dp(100.0f));
                Bitmap q6 = m71Var.b.q(j10, false);
                if (q6 != null) {
                    ...
                    try {
                        ...
                        canvas.drawBitmap(q6, (Rect) null, rectF, m71Var.I);
                ...
                AndroidUtilities.runOnUIThread(new ar0(18, m71Var, q6));
            }
        };
        this.f = r52;
