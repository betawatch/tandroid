    ...
    public final void b(Canvas canvas, View view) {
        ...
        if (i0Var != null) {
            ...
            for (int i13 = 0; i13 < min; i13++) {
                yv0 yv0Var2 = (yv0) arrayList.get(i13);
                float f7 = yv0Var2.a;
                float f10 = yv0Var2.b;
                int i14 = yv0Var2.j;
                float f11 = dp / 2.0f;
                ...
                i0Var.e(i13, i0.a.k(this.n, (int) (yv0Var2.f * 255.0f)));
                e0.i0.a((float[]) i0Var.b, i13, f7 - f11, f10 - f11, f7 + f11, f10 + f11);
                float f13 = dp;
                e0.i0.a((float[]) i0Var.c, i13, f12, 0.0f, f12 + f13, f13);
            }
            g0.a.b(canvas, i0Var, min, this.b);
        } else {
            int size = arrayList.size();
            for (int i15 = 0; i15 < size; i15++) {
                yv0 yv0Var3 = (yv0) arrayList.get(i15);
                zv0 zv0Var = yv0Var3.k;
                Paint paint = zv0Var.c;
                if (yv0Var3.j != 0) {
                    Bitmap bitmap = zv0Var.j;
                    Paint paint2 = zv0Var.e;
                    if (bitmap == null) {
                        zv0Var.j = a(false);
                    }
                    paint2.setAlpha((int) (yv0Var3.f * 255.0f));
                    canvas.save();
                    float f14 = yv0Var3.i;
                    canvas.scale(f14, f14, yv0Var3.a, yv0Var3.b);
                    canvas.drawBitmap(zv0Var.j, yv0Var3.a, yv0Var3.b, paint2);
                    canvas.restore();
                } else {
                    paint.setAlpha((int) (yv0Var3.f * 255.0f));
                    canvas.drawPoint(yv0Var3.a, yv0Var3.b, paint);
                }
            }
        }
        int i16 = this.h;
        ...
        if (size2 < i11) {
            ...
            while (i19 < i17) {
                if (arrayList.size() >= i11 || Utilities.random.nextFloat() <= 0.7f) {
                    ...
                    yv0Var.f = 0.0f;
                    yv0Var.h = 0.0f;
                    yv0Var.i = Utilities.random.nextFloat() * 1.2f;
                    yv0Var.j = Utilities.random.nextInt(2);
                    if (i16 == 0) {
                        yv0Var.g = Utilities.random.nextInt(100) + 2000;
                    } else {
                        yv0Var.g = Utilities.random.nextInt(2000) + 3000;
                    }
                    yv0Var.e = (Utilities.random.nextFloat() * 4.0f) + 20.0f;
        ...
        while (i12 < size3) {
            yv0 yv0Var4 = (yv0) arrayList.get(i12);
            float f15 = yv0Var4.h;
            float f16 = yv0Var4.g;
            if (f15 >= f16) {
                ...
                if (i16 == 0) {
                    if (f15 < 200.0f) {
                        yv0Var4.f = AndroidUtilities.accelerateInterpolator.getInterpolation(f15 / 200.0f);
                    } else {
                        yv0Var4.f = 1.0f - AndroidUtilities.decelerateInterpolator.getInterpolation((f15 - 200.0f) / (f16 - 200.0f));
                    }
                } else if (f15 < 200.0f) {
                    yv0Var4.f = AndroidUtilities.accelerateInterpolator.getInterpolation(f15 / 200.0f);
                } else {
                    float f17 = f16 - f15;
                    if (f17 < 2000.0f) {
                        yv0Var4.f = AndroidUtilities.decelerateInterpolator.getInterpolation(f17 / 2000.0f);
                    }
                }
                float f18 = yv0Var4.a;
                float f19 = yv0Var4.c;
                float f20 = yv0Var4.e;
                float f21 = min2;
                yv0Var4.a = a4.a.A(f19 * f20, f21, 500.0f, f18);
                yv0Var4.b = (((yv0Var4.d * f20) * f21) / 500.0f) + yv0Var4.b;
                yv0Var4.h += f21;
            }
            i12++;
            i18 = 40;
