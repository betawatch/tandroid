...
public final class r61 extends Drawable implements u5, v6, NotificationCenter.NotificationCenterDelegate {
    ...
    public r61(TLRPC.VideoSize videoSize, boolean z10, int i10) {
        ...
        if (videoSize instanceof TLRPC.TL_videoSizeEmojiMarkup) {
            o5 o5Var = new o5((i10 == 1 && z10) ? 7 : i10 == 2 ? 15 : 8, UserConfig.selectedAccount, ((TLRPC.TL_videoSizeEmojiMarkup) videoSize).emoji_id);
            this.h = o5Var;
    ...
    */
    ...
    public final void draw(Canvas canvas) {
        ...
        if (q61Var != null) {
            float f14 = width * 2;
            q61Var.setRoundRadius((int) (0.13f * f14));
            q61Var.setImageCoords(centerX - width, centerY - width, f14, f14);
            q61Var.draw(canvas);
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && r61.class == obj.getClass()) {
            ...
            if (this.b == r61Var.b) {
                o20 o20Var = this.a;
                int i10 = o20Var.d;
                o20 o20Var2 = r61Var.a;
                if (i10 == o20Var2.d && o20Var.e == o20Var2.e && o20Var.f == o20Var2.f && o20Var.g == o20Var2.g) {
                    o5 o5Var2 = this.h;
                    if (o5Var2 != null && o5Var != null) {
                        return o5Var2.i() == o5Var.i();
                    }
                    TLRPC.TL_videoSizeStickerMarkup tL_videoSizeStickerMarkup2 = this.w;
                    if (tL_videoSizeStickerMarkup2 != null && (tL_videoSizeStickerMarkup = r61Var.w) != null && tL_videoSizeStickerMarkup2.stickerset.id == tL_videoSizeStickerMarkup.stickerset.id && tL_videoSizeStickerMarkup2.sticker_id == tL_videoSizeStickerMarkup.sticker_id) {
                        return true;
                    }
                }
            }
    ...
    @Override // org.telegram.ui.Components.v6
    public final /* synthetic */ void a(bj0 bj0Var) {
    }
