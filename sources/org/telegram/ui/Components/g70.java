...
public final class g70 extends xl0 {
    ...
    public final TLObject E(int i10) {
        ...
        if (DialogObject.isUserDialog(dialog.id)) {
            i12 = ((org.telegram.ui.ActionBar.f3) m70Var).currentAccount;
            return MessagesController.getInstance(i12).getUser(Long.valueOf(dialog.id));
        }
        i11 = ((org.telegram.ui.ActionBar.f3) m70Var).currentAccount;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 2) {
            m70 m70Var = this.c;
            if (i10 == 3) {
                view = new org.telegram.ui.Cells.h4(context, 1, 0, m70Var.m0 != null);
            } else if (i10 == 4) {
                ...
                org.telegram.ui.fu fuVar = m70Var.m0;
                vh.n nVar = f70Var.d;
                if (fuVar != null) {
