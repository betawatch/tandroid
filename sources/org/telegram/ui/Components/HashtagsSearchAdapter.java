...
public abstract class HashtagsSearchAdapter extends UniversalAdapter {
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.HashtagsSearchAdapter$$ExternalSyntheticLambda2
            ...
            public final void run() {
                HashtagsSearchAdapter.this.scrollToTop(true);
            }
        });
    }
    ...
    public void search(String str) {
        ...
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.HashtagsSearchAdapter$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                HashtagsSearchAdapter.$r8$lambda$HUrBpdTFncWWyEi2-Yg2z3xmHlk(HashtagsSearchAdapter.this, i, hashtag);
            }
        };
    ...
    public static /* synthetic */ void $r8$lambda$HUrBpdTFncWWyEi2-Yg2z3xmHlk(final HashtagsSearchAdapter hashtagsSearchAdapter, final int i, String str) {
        ...
        hashtagsSearchAdapter.reqId = ConnectionsManager.getInstance(hashtagsSearchAdapter.currentAccount).sendRequest(tL_channels_searchPosts, new RequestDelegate() { // from class: org.telegram.ui.Components.HashtagsSearchAdapter$$ExternalSyntheticLambda3
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                HashtagsSearchAdapter.$r8$lambda$Xnn3pljL4q2uf9Fnkn6R8y7R_uU(HashtagsSearchAdapter.this, i, sb2, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$Xnn3pljL4q2uf9Fnkn6R8y7R_uU(final HashtagsSearchAdapter hashtagsSearchAdapter, final int i, final String str, final TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.HashtagsSearchAdapter$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                HashtagsSearchAdapter.$r8$lambda$JNJvzFIeEZoZDRY5oBboHcFbvG0(HashtagsSearchAdapter.this, i, tLObject, str);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$JNJvzFIeEZoZDRY5oBboHcFbvG0(HashtagsSearchAdapter hashtagsSearchAdapter, int i, TLObject tLObject, String str) {
        if (i != hashtagsSearchAdapter.searchId) {
            return;
        }
