...
public final class z80 extends g7.r8 {
    ...
    public final jc.d e = new jc.d(new za.b(10), new ab.a(11));
    ...
    public static int B(je.p pVar) {
        ...
        je.p pVar3 = (je.p) pVar2.c;
        if (!(pVar3 instanceof je.s) || (str = (sVar = (je.s) pVar3).g) == null) {
            return -1;
        }
        int i10 = 3;
        if (str.length() < 3) {
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        if (z10) {
                            y80 y80Var2 = (y80) obj;
                            if ("summary".equalsIgnoreCase(y80Var2.a.a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(y80Var2.c, sb2);
                                String trim = sb2.toString().trim();
                                pageblockdetails.title = trim.isEmpty() ? new TL_iv.textEmpty() : d90.j(trim);
                            }
                        }
                        if (obj instanceof x80) {
                            arrayList2.add(((x80) obj).a);
                        } else if (z10) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof x80) {
                TL_iv.PageBlock pageBlock = ((x80) obj).a;
    ...
    public final void b(je.c cVar) {
        ...
        for (je.p pVar = (je.p) cVar.c; pVar != null; pVar = (je.p) pVar.f) {
    ...
    public final void f(je.h hVar) {
        ...
        pageblockpreformatted.text = d90.d(d90.j(hVar.k));
        String str = hVar.j;
        if (str == null) {
            str = "";
        }
    ...
    public final void g(je.i iVar) {
        TL_iv.RichText d = d90.d(d90.a(iVar, null));
        if (this.c.isEmpty()) {
            this.b = d;
        }
        switch (iVar.g) {
    ...
    public final void j(je.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = d90.d(d90.j(lVar.g));
    ...
    public final void k(je.n nVar) {
        if (!(nVar instanceof ee.a)) {
            ...
            pageblockparagraph.text = d90.c(((ic.a) nVar).g);
        ...
        for (je.p pVar = (je.p) ((ee.a) nVar).c; pVar != null; pVar = (je.p) pVar.f) {
            boolean z10 = pVar instanceof ee.e;
            if (z10 || (pVar instanceof ee.b)) {
                for (je.p pVar2 = (je.p) pVar.c; pVar2 != null; pVar2 = (je.p) pVar2.f) {
                    if (pVar2 instanceof ee.f) {
                        ArrayList<TL_iv.pageTableRow> arrayList = pageblocktable.rows;
                        TL_iv.pageTableRow pagetablerow = new TL_iv.pageTableRow();
                        for (je.p pVar3 = (je.p) ((ee.f) pVar2).c; pVar3 != null; pVar3 = (je.p) pVar3.f) {
    ...
    */
    public final void m(je.q qVar) {
        ...
        boolean z10 = ((je.a) ((je.p) qVar.b)) instanceof je.f;
        int i10 = qVar.g;
        for (je.p pVar = (je.p) qVar.c; pVar != null; pVar = (je.p) pVar.f) {
            if (pVar instanceof je.o) {
                if (z10) {
                ...
                tL_pageListOrderedItemText2.text = d90.d(d90.a(pVar, pageblockorderedlist));
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.c.add(new x80(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        while (i10 < size) {
            ...
            i10++;
            x80 x80Var = (x80) obj;
            hashMap.put(Integer.valueOf(x80Var.b), x80Var);
        }
        ...
        while (it.hasNext()) {
            ...
            if (num2 != null && num3.intValue() > num2.intValue()) {
                ...
                if (intValue2 - intValue == 1 && hashMap.containsKey(num2)) {
                    arrayList5.add((x80) hashMap.get(num2));
                } else {
                    String trim = sb2.substring(intValue, intValue2).trim();
                    if (!trim.isEmpty()) {
                        TL_iv.pageBlockParagraph pageblockparagraph = new TL_iv.pageBlockParagraph();
                        pageblockparagraph.text = d90.d(d90.j(trim));
                        arrayList5.add(new x80(intValue, pageblockparagraph));
                    }
                }
            }
            num2 = num3;
        ...
        y80 y80Var = new y80(null, ConnectionsManager.DEFAULT_DATACENTER_ID);
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((jc.a) arrayList3.get(i12)).b <= x80Var2.b) {
                int i14 = i12 + 1;
                jc.a aVar4 = (jc.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.b;
                if (i15 >= x80Var2.b) {
                    while (arrayDeque.peek() != y80Var && ((y80) arrayDeque.peek()).b <= i16) {
                        arrayDeque.pop();
                    }
                    y80 y80Var2 = new y80(aVar4, aVar4.d);
                    ((y80) arrayDeque.peek()).c.add(y80Var2);
                    arrayDeque.push(y80Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != y80Var && ((y80) arrayDeque.peek()).b <= x80Var2.b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = x80Var2.a;
            ((y80) arrayDeque.peek()).c.add(x80Var2);
        }
        A(0, y80Var.c, this.a);
    }
}
