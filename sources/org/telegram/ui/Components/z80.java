...
public final class z80 {
    ...
    public final void a(d90 d90Var, Object obj) {
        this.c.add(new Pair(d90Var, obj));
        this.d++;
        h(obj, true);
    }
    ...
    public final boolean f(Canvas canvas) {
        ...
        for (int i11 = 0; i11 < this.d; i11++) {
            z10 = ((d90) ((Pair) this.c.get(i11)).first).a(canvas) || z10;
        }
        return z10;
    }
    ...
    public final boolean g(Canvas canvas, Object obj) {
        ...
        for (int i11 = 0; i11 < this.d; i11++) {
            ...
            if (((Pair) arrayList2.get(i11)).second == obj) {
                z10 = ((d90) ((Pair) arrayList2.get(i11)).first).a(canvas) || z10;
            }
        }
        h(obj, false);
        return z10;
    ...
    public final void j(int i10) {
        ...
        if (d90Var.p < 0) {
            d90Var.p = Math.max(d90Var.o + d90Var.q, SystemClock.elapsedRealtime());
            h(pair.second, true);
            AndroidUtilities.runOnUIThread(new y80(this, d90Var, 1), Math.max(0L, (d90Var.p - SystemClock.elapsedRealtime()) + 175));
        }
    }
    ...
    public final void k(d90 d90Var, boolean z10) {
        ...
        if (d90Var.p < 0) {
            d90Var.p = Math.max(d90Var.o + d90Var.q, SystemClock.elapsedRealtime());
            h(pair.second, true);
            AndroidUtilities.runOnUIThread(new y80(this, d90Var, 0), Math.max(0L, (d90Var.p - SystemClock.elapsedRealtime()) + 175));
        }
    }
    ...
    public final void m(int i10, boolean z10) {
        ...
        AndroidUtilities.runOnUIThread(new ny(14, this, g90Var), g90Var.c > 0 ? 320 - (SystemClock.elapsedRealtime() - g90Var.c) : 0L);
    }
