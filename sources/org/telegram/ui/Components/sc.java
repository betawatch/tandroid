...
public class sc extends f90 {
    ...
    @Override // org.telegram.ui.Components.f90, android.widget.TextView, android.view.View
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            this.I = null;
        } else if (action == 2 && (tcVar2 = this.I) != null && tcVar2 != tcVar) {
            tcVar2.c(this, false);
            this.I = null;
        }
        return this.I != null || super.onTouchEvent(motionEvent);
    }
}
