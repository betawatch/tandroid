...
public final class d71 extends AnimatorListenerAdapter {
    ...
    public /* synthetic */ d71(p71 p71Var, int i10) {
        this.a = i10;
        this.b = p71Var;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.a) {
            ...
            case 1:
                p71 p71Var2 = this.b;
                p71Var2.w = null;
                View[] viewArr3 = p71Var2.e;
                if (viewArr3[1] != null) {
                    if (!p71Var2.B) {
                        p71Var2.F();
                    }
                    p71Var2.h.put(p71Var2.f[1], viewArr3[1]);
            ...
            default:
                p71 p71Var4 = this.b;
                p71Var4.w = null;
                View[] viewArr5 = p71Var4.e;
                if (viewArr5[1] != null) {
                    if (!p71Var4.B) {
                        p71Var4.F();
                    }
                    p71Var4.h.put(p71Var4.f[1], viewArr5[1]);
