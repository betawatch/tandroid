...
public final class d71 {
    ...
    public static d71 d(int i10, TLRPC.Document document, TLRPC.Document document2, int i11, boolean z10) {
        ...
        d71Var.a = i10;
        d71Var.g = document;
        d71Var.c = document.id;
        d71Var.d = a(i10, i11, document);
        if (document2 != null) {
            d71Var.h = document2;
            d71Var.e = document2.id;
            d71Var.f = a(i10, i11, document2);
            ...
            if (pathToAttach == null || !pathToAttach.exists()) {
                ...
                if (pathToAttach2 != null && pathToAttach2.exists()) {
                    d71Var.f = Uri.fromFile(pathToAttach2);
                }
            } else {
                d71Var.f = Uri.fromFile(pathToAttach);
            }
        }
        d71Var.m = lowerCase;
        ...
        if (tL_documentAttributeVideo != null) {
            ...
            d71Var.i = tL_documentAttributeVideo.w;
            d71Var.j = tL_documentAttributeVideo.h;
            d71Var.l = j3 / d;
        }
        File pathToAttach3 = FileLoader.getInstance(i10).getPathToAttach(document, null, false, z10);
        if (pathToAttach3 != null && pathToAttach3.exists()) {
            d71Var.d = Uri.fromFile(pathToAttach3);
            return d71Var;
        }
        ...
        if (pathToAttach4 != null && pathToAttach4.exists()) {
            d71Var.d = Uri.fromFile(pathToAttach4);
        }
        return d71Var;
    }
