...
public class yl0 extends RecyclerView implements bh.a {
    ...
    public final org.telegram.ui.Cells.u6 D2;
    public int E1;
    public final ot E2;
    public View F1;
    public Matrix F2;
    ...
    public static void P0(Canvas canvas, RectF rectF, float f7, float f10, float f11, org.telegram.ui.ActionBar.f6 f6Var) {
    ...
    public final void D0(Runnable runnable) {
        this.E2.b.add(new lt(runnable, 1));
    }
    ...
    @Override // androidx.recyclerview.widget.RecyclerView
    public final View F(float f7, float f10) {
    ...
    public void K0(Canvas canvas, RectF rectF, long j3) {
        ...
        for (int i10 = 0; i10 < itemDecorationCount; i10++) {
            Object Y = Y(i10);
            if ((Y instanceof bh.a) && (Y != this.H2 || this.G2)) {
                ((bh.a) Y).f(canvas, rectF);
            }
        }
        int childCount = getChildCount();
    ...
    public final void L0(boolean z10) {
        ...
        if (!z10) {
            ...
            if (i10 == 0) {
                ...
                alpha.setDuration(150L).setListener(new gd0(this, 8)).start();
            }
        }
        if (this.A1) {
            int i11 = T0 ? 4 : 0;
                ...
                if (c0Var.o == 1) {
                    ...
                    if (i10 != 1 && i10 != 3) {
                        if (i10 == 2) {
                            ...
                            if (view3 == null || (U3 = U(view3)) == null || (S = this.g1.S((b10 = U3.b()))) < 0) {
                                return;
                            }
                            if (this.s1 != S || this.r1 == null) {
                                View view4 = this.r1;
                                boolean z11 = view4 == null;
                                View T = this.g1.T(S, view4);
                                if (z11) {
                                    U0(T, false);
                                }
                                this.r1 = T;
                                T.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 0));
                                View view5 = this.r1;
                    ...
                    if (this.y1 != 3) {
                        ...
                        for (int i21 = this.u1; i21 < this.u1 + this.v1; i21++) {
                            ...
                            if (i21 == this.u1) {
                                ...
                                if (Q3 == M3 - 1) {
                                    T3.setTag(Integer.valueOf((-T3.getHeight()) + paddingTop));
                                } else if (Q3 == M3 - 2) {
                                    View childAt3 = getChildAt(i20 - b11);
                                    T3.setTag(Integer.valueOf(Math.min(childAt3 != null ? childAt3.getTop() + paddingTop : -AndroidUtilities.dp(100.0f), 0)));
                                } else {
                                    T3.setTag(0);
                                }
                                ...
                                if (childAt4 != null) {
                                    T3.setTag(Integer.valueOf(childAt4.getTop() + paddingTop));
                                } else {
                                    T3.setTag(Integer.valueOf(-AndroidUtilities.dp(100.0f)));
                                }
                                i20 += M3;
                            }
                        }
    ...
    public final void N0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            int[] iArr2 = this.m2;
            org.telegram.ui.zn znVar = qiVar.d;
            ...
            if (rectF.contains(min2, min)) {
                ...
                if (i11 != T) {
                    int i12 = this.f2;
                    boolean z10 = i11 > i12 || T > i12;
                    org.telegram.ui.zn znVar2 = this.h2.d;
                    org.telegram.ui.lm lmVar = znVar2.A0;
                    ...
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        ...
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) znVar2.x6.f(messageObject.getGroupId())) != null) {
                            ...
                            T = arrayList.indexOf(arrayList2.get(z10 ? 0 : arrayList2.size() - 1)) + znVar2.A0.J;
                        }
                    }
                    if (z10) {
                        int i14 = this.g2;
    ...
    public final void O0(Canvas canvas, View view) {
        ...
        if (S == -1) {
            ...
            View V0 = V0(S - 1);
            View V02 = V0(S + 1);
            z10 = V0 != null && ((Boolean) this.H2.a.run(V0)).booleanValue();
            z11 = V02 != null && ((Boolean) this.H2.a.run(V02)).booleanValue();
        }
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(view.getX(), Math.max(-this.L2, u1(view)), view.getX() + view.getWidth(), Math.min(getHeight() - (-this.L2), H0(view)));
        if (z10 && z11) {
    ...
    public final void Q0(Canvas canvas, View view, View view2, boolean z10, boolean z11) {
        ...
        float bottomInfoMargin = view2 instanceof v80 ? ((v80) view2).getBottomInfoMargin() : 0.0f;
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(view.getLeft(), Math.max(-this.L2, u1(view) - (z10 ? this.L2 : 0.0f)), view.getRight(), Math.min(getHeight() - (-this.L2), (H0(view2) + (z11 ? this.L2 : 0.0f)) - bottomInfoMargin));
    ...
    */
    public final void R0(Canvas canvas) {
        ...
        if (m0Var == null || !m0Var.k()) {
            ...
            for (int i13 = 0; i13 < getChildCount(); i13++) {
                ...
                if (childAt == this.c1 || childAt.getVisibility() != 0 || childAt.getAlpha() <= 0.0f || !((Boolean) this.H2.a.run(childAt)).booleanValue() || h1(RecyclerView.S(childAt))) {
                    Q0(canvas, view2, view3, Z0(i11, view2), b1(i12, view3));
                    i11 = -1;
                    view2 = null;
                    view3 = null;
                    i12 = -1;
            ...
            for (int i14 = 0; i14 < getChildCount(); i14++) {
                ...
                if (childAt2 != this.c1 && childAt2.getVisibility() == 0 && childAt2.getAlpha() > 0.0f && ((Boolean) this.H2.a.run(childAt2)).booleanValue()) {
                    ...
                    float H0 = H0(childAt2);
                    s4.c1 U = U(childAt2);
                    if (!U.j() || childAt2.getAlpha() >= 1.0f) {
                        if (h1(U.b())) {
                        }
                        ...
                        if (U.j() && (i10 = U.i) >= 0) {
                            ...
                            while (true) {
                                ...
                                view = getChildAt(i15);
                                if (view != null && view != childAt2 && RecyclerView.S(view) == ceil) {
                                    break;
                                } else {
                                    i15++;
                                }
                            }
                            if (view != null && H0 > view.getY() && ((Boolean) this.H2.a.run(view)).booleanValue() && !U(view).j()) {
                                u12 -= 1.0f;
                                H0 = view.getY();
                                if (H0 < u12) {
                                }
            ...
            if (arrayList3 == null || arrayList3.isEmpty()) {
                ...
                Collections.sort(arrayList3, new org.telegram.ui.df(13));
                arrayList4.clear();
                int i16 = 0;
                while (i16 < arrayList3.size()) {
                    float f13 = ((vl0) arrayList3.get(i16)).b;
                    int i17 = i16 + 1;
                    while (i17 < arrayList3.size() && ((vl0) arrayList3.get(i17)).a <= f13 + 1.5f) {
                        f13 = Math.max(f13, ((vl0) arrayList3.get(i17)).b);
                        i17++;
                    }
                    ...
                    for (int i18 = i16; i18 < i17; i18++) {
                        vl0 vl0Var3 = (vl0) arrayList3.get(i18);
                        if (vl0Var3.c >= 0.99f) {
                    ...
                    for (int i19 = i16; i19 < i17; i19++) {
                        vl0 vl0Var4 = (vl0) arrayList3.get(i19);
                    ...
                    if (f18 >= 0.001f) {
                        if (z10) {
                            ...
                            for (int i20 = i16; i20 < i17; i20++) {
                                vl0 vl0Var6 = (vl0) arrayList3.get(i20);
                                float f20 = vl0Var6.c;
                                if (f20 < 0.99f) {
                                    float f21 = vl0Var6.a;
                                    if (f21 < f16) {
                            ...
                            float f23 = 0.0f;
                            while (i16 < i17) {
                                vl0 vl0Var8 = (vl0) arrayList3.get(i16);
                                float f24 = vl0Var8.c;
                                if (f24 < 0.99f) {
                                    float f25 = vl0Var8.b;
                                    if (f25 > f17) {
    ...
    public final void S0(Canvas canvas) {
        ...
        if ((i10 == -2 || i10 == this.E1) && this.F1 != null) {
            if (getAdapter() instanceof xl0) {
                ((xl0) getAdapter()).getClass();
            }
    ...
    public final Drawable W0(View view, boolean z10) {
        boolean z11;
        boolean z12;
        if (view.getParent() != this || !c1() || !((Boolean) this.H2.a.run(view)).booleanValue()) {
            return null;
        }
        int S = RecyclerView.S(view);
        if (S == -1) {
            ...
            View V0 = V0(S - 1);
            View V02 = V0(S + 1);
            z11 = V0 != null && ((Boolean) this.H2.a.run(V0)).booleanValue();
            z12 = V02 != null && ((Boolean) this.H2.a.run(V02)).booleanValue();
        }
    ...
    public final boolean Z0(int i10, View view) {
        int S;
        if (view == null || i10 > 0 || getAdapter() == null || this.I2 == null || (S = RecyclerView.S(view)) == -1 || S == 0) {
            return false;
        }
        return ((Boolean) this.I2.run(Integer.valueOf(getAdapter().j(S - 1)))).booleanValue();
    }

    public final boolean a1() {
        for (nt ntVar : this.E2.a) {
    ...
    public final boolean b1(int i10, View view) {
        int S;
        if (view == null || i10 < getChildCount() - 1 || getAdapter() == null || this.I2 == null || (S = RecyclerView.S(view)) == -1 || S == getAdapter().h() - 1) {
            return false;
        }
        return ((Boolean) this.I2.run(Integer.valueOf(getAdapter().j(S + 1)))).booleanValue();
    }
        ...
        if (dl0Var != null) {
            ...
            if (dl0Var.d || dl0Var.e) {
                for (int i10 = 0; i10 < yl0Var.getChildCount(); i10++) {
                    ...
                    int S = RecyclerView.S(childAt);
                    if (S >= 0 && !dl0Var.c.contains(childAt)) {
                        Float f7 = (Float) dl0Var.b.get(S, null);
                        if (f7 == null) {
    ...
    public final void f1(jl0 jl0Var, int i10, boolean z10) {
        ...
        if (i10 > 0) {
            this.U1 = null;
            jc0 jc0Var2 = new jc0(this, 20);
            this.V1 = jc0Var2;
            AndroidUtilities.runOnUIThread(jc0Var2, i10);
        }
    }
    ...
    public final void g0(View view) {
        ...
        s4.c1 H = H(view);
        if (H != null) {
            view.setEnabled(((xl0) getAdapter()).D(H));
            if (this.q2) {
    ...
    public void i1(View view, float f7, float f10, boolean z10) {
    ...
    public final void l1(MotionEvent motionEvent, View view) {
        if (view != null) {
            Rect rect = this.G1;
            if (rect.isEmpty()) {
                return;
    ...
    public final void m1(yl0 yl0Var, boolean z10) {
        ViewParent parent;
        if (yl0Var == null || (parent = yl0Var.getParent()) == null) {
            return;
        }
    ...
    public final void o1(pl0 pl0Var, long j3) {
        this.Y0 = pl0Var;
        k2.e eVar = this.M1;
        boolean z10 = pl0Var != null;
        k20 k20Var = (k20) eVar.b;
        k20Var.t = z10;
        k20Var.u = j3;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean z10 = this.d2;
        org.telegram.ui.Cells.u6 u6Var = this.D2;
    ...
    public void r1(int i10, float f7, boolean z10) {
        s1(new ei.c(5), i10, f7, new mv(this, 16), z10);
    }
    ...
    public final void s1(Utilities.CallbackReturn callbackReturn, int i10, float f7, Utilities.Callback5 callback5, boolean z10) {
        SparseIntArray sparseIntArray = new SparseIntArray();
        Pair pair = new Pair(new ci.p5(this, callbackReturn, sparseIntArray, 3), new xi(sparseIntArray, 2));
        t1((Utilities.CallbackReturn) pair.first, (Utilities.CallbackReturn) pair.second, i10, f7, callback5, z10);
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        org.telegram.ui.Cells.z zVar = this.D1;
        if (num == null) {
            intValue = org.telegram.ui.ActionBar.j6.v0(c1() ? org.telegram.ui.ActionBar.j6.j6 : org.telegram.ui.ActionBar.j6.i6, this.p2);
        } else {
    ...
    public final void t1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f7, Utilities.Callback5 callback5, boolean z10) {
        ...
        kl0 kl0Var = new kl0(this, callbackReturn, i10, z10);
        this.H2 = kl0Var;
        i(kl0Var);
    }
    ...
    public final boolean w(int i10, int i11, int i12, int[] iArr, int[] iArr2) {
        if (!this.Z0) {
            return super.w(i10, i11, i12, iArr, iArr2);
        }
        pl0 pl0Var = this.Y0;
        if (pl0Var != null) {
            pl0Var.q(i11);
    ...
    public yl0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.U0 = true;
        this.k1 = true;
        this.s1 = -1;
        ...
        this.D2 = new org.telegram.ui.Cells.u6(this, 20);
        this.P2 = new Path();
        this.p2 = f6Var;
        ot otVar = new ot();
        this.E2 = otVar;
        setEdgeEffectFactory(otVar);
        ...
        super.setOnScrollListener(new vb0(this, 4));
        this.E.add(new tl0(this, context));
    }
    ...
    public void setOnItemLongClickListener(pl0 pl0Var) {
        o1(pl0Var, ViewConfiguration.getLongPressTimeout());
    }
}
