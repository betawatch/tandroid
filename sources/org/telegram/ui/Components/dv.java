...
public final class dv extends gt {
    ...
    public final void a(Canvas canvas, long j10, int i10, int i11, float f10) {
        ...
        if (!z10) {
            for (int i12 = 0; i12 < this.K.size(); i12++) {
                ...
                if (fvVar.e != 0.0f || fvVar.d != null || fvVar.getTranslationX() != 0.0f || fvVar.getTranslationY() != 0.0f || fvVar.getAlpha() != 1.0f) {
                    break;
                }
            }
        }
    ...
    public final void c(Canvas canvas) {
        ...
        while (true) {
            ...
            fvVar.b.draw(canvas, fvVar.a[this.H]);
            i10++;
        }
    }
    ...
    public final void d(Canvas canvas, float f10) {
        ...
        if (this.K != null) {
            for (int i10 = 0; i10 < this.K.size(); i10++) {
                ...
                u5 u5Var = fvVar.c;
                if (u5Var != null && (l5Var = (l5) this.M.y.b.get(u5Var.getDocumentId())) != null && l5Var.k != null && fvVar.b != null) {
    ...
    public final void g() {
        ...
        while (true) {
            ArrayList arrayList = this.L;
            if (i10 >= arrayList.size()) {
                viewGroup = ((org.telegram.ui.ActionBar.h3) this.M.y).containerView;
                viewGroup.invalidate();
                return;
            } else {
                ((fv) arrayList.get(i10)).a[this.H].release();
                i10++;
            }
        }
    }
    ...
    public final void i(long j10) {
        ...
        for (int i10 = 0; i10 < this.K.size(); i10++) {
            fv fvVar = (fv) this.K.get(i10);
            u5 u5Var = fvVar.c;
            ImageReceiver.BackgroundThreadDrawHolder[] backgroundThreadDrawHolderArr = fvVar.a;
            if (u5Var != null && (l5Var = (l5) ovVar.b.get(u5Var.getDocumentId())) != null && l5Var.k != null) {
                l5Var.t(j10);
                oh.z2 z2Var = l5Var.k;
                int i11 = this.H;
