...
public final class uv extends LinearLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (!this.h) {
            ...
            int A = (int) (org.telegram.messenger.vl.A(30.0f, childCount, ((i12 - i10) - getPaddingLeft()) - getPaddingRight()) / Math.max(1, childCount - 1));
        ...
        while (true) {
            ...
            if (childAt2 != yvVar && !cwVar.H.containsKey(childAt2) && childAt2 != null) {
                ...
                if ((childAt2 != cwVar.y || cwVar.W) && (childAt2 != cwVar.E || cwVar.b0)) {
                    paddingLeft2 = org.telegram.messenger.y0.C(3.0f, childAt2.getMeasuredWidth(), paddingLeft2);
                }
            }
            i16++;
        }
