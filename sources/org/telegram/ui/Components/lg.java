...
public abstract class lg extends bu {
    ...
    */
    ...
    public final void m(Uri uri, String str) {
        ...
        Utilities.globalQueue.postRunnable(new org.telegram.ui.ActionBar.q(this, uri, AndroidUtilities.generatePicturePath(boVar != null && boVar.v(), MimeTypeMap.getSingleton().getExtensionFromMimeType(str)), 9));
    }
