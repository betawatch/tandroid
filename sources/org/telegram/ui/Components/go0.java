...
public class go0 extends FrameLayout {
    ...
    */
    public final void a(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = go0Var.e;
        float f10 = i11 / 2.0f;
        float measuredWidth = go0Var.getMeasuredWidth() - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(go0Var.V * 1.0f) / 2.0f;
        if (k0 == null) {
            k0 = new Path();
        }
        k0.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= go0Var.S.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) go0Var.S.get(i12)).first).floatValue() >= dp3) {
                break;
            } else {
                i12++;
            }
        ...
        int size = go0Var.S.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) go0Var.S.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) go0Var.S.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) go0Var.S.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= go0Var.S.size() - 1 || ((Float) ((Pair) go0Var.S.get(i13)).first).floatValue() - floatValue > dp3) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) go0Var.S.get(i13)).first).floatValue();
            }
            c11 = 1;
    ...
    public do0 getSeekBarAccessibilityDelegate() {
        return this.a;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        eo0 eo0Var = this.N;
        int measuredHeight = (eo0Var.getMeasuredHeight() / 2) + dp;
        int dp2 = AndroidUtilities.dp(8.0f) + AndroidUtilities.dp(25.0f) + (this.e / 2) + (this.U > 600000 ? AndroidUtilities.dp(42.0f) : 0);
        eo0Var.layout(dp2, measuredHeight - eo0Var.getMeasuredHeight(), eo0Var.getMeasuredWidth() + dp2, measuredHeight);
    }
    ...
    public void setDelegate(fo0 fo0Var) {
        this.w = fo0Var;
    }
    ...
    public go0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        ...
        eo0 eo0Var = new eo0(this, context, context, 0);
        this.N = eo0Var;
        eo0Var.x = true;
        addView(eo0Var, w7.x5.c(-2.0f, -1));
