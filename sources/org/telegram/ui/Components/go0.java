...
public class go0 {
    ...
    public final void b(Canvas canvas) {
        ...
        if (this.r != dp) {
            ...
            float f13 = this.r;
            if (f13 < dp) {
                float c3 = vh.v2.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f13);
                this.r = c3;
                if (c3 > dp) {
                    this.r = dp;
                }
    ...
    */
    public final void c(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = E;
        float f12 = i11 / 2.0f;
        float f13 = go0Var.f - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp = AndroidUtilities.dp(go0Var.x * 1.0f) / 2.0f;
        if (G == null) {
            G = new Path();
        }
        G.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= go0Var.u.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) go0Var.u.get(i12)).first).floatValue() >= dp2) {
                break;
            } else {
                i12++;
            }
        ...
        int size = go0Var.u.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) go0Var.u.get(size)).first).floatValue() >= dp2) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c3 = 0;
                floatValue = ((Float) ((Pair) go0Var.u.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) go0Var.u.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c10 = 1;
                if (i13 >= go0Var.u.size() - 1 || ((Float) ((Pair) go0Var.u.get(i13)).first).floatValue() - floatValue > dp2) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) go0Var.u.get(i13)).first).floatValue();
            }
            c10 = 1;
