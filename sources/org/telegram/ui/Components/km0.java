...
public final class km0 extends Dialog {
    ...
    public km0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.s = ldVar;
        int i10 = 10;
        ldVar.setOnClickListener(new g80(this, i10));
    ...
    public final void e(w70 w70Var) {
        ...
        w70Var.R(this.n, dh.c.k(f6Var), false);
        this.w = w70Var;
        this.y = w70Var.A;
        FrameLayout frameLayout = new FrameLayout(this.a);
        this.x = frameLayout;
        frameLayout.addView(this.y, w7.a6.c(-2.0f, -2));
        this.v.addView(this.x, w7.a6.c(-2.0f, -2));
    }
    ...
    /* JADX WARN: Type inference failed for: r5v6, types: [android.graphics.Path, org.telegram.ui.Components.ar, org.telegram.ui.Components.g90] */
    /* JADX WARN: Type inference failed for: r7v16, types: [android.graphics.Path, org.telegram.ui.Components.g90] */
    /*
                        ...
                        for (CharacterStyle characterStyle2 : characterStyleArr) {
                            if (characterStyle2 == characterStyle) {
                                ...
                                if (charSequence != null) {
                                    ...
                                    ?? g90Var = new g90(0);
                                    g90Var.d(r14, i22, 0.0f);
                                    r14.getSelectionPath(i22, i23, g90Var);
                                    RectF rectF2 = new RectF();
                                    g90Var.computeBounds(rectF2, true);
                                ...
                                ?? g90Var2 = new g90(0);
                                g90Var2.c = true;
                                g90Var2.d(r12, i22, 0.0f);
                                r12.getSelectionPath(i22, i23, g90Var2);
                                g90Var2.a();
                                RectF rectF3 = new RectF();
                                g90Var2.computeBounds(rectF3, true);
                                ...
                                if (!t1Var.C1() || width2 <= 0) {
                                    ...
                                    if (rectF3.height() > 0.0f) {
                                        ...
                                        canvas.drawPath(g90Var2, paint4);
                                        bitmap = createBitmap;
                                        ...
                                        this.E = new jm0(g90Var2, new int[]{iArr[0] + ((int) f21), iArr[1] + ((int) f14)}, t1Var, iArr, bitmap, rectF3, paint5, paint, makeStaticLayout2);
                                ...
                                this.E = new jm0(g90Var2, new int[]{iArr2[0] + ((int) f21), iArr2[1] + ((int) f14)}, t1Var, iArr2, bitmap, rectF3, paint52, paint, makeStaticLayout22);
