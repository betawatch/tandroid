...
public final class p70 {
    ...
    public static void a(p70 p70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(n70Var.w, 0.0f);
        p70Var.m0 = ofFloat;
    ...
    public static void f(p70 p70Var, nh.h6 h6Var, final HashSet hashSet, boolean z4, Runnable runnable, final Utilities.Callback callback) {
        ...
        m70Var.addView(linearLayout);
        linearLayout.setOrientation(1);
        p70Var.r(m70Var, k7.b6.n(-1, -2));
        float f10 = 0.12f;
        if (z4 && runnable != null) {
        ...
        while (i11 < size) {
            ...
            g1Var2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.i70
    ...
    public final void B() {
        io ioVar = new io(this, this.e, R.drawable.popup_fixed_alert4, this.d, (this.F ? 2 : 0) | (this.E ? 1 : 0) | (this.G ? 0 : 4));
        this.D = ioVar;
        ioVar.setDispatchKeyEventListener(new e70(this, 0));
        this.A = this.D;
    }

    /* JADX WARN: Type inference failed for: r0v1, types: [org.telegram.ui.Components.f70] */
    public final void C() {
        N();
        View view = this.f;
        if (view == null) {
        ...
        this.f0 = new ViewTreeObserver.OnScrollChangedListener() { // from class: org.telegram.ui.Components.f70
            @Override // android.view.ViewTreeObserver.OnScrollChangedListener
            public final void onScrollChanged() {
                k70 k70Var;
                p70 p70Var = p70.this;
                if (p70Var.e0 == null || (k70Var = p70Var.m) == null || !k70Var.isShowing()) {
                    return;
                }
                int[] iArr = new int[2];
                p70Var.e0.getLocationOnScreen(iArr);
                int i10 = iArr[0];
                int[] iArr2 = p70Var.h0;
        ...
        this.g0 = g70Var;
        this.e0.addOnLayoutChangeListener(g70Var);
    }

    public final boolean D() {
        k70 k70Var = this.m;
        return k70Var != null && k70Var.isShowing();
    }
    ...
    public final void N() {
        ...
        if (view != null) {
            ...
            g70 g70Var = this.g0;
            if (g70Var != null) {
                this.e0.removeOnLayoutChangeListener(g70Var);
            }
        }
        this.f0 = null;
        this.g0 = null;
    ...
    public final void O() {
        ...
        int y10;
        k70 k70Var = this.m;
        if (k70Var == null || !k70Var.isShowing() || (view = this.f) == 0 || (viewGroup = this.b) == null || this.A == null || this.D == null) {
            return;
        }
        float[] fArr = this.o;
    ...
    public final void X(float f10) {
        k70 k70Var = this.m;
        if (k70Var != null) {
            k70Var.update((int) this.a0, (int) (this.b0 + f10), -1, -1);
        }
    }
    ...
    */
    public final void Z() {
        ...
        if (this.s > 0 || this.u || this.v) {
            n70 n70Var3 = new n70(this, context);
            this.x = n70Var3;
            this.y = new mt(i12, n70Var3);
        ...
        if (!this.L || (n70Var2 = this.x) == null || this.N == 0) {
            f13 = f12;
        } else {
            n70Var2.s = (overlayContainerView.getWidth() - this.N) / f11;
            if (this.M == 3) {
        ...
        Rect padding = this.D.getPadding();
        rectF2.set(padding.left, padding.top, this.A.getMeasuredWidth() - padding.right, this.A.getMeasuredHeight() - padding.bottom);
        k70 k70Var = new k70(this, this.A, overlayContainerView);
        this.m = k70Var;
        k70Var.setOnDismissListener(new l70(this, overlayContainerView));
        ...
        if (this.W) {
            ...
            if (this.U || f18 + height2 + this.A.getMeasuredHeight() + AndroidUtilities.dp(16.0f) > i19) {
                ...
                if (!this.V || Math.max(0.0f, f18 + height2) + this.A.getMeasuredHeight() <= fArr[1] + rectF.top || rectF.height() != view.getHeight()) {
                    ...
                    if (this.L && (n70Var = this.x) != null) {
                        float height3 = overlayContainerView.getHeight();
                        float measuredHeight = this.A.getMeasuredHeight();
                        float f19 = rectF.bottom;
                        n70Var.v = (height3 - (measuredHeight + f19)) / f11;
                        n70 n70Var4 = this.x;
                        height = (int) (n70Var4.v + f19);
                        width = (int) (((n70Var4.s + rectF.right) - this.A.getMeasuredWidth()) + AndroidUtilities.dp(4.0f));
                        if (this.M == 3) {
                    ...
                    this.b0 = f21;
                    k70Var2.showAtLocation(overlayContainerView, 0, (int) f20, (int) f21);
                    if (this.w && view != 0) {
                        if (view.getParent() != null) {
                            view.getParent().requestDisallowInterceptTouchEvent(true);
                        }
                        sr srVar = new sr(new WeakReference(this), i12);
                        this.o0 = srVar;
            ...
            if (this.L) {
                ...
                n70Var.v = (height32 - (measuredHeight2 + f192)) / f11;
                n70 n70Var42 = this.x;
                height = (int) (n70Var42.v + f192);
                width = (int) (((n70Var42.s + rectF.right) - this.A.getMeasuredWidth()) + AndroidUtilities.dp(4.0f));
                if (this.M == 3) {
                }
            }
            if (!this.w) {
            ...
            this.b0 = f212;
            k70Var22.showAtLocation(overlayContainerView, 0, (int) f202, (int) f212);
            if (this.w) {
                if (view.getParent() != null) {
                }
                sr srVar2 = new sr(new WeakReference(this), i12);
                this.o0 = srVar2;
                view.setOnTouchListener(srVar2);
            }
            if (this.d0) {
            }
        } else {
        ...
        k70 k70Var222 = this.m;
        k70Var222.g = this.I;
        float f2022 = width + this.q;
        this.a0 = f2022;
        float f2122 = height + this.r;
        this.b0 = f2122;
        k70Var222.showAtLocation(overlayContainerView, 0, (int) f2022, (int) f2122);
        if (this.w) {
        }
        if (this.d0) {
        }
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.ui.b.l(org.telegram.ui.ActionBar.j6.q5, f6Var, h, 1, 13.0f);
