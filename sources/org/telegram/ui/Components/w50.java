...
public final class w50 implements Runnable {
    ...
    public static void a(w50 w50Var, boolean z10) {
        ...
        try {
            ...
            for (int i12 = 0; i12 < 3; i12++) {
                w50Var.z0.add(new l50());
            }
            if (z10) {
                w50Var.g0 = w50Var.d0 + w50Var.e0;
                w50Var.k0 = w50Var.i0 + w50Var.j0;
                w50Var.Q = true;
                j3 = 0;
            } else {
                w50Var.g0 = -1L;
            ...
            w50Var.y0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + w50Var.y0.getChannelCount() + " sample rate = " + w50Var.y0.getSampleRate() + " bufferSize = " + i11);
            }
            w50Var.D0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(w50Var.H0.a).roundAudioBitrate * 1024);
            ...
            w50Var.F.start();
            w50Var.E = MediaCodec.createEncoderByType(MediaController.VIDEO_MIME_TYPE);
            w50Var.H = true;
            ...
            w50Var.r = w50Var.E.createInputSurface();
            w50Var.E.start();
            if (!z10) {
            ...
            w50Var.x0 = new c50(w50Var.d, w50Var.e);
            x50 x50Var2 = w50Var.H0;
            Size size = x50Var2.i0[0];
            ...
            w50Var.p0 = GLES20.glGetAttribLocation(w50Var.m0, "aPosition");
            w50Var.q0 = GLES20.glGetAttribLocation(w50Var.m0, "aTextureCoord");
            w50Var.s0 = GLES20.glGetUniformLocation(w50Var.m0, "preview");
            w50Var.r0 = GLES20.glGetUniformLocation(w50Var.m0, "resolution");
            w50Var.u0 = GLES20.glGetUniformLocation(w50Var.m0, "alpha");
            w50Var.n0 = GLES20.glGetUniformLocation(w50Var.m0, "uMVPMatrix");
            w50Var.o0 = GLES20.glGetUniformLocation(w50Var.m0, "uSTMatrix");
            w50Var.t0 = GLES20.glGetUniformLocation(w50Var.m0, "texelSize");
        } catch (Exception e) {
    ...
    public static void b(w50 w50Var, int i10, r50 r50Var) {
        ...
        if (i10 != 1 || (((videoEditedInfo = w50Var.H0.N) != null && videoEditedInfo.needConvert()) || w50Var.H0.c.c())) {
            z10 = true;
        } else {
            if (!w50Var.G0) {
                w50Var.G0 = true;
        ...
        if (i10 == 0) {
            FileLoader.getInstance(w50Var.H0.a).cancelFileUpload(w50Var.a.getAbsolutePath(), false);
            try {
                w50Var.b.delete();
    ...
    public final void c(j50 j50Var, long j3, boolean z10) {
        ...
        int i10 = x50Var.a;
        if (!this.h) {
            FileLoader.getInstance(i10).checkUploadNewDataAvailable(j50Var.toString(), x50Var.M, j3, z10 ? j50Var.length() : 0L);
            return;
        }
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, (Property<LinearLayout, Float>) property, 0.0f), ObjectAnimator.ofInt(x50Var.d, s6.b, 0), ObjectAnimator.ofFloat(x50Var.w, (Property<ImageView, Float>) property, 1.0f));
