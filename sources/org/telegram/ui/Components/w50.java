...
public final class w50 implements Runnable {
    ...
    public static void a(w50 w50Var, boolean z4) {
        ...
        try {
            ...
            for (int i12 = 0; i12 < 3; i12++) {
                w50Var.w0.add(new m50());
            }
            if (z4) {
                w50Var.d0 = w50Var.a0 + w50Var.b0;
                w50Var.h0 = w50Var.f0 + w50Var.g0;
                w50Var.N = true;
                j10 = 0;
            } else {
                w50Var.d0 = -1L;
            ...
            w50Var.v0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + w50Var.v0.getChannelCount() + " sample rate = " + w50Var.v0.getSampleRate() + " bufferSize = " + i11);
            }
            w50Var.A0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(w50Var.E0.a).roundAudioBitrate * 1024);
            ...
            w50Var.C.start();
            w50Var.B = MediaCodec.createEncoderByType(MediaController.VIDEO_MIME_TYPE);
            w50Var.E = true;
            MediaFormat createVideoFormat = MediaFormat.createVideoFormat(MediaController.VIDEO_MIME_TYPE, w50Var.d, w50Var.e);
            createVideoFormat.setInteger("color-format", 2130708361);
            createVideoFormat.setInteger("bitrate", w50Var.f);
            createVideoFormat.setInteger("frame-rate", 30);
            createVideoFormat.setInteger("i-frame-interval", 1);
            w50Var.B.configure(createVideoFormat, (Surface) null, (MediaCrypto) null, 1);
            w50Var.r = w50Var.B.createInputSurface();
            w50Var.B.start();
            if (!z4) {
                boolean isSdCardPath = ImageLoader.isSdCardPath(w50Var.a);
                w50Var.b = w50Var.a;
                if (isSdCardPath) {
                    try {
                ...
                mp4Movie.setCacheFile(w50Var.b);
            ...
            if (w50Var.s != EGL14.EGL_NO_DISPLAY) {
                throw new RuntimeException("EGL already set up");
            }
            EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
            w50Var.s = eglGetDisplay;
            ...
            if (w50Var.v == EGL14.EGL_NO_CONTEXT) {
                ...
                if (!EGL14.eglChooseConfig(w50Var.s, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, EglBase.EGL_RECORDABLE_ANDROID, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                    throw new RuntimeException("Unable to find a suitable EGLConfig");
                }
                i10 = 0;
                w50Var.v = EGL14.eglCreateContext(w50Var.s, eGLConfigArr[0], w50Var.w, new int[]{12440, 2, 12344}, 0);
                w50Var.x = eGLConfigArr[0];
            } else {
                i10 = 0;
            }
            EGL14.eglQueryContext(w50Var.s, w50Var.v, 12440, new int[1], i10);
            if (w50Var.y != EGL14.EGL_NO_SURFACE) {
                throw new IllegalStateException("surface already created");
            }
            EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(w50Var.s, w50Var.x, w50Var.r, new int[]{12344}, i10);
            w50Var.y = eglCreateWindowSurface;
            if (eglCreateWindowSurface == null) {
                throw new RuntimeException("surface was null");
            }
            if (!EGL14.eglMakeCurrent(w50Var.s, eglCreateWindowSurface, eglCreateWindowSurface, w50Var.v)) {
                if (BuildVars.LOGS_ENABLED) {
            ...
            w50Var.j0 = glCreateProgram;
            GLES20.glAttachShader(glCreateProgram, a2);
            GLES20.glAttachShader(w50Var.j0, a10);
            GLES20.glLinkProgram(w50Var.j0);
            int[] iArr2 = new int[1];
            GLES20.glGetProgramiv(w50Var.j0, 35714, iArr2, 0);
            if (iArr2[0] == 0) {
                GLES20.glDeleteProgram(w50Var.j0);
                w50Var.j0 = 0;
                return;
            }
            w50Var.m0 = GLES20.glGetAttribLocation(w50Var.j0, "aPosition");
            w50Var.n0 = GLES20.glGetAttribLocation(w50Var.j0, "aTextureCoord");
            w50Var.p0 = GLES20.glGetUniformLocation(w50Var.j0, "preview");
            w50Var.o0 = GLES20.glGetUniformLocation(w50Var.j0, "resolution");
            w50Var.r0 = GLES20.glGetUniformLocation(w50Var.j0, "alpha");
            w50Var.k0 = GLES20.glGetUniformLocation(w50Var.j0, "uMVPMatrix");
            w50Var.l0 = GLES20.glGetUniformLocation(w50Var.j0, "uSTMatrix");
            w50Var.q0 = GLES20.glGetUniformLocation(w50Var.j0, "texelSize");
        } catch (Exception e) {
    ...
    public static void b(w50 w50Var, int i10, s50 s50Var) {
        ...
        if (i10 != 1 || (((videoEditedInfo = w50Var.E0.K) != null && videoEditedInfo.needConvert()) || w50Var.E0.c.c())) {
            z4 = true;
        } else {
            if (!w50Var.D0) {
                w50Var.D0 = true;
            ...
            if (w50Var.c) {
                if (w50Var.a.exists()) {
                    try {
                        ...
                        FileLog.e("InstantCamera copying fileToWrite to videoFile, deleting videoFile error " + w50Var.a);
                        FileLog.e(e12);
                    }
                }
                if (!w50Var.b.renameTo(w50Var.a)) {
                    FileLog.e("InstantCamera unable to rename file, try move file");
                    try {
                        AndroidUtilities.copyFile(w50Var.b, w50Var.a);
                        w50Var.b.delete();
        ...
        if (i10 != 2 && (dispatchQueue = w50Var.y0) != null) {
        ...
        if (i10 == 0) {
            FileLoader.getInstance(w50Var.E0.a).cancelFileUpload(w50Var.a.getAbsolutePath(), false);
            try {
                w50Var.b.delete();
        ...
        EGL14.eglDestroySurface(w50Var.s, w50Var.y);
        w50Var.y = EGL14.EGL_NO_SURFACE;
        Surface surface = w50Var.r;
        if (surface != null) {
            surface.release();
            w50Var.r = null;
        }
        EGLDisplay eGLDisplay = w50Var.s;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            EGL14.eglDestroyContext(w50Var.s, w50Var.v);
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(w50Var.s);
        }
        w50Var.s = EGL14.EGL_NO_DISPLAY;
    ...
    public final void c(l50 l50Var, long j10, boolean z4) {
        ...
        int i10 = x50Var.a;
        if (!this.h) {
            FileLoader.getInstance(i10).checkUploadNewDataAvailable(l50Var.toString(), x50Var.J, j10, z4 ? l50Var.length() : 0L);
            return;
        }
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, (Property<LinearLayout, Float>) property, 0.0f), ObjectAnimator.ofInt(x50Var.d, n6.b, 0), ObjectAnimator.ofFloat(x50Var.w, (Property<ImageView, Float>) property, 1.0f));
