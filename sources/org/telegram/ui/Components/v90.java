...
public final class v90 extends v7.i0 {
    ...
    public v90(ArrayList arrayList, ArrayDeque arrayDeque) {
        this.a = arrayList;
        this.f = arrayDeque;
    }
    ...
    public static void C(u90 u90Var, List list, int i10) {
        String str;
        ad.a aVar = u90Var.a;
        ArrayList arrayList = u90Var.c;
        String str2 = aVar.a;
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        i11++;
                        boolean z10 = obj instanceof u90;
                        if (z10) {
                            u90 u90Var2 = (u90) obj;
                            if ("summary".equalsIgnoreCase(u90Var2.a.a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(u90Var2.c, sb2);
                                String trim = sb2.toString().trim();
                                pageblockdetails.title = trim.isEmpty() ? new TL_iv.textEmpty() : z90.j(trim);
                            }
                        }
                        if (obj instanceof t90) {
                            arrayList2.add(((t90) obj).a);
                        } else if (z10) {
                            C((u90) obj, arrayList2, i10 + 1);
                        }
                    }
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof t90) {
                TL_iv.PageBlock pageBlock = ((t90) obj).a;
                if (pageBlock instanceof TL_iv.pageBlockParagraph) {
                    if (sb2.length() > 0) {
                        sb2.append('\n');
                    }
                    sb2.append(z90.l(((TL_iv.pageBlockParagraph) pageBlock).text));
                } else if (pageBlock instanceof TL_iv.pageBlockHeader) {
                    if (sb2.length() > 0) {
                        sb2.append('\n');
                    }
                    sb2.append(z90.l(((TL_iv.pageBlockHeader) pageBlock).text));
                } else if (pageBlock instanceof TL_iv.pageBlockSubheader) {
                    if (sb2.length() > 0) {
                        sb2.append('\n');
                    }
                    sb2.append(z90.l(((TL_iv.pageBlockSubheader) pageBlock).text));
                }
            } else if (obj instanceof u90) {
                w(((u90) obj).c, sb2);
            }
    ...
    public final void a(bf.b bVar) {
        for (TL_iv.RichText richText : z90.b(z90.a(bVar, null))) {
    ...
    public final void b(bf.c cVar) {
        ...
        for (bf.p pVar = (bf.p) cVar.c; pVar != null; pVar = (bf.p) pVar.f) {
            if (pVar instanceof bf.o) {
                ...
                tL_pageListItemText.text = z90.d(z90.a(pVar, pageblocklist));
    ...
    public final void f(bf.h hVar) {
        ...
        pageblockpreformatted.text = z90.d(z90.j(hVar.k));
        String str = hVar.j;
        if (str == null) {
            str = "";
        }
    ...
    public final void g(bf.i iVar) {
        TL_iv.RichText d = z90.d(z90.a(iVar, null));
        if (this.c.isEmpty()) {
            this.b = d;
        }
        switch (iVar.g) {
    ...
    public final void j(bf.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = z90.d(z90.j(lVar.g));
    ...
    public final void k(bf.n nVar) {
        if (!(nVar instanceof we.a)) {
            ...
            pageblockparagraph.text = z90.c(((zc.a) nVar).g);
                    ...
                    if (pVar2 instanceof we.f) {
                        ...
                        for (bf.p pVar3 = (bf.p) ((we.f) pVar2).c; pVar3 != null; pVar3 = (bf.p) pVar3.f) {
                            if (pVar3 instanceof we.d) {
                                ...
                                pagetablecell.text = z90.d(z90.a(dVar, null));
    ...
    */
            ...
            if (pVar instanceof bf.o) {
                if (z10) {
                    ...
                    if (!arrayDeque.isEmpty()) {
                        ...
                        tL_pageListOrderedItemText.text = z90.d(z90.a(pVar, pageblockorderedlist));
                ...
                tL_pageListOrderedItemText2.text = z90.d(z90.a(pVar, pageblockorderedlist));
    ...
    public final void n(bf.r rVar) {
        for (TL_iv.RichText richText : z90.b(z90.a(rVar, null))) {
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.c.add(new t90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        while (i10 < size) {
            ...
            i10++;
            t90 t90Var = (t90) obj;
            hashMap.put(Integer.valueOf(t90Var.b), t90Var);
        }
        ...
        while (it.hasNext()) {
            ...
            if (num2 != null && num3.intValue() > num2.intValue()) {
                ...
                if (intValue2 - intValue == 1 && hashMap.containsKey(num2)) {
                    arrayList5.add((t90) hashMap.get(num2));
                } else {
                    String trim = sb2.substring(intValue, intValue2).trim();
                    if (!trim.isEmpty()) {
                        TL_iv.pageBlockParagraph pageblockparagraph = new TL_iv.pageBlockParagraph();
                        pageblockparagraph.text = z90.d(z90.j(trim));
                        arrayList5.add(new t90(intValue, pageblockparagraph));
                    }
                }
            }
            num2 = num3;
        ...
        u90 u90Var = new u90(null, ConnectionsManager.DEFAULT_DATACENTER_ID);
        ArrayDeque arrayDeque = new ArrayDeque();
        arrayDeque.push(u90Var);
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).b <= t90Var2.b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.b;
                if (i15 >= t90Var2.b) {
                    while (arrayDeque.peek() != u90Var && ((u90) arrayDeque.peek()).b <= i16) {
                        arrayDeque.pop();
                    }
                    u90 u90Var2 = new u90(aVar4, aVar4.d);
                    ((u90) arrayDeque.peek()).c.add(u90Var2);
                    arrayDeque.push(u90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != u90Var && ((u90) arrayDeque.peek()).b <= t90Var2.b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = t90Var2.a;
            ((u90) arrayDeque.peek()).c.add(t90Var2);
        }
        A(0, u90Var.c, this.a);
    }
}
