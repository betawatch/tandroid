...
public final class v90 extends qv0 {
    ...
    public /* synthetic */ v90(org.telegram.ui.ActionBar.o2 o2Var, Context context, FrameLayout frameLayout, int i10) {
        super(context, null);
        this.w0 = i10;
        this.y0 = o2Var;
        this.x0 = frameLayout;
    ...
    public void L(Canvas canvas, ArrayList arrayList) {
        switch (this.w0) {
            case 0:
                ((ba0) this.y0).V.Q(canvas, arrayList);
                break;
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.w0) {
            case 0:
                ba0 ba0Var = (ba0) this.y0;
                y90 y90Var = ba0Var.V;
                if (y90Var != null && (st0Var = (st0VarArr = y90Var.k0)[0]) != null && st0Var.h.getFastScroll() != null && st0VarArr[0].h.getFastScroll().n) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.w0) {
            case 0:
                ...
                kVar = ((org.telegram.ui.ActionBar.o2) ba0Var).actionBar;
                ...
                kVar2 = ((org.telegram.ui.ActionBar.o2) ba0Var).actionBar;
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    if (k5VarArr[i12] != null) {
                        ((FrameLayout.LayoutParams) k5VarArr[i12].getLayoutParams()).topMargin = AndroidUtilities.dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 5.0f : 4.0f) + org.telegram.messenger.wl.y(22.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2, 2);
                    }
                    if (n6VarArr[i12] != null) {
                        ((FrameLayout.LayoutParams) n6VarArr[i12].getLayoutParams()).topMargin = ((((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2) - AndroidUtilities.dp(19.0f)) / 2) + (org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2)) - AndroidUtilities.dp(7.0f);
                    }
                }
                ((FrameLayout.LayoutParams) ba0Var.y.getLayoutParams()).topMargin = org.telegram.messenger.wl.y(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
