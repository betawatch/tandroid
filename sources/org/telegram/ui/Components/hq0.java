...
public final class hq0 extends cw0 {
    ...
    public hq0(wq0 wq0Var, Context context) {
        ...
        this.F0 = AndroidUtilities.computePerceivedBrightness(wq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) > 0.721f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0.0f, getPaddingTop() + wq0Var.t0, getMeasuredWidth(), getMeasuredHeight() + wq0Var.t0 + AndroidUtilities.dp(50.0f));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout = wq0Var.w;
        canvas.translate(0.0f, wq0Var.t0);
        int i16 = wq0Var.p0;
        ...
        if (z10) {
            ...
            if (this.y0) {
                ...
                if (i15 + dp2 < wq0Var.G0.b) {
                    z11 = true;
                    int i19 = dp2 + wq0Var.G0.b;
        ...
        if (frameLayout != null) {
            if (dp2 > wq0Var.G0.b || frameLayout.getChildCount() <= 0) {
                i13 = ((org.telegram.ui.ActionBar.f3) wq0Var).backgroundPaddingTop;
        ...
        if (f7 < 1.0f) {
            ...
            org.telegram.ui.ActionBar.j6.t0.setColor(wq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            boolean z12 = this.F0 && ((float) 0) > ((float) wq0Var.G0.b) * 0.5f;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        wq0 wq0Var = this.H0;
        if (z10) {
            if (motionEvent.getAction() == 0 && wq0Var.p0 != 0 && motionEvent.getY() < wq0Var.p0 - AndroidUtilities.dp(30.0f)) {
                wq0Var.dismiss();
                return true;
            }
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        wq0 wq0Var = this.H0;
        bq0 bq0Var = wq0Var.d;
        z11 = ((org.telegram.ui.ActionBar.f3) wq0Var).keyboardVisible;
        int max = (z11 || R > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow) ? 0 : Math.max(wq0Var.G0.d, bq0Var.getEmojiPadding());
        setBottomClip(max);
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (i23 == 1) {
                    ...
                    if (i22 == 16) {
                        ...
                        if (bq0Var != null && bq0Var.l(childAt)) {
                    ...
                    i15 = ((org.telegram.ui.ActionBar.f3) wq0Var).backgroundPaddingLeft;
                }
                i16 = i14 - i15;
                if (i22 == 16) {
                }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        yp0 yp0Var2 = wq0Var.F;
        yl0 yl0Var = wq0Var.E;
        int size = hq0Var.getLayoutParams().height > 0 ? hq0Var.getLayoutParams().height : View.MeasureSpec.getSize(i11);
        int i18 = 0;
        wq0Var.H.G = hq0Var.getLayoutParams().height <= 0;
        wq0Var.J.G = hq0Var.getLayoutParams().height <= 0;
        z10 = ((org.telegram.ui.ActionBar.f3) wq0Var).isFullscreen;
        if (!z10) {
            hq0Var.w0 = true;
            i16 = ((org.telegram.ui.ActionBar.f3) wq0Var).backgroundPaddingLeft;
            int i19 = wq0Var.G0.b;
            i17 = ((org.telegram.ui.ActionBar.f3) wq0Var).backgroundPaddingLeft;
            hq0Var.setPadding(i16, i19, i17, 0);
            hq0Var.w0 = false;
        }
        int paddingTop = size - hq0Var.getPaddingTop();
        int D = org.telegram.messenger.l0.D(103.0f, Math.max(2, (int) Math.ceil(Math.max(wq0Var.M.h(), wq0Var.K.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + AndroidUtilities.dp(103.0f));
        i12 = ((org.telegram.ui.ActionBar.f3) wq0Var).backgroundPaddingTop;
        int i20 = i12 + D;
        if (yl0Var.getVisibility() != 8) {
            int D2 = org.telegram.messenger.l0.D(103.0f, Math.max(2, (int) Math.ceil((wq0Var.L.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + AndroidUtilities.dp(103.0f));
            i15 = ((org.telegram.ui.ActionBar.f3) wq0Var).backgroundPaddingTop;
            int i21 = i15 + D2;
            if (i21 > i20) {
                i20 = AndroidUtilities.lerp(i20, i21, yl0Var.getAlpha());
            }
        }
        int i22 = i20 < paddingTop ? 0 : paddingTop - ((paddingTop / 5) * 3);
        int dp = AndroidUtilities.dp((frameLayout != null ? 48 : 0) + 100) + wq0Var.G0.d;
        if (yp0Var2.getPaddingTop() != i22 || yp0Var2.getPaddingBottom() != dp) {
            hq0Var.w0 = true;
            yp0Var2.setPadding(0, i22, 0, dp);
            yl0Var.setPadding(0, i22, 0, dp);
            hq0Var.w0 = false;
        }
        z11 = ((org.telegram.ui.ActionBar.f3) wq0Var).keyboardVisible;
        if (z11 && hq0Var.getLayoutParams().height <= 0 && yp0Var.getPaddingTop() != i22) {
            hq0Var.w0 = true;
            yp0Var.setPadding(0, 0, 0, AndroidUtilities.dp((frameLayout == null ? 0 : 48) + 60) + wq0Var.G0.d);
            hq0Var.w0 = false;
        }
        boolean z13 = i20 >= size;
        hq0Var.y0 = z13;
        hq0Var.z0 = z13 ? 0 : size - i20;
        hq0Var.w0 = true;
        wq0Var.K0(false);
        hq0Var.w0 = false;
        ...
        i13 = ((org.telegram.ui.ActionBar.f3) wq0Var).backgroundPaddingLeft;
        FrameLayout frameLayout2 = wq0Var.r;
        bq0 bq0Var = wq0Var.d;
        int i23 = size2 - (i13 * 2);
        int R = hq0Var.R();
        wq0Var.N0 = R;
        ...
        if (wq0Var.N0 <= AndroidUtilities.dp(20.0f)) {
            if (!AndroidUtilities.isInMultiwindow) {
                z12 = ((org.telegram.ui.ActionBar.f3) wq0Var).keyboardVisible;
                size3 -= z12 ? 0 : bq0Var.getEmojiPadding();
                makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30);
            }
            int i24 = bq0Var.e ? 8 : 0;
        ...
        while (i18 < childCount) {
            View childAt = hq0Var.getChildAt(i18);
            if (childAt != null && childAt.getVisibility() != i14) {
                if (!bq0Var.l(childAt)) {
                    hq0Var.measureChildWithMargins(childAt, i10, 0, i25, 0);
                    ...
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(i23, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.dp(200.0f), hq0Var.getPaddingTop() + (i26 - wq0Var.G0.b)), TLObject.FLAG_30));
                } else {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(i23, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(hq0Var.getPaddingTop() + (i26 - wq0Var.G0.b), TLObject.FLAG_30));
                }
            }
            i18++;
            hq0Var = this;
