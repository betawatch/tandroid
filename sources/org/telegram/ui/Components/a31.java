...
public final class a31 extends Thread {
    public final /* synthetic */ String a;
    public final /* synthetic */ String b;
    public final /* synthetic */ String c;
    public final /* synthetic */ Utilities.Callback2 d;

    public a31(String str, String str2, String str3, Utilities.Callback2 callback2) {
        this.a = str;
        this.b = str2;
        this.c = str3;
        this.d = callback2;
    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                httpURLConnection.setRequestProperty("User-Agent", k31.N[(int) Math.round(Math.random() * 5)]);
                httpURLConnection.setRequestProperty("Content-Type", "application/json");
                StringBuilder sb2 = new StringBuilder();
                BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream(), p8.d.c));
                while (true) {
                    try {
                ...
                AndroidUtilities.runOnUIThread(new ii0(20, callback2, str3));
            } catch (Exception e10) {
                e = e10;
                try {
                ...
                if (httpURLConnection != null) {
                    try {
                        ...
                        AndroidUtilities.runOnUIThread(new fq0(callback2, 21));
                        return;
                    }
                }
                AndroidUtilities.runOnUIThread(new p90(7, callback2, z10));
            }
        } catch (Exception e12) {
            e = e12;
