...
public final class er implements Interpolator {
    public static final er f = new er(0.25d, 0.1d, 0.25d, 1.0d);
    public static final er g = new er(0.0d, 0.0d, 0.58d, 1.0d);
    public static final er h = new er(0.23d, 1.0d, 0.32d, 1.0d);
    public static final er i = new er(0.42d, 0.0d, 1.0d, 1.0d);
    public static final er j = new er(0.42d, 0.0d, 0.58d, 1.0d);
    public static final er k = new er(0.34d, 1.56d, 0.64d, 1.0d);
