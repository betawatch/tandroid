...
public final class az extends il0 {
    ...
    public az(fz fzVar, Context context) {
        this.M = fzVar;
        this.h = context;
        zy zyVar = new zy(context, fzVar.Y0, new d(this, 12), new cv(this, 3), fzVar.V1);
        this.c = zyVar;
        zyVar.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(5.0f));
        zyVar.setClipToPadding(false);
        zyVar.U2.r = false;
        zyVar.setNestedScrollingEnabled(false);
        zyVar.setDrawSelection(false);
        zyVar.setOnTouchListener(new m.d2(this, 3));
    }
    ...
    public final void v(f2.n1 n1Var, int i10) {
        fz fzVar = this.M;
        LongSparseArray longSparseArray = fzVar.v1;
        LongSparseArray longSparseArray2 = fzVar.u1;
        int i11 = n1Var.f;
        View view = n1Var.a;
        ...
        if (i11 == 0) {
            ...
            b8Var.d(document, null, this.s.get(i10), (String) this.w.get(i10), false, false);
            if (!fzVar.f1.contains(document) && !fzVar.g1.contains(document)) {
                z10 = false;
            }
            b8Var.setRecent(z10);
            return;
        ...
        if (i11 == 1) {
            ...
            if (num == null) {
                ...
                int z11 = org.telegram.ui.b.z(82.0f, (int) Math.ceil(num.intValue() / fzVar.u0.d), fzVar.h.getHeight());
        ...
        if (i11 == 2) {
            ...
            if (stickerSet2 != null && num2 != null) {
                k8Var.c(stickerSet2.title, 0, null, num2.intValue(), !TextUtils.isEmpty(this.J) ? this.J.length() : 0);
            }
            k8Var.d(0, null);
            return;
        }
    ...
    public final f2.n1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                vyVar = new vy(1, context, fzVar.V1, z10);
                break;
            case 1:
                vyVar = new org.telegram.ui.Cells.i3(context);
                break;
            case 2:
                vyVar = new org.telegram.ui.Cells.k8(this.h, false, false, fzVar.V1, fzVar.e2);
                break;
            case 3:
