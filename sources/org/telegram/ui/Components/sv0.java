    ...
    public final void b(Canvas canvas, View view) {
        ...
        if (i0Var != null) {
            ...
            for (int i13 = 0; i13 < min; i13++) {
                rv0 rv0Var2 = (rv0) arrayList.get(i13);
                float f9 = rv0Var2.a;
                float f10 = rv0Var2.b;
                int i14 = rv0Var2.j;
                float f11 = dp / 2.0f;
                ...
                i0Var.e(i13, i0.a.k(this.n, (int) (rv0Var2.f * 255.0f)));
                e0.i0.a((float[]) i0Var.b, i13, f9 - f11, f10 - f11, f9 + f11, f10 + f11);
                float f13 = dp;
            ...
            for (int i15 = 0; i15 < size; i15++) {
                rv0 rv0Var3 = (rv0) arrayList.get(i15);
                sv0 sv0Var = rv0Var3.k;
                Paint paint = sv0Var.c;
                if (rv0Var3.j != 0) {
                    Bitmap bitmap = sv0Var.j;
                    Paint paint2 = sv0Var.e;
                    if (bitmap == null) {
                        sv0Var.j = a(false);
                    }
                    paint2.setAlpha((int) (rv0Var3.f * 255.0f));
                    canvas.save();
                    float f14 = rv0Var3.i;
                    canvas.scale(f14, f14, rv0Var3.a, rv0Var3.b);
                    canvas.drawBitmap(sv0Var.j, rv0Var3.a, rv0Var3.b, paint2);
                    canvas.restore();
                } else {
                    paint.setAlpha((int) (rv0Var3.f * 255.0f));
                    canvas.drawPoint(rv0Var3.a, rv0Var3.b, paint);
                }
            }
        }
        int i16 = this.h;
        ...
        if (size2 < i11) {
            ...
            while (i19 < i17) {
                if (arrayList.size() >= i11 || Utilities.random.nextFloat() <= 0.7f) {
                    ...
                    float nextFloat2 = i16 == 0 ? (Utilities.random.nextFloat() * org.telegram.messenger.x3.B(20.0f, view.getMeasuredHeight(), i20)) + i20 : Utilities.random.nextFloat() * view.getMeasuredHeight();
                    ...
                    rv0Var.f = 0.0f;
                    rv0Var.h = 0.0f;
                    rv0Var.i = Utilities.random.nextFloat() * 1.2f;
                    rv0Var.j = Utilities.random.nextInt(2);
                    if (i16 == 0) {
                        rv0Var.g = Utilities.random.nextInt(100) + 2000;
                    } else {
                        rv0Var.g = Utilities.random.nextInt(2000) + 3000;
                    }
                    rv0Var.e = (Utilities.random.nextFloat() * 4.0f) + 20.0f;
        ...
        while (i12 < size3) {
            rv0 rv0Var4 = (rv0) arrayList.get(i12);
            float f15 = rv0Var4.h;
            float f16 = rv0Var4.g;
            if (f15 >= f16) {
                ...
                if (i16 == 0) {
                    if (f15 < 200.0f) {
                        rv0Var4.f = AndroidUtilities.accelerateInterpolator.getInterpolation(f15 / 200.0f);
                    } else {
                        rv0Var4.f = 1.0f - AndroidUtilities.decelerateInterpolator.getInterpolation((f15 - 200.0f) / (f16 - 200.0f));
                    }
                } else if (f15 < 200.0f) {
                    rv0Var4.f = AndroidUtilities.accelerateInterpolator.getInterpolation(f15 / 200.0f);
                } else {
                    float f17 = f16 - f15;
                    if (f17 < 2000.0f) {
                        rv0Var4.f = AndroidUtilities.decelerateInterpolator.getInterpolation(f17 / 2000.0f);
                    }
                }
                float f18 = rv0Var4.a;
                float f19 = rv0Var4.c;
                float f20 = rv0Var4.e;
                float f21 = min2;
                rv0Var4.a = a4.w.d(f19 * f20, f21, 500.0f, f18);
                rv0Var4.b = (((rv0Var4.d * f20) * f21) / 500.0f) + rv0Var4.b;
                rv0Var4.h += f21;
            }
            i12++;
            i18 = 40;
