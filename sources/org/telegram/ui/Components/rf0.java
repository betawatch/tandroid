...
public final class rf0 extends FrameLayout implements yz, ci.kc {
    ...
    */
    public rf0(Context context, i71 i71Var, Bitmap bitmap, Bitmap bitmap2, int i10, MediaController.SavedFilterState savedFilterState, od0 od0Var, int i11, boolean z10, boolean z11, ia iaVar, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        ...
        if (i71Var != null) {
            this.i0 = i71Var;
            i71Var.setDelegate(new jf0(this));
        } else {
            this.j0 = true;
            lf0 lf0Var = new lf0(this, context);
            this.i0 = lf0Var;
            if (z11) {
                addView(lf0Var, w7.y5.e(-1, -1, 51));
            }
            lf0Var.setVisibility(4);
            lf0Var.setSurfaceTextureListener(new mf0(this, z11, iaVar));
        }
        gf0 gf0Var = new gf0(context);
        gf0Var.a = new PointF();
        gf0Var.d = new uv0();
        gf0Var.e = new PointF(0.5f, 0.5f);
        gf0Var.f = 0.15f;
        gf0Var.h = 0.35f;
        gf0Var.r = new RectF();
        gf0Var.x = 1.0f;
        ...
        if (z11) {
            addView(gf0Var, w7.y5.e(-1, -1, 51));
        }
        gf0Var.setDelegate(new jf0(this));
        nf0 nf0Var = this.W;
        ...
        this.p0 = if0Var;
        if0Var.setDelegate(new jf0(this));
        ...
        final int i17 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.kf0
            ...
            public final void onClick(View view) {
                switch (i17) {
                    case 0:
                        rf0 rf0Var = this.b;
                        rf0Var.y0 = 0;
                        rf0Var.z0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.zf, rf0Var.I0), PorterDuff.Mode.MULTIPLY));
                        rf0Var.A0.setColorFilter((ColorFilter) null);
                        rf0Var.B0.setColorFilter((ColorFilter) null);
                        rf0Var.f();
                        break;
                    case 1:
                        rf0 rf0Var2 = this.b;
                        rf0Var2.y0 = 1;
                        rf0Var2.z0.setColorFilter((ColorFilter) null);
                        rf0Var2.A0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.zf, rf0Var2.I0), PorterDuff.Mode.MULTIPLY));
                        rf0Var2.B0.setColorFilter((ColorFilter) null);
                        rf0Var2.f();
                        break;
                    case 2:
                        rf0 rf0Var3 = this.b;
                        rf0Var3.y0 = 2;
                        rf0Var3.z0.setColorFilter((ColorFilter) null);
                        rf0Var3.A0.setColorFilter((ColorFilter) null);
                        rf0Var3.B0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.zf, rf0Var3.I0), PorterDuff.Mode.MULTIPLY));
                        rf0Var3.f();
                        break;
                    case 3:
                        rf0 rf0Var4 = this.b;
                        ...
                        rf0Var4.W.f = intValue;
                        int i18 = 0;
                        while (i18 < 4) {
                            rf0Var4.u0[i18].a(i18 == intValue, true);
                            i18++;
                        }
                        rf0Var4.p0.invalidate();
                        break;
                    case 4:
                        rf0 rf0Var5 = this.b;
                        rf0Var5.T = 0;
                        rf0Var5.h();
                        rf0Var5.o0.setVisibility(4);
                        vz vzVar = rf0Var5.l0;
                        if (vzVar != null) {
                    ...
                    case 5:
                        ...
                        rf0Var6.T = 1;
                        rf0Var6.h();
                        gf0 gf0Var2 = rf0Var6.o0;
                        gf0Var2.setVisibility(0);
                        gf0Var2.setType(1);
                        vz vzVar2 = rf0Var6.l0;
                        if (vzVar2 != null) {
                    ...
                    default:
                        ...
                        rf0Var7.T = 2;
                        rf0Var7.h();
                        gf0 gf0Var3 = rf0Var7.o0;
                        gf0Var3.setVisibility(0);
                        gf0Var3.setType(0);
                        vz vzVar3 = rf0Var7.l0;
                        if (vzVar3 != null) {
        ...
        final int i18 = 1;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.kf0
            public final /* synthetic */ rf0 b;
            ...
            public final void onClick(View view) {
                switch (i18) {
                    ...
                    case 3:
                        ...
                        int i182 = 0;
                        while (i182 < 4) {
                            rf0Var4.u0[i182].a(i182 == intValue, true);
                            i182++;
                        }
                        rf0Var4.p0.invalidate();
                        break;
        ...
        final int i19 = 2;
        imageView3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.kf0
            public final /* synthetic */ rf0 b;
        ...
        yhVar.setAdapter(new qf0(this, context));
        ...
        while (i20 < 4) {
            ...
            if (i20 == 0) {
                ...
                final int i21 = 3;
                frameLayout4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.kf0
                    public final /* synthetic */ rf0 b;
        ...
        final int i22 = 4;
        textView3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.kf0
            public final /* synthetic */ rf0 b;
        ...
        final int i23 = 5;
        textView4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.kf0
            public final /* synthetic */ rf0 b;
        ...
        final int i24 = 6;
        textView5.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.kf0
            public final /* synthetic */ rf0 b;
    ...
    public final boolean d() {
        ...
        nf0 nf0Var = this.W;
        return savedFilterState != null ? (this.G == savedFilterState.enhanceValue && this.I == savedFilterState.contrastValue && this.P == savedFilterState.highlightsValue && this.H == savedFilterState.exposureValue && this.J == savedFilterState.warmthValue && this.K == savedFilterState.saturationValue && this.R == savedFilterState.vignetteValue && this.Q == savedFilterState.shadowsValue && this.S == savedFilterState.grainValue && this.U == savedFilterState.sharpenValue && this.L == savedFilterState.fadeValue && this.M == savedFilterState.softenSkinValue && this.O == savedFilterState.tintHighlightsColor && this.N == savedFilterState.tintShadowsColor && nf0Var.b()) ? false : true : (this.G == 0.0f && this.I == 0.0f && this.P == 0.0f && this.H == 0.0f && this.J == 0.0f && this.K == 0.0f && this.R == 0.0f && this.Q == 0.0f && this.S == 0.0f && this.U == 0.0f && this.L == 0.0f && this.M == 0.0f && this.O == 0 && this.N == 0 && nf0Var.b()) ? false : true;
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        od0 od0Var = this.v0;
        if (od0Var != null && view == (textureView = this.i0)) {
            canvas.save();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.k0) {
            ...
            uv0Var.a = f14;
            uv0Var.b = f15;
            ((FrameLayout.LayoutParams) gf0Var.getLayoutParams()).height = AndroidUtilities.dp(38.0f) + i12;
            ((FrameLayout.LayoutParams) if0Var.getLayoutParams()).height = AndroidUtilities.dp(28.0f) + i12;
