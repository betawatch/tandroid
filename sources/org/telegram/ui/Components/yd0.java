...
public abstract class yd0 {
            ...
            if (activity.checkSelfPermission(str) != 0) {
                for (String str2 : strArr) {
                    if (activity.shouldShowRequestPermissionRationale(str2)) {
                        ...
                        alertDialog$Builder.a.P = AndroidUtilities.replaceTags(LocaleController.getString(i11));
                        alertDialog$Builder.k(LocaleController.getString(R.string.PermissionOpenSettings), new l1(activity, 2));
                ...
                g(strArr, new wd0(strArr, activity, callback, 1));
                return;
            }
        }
        callback.run(Boolean.TRUE);
    ...
    public static void e(int i10, int i11, String[] strArr, String[] strArr2, Utilities.Callback callback) {
        ...
        for (String str2 : strArr) {
            if (!activity.shouldShowRequestPermissionRationale(str2)) {
                ...
                alertDialog$Builder.m(i10, 72, org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.L5, false), null);
                alertDialog$Builder.a.P = AndroidUtilities.replaceTags(LocaleController.getString(i11));
                alertDialog$Builder.k(LocaleController.getString(R.string.PermissionOpenSettings), new l1(activity, 1));
                alertDialog$Builder.h(LocaleController.getString(R.string.ContactsPermissionAlertNotNow), null);
                alertDialog$Builder.a.show();
                callback.run(Boolean.FALSE);
                return;
        ...
        g(strArr2, new wd0(strArr2, activity, callback, 0));
    }
    ...
    public static void g(String[] strArr, Utilities.Callback callback) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            notificationCenterDelegateArr[0] = new xd0(i10, callback, notificationCenterDelegateArr);
