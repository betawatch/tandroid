...
public final class cy extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public cy(kz kzVar, Context context) {
        ...
        lj0Var.setColorFilter(kzVar.z(i10));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            ...
            uw uwVar = new uw(i13, this, stickerSetById);
            Pattern pattern = sv.V;
            if (n2Var3.getFragmentView() != null) {
                MediaDataController.getInstance(n2Var3.getCurrentAccount()).toggleStickerSet(n2Var3.getFragmentView().getContext(), stickerSetById, 0, n2Var3, true, true, uwVar, false);
            }
            this.r = null;
        }
    }
