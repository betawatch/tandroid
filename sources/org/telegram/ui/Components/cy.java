...
public final class cy extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public cy(lz lzVar, Context context) {
        super(context);
        this.E = lzVar;
        ...
        addView(i5Var, w7.x5.i(-2.0f, -1.0f, 8388611, 15.0f, 15.0f, 0.0f, 0.0f));
        ...
        textView2.setBackground(org.telegram.ui.ActionBar.x5.d(new float[]{16.0f}, lzVar.z(i11), lzVar.z(org.telegram.ui.ActionBar.h6.Qh)));
        ...
        textView3.setBackground(org.telegram.ui.ActionBar.x5.d(new float[]{16.0f}, 0, lzVar.z(i11) & 452984831));
    ...
    public final void a(boolean z10) {
        ...
        boolean z11 = xxVar.f;
        lz lzVar = this.E;
        int i10 = (this.s.e || UserConfig.getInstance(lzVar.c1).isPremium() || lzVar.U0) ? this.s.g ? z11 || lzVar.p1.contains(Long.valueOf(xxVar.b.id)) ? 3 : 2 : 0 : 1;
        if ((i10 == 0) != (this.x == 0)) {
            requestLayout();
        }
        this.x = i10;
        ...
        if (!z10) {
            ...
            i5Var.setTranslationX(i10 == 1 ? AndroidUtilities.dp(16.0f) : 0.0f);
        ...
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(i5Var, (Property<org.telegram.ui.ActionBar.i5, Float>) property, fArr3);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            if (this.n != null && (stickerSetById2 = MediaDataController.getInstance(i12).getStickerSetById(this.n.id)) != null && stickerSetById2.set != null) {
                ...
                tv.W(n2Var, stickerSetById2, true, null, new yp(this, 14));
                this.n = null;
            }
            ...
            org.telegram.ui.ActionBar.n2 n2Var2 = lzVar.Y1;
            if (n2Var2 == null) {
                n2Var2 = new ai.y3(this, 6);
            }
            org.telegram.ui.ActionBar.n2 n2Var3 = n2Var2;
            ph phVar = new ph(27, this, stickerSetById);
            Pattern pattern = tv.V;
            if (n2Var3.getFragmentView() != null) {
                MediaDataController.getInstance(n2Var3.getCurrentAccount()).toggleStickerSet(n2Var3.getFragmentView().getContext(), stickerSetById, 0, n2Var3, true, true, phVar, false);
            }
            this.r = null;
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.ActionBar.i5 i5Var = this.b;
        i5Var.setRightPadding(measuredWidth);
        if (textView.getVisibility() == 0) {
            textView.setTranslationX(AndroidUtilities.dp(4.0f) + i5Var.getTextWidth());
            float dp2 = AndroidUtilities.dp(4.0f) + (i5Var.getMaxTextWidth() - measuredWidth);
