...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.invalidateMotionBackground, 0, NotificationCenter.onRequestPermissionResultReceived), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.invalidateMotionBackground, 150, NotificationCenter.onRequestPermissionResultReceived), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.invalidateMotionBackground, NotificationCenter.onRequestPermissionResultReceived, NotificationCenter.onRequestPermissionResultReceived), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.invalidateMotionBackground, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.invalidateMotionBackground, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.invalidateMotionBackground, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
