...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.cameraInitied, 0, NotificationCenter.currentUserPremiumStatusChanged), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.cameraInitied, 150, NotificationCenter.currentUserPremiumStatusChanged), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.cameraInitied, NotificationCenter.currentUserPremiumStatusChanged, NotificationCenter.currentUserPremiumStatusChanged), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.cameraInitied, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.cameraInitied, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.cameraInitied, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
