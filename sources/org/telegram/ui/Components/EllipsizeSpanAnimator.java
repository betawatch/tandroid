...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.closeOtherAppActivities, 0, NotificationCenter.onUserRingtonesUpdated), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.closeOtherAppActivities, 150, NotificationCenter.onUserRingtonesUpdated), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.closeOtherAppActivities, NotificationCenter.onUserRingtonesUpdated, NotificationCenter.onUserRingtonesUpdated), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.closeOtherAppActivities, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.closeOtherAppActivities, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.closeOtherAppActivities, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
