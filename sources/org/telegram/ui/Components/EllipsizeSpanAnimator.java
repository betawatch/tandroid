...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.goingToPreviewTheme, 0, NotificationCenter.permissionsGranted), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.goingToPreviewTheme, 150, NotificationCenter.permissionsGranted), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.goingToPreviewTheme, NotificationCenter.permissionsGranted, NotificationCenter.permissionsGranted), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.goingToPreviewTheme, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.goingToPreviewTheme, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.goingToPreviewTheme, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
