...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.reloadInterface, 0, NotificationCenter.chatSwitchedForum), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.reloadInterface, 150, NotificationCenter.chatSwitchedForum), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.reloadInterface, NotificationCenter.chatSwitchedForum, NotificationCenter.chatSwitchedForum), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.reloadInterface, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.reloadInterface, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.reloadInterface, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
