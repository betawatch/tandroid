...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.didSetNewWallpapper, 0, NotificationCenter.onDatabaseReset), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.didSetNewWallpapper, 150, NotificationCenter.onDatabaseReset), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.didSetNewWallpapper, NotificationCenter.onDatabaseReset, NotificationCenter.onDatabaseReset), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.didSetNewWallpapper, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.didSetNewWallpapper, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.didSetNewWallpapper, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
