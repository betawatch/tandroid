...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.needCheckSystemBarColors, 0, NotificationCenter.premiumStickersPreviewLoaded), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.needCheckSystemBarColors, 150, NotificationCenter.premiumStickersPreviewLoaded), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.needCheckSystemBarColors, NotificationCenter.premiumStickersPreviewLoaded, NotificationCenter.premiumStickersPreviewLoaded), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.needCheckSystemBarColors, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.needCheckSystemBarColors, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.needCheckSystemBarColors, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
