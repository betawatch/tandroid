...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.didApplyNewTheme, 0, NotificationCenter.billingProductDetailsUpdated), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.didApplyNewTheme, 150, NotificationCenter.billingProductDetailsUpdated), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.didApplyNewTheme, NotificationCenter.billingProductDetailsUpdated, NotificationCenter.billingProductDetailsUpdated), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.didApplyNewTheme, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.didApplyNewTheme, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.didApplyNewTheme, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
