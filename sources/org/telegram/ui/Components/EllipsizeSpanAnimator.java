...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.didReceiveSmsCode, 0, NotificationCenter.dialogsUnreadPollVotesCounterChanged), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.didReceiveSmsCode, 150, NotificationCenter.dialogsUnreadPollVotesCounterChanged), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.didReceiveSmsCode, NotificationCenter.dialogsUnreadPollVotesCounterChanged, NotificationCenter.dialogsUnreadPollVotesCounterChanged), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.didReceiveSmsCode, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.didReceiveSmsCode, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.didReceiveSmsCode, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
