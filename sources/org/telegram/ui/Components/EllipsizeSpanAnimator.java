...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.didReplacedPhotoInMemCache, 0, NotificationCenter.premiumPromoUpdated), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.didReplacedPhotoInMemCache, 150, NotificationCenter.premiumPromoUpdated), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.didReplacedPhotoInMemCache, NotificationCenter.premiumPromoUpdated, NotificationCenter.premiumPromoUpdated), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.didReplacedPhotoInMemCache, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.didReplacedPhotoInMemCache, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.didReplacedPhotoInMemCache, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
