...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.locationPermissionGranted, 0, NotificationCenter.activityPermissionsGranted), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.locationPermissionGranted, 150, NotificationCenter.activityPermissionsGranted), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.locationPermissionGranted, NotificationCenter.activityPermissionsGranted, NotificationCenter.activityPermissionsGranted), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.locationPermissionGranted, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.locationPermissionGranted, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.locationPermissionGranted, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
