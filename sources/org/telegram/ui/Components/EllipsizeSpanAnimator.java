...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.didReceiveCall, 0, NotificationCenter.onDatabaseOpened), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.didReceiveCall, 150, NotificationCenter.onDatabaseOpened), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.didReceiveCall, NotificationCenter.onDatabaseOpened, NotificationCenter.onDatabaseOpened), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.didReceiveCall, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.didReceiveCall, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.didReceiveCall, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
