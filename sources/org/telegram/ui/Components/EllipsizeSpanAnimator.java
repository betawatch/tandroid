...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, NotificationCenter.suggestedLangpack, 0, NotificationCenter.didUpdateGlobalAutoDeleteTimer), createEllipsizeAnimator(textAlphaSpanArr[1], 0, NotificationCenter.suggestedLangpack, 150, NotificationCenter.didUpdateGlobalAutoDeleteTimer), createEllipsizeAnimator(textAlphaSpanArr[2], 0, NotificationCenter.suggestedLangpack, NotificationCenter.didUpdateGlobalAutoDeleteTimer, NotificationCenter.didUpdateGlobalAutoDeleteTimer), createEllipsizeAnimator(textAlphaSpanArr[0], NotificationCenter.suggestedLangpack, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], NotificationCenter.suggestedLangpack, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], NotificationCenter.suggestedLangpack, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
