...
public abstract class g01 extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas2.translate(((int) (((this.a.getPrimaryHorizontal(this.h) - this.a.getPrimaryHorizontal(0)) * this.s) + org.telegram.ui.th.b(f10, this.s, AndroidUtilities.dp(4.0f), primaryHorizontal4))) - i10, i11);
        canvas2.scale(interpolation, interpolation, f12, f12);
        path.reset();
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int D = org.telegram.messenger.x3.D(8.0f, 2, this.a.getHeight());
