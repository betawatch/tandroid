...
public final class kn extends View {
    ...
    public /* synthetic */ kn(Context context, int i10) {
        super(context);
        this.a = i10;
    }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            case 14:
                ...
                break;
            case 15:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(org.telegram.ui.i60.F3 ? 0.0f : 8.0f), TLObject.FLAG_30));
                break;
            case 20:
