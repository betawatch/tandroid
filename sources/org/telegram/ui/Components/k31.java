...
public final class k31 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.e {
    ...
    public k31(Activity activity, org.telegram.ui.wn wnVar, int i10, long j3, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.s = y21Var;
        final int i12 = 1;
        y21Var.B1(new Utilities.Callback2(this) { // from class: org.telegram.ui.Components.x21
            public final /* synthetic */ k31 b;
        ...
        frameLayout.addView(y21Var, w7.y5.d(-1, -1.0f, 119, 41.0f, 0.0f, 0.0f, 0.0f));
        ...
        if (isBotForumWithEditableTopics) {
            ...
            final int i13 = 2;
            j31Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.t21
                public final /* synthetic */ k31 b;
            ...
            viewGroup.addView(j31Var, w7.y5.d(64, 42.0f, 51, 0.0f, 48.0f, 0.0f, 0.0f));
        } else {
            viewGroup = frameLayout2;
            this.v = null;
        }
        ...
        this.G = a31Var;
        final int i15 = 1;
        a31Var.B1(new Utilities.Callback2(this) { // from class: org.telegram.ui.Components.x21
            public final /* synthetic */ k31 b;
        ...
        viewGroup2.addView(a31Var, w7.y5.d(-1, -1.0f, 119, 0.0f, isBotForumWithEditableTopics ? 90.0f : 48.0f, 0.0f, 0.0f));
        a31Var.j(new z21(this, 1));
        final int i16 = 0;
        ImageView i17 = i(activity, R.drawable.menu_sidebar_left, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.t21
            public final /* synthetic */ k31 b;
        ...
        this.y = i17;
        final int i18 = 0;
        ImageView i19 = i(activity, R.drawable.menu_sidebar_left, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.t21
            public final /* synthetic */ k31 b;
        ...
        final int i20 = 1;
        ImageView i21 = i(activity, R.drawable.msg_select, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.t21
            public final /* synthetic */ k31 b;
        ...
        this.w = i21;
        final int i22 = 1;
        ImageView i23 = i(activity, R.drawable.msg_select, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.t21
            public final /* synthetic */ k31 b;
    ...
    public static boolean c(final k31 k31Var, v51 v51Var, View view) {
        ...
        if (ChatObject.isMonoForum(chat)) {
            ...
            if (user2 == null || !ChatObject.canBlockUsers(chat3)) {
                ...
                y3.setVisibility(8);
                y70Var2 = I;
                MessagesController.getInstance(i12).checkIsInChat(true, chat3, user2, new q21(k31Var, y3, I, j10, user2, chat3));
            }
            y70Var = y70Var2;
            d6Var = d6Var2;
            r62 = 1;
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                ...
                I.c(z11 ? R.drawable.msg_unpin : R.drawable.msg_pin, LocaleController.getString(z11 ? R.string.DialogUnpin : R.string.DialogPin), new vn0(k31Var, I, messagesController, tL_forumTopic), false);
                if (tL_forumTopic.pinned) {
                    I.c(R.drawable.tabs_reorder, LocaleController.getString(R.string.FilterReorder), new r21(k31Var, i13), false);
                }
            }
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(k31Var) { // from class: org.telegram.ui.Components.s21
                    public final /* synthetic */ k31 b;
                    ...
                    public final void run() {
                        ...
                        switch (i14) {
                            case 0:
                                y70Var3.u();
                                k31Var2.h.presentFragment(se1.a0(-k31Var2.c, tL_forumTopic2.id));
                                break;
                            case 1:
                                k31Var2.getClass();
                                y70Var3.u();
                                MessagesController.getInstance(k31Var2.b).getTopicsController().toggleCloseTopic(-k31Var2.c, tL_forumTopic2.id, true ^ tL_forumTopic2.closed);
                                break;
                            default:
                                y70Var3.u();
                                ...
                                if (hashSet.size() == 1) {
                                    z12 = false;
                                    a2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, MessagesController.getInstance(k31Var3.b).getTopicsController().findTopic(-k31Var3.c, ((Integer) arrayList.get(0)).intValue()).title);
                                } else {
                                    z12 = false;
            ...
            b10 = 0;
            y70Var = I;
            y70Var.c(isDialogMuted ? R.drawable.msg_unmute : R.drawable.msg_mute, LocaleController.getString(isDialogMuted ? R.string.Unmute : R.string.Mute), new ai.m3(k31Var, messagesController, tL_forumTopic, I, J, 25), false);
            if (!ChatObject.canManageTopic(i12, chat4, tL_forumTopic) || UserObject.isBotForum(user)) {
                ...
                y70Var.c(i14, string, new Runnable(k31Var) { // from class: org.telegram.ui.Components.s21
                    public final /* synthetic */ k31 b;
            ...
            if (ChatObject.canDeleteTopic(i12, chat4, tL_forumTopic)) {
                y70Var.c(R.drawable.msg_delete, LocaleController.getPluralString("DeleteTopics", z10 ? 1 : 0), new Runnable(k31Var) { // from class: org.telegram.ui.Components.s21
                    public final /* synthetic */ k31 b;
