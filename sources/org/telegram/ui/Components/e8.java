...
public abstract class e8 extends FrameLayout {
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        ...
        this.n = animatorSet2;
        animatorSet2.addListener(new fi.v2(this, i14, 5));
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.d8
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i12) {
                    case 0:
                        e8 e8Var = this.b;
                        e8Var.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        e8Var.invalidate();
                        break;
                    default:
                        e8 e8Var2 = this.b;
                        e8Var2.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        e8Var2.invalidate();
                        break;
                }
            }
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.d8
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i10) {
                    case 0:
                        e8 e8Var = this.b;
                        e8Var.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        e8Var.invalidate();
                        break;
                    default:
                        e8 e8Var2 = this.b;
                        e8Var2.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        e8Var2.invalidate();
                        break;
                }
            }
