...
public final class v01 extends DispatchQueue {
    public int E;
    public int F;
    public int G;
    public int H;
    ...
    public v01(SurfaceTexture surfaceTexture, r01 r01Var, r01 r01Var2, int i10, int i11) {
    ...
    public final void b(u01 u01Var) {
        int i10 = 0;
        GLES20.glGenTextures(1, u01Var.A, 0);
        GLES20.glBindTexture(3553, u01Var.A[0]);
        GLES20.glTexParameteri(3553, 10241, 9729);
        GLES20.glTexParameteri(3553, 10240, 9729);
        GLES20.glTexParameteri(3553, 10242, 33071);
        GLES20.glTexParameteri(3553, 10243, 33071);
        GLUtils.texImage2D(3553, 0, u01Var.C, 0);
    ...
    public final void c(Matrix matrix, Bitmap bitmap, Runnable runnable, Runnable runnable2) {
        if (!this.b.get()) {
            AndroidUtilities.runOnUIThread(new t01(runnable, runnable2, 0));
            x01.b(this.d);
            this.d = null;
        } else {
            u01 u01Var = new u01(this, matrix, bitmap, runnable, runnable2);
            getHandler();
            this.S = true;
            postRunnable(new s01(this, u01Var, 1));
        }
    }

    public final void e(View view, float f7, Runnable runnable) {
        if (this.b.get()) {
            u01 u01Var = new u01(this, view, f7, runnable);
            getHandler();
            this.S = true;
            postRunnable(new s01(this, u01Var, 2));
            return;
        }
        if (view != null) {
        ...
        r01 r01Var = this.d;
        if (r01Var != null) {
            AndroidUtilities.runOnUIThread(r01Var);
            this.d = null;
        }
    }
    ...
    public final void f(ArrayList arrayList, Runnable runnable) {
        if (this.b.get()) {
            u01 u01Var = new u01(this, arrayList, runnable);
            this.S = true;
            postRunnable(new s01(this, u01Var, 0));
            return;
        }
    ...
    public final void g() {
        ...
        if (this.b.get()) {
            ...
            while (i14 < this.T.size()) {
                u01 u01Var = (u01) this.T.get(i14);
                if (u01Var.d) {
                    ArrayList arrayList = this.T;
                    int i15 = 0;
                    for (int i16 = 0; i16 < arrayList.size(); i16++) {
                        i15 += ((u01) arrayList.get(i16)).u;
                    }
                    float f7 = u01Var.u;
                    float f10 = f7 / i15;
                    int[] iArr = u01Var.B;
                    ...
                    int i18 = u01Var.E.a ? 120000 : devicePerformanceClass != 1 ? devicePerformanceClass != 2 ? 30000 : 120000 : 60000;
                    if (u01Var.D) {
                        i18 /= 2;
                    }
                    float max = Math.max(AndroidUtilities.dpf2(0.4f), 1.0f);
                    u01Var.s = Utilities.clamp((int) ((r4 * i17) / (max * max)), (int) (i18 * f10), 10);
                    float f11 = i17;
                    float f12 = f11 / f7;
                    int round = (int) Math.round(Math.sqrt(r4 / f12));
                    u01Var.w = round;
                    u01Var.v = Math.round(u01Var.s / round);
                    while (true) {
                        i10 = u01Var.v;
                        i11 = u01Var.w;
                        i12 = i10 * i11;
                    ...
                    u01Var.s = i12;
                    u01Var.x = Math.max(f11 / i10, f7 / i11);
                    GLES20.glGenBuffers(2, iArr, i13);
                    for (int i19 = 0; i19 < 2; i19++) {
                        GLES20.glBindBuffer(34962, iArr[i19]);
                        GLES20.glBufferData(34962, u01Var.s * 28, null, 35048);
                    }
                    if (u01Var.e != null) {
                        this.U.add(u01Var);
                    }
                ...
                this.V = true;
                int[] iArr2 = u01Var.B;
                boolean z10 = u01Var.D;
                float f13 = u01Var.m;
                int i20 = u01Var.u;
                int i21 = u01Var.t;
                Matrix matrix = u01Var.r;
                v01 v01Var = u01Var.E;
                long nanoTime = System.nanoTime();
                double d = u01Var.b < 0 ? 0.0d : (nanoTime - r7) / 1.0E9d;
                u01Var.b = nanoTime;
                if (u01Var.n && !u01Var.o) {
                    matrix.reset();
                    matrix.postScale(i21, i20);
                    matrix.postTranslate(u01Var.i, u01Var.j);
                    u01Var.c();
                }
                u01Var.c = (float) ((f13 * d) + u01Var.c);
                GLES20.glUniformMatrix3fv(v01Var.x, 1, false, u01Var.p, 0);
                GLES20.glUniform1f(v01Var.y, u01Var.d ? 1.0f : 0.0f);
                GLES20.glUniform1f(v01Var.E, u01Var.c);
                GLES20.glUniform1f(v01Var.F, ((float) d) * f13);
                GLES20.glUniform1f(v01Var.G, u01Var.s);
                GLES20.glUniform3f(v01Var.I, u01Var.v, u01Var.w, u01Var.x);
                GLES20.glUniform2f(v01Var.P, u01Var.g, u01Var.h);
                GLES20.glUniform1f(v01Var.Q, z10 ? 0.8f : 1.0f);
                GLES20.glUniform1f(v01Var.R, z10 ? 1.0f : 0.6f);
                GLES20.glUniform2f(v01Var.J, i21, i20);
                GLES20.glUniform1f(v01Var.K, u01Var.y);
                GLES20.glUniform2f(v01Var.L, 0.0f, 0.0f);
                GLES20.glUniform1f(v01Var.N, u01Var.k);
                GLES20.glUniform1f(v01Var.O, u01Var.l);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, u01Var.A[0]);
                GLES20.glUniform1i(v01Var.M, 0);
                GLES20.glBindBuffer(34962, iArr2[u01Var.z]);
                ...
                GLES30.glBindBufferBase(35982, 0, iArr2[1 - u01Var.z]);
                GLES20.glVertexAttribPointer(0, 2, 5126, false, 28, 0);
                GLES20.glEnableVertexAttribArray(0);
                GLES20.glVertexAttribPointer(1, 2, 5126, false, 28, 8);
                GLES20.glEnableVertexAttribArray(1);
                ...
                GLES20.glDrawArrays(0, 0, u01Var.s);
                GLES30.glEndTransformFeedback();
                GLES20.glBindBuffer(34962, 0);
                GLES20.glBindBuffer(35982, 0);
                u01Var.d = false;
                u01Var.z = 1 - u01Var.z;
                if (u01Var.c > u01Var.l + (u01Var.D ? 2.0f : 0.9f)) {
                    u01Var.a();
                    this.T.remove(i14);
                ...
                if (glGetError == 0) {
                    try {
                        ...
                        for (int i22 = 0; i22 < this.U.size(); i22++) {
                            AndroidUtilities.runOnUIThread(((u01) this.U.get(i22)).e);
                        }
                        this.U.clear();
                        for (int i23 = 0; i23 < this.T.size(); i23++) {
                            ((u01) this.T.get(i23)).a();
                        }
                        this.T.clear();
            ...
            for (int i24 = 0; i24 < this.U.size(); i24++) {
                AndroidUtilities.runOnUIThread(((u01) this.U.get(i24)).e);
            }
            this.U.clear();
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 == 4) {
            while (i11 < arrayList.size()) {
                u01 u01Var = (u01) arrayList.get(i11);
                u01Var.g += message.arg1;
                u01Var.h += message.arg2;
                i11++;
            }
            return;
        }
        ...
        while (i11 < arrayList.size()) {
            u01 u01Var2 = (u01) arrayList.get(i11);
            if (u01Var2.a.contains(view)) {
                u01Var2.a();
    ...
    public final void run() {
        ...
        try {
            ...
            FileLog.e(e);
            while (i10 < arrayList.size()) {
                u01 u01Var = (u01) arrayList.get(i10);
                Runnable runnable = u01Var.e;
                if (runnable != null) {
                    AndroidUtilities.runOnUIThread(runnable);
                }
                u01Var.a();
