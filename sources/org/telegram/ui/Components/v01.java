...
public final class v01 {
     ...
     */
    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Object, org.telegram.ui.Components.v01] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public v01(w01 w01Var, ArrayList arrayList, Runnable runnable) {
        ml0 ml0Var;
        org.telegram.ui.tm tmVar;
        int i10;
        float f7;
        float f10;
        ...
        if (arrayList.size() > 0 && (((View) arrayList.get(0)).getParent() instanceof ml0)) {
            ...
            if (ml0Var2.getParent() instanceof org.telegram.ui.tm) {
                org.telegram.ui.tm tmVar2 = (org.telegram.ui.tm) ml0Var2.getParent();
                org.telegram.ui.bo chatActivity = tmVar2.getChatActivity();
                ...
                while (i19 < 3) {
                    ...
                    if (i19 != 2 || ml0Var2.X1) {
                        ...
                        while (i27 < arrayList7.size()) {
                            ...
                            transitionParams4.cell.B1(canvas, (int) f23, (int) f20, (int) f24, (int) f21, transitionParams4.pinnedTop, transitionParams4.pinnedBotton, false, tmVar.getKeyboardHeight());
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public v01(w01 w01Var, View view, float f7, Runnable runnable) {
        this.E = w01Var;
