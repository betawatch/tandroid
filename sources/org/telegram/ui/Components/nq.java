...
public class nq extends FrameLayout {
    ...
    public org.telegram.ui.ActionBar.d6 d0;
    ...
    public nq(Context context, boolean z10, mq mqVar) {
        super(context);
        this.n = new RectF();
                    ...
                    switch (i16) {
                            ...
                            if (nqVar.y == null) {
                                ...
                                if (i17 == 1) {
                                    ...
                                    if (colorPicker$RadioButton2.e == 0) {
                                        i15 = 0;
                                        colorPicker$RadioButton2.a(nq.d(colorPicker$RadioButtonArr[0].e));
                                    } else {
                                        i15 = 0;
                                    }
                                    if (nqVar.h) {
                                        mqVar2.x0(colorPicker$RadioButtonArr[i15].e, i15, true);
                                    }
                                    mqVar2.x0(colorPicker$RadioButtonArr[1].e, 1, true);
                                    nqVar.K = 2;
                                } else if (i17 == 2) {
                                    nqVar.K = 3;
                                    ...
                                    mqVar2.x0(colorPicker$RadioButtonArr[2].e, 2, true);
                                } else if (i17 == 3) {
                                    nqVar.K = 4;
                                    ColorPicker$RadioButton colorPicker$RadioButton3 = colorPicker$RadioButtonArr[3];
                                    if (colorPicker$RadioButton3.e == 0) {
                                        colorPicker$RadioButton3.a(nq.d(colorPicker$RadioButtonArr[2].e));
                                    }
                                    mqVar2.x0(colorPicker$RadioButtonArr[3].e, 3, true);
                                }
                                ...
                                nqVar.g(nqVar.getMeasuredWidth(), arrayList, false);
                                nqVar.y.playTogether(arrayList);
                                nqVar.y.setDuration(180L);
                                nqVar.y.setInterpolator(rr.g);
                                nqVar.y.addListener(new r8(nqVar, 14));
                                nqVar.y.start();
                                break;
                            }
                            break;
                        case 1:
                            ...
                            if (nqVar.y == null) {
                                ...
                                int i21 = nqVar.T;
                                if (i21 < 0 || i21 >= nqVar.S) {
                                    colorPicker$RadioButtonArr2[nqVar.K - 1].callOnClick();
                                } else {
                                ...
                                while (i22 < colorPicker$RadioButtonArr2.length) {
                                    if (i22 < nqVar.K) {
                                        mqVar3.x0(colorPicker$RadioButtonArr2[i22].e, i22, i22 == colorPicker$RadioButtonArr2.length - 1);
                                    } else {
                                        mqVar3.x0(0, i22, i22 == colorPicker$RadioButtonArr2.length - 1);
                                    }
                                    i22++;
                                }
                                nqVar.y = new AnimatorSet();
                                nqVar.g(nqVar.getMeasuredWidth(), arrayList2, true);
                                nqVar.y.playTogether(arrayList2);
                                nqVar.y.setDuration(180L);
                                nqVar.y.setInterpolator(rr.g);
                                nqVar.y.addListener(new lq(nqVar));
                                nqVar.y.start();
                                break;
                            }
                            break;
        ...
        while (true) {
            ...
            if (i15 % 2 == 0) {
                editTextBoldCursorArr[i15] = new jq(this, context, i15, i13);
            ...
            this.E[i15].setHintTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.H6, this.d0));
            EditTextBoldCursor editTextBoldCursor = this.E[i15];
            int i16 = org.telegram.ui.ActionBar.h6.G6;
            editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.h6.v0(i16, this.d0));
            this.E[i15].setCursorColor(org.telegram.ui.ActionBar.h6.v0(i16, this.d0));
            ...
            this.E[i15].setHeaderHintColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.L6, this.d0));
        ...
        this.G = imageView;
        int i17 = org.telegram.ui.ActionBar.h6.I5;
        imageView.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.v0(i17, this.d0), 1, -1));
        imageView.setImageResource(R.drawable.msg_add);
        int i18 = org.telegram.ui.ActionBar.h6.G6;
        int v02 = org.telegram.ui.ActionBar.h6.v0(i18, this.d0);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        imageView.setColorFilter(new PorterDuffColorFilter(v02, mode));
        ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
        imageView.setScaleType(scaleType);
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.iq
            public final /* synthetic */ nq b;
                    ...
                    case 0:
                        ...
                        if (nqVar.y == null) {
                            ...
                            if (i172 == 1) {
                                ...
                                if (nqVar.h) {
                                    mqVar2.x0(colorPicker$RadioButtonArr[i152].e, i152, true);
                                }
                                mqVar2.x0(colorPicker$RadioButtonArr[1].e, 1, true);
                                nqVar.K = 2;
                            } else if (i172 == 2) {
    ...
    public static void a(nq nqVar, View view) {
        ...
        while (true) {
            ...
            if (i10 >= colorPicker$RadioButtonArr.length) {
                ...
                nqVar.setColorInner(i11);
                nqVar.E[1].setText(String.format("%02x%02x%02x", Byte.valueOf((byte) Color.red(i11)), Byte.valueOf((byte) Color.green(i11)), Byte.valueOf((byte) Color.blue(i11))).toUpperCase());
                return;
            }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!this.Q) {
            ...
            float interpolation = rr.g.getInterpolation(this.U);
    ...
    public void setHasChanges(boolean z10) {
        ...
        if (!z10 || textView.getTag() == null) {
            if ((z10 || textView.getTag() != null) && this.F.getTag() == null) {
                ...
                animatorSet.addListener(new ca(6, this, z10));
