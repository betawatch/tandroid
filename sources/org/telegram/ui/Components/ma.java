...
public final class ma {
    ...
    public final void b(Canvas canvas, boolean z10) {
        ...
        if (!isHardwareAccelerated) {
            canvas.drawColor(num != null ? num.intValue() : iaVar.i);
            return;
        }
        RenderNode renderNode = (RenderNode) iaVar.l;
        if (!renderNode.hasDisplayList()) {
            RenderNode renderNode2 = (RenderNode) iaVar.k;
            renderNode.setPosition(0, 0, renderNode2.getWidth(), renderNode2.getHeight());
            RecordingCanvas beginRecording = renderNode.beginRecording();
            beginRecording.drawColor(num != null ? num.intValue() : iaVar.i);
    ...
    public final Paint[] d() {
        ...
        if (c10 != null && z10) {
            c10.setAlpha((int) org.telegram.messenger.a2.A(1.0f, this.f, 255.0f, 1.0f));
        }
        if (paint != null) {
    ...
    public final void f(int i10, int i11, boolean z10) {
        ...
        matrix.reset();
        ia iaVar = this.a;
        View view2 = iaVar != null ? z10 ? iaVar.j : iaVar.b : null;
        if (iaVar != null) {
