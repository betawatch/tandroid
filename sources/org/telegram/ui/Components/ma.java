...
public final class ma {
    ...
    public final ig u = new ig(this, 13);
    ...
    public final void a(float[] fArr, int i10, int i11, int i12) {
        ...
        GLES20.glUseProgram(haVar.a);
        GLES20.glUniform1i(haVar.e, 0);
        ...
        GLES20.glEnableVertexAttribArray(haVar.c);
        GLES20.glVertexAttribPointer(haVar.c, 2, 5126, false, 8, (Buffer) this.g);
        GLES20.glEnableVertexAttribArray(haVar.b);
        GLES20.glVertexAttribPointer(haVar.b, 2, 5126, false, 8, (Buffer) this.e);
        GLES20.glUniform2f(haVar.f, this.a, this.b);
        float f9 = i11;
        float f10 = i12;
        GLES20.glUniform2f(haVar.g, f9, f10);
        GLES20.glUniform1i(haVar.j, 0);
        GLES20.glUniform1f(haVar.k, c3 != 0 ? 1.0f : 0.0f);
        if (c3 != 0) {
            GLES20.glUniformMatrix4fv(haVar.l, 1, false, fArr, 0);
        }
        GLES20.glUniform1f(haVar.m, c3 == 0 ? 0.0f : 1.0f);
        ag.u1.a(haVar.h, this.l);
        ag.u1.a(haVar.i, this.m);
        synchronized (this.k) {
            GLES20.glUniformMatrix4fv(haVar.d, 1, false, this.j, 0);
        }
        ...
        if (c3 != 0) {
            ...
            ag.u1.a(haVar.h, this.l);
            ag.u1.a(haVar.i, this.m);
            GLES20.glUniform1f(haVar.k, 0.0f);
            synchronized (this.k) {
                GLES20.glUniformMatrix4fv(haVar.d, 1, false, this.j, 0);
            }
        }
        GLES20.glBindFramebuffer(36160, this.r[1]);
        GLES20.glUniform1i(haVar.j, 1);
        GLES20.glUniform1i(haVar.e, 0);
        GLES20.glActiveTexture(33984);
        ...
        GLES20.glClear(16384);
        GLES20.glEnableVertexAttribArray(haVar.b);
        GLES20.glVertexAttribPointer(haVar.b, 2, 5126, false, 8, (Buffer) this.f);
        GLES20.glUniform1i(haVar.j, 2);
        GLES20.glUniform1i(haVar.e, 0);
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, this.s[1]);
        ga gaVar = this.t;
        Object obj = gaVar != null ? gaVar.h : null;
        if (obj != null) {
            synchronized (obj) {
                GLES20.glDrawArrays(5, 0, 4);
            }
    ...
    public final boolean b(float f9, int i10) {
        this.a = (int) Math.round(Math.sqrt(f9 * 324.0f));
        this.b = (int) Math.round(Math.sqrt(324.0f / f9));
        this.c = i10;
        if (!this.h) {
        ...
        if (readRes != null && readRes2 != null) {
            ...
            while (true) {
                ...
                ha haVar = new ha();
                haVar.a = glCreateProgram;
                haVar.b = GLES20.glGetAttribLocation(glCreateProgram, "p");
                haVar.c = GLES20.glGetAttribLocation(glCreateProgram, "inputuv");
                haVar.d = GLES20.glGetUniformLocation(glCreateProgram, "matrix");
                haVar.e = GLES20.glGetUniformLocation(glCreateProgram, "tex");
                haVar.f = GLES20.glGetUniformLocation(glCreateProgram, "sz");
                haVar.g = GLES20.glGetUniformLocation(glCreateProgram, "texSz");
                haVar.h = GLES20.glGetUniformLocation(glCreateProgram, "gtop");
                haVar.i = GLES20.glGetUniformLocation(glCreateProgram, "gbottom");
                haVar.j = GLES20.glGetUniformLocation(glCreateProgram, "step");
                haVar.l = GLES20.glGetUniformLocation(glCreateProgram, "videoMatrix");
                haVar.m = GLES20.glGetUniformLocation(glCreateProgram, "hasVideoMatrix");
                haVar.k = GLES20.glGetUniformLocation(glCreateProgram, "flipy");
                this.d[i14] = haVar;
                i14++;
            }
        }
