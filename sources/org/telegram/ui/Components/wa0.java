...
public final class wa0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public wa0(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, ArrayList arrayList, int i11) {
        super(context);
        String str;
        ...
        if (arrayList.size() > 1) {
            ...
            for (int i12 = 0; f51VarArr != null && i12 < f51VarArr.length; i12++) {
                ...
                replaceTags.setSpan(new va0(0, this), spanStart, spanEnd, 33);
            }
            return;
        }
        if (arrayList.size() != 1) {
        ...
        if (str == null || document == null) {
            ...
            this.f = j90Var;
            j90Var.l = org.telegram.ui.ActionBar.j6.G8;
            j90Var.m = org.telegram.ui.ActionBar.j6.i6;
            j90Var.j(4.0f);
            return;
        }
        SpannableString spannableString = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString.setSpan(new ta0(this, document, this.h.getFontMetricsInt()), 0, spannableString.length(), 33);
        ...
        spannableString2.setSpan(new va0(0, this), 0, spannableString2.length(), 33);
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        spannableString2.setSpan(new ua0(this, document, this.h.getFontMetricsInt()), 0, spannableString2.length(), 33);
        SpannableString spannableString3 = new SpannableString(str);
        spannableString3.setSpan(new va0(i13, this), 0, spannableString3.length(), 33);
