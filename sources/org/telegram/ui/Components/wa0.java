...
public abstract class wa0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b() {
        ...
        gg.q1 q1Var = this.e;
        if (g10) {
            float min = Math.min(Math.max(0.0f, va0Var.getTranslationY() + (q1Var.f ? q1Var.e.getTop() : getHeight())) + this.s, (1.0f - this.M) * getHeight());
            this.n = 0.0f;
            this.r = min;
        } else {
            this.n = Math.max(Math.max(0.0f, va0Var.getTranslationY() + (q1Var.f ? q1Var.e.getBottom() : 0)) - this.s, this.M * getHeight());
        ...
        if (dVar != null) {
            ...
            RectF rectF = this.T;
            rectF.set(rect);
            if (va0Var == null || (pa0Var = this.d) == null || va0Var.getLayoutManager() != pa0Var || (k1Var = this.f) == null || k1Var.R == null) {
    ...
    public final void c() {
        ...
        boolean z10 = (va0Var == null || (pa0Var = this.d) == null || va0Var.getLayoutManager() != pa0Var || (k1Var = this.f) == null || k1Var.R == null) ? false : true;
        if (this.R == null) {
            va0Var.setPadding(0, 0, 0, 0);
        } else {
            va0Var.setPadding(AndroidUtilities.dp(z10 ? 7.0f : 5.0f), z10 ? AndroidUtilities.dp(2.0f) : 0, AndroidUtilities.dp(z10 ? 7.0f : 5.0f), z10 ? AndroidUtilities.dp(2.0f) : 0);
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Rect rect = this.y;
        if (g10) {
            float min2 = Math.min(Math.max(0.0f, va0Var.getTranslationY() + (q1Var.f ? q1Var.e.getTop() : getHeight())) + this.s, (1.0f - this.M) * getHeight());
            this.n = 0.0f;
            ...
            float max = Math.max(0.0f, va0Var.getTranslationY() + (q1Var.f ? q1Var.e.getBottom() : 0)) - this.s;
            this.n = max;
    ...
    public final void o(boolean z10) {
        if (z10) {
            ...
            if (!this.I) {
                ...
                if (getVisibility() == 8) {
                    this.M = 1.0f;
                    va0Var.setTranslationY(g10 ? -(this.v + AndroidUtilities.dp(12.0f)) : va0Var.computeVerticalScrollOffset() + this.v);
                }
            }
            setVisibility(0);
        } else {
