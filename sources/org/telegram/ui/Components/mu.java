...
public final class mu extends org.telegram.ui.ActionBar.h5 {
    public final /* synthetic */ boolean f;
    public final /* synthetic */ pu h;

    public mu(pu puVar, boolean z4) {
        this.h = puVar;
        this.f = z4;
    }
    ...
    public final boolean g() {
        ...
        try {
            puVar.r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e) {
            FileLog.e(e);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        pu puVar = this.h;
        int i10 = puVar.N;
        RadialProgressView radialProgressView = puVar.n;
        ju juVar = puVar.b;
        e91 e91Var = puVar.c;
        if (this.f && puVar.c.g(puVar.H, null, null, puVar.F, true)) {
            radialProgressView.setVisibility(4);
            juVar.setVisibility(4);
        ...
        try {
            ...
            puVar.y = true;
            juVar.addJavascriptInterface(new ou(puVar), "YoutubeProxy");
            String str2 = puVar.F;
            if (str2 != null) {
                try {
