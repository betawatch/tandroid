...
public final class q50 extends DispatchQueue {
    ...
    public final void c() {
        y50 y50Var = this.E;
        if (y50Var.f0[y50Var.X0] != null) {
            y50 y50Var2 = this.E;
            int width = y50Var2.f0[y50Var2.X0].getWidth();
            y50 y50Var3 = this.E;
            float min = this.C / Math.min(width, r1);
            int i10 = (int) (width * min);
            int height = (int) (y50Var3.f0[y50Var3.X0].getHeight() * min);
            if (i10 == height) {
                y50 y50Var4 = this.E;
                y50Var4.y0 = 1.0f;
                y50Var4.z0 = 1.0f;
                ...
                y50 y50Var5 = this.E;
                y50Var5.y0 = 1.0f;
                y50Var5.z0 = i10 / this.D;
            } else {
                y50 y50Var6 = this.E;
                y50Var6.y0 = height / this.C;
                y50Var6.z0 = 1.0f;
            }
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 != 0) {
            if (i10 == 1) {
                finish();
                if (this.y && ((!((z10 = (obj = message.obj) instanceof t50)) || ((t50) obj).c != -2) && (x50Var = this.E.V0) != null)) {
                    x50Var.i(message.arg1, z10 ? (t50) obj : null);
                }
            ...
            if (i10 != 2) {
                ...
                c();
                y50 y50Var2 = this.E;
                float f10 = (1.0f / y50Var2.y0) / 2.0f;
                float f11 = (1.0f / y50Var2.z0) / 2.0f;
                float f12 = 0.5f - f10;
                float f13 = 0.5f - f11;
                float f14 = f10 + 0.5f;
                float f15 = f11 + 0.5f;
                y50Var2.w0 = org.telegram.messenger.y3.k(ByteBuffer.allocateDirect(32));
            ...
            if (surfaceTexture != null) {
                ...
                y50Var3.S = 0.0f;
                iArr2[0] = 0;
                y50Var3.x0 = y50Var3.w0.duplicate();
                y50 y50Var4 = this.E;
                y50Var4.A0 = y50Var4.f0[0];
            }
            ...
            c();
            y50 y50Var5 = this.E;
            float f16 = (1.0f / y50Var5.y0) / 2.0f;
            float f17 = (1.0f / y50Var5.z0) / 2.0f;
            float f18 = 0.5f - f16;
            float f19 = 0.5f - f17;
            float f20 = f16 + 0.5f;
            float f21 = f17 + 0.5f;
            y50Var5.w0 = org.telegram.messenger.y3.k(ByteBuffer.allocateDirect(32));
        ...
        if (this.f) {
            ...
            if (this.y) {
                ...
                if (y50Var7.V0.C0) {
                    if (!y50Var7.C) {
                        this.E.C = true;
                        AndroidUtilities.runOnUIThread(new Runnable(this) { // from class: org.telegram.ui.Components.p50
                                ...
                                switch (i13) {
                                    ...
                                    default:
                                        ...
                                        if (y50Var8.i0 != null) {
                                            ...
                                            y50Var8.W0 = y50Var8.i0.getBitmap();
                                            break;
                                        }
                                        break;
                                }
                ...
                if (x50Var2.C0 && x50Var2.Q != null && x50Var2.Q.getLooper() != null && x50Var2.Q.getLooper().getThread() != null && x50Var2.Q.getLooper().getThread().isAlive()) {
                    x50Var2.w = eglGetCurrentContext;
                    x50Var2.Q.sendMessage(x50Var2.Q.obtainMessage(0, 1, 0));
                }
                x50Var2.C0 = true;
                int i16 = MessagesController.getInstance(x50Var2.E0.a).roundVideoSize;
                int i17 = MessagesController.getInstance(x50Var2.E0.a).roundVideoBitrate * 1024;
                AndroidUtilities.runOnUIThread(new u50(x50Var2, i12));
                x50Var2.a = m50Var;
                x50Var2.d = i16;
                x50Var2.e = i16;
                x50Var2.f = i17;
                ...
                synchronized (x50Var2.R) {
                    try {
                        if (!x50Var2.T) {
                            ...
                            x50Var2.x0.clear();
                            x50Var2.z0 = 0;
                            DispatchQueue dispatchQueue = x50Var2.y0;
                            if (dispatchQueue != null) {
                                dispatchQueue.cleanupQueue();
                                x50Var2.y0.recycle();
                            }
                            x50Var2.y0 = new DispatchQueue("keyframes_thumb_queue");
                ...
                if (currentOrientation == 90 || currentOrientation == 270) {
                    y50 y50Var9 = this.E;
                    float f22 = y50Var9.y0;
                    y50Var9.y0 = y50Var9.z0;
                    y50Var9.z0 = f22;
                }
                this.y = true;
                this.E.r();
            ...
            y50 y50Var10 = this.E;
            if (y50Var10.V0 != null && ((y50Var10.X0 == 0 && z11) || (this.E.X0 == 1 && z12))) {
                y50 y50Var11 = this.E;
                x50 x50Var3 = y50Var11.V0;
                SurfaceTexture surfaceTexture2 = this.n[y50Var11.X0];
                y50 y50Var12 = this.E;
                if (y50Var12.m0) {
                    i14 = y50Var12.X0;
                }
                        ...
                        switch (i12) {
                            ...
                            default:
                                ...
                                if (y50Var82.i0 != null) {
                                    ...
                                    y50Var82.W0 = y50Var82.i0.getBitmap();
                                    break;
                                }
                                break;
                        }
                ...
                if (eglCreateContext == null) {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            Matrix.setIdentityM(y50Var.t0, 0);
                            ...
                            if (a2 == 0 || a10 == 0) {
                                ...
                                Matrix.setIdentityM(y50Var.s0, 0);
                                ...
                                for (final int i11 = 0; i11 < 2; i11++) {
                                    ...
                                    AndroidUtilities.runOnUIThread(new ey(y50Var, i11, surfaceTextureArr[i11], i10));
                                }
                                if (BuildVars.LOGS_ENABLED) {
