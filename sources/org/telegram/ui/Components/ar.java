...
public abstract class ar {
    public static void a(Context context, final int i10, TLRPC.User user, TLRPC.TL_requestPeerTypeCreateBot tL_requestPeerTypeCreateBot, boolean z4, final Utilities.Callback callback, org.telegram.ui.ActionBar.f6 f6Var, qc qcVar) {
        ...
        j10.setText(AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(R.string.CreateManagedBotText, UserObject.getUserName(user)), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var)));
        j10.setGravity(17);
        ...
        o10.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Components.wq
