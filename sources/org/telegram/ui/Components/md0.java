...
public final class md0 extends HorizontalScrollView {
    ...
    public static void a(md0 md0Var, int i10, int i11) {
        View childAt;
        if (md0Var.f == 0 || (childAt = md0Var.d.getChildAt(i10)) == null) {
            return;
        }
        ...
        if (childAt != null) {
            ...
            if (f10 <= 0.0f || (i10 = this.h) >= this.f - 1) {
                ...
                if (childAt instanceof ld0) {
                    ...
                    ld0Var.setTextColor(ld0Var.a.c(AndroidUtilities.lerp(0.6f, 0.8f, 1.0f - this.n)));
                }
                if (childAt2 instanceof ld0) {
                    ld0 ld0Var2 = (ld0) childAt2;
                    ld0Var2.setTextColor(ld0Var2.a.c(AndroidUtilities.lerp(0.6f, 0.8f, this.n)));
                }
            }
            if (this.y != 0) {
