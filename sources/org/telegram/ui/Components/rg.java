...
public final class rg extends FrameLayout {
    ...
    public rg(ChatActivityEnterView chatActivityEnterView, Context context) {
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.j0(org.telegram.ui.ActionBar.h6.be), PorterDuff.Mode.MULTIPLY));
        this.c = org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(5.0f), chatActivityEnterView.j0(org.telegram.ui.ActionBar.h6.qf));
    ...
    public final void a() {
        ci.e4 e4Var = this.a;
        if (e4Var != null) {
            e4Var.l0 = new pg(this, e4Var, 1);
            e4Var.e(true);
            this.a = null;
        }
        ci.e4 e4Var2 = this.b;
        if (e4Var2 != null) {
            e4Var2.l0 = new pg(this, e4Var2, 2);
            e4Var2.e(true);
            this.b = null;
        }
    }
    ...
    public final void b() {
        ...
        ci.e4 e4Var2 = this.b;
        e4Var2.h = ci.e4.a(e4Var2.getText(), this.b.getTextPaint());
        if (chatActivityEnterView.O) {
            ci.e4 e4Var3 = this.b;
            int i10 = R.raw.fire_on;
            e4Var3.getClass();
            yi0 yi0Var = new yi0(i10, AndroidUtilities.dp(34.0f), AndroidUtilities.dp(34.0f));
            yi0Var.start();
            e4Var3.j(yi0Var);
        } else {
        ...
        ci.e4 e4Var4 = this.b;
        e4Var4.l0 = new pg(this, e4Var4, 0);
        e4Var4.u();
    }
    ...
    public final void c() {
        ...
        int i10 = this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd;
        ChatActivityEnterView chatActivityEnterView = this.V;
        this.y.e(chatActivityEnterView.j0(i10), chatActivityEnterView.j0(org.telegram.ui.ActionBar.h6.cf), -1);
        this.n.setColor(chatActivityEnterView.j0(org.telegram.ui.ActionBar.h6.pf));
        int dp = AndroidUtilities.dp(5.0f);
        int i11 = org.telegram.ui.ActionBar.h6.qf;
        this.c = org.telegram.ui.ActionBar.h6.b0(dp, chatActivityEnterView.j0(i11));
        int j02 = chatActivityEnterView.j0(i11);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.d.setColorFilter(new PorterDuffColorFilter(j02, mode));
        this.r.setColor(chatActivityEnterView.j0(org.telegram.ui.ActionBar.h6.ae));
        this.s.setColor(chatActivityEnterView.j0(this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd));
        this.v.setColor(chatActivityEnterView.j0(this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd));
        this.E.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.j0(this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd), mode));
        this.F.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.j0(this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd), mode));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x01ce, code lost:
        ...
        r46.restore();
        r46.save();
        r4.setBounds(r7 - (r4.getIntrinsicWidth() / 2), (int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14)), org.telegram.messenger.ul.B(2, r7, r4), r4.getIntrinsicHeight() + ((int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14))));
        r4.draw(r46);
        r46.restore();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x03e8, code lost:
        ...
        r2 = org.telegram.messenger.z0.A(1.0f, r2, (1.0f - r10) * r8.h4, r5);
        r9 = r7;
        r6 = r30 + r26;
    ...
    */
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.T && rectF2.contains(x10, y3)) {
                ...
                mediaDataController.toggleDraftVoiceOnce(j3, (xnVar == null || !xnVar.h4) ? 0L : xnVar.d(), chatActivityEnterView.O);
                if (chatActivityEnterView.O) {
                    b();
                } else {
                    a();
    ...
    public void setBlurredBackgroundFactory(ah.c cVar) {
        this.Q = true;
        if (this.P == null) {
            this.P = new dh.b(org.telegram.ui.ActionBar.h6.ae, this.V.V3);
        }
