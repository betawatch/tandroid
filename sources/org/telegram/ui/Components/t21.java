...
public final class t21 extends FrameLayout {
    ...
    public t21(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.r = new c6(this, 360L, qr.h);
        this.s = false;
        this.x = false;
        this.y = false;
    ...
    private int getMeasuringWidth() {
        ...
        m6 m6Var = this.e;
        return AndroidUtilities.dp(11.0f) + this.d.getMeasuredWidth() + AndroidUtilities.dp(11.0f) + (m6Var.d > 0.0f ? AndroidUtilities.dp(4.66f) + ((int) Math.max(dp, m6Var.d + AndroidUtilities.dp(10.0f))) : 0) + this.L;
    }
    ...
    public final void d(boolean z10, boolean z11, boolean z12) {
        ...
        if (z10) {
            q21 q21Var = new q21(getContext());
            q21Var.b.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.b));
            imageView.setImageDrawable(q21Var);
        }
        String string = LocaleController.getString(z10 ? R.string.BotForumNewTopic : R.string.AllTopicsShort);
        c90 c90Var = this.d;
        c90Var.setText(string);
        c90Var.setVisibility(z10 ? 8 : 0);
        setSelected(z12);
        h();
        e(0, true, false);
        if (this.s) {
    ...
    public final void e(int i10, boolean z10, boolean z11) {
        ...
        if (z11 && this.J < i10) {
            ...
            this.K = ofFloat;
            ofFloat.addUpdateListener(new r21(this, 0));
    ...
    public final void g(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        if (userOrChat != null) {
            ...
            g5Var3.b.setForUserOrChat(userOrChat, f9Var);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (f7 > 0.0f) {
            ...
            n4Var.layout(AndroidUtilities.dp(4.66f) + c90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), i16 - (n4Var.getMeasuredHeight() / 2), n4Var.getMeasuredWidth() + AndroidUtilities.dp(4.66f) + c90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), (n4Var.getMeasuredHeight() / 2) + i16);
        }
    ...
    public void setSelected(boolean z10) {
        ...
        this.H = ofFloat;
        ofFloat.addUpdateListener(new r21(this, 1));
