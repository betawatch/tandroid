        ...
        switch (this.a) {
            case 0:
                ...
                if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
                    ...
                    o70 F = o70.F(f0Var.container, f6Var, d0Var);
                    ...
                    F.c(R.drawable.msg_share, LocaleController.getString(R.string.AIEditorShareStyle), new org.telegram.ui.ih(f0Var, tL_aiComposeTone, context, f6Var, 6), false);
                    F.m(!tL_aiComposeTone.creator, R.drawable.msg_delete, LocaleController.getString(R.string.AIEditorRemoveStyle), true, new org.telegram.ui.hp(7, f0Var, tL_aiComposeTone));
                    final int i11 = 1;
            ...
            default:
                ...
                if (num.intValue() == 0) {
                    ...
                    zArr[0] = false;
                    ph.ab.a(true, new org.telegram.ui.web.u1(4, c5Var, l4Var));
                    break;
                    ...
                    zArr[0] = false;
                    ph.m6 m6Var = new ph.m6(c5Var.getContext(), false, null, new org.telegram.ui.web.y0(c5Var, 8), new nh.b());
                    m6Var.setOnDismissListener(new ph.a4(c5Var, 2));
                    m6Var.show();
                    break;
