                    ...
                    if (e5Var != null) {
                        ...
                        if (p2Var != null && (themeDescriptions = p2Var.getThemeDescriptions()) != null) {
                            ...
                            if (themeEditorView.b != null) {
                                ...
                                try {
                                    animatorSet.playTogether(ObjectAnimator.ofFloat(themeEditorView.a, (Property<b11, Float>) property, 1.0f, 0.0f), ObjectAnimator.ofFloat(themeEditorView.a, (Property<b11, Float>) View.SCALE_X, 1.0f, 0.0f), ObjectAnimator.ofFloat(themeEditorView.a, (Property<b11, Float>) View.SCALE_Y, 1.0f, 0.0f));
                                    animatorSet.setInterpolator(themeEditorView.i);
                                    animatorSet.setDuration(150L);
                                    animatorSet.addListener(new d11(themeEditorView, 0));
                                    animatorSet.start();
                                    ...
                                    if (motionEvent.getAction() == 2) {
                                        ...
                                        if (Math.abs(b10 - themeEditorView.g.x) <= dp || ((i10 = themeEditorView.g.x) < 0 && i10 > (-i11) / 4)) {
                                            ...
                                            if (themeEditorView.a.getAlpha() != 1.0f) {
                                                arrayList.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<b11, Float>) property, 1.0f));
                                            }
                                            ...
                                            if (Math.abs(b11 - i10) > dp) {
                                                ...
                                                if (i21 <= i22 - i11 || i21 >= i22 - ((i11 / 4) * 3)) {
                                                    ...
                                                    if (arrayList != null) {
                                                        ...
                                                        if (z4) {
                                                            z10 = true;
                                                            arrayList.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<b11, Float>) property, 0.0f));
                                                            animatorSet2.addListener(new d11(themeEditorView, 1 == true ? 1 : 0));
                                                        } else {
                                                            z10 = true;
                                                        }
                                            ...
                                            edit.putInt("sidex", 1);
                                            if (themeEditorView.a.getAlpha() != 1.0f) {
                                                arrayList2.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<b11, Float>) property, 1.0f));
                                            }
