    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (i31 < i32) {
                ...
                RectF rectF = this.b;
                if (f7 != 1.0f) {
                    org.telegram.ui.ActionBar.h6.t0.setColor(-1);
                ...
                org.telegram.ui.ActionBar.h6.t0.setColor(-1973016);
                org.telegram.ui.ActionBar.h6.t0.setAlpha((int) (editorAlert.c.getAlpha() * 255.0f));
                ...
                if (i13 > 0) {
                    ...
                    canvas.drawRect(i14, f11, measuredWidth2 - i15, AndroidUtilities.statusBarHeight, org.telegram.ui.ActionBar.h6.t0);
                }
                ...
                boolean z12 = AndroidUtilities.computePerceivedBrightness(editorAlert.getThemedColor(org.telegram.ui.ActionBar.h6.h5)) <= 0.721f;
                boolean z13 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v(editorAlert.getThemedColor(org.telegram.ui.ActionBar.h6.s8), 855638016)) > 0.721f;
        ...
        if (AndroidUtilities.computePerceivedBrightness(editorAlert.getThemedColor(org.telegram.ui.ActionBar.h6.h5)) <= 0.721f) {
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v(editorAlert.getThemedColor(org.telegram.ui.ActionBar.h6.s8), 855638016)) > 0.721f) {
        }
        this.c = Boolean.valueOf(z11);
        if (!z11) {
        }
