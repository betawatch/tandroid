...
public final class r01 extends FrameLayout {
    ...
    public r01(ThemeEditorView.EditorAlert editorAlert, Context context) {
        ...
        while (i10 < 4) {
            ...
            this.a.addView(this.n[i10], h7.z5.k(0.0f, 0.0f, i10 != 3 ? 16.0f : 0.0f, 0.0f, 55, 36));
            this.n[i10].addTextChangedListener(new q01(this, i10));
            this.n[i10].setOnEditorActionListener(new o2(2));
            i10++;
        }
    }
    ...
    public final void d(boolean z10) {
        ...
        ObjectAnimator ofInt = ObjectAnimator.ofInt(d3Var, m6.d, z10 ? 0 : 51);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i18 = dp / 2;
        float f14 = i17;
        a(canvas, i15 + i18, (int) ((fArr[c10] * f14) + f12), Color.HSVToColor(fArr));
        int i19 = (i10 * 2) + i15;
        if (this.y == null) {
        ...
        a(canvas, i19 + i18, (int) com.google.android.recaptcha.internal.a.z(1.0f, this.v, f14, f12), (Color.HSVToColor(fArr) & 16777215) | (((int) (this.v * 255.0f)) << 24));
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        int d = i0.a.d(20.0f, (i10 / 2) - (this.b * 2), 1);
        this.r = d;
        int i14 = d * 2;
        int i15 = d * 2;
