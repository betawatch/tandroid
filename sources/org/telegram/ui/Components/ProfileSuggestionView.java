...
public class ProfileSuggestionView extends FrameLayout {
    ...
    public ProfileSuggestionView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(10.0f), Theme.multAlpha(-16777216, 0.175f)));
        ...
        textView2.setText(LocaleController.getString(R.string.PasskeyPopupText));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(88.0f), TLObject.FLAG_30));
    }
