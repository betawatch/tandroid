...
public final class a10 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (w01Var4 != null) {
            ...
            canvas.translate(f10, measuredHeight - (w01Var4.j() / 2.0f));
            w01Var4.d(canvas);
            canvas.restore();
            f11 = f16;
        } else {
        ...
        if (charSequence2 == null || charSequence2.length() == 0) {
            ...
            f13 = 2.0f;
            int dp = (int) (w01Var4.c + f10 + AndroidUtilities.dp(4.66f));
            int dp2 = (int) (measuredHeight - AndroidUtilities.dp(9.0f));
            f12 = measuredHeight;
            int d = (int) (n6Var.d() + w01Var4.c + f10 + AndroidUtilities.dp(f7));
            w01Var = w01Var4;
        ...
        float f17 = (f10 - dp3) - w01Var2.c;
        canvas.save();
        canvas.translate(f17, (f12 - (w01Var2.j() / f13)) + AndroidUtilities.dp(1.0f));
        w01Var2.d(canvas);
        canvas.restore();
        float f18 = f10 + f11;
        if (w01Var3 != null) {
            canvas.save();
            canvas.translate(f18 + dp3, (f12 - (w01Var3.j() / f13)) + AndroidUtilities.dp(1.0f));
            w01Var3.d(canvas);
            canvas.restore();
            f18 += dp3 + w01Var3.c;
        }
        float f19 = f18;
        float dp4 = AndroidUtilities.dp(12.0f) + (w01Var.j() / f13) + f12;
