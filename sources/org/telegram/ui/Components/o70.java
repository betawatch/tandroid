...
public final class o70 {
    ...
    public o70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        ...
        if ((((n2Var instanceof ProfileActivity) && ((ProfileActivity) n2Var).I0) || (((n2Var instanceof org.telegram.ui.ry) && ((org.telegram.ui.ry) n2Var).W) || (((n2Var instanceof ContactsActivity) && ((ContactsActivity) n2Var).I) || ((n2Var instanceof org.telegram.ui.x81) && ((org.telegram.ui.x81) n2Var).M)))) && (parentLayout = n2Var.getParentLayout()) != null) {
            org.telegram.ui.ActionBar.n2 safeLastFragment = parentLayout.getSafeLastFragment();
            if (safeLastFragment instanceof org.telegram.ui.zg0) {
    ...
    public static o70 F(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view) {
        return new o70(viewGroup, d6Var, view, false, false, false);
    }

    public static o70 G(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view, boolean z10) {
        return new o70(viewGroup, d6Var, view, z10, false, false);
    }

    public static o70 H(org.telegram.ui.ActionBar.n2 n2Var, View view) {
        return new o70(n2Var, view, false, true);
    }

    public static o70 I(org.telegram.ui.ActionBar.n2 n2Var, View view) {
        return new o70(n2Var, view, true, true);
    }
    ...
    public static void a(o70 o70Var, ViewGroup viewGroup) {
        ...
        o70Var.m0.addListener(new ai.y4(o70Var, m70Var, viewGroup, 7));
        if (o70Var.L) {
            o70Var.m0.setDuration(380L);
            o70Var.m0.setInterpolator(rr.h);
        } else {
    ...
    public static void f(o70 o70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        Object obj;
        ArrayList<TLRPC.PhotoSize> arrayList;
        Context context = o70Var.e;
        org.telegram.ui.ActionBar.d6 d6Var = o70Var.d;
        l70 l70Var = new l70(context);
        LinearLayout linearLayout = new LinearLayout(context);
        l70Var.addView(linearLayout);
        linearLayout.setOrientation(1);
        o70Var.r(l70Var, w7.x5.n(-1, -2));
        float f7 = 0.12f;
        if (z10 && runnable != null) {
            org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(2, o70Var.e, o70Var.d, false, false);
            f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
            int i10 = org.telegram.ui.ActionBar.h6.E8;
            f1Var.c(org.telegram.ui.ActionBar.h6.v0(i10, d6Var), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.F8, d6Var));
            f1Var.setSelectorColor(org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(i10, d6Var)));
        ...
        while (i11 < size) {
            ...
            org.telegram.ui.ActionBar.f1 f1Var2 = new org.telegram.ui.ActionBar.f1(2, o70Var.e, o70Var.d, false, false);
            ...
            f1Var2.c(org.telegram.ui.ActionBar.h6.v0(i13, d6Var), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.F8, d6Var));
            f1Var2.setSelectorColor(org.telegram.ui.ActionBar.h6.l1(f7, org.telegram.ui.ActionBar.h6.v0(i13, d6Var)));
            ...
            f1Var2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.h70
    ...
    public final void B() {
        ...
        this.D = ooVar;
        ooVar.setDispatchKeyEventListener(new d70(this, 0));
        this.A = this.D;
    }
    ...
    public final void M(Runnable runnable) {
        ...
        if (childAt instanceof org.telegram.ui.ActionBar.f1) {
            ...
            f1Var.setOnClickListener(new g70(this, runnable, 2));
        }
    }
    ...
    public final void X(float f7) {
        j70 j70Var = this.m;
        if (j70Var != null) {
            j70Var.update((int) this.a0, (int) (this.b0 + f7), -1, -1);
        }
    }
        ...
        while (i10 < this.A.getChildCount()) {
            ...
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ...
                if (actionBarPopupWindow$ActionBarPopupWindowLayout.getItemsCount() > 0) {
                    ...
                    } else if ((childAt2 instanceof tb0) || (childAt2 instanceof FrameLayout)) {
                    ...
                    } else if ((childAt3 instanceof tb0) || (childAt3 instanceof FrameLayout)) {
    ...
    */
    public final void Z() {
        ...
        if (this.s > 0 || this.u || this.v) {
            ...
            this.m0.addListener(new r8(this, 24));
            if (this.L) {
                f11 = f16;
        ...
        if (!this.L || (m70Var2 = this.x) == null || this.N == 0) {
            ...
            m70Var2.s = (overlayContainerView.getWidth() - this.N) / f10;
            if (this.M == 3) {
        ...
        if (this.W) {
            ...
            if (this.U || f17 + height2 + this.A.getMeasuredHeight() + AndroidUtilities.dp(16.0f) > i19) {
                ...
                if (!this.V || Math.max(0.0f, f17 + height2) + this.A.getMeasuredHeight() <= fArr[1] + rectF.top || rectF.height() != view.getHeight()) {
                    ...
                    if (this.L && (m70Var = this.x) != null) {
                        ...
                        m70Var.v = (height3 - (measuredHeight + f18)) / f10;
                        m70 m70Var4 = this.x;
                        height = (int) (m70Var4.v + f18);
                    ...
                    this.b0 = f20;
                    j70Var2.showAtLocation(overlayContainerView, 0, (int) f19, (int) f20);
                    if (this.w && view != 0) {
                        if (view.getParent() != null) {
                            view.getParent().requestDisallowInterceptTouchEvent(true);
                        }
                        wr wrVar = new wr(new WeakReference(this), i12);
                        this.o0 = wrVar;
            ...
            if (this.L) {
                ...
                m70Var.v = (height32 - (measuredHeight2 + f182)) / f10;
                m70 m70Var42 = this.x;
                height = (int) (m70Var42.v + f182);
            ...
            this.b0 = f202;
            j70Var22.showAtLocation(overlayContainerView, 0, (int) f192, (int) f202);
            if (this.w) {
                if (view.getParent() != null) {
                }
                wr wrVar2 = new wr(new WeakReference(this), i12);
                this.o0 = wrVar2;
        ...
        this.b0 = f2022;
        j70Var222.showAtLocation(overlayContainerView, 0, (int) f1922, (int) f2022);
        if (this.w) {
        }
        if (this.d0) {
        }
    ...
    public final void b(int i10, Drawable drawable, CharSequence charSequence, int i11, int i12, Runnable runnable) {
        ...
        f1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(i12, d6Var)));
        f1Var.setOnClickListener(new g70(this, runnable, 3));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.x5.n(-1, -2));
        } else {
    ...
    public final void d(org.telegram.ui.ActionBar.f1 f1Var) {
        ...
        Integer num2 = this.k0;
        f1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.F8, d6Var));
        f1Var.setSelectorColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.ai, d6Var));
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.E8, d6Var)));
        int i10 = this.S;
        if (i10 <= 0) {
            r(f1Var, w7.x5.n(-1, -2));
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        f1Var.addView(w9Var, w7.x5.d(34, 34.0f, (LocaleController.isRTL ? 5 : 3) | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.d6 d6Var = this.d;
        if (z10) {
        ...
        Integer num2 = this.k0;
        f1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.h6.v0(i12, d6Var));
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(i11, d6Var)));
        f1Var.setOnClickListener(new g70(this, runnable, 4));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.x5.n(-1, -2));
        } else {
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        f1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(i10, d6Var)));
        f1Var.setOnClickListener(new g70(this, runnable, 1));
        int i12 = this.S;
        if (i12 <= 0) {
            r(f1Var, w7.x5.n(-1, -2));
        } else {
    ...
    public final void j(boolean z10, int i10, ii.c2 c2Var, CharSequence charSequence, Runnable runnable) {
        ...
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.h6.l1(0.12f, org.telegram.ui.ActionBar.h6.v0(i11, d6Var)));
        f1Var.setOnClickListener(new g70(this, runnable, 5));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.x5.n(-1, -2));
        } else {
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        h9Var.p(tLObject);
        w9Var.e(tLObject, h9Var);
        frameLayout.addView(w9Var, w7.x5.d(34, 34.0f, 19, 13.0f, 0.0f, 0.0f, 0.0f));
        ...
        org.telegram.messenger.ul.o(org.telegram.ui.ActionBar.h6.q5, d6Var, f7, 1, 13.0f);
    ...
    public o70(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view, boolean z10, boolean z11, boolean z12) {
        this.i = 5;
        this.o = new float[2];
        this.t = true;
        this.w = true;
    ...
    public o70(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, org.telegram.ui.ActionBar.d6 d6Var) {
        this.i = 5;
        this.o = new float[2];
        this.t = true;
        this.w = true;
