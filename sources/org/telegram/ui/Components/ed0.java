...
public class ed0 extends LinearLayout {
    ...
    public ed0(LaunchActivity launchActivity) {
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.E) {
            ...
            if (strArr != null) {
                ...
                ad0 ad0Var = this.K;
                str = ad0Var != null ? ad0Var.j(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.G;
                    ad0 ad0Var = this.K;
                    str = ad0Var != null ? ad0Var.j(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z10) {
        ...
        if (z10 && (cd0Var = this.I) != null) {
            cd0Var.q(this, this.G);
        }
        f();
        invalidate();
        if (this.k0 != 0 || (bd0Var = this.J) == null) {
            return;
        }
        bd0Var.n(0);
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (f7 < this.l0) {
            if (this.k0 == 0) {
                ...
                dd0Var.c = 1;
                dd0Var.b = 2;
                ((ed0) dd0Var.d).postDelayed(dd0Var, ViewConfiguration.getTapTimeout());
            }
            ...
            dd0Var2.c = 1;
            dd0Var2.b = 1;
            ((ed0) dd0Var2.d).postDelayed(dd0Var2, ViewConfiguration.getTapTimeout());
        }
        ...
        if (f10 < this.l0) {
            ...
            zc0 zc0Var = this.V;
            zc0Var.a = false;
            postDelayed(zc0Var, longPressTimeout);
            return true;
        }
        if (f10 > this.m0) {
            ...
            zc0 zc0Var2 = this.V;
            zc0Var2.a = true;
            postDelayed(zc0Var2, longPressTimeout2);
        }
        return true;
    }
    ...
    public void setFormatter(ad0 ad0Var) {
        if (ad0Var == this.K) {
            return;
        }
        this.K = ad0Var;
    ...
    public void setOnScrollListener(bd0 bd0Var) {
        this.J = bd0Var;
    }

    public void setOnValueChangedListener(cd0 cd0Var) {
        this.I = cd0Var;
    }
    ...
    */
    ...
    public ed0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        this(context, 18, d6Var);
    }

    public ed0(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.a = 3;
        this.b = 1;
        this.L = 300L;
        ...
        setAccessibilityDelegate(new yc0(this));
    }
}
