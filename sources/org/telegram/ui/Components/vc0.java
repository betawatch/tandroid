...
public class vc0 extends LinearLayout {
    public static final pr v0 = new pr(0.0f, 0.5f, 0.5f, 1.0f);
    public int E;
    public boolean F;
    public int G;
    public int H;
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.E) {
            ...
            if (strArr != null) {
                ...
                rc0 rc0Var = this.K;
                str = rc0Var != null ? rc0Var.f(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.G;
                    rc0 rc0Var = this.K;
                    str = rc0Var != null ? rc0Var.f(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z10) {
        ...
        f();
        invalidate();
        if (this.k0 != 0 || (sc0Var = this.J) == null) {
            return;
        }
        sc0Var.b(0);
    }
