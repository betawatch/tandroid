        ...
        while (true) {
            ...
            if (f10 >= 0.0f) {
                ...
                if (i14 == i15 || i14 == i12) {
                    ...
                    C = org.telegram.messenger.rl.C(3.0f, i16, dp6);
                    i10 = dp5;
                } else if (i14 == i11) {
                    ...
                    C = org.telegram.messenger.rl.C(2.0f, i16, dp7);
                } else if (i14 == 2) {
                    i10 = AndroidUtilities.dp(5.0f * f11);
                    dp = AndroidUtilities.dp(f11 * 18.0f);
                    ...
                    C = org.telegram.messenger.rl.C(2.0f, i16, dp8);
                } else if (i14 == i13) {
                    ...
                    dp3 = (intrinsicHeight / 2) + intrinsicHeight2;
                    i10 = dp9;
                    C = org.telegram.messenger.rl.C(7.0f, i16, dp10);
                } else {
                    i10 = AndroidUtilities.dp(5.0f * f11);
                    dp = AndroidUtilities.dp(f11 * 18.0f);
                    ...
                    dp3 = ((intrinsicHeight / 2) + intrinsicHeight2) - AndroidUtilities.dp(7.0f);
                    C = org.telegram.messenger.rl.C(42.0f, i16, dp11);
                }
                float f12 = fArr[i17];
                int a2 = (int) ((f12 < 0.5f ? f12 / 0.5f : org.telegram.messenger.y1.a(f12, 0.5f, 0.5f, 1.0f)) * 255.0f);
