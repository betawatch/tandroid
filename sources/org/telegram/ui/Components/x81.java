...
public class x81 extends FrameLayout {
    ...
    */
                ...
                if (motionEvent != null && motionEvent.getAction() == 0 && !this.H && !this.I) {
                    ...
                    if (this.H) {
                        ...
                        if (this.d < 0) {
                            ...
                            ofFloat.addUpdateListener(new k81(this, i10));
                        ...
                        this.w.addListener(new l81(this, i10));
                        this.w.start();
                        this.x = true;
                        this.H = false;
                        x(false);
    ...
    public final void D(boolean z10) {
        ...
        o81 o81Var = this.L;
        o81Var.getClass();
        if (!(o81Var instanceof org.telegram.ui.e7)) {
            z10 = false;
        }
    ...
    public final void E(int i10) {
        if (i10 != this.b) {
            ...
            if (valueAnimator == null || this.d != i10) {
                ...
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.R = ofFloat;
                ofFloat.addUpdateListener(new k81(this, i11));
                this.R.addListener(new l81(this, i11));
    ...
    public final void J(int i10) {
        ...
        o81 o81Var = this.L;
        o81Var.b(viewArr[i10], i11, o81Var.h(i11));
    }
    ...
    public final w81 n(int i10, boolean z10) {
        m81 m81Var = new m81(this, getContext(), z10, i10, this.a);
        this.M = m81Var;
        m81Var.r = H();
    ...
    public final void o(boolean z10) {
        m81 m81Var;
        if (this.L == null || (m81Var = this.M) == null) {
            return;
        }
        m81Var.h.clear();
        m81Var.b0.clear();
    ...
    public void setAdapter(o81 o81Var) {
        this.L = o81Var;
        int h = o81Var.h(this.b);
        int[] iArr = this.f;
        iArr[0] = h;
        View d = o81Var.d(h);
        View[] viewArr = this.e;
        ...
        if (d == null && this.b != 0) {
            ...
            int h10 = o81Var.h(0);
            iArr[0] = h10;
            viewArr[0] = o81Var.d(h10);
        }
        o81Var.b(viewArr[0], this.b, iArr[0]);
        addView(viewArr[0]);
        viewArr[0].setVisibility(0);
        o(false);
    }
