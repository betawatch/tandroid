...
public abstract class CreateBotAlert {
    public static void show(final Context context, final int i, final TLRPC.User user, TLRPC.TL_requestPeerTypeCreateBot tL_requestPeerTypeCreateBot, final boolean z, final Utilities.Callback callback, final Theme.ResourcesProvider resourcesProvider, BulletinFactory bulletinFactory, boolean z2) {
        ...
        if (!user.bot_can_manage_bots) {
            if (bulletinFactory == null) {
                ...
                bulletinFactory2 = BulletinFactory.of(safeLastFragment);
            } else {
            ...
            bulletinFactory2.createSimpleBulletin(R.raw.error, AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(R.string.CreateManagedBotUnsupported, userName), Theme.getColor(Theme.key_undo_cancelColor, resourcesProvider))).show();
            if (callback != null) {
                callback.run(null);
                return;
            }
        ...
        editTextCell.setBackground(Theme.createRoundRectDrawable(dp, Theme.getColor(i3, resourcesProvider)));
        ...
        final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.CreateBotAlert$$ExternalSyntheticLambda1
            ...
            public final void run() {
                CreateBotAlert.lambda$show$2(EditTextCell.this, iArr, i, strArr, strArr2, round, textInfoPrivacyCell2, resourcesProvider, iArr2);
            }
        };
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.CreateBotAlert$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                CreateBotAlert.lambda$show$6(strArr, runnable, editTextCell, iArr2, round, z, i, user, zArr, callback, create, resourcesProvider, context);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$show$6(String[] strArr, Runnable runnable, EditTextCell editTextCell, int[] iArr, final ButtonWithCounterView buttonWithCounterView, boolean z, final int i, final TLRPC.User user, final boolean[] zArr, final Utilities.Callback callback, final BottomSheet bottomSheet, final Theme.ResourcesProvider resourcesProvider, final Context context) {
        if (strArr[0] == null) {
            runnable.run();
            return;
        }
        String trim = editTextCell.editText.getText().toString().trim();
        ...
        ConnectionsManager.getInstance(i).sendRequestTyped(createbot, new BotForumHelper$$ExternalSyntheticLambda2(), new Utilities.Callback2() { // from class: org.telegram.ui.Components.CreateBotAlert$$ExternalSyntheticLambda8
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                CreateBotAlert.lambda$show$5(ButtonWithCounterView.this, zArr, i, callback, bottomSheet, resourcesProvider, context, user, (TLRPC.User) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$show$5(ButtonWithCounterView buttonWithCounterView, boolean[] zArr, int i, Utilities.Callback callback, final BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, final Context context, TLRPC.User user, TLRPC.User user2, TLRPC.TL_error tL_error) {
        String userName;
        String formatString;
        buttonWithCounterView.setLoading(false);
        if (user2 != null) {
        ...
        if (tL_error != null) {
            if ("BOT_CREATE_LIMIT_EXCEEDED".equalsIgnoreCase(tL_error.text)) {
                ...
                BulletinFactory of = BulletinFactory.of(bottomSheet.topBulletinContainer, resourcesProvider);
                int i2 = R.raw.error;
                String string = LocaleController.getString(R.string.CreateManagedBotLimitTitle);
                if (isPremium) {
                    formatString = LocaleController.formatString(R.string.CreateManagedBotLimitText, Integer.valueOf(messagesController.config.botsCreateLimitPremium.get()));
                } else {
                    formatString = LocaleController.formatString(R.string.CreateManagedBotLimitTextPremium, Integer.valueOf(messagesController.config.botsCreateLimitPremium.get()), Integer.valueOf(messagesController.config.botsCreateLimitDefault.get()));
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$show$10(boolean[] zArr, Utilities.Callback callback, DialogInterface dialogInterface) {
        if (zArr[0]) {
            return;
        }
        zArr[0] = true;
    ...
    private static SpannableStringBuilder highlightBotFather(Context context, CharSequence charSequence, final Runnable runnable, final Theme.ResourcesProvider resourcesProvider) {
        ...
        int charSequenceIndexOf = AndroidUtilities.charSequenceIndexOf(spannableStringBuilder, "@BotFather");
        if (charSequenceIndexOf >= 0) {
            spannableStringBuilder.setSpan(new ClickableSpan() { // from class: org.telegram.ui.Components.CreateBotAlert.2
                ...
                public void updateDrawState(TextPaint textPaint) {
                    ...
                    textPaint.setColor(Theme.getColor(Theme.key_undo_cancelColor, Theme.ResourcesProvider.this));
                }
            ...
            }, charSequenceIndexOf, charSequenceIndexOf + 10, 33);
        }
