...
public final class oh0 extends View {
    ...
    public final void d() {
        ...
        AndroidUtilities.runOnUIThread(new uw(23, this, arrayList));
    }
    ...
    public final lh0 k(int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                j3 = new lh0(this, mh0.n);
                j3.t = true;
                j3.x = 200;
                break;
            case 4:
                j3 = new lh0(this, mh0.r);
                break;
            case 5:
                j3 = new lh0(this, mh0.s);
                this.K = j3;
                j3.t = true;
                j3.x = 500;
                break;
            case 6:
                ...
                break;
            case 7:
                j3 = new lh0(this, mh0.w);
                j3.t = true;
                j3.v = 300;
                break;
            case 8:
                j3 = new lh0(this, mh0.x);
                j3.t = true;
                j3.x = 500;
                break;
            case 9:
                j3 = new lh0(this, mh0.y);
                j3.t = true;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        while (i13 < size) {
            ...
            if (z12) {
                ...
                e6 e6Var = lh0Var5.e;
                f13 = f18;
                RectF rectF2 = lh0Var5.c;
                float f24 = f19;
                oh0 oh0Var = lh0Var5.y;
                f14 = itemWidth;
                RectF rectF3 = lh0Var5.f;
                i11 = i13;
                RectF rectF4 = lh0Var5.g;
                lh0 lh0Var6 = lh0Var3;
                if (lh0Var5.o) {
                    lh0Var5.a();
                } else {
                    boolean z13 = oh0Var.e;
                    float f25 = oh0Var.N;
                    if (z13) {
                        lh0Var5.n = false;
                        rectF2.set(rectF);
                        ...
                        if (rectF3.isEmpty()) {
                            ...
                            boolean z15 = rectF.right + 1.0f >= ((float) oh0Var.getMeasuredWidth()) - f25;
                            if (z14 && z15) {
                                lh0Var = lh0Var4;
                            } else {
                                z11 = z15;
                                lh0 lh0Var7 = oh0Var.L;
                                if (lh0Var7 != null) {
                                    lh0Var = lh0Var4;
                                } else {
                                    lh0Var = lh0Var4;
                                }
                                lh0 lh0Var8 = oh0Var.M;
                                if (lh0Var8 != null) {
                                }
                                i12 = lh0Var5.a;
                                if (((i12 != 5 && i12 != 6) || oh0Var.H != 0) && ((i12 != 3 && i12 != 2) || oh0Var.H != 1)) {
                                    if (!z14 && (lh0Var2 = oh0Var.L) != null && !lh0Var2.o) {
                                        z11 = true;
                                        z14 = false;
                                    } else if (z11) {
                                        lh0 lh0Var9 = oh0Var.M;
                                        if (lh0Var9 != null) {
                                        }
                                    }
                                    if (!z14) {
        ...
        while (i14 < size) {
            ...
            if (z16) {
                ...
                if (this.S != null) {
                    ...
                    paint2.setAlpha((int) (lh0Var10.b() * f12 * alpha2));
        ...
        if (clamp013 > 0.0f) {
            int i15 = 0;
            while (i15 < size) {
                lh0 lh0Var11 = (lh0) arrayList.get(i15);
                if (lh0Var11 != null) {
                    Rect rect = lh0Var11.h;
                    RectF rectF8 = lh0Var11.d;
                    if (!lh0Var11.p) {
                        ...
                        canvas.save();
                        float b11 = lh0Var11.b() * clamp013;
                        float centerX2 = rectF8.centerX();
                        float centerY = rectF8.centerY();
                        float f30 = a2;
                        f10 = clamp01;
                        float a10 = lh0Var11.b.a(0.04f) * f10;
                        ...
                        float f31 = dp * 0.5f;
                        lh0Var11.l.q(rectF8.width() - AndroidUtilities.dp(f21));
                        lh0Var11.m = lh0Var11.l.b.getLineCount() >= 3 ? 0.75f : lh0Var11.l.b.getLineCount() >= 2 ? 0.85f : 1.0f;
                        float max2 = Math.max(0.0f, AndroidUtilities.dpf2(1.33f) + com.google.android.gms.internal.vision.e2.v(lh0Var11.l.j(), lh0Var11.m, f26, 3.0f));
                        rect.set((int) (centerX3 - f31), (int) max2, (int) (centerX3 + f31), (int) (max2 + dp));
                        ij0 ij0Var = lh0Var11.k;
                        if (ij0Var != null) {
                            ij0Var.setBounds(rect);
                        }
                        Drawable drawable = lh0Var11.i;
                        if (drawable != null) {
                            drawable.setBounds(rect);
                        }
                        Drawable drawable2 = lh0Var11.j;
                        if (drawable2 != null) {
                            drawable2.setBounds(rect);
                        }
                        float j3 = ((rect.bottom + rect.top) - ((lh0Var11.l.j() * lh0Var11.m) / f21)) - AndroidUtilities.dp(4.66f);
                        canvas.save();
                        float f32 = lh0Var11.m;
                        f7 = f26;
                        canvas.scale(f32, f32, centerX2, a4.a.A(lh0Var11.l.j(), lh0Var11.m, 2.0f, j3));
                        v01 v01Var = lh0Var11.l;
                        v01Var.c(centerX2 - (v01Var.l() / 2.0f), j3, b11, d, canvas);
                        canvas.restore();
                        float f33 = lh0Var11.q;
                        if (f33 != 1.0f) {
                            canvas.scale(f33, f33, rect.centerX(), rect.centerY());
                        }
                        float f34 = (1.0f - f30) * b11;
                        float f35 = f30 * b11;
                        ij0 ij0Var2 = lh0Var11.k;
                        if (ij0Var2 == null) {
                            h(canvas, lh0Var11.j, f34);
                            h(canvas, lh0Var11.i, f35);
                        } else if (lh0Var11.a == 1) {
                            h(canvas, lh0Var11.j, f34);
                            h(canvas, lh0Var11.k, f35);
                        } else {
                            h(canvas, ij0Var2, b11);
                        }
                        canvas.restore();
                        if (lh0Var11.x > 0 && System.currentTimeMillis() > lh0Var11.x + lh0Var11.w) {
                            lh0Var11.s = false;
                        }
                        if (lh0Var11.s) {
                            p90 p90Var = lh0Var11.r;
                            if (p90Var == null) {
                                p90 p90Var2 = new p90();
                                lh0Var11.r = p90Var2;
                                p90Var2.setCallback(this);
                                lh0Var11.r.f(org.telegram.ui.ActionBar.j6.l1(0.1f, -1), org.telegram.ui.ActionBar.j6.l1(0.3f, -1), org.telegram.ui.ActionBar.j6.l1(0.35f, -1), org.telegram.ui.ActionBar.j6.l1(0.8f, -1));
                                p90 p90Var3 = lh0Var11.r;
                                p90Var3.C = true;
                                p90Var3.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                            } else if (p90Var.b() || lh0Var11.r.c()) {
                                p90 p90Var4 = lh0Var11.r;
                                f11 = clamp013;
                                p90Var4.b = -1L;
                                p90Var4.c = -1L;
                            }
                            ...
                            f11 = clamp013;
                            p90 p90Var5 = lh0Var11.r;
                            if (p90Var5 != null && !p90Var5.c() && !lh0Var11.r.b()) {
                                lh0Var11.r.a();
                            }
                        }
                        p90 p90Var6 = lh0Var11.r;
                        if (p90Var6 != null) {
                            p90Var6.d(rectF8);
                            lh0Var11.r.h(getRoundRadius());
                            lh0Var11.r.setAlpha((int) (b11 * 255.0f));
                            lh0Var11.r.draw(canvas);
                        }
                        i15++;
                        clamp013 = f11;
                        f26 = f7;
        ...
        if (this.E >= AndroidUtilities.dp(8.0f)) {
            ...
            if (action == 0) {
                ...
                while (true) {
                    ...
                    if (!lh0Var2.o && lh0Var2.d.contains(x10, y3)) {
                        this.W = lh0Var2;
                        this.a0 = x10;
                        this.b0 = y3;
                ...
                if (action == 1 && this.W.d.contains(x10, y3)) {
                    ...
                    if (nh0Var != null) {
                        ...
                        if (i12 == 0) {
                            int i13 = lh0Var5.a;
                            RectF rectF = lh0Var5.d;
                            ProfileActivity.Y(((org.telegram.ui.ky0) nh0Var).b, i13, rectF.left, rectF.top);
                        } else {
                            postDelayed(new uw(24, this, lh0Var5), i12);
                        }
                    }
                }
                this.W = null;
    ...
    public final void p(lh0 lh0Var, boolean z10) {
        if (!z10) {
            mh0 mh0Var = this.J ? mh0.e : mh0.f;
            lh0Var.d(0, mh0Var.b, mh0Var.c);
            lh0Var.c(LocaleController.getString(mh0Var.a));
        } else if (this.J) {
            mh0 mh0Var2 = mh0.e;
            lh0Var.c(LocaleController.getString(mh0Var2.a));
            lh0Var.d(R.raw.profile_unmuting, mh0Var2.b, mh0Var2.c);
        } else {
            mh0 mh0Var3 = mh0.f;
            lh0Var.c(LocaleController.getString(mh0Var3.a));
            lh0Var.d(R.raw.profile_muting, mh0Var3.b, mh0Var3.c);
        }
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || (drawable instanceof p90);
    }
}
