        ...
        switch (this.a) {
            case 0:
                ...
                if (actionMasked == 1 || actionMasked == 3 || actionMasked == 6) {
                    ...
                    og0Var.i();
                    AndroidUtilities.cancelRunOnUIThread(og0Var.h0);
                } else if (actionMasked == 2 && (photoViewer = og0Var.V) != null && (ct0Var = photoViewer.c4) != null && ct0Var.rewinding) {
                ...
                obtain2.recycle();
                boolean z10 = !og0Var.s.isInProgress() && og0Var.v.g0(motionEvent);
                if (actionMasked == 1 || actionMasked == 3 || actionMasked == 6) {
                    og0Var.w = false;
                    og0Var.x = false;
                    if (og0Var.d0) {
        ...
        switch (this.a) {
            case 0:
                ...
                if (og0Var.H != og0Var.t() * og0Var.J || og0Var.I != og0Var.r() * og0Var.J) {
                    ...
                    kVar.b = f7;
                    kVar.c = true;
                    kVar.u.i = a4.a.B(og0Var.t(), og0Var.J, 2.0f, f7) >= AndroidUtilities.displaySize.x / 2.0f ? (r3 - (og0Var.t() * og0Var.J)) - AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(16.0f);
                    og0Var.M.f();
                    o1.k kVar2 = og0Var.N;
                    kVar2.b = og0Var.L;
                    kVar2.c = true;
