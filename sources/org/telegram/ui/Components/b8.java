...
public abstract class b8 extends FrameLayout {
    ...
    public b8(Context context) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            addView(this.a[i10], w7.x5.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.a8
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i12) {
                    case 0:
                        b8 b8Var = this.b;
                        b8Var.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        b8Var.invalidate();
                        break;
                    default:
                        b8 b8Var2 = this.b;
                        b8Var2.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        b8Var2.invalidate();
                        break;
                }
            }
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.a8
            public final /* synthetic */ b8 b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i10) {
                    case 0:
                        b8 b8Var = this.b;
                        b8Var.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        b8Var.invalidate();
                        break;
                    default:
                        b8 b8Var2 = this.b;
                        b8Var2.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        b8Var2.invalidate();
                        break;
                }
            }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (this.s > 0) {
            ...
            while (true) {
                ...
                if ((textView instanceof r90) && ((r90) textView).d) {
                    this.s = -1;
                    break;
                }
                i11++;
    ...
    public void setCustomPaddingRight(int i10) {
        ...
        for (TextView textView : this.a) {
            if (textView instanceof r90) {
                ((r90) textView).setCustomPaddingRight(i10);
            }
        }
        invalidate();
    }
