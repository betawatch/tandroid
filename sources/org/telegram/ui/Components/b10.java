...
public final class b10 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (charSequence2 == null || charSequence2.length() == 0) {
            ...
            f14 = 2.0f;
            int dp = (int) (l01Var4.c + f11 + AndroidUtilities.dp(4.66f));
            int dp2 = (int) (measuredHeight - AndroidUtilities.dp(9.0f));
            f13 = measuredHeight;
            int d = (int) (j6Var.d() + l01Var4.c + f11 + AndroidUtilities.dp(f10));
            l01Var = l01Var4;
        ...
        if (l01Var3 != null) {
            canvas.save();
            canvas.translate(f19 + dp3, (f13 - (l01Var3.j() / f14)) + AndroidUtilities.dp(1.0f));
            l01Var3.d(canvas);
            canvas.restore();
            f19 += dp3 + l01Var3.c;
        }
        float f20 = f19;
        float dp4 = AndroidUtilities.dp(12.0f) + (l01Var.j() / f14) + f13;
