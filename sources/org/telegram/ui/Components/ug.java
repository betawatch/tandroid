...
public final class ug extends FrameLayout {
    ...
    public final void a() {
        bi.x4 x4Var = this.a;
        if (x4Var != null) {
            x4Var.l0 = new sg(this, x4Var, 1);
            x4Var.e(true);
            this.a = null;
        }
        bi.x4 x4Var2 = this.b;
        if (x4Var2 != null) {
            x4Var2.l0 = new sg(this, x4Var2, 2);
            x4Var2.e(true);
            this.b = null;
        }
    }
    ...
    public final void b() {
        ...
        bi.x4 x4Var2 = this.b;
        x4Var2.h = bi.x4.a(x4Var2.getText(), this.b.getTextPaint());
        ...
        addView(this.b, w7.a6.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
        bi.x4 x4Var4 = this.b;
        x4Var4.l0 = new sg(this, x4Var4, 0);
        x4Var4.u();
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:143:0x0351, code lost:
        ...
        r3 = org.telegram.ui.Components.wr.j;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x01ce, code lost:
        ...
        r46.restore();
        r46.save();
        r4.setBounds(r7 - (r4.getIntrinsicWidth() / 2), (int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14)), org.telegram.messenger.em.B(2, r7, r4), r4.getIntrinsicHeight() + ((int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14))));
        r4.draw(r46);
        r46.restore();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x0324, code lost:
        ...
        r5 = org.telegram.ui.Components.wr.j;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x03e8, code lost:
        ...
        r2 = org.telegram.messenger.a2.A(1.0f, r2, (1.0f - r10) * r8.h4, r5);
        r9 = r7;
        r6 = r30 + r26;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (chatActivityEnterView.r4) {
            ...
            f12 = com.google.android.gms.internal.vision.e2.a(1.0f, f19, f20 * 15.0f, (1.0f - f20) * (1.0f - dp3) * 9.0f);
            f13 = dp3;
        } else {
            f10 = 0.25f;
            f11 = 26.0f;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.T && rectF2.contains(x10, y3)) {
                ...
                mediaDataController.toggleDraftVoiceOnce(j3, (eoVar == null || !eoVar.h4) ? 0L : eoVar.d(), chatActivityEnterView.O);
                if (chatActivityEnterView.O) {
                    b();
                } else {
                    a();
    ...
    public void setBlurredBackgroundFactory(zg.a aVar) {
        this.Q = true;
        if (this.P == null) {
            this.P = new ch.b(org.telegram.ui.ActionBar.j6.ae, this.V.V3);
        }
