...
public final class bz0 {
    ...
    public bz0(org.telegram.ui.ActionBar.f6 f6Var) {
        this.a = f6Var;
    }
    ...
    public final void b(MessageObject messageObject) {
        ...
        Paint F = f6Var != null ? f6Var.F("paintChatActionText3") : null;
        if (F == null) {
            F = org.telegram.ui.ActionBar.j6.S0("paintChatActionText3");
        }
        ...
        if (aVar != null && !aVar.k()) {
            arrayList.add(new az0(new t01(LocaleController.getString(R.string.SuggestionOfferInfoPrice), textPaint), new t01(LocaleController.bold(of2.amount.f()), textPaint)));
        }
        if (suggestedPost.schedule_date > 0) {
            arrayList.add(new az0(new t01(LocaleController.getString(R.string.SuggestionOfferInfoTime), textPaint), new t01(LocaleController.bold(LocaleController.formatDateTime(suggestedPost.schedule_date, true)), textPaint)));
        }
        ...
        while (i11 < size) {
            ...
            i11++;
            az0 az0Var = (az0) obj;
            f10 = Math.max(f10, az0Var.a.l());
            f11 = Math.max(f11, az0Var.b.l());
            int j3 = ((int) az0Var.a.j()) + this.g;
            this.g = j3;
        ...
        int D = org.telegram.messenger.a2.D(24.0f, 2, Math.max(dp, i19));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
