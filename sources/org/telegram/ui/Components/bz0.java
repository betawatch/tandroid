...
public final class bz0 {
    ...
    public bz0(org.telegram.ui.ActionBar.e6 e6Var) {
        this.a = e6Var;
    }
    ...
    public final void b(MessageObject messageObject) {
        ...
        if (aVar != null && !aVar.k()) {
            arrayList.add(new az0(new v01(LocaleController.getString(R.string.SuggestionOfferInfoPrice), textPaint), new v01(LocaleController.bold(of2.amount.f()), textPaint)));
        }
        if (suggestedPost.schedule_date > 0) {
            arrayList.add(new az0(new v01(LocaleController.getString(R.string.SuggestionOfferInfoTime), textPaint), new v01(LocaleController.bold(LocaleController.formatDateTime(suggestedPost.schedule_date, true)), textPaint)));
        }
        ...
        int c11 = org.telegram.messenger.wh.c(24.0f, 2, Math.max(dp, i19));
        this.h = c11;
        this.d = (c11 - max) / 2;
        this.e = (c11 - dp) / 2;
