    ...
    public void onDraw(Canvas canvas) {
        ...
        if (viewType == 7) {
            while (i10 <= getMeasuredHeight()) {
                ...
                i10 = org.telegram.ui.Cells.pa.g(this, i10);
                int i14 = i12 + 1;
            ...
            while (i10 <= getMeasuredHeight()) {
                canvas2.drawCircle(a(AndroidUtilities.dp(10.0f) + r3), org.telegram.messenger.y1.C(10.0f, i10, r3), AndroidUtilities.dp(14.0f), paint3);
                canvas2.save();
            ...
            while (i16 <= getMeasuredHeight()) {
                canvas2.drawCircle(a(org.telegram.messenger.y1.C(9.0f, this.C, r1)), AndroidUtilities.dp(32.0f) + i16, AndroidUtilities.dp(25.0f), paint3);
                ...
                Paint paint4 = paint3;
                canvas3.drawLine(AndroidUtilities.dp(f12), org.telegram.ui.Cells.pa.g(this, i16), getMeasuredWidth(), org.telegram.ui.Cells.pa.g(this, i16), paint4);
                canvas2 = canvas3;
                i16 = org.telegram.ui.Cells.pa.g(this, i16);
                int i18 = i12 + 1;
            ...
            if (getViewType() == 19) {
                ...
                while (i19 <= getMeasuredHeight()) {
                    canvas2.drawCircle(a(org.telegram.messenger.y1.C(9.0f, this.C, r1)), AndroidUtilities.dp(29.0f) + i19, AndroidUtilities.dp(20.0f), paint5);
                    float f13 = 76;
                    ...
                    Paint paint6 = paint5;
                    canvas4.drawLine(AndroidUtilities.dp(f13), org.telegram.ui.Cells.pa.g(this, i19), getMeasuredWidth(), org.telegram.ui.Cells.pa.g(this, i19), paint6);
                    canvas2 = canvas4;
                    paint5 = paint6;
                    i19 = org.telegram.ui.Cells.pa.g(this, i19);
                    int i20 = i12 + 1;
                ...
                while (true) {
                    ...
                    Paint paint7 = paint5;
                    i23 = org.telegram.messenger.y1.C(2.0f, i22, i23);
                    i24++;
                    if (this.y && i24 >= 2) {
                        break;
                    }
                ...
                if (getViewType() == 3) {
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(AndroidUtilities.dp(12.0f) + r4), org.telegram.messenger.y1.C(6.0f, i10, r4), AndroidUtilities.dp(44.0f) >> 1, paint5);
                        rectF.set(AndroidUtilities.dp(68.0f), AndroidUtilities.dp(12.0f) + i10, AndroidUtilities.dp(140.0f), AndroidUtilities.dp(20.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                        rectF.set(AndroidUtilities.dp(68.0f), AndroidUtilities.dp(34.0f) + i10, AndroidUtilities.dp(260.0f), AndroidUtilities.dp(42.0f) + i10);
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.y1.C(9.0f, this.C, r4)), (AndroidUtilities.dp(64.0f) >> 1) + i10, AndroidUtilities.dp(23.0f), paint5);
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.y1.C(13.0f, this.C, r4)), (AndroidUtilities.dp(58.0f) >> 1) + i10, AndroidUtilities.dp(23.0f), paint5);
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.y1.C(11.0f, this.C, r4)), (AndroidUtilities.dp(64.0f) >> 1) + i10, AndroidUtilities.dp(23.0f), paint5);
                    ...
                    while (dp2 <= getMeasuredHeight()) {
                        ...
                        dp2 = org.telegram.ui.Cells.pa.g(this, dp2);
                        if (this.y) {
                            break;
                        }
                    }
                    ...
                    for (int i37 = 0; i37 < 3; i37++) {
                        canvas2.drawCircle(org.telegram.messenger.y1.D(12.0f, i37, AndroidUtilities.dp(13.0f) + (getMeasuredWidth() - AndroidUtilities.dp(56.0f))), measuredHeight2, AndroidUtilities.dp(13.0f), this.J);
                        canvas2.drawCircle(org.telegram.messenger.y1.D(12.0f, i37, AndroidUtilities.dp(13.0f) + (getMeasuredWidth() - AndroidUtilities.dp(56.0f))), measuredHeight2, AndroidUtilities.dp(12.0f), paint5);
                    }
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.y1.C(12.0f, this.C, dp15)), org.telegram.messenger.y1.C(8.0f, i10, dp15), dp15, paint5);
                    ...
                    int i40 = 0;
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.y1.C(8.0f, this.C, r6)), AndroidUtilities.dp(24.0f) + i10, AndroidUtilities.dp(18.0f), paint5);
                        ...
                        if (i40 < 4) {
                            canvas2.drawCircle(a(org.telegram.messenger.y1.B(12.0f, getWidth(), r6)), AndroidUtilities.dp(24.0f) + i10, AndroidUtilities.dp(12.0f), paint5);
                        }
                        i10 = org.telegram.ui.Cells.pa.g(this, i10);
                        i40++;
                    ...
                    if (i41 == 21) {
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            canvas2.drawCircle(a(AndroidUtilities.dp(20.0f) + r4), org.telegram.messenger.y1.C(6.0f, i10, r4), AndroidUtilities.dp(48.0f) >> 1, paint5);
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            canvas2.drawCircle(AndroidUtilities.dp(17.0f) + r4, org.telegram.messenger.y1.C(6.0f, i10, r4), AndroidUtilities.dp(38.0f) >> 1, paint5);
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            canvas2.drawCircle(LocaleController.isRTL ? org.telegram.messenger.y1.B(21.0f, getMeasuredWidth(), r4) : AndroidUtilities.dp(21.0f) + r4, org.telegram.messenger.y1.C(16.0f, i10, r4), AndroidUtilities.dp(21.0f) >> 1, paint5);
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            canvas2.drawCircle(a(org.telegram.messenger.y1.C(10.0f, this.C, r4)), (AndroidUtilities.dp(58.0f) >> 1) + i10, AndroidUtilities.dp(24.0f), paint5);
                            rectF.set(AndroidUtilities.dp(68.0f) + this.C, AndroidUtilities.dp(17.0f) + i10, AndroidUtilities.dp(260.0f) + this.C, AndroidUtilities.dp(25.0f) + i10);
                            b(rectF);
                            canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                            rectF.set(AndroidUtilities.dp(68.0f) + this.C, AndroidUtilities.dp(39.0f) + i10, AndroidUtilities.dp(140.0f) + this.C, AndroidUtilities.dp(47.0f) + i10);
    ...
    public void setViewType(int i10) {
        ...
        if (i10 == 11) {
            ...
            for (int i11 = 0; i11 < 2; i11++) {
                this.I[i11] = org.telegram.ui.Cells.pa.f(random, MediaDataController.MAX_STYLE_RUNS_COUNT) / 1000.0f;
            }
        }
        invalidate();
    }
