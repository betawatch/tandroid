        ...
        if (f20 < 0.99f && (fArr = this.G) != null) {
            ...
            if (i18 >= 0 && i18 < fArr.length) {
                ...
                while (i11 < arrayList.size()) {
                    ...
                    float f24 = min2;
                    float f25 = mo0Var.f - (f24 / mo0Var.g);
                    mo0Var.f = f25;
                    if (f25 < 0.0f) {
                        ...
                        float f27 = mo0Var.d;
                        float f28 = mo0Var.c;
                        mo0Var.a = (((f27 * f28) * f24) / 500.0f) + f26;
                        float f29 = mo0Var.b;
                        float f30 = mo0Var.e;
                        mo0Var.b = (((f28 * f30) * f24) / 500.0f) + f29;
                        mo0Var.e = f30 - ((AndroidUtilities.dp(0.33f) * min2) / 500.0f);
                    }
                    i11++;
                }
                if (((RectF) g0Var.g) != null) {
                    ...
                    for (int i19 = 0; i19 < min3; i19++) {
                        mo0 mo0Var2 = arrayList2.isEmpty() ? new mo0() : (mo0) arrayList2.remove(0);
                        RectF rectF2 = (RectF) g0Var.g;
                        mo0Var2.a = (Utilities.random.nextFloat() * rectF2.width()) + rectF2.left;
                        RectF rectF3 = (RectF) g0Var.g;
                        mo0Var2.b = (Utilities.random.nextFloat() * rectF3.height()) + rectF3.top;
                        double nextInt = (Utilities.random.nextInt(200) - 125) * 0.017453292519943295d;
                        mo0Var2.d = ((float) (Math.cos(nextInt) - Math.sin(nextInt))) * 0.8f;
                        mo0Var2.e = ((float) (Math.cos(nextInt) + Math.sin(nextInt))) - 0.2f;
                        mo0Var2.f = 1.0f;
                        mo0Var2.c = AndroidUtilities.dp((Utilities.random.nextFloat() * 7.0f) + 10.0f);
                        mo0Var2.g = AndroidUtilities.lerp(420, 550, Utilities.random.nextFloat());
                        arrayList.add(mo0Var2);
                    }
                }
                for (i12 = 0; i12 < arrayList.size(); i12++) {
                    mo0 mo0Var3 = (mo0) arrayList.get(i12);
                    paint.setAlpha((int) (255.0f * f23 * mo0Var3.f));
                    canvas.drawPoint(mo0Var3.a, mo0Var3.b, paint);
                }
                ec0Var = (ec0) g0Var.c;
                if (ec0Var == null) {
                    ec0Var.run();
