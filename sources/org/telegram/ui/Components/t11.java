...
public final class t11 {
    ...
    public Runnable r;
    public long s;
    public final e9 f = new e9((org.telegram.ui.ActionBar.c6) null);
    ...
    public final void c(Canvas canvas, int i10, float f9, float f10, float f11, float f12, boolean z10) {
        ...
        zz0Var.p = i10 - AndroidUtilities.dp(144.66f);
        ...
        if (this.e != null) {
            if (this.p.contains(motionEvent.getX(), motionEvent.getY() - (z10 ? this.b.getPaddingTop() : 0))) {
                ...
                if (action != 0) {
                    ...
                    if (ucVar.h && (runnable = this.r) != null) {
                        runnable.run();
                    }
                    ucVar.c(false);
    ...
    public final boolean f(MessageObject messageObject) {
        ...
        if (messageObject == null) {
            ...
            if (isMonoForum) {
                ...
                this.e = new zz0(DialogObject.getName(userOrChat), 14.0f, AndroidUtilities.bold());
            } else {
                ...
                if (topicId == 1) {
                    imageReceiver.setImageBitmap(yf.d.c(view.getContext(), 0.75f, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.v8, this.c), false));
                ...
                this.e = new zz0(findTopic.title, 14.0f, AndroidUtilities.bold());
            }
        }
        return this.e != null;
    }
