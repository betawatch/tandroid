...
public final class da {
    ...
    public final void b(Canvas canvas, boolean z10) {
        ...
        if (!isHardwareAccelerated) {
            canvas.drawColor(num != null ? num.intValue() : z9Var.i);
            return;
        }
        RenderNode renderNode = (RenderNode) z9Var.l;
        if (!renderNode.hasDisplayList()) {
            RenderNode renderNode2 = (RenderNode) z9Var.k;
            renderNode.setPosition(0, 0, renderNode2.getWidth(), renderNode2.getHeight());
            RecordingCanvas beginRecording = renderNode.beginRecording();
            beginRecording.drawColor(num != null ? num.intValue() : z9Var.i);
    ...
    public final Paint[] d() {
        ...
        if (c10 != null && z10) {
            c10.setAlpha((int) org.telegram.messenger.y1.z(1.0f, this.f, 255.0f, 1.0f));
        }
        if (paint != null) {
    ...
    public final void f(int i10, int i11, boolean z10) {
        ...
        matrix.reset();
        z9 z9Var = this.a;
        View view2 = z9Var != null ? z10 ? z9Var.j : z9Var.b : null;
        if (z9Var != null) {
