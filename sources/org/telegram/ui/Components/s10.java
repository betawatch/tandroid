    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!z10) {
            ...
            if (this.a != null) {
                ...
                this.a.addListener(new r10(this, 0));
                this.f = NotificationCenter.getInstance(t10Var.a).setAnimationInProgress(this.f, null);
                this.a.start();
                this.b = true;
            } else {
                this.h = dp5;
        ...
        int i15 = this.n;
        t10Var.e = i15 > 0 ? AndroidUtilities.dp(40.0f) + i15 : 0;
