...
public class rk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public rk0(int i10, int i11, Context context, org.telegram.ui.ActionBar.p2 p2Var, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        this.a = false;
        ...
        this.T = crVar;
        d1Var.i(new dk0(this, 0));
        d1Var.setLayoutManager(crVar);
        d1Var.setOverScrollMode(2);
        hk0 hk0Var = new hk0(this);
        this.U = hk0Var;
        d1Var.setAdapter(hk0Var);
        d1Var.j(new lk0(this));
        d1Var.j(new nb0(this, 2));
        d1Var.i(new dk0(this, 1));
        d1Var.setOnItemClickListener(new k(this, 11));
        d1Var.setOnItemLongClickListener((ll0) new hg.m2(this, i10, 8));
    ...
    public static void a(rk0 rk0Var) {
        ...
        ng.d0 d0Var = new ng.d0(rk0Var.J0, rk0Var.q0, rk0Var.S, rk0Var.a0, rk0Var, rk0Var.h0, rk0Var.a);
        rk0Var.u0 = d0Var;
        og.a aVar = rk0Var.W0;
        boolean z4 = true;
        if (aVar != null) {
            rg.d dVar = rk0Var.X0;
            org.telegram.ui.i51 i51Var = d0Var.m.c0;
            i51Var.x = true;
            i51Var.setBackground(null);
            i51Var.e();
            i51Var.invalidate();
        ...
        ng.d0 d0Var2 = rk0Var.u0;
        qk0 qk0Var = rk0Var.d0;
        if (qk0Var != null && !qk0Var.g()) {
            z4 = false;
        }
        d0Var2.m.setLongPressEnabled(z4);
        rk0Var.j();
        rk0Var.u0.p = new ec0(rk0Var, 16);
        rk0Var.m();
    }

    public static void b(rk0 rk0Var, View view, float f10) {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (z4) {
            ...
            if (f24 != 1.0f) {
                ...
                q0Var = this.i0;
                i10 = this.J0;
                if (q0Var != null && i10 != 5 && ((qk0Var = this.d0) == null || qk0Var.g())) {
                    f23 = this.k0;
                    if (f23 != 1.0f) {
                ...
                if (this.v != 0.0f) {
                    ...
                    if (getAlpha() == 1.0f || i18 == 5) {
                        ...
                        while (i19 < d1Var3.getChildCount()) {
                            ...
                            float f35 = f26;
                            if (childAt instanceof pk0) {
                                pk0 pk0Var = (pk0) d1Var3.getChildAt(i19);
                                i14 = i19;
                                if (this.y0 != 0.0f) {
                                    i13 = save3;
                                    f20 = AndroidUtilities.dp(46.0f) * Utilities.clamp(pk0Var.getLeft() / (getMeasuredWidth() - AndroidUtilities.dp(34.0f)), 1.0f, 0.0f) * getPullingLeftProgress();
                                } else {
                                    i13 = save3;
                                    f20 = 0.0f;
                                }
                                ...
                                ok0 ok0Var3 = pk0Var.c;
                                rectF4 = rectF;
                                if (q0Var3.equals(this.i0)) {
                                    ok0 ok0Var4 = ok0Var2.getVisibility() == 0 ? ok0Var2 : ok0Var;
                                    pk0Var.setPivotX(pk0Var.getMeasuredWidth() >> 1);
                                    pk0Var.setPivotY(ok0Var4.getY() + ok0Var4.getMeasuredHeight());
                                    pk0Var.setScaleX(this.m0);
                                    pk0Var.setScaleY(this.m0);
                                    if (!this.o0) {
                                        if (this.N == null) {
                                            ok0Var3.setVisibility(0);
                                            ok0Var3.setAlpha(1.0f);
                                            if (ok0Var3.getImageReceiver().hasBitmapImage() || ((l5Var = ok0Var3.e) != null && (z2Var = l5Var.k) != null && z2Var.hasBitmapImage())) {
                                                ok0Var4.setAlpha(0.0f);
                                            }
                                            f22 = 1.0f;
                                        } else {
                                            f22 = 1.0f;
                                            ok0Var3.setAlpha(1.0f - this.l0);
                                            ok0Var4.setAlpha(this.l0);
                                        }
                                        if (this.k0 == f22) {
                                            this.o0 = true;
                                            if (System.currentTimeMillis() - this.p0 > 300) {
                                                ...
                                                d1Var2 = d1Var3;
                                                this.d0.o(pk0Var, pk0Var.e, true, false);
                                                canvas2.save();
                                                x10 = pk0Var.getX() + d1Var2.getX();
                                                scaleX = ((pk0Var.getScaleX() * pk0Var.getMeasuredWidth()) - pk0Var.getMeasuredWidth()) / f15;
                                                f21 = x10 - scaleX;
                                                if (f21 >= 0.0f && pk0Var.getTranslationX() >= 0.0f) {
                                                    pk0Var.setTranslationX((-f21) - f36);
                                                } else if (pk0Var.getMeasuredWidth() + x10 + scaleX > getMeasuredWidth() || pk0Var.getTranslationX() > 0.0f) {
                                                    pk0Var.setTranslationX(0.0f - f36);
                                                } else {
                                                    pk0Var.setTranslationX((((getMeasuredWidth() - x10) - pk0Var.getMeasuredWidth()) - scaleX) - f36);
                                                }
                                                canvas2.translate(pk0Var.getX() + d1Var2.getX(), pk0Var.getY() + d1Var2.getY());
                                                canvas2.scale(pk0Var.getScaleX(), pk0Var.getScaleY(), pk0Var.getPivotX(), pk0Var.getPivotY());
                                                pk0Var.draw(canvas2);
                                                canvas2.restore();
                                            }
                                        }
                                    ...
                                    if (pk0Var.getMeasuredWidth() + x10 + scaleX > getMeasuredWidth()) {
                                    }
                                    pk0Var.setTranslationX(0.0f - f36);
                                    canvas2.translate(pk0Var.getX() + d1Var2.getX(), pk0Var.getY() + d1Var2.getY());
                                    canvas2.scale(pk0Var.getScaleX(), pk0Var.getScaleY(), pk0Var.getPivotX(), pk0Var.getPivotY());
                                    ...
                                    d1Var2 = d1Var3;
                                    int R2 = RecyclerView.R(pk0Var);
                                    float measuredWidth = (((this.m0 - 1.0f) * pk0Var.getMeasuredWidth()) / 3.0f) - (((1.0f - this.n0) * pk0Var.getMeasuredWidth()) * (Math.abs(this.j0 - R2) - 1));
                                    if (R2 < this.j0) {
                                        pk0Var.setPivotX(0.0f);
                                        pk0Var.setTranslationX(-measuredWidth);
                                    } else {
                                        pk0Var.setPivotX(pk0Var.getMeasuredWidth() - f36);
                                        pk0Var.setTranslationX(measuredWidth - f36);
                                    }
                                    pk0Var.setPivotY(ok0Var.getY() + ok0Var.getMeasuredHeight());
                                    pk0Var.setScaleX(this.n0);
                                    pk0Var.setScaleY(this.n0);
                                    ok0Var3.setVisibility(4);
                                    ok0Var.setAlpha(1.0f);
                                }
                                if (childAt.getLeft() > i20) {
                                    i20 = childAt.getLeft();
                                }
                                if (!this.K0 && (!pk0Var.r || ok0Var.getImageReceiver().getLottieAnimation() != null)) {
                                    if ((pk0Var.getMeasuredWidth() / f15) + pk0Var.getX() > 0.0f && (pk0Var.getMeasuredWidth() / f15) + pk0Var.getX() < d1Var2.getWidth()) {
                                        if (!hashSet.contains(pk0Var)) {
                                            pk0Var.c(abs);
                                            abs += 30;
                                        }
                                        hashSet2.add(pk0Var);
                                            ...
                                            if ((childAt.getMeasuredWidth() / f15) + childAt.getX() <= f18 || (childAt.getMeasuredWidth() / f15) + childAt.getX() >= d1Var2.getWidth()) {
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    ...
                                                    if (z10) {
                                                        ...
                                                        ((ValueAnimator) rrVar3.b).setStartDelay((long) (abs * ((rk0) rrVar3.c).c));
                        ...
                        if (pullingLeftProgress > 0.0f) {
                            ...
                            int measuredWidth3 = pk0Var2.getMeasuredWidth() - AndroidUtilities.dp(f15);
                            float f37 = i20 + measuredWidth3;
                            float clamp2 = Utilities.clamp(f37 / (getMeasuredWidth() - pk0Var2.getMeasuredWidth()), 1.0f, 0.0f) * pullingLeftProgress2 * measuredWidth3;
                            if (pk0Var2.getTag() == null) {
                                pk0Var2.setTag(Float.valueOf(1.0f));
                                pk0Var2.d();
                                pk0Var2.c(0);
                            }
                            float clamp3 = Utilities.clamp(pullingLeftProgress2, 1.0f, 0.0f);
                            pk0Var2.setScaleX(clamp3);
                            pk0Var2.setScaleY(clamp3);
                            pk0Var2.setTranslationX(((d1Var.getX() + f37) - clamp2) + (-((i18 == 1 || i18 == 2) ? AndroidUtilities.dp(8.0f) : AndroidUtilities.dp(20.0f))));
                            if (pk0Var2.getVisibility() != 0) {
                                pk0Var2.setVisibility(0);
                            }
                        } else {
                            if (pk0Var2.getVisibility() != 8 && this.L0) {
    ...
    public final void n() {
        ...
        mh.d1 d1Var = this.b;
        AndroidUtilities.forEachViews((RecyclerView) d1Var, (h5.d) ck0Var);
        this.z0.clear();
        d1Var.invalidate();
        ag.l lVar = this.P;
        if (lVar != null) {
    ...
    public final void p(MessageObject messageObject, TLRPC.ChatFull chatFull, boolean z4) {
        ...
        if (q()) {
            ...
            if (i16 < arrayList2.size()) {
                pk0.a(this.w0, (ng.q0) arrayList2.get(i16), -1);
            }
        } else {
        ...
        for (int i18 = 0; i18 < arrayList8.size(); i18++) {
            ...
            arrayList9.add(new ik0(q0Var3.f == null ? 3 : 0, q0Var3));
        }
        if (!rk0Var.R.isEmpty() && !MessagesController.getInstance(rk0Var.G).premiumFeaturesBlocked()) {
    ...
    public final void r(boolean z4) {
        ...
        duration.addListener(new ek0(this, 0));
        duration.start();
    }
    ...
    public void setAlpha(float f10) {
        if (getAlpha() != f10 && f10 == 0.0f) {
            ...
            while (true) {
                ...
                if (d1Var.getChildAt(i10) instanceof pk0) {
                    ((pk0) d1Var.getChildAt(i10)).d();
                }
                i10++;
            }
        }
    ...
    public void setSelectedEmojis(ArrayList<String> arrayList) {
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.b, (h5.d) new ck0(this, 0));
    }
        ...
        if (this.Z0 != z4) {
            ...
            if (!z4) {
                ...
                while (true) {
                    ...
                    if (d1Var.getChildAt(i10) instanceof pk0) {
                        pk0 pk0Var = (pk0) d1Var.getChildAt(i10);
                        boolean z10 = pk0Var.r;
                        ok0 ok0Var = pk0Var.b;
                        if (z10 && (ok0Var.getImageReceiver().getLottieAnimation() != null || ok0Var.getImageReceiver().getAnimation() != null)) {
                            ok0Var.setVisibility(0);
                            pk0Var.a.setVisibility(4);
                            if (pk0Var.s) {
                                pk0Var.v = true;
                            }
                        }
