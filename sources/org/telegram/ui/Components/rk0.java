        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z12) {
                ...
                if (j71Var != null) {
                    ...
                    this.S = clamp;
                    j71Var.L((long) (clamp * this.n.p()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.Q) {
                ...
                j71 j71Var2 = this.n;
                if (j71Var2 != null) {
                    j71Var2.L((long) (this.s * j71Var2.p()), false);
                }
                setPlaying(true);
            } else if (this.P && this.w) {
                j71 j71Var3 = this.n;
                if (j71Var3 != null) {
                    j71Var3.L(Math.max((long) (this.s * j71Var3.p()), ((long) (this.v * this.n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.R && !b()) {
                setPlaying(true);
