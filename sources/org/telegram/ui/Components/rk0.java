        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z13) {
                ...
                if (s71Var != null) {
                    ...
                    this.V = clamp;
                    s71Var.L((long) (clamp * this.n.p()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.T) {
                ...
                s71 s71Var2 = this.n;
                if (s71Var2 != null) {
                    s71Var2.L((long) (this.s * s71Var2.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.w) {
                s71 s71Var3 = this.n;
                if (s71Var3 != null) {
                    s71Var3.L(Math.max((long) (this.s * s71Var3.p()), ((long) (this.v * this.n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
