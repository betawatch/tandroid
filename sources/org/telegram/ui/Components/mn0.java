...
public class mn0 {
    ...
    public final void b(Canvas canvas) {
        ...
        if (this.r != dp) {
            ...
            float f13 = this.r;
            if (f13 < dp) {
                float c10 = s3.c.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f13);
                this.r = c10;
                if (c10 > dp) {
                    this.r = dp;
                }
            } else {
                float c11 = org.telegram.messenger.rl.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f13);
                this.r = c11;
                if (c11 < dp) {
                    this.r = dp;
                }
        ...
        if (size != this.y) {
            ...
            if (size >= 0 && size < this.u.size()) {
                e((r41) ((Pair) this.u.get(this.y)).second);
            }
        }
        if (this.B < 1.0f) {
    ...
    */
    public final void c(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = E;
        float f12 = i11 / 2.0f;
        float f13 = mn0Var.f - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp = AndroidUtilities.dp(mn0Var.x * 1.0f) / 2.0f;
        if (G == null) {
            G = new Path();
        }
        G.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= mn0Var.u.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) mn0Var.u.get(i12)).first).floatValue() >= dp2) {
                break;
            } else {
                i12++;
            }
        ...
        int size = mn0Var.u.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) mn0Var.u.get(size)).first).floatValue() >= dp2) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) mn0Var.u.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) mn0Var.u.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= mn0Var.u.size() - 1 || ((Float) ((Pair) mn0Var.u.get(i13)).first).floatValue() - floatValue > dp2) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) mn0Var.u.get(i13)).first).floatValue();
            }
            c11 = 1;
            ...
            for (r41 r41Var : r41VarArr) {
                try {
                    if (r41Var != null && r41Var.getURL() != null && r41Var.d != null && r41Var.getURL().startsWith("audio?") && (parseInt = Utilities.parseInt((CharSequence) r41Var.getURL().substring(6))) != null && parseInt.intValue() >= 0) {
                        ...
                        this.u.add(new Pair(Float.valueOf((parseInt.intValue() * 1000) / valueOf.longValue()), r41Var));
                    }
                } catch (Exception e9) {
                    FileLog.e(e9);
                }
            }
            Collections.sort(this.u, new k9.a(28));
        } catch (Exception e10) {
            FileLog.e(e10);
            this.u = null;
            this.y = -1;
