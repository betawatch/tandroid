...
public final class qu extends View {
    ...
    public qu(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.v = new RectF();
        nr nrVar = nr.h;
        this.w = new z5(this, 125L, nrVar);
        this.x = new z5(this, 125L, nrVar);
        this.C = -1;
        this.D = true;
        this.y = f6Var;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable = quVar.c;
        boolean z4 = false;
        drawable.setBounds(0, 0, measuredWidth, measuredHeight);
        drawable.draw(canvas);
        int dp = quVar.h - AndroidUtilities.dp(9.0f);
        int measuredHeight2 = quVar.getMeasuredHeight() - AndroidUtilities.dp(6.34f);
        int dp2 = AndroidUtilities.dp(9.0f) + quVar.h;
        ...
        if (quVar.e != null) {
            boolean z10 = quVar.f;
            org.telegram.ui.ActionBar.f6 f6Var = quVar.y;
            int[] iArr = quVar.n;
            z5 z5Var = quVar.w;
            Paint paint = quVar.s;
            Drawable[] drawableArr = quVar.b;
            RectF rectF = quVar.v;
            float f10 = 1.0f;
            int i10 = quVar.a;
            if (!z10) {
            ...
            int i12 = 0;
            while (i12 < 2) {
                float d10 = (i12 == 0 ? z5Var : quVar.x).d(iArr[i12], z4);
                float max = Math.max(0.0f, Math.min(f10, -d10));
                rectF.set((int) ((i10 * (d10 + f10)) + AndroidUtilities.dp((r6 * 4.0f) + (Math.max(0.0f, Math.min(f10, r6)) * 3.0f) + 5.0f)), AndroidUtilities.lerp(((AndroidUtilities.dp(f10) + i10) * i12) + AndroidUtilities.dp(3.0f), (quVar.getMeasuredHeight() - i10) / 2, max), r6 + i10, r9 + i10);
