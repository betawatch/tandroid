...
public class k21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public TextPaint E;
    ...
    public k21(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        StaticLayout d = ww0.d(b10, textPaint2, i11, true, i11, 3);
        this.F = d;
        return d;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.n != 1.0f && (j21Var2 = this.h) != null) {
            j21Var2.b(canvas, 1.0f);
        }
        float f7 = this.n;
        if (f7 != 0.0f) {
            this.f.b(canvas, f7);
        }
        if (this.n != 1.0f && (j21Var = this.h) != null) {
            j21Var.a(canvas, 1.0f);
        }
        float f10 = this.n;
        if (f10 != 0.0f) {
            this.f.a(canvas, f10);
    ...
    public final void f(lp lpVar, long j3, boolean z10) {
        ...
        if (z11 || z12) {
            ...
            if (lpVar2 == null || (d4Var = lpVar2.a) == null) {
                ...
                Paint paint = j21Var.c;
                Paint paint2 = j21Var.a;
                Paint paint3 = j21Var.b;
                paint.setColor(i16);
                ...
                if (aVar != null) {
                    ...
                    if (c4Var2.a() != 0) {
                        ...
                        if (this.G != null) {
                            ...
                            if (i11 != 0) {
                                nc0Var = new nc0(true, i10, i11, i12, i13);
                                this.L = nc0Var.f();
                            } else {
                                nc0 nc0Var3 = new nc0(true, i10, i10, i10, i10);
                                this.L = -16777216;
                                nc0Var = nc0Var3;
                            }
                            this.G.b = nc0Var;
                ...
                if (this.G != null) {
                    ...
                    if (c4Var3.a.k(false) != null) {
                        if (i23 != 0) {
                            nc0 nc0Var4 = new nc0(i22, i23, i24, i25, true, i26, false);
                            this.L = nc0Var4.f();
                            drawable = nc0Var4;
                        } else {
                            Drawable nc0Var5 = new nc0(i22, i22, i22, i22, true, i26, false);
                            this.L = -16777216;
                            drawable = nc0Var5;
                        }
                    } else if (i22 != 0 && i23 != 0) {
                        drawable = new nc0(i22, i23, i24, i25, true, i26, false);
                    } else if (i22 != 0) {
                        ...
                        if (i6Var == null || (i6Var.P <= 0 && i6Var.c == null)) {
                            ...
                            if (d4Var3 == null || !d4Var3.m()) {
                                drawable = new nc0(true, -2368069, -9722489, -2762611, -7817084);
                            }
                            drawable = null;
                        } else {
