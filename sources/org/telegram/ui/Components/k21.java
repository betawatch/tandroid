...
public final class k21 extends g61 {
    ...
    public k21(w21 w21Var, Context context, int i10, j21 j21Var, e21 e21Var, e21 e21Var2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        nr nrVar = nr.h;
        this.d3 = new z5(this, 320L, nrVar);
        this.e3 = new z5(this, 320L, nrVar);
        this.f3 = new RectF();
        this.g3 = new Paint(1);
        this.h3 = new z5(this, 420L, nrVar);
        this.k3 = new Paint(1);
    }
    ...
    @Override // org.telegram.ui.Components.g61, org.telegram.ui.Components.sl0, android.view.ViewGroup, android.view.View
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f14 > width) {
            ...
            this.i3.setBounds((int) (AndroidUtilities.dp(-17.0f) + f14), (int) (rectF.top + AndroidUtilities.dp(10.0f)), (int) (f14 + AndroidUtilities.dp(-7.0f)), (int) (rectF.top + AndroidUtilities.dp(20.0f)));
