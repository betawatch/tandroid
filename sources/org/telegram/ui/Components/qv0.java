...
public class qv0 extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    ...
    public final void I() {
        ...
        if (this.v == null) {
            ...
            this.v = m81Var2;
            m81Var2.n = new lv(this, 21);
            if (getMeasuredWidth() != 0 && getMeasuredHeight() != 0) {
                m81 m81Var3 = this.v;
                int measuredWidth = getMeasuredWidth();
                int measuredHeight = getMeasuredHeight();
                m81Var3.getClass();
                this.y = m81.a(measuredWidth, measuredHeight);
            }
        }
        if (this.F) {
            return;
    ...
    */
    ...
    public void S() {
        if (this.v != null) {
            this.y = m81.a(getMeasuredWidth(), getMeasuredHeight());
        }
        ...
        post(new tr0(1, this, point.x > point.y));
    }
    ...
    public final void W() {
        ...
        mv0 mv0Var = arrayList.size() > 0 ? (mv0) hg.k0.z(1, arrayList) : null;
        if (mv0Var == null) {
            mv0Var = new mv0();
        ...
        float width = mv0Var.c.getWidth() / f10;
        float height = (mv0Var.c.getHeight() - 34) / f7;
        int save = mv0Var.b.save();
        mv0Var.a = getScrollOffset() % 24;
        float f11 = 10.0f * height;
        mv0Var.b.clipRect(1.0f, f11, mv0Var.c.getWidth(), mv0Var.c.getHeight() - 1);
        mv0Var.b.scale(width, height);
        mv0Var.b.translate(0.0f, f11 + mv0Var.a);
        mv0Var.d = 1.0f / width;
