...
public final class gi0 extends View {
    ...
    public gi0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        ...
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.s8, e6Var);
            bgColor2 = bgColor1;
        } else {
        ...
        if (peerColor == null) {
            this.G = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.d6, e6Var);
            this.H = true;
        } else {
    ...
    public void setMusicDocument(TLRPC.Document document) {
        ...
        if (TextUtils.isEmpty(str)) {
            if (TextUtils.isEmpty(str2)) {
                ...
                str2 = org.telegram.messenger.q.h(R.string.AudioUnknownTitle, new StringBuilder(" - "));
            } else {
                str = "";
            }
