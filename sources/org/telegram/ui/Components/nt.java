...
public abstract class nt extends EditText {
    ...
    public static void a(nt ntVar) {
        ...
        ntVar.spoilers.get(0).q = new mt(ntVar, 3);
        float sqrt = (float) Math.sqrt(Math.pow(ntVar.getHeight(), 2.0d) + Math.pow(ntVar.getWidth(), 2.0d));
        Iterator<eh.k> it = ntVar.spoilers.iterator();
        while (it.hasNext()) {
            it.next().j(ntVar.lastRippleX, ntVar.lastRippleY, sqrt, true);
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (arrayList == null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                di0 di0Var2 = di0Var;
                zh0 zh0Var = di0Var2.e.F;
                boolean z12 = di0Var2.b() && di0Var2.g.contains(motionEvent.getX(), motionEvent.getY() - ((float) paddingTop));
