...
public class ll0 extends RecyclerView implements bh.a {
    ...
    public boolean L1;
    public float L2;
    public org.telegram.ui.Cells.ia M1;
    public float[] M2;
    public View N1;
    public float[] N2;
    public int O1;
    ...
    public q0.a o2;
    public ArrayList p1;
    public final org.telegram.ui.ActionBar.e6 p2;
    public ArrayList q1;
    public boolean q2;
    public View r1;
    public final ne r2;
    ...
    public static void O0(Canvas canvas, RectF rectF, float f7, float f10, float f11, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        Paint paint2 = U2;
        if (z10) {
            paint2.setShadowLayer(AndroidUtilities.dpf2(0.33f), 0.0f, 0.0f, org.telegram.ui.ActionBar.i6.l1(f11, 201326592));
            paint2.setColor(0);
            paint.setShadowLayer(AndroidUtilities.dpf2(2.0f), 0.0f, AndroidUtilities.dpf2(0.33f), org.telegram.ui.ActionBar.i6.l1(f11, 167772160));
        } else {
            paint.setShadowLayer(0.0f, 0.0f, 0.0f, 0);
        }
        paint.setColor(org.telegram.ui.ActionBar.i6.l1(f11, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.d6, e6Var)));
        if (f7 == f10) {
    ...
    public final void K0(boolean z10) {
        ...
        if (!z10) {
            ...
            if (i10 == 0) {
                ...
                alpha.setDuration(150L).setListener(new jd0(this, 7)).start();
            }
        }
        if (this.A1) {
            int i11 = S0 ? 4 : 0;
    ...
    public final void M0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            int[] iArr2 = this.m2;
            org.telegram.ui.bo boVar = qiVar.d;
            iArr2[0] = (int) boVar.s9;
            iArr2[1] = boVar.Aa;
            ...
            if (rectF.contains(min2, min)) {
                ...
                if (i11 != S) {
                    ...
                    org.telegram.ui.bo boVar2 = this.h2.d;
                    org.telegram.ui.nm nmVar = boVar2.A0;
                    ArrayList arrayList = boVar2.u6;
                    int i13 = S - nmVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) boVar2.x6.f(messageObject.getGroupId())) != null) {
                            ArrayList<MessageObject> arrayList2 = groupedMessages.messages;
                            S = arrayList.indexOf(arrayList2.get(z10 ? 0 : arrayList2.size() - 1)) + boVar2.A0.J;
                        }
                    }
                    if (z10) {
                        int i14 = this.g2;
    ...
    public final void N0(Canvas canvas, View view) {
        ...
        if (R == -1) {
            ...
            View U0 = U0(R - 1);
            View U02 = U0(R + 1);
            z10 = U0 != null && ((Boolean) this.H2.a.run(U0)).booleanValue();
            z11 = U02 != null && ((Boolean) this.H2.a.run(U02)).booleanValue();
        }
        RectF rectF = AndroidUtilities.rectTmp;
    ...
    public final void P0(Canvas canvas, View view, View view2, boolean z10, boolean z11) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(view.getLeft(), Math.max(-this.L2, t1(view) - (z10 ? this.L2 : 0.0f)), view.getRight(), Math.min(getHeight() - (-this.L2), (G0(view2) + (z11 ? this.L2 : 0.0f)) - bottomInfoMargin));
    ...
    */
    public final void Q0(Canvas canvas) {
        ...
        if (m0Var == null || !m0Var.k()) {
            ...
            for (int i13 = 0; i13 < getChildCount(); i13++) {
                ...
                if (childAt == this.c1 || childAt.getVisibility() != 0 || childAt.getAlpha() <= 0.0f || !((Boolean) this.H2.a.run(childAt)).booleanValue() || g1(RecyclerView.R(childAt))) {
    ...
    public final Drawable V0(View view, boolean z10) {
        boolean z11;
        boolean z12;
        if (view.getParent() != this || !b1() || !((Boolean) this.H2.a.run(view)).booleanValue()) {
            return null;
        }
        int R = RecyclerView.R(view);
        if (R == -1) {
            ...
            View U0 = U0(R - 1);
            View U02 = U0(R + 1);
            z11 = U0 != null && ((Boolean) this.H2.a.run(U0)).booleanValue();
            z12 = U02 != null && ((Boolean) this.H2.a.run(U02)).booleanValue();
        }
    ...
    public final void e1(wk0 wk0Var, int i10, boolean z10) {
        ...
        if (i10 > 0) {
            this.U1 = null;
            bc0 bc0Var2 = new bc0(this, 19);
            this.V1 = bc0Var2;
            AndroidUtilities.runOnUIThread(bc0Var2, i10);
        }
    }
    ...
    public final void l1(ll0 ll0Var, boolean z10) {
        ViewParent parent;
    ...
    public final void n1(cl0 cl0Var, long j3) {
        this.Y0 = cl0Var;
        org.telegram.ui.Cells.ia iaVar = this.M1;
        boolean z10 = cl0Var != null;
        k20 k20Var = (k20) iaVar.b;
        k20Var.t = z10;
        k20Var.u = j3;
    }
    ...
    public void q1(int i10, float f7, boolean z10) {
        r1(new ei.c(5), i10, f7, new lv(this, 15), z10);
    }
    ...
    public ll0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        setGlowColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.s8, e6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.i6, e6Var), 2, -1);
        this.D1 = f02;
        ...
        super.setOnScrollListener(new kb0(this, 3));
