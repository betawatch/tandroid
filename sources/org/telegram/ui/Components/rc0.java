...
public final class rc0 extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r6v2, types: [android.view.View, android.widget.EditText, android.widget.TextView, org.telegram.ui.Components.EditTextBoldCursor, org.telegram.ui.Components.nt, zf.b] */
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (b10 == 0) {
                ...
                if ((2 & mediaEntity.subType) != 0) {
                    n9Var2.setScaleX(-1.0f);
                }
                mediaEntity.view = n9Var2;
                n9Var = n9Var2;
            } else if (b10 == 1) {
                ?? qc0Var = new qc0(getContext());
                ...
                qc0Var.setImeOptions(TLObject.FLAG_28);
            ...
            if (n9Var != null) {
                addView(n9Var);
                n9Var.setRotation((float) (((-mediaEntity.rotation) / 3.141592653589793d) * 180.0d));
                this.b.put(n9Var, mediaEntity);
            }
        }
    }
