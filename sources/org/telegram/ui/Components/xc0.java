...
public class xc0 extends LinearLayout {
    public static final mr s0 = new mr(0.0f, 0.5f, 0.5f, 1.0f);
    public int B;
    public boolean C;
    public int D;
    public int E;
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.B) {
            ...
            if (strArr != null) {
                ...
                tc0 tc0Var = this.H;
                str = tc0Var != null ? tc0Var.e(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.D;
                    tc0 tc0Var = this.H;
                    str = tc0Var != null ? tc0Var.e(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z4) {
        ...
        f();
        invalidate();
        if (this.h0 != 0 || (uc0Var = this.G) == null) {
            return;
        }
        uc0Var.k(0);
    }
