...
public final class xm implements ky {
    ...
    public final void n() {
        un unVar = this.a;
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(unVar.getContext(), 0, unVar.a);
    ...
    public final void x(long j3, TLRPC.Document document, String str, boolean z10) {
        ...
        try {
            ...
            x5 x5Var = document != null ? new x5(document, editField.getPaint().getFontMetricsInt()) : new x5(j3, editField.getPaint().getFontMetricsInt());
            x5Var.cacheType = 3;
