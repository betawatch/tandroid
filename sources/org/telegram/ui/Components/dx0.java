...
public final class dx0 extends lj0 {
    public float E;
    ...
    public dx0(ix0 ix0Var, Context context) {
        super(context);
        org.telegram.ui.ActionBar.e6 e6Var = ix0Var.p2;
        this.H = ix0Var;
        this.w = false;
        this.y = 1.0f;
        k(ix0Var.w3 ? i0.a.k(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Wk, e6Var), (int) 102.0f) : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Me, e6Var));
    ...
    public final void l(boolean z10, boolean z11) {
        if (Math.abs(this.s - (z10 ? 1.0f : 0.0f)) > 0.01f) {
            ...
            this.v = ofFloat;
            ofFloat.addUpdateListener(new ax0(this, 1));
            this.v.addListener(new cx0(this, 1));
    ...
    public final void m(float f7) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = ix0Var.p2;
        if (ix0Var.w3) {
            k(i0.a.k(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Wk, e6Var), (int) (AndroidUtilities.lerp(0.4f, 0.8f, f7) * 255.0f)));
        } else {
            k(i0.a.d(this.s, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Me, e6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oe, e6Var)));
        }
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(org.telegram.messenger.wh.y(4.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30));
    }
    ...
    public final void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            if (f7 != 0.0f) {
                ...
                this.F = ofFloat;
                ofFloat.addUpdateListener(new ax0(this, 0));
                this.F.addListener(new cx0(this, 2));
