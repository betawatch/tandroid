...
public final class nk0 extends FrameLayout {
    ...
    public final void e(mg.q0 q0Var) {
        ...
        if (q0Var != null && q0Var.a) {
            mk0Var.getImageReceiver().setImageBitmap(new gj0(R.raw.star_reaction, AndroidUtilities.dp(30.0f), "star_reaction", AndroidUtilities.dp(30.0f)));
    ...
    public final void f(mg.q0 q0Var, boolean z4) {
        ...
        if (contains != z10) {
            ...
            if (z4) {
                ...
                mk0Var.animate().scaleX(this.F * (this.w ? 0.76f : 1.0f)).scaleY(this.F * (this.w ? 0.76f : 1.0f)).setDuration(240L).setInterpolator(nrVar).start();
            } else {
        ...
        if (this.L) {
            ...
            if (pk0Var.N == null) {
                ...
                if (action == 0) {
                    ...
                    if (this.h == 1.0f && !this.E && (i10 = pk0Var.J0) != 3 && i10 != 4 && i10 != 5 && ((ok0Var = pk0Var.d0) == null || ok0Var.h())) {
                ...
                if (motionEvent.getAction() == 1 && this.K && ((pk0Var.i0 == null || pk0Var.k0 > 0.8f) && pk0Var.d0 != null)) {
                    ...
                    if (System.currentTimeMillis() - pk0Var.p0 > 300) {
                        ...
                        pk0Var.d0.i(this, this.e, pk0Var.k0 > 0.8f, false);
                    }
                }
