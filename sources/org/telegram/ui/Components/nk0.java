...
public final class nk0 extends FrameLayout {
    ...
    public static void a(nk0 nk0Var, zg.o0 o0Var, int i10) {
        ...
        if (z10 && nk0Var.f == null) {
            ...
            nk0Var.addView(nk0Var.f, w7.y5.d(18, 18.0f, 17, 8.0f, 8.0f, 0.0f, 0.0f));
        }
        rg.b1 b1Var2 = nk0Var.f;
        if (b1Var2 != null) {
            b1Var2.setVisibility(nk0Var.H ? 0 : 8);
        }
        nk0Var.d();
        nk0Var.e = o0Var;
        nk0Var.r = o0Var.a || (o0Var.f != null && ((pk0Var.q() || pk0Var.G0) && LiteMode.isEnabled(LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS)));
        if (i12 == 4 || nk0Var.e.b) {
            nk0Var.r = false;
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.w && this.x) {
            ...
            zg.o0 o0Var = this.e;
            pk0 pk0Var = this.P;
            canvas.drawCircle(measuredWidth, measuredHeight, measuredWidth2, (o0Var == null || !o0Var.a) ? pk0Var.H0 : pk0Var.I0);
        }
        p5 p5Var = this.b.e;
    ...
    public final void e(zg.o0 o0Var) {
        ...
        if (i10 == 4 && o0Var != null && o0Var.f != null) {
            mk0Var.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(o0Var.f));
            mk0Var2.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(o0Var.f));
            return;
        }
        zg.o0 o0Var2 = this.e;
        if (o0Var2.b) {
            ...
            if (tL_availableReaction2 != null) {
                ...
                if (!LiteMode.isEnabled(LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS) || i10 == 4) {
                    ...
                    if (SharedConfig.getDevicePerformanceClass() <= 0 || i10 == 4) {
                        ...
                        mk0Var.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.appear_animation), "30_30_nolimit", null, null, svgThumb, 0L, "tgs", o0Var, 0);
                        mk0Var2.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_firstframe", null, null, this.r ? null : svgThumb, 0L, "tgs", this.e, 0);
                    }
                } else {
                    tL_availableReaction = tL_availableReaction2;
                    mk0Var.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction2.appear_animation), "30_30_nolimit", null, null, svgThumb, 0L, "tgs", o0Var, 0);
                ...
                MediaDataController.getInstance(pk0Var.J).preloadImage(imageReceiver, ImageLocation.getForDocument(tL_availableReaction.around_animation), zg.k0.a());
            }
            rg.b1 b1Var = this.f;
            if (b1Var != null) {
    ...
    public final void f(zg.o0 o0Var, boolean z10) {
        ...
        if (contains != z11) {
            ...
            if (z10) {
                ...
                mk0Var.animate().scaleX(this.I * (this.w ? 0.76f : 1.0f)).scaleY(this.I * (this.w ? 0.76f : 1.0f)).setDuration(240L).setInterpolator(qrVar).start();
            } else {
            ...
            if (pk0Var.Q == null) {
                ...
                if (motionEvent.getAction() == 1 && this.N && ((pk0Var.l0 == null || pk0Var.n0 > 0.8f) && pk0Var.g0 != null)) {
                    ...
                    if (System.currentTimeMillis() - pk0Var.s0 > 300) {
                        ...
                        pk0Var.g0.h(this, this.e, pk0Var.n0 > 0.8f, false);
                    }
                }
                if (!pk0Var.r0 && pk0Var.l0 != null) {
                    ...
                    pk0Var.Q.addListener(new ci.v5(pk0Var, i11));
                    pk0Var.Q.setDuration(150L);
                    pk0Var.Q.setInterpolator(qr.f);
                    pk0Var.Q.start();
                }
