                ...
                if (wxVar2 != null && (stickerSet2 = wxVar2.b) != null) {
                    ...
                    while (true) {
                        if (i13 >= vxVar.getChildCount()) {
                            num = null;
                            view2 = null;
                        } else if (!(vxVar.getChildAt(i13) instanceof yx) || (S = RecyclerView.S((view2 = vxVar.getChildAt(i13)))) < 0 || (i10 = sxVar.w.get(S)) < 0 || i10 >= arrayList3.size() || arrayList3.get(i10) == null || ayVar.s == null || ((wx) arrayList3.get(i10)).b.id != ayVar.s.b.id) {
                            i13++;
                        } else {
                    ...
                    if (ayVar.n == null) {
                        ...
                        if (stickerSet5 != null && stickerSet5.set != null) {
                            org.telegram.ui.ActionBar.o2 o2Var = kzVar2.Y1;
                            if (o2Var == null) {
                                o2Var = new ai.y3(ayVar, 6);
                            }
                            sv.W(o2Var, stickerSet5, true, null, new xp(ayVar, 14));
                            break;
                        } else {
                ...
                if (wxVar3 != null && (stickerSet3 = wxVar3.b) != null) {
                    ...
                    if (ayVar.r == null) {
                        ...
                        if (stickerSet7 != null && stickerSet7.set != null) {
                            org.telegram.ui.ActionBar.o2 o2Var2 = kzVar3.Y1;
                            if (o2Var2 == null) {
                                o2Var2 = new ai.y3(ayVar, 6);
                            }
                            ...
                            if (o2Var3.getFragmentView() != null) {
                                MediaDataController.getInstance(o2Var3.getCurrentAccount()).toggleStickerSet(o2Var3.getFragmentView().getContext(), stickerSet7, 0, o2Var3, true, true, ohVar, false);
                                break;
                            }
                        } else {
