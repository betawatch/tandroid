...
public final class zx extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public zx(kz kzVar, Context context) {
        ...
        this.e = textView2;
        org.telegram.ui.ai.o(14.0f, 1, textView2);
    ...
    public final void a(boolean z4) {
        ...
        this.y.addListener(new org.telegram.ui.Cells.a4(this, i10, 4));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            ...
            if (this.n != null && (stickerSetById2 = MediaDataController.getInstance(i12).getStickerSetById(this.n.id)) != null && stickerSetById2.set != null) {
                ...
                lv.W(p2Var, stickerSetById2, true, null, new up(this, 14));
                this.n = null;
            }
            ...
            em emVar = new em(i13, this, stickerSetById);
            Pattern pattern = lv.S;
            if (p2Var3.getFragmentView() != null) {
                MediaDataController.getInstance(p2Var3.getCurrentAccount()).toggleStickerSet(p2Var3.getFragmentView().getContext(), stickerSetById, 0, p2Var3, true, true, emVar, false);
            }
            this.r = null;
        }
    }
