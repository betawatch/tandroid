    ...
    public final void run(Object obj) {
        ...
        switch (this.a) {
            ...
            case 7:
                ...
                ArrayList arrayList = ub0Var.e.a;
                wa0 wa0Var = ub0Var.f;
                if (((rb0) arrayList.get(wa0Var.getCurrentPosition())).a != num.intValue()) {
                    int i10 = 0;
                    int i11 = 0;
                    while (true) {
                        if (i11 < arrayList.size()) {
                            if (((rb0) arrayList.get(i11)).a == num.intValue()) {
                                i10 = i11;
                            } else {
                                i11++;
                            }
            ...
            case 8:
                ...
                ob0Var.n.y(ob0Var.f.T((View) obj));
                break;
            case 9:
                ...
                if (sd0Var.getContext() != null) {
                    ...
                    if (SharedConfig.passcodeType == 1) {
                        ...
                        sd0Var.I.animate().alpha(intValue > AndroidUtilities.dp(20.0f) ? 0.0f : 1.0f).setDuration(320L).setInterpolator(rrVar);
                        break;
                    }
                }
                break;
            ...
            case 12:
                ...
                ConnectionsManager.getInstance(i12).sendRequest(updatebirthday, new ai.s5(gy0Var, userFull, tL_birthday2, 13), 1024);
