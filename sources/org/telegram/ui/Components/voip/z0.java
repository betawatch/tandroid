...
public final class z0 extends TextView {
    ...
    public z0(vh1 vh1Var, Context context) {
        ...
        this.a = paint;
        this.b = new Paint[vh1Var.e.length];
        fc0 fc0Var = vh1Var.O;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp = AndroidUtilities.dp(8.0f) + ((int) ((1.0f - vh1Var.y) * (AndroidUtilities.dp(26.0f) - AndroidUtilities.dp(8.0f))));
