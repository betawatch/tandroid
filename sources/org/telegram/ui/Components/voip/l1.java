...
public final class l1 extends FrameLayout {
    ...
    public l1(Context context) {
        ...
        addView(aj0Var, f6.c(37.0f, 37));
        addView(aj0Var2, f6.c(37.0f, 37));
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            k1 k1Var2 = this.e;
            if (k1Var2 != null) {
                l1[] l1VarArr = ((m1) ((l4.s0) k1Var2).b).c;
                while (true) {
                    i10 = this.f;
                    if (i11 > i10) {
                        break;
            ...
            k1 k1Var3 = this.e;
            if (k1Var3 != null) {
                l1[] l1VarArr2 = ((m1) ((l4.s0) k1Var3).b).c;
            ...
            if (this.d != null) {
                ...
                int i16 = this.f + 1;
                m1 m1Var = (m1) j1Var.b;
                Context context = (Context) j1Var.c;
                if (i16 >= 4) {
                    ...
                    int i17 = iArr2[0];
                    int i18 = iArr2[1];
                    m1Var.addView(aj0Var7, f6.c(133.0f, 133));
                    float f9 = width - i17;
                    float f10 = dp / 2.0f;
                    aj0Var7.setTranslationX(f9 - f10);
            ...
            l1[] l1VarArr3 = ((m1) ((l4.s0) k1Var).b).c;
