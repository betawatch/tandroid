...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public static /* synthetic */ void $r8$lambda$l9tJBS9m5tMYWLxgU_15IsfNWFo(VoIPFloatingLayout voIPFloatingLayout, ValueAnimator valueAnimator) {
    ...
    public VoIPFloatingLayout(Context context) {
        ...
        this.mutedUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIPFloatingLayout$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                VoIPFloatingLayout.$r8$lambda$l9tJBS9m5tMYWLxgU_15IsfNWFo(VoIPFloatingLayout.this, valueAnimator);
            }
        };
    ...
    */
    ...
    public void setFloatingMode(boolean z, boolean z2) {
        ...
        if (z && !this.floatingMode) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(voIPFloatingLayout.toFloatingModeProgress, 1.0f);
            voIPFloatingLayout.switchToFloatingModeAnimator = ofFloat;
            ofFloat.addUpdateListener(voIPFloatingLayout.progressUpdateListener);
