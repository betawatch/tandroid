                ...
                if (action != 1) {
                    if (action == 2) {
                        ...
                        if (voIPPiPView4.moving) {
                            ...
                            WindowManager windowManager = voIPPiPView4.windowManager;
                            VoIPPiPView voIPPiPView5 = VoIPPiPView.this;
                            AndroidUtilities.updateViewLayout(windowManager, voIPPiPView5.windowView, voIPPiPView5.windowLayoutParams);
                        }
                    }
                }
