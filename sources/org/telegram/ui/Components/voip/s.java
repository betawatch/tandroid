...
public final class s extends View {
    ...
    public static void a(s sVar, boolean z4) {
        ...
        if (b60VarArr[i10] == null) {
            ...
            int i11 = sVar.C;
            if (i11 == 2) {
                b60VarArr[i11].g = new LinearGradient(0.0f, 400.0f, 400.0f, 0.0f, new int[]{j6.w0(null, j6.ih, false), j6.w0(null, j6.kh, false), j6.w0(null, j6.jh, false)}, (float[]) null, Shader.TileMode.CLAMP);
            } else if (i11 == 1) {
                b60VarArr[i11].g = new RadialGradient(200.0f, 200.0f, 200.0f, new int[]{j6.w0(null, j6.Fg, false), j6.w0(null, j6.Hg, false)}, (float[]) null, Shader.TileMode.CLAMP);
            } else {
                b60VarArr[i11].g = new RadialGradient(200.0f, 200.0f, 200.0f, new int[]{j6.w0(null, j6.Jg, false), j6.w0(null, j6.Ig, false)}, (float[]) null, Shader.TileMode.CLAMP);
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        b60 b60Var3 = this.y;
        if (b60Var3 != null) {
            b60Var3.b((int) (this.w - AndroidUtilities.dp(100.0f)), (int) (this.v - AndroidUtilities.dp(100.0f)), AndroidUtilities.dp(200.0f), 16L, this.n);
        }
        float f20 = this.n;
        u9 u9Var = this.e;
        u9Var.e(f20, 1.0f);
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            if (i10 != 0 || (b60Var2 = this.B) == null) {
                if (i10 == 1 && (b60Var = this.y) != null) {
                    paint.setShader(b60Var.g);
                    f10 = this.D;
                }
            } else {
                paint.setShader(b60Var2.g);
                f10 = 1.0f - this.D;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.w = (getMeasuredHeight() >> 1) + (c60.C3 ? 0.0f : (-getMeasuredHeight()) * 0.12f);
        float f10 = dp / 2.0f;
