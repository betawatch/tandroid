    ...
    public final void b() {
        ...
        if (imageView != null && imageView.getParent() != null) {
            if (tVar.t0.getAlpha() == 1.0f) {
                tVar.t0.animate().alpha(0.0f).setDuration(300L).setListener(new f11(this, 11)).start();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (!isFirstFrameRendered || (!(q2Var.getAlpha() == 1.0f || this.e.getAlpha() == 1.0f) || tVar.o0)) {
            ...
            if (videoParticipant == call.videoNotAvailableParticipant) {
                ...
                if (tVar.r || tVar.b) {
                    f11 = 10.0f;
                    d = (int) com.google.android.recaptcha.internal.a.d(AndroidUtilities.dp(39.0f), k0Var.c, AndroidUtilities.dp(10.0f), dp2);
                } else {
                    f11 = 10.0f;
                    d = (int) ((Math.max(1.0f - k0Var.c, (tVar.h || tVar.f) ? k0Var.n : 0.0f) * AndroidUtilities.dp(10.0f)) + dp2);
                }
                ...
                float f22 = f12;
                int dp3 = (int) ((AndroidUtilities.dp(17.0f) * f21) + ((((getMeasuredHeight() - d) / 2) - AndroidUtilities.dp(28.0f)) - (((((tVar.b || tVar.r) ? k0Var.c : 0.0f) * AndroidUtilities.dp(74.0f)) + AndroidUtilities.dp(17.0f)) * f22)));
                brVar = brVar2;
                int i11 = dp3 + d;
                ...
                qVar.setTranslationY(((AndroidUtilities.dp(72.0f) + i10) + tVar.l0) - this.J);
                ...
                if (k0Var.c < 1.0f && f20 < 1.0f) {
                    ...
                    canvas.save();
                    canvas.translate((d / 2.0f) + (measuredWidth - (AndroidUtilities.dp(400.0f) / 2.0f)), AndroidUtilities.dp(f11) + i10);
                    this.k0.draw(canvas);
                    canvas.restore();
                }
            } else {
        ...
        if (tVar.w != call.videoNotAvailableParticipant) {
            canvas.save();
            if ((tVar.b || tVar.r) && !s50.B3 && !s50.C3) {
