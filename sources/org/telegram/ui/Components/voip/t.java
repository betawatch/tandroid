...
public final class t extends View {
    ...
    public static void a(t tVar, boolean z10) {
        ...
        if (j60VarArr[i10] == null) {
            ...
            int i11 = tVar.F;
            if (i11 == 2) {
                j60VarArr[i11].g = new LinearGradient(0.0f, 400.0f, 400.0f, 0.0f, new int[]{j6.w0(null, j6.ih, false), j6.w0(null, j6.kh, false), j6.w0(null, j6.jh, false)}, (float[]) null, Shader.TileMode.CLAMP);
            } else if (i11 == 1) {
                j60VarArr[i11].g = new RadialGradient(200.0f, 200.0f, 200.0f, new int[]{j6.w0(null, j6.Fg, false), j6.w0(null, j6.Hg, false)}, (float[]) null, Shader.TileMode.CLAMP);
            } else {
                j60VarArr[i11].g = new RadialGradient(200.0f, 200.0f, 200.0f, new int[]{j6.w0(null, j6.Jg, false), j6.w0(null, j6.Ig, false)}, (float[]) null, Shader.TileMode.CLAMP);
            }
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        j60 j60Var3 = this.y;
        if (j60Var3 != null) {
            j60Var3.b((int) (this.w - AndroidUtilities.dp(100.0f)), (int) (this.v - AndroidUtilities.dp(100.0f)), AndroidUtilities.dp(200.0f), 16L, this.n);
        }
        float f19 = this.n;
        z9 z9Var = this.e;
        z9Var.e(f19, 1.0f);
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            if (i10 != 0 || (j60Var2 = this.E) == null) {
                if (i10 == 1 && (j60Var = this.y) != null) {
                    paint.setShader(j60Var.g);
                    f7 = this.G;
                }
            } else {
                paint.setShader(j60Var2.g);
                f7 = 1.0f - this.G;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.w = (getMeasuredHeight() >> 1) + (k60.F3 ? 0.0f : (-getMeasuredHeight()) * 0.12f);
        float f7 = dp / 2.0f;
