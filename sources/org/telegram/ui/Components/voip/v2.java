...
public class v2 extends FrameLayout {
    ...
    public final void c(int i10, int i11, int i12, float f10, boolean z4, String str, boolean z10, boolean z11) {
        ...
        this.v.addListener(new l00(17, this, z13));
                        ...
                        if (z11) {
                            ...
                            if (f16 < 1.0f) {
                                ...
                                if (this.H <= 0.0f) {
                                    ...
                                    nr nrVar = nr.f;
                                    float interpolation = (nrVar.getInterpolation(this.H) * dp3) + (dpf2 - AndroidUtilities.dp(1.0f));
                                    float interpolation2 = (nrVar.getInterpolation(this.H) * AndroidUtilities.dp(17.0f)) + dpf22;
