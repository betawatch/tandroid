...
public abstract class w0 extends FrameLayout implements VoIPService.StateListener {
    ...
    public w0(Context context, boolean z10) {
        ...
        int i10 = j6.ng;
        tVar.setTextColor(j6.w0(null, i10, false));
        tVar.setGravity(17);
        ...
        while (true) {
            ...
            this.d.addView(this.f[i11], a6.n(-2, -1));
            if (i11 == 0 && this.y) {
            ...
            this.f[i11].setOnClickListener(new j5(this, i11, 15));
            i11++;
        }
        setAlpha(0.0f);
        ...
        if (sharedInstance != null) {
            ...
            this.h.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new u0());
        ...
        this.v = true;
        hj0Var.M(69);
        kj0Var.setOnClickListener(new u10(21, this, hj0Var));
        addView(kj0Var, a6.d(48, 48.0f, 83, 24.0f, 0.0f, 0.0f, 136.0f));
    }

    public static void a(w0 w0Var) {
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (w0Var.n == w0Var.r || sharedInstance == null) {
            return;
        }
