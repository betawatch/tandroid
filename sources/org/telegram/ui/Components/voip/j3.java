...
public final class j3 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i11 = q1Var.g;
        Paint paint = q1Var.j;
        com.google.firebase.messaging.n nVar = q1Var.a;
        float f10 = q1Var.g;
        float f11 = 1.12f * f10;
        float f12 = (f11 - q1Var.f) / 2.0f;
        ...
        if (yi0Var != null) {
            ...
            if (q1Var.e) {
                canvas.drawCircle(width, height, f17, (Paint) q1Var.c.a);
            }
            this.c.draw(canvas);
            return;
        }
        ...
        if (z10 || this.r > 0) {
            ...
            if (q1Var.e) {
                canvas.drawCircle(width, height, this.r, (Paint) q1Var.c.a);
            }
            this.a.draw(canvas);
        }
