...
public class VoipCoverEmoji {
    ...
    private void show() {
        ...
        long j2 = NotificationCenter.newEmojiSuggestionsAvailable;
        ofFloat.setStartDelay(j2);
        ofFloat.start();
        ValueAnimator ofInt = ValueAnimator.ofInt(0, NotificationCenter.invalidateMotionBackground, NotificationCenter.invalidateMotionBackground);
