...
public final class u1 extends FrameLayout {
    ...
    public final void c(boolean z10, boolean z11) {
        ...
        if (!z10 || this.M) {
            ...
            getViewTreeObserver().addOnPreDrawListener(new s1(this, translationX, translationY));
            return;
        }
        this.M = true;
        this.N = z10;
        ...
        if (f7 >= 0.0f) {
            u1Var = this;
            u1Var.e(f7, this.E, (int) (getMeasuredWidth() * 0.23f), (int) (getMeasuredHeight() * 0.23f), false);
        } else {
            u1Var = this;
        }
        u1Var.M = false;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.y < 0.0f || !this.M || getMeasuredWidth() <= 0) {
            ...
            u1Var = this;
            u1Var.e(this.y, this.E, getMeasuredWidth(), getMeasuredHeight(), false);
            u1Var.y = -1.0f;
            u1Var.E = -1.0f;
        }
    ...
    */
    ...
    public void setRelativePosition(u1 u1Var) {
        ...
        float systemWindowInsetTop = this.n == null ? 0.0f : r1.getSystemWindowInsetTop() + this.H;
        View view = (View) parent;
        d(Math.min(1.0f, Math.max(0.0f, (u1Var.getTranslationX() - this.F) / (((view.getMeasuredWidth() - this.F) - this.G) - u1Var.getMeasuredWidth()))), Math.min(1.0f, Math.max(0.0f, (u1Var.getTranslationY() - systemWindowInsetTop) / (((view.getMeasuredHeight() - (this.n == null ? 0.0f : r3.getSystemWindowInsetBottom() + this.I)) - systemWindowInsetTop) - u1Var.getMeasuredHeight()))));
    }
