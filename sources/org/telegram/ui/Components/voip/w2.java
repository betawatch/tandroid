...
public abstract class w2 extends FrameLayout {
    ...
    public final void c(long j10) {
        ...
        if (ii1.k1 != null) {
            if (VoIPService.getSharedInstance() != null) {
                ...
                if (ii1.k1.A0 && !VoIPService.getSharedInstance().isConverting()) {
                    ii1 ii1Var = ii1.k1;
                    m2.l(ii1Var.b, ii1Var.a, ii1Var.r0.getMeasuredWidth(), measuredHeight, 0);
        ...
        if (this.b) {
            ...
            this.c.lock();
            animate().translationY(getMeasuredHeight()).alpha(0.0f).setListener(new f91(this, 9)).setDuration(j10).setInterpolator(mr.f).start();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        setAlpha(0.0f);
        animate().translationY(0.0f).alpha(1.0f).setDuration(330L).setInterpolator(mr.f).start();
    }
