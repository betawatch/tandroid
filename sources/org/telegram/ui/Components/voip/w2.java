...
public class w2 extends FrameLayout {
    ...
    public w2(Context context, float f10) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.f.addView(textView, c6.d(-1, -2.0f, 0, 0.0f, f10 + 6.0f, 0.0f, 0.0f));
            this.h[i10] = textView;
        }
    ...
    public final void c(int i10, int i11, int i12, float f10, boolean z4, String str, boolean z10, boolean z11) {
        ...
        if (this.K == null || z4) {
            ...
            if (alpha != 255 || AndroidUtilities.computePerceivedBrightness(i12) <= 0.5d) {
                org.telegram.ui.Cells.z h02 = k6.h0(AndroidUtilities.dp(f11), 0, i0.a.k(-1, (int) (f10 * 76.5f)));
                this.K = h02;
                h02.setCallback(this);
            } else {
                org.telegram.ui.Cells.z h03 = k6.h0(AndroidUtilities.dp(f11), 0, i0.a.k(-16777216, (int) (f10 * 25.5f)));
                this.K = h03;
        ...
        this.v = ofFloat;
        ofFloat.addUpdateListener(new eg.z0(9, this, z13));
        this.v.addListener(new x20(15, this, z13));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z4) {
            ...
            if (f12 != 0.0f) {
                ...
                if (this.K == null) {
                    org.telegram.ui.Cells.z h02 = k6.h0(AndroidUtilities.dp(f13), 0, -16777216);
                    this.K = h02;
                    h02.setCallback(this);
                }
                if (this.c) {
                        ...
                        if (z11) {
                            ...
                            if (f16 < 1.0f) {
                                ...
                                if (this.H <= 0.0f) {
                                    ...
                                    pr prVar = pr.f;
                                    float interpolation = (prVar.getInterpolation(this.H) * dp3) + (dpf2 - AndroidUtilities.dp(1.0f));
                                    float interpolation2 = (prVar.getInterpolation(this.H) * AndroidUtilities.dp(17.0f)) + dpf22;
