...
public abstract class w2 extends FrameLayout {
    ...
    public final void c(long j3) {
        ...
        if (this.b) {
            ...
            this.c.lock();
            animate().translationY(getMeasuredHeight()).alpha(0.0f).setListener(new w81(this, 10)).setDuration(j3).setInterpolator(qr.f).start();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        setAlpha(0.0f);
        animate().translationY(0.0f).alpha(1.0f).setDuration(330L).setInterpolator(qr.f).start();
    }
