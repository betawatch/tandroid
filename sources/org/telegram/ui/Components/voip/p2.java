...
public final class p2 extends FrameLayout {
    ...
    public final void a(View view, View view2, Runnable runnable) {
        ...
        this.h.addListener(new us(this, view, view2, runnable, 2));
        this.h.setDuration(250L).setInterpolator(mr.f);
        this.h.start();
    }
    ...
    public final void c(boolean z4) {
        ...
        if (!z4) {
            ...
            frameLayout.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(mr.f).setListener(new o2(this, 1)).setDuration(300L).start();
        } else {
            ...
            org.telegram.ui.b.p(frameLayout.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), mr.k, 300L);
        }
    }
