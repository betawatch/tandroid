...
public final class t1 extends FrameLayout {
    ...
    public t1(Activity activity) {
        ...
        this.Q = -1.0f;
        this.R = true;
        this.e0 = new ai.m(this, 9);
        this.g0 = new ai.a(this, 19);
    ...
    public final void c(boolean z10, boolean z11) {
        ...
        if (f7 >= 0.0f) {
            t1Var = this;
            t1Var.e(f7, this.E, (int) (getMeasuredWidth() * 0.23f), (int) (getMeasuredHeight() * 0.23f), false);
        } else {
            t1Var = this;
        }
        t1Var.M = false;
        ...
        wr wrVar = wr.f;
        duration.setInterpolator(wrVar).setListener(new le.c(this, translationX2, translationY2, 1)).setInterpolator(wrVar).start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.y < 0.0f || !this.M || getMeasuredWidth() <= 0) {
            ...
            t1Var = this;
            t1Var.e(this.y, this.E, getMeasuredWidth(), getMeasuredHeight(), false);
            t1Var.y = -1.0f;
            t1Var.E = -1.0f;
        }
        ...
        canvas.drawCircle(f7, f10, AndroidUtilities.dp(14.0f), t1Var.w);
    ...
    public final void e(float f7, float f10, int i10, int i11, boolean z10) {
        ...
        if (z10) {
            animate().setListener(null).cancel();
            animate().scaleX(1.0f).scaleY(1.0f).translationX(z11).translationY(z12).alpha(1.0f).setStartDelay(this.L ? 0L : 150L).setDuration(150L).setInterpolator(wr.f).start();
            return;
        }
        if (!this.S) {
            animate().setListener(null).cancel();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        s1 s1Var = this.i0;
        if (s1Var != null) {
            ((hi1) s1Var).b.d0.d(this.J, this.P);
        }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            ...
            if (parent != null && this.M && !this.O) {
                ...
                startDelay.setDuration(150L).setInterpolator(wr.f).start();
            }
            this.e = false;
            return true;
        }
    ...
    public void setRelativePosition(t1 t1Var) {
        ...
        float systemWindowInsetTop = this.n == null ? 0.0f : r1.getSystemWindowInsetTop() + this.H;
        View view = (View) parent;
        d(Math.min(1.0f, Math.max(0.0f, (t1Var.getTranslationX() - this.F) / (((view.getMeasuredWidth() - this.F) - this.G) - t1Var.getMeasuredWidth()))), Math.min(1.0f, Math.max(0.0f, (t1Var.getTranslationY() - systemWindowInsetTop) / (((view.getMeasuredHeight() - (this.n == null ? 0.0f : r3.getSystemWindowInsetBottom() + this.I)) - systemWindowInsetTop) - t1Var.getMeasuredHeight()))));
    }
