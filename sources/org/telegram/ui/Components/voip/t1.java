...
public final class t1 extends FrameLayout {
    ...
    public t1(Activity activity) {
        ...
        this.N = -1.0f;
        this.O = true;
        this.b0 = new f2.d0(this, 8);
        this.d0 = new f5(this, 6);
    ...
    public final void c(boolean z4, boolean z10) {
        ...
        if (f10 >= 0.0f) {
            t1Var = this;
            t1Var.e(f10, this.B, (int) (getMeasuredWidth() * 0.23f), (int) (getMeasuredHeight() * 0.23f), false);
        } else {
            t1Var = this;
        }
        t1Var.J = false;
        ...
        pr prVar = pr.f;
        duration.setInterpolator(prVar).setListener(new q1(this, translationX2, translationY2, 0)).setInterpolator(prVar).start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.y < 0.0f || !this.J || getMeasuredWidth() <= 0) {
            ...
            t1Var = this;
            t1Var.e(this.y, this.B, getMeasuredWidth(), getMeasuredHeight(), false);
            t1Var.y = -1.0f;
            t1Var.B = -1.0f;
        }
        ...
        canvas.drawCircle(f10, f11, AndroidUtilities.dp(14.0f), t1Var.w);
    ...
    public final void e(float f10, float f11, int i10, int i11, boolean z4) {
        ...
        if (z4) {
            animate().setListener(null).cancel();
            animate().scaleX(1.0f).scaleY(1.0f).translationX(w10).translationY(w11).alpha(1.0f).setStartDelay(this.I ? 0L : 150L).setDuration(150L).setInterpolator(pr.f).start();
            return;
        }
        if (!this.P) {
            animate().setListener(null).cancel();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        s1 s1Var = this.f0;
        if (s1Var != null) {
            ((qh1) s1Var).b.a0.d(this.G, this.M);
        }
    ...
    */
    ...
    public void setRelativePosition(t1 t1Var) {
        ...
        float systemWindowInsetTop = this.n == null ? 0.0f : r1.getSystemWindowInsetTop() + this.E;
        View view = (View) parent;
        d(Math.min(1.0f, Math.max(0.0f, (t1Var.getTranslationX() - this.C) / (((view.getMeasuredWidth() - this.C) - this.D) - t1Var.getMeasuredWidth()))), Math.min(1.0f, Math.max(0.0f, (t1Var.getTranslationY() - systemWindowInsetTop) / (((view.getMeasuredHeight() - (this.n == null ? 0.0f : r3.getSystemWindowInsetBottom() + this.F)) - systemWindowInsetTop) - t1Var.getMeasuredHeight()))));
    }
