...
public final class b1 extends TextView {
    ...
    public b1(mi1 mi1Var, Context context) {
        ...
        this.a = paint;
        this.b = new Paint[mi1Var.e.length];
        kc0 kc0Var = mi1Var.R;
        ...
        kc0Var.draw((Canvas) nVar.b);
        kc0Var2.draw((Canvas) nVar2.b);
        paint.setColor(-1);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp = AndroidUtilities.dp(8.0f) + ((int) ((1.0f - mi1Var.y) * (AndroidUtilities.dp(26.0f) - AndroidUtilities.dp(8.0f))));
