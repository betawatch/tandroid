...
public final class s1 extends FrameLayout {
    ...
    public s1(Activity activity) {
        ...
        setOutlineProvider(new rl(this, 3));
    ...
    public final void c(boolean z4, boolean z10) {
        ...
        mr mrVar = mr.f;
        duration.setInterpolator(mrVar).setListener(new p1(this, translationX2, translationY2, 0)).setInterpolator(mrVar).start();
    }
    ...
    public final void e(float f10, float f11, int i10, int i11, boolean z4) {
        ...
        if (z4) {
            animate().setListener(null).cancel();
            animate().scaleX(1.0f).scaleY(1.0f).translationX(w10).translationY(w11).alpha(1.0f).setStartDelay(this.I ? 0L : 150L).setDuration(150L).setInterpolator(mr.f).start();
            return;
        }
        if (!this.P) {
            animate().setListener(null).cancel();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        r1 r1Var = this.f0;
        if (r1Var != null) {
            ((qh1) r1Var).b.a0.d(this.G, this.M);
        }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            ...
            if (parent != null && this.J && !this.L) {
                ...
                startDelay.setDuration(150L).setInterpolator(mr.f).start();
            }
            this.e = false;
            return true;
        }
