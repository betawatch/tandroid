...
public class x2 extends FrameLayout {
    ...
    public x2(Context context, float f9) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.f.addView(textView, f6.d(-1, -2.0f, 0, 0.0f, f9 + 6.0f, 0.0f, 0.0f));
            this.h[i10] = textView;
        }
    ...
    public final void c(int i10, int i11, int i12, float f9, boolean z10, String str, boolean z11, boolean z12) {
        ...
        if (this.J == null || z10) {
            ...
            if (alpha != 255 || AndroidUtilities.computePerceivedBrightness(i12) <= 0.5d) {
                org.telegram.ui.Cells.z h02 = g6.h0(AndroidUtilities.dp(f10), 0, i0.a.k(-1, (int) (f9 * 76.5f)));
                this.J = h02;
                h02.setCallback(this);
            } else {
                org.telegram.ui.Cells.z h03 = g6.h0(AndroidUtilities.dp(f10), 0, i0.a.k(-16777216, (int) (f9 * 25.5f)));
                this.J = h03;
        ...
        this.v = ofFloat;
        ofFloat.addUpdateListener(new bg.c1(10, this, z14));
        this.v.addListener(new z9(25, this, z14));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f11 != 0.0f) {
                ...
                if (this.J == null) {
                    org.telegram.ui.Cells.z h02 = g6.h0(AndroidUtilities.dp(f12), 0, -16777216);
                    this.J = h02;
                    h02.setCallback(this);
                }
                if (this.c) {
                    ...
                    if (!z11 && this.G == 0.0f) {
                        ...
                        while (true) {
                            ...
                            if (drawableArr[i10] != null) {
                                canvas.save();
                                float f13 = this.s;
                                if (f13 == 0.0f || this.C || drawableArr[0] == null || drawableArr[1] == null) {
                                    if (this.C) {
                                        int d = i0.a.d(f13, this.D, this.x);
                        ...
                        if (this.C) {
                            int d10 = i0.a.d(this.s, this.D, this.x);
                        ...
                        float f14 = this.s;
                        if (f14 != 0.0f && this.C) {
                            int d11 = i0.a.d(f14, this.D, this.x);
                        ...
                        if (z12) {
                            ...
                            if (f15 < 1.0f) {
                                ...
                                if (this.G <= 0.0f) {
                                    ...
                                    jr jrVar = jr.f;
                                    float interpolation = (jrVar.getInterpolation(this.G) * dp3) + (dpf2 - AndroidUtilities.dp(1.0f));
                                    float interpolation2 = (jrVar.getInterpolation(this.G) * AndroidUtilities.dp(17.0f)) + dpf22;
