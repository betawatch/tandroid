...
public abstract class u2 extends FrameLayout {
    ...
    public final void c(long j3) {
        ...
        if (ui1.n1 != null) {
            if (VoIPService.getSharedInstance() != null) {
                ...
                if (ui1.n1.D0 && !VoIPService.getSharedInstance().isConverting()) {
                    ui1 ui1Var = ui1.n1;
                    k2.l(ui1Var.b, ui1Var.a, ui1Var.u0.getMeasuredWidth(), measuredHeight, 0);
        ...
        if (this.b) {
            ...
            this.c.lock();
            animate().translationY(getMeasuredHeight()).alpha(0.0f).setListener(new k61(this, 13)).setDuration(j3).setInterpolator(pr.f).start();
        }
    }
