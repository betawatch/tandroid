...
public class u2 extends FrameLayout {
    ...
    public u2(Context context, float f7) {
        super(context);
        this.a = new Paint(1);
        this.b = true;
        this.c = true;
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.f.addView(textView, a6.d(-1, -2.0f, 0, 0.0f, f7 + 6.0f, 0.0f, 0.0f));
            this.h[i10] = textView;
        }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        if (this.O) {
            ...
            this.U.addListener(new zn0(this, 29));
    ...
    public final void c(int i10, int i11, int i12, float f7, boolean z10, String str, boolean z11, boolean z12) {
        ...
        this.v = ofFloat;
        ofFloat.addUpdateListener(new m7(7, this, z14));
        this.v.addListener(new yo(21, this, z14));
                        ...
                        if (z12) {
                            ...
                            if (f15 < 1.0f) {
                                ...
                                if (this.K <= 0.0f) {
                                    ...
                                    wr wrVar = wr.f;
                                    float interpolation = (wrVar.getInterpolation(this.K) * dp3) + (dpf2 - AndroidUtilities.dp(1.0f));
                                    float interpolation2 = (wrVar.getInterpolation(this.K) * AndroidUtilities.dp(17.0f)) + dpf22;
