...
public final class o2 extends FrameLayout {
    ...
    public final void a(View view, View view2, Runnable runnable) {
        ...
        this.h.setDuration(250L).setInterpolator(wr.f);
        this.h.start();
    }
    ...
    public final void b(String str, boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            spannableString.setSpan(new gg.f2(textViewArr), 0, 1, 33);
        ...
        if (this.n) {
            ...
            a(textViewArr[0], textViewArr[1], new x(this, 5));
        }
    }
    ...
    public final void c(boolean z10) {
        ...
        if (!z10) {
            ...
            frameLayout.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(wr.f).setListener(new n2(this, 1)).setDuration(300L).start();
        } else {
            ...
            em.q(frameLayout.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), wr.k, 300L);
        }
    }
