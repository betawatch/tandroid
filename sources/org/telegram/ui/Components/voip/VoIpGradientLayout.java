...
public class VoIpGradientLayout extends FrameLayout {
    ...
    public void switchToCalling() {
        ...
        this.alphaBlueGreen = NotificationCenter.needCheckSystemBarColors;
        ValueAnimator ofInt = ValueAnimator.ofInt(NotificationCenter.needCheckSystemBarColors, 0, NotificationCenter.needCheckSystemBarColors);
    ...
    public void switchToConnectedAnimator() {
        ...
        this.alphaGreen = NotificationCenter.needCheckSystemBarColors;
        this.connectedAnimatorSet = new AnimatorSet();
        ValueAnimator ofInt = ValueAnimator.ofInt(0, NotificationCenter.needCheckSystemBarColors, NotificationCenter.needCheckSystemBarColors, NotificationCenter.needCheckSystemBarColors, 0);
        ...
        ofInt.setRepeatCount(-1);
        ofInt.setRepeatMode(1);
        ValueAnimator ofInt2 = ValueAnimator.ofInt(0, 0, NotificationCenter.needCheckSystemBarColors, 0, 0);
    ...
    public void showToBadConnection() {
        ...
        this.state = gradientState2;
        ValueAnimator ofInt = ValueAnimator.ofInt(this.alphaOrangeRed, NotificationCenter.needCheckSystemBarColors);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.showClip) {
            ...
            this.bgGreen.setAlpha(NotificationCenter.needCheckSystemBarColors);
            this.bgGreen.draw(canvas);
            this.clipPath.rewind();
            ...
            this.bgGreenLightReveal.setAlpha(NotificationCenter.needCheckSystemBarColors);
            ...
            this.bgGreenDarkReveal.setAlpha(NotificationCenter.needCheckSystemBarColors);
