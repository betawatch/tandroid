...
public class VoIpGradientLayout extends FrameLayout {
    ...
    public void switchToCalling() {
        ...
        this.alphaBlueGreen = NotificationCenter.invalidateMotionBackground;
        ValueAnimator ofInt = ValueAnimator.ofInt(NotificationCenter.invalidateMotionBackground, 0, NotificationCenter.invalidateMotionBackground);
    ...
    public void switchToConnectedAnimator() {
        ...
        this.alphaGreen = NotificationCenter.invalidateMotionBackground;
        this.connectedAnimatorSet = new AnimatorSet();
        ValueAnimator ofInt = ValueAnimator.ofInt(0, NotificationCenter.invalidateMotionBackground, NotificationCenter.invalidateMotionBackground, NotificationCenter.invalidateMotionBackground, 0);
        ...
        ofInt.setRepeatCount(-1);
        ofInt.setRepeatMode(1);
        ValueAnimator ofInt2 = ValueAnimator.ofInt(0, 0, NotificationCenter.invalidateMotionBackground, 0, 0);
    ...
    public void showToBadConnection() {
        ...
        this.state = gradientState2;
        ValueAnimator ofInt = ValueAnimator.ofInt(this.alphaOrangeRed, NotificationCenter.invalidateMotionBackground);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.showClip) {
            ...
            this.bgGreen.setAlpha(NotificationCenter.invalidateMotionBackground);
            this.bgGreen.draw(canvas);
            this.clipPath.rewind();
            ...
            this.bgGreenLightReveal.setAlpha(NotificationCenter.invalidateMotionBackground);
            ...
            this.bgGreenDarkReveal.setAlpha(NotificationCenter.invalidateMotionBackground);
