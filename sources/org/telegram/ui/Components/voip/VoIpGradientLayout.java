...
public class VoIpGradientLayout extends FrameLayout {
    ...
    public void switchToCalling() {
        ...
        this.alphaBlueGreen = NotificationCenter.closeOtherAppActivities;
        ValueAnimator ofInt = ValueAnimator.ofInt(NotificationCenter.closeOtherAppActivities, 0, NotificationCenter.closeOtherAppActivities);
    ...
    public void switchToConnectedAnimator() {
        ...
        this.alphaGreen = NotificationCenter.closeOtherAppActivities;
        this.connectedAnimatorSet = new AnimatorSet();
        ValueAnimator ofInt = ValueAnimator.ofInt(0, NotificationCenter.closeOtherAppActivities, NotificationCenter.closeOtherAppActivities, NotificationCenter.closeOtherAppActivities, 0);
        ...
        ofInt.setRepeatCount(-1);
        ofInt.setRepeatMode(1);
        ValueAnimator ofInt2 = ValueAnimator.ofInt(0, 0, NotificationCenter.closeOtherAppActivities, 0, 0);
    ...
    public void showToBadConnection() {
        ...
        this.state = gradientState2;
        ValueAnimator ofInt = ValueAnimator.ofInt(this.alphaOrangeRed, NotificationCenter.closeOtherAppActivities);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.showClip) {
            ...
            this.bgGreen.setAlpha(NotificationCenter.closeOtherAppActivities);
            this.bgGreen.draw(canvas);
            this.clipPath.rewind();
            ...
            this.bgGreenLightReveal.setAlpha(NotificationCenter.closeOtherAppActivities);
            ...
            this.bgGreenDarkReveal.setAlpha(NotificationCenter.closeOtherAppActivities);
