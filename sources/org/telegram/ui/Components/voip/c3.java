...
public final class c3 extends FrameLayout {
    ...
    public c3(Activity activity, boolean z4, n1 n1Var) {
        ...
        this.R = isEnabled;
        this.a = z4 ? new b3() : new ec0(-4958504, -8304404, -14637865, -12612630, false, 0, true);
        this.b = z4 ? new b3() : new ec0(-12224791, -12879119, -16207709, -15226140, false, 0, true);
        this.c = new ec0(-16275028, -16270749, -5649306, -10833593, false, 0, true);
        this.d = new ec0(-1545896, -1613425, -2387892, -2198984, false, 0, true);
        Drawable b3Var = z4 ? new b3() : new ec0(-5818672, -9819171, -15755831, -14124319, false, 0, true);
        this.e = b3Var;
        Drawable b3Var2 = z4 ? new b3() : new ec0(-13803306, -13866273, -16738923, -16608823, false, 0, true);
        this.f = b3Var2;
        ec0 ec0Var = new ec0(-16741490, -16673972, -7357129, -13525721, false, 0, true);
        this.h = ec0Var;
        ec0 ec0Var2 = new ec0(-1949911, -1691537, -3705322, -2663914, false, 0, true);
        this.n = ec0Var2;
        Drawable b3Var3 = z4 ? new b3() : new ec0(-2726657, -7186179, -13778695, -11034113, false, 0, true);
        this.r = b3Var3;
        Drawable b3Var4 = z4 ? new b3() : new ec0(-11170817, -10507265, -16458548, -14105857, false, 0, true);
        this.s = b3Var4;
        ec0 ec0Var3 = new ec0(-16723243, -16129415, -3674272, -9578153, false, 0, true);
        this.v = ec0Var3;
        ec0 ec0Var4 = new ec0(-34714, -32091, -85931, -29103, false, 0, true);
        this.w = ec0Var4;
        this.x = new ec0(-16723243, -16129415, -3674272, -9578153, false, 0, true);
        this.y = new ec0(-16741490, -16673972, -7357129, -13525721, false, 0, true);
