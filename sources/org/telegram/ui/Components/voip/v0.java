...
public abstract class v0 extends FrameLayout implements VoIPService.StateListener {
    ...
    public v0(Context context, boolean z10) {
        ...
        int i10 = j6.ng;
        nVar.setTextColor(j6.w0(null, i10, false));
        nVar.setGravity(17);
        ...
        aj0Var.setBackground(j6.K(AndroidUtilities.dp(48.0f), i0.a.k(-16777216, 76)));
        ...
        this.v = true;
        xi0Var.K(69);
        aj0Var.setOnClickListener(new ct(24, this, xi0Var));
    ...
    public final void d() {
        ...
        if (this.x + (!z10 ? 1 : 0) == this.n) {
            q2Var.setTranslationX((-this.w) * getMeasuredWidth());
        } else {
            q2Var.setTranslationX((1.0f - this.w) * getMeasuredWidth());
        }
    }
