        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.singleIcon != null) {
                if (this.singleIconBackgroundAlphaPercent > 20) {
                    ...
                    this.whiteCirclePaint.setAlpha((int) ((this.singleIconBackgroundAlphaPercent * NotificationCenter.didReceiveSmsCode) / 100.0f));
            ...
            if (i3 == i2 && i > 0 && i != i2) {
                ...
                this.selectedIcon.setAlpha(NotificationCenter.didReceiveSmsCode);
