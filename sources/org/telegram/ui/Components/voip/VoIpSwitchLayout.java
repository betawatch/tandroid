    ...
    public void setType(Type type, boolean z, boolean z2) {
        ...
        if (ordinal == 0) {
            if (this.type != Type.MICRO) {
                ...
                voIpButtonView.unSelectedIcon = new RLottieDrawable(i, "" + i, dp, dp, true, null);
                this.voIpButtonView.selectedIcon = new RLottieDrawable(i, "" + i, dp, dp, true, null);
            ...
            if (ordinal == 1) {
                ...
                if (type2 == Type.SPEAKER || type2 == Type.BLUETOOTH) {
                    ...
                    voIpButtonView2.singleIcon = new RLottieDrawable(i2, "" + i2, dp, dp, true, null);
                ...
                voIpButtonView3.unSelectedIcon = new RLottieDrawable(i3, "" + i3, dp, dp, true, null);
                this.voIpButtonView.selectedIcon = new RLottieDrawable(i3, "" + i3, dp, dp, true, null);
                this.voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
                this.voIpButtonView.selectedIcon.setMasterParent(this.voIpButtonView);
            }
            if (!z3) {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.singleIcon != null) {
                if (this.singleIconBackgroundAlphaPercent > 20) {
                    ...
                    this.whiteCirclePaint.setAlpha((int) ((this.singleIconBackgroundAlphaPercent * NotificationCenter.invalidateMotionBackground) / 100.0f));
            ...
            if (i3 == i2 && i > 0 && i != i2) {
                ...
                this.selectedIcon.setAlpha(NotificationCenter.invalidateMotionBackground);
