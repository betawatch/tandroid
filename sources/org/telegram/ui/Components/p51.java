...
public final class p51 extends IUpdateLayout {
    ...
    public final void createUpdateUI(int i9) {
        ...
        this.a.setBackground(org.telegram.ui.ActionBar.f6.f0(1090519039, 2, -1));
        viewGroup.addView(this.a, g7.e6.e(-1, 44, 83));
        this.a.setOnClickListener(new gh.z0(this, i9, 13));
    ...
    public final void updateAppUpdateViews(int i9, boolean z10) {
        ...
        if (ApplicationLoader.applicationLoaderInstance.getUpdate() == null) {
            ...
            this.a.setTag(null);
            if (z10) {
                this.a.animate().translationY(AndroidUtilities.dp(44.0f)).setInterpolator(gr.g).setListener(new y11(this, 3)).setDuration(180L).start();
                return;
            } else {
                this.a.setTranslationY(AndroidUtilities.dp(44.0f));
        ...
        this.a.setTag(1);
        if (z10) {
            this.a.animate().translationY(0.0f).setInterpolator(gr.g).setListener(null).setDuration(180L).start();
        } else {
