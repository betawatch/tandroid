...
public class ForumBubbleDrawable extends Drawable {
    ...
    public int moveNexColor() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Forum.ForumBubbleDrawable$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ForumBubbleDrawable.$r8$lambda$t7ykXJ1ZJltEB92dqdNclhQwIV0(ForumBubbleDrawable.this, iArr2, valueAnimator);
            }
        });
    ...
    public static /* synthetic */ void $r8$lambda$t7ykXJ1ZJltEB92dqdNclhQwIV0(ForumBubbleDrawable forumBubbleDrawable, int[] iArr, ValueAnimator valueAnimator) {
        forumBubbleDrawable.getClass();
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        Paint paint = new Paint(1);
        LinearGradient linearGradient = new LinearGradient(0.0f, 100.0f, 0.0f, 0.0f, new int[]{ColorUtils.blendARGB(iArr[0], forumBubbleDrawable.currentColors[0], floatValue), ColorUtils.blendARGB(iArr[1], forumBubbleDrawable.currentColors[1], floatValue)}, (float[]) null, Shader.TileMode.CLAMP);
        ...
        forumBubbleDrawable.topPaint.setColor(ColorUtils.blendARGB(ColorUtils.blendARGB(iArr[1], forumBubbleDrawable.currentColors[1], floatValue), -1, 0.1f));
        forumBubbleDrawable.strokePaint.setColor(ColorUtils.blendARGB(ColorUtils.blendARGB(iArr[0], forumBubbleDrawable.currentColors[0], floatValue), -16777216, 0.1f));
