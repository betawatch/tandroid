...
public class m81 extends FrameLayout {
    ...
    */
                ...
                if (motionEvent != null && motionEvent.getAction() == 0 && !this.E && !this.F) {
                    ...
                    if (this.E) {
                        ...
                        if (this.d < 0) {
                            ...
                            ofFloat.addUpdateListener(new a81(this, i10));
                        ...
                        this.w.addListener(new b81(this, i10));
                        this.w.start();
                        this.x = true;
                        this.E = false;
                        w(false);
    ...
    public final void D(int i10) {
        if (i10 != this.b) {
            ...
            if (valueAnimator == null || this.d != i10) {
                ...
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.N = ofFloat;
                ofFloat.addUpdateListener(new a81(this, i11));
                this.N.addListener(new b81(this, i11));
    ...
    public final l81 n(int i10, boolean z4) {
        c81 c81Var = new c81(this, getContext(), z4, i10, this.a);
        this.J = c81Var;
        c81Var.r = G();
    ...
    public void setAdapter(e81 e81Var) {
        ...
        e81Var.b(viewArr[0], this.b, iArr[0]);
        addView(viewArr[0]);
        viewArr[0].setVisibility(0);
        o(false);
    }
