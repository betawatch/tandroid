        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.f) {
                    ...
                    if (y71Var5 != null) {
                        float f16 = this.b;
                        ChatActivityEnterView chatActivityEnterView = ((ue) y71Var5).a;
                ...
                if (this.h) {
                    ...
                    if (y71Var6 != null) {
                        float f22 = this.c;
                        ChatActivityEnterView chatActivityEnterView2 = ((ue) y71Var6).a;
