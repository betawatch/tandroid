...
public final class id0 extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r6v2, types: [android.view.View, android.widget.EditText, android.widget.TextView, dg.b, org.telegram.ui.Components.EditTextBoldCursor, org.telegram.ui.Components.wt] */
    public final void b(ArrayList arrayList, boolean z4, boolean z10, boolean z11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (b10 == 0) {
                ...
                ?? hd0Var = new hd0(getContext());
                hd0Var.setBackgroundColor(0);
                hd0Var.setPadding(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f));
                hd0Var.setTextSize(0, mediaEntity.fontSize);
                hd0Var.setTypeface(mediaEntity.textTypeface.d());
                SpannableString spannableString = new SpannableString(Emoji.replaceEmoji(mediaEntity.text, hd0Var.getPaint().getFontMetricsInt(), false));
                ...
                while (i13 < size2) {
                    ...
                    u5 u5Var = new u5(emojiEntity2.document_id, hd0Var.getPaint().getFontMetricsInt());
                ...
                hd0Var.setText(spannableString);
                int i15 = 17;
                ...
                hd0Var.setTextAlignment(i11);
                hd0Var.setHorizontallyScrolling(false);
                hd0Var.setImeOptions(TLObject.FLAG_28);
                hd0Var.setFocusableInTouchMode(true);
                hd0Var.setEnabled(false);
                hd0Var.setInputType(hd0Var.getInputType() | 16384);
                if (i17 >= 23) {
                    hd0Var.setBreakStrategy(0);
                }
                hd0Var.setShadowLayer(0.0f, 0.0f, 0.0f, 0);
                int i20 = mediaEntity.color;
                byte b11 = mediaEntity.subType;
                if (b11 == 0) {
                    hd0Var.setFrameColor(i20);
                    i20 = AndroidUtilities.computePerceivedBrightness(mediaEntity.color) >= 0.721f ? -16777216 : -1;
                } else if (b11 == 1) {
                    hd0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -1728053248 : -1711276033);
                } else if (b11 == 2) {
                    hd0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -16777216 : -1);
                } else {
                    hd0Var.setFrameColor(0);
                }
                hd0Var.setTextColor(i20);
                hd0Var.setCursorColor(i20);
                hd0Var.setHandlesColor(i20);
                hd0Var.setHighlightColor(org.telegram.ui.ActionBar.j6.l1(0.4f, i20));
                mediaEntity.view = hd0Var;
                p9Var = hd0Var;
            } else {
                p9Var = null;
            }
