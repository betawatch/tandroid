    ...
    public final org.telegram.ui.lu0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z4, boolean z10) {
        ...
        if (i10 >= 0 && i10 < this.a.size() && x(i10) && (photoEntry = (MediaController.PhotoEntry) this.a.get(i10)) != null) {
            ...
            if (omVar != null && nmVar != null) {
                ...
                lu0Var.b = iArr[0];
                lu0Var.c = iArr[1] + ((int) omVar.a);
                lu0Var.k = 1.0f;
                lu0Var.d = pmVar;
                ImageReceiver imageReceiver = nmVar.c;
                lu0Var.a = imageReceiver;
                lu0Var.e = imageReceiver.getBitmapSafe();
                lu0Var.h = new int[]{(int) r8.left, (int) r8.top, (int) r8.right, (int) r8.bottom};
                RectF rectF = nmVar.q;
                lu0Var.j = (int) (-pmVar.getY());
                lu0Var.i = pmVar.getHeight() - ((int) (((-pmVar.getY()) + qmVar.r.getHeight()) - qmVar.b.l1()));
                return lu0Var;
            }
        }
        return null;
