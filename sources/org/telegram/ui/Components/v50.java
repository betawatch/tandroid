...
public final class v50 implements Runnable {
    ...
    public static void a(v50 v50Var, boolean z10) {
        ...
        try {
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(v50Var.H0.a).roundAudioBitrate * 1024);
    ...
    public static void b(v50 v50Var, int i10, q50 q50Var) {
        ...
        if (i10 != 1 || (((videoEditedInfo = v50Var.H0.N) != null && videoEditedInfo.needConvert()) || v50Var.H0.c.c())) {
            z10 = true;
        } else {
            if (!v50Var.G0) {
                v50Var.G0 = true;
        ...
        if (i10 == 0) {
            FileLoader.getInstance(v50Var.H0.a).cancelFileUpload(v50Var.a.getAbsolutePath(), false);
            try {
                v50Var.b.delete();
    ...
    public final void c(i50 i50Var, long j3, boolean z10) {
        ...
        int i10 = w50Var.a;
        if (!this.h) {
            FileLoader.getInstance(i10).checkUploadNewDataAvailable(i50Var.toString(), w50Var.M, j3, z10 ? i50Var.length() : 0L);
            return;
        }
