...
public final class v50 implements Runnable {
    ...
    public static void a(v50 v50Var, boolean z10) {
        ...
        try {
            ...
            for (int i12 = 0; i12 < 3; i12++) {
                v50Var.z0.add(new k50());
            }
            if (z10) {
                v50Var.g0 = v50Var.d0 + v50Var.e0;
                v50Var.k0 = v50Var.i0 + v50Var.j0;
                v50Var.Q = true;
                j3 = 0;
            } else {
                v50Var.g0 = -1L;
            ...
            v50Var.y0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + v50Var.y0.getChannelCount() + " sample rate = " + v50Var.y0.getSampleRate() + " bufferSize = " + i11);
            }
            v50Var.D0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(v50Var.H0.f).roundAudioBitrate * 1024);
            ...
            v50Var.F.start();
            v50Var.E = MediaCodec.createEncoderByType(MediaController.VIDEO_MIME_TYPE);
            v50Var.H = true;
            MediaFormat createVideoFormat = MediaFormat.createVideoFormat(MediaController.VIDEO_MIME_TYPE, v50Var.d, v50Var.e);
            createVideoFormat.setInteger("color-format", 2130708361);
            createVideoFormat.setInteger("bitrate", v50Var.f);
            createVideoFormat.setInteger("frame-rate", 30);
            createVideoFormat.setInteger("i-frame-interval", 1);
            v50Var.E.configure(createVideoFormat, (Surface) null, (MediaCrypto) null, 1);
            v50Var.r = v50Var.E.createInputSurface();
            v50Var.E.start();
            if (!z10) {
                boolean isSdCardPath = ImageLoader.isSdCardPath(v50Var.a);
                v50Var.b = v50Var.a;
                if (isSdCardPath) {
                    try {
                ...
                mp4Movie.setCacheFile(v50Var.b);
            ...
            if (v50Var.v == EGL14.EGL_NO_CONTEXT) {
                ...
                if (!EGL14.eglChooseConfig(v50Var.s, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, EglBase.EGL_RECORDABLE_ANDROID, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                    throw new RuntimeException("Unable to find a suitable EGLConfig");
                }
                i10 = 0;
                v50Var.v = EGL14.eglCreateContext(v50Var.s, eGLConfigArr[0], v50Var.w, new int[]{12440, 2, 12344}, 0);
                v50Var.x = eGLConfigArr[0];
            } else {
                i10 = 0;
            }
            EGL14.eglQueryContext(v50Var.s, v50Var.v, 12440, new int[1], i10);
            if (v50Var.y != EGL14.EGL_NO_SURFACE) {
                throw new IllegalStateException("surface already created");
            }
            EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(v50Var.s, v50Var.x, v50Var.r, new int[]{12344}, i10);
            v50Var.y = eglCreateWindowSurface;
            if (eglCreateWindowSurface == null) {
                throw new RuntimeException("surface was null");
            }
            if (!EGL14.eglMakeCurrent(v50Var.s, eglCreateWindowSurface, eglCreateWindowSurface, v50Var.v)) {
                if (BuildVars.LOGS_ENABLED) {
            ...
            v50Var.x0 = new c50(v50Var.d, v50Var.e);
            ...
            int j10 = c60.j(v50Var.H0, 35633, "uniform mat4 uMVPMatrix;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n   gl_Position = uMVPMatrix * aPosition;\n   vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}\n");
            int j11 = c60.j(v50Var.H0, 35632, str);
            if (j10 == 0 || j11 == 0) {
                return;
            }
            ...
            GLES20.glAttachShader(v50Var.m0, j11);
            ...
            v50Var.p0 = GLES20.glGetAttribLocation(v50Var.m0, "aPosition");
            v50Var.q0 = GLES20.glGetAttribLocation(v50Var.m0, "aTextureCoord");
            v50Var.s0 = GLES20.glGetUniformLocation(v50Var.m0, "preview");
            v50Var.r0 = GLES20.glGetUniformLocation(v50Var.m0, "resolution");
            v50Var.u0 = GLES20.glGetUniformLocation(v50Var.m0, "alpha");
    ...
    public static void b(v50 v50Var, int i10, q50 q50Var) {
        ...
        if (i10 != 1 || (((videoEditedInfo = v50Var.H0.S) != null && videoEditedInfo.needConvert()) || v50Var.H0.n.c())) {
            z10 = true;
        } else {
            if (!v50Var.G0) {
                v50Var.G0 = true;
        ...
        if (i10 == 0) {
            FileLoader.getInstance(v50Var.H0.f).cancelFileUpload(v50Var.a.getAbsolutePath(), false);
            try {
                v50Var.b.delete();
            ...
            if (z10 && (i10 != 1 || !v50Var.G0)) {
                v50Var.G0 = true;
                AndroidUtilities.runOnUIThread(new xm(v50Var, i10, q50Var, 7));
            }
            AndroidUtilities.runOnUIThread(new r50(v50Var, 2));
        }
        EGL14.eglDestroySurface(v50Var.s, v50Var.y);
        v50Var.y = EGL14.EGL_NO_SURFACE;
        Surface surface = v50Var.r;
        if (surface != null) {
            surface.release();
            v50Var.r = null;
        }
        EGLDisplay eGLDisplay = v50Var.s;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            EGL14.eglDestroyContext(v50Var.s, v50Var.v);
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(v50Var.s);
        }
        v50Var.s = EGL14.EGL_NO_DISPLAY;
    ...
    public final void c(j50 j50Var, long j3, boolean z10) {
        ...
        int i10 = c60Var.f;
        if (!this.h) {
            FileLoader.getInstance(i10).checkUploadNewDataAvailable(j50Var.toString(), c60Var.R, j3, z10 ? j50Var.length() : 0L);
            return;
        }
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, (Property<LinearLayout, Float>) property, 0.0f), ObjectAnimator.ofInt(c60Var.r, s6.b, 0), ObjectAnimator.ofFloat(c60Var.G, (Property<ImageView, Float>) property, 1.0f));
