        ...
        if (this.n && VoIPService.getSharedInstance() == null) {
            ...
            if (type == 8) {
                ...
                if (sensor6 == sensor5) {
                    ...
                    j10 = 0;
                    c10 = 0;
                    float f12 = (float) ((fArr4[0] * d9) + (fArr2[0] * d));
                    fArr2[0] = f12;
                    sensor = sensor3;
                    float f13 = (float) ((fArr4[c12] * d9) + (fArr2[c12] * d));
                    fArr2[c12] = f13;
                    float f14 = (float) ((d9 * fArr4[c11]) + (d * fArr2[c11]));
                    fArr2[c11] = f14;
            ...
            if (sensor7 == sensor4 || sensor7 == sensor2 || sensor7 == sensor5) {
                ...
                if (i11 != 6 && ((f18 > 0.0f && this.H > 0.0f) || (f18 < 0.0f && this.H < 0.0f))) {
                    ...
                    if (i12 != 0 && i12 != i9) {
                    ...
                    } else if (z10 && i11 == 0 && (i12 == 0 || i12 == i9)) {
                        int i15 = this.x;
                        if (i15 < 6 && !this.E) {
                            this.y = i9;
                            int i16 = i15 + 1;
                        ...
                        if (i12 != i9 || this.B == 10 || this.x != 6 || i11 != 0) {
                            this.A = 0;
                            this.x = 0;
                            this.y = 0;
                            this.B = 0;
