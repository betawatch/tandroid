    ...
    public final void draw(Canvas canvas) {
        switch (this.a) {
            case 0:
                fd fdVar = (fd) this.c;
                if (fdVar.c <= 1) {
                    fdVar.c(canvas, (Paint) this.b);
                    break;
                } else {
                    fdVar.c(canvas, fdVar.o);
                    break;
                }
            case 1:
                ...
                if (chatActivityEnterView.U0 != null) {
                    ...
                    canvas.drawRect(0.0f, 0.0f, width, y3 + (pfVar == null ? 0.0f : pfVar.getOffsetY()), paint);
                    break;
                }
                break;
            case 2:
            ...
            default:
                ...
                int imageHeight = (int) ((((imageReceiver.getImageHeight() / 2.0f) - intrinsicHeight) + imageReceiver.getImageY()) - ((1.0f - qr.k.getInterpolation(imageReceiver.getCurrentAlpha())) * AndroidUtilities.dp(16.0f)));
