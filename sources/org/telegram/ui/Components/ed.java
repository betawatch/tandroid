...
public final /* synthetic */ class ed implements Runnable {
    ...
    public /* synthetic */ ed(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.a = i10;
    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 5:
                ...
                if (!chatActivityEnterView.e2 && i11 != 0 && (bfVar = chatActivityEnterView.A0) != null) {
                    try {
                        bfVar.requestFocus();
                        break;
                    } catch (Exception e9) {
            ...
            case 6:
                ...
                if (qfVar != null) {
                    if (chatActivityEnterView.Y4 == null) {
                        qfVar.getLayoutParams().height = chatActivityEnterView.y3;
                    }
            ...
            case 7:
                ...
                if (yeVar != null) {
                    yeVar.h(chatActivityEnterView.z4);
            ...
            case 28:
                ...
                nh.q4 b10 = nh.q4.b(i20, j10, j10, str, str2, 2, 0, rnVar5 == null ? 0L : rnVar5.N8(), null, false, null, null, 0, false, false);
                LaunchActivity launchActivity = LaunchActivity.C1;
                if (launchActivity != null && launchActivity.P() != null && LaunchActivity.C1.P().k(b10) != null) {
                    nh.a0 a0Var2 = chatActivityEnterView.h0;
                    if (a0Var2 != null) {
                        a0Var2.setOpened(false);
                        break;
                    }
                } else if (!org.telegram.ui.ob0.l(chatActivityEnterView.f0)) {
                    ...
                    if (!TextUtils.isEmpty(restrictionReason)) {
                        ...
                        b3Var.s(rnVar5, b10);
                        b3Var.show();
                        nh.a0 a0Var3 = chatActivityEnterView.h0;
                        if (a0Var3 != null) {
                    ...
                    we.d dVar = new we.d();
                    dVar.c = new ed(chatActivityEnterView, i11);
                    we.e.k(chatActivityEnterView.getContext(), chatActivityEnterView.f0, false, false, dVar);
                    break;
                }
                break;
            default:
