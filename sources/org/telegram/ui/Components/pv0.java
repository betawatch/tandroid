...
public class pv0 extends FrameLayout implements org.telegram.ui.ActionBar.y5 {
    ...
    public final void I() {
        ...
        if (this.v == null) {
            ...
            this.v = k81Var2;
            k81Var2.n = new mv(this, 21);
            if (getMeasuredWidth() != 0 && getMeasuredHeight() != 0) {
                k81 k81Var3 = this.v;
                int measuredWidth = getMeasuredWidth();
                int measuredHeight = getMeasuredHeight();
                k81Var3.getClass();
                this.y = k81.a(measuredWidth, measuredHeight);
            }
        }
        if (this.F) {
            return;
    ...
    public void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        K(canvas, f7, rect, paint, z10, Color.alpha(org.telegram.ui.ActionBar.h6.v0((F() && SharedConfig.getDevicePerformanceClass() == 2) ? org.telegram.ui.ActionBar.h6.xf : org.telegram.ui.ActionBar.h6.yf, getResourceProvider())));
    }
    ...
    */
        ...
        if (!F()) {
            ...
            if (this.d0.getShader() != null) {
                ...
                if (z10) {
                    ...
                    lv0 lv0Var = this.Q;
                    matrix.preScale(lv0Var.d, lv0Var.e);
                    if (this.R != null) {
                        matrix2.setTranslate(0.0f, (f14 - r6.a) - 34.0f);
                        lv0 lv0Var2 = this.R;
                        matrix2.preScale(lv0Var2.d, lv0Var2.e);
                    }
                } else {
                    this.Q.getClass();
                    float f15 = (-f13) + 0.0f;
    ...
    public void S() {
        if (this.v != null) {
            this.y = k81.a(getMeasuredWidth(), getMeasuredHeight());
        }
        ...
        post(new sr0(1, this, point.x > point.y));
    }
    ...
    public final void W() {
        if (!this.O || this.P || !this.h0 || !SharedConfig.chatBlurEnabled() || F() || Color.alpha(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.yf, false)) == 255) {
            return;
        }
        int measuredWidth = getMeasuredWidth();
        ...
        lv0 lv0Var = arrayList.size() > 0 ? (lv0) hg.c.z(1, arrayList) : null;
        if (lv0Var == null) {
            lv0Var = new lv0();
            lv0Var.c = Bitmap.createBitmap(i11, i10, Bitmap.Config.ARGB_8888);
            lv0Var.b = new nv0(lv0Var.c);
        } else {
            lv0Var.c.eraseColor(0);
        }
        float width = lv0Var.c.getWidth() / f10;
        float height = (lv0Var.c.getHeight() - 34) / f7;
        int save = lv0Var.b.save();
        lv0Var.a = getScrollOffset() % 24;
        float f11 = 10.0f * height;
        lv0Var.b.clipRect(1.0f, f11, lv0Var.c.getWidth(), lv0Var.c.getHeight() - 1);
        lv0Var.b.scale(width, height);
        lv0Var.b.translate(0.0f, f11 + lv0Var.a);
        lv0Var.d = 1.0f / width;
        lv0Var.e = 1.0f / height;
        L(lv0Var.b, null);
        try {
            lv0Var.b.restoreToCount(save);
        } catch (Exception e) {
            FileLog.e(e);
        }
        System.currentTimeMillis();
    ...
    public int getBackgroundSizeY() {
        return getMeasuredHeight() - (this.b instanceof org.telegram.ui.ao ? this.E : 0);
    }
    ...
    public void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            if (arrayList.get(i10) != null) {
                ((lv0) arrayList.get(i10)).c.recycle();
            }
            i10++;
        }
        arrayList.clear();
