...
public final class pv0 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public pv0(Context context, ov0 ov0Var, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        cg0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false));
        ...
        cg0Var.addView(textView, w7.y5.e(-2, -1, 51));
        ...
        cg0Var.addView(linearLayout, w7.y5.e(-2, -1, 53));
        ...
        cg0Var.setBackgroundColor(getThemedColor(i10));
        this.containerView.addView(cg0Var, w7.y5.e(-1, 48, 83));
        ...
        final int i13 = 0;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mv0
        ...
        final int i14 = 1;
        linearLayout.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mv0
            public final /* synthetic */ pv0 b;
