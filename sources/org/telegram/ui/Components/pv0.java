...
public class pv0 extends FrameLayout implements org.telegram.ui.ActionBar.b6 {
    ...
    public void J(Canvas canvas, float f10, Rect rect, Paint paint, boolean z4) {
        K(canvas, f10, rect, paint, z4, Color.alpha(org.telegram.ui.ActionBar.k6.v0((F() && SharedConfig.getDevicePerformanceClass() == 2) ? org.telegram.ui.ActionBar.k6.xf : org.telegram.ui.ActionBar.k6.yf, getResourceProvider())));
    }
    ...
    */
    ...
    public void S() {
        ...
        post(new kh.f(29, this, point.x > point.y));
    }
    ...
    public final void W() {
        if (!this.L || this.M || !this.e0 || !SharedConfig.chatBlurEnabled() || F() || Color.alpha(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.yf, false)) == 255) {
            return;
        }
        int measuredWidth = getMeasuredWidth();
        ...
        lv0 lv0Var = arrayList.size() > 0 ? (lv0) e2.c.g(1, arrayList) : null;
        if (lv0Var == null) {
            lv0Var = new lv0();
        ...
        float width = lv0Var.c.getWidth() / f11;
        float height = (lv0Var.c.getHeight() - 34) / f10;
        int save = lv0Var.b.save();
        lv0Var.a = getScrollOffset() % 24;
        float f12 = 10.0f * height;
        lv0Var.b.clipRect(1.0f, f12, lv0Var.c.getWidth(), lv0Var.c.getHeight() - 1);
        lv0Var.b.scale(width, height);
        lv0Var.b.translate(0.0f, f12 + lv0Var.a);
        lv0Var.d = 1.0f / width;
        ...
        int max = (int) (((int) (Math.max(6, Math.max(dp, measuredWidth) / 180) * 2.5f)) * org.telegram.ui.l5.d);
    ...
    public int getBackgroundSizeY() {
        return getMeasuredHeight() - (this.b instanceof org.telegram.ui.ao ? this.B : 0);
    }
