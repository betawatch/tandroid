...
public final class bt0 implements xm0 {
    ...
    public final boolean m1(int i10, View view) {
        ...
        if (n2Var != null && jv0.d0(i10, jv0Var.d1 instanceof TLRPC.TL_channelFull) != null) {
            if (jv0Var.d1 instanceof TLRPC.TL_channelFull) {
                if (ChatObject.canUserDoAction(n2Var.getMessagesController().getChat(Long.valueOf(jv0Var.d1.id)), 5)) {
            ...
            } else if (jv0Var.j1 == n2Var.getUserConfig().getClientUserId() && (userFull = jv0Var.e1) != null) {
                profileTab = userFull.main_tab;
                if (profileTab != null) {
                }
                v70 H2 = v70.H(n2Var, view);
    ...
    public final void y0(float f7) {
        ...
        if (f7 != 1.0f || cu0VarArr[1].getVisibility() == 0) {
            ...
            if (v0Var == null || jv0Var.D()) {
                ...
                v0Var.setVisibility(jv0Var.v0() ? 8 : 4);
                jv0Var.o0 = 0.0f;
            }
            jv0Var.q1(false);
            if (f7 == 1.0f) {
