...
public final class gk extends ol0 {
    public long B;
    public long C;
    public int D;
    public String F;
    ...
    public final View T(int i10, View view) {
        ...
        if (u3Var == null) {
            ...
            hk hkVar = this.U;
            u3Var = new org.telegram.ui.Cells.u3(context, hkVar.a);
            u3Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.e7, hkVar.a) & (-218103809));
        }
    ...
    public final void W(int i10, int i11, f2.l1 l1Var) {
        ...
        if (i13 == 1 || i13 == 4) {
            ...
            if (i10 == 0) {
                ...
                int i15 = akVar.a;
                if (i15 != 0) {
                    i7Var.d(false, akVar.b, i15, akVar.c, null, null);
                } else {
                    i7Var.d(false, akVar.b, 0, akVar.c, akVar.d.toUpperCase().substring(0, Math.min(akVar.d.length(), 4)), akVar.e);
                }
                File file = akVar.f;
                hk hkVar = this.U;
                if (file != null) {
            ...
            i7Var.getViewTreeObserver().addOnPreDrawListener(new fk(this, i7Var, messageObject, z10, 0));
        }
    }
    ...
    public final void Y(String str, boolean z4) {
        ...
        zj zjVar = hkVar.v;
        vj vjVar = hkVar.r;
        org.telegram.ui.hp hpVar = this.w;
        if (hpVar != null) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            org.telegram.ui.hp hpVar2 = new org.telegram.ui.hp(26, this, str);
            this.w = hpVar2;
    ...
    */
    public final void a0(ArrayList arrayList, ArrayList arrayList2, boolean z4) {
        ...
        if ((z11 || z14 || !z4) && z14) {
            ...
            if (arrayList != null || arrayList2 != null) {
                ...
                if (z10 || g0Var.getTag() == null) {
                    ...
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(vjVar, (Property<vj, Float>) property, !z10 ? AndroidUtilities.dp(44.0f) : 0.0f), ObjectAnimator.ofFloat(g0Var, (Property<tf.g0, Float>) property, !z10 ? 0.0f : -AndroidUtilities.dp(44.0f)), ObjectAnimator.ofFloat(hkVar.G, (Property<t00, Float>) property, !z10 ? AndroidUtilities.dp(44.0f) : 0.0f), ObjectAnimator.ofFloat(hkVar.I, (Property<nh.y4, Float>) property, z10 ? AndroidUtilities.dp(44.0f) : 0.0f));
                    hkVar.F.addListener(new a9(this, 7));
                    hkVar.F.setInterpolator(nr.g);
        ...
        animatorSet22.playTogether(ObjectAnimator.ofFloat(vjVar2, (Property<vj, Float>) property2, !z10 ? AndroidUtilities.dp(44.0f) : 0.0f), ObjectAnimator.ofFloat(g0Var, (Property<tf.g0, Float>) property2, !z10 ? 0.0f : -AndroidUtilities.dp(44.0f)), ObjectAnimator.ofFloat(hkVar.G, (Property<t00, Float>) property2, !z10 ? AndroidUtilities.dp(44.0f) : 0.0f), ObjectAnimator.ofFloat(hkVar.I, (Property<nh.y4, Float>) property2, z10 ? AndroidUtilities.dp(44.0f) : 0.0f));
        hkVar.F.addListener(new a9(this, 7));
        hkVar.F.setInterpolator(nr.g);
        hkVar.F.setDuration(180L);
        hkVar.F.start();
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
                    t00 t00Var = new t00(context, hkVar.a);
            ...
            org.telegram.ui.Cells.i7 i7Var = new org.telegram.ui.Cells.i7(context, i10 == 1 ? 1 : 2, hkVar.a);
