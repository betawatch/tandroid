...
public final class ro0 {
    ...
    */
    public final void c(Canvas canvas, org.telegram.ui.Cells.t1 t1Var) {
        ...
        if (fArr3 == null || (fArr2 = this.I) == null) {
            ...
            if (this.G != null) {
                ...
                while (true) {
                    ...
                    a(this.x, dpf22, com.google.android.gms.internal.vision.e2.a(1.0f, a2, AndroidUtilities.dpf2(1.0f), AndroidUtilities.dpf2(this.G[z10 ? (r3.length - 1) - i13 : i13]) * a2));
                    i13++;
                }
            }
            f11 = 0.0f;
        ...
        canvas.restore();
        if (this.M == null) {
            this.M = new qo0(new kc0(this, 26));
        }
        float f19 = this.K;
        if (f19 < 0.99f && (fArr = this.G) != null) {
            ...
            if (i18 >= 0 && i18 < fArr.length) {
                ...
                qo0Var = this.M;
                ((Paint) qo0Var.f).setColor(this.q);
                qo0Var.g = rectF;
                float f22 = this.L;
                Paint paint = (Paint) qo0Var.f;
                ArrayList arrayList2 = (ArrayList) qo0Var.e;
                arrayList = (ArrayList) qo0Var.d;
                long currentTimeMillis = System.currentTimeMillis();
                long min2 = Math.min(20L, currentTimeMillis - qo0Var.b);
                qo0Var.b = currentTimeMillis;
                i11 = 0;
                while (i11 < arrayList.size()) {
                    po0 po0Var = (po0) arrayList.get(i11);
                    float f23 = min2;
                    float f24 = po0Var.f - (f23 / po0Var.g);
                    po0Var.f = f24;
                    if (f24 < 0.0f) {
                        arrayList2.add(po0Var);
                        ...
                        float f26 = po0Var.d;
                        float f27 = po0Var.c;
                        po0Var.a = (((f26 * f27) * f23) / 500.0f) + f25;
                        float f28 = po0Var.b;
                        float f29 = po0Var.e;
                        po0Var.b = (((f27 * f29) * f23) / 500.0f) + f28;
                        po0Var.e = f29 - ((AndroidUtilities.dp(0.33f) * min2) / 500.0f);
                    }
                    i11++;
                }
                if (((RectF) qo0Var.g) != null) {
                    int min3 = Math.min(4, qo0Var.a - arrayList.size());
                    for (int i19 = 0; i19 < min3; i19++) {
                        po0 po0Var2 = arrayList2.isEmpty() ? new po0() : (po0) arrayList2.remove(0);
                        RectF rectF2 = (RectF) qo0Var.g;
                        po0Var2.a = (Utilities.random.nextFloat() * rectF2.width()) + rectF2.left;
                        RectF rectF3 = (RectF) qo0Var.g;
                        po0Var2.b = (Utilities.random.nextFloat() * rectF3.height()) + rectF3.top;
                        double nextInt = (Utilities.random.nextInt(200) - 125) * 0.017453292519943295d;
                        po0Var2.d = ((float) (Math.cos(nextInt) - Math.sin(nextInt))) * 0.8f;
                        po0Var2.e = ((float) (Math.cos(nextInt) + Math.sin(nextInt))) - 0.2f;
                        po0Var2.f = 1.0f;
                        po0Var2.c = AndroidUtilities.dp((Utilities.random.nextFloat() * 7.0f) + 10.0f);
                        po0Var2.g = AndroidUtilities.lerp(420, 550, Utilities.random.nextFloat());
                        arrayList.add(po0Var2);
                    }
                }
                for (i12 = 0; i12 < arrayList.size(); i12++) {
                    po0 po0Var3 = (po0) arrayList.get(i12);
                    paint.setAlpha((int) (255.0f * f22 * po0Var3.f));
                    canvas.drawPoint(po0Var3.a, po0Var3.b, paint);
                }
                kc0Var = (kc0) qo0Var.c;
                if (kc0Var == null) {
                    kc0Var.run();
        ...
        qo0Var.g = rectF;
        float f222 = this.L;
        Paint paint2 = (Paint) qo0Var.f;
        ArrayList arrayList22 = (ArrayList) qo0Var.e;
        arrayList = (ArrayList) qo0Var.d;
        long currentTimeMillis2 = System.currentTimeMillis();
        long min22 = Math.min(20L, currentTimeMillis2 - qo0Var.b);
        qo0Var.b = currentTimeMillis2;
        i11 = 0;
        while (i11 < arrayList.size()) {
        }
        if (((RectF) qo0Var.g) != null) {
