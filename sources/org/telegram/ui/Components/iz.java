...
public final class iz extends ul0 {
    ...
    public final int F(int i10) {
        ...
        if (i14 == Integer.MIN_VALUE) {
            ...
            if (obj2 instanceof String) {
                return "premium".equals(obj2) ? rzVar.I1 : "recent".equals(obj2) ? rzVar.F1 : rzVar.G1;
            }
    ...
    */
    public final void G() {
        ...
        int measuredWidth = rzVar2.getMeasuredWidth();
        if (measuredWidth == 0) {
            measuredWidth = AndroidUtilities.displaySize.x;
        }
        ...
        int i14 = 0;
        this.s = 0;
        ArrayList arrayList2 = rzVar2.d1;
        int i15 = -5;
        int i16 = -5;
        int i17 = 0;
        boolean z10 = false;
            ...
            if (i16 == i15) {
                ...
                if (i16 == -4) {
                    ...
                    if (i10 == -3) {
                        ...
                        arrayList = rzVar2.j1;
                        if (!arrayList.isEmpty() && !rzVar2.M2) {
                            z10 = true;
                        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 == 0) {
            ...
            g8Var.setRecent(rzVar.j1.contains(document));
            return;
        }
        ...
        if (i12 == 1) {
            ...
            if (obj instanceof TLRPC.TL_messages_stickerSet) {
                ...
                arrayList = "recent".equals(obj) ? rzVar.j1 : rzVar.k1;
            }
            if (arrayList == null) {
                k3Var.setHeight(1);
                return;
        ...
        if (i10 == rzVar.f1) {
            int i15 = (rzVar.g1 && rzVar.h1 == null) ? 0 : rzVar.h1 != null ? R.drawable.msg_mini_customize : R.drawable.msg_close;
            TLRPC.Chat chat = rzVar.J1 != null ? MessagesController.getInstance(i11).getChat(Long.valueOf(rzVar.J1.id)) : null;
        ...
        if (obj2 instanceof TLRPC.TL_messages_stickerSet) {
            ...
            if (stickerSet != null) {
                ...
                if (tL_messages_stickerSet.set.creator && !rzVar.M2) {
                    p8Var.setEdit(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.hz
                ...
                p8Var.setHeaderOnClick(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.hz
                    public final /* synthetic */ iz b;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                view = new fg.g2(z11 ? 1 : 0, context, rzVar.Z1, z10 ? 1 : 0);
                break;
            case 1:
            ...
            case 3:
                ...
                o8Var.addView(textView, w7.a6.t(-1, -2, 51, 17, 4, 17, 0));
                ...
                o8Var.addView(textView2, w7.a6.t(-2, 28, 51, 17, 10, 14, 8));
                o8Var.setAddOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.gz
                    public final /* synthetic */ iz b;
                    ...
                    public final void onClick(View view2) {
                        switch (i11) {
                            case 0:
                                ...
                                sy syVar = rzVar2.t1;
                                if (syVar != null) {
                                    syVar.y(rzVar2.J1.id);
                                    break;
                                }
                                break;
                            case 1:
                                rz rzVar3 = this.b.v;
                                ArrayList<TLRPC.StickerSetCovered> featuredStickerSets = MediaDataController.getInstance(rzVar3.c1).getFeaturedStickerSets();
                                if (!featuredStickerSets.isEmpty()) {
                                    MessagesController.getEmojiSettings(rzVar3.c1).edit().putLong("featured_hidden", featuredStickerSets.get(0).set.id).commit();
                                    iz izVar = rzVar3.y0;
                                    if (izVar != null) {
                                        izVar.t(1, 2);
                                    }
                                ...
                                break;
                            default:
                                org.telegram.ui.ActionBar.p2 p2Var = this.b.v.Y1;
            ...
            case 4:
                ...
                break;
            case 5:
                org.telegram.ui.Cells.p8 p8Var2 = new org.telegram.ui.Cells.p8(this.c, false, false, rzVar.Z1, rzVar.i2);
                p8Var2.setOnIconClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.gz
                    public final /* synthetic */ iz b;
            ...
            case 7:
                ...
                int i13 = org.telegram.ui.ActionBar.j6.Me;
                linearLayout.setBackground(org.telegram.ui.ActionBar.j6.b0(dp, org.telegram.ui.ActionBar.j6.l1(0.12f, rzVar.z(i13))));
                w7.c6.b(linearLayout, 0.1f, 1.5f);
                final int i14 = 2;
                linearLayout.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.gz
                    public final /* synthetic */ iz b;
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(rzVar.z(i13), PorterDuff.Mode.SRC_IN));
                linearLayout.addView(imageView, w7.a6.t(24, 24, 17, 0, 0, 0, 0));
                TextView textView3 = new TextView(context);
                textView3.setGravity(17);
                textView3.setTextColor(rzVar.z(i13));
                textView3.setTextSize(1, 11.0f);
                textView3.setTypeface(AndroidUtilities.bold());
                textView3.setText(LocaleController.getString(R.string.Create));
                linearLayout.addView(textView3, w7.a6.t(-1, -2, 17, 0, 3, 0, 0));
                frameLayout.addView(linearLayout, w7.a6.d(-1, -1.0f, 119, 8.0f, 8.0f, 8.0f, 8.0f));
                view = frameLayout;
                break;
        }
        return new fl0(view);
