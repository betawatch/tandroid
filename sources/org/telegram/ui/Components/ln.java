...
public final class ln extends View {
    ...
    public /* synthetic */ ln(Context context, int i10) {
        super(context);
        this.a = i10;
    }
    ...
    public void onDraw(Canvas canvas) {
        switch (this.a) {
            ...
            case 9:
                super.onDraw(canvas);
                canvas.drawLine(0.0f, AndroidUtilities.dp(14.0f), 2.0f, getMeasuredHeight() - AndroidUtilities.dp(14.0f), org.telegram.ui.ActionBar.h6.k0);
                break;
            case 16:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            case 14:
                ...
                break;
            case 15:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(org.telegram.ui.d60.F3 ? 0.0f : 8.0f), TLObject.FLAG_30));
                break;
            case 20:
