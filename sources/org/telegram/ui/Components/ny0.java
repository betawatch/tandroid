...
public abstract class ny0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final long a() {
        ...
        for (int i10 = 0; i10 < this.b.length; i10++) {
            ...
            my0 my0Var = this.b[i10];
            if (my0Var != null && (my0Var.c || f7 > 0)) {
                if (f7 <= 0) {
                    f7 = my0Var.e;
                }
                j3 += f7;
    ...
    public final void c(boolean z10) {
        ...
        for (int i11 = 0; i11 < my0VarArr.length; i11++) {
            ...
            if (my0Var2 != null && (my0Var2.c || f12 > 0)) {
                this.y++;
            }
            if (my0Var2 == null || (!(z11 = my0Var2.c) && f12 <= 0)) {
                this.d[i11] = 0.0f;
            } else {
                if (f12 <= 0) {
                    f12 = my0Var2.e;
        ...
        if (f10 > 1.0f) {
            float f14 = 1.0f / f10;
            for (int i12 = 0; i12 < my0VarArr.length; i12++) {
                if (my0VarArr[i12] != null) {
                    float[] fArr = this.d;
        ...
        if (!z10) {
            System.arraycopy(this.d, 0, this.c, 0, my0VarArr.length);
            return;
        }
        System.arraycopy(this.c, 0, this.e, 0, my0VarArr.length);
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (my0Var != null) {
                ...
                if (f18 != 0.0f) {
                    if (my0Var.d) {
                        ...
                        my0Var.b.setColor(org.telegram.ui.ActionBar.h6.w0(null, my0Var.a, z11));
            ...
            if (my0Var2 != null) {
                ...
                if (f20 != 0.0f) {
                    if (my0Var2.d) {
                        ...
                        my0Var2.b.setColor(org.telegram.ui.ActionBar.h6.w0(null, my0Var2.a, false));
        ...
        if (this.x != null) {
            ...
            this.w.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.j5, false));
            this.x.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (l4 != null) {
            ...
            int textSize = (int) o6Var2.a.getTextSize();
            int textSize2 = (int) o6Var.a.getTextSize();
