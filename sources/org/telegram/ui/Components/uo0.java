...
public class uo0 extends FrameLayout {
    ...
    */
    public final void a(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = uo0Var.e;
        float f10 = i11 / 2.0f;
        float measuredWidth = uo0Var.getMeasuredWidth() - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(uo0Var.V * 1.0f) / 2.0f;
        if (k0 == null) {
            k0 = new Path();
        }
        k0.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= uo0Var.S.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) uo0Var.S.get(i12)).first).floatValue() >= dp3) {
                break;
            } else {
                i12++;
            }
        ...
        int size = uo0Var.S.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) uo0Var.S.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) uo0Var.S.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) uo0Var.S.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= uo0Var.S.size() - 1 || ((Float) ((Pair) uo0Var.S.get(i13)).first).floatValue() - floatValue > dp3) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) uo0Var.S.get(i13)).first).floatValue();
            }
            c11 = 1;
            ...
            try {
                ...
                for (c61 c61Var : c61VarArr) {
                    if (c61Var != null && c61Var.getURL() != null && c61Var.d != null && c61Var.getURL().startsWith("audio?") && (parseInt = Utilities.parseInt((CharSequence) c61Var.getURL().substring(6))) != null && parseInt.intValue() >= 0) {
                        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(c61Var.d);
    ...
    public uo0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
