...
public final class y50 implements Runnable {
    ...
    public static void a(y50 y50Var, boolean z4) {
        ...
        try {
            ...
            for (int i12 = 0; i12 < 3; i12++) {
                y50Var.w0.add(new o50());
            }
            if (z4) {
                y50Var.d0 = y50Var.a0 + y50Var.b0;
                y50Var.h0 = y50Var.f0 + y50Var.g0;
                y50Var.N = true;
                j10 = 0;
            } else {
                y50Var.d0 = -1L;
            ...
            y50Var.v0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + y50Var.v0.getChannelCount() + " sample rate = " + y50Var.v0.getSampleRate() + " bufferSize = " + i11);
            }
            y50Var.A0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(y50Var.E0.a).roundAudioBitrate * 1024);
            ...
            y50Var.C.start();
            y50Var.B = MediaCodec.createEncoderByType(MediaController.VIDEO_MIME_TYPE);
            y50Var.E = true;
            MediaFormat createVideoFormat = MediaFormat.createVideoFormat(MediaController.VIDEO_MIME_TYPE, y50Var.d, y50Var.e);
            createVideoFormat.setInteger("color-format", 2130708361);
            createVideoFormat.setInteger("bitrate", y50Var.f);
            createVideoFormat.setInteger("frame-rate", 30);
            createVideoFormat.setInteger("i-frame-interval", 1);
            y50Var.B.configure(createVideoFormat, (Surface) null, (MediaCrypto) null, 1);
            y50Var.r = y50Var.B.createInputSurface();
            y50Var.B.start();
            if (!z4) {
                boolean isSdCardPath = ImageLoader.isSdCardPath(y50Var.a);
                y50Var.b = y50Var.a;
                if (isSdCardPath) {
                    try {
                ...
                mp4Movie.setCacheFile(y50Var.b);
                mp4Movie.setRotation(0);
                mp4Movie.setSize(y50Var.d, y50Var.e);
            ...
            if (y50Var.s != EGL14.EGL_NO_DISPLAY) {
                throw new RuntimeException("EGL already set up");
            }
            EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
            y50Var.s = eglGetDisplay;
            ...
            if (y50Var.v == EGL14.EGL_NO_CONTEXT) {
                ...
                if (!EGL14.eglChooseConfig(y50Var.s, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, EglBase.EGL_RECORDABLE_ANDROID, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                    throw new RuntimeException("Unable to find a suitable EGLConfig");
                }
                i10 = 0;
                y50Var.v = EGL14.eglCreateContext(y50Var.s, eGLConfigArr[0], y50Var.w, new int[]{12440, 2, 12344}, 0);
                y50Var.x = eGLConfigArr[0];
            } else {
                i10 = 0;
            }
            EGL14.eglQueryContext(y50Var.s, y50Var.v, 12440, new int[1], i10);
            if (y50Var.y != EGL14.EGL_NO_SURFACE) {
                throw new IllegalStateException("surface already created");
            }
            EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(y50Var.s, y50Var.x, y50Var.r, new int[]{12344}, i10);
            y50Var.y = eglCreateWindowSurface;
            if (eglCreateWindowSurface == null) {
                throw new RuntimeException("surface was null");
            }
            if (!EGL14.eglMakeCurrent(y50Var.s, eglCreateWindowSurface, eglCreateWindowSurface, y50Var.v)) {
                if (BuildVars.LOGS_ENABLED) {
            ...
            y50Var.j0 = glCreateProgram;
            GLES20.glAttachShader(glCreateProgram, a2);
            GLES20.glAttachShader(y50Var.j0, a10);
            GLES20.glLinkProgram(y50Var.j0);
            int[] iArr2 = new int[1];
            GLES20.glGetProgramiv(y50Var.j0, 35714, iArr2, 0);
            if (iArr2[0] == 0) {
                GLES20.glDeleteProgram(y50Var.j0);
                y50Var.j0 = 0;
                return;
            }
            y50Var.m0 = GLES20.glGetAttribLocation(y50Var.j0, "aPosition");
            y50Var.n0 = GLES20.glGetAttribLocation(y50Var.j0, "aTextureCoord");
            y50Var.p0 = GLES20.glGetUniformLocation(y50Var.j0, "preview");
            y50Var.o0 = GLES20.glGetUniformLocation(y50Var.j0, "resolution");
            y50Var.r0 = GLES20.glGetUniformLocation(y50Var.j0, "alpha");
            y50Var.k0 = GLES20.glGetUniformLocation(y50Var.j0, "uMVPMatrix");
            y50Var.l0 = GLES20.glGetUniformLocation(y50Var.j0, "uSTMatrix");
            y50Var.q0 = GLES20.glGetUniformLocation(y50Var.j0, "texelSize");
        } catch (Exception e6) {
    ...
    public static void b(y50 y50Var, int i10, u50 u50Var) {
        ...
        if (i10 != 1 || (((videoEditedInfo = y50Var.E0.K) != null && videoEditedInfo.needConvert()) || y50Var.E0.c.c())) {
            z4 = true;
        } else {
            if (!y50Var.D0) {
                y50Var.D0 = true;
            ...
            if (y50Var.c) {
                if (y50Var.a.exists()) {
                    try {
                        ...
                        FileLog.e("InstantCamera copying fileToWrite to videoFile, deleting videoFile error " + y50Var.a);
                        FileLog.e(e13);
                    }
                }
                if (!y50Var.b.renameTo(y50Var.a)) {
                    FileLog.e("InstantCamera unable to rename file, try move file");
                    try {
                        AndroidUtilities.copyFile(y50Var.b, y50Var.a);
                        y50Var.b.delete();
        ...
        if (i10 != 2 && (dispatchQueue = y50Var.y0) != null) {
        ...
        if (i10 == 0) {
            FileLoader.getInstance(y50Var.E0.a).cancelFileUpload(y50Var.a.getAbsolutePath(), false);
            try {
                y50Var.b.delete();
        ...
        EGL14.eglDestroySurface(y50Var.s, y50Var.y);
        y50Var.y = EGL14.EGL_NO_SURFACE;
        Surface surface = y50Var.r;
        if (surface != null) {
            surface.release();
            y50Var.r = null;
        }
        EGLDisplay eGLDisplay = y50Var.s;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            EGL14.eglDestroyContext(y50Var.s, y50Var.v);
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(y50Var.s);
        }
        y50Var.s = EGL14.EGL_NO_DISPLAY;
    ...
    public final void c(n50 n50Var, long j10, boolean z4) {
        ...
        int i10 = z50Var.a;
        if (!this.h) {
            FileLoader.getInstance(i10).checkUploadNewDataAvailable(n50Var.toString(), z50Var.J, j10, z4 ? n50Var.length() : 0L);
            return;
        }
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, (Property<LinearLayout, Float>) property, 0.0f), ObjectAnimator.ofInt(z50Var.d, n6.b, 0), ObjectAnimator.ofFloat(z50Var.w, (Property<ImageView, Float>) property, 1.0f));
    ...
    public final void run() {
        ...
        synchronized (this.R) {
            ...
            u0Var.b = new WeakReference(this);
            this.Q = u0Var;
            this.S = true;
            this.R.notify();
        }
