                ...
                if (!chatActivityEnterView4.k5 ? chatActivityEnterView4.getTranslationY() == 0.0f : !chatActivityEnterView4.t0()) {
                    ...
                    if (chatActivityEnterView4.Y2.J() != null) {
                        ...
                        if (efVar != null) {
                            ...
                            if (measuredHeight < (((i17 * 2) + b13) - ((znVar4 == null || !znVar4.isInBubbleMode()) ? AndroidUtilities.statusBarHeight : 0)) - chatActivityEnterView4.q0.p.getMeasuredHeight()) {
                            ...
                            if (peer3 != null) {
                                ...
                                while (i20 < arrayList3.size()) {
                                    ...
                                    efVar3.w.h1(i20, (size2 - ((arrayList4.size() - 2) * dp)) + AndroidUtilities.dp(7.0f) + ((i20 == arrayList4.size() + (-1) || wl0Var2.getMeasuredHeight() >= size2) ? 0 : wl0Var2.getMeasuredHeight() % dp));
