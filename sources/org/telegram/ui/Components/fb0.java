...
public final class fb0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public fb0(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, ArrayList arrayList, int i11) {
        super(context);
        String str;
        ...
        if (str == null || document == null) {
            ...
            this.f = r90Var;
            r90Var.l = org.telegram.ui.ActionBar.h6.G8;
            r90Var.m = org.telegram.ui.ActionBar.h6.i6;
            r90Var.j(4.0f);
            return;
        }
        SpannableString spannableString = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString.setSpan(new cb0(this, document, this.h.getFontMetricsInt()), 0, spannableString.length(), 33);
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        spannableString.setSpan(new db0(this, 0), 0, 1, 33);
        SpannableString spannableString2 = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString2.setSpan(new eb0(this, document, this.h.getFontMetricsInt()), 0, spannableString2.length(), 33);
