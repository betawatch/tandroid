...
public final class lz {
    ...
    public final boolean b() {
        kz kzVar;
        kz kzVar2 = this.f1;
        int blurType = kzVar2 != null ? kzVar2.getBlurType() : 0;
        if (this.g1 || (kzVar = this.f1) == null || kzVar.b() || blurType == 0) {
            return false;
        }
        boolean z10 = this.a;
        int[] iArr = this.S0;
    ...
    public final void d() {
        ...
        if (z11) {
            ...
            if (!z10 || this.h) {
                ...
                int i10 = this.M;
                if (i10 != -1) {
                    GLES20.glUniform2f(i10, this.X0, this.Y0);
                }
                c10 = 1;
            }
    ...
    public final void f() {
        ...
        int i10;
        kz kzVar = this.f1;
        if (kzVar == null || kzVar.b() || this.f1.getSoftenSkinValue() <= 0.0f || (i9 = this.X0) <= 0 || this.Y0 <= 0) {
            if (this.h) {
                this.W0 = false;
                this.h = false;
                return;
    ...
    public final int g(int i9) {
        ...
        int[] iArr = this.S0;
        if (z10) {
            return iArr[i9 == 0 ? (char) 1 : (char) 0];
        }
        return iArr[i9];
    }
    ...
    public final boolean j() {
        ...
        while (true) {
            ...
            if (i11 >= (z11 ? 2 : 1)) {
                ...
                if (z12) {
                    ...
                    if (i9 == 0 && i10 != 0) {
                        ...
                        GLES20.glAttachShader(this.i, i10);
            ...
            int i13 = h13;
            int[] iArr2 = this.H;
            GLES20.glDeleteProgram(iArr2[i11]);
            if (i13 == 0 || h14 == 0) {
                return false;
            }
            int glCreateProgram3 = GLES20.glCreateProgram();
            iArr2[i11] = glCreateProgram3;
            GLES20.glAttachShader(glCreateProgram3, i13);
            GLES20.glAttachShader(iArr2[i11], h14);
            GLES20.glBindAttribLocation(iArr2[i11], 0, "position");
            GLES20.glBindAttribLocation(iArr2[i11], 1, "inputTexCoord");
            GLES20.glLinkProgram(iArr2[i11]);
            GLES20.glGetProgramiv(iArr2[i11], 35714, iArr, 0);
            if (iArr[0] == 0) {
                GLES20.glDeleteProgram(iArr2[i11]);
                iArr2[i11] = 0;
            } else {
                this.I[i11] = GLES20.glGetAttribLocation(iArr2[i11], "position");
                this.J[i11] = GLES20.glGetAttribLocation(iArr2[i11], "inputTexCoord");
                this.K[i11] = GLES20.glGetUniformLocation(iArr2[i11], "sTexture");
                if (i11 == 1) {
                    this.L = GLES20.glGetUniformLocation(iArr2[i11], "videoMatrix");
                    this.M = GLES20.glGetUniformLocation(iArr2[i11], "texSize");
                }
            }
            i11++;
            a2 = i12;
