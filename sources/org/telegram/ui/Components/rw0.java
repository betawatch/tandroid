...
public final class rw0 extends aj0 {
    public float E;
    ...
    public rw0(ww0 ww0Var, Context context) {
        super(context);
        org.telegram.ui.ActionBar.e6 e6Var = ww0Var.p2;
        this.H = ww0Var;
        this.w = false;
        this.y = 1.0f;
        k(ww0Var.w3 ? i0.a.k(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Wk, e6Var), (int) 102.0f) : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Me, e6Var));
    ...
    public final void c() {
        ...
        if (this.y < 1.0f) {
            ...
            this.G = ofFloat;
            ofFloat.addUpdateListener(new ow0(this, 2));
            this.G.addListener(new qw0(this, 0));
    ...
    public final void l(boolean z10, boolean z11) {
        if (Math.abs(this.s - (z10 ? 1.0f : 0.0f)) > 0.01f) {
            ...
            this.v = ofFloat;
            ofFloat.addUpdateListener(new ow0(this, 1));
            this.v.addListener(new qw0(this, 1));
    ...
    public final void m(float f7) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = ww0Var.p2;
        if (ww0Var.w3) {
            k(i0.a.k(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Wk, e6Var), (int) (AndroidUtilities.lerp(0.4f, 0.8f, f7) * 255.0f)));
        } else {
            k(i0.a.d(this.s, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Me, e6Var), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Oe, e6Var)));
        }
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(org.telegram.messenger.vl.d(4.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30));
    }
    ...
    public final void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            if (f7 != 0.0f) {
                ...
                this.F = ofFloat;
                ofFloat.addUpdateListener(new ow0(this, 0));
                this.F.addListener(new qw0(this, 2));
