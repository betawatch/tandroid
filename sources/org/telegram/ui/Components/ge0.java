...
public final class ge0 extends FrameLayout {
    ...
    public final void b(Bitmap bitmap, int i10, boolean z10, boolean z11, uf.f fVar, a61 a61Var, MediaController.CropState cropState) {
        ...
        if (bitmap == null && a61Var == null) {
            ...
            imageView.setImageBitmap(a61Var == null ? nVar.w : null);
        }
        uf.e eVar = this.c;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (this.f && view == (nVar = this.b)) {
            ...
            org.telegram.ui.rr0 rr0Var = (org.telegram.ui.rr0) this.a;
            rr0Var.getClass();
            int dp2 = AndroidUtilities.dp(2.0f) + (((int) (((r1.N7.getMeasuredWidth() - AndroidUtilities.dp(32.0f)) * rr0Var.a.r8) + AndroidUtilities.dp(16.0f))) - (dp / 2));
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.dp(156.0f);
            float f10 = actualRect.left;
            float f11 = this.r;
            float f12 = ((dp2 - f10) * f11) + f10;
            float f13 = actualRect.top;
            float z10 = com.google.android.recaptcha.internal.a.z(measuredHeight, f13, f11, f13);
