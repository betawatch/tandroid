...
public final class lo0 {
    ...
    */
    public final void c(Canvas canvas, org.telegram.ui.Cells.s1 s1Var) {
        ...
        boolean z4 = (s1Var2 == null || (messageObject = s1Var2.v7) == null || !messageObject.isVoiceOnce()) ? false : true;
        float[] fArr3 = this.H;
        if (fArr3 == null || (fArr2 = this.I) == null) {
            ...
            if (this.G != null) {
                ...
                while (true) {
                    ...
                    float a2 = k7.n.a((d * f10) - f16, 0.0f, 1.0f);
                    a(this.x, dpf22, org.telegram.ui.ai.c(1.0f, a2, AndroidUtilities.dpf2(1.0f), AndroidUtilities.dpf2(this.G[z4 ? (r3.length - 1) - i13 : i13]) * a2));
                    i13++;
                }
            }
            f12 = 0.0f;
            ...
            while (i17 < max) {
                float f18 = i17;
                float f19 = dpf2;
                int b10 = k7.n.b((int) Math.floor((f18 / max) * min), 0, min - 1);
                if (i16 < b10) {
        ...
        canvas.restore();
        if (this.M == null) {
            this.M = new o4.g0(new dc0(this, 26));
        }
        float f20 = this.K;
        if (f20 < 0.99f && (fArr = this.G) != null) {
            ...
            if (i18 >= 0 && i18 < fArr.length) {
                float dpf24 = AndroidUtilities.dpf2(this.G[i18]) * k7.n.a((d * f10) - i18, 0.0f, 1.0f);
                ...
                while (i11 < arrayList.size()) {
                    ko0 ko0Var = (ko0) arrayList.get(i11);
                    float f24 = min2;
                    float f25 = ko0Var.f - (f24 / ko0Var.g);
                    ko0Var.f = f25;
                    if (f25 < 0.0f) {
                        arrayList2.add(ko0Var);
                        ...
                        float f27 = ko0Var.d;
                        float f28 = ko0Var.c;
                        ko0Var.a = (((f27 * f28) * f24) / 500.0f) + f26;
                        float f29 = ko0Var.b;
                        float f30 = ko0Var.e;
                        ko0Var.b = (((f28 * f30) * f24) / 500.0f) + f29;
                        ko0Var.e = f30 - ((AndroidUtilities.dp(0.33f) * min2) / 500.0f);
                    }
                    i11++;
                }
                if (((RectF) g0Var.g) != null) {
                    ...
                    for (int i19 = 0; i19 < min3; i19++) {
                        ko0 ko0Var2 = arrayList2.isEmpty() ? new ko0() : (ko0) arrayList2.remove(0);
                        RectF rectF2 = (RectF) g0Var.g;
                        ko0Var2.a = (Utilities.random.nextFloat() * rectF2.width()) + rectF2.left;
                        RectF rectF3 = (RectF) g0Var.g;
                        ko0Var2.b = (Utilities.random.nextFloat() * rectF3.height()) + rectF3.top;
                        double nextInt = (Utilities.random.nextInt(200) - 125) * 0.017453292519943295d;
                        ko0Var2.d = ((float) (Math.cos(nextInt) - Math.sin(nextInt))) * 0.8f;
                        ko0Var2.e = ((float) (Math.cos(nextInt) + Math.sin(nextInt))) - 0.2f;
                        ko0Var2.f = 1.0f;
                        ko0Var2.c = AndroidUtilities.dp((Utilities.random.nextFloat() * 7.0f) + 10.0f);
                        ko0Var2.g = AndroidUtilities.lerp(420, 550, Utilities.random.nextFloat());
                        arrayList.add(ko0Var2);
                    }
                }
                for (i12 = 0; i12 < arrayList.size(); i12++) {
                    ko0 ko0Var3 = (ko0) arrayList.get(i12);
                    paint.setAlpha((int) (255.0f * f23 * ko0Var3.f));
                    canvas.drawPoint(ko0Var3.a, ko0Var3.b, paint);
                }
                dc0Var = (dc0) g0Var.c;
                if (dc0Var == null) {
                    dc0Var.run();
