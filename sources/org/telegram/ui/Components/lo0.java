...
public class lo0 extends FrameLayout {
    ...
    */
    public final void a(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = lo0Var.e;
        float f11 = i11 / 2.0f;
        float measuredWidth = lo0Var.getMeasuredWidth() - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(lo0Var.S * 1.0f) / 2.0f;
        if (h0 == null) {
            h0 = new Path();
        }
        h0.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= lo0Var.P.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) lo0Var.P.get(i12)).first).floatValue() >= dp3) {
                break;
            } else {
                i12++;
            }
        ...
        int size = lo0Var.P.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) lo0Var.P.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c3 = 0;
                floatValue = ((Float) ((Pair) lo0Var.P.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) lo0Var.P.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c10 = 1;
                if (i13 >= lo0Var.P.size() - 1 || ((Float) ((Pair) lo0Var.P.get(i13)).first).floatValue() - floatValue > dp3) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) lo0Var.P.get(i13)).first).floatValue();
            }
            c10 = 1;
