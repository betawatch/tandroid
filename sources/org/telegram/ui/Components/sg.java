...
public final class sg extends FrameLayout {
    ...
    public sg(ChatActivityEnterView chatActivityEnterView, Context context) {
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.be), PorterDuff.Mode.MULTIPLY));
        this.c = org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(5.0f), chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.qf));
    ...
    public final void a() {
        ci.e4 e4Var = this.a;
        if (e4Var != null) {
            e4Var.l0 = new qg(this, e4Var, 1);
            e4Var.e(true);
            this.a = null;
        }
        ci.e4 e4Var2 = this.b;
        if (e4Var2 != null) {
            e4Var2.l0 = new qg(this, e4Var2, 2);
            e4Var2.e(true);
            this.b = null;
        }
    }
    ...
    public final void b() {
        ...
        addView(this.b, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
        ci.e4 e4Var4 = this.b;
        e4Var4.l0 = new qg(this, e4Var4, 0);
        e4Var4.u();
    }
    ...
    public final void c() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.V;
        this.y.e(chatActivityEnterView.i0(i10), chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.cf), -1);
        this.n.setColor(chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.pf));
        int dp = AndroidUtilities.dp(5.0f);
        int i11 = org.telegram.ui.ActionBar.h6.qf;
        this.c = org.telegram.ui.ActionBar.h6.b0(dp, chatActivityEnterView.i0(i11));
        int i02 = chatActivityEnterView.i0(i11);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.d.setColorFilter(new PorterDuffColorFilter(i02, mode));
        this.r.setColor(chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.ae));
        this.s.setColor(chatActivityEnterView.i0(this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd));
        this.v.setColor(chatActivityEnterView.i0(this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd));
        this.E.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.i0(this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd), mode));
        this.F.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.i0(this.Q ? org.telegram.ui.ActionBar.h6.Wk : org.telegram.ui.ActionBar.h6.Zd), mode));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x01ce, code lost:
        ...
        r46.restore();
        r46.save();
        r4.setBounds(r7 - (r4.getIntrinsicWidth() / 2), (int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14)), org.telegram.ui.Cells.c1.t(2, r7, r4), r4.getIntrinsicHeight() + ((int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14))));
        r4.draw(r46);
        r46.restore();
     */
    ...
    */
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.T && rectF2.contains(x10, y3)) {
                ...
                mediaDataController.toggleDraftVoiceOnce(j3, (wnVar == null || !wnVar.h4) ? 0L : wnVar.d(), chatActivityEnterView.O);
                if (chatActivityEnterView.O) {
                    b();
                } else {
                    a();
    ...
    public void setBlurredBackgroundFactory(ah.c cVar) {
        this.Q = true;
        if (this.P == null) {
            this.P = new dh.b(org.telegram.ui.ActionBar.h6.ae, this.V.W3);
        }
