...
public final /* synthetic */ class h7 implements Utilities.Callback {
    ...
    public /* synthetic */ h7(Object obj, Object obj2, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
        this.d = obj3;
    ...
    public final void run(Object obj) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                Long l4 = (Long) obj;
                if (!eoVar.c()) {
                    znVar.j0.c(tL_messageMediaToDo, null, null, null, true, 0, l4.longValue());
            ...
            case 2:
                ...
                while (i11 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(qyVar.a.F.c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
            ...
            case 5:
                ...
                new wh.c(mVar.getContext(), (org.telegram.ui.ActionBar.f6) obj2, mVar.l0, (List) obj).show();
                break;
            case 6:
                wh.w wVar = (wh.w) obj4;
            ...
            case 9:
                ...
                wv wvVar = new wv(((zh.u7) obj3).f, l2Var.getContext(), (org.telegram.ui.ActionBar.f6) obj2, arrayList4);
                zh.w2 w2Var = l2Var.z0.Q1;
                if (w2Var != null) {
                    ((zh.l7) w2Var).h(wvVar);
                    break;
                }
            ...
            case 10:
                ...
                zh.a3 a3Var = v2Var.l;
                if ((storyItem instanceof zh.r4) && (s4Var = ((zh.r4) storyItem).a) != null) {
                    xh.n1 n1Var = new xh.n1(s4Var, storyItem2, callback, 12);
                    if (s4Var.F != 0) {
                        ConnectionsManager.getInstance(s4Var.c).cancelRequest(s4Var.F, true);
                        s4Var.F = 0;
                    }
                    s4Var.C = false;
                    s4Var.D = false;
            ...
            default:
                ...
                a3Var2.S1.c(b5Var.a, a3Var2.B1, (TL_stories.StoryItem) obj3);
                new wc(a3Var2.c1, (org.telegram.ui.ActionBar.f6) obj2).Q(R.raw.contact_check, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.StoryAddedToAlbumX, b5Var.b))).j();
                break;
        }
    }

    public /* synthetic */ h7(org.telegram.ui.ActionBar.d2 d2Var, org.telegram.ui.ActionBar.d2 d2Var2, ly0 ly0Var) {
        this.a = 3;
        this.c = d2Var;
        this.b = d2Var2;
        this.d = ly0Var;
