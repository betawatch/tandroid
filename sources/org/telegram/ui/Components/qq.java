...
public abstract class qq {
    public static void a(Context context, final int i10, TLRPC.User user, TLRPC.TL_requestPeerTypeCreateBot tL_requestPeerTypeCreateBot, boolean z10, final Utilities.Callback callback, org.telegram.ui.ActionBar.c6 c6Var, mc mcVar) {
        ...
        if (!user.bot_can_manage_bots) {
            ...
            mcVar2.Q(R.raw.error, 36, AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(R.string.CreateManagedBotUnsupported, userName), org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Gi, c6Var))).j();
            callback.run(null);
            return;
        }
        ...
        TextView i12 = org.telegram.ui.Cells.pa.i(linearLayout, textView, h7.z5.t(-1, -2, 55, 16, 0, 16, 8), context);
        org.telegram.messenger.rl.l(i11, c6Var, i12, 1, 14.0f);
        ...
        i12.setGravity(17);
        linearLayout.addView(i12, h7.z5.t(-1, -2, 55, 16, 0, 16, 22));
        ...
        linearLayout3.addView(g10, h7.z5.p(0, 48, 119.0f, 1, 5, 0, 0, 0));
        ...
        final int[] iArr = {-1};
        int[] iArr2 = {4};
        hh.t6 t6Var = new hh.t6(g3Var2, new int[]{-1}, i10, strArr, new String[1], g10, x8Var2, c6Var, iArr2);
        lq lqVar = new lq(strArr, t6Var, g3Var, iArr2, g10, z10, i10, user, iArr, zArr, callback, o10, c6Var, context);
        e3Var2.addTextChangedListener(new pq(t6Var));
        if (!TextUtils.isEmpty(str)) {
            t6Var.run();
        }
        e3Var2.setOnEditorActionListener(new c1(lqVar, 2));
        dVar.setOnClickListener(new z2(o10, 2));
        g10.setEnabled(false);
        g10.setOnClickListener(new f0(lqVar, 10));
        o10.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Components.mq
