            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof p5) && (h1Var = ((p5) drawable).k) != null && h1Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (!bm0Var.e || z10) {
                            n5Var.v = (int) ((n5Var == this.u ? 1.0f : 0.3f) * 255.0f * bm0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(bm0Var.a);
                            float dp2 = AndroidUtilities.dp(bm0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * bm0Var.c * e;
    ...
    */
    public final void e(Canvas canvas, RectF rectF, float f7) {
        ...
        if (e > 0.0f && !this.i) {
            ...
            rectF2.set(rectF.left, (AndroidUtilities.lerp(0.0f, 1.0f - wr.i.getInterpolation(w7.q.a(((Math.max(pow, 0.5f) + 1.5f) % 3.5f) * 0.5f, 0.0f, 1.0f)), e) * rectF.height()) + rectF.top, rectF.left + AndroidUtilities.dp(6.0f), (AndroidUtilities.lerp(1.0f, 1.0f - wr.g.getInterpolation(w7.q.a((((pow + 1.5f) % 3.5f) - 1.5f) * 0.5f, 0.0f, 1.0f)), e) * rectF.height()) + rectF.top);
