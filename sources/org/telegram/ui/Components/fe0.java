...
public final class fe0 implements DialogInterface.OnClickListener {
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        Integer num12 = 6;
        ke0 ke0Var2 = this.a;
        ArrayList arrayList3 = ke0Var2.I;
        ArrayList arrayList4 = ke0Var2.H;
        Integer num13 = 0;
        if (i10 == 0) {
        ...
        TLRPC.TL_userContact_old2 tL_userContact_old2 = ke0Var2.J;
        ...
        try {
            ke0Var.r.getParentActivity().startActivity(intent3);
            ke0Var.dismiss();
        } catch (Exception e10) {
            FileLog.e(e10);
        }
