...
public final class us0 extends yk0 {
    ...
    public final boolean D(f2.o1 o1Var) {
        wt0[] wt0VarArr = this.d.p1;
        return wt0VarArr[5].a.size() != 0 || wt0VarArr[5].g;
    }

    @Override // f2.q0
    public final int h() {
        wt0[] wt0VarArr = this.d.p1;
        if (wt0VarArr[5].a.size() != 0 || wt0VarArr[5].g) {
            return wt0VarArr[5].a.size();
        }
        return 1;
    }
    ...
    public final int j(int i10) {
        wt0[] wt0VarArr = this.d.p1;
        return (wt0VarArr[5].a.size() != 0 || wt0VarArr[5].g) ? 12 : 11;
    }
    ...
    public final void v(f2.o1 o1Var, int i10) {
        if (o1Var.f == 12) {
            hu0 hu0Var = this.d;
            MessageObject messageObject = (MessageObject) hu0Var.p1[5].a.get(i10);
            ...
            if (document != null) {
                ...
                if (view instanceof org.telegram.ui.Cells.d2) {
                    ...
                    if (hu0Var.y1) {
                        d2Var.c(hu0Var.V0[(messageObject.getDialogId() > hu0Var.f1 ? 1 : (messageObject.getDialogId() == hu0Var.f1 ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0, !hu0Var.X0);
                    } else {
    ...
    public final f2.o1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 11) {
            ts0 M = hu0.M(5, hu0Var.f1, context, c6Var);
