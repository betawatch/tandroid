...
public final class n00 {
    ...
    public final int a(boolean z10) {
        ...
        r00 r00Var = this.h;
        int ceil = (int) Math.ceil(bi.x4.g(charSequence, r00Var.b));
        this.c = ceil;
        int i12 = 0;
        if (z10) {
            i10 = ((org.telegram.ui.vw) r00Var.J).a(this.a);
            if (i10 < 0) {
                i10 = 0;
            }
            if (z10) {
        ...
        if (i10 > 0) {
            i11 = AndroidUtilities.dp(-2.0f) + AndroidUtilities.dp(10.0f) + Math.max(AndroidUtilities.dp(7.333f), (int) Math.ceil(r00Var.c.measureText(String.format("%d", Integer.valueOf(i10)))));
        } else {
            if (!this.e && r00Var.n) {
