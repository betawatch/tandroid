...
public final class xj0 extends View {
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        float e9 = this.K.e(!this.Q);
        if (e9 > 0.0f) {
            float d = (int) (i6Var.d() + AndroidUtilities.dp(30.0f));
            float e10 = this.J.e(d <= ((float) ((i10 - lerp) - AndroidUtilities.dp(8.0f))));
            ...
            tf0 tf0Var3 = tf0Var;
            tf0Var3.setBounds(0, (-dp8) / 2, dp8, dp8 / 2);
            tf0Var3.g = (int) (e9 * 255.0f);
            tf0Var3.draw(canvas);
            canvas.restore();
            if (e10 > 0.0f) {
                canvas.save();
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z13) {
                ...
                if (m61Var != null) {
                    ...
                    this.R = clamp;
                    m61Var.M((long) (clamp * this.n.q()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.P) {
                ...
                m61 m61Var2 = this.n;
                if (m61Var2 != null) {
                    m61Var2.M((long) (this.s * m61Var2.q()), false);
                }
                setPlaying(true);
            } else if (this.O && this.w) {
                m61 m61Var3 = this.n;
                if (m61Var3 != null) {
                    m61Var3.M(Math.max((long) (this.s * m61Var3.q()), ((long) (this.v * this.n.q())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.Q && !b()) {
                setPlaying(true);
