...
public final /* synthetic */ class oq0 implements Runnable {
    ...
    public /* synthetic */ oq0(rq0 rq0Var, int i10, String str) {
        this.a = 1;
        this.b = rq0Var;
        this.c = i10;
        this.d = str;
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                rq0 rq0Var3 = this.b;
                rq0Var3.f = null;
                i10 = ((org.telegram.ui.ActionBar.f3) rq0Var3.K).currentAccount;
                DispatchQueue storageQueue = MessagesStorage.getInstance(i10).getStorageQueue();
                String str = this.d;
                int i18 = this.c;
                storageQueue.postRunnable(new oq0(rq0Var3, str, i18, 2));
                oq0 oq0Var = new oq0(rq0Var3, i18, str);
                rq0Var3.h = oq0Var;
            ...
            case 1:
                ...
                int i20 = this.c;
                if (i20 == i19) {
                    rq0Var4.e.g(this.d, true, true, true, true, 0L, false, 0, i20);
                    break;
                }
                break;
            default:
                ...
                int i21 = this.c;
                rq0 rq0Var5 = this.b;
                vq0 vq0Var2 = rq0Var5.K;
                try {
                    String lowerCase = str2.trim().toLowerCase();
                    if (lowerCase.length() == 0) {
                        rq0Var5.r = -1;
                        AndroidUtilities.runOnUIThread(new wm(rq0Var5, rq0Var5.r, new ArrayList(), 9));
                        break;
                    } else {
                        ...
                        a0.i iVar = new a0.i();
                        i11 = ((org.telegram.ui.ActionBar.f3) vq0Var2).currentAccount;
                        ...
                        while (queryFinalized.next()) {
                            ...
                            jq0 jq0Var = new jq0();
                            jq0Var.c = queryFinalized.intValue(1);
                            iVar.k(jq0Var, longValue);
                        ...
                        if (arrayList.isEmpty()) {
                            ...
                            i16 = ((org.telegram.ui.ActionBar.f3) vq0Var2).currentAccount;
                                            ...
                                            if (!stringValue.contains(" " + str3)) {
                                                ...
                                                if (r12 == 0) {
                                                    ...
                                                    if (byteBufferValue != null) {
                                                        ...
                                                        int i27 = i21;
                                                        rq0Var2 = rq0Var5;
                                                        jq0 jq0Var2 = (jq0) iVar.f(TLdeserialize.id);
                                                        ...
                                                        if (r12 == z10) {
                                                            jq0Var2.d = AndroidUtilities.generateSearchName(TLdeserialize.first_name, TLdeserialize.last_name, str3);
                                                        } else {
                                                            jq0Var2.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize), null, "@" + str3);
                                                        }
                                                        jq0Var2.b = TLdeserialize;
                                                        jq0Var2.a.id = TLdeserialize.id;
                                                        i23 = i24 + 1;
                                                    }
                                                } else {
                                                    i25 = i26 + 1;
                                ...
                                for (int i28 = 0; i28 < i22; i28++) {
                                    ...
                                    if (byteBufferValue2 != null) {
                                        ...
                                        if (TLdeserialize2 != null && !ChatObject.isNotInChat(TLdeserialize2) && (!ChatObject.isChannel(TLdeserialize2) || TLdeserialize2.creator || (((tL_chatAdminRights = TLdeserialize2.admin_rights) != null && tL_chatAdminRights.post_messages) || TLdeserialize2.megagroup))) {
                                            jq0 jq0Var3 = (jq0) iVar.f(-TLdeserialize2.id);
                                            jq0Var3.d = AndroidUtilities.generateSearchName(TLdeserialize2.title, null, str4);
                                            jq0Var3.b = TLdeserialize2;
                                            jq0Var3.a.id = -TLdeserialize2.id;
                                            i13++;
                                        }
                                    }
                                }
                        ...
                        for (int i29 = 0; i29 < iVar.m(); i29++) {
                            jq0 jq0Var4 = (jq0) iVar.n(i29);
                            if (jq0Var4.b != null && jq0Var4.d != null) {
                                arrayList3.add(jq0Var4);
                            }
                        }
                                            ...
                                            if (!stringValue3.contains(" " + str5)) {
                                                ...
                                                if (c10 == 0) {
                                                    ...
                                                    if (byteBufferValue3 != null) {
                                                        ...
                                                        jq0Var5.a.id = TLdeserialize3.id;
                                                        jq0Var5.b = TLdeserialize3;
                                                        if (c10 == 1) {
                                                            jq0Var5.d = AndroidUtilities.generateSearchName(TLdeserialize3.first_name, TLdeserialize3.last_name, str5);
                                                        } else {
                                                            jq0Var5.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize3), null, "@" + str5);
                                                        }
                                                        arrayList3.add(jq0Var5);
                                                    }
                                                } else {
                                                    i30++;
                                                }
                        ...
                        AndroidUtilities.runOnUIThread(new wm(rq0Var, i12, arrayList3, 9));
                        break;
                    }
                } catch (Exception e) {
                    FileLog.e(e);
    ...
    public /* synthetic */ oq0(rq0 rq0Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = rq0Var;
        this.d = str;
        this.c = i10;
