...
public final /* synthetic */ class fw implements ki.c, cl0, hm0, le.e {
    ...
    public void a(int i10) {
        ...
        switch (this.a) {
                ...
                if (i10 != lzVar.s0 || !qyVar.x.isEmpty()) {
                    ...
                    if (i10 == lzVar.r0 || i10 == lzVar.s0) {
                        ...
                        if (i10 != lzVar.s0 || (i11 = qyVar.I) < 1) {
                            ly lyVar = lzVar.t1;
                            ryVar.h1((lyVar == null || !lyVar.A()) ? 1 : 0, 0);
                        } else {
            ...
            default:
                ...
                if (!lzVar2.S0) {
                    if (i10 != lzVar2.H1) {
                        if (wwVar != null && (xyVar = wwVar.r) != null && xyVar.getSelectedCategory() != null) {
                            wwVar.c(null, false);
                            xyVar.F1(null);
                        }
                        if (i10 != lzVar2.F1) {
                            if (i10 != lzVar2.G1) {
                                if (i10 != lzVar2.I1) {
                                    ...
                                    lzVar2.F(0);
                                    int i16 = lzVar2.I1;
                                    xwVar.k(i16, i16 > 0 ? i16 : lzVar2.E1);
                                    break;
                                }
                            } else {
                                twVar.B0();
                                ...
                                lzVar2.F(0);
                                int i17 = lzVar2.G1;
                                xwVar.k(i17, i17 > 0 ? i17 : lzVar2.E1);
                                break;
                            }
                        } else {
                            twVar.B0();
                            ...
                            lzVar2.F(0);
                            int i18 = lzVar2.F1;
                            xwVar.k(i18, i18 > 0 ? i18 : lzVar2.E1);
                            break;
                        }
                    } else {
                        lzVar2.t1.o(new d51(lzVar2.getContext(), new fx(lzVar2), lzVar2.x1, lzVar2.y1, lzVar2.z1, null, lzVar2.Z1));
                        break;
                    }
                }
                break;
    ...
    public boolean d(int i10, View view) {
        ...
        if (iArr[0] - i11 < AndroidUtilities.dp(5.0f)) {
            i11 = org.telegram.messenger.ul.D(5.0f, iArr[0] - i11, i11);
