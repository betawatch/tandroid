...
public abstract class e31 {
    ...
    public e31(org.telegram.ui.Cells.t1 t1Var, io0 io0Var) {
        ...
        final int i10 = 0;
        xi0Var.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.c31
        ...
        xi0Var2.R(t1Var);
        final int i11 = 1;
        xi0Var2.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.c31
            public final /* synthetic */ e31 b;
        ...
        this.x = z10;
        qr qrVar = qr.h;
        this.l = new c6(t1Var, 250L, qrVar);
        this.j = new c6(t1Var, 250L, qrVar);
    }
    ...
    public static boolean g(MessageObject messageObject, long j3, String str) {
        try {
            ...
            if (messageObject2 != null && messageObject2.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new z21(str, messageObject2, j3, 0));
                return true;
            }
            return false;
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (z12) {
                    ...
                    if (tL_error != null && (str = tL_error.text) != null && str.startsWith("FLOOD_WAIT_")) {
                        ...
                        AndroidUtilities.runOnUIThread(new wm(messageObject2, k1Var2, i14, 24));
                        return;
                    }
                    j3 = 0;
                    z11 = true;
    ...
    public final void f(Canvas canvas, float f7) {
        ...
        if (f12 > 0.0f) {
            ...
            if (M2 == t1Var.M2("paintChatActionBackground") && t1Var.R2()) {
                ...
                org.telegram.ui.ActionBar.i6.h2.setAlpha((int) (alpha2 * f12));
                canvas.drawRect(rect, org.telegram.ui.ActionBar.i6.h2);
    ...
    public final void q(float f7, int i10) {
        ...
        this.a = k10;
        this.e = f7;
        this.d = org.telegram.ui.ActionBar.i6.v(k10, i0.a.k(i10, (int) (Color.alpha(i10) * (org.telegram.ui.ActionBar.i6.I.q() ? 0.3f : 0.2f))));
        if (this.f == null) {
            this.f = new Paint();
        }
        ...
        if (z10) {
            xi0 xi0Var = this.n;
            xi0Var.Z = true;
            xi0Var.Q(this.c, "Artboard Outlines");
            xi0Var.o();
            xi0Var.J(true);
            xi0Var.V(0L);
            ...
            xi0 xi0Var2 = this.p;
            xi0Var2.Z = true;
            xi0Var2.Q(this.c, "Artboard Outlines");
            xi0Var2.o();
            xi0Var2.J(true);
            xi0Var2.V(0L);
