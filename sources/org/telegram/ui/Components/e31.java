...
public abstract class e31 {
    ...
    public e31(org.telegram.ui.Cells.t1 t1Var, no0 no0Var) {
        boolean z4 = false;
        this.r = t1Var;
        this.s = no0Var;
        ...
        ij0 ij0Var = new ij0(org.telegram.messenger.R.raw.transcribe_out, AndroidUtilities.dp(26.0f), "transcribe_out", AndroidUtilities.dp(26.0f));
        this.p = ij0Var;
        ij0Var.K(0);
        ij0Var.setCallback(t1Var);
        final int i10 = 0;
        ij0Var.P(19, new Runnable(this) { // from class: org.telegram.ui.Components.c31
        ...
        ij0Var.H(true);
        ij0 ij0Var2 = new ij0(org.telegram.messenger.R.raw.transcribe_in, AndroidUtilities.dp(26.0f), "transcribe_in", AndroidUtilities.dp(26.0f));
        this.n = ij0Var2;
        ij0Var2.K(0);
        ij0Var2.setCallback(t1Var);
        ij0Var2.s0 = t1Var;
        final int i11 = 1;
        ij0Var2.P(19, new Runnable(this) { // from class: org.telegram.ui.Components.c31
            public final /* synthetic */ e31 b;
    ...
    public static boolean g(MessageObject messageObject, long j10, String str) {
        try {
            ...
            if (messageObject2 != null && messageObject2.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new z21(str, messageObject2, j10, 0));
                return true;
            }
            return false;
    ...
    public static void u(MessageObject messageObject, boolean z4) {
        ...
        if (z4) {
            AndroidUtilities.runOnUIThread(new oq0(messageObject, 20));
        }
    }
    ...
    public static void w(final MessageObject messageObject, boolean z4, final org.telegram.ui.Cells.k1 k1Var) {
        ...
        if (!z4) {
            ...
            final int i12 = 1;
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.a31
                @Override // java.lang.Runnable
                public final void run() {
                    int i13 = i12;
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_transcribeAudio, new RequestDelegate() { // from class: org.telegram.ui.Components.b31
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (z11) {
                    ...
                    if ((tL_messages_transcribedAudio.flags & 2) != 0) {
                        ...
                        AndroidUtilities.runOnUIThread(new a90(26, k1Var2, tL_messages_transcribedAudio));
                    }
                    if (e31.O == null) {
                        e31.O = new HashMap();
                    }
                    e31.O.put(Long.valueOf(j10), messageObject2);
                ...
                if (z10) {
                    AndroidUtilities.runOnUIThread(new z21(str4, messageObject2, j10, 1), Math.max(0L, 350 - elapsedRealtime2));
                }
            }
    ...
    public final void f(Canvas canvas, float f10) {
        ...
        if (this.y) {
            ij0 ij0Var = this.n;
            ij0Var.setAlpha((int) (this.m * f10));
            ij0Var.draw(canvas);
        } else {
            ij0 ij0Var2 = this.p;
            ij0Var2.setAlpha((int) (this.o * f10));
            ij0Var2.draw(canvas);
        }
    ...
    public final void q(float f10, int i10) {
        ...
        if (z4) {
            ij0 ij0Var = this.n;
            ij0Var.X = true;
            ij0Var.O(this.c, "Artboard Outlines");
            ij0Var.m();
            ij0Var.H(true);
            ij0Var.S(0L);
            ...
            ij0 ij0Var2 = this.p;
            ij0Var2.X = true;
            ij0Var2.O(this.c, "Artboard Outlines");
            ij0Var2.m();
            ij0Var2.H(true);
            ij0Var2.S(0L);
    ...
    public final void r(boolean z4, boolean z10) {
        this.k = z4;
        no0 no0Var = this.s;
        if (!no0Var.z && z4 && no0Var.B.c <= 0.0f) {
            no0Var.A = SystemClock.elapsedRealtime();
        }
        no0Var.z = z4;
        org.telegram.ui.Cells.t1 t1Var = no0Var.n;
        if (t1Var != null) {
            t1Var.invalidate();
        }
        z5 z5Var = this.l;
