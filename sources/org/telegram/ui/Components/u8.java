...
public final class u8 extends qv0 {
    public float A0;
    public float B0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z11 != z12) {
            ...
            dc1 dc1Var = c9Var.r;
            dc1Var.setTranslationY((dc1Var.getTranslationY() + ((ViewGroup.MarginLayoutParams) c9Var.r.getLayoutParams()).topMargin) - i12);
            ...
            if (!c9Var.U) {
                ...
                c9Var.M.setInterpolator(org.telegram.ui.ActionBar.q1.w);
                c9Var.M.start();
            }
        }
        super.onMeasure(i10, i11);
