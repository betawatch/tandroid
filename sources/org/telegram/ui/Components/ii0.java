...
public abstract class ii0 {
    ...
    public final void c(Canvas canvas, boolean z10) {
        ...
        if (f43 == 0.0f || z11) {
            ...
            hi0Var.b.setColor(this.G ? paint2.getColor() : org.telegram.ui.ActionBar.i6.w0(null, this.b, false));
            hi0Var.draw(canvas);
            canvas.restore();
        } else {
            i15 = dp;
        ...
        if (this.T != null) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.H.getMeasuredWidth(), this.H.getMeasuredHeight(), (int) (org.telegram.messenger.y0.A(1.0f, this.o, 255.0f, f12) * this.x), 31);
        ...
        if (!org.telegram.ui.ActionBar.i6.C1) {
            ...
            xi0Var.Z = true;
            int i28 = this.d;
            xi0Var.Q(org.telegram.ui.ActionBar.i6.w0(null, i28, true), "Arrow1");
