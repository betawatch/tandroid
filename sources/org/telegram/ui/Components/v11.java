...
public class v11 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public TextPaint E;
    ...
    public f9 Q;
    public final org.telegram.ui.ActionBar.g5 R;
    public final org.telegram.ui.ActionBar.g5 S;
    ...
    public v11(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        ...
        this.v = new RectF();
        this.w = new Path();
        this.R = new org.telegram.ui.ActionBar.g5(0, true, false, null);
        this.S = new org.telegram.ui.ActionBar.g5(0, false, false, null);
        this.K = i11;
        this.I = i10;
        this.x = f6Var;
    ...
    public final void d() {
        if (this.H.getImageReceiver().getLottieAnimation() != null) {
            ...
            kq0 kq0Var = new kq0(this, 16);
            this.J = kq0Var;
            AndroidUtilities.runOnUIThread(kq0Var, 2500L);
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.n != 1.0f && (u11Var2 = this.h) != null) {
            u11Var2.b(canvas, 1.0f);
        }
        float f7 = this.n;
        if (f7 != 0.0f) {
            this.f.b(canvas, f7);
        }
        if (this.n != 1.0f && (u11Var = this.h) != null) {
            u11Var.a(canvas, 1.0f);
        }
        float f10 = this.n;
        if (f10 != 0.0f) {
            this.f.a(canvas, f10);
    ...
    public final void f(lp lpVar, long j3, boolean z10) {
        ...
        org.telegram.ui.ActionBar.e4 e4Var2 = lpVar.a;
        ...
        if (this.U != 0) {
            if (this.Q == null) {
                this.Q = new f9((org.telegram.ui.ActionBar.f6) null);
            }
        ...
        if (z11 || z12) {
            ...
            u11 u11Var = this.f;
            lp lpVar2 = this.G;
            if (lpVar2 == null || (e4Var = lpVar2.a) == null) {
                j10 = 0;
            } else {
                org.telegram.ui.ActionBar.d4 d4Var = (org.telegram.ui.ActionBar.d4) e4Var.f.get(lpVar2.c);
                int i16 = d4Var.h;
                if (this.U != 0) {
                    i16 = d4Var.k;
                }
                Paint paint = u11Var.c;
                Paint paint2 = u11Var.a;
                Paint paint3 = u11Var.b;
                paint.setColor(i16);
                paint3.setColor(d4Var.i);
                int v02 = this.G.a.m() ? org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.x) : d4Var.j;
                ...
                if (aVar != null) {
                    ...
                    if (d4Var2.a() != 0) {
                        lp lpVar4 = this.G;
                        int i17 = ((org.telegram.ui.ActionBar.d4) lpVar4.a.f.get(lpVar4.c)).d;
                ...
                lp lpVar5 = this.G;
                org.telegram.ui.ActionBar.d4 d4Var3 = (org.telegram.ui.ActionBar.d4) lpVar5.a.f.get(lpVar5.c);
                if (this.G != null) {
                    int i22 = d4Var3.k;
                    int i23 = d4Var3.l;
                    int i24 = d4Var3.m;
                    ...
                    if (d4Var3.a.k(false) != null) {
                        ...
                        if (i6Var == null || (i6Var.P <= 0 && i6Var.c == null)) {
                            org.telegram.ui.ActionBar.e4 e4Var3 = this.G.a;
            ...
            if (i27 != j10) {
                ...
                org.telegram.ui.ActionBar.h6 h6Var = sparseArray != null ? (org.telegram.ui.ActionBar.h6) sparseArray.get(((org.telegram.ui.ActionBar.d4) lpVar.a.f.get(this.V)).e) : null;
        ...
        org.telegram.ui.ActionBar.e4 e4Var4 = this.G.a;
