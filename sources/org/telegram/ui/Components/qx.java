...
public class qx extends im0 {
    ...
    public qx(kz kzVar, Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        if (!this.A0) {
            ...
            if (getScrollX() == 0 && translationX == 0.0f) {
                if (this.v0 || this.w0 - motionEvent.getX() >= 0.0f) {
                    if (this.v0 && this.w0 - motionEvent.getX() > 0.0f && ywVar.e0) {
                        ywVar.i();
                        this.v0 = false;
                    }
                } else if (!ywVar.M) {
