...
public final class cy0 extends FrameLayout {
    ...
    public final oi0 a(int i10) {
        ...
        if (oi0VarArr[i10] == null) {
            ...
            oi0VarArr[i10] = new oi0(i11, i0.a.k(i11, ""), AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), true, null);
            c(i10);
        }
    ...
    public final void b() {
        ...
        if (this.C == null && this.B != (value = this.f.getValue())) {
            ...
            if (a2 != null) {
                ...
                ri0VarArr[i10].setAnimation(a2);
                ri0VarArr[i10].d();
            } else {
                ri0VarArr[i10].a();
            }
            AndroidUtilities.updateViewVisibilityAnimated(ri0VarArr[this.s], false, 0.5f, true);
    ...
    public final void c(int i10) {
        oi0[] oi0VarArr = this.r;
        if (oi0VarArr[i10] != null) {
            int d = i0.b.d(0.9f, org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.c9, false));
            int w02 = org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.e9, false);
            if (i10 != 2) {
                oi0VarArr[i10].setColorFilter(new PorterDuffColorFilter(w02, PorterDuff.Mode.SRC_IN));
                return;
            }
            oi0VarArr[i10].O(d, "Arrow");
            oi0VarArr[i10].O(w02, "Box2");
            oi0VarArr[i10].O(w02, "Box1");
        }
    }
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f12 != 1.0f) {
                ...
                int u10 = org.telegram.messenger.rl.u(16.0f, AndroidUtilities.dp(21.0f) + AndroidUtilities.dp(132.0f), getMeasuredWidth());
                int dp = AndroidUtilities.dp(21.0f);
                float f14 = dp;
                float x8 = org.telegram.messenger.rl.x(48.0f, getMeasuredHeight(), 2);
                rectF.set(f14, x8, u10, getMeasuredHeight() - r9);
                if (this.A >= 0) {
                    this.A = iArr[by0Var.getValue()];
                    this.x = 1.0f;
                    f10 = 1.0f;
                    this.y = i0.b.d(0.9f, org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false), org.telegram.ui.ActionBar.g6.w0(null, this.A, false));
                } else {
                    f10 = 1.0f;
                    if (iArr[by0Var.getValue()] != this.A) {
                        this.y = i0.b.d(this.x, this.y, i0.b.d(0.9f, org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false), org.telegram.ui.ActionBar.g6.w0(null, this.A, false)));
                        this.x = 0.0f;
                        this.A = iArr[by0Var.getValue()];
                    }
                }
                ...
                paint3.setColor(i0.b.d(this.x, i11, i0.b.d(0.9f, org.telegram.ui.ActionBar.g6.w0(null, i12, false), org.telegram.ui.ActionBar.g6.w0(null, this.A, false))));
                ...
                paint3.setAlpha(255);
                rectF.set(f14, x8, u10 - AndroidUtilities.dp(58.0f), getMeasuredHeight() - r9);
        ...
        int u102 = org.telegram.messenger.rl.u(16.0f, AndroidUtilities.dp(21.0f) + AndroidUtilities.dp(132.0f), getMeasuredWidth());
        int dp2 = AndroidUtilities.dp(21.0f);
        float f142 = dp2;
        float x82 = org.telegram.messenger.rl.x(48.0f, getMeasuredHeight(), 2);
        rectF.set(f142, x82, u102, getMeasuredHeight() - r9);
        if (this.A >= 0) {
        }
        f11 = this.x;
        if (f11 != f10) {
        ...
        paint3.setColor(i0.b.d(this.x, i112, i0.b.d(0.9f, org.telegram.ui.ActionBar.g6.w0(null, i122, false), org.telegram.ui.ActionBar.g6.w0(null, this.A, false))));
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint3);
        paint3.setColor(org.telegram.ui.ActionBar.g6.w0(null, i122, false));
        paint3.setAlpha(255);
        rectF.set(f142, x82, u102 - AndroidUtilities.dp(58.0f), getMeasuredHeight() - r9);
        rectF.inset(-AndroidUtilities.dp(1.0f), -AndroidUtilities.dp(1.0f));
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint3);
        paint.setAlpha(31);
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint);
    ...
    public void setBackgroundColor(int i10) {
        ...
        by0Var.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.j5, false));
        by0Var.invalidate();
    }
}
