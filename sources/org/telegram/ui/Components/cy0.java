...
public final class cy0 extends ul0 {
    ...
    public final void l() {
        ...
        if (gy0Var.W != null) {
            ...
            this.h = 0;
            this.n = 0;
            for (int i12 = 0; i12 < gy0Var.W.size(); i12++) {
                TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) gy0Var.W.get(i12);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList == null) {
            if (gy0Var.X != null) {
                ((org.telegram.ui.Cells.g8) view).setSticker((SendMessagesHelper.ImportingSticker) gy0Var.Y.get(i10));
                return;
            }
            if (c1Var.f != 3) {
                ...
                g8Var.d(tL_messages_stickerSet.documents.get(i10), null, gy0Var.S, null, gy0Var.h0, gy0Var.R);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 == 1) {
                ...
                f6Var2 = ((org.telegram.ui.ActionBar.f3) gy0Var).resourcesProvider;
                frameLayout2 = new org.telegram.ui.Cells.t3(8, this.c, f6Var2, true, false);
            } else if (i10 != 3) {
                frameLayout2 = null;
            } else {
                f6Var3 = ((org.telegram.ui.ActionBar.f3) gy0Var).resourcesProvider;
                FrameLayout ay0Var = new ay0(context);
