    ...
    public final void g() {
        ...
        if (this.b.get()) {
            ...
            while (i14 < this.T.size()) {
                j11 j11Var = (j11) this.T.get(i14);
                if (j11Var.d) {
                    ArrayList arrayList = this.T;
                    int i15 = 0;
                    for (int i16 = 0; i16 < arrayList.size(); i16++) {
                        i15 += ((j11) arrayList.get(i16)).u;
                    }
                    float f7 = j11Var.u;
                    float f10 = f7 / i15;
                    int[] iArr = j11Var.B;
                    ...
                    int i18 = j11Var.E.a ? 120000 : devicePerformanceClass != 1 ? devicePerformanceClass != 2 ? 30000 : 120000 : 60000;
                    if (j11Var.D) {
                        i18 /= 2;
                    }
                    float max = Math.max(AndroidUtilities.dpf2(0.4f), 1.0f);
                    j11Var.s = Utilities.clamp((int) ((r4 * i17) / (max * max)), (int) (i18 * f10), 10);
                    float f11 = i17;
                    float f12 = f11 / f7;
                    int round = (int) Math.round(Math.sqrt(r4 / f12));
                    j11Var.w = round;
                    j11Var.v = Math.round(j11Var.s / round);
                    while (true) {
                        i10 = j11Var.v;
                        i11 = j11Var.w;
                        i12 = i10 * i11;
                    ...
                    j11Var.s = i12;
                    j11Var.x = Math.max(f11 / i10, f7 / i11);
                    GLES20.glGenBuffers(2, iArr, i13);
                    for (int i19 = 0; i19 < 2; i19++) {
                        GLES20.glBindBuffer(34962, iArr[i19]);
                        GLES20.glBufferData(34962, j11Var.s * 28, null, 35048);
                    }
                    if (j11Var.e != null) {
                        this.U.add(j11Var);
                    }
                ...
                int i20 = j11Var.u;
                int i21 = j11Var.t;
                Matrix matrix = j11Var.r;
                k11 k11Var = j11Var.E;
                long nanoTime = System.nanoTime();
                double d = j11Var.b < 0 ? 0.0d : (nanoTime - r7) / 1.0E9d;
                j11Var.b = nanoTime;
                if (j11Var.n && !j11Var.o) {
                    matrix.reset();
                    matrix.postScale(i21, i20);
                    matrix.postTranslate(j11Var.i, j11Var.j);
                    j11Var.c();
                }
                j11Var.c = (float) ((f13 * d) + j11Var.c);
                GLES20.glUniformMatrix3fv(k11Var.x, 1, false, j11Var.p, 0);
                GLES20.glUniform1f(k11Var.y, j11Var.d ? 1.0f : 0.0f);
                GLES20.glUniform1f(k11Var.E, j11Var.c);
                GLES20.glUniform1f(k11Var.F, ((float) d) * f13);
                GLES20.glUniform1f(k11Var.G, j11Var.s);
                GLES20.glUniform3f(k11Var.I, j11Var.v, j11Var.w, j11Var.x);
                GLES20.glUniform2f(k11Var.P, j11Var.g, j11Var.h);
                GLES20.glUniform1f(k11Var.Q, z10 ? 0.8f : 1.0f);
                GLES20.glUniform1f(k11Var.R, z10 ? 1.0f : 0.6f);
                GLES20.glUniform2f(k11Var.J, i21, i20);
                GLES20.glUniform1f(k11Var.K, j11Var.y);
                GLES20.glUniform2f(k11Var.L, 0.0f, 0.0f);
                GLES20.glUniform1f(k11Var.N, j11Var.k);
                GLES20.glUniform1f(k11Var.O, j11Var.l);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, j11Var.A[0]);
                GLES20.glUniform1i(k11Var.M, 0);
                GLES20.glBindBuffer(34962, iArr2[j11Var.z]);
                ...
                GLES30.glBindBufferBase(35982, 0, iArr2[1 - j11Var.z]);
                GLES20.glVertexAttribPointer(0, 2, 5126, false, 28, 0);
                GLES20.glEnableVertexAttribArray(0);
                GLES20.glVertexAttribPointer(1, 2, 5126, false, 28, 8);
                GLES20.glEnableVertexAttribArray(1);
                ...
                GLES20.glDrawArrays(0, 0, j11Var.s);
                GLES30.glEndTransformFeedback();
                GLES20.glBindBuffer(34962, 0);
                GLES20.glBindBuffer(35982, 0);
                j11Var.d = false;
                j11Var.z = 1 - j11Var.z;
                if (j11Var.c > j11Var.l + (j11Var.D ? 2.0f : 0.9f)) {
                    j11Var.a();
                    this.T.remove(i14);
                ...
                if (glGetError == 0) {
                    try {
                        ...
                        for (int i22 = 0; i22 < this.U.size(); i22++) {
                            AndroidUtilities.runOnUIThread(((j11) this.U.get(i22)).e);
                        }
                        this.U.clear();
                        for (int i23 = 0; i23 < this.T.size(); i23++) {
                            ((j11) this.T.get(i23)).a();
                        }
                        this.T.clear();
            ...
            for (int i24 = 0; i24 < this.U.size(); i24++) {
                AndroidUtilities.runOnUIThread(((j11) this.U.get(i24)).e);
            }
            this.U.clear();
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 == 4) {
            while (i11 < arrayList.size()) {
                ...
                j11Var.g += message.arg1;
                j11Var.h += message.arg2;
                i11++;
            }
            return;
        }
