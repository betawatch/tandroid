...
public final class i00 extends View {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (i13 < 0) {
            if ((k00Var.L || i25 != -1) && (i26 == i10 || i26 == i11)) {
                f6Var2 = f6Var;
                textPaint6.setColor(i0.a.d(k00Var.M, org.telegram.ui.ActionBar.j6.v0(i14, f6Var2), org.telegram.ui.ActionBar.j6.v0(i12, f6Var2)));
            } else {
                f6Var2 = f6Var;
            ...
            int i27 = this.b.a;
            if (i27 == i10 || i27 == i11) {
                textPaint6.setColor(i0.a.d(k00Var.M, i0.a.d(k00Var.t0, org.telegram.ui.ActionBar.j6.v0(i14, f6Var2), org.telegram.ui.ActionBar.j6.v0(i17, f6Var2)), i0.a.d(k00Var.t0, v03, v04)));
            }
            textPaint6.setColor(i0.a.d(k00Var.t0, v03, v04));
        }
        ...
        if (this.R) {
            ...
            if (this.Q != null) {
                ...
                f14 = f23;
                f6Var4 = f6Var3;
                u5.drawAnimatedEmojis(canvas2, this.Q, this.P, 0.0f, null, computeVerticalScrollOffset() - AndroidUtilities.dp(6.0f), computeVerticalScrollOffset() + computeVerticalScrollExtent(), 0.0f, 1.0f, k00Var.f);
                canvas2.restore();
            } else {
                textPaint3 = textPaint6;
                f14 = f23;
            ...
            if (this.M != null) {
                ...
                f15 = 1.0f;
                u5.drawAnimatedEmojis(canvas2, staticLayout2, q5Var, 0.0f, null, computeVerticalScrollOffset, computeVerticalScrollOffset2, 0.0f, f25, k00Var.f);
                canvas2.restore();
            ...
            if (this.O != null) {
                ...
                this.O.draw(canvas2);
                u5.drawAnimatedEmojis(canvas2, this.O, this.N, 0.0f, null, computeVerticalScrollOffset() - AndroidUtilities.dp(6.0f), computeVerticalScrollOffset() + computeVerticalScrollExtent(), 0.0f, this.S ? this.x : f15 - this.x, k00Var.f);
                canvas2.restore();
            ...
            if (this.s != null) {
                ...
                this.s.draw(canvas2);
                u5.drawAnimatedEmojis(canvas2, this.s, this.r, 0.0f, null, computeVerticalScrollOffset() - AndroidUtilities.dp(6.0f), computeVerticalScrollOffset() + computeVerticalScrollExtent(), 0.0f, 1.0f, k00Var.f);
                canvas2.restore();
            }
            f16 = 0.0f;
        }
        ...
        if (!z12 && str2 == null) {
            ...
            if (k00Var.q0 == null) {
                k00Var.q0 = getContext().getDrawable(R.drawable.other_lockedfolders);
            }
            z10 = this.b.f;
            if (z10) {
                float f27 = this.h0;
                if (f27 != f15) {
                    ...
                    v02 = org.telegram.ui.ActionBar.j6.v0(k00Var.T, f6Var4);
                    i24 = k00Var.b0;
                    if (i24 >= 0) {
                        v02 = i0.a.d(k00Var.t0, v02, org.telegram.ui.ActionBar.j6.v0(i24, f6Var4));
                    }
                    if (k00Var.r0 != v02) {
                        k00Var.r0 = v02;
                        k00Var.q0.setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.MULTIPLY));
                    }
                    int measuredWidth2 = (int) (((getMeasuredWidth() - k00Var.q0.getIntrinsicWidth()) / 2.0f) + this.y);
                    int measuredHeight = getMeasuredHeight() - AndroidUtilities.dp(12.0f);
                    Drawable drawable = k00Var.q0;
                    drawable.setBounds(measuredWidth2, measuredHeight, drawable.getIntrinsicWidth() + measuredWidth2, k00Var.q0.getIntrinsicHeight() + measuredHeight);
                    if (this.h0 != 1.0f) {
                        k00Var.q0.draw(canvas2);
                        return;
                    }
                    canvas2.save();
                    float f28 = this.h0;
                    canvas2.scale(f28, f28, k00Var.q0.getBounds().centerX(), k00Var.q0.getBounds().centerY());
                    k00Var.q0.draw(canvas2);
                    canvas2.restore();
                    return;
                }
            ...
            int measuredWidth22 = (int) (((getMeasuredWidth() - k00Var.q0.getIntrinsicWidth()) / 2.0f) + this.y);
            int measuredHeight2 = getMeasuredHeight() - AndroidUtilities.dp(12.0f);
            Drawable drawable2 = k00Var.q0;
            drawable2.setBounds(measuredWidth22, measuredHeight2, drawable2.getIntrinsicWidth() + measuredWidth22, k00Var.q0.getIntrinsicHeight() + measuredHeight2);
            if (this.h0 != 1.0f) {
            }
        }
        f17 = 0.0f;
        if (k00Var.c0 < 0) {
            textPaint5.setColor(org.telegram.ui.ActionBar.j6.v0(k00Var.V, f6Var4));
        } else {
            textPaint5.setColor(i0.a.d(k00Var.t0, org.telegram.ui.ActionBar.j6.v0(k00Var.V, f6Var4), org.telegram.ui.ActionBar.j6.v0(k00Var.c0, f6Var4)));
        }
        if (org.telegram.ui.ActionBar.j6.c1(i15) && org.telegram.ui.ActionBar.j6.c1(i16)) {
            ...
            if (k00Var.L || k00Var.N != -1) {
                ...
                paint2.setColor(i0.a.d(k00Var.M, org.telegram.ui.ActionBar.j6.v0(i23, f6Var4), v05));
            }
            paint2 = paint;
            paint2.setColor(v05);
        } else {
        ...
        if (z4 || ((!k00Var.n && k00Var.w == f17) || str2 != null)) {
            paint2.setAlpha(255);
        } else {
            ...
            if (f32 != f33) {
                ...
                if (!z14) {
                    if (this.H != null) {
                        ...
                        float f40 = z4 ? f15 - k00Var.w : 1.0f;
                        if (this.H != null) {
                            canvas2.save();
                    ...
                    if (!z4) {
                        textPaint5.setAlpha((int) ((f15 - k00Var.w) * 255.0f));
                    }
                ...
                int measuredWidth222 = (int) (((getMeasuredWidth() - k00Var.q0.getIntrinsicWidth()) / 2.0f) + this.y);
                int measuredHeight22 = getMeasuredHeight() - AndroidUtilities.dp(12.0f);
                Drawable drawable22 = k00Var.q0;
                drawable22.setBounds(measuredWidth222, measuredHeight22, drawable22.getIntrinsicWidth() + measuredWidth222, k00Var.q0.getIntrinsicHeight() + measuredHeight22);
                if (this.h0 != 1.0f) {
                }
            }
        } else {
        ...
        int measuredWidth2222 = (int) (((getMeasuredWidth() - k00Var.q0.getIntrinsicWidth()) / 2.0f) + this.y);
        int measuredHeight222 = getMeasuredHeight() - AndroidUtilities.dp(12.0f);
        Drawable drawable222 = k00Var.q0;
        drawable222.setBounds(measuredWidth2222, measuredHeight222, drawable222.getIntrinsicWidth() + measuredWidth2222, k00Var.q0.getIntrinsicHeight() + measuredHeight222);
        if (this.h0 != 1.0f) {
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        h00 h00Var = this.b;
        accessibilityNodeInfo.setSelected((h00Var == null || (i10 = this.j0.I) == -1 || h00Var.a != i10) ? false : true);
