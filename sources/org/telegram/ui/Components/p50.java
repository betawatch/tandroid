...
public final class p50 extends DispatchQueue {
    ...
    public final void c() {
        x50 x50Var = this.E;
        if (x50Var.f0[x50Var.X0] != null) {
            x50 x50Var2 = this.E;
            int width = x50Var2.f0[x50Var2.X0].getWidth();
            x50 x50Var3 = this.E;
            float min = this.C / Math.min(width, r1);
            int i10 = (int) (width * min);
            int height = (int) (x50Var3.f0[x50Var3.X0].getHeight() * min);
            if (i10 == height) {
                x50 x50Var4 = this.E;
                x50Var4.y0 = 1.0f;
                x50Var4.z0 = 1.0f;
                ...
                x50 x50Var5 = this.E;
                x50Var5.y0 = 1.0f;
                x50Var5.z0 = i10 / this.D;
            } else {
                x50 x50Var6 = this.E;
                x50Var6.y0 = height / this.C;
                x50Var6.z0 = 1.0f;
            }
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 != 0) {
            if (i10 == 1) {
                finish();
                if (this.y && ((!((z10 = (obj = message.obj) instanceof s50)) || ((s50) obj).c != -2) && (w50Var = this.E.V0) != null)) {
                    w50Var.i(message.arg1, z10 ? (s50) obj : null);
                }
            ...
            if (i10 != 2) {
                ...
                c();
                x50 x50Var2 = this.E;
                float f10 = (1.0f / x50Var2.y0) / 2.0f;
                float f11 = (1.0f / x50Var2.z0) / 2.0f;
                float f12 = 0.5f - f10;
                float f13 = 0.5f - f11;
                float f14 = f10 + 0.5f;
                float f15 = f11 + 0.5f;
                x50Var2.w0 = org.telegram.messenger.y3.k(ByteBuffer.allocateDirect(32));
            ...
            if (surfaceTexture != null) {
                ...
                x50Var3.S = 0.0f;
                iArr2[0] = 0;
                x50Var3.x0 = x50Var3.w0.duplicate();
                x50 x50Var4 = this.E;
                x50Var4.A0 = x50Var4.f0[0];
            }
            ...
            AndroidUtilities.runOnUIThread(new ey(this.E, i13, this.n[0], i11));
            c();
            x50 x50Var5 = this.E;
            float f16 = (1.0f / x50Var5.y0) / 2.0f;
            float f17 = (1.0f / x50Var5.z0) / 2.0f;
            float f18 = 0.5f - f16;
            float f19 = 0.5f - f17;
            float f20 = f16 + 0.5f;
            float f21 = f17 + 0.5f;
            x50Var5.w0 = org.telegram.messenger.y3.k(ByteBuffer.allocateDirect(32));
        ...
        if (this.f) {
            ...
            if (this.y) {
                ...
                if (x50Var7.V0.C0) {
                    if (!x50Var7.C) {
                        this.E.C = true;
                        AndroidUtilities.runOnUIThread(new Runnable(this) { // from class: org.telegram.ui.Components.o50
                                ...
                                switch (i13) {
                                    ...
                                    default:
                                        ...
                                        if (x50Var8.i0 != null) {
                                            ...
                                            x50Var8.W0 = x50Var8.i0.getBitmap();
                                            break;
                                        }
                                        break;
                                }
                ...
                w50Var2.C0 = true;
                int i16 = MessagesController.getInstance(w50Var2.E0.a).roundVideoSize;
                int i17 = MessagesController.getInstance(w50Var2.E0.a).roundVideoBitrate * 1024;
                AndroidUtilities.runOnUIThread(new t50(w50Var2, i12));
                w50Var2.a = l50Var;
                w50Var2.d = i16;
                w50Var2.e = i16;
                w50Var2.f = i17;
                ...
                synchronized (w50Var2.R) {
                    try {
                        if (!w50Var2.T) {
                            ...
                            w50Var2.x0.clear();
                            w50Var2.z0 = 0;
                            DispatchQueue dispatchQueue = w50Var2.y0;
                            if (dispatchQueue != null) {
                                dispatchQueue.cleanupQueue();
                                w50Var2.y0.recycle();
                            }
                            w50Var2.y0 = new DispatchQueue("keyframes_thumb_queue");
                ...
                if (currentOrientation == 90 || currentOrientation == 270) {
                    x50 x50Var9 = this.E;
                    float f22 = x50Var9.y0;
                    x50Var9.y0 = x50Var9.z0;
                    x50Var9.z0 = f22;
                }
                this.y = true;
                this.E.r();
            ...
            x50 x50Var10 = this.E;
            if (x50Var10.V0 != null && ((x50Var10.X0 == 0 && z11) || (this.E.X0 == 1 && z12))) {
                x50 x50Var11 = this.E;
                w50 w50Var3 = x50Var11.V0;
                SurfaceTexture surfaceTexture2 = this.n[x50Var11.X0];
                x50 x50Var12 = this.E;
                if (x50Var12.m0) {
                    i14 = x50Var12.X0;
                }
                        ...
                        switch (i12) {
                            ...
                            default:
                                ...
                                if (x50Var82.i0 != null) {
                                    ...
                                    x50Var82.W0 = x50Var82.i0.getBitmap();
                                    break;
                                }
                                break;
                        }
                ...
                if (eglCreateContext == null) {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            Matrix.setIdentityM(x50Var.t0, 0);
                            ...
                            if (a2 == 0 || a10 == 0) {
                                ...
                                Matrix.setIdentityM(x50Var.s0, 0);
                                ...
                                for (final int i11 = 0; i11 < 2; i11++) {
                                    ...
                                    surfaceTexture2.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.telegram.ui.Components.n50
                                        @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
                                        public final void onFrameAvailable(SurfaceTexture surfaceTexture3) {
                                            p50 p50Var = p50.this;
                                            int i12 = i11;
                                            p50Var.E.O = true;
                                            p50Var.requestRender(i12 == 0, i12 == 1);
                                        }
                                    });
                                    AndroidUtilities.runOnUIThread(new ey(x50Var, i11, surfaceTextureArr[i11], i10));
                                }
                                if (BuildVars.LOGS_ENABLED) {
