    ...
    public final void a() {
        ...
        while (i11 < size) {
            ...
            if (hashMap2.containsKey(photoEntry)) {
                ...
                qm.R.put(photoEntry, Boolean.valueOf(z4));
            }
            if (z4) {
                int i14 = i12;
                i12 = i13;
        ...
        if (size == 1) {
            ...
            for (int i16 = 1; i16 < size2; i16++) {
                ...
                if (i16 <= 3 && i17 <= 3) {
                    ...
                    hm hmVar = new hm();
                    hmVar.a = new int[]{i16, i17};
                    hmVar.b = new float[]{b10, b11};
                    ...
                    if (i19 < i20) {
                        ...
                        if (i18 <= 3) {
                            if (i19 <= (f14 < 0.85f ? 4 : 3) && i21 <= 3) {
                                ...
                                hm hmVar2 = new hm();
                                hmVar2.a = new int[]{i18, i19, i21};
                                hmVar2.b = new float[]{b12, b13, b14};
                                arrayList3.add(hmVar2);
                            }
                        }
                        i19++;
                    }
                        ...
                        while (true) {
                            ...
                            if (i26 < i27) {
                                ...
                                if (i23 > 3 || i24 > 3 || i26 > 3 || i28 > 3) {
                                    ...
                                    hm hmVar3 = new hm();
                                    hmVar3.a = new int[]{i23, i24, i26, i28};
                                    i10 = size2;
                                    hmVar3.b = new float[]{b15, b16, b17, b18};
                                    arrayList3.add(hmVar3);
                                }
                                i26++;
                                size2 = i10;
                            }
            ...
            for (int i31 = 0; i31 < arrayList3.size(); i31++) {
                hm hmVar5 = (hm) arrayList3.get(i31);
                float f16 = Float.MAX_VALUE;
                float f17 = 0.0f;
                int i32 = 0;
                while (true) {
                    float[] fArr2 = hmVar5.b;
                    if (i32 >= fArr2.length) {
                        break;
                    }
                    float f18 = fArr2[i32];
