...
public final class w20 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f12 = iArr[7] - i9;
        float f13 = this.x;
        int argb = Color.argb(i9 + ((int) (f12 * f13)), iArr[0] + ((int) ((iArr[1] - r6) * f13)), iArr[2] + ((int) ((iArr[3] - r8) * f13)), iArr[4] + ((int) ((iArr[5] - r9) * f13)));
        Paint paint = G;
        paint.setColor(argb);
        ...
        int i10 = org.telegram.ui.ActionBar.f6.bi;
        org.telegram.ui.ActionBar.b6 b6Var = this.C;
        F.setColor(i0.a.d(this.x, org.telegram.ui.ActionBar.f6.v0(i10, b6Var), org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.J7, b6Var)));
        this.n.draw(canvas);
        canvas.restore();
    }
    ...
    */
    public w20(Context context, Object obj, ContactsController.Contact contact, boolean z10, org.telegram.ui.ActionBar.b6 b6Var) {
        super(context);
        String str;
        String str2;
        ...
        if (!z11) {
            if (obj instanceof TLRPC.User) {
                ...
                z8Var.h(org.telegram.ui.ActionBar.f6.l1(0.7f, org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.p7, b6Var)));
                this.E = false;
                z8Var.w = false;
            ...
            if (AndroidUtilities.isTablet()) {
                ...
                y10 = org.telegram.messenger.ll.y((z10 ? 28 : 32) + 132, Math.min(point.x, point.y), 2);
            } else {
                y10 = AndroidUtilities.dp(398 - (z10 ? 28 : 32)) / 2;
            }
            staticLayout = new StaticLayout(TextUtils.ellipsize(Emoji.replaceEmoji(str2.replace('\n', ' '), textPaint.getFontMetricsInt(), false), textPaint, y10, TextUtils.TruncateAt.END), textPaint, MediaDataController.MAX_STYLE_RUNS_COUNT, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.n = staticLayout;
        ...
        switch (str6.hashCode()) {
            ...
            case -1359418551:
                if (str6.equals("miniapps")) {
                    this.d = true;
                    z8Var.i(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.T7, b6Var), org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.a8, b6Var));
            ...
            case -318452137:
                if (str6.equals("premium")) {
                    this.d = true;
                    z8Var.h(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.Qj, b6Var));
