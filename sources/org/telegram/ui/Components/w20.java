...
public abstract class w20 extends org.telegram.ui.ActionBar.h3 {
    public w20(Context context, org.telegram.ui.ActionBar.p2 p2Var) {
        super(context, true);
        ...
        kj0Var.d();
        linearLayout.addView(kj0Var, w7.a6.t(160, 160, 49, 17, 30, 17, 0));
        ...
        linearLayout.addView(textView, w7.a6.t(-2, -2, 49, 17, 18, 17, 0));
        LinearLayout linearLayout2 = new LinearLayout(context);
        linearLayout2.setOrientation(1);
        linearLayout.addView(linearLayout2, w7.a6.t(-2, -2, 1, 0, 12, 0, 0));
        for (int i10 = 0; i10 < 3; i10++) {
            LinearLayout f7 = org.telegram.messenger.em.f(context, 0);
            linearLayout2.addView(f7, w7.a6.t(-2, -2, LocaleController.isRTL ? 5 : 3, 0, 8, 0, 0));
            ...
            if (LocaleController.isRTL) {
                f7.addView(textView2, w7.a6.n(-2, -2));
                f7.addView(imageView, w7.a6.k(8.0f, 7.0f, 0.0f, 0.0f, -2, -2));
            } else {
                f7.addView(imageView, w7.a6.k(0.0f, 8.0f, 8.0f, 0.0f, -2, -2));
                f7.addView(textView2, w7.a6.n(-2, -2));
            }
        }
        ...
        v20Var.addView(view, w7.a6.d(-1, -1.0f, 0, 16.0f, 16.0f, 16.0f, 16.0f));
        ...
        org.telegram.messenger.a2.q(textView3, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Sh, false), 1, 14.0f);
        v20Var.addView(textView3, w7.a6.e(-2, -2, 17));
        v20Var.setBackground(null);
        v20Var.setText(LocaleController.getString(R.string.GigagroupConvertProcessButton));
        view.setOnClickListener(new bi.q(this, context, p2Var, 18));
        linearLayout.addView(v20Var, w7.a6.t(-1, 50, 51, 0, 29, 0, 0));
        TextView textView4 = new TextView(context);
        textView4.setTextSize(1, 14.0f);
        textView4.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.n5, false));
        org.telegram.messenger.em.k(R.string.GigagroupConvertCancelButton, textView4, 17);
        linearLayout.addView(textView4, w7.a6.t(-2, 48, 49, 17, 0, 17, 16));
