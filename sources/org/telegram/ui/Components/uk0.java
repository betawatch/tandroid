...
public final class uk0 extends z10 {
    ...
    public final boolean a() {
        return ((zk0) this.b.b).U0 != null;
    }

    public final void b(MotionEvent motionEvent, View view) {
        zk0 zk0Var = (zk0) this.b.b;
        if (view != null) {
    ...
    public final boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        zk0Var.S0.c0(this.a, motionEvent.getX(), motionEvent.getY());
        this.a = null;
        return true;
    }
    ...
    public final void onLongPress(MotionEvent motionEvent) {
        ...
        if (zk0Var.U0.c(motionEvent.getX() - zk0Var.J1.getX(), motionEvent.getY() - zk0Var.J1.getY(), i10, view)) {
            try {
                view.performHapticFeedback(0);
    ...
    public final boolean onSingleTapConfirmed(MotionEvent motionEvent) {
        qk0 qk0Var;
        View view = this.a;
        if (view == null || (qk0Var = ((zk0) this.b.b).S0) == null || !qk0Var.f1(view)) {
            return false;
        }
