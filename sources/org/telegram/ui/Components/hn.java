...
public final class hn extends View {
    ...
    public /* synthetic */ hn(Context context, int i10) {
        super(context);
        this.a = i10;
    }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            case 11:
                ...
                break;
            case 12:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(org.telegram.ui.c60.C3 ? 0.0f : 8.0f), TLObject.FLAG_30));
                break;
            case 17:
