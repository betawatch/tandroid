...
public final class zj0 extends FrameLayout {
    ...
    public final void i() {
        ...
        while (true) {
            ...
            TLRPC.InputStickerSet inputStickerSet = MessageObject.getInputStickerSet(p5.f(i10, ((zg.o0) arrayList3.get(i11)).g));
        ...
        arrayList.addAll(arrayList2);
        bb0 bb0Var = new bb0(this.b, getContext(), this.K, arrayList2, 1);
        this.J = bb0Var;
        bb0Var.K = false;
    }
