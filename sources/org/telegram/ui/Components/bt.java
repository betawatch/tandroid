...
public abstract class bt extends s4.f1 {
    ...
    public final void B(ArrayList arrayList, s4.c1 c1Var) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ...
            if (C(zsVar, c1Var) && zsVar.a == null && zsVar.b == null) {
    ...
    public final void f(s4.c1 c1Var) {
        ...
        while (true) {
            ...
            if (((at) arrayList.get(size)).a == c1Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                v(c1Var);
        ...
        for (int size3 = arrayList4.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                ...
                if (((at) arrayList5.get(size4)).a == c1Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    v(c1Var);
    ...
    public final void g() {
        ...
        for (int size4 = arrayList4.size() - 1; size4 >= 0; size4--) {
            ...
            s4.c1 c1Var3 = zsVar.a;
            if (c1Var3 != null) {
                C(zsVar, c1Var3);
            }
            s4.c1 c1Var4 = zsVar.b;
            if (c1Var4 != null) {
                C(zsVar, c1Var4);
            }
        }
        ...
        if (k()) {
            ...
            for (int size9 = arrayList9.size() - 1; size9 >= 0; size9--) {
                ...
                for (int size10 = arrayList10.size() - 1; size10 >= 0; size10--) {
                    ...
                    s4.c1 c1Var6 = zsVar2.a;
                    if (c1Var6 != null) {
                        C(zsVar2, c1Var6);
                    }
                    s4.c1 c1Var7 = zsVar2.b;
                    if (c1Var7 != null) {
                        C(zsVar2, c1Var7);
                    }
    ...
    public final void m() {
        ...
        if (!isEmpty2) {
            ...
            arrayList3.clear();
            final int i13 = 0;
            new Runnable(this) { // from class: org.telegram.ui.Components.vs
                    ...
                    switch (i14) {
                        case 0:
                            ...
                            while (true) {
                                ...
                                if (i15 >= size2) {
                                    arrayList7.clear();
                                    btVar.t.remove(arrayList7);
                                    break;
                                } else {
                                    Object obj2 = arrayList7.get(i15);
                                    i15++;
                                    at atVar = (at) obj2;
                                    s4.c1 c1Var2 = atVar.a;
                                    int i16 = atVar.b;
                                    int i17 = atVar.c;
                                    int i18 = atVar.d;
                                    int i19 = atVar.e;
                                    ...
                                    org.telegram.ui.Cells.s2 s2Var3 = btVar.z;
                                    if (s2Var3 != null) {
                                        if (btVar.A != Integer.MAX_VALUE) {
                                            int measuredHeight3 = s2Var3.getMeasuredHeight();
                                            int i22 = btVar.A;
                                            btVar.B = measuredHeight3 - i22;
                                            btVar.z.setTopClip(i22);
                                            btVar.z.setBottomClip(btVar.B);
                                        } else if (btVar.B != Integer.MAX_VALUE) {
                                            int measuredHeight4 = s2Var3.getMeasuredHeight() - btVar.B;
                                            btVar.A = measuredHeight4;
                                            btVar.z.setTopClip(measuredHeight4);
                                            btVar.z.setBottomClip(btVar.B);
                                        }
                                    }
                                    ViewPropertyAnimator animate2 = view2.animate();
                                    btVar.w.add(c1Var2);
                                    animate2.setDuration(180L).setListener(new ys(btVar, c1Var2, i20, view2, i21, animate2, 0)).start();
                                }
                            }
                        default:
                            ...
                            while (true) {
                                ...
                                if (i23 >= size3) {
                                    arrayList7.clear();
                                    btVar2.u.remove(arrayList7);
                                    break;
                                } else {
                                    Object obj3 = arrayList7.get(i23);
                                    i23++;
                                    zs zsVar = (zs) obj3;
                                    ArrayList arrayList8 = btVar2.y;
                                    s4.c1 c1Var3 = zsVar.a;
                                    s4.c1 c1Var4 = zsVar.b;
                                    if (c1Var3 != null && c1Var4 != null) {
                                        ...
                                        arrayList8.add(zsVar.a);
                                        arrayList8.add(zsVar.b);
    ...
    public final boolean r(s4.c1 c1Var, b2.q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        at atVar = new at();
        atVar.a = c1Var;
        atVar.b = translationX;
        atVar.c = translationY;
        atVar.d = i12;
        atVar.e = i13;
        this.q.add(atVar);
        return true;
