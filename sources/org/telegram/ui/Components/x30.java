...
public final class x30 extends View implements GestureDetector.OnGestureListener {
    ...
    private ImageReceiver getFreeReceiver() {
        ...
        imageReceiver.setCurrentAccount(((org.telegram.ui.zr0) this.T).a.Q);
            ...
            if (i11 != Integer.MIN_VALUE) {
                ...
                while (i11 < size2) {
                    ...
                    if (arrayList4.get(0) instanceof MessageObject) {
                        ...
                        org.telegram.ui.du0 du0Var = ((org.telegram.ui.zr0) this.T).a.g7;
                        obj = du0Var != null ? du0Var.g() : null;
                    } else {
                        obj = "avatar_" + ((org.telegram.ui.zr0) this.T).a.w5;
                    }
            ...
            if (i12 != Integer.MAX_VALUE) {
                while (i12 >= 0) {
                    ...
                    if (arrayList4.get(0) instanceof MessageObject) {
                        ...
                        org.telegram.ui.du0 du0Var2 = ((org.telegram.ui.zr0) this.T).a.g7;
                        sb = du0Var2 != null ? du0Var2.g() : null;
                    } else {
                        StringBuilder sb2 = new StringBuilder(str2);
                        str = str2;
                        sb2.append(((org.telegram.ui.zr0) this.T).a.w5);
                        sb = sb2.toString();
    ...
    */
    public final void b() {
        ...
        PhotoViewer photoViewer = ((org.telegram.ui.zr0) this.T).a;
        int i14 = photoViewer.M4;
        ArrayList arrayList = photoViewer.X6;
        ArrayList arrayList2 = photoViewer.V6;
        org.telegram.ui.du0 du0Var = photoViewer.g7;
        List all = du0Var != null ? du0Var.getAll() : null;
        int i15 = ((org.telegram.ui.zr0) this.T).a.v;
        this.R = false;
        long j11 = 0;
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            boolean z11 = arrayList2.size() > 1 && (hu0Var = ((org.telegram.ui.zr0) this.T).a.d) != null && hu0Var.K();
            if (this.h != 0 || z11) {
                this.R = true;
        ...
        if (z12) {
            if (this.R) {
                ...
                float f10 = this.W;
                if (f10 < 1.0f && this.U == null) {
                    final int i20 = 1;
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, 1.0f);
                    this.U = ofFloat;
                    ofFloat.setDuration((long) ((1.0f - this.W) * 200.0f));
                    this.U.addListener(new v30(this, i20));
                    this.U.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.u30
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            switch (i20) {
                                case 0:
                                    x30 x30Var = this.b;
                                    x30Var.getClass();
                                    x30Var.W = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                                    x30Var.invalidate();
                                    break;
                                default:
                                    x30 x30Var2 = this.b;
                                    x30Var2.getClass();
                                    x30Var2.W = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                                    x30Var2.invalidate();
                                    break;
                            }
                        }
                ...
                if (this.W > 0.0f && arrayList3.size() > 1) {
                    if (this.V == null) {
                        ...
                        this.V = ofFloat2;
                        ofFloat2.setDuration((long) (this.W * 200.0f));
                        final int i21 = 0;
                        this.V.addListener(new v30(this, i21));
                        this.V.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.u30
                            public final /* synthetic */ x30 b;
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator22) {
                                switch (i21) {
                                    case 0:
                                        x30 x30Var = this.b;
                                        x30Var.getClass();
                                        x30Var.W = ((Float) valueAnimator22.getAnimatedValue()).floatValue();
                                        x30Var.invalidate();
                                        break;
                                    default:
                                        x30 x30Var2 = this.b;
                                        x30Var2.getClass();
                                        x30Var2.W = ((Float) valueAnimator22.getAnimatedValue()).floatValue();
                                        x30Var2.invalidate();
                                        break;
                                }
                            }
        ...
        if (!z4) {
            if (i10 == arrayList3.size() && arrayList4.contains(obj)) {
                ...
                if (i22 != indexOf && indexOf != -1) {
                    boolean z13 = this.F;
                    if (!z13 && !this.E && (indexOf == i22 - 1 || indexOf == i22 + 1)) {
                        this.J = true;
                        z13 = true;
                    }
                    int i23 = this.v;
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
                ...
                org.telegram.ui.hu0 hu0Var2 = ((org.telegram.ui.zr0) this.T).a.d;
                boolean z14 = (hu0Var2 != null && hu0Var2.K()) && arrayList2.size() > 1;
                if (this.h != j10 || z14 || i15 != 0) {
                    ...
                    for (int i30 = i13 - 1; i30 >= max2; i30--) {
                        ...
                        if (i15 == 0 && !z14 && messageObject5.getGroupIdForUse() != this.h) {
                            break;
                        }
    ...
    public final void e() {
        ...
        if (i10 >= 0 && i10 < this.e.size()) {
            ...
            this.I = i11;
            this.C = i11;
            this.G = (this.n + this.v) * (this.f - i11);
            this.H = this.w;
            this.x = 1.0f;
            this.Q = -1;
            w30 w30Var = this.T;
            if (w30Var != null) {
                PhotoViewer photoViewer = ((org.telegram.ui.zr0) w30Var).a;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z4 || !arrayList.isEmpty()) {
            ...
            float f12 = this.y;
            int i16 = (int) (f11 * f12);
            int i17 = ((int) ((min - i12) * f12)) + i12 + i16;
            int i18 = this.C;
            ...
            float f13 = this.B;
            int i19 = (int) (f11 * f13);
            int i20 = (int) (((((min2 + i19) - i12) / 2) * f13 * (this.C > this.f ? -1 : 1)) + i11);
            int i21 = ((int) ((min2 - i12) * f13)) + i12 + i19;
            ...
            if (i26 >= 0) {
                ...
                if (f14 > 0.0f) {
                    float f15 = j10;
                    float f16 = f14 - (f15 / (this.J ? 100.0f : 200.0f));
                    this.x = f16;
                    if (i26 == this.f) {
                        float f17 = this.y;
                        if (f17 < 1.0f) {
                        ...
                        this.w = this.H + ((int) Math.ceil(this.y * (this.G - r1)));
                    } else {
                        nr nrVar = nr.g;
                        this.B = nrVar.getInterpolation(1.0f - f16);
                        if (this.N) {
                            float f19 = this.y;
                            if (f19 > 0.0f) {
                            ...
                            this.w = this.H + ((int) Math.ceil(r5 * (this.G - r1)));
                        } else {
                            this.y = nrVar.getInterpolation(this.x);
                            this.w = (int) Math.ceil(this.B * this.G);
                        }
                    }
                    if (this.x <= 0.0f) {
                        this.f = this.I;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.d.isEmpty() && getAlpha() == 1.0f) {
            r1 = this.L.onTouchEvent(motionEvent) || super.onTouchEvent(motionEvent);
