...
public final class qx0 {
    ...
    public final void a(Canvas canvas) {
        ...
        oi0 oi0Var = this.d;
        oi0Var.setBounds(width, AndroidUtilities.dp(13.0f), width + dp, dp2);
        oi0Var.draw(canvas);
        ...
        while (i12 < this.g.length) {
            ...
            int i13 = (int) (f10 + max);
            pz0 pz0Var = this.g[i12];
            pz0Var.c(f11 - (pz0Var.l() / 2.0f), j10, 0.75f, -1, canvas);
            pz0 pz0Var2 = this.h[i12];
            pz0Var2.c(f11 - (pz0Var2.l() / 2.0f), AndroidUtilities.dp(16.0f) + j10, 1.0f, -1, canvas);
            i12++;
            width2 = i13;
        }
        if (this.i) {
