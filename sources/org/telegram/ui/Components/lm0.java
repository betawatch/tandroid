...
public final class lm0 extends Drawable {
    ...
    public final y5 n = new y5(1.0f, new mb0(this, 21), 0, 350, er.h);
    ...
    public final float d(float f10) {
        return org.telegram.ui.Cells.pa.b(0.5f, f10, this.p, this.q);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (f19 > 0.0f || f20 > 0.0f) {
            ...
            float e10 = e(0.5f);
            if (h7.y.a(d10, e9, d11, e10) <= this.p * 0.075f) {
                f11 = f21;
                f12 = 0.5f;
                f13 = 0.25f;
                f14 = 0.0f;
                ...
                f13 = 0.25f;
                f14 = 0.0f;
                canvas2.drawLine(d10, e9, d11, e10, paint);
            }
            canvas2.restore();
        } else {
            f11 = f21;
        ...
        if (f20 > f14) {
            ...
            if (Math.max(h7.y.a(d12, lerp5, lerp4, e11), h7.y.a(d13, lerp6, lerp4, e11)) > this.p * 0.075f) {
                Path path = this.c;
                path.rewind();
        ...
        if (f11 > f14) {
            ...
            if (this.e > 0) {
                float[] fArr = this.i;
                hp.a(fArr, (System.currentTimeMillis() - this.e) % 5400.0f);
                float f22 = fArr[c11];
                float f23 = fArr[c10];
                if (this.k != 2 && !this.l) {
    ...
    public final float e(float f10) {
        return org.telegram.ui.Cells.pa.b(0.5f, f10, this.p, this.r);
    }
