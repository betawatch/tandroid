...
public final class fe extends FrameLayout {
    ...
    public final boolean drawChild(final Canvas canvas, final View view, final long j10) {
        ...
        if (view != null && view == chatActivityEnterView.A0) {
            return chatActivityEnterView.f0(canvas, new Utilities.Callback0Return() { // from class: org.telegram.ui.Components.ee
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            Float f9 = (Float) chatActivityEnterView.x0.get(childAt);
            if (f9 != null) {
                childAt.setTranslationX(f9.floatValue() - childAt.getLeft());
                childAt.animate().translationX(0.0f).setDuration(150L).setInterpolator(jr.f).start();
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ChatActivityEnterView chatActivityEnterView = this.a;
        vd.c cVar = chatActivityEnterView.a5;
        if (cVar.e > 0.0f) {
            cVar.a(max);
        } else {
            cVar.c(max);
