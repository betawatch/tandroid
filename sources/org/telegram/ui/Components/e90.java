...
public final class e90 {
    ...
    public e90(CharacterStyle characterStyle, org.telegram.ui.ActionBar.d6 d6Var, float f7, float f10, int i10) {
    ...
    public final boolean a(Canvas canvas) {
        ...
        if (rect != null || this.h <= 0) {
            ...
            x80 x80Var = (x80) arrayList.get(0);
            RectF rectF = AndroidUtilities.rectTmp;
            x80Var.computeBounds(rectF, false);
            this.m = new Rect((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
            for (int i10 = 1; i10 < this.h; i10++) {
                x80 x80Var2 = (x80) arrayList.get(i10);
                RectF rectF2 = AndroidUtilities.rectTmp;
                x80Var2.computeBounds(rectF2, false);
                Rect rect2 = this.m;
        ...
        if (z10) {
            ...
            float interpolation = rr.f.getInterpolation(Math.min(1.0f, (elapsedRealtime - this.o) / this.q));
    ...
    public final x80 b() {
        ...
        x80 x80Var = !arrayList.isEmpty() ? (x80) arrayList.remove(0) : new x80(0);
        x80Var.c = !this.r;
        x80Var.reset();
