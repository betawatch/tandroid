...
public final class e90 extends TextView {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float a2 = f10 < f11 ? h7.n.a(f10 / AndroidUtilities.dp(10.0f), 0.0f, 1.0f) : 0.0f;
        Matrix matrix = this.a;
        matrix.reset();
        float dp2 = AndroidUtilities.dp(10.0f);
        float f12 = this.c;
        matrix.postScale(com.google.android.recaptcha.internal.a.z(1.0f, a2, dp2 / f12, 1.0f), 1.0f, f12, 0.0f);
        ...
        lp lpVar = this.n;
        if ((z12 && this.e) || !z11) {
            float c10 = s3.c.c(min, 1000.0f, AndroidUtilities.dp(60.0f), this.f);
            this.f = c10;
            if (c10 > measuredWidth + dp) {
