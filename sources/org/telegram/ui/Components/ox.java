...
public final class ox extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a(boolean z10) {
        ...
        boolean z11 = kxVar.f;
        yy yyVar = this.A;
        int i10 = (this.s.e || UserConfig.getInstance(yyVar.Y0).isPremium() || yyVar.Q0) ? this.s.g ? z11 || yyVar.l1.contains(Long.valueOf(kxVar.b.id)) ? 3 : 2 : 0 : 1;
        if ((i10 == 0) != (this.x == 0)) {
            requestLayout();
        }
        this.x = i10;
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(ri0Var, (Property<ri0, Float>) property, fArr);
        float[] fArr2 = new float[1];
        fArr2[c10] = i10 == 1 ? 1.0f : 0.0f;
        Property property2 = FrameLayout.ALPHA;
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(ri0Var, (Property<ri0, Float>) property2, fArr2);
        ...
        ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(s1Var, (Property<ag.s1, Float>) property2, fArr4);
        float[] fArr5 = new float[1];
        fArr5[c10] = i10 == 1 ? 1.0f : 0.6f;
        Property property3 = FrameLayout.SCALE_X;
        ObjectAnimator ofFloat5 = ObjectAnimator.ofFloat(s1Var, (Property<ag.s1, Float>) property3, fArr5);
        float[] fArr6 = new float[1];
        fArr6[c10] = i10 == 1 ? 1.0f : 0.6f;
        Property property4 = FrameLayout.SCALE_Y;
        ObjectAnimator ofFloat6 = ObjectAnimator.ofFloat(s1Var, (Property<ag.s1, Float>) property4, fArr6);
        ...
        this.y.addListener(new nh.n2(this, i10, 6));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            if (this.n != null && (stickerSetById2 = MediaDataController.getInstance(i12).getStickerSetById(this.n.id)) != null && stickerSetById2.set != null) {
                ...
                if (n2Var == null) {
                    n2Var = new ag.r2(this, 10);
                }
                cv.W(n2Var, stickerSetById2, true, null, new lp(this, 14));
                this.n = null;
            }
            ...
            org.telegram.ui.ActionBar.n2 n2Var2 = yyVar.U1;
            if (n2Var2 == null) {
                n2Var2 = new ag.r2(this, 10);
            }
            ...
            if (n2Var3.getFragmentView() != null) {
                MediaDataController.getInstance(n2Var3.getCurrentAccount()).toggleStickerSet(n2Var3.getFragmentView().getContext(), stickerSetById, 0, n2Var3, true, true, xqVar, false);
            }
            this.r = null;
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v) {
            if (this.w == null) {
                ...
                this.w.setColor(this.A.B(org.telegram.ui.ActionBar.g6.d7));
            }
            canvas2 = canvas;
