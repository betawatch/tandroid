...
public final class j11 extends FrameLayout {
    ...
    public j11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        super(context);
        this.I = editorAlert;
        ...
        while (i10 < 4) {
            ...
            this.a.addView(this.n[i10], w7.x5.k(0.0f, 0.0f, i10 != 3 ? 16.0f : 0.0f, 0.0f, 55, 36));
            this.n[i10].addTextChangedListener(new i11(this, i10));
    ...
    public final void d(boolean z10) {
        ...
        ObjectAnimator ofInt = ObjectAnimator.ofInt(e3Var, q6.d, z10 ? 0 : 51);
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        int f7 = hg.c.f(20.0f, (i10 / 2) - (this.b * 2), 1);
        this.r = f7;
        int i14 = f7 * 2;
        int i15 = f7 * 2;
                    ...
                    if (x10 >= i19 + i13 && x10 <= i14 + i19) {
                        ...
                        if (!this.G) {
                            ...
                            for (i12 = 0; i12 < themeEditorView.c.size(); i12++) {
                                ...
                                ((org.telegram.ui.ActionBar.k6) themeEditorView.c.get(i12)).d(b10, false, true);
                            }
