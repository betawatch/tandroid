...
public final class j11 {
    ...
    public Runnable r;
    public long s;
    public final y8 f = new y8((org.telegram.ui.ActionBar.c6) null);
    ...
    public final void c(Canvas canvas, int i10, float f10, float f11, float f12, float f13, boolean z10) {
        ...
        pz0Var.p = i10 - AndroidUtilities.dp(144.66f);
        ...
        if (z10) {
            ...
            int v02 = org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.ic, c6Var);
            ...
            int l1 = org.telegram.ui.ActionBar.g6.l1(0.75f * f13, v02);
            Paint paint = this.n;
            paint.setColor(l1);
        ...
        if (this.e != null) {
            if (this.p.contains(motionEvent.getX(), motionEvent.getY() - (z10 ? this.b.getPaddingTop() : 0))) {
                ...
                if (action != 0) {
                    ...
                    if (ncVar.h && (runnable = this.r) != null) {
                        runnable.run();
                    }
                    ncVar.c(false);
    ...
    public final boolean f(MessageObject messageObject) {
        ...
        if (messageObject == null) {
            ...
            if (isMonoForum) {
                ...
                this.e = new pz0(DialogObject.getName(userOrChat), 14.0f, AndroidUtilities.bold());
            } else {
                ...
                if (topicId == 1) {
                    imageReceiver.setImageBitmap(wf.c.c(view.getContext(), 0.75f, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.v8, this.c), false));
                } else if (findTopic.icon_emoji_id != 0) {
                    this.h = new k5(0, i10, findTopic.icon_emoji_id);
                    imageReceiver.onDetachedFromWindow();
                    this.h.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
                } else {
                    imageReceiver.setImageBitmap(wf.c.e(findTopic));
                }
                this.e = new pz0(findTopic.title, 14.0f, AndroidUtilities.bold());
            }
        }
        return this.e != null;
    }
