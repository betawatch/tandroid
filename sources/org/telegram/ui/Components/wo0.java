...
public final class wo0 {
    ...
    public org.telegram.ui.Cells.u1 n;
    public boolean o;
    public int p;
    public int q;
    public int r;
    ...
    public final void a(Path path, float f7, float f10) {
        ...
        int A = org.telegram.messenger.wh.A(14.0f, this.h, 2);
    ...
    */
    public final void c(Canvas canvas, org.telegram.ui.Cells.u1 u1Var) {
        int i10;
        float f7;
        float f10;
        float f11;
        ...
        boolean z10 = (u1Var2 == null || (messageObject = u1Var2.y7) == null || !messageObject.isVoiceOnce()) ? false : true;
        float[] fArr3 = this.H;
        if (fArr3 == null || (fArr2 = this.I) == null) {
            ...
            if (this.G != null) {
                ...
                while (true) {
                    ...
                    float a2 = w7.q.a((d * f7) - f15, 0.0f, 1.0f);
            ...
            while (i17 < max) {
                float f17 = i17;
                float f18 = dpf2;
                int b10 = w7.q.b((int) Math.floor((f17 / max) * min), 0, min - 1);
                if (i16 < b10) {
        ...
        canvas.restore();
        if (this.M == null) {
            this.M = new vo0(new kc0(this, 26));
        }
        float f19 = this.K;
        if (f19 < 0.99f && (fArr = this.G) != null) {
            ...
            if (i18 >= 0 && i18 < fArr.length) {
                float dpf24 = AndroidUtilities.dpf2(this.G[i18]) * w7.q.a((d * f7) - i18, 0.0f, 1.0f);
                ...
                rectF.set((AndroidUtilities.dpf2(1.0f) + dpf25) - f21, ((-f20) - f21) + AndroidUtilities.dp(7.0f) + A, AndroidUtilities.dpf2(1.0f) + dpf25 + f21, f20 + f21 + AndroidUtilities.dp(7.0f) + A);
                vo0Var = this.M;
                ((Paint) vo0Var.f).setColor(this.q);
                vo0Var.g = rectF;
                float f22 = this.L;
                Paint paint = (Paint) vo0Var.f;
                ArrayList arrayList2 = (ArrayList) vo0Var.e;
                arrayList = (ArrayList) vo0Var.d;
                long currentTimeMillis = System.currentTimeMillis();
                long min2 = Math.min(20L, currentTimeMillis - vo0Var.b);
                vo0Var.b = currentTimeMillis;
                i11 = 0;
                while (i11 < arrayList.size()) {
                    uo0 uo0Var = (uo0) arrayList.get(i11);
                    float f23 = min2;
                    float f24 = uo0Var.f - (f23 / uo0Var.g);
                    uo0Var.f = f24;
                    if (f24 < 0.0f) {
                        ...
                        float f26 = uo0Var.d;
                        float f27 = uo0Var.c;
                        uo0Var.a = (((f26 * f27) * f23) / 500.0f) + f25;
                        float f28 = uo0Var.b;
                        float f29 = uo0Var.e;
                        uo0Var.b = (((f27 * f29) * f23) / 500.0f) + f28;
                        uo0Var.e = f29 - ((AndroidUtilities.dp(0.33f) * min2) / 500.0f);
                    }
                    i11++;
                }
                if (((RectF) vo0Var.g) != null) {
                    int min3 = Math.min(4, vo0Var.a - arrayList.size());
                    for (int i19 = 0; i19 < min3; i19++) {
                        uo0 uo0Var2 = arrayList2.isEmpty() ? new uo0() : (uo0) arrayList2.remove(0);
                        RectF rectF2 = (RectF) vo0Var.g;
                        uo0Var2.a = (Utilities.random.nextFloat() * rectF2.width()) + rectF2.left;
                        RectF rectF3 = (RectF) vo0Var.g;
                        uo0Var2.b = (Utilities.random.nextFloat() * rectF3.height()) + rectF3.top;
                        double nextInt = (Utilities.random.nextInt(200) - 125) * 0.017453292519943295d;
                        uo0Var2.d = ((float) (Math.cos(nextInt) - Math.sin(nextInt))) * 0.8f;
                        uo0Var2.e = ((float) (Math.cos(nextInt) + Math.sin(nextInt))) - 0.2f;
                        uo0Var2.f = 1.0f;
                        uo0Var2.c = AndroidUtilities.dp((Utilities.random.nextFloat() * 7.0f) + 10.0f);
                        uo0Var2.g = AndroidUtilities.lerp(420, 550, Utilities.random.nextFloat());
                        arrayList.add(uo0Var2);
                    }
                }
                for (i12 = 0; i12 < arrayList.size(); i12++) {
                    uo0 uo0Var3 = (uo0) arrayList.get(i12);
                    paint.setAlpha((int) (255.0f * f22 * uo0Var3.f));
                    canvas.drawPoint(uo0Var3.a, uo0Var3.b, paint);
                }
                kc0Var = (kc0) vo0Var.c;
                if (kc0Var == null) {
                    kc0Var.run();
        ...
        vo0Var.g = rectF;
        float f222 = this.L;
        Paint paint2 = (Paint) vo0Var.f;
        ArrayList arrayList22 = (ArrayList) vo0Var.e;
        arrayList = (ArrayList) vo0Var.d;
        long currentTimeMillis2 = System.currentTimeMillis();
        long min22 = Math.min(20L, currentTimeMillis2 - vo0Var.b);
        vo0Var.b = currentTimeMillis2;
        i11 = 0;
        while (i11 < arrayList.size()) {
        }
        if (((RectF) vo0Var.g) != null) {
    ...
    public final void d(Canvas canvas, float f7) {
        ...
        if (d > 0.0f) {
            ...
            canvas.restore();
            org.telegram.ui.Cells.u1 u1Var = this.n;
            if (u1Var != null) {
                u1Var.invalidate();
            }
        }
