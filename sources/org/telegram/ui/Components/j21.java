    ...
    public final void b(int i10) {
        ...
        if (this.f != i10) {
            ...
            if (i11 >= 1 && i11 < 60) {
                str = hc.b.j(i10, "");
                if (str.length() < 2) {
                    str = org.telegram.messenger.a2.h(R.string.SecretChatTimerSeconds, a4.a.u(str));
                }
            } else if (i11 >= 60 && i11 < 3600) {
                str = "" + (i10 / 60);
                if (str.length() < 2) {
                    str = org.telegram.messenger.a2.h(R.string.SecretChatTimerMinutes, a4.a.u(str));
                }
            } else if (i11 >= 3600 && i11 < 86400) {
                str = "" + ((i10 / 60) / 60);
                if (str.length() < 2) {
                    str = org.telegram.messenger.a2.h(R.string.SecretChatTimerHours, a4.a.u(str));
                }
            } else if (i11 >= 86400 && i11 < 604800) {
                str = "" + (((i10 / 60) / 60) / 24);
                if (str.length() < 2) {
                    str = org.telegram.messenger.a2.h(R.string.SecretChatTimerDays, a4.a.u(str));
                }
            } else if (i11 < 2678400) {
                str = "" + ((((i10 / 60) / 60) / 24) / 7);
                if (str.length() < 2) {
                    str = org.telegram.messenger.a2.h(R.string.SecretChatTimerWeeks, a4.a.u(str));
                ...
                str = "" + ((((i10 / 60) / 60) / 24) / 30);
                if (str.length() < 2) {
                    str = org.telegram.messenger.a2.h(R.string.SecretChatTimerMonths, a4.a.u(str));
                }
            } else {
                str = "" + ((((i10 / 60) / 60) / 24) / 364);
                if (str.length() < 2) {
                    str = org.telegram.messenger.a2.h(R.string.SecretChatTimerYears, a4.a.u(str));
                }
            }
            String str2 = str;
