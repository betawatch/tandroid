...
public class j21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public TextPaint E;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.n != 1.0f && (i21Var2 = this.h) != null) {
        ...
        if (this.n != 1.0f && (i21Var = this.h) != null) {
    ...
    public final void f(lp lpVar, long j3, boolean z10) {
        ...
        if (z11 || z12) {
            ...
            if (lpVar2 == null || (d4Var = lpVar2.a) == null) {
                ...
                Paint paint = i21Var.c;
                Paint paint2 = i21Var.a;
                Paint paint3 = i21Var.b;
                paint.setColor(i16);
    ...
    public void setBackgroundColor(int i10) {
        ...
        this.s.setColor(org.telegram.ui.ActionBar.j6.v0(i11, e6Var));
        TextPaint textPaint = this.E;
        if (textPaint != null) {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.We, e6Var));
        }
        invalidate();
    }
