            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof q5) && (y3Var = ((q5) drawable).k) != null && y3Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (!rl0Var.e || z10) {
                            o5Var.v = (int) ((o5Var == this.u ? 1.0f : 0.3f) * 255.0f * rl0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(rl0Var.a);
                            float dp2 = AndroidUtilities.dp(rl0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * rl0Var.c * e7;
    ...
    */
    public final void e(Canvas canvas, RectF rectF, float f7) {
        ...
        if (e7 > 0.0f && !this.i) {
            ...
            rectF2.set(rectF.left, (AndroidUtilities.lerp(0.0f, 1.0f - pr.i.getInterpolation(w7.p.a(((Math.max(pow, 0.5f) + 1.5f) % 3.5f) * 0.5f, 0.0f, 1.0f)), e7) * rectF.height()) + rectF.top, rectF.left + AndroidUtilities.dp(6.0f), (AndroidUtilities.lerp(1.0f, 1.0f - pr.g.getInterpolation(w7.p.a((((pow + 1.5f) % 3.5f) - 1.5f) * 0.5f, 0.0f, 1.0f)), e7) * rectF.height()) + rectF.top);
        ...
        int h = i0.a.h(org.telegram.ui.ActionBar.j6.l1(e10 * f7, a10), l12);
        int h10 = this.j ? i0.a.h(org.telegram.ui.ActionBar.j6.l1(f7 * e11, a11), l12) : 0;
    ...
    public final void i() {
        ...
        float e7 = this.M.e(this.S);
        this.T = (Math.min(30L, currentTimeMillis - this.V) * e7) + this.T;
        this.U = (Math.min(30L, currentTimeMillis - this.V) * e7) + this.U;
