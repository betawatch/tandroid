...
public final class sl0 extends Transition {
    ...
    public final void captureEndValues(TransitionValues transitionValues) {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                viewGroup = ((org.telegram.ui.ActionBar.e3) ex0Var).containerView;
                map.put("offset", Integer.valueOf(viewGroup.getTop() + ex0Var.a0));
                break;
            case 2:
    ...
    public final void captureStartValues(TransitionValues transitionValues) {
        ...
        switch (this.a) {
            ...
            case 2:
                View view = transitionValues.view;
                org.telegram.ui.at0 at0Var = ((PhotoViewer) this.b).P1;
                if (view == at0Var) {
            ...
            default:
                View view2 = transitionValues.view;
                org.telegram.ui.at0 at0Var2 = ((SecretMediaViewer) this.b).W;
                if (view2 == at0Var2) {
    ...
    public final Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        switch (i10) {
            case 0:
                ...
                ofFloat.addUpdateListener(new v60(this, 13));
                return ofFloat;
            case 1:
                int i13 = ((ex0) obj).a0;
                ...
                ofFloat2.addUpdateListener(new lh.t4(this, intValue3, i13, 4));
                return ofFloat2;
            case 2:
                PhotoViewer photoViewer = (PhotoViewer) obj;
                if (transitionValues.view == photoViewer.P1) {
                    ValueAnimator ofInt = ValueAnimator.ofInt(((Integer) transitionValues.values.get("scrollY")).intValue(), 0);
                    ofInt.addListener(new org.telegram.ui.ct0(this, i12));
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(photoViewer.M1, (Property<org.telegram.ui.qt0, Float>) View.TRANSLATION_Y, 0.0f, intValue);
                ofFloat3.addListener(new org.telegram.ui.ct0(this, i11));
                return ofFloat3;
            default:
                ...
                if (transitionValues.view == secretMediaViewer.W) {
                    ...
                    ofInt2.addListener(new org.telegram.ui.s31(this, i12));
                ...
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(secretMediaViewer.V, (Property<org.telegram.ui.qt0, Float>) View.TRANSLATION_Y, 0.0f, intValue2);
                ofFloat4.addListener(new org.telegram.ui.s31(this, i11));
                return ofFloat4;
        }
    }
