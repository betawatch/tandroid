...
public abstract class s01 extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        int primaryHorizontal3 = (int) (((this.a.getPrimaryHorizontal(this.n) - this.a.getPrimaryHorizontal(this.r)) * this.v) + e2.c.w(1.0f, this.v, AndroidUtilities.dpf2(4.0f), this.a.getPrimaryHorizontal(this.r)));
        canvas2.save();
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int D = org.telegram.messenger.y3.D(8.0f, 2, this.a.getHeight());
