...
public class PollVotesAlert$UserCell extends LinearLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.x || this.y != 0.0f) {
            qg0 qg0Var = this.F;
            qg0Var.G.setAlpha((int) (this.y * 255.0f));
            u9 u9Var = this.a;
            ...
            qg0Var.M.set(dp, r5 - AndroidUtilities.dp(4.0f), dp + dp2, AndroidUtilities.dp(4.0f) + r5);
            ...
            qg0Var.M.set(dp3, r5 - AndroidUtilities.dp(4.0f), dp3 + dp4, AndroidUtilities.dp(4.0f) + r5);
            canvas.drawRoundRect(qg0Var.M, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), qg0Var.G);
        }
        if (this.v) {
