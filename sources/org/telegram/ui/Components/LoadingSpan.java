...
public class LoadingSpan extends ReplacementSpan {
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        int i6 = this.size;
        if (this.fullWidth && (view = this.view) != null && view.getMeasuredWidth() > 0) {
            i6 = ((this.view.getMeasuredWidth() - this.view.getPaddingLeft()) - this.view.getPaddingRight()) - this.size;
        }
        ...
        if (f2 > 0.0f) {
            ...
            int i7 = (int) f;
            float f4 = f2 / 2.0f;
            this.drawable.setBounds(i7, (int) (f3 - f4), i6 + i7, (int) (f3 + f4));
        } else {
            int i8 = (int) f;
        ...
        this.drawable.setAlpha((int) ((paint == null ? NotificationCenter.didReceiveSmsCode : paint.getAlpha()) * this.alpha));
