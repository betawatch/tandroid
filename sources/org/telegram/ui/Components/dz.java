    ...
    public final void p1() {
        ...
        if (this.K > 0 && (adapter = (recyclerView = this.N).getAdapter()) != null) {
            ...
            for (int i12 = this.O; i12 < h; i12++) {
                ...
                if (o1Var == null) {
                    o1Var = adapter.g(recyclerView, j10);
                    View view = o1Var.a;
