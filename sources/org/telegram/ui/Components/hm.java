    ...
    public final void a() {
        ...
        while (i11 < size) {
            ...
            if (hashMap2.containsKey(photoEntry)) {
                ...
                pm.R.put(photoEntry, Boolean.valueOf(z4));
            }
            if (z4) {
                int i14 = i12;
                i12 = i13;
        ...
        if (size == 1) {
            ...
            for (int i16 = 1; i16 < size2; i16++) {
                ...
                if (i16 <= 3 && i17 <= 3) {
                    ...
                    gm gmVar = new gm();
                    gmVar.a = new int[]{i16, i17};
                    gmVar.b = new float[]{b10, b11};
                    ...
                    if (i19 < i20) {
                        ...
                        if (i18 <= 3) {
                            if (i19 <= (f14 < 0.85f ? 4 : 3) && i21 <= 3) {
                                ...
                                gm gmVar2 = new gm();
                                gmVar2.a = new int[]{i18, i19, i21};
                                gmVar2.b = new float[]{b12, b13, b14};
                        ...
                        while (true) {
                            ...
                            if (i26 < i27) {
                                ...
                                if (i23 > 3 || i24 > 3 || i26 > 3 || i28 > 3) {
                                    ...
                                    gm gmVar3 = new gm();
                                    gmVar3.a = new int[]{i23, i24, i26, i28};
                                    i10 = size2;
                                    gmVar3.b = new float[]{b15, b16, b17, b18};
                                    arrayList3.add(gmVar3);
                                }
                                i26++;
                                size2 = i10;
                            }
            ...
            for (int i31 = 0; i31 < arrayList3.size(); i31++) {
                gm gmVar5 = (gm) arrayList3.get(i31);
                float f16 = Float.MAX_VALUE;
                float f17 = 0.0f;
                int i32 = 0;
                while (true) {
                    float[] fArr2 = gmVar5.b;
                    if (i32 >= fArr2.length) {
                        break;
                    }
                    float f18 = fArr2[i32];
