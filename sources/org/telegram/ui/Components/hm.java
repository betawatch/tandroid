...
public final class hm extends el0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        t5Var.d(b02, hashMap.size() > 1, z10 && chatAttachAlertPhotoLayout.T0 == chatAttachAlertPhotoLayout.U0, i10 == h() - 1, viVar != null && viVar.i0);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        vi viVar = chatAttachAlertPhotoLayout.b;
        org.telegram.ui.ActionBar.e6 e6Var = chatAttachAlertPhotoLayout.a;
        if (i10 == 0) {
        ...
        if (i10 == 2) {
            return new gl0(new ci.eb(this, context, 13));
        }
        if (i10 == 4) {
            viVar.getClass();
            return new gl0(new gm(this, context));
        }
        if (i10 == 5) {
        ...
        if (i10 == 7) {
            ...
            g20Var.c.setOnClickListener(new dt(5, g20Var, new y2(this, 2)));
            return new gl0(g20Var);
        }
        if (i10 == 8) {
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.aa, e6Var);
        ...
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.ba, e6Var), mode));
        n5Var.addView(imageView2, w7.y5.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
        TextView textView = new TextView(context);
        n5Var.c = textView;
        org.telegram.messenger.wh.m(org.telegram.ui.ActionBar.j6.ca, e6Var, textView, 1, 12.0f);
