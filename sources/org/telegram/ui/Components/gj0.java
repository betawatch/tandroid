...
public class gj0 extends BitmapDrawable implements Animatable, kf.e {
    ...
    static {
        final int i10 = 0;
        O0 = Executors.newFixedThreadPool(4, new ThreadFactory() { // from class: org.telegram.ui.Components.fj0
        ...
        final int i11 = 1;
        P0 = Executors.newFixedThreadPool(2, new ThreadFactory() { // from class: org.telegram.ui.Components.fj0
            @Override // java.util.concurrent.ThreadFactory
            public final Thread newThread(Runnable runnable) {
                switch (i11) {
                    case 0:
    ...
    */
    public gj0(File file, String str, int i10, int i11, ke.i iVar, boolean z4, int i12, boolean z10) {
        ...
        this.g0 = new RectF[2];
        this.h0 = new Paint[2];
        this.u0 = new ej0(this, 1);
        this.v0 = new ej0(this, 2);
        this.x0 = new ej0(this, 3);
        this.y0 = new ej0(this, 4);
        ...
        try {
            try {
                ...
                this.A0 = new kf.g(file, this, iVar, i10, i11, !z4, i12);
            }
        } catch (Exception e6) {
            e = e6;
            FileLog.e((Throwable) e, false);
    ...
    public gj0(int i10, int i11, int i12, boolean z4, int[] iArr) {
        ...
        if (find != -1) {
            ...
            if (TextUtils.isEmpty(readRes)) {
                ...
                nVar.d = readRes;
                this.k0 = RLottieNative.b(readRes, iArr2, (int[]) nVar.c, hashMap);
            }
        }
        if (this.D) {
