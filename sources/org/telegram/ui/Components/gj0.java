...
public final class gj0 extends FrameLayout {
    ...
    public gj0(Context context, org.telegram.ui.ActionBar.c6 c6Var, int i10, MessageObject messageObject, TLRPC.ReactionCount reactionCount, boolean z10) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            yi0Var.setVerticalScrollbarThumbDrawable(new ColorDrawable(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.i6, false)));
        }
        ...
        this.h = bj0Var;
        bj0Var.f(org.telegram.ui.ActionBar.g6.G8, org.telegram.ui.ActionBar.g6.i6, -1);
        bj0Var.setIsSingleCell(true);
        bj0Var.setItemsCount(this.a);
    ...
    public static /* synthetic */ void a(gj0 gj0Var, TLObject tLObject) {
        ArrayList arrayList = gj0Var.D;
        LongSparseArray longSparseArray = gj0Var.r;
        ArrayList arrayList2 = gj0Var.n;
        int i10 = gj0Var.b;
        ...
        for (int i11 = 0; i11 < tL_messages_messageReactionsList.reactions.size(); i11++) {
            ...
            ig.q0 d = ig.q0.d(tL_messages_messageReactionsList.reactions.get(i11).reaction);
            if (d.g != 0) {
                hashSet.add(d);
            }
    ...
    public final void h(List list) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                TLObject tLObject = vi0Var.a;
                if (vi0Var.c > 0) {
                    int i10 = 0;
                    while (true) {
                        if (i10 < arrayList.size()) {
                            TLRPC.MessagePeerReaction messagePeerReaction = (TLRPC.MessagePeerReaction) arrayList.get(i10);
                            if (messagePeerReaction != null && messagePeerReaction.date <= 0 && MessageObject.getPeerId(messagePeerReaction.peer_id) == vi0Var.b) {
                                messagePeerReaction.date = vi0Var.c;
        ...
        while (it2.hasNext()) {
            ...
            if (((ArrayList) longSparseArray.get(j10)) == null) {
                ...
                tL_messagePeerReaction.date = vi0Var2.c;
    ...
    public final void i() {
        ...
        while (true) {
            ...
            TLRPC.InputStickerSet inputStickerSet = MessageObject.getInputStickerSet(k5.f(i10, ((ig.q0) arrayList3.get(i11)).g));
        ...
        arrayList.addAll(arrayList2);
        ga0 ga0Var = new ga0(this.b, getContext(), this.G, arrayList2, 1);
        this.F = ga0Var;
        ga0Var.G = false;
    }
    ...
    public final void j() {
        if (this.y != null) {
            ...
            ga0 ga0Var = this.F;
            if (ga0Var != null) {
                dp = org.telegram.messenger.y1.C(8.0f, ga0Var.getMeasuredHeight(), dp);
            }
            yi0 yi0Var = this.e;
            if (yi0Var.getMeasuredHeight() != 0) {
                dp = Math.min(yi0Var.getMeasuredHeight(), dp);
            }
            this.y.a(this, dp);
        }
    }
