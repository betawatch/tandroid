...
public final class j9 {
    ...
    public final i9[] b = new i9[3];
    public final i9[] c = new i9[3];
    public float e = 1.0f;
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        while (true) {
            ...
            i9VarArr3[i11] = i9VarArr[i11];
            i9 i9Var = i9VarArr[i11];
            long j3 = i9Var.g;
            i9 i9Var2 = i9VarArr2[i11];
            if (j3 != i9Var2.g) {
                z12 = true;
            } else {
                i9Var.d = i9Var2.d;
        ...
        for (int i12 = 0; i12 < 3; i12++) {
            ...
            while (true) {
                ...
                if (i9VarArr[i13].g == i9VarArr2[i12].g) {
                    i9VarArr3[i13] = null;
                    if (i12 == i13) {
                        i9 i9Var3 = i9VarArr2[i12];
                        i9Var3.i = -1;
                        org.telegram.ui.Cells.c4 c4Var = i9Var3.b;
                        i9 i9Var4 = i9VarArr[i12];
                        i9Var3.b = i9Var4.b;
                        i9Var4.b = c4Var;
                    } else {
                        i9 i9Var5 = i9VarArr2[i12];
                        i9Var5.i = 2;
                        i9Var5.j = i13;
                    }
                } else {
    ...
    */
    public final void i(Canvas canvas) {
        ...
        while (true) {
            ...
            i9[] i9VarArr4 = i9VarArr;
            if (i9VarArr2[i25].g != 0) {
                i26++;
            }
            i25++;
            i9VarArr = i9VarArr4;
        }
        i9[] i9VarArr5 = i9VarArr;
        int i27 = this.k;
        ...
        if (z18) {
            ...
            while (i28 >= 0) {
                ...
                while (i29 < i10) {
                    if (i29 != 0 || this.e != f21) {
                        i9[] i9VarArr6 = i29 == 0 ? i9VarArr3 : i9VarArr5;
                        if (i29 != z14 || this.e == f21 || i9VarArr6[i28].i == z14) {
                            ImageReceiver imageReceiver = i9VarArr6[i28].e;
                            if (imageReceiver.hasImageSet()) {
                                if (i29 == 0) {
                                    if (this.l) {
                                        f15 = 1.0f;
                                        i17 = org.telegram.messenger.wh.A(z15 ? 8.0f : 4.0f, this.p - (i26 * i21), i10);
                                    } else {
                                        f15 = 1.0f;
                                        i17 = dp2;
                                    }
                                ...
                                if (this.e != f15) {
                                    ...
                                    if (i31 == z14) {
                                        ...
                                        if (this.l) {
                                            i16 = org.telegram.messenger.wh.A(z15 ? 8.0f : 4.0f, this.p - (i26 * i21), i10);
                                        } else {
                                            i16 = dp2;
                                        }
                                        int i32 = (i21 * i28) + i16;
                                        ...
                                        int A = org.telegram.messenger.wh.A(z15 ? 8.0f : 4.0f, this.p - (i26 * i21), i10) + (i21 * i28);
                                        float f25 = this.e;
        ...
        for (int i36 = 2; i36 >= 0; i36--) {
            ...
            while (i37 < 2) {
                ...
                i9[] i9VarArr7 = i37 == 0 ? i9VarArr3 : i9VarArr5;
                if (i37 != 1 || this.e == f10 || i9VarArr7[i36].i == 1) {
                    ImageReceiver imageReceiver2 = i9VarArr7[i36].e;
                    if (imageReceiver2.hasImageSet()) {
                        if (i37 == 0) {
                            if (this.l) {
                                i14 = org.telegram.messenger.wh.A(z15 ? 8.0f : 4.0f, this.p - (i26 * i21), 2);
                            } else {
                                i14 = dp2;
                            }
                            ...
                            if (i38 != 11) {
                                ...
                                if (this.e != 1.0f) {
                                    ...
                                    if (i39 == 1) {
                                        ...
                                        if (this.l) {
                                            i13 = org.telegram.messenger.wh.A(z15 ? 8.0f : 4.0f, this.p - (i26 * i21), 2);
                                        } else {
                                            i13 = dp2;
                                        }
                                        int i40 = (i21 * i36) + i13;
                                        ...
                                        int A2 = org.telegram.messenger.wh.A(z15 ? 8.0f : 4.0f, this.p - (i26 * i21), 2) + (i21 * i36);
                                        float f30 = this.e;
                                    ...
                                    z10 = true;
                                    f12 = f11 * this.u;
                                    if (i36 == i9VarArr7.length - 1 || this.x) {
                                        i11 = this.k;
                                        paint = this.i;
                                        if (i11 != 1 || i11 == 3 || i11 == 5) {
                                            ...
                                            if (i9Var.b == null) {
                                                if (this.k == 5) {
                                                    i9Var.b = new org.telegram.ui.Cells.c4(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(16.0f));
                                                } else {
                                                    i9Var.b = new org.telegram.ui.Cells.c4(AndroidUtilities.dp(17.0f), AndroidUtilities.dp(21.0f));
                                                }
                                            }
                                            if (this.k == 5) {
                                                i9VarArr7[i36].b.d(i0.a.k(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.qg, false), (int) (f13 * 76.5f)));
                                            }
                                            i9Var2 = i9VarArr7[i36];
                                            groupCallParticipant = i9Var2.f;
                                            if (groupCallParticipant == null && groupCallParticipant.amplitude > 0.0f) {
                                                i9Var2.b.e(view, true);
                                                i9VarArr7[i36].b.c(r4.f.amplitude * 15.0f);
                                                if (this.k == 5 && SystemClock.uptimeMillis() - i9VarArr7[i36].f.lastSpeakTime > 500) {
                                                    this.j.run();
                                                }
                                                i9VarArr7[i36].b.f();
                                                if (this.k == 5) {
                                                    i9VarArr7[i36].b.a(canvas2, imageReceiver2.getCenterX(), imageReceiver2.getCenterY(), view);
                                                    f();
                                                }
                                                b10 = i9VarArr7[i36].b.b();
                                            ...
                                            i9 i9Var3 = i9VarArr7[i36];
                                            if (i9Var3.b == null) {
                                                i9Var3.b = new org.telegram.ui.Cells.c4(AndroidUtilities.dp(17.0f), AndroidUtilities.dp(21.0f));
                                            }
                                            if (this.k == 10) {
                                                i9VarArr7[i36].b.d(i0.a.k(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.qg, false), (int) (f12 * 76.5f)));
                                            } else {
                                                i9VarArr7[i36].b.d(i0.a.k(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.pg, false), (int) (f12 * 76.5f)));
                                            }
                                            long currentTimeMillis = System.currentTimeMillis();
                                            i9 i9Var4 = i9VarArr7[i36];
                                            z11 = z10;
                                            if (currentTimeMillis - i9Var4.c > 100) {
                                                i9Var4.c = currentTimeMillis;
                                                if (this.k == 10) {
                                                    TLRPC.GroupCallParticipant groupCallParticipant2 = i9Var4.f;
                                                    if (groupCallParticipant2 == null || groupCallParticipant2.amplitude <= 0.0f) {
                                                        i9Var4.b.e(view, false);
                                                    } else {
                                                        i9Var4.b.e(view, true);
                                                        i9VarArr7[i36].b.c(r4.f.amplitude * 15.0f);
                                                    }
                                                } else {
                                                    long currentTime = ConnectionsManager.getInstance(UserConfig.selectedAccount).getCurrentTime();
                                                    i9 i9Var5 = i9VarArr7[i36];
                                                    f13 = f12;
                                                    if (currentTime - i9Var5.d <= 5) {
                                                        i9Var5.b.e(view, true);
                                                        i9VarArr7[i36].b.c(this.z.nextInt() % 100);
                                                    } else {
                                                        i9Var5.b.e(view, false);
                                                        i9VarArr7[i36].b.c(0.0d);
                                                    }
                                                    i9VarArr7[i36].b.f();
                                                    i9VarArr7[i36].b.a(canvas2, imageReceiver2.getCenterX(), imageReceiver2.getCenterY(), view);
                                                    b10 = i9VarArr7[i36].b.b();
    ...
    public final void j(int i10) {
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            i9 i9Var = this.b[i11];
            if (i9Var != null && (h9Var2 = i9Var.a) != null) {
                h9Var2.u(i10);
            }
            i9 i9Var2 = this.c[i11];
            if (i9Var2 != null && (h9Var = i9Var2.a) != null) {
                h9Var.u(i10);
            }
        }
    }
    ...
    public final void l(int i10, TLObject tLObject, int i11) {
        ...
        if (tLObject instanceof TLRPC.GroupCallParticipant) {
            ...
            i9VarArr[i10].g = peerId;
        } else if (tLObject instanceof TLRPC.User) {
            TLRPC.User user2 = (TLRPC.User) tLObject;
            if (user2.self && this.a) {
                i9Var.a.g(1);
                i9VarArr[i10].a.p = 0.6f;
            } else {
                i9Var.a.g(0);
                h9 h9Var = i9VarArr[i10].a;
                h9Var.p = 1.0f;
                h9Var.m(i11, user2);
            }
            i9VarArr[i10].g = user2.id;
            user = user2;
            chat = null;
        } else if (tLObject instanceof TLRPC.Chat) {
            chat = (TLRPC.Chat) tLObject;
            i9Var.a.g(0);
            h9 h9Var2 = i9VarArr[i10].a;
            h9Var2.p = 1.0f;
            h9Var2.k(i11, chat);
            i9VarArr[i10].g = -chat.id;
            user = null;
        } else {
            user = null;
            chat = null;
        ...
        if (tLObject instanceof TL_stories.StoryItem) {
            ...
            i9Var2.e.setForUserOrChat(chat, i9Var2.a);
        } else if (user.self && this.a) {
            i9 i9Var3 = i9VarArr[i10];
            i9Var3.e.setImageBitmap(i9Var3.a);
        } else {
            i9 i9Var4 = i9VarArr[i10];
            i9Var4.e.setForUserOrChat(user, i9Var4.a);
        }
