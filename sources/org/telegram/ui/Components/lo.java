...
public final class lo {
    ...
    public lo(Context context, int i10, ah0 ah0Var, boolean z4, final ko koVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.g = i10;
        this.i = koVar;
        jo joVar = new jo(context, z4 ? R.drawable.popup_fixed_alert : 0, 0, f6Var, 0);
        joVar.R = new Path();
        this.f = joVar;
        joVar.setFitItems(true);
        if (ah0Var != null) {
            num = 1;
            actionBarPopupWindow$ActionBarPopupWindowLayout = joVar;
        ...
        this.b = c10;
        final int i11 = 0;
        c10.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ho
        ...
        this.d = c11;
        final int i12 = 1;
        c11.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ho
            public final /* synthetic */ lo b;
        ...
        this.e = c12;
        final int i13 = 2;
        c12.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ho
            public final /* synthetic */ lo b;
        ...
        Integer num2 = num;
        org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.msg_mute_period, LocaleController.getString(R.string.MuteForPopup), false, f6Var).setOnClickListener(new io(this, context, f6Var, i10, koVar, 0));
        final int i14 = 3;
        org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.msg_customize, LocaleController.getString(R.string.NotificationsCustomize), false, f6Var).setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ho
            public final /* synthetic */ lo b;
        ...
        this.c = c13;
        final int i15 = 4;
        c13.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ho
            public final /* synthetic */ lo b;
        ...
        final int i16 = 5;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ho
            public final /* synthetic */ lo b;
