...
public class vl0 extends RecyclerView implements ah.a {
            ...
            if (layoutManager instanceof s4.c0) {
                ...
                if (c0Var.o == 1) {
                    if (this.g1 == null) {
                        ...
                        if ((!this.K1 && !z10) || (cl0Var = this.f1) == null || cl0Var.n) {
                            return;
                        }
                        ...
                        if (adapter instanceof dl0) {
                            ...
                            this.f1.setIsVisible(dl0Var.E(this));
                    ...
                    if ((this.K1 || z10) && (cl0Var2 = this.f1) != null && !cl0Var2.n && (getAdapter() instanceof dl0)) {
    ...
    public final void L0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            org.telegram.ui.si siVar = this.h2;
            int[] iArr2 = this.m2;
            org.telegram.ui.eo eoVar = siVar.d;
            iArr2[0] = (int) eoVar.s9;
            iArr2[1] = eoVar.Aa;
            ...
            if (rectF.contains(min2, min)) {
                ...
                if (i11 != S) {
                    ...
                    org.telegram.ui.eo eoVar2 = this.h2.d;
                    org.telegram.ui.pm pmVar = eoVar2.A0;
                    ArrayList arrayList = eoVar2.u6;
                    int i13 = S - pmVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) eoVar2.x6.f(messageObject.getGroupId())) != null) {
                            ArrayList<MessageObject> arrayList2 = groupedMessages.messages;
                            S = arrayList.indexOf(arrayList2.get(z10 ? 0 : arrayList2.size() - 1)) + eoVar2.A0.J;
                        }
                    }
                    if (z10) {
                        int i14 = this.g2;
    ...
    public final void O0(Canvas canvas, View view, View view2, boolean z10, boolean z11) {
        ...
        float bottomInfoMargin = view2 instanceof u80 ? ((u80) view2).getBottomInfoMargin() : 0.0f;
        RectF rectF = AndroidUtilities.rectTmp;
    ...
    */
            ...
            for (int i14 = 0; i14 < getChildCount(); i14++) {
                ...
                if (childAt2 != this.c1 && childAt2.getVisibility() == 0 && childAt2.getAlpha() > 0.0f && ((Boolean) this.H2.a.run(childAt2)).booleanValue()) {
                    ...
                    if (!T.j() || childAt2.getAlpha() >= 1.0f) {
                        ...
                        sl0Var2.b = G0;
                        sl0Var2.c = alpha2;
                        arrayList2.add(sl0Var2);
                    }
                }
            }
            ArrayList arrayList3 = this.O2;
            float f12 = this.L2;
            ArrayList arrayList4 = tl0.a;
            if (arrayList3 == null || arrayList3.isEmpty()) {
                f7 = 1.0f;
            } else {
                Collections.sort(arrayList3, new m9(6));
                arrayList4.clear();
                int i16 = 0;
                while (i16 < arrayList3.size()) {
                    float f13 = ((sl0) arrayList3.get(i16)).b;
                    int i17 = i16 + 1;
                    while (i17 < arrayList3.size() && ((sl0) arrayList3.get(i17)).a <= f13 + 1.5f) {
                        f13 = Math.max(f13, ((sl0) arrayList3.get(i17)).b);
                        i17++;
                    }
                    ...
                    for (int i18 = i16; i18 < i17; i18++) {
                        sl0 sl0Var3 = (sl0) arrayList3.get(i18);
                        if (sl0Var3.c >= 0.99f) {
                            f16 = Math.min(f16, sl0Var3.a);
                            f17 = Math.max(f17, sl0Var3.b);
                        }
                    }
                    boolean z10 = f16 != Float.MAX_VALUE;
                    float f18 = 0.0f;
                    for (int i19 = i16; i19 < i17; i19++) {
                        sl0 sl0Var4 = (sl0) arrayList3.get(i19);
                        f14 = Math.min(f14, sl0Var4.a);
                        f15 = Math.max(f15, sl0Var4.b);
                        f18 = Math.max(f18, sl0Var4.c);
                    }
                    if (f18 >= 0.001f) {
                        if (z10) {
                            float f19 = 0.0f;
                            ...
                            for (int i20 = i16; i20 < i17; i20++) {
                                sl0 sl0Var6 = (sl0) arrayList3.get(i20);
                                float f20 = sl0Var6.c;
                                if (f20 < 0.99f) {
                                    float f21 = sl0Var6.a;
                                    if (f21 < f16) {
                            ...
                            float f23 = 0.0f;
                            while (i16 < i17) {
                                sl0 sl0Var8 = (sl0) arrayList3.get(i16);
                                float f24 = sl0Var8.c;
                                if (f24 < 0.99f) {
                                    float f25 = sl0Var8.b;
                                    if (f25 > f17) {
            ...
            if (zk0Var.d || zk0Var.e) {
                for (int i10 = 0; i10 < vl0Var.getChildCount(); i10++) {
                    ...
                    if (R >= 0 && !zk0Var.c.contains(childAt)) {
                        Float f7 = (Float) zk0Var.b.get(R, null);
                        if (f7 == null) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (cl0Var != null) {
            this.J1 = true;
            int paddingTop = i11 + (cl0Var.a ? getPaddingTop() : cl0Var.h0);
            cl0 cl0Var2 = this.f1;
            if (cl0Var2.g0) {
                cl0Var2.layout(0, paddingTop, cl0Var2.getMeasuredWidth(), this.f1.getMeasuredHeight() + paddingTop);
            } else {
                int measuredWidth = getMeasuredWidth() - this.f1.getMeasuredWidth();
                cl0 cl0Var3 = this.f1;
                cl0Var3.layout(measuredWidth, paddingTop, cl0Var3.getMeasuredWidth() + measuredWidth, this.f1.getMeasuredHeight() + paddingTop);
            }
            this.J1 = false;
        }
        K0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (cl0Var != null && cl0Var.getLayoutParams() != null) {
            cl0 cl0Var2 = this.f1;
            int measuredHeight = (getMeasuredHeight() - (cl0Var2.a ? getPaddingTop() : cl0Var2.h0)) - getPaddingBottom();
    ...
    public void setAdapter(s4.h0 h0Var) {
        ...
        fg.q1 q1Var = this.t2;
        if (adapter != null) {
            adapter.a.unregisterObserver(q1Var);
        }
    ...
    public void setFastScrollEnabled(int i10) {
        this.f1 = new cl0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.f1);
        }
    }
    ...
    public vl0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        super.setOnScrollListener(new al0(this, i10));
