...
public class vl0 extends RecyclerView implements bh.a {
    ...
    public final void L0(boolean z10) {
        ...
        if (!z10) {
            ...
            if (i10 == 0) {
                ...
                alpha.setDuration(150L).setListener(new dd0(this, 8)).start();
            }
        }
        if (this.A1) {
            int i11 = T0 ? 4 : 0;
    ...
    public final void Q0(Canvas canvas, View view, View view2, boolean z10, boolean z11) {
        ...
        float bottomInfoMargin = view2 instanceof s80 ? ((s80) view2).getBottomInfoMargin() : 0.0f;
        RectF rectF = AndroidUtilities.rectTmp;
    ...
    */
        ...
        if (al0Var != null) {
            ...
            if (al0Var.d || al0Var.e) {
                for (int i10 = 0; i10 < vl0Var.getChildCount(); i10++) {
                    ...
                    int S = RecyclerView.S(childAt);
                    if (S >= 0 && !al0Var.c.contains(childAt)) {
                        Float f7 = (Float) al0Var.b.get(S, null);
                        if (f7 == null) {
    ...
    public final void f1(gl0 gl0Var, int i10, boolean z10) {
        jc0 jc0Var = this.V1;
        if (jc0Var != null) {
            AndroidUtilities.cancelRunOnUIThread(jc0Var);
            this.V1 = null;
        }
        s4.c1 L = L(gl0Var.run());
        if (L == null) {
            if (z10) {
                this.U1 = gl0Var;
                return;
    ...
    public final void g0(View view) {
        ...
        s4.c1 H = H(view);
        if (H != null) {
            view.setEnabled(((ul0) getAdapter()).D(H));
            if (this.q2) {
    ...
    public final void m1(vl0 vl0Var, boolean z10) {
        ViewParent parent;
    ...
    public final void o1(ml0 ml0Var, long j3) {
        this.Y0 = ml0Var;
        ka.c cVar = this.M1;
    ...
    public vl0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.D2 = new org.telegram.ui.Cells.u6(this, 21);
        this.P2 = new Path();
        this.p2 = f6Var;
        ot otVar = new ot();
        this.E2 = otVar;
        ...
        super.setOnScrollListener(new sb0(this, 4));
    ...
    public void setOnItemLongClickListener(ml0 ml0Var) {
        o1(ml0Var, ViewConfiguration.getLongPressTimeout());
    }
}
