...
public final class gk0 extends View {
    ...
    public gk0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.b = new Paint(1);
        this.c = new Paint(1);
        this.d = new Paint(1);
        ...
        this.M = new Path();
        qr qrVar = qr.h;
        this.N = new c6(this, 0L, 340L, qrVar);
        this.O = new c6(this, 0L, 340L, qrVar);
        this.P = true;
        this.a = e6Var;
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        Paint paint4 = this.b;
        paint4.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.lf, e6Var);
        Paint paint5 = this.c;
        paint5.setColor(v03);
        ...
        m6 m6Var2 = this.h;
        m6Var2.r(v04);
        int v05 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.ff, e6Var);
        fg0 fg0Var2 = this.f;
        fg0Var2.a.setColor(v05);
        int v06 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.gf, e6Var);
        Paint paint6 = this.d;
        paint6.setColor(v06);
        ...
        float f7 = lerp;
        float f10 = i10;
        canvas.drawRect(f7, rectF.top, f10, rectF.bottom, paint2);
        if (this.U) {
            clamp = this.V;
        } else {
            clamp = Utilities.clamp(this.n != null ? r3.n() / this.n.p() : 1.0f, this.v, this.s);
        }
        float clamp2 = Utilities.clamp(AndroidUtilities.lerp(rectF.left + AndroidUtilities.dp(13.0f), rectF.right - AndroidUtilities.dp(14.0f), clamp), f10, f7);
        if (clamp2 < f10) {
            canvas.save();
        ...
        if (e > 0.0f) {
            float d = (int) (m6Var.d() + AndroidUtilities.dp(30.0f));
            ...
            fg0 fg0Var3 = fg0Var;
            fg0Var3.setBounds(0, (-dp8) / 2, dp8, dp8 / 2);
            fg0Var3.g = (int) (e * 255.0f);
            fg0Var3.draw(canvas);
            canvas.restore();
            if (e7 > 0.0f) {
                canvas.save();
                ...
                m6 m6Var3 = m6Var;
                m6Var3.setBounds(-1, -1, 1, 1);
                m6Var3.w = (int) (e7 * 255.0f * e);
                m6Var3.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z12) {
                b();
                this.V = this.n != null ? r0.n() / this.n.p() : 1.0f;
                setPlaying(false);
            }
            ...
            if (z13) {
                ...
                if (g71Var != null) {
                    ...
                    this.V = clamp;
                    g71Var.L((long) (clamp * this.n.p()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.T) {
                ...
                g71 g71Var2 = this.n;
                if (g71Var2 != null) {
                    g71Var2.L((long) (this.s * g71Var2.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.w) {
                g71 g71Var3 = this.n;
                if (g71Var3 != null) {
                    g71Var3.L(Math.max((long) (this.s * g71Var3.p()), ((long) (this.v * this.n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
        ...
        return this.T || this.R || this.S || this.U || super.dispatchTouchEvent(motionEvent);
    }
