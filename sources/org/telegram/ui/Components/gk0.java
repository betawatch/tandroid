...
public class gk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public gk0(int i10, int i11, Context context, org.telegram.ui.ActionBar.n2 n2Var, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        int i12 = 1;
        w0Var.j(new kg0(this, i12));
        w0Var.i(new tj0(this, i12));
    ...
    public static void a(gk0 gk0Var) {
        ...
        if (cVar != null) {
            dh.e eVar = gk0Var.a1;
            org.telegram.ui.q51 q51Var = c0Var.m.f0;
            q51Var.x = true;
    ...
    */
                ...
                if (this.v != 0.0f) {
                    ...
                    if (getAlpha() == 1.0f || i18 == 5) {
                                ...
                                if (p0Var3.equals(this.l0)) {
                                    ...
                                    if (!this.r0) {
                                        if (this.Q == null) {
                                            ...
                                            if (dk0Var3.getImageReceiver().hasBitmapImage() || ((q5Var = dk0Var3.e) != null && (l4Var = q5Var.k) != null && l4Var.hasBitmapImage())) {
                                    ...
                                    w0Var2 = w0Var3;
                                    int R2 = RecyclerView.R(ek0Var);
                                    float measuredWidth = (((this.p0 - 1.0f) * ek0Var.getMeasuredWidth()) / 3.0f) - (((1.0f - this.q0) * ek0Var.getMeasuredWidth()) * (Math.abs(this.m0 - R2) - 1));
                                    if (R2 < this.m0) {
                                    ...
                                    if ((childAt.getMeasuredWidth() / f14) + childAt.getX() <= 0.0f || (childAt.getMeasuredWidth() / f14) + childAt.getX() >= w0Var2.getWidth()) {
                                        ...
                                        if (childAt == this.S) {
                                            if ((childAt.getMeasuredWidth() / f14) + childAt.getX() <= f17 || (childAt.getMeasuredWidth() / f14) + childAt.getX() >= w0Var2.getWidth()) {
                                                tr trVar = this.v0;
                                                trVar.setScaleX(0.0f);
                                                trVar.setScaleY(0.0f);
                                                ((gk0) trVar.c).S.invalidate();
                                                ValueAnimator valueAnimator = (ValueAnimator) trVar.b;
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    if (this.v != 1.0f) {
                                                        tr trVar2 = this.v0;
                                                        trVar2.setScaleX(0.0f);
                                                        trVar2.setScaleY(0.0f);
                                                        ((gk0) trVar2.c).S.invalidate();
                                                        ValueAnimator valueAnimator2 = (ValueAnimator) trVar2.b;
                                                    ...
                                                    trVar3.invalidate();
                                                    ValueAnimator valueAnimator3 = (ValueAnimator) trVar3.b;
                                                    if (valueAnimator3 != null) {
                                                        valueAnimator3.removeAllListeners();
                                                        ((ValueAnimator) trVar3.b).cancel();
                                                    }
                                                    if (z11) {
                                                        ValueAnimator ofFloat = ValueAnimator.ofFloat(trVar3.getScaleX(), 1.0f);
                                                        trVar3.b = ofFloat;
                                                        ofFloat.setInterpolator(AndroidUtilities.overshootInterpolator);
                                                        ((ValueAnimator) trVar3.b).addUpdateListener(new i70(trVar3, 7));
                                                        ((ValueAnimator) trVar3.b).setStartDelay((long) (abs * ((gk0) trVar3.c).c));
                                                        ((ValueAnimator) trVar3.b).setDuration(300L);
                                                        ((ValueAnimator) trVar3.b).start();
                                                    } else {
                                                        trVar3.setScaleX(1.0f);
                                                        trVar3.setScaleY(1.0f);
                                                    }
                                                    abs += 30;
                                                }
                        ...
                        if (!this.c1 && this.x0 != null) {
                            int A = (int) org.telegram.messenger.z0.A(1.0f, this.w0, Utilities.clamp(1.0f - (this.w0 / 0.2f), 1.0f, 0.0f), 255.0f);
                            canvas.save();
    ...
    public final void f(float f7, float f10, float f11, int i10, Canvas canvas) {
        ...
        RectF rectF = this.w;
        if (z10) {
            canvas.clipRect(0.0f, 0.0f, getMeasuredWidth(), (AndroidUtilities.lerp(rectF.top, getMeasuredHeight(), rr.f.getInterpolation(this.O)) - ((int) Math.ceil((1.0f - this.v) * (rectF.height() / 2.0f)))) + 1.0f);
        } else {
            float f13 = rectF.bottom;
            rr rrVar = rr.f;
            canvas.clipRect(0.0f, (AndroidUtilities.lerp(f13, 0.0f, rrVar.getInterpolation(this.O)) - ((int) Math.ceil((1.0f - this.v) * (rectF.height() / 2.0f)))) - 1.0f, getMeasuredWidth(), AndroidUtilities.lerp(AndroidUtilities.dp(8.0f) + getMeasuredHeight(), getPaddingTop() - g(), rrVar.getInterpolation(this.O)));
        }
        ...
        boolean z12 = this.L;
        float f22 = this.F;
        float lerp = AndroidUtilities.lerp(z12 ? (getPaddingTop() - g()) - AndroidUtilities.dp(16.0f) : ((getHeight() - f22) - f15) + g(), (f22 + f15) - g(), rr.f.getInterpolation(this.O));
    ...
    public void setSelectedEmojis(ArrayList<String> arrayList) {
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.b, (Utilities.Callback<View>) new sj0(this, 0));
    }
    ...
    public void setTransitionProgress(float f7) {
        ...
        if (toVar != null) {
            ...
            toVar.setReactionsTransitionProgress(f7);
        }
        invalidate();
    }
