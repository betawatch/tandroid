...
public class gk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float s;
    public long s0;
    public org.telegram.ui.ActionBar.o2 t0;
    public rg.b1 u0;
    public float v;
    public sr v0;
    ...
    public static void a(gk0 gk0Var) {
        ...
        zg.c0 c0Var = new zg.c0(gk0Var.M0, gk0Var.t0, gk0Var.V, gk0Var.d0, gk0Var, gk0Var.k0, gk0Var.a);
        gk0Var.x0 = c0Var;
        ah.c cVar = gk0Var.Z0;
        boolean z10 = true;
        if (cVar != null) {
            dh.e eVar = gk0Var.a1;
            org.telegram.ui.z51 z51Var = c0Var.m.f0;
            z51Var.x = true;
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f23 != 1.0f) {
                ...
                p0Var = this.l0;
                i10 = this.M0;
                if (p0Var != null && i10 != 5 && ((fk0Var = this.g0) == null || fk0Var.j())) {
                    f22 = this.n0;
                    if (f22 != 1.0f) {
                ...
                if (this.v != 0.0f) {
                    ...
                    if (getAlpha() == 1.0f || i18 == 5) {
                        ...
                        while (i19 < w0Var3.getChildCount()) {
                            ...
                            float f34 = f25;
                            if (childAt instanceof ek0) {
                                ek0 ek0Var = (ek0) w0Var3.getChildAt(i19);
                                i14 = i19;
                                if (this.B0 != 0.0f) {
                                    i13 = save3;
                                    f19 = AndroidUtilities.dp(46.0f) * Utilities.clamp(ek0Var.getLeft() / (getMeasuredWidth() - AndroidUtilities.dp(34.0f)), 1.0f, 0.0f) * getPullingLeftProgress();
                                } else {
                                    i13 = save3;
                                    f19 = 0.0f;
                                }
                                ...
                                dk0 dk0Var3 = ek0Var.c;
                                rectF4 = rectF;
                                if (p0Var3.equals(this.l0)) {
                                    dk0 dk0Var4 = dk0Var2.getVisibility() == 0 ? dk0Var2 : dk0Var;
                                    ek0Var.setPivotX(ek0Var.getMeasuredWidth() >> 1);
                                    ek0Var.setPivotY(dk0Var4.getY() + dk0Var4.getMeasuredHeight());
                                    ek0Var.setScaleX(this.p0);
                                    ek0Var.setScaleY(this.p0);
                                    if (!this.r0) {
                                        if (this.Q == null) {
                                            dk0Var3.setVisibility(0);
                                            dk0Var3.setAlpha(1.0f);
                                            if (dk0Var3.getImageReceiver().hasBitmapImage() || ((o5Var = dk0Var3.e) != null && (l4Var = o5Var.k) != null && l4Var.hasBitmapImage())) {
                                                dk0Var4.setAlpha(0.0f);
                                            }
                                            f21 = 1.0f;
                                        } else {
                                            f21 = 1.0f;
                                            dk0Var3.setAlpha(1.0f - this.o0);
                                            dk0Var4.setAlpha(this.o0);
                                        }
                                        if (this.n0 == f21) {
                                            this.r0 = true;
                                            if (System.currentTimeMillis() - this.s0 > 300) {
                                                ...
                                                w0Var2 = w0Var3;
                                                this.g0.h(ek0Var, ek0Var.e, true, false);
                                                canvas2.save();
                                                x10 = ek0Var.getX() + w0Var2.getX();
                                                scaleX = ((ek0Var.getScaleX() * ek0Var.getMeasuredWidth()) - ek0Var.getMeasuredWidth()) / f14;
                                                f20 = x10 - scaleX;
                                                if (f20 >= 0.0f && ek0Var.getTranslationX() >= 0.0f) {
                                                    ek0Var.setTranslationX((-f20) - f35);
                                                } else if (ek0Var.getMeasuredWidth() + x10 + scaleX > getMeasuredWidth() || ek0Var.getTranslationX() > 0.0f) {
                                                    ek0Var.setTranslationX(0.0f - f35);
                                                } else {
                                                    ek0Var.setTranslationX((((getMeasuredWidth() - x10) - ek0Var.getMeasuredWidth()) - scaleX) - f35);
                                                }
                                                canvas2.translate(ek0Var.getX() + w0Var2.getX(), ek0Var.getY() + w0Var2.getY());
                                                canvas2.scale(ek0Var.getScaleX(), ek0Var.getScaleY(), ek0Var.getPivotX(), ek0Var.getPivotY());
                                                ek0Var.draw(canvas2);
                                                canvas2.restore();
                                            }
                                        }
                                    ...
                                    if (ek0Var.getMeasuredWidth() + x10 + scaleX > getMeasuredWidth()) {
                                    }
                                    ek0Var.setTranslationX(0.0f - f35);
                                    canvas2.translate(ek0Var.getX() + w0Var2.getX(), ek0Var.getY() + w0Var2.getY());
                                    canvas2.scale(ek0Var.getScaleX(), ek0Var.getScaleY(), ek0Var.getPivotX(), ek0Var.getPivotY());
                                    ...
                                    w0Var2 = w0Var3;
                                    int S2 = RecyclerView.S(ek0Var);
                                    float measuredWidth = (((this.p0 - 1.0f) * ek0Var.getMeasuredWidth()) / 3.0f) - (((1.0f - this.q0) * ek0Var.getMeasuredWidth()) * (Math.abs(this.m0 - S2) - 1));
                                    if (S2 < this.m0) {
                                        ek0Var.setPivotX(0.0f);
                                        ek0Var.setTranslationX(-measuredWidth);
                                    } else {
                                        ek0Var.setPivotX(ek0Var.getMeasuredWidth() - f35);
                                        ek0Var.setTranslationX(measuredWidth - f35);
                                    }
                                    ek0Var.setPivotY(dk0Var.getY() + dk0Var.getMeasuredHeight());
                                    ek0Var.setScaleX(this.q0);
                                    ek0Var.setScaleY(this.q0);
                                    dk0Var3.setVisibility(4);
                                    dk0Var.setAlpha(1.0f);
                                }
                                if (childAt.getLeft() > i20) {
                                    i20 = childAt.getLeft();
                                }
                                if (!this.N0 && (!ek0Var.r || dk0Var.getImageReceiver().getLottieAnimation() != null)) {
                                    if ((ek0Var.getMeasuredWidth() / f14) + ek0Var.getX() > 0.0f && (ek0Var.getMeasuredWidth() / f14) + ek0Var.getX() < w0Var2.getWidth()) {
                                        if (!hashSet.contains(ek0Var)) {
                                            ek0Var.c(abs);
                                            abs += 30;
                                        }
                                        hashSet2.add(ek0Var);
                                            ...
                                            if ((childAt.getMeasuredWidth() / f14) + childAt.getX() <= f17 || (childAt.getMeasuredWidth() / f14) + childAt.getX() >= w0Var2.getWidth()) {
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    ...
                                                    if (z11) {
                                                        ...
                                                        ((ValueAnimator) srVar3.b).addUpdateListener(new h70(srVar3, 7));
                                                        ((ValueAnimator) srVar3.b).setStartDelay((long) (abs * ((gk0) srVar3.c).c));
                        ...
                        if (pullingLeftProgress > 0.0f) {
                            ...
                            int measuredWidth3 = ek0Var2.getMeasuredWidth() - AndroidUtilities.dp(f14);
                            float f36 = i20 + measuredWidth3;
                            float clamp2 = Utilities.clamp(f36 / (getMeasuredWidth() - ek0Var2.getMeasuredWidth()), 1.0f, 0.0f) * pullingLeftProgress2 * measuredWidth3;
                            if (ek0Var2.getTag() == null) {
                                ek0Var2.setTag(Float.valueOf(1.0f));
                                ek0Var2.d();
                                ek0Var2.c(0);
                            }
                            float clamp3 = Utilities.clamp(pullingLeftProgress2, 1.0f, 0.0f);
                            ek0Var2.setScaleX(clamp3);
                            ek0Var2.setScaleY(clamp3);
                            ek0Var2.setTranslationX(((w0Var.getX() + f36) - clamp2) + (-((i18 == 1 || i18 == 2) ? AndroidUtilities.dp(8.0f) : AndroidUtilities.dp(20.0f))));
                            if (ek0Var2.getVisibility() != 0) {
                                ek0Var2.setVisibility(0);
                            }
                        } else {
                            if (ek0Var2.getVisibility() != 8 && this.O0) {
                                ek0Var2.setVisibility(8);
                            }
                            if (ek0Var2.getTag() != null) {
                                ek0Var2.setTag(null);
                            }
    ...
    public final void p(MessageObject messageObject, TLRPC.ChatFull chatFull, boolean z10) {
        ...
        if (q()) {
            ...
            if (i16 < arrayList2.size()) {
                ek0.a(this.z0, (zg.p0) arrayList2.get(i16), -1);
            }
        } else {
        ...
        for (int i18 = 0; i18 < arrayList8.size(); i18++) {
            ...
            arrayList9.add(new xj0(p0Var3.f == null ? 3 : 0, p0Var3));
        }
    ...
    public void setSelectedEmojis(ArrayList<String> arrayList) {
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.b, (e2.h) new sj0(this, 0));
    }
