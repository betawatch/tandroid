...
public abstract class pm0 extends HorizontalScrollView {
    ...
    public pm0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        super(context);
        this.a = 1;
        this.b = om0.a;
        this.h = new HashMap();
        ...
        this.k0 = new Paint();
        this.l0 = true;
        this.m0 = new z5(this, 350L, nrVar);
        ...
        hb1 hb1Var = new hb1(this, context, 9);
        this.e = hb1Var;
        hb1Var.setOrientation(0);
        hb1Var.setPadding(AndroidUtilities.dp(9.5f), 0, AndroidUtilities.dp(9.5f), 0);
        addView(hb1Var, new FrameLayout.LayoutParams(-1, -1, 16));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            hb1Var = this.e;
            if (i11 >= hb1Var.getChildCount()) {
                break;
            }
            if (hb1Var.getChildAt(i11) instanceof fx0) {
                fx0 fx0Var = (fx0) hb1Var.getChildAt(i11);
        ...
        if (isInEditMode() || this.x == 0 || this.G < 0) {
            ...
            View view = null;
            View childAt = (floor < 0 || floor >= hb1Var.getChildCount()) ? null : hb1Var.getChildAt(floor);
            if (ceil >= 0 && ceil < hb1Var.getChildCount()) {
                view = hb1Var.getChildAt(ceil);
            }
            float f17 = f15 / 2.0f;
            ...
            float interpolation = nr.i.getInterpolation(this.f0);
        ...
        Paint paint2 = this.E;
        paint2.setColor(i12);
        canvas2.drawRect(0.0f, f15 - this.J, hb1Var.getWidth(), f15, paint2);
    }
    ...
    public final boolean e(int i10) {
        ...
        hb1 hb1Var = this.e;
        if (i10 >= hb1Var.getChildCount()) {
            return false;
        }
        View childAt = hb1Var.getChildAt(i10);
        if (!(childAt instanceof fx0)) {
            return false;
        }
    ...
    public final boolean f(MotionEvent motionEvent) {
            ...
            if (this.s != null) {
                ...
                if (i10 != i11) {
                    ...
                    for (int i12 = 0; i12 < hb1Var.getChildCount(); i12++) {
                        hb1Var.getChildAt(i12).setTag(R.id.index_tag, Integer.valueOf(i12));
                    }
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                ofFloat.addUpdateListener(new i70(this, 12));
                ofFloat.addListener(new nd0(this, 7));
                ofFloat.start();
            }
            this.V = false;
            j();
        ...
        if (this.R != ceil && e(ceil)) {
            for (int i14 = 0; i14 < hb1Var.getChildCount(); i14++) {
                if (i14 != this.R) {
                    fx0 fx0Var = (fx0) hb1Var.getChildAt(i14);
            ...
            this.R = ceil;
            hb1Var.removeView(this.s);
            hb1Var.addView(this.s, this.R);
            invalidate();
        }
    ...
    public final void h() {
        ...
        if (hashMap != null) {
            ...
            while (it.hasNext()) {
                hb1Var.removeView((View) ((Map.Entry) it.next()).getValue());
            }
            this.n.clear();
        }
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (hb1Var.indexOfChild(view) != keyAt) {
                hb1Var.removeView(view);
                hb1Var.addView(view, keyAt);
            }
        }
        sparseArray.clear();
    }
    ...
    public final void i(final float f10, final boolean z4) {
        if (this.c0 != z4) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.km0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (!z4) {
                        ...
                        float f11 = f10;
                        float childCount2 = (scrollX + f11) / (pm0Var.g0 * hb1Var.getChildCount());
            ...
            this.e0.addListener(new jh.r(this, z4, f10, 1));
            this.e0.start();
            hb1 hb1Var = this.e;
            if (z4) {
                this.d0 = true;
            ...
            if (z4) {
                float childCount = this.g0 * hb1Var.getChildCount() * ((getScrollX() + f10) / (this.h0 * hb1Var.getChildCount()));
    ...
    public final void k(int i10, int i11) {
        ...
        while (true) {
            boolean z4 = true;
            if (i13 >= hb1Var.getChildCount()) {
                break;
            }
            View childAt2 = hb1Var.getChildAt(i13);
            if (i13 != i10) {
                z4 = false;
            }
    ...
    public final void l(int i10) {
        if (this.x != 0) {
            hb1 hb1Var = this.e;
            if (hb1Var.getChildAt(i10) == null) {
                return;
            }
            int left = hb1Var.getChildAt(i10).getLeft();
            int i11 = this.I;
            if (i10 > 0) {
                left -= i11;
            }
    ...
    */
    public final void n() {
        ...
        hb1 hb1Var2 = this.e;
        int paddingLeft = (int) ((scrollX - hb1Var2.getPaddingLeft()) / f11);
        int i13 = 1;
        int min = Math.min(hb1Var2.getChildCount(), ((int) Math.ceil(getMeasuredWidth() / f11)) + paddingLeft + 1);
        if (this.d0) {
            paddingLeft -= 2;
            min += 2;
            if (paddingLeft < 0) {
            ...
            if (min > hb1Var2.getChildCount()) {
                min = hb1Var2.getChildCount();
            }
        }
        ...
        while (paddingLeft < min) {
            View childAt = hb1Var2.getChildAt(paddingLeft);
            if (childAt instanceof fx0) {
                fx0 fx0Var = (fx0) childAt;
                int i15 = fx0Var.s;
                p9 p9Var = fx0Var.e;
                if (fx0Var.a == 2) {
                    ...
                    if (tag3 instanceof TLRPC.Document) {
                        if (!fx0Var.c) {
                            fx0Var.v = DocumentObject.getSvgThumb((TLRPC.Document) tag3, org.telegram.ui.ActionBar.j6.c7, 0.2f);
                        }
                        ...
                        if (tag4 instanceof TLRPC.TL_messages_stickerSet) {
                            ...
                            if (fx0Var.c) {
                                ...
                                i10 = paddingLeft;
                                i11 = min;
                                fx0Var.v = DocumentObject.getSvgThumb(arrayList, org.telegram.ui.ActionBar.j6.c7, 0.2f, DocumentObject.containsPhotoSizeType(arrayList, "v"));
                            }
                        } else {
                            i10 = paddingLeft;
                            i11 = min;
                    ...
                    if (!fx0Var.c && fx0Var.v == null && document != null) {
                        fx0Var.v = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.c7, 0.2f);
                    }
                    if (forSticker != null) {
                        fx0Var.c = true;
