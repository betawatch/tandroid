...
public final class w40 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public w40(Context context, String str, org.telegram.ui.bo boVar, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        aj0Var.getAnimatedDrawable().S(MessagesStorage.LAST_DB_VERSION, xpVar);
        ...
        aj0Var2.setBackground(org.telegram.ui.ActionBar.i6.K(dp2, org.telegram.ui.ActionBar.i6.v0(i12, e6Var)));
        aj0Var2.setScaleType(ImageView.ScaleType.CENTER);
        aj0Var2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i11, e6Var), PorterDuff.Mode.MULTIPLY));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (!this.n && ((180 - aj0Var.getAnimatedDrawable().a0) * 16.6d) + 3000.0d >= importingHistory.timeUntilFinish) {
        ...
        if (i10 == NotificationCenter.stickersImportProgressChanged) {
            ...
            if (!this.n && ((180 - aj0Var.getAnimatedDrawable().a0) * 16.6d) + 3000.0d >= importingStickers.timeUntilFinish) {
                aj0Var.setAutoRepeat(false);
                this.n = true;
            }
