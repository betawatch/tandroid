...
public final class gn0 extends Drawable {
    ...
    public final z5 n = new z5(1.0f, new ec0(this, 21), 0, 350, pr.h);
    ...
    public final float d(float f10) {
        return org.telegram.ui.yh.c(0.5f, f10, this.p, this.q);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (f19 > 0.0f || f20 > 0.0f) {
            ...
            float e10 = e(0.5f);
            if (k7.o6.a(d10, e6, d11, e10) <= this.p * 0.075f) {
                f11 = f21;
                f12 = 0.5f;
                f13 = 0.25f;
                f14 = 0.0f;
                ...
                f13 = 0.25f;
                f14 = 0.0f;
                canvas2.drawLine(d10, e6, d11, e10, paint);
            }
            canvas2.restore();
        } else {
            f11 = f21;
        ...
        if (f20 > f14) {
            ...
            if (Math.max(k7.o6.a(d12, lerp5, lerp4, e11), k7.o6.a(d13, lerp6, lerp4, e11)) > this.p * 0.075f) {
                Path path = this.c;
                path.rewind();
    ...
    public final float e(float f10) {
        return org.telegram.ui.yh.c(0.5f, f10, this.p, this.r);
    }
