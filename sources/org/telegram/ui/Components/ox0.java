...
public final class ox0 extends FrameLayout {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        wx0 wx0Var = this.e;
        int i23 = wx0Var.e0;
        i10 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingTop;
        int dp = AndroidUtilities.dp(6.0f) + (i23 - i10);
        int i24 = wx0Var.e0;
        i11 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingTop;
        ...
        if (this.c) {
            ...
            int i30 = i29 * 2;
            if (i28 < i30) {
                i22 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingTop;
            ...
            if (i31 < i32) {
                ...
                drawable = ((org.telegram.ui.ActionBar.g3) wx0Var).shadowDrawable;
                drawable.setBounds(0, i26, getMeasuredWidth(), getMeasuredHeight());
                drawable2 = ((org.telegram.ui.ActionBar.g3) wx0Var).shadowDrawable;
                drawable2.draw(canvas);
                RectF rectF = this.b;
                if (f7 != 1.0f) {
                    org.telegram.ui.ActionBar.j6.t0.setColor(wx0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
                    i15 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingLeft;
                    i16 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingTop;
                    int measuredWidth = getMeasuredWidth();
                    i17 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingLeft;
                    float f10 = measuredWidth - i17;
                    i18 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingTop;
                ...
                org.telegram.ui.ActionBar.j6.t0.setColor(wx0Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
                ...
                if (bool != null || bool.booleanValue() != z10) {
                    boolean z11 = AndroidUtilities.computePerceivedBrightness(wx0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) <= 0.721f;
                    boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(wx0Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f;
                    this.d = Boolean.valueOf(z10);
                    if (!z10) {
                        z11 = z12;
                    }
                    AndroidUtilities.setLightStatusBar(wx0Var.getWindow(), z11);
                }
                if (i12 <= 0) {
                    org.telegram.ui.ActionBar.j6.t0.setColor(wx0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
                    ...
                    i14 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingLeft;
        ...
        if (AndroidUtilities.computePerceivedBrightness(wx0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) <= 0.721f) {
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(wx0Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f) {
        }
        this.d = Boolean.valueOf(z10);
        if (!z10) {
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            wx0 wx0Var = this.e;
            if (wx0Var.e0 != 0 && motionEvent.getY() < wx0Var.e0) {
                wx0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        wx0Var.g0 = false;
        if (wx0Var.s0()) {
            int measuredWidth = wx0Var.c.getMeasuredWidth();
            if (measuredWidth == 0) {
                measuredWidth = AndroidUtilities.displaySize.x;
            }
            wx0Var.d.d = Math.max(1, measuredWidth / AndroidUtilities.dp(AndroidUtilities.isTablet() ? 60.0f : 45.0f));
        ...
        float f7 = wx0Var.d.d;
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) wx0Var.c.getLayoutParams();
        if (arrayList != null) {
            int max = (Math.max(3, (int) Math.ceil(arrayList.size() / f7)) * wx0Var.P) + AndroidUtilities.dp(48.0f) + marginLayoutParams.bottomMargin;
            i19 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingTop;
            i17 = i19 + max + AndroidUtilities.statusBarHeight;
        } else {
            if (wx0Var.W != null) {
                int size3 = (wx0Var.d.n * wx0Var.P) + (wx0Var.W.size() * AndroidUtilities.dp(60.0f)) + AndroidUtilities.dp(8.0f) + marginLayoutParams.bottomMargin;
                i18 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingTop;
                i16 = i18 + size3;
                i15 = AndroidUtilities.dp(24.0f);
            } else {
                int max2 = (Math.max(wx0Var.s0() ? 2 : 3, wx0Var.S != null ? (int) Math.ceil(r4.documents.size() / f7) : 0) * wx0Var.P) + AndroidUtilities.dp(48.0f) + marginLayoutParams.bottomMargin;
                i14 = ((org.telegram.ui.ActionBar.g3) wx0Var).backgroundPaddingTop;
                i15 = i14 + max2;
        ...
        if (wx0Var.c.getPaddingTop() != i21) {
            wx0Var.g0 = true;
            wx0Var.c.setPadding(AndroidUtilities.dp(10.0f), i21, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(8.0f));
            wx0Var.K.setPadding(0, i21, 0, 0);
            wx0Var.g0 = false;
        }
        this.c = i17 >= size;
