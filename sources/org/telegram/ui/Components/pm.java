    ...
    public final void a() {
        ...
        while (i11 < size) {
            ...
            if (hashMap2.containsKey(photoEntry)) {
                ...
                xm.U.put(photoEntry, Boolean.valueOf(z10));
            }
            if (z10) {
                int i14 = i12;
                i12 = i13;
        ...
        if (size == 1) {
            ...
            for (int i16 = 1; i16 < size2; i16++) {
                ...
                if (i16 <= 3 && i17 <= 3) {
                    ...
                    om omVar = new om();
                    omVar.a = new int[]{i16, i17};
                    omVar.b = new float[]{b10, b11};
                    ...
                    if (i19 < i20) {
                        ...
                        if (i18 <= 3) {
                            if (i19 <= (f13 < 0.85f ? 4 : 3) && i21 <= 3) {
                                ...
                                om omVar2 = new om();
                                omVar2.a = new int[]{i18, i19, i21};
                                omVar2.b = new float[]{b12, b13, b14};
                        ...
                        while (true) {
                            ...
                            if (i26 < i27) {
                                ...
                                if (i23 > 3 || i24 > 3 || i26 > 3 || i28 > 3) {
                                    ...
                                    om omVar3 = new om();
                                    omVar3.a = new int[]{i23, i24, i26, i28};
                                    i10 = size2;
                                    omVar3.b = new float[]{b15, b16, b17, b18};
                                    arrayList3.add(omVar3);
                                }
                                i26++;
                                size2 = i10;
                            }
            ...
            for (int i31 = 0; i31 < arrayList3.size(); i31++) {
                om omVar5 = (om) arrayList3.get(i31);
                float f15 = Float.MAX_VALUE;
                float f16 = 0.0f;
                int i32 = 0;
                while (true) {
                    float[] fArr2 = omVar5.b;
                    if (i32 >= fArr2.length) {
                        break;
                    }
                    float f17 = fArr2[i32];
