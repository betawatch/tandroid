...
public final class pm extends ei {
    ...
    public final void D(ei eiVar) {
        ...
        if (eiVar instanceof ChatAttachAlertPhotoLayout) {
            ...
            omVar.requestLayout();
            this.s.h1(0, 0);
            this.r.post(new org.telegram.ui.mp(29, this, eiVar));
    ...
    public int getSelectedItemsCount() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (nmVar != null && (hmVar = nmVar.k) != null && (arrayList = hmVar.g) != null) {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.Q != z10) {
            this.Q = z10;
            int size = omVar.b.size();
            for (int i14 = 0; i14 < size; i14++) {
                nm nmVar = (nm) omVar.b.get(i14);
                if (nmVar.k.g.size() == 1) {
    ...
    public final void q() {
        ...
        while (i10 < size) {
            ...
            while (i11 < size2) {
                ...
                i11++;
                mm mmVar = (mm) obj2;
                if (mmVar.e && (photoEntry = mmVar.b) != null) {
        ...
        if (!AndroidUtilities.isTablet()) {
            ...
            if (point.x > point.y) {
                ...
                if (d1Var.getPaddingTop() == this.O || d1Var.getPaddingBottom() != this.e) {
                    d1Var.n1(d1Var.getPaddingLeft(), this.O, d1Var.getPaddingRight(), this.e);
                    invalidate();
                }
