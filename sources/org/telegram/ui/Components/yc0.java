...
public class yc0 extends LinearLayout {
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.B) {
            ...
            if (strArr != null) {
                ...
                uc0 uc0Var = this.H;
                str = uc0Var != null ? uc0Var.e(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.D;
                    uc0 uc0Var = this.H;
                    str = uc0Var != null ? uc0Var.e(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z4) {
        ...
        int e6 = this.d0 ? e(i10) : Math.min(Math.max(i10, this.x), this.B);
        int i11 = this.D;
        this.E = e6;
        this.D = e6;
        n();
        if (Math.abs(i11 - e6) > 0.9f) {
        ...
        f();
        invalidate();
        if (this.h0 != 0 || (vc0Var = this.G) == null) {
            return;
        }
        vc0Var.g(0);
    }
    ...
    */
    ...
    public yc0(Context context, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.d.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.j5, g6Var));
