...
public class cw0 extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    ...
    public final void I() {
        ...
        if (this.v == null) {
            ...
            this.v = c91Var2;
            c91Var2.n = new mv(this, 22);
            if (getMeasuredWidth() != 0 && getMeasuredHeight() != 0) {
                c91 c91Var3 = this.v;
                int measuredWidth = getMeasuredWidth();
                int measuredHeight = getMeasuredHeight();
                c91Var3.getClass();
                this.y = c91.a(measuredWidth, measuredHeight);
            }
        }
        if (this.F) {
            return;
    ...
    */
        ...
        if (!F()) {
            ...
            if (this.d0.getShader() != null) {
                ...
                if (z10) {
                    ...
                    yv0 yv0Var = this.Q;
                    matrix.preScale(yv0Var.d, yv0Var.e);
                    if (this.R != null) {
                        matrix2.setTranslate(0.0f, (f14 - r6.a) - 34.0f);
                        yv0 yv0Var2 = this.R;
                        matrix2.preScale(yv0Var2.d, yv0Var2.e);
                    }
                } else {
                    this.Q.getClass();
                    float f15 = (-f13) + 0.0f;
    ...
    public void S() {
        if (this.v != null) {
            this.y = c91.a(getMeasuredWidth(), getMeasuredHeight());
        }
        ...
        post(new as0(2, this, point.x > point.y));
    }
    ...
    public final void W() {
        ...
        yv0 yv0Var = arrayList.size() > 0 ? (yv0) hg.k0.x(1, arrayList) : null;
        if (yv0Var == null) {
            yv0Var = new yv0();
            yv0Var.c = Bitmap.createBitmap(i11, i10, Bitmap.Config.ARGB_8888);
            yv0Var.b = new aw0(yv0Var.c);
        } else {
            yv0Var.c.eraseColor(0);
        }
        float width = yv0Var.c.getWidth() / f10;
        float height = (yv0Var.c.getHeight() - 34) / f7;
        int save = yv0Var.b.save();
        yv0Var.a = getScrollOffset() % 24;
        float f11 = 10.0f * height;
        yv0Var.b.clipRect(1.0f, f11, yv0Var.c.getWidth(), yv0Var.c.getHeight() - 1);
        yv0Var.b.scale(width, height);
        yv0Var.b.translate(0.0f, f11 + yv0Var.a);
        yv0Var.d = 1.0f / width;
        yv0Var.e = 1.0f / height;
        L(yv0Var.b, null);
        try {
            yv0Var.b.restoreToCount(save);
        } catch (Exception e) {
            FileLog.e(e);
        }
        System.currentTimeMillis();
    ...
    public void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            if (arrayList.get(i10) != null) {
                ((yv0) arrayList.get(i10)).c.recycle();
            }
            i10++;
        }
        arrayList.clear();
