...
public abstract class l80 extends LinearLayout {
    ...
    public l80(Context context, TLRPC.Chat chat) {
        super(context);
        ...
        final int i10 = 0;
        x8Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.i80
            ...
            public final void onClick(View view) {
                switch (i10) {
                    case 0:
                        l80 l80Var = this.b;
                        boolean z12 = l80Var.f;
                        boolean z13 = !z12;
                        if (l80Var.b(z13, new k80(l80Var, l80Var.h, z12, 0))) {
                            l80Var.setJoinRequest(false);
                            l80Var.setJoinToSend(z13);
                            break;
                        }
                        break;
                    default:
                        l80 l80Var2 = this.b;
                        boolean z14 = l80Var2.h;
                        boolean z15 = !z14;
                        if (l80Var2.a(z15, new j80(l80Var2, z14, 0))) {
                            l80Var2.setJoinRequest(z15);
                            break;
                        }
                        break;
                }
        ...
        final int i11 = 1;
        x8Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.i80
            public final /* synthetic */ l80 b;
    ...
    public abstract boolean a(boolean z10, j80 j80Var);

    public boolean b(boolean z10, k80 k80Var) {
        return true;
    }
    ...
    public void setJoinToSend(boolean z10) {
        ...
        this.r.addListener(new r8(this, 26));
