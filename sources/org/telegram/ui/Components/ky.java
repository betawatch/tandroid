...
public final class ky extends ll0 {
    public boolean E;
    ...
    public ky(lz lzVar, Context context) {
        this.F = lzVar;
        fy fyVar = new fy(context, lzVar.c1, new d(this, 11), new mv(this, 1), lzVar.Z1);
        this.c = fyVar;
    ...
    public static void E(ky kyVar, Runnable runnable, ArrayList arrayList, boolean z10) {
        ...
        MediaDataController.getInstance(lzVar.c1).searchStickers(true, str, str2, new ai.e4((Object) kyVar, str2, arrayList, (Object) runnable, 9), z10);
    }
    ...
    */
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            view = new org.telegram.ui.Cells.p8(lzVar.getContext(), true, false, lzVar.Z1, lzVar.i2);
        } else if (i10 == 4) {
