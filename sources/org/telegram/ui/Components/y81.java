...
public final class y81 extends FrameLayout {
    ...
    public y81(c91 c91Var, Context context) {
        super(context);
        this.H = c91Var;
        this.x = true;
    ...
    public final void d(boolean z10, boolean z11) {
        ...
        if (z12) {
            if (z11) {
                ...
                this.y = animatorSet2;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<y81, Float>) property, 1.0f));
                this.y.setDuration(150L);
                this.y.addListener(new x81(this, 0));
                this.y.start();
            } else {
                setAlpha(1.0f);
            }
            ...
            this.y = animatorSet3;
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this, (Property<y81, Float>) property, 0.0f));
            this.y.setDuration(150L);
            this.y.addListener(new x81(this, 1));
            this.y.start();
        } else {
            setAlpha(0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        c91 c91Var = this.H;
        if (c91Var.P) {
            if (c91Var.M && c91Var.N != 0.0f) {
                long currentTimeMillis = System.currentTimeMillis();
                long j3 = currentTimeMillis - c91Var.L;
                c91Var.L = currentTimeMillis;
                float f7 = c91Var.N - (j3 / 150.0f);
                c91Var.N = f7;
                if (f7 < 0.0f) {
                    c91Var.N = 0.0f;
                }
        ...
        if (!c91Var.U) {
            if (this.d != null) {
                canvas.save();
                canvas.translate((measuredWidth - AndroidUtilities.dp(58.0f)) - this.r, measuredHeight - AndroidUtilities.dp((c91Var.T ? 6 : 10) + 29));
                this.d.draw(canvas);
                canvas.restore();
            }
            if (this.e != null) {
                canvas.save();
                canvas.translate(AndroidUtilities.dp(18.0f), measuredHeight - AndroidUtilities.dp((c91Var.T ? 6 : 10) + 29));
                this.e.draw(canvas);
                canvas.restore();
            }
        }
