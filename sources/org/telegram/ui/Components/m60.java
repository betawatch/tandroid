...
public final class m60 extends FrameLayout {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        a70 a70Var = this.d;
        int i23 = a70Var.Z;
        i10 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingTop;
        int dp = (i23 - i10) - AndroidUtilities.dp(8.0f);
        int dp2 = AndroidUtilities.dp(36.0f) + getMeasuredHeight();
        i11 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingTop;
        int i24 = i11 + dp2;
        int i25 = AndroidUtilities.statusBarHeight;
        int i26 = dp + i25;
        int i27 = i24 - i25;
        if (this.b) {
            i19 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingTop;
            int i28 = i19 + i26;
            int i29 = AndroidUtilities.statusBarHeight;
            int i30 = i29 * 2;
            if (i28 < i30) {
                i22 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingTop;
            ...
            i20 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingTop;
            int i31 = i20 + i26;
            int i32 = AndroidUtilities.statusBarHeight;
            if (i31 < i32) {
                i21 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingTop;
                i12 = Math.min(i32, (i32 - i26) - i21);
                drawable = ((org.telegram.ui.ActionBar.f3) a70Var).shadowDrawable;
                drawable.setBounds(0, i26, getMeasuredWidth(), AndroidUtilities.dp(10.0f) + i27 + AndroidUtilities.navigationBarHeight);
                drawable2 = ((org.telegram.ui.ActionBar.f3) a70Var).shadowDrawable;
                drawable2.draw(canvas);
                if (f7 != 1.0f) {
                    org.telegram.ui.ActionBar.j6.t0.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.h5, false));
                    i15 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingLeft;
                    i16 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingTop;
                    float f10 = i16 + i26;
                    int measuredWidth = getMeasuredWidth();
                    i17 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingLeft;
                    float f11 = measuredWidth - i17;
                    i18 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingTop;
                ...
                if (i12 > 0) {
                    ...
                    i14 = ((org.telegram.ui.ActionBar.f3) a70Var).backgroundPaddingLeft;
