...
public final class j00 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public j00(ArrayList arrayList, org.telegram.ui.fy fyVar) {
        ...
        fixNavigationBar();
        this.v = arrayList;
        this.s = new ArrayList(fyVar.getMessagesController().dialogFilters);
        int i10 = 0;
    ...
    public final void I(boolean z10) {
        ...
        this.e.addListener(new z9(8, this, z10));
        this.e.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.b, (f5.d) new l4.x0(7));
        }
    }
