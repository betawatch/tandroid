...
public final class j00 extends FrameLayout {
    ...
    public final void a(boolean z10) {
        if (this.n != z10) {
            ...
            this.r.addListener(new u9(9, this, z10));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.h > 0.0f) {
            if (this.B == null) {
                this.B = new jp(i6Var2.a.getColor());
            }
        ...
        if (f10 < 1.0f) {
            ...
            float d = i6Var2.d();
            float d9 = this.e.d(this.d, false);
            float d10 = ((i6Var.d() + AndroidUtilities.dp(15.66f)) * d9) + d;
            Rect rect = AndroidUtilities.rectTmp2;
            rect.set((int) (((getMeasuredWidth() - d10) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - i6Var2.e) / 2.0f) - AndroidUtilities.dp(1.0f)), (int) j3.r0.c(getMeasuredWidth() - d10, getWidth(), 2.0f, d), (int) (((getMeasuredHeight() + i6Var2.e) / 2.0f) - AndroidUtilities.dp(1.0f)));
            ...
            i6Var.w = (int) org.telegram.messenger.l0.y(1.0f, this.h, 255.0f, d9);
