...
public class aw extends ViewGroup {
    ...
    public final void c() {
        ...
        if (this.x && this.y) {
            ...
            if (q5Var != null || (this.s == null && this.r == null)) {
                ...
                ew ewVar = this.J;
                if (document != null) {
                    this.w = q5.m(UserConfig.selectedAccount, ewVar.S, document);
                } else {
                    this.w = q5.n(UserConfig.selectedAccount, this.r.longValue(), null, ewVar.S);
                }
                this.w.a(w9Var);
    ...
    public aw(ew ewVar, Context context, TLRPC.Document document) {
        ...
        addView(xvVar);
        int i10 = rg.b1.L;
        yv yvVar = new yv(context, 1, ewVar.v);
        this.f = yvVar;
        yvVar.setAlpha(0.0f);
    ...
    public aw(ew ewVar, Context context, long j3) {
        ...
        addView(y5Var);
        int i10 = rg.b1.L;
        zv zvVar = new zv(context, 1, ewVar.v);
        this.f = zvVar;
        zvVar.setAlpha(0.0f);
