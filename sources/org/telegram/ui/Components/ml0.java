...
public class ml0 extends RecyclerView implements bh.a {
    ...
    public boolean L1;
    public float L2;
    public org.telegram.ui.Cells.ja M1;
    public float[] M2;
    public View N1;
    public float[] N2;
    public int O1;
    ...
    public static void O0(Canvas canvas, RectF rectF, float f7, float f10, float f11, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.h6.l1(f11, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, d6Var)));
        if (f7 == f10) {
    ...
    public final void C0(Runnable runnable) {
        this.E2.b.add(new mt(runnable, 1));
    }
            ...
            if (layoutManager instanceof s4.c0) {
                ...
                if (c0Var.o == 1) {
                    if (this.g1 == null) {
                        ...
                        if ((!this.K1 && !z10) || (tk0Var = this.f1) == null || tk0Var.n) {
                            return;
                        }
                        s4.h0 adapter = getAdapter();
                        if (adapter instanceof uk0) {
                            uk0 uk0Var = (uk0) adapter;
                            float H = uk0Var.H(this);
                            this.f1.setIsVisible(uk0Var.E(this));
                    ...
                    if ((this.K1 || z10) && (tk0Var2 = this.f1) != null && !tk0Var2.n && (getAdapter() instanceof uk0)) {
    ...
    public final void M0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            org.telegram.ui.ni niVar = this.h2;
            int[] iArr2 = this.m2;
            org.telegram.ui.xn xnVar = niVar.d;
            iArr2[0] = (int) xnVar.s9;
            iArr2[1] = xnVar.Aa;
            ...
            if (rectF.contains(min2, min)) {
                ...
                if (i11 != S) {
                    ...
                    org.telegram.ui.xn xnVar2 = this.h2.d;
                    org.telegram.ui.km kmVar = xnVar2.A0;
                    ArrayList arrayList = xnVar2.u6;
                    int i13 = S - kmVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) xnVar2.x6.f(messageObject.getGroupId())) != null) {
                            ArrayList<MessageObject> arrayList2 = groupedMessages.messages;
                            S = arrayList.indexOf(arrayList2.get(z10 ? 0 : arrayList2.size() - 1)) + xnVar2.A0.J;
                        }
                    }
                    if (z10) {
                        int i14 = this.g2;
    ...
    public final void P0(Canvas canvas, View view, View view2, boolean z10, boolean z11) {
        ...
        float bottomInfoMargin = view2 instanceof l80 ? ((l80) view2).getBottomInfoMargin() : 0.0f;
        RectF rectF = AndroidUtilities.rectTmp;
    ...
    */
        ...
        if (m0Var == null || !m0Var.k()) {
            ...
            for (int i14 = 0; i14 < getChildCount(); i14++) {
                ...
                if (childAt2 != this.c1 && childAt2.getVisibility() == 0 && childAt2.getAlpha() > 0.0f && ((Boolean) this.H2.a.run(childAt2)).booleanValue()) {
                    ...
                    if (!T.j() || childAt2.getAlpha() >= 1.0f) {
                        ...
                        jl0Var2.b = G0;
                        jl0Var2.c = alpha2;
                        arrayList2.add(jl0Var2);
                    }
                }
            }
            ArrayList arrayList3 = this.O2;
            float f12 = this.L2;
            ArrayList arrayList4 = kl0.a;
            if (arrayList3 == null || arrayList3.isEmpty()) {
                ...
                while (i16 < arrayList3.size()) {
                    float f13 = ((jl0) arrayList3.get(i16)).b;
                    int i17 = i16 + 1;
                    while (i17 < arrayList3.size() && ((jl0) arrayList3.get(i17)).a <= f13 + 1.5f) {
                        f13 = Math.max(f13, ((jl0) arrayList3.get(i17)).b);
                        i17++;
                    }
                    ...
                    for (int i18 = i16; i18 < i17; i18++) {
                        jl0 jl0Var3 = (jl0) arrayList3.get(i18);
                        if (jl0Var3.c >= 0.99f) {
                            f16 = Math.min(f16, jl0Var3.a);
                            f17 = Math.max(f17, jl0Var3.b);
                        }
                    }
                    boolean z10 = f16 != Float.MAX_VALUE;
                    float f18 = 0.0f;
                    for (int i19 = i16; i19 < i17; i19++) {
                        jl0 jl0Var4 = (jl0) arrayList3.get(i19);
                        f14 = Math.min(f14, jl0Var4.a);
                        f15 = Math.max(f15, jl0Var4.b);
                        f18 = Math.max(f18, jl0Var4.c);
                    }
                    if (f18 >= 0.001f) {
                        if (z10) {
                            float f19 = 0.0f;
                            ...
                            for (int i20 = i16; i20 < i17; i20++) {
                                jl0 jl0Var6 = (jl0) arrayList3.get(i20);
                                float f20 = jl0Var6.c;
                                if (f20 < 0.99f) {
                                    float f21 = jl0Var6.a;
                                    if (f21 < f16) {
                            ...
                            float f23 = 0.0f;
                            while (i16 < i17) {
                                jl0 jl0Var8 = (jl0) arrayList3.get(i16);
                                float f24 = jl0Var8.c;
                                if (f24 < 0.99f) {
                                    float f25 = jl0Var8.b;
                                    if (f25 > f17) {
    ...
    public final void R0(Canvas canvas) {
        ...
        if ((i10 == -2 || i10 == this.E1) && this.F1 != null) {
            if (getAdapter() instanceof ll0) {
                ((ll0) getAdapter()).getClass();
            }
    ...
    public final Drawable V0(View view, boolean z10) {
        ...
        if (z11 && z12 && !z10) {
            ...
            if (z11 && z13) {
                return org.telegram.ui.ActionBar.h6.b0(0, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, this.p2));
            }
            z12 = z13;
        }
        Path path = new Path();
        ...
        return new sk0(this, view, path, rectF);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (rk0Var != null) {
            ml0 ml0Var = rk0Var.a;
            if (rk0Var.d || rk0Var.e) {
                for (int i10 = 0; i10 < ml0Var.getChildCount(); i10++) {
                    View childAt = ml0Var.getChildAt(i10);
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !rk0Var.c.contains(childAt)) {
                        Float f7 = (Float) rk0Var.b.get(R, null);
                        if (f7 == null) {
    ...
    public final void e1(xk0 xk0Var, int i10, boolean z10) {
        ac0 ac0Var = this.V1;
        if (ac0Var != null) {
            AndroidUtilities.cancelRunOnUIThread(ac0Var);
            this.V1 = null;
        }
        s4.c1 K = K(xk0Var.run());
        if (K == null) {
            if (z10) {
                this.U1 = xk0Var;
                return;
        ...
        if (i10 > 0) {
            this.U1 = null;
            ac0 ac0Var2 = new ac0(this, 19);
            this.V1 = ac0Var2;
            AndroidUtilities.runOnUIThread(ac0Var2, i10);
        }
    }
    ...
    public final void f0(View view) {
        ...
        s4.c1 G = G(view);
        if (G != null) {
            view.setEnabled(((ll0) getAdapter()).D(G));
            if (this.q2) {
    ...
    public al0 getOnItemClickListener() {
        return this.V0;
    }
    ...
    public final void i1(int i10, View view) {
        ...
        if (this.C1 == 8) {
            ...
            org.telegram.ui.ActionBar.h6.A1(this.D1, i10 == 0 ? this.b2 : 0, i10 == getAdapter().h() + (-2) ? this.b2 : 0);
        }
    ...
    public final void l1(ml0 ml0Var, boolean z10) {
        ViewParent parent;
        if (ml0Var == null || (parent = ml0Var.getParent()) == null) {
            return;
        }
    ...
    public final void n1(dl0 dl0Var, long j3) {
        this.Y0 = dl0Var;
        org.telegram.ui.Cells.ja jaVar = this.M1;
        boolean z10 = dl0Var != null;
        l20 l20Var = (l20) jaVar.b;
        l20Var.t = z10;
        l20Var.u = j3;
    }
    ...
    public void onAttachedToWindow() {
        ...
        tk0 tk0Var = this.f1;
        if (tk0Var == null || tk0Var.getParent() == getParent()) {
            return;
        }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (tk0Var != null) {
            this.J1 = true;
            int paddingTop = i11 + (tk0Var.a ? getPaddingTop() : tk0Var.h0);
            tk0 tk0Var2 = this.f1;
            if (tk0Var2.g0) {
                tk0Var2.layout(0, paddingTop, tk0Var2.getMeasuredWidth(), this.f1.getMeasuredHeight() + paddingTop);
            } else {
                int measuredWidth = getMeasuredWidth() - this.f1.getMeasuredWidth();
                tk0 tk0Var3 = this.f1;
                tk0Var3.layout(measuredWidth, paddingTop, tk0Var3.getMeasuredWidth() + measuredWidth, this.f1.getMeasuredHeight() + paddingTop);
            }
            this.J1 = false;
        }
        L0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        tk0 tk0Var = this.f1;
        if (tk0Var != null && tk0Var.getLayoutParams() != null) {
            tk0 tk0Var2 = this.f1;
            int measuredHeight = (getMeasuredHeight() - (tk0Var2.a ? getPaddingTop() : tk0Var2.h0)) - getPaddingBottom();
    ...
    public void q1(int i10, float f7, boolean z10) {
        r1(new ei.c(5), i10, f7, new mv(this, 15), z10);
    }
    ...
    public final void s1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f7, Utilities.Callback5 callback5, boolean z10) {
        setSelectorDrawableColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.j6, this.p2));
        ...
        yk0 yk0Var = new yk0(this, callbackReturn, i10, z10);
        this.H2 = yk0Var;
        i(yk0Var);
    }
    ...
    public void setFastScrollEnabled(int i10) {
        this.f1 = new tk0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.f1);
        }
    }
    ...
    public void setItemsEnterAnimator(rk0 rk0Var) {
        this.n2 = rk0Var;
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        org.telegram.ui.Cells.z zVar = this.D1;
        if (num == null) {
            intValue = org.telegram.ui.ActionBar.h6.v0(b1() ? org.telegram.ui.ActionBar.h6.j6 : org.telegram.ui.ActionBar.h6.i6, this.p2);
        } else {
    ...
    public void setOnInterceptTouchListener(zk0 zk0Var) {
        this.b1 = zk0Var;
    }
    ...
    public ml0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        setGlowColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.s8, d6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.i6, d6Var), 2, -1);
        this.D1 = f02;
        ...
        super.setOnScrollListener(new kg0(this, i10));
        this.E.add(new hl0(this, context));
    }

    public void setOnItemClickListener(bl0 bl0Var) {
        this.W0 = bl0Var;
    }

    public void setOnItemLongClickListener(dl0 dl0Var) {
        n1(dl0Var, ViewConfiguration.getLongPressTimeout());
    }
}
