...
public class to0 extends FrameLayout {
    ...
    */
    public final void a(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = to0Var.e;
        float f10 = i11 / 2.0f;
        float measuredWidth = to0Var.getMeasuredWidth() - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(to0Var.V * 1.0f) / 2.0f;
        if (k0 == null) {
            k0 = new Path();
        }
        k0.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= to0Var.S.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) to0Var.S.get(i12)).first).floatValue() >= dp3) {
                break;
            } else {
                i12++;
            }
        ...
        int size = to0Var.S.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) to0Var.S.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) to0Var.S.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) to0Var.S.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= to0Var.S.size() - 1 || ((Float) ((Pair) to0Var.S.get(i13)).first).floatValue() - floatValue > dp3) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) to0Var.S.get(i13)).first).floatValue();
            }
            c11 = 1;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.y > 0.0f) {
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ui, e6Var));
            f7 = 0.0f;
        ...
        if (f17 != f18) {
            if (f17 < f18) {
                ...
                f10 = 16.0f;
                f11 = 8.0f;
                float b10 = org.telegram.messenger.wh.b(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f17);
                this.F = b10;
                if (b10 < f18) {
                    this.F = f18;
                }
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            this.b0.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Si, e6Var));
            if (this.a0[1] != null) {
                canvas2.save();
                if (this.d0 != 0) {
                    f13 = 0.0f;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        ro0 ro0Var = this.N;
        int measuredHeight = (ro0Var.getMeasuredHeight() / 2) + dp;
        int dp2 = AndroidUtilities.dp(8.0f) + AndroidUtilities.dp(25.0f) + (this.e / 2) + (this.U > 600000 ? AndroidUtilities.dp(42.0f) : 0);
        ro0Var.layout(dp2, measuredHeight - ro0Var.getMeasuredHeight(), ro0Var.getMeasuredWidth() + dp2, measuredHeight);
    }
    ...
    public to0(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        super(context);
        this.h = new e6(this, 0L, 60L, qr.g);
        this.r = -100.0f;
        this.s = -1.0f;
        ...
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.j6.f0(i0.a.k(org.telegram.ui.ActionBar.j6.v0(i10, e6Var), 40), 1, AndroidUtilities.dp(16.0f));
        this.E = f02;
