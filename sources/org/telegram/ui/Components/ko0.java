...
public class ko0 extends FrameLayout {
    ...
    */
    public final void a(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = ko0Var.e;
        float f11 = i11 / 2.0f;
        float measuredWidth = ko0Var.getMeasuredWidth() - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(ko0Var.S * 1.0f) / 2.0f;
        if (h0 == null) {
            h0 = new Path();
        }
        h0.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= ko0Var.P.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) ko0Var.P.get(i12)).first).floatValue() >= dp3) {
                break;
            } else {
                i12++;
            }
        ...
        int size = ko0Var.P.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) ko0Var.P.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c3 = 0;
                floatValue = ((Float) ((Pair) ko0Var.P.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) ko0Var.P.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c10 = 1;
                if (i13 >= ko0Var.P.size() - 1 || ((Float) ((Pair) ko0Var.P.get(i13)).first).floatValue() - floatValue > dp3) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) ko0Var.P.get(i13)).first).floatValue();
            }
            c10 = 1;
    ...
    public ho0 getSeekBarAccessibilityDelegate() {
        return this.a;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f18 != f19) {
            if (f18 < f19) {
                f11 = 16.0f;
                f12 = 8.0f;
                float c3 = vh.v2.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f18);
                this.C = c3;
                if (c3 > f19) {
                    this.C = f19;
                }
        ...
        float f22 = this.E;
        if (f22 < 1.0f) {
            float interpolation = 1.0f - gt.c.getInterpolation(Math.min(1.0f, f22 * 3.0f));
            float interpolation2 = gt.d.getInterpolation(this.E);
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            float interpolation3 = nr.f.getInterpolation(this.W);
            canvas2.save();
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        io0 io0Var = this.K;
        int measuredHeight = (io0Var.getMeasuredHeight() / 2) + dp;
        int dp2 = AndroidUtilities.dp(8.0f) + AndroidUtilities.dp(25.0f) + (this.e / 2) + (this.R > 600000 ? AndroidUtilities.dp(42.0f) : 0);
        io0Var.layout(dp2, measuredHeight - io0Var.getMeasuredHeight(), io0Var.getMeasuredWidth() + dp2, measuredHeight);
    }
    ...
    public void setDelegate(jo0 jo0Var) {
        this.w = jo0Var;
    }
    ...
    public ko0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        super(context);
        this.h = new z5(this, 0L, 60L, nr.g);
        this.r = -100.0f;
        this.s = -1.0f;
        ...
        io0 io0Var = new io0(this, context, context, 0);
        this.K = io0Var;
        io0Var.x = true;
        addView(io0Var, k7.b6.c(-2.0f, -1));
