...
public class ko0 extends FrameLayout {
    ...
    */
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i15 = org.telegram.ui.ActionBar.k6.Ti;
        ...
        if (f18 != f19) {
            if (f18 < f19) {
                f11 = 16.0f;
                f12 = 8.0f;
                float c3 = w.c.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f18);
                this.C = c3;
                if (c3 > f19) {
                    this.C = f19;
                }
        ...
        float f22 = this.E;
        if (f22 < 1.0f) {
            float interpolation = 1.0f - jt.c.getInterpolation(Math.min(1.0f, f22 * 3.0f));
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            float interpolation3 = pr.f.getInterpolation(this.W);
            canvas2.save();
    ...
    public ko0(Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4) {
        super(context);
        this.h = new z5(this, 0L, 60L, pr.g);
        this.r = -100.0f;
        this.s = -1.0f;
