...
public final class h31 extends FrameLayout {
    ...
    public int getTextColor() {
        ...
        return i0.a.d(this.x ? 1.0f : this.F, org.telegram.ui.ActionBar.j6.v0(i10, e6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, e6Var));
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (f7 > 0.0f) {
            ...
            n4Var.layout(AndroidUtilities.dp(4.66f) + l90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), i16 - (n4Var.getMeasuredHeight() / 2), n4Var.getMeasuredWidth() + AndroidUtilities.dp(4.66f) + l90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), (n4Var.getMeasuredHeight() / 2) + i16);
        }
