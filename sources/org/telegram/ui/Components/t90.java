...
public final class t90 extends TextView {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float a2 = f10 < f11 ? k7.n.a(f10 / AndroidUtilities.dp(10.0f), 0.0f, 1.0f) : 0.0f;
        ...
        vp vpVar = this.n;
        if ((z11 && this.e) || !z10) {
            float c3 = vh.v2.c(min, 1000.0f, AndroidUtilities.dp(60.0f), this.f);
            this.f = c3;
        ...
        this.r = true;
        AndroidUtilities.runOnUIThread(vpVar, 1500L);
    }
