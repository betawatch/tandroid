        ...
        if (this.e != null) {
            if (this.p.contains(motionEvent.getX(), motionEvent.getY() - (z10 ? this.b.getPaddingTop() : 0))) {
                ...
                if (action != 0) {
                    ...
                    if (xcVar.h && (runnable = this.r) != null) {
                        runnable.run();
                    }
                    xcVar.c(false);
    ...
    public final boolean f(MessageObject messageObject) {
        ...
        if (messageObject == null) {
            ...
            if (isMonoForum) {
                ...
                if (topicId == 1) {
                    imageReceiver.setImageBitmap(mg.d.c(view.getContext(), 0.75f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.v8, this.c), false));
