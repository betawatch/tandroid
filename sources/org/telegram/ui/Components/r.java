...
public final class r extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void R(r rVar, ArrayList arrayList, w51 w51Var) {
        ...
        if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
            ...
            if (user == null) {
                ...
                sb.append(str);
                sb.append(TextUtils.isEmpty(publicUsername) ? LocaleController.formatString(R.string.AIEditorCreatedBy, UserObject.getUserName(user)) : LocaleController.formatString(R.string.AIEditorCreatedBy, vh.v2.e("@", publicUsername)));
                arrayList.add(i51.B(AndroidUtilities.replaceSingleLink(sb.toString(), rVar.getThemedColor(org.telegram.ui.ActionBar.j6.gc), new org.telegram.ui.hp(8, rVar, tL_aiComposeTone))));
            }
        }
    ...
    public static SpannableStringBuilder V() {
        ...
        for (int i10 = 0; i10 < 5; i10++) {
            ...
            j90 j90Var = new j90(null, dp, 0, null);
