...
public class RadialProgress2 {
    ...
    public void setImageOverlay(TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2, TLRPC.Document document, Object obj) {
        ...
        this.overlayImageView.setImage(photoSize == null ? null : ImageLocation.getForDocument(photoSize, document), format, photoSize2 != null ? ImageLocation.getForDocument(photoSize2, document) : null, format, null, 0L, null, obj, 1);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if ((this.mediaActionDrawable.getCurrentIcon() != 4 || this.mediaActionDrawable.getTransitionProgress() < 1.0f) && !this.progressRect.isEmpty()) {
            ...
            if (this.isPressedMini && this.circleCrossfadeColorKey < 0) {
                ...
                int i7 = this.circlePressedColorKey;
                if (i7 >= 0) {
                    this.circleMiniPaint.setColor(getThemedColor(i7));
                } else {
                ...
                if (i8 >= 0) {
                    this.miniMediaActionDrawable.setColor(getThemedColor(i8));
                } else {
                    this.miniMediaActionDrawable.setColor(this.iconColor);
                }
                int i9 = this.circleColorKey;
                if (i9 >= 0) {
                    if (this.circleCrossfadeColorKey >= 0) {
                        this.circleMiniPaint.setColor(AndroidUtilities.getOffsetColor(getThemedColor(i9), getThemedColor(this.circleCrossfadeColorKey), this.circleCrossfadeColorProgress, this.circleCheckProgress));
                    } else {
                        this.circleMiniPaint.setColor(getThemedColor(i9));
                    }
                } else {
            ...
            if (this.isPressed) {
                ...
                if (i10 >= 0) {
                    ...
                    int i11 = this.iconPressedColor;
                    mediaActionDrawable2.setColor(i11);
                    this.mediaActionDrawable.setBackColor(this.circlePressedColor);
                    i = i11;
                }
                int i12 = this.circlePressedColorKey;
                if (i12 >= 0) {
                ...
                if (i13 >= 0) {
                    ...
                    mediaActionDrawable4.setColor(i14);
                    this.mediaActionDrawable.setBackColor(this.circleColor);
                    i = i14;
                }
                int i15 = this.circleColorKey;
                if (i15 >= 0) {
                    this.circlePaint.setColor(getThemedColor(i15));
                } else {
            ...
            if (canvas5 == null || this.circleCrossfadeColorKey < 0 || this.circleCheckProgress == f) {
                ...
                i2 = canvas5.save();
                float f6 = f - ((f - this.circleCheckProgress) * 0.1f);
                this.miniDrawCanvas.scale(f6, f6, ceil, ceil2);
            }
            ...
            if (this.drawMiniIcon || this.circleCrossfadeColorKey >= 0) {
                if (Math.abs(this.progressRect.width() - AndroidUtilities.dp(44.0f)) < AndroidUtilities.density) {
                    float f8 = 16;
                    centerX = this.progressRect.centerX() + AndroidUtilities.dp(f8);
                    centerY = this.progressRect.centerY() + AndroidUtilities.dp(f8);
                    i3 = 20;
                    i4 = 0;
                } else {
                ...
                int i19 = i3 / 2;
                if (this.drawMiniIcon) {
                    f2 = this.miniMediaActionDrawable.getCurrentIcon() != 4 ? 1.0f : f - this.miniMediaActionDrawable.getTransitionProgress();
                    if (f2 == 0.0f) {
                ...
                if (canvas7 != null) {
                    float f9 = i3 + 18 + i4;
                    canvas7.drawCircle(AndroidUtilities.dp(f9), AndroidUtilities.dp(f9), AndroidUtilities.dp(i19 + 1) * f2 * this.miniIconScale, Theme.checkboxSquare_eraserPaint);
                } else {
                ...
                float f11 = i19;
                canvas.drawCircle(centerX, centerY, (AndroidUtilities.dp(f11) * f2) + (AndroidUtilities.dp(f) * (f - this.circleCheckProgress)), this.circleMiniPaint);
                if (this.drawMiniIcon) {
                    this.miniMediaActionDrawable.setBounds((int) (centerX - (AndroidUtilities.dp(f11) * f2)), (int) (centerY - (AndroidUtilities.dp(f11) * f2)), (int) (centerX + (AndroidUtilities.dp(f11) * f2)), (int) (centerY + (AndroidUtilities.dp(f11) * f2)));
