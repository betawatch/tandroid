...
public class ChatReplyContainer extends FrameLayout {
    ...
    public void switchLayouts(boolean z) {
        ...
        if (z) {
            ...
            this.layouts[1].animate().scaleX(0.8f).scaleY(0.8f).alpha(0.0f).translationY(-AndroidUtilities.dp(20.0f)).setInterpolator(cubicBezierInterpolator).setDuration(320L).withEndAction(new Runnable() { // from class: org.telegram.ui.Components.ChatReplyContainer$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ChatReplyContainer.Layout.this.setVisibility(8);
                }
            }).start();
            return;
        }
