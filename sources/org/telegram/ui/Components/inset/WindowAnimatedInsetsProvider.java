...
public class WindowAnimatedInsetsProvider extends WindowInsetsAnimationCompat.Callback {
    ...
    private void dispatchWindowInsetsAnimationChange(WindowInsetsCompat windowInsetsCompat) {
        ...
        while (it.hasNext()) {
            ...
            WindowInsetsCompat calculateWindowInsets = calculateWindowInsets(windowInsetsCompat, animatedInsetsTargetView, this.root);
            if (calculateWindowInsets != null) {
                listener.onAnimatedInsetsChanged(animatedInsetsTargetView, calculateWindowInsets);
            }
        }
    }
