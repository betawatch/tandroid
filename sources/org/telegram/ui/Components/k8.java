...
public final class k8 {
    ...
    public k8() {
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            yp ypVar = new yp();
            ypVarArr[i10] = ypVar;
            ypVar.g = AndroidUtilities.dp(24.0f);
            ypVar.k = 1.0f;
        }
        this.h = new Paint(1);
    }
    ...
    public final void b(Canvas canvas, float f7, float f10) {
        ...
        if (LiteMode.isEnabled(32)) {
            ...
            yp[] ypVarArr = this.a;
            yp ypVar = ypVarArr[0];
            for (int i12 = 0; i12 < ypVar.f; i12 += 2) {
                float[] fArr4 = ypVar.j;
            ...
            for (int i14 = 0; i14 < ypVar2.f; i14 += 2) {
                float[] fArr5 = ypVar2.j;
    ...
    public final void e(boolean z10, boolean z11, float[] fArr) {
        ...
        if (LiteMode.isEnabled(32)) {
            ...
            if (this.p > 6) {
                ...
                float f13 = f12 / 6.0f;
                if (f13 > 0.52f) {
                    f11 = com.google.android.gms.internal.vision.e2.a(f13, 0.4f, f10, f11);
                }
            }
            while (true) {
                fArr2 = this.e;
