...
public class wn0 {
    ...
    public final void b(Canvas canvas) {
        ...
        if (f9 < 1.0f) {
            canvas2 = canvas;
            canvas2.saveLayerAlpha(0.0f, 0.0f, this.f, this.g, (int) (f9 * 255.0f), 31);
        } else {
            canvas2 = canvas;
        }
        int i10 = E / 2;
        ...
        if (this.r != dp) {
            ...
            float f12 = this.r;
            if (f12 < dp) {
                float c3 = u3.c.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f12);
                this.r = c3;
                if (c3 > dp) {
                    this.r = dp;
                }
            } else {
                float A = org.telegram.messenger.x3.A(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f12);
                this.r = A;
                if (A < dp) {
                    this.r = dp;
                }
        ...
        if (size != this.y) {
            ...
            if (size >= 0 && size < this.u.size()) {
                e((a51) ((Pair) this.u.get(this.y)).second);
            }
        }
        if (this.B < 1.0f) {
    ...
    */
    public final void c(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = E;
        float f11 = i11 / 2.0f;
        float f12 = wn0Var.f - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp = AndroidUtilities.dp(wn0Var.x * 1.0f) / 2.0f;
        if (G == null) {
            G = new Path();
        }
        G.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= wn0Var.u.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) wn0Var.u.get(i12)).first).floatValue() >= dp2) {
                break;
            } else {
                i12++;
            }
        ...
        int size = wn0Var.u.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) wn0Var.u.get(size)).first).floatValue() >= dp2) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c3 = 0;
                floatValue = ((Float) ((Pair) wn0Var.u.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) wn0Var.u.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c6 = 1;
                if (i13 >= wn0Var.u.size() - 1 || ((Float) ((Pair) wn0Var.u.get(i13)).first).floatValue() - floatValue > dp2) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) wn0Var.u.get(i13)).first).floatValue();
            }
            c6 = 1;
        ...
        if (i10 == 0) {
            ...
            if (this.e) {
                ...
                if (i10 == 1 && (vn0Var = this.h) != null) {
                    vn0Var.c(i19 / (this.f - E));
                }
                this.e = false;
                return true;
            }
        } else if (i10 == 2 && this.e) {
            int i20 = (int) (f9 - this.d);
            this.c = i20;
            if (i20 < 0) {
                this.c = 0;
            } else {
    ...
    public final void i(float f9) {
        this.a = f9;
        int ceil = (int) Math.ceil((this.f - E) * f9);
        this.b = ceil;
        if (ceil < 0) {
            this.b = 0;
            return;
            ...
            for (a51 a51Var : a51VarArr) {
                try {
                    if (a51Var != null && a51Var.getURL() != null && a51Var.d != null && a51Var.getURL().startsWith("audio?") && (parseInt = Utilities.parseInt((CharSequence) a51Var.getURL().substring(6))) != null && parseInt.intValue() >= 0) {
                        ...
                        this.u.add(new Pair(Float.valueOf((parseInt.intValue() * 1000) / valueOf.longValue()), a51Var));
                    }
                } catch (Exception e10) {
                    FileLog.e(e10);
                }
            }
            Collections.sort(this.u, new lh.e4(28));
        } catch (Exception e11) {
            FileLog.e(e11);
            this.u = null;
            this.y = -1;
