...
public final class o50 extends DispatchQueue {
    ...
    public final void c() {
        x50 x50Var = this.H;
        if (x50Var.i0[x50Var.a1] != null) {
            x50 x50Var2 = this.H;
            int width = x50Var2.i0[x50Var2.a1].getWidth();
            x50 x50Var3 = this.H;
            float min = this.F / Math.min(width, r1);
            int i10 = (int) (width * min);
            int height = (int) (x50Var3.i0[x50Var3.a1].getHeight() * min);
            if (i10 == height) {
                x50 x50Var4 = this.H;
                x50Var4.B0 = 1.0f;
                x50Var4.C0 = 1.0f;
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 != 0) {
            if (i10 == 1) {
                finish();
                if (this.y && ((!((z11 = (obj = message.obj) instanceof r50)) || ((r50) obj).c != -2) && (w50Var = this.H.Y0) != null)) {
                    w50Var.i(message.arg1, z11 ? (r50) obj : null);
                }
            ...
            if (i10 != 2) {
                ...
                float f13 = f7 + 0.5f;
                float f14 = f10 + 0.5f;
                x50Var2.z0 = org.telegram.messenger.ul.i(ByteBuffer.allocateDirect(32));
            ...
            if (surfaceTexture != null) {
                ...
                x50Var3.V = 0.0f;
                iArr2[0] = 0;
                x50Var3.A0 = x50Var3.z0.duplicate();
                x50 x50Var4 = this.H;
                x50Var4.D0 = x50Var4.i0[0];
            }
            ...
            this.n[0].setOnFrameAvailableListener(new vz(this, 1));
            AndroidUtilities.runOnUIThread(new xm(this.H, i12, this.n[0], i13));
            c();
            x50 x50Var5 = this.H;
            ...
            float f19 = f15 + 0.5f;
            float f20 = f16 + 0.5f;
            x50Var5.z0 = org.telegram.messenger.ul.i(ByteBuffer.allocateDirect(32));
        ...
        if (this.f) {
            if (!this.d.equals(this.b.eglGetCurrentContext()) || !this.e.equals(this.b.eglGetCurrentSurface(12377))) {
                ...
                if (!egl102.eglMakeCurrent(eGLDisplay2, eGLSurface2, eGLSurface2, this.d)) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.ul.t(this.b, new StringBuilder("eglMakeCurrent failed "));
                        return;
                    }
                    return;
                }
            ...
            if (this.y) {
                ...
                if (x50Var7.Y0.F0) {
                    if (!x50Var7.F) {
                        this.H.F = true;
                        AndroidUtilities.runOnUIThread(new Runnable(this) { // from class: org.telegram.ui.Components.n50
                                ...
                                switch (i12) {
                                    ...
                                    default:
                                        ...
                                        if (x50Var8.l0 != null) {
                                            ...
                                            x50Var8.Z0 = x50Var8.l0.getBitmap();
                                            break;
                                        }
                                        break;
                                }
                ...
                if (w50Var2.F0 && w50Var2.T != null && w50Var2.T.getLooper() != null && w50Var2.T.getLooper().getThread() != null && w50Var2.T.getLooper().getThread().isAlive()) {
                    w50Var2.w = eglGetCurrentContext;
                    w50Var2.T.sendMessage(w50Var2.T.obtainMessage(0, 1, 0));
                }
                w50Var2.F0 = true;
                int i16 = MessagesController.getInstance(w50Var2.H0.a).roundVideoSize;
                int i17 = MessagesController.getInstance(w50Var2.H0.a).roundVideoBitrate * 1024;
                AndroidUtilities.runOnUIThread(new s50(w50Var2, i11));
                w50Var2.a = j50Var;
                w50Var2.d = i16;
                w50Var2.e = i16;
                w50Var2.f = i17;
            ...
            x50 x50Var10 = this.H;
            if (x50Var10.Y0 != null && ((x50Var10.a1 == 0 && z12) || (this.H.a1 == 1 && z13))) {
                x50 x50Var11 = this.H;
                w50 w50Var3 = x50Var11.Y0;
                SurfaceTexture surfaceTexture2 = this.n[x50Var11.a1];
                x50 x50Var12 = this.H;
                if (x50Var12.p0) {
                    i14 = x50Var12.a1;
                }
            ...
            x50 x50Var13 = this.H;
            GLES20.glBindTexture(36197, x50Var13.T[x50Var13.a1]);
                        ...
                        switch (i11) {
                            ...
                            default:
                                ...
                                if (x50Var82.l0 != null) {
                                    ...
                                    x50Var82.Z0 = x50Var82.l0.getBitmap();
                                    break;
                                }
                                break;
                        }
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.ul.t(this.b, new StringBuilder("InstantCamera eglGetDisplay failed "));
            }
            finish();
            ...
            if (!this.b.eglChooseConfig(this.c, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 0, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    org.telegram.messenger.ul.t(this.b, new StringBuilder("InstantCamera eglChooseConfig failed "));
                }
                finish();
            } else if (iArr[0] > 0) {
                ...
                if (eglCreateContext == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.ul.t(this.b, new StringBuilder("InstantCamera eglCreateContext failed "));
                    }
                    finish();
                } else {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.ul.t(this.b, new StringBuilder("InstantCamera createWindowSurface failed "));
                            }
                            finish();
                            ...
                            FloatBuffer i11 = org.telegram.messenger.ul.i(ByteBuffer.allocateDirect(48));
                            x50Var.y0 = i11;
                            i11.put(fArr).position(0);
                            FloatBuffer i12 = org.telegram.messenger.ul.i(ByteBuffer.allocateDirect(32));
                            x50Var.z0 = i12;
                            i12.put(fArr2).position(0);
                            Matrix.setIdentityM(x50Var.w0, 0);
                            ...
                            if (a2 == 0 || a10 == 0) {
                                ...
                                Matrix.setIdentityM(x50Var.v0, 0);
                                ...
                                for (final int i13 = 0; i13 < 2; i13++) {
                                    ...
                                    surfaceTexture2.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.telegram.ui.Components.m50
                                        @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
                                        public final void onFrameAvailable(SurfaceTexture surfaceTexture3) {
                                            o50 o50Var = o50.this;
                                            int i14 = i13;
                                            o50Var.H.R = true;
                                            o50Var.requestRender(i14 == 0, i14 == 1);
                                        }
                                    });
                                    AndroidUtilities.runOnUIThread(new xm(x50Var, i13, surfaceTextureArr[i13], i10));
                                }
                                if (BuildVars.LOGS_ENABLED) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.ul.t(this.b, new StringBuilder("InstantCamera eglMakeCurrent failed "));
                            }
                            finish();
                        }
                    } else {
            ...
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.ul.t(this.b, new StringBuilder("InstantCamera eglInitialize failed "));
            }
            finish();
        }
        this.f = z10;
