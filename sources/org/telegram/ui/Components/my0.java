...
public final class my0 {
    ...
    public final void a(Canvas canvas, View view, boolean z10) {
        ...
        boolean z13 = i13 == i14;
        boolean z14 = this.q + this.l == ty0Var.A;
        int dp = AndroidUtilities.dp(8.0f);
        boolean z15 = this.c.header;
        if (z15 || (ty0Var.D && this.a.a.b.a % 2 == 0)) {
            int i15 = this.p;
            if (i15 == 0 && this.q == 0) {
                float f10 = dp;
                fArr[1] = f10;
            ...
            if (z12) {
                ...
                canvas2.drawRect(i15, this.q, i15 + this.k, r4 + this.l, sy0Var.getHeaderPaint());
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.drawRect(i15, this.q, this.k + i15, r1 + this.l, sy0Var.getStripPaint());
            }
        }
        if (z10 && this.b != null) {
            canvas2.save();
            canvas2.translate(b(), c());
            if (this.r >= 0 && (j9Var = ty0Var.a) != null) {
                j9Var.a0(canvas2, (org.telegram.ui.Cells.i9) ty0Var.getParent().getParent(), this.r);
            }
        ...
        if (ty0Var.C) {
            ...
            Paint paint3 = paint;
            canvas.drawLine(f24, (z13 && (i12 = this.q) == 0) ? i12 + dp : this.q - strokeWidth, f24, (z13 && z14) ? (this.q + this.l) - dp : (this.q + this.l) - strokeWidth, paint3);
            int i20 = this.p;
            float f25 = (this.q + this.l) - strokeWidth;
            canvas.drawLine((i20 == 0 && z14) ? i20 + dp : i20 - strokeWidth, f25, (z13 && z14) ? (i20 + this.k) - dp : (i20 + this.k) - strokeWidth, f25, paint3);
            int i21 = this.p;
    ...
    */
        ...
        if (this.c != null) {
            ...
            if (ly0Var != null) {
                ...
                if (!z10) {
                    ...
                    ty0 ty0Var = this.s;
                    e(ty0Var.K.createTextLayout(this.c, this.k - (ty0Var.v * 2)));
                    this.m = this.f + ty0Var.r + ty0Var.s;
                }
                f();
            }
            g();
    ...
    public final void f() {
        ...
        ty0 ty0Var = this.s;
        if (z10) {
            this.g = ((this.k - this.e) - ty0Var.v) + i10;
