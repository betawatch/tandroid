...
public abstract class my0 {
    ...
    public static void c(TLRPC.StickerSet stickerSet, org.telegram.ui.ActionBar.f6 f6Var, Context context, Utilities.Callback2 callback2) {
        ...
        final ky0 ky0Var = new ky0(context);
        int i10 = org.telegram.ui.ActionBar.j6.j5;
        ky0Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
        ky0Var.setInputType(16385);
        ky0Var.setTextSize(1, 16.0f);
        ky0Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
        ky0Var.setHandlesColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.vf, f6Var));
        ky0Var.setHeaderHintColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.L6, f6Var));
        ky0Var.setSingleLine(true);
        ky0Var.setFocusable(true);
        ky0Var.setFilters(new InputFilter[]{new InputFilter.LengthFilter(50), new InputFilter() { // from class: org.telegram.ui.Components.jy0
            @Override // android.text.InputFilter
            public final CharSequence filter(CharSequence charSequence, int i11, int i12, Spanned spanned, int i13, int i14) {
                return (charSequence.length() <= 0 || !Character.isWhitespace(charSequence.charAt(0))) ? charSequence : (TextUtils.isEmpty(ky0.this.getText()) || i13 == 0) ? "" : charSequence;
            }
        }});
        ky0Var.setLineColors(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.k6, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.l6, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.p7, f6Var));
        ky0Var.setImeOptions(6);
        ky0Var.setBackground(null);
        ky0Var.requestFocus();
        ky0Var.setPadding(AndroidUtilities.dp(LocaleController.isRTL ? 28.0f : 0.0f), 0, AndroidUtilities.dp(LocaleController.isRTL ? 0.0f : 28.0f), 0);
        ...
        ky0Var.addTextChangedListener(new ly0(numberTextView, ky0Var));
        if (z10) {
            ky0Var.setText(stickerSet.title);
            ky0Var.setSelection(stickerSet.title.length());
        }
        alertDialog$Builder.n(frameLayout);
        b2Var.G = 4;
        alertDialog$Builder.k(LocaleController.getString(z10 ? R.string.Done : R.string.Create), new ca.b(ky0Var, callback2, context, z10, 5));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new mv(ky0Var, 25));
        org.telegram.ui.ActionBar.b2 o9 = alertDialog$Builder.o();
        o9.h0 = false;
        ky0Var.setOnEditorActionListener(new e1(o9, 8));
    }
}
