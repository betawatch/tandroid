...
public final class n70 {
    ...
    public n70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        ...
        if ((((n2Var instanceof ProfileActivity) && ((ProfileActivity) n2Var).I0) || (((n2Var instanceof org.telegram.ui.uy) && ((org.telegram.ui.uy) n2Var).W) || (((n2Var instanceof ContactsActivity) && ((ContactsActivity) n2Var).I) || ((n2Var instanceof f91) && ((f91) n2Var).M)))) && (parentLayout = n2Var.getParentLayout()) != null) {
        ...
        this.f = view;
        this.s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static n70 F(ViewGroup viewGroup, org.telegram.ui.ActionBar.e6 e6Var, View view) {
        return new n70(viewGroup, e6Var, view, false, false, false);
    }

    public static n70 G(ViewGroup viewGroup, org.telegram.ui.ActionBar.e6 e6Var, View view, boolean z10) {
        return new n70(viewGroup, e6Var, view, z10, false, false);
    }
    ...
    public static void f(n70 n70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = n70Var.d;
        ...
        if (z10 && runnable != null) {
            ...
            f1Var.c(org.telegram.ui.ActionBar.i6.v0(i10, e6Var), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.F8, e6Var));
            f1Var.setSelectorColor(org.telegram.ui.ActionBar.i6.l1(0.12f, org.telegram.ui.ActionBar.i6.v0(i10, e6Var)));
            f1Var.g(LocaleController.getString(R.string.StoriesAlbumNewAlbum), R.drawable.menu_album_add, null);
            f1Var.setOnClickListener(new s6(2, runnable));
        ...
        while (i11 < size) {
            ...
            f1Var2.c(org.telegram.ui.ActionBar.i6.v0(i13, e6Var), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.F8, e6Var));
            f1Var2.setSelectorColor(org.telegram.ui.ActionBar.i6.l1(f7, org.telegram.ui.ActionBar.i6.v0(i13, e6Var)));
    ...
    public final void R(ha haVar, float f7, float f10) {
        ...
        ViewGroup viewGroup = this.A;
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new ka(new la(haVar, viewGroup, 5, false), this.A.getX() + this.a0 + f7, this.A.getY() + this.b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new ka(new la(haVar, childAt, 5, false), this.A.getX() + this.a0 + f7 + childAt.getX(), this.A.getY() + this.b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
            ...
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ...
                if (actionBarPopupWindow$ActionBarPopupWindowLayout.getItemsCount() > 0) {
                    ...
                    if (z10) {
                        ...
                        childAt2.setBackground(org.telegram.ui.ActionBar.i6.Y(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.I5, e6Var), 12, childAt2 == childAt3 ? 12 : 0));
                    ...
                    if (childAt3 instanceof org.telegram.ui.ActionBar.f1) {
                        ...
                        childAt3.setBackground(org.telegram.ui.ActionBar.i6.Y(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.I5, e6Var), childAt2 == childAt3 ? 12 : 0, 12));
    ...
    */
    public final void Z() {
        ...
        if (this.s > 0 || this.u || this.v) {
            ...
            this.m0 = ofFloat;
            ofFloat.addUpdateListener(new i6(this, 29));
            this.m0.addListener(new p8(this, 24));
            if (this.L) {
                f11 = f16;
        ...
        if (this.W) {
            ...
            if (this.U || f17 + height2 + this.A.getMeasuredHeight() + AndroidUtilities.dp(16.0f) > i19) {
                ...
                if (!this.V || Math.max(0.0f, f17 + height2) + this.A.getMeasuredHeight() <= fArr[1] + rectF.top || rectF.height() != view.getHeight()) {
                    ...
                    if (this.v && this.n != null) {
                        int i20 = org.telegram.ui.ActionBar.i6.E8;
                        org.telegram.ui.ActionBar.e6 e6Var = this.d;
                        T(org.telegram.ui.ActionBar.i6.l1(0.06f, org.telegram.ui.ActionBar.i6.v0(i20, e6Var)));
            ...
            if (this.v) {
                int i202 = org.telegram.ui.ActionBar.i6.E8;
                org.telegram.ui.ActionBar.e6 e6Var2 = this.d;
                T(org.telegram.ui.ActionBar.i6.l1(0.06f, org.telegram.ui.ActionBar.i6.v0(i202, e6Var2)));
                ch.d c112 = new ah.c(this.n).c(this.A, null, true);
                c112.o(eh.b.k(e6Var2));
    ...
    public final void b(int i10, Drawable drawable, CharSequence charSequence, int i11, int i12, Runnable runnable) {
        ...
        Integer num = this.j0;
        org.telegram.ui.ActionBar.e6 e6Var = this.d;
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.i6.v0(i12, e6Var);
        Integer num2 = this.k0;
        f1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.i6.v0(i11, e6Var));
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.i6.l1(0.12f, org.telegram.ui.ActionBar.i6.v0(i12, e6Var)));
    ...
    public final void d(org.telegram.ui.ActionBar.f1 f1Var) {
        ...
        Integer num = this.j0;
        org.telegram.ui.ActionBar.e6 e6Var = this.d;
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.E8, e6Var);
        Integer num2 = this.k0;
        f1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.F8, e6Var));
        f1Var.setSelectorColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.ai, e6Var));
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.i6.l1(0.12f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.E8, e6Var)));
        int i10 = this.S;
        if (i10 <= 0) {
            r(f1Var, w7.x5.n(-1, -2));
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        u9Var.setScaleX(z10 ? 0.84f : 1.0f);
        u9Var.setScaleY(z10 ? 0.84f : 1.0f);
        f1Var.addView(u9Var, w7.x5.d(34, 34.0f, (LocaleController.isRTL ? 5 : 3) | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.e6 e6Var = this.d;
        if (z10) {
            View view = new View(context);
            view.setBackground(new gh.c(AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Oh, e6Var), AndroidUtilities.dp(34.0f)));
            f1Var.addView(view, w7.x5.b(36.0f, 36.0f, (LocaleController.isRTL ? 5 : 3) | 16, -6.0f, 0.0f, -5.0f, 0.0f));
        }
        Integer num = this.j0;
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.i6.v0(i11, e6Var);
        Integer num2 = this.k0;
        f1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.i6.v0(i12, e6Var));
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.i6.l1(0.12f, org.telegram.ui.ActionBar.i6.v0(i11, e6Var)));
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        Integer num = this.j0;
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.i6.v0(i10, e6Var);
        Integer num2 = this.k0;
        f1Var.c(intValue, num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.i6.v0(i11, e6Var));
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.i6.l1(0.12f, org.telegram.ui.ActionBar.i6.v0(i10, e6Var)));
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        TextView f7 = org.telegram.ui.Cells.q3.f(frameLayout, textView, w7.x5.d(-2, -2.0f, 55, 59.0f, 6.0f, 16.0f, 0.0f), context);
        org.telegram.messenger.vl.o(org.telegram.ui.ActionBar.i6.q5, e6Var, f7, 1, 13.0f);
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.j5, this.d));
    ...
    public final void t() {
        ...
        View childAt = this.D.L.getChildAt(r0.getItemsCount() - 1);
        if (childAt instanceof org.telegram.ui.ActionBar.f1) {
            w5 textView = ((org.telegram.ui.ActionBar.f1) childAt).getTextView();
    ...
    public n70(ViewGroup viewGroup, org.telegram.ui.ActionBar.e6 e6Var, View view, boolean z10, boolean z11, boolean z12) {
        this.i = 5;
        this.o = new float[2];
        this.t = true;
        this.w = true;
        ...
        this.f = view;
        this.s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.d6, e6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
    ...
    public n70(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, org.telegram.ui.ActionBar.e6 e6Var) {
        this.i = 5;
        this.o = new float[2];
        this.t = true;
        this.w = true;
