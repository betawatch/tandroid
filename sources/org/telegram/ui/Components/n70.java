...
public final class n70 {
    ...
    public static void f(n70 n70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        while (i11 < size) {
            ...
            if (photo == null || (arrayList = photo.sizes) == null) {
                obj = null;
                g1Var2.g(e9Var.b, R.drawable.msg_folders, null);
            } else {
                g1Var2.h(e9Var.b, ImageLocation.getForObject(FileLoader.getClosestPhotoSizeWithSize(e9Var.c.sizes, AndroidUtilities.dp(24.0f), false, FileLoader.getClosestPhotoSizeWithSize(arrayList, 50), true), e9Var.c), "50_50", null, null);
                obj = null;
            }
            g1Var2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.g70
    ...
    */
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        g1Var.addView(u9Var, w7.x5.d(34, 34.0f, (LocaleController.isRTL ? 5 : 3) | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.f6 f6Var = this.d;
        if (z10) {
            ...
            g1Var.addView(view, w7.x5.b(36.0f, 36.0f, (LocaleController.isRTL ? 5 : 3) | 16, -6.0f, 0.0f, -5.0f, 0.0f));
        }
        Integer num = this.j0;
    ...
    public final void j(boolean z10, int i10, ii.b2 b2Var, CharSequence charSequence, Runnable runnable) {
        ...
        int i11 = org.telegram.ui.ActionBar.j6.E8;
        int i12 = org.telegram.ui.ActionBar.j6.F8;
        org.telegram.ui.ActionBar.g1 g1Var = new org.telegram.ui.ActionBar.g1((i10 == 0 && b2Var == null) ? 1 : 2, this.e, this.d, false, false);
        g1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        if (b2Var != null) {
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.messenger.wl.n(org.telegram.ui.ActionBar.j6.q5, f6Var, f7, 1, 13.0f);
