...
public final class n70 extends View {
    ...
    public n70(p70 p70Var, Context context) {
        ...
        this.h = i0.a.k(0, p70Var.s);
        if (p70Var.t && (view instanceof org.telegram.ui.Cells.ua) && (p70Var.c instanceof ProfileActivity)) {
            this.b = new Paint(3);
        ...
        if (p70Var.u || p70Var.v) {
            this.d = new Paint(3);
            view.setAlpha(0.0f);
            ViewGroup viewGroup = p70Var.b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (p70Var.t) {
            ...
            if (bitmap != null && (view.getParent() instanceof View)) {
                canvas2.save();
                if (f12 < 1.0f) {
                    canvas2.clipRect(-rect.left, (((-rect.top) + fArr[1]) - (f12 * (p70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, getMeasuredWidth() + rect.right, getMeasuredHeight() + rect.bottom);
                }
                if (p70Var.L) {
                    p70.A(view, p70Var.b, fArr);
                ...
                Drawable drawable = p70Var.g;
                if (drawable != null) {
                    if (drawable.getIntrinsicWidth() <= 0 || p70Var.g.getIntrinsicHeight() <= 0) {
                        p70Var.g.setBounds(-rect.left, -rect.top, view.getWidth() + rect.right, view.getHeight() + rect.bottom);
                    } else {
                        p70Var.g.setBounds((((view.getWidth() + rect.right) - p70Var.g.getIntrinsicWidth()) / 2) + (-rect.left), (((view.getHeight() + rect.bottom) - p70Var.g.getIntrinsicHeight()) / 2) + (-rect.top), ((p70Var.g.getIntrinsicWidth() + (view.getWidth() + rect.right)) / 2) + (-rect.left), ((p70Var.g.getIntrinsicHeight() + (view.getHeight() + rect.bottom)) / 2) + (-rect.top));
                    }
                    p70Var.g.draw(canvas2);
                }
                if (p70Var.k > 0 || p70Var.l > 0) {
                    path.rewind();
                    RectF rectF = AndroidUtilities.rectTmp;
                    float f13 = -rect.left;
                    float f14 = p70Var.k;
                    rectF.set((this.w * f14) + f13, (getAlpha() * f14) + (-rect.top), (bitmap.getWidth() + (-rect.left)) - (getAlpha() * p70Var.k), (bitmap.getHeight() + (-rect.top)) - (getAlpha() * p70Var.k));
                    float f15 = p70Var.l * this.w;
            ...
            if (view != 0 && (view.getParent() instanceof View)) {
                ...
                if (f12 >= 1.0f && f16 == 0.0f) {
                    ...
                    f10 = 255.0f;
                    c3 = 0;
                    canvas2.clipRect(-rect.left, AndroidUtilities.lerp((((-rect.top) + fArr[1]) - (f12 * (p70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, 0.0f, this.w), getMeasuredWidth() + rect.right, org.telegram.ui.ai.c(1.0f, this.w, f16, getMeasuredHeight() + rect.bottom));
                } else {
                    f10 = 255.0f;
                    c3 = 0;
                    canvas2.clipRect(-rect.left, (((-rect.top) + fArr[1]) - (f12 * (p70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, getMeasuredWidth() + rect.right, getMeasuredHeight() + rect.bottom);
                ...
                if (p70Var.N == 0 || p70Var.O == 0) {
                    ...
                    width = AndroidUtilities.lerp(view.getWidth(), p70Var.N, f17);
                    height = AndroidUtilities.lerp(view.getHeight(), p70Var.O, f17);
                }
                float f18 = height;
                Drawable drawable2 = p70Var.g;
                if (drawable2 != null) {
                    if (drawable2.getIntrinsicWidth() <= 0 || p70Var.g.getIntrinsicHeight() <= 0) {
                        f11 = 1.0f;
                        p70Var.g.setBounds(-rect.left, -rect.top, view.getWidth() + rect.right, view.getHeight() + rect.bottom);
                    } else {
                        f11 = 1.0f;
                    ...
                    p70Var.g.setAlpha((int) (this.w * f10));
                    if (Build.VERSION.SDK_INT >= 29) {
                        Drawable drawable3 = p70Var.g;
                        if (drawable3 instanceof ShapeDrawable) {
                            Paint paint3 = ((ShapeDrawable) drawable3).getPaint();
                            paint3.setShadowLayer(paint3.getShadowLayerRadius(), paint3.getShadowLayerDx(), paint3.getShadowLayerDy(), org.telegram.ui.ActionBar.j6.l1(this.w, p70Var.h));
                        }
                    }
                    p70Var.g.draw(canvas2);
                } else {
                ...
                if (!(view instanceof org.telegram.ui.Cells.q7)) {
                    if (!(view instanceof kh.x1) || p70Var.N == 0 || p70Var.O == 0) {
                        ...
                        ((kh.x1) view).a(this, canvas2, width, f18, this.w);
                        canvas2 = canvas;
                    } else {
                        ...
                        ((kh.x1) view).a(this, canvas, width, f18, this.w);
                        canvas.restore();
                        canvas2 = canvas;
                    }
                    canvas2.restore();
                ...
                if (view.getAlpha() >= f11) {
                    ((org.telegram.ui.Cells.q7) view).a(canvas2, width, f18, this.w);
                } else {
                    float f24 = width;
                    ...
                    ((org.telegram.ui.Cells.q7) view).a(canvas2, f24, f18, this.w);
                    canvas2.restore();
                }
                canvas2.restore();
            }
