...
public class vv extends ViewGroup {
    ...
    public final void c() {
        ...
        if (this.x && this.y) {
            ...
            if (l5Var != null || (this.s == null && this.r == null)) {
                ...
                zv zvVar = this.G;
                if (document != null) {
                    this.w = l5.m(UserConfig.selectedAccount, zvVar.P, document);
                } else {
                    this.w = l5.n(UserConfig.selectedAccount, this.r.longValue(), null, zvVar.P);
                }
                this.w.a(p9Var);
    ...
    public final void g(boolean z4, boolean z10) {
        ...
        if ((p9Var == null || p9Var.getImageReceiver().getImageDrawable() != null || this.G.M) && this.E != z4) {
            ...
            this.F.setDuration(ng.g0.d() ? 0L : 350L);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        fg.r1 r1Var = this.f;
        if (r1Var != null) {
            r1Var.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(12.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(12.0f), TLObject.FLAG_30));
        }
    }
    ...
    public vv(zv zvVar, Context context, TLRPC.Document document) {
        ...
        addView(svVar);
        int i10 = fg.r1.I;
        tv tvVar = new tv(context, 1, zvVar.v);
        this.f = tvVar;
        tvVar.setAlpha(0.0f);
    ...
    public vv(zv zvVar, Context context, long j10) {
        ...
        addView(a4Var);
        int i10 = fg.r1.I;
        uv uvVar = new uv(context, 1, zvVar.v);
        this.f = uvVar;
        uvVar.setAlpha(0.0f);
        uvVar.setScaleX(0.0f);
        uvVar.setScaleY(0.0f);
        f();
        addView(uvVar);
        d();
    }
