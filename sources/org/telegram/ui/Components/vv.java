...
public final class vv extends LinearLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (!this.h) {
            ...
            int A = (int) (org.telegram.messenger.ul.A(30.0f, childCount, ((i12 - i10) - getPaddingLeft()) - getPaddingRight()) / Math.max(1, childCount - 1));
            ...
            if (childAt2 != zvVar && !dwVar.H.containsKey(childAt2) && childAt2 != null) {
                ...
                if (dwVar.O && z11) {
                    ...
                    if (zvVar3.b) {
                        ...
                        childAt2.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(zg.f0.d() ? 0L : 200L).setInterpolator(rr.h).start();
                    }
                }
                if (l4 != null) {
                ...
                if ((childAt2 != dwVar.y || dwVar.W) && (childAt2 != dwVar.E || dwVar.b0)) {
                    paddingLeft2 = org.telegram.messenger.z0.C(3.0f, childAt2.getMeasuredWidth(), paddingLeft2);
                }
            }
            i16++;
        }
