...
public final class br0 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(0.0f, (-org.telegram.messenger.q.B(4.0f, getMeasuredHeight(), dp)) * f11);
        int i11 = 0;
        while (i11 < i10) {
            ...
            rectF.set(AndroidUtilities.dp(1.0f) + measuredWidth, f12, org.telegram.messenger.q.D(1.0f, measuredWidth, measuredWidth), f13);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), paint2);
            i11++;
            i10 = 7;
            f7 = 3.0f;
