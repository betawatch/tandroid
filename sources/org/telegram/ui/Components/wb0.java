...
public final class wb0 implements org.telegram.ui.Cells.l1 {
    ...
    public final void V0(org.telegram.ui.Cells.u1 u1Var, CharacterStyle characterStyle, boolean z10) {
        xb0 xb0Var = this.a;
        yb0 yb0Var = xb0Var.c;
        if (yb0Var.a != 2 || yb0Var.c0.d.currentLink == characterStyle || u1Var.getMessageObject() == null || !(characterStyle instanceof URLSpan)) {
            return;
        }
        ...
        org.telegram.ui.zn znVar = ec0Var.c;
        if (znVar != null && url != null) {
            znVar.Ya(url, true);
        }
        yb0.b(xb0Var.c, u1Var);
    }
