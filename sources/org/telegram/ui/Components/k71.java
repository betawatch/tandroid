    ...
    public final void a(Canvas canvas, View view) {
        ...
        if (f17 != 1.0f) {
            ...
            if (f18 >= 1.0f) {
                ...
                view.invalidate();
                float interpolation = nr.f.getInterpolation(this.C);
        ...
        if (this.t != dp) {
            ...
            if (f26 < dp) {
                c3 = 0;
                float c11 = vh.v2.c(j10, 60.0f, AndroidUtilities.dp(1.0f), f26);
                this.t = c11;
                if (c11 > dp) {
                    this.t = dp;
                }
        ...
        float interpolation2 = nr.f.getInterpolation(this.M);
        canvas.save();
        int i15 = this.i;
