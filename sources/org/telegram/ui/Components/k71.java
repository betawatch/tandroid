...
public final class k71 {
    ...
    public final void a(Canvas canvas, View view) {
        ...
        if (f17 != 1.0f) {
            ...
            if (f18 >= 1.0f) {
                ...
                view.invalidate();
                float interpolation = mr.f.getInterpolation(this.C);
        ...
        if (this.t != dp) {
            ...
            if (f26 < dp) {
                c3 = 0;
                float c11 = vh.w2.c(j10, 60.0f, AndroidUtilities.dp(1.0f), f26);
                this.t = c11;
                if (c11 > dp) {
                    this.t = dp;
                }
        ...
        float interpolation2 = mr.f.getInterpolation(this.M);
        canvas.save();
        int i15 = this.i;
    ...
    */
    public final void b(Canvas canvas, RectF rectF, Paint paint) {
        ...
        char c10;
        k71 k71Var = this;
        float dp = AndroidUtilities.dp(AndroidUtilities.lerp(2, 1, k71Var.y));
        ArrayList arrayList = k71Var.F;
        if (arrayList == null || arrayList.isEmpty()) {
            canvas.drawRoundRect(rectF, dp, dp, paint);
            return;
        }
        float f10 = rectF.bottom;
        float lerp = AndroidUtilities.lerp(S / 2.0f, 0.0f, k71Var.y) + k71Var.z;
        float lerp2 = AndroidUtilities.lerp(k71Var.h - (S / 2.0f), k71Var.v.getWidth() - (k71Var.z * 2.0f), k71Var.y) + k71Var.z;
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(k71Var.I * 1.0f) / 2.0f;
        if (U == null) {
            U = new Path();
        }
        U.reset();
        ...
        while (true) {
            i10 = -1;
            if (i11 >= k71Var.F.size()) {
                i11 = -1;
                break;
            } else if (((Float) ((Pair) k71Var.F.get(i11)).first).floatValue() >= dp3) {
                break;
            } else {
                i11++;
            }
        ...
        int size = k71Var.F.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) k71Var.F.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i12) {
            if (i13 == i11) {
                ...
                c3 = 1;
                floatValue = ((Float) ((Pair) k71Var.F.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i12 ? 1.0f : ((Float) ((Pair) k71Var.F.get(i13)).first).floatValue();
            while (i13 != i12 && i13 != 0 && i13 < k71Var.F.size() - 1 && ((Float) ((Pair) k71Var.F.get(i13)).first).floatValue() - floatValue <= dp3) {
                i13++;
                floatValue2 = ((Float) ((Pair) k71Var.F.get(i13)).first).floatValue();
            }
