...
public abstract class ji0 {
    ...
    public final void c(Canvas canvas, boolean z10) {
        ...
        boolean z12 = r2Var instanceof tf1;
        ...
        if (f43 == 0.0f || z11) {
            ...
            ii0Var.b.setColor(this.G ? paint2.getColor() : org.telegram.ui.ActionBar.h6.w0(null, this.b, false));
            ii0Var.draw(canvas);
            canvas.restore();
        } else {
            i15 = dp;
        ...
        if (this.T != null) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.H.getMeasuredWidth(), this.H.getMeasuredHeight(), (int) (org.telegram.messenger.z0.A(1.0f, this.o, 255.0f, f12) * this.x), 31);
        ...
        float f56 = this.C;
        float a2 = org.telegram.ui.Cells.q3.a(1.0f - dp7, f56, dp7, f7);
        float f57 = i16 - f23;
        float f58 = 1.0f - f56;
        ...
        if (!org.telegram.ui.ActionBar.h6.C1) {
            yi0 yi0Var = org.telegram.ui.ActionBar.h6.u1;
            yi0Var.Z = true;
            int i28 = this.d;
            yi0Var.Q(org.telegram.ui.ActionBar.h6.w0(null, i28, true), "Arrow1");
