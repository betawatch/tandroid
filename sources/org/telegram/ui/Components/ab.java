...
public abstract class ab extends org.telegram.ui.ActionBar.f3 {
    ...
    */
    public ab(org.telegram.ui.ActionBar.n2 n2Var, boolean z10) {
        this(r0, n2Var, new za(r1));
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public ab(org.telegram.ui.ActionBar.n2 n2Var, boolean z10, boolean z11, org.telegram.ui.ActionBar.f6 f6Var) {
        this(r0, n2Var, new za(r1));
        Activity parentActivity = n2Var.getParentActivity();
        za zaVar = new za();
        zaVar.a = z10;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public ab(Context context, org.telegram.ui.ActionBar.n2 n2Var, boolean z10, boolean z11, org.telegram.ui.ActionBar.f6 f6Var) {
        this(context, n2Var, new za(r0));
        za zaVar = new za();
        zaVar.a = z10;
        zaVar.c = z11;
        zaVar.d = false;
    ...
    */
    public ab(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        this(context, (org.telegram.ui.ActionBar.n2) null, new za(r0));
        za zaVar = new za();
        zaVar.a = z10;
        zaVar.c = false;
        zaVar.d = false;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public ab(Context context, org.telegram.ui.ActionBar.n2 n2Var, boolean z10, boolean z11, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        this(context, n2Var, new za(r0));
        za zaVar = new za();
        zaVar.a = z10;
        zaVar.c = false;
    ...
    */
    ...
    public ab(Context context, org.telegram.ui.ActionBar.n2 n2Var, za zaVar) {
        ...
        if (z11) {
            ...
            cw0Var = new va(this, context, z12, z10);
        }
        yl0 w10 = w(context);
        this.d = w10;
        ...
        if (z10) {
            ...
            wa waVar = new wa(this, context, cw0Var);
            this.e = waVar;
            ...
            waVar.B(getThemedColor(org.telegram.ui.ActionBar.j6.y8), false);
            waVar.setCastShadows(true);
            waVar.setTitle(y());
            waVar.setActionBarMenuOnItemClick(new org.telegram.ui.ro(this, 7));
            cw0Var.addView(w10);
            cw0Var.addView(waVar, w7.y5.d(-1, -2.0f, 0, 6.0f, 0.0f, 6.0f, 0.0f));
            w10.j(new ai.r(cw0Var, 16));
        }
        if (i10 == 2) {
            K();
        }
