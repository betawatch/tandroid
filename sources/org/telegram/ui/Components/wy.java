...
public final class wy extends il0 {
    ...
    public final int F(int i10) {
        ...
        if (i14 == Integer.MIN_VALUE) {
            ...
            if (obj2 instanceof String) {
                return "premium".equals(obj2) ? fzVar.E1 : "recent".equals(obj2) ? fzVar.B1 : fzVar.C1;
            }
    ...
    */
    public final void G() {
        ...
        int measuredWidth = fzVar2.getMeasuredWidth();
        if (measuredWidth == 0) {
            measuredWidth = AndroidUtilities.displaySize.x;
        }
        ...
        int i14 = 0;
        this.s = 0;
        ArrayList arrayList2 = fzVar2.Z0;
        int i15 = -5;
        int i16 = -5;
        int i17 = 0;
        boolean z10 = false;
            ...
            if (i16 == i15) {
                ...
                if (i16 == -4) {
                    ...
                    if (i10 == -3) {
                        ...
                        arrayList = fzVar2.f1;
                        if (!arrayList.isEmpty() && !fzVar2.I2) {
                            z10 = true;
                        }
    ...
    public final void v(f2.n1 n1Var, int i10) {
        ...
        if (i12 == 0) {
            ...
            b8Var.d(document, null, this.n.get(i10), null, false, false);
            b8Var.setRecent(fzVar.f1.contains(document));
            return;
        }
        ...
        if (i12 == 1) {
            ...
            if (obj instanceof TLRPC.TL_messages_stickerSet) {
                ...
                arrayList = "recent".equals(obj) ? fzVar.f1 : fzVar.g1;
            }
            if (arrayList == null) {
                i3Var.setHeight(1);
                return;
                ...
                int z10 = org.telegram.ui.b.z(82.0f, (int) Math.ceil(arrayList.size() / this.d), fzVar.h.getHeight());
        ...
        if (i12 != 2) {
            if (i12 == 3) {
                ((org.telegram.ui.Cells.j8) view).setIsLast(i10 == this.s - 1);
                return;
            } else {
                if (i12 != 5) {
                    return;
                }
                ((org.telegram.ui.Cells.k8) view).c(LocaleController.getString(MediaDataController.getInstance(i11).loadFeaturedPremium ? R.string.FeaturedStickersPremium : R.string.FeaturedStickers), R.drawable.msg_close, LocaleController.getString(R.string.AccDescrCloseTrendingStickers), 0, 0);
                return;
            }
        }
        org.telegram.ui.Cells.k8 k8Var = (org.telegram.ui.Cells.k8) view;
        k8Var.setHeaderOnClick(null);
        if (i10 == fzVar.b1) {
            int i15 = (fzVar.c1 && fzVar.d1 == null) ? 0 : fzVar.d1 != null ? R.drawable.msg_mini_customize : R.drawable.msg_close;
            TLRPC.Chat chat = fzVar.F1 != null ? MessagesController.getInstance(i11).getChat(Long.valueOf(fzVar.F1.id)) : null;
            k8Var.b(i15, LocaleController.formatString("CurrentGroupStickers", R.string.CurrentGroupStickers, chat != null ? chat.title : "Group Stickers"));
            return;
        }
        ...
        if (obj2 instanceof TLRPC.TL_messages_stickerSet) {
            ...
            if (stickerSet != null) {
                ...
                if (tL_messages_stickerSet.set.creator && !fzVar.I2) {
                    k8Var.setEdit(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.uy
                ...
                k8Var.setHeaderOnClick(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.uy
                    public final /* synthetic */ wy b;
        ...
        if (obj2 == fzVar.f1) {
            k8Var.c(LocaleController.getString(R.string.RecentStickers), R.drawable.msg_close, LocaleController.getString(R.string.ClearRecentStickersAlertTitle), 0, 0);
        } else if (obj2 == fzVar.g1) {
            k8Var.b(0, LocaleController.getString(R.string.FavoriteStickers));
        } else if (obj2 == fzVar.h1) {
            k8Var.b(0, LocaleController.getString(R.string.PremiumStickers));
        }
    }
    ...
    public final f2.n1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                view = new vy(i12, context, fzVar.V1, z10 ? 1 : 0);
                break;
            case 1:
            ...
            case 3:
                ...
                j8Var.addView(textView, i7.f6.t(-1, -2, 51, 17, 4, 17, 0));
                ...
                j8Var.addView(textView2, i7.f6.t(-2, 28, 51, 17, 10, 14, 8));
                j8Var.setAddOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ty
                    public final /* synthetic */ wy b;
                        ...
                        switch (i12) {
                            ...
                            case 1:
                                ...
                                if (!featuredStickerSets.isEmpty()) {
                                    MessagesController.getEmojiSettings(fzVar3.Y0).edit().putLong("featured_hidden", featuredStickerSets.get(0).set.id).commit();
                                    wy wyVar = fzVar3.u0;
                                    if (wyVar != null) {
                                        wyVar.t(1, 2);
                                    }
                ...
                j8Var.setLayoutParams(new f2.x0(-1, -2));
                view = j8Var;
                break;
            case 4:
                ...
                break;
            case 5:
                org.telegram.ui.Cells.k8 k8Var2 = new org.telegram.ui.Cells.k8(this.c, false, false, fzVar.V1, fzVar.e2);
                k8Var2.setOnIconClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ty
                    public final /* synthetic */ wy b;
            ...
            case 7:
                ...
                linearLayout.setBackground(org.telegram.ui.ActionBar.g6.b0(dp, org.telegram.ui.ActionBar.g6.l1(0.12f, fzVar.A(i14))));
                i7.h6.b(linearLayout, 0.1f, 1.5f);
                linearLayout.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ty
                    public final /* synthetic */ wy b;
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(fzVar.A(i14), PorterDuff.Mode.SRC_IN));
                linearLayout.addView(imageView, i7.f6.t(24, 24, 17, 0, 0, 0, 0));
                TextView textView3 = new TextView(context);
                textView3.setGravity(17);
                textView3.setTextColor(fzVar.A(i14));
                textView3.setTextSize(1, 11.0f);
                textView3.setTypeface(AndroidUtilities.bold());
                textView3.setText(LocaleController.getString(R.string.Create));
                linearLayout.addView(textView3, i7.f6.t(-1, -2, 17, 0, 3, 0, 0));
                frameLayout.addView(linearLayout, i7.f6.d(-1, -1.0f, 119, 8.0f, 8.0f, 8.0f, 8.0f));
                view = frameLayout;
                break;
        }
        return new vk0(view);
