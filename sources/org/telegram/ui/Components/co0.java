...
public class co0 {
    ...
    */
    public final void c(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = E;
        float f11 = i11 / 2.0f;
        float f12 = co0Var.f - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp = AndroidUtilities.dp(co0Var.x * 1.0f) / 2.0f;
        if (G == null) {
            G = new Path();
        }
        G.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= co0Var.u.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) co0Var.u.get(i12)).first).floatValue() >= dp2) {
                break;
            } else {
                i12++;
            }
        ...
        int size = co0Var.u.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) co0Var.u.get(size)).first).floatValue() >= dp2) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) co0Var.u.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) co0Var.u.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= co0Var.u.size() - 1 || ((Float) ((Pair) co0Var.u.get(i13)).first).floatValue() - floatValue > dp2) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) co0Var.u.get(i13)).first).floatValue();
            }
            c11 = 1;
