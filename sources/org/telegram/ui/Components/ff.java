...
public final class ff extends fp0 {
    ...
    public ff(ChatActivityEnterView chatActivityEnterView, final Context context, final org.telegram.ui.eo eoVar, MessagesController messagesController, final boolean z10, TLRPC.Peer peer, TLRPC.TL_channels_sendAsPeers tL_channels_sendAsPeers, final androidx.car.app.utils.a aVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int width = (int) ((eoVar == null ? AndroidUtilities.displaySize.x : eoVar.X0.getWidth()) * 0.75f);
        zo0 zo0Var = new zo0(context, width, AndroidUtilities.dp(450.0f));
        this.o = zo0Var;
        zo0Var.setOrientation(1);
        TextView textView = new TextView(context);
        this.p = textView;
        org.telegram.messenger.em.n(org.telegram.ui.ActionBar.j6.m5, f6Var, textView, 1, 16.0f);
        ...
        vl0Var.setAdapter(new ap0(f6Var, arrayList, messagesController, width, peer));
        vl0Var.j(new bp0(this));
        vl0Var.setOnItemClickListener(new jl0() { // from class: org.telegram.ui.Components.xo0
            @Override // org.telegram.ui.Components.jl0
            public final void d(int i10, View view) {
                fp0.k(ff.this, arrayList, context, eoVar, z10, aVar, view, i10);
            }
        });
    ...
    @Override // org.telegram.ui.Components.fp0, org.telegram.ui.ActionBar.p1, android.widget.PopupWindow
