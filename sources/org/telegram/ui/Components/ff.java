...
public final class ff extends ip0 {
    ...
    public ff(ChatActivityEnterView chatActivityEnterView, final Context context, final org.telegram.ui.wn wnVar, MessagesController messagesController, final boolean z10, TLRPC.Peer peer, TLRPC.TL_channels_sendAsPeers tL_channels_sendAsPeers, final ai.q5 q5Var, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        int width = (int) ((wnVar == null ? AndroidUtilities.displaySize.x : wnVar.X0.getWidth()) * 0.75f);
        cp0 cp0Var = new cp0(context, width, AndroidUtilities.dp(450.0f));
        this.o = cp0Var;
        cp0Var.setOrientation(1);
        TextView textView = new TextView(context);
        this.p = textView;
        org.telegram.messenger.ok.n(org.telegram.ui.ActionBar.h6.m5, d6Var, textView, 1, 16.0f);
        ...
        wl0Var.setAdapter(new dp0(d6Var, arrayList, messagesController, width, peer));
        wl0Var.j(new ep0(this));
        wl0Var.setOnItemClickListener(new kl0() { // from class: org.telegram.ui.Components.bp0
            @Override // org.telegram.ui.Components.kl0
            public final void d(int i10, View view) {
                ip0.k(ff.this, arrayList, context, wnVar, z10, q5Var, view, i10);
            }
        });
    ...
    @Override // org.telegram.ui.Components.ip0, org.telegram.ui.ActionBar.m1, android.widget.PopupWindow
