...
public final class o41 extends pv0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float Z = Z();
        boolean z4 = Z == 0.0f && !p41Var.isDismissed();
        if (this.w0 != z4) {
        ...
        if (this.A0 != z10) {
            this.A0 = z10;
            boolean z11 = AndroidUtilities.computePerceivedBrightness(p41Var.getThemedColor(org.telegram.ui.ActionBar.k6.h5)) > 0.721f;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.k6.v(p41Var.getThemedColor(org.telegram.ui.ActionBar.k6.s8), 855638016)) > 0.721f;
            if (!z10) {
                z11 = z12;
            }
        ...
        if (this.y0 > 0.0f) {
            int themedColor = p41Var.getThemedColor(org.telegram.ui.ActionBar.k6.h5);
            Paint paint = this.t0;
        ...
        gradientDrawable.setColor(i0.a.k(p41Var.getThemedColor(org.telegram.ui.ActionBar.k6.Ii), (int) (Color.alpha(r5) * Z)));
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.y3.C(10.0f, p41Var.f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + p41Var.f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(p41Var.getThemedColor(org.telegram.ui.ActionBar.k6.h5));
            float[] fArr = this.z0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
