...
public final class o41 extends pv0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.D0 != z11) {
            this.D0 = z11;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5)) > 0.721f;
            boolean z13 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v(p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.s8), 855638016)) > 0.721f;
            if (!z11) {
                z12 = z13;
            }
        ...
        if (this.B0 > 0.0f) {
            int themedColor = p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5);
            Paint paint = this.w0;
        ...
        gradientDrawable.setColor(i0.a.k(p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.Ii), (int) (Color.alpha(r5) * Z)));
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.z0.C(10.0f, p41Var.f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + p41Var.f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(p41Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5));
            float[] fArr = this.C0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
