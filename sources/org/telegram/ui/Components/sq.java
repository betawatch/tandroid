...
public abstract class sq {
    public static void a(Context context, final int i9, TLRPC.User user, TLRPC.TL_requestPeerTypeCreateBot tL_requestPeerTypeCreateBot, boolean z10, final Utilities.Callback callback, org.telegram.ui.ActionBar.b6 b6Var, oc ocVar) {
        ...
        h.setText(AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(R.string.CreateManagedBotText, UserObject.getUserName(user)), org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.gc, b6Var)));
        h.setGravity(17);
        ...
        j10.setBackgroundColor(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.a7, b6Var));
        ...
        j10.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Components.oq
