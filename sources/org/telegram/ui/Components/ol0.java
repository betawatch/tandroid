...
public final class ol0 extends Dialog {
    ...
    public final void c(Runnable runnable, boolean z10) {
        ...
        this.J = ofFloat;
        ofFloat.addUpdateListener(new v60(this, 11));
    ...
    public final void e(b70 b70Var) {
        ...
        b70Var.Q(this.n, ng.c.j(c6Var), false);
        this.w = b70Var;
        this.y = b70Var.A;
        FrameLayout frameLayout = new FrameLayout(this.a);
        this.x = frameLayout;
        frameLayout.addView(this.y, h7.z5.c(-2.0f, -2));
        this.v.addView(this.x, h7.z5.c(-2.0f, -2));
    }
    ...
    /* JADX WARN: Type inference failed for: r5v6, types: [android.graphics.Path, org.telegram.ui.Components.iq, org.telegram.ui.Components.j80] */
    /* JADX WARN: Type inference failed for: r7v16, types: [android.graphics.Path, org.telegram.ui.Components.j80] */
    /*
                    ...
                    if (characterStyleArr != null) {
                        for (CharacterStyle characterStyle2 : characterStyleArr) {
                            if (characterStyle2 == characterStyle) {
                                ...
                                f13 = i18 + f18;
                                f14 = textLayoutBlock.textYOffset(arrayList, s1Var.Vc) + textLayoutBlock.padTop + f19;
                                ...
                                if (charSequence != null) {
                                    ...
                                    ?? j80Var = new j80(0);
                                    j80Var.d(r14, i22, 0.0f);
                                    r14.getSelectionPath(i22, i23, j80Var);
                                ...
                                if (!s1Var.B1() || width2 <= 0) {
                                    ...
                                    if (rectF3.height() > 0.0f) {
                                        ...
                                        canvas.drawPath(j80Var2, paint4);
                                        bitmap = createBitmap;
                                        ...
                                        this.A = new nl0(j80Var2, new int[]{iArr[0] + ((int) f22), iArr[1] + ((int) f15)}, s1Var, iArr, bitmap, rectF3, paint5, paint, makeStaticLayout2);
                                ...
                                this.A = new nl0(j80Var2, new int[]{iArr2[0] + ((int) f22), iArr2[1] + ((int) f15)}, s1Var, iArr2, bitmap, rectF3, paint52, paint, makeStaticLayout22);
