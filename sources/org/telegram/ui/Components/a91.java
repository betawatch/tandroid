...
public final class a91 extends AsyncTask {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:136:0x0282, code lost:
        ...
        r0 = org.telegram.ui.Components.b91.u0.matcher(r4);
     */
    ...
    */
    public final Object doInBackground(Object[] objArr) {
        ...
        boolean z12 = true;
        String c12 = b91.c(this, str5, null, true);
        if (!isCancelled()) {
            ...
            if (c12 != null) {
                Matcher matcher = b91.t0.matcher(c12);
                if (matcher.find()) {
            ...
            while (true) {
                ...
                b91Var2.getClass();
                String c14 = b91.c(this, str7, hashMap, z12);
                if (isCancelled()) {
                    return hashMap;
                }
                if (c14 != null) {
        ...
        String str10 = null;
        if (str10 != null) {
            Matcher matcher2 = b91.A0.matcher(str10);
            if (matcher2.find()) {
            ...
            if (str2 == null) {
                ...
                this.e.getClass();
                obj = null;
                String c15 = b91.c(this, str10, null, true);
                if (!isCancelled()) {
                    if (c15 != null) {
                        Matcher matcher3 = b91.v0.matcher(c15);
                        if (matcher3.find()) {
                            str3 = matcher3.group(1);
                        } else {
                            Matcher matcher4 = b91.w0.matcher(c15);
                            if (matcher4.find()) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                try {
                    AndroidUtilities.runOnUIThread(new jn0(25, this, str2 + str3 + "('" + this.d.substring(3) + "');"));
                    this.b.await();
                } catch (Exception e15) {
                    FileLog.e(e15);
                    z16 = true;
