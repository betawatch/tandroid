...
public abstract class x61 extends View {
    ...
    public x61(Context context) {
        ...
        this.U = paint6;
        this.V = new y5(0.0f, this, 0L, 200L, er.j);
        this.W = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        ...
        for (int i10 = 0; i10 < this.B.size(); i10++) {
            ...
            if (v61Var != null && (bitmap = v61Var.a) != null) {
                bitmap.recycle();
            }
        }
        this.B.clear();
        ...
        if (isEmpty && this.C == null) {
            ...
            if (!z10) {
                ...
                while (true) {
                    ...
                    if (((v61) arrayList.get(i10)).a == null) {
                        this.a0 = true;
                        break;
                    }
                    i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                Bitmap bitmap = v61Var.a;
                if (bitmap != null) {
                    float f17 = (this.E * i11) + dpf2;
                    ...
                    if (f18 != 1.0f) {
                        ...
                        int interpolation = (int) (er.h.getInterpolation(v61Var.b) * 255.0f);
                        Paint paint = this.M;
        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.y != null) {
                    ...
                    if (dp3 != dp && dp2 - dp5 <= x8 && x8 <= dp5 + dp2 && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        w61 w61Var = this.A;
                        if (w61Var != null) {
                    ...
                    if (dp - dp4 <= x8 && x8 <= Math.min(dp + dp4, dp3) && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        w61 w61Var2 = this.A;
                        if (w61Var2 != null) {
                    ...
                    if (dp3 - dp4 <= x8 && x8 <= dp4 + dp3 && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        w61 w61Var3 = this.A;
                        if (w61Var3 != null) {
                    ...
                    if (dp <= x8 && x8 <= dp3 && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        w61 w61Var4 = this.A;
                        if (w61Var4 != null) {
                            ((com.google.android.gms.common.api.internal.v) w61Var4).c(2);
                        }
                        this.r = true;
                        float dp6 = (x8 - AndroidUtilities.dp(16.0f)) / f10;
                        this.s = dp6;
                        w61 w61Var5 = this.A;
                        if (w61Var5 != null) {
                ...
                if (this.r) {
                    float dp7 = (((int) (x8 - this.v)) - AndroidUtilities.dp(16.0f)) / f10;
                    this.s = dp7;
                    float f11 = this.d;
                    if (dp7 < f11) {
                        this.s = f11;
                ...
                if (this.n) {
                    ...
                    w61 w61Var11 = this.A;
                    if (w61Var11 != null) {
                        ((com.google.android.gms.common.api.internal.v) w61Var11).e(this.e);
                    }
                    invalidate();
                    return true;
                }
    ...
    public void setRightProgress(float f10) {
        ...
        w61 w61Var2 = this.A;
        if (w61Var2 != null) {
            ((com.google.android.gms.common.api.internal.v) w61Var2).e(this.e);
        }
        w61 w61Var3 = this.A;
        if (w61Var3 != null) {
