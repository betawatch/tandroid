...
public final class w11 implements TextWatcher {
    ...
    */
    public final void afterTextChanged(Editable editable) {
        ...
        int i12;
        x11 x11Var = this.b;
        EditTextBoldCursor[] editTextBoldCursorArr = x11Var.n;
        ThemeEditorView.EditorAlert editorAlert = x11Var.I;
        if (editorAlert.K) {
            return;
        }
        editorAlert.K = true;
        ...
        if (i13 == 2) {
            ...
            if (i13 != 0) {
                ...
                for (i12 = 0; i12 < ThemeEditorView.this.c.size(); i12++) {
                    ((org.telegram.ui.ActionBar.l6) ThemeEditorView.this.c.get(i12)).d(x11Var.b(), false, true);
                }
                editorAlert.K = false;
            }
            i10 = b10 & (-16711681);
