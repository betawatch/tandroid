...
public class w11 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void f(jp jpVar, long j10, boolean z4) {
        ...
        boolean z10 = this.D != jpVar;
        int i14 = this.S;
        int i15 = jpVar.c;
        boolean z11 = i14 != i15;
        this.S = i15;
        this.D = jpVar;
        TLRPC.Document f10 = jpVar.a.f();
        org.telegram.ui.ActionBar.e4 e4Var2 = jpVar.a;
        ...
        if (z10) {
            ...
            if (svgThumb == null) {
                Emoji.preloadEmoji(jpVar.a.e);
                svgThumb = Emoji.getEmojiDrawable(jpVar.a.e);
            }
        ...
        this.E.setVisibility((!jpVar.a.m() || this.Q == null) ? 0 : 8);
        if (z10 || z11) {
            if (z4) {
                this.n = 0.0f;
                this.h = this.f;
            ...
            v11 v11Var = this.f;
            jp jpVar2 = this.D;
            if (jpVar2 == null || (e4Var = jpVar2.a) == null) {
                j11 = 0;
            } else {
                org.telegram.ui.ActionBar.d4 d4Var = (org.telegram.ui.ActionBar.d4) e4Var.f.get(jpVar2.c);
                int i16 = d4Var.h;
                if (this.R != 0) {
                    i16 = d4Var.k;
                }
                ...
                jp jpVar3 = this.D;
                sf.a aVar = (sf.a) jpVar3.a.f.get(jpVar3.c);
                if (aVar != null) {
                    org.telegram.ui.ActionBar.d4 d4Var2 = (org.telegram.ui.ActionBar.d4) aVar;
                    if (d4Var2.a() != 0) {
                        jp jpVar4 = this.D;
                        int i17 = ((org.telegram.ui.ActionBar.d4) jpVar4.a.f.get(jpVar4.c)).d;
                ...
                jp jpVar5 = this.D;
                org.telegram.ui.ActionBar.d4 d4Var3 = (org.telegram.ui.ActionBar.d4) jpVar5.a.f.get(jpVar5.c);
                if (this.D != null) {
                    int i22 = d4Var3.k;
                    int i23 = d4Var3.l;
                    int i24 = d4Var3.m;
            ...
            long i27 = jpVar.a.i(this.S);
            if (i27 != j11) {
                TLRPC.WallPaper k10 = jpVar.a.k(this.S);
                if (k10 != null) {
                    jpVar.a.p(this.S, new s1(this, i27, jpVar, k10.settings.intensity));
                }
            } else {
                SparseArray sparseArray = jpVar.a.j(this.S).X;
                org.telegram.ui.ActionBar.h6 h6Var = sparseArray != null ? (org.telegram.ui.ActionBar.h6) sparseArray.get(((org.telegram.ui.ActionBar.d4) jpVar.a.f.get(this.S)).e) : null;
                if (h6Var != null && (tL_theme = h6Var.r) != null && tL_theme.settings.size() > 0) {
                    ...
                    Drawable drawable2 = jpVar.b;
                    if (drawable2 instanceof dc0) {
                        dc0 dc0Var6 = (dc0) drawable2;
                        dc0Var6.t(dc0Var6.u, i28);
                    }
                    ChatThemeController.chatThemeQueue.postRunnable(new ey(this, jpVar, i28, 21));
                }
            }
        }
        if (!z4) {
    ...
    public final void g(boolean z4, boolean z10) {
        ...
        if (this.T != z4) {
            ...
            this.y.addListener(new l00(12, this, z4));
