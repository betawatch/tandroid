...
public final class w11 extends FrameLayout {
    ...
    public w11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        ...
        while (i10 < 4) {
            ...
            this.a.addView(this.n[i10], w7.a6.k(0.0f, 0.0f, i10 != 3 ? 16.0f : 0.0f, 0.0f, 55, 36));
            this.n[i10].addTextChangedListener(new v11(this, i10));
            this.n[i10].setOnEditorActionListener(new og.w(4));
            i10++;
        }
    }
    ...
    public final void d(boolean z10) {
        ...
        ObjectAnimator ofInt = ObjectAnimator.ofInt(g3Var, r6.d, z10 ? 0 : 51);
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        int g10 = hc.b.g(20.0f, (i10 / 2) - (this.b * 2), 1);
        this.r = g10;
        int i14 = g10 * 2;
        int i15 = g10 * 2;
