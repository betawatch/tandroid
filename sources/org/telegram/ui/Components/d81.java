...
public abstract class d81 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public final void c(v71 v71Var, MessageObject messageObject) {
        ...
        if (v71Var.t() > 0) {
            t71 t71Var = null;
            for (int i10 = 0; i10 < v71Var.t(); i10++) {
                ArrayList arrayList = v71Var.u(i10).d;
                ...
                while (i11 < size) {
                    ...
                    i11++;
                    t71 t71Var2 = (t71) obj;
                    if (t71Var == null || ((!t71Var.b() && t71Var2.b()) || (t71Var.b() == t71Var2.b() && t71Var2.i * t71Var2.j < t71Var.i * t71Var.j))) {
                        t71Var = t71Var2;
                    }
                }
            }
            if (t71Var != null && !t71Var.b()) {
                int o9 = v71Var.o();
                r71 u10 = (o9 < 0 || o9 >= v71Var.t()) ? null : v71Var.u(o9);
                if (u10 != null) {
                    t71Var = u10.a();
                }
            }
            ...
            if (t71Var != null && !t71Var.d.equals(this.d)) {
                if (this.a) {
                    a();
                }
                this.d = t71Var.d;
                DispatchQueue dispatchQueue = Utilities.globalQueue;
                en0 en0Var = new en0((org.telegram.ui.mt0) this, t71Var, messageObject, 16);
                this.e = en0Var;
                dispatchQueue.postRunnable(en0Var);
            }
        } else {
            Uri uri = v71Var.F;
            if (uri != null) {
            ...
            if (uri != null && !uri.equals(this.d)) {
                ...
                en0 en0Var2 = new en0((org.telegram.ui.mt0) this, uri, messageObject, 15);
                this.e = en0Var2;
                dispatchQueue2.postRunnable(en0Var2);
            }
        }
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [java.lang.Runnable, org.telegram.ui.Components.b81] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void e(MessageObject messageObject, final float f7, int i10) {
        ...
        DispatchQueue dispatchQueue = Utilities.globalQueue;
        ?? r52 = new Runnable() { // from class: org.telegram.ui.Components.b81
            @Override // java.lang.Runnable
            public final void run() {
                int i13;
                d81 d81Var = d81.this;
                RectF rectF = d81Var.H;
                if (d81Var.b == null) {
                    d81Var.h = f7;
                    return;
                }
                int max = Math.max(200, AndroidUtilities.dp(100.0f));
                Bitmap q6 = d81Var.b.q(j10, false);
                if (q6 != null) {
                    ...
                    try {
                        ...
                        canvas.drawBitmap(q6, (Rect) null, rectF, d81Var.I);
                ...
                AndroidUtilities.runOnUIThread(new yn0(24, d81Var, q6));
            }
        };
        this.f = r52;
