...
public final class v8 extends cw0 {
    public float A0;
    public float B0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (!d9Var.U) {
            if (!d9Var.h) {
                ...
                float lerp = AndroidUtilities.lerp(y3, AndroidUtilities.statusBarHeight + ((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() - d9Var.c) >> 1), d9Var.N);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10 != d9Var.U) {
            ...
            if (d9Var.U) {
                ...
                addView(d9Var.a, 0, w7.y5.c(-1.0f, -1));
            } else {
                d9Var.r.addView(d9Var.a, 0, w7.y5.c(-2.0f, -1));
            }
        ...
        if (z11 != z12) {
            ...
            dc1 dc1Var = d9Var.r;
            dc1Var.setTranslationY((dc1Var.getTranslationY() + ((ViewGroup.MarginLayoutParams) d9Var.r.getLayoutParams()).topMargin) - i12);
            ...
            if (!d9Var.U) {
                ...
                d9Var.M.setInterpolator(org.telegram.ui.ActionBar.p1.w);
                d9Var.M.start();
            }
        }
        super.onMeasure(i10, i11);
