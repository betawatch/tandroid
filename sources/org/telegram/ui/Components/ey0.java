...
public abstract class ey0 {
    public static void a(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, org.telegram.ui.ActionBar.p2 p2Var, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        y1Var.y = new e3.d(i10, context, tL_messages_stickerSet, 7);
    ...
    public static void c(TLRPC.StickerSet stickerSet, org.telegram.ui.ActionBar.g6 g6Var, Context context, Utilities.Callback2 callback2) {
        ...
        final cy0 cy0Var = new cy0(context);
        int i10 = org.telegram.ui.ActionBar.k6.j5;
        cy0Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(i10, g6Var));
        cy0Var.setInputType(16385);
        cy0Var.setTextSize(1, 16.0f);
        cy0Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(i10, g6Var));
        cy0Var.setHandlesColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.vf, g6Var));
        cy0Var.setHeaderHintColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.L6, g6Var));
        cy0Var.setSingleLine(true);
        cy0Var.setFocusable(true);
        cy0Var.setFilters(new InputFilter[]{new InputFilter.LengthFilter(50), new InputFilter() { // from class: org.telegram.ui.Components.by0
            @Override // android.text.InputFilter
            public final CharSequence filter(CharSequence charSequence, int i11, int i12, Spanned spanned, int i13, int i14) {
                return (charSequence.length() <= 0 || !Character.isWhitespace(charSequence.charAt(0))) ? charSequence : (TextUtils.isEmpty(cy0.this.getText()) || i13 == 0) ? "" : charSequence;
            }
        }});
        cy0Var.setLineColors(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.k6, g6Var), org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.l6, g6Var), org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.p7, g6Var));
        cy0Var.setImeOptions(6);
        cy0Var.setBackground(null);
        cy0Var.requestFocus();
        cy0Var.setPadding(AndroidUtilities.dp(LocaleController.isRTL ? 28.0f : 0.0f), 0, AndroidUtilities.dp(LocaleController.isRTL ? 0.0f : 28.0f), 0);
        ...
        cy0Var.addTextChangedListener(new dy0(numberTextView, cy0Var));
        if (z4) {
            cy0Var.setText(stickerSet.title);
            cy0Var.setSelection(stickerSet.title.length());
        }
        alertDialog$Builder.n(frameLayout);
        d2Var.D = 4;
        alertDialog$Builder.k(LocaleController.getString(z4 ? R.string.Done : R.string.Create), new o9.b(cy0Var, callback2, context, z4, 3));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new hv(cy0Var, 24));
        org.telegram.ui.ActionBar.d2 o10 = alertDialog$Builder.o();
        o10.e0 = false;
        cy0Var.setOnEditorActionListener(new d1(o10, 8));
    }
}
