...
public final class n61 extends IUpdateLayout {
    ...
    public final void updateAppUpdateViews(int i10, boolean z4) {
        ...
        if (ApplicationLoader.applicationLoaderInstance.getUpdate() == null) {
            ...
            this.a.setTag(null);
            if (z4) {
                this.a.animate().translationY(AndroidUtilities.dp(44.0f)).setInterpolator(mr.g).setListener(new od0(this, 26)).setDuration(180L).start();
                return;
            } else {
                this.a.setTranslationY(AndroidUtilities.dp(44.0f));
        ...
        this.a.setTag(1);
        if (z4) {
            this.a.animate().translationY(0.0f).setInterpolator(mr.g).setListener(null).setDuration(180L).start();
        } else {
