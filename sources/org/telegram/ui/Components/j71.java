...
public final class j71 {
    ...
    public final void a(Canvas canvas, View view) {
        ...
        if (this.t != dp) {
            ...
            if (f25 < dp) {
                ...
                c10 = 0;
                float c12 = org.telegram.messenger.wl.c(j3, 60.0f, AndroidUtilities.dp(1.0f), f25);
                this.t = c12;
                if (c12 < dp) {
                    this.t = dp;
                }
        ...
        if (this.K[c10] != null) {
            ...
            this.L.setAlpha((int) (org.telegram.messenger.w1.A(1.0f, this.y, 255.0f, interpolation2) * this.I));
    ...
    */
    public final void b(Canvas canvas, RectF rectF, Paint paint) {
        ...
        char c11;
        j71 j71Var = this;
        float dp = AndroidUtilities.dp(AndroidUtilities.lerp(2, 1, j71Var.y));
        ArrayList arrayList = j71Var.F;
        if (arrayList == null || arrayList.isEmpty()) {
            canvas.drawRoundRect(rectF, dp, dp, paint);
            return;
        }
        float f7 = rectF.bottom;
        float lerp = AndroidUtilities.lerp(S / 2.0f, 0.0f, j71Var.y) + j71Var.z;
        float lerp2 = AndroidUtilities.lerp(j71Var.h - (S / 2.0f), j71Var.v.getWidth() - (j71Var.z * 2.0f), j71Var.y) + j71Var.z;
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(j71Var.I * 1.0f) / 2.0f;
        if (U == null) {
            U = new Path();
        }
        U.reset();
        ...
        while (true) {
            i10 = -1;
            if (i11 >= j71Var.F.size()) {
                i11 = -1;
                break;
            } else if (((Float) ((Pair) j71Var.F.get(i11)).first).floatValue() >= dp3) {
                break;
            } else {
                i11++;
            }
        ...
        int size = j71Var.F.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) j71Var.F.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i12) {
            if (i13 == i11) {
                ...
                c10 = 1;
                floatValue = ((Float) ((Pair) j71Var.F.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i12 ? 1.0f : ((Float) ((Pair) j71Var.F.get(i13)).first).floatValue();
            while (i13 != i12 && i13 != 0 && i13 < j71Var.F.size() - 1 && ((Float) ((Pair) j71Var.F.get(i13)).first).floatValue() - floatValue <= dp3) {
                i13++;
                floatValue2 = ((Float) ((Pair) j71Var.F.get(i13)).first).floatValue();
            }
    ...
    public final boolean e(float f7, float f10, int i10) {
        ...
        if (i10 == 0) {
            ...
            if (this.f) {
                ...
                float f11 = i18;
                this.c = f11;
                if (i10 == 1 && (i71Var = this.j) != null) {
                    i71Var.b(f11 / (this.h - S));
                }
                this.f = false;
                AndroidUtilities.runOnUIThread(new y61(this, 2), 50L);
                return true;
            }
