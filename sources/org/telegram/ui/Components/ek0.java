...
public final class ek0 extends FrameLayout {
    ...
    public static void a(ek0 ek0Var, zg.p0 p0Var, int i10) {
        ...
        int i11 = gk0Var.J;
        org.telegram.ui.ActionBar.f6 f6Var = gk0Var.k0;
        int i12 = gk0Var.M0;
        ...
        if (p0Var3.a || p0Var3.f != null) {
            ...
            o5 o5Var = new o5(4, gk0Var.J, ek0Var.e.g);
            o5 o5Var2 = new o5(3, gk0Var.J, ek0Var.e.g);
            if (i12 == 1 || i12 == 2 || i12 == 4) {
                ...
                o5Var2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i13, f6Var), mode2));
            }
    ...
    public final void b() {
        dk0 dk0Var = this.b;
        o5 o5Var = dk0Var.e;
        ImageReceiver imageReceiver = o5Var != null ? o5Var.k : dk0Var.a;
    ...
    public final void e(zg.p0 p0Var) {
        ...
        if (p0Var != null && p0Var.a) {
            ...
            if (this.F == null) {
                this.F = new yh.k8(1, SharedConfig.getDevicePerformanceClass() == 2 ? 45 : 18);
                return;
            }
            return;
        }
        ...
        if (p0Var2.b) {
            ...
            dk0Var2.getImageReceiver().setImage(ImageLocation.getForDocument(effectDocument), "60_60_firstframe", null, null, this.r ? null : DocumentObject.getSvgThumb(effectDocument, org.telegram.ui.ActionBar.j6.m6, 0.2f), 0L, "tgs", this.e, 0);
            return;
        }
        if (p0Var2.f != null) {
    ...
    public final void f(zg.p0 p0Var, boolean z10) {
        ...
        if (contains != z11) {
            ...
            if (z10) {
                ...
                dk0Var.animate().scaleX(this.I * (this.w ? 0.76f : 1.0f)).scaleY(this.I * (this.w ? 0.76f : 1.0f)).setDuration(240L).setInterpolator(qrVar).start();
            } else {
        ...
        if (this.O) {
            ...
            if (gk0Var.Q == null) {
                ...
                if (!gk0Var.r0 && gk0Var.l0 != null) {
                    ...
                    gk0Var.Q.addListener(new ci.v5(gk0Var, i11));
                    gk0Var.Q.setDuration(150L);
                    gk0Var.Q.setInterpolator(qr.f);
                    gk0Var.Q.start();
                }
