...
public final class im0 extends Dialog {
    ...
    public im0(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        s2Var.addView(pv0Var, k7.c6.e(-1, -1, 119));
        tg.b bVar = new tg.b();
        this.h = bVar;
    ...
    public final void e(q70 q70Var) {
        ...
        q70Var.Q(this.n, sg.b.k(g6Var), false);
        this.w = q70Var;
        this.y = q70Var.A;
                            ...
                            if (characterStyle2 == characterStyle) {
                                ...
                                if (!t1Var.C1() || width2 <= 0) {
                                    ...
                                    if (rectF3.height() > 0.0f) {
                                        ...
                                        this.B = new hm0(z80Var2, new int[]{iArr[0] + ((int) f22), iArr[1] + ((int) f15)}, t1Var, iArr, bitmap, rectF3, paint5, paint, makeStaticLayout2);
                                ...
                                this.B = new hm0(z80Var2, new int[]{iArr2[0] + ((int) f22), iArr2[1] + ((int) f15)}, t1Var, iArr2, bitmap, rectF3, paint52, paint, makeStaticLayout22);
