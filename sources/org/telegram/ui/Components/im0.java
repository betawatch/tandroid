...
public final class im0 extends Dialog {
    ...
    public final void e(o70 o70Var) {
        ...
        o70Var.Q(this.n, rg.b.j(f6Var), false);
        this.w = o70Var;
        this.y = o70Var.A;
    ...
    /* JADX WARN: Type inference failed for: r5v6, types: [android.graphics.Path, org.telegram.ui.Components.sq, org.telegram.ui.Components.y80] */
                            ...
                            if (characterStyle2 == characterStyle) {
                                ...
                                if (!t1Var.C1() || width2 <= 0) {
                                    ...
                                    if (rectF3.height() > 0.0f) {
                                        ...
                                        this.B = new hm0(y80Var2, new int[]{iArr[0] + ((int) f22), iArr[1] + ((int) f15)}, t1Var, iArr, bitmap, rectF3, paint5, paint, makeStaticLayout2);
                                ...
                                this.B = new hm0(y80Var2, new int[]{iArr2[0] + ((int) f22), iArr2[1] + ((int) f15)}, t1Var, iArr2, bitmap, rectF3, paint52, paint, makeStaticLayout22);
