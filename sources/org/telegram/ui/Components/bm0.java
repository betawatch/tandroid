...
public final class bm0 {
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.g6 g6Var, int i10) {
        ...
        if (messageObject == null) {
            ...
            this.A = v02;
            this.z = v02;
            this.x = org.telegram.ui.ActionBar.k6.l1(a2 ? 0.12f : 0.1f, v02);
            this.C = h();
        ...
        if (i10 != 4 || (message4 = messageObject.messageOwner) == null || MessageObject.getMedia(message4) == null || !(MessageObject.getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaContact)) {
            ...
            if (i10 != 0 && (messageObject.overrideLinkColor >= 0 || (messageObject.messageOwner != null && (((messageObject.isFromUser() || DialogObject.isEncryptedDialog(messageObject.getDialogId())) && user2 != null) || ((messageObject.isFromChannel() && chat != null) || (((message3 = messageObject.messageOwner) != null && (messageFwdHeader3 = message3.fwd_from) != null && messageFwdHeader3.from_id != null) || (messageObject.isSponsored() && (peerColor2 = messageObject.sponsoredColor) != null && peerColor2.color != -1))))))) {
                ...
                this.x = org.telegram.ui.ActionBar.k6.l1(0.1f, this.z);
                this.y = this.z;
                ...
                this.A = v04;
                this.z = v04;
                this.x = org.telegram.ui.ActionBar.k6.l1(0.1f, v04);
                this.y = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Wc, g6Var);
            } else {
                ...
                m(messageObject.replyMessageObject, i14, g6Var);
                this.x = org.telegram.ui.ActionBar.k6.l1(0.1f, this.z);
                this.y = this.z;
            }
        } else {
        ...
        if (messageObject.shouldDrawWithoutBackground()) {
            ...
            this.z = -1;
            this.x = 0;
            this.y = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Xc, g6Var);
        } else if (messageObject.isOutOwner() || i10 == 2) {
            if (i10 != 2 || messageObject.isOutOwner()) {
                int v05 = org.telegram.ui.ActionBar.k6.v0((this.i || this.j) ? org.telegram.ui.ActionBar.k6.bb : org.telegram.ui.ActionBar.k6.ab, g6Var);
                this.B = v05;
                this.A = v05;
                this.z = v05;
            } else {
                int v06 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.pk, g6Var);
                this.B = v06;
                this.A = v06;
                this.z = v06;
            }
            if (this.j) {
                this.R = true;
                this.z = org.telegram.ui.ActionBar.k6.l1(0.2f, this.z);
                this.A = org.telegram.ui.ActionBar.k6.l1(0.5f, this.A);
            } else if (this.i) {
                this.R = true;
                this.z = org.telegram.ui.ActionBar.k6.l1(0.35f, this.z);
            }
            this.x = org.telegram.ui.ActionBar.k6.l1(a2 ? 0.12f : 0.1f, this.B);
            this.y = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.cb, g6Var);
        }
    ...
    public final void d(Canvas canvas, RectF rectF, float f10, boolean z4, boolean z10) {
        ...
        j5 j5Var;
        if (!z10) {
            int l1 = org.telegram.ui.ActionBar.k6.l1(f10, this.E.a(this.x, false));
            Paint paint = this.g;
            paint.setColor(l1);
            float[] fArr = this.e;
            if (lf.l0.c(fArr)) {
        ...
        if (j5Var2 != null) {
            if (!this.Y) {
                ...
                if ((drawable instanceof l5) && (z2Var = ((l5) drawable).k) != null && z2Var.hasImageLoaded()) {
                    this.Y = true;
                } else {
                    z11 = false;
                    e6 = this.L.e(z11);
                    if (e6 > 0.0f || this.r <= 0.0f) {
                    }
                    if (this.W == null) {
                        this.W = new am0[]{new am0(4.0f, -6.33f, 1.0f, 1.0f), new am0(30.0f, 3.0f, 0.78f, 0.9f), new am0(46.0f, -17.0f, 0.6f, 0.6f), new am0(69.66f, -0.666f, 0.87f, 0.7f), new am0(98.0f, -12.6f, 1.03f, 0.3f), new am0(51.0f, 24.0f, 1.0f, 0.5f), new am0(6.33f, 20.0f, 0.77f, 0.7f), new am0(-19.0f, 12.0f, 0.8f, 0.6f, 0), new am0(-22.0f, 36.0f, 0.7f, 0.5f, 0)};
                    }
                    canvas.save();
                    ...
                    int i10 = 0;
                    while (true) {
                        am0[] am0VarArr = this.W;
                        if (i10 >= am0VarArr.length) {
                            canvas.restore();
                            return;
                        }
                        ...
                        am0 am0Var = am0VarArr[i10];
                        if (!am0Var.e || z4) {
                            j5Var.v = (int) ((j5Var == this.u ? 1.0f : 0.3f) * 255.0f * am0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(am0Var.a);
                            float dp2 = AndroidUtilities.dp(am0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * am0Var.c * e6;
    ...
    */
    public final void e(Canvas canvas, RectF rectF, float f10) {
        ...
        int l1 = org.telegram.ui.ActionBar.k6.l1(f10, a2);
        Paint paint = this.b;
        paint.setColor(l1);
        ...
        if (e6 > 0.0f && !this.i) {
            ...
            rectF2.set(rectF.left, (AndroidUtilities.lerp(0.0f, 1.0f - pr.i.getInterpolation(k7.o.a(((Math.max(pow, 0.5f) + 1.5f) % 3.5f) * 0.5f, 0.0f, 1.0f)), e6) * rectF.height()) + rectF.top, rectF.left + AndroidUtilities.dp(6.0f), (AndroidUtilities.lerp(1.0f, 1.0f - pr.g.getInterpolation(k7.o.a((((pow + 1.5f) % 3.5f) - 1.5f) * 0.5f, 0.0f, 1.0f)), e6) * rectF.height()) + rectF.top);
        ...
        int l12 = org.telegram.ui.ActionBar.k6.l1(f10, a2);
        int h = i0.a.h(org.telegram.ui.ActionBar.k6.l1(e10 * f10, a10), l12);
        int h9 = this.j ? i0.a.h(org.telegram.ui.ActionBar.k6.l1(f10 * e11, a11), l12) : 0;
    ...
    public final void f(Canvas canvas, RectF rectF, float f10, float f11, float f12, float f13) {
        ...
        this.h.f(org.telegram.ui.ActionBar.k6.l1(0.1f, this.z), org.telegram.ui.ActionBar.k6.l1(0.3f, this.z), org.telegram.ui.ActionBar.k6.l1(0.3f, this.z), org.telegram.ui.ActionBar.k6.l1(1.25f, this.z));
        this.h.d(rectF);
        this.h.i(fArr);
    ...
    public final void i() {
        ...
        float e6 = this.M.e(this.S);
        this.T = (Math.min(30L, currentTimeMillis - this.V) * e6) + this.T;
        this.U = (Math.min(30L, currentTimeMillis - this.V) * e6) + this.U;
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.y = i11;
        this.x = org.telegram.ui.ActionBar.k6.l1(0.1f, i11);
    ...
    public final void m(MessageObject messageObject, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        if (i10 < 7) {
            int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.r8[i10], g6Var);
            this.B = v02;
            this.A = v02;
            this.z = v02;
            this.j = false;
        ...
        if (color == null) {
            int v03 = org.telegram.ui.ActionBar.k6.v0((messageObject == null || !messageObject.isOutOwner()) ? org.telegram.ui.ActionBar.k6.Uc : org.telegram.ui.ActionBar.k6.ab, g6Var);
            this.B = v03;
            this.A = v03;
            this.z = v03;
            this.j = false;
        ...
        this.z = color.getColor(0, g6Var);
        this.A = color.getColor(1, g6Var);
        int color2 = color.getColor(2, g6Var);
        this.B = color2;
        int i11 = this.A;
        int i12 = this.z;
        this.i = i11 != i12;
    ...
    public final int o(org.telegram.ui.ActionBar.g6 g6Var) {
        View view;
        int i10 = org.telegram.ui.ActionBar.k6.q7;
        this.y = org.telegram.ui.ActionBar.k6.v0(i10, g6Var);
        this.z = org.telegram.ui.ActionBar.k6.v0(i10, g6Var);
        this.i = false;
        this.j = false;
        this.x = org.telegram.ui.ActionBar.k6.l1(0.1f, org.telegram.ui.ActionBar.k6.v0(i10, g6Var));
        if (this.v != 0 && this.t == null && (view = this.D) != null) {
            this.t = new j5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).J0) {
                this.t.a();
    ...
    public final void q(int i10, boolean z4) {
        ...
        this.A = i10;
        this.z = i10;
        this.x = org.telegram.ui.ActionBar.k6.l1(z4 ? 0.12f : 0.1f, i10);
        this.C = i10;
    }
}
