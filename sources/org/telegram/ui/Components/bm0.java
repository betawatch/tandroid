...
public final class bm0 {
    ...
    static {
        ...
        for (int i10 = 0; i10 <= 100; i10++) {
            ...
            float f14 = 1.0f;
            while (true) {
                float A2 = com.google.android.recaptcha.internal.a.A(f14, f12, 2.0f, f12);
                float f15 = 1.0f - A2;
                f10 = 3.0f * A2 * f15;
                f11 = A2 * A2 * A2;
                float B = com.google.android.recaptcha.internal.a.B(A2, x, f15 * w, f10) + f11;
    ...
    public final boolean b() {
        ...
        if (i11 == 0) {
            ...
            float e9 = interpolator == null ? e(f10) : interpolator.getInterpolation(f10);
            this.j = Math.round(this.o * e9) + this.b;
            this.k = Math.round(e9 * this.p) + this.c;
            return true;
        }
        if (i11 == 1) {
            ...
            float[] fArr = y;
            float f13 = fArr[i12];
            float z10 = com.google.android.recaptcha.internal.a.z(fArr[i13], f13, (f11 - f12) / ((i13 / 100.0f) - f12), f13);
