...
public final class jb0 extends rl0 {
    public final /* synthetic */ rb0 U2;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public jb0(rb0 rb0Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var);
        this.U2 = rb0Var;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i12 = 0;
        while (i12 < 3) {
            xb0 xb0Var = rb0Var2.W;
            ArrayList arrayList = xb0Var.B;
            jb0 jb0Var = rb0Var2.f;
            xb0Var.B.clear();
            if (i12 != 2 || jb0Var.U1) {
                int i13 = 0;
                ?? r32 = z10;
                while (true) {
                    ...
                    View childAt3 = jb0Var.getChildAt(i13);
                    if (childAt3 instanceof org.telegram.ui.Cells.s1) {
                        org.telegram.ui.Cells.s1 s1Var = (org.telegram.ui.Cells.s1) childAt3;
                        if (childAt3.getY() <= jb0Var.getHeight() && childAt3.getY() + childAt3.getHeight() >= 0.0f && (currentMessagesGroup = s1Var.getCurrentMessagesGroup()) != null && ((i12 != 0 || currentMessagesGroup.messages.size() != 1) && ((i12 != 1 || currentMessagesGroup.transitionParams.drawBackgroundForDeletedItems) && ((i12 != 0 || !s1Var.getMessageObject().deleted) && ((i12 != 1 || s1Var.getMessageObject().deleted) && ((i12 != 2 || s1Var.lc) && (i12 == 2 || !s1Var.lc))))))) {
                ...
                while (i18 < arrayList.size()) {
                    ...
                    if (groupedMessages2 == null) {
                        ...
                        if (f14 > AndroidUtilities.dp(20.0f) + jb0Var.getMeasuredHeight()) {
                            f14 = AndroidUtilities.dp(20.0f) + jb0Var.getMeasuredHeight();
                        }
                        ...
                        if (z11) {
                            ...
                            for (int i19 = 0; i19 < childCount; i19++) {
                                View childAt4 = jb0Var.getChildAt(i19);
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        jb0 jb0Var = rb0Var.f;
        if (rb0Var.R) {
            if (jb0Var.computeVerticalScrollRange() > jb0Var.computeVerticalScrollExtent()) {
                rb0Var.postDelayed(new db0(rb0Var, 0), 0L);
            }
            rb0Var.R = false;
        }
        if (rb0Var.K && i14 == 0) {
