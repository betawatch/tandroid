...
public final class kh0 extends View {
    ...
    public final hh0 k(int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                j10 = new hh0(this, ih0.n);
                j10.t = true;
                j10.x = 200;
                break;
            case 4:
                j10 = new hh0(this, ih0.r);
                break;
            case 5:
                j10 = new hh0(this, ih0.s);
                this.H = j10;
                j10.t = true;
                j10.x = 500;
                break;
            case 6:
                ...
                break;
            case 7:
                j10 = new hh0(this, ih0.w);
                j10.t = true;
                j10.v = 300;
                break;
            case 8:
                j10 = new hh0(this, ih0.x);
                j10.t = true;
                j10.x = 500;
                break;
            case 9:
                j10 = new hh0(this, ih0.y);
                j10.t = true;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        float f22 = 2.0f;
        while (i13 < size) {
            hh0 hh0Var5 = (hh0) arrayList.get(i13);
            boolean z11 = hh0Var5.p;
            float f23 = max;
            rc rcVar = hh0Var5.b;
            float f24 = f21;
            ...
            if (z11) {
                ...
                z5 z5Var = hh0Var5.e;
                f14 = f19;
                RectF rectF2 = hh0Var5.c;
                float f25 = f20;
                kh0 kh0Var = hh0Var5.y;
                f15 = itemWidth;
                RectF rectF3 = hh0Var5.f;
                i11 = i13;
                RectF rectF4 = hh0Var5.g;
                hh0 hh0Var6 = hh0Var3;
                if (hh0Var5.o) {
                    hh0Var5.a();
                } else {
                    boolean z12 = kh0Var.e;
                    float f26 = kh0Var.K;
                    if (z12) {
                        hh0Var5.n = false;
                        rectF2.set(rectF);
                        ...
                        if (rectF3.isEmpty()) {
                            ...
                            boolean z14 = rectF.right + 1.0f >= ((float) kh0Var.getMeasuredWidth()) - f26;
                            if (z13 && z14) {
                                hh0Var = hh0Var4;
                            } else {
                                z10 = z14;
                                hh0 hh0Var7 = kh0Var.I;
                                if (hh0Var7 != null) {
                                    hh0Var = hh0Var4;
                                } else {
                                    hh0Var = hh0Var4;
                                }
                                hh0 hh0Var8 = kh0Var.J;
                                if (hh0Var8 != null) {
                                }
                                i12 = hh0Var5.a;
                                if (((i12 != 5 && i12 != 6) || kh0Var.E != 0) && ((i12 != 3 && i12 != 2) || kh0Var.E != 1)) {
                                    if (!z13 && (hh0Var2 = kh0Var.I) != null && !hh0Var2.o) {
                                        z10 = true;
                                        z13 = false;
                                    } else if (z10) {
                                        hh0 hh0Var9 = kh0Var.J;
                                        if (hh0Var9 != null) {
                                        }
                                    }
                                    if (!z13) {
        ...
        int i14 = 0;
        while (i14 < size) {
            hh0 hh0Var10 = (hh0) arrayList.get(i14);
            boolean z15 = hh0Var10.p;
            rc rcVar2 = hh0Var10.b;
            RectF rectF6 = hh0Var10.d;
            if (z15) {
                f13 = clamp012;
                i10 = i14;
            } else {
                ...
                float b10 = (int) (hh0Var10.b() * clamp012 * alpha);
                ...
                if (this.P != null) {
                    ...
                    paint2.setAlpha((int) (hh0Var10.b() * f13 * alpha2));
        ...
        if (clamp013 > 0.0f) {
            int i15 = 0;
            while (i15 < size) {
                hh0 hh0Var11 = (hh0) arrayList.get(i15);
                if (hh0Var11 != null) {
                    Rect rect = hh0Var11.h;
                    RectF rectF8 = hh0Var11.d;
                    if (!hh0Var11.p) {
                        ...
                        canvas.save();
                        float b11 = hh0Var11.b() * clamp013;
                        float centerX2 = rectF8.centerX();
                        float centerY = rectF8.centerY();
                        float f31 = a2;
                        f11 = clamp01;
                        float a10 = hh0Var11.b.a(0.04f) * f11;
                        ...
                        float f32 = dp * 0.5f;
                        hh0Var11.l.q(rectF8.width() - AndroidUtilities.dp(f22));
                        hh0Var11.m = hh0Var11.l.b.getLineCount() >= 3 ? 0.75f : hh0Var11.l.b.getLineCount() >= 2 ? 0.85f : 1.0f;
                        float max2 = Math.max(0.0f, AndroidUtilities.dpf2(1.33f) + e2.c.d(hh0Var11.l.j(), hh0Var11.m, f27, 3.0f));
                        rect.set((int) (centerX3 - f32), (int) max2, (int) (centerX3 + f32), (int) (max2 + dp));
                        gj0 gj0Var = hh0Var11.k;
                        if (gj0Var != null) {
                            gj0Var.setBounds(rect);
                        }
                        Drawable drawable = hh0Var11.i;
                        if (drawable != null) {
                            drawable.setBounds(rect);
                        }
                        Drawable drawable2 = hh0Var11.j;
                        if (drawable2 != null) {
                            drawable2.setBounds(rect);
                        }
                        float j10 = ((rect.bottom + rect.top) - ((hh0Var11.l.j() * hh0Var11.m) / f22)) - AndroidUtilities.dp(4.66f);
                        canvas.save();
                        float f33 = hh0Var11.m;
                        f10 = f27;
                        canvas.scale(f33, f33, centerX2, android.support.v4.media.a.d(hh0Var11.l.j(), hh0Var11.m, 2.0f, j10));
                        k01 k01Var = hh0Var11.l;
                        k01Var.c(centerX2 - (k01Var.l() / 2.0f), j10, b11, d, canvas);
                        canvas.restore();
                        float f34 = hh0Var11.q;
                        if (f34 != 1.0f) {
                            canvas.scale(f34, f34, rect.centerX(), rect.centerY());
                        }
                        float f35 = (1.0f - f31) * b11;
                        float f36 = f31 * b11;
                        gj0 gj0Var2 = hh0Var11.k;
                        if (gj0Var2 == null) {
                            h(canvas, hh0Var11.j, f35);
                            h(canvas, hh0Var11.i, f36);
                        } else if (hh0Var11.a == 1) {
                            h(canvas, hh0Var11.j, f35);
                            h(canvas, hh0Var11.k, f36);
                        } else {
                            h(canvas, gj0Var2, b11);
                        }
                        canvas.restore();
                        if (hh0Var11.x > 0 && System.currentTimeMillis() > hh0Var11.x + hh0Var11.w) {
                            hh0Var11.s = false;
                        }
                        if (hh0Var11.s) {
                            j90 j90Var = hh0Var11.r;
                            if (j90Var == null) {
                                j90 j90Var2 = new j90();
                                hh0Var11.r = j90Var2;
                                j90Var2.setCallback(this);
                                hh0Var11.r.f(org.telegram.ui.ActionBar.j6.l1(0.1f, -1), org.telegram.ui.ActionBar.j6.l1(0.3f, -1), org.telegram.ui.ActionBar.j6.l1(0.35f, -1), org.telegram.ui.ActionBar.j6.l1(0.8f, -1));
                                j90 j90Var3 = hh0Var11.r;
                                j90Var3.C = true;
                                j90Var3.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                            } else if (j90Var.b() || hh0Var11.r.c()) {
                                j90 j90Var4 = hh0Var11.r;
                                f12 = clamp013;
                                j90Var4.b = -1L;
                                j90Var4.c = -1L;
                            }
                            ...
                            f12 = clamp013;
                            j90 j90Var5 = hh0Var11.r;
                            if (j90Var5 != null && !j90Var5.c() && !hh0Var11.r.b()) {
                                hh0Var11.r.a();
                            }
                        }
                        j90 j90Var6 = hh0Var11.r;
                        if (j90Var6 != null) {
                            j90Var6.d(rectF8);
                            hh0Var11.r.h(getRoundRadius());
                            hh0Var11.r.setAlpha((int) (b11 * 255.0f));
                            hh0Var11.r.draw(canvas);
                        }
                        i15++;
                        clamp013 = f12;
                        f27 = f10;
        ...
        if (this.B >= AndroidUtilities.dp(8.0f)) {
            ...
            if (action == 0) {
                ...
                while (true) {
                    ...
                    if (!hh0Var2.o && hh0Var2.d.contains(x10, y10)) {
                        this.T = hh0Var2;
                        this.U = x10;
                        this.V = y10;
                ...
                if (action == 1 && this.T.d.contains(x10, y10)) {
                    ...
                    if (jh0Var != null) {
                        ...
                        if (i12 == 0) {
                            int i13 = hh0Var5.a;
                            RectF rectF = hh0Var5.d;
                            ProfileActivity.Y(((org.telegram.ui.wx0) jh0Var).b, i13, rectF.left, rectF.top);
                        } else {
    ...
    public final void p(hh0 hh0Var, boolean z4) {
        if (!z4) {
            ih0 ih0Var = this.G ? ih0.e : ih0.f;
            hh0Var.d(0, ih0Var.b, ih0Var.c);
            hh0Var.c(LocaleController.getString(ih0Var.a));
        } else if (this.G) {
            ih0 ih0Var2 = ih0.e;
            hh0Var.c(LocaleController.getString(ih0Var2.a));
            hh0Var.d(R.raw.profile_unmuting, ih0Var2.b, ih0Var2.c);
        } else {
            ih0 ih0Var3 = ih0.f;
            hh0Var.c(LocaleController.getString(ih0Var3.a));
            hh0Var.d(R.raw.profile_muting, ih0Var3.b, ih0Var3.c);
        }
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || (drawable instanceof j90);
    }
}
