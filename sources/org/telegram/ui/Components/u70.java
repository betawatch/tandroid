...
public final class u70 extends View {
    ...
    public u70(w70 w70Var, Context context) {
        ...
        if (w70Var.t && (view instanceof org.telegram.ui.Cells.za) && (w70Var.c instanceof ProfileActivity)) {
            this.b = new Paint(3);
        ...
        if (w70Var.t) {
            ...
            if (view != 0 && (view.getParent() instanceof View)) {
                ...
                if (f11 >= 1.0f && f15 == 0.0f) {
                    ...
                    f7 = 255.0f;
                    c10 = 0;
                    canvas2.clipRect(-rect.left, AndroidUtilities.lerp((((-rect.top) + fArr[1]) - (f11 * (w70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, 0.0f, this.w), getMeasuredWidth() + rect.right, com.google.android.gms.internal.vision.e2.b(1.0f, this.w, f15, getMeasuredHeight() + rect.bottom));
                } else {
                    f7 = 255.0f;
                    c10 = 0;
                    canvas2.clipRect(-rect.left, (((-rect.top) + fArr[1]) - (f11 * (w70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, getMeasuredWidth() + rect.right, getMeasuredHeight() + rect.bottom);
