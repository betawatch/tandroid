...
public final class u70 extends Drawable {
    ...
    public u70(int i9, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        if (i9 == 0) {
            ...
            j.setColor(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.Jh, b6Var));
            k.setColor(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.Kh, b6Var));
            this.h = k;
            return;
        }
        if (i9 == 1) {
        ...
        m.setColor(-1);
        m.setTextSize(org.telegram.ui.ActionBar.f6.d3.getTextSize() * 0.75f);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.b != null) {
            ...
            canvas.translate(e2.c.A(width, this.c, 2.0f, bounds.left) - this.e, e2.c.A(width, this.d, 2.0f, bounds.top));
            this.b.draw(canvas);
        }
        canvas.restore();
    }
