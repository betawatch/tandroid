...
public final class k20 {
    ...
    */
    public final boolean a(MotionEvent motionEvent) {
        ...
        boolean z11;
        boolean z12;
        org.telegram.ui.nt0 nt0Var;
        MessageObject messageObject;
        org.telegram.ui.nt0 nt0Var2;
        i20 i20Var;
        boolean z13;
        boolean onScroll;
        int i10;
        ...
        if (i11 != 0) {
            if (i11 == 1) {
                ...
                if (!this.q) {
                    if (this.k) {
                        ...
                        boolean onSingleTapUp = j20Var2.onSingleTapUp(motionEvent);
                        if (this.j && (i20Var = this.h) != null) {
                            ((PhotoViewer) i20Var).Z1(motionEvent);
                        }
                        z16 = onSingleTapUp;
                    } else {
                        ...
                        if (Math.abs(yVelocity) > this.d || Math.abs(xVelocity) > this.d) {
                            z16 = j20Var2.onFling(this.n, motionEvent, xVelocity, yVelocity);
                        }
                    }
                    z16 = false;
                }
            ...
            if (this.q) {
                ...
                if (this.l) {
                    ...
                    int i20 = i10;
                    if (i20 > i19) {
                        onScroll = j20Var2.onScroll(this.n, motionEvent, f15, f16);
                        this.r = f13;
                        this.s = f14;
                        z14 = false;
                        this.l = false;
        ...
        i20 i20Var2 = this.h;
        if (i20Var2 != null) {
            PhotoViewer photoViewer = (PhotoViewer) i20Var2;
            if (photoViewer.K0.getVisibility() != 0) {
                boolean[] zArr = photoViewer.t1;
                if (!zArr[0] && !zArr[1]) {
                    float x10 = motionEvent.getX();
                    if ((x10 < Math.min(135, photoViewer.b0.getMeasuredWidth() / 8) || x10 > photoViewer.b0.getMeasuredWidth() - r4) && (messageObject = photoViewer.Q4) != null && ((!messageObject.isVideo() && ((nt0Var2 = photoViewer.c0) == null || !nt0Var2.x)) || SystemClock.elapsedRealtime() - photoViewer.r1 < 500 || !photoViewer.q0(motionEvent))) {
                        this.j = true;
                    }
                }
            }
            ...
            if (motionEvent6 == null || (motionEvent3 = this.p) == null || !hasMessages2 || !this.m) {
                ...
                if (eventTime <= i21 && eventTime >= 40) {
                    ...
                    if ((y10 * y10) + (x11 * x11) < this.c) {
                        ...
                        if ((photoViewer2.C2 != null || ((nt0Var = photoViewer2.c0) != null && nt0Var.x)) && photoViewer2.i3) {
                                    ...
                                    if (j12 > A1) {
                                        ...
                                        if (j12 < 0) {
                                            ...
                                            if (z10) {
                                                ...
                                                y61 y61Var = photoViewer2.w1;
                                                j20Var = j20Var2;
                                                long j13 = y61Var.o + 10000;
                                                y61Var.o = j13;
                                                y61Var.p = LocaleController.formatPluralString("Seconds", (int) (j13 / 1000), new Object[0]);
                                                photoViewer2.t2(j11);
                                            ...
                                            return j20Var.onDown(motionEvent) | z4;
                                        }
                                        j11 = j12;
                                    }
                                    z10 = true;
                        ...
                        if (photoViewer2.F6 && ((photoViewer2.X5 != 1.0f || (photoViewer2.V5 == 0.0f && photoViewer2.U5 == 0.0f)) && photoViewer2.k6 == j10 && photoViewer2.k4 == 0)) {
                            org.telegram.ui.fu0 fu0Var = photoViewer2.T0[0];
                            if (fu0Var == null || !fu0Var.p || fu0Var.h == -1) {
                                dVar = dVar2;
                            } else {
                                dVar = dVar2;
                            }
