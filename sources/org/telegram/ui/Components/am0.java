                ...
                if ((drawable instanceof l5) && (y2Var = ((l5) drawable).k) != null && y2Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (!zl0Var.e || z4) {
                            ...
                            float dp3 = AndroidUtilities.dp(10.0f) * zl0Var.c * e;
    ...
    */
    public final void e(Canvas canvas, RectF rectF, float f10) {
        ...
        if (e > 0.0f && !this.i) {
            ...
            rectF2.set(rectF.left, (AndroidUtilities.lerp(0.0f, 1.0f - nr.i.getInterpolation(k7.n.a(((Math.max(pow, 0.5f) + 1.5f) % 3.5f) * 0.5f, 0.0f, 1.0f)), e) * rectF.height()) + rectF.top, rectF.left + AndroidUtilities.dp(6.0f), (AndroidUtilities.lerp(1.0f, 1.0f - nr.g.getInterpolation(k7.n.a((((pow + 1.5f) % 3.5f) - 1.5f) * 0.5f, 0.0f, 1.0f)), e) * rectF.height()) + rectF.top);
