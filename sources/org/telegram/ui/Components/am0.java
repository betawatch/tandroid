...
public final class am0 extends Dialog {
    ...
    public final void e(n70 n70Var) {
        ...
        n70Var.Q(this.n, eh.b.k(e6Var), false);
        this.w = n70Var;
        this.y = n70Var.A;
    ...
    /* JADX WARN: Type inference failed for: r5v6, types: [android.graphics.Path, org.telegram.ui.Components.uq, org.telegram.ui.Components.w80] */
    /* JADX WARN: Type inference failed for: r7v16, types: [android.graphics.Path, org.telegram.ui.Components.w80] */
    /*
                        ...
                        for (CharacterStyle characterStyle2 : characterStyleArr) {
                            if (characterStyle2 == characterStyle) {
                                ...
                                if (charSequence != null) {
                                    ...
                                    ?? w80Var = new w80(0);
                                    w80Var.d(r14, i22, 0.0f);
                                    r14.getSelectionPath(i22, i23, w80Var);
                                    RectF rectF2 = new RectF();
                                    w80Var.computeBounds(rectF2, true);
                                ...
                                paint2.setColor(org.telegram.ui.ActionBar.i6.v0(messageObject.isOutOwner() ? org.telegram.ui.ActionBar.i6.Aa : org.telegram.ui.ActionBar.i6.ra, this.b));
                                paint2.setPathEffect(new CornerPathEffect(AndroidUtilities.dp(5.0f)));
                                ?? w80Var2 = new w80(0);
                                w80Var2.c = true;
                                w80Var2.d(r12, i22, 0.0f);
                                r12.getSelectionPath(i22, i23, w80Var2);
                                w80Var2.a();
                                RectF rectF3 = new RectF();
                                w80Var2.computeBounds(rectF3, true);
                                ...
                                if (!t1Var.C1() || width2 <= 0) {
                                    ...
                                    if (rectF3.height() > 0.0f) {
                                        ...
                                        canvas.drawPath(w80Var2, paint4);
                                        bitmap = createBitmap;
                                        ...
                                        spannableStringBuilder = new SpannableStringBuilder(x5.cloneSpans(layout.getText(), -1, textPaint.getFontMetricsInt()));
                                        if (i22 <= 0) {
                                            i13 = 0;
                                        ...
                                        this.E = new zl0(w80Var2, new int[]{iArr[0] + ((int) f21), iArr[1] + ((int) f14)}, t1Var, iArr, bitmap, rectF3, paint5, paint, makeStaticLayout2);
                                ...
                                spannableStringBuilder = new SpannableStringBuilder(x5.cloneSpans(layout.getText(), -1, textPaint2.getFontMetricsInt()));
                                if (i22 <= 0) {
                                }
                                if (i23 < spannableStringBuilder.length()) {
                                }
                                ...
                                this.E = new zl0(w80Var2, new int[]{iArr2[0] + ((int) f21), iArr2[1] + ((int) f14)}, t1Var, iArr2, bitmap, rectF3, paint52, paint, makeStaticLayout22);
