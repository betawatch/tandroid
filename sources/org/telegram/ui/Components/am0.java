            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof l5) && (z2Var = ((l5) drawable).k) != null && z2Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (!zl0Var.e || z4) {
                            j5Var.v = (int) ((j5Var == this.u ? 1.0f : 0.3f) * 255.0f * zl0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(zl0Var.a);
                            float dp2 = AndroidUtilities.dp(zl0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * zl0Var.c * e6;
