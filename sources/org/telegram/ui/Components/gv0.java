...
public class gv0 extends dv0 {
    ...
    @Override // org.telegram.ui.Components.dv0, org.telegram.ui.Components.ul0
    public final boolean D(s4.c1 c1Var) {
        return false;
    }

    @Override // org.telegram.ui.Components.dv0, org.telegram.ui.Components.dl0
    ...
    public final void v(s4.c1 c1Var, int i10) {
        if (this.s != null && c1Var.f == 19) {
            ...
            if (view instanceof org.telegram.ui.Cells.u7) {
                ...
                jv0 jv0Var = this.F;
                u7Var.setReorder(jv0Var.r0() || u7Var.f0);
                u7Var.h = jv0Var.t0();
                u7Var.k(messageObject, O(), false);
                if (!jv0Var.C1 || messageObject == null) {
                    u7Var.i(false, false);
                } else {
                    u7Var.i(jv0Var.Z0[(messageObject.getDialogId() > jv0Var.j1 ? 1 : (messageObject.getDialogId() == jv0Var.j1 ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0, true);
                }
    ...
    public gv0(jv0 jv0Var, Context context, int i10, boolean z10) {
        ...
        if (!TextUtils.isEmpty(jv0Var.getStoriesHashtag())) {
            ...
            if (i10 > 0) {
                this.s = n2Var.getMessagesController().getStoriesController().A(jv0Var.j1, 0, i10, true);
            } else {
                this.s = n2Var.getMessagesController().getStoriesController().A(jv0Var.j1, z11 ? 4 : z10 ? 1 : 0, -1, true);
            }
        } else {
            this.s = null;
        }
        ...
        if (d9Var != null) {
            this.v = d9Var.o();
            this.w = new ev0(this, n2Var.getMessagesController().getStoriesController(), jv0Var.j1, this.s.c);
        }
        N();
    }
