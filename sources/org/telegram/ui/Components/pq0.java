...
public final /* synthetic */ class pq0 implements Runnable {
    public final /* synthetic */ int a;
    public final /* synthetic */ sq0 b;
    public final /* synthetic */ int c;
    public final /* synthetic */ String d;

    public /* synthetic */ pq0(sq0 sq0Var, int i10, String str) {
        this.a = 1;
        this.b = sq0Var;
        this.c = i10;
        this.d = str;
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                sq0 sq0Var3 = this.b;
                sq0Var3.f = null;
                i10 = ((org.telegram.ui.ActionBar.f3) sq0Var3.K).currentAccount;
                DispatchQueue storageQueue = MessagesStorage.getInstance(i10).getStorageQueue();
                String str = this.d;
                int i18 = this.c;
                storageQueue.postRunnable(new pq0(sq0Var3, str, i18, 2));
                pq0 pq0Var = new pq0(sq0Var3, i18, str);
                sq0Var3.h = pq0Var;
                AndroidUtilities.runOnUIThread(pq0Var);
                break;
            case 1:
                sq0 sq0Var4 = this.b;
                sq0Var4.h = null;
                ...
                int i20 = this.c;
                if (i20 == i19) {
                    sq0Var4.e.g(this.d, true, true, true, true, 0L, false, 0, i20);
                    break;
                }
                break;
            default:
                ...
                int i21 = this.c;
                sq0 sq0Var5 = this.b;
                wq0 wq0Var2 = sq0Var5.K;
                try {
                    String lowerCase = str2.trim().toLowerCase();
                    if (lowerCase.length() == 0) {
                        sq0Var5.r = -1;
                        AndroidUtilities.runOnUIThread(new wm(sq0Var5, sq0Var5.r, new ArrayList(), 9));
                        break;
                    } else {
                        ...
                        a0.i iVar = new a0.i();
                        i11 = ((org.telegram.ui.ActionBar.f3) wq0Var2).currentAccount;
                        ...
                        while (queryFinalized.next()) {
                            ...
                            kq0 kq0Var = new kq0();
                            kq0Var.c = queryFinalized.intValue(1);
                            iVar.k(kq0Var, longValue);
                        ...
                        if (arrayList.isEmpty()) {
                            ...
                            i16 = ((org.telegram.ui.ActionBar.f3) wq0Var2).currentAccount;
                                            ...
                                            if (!stringValue.contains(" " + str3)) {
                                                ...
                                                if (r12 == 0) {
                                                    ...
                                                    if (byteBufferValue != null) {
                                                        ...
                                                        int i27 = i21;
                                                        sq0Var2 = sq0Var5;
                                                        kq0 kq0Var2 = (kq0) iVar.f(TLdeserialize.id);
                                                        ...
                                                        if (r12 == z10) {
                                                            kq0Var2.d = AndroidUtilities.generateSearchName(TLdeserialize.first_name, TLdeserialize.last_name, str3);
                                                        } else {
                                                            kq0Var2.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize), null, "@" + str3);
                                                        }
                                                        kq0Var2.b = TLdeserialize;
                                                        kq0Var2.a.id = TLdeserialize.id;
                                                        i23 = i24 + 1;
                                                    }
                                                } else {
                                                    i25 = i26 + 1;
                                ...
                                for (int i28 = 0; i28 < i22; i28++) {
                                    ...
                                    if (byteBufferValue2 != null) {
                                        ...
                                        if (TLdeserialize2 != null && !ChatObject.isNotInChat(TLdeserialize2) && (!ChatObject.isChannel(TLdeserialize2) || TLdeserialize2.creator || (((tL_chatAdminRights = TLdeserialize2.admin_rights) != null && tL_chatAdminRights.post_messages) || TLdeserialize2.megagroup))) {
                                            kq0 kq0Var3 = (kq0) iVar.f(-TLdeserialize2.id);
                                            kq0Var3.d = AndroidUtilities.generateSearchName(TLdeserialize2.title, null, str4);
                                            kq0Var3.b = TLdeserialize2;
                                            kq0Var3.a.id = -TLdeserialize2.id;
                                            i13++;
                                        }
                                    }
                                }
                        ...
                        for (int i29 = 0; i29 < iVar.m(); i29++) {
                            kq0 kq0Var4 = (kq0) iVar.n(i29);
                            if (kq0Var4.b != null && kq0Var4.d != null) {
                                arrayList3.add(kq0Var4);
                            }
                        }
                                            ...
                                            if (!stringValue3.contains(" " + str5)) {
                                                ...
                                                if (c10 == 0) {
                                                    ...
                                                    if (byteBufferValue3 != null) {
                                                        ...
                                                        kq0Var5.a.id = TLdeserialize3.id;
                                                        kq0Var5.b = TLdeserialize3;
                                                        if (c10 == 1) {
                                                            kq0Var5.d = AndroidUtilities.generateSearchName(TLdeserialize3.first_name, TLdeserialize3.last_name, str5);
                                                        } else {
                                                            kq0Var5.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize3), null, "@" + str5);
                                                        }
                                                        arrayList3.add(kq0Var5);
                                                    }
                                                } else {
                                                    i30++;
                                                }
                        ...
                        AndroidUtilities.runOnUIThread(new wm(sq0Var, i12, arrayList3, 9));
                        break;
                    }
                } catch (Exception e) {
                    FileLog.e(e);
    ...
    public /* synthetic */ pq0(sq0 sq0Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = sq0Var;
        this.d = str;
        this.c = i10;
