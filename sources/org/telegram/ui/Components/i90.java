...
public final class i90 extends i7.t {
    ...
    public final kc.d e = new kc.d(new bb.a(11), new f7.v(11));
    ...
    public static int B(le.p pVar) {
        le.s sVar;
        String str;
        le.p pVar2 = (le.p) pVar.c;
        if (!(pVar2 instanceof le.r)) {
            return -1;
        }
        le.p pVar3 = (le.p) pVar2.c;
        if (!(pVar3 instanceof le.s) || (str = (sVar = (le.s) pVar3).g) == null) {
            return -1;
        }
        int i10 = 3;
        if (str.length() < 3) {
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        i11++;
                        boolean z10 = obj instanceof h90;
                        if (z10) {
                            h90 h90Var2 = (h90) obj;
                            if ("summary".equalsIgnoreCase(h90Var2.a.a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(h90Var2.c, sb2);
                                String trim = sb2.toString().trim();
                                pageblockdetails.title = trim.isEmpty() ? new TL_iv.textEmpty() : m90.j(trim);
                            }
                        }
                        if (obj instanceof g90) {
                            arrayList2.add(((g90) obj).a);
                        } else if (z10) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof g90) {
                TL_iv.PageBlock pageBlock = ((g90) obj).a;
    ...
    public final void b(le.c cVar) {
        ...
        for (le.p pVar = (le.p) cVar.c; pVar != null; pVar = (le.p) pVar.f) {
    ...
    public final void f(le.h hVar) {
        ...
        pageblockpreformatted.text = m90.d(m90.j(hVar.k));
        String str = hVar.j;
        if (str == null) {
            str = "";
        }
    ...
    public final void j(le.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = m90.d(m90.j(lVar.g));
    ...
    public final void k(le.n nVar) {
        if (!(nVar instanceof ge.a)) {
            ...
            pageblockparagraph.text = m90.c(((jc.a) nVar).g);
        ...
        for (le.p pVar = (le.p) ((ge.a) nVar).c; pVar != null; pVar = (le.p) pVar.f) {
            boolean z10 = pVar instanceof ge.e;
            if (z10 || (pVar instanceof ge.b)) {
                for (le.p pVar2 = (le.p) pVar.c; pVar2 != null; pVar2 = (le.p) pVar2.f) {
                    if (pVar2 instanceof ge.f) {
                        ArrayList<TL_iv.pageTableRow> arrayList = pageblocktable.rows;
                        TL_iv.pageTableRow pagetablerow = new TL_iv.pageTableRow();
                        for (le.p pVar3 = (le.p) ((ge.f) pVar2).c; pVar3 != null; pVar3 = (le.p) pVar3.f) {
    ...
    */
    public final void m(le.q qVar) {
        ...
        boolean z10 = ((le.a) ((le.p) qVar.b)) instanceof le.f;
        int i10 = qVar.g;
        for (le.p pVar = (le.p) qVar.c; pVar != null; pVar = (le.p) pVar.f) {
            if (pVar instanceof le.o) {
                if (z10) {
                    ...
                    if (!arrayDeque.isEmpty()) {
                        ...
                        tL_pageListOrderedItemText.text = m90.d(m90.a(pVar, pageblockorderedlist));
                ...
                tL_pageListOrderedItemText2.text = m90.d(m90.a(pVar, pageblockorderedlist));
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.c.add(new g90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        while (i10 < size) {
            ...
            i10++;
            g90 g90Var = (g90) obj;
            hashMap.put(Integer.valueOf(g90Var.b), g90Var);
        }
        ...
        h90 h90Var = new h90(null, ConnectionsManager.DEFAULT_DATACENTER_ID);
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((kc.a) arrayList3.get(i12)).b <= g90Var2.b) {
                int i14 = i12 + 1;
                kc.a aVar4 = (kc.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.b;
                if (i15 >= g90Var2.b) {
                    while (arrayDeque.peek() != h90Var && ((h90) arrayDeque.peek()).b <= i16) {
                        arrayDeque.pop();
                    }
                    h90 h90Var2 = new h90(aVar4, aVar4.d);
                    ((h90) arrayDeque.peek()).c.add(h90Var2);
                    arrayDeque.push(h90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != h90Var && ((h90) arrayDeque.peek()).b <= g90Var2.b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = g90Var2.a;
            ((h90) arrayDeque.peek()).c.add(g90Var2);
        }
        A(0, h90Var.c, this.a);
    }
}
