    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (d6Var.c == 0.0f) {
            ...
            canvas.drawCircle(measuredWidth, measuredHeight, com.google.android.gms.internal.vision.e2.z(1.0f, d6Var.c, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(10.0f)), paint);
        }
        if (this.v) {
            if (this.h != null) {
            }
