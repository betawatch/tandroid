...
public final /* synthetic */ class h21 implements Runnable {
    ...
    public /* synthetic */ h21(x21 x21Var, boolean z10, org.telegram.ui.ActionBar.f1 f1Var, n70 n70Var, long j3, TLRPC.User user, TLRPC.Chat chat) {
        this.d = x21Var;
        this.b = z10;
        this.e = f1Var;
        this.f = n70Var;
    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                f1Var.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.i21
                    ...
                    public final void onClick(View view) {
                        ...
                        ConnectionsManager.getInstance(i10).sendRequest(tL_channels_editBanned, new x1(x21Var2, 15));
                    }
                });
                break;
            default:
    ...
    public /* synthetic */ h21(yh.g gVar, TLRPC.TL_error tL_error, TwoStepVerificationActivity twoStepVerificationActivity, Activity activity, boolean z10, long j3, TLObject tLObject) {
        this.d = gVar;
        this.e = tL_error;
