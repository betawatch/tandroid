...
public final class t9 extends GradientDrawable {
    public final int[] a;
    public final a0.f b;
    public final a0.f c;
    public final a0.f d;
    ...
    public t9(GradientDrawable.Orientation orientation, int[] iArr) {
    ...
    public static /* synthetic */ void a(t9 t9Var, Runnable[] runnableArr, Bitmap bitmap, y50 y50Var, int i10, w7.i0[] i0VarArr) {
        a0.f fVar = t9Var.b;
        ArrayList arrayList = t9Var.e;
    ...
    public static Rect e(GradientDrawable.Orientation orientation, int i10, int i11) {
        Rect rect = new Rect();
        switch (r9.a[orientation.ordinal()]) {
            case 1:
                int i12 = i10 / 2;
                rect.left = i12;
                rect.top = 0;
    ...
    public final s9 c(Canvas canvas, final ViewGroup viewGroup) {
        if (this.g) {
            super.draw(canvas);
            return null;
        }
        ...
        while (true) {
            a0.f fVar2 = this.d;
            if (i11 >= i10) {
                s9 s9Var = (s9) fVar2.remove(viewGroup);
                if (s9Var != null) {
                    s9Var.dispose();
                }
                ...
                final o9 g10 = g(new y50[]{y50Var}, new q9(this, viewGroup), 0L);
                s9 s9Var2 = (s9) fVar2.put(viewGroup, new s9() { // from class: org.telegram.ui.Components.p9
                    @Override // org.telegram.ui.Components.s9
                    public final void dispose() {
                        t9.this.d.remove(viewGroup);
                        g10.dispose();
                    }
                });
                super.draw(canvas);
    ...
    public final o9 f(k2.c0 c0Var, w7.i0 i0Var, long j3) {
        y50[] y50VarArr = (y50[]) c0Var.b;
        if (!this.g) {
    ...
    public final o9 g(y50[] y50VarArr, w7.i0 i0Var, long j3) {
        ...
        for (int i10 = 0; i10 < y50VarArr.length; i10++) {
            ...
            if (y50Var.a != 0 && y50Var.b != 0) {
                ...
                n9 n9Var = new n9(this, y50Var, runnableArr, i10, i0VarArr);
                runnableArr[i10] = n9Var;
                dispatchQueue.postRunnable(n9Var, j3);
            }
        }
        return new o9(this, i0VarArr, runnableArr, y50VarArr);
    }
