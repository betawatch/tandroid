...
public final class x71 {
    ...
    */
    public final void b(Canvas canvas, RectF rectF, Paint paint) {
        ...
        char c11;
        x71 x71Var = this;
        float dp = AndroidUtilities.dp(AndroidUtilities.lerp(2, 1, x71Var.y));
        ArrayList arrayList = x71Var.F;
        if (arrayList == null || arrayList.isEmpty()) {
            canvas.drawRoundRect(rectF, dp, dp, paint);
            return;
        }
        float f7 = rectF.bottom;
        float lerp = AndroidUtilities.lerp(S / 2.0f, 0.0f, x71Var.y) + x71Var.z;
        float lerp2 = AndroidUtilities.lerp(x71Var.h - (S / 2.0f), x71Var.v.getWidth() - (x71Var.z * 2.0f), x71Var.y) + x71Var.z;
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(x71Var.I * 1.0f) / 2.0f;
        if (U == null) {
            U = new Path();
        }
        U.reset();
        ...
        while (true) {
            i10 = -1;
            if (i11 >= x71Var.F.size()) {
                i11 = -1;
                break;
            } else if (((Float) ((Pair) x71Var.F.get(i11)).first).floatValue() >= dp3) {
                break;
            } else {
                i11++;
            }
        ...
        int size = x71Var.F.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) x71Var.F.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i12) {
            if (i13 == i11) {
                ...
                c10 = 1;
                floatValue = ((Float) ((Pair) x71Var.F.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i12 ? 1.0f : ((Float) ((Pair) x71Var.F.get(i13)).first).floatValue();
            while (i13 != i12 && i13 != 0 && i13 < x71Var.F.size() - 1 && ((Float) ((Pair) x71Var.F.get(i13)).first).floatValue() - floatValue <= dp3) {
                i13++;
                floatValue2 = ((Float) ((Pair) x71Var.F.get(i13)).first).floatValue();
            }
    ...
    public final boolean e(float f7, float f10, int i10) {
        ...
        if (i10 == 0) {
            ...
            if (this.f) {
                ...
                float f11 = i18;
                this.c = f11;
                if (i10 == 1 && (w71Var = this.j) != null) {
                    w71Var.b(f11 / (this.h - S));
                }
                this.f = false;
                AndroidUtilities.runOnUIThread(new j71(this, 3), 50L);
                return true;
            }
