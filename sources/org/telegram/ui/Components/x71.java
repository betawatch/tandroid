                ...
                if (this.f) {
                    ...
                    if (w71Var5 != null) {
                        ...
                        if (videoEditedInfo != null) {
                            ...
                            chatActivityEnterView.V2.K(f16, 2);
                        }
                    }
                    invalidate();
                    return true;
                ...
                if (this.h) {
                    ...
                    if (w71Var6 != null) {
                        ...
                        if (videoEditedInfo2 != null) {
                            ...
                            chatActivityEnterView2.V2.K(f22, 2);
                        }
                    }
                    invalidate();
                    return true;
