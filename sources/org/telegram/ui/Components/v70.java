...
public final class v70 {
    ...
    public v70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        ...
        if ((((n2Var instanceof ProfileActivity) && ((ProfileActivity) n2Var).I0) || (((n2Var instanceof org.telegram.ui.uy) && ((org.telegram.ui.uy) n2Var).W) || (((n2Var instanceof ContactsActivity) && ((ContactsActivity) n2Var).I) || ((n2Var instanceof org.telegram.ui.i91) && ((org.telegram.ui.i91) n2Var).M)))) && (parentLayout = n2Var.getParentLayout()) != null) {
    ...
    public static v70 F(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view) {
        return new v70(viewGroup, f6Var, view, false, false, false);
    }

    public static v70 G(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z10) {
        return new v70(viewGroup, f6Var, view, z10, false, false);
    }

    public static v70 H(org.telegram.ui.ActionBar.n2 n2Var, View view) {
        return new v70(n2Var, view, false, true);
    }

    public static v70 I(org.telegram.ui.ActionBar.n2 n2Var, View view) {
        return new v70(n2Var, view, true, true);
    }
    ...
    public static void a(v70 v70Var, ViewGroup viewGroup) {
        t70 t70Var = v70Var.x;
        if (t70Var == null) {
            return;
        }
        v70Var.x = null;
        ValueAnimator valueAnimator = v70Var.m0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(t70Var.w, 0.0f);
        v70Var.m0 = ofFloat;
        ofFloat.addUpdateListener(new p70(t70Var, 0));
        v70Var.m0.addListener(new ai.y4(v70Var, t70Var, viewGroup, 7));
        if (v70Var.L) {
            v70Var.m0.setDuration(380L);
            v70Var.m0.setInterpolator(qr.h);
        } else {
            v70Var.m0.setDuration(150L);
        }
        v70Var.m0.start();
    }

    public static void f(v70 v70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        Object obj;
        ArrayList<TLRPC.PhotoSize> arrayList;
        Context context = v70Var.e;
        org.telegram.ui.ActionBar.f6 f6Var = v70Var.d;
        s70 s70Var = new s70(context);
        LinearLayout linearLayout = new LinearLayout(context);
        s70Var.addView(linearLayout);
        linearLayout.setOrientation(1);
        v70Var.r(s70Var, w7.y5.n(-1, -2));
        float f7 = 0.12f;
        if (z10 && runnable != null) {
            org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(2, v70Var.e, v70Var.d, false, false);
            ...
            f1Var.setOnClickListener(new t6(2, runnable));
        ...
        while (i11 < size) {
            ...
            org.telegram.ui.ActionBar.f1 f1Var2 = new org.telegram.ui.ActionBar.f1(2, v70Var.e, v70Var.d, false, false);
            ...
            if (photo == null || (arrayList = photo.sizes) == null) {
                obj = null;
                f1Var2.g(e9Var.b, R.drawable.msg_folders, null);
            } else {
                f1Var2.h(e9Var.b, ImageLocation.getForObject(FileLoader.getClosestPhotoSizeWithSize(e9Var.c.sizes, AndroidUtilities.dp(24.0f), false, FileLoader.getClosestPhotoSizeWithSize(arrayList, 50), true), e9Var.c), "50_50", null, null);
                obj = null;
            }
            f1Var2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.o70
    ...
    public final void B() {
        no noVar = new no(this, this.e, R.drawable.popup_fixed_alert4, this.d, (this.F ? 2 : 0) | (this.E ? 1 : 0) | (this.G ? 0 : 4));
        this.D = noVar;
        noVar.setDispatchKeyEventListener(new k70(this, 0));
        this.A = this.D;
    }

    /* JADX WARN: Type inference failed for: r0v1, types: [org.telegram.ui.Components.l70] */
    public final void C() {
        N();
        View view = this.f;
        if (view == null) {
        ...
        this.f0 = new ViewTreeObserver.OnScrollChangedListener() { // from class: org.telegram.ui.Components.l70
            @Override // android.view.ViewTreeObserver.OnScrollChangedListener
            public final void onScrollChanged() {
                q70 q70Var;
                v70 v70Var = v70.this;
                if (v70Var.e0 == null || (q70Var = v70Var.m) == null || !q70Var.isShowing()) {
                    return;
                }
                int[] iArr = new int[2];
                v70Var.e0.getLocationOnScreen(iArr);
                int i10 = iArr[0];
                int[] iArr2 = v70Var.h0;
        ...
        m70 m70Var = new m70(this, 0);
        this.g0 = m70Var;
        this.e0.addOnLayoutChangeListener(m70Var);
    }

    public final boolean D() {
        q70 q70Var = this.m;
        return q70Var != null && q70Var.isShowing();
    }
    ...
    public final v70 J() {
        v70 v70Var = new v70(this.D, this.d);
        v70Var.C = this.D.b(v70Var.B);
        return v70Var;
    }

    public final void K(v70 v70Var) {
        this.n0 = true;
        this.D.getSwipeBack().e(v70Var.C);
    }
    ...
    public final void M(Runnable runnable) {
        ...
        if (childAt instanceof org.telegram.ui.ActionBar.f1) {
            ...
            f1Var.setOnClickListener(new n70(this, runnable, 2));
        }
    }
    ...
    public final void N() {
        ...
        if (view != null) {
            ...
            m70 m70Var = this.g0;
            if (m70Var != null) {
                this.e0.removeOnLayoutChangeListener(m70Var);
            }
        }
        this.f0 = null;
        this.g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        q70 q70Var = this.m;
        if (q70Var == null || !q70Var.isShowing() || (view = this.f) == 0 || (viewGroup = this.b) == null || this.A == null || this.D == null) {
            return;
        }
        float[] fArr = this.o;
    ...
    public final void R(ia iaVar, float f7, float f10) {
    ...
    public final void X(float f7) {
        q70 q70Var = this.m;
        if (q70Var != null) {
            q70Var.update((int) this.a0, (int) (this.b0 + f7), -1, -1);
        }
    }
        ...
        while (i10 < this.A.getChildCount()) {
            ...
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ...
                if (actionBarPopupWindow$ActionBarPopupWindowLayout.getItemsCount() > 0) {
                    ...
                    } else if ((childAt2 instanceof cc0) || (childAt2 instanceof FrameLayout)) {
                    ...
                    } else if ((childAt3 instanceof cc0) || (childAt3 instanceof FrameLayout)) {
    ...
    */
    public final void Z() {
        ...
        if (this.s > 0 || this.u || this.v) {
            t70 t70Var3 = new t70(this, context);
            this.x = t70Var3;
            this.y = new rt(i12, t70Var3);
            ...
            this.m0.addListener(new q8(this, 25));
            if (this.L) {
                f11 = f16;
        ...
        if (!this.L || (t70Var2 = this.x) == null || this.N == 0) {
            f12 = f11;
        } else {
            t70Var2.s = (overlayContainerView.getWidth() - this.N) / f10;
            if (this.M == 3) {
        ...
        Rect padding = this.D.getPadding();
        rectF2.set(padding.left, padding.top, this.A.getMeasuredWidth() - padding.right, this.A.getMeasuredHeight() - padding.bottom);
        q70 q70Var = new q70(this, this.A, overlayContainerView);
        this.m = q70Var;
        q70Var.setOnDismissListener(new r70(this, overlayContainerView));
        ...
        if (this.W) {
            ...
            if (this.U || f17 + height2 + this.A.getMeasuredHeight() + AndroidUtilities.dp(16.0f) > i19) {
                ...
                if (!this.V || Math.max(0.0f, f17 + height2) + this.A.getMeasuredHeight() <= fArr[1] + rectF.top || rectF.height() != view.getHeight()) {
                    ...
                    if (this.L && (t70Var = this.x) != null) {
                        float height3 = overlayContainerView.getHeight();
                        float measuredHeight = this.A.getMeasuredHeight();
                        float f18 = rectF.bottom;
                        t70Var.v = (height3 - (measuredHeight + f18)) / f10;
                        t70 t70Var4 = this.x;
                        height = (int) (t70Var4.v + f18);
                        width = (int) (((t70Var4.s + rectF.right) - this.A.getMeasuredWidth()) + AndroidUtilities.dp(4.0f));
                        if (this.M == 3) {
                    ...
                    this.b0 = f20;
                    q70Var2.showAtLocation(overlayContainerView, 0, (int) f19, (int) f20);
                    if (this.w && view != 0) {
                        if (view.getParent() != null) {
                            view.getParent().requestDisallowInterceptTouchEvent(true);
                        }
                        vr vrVar = new vr(new WeakReference(this), 2);
                        this.o0 = vrVar;
            ...
            if (this.L) {
                ...
                t70Var.v = (height32 - (measuredHeight2 + f182)) / f10;
                t70 t70Var42 = this.x;
                height = (int) (t70Var42.v + f182);
                width = (int) (((t70Var42.s + rectF.right) - this.A.getMeasuredWidth()) + AndroidUtilities.dp(4.0f));
                if (this.M == 3) {
                }
            }
            if (!this.w) {
            ...
            this.b0 = f202;
            q70Var22.showAtLocation(overlayContainerView, 0, (int) f192, (int) f202);
            if (this.w) {
                if (view.getParent() != null) {
                }
                vr vrVar2 = new vr(new WeakReference(this), 2);
                this.o0 = vrVar2;
        ...
        q70 q70Var222 = this.m;
        q70Var222.g = this.I;
        float f1922 = width + this.q;
        this.a0 = f1922;
        float f2022 = height + this.r;
        this.b0 = f2022;
        q70Var222.showAtLocation(overlayContainerView, 0, (int) f1922, (int) f2022);
        if (this.w) {
        }
        if (this.d0) {
        }
    ...
    public final void b(int i10, Drawable drawable, CharSequence charSequence, int i11, int i12, Runnable runnable) {
        ...
        f1Var.setOnClickListener(new n70(this, runnable, 3));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        g9Var.r(currentUser);
        v9Var.setRoundRadius(AndroidUtilities.dp(34.0f));
        v9Var.e(currentUser, g9Var);
        v9Var.setScaleX(z10 ? 0.84f : 1.0f);
        v9Var.setScaleY(z10 ? 0.84f : 1.0f);
        f1Var.addView(v9Var, w7.y5.d(34, 34.0f, (LocaleController.isRTL ? 5 : 3) | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.f6 f6Var = this.d;
        if (z10) {
            View view = new View(context);
            view.setBackground(new gh.c(AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, f6Var), AndroidUtilities.dp(34.0f)));
            f1Var.addView(view, w7.y5.b(36.0f, 36.0f, (LocaleController.isRTL ? 5 : 3) | 16, -6.0f, 0.0f, -5.0f, 0.0f));
        }
        Integer num = this.j0;
        ...
        f1Var.setOnClickListener(new n70(this, runnable, 4));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        f1Var.setOnClickListener(new n70(this, runnable, 1));
        int i12 = this.S;
        if (i12 <= 0) {
            r(f1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public final void j(boolean z10, int i10, ii.b2 b2Var, CharSequence charSequence, Runnable runnable) {
        ...
        int i11 = org.telegram.ui.ActionBar.j6.E8;
        int i12 = org.telegram.ui.ActionBar.j6.F8;
        org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1((i10 == 0 && b2Var == null) ? 1 : 2, this.e, this.d, false, false);
        f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        if (b2Var != null) {
        ...
        Integer num3 = this.l0;
        f1Var.setSelectorColor(num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.j6.l1(0.12f, org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
        f1Var.setOnClickListener(new n70(this, runnable, 5));
        int i13 = this.S;
        if (i13 <= 0) {
            r(f1Var, w7.y5.n(-1, -2));
        } else {
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        g9Var.p(tLObject);
        v9Var.e(tLObject, g9Var);
        frameLayout.addView(v9Var, w7.y5.d(34, 34.0f, 19, 13.0f, 0.0f, 0.0f, 0.0f));
        ...
        org.telegram.messenger.rk.n(org.telegram.ui.ActionBar.j6.q5, f6Var, h, 1, 13.0f);
        ...
        frameLayout.setOnClickListener(new n70(this, runnable, 0));
    ...
    public final void o() {
        ...
        actionBarPopupWindow$ActionBarPopupWindowLayout2.setDispatchKeyEventListener(new k70(this, 1));
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.j5, this.d));
    ...
    public final void t() {
        ...
        View childAt = this.D.L.getChildAt(r0.getItemsCount() - 1);
        if (childAt instanceof org.telegram.ui.ActionBar.f1) {
            x5 textView = ((org.telegram.ui.ActionBar.f1) childAt).getTextView();
    ...
    public v70(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z10, boolean z11, boolean z12) {
        this.i = 5;
        this.o = new float[2];
        this.t = true;
        this.w = true;
    ...
    public v70(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, org.telegram.ui.ActionBar.f6 f6Var) {
        this.i = 5;
        this.o = new float[2];
        this.t = true;
        this.w = true;
