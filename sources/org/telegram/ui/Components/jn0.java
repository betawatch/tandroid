...
public final class jn0 extends xl0 {
    ...
    public final MessageObject E(int i10) {
        ...
        return (MessageObject) kn0Var.f.get(i10 - i12);
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            if (i10 != kn0Var.s) {
                if (i10 == kn0Var.x) {
                    w3Var.c(LocaleController.getString(R.string.RecentlyDownloaded), LocaleController.getString(R.string.Settings), new i80(this, 11));
                    return;
                }
                return;
            }
            ...
            if (!w3Var.getText().equals(string)) {
                w3Var.c(string, LocaleController.getString(kn0Var.H ? R.string.PauseAll : R.string.ResumeAll), new in0(this));
                return;
            }
            String string2 = LocaleController.getString(kn0Var.H ? R.string.PauseAll : R.string.ResumeAll);
            boolean z11 = kn0Var.H;
        ...
        MessageObject E = E(i10);
        if (E != null) {
            boolean z12 = kn0Var.I.g() && i10 >= kn0Var.v && i10 < kn0Var.w;
            if (i11 == 1) {
                gn0 gn0Var = (gn0) view;
                gn0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false));
                org.telegram.ui.Cells.l7 l7Var = gn0Var.a;
                ...
                p10Var.b = id3;
                l7Var.b(kn0Var.I.c(p10Var), id2 == E.getId());
                z10 = id2 == E.getId();
                if (l7Var.O == z12) {
                    return;
                }
            ...
            if (i11 == 2) {
                ...
                p10Var.b = id5;
                k7Var.e(kn0Var.I.c(p10Var), id4 == E.getId());
                z10 = id4 == E.getId();
                if (k7Var.d0 == z12) {
                    return;
                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            gn0Var.addView(l7Var);
            frameLayout = gn0Var;
        } else {
            frameLayout = new hn0(viewGroup.getContext());
        }
