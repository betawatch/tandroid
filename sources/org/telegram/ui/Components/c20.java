...
public class c20 extends FrameLayout implements xd.b, org.telegram.ui.ActionBar.a6 {
    ...
    public c20(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        nr nrVar = nr.h;
        this.a = new xd.a(0, this, nrVar, 380L, false);
        this.b = new xd.a(1, this, nrVar, 380L, true);
        ...
        hb1 hb1Var = new hb1(this, getContext(), 8);
        this.D = hb1Var;
        hb1Var.setOrientation(0);
        hb1Var.setVisibility(0);
        addView(hb1Var, k7.b6.d(-2, 32.0f, (LocaleController.isRTL ? 5 : 3) | 16, 4.0f, 0.0f, 4.0f, 0.0f));
    ...
    public final void e() {
        ...
        hb1 hb1Var = this.D;
        int childCount2 = hb1Var.getChildCount();
        for (int i12 = 0; i12 < childCount2; i12++) {
            if (hb1Var.getChildAt(i12) instanceof org.telegram.ui.ActionBar.v0) {
                ((org.telegram.ui.ActionBar.v0) hb1Var.getChildAt(i12)).a();
            }
        }
        invalidate();
    }
    ...
    public final void f() {
        ...
        transitionSet.setInterpolator((TimeInterpolator) nr.g);
        transitionSet.addListener((Transition.TransitionListener) new a20(this));
        hb1 hb1Var = this.D;
        TransitionManager.beginDelayedTransition(hb1Var, transitionSet);
        int i10 = 0;
        while (i10 < hb1Var.getChildCount()) {
            if (!arrayList2.remove(((org.telegram.ui.ActionBar.v0) hb1Var.getChildAt(i10)).getFilter())) {
                hb1Var.removeViewAt(i10);
                i10--;
            }
            i10++;
        }
        for (int i11 = 0; i11 < arrayList2.size(); i11++) {
            ...
            boolean z4 = LocaleController.isRTL;
            hb1Var.addView(v0Var, k7.b6.t(-2, -1, 0, z4 ? 6 : 0, 0, z4 ? 0 : 6, 0));
        }
        int i12 = 0;
        while (i12 < hb1Var.getChildCount()) {
            ((org.telegram.ui.ActionBar.v0) hb1Var.getChildAt(i12)).setExpanded(i12 == this.F);
            i12++;
        }
        hb1Var.setTag(!isEmpty ? 1 : null);
    }
