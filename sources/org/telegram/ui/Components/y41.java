...
public final /* synthetic */ class y41 implements Runnable {
    ...
    public /* synthetic */ y41(org.telegram.ui.yk ykVar, boolean[] zArr, String str, LinearLayout linearLayout, ArrayList arrayList, String str2, TranslateController translateController, org.telegram.ui.ActionBar.n1 n1Var, ArrayList arrayList2) {
        this.d = ykVar;
        this.e = zArr;
        this.f = str;
        this.n = linearLayout;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                boolean z10 = false;
                if (!zArr[0]) {
                    if (str != null && (y3 = j41.y(j41.E(str, null, null))) != null) {
                    ...
                    while (i10 < size) {
                        ...
                        if (TextUtils.equals(str3, str2)) {
                            ...
                            if (z10) {
                                ...
                                f1Var = f1Var3;
                                final int i12 = 0;
                                f1Var.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.w41
                                    @Override // android.view.View.OnClickListener
                                    public final void onClick(View view) {
                                        switch (i12) {
                                            case 0:
                                                org.telegram.ui.yk ykVar2 = ykVar;
                                                translateController.setDialogTranslateTo(ykVar2.b, str3);
                                                n1Var.d(true);
                                                ykVar2.b();
                                                break;
                                            default:
                                                org.telegram.ui.yk ykVar3 = ykVar;
                                                translateController.setDialogTranslateTo(ykVar3.b, str3);
                                                n1Var.d(true);
                                                ykVar3.b();
                                                break;
                                        }
                    ...
                    while (i13 < size2) {
                        ...
                        if (!TextUtils.equals(str4, str2)) {
                            ...
                            if (!z11) {
                                final int i15 = 1;
                                f1Var4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.w41
                                    @Override // android.view.View.OnClickListener
                                    public final void onClick(View view) {
                                        switch (i15) {
                                            case 0:
                                                org.telegram.ui.yk ykVar2 = ykVar;
                                                translateController.setDialogTranslateTo(ykVar2.b, str4);
                                                n1Var.d(true);
                                                ykVar2.b();
                                                break;
                                            default:
                                                org.telegram.ui.yk ykVar3 = ykVar;
                                                translateController.setDialogTranslateTo(ykVar3.b, str4);
                                                n1Var.d(true);
                                                ykVar3.b();
                                                break;
                                        }
    ...
    public /* synthetic */ y41(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, ArrayList arrayList5, ArrayList arrayList6, ArrayList arrayList7, ArrayList arrayList8) {
