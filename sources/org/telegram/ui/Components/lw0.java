    ...
    public final void b(Canvas canvas, View view) {
        ...
        if (size2 < i11) {
            ...
            while (i19 < i17) {
                if (arrayList.size() >= i11 || Utilities.random.nextFloat() <= 0.7f) {
                    ...
                    float nextFloat2 = i16 == 0 ? (Utilities.random.nextFloat() * org.telegram.messenger.f0.B(20.0f, view.getMeasuredHeight(), i20)) + i20 : Utilities.random.nextFloat() * view.getMeasuredHeight();
        ...
        while (i12 < size3) {
            ...
            if (f15 >= f16) {
                ...
                float f20 = kw0Var4.e;
                float f21 = min2;
                kw0Var4.a = a4.a.B(f19 * f20, f21, 500.0f, f18);
