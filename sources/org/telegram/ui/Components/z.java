...
public final class z extends sa {
    ...
    public static void Q(final z zVar, final org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (zVar.g0 == null) {
            ...
            createtone.display_author = lpVar.a.q;
                    ...
                    switch (i10) {
                        case 0:
                            ...
                            if (aiComposeTone == null) {
                                if (tL_error != null) {
                                    org.telegram.ui.yh.u(zVar2.c0, f6Var, tL_error, false);
                                    break;
                                }
                            } else {
                                e eVar = zVar2.i0;
        ...
        updatetone.display_author = lpVar.a.q;
    ...
    public static void R(z zVar, org.telegram.ui.ActionBar.f6 f6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            if (!"TONES_SAVED_TOO_MANY".equalsIgnoreCase(tL_error.text)) {
                org.telegram.ui.yh.u(frameLayout, f6Var, tL_error, false);
            } else {
    ...
    public final void V() {
        ...
        this.f0 = yVar;
        org.telegram.ui.g61[] g61VarArr = {yVar};
