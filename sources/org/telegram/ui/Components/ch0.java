    ...
    public final void c(wu wuVar, Canvas canvas) {
        ...
        if (canvas.isHardwareAccelerated()) {
            ...
            if (childCount > 0) {
                ...
                NotchInfoUtils.NotchInfo notchInfo = eh0Var.n;
                if (notchInfo != null) {
            ...
            int ilerp = (int) ((1.0f - AndroidUtilities.ilerp(eh0Var.e, 0.5f, 1.0f)) * 255.0f);
            int b10 = g7.n.b(ilerp, 0, 255);
            eh0.a((eh0) wuVar.b, beginRecording);
            this.b.endRecording();
            float f21 = this.f;
            float z10 = e2.c.z(f21, 1.0f, 2.0f, e2.c.x(eh0Var.f, 0.5f, f21, (f21 / 4.0f) + 1.0f));
            ...
            float lerp = AndroidUtilities.lerp(0.0f, AndroidUtilities.dp(7.0f) * f23, 0.0f, 0.5f, eh0Var.e);
            ...
            if (eh0Var.n != null) {
                ...
                NotchInfoUtils.NotchInfo notchInfo2 = eh0Var.n;
                if (notchInfo2.isLikelyCircle) {
                    float min = Math.min(notchInfo2.bounds.width(), eh0Var.n.bounds.height()) / 2.0f;
                    RectF rectF3 = eh0Var.n.bounds;
                    float width2 = rectF3.bottom - (rectF3.width() / 2.0f);
                    beginRecording4.drawCircle(eh0Var.n.bounds.centerX(), width2, min, paint2);
                    path.rewind();
                    float f25 = f10 / 2.0f;
                    path.moveTo(eh0Var.n.bounds.centerX() - f25, width2);
                    path.lineTo(eh0Var.n.bounds.centerX(), min + width2 + f10);
                    path.lineTo(eh0Var.n.bounds.centerX() + f25, width2);
                    path.close();
                    beginRecording4.drawPath(path, paint2);
                } else if (notchInfo2.isAccurate) {
                    beginRecording4.drawPath(notchInfo2.path, paint2);
                } else {
                    float max = Math.max(notchInfo2.bounds.width(), eh0Var.n.bounds.height()) / 2.0f;
                    RectF rectF4 = eh0Var.n.bounds;
                    RectF rectF5 = this.h;
                    rectF5.set(rectF4);
            ...
            NotchInfoUtils.NotchInfo notchInfo3 = eh0Var.n;
            if (notchInfo3 != null) {
