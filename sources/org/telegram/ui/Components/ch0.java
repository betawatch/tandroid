...
public class ch0 extends kp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View E(int i10) {
        ...
        ArrayList arrayList = bh0Var.c;
        if (arrayList.size() <= i10 || i10 < 0) {
            return null;
        }
        yg0 yg0Var = (yg0) arrayList.get(i10);
        zg0 zg0Var = yg0Var.b;
        return zg0Var == null ? yg0Var.c : zg0Var;
    }
    ...
    public final void N(int i10, int i11) {
        ...
        bh0 bh0Var = this.z0;
        if (bh0Var != null) {
            for (int i12 = 0; i12 < bh0Var.c.size(); i12++) {
                if (((yg0) bh0Var.c.get(i12)).c != null) {
                    wg0 wg0Var = ((yg0) bh0Var.c.get(i12)).c;
                    int i13 = this.i1;
                    int i14 = this.j1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        ArrayList arrayList5 = ch0Var2.Q0;
        ArrayList arrayList6 = ch0Var2.P0;
        if (i10 != i14) {
        ...
        if (ch0Var2.O0 == dialogPhotos3) {
            ...
            if (!arrayList7.isEmpty() || !dialogPhotos3.fromCache) {
                ...
                ch0Var2.g1 = -1;
                int i18 = ch0Var2.H0;
                TLRPC.User user4 = MessagesController.getInstance(i18).getUser(Long.valueOf(ch0Var2.A0));
                ...
                if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                    ...
                    ch0Var2.g1 = arrayList7.size() - 1;
                }
                arrayList5.clear();
                arrayList6.clear();
                ArrayList arrayList8 = ch0Var2.T0;
                arrayList8.clear();
                ArrayList arrayList9 = ch0Var2.S0;
                arrayList9.clear();
                ArrayList arrayList10 = ch0Var2.U0;
                arrayList10.clear();
                ArrayList arrayList11 = ch0Var2.V0;
                arrayList11.clear();
                ArrayList arrayList12 = ch0Var2.R0;
                arrayList12.clear();
                ArrayList arrayList13 = ch0Var2.W0;
                arrayList13.clear();
                ArrayList arrayList14 = ch0Var2.X0;
                arrayList14.clear();
                if (DialogObject.isChatDialog(ch0Var2.A0)) {
                    ...
                    if (imageLocation != null) {
                        ...
                        if (chatFull == null || !FileLoader.isSamePhoto((TLRPC.FileLocation) imageLocation.location, chatFull.chat_photo)) {
                            ...
                            arrayList12.add(ch0Var2.B0.chat_photo);
                            if (ch0Var2.B0.chat_photo.video_sizes.isEmpty()) {
                                z13 = false;
                                arrayList9.add(null);
                                arrayList6.add(null);
                            } else {
                                TLRPC.VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(ch0Var2.B0.chat_photo.video_sizes, MediaDataController.MAX_STYLE_RUNS_COUNT);
                                arrayList9.add(ImageLocation.getForPhoto(closestVideoSizeWithSize, ch0Var2.B0.chat_photo));
                ...
                while (true) {
                    ...
                    if (photo2 == null || (photo2 instanceof TLRPC.TL_photoEmpty) || (arrayList3 = photo2.sizes) == null) {
                        ...
                        if (closestPhotoSizeWithSize2 != null) {
                            ...
                            if (forPhoto != null) {
                                ImageLocation imageLocation3 = ch0Var2.L0;
                                num = num2;
                                if (imageLocation3 == null) {
                                    arrayList14 = arrayList4;
                                    user2 = user;
                                } else if (imageLocation3.photoId != forPhoto.photoId || z10 || ch0Var2.A0 == UserConfig.getInstance(i12).getClientUserId()) {
                                    user2 = user;
                                    arrayList14 = arrayList4;
                                } else {
                                    arrayList5.add(null);
                                    arrayList.add(ch0Var2.L0);
                                    ImageLocation imageLocation4 = ch0Var2.M0;
                                    ...
                                    if (photo2.video_sizes.isEmpty()) {
                                        ...
                                        if (vectorMarkupVideoSize != null) {
                                            user3 = user;
                                            arrayList11.add(new w51(vectorMarkupVideoSize, user != null && user3.premium, 2));
                                            obj = null;
                                            arrayList9.add(null);
                                            arrayList6.add(null);
                                        } else {
                                ...
                                if (photo2.video_sizes.isEmpty()) {
                                    ...
                                    if (vectorMarkupVideoSize2 != null) {
                                        user = user2;
                                        arrayList11.add(new w51(vectorMarkupVideoSize2, user2 != null && user2.premium, 2));
                                        z12 = false;
                                        arrayList9.add(null);
                                        arrayList6.add(null);
                                    } else {
                ...
                ImageLocation imageLocation5 = ch0Var.m1;
                if (imageLocation5 != null) {
                    ch0Var.A(imageLocation5, ch0Var.n1);
                }
            }
        }
    }
    ...
    public n9 getCurrentItemView() {
        bh0 bh0Var = this.z0;
        if (bh0Var == null || bh0Var.c.isEmpty()) {
            return null;
        }
        return ((yg0) bh0Var.c.get(getCurrentItem())).c;
    }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (bh0Var != null) {
            zk0 zk0Var = this.y0;
            if (zk0Var.getScrollState() != 0 && !this.w0 && this.x0) {
                this.x0 = false;
            ...
            org.telegram.ui.ou0 ou0Var = this.d1;
            xg0 xg0Var = this.C0;
            if (ou0Var != null && getCurrentItemView() != null) {
                if (action != 0 && this.E0) {
                    org.telegram.ui.ou0 ou0Var2 = this.d1;
                    if (!ou0Var2.n) {
                        ou0Var2.a(MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0), this, getCurrentItemView().getImageReceiver(), null, 0);
                    }
                }
            ...
            if (action == 0) {
                ...
                if (bh0Var.c.size() > 1 && xg0Var != null) {
                    xg0Var.b(motionEvent.getX() < ((float) getWidth()) / 3.0f);
                }
                this.E0 = false;
            } else if (action == 1) {
                if (!this.E0) {
                    ...
                    if (realCount > 1) {
                        if (motionEvent.getX() > getWidth() / 3.0f) {
                            ...
                            i10 = i12 < bh0Var.j() ? (realCount + r0) - 1 : i12;
                        }
                        if (xg0Var != null) {
                            xg0Var.a();
                        }
                ...
                float f10 = this.u0;
                boolean z10 = abs >= f10 || Math.abs(x8) >= f10;
                if (z10) {
                    this.E0 = true;
                    if (xg0Var != null) {
                        xg0Var.a();
            ...
            boolean onTouchEvent = this.w0 ? zk0Var.onTouchEvent(motionEvent) : false;
            if (this.x0) {
                try {
    ...
    public void setAnimatedFileMaybe(x5 x5Var) {
        bh0 bh0Var;
        if (x5Var == null || (bh0Var = this.z0) == null) {
            return;
        }
        int childCount = getChildCount();
    ...
    public ch0(Context context, long j10, org.telegram.ui.ActionBar.k kVar, zk0 zk0Var, org.telegram.ui.iz0 iz0Var, xg0 xg0Var, tg0 tg0Var) {
        ...
        this.g1 = -1;
        this.l1 = tg0Var;
        setPadding(0, 0, 0, tg0Var == null ? 0 : tg0Var.n);
        if (tg0Var != null) {
            tg0Var.setView(this);
        }
        setVisibility(8);
