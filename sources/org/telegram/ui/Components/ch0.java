...
public final class ch0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public ch0(Context context, int i10, MessageObject messageObject, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        while (true) {
            ...
            if (pollAnswerVoters.voters != 0) {
                ...
                this.x.add(new bh0(tL_messages_votesList, pollAnswerVoters.option));
        ...
        R();
        Collections.sort(this.x, new ug0(this));
        S();
        ...
        getContext();
        wg0Var.setLayoutManager(new gg.b0(1, z10, 9));
                ...
                while (true) {
                    if (i12 < size2) {
                        ...
                        if (Arrays.equals(bh0Var.d, bh0Var2.d)) {
                            bh0Var2.c = bh0Var.c;
                            if (bh0Var2.a != bh0Var.a || bh0Var2.b.size() != bh0Var.b.size()) {
                                z10 = true;
                            }
                            bh0Var2.a = bh0Var.a;
                            bh0Var2.b = bh0Var.b;
            ...
            if (wg0Var != null) {
                ...
                for (int i13 = 0; i13 < childCount; i13++) {
                    ...
                    if (childAt instanceof PollVotesAlert$UserCell) {
                        ...
                        s4.c1 U = G == null ? null : wg0Var.U(G);
                        if (U != null) {
    ...
    public static void n(ch0 ch0Var, bh0 bh0Var, TLObject tLObject) {
        if (ch0Var.isShowing()) {
            ...
            if (tLObject != null) {
                TLRPC.TL_messages_votesList tL_messages_votesList = (TLRPC.TL_messages_votesList) tLObject;
                MessagesController.getInstance(ch0Var.currentAccount).putUsers(tL_messages_votesList.users, false);
                bh0Var.b.addAll(tL_messages_votesList.votes);
                bh0Var.c = tL_messages_votesList.next_offset;
                ch0Var.O(null);
                ch0Var.c.X(true);
            }
        }
        ...
        if (AndroidUtilities.isContextSafe(context)) {
            ...
            if (arrayList == null || arrayList.isEmpty()) {
                ...
                if (view instanceof org.telegram.ui.Cells.s8) {
                    ...
                    bh0 bh0Var = (bh0) ch0Var.x.get(S);
                    if (Q != bh0Var.b() || hashSet.contains(bh0Var)) {
                        return;
                    }
                    if (bh0Var.e && bh0Var.f < bh0Var.b.size()) {
                        int min = Math.min(bh0Var.f + 50, bh0Var.b.size());
                        bh0Var.f = min;
                        if (min == bh0Var.b.size()) {
                            bh0Var.e = false;
                        }
                        ch0Var.O(null);
                        yg0Var.X(true);
                    ...
                    hashSet.add(bh0Var);
                    TLRPC.TL_messages_getPollVotes tL_messages_getPollVotes = new TLRPC.TL_messages_getPollVotes();
                    tL_messages_getPollVotes.peer = ch0Var.s;
                    tL_messages_getPollVotes.id = ch0Var.n.getId();
                    ...
                    tL_messages_getPollVotes.offset = bh0Var.c;
    ...
    public static void t(ch0 ch0Var) {
        ...
        if ((z10 && x7Var.getTag() == null) || (!z10 && x7Var.getTag() != null)) {
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(x7Var, (Property<x7, Float>) property, z10 ? 1.0f : 0.0f), ObjectAnimator.ofFloat(ch0Var.e, (Property<View, Float>) property, z10 ? 1.0f : 0.0f));
    ...
    public final void O(View view) {
        ...
        while (true) {
            ...
            View pinnedHeader = i10 == -2 ? view : i10 == -1 ? wg0Var.getPinnedHeader() : wg0Var.getChildAt(i10);
            if ((pinnedHeader instanceof ah0) && (pinnedHeader.getTag(R.id.object_tag) instanceof bh0)) {
                ah0 ah0Var = (ah0) pinnedHeader;
                bh0 bh0Var = (bh0) pinnedHeader.getTag(R.id.object_tag);
                ...
                while (true) {
                    if (i12 < size) {
                        ...
                        if (!Arrays.equals(pollAnswer.option, bh0Var.d) || ((zg0) this.w.get(bh0Var)) == null) {
                            i12++;
                        } else {
                            ...
                            ah0Var.a(tL_textWithEntities == null ? "" : tL_textWithEntities.text, tL_textWithEntities == null ? null : tL_textWithEntities.entities, P(bh0Var.d), bh0Var.a, bh0Var.a(), true);
        ...
        View view2 = wg0Var.r1;
        if (view2 != null) {
            view2.measure(View.MeasureSpec.makeMeasureSpec(wg0Var.getMeasuredWidth(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(wg0Var.getMeasuredHeight(), 0));
            View view3 = wg0Var.r1;
            view3.layout(0, 0, view3.getMeasuredWidth(), wg0Var.r1.getMeasuredHeight());
            wg0Var.invalidate();
        }
        wg0Var.invalidate();
    }
    ...
    public final void R() {
        ...
        while (i11 < size) {
            ...
            hashMap2.put(bh0Var, zg0Var);
            if (!tL_messageMediaPoll.results.results.isEmpty()) {
                int size2 = tL_messageMediaPoll.results.results.size();
                int i14 = 0;
                while (i14 < size2) {
                    hashMap = hashMap2;
                    if (Arrays.equals(bh0Var.d, tL_messageMediaPoll.results.results.get(i14).option)) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, TLObject.FLAG_19, new Class[]{ah0.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, TLObject.FLAG_19, new Class[]{ah0.class}, new String[]{"middleTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, TLObject.FLAG_19, new Class[]{ah0.class}, new String[]{"righTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 524304, new Class[]{ah0.class}, null, null, null, org.telegram.ui.ActionBar.j6.e7));
