...
public final class lq {
    ...
    public float l = 1.0f;
    public int v = org.telegram.ui.ActionBar.f6.sf;
    public int w = org.telegram.ui.ActionBar.f6.tf;
    public int z = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (i9 != 1 && i9 != 2) {
            ...
            int v03 = org.telegram.ui.ActionBar.f6.v0(this.w, b6Var);
            if (this.u != v02) {
                this.u = v02;
                this.e.setColor(v02);
            }
        ...
        float f16 = this.C;
        float f17 = f16 * 2.0f;
        float dp = (i12 - AndroidUtilities.dp(f17)) / 2.0f;
        int i13 = this.s;
        int i14 = this.r;
        float z11 = i13 == i14 ? i13 : e2.c.z(1.0f, f15, i14, i13 * f15);
        e(z11);
        if (this.j) {
            float f18 = this.l;
            f10 = ((f18 <= 0.5f ? gr.g.getInterpolation(f18 * 2.0f) : gr.i.getInterpolation(1.0f - ((f18 - 0.5f) * 2.0f))) * 0.1f) + 1.0f;
        } else {
            f10 = 1.0f;
        }
        float f19 = this.B;
        ...
        if (this.F && (paint = this.d) != null) {
            ...
            if (this.g && org.telegram.ui.ActionBar.f6.a1()) {
                float f22 = f16 * AndroidUtilities.density;
                canvas.drawRoundRect(rectF, f22, f22, org.telegram.ui.ActionBar.f6.h2);
            }
        }
        if (z10) {
            canvas.restore();
        ...
        if (this.q != null) {
            ...
            canvas.translate(f23, e2.c.z(1.0f, f15, dp3, dp2));
            ...
            canvas.translate(f24, e2.c.z(1.0f, f15, dp5, dp4));
            this.e.setAlpha((int) (f15 * 255.0f));
            this.n.draw(canvas);
            canvas.restore();
        }
    ...
    public final void b(Canvas canvas) {
        ...
        if (this.d != null && this.F) {
            ...
            if (this.g && org.telegram.ui.ActionBar.f6.a1()) {
                ...
                canvas.drawRoundRect(rectF, f15, f15, org.telegram.ui.ActionBar.f6.h2);
            }
            if (z10) {
                canvas.restore();
            }
    ...
    public final void c(int i9, boolean z10) {
        ...
        View view2;
        boolean z11 = false;
        String formatWholeNumber = this.a ? AndroidUtilities.formatWholeNumber(i9, 0) : String.valueOf(i9);
        ...
        boolean z12 = Math.abs(i9 - this.h) > 99 ? false : z10;
        if (!z12) {
            this.h = i9;
        ...
        if (z12) {
            ...
            this.k.addListener(new org.telegram.ui.xp(this, 21));
            if (this.h <= 0) {
                this.c = 0;
            ...
            if (this.n != null) {
                ...
                if (str.length() == formatWholeNumber.length()) {
                    ...
                    for (int i10 = 0; i10 < str.length(); i10++) {
                        if (str.charAt(i10) == formatWholeNumber.charAt(i10)) {
                            int i11 = i10 + 1;
                            spannableStringBuilder.setSpan(new xy(z11), i10, i11, 0);
                            spannableStringBuilder2.setSpan(new xy(z11), i10, i11, 0);
                        } else {
                            spannableStringBuilder3.setSpan(new xy(z11), i10, i10 + 1, 0);
                        }
                    }
