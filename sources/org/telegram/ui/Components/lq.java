...
public final /* synthetic */ class lq implements Runnable {
    ...
    public final /* synthetic */ hh.t6 b;
    public final /* synthetic */ org.telegram.ui.Cells.g3 c;
    public final /* synthetic */ int[] d;
    public final /* synthetic */ lh.d e;
    ...
    public /* synthetic */ lq(String[] strArr, hh.t6 t6Var, org.telegram.ui.Cells.g3 g3Var, int[] iArr, lh.d dVar, boolean z10, int i10, TLRPC.User user, int[] iArr2, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.ActionBar.e3 e3Var, org.telegram.ui.ActionBar.c6 c6Var, Context context) {
        this.a = strArr;
        this.b = t6Var;
        this.c = g3Var;
        this.d = iArr;
    ...
    public final void run() {
        ...
        iArr2[0] = connectionsManager.sendRequestTyped(createbot, aVar, new Utilities.Callback2() { // from class: org.telegram.ui.Components.oq
                ...
                if (tL_error != null) {
                    ...
                    if (equalsIgnoreCase) {
                        ...
                        if (charSequenceIndexOf >= 0) {
                            replaceSingleLink.setSpan(new org.telegram.ui.Cells.i(c6Var2, yqVar, 6), charSequenceIndexOf, charSequenceIndexOf + 10, 33);
                        }
                        ec M = mcVar.M(string, replaceSingleLink, i13);
                        M.j = 8000;
                        M.j();
                    } else {
