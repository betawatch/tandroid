    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.a) {
            case 0:
                ...
                float interpolation = rr.i.getInterpolation(min < 0.3f ? min / 0.3f : 1.0f);
                rr rrVar = rr.g;
                float interpolation2 = rrVar.getInterpolation(min < 0.3f ? 0.0f : (min - 0.3f) / 0.7f);
                if (this.d) {
                    ...
                    dpf2 = (1.0f - rrVar.getInterpolation(this.e / 2.0f)) * AndroidUtilities.dpf2(1.5f);
                } else {
                    dp = ((AndroidUtilities.dp(7.0f) - AndroidUtilities.dp(2.1f)) * interpolation) + ((1.0f - interpolation) * AndroidUtilities.dp(2.1f));
                    dpf2 = AndroidUtilities.dpf2(1.5f) * rr.h.getInterpolation(this.e / 2.0f);
                }
                ...
                if (paint2 == null) {
                    paint2 = org.telegram.ui.ActionBar.h6.c2;
                }
            ...
            default:
                ...
                Paint paint3 = this.g;
                if (paint3 == null) {
                    paint3 = org.telegram.ui.ActionBar.h6.d2;
                }
                Paint paint4 = paint3;
