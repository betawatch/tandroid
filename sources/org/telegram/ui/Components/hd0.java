...
public final class hd0 extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r6v2, types: [android.view.View, android.widget.EditText, android.widget.TextView, dg.b, org.telegram.ui.Components.EditTextBoldCursor, org.telegram.ui.Components.xt] */
    public final void b(ArrayList arrayList, boolean z4, boolean z10, boolean z11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (b10 == 0) {
                ...
                ?? gd0Var = new gd0(getContext());
                gd0Var.setBackgroundColor(0);
                gd0Var.setPadding(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f));
                gd0Var.setTextSize(0, mediaEntity.fontSize);
                gd0Var.setTypeface(mediaEntity.textTypeface.d());
                SpannableString spannableString = new SpannableString(Emoji.replaceEmoji(mediaEntity.text, gd0Var.getPaint().getFontMetricsInt(), false));
                ...
                while (i13 < size2) {
                    ...
                    u5 u5Var = new u5(emojiEntity2.document_id, gd0Var.getPaint().getFontMetricsInt());
                ...
                gd0Var.setText(spannableString);
                int i15 = 17;
                ...
                gd0Var.setTextAlignment(i11);
                gd0Var.setHorizontallyScrolling(false);
                gd0Var.setImeOptions(TLObject.FLAG_28);
                gd0Var.setFocusableInTouchMode(true);
                gd0Var.setEnabled(false);
                gd0Var.setInputType(gd0Var.getInputType() | 16384);
                if (i17 >= 23) {
                    gd0Var.setBreakStrategy(0);
                }
                gd0Var.setShadowLayer(0.0f, 0.0f, 0.0f, 0);
                int i20 = mediaEntity.color;
                byte b11 = mediaEntity.subType;
                if (b11 == 0) {
                    gd0Var.setFrameColor(i20);
                    i20 = AndroidUtilities.computePerceivedBrightness(mediaEntity.color) >= 0.721f ? -16777216 : -1;
                } else if (b11 == 1) {
                    gd0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -1728053248 : -1711276033);
                } else if (b11 == 2) {
                    gd0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -16777216 : -1);
                } else {
                    gd0Var.setFrameColor(0);
                }
                gd0Var.setTextColor(i20);
                gd0Var.setCursorColor(i20);
                gd0Var.setHandlesColor(i20);
                gd0Var.setHighlightColor(org.telegram.ui.ActionBar.j6.l1(0.4f, i20));
                mediaEntity.view = gd0Var;
                p9Var = gd0Var;
            } else {
                p9Var = null;
            }
