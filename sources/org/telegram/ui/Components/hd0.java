...
public final class hd0 extends HorizontalScrollView {
    ...
    public static void a(hd0 hd0Var, int i10, int i11) {
        View childAt;
        if (hd0Var.f == 0 || (childAt = hd0Var.d.getChildAt(i10)) == null) {
            return;
        }
    ...
    public final void d() {
        ...
        for (int i10 = 0; i10 < this.f; i10++) {
            if (this.e.getAdapter() instanceof fd0) {
                ((fd0) this.e.getAdapter()).getClass();
    ...
    public final void e() {
        ...
        while (i10 < this.f) {
            ...
            } else if (this.e.getAdapter() instanceof fd0) {
                ((ey) ((fd0) this.e.getAdapter())).getClass();
        ...
        if (childAt != null) {
            ...
            if (f11 <= 0.0f || (i10 = this.h) >= this.f - 1) {
                ...
                if (childAt instanceof gd0) {
                    ...
                    gd0Var.setTextColor(gd0Var.a.c(AndroidUtilities.lerp(0.6f, 0.8f, 1.0f - this.n)));
                }
                if (childAt2 instanceof gd0) {
                    gd0 gd0Var2 = (gd0) childAt2;
                    gd0Var2.setTextColor(gd0Var2.a.c(AndroidUtilities.lerp(0.6f, 0.8f, this.n)));
                }
            }
            if (this.y != 0) {
