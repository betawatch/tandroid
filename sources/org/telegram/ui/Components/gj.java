...
public final /* synthetic */ class gj implements Runnable {
    ...
    public /* synthetic */ gj(org.telegram.ui.i6 i6Var, rh.d1 d1Var, int i10, org.telegram.ui.Cells.j9 j9Var, rh.g0 g0Var, int i11) {
        this.e = i6Var;
        this.f = d1Var;
        this.b = i10;
        this.c = j9Var;
    ...
    public final void run() {
        ...
        switch (i12) {
                ...
                if (lowerCase.length() != 0) {
                    ...
                    while (i15 < arrayList2.size()) {
                        ...
                        while (i17 < i14) {
                            ...
                            if ((str == null || !(str.startsWith(str4) || org.telegram.messenger.y1.x(" ", str4, str))) && (str2 == null || !(str2.startsWith(str4) || org.telegram.messenger.y1.x(" ", str4, str2)))) {
                                str3 = str;
                                TLRPC.User user2 = contact.user;
                                r12 = (user2 == null || (publicUsername = UserObject.getPublicUsername(user2)) == null || !publicUsername.startsWith(str4)) ? (lowerCase2.startsWith(str4) || org.telegram.messenger.y1.x(" ", str4, lowerCase2) || (translitString2 != null && (translitString2.startsWith(str4) || org.telegram.messenger.y1.x(" ", str4, translitString2)))) ? 3 : z10 : 2;
                            } else {
                                str3 = str;
                                r12 = 1;
                            }
                    ...
                    while (i20 < arrayList3.size()) {
                        ...
                        if (longSparseIntArray.indexOfKey(tL_contact.user_id) < 0) {
                            ...
                            while (i21 < i14) {
                                ...
                                if (lowerCase3.startsWith(str6) || org.telegram.messenger.y1.x(" ", str6, lowerCase3) || (translitString3 != null && (translitString3.startsWith(str6) || org.telegram.messenger.y1.x(" ", str6, translitString3)))) {
                                    i10 = i20;
                                    c10 = 1;
                                } else {
                                    i10 = i20;
                    ...
                    AndroidUtilities.runOnUIThread(new ag.k0(hjVar4, this.d, arrayList4, arrayList5, 14));
                    break;
                } else {
                    hjVar.h = -1;
            ...
            case 1:
                ...
                PhotoViewer.t1().f2(arrayList6, this.d, giVar.D ? 13 : i11, false, chatAttachAlertPhotoLayout.d1, giVar.D ? null : rnVar);
            ...
            default:
                ...
                rh.h0 h0Var = (rh.h0) ((org.telegram.ui.i6) obj4).c;
    ...
    public /* synthetic */ gj(hj hjVar, String str, ArrayList arrayList, ArrayList arrayList2, int i10, int i11) {
        this.e = hjVar;
        this.f = str;
        this.c = arrayList;
        this.h = arrayList2;
    ...
    public /* synthetic */ gj(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout, int i10, org.telegram.ui.ActionBar.n2 n2Var, ArrayList arrayList, int i11, org.telegram.ui.rn rnVar) {
