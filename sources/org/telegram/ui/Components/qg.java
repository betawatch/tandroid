...
public final class qg extends FrameLayout {
    ...
    public qg(ChatActivityEnterView chatActivityEnterView, Context context) {
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.be), PorterDuff.Mode.MULTIPLY));
        this.c = org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.qf));
    ...
    public final void a() {
        ci.f4 f4Var = this.a;
        if (f4Var != null) {
            f4Var.l0 = new og(this, f4Var, 1);
            f4Var.e(true);
            this.a = null;
        }
        ci.f4 f4Var2 = this.b;
        if (f4Var2 != null) {
            f4Var2.l0 = new og(this, f4Var2, 2);
            f4Var2.e(true);
            this.b = null;
        }
    }
    ...
    public final void b() {
        ...
        ci.f4 f4Var2 = this.b;
        f4Var2.h = ci.f4.a(f4Var2.getText(), this.b.getTextPaint());
        ...
        ci.f4 f4Var4 = this.b;
        f4Var4.l0 = new og(this, f4Var4, 0);
        f4Var4.u();
    }
    ...
    public final void c() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.V;
        this.y.e(chatActivityEnterView.j0(i10), chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.cf), -1);
        this.n.setColor(chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.pf));
        int dp = AndroidUtilities.dp(5.0f);
        int i11 = org.telegram.ui.ActionBar.j6.qf;
        this.c = org.telegram.ui.ActionBar.j6.b0(dp, chatActivityEnterView.j0(i11));
        int j02 = chatActivityEnterView.j0(i11);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.d.setColorFilter(new PorterDuffColorFilter(j02, mode));
        this.r.setColor(chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.ae));
        this.s.setColor(chatActivityEnterView.j0(this.Q ? org.telegram.ui.ActionBar.j6.Wk : org.telegram.ui.ActionBar.j6.Zd));
        this.v.setColor(chatActivityEnterView.j0(this.Q ? org.telegram.ui.ActionBar.j6.Wk : org.telegram.ui.ActionBar.j6.Zd));
        this.E.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.j0(this.Q ? org.telegram.ui.ActionBar.j6.Wk : org.telegram.ui.ActionBar.j6.Zd), mode));
        this.F.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.j0(this.Q ? org.telegram.ui.ActionBar.j6.Wk : org.telegram.ui.ActionBar.j6.Zd), mode));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:143:0x0351, code lost:
        ...
        r3 = org.telegram.ui.Components.qr.j;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x01ce, code lost:
        ...
        r46.restore();
        r46.save();
        r4.setBounds(r7 - (r4.getIntrinsicWidth() / 2), (int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14)), org.telegram.messenger.wl.B(2, r7, r4), r4.getIntrinsicHeight() + ((int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14))));
        r4.draw(r46);
        r46.restore();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x0324, code lost:
        ...
        r5 = org.telegram.ui.Components.qr.j;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.T && rectF2.contains(x10, y3)) {
                ...
                mediaDataController.toggleDraftVoiceOnce(j3, (boVar == null || !boVar.h4) ? 0L : boVar.d(), chatActivityEnterView.O);
                if (chatActivityEnterView.O) {
                    b();
                } else {
                    a();
