...
public abstract class z20 extends org.telegram.ui.ActionBar.e3 {
    ...
    public z20(Context context, TLRPC.Chat chat, boolean z10) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            int k10 = i0.b.k(org.telegram.ui.ActionBar.g6.w0(null, i11, false), 76);
            w20Var.setForeground(org.telegram.ui.ActionBar.g6.i0(dp, dp, dp, dp, 0, k10, k10));
        }
        ...
        while (true) {
            ...
            this.d.addView(this.e[i12], h7.z5.n(-2, -1));
            if (i12 == 0) {
            ...
            this.e[i12].setOnClickListener(new hh.z0(this, i12, 8));
            i12++;
        }
        if (z10) {
    ...
    public static void m(z20 z20Var) {
        ...
        if (textView2 != null) {
            measuredWidth2 -= (((textView2.getMeasuredWidth() / 2) + textView2.getLeft()) - measuredWidth) * z20Var.f;
        }
