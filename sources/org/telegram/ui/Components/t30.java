...
public final class t30 extends q61 {
    ...
    public static /* synthetic */ int M(t30 t30Var, int i10, TLObject tLObject, TLObject tLObject2) {
    ...
    public static /* synthetic */ void N(t30 t30Var, TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_channels_getParticipants tL_channels_getParticipants) {
        int h;
        a0.h hVar;
        ArrayList arrayList;
        a0.h hVar2;
        ...
        if (tL_error == null) {
            ...
            while (i12 < size2) {
                ...
                boolean z4 = hVar4.f(peerId) != null || ((hVar2 = t30Var.b0) != null && hVar2.h(peerId) >= 0);
        ...
        t30Var.U();
        rl0 rl0Var2 = t30Var.f;
        if (rl0Var2 != null) {
            rl0Var2.l();
            if (zw0Var != null && t30Var.f.h() == 0 && t30Var.a0) {
                zw0Var.e(false, true);
            }
        }
    }
    ...
    public final void D(MotionEvent motionEvent, kg.f fVar) {
        org.telegram.ui.c60 c60Var = this.d0.a;
        if (c60Var.t0) {
            return;
        }
