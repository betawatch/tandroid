    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                httpURLConnection.setRequestProperty("User-Agent", b31.N[(int) Math.round(Math.random() * 5)]);
                httpURLConnection.setRequestProperty("Content-Type", "application/json");
                StringBuilder sb2 = new StringBuilder();
                BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream(), o8.d.c));
                while (true) {
                    try {
                ...
                AndroidUtilities.runOnUIThread(new lg0(23, callback2, str3));
            } catch (Exception e9) {
                e = e9;
                try {
