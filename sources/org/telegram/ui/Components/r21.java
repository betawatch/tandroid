...
public final class r21 extends FrameLayout {
    ...
    public r21(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.r = new e6(this, 360L, rr.h);
        this.s = false;
        this.x = false;
        this.y = false;
    ...
    public final void g(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        int i10 = this.a;
        if (h5Var == null) {
            org.telegram.ui.h5 h5Var2 = new org.telegram.ui.h5(d90Var, 18.0f, i10);
            this.E = h5Var2;
            h5Var2.v = false;
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        ...
        if (userOrChat != null) {
            ...
            h9 h9Var = h5Var3.c;
            h9Var.j(h5Var3.e, userOrChat);
            h5Var3.b.setForUserOrChat(userOrChat, h9Var);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (f7 > 0.0f) {
            ...
            n4Var.layout(AndroidUtilities.dp(4.66f) + d90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), i16 - (n4Var.getMeasuredHeight() / 2), n4Var.getMeasuredWidth() + AndroidUtilities.dp(4.66f) + d90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), (n4Var.getMeasuredHeight() / 2) + i16);
        }
