...
public final class r21 extends FrameLayout {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (f10 > 0.0f) {
            ...
            a3Var.layout(AndroidUtilities.dp(4.66f) + e90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), i16 - (a3Var.getMeasuredHeight() / 2), a3Var.getMeasuredWidth() + AndroidUtilities.dp(4.66f) + e90Var.getMeasuredWidth() + AndroidUtilities.dp(11.0f), (a3Var.getMeasuredHeight() / 2) + i16);
        }
