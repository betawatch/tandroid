...
public final class dd extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        switch (this.a) {
            case 0:
                ed edVar = (ed) this.c;
                if (edVar.c <= 1) {
                    edVar.c(canvas, (Paint) this.b);
                    break;
                } else {
                    edVar.c(canvas, edVar.o);
                    break;
                }
            case 1:
    ...
    public void onBoundsChange(Rect rect) {
        switch (this.a) {
            case 4:
                ((ImageReceiver) this.b).setImageCoords(AndroidUtilities.dp(2.0f) + rect.left, AndroidUtilities.dp(2.0f) + rect.top, org.telegram.messenger.em.v(2.0f, rect.left, rect.right - AndroidUtilities.dp(2.0f)), org.telegram.messenger.em.v(2.0f, rect.top, rect.bottom - AndroidUtilities.dp(2.0f)));
                break;
            default:
