...
public final class e9 extends org.telegram.ui.ActionBar.n2 {
    ...
    public e9(u40 u40Var, s40 s40Var) {
        super(null);
        this.O = new Paint();
        this.Q = true;
        this.Z = false;
    ...
    public final View createView(Context context) {
        ...
        this.r = new bc1(this, getParentActivity(), 5);
        w8 w8Var = new w8(this, context);
        w8Var.setFitsSystemWindows(true);
        w8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.a7, false));
        ...
        this.J = b9Var;
        v7Var.addView(b9Var);
        this.r.addView(v7Var, w7.y5.t(-1, 48, 0, 12, 0, 12, 0));
    ...
    public final boolean e0() {
        ...
        x8 x8Var = this.a;
        a9 a9Var = x8Var.h;
        return (a9Var != null && a9Var.b) || x8Var.n;
    }
    ...
    */
    public final void f0() {
        ...
        if (b3Var != null) {
            ...
            o20 o20Var = new o20();
            if (a9Var != null) {
                o20Var.d(a9Var.c, a9Var.d, a9Var.e, a9Var.f);
            } else {
                int[] iArr = c0[0];
            ...
            try {
                ...
                int i13 = (int) 560.0f;
                imageReceiver = x8Var.getImageReceiver();
                ...
                if (x8Var.getImageReceiver().getAnimation() == null) {
                }
                ...
                videoEditedInfo2.endTime = x8Var.getDuration();
            ...
            if (x8Var.getImageReceiver().getAnimation() == null || x8Var.getImageReceiver().getLottieAnimation() != null) {
                ...
                if (x8Var.a == 0) {
                    ...
                    tL_videoSizeEmojiMarkup.emoji_id = x8Var.a;
                    tL_videoSizeEmojiMarkup.background_colors.add(Integer.valueOf(x8Var.h.c));
                    int i14 = x8Var.h.d;
                    if (i14 != 0) {
                    ...
                    TLRPC.Document document3 = x8Var.b;
                    ...
                    tL_videoSizeStickerMarkup.background_colors.add(Integer.valueOf(x8Var.h.c));
                    int i17 = x8Var.h.d;
                    if (i17 != 0) {
                ...
                videoEditedInfo22.endTime = x8Var.getDuration();
    ...
    public final void h0(boolean z10, long j3, TLRPC.Document document) {
        ...
        if (j3 == 0) {
            ...
            z5Var.setAnimatedEmojiDrawable(new q5(14, this.currentAccount, j3));
    ...
    */
    public final boolean isLightStatusBar() {
        boolean z10;
        x8 x8Var = this.a;
        if (x8Var != null && (x8Var.v || (x8Var.w >= 0.0f && x8Var.h != null))) {
            a9 a9Var = x8Var.h;
            int i10 = a9Var.c;
            int i11 = a9Var.d;
            if (i11 != 0) {
        ...
        if (this.Z != z10) {
            ...
            if (this.actionBar.getAlpha() == 0.0f) {
                ...
                this.b0 = ofFloat;
                ofFloat.addUpdateListener(new k6(this, 3));
                this.b0.setDuration(150L).start();
            }
        }
        s8 s8Var = this.S;
        if (s8Var != null) {
            AndroidUtilities.setLightStatusBar(s8Var, z10);
        }
        return z10;
    }
    ...
    public final void l0(TLRPC.VideoSize videoSize) {
        a9 a9Var = new a9();
        a9Var.c = i0.a.k(videoSize.background_colors.get(0).intValue(), 255);
        a9Var.d = videoSize.background_colors.size() > 1 ? i0.a.k(videoSize.background_colors.get(1).intValue(), 255) : 0;
        a9Var.e = videoSize.background_colors.size() > 2 ? i0.a.k(videoSize.background_colors.get(2).intValue(), 255) : 0;
        a9Var.f = videoSize.background_colors.size() > 3 ? i0.a.k(videoSize.background_colors.get(3).intValue(), 255) : 0;
        this.a.b(a9Var, false);
        n0();
