    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new po0(15, callback2, str3));
            } catch (Exception e) {
                e = e;
                try {
                ...
                if (httpURLConnection != null) {
                    try {
                        ...
                        AndroidUtilities.runOnUIThread(new xq0(callback2, 21));
                        return;
                    }
                }
                AndroidUtilities.runOnUIThread(new es0(3, callback2, z10));
            }
        } catch (Exception e10) {
            e = e10;
