...
public abstract class a41 extends FrameLayout implements org.telegram.ui.ActionBar.x5 {
    ...
    public a41(Context context, org.telegram.ui.ActionBar.c6 c6Var, org.telegram.ui.tn tnVar) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.x31
            ...
            public final void onClick(View view) {
                ...
                if (!isPremium && (chat == null || !chat.autotranslation)) {
                    org.telegram.ui.tn tnVar2 = qkVar2.s;
                    i10 = ((org.telegram.ui.ActionBar.o2) tnVar2).currentAccount;
                    MessagesController.getNotificationsSettings(i10).edit().putInt("dialog_show_translate_count" + tnVar2.a(), 140).commit();
                    tnVar2.Qc(true);
                    return;
                }
                int i12 = qkVar2.a;
                ...
                z31 z31Var = new z31(qkVar2.getContext());
                z31Var.b = new d6(z31Var, 350L, jr.h);
                LinearLayout linearLayout2 = new LinearLayout(qkVar2.getContext());
                z31Var.addView(linearLayout2);
                ...
                y80Var.setBackground(org.telegram.ui.ActionBar.g6.Y(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.i6, c6Var2), 0, 12));
    ...
    public static void a(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        y80Var.setTextColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.y6, c6Var));
    ...
    public final void b() {
        ...
        if (isTranslatingDialog) {
            ...
            r3Var.setText(TextUtils.concat(spannableString, " ", zArr[0] ? LocaleController.formatString(R.string.TranslateToButton, D2) : LocaleController.formatString(R.string.TranslateToButtonOther, D2)));
        }
    ...
    public void setLeftMargin(float f9) {
        this.e.setTranslationX(f9 / 2.0f);
    }
}
