...
public final class ef0 extends View {
    ...
    public final void c(int i9, int i10, boolean z10) {
        ...
        if (!z10) {
            ...
            this.b = i10;
            invalidate();
        } else if (this.b == i10 && (Math.abs(i11 - i9) <= 2 || this.h || this.n)) {
            b(i9);
        } else {
            ...
            int i12 = dp * 2;
            this.v = (getMeasuredHeight() - i12) / Math.min(this.b, 3);
            this.w = (getMeasuredHeight() - i12) / Math.min(i10, 3);
            float f10 = (this.a - 1) * this.v;
            this.r = f10;
            if (f10 < 0.0f) {
                this.r = 0.0f;
            } else {
                float e10 = e2.c.e(this.b, 1, r4, dp) - f10;
                int measuredHeight = getMeasuredHeight() - dp;
                int i13 = this.v;
                if (e10 < measuredHeight - i13) {
                    this.r = e2.c.e(this.b, 1, i13, dp) - ((getMeasuredHeight() - dp) - this.v);
                }
            }
            float f11 = (i9 - 1) * this.w;
            this.s = f11;
            if (f11 < 0.0f) {
                this.s = 0.0f;
            } else {
                int i14 = i10 - 1;
                float f12 = ((r4 * i14) + dp) - f11;
                int measuredHeight2 = getMeasuredHeight() - dp;
                int i15 = this.w;
                if (f12 < measuredHeight2 - i15) {
                    this.s = ((i14 * i15) + dp) - ((getMeasuredHeight() - dp) - this.w);
                }
            }
            this.d = this.a;
            this.c = i9;
    ...
    public final void d() {
        int v02 = org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.ee, this.H);
        this.G = v02;
