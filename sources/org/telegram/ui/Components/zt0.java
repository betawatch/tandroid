    ...
    public zt0(org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        if (n2Var instanceof ng) {
            ...
            if (a2 != n2Var.getUserConfig().getClientUserId()) {
                n2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a2, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.yt0
                    ...
                    public final void run(Object obj) {
                        ...
                        switch (i11) {
                            case 0:
                                zt0 zt0Var = this.b;
                                ArrayList arrayList = zt0Var.x;
                                boolean booleanValue = bool.booleanValue();
                                zt0Var.f = booleanValue;
                                zt0Var.h = true;
                                if (booleanValue) {
                            ...
                            default:
                                zt0 zt0Var2 = this.b;
                                ArrayList arrayList2 = zt0Var2.x;
                                boolean booleanValue2 = bool.booleanValue();
                                zt0Var2.f = booleanValue2;
                                zt0Var2.h = true;
                                if (booleanValue2) {
            ...
            if (profileActivity.d1) {
                ...
                if (a3 != n2Var.getUserConfig().getClientUserId()) {
                    n2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a3, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.yt0
                        public final /* synthetic */ zt0 b;
                ...
                for (int i24 = 0; i24 < arrayList.size(); i24++) {
                    ...
                    if (!messageObject.isEphemeral()) {
                        ...
                        if ((j12 == 0 || j12 == MessageObject.getTopicId(currentAccount, messageObject.messageOwner, true)) && MessageObject.getMedia(messageObject.messageOwner) != null && !messageObject.needDrawBluredPreview() && (mediaType = MediaDataController.getMediaType(messageObject.messageOwner)) != -1 && ((mediaType != 0 || this.n[0].q != 2 || messageObject.isVideo()) && (mediaType != 0 || this.n[0].q != 1 || !messageObject.isVideo()))) {
                            wt0 wt0Var = this.n[mediaType];
                            if (wt0Var.l) {
                                wt0Var.a(messageObject, i23, true, isEncryptedDialog);
                            }
                            if (this.s == 0) {
                            ...
                            if (i23 == 0) {
                                for (int i25 = 0; i25 < this.n[mediaType].e.size(); i25++) {
                                    ((et0) this.n[mediaType].e.get(i25)).b++;
                                }
                            }
                        }
                    }
        ...
        if (i10 != NotificationCenter.messageReceivedByServer) {
                ...
                for (int i28 = 0; i28 < size3; i28++) {
                    ...
                    while (true) {
                        ...
                        if (i29 < wt0VarArr.length) {
                            MessageObject b10 = wt0VarArr[i29].b(((Integer) arrayList3.get(i28)).intValue(), 0);
                            if (b10 != null) {
            ...
            if (i10 != NotificationCenter.replaceMessagesObjects) {
                ...
                if (i10 == NotificationCenter.fileLoaded) {
                    ...
                    int i34 = 0;
                    while (true) {
                        wt0[] wt0VarArr2 = this.n;
                        if (i34 >= wt0VarArr2.length) {
                            break;
                        }
                        arrayList4.addAll(wt0VarArr2[i34].a);
                        i34++;
                    }
            ...
            if (longValue8 == j14 || longValue8 == this.v) {
                ...
                while (i37 < size6) {
                    ...
                    if (j15 == 0 || topicId == j15) {
                        int i38 = 0;
                        while (true) {
                            wt0[] wt0VarArr3 = this.n;
                            if (i38 >= wt0VarArr3.length) {
                                break;
                            }
                            MessageObject messageObject3 = (MessageObject) wt0VarArr3[i38].b[i36].get(id2);
