...
public class Switch extends View {
    ...
    public Switch(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.a = new le.b(0, new hi.y1(this, 23), wr.h, 380L, true);
        this.v = 1.0f;
    ...
    */
                ...
                if (i16 == 0) {
                    if (this.F != null) {
                        ...
                        if (f14 > 0.0f) {
                            ...
                            drawable2.setBounds(org.telegram.messenger.em.w(2, dp2, drawable2), org.telegram.messenger.em.e(2, measuredHeight2, this.F), org.telegram.messenger.em.B(2, dp2, this.F), org.telegram.messenger.em.z(2, measuredHeight2, this.F));
                            this.F.draw(canvas4);
                            if (z10) {
                                canvas.restore();
                            }
    ...
    public void setDrawRipple(boolean z10) {
        ...
        if (this.I == null) {
            ...
            this.J = paint;
            paint.setColor(-1);
            org.telegram.ui.Cells.z zVar = new org.telegram.ui.Cells.z(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{0}), null, i10 >= 23 ? null : new bi.w4(this, 5));
            this.I = zVar;
            if (i10 >= 23) {
