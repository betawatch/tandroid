...
public class Switch extends View {
    ...
    public Switch(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        super(context);
        this.a = new vd.a(0, new sf.f1(this, 13), jr.h, 380L, true);
        this.v = 1.0f;
    ...
    public final void b(int i10, boolean z10, boolean z11) {
        ...
        if (this.s != i10) {
            ...
            if (this.f && z11) {
                ...
                this.e.addListener(new my0(this, 1));
                this.e.start();
                return;
            }
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i13 == 1 && this.T == 0) {
                ...
                if (i14 != 1) {
                    ...
                    int a10 = a(org.telegram.ui.ActionBar.g6.v0(this.x, c6Var));
                    if (i13 == 0 && (drawable = this.B) != null) {
                        if (this.C != (this.h ? a10 : a2)) {
        ...
        while (i16 < 2) {
            if (i16 == 1 && this.T == 0) {
                ...
                int a11 = a(org.telegram.ui.ActionBar.g6.v0(this.A, c6Var));
                ...
                if (i16 == 0) {
                    if (this.B != null) {
                        ...
                        if (f14 > 0.0f) {
                            ...
                            drawable2.setBounds(org.telegram.ui.b.v(2, dp2, drawable2), org.telegram.ui.b.f(2, measuredHeight2, this.B), org.telegram.ui.b.A(2, dp2, this.B), org.telegram.ui.b.y(2, measuredHeight2, this.B));
                            this.B.draw(canvas4);
                            if (z10) {
                                canvas.restore();
                            }
    ...
    public void setDrawRipple(boolean z10) {
        ...
        if (this.E == null) {
            ...
            this.F = paint;
            paint.setColor(-1);
            org.telegram.ui.Cells.z zVar = new org.telegram.ui.Cells.z(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{0}), null, i10 >= 23 ? null : new bg.m1(this, 6));
            this.E = zVar;
            if (i10 >= 23) {
