...
public abstract class b20 extends org.telegram.ui.ActionBar.e3 {
    public b20(Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ...
            linearLayout2.addView(g10, h7.z5.t(-2, -2, LocaleController.isRTL ? 5 : 3, 0, 8, 0, 0));
            ...
            if (LocaleController.isRTL) {
                g10.addView(textView2, h7.z5.n(-2, -2));
                g10.addView(imageView, h7.z5.k(8.0f, 7.0f, 0.0f, 0.0f, -2, -2));
            } else {
                g10.addView(imageView, h7.z5.k(0.0f, 8.0f, 8.0f, 0.0f, -2, -2));
                g10.addView(textView2, h7.z5.n(-2, -2));
            }
        }
