                    ...
                    if (d5Var != null) {
                        ...
                        if (n2Var != null && (themeDescriptions = n2Var.getThemeDescriptions()) != null) {
                            ...
                            if (themeEditorView.b != null) {
                                ...
                                try {
                                    animatorSet.playTogether(ObjectAnimator.ofFloat(themeEditorView.a, (Property<n11, Float>) property, 1.0f, 0.0f), ObjectAnimator.ofFloat(themeEditorView.a, (Property<n11, Float>) View.SCALE_X, 1.0f, 0.0f), ObjectAnimator.ofFloat(themeEditorView.a, (Property<n11, Float>) View.SCALE_Y, 1.0f, 0.0f));
                                    animatorSet.setInterpolator(themeEditorView.i);
                                    animatorSet.setDuration(150L);
                                    animatorSet.addListener(new p11(themeEditorView, 0));
                                    animatorSet.start();
                                    ...
                                    if (motionEvent.getAction() == 2) {
                                        ...
                                        if (i17 < 0) {
                                            ...
                                            if (i17 > AndroidUtilities.displaySize.x - layoutParams.width) {
                                                f7 = org.telegram.messenger.wh.b((i17 - r9) + r8, i14, 0.5f, 1.0f);
                                            }
                                        }
                                        ...
                                        if (Math.abs(b10 - themeEditorView.g.x) <= dp || ((i10 = themeEditorView.g.x) < 0 && i10 > (-i11) / 4)) {
                                            ...
                                            if (themeEditorView.a.getAlpha() != 1.0f) {
                                                arrayList.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<n11, Float>) property, 1.0f));
                                            }
                                            ...
                                            if (Math.abs(b11 - i10) > dp) {
                                                ...
                                                if (i21 <= i22 - i11 || i21 >= i22 - ((i11 / 4) * 3)) {
                                                    ...
                                                    if (arrayList != null) {
                                                        ...
                                                        if (z10) {
                                                            z11 = true;
                                                            arrayList.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<n11, Float>) property, 0.0f));
                                                            animatorSet2.addListener(new p11(themeEditorView, 1 == true ? 1 : 0));
                                                        } else {
                                                            z11 = true;
                                                        }
                                            ...
                                            edit.putInt("sidex", 1);
                                            if (themeEditorView.a.getAlpha() != 1.0f) {
                                                arrayList2.add(ObjectAnimator.ofFloat(themeEditorView.a, (Property<n11, Float>) property, 1.0f));
                                            }
