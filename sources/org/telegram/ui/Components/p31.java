...
public abstract class p31 extends FrameLayout implements org.telegram.ui.ActionBar.w5 {
    ...
    public p31(Context context, org.telegram.ui.ActionBar.b6 b6Var, org.telegram.ui.qn qnVar) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.m31
            ...
            public final void onClick(View view) {
                ...
                if (!isPremium && (chat == null || !chat.autotranslation)) {
                    org.telegram.ui.qn qnVar2 = nkVar2.s;
                    i9 = ((org.telegram.ui.ActionBar.o2) qnVar2).currentAccount;
                    MessagesController.getNotificationsSettings(i9).edit().putInt("dialog_show_translate_count" + qnVar2.a(), 140).commit();
                    qnVar2.Qc(true);
                    return;
                }
                int i11 = nkVar2.a;
                ...
                o31 o31Var = new o31(nkVar2.getContext());
                o31Var.b = new y5(o31Var, 350L, gr.h);
                LinearLayout linearLayout2 = new LinearLayout(nkVar2.getContext());
                o31Var.addView(linearLayout2);
                ...
                l80Var.setLinkTextColor(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.gc, b6Var2));
                ...
                l80Var.setBackground(org.telegram.ui.ActionBar.f6.Y(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.i6, b6Var2), 0, 12));
    ...
    public static void a(Context context, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        l80Var.setTextColor(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.y6, b6Var));
    ...
    public final void b() {
        int i9 = this.a;
        TranslateController translateController = MessagesController.getInstance(i9).getTranslateController();
        ...
        if (isTranslatingDialog) {
            ...
            u3Var.setText(TextUtils.concat(spannableString, " ", zArr[0] ? LocaleController.formatString(R.string.TranslateToButton, D2) : LocaleController.formatString(R.string.TranslateToButtonOther, D2)));
        }
        this.n.setImageResource((UserConfig.getInstance(i9).isPremium() || (chat != null && chat.autotranslation)) ? R.drawable.msg_mini_customize : R.drawable.msg_close);
    }
    ...
    public final void d() {
        ...
        u3Var.setBackground(org.telegram.ui.ActionBar.f6.W(dp, v03, dp2, dp2, dp2, dp2));
        org.telegram.ui.Cells.z M = org.telegram.ui.ActionBar.f6.M(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.i6, b6Var), 0, 0);
        ImageView imageView = this.n;
        imageView.setBackground(M);
        int v04 = org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.de, b6Var);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        imageView.setColorFilter(new PorterDuffColorFilter(v04, mode));
        this.f.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.f6.v0(i9, b6Var), mode));
    }
