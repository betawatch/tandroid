...
public class lx0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public boolean E;
    public int F;
    public int G;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            ViewPropertyAnimator translationY = dc1Var.animate().translationY(dp);
            qr qrVar = qr.f;
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (this.J != z11) {
            ...
            if (z10) {
                ...
                this.H.addUpdateListener(new s70(this, 24));
                this.H.start();
            } else {
        ...
        if (visibility != i10 && i10 == 0) {
            if (this.h) {
                ...
                if (view != null) {
                    view.animate().setListener(null).cancel();
                    view.animate().setListener(new kx0(this, 0)).alpha(0.0f).setDuration(150L).start();
                } else {
        ...
        if (view != null) {
            view.animate().setListener(null).cancel();
            view.animate().setListener(new kx0(this, 1)).alpha(0.0f).setDuration(150L).start();
        } else {
    ...
    public void e(boolean z10, boolean z11) {
        if (this.h != z10) {
            ...
            if (z11) {
                ...
                if (view != null) {
                    view.animate().setListener(null).cancel();
                    view.animate().setListener(new kx0(this, 2)).alpha(0.0f).setDuration(150L).start();
                } else {
                    radialProgressView.animate().alpha(0.0f).scaleY(0.5f).scaleX(0.5f).setDuration(150L).start();
                }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            ...
            if (!this.x) {
                dc1Var.animate().translationY(0.0f).setInterpolator(qr.f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.c;
            if (radialProgressView != null) {
    ...
    public lx0(Context context, View view, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.w = UserConfig.selectedAccount;
        this.y = new org.telegram.ui.Cells.u6(this, 25);
        ...
        dc1Var.addView(nVar, w7.y5.t(-2, -2, 1, 0, 12, 0, 0));
        dc1Var.addView(n90Var, w7.y5.t(-2, -2, 1, 0, 8, 0, 0));
