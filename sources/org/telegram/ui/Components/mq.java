...
public class mq extends ReplacementSpan {
    ...
    */
                        ...
                        if (this.usePaintColor) {
                            ...
                            if (i15 != 1) {
                                if (i15 == 2) {
                                    ...
                                    i17 = kh.a2.d(i18, i19, 2, i12) + AndroidUtilities.dp(this.topOffset);
                                }
                            }
    ...
    public mq(int i10, Drawable drawable) {
        this.draw = true;
