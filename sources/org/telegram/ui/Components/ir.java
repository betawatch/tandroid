...
public final class ir extends ViewGroup {
    ...
    public ir(Context context) {
        ...
        while (i11 < 11) {
            if (i11 != 9) {
                ...
                this.c[i11] = new hr(context, valueOf, str);
                this.c[i11].setOnClickListener(new q2(15, this, valueOf));
                addView(this.c[i11]);
            }
            i11++;
        }
    ...
    public static org.telegram.ui.Cells.z a(int i10) {
        ...
        int k10 = i0.b.k(org.telegram.ui.ActionBar.g6.w0(null, i12, false), 30);
        float f10 = 12.0f;
        ...
        return org.telegram.ui.ActionBar.g6.i0(dp, dp2, dp3, AndroidUtilities.dp(f10), w02, k10, k10);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int x8 = org.telegram.messenger.rl.x(32.0f, getWidth(), 3);
        int x10 = org.telegram.messenger.rl.x(42.0f, getHeight(), 4);
        int i14 = 0;
        while (true) {
            View[] viewArr = this.c;
            ...
            int dp = AndroidUtilities.dp(6.0f) + x8;
            ...
            if (view != null) {
                view.layout(dp2, dp4, dp2 + x8, dp4 + x10);
            }
            i14++;
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (View view : this.c) {
            if (view != null) {
                view.measure(View.MeasureSpec.makeMeasureSpec(x8, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(x10, TLObject.FLAG_30));
            }
        }
    }
