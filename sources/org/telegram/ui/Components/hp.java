...
public final class hp implements ResultCallback {
    ...
    public final void onComplete(Object obj) {
        ...
        List<org.telegram.ui.ActionBar.f4> emojiThemes = chatThemeController.getEmojiThemes((chatThemeController.isGiftThemesFullyLoaded() ? 2 : 0) | 5);
        mp mpVar = this.b;
        i10 = ((org.telegram.ui.ActionBar.h3) mpVar).currentAccount;
        NotificationCenter.getInstance(i10).doOnIdle(new eo(2, this, emojiThemes));
        mpVar.Y = false;
    }
