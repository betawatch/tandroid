...
public class hp extends Drawable {
    ...
    public final void setBounds(int i10, int i11, int i12, int i13) {
        ...
        float f14 = i11;
        float f15 = i13 - i11;
        this.g.set(com.google.android.recaptcha.internal.a.A(f11 - (f12 / 2.0f), f13, 2.0f, f10), (((f15 - (f12 / 2.0f)) - f13) / 2.0f) + f14, ((((f12 / 2.0f) + f11) + f13) / 2.0f) + f10, ((((f12 / 2.0f) + f15) + f13) / 2.0f) + f14);
