...
public final class oa {
    ...
    public final void a(float[] fArr, int i10, int i11, int i12) {
        ...
        GLES20.glEnableVertexAttribArray(jaVar.c);
        GLES20.glVertexAttribPointer(jaVar.c, 2, 5126, false, 8, (Buffer) this.g);
        GLES20.glEnableVertexAttribArray(jaVar.b);
        GLES20.glVertexAttribPointer(jaVar.b, 2, 5126, false, 8, (Buffer) this.e);
        GLES20.glUniform2f(jaVar.f, this.a, this.b);
        float f7 = i11;
        float f10 = i12;
        GLES20.glUniform2f(jaVar.g, f7, f10);
        GLES20.glUniform1i(jaVar.j, 0);
        GLES20.glUniform1f(jaVar.k, c10 != 0 ? 1.0f : 0.0f);
        if (c10 != 0) {
            GLES20.glUniformMatrix4fv(jaVar.l, 1, false, fArr, 0);
        }
        GLES20.glUniform1f(jaVar.m, c10 == 0 ? 0.0f : 1.0f);
        og.i1.a(jaVar.h, this.l);
        og.i1.a(jaVar.i, this.m);
        synchronized (this.k) {
        ...
        GLES20.glClear(16384);
        GLES20.glEnableVertexAttribArray(jaVar.b);
        GLES20.glVertexAttribPointer(jaVar.b, 2, 5126, false, 8, (Buffer) this.f);
        GLES20.glUniform1i(jaVar.j, 2);
        GLES20.glUniform1i(jaVar.e, 0);
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, this.s[1]);
        ia iaVar = this.t;
        Object obj = iaVar != null ? iaVar.h : null;
        if (obj != null) {
            synchronized (obj) {
                GLES20.glDrawArrays(5, 0, 4);
            }
    ...
    public final boolean b(float f7, int i10) {
        ...
        if (readRes != null && readRes2 != null) {
            ...
            while (true) {
                ...
                ja jaVar = new ja();
                jaVar.a = glCreateProgram;
                jaVar.b = GLES20.glGetAttribLocation(glCreateProgram, "p");
                jaVar.c = GLES20.glGetAttribLocation(glCreateProgram, "inputuv");
                jaVar.d = GLES20.glGetUniformLocation(glCreateProgram, "matrix");
                jaVar.e = GLES20.glGetUniformLocation(glCreateProgram, "tex");
                jaVar.f = GLES20.glGetUniformLocation(glCreateProgram, "sz");
                jaVar.g = GLES20.glGetUniformLocation(glCreateProgram, "texSz");
                jaVar.h = GLES20.glGetUniformLocation(glCreateProgram, "gtop");
                jaVar.i = GLES20.glGetUniformLocation(glCreateProgram, "gbottom");
                jaVar.j = GLES20.glGetUniformLocation(glCreateProgram, "step");
                jaVar.l = GLES20.glGetUniformLocation(glCreateProgram, "videoMatrix");
                jaVar.m = GLES20.glGetUniformLocation(glCreateProgram, "hasVideoMatrix");
                jaVar.k = GLES20.glGetUniformLocation(glCreateProgram, "flipy");
                this.d[i14] = jaVar;
                i14++;
            }
        }
