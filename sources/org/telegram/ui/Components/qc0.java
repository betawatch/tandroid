...
public final class qc0 {
    ...
    public int g;
    public int h;
    public final aa.a a = new aa.a(new j2(18));
    ...
    public final Paint e(Bitmap bitmap, Bitmap bitmap2, int i10, int i11, int i12, boolean z10) {
        ...
        if (i12 >= 0) {
            ...
            i10Var.a = 2;
            paint.setShader(new ComposeShader((yf.i) gtVar.b, new ComposeShader(new ComposeShader(pc0Var2.d, pc0Var3.d, PorterDuff.Mode.DST_IN), (yf.i) gtVar2.b, PorterDuff.Mode.MULTIPLY), PorterDuff.Mode.SRC_OVER));
            return paint;
        }
        return paint;
    }
