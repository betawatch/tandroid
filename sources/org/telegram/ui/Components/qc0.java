...
public class qc0 extends LinearLayout {
    public static final jr r0 = new jr(0.0f, 0.5f, 0.5f, 1.0f);
    public int A;
    public boolean B;
    public int C;
    public int D;
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.A) {
            ...
            if (strArr != null) {
                ...
                mc0 mc0Var = this.G;
                str = mc0Var != null ? mc0Var.e(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.C;
                    mc0 mc0Var = this.G;
                    str = mc0Var != null ? mc0Var.e(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z10) {
        ...
        int e10 = this.c0 ? e(i10) : Math.min(Math.max(i10, this.x), this.A);
        int i11 = this.C;
        this.D = e10;
        this.C = e10;
        n();
        if (Math.abs(i11 - e10) > 0.9f) {
        ...
        f();
        invalidate();
        if (this.g0 != 0 || (nc0Var = this.F) == null) {
            return;
        }
        nc0Var.n(0);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 1) {
            ...
            if (this.g0 == 1) {
                ...
                invalidate();
            } else if (((int) Math.abs(y8 - this.S)) > this.W) {
                j();
                i(1);
            }
            this.U = y8;
