...
public final class bo extends LinearLayout {
    ...
    public bo(Activity activity, View view, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        super(activity);
        ...
        F = F == null ? org.telegram.ui.ActionBar.k6.S0("paintChatActionBackground") : F;
        int i11 = org.telegram.ui.ActionBar.k6.a;
        setBackground(new org.telegram.ui.ActionBar.x5(this, view, dp, F));
        ...
        if (i10 == 0) {
            ...
            textView.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.ic, g6Var));
            textView.setGravity(1);
            textView.setMaxWidth(AndroidUtilities.dp(210.0f));
            arrayList.add(textView);
            addView(textView, k7.c6.q(-2, -2, 49));
        } else if (i10 == 1) {
            TextView textView2 = new TextView(activity);
            this.b = textView2;
            textView2.setTextSize(1, 15.0f);
            textView2.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.ic, g6Var));
            textView2.setGravity(1);
            textView2.setMaxWidth(AndroidUtilities.dp(210.0f));
            arrayList.add(textView2);
            addView(textView2, k7.c6.q(-2, -2, 49));
        } else {
            kj0 kj0Var = new kj0(activity);
            kj0Var.setAutoRepeat(true);
            kj0Var.f(R.raw.utyan_saved_messages, 120, 120, null);
            kj0Var.d();
            addView(kj0Var, k7.c6.t(-2, -2, 49, 0, 2, 0, 0));
        }
        ...
        textView3.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.ic, g6Var));
        arrayList.add(textView3);
        textView3.setMaxWidth(AndroidUtilities.dp(260.0f));
        addView(textView3, k7.c6.t(-2, -2, (i10 != 2 ? LocaleController.isRTL ? 5 : 3 : 1) | 48, 0, 8, 0, i10 != 2 ? 0 : 8));
        for (int i12 = 0; i12 < 4; i12++) {
            LinearLayout h = l.d.h(activity, 0);
            addView(h, k7.c6.t(-2, -2, LocaleController.isRTL ? 5 : 3, 0, 8, 0, 0));
            ImageView imageView = new ImageView(activity);
            int i13 = org.telegram.ui.ActionBar.k6.ic;
            imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(i13, this.a), PorterDuff.Mode.MULTIPLY));
            if (i10 == 0) {
            ...
            textView4.setTextColor(org.telegram.ui.ActionBar.k6.v0(i13, this.a));
            ...
            if (LocaleController.isRTL) {
                h.addView(textView4, k7.c6.n(-2, -2));
                if (i10 == 0) {
                    h.addView(imageView, k7.c6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    h.addView(imageView, k7.c6.k(8.0f, 7.0f, 0.0f, 0.0f, -2, -2));
                } else {
                    h.addView(imageView, k7.c6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                }
            } else {
                if (i10 == 0) {
                    h.addView(imageView, k7.c6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    h.addView(imageView, k7.c6.k(0.0f, 8.0f, 8.0f, 0.0f, -2, -2));
                } else {
                    h.addView(imageView, k7.c6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                }
                h.addView(textView4, k7.c6.n(-2, -2));
    ...
    public void setTextColor(int i10) {
        ...
        while (true) {
            ...
            ((ImageView) arrayList2.get(i11)).setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.ic, this.a), PorterDuff.Mode.MULTIPLY));
            i11++;
        }
    }
}
