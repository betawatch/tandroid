...
public final class h30 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z12) {
            ...
            if (f14 != 1.0f) {
                ...
                float interpolation = mr.f.getInterpolation(this.K) * 0.1f;
                ...
                if (z4) {
                    ...
                    if (currentTimeMillis - this.E > 1000) {
                        ...
                        float d = android.support.v4.media.a.d(org.telegram.ui.ai.f(this.G, 100), 0.5f, 100.0f, 0.5f);
                        this.e = d;
        ...
        float interpolation3 = mr.f.getInterpolation(this.K) * 0.1f;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        b30 b30Var = b30.a0;
        if (b30Var != null) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString(b30Var.w ? R.string.AccDescrCloseMenu : R.string.AccDescrOpenMenu2)));
        }
    }
