    ...
    */
    public t01(u01 u01Var, ArrayList arrayList, Runnable runnable) {
        ...
        if (arrayList.size() > 0 && (((View) arrayList.get(0)).getParent() instanceof ll0)) {
            ...
            if (ll0Var2.getParent() instanceof org.telegram.ui.um) {
                org.telegram.ui.um umVar2 = (org.telegram.ui.um) ll0Var2.getParent();
                org.telegram.ui.co chatActivity = umVar2.getChatActivity();
                ...
                while (i19 < 3) {
                    ...
                    if (i19 != 2 || ll0Var2.X1) {
                        ...
                        while (i27 < arrayList7.size()) {
                            ...
                            transitionParams4.cell.B1(canvas, (int) f23, (int) f20, (int) f24, (int) f21, transitionParams4.pinnedTop, transitionParams4.pinnedBotton, false, umVar.getKeyboardHeight());
                ...
                for (int i30 = 0; i30 < arrayList.size(); i30++) {
                    ...
                    if (view4 instanceof org.telegram.ui.Cells.t1) {
                        ...
                        ((org.telegram.ui.Cells.w0) view4).A(canvas);
                    }
                    canvas.restore();
                }
                ll0Var3.getY();
        ...
        if (z11) {
            ...
            if (w0Var.J()) {
                ...
                if (!z10) {
                    ...
                    ((org.telegram.ui.Cells.w0) view).A(canvas);
                }
                canvas.restoreToCount(save);
