...
public final class t01 {
     ...
     */
    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Object, org.telegram.ui.Components.t01] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public t01(u01 u01Var, ArrayList arrayList, Runnable runnable) {
        ml0 ml0Var;
        org.telegram.ui.qm qmVar;
        int i10;
        float f7;
        float f10;
        ...
        for (int i18 = 0; i18 < arrayList.size(); i18++) {
            if (arrayList.get(i18) instanceof org.telegram.ui.Cells.t1) {
                ((org.telegram.ui.Cells.t1) arrayList.get(i18)).pe = true;
            }
        }
        obj.C = Bitmap.createBitmap(obj.t, obj.u, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(obj.C);
        if (arrayList.size() > 0 && (((View) arrayList.get(0)).getParent() instanceof ml0)) {
            ml0 ml0Var2 = (ml0) ((View) arrayList.get(0)).getParent();
            if (ml0Var2.getParent() instanceof org.telegram.ui.qm) {
                org.telegram.ui.qm qmVar2 = (org.telegram.ui.qm) ml0Var2.getParent();
                org.telegram.ui.xn chatActivity = qmVar2.getChatActivity();
                    ...
                    if (i19 != 2 || ml0Var2.X1) {
                        ...
                        while (true) {
                            ...
                            if (view2 instanceof org.telegram.ui.Cells.t1) {
                                ...
                                if (view2.getY() <= ml0Var.getHeight() && view2.getY() + view2.getHeight() >= 0.0f) {
                                    i12 = i20;
                        ...
                        while (i27 < arrayList7.size()) {
                            ...
                            f18 = f18 > ((float) (AndroidUtilities.dp(20.0f) + ml0Var.getMeasuredHeight())) ? AndroidUtilities.dp(20.0f) + ml0Var.getMeasuredHeight() : f18;
                            float f19 = t01Var2.j;
                            float f20 = f16 - f19;
                            float f21 = f18 - f19;
                            float f22 = t01Var2.i;
                            ...
                            transitionParams4.cell.B1(canvas, (int) f23, (int) f20, (int) f24, (int) f21, transitionParams4.pinnedTop, transitionParams4.pinnedBotton, false, qmVar.getKeyboardHeight());
                ...
                for (int i35 = 0; i35 < arrayList.size(); i35++) {
                    if (arrayList.get(i35) instanceof org.telegram.ui.Cells.t1) {
                        ((org.telegram.ui.Cells.t1) arrayList.get(i35)).pe = false;
                    }
                }
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public t01(u01 u01Var, View view, float f7, Runnable runnable) {
        this.E = u01Var;
        ...
        if (z10) {
            ((org.telegram.ui.Cells.t1) view).pe = true;
        }
