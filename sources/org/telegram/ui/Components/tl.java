...
public final class tl extends yl {
    ...
    public final org.telegram.ui.qu0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z4, boolean z10) {
        ...
        if (z10 && (ltVar = liVar.O0) != null && (closeIntoObject = ((w40) ltVar.b).getCloseIntoObject()) != null) {
    ...
    public final void Z(int i10) {
        org.telegram.ui.Cells.s5 K = ChatAttachAlertPhotoLayout.K(this.b, i10);
        if (K != null) {
            K.g(true);
        }
    }
    ...
    public final boolean l() {
        li liVar = this.b.b;
        return liVar != null && (liVar.c0 instanceof org.telegram.ui.zn);
    }
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z4, int i11, int i12, boolean z10) {
        ...
        z4.a0(liVar.G1, liVar.j1() + ChatAttachAlertPhotoLayout.p1.size(), liVar.n1(), new jl(this, z4, i11, z10));
    }
