...
public final class b90 extends Drawable {
    ...
    public final void c(int i9) {
        ...
        this.e.setColor(i10);
        this.a.setColor(i10);
        this.g = new PorterDuffColorFilter(i9, PorterDuff.Mode.MULTIPLY);
    }

    public final void d(int i9, boolean z10) {
        int i10;
        int i11;
        if (this.p == i9 && (i11 = this.q) != i9) {
            this.p = i11;
            this.r = 1.0f;
        }
        if (z10) {
            int i12 = this.p;
            if (i12 == i9 || (i10 = this.q) == i9) {
                return;
            }
    ...
    */
    public final void draw(Canvas canvas) {
            ...
            if (this.u) {
                ...
                if (i40 != 2) {
                    if (f10 <= 0.5f) {
                        ...
                        float z11 = e2.c.z(dp7, dp, f12, dp);
                        if (f43 > 0.0f) {
                            ...
                            if (i44 != 0) {
                                ...
                                if (this.q == 14) {
                                    paint3.setAlpha(i44);
                                    rectF5.set(centerX3 - AndroidUtilities.dp(3.5f), i11 - AndroidUtilities.dp(3.5f), AndroidUtilities.dp(3.5f) + centerX3, AndroidUtilities.dp(3.5f) + i11);
                ...
                float z12 = e2.c.z(dp, dp5, f11, dp5);
                float z13 = e2.c.z(dp7, dp6, f11, dp6);
                float f49 = centerX3;
            ...
            if (i45 == 4 && ((i34 = this.q) == 14 || i34 == 3)) {
                ...
                if (i45 == 10 || this.q == 10 || i45 == 13) {
                    ...
                    if (i47 != 0) {
                        ...
                        i16 = this.q;
                        if (i16 != 15) {
                            pathArr = org.telegram.ui.ActionBar.f6.a5;
                        } else {
                            if (this.p == 15) {
                                pathArr2 = org.telegram.ui.ActionBar.f6.a5;
                                pathArr = null;
                                if (i16 == 5) {
                                    pathArr = org.telegram.ui.ActionBar.f6.Z4;
                                } else if (this.p == 5) {
                                    pathArr2 = org.telegram.ui.ActionBar.f6.Z4;
                                }
                                Path[] pathArr3 = pathArr;
                                Path[] pathArr4 = pathArr2;
                                if (i16 == 7) {
                                    drawable2 = org.telegram.ui.ActionBar.f6.b5;
                                    drawable = null;
                                    i17 = 8;
                                } else {
                                    drawable = this.p == 7 ? org.telegram.ui.ActionBar.f6.b5 : null;
                                    i17 = 8;
                                    drawable2 = null;
                                }
                                if (i16 == i17) {
                                    drawable2 = org.telegram.ui.ActionBar.f6.c5;
                                } else if (this.p == i17) {
                                    drawable = org.telegram.ui.ActionBar.f6.c5;
                                }
                                if (this.p != 9 || i16 == 9) {
                                    a(false);
                                    paint5.setAlpha(this.p == this.q ? 255 : (int) (this.r * 255.0f));
                                    int dp14 = AndroidUtilities.dp(7.0f) + i14;
                                    int dp15 = centerX3 - AndroidUtilities.dp(3.0f);
                                    if (this.p != this.q) {
                                        canvas2.save();
                                        float f57 = this.r;
                                        canvas2.scale(f57, f57, centerX3, i14);
                                    }
                                    float f58 = dp15;
                                    float f59 = dp14;
                                    drawable3 = drawable;
                                ...
                                if (this.p != 12 || this.q == 12) {
                                    ...
                                    if (this.p != this.q) {
                                        canvas2.save();
                                        canvas2.scale(f60, f60, centerX3, i14);
                                    }
                                ...
                                if (this.p != 13 || this.q == 13) {
                                    ...
                                    int dp17 = AndroidUtilities.dp(5.0f) + i14;
                                    f17 = 5.0f;
                                    int i52 = centerX3 - (this.n / 2);
                                    rect = bounds;
                                    f18 = f16;
                                    if (this.p != this.q) {
                                        canvas2.save();
                                        canvas2.scale(f67, f67, centerX3, i14);
                                    }
                                    i18 = (int) (this.x * 100.0f);
                                    if (this.m == null && i18 == this.l) {
                                        i19 = centerX3;
                                    } else {
                                        this.l = i18;
                                        this.m = String.format("%d%%", Integer.valueOf(i18));
                                        i19 = centerX3;
                                        this.n = (int) Math.ceil(textPaint.measureText(r2));
                                    }
                                    canvas2.drawText(this.m, i52, dp17, textPaint);
                                    if (this.p != this.q) {
                                        canvas2.restore();
                                    }
                                } else {
                                ...
                                i20 = this.p;
                                if (i20 != 0 || i20 == 1 || (i29 = this.q) == 0 || i29 == 1) {
                                    if ((i20 == 0 || this.q != 1) && !(i20 == 1 && this.q == 0)) {
                                        i21 = 1;
                                    } else if (this.u) {
                                        f20 = this.q == 0 ? 1.0f - this.r : this.r;
                                        i21 = 1;
                                        i22 = this.q;
                                        if ((i22 != 0 || i22 == i21) && (i20 == 0 || i20 == i21)) {
                                            paint2 = paint;
                                            paint2.setAlpha(255);
                                        } else if (i22 == 4) {
                                            paint2 = paint;
                                            ...
                                            paint2 = paint;
                                            paint2.setAlpha(i20 == i22 ? 255 : (int) (this.r * 255.0f));
                                        }
                                        a(true);
                                        canvas2.save();
                                        canvas2.translate(e2.c.z(1.0f, f20, AndroidUtilities.dp(1.0f), rect.centerX()), rect.centerY());
                                        f21 = f20 * 500.0f;
                                        i23 = this.p;
                                        f22 = i23 != 1 ? 90.0f : 0.0f;
                                        if (i23 == 0 || this.q != 1) {
                                            interpolation = (i23 == 1 || this.q != 0) ? f22 : f21 < 100.0f ? gr.j.getInterpolation(f21 / 100.0f) * (-5.0f) : f21 < 484.0f ? (gr.j.getInterpolation((f21 - 100.0f) / 384.0f) * 95.0f) - 5.0f : 90.0f;
                                        } else {
                                            interpolation = f21 < 384.0f ? gr.j.getInterpolation(f21 / 384.0f) * 95.0f : f21 < 484.0f ? 95.0f - (gr.j.getInterpolation((f21 - 384.0f) / 100.0f) * f17) : 90.0f;
                                            f21 += 100.0f;
                                        }
                                        canvas2.rotate(interpolation);
                                        i24 = this.p;
                                        if ((i24 != 0 && i24 != 1) || i24 == 4) {
                                            canvas2.scale(f15, f15);
                                        }
                                        org.telegram.ui.ActionBar.f6.x3.b(canvas2, paint2, f21);
                                ...
                                if (this.p == 6 || this.q == 6) {
                                    ...
                                    int dp18 = AndroidUtilities.dp(7.0f) + i14;
                                    int dp19 = i19 - AndroidUtilities.dp(3.0f);
                                    if (f23 < 1.0f) {
                                        i25 = i19;
                                        i26 = dp18;
                                        f25 = f24;
                                ...
                                if (drawable3 != null && drawable3 != drawable4) {
                                    ...
                                    int i53 = intrinsicWidth / 2;
                                    int i54 = intrinsicHeight / 2;
                                    drawable3.setBounds(i25 - i53, i14 - i54, i25 + i53, i54 + i14);
                                ...
                                if (drawable4 != null) {
                                    ...
                                    int i55 = intrinsicWidth2 / 2;
                                    int i56 = intrinsicHeight2 / 2;
                                    drawable4.setBounds(i25 - i55, i14 - i56, i25 + i55, i56 + i14);
                                ...
                                if (pathArr3 != null) {
                                    ...
                                    int i57 = this.p == this.q ? 255 : (int) (this.r * 255.0f);
                                    paint2.setStyle(Paint.Style.FILL_AND_STROKE);
                                    paint2.setAlpha(i57);
                                    a(true);
                                    canvas2.save();
                                    ...
                                    if (path5 != null) {
                                        if (i57 != 255) {
                                            ...
                                            paint6.setAlpha((int) ((i57 / 255.0f) * alpha));
                                ...
                                int i58 = this.p;
                                if (i58 == 3 || i58 == 14 || ((i58 == 4 && this.q == 14) || i58 == 10 || i58 == 13)) {
                        ...
                        a(false);
                        paint5.setAlpha(this.p == this.q ? 255 : (int) (this.r * 255.0f));
                        int dp142 = AndroidUtilities.dp(7.0f) + i14;
                        ...
                        int dp172 = AndroidUtilities.dp(5.0f) + i14;
                        f17 = 5.0f;
                        int i522 = centerX3 - (this.n / 2);
                        rect = bounds;
                        f18 = f16;
                        if (this.p != this.q) {
                        }
                        ...
                        canvas2.drawText(this.m, i522, dp172, textPaint2);
                        if (this.p != this.q) {
                        }
                        i20 = this.p;
                        if (i20 != 0) {
                ...
                a(false);
                paint5.setAlpha(this.p == this.q ? 255 : (int) (this.r * 255.0f));
                int dp1422 = AndroidUtilities.dp(7.0f) + i14;
                ...
                int dp1722 = AndroidUtilities.dp(5.0f) + i14;
                f17 = 5.0f;
                int i5222 = centerX3 - (this.n / 2);
                rect = bounds;
                f18 = f16;
                if (this.p != this.q) {
                }
                ...
                canvas2.drawText(this.m, i5222, dp1722, textPaint22);
                if (this.p != this.q) {
                }
                i20 = this.p;
                if (i20 != 0) {
        ...
        if (i60 == 2) {
            ...
            if (i60 == 15 || i60 == 0 || i60 == i12 || i60 == 5 || i60 == 8 || i60 == 9 || i60 == 7 || i60 == 6) {
                ...
                if (f30 != 0.0f) {
                    canvas2.save();
                    i14 = i11;
                    canvas2.rotate(f30, centerX3, i14);
                } else {
                    i14 = i11;
                }
                if (min != 0) {
                    ...
                    if (this.p == 14 || this.q == 14) {
                        ...
                        rectF3.set(centerX3 - AndroidUtilities.dp(3.5f), i14 - AndroidUtilities.dp(3.5f), AndroidUtilities.dp(3.5f) + centerX3, AndroidUtilities.dp(3.5f) + i14);
                ...
                i30 = this.p;
                if ((i30 != 3 || i30 == 14 || (i30 == i13 && ((i32 = this.q) == 14 || i32 == 3))) && min != 0) {
                    ...
                    a(false);
                    paint5.setAlpha(this.p == this.q ? 255 : (int) (this.r * 255.0f));
                    int dp14222 = AndroidUtilities.dp(7.0f) + i14;
                    ...
                    int dp17222 = AndroidUtilities.dp(5.0f) + i14;
                    f17 = 5.0f;
                    int i52222 = centerX3 - (this.n / 2);
                    rect = bounds;
                    f18 = f16;
                    if (this.p != this.q) {
                    }
                    ...
                    canvas2.drawText(this.m, i52222, dp17222, textPaint222);
                    if (this.p != this.q) {
                    }
                    i20 = this.p;
                    if (i20 != 0) {
                ...
                a(false);
                paint5.setAlpha(this.p == this.q ? 255 : (int) (this.r * 255.0f));
                int dp142222 = AndroidUtilities.dp(7.0f) + i14;
                ...
                int dp172222 = AndroidUtilities.dp(5.0f) + i14;
                f17 = 5.0f;
                int i522222 = centerX3 - (this.n / 2);
                rect = bounds;
                f18 = f16;
                if (this.p != this.q) {
                }
                ...
                canvas2.drawText(this.m, i522222, dp172222, textPaint2222);
                if (this.p != this.q) {
                }
                i20 = this.p;
                if (i20 != 0) {
            ...
            a(false);
            paint5.setAlpha(this.p == this.q ? 255 : (int) (this.r * 255.0f));
            int dp1422222 = AndroidUtilities.dp(7.0f) + i14;
            ...
            int dp1722222 = AndroidUtilities.dp(5.0f) + i14;
            f17 = 5.0f;
            int i5222222 = centerX3 - (this.n / 2);
            rect = bounds;
            f18 = f16;
            if (this.p != this.q) {
            }
            ...
            canvas2.drawText(this.m, i5222222, dp1722222, textPaint22222);
            if (this.p != this.q) {
            }
            i20 = this.p;
            if (i20 != 0) {
        ...
        a(false);
        paint5.setAlpha(this.p == this.q ? 255 : (int) (this.r * 255.0f));
        int dp14222222 = AndroidUtilities.dp(7.0f) + i14;
        ...
        int dp17222222 = AndroidUtilities.dp(5.0f) + i14;
        f17 = 5.0f;
        int i52222222 = centerX3 - (this.n / 2);
        rect = bounds;
        f18 = f16;
        if (this.p != this.q) {
        }
        ...
        canvas2.drawText(this.m, i52222222, dp17222222, textPaint222222);
        if (this.p != this.q) {
        }
        i20 = this.p;
        if (i20 != 0) {
