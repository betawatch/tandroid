...
public final class te0 implements DialogInterface.OnClickListener {
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        Integer num12 = 6;
        ye0 ye0Var2 = this.a;
        ArrayList arrayList3 = ye0Var2.M;
        ArrayList arrayList4 = ye0Var2.L;
        Integer num13 = 0;
        if (i10 == 0) {
        ...
        TLRPC.TL_userContact_old2 tL_userContact_old2 = ye0Var2.N;
        ...
        try {
            ye0Var.r.getParentActivity().startActivity(intent3);
            ye0Var.dismiss();
        } catch (Exception e) {
            FileLog.e(e);
        }
