...
public final class l51 extends Drawable {
    ...
    public l51() {
        ...
        this.h = pcVar;
        this.i = new ud.b(new n5.e0(this, 12));
    ...
    public final int a(int i9) {
        ...
        int dp = (((i9 - this.s) - ((int) ((this.t * 2) + measureText))) - this.x) - AndroidUtilities.dp(11.0f);
    ...
    public final void b() {
        int w02 = org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.ic, false);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        this.a.setColorFilter(new PorterDuffColorFilter(w02, mode));
        this.b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.f6.l1(0.11f, -16777216), mode));
        this.c.setColor(w02);
        this.d.setColor(i0.a.k(w02, 179));
        this.e.setColor(w02);
        this.f.setColor(org.telegram.ui.ActionBar.f6.l1(0.11f, -16777216));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(this.s + i9, height);
        this.k.draw(canvas);
        ...
        int i11 = this.t;
        int dp = i10 - AndroidUtilities.dp(11.0f);
        float f10 = centerY - (this.u / 2);
        RectF rectF = this.g;
        rectF.set(dp - ((int) (width + (i11 * 2))), f10, dp, r6 + r5);
        ...
        canvas.save();
        canvas.translate(r3 + i11, ((r5 - this.m.getHeight()) / 2.0f) + f10);
        this.m.draw(canvas);
        canvas.restore();
        canvas.restore();
        float dp2 = AndroidUtilities.dp(29.66f) + i9;
        float f11 = centerY + 1;
        Drawable drawable = this.b;
        ff.s.d(drawable, dp2, f11, 17);
        drawable.draw(canvas);
        float dp3 = AndroidUtilities.dp(29.66f) + i9;
        Drawable drawable2 = this.a;
        ff.s.d(drawable2, dp3, f11, 17);
