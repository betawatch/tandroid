...
public final class fq0 extends aw0 {
    ...
    public fq0(uq0 uq0Var, Context context) {
        ...
        this.F0 = AndroidUtilities.computePerceivedBrightness(uq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) > 0.721f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (frameLayout != null) {
            if (dp2 > uq0Var.G0.b || frameLayout.getChildCount() <= 0) {
                i13 = ((org.telegram.ui.ActionBar.f3) uq0Var).backgroundPaddingTop;
        ...
        if (f7 < 1.0f) {
            ...
            org.telegram.ui.ActionBar.j6.t0.setColor(uq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        uq0 uq0Var = this.H0;
        zp0 zp0Var = uq0Var.d;
        z11 = ((org.telegram.ui.ActionBar.f3) uq0Var).keyboardVisible;
        ...
        for (int i20 = 0; i20 < childCount; i20++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (i23 == 1) {
                    ...
                    i15 = ((org.telegram.ui.ActionBar.f3) uq0Var).backgroundPaddingLeft;
                }
                i16 = i14 - i15;
                if (i22 == 16) {
                }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!z10) {
            ...
            int i19 = uq0Var.G0.b;
            i17 = ((org.telegram.ui.ActionBar.f3) uq0Var).backgroundPaddingLeft;
            fq0Var.setPadding(i16, i19, i17, 0);
            fq0Var.w0 = false;
        }
        int paddingTop = size - fq0Var.getPaddingTop();
        int D = org.telegram.messenger.l0.D(103.0f, Math.max(2, (int) Math.ceil(Math.max(uq0Var.M.h(), uq0Var.K.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + AndroidUtilities.dp(103.0f));
        i12 = ((org.telegram.ui.ActionBar.f3) uq0Var).backgroundPaddingTop;
        int i20 = i12 + D;
        if (vl0Var.getVisibility() != 8) {
            int D2 = org.telegram.messenger.l0.D(103.0f, Math.max(2, (int) Math.ceil((uq0Var.L.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + AndroidUtilities.dp(103.0f));
            i15 = ((org.telegram.ui.ActionBar.f3) uq0Var).backgroundPaddingTop;
            int i21 = i15 + D2;
            if (i21 > i20) {
        ...
        i13 = ((org.telegram.ui.ActionBar.f3) uq0Var).backgroundPaddingLeft;
        ...
        if (uq0Var.N0 <= AndroidUtilities.dp(20.0f)) {
            if (!AndroidUtilities.isInMultiwindow) {
                z12 = ((org.telegram.ui.ActionBar.f3) uq0Var).keyboardVisible;
