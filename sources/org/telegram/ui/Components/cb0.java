...
public final class cb0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public cb0(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, ArrayList arrayList, int i11) {
        super(context);
        String str;
        ...
        this.M = 0.0f;
        this.a = i10;
        setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, e6Var), 0, 16));
        TextPaint textPaint = new TextPaint(1);
        this.h = textPaint;
        textPaint.setTextSize(AndroidUtilities.dp(13.0f));
        textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.E8, e6Var));
        if (arrayList.size() > 1) {
        ...
        if (arrayList.size() != 1) {
            if (i11 == 4) {
                this.n = AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StickersCheckStickersBotForMoreOptions), org.telegram.ui.ActionBar.j6.gc, 2, null, e6Var);
                return;
            }
            return;
        }
        ...
        if (str == null || document == null) {
            ...
            this.f = p90Var;
            p90Var.l = org.telegram.ui.ActionBar.j6.G8;
            p90Var.m = org.telegram.ui.ActionBar.j6.i6;
            p90Var.j(4.0f);
            return;
        }
        SpannableString spannableString = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString.setSpan(new za0(this, document, this.h.getFontMetricsInt()), 0, spannableString.length(), 33);
        q5 m10 = q5.m(i10, 0, document);
        this.d = m10;
        m10.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.n6, e6Var), PorterDuff.Mode.SRC_IN));
        this.d.a(this);
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        spannableString.setSpan(new ab0(this, 0), 0, 1, 33);
        SpannableString spannableString2 = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString2.setSpan(new bb0(this, document, this.h.getFontMetricsInt()), 0, spannableString2.length(), 33);
