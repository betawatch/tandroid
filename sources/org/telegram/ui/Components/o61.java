...
public final class o61 extends IUpdateLayout {
    ...
    public final void createUpdateUI(int i10) {
        ...
        this.a.setBackground(org.telegram.ui.ActionBar.k6.f0(1090519039, 2, -1));
        viewGroup.addView(this.a, k7.c6.e(-1, 44, 83));
        this.a.setOnClickListener(new mh.x0(this, i10, 11));
    ...
    public final void updateAppUpdateViews(int i10, boolean z4) {
        ...
        if (ApplicationLoader.applicationLoaderInstance.getUpdate() == null) {
            ...
            this.a.setTag(null);
            if (z4) {
                this.a.animate().translationY(AndroidUtilities.dp(44.0f)).setInterpolator(pr.g).setListener(new pd0(this, 26)).setDuration(180L).start();
                return;
            } else {
                this.a.setTranslationY(AndroidUtilities.dp(44.0f));
