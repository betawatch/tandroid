...
public final class o61 {
    ...
    public final void a(Canvas canvas, View view) {
        ...
        if (f17 != 1.0f) {
            ...
            if (f18 >= 1.0f) {
                ...
                view.invalidate();
                float interpolation = er.f.getInterpolation(this.C);
        ...
        if (this.t != dp) {
            ...
            if (f26 < dp) {
                c10 = 0;
                float c12 = s3.c.c(j10, 60.0f, AndroidUtilities.dp(1.0f), f26);
                this.t = c12;
                if (c12 > dp) {
                    this.t = dp;
                }
                ...
                c10 = 0;
                float c13 = org.telegram.messenger.rl.c(j10, 60.0f, AndroidUtilities.dp(1.0f), f26);
                this.t = c13;
                if (c13 < dp) {
                    this.t = dp;
                }
        ...
        if (d > 0.0f) {
            ...
            g(1.0f, i0.b.d(this.y, this.n, this.A));
            b(canvas, rectF, Q);
            rectF.left = f27;
            g(1.0f - this.y, i0.b.d(this.y, this.m, c() == 0.0f ? 0 : this.A));
        ...
        float interpolation2 = er.f.getInterpolation(this.M);
        canvas.save();
        int i15 = this.i;
        ...
        if (this.K[c10] != null) {
            ...
            this.L.setAlpha((int) (org.telegram.messenger.y1.z(1.0f, this.y, 255.0f, interpolation2) * this.I));
    ...
    */
    public final void b(Canvas canvas, RectF rectF, Paint paint) {
        ...
        char c11;
        o61 o61Var = this;
        float dp = AndroidUtilities.dp(AndroidUtilities.lerp(2, 1, o61Var.y));
        ...
        float lerp = AndroidUtilities.lerp(S / 2.0f, 0.0f, o61Var.y) + o61Var.z;
        float lerp2 = AndroidUtilities.lerp(o61Var.h - (S / 2.0f), o61Var.v.getWidth() - (o61Var.z * 2.0f), o61Var.y) + o61Var.z;
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(o61Var.I * 1.0f) / 2.0f;
        if (U == null) {
            U = new Path();
        }
        U.reset();
        ...
        while (true) {
            i10 = -1;
            if (i11 >= o61Var.F.size()) {
                i11 = -1;
                break;
            } else if (((Float) ((Pair) o61Var.F.get(i11)).first).floatValue() >= dp3) {
                break;
            } else {
                i11++;
            }
        ...
        int size = o61Var.F.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) o61Var.F.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i12) {
            if (i13 == i11) {
                ...
                c10 = 1;
                floatValue = ((Float) ((Pair) o61Var.F.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i12 ? 1.0f : ((Float) ((Pair) o61Var.F.get(i13)).first).floatValue();
            while (i13 != i12 && i13 != 0 && i13 < o61Var.F.size() - 1 && ((Float) ((Pair) o61Var.F.get(i13)).first).floatValue() - floatValue <= dp3) {
                i13++;
                floatValue2 = ((Float) ((Pair) o61Var.F.get(i13)).first).floatValue();
            }
