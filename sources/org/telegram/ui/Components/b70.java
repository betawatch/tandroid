...
public final class b70 extends ViewGroup {
    ...
    public final void a(n30 n30Var, boolean z4) {
        ...
        this.d = true;
        c70 c70Var = this.e;
        c70Var.c0.k(n30Var, n30Var.getUid());
        AnimatorSet animatorSet = c70Var.a0;
        if (animatorSet != null) {
        ...
        if (z4) {
            ...
            c70Var.a0 = animatorSet2;
            animatorSet2.addListener(new a70(this, i10));
            c70Var.a0.setDuration(150L);
            c70Var.a0.setInterpolator(nr.f);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int min = c70Var.j0 != null ? c70Var.d0 ? Math.min(c70Var.p0, dp6) : 0 : kh.a2.c(52.0f, Math.min(c70Var.p0, dp6), 0);
        int i16 = c70Var.r0;
        int dp7 = (c70Var.j0 != null || c70Var.c0.m() <= 0) ? 0 : AndroidUtilities.dp(56.0f);
        c70Var.r0 = dp7;
        if (min != c70Var.l0 || i16 != dp7) {
            c70Var.l0 = min;
            if (e1Var.getAdapter() != null && e1Var.getAdapter().h() > 0 && (K = e1Var.K(0)) != null) {
                e1Var.getAdapter().m(0);
                c70Var.O.h1(0, K.a.getTop() - e1Var.getPaddingTop());
        ...
        int min2 = Math.min(c70Var.p0, dp6);
        int i17 = c70Var.h0;
        if (i17 != min2) {
                ...
                public final void run() {
                    switch (i18) {
                        case 0:
                            ...
                            c70Var2.S.smoothScrollTo(0, dp6 - c70Var2.p0);
                            break;
                        default:
                            c70 c70Var3 = this.b.e;
                            c70Var3.S.smoothScrollTo(0, dp6 - c70Var3.p0);
                            break;
                    }
                }
            });
        ...
        if (!this.a && (animatorSet = c70Var.a0) != null) {
            animatorSet.playTogether(arrayList);
            c70Var.a0.addListener(new a70(this, 0));
            c70Var.a0.start();
            this.a = true;
        }
        if (c70Var.a0 == null) {
