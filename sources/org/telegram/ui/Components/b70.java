...
public final class b70 extends ViewGroup {
    ...
    public final void a(n30 n30Var, boolean z10) {
        ...
        this.d = true;
        c70 c70Var = this.e;
        c70Var.f0.k(n30Var, n30Var.getUid());
        AnimatorSet animatorSet = c70Var.d0;
        if (animatorSet != null) {
        ...
        if (z10) {
            ...
            c70Var.d0 = animatorSet2;
            animatorSet2.addListener(new a70(this, i10));
            c70Var.d0.setDuration(150L);
            c70Var.d0.setInterpolator(rr.f);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int min = c70Var.m0 != null ? c70Var.g0 ? Math.min(c70Var.s0, dp6) : 0 : hg.c.f(52.0f, Math.min(c70Var.s0, dp6), 0);
        int i16 = c70Var.u0;
        int dp7 = (c70Var.m0 != null || c70Var.f0.m() <= 0) ? 0 : AndroidUtilities.dp(56.0f);
        c70Var.u0 = dp7;
        if (min != c70Var.o0 || i16 != dp7) {
            c70Var.o0 = min;
            if (w0Var.getAdapter() != null && w0Var.getAdapter().h() > 0 && (K = w0Var.K(0)) != null) {
                w0Var.getAdapter().m(0);
                c70Var.R.h1(0, K.a.getTop() - w0Var.getPaddingTop());
        ...
        int min2 = Math.min(c70Var.s0, dp6);
        int i17 = c70Var.k0;
        if (i17 != min2) {
        ...
        boolean z10 = this.d;
        if (z10 && dp6 > c70Var.s0) {
            final int i18 = 0;
            AndroidUtilities.runOnUIThread(new Runnable(this) { // from class: org.telegram.ui.Components.z60
                ...
                public final void run() {
                    switch (i18) {
                        case 0:
                            c70 c70Var2 = this.b.e;
                            c70Var2.V.smoothScrollTo(0, dp6 - c70Var2.s0);
                            break;
                        default:
                            c70 c70Var3 = this.b.e;
                            c70Var3.V.smoothScrollTo(0, dp6 - c70Var3.s0);
                            break;
                    }
                }
            });
        ...
        if (!this.a && (animatorSet = c70Var.d0) != null) {
            animatorSet.playTogether(arrayList);
            c70Var.d0.addListener(new a70(this, 0));
            c70Var.d0.start();
            this.a = true;
        }
        if (c70Var.d0 == null) {
