...
public final class m70 extends View {
    ...
    public m70(o70 o70Var, Context context) {
        ...
        if (o70Var.t && (view instanceof org.telegram.ui.Cells.va) && (o70Var.c instanceof ProfileActivity)) {
            this.b = new Paint(3);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (o70Var.t) {
            ...
            if (bitmap != null && (view.getParent() instanceof View)) {
                canvas2.save();
                if (f12 < 1.0f) {
                    canvas2.clipRect(-rect.left, (((-rect.top) + fArr[1]) - (f12 * (o70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, getMeasuredWidth() + rect.right, getMeasuredHeight() + rect.bottom);
                }
                if (o70Var.L) {
                ...
                if (o70Var.k > 0 || o70Var.l > 0) {
                    ...
                    float f13 = -rect.left;
                    float f14 = o70Var.k;
                    rectF.set((this.w * f14) + f13, (getAlpha() * f14) + (-rect.top), (bitmap.getWidth() + (-rect.left)) - (getAlpha() * o70Var.k), (bitmap.getHeight() + (-rect.top)) - (getAlpha() * o70Var.k));
                    float f15 = o70Var.l * this.w;
            ...
            if (view != 0 && (view.getParent() instanceof View)) {
                ...
                if (f12 >= 1.0f && f16 == 0.0f) {
                    ...
                    f10 = 255.0f;
                    c3 = 0;
                    canvas2.clipRect(-rect.left, AndroidUtilities.lerp((((-rect.top) + fArr[1]) - (f12 * (o70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, 0.0f, this.w), getMeasuredWidth() + rect.right, org.telegram.ui.yh.c(1.0f, this.w, f16, getMeasuredHeight() + rect.bottom));
                } else {
                    f10 = 255.0f;
                    c3 = 0;
                    canvas2.clipRect(-rect.left, (((-rect.top) + fArr[1]) - (f12 * (o70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, getMeasuredWidth() + rect.right, getMeasuredHeight() + rect.bottom);
                ...
                if (o70Var.N == 0 || o70Var.O == 0) {
                    ...
                    width = AndroidUtilities.lerp(view.getWidth(), o70Var.N, f17);
                    height = AndroidUtilities.lerp(view.getHeight(), o70Var.O, f17);
                }
                float f18 = height;
                ...
                if (drawable2 != null) {
                    ...
                    o70Var.g.setAlpha((int) (this.w * f10));
                    if (Build.VERSION.SDK_INT >= 29) {
                        Drawable drawable3 = o70Var.g;
                        if (drawable3 instanceof ShapeDrawable) {
                            Paint paint3 = ((ShapeDrawable) drawable3).getPaint();
                            paint3.setShadowLayer(paint3.getShadowLayerRadius(), paint3.getShadowLayerDx(), paint3.getShadowLayerDy(), org.telegram.ui.ActionBar.j6.l1(this.w, o70Var.h));
                        }
                    }
                    o70Var.g.draw(canvas2);
                } else {
