...
public final class m70 extends View {
    ...
    public m70(o70 o70Var, Context context) {
        ...
        this.h = i0.a.k(0, o70Var.s);
        if (o70Var.t && (view instanceof org.telegram.ui.Cells.bb) && (o70Var.c instanceof ProfileActivity)) {
            this.b = new Paint(3);
        ...
        if (o70Var.u || o70Var.v) {
            this.d = new Paint(3);
            view.setAlpha(0.0f);
            ViewGroup viewGroup = o70Var.b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (o70Var.t) {
            ...
            if (bitmap != null && (view.getParent() instanceof View)) {
                canvas2.save();
                if (f11 < 1.0f) {
                    canvas2.clipRect(-rect.left, (((-rect.top) + fArr[1]) - (f11 * (o70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, getMeasuredWidth() + rect.right, getMeasuredHeight() + rect.bottom);
                }
                if (o70Var.L) {
                    o70.A(view, o70Var.b, fArr);
                ...
                Drawable drawable = o70Var.g;
                if (drawable != null) {
                    if (drawable.getIntrinsicWidth() <= 0 || o70Var.g.getIntrinsicHeight() <= 0) {
                        o70Var.g.setBounds(-rect.left, -rect.top, view.getWidth() + rect.right, view.getHeight() + rect.bottom);
                    } else {
                        o70Var.g.setBounds((((view.getWidth() + rect.right) - o70Var.g.getIntrinsicWidth()) / 2) + (-rect.left), (((view.getHeight() + rect.bottom) - o70Var.g.getIntrinsicHeight()) / 2) + (-rect.top), ((o70Var.g.getIntrinsicWidth() + (view.getWidth() + rect.right)) / 2) + (-rect.left), ((o70Var.g.getIntrinsicHeight() + (view.getHeight() + rect.bottom)) / 2) + (-rect.top));
                    }
                    o70Var.g.draw(canvas2);
                }
                if (o70Var.k > 0 || o70Var.l > 0) {
                    path.rewind();
                    RectF rectF = AndroidUtilities.rectTmp;
                    float f12 = -rect.left;
                    float f13 = o70Var.k;
                    rectF.set((this.w * f13) + f12, (getAlpha() * f13) + (-rect.top), (bitmap.getWidth() + (-rect.left)) - (getAlpha() * o70Var.k), (bitmap.getHeight() + (-rect.top)) - (getAlpha() * o70Var.k));
                    float f14 = o70Var.l * this.w;
            ...
            if (view != 0 && (view.getParent() instanceof View)) {
                ...
                if (f11 >= 1.0f && f15 == 0.0f) {
                    ...
                    f7 = 255.0f;
                    c10 = 0;
                    canvas2.clipRect(-rect.left, AndroidUtilities.lerp((((-rect.top) + fArr[1]) - (f11 * (o70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, 0.0f, this.w), getMeasuredWidth() + rect.right, com.google.android.gms.internal.vision.e2.b(1.0f, this.w, f15, getMeasuredHeight() + rect.bottom));
                } else {
                    f7 = 255.0f;
                    c10 = 0;
                    canvas2.clipRect(-rect.left, (((-rect.top) + fArr[1]) - (f11 * (o70Var.u ? 1.0f - this.w : 1.0f))) + 1.0f, getMeasuredWidth() + rect.right, getMeasuredHeight() + rect.bottom);
                ...
                if (o70Var.N == 0 || o70Var.O == 0) {
                    ...
                    width = AndroidUtilities.lerp(view.getWidth(), o70Var.N, f16);
                    height = AndroidUtilities.lerp(view.getHeight(), o70Var.O, f16);
                }
                float f17 = height;
                Drawable drawable2 = o70Var.g;
                if (drawable2 != null) {
                    if (drawable2.getIntrinsicWidth() <= 0 || o70Var.g.getIntrinsicHeight() <= 0) {
                        f10 = 1.0f;
                        o70Var.g.setBounds(-rect.left, -rect.top, view.getWidth() + rect.right, view.getHeight() + rect.bottom);
                    } else {
                        f10 = 1.0f;
                    ...
                    o70Var.g.setAlpha((int) (this.w * f7));
                    if (Build.VERSION.SDK_INT >= 29) {
                        Drawable drawable3 = o70Var.g;
                        if (drawable3 instanceof ShapeDrawable) {
                            Paint paint3 = ((ShapeDrawable) drawable3).getPaint();
                            paint3.setShadowLayer(paint3.getShadowLayerRadius(), paint3.getShadowLayerDx(), paint3.getShadowLayerDy(), org.telegram.ui.ActionBar.h6.l1(this.w, o70Var.h));
                        }
                    }
                    o70Var.g.draw(canvas2);
                } else {
