...
public final class yb0 extends Drawable {
    ...
    public yb0() {
        ...
        this.e = new jr(0.33d, 0.0d, 0.0d, 1.0d);
        this.h = 1.0f;
        this.j = new RectF();
        this.m = new Bitmap[3];
        this.n = new Paint(2);
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.save();
        Bitmap e10 = e();
        float f9 = e10 != null ? bounds.top : this.f;
        ...
        if (i12 < 0) {
            ...
            if (e10 != null) {
                if (z11) {
                    ...
                    if (this.u != null) {
                        Bitmap e11 = e();
                        rg.a aVar = this.b0;
                        if (aVar.a(e11) || this.c0 == null || this.d0 != i13) {
                            ...
                            Utilities.applyAlphaInvert(e11, this.c0, i13);
                        }
                        aVar.b(e11);
                    }
            ...
            if (e10 != null) {
                ...
                if (z12) {
                    ...
                    dc0 dc0Var = this.Q;
                    RectF rectF2 = dc0Var.j;
                    rectF2.set(0.0f, 0.0f, dc0Var.g, dc0Var.h);
                    Matrix matrix = dc0Var.i;
    ...
    public final void z() {
        ...
        if (f9 < 1.0f) {
            ...
            if (z10) {
                float f10 = ((j10 / 12000.0f) * this.M) + f9;
                this.h = f10;
                if (f10 >= 1.0f) {
                    this.h = 0.0f;
                }
                ...
                jr jrVar = this.e;
                if (z13) {
                    float interpolation2 = jrVar.getInterpolation(f9);
                    ...
                    float interpolation3 = (this.D != null || this.d) ? this.h : jrVar.getInterpolation(this.h);
                    ...
                    if (genericProvider2 != null) {
                        ...
                        this.h = (j10 / (this.B ? 300.0f : 500.0f)) + f9;
                    }
                    if (this.h > 1.0f) {
                        this.h = 1.0f;
                    }
                    interpolation = (this.D != null || this.d) ? this.h : jrVar.getInterpolation(this.h);
