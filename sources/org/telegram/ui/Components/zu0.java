...
public class zu0 extends FrameLayout implements org.telegram.ui.ActionBar.x5 {
    ...
    public final void I() {
        ...
        if (this.v == null) {
            ...
            this.v = s71Var2;
            s71Var2.n = new vu(this, 21);
            if (getMeasuredWidth() != 0 && getMeasuredHeight() != 0) {
                s71 s71Var3 = this.v;
                int measuredWidth = getMeasuredWidth();
                int measuredHeight = getMeasuredHeight();
                s71Var3.getClass();
                this.y = s71.a(measuredWidth, measuredHeight);
            }
        }
        if (this.B) {
            return;
    ...
    public void J(Canvas canvas, float f10, Rect rect, Paint paint, boolean z10) {
        K(canvas, f10, rect, paint, z10, Color.alpha(org.telegram.ui.ActionBar.g6.v0((F() && SharedConfig.getDevicePerformanceClass() == 2) ? org.telegram.ui.ActionBar.g6.xf : org.telegram.ui.ActionBar.g6.yf, getResourceProvider())));
    }
    ...
    */
        ...
        if (!F()) {
            ...
            if (this.W.getShader() != null) {
                ...
                if (z10) {
                    ...
                    vu0 vu0Var = this.M;
                    matrix.preScale(vu0Var.d, vu0Var.e);
                    if (this.N != null) {
                        matrix2.setTranslate(0.0f, (f15 - r6.a) - 34.0f);
                        vu0 vu0Var2 = this.N;
                        matrix2.preScale(vu0Var2.d, vu0Var2.e);
                    }
                } else {
                    this.M.getClass();
                    float f16 = (-f14) + 0.0f;
    ...
    public void S() {
        if (this.v != null) {
            this.y = s71.a(getMeasuredWidth(), getMeasuredHeight());
        }
    ...
    public final void W() {
        ...
        if (vu0Var == null) {
            vu0Var = new vu0();
            vu0Var.c = Bitmap.createBitmap(i11, i10, Bitmap.Config.ARGB_8888);
            vu0Var.b = new xu0(vu0Var.c);
        } else {
            vu0Var.c.eraseColor(0);
        }
        float width = vu0Var.c.getWidth() / f11;
        float height = (vu0Var.c.getHeight() - 34) / f10;
        int save = vu0Var.b.save();
        vu0Var.a = getScrollOffset() % 24;
        float f12 = 10.0f * height;
        vu0Var.b.clipRect(1.0f, f12, vu0Var.c.getWidth(), vu0Var.c.getHeight() - 1);
        vu0Var.b.scale(width, height);
        vu0Var.b.translate(0.0f, f12 + vu0Var.a);
        vu0Var.d = 1.0f / width;
        vu0Var.e = 1.0f / height;
        L(vu0Var.b, null);
        try {
            vu0Var.b.restoreToCount(save);
        } catch (Exception e9) {
            FileLog.e(e9);
        }
        System.currentTimeMillis();
    ...
    public int getBackgroundSizeY() {
        return getMeasuredHeight() - (this.b instanceof org.telegram.ui.un ? this.A : 0);
    }
    ...
    public void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            if (arrayList.get(i10) != null) {
                ((vu0) arrayList.get(i10)).c.recycle();
            }
            i10++;
        }
        arrayList.clear();
