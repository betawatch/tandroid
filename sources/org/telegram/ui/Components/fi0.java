...
public final class fi0 extends FrameLayout {
    ...
    public final void a() {
        ...
        this.s = animatorSet2;
        animatorSet2.playTogether(ObjectAnimator.ofFloat(bi0Var, (Property<bi0, Float>) View.TRANSLATION_Y, AndroidUtilities.dp(10.0f) + bi0Var.getMeasuredHeight()));
        if (this.E) {
            float measuredHeight = bi0Var.getMeasuredHeight();
            this.s.setDuration(Math.max(60, (int) (((measuredHeight - bi0Var.getTranslationY()) * 250.0f) / measuredHeight)));
            this.E = false;
        } else {
            this.s.setDuration(250L);
        }
        this.s.setInterpolator(rr.f);
        this.s.addListener(new ei0(this, 2));
            ...
            if (motionEvent == null || (!(motionEvent.getAction() == 0 || motionEvent.getAction() == 2) || this.f || this.e || motionEvent.getPointerCount() != 1)) {
                if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.d) {
                    ...
                    if (this.e && !this.f && y3 > 0.0f && y3 / 3.0f > Math.abs(abs) && Math.abs(y3) >= this.y) {
                        ...
                        float translationY = bi0Var.getTranslationY() + y3;
                        bi0Var.setTranslationY(translationY >= 0.0f ? translationY : 0.0f);
                        this.c = (int) motionEvent.getY();
                    }
                    ...
                    float translationY2 = bi0Var.getTranslationY();
                    if (this.f || translationY2 != 0.0f) {
                        ...
                        if ((bi0Var.getTranslationY() >= AndroidUtilities.getPixelsInCM(0.8f, false) || (yVelocity >= 3500.0f && Math.abs(yVelocity) >= Math.abs(xVelocity))) && (yVelocity >= 0.0f || Math.abs(yVelocity) < 3500.0f)) {
                            ...
                            this.h = animatorSet;
                            animatorSet.playTogether(ObjectAnimator.ofFloat(bi0Var, (Property<bi0, Float>) View.TRANSLATION_Y, 0.0f));
                            this.h.setDuration((int) ((Math.max(0.0f, r6) / AndroidUtilities.getPixelsInCM(0.8f, false)) * 150.0f));
                            this.h.setInterpolator(rr.g);
                            this.h.addListener(new ei0(this, i10));
                            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
                            this.h.start();
                        }
                        this.f = false;
                ...
                this.c = y10;
                if (y10 < bi0Var.getTop() || this.b < bi0Var.getLeft() || this.b > bi0Var.getRight()) {
                    requestDisallowInterceptTouchEvent(true);
                    a();
                    return true;
                }
    ...
    */
    public final void c(boolean z10) {
        ...
        int i10 = (int) value;
        org.telegram.ui.dd0 dd0Var = this.I.b;
        ArrayList arrayList = dd0Var.g0;
        ...
        if (iCircle != null) {
            ...
            if (z10) {
                ...
                onCreateLatLngBoundsBuilder.include(new IMapsProvider.LatLng(dd0Var.w0.getLatitude(), dd0Var.w0.getLongitude()));
                try {
                    ...
                    double d = max;
                    IMapsProvider.LatLng p02 = org.telegram.ui.dd0.p0(center, d, d);
                    double d10 = -max;
                    onCreateLatLngBoundsBuilder.include(org.telegram.ui.dd0.p0(center, d10, d10));
                    onCreateLatLngBoundsBuilder.include(p02);
                    IMapsProvider.ILatLngBounds build = onCreateLatLngBoundsBuilder.build();
                    try {
                        dd0Var.I.setPadding(AndroidUtilities.dp(70.0f), 0, AndroidUtilities.dp(70.0f), (int) ((dd0Var.R.getCustomView().getMeasuredHeight() - AndroidUtilities.dp(40.0f)) + dd0Var.S.getTranslationY()));
                        dd0Var.I.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngBounds(build, 0), 500, null);
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
        ...
        if (!DialogObject.isChatDialog(dd0Var.e0)) {
            int size = arrayList.size();
            for (int i11 = 0; i11 < size; i11++) {
                org.telegram.ui.xc0 xc0Var = (org.telegram.ui.xc0) arrayList.get(i11);
                if (xc0Var.b != null && !UserObject.isUserSelf(xc0Var.c)) {
                    TLRPC.GeoPoint geoPoint = xc0Var.b.media.geo;
                    Location location = new Location("network");
                    location.setLatitude(geoPoint.lat);
                    location.setLongitude(geoPoint._long);
                    if (dd0Var.w0.distanceTo(location) > i10) {
                    }
                }
            }
            z11 = false;
            if (z11 && user != null) {
                ...
                if (di0Var.getTag() == null) {
                    di0Var.setTag(1);
                    di0Var.animate().setDuration(180L).alpha(0.0f).scaleX(0.5f).scaleY(0.5f).start();
            ...
            if (user != null) {
                di0Var.setText(LocaleController.formatString("LocationNotifiationButtonGroup", R.string.LocationNotifiationButtonGroup, formatDistance));
            } else {
                di0Var.setText(LocaleController.formatString("LocationNotifiationButtonUser", R.string.LocationNotifiationButtonUser, TextUtils.ellipsize(UserObject.getFirstName(user), di0Var.getPaint(), Math.max(AndroidUtilities.dp(10.0f), (int) (((this.N - AndroidUtilities.dp(94.0f)) * 1.5f) - ((int) Math.ceil(di0Var.getPaint().measureText(LocaleController.getString(R.string.LocationNotifiationButtonUser)))))), TextUtils.TruncateAt.END), formatDistance));
            }
            if (di0Var.getTag() == null) {
                di0Var.setTag(null);
                di0Var.animate().setDuration(180L).alpha(1.0f).scaleX(1.0f).scaleY(1.0f).start();
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i20 = i13 - i11;
        bi0 bi0Var = this.v;
        int measuredHeight = i20 - bi0Var.getMeasuredHeight();
        int i21 = i12 - i10;
        int measuredWidth = (i21 - bi0Var.getMeasuredWidth()) / 2;
        bi0Var.layout(measuredWidth, measuredHeight, bi0Var.getMeasuredWidth() + measuredWidth, bi0Var.getMeasuredHeight() + measuredHeight);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        bi0 bi0Var = this.v;
        bi0Var.measure(View.MeasureSpec.makeMeasureSpec((this.x * 2) + size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_31));
        int childCount = getChildCount();
