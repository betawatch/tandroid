...
public class SenderSelectView extends View {
    private static final FloatPropertyCompat MENU_PROGRESS = new SimpleFloatPropertyCompat("menuProgress", new SimpleFloatPropertyCompat.Getter() { // from class: org.telegram.ui.Components.SenderSelectView$$ExternalSyntheticLambda0
        ...
        public final void set(Object obj, float f) {
            SenderSelectView.$r8$lambda$K-0kIe8gi8ce3Pl7QoAyAgwuavA((SenderSelectView) obj, f);
        }
    ...
    public static /* synthetic */ void $r8$lambda$K-0kIe8gi8ce3Pl7QoAyAgwuavA(SenderSelectView senderSelectView, float f) {
    ...
    private void updateColors() {
        ...
        Drawable createSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.dp(18.0f), 0, Theme.multAlpha(Theme.getColor(Theme.key_windowBackgroundWhite), 0.2f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float dp = AndroidUtilities.dp(10.0f) + this.menuPaint.getStrokeWidth();
        ...
        if (z) {
            ...
            if (z2) {
                ...
                this.menuSpring.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener() { // from class: org.telegram.ui.Components.SenderSelectView$$ExternalSyntheticLambda2
                    ...
                    public final void onAnimationUpdate(DynamicAnimation dynamicAnimation, float f4, float f5) {
                        SenderSelectView.$r8$lambda$tvKHM2Ks8u9CXao3tOmjK89FcF4(SenderSelectView.this, z3, f2, f3, dynamicAnimation, f4, f5);
                    }
                });
                this.menuSpring.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: org.telegram.ui.Components.SenderSelectView$$ExternalSyntheticLambda3
                    ...
                    public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z4, float f4, float f5) {
                        SenderSelectView.$r8$lambda$139Yq8ZuUy7Lp93hTzCnjcroZ7A(SenderSelectView.this, dynamicAnimation, z4, f4, f5);
                    }
                });
            ...
            this.menuAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.SenderSelectView$$ExternalSyntheticLambda4
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    SenderSelectView.$r8$lambda$yWkUVg07clSnF4EpobV2H0D4FKU(SenderSelectView.this, valueAnimator2);
                }
            });
    ...
    public static /* synthetic */ void $r8$lambda$tvKHM2Ks8u9CXao3tOmjK89FcF4(SenderSelectView senderSelectView, boolean z, float f, float f2, DynamicAnimation dynamicAnimation, float f3, float f4) {
    ...
    public static /* synthetic */ void $r8$lambda$139Yq8ZuUy7Lp93hTzCnjcroZ7A(SenderSelectView senderSelectView, DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
    ...
    public static /* synthetic */ void $r8$lambda$yWkUVg07clSnF4EpobV2H0D4FKU(SenderSelectView senderSelectView, ValueAnimator valueAnimator) {
        senderSelectView.getClass();
