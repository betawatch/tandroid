...
public class fk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public fk0(int i10, int i11, Context context, org.telegram.ui.ActionBar.n2 n2Var, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        paint2.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.i6, e6Var));
    ...
    public static void a(fk0 fk0Var) {
        ...
        zg.c0 c0Var = new zg.c0(fk0Var.M0, fk0Var.t0, fk0Var.V, fk0Var.d0, fk0Var, fk0Var.k0, fk0Var.a);
        fk0Var.x0 = c0Var;
        ah.c cVar = fk0Var.Z0;
        boolean z10 = true;
        if (cVar != null) {
            dh.e eVar = fk0Var.a1;
            org.telegram.ui.y51 y51Var = c0Var.m.f0;
            y51Var.x = true;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f23 != 1.0f) {
                ...
                p0Var = this.l0;
                i10 = this.M0;
                if (p0Var != null && i10 != 5 && ((ek0Var = this.g0) == null || ek0Var.j())) {
                    f22 = this.n0;
                    if (f22 != 1.0f) {
                ...
                if (this.v != 0.0f) {
                    ...
                    if (getAlpha() == 1.0f || i18 == 5) {
                        ...
                        while (i19 < w0Var3.getChildCount()) {
                            ...
                            float f34 = f25;
                            if (childAt instanceof dk0) {
                                dk0 dk0Var = (dk0) w0Var3.getChildAt(i19);
                                i14 = i19;
                                if (this.B0 != 0.0f) {
                                    i13 = save3;
                                ...
                                if (p0Var3.equals(this.l0)) {
                                    ...
                                    if (!this.r0) {
                                        if (this.Q == null) {
                                            ...
                                            if (ck0Var3.getImageReceiver().hasBitmapImage() || ((o5Var = ck0Var3.e) != null && (l4Var = o5Var.k) != null && l4Var.hasBitmapImage())) {
                                        ...
                                        if (this.n0 == f21) {
                                            ...
                                            if (System.currentTimeMillis() - this.s0 > 300) {
                                                ...
                                                w0Var2 = w0Var3;
                                                this.g0.h(dk0Var, dk0Var.e, true, false);
                                                canvas2.save();
                                                x10 = dk0Var.getX() + w0Var2.getX();
                                                ...
                                                canvas2.translate(dk0Var.getX() + w0Var2.getX(), dk0Var.getY() + w0Var2.getY());
                                ...
                                if (!this.N0 && (!dk0Var.r || ck0Var.getImageReceiver().getLottieAnimation() != null)) {
                                    if ((dk0Var.getMeasuredWidth() / f14) + dk0Var.getX() > 0.0f && (dk0Var.getMeasuredWidth() / f14) + dk0Var.getX() < w0Var2.getWidth()) {
                                            ...
                                            if ((childAt.getMeasuredWidth() / f14) + childAt.getX() <= f17 || (childAt.getMeasuredWidth() / f14) + childAt.getX() >= w0Var2.getWidth()) {
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    ...
                                                    if (z11) {
                                                        ...
                                                        ((ValueAnimator) srVar3.b).setStartDelay((long) (abs * ((fk0) srVar3.c).c));
                        ...
                        if (pullingLeftProgress > 0.0f) {
                            ...
                            dk0Var2.setTranslationX(((w0Var.getX() + f36) - clamp2) + (-((i18 == 1 || i18 == 2) ? AndroidUtilities.dp(8.0f) : AndroidUtilities.dp(20.0f))));
                        ...
                        if (!this.c1 && this.x0 != null) {
                            int A = (int) org.telegram.messenger.y0.A(1.0f, this.w0, Utilities.clamp(1.0f - (this.w0 / 0.2f), 1.0f, 0.0f), 255.0f);
                            canvas.save();
    ...
    public final void p(MessageObject messageObject, TLRPC.ChatFull chatFull, boolean z10) {
        ...
        if (q()) {
            ...
            if (i16 < arrayList2.size()) {
                dk0.a(this.z0, (zg.p0) arrayList2.get(i16), -1);
            }
        } else {
        ...
        for (int i18 = 0; i18 < arrayList8.size(); i18++) {
            ...
            arrayList9.add(new wj0(p0Var3.f == null ? 3 : 0, p0Var3));
        }
    ...
    public void setHint(CharSequence charSequence) {
        ...
        if (this.R0 == null) {
            ...
            if (i10 == 1 || i10 == 2 || i10 == 4) {
                ...
                this.R0.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.z6, e6Var));
            }
