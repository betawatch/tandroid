...
public class InstantCameraVideoEncoderOverlayHelper {
    ...
    public InstantCameraVideoEncoderOverlayHelper(int i, int i2) {
        ...
        this.videoWidth = i;
        this.videoHeight = i2;
        float[] fArr3 = new float[NotificationCenter.channelSuggestedBotsUpdate];
        ...
        FloatBuffer asFloatBuffer = ByteBuffer.allocateDirect(NotificationCenter.fileNewChunkAvailable).order(ByteOrder.nativeOrder()).asFloatBuffer();
