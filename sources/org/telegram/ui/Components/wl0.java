...
public class wl0 extends RecyclerView implements bh.a {
    ...
    public static void P0(Canvas canvas, RectF rectF, float f7, float f10, float f11, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.j6.l1(f11, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.d6, e6Var)));
        if (f7 == f10) {
    ...
    public final void L0(boolean z10) {
        ...
        if (!z10) {
            ...
            if (i10 == 0) {
                ...
                alpha.setDuration(150L).setListener(new ed0(this, 8)).start();
            }
        }
        if (this.A1) {
            int i11 = T0 ? 4 : 0;
    ...
    public final void Q0(Canvas canvas, View view, View view2, boolean z10, boolean z11) {
        ...
        float bottomInfoMargin = view2 instanceof t80 ? ((t80) view2).getBottomInfoMargin() : 0.0f;
        RectF rectF = AndroidUtilities.rectTmp;
    ...
    */
        ...
        if (bl0Var != null) {
            ...
            if (bl0Var.d || bl0Var.e) {
                for (int i10 = 0; i10 < wl0Var.getChildCount(); i10++) {
                    ...
                    int S = RecyclerView.S(childAt);
                    if (S >= 0 && !bl0Var.c.contains(childAt)) {
                        Float f7 = (Float) bl0Var.b.get(S, null);
                        if (f7 == null) {
    ...
    public final void f1(hl0 hl0Var, int i10, boolean z10) {
        kc0 kc0Var = this.V1;
        if (kc0Var != null) {
            AndroidUtilities.cancelRunOnUIThread(kc0Var);
            this.V1 = null;
        }
        s4.c1 L = L(hl0Var.run());
        if (L == null) {
            if (z10) {
                this.U1 = hl0Var;
                return;
    ...
    public final void g0(View view) {
        ...
        s4.c1 H = H(view);
        if (H != null) {
            view.setEnabled(((vl0) getAdapter()).D(H));
            if (this.q2) {
    ...
    public final void m1(wl0 wl0Var, boolean z10) {
        ViewParent parent;
    ...
    public final void o1(nl0 nl0Var, long j3) {
        this.Y0 = nl0Var;
        ka.c cVar = this.M1;
        boolean z10 = nl0Var != null;
        k20 k20Var = (k20) cVar.b;
        k20Var.t = z10;
        k20Var.u = j3;
    }
    ...
    public wl0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.U0 = true;
        this.k1 = true;
        this.s1 = -1;
        ...
        this.D2 = new org.telegram.ui.Cells.t6(this, 21);
        this.P2 = new Path();
        this.p2 = e6Var;
        ot otVar = new ot();
        this.E2 = otVar;
        setEdgeEffectFactory(otVar);
        setGlowColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.s8, e6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, e6Var), 2, -1);
        this.D1 = f02;
        ...
        super.setOnScrollListener(new tb0(this, 4));
    ...
    public void setOnItemLongClickListener(nl0 nl0Var) {
        o1(nl0Var, ViewConfiguration.getLongPressTimeout());
    }
}
