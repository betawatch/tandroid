...
public class wl0 extends RecyclerView implements bh.a {
            ...
            if (layoutManager instanceof s4.c0) {
                ...
                if (c0Var.o == 1) {
                    if (this.g1 == null) {
                        ...
                        if ((!this.K1 && !z10) || (dl0Var = this.f1) == null || dl0Var.n) {
                            return;
                        }
                        ...
                        if (adapter instanceof el0) {
                            ...
                            this.f1.setIsVisible(el0Var.E(this));
                    ...
                    if ((this.K1 || z10) && (dl0Var2 = this.f1) != null && !dl0Var2.n && (getAdapter() instanceof el0)) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (rectF.contains(min2, min)) {
                ...
                if (i11 != S) {
                    ...
                    org.telegram.ui.wn wnVar2 = this.h2.d;
                    org.telegram.ui.jm jmVar = wnVar2.A0;
                    ArrayList arrayList = wnVar2.u6;
                    int i13 = S - jmVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) wnVar2.x6.f(messageObject.getGroupId())) != null) {
                            ArrayList<MessageObject> arrayList2 = groupedMessages.messages;
                            S = arrayList.indexOf(arrayList2.get(z10 ? 0 : arrayList2.size() - 1)) + wnVar2.A0.J;
                        }
                    }
                    if (z10) {
                        int i14 = this.g2;
    ...
    */
            ...
            for (int i14 = 0; i14 < getChildCount(); i14++) {
                ...
                if (childAt2 != this.c1 && childAt2.getVisibility() == 0 && childAt2.getAlpha() > 0.0f && ((Boolean) this.H2.a.run(childAt2)).booleanValue()) {
                    ...
                    if (!T.j() || childAt2.getAlpha() >= 1.0f) {
                        ...
                        tl0Var2.b = G0;
                        tl0Var2.c = alpha2;
                        arrayList2.add(tl0Var2);
                    }
                }
            }
            ArrayList arrayList3 = this.O2;
            float f12 = this.L2;
            ArrayList arrayList4 = ul0.a;
            if (arrayList3 == null || arrayList3.isEmpty()) {
                f7 = 1.0f;
            } else {
                Collections.sort(arrayList3, new org.telegram.ui.cf(13));
                arrayList4.clear();
                int i16 = 0;
                while (i16 < arrayList3.size()) {
                    float f13 = ((tl0) arrayList3.get(i16)).b;
                    int i17 = i16 + 1;
                    while (i17 < arrayList3.size() && ((tl0) arrayList3.get(i17)).a <= f13 + 1.5f) {
                        f13 = Math.max(f13, ((tl0) arrayList3.get(i17)).b);
                        i17++;
                    }
                    ...
                    for (int i18 = i16; i18 < i17; i18++) {
                        tl0 tl0Var3 = (tl0) arrayList3.get(i18);
                        if (tl0Var3.c >= 0.99f) {
                            f16 = Math.min(f16, tl0Var3.a);
                            f17 = Math.max(f17, tl0Var3.b);
                        }
                    }
                    boolean z10 = f16 != Float.MAX_VALUE;
                    float f18 = 0.0f;
                    for (int i19 = i16; i19 < i17; i19++) {
                        tl0 tl0Var4 = (tl0) arrayList3.get(i19);
                        f14 = Math.min(f14, tl0Var4.a);
                        f15 = Math.max(f15, tl0Var4.b);
                        f18 = Math.max(f18, tl0Var4.c);
                    }
                    if (f18 >= 0.001f) {
                        if (z10) {
                            float f19 = 0.0f;
                            ...
                            for (int i20 = i16; i20 < i17; i20++) {
                                tl0 tl0Var6 = (tl0) arrayList3.get(i20);
                                float f20 = tl0Var6.c;
                                if (f20 < 0.99f) {
                                    float f21 = tl0Var6.a;
                                    if (f21 < f16) {
                            ...
                            float f23 = 0.0f;
                            while (i16 < i17) {
                                tl0 tl0Var8 = (tl0) arrayList3.get(i16);
                                float f24 = tl0Var8.c;
                                if (f24 < 0.99f) {
                                    float f25 = tl0Var8.b;
                                    if (f25 > f17) {
        ...
        if (bl0Var != null) {
            ...
            if (bl0Var.d || bl0Var.e) {
                for (int i10 = 0; i10 < wl0Var.getChildCount(); i10++) {
                    ...
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !bl0Var.c.contains(childAt)) {
                        Float f7 = (Float) bl0Var.b.get(R, null);
                        if (f7 == null) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (dl0Var != null) {
            this.J1 = true;
            int paddingTop = i11 + (dl0Var.a ? getPaddingTop() : dl0Var.h0);
            dl0 dl0Var2 = this.f1;
            if (dl0Var2.g0) {
                dl0Var2.layout(0, paddingTop, dl0Var2.getMeasuredWidth(), this.f1.getMeasuredHeight() + paddingTop);
            } else {
                int measuredWidth = getMeasuredWidth() - this.f1.getMeasuredWidth();
                dl0 dl0Var3 = this.f1;
                dl0Var3.layout(measuredWidth, paddingTop, dl0Var3.getMeasuredWidth() + measuredWidth, this.f1.getMeasuredHeight() + paddingTop);
            }
            this.J1 = false;
        }
        L0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (dl0Var != null && dl0Var.getLayoutParams() != null) {
            dl0 dl0Var2 = this.f1;
            int measuredHeight = (getMeasuredHeight() - (dl0Var2.a ? getPaddingTop() : dl0Var2.h0)) - getPaddingBottom();
    ...
    public void q1(int i10, float f7, boolean z10) {
        r1(new ei.c(5), i10, f7, new mv(this, 16), z10);
    }
    ...
    public void setFastScrollEnabled(int i10) {
        this.f1 = new dl0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.f1);
        }
    }
    ...
    public wl0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        super.setOnScrollListener(new ug0(this, i10));
