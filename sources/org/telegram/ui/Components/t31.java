...
public abstract class t31 {
    ...
    public t31(org.telegram.ui.Cells.u1 u1Var, wo0 wo0Var) {
        ...
        ij0 ij0Var = new ij0(org.telegram.messenger.R.raw.transcribe_out, AndroidUtilities.dp(26.0f), AndroidUtilities.dp(26.0f));
        this.p = ij0Var;
        ij0Var.M(0);
        ij0Var.setCallback(u1Var);
        final int i10 = 0;
        ij0Var.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.r31
        ...
        ij0Var.J(true);
        ij0 ij0Var2 = new ij0(org.telegram.messenger.R.raw.transcribe_in, AndroidUtilities.dp(26.0f), AndroidUtilities.dp(26.0f));
        this.n = ij0Var2;
        ij0Var2.M(0);
        ij0Var2.setCallback(u1Var);
        ij0Var2.R(u1Var);
        final int i11 = 1;
        ij0Var2.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.r31
            public final /* synthetic */ t31 b;
        ...
        this.x = z10;
        qr qrVar = qr.h;
        this.l = new e6(u1Var, 250L, qrVar);
        this.j = new e6(u1Var, 250L, qrVar);
    }
    ...
    public static void c(Path path, int i10, int i11, int i12, int i13, float f7, float f10) {
        ...
        float a2 = w7.q.a(f7, 0.0f, 1.0f);
        if (w7.q.a(f10, 0.0f, 1.0f) - a2 <= 0.0f) {
            return;
        }
    ...
    public static boolean g(MessageObject messageObject, long j3, String str) {
        try {
            ...
            if (messageObject2 != null && messageObject2.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new o31(str, messageObject2, j3, 0));
                return true;
            }
            return false;
    ...
    public static void u(MessageObject messageObject, boolean z10) {
        ...
        if (z10) {
            AndroidUtilities.runOnUIThread(new xq0(messageObject, 20));
        }
    }
    ...
    public static void w(final MessageObject messageObject, boolean z10, final org.telegram.ui.Cells.l1 l1Var) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_transcribeAudio, new RequestDelegate() { // from class: org.telegram.ui.Components.q31
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (z12) {
                    ...
                    if ((tL_messages_transcribedAudio.flags & 2) != 0) {
                        ...
                        AndroidUtilities.runOnUIThread(new po0(13, l1Var2, tL_messages_transcribedAudio));
                    }
                    if (t31.O == null) {
                        t31.O = new HashMap();
                    }
                    t31.O.put(Long.valueOf(j3), messageObject2);
                    ...
                    if (tL_error != null && (str = tL_error.text) != null && str.startsWith("FLOOD_WAIT_")) {
                        ...
                        AndroidUtilities.runOnUIThread(new wm(messageObject2, l1Var2, i14, 24));
                        return;
                    }
                    j3 = 0;
                    z11 = true;
                ...
                if (z11) {
                    AndroidUtilities.runOnUIThread(new o31(str4, messageObject2, j3, 1), Math.max(0L, 350 - elapsedRealtime2));
                }
            }
    ...
    public final void f(Canvas canvas, float f7) {
        ...
        if (f12 > 0.0f) {
            ...
            Paint M2 = u1Var.y7.shouldDrawWithoutBackground() ? u1Var.M2("paintChatActionBackground") : u1Var.M2("paintChatTimeBackground");
        ...
        if (this.y) {
            ij0 ij0Var = this.n;
            ij0Var.setAlpha((int) (this.m * f7));
            ij0Var.draw(canvas);
        } else {
            ij0 ij0Var2 = this.p;
            ij0Var2.setAlpha((int) (this.o * f7));
            ij0Var2.draw(canvas);
        }
    ...
    public final void m() {
        boolean z10;
        org.telegram.ui.Cells.u1 u1Var = this.r;
        if (u1Var == null) {
            return;
        }
        this.w = false;
        ...
        if (z10) {
            ...
            } else if (e(u1Var.getMessageObject()) || !(u1Var.getMessageObject() == null || u1Var.getMessageObject().messageOwner == null || TextUtils.isEmpty(u1Var.getMessageObject().messageOwner.voiceTranscription))) {
                w(u1Var.getMessageObject(), z12, u1Var.getDelegate());
    ...
    public final void q(float f7, int i10) {
        ...
        if (z10) {
            ij0 ij0Var = this.n;
            ij0Var.Z = true;
            ij0Var.Q(this.c, "Artboard Outlines");
            ij0Var.o();
            ij0Var.J(true);
            ij0Var.V(0L);
            int alpha = Color.alpha(i10);
            this.m = alpha;
            ij0Var.setAlpha(alpha);
            ij0 ij0Var2 = this.p;
            ij0Var2.Z = true;
            ij0Var2.Q(this.c, "Artboard Outlines");
            ij0Var2.o();
            ij0Var2.J(true);
            ij0Var2.V(0L);
            int alpha2 = Color.alpha(i10);
            this.o = alpha2;
            ij0Var2.setAlpha(alpha2);
        }
        if (this.g == null) {
    ...
    public final void r(boolean z10, boolean z11) {
        this.k = z10;
        wo0 wo0Var = this.s;
        if (!wo0Var.z && z10 && wo0Var.B.c <= 0.0f) {
            wo0Var.A = SystemClock.elapsedRealtime();
        }
        wo0Var.z = z10;
        org.telegram.ui.Cells.u1 u1Var = wo0Var.n;
        if (u1Var != null) {
            u1Var.invalidate();
        }
        e6 e6Var = this.l;
    ...
    public final void s(boolean z10, boolean z11) {
        ...
        if (this.i != z10 && (u1Var = this.r) != null) {
            u1Var.invalidate();
        }
        this.i = z10;
        if (z11) {
