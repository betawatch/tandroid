...
public abstract class d8 extends FrameLayout {
    ...
    public d8(Context context) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            addView(this.a[i10], w7.a6.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        ...
        this.n = animatorSet2;
        animatorSet2.addListener(new di.y2(this, i14, 5));
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.c8
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i12) {
                    case 0:
                        d8 d8Var = this.b;
                        d8Var.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        d8Var.invalidate();
                        break;
                    default:
                        d8 d8Var2 = this.b;
                        d8Var2.b[i14] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        d8Var2.invalidate();
                        break;
                }
            }
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.c8
            public final /* synthetic */ d8 b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i10) {
                    case 0:
                        d8 d8Var = this.b;
                        d8Var.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        d8Var.invalidate();
                        break;
                    default:
                        d8 d8Var2 = this.b;
                        d8Var2.b[i15] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        d8Var2.invalidate();
                        break;
                }
            }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (this.s > 0) {
            ...
            while (true) {
                ...
                if ((textView instanceof ba0) && ((ba0) textView).d) {
                    this.s = -1;
                    break;
                }
                i11++;
    ...
    public void setCustomPaddingRight(int i10) {
        ...
        for (TextView textView : this.a) {
            if (textView instanceof ba0) {
                ((ba0) textView).setCustomPaddingRight(i10);
            }
        }
        invalidate();
    }
