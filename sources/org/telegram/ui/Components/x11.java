...
public final class x11 extends FrameLayout {
    ...
    public x11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        super(context);
        this.I = editorAlert;
        ...
        while (i10 < 4) {
            ...
            this.n[i10].addTextChangedListener(new w11(this, i10));
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        int b10 = org.telegram.messenger.l0.b(20.0f, (i10 / 2) - (this.b * 2), 1);
        this.r = b10;
        int i14 = b10 * 2;
        int i15 = b10 * 2;
