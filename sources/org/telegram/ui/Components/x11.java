...
public final class x11 {
    ...
    public final void a(float f7, float f10, Canvas canvas, Paint paint, RectF rectF) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            paint.setAlpha((int) (w11Var2.f * 255.0f * f10));
            canvas.drawPoint(w11Var2.a, w11Var2.b, paint);
        }
        ...
        while (i12 < clamp) {
            ...
            if (this.b && this.f) {
                ...
                w11Var.a = AndroidUtilities.lerp(this.g, centerX, f11);
                w11Var.b = AndroidUtilities.lerp(this.h, centerY, f11);
            } else {
                w11Var.a = centerX;
                w11Var.b = centerY;
            }
            ...
            w11Var.c = (float) ((Math.cos(nextInt) * d11) - (Math.sin(nextInt) * d10));
            w11 w11Var3 = w11Var;
            w11Var3.d = (float) hg.c.e(nextInt, d10, Math.sin(nextInt) * d11);
            w11Var3.f = 1.0f;
            w11Var3.h = 0.0f;
            if (this.b) {
                w11Var3.g = Utilities.random.nextInt(200) + 600;
                w11Var3.e = (Utilities.random.nextFloat() * 20.0f) + 30.0f;
            } else {
                w11Var3.g = Utilities.random.nextInt(100) + 400;
        ...
        while (i13 < size2) {
            ...
            if (f12 >= f13) {
                ...
                w11Var4.f = 1.0f - AndroidUtilities.decelerateInterpolator.getInterpolation(f12 / f13);
                float f14 = w11Var4.a;
                float f15 = w11Var4.c;
                float f16 = w11Var4.e;
                float f17 = min;
                w11Var4.a = a4.a.B(f15 * f16, f17, 200.0f, f14);
                w11Var4.b = (((w11Var4.d * f16) * f17) / 200.0f) + w11Var4.b;
                w11Var4.h += f17;
            }
            i13++;
        }
