...
public final class t6 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public t6(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var, Runnable runnable, org.telegram.ui.ej ejVar) {
        super(context);
        this.a = i10;
        this.c = runnable;
        ...
        linearLayout.addView(imageView, w7.x5.t(80, 80, 49, 0, ejVar != null ? 14 : 0, 0, 14));
        ...
        if (ejVar != null) {
            ...
            g10.setOnClickListener(new s6(0, ejVar));
