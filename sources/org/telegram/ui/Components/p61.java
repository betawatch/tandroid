...
public final class p61 extends Drawable implements w5, x6, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public final void draw(Canvas canvas) {
        ...
        if (o61Var != null) {
            float f14 = width * 2;
            o61Var.setRoundRadius((int) (0.13f * f14));
            o61Var.setImageCoords(centerX - width, centerY - width, f14, f14);
            o61Var.draw(canvas);
        }
    }
        ...
        if (obj != null && p61.class == obj.getClass()) {
            ...
            if (this.b == p61Var.b) {
                ...
                if (i10 == p20Var2.d && p20Var.e == p20Var2.e && p20Var.f == p20Var2.f && p20Var.g == p20Var2.g) {
                    ...
                    if (tL_videoSizeStickerMarkup2 != null && (tL_videoSizeStickerMarkup = p61Var.w) != null && tL_videoSizeStickerMarkup2.stickerset.id == tL_videoSizeStickerMarkup.stickerset.id && tL_videoSizeStickerMarkup2.sticker_id == tL_videoSizeStickerMarkup.sticker_id) {
                        return true;
                    }
                }
            }
