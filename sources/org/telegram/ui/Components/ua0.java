...
public final class ua0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public ua0(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, ArrayList arrayList, int i11) {
        super(context);
        String str;
        ...
        if (str == null || document == null) {
            ...
            this.f = h90Var;
            h90Var.l = org.telegram.ui.ActionBar.h6.G8;
            h90Var.m = org.telegram.ui.ActionBar.h6.i6;
            h90Var.j(4.0f);
            return;
        }
