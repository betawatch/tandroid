...
public final class ua0 implements org.telegram.ui.Cells.k1 {
    ...
    public final void R0(org.telegram.ui.Cells.t1 t1Var, CharacterStyle characterStyle, boolean z10) {
        va0 va0Var = this.a;
        wa0 wa0Var = va0Var.c;
        if (wa0Var.a != 2 || wa0Var.V.d.currentLink == characterStyle || t1Var.getMessageObject() == null || !(characterStyle instanceof URLSpan)) {
            return;
        }
        String url = ((URLSpan) characterStyle).getURL();
        cb0 cb0Var = va0Var.c.V;
        ...
        org.telegram.ui.qn qnVar = cb0Var.c;
        if (qnVar != null && url != null) {
            qnVar.Ya(url, true);
        }
        wa0.b(va0Var.c, t1Var);
    }
