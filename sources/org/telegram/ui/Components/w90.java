...
public final class w90 extends v7.i0 {
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        i11++;
                        boolean z10 = obj instanceof v90;
                        if (z10) {
                            v90 v90Var2 = (v90) obj;
                            if ("summary".equalsIgnoreCase(v90Var2.a.a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(v90Var2.c, sb2);
                                String trim = sb2.toString().trim();
                                pageblockdetails.title = trim.isEmpty() ? new TL_iv.textEmpty() : aa0.j(trim);
                            }
                        }
                        if (obj instanceof u90) {
                            arrayList2.add(((u90) obj).a);
                        } else if (z10) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof u90) {
                TL_iv.PageBlock pageBlock = ((u90) obj).a;
    ...
    public final void f(bf.h hVar) {
        ...
        pageblockpreformatted.text = aa0.d(aa0.j(hVar.k));
        String str = hVar.j;
        if (str == null) {
            str = "";
        }
    ...
    public final void j(bf.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = aa0.d(aa0.j(lVar.g));
    ...
    public final void k(bf.n nVar) {
        if (!(nVar instanceof we.a)) {
            ...
            pageblockparagraph.text = aa0.c(((zc.a) nVar).g);
    ...
    */
            ...
            if (pVar instanceof bf.o) {
                if (z10) {
                    ...
                    if (!arrayDeque.isEmpty()) {
                        ...
                        tL_pageListOrderedItemText.text = aa0.d(aa0.a(pVar, pageblockorderedlist));
                ...
                tL_pageListOrderedItemText2.text = aa0.d(aa0.a(pVar, pageblockorderedlist));
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.c.add(new u90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        while (i10 < size) {
            ...
            i10++;
            u90 u90Var = (u90) obj;
            hashMap.put(Integer.valueOf(u90Var.b), u90Var);
        }
        ...
        v90 v90Var = new v90(null, ConnectionsManager.DEFAULT_DATACENTER_ID);
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).b <= u90Var2.b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.b;
                if (i15 >= u90Var2.b) {
                    while (arrayDeque.peek() != v90Var && ((v90) arrayDeque.peek()).b <= i16) {
                        arrayDeque.pop();
                    }
                    v90 v90Var2 = new v90(aVar4, aVar4.d);
                    ((v90) arrayDeque.peek()).c.add(v90Var2);
                    arrayDeque.push(v90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != v90Var && ((v90) arrayDeque.peek()).b <= u90Var2.b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = u90Var2.a;
            ((v90) arrayDeque.peek()).c.add(u90Var2);
        }
        A(0, v90Var.c, this.a);
    }
}
