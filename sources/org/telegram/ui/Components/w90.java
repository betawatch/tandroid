...
public final class w90 extends pv0 {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.w0) {
            case 0:
                ...
                z90 z90Var = ca0Var.V;
                if (z90Var != null && (rt0Var = (rt0VarArr = z90Var.k0)[0]) != null && rt0Var.h.getFastScroll() != null && rt0VarArr[0].h.getFastScroll().n) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.w0) {
            case 0:
                ca0 ca0Var = (ca0) this.y0;
                p6[] p6VarArr = ca0Var.x;
                org.telegram.ui.ActionBar.i5[] i5VarArr = ca0Var.w;
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    if (i5VarArr[i12] != null) {
                        ((FrameLayout.LayoutParams) i5VarArr[i12].getLayoutParams()).topMargin = AndroidUtilities.dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 5.0f : 4.0f) + org.telegram.messenger.ul.y(22.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2, 2);
                    }
                ...
                ((FrameLayout.LayoutParams) ca0Var.y.getLayoutParams()).topMargin = org.telegram.messenger.ul.y(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
