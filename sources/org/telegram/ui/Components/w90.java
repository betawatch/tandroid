            ...
            case 0:
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    if (j5VarArr[i12] != null) {
                        ((FrameLayout.LayoutParams) j5VarArr[i12].getLayoutParams()).topMargin = AndroidUtilities.dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 5.0f : 4.0f) + org.telegram.messenger.vl.y(22.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2, 2);
                    }
                ...
                ((FrameLayout.LayoutParams) ca0Var.y.getLayoutParams()).topMargin = org.telegram.messenger.vl.y(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
