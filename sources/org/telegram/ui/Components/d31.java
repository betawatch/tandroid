...
public abstract class d31 {
    ...
    public d31(org.telegram.ui.Cells.t1 t1Var, io0 io0Var) {
        ...
        yi0 yi0Var = new yi0(org.telegram.messenger.R.raw.transcribe_out, AndroidUtilities.dp(26.0f), AndroidUtilities.dp(26.0f));
        this.p = yi0Var;
        yi0Var.M(0);
        yi0Var.setCallback(t1Var);
        final int i10 = 0;
        yi0Var.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.b31
        ...
        yi0Var.J(true);
        yi0 yi0Var2 = new yi0(org.telegram.messenger.R.raw.transcribe_in, AndroidUtilities.dp(26.0f), AndroidUtilities.dp(26.0f));
        this.n = yi0Var2;
        yi0Var2.M(0);
        yi0Var2.setCallback(t1Var);
        yi0Var2.R(t1Var);
        final int i11 = 1;
        yi0Var2.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.b31
            public final /* synthetic */ d31 b;
        ...
        this.x = z10;
        rr rrVar = rr.h;
        this.l = new e6(t1Var, 250L, rrVar);
        this.j = new e6(t1Var, 250L, rrVar);
    }
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (z12) {
                    ...
                    if (tL_error != null && (str = tL_error.text) != null && str.startsWith("FLOOD_WAIT_")) {
                        ...
                        AndroidUtilities.runOnUIThread(new xm(messageObject2, k1Var2, i14, 24));
                        return;
                    }
                    j3 = 0;
                    z11 = true;
    ...
    public final void f(Canvas canvas, float f7) {
        ...
        if (f12 > 0.0f) {
            ...
            if (M2 == t1Var.M2("paintChatActionBackground") && t1Var.R2()) {
                ...
                org.telegram.ui.ActionBar.h6.h2.setAlpha((int) (alpha2 * f12));
                canvas.drawRect(rect, org.telegram.ui.ActionBar.h6.h2);
        ...
        if (this.y) {
            yi0 yi0Var = this.n;
            yi0Var.setAlpha((int) (this.m * f7));
            yi0Var.draw(canvas);
        } else {
            yi0 yi0Var2 = this.p;
            yi0Var2.setAlpha((int) (this.o * f7));
            yi0Var2.draw(canvas);
        }
    ...
    public final void q(float f7, int i10) {
        ...
        this.a = k10;
        this.e = f7;
        this.d = org.telegram.ui.ActionBar.h6.v(k10, i0.a.k(i10, (int) (Color.alpha(i10) * (org.telegram.ui.ActionBar.h6.I.q() ? 0.3f : 0.2f))));
        if (this.f == null) {
            this.f = new Paint();
        }
        ...
        if (z10) {
            yi0 yi0Var = this.n;
            yi0Var.Z = true;
            yi0Var.Q(this.c, "Artboard Outlines");
            yi0Var.o();
            yi0Var.J(true);
            yi0Var.V(0L);
            int alpha = Color.alpha(i10);
            this.m = alpha;
            yi0Var.setAlpha(alpha);
            yi0 yi0Var2 = this.p;
            yi0Var2.Z = true;
            yi0Var2.Q(this.c, "Artboard Outlines");
            yi0Var2.o();
            yi0Var2.J(true);
            yi0Var2.V(0L);
            int alpha2 = Color.alpha(i10);
            this.o = alpha2;
            yi0Var2.setAlpha(alpha2);
        }
        if (this.g == null) {
