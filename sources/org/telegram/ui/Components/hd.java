...
public final class hd extends Drawable {
    ...
    public hd() {
        ...
        gdVar.a = 1.0f;
        gdVar.b = 0.0f;
        gdVar.c = AndroidUtilities.dp(0.5f);
        ...
        gdVar2.a = 0.82f;
        gdVar2.b = 0.6f;
        gdVar2.c = AndroidUtilities.dp(0.0f);
    ...
    public final void b(Canvas canvas, gd gdVar, float f7, float f10, float f11) {
        ...
        float f12 = gdVar.c;
        float f13 = gdVar.d - f12;
        float f14 = this.v;
        float f15 = (f13 * f14) + f12;
        float B = com.google.android.gms.internal.vision.e2.B(f14, 1.0f, 0.0f, this.d * gdVar.e);
        float[] fArr = gdVar.u;
        float[] fArr2 = gdVar.v;
        float[] fArr3 = gdVar.w;
        char c12 = 0;
        for (int i11 = 0; i11 < i10; i11++) {
            float interpolation = H.getInterpolation(gdVar.o[i11]);
            float f16 = 1.0f - interpolation;
            fArr[i11] = (gdVar.l[i11] * interpolation) + (gdVar.k[i11] * f16);
            fArr3[i11] = (gdVar.n[i11] * interpolation) + (gdVar.m[i11] * f16);
        }
        float f17 = this.g;
        char c13 = 2;
        if (f17 > 0.0f) {
        ...
        while (i15 < i10) {
            ...
            gdVar.q[i15] = (f31 * f33) + f7 + fArr5[c10];
            gdVar.r[i15] = (f32 * f33) + f10 + fArr5[1];
            gdVar.s[i15] = fArr5[c11];
            gdVar.t[i15] = fArr5[3];
            i15++;
            c12 = 0;
            c13 = 2;
        ...
        Path path = this.y;
        path.rewind();
        path.moveTo(gdVar.q[0], gdVar.r[0]);
        int i16 = 0;
        while (i16 < i10) {
            int i17 = i16 + 1;
            ...
            float[] fArr10 = gdVar.r;
            float f38 = fArr10[i16];
            float[] fArr11 = gdVar.t;
    ...
    public final float c() {
        ...
        float f15 = (f13 * f14) + f12;
        gd gdVar2 = this.r;
        return Math.max(f15, (f14 * gdVar2.e) + (f11 * gdVar2.f) + gdVar2.d);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float B2 = com.google.android.gms.internal.vision.e2.B((float) Math.sin(this.s + gdVar.b), 0.5f, 0.5f, f17 * gdVar.f * f15);
