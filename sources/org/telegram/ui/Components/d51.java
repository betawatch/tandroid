...
public final class d51 extends aw0 {
    ...
    public final float Z() {
        e51 e51Var = this.E0;
        return Math.min(1.0f, Math.max(0.0f, e51Var.f / (e51Var.b * 2.0f)));
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        s51 s51Var = e51Var.e;
        int i12 = e51Var.b;
        GradientDrawable gradientDrawable = e51Var.c;
        float Z = Z();
        boolean z10 = Z == 0.0f && !e51Var.isDismissed();
        if (this.z0 != z10) {
        ...
        if (this.D0 != z11) {
            this.D0 = z11;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(e51Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) > 0.721f;
            boolean z13 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(e51Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f;
            if (!z11) {
                z12 = z13;
            }
        ...
        if (this.B0 > 0.0f) {
            int themedColor = e51Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5);
            Paint paint = this.w0;
            paint.setColor(themedColor);
            int max = (int) Math.max(0.0f, s51Var.getTranslationY() + (AndroidUtilities.statusBarHeight - i12) + ((1.0f - Z()) * i12) + e51Var.f + AndroidUtilities.dp(24.0f));
            i10 = ((org.telegram.ui.ActionBar.f3) e51Var).backgroundPaddingLeft;
        ...
        gradientDrawable.setColor(i0.a.k(e51Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii), (int) (Color.alpha(r5) * Z)));
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.l0.C(10.0f, e51Var.f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + e51Var.f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate(0.0f, e51Var.e.getTranslationY() + i15);
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(e51Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
            float[] fArr = this.C0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
            ...
            i11 = ((org.telegram.ui.ActionBar.f3) e51Var).backgroundPaddingLeft;
            int i17 = e51Var.f + i14;
            int width = getWidth();
            i12 = ((org.telegram.ui.ActionBar.f3) e51Var).backgroundPaddingLeft;
            gradientDrawable.setBounds(i11, i17, width - i12, AndroidUtilities.dp(24.0f) + e51Var.f + i14);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            e51 e51Var = this.E0;
            if (e51Var.f != 0 && motionEvent.getY() < e51Var.f) {
                e51Var.dismiss();
                return true;
            }
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        s51Var.setContentViewPaddingTop(i17);
