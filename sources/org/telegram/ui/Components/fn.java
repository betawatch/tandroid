...
public final class fn extends View {
    ...
    public /* synthetic */ fn(Context context, int i10) {
        super(context);
        this.a = i10;
    }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            case 12:
                ...
                break;
            case 13:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(org.telegram.ui.r50.B3 ? 0.0f : 8.0f), TLObject.FLAG_30));
                break;
            case 18:
