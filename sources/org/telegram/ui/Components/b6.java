...
public final class b6 extends BitmapDrawable implements Animatable, yf.c {
    ...
    public y5 s;
    public final pe.b s0;
    public final pe.b t0;
    ...
    public final void D(long j3) {
        ...
        y5 y5Var2 = this.n;
        if (y5Var2 == null && this.r == null) {
            x(false);
            return;
        }
        if (this.r != null) {
            if (y5Var2 == null || (z10 && !this.a && this.M < 0)) {
                y5 y5Var3 = this.n;
                if (y5Var3 != null) {
                    this.h.add(y5Var3);
                }
    ...
    public final void e(ImageReceiver imageReceiver) {
        if (this.t0.add(imageReceiver) && this.b0) {
            x(false);
        }
        h();
    }
    ...
    public final void k() {
        ...
        if (y5Var != null) {
            y5Var.b.recycle();
            Arrays.fill(y5Var.a, (Object) null);
            this.n = null;
        }
        y5 y5Var2 = this.v;
        if (y5Var2 != null) {
            y5Var2.b.recycle();
            Arrays.fill(y5Var2.a, (Object) null);
            this.v = null;
        }
        ...
        while (true) {
            ...
            if (i10 >= arrayList.size()) {
                ...
                y5Var3.b.recycle();
                Arrays.fill(y5Var3.a, (Object) null);
                i10++;
            }
        }
    }
    ...
    */
    public final void l(Canvas canvas, boolean z10, long j3, int i10) {
        ...
        if (!z10) {
            ...
            int i17 = z10 ? i10 + 1 : 0;
            y5 y5Var2 = this.n;
            BitmapShader[] bitmapShaderArr = y5Var2.a;
            if (bitmapShaderArr[i17] == null) {
                Bitmap bitmap = y5Var2.b;
    ...
    public final Bitmap r(boolean z10) {
        ...
        if (this.v == null) {
            if (this.h.isEmpty()) {
                float f7 = this.d[0];
                float f10 = this.m0;
                this.v = new y5(Bitmap.createBitmap((int) (f7 * f10), (int) (r0[1] * f10), Bitmap.Config.ARGB_8888));
            } else {
    ...
    public final void u() {
        ...
        if (this.e == null) {
            ...
            y5 y5Var2 = this.r;
            if (y5Var2 != null) {
                arrayList.add(y5Var2.b);
            }
            y5 y5Var3 = this.s;
            if (y5Var3 != null) {
                arrayList.add(y5Var3.b);
            }
            y5 y5Var4 = this.v;
            if (y5Var4 != null) {
                arrayList.add(y5Var4.b);
            }
            ...
            if ((this.n == null || !this.f) && g() && !this.w) {
                ...
                if (!this.v0) {
                    ...
                    if (z10 && (z5Var = this.e) != null) {
                        this.f0.cancelRunnable(z5Var);
                    }
                    DispatchQueue dispatchQueue = this.f0;
                    z5 z5Var3 = this.H0;
                    this.e = z5Var3;
                    dispatchQueue.postRunnable(z5Var3, 0L);
                } else if (this.x0) {
                    z5 z5Var4 = this.H0;
                    this.e = z5Var4;
                    DispatchQueuePoolBackground.execute(z5Var4);
                } else {
                    ...
                    z5 z5Var5 = this.H0;
                    this.e = z5Var5;
                    scheduledThreadPoolExecutor.execute(z5Var5);
                }
                this.K0 = true;
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public b6(File file, boolean z10, long j3, int i10, TLRPC.Document document, ImageLocation imageLocation, Object obj, long j10, int i11, boolean z11, int i12, int i13, b2.n1 n1Var, int i14, boolean z12) {
        ?? r12;
        ?? r13;
        long j11;
        int[] iArr = new int[8];
        ...
        this.p0 = new RectF[2];
        this.q0 = new Paint[2];
        this.s0 = new pe.b(true);
        this.t0 = new pe.b(true);
        this.w0 = true;
        this.B0 = new z5(this, 2);
        this.E0 = new z5(this, 3);
        this.F0 = new z5(this, 4);
        this.G0 = 0;
        this.H0 = new z5(this, 5);
        this.I0 = new z5(this, 6);
        this.S0 = new a6(this, 0);
        this.G = file;
        ...
        this.j0 = i12;
        this.k0 = z12;
        boolean z13 = n1Var != null && i12 > 0 && i13 > 0;
        this.l0 = z13;
        this.o0 = document;
        getPaint().setFlags(3);
        ...
        if (!z10 || z13) {
            ...
            if (this.d0 != null && (iArr[0] > 3840 || iArr[r12] > 3840)) {
                this.d0.f();
                this.d0 = null;
            }
            d();
        ...
        if (z13) {
            this.d0 = AnimatedFileNative.a(file.getAbsolutePath(), iArr, i11, j3, this.u0, z11);
            this.e0 = this.d0 == null && (!this.n0 || this.G0 > 15);
            if (this.d0 == null || (iArr[r13] <= 3840 && iArr[r12] <= 3840)) {
                j11 = j10;
