...
public abstract class b6 extends LinearLayout {
    ...
    public b6(Context context) {
        ...
        this.c = new xd.h(new t(this, 11), nr.h, 420L);
    }
    ...
    public final void a() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            a6 a6Var = (a6) this.a.get(childAt);
            if (childAt.getVisibility() == 0 && a6Var != null && a6Var.b) {
    ...
    public final void i(View view, boolean z4, boolean z10) {
        a6 a6Var;
        if (view == null || (a6Var = (a6) this.a.get(view)) == null) {
            return;
        }
        View view2 = a6Var.a;
        if (a6Var.b != z4) {
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (a6Var != null) {
                a6Var.e = i14;
                if (childAt.getVisibility() == 0 && a6Var.b) {
                    arrayList.add(a6Var);
                }
            }
        }
