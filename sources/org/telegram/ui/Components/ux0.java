...
public final class ux0 extends sl0 {
    ...
    public ux0(yx0 yx0Var, Context context) {
        this.r = yx0Var;
        this.c = context;
    }
    ...
    public final void l() {
        ...
        if (yx0Var.T != null) {
            ...
            this.h = 0;
            this.n = 0;
            for (int i12 = 0; i12 < yx0Var.T.size(); i12++) {
                TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) yx0Var.T.get(i12);
    ...
    public final void v(f2.m1 m1Var, int i10) {
        View view = m1Var.a;
        yx0 yx0Var = this.r;
        ArrayList arrayList = yx0Var.T;
        if (arrayList == null) {
            if (yx0Var.U != null) {
                ((org.telegram.ui.Cells.d8) view).setSticker((SendMessagesHelper.ImportingSticker) yx0Var.V.get(i10));
                return;
            }
            if (m1Var.f != 3) {
                ...
                d8Var.d(tL_messages_stickerSet.documents.get(i10), null, yx0Var.P, null, yx0Var.e0, yx0Var.O);
                d8Var.G.setOnClickListener(new sx0(0, this, d8Var));
                return;
            }
            return;
        }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 == 1) {
                ...
                g6Var2 = ((org.telegram.ui.ActionBar.h3) yx0Var).resourcesProvider;
                frameLayout2 = new org.telegram.ui.Cells.r3(8, this.c, g6Var2, true, false);
            } else if (i10 != 3) {
                frameLayout2 = null;
            } else {
                g6Var3 = ((org.telegram.ui.ActionBar.h3) yx0Var).resourcesProvider;
                FrameLayout rx0Var = new rx0(context);
                ...
                k7.e6.a(view);
                rx0Var.addView(view, k7.c6.e(56, 56, 17));
                frameLayout = rx0Var;
            }
            return new fl0(frameLayout2);
        }
        g6Var = ((org.telegram.ui.ActionBar.h3) yx0Var).resourcesProvider;
        tx0 tx0Var = new tx0(this, context, g6Var);
        tx0Var.getImageView().setLayerNum(7);
        frameLayout = tx0Var;
