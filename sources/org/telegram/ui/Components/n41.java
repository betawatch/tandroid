...
public abstract class n41 extends FrameLayout implements org.telegram.ui.ActionBar.b6 {
    public final int a;
    public final long b;
    ...
    public n41(Context context, org.telegram.ui.ActionBar.g6 g6Var, org.telegram.ui.xn xnVar) {
        super(context);
        ...
        this.c = xnVar;
        this.d = g6Var;
        org.telegram.ui.Cells.t3 t3Var = new org.telegram.ui.Cells.t3(context, z4, z4, false, 2);
        this.e = t3Var;
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.j41
            ...
            public final void onClick(View view) {
                ...
                if (!isPremium && (chat == null || !chat.autotranslation)) {
                    org.telegram.ui.xn xnVar2 = wkVar2.s;
                    i10 = ((org.telegram.ui.ActionBar.p2) xnVar2).currentAccount;
                    MessagesController.getNotificationsSettings(i10).edit().putInt("dialog_show_translate_count" + xnVar2.a(), 140).commit();
                    xnVar2.Qc(true);
                    return;
                }
                int i12 = wkVar2.a;
                ...
                m41 m41Var = new m41(wkVar2.getContext());
                m41Var.b = new z5(m41Var, 350L, pr.h);
                LinearLayout linearLayout2 = new LinearLayout(wkVar2.getContext());
                m41Var.addView(linearLayout2);
                ...
                long j10 = wkVar2.b;
                g1Var.setSubtext(w31.y(w31.D(translateController.getDialogTranslateTo(j10), null, null)));
                ...
                linearLayout.addView(m41Var, k7.c6.n(-1, 420));
                String dialogDetectedLanguage = translateController.getDialogDetectedLanguage(j10);
                w31.D(dialogDetectedLanguage, null, null);
                boolean[] zArr = wkVar2.r;
                String D = w31.D(dialogDetectedLanguage, zArr, null);
                ...
                g1Var.setOnClickListener(new eg.k2(new k41(wkVar2, new boolean[1], dialogTranslateTo, linearLayout2, suggestedLanguages, dialogDetectedLanguage, translateController, p1Var, languages), actionBarPopupWindow$ActionBarPopupWindowLayout, b10, 14));
                if (UserConfig.getInstance(i12).isPremium() && D != null) {
                    ...
                    g1Var3.g(qh.f3.b(formatString, g1Var3.getTextView().getPaint()), R.drawable.msg_block2, null);
                ...
                g1Var4.setOnClickListener(new r31(wkVar2, translateController, p1Var, 1));
                ...
                g90Var.setLinkTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.gc, g6Var2));
                g90Var.setEmojiColor(org.telegram.ui.ActionBar.k6.v0(i14, g6Var2));
                CharSequence concat = TextUtils.concat(AndroidUtilities.replaceTags(LocaleController.getString(R.string.CocoonPoweredBy)), " ", AndroidUtilities.premiumText(LocaleController.getString(R.string.CocoonPoweredByLink), new a90(29, wkVar2, p1Var)));
                ...
                g90Var.setText(qh.f3.b(AndroidUtilities.replaceCharSequence("🥚", AndroidUtilities.replaceCharSequence("🥚 ", concat, spannableStringBuilder2), spannableStringBuilder), g90Var.getPaint()));
                g90Var.setBackground(org.telegram.ui.ActionBar.k6.Y(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.i6, g6Var2), 0, 12));
                g90Var.setOnClickListener(new sx0(5, wkVar2, p1Var));
    ...
    public static void a(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        g90Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.y6, g6Var));
    ...
    public final void b() {
        ...
        if (isTranslatingDialog) {
            String D = w31.D(translateController.getDialogDetectedLanguage(j10), null, null);
            ...
            boolean[] zArr = this.r;
            String D2 = w31.D(dialogTranslateTo, zArr, null);
    ...
    public final void e() {
        ...
        t3Var.setBackground(org.telegram.ui.ActionBar.k6.W(dp, v03, dp2, dp2, dp2, dp2));
        org.telegram.ui.Cells.z M = org.telegram.ui.ActionBar.k6.M(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.i6, g6Var), 0, 0);
        ImageView imageView = this.n;
        imageView.setBackground(M);
        int v04 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.de, g6Var);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        imageView.setColorFilter(new PorterDuffColorFilter(v04, mode));
        this.f.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(i10, g6Var), mode));
    }
