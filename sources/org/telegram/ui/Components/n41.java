...
public abstract class n41 extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    public final int a;
    public final long b;
    public final org.telegram.ui.bo c;
    ...
    public n41(Context context, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.bo boVar) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.k41
            ...
            public final void onClick(View view) {
                ...
                if (!isPremium && (chat == null || !chat.autotranslation)) {
                    org.telegram.ui.bo boVar2 = alVar2.s;
                    i10 = ((org.telegram.ui.ActionBar.o2) boVar2).currentAccount;
                    MessagesController.getNotificationsSettings(i10).edit().putInt("dialog_show_translate_count" + boVar2.a(), 140).commit();
                    boVar2.Qc(true);
                    return;
                }
                int i12 = alVar2.a;
                ...
                m41 m41Var = new m41(alVar2.getContext());
                m41Var.b = new c6(m41Var, 350L, qr.h);
                ...
                c90Var.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, f6Var2), 0, 12));
    ...
    public static void a(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        c90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.y6, f6Var));
    ...
    public final void b() {
        ...
        if (isTranslatingDialog) {
            ...
            t3Var.setText(TextUtils.concat(spannableString, " ", zArr[0] ? LocaleController.formatString(R.string.TranslateToButton, E2) : LocaleController.formatString(R.string.TranslateToButtonOther, E2)));
        }
