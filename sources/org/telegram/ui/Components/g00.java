...
public final class g00 {
    ...
    public final int a(boolean z4) {
        ...
        j00 j00Var = this.h;
        int ceil = (int) Math.ceil(ph.f3.g(charSequence, j00Var.b));
        this.c = ceil;
        int i12 = 0;
        if (z4) {
            i10 = ((org.telegram.ui.ow) j00Var.G).a(this.a);
            if (i10 < 0) {
                i10 = 0;
            }
            if (z4) {
        ...
        if (i10 > 0) {
            i11 = AndroidUtilities.dp(-2.0f) + AndroidUtilities.dp(10.0f) + Math.max(AndroidUtilities.dp(7.333f), (int) Math.ceil(j00Var.c.measureText(String.format("%d", Integer.valueOf(i10)))));
        } else {
            if (!this.e && j00Var.n) {
