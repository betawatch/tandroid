...
public class BlurBehindDrawable {
            ...
            if (this.renderingBitmap == null || this.invalidate) {
                ...
                for (int i = 0; i < 2; i++) {
                    if (this.blurredBitmapTmp[i] == null || this.parentView.getMeasuredWidth() != this.lastW || this.parentView.getMeasuredHeight() != this.lastH) {
                        ...
                        try {
                            this.blurredBitmapTmp[i] = Bitmap.createBitmap((int) (measuredWidth / 15.0f), (int) (measuredHeight / 15.0f), Bitmap.Config.ARGB_8888);
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.BlurBehindDrawable$$ExternalSyntheticLambda0
                                ...
                                public final void run() {
                                    BlurBehindDrawable.$r8$lambda$XKdQ65x-Ao6OpibVcjPecf1TO_M(BlurBehindDrawable.this);
                                }
                            });
                            return;
                        }
    ...
    public static /* synthetic */ void $r8$lambda$XKdQ65x-Ao6OpibVcjPecf1TO_M(BlurBehindDrawable blurBehindDrawable) {
    ...
    private void generateBlurredBitmaps() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (bitmap == null || bitmap.getHeight() != dp || bitmapArr[i].getWidth() != this.parentView.getMeasuredWidth()) {
                ...
                bitmapArr2[i] = Bitmap.createBitmap(i2, (int) (dp / 15.0f), config);
                if (i == 1) {
                    this.blurredBitmapTmp[i].eraseColor(getThemedColor(Theme.key_windowBackgroundWhite));
                }
                this.blurCanvas[i] = new Canvas(this.blurredBitmapTmp[i]);
                ...
                this.emptyPaint.setAlpha(NotificationCenter.didReceiveSmsCode);
                if (i == 1) {
    ...
    public class BlurBackgroundTask implements Runnable {
        ...
        public void run() {
            ...
            while (i2 < 2) {
                ...
                BlurBehindDrawable.this.emptyPaint.setAlpha(NotificationCenter.didReceiveSmsCode);
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.BlurBehindDrawable$BlurBackgroundTask$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    BlurBehindDrawable.BlurBackgroundTask.$r8$lambda$6YsYc_bGOZr5O7Zc7yOqOW4CKoE(BlurBehindDrawable.BlurBackgroundTask.this);
                }
            });
        }

        public static /* synthetic */ void $r8$lambda$6YsYc_bGOZr5O7Zc7yOqOW4CKoE(BlurBackgroundTask blurBackgroundTask) {
