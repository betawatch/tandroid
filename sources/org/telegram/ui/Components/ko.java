...
public final class ko extends LinearLayout {
    ...
    public ko(Activity activity, View view, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        F = F == null ? org.telegram.ui.ActionBar.j6.S0("paintChatActionBackground") : F;
        int i11 = org.telegram.ui.ActionBar.j6.a;
        setBackground(new org.telegram.ui.ActionBar.w5(this, view, dp, F));
        ...
        if (i10 == 0) {
            ...
            kj0Var.d();
            addView(kj0Var, w7.a6.t(-2, -2, 49, 0, 2, 0, 0));
        }
        ...
        addView(textView3, w7.a6.t(-2, -2, (i10 != 2 ? LocaleController.isRTL ? 5 : 3 : 1) | 48, 0, 8, 0, i10 != 2 ? 0 : 8));
        for (int i12 = 0; i12 < 4; i12++) {
            LinearLayout f7 = org.telegram.messenger.a2.f(activity, 0);
            addView(f7, w7.a6.t(-2, -2, LocaleController.isRTL ? 5 : 3, 0, 8, 0, 0));
            ...
            if (LocaleController.isRTL) {
                ...
                if (i10 == 0) {
                    f7.addView(imageView, w7.a6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                ...
                if (i10 == 0) {
                    f7.addView(imageView, w7.a6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
