...
public final class va0 extends sh.m {
    ...
    public final void W() {
        gb0 gb0Var = this.Y.V;
        AndroidUtilities.cancelRunOnUIThread(gb0Var.y);
        gb0Var.y.run();
        if (this.W == -1) {
            this.W = NotificationCenter.getInstance(gb0Var.w).setAnimationInProgress(this.W, null, false);
        }
        Runnable runnable = this.X;
        if (runnable != null) {
            AndroidUtilities.cancelRunOnUIThread(runnable);
