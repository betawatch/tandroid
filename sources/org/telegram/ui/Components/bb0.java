...
public final class bb0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public int E;
    public int F;
    ...
    */
    public bb0(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, ArrayList arrayList, int i11) {
        super(context);
        String str;
        ...
        if (arrayList.size() > 1) {
            ...
            for (int i12 = 0; t51VarArr != null && i12 < t51VarArr.length; i12++) {
                int spanStart = replaceTags.getSpanStart(t51VarArr[i12]);
                int spanEnd = replaceTags.getSpanEnd(t51VarArr[i12]);
                replaceTags.removeSpan(t51VarArr[i12]);
        ...
        if (str == null || document == null) {
            ...
            this.f = o90Var;
            o90Var.l = org.telegram.ui.ActionBar.j6.G8;
            o90Var.m = org.telegram.ui.ActionBar.j6.i6;
            o90Var.j(4.0f);
            return;
        }
        SpannableString spannableString = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString.setSpan(new ya0(this, document, this.h.getFontMetricsInt()), 0, spannableString.length(), 33);
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        spannableString.setSpan(new za0(this, 0), 0, 1, 33);
        SpannableString spannableString2 = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString2.setSpan(new ab0(this, document, this.h.getFontMetricsInt()), 0, spannableString2.length(), 33);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.r != null) {
            ...
            this.r.draw(canvas);
            o90 o90Var = this.f;
            if (o90Var != null && this.e) {
                o90Var.setAlpha((int) ((1.0f - this.M) * 255.0f));
                Rect rect2 = this.N;
                if (rect2 != null && (rect = this.O) != null) {
                    float f7 = this.M;
                    Rect rect3 = AndroidUtilities.rectTmp2;
                    AndroidUtilities.lerp(rect2, rect, f7, rect3);
                    o90Var.setBounds(rect3);
                }
                o90Var.draw(canvas);
                invalidate();
            }
