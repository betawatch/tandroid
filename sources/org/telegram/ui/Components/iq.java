    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f9, int i12, int i13, int i14, Paint paint) {
        ...
        if (this.draw) {
            ...
            if (runnable != null) {
                ...
                if (i16 == 0) {
                    if (this.useLinkPaintColor && (paint instanceof TextPaint)) {
                        ...
                        if (this.usePaintColor) {
                            ...
                            if (i15 != 1) {
                                if (i15 == 2) {
                                    int e10 = j7.l1.e(i14, i12, 2, i12);
                                    Drawable drawable2 = this.drawable;
                                    i17 = e10 - (drawable2 != null ? drawable2.getBounds().height() / 2 : 0);
                                } else if (i15 == 0) {
                                    int i18 = i14 - i12;
                                    int i19 = this.size;
                                    if (i19 == 0) {
                                    ...
                                    i17 = j7.l1.e(i18, i19, 2, i12) + AndroidUtilities.dp(this.topOffset);
                                }
                            }
                            canvas.translate(f9 + this.translateX, i17 + this.translateY);
                ...
                canvas.translate(f9 + this.translateX, i172 + this.translateY);
                if (this.drawable != null) {
                }
                canvas.restore();
            }
            ...
            canvas.translate(f9 + this.translateX, i1722 + this.translateY);
            if (this.drawable != null) {
            }
            canvas.restore();
        }
