...
public final class yc extends Drawable {
    ...
    public yc() {
        ...
        xcVar.a = 1.0f;
        xcVar.b = 0.0f;
        xcVar.c = AndroidUtilities.dp(0.5f);
        ...
        xcVar2.a = 0.82f;
        xcVar2.b = 0.6f;
        xcVar2.c = AndroidUtilities.dp(0.0f);
    ...
    public final void b(Canvas canvas, xc xcVar, float f10, float f11, float f12) {
        ...
        float f13 = xcVar.c;
        float f14 = xcVar.d - f13;
        float f15 = this.v;
        float f16 = (f14 * f15) + f13;
        float B = e2.c.B(f15, 1.0f, 0.0f, this.d * xcVar.e);
        float[] fArr = xcVar.u;
        float[] fArr2 = xcVar.v;
        float[] fArr3 = xcVar.w;
        char c12 = 0;
        for (int i10 = 0; i10 < i9; i10++) {
            float interpolation = H.getInterpolation(xcVar.o[i10]);
            float f17 = 1.0f - interpolation;
            fArr[i10] = (xcVar.l[i10] * interpolation) + (xcVar.k[i10] * f17);
            fArr3[i10] = (xcVar.n[i10] * interpolation) + (xcVar.m[i10] * f17);
        }
        float f18 = this.g;
        char c13 = 2;
        if (f18 > 0.0f) {
            ...
            while (i11 < 2) {
                ...
                while (i12 < i9) {
                    int i13 = i12 + 1;
                    float f19 = (fArr[i12 == 0 ? i9 - 1 : i12 - 1] + fArr[i13 == i9 ? 0 : i13]) * 0.5f;
                    float f20 = fArr[i12];
                    fArr2[i12] = e2.c.z(f19, f20, f18, f20);
                    i12 = i13;
                }
                i11++;
                float[] fArr4 = fArr2;
        ...
        while (i14 < i9) {
            ...
            float f32 = fArr5[3];
            float f33 = -fArr5[c11];
            float f34 = (fArr[i14] * B) + f16 + f12;
            xcVar.q[i14] = (f32 * f34) + f10 + fArr5[c10];
            xcVar.r[i14] = (f33 * f34) + f11 + fArr5[1];
            xcVar.s[i14] = fArr5[c11];
            xcVar.t[i14] = fArr5[3];
            i14++;
            c12 = 0;
            c13 = 2;
        ...
        Path path = this.y;
        path.rewind();
        path.moveTo(xcVar.q[0], xcVar.r[0]);
        int i15 = 0;
        while (i15 < i9) {
            int i16 = i15 + 1;
            int i17 = i16 < i9 ? i16 : 0;
            float[] fArr6 = xcVar.q;
            float f35 = fArr6[i17] - fArr6[i15];
            float[] fArr7 = xcVar.r;
            float f36 = fArr7[i17] - fArr7[i15];
            float sqrt = ((float) Math.sqrt((f36 * f36) + (f35 * f35))) / 3.0f;
            float[] fArr8 = xcVar.q;
            float f37 = fArr8[i15];
            float[] fArr9 = xcVar.s;
            float f38 = (fArr9[i15] * sqrt) + f37;
            float[] fArr10 = xcVar.r;
            float f39 = fArr10[i15];
            float[] fArr11 = xcVar.t;
            float f40 = (fArr11[i15] * sqrt) + f39;
            float f41 = fArr8[i17];
            float f42 = f41 - (fArr9[i17] * sqrt);
            float f43 = fArr10[i17];
            path.cubicTo(f38, f40, f42, f43 - (fArr11[i17] * sqrt), f41, f43);
            i15 = i16;
        }
        path.close();
        canvas.drawPath(path, xcVar.i);
    }
    ...
    public final float c() {
        ...
        float f16 = (f14 * f15) + f13;
        xc xcVar2 = this.r;
        return Math.max(f16, (f15 * xcVar2.e) + (f12 * xcVar2.f) + xcVar2.d);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (isEnabled && min > 0) {
            ...
            this.s = org.telegram.ui.Cells.j2.b(min, this.f, 6.2831855f, this.s);
            xcVar2.d(this.v);
            xcVar.d(this.v);
        }
        float f14 = this.E;
        ...
        float f17 = xcVar2.f;
        float f18 = this.e;
        float B = e2.c.B((float) Math.sin(this.s), 0.5f, 0.5f, f17 * f18 * f16);
        float B2 = e2.c.B((float) Math.sin(this.s + xcVar.b), 0.5f, 0.5f, f18 * xcVar.f * f16);
    ...
    public final void e(int i9, boolean z10) {
        if (i9 != this.A || this.E < 1.0f) {
            this.A = i9;
            int w02 = i9 != 0 ? i9 != 1 ? i9 != 3 ? org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.bh, false) : i0.a.d(0.5f, i0.a.d(0.5f, org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.ih, false), org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.jh, false)), org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.kh, false)) : i0.a.d(0.5f, org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.Zg, false), org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.ah, false)) : i0.a.d(0.5f, org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.Xg, false), org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.Yg, false));
