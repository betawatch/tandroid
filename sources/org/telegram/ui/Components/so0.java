...
public class so0 extends FrameLayout {
    ...
    public float V;
    public int W;
    public final org.telegram.ui.Cells.g1 a;
    ...
    */
    public final void a(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = so0Var.e;
        float f10 = i11 / 2.0f;
        float measuredWidth = so0Var.getMeasuredWidth() - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(so0Var.V * 1.0f) / 2.0f;
        if (k0 == null) {
            k0 = new Path();
        }
        k0.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= so0Var.S.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) so0Var.S.get(i12)).first).floatValue() >= dp3) {
                break;
            } else {
                i12++;
            }
        ...
        int size = so0Var.S.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) so0Var.S.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) so0Var.S.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) so0Var.S.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= so0Var.S.size() - 1 || ((Float) ((Pair) so0Var.S.get(i13)).first).floatValue() - floatValue > dp3) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) so0Var.S.get(i13)).first).floatValue();
            }
            c11 = 1;
    ...
    public boolean d(MotionEvent motionEvent) {
        ...
        if (action == 1 || motionEvent.getAction() == 3) {
            ...
            if (this.v) {
                ...
                this.w.B();
                this.v = false;
                AndroidUtilities.runOnUIThread(new jc0(this, 25), 50L);
                invalidate();
                return true;
            }
    ...
    public final void g(MessageObject messageObject) {
        ...
        if (z10 || this.U != valueOf.longValue()) {
            ...
            try {
                ...
                Collections.sort(this.S, new org.telegram.ui.df(15));
            } catch (Exception e) {
                FileLog.e(e);
                this.S = null;
                this.W = -1;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f17 != f18) {
            if (f17 < f18) {
                f10 = 16.0f;
                f11 = 8.0f;
                float e = a4.a.e(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f17);
                this.F = e;
                if (e > f18) {
                    this.F = f18;
                }
                ...
                f10 = 16.0f;
                f11 = 8.0f;
                float b10 = org.telegram.messenger.rk.b(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f17);
                this.F = b10;
                if (b10 < f18) {
                    this.F = f18;
                }
    ...
    public so0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.h = new d6(this, 0L, 60L, qr.g);
        this.r = -100.0f;
        this.s = -1.0f;
