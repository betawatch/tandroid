...
public final class w7 extends org.telegram.ui.ActionBar.k {
    ...
    public void setAlpha(float f7) {
        ...
        switch (this.t1) {
            case 0:
                super.setAlpha(f7);
                viewGroup = ((org.telegram.ui.ActionBar.f3) ((h8) this.u1)).containerView;
        ...
        switch (this.t1) {
            case 7:
                ...
                if (w7Var != null && w7Var.getTag() != null) {
                    AndroidUtilities.setLightStatusBar(x0Var, i0.a.f(x0Var.getThemedColor(org.telegram.ui.ActionBar.i6.h5)) > 0.699999988079071d);
                    break;
                } else {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ w7(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Context context, org.telegram.ui.ActionBar.e6 e6Var, int i10) {
        super(context, e6Var);
        this.t1 = i10;
