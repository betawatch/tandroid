            ...
            if (i46 == 4 && ((i35 = this.q) == 14 || i35 == 3)) {
                ...
                if (i46 == 10 || this.q == 10 || i46 == 13) {
                    ...
                    if (i48 != 0) {
                        ...
                        i17 = this.q;
                        if (i17 != 15) {
                            pathArr = org.telegram.ui.ActionBar.h6.a5;
                        } else {
                            if (this.p == 15) {
                                pathArr2 = org.telegram.ui.ActionBar.h6.a5;
                                pathArr = null;
                                if (i17 == 5) {
                                    pathArr = org.telegram.ui.ActionBar.h6.Z4;
                                } else if (this.p == 5) {
                                    pathArr2 = org.telegram.ui.ActionBar.h6.Z4;
                                }
                                Path[] pathArr3 = pathArr;
                                Path[] pathArr4 = pathArr2;
                                if (i17 == 7) {
                                    drawable2 = org.telegram.ui.ActionBar.h6.b5;
                                    drawable = null;
                                    i18 = 8;
                                } else {
                                    drawable = this.p == 7 ? org.telegram.ui.ActionBar.h6.b5 : null;
                                    i18 = 8;
                                    drawable2 = null;
                                }
                                if (i17 == i18) {
                                    drawable2 = org.telegram.ui.ActionBar.h6.c5;
                                } else if (this.p == i18) {
                                    drawable = org.telegram.ui.ActionBar.h6.c5;
                                }
                                if (this.p != 9 || i17 == 9) {
                                    a(false);
                                ...
                                if (i21 != 0 || i21 == 1 || (i30 = this.q) == 0 || i30 == 1) {
                                    if ((i21 == 0 || this.q != 1) && !(i21 == 1 && this.q == 0)) {
                                        ...
                                        if (i24 == 0 || this.q != 1) {
                                            interpolation = (i24 == 1 || this.q != 0) ? f21 : f20 < 100.0f ? rr.j.getInterpolation(f20 / 100.0f) * (-5.0f) : f20 < 484.0f ? (rr.j.getInterpolation((f20 - 100.0f) / 384.0f) * 95.0f) - 5.0f : 90.0f;
                                        } else {
                                            interpolation = f20 < 384.0f ? rr.j.getInterpolation(f20 / 384.0f) * 95.0f : f20 < 484.0f ? 95.0f - (rr.j.getInterpolation((f20 - 384.0f) / 100.0f) * f16) : 90.0f;
                                            f20 += 100.0f;
                                        }
                                        ...
                                        org.telegram.ui.ActionBar.h6.x3.b(canvas2, paint2, f20);
