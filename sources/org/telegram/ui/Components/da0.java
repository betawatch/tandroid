...
public final class da0 extends aw0 {
    ...
    public /* synthetic */ da0(org.telegram.ui.ActionBar.n2 n2Var, Context context, FrameLayout frameLayout, int i10) {
        super(context, null);
        this.w0 = i10;
        this.y0 = n2Var;
        this.x0 = frameLayout;
    ...
    public void L(Canvas canvas, ArrayList arrayList) {
        switch (this.w0) {
            case 0:
                ((ja0) this.y0).V.Q(canvas, arrayList);
                break;
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.w0) {
            case 0:
                ja0 ja0Var = (ja0) this.y0;
                ga0 ga0Var = ja0Var.V;
                if (ga0Var != null && (cu0Var = (cu0VarArr = ga0Var.k0)[0]) != null && cu0Var.h.getFastScroll() != null && cu0VarArr[0].h.getFastScroll().n) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.w0) {
            ...
            case 2:
                ...
                ih1 ih1Var = (ih1) this.y0;
                if (ih1Var.e0.getVisibility() == 8 || R() < AndroidUtilities.dp(20.0f)) {
                    if (ih1Var.e0.getVisibility() != 8) {
                ...
                ih1Var.e0.layout(0, measuredHeight2, getMeasuredWidth(), AndroidUtilities.dp(230.0f) + measuredHeight2);
                break;
            default:
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.w0) {
            case 0:
                ja0 ja0Var = (ja0) this.y0;
                o6[] o6VarArr = ja0Var.x;
                org.telegram.ui.ActionBar.j5[] j5VarArr = ja0Var.w;
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) ja0Var.V.getLayoutParams();
                int currentActionBarHeight = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
                kVar = ((org.telegram.ui.ActionBar.n2) ja0Var).actionBar;
                ...
                kVar2 = ((org.telegram.ui.ActionBar.n2) ja0Var).actionBar;
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    if (j5VarArr[i12] != null) {
                        ((FrameLayout.LayoutParams) j5VarArr[i12].getLayoutParams()).topMargin = AndroidUtilities.dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 5.0f : 4.0f) + org.telegram.messenger.rk.z(22.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2, 2);
                    }
                    if (o6VarArr[i12] != null) {
                        ((FrameLayout.LayoutParams) o6VarArr[i12].getLayoutParams()).topMargin = ((((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2) - AndroidUtilities.dp(19.0f)) / 2) + (org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2)) - AndroidUtilities.dp(7.0f);
                    }
                }
                ((FrameLayout.LayoutParams) ja0Var.y.getLayoutParams()).topMargin = org.telegram.messenger.rk.z(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
            ...
            default:
                ...
                ih1Var.e0.measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(230.0f), TLObject.FLAG_30));
                break;
        }
    }
}
