...
public final class wq {
    ...
    public float l = 1.0f;
    public int v = org.telegram.ui.ActionBar.h6.sf;
    public int w = org.telegram.ui.ActionBar.h6.tf;
    public int z = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (i10 != 1 && i10 != 2) {
            ...
            int v03 = org.telegram.ui.ActionBar.h6.v0(this.w, d6Var);
            if (this.u != v02) {
                this.u = v02;
                this.e.setColor(v02);
            }
        ...
        if (this.j) {
            float f17 = this.l;
            f7 = ((f17 <= 0.5f ? rr.g.getInterpolation(f17 * 2.0f) : rr.i.getInterpolation(1.0f - ((f17 - 0.5f) * 2.0f))) * 0.1f) + 1.0f;
        } else {
            f7 = 1.0f;
        }
        float f18 = this.B;
        ...
        if (this.F && (paint = this.d) != null) {
            ...
            if (this.g && org.telegram.ui.ActionBar.h6.a1()) {
                float f21 = f15 * AndroidUtilities.density;
                canvas.drawRoundRect(rectF, f21, f21, org.telegram.ui.ActionBar.h6.h2);
            }
        }
        if (z10) {
            canvas.restore();
    ...
    public final void b(Canvas canvas) {
        ...
        if (this.d != null && this.F) {
            ...
            if (this.g && org.telegram.ui.ActionBar.h6.a1()) {
                ...
                canvas.drawRoundRect(rectF, f14, f14, org.telegram.ui.ActionBar.h6.h2);
            }
            if (z10) {
                canvas.restore();
            }
                ...
                if (str.length() == formatWholeNumber.length()) {
                    ...
                    for (int i11 = 0; i11 < str.length(); i11++) {
                        if (str.charAt(i11) == formatWholeNumber.charAt(i11)) {
                            int i12 = i11 + 1;
                            spannableStringBuilder.setSpan(new mz(z11), i11, i12, 0);
                            spannableStringBuilder2.setSpan(new mz(z11), i11, i12, 0);
                        } else {
                            spannableStringBuilder3.setSpan(new mz(z11), i11, i11 + 1, 0);
                        }
                    }
