...
public abstract class xs extends f2.o1 {
    ...
    public org.telegram.ui.Cells.q2 z;
    ...
    public final void B(ArrayList arrayList, f2.l1 l1Var) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ...
            if (C(vsVar, l1Var) && vsVar.a == null && vsVar.b == null) {
    ...
    public final boolean c(f2.l1 l1Var, List list) {
        return l1Var.a instanceof org.telegram.ui.Cells.w2;
    }
    ...
    public final void f(f2.l1 l1Var) {
        ...
        while (true) {
            ...
            if (((ws) arrayList.get(size)).a == l1Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                v(l1Var);
        ...
        for (int size3 = arrayList4.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                ...
                if (((ws) arrayList5.get(size4)).a == l1Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    v(l1Var);
    ...
    public final void g() {
        ...
        for (int size4 = arrayList4.size() - 1; size4 >= 0; size4--) {
            ...
            f2.l1 l1Var3 = vsVar.a;
            if (l1Var3 != null) {
                C(vsVar, l1Var3);
            }
            f2.l1 l1Var4 = vsVar.b;
            if (l1Var4 != null) {
                C(vsVar, l1Var4);
            }
        }
        ...
        if (k()) {
            ...
            for (int size9 = arrayList9.size() - 1; size9 >= 0; size9--) {
                ...
                for (int size10 = arrayList10.size() - 1; size10 >= 0; size10--) {
                    ...
                    f2.l1 l1Var6 = vsVar2.a;
                    if (l1Var6 != null) {
                        C(vsVar2, l1Var6);
                    }
                    f2.l1 l1Var7 = vsVar2.b;
                    if (l1Var7 != null) {
                        C(vsVar2, l1Var7);
                    }
    ...
    public final void m() {
        ...
        while (i11 < size) {
            ...
            if (view instanceof org.telegram.ui.Cells.q2) {
                ...
                org.telegram.ui.Cells.q2 q2Var2 = this.z;
                ...
                if (view == q2Var2) {
                    ...
                    arrayList = arrayList2;
                    i10 = size;
                    ObjectAnimator duration2 = ObjectAnimator.ofFloat(q2Var, (Property<org.telegram.ui.Cells.q2, Float>) View.ALPHA, 1.0f).setDuration(180L);
        ...
        if (!isEmpty2) {
            ...
            arrayList3.clear();
            final int i13 = 0;
            new Runnable(this) { // from class: org.telegram.ui.Components.rs
                    ...
                    switch (i14) {
                        case 0:
                            ...
                            while (true) {
                                ...
                                if (i15 >= size2) {
                                    arrayList7.clear();
                                    xsVar.t.remove(arrayList7);
                                    break;
                                } else {
                                    Object obj2 = arrayList7.get(i15);
                                    i15++;
                                    ws wsVar = (ws) obj2;
                                    f2.l1 l1Var2 = wsVar.a;
                                    int i16 = wsVar.b;
                                    int i17 = wsVar.c;
                                    int i18 = wsVar.d;
                                    int i19 = wsVar.e;
                                    ...
                                    org.telegram.ui.Cells.q2 q2Var3 = xsVar.z;
                                    if (q2Var3 != null) {
                                        if (xsVar.A != Integer.MAX_VALUE) {
                                            int measuredHeight3 = q2Var3.getMeasuredHeight();
                                            int i22 = xsVar.A;
                                            xsVar.B = measuredHeight3 - i22;
                                            xsVar.z.setTopClip(i22);
                                            xsVar.z.setBottomClip(xsVar.B);
                                        } else if (xsVar.B != Integer.MAX_VALUE) {
                                            int measuredHeight4 = q2Var3.getMeasuredHeight() - xsVar.B;
                                            xsVar.A = measuredHeight4;
                                            xsVar.z.setTopClip(measuredHeight4);
                                            xsVar.z.setBottomClip(xsVar.B);
                                        }
                                    }
                                    ViewPropertyAnimator animate2 = view2.animate();
                                    xsVar.w.add(l1Var2);
                                    animate2.setDuration(180L).setListener(new f2.h(xsVar, l1Var2, i20, view2, i21, animate2, 1)).start();
                                }
                            }
                        default:
                            ...
                            while (true) {
                                ...
                                if (i23 >= size3) {
                                    arrayList7.clear();
                                    xsVar2.u.remove(arrayList7);
                                    break;
                                } else {
                                    Object obj3 = arrayList7.get(i23);
                                    i23++;
                                    vs vsVar = (vs) obj3;
                                    ArrayList arrayList8 = xsVar2.y;
                                    f2.l1 l1Var3 = vsVar.a;
                                    f2.l1 l1Var4 = vsVar.b;
                                    if (l1Var3 != null && l1Var4 != null) {
                                        ...
                                        arrayList8.add(vsVar.a);
                                        arrayList8.add(vsVar.b);
    ...
    public final void p(f2.l1 l1Var) {
        ...
        if (arrayList.size() > 2) {
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ...
                if (((f2.l1) arrayList.get(i10)).a instanceof org.telegram.ui.Cells.q2) {
                    ((org.telegram.ui.Cells.q2) ((f2.l1) arrayList.get(i10)).a).setMoving(true);
                }
            }
        }
    }
    ...
    public final boolean r(f2.l1 l1Var, c5.e eVar, int i10, int i11, int i12, int i13) {
        ...
        ws wsVar = new ws();
        wsVar.a = l1Var;
        wsVar.b = translationX;
        wsVar.c = translationY;
        wsVar.d = i12;
        wsVar.e = i13;
        this.q.add(wsVar);
        return true;
