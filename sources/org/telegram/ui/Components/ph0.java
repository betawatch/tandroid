...
public class ph0 extends wp implements NotificationCenter.NotificationCenterDelegate {
    public boolean A0;
    public boolean B0;
    public final ml0 C0;
    public final oh0 D0;
    ...
    public ph0(Context context, org.telegram.ui.ActionBar.k kVar, ml0 ml0Var, org.telegram.ui.q4 q4Var) {
        super(context);
        this.x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.G0 = q4Var;
        b(new hh0(this));
        oh0 oh0Var = new oh0(this, getContext(), null);
        this.D0 = oh0Var;
        setAdapter((vp) oh0Var);
    ...
    public final View E(int i10) {
        ...
        ArrayList arrayList = oh0Var.c;
        if (arrayList.size() <= i10 || i10 < 0) {
            return null;
        }
        lh0 lh0Var = (lh0) arrayList.get(i10);
        mh0 mh0Var = lh0Var.b;
        return mh0Var == null ? lh0Var.c : mh0Var;
    }
    ...
    public final boolean H(r61 r61Var, ImageLocation imageLocation, ImageLocation imageLocation2, boolean z10) {
            ...
            if (imageLocation3 == null || imageLocation3.location.local_id != imageLocation.location.local_id) {
                ...
                if (!isEmpty) {
                    ...
                    if (z10 && (dialogPhotos2 = this.S0) != null) {
                        dialogPhotos2.reset();
                        this.S0.loadAfter(getCurrentItem() - (oh0Var != null ? oh0Var.j() : 0), true);
                    }
                    return true;
                }
    ...
    public final boolean J() {
        ...
        b6 animation = currentItemView.getImageReceiver().getAnimation();
    ...
    public final void K() {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt instanceof u9) {
                u9 u9Var = (u9) childAt;
                if (u9Var.getImageReceiver().hasStaticThumb()) {
                    Drawable drawable = u9Var.getImageReceiver().getDrawable();
    ...
    public final void N(int i10, int i11) {
        ...
        oh0 oh0Var = this.D0;
        if (oh0Var != null) {
            for (int i12 = 0; i12 < oh0Var.c.size(); i12++) {
                if (((lh0) oh0Var.c.get(i12)).c != null) {
                    jh0 jh0Var = ((lh0) oh0Var.c.get(i12)).c;
                    int i13 = this.m1;
                    int i14 = this.n1;
                    jh0Var.r(i13, i13, i14, i14);
                }
            }
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        ArrayList arrayList5 = ph0Var2.U0;
        ArrayList arrayList6 = ph0Var2.T0;
        if (i10 != i14) {
            int i15 = NotificationCenter.fileLoaded;
            SparseArray sparseArray = ph0Var2.d1;
            if (i10 == i15) {
            ...
            if (i10 != NotificationCenter.fileLoadProgressChanged) {
                if (i10 == NotificationCenter.reloadDialogPhotos && ph0Var2.c1 == 0 && (dialogPhotos = ph0Var2.S0) != null) {
                    dialogPhotos.reset();
                    MessagesController.DialogPhotos dialogPhotos2 = ph0Var2.S0;
                    int currentItem = ph0Var2.getCurrentItem();
                    oh0 oh0Var = ph0Var2.D0;
                    dialogPhotos2.loadAfter(currentItem - (oh0Var != null ? oh0Var.j() : 0), true);
                    return;
                }
                return;
            }
        ...
        if (ph0Var2.S0 == dialogPhotos3) {
            ArrayList arrayList7 = new ArrayList(dialogPhotos3.photos);
            if (!arrayList7.isEmpty() || !dialogPhotos3.fromCache) {
                ph0Var2.j1 = -1;
                ph0Var2.k1 = -1;
                int i18 = ph0Var2.L0;
                TLRPC.User user4 = MessagesController.getInstance(i18).getUser(Long.valueOf(ph0Var2.E0));
                TLRPC.UserFull userFull = MessagesController.getInstance(i18).getUserFull(ph0Var2.E0);
                ...
                if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                    ...
                    ph0Var2.k1 = arrayList7.size() - 1;
                }
                arrayList5.clear();
                arrayList6.clear();
                ArrayList arrayList8 = ph0Var2.X0;
                arrayList8.clear();
                ArrayList arrayList9 = ph0Var2.W0;
                arrayList9.clear();
                ArrayList arrayList10 = ph0Var2.Y0;
                arrayList10.clear();
                ArrayList arrayList11 = ph0Var2.Z0;
                arrayList11.clear();
                ArrayList arrayList12 = ph0Var2.V0;
                arrayList12.clear();
                ArrayList arrayList13 = ph0Var2.a1;
                arrayList13.clear();
                ArrayList arrayList14 = ph0Var2.b1;
                arrayList14.clear();
                if (DialogObject.isChatDialog(ph0Var2.E0)) {
                    TLRPC.Chat chat = MessagesController.getInstance(i18).getChat(Long.valueOf(-ph0Var2.E0));
                    ...
                    if (imageLocation != null) {
                        ...
                        arrayList5.add(null);
                        TLRPC.ChatFull chatFull = ph0Var2.F0;
                        if (chatFull == null || !FileLoader.isSamePhoto((TLRPC.FileLocation) imageLocation.location, chatFull.chat_photo)) {
                            ...
                            arrayList12.add(ph0Var2.F0.chat_photo);
                            if (ph0Var2.F0.chat_photo.video_sizes.isEmpty()) {
                                z13 = false;
                                arrayList9.add(null);
                                arrayList6.add(null);
                            } else {
                                TLRPC.VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(ph0Var2.F0.chat_photo.video_sizes, MediaDataController.MAX_STYLE_RUNS_COUNT);
                                arrayList9.add(ImageLocation.getForPhoto(closestVideoSizeWithSize, ph0Var2.F0.chat_photo));
                ...
                while (true) {
                    ...
                    if (photo2 == null || (photo2 instanceof TLRPC.TL_photoEmpty) || (arrayList3 = photo2.sizes) == null) {
                        ...
                        if (closestPhotoSizeWithSize2 != null) {
                            ...
                            if (forPhoto != null) {
                                ImageLocation imageLocation3 = ph0Var2.P0;
                                num = num2;
                                if (imageLocation3 == null) {
                                    arrayList14 = arrayList4;
                                    user2 = user;
                                } else if (imageLocation3.photoId != forPhoto.photoId || z10 || ph0Var2.E0 == UserConfig.getInstance(i12).getClientUserId()) {
                                    user2 = user;
                                    arrayList14 = arrayList4;
                                } else {
                                    arrayList5.add(null);
                                    arrayList.add(ph0Var2.P0);
                                    ImageLocation imageLocation4 = ph0Var2.Q0;
                                    ...
                                    if (photo2.video_sizes.isEmpty()) {
                                        ...
                                        if (vectorMarkupVideoSize != null) {
                                            user3 = user;
                                            arrayList11.add(new r61(vectorMarkupVideoSize, user != null && user3.premium, 2));
                                            obj = null;
                                            arrayList9.add(null);
                                            arrayList6.add(null);
                                        } else {
                                ...
                                if (photo2.video_sizes.isEmpty()) {
                                    ...
                                    if (vectorMarkupVideoSize2 != null) {
                                        user = user2;
                                        arrayList11.add(new r61(vectorMarkupVideoSize2, user2 != null && user2.premium, 2));
                                        z12 = false;
                                        arrayList9.add(null);
                                        arrayList6.add(null);
                                    } else {
                ...
                if (z10) {
                    ...
                    if (!ph0Var.H0 || ph0Var.f1) {
                        ph0Var.L();
                        ph0Var.getAdapter().g();
                        ph0Var.B(0.0f, ph0Var.getRealPosition());
                    }
                }
                if (ph0Var.k1 >= 0 || ph0Var.j1 >= 0) {
                    z11 = false;
                } else {
                    z11 = false;
                    ph0Var.B(0.0f, 0);
                ...
                ph0Var.f1 = z11;
                kh0 kh0Var = ph0Var.G0;
                if (kh0Var != null) {
                    kh0Var.c();
                }
                ImageLocation imageLocation5 = ph0Var.q1;
                if (imageLocation5 != null) {
                    ph0Var.A(imageLocation5, ph0Var.r1);
                }
            }
        }
    }

    public gh0 getBlurDrawer() {
        return this.p1;
    }

    public float getCurrentItemProgress() {
        b6 animation;
        u9 currentItemView = getCurrentItemView();
    ...
    public u9 getCurrentItemView() {
        oh0 oh0Var = this.D0;
        if (oh0Var == null || oh0Var.c.isEmpty()) {
            return null;
        }
        return ((lh0) oh0Var.c.get(getCurrentItem())).c;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        gh0 gh0Var = this.p1;
        if (gh0Var != null) {
            gh0Var.setTranslationY(getHeight() - this.p1.getMeasuredHeight());
        }
    }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (oh0Var != null) {
            ml0 ml0Var = this.C0;
            if (ml0Var.getScrollState() != 0 && !this.A0 && this.B0) {
                this.B0 = false;
            ...
            if (action == 0) {
                ...
                if (oh0Var.c.size() > 1 && kh0Var != null) {
                    kh0Var.b(motionEvent.getX() < ((float) getWidth()) / 3.0f);
                }
                this.I0 = false;
            } else if (action == 1) {
                if (!this.I0) {
                    ...
                    if (realCount > 1) {
                        if (motionEvent.getX() > getWidth() / 3.0f) {
                            ...
                            i10 = i12 < oh0Var.j() ? (realCount + r0) - 1 : i12;
                        }
                        if (kh0Var != null) {
                            kh0Var.a();
                        }
            ...
            boolean onTouchEvent = this.A0 ? ml0Var.onTouchEvent(motionEvent) : false;
            if (this.B0) {
                try {
    ...
    public void setAnimatedFileMaybe(b6 b6Var) {
        oh0 oh0Var;
        if (b6Var == null || (oh0Var = this.D0) == null) {
            return;
        }
        int childCount = getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = getChildAt(i10);
            if ((childAt instanceof u9) && oh0Var.k(oh0Var.d.indexOf(childAt)) == 0) {
                u9 u9Var = (u9) childAt;
                b6 animation = u9Var.getImageReceiver().getAnimation();
                if (animation != b6Var) {
                    if (animation != null) {
                        animation.w(u9Var);
                    }
                    u9Var.setImageDrawable(b6Var);
                    b6Var.f(this);
                    b6Var.R = true;
                }
            }
    ...
    public void setParentAvatarImage(u9 u9Var) {
        oh0 oh0Var = this.D0;
        if (oh0Var != null) {
            oh0Var.g = u9Var;
        }
    ...
    public ph0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, ml0 ml0Var, org.telegram.ui.o01 o01Var, kh0 kh0Var, gh0 gh0Var) {
        super(context);
        this.x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.k1 = -1;
        this.p1 = gh0Var;
        setPadding(0, 0, 0, gh0Var == null ? 0 : gh0Var.n);
        if (gh0Var != null) {
            gh0Var.setView(this);
        }
        setVisibility(8);
        ...
        this.C0 = ml0Var;
        this.z0 = kVar;
        oh0 oh0Var = new oh0(this, getContext(), o01Var);
        this.D0 = oh0Var;
        setAdapter((vp) oh0Var);
        this.y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = kh0Var;
        b(new ih0((org.telegram.ui.rz0) this));
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.dialogPhotosLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoadProgressChanged);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.reloadDialogPhotos);
