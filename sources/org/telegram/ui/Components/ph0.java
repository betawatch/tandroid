...
public class ph0 extends xp implements NotificationCenter.NotificationCenterDelegate {
    public boolean A0;
    public boolean B0;
    public final ml0 C0;
    public final oh0 D0;
    ...
    public ph0(Context context, org.telegram.ui.ActionBar.k kVar, ml0 ml0Var, org.telegram.ui.r4 r4Var) {
        super(context);
        this.x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
    ...
    public final boolean H(p61 p61Var, ImageLocation imageLocation, ImageLocation imageLocation2, boolean z10) {
                            ...
                            if (forPhoto != null) {
                                ...
                                if (imageLocation3 == null) {
                                    ...
                                    if (photo2.video_sizes.isEmpty()) {
                                        ...
                                        if (vectorMarkupVideoSize != null) {
                                            user3 = user;
                                            arrayList11.add(new p61(vectorMarkupVideoSize, user != null && user3.premium, 2));
                                            obj = null;
                                            arrayList9.add(null);
                                            arrayList6.add(null);
                                        } else {
                                ...
                                if (photo2.video_sizes.isEmpty()) {
                                    ...
                                    if (vectorMarkupVideoSize2 != null) {
                                        user = user2;
                                        arrayList11.add(new p61(vectorMarkupVideoSize2, user2 != null && user2.premium, 2));
                                        z12 = false;
                                        arrayList9.add(null);
                                        arrayList6.add(null);
                                    } else {
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (oh0Var != null) {
            ...
            org.telegram.ui.iv0 iv0Var = this.h1;
            kh0 kh0Var = this.G0;
            if (iv0Var != null && getCurrentItemView() != null) {
                if (action != 0 && this.I0) {
                    org.telegram.ui.iv0 iv0Var2 = this.h1;
                    if (!iv0Var2.n) {
                        iv0Var2.a(MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0), this, getCurrentItemView().getImageReceiver(), null, 0);
                    }
                }
    ...
    public void setAnimatedFileMaybe(d6 d6Var) {
        oh0 oh0Var;
        if (d6Var == null || (oh0Var = this.D0) == null) {
            return;
        }
        int childCount = getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = getChildAt(i10);
            if ((childAt instanceof w9) && oh0Var.k(oh0Var.d.indexOf(childAt)) == 0) {
                w9 w9Var = (w9) childAt;
    ...
    public void setPinchToZoomHelper(org.telegram.ui.iv0 iv0Var) {
        this.h1 = iv0Var;
    }
    ...
    public ph0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, ml0 ml0Var, org.telegram.ui.f01 f01Var, kh0 kh0Var, gh0 gh0Var) {
        super(context);
        this.x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.C0 = ml0Var;
        this.z0 = kVar;
        oh0 oh0Var = new oh0(this, getContext(), f01Var);
        this.D0 = oh0Var;
        setAdapter((wp) oh0Var);
        this.y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = kh0Var;
        b(new ih0((org.telegram.ui.iz0) this));
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.dialogPhotosLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoadProgressChanged);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.reloadDialogPhotos);
