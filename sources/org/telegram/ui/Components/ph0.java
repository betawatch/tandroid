...
public final class ph0 extends p9 implements nv0 {
    public final int D;
    ...
    public Runnable L;
    public final /* synthetic */ vh0 M;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ph0(vh0 vh0Var, Context context, int i10, Paint paint) {
        super(context);
        this.M = vh0Var;
    ...
    public final void onDraw(Canvas canvas) {
        Canvas canvas2;
        vh0 vh0Var = this.M;
        float[] fArr = vh0Var.L0;
        Path path = vh0Var.J0;
        ArrayList arrayList = vh0Var.Y0;
        RectF rectF = vh0Var.K0;
        org.telegram.ui.vu0 vu0Var = vh0Var.e1;
        if (vu0Var == null || !vu0Var.n) {
            if (this.E != null) {
                int k10 = vh0Var.A0.k(this.J);
                if (vh0Var.f1) {
                    k10--;
                }
                ...
                if (k10 >= arrayList.size() || arrayList.get(k10) == null ? drawable == null || (this.I && (!(drawable instanceof y5) || ((y5) drawable).d[4] <= 0)) : ((Float) arrayList.get(k10)).floatValue() < 1.0f) {
                    if (this.H < 0) {
                        ...
                        if (currentTimeMillis <= 250 + j11 && currentTimeMillis > j11) {
                            this.E.E = nr.f.getInterpolation((currentTimeMillis - j11) / 250.0f);
                        }
                    }
                    if (vh0Var.d1) {
                        invalidate();
                    ...
                    this.F.addUpdateListener(new i70(this, i10));
                    this.F.addListener(new org.telegram.ui.Cells.b4(this, k10, 5));
                    this.F.start();
                }
                int i11 = vh0Var.j1;
                if (i11 == 0 && vh0Var.k1 == 0) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (this.E != null) {
            ...
            radialProgress2.q((i10 - i14) / 2, kh.a2.d(i15, i14, 2, currentActionBarHeight), (i10 + i14) / 2, ((i15 + i14) / 2) + currentActionBarHeight);
        }
    }
