...
public abstract class o71 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public final void c(h71 h71Var, MessageObject messageObject) {
        ...
        if (h71Var.t() > 0) {
            f71 f71Var = null;
            for (int i10 = 0; i10 < h71Var.t(); i10++) {
                ArrayList arrayList = h71Var.u(i10).d;
                ...
                while (i11 < size) {
                    ...
                    i11++;
                    f71 f71Var2 = (f71) obj;
                    if (f71Var == null || ((!f71Var.b() && f71Var2.b()) || (f71Var.b() == f71Var2.b() && f71Var2.i * f71Var2.j < f71Var.i * f71Var.j))) {
                        f71Var = f71Var2;
                    }
                }
            }
            if (f71Var != null && !f71Var.b()) {
                int o9 = h71Var.o();
                d71 u10 = (o9 < 0 || o9 >= h71Var.t()) ? null : h71Var.u(o9);
                if (u10 != null) {
                    f71Var = u10.a();
                }
            }
            ...
            if (f71Var != null && !f71Var.d.equals(this.d)) {
                if (this.a) {
                    a();
                }
                this.d = f71Var.d;
                DispatchQueue dispatchQueue = Utilities.globalQueue;
                gr0 gr0Var = new gr0((org.telegram.ui.ot0) this, f71Var, messageObject, 13);
                this.e = gr0Var;
                dispatchQueue.postRunnable(gr0Var);
            }
        } else {
            Uri uri = h71Var.F;
            if (uri != null) {
            ...
            if (uri != null && !uri.equals(this.d)) {
                ...
                gr0 gr0Var2 = new gr0((org.telegram.ui.ot0) this, uri, messageObject, 12);
                this.e = gr0Var2;
                dispatchQueue2.postRunnable(gr0Var2);
            }
        }
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [java.lang.Runnable, org.telegram.ui.Components.m71] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void e(MessageObject messageObject, final float f7, int i10) {
        ...
        DispatchQueue dispatchQueue = Utilities.globalQueue;
        ?? r52 = new Runnable() { // from class: org.telegram.ui.Components.m71
            @Override // java.lang.Runnable
            public final void run() {
                int i13;
                o71 o71Var = o71.this;
                RectF rectF = o71Var.H;
                if (o71Var.b == null) {
                    o71Var.h = f7;
                    return;
                }
                int max = Math.max(200, AndroidUtilities.dp(100.0f));
                Bitmap q6 = o71Var.b.q(j10, false);
                if (q6 != null) {
                    ...
                    try {
                        ...
                        canvas.drawBitmap(q6, (Rect) null, rectF, o71Var.I);
                ...
                AndroidUtilities.runOnUIThread(new br0(18, o71Var, q6));
            }
        };
        this.f = r52;
