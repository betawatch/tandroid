...
public final class mw0 extends CacheFetcher {
    @Override // org.telegram.messenger.CacheFetcher
    public final void getLocal(int i10, Object obj, Utilities.Callback2 callback2) {
        MessagesStorage.getInstance(i10).getStorageQueue().postRunnable(new rm(i10, (Integer) obj, callback2, 19));
    }
    ...
    public final void getRemote(int i10, Object obj, long j10, Utilities.Callback4 callback4) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_getEmojiGroups, new lw0(callback4, 0));
    }

    @Override // org.telegram.messenger.CacheFetcher
    public final void setLocal(int i10, Object obj, Object obj2, long j10) {
        MessagesStorage.getInstance(i10).getStorageQueue().postRunnable(new rm(i10, (TLRPC.TL_messages_emojiGroups) obj2, (Integer) obj, 18));
    }
}
