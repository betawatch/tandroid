...
public final class fh0 extends View {
    ...
    public fh0(Context context) {
        ...
        this.H = false;
        this.N = new mv0[3];
        c6 c6Var = new c6(this, 0L, 350L, qr.f);
        this.O = c6Var;
    ...
    */
    public final boolean d() {
        org.telegram.ui.pv0 pv0Var;
        mv0[] mv0VarArr;
        oh0 oh0Var = this.h;
        boolean z10 = false;
        if (oh0Var != null && ((pv0Var = oh0Var.h1) == null || !pv0Var.n)) {
            ...
            if (canvas2.isHardwareAccelerated()) {
                if (n01Var != null || getVisibility() != 0 || getAlpha() <= 0.0f) {
                    if (n01Var != null) {
                        ...
                        o5 o5Var = n01Var.e;
                        g(o5Var != null ? o5Var.k : n01Var.a, beginRecording, f15, f10);
