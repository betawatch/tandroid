...
public final class zo0 extends Drawable {
    ...
    public zo0(Runnable runnable, boolean z10) {
        ...
        Path path = new Path();
        this.f = path;
        this.g = new w01(LocaleController.getString(R.string.SeekSpeedHint), 14.0f, null);
        Path path2 = new Path();
        this.h = path2;
        Path path3 = new Path();
        this.i = path3;
        ...
        this.l = d6Var;
        d6Var.d(0.0f, true);
        this.m = new d6(runnable, 320L, qrVar, 0);
        this.n = new d6(runnable, 200L, qrVar, 0);
