...
public final class w21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.e {
    ...
    public w21(Activity activity, org.telegram.ui.xn xnVar, int i10, long j3, org.telegram.ui.ActionBar.d6 d6Var) {
        super(activity);
        ViewGroup viewGroup;
        rr rrVar = rr.h;
        this.a = new le.c(0, this, rrVar, 380L, true);
        this.J = new le.c(0, new b21(this), rrVar, 320L, false);
        this.R = 0.0f;
        this.e0 = new HashSet();
        this.h = xnVar;
        this.b = i10;
        ...
        this.n = !org.telegram.messenger.z0.v("topics_end_reached_", j10, UserConfig.getInstance(i10).getPreferences(), false);
        ...
        }, new b21(this), new b21(this), d6Var);
        this.s = k21Var;
        final int i12 = 1;
        k21Var.B1(new Utilities.Callback2(this) { // from class: org.telegram.ui.Components.j21
            public final /* synthetic */ w21 b;
        ...
        k21Var.Y2.r = false;
        k21Var.getContext();
        gg.j0 j0Var = new gg.j0((ViewGroup) k21Var, 5);
        k21Var.X2 = j0Var;
        ...
        if (isBotForumWithEditableTopics) {
            v21 v21Var = new v21(activity, i10, d6Var);
            this.v = v21Var;
        ...
        this.G = m21Var;
        final int i15 = 1;
        m21Var.B1(new Utilities.Callback2(this) { // from class: org.telegram.ui.Components.j21
            public final /* synthetic */ w21 b;
        ...
        if (org.telegram.messenger.z0.v("topicssidetabs", j3, mainSettings, false)) {
            this.R = 1.0f;
            this.Q = true;
        }
        boolean v = org.telegram.messenger.z0.v("topicssidetabsb", j3, mainSettings, false);
        this.P = v;
    ...
    public static boolean c(final w21 w21Var, h51 h51Var, View view) {
        ...
        ?? r62;
        o70 o70Var2;
        org.telegram.ui.ActionBar.d6 d6Var2 = w21Var.d;
        ...
        if (ChatObject.isMonoForum(chat)) {
            ...
            I.c(R.drawable.msg_clear, LocaleController.getString(R.string.ClearHistory), new ai.q8(w21Var, I, peerDialogId, chat2, 29), false);
            long j10 = chat2.id;
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                ...
                I.c(z11 ? R.drawable.msg_unpin : R.drawable.msg_pin, LocaleController.getString(z11 ? R.string.DialogUnpin : R.string.DialogPin), new jn0(w21Var, I, messagesController, tL_forumTopic), false);
                ...
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(w21Var) { // from class: org.telegram.ui.Components.e21
                    ...
                    public final void run() {
                        ...
                        switch (i14) {
                            case 0:
                                o70Var3.u();
                                w21Var2.h.presentFragment(se1.a0(-w21Var2.c, tL_forumTopic2.id));
                                break;
                            case 1:
                                w21Var2.getClass();
                                o70Var3.u();
                            ...
                            default:
                                ...
                                alertDialog$Builder.k(LocaleController.getString(R.string.Delete), new org.telegram.ui.we(w21Var3, arrayList, j12, hashSet, thVar));
                                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new xc0(24));
                                b2Var.show();
                                TextView textView = (TextView) b2Var.d(-1);
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.q7, z12));
                                    break;
                                }
                                break;
                        }
            ...
            org.telegram.ui.ActionBar.d6 resourceProvider = xnVar.getResourceProvider();
            lo loVar = new lo(I, currentAccount, j12, j13, xnVar, resourceProvider);
            o70 J = I.J();
            J.c(R.drawable.msg_arrow_back, LocaleController.getString(R.string.Back), new org.telegram.ui.fu0(I, 25), false);
            ...
            b10 = 0;
            o70Var = I;
            o70Var.c(isDialogMuted ? R.drawable.msg_unmute : R.drawable.msg_mute, LocaleController.getString(isDialogMuted ? R.string.Unmute : R.string.Mute), new ai.m3(w21Var, messagesController, tL_forumTopic, I, J, 25), false);
            if (!ChatObject.canManageTopic(i12, chat4, tL_forumTopic) || UserObject.isBotForum(user)) {
                ...
                o70Var.c(i14, string, new Runnable(w21Var) { // from class: org.telegram.ui.Components.e21
                    public final /* synthetic */ w21 b;
                    ...
                    public final void run() {
                        ...
                        switch (i142) {
                            ...
                            default:
                                ...
                                alertDialog$Builder.k(LocaleController.getString(R.string.Delete), new org.telegram.ui.we(w21Var3, arrayList, j122, hashSet, thVar));
                                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new xc0(24));
                                b2Var.show();
                                TextView textView = (TextView) b2Var.d(-1);
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.q7, z122));
                                    break;
                                }
                                break;
                        }
            ...
            if (ChatObject.canDeleteTopic(i12, chat4, tL_forumTopic)) {
                o70Var.c(R.drawable.msg_delete, LocaleController.getPluralString("DeleteTopics", z10 ? 1 : 0), new Runnable(w21Var) { // from class: org.telegram.ui.Components.e21
                    public final /* synthetic */ w21 b;
        ...
        if (view instanceof r21) {
            ...
            o70Var.W(cwVar);
            o70Var.a0(AndroidUtilities.dp(16.0f), 0.0f);
        } else {
    ...
    public final void d(boolean z10) {
        ...
        this.U = ofFloat;
        ofFloat.addUpdateListener(new i70(this, 28));
    ...
    public final void n() {
        ...
        int d = i0.a.d(1.0f - this.R, v02, org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.y.setColorFilter(new PorterDuffColorFilter(d, mode));
        this.E.setColorFilter(new PorterDuffColorFilter(i0.a.d(this.R, org.telegram.ui.ActionBar.h6.v0(i10, d6Var), org.telegram.ui.ActionBar.h6.v0(i11, d6Var)), mode));
        this.w.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), mode));
        this.x.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), mode));
        invalidate();
    }
