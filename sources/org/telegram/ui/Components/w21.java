...
public final class w21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, xd.b {
    ...
    public w21(Activity activity, org.telegram.ui.xn xnVar, int i10, long j10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity);
        ViewGroup viewGroup;
        nr nrVar = nr.h;
        this.a = new xd.a(0, this, nrVar, 380L, true);
        this.G = new xd.a(0, new e21(this), nrVar, 320L, false);
        this.O = 0.0f;
        this.b0 = new HashSet();
        this.h = xnVar;
        this.b = i10;
        ...
        k21Var.V2.r = false;
        k21Var.getContext();
        org.telegram.ui.br brVar = new org.telegram.ui.br((ViewGroup) k21Var, 4);
        k21Var.U2 = brVar;
        k21Var.setLayoutManager(brVar);
    ...
    public static void b(w21 w21Var, ArrayList arrayList) {
        ...
        while (i10 < arrayList.size()) {
            i10 = org.telegram.ui.yh.e(((i51) arrayList.get(i10)).d, i10, 1, arrayList2);
        }
        long j11 = -j10;
    ...
    public static boolean c(final w21 w21Var, i51 i51Var, View view) {
        ...
        if (ChatObject.isMonoForum(chat2)) {
            ...
            TLRPC.Chat chat3 = chat2;
            I.c(R.drawable.msg_clear, LocaleController.getString(R.string.ClearHistory), new org.telegram.messenger.ci(w21Var, I, peerDialogId, chat2, 4), false);
            long j11 = chat3.id;
                ...
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(w21Var2) { // from class: org.telegram.ui.Components.g21
                    ...
                    public final void run() {
                        ...
                        switch (i17) {
                            case 0:
                                o70Var3.u();
                                w21Var3.h.presentFragment(fe1.a0(-w21Var3.c, tL_forumTopic2.id));
                                break;
                            case 1:
                                w21Var3.getClass();
                                o70Var3.u();
                            ...
                            default:
                                ...
                                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new kh0(12));
                                d2Var.show();
            ...
            o70 o70Var3 = I;
            go goVar = new go(o70Var3, currentAccount, j13, j14, xnVar, resourceProvider);
            o70 J = o70Var3.J();
            J.c(R.drawable.msg_arrow_back, LocaleController.getString(R.string.Back), new org.telegram.ui.rt0(o70Var3, 25), false);
            J.c(R.drawable.msg_tone_on, LocaleController.getString(R.string.SoundOn), new org.telegram.messenger.le(o70Var3, currentAccount, j13, j14, J, xnVar, resourceProvider), false);
            org.telegram.ui.ActionBar.g1 y11 = J.y();
            J.c(R.drawable.msg_mute_period, LocaleController.getString(R.string.MuteForPopup), new cg.v1(o70Var3, resourceProvider, currentAccount, goVar, 16), false);
            f6Var = f6Var2;
            J.c(R.drawable.msg_customize, LocaleController.getString(R.string.NotificationsCustomize), new gg.s0(o70Var3, j13, j14, xnVar, resourceProvider, 8), false);
            J.c(0, "", new lh.u7(o70Var3, currentAccount, j13, j14, xnVar, resourceProvider), false);
            ...
            b10 = 0;
            i11 = 8;
            jy0 jy0Var = new jy0(w21Var, messagesController, tL_forumTopic, o70Var3, J, 1);
            o70Var = o70Var3;
            o70Var.c(i17, string2, jy0Var, false);
            ...
            if (ChatObject.canManageTopic(i12, chat6, tL_forumTopic) && !UserObject.isBotForum(user)) {
                ...
                o70Var.c(i18, string3, new Runnable(w21Var) { // from class: org.telegram.ui.Components.g21
                    public final /* synthetic */ w21 b;
            ...
            if (ChatObject.canDeleteTopic(i12, chat6, tL_forumTopic)) {
                o70Var.c(R.drawable.msg_delete, LocaleController.getPluralString("DeleteTopics", 1), new Runnable(w21Var) { // from class: org.telegram.ui.Components.g21
                    public final /* synthetic */ w21 b;
