...
public abstract class sa extends org.telegram.ui.ActionBar.g3 {
    ...
    */
    ...
    public final void J() {
        ...
        this.K = new z5(this.containerView, 0L, 350L, nr.h);
    ...
    public final void s() {
        ...
        if (sl0Var.getLayoutManager() instanceof f2.i0) {
            ((f2.i0) sl0Var.getLayoutManager()).h1(this.R, top);
        }
        this.R = -1;
    }
