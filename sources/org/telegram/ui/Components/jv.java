...
public final class jv extends FrameLayout {
    ...
    public jv(tv tvVar, Context context) {
        ...
        qr qrVar = qr.h;
        this.s = new d6(this, 0L, 350L, qrVar);
        ...
        if (vVar == null) {
            ...
            for (int i10 = 0; i10 < vVar.getChildCount(); i10++) {
                ...
                if (childAt instanceof kv) {
                    y5VarArr2[i10] = ((kv) childAt).c;
                }
            }
            y5VarArr = y5VarArr2;
        }
        tvVar.b = y5.update(3, this, y5VarArr, (LongSparseArray<p5>) tvVar.b);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            if (bool == null || z10 != bool.booleanValue()) {
                ...
                boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(tvVar.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f;
                if (!z10) {
                    z11 = z12;
                }
                AndroidUtilities.setLightStatusBar(tvVar, z11);
            }
            org.telegram.ui.ActionBar.j6.t0.setColor(tvVar.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
            ...
            if (vVar != null) {
                ...
                while (i12 < vVar.getChildCount()) {
                    ...
                    if (childAt instanceof kv) {
                        ...
                        if (tvVar.b != null && (y5Var = kvVar.c) != null) {
                            p5 p5Var = (p5) tvVar.b.get(y5Var.getDocumentId());
                            if (p5Var != null) {
