    ...
    private void checkButtonsPositionsAndVisibility() {
        ...
        while (true) {
            ...
            if (buttonHolder != null) {
                ...
                if (i != 0) {
                    buttonHolder.button.setTranslationY((AndroidUtilities.dp(80.0f) * (1.0f - floatValue)) - f);
                }
                f += (AndroidUtilities.dp(44.0f) + AndroidUtilities.dp((floatValue2 * 10.0f) + 10.0f)) * floatValue;
            }
            i++;
        }
    }
