    ...
    */
    public final q00 a(boolean z4) {
        ...
        try {
            ...
            if (this.h && nextInt == 0) {
                q00Var.a = (byte) 2;
                q00Var.b = (byte) Utilities.random.nextInt(C.length);
            } else if (this.n && Utilities.random.nextBoolean()) {
                q00Var.a = (byte) 2;
                q00Var.b = (byte) Utilities.random.nextInt(D.length);
            } else {
                q00Var.b = (byte) Utilities.random.nextInt(B.length);
            }
            ...
            if (b10 != 0 && b10 != 2) {
                ...
                q00Var.j = e2.c.y(Utilities.random.nextFloat(), AndroidUtilities.dp(4.0f), AndroidUtilities.dp(1.2f), q00Var.c == 0 ? 1 : -1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (i11 < size) {
                ...
                if (b10 == 1) {
                    ...
                    if (b10 == 2) {
                        ...
                        if (drawable != null) {
                            ...
                            canvas.scale(f12, f12, q00Var.g, q00Var.h);
            ...
            float f14 = q00Var.g;
            float f15 = q00Var.j;
            q00Var.g = (f15 * f13) + f14;
            q00Var.h = (q00Var.k * f13) + q00Var.h;
            if (q00Var.e != 0) {
                float dp = AndroidUtilities.dp(1.0f) * 0.5f;
                if (q00Var.e == 1) {
                    float u10 = e2.c.u(dp, f13, 0.05f, q00Var.j);
                    q00Var.j = u10;
                    if (u10 >= dp) {
                        q00Var.e = (byte) 2;
                    }
                } else {
                    float f16 = q00Var.j - ((dp * f13) * 0.05f);
                    q00Var.j = f16;
                    if (f16 <= (-dp)) {
                        q00Var.e = (byte) 1;
                    }
            ...
            boolean z4 = f20 < f19;
            if (f20 > f19) {
                q00Var.k = ((AndroidUtilities.dp(1.0f) / 3.0f) * f13 * r00Var2.e) + f20;
            } else {
                q00Var.k = vh.v2.c(AndroidUtilities.dp(1.0f), 3.0f, f13, f20);
            }
            if (z4 && q00Var.k > f19) {
                r00Var2.f++;
            }
            byte b11 = q00Var.a;
            if (b11 == 1 || b11 == 2) {
                short s6 = (short) ((f13 * 10.0f) + q00Var.i);
                q00Var.i = s6;
                if (s6 > 360) {
                    q00Var.i = (short) (s6 - 360);
                }
            }
