...
public abstract class v31 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public v31(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        c90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.i6.uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.i6.vf);
        try {
    ...
    public static void o(v31 v31Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = v31Var.r;
        v31Var.b = null;
    ...
    public static void p(v31 v31Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            org.telegram.messenger.y0.p(bool.booleanValue() ? R.string.TranslationFailedAlert1 : R.string.TranslationFailedAlert2, new vc((FrameLayout) v31Var.containerView, v31Var.resourcesProvider), null);
            r31 r31Var = v31Var.x.e;
            String str2 = v31Var.w;
            v31Var.v = str2;
    ...
    public static boolean u(v31 v31Var) {
        ...
        return f7 >= ((float) ((i31Var.getHeight() - i31Var.getPaddingTop()) - i31Var.getPaddingBottom()));
    }
    ...
    public final void M() {
        ...
        this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.qo(17, this, tL_textWithEntities)));
    }
