...
public final class pd0 extends HorizontalScrollView {
    ...
    public static void a(pd0 pd0Var, int i10, int i11) {
        View childAt;
        if (pd0Var.f == 0 || (childAt = pd0Var.d.getChildAt(i10)) == null) {
            return;
        }
        ...
        if (childAt != null) {
            ...
            if (f10 <= 0.0f || (i10 = this.h) >= this.f - 1) {
                ...
                if (childAt instanceof od0) {
                    ...
                    od0Var.setTextColor(od0Var.a.c(AndroidUtilities.lerp(0.6f, 0.8f, 1.0f - this.n)));
                }
                if (childAt2 instanceof od0) {
                    od0 od0Var2 = (od0) childAt2;
                    od0Var2.setTextColor(od0Var2.a.c(AndroidUtilities.lerp(0.6f, 0.8f, this.n)));
                }
            }
            if (this.y != 0) {
