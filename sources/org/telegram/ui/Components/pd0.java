...
public final class pd0 extends FrameLayout {
    ...
    /* JADX WARN: Type inference failed for: r6v2, types: [android.view.View, android.widget.EditText, android.widget.TextView, org.telegram.ui.Components.EditTextBoldCursor, org.telegram.ui.Components.hu, pg.b] */
    public final void b(ArrayList arrayList, boolean z10, boolean z11, boolean z12) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (b10 == 0) {
                ...
                ?? od0Var = new od0(getContext());
                od0Var.setBackgroundColor(0);
                od0Var.setPadding(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(7.0f));
                od0Var.setTextSize(0, mediaEntity.fontSize);
                od0Var.setTypeface(mediaEntity.textTypeface.d());
                SpannableString spannableString = new SpannableString(Emoji.replaceEmoji(mediaEntity.text, od0Var.getPaint().getFontMetricsInt(), false));
                ...
                while (i13 < size2) {
                    ...
                    y5 y5Var = new y5(emojiEntity2.document_id, od0Var.getPaint().getFontMetricsInt());
                ...
                od0Var.setText(spannableString);
                int i15 = 17;
                ...
                od0Var.setTextAlignment(i11);
                od0Var.setHorizontallyScrolling(false);
                od0Var.setImeOptions(TLObject.FLAG_28);
                od0Var.setFocusableInTouchMode(true);
                od0Var.setEnabled(false);
                od0Var.setInputType(od0Var.getInputType() | 16384);
                if (i17 >= 23) {
                    od0Var.setBreakStrategy(0);
                }
                od0Var.setShadowLayer(0.0f, 0.0f, 0.0f, 0);
                int i20 = mediaEntity.color;
                byte b11 = mediaEntity.subType;
                if (b11 == 0) {
                    od0Var.setFrameColor(i20);
                    i20 = AndroidUtilities.computePerceivedBrightness(mediaEntity.color) >= 0.721f ? -16777216 : -1;
                } else if (b11 == 1) {
                    od0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -1728053248 : -1711276033);
                } else if (b11 == 2) {
                    od0Var.setFrameColor(AndroidUtilities.computePerceivedBrightness(i20) >= 0.25f ? -16777216 : -1);
                } else {
                    od0Var.setFrameColor(0);
                }
                od0Var.setTextColor(i20);
                od0Var.setCursorColor(i20);
                od0Var.setHandlesColor(i20);
                od0Var.setHighlightColor(org.telegram.ui.ActionBar.j6.l1(0.4f, i20));
                mediaEntity.view = od0Var;
                w9Var = od0Var;
            } else {
                w9Var = null;
            }
