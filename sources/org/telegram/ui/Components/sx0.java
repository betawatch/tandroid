...
public final /* synthetic */ class sx0 implements View.OnClickListener {
    ...
    public /* synthetic */ sx0(int i10, Object obj, Object obj2) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
    }
    ...
    public final void onClick(View view) {
        ...
        switch (this.a) {
            case 0:
                ...
                org.telegram.ui.qt.q().v(ux0Var.r.j0);
            ...
            case 7:
                ...
                if (file == null) {
                    ...
                    Activity findActivity = AndroidUtilities.findActivity(o61Var.getContext());
            ...
            case 11:
                ...
                if (!z11 || ApplicationLoader.mainInterfacePaused) {
                    ...
                    ci1.w((Activity) context, n2Var.I);
                    break;
                }
                break;
            case 12:
                org.telegram.ui.os osVar = (org.telegram.ui.os) this.b;
                osVar.showDialog(z4.m(osVar.getParentActivity(), LocaleController.formatString(R.string.UserSuggestBirthdayTitle, UserObject.getForcedFirstName((TLRPC.User) this.c)), LocaleController.getString(R.string.UserSuggestBirthdayButton), null, new org.telegram.ui.w3(osVar, i10), null, false, false, osVar.r).a);
                break;
            case 13:
            ...
            case 14:
                ...
                for (fy0 fy0Var : fy0VarArr) {
                    if (fy0Var != null) {
                        boolean z12 = fy0Var.c;
                    }
                }
                org.telegram.ui.Cells.z1 z1Var2 = (org.telegram.ui.Cells.z1) view;
                int intValue2 = ((Integer) z1Var2.getTag()).intValue();
                fy0 fy0Var2 = fy0VarArr[intValue2];
                boolean z13 = fy0Var2.c;
                boolean z14 = !z13;
                if (z13 != z14) {
                    fy0Var2.c = z14;
                    fy0Var2.d = true;
                }
                z1Var2.c(fy0Var2.c, true);
                boolean z15 = fy0VarArr[intValue2].c;
            ...
            case 19:
                ...
                break;
            case 20:
                AndroidUtilities.runOnUIThread(new l41(14, (org.telegram.ui.py) this.b, (String) this.c), 250L);
                break;
            case 21:
            ...
            case 26:
                ...
                if (!org.telegram.ui.py.u4) {
                    ...
                    ij0 ij0Var2 = v70Var.v;
                    ij0Var2.N(!q10 ? ij0Var2.e[0] - 1 : 0);
                    lj0Var.d();
                    int[] iArr = {(lj0Var.getMeasuredWidth() / 2) + r14, (lj0Var.getMeasuredHeight() / 2) + r14};
                    lj0Var.getLocationInWindow(iArr);
                    int i17 = iArr[0];
                    int i18 = iArr[1];
                    NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needSetDayNightTheme, N0, Boolean.FALSE, iArr, -1, Boolean.valueOf(z16), lj0Var);
                    lj0Var.setContentDescription(LocaleController.getString(!q10 ? R.string.AccDescrSwitchToDayTheme : R.string.AccDescrSwitchToNightTheme));
                    break;
                }
                break;
            case 27:
                ...
                if (h80Var.c0.isEmpty()) {
                    ...
                    pyVar3.z2 = new org.telegram.ui.rs(13, h80Var, pyVar3);
            ...
            case 28:
                ...
                break;
            default:
                z4.y((Context) this.c, LocaleController.getString(R.string.ExpireAfter), LocaleController.getString(R.string.SetTimeLimit), -1L, new org.telegram.ui.db0((org.telegram.ui.ob0) this.b, i11));
                break;
        }
    }
}
