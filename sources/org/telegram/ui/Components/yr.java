            ...
            case 0:
                ...
                if (fsVar.b0 != null) {
                    ...
                    if (fsVar.z0) {
                        ...
                        j51 z11 = j51.z(i10 + "/2", str, 100);
                        z11.K(i10 == 2);
                        z11.f = fsVar.B0;
                        z11.D = new org.telegram.ui.tf(29, fsVar, x51Var);
                        arrayList.add(z11);
                        if (!fsVar.B0) {
                            j51 y3 = j51.y(101, LocaleController.getString(R.string.RestrictUserDeleteAllMessages));
                            y3.K(fsVar.C0);
                            y3.i = 1;
                            arrayList.add(y3);
                            j51 y10 = j51.y(102, LocaleController.getString(R.string.RestrictUserDeleteAllReactions));
                            y10.K(fsVar.D0);
                            y10.i = 1;
                            arrayList.add(y10);
                        }
                    ...
                    if (!fsVar.h0 && esVar2.c()) {
                        if (fsVar.g0) {
                            ...
                            if (!fsVar.y0) {
                                ...
                                y16.i = 1;
                                arrayList.add(y16);
                                j51 y17 = j51.y(12, LocaleController.getString(R.string.SendMediaPermissionStickersGifs));
                                ...
                                y17.i = 1;
                                arrayList.add(y17);
                                j51 y18 = j51.y(13, LocaleController.getString(R.string.SendMediaPolls));
                                y18.K((tL_chatBannedRights.send_polls || tL_chatBannedRights2.send_polls) ? false : true);
                                y18.t = tL_chatBannedRights2.send_polls;
                                y18.i = 1;
                                arrayList.add(y18);
                                j51 y19 = j51.y(14, LocaleController.getString(R.string.UserRestrictionsEmbedLinks));
                                ...
                                y19.i = 1;
                                arrayList.add(y19);
                                j51 y20 = j51.y(15, LocaleController.getString(R.string.UserRestrictionsSendReactions));
                        ...
                        if (fsVar.o0) {
                            ...
                            if (fsVar.q0 == 0) {
                                ...
                                arrayList.add(j51.A(104, AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("CommunityBanFromCommunityInfo", participantJoinedChats != null ? participantJoinedChats.joined_chat_ids.size() : 1, new Object[0]), new zr(fsVar, 1)), true)));
                                break;
                            }
                        }
                    }
