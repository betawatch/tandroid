...
public class qk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public qk0(int i10, int i11, Context context, org.telegram.ui.ActionBar.m2 m2Var, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        int i12 = 1;
        w0Var.j(new ug0(this, i12));
        w0Var.i(new dk0(this, i12));
    ...
    */
                        ...
                        while (i19 < w0Var3.getChildCount()) {
                            ...
                            if (childAt instanceof ok0) {
                                ...
                                if (o0Var3.equals(this.l0)) {
                                    ...
                                    float measuredWidth = (((this.p0 - 1.0f) * ok0Var.getMeasuredWidth()) / 3.0f) - (((1.0f - this.q0) * ok0Var.getMeasuredWidth()) * (Math.abs(this.m0 - R2) - 1));
                                    if (R2 < this.m0) {
                                            ...
                                            if ((childAt.getMeasuredWidth() / f14) + childAt.getX() <= f17 || (childAt.getMeasuredWidth() / f14) + childAt.getX() >= w0Var2.getWidth()) {
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    ...
                                                    if (z11) {
                                                        ...
                                                        ((ValueAnimator) trVar3.b).addUpdateListener(new s70(trVar3, 7));
                                                        ((ValueAnimator) trVar3.b).setStartDelay((long) (abs * ((qk0) trVar3.c).c));
    ...
    public void setSelectedEmojis(ArrayList<String> arrayList) {
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.b, (Utilities.Callback<View>) new ck0(this, 0));
    }
