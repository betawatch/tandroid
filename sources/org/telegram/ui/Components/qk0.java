...
public class qk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public qk0(int i10, int i11, Context context, org.telegram.ui.ActionBar.n2 n2Var, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.a = false;
        ...
        paint2.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, e6Var));
        paint3.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Jj, e6Var));
        this.k0 = e6Var;
        this.J = i11;
        this.t0 = n2Var;
        ...
        w0Var.j(new tb0(this, 3));
        w0Var.i(new dk0(this, 1));
        w0Var.setOnItemClickListener(new j(this, 11));
        w0Var.setOnItemLongClickListener((ml0) new i2.s(this, i10, 8));
    ...
    public static void a(qk0 qk0Var) {
        ...
        zg.b0 b0Var = new zg.b0(qk0Var.M0, qk0Var.t0, qk0Var.V, qk0Var.d0, qk0Var, qk0Var.k0, qk0Var.a);
        qk0Var.x0 = b0Var;
        ah.c cVar = qk0Var.Z0;
        boolean z10 = true;
        if (cVar != null) {
            dh.e eVar = qk0Var.a1;
            org.telegram.ui.x51 x51Var = b0Var.m.f0;
            x51Var.x = true;
            x51Var.setBackground(null);
            x51Var.e();
            x51Var.invalidate();
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f23 != 1.0f) {
                ...
                o0Var = this.l0;
                i10 = this.M0;
                if (o0Var != null && i10 != 5 && ((pk0Var = this.g0) == null || pk0Var.j())) {
                    f22 = this.n0;
                    if (f22 != 1.0f) {
                ...
                if (this.v != 0.0f) {
                    ...
                    if (getAlpha() == 1.0f || i18 == 5) {
                        ...
                        while (i19 < w0Var3.getChildCount()) {
                            ...
                            float f34 = f25;
                            if (childAt instanceof ok0) {
                                ok0 ok0Var = (ok0) w0Var3.getChildAt(i19);
                                i14 = i19;
                                if (this.B0 != 0.0f) {
                                    i13 = save3;
                                    f19 = AndroidUtilities.dp(46.0f) * Utilities.clamp(ok0Var.getLeft() / (getMeasuredWidth() - AndroidUtilities.dp(34.0f)), 1.0f, 0.0f) * getPullingLeftProgress();
                                } else {
                                    i13 = save3;
                                    f19 = 0.0f;
                                }
                                ...
                                if (o0Var3.equals(this.l0)) {
                                    ...
                                    ok0Var.setScaleX(this.p0);
                                    ok0Var.setScaleY(this.p0);
                                    if (!this.r0) {
                                        if (this.Q == null) {
                                            nk0Var3.setVisibility(0);
                                            nk0Var3.setAlpha(1.0f);
                                            if (nk0Var3.getImageReceiver().hasBitmapImage() || ((q5Var = nk0Var3.e) != null && (l4Var = q5Var.k) != null && l4Var.hasBitmapImage())) {
                                                nk0Var4.setAlpha(0.0f);
                                            }
                                            f21 = 1.0f;
                                        } else {
                                            f21 = 1.0f;
                                            nk0Var3.setAlpha(1.0f - this.o0);
                                            nk0Var4.setAlpha(this.o0);
                                        }
                                        if (this.n0 == f21) {
                                            this.r0 = true;
                                            if (System.currentTimeMillis() - this.s0 > 300) {
                                                ...
                                                w0Var2 = w0Var3;
                                                this.g0.h(ok0Var, ok0Var.e, true, false);
                                                canvas2.save();
                                                x10 = ok0Var.getX() + w0Var2.getX();
                                                scaleX = ((ok0Var.getScaleX() * ok0Var.getMeasuredWidth()) - ok0Var.getMeasuredWidth()) / f14;
                                                f20 = x10 - scaleX;
                                                if (f20 >= 0.0f && ok0Var.getTranslationX() >= 0.0f) {
                                                    ok0Var.setTranslationX((-f20) - f35);
                                                } else if (ok0Var.getMeasuredWidth() + x10 + scaleX > getMeasuredWidth() || ok0Var.getTranslationX() > 0.0f) {
                                                    ok0Var.setTranslationX(0.0f - f35);
                                                } else {
                                                    ok0Var.setTranslationX((((getMeasuredWidth() - x10) - ok0Var.getMeasuredWidth()) - scaleX) - f35);
                                                }
                                                canvas2.translate(ok0Var.getX() + w0Var2.getX(), ok0Var.getY() + w0Var2.getY());
                                    ...
                                    w0Var2 = w0Var3;
                                    int S2 = RecyclerView.S(ok0Var);
                                    float measuredWidth = (((this.p0 - 1.0f) * ok0Var.getMeasuredWidth()) / 3.0f) - (((1.0f - this.q0) * ok0Var.getMeasuredWidth()) * (Math.abs(this.m0 - S2) - 1));
                                    if (S2 < this.m0) {
                                        ok0Var.setPivotX(0.0f);
                                        ok0Var.setTranslationX(-measuredWidth);
                                    } else {
                                        ok0Var.setPivotX(ok0Var.getMeasuredWidth() - f35);
                                        ok0Var.setTranslationX(measuredWidth - f35);
                                    }
                                    ok0Var.setPivotY(nk0Var.getY() + nk0Var.getMeasuredHeight());
                                    ok0Var.setScaleX(this.q0);
                                    ok0Var.setScaleY(this.q0);
                                ...
                                if (!this.N0 && (!ok0Var.r || nk0Var.getImageReceiver().getLottieAnimation() != null)) {
                                    if ((ok0Var.getMeasuredWidth() / f14) + ok0Var.getX() > 0.0f && (ok0Var.getMeasuredWidth() / f14) + ok0Var.getX() < w0Var2.getWidth()) {
                                            ...
                                            if ((childAt.getMeasuredWidth() / f14) + childAt.getX() <= f17 || (childAt.getMeasuredWidth() / f14) + childAt.getX() >= w0Var2.getWidth()) {
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    ...
                                                    if (z11) {
                                                        ...
                                                        ((ValueAnimator) srVar3.b).addUpdateListener(new q70(srVar3, 7));
                                                        ((ValueAnimator) srVar3.b).setStartDelay((long) (abs * ((qk0) srVar3.c).c));
                        ...
                        if (pullingLeftProgress > 0.0f) {
                            ...
                            int measuredWidth3 = ok0Var2.getMeasuredWidth() - AndroidUtilities.dp(f14);
                            float f36 = i20 + measuredWidth3;
                            float clamp2 = Utilities.clamp(f36 / (getMeasuredWidth() - ok0Var2.getMeasuredWidth()), 1.0f, 0.0f) * pullingLeftProgress2 * measuredWidth3;
                            ...
                            ok0Var2.setTranslationX(((w0Var.getX() + f36) - clamp2) + (-((i18 == 1 || i18 == 2) ? AndroidUtilities.dp(8.0f) : AndroidUtilities.dp(20.0f))));
                            if (ok0Var2.getVisibility() != 0) {
                                ok0Var2.setVisibility(0);
                            }
                        } else {
                            if (ok0Var2.getVisibility() != 8 && this.O0) {
                        ...
                        if (!this.c1 && this.x0 != null) {
                            int A = (int) org.telegram.messenger.q.A(1.0f, this.w0, Utilities.clamp(1.0f - (this.w0 / 0.2f), 1.0f, 0.0f), 255.0f);
                            canvas.save();
    ...
    public final void n() {
        ...
        ai.w0 w0Var = this.b;
        AndroidUtilities.forEachViews((RecyclerView) w0Var, (e2.h) ck0Var);
        this.C0.clear();
        w0Var.invalidate();
        ci.n6 n6Var = this.S;
        if (n6Var != null) {
    ...
    public final void p(MessageObject messageObject, TLRPC.ChatFull chatFull, boolean z10) {
        ...
        if (q()) {
            ...
            if (i16 < arrayList2.size()) {
                ok0.a(this.z0, (zg.o0) arrayList2.get(i16), -1);
            }
        } else {
        ...
        for (int i18 = 0; i18 < arrayList8.size(); i18++) {
            ...
            arrayList9.add(new hk0(o0Var3.f == null ? 3 : 0, o0Var3));
        }
    ...
    public void setHint(CharSequence charSequence) {
        ...
        if (this.R0 == null) {
            ...
            this.R0 = l90Var;
            l90Var.setPadding(AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f), 0);
            this.R0.setClickable(true);
            this.R0.setTextSize(1, 12.0f);
            int i10 = this.M0;
            if (i10 == 1 || i10 == 2 || i10 == 4) {
                this.R0.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, e6Var));
                this.R0.setAlpha(0.5f);
            } else {
                this.R0.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, e6Var));
            }
    ...
    public void setSelectedEmojis(ArrayList<String> arrayList) {
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.b, (e2.h) new ck0(this, 0));
    }
