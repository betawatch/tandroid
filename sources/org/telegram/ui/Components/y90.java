...
public final class y90 extends qv0 {
    public final /* synthetic */ int t0;
    public final /* synthetic */ FrameLayout u0;
    public final /* synthetic */ org.telegram.ui.ActionBar.p2 v0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ y90(org.telegram.ui.ActionBar.p2 p2Var, Context context, FrameLayout frameLayout, int i10) {
        super(context, null);
        this.t0 = i10;
        this.v0 = p2Var;
        this.u0 = frameLayout;
    ...
    public void L(Canvas canvas, ArrayList arrayList) {
        switch (this.t0) {
            case 0:
                ((ea0) this.v0).S.Q(canvas, arrayList);
                break;
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.t0) {
            case 0:
                ea0 ea0Var = (ea0) this.v0;
                ba0 ba0Var = ea0Var.S;
                if (ba0Var != null && (qt0Var = (qt0VarArr = ba0Var.h0)[0]) != null && qt0Var.h.getFastScroll() != null && qt0VarArr[0].h.getFastScroll().n) {
                    return ea0Var.S.O(motionEvent);
                }
                ba0 ba0Var2 = ea0Var.S;
                if (ba0Var2 == null || !ba0Var2.H(motionEvent)) {
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        switch (this.t0) {
            case 1:
                ...
                break;
            case 2:
                org.telegram.ui.n0 n0Var = (org.telegram.ui.n0) this.u0;
                wg1 wg1Var = (wg1) this.v0;
                if (wg1Var.b0.getVisibility() == 8 || R() < AndroidUtilities.dp(20.0f)) {
                    if (wg1Var.b0.getVisibility() != 8) {
                ...
                wg1Var.b0.layout(0, measuredHeight2, getMeasuredWidth(), AndroidUtilities.dp(230.0f) + measuredHeight2);
                break;
            default:
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.t0) {
            case 0:
                ...
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) ea0Var.S.getLayoutParams();
                int currentActionBarHeight = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
                kVar = ((org.telegram.ui.ActionBar.p2) ea0Var).actionBar;
                ...
                kVar2 = ((org.telegram.ui.ActionBar.p2) ea0Var).actionBar;
                ...
                for (int i12 = 0; i12 < 2; i12++) {
                    if (k5VarArr[i12] != null) {
                        ((FrameLayout.LayoutParams) k5VarArr[i12].getLayoutParams()).topMargin = AndroidUtilities.dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 5.0f : 4.0f) + org.telegram.ui.b.x(22.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() / 2, 2);
                    }
                ...
                ((FrameLayout.LayoutParams) ea0Var.y.getLayoutParams()).topMargin = org.telegram.ui.b.x(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
            ...
            default:
                ...
                ((org.telegram.ui.n0) this.u0).measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size4, TLObject.FLAG_30));
                wg1Var.b0.measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(230.0f), TLObject.FLAG_30));
                break;
        }
    }
}
