...
public abstract class TopicsTabsView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean onTabLongClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (ChatObject.isMonoForum(chat2)) {
            ...
            itemOptions.add(R.drawable.msg_clear, LocaleController.getString(R.string.ClearHistory), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (ChatObject.canManageTopics(chat2) || UserObject.isBotForum(user2)) {
                ...
                itemOptions.add(z ? R.drawable.msg_unpin : R.drawable.msg_pin, LocaleController.getString(z ? R.string.DialogUnpin : R.string.DialogPin), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda10
                    @Override // java.lang.Runnable
                    public final void run() {
                ...
                if (tL_forumTopic.pinned) {
                    itemOptions.add(R.drawable.tabs_reorder, LocaleController.getString(R.string.FilterReorder), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda11
                        @Override // java.lang.Runnable
                        public final void run() {
