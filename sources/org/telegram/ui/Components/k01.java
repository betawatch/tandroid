...
public final class k01 extends FrameLayout {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (i31 < i32) {
                ...
                RectF rectF = this.b;
                if (f10 != 1.0f) {
                    org.telegram.ui.ActionBar.g6.t0.setColor(-1);
                ...
                org.telegram.ui.ActionBar.g6.t0.setColor(-1973016);
                org.telegram.ui.ActionBar.g6.t0.setAlpha((int) (editorAlert.c.getAlpha() * 255.0f));
                ...
                if (i13 > 0) {
                    ...
                    canvas.drawRect(i14, f12, measuredWidth2 - i15, AndroidUtilities.statusBarHeight, org.telegram.ui.ActionBar.g6.t0);
                }
                ...
                boolean z12 = AndroidUtilities.computePerceivedBrightness(editorAlert.getThemedColor(org.telegram.ui.ActionBar.g6.h5)) <= 0.721f;
                boolean z13 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.g6.v(editorAlert.getThemedColor(org.telegram.ui.ActionBar.g6.s8), 855638016)) > 0.721f;
        ...
        if (AndroidUtilities.computePerceivedBrightness(editorAlert.getThemedColor(org.telegram.ui.ActionBar.g6.h5)) <= 0.721f) {
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.g6.v(editorAlert.getThemedColor(org.telegram.ui.ActionBar.g6.s8), 855638016)) > 0.721f) {
        }
        this.c = Boolean.valueOf(z11);
        if (!z11) {
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (l01Var.getPaddingTop() != dp) {
            this.a = true;
            l01Var.getPaddingTop();
            l01Var.setPadding(0, dp, 0, AndroidUtilities.dp(48.0f));
