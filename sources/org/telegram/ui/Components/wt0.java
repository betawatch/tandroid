...
public final class wt0 extends FrameLayout {
    public final org.telegram.ui.Cells.h6 a;

    public wt0(int i10, Context context, boolean z10, org.telegram.ui.ActionBar.f6 f6Var, kq0 kq0Var) {
        super(context);
        org.telegram.ui.Cells.h6 h6Var = new org.telegram.ui.Cells.h6(context, f6Var);
        this.a = h6Var;
        h6Var.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, f6Var), 2, -1));
        ...
        dVar.setOnClickListener(new x70(kq0Var, 17));
        ...
        c90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.n6, f6Var));
        c90Var.setLineSpacing(AndroidUtilities.dp(3.0f), 1.0f);
        SpannableStringBuilder premiumText = AndroidUtilities.premiumText(LocaleController.getString(z10 ? R.string.MoreSimilarBotsText : R.string.MoreSimilarText), new kq0(kq0Var, 4));
