...
public final class zg extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (chatActivityEnterView.c1 && j3 >= 59500 && !this.b) {
            ...
            chatActivityEnterView.Y2.i2(3, 0, chatActivityEnterView.O ? ConnectionsManager.DEFAULT_DATACENTER_ID : 0, chatActivityEnterView.R4, 0L, true);
        ...
        if (formatTimerDurationFast.length() < 3 || (str = this.c) == null || str.length() < 3 || formatTimerDurationFast.length() != this.c.length() || formatTimerDurationFast.charAt(formatTimerDurationFast.length() - 3) == this.c.charAt(formatTimerDurationFast.length() - 3)) {
            ...
            for (int i17 = 0; i17 < length - 1; i17++) {
                if (this.c.charAt(i17) != formatTimerDurationFast.charAt(i17)) {
                    ...
                    if (i15 != 0) {
                        ...
                        int i18 = i15 + i13;
                        spannableStringBuilder.setSpan(szVar, i13, i18, 33);
                        spannableStringBuilder2.setSpan(szVar, i13, i18, 33);
                        i15 = 0;
                    }
                } else {
                    if (i15 == 0) {
                    ...
                    i15++;
                    if (i16 != 0) {
                        this.r.setSpan(new sz(false), i14, i16 + i14, 33);
                        i16 = 0;
                    }
                }
            }
            if (i15 != 0) {
                ...
                int i19 = i15 + i13 + 1;
                spannableStringBuilder.setSpan(szVar2, i13, i19, 33);
                spannableStringBuilder2.setSpan(szVar2, i13, i19, 33);
            }
            if (i16 != 0) {
                this.r.setSpan(new sz(false), i14, i16 + i14, 33);
            }
