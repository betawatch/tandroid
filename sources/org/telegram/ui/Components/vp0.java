...
public final /* synthetic */ class vp0 implements Runnable {
    ...
    public /* synthetic */ vp0(zp0 zp0Var, int i10, String str) {
        this.a = 1;
        this.b = zp0Var;
        this.c = i10;
        this.d = str;
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                zp0 zp0Var3 = this.b;
                zp0Var3.f = null;
                i10 = ((org.telegram.ui.ActionBar.f3) zp0Var3.G).currentAccount;
                DispatchQueue storageQueue = MessagesStorage.getInstance(i10).getStorageQueue();
                String str = this.d;
                int i18 = this.c;
                storageQueue.postRunnable(new vp0(zp0Var3, str, i18, 2));
                vp0 vp0Var = new vp0(zp0Var3, i18, str);
                zp0Var3.h = vp0Var;
                AndroidUtilities.runOnUIThread(vp0Var);
                break;
            case 1:
                zp0 zp0Var4 = this.b;
                zp0Var4.h = null;
                ...
                int i20 = this.c;
                if (i20 == i19) {
                    zp0Var4.e.g(this.d, true, true, true, true, 0L, false, 0, i20);
                    break;
                }
                break;
            default:
                ...
                int i21 = this.c;
                zp0 zp0Var5 = this.b;
                dq0 dq0Var2 = zp0Var5.G;
                try {
                    String lowerCase = str2.trim().toLowerCase();
                    if (lowerCase.length() == 0) {
                        zp0Var5.r = -1;
                        AndroidUtilities.runOnUIThread(new rm(zp0Var5, zp0Var5.r, new ArrayList(), 9));
                        break;
                    } else {
                        ...
                        a0.h hVar = new a0.h();
                        i11 = ((org.telegram.ui.ActionBar.f3) dq0Var2).currentAccount;
                        ...
                        while (queryFinalized.next()) {
                            ...
                            qp0 qp0Var = new qp0();
                            qp0Var.c = queryFinalized.intValue(1);
                            hVar.k(qp0Var, longValue);
                        ...
                        if (arrayList.isEmpty()) {
                            ...
                            i16 = ((org.telegram.ui.ActionBar.f3) dq0Var2).currentAccount;
                                            ...
                                            if (!stringValue.contains(" " + str3)) {
                                                ...
                                                if (r12 == 0) {
                                                    ...
                                                    if (byteBufferValue != null) {
                                                        ...
                                                        int i27 = i21;
                                                        zp0Var2 = zp0Var5;
                                                        qp0 qp0Var2 = (qp0) hVar.f(TLdeserialize.id);
                                                        ...
                                                        if (r12 == z10) {
                                                            qp0Var2.d = AndroidUtilities.generateSearchName(TLdeserialize.first_name, TLdeserialize.last_name, str3);
                                                        } else {
                                                            qp0Var2.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize), null, "@" + str3);
                                                        }
                                                        qp0Var2.b = TLdeserialize;
                                                        qp0Var2.a.id = TLdeserialize.id;
                                                        i23 = i24 + 1;
                                                    }
                                                } else {
                                                    i25 = i26 + 1;
                                ...
                                for (int i28 = 0; i28 < i22; i28++) {
                                    ...
                                    if (byteBufferValue2 != null) {
                                        ...
                                        if (TLdeserialize2 != null && !ChatObject.isNotInChat(TLdeserialize2) && (!ChatObject.isChannel(TLdeserialize2) || TLdeserialize2.creator || (((tL_chatAdminRights = TLdeserialize2.admin_rights) != null && tL_chatAdminRights.post_messages) || TLdeserialize2.megagroup))) {
                                            qp0 qp0Var3 = (qp0) hVar.f(-TLdeserialize2.id);
                                            qp0Var3.d = AndroidUtilities.generateSearchName(TLdeserialize2.title, null, str4);
                                            qp0Var3.b = TLdeserialize2;
                                            qp0Var3.a.id = -TLdeserialize2.id;
                                            i13++;
                                        }
                                    }
                                }
                        ...
                        for (int i29 = 0; i29 < hVar.m(); i29++) {
                            qp0 qp0Var4 = (qp0) hVar.n(i29);
                            if (qp0Var4.b != null && qp0Var4.d != null) {
                                arrayList3.add(qp0Var4);
                            }
                        }
                                            ...
                                            if (!stringValue3.contains(" " + str5)) {
                                                ...
                                                if (c3 == 0) {
                                                    ...
                                                    if (byteBufferValue3 != null) {
                                                        ...
                                                        qp0Var5.a.id = TLdeserialize3.id;
                                                        qp0Var5.b = TLdeserialize3;
                                                        if (c3 == 1) {
                                                            qp0Var5.d = AndroidUtilities.generateSearchName(TLdeserialize3.first_name, TLdeserialize3.last_name, str5);
                                                        } else {
                                                            qp0Var5.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize3), null, "@" + str5);
                                                        }
                                                        arrayList3.add(qp0Var5);
                                                    }
                                                } else {
                                                    i30++;
                                                }
                        ...
                        Collections.sort(arrayList3, new wp0(0));
                        AndroidUtilities.runOnUIThread(new rm(zp0Var, i12, arrayList3, 9));
                        break;
                    }
                } catch (Exception e10) {
                    FileLog.e(e10);
    ...
    public /* synthetic */ vp0(zp0 zp0Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = zp0Var;
        this.d = str;
        this.c = i10;
