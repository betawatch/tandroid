...
public final class l90 {
    ...
    public l90(CharacterStyle characterStyle, org.telegram.ui.ActionBar.f6 f6Var, float f7, float f10, int i10) {
    ...
    public final boolean a(Canvas canvas) {
        ...
        if (rect != null || this.h <= 0) {
            ...
            e90 e90Var = (e90) arrayList.get(0);
            RectF rectF = AndroidUtilities.rectTmp;
            e90Var.computeBounds(rectF, false);
            this.m = new Rect((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
            for (int i10 = 1; i10 < this.h; i10++) {
                e90 e90Var2 = (e90) arrayList.get(i10);
                RectF rectF2 = AndroidUtilities.rectTmp;
                e90Var2.computeBounds(rectF2, false);
                Rect rect2 = this.m;
    ...
    public final e90 b() {
        ...
        e90 e90Var = !arrayList.isEmpty() ? (e90) arrayList.remove(0) : new e90(0);
        e90Var.c = !this.r;
        e90Var.reset();
