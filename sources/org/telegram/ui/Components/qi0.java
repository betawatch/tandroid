...
public abstract class qi0 {
    ...
    public qi0(CharSequence charSequence, CharSequence charSequence2) {
        ...
        this.P = 1.0f;
        this.U = 1.0f;
        this.a0 = new oi0(this, 3);
        this.b0 = new oi0(this, 4);
    ...
    public final void c(Canvas canvas, boolean z4) {
        ...
        boolean z11 = q2Var instanceof pf1;
        ...
        if (f44 == 0.0f || z10) {
            ...
            int i26 = dp5 >> 1;
            i15 = dp;
            pi0Var.setBounds(i24 - dp6, measuredHeight - i26, i24 + dp6, measuredHeight + i26);
            ...
            pi0Var.b.setColor(this.G ? paint2.getColor() : org.telegram.ui.ActionBar.j6.w0(null, this.b, false));
            pi0Var.draw(canvas);
            canvas.restore();
        } else {
            i15 = dp;
