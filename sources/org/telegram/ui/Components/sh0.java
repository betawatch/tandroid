...
public final class sh0 extends FrameLayout {
    ...
    public final void a() {
        ...
        if (this.A) {
            ...
            this.s.setDuration(Math.max(60, (int) (((measuredHeight - oh0Var.getTranslationY()) * 250.0f) / measuredHeight)));
            this.A = false;
        } else {
            this.s.setDuration(250L);
        }
        this.s.setInterpolator(er.f);
        this.s.addListener(new rh0(this, 2));
            ...
            if (motionEvent == null || (!(motionEvent.getAction() == 0 || motionEvent.getAction() == 2) || this.f || this.e || motionEvent.getPointerCount() != 1)) {
                if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.d) {
                    ...
                    if (this.f || translationY2 != 0.0f) {
                        ...
                        if ((oh0Var.getTranslationY() >= AndroidUtilities.getPixelsInCM(0.8f, false) || (yVelocity >= 3500.0f && Math.abs(yVelocity) >= Math.abs(xVelocity))) && (yVelocity >= 0.0f || Math.abs(yVelocity) < 3500.0f)) {
                            this.A = true;
                            a();
                        } else {
                ...
                this.c = y11;
                if (y11 < oh0Var.getTop() || this.b < oh0Var.getLeft() || this.b > oh0Var.getRight()) {
                    requestDisallowInterceptTouchEvent(true);
                    a();
                    return true;
                }
    ...
    */
    public final void c(boolean z10) {
        ...
        int i10 = (int) value;
        org.telegram.ui.tc0 tc0Var = this.E.b;
        ArrayList arrayList = tc0Var.c0;
        ...
        if (iCircle != null) {
            ...
            if (z10) {
                ...
                onCreateLatLngBoundsBuilder.include(new IMapsProvider.LatLng(tc0Var.s0.getLatitude(), tc0Var.s0.getLongitude()));
                try {
                    ...
                    double d = max;
                    IMapsProvider.LatLng p02 = org.telegram.ui.tc0.p0(center, d, d);
                    double d10 = -max;
                    onCreateLatLngBoundsBuilder.include(org.telegram.ui.tc0.p0(center, d10, d10));
                    ...
                    try {
                        ...
                        tc0Var.E.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngBounds(build, 0), 500, null);
                    } catch (Exception e9) {
                        FileLog.e(e9);
                    }
        ...
        if (!DialogObject.isChatDialog(tc0Var.a0)) {
            int size = arrayList.size();
            for (int i11 = 0; i11 < size; i11++) {
                org.telegram.ui.nc0 nc0Var = (org.telegram.ui.nc0) arrayList.get(i11);
                if (nc0Var.b != null && !UserObject.isUserSelf(nc0Var.c)) {
                    TLRPC.GeoPoint geoPoint = nc0Var.b.media.geo;
                    Location location = new Location("network");
                    location.setLatitude(geoPoint.lat);
                    location.setLongitude(geoPoint._long);
                    if (tc0Var.s0.distanceTo(location) > i10) {
                    }
                }
            }
            z11 = false;
            ...
            if (user != null) {
                qh0Var.setText(LocaleController.formatString("LocationNotifiationButtonGroup", R.string.LocationNotifiationButtonGroup, formatDistance));
            } else {
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        oh0 oh0Var = this.v;
        oh0Var.measure(View.MeasureSpec.makeMeasureSpec((this.x * 2) + size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_31));
        int childCount = getChildCount();
