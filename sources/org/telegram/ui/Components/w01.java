    ...
    public final void g() {
        ...
        if (this.b.get()) {
            ...
            while (i14 < this.T.size()) {
                v01 v01Var = (v01) this.T.get(i14);
                if (v01Var.d) {
                    ArrayList arrayList = this.T;
                    int i15 = 0;
                    for (int i16 = 0; i16 < arrayList.size(); i16++) {
                        i15 += ((v01) arrayList.get(i16)).u;
                    }
                    float f7 = v01Var.u;
                    float f10 = f7 / i15;
                    int[] iArr = v01Var.B;
                    ...
                    int i18 = v01Var.E.a ? 120000 : devicePerformanceClass != 1 ? devicePerformanceClass != 2 ? 30000 : 120000 : 60000;
                    if (v01Var.D) {
                        i18 /= 2;
                    }
                    float max = Math.max(AndroidUtilities.dpf2(0.4f), 1.0f);
                    v01Var.s = Utilities.clamp((int) ((r4 * i17) / (max * max)), (int) (i18 * f10), 10);
                    float f11 = i17;
                    float f12 = f11 / f7;
                    int round = (int) Math.round(Math.sqrt(r4 / f12));
                    v01Var.w = round;
                    v01Var.v = Math.round(v01Var.s / round);
                    while (true) {
                        i10 = v01Var.v;
                        i11 = v01Var.w;
                        i12 = i10 * i11;
                    ...
                    v01Var.s = i12;
                    v01Var.x = Math.max(f11 / i10, f7 / i11);
                    GLES20.glGenBuffers(2, iArr, i13);
                    for (int i19 = 0; i19 < 2; i19++) {
                        GLES20.glBindBuffer(34962, iArr[i19]);
                        GLES20.glBufferData(34962, v01Var.s * 28, null, 35048);
                    }
                    if (v01Var.e != null) {
                        this.U.add(v01Var);
                    }
                ...
                int i20 = v01Var.u;
                int i21 = v01Var.t;
                Matrix matrix = v01Var.r;
                w01 w01Var = v01Var.E;
                long nanoTime = System.nanoTime();
                double d = v01Var.b < 0 ? 0.0d : (nanoTime - r7) / 1.0E9d;
                v01Var.b = nanoTime;
                if (v01Var.n && !v01Var.o) {
                    matrix.reset();
                    matrix.postScale(i21, i20);
                    matrix.postTranslate(v01Var.i, v01Var.j);
                    v01Var.c();
                }
                v01Var.c = (float) ((f13 * d) + v01Var.c);
                GLES20.glUniformMatrix3fv(w01Var.x, 1, false, v01Var.p, 0);
                GLES20.glUniform1f(w01Var.y, v01Var.d ? 1.0f : 0.0f);
                GLES20.glUniform1f(w01Var.E, v01Var.c);
                GLES20.glUniform1f(w01Var.F, ((float) d) * f13);
                GLES20.glUniform1f(w01Var.G, v01Var.s);
                GLES20.glUniform3f(w01Var.I, v01Var.v, v01Var.w, v01Var.x);
                GLES20.glUniform2f(w01Var.P, v01Var.g, v01Var.h);
                GLES20.glUniform1f(w01Var.Q, z10 ? 0.8f : 1.0f);
                GLES20.glUniform1f(w01Var.R, z10 ? 1.0f : 0.6f);
                GLES20.glUniform2f(w01Var.J, i21, i20);
                GLES20.glUniform1f(w01Var.K, v01Var.y);
                GLES20.glUniform2f(w01Var.L, 0.0f, 0.0f);
                GLES20.glUniform1f(w01Var.N, v01Var.k);
                GLES20.glUniform1f(w01Var.O, v01Var.l);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, v01Var.A[0]);
                GLES20.glUniform1i(w01Var.M, 0);
                GLES20.glBindBuffer(34962, iArr2[v01Var.z]);
                ...
                GLES30.glBindBufferBase(35982, 0, iArr2[1 - v01Var.z]);
                GLES20.glVertexAttribPointer(0, 2, 5126, false, 28, 0);
                GLES20.glEnableVertexAttribArray(0);
                GLES20.glVertexAttribPointer(1, 2, 5126, false, 28, 8);
                GLES20.glEnableVertexAttribArray(1);
                ...
                GLES20.glDrawArrays(0, 0, v01Var.s);
                GLES30.glEndTransformFeedback();
                GLES20.glBindBuffer(34962, 0);
                GLES20.glBindBuffer(35982, 0);
                v01Var.d = false;
                v01Var.z = 1 - v01Var.z;
                if (v01Var.c > v01Var.l + (v01Var.D ? 2.0f : 0.9f)) {
                    v01Var.a();
                    this.T.remove(i14);
                ...
                if (glGetError == 0) {
                    try {
                        ...
                        for (int i22 = 0; i22 < this.U.size(); i22++) {
                            AndroidUtilities.runOnUIThread(((v01) this.U.get(i22)).e);
                        }
                        this.U.clear();
                        for (int i23 = 0; i23 < this.T.size(); i23++) {
                            ((v01) this.T.get(i23)).a();
                        }
                        this.T.clear();
            ...
            for (int i24 = 0; i24 < this.U.size(); i24++) {
                AndroidUtilities.runOnUIThread(((v01) this.U.get(i24)).e);
            }
            this.U.clear();
    ...
    public final void handleMessage(Message message) {
        ...
        if (i10 == 4) {
            while (i11 < arrayList.size()) {
                ...
                v01Var.g += message.arg1;
                v01Var.h += message.arg2;
                i11++;
            }
            return;
        }
