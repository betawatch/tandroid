...
public final class rp extends xw0 {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.a) {
            case 0:
                ...
                float interpolation = qr.i.getInterpolation(min < 0.3f ? min / 0.3f : 1.0f);
                qr qrVar = qr.g;
                float interpolation2 = qrVar.getInterpolation(min < 0.3f ? 0.0f : (min - 0.3f) / 0.7f);
                if (this.d) {
                    ...
                    dpf2 = (1.0f - qrVar.getInterpolation(this.e / 2.0f)) * AndroidUtilities.dpf2(1.5f);
                } else {
                    dp = ((AndroidUtilities.dp(7.0f) - AndroidUtilities.dp(2.1f)) * interpolation) + ((1.0f - interpolation) * AndroidUtilities.dp(2.1f));
                    dpf2 = AndroidUtilities.dpf2(1.5f) * qr.h.getInterpolation(this.e / 2.0f);
                }
