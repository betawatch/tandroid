...
public final class gc0 {
    ...
    public int g;
    public int h;
    public final aa.a a = new aa.a(new x1(29));
    ...
    public final void d(Matrix matrix) {
        ...
        boolean z10 = false;
        fc0Var.a(b(fArr[0]) && b(fArr[1]));
        ec0 ec0Var = this.d;
        if (ec0Var == null || Build.VERSION.SDK_INT < 33) {
            return;
        }
        float[] fArr2 = ec0Var.g;
        a(matrix, fArr2);
    ...
    public final Paint e(Bitmap bitmap, Bitmap bitmap2, int i10, int i11, int i12, boolean z10) {
        ...
        if (i12 >= 0) {
            ...
            j10Var.a = 2;
            paint.setShader(new ComposeShader((yf.i) htVar.b, new ComposeShader(new ComposeShader(fc0Var2.d, fc0Var3.d, PorterDuff.Mode.DST_IN), (yf.i) htVar2.b, PorterDuff.Mode.MULTIPLY), PorterDuff.Mode.SRC_OVER));
            return paint;
        }
        return paint;
    }
