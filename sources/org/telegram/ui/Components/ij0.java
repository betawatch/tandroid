...
public class ij0 extends BitmapDrawable implements Animatable, yf.c {
    ...
    */
    public ij0(File file, String str, int i10, int i11, b2.n1 n1Var, boolean z10, int i12, boolean z11) {
        char c10;
        RLottieNative a2;
        int[] iArr = new int[3];
        this.e = iArr;
        ...
        this.i0 = new RectF[2];
        this.j0 = new Paint[2];
        this.v0 = new hj0(this, 1);
        this.w0 = new hj0(this, 2);
    ...
    public static void e(ij0 ij0Var) {
        if (ij0Var.l0 || ij0Var.V || !ij0Var.k() || ij0Var.O != null) {
            return;
        }
        ij0Var.x0 = true;
        if (T0 == null) {
    ...
    public static void f(ij0 ij0Var) {
        ...
        try {
            ...
            if (i10 == 1) {
                if (ij0Var.S != null) {
                    ...
                    createBitmap = Bitmap.createBitmap(ij0Var.b, ij0Var.c, ij0Var.G ? Bitmap.Config.ALPHA_8 : Bitmap.Config.ARGB_8888);
        ...
        if (i10 == 1) {
            ij0Var.G0 = 0;
            AndroidUtilities.runOnUIThread(ij0Var.w0);
        } else if (i10 == 2) {
            AndroidUtilities.runOnUIThread(ij0Var.v0, ij0Var.G0);
    ...
    public static void h(ij0 ij0Var) {
        ij0Var.X = true;
        if ((!ij0Var.k0 && ij0Var.W) || (ij0Var.Q == null && ij0Var.R != null)) {
            ij0Var.x();
        }
        ij0Var.p();
    }
