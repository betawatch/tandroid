...
public class ij0 extends BitmapDrawable implements Animatable, lf.e {
    ...
    */
    public ij0(File file, String str, int i10, int i11, ke.i iVar, boolean z4, int i12, boolean z10) {
        int i13;
        char c3;
        RLottieNative a2;
        ...
        if (!z11) {
            this.k0 = RLottieNative.a(file.getAbsolutePath(), str, i10, i11, iArr, z11, (int[]) hj0Var.e, z4, i12, hashMap);
            if (this.k0 == null) {
        ...
        try {
            try {
                ...
                i13 = 60;
                c3 = 1;
                a2 = RLottieNative.a(absolutePath, str, i14, i15, iArr, false, (int[]) hj0Var2.e, this.Z, hj0Var2.a, this.w);
                if (a2 != null) {
                    a2.d();
                }
                if (this.Z) {
            ...
            int i142 = this.b;
            int i152 = this.c;
            hj0 hj0Var22 = this.t0;
            i13 = 60;
            c3 = 1;
            a2 = RLottieNative.a(absolutePath2, str, i142, i152, iArr, false, (int[]) hj0Var22.e, this.Z, hj0Var22.a, this.w);
            if (a2 != null) {
            }
            if (this.Z) {
            }
    ...
    public static void e(ij0 ij0Var) {
        if (ij0Var.j0 || ij0Var.T || !ij0Var.i() || ij0Var.M != null) {
            return;
        }
        ij0Var.w0 = true;
        if (Q0 == null) {
    ...
    public static void f(ij0 ij0Var) {
        Runnable runnable = ij0Var.u0;
        int z4 = ij0Var.z();
        if (z4 == 1) {
            ij0Var.F0 = 0;
            AndroidUtilities.runOnUIThread(ij0Var.v0);
        } else if (z4 == 2) {
    ...
    public static void h(ij0 ij0Var) {
        ij0Var.V = true;
        if ((!ij0Var.i0 && ij0Var.U) || (ij0Var.O == null && ij0Var.P != null)) {
            ij0Var.v();
        }
        ij0Var.n();
    }
    ...
    public final void b() {
        File file;
        hj0 hj0Var = this.t0;
        File file2 = (File) hj0Var.f;
        RLottieNative a2 = RLottieNative.a(file2 != null ? file2.toString() : null, hj0Var.b, this.b, this.c, this.a0 ? this.e : null, false, (int[]) hj0Var.e, false, hj0Var.a, this.w);
        this.G0 = a2;
        this.B0 = 0;
    ...
    /* JADX WARN: Removed duplicated region for block: B:71:0x014f A[Catch: Exception -> 0x0136, TryCatch #3 {Exception -> 0x0136, blocks: (B:46:0x00fc, B:49:0x0105, B:51:0x0109, B:65:0x0141, B:67:0x0145, B:69:0x014b, B:71:0x014f, B:72:0x0156, B:74:0x015b, B:76:0x015f, B:77:0x0189, B:79:0x018d, B:81:0x019b, B:83:0x01a3, B:85:0x01a7, B:87:0x01ab, B:89:0x01ae, B:90:0x01b4, B:92:0x01ba, B:93:0x01c1, B:95:0x01c4, B:96:0x01c9, B:98:0x01cf, B:99:0x01d5, B:103:0x01e1, B:105:0x01e5, B:106:0x01ed, B:107:0x01f2, B:109:0x01f6, B:111:0x01fe, B:112:0x0202, B:114:0x0206, B:116:0x020c, B:118:0x0219, B:119:0x021e, B:121:0x0224, B:122:0x01db, B:124:0x0132, B:127:0x0139), top: B:45:0x00fc }] */
    /* JADX WARN: Removed duplicated region for block: B:74:0x015b A[Catch: Exception -> 0x0136, TryCatch #3 {Exception -> 0x0136, blocks: (B:46:0x00fc, B:49:0x0105, B:51:0x0109, B:65:0x0141, B:67:0x0145, B:69:0x014b, B:71:0x014f, B:72:0x0156, B:74:0x015b, B:76:0x015f, B:77:0x0189, B:79:0x018d, B:81:0x019b, B:83:0x01a3, B:85:0x01a7, B:87:0x01ab, B:89:0x01ae, B:90:0x01b4, B:92:0x01ba, B:93:0x01c1, B:95:0x01c4, B:96:0x01c9, B:98:0x01cf, B:99:0x01d5, B:103:0x01e1, B:105:0x01e5, B:106:0x01ed, B:107:0x01f2, B:109:0x01f6, B:111:0x01fe, B:112:0x0202, B:114:0x0206, B:116:0x020c, B:118:0x0219, B:119:0x021e, B:121:0x0224, B:122:0x01db, B:124:0x0132, B:127:0x0139), top: B:45:0x00fc }] */
    /* JADX WARN: Removed duplicated region for block: B:81:0x019b A[Catch: Exception -> 0x0136, TryCatch #3 {Exception -> 0x0136, blocks: (B:46:0x00fc, B:49:0x0105, B:51:0x0109, B:65:0x0141, B:67:0x0145, B:69:0x014b, B:71:0x014f, B:72:0x0156, B:74:0x015b, B:76:0x015f, B:77:0x0189, B:79:0x018d, B:81:0x019b, B:83:0x01a3, B:85:0x01a7, B:87:0x01ab, B:89:0x01ae, B:90:0x01b4, B:92:0x01ba, B:93:0x01c1, B:95:0x01c4, B:96:0x01c9, B:98:0x01cf, B:99:0x01d5, B:103:0x01e1, B:105:0x01e5, B:106:0x01ed, B:107:0x01f2, B:109:0x01f6, B:111:0x01fe, B:112:0x0202, B:114:0x0206, B:116:0x020c, B:118:0x0219, B:119:0x021e, B:121:0x0224, B:122:0x01db, B:124:0x0132, B:127:0x0139), top: B:45:0x00fc }] */
    /* JADX WARN: Type inference failed for: r8v19, types: [int[], java.io.Serializable] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public int z() {
        ...
        if (i()) {
            if (this.k0 == null && this.d) {
                ...
                if (!TextUtils.isEmpty(readRes)) {
                    hj0 hj0Var = this.t0;
                    this.k0 = RLottieNative.b(readRes, hj0Var.d, this.e, (int[]) hj0Var.e, this.w);
                    this.d = false;
                }
            }
            if (this.Q == null) {
                ...
                if (this.Q != null) {
                    ...
                    if (rLottieNative != null) {
                        try {
                            if (!this.v.isEmpty() || this.r != null) {
                                ...
                                int[] iArr = this.r;
                                if (iArr != null) {
                                    this.t0.e = (int[]) iArr.clone();
                                }
                                hj0 hj0Var2 = this.t0;
                                File file = (File) hj0Var2.f;
                                if (file != null) {
                                    String absolutePath = file.getAbsolutePath();
                                    hj0 hj0Var3 = this.t0;
                                    b10 = RLottieNative.a(absolutePath, hj0Var3.b, this.b, this.c, this.e, false, (int[]) hj0Var3.e, this.Z, hj0Var3.a, this.w);
                                } else {
                                    int i10 = hj0Var2.c;
                                    if (i10 == 0 || hj0Var2.b != null) {
                                        b10 = RLottieNative.b(hj0Var2.b, hj0Var2.d, this.e, (int[]) hj0Var2.e, this.w);
                                    } else {
                                        String readRes2 = AndroidUtilities.readRes(i10);
                                        if (!TextUtils.isEmpty(readRes2)) {
                                            hj0 hj0Var4 = this.t0;
                                            hj0Var4.b = readRes2;
                                            b10 = RLottieNative.b(readRes2, hj0Var4.d, this.e, (int[]) hj0Var4.e, this.w);
                                        }
                                    }
                                }
                                if (b10 != null) {
                    ...
                    try {
                        ...
                        if (gVar != null && gVar.g()) {
                            ...
                            if (this.D0) {
                                if (this.k0 == null) {
                                    String file2 = ((File) this.t0.f).toString();
                                    hj0 hj0Var5 = this.t0;
                                    this.k0 = RLottieNative.a(file2, hj0Var5.b, this.b, this.c, null, false, (int[]) hj0Var5.e, false, hj0Var5.a, this.w);
                                }
                                if (this.k0 != null) {
    ...
    /* JADX WARN: Type inference failed for: r8v8, types: [java.io.Serializable] */
    public ij0(int i10, String str, int i11, int i12, boolean z4, int[] iArr) {
        ...
        this.t0 = hj0Var;
        hj0Var.d = str;
        hj0Var.e = iArr == null ? 0 : (int[]) iArr.clone();
        long[] jArr = ue.a.a;
        ...
        if (j11 != j10) {
            ...
            if (TextUtils.isEmpty(readRes)) {
                ...
                hj0 hj0Var2 = this.t0;
                hj0Var2.b = readRes;
                this.k0 = RLottieNative.b(readRes, str, this.e, (int[]) hj0Var2.e, this.w);
            }
        }
        if (this.D) {
