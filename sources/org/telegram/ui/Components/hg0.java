...
public final class hg0 implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public /* synthetic */ hg0(Object obj, int i10) {
        this.a = i10;
        this.b = obj;
    }
    ...
    public final boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        switch (this.a) {
            case 0:
                lg0 lg0Var = (lg0) this.b;
                lg0Var.G = k7.n.a(scaleGestureDetector.getScaleFactor() * lg0Var.G, 0.75f, lg0Var.a);
                lg0Var.E = (int) (lg0Var.t() * lg0Var.G);
                lg0Var.F = (int) (lg0Var.r() * lg0Var.G);
                AndroidUtilities.runOnUIThread(new cc0(this, 12));
                float dp = scaleGestureDetector.getFocusX() >= ((float) AndroidUtilities.displaySize.x) / 2.0f ? (r2 - lg0Var.E) - AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(16.0f);
                o1.j jVar = lg0Var.J;
                if (jVar.f) {
                    jVar.u.i = dp;
                } else {
    ...
    public final boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
        switch (this.a) {
            case 0:
                ...
                lg0Var.x = true;
                lg0Var.c.width = (int) (lg0Var.t() * lg0Var.a);
                lg0Var.c.height = (int) (lg0Var.r() * lg0Var.a);
                AndroidUtilities.updateViewLayout(lg0Var.b, lg0Var.d, lg0Var.c);
                break;
            case 1:
                org.telegram.ui.Components.voip.g1 g1Var = (org.telegram.ui.Components.voip.g1) this.b;
