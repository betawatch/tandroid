...
public class WebPagePreviewView extends FrameLayout {
    ...
    public void setWebPage(TLRPC.WebPage webPage) {
        ...
        if (z) {
            ...
            backupImageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(6.0f), Theme.multAlpha(Theme.getColor(Theme.key_dialogTextBlack, this.resourcesProvider), 0.08f)));
