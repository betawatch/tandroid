...
public final class t51 extends xl0 {
    ...
    public final void E(View view, int i10, boolean z10) {
        ...
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = u51Var.c;
        int i11 = u51Var.a;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0052, code lost:
        ...
        if ((r11 instanceof org.telegram.ui.Cells.q3) == false) goto L29;
     */
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0054, code lost:
    
        ((org.telegram.ui.Cells.q3) r11).e.a(true, true);
     */
    /* JADX WARN: Code restructure failed: missing block: B:26:0x005f, code lost:
    
        if ((r11 instanceof org.telegram.ui.Cells.t3) == false) goto L32;
     */
    /* JADX WARN: Code restructure failed: missing block: B:27:0x0061, code lost:
    
        ((org.telegram.ui.Cells.t3) r11).b(true, true);
     */
    ...
    */
    public final void F(TLRPC.StickerSetCovered stickerSetCovered, FrameLayout frameLayout) {
        ...
        while (true) {
            ...
            if (stickerSetCoveredArr[i10] != null) {
                TLRPC.TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(u51Var.a).getStickerSetById(stickerSetCoveredArr[i10].set.id);
                if (stickerSetById != null && !stickerSetById.set.archived) {
    ...
    public final void G() {
        ...
        arrayList.clear();
        this.w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(u51Var.a);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        View view = c1Var.a;
        if (i11 == 0) {
            ((org.telegram.ui.Cells.g8) view).d((TLRPC.Document) this.d.get(i10), null, this.f.get(i10), null, false, false);
        } else {
            if (i11 == 1) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        u51 u51Var = this.x;
        org.telegram.ui.ActionBar.f6 f6Var = u51Var.P;
        ...
        if (i10 == 0) {
            ...
            org.telegram.ui.Cells.t3 t3Var = new org.telegram.ui.Cells.t3(17, this.c, u51Var.P, true, true);
            final int i11 = 0;
            t3Var.setAddOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.s51
                ...
                public final void onClick(View view) {
                    switch (i11) {
                        ...
                        default:
                            ...
                            TLRPC.StickerSetCovered stickerSet2 = q3Var.getStickerSet();
                            t51 t51Var2 = this.b;
                            u51 u51Var3 = t51Var2.x;
            ...
            frameLayout = new org.telegram.ui.Cells.w3(context, f6Var);
        } else if (i10 != 5) {
            frameLayout = null;
        } else {
            org.telegram.ui.Cells.q3 q3Var = new org.telegram.ui.Cells.q3(context, f6Var);
            final int i12 = 1;
            q3Var.setAddOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.s51
                public final /* synthetic */ t51 b;
                ...
                public final void onClick(View view) {
                    switch (i12) {
                        ...
                        default:
                            ...
                            TLRPC.StickerSetCovered stickerSet2 = q3Var2.getStickerSet();
                            t51 t51Var2 = this.b;
                            u51 u51Var3 = t51Var2.x;
                            LongSparseArray longSparseArray3 = u51Var3.d;
                            LongSparseArray longSparseArray4 = u51Var3.e;
            ...
            q3Var.getImageView().setLayerNum(3);
            frameLayout = q3Var;
        }
