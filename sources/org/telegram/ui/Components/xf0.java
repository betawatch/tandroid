...
public final class xf0 extends FrameLayout {
    ...
    public xf0(PipRoundVideoView pipRoundVideoView, Activity activity) {
        super(activity);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 2) {
            ...
            if (i14 < 0) {
                ...
                if (i14 > AndroidUtilities.displaySize.x - layoutParams.width) {
                    f10 = org.telegram.messenger.wl.c((i14 - r11) + r10, i11, 0.5f, 1.0f);
                }
            }
        ...
        if (abs > dp) {
            ...
            if (i17 >= 0 || i17 <= (-pipRoundVideoView.h) / 4) {
                if (Math.abs(b11 - i17) > dp) {
                    ...
                    if (i18 <= i19 - i20 || i18 >= i19 - ((i20 / 4) * 3)) {
                        if (pipRoundVideoView.a.getAlpha() != 1.0f) {
                            ...
                            if (z10) {
                                z11 = true;
                                arrayList.add(ObjectAnimator.ofFloat(pipRoundVideoView.a, (Property<xf0, Float>) property, 0.0f));
                                animatorSet.addListener(new zf0(pipRoundVideoView, 1));
                            } else {
                                z11 = true;
                            }
                ...
                edit.putInt("sidex", 1);
                if (pipRoundVideoView.a.getAlpha() != 1.0f) {
                    xf0 xf0Var = pipRoundVideoView.a;
                    float[] fArr = new float[1];
                    fArr[c10] = 1.0f;
                    arrayList.add(ObjectAnimator.ofFloat(xf0Var, (Property<xf0, Float>) property, fArr));
                }
        ...
        if (pipRoundVideoView.a.getAlpha() != f7) {
            arrayList2.add(ObjectAnimator.ofFloat(pipRoundVideoView.a, (Property<xf0, Float>) property, f7));
        }
