...
public final class jg0 extends FrameLayout {
        ...
        switch (i10) {
            ...
            case 3:
                ...
                if (!this.b && z51Var.r > 0.0f) {
                    ...
                    super.dispatchDraw(canvas);
                    ((Paint) this.c).setAlpha((int) (z51Var.r * 255.0f));
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.a) {
            case 4:
                ...
                canvas.drawRect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), ((org.telegram.ui.v5) ((org.telegram.ui.y0) limitPreviewView.e0).b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                canvas.restore();
                invalidate();
                return drawChild;
            default:
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 0:
                ...
                int i21 = qg0Var.E;
                i10 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingTop;
                int i22 = (i21 - i10) - dp;
                i11 = ((org.telegram.ui.ActionBar.g3) qg0Var).currentSheetAnimationType;
                if (i11 == 1) {
                    i22 = (int) (qg0Var.b.getTranslationY() + i22);
                }
                ...
                int i23 = i12 + dp3;
                i13 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingTop;
                if (i13 + i22 < org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) {
                    ...
                    i20 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingTop;
                ...
                if (f7 != 1.0f) {
                    ...
                    i16 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingLeft;
                    i17 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingTop;
                    int measuredWidth = getMeasuredWidth();
                    i18 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingLeft;
                    float f10 = measuredWidth - i18;
                    i19 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingTop;
                ...
                org.telegram.ui.ActionBar.j6.t0.setColor(Color.argb((int) (qg0Var.f.getAlpha() * 255.0f), Color.red(w03), Color.green(w03), Color.blue(w03)));
                i14 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingLeft;
                float f11 = i14;
                int measuredWidth2 = getMeasuredWidth();
                i15 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingLeft;
        ...
        switch (this.a) {
            case 0:
                ...
                if (motionEvent.getAction() == 0 && qg0Var.E != 0) {
                    if (motionEvent.getY() < AndroidUtilities.dp(12.0f) + qg0Var.E && qg0Var.f.getAlpha() == 0.0f) {
                        qg0Var.dismiss();
                        return true;
                    }
                }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            case 0:
                ...
                mg0 mg0Var = qg0Var.c;
                kg0 kg0Var = qg0Var.b;
                z10 = ((org.telegram.ui.ActionBar.g3) qg0Var).isFullscreen;
                if (!z10) {
                    this.b = true;
                    i14 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingLeft;
                ...
                for (int i17 = 0; i17 < R; i17++) {
                    if (i17 == 0) {
                        i13 = ((org.telegram.ui.ActionBar.g3) qg0Var).backgroundPaddingLeft;
                        w5Var.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10 - (i13 * 2)), TLObject.FLAG_30), i11);
                        M = w5Var.getMeasuredHeight();
                    } else {
                        M = ((mg0Var.M(i17) - 1) * AndroidUtilities.dp(50.0f)) + AndroidUtilities.dp(32.0f);
                    }
                    dp = M + dp;
                }
                int dp2 = AndroidUtilities.dp(8.0f) + (dp < paddingTop ? paddingTop - dp : paddingTop - ((paddingTop / 5) * 3));
                if (kg0Var.getPaddingTop() != dp2) {
                    this.b = true;
                    kg0Var.setPinnedSectionOffsetY(-dp2);
                    kg0Var.setPadding(0, dp2, 0, AndroidUtilities.navigationBarHeight);
                    this.b = false;
                }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.a) {
            case 0:
                return !((qg0) this.d).isDismissed() && super.onTouchEvent(motionEvent);
            default:
