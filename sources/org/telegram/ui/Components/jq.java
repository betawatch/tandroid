...
public final class jq {
    ...
    public final void a(Canvas canvas) {
        ...
        int i14 = this.s;
        int i15 = this.r;
        float z11 = i14 == i15 ? i14 : com.google.android.recaptcha.internal.a.z(1.0f, f15, i15, i14 * f15);
        e(z11);
        if (this.j) {
            float f18 = this.l;
            f10 = ((f18 <= 0.5f ? er.g.getInterpolation(f18 * 2.0f) : er.i.getInterpolation(1.0f - ((f18 - 0.5f) * 2.0f))) * 0.1f) + 1.0f;
        } else {
            f10 = 1.0f;
        }
        float f19 = this.B;
        RectF rectF = this.f;
        rectF.set(f19, dp, z11 + f19 + AndroidUtilities.dp(f16 - 0.5f), AndroidUtilities.dp(f17) + dp);
        canvas.save();
        ...
        if (this.F && (paint = this.d) != null) {
            ...
            if (this.g && org.telegram.ui.ActionBar.g6.a1()) {
                ...
                canvas.drawRoundRect(rectF, f22, f22, org.telegram.ui.ActionBar.g6.h2);
            }
        }
        if (z10) {
            canvas.restore();
        ...
        if (this.q != null) {
            ...
            canvas.translate(f23, com.google.android.recaptcha.internal.a.z(1.0f, f15, dp3, dp2));
            ...
            canvas.translate(f24, com.google.android.recaptcha.internal.a.z(1.0f, f15, dp5, dp4));
            this.e.setAlpha((int) (f15 * 255.0f));
            this.n.draw(canvas);
            canvas.restore();
        }
        if (this.o != null) {
            canvas.save();
            canvas.translate(this.A, ((z12 ? -AndroidUtilities.dp(13.0f) : AndroidUtilities.dp(13.0f)) * f15) + AndroidUtilities.dp(4.0f) + dp);
    ...
    public final void b(Canvas canvas) {
        ...
        if (this.d != null && this.F) {
            ...
            if (this.g && org.telegram.ui.ActionBar.g6.a1()) {
                ...
                canvas.drawRoundRect(rectF, f15, f15, org.telegram.ui.ActionBar.g6.h2);
            }
            if (z10) {
                canvas.restore();
            }
    ...
    public final void c(int i10, boolean z10) {
        ...
        if (z12) {
            ...
            this.k.addListener(new org.telegram.ui.am(this, 23));
            if (this.h <= 0) {
                this.c = 0;
