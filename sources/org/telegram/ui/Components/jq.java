...
public class jq extends FrameLayout {
    ...
    public jq(Context context, boolean z4, iq iqVar) {
        ...
        while (i14 < 4) {
            ...
            this.v[i14].setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.eq
                        ...
                        case 0:
                            ...
                            if (jqVar.y == null) {
                                ...
                                if (i17 == 1) {
                                    ...
                                    if (jqVar.h) {
                                        iqVar2.r0(colorPicker$RadioButtonArr[i15].e, i15, true);
                                    }
                                ...
                                if (jqVar.H < jqVar.I) {
                                    ...
                                    arrayList.add(ObjectAnimator.ofFloat(imageView, (Property<ImageView, Float>) property, e2.c.e(jqVar.H, 1, AndroidUtilities.dp(13.0f), (jqVar.H - 1) * AndroidUtilities.dp(30.0f))));
                                } else {
                                    arrayList.add(ObjectAnimator.ofFloat(imageView, (Property<ImageView, Float>) property, e2.c.e(jqVar.H, 1, AndroidUtilities.dp(13.0f), (jqVar.H - 1) * AndroidUtilities.dp(30.0f))));
                                ...
                                jqVar.y = new AnimatorSet();
                                jqVar.g(jqVar.getMeasuredWidth(), arrayList, false);
                                jqVar.y.playTogether(arrayList);
                                jqVar.y.setDuration(180L);
                                jqVar.y.setInterpolator(mr.g);
                                jqVar.y.addListener(new a9(jqVar, 13));
                                jqVar.y.start();
                                break;
                            }
                            break;
                        case 1:
                            ...
                            if (jqVar.y == null) {
                                ...
                                while (i22 < colorPicker$RadioButtonArr2.length) {
                                    if (i22 < jqVar.H) {
                                        iqVar3.r0(colorPicker$RadioButtonArr2[i22].e, i22, i22 == colorPicker$RadioButtonArr2.length - 1);
                                    } else {
                                        iqVar3.r0(0, i22, i22 == colorPicker$RadioButtonArr2.length - 1);
                                    }
                                    i22++;
                                }
                                jqVar.y = new AnimatorSet();
                                jqVar.g(jqVar.getMeasuredWidth(), arrayList2, true);
                                jqVar.y.playTogether(arrayList2);
                                jqVar.y.setDuration(180L);
                                jqVar.y.setInterpolator(mr.g);
                                jqVar.y.addListener(new hq(jqVar));
                                jqVar.y.start();
                                break;
                            }
                            break;
        ...
        while (true) {
            ...
            if (i15 % 2 == 0) {
                editTextBoldCursorArr[i15] = new fq(this, context, i15, i13);
                ...
                editTextBoldCursorArr[i15] = new fq(this, context, i15, i10);
                this.B[i15].setBackgroundDrawable(null);
                ...
                this.B[i15].addTextChangedListener(new gq(this, i15));
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.eq
            public final /* synthetic */ jq b;
                    ...
                    case 0:
                        ...
                        if (jqVar.y == null) {
                            ...
                            if (i172 == 1) {
                                ...
                                if (jqVar.h) {
                                    iqVar2.r0(colorPicker$RadioButtonArr[i152].e, i152, true);
                                }
                                iqVar2.r0(colorPicker$RadioButtonArr[1].e, 1, true);
                                jqVar.H = 2;
                            } else if (i172 == 2) {
                            ...
                            if (jqVar.H < jqVar.I) {
                                ...
                                arrayList.add(ObjectAnimator.ofFloat(imageView2, (Property<ImageView, Float>) property, e2.c.e(jqVar.H, 1, AndroidUtilities.dp(13.0f), (jqVar.H - 1) * AndroidUtilities.dp(30.0f))));
                            } else {
                                arrayList.add(ObjectAnimator.ofFloat(imageView2, (Property<ImageView, Float>) property, e2.c.e(jqVar.H, 1, AndroidUtilities.dp(13.0f), (jqVar.H - 1) * AndroidUtilities.dp(30.0f))));
        ...
        l0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.eq
            public final /* synthetic */ jq b;
        ...
        if (z4) {
            ...
            w0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.eq
                public final /* synthetic */ jq b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!this.N) {
            ...
            float interpolation = mr.g.getInterpolation(this.R);
