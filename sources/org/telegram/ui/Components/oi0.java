...
public final class oi0 extends Path {
    ...
    public oi0(final org.telegram.ui.Cells.t1 t1Var, int i10, int i11) {
        ...
        this.a = t1Var;
        final int i12 = 0;
        this.k = new c6(0.0f, new Runnable() { // from class: org.telegram.ui.Components.mi0
    ...
    public final void b(Canvas canvas, float f7, float f10, Rect rect, float f11) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                uqVar.addRect(AndroidUtilities.lerp(rect.left - f7, ni0Var.a, d), AndroidUtilities.lerp(ni0Var.e ? rect.top - f10 : ni0Var.g, ni0Var.c, d), AndroidUtilities.lerp(rect.right - f7, ni0Var.b, d), AndroidUtilities.lerp(ni0Var.f ? rect.bottom - f10 : ni0Var.h, ni0Var.d, d), Path.Direction.CW);
                i10++;
            }
            uqVar.a();
        }
    ...
    public oi0(org.telegram.ui.Cells.t1 t1Var, ViewParent viewParent, int i10, ArrayList arrayList, int i11, int i12, float f7) {
        ...
        this.m = new ArrayList();
        this.a = null;
        this.k = new c6(0.0f, new ny(21, t1Var, viewParent), 350L, 420L, qr.h);
        this.b = i10;
        this.c = i14;
        this.d = i12;
        int i15 = 0;
        ...
        if (this.l.size() > 0) {
            ...
            ni0 ni0Var2 = (ni0) hg.k0.h(1, this.l);
            ni0Var.e = true;
