...
public class oi0 extends BitmapDrawable implements Animatable, gf.f {
    ...
    static {
        final int i10 = 0;
        N0 = Executors.newFixedThreadPool(4, new ThreadFactory() { // from class: org.telegram.ui.Components.mi0
        ...
        final int i11 = 1;
        O0 = Executors.newFixedThreadPool(2, new ThreadFactory() { // from class: org.telegram.ui.Components.mi0
            @Override // java.util.concurrent.ThreadFactory
            public final Thread newThread(Runnable runnable) {
                switch (i11) {
                    case 0:
    ...
    */
    public oi0(File file, String str, int i10, int i11, ge.i iVar, boolean z10, int i12, boolean z11) {
        int i13;
        char c10;
        RLottieNative a2;
        ...
        this.f0 = new RectF[2];
        this.g0 = new Paint[2];
        this.t0 = new li0(this, 1);
        this.u0 = new li0(this, 2);
        this.w0 = new li0(this, 3);
        this.x0 = new li0(this, 4);
        ...
        if (!z12) {
            this.j0 = RLottieNative.a(file.getAbsolutePath(), str, i10, i11, iArr, z12, ni0Var.a, z10, i12, hashMap);
            if (this.j0 == null) {
        ...
        try {
            try {
                ...
                i13 = 60;
                c10 = 1;
                a2 = RLottieNative.a(absolutePath, str, i14, i15, iArr, false, ni0Var2.a, this.Y, ni0Var2.b, this.w);
                if (a2 != null) {
                    a2.d();
                }
                if (this.Y) {
                ...
                this.z0 = new gf.h(file, this, iVar, i10, i11, !z10, i12);
            }
        } catch (Exception e10) {
            e = e10;
            FileLog.e((Throwable) e, false);
            ...
            int i142 = this.b;
            int i152 = this.c;
            ni0 ni0Var22 = this.s0;
            i13 = 60;
            c10 = 1;
            a2 = RLottieNative.a(absolutePath2, str, i142, i152, iArr, false, ni0Var22.a, this.Y, ni0Var22.b, this.w);
            if (a2 != null) {
            }
            if (this.Y) {
            }
    ...
    public static void e(oi0 oi0Var) {
        if (oi0Var.i0 || oi0Var.S || !oi0Var.i() || oi0Var.L != null) {
            return;
        }
        oi0Var.v0 = true;
        if (P0 == null) {
    ...
    public static void f(oi0 oi0Var) {
        Runnable runnable = oi0Var.t0;
        int z10 = oi0Var.z();
        if (z10 == 1) {
            oi0Var.E0 = 0;
            AndroidUtilities.runOnUIThread(oi0Var.u0);
        } else if (z10 == 2) {
    ...
    public static void h(oi0 oi0Var) {
        oi0Var.U = true;
        if ((!oi0Var.h0 && oi0Var.T) || (oi0Var.N == null && oi0Var.O != null)) {
            oi0Var.v();
        }
        oi0Var.n();
    }
    ...
    public final void b() {
        ...
        ni0 ni0Var = this.s0;
        File file2 = ni0Var.d;
        RLottieNative a2 = RLottieNative.a(file2 != null ? file2.toString() : null, ni0Var.e, this.b, this.c, this.Z ? this.e : null, false, ni0Var.a, false, ni0Var.b, this.w);
        this.F0 = a2;
        this.A0 = 0;
    ...
    */
        ...
        if (i()) {
            if (this.j0 == null && this.d) {
                ...
                if (!TextUtils.isEmpty(readRes)) {
                    ni0 ni0Var = this.s0;
                    this.j0 = RLottieNative.b(readRes, ni0Var.f, this.e, ni0Var.a, this.w);
                    this.d = false;
                }
            }
            if (this.P == null) {
                        ...
                        if (rLottieNative != null) {
                            if (!this.v.isEmpty() || this.r != null) {
                                ...
                                if (file != null) {
                                    ...
                                    ni0 ni0Var3 = this.s0;
                                    i10 = 2;
                                    b10 = RLottieNative.a(absolutePath, ni0Var3.e, this.b, this.c, this.e, false, ni0Var3.a, this.Y, ni0Var3.b, this.w);
                                } else {
                                    i10 = 2;
                                    int i11 = ni0Var2.c;
                                    if (i11 == 0 || ni0Var2.e != null) {
                                        b10 = RLottieNative.b(ni0Var2.e, ni0Var2.f, this.e, ni0Var2.a, this.w);
                                    } else {
                                        ...
                                        if (TextUtils.isEmpty(readRes2)) {
                                            ...
                                            if (hVar != null && hVar.g()) {
                                                ...
                                                if (this.C0) {
                                                    if (this.j0 == null) {
                                                        ...
                                                        ni0 ni0Var4 = this.s0;
                                                        this.j0 = RLottieNative.a(file2, ni0Var4.e, this.b, this.c, null, false, ni0Var4.a, false, ni0Var4.b, this.w);
                                                    }
                                                    if (this.j0 != null) {
                                            ...
                                            ni0 ni0Var5 = this.s0;
                                            ni0Var5.e = readRes2;
                                            b10 = RLottieNative.b(readRes2, ni0Var5.f, this.e, ni0Var5.a, this.w);
                                        }
                                    }
                                }
                                if (b10 != null) {
    ...
    public oi0(int i10, String str, int i11, int i12, boolean z10, int[] iArr) {
        ...
        this.s0 = ni0Var;
        ni0Var.f = str;
        ni0Var.a = iArr == null ? null : (int[]) iArr.clone();
        long[] jArr = qe.b.a;
        ...
        if (j11 != j10) {
            ...
            if (TextUtils.isEmpty(readRes)) {
                ...
                ni0 ni0Var2 = this.s0;
                ni0Var2.e = readRes;
                this.j0 = RLottieNative.b(readRes, str, this.e, ni0Var2.a, this.w);
            }
        }
        if (this.C) {
