...
public final class oi0 extends FrameLayout {
    ...
    */
    public final void c(boolean z10) {
        ...
        int i10 = (int) value;
        org.telegram.ui.kd0 kd0Var = this.I.b;
        ...
        if (iCircle != null) {
            ...
            if (z10) {
                ...
                onCreateLatLngBoundsBuilder.include(new IMapsProvider.LatLng(kd0Var.w0.getLatitude(), kd0Var.w0.getLongitude()));
                try {
                    ...
                    double d = max;
                    IMapsProvider.LatLng p02 = org.telegram.ui.kd0.p0(center, d, d);
                    double d10 = -max;
                    onCreateLatLngBoundsBuilder.include(org.telegram.ui.kd0.p0(center, d10, d10));
                    onCreateLatLngBoundsBuilder.include(p02);
                    IMapsProvider.ILatLngBounds build = onCreateLatLngBoundsBuilder.build();
                    try {
                        kd0Var.I.setPadding(AndroidUtilities.dp(70.0f), 0, AndroidUtilities.dp(70.0f), (int) ((kd0Var.R.getCustomView().getMeasuredHeight() - AndroidUtilities.dp(40.0f)) + kd0Var.S.getTranslationY()));
                        kd0Var.I.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngBounds(build, 0), 500, null);
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
        ...
        if (!DialogObject.isChatDialog(kd0Var.e0)) {
            int size = arrayList.size();
            for (int i11 = 0; i11 < size; i11++) {
                org.telegram.ui.ed0 ed0Var = (org.telegram.ui.ed0) arrayList.get(i11);
                if (ed0Var.b != null && !UserObject.isUserSelf(ed0Var.c)) {
                    TLRPC.GeoPoint geoPoint = ed0Var.b.media.geo;
                    Location location = new Location("network");
                    location.setLatitude(geoPoint.lat);
                    location.setLongitude(geoPoint._long);
                    if (kd0Var.w0.distanceTo(location) > i10) {
                    }
                }
            }
            z11 = false;
