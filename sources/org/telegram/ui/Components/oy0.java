...
public abstract class oy0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final long a() {
        ...
        for (int i10 = 0; i10 < this.b.length; i10++) {
            ...
            ny0 ny0Var = this.b[i10];
            if (ny0Var != null && (ny0Var.c || f7 > 0)) {
                if (f7 <= 0) {
                    f7 = ny0Var.e;
                }
                j3 += f7;
    ...
    public final void c(boolean z10) {
        boolean z11;
        ny0[] ny0VarArr = this.b;
        if (ny0VarArr == null) {
            return;
        }
        long j3 = 0;
        for (int i10 = 0; i10 < ny0VarArr.length; i10++) {
            long f7 = this.F.f(i10);
        ...
        float f10 = 0.0f;
        float f11 = 0.0f;
        for (int i11 = 0; i11 < ny0VarArr.length; i11++) {
            long f12 = this.F.f(i11);
            ny0 ny0Var2 = ny0VarArr[i11];
            if (ny0Var2 != null && (ny0Var2.c || f12 > 0)) {
                this.y++;
            }
            if (ny0Var2 == null || (!(z11 = ny0Var2.c) && f12 <= 0)) {
                this.d[i11] = 0.0f;
            } else {
                if (f12 <= 0) {
                    f12 = ny0Var2.e;
        ...
        if (f10 > 1.0f) {
            float f14 = 1.0f / f10;
            for (int i12 = 0; i12 < ny0VarArr.length; i12++) {
                if (ny0VarArr[i12] != null) {
                    float[] fArr = this.d;
        ...
        if (!z10) {
            System.arraycopy(this.d, 0, this.c, 0, ny0VarArr.length);
            return;
        }
        System.arraycopy(this.c, 0, this.e, 0, ny0VarArr.length);
        ...
        this.E = ofFloat;
        ofFloat.addUpdateListener(new ai.x(16, this, ny0VarArr));
        this.E.addListener(new dd0(ny0VarArr, 19));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            i10 = 255;
            f7 = 10.0f;
            if (i12 >= ny0VarArr.length) {
                break;
            }
            ny0 ny0Var = ny0VarArr[i12];
            if (ny0Var != null) {
                ...
                if (f18 != 0.0f) {
                    if (ny0Var.d) {
                        ...
                        ny0Var.b.setColor(org.telegram.ui.ActionBar.j6.w0(null, ny0Var.a, z11));
        ...
        float f19 = 0.0f;
        while (true) {
            ny0[] ny0VarArr2 = this.b;
            if (i13 >= ny0VarArr2.length) {
                break;
            }
            ny0 ny0Var2 = ny0VarArr2[i13];
            if (ny0Var2 != null) {
                ...
                if (f20 != 0.0f) {
                    if (ny0Var2.d) {
                        ...
                        ny0Var2.b.setColor(org.telegram.ui.ActionBar.j6.w0(null, ny0Var2.a, false));
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z10 && motionEvent.getAction() != 3) {
                AndroidUtilities.runOnUIThread(new wq0(this, 10), 80L);
            }
            setPressed(false);
            return true;
        }
    ...
    public void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            if (f7 != 0.0f) {
                ...
                this.H = ofFloat;
                ofFloat.addUpdateListener(new p70(this, 25));
                this.H.addListener(new dd0(this, 20));
