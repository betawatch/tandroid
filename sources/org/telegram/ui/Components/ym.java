...
public final class ym implements org.telegram.ui.nt {
    ...
    public final o70 d(ah.d dVar) {
        o70 F = o70.F(dVar, null, new View(this.b.getContext()));
        F.s = 0;
        F.t = false;
        ...
        F.c(i10, string, new Runnable(this) { // from class: org.telegram.ui.Components.xm
        ...
        final int i13 = 1;
        F.c(R.drawable.msg_delete, LocaleController.getString(R.string.Delete), new Runnable(this) { // from class: org.telegram.ui.Components.xm
            public final /* synthetic */ ym b;
