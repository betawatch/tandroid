...
public final class k4 extends il0 {
    public final /* synthetic */ gh.w d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k4(Context context, int i10, jh.b bVar, gh.w wVar) {
        ...
        scrollView.addView(frameLayout, h7.z5.x(-1, -2, 51));
        ri0 ri0Var = new ri0(context);
        ri0Var.f(R.raw.report_police, 120, 120, null);
        ri0Var.d();
        frameLayout.addView(ri0Var, h7.z5.d(160, 160.0f, 49, 17.0f, 14.0f, 17.0f, 0.0f));
        ...
        TextView h = org.telegram.ui.Cells.pa.h(frameLayout, textView, h7.z5.d(-2, -2.0f, 49, 17.0f, 197.0f, 17.0f, 0.0f), context);
        ...
        frameLayout.addView(h, h7.z5.d(-2, -2.0f, 49, 30.0f, 235.0f, 30.0f, 44.0f));
        ...
        frameLayout.addView(editTextBoldCursor, h7.z5.d(-1, 36.0f, 51, 17.0f, 305.0f, 17.0f, 0.0f));
        ...
        hl0Var.addView(view, h7.z5.d(-1, -1.0f, 0, 16.0f, 16.0f, 16.0f, 16.0f));
        ...
        textView2.setTextColor(bVar.N0(org.telegram.ui.ActionBar.g6.Sh));
        textView2.setTextSize(1, 14.0f);
        textView2.setTypeface(AndroidUtilities.bold());
        hl0Var.addView(textView2, h7.z5.e(-2, -2, 17));
        this.b = hl0Var;
        hl0Var.setBackground(null);
        hl0Var.setText(LocaleController.getString(R.string.ReportSend));
        h7.b6.a(hl0Var);
        view.setOnClickListener(new hh.z0(this, i10, 11));
        frameLayout.addView(hl0Var, h7.z5.d(-1, 50.0f, 51, 0.0f, 357.0f, 0.0f, 0.0f));
