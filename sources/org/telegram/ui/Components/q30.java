...
public final class q30 extends FrameLayout {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        v30 v30Var = this.a;
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) v30Var.c.getLayoutParams();
        if (z10) {
        ...
        v30Var.b.setPadding(y3, 0, y3, 0);
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(370.0f), TLObject.FLAG_30));
        measureChildWithMargins(v30Var.d, View.MeasureSpec.makeMeasureSpec(0, 0), 0, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f), TLObject.FLAG_30), 0);
    }
}
