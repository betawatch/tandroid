...
public final class kc0 extends Drawable {
        ...
        if (i12 < 0) {
            ...
            if (e != null) {
                ...
                if (z12) {
                    ...
                    pc0 pc0Var = this.Q;
                    RectF rectF2 = pc0Var.j;
                    rectF2.set(0.0f, 0.0f, pc0Var.g, pc0Var.h);
                    Matrix matrix = pc0Var.i;
    ...
    public kc0(boolean z10, int i10, int i11, int i12, int i13) {
        this(i10, i11, i12, i13, z10, 0, false);
    }

    public kc0(int i10, int i11, int i12, int i13, boolean z10, int i14, boolean z11) {
        this.a = new int[]{-12423849, -531317, -7888252, -133430};
        this.e = new qr(0.33d, 0.0d, 0.0d, 1.0d);
        this.h = 1.0f;
        this.j = new RectF();
