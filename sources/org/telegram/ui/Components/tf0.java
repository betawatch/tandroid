    ...
    public final void draw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f10 < 1.0f) {
                ...
                float interpolation = f12 >= 100.0f ? er.j.getInterpolation(f12 / 100.0f) * (-5.0f) : f12 < 484.0f ? (er.j.getInterpolation((f12 - 100.0f) / 384.0f) * 95.0f) - 5.0f : 90.0f;
                int i11 = this.b;
                canvas2.scale((i11 * 1.45f) / AndroidUtilities.dp(28.0f), (i11 * 1.5f) / AndroidUtilities.dp(28.0f));
                canvas2.rotate(interpolation);
                kd0Var = org.telegram.ui.ActionBar.g6.x3;
                if (kd0Var != null) {
                    Paint paint = this.a;
                    kd0Var.b(canvas2, paint, f12);
                    canvas2.scale(1.0f, -1.0f);
                    org.telegram.ui.ActionBar.g6.x3.b(canvas2, paint, f12);
                }
                canvas2.restore();
            }
        }
