...
public final class tf0 extends FrameLayout implements zz, ci.hc {
    ...
    */
    public tf0(Context context, i71 i71Var, Bitmap bitmap, Bitmap bitmap2, int i10, MediaController.SavedFilterState savedFilterState, qd0 qd0Var, int i11, boolean z10, boolean z11, ja jaVar, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        ...
        if (i71Var != null) {
            this.i0 = i71Var;
            i71Var.setDelegate(new lf0(this));
        } else {
            this.j0 = true;
            nf0 nf0Var = new nf0(this, context);
            this.i0 = nf0Var;
            if (z11) {
                addView(nf0Var, w7.y5.e(-1, -1, 51));
            }
            nf0Var.setVisibility(4);
            nf0Var.setSurfaceTextureListener(new of0(this, z11, jaVar));
        }
        if0 if0Var = new if0(context);
        if0Var.a = new PointF();
        if0Var.d = new uv0();
        if0Var.e = new PointF(0.5f, 0.5f);
        if0Var.f = 0.15f;
        if0Var.h = 0.35f;
        if0Var.r = new RectF();
        if0Var.x = 1.0f;
        ...
        if (z11) {
            addView(if0Var, w7.y5.e(-1, -1, 51));
        }
        if0Var.setDelegate(new lf0(this));
        pf0 pf0Var = this.W;
        ...
        this.p0 = kf0Var;
        kf0Var.setDelegate(new lf0(this));
        ...
        final int i17 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mf0
            ...
            public final void onClick(View view) {
                switch (i17) {
                    case 0:
                        tf0 tf0Var = this.b;
                        tf0Var.y0 = 0;
                        tf0Var.z0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.zf, tf0Var.I0), PorterDuff.Mode.MULTIPLY));
                        tf0Var.A0.setColorFilter((ColorFilter) null);
                        tf0Var.B0.setColorFilter((ColorFilter) null);
                        tf0Var.f();
                        break;
                    case 1:
                        tf0 tf0Var2 = this.b;
                        tf0Var2.y0 = 1;
                        tf0Var2.z0.setColorFilter((ColorFilter) null);
                        tf0Var2.A0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.zf, tf0Var2.I0), PorterDuff.Mode.MULTIPLY));
                        tf0Var2.B0.setColorFilter((ColorFilter) null);
                        tf0Var2.f();
                        break;
                    case 2:
                        tf0 tf0Var3 = this.b;
                        tf0Var3.y0 = 2;
                        tf0Var3.z0.setColorFilter((ColorFilter) null);
                        tf0Var3.A0.setColorFilter((ColorFilter) null);
                        tf0Var3.B0.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.zf, tf0Var3.I0), PorterDuff.Mode.MULTIPLY));
                        tf0Var3.f();
                        break;
                    case 3:
                        tf0 tf0Var4 = this.b;
                        ...
                        tf0Var4.W.f = intValue;
                        int i18 = 0;
                        while (i18 < 4) {
                            tf0Var4.u0[i18].a(i18 == intValue, true);
                            i18++;
                        }
                        tf0Var4.p0.invalidate();
                        break;
                    case 4:
                        tf0 tf0Var5 = this.b;
                        tf0Var5.T = 0;
                        tf0Var5.h();
                        tf0Var5.o0.setVisibility(4);
                        wz wzVar = tf0Var5.l0;
                        if (wzVar != null) {
                    ...
                    case 5:
                        ...
                        tf0Var6.T = 1;
                        tf0Var6.h();
                        if0 if0Var2 = tf0Var6.o0;
                        if0Var2.setVisibility(0);
                        if0Var2.setType(1);
                        wz wzVar2 = tf0Var6.l0;
                        if (wzVar2 != null) {
                    ...
                    default:
                        ...
                        tf0Var7.T = 2;
                        tf0Var7.h();
                        if0 if0Var3 = tf0Var7.o0;
                        if0Var3.setVisibility(0);
                        if0Var3.setType(0);
                        wz wzVar3 = tf0Var7.l0;
                        if (wzVar3 != null) {
        ...
        final int i18 = 1;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mf0
            public final /* synthetic */ tf0 b;
            ...
            public final void onClick(View view) {
                switch (i18) {
                    ...
                    case 3:
                        ...
                        int i182 = 0;
                        while (i182 < 4) {
                            tf0Var4.u0[i182].a(i182 == intValue, true);
                            i182++;
                        }
                        tf0Var4.p0.invalidate();
                        break;
        ...
        final int i19 = 2;
        imageView3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mf0
            public final /* synthetic */ tf0 b;
        ...
        zhVar.setAdapter(new sf0(this, context));
        ...
        while (i20 < 4) {
            ...
            if (i20 == 0) {
                ...
                final int i21 = 3;
                frameLayout4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mf0
                    public final /* synthetic */ tf0 b;
        ...
        final int i22 = 4;
        textView3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mf0
            public final /* synthetic */ tf0 b;
        ...
        final int i23 = 5;
        textView4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mf0
            public final /* synthetic */ tf0 b;
        ...
        final int i24 = 6;
        textView5.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.mf0
            public final /* synthetic */ tf0 b;
    ...
    public final boolean d() {
        ...
        pf0 pf0Var = this.W;
        return savedFilterState != null ? (this.G == savedFilterState.enhanceValue && this.I == savedFilterState.contrastValue && this.P == savedFilterState.highlightsValue && this.H == savedFilterState.exposureValue && this.J == savedFilterState.warmthValue && this.K == savedFilterState.saturationValue && this.R == savedFilterState.vignetteValue && this.Q == savedFilterState.shadowsValue && this.S == savedFilterState.grainValue && this.U == savedFilterState.sharpenValue && this.L == savedFilterState.fadeValue && this.M == savedFilterState.softenSkinValue && this.O == savedFilterState.tintHighlightsColor && this.N == savedFilterState.tintShadowsColor && pf0Var.b()) ? false : true : (this.G == 0.0f && this.I == 0.0f && this.P == 0.0f && this.H == 0.0f && this.J == 0.0f && this.K == 0.0f && this.R == 0.0f && this.Q == 0.0f && this.S == 0.0f && this.U == 0.0f && this.L == 0.0f && this.M == 0.0f && this.O == 0 && this.N == 0 && pf0Var.b()) ? false : true;
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        qd0 qd0Var = this.v0;
        if (qd0Var != null && view == (textureView = this.i0)) {
            canvas.save();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.k0) {
            ...
            uv0Var.a = f14;
            uv0Var.b = f15;
            ((FrameLayout.LayoutParams) if0Var.getLayoutParams()).height = AndroidUtilities.dp(38.0f) + i12;
            ((FrameLayout.LayoutParams) kf0Var.getLayoutParams()).height = AndroidUtilities.dp(28.0f) + i12;
