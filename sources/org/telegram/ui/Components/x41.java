...
public final /* synthetic */ class x41 implements Runnable {
    ...
    public /* synthetic */ x41(org.telegram.ui.bl blVar, boolean[] zArr, String str, LinearLayout linearLayout, ArrayList arrayList, String str2, TranslateController translateController, org.telegram.ui.ActionBar.p1 p1Var, ArrayList arrayList2) {
        this.d = blVar;
        this.e = zArr;
        this.f = str;
        this.n = linearLayout;
                ...
                if (!zArr[0]) {
                    ...
                    while (i10 < size) {
                        ...
                        if (TextUtils.equals(str3, str2)) {
                            ...
                            if (z10) {
                                ...
                                g1Var = g1Var3;
                                final int i12 = 0;
                                g1Var.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.v41
                                    @Override // android.view.View.OnClickListener
                                    public final void onClick(View view) {
                                        switch (i12) {
                                            case 0:
                                                org.telegram.ui.bl blVar2 = blVar;
                                                translateController.setDialogTranslateTo(blVar2.b, str3);
                                                p1Var.d(true);
                                                blVar2.b();
                                                break;
                                            default:
                                                org.telegram.ui.bl blVar3 = blVar;
                                                translateController.setDialogTranslateTo(blVar3.b, str3);
                                                p1Var.d(true);
                                                blVar3.b();
                                                break;
                                        }
                    ...
                    while (i13 < size2) {
                        ...
                        if (!TextUtils.equals(str4, str2)) {
                            ...
                            if (!z11) {
                                final int i15 = 1;
                                g1Var4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.v41
                                    @Override // android.view.View.OnClickListener
                                    public final void onClick(View view) {
                                        switch (i15) {
                                            case 0:
                                                org.telegram.ui.bl blVar2 = blVar;
                                                translateController.setDialogTranslateTo(blVar2.b, str4);
                                                p1Var.d(true);
                                                blVar2.b();
                                                break;
                                            default:
                                                org.telegram.ui.bl blVar3 = blVar;
                                                translateController.setDialogTranslateTo(blVar3.b, str4);
                                                p1Var.d(true);
                                                blVar3.b();
                                                break;
                                        }
