...
public final class fz0 extends FrameLayout {
    ...
    public final ij0 a(int i10) {
        ij0[] ij0VarArr = this.r;
        if (ij0VarArr[i10] == null) {
            ij0VarArr[i10] = new ij0(i10 != 1 ? i10 != 2 ? i10 != 3 ? i10 != 4 ? i10 != 5 ? R.raw.swipe_pin : R.raw.swipe_disabled : R.raw.swipe_delete : R.raw.swipe_mute : R.raw.chats_archive : R.raw.swipe_read, AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), true, null);
            c(i10);
        }
    ...
    public final void b() {
        ...
        if (this.G == null && this.F != (value = this.f.getValue())) {
            ...
            AndroidUtilities.updateViewVisibilityAnimated(lj0VarArr[this.s], false, 0.5f, true);
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f11 != 1.0f) {
                ...
                if (f12 > 1.0f) {
                    ...
                    lj0VarArr[0].invalidate();
                    lj0VarArr[1].invalidate();
                    invalidate();
                }
                ...
                int z11 = org.telegram.messenger.wh.z(16.0f, AndroidUtilities.dp(21.0f) + AndroidUtilities.dp(132.0f), getMeasuredWidth());
                int dp = AndroidUtilities.dp(21.0f);
                float f13 = dp;
                float A = org.telegram.messenger.wh.A(48.0f, getMeasuredHeight(), 2);
                rectF.set(f13, A, z11, getMeasuredHeight() - r9);
                if (this.E >= 0) {
                ...
                paint3.setAlpha(255);
                rectF.set(f13, A, z11 - AndroidUtilities.dp(58.0f), getMeasuredHeight() - r9);
        ...
        int z112 = org.telegram.messenger.wh.z(16.0f, AndroidUtilities.dp(21.0f) + AndroidUtilities.dp(132.0f), getMeasuredWidth());
        int dp2 = AndroidUtilities.dp(21.0f);
        float f132 = dp2;
        float A2 = org.telegram.messenger.wh.A(48.0f, getMeasuredHeight(), 2);
        rectF.set(f132, A2, z112, getMeasuredHeight() - r9);
        if (this.E >= 0) {
        }
        f10 = this.x;
        if (f10 != f7) {
        ...
        paint3.setAlpha(255);
        rectF.set(f132, A2, z112 - AndroidUtilities.dp(58.0f), getMeasuredHeight() - r9);
        rectF.inset(-AndroidUtilities.dp(1.0f), -AndroidUtilities.dp(1.0f));
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint3);
        paint.setAlpha(31);
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint);
