...
public final class mg extends org.telegram.ui.lu0 {
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        ...
        if (mnVar != null && (wnVar = chatActivityEnterView.P2) != null && mnVar.f) {
            wnVar.Rb();
            return;
        }
        ...
        int i13 = wnVar2 == null ? 0 : wnVar2.R3;
        ...
        if (wnVar3 != null) {
            messageSuggestionParams = wnVar3.g5;
        }
        SendMessagesHelper.prepareSendingMedia(accountInstance, arrayList, j3, messageObject, threadMessage, null, mnVar2, false, false, messageObject2, z10, i11, i12, i13, checkUpdateStickersOrder, null, C8, 0L, false, 0L, sendMonoForumPeerId, messageSuggestionParams);
