...
public abstract class mg extends cu {
    ...
    */
    ...
    public final void m(Uri uri, String str) {
        ...
        Utilities.globalQueue.postRunnable(new org.telegram.ui.ActionBar.p(this, uri, AndroidUtilities.generatePicturePath(xnVar != null && xnVar.v(), MimeTypeMap.getSingleton().getExtensionFromMimeType(str)), 9));
    }
    ...
    public final void o(t0.i iVar, boolean z10, int i10, int i11) {
        ...
        if (hVar.getDescription().hasMimeType("image/gif")) {
            ...
            SendMessagesHelper.prepareSendingDocument(accountInstance, null, null, c10, null, "image/gif", j3, messageObject, threadMessage2, null, chatActivityEnterView.U2, null, z10, 0, iVar, xnVar != null ? xnVar.C8() : null, false);
        } else {
            ...
            SendMessagesHelper.prepareSendingPhoto(accountInstance2, null, c11, j10, messageObject2, threadMessage, chatActivityEnterView.U2, null, null, null, iVar, 0, null, z10, 0, xnVar == null ? 0 : xnVar.R3, xnVar != null ? xnVar.C8() : null);
        }
