...
public abstract class ei0 {
    ...
    public ei0(CharSequence charSequence, CharSequence charSequence2) {
        ...
        this.P = 1.0f;
        this.U = 1.0f;
        this.a0 = new ci0(this, 3);
        this.b0 = new ci0(this, 4);
        this.d0 = new lh.m7(this, 28);
        this.e0 = false;
    ...
    public final void c(Canvas canvas, boolean z10) {
        ...
        boolean z12 = p2Var instanceof we1;
        ...
        if (f28 == 0.0f) {
            ...
            f9 = f14;
            i13 = dp3;
            float z14 = com.google.android.recaptcha.internal.a.z(1.0f, this.C, this.H.getWidth() - this.M, (f29 * f14) + f29);
            if (this.v != 1.0f && this.w != 1.0f) {
        ...
        if (f43 == 0.0f || z11) {
            ...
            int i26 = dp5 >> 1;
            i15 = dp;
            di0Var.setBounds(i24 - dp6, measuredHeight - i26, i24 + dp6, measuredHeight + i26);
            ...
            di0Var.b.setColor(this.G ? paint2.getColor() : org.telegram.ui.ActionBar.g6.w0(null, this.b, false));
            di0Var.draw(canvas);
            canvas.restore();
        } else {
            i15 = dp;
        ...
        if (this.O != null) {
            ...
            if (f48 > 0.0f && f48 < 1.0f) {
                ...
                canvas.scale(f49, f49, width2, com.google.android.recaptcha.internal.a.z(1.0f, this.o, AndroidUtilities.dp(16.0f), height2));
            }
            i16 = i24;
            f12 = f27;
            f13 = f10;
        ...
        if (this.T != null) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.H.getMeasuredWidth(), this.H.getMeasuredHeight(), (int) (org.telegram.messenger.x3.y(1.0f, this.o, 255.0f, f12) * this.x), 31);
        ...
        float f56 = this.C;
        float d10 = com.google.android.recaptcha.internal.a.d(1.0f - dp7, f56, dp7, f9);
        float f57 = i16 - f23;
        float f58 = 1.0f - f56;
        ...
        float f59 = f55 / 2.0f;
        org.telegram.ui.ActionBar.g6.u1.setBounds((int) (f23 - f59), (int) (f13 - f59), (int) (f23 + f59), (int) (f59 + f13));
    ...
    public final void e(float f9) {
        this.C = f9;
        int d = i0.a.d(1.0f - this.C, org.telegram.ui.ActionBar.g6.w0(null, this.d, true), org.telegram.ui.ActionBar.g6.w0(null, this.c, true));
        this.h.setColor(d);
