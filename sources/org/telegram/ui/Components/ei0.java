...
public final class ei0 extends FrameLayout {
    ...
    public final void a() {
        ...
        this.s = animatorSet2;
        animatorSet2.playTogether(ObjectAnimator.ofFloat(ai0Var, (Property<ai0, Float>) View.TRANSLATION_Y, AndroidUtilities.dp(10.0f) + ai0Var.getMeasuredHeight()));
        if (this.E) {
            float measuredHeight = ai0Var.getMeasuredHeight();
            this.s.setDuration(Math.max(60, (int) (((measuredHeight - ai0Var.getTranslationY()) * 250.0f) / measuredHeight)));
            this.E = false;
        } else {
            this.s.setDuration(250L);
        }
        this.s.setInterpolator(pr.f);
        this.s.addListener(new di0(this, 2));
            ...
            if (motionEvent == null || (!(motionEvent.getAction() == 0 || motionEvent.getAction() == 2) || this.f || this.e || motionEvent.getPointerCount() != 1)) {
                if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.d) {
                    ...
                    if (this.e && !this.f && y3 > 0.0f && y3 / 3.0f > Math.abs(abs) && Math.abs(y3) >= this.y) {
                        ...
                        float translationY = ai0Var.getTranslationY() + y3;
                        ai0Var.setTranslationY(translationY >= 0.0f ? translationY : 0.0f);
                        this.c = (int) motionEvent.getY();
                    }
                    ...
                    float translationY2 = ai0Var.getTranslationY();
                    if (this.f || translationY2 != 0.0f) {
                        ...
                        if ((ai0Var.getTranslationY() >= AndroidUtilities.getPixelsInCM(0.8f, false) || (yVelocity >= 3500.0f && Math.abs(yVelocity) >= Math.abs(xVelocity))) && (yVelocity >= 0.0f || Math.abs(yVelocity) < 3500.0f)) {
                            ...
                            this.h = animatorSet;
                            animatorSet.playTogether(ObjectAnimator.ofFloat(ai0Var, (Property<ai0, Float>) View.TRANSLATION_Y, 0.0f));
                            this.h.setDuration((int) ((Math.max(0.0f, r6) / AndroidUtilities.getPixelsInCM(0.8f, false)) * 150.0f));
                            this.h.setInterpolator(pr.g);
                            this.h.addListener(new di0(this, i10));
                            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
                            this.h.start();
                        }
                        this.f = false;
                ...
                this.c = y10;
                if (y10 < ai0Var.getTop() || this.b < ai0Var.getLeft() || this.b > ai0Var.getRight()) {
                    requestDisallowInterceptTouchEvent(true);
                    a();
                    return true;
                }
    ...
    public final void c(boolean z10) {
        ...
        if (!DialogObject.isChatDialog(id0Var.e0)) {
            ...
            if (z11 && user != null) {
                ...
                if (ci0Var.getTag() == null) {
                    ci0Var.setTag(1);
                    ci0Var.animate().setDuration(180L).alpha(0.0f).scaleX(0.5f).scaleY(0.5f).start();
            ...
            if (user != null) {
                ci0Var.setText(LocaleController.formatString("LocationNotifiationButtonGroup", R.string.LocationNotifiationButtonGroup, formatDistance));
            } else {
                ci0Var.setText(LocaleController.formatString("LocationNotifiationButtonUser", R.string.LocationNotifiationButtonUser, TextUtils.ellipsize(UserObject.getFirstName(user), ci0Var.getPaint(), Math.max(AndroidUtilities.dp(10.0f), (int) (((this.N - AndroidUtilities.dp(94.0f)) * 1.5f) - ((int) Math.ceil(ci0Var.getPaint().measureText(LocaleController.getString(R.string.LocationNotifiationButtonUser)))))), TextUtils.TruncateAt.END), formatDistance));
            }
            if (ci0Var.getTag() == null) {
                ci0Var.setTag(null);
                ci0Var.animate().setDuration(180L).alpha(1.0f).scaleX(1.0f).scaleY(1.0f).start();
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i20 = i13 - i11;
        ai0 ai0Var = this.v;
        int measuredHeight = i20 - ai0Var.getMeasuredHeight();
        int i21 = i12 - i10;
        int measuredWidth = (i21 - ai0Var.getMeasuredWidth()) / 2;
        ai0Var.layout(measuredWidth, measuredHeight, ai0Var.getMeasuredWidth() + measuredWidth, ai0Var.getMeasuredHeight() + measuredHeight);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ai0 ai0Var = this.v;
        ai0Var.measure(View.MeasureSpec.makeMeasureSpec((this.x * 2) + size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_31));
        int childCount = getChildCount();
