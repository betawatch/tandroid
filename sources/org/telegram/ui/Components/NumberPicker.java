...
public class NumberPicker extends LinearLayout {
    ...
    private void fling(int i) {
        this.mPreviousScrollerY = 0;
        this.mFlingScroller.fling(0, i > 0 ? 0 : ConnectionsManager.DEFAULT_DATACENTER_ID, 0, i, 0, 0, 0, ConnectionsManager.DEFAULT_DATACENTER_ID);
        invalidate();
    }
    ...
    protected void changeValueByOne(boolean z) {
        ...
        this.mPreviousScrollerY = 0;
        if (z) {
            this.mFlingScroller.startScroll(0, 0, 0, -this.mSelectorElementHeight, NotificationCenter.didUpdateGlobalAutoDeleteTimer);
        } else {
            this.mFlingScroller.startScroll(0, 0, 0, this.mSelectorElementHeight, NotificationCenter.didUpdateGlobalAutoDeleteTimer);
        }
        invalidate();
