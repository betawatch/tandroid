    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i == 0) {
            ...
            if (max != 0.0f) {
                ...
                canvas2.drawLine(AndroidUtilities.dp(21.0f), height, dp2, height, this.outlinePaint);
                ...
                canvas2 = canvas;
                canvas2.drawLine(dp2, height, cos, height - sin, this.outlinePaint);
                canvas2.drawLine(dp2, height, cos, height + sin, this.outlinePaint);
            }
        } else if (i == 1) {
            ...
            canvas2.drawLine(dp4 + ((width - dp4) * this.progress), height2, width, height2, this.outlinePaint);
