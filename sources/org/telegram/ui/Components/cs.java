...
public final /* synthetic */ class cs implements MessagesStorage.LongCallback, bl0 {
    ...
    public void c(float f7, float f10, int i10, View view) {
        ...
        if (i12 != 36 && i12 != 35) {
            ...
            if (i12 == 38) {
                boolean z13 = gsVar.g0;
                gsVar.g0 = !z13;
                boolean[] zArr = !z13 ? gsVar.n0 : gsVar.m0;
                if (fsVar4.g != 0) {
                    fsVar4.e = zArr;
                    fsVar4.f();
                    fsVar4.g();
            ...
            if (i11 == 6) {
                ...
                if (i11 == 7) {
                    ...
                    if (i11 == 12) {
                        ...
                        if (tL_chatBannedRights.send_plain || gsVar.v0.send_plain) {
                            int i15 = 0;
                            while (true) {
                                if (i15 >= gsVar.X.x.size()) {
                                    break;
                                }
                                h51 G2 = gsVar.X.G(i15);
                                if (G2.a == 39 && G2.d == 0) {
