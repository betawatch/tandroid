...
public final class j50 implements Runnable {
    ...
    public static void a(j50 j50Var, boolean z10) {
        ...
        try {
            ...
            for (int i12 = 0; i12 < 3; i12++) {
                j50Var.v0.add(new y40());
            }
            if (z10) {
                j50Var.c0 = j50Var.Z + j50Var.a0;
                j50Var.g0 = j50Var.e0 + j50Var.f0;
                j50Var.M = true;
                j10 = 0;
            } else {
                j50Var.c0 = -1L;
            ...
            j50Var.u0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + j50Var.u0.getChannelCount() + " sample rate = " + j50Var.u0.getSampleRate() + " bufferSize = " + i11);
            }
            j50Var.z0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(j50Var.D0.a).roundAudioBitrate * 1024);
            mediaFormat.setInteger("max-input-size", 20480);
            MediaCodec createEncoderByType = MediaCodec.createEncoderByType(MediaController.AUDIO_MIME_TYPE);
            j50Var.B = createEncoderByType;
            createEncoderByType.configure(mediaFormat, (Surface) null, (MediaCrypto) null, 1);
            j50Var.B.start();
            j50Var.A = MediaCodec.createEncoderByType(MediaController.VIDEO_MIME_TYPE);
            j50Var.D = true;
            MediaFormat createVideoFormat = MediaFormat.createVideoFormat(MediaController.VIDEO_MIME_TYPE, j50Var.d, j50Var.e);
            createVideoFormat.setInteger("color-format", 2130708361);
            createVideoFormat.setInteger("bitrate", j50Var.f);
            createVideoFormat.setInteger("frame-rate", 30);
            createVideoFormat.setInteger("i-frame-interval", 1);
            j50Var.A.configure(createVideoFormat, (Surface) null, (MediaCrypto) null, 1);
            j50Var.r = j50Var.A.createInputSurface();
            j50Var.A.start();
            if (!z10) {
                boolean isSdCardPath = ImageLoader.isSdCardPath(j50Var.a);
                j50Var.b = j50Var.a;
                if (isSdCardPath) {
                    try {
                ...
                mp4Movie.setCacheFile(j50Var.b);
                mp4Movie.setRotation(0);
                mp4Movie.setSize(j50Var.d, j50Var.e);
                MP4Builder createMovie = new MP4Builder().createMovie(mp4Movie, j50Var.D0.I, false);
                j50Var.G = createMovie;
                k50 k50Var = j50Var.D0;
                boolean deviceIsHigh = SharedConfig.deviceIsHigh();
                k50Var.M0 = deviceIsHigh;
                createMovie.setAllowSyncFiles(deviceIsHigh);
            }
            AndroidUtilities.runOnUIThread(new f50(0, j50Var, z10));
            if (j50Var.s != EGL14.EGL_NO_DISPLAY) {
                throw new RuntimeException("EGL already set up");
            }
            EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
            j50Var.s = eglGetDisplay;
            ...
            if (j50Var.v == EGL14.EGL_NO_CONTEXT) {
                ...
                if (!EGL14.eglChooseConfig(j50Var.s, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, EglBase.EGL_RECORDABLE_ANDROID, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                    throw new RuntimeException("Unable to find a suitable EGLConfig");
                }
                i10 = 0;
                j50Var.v = EGL14.eglCreateContext(j50Var.s, eGLConfigArr[0], j50Var.w, new int[]{12440, 2, 12344}, 0);
                j50Var.x = eGLConfigArr[0];
            } else {
                i10 = 0;
            }
            EGL14.eglQueryContext(j50Var.s, j50Var.v, 12440, new int[1], i10);
            if (j50Var.y != EGL14.EGL_NO_SURFACE) {
                throw new IllegalStateException("surface already created");
            }
            EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(j50Var.s, j50Var.x, j50Var.r, new int[]{12344}, i10);
            j50Var.y = eglCreateWindowSurface;
            if (eglCreateWindowSurface == null) {
                throw new RuntimeException("surface was null");
            }
            if (!EGL14.eglMakeCurrent(j50Var.s, eglCreateWindowSurface, eglCreateWindowSurface, j50Var.v)) {
                if (BuildVars.LOGS_ENABLED) {
            ...
            j50Var.t0 = new q40(j50Var.d, j50Var.e);
            k50 k50Var2 = j50Var.D0;
            Size size = k50Var2.e0[0];
            String str = (SharedConfig.deviceIsLow() || !k50.b() || (size != null && ((float) Math.max(size.getHeight(), size.getWidth())) * 0.7f < ((float) MessagesController.getInstance(k50Var2.a).roundVideoSize))) ? "#extension GL_OES_EGL_image_external : require\nprecision highp float;\nvarying vec2 vTextureCoord;\nuniform float alpha;\nuniform vec2 preview;\nuniform vec2 resolution;\nuniform samplerExternalOES sTexture;\nvoid main() {\n   vec4 textColor = texture2D(sTexture, vTextureCoord);\n   gl_FragColor = vec4(textColor.rgb * alpha, alpha);\n}\n" : "#extension GL_OES_EGL_image_external : require\nprecision highp float;\nvarying vec2 vTextureCoord;\nuniform vec2 resolution;\nuniform vec2 preview;\nuniform float alpha;\nuniform samplerExternalOES sTexture;\nvoid main() {\n   vec2 c_textureSize = preview;\n   vec2 c_onePixel = (1.0 / c_textureSize);\n   vec2 uv = vTextureCoord;\n   vec2 pixel = uv * c_textureSize + 0.5;\n   vec2 frac = fract(pixel);\n   pixel = (floor(pixel) / c_textureSize) - vec2(c_onePixel);\n   vec4 tl = texture2D(sTexture, pixel + vec2(0.0         , 0.0));\n   vec4 tr = texture2D(sTexture, pixel + vec2(c_onePixel.x, 0.0));\n   vec4 bl = texture2D(sTexture, pixel + vec2(0.0         , c_onePixel.y));\n   vec4 br = texture2D(sTexture, pixel + vec2(c_onePixel.x, c_onePixel.y));\n   vec4 x1 = mix(tl, tr, frac.x);\n   vec4 x2 = mix(bl, br, frac.x);\n   gl_FragColor = mix(x1, x2, frac.y) * alpha;\n}\n";
            int a2 = k50.a(j50Var.D0, 35633, "uniform mat4 uMVPMatrix;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n   gl_Position = uMVPMatrix * aPosition;\n   vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}\n");
            int a3 = k50.a(j50Var.D0, 35632, str);
            if (a2 == 0 || a3 == 0) {
                return;
            }
            int glCreateProgram = GLES20.glCreateProgram();
            j50Var.i0 = glCreateProgram;
            GLES20.glAttachShader(glCreateProgram, a2);
            GLES20.glAttachShader(j50Var.i0, a3);
            GLES20.glLinkProgram(j50Var.i0);
            int[] iArr2 = new int[1];
            GLES20.glGetProgramiv(j50Var.i0, 35714, iArr2, 0);
            if (iArr2[0] == 0) {
                GLES20.glDeleteProgram(j50Var.i0);
                j50Var.i0 = 0;
                return;
            }
            j50Var.l0 = GLES20.glGetAttribLocation(j50Var.i0, "aPosition");
            j50Var.m0 = GLES20.glGetAttribLocation(j50Var.i0, "aTextureCoord");
            j50Var.o0 = GLES20.glGetUniformLocation(j50Var.i0, "preview");
            j50Var.n0 = GLES20.glGetUniformLocation(j50Var.i0, "resolution");
            j50Var.q0 = GLES20.glGetUniformLocation(j50Var.i0, "alpha");
            j50Var.j0 = GLES20.glGetUniformLocation(j50Var.i0, "uMVPMatrix");
            j50Var.k0 = GLES20.glGetUniformLocation(j50Var.i0, "uSTMatrix");
            j50Var.p0 = GLES20.glGetUniformLocation(j50Var.i0, "texelSize");
        } catch (Exception e9) {
    ...
    public static void b(j50 j50Var, int i10, e50 e50Var) {
        ...
        if (i10 != 1 || (((videoEditedInfo = j50Var.D0.J) != null && videoEditedInfo.needConvert()) || j50Var.D0.c.c())) {
            z10 = true;
        } else {
            if (!j50Var.C0) {
                j50Var.C0 = true;
            ...
            if (j50Var.c) {
                if (j50Var.a.exists()) {
                    try {
                        ...
                        FileLog.e("InstantCamera copying fileToWrite to videoFile, deleting videoFile error " + j50Var.a);
                        FileLog.e(e13);
                    }
                }
                if (!j50Var.b.renameTo(j50Var.a)) {
                    FileLog.e("InstantCamera unable to rename file, try move file");
                    try {
                        AndroidUtilities.copyFile(j50Var.b, j50Var.a);
                        j50Var.b.delete();
        ...
        if (i10 != 2 && (dispatchQueue = j50Var.x0) != null) {
        ...
        if (i10 == 0) {
            FileLoader.getInstance(j50Var.D0.a).cancelFileUpload(j50Var.a.getAbsolutePath(), false);
            try {
                j50Var.b.delete();
        ...
        EGL14.eglDestroySurface(j50Var.s, j50Var.y);
        j50Var.y = EGL14.EGL_NO_SURFACE;
        Surface surface = j50Var.r;
        if (surface != null) {
            surface.release();
            j50Var.r = null;
        }
        EGLDisplay eGLDisplay = j50Var.s;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            EGL14.eglDestroyContext(j50Var.s, j50Var.v);
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(j50Var.s);
        }
        j50Var.s = EGL14.EGL_NO_DISPLAY;
            ...
            if (dequeueOutputBuffer2 == -1) {
                ...
                if (dequeueOutputBuffer2 == -2) {
                    ...
                    if (outputBuffer2 == null) {
                        throw new RuntimeException(i0.a.l(dequeueOutputBuffer2, "encoderOutputBuffer ", " was null"));
                    }
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, (Property<LinearLayout, Float>) property, 0.0f), ObjectAnimator.ofInt(k50Var.d, m6.b, 0), ObjectAnimator.ofFloat(k50Var.w, (Property<ImageView, Float>) property, 1.0f));
