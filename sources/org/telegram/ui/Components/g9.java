...
public class g9 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.c && (x20Var = this.f) != null) {
            x20Var.b(bounds.left, bounds.top, r4 + width, r10 + width);
            paint = this.f.c;
        } else if (this.b) {
    ...
    public g9(int i10, TLRPC.User user) {
        this((org.telegram.ui.ActionBar.f6) null);
        this.l = false;
        if (user != null) {
    ...
    public g9(TLRPC.Chat chat) {
        this((org.telegram.ui.ActionBar.f6) null);
        this.l = false;
        q(chat);
    }

    public g9(org.telegram.ui.ActionBar.f6 f6Var) {
        this.p = 1.0f;
