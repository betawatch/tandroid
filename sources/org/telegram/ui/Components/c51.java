...
public final class c51 extends aw0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.D0 != z11) {
            this.D0 = z11;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5)) > 0.721f;
            boolean z13 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v(d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.s8), 855638016)) > 0.721f;
            if (!z11) {
                z12 = z13;
            }
        ...
        if (this.B0 > 0.0f) {
            int themedColor = d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5);
            Paint paint = this.w0;
        ...
        gradientDrawable.setColor(i0.a.k(d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.Ii), (int) (Color.alpha(r5) * Z)));
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.f0.C(10.0f, d51Var.f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + d51Var.f + i13 + dp2);
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        AndroidUtilities.runOnUIThread(new wq0(this, 26), 200L);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        drawable2 = ((org.telegram.ui.ActionBar.e3) d51Var).shadowDrawable;
        drawable2.draw(canvas);
        if (Z > 0.0f && Z < 1.0f) {
            float dp = AndroidUtilities.dp(12.0f) * Z;
            gradientDrawable.setColor(d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5));
            float[] fArr = this.C0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (getPaddingTop() != i16) {
            i14 = ((org.telegram.ui.ActionBar.e3) d51Var).backgroundPaddingLeft;
