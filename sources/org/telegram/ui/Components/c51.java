...
public abstract class c51 extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    ...
    public c51(Context context, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.zn znVar) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.z41
            ...
            public final void onClick(View view) {
                ...
                if (!isPremium && (chat == null || !chat.autotranslation)) {
                    org.telegram.ui.zn znVar2 = zkVar2.s;
                ...
                b51 b51Var = new b51(zkVar2.getContext());
                b51Var.b = new d6(b51Var, 350L, qr.h);
                LinearLayout linearLayout2 = new LinearLayout(zkVar2.getContext());
                b51Var.addView(linearLayout2);
                ...
                n90Var.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.i6, f6Var2), 0, 12));
    ...
    public static void a(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        n90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.y6, f6Var));
    ...
    public final void b() {
        ...
        if (isTranslatingDialog) {
            ...
            v3Var.setText(TextUtils.concat(spannableString, " ", zArr[0] ? LocaleController.formatString(R.string.TranslateToButton, D2) : LocaleController.formatString(R.string.TranslateToButtonOther, D2)));
        }
