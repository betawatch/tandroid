...
public final class p41 extends pv0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float Z = Z();
        boolean z10 = Z == 0.0f && !q41Var.isDismissed();
        if (this.z0 != z10) {
        ...
        if (this.D0 != z11) {
            this.D0 = z11;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.h5)) > 0.721f;
            boolean z13 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v(q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.s8), 855638016)) > 0.721f;
            if (!z11) {
                z12 = z13;
            }
        ...
        if (this.B0 > 0.0f) {
            int themedColor = q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.h5);
            Paint paint = this.w0;
        ...
        gradientDrawable.setColor(i0.a.k(q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.Ii), (int) (Color.alpha(r5) * Z)));
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.y0.C(10.0f, q41Var.f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + q41Var.f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.h5));
            float[] fArr = this.C0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
