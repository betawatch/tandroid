...
public final class cn implements ki {
    public final /* synthetic */ org.telegram.ui.ActionBar.p2 a;
    public final /* synthetic */ Utilities.Callback b;
    public final /* synthetic */ an c;

    public cn(Utilities.Callback callback, org.telegram.ui.ActionBar.p2 p2Var, an anVar) {
        this.a = p2Var;
        this.b = callback;
        this.c = anVar;
    }
    ...
    public final void I1(int i10, boolean z4, boolean z10, int i11, int i12, long j10, boolean z11, boolean z12, long j11) {
        an anVar = this.c;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = anVar.g0;
        Utilities.Callback callback = this.b;
        if (i10 == 15) {
            org.telegram.ui.ActionBar.p2 p2Var = this.a;
            z4.g0(p2Var.getContext(), p2Var.getResourceProvider(), null, null, new bn(0, callback), null);
        } else if (i10 == 7 || i10 == 8) {
