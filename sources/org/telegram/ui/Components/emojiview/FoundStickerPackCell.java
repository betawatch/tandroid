...
public class FoundStickerPackCell extends FrameLayout implements FactorAnimator.Target, Theme.Colorable {
    ...
    public void updateColors() {
        if (this.bgSelected != null) {
            ShapeDrawable createRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.dp(10.0f), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_glass_defaultIcon, this.resourcesProvider), 25));
