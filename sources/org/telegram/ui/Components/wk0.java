...
public final class wk0 implements View.OnLayoutChangeListener {
    ...
    public final void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        ((ValueAnimator) yVar.g).addListener(new dg.y2(25, this, arrayList2));
        if (!yVar.d) {
            if (z4) {
                min = 600;
            } else {
            ...
            ((ValueAnimator) yVar.g).setInterpolator(nr.h);
        } else if (z4) {
            ((ValueAnimator) yVar.g).setDuration(150L);
            ((ValueAnimator) yVar.g).setInterpolator(nr.g);
        } else {
