...
public class PhotoFilterView extends FrameLayout implements FilterShaders.FilterShadersDelegate, StoryRecorder.Touchable {
    ...
    */
    public PhotoFilterView(Context context, VideoEditTextureView videoEditTextureView, Bitmap bitmap, Bitmap bitmap2, int i, MediaController.SavedFilterState savedFilterState, PaintingOverlay paintingOverlay, int i2, boolean z, boolean z2, BlurringShader.BlurManager blurManager, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(frameLayout, LayoutHelper.createFrame(-1, (!z2 ? 40 : 0) + NotificationCenter.boostedChannelByUser, 83));
        ...
        this.toolsView.addView(this.blurLayout, LayoutHelper.createFrame(NotificationCenter.webRtcSpeakerAmplitudeEvent, 60.0f, 1, 0.0f, (z2 ? 0 : 40) + 40, 0.0f, 0.0f));
    ...
    private void fixLayout(int i, int i2) {
        ...
        if (this.ownLayout) {
            ...
            int dp2 = i2 - (AndroidUtilities.dp(214.0f) + (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0));
            ...
            int ceil3 = (int) Math.ceil(((f3 - ceil) / 2.0f) + AndroidUtilities.dp(14.0f) + (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0));
            int i4 = (int) f;
            int i5 = (int) ceil;
            if (this.ownsTextureView) {
            ...
            float f4 = i4;
            float f5 = i5;
            this.curvesControl.setActualArea(ceil2, ceil3 - (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0), f4, f5);
