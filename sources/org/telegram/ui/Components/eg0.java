    ...
    public static boolean x(boolean z10, Activity activity, qf0 qf0Var, View view, int i10, int i11, boolean z11) {
        ...
        if (!z10) {
            ...
            if (sf.c.a(ApplicationLoader.applicationContext) != 1) {
                ...
                float f7 = eg0Var.n().a.getFloat("x", -1.0f);
                float f10 = eg0Var.n().a.getFloat("y", -1.0f);
                eg0Var.J = eg0Var.n().a.getFloat("scale_factor", 1.0f);
                ...
                ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, new lg.b(eg0Var, i12));
                ...
                ai.n4 n4Var = new ai.n4(eg0Var, context);
                eg0Var.b0 = n4Var;
                eg0Var.h.addView(n4Var, w7.x5.c(-1.0f, -1));
