...
public final class yo extends yk0 {
    ...
    public final void v(f2.o1 o1Var, int i10) {
        ...
        int intValue;
        String[] split;
        b11 b11Var = (b11) o1Var.a;
        org.telegram.ui.ActionBar.f6 j10 = ((zo) this.d.get(i10)).a.j(((zo) this.d.get(i10)).c);
        if (j10 != null && j10.b != null && !j10.P && new File(j10.b).exists() && j10.b != null) {
            ...
            if (j10.c == null || j10.f || new File(j10.c).exists()) {
                ...
                if (!hashMap.containsKey(j10)) {
                    ...
                    ConnectionsManager.getInstance(j10.A).sendRequest(getwallpaper, new org.telegram.ui.gg(11, this, j10));
                }
            }
        }
        zo zoVar = (zo) this.d.get(i10);
        zo zoVar2 = b11Var.C;
        boolean z11 = zoVar2 != null && of.b.a(zoVar2.a.c, zoVar.a.c) && !org.telegram.ui.gy.t4 && b11Var.R == zoVar.c;
        ...
        b11Var.f(zoVar, this.r, z11);
        b11Var.g(i10 == this.f, z11);
        if (i10 == this.f) {
    ...
    public final f2.o1 x(ViewGroup viewGroup, int i10) {
        ...
        return new lk0(new b11(this.h, this.n, context, c6Var));
    }
