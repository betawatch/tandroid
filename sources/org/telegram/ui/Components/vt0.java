...
public final class vt0 extends FrameLayout {
    ...
    public vt0(int i10, Context context, boolean z4, org.telegram.ui.ActionBar.g6 g6Var, oq0 oq0Var) {
        super(context);
        ...
        dVar.setOnClickListener(new b80(oq0Var, 17));
        ...
        SpannableStringBuilder premiumText = AndroidUtilities.premiumText(LocaleController.getString(z4 ? R.string.MoreSimilarBotsText : R.string.MoreSimilarText), new oq0(oq0Var, 4));
