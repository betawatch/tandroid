...
public abstract class fy0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final long a() {
        ...
        for (int i10 = 0; i10 < this.b.length; i10++) {
            ...
            ey0 ey0Var = this.b[i10];
            if (ey0Var != null && (ey0Var.c || f10 > 0)) {
                if (f10 <= 0) {
                    f10 = ey0Var.e;
                }
                j10 += f10;
    ...
    public final void c(boolean z4) {
        ...
        for (int i11 = 0; i11 < ey0VarArr.length; i11++) {
            ...
            if (ey0Var2 != null && (ey0Var2.c || f13 > 0)) {
                this.y++;
            }
            if (ey0Var2 == null || (!(z10 = ey0Var2.c) && f13 <= 0)) {
                this.d[i11] = 0.0f;
            } else {
                if (f13 <= 0) {
                    f13 = ey0Var2.e;
        ...
        if (f11 > 1.0f) {
            float f15 = 1.0f / f11;
            for (int i12 = 0; i12 < ey0VarArr.length; i12++) {
                if (ey0VarArr[i12] != null) {
                    float[] fArr = this.d;
        ...
        if (!z4) {
            System.arraycopy(this.d, 0, this.c, 0, ey0VarArr.length);
            return;
        }
        System.arraycopy(this.c, 0, this.e, 0, ey0VarArr.length);
