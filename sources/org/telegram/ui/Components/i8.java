...
public final class i8 extends ul0 {
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        bi.x1 x1Var = j8Var.s0() ? new bi.x1(2, this, xVar) : null;
        int i11 = org.telegram.ui.ActionBar.j6.h5;
        f6Var = ((org.telegram.ui.ActionBar.h3) j8Var).resourcesProvider;
        xVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
        boolean s02 = j8Var.s0();
        bi.q qVar = (j8Var.s0() || j8Var.z0 || messageObject.getId() <= 0) ? null : new bi.q(this, xVar, messageObject, 11);
        ...
        imageView.setOnTouchListener(x1Var);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 1) {
            ...
            qnVar.setTag(-33024);
            return new fl0(qnVar);
        }
        boolean currentPlaylistIsGlobalSearch = MediaController.getInstance().currentPlaylistIsGlobalSearch();
        f6Var = ((org.telegram.ui.ActionBar.h3) this.n).resourcesProvider;
        return new fl0(new org.telegram.ui.Cells.x(context, currentPlaylistIsGlobalSearch ? 1 : 0, f6Var));
    }
}
