...
public final class oz0 extends TableLayout {
    ...
    public oz0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.b = new Path();
        this.c = new float[8];
        this.d = new Paint(1);
    ...
    public final mz0 a(CharSequence charSequence) {
        ...
        oVar.setTextColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        oVar.setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.gc, d6Var));
        ...
        layoutParams.span = 2;
        mz0 mz0Var = new mz0(this, oVar, true);
    ...
    public final TableRow c(CharSequence charSequence, CharSequence charSequence2, nz0[] nz0VarArr, zc[] zcVarArr) {
        ...
        tableRow.addView(new lz0(this, zcVar, false), new TableRow.LayoutParams(0, -1, 1.0f));
        addView(tableRow);
        if (zcVarArr != null) {
            zcVarArr[0] = zcVar;
        }
    ...
    public final void g(String str, String str2, Runnable runnable) {
        ...
        d90Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
    ...
    public final void h(String str, CharSequence charSequence, int i10, uh.i iVar) {
        ...
        imageView.setOnClickListener(new et(16, charSequence, iVar));
        w7.z5.a(imageView);
    ...
    public final TableRow j(CharSequence charSequence, int i10, long j3, Runnable runnable, String str, Runnable runnable2) {
        ...
        org.telegram.ui.h5 h5Var = new org.telegram.ui.h5(zcVar, 24.0f, i10);
        ImageReceiver imageReceiver = h5Var.b;
    ...
    public final TableRow l(String str, final int i10, final long j3, Runnable runnable) {
        ...
        Context context = getContext();
        org.telegram.ui.ActionBar.d6 d6Var = this.a;
        final b90 b90Var = new b90(context, d6Var);
        ...
        b90Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        b90Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        b90Var.setTextSize(14);
        org.telegram.ui.h5 h5Var = new org.telegram.ui.h5(b90Var, 24.0f, i10);
        ImageReceiver imageReceiver = h5Var.b;
        if (j3 == UserObject.ANONYMOUS) {
        ...
        o5Var.J = 0;
        b90Var.addOnAttachStateChangeListener(new ai.u2(o5Var, 10));
