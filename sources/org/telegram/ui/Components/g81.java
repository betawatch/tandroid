...
public final class g81 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        drawable.setBounds(org.telegram.messenger.em.w(2, this.c.getWidth() / 2, drawable), (int) (AndroidUtilities.dpf2(4.0f) + this.c.getHeight()), org.telegram.messenger.em.B(2, this.c.getWidth() / 2, drawable), drawable.getIntrinsicHeight() + ((int) (AndroidUtilities.dpf2(4.0f) + this.c.getHeight())));
