...
public final class g81 extends View {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        int i21;
        i81 i81Var = this.r;
        TextPaint textPaint = i81Var.d;
        TextPaint textPaint2 = i81Var.e;
        Paint paint = i81Var.f;
        org.telegram.ui.ActionBar.f6 f6Var = i81Var.j0;
        TextPaint textPaint3 = i81Var.c;
        canvas.save();
        ...
        if (i81Var.E == 9) {
            textPaint3.setColor(org.telegram.ui.ActionBar.j6.v0(i81Var.R, f6Var));
        } else if ((i81Var.J || i24 != -1) && (i22 == i10 || i22 == i11)) {
            textPaint3.setColor(i0.a.d(i81Var.K, org.telegram.ui.ActionBar.j6.v0(i13, f6Var), org.telegram.ui.ActionBar.j6.v0(i12, f6Var)));
        } else {
        ...
        if (this.a.a != Integer.MAX_VALUE) {
            if (i81Var.n) {
                ...
                if ((charSequence != null && this.d != null) || !TextUtils.equals(charSequence, this.d)) {
                    f81 f81Var = this.a;
                    CharSequence replaceEmoji = Emoji.replaceEmoji(f81Var.b, textPaint3.getFontMetricsInt(), false);
                    f81Var.b = replaceEmoji;
                    this.d = replaceEmoji;
                    h01 h01Var2 = this.e;
                    if (h01Var2 != null) {
                        x5.release(h01Var2.j, h01Var2.k);
                    }
                    h01 h01Var3 = new h01(this.d, textPaint3.getTextSize() / AndroidUtilities.density, textPaint3.getTypeface());
                    h01Var3.s(this);
                    this.e = h01Var3;
                }
                h01Var = this.e;
                if (h01Var == null) {
                    h01Var.p = AndroidUtilities.dp(400.0f);
                    i20 = i11;
                    i19 = i10;
                    i18 = measuredWidth;
                    h01Var.c(measuredWidth, getMeasuredHeight() / 2, 1.0f, textPaint3.getColor(), canvas);
                    canvas2 = canvas;
                } else {
                    canvas2 = canvas;
                    i18 = measuredWidth;
                ...
                if (this.a.a != Integer.MAX_VALUE) {
                    if (i81Var.n) {
                        textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(i81Var.T, f6Var));
                        if (org.telegram.ui.ActionBar.j6.c1(i14) && org.telegram.ui.ActionBar.j6.c1(i15)) {
                            ...
                            if ((i81Var.J || i81Var.L != -1) && ((i21 = this.a.a) == i19 || i21 == i20)) {
                                paint.setColor(i0.a.d(i81Var.K, org.telegram.ui.ActionBar.j6.v0(i15, f6Var), v02));
                            } else {
                                paint.setColor(v02);
                            }
                        } else {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        f81 f81Var = this.a;
        accessibilityNodeInfo.setSelected((f81Var == null || (i10 = this.r.G) == -1 || f81Var.a != i10) ? false : true);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        f81 f81Var = this.a;
        i81 i81Var = this.r;
        setMeasuredDimension(AndroidUtilities.dp(i81Var.r * 2) + f81Var.a(i81Var.c) + i81Var.I, View.MeasureSpec.getSize(i11));
    }
