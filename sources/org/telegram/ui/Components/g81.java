...
public abstract class g81 extends FrameLayout {
    ...
    public g81(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        this.T = org.telegram.ui.ActionBar.h6.s8;
        this.a0 = rr.h;
        ...
        ai.w0 w0Var = new ai.w0(this, context, i11);
        this.v = w0Var;
        ...
        gg.j0 j0Var = new gg.j0((ViewGroup) this, i13);
        this.w = j0Var;
        ...
        w0Var.setOnScrollListener(new kg0(this, i12));
        if (i10 == 9 || i10 == 10) {
    ...
    public final void a(int i10, CharSequence charSequence) {
        ...
        d81 d81Var = new d81();
        d81Var.a = i10;
        d81Var.b = charSequence;
        this.H = org.telegram.messenger.z0.C(this.r * 2, d81Var.a(this.c), this.H);
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        if (z11) {
            while (i10 < w0Var.getChildCount()) {
                w0Var.getChildAt(i10).animate().alpha(z10 ? 0.0f : 1.0f).scaleX(z10 ? 0.0f : 1.0f).scaleY(z10 ? 0.0f : 1.0f).setInterpolator(rr.f).setDuration(220L).start();
                i10++;
            }
        } else {
            while (i10 < w0Var.getChildCount()) {
    ...
    public final void d(int i10, int i11) {
        ...
        this.k0.setInterpolator(rr.f);
        this.k0.addListener(new jd0(this, 29));
        this.k0.start();
    }
    ...
    */
        ...
        if (view == w0Var) {
            ...
            if (z10) {
                ...
                if (f7 != 1.0f) {
                    ...
                    i10 = 0;
                    if (this.J && this.L == -1) {
                        s4.c1 K2 = w0Var.K(this.F);
                        if (K2 != null) {
                            e81 e81Var = (e81) K2.a;
                            i13 = e81Var.b;
                            dp = (int) (e81Var.getX() + ((e81Var.getMeasuredWidth() - i13) / 2));
                            int i15 = i13;
                            i10 = dp;
                            i14 = i15;
                        }
                    ...
                    if (i14 != 0) {
                        ...
                        int l1 = org.telegram.ui.ActionBar.h6.l1(0.15f, this.c.getColor());
                        Paint paint = this.q0;
                        paint.setColor(l1);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            for (int i15 = 0; i15 < size2; i15++) {
                int a2 = ((d81) arrayList.get(i15)).a(this.c);
    ...
    public void setReordering(boolean z10) {
        ...
        AndroidUtilities.forEachViews((RecyclerView) w0Var, (Utilities.Callback<View>) new ai.i3(5, this, z10));
    }
}
