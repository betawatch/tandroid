...
public final class c90 extends Drawable {
    ...
    */
    public final void draw(Canvas canvas) {
        ...
        int intValue = num != null ? num.intValue() : org.telegram.ui.ActionBar.g6.v0(this.l, c6Var);
        Integer num2 = this.p;
        int intValue2 = num2 != null ? num2.intValue() : org.telegram.ui.ActionBar.g6.v0(this.m, c6Var);
        Integer num3 = this.q;
        int intValue3 = num3 != null ? num3.intValue() : org.telegram.ui.ActionBar.g6.v0(this.l, c6Var);
        Integer num4 = this.r;
        int intValue4 = num4 != null ? num4.intValue() : org.telegram.ui.ActionBar.g6.v0(this.m, c6Var);
        ...
        if (linearGradient == null || min != this.s || intValue != this.h || intValue2 != this.i || intValue3 != this.j || intValue4 != this.k) {
            ...
            LinearGradient linearGradient2 = new LinearGradient(0.0f, 0.0f, f9, 0.0f, new int[]{i10, this.i, i10}, new float[]{0.0f, 0.67f, 1.0f}, tileMode);
        ...
        float interpolation = this.c > 0 ? 1.0f - jr.g.getInterpolation(Math.min(1.0f, (elapsedRealtime - r8) / 320.0f)) : 0.0f;
        boolean c3 = c();
        boolean z11 = false;
        RectF rectF = this.B;
        if (c3) {
    ...
    public final void h(float f9) {
        if (this.x != null) {
            ...
            this.w.setPathEffect(new CornerPathEffect(f9));
            return;
        }
        float[] fArr = this.A;
        boolean z10 = (fArr[0] == f9 && fArr[2] == f9 && fArr[4] == f9 && fArr[6] == f9) ? false : true;
        fArr[1] = f9;
        fArr[0] = f9;
        fArr[3] = f9;
        fArr[2] = f9;
    ...
    public c90() {
        ...
        this.f = new Matrix();
        this.g = new Matrix();
        this.l = org.telegram.ui.ActionBar.g6.h5;
        this.m = org.telegram.ui.ActionBar.g6.i5;
        this.t = 1.0f;
        this.u = 1.0f;
        this.v = new Paint(1);
