...
public class ax0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public boolean B;
    public int C;
    public int D;
    ...
    public final void b(int i10, boolean z4) {
        if (this.v != i10) {
            ...
            ViewPropertyAnimator translationY = ib1Var.animate().translationY(dp);
            pr prVar = pr.f;
    ...
    public final void d(int i10, boolean z4) {
        ...
        if (visibility != i10 && i10 == 0) {
            if (this.h) {
                ib1Var.animate().alpha(0.0f).scaleY(0.8f).scaleX(0.8f).setDuration(150L).start();
                view.animate().setListener(null).cancel();
                view.setVisibility(0);
                view.setAlpha(1.0f);
            } else {
                ib1Var.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).start();
                if (view != null) {
                    view.animate().setListener(null).cancel();
                    view.animate().setListener(new zw0(this, 0)).alpha(0.0f).setDuration(150L).start();
                } else {
        ...
        ib1Var.setScaleX(0.8f);
        ib1Var.setScaleY(0.8f);
        if (view != null) {
            view.animate().setListener(null).cancel();
            view.animate().setListener(new zw0(this, 1)).alpha(0.0f).setDuration(150L).start();
        } else {
    ...
    public void e(boolean z4, boolean z10) {
        if (this.h != z4) {
            ...
            if (z10) {
                ...
                if (view != null) {
                    view.animate().setListener(null).cancel();
                    view.animate().setListener(new zw0(this, 2)).alpha(0.0f).setDuration(150L).start();
                } else {
                    radialProgressView.animate().alpha(0.0f).scaleY(0.5f).scaleX(0.5f).setDuration(150L).start();
                }
            ...
            if (!z4) {
                ib1Var.animate().cancel();
                ib1Var.setAlpha(1.0f);
                ib1Var.setScaleX(1.0f);
                ib1Var.setScaleY(1.0f);
                if (view != null) {
                    view.animate().setListener(null).cancel();
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if ((this.B || this.x) && (i14 = this.C) > 0 && i14 != getMeasuredHeight()) {
            ...
            ib1 ib1Var = this.a;
            ib1Var.setTranslationY(ib1Var.getTranslationY() + measuredHeight);
            if (!this.x) {
                ib1Var.animate().translationY(0.0f).setInterpolator(pr.f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.c;
            if (radialProgressView != null) {
    ...
    public ax0(Context context, View view, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        this.w = UserConfig.selectedAccount;
        this.y = new ul0(this, 3);
        this.D = org.telegram.ui.ActionBar.k6.c7;
        this.n = g6Var;
        this.s = view;
        this.r = i10;
        ib1 ib1Var = new ib1(this, context, 11);
        this.a = ib1Var;
        ...
        ib1Var.addView(p9Var, k7.c6.q(117, 117, 1));
        ib1Var.addView(sVar, k7.c6.t(-2, -2, 1, 0, 12, 0, 0));
        ib1Var.addView(g90Var, k7.c6.t(-2, -2, 1, 0, 8, 0, 0));
        ib1Var.addView(dVar, k7.c6.t(-1, 48, 1, 28, 16, 28, 0));
        addView(ib1Var, k7.c6.d(-2, -2.0f, 17, 46.0f, 0.0f, 46.0f, 30.0f));
        if (view == null) {
