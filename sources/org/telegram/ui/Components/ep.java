...
public final class ep extends FrameLayout {
    ...
    public ep(Activity activity, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        while (i10 < 2) {
            this.b[i10] = new ri0(activity);
            this.b[i10].setScaleType(ImageView.ScaleType.CENTER);
            frameLayout.addView(this.b[i10], h7.z5.d(24, 24.0f, 51, 0.0f, i10 == 0 ? 0.0f : 24.0f, 0.0f, 0.0f));
            ...
            frameLayout.addView(this.a[i10], h7.z5.d(-2, -2.0f, 51, 32.0f, i10 == 0 ? 2.0f : 26.0f, 10.0f, 0.0f));
            if (i10 == 0) {
