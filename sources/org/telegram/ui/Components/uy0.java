...
public final class uy0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10 || this.d) {
            ...
            float f13 = wy0Var.h;
            rectF.set(f13, f13, getWidth() - wy0Var.h, (wy0Var.h * AndroidUtilities.dp(this.d ? -1.0f : 1.0f)) + getHeight());
            ...
            float f15 = wy0Var.h;
            canvas2.drawRect(f15, f15, getWidth() - wy0Var.h, getHeight() + wy0Var.h, wy0Var.e);
        }
