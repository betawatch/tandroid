...
public final class f81 extends AsyncTask {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:136:0x0282, code lost:
        ...
        r0 = org.telegram.ui.Components.g81.q0.matcher(r4);
     */
    ...
    */
    public final Object doInBackground(Object[] objArr) {
        ...
        boolean z12 = true;
        String c12 = g81.c(this, str5, null, true);
        if (!isCancelled()) {
            String r10 = aa.d.r(new StringBuilder("video_id="), this.a, "&ps=default&gl=US&hl=en");
            try {
            ...
            if (c12 != null) {
                Matcher matcher = g81.p0.matcher(c12);
                if (matcher.find()) {
                    StringBuilder e11 = ta.b.e(r10, "&sts=");
                    e11.append(c12.substring(matcher.start() + 6, matcher.end()));
                    r10 = e11.toString();
                } else {
                    r10 = ta.b.j(r10, "&sts=");
                }
            ...
            while (true) {
                ...
                g81 g81Var2 = this.e;
                String str7 = "https://www.youtube.com/get_video_info?" + r10 + strArr[i9];
                g81Var2.getClass();
                String c14 = g81.c(this, str7, hashMap, z12);
                if (isCancelled()) {
                    return hashMap;
                }
                if (c14 != null) {
                    ...
                    while (i11 < split.length) {
                        if (split[i11].startsWith("dashmpd")) {
                            ...
                            if (split[i11].startsWith("url_encoded_fmt_stream_map")) {
                            ...
                            } else if (split[i11].startsWith("use_cipher_signature")) {
                                String[] split6 = split[i11].split("=");
                                if (split6.length == 2 && split6[1].toLowerCase().equals("true")) {
                                    z14 = true;
                                }
                            } else if (split[i11].startsWith("hlsvp")) {
                            ...
                            } else if (split[i11].startsWith("livestream")) {
                                String[] split8 = split[i11].split("=");
        ...
        String str10 = null;
        if (str10 != null) {
            Matcher matcher2 = g81.w0.matcher(str10);
            if (matcher2.find()) {
            ...
            if (str2 == null) {
                ...
                this.e.getClass();
                obj = null;
                String c15 = g81.c(this, str10, null, true);
                if (!isCancelled()) {
                    if (c15 != null) {
                        Matcher matcher3 = g81.r0.matcher(c15);
                        if (matcher3.find()) {
                            str3 = matcher3.group(1);
                        } else {
                            Matcher matcher4 = g81.s0.matcher(c15);
                            if (matcher4.find()) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                try {
                    AndroidUtilities.runOnUIThread(new p61(1, this, str2 + str3 + "('" + this.d.substring(3) + "');"));
                    this.b.await();
                } catch (Exception e17) {
                    FileLog.e(e17);
                    z16 = true;
