...
public final class f81 extends View {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = h81Var.j0;
        ...
        if (h81Var.E == 9) {
            textPaint3.setColor(org.telegram.ui.ActionBar.i6.v0(h81Var.R, e6Var));
        } else if ((h81Var.J || i24 != -1) && (i22 == i10 || i22 == i11)) {
            textPaint3.setColor(i0.a.d(h81Var.K, org.telegram.ui.ActionBar.i6.v0(i13, e6Var), org.telegram.ui.ActionBar.i6.v0(i12, e6Var)));
        } else {
            textPaint3.setColor(org.telegram.ui.ActionBar.i6.v0(i12, e6Var));
        }
        this.a.getClass();
        if (this.a.a != Integer.MAX_VALUE) {
            if (h81Var.n) {
                ...
                if ((charSequence != null && this.d != null) || !TextUtils.equals(charSequence, this.d)) {
                    ...
                    g01 g01Var2 = this.e;
                    if (g01Var2 != null) {
                        x5.release(g01Var2.j, g01Var2.k);
                    }
                    g01 g01Var3 = new g01(this.d, textPaint3.getTextSize() / AndroidUtilities.density, textPaint3.getTypeface());
                    g01Var3.s(this);
                    this.e = g01Var3;
                }
                g01Var = this.e;
                if (g01Var == null) {
                    g01Var.p = AndroidUtilities.dp(400.0f);
                    i20 = i11;
                    i19 = i10;
                    i18 = measuredWidth;
                    g01Var.c(measuredWidth, getMeasuredHeight() / 2, 1.0f, textPaint3.getColor(), canvas);
                    canvas2 = canvas;
                } else {
                    canvas2 = canvas;
                    i18 = measuredWidth;
                ...
                if (this.a.a != Integer.MAX_VALUE) {
                    if (h81Var.n) {
                        textPaint.setColor(org.telegram.ui.ActionBar.i6.v0(h81Var.T, e6Var));
                        if (org.telegram.ui.ActionBar.i6.c1(i14) && org.telegram.ui.ActionBar.i6.c1(i15)) {
                            int v02 = org.telegram.ui.ActionBar.i6.v0(i14, e6Var);
                            if ((h81Var.J || h81Var.L != -1) && ((i21 = this.a.a) == i19 || i21 == i20)) {
                                paint.setColor(i0.a.d(h81Var.K, org.telegram.ui.ActionBar.i6.v0(i15, e6Var), v02));
                            } else {
                                paint.setColor(v02);
                            }
                        } else {
                        ...
                        int y3 = org.telegram.messenger.vl.y(20.0f, getMeasuredHeight(), 2);
                        if (this.a.a != Integer.MAX_VALUE) {
                            if (h81Var.n) {
                                int i28 = h81.s0;
