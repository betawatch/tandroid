...
public class pq extends ReplacementSpan {
    ...
    */
            ...
            if (runnable != null) {
                ...
                if (i16 == 0) {
                    if (this.useLinkPaintColor && (paint instanceof TextPaint)) {
                        ...
                        if (this.usePaintColor) {
                            ...
                            if (i15 != 1) {
                                if (i15 == 2) {
                                    ...
                                    i17 = hg.c.z(i18, i19, 2, i12) + AndroidUtilities.dp(this.topOffset);
                                }
                            }
                        ...
                        i16 = org.telegram.ui.ActionBar.h6.w0(null, this.colorKey, false);
                    }
                }
                z10 = false;
                if (this.drawableColor != i16) {
    ...
    public pq(int i10, Drawable drawable) {
        this.draw = true;
