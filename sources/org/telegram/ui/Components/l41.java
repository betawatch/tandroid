...
public final /* synthetic */ class l41 implements Runnable {
    ...
    public /* synthetic */ l41(org.telegram.ui.al alVar, boolean[] zArr, String str, LinearLayout linearLayout, ArrayList arrayList, String str2, TranslateController translateController, org.telegram.ui.ActionBar.o1 o1Var, ArrayList arrayList2) {
        this.d = alVar;
        this.e = zArr;
        this.f = str;
        this.n = linearLayout;
                ...
                if (!zArr[0]) {
                    ...
                    while (i10 < size) {
                        ...
                        if (TextUtils.equals(str3, str2)) {
                            ...
                            if (z10) {
                                ...
                                g1Var = g1Var3;
                                final int i12 = 0;
                                g1Var.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.j41
                                    @Override // android.view.View.OnClickListener
                                    public final void onClick(View view) {
                                        switch (i12) {
                                            case 0:
                                                org.telegram.ui.al alVar2 = alVar;
                                                translateController.setDialogTranslateTo(alVar2.b, str3);
                                                o1Var.d(true);
                                                alVar2.b();
                                                break;
                                            default:
                                                org.telegram.ui.al alVar3 = alVar;
                                                translateController.setDialogTranslateTo(alVar3.b, str3);
                                                o1Var.d(true);
                                                alVar3.b();
                                                break;
                                        }
                    ...
                    while (i13 < size2) {
                        ...
                        if (!TextUtils.equals(str4, str2)) {
                            ...
                            if (!z11) {
                                final int i15 = 1;
                                g1Var4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.j41
                                    @Override // android.view.View.OnClickListener
                                    public final void onClick(View view) {
                                        switch (i15) {
                                            case 0:
    ...
    public /* synthetic */ l41(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, ArrayList arrayList5, ArrayList arrayList6, ArrayList arrayList7, ArrayList arrayList8) {
