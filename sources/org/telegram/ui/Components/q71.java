...
public final class q71 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas2.drawRoundRect(rectF, measuredHeight2, measuredHeight3, N);
        if (c6Var == null ? org.telegram.ui.ActionBar.g6.a1() : c6Var.u0()) {
            ...
            Paint N2 = c6Var != null ? c6Var.N("paintChatActionBackgroundDarken") : null;
            if (N2 == null) {
                N2 = org.telegram.ui.ActionBar.g6.S0("paintChatActionBackgroundDarken");
            }
            canvas2.drawRoundRect(rectF, measuredHeight4, measuredHeight5, N2);
        }
        if (this.E > 0.0f) {
        ...
        int x8 = org.telegram.messenger.rl.x(28.0f, getMeasuredWidth() - this.h, 2);
        canvas2.drawText(this.f, AndroidUtilities.dp(28.0f) + x8, AndroidUtilities.dp(21.0f), textPaint);
        canvas2.save();
        canvas2.translate(x8, AndroidUtilities.dp(7.0f));
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.rl.B(56.0f, this.n, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), TLObject.FLAG_30));
    }
