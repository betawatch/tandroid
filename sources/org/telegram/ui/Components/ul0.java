...
public final class ul0 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        Paint paint = this.c;
        paint.setColor(i0.a.d(this.k, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.ic, this.n), this.l));
        int i10 = this.m;
        if (i10 != 255) {
        ...
        if (this.b) {
            ...
            float f9 = j10;
            float f10 = ((f9 / 300.0f) * this.g) + this.d;
            this.d = f10;
            if (f10 > 1.0f) {
                this.g = -1;
                this.d = 1.0f;
            ...
            float f11 = ((f9 / 310.0f) * this.h) + this.e;
            this.e = f11;
            if (f11 > 1.0f) {
                this.h = -1;
                this.e = 1.0f;
            ...
            float f12 = ((f9 / 320.0f) * this.i) + this.f;
            this.f = f12;
            if (f12 > 1.0f) {
                this.i = -1;
                this.f = 1.0f;
