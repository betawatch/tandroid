...
public final class sp0 extends pv0 {
    ...
    public sp0(hq0 hq0Var, Context context) {
        ...
        this.F0 = AndroidUtilities.computePerceivedBrightness(hq0Var.getThemedColor(org.telegram.ui.ActionBar.i6.h5)) > 0.721f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f7 < 1.0f) {
            ...
            org.telegram.ui.ActionBar.i6.t0.setColor(hq0Var.getThemedColor(org.telegram.ui.ActionBar.i6.Ii));
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int D = org.telegram.messenger.y0.D(103.0f, Math.max(2, (int) Math.ceil(Math.max(hq0Var.M.h(), hq0Var.K.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + AndroidUtilities.dp(103.0f));
        i12 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingTop;
        int i20 = i12 + D;
        if (ll0Var.getVisibility() != 8) {
            int D2 = org.telegram.messenger.y0.D(103.0f, Math.max(2, (int) Math.ceil((hq0Var.L.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + AndroidUtilities.dp(103.0f));
            i15 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingTop;
            int i21 = i15 + D2;
            if (i21 > i20) {
