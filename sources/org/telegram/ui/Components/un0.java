...
public final class un0 extends Drawable {
    ...
    public un0(Runnable runnable, boolean z10) {
        ...
        Path path = new Path();
        this.f = path;
        this.g = new pz0(LocaleController.getString(R.string.SeekSpeedHint), 14.0f, null);
        Path path2 = new Path();
        this.h = path2;
        Path path3 = new Path();
        this.i = path3;
        ...
        this.l = y5Var;
        y5Var.d(0.0f, true);
        this.m = new y5(runnable, 320L, erVar, 0);
        this.n = new y5(runnable, 200L, erVar, 0);
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.translate(0.0f, (1.0f - e9) * (-AndroidUtilities.dp(15.0f)));
        canvas.clipRect(this.r);
        this.c.setColor(org.telegram.ui.ActionBar.g6.l1(f11, -16777216));
        RectF rectF = this.r;
        ...
        this.d.setColor(org.telegram.ui.ActionBar.g6.l1(((((((float) Math.sin(this.t * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, f13) * e9, -1));
        canvas.drawPath(this.h, this.d);
        canvas.translate(AndroidUtilities.dp(10.66f), 0.0f);
        this.d.setColor(org.telegram.ui.ActionBar.g6.l1(((((((float) Math.sin((this.t + 0.17f) * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, f13) * e9, -1));
        canvas.drawPath(this.h, this.d);
        canvas.restore();
        canvas.save();
        canvas.translate(((-AndroidUtilities.dp(28.0f)) / 2.0f) * d10, 0.0f);
        tn0 tn0Var = this.p;
        tn0Var.w = (int) (e9 * 255.0f);
        tn0Var.draw(canvas);
        canvas.restore();
        canvas.save();
        ...
        this.d.setColor(org.telegram.ui.ActionBar.g6.l1(((((((float) Math.sin(this.t * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, d10) * e9, -1));
        canvas.drawPath(this.i, this.d);
        canvas.translate(AndroidUtilities.dp(10.66f), 0.0f);
        this.d.setColor(org.telegram.ui.ActionBar.g6.l1(((((((float) Math.sin((this.t - 0.17f) * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, d10) * e9, -1));
        canvas.drawPath(this.i, this.d);
        canvas.restore();
        canvas.restore();
        ...
        if (e10 > 0.0f) {
            if (this.e == null) {
                ...
                this.e = oi0Var;
                oi0Var.H(true);
                this.e.setCallback(new fg.a(this, 7));
                this.e.I(1);
                this.e.start();
            }
            ...
            RectF rectF3 = this.r;
            float height = (rectF3.height() * e9) + rectF3.top + AndroidUtilities.dp(11.0f);
            float centerX2 = bounds.centerX() + f14;
            RectF rectF4 = this.r;
            rectF2.set(centerX, height, centerX2, (rectF4.height() * e9) + rectF4.top + AndroidUtilities.dp(11.0f) + dp2);
            canvas.save();
            float f15 = (0.25f * e10) + 0.75f;
            canvas.scale(f15, f15, this.s.centerX(), this.s.top);
            this.c.setColor(org.telegram.ui.ActionBar.g6.l1(e10 * 0.4f, -16777216));
            canvas.save();
