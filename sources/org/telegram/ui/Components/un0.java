...
public class un0 extends ScrollView {
    ...
    public static boolean e(View view) {
        return (Objects.equals(view.getTag(), -33024) || (view instanceof org.telegram.ui.Cells.y8) || (view instanceof org.telegram.ui.Cells.x6) || (view instanceof org.telegram.ui.k10)) ? false : true;
    }
    ...
    public final void a(Canvas canvas, View view, View view2) {
        ...
        if (view2.getParent() != linearLayout && (layoutParams2 instanceof ViewGroup.MarginLayoutParams)) {
            f9 = ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin;
        }
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(c(view) + linearLayout.getX(), Math.max(getScrollY() - AndroidUtilities.dp(16.0f), (d(view) + linearLayout.getY()) - f10), c(view) + linearLayout.getX() + view.getWidth(), Math.min(getScrollY() + AndroidUtilities.dp(16.0f) + getHeight(), d(view2) + linearLayout.getY() + view2.getHeight() + f9));
        if (rectF.bottom < rectF.top) {
            return;
        }
        jl0.N0(canvas, rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), view.getAlpha(), this.a);
    }
            ...
            if (childAt.getVisibility() == 0) {
                if (childAt instanceof LinearLayout) {
                    ...
                    if (linearLayout.getOrientation() == 1) {
                        float x4 = childAt.getX() + f9;
                        LinearLayout linearLayout2 = this.b;
                        if (x4 <= linearLayout2.getPaddingLeft() && childAt.getX() + f9 + childAt.getWidth() >= linearLayout2.getWidth() - linearLayout2.getPaddingRight()) {
