        ...
        if (this.F) {
            ...
            if (this.A) {
                ...
                while (size >= 0) {
                    ...
                    if ((size % 2 == 0 ? 1 : 0) == i17) {
                        ...
                        if (l6Var2.length() > l6Var.length()) {
                            faVar.b(l6Var2.subSequence(length3, length3 + intValue));
                        } else {
                            faVar.b(l6Var.subSequence(length4, length4 + intValue));
                        }
                    } else {
                        i11 = size;
                ...
                while (i24 <= min) {
                    ...
                    if (z13 != z14 || i24 == min) {
                        if (i24 - i25 > 0) {
                            if (z13) {
                                i(faVar, l6Var2.subSequence(i25, i24), i25, i24);
                            } else {
            ...
            while (i26 <= min2) {
                ...
                if (z15 != z16 || i26 == min2) {
                    ...
                    if (i30 > 0 || i31 > 0) {
                        if (i30 == i31 && z17) {
                            faVar.b(l6Var2.subSequence(i28, i26));
                        } else {
                            if (i30 > 0) {
