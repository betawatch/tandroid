...
public final class av0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public av0(org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        if (p2Var instanceof eh) {
            ...
            if (a2 != p2Var.getUserConfig().getClientUserId()) {
                p2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a2, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.zu0
                    ...
                    public final void run(Object obj) {
                        ...
                        switch (i11) {
                            case 0:
                                av0 av0Var = this.b;
                                ArrayList arrayList = av0Var.x;
                                boolean booleanValue = bool.booleanValue();
                                av0Var.f = booleanValue;
                                av0Var.h = true;
                                if (booleanValue) {
                                    int size = arrayList.size();
                                    for (int i12 = 0; i12 < size; i12++) {
                                        ((bv0) arrayList.get(i12)).M();
                                    }
                                    break;
                                }
                                break;
                            default:
                                av0 av0Var2 = this.b;
                                ArrayList arrayList2 = av0Var2.x;
                                boolean booleanValue2 = bool.booleanValue();
                                av0Var2.f = booleanValue2;
                                av0Var2.h = true;
                                if (booleanValue2) {
                                    int size2 = arrayList2.size();
                                    for (int i13 = 0; i13 < size2; i13++) {
                                        ((bv0) arrayList2.get(i13)).M();
                                    }
                                    break;
                                }
                                break;
            ...
            if (profileActivity.h1) {
                ...
                if (a10 != p2Var.getUserConfig().getClientUserId()) {
                    p2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a10, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.zu0
                        public final /* synthetic */ av0 b;
        ...
        int i12 = 0;
        while (true) {
            xu0[] xu0VarArr = this.n;
            if (i12 >= xu0VarArr.length) {
                break;
            }
            xu0VarArr[i12] = new xu0();
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
                ...
                for (int i24 = 0; i24 < arrayList.size(); i24++) {
                    ...
                    if (!messageObject.isEphemeral()) {
                        ...
                        if ((j11 == 0 || j11 == MessageObject.getTopicId(currentAccount, messageObject.messageOwner, true)) && MessageObject.getMedia(messageObject.messageOwner) != null && !messageObject.needDrawBluredPreview() && (mediaType = MediaDataController.getMediaType(messageObject.messageOwner)) != -1 && ((mediaType != 0 || this.n[0].q != 2 || messageObject.isVideo()) && (mediaType != 0 || this.n[0].q != 1 || !messageObject.isVideo()))) {
                            xu0 xu0Var = this.n[mediaType];
                            if (xu0Var.l) {
                                xu0Var.a(messageObject, i23, true, isEncryptedDialog);
                            }
                            if (this.s == 0) {
                            ...
                            if (i23 == 0) {
                                for (int i25 = 0; i25 < this.n[mediaType].e.size(); i25++) {
                                    ((fu0) this.n[mediaType].e.get(i25)).b++;
                                }
                            }
                        }
                    }
        ...
        if (i10 != NotificationCenter.messageReceivedByServer) {
            ...
            if (i10 == NotificationCenter.messagesDeleted) {
                ...
                for (int i28 = 0; i28 < size3; i28++) {
                    ...
                    while (true) {
                        xu0[] xu0VarArr = this.n;
                        if (i29 < xu0VarArr.length) {
                            MessageObject b10 = xu0VarArr[i29].b(((Integer) arrayList3.get(i28)).intValue(), 0);
                            if (b10 != null) {
            ...
            if (i10 != NotificationCenter.replaceMessagesObjects) {
                ...
                if (i10 == NotificationCenter.fileLoaded) {
                    ...
                    int i34 = 0;
                    while (true) {
                        xu0[] xu0VarArr2 = this.n;
                        if (i34 >= xu0VarArr2.length) {
                            break;
                        }
                        arrayList4.addAll(xu0VarArr2[i34].a);
                        i34++;
                    }
                ...
                if (i10 == NotificationCenter.savedMessagesDialogsUpdate) {
                    ...
                    boolean z12 = p2Var3 != null && p2Var3.getMessagesController().getSavedMessagesController().containsDialog(this.r);
            ...
            if (longValue8 == j13 || longValue8 == this.v) {
                ...
                while (i37 < size6) {
                    ...
                    if (j14 == 0 || topicId == j14) {
                        int i38 = 0;
                        while (true) {
                            xu0[] xu0VarArr3 = this.n;
                            if (i38 >= xu0VarArr3.length) {
                                break;
                            }
                            MessageObject messageObject3 = (MessageObject) xu0VarArr3[i38].b[i36].get(id2);
        ...
        while (true) {
            xu0[] xu0VarArr4 = this.n;
            if (i17 >= xu0VarArr4.length) {
                return;
            }
            xu0VarArr4[i17].f(i41, num.intValue(), num2.intValue());
            i17++;
        }
    }
}
