...
public final class nr implements Interpolator {
    public static final nr f = new nr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final nr g = new nr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final nr h = new nr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final nr i = new nr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final nr j = new nr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final nr k = new nr(0.34d, 1.56d, 0.64d, 1.0d);
    ...
    static {
        new PathInterpolator(j7.y7.d("M 0,0 C 0.05, 0, 0.133333, 0.06, 0.166666, 0.4 C 0.208333, 0.82, 0.25, 1, 1, 1"));
    ...
    public nr(float f10, float f11, float f12, float f13) {
    ...
    public nr(double d, double d10, double d11, double d12) {
