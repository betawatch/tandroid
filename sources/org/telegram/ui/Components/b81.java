...
public abstract class b81 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [java.lang.Runnable, org.telegram.ui.Components.z71] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void e(MessageObject messageObject, final float f7, int i10) {
        ...
        DispatchQueue dispatchQueue = Utilities.globalQueue;
        ?? r52 = new Runnable() { // from class: org.telegram.ui.Components.z71
            @Override // java.lang.Runnable
            public final void run() {
                int i13;
                b81 b81Var = b81.this;
                RectF rectF = b81Var.H;
                if (b81Var.b == null) {
                    b81Var.h = f7;
                    return;
                }
                int max = Math.max(200, AndroidUtilities.dp(100.0f));
                Bitmap q6 = b81Var.b.q(j10, false);
                if (q6 != null) {
                    ...
                    try {
                        ...
                        canvas.drawBitmap(q6, (Rect) null, rectF, b81Var.I);
