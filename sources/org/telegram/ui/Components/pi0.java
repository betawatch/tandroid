...
public abstract class pi0 {
    ...
    public pi0(CharSequence charSequence, CharSequence charSequence2) {
        TextPaint textPaint = new TextPaint(1);
        this.k = textPaint;
        oi0 oi0Var = new oi0();
        oi0Var.a = new Path();
        oi0Var.b = new Paint(1);
        oi0Var.a();
        this.l = oi0Var;
        this.n = new Path();
        this.o = 1.0f;
        ...
        this.P = 1.0f;
        this.U = 1.0f;
        this.a0 = new ni0(this, 3);
        this.b0 = new ni0(this, 4);
        this.d0 = new m2.b(this, 27);
        this.e0 = false;
    ...
    public final void a(boolean z4) {
        if (this.G != z4) {
            ...
            if (z4) {
                ...
                this.t = ofFloat;
                ofFloat.addUpdateListener(new ni0(this, 0));
            ...
            this.u = ofFloat2;
            ofFloat2.addUpdateListener(new ni0(this, 1));
    ...
    public final void c(Canvas canvas, boolean z4) {
        ...
        boolean z11 = r2Var instanceof hf1;
        ...
        if (z12 != this.r) {
            ...
            this.A = ofFloat2;
            ofFloat2.addUpdateListener(new ni0(this, 2));
            this.A.setInterpolator(nr.j);
        ...
        if (f29 == 0.0f) {
            ...
            f10 = f15;
            i13 = dp3;
            float w10 = e2.c.w(1.0f, this.C, this.H.getWidth() - this.M, (f30 * f15) + f30);
            if (this.v != 1.0f && this.w != 1.0f) {
                canvas.drawCircle(f24, f25, w10, paint);
            }
            Path path = this.n;
            path.reset();
            f11 = f25;
            rectF.set(f24 - w10, f25 - w10, f24 + w10, f11 + w10);
        ...
        if (f44 == 0.0f || z10) {
            ...
            int i26 = dp5 >> 1;
            i15 = dp;
            oi0Var.setBounds(i24 - dp6, measuredHeight - i26, i24 + dp6, measuredHeight + i26);
            ...
            oi0Var.b.setColor(this.G ? paint2.getColor() : org.telegram.ui.ActionBar.j6.w0(null, this.b, false));
            oi0Var.draw(canvas);
            canvas.restore();
        } else {
            i15 = dp;
        ...
        float width2 = (this.H.getWidth() + (z10 ? i15 * 2 : 0)) / 2.0f;
        if (this.O != null) {
            float f49 = this.o;
            if (f49 > 0.0f && f49 < 1.0f) {
                canvas.save();
                float f50 = (this.o * 0.2f) + 0.8f;
                canvas.scale(f50, f50, width2, e2.c.w(1.0f, this.o, AndroidUtilities.dp(16.0f), height2));
            }
            i16 = i24;
            f13 = f28;
            f14 = f11;
            canvas.saveLayerAlpha(0.0f, 0.0f, this.H.getMeasuredWidth(), this.H.getMeasuredHeight(), (int) (this.o * f12 * f28 * this.x), 31);
            canvas.translate((width2 - this.Q) - (this.R / 2.0f), e2.c.w(1.0f, this.o, AndroidUtilities.dp(8.0f), height2) - this.O.getHeight());
            float f51 = this.P;
        ...
        if (this.T != null) {
            ...
            if (f53 > 0.0f && f53 < 1.0f) {
                canvas.save();
                float w11 = e2.c.w(1.0f, this.o, 0.1f, 0.9f);
                canvas.scale(w11, w11, width2, height2 - (AndroidUtilities.dp(8.0f) * this.o));
            }
            canvas.saveLayerAlpha(0.0f, 0.0f, this.H.getMeasuredWidth(), this.H.getMeasuredHeight(), (int) (org.telegram.messenger.y3.y(1.0f, this.o, 255.0f, f13) * this.x), 31);
        ...
        float f57 = this.C;
        float A = e2.c.A(1.0f - dp7, f57, dp7, f10);
        float f58 = i16 - f24;
        float f59 = 1.0f - f57;
        ...
        float f60 = f56 / 2.0f;
        org.telegram.ui.ActionBar.j6.u1.setBounds((int) (f24 - f60), (int) (f14 - f60), (int) (f24 + f60), (int) (f60 + f14));
