...
public final class pi0 extends FrameLayout {
    ...
    public final void a() {
        ...
        this.s = animatorSet2;
        animatorSet2.playTogether(ObjectAnimator.ofFloat(li0Var, (Property<li0, Float>) View.TRANSLATION_Y, AndroidUtilities.dp(10.0f) + li0Var.getMeasuredHeight()));
        if (this.E) {
            float measuredHeight = li0Var.getMeasuredHeight();
            this.s.setDuration(Math.max(60, (int) (((measuredHeight - li0Var.getTranslationY()) * 250.0f) / measuredHeight)));
            this.E = false;
        } else {
            this.s.setDuration(250L);
        }
        this.s.setInterpolator(qr.f);
        this.s.addListener(new oi0(this, 2));
            ...
            if (motionEvent == null || (!(motionEvent.getAction() == 0 || motionEvent.getAction() == 2) || this.f || this.e || motionEvent.getPointerCount() != 1)) {
                if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.d) {
                    ...
                    if (this.e && !this.f && y3 > 0.0f && y3 / 3.0f > Math.abs(abs) && Math.abs(y3) >= this.y) {
                        ...
                        float translationY = li0Var.getTranslationY() + y3;
                        li0Var.setTranslationY(translationY >= 0.0f ? translationY : 0.0f);
                        this.c = (int) motionEvent.getY();
                    }
                    ...
                    float translationY2 = li0Var.getTranslationY();
                    if (this.f || translationY2 != 0.0f) {
                        ...
                        if ((li0Var.getTranslationY() >= AndroidUtilities.getPixelsInCM(0.8f, false) || (yVelocity >= 3500.0f && Math.abs(yVelocity) >= Math.abs(xVelocity))) && (yVelocity >= 0.0f || Math.abs(yVelocity) < 3500.0f)) {
                            ...
                            this.h = animatorSet;
                            animatorSet.playTogether(ObjectAnimator.ofFloat(li0Var, (Property<li0, Float>) View.TRANSLATION_Y, 0.0f));
                            this.h.setDuration((int) ((Math.max(0.0f, r6) / AndroidUtilities.getPixelsInCM(0.8f, false)) * 150.0f));
                            this.h.setInterpolator(qr.g);
                            this.h.addListener(new oi0(this, i10));
                            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
                            this.h.start();
                        }
                        this.f = false;
                ...
                this.c = y10;
                if (y10 < li0Var.getTop() || this.b < li0Var.getLeft() || this.b > li0Var.getRight()) {
                    requestDisallowInterceptTouchEvent(true);
                    a();
                    return true;
                }
    ...
    */
    public final void c(boolean z10) {
        ...
        int i10 = (int) value;
        org.telegram.ui.jd0 jd0Var = this.I.b;
        ...
        if (iCircle != null) {
            ...
            if (z10) {
                ...
                onCreateLatLngBoundsBuilder.include(new IMapsProvider.LatLng(jd0Var.w0.getLatitude(), jd0Var.w0.getLongitude()));
                try {
                    ...
                    double d = max;
                    IMapsProvider.LatLng p02 = org.telegram.ui.jd0.p0(center, d, d);
                    double d10 = -max;
                    onCreateLatLngBoundsBuilder.include(org.telegram.ui.jd0.p0(center, d10, d10));
                    onCreateLatLngBoundsBuilder.include(p02);
                    IMapsProvider.ILatLngBounds build = onCreateLatLngBoundsBuilder.build();
                    try {
                        jd0Var.I.setPadding(AndroidUtilities.dp(70.0f), 0, AndroidUtilities.dp(70.0f), (int) ((jd0Var.R.getCustomView().getMeasuredHeight() - AndroidUtilities.dp(40.0f)) + jd0Var.S.getTranslationY()));
                        jd0Var.I.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngBounds(build, 0), 500, null);
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
        ...
        if (!DialogObject.isChatDialog(jd0Var.e0)) {
            int size = arrayList.size();
            for (int i11 = 0; i11 < size; i11++) {
                org.telegram.ui.dd0 dd0Var = (org.telegram.ui.dd0) arrayList.get(i11);
                if (dd0Var.b != null && !UserObject.isUserSelf(dd0Var.c)) {
                    TLRPC.GeoPoint geoPoint = dd0Var.b.media.geo;
                    Location location = new Location("network");
                    location.setLatitude(geoPoint.lat);
                    location.setLongitude(geoPoint._long);
                    if (jd0Var.w0.distanceTo(location) > i10) {
                    }
                }
            }
            z11 = false;
            if (z11 && user != null) {
                ...
                if (ni0Var.getTag() == null) {
                    ni0Var.setTag(1);
                    ni0Var.animate().setDuration(180L).alpha(0.0f).scaleX(0.5f).scaleY(0.5f).start();
            ...
            if (user != null) {
                ni0Var.setText(LocaleController.formatString("LocationNotifiationButtonGroup", R.string.LocationNotifiationButtonGroup, formatDistance));
            } else {
                ni0Var.setText(LocaleController.formatString("LocationNotifiationButtonUser", R.string.LocationNotifiationButtonUser, TextUtils.ellipsize(UserObject.getFirstName(user), ni0Var.getPaint(), Math.max(AndroidUtilities.dp(10.0f), (int) (((this.N - AndroidUtilities.dp(94.0f)) * 1.5f) - ((int) Math.ceil(ni0Var.getPaint().measureText(LocaleController.getString(R.string.LocationNotifiationButtonUser)))))), TextUtils.TruncateAt.END), formatDistance));
            }
            if (ni0Var.getTag() == null) {
                ni0Var.setTag(null);
                ni0Var.animate().setDuration(180L).alpha(1.0f).scaleX(1.0f).scaleY(1.0f).start();
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i20 = i13 - i11;
        li0 li0Var = this.v;
        int measuredHeight = i20 - li0Var.getMeasuredHeight();
        int i21 = i12 - i10;
        int measuredWidth = (i21 - li0Var.getMeasuredWidth()) / 2;
        li0Var.layout(measuredWidth, measuredHeight, li0Var.getMeasuredWidth() + measuredWidth, li0Var.getMeasuredHeight() + measuredHeight);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        li0 li0Var = this.v;
        li0Var.measure(View.MeasureSpec.makeMeasureSpec((this.x * 2) + size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_31));
        int childCount = getChildCount();
