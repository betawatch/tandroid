...
public final class y61 extends IUpdateLayout {
    ...
    public final void createUpdateUI(int i10) {
        ...
        this.a.setBackground(org.telegram.ui.ActionBar.h6.f0(1090519039, 2, -1));
    ...
    public final void updateAppUpdateViews(int i10, boolean z10) {
        ...
        if (ApplicationLoader.applicationLoaderInstance.getUpdate() == null) {
            ...
            this.a.setTag(null);
            if (z10) {
                this.a.animate().translationY(AndroidUtilities.dp(44.0f)).setInterpolator(rr.g).setListener(new fd0(this, 28)).setDuration(180L).start();
                return;
            } else {
                this.a.setTranslationY(AndroidUtilities.dp(44.0f));
        ...
        this.a.setTag(1);
        if (z10) {
            this.a.animate().translationY(0.0f).setInterpolator(rr.g).setListener(null).setDuration(180L).start();
        } else {
