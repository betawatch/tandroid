...
public final class ec0 extends View {
    ...
    public ec0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (f6Var instanceof org.telegram.ui.xn) {
            ...
            if ((xnVar.d() instanceof nc0) && (iArr = ((nc0) xnVar.d()).a) != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF = this.r;
        if (z10 && z11) {
            AndroidUtilities.lerp(((dc0) arrayList.get(floor)).c, ((dc0) arrayList.get(ceil)).c, f7 - floor, rectF);
        } else if (z10) {
            rectF.set(((dc0) arrayList.get(floor)).c);
        } else if (z11) {
            rectF.set(((dc0) arrayList.get(ceil)).c);
        }
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            dc0Var.b.c(dc0Var.c.left + this.h, getMeasuredHeight() / 2.0f, 1.0f, i0.a.d(1.0f - Math.abs(f7 - i10), this.d, this.e), canvas);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            f7 += ((dc0) arrayList.get(i12)).b.l() + this.h + this.h;
            i12++;
        }
        ...
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            float l4 = ((dc0) arrayList.get(i13)).b.l() + this.h + this.h;
            ((dc0) arrayList.get(i13)).c.set(f12, dp, f12 + l4, dp2);
            ((dc0) arrayList.get(i13)).d.set(((dc0) arrayList.get(i13)).c);
            ((dc0) arrayList.get(i13)).d.inset((-this.n) / 2.0f, -dp);
            f12 += l4 + this.n;
        }
        Drawable drawable = this.f;
        if (drawable != null) {
