...
public final class ec0 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.save();
        Bitmap e = e();
        float f10 = e != null ? bounds.top : this.f;
        ...
        boolean z4 = (Build.VERSION.SDK_INT < 28 || this.Q == null || this.k == null || e == null) ? false : true;
        int i12 = this.q;
        float f17 = 1.0f;
        Paint paint = this.n;
        Paint paint2 = this.o;
        ...
        if (i12 < 0) {
            ...
            if (e != null) {
                if (z10) {
                    ...
                    if (this.u != null) {
                        Bitmap e6 = e();
                        tg.a aVar = this.b0;
                        if (aVar.a(e6) || this.c0 == null || this.d0 != i13) {
                            ...
                            Utilities.applyAlphaInvert(e6, this.c0, i13);
                        }
                        aVar.b(e6);
                    }
            ...
            if (e != null) {
                ...
                if (z11) {
                    ...
                    jc0 jc0Var = this.Q;
                    RectF rectF2 = jc0Var.j;
                    rectF2.set(0.0f, 0.0f, jc0Var.g, jc0Var.h);
                    Matrix matrix = jc0Var.i;
    ...
    public final void z() {
        ...
        if (f10 < 1.0f) {
            ...
            if (z4) {
                ...
                mr mrVar = this.e;
                if (z12) {
                    float interpolation2 = mrVar.getInterpolation(f10);
                    char c3 = interpolation2 <= 0.25f ? (char) 0 : interpolation2 <= 0.5f ? (char) 1 : interpolation2 <= 0.75f ? (char) 2 : (char) 3;
                    ...
                    float interpolation3 = (this.D != null || this.d) ? this.h : mrVar.getInterpolation(this.h);
                    if (this.d && (interpolation3 == 0.0f || interpolation3 == 1.0f)) {
                        this.d = false;
                    }
                    if ((c3 == 0 && interpolation3 > 0.25f) || ((c3 == 1 && interpolation3 > 0.5f) || (c3 == 2 && interpolation3 > 0.75f))) {
                        if (this.E) {
                            int i11 = this.i + 1;
                            this.i = i11;
                            if (i11 > 7) {
                    ...
                    interpolation = (this.D != null || this.d) ? this.h : mrVar.getInterpolation(this.h);
