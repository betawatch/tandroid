...
public final class cz0 {
    ...
    public cz0(org.telegram.ui.ActionBar.f6 f6Var) {
        this.a = f6Var;
    }
    ...
    public final void b(MessageObject messageObject) {
        ...
        if (aVar != null && !aVar.k()) {
            arrayList.add(new bz0(new w01(LocaleController.getString(R.string.SuggestionOfferInfoPrice), textPaint), new w01(LocaleController.bold(of2.amount.f()), textPaint)));
        }
        if (suggestedPost.schedule_date > 0) {
            arrayList.add(new bz0(new w01(LocaleController.getString(R.string.SuggestionOfferInfoTime), textPaint), new w01(LocaleController.bold(LocaleController.formatDateTime(suggestedPost.schedule_date, true)), textPaint)));
        }
        ...
        while (i11 < size) {
            ...
            i11++;
            bz0 bz0Var = (bz0) obj;
            f10 = Math.max(f10, bz0Var.a.l());
            f11 = Math.max(f11, bz0Var.b.l());
            int j3 = ((int) bz0Var.a.j()) + this.g;
            this.g = j3;
        ...
        int D = org.telegram.messenger.l0.D(24.0f, 2, Math.max(dp, i19));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
