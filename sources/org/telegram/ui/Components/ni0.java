...
public final class ni0 extends Path {
    ...
    public ni0(final org.telegram.ui.Cells.t1 t1Var, int i10, int i11) {
        ...
        this.a = t1Var;
        final int i12 = 0;
        this.k = new c6(0.0f, new Runnable() { // from class: org.telegram.ui.Components.li0
    ...
    public final void b(Canvas canvas, float f7, float f10, Rect rect, float f11) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                uqVar.addRect(AndroidUtilities.lerp(rect.left - f7, mi0Var.a, d), AndroidUtilities.lerp(mi0Var.e ? rect.top - f10 : mi0Var.g, mi0Var.c, d), AndroidUtilities.lerp(rect.right - f7, mi0Var.b, d), AndroidUtilities.lerp(mi0Var.f ? rect.bottom - f10 : mi0Var.h, mi0Var.d, d), Path.Direction.CW);
                i10++;
            }
            uqVar.a();
        }
    ...
    public ni0(org.telegram.ui.Cells.t1 t1Var, ViewParent viewParent, int i10, ArrayList arrayList, int i11, int i12, float f7) {
        ...
        if (this.l.size() > 0) {
            ...
            mi0 mi0Var2 = (mi0) hg.c.h(1, this.l);
            mi0Var.e = true;
