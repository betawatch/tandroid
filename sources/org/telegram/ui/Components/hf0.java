...
public final class hf0 extends FrameLayout {
    ...
    private PointF getActualCenterPoint() {
        ...
        float f12 = vv0Var.a;
        return new PointF(f10, (this.e.y * f12) + org.telegram.messenger.q.y(f12, f11, 2.0f, A));
    }

    private float getActualInnerRadius() {
        vv0 vv0Var = this.d;
        return Math.min(vv0Var.a, vv0Var.b) * this.f;
    }

    private float getActualOuterRadius() {
        vv0 vv0Var = this.d;
        return Math.min(vv0Var.a, vv0Var.b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        vv0 vv0Var = this.d;
        float min = Math.min(vv0Var.a, vv0Var.b);
        ...
        if (i12 == 0) {
            ...
            if (c10 == 1) {
                ...
                float f19 = y3 - this.v;
                float width = (getWidth() - vv0Var.a) / 2.0f;
                int i13 = !z10 ? AndroidUtilities.statusBarHeight : 0;
                float height = getHeight();
                float f20 = vv0Var.b;
                float A = com.google.android.gms.internal.vision.e2.A(height, f20, 2.0f, i13);
                PointF pointF = new PointF(Math.max(width, Math.min(vv0Var.a + width, this.a.x + f18)), Math.max(A, Math.min(f20 + A, this.a.y + f19)));
                float f21 = pointF.x - width;
                float f22 = vv0Var.a;
                this.e = new PointF(f21 / f22, (((f22 - vv0Var.b) / 2.0f) + (pointF.y - A)) / f22);
            } else if (c10 == 2) {
            ...
            if (c11 == 1) {
                ...
                float f26 = y3 - this.v;
                float width2 = (getWidth() - vv0Var.a) / 2.0f;
                ...
                PointF pointF2 = new PointF(Math.max(width2, Math.min(vv0Var.a + width2, this.a.x + f25)), Math.max(A2, Math.min(f27 + A2, this.a.y + f26)));
                float f28 = pointF2.x - width2;
                float f29 = vv0Var.a;
                this.e = new PointF(f28 / f29, (((f29 - vv0Var.b) / 2.0f) + (pointF2.y - A2)) / f29);
            } else if (c11 == 2) {
