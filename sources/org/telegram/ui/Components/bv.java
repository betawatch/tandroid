...
public final class bv extends FrameLayout {
    ...
    public bv(lv lvVar, Context context) {
        ...
        mr mrVar = mr.h;
        this.s = new z5(this, 0L, 350L, mrVar);
        ...
        if (m3Var == null) {
            ...
            for (int i10 = 0; i10 < m3Var.getChildCount(); i10++) {
                ...
                if (childAt instanceof cv) {
                    u5VarArr2[i10] = ((cv) childAt).c;
                }
            }
            u5VarArr = u5VarArr2;
        }
        lvVar.b = u5.update(3, this, u5VarArr, (LongSparseArray<l5>) lvVar.b);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            ...
            int themedColor = lvVar.getThemedColor(i10);
            Paint paint = this.a;
            ...
            if (bool == null || z4 != bool.booleanValue()) {
                ...
                boolean z10 = AndroidUtilities.computePerceivedBrightness(lvVar.getThemedColor(i10)) > 0.721f;
                boolean z11 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(lvVar.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f;
                if (!z4) {
                    z10 = z11;
                }
                AndroidUtilities.setLightStatusBar(lvVar, z10);
            }
            org.telegram.ui.ActionBar.j6.t0.setColor(lvVar.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
            ...
            lvVar.r.setVisibility((m3Var.canScrollVertically(1) || lvVar.w.getVisibility() == 0) ? 0 : 4);
            if (m3Var != null) {
                canvas2.save();
                ...
                while (i12 < m3Var.getChildCount()) {
                    ...
                    if (childAt instanceof cv) {
                        ...
                        if (lvVar.b != null && (u5Var = cvVar.c) != null) {
                            l5 l5Var = (l5) lvVar.b.get(u5Var.getDocumentId());
                            if (l5Var != null) {
                ...
                while (true) {
                    ...
                    while (true) {
                        if (i14 >= arrayList5.size()) {
                            ...
                            if (((av) arrayList5.get(i14)).J == R) {
                                avVar = (av) arrayList5.get(i14);
                    ...
                    avVar2.a(canvas3, currentTimeMillis, getMeasuredWidth(), view.getMeasuredHeight() - view.getPaddingBottom(), 1.0f);
                    canvas2 = canvas3;
                    canvas2.restore();
                    i13++;
                }
                for (int i15 = 0; i15 < arrayList5.size(); i15++) {
                    if (arrayList2.size() < 3) {
                        arrayList2.add((av) arrayList5.get(i15));
                        ((av) arrayList5.get(i15)).K = null;
                        ((av) arrayList5.get(i15)).k();
                    } else {
                        ((av) arrayList5.get(i15)).f();
                    }
                }
                arrayList5.clear();
                canvas2.restore();
