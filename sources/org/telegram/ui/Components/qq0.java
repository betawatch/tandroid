...
public final class qq0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
        ...
        if (charSequence != null && charSequence.length() != 0) {
            ...
            if (arrayList != null || arrayList.isEmpty()) {
                ...
                if (this.b == 0) {
                    ...
                    pq0 pq0Var2 = this.E;
                    if (pq0Var2 != null) {
                        ((org.telegram.ui.sv) pq0Var2).g(0);
                        return;
                    }
                    return;
                }
            ...
            ((org.telegram.ui.sv) pq0Var).g(i13);
            return;
        }
        arrayList = null;
    ...
    public final void i(int i10, ArrayList arrayList) {
        ...
        ((org.telegram.ui.sv) pq0Var).g(i15);
    }
    ...
    public final void k() {
        ...
        oq0Var3.getClass();
        oq0Var3.animate().scaleX(0.8f).scaleY(0.8f).alpha(0.0f).translationY(-AndroidUtilities.dp(20.0f)).setInterpolator(nrVar).setDuration(320L).withEndAction(new nq0(oq0Var3, 0)).start();
    }
