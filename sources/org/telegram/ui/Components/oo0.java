...
public class oo0 extends FrameLayout {
    ...
    */
    public final void a(Canvas canvas, RectF rectF, Paint paint) {
        ...
        int i11 = oo0Var.e;
        float f10 = i11 / 2.0f;
        float measuredWidth = oo0Var.getMeasuredWidth() - (i11 / 2.0f);
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(oo0Var.V * 1.0f) / 2.0f;
        if (k0 == null) {
            k0 = new Path();
        }
        k0.reset();
        ...
        while (true) {
            i10 = -1;
            if (i12 >= oo0Var.S.size()) {
                i12 = -1;
                break;
            } else if (((Float) ((Pair) oo0Var.S.get(i12)).first).floatValue() >= dp3) {
                break;
            } else {
                i12++;
            }
        ...
        int size = oo0Var.S.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) oo0Var.S.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i10) {
            if (i13 == i12) {
                ...
                c10 = 0;
                floatValue = ((Float) ((Pair) oo0Var.S.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i10 ? 1.0f : ((Float) ((Pair) oo0Var.S.get(i13)).first).floatValue();
            while (i13 != i10 && i13 != 0) {
                c11 = 1;
                if (i13 >= oo0Var.S.size() - 1 || ((Float) ((Pair) oo0Var.S.get(i13)).first).floatValue() - floatValue > dp3) {
                    break;
                }
                i13++;
                floatValue2 = ((Float) ((Pair) oo0Var.S.get(i13)).first).floatValue();
            }
            c11 = 1;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f17 != f18) {
            if (f17 < f18) {
                ...
                f10 = 16.0f;
                f11 = 8.0f;
                float c10 = org.telegram.messenger.em.c(elapsedRealtime, 60.0f, AndroidUtilities.dp(1.0f), f17);
                this.F = c10;
                if (c10 < f18) {
                    this.F = f18;
                }
        ...
        float f21 = this.H;
        if (f21 < 1.0f) {
            float interpolation = 1.0f - pt.c.getInterpolation(Math.min(1.0f, f21 * 3.0f));
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            float interpolation3 = wr.f.getInterpolation(this.c0);
            canvas2.save();
    ...
    public oo0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.h = new d6(this, 0L, 60L, wr.g);
        this.r = -100.0f;
        this.s = -1.0f;
