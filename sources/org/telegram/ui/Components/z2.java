...
public final /* synthetic */ class z2 implements Utilities.Callback2 {
    ...
    public /* synthetic */ z2(int i10, long j3, TLRPC.Photo photo, Context context, ai.d dVar) {
        this.c = i10;
        this.d = j3;
        this.e = photo;
        this.b = context;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                ...
                new xc(lb.a(this.b), dVar).E(dVar).j();
                break;
            default:
                ...
                if (auction != null) {
                    ...
                    if (j10 != peerDialogId && j10 != 0 && peerDialogId != 0) {
                        ...
                        e.addView(new gi.a(context, user, user2), w7.y5.t(-1, -2, 48, 0, -4, 0, 0));
                        ...
                        org.telegram.ui.Cells.c1.n(i13, e6Var, textView, 1, 20.0f);
                        textView.setGravity(LocaleController.isRTL ? 5 : 3);
                        e.addView(textView, w7.y5.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 24.0f, 19.0f, 24.0f, 2.0f));
                        TextView textView2 = new TextView(context);
                        org.telegram.messenger.wh.m(i13, e6Var, textView2, 1, 16.0f);
                        org.telegram.messenger.wh.p(R.string.Gift2AuctionsChangeRecipient2, new Object[]{DialogObject.getShortName(peerDialogId), DialogObject.getShortName(j10)}, textView2);
    ...
    public /* synthetic */ z2(Context context, org.telegram.ui.ActionBar.e6 e6Var, int i10, long j3, Runnable runnable) {
        this.b = context;
        this.e = e6Var;
        this.c = i10;
        this.d = j3;
