...
public final /* synthetic */ class z2 implements Utilities.Callback2 {
            ...
            default:
                ...
                if (auction != null) {
                    ...
                    if (j10 != peerDialogId && j10 != 0 && peerDialogId != 0) {
                        ai.m8 m8Var = new ai.m8(context, i12, auction, j10, runnable);
    ...
    public /* synthetic */ z2(Context context, org.telegram.ui.ActionBar.d6 d6Var, int i10, long j3, Runnable runnable) {
        this.b = context;
        this.e = d6Var;
        this.c = i10;
        this.d = j3;
