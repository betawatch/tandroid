...
public final class bc0 extends Drawable {
        ...
        if (i12 < 0) {
            ...
            if (e != null) {
                ...
                if (z12) {
                    ...
                    gc0 gc0Var = this.Q;
                    RectF rectF2 = gc0Var.j;
                    rectF2.set(0.0f, 0.0f, gc0Var.g, gc0Var.h);
                    Matrix matrix = gc0Var.i;
    ...
    public bc0(boolean z10, int i10, int i11, int i12, int i13) {
        this(i10, i11, i12, i13, z10, 0, false);
    }

    public bc0(int i10, int i11, int i12, int i13, boolean z10, int i14, boolean z11) {
        this.a = new int[]{-12423849, -531317, -7888252, -133430};
        this.e = new rr(0.33d, 0.0d, 0.0d, 1.0d);
        this.h = 1.0f;
        this.j = new RectF();
