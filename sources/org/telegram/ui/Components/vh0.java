...
public class vh0 extends up implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View E(int i10) {
        ...
        sh0 sh0Var = rh0Var.b;
        return sh0Var == null ? rh0Var.c : sh0Var;
    }
            ...
            if (imageLocation3 == null || imageLocation3.location.local_id != imageLocation.location.local_id) {
                ...
                if (!isEmpty) {
                    ...
                    if (z4 && (dialogPhotos2 = this.P0) != null) {
                        dialogPhotos2.reset();
                        this.P0.loadAfter(getCurrentItem() - (uh0Var != null ? uh0Var.j() : 0), true);
                    }
                    return true;
                }
    ...
    public final void N(int i10, int i11) {
        ...
        uh0 uh0Var = this.A0;
        if (uh0Var != null) {
            for (int i12 = 0; i12 < uh0Var.c.size(); i12++) {
                if (((rh0) uh0Var.c.get(i12)).c != null) {
                    ph0 ph0Var = ((rh0) uh0Var.c.get(i12)).c;
                    int i13 = this.j1;
                    int i14 = this.k1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 != i14) {
            ...
            SparseArray sparseArray = vh0Var2.a1;
            if (i10 == i15) {
            ...
            if (i10 != NotificationCenter.fileLoadProgressChanged) {
                if (i10 == NotificationCenter.reloadDialogPhotos && vh0Var2.Z0 == 0 && (dialogPhotos = vh0Var2.P0) != null) {
                    dialogPhotos.reset();
                    MessagesController.DialogPhotos dialogPhotos2 = vh0Var2.P0;
                    int currentItem = vh0Var2.getCurrentItem();
                    uh0 uh0Var = vh0Var2.A0;
                    dialogPhotos2.loadAfter(currentItem - (uh0Var != null ? uh0Var.j() : 0), true);
                    return;
                }
                return;
            }
        ...
        if (vh0Var2.P0 == dialogPhotos3) {
            ArrayList arrayList7 = new ArrayList(dialogPhotos3.photos);
            if (!arrayList7.isEmpty() || !dialogPhotos3.fromCache) {
                vh0Var2.g1 = -1;
                vh0Var2.h1 = -1;
                int i18 = vh0Var2.I0;
                TLRPC.User user4 = MessagesController.getInstance(i18).getUser(Long.valueOf(vh0Var2.B0));
                TLRPC.UserFull userFull = MessagesController.getInstance(i18).getUserFull(vh0Var2.B0);
                ...
                if (DialogObject.isChatDialog(vh0Var2.B0)) {
                    TLRPC.Chat chat = MessagesController.getInstance(i18).getChat(Long.valueOf(-vh0Var2.B0));
                    ...
                    if (imageLocation != null) {
                        ...
                        if (chatFull == null || !FileLoader.isSamePhoto((TLRPC.FileLocation) imageLocation.location, chatFull.chat_photo)) {
                            ...
                            if (vh0Var2.C0.chat_photo.video_sizes.isEmpty()) {
                                ...
                                TLRPC.VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(vh0Var2.C0.chat_photo.video_sizes, MediaDataController.MAX_STYLE_RUNS_COUNT);
                        ...
                        if (closestPhotoSizeWithSize2 != null) {
                            ...
                            if (forPhoto != null) {
                                ...
                                if (imageLocation3 == null) {
                                    arrayList14 = arrayList4;
                                    user2 = user;
                                } else if (imageLocation3.photoId != forPhoto.photoId || z4 || vh0Var2.B0 == UserConfig.getInstance(i12).getClientUserId()) {
                                    user2 = user;
                                    arrayList14 = arrayList4;
                                } else {
                                    arrayList5.add(null);
                ...
                ImageLocation imageLocation5 = vh0Var.n1;
                if (imageLocation5 != null) {
                    vh0Var.A(imageLocation5, vh0Var.o1);
                }
            }
        }
    }
    ...
    public p9 getCurrentItemView() {
        uh0 uh0Var = this.A0;
        if (uh0Var == null || uh0Var.c.isEmpty()) {
            return null;
        }
        return ((rh0) uh0Var.c.get(getCurrentItem())).c;
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        mh0 mh0Var = this.m1;
        if (mh0Var != null) {
            mh0Var.setTranslationY(getHeight() - this.m1.getMeasuredHeight());
        }
    }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (uh0Var != null) {
            ...
            org.telegram.ui.vu0 vu0Var = this.e1;
            qh0 qh0Var = this.D0;
            if (vu0Var != null && getCurrentItemView() != null) {
                if (action != 0 && this.F0) {
                    org.telegram.ui.vu0 vu0Var2 = this.e1;
                    if (!vu0Var2.n) {
                        vu0Var2.a(MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0), this, getCurrentItemView().getImageReceiver(), null, 0);
                    }
                }
            ...
            if (action == 0) {
                ...
                if (uh0Var.c.size() > 1 && qh0Var != null) {
                    qh0Var.b(motionEvent.getX() < ((float) getWidth()) / 3.0f);
                }
                this.F0 = false;
            } else if (action == 1) {
                if (!this.F0) {
                    ...
                    if (realCount > 1) {
                        if (motionEvent.getX() > getWidth() / 3.0f) {
                            ...
                            i10 = i12 < uh0Var.j() ? (realCount + r0) - 1 : i12;
                        }
                        if (qh0Var != null) {
                            qh0Var.a();
                        }
    ...
    public vh0(Context context, long j10, org.telegram.ui.ActionBar.k kVar, sl0 sl0Var, org.telegram.ui.tz0 tz0Var, qh0 qh0Var, mh0 mh0Var) {
        ...
        this.h1 = -1;
        this.m1 = mh0Var;
        setPadding(0, 0, 0, mh0Var == null ? 0 : mh0Var.n);
        if (mh0Var != null) {
            mh0Var.setView(this);
        }
        setVisibility(8);
