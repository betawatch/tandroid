...
public final class hj0 extends FrameLayout {
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        ig.q0 d = ig.q0.d(reactionCount.reaction);
        this.v = d;
        String str = d.f;
        ImageView imageView = this.e;
        n9 n9Var = this.d;
        if (str == null) {
            n9Var.setAnimatedEmojiDrawable(new k5(0, i10, this.v.g));
        ...
        for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
            if (tL_availableReaction.reaction.equals(this.v.f)) {
                n9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.g6.a7, 1.0f), tL_availableReaction);
                n9Var.setVisibility(0);
                imageView.setVisibility(8);
                return;
            }
    ...
    public void setOutlineProgress(float f10) {
        ...
        int k10 = i0.b.k(org.telegram.ui.ActionBar.g6.w0(null, i10, false), 16);
        int i11 = org.telegram.ui.ActionBar.g6.Fj;
        int d = i0.b.d(f10, org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.Ej, false), org.telegram.ui.ActionBar.g6.w0(null, i11, false));
        this.a.setColor(i0.b.d(f10, k10, w02));
        ...
        if (f10 == 1.0f) {
            int i12 = (int) f11;
            int k11 = i0.b.k(org.telegram.ui.ActionBar.g6.w0(null, i11, false), 76);
            view.setBackground(org.telegram.ui.ActionBar.g6.i0(i12, i12, i12, i12, 0, k11, k11));
        } else if (f10 == 0.0f) {
            int i13 = (int) f11;
            int k12 = i0.b.k(w02, 76);
            view.setBackground(org.telegram.ui.ActionBar.g6.i0(i13, i13, i13, i13, 0, k12, k12));
        }
        invalidate();
    }
}
