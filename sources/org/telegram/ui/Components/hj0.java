...
public class hj0 extends BitmapDrawable implements Animatable, yf.c {
    ...
    */
    public hj0(File file, String str, int i10, int i11, b2.n1 n1Var, boolean z10, int i12, boolean z11) {
        ...
        this.i0 = new RectF[2];
        this.j0 = new Paint[2];
        this.v0 = new gj0(this, 1);
        this.w0 = new gj0(this, 2);
        this.y0 = new gj0(this, 3);
        this.z0 = new gj0(this, 4);
        this.F0 = new gj0(this, 5);
    ...
    public static void e(hj0 hj0Var) {
        if (hj0Var.l0 || hj0Var.V || !hj0Var.k() || hj0Var.O != null) {
            return;
        }
        hj0Var.x0 = true;
        if (T0 == null) {
    ...
    public static void f(hj0 hj0Var) {
        ...
        if (i10 == 1) {
            hj0Var.G0 = 0;
            AndroidUtilities.runOnUIThread(hj0Var.w0);
        } else if (i10 == 2) {
            AndroidUtilities.runOnUIThread(hj0Var.v0, hj0Var.G0);
            hj0Var.G0 = Math.min((Math.max(hj0Var.G0, 2) * 3) / 2, 2000);
        } else if (i10 == 3) {
            AndroidUtilities.runOnUIThread(hj0Var.v0);
        }
        CountDownLatch countDownLatch = hj0Var.U;
    ...
    public static void h(hj0 hj0Var) {
        hj0Var.X = true;
        if ((!hj0Var.k0 && hj0Var.W) || (hj0Var.Q == null && hj0Var.R != null)) {
            hj0Var.x();
        }
        hj0Var.p();
    }
    ...
    public void D(boolean z10) {
        ...
        this.m0 = null;
        if (rLottieNative != null) {
            jc0 jc0Var = new jc0(rLottieNative, 15);
            if (z10) {
