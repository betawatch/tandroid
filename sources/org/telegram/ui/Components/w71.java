...
public final class w71 {
    ...
    public final void a(Canvas canvas, View view) {
        ...
        if (f16 != 1.0f) {
            ...
            if (f17 >= 1.0f) {
                ...
                view.invalidate();
                float interpolation = qr.f.getInterpolation(this.C);
        ...
        if (this.t != dp) {
            ...
            if (f25 < dp) {
                ...
                c10 = 0;
                float b10 = org.telegram.messenger.wh.b(j3, 60.0f, AndroidUtilities.dp(1.0f), f25);
                this.t = b10;
                if (b10 < dp) {
                    this.t = dp;
                }
        ...
        float interpolation2 = qr.f.getInterpolation(this.M);
        canvas.save();
        int i15 = this.i;
        ...
        if (this.K[c10] != null) {
            ...
            this.L.setAlpha((int) (org.telegram.messenger.q.A(1.0f, this.y, 255.0f, interpolation2) * this.I));
    ...
    */
    public final void b(Canvas canvas, RectF rectF, Paint paint) {
        ...
        char c11;
        w71 w71Var = this;
        float dp = AndroidUtilities.dp(AndroidUtilities.lerp(2, 1, w71Var.y));
        ArrayList arrayList = w71Var.F;
        if (arrayList == null || arrayList.isEmpty()) {
            canvas.drawRoundRect(rectF, dp, dp, paint);
            return;
        }
        float f7 = rectF.bottom;
        float lerp = AndroidUtilities.lerp(S / 2.0f, 0.0f, w71Var.y) + w71Var.z;
        float lerp2 = AndroidUtilities.lerp(w71Var.h - (S / 2.0f), w71Var.v.getWidth() - (w71Var.z * 2.0f), w71Var.y) + w71Var.z;
        AndroidUtilities.rectTmp.set(rectF);
        float dp2 = AndroidUtilities.dp(w71Var.I * 1.0f) / 2.0f;
        if (U == null) {
            U = new Path();
        }
        U.reset();
        ...
        while (true) {
            i10 = -1;
            if (i11 >= w71Var.F.size()) {
                i11 = -1;
                break;
            } else if (((Float) ((Pair) w71Var.F.get(i11)).first).floatValue() >= dp3) {
                break;
            } else {
                i11++;
            }
        ...
        int size = w71Var.F.size() - 1;
        while (true) {
            if (size < 0) {
                break;
            }
            if (1.0f - ((Float) ((Pair) w71Var.F.get(size)).first).floatValue() >= dp3) {
                i10 = size + 1;
                break;
            }
            size--;
        ...
        while (i13 <= i12) {
            if (i13 == i11) {
                ...
                c10 = 1;
                floatValue = ((Float) ((Pair) w71Var.F.get(i13 - 1)).first).floatValue();
            }
            float floatValue2 = i13 == i12 ? 1.0f : ((Float) ((Pair) w71Var.F.get(i13)).first).floatValue();
            while (i13 != i12 && i13 != 0 && i13 < w71Var.F.size() - 1 && ((Float) ((Pair) w71Var.F.get(i13)).first).floatValue() - floatValue <= dp3) {
                i13++;
                floatValue2 = ((Float) ((Pair) w71Var.F.get(i13)).first).floatValue();
            }
