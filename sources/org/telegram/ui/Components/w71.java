...
public final class w71 extends View {
    ...
    public final void b(int i10) {
        ...
        this.w = t71Var;
        t71Var.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, Integer.valueOf(i10), null, null);
    }
        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.f) {
                    ...
                    if (v71Var5 != null) {
                        float f15 = this.b;
                        ChatActivityEnterView chatActivityEnterView = ((bf) v71Var5).a;
                ...
                if (this.h) {
                    ...
                    if (v71Var6 != null) {
                        float f21 = this.c;
                        ChatActivityEnterView chatActivityEnterView2 = ((bf) v71Var6).a;
    ...
    public void setDelegate(v71 v71Var) {
        this.s = v71Var;
    }
    ...
    public void setTimeHintView(u71 u71Var) {
        this.P = u71Var;
    }
