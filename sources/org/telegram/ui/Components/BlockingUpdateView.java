...
public abstract class BlockingUpdateView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BlockingUpdateView(final Context context) {
        ...
        addView(this.scrollView, LayoutHelper.createFrame(-1, -1.0f, 51, 27.0f, i2 + NotificationCenter.dialogFiltersUpdated, 27.0f, 130.0f));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$show$3(final TLObject tLObject, TLRPC.TL_error tL_error) {
