...
public final class qy0 {
    ...
    public qy0(org.telegram.ui.ActionBar.f6 f6Var) {
        this.a = f6Var;
    }
    ...
    public final void b(MessageObject messageObject) {
        ...
        if (aVar != null && !aVar.k()) {
            arrayList.add(new py0(new h01(LocaleController.getString(R.string.SuggestionOfferInfoPrice), textPaint), new h01(LocaleController.bold(of2.amount.f()), textPaint)));
        }
        if (suggestedPost.schedule_date > 0) {
            arrayList.add(new py0(new h01(LocaleController.getString(R.string.SuggestionOfferInfoTime), textPaint), new h01(LocaleController.bold(LocaleController.formatDateTime(suggestedPost.schedule_date, true)), textPaint)));
        }
        ...
        while (i11 < size) {
            ...
            i11++;
            py0 py0Var = (py0) obj;
            f10 = Math.max(f10, py0Var.a.l());
            f11 = Math.max(f11, py0Var.b.l());
            int j3 = ((int) py0Var.a.j()) + this.g;
            this.g = j3;
