...
public abstract class qy0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final long a() {
        ...
        for (int i10 = 0; i10 < this.b.length; i10++) {
            ...
            py0 py0Var = this.b[i10];
            if (py0Var != null && (py0Var.c || f7 > 0)) {
                if (f7 <= 0) {
                    f7 = py0Var.e;
                }
                j3 += f7;
    ...
    public final void c(boolean z10) {
        ...
        for (int i11 = 0; i11 < py0VarArr.length; i11++) {
            ...
            if (py0Var2 != null && (py0Var2.c || f12 > 0)) {
                this.y++;
            }
            if (py0Var2 == null || (!(z11 = py0Var2.c) && f12 <= 0)) {
                this.d[i11] = 0.0f;
            } else {
                if (f12 <= 0) {
                    f12 = py0Var2.e;
        ...
        if (f10 > 1.0f) {
            float f14 = 1.0f / f10;
            for (int i12 = 0; i12 < py0VarArr.length; i12++) {
                if (py0VarArr[i12] != null) {
                    float[] fArr = this.d;
        ...
        if (!z10) {
            System.arraycopy(this.d, 0, this.c, 0, py0VarArr.length);
            return;
        }
        System.arraycopy(this.c, 0, this.e, 0, py0VarArr.length);
            ...
            if (py0Var != null) {
                ...
                if (f18 != 0.0f) {
                    if (py0Var.d) {
                        ...
                        py0Var.b.setColor(org.telegram.ui.ActionBar.j6.w0(null, py0Var.a, z11));
            ...
            if (py0Var2 != null) {
                ...
                if (f20 != 0.0f) {
                    if (py0Var2.d) {
                        ...
                        py0Var2.b.setColor(org.telegram.ui.ActionBar.j6.w0(null, py0Var2.a, false));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.v != null) {
            ...
            this.x = ww0.d(charSequence, textPaint, size, false, size, 1);
        }
        if (imageReceiver != null) {
