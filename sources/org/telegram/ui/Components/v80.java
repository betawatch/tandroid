...
public abstract class v80 extends LinearLayout {
    ...
    public v80(Context context, TLRPC.Chat chat) {
        ...
        final int i10 = 0;
        w8Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.s80
        ...
        final int i11 = 1;
        w8Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.s80
            public final /* synthetic */ v80 b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (w8Var.getVisibility() == 0) {
            measuredHeight = (w8Var2.getMeasuredHeight() * this.s) + w8Var.getMeasuredHeight() + m4Var.getMeasuredHeight();
        } else {
    ...
    public void setJoinToSend(boolean z10) {
        ...
        this.r.addListener(new r8(this, 27));
