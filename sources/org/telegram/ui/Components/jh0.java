...
public final class jh0 extends View {
    ...
    public final void g() {
        ...
        RadialGradient radialGradient = new RadialGradient(max / 2.0f, this.y / 2.0f, this.O ? max * 0.65f : 1.0f, org.telegram.ui.ActionBar.j6.l1(0.8f, this.N), this.N, Shader.TileMode.CLAMP);
    ...
    public final gh0 k(int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                j10 = new gh0(this, hh0.n);
                j10.t = true;
                j10.x = 200;
                break;
            case 4:
                j10 = new gh0(this, hh0.r);
                break;
            case 5:
                j10 = new gh0(this, hh0.s);
                this.H = j10;
                j10.t = true;
                j10.x = 500;
                break;
            case 6:
                ...
                break;
            case 7:
                j10 = new gh0(this, hh0.w);
                j10.t = true;
                j10.v = 300;
                break;
            case 8:
                j10 = new gh0(this, hh0.x);
                j10.t = true;
                j10.x = 500;
                break;
            case 9:
                j10 = new gh0(this, hh0.y);
                j10.t = true;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        float f22 = 2.0f;
        while (i13 < size) {
            gh0 gh0Var5 = (gh0) arrayList.get(i13);
            boolean z11 = gh0Var5.p;
            float f23 = max;
            rc rcVar = gh0Var5.b;
            float f24 = f21;
            ...
            if (z11) {
                ...
                z5 z5Var = gh0Var5.e;
                f14 = f19;
                RectF rectF2 = gh0Var5.c;
                float f25 = f20;
                jh0 jh0Var = gh0Var5.y;
                f15 = itemWidth;
                RectF rectF3 = gh0Var5.f;
                i11 = i13;
                RectF rectF4 = gh0Var5.g;
                gh0 gh0Var6 = gh0Var3;
                if (gh0Var5.o) {
                    gh0Var5.a();
                } else {
                    boolean z12 = jh0Var.e;
                    float f26 = jh0Var.K;
                    if (z12) {
                        gh0Var5.n = false;
                        rectF2.set(rectF);
                        ...
                        if (rectF3.isEmpty()) {
                            ...
                            boolean z14 = rectF.right + 1.0f >= ((float) jh0Var.getMeasuredWidth()) - f26;
                            if (z13 && z14) {
                                gh0Var = gh0Var4;
                            } else {
                                z10 = z14;
                                gh0 gh0Var7 = jh0Var.I;
                                if (gh0Var7 != null) {
                                    gh0Var = gh0Var4;
                                } else {
                                    gh0Var = gh0Var4;
                                }
                                gh0 gh0Var8 = jh0Var.J;
                                if (gh0Var8 != null) {
                                }
                                i12 = gh0Var5.a;
                                if (((i12 != 5 && i12 != 6) || jh0Var.E != 0) && ((i12 != 3 && i12 != 2) || jh0Var.E != 1)) {
                                    if (!z13 && (gh0Var2 = jh0Var.I) != null && !gh0Var2.o) {
                                        z10 = true;
                                        z13 = false;
                                    } else if (z10) {
                                        gh0 gh0Var9 = jh0Var.J;
                                        if (gh0Var9 != null) {
                                        }
                                    }
                                    if (!z13) {
        ...
        int i14 = 0;
        while (i14 < size) {
            gh0 gh0Var10 = (gh0) arrayList.get(i14);
            boolean z15 = gh0Var10.p;
            rc rcVar2 = gh0Var10.b;
            RectF rectF6 = gh0Var10.d;
            if (z15) {
                f13 = clamp012;
                i10 = i14;
            } else {
                ...
                float b10 = (int) (gh0Var10.b() * clamp012 * alpha);
                ...
                if (!SharedConfig.shadowsInSections || AndroidUtilities.computePerceivedBrightness(this.N) <= 0.72f || this.d >= 0.5f) {
                    ...
                    f13 = clamp012;
                    paint.setShadowLayer(AndroidUtilities.dpf2(1.5f), 0.0f, 0.0f, org.telegram.ui.ActionBar.j6.l1((b10 / 255.0f) * (this.P != null ? 0.1f : 1.0f), TLObject.FLAG_29));
                }
                canvas.drawRoundRect(rectF7, roundRadius, roundRadius, paint);
                if (this.P != null) {
                    Paint paint2 = this.c;
                    int alpha2 = paint2.getAlpha();
                    paint2.setAlpha((int) (gh0Var10.b() * f13 * alpha2));
        ...
        if (renderNode2 != null && Build.VERSION.SDK_INT >= 29 && renderNode2.hasDisplayList() && canvas.isHardwareAccelerated()) {
            canvas.save();
            org.telegram.ui.tz0 tz0Var = this.r;
            if (tz0Var != null) {
                View view = (View) tz0Var.getParent();
                float x10 = view.getX();
        ...
        if (clamp013 > 0.0f) {
            int i15 = 0;
            while (i15 < size) {
                gh0 gh0Var11 = (gh0) arrayList.get(i15);
                if (gh0Var11 != null) {
                    Rect rect = gh0Var11.h;
                    RectF rectF8 = gh0Var11.d;
                    if (!gh0Var11.p) {
                        boolean z16 = AndroidUtilities.computePerceivedBrightness(this.N) > 0.72f;
                        float a2 = (!z16 || Build.VERSION.SDK_INT >= 31) ? !z16 ? 1.0f : k7.n.a((this.d - 0.75f) / 0.25f, 0.0f, 1.0f) : 0.0f;
                        ...
                        canvas.save();
                        float b11 = gh0Var11.b() * clamp013;
                        float centerX2 = rectF8.centerX();
                        float centerY = rectF8.centerY();
                        float f31 = a2;
                        f11 = clamp01;
                        float a10 = gh0Var11.b.a(0.04f) * f11;
                        ...
                        float f32 = dp * 0.5f;
                        gh0Var11.l.q(rectF8.width() - AndroidUtilities.dp(f22));
                        gh0Var11.m = gh0Var11.l.b.getLineCount() >= 3 ? 0.75f : gh0Var11.l.b.getLineCount() >= 2 ? 0.85f : 1.0f;
                        float max2 = Math.max(0.0f, AndroidUtilities.dpf2(1.33f) + e2.c.d(gh0Var11.l.j(), gh0Var11.m, f27, 3.0f));
                        rect.set((int) (centerX3 - f32), (int) max2, (int) (centerX3 + f32), (int) (max2 + dp));
                        gj0 gj0Var = gh0Var11.k;
                        if (gj0Var != null) {
                            gj0Var.setBounds(rect);
                        }
                        Drawable drawable = gh0Var11.i;
                        if (drawable != null) {
                            drawable.setBounds(rect);
                        }
                        Drawable drawable2 = gh0Var11.j;
                        if (drawable2 != null) {
                            drawable2.setBounds(rect);
                        }
                        float j10 = ((rect.bottom + rect.top) - ((gh0Var11.l.j() * gh0Var11.m) / f22)) - AndroidUtilities.dp(4.66f);
                        canvas.save();
                        float f33 = gh0Var11.m;
                        f10 = f27;
                        canvas.scale(f33, f33, centerX2, android.support.v4.media.a.d(gh0Var11.l.j(), gh0Var11.m, 2.0f, j10));
                        k01 k01Var = gh0Var11.l;
                        k01Var.c(centerX2 - (k01Var.l() / 2.0f), j10, b11, d, canvas);
                        canvas.restore();
                        float f34 = gh0Var11.q;
                        if (f34 != 1.0f) {
                            canvas.scale(f34, f34, rect.centerX(), rect.centerY());
                        }
                        float f35 = (1.0f - f31) * b11;
                        float f36 = f31 * b11;
                        gj0 gj0Var2 = gh0Var11.k;
                        if (gj0Var2 == null) {
                            h(canvas, gh0Var11.j, f35);
                            h(canvas, gh0Var11.i, f36);
                        } else if (gh0Var11.a == 1) {
                            h(canvas, gh0Var11.j, f35);
                            h(canvas, gh0Var11.k, f36);
                        } else {
                            h(canvas, gj0Var2, b11);
                        }
                        canvas.restore();
                        if (gh0Var11.x > 0 && System.currentTimeMillis() > gh0Var11.x + gh0Var11.w) {
                            gh0Var11.s = false;
                        }
                        if (gh0Var11.s) {
                            i90 i90Var = gh0Var11.r;
                            if (i90Var == null) {
                                i90 i90Var2 = new i90();
                                gh0Var11.r = i90Var2;
                                i90Var2.setCallback(this);
                                gh0Var11.r.f(org.telegram.ui.ActionBar.j6.l1(0.1f, -1), org.telegram.ui.ActionBar.j6.l1(0.3f, -1), org.telegram.ui.ActionBar.j6.l1(0.35f, -1), org.telegram.ui.ActionBar.j6.l1(0.8f, -1));
                                i90 i90Var3 = gh0Var11.r;
                                i90Var3.C = true;
                                i90Var3.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                            } else if (i90Var.b() || gh0Var11.r.c()) {
                                i90 i90Var4 = gh0Var11.r;
                                f12 = clamp013;
                                i90Var4.b = -1L;
                                i90Var4.c = -1L;
                            }
                            ...
                            f12 = clamp013;
                            i90 i90Var5 = gh0Var11.r;
                            if (i90Var5 != null && !i90Var5.c() && !gh0Var11.r.b()) {
                                gh0Var11.r.a();
                            }
                        }
                        i90 i90Var6 = gh0Var11.r;
                        if (i90Var6 != null) {
                            i90Var6.d(rectF8);
                            gh0Var11.r.h(getRoundRadius());
                            gh0Var11.r.setAlpha((int) (b11 * 255.0f));
                            gh0Var11.r.draw(canvas);
                        }
                        i15++;
                        clamp013 = f12;
                        f27 = f10;
        ...
        if (this.B >= AndroidUtilities.dp(8.0f)) {
            ...
            if (action == 0) {
                ...
                while (true) {
                    ...
                    if (!gh0Var2.o && gh0Var2.d.contains(x10, y10)) {
                        this.T = gh0Var2;
                        this.U = x10;
                        this.V = y10;
                ...
                if (action == 1 && this.T.d.contains(x10, y10)) {
                    ...
                    if (ih0Var != null) {
                        ...
                        if (i12 == 0) {
                            int i13 = gh0Var5.a;
                            RectF rectF = gh0Var5.d;
                            ProfileActivity.Y(((org.telegram.ui.px0) ih0Var).b, i13, rectF.left, rectF.top);
                        } else {
    ...
    public final void p(gh0 gh0Var, boolean z4) {
        if (!z4) {
            hh0 hh0Var = this.G ? hh0.e : hh0.f;
            gh0Var.d(0, hh0Var.b, hh0Var.c);
            gh0Var.c(LocaleController.getString(hh0Var.a));
        } else if (this.G) {
            hh0 hh0Var2 = hh0.e;
            gh0Var.c(LocaleController.getString(hh0Var2.a));
            gh0Var.d(R.raw.profile_unmuting, hh0Var2.b, hh0Var2.c);
        } else {
            hh0 hh0Var3 = hh0.f;
            gh0Var.c(LocaleController.getString(hh0Var3.a));
            gh0Var.d(R.raw.profile_muting, hh0Var3.b, hh0Var3.c);
        }
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || (drawable instanceof i90);
    }
}
