...
public final class jh0 extends w9 implements mv0 {
    public final int G;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.iv0 iv0Var = ph0Var.h1;
        if (iv0Var == null || !iv0Var.n) {
            if (this.H != null) {
                ...
                if (k10 >= arrayList.size() || arrayList.get(k10) == null ? drawable == null || (this.L && (!(drawable instanceof d6) || ((d6) drawable).d[4] <= 0)) : ((Float) arrayList.get(k10)).floatValue() < 1.0f) {
                    ...
                    this.I.addUpdateListener(new i70(this, i10));
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (this.H != null) {
            ...
            radialProgress2.q((i10 - i14) / 2, hg.c.C(i15, i14, 2, currentActionBarHeight), (i10 + i14) / 2, ((i15 + i14) / 2) + currentActionBarHeight);
        }
    }
