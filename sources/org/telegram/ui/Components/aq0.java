...
public final /* synthetic */ class aq0 implements Runnable {
    ...
    public /* synthetic */ aq0(dq0 dq0Var, int i10, String str) {
        this.a = 1;
        this.b = dq0Var;
        this.c = i10;
        this.d = str;
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                dq0 dq0Var3 = this.b;
                dq0Var3.f = null;
                i10 = ((org.telegram.ui.ActionBar.f3) dq0Var3.K).currentAccount;
                DispatchQueue storageQueue = MessagesStorage.getInstance(i10).getStorageQueue();
                String str = this.d;
                int i18 = this.c;
                storageQueue.postRunnable(new aq0(dq0Var3, str, i18, 2));
                aq0 aq0Var = new aq0(dq0Var3, i18, str);
                dq0Var3.h = aq0Var;
                AndroidUtilities.runOnUIThread(aq0Var);
                break;
            case 1:
                dq0 dq0Var4 = this.b;
                dq0Var4.h = null;
                ...
                int i20 = this.c;
                if (i20 == i19) {
                    dq0Var4.e.g(this.d, true, true, true, true, 0L, false, 0, i20);
                    break;
                }
                break;
            default:
                ...
                int i21 = this.c;
                dq0 dq0Var5 = this.b;
                hq0 hq0Var2 = dq0Var5.K;
                try {
                    String lowerCase = str2.trim().toLowerCase();
                    if (lowerCase.length() == 0) {
                        dq0Var5.r = -1;
                        AndroidUtilities.runOnUIThread(new org.telegram.ui.dm(dq0Var5, dq0Var5.r, new ArrayList(), 10));
                        break;
                    } else {
                        ...
                        a0.i iVar = new a0.i();
                        i11 = ((org.telegram.ui.ActionBar.f3) hq0Var2).currentAccount;
                        ...
                        while (queryFinalized.next()) {
                            ...
                            vp0 vp0Var = new vp0();
                            vp0Var.c = queryFinalized.intValue(1);
                            iVar.k(vp0Var, longValue);
                        ...
                        if (arrayList.isEmpty()) {
                            ...
                            i16 = ((org.telegram.ui.ActionBar.f3) hq0Var2).currentAccount;
                                            ...
                                            if (!stringValue.contains(" " + str3)) {
                                                ...
                                                if (r12 == 0) {
                                                    ...
                                                    if (byteBufferValue != null) {
                                                        ...
                                                        int i27 = i21;
                                                        dq0Var2 = dq0Var5;
                                                        vp0 vp0Var2 = (vp0) iVar.f(TLdeserialize.id);
                                                        ...
                                                        if (r12 == z10) {
                                                            vp0Var2.d = AndroidUtilities.generateSearchName(TLdeserialize.first_name, TLdeserialize.last_name, str3);
                                                        } else {
                                                            vp0Var2.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize), null, "@" + str3);
                                                        }
                                                        vp0Var2.b = TLdeserialize;
                                                        vp0Var2.a.id = TLdeserialize.id;
                                                        i23 = i24 + 1;
                                                    }
                                                } else {
                                                    i25 = i26 + 1;
                                ...
                                for (int i28 = 0; i28 < i22; i28++) {
                                    ...
                                    if (byteBufferValue2 != null) {
                                        ...
                                        if (TLdeserialize2 != null && !ChatObject.isNotInChat(TLdeserialize2) && (!ChatObject.isChannel(TLdeserialize2) || TLdeserialize2.creator || (((tL_chatAdminRights = TLdeserialize2.admin_rights) != null && tL_chatAdminRights.post_messages) || TLdeserialize2.megagroup))) {
                                            vp0 vp0Var3 = (vp0) iVar.f(-TLdeserialize2.id);
                                            vp0Var3.d = AndroidUtilities.generateSearchName(TLdeserialize2.title, null, str4);
                                            vp0Var3.b = TLdeserialize2;
                                            vp0Var3.a.id = -TLdeserialize2.id;
                                            i13++;
                                        }
                                    }
                                }
                        ...
                        for (int i29 = 0; i29 < iVar.m(); i29++) {
                            vp0 vp0Var4 = (vp0) iVar.n(i29);
                            if (vp0Var4.b != null && vp0Var4.d != null) {
                                arrayList3.add(vp0Var4);
                            }
                        }
                                            ...
                                            if (!stringValue3.contains(" " + str5)) {
                                                ...
                                                if (c10 == 0) {
                                                    ...
                                                    if (byteBufferValue3 != null) {
                                                        ...
                                                        vp0Var5.a.id = TLdeserialize3.id;
                                                        vp0Var5.b = TLdeserialize3;
                                                        if (c10 == 1) {
                                                            vp0Var5.d = AndroidUtilities.generateSearchName(TLdeserialize3.first_name, TLdeserialize3.last_name, str5);
                                                        } else {
                                                            vp0Var5.d = AndroidUtilities.generateSearchName("@" + UserObject.getPublicUsername(TLdeserialize3), null, "@" + str5);
                                                        }
                                                        arrayList3.add(vp0Var5);
                                                    }
                                                } else {
                                                    i30++;
                                                }
                        ...
                        Collections.sort(arrayList3, new org.telegram.ui.f6(18));
                        AndroidUtilities.runOnUIThread(new org.telegram.ui.dm(dq0Var, i12, arrayList3, 10));
                        break;
                    }
                } catch (Exception e7) {
                    FileLog.e(e7);
    ...
    public /* synthetic */ aq0(dq0 dq0Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = dq0Var;
        this.d = str;
        this.c = i10;
