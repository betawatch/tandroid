...
public class rl0 extends RecyclerView implements og.a {
    ...
    public final void C0(Runnable runnable) {
        this.B2.b.add(new gt(runnable, 1));
    }
            ...
            if (layoutManager instanceof f2.i0) {
                ...
                if (i0Var.o == 1) {
                    if (this.d1 == null) {
                        ...
                        if ((!this.H1 && !z4) || (al0Var = this.c1) == null || al0Var.n) {
                            return;
                        }
                        ...
                        if (adapter instanceof bl0) {
                            ...
                            this.c1.setIsVisible(bl0Var.E(this));
                    ...
                    if ((this.H1 || z4) && (al0Var2 = this.c1) != null && !al0Var2.n && (getAdapter() instanceof bl0)) {
    ...
    public final void L0(float f10, float f11) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            org.telegram.ui.oi oiVar = this.e2;
            int[] iArr2 = this.j2;
            org.telegram.ui.zn znVar = oiVar.d;
            iArr2[0] = (int) znVar.p9;
            iArr2[1] = znVar.xa;
            ...
            if (rectF.contains(min2, min)) {
                ...
                if (i11 != S) {
                    ...
                    org.telegram.ui.zn znVar2 = this.e2.d;
                    org.telegram.ui.lm lmVar = znVar2.x0;
                    ArrayList arrayList = znVar2.r6;
                    int i13 = S - lmVar.G;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) znVar2.u6.f(messageObject.getGroupId())) != null) {
                            ArrayList<MessageObject> arrayList2 = groupedMessages.messages;
                            S = arrayList.indexOf(arrayList2.get(z4 ? 0 : arrayList2.size() - 1)) + znVar2.x0.G;
                        }
                    }
                    if (z4) {
                        int i14 = this.d2;
    ...
    public final void M0(Canvas canvas, View view) {
        ...
        if (R == -1) {
            ...
            View T0 = T0(R - 1);
            View T02 = T0(R + 1);
            z4 = T0 != null && ((Boolean) this.E2.a.run(T0)).booleanValue();
            z10 = T02 != null && ((Boolean) this.E2.a.run(T02)).booleanValue();
        }
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(view.getX(), Math.max(-this.I2, s1(view)), view.getX() + view.getWidth(), Math.min(getHeight() - (-this.I2), G0(view)));
        if (z4 && z10) {
            z4 = s1(view) >= rectF.top;
    ...
    public final void O0(Canvas canvas, View view, View view2, boolean z4, boolean z10) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(view.getLeft(), Math.max(-this.I2, s1(view) - (z4 ? this.I2 : 0.0f)), view.getRight(), Math.min(getHeight() - (-this.I2), (G0(view2) + (z10 ? this.I2 : 0.0f)) - bottomInfoMargin));
    ...
    */
    public final void P0(Canvas canvas) {
        ...
        if (t0Var == null || !t0Var.k()) {
            ...
            for (int i13 = 0; i13 < getChildCount(); i13++) {
                ...
                if (childAt == this.Z0 || childAt.getVisibility() != 0 || childAt.getAlpha() <= 0.0f || !((Boolean) this.E2.a.run(childAt)).booleanValue() || f1(RecyclerView.R(childAt))) {
            ...
            for (int i14 = 0; i14 < getChildCount(); i14++) {
                ...
                if (childAt2 != this.Z0 && childAt2.getVisibility() == 0 && childAt2.getAlpha() > 0.0f && ((Boolean) this.E2.a.run(childAt2)).booleanValue()) {
                    ...
                    if (!T.j() || childAt2.getAlpha() >= 1.0f) {
                        ...
                        ol0Var2.b = G0;
                        ol0Var2.c = alpha2;
                        arrayList2.add(ol0Var2);
                    }
                }
            }
            ArrayList arrayList3 = this.L2;
            float f13 = this.I2;
            ArrayList arrayList4 = pl0.a;
            if (arrayList3 == null || arrayList3.isEmpty()) {
                ...
                while (i16 < arrayList3.size()) {
                    float f14 = ((ol0) arrayList3.get(i16)).b;
                    int i17 = i16 + 1;
                    while (i17 < arrayList3.size() && ((ol0) arrayList3.get(i17)).a <= f14 + 1.5f) {
                        f14 = Math.max(f14, ((ol0) arrayList3.get(i17)).b);
                        i17++;
                    }
                    ...
                    for (int i18 = i16; i18 < i17; i18++) {
                        ol0 ol0Var3 = (ol0) arrayList3.get(i18);
                        if (ol0Var3.c >= 0.99f) {
                            f17 = Math.min(f17, ol0Var3.a);
                            f18 = Math.max(f18, ol0Var3.b);
                        }
                    }
                    boolean z4 = f17 != Float.MAX_VALUE;
                    float f19 = 0.0f;
                    for (int i19 = i16; i19 < i17; i19++) {
                        ol0 ol0Var4 = (ol0) arrayList3.get(i19);
                        f15 = Math.min(f15, ol0Var4.a);
                        f16 = Math.max(f16, ol0Var4.b);
                        f19 = Math.max(f19, ol0Var4.c);
                    }
                    if (f19 >= 0.001f) {
                        if (z4) {
                            float f20 = 0.0f;
                            ...
                            for (int i20 = i16; i20 < i17; i20++) {
                                ol0 ol0Var6 = (ol0) arrayList3.get(i20);
                                float f21 = ol0Var6.c;
                                if (f21 < 0.99f) {
                                    float f22 = ol0Var6.a;
                                    if (f22 < f17) {
                            ...
                            float f24 = 0.0f;
                            while (i16 < i17) {
                                ol0 ol0Var8 = (ol0) arrayList3.get(i16);
                                float f25 = ol0Var8.c;
                                if (f25 < 0.99f) {
                                    float f26 = ol0Var8.b;
                                    if (f26 > f18) {
    ...
    public final Drawable U0(View view, boolean z4) {
        boolean z10;
        boolean z11;
        if (view.getParent() != this || !a1() || !((Boolean) this.E2.a.run(view)).booleanValue()) {
            return null;
        }
        int R = RecyclerView.R(view);
        if (R == -1) {
            ...
            View T0 = T0(R - 1);
            View T02 = T0(R + 1);
            z10 = T0 != null && ((Boolean) this.E2.a.run(T0)).booleanValue();
            z11 = T02 != null && ((Boolean) this.E2.a.run(T02)).booleanValue();
        }
        ...
        if (yk0Var != null) {
            ...
            if (yk0Var.d || yk0Var.e) {
                for (int i10 = 0; i10 < rl0Var.getChildCount(); i10++) {
                    ...
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !yk0Var.c.contains(childAt)) {
                        Float f10 = (Float) yk0Var.b.get(R, null);
                        if (f10 == null) {
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (al0Var != null) {
            this.G1 = true;
            int paddingTop = i11 + (al0Var.a ? getPaddingTop() : al0Var.e0);
            al0 al0Var2 = this.c1;
            if (al0Var2.d0) {
                al0Var2.layout(0, paddingTop, al0Var2.getMeasuredWidth(), this.c1.getMeasuredHeight() + paddingTop);
            } else {
                int measuredWidth = getMeasuredWidth() - this.c1.getMeasuredWidth();
                al0 al0Var3 = this.c1;
                al0Var3.layout(measuredWidth, paddingTop, al0Var3.getMeasuredWidth() + measuredWidth, this.c1.getMeasuredHeight() + paddingTop);
            }
            this.G1 = false;
        }
        K0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (al0Var != null && al0Var.getLayoutParams() != null) {
            al0 al0Var2 = this.c1;
            int measuredHeight = (getMeasuredHeight() - (al0Var2.a ? getPaddingTop() : al0Var2.e0)) - getPaddingBottom();
    ...
    public void setFastScrollEnabled(int i10) {
        this.c1 = new al0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.c1);
        }
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        org.telegram.ui.Cells.z zVar = this.A1;
        if (num == null) {
            intValue = org.telegram.ui.ActionBar.j6.v0(a1() ? org.telegram.ui.ActionBar.j6.j6 : org.telegram.ui.ActionBar.j6.i6, this.m2);
        } else {
