...
public class aw0 extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    ...
    public aw0(Context context, org.telegram.ui.ActionBar.d5 d5Var) {
        super(context);
        this.a = new Rect();
    ...
    public final void I() {
        ...
        if (this.v == null) {
            a91 a91Var2 = new a91(getContext());
            this.v = a91Var2;
            a91Var2.n = new mv(this, 22);
            if (getMeasuredWidth() != 0 && getMeasuredHeight() != 0) {
                a91 a91Var3 = this.v;
                int measuredWidth = getMeasuredWidth();
                int measuredHeight = getMeasuredHeight();
                a91Var3.getClass();
                this.y = a91.a(measuredWidth, measuredHeight);
            }
        }
        if (this.F) {
            return;
    ...
    */
    ...
    public void S() {
        if (this.v != null) {
            this.y = a91.a(getMeasuredWidth(), getMeasuredHeight());
        }
        ...
        post(new ds0(1, this, point.x > point.y));
    }
    ...
    public final void W() {
        ...
        wv0 wv0Var = arrayList.size() > 0 ? (wv0) hg.k0.x(1, arrayList) : null;
        if (wv0Var == null) {
            wv0Var = new wv0();
    ...
    public int getBackgroundSizeY() {
        return getMeasuredHeight() - (this.b instanceof org.telegram.ui.co ? this.E : 0);
    }
