...
public class m40 extends FrameLayout {
    ...
    public final void a() {
        ...
        this.b.setColorFilter(new PorterDuffColorFilter(i0.a.k(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.pf, this.C), 125), PorterDuff.Mode.MULTIPLY));
        ImageView imageView2 = this.b;
        boolean z4 = this.r;
        addView(imageView2, k7.c6.d(34, 34.0f, 21, 0.0f, z4 ? 3.0f : 0.0f, 0.0f, z4 ? 0.0f : 3.0f));
    ...
    public final void b(boolean z4) {
        ...
        if (z10) {
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<m40, Float>) property, 1.0f, 0.0f), ObjectAnimator.ofFloat(this, (Property<m40, Float>) View.SCALE_Y, 1.0f, 0.5f), ObjectAnimator.ofFloat(this, (Property<m40, Float>) View.SCALE_X, 1.0f, 0.5f));
            this.f.setDuration(150L);
            this.f.setInterpolator(pr.f);
        } else {
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<m40, Float>) property, 0.0f));
            this.f.setDuration(300L);
        }
        this.f.addListener(new k40(this, i10));
        this.f.start();
    }
    ...
    public final void d() {
        ...
        int i10 = this.n;
        qVar.setBackground(org.telegram.ui.ActionBar.k6.b0(AndroidUtilities.dp((i10 == 7 || i10 == 8) ? 6.0f : 3.0f), -366530760));
    }
    ...
    */
    public final boolean e(org.telegram.ui.Cells.t1 t1Var, Integer num, int i10, int i11, boolean z4) {
        float f10;
        int i12;
        int dp;
        ...
        if ((i14 != 5 || i11 != this.v || this.d != t1Var) && (i14 == 5 || ((i14 != 0 || getTag() == null) && this.d != t1Var))) {
            ...
            if (i14 == 0) {
                ...
                if (i12 > AndroidUtilities.dp(10.0f) + getMeasuredHeight() && i17 <= (imageHeight / 4) + measuredHeight) {
                    ...
                    if (i14 == 5) {
                        int c3 = l.d.c(19.1f, forwardNameCenterX - (getMeasuredWidth() / 2), 0);
                        setTranslationX(c3);
                        dp3 += c3;
                    ...
                    AnimatorSet animatorSet2 = new AnimatorSet();
                    this.f = animatorSet2;
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<m40, Float>) View.ALPHA, 0.0f, 1.0f));
                    this.f.addListener(new k40(this, i13));
                    this.f.setDuration(300L);
                    this.f.start();
                    return true;
                }
                ...
                if (i14 == 5) {
                    ...
                    if (currentUser == null || currentUser.id != 0) {
                        ...
                        if (messageObject2.isOutOwner() || !t1Var.Wa || t1Var.Ha == null) {
                            i12 = dp6;
                            if (!z10 || i12 > AndroidUtilities.dp(10.0f) + getMeasuredHeight()) {
                        ...
                        dp = org.telegram.ui.b.C(50.0f, t1Var.getMeasuredHeight() - Math.max(0, t1Var.getBottom() - view.getMeasuredHeight()), i16);
                    }
                    i12 = dp;
                    if (!z10) {
                    }
    ...
    public final void f(View view, boolean z4) {
        ...
        if (z10) {
            ...
            this.f.playTogether(ObjectAnimator.ofFloat(this, (Property<m40, Float>) property, 0.0f, 1.0f), ObjectAnimator.ofFloat(this, (Property<m40, Float>) View.SCALE_Y, 0.5f, 1.0f), ObjectAnimator.ofFloat(this, (Property<m40, Float>) View.SCALE_X, 0.5f, 1.0f));
            this.f.setDuration(350L);
            this.f.setInterpolator(pr.h);
        } else {
            animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<m40, Float>) property, 0.0f, 1.0f));
            this.f.setDuration(300L);
        }
        this.f.addListener(new k40(this, i10));
        this.f.start();
    ...
    */
    public final void g(View view) {
        ...
        if (i12 == 4) {
            ...
            dp = org.telegram.messenger.y3.C(10.0f, getMeasuredHeight() + view.getMeasuredHeight(), dp);
        } else if (i12 == 7 || (i12 == 8 && z4)) {
            dp = org.telegram.messenger.y3.C(8.0f, getMeasuredHeight() + view.getMeasuredHeight(), dp);
        } else if (i12 == 8) {
        ...
        if (i12 != 8 || !z4) {
            ...
            measuredWidth = (iArr[0] + (rightDrawable != null ? rightDrawable.getBounds().centerX() : l5Var.getTextWidth() / 2)) - AndroidUtilities.dp(8.0f);
        } else {
        ...
        if (i12 == 8 && !z4) {
        ...
        } else if (c3 > view2.getMeasuredWidth() / 2) {
            if (i12 == 3) {
            ...
            measuredWidth2 = (c3 - (getMeasuredWidth() / 2)) - imageView.getMeasuredWidth();
        }
        setTranslationX(i13);
        float measuredWidth4 = (c3 - (i10 + i13)) - (imageView.getMeasuredWidth() / 2.0f);
        if (i12 == 7) {
            measuredWidth4 += AndroidUtilities.dp(2.0f);
        }
        imageView.setTranslationX(measuredWidth4);
        if (c3 > view2.getMeasuredWidth() / 2) {
    ...
    public m40(int i10, Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4) {
        ...
        this.a = qVar;
        int i11 = org.telegram.ui.ActionBar.k6.pf;
        ...
        if (i10 == 3) {
            qVar.setGravity(19);
            qVar.setBackground(org.telegram.ui.ActionBar.k6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.qf, g6Var)));
            ...
            qVar.setGravity(51);
            qVar.setBackground(org.telegram.ui.ActionBar.k6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.qf, g6Var)));
        ...
        if (i10 == 0) {
            ...
            this.b.setScaleType(ImageView.ScaleType.CENTER);
            this.b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(i11, g6Var), PorterDuff.Mode.MULTIPLY));
            addView(this.b, k7.c6.d(38, 34.0f, 51, 7.0f, 7.0f, 0.0f, 0.0f));
        }
        ImageView imageView2 = new ImageView(context);
        this.c = imageView2;
        imageView2.setImageResource(z4 ? R.drawable.tooltip_arrow_up : R.drawable.tooltip_arrow);
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.qf, g6Var), PorterDuff.Mode.MULTIPLY));
