                ...
                if (read <= 0 || i10 % 2 != 0) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.t50
                        ...
                        public final void run() {
                            ...
                            NotificationCenter.getInstance(v50Var.H0.f).lambda$postNotificationNameOnUIThread$1(NotificationCenter.recordProgressChanged, Integer.valueOf(v50Var.H0.V), Double.valueOf(sqrt));
                        }
                    });
