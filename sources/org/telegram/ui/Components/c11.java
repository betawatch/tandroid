...
public final class c11 extends FrameLayout {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (AndroidUtilities.computePerceivedBrightness(editorAlert.getThemedColor(org.telegram.ui.ActionBar.i6.h5)) <= 0.721f) {
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v(editorAlert.getThemedColor(org.telegram.ui.ActionBar.i6.s8), 855638016)) > 0.721f) {
        }
        this.c = Boolean.valueOf(z11);
        if (!z11) {
        }
