...
public final class ql0 {
    ...
    public final void d(Canvas canvas, RectF rectF, float f9, boolean z10, boolean z11) {
        ...
        n5 n5Var;
        if (!z11) {
            int l1 = org.telegram.ui.ActionBar.g6.l1(f9, this.E.a(this.x, false));
            Paint paint = this.g;
            paint.setColor(l1);
            float[] fArr = this.e;
            if (jf.l0.c(fArr)) {
            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof p5) && (x2Var = ((p5) drawable).k) != null && x2Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (!pl0Var.e || z10) {
                            n5Var.v = (int) ((n5Var == this.u ? 1.0f : 0.3f) * 255.0f * pl0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(pl0Var.a);
                            float dp2 = AndroidUtilities.dp(pl0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * pl0Var.c * e10;
    ...
    */
    public final void e(Canvas canvas, RectF rectF, float f9) {
        ...
        int l1 = org.telegram.ui.ActionBar.g6.l1(f9, a2);
        Paint paint = this.b;
        paint.setColor(l1);
        ...
        if (e10 > 0.0f && !this.i) {
            ...
            rectF2.set(rectF.left, (AndroidUtilities.lerp(0.0f, 1.0f - jr.i.getInterpolation(i7.w.a(((Math.max(pow, 0.5f) + 1.5f) % 3.5f) * 0.5f, 0.0f, 1.0f)), e10) * rectF.height()) + rectF.top, rectF.left + AndroidUtilities.dp(6.0f), (AndroidUtilities.lerp(1.0f, 1.0f - jr.g.getInterpolation(i7.w.a((((pow + 1.5f) % 3.5f) - 1.5f) * 0.5f, 0.0f, 1.0f)), e10) * rectF.height()) + rectF.top);
        ...
        int l12 = org.telegram.ui.ActionBar.g6.l1(f9, a2);
        int h = i0.a.h(org.telegram.ui.ActionBar.g6.l1(e11 * f9, a10), l12);
        int h10 = this.j ? i0.a.h(org.telegram.ui.ActionBar.g6.l1(f9 * e12, a11), l12) : 0;
