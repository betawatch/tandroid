...
public final class sd0 extends FrameLayout {
    ...
    public static void a(sd0 sd0Var, boolean z4) {
        ArrayList arrayList = (ArrayList) sd0Var.c;
        ArrayList arrayList2 = (ArrayList) sd0Var.b;
        StringBuilder sb = (StringBuilder) sd0Var.d;
        if (sb.length() == 0) {
            return;
        }
        ye yeVar = (ye) sd0Var.f;
        if (yeVar != null) {
    ...
    public void d(boolean z4) {
        ...
        textView.setLayoutParams(k7.b6.d(-1, -2.0f, 23, (z10 || !z4) ? 22.0f : 53.0f, 0.0f, (z10 && z4) ? 53.0f : 22.0f, 0.0f));
    }
