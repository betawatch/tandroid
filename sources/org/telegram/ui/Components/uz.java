...
public final class uz {
    ...
    public final boolean b() {
        tz tzVar;
        tz tzVar2 = this.f1;
        int blurType = tzVar2 != null ? tzVar2.getBlurType() : 0;
        if (this.g1 || (tzVar = this.f1) == null || tzVar.b() || blurType == 0) {
            return false;
        }
        boolean z10 = this.a;
        int[] iArr = this.S0;
    ...
    public final void d() {
        ...
        if (z11) {
            ...
            GLES20.glVertexAttribPointer(iArr5[c3], 2, 5126, false, 8, (Buffer) (z10 ? this.b1 : this.Z0));
    ...
    public final void f() {
        ...
        int i11;
        tz tzVar = this.f1;
        if (tzVar == null || tzVar.b() || this.f1.getSoftenSkinValue() <= 0.0f || (i10 = this.X0) <= 0 || this.Y0 <= 0) {
            if (this.h) {
                this.W0 = false;
                this.h = false;
                return;
        ...
        if (z10 || z11) {
            float f9 = i10 * 0.006f;
            if (this.e == null || Math.abs(this.f - f9) > 1.0E-4d) {
                sz szVar = this.e;
                if (szVar != null && (i11 = szVar.c) != 0) {
