...
public class ae0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ae0(Context context) {
        ...
        this.Q = -12;
        this.R = new org.telegram.ui.Cells.u6(this, 19);
        this.U = true;
        this.W = new int[2];
        ...
        addView(kj0Var, w7.y5.e(58, 58, 51));
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.rd0
            ...
            public final void onClick(View view) {
                ...
                switch (i16) {
                    ...
                    case 1:
                        ...
                        break;
                    default:
                        LinkedList linkedList4 = ae0Var.N;
                        LinkedList linkedList5 = ae0Var.M;
                        ci.m9 m9Var2 = ae0Var.s;
                        if (ae0Var.U) {
                            ...
                            switch (intValue) {
                                ...
                                case 11:
                                    ...
                                    if (sb2.length() == 0) {
                                        ...
                                        ((AnimatorSet) m9Var2.e).addListener(new wd0(m9Var2, 1));
                                ...
                                if (drawable instanceof kc0) {
                                    ...
                                    if (z12) {
                                        if (f7 >= 1.0f) {
                                            ...
                                            ci.y0 y0Var = new ci.y0(ae0Var, z11, kc0Var, 21);
        ...
        final int i12 = 1;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.rd0
            public final /* synthetic */ ae0 b;
        ...
        while (true) {
            ...
            w7.b6.b(yd0Var, 0.15f, 1.5f);
            yd0Var.setTag(Integer.valueOf(i13));
            if (i13 == 11) {
                int dp = AndroidUtilities.dp(30.0f);
                yd0Var.setBackground(org.telegram.ui.ActionBar.j6.i0(dp, dp, dp, dp, 0, 654311423, 654311423));
                yd0Var.setImage(R.drawable.filled_clear);
                yd0Var.setOnLongClickListener(new m10(this, 1));
                yd0Var.setContentDescription(LocaleController.getString(R.string.AccDescrBackspace));
                l(yd0Var, R.id.passcode_btn_0);
            } else if (i13 == 10) {
                this.n = yd0Var;
                int dp2 = AndroidUtilities.dp(30.0f);
                yd0Var.setBackground(org.telegram.ui.ActionBar.j6.i0(dp2, dp2, dp2, dp2, 0, 654311423, 654311423));
                yd0Var.setContentDescription(LocaleController.getString(R.string.AccDescrFingerprint));
                yd0Var.setImage(R.drawable.fingerprint);
                l(yd0Var, R.id.passcode_btn_1);
            } else {
                int dp3 = AndroidUtilities.dp(30.0f);
                yd0Var.setBackground(org.telegram.ui.ActionBar.j6.i0(dp3, dp3, dp3, dp3, 654311423, 1291845631, 1291845631));
                yd0Var.setContentDescription(i13 + "");
                yd0Var.setNum(i13);
                if (i13 == 0) {
                    l(yd0Var, R.id.passcode_btn_backspace);
                } else if (i13 == 9) {
                    ...
                    if (Build.VERSION.SDK_INT >= 23 && findActivity != null && SharedConfig.useFingerprintLock) {
                        try {
                            ...
                            if (aVar.I0(context2) && aVar.c(context2) && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                                l(yd0Var, R.id.passcode_btn_fingerprint);
                            }
                        } catch (Throwable th2) {
                            FileLog.e(th2);
                        }
            ...
            yd0Var.setId(iArr[i13]);
            final int i14 = 2;
            yd0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.rd0
                public final /* synthetic */ ae0 b;
    ...
    public static void a(ae0 ae0Var) {
        FrameLayout frameLayout = ae0Var.b;
        ci.m9 m9Var = ae0Var.s;
    ...
    public static void l(yd0 yd0Var, int i10) {
        yd0Var.setNextFocusForwardId(i10);
        if (Build.VERSION.SDK_INT >= 22) {
            yd0Var.setAccessibilityTraversalBefore(i10);
        }
    }
    ...
    public final void b(kc0 kc0Var) {
        ...
        kc0Var.D = new mv(jVar, 9);
        kc0Var.z();
        o1.k kVar2 = new o1.k(jVar);
        kVar2.u = org.telegram.ui.Cells.c1.m(100.0f, 300.0f, 1.0f);
        this.L = kVar2;
        int i10 = 4;
        kVar2.a(new ei.m4(i10, this, kc0Var));
        this.L.b(new j7(kc0Var, i10));
        this.L.f();
    }
    ...
    public final void c() {
        ...
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                ...
                if (!arrayList.isEmpty() || (ce0Var = launchActivity.A0) == null) {
                    if (hg.k0.g(1, arrayList) != this) {
                        return;
                    }
                } else if (this != ce0Var.b) {
                    return;
                }
            }
            try {
                if (new aa.a(new k6.h(getContext(), 1)).f(15) == 0 && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                    a6.m mVar = new a6.m(LaunchActivity.G1, f0.e.e(getContext()), new sd0(this));
    ...
    */
    ...
    public final void i() {
        ...
        if (this.x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                ...
                AndroidUtilities.runOnUIThread(new pd0(this, 0), 200L);
            }
            c();
        }
    }
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.r80 r80Var) {
        ...
        u9 u9Var = null;
        this.a = null;
        boolean z12 = org.telegram.ui.ActionBar.j6.r0() instanceof kc0;
        ci.n6 n6Var = this.v;
        if (z12) {
        ...
        if (drawable instanceof kc0) {
            ...
            this.a = new kc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (kc0Var.u == null || kc0Var.q >= 0) {
                n6Var.setBackgroundColor(570425344);
            } else {
        ...
        if (z10) {
            setAlpha(0.0f);
            getViewTreeObserver().addOnGlobalLayoutListener(new vd0(this, i10, i11, r80Var));
            requestLayout();
        } else {
            setAlpha(1.0f);
            this.P = 1.0f;
    ...
    public final void k(boolean z10) {
        ...
        kj0Var.d();
        AndroidUtilities.runOnUIThread(new pd0(this, 1));
    }
    ...
    public final void m(boolean z10) {
        ...
        this.V = ofFloat;
        ofFloat.addUpdateListener(new qd0(this, 1));
    ...
    public void setDelegate(zd0 zd0Var) {
        this.K = zd0Var;
    }
