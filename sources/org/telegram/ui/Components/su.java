...
public final class su extends View {
    ...
    public su(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.v = new RectF();
        pr prVar = pr.h;
        this.w = new z5(this, 125L, prVar);
        this.x = new z5(this, 125L, prVar);
        this.C = -1;
        this.D = true;
        this.y = g6Var;
    ...
    public final void a() {
        ...
        org.telegram.ui.ActionBar.k6.w1(org.telegram.ui.ActionBar.k6.v0(i10, g6Var), this.c);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp = suVar.h - AndroidUtilities.dp(9.0f);
        int measuredHeight2 = suVar.getMeasuredHeight() - AndroidUtilities.dp(6.34f);
        int dp2 = AndroidUtilities.dp(9.0f) + suVar.h;
        ...
        if (suVar.e != null) {
            boolean z10 = suVar.f;
            org.telegram.ui.ActionBar.g6 g6Var = suVar.y;
            int[] iArr = suVar.n;
            z5 z5Var = suVar.w;
            Paint paint = suVar.s;
            Drawable[] drawableArr = suVar.b;
            RectF rectF = suVar.v;
            float f10 = 1.0f;
            int i10 = suVar.a;
            if (!z10) {
            ...
            int i12 = 0;
            while (i12 < 2) {
                float d10 = (i12 == 0 ? z5Var : suVar.x).d(iArr[i12], z4);
                float max = Math.max(0.0f, Math.min(f10, -d10));
                rectF.set((int) ((i10 * (d10 + f10)) + AndroidUtilities.dp((r6 * 4.0f) + (Math.max(0.0f, Math.min(f10, r6)) * 3.0f) + 5.0f)), AndroidUtilities.lerp(((AndroidUtilities.dp(f10) + i10) * i12) + AndroidUtilities.dp(3.0f), (suVar.getMeasuredHeight() - i10) / 2, max), r6 + i10, r9 + i10);
                rectF.inset(AndroidUtilities.dp(-2.0f), AndroidUtilities.dp(max * (-2.0f)));
                paint.setColor(org.telegram.ui.ActionBar.k6.l1(AndroidUtilities.lerp(f10, 0.5f, max), org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.i6, g6Var)));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint);
                int i13 = 0;
                while (i13 < 5) {
                    i13++;
            ...
            canvas.drawRect(AndroidUtilities.dp(8.45f) + i10, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(8.45f) + i10 + 1, getMeasuredHeight() - AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.k6.k0);
        }
    }
