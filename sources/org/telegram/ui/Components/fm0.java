...
public final class fm0 {
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.f6 f6Var, int i10) {
        ...
        if (this.v != 0 && this.t == null && (view = this.D) != null) {
            this.t = new n5(AndroidUtilities.dp(20.0f), 13, view, false);
            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof p5) && (l4Var = ((p5) drawable).k) != null && l4Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (i10 != 0 || (n5Var = this.u) == null || this.w == 0) {
                            n5Var = this.t;
                        }
                        em0 em0Var = em0VarArr[i10];
                        if (!em0Var.e || z10) {
                            n5Var.v = (int) ((n5Var == this.u ? 1.0f : 0.3f) * 255.0f * em0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(em0Var.a);
                            float dp2 = AndroidUtilities.dp(em0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * em0Var.c * e;
    ...
    */
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (this.w != 0 && this.u == null && view != null) {
            this.u = new n5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.u1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.u1) view).M0) {
                this.u.a();
            }
        }
