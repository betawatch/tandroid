...
public final class nz {
                            ...
                            if (h17 != 0 && h18 != 0) {
                                ...
                                if (h20 != 0 && h19 != 0) {
                                    ...
                                    if (h22 != 0 && h21 != 0) {
                                        ...
                                        float[] f10 = o0.b.f(arrayList2);
                                        float[] f11 = o0.b.f(arrayList);
                                        ...
                                        if (f11.length >= 256 && f11.length >= 256 && f11.length >= 256 && f10.length >= 256) {
                                            for (int i10 = 0; i10 < 256; i10++) {
                                                float f12 = i10;
                                                int min = (int) Math.min(Math.max(f11[i10] + f12, 0.0f), 255.0f);
                                                int min2 = (int) Math.min(Math.max(f11[i10] + f12, 0.0f), 255.0f);
                                                int min3 = (int) Math.min(Math.max(f12 + f11[i10], 0.0f), 255.0f);
                                                allocateDirect.put((byte) Math.min(Math.max(min3 + f10[min3], 0.0f), 255.0f));
                                                allocateDirect.put((byte) Math.min(Math.max(min2 + f10[min2], 0.0f), 255.0f));
                                                allocateDirect.put((byte) Math.min(Math.max(min + f10[min], 0.0f), 255.0f));
    ...
    public final boolean b() {
        ...
        if (this.g1 || (mzVar = this.f1) == null || mzVar.b() || blurType == 0) {
            return false;
        }
        boolean z10 = this.a;
        int[] iArr = this.S0;
    ...
    public final void f() {
        ...
        int i11;
        mz mzVar = this.f1;
        if (mzVar == null || mzVar.b() || this.f1.getSoftenSkinValue() <= 0.0f || (i10 = this.X0) <= 0 || this.Y0 <= 0) {
            if (this.h) {
                this.W0 = false;
                this.h = false;
                return;
