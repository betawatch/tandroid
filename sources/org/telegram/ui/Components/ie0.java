...
public final class ie0 extends FrameLayout {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i10), org.telegram.messenger.x3.b(20.0f, textView2.getMeasuredHeight() + textView.getMeasuredHeight(), AndroidUtilities.dp(64.0f)) + (this.e ? 1 : 0));
    }
