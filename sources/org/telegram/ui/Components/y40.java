...
public final class y40 extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public y40(Context context, String str, org.telegram.ui.xn xnVar, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var, false, false);
        this.b = new TextView[2];
        this.s = new TextView[2];
        vp vpVar = new vp(this, 23);
        ...
        gj0 gj0Var = new gj0(R.raw.import_finish, "" + R.raw.import_finish, AndroidUtilities.dp(120.0f), AndroidUtilities.dp(120.0f), false, null);
        this.r = gj0Var;
        gj0Var.H(true);
        ...
        jj0Var.getAnimatedDrawable().P(178, vpVar);
        ...
        x40Var.addView(view, k7.b6.d(-1, -1.0f, 0, 16.0f, 16.0f, 16.0f, 16.0f));
        LinearLayout linearLayout = new LinearLayout(context);
        x40Var.d = linearLayout;
        linearLayout.setOrientation(0);
        x40Var.addView(linearLayout, k7.b6.e(-2, -2, 17));
        ...
        this.h = x40Var;
        x40Var.setBackground(null);
        x40Var.setText(LocaleController.getString(R.string.ImportDone));
        x40Var.setVisibility(4);
        view.setOnClickListener(new g0(this, 27));
        view.setPivotY(AndroidUtilities.dp(48.0f));
        view.setScaleY(0.04f);
        frameLayout.addView(x40Var, k7.b6.d(-1, 50.0f, 51, 34.0f, 247.0f, 34.0f, 0.0f));
    ...
    public final void m() {
        ...
        animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4, ObjectAnimator.ofFloat(textViewArr2[0], (Property<TextView, Float>) property, 0.0f), ObjectAnimator.ofFloat(textViewArr2[0], (Property<TextView, Float>) property2, -AndroidUtilities.dp(10.0f)), ObjectAnimator.ofFloat(textViewArr[1], (Property<TextView, Float>) property, 1.0f), ObjectAnimator.ofFloat(textViewArr[1], (Property<TextView, Float>) property2, 0.0f), ObjectAnimator.ofFloat(textViewArr2[1], (Property<TextView, Float>) property, 1.0f), ObjectAnimator.ofFloat(textViewArr2[1], (Property<TextView, Float>) property2, 0.0f), ObjectAnimator.ofFloat(this.d, (Property<o80, Float>) property, 0.0f), ObjectAnimator.ofFloat(x40Var.d, (Property<LinearLayout, Float>) property2, AndroidUtilities.dp(8.0f), 0.0f));
        x40Var.a.animate().scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        x40Var.c.animate().scaleY(1.0f).scaleX(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        x40Var.c.d();
        animatorSet.start();
    }
}
