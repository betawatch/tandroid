...
public class kx0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public boolean E;
    public int F;
    public int G;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            ViewPropertyAnimator translationY = bc1Var.animate().translationY(dp);
            qr qrVar = qr.f;
            translationY.setInterpolator(qrVar).setDuration(250L);
            if (radialProgressView != null) {
                radialProgressView.animate().translationY(dp).setInterpolator(qrVar).setDuration(250L);
            }
        }
    }
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (visibility != i10 && i10 == 0) {
            if (this.h) {
                bc1Var.animate().alpha(0.0f).scaleY(0.8f).scaleX(0.8f).setDuration(150L).start();
                view.animate().setListener(null).cancel();
                view.setVisibility(0);
                view.setAlpha(1.0f);
            } else {
                bc1Var.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).setDuration(150L).start();
                if (view != null) {
                    view.animate().setListener(null).cancel();
                    view.animate().setListener(new jx0(this, 0)).alpha(0.0f).setDuration(150L).start();
                } else {
        ...
        this.F = 0;
        bc1Var.setAlpha(0.0f);
        bc1Var.setScaleX(0.8f);
        bc1Var.setScaleY(0.8f);
        if (view != null) {
            view.animate().setListener(null).cancel();
            view.animate().setListener(new jx0(this, 1)).alpha(0.0f).setDuration(150L).start();
        } else {
    ...
    public void e(boolean z10, boolean z11) {
        if (this.h != z10) {
            ...
            if (z11) {
                ...
                if (view != null) {
                    view.animate().setListener(null).cancel();
                    view.animate().setListener(new jx0(this, 2)).alpha(0.0f).setDuration(150L).start();
                } else {
                    radialProgressView.animate().alpha(0.0f).scaleY(0.5f).scaleX(0.5f).setDuration(150L).start();
                }
            ...
            if (!z10) {
                bc1Var.animate().cancel();
                bc1Var.setAlpha(1.0f);
                bc1Var.setScaleX(1.0f);
                bc1Var.setScaleY(1.0f);
                if (view != null) {
                    view.animate().setListener(null).cancel();
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            ...
            bc1 bc1Var = this.a;
            bc1Var.setTranslationY(bc1Var.getTranslationY() + measuredHeight);
            if (!this.x) {
                bc1Var.animate().translationY(0.0f).setInterpolator(qr.f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(qr.f).setDuration(250L);
                }
            }
        }
    ...
    public kx0(Context context, View view, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.y = new org.telegram.ui.Cells.t6(this, 26);
        this.G = org.telegram.ui.ActionBar.j6.c7;
        this.n = e6Var;
        this.s = view;
        this.r = i10;
        bc1 bc1Var = new bc1(this, context, 10);
        this.a = bc1Var;
        ...
        oVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(i11, e6Var));
        oVar.setTextSize(1, 20.0f);
        oVar.setGravity(17);
        l90 l90Var = new l90(context, null);
        this.e = l90Var;
        int i12 = org.telegram.ui.ActionBar.j6.y6;
        l90Var.setTag(Integer.valueOf(i12));
        l90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i12, e6Var));
        ...
        bc1Var.addView(w9Var, w7.y5.q(117, 117, 1));
        bc1Var.addView(oVar, w7.y5.t(-2, -2, 1, 0, 12, 0, 0));
        bc1Var.addView(l90Var, w7.y5.t(-2, -2, 1, 0, 8, 0, 0));
        bc1Var.addView(dVar, w7.y5.t(-1, 48, 1, 28, 16, 28, 0));
        addView(bc1Var, w7.y5.d(-2, -2.0f, 17, 46.0f, 0.0f, 46.0f, 30.0f));
        if (view == null) {
