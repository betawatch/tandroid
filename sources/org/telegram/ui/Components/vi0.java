...
public abstract class vi0 {
    ...
    public final ti0 b0;
    public int c0;
    public final org.telegram.ui.Cells.u6 d0;
    public boolean e0;
    ...
    public vi0(CharSequence charSequence, CharSequence charSequence2) {
        ...
        this.P = 1.0f;
        this.U = 1.0f;
        this.a0 = new ti0(this, 3);
        this.b0 = new ti0(this, 4);
        this.d0 = new org.telegram.ui.Cells.u6(this, 19);
        this.e0 = false;
    ...
    public final void c(Canvas canvas, boolean z10) {
        ...
        boolean z12 = s2Var instanceof cg1;
        ...
        if (f43 == 0.0f || z11) {
            ...
            int i26 = dp5 >> 1;
            i15 = dp;
            ui0Var.setBounds(i24 - dp6, measuredHeight - i26, i24 + dp6, measuredHeight + i26);
            ...
            ui0Var.b.setColor(this.G ? paint2.getColor() : org.telegram.ui.ActionBar.j6.w0(null, this.b, false));
            ui0Var.draw(canvas);
            canvas.restore();
        } else {
            i15 = dp;
        ...
        if (this.J > 0.0f && !this.y) {
            if (Math.abs(this.a) >= this.Z * 0.5f) {
                ...
                org.telegram.ui.Cells.u6 u6Var = this.d0;
                s2Var2.removeCallbacks(u6Var);
                this.H.postDelayed(u6Var, 200L);
            } else if (!this.e0) {
                this.x = 1.0f;
                this.y = true;
            }
        ...
        if (this.T != null) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.H.getMeasuredWidth(), this.H.getMeasuredHeight(), (int) (org.telegram.messenger.l0.z(1.0f, this.o, 255.0f, f12) * this.x), 31);
        ...
        if (!org.telegram.ui.ActionBar.j6.C1) {
            ...
            kj0Var.Z = true;
            int i28 = this.d;
            kj0Var.Q(org.telegram.ui.ActionBar.j6.w0(null, i28, true), "Arrow1");
