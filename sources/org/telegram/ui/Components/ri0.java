...
public final class ri0 extends FrameLayout {
    ...
    public final void a() {
        ...
        this.s = animatorSet2;
        animatorSet2.playTogether(ObjectAnimator.ofFloat(ni0Var, (Property<ni0, Float>) View.TRANSLATION_Y, AndroidUtilities.dp(10.0f) + ni0Var.getMeasuredHeight()));
        if (this.E) {
            float measuredHeight = ni0Var.getMeasuredHeight();
            this.s.setDuration(Math.max(60, (int) (((measuredHeight - ni0Var.getTranslationY()) * 250.0f) / measuredHeight)));
            this.E = false;
        } else {
            ...
            if (motionEvent == null || (!(motionEvent.getAction() == 0 || motionEvent.getAction() == 2) || this.f || this.e || motionEvent.getPointerCount() != 1)) {
                if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.d) {
                    ...
                    if (this.e && !this.f && y3 > 0.0f && y3 / 3.0f > Math.abs(abs) && Math.abs(y3) >= this.y) {
                        ...
                        float translationY = ni0Var.getTranslationY() + y3;
                        ni0Var.setTranslationY(translationY >= 0.0f ? translationY : 0.0f);
                        this.c = (int) motionEvent.getY();
                    }
                    ...
                    float translationY2 = ni0Var.getTranslationY();
                ...
                this.c = y10;
                if (y10 < ni0Var.getTop() || this.b < ni0Var.getLeft() || this.b > ni0Var.getRight()) {
                    requestDisallowInterceptTouchEvent(true);
                    a();
                    return true;
                }
    ...
    public final void c(boolean z10) {
        ...
        if (!DialogObject.isChatDialog(kd0Var.e0)) {
            ...
            if (z11 && user != null) {
                ...
                if (pi0Var.getTag() == null) {
                    pi0Var.setTag(1);
                    pi0Var.animate().setDuration(180L).alpha(0.0f).scaleX(0.5f).scaleY(0.5f).start();
            ...
            if (user != null) {
                pi0Var.setText(LocaleController.formatString("LocationNotifiationButtonGroup", R.string.LocationNotifiationButtonGroup, formatDistance));
            } else {
                pi0Var.setText(LocaleController.formatString("LocationNotifiationButtonUser", R.string.LocationNotifiationButtonUser, TextUtils.ellipsize(UserObject.getFirstName(user), pi0Var.getPaint(), Math.max(AndroidUtilities.dp(10.0f), (int) (((this.N - AndroidUtilities.dp(94.0f)) * 1.5f) - ((int) Math.ceil(pi0Var.getPaint().measureText(LocaleController.getString(R.string.LocationNotifiationButtonUser)))))), TextUtils.TruncateAt.END), formatDistance));
            }
            if (pi0Var.getTag() == null) {
                pi0Var.setTag(null);
                pi0Var.animate().setDuration(180L).alpha(1.0f).scaleX(1.0f).scaleY(1.0f).start();
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i20 = i13 - i11;
        ni0 ni0Var = this.v;
        int measuredHeight = i20 - ni0Var.getMeasuredHeight();
        int i21 = i12 - i10;
        int measuredWidth = (i21 - ni0Var.getMeasuredWidth()) / 2;
        ni0Var.layout(measuredWidth, measuredHeight, ni0Var.getMeasuredWidth() + measuredWidth, ni0Var.getMeasuredHeight() + measuredHeight);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ni0 ni0Var = this.v;
        ni0Var.measure(View.MeasureSpec.makeMeasureSpec((this.x * 2) + size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_31));
        int childCount = getChildCount();
