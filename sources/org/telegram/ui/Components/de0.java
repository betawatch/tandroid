...
public class de0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float P;
    public int Q;
    public final org.telegram.ui.Cells.u6 R;
    public int S;
    public ci.j4 T;
    public boolean U;
    ...
    public de0(Context context) {
        ...
        this.Q = -12;
        this.R = new org.telegram.ui.Cells.u6(this, 18);
        this.U = true;
        this.W = new int[2];
        ...
        this.h = frameLayout;
        n6Var.addView(frameLayout, w7.y5.c(-1.0f, -1));
        ...
        h.setGravity(1);
        h.setVisibility(4);
        n6Var.addView(h, w7.y5.e(-2, -2, 17));
        ci.m9 m9Var = new ci.m9(this, context);
        this.s = m9Var;
        frameLayout.addView(m9Var, w7.y5.d(-1, -2.0f, 81, 70.0f, 0.0f, 70.0f, 46.0f));
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ud0
            ...
            public final void onClick(View view) {
                ...
                switch (i16) {
                    ...
                    case 1:
                        ...
                        break;
                    default:
                        LinkedList linkedList4 = de0Var.N;
                        LinkedList linkedList5 = de0Var.M;
                        ci.m9 m9Var2 = de0Var.s;
                        if (de0Var.U) {
                            ...
                            switch (intValue) {
                                ...
                                case 11:
                                    ...
                                    if (sb2.length() == 0) {
                                        ...
                                        ((AnimatorSet) m9Var2.e).addListener(new zd0(m9Var2, 1));
                                ...
                                if (drawable instanceof nc0) {
                                    ...
                                    if (z12) {
                                        if (f7 >= 1.0f) {
                                            ...
                                            ci.y0 y0Var = new ci.y0(de0Var, z11, nc0Var, 21);
                                            ...
                                            Collections.sort(arrayList5, new org.telegram.ui.df(i19));
        ...
        final int i12 = 1;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ud0
            public final /* synthetic */ de0 b;
        ...
        this.d = frameLayout2;
        n6Var.addView(frameLayout2, w7.y5.e(-1, -1, 51));
        ai.x5 x5Var = new ai.x5(context, 17);
        this.e = x5Var;
        frameLayout2.addView(x5Var, w7.y5.e(-2, -2, 17));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.b = frameLayout3;
        x5Var.addView(frameLayout3, w7.y5.e(-2, -2, 49));
        ...
        while (true) {
            ...
            w7.a6.b(be0Var, 0.15f, 1.5f);
            be0Var.setTag(Integer.valueOf(i13));
            if (i13 == 11) {
                int dp = AndroidUtilities.dp(30.0f);
                be0Var.setBackground(org.telegram.ui.ActionBar.j6.i0(dp, dp, dp, dp, 0, 654311423, 654311423));
                be0Var.setImage(R.drawable.filled_clear);
                be0Var.setOnLongClickListener(new m10(this, 1));
                be0Var.setContentDescription(LocaleController.getString(R.string.AccDescrBackspace));
                l(be0Var, R.id.passcode_btn_0);
            } else if (i13 == 10) {
                this.n = be0Var;
                int dp2 = AndroidUtilities.dp(30.0f);
                be0Var.setBackground(org.telegram.ui.ActionBar.j6.i0(dp2, dp2, dp2, dp2, 0, 654311423, 654311423));
                be0Var.setContentDescription(LocaleController.getString(R.string.AccDescrFingerprint));
                be0Var.setImage(R.drawable.fingerprint);
                l(be0Var, R.id.passcode_btn_1);
            } else {
                int dp3 = AndroidUtilities.dp(30.0f);
                be0Var.setBackground(org.telegram.ui.ActionBar.j6.i0(dp3, dp3, dp3, dp3, 654311423, 1291845631, 1291845631));
                be0Var.setContentDescription(i13 + "");
                be0Var.setNum(i13);
                if (i13 == 0) {
                    l(be0Var, R.id.passcode_btn_backspace);
                } else if (i13 == 9) {
                    ...
                    if (Build.VERSION.SDK_INT >= 23 && findActivity != null && SharedConfig.useFingerprintLock) {
                        try {
                            ...
                            xf.a aVar = xf.b.a;
                            if (aVar.I0(context2) && aVar.c(context2) && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                                l(be0Var, R.id.passcode_btn_fingerprint);
                            }
                        } catch (Throwable th2) {
                            FileLog.e(th2);
                        }
            ...
            be0Var.setId(iArr[i13]);
            final int i14 = 2;
            be0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ud0
                public final /* synthetic */ de0 b;
    ...
    public static void a(de0 de0Var) {
        FrameLayout frameLayout = de0Var.b;
        ci.m9 m9Var = de0Var.s;
        boolean z10 = m9Var == null || ((StringBuilder) m9Var.d).length() > 0;
        if (frameLayout != null) {
            frameLayout.animate().cancel();
            org.telegram.messenger.rk.s(frameLayout.animate().alpha(z10 ? 0.0f : 1.0f).scaleX(z10 ? 0.8f : 1.0f).scaleY(z10 ? 0.8f : 1.0f), qr.h, 320L);
        }
    }

    public static void l(be0 be0Var, int i10) {
        be0Var.setNextFocusForwardId(i10);
        if (Build.VERSION.SDK_INT >= 22) {
            be0Var.setAccessibilityTraversalBefore(i10);
        }
    }
    ...
    public final void b(nc0 nc0Var) {
        ...
        nc0Var.D = new mv(jVar, 9);
        nc0Var.z();
        o1.k kVar2 = new o1.k(jVar);
        kVar2.u = org.telegram.ui.Cells.c1.m(100.0f, 300.0f, 1.0f);
        this.L = kVar2;
        int i10 = 4;
        kVar2.a(new ei.m4(i10, this, nc0Var));
        this.L.b(new j7(nc0Var, i10));
        this.L.f();
    }
    ...
    public final void c() {
        ...
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                ...
                if (!arrayList.isEmpty() || (fe0Var = launchActivity.A0) == null) {
                    if (hg.k0.g(1, arrayList) != this) {
                        return;
                    }
                } else if (this != fe0Var.b) {
                    return;
                }
            }
            try {
                if (new aa.a(new k6.h(getContext(), 1)).i(15) == 0 && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                    pb.c cVar = new pb.c(LaunchActivity.G1, f0.e.e(getContext()), new vd0(this));
    ...
    */
    public final void d() {
        ...
        if (Build.VERSION.SDK_INT < 23 || findActivity == null || !SharedConfig.useFingerprintLock) {
            ...
            try {
                ...
                xf.a aVar = xf.b.a;
                if (aVar.I0(context) && aVar.c(context) && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                    try {
    ...
    public final void i() {
        ...
        if (this.x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                ...
                AndroidUtilities.runOnUIThread(new sd0(this, 0), 200L);
            }
            c();
        }
    }
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.r80 r80Var) {
        ...
        u9 u9Var = null;
        this.a = null;
        boolean z12 = org.telegram.ui.ActionBar.j6.r0() instanceof nc0;
        ci.n6 n6Var = this.v;
        if (z12) {
            ...
            if (!org.telegram.ui.ActionBar.j6.W || "CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.j6.H0()) || "qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.j6.H0())) {
                ...
                if (b6Var != null && (i12 = b6Var.d) != 0 && (i13 = b6Var.e) != 0) {
                    u9Var = new u9(u9.d(b6Var.h), new int[]{i12, i13});
                }
                this.a = u9Var;
                if (u9Var == null) {
                    this.a = org.telegram.ui.ActionBar.j6.r0();
        ...
        if (drawable instanceof nc0) {
            ...
            this.a = new nc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (nc0Var.u == null || nc0Var.q >= 0) {
                n6Var.setBackgroundColor(570425344);
            } else {
        ...
        if (z10) {
            setAlpha(0.0f);
            getViewTreeObserver().addOnGlobalLayoutListener(new yd0(this, i10, i11, r80Var));
            requestLayout();
        } else {
            setAlpha(1.0f);
            this.P = 1.0f;
    ...
    public final void k(boolean z10) {
        ...
        nj0Var.d();
        AndroidUtilities.runOnUIThread(new sd0(this, 1));
    }
    ...
    public final void m(boolean z10) {
        ...
        this.V = ofFloat;
        ofFloat.addUpdateListener(new td0(this, 1));
        this.V.addListener(new ba(16, this, z10));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            layoutParams.topMargin = org.telegram.messenger.rk.z(140.0f, i13, 2) + (SharedConfig.passcodeType == 0 ? AndroidUtilities.dp(40.0f) : 0);
            ...
            if (AndroidUtilities.isTablet()) {
                if (size > AndroidUtilities.dp(498.0f)) {
                    i12 = org.telegram.messenger.rk.z(498.0f, size, 2);
                    size = AndroidUtilities.dp(498.0f);
                } else {
                    i12 = 0;
                }
                if (i13 > AndroidUtilities.dp(528.0f)) {
                    i15 = org.telegram.messenger.rk.z(528.0f, i13, 2);
