...
public final class a01 extends ReplacementSpan {
    ...
    public a01(View view, Bitmap bitmap, int i10, int i11, int i12, int i13) {
        this.b = i10;
        this.c = i11;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f9, int i12, int i13, int i14, Paint paint) {
        ...
        canvas.save();
        if (this.d) {
            imageReceiver.setImageCoords((int) f9, i13 - (i16 - this.e), i15, i16);
        } else {
            imageReceiver.setImageCoords((int) f9, j7.l1.e(org.telegram.messenger.x3.B(4.0f, i14, i12), i16, 2, i12), i15, i16);
        }
