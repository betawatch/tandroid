...
public final class oy extends ql0 {
    public em B;
    public boolean C;
    public int D;
    public int E;
    ...
    public oy(kz kzVar, Context context, boolean z4, int i10) {
        ...
        this.d = z4;
        this.f = i10;
        this.e = z4 ? null : new qy(kzVar, context);
    }
    ...
    public final void E(String str, String str2, boolean z4, boolean z10, boolean z11, String str3, TLObject tLObject) {
        ...
        if (tLObject instanceof TLRPC.messages_BotResults) {
            ...
            HashMap hashMap2 = kzVar.i0;
            oy oyVar = kzVar.k0;
            if (!hashMap2.containsKey(str3)) {
                kzVar.i0.put(str3, messages_botresults);
            }
        ...
        if (kzVar.e0.getAdapter() != this) {
            kzVar.e0.setAdapter(this);
        }
    ...
    public final void G(String str, boolean z4) {
        ...
        em emVar = this.B;
        if (emVar != null) {
            AndroidUtilities.cancelRunOnUIThread(emVar);
        }
        if (!TextUtils.isEmpty(str)) {
            ...
            em emVar2 = new em(17, this, str);
            this.B = emVar2;
            AndroidUtilities.runOnUIThread(emVar2, z4 ? 300L : 0L);
            return;
        }
        this.w = null;
        if (this.H) {
        ...
        if (currentPosition != kzVar.o0 && currentPosition != kzVar.p0) {
            H(MessagesController.getInstance(kzVar.Z0).gifSearchEmojies.get(currentPosition - kzVar.q0));
            return;
        }
    ...
    public final void l() {
        ...
        if (this.d && (i10 = this.f) != 0) {
            ...
            if (i10 == Integer.MAX_VALUE) {
                this.E = kzVar.f1.size();
            } else {
                jw jwVar = kzVar.e0;
                py pyVar = kzVar.f0;
                if (jwVar.getMeasuredWidth() != 0) {
                    int measuredWidth = kzVar.e0.getMeasuredWidth();
                    int i11 = pyVar.J;
                    int dp = AndroidUtilities.dp(100.0f);
                    this.E = 0;
                    int size = kzVar.f1.size();
                    int i12 = i11;
                    int i13 = 0;
                    int i14 = 0;
                    for (int i15 = 0; i15 < size; i15++) {
                        TLRPC.Document document = (TLRPC.Document) kzVar.f1.get(i15);
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        org.telegram.ui.Cells.d2 d2Var = (org.telegram.ui.Cells.d2) l1Var.a;
        int i11 = this.G;
        if (i11 >= 0 && i10 >= i11) {
