...
public final class oy extends rl0 {
    ...
    public final void G(String str, boolean z4) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            this.B = ilVar2;
            AndroidUtilities.runOnUIThread(ilVar2, z4 ? 300L : 0L);
            return;
        }
        this.w = null;
        if (this.H) {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        org.telegram.ui.Cells.e2 e2Var = (org.telegram.ui.Cells.e2) l1Var.a;
        int i11 = this.G;
        if (i11 >= 0 && i10 >= i11) {
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            if (i10 == 1) {
                ...
                org.telegram.ui.Cells.m8 m8Var = new org.telegram.ui.Cells.m8(this.c, false, false, kzVar.W1, kzVar.f2);
