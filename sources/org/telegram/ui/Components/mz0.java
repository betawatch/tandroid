...
public final class mz0 {
    ...
    public final void a(lf.i iVar, boolean z10) {
        ...
        for (int i10 = 0; i10 < nz0VarArr.length; i10++) {
            ...
            sz0 sz0Var2 = (sz0) ((Object[]) iVar.d)[((int[]) iVar.b)[i10]];
            int i11 = sz0Var2.a;
            if (!z10) {
                d = -d;
            }
    ...
    public final kz0[] d() {
        if (this.n == null) {
            ...
            int i10 = 0;
            while (true) {
                qz0[] qz0VarArr = (qz0[]) ((Object[]) iVar.c);
            ...
            int i11 = 0;
            while (true) {
                qz0[] qz0VarArr2 = (qz0[]) ((Object[]) iVar2.c);
    ...
    public final lf.i f() {
        ...
        if (!this.e) {
            ...
            for (int i11 = 0; i11 < childCount2; i11++) {
                ...
                lf.i iVar2 = this.d;
                nz0 nz0Var2 = (nz0) ((Object[]) iVar2.d)[((int[]) iVar2.b)[i11]];
    ...
    public final void n(int i10) {
        if (i10 != Integer.MIN_VALUE && i10 < h()) {
            throw new IllegalArgumentException(t8.b.v((this.a ? "column" : "row").concat("Count must be greater than or equal to the maximum of all grid indices (and spans) defined in the LayoutParams of each child"), ". "));
        }
        this.b = i10;
    }
