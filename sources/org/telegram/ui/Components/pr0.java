...
public final /* synthetic */ class pr0 implements Runnable {
    ...
    public /* synthetic */ pr0(org.telegram.ui.ActionBar.b2[] b2VarArr, int i10, int i11, int i12) {
        this.a = i12;
        this.b = b2VarArr;
        this.c = i10;
        this.d = i11;
        ...
        switch (this.a) {
            case 0:
                ...
                if (b2Var != null) {
                    ...
                    b2Var.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.Components.vr0
            ...
            default:
                ...
                if (b2Var2 != null) {
                    ...
                    b2Var2.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.Components.vr0
                        @Override // android.content.DialogInterface.OnCancelListener
                        public final void onCancel(DialogInterface dialogInterface) {
                            switch (i13) {
                                case 0:
