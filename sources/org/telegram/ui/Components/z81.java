...
public class z81 extends FrameLayout {
    ...
    public z81(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.c = 1.0f;
    ...
    */
            ...
            if (this.H || motionEvent == null || (q6 = q(this, motionEvent.getX(), motionEvent.getY())) == null || (!q6.canScrollHorizontally(1) && !q6.canScrollHorizontally(-1))) {
                if (motionEvent != null && motionEvent.getAction() == 0 && !this.H && !this.I) {
                    ...
                    if (this.H && (((z10 = this.y) && x11 > 0) || (!z10 && x11 < 0))) {
                        if (!C(motionEvent, x11 < 0)) {
                            this.I = true;
                            this.H = false;
                            F(viewArr[0], 0.0f);
                            View view = viewArr[1];
                            if (view != null) {
                                F(view, this.y ? viewArr[0].getMeasuredWidth() : -viewArr[0].getMeasuredWidth());
                            }
                            this.d = 0;
                            this.c = 1.0f;
                            o81 o81Var2 = this.M;
                            if (o81Var2 != null) {
                                o81Var2.e(1.0f, 0, this.b);
                            }
                            x(false);
                        }
                    }
                    if (this.I && !this.H) {
                        ...
                        if (this.d == -1) {
                            ...
                            if (view2 != null) {
                                if (this.y) {
                                    F(view2, viewArr[0].getMeasuredWidth() + x11);
                                } else {
                                    F(view2, x11 - viewArr[0].getMeasuredWidth());
                                }
                            }
                        }
                        float f12 = 1.0f - abs2;
                    ...
                    if (this.H) {
                        ...
                        if (this.F) {
                            f11 = Math.abs(x13);
                            if (this.y) {
                                this.w.playTogether(I(viewArr[0], 0.0f));
                                View view4 = viewArr[1];
                                if (view4 != null) {
                                    this.w.playTogether(I(view4, view4.getMeasuredWidth()));
                                }
                            } else {
                                this.w.playTogether(I(viewArr[0], 0.0f));
                                View view5 = viewArr[1];
                                if (view5 != null) {
                                    this.w.playTogether(I(view5, -view5.getMeasuredWidth()));
                                }
                            }
                        } else if (this.d >= 0) {
                            f11 = viewArr[0].getMeasuredWidth() - Math.abs(x13);
                            if (this.y) {
                                this.w.playTogether(I(viewArr[0], -r8.getMeasuredWidth()));
                                View view6 = viewArr[1];
                                if (view6 != null) {
                                    this.w.playTogether(I(view6, 0.0f));
                                }
                            } else {
                                this.w.playTogether(I(viewArr[0], r8.getMeasuredWidth()));
                                View view7 = viewArr[1];
                                if (view7 != null) {
                                    this.w.playTogether(I(view7, 0.0f));
                                }
                            }
                        } else {
                            f11 = 0.0f;
                        ...
                        if (this.d < 0) {
                            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.S, this.F ? 0.0f : 1.0f);
                            ofFloat.addUpdateListener(new m81(this, i10));
                        ...
                        this.w.addListener(new n81(this, i10));
                        this.w.start();
                        this.x = true;
                        this.H = false;
                        x(false);
    ...
    public final boolean C(MotionEvent motionEvent, boolean z10) {
        ...
        if ((z10 && this.b == this.L.e() - 1) || this.R != null || !i(motionEvent) || ((z10 && !k(motionEvent)) || (!z10 && !j(motionEvent)))) {
            return false;
        }
    ...
    public final void D(boolean z10) {
        ...
        q81 q81Var = this.L;
        q81Var.getClass();
        if (!(q81Var instanceof org.telegram.ui.e7)) {
            z10 = false;
        }
        ...
        if (view7 != null) {
            F(view7, -getMeasuredWidth());
        }
        View view8 = viewArr[1];
        if (view8 != null) {
            this.w.playTogether(I(view8, getMeasuredWidth()));
        }
        View view9 = viewArr[0];
        if (view9 != null) {
            this.w.playTogether(I(view9, 0.0f));
        }
        x(true);
        o81 o81Var = this.M;
        o81Var.a = 0.0f;
    ...
    public final void E(int i10) {
        if (i10 != this.b) {
            ...
            if (valueAnimator == null || this.d != i10) {
                ...
                if (z10) {
                    F(viewArr[1], measuredWidth);
                } else {
                    F(viewArr[1], -measuredWidth);
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.R = ofFloat;
                ofFloat.addUpdateListener(new m81(this, i11));
                this.R.addListener(new n81(this, i11));
    ...
    public final ValueAnimator I(View view, float f7) {
        ...
        ofFloat.addUpdateListener(new px0(this, view, 1));
        ofFloat.addListener(new p81(this, view, f7));
        return ofFloat;
    }
    ...
    public final void J(int i10) {
        ...
        q81 q81Var = this.L;
        q81Var.b(viewArr[i10], i11, q81Var.h(i11));
    }
        ...
        if (this.H) {
            ...
            if (this.F) {
                ...
                if (this.y) {
                    ...
                    View view2 = viewArr[1];
                    if (view2 != null) {
                        this.w.playTogether(I(view2, view2.getMeasuredWidth()));
                    }
                } else {
                    this.w.playTogether(I(viewArr[0], 0.0f));
                    View view3 = viewArr[1];
                    if (view3 != null) {
                        this.w.playTogether(I(view3, -view3.getMeasuredWidth()));
                    }
                }
            } else if (this.d >= 0) {
                f7 = viewArr[0].getMeasuredWidth() - Math.abs(x10);
                if (this.y) {
                    this.w.playTogether(I(viewArr[0], -r6.getMeasuredWidth()));
                    View view4 = viewArr[1];
                    if (view4 != null) {
                        this.w.playTogether(I(view4, 0.0f));
                    }
                } else {
                    this.w.playTogether(I(viewArr[0], r6.getMeasuredWidth()));
                    View view5 = viewArr[1];
                    if (view5 != null) {
                        this.w.playTogether(I(view5, 0.0f));
                    }
                }
            } else {
                f7 = 0.0f;
    ...
    public final boolean m() {
        ...
        if (z11) {
            if (Math.abs(viewArr[0].getTranslationX()) < 1.0f) {
                ...
                View view = viewArr[1];
                if (view != null) {
                    F(view, viewArr[0].getMeasuredWidth() * (this.y ? 1 : -1));
                }
                z10 = true;
            }
            z10 = false;
            ...
            if (Math.abs(viewArr[1].getTranslationX()) < 1.0f) {
                F(viewArr[0], r0.getMeasuredWidth() * (this.y ? -1 : 1));
                View view2 = viewArr[1];
                if (view2 != null) {
                    F(view2, 0.0f);
                }
    ...
    public final y81 n(int i10, boolean z10) {
        o81 o81Var = new o81(this, getContext(), z10, i10, this.a);
        this.M = o81Var;
        o81Var.r = H();
        this.M.setDelegate(new ki.e0(this, 14));
        o(false);
        return this.M;
    }
    ...
    public final void o(boolean z10) {
        o81 o81Var;
        if (this.L == null || (o81Var = this.M) == null) {
            return;
        }
        o81Var.h.clear();
        o81Var.b0.clear();
    ...
    public void setAdapter(q81 q81Var) {
        this.L = q81Var;
        int h = q81Var.h(this.b);
        int[] iArr = this.f;
        iArr[0] = h;
        View d = q81Var.d(h);
        View[] viewArr = this.e;
        ...
        if (d == null && this.b != 0) {
            ...
            int h10 = q81Var.h(0);
            iArr[0] = h10;
            viewArr[0] = q81Var.d(h10);
        }
        q81Var.b(viewArr[0], this.b, iArr[0]);
        addView(viewArr[0]);
        viewArr[0].setVisibility(0);
        o(false);
    }
