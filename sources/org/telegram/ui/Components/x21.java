...
public final class x21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public x21(Activity activity, org.telegram.ui.bo boVar, int i10, long j3, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.n = !org.telegram.messenger.y0.v("topics_end_reached_", j10, UserConfig.getInstance(i10).getPreferences(), false);
                    ...
                    case 0:
                        ...
                        if (topics != null) {
                            ...
                            while (i16 < size) {
                                ...
                                if (x21Var.e0.contains(Integer.valueOf(tL_forumTopic2.id))) {
                                    size = i18;
                                    i16 = i12;
                                } else {
                        ...
                        if (topics != null && !topics.isEmpty() && !topicsController2.endIsReached(j17) && x21Var.n) {
                    ...
                    default:
                        ...
                        if (topics2 != null) {
                            ...
                            while (i21 < size2) {
                                ...
                                if (x21Var.e0.contains(Integer.valueOf(tL_forumTopic4.id))) {
                                    chat2 = chat3;
                                    size2 = i22;
                                    user3 = user;
                                } else {
                        ...
                        if (topics2 != null && !topics2.isEmpty() && !topicsController.endIsReached(j20) && x21Var.n) {
                            int i24 = v21.a;
        ...
        frameLayout.addView(l21Var, w7.x5.d(-1, -1.0f, 119, 41.0f, 0.0f, 0.0f, 0.0f));
        l21Var.j(new m21(this, 0));
        if (isBotForumWithEditableTopics) {
            w21 w21Var = new w21(activity, i10, e6Var);
            this.v = w21Var;
            w21Var.c(true, false, this.V == 0);
            final int i13 = 2;
            w21Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.g21
                public final /* synthetic */ x21 b;
            ...
            viewGroup.addView(w21Var, w7.x5.d(64, 42.0f, 51, 0.0f, 48.0f, 0.0f, 0.0f));
        } else {
            viewGroup = frameLayout2;
            this.v = null;
        }
        ...
        viewGroup2.addView(n21Var, w7.x5.d(-1, -1.0f, 119, 0.0f, isBotForumWithEditableTopics ? 90.0f : 48.0f, 0.0f, 0.0f));
        n21Var.j(new m21(this, 1));
        final int i16 = 0;
        ImageView i17 = i(activity, R.drawable.menu_sidebar_left, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.g21
            public final /* synthetic */ x21 b;
        ...
        this.y = i17;
        final int i18 = 0;
        ImageView i19 = i(activity, R.drawable.menu_sidebar_left, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.g21
            public final /* synthetic */ x21 b;
        ...
        final int i20 = 1;
        ImageView i21 = i(activity, R.drawable.msg_select, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.g21
            public final /* synthetic */ x21 b;
        ...
        this.w = i21;
        final int i22 = 1;
        ImageView i23 = i(activity, R.drawable.msg_select, new View.OnClickListener(this) { // from class: org.telegram.ui.Components.g21
            public final /* synthetic */ x21 b;
        ...
        if (org.telegram.messenger.y0.v("topicssidetabs", j3, mainSettings, false)) {
            this.R = 1.0f;
            this.Q = true;
        }
        boolean v = org.telegram.messenger.y0.v("topicssidetabsb", j3, mainSettings, false);
        this.P = v;
    ...
    public static void a(x21 x21Var, i51 i51Var) {
        if (x21Var.e) {
            Utilities.Callback2 callback2 = x21Var.c0;
            if (callback2 != null) {
        ...
        Utilities.Callback2 callback22 = x21Var.a0;
        if (callback22 != null) {
    ...
    public static boolean c(final x21 x21Var, i51 i51Var, View view) {
        ...
        if (ChatObject.isMonoForum(chat)) {
            ...
            if (user2 == null || !ChatObject.canBlockUsers(chat3)) {
                ...
                y3.setVisibility(8);
                n70Var2 = I;
                MessagesController.getInstance(i12).checkIsInChat(true, chat3, user2, new d21(x21Var, y3, I, j10, user2, chat3));
            }
            n70Var = n70Var2;
            e6Var = e6Var2;
            r62 = 1;
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                ...
                I.c(z11 ? R.drawable.msg_unpin : R.drawable.msg_pin, LocaleController.getString(z11 ? R.string.DialogUnpin : R.string.DialogPin), new jn0(x21Var, I, messagesController, tL_forumTopic), false);
                if (tL_forumTopic.pinned) {
                    I.c(R.drawable.tabs_reorder, LocaleController.getString(R.string.FilterReorder), new e21(x21Var, i13), false);
                }
            }
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(x21Var) { // from class: org.telegram.ui.Components.f21
                    public final /* synthetic */ x21 b;
                    ...
                    public final void run() {
                        ...
                        switch (i14) {
                            case 0:
                                n70Var3.u();
                                x21Var2.h.presentFragment(af1.a0(-x21Var2.c, tL_forumTopic2.id));
                                break;
                            case 1:
                                x21Var2.getClass();
                                n70Var3.u();
                                MessagesController.getInstance(x21Var2.b).getTopicsController().toggleCloseTopic(-x21Var2.c, tL_forumTopic2.id, true ^ tL_forumTopic2.closed);
                                break;
                            default:
                                n70Var3.u();
                                ...
                                sh shVar = new sh(11);
                                x21 x21Var3 = this.b;
                                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(x21Var3.getContext());
                                ...
                                if (hashSet.size() == 1) {
                                    z12 = false;
                                    b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, MessagesController.getInstance(x21Var3.b).getTopicsController().findTopic(-x21Var3.c, ((Integer) arrayList.get(0)).intValue()).title);
                                } else {
                                    z12 = false;
                                    b2Var.T = LocaleController.getString(R.string.DeleteSelectedTopics);
                                }
                                alertDialog$Builder.k(LocaleController.getString(R.string.Delete), new org.telegram.ui.we(x21Var3, arrayList, j12, hashSet, shVar));
                                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new in0(10));
                                b2Var.show();
            ...
            b10 = 0;
            n70Var = I;
            n70Var.c(isDialogMuted ? R.drawable.msg_unmute : R.drawable.msg_mute, LocaleController.getString(isDialogMuted ? R.string.Unmute : R.string.Mute), new ai.m3(x21Var, messagesController, tL_forumTopic, I, J, 25), false);
            if (!ChatObject.canManageTopic(i12, chat4, tL_forumTopic) || UserObject.isBotForum(user)) {
                ...
                n70Var.c(i14, string, new Runnable(x21Var) { // from class: org.telegram.ui.Components.f21
                    public final /* synthetic */ x21 b;
                    ...
                    public final void run() {
                        ...
                        switch (i142) {
                            ...
                            default:
                                ...
                                alertDialog$Builder.k(LocaleController.getString(R.string.Delete), new org.telegram.ui.we(x21Var3, arrayList, j122, hashSet, shVar));
                                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new in0(10));
                                b2Var.show();
                                TextView textView = (TextView) b2Var.d(-1);
                                if (textView != null) {
            ...
            if (ChatObject.canDeleteTopic(i12, chat4, tL_forumTopic)) {
                n70Var.c(R.drawable.msg_delete, LocaleController.getPluralString("DeleteTopics", z10 ? 1 : 0), new Runnable(x21Var) { // from class: org.telegram.ui.Components.f21
                    public final /* synthetic */ x21 b;
    ...
    public t21 getCurrentTabsPosition() {
        return this.Q ? t21.b : this.P ? t21.c : t21.a;
    }
    ...
    public final void h() {
        ...
        if (this.P) {
            frameLayout.setTranslationY(((getMeasuredHeight() - AndroidUtilities.dp(50.0f)) - this.M) + AndroidUtilities.lerp(AndroidUtilities.dp(43.0f), 0, j(t21.c)));
        } else {
            frameLayout.setTranslationY(this.N + AndroidUtilities.lerp(-AndroidUtilities.dp(43.0f), 0, j(t21.a)));
        }
    }
    ...
    public final float j(t21 t21Var) {
        ...
        if (t21Var == t21.b) {
            ...
            if ((t21Var != t21.a || this.P) && !(t21Var == t21.c && this.P)) {
                return 0.0f;
            }
            f7 = 1.0f - this.R;
        }
    ...
    public final boolean k() {
        if (this.R <= 0.5f) {
            ...
            while (true) {
                ...
                i51 G = l21Var.Y2.G(RecyclerView.R(l21Var.getChildAt(i10)));
                if (G != null && G.r) {
                    return true;
                }
                i10++;
            ...
            while (true) {
                ...
                i51 G2 = n21Var.Y2.G(RecyclerView.R(n21Var.getChildAt(i11)));
                if (G2 != null && G2.r) {
                    return true;
                }
                i11++;
    ...
    public final void n() {
        ...
        int d = i0.a.d(1.0f - this.R, v02, org.telegram.ui.ActionBar.i6.v0(i11, e6Var));
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.y.setColorFilter(new PorterDuffColorFilter(d, mode));
        this.E.setColorFilter(new PorterDuffColorFilter(i0.a.d(this.R, org.telegram.ui.ActionBar.i6.v0(i10, e6Var), org.telegram.ui.ActionBar.i6.v0(i11, e6Var)), mode));
        this.w.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i11, e6Var), mode));
        this.x.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i11, e6Var), mode));
        invalidate();
    }
