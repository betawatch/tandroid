...
public final class cc0 extends View {
    ...
    public cc0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        int[] iArr;
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Nd, e6Var);
        if (e6Var instanceof org.telegram.ui.xn) {
            org.telegram.ui.xn xnVar = (org.telegram.ui.xn) e6Var;
            if ((xnVar.d() instanceof lc0) && (iArr = ((lc0) xnVar.d()).a) != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF = this.r;
        if (z10 && z11) {
            AndroidUtilities.lerp(((bc0) arrayList.get(floor)).c, ((bc0) arrayList.get(ceil)).c, f7 - floor, rectF);
        } else if (z10) {
            rectF.set(((bc0) arrayList.get(floor)).c);
        } else if (z11) {
            rectF.set(((bc0) arrayList.get(ceil)).c);
        }
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            bc0Var.b.c(bc0Var.c.left + this.h, getMeasuredHeight() / 2.0f, 1.0f, i0.a.d(1.0f - Math.abs(f7 - i10), this.d, this.e), canvas);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            f7 += ((bc0) arrayList.get(i12)).b.l() + this.h + this.h;
            i12++;
        }
        ...
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            float l4 = ((bc0) arrayList.get(i13)).b.l() + this.h + this.h;
            ((bc0) arrayList.get(i13)).c.set(f12, dp, f12 + l4, dp2);
            ((bc0) arrayList.get(i13)).d.set(((bc0) arrayList.get(i13)).c);
            ((bc0) arrayList.get(i13)).d.inset((-this.n) / 2.0f, -dp);
            f12 += l4 + this.n;
        }
        Drawable drawable = this.f;
        if (drawable != null) {
