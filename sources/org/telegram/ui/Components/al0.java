...
public final class al0 extends View {
    public boolean B;
    public float C;
    public float D;
    ...
    public al0(rl0 rl0Var, Context context, int i10) {
        super(context);
        org.telegram.ui.ActionBar.f6 f6Var = rl0Var.m2;
        this.l0 = rl0Var;
        this.a = true;
        this.b = new RectF();
        this.c = new Paint(1);
        ...
        if (layoutManager instanceof f2.i0) {
            ...
            if (i0Var.o == 1) {
                ...
                if (adapter instanceof bl0) {
                    ...
                    float f10 = this.e;
                    int[] iArr = this.T;
                    bl0Var.G(rl0Var, f10, iArr);
                    if (z4) {
                        i0Var.h1(iArr[0], (-iArr[1]) + rl0Var.t1);
                    }
                    String F = bl0Var.F(iArr[0]);
                    if (F == null) {
    ...
    public final void c() {
        rl0 rl0Var = this.l0;
        int i10 = this.O;
        this.P = i10 == 0 ? org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.m7, rl0Var.m2) : i0.a.k(-16777216, 102);
        this.Q = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.l7, rl0Var.m2);
        this.c.setColor(this.P);
        TextPaint textPaint = this.E;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.n7, rl0Var.m2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, rl0Var.m2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i11 == 0) {
            ...
            rl0 rl0Var = this.l0;
            f12 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.j6.v0(i12, rl0Var.m2), -1));
            ...
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, rl0Var.m2));
            canvas.save();
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        f2.o0 adapter2 = rl0Var.getAdapter();
        if (this.n && !this.h0 && System.currentTimeMillis() - this.i0 < 150 && (adapter2 instanceof bl0)) {
            ((bl0) adapter2).I();
        }
        this.h0 = false;
        this.n = false;
        this.M = System.currentTimeMillis();
        invalidate();
        if (adapter2 instanceof bl0) {
            ((bl0) adapter2).J(rl0Var);
        }
        b();
        return true;
        return true;
