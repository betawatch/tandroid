...
public final class xo0 {
    ...
    */
    public final void c(Canvas canvas, org.telegram.ui.Cells.u1 u1Var) {
        ...
        canvas.restore();
        if (this.M == null) {
            this.M = new wo0(new jc0(this, 27));
        }
        float f19 = this.K;
        if (f19 < 0.99f && (fArr = this.G) != null) {
            ...
            if (i18 >= 0 && i18 < fArr.length) {
                ...
                wo0Var = this.M;
                ((Paint) wo0Var.f).setColor(this.q);
                wo0Var.g = rectF;
                float f22 = this.L;
                Paint paint = (Paint) wo0Var.f;
                ArrayList arrayList2 = (ArrayList) wo0Var.e;
                arrayList = (ArrayList) wo0Var.d;
                long currentTimeMillis = System.currentTimeMillis();
                long min2 = Math.min(20L, currentTimeMillis - wo0Var.b);
                wo0Var.b = currentTimeMillis;
                i11 = 0;
                while (i11 < arrayList.size()) {
                    vo0 vo0Var = (vo0) arrayList.get(i11);
                    float f23 = min2;
                    float f24 = vo0Var.f - (f23 / vo0Var.g);
                    vo0Var.f = f24;
                    if (f24 < 0.0f) {
                        ...
                        float f26 = vo0Var.d;
                        float f27 = vo0Var.c;
                        vo0Var.a = (((f26 * f27) * f23) / 500.0f) + f25;
                        float f28 = vo0Var.b;
                        float f29 = vo0Var.e;
                        vo0Var.b = (((f27 * f29) * f23) / 500.0f) + f28;
                        vo0Var.e = f29 - ((AndroidUtilities.dp(0.33f) * min2) / 500.0f);
                    }
                    i11++;
                }
                if (((RectF) wo0Var.g) != null) {
                    int min3 = Math.min(4, wo0Var.a - arrayList.size());
                    for (int i19 = 0; i19 < min3; i19++) {
                        vo0 vo0Var2 = arrayList2.isEmpty() ? new vo0() : (vo0) arrayList2.remove(0);
                        RectF rectF2 = (RectF) wo0Var.g;
                        vo0Var2.a = (Utilities.random.nextFloat() * rectF2.width()) + rectF2.left;
                        RectF rectF3 = (RectF) wo0Var.g;
                        vo0Var2.b = (Utilities.random.nextFloat() * rectF3.height()) + rectF3.top;
                        double nextInt = (Utilities.random.nextInt(200) - 125) * 0.017453292519943295d;
                        vo0Var2.d = ((float) (Math.cos(nextInt) - Math.sin(nextInt))) * 0.8f;
                        vo0Var2.e = ((float) (Math.cos(nextInt) + Math.sin(nextInt))) - 0.2f;
                        vo0Var2.f = 1.0f;
                        vo0Var2.c = AndroidUtilities.dp((Utilities.random.nextFloat() * 7.0f) + 10.0f);
                        vo0Var2.g = AndroidUtilities.lerp(420, 550, Utilities.random.nextFloat());
                        arrayList.add(vo0Var2);
                    }
                }
                for (i12 = 0; i12 < arrayList.size(); i12++) {
                    vo0 vo0Var3 = (vo0) arrayList.get(i12);
                    paint.setAlpha((int) (255.0f * f22 * vo0Var3.f));
                    canvas.drawPoint(vo0Var3.a, vo0Var3.b, paint);
                }
                jc0Var = (jc0) wo0Var.c;
                if (jc0Var == null) {
                    jc0Var.run();
        ...
        wo0Var.g = rectF;
        float f222 = this.L;
        Paint paint2 = (Paint) wo0Var.f;
        ArrayList arrayList22 = (ArrayList) wo0Var.e;
        arrayList = (ArrayList) wo0Var.d;
        long currentTimeMillis2 = System.currentTimeMillis();
        long min22 = Math.min(20L, currentTimeMillis2 - wo0Var.b);
        wo0Var.b = currentTimeMillis2;
        i11 = 0;
        while (i11 < arrayList.size()) {
        }
        if (((RectF) wo0Var.g) != null) {
