...
public final class h61 extends Drawable {
    ...
    public h61() {
        ...
        this.h = wcVar;
        this.i = new me.b(new org.telegram.ui.Cells.ia(this, 4));
    ...
    public final void b() {
        int w02 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.ic, false);
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        this.a.setColorFilter(new PorterDuffColorFilter(w02, mode));
        this.b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.l1(0.11f, -16777216), mode));
        this.c.setColor(w02);
        this.d.setColor(i0.a.k(w02, 179));
        this.e.setColor(w02);
        this.f.setColor(org.telegram.ui.ActionBar.i6.l1(0.11f, -16777216));
    }
