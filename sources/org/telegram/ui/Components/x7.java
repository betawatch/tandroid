    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (!z10) {
            ...
            if (i19 + translationY < org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) {
                ...
                if (!z10 && f7 != 0.0f) {
                    ...
                    int themedColor = j8Var.getThemedColor(org.telegram.ui.ActionBar.h6.Ii);
        ...
        if (!z10) {
            ...
            int themedColor2 = j8Var.getThemedColor(org.telegram.ui.ActionBar.h6.Ii);
            int alpha2 = Color.alpha(themedColor2);
            org.telegram.ui.ActionBar.h6.t0.setColor(themedColor2);
            org.telegram.ui.ActionBar.h6.t0.setAlpha((int) (alpha2 * 1.0f * f7));
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.h6.t0);
        }
        if (z10) {
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!j8Var.f) {
            ...
            if (!z12) {
                ...
                ((FrameLayout.LayoutParams) u7Var.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
                ((FrameLayout.LayoutParams) j8Var.d.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
        ...
        ((FrameLayout.LayoutParams) j8Var.d.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
        ((FrameLayout.LayoutParams) p7Var2.getLayoutParams()).topMargin = -getPaddingTop();
        int dp22 = AndroidUtilities.dp(MessagesStorage.LAST_DB_VERSION + ((!j8Var.s0() || j8Var.z0) ? 0 : 52));
        if (j8Var.x0.size() > 1) {
        }
        if (!j8Var.h) {
        }
