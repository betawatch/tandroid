...
public final class tz extends FrameLayout {
    ...
    public tz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.a = f6Var;
        View radialProgressView = new RadialProgressView(context, null);
        addView(radialProgressView, w7.a6.c(-2.0f, -2));
        ...
        linearLayout.addView(kj0Var, w7.a6.t(ImageReceiver.DEFAULT_CROSSFADE_DURATION, ImageReceiver.DEFAULT_CROSSFADE_DURATION, 17, 0, 0, 0, 20));
        ...
        linearLayout.addView(textView, w7.a6.q(-2, -2, 17));
        ...
        setOnTouchListener(new ai.h(18));
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                View view = this.c;
                if (childAt == view && (view instanceof a10)) {
