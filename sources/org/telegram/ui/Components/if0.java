...
public final class if0 extends View {
    ...
    public final void a(int i10, MotionEvent motionEvent) {
        ...
        nf0 nf0Var = this.w;
        int i11 = nf0Var.f;
        of0 of0Var = i11 != 0 ? i11 != 1 ? i11 != 2 ? i11 != 3 ? null : nf0Var.d : nf0Var.c : nf0Var.b : nf0Var.a;
        int i12 = this.a;
        if (i12 == 1) {
            of0Var.a = Math.max(0.0f, Math.min(100.0f, of0Var.a + min));
        } else if (i12 == 2) {
            of0Var.b = Math.max(0.0f, Math.min(100.0f, of0Var.b + min));
        } else if (i12 == 3) {
            of0Var.c = Math.max(0.0f, Math.min(100.0f, of0Var.c + min));
        } else if (i12 == 4) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i14 = 0;
        while (i14 < 5) {
            String format = i14 != 0 ? i14 != 1 ? i14 != i13 ? i14 != i12 ? i14 != 4 ? "" : String.format(Locale.US, "%.2f", Float.valueOf(of0Var.e / 100.0f)) : String.format(Locale.US, "%.2f", Float.valueOf(of0Var.d / 100.0f)) : String.format(Locale.US, "%.2f", Float.valueOf(of0Var.c / 100.0f)) : String.format(Locale.US, "%.2f", Float.valueOf(of0Var.b / 100.0f)) : String.format(Locale.US, "%.2f", Float.valueOf(of0Var.a / 100.0f));
