...
public final class if0 extends FrameLayout {
    ...
    private float getActualInnerRadius() {
        uv0 uv0Var = this.d;
        return Math.min(uv0Var.a, uv0Var.b) * this.f;
    }

    private float getActualOuterRadius() {
        uv0 uv0Var = this.d;
        return Math.min(uv0Var.a, uv0Var.b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        uv0 uv0Var = this.d;
        float min = Math.min(uv0Var.a, uv0Var.b);
        ...
        if (i12 == 0) {
            ...
            if (c10 == 1) {
                ...
                float f19 = y3 - this.v;
                float width = (getWidth() - uv0Var.a) / 2.0f;
                int i13 = !z10 ? AndroidUtilities.statusBarHeight : 0;
                float height = getHeight();
                float f20 = uv0Var.b;
                float A = com.google.android.gms.internal.vision.e2.A(height, f20, 2.0f, i13);
                PointF pointF = new PointF(Math.max(width, Math.min(uv0Var.a + width, this.a.x + f18)), Math.max(A, Math.min(f20 + A, this.a.y + f19)));
                float f21 = pointF.x - width;
                float f22 = uv0Var.a;
                this.e = new PointF(f21 / f22, (((f22 - uv0Var.b) / 2.0f) + (pointF.y - A)) / f22);
            } else if (c10 == 2) {
            ...
            if (c11 == 1) {
                ...
                float f26 = y3 - this.v;
                float width2 = (getWidth() - uv0Var.a) / 2.0f;
                ...
                PointF pointF2 = new PointF(Math.max(width2, Math.min(uv0Var.a + width2, this.a.x + f25)), Math.max(A2, Math.min(f27 + A2, this.a.y + f26)));
                float f28 = pointF2.x - width2;
                float f29 = uv0Var.a;
                this.e = new PointF(f28 / f29, (((f29 - uv0Var.b) / 2.0f) + (pointF2.y - A2)) / f29);
            } else if (c11 == 2) {
