    ...
    public final void z() {
        ...
        if (f10 < 1.0f) {
            ...
            if (z4) {
                ...
                nr nrVar = this.e;
                if (z12) {
                    float interpolation2 = nrVar.getInterpolation(f10);
                    ...
                    float interpolation3 = (this.D != null || this.d) ? this.h : nrVar.getInterpolation(this.h);
                    ...
                    interpolation = (this.D != null || this.d) ? this.h : nrVar.getInterpolation(this.h);
