...
public final class dc0 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.save();
        Bitmap e7 = e();
        float f7 = e7 != null ? bounds.top : this.f;
        ...
        boolean z10 = (Build.VERSION.SDK_INT < 28 || this.Q == null || this.k == null || e7 == null) ? false : true;
        int i12 = this.q;
        float f16 = 1.0f;
        Paint paint = this.n;
        Paint paint2 = this.o;
        ...
        if (i12 < 0) {
            ...
            if (e7 != null) {
                if (z11) {
                    ...
                    if (z10) {
                        Paint e11 = this.Q.e(this.k, e7, this.U, (int) (this.L * this.J), this.q, canvas.isHardwareAccelerated());
                        this.Q.d(this.A);
                        this.Q.c(rectF);
                        float f23 = this.I;
            ...
            if (e7 != null) {
                ...
                paint2.setAlpha((int) ((Math.abs(this.q) / 100.0f) * this.L * this.J));
                if (z12) {
                    Paint e12 = this.Q.e(this.k, e7, this.U, (int) (this.L * this.J), this.q, canvas.isHardwareAccelerated());
                    ic0 ic0Var = this.Q;
                    RectF rectF2 = ic0Var.j;
                    rectF2.set(0.0f, 0.0f, ic0Var.g, ic0Var.h);
                    Matrix matrix = ic0Var.i;
    ...
    public final void z() {
        ...
        if (f7 < 1.0f) {
            ...
            if (z10) {
                ...
                pr prVar = this.e;
                if (z13) {
                    float interpolation2 = prVar.getInterpolation(f7);
