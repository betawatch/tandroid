...
public final class ag0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public ag0(Context context, int i9, MessageObject messageObject, org.telegram.ui.ActionBar.b6 b6Var) {
        ...
        while (true) {
            ...
            if (pollAnswerVoters.voters != 0) {
                ...
                int i11 = pollAnswerVoters.voters;
                i11 = i11 > 15 ? 10 : i11;
                for (int i12 = 0; i12 < i11; i12++) {
                    tL_messages_votesList.votes.add(new TLRPC.TL_messagePeerVoteInputOption());
                }
                int i13 = pollAnswerVoters.voters;
                tL_messages_votesList.next_offset = i11 < i13 ? "empty" : null;
                tL_messages_votesList.count = i13;
                this.x.add(new zf0(tL_messages_votesList, pollAnswerVoters.option));
                ...
                Integer valueOf = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPollVotes, new ff.j0(this, numArr, i10, arrayList, pollAnswerVoters, 8)));
                numArr[i10] = valueOf;
                this.B.add(valueOf);
            }
            i10++;
        ...
        Q();
        Collections.sort(this.x, new sf0(this));
        R();
        Drawable mutate = context.getResources().getDrawable(R.drawable.sheet_shadow_round).mutate();
        this.d = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.i5, false), PorterDuff.Mode.MULTIPLY));
        ...
        getContext();
        uf0Var.setLayoutManager(new of.y(1, z10, 8));
        ...
        this.f = r7Var;
        r7Var.setBackgroundColor(org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.h5, false));
        r7Var.setBackButtonImage(R.drawable.ic_ab_back);
        r7Var.C(org.telegram.ui.ActionBar.f6.w0(null, i15, false), false);
        r7Var.A(org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.I5, false), false);
        r7Var.setTitleColor(org.telegram.ui.ActionBar.f6.w0(null, i15, false));
                ...
                while (true) {
                    if (i11 < size2) {
                        ...
                        if (Arrays.equals(zf0Var.d, zf0Var2.d)) {
                            zf0Var2.c = zf0Var.c;
                            if (zf0Var2.a != zf0Var.a || zf0Var2.b.size() != zf0Var.b.size()) {
                                z10 = true;
                            }
                            zf0Var2.a = zf0Var.a;
                            zf0Var2.b = zf0Var.b;
            ...
            if (uf0Var != null) {
                ...
                for (int i12 = 0; i12 < childCount; i12++) {
                    ...
                    if (childAt instanceof PollVotesAlert$UserCell) {
                        ...
                        f2.q1 T = F == null ? null : uf0Var.T(F);
                        if (T != null) {
    ...
    public static void n(ag0 ag0Var, zf0 zf0Var, TLObject tLObject) {
        if (ag0Var.isShowing()) {
            ...
            if (tLObject != null) {
                TLRPC.TL_messages_votesList tL_messages_votesList = (TLRPC.TL_messages_votesList) tLObject;
                MessagesController.getInstance(ag0Var.currentAccount).putUsers(tL_messages_votesList.users, false);
                zf0Var.b.addAll(tL_messages_votesList.votes);
                zf0Var.c = tL_messages_votesList.next_offset;
                ag0Var.N(null);
                ag0Var.c.X(true);
            }
        }
        ...
        if (AndroidUtilities.isContextSafe(context)) {
            ...
            if (arrayList == null || arrayList.isEmpty()) {
                ...
                if (view instanceof org.telegram.ui.Cells.p8) {
                    ...
                    zf0 zf0Var = (zf0) ag0Var.x.get(S);
                    if (Q != zf0Var.b() || hashSet.contains(zf0Var)) {
                        return;
                    }
                    if (zf0Var.e && zf0Var.f < zf0Var.b.size()) {
                        int min = Math.min(zf0Var.f + 50, zf0Var.b.size());
                        zf0Var.f = min;
                        if (min == zf0Var.b.size()) {
                            zf0Var.e = false;
                        }
                        ag0Var.N(null);
                        wf0Var.X(true);
                    ...
                    hashSet.add(zf0Var);
                    TLRPC.TL_messages_getPollVotes tL_messages_getPollVotes = new TLRPC.TL_messages_getPollVotes();
                    tL_messages_getPollVotes.peer = ag0Var.s;
                    tL_messages_getPollVotes.id = ag0Var.n.getId();
                    ...
                    tL_messages_getPollVotes.offset = zf0Var.c;
                ...
                if (view instanceof PollVotesAlert$UserCell) {
                    ...
                    if (U instanceof org.telegram.ui.qn) {
                        if (pollVotesAlert$UserCell.h != null) {
                            ...
                            if (i12 != null && i12.id == pollVotesAlert$UserCell.h.id) {
                                i10 = 1;
                            }
                            profileActivity.N4(i10);
                        } else {
                            TLRPC.Chat chat = ((org.telegram.ui.qn) U).e;
    ...
    public static void t(ag0 ag0Var) {
        ...
        if ((z10 && r7Var.getTag() == null) || (!z10 && r7Var.getTag() != null)) {
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(r7Var, (Property<r7, Float>) property, z10 ? 1.0f : 0.0f), ObjectAnimator.ofFloat(ag0Var.e, (Property<View, Float>) property, z10 ? 1.0f : 0.0f));
    ...
    public final void N(View view) {
        ...
        while (true) {
            ...
            View pinnedHeader = i9 == -2 ? view : i9 == -1 ? uf0Var.getPinnedHeader() : uf0Var.getChildAt(i9);
            if ((pinnedHeader instanceof yf0) && (pinnedHeader.getTag(R.id.object_tag) instanceof zf0)) {
                yf0 yf0Var = (yf0) pinnedHeader;
                zf0 zf0Var = (zf0) pinnedHeader.getTag(R.id.object_tag);
                ...
                while (true) {
                    if (i11 < size) {
                        ...
                        if (!Arrays.equals(pollAnswer.option, zf0Var.d) || ((xf0) this.w.get(zf0Var)) == null) {
                            i11++;
                        } else {
                            ...
                            yf0Var.a(tL_textWithEntities == null ? "" : tL_textWithEntities.text, tL_textWithEntities == null ? null : tL_textWithEntities.entities, O(zf0Var.d), zf0Var.a, zf0Var.a(), true);
        ...
        View view2 = uf0Var.n1;
        if (view2 != null) {
            view2.measure(View.MeasureSpec.makeMeasureSpec(uf0Var.getMeasuredWidth(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(uf0Var.getMeasuredHeight(), 0));
            View view3 = uf0Var.n1;
            view3.layout(0, 0, view3.getMeasuredWidth(), uf0Var.n1.getMeasuredHeight());
            uf0Var.invalidate();
        }
        uf0Var.invalidate();
    }
    ...
    public final void Q() {
        ...
        while (i10 < size) {
            ...
            hashMap2.put(zf0Var, xf0Var);
            if (!tL_messageMediaPoll.results.results.isEmpty()) {
                int size2 = tL_messageMediaPoll.results.results.size();
                int i13 = 0;
                while (i13 < size2) {
                    hashMap = hashMap2;
                    if (Arrays.equals(zf0Var.d, tL_messageMediaPoll.results.results.get(i13).option)) {
    ...
    public final void R() {
        ...
        int w03 = org.telegram.ui.ActionBar.f6.w0(null, org.telegram.ui.ActionBar.f6.i5, false);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.f, 1, null, null, null, null, i9));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, 32768, null, null, null, null, org.telegram.ui.ActionBar.f6.A5));
        int i10 = org.telegram.ui.ActionBar.f6.j5;
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.f, 64, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.f, 128, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.f, 1024, null, null, null, null, org.telegram.ui.ActionBar.f6.Pi));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.f, 256, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.y, 4, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.e, 1, null, null, null, null, org.telegram.ui.ActionBar.f6.V5));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, 0, new Class[]{View.class}, null, null, null, -1, s6Var, i9));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, 0, new Class[]{View.class}, null, null, null, -1, s6Var, org.telegram.ui.ActionBar.f6.i5));
        int i11 = org.telegram.ui.ActionBar.f6.f7;
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, TLObject.FLAG_19, new Class[]{yf0.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, TLObject.FLAG_19, new Class[]{yf0.class}, new String[]{"middleTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, TLObject.FLAG_19, new Class[]{yf0.class}, new String[]{"righTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, 524304, new Class[]{yf0.class}, null, null, null, org.telegram.ui.ActionBar.f6.e7));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, 0, new Class[]{PollVotesAlert$UserCell.class}, new String[]{"nameTextView"}, null, null, -1, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, 0, new Class[]{org.telegram.ui.Cells.p8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.f6.q6));
        arrayList.add(new org.telegram.ui.ActionBar.h6(this.b, 0, new Class[]{org.telegram.ui.Cells.p8.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.f6.N6));
        return arrayList;
    }
}
