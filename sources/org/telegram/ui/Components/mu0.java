...
public final class mu0 implements org.telegram.ui.Cells.k1 {
    ...
    public final void P0(int i10, org.telegram.ui.Cells.t1 t1Var) {
        if (i10 == 80) {
            org.telegram.ui.ActionBar.p2 p2Var = this.c.s.v1;
    ...
    public final void m(org.telegram.ui.Cells.t1 t1Var, TLRPC.PollAnswer pollAnswer, TLRPC.MessageMedia messageMedia, int i10) {
        ...
        int i13 = this.a;
        if (geoPoint != null) {
            if (AndroidUtilities.isMapsInstalled(iv0Var.v1)) {
                gu0 gu0Var = new gu0(3);
                gu0Var.setResourceProvider(f6Var);
                TLRPC.TL_message tL_message = new TLRPC.TL_message();
                tL_message.local_id = -1;
                tL_message.peer_id = MessagesController.getInstance(i13).getPeer(iv0Var.j1);
                ...
                gu0Var.O0 = false;
                gu0Var.u0(new MessageObject(UserConfig.selectedAccount, tL_message, false, false));
                iv0Var.v1.presentFragment(gu0Var);
                return;
            }
            return;
        }
        if (MessageObject.isAnyKindOfStickerOrEmoji(messageMedia.document)) {
            org.telegram.ui.tt.q().w(iv0Var.v1.getParentActivity());
        ...
        if (messageMedia3 != null && messageMedia3.geo == null && ((document3 = messageMedia3.document) == null || MessageObject.isVideoDocument(document3))) {
            ...
            arrayList2.add(new iu0(i13, a2, false, true));
            arrayList.add(-2);
        } else {
            i11 = -1;
        }
        if (messageObject.expandedExplanation && (pollResults = tL_messageMediaPoll.results) != null && (messageMedia2 = pollResults.solution_media) != null && messageMedia2.geo == null && ((document2 = messageMedia2.document) == null || MessageObject.isVideoDocument(document2))) {
            ...
            arrayList2.add(new ju0(i13, a10, false, true));
            arrayList.add(-3);
        }
        int i14 = i13;
        yf.d.b(tL_messageMediaPoll.poll, UserConfig.getInstance(i13).getClientUserId());
        ...
        while (i15 < arrayList3.size()) {
            ...
            if (messageMedia4 != null && messageMedia4.geo == null && ((document = messageMedia4.document) == null || MessageObject.isVideoDocument(document))) {
                ...
                i12 = i14;
                message = message2;
                arrayList2.add(new ku0(i12, a11, false, true));
        ...
        PhotoViewer.t1().K2(null, iv0Var.v1, f6Var);
        PhotoViewer.t1().a2(arrayList2, i11, iv0Var.j1, 0L, 0L, new lu0(this));
    }
    ...
    @Override // org.telegram.ui.Cells.k1
    public final /* synthetic */ void V0(org.telegram.ui.Cells.t1 t1Var, CharacterStyle characterStyle, boolean z10) {
    }
