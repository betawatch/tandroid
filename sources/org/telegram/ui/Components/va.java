...
public final class va extends cw0 {
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        z11 = ((org.telegram.ui.ActionBar.f3) abVar).keyboardVisible;
        ...
        for (int i20 = 0; i20 < childCount; i20++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (i23 == 1) {
                    ...
                    i15 = ((org.telegram.ui.ActionBar.f3) abVar).backgroundPaddingLeft;
                }
                i16 = i14 - i15;
                if (i22 == 16) {
                }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (AndroidUtilities.dp(20.0f) >= 0) {
            z10 = ((org.telegram.ui.ActionBar.f3) abVar).keyboardVisible;
            int emojiPadding = (z10 || (juVar = abVar.Q) == null) ? 0 : juVar.getEmojiPadding();
