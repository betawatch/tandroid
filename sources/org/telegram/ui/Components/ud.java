    ...
    public final void onClick(View view) {
        ...
        switch (i12) {
            case 0:
                ...
                String obj = pfVar2 != null ? pfVar2.getText().toString() : "";
            ...
            case 5:
                if (chatActivityEnterView.S0.getVisibility() == 0 && chatActivityEnterView.S0.getAlpha() == 1.0f && !chatActivityEnterView.j3) {
                    if (!chatActivityEnterView.y2 || (pfVar = chatActivityEnterView.E0) == null || !pfVar.isFocused()) {
            ...
            case 6:
                ...
                if (animatorSet2 == null || !animatorSet2.isRunning()) {
                    ...
                    mediaDataController.pushDraftVoiceMessage(j3, (xnVar == null || !xnVar.h4) ? 0L : xnVar.d(), null);
            ...
            case 7:
                ...
                if (chatActivityEnterView.k0()) {
                    ...
                    nf nfVar = chatActivityEnterView.m0;
                    if (nfVar != null) {
                        nfVar.c();
                        break;
                    }
                    ...
                    if (chatActivityEnterView.m0 == null) {
                        nf nfVar2 = new nf(chatActivityEnterView, chatActivityEnterView.getContext());
                        chatActivityEnterView.m0 = nfVar2;
                        ai.w0 w0Var = nfVar2.c;
                        ...
                        chatActivityEnterView.m0.c.setOnItemClickListener(new of(chatActivityEnterView));
                    ...
                    if (nfVar3.getVisibility() != 0) {
                        nfVar3.setVisibility(0);
                        nfVar3.c.u0(0);
                        nfVar3.n = true;
                        nfVar3.f = false;
                        break;
            ...
            case 9:
                ...
                if (BirthdayController.isToday(xnVar2.a8)) {
            ...
            case 14:
                ...
                if (p1Var == null || !p1Var.f) {
                    if (chatActivityEnterView.A0) {
                        ...
                        boolean z16 = pfVar4 != null && pfVar4.length() > 0;
                        org.telegram.ui.xn xnVar3 = chatActivityEnterView.O2;
                        if (xnVar3 != null) {
                            ci.e4 e4Var = xnVar3.y1;
                            if (e4Var != null) {
                                if (e4Var.V) {
                                    e4Var.e(true);
                                }
            ...
            case 16:
                ...
                if (!chatActivityEnterView4.l5 ? chatActivityEnterView4.getTranslationY() == 0.0f : !chatActivityEnterView4.u0()) {
                    ...
                    if (chatActivityEnterView4.Y2.J() != null) {
                        ...
                        ef efVar = chatActivityEnterView4.q0;
                        if (efVar != null) {
                            efVar.e = false;
                            efVar.l(new o1.k[0]);
                            break;
                            ...
                            ef efVar2 = new ef(chatActivityEnterView4, chatActivityEnterView4.getContext(), chatActivityEnterView4.O2, messagesController, isChannelAndNotMegaGroup, peer2, chatActivityEnterView4.Y2.J(), new ai.q5(chatActivityEnterView4, chatFull, messagesController, i13), chatActivityEnterView4.V3);
                            chatActivityEnterView4.q0 = efVar2;
                            efVar2.e = true;
                            efVar2.c = 220;
                            ...
                            if (measuredHeight < (((i17 * 2) + b13) - ((xnVar4 == null || !xnVar4.isInBubbleMode()) ? AndroidUtilities.statusBarHeight : 0)) - chatActivityEnterView4.q0.p.getMeasuredHeight()) {
                                chatActivityEnterView4.getLocationInWindow(iArr);
                                i11 = ((iArr[1] - measuredHeight) - i17) - AndroidUtilities.dp(2.0f);
                            } else {
                                int i18 = (xnVar4 == null || !xnVar4.isInBubbleMode()) ? AndroidUtilities.statusBarHeight : 0;
                            ...
                            ef efVar3 = chatActivityEnterView4.q0;
                            View view2 = efVar3.u;
                            ml0 ml0Var = efVar3.v;
                            TLRPC.Peer peer3 = efVar3.r;
                            po0 po0Var = efVar3.o;
                            ai.f0 f0Var = efVar3.t;
                            ArrayList arrayList2 = efVar3.z;
                            ...
                            ArrayList<TLRPC.TL_sendAsPeer> arrayList3 = efVar3.s.peers;
                            if (peer3 != null) {
                                ...
                                while (i20 < arrayList3.size()) {
                                    ...
                                    efVar3.w.h1(i20, (size2 - ((arrayList4.size() - 2) * dp)) + AndroidUtilities.dp(7.0f) + ((i20 == arrayList4.size() + (-1) || ml0Var2.getMeasuredHeight() >= size2) ? 0 : ml0Var2.getMeasuredHeight() % dp));
                            ...
                            ef efVar4 = chatActivityEnterView4.q0;
                            chatActivityEnterView4.s0 = i10;
                            chatActivityEnterView4.t0 = i11;
                            efVar4.showAtLocation(view, 51, i10, i11);
