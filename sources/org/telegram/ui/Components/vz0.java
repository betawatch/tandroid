...
public final /* synthetic */ class vz0 implements View.OnClickListener {
    ...
    public /* synthetic */ vz0(qh.d dVar, g01 g01Var, MessagesController messagesController, long j10, TLRPC.User user, String[] strArr, int i10, org.telegram.ui.ActionBar.h3 h3Var, boolean z4, org.telegram.ui.ActionBar.g6 g6Var) {
        this.b = dVar;
        this.r = g01Var;
            ...
            case 0:
                ...
                if (!dVar.K) {
                    ...
                    if (textView.getText().toString().trim().length() > 16) {
                        ...
                        connectionsManager.sendRequestTyped(tL_messages_editChatParticipantRank, aVar, new Utilities.Callback2() { // from class: org.telegram.ui.Components.wz0
    ...
    public /* synthetic */ vz0(qh.d dVar, long[] jArr, int i10, TL_payments.starRefProgram starrefprogram, org.telegram.ui.ActionBar.h3 h3Var, long j10, boolean z4, Context context, org.telegram.ui.ActionBar.g6 g6Var, TLRPC.User user) {
        this.b = dVar;
        this.r = jArr;
        this.c = i10;
