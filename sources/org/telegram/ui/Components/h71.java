...
public final class h71 {
    ...
    public static h71 d(int i10, TLRPC.Document document, TLRPC.Document document2, int i11, boolean z4) {
        ...
        h71Var.a = i10;
        h71Var.g = document;
        h71Var.c = document.id;
        h71Var.d = a(i10, i11, document);
        if (document2 != null) {
            h71Var.h = document2;
            h71Var.e = document2.id;
            h71Var.f = a(i10, i11, document2);
            ...
            if (pathToAttach == null || !pathToAttach.exists()) {
                ...
                if (pathToAttach2 != null && pathToAttach2.exists()) {
                    h71Var.f = Uri.fromFile(pathToAttach2);
                }
            } else {
                h71Var.f = Uri.fromFile(pathToAttach);
            }
        }
        h71Var.m = lowerCase;
        ...
        if (tL_documentAttributeVideo != null) {
            ...
            h71Var.i = tL_documentAttributeVideo.w;
            h71Var.j = tL_documentAttributeVideo.h;
            h71Var.l = j10 / d;
        }
        File pathToAttach3 = FileLoader.getInstance(i10).getPathToAttach(document, null, false, z4);
        if (pathToAttach3 != null && pathToAttach3.exists()) {
            h71Var.d = Uri.fromFile(pathToAttach3);
            return h71Var;
        }
        ...
        if (pathToAttach4 != null && pathToAttach4.exists()) {
            h71Var.d = Uri.fromFile(pathToAttach4);
        }
        return h71Var;
    }
