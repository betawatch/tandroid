...
public class p00 extends View implements org.telegram.ui.ActionBar.x5 {
    ...
    public final float a(float f9) {
        return LocaleController.isRTL ? getMeasuredWidth() - f9 : f9;
    }
    ...
    public final void e() {
        ...
        if (this.y || (i10 = this.A) == 13 || i10 == 14 || i10 == 17) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (viewType == 7) {
            while (i10 <= getMeasuredHeight()) {
                ...
                i10 = org.telegram.ui.th.g(this, i10);
                int i14 = i12 + 1;
            ...
            while (i10 <= getMeasuredHeight()) {
                canvas2.drawCircle(a(AndroidUtilities.dp(10.0f) + r3), org.telegram.messenger.x3.C(10.0f, i10, r3), AndroidUtilities.dp(14.0f), paint3);
                canvas2.save();
            ...
            while (i16 <= getMeasuredHeight()) {
                canvas2.drawCircle(a(org.telegram.messenger.x3.C(9.0f, this.C, r1)), AndroidUtilities.dp(32.0f) + i16, AndroidUtilities.dp(25.0f), paint3);
                ...
                Paint paint4 = paint3;
                canvas3.drawLine(AndroidUtilities.dp(f11), org.telegram.ui.th.g(this, i16), getMeasuredWidth(), org.telegram.ui.th.g(this, i16), paint4);
                canvas2 = canvas3;
                i16 = org.telegram.ui.th.g(this, i16);
                int i18 = i12 + 1;
                if (this.y && i18 >= this.G) {
                    break;
                }
                i12 = i18;
                paint3 = paint4;
            ...
            if (getViewType() == 19) {
                ...
                while (i19 <= getMeasuredHeight()) {
                    canvas2.drawCircle(a(org.telegram.messenger.x3.C(9.0f, this.C, r1)), AndroidUtilities.dp(29.0f) + i19, AndroidUtilities.dp(20.0f), paint5);
                    float f12 = 76;
                    ...
                    Paint paint6 = paint5;
                    canvas4.drawLine(AndroidUtilities.dp(f12), org.telegram.ui.th.g(this, i19), getMeasuredWidth(), org.telegram.ui.th.g(this, i19), paint6);
                    canvas2 = canvas4;
                    paint5 = paint6;
                ...
                while (true) {
                    ...
                    Paint paint7 = paint5;
                    i23 = org.telegram.messenger.x3.C(2.0f, i22, i23);
                    i24++;
                    if (this.y && i24 >= 2) {
                        break;
                    }
                ...
                if (getViewType() == 3) {
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(AndroidUtilities.dp(12.0f) + r4), org.telegram.messenger.x3.C(6.0f, i10, r4), AndroidUtilities.dp(44.0f) >> 1, paint5);
                        rectF.set(AndroidUtilities.dp(68.0f), AndroidUtilities.dp(12.0f) + i10, AndroidUtilities.dp(140.0f), AndroidUtilities.dp(20.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                        rectF.set(AndroidUtilities.dp(68.0f), AndroidUtilities.dp(34.0f) + i10, AndroidUtilities.dp(260.0f), AndroidUtilities.dp(42.0f) + i10);
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.x3.C(9.0f, this.C, r4)), (AndroidUtilities.dp(64.0f) >> 1) + i10, AndroidUtilities.dp(23.0f), paint5);
                        rectF.set(AndroidUtilities.dp(68.0f) + this.C, AndroidUtilities.dp(17.0f) + i10, AndroidUtilities.dp(260.0f) + this.C, AndroidUtilities.dp(25.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                        rectF.set(AndroidUtilities.dp(68.0f) + this.C, AndroidUtilities.dp(39.0f) + i10, AndroidUtilities.dp(140.0f) + this.C, AndroidUtilities.dp(47.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                        if (this.w) {
                            rectF.set(getMeasuredWidth() - AndroidUtilities.dp(50.0f), AndroidUtilities.dp(20.0f) + i10, getMeasuredWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(28.0f) + i10);
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.x3.C(13.0f, this.C, r4)), (AndroidUtilities.dp(58.0f) >> 1) + i10, AndroidUtilities.dp(23.0f), paint5);
                        rectF.set(AndroidUtilities.dp(72.0f) + this.C, AndroidUtilities.dp(17.0f) + i10, AndroidUtilities.dp(260.0f) + this.C, AndroidUtilities.dp(25.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                        rectF.set(AndroidUtilities.dp(72.0f) + this.C, AndroidUtilities.dp(39.0f) + i10, AndroidUtilities.dp(140.0f) + this.C, AndroidUtilities.dp(47.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                        i10 = org.telegram.ui.th.g(this, i10);
                        int i31 = i12 + 1;
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.x3.C(11.0f, this.C, r4)), (AndroidUtilities.dp(64.0f) >> 1) + i10, AndroidUtilities.dp(23.0f), paint5);
                        rectF.set(AndroidUtilities.dp(68.0f) + this.C, AndroidUtilities.dp(17.0f) + i10, AndroidUtilities.dp(140.0f) + this.C, AndroidUtilities.dp(25.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                        rectF.set(AndroidUtilities.dp(68.0f) + this.C, AndroidUtilities.dp(39.0f) + i10, AndroidUtilities.dp(260.0f) + this.C, AndroidUtilities.dp(47.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                        if (this.w) {
                            rectF.set(getMeasuredWidth() - AndroidUtilities.dp(50.0f), AndroidUtilities.dp(20.0f) + i10, getMeasuredWidth() - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(28.0f) + i10);
                    ...
                    while (dp2 <= getMeasuredHeight()) {
                        ...
                        dp2 = org.telegram.ui.th.g(this, dp2);
                        if (this.y) {
                            break;
                        }
                    }
                    ...
                    for (int i37 = 0; i37 < 3; i37++) {
                        canvas2.drawCircle(org.telegram.messenger.x3.D(12.0f, i37, AndroidUtilities.dp(13.0f) + (getMeasuredWidth() - AndroidUtilities.dp(56.0f))), measuredHeight2, AndroidUtilities.dp(13.0f), this.J);
                        canvas2.drawCircle(org.telegram.messenger.x3.D(12.0f, i37, AndroidUtilities.dp(13.0f) + (getMeasuredWidth() - AndroidUtilities.dp(56.0f))), measuredHeight2, AndroidUtilities.dp(12.0f), paint5);
                    }
                    ...
                    while (dp4 < getMeasuredWidth()) {
                        if (this.J == null) {
                            this.J = new Paint(i13);
                        }
                        this.J.setColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.h5, this.H));
                        ...
                        if (getViewType() == 14) {
                            ...
                            f9 = 8.0f;
                            float A = com.google.android.recaptcha.internal.a.A(dp5, dp14, 2.0f, dp4);
                            rectF4.set(A, AndroidUtilities.dp(21.0f), dp14 + A, AndroidUtilities.dp(32.0f) + r13);
                            canvas2.drawRoundRect(rectF4, dp13, dp13, this.J);
                            canvas2.drawCircle((dp5 / 2) + dp4, getMeasuredHeight() - AndroidUtilities.dp(20.0f), AndroidUtilities.dp(f9), this.J);
                            dp4 = i38;
                            i13 = 1;
                            f13 = 8.0f;
                        }
                    ...
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.x3.C(12.0f, this.C, dp15)), org.telegram.messenger.x3.C(8.0f, i10, dp15), dp15, paint5);
                        rectF.set(AndroidUtilities.dp(74.0f) + this.C, AndroidUtilities.dp(12.0f) + i10, AndroidUtilities.dp(260.0f) + this.C, AndroidUtilities.dp(20.0f) + i10);
                        b(rectF);
                        float f16 = dp16;
                        canvas2.drawRoundRect(rectF, f16, f16, paint5);
                        rectF.set(AndroidUtilities.dp(74.0f) + this.C, AndroidUtilities.dp(36.0f) + i10, AndroidUtilities.dp(140.0f) + this.C, AndroidUtilities.dp(42.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, f16, f16, paint5);
                        if (this.P > 0.0f) {
                            rectF.set(AndroidUtilities.dp(73.0f) + this.C, AndroidUtilities.dp(62.0f) + i10, AndroidUtilities.dp(73.0f) + this.C + this.P, AndroidUtilities.dp(94.0f) + i10);
                            b(rectF);
                            canvas2.drawRoundRect(rectF, f16, f16, paint5);
                        }
                        i10 = org.telegram.ui.th.g(this, i10);
                    ...
                    int i40 = 0;
                    while (i10 <= getMeasuredHeight()) {
                        canvas2.drawCircle(a(org.telegram.messenger.x3.C(8.0f, this.C, r6)), AndroidUtilities.dp(24.0f) + i10, AndroidUtilities.dp(18.0f), paint5);
                        rectF.set(AndroidUtilities.dp(58.0f) + this.C, AndroidUtilities.dp(20.0f) + i10, getWidth() - AndroidUtilities.dp(53.0f), AndroidUtilities.dp(28.0f) + i10);
                        b(rectF);
                        canvas2.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), paint5);
                        if (i40 < 4) {
                            canvas2.drawCircle(a(org.telegram.messenger.x3.B(12.0f, getWidth(), r6)), AndroidUtilities.dp(24.0f) + i10, AndroidUtilities.dp(12.0f), paint5);
                        }
                        i10 = org.telegram.ui.th.g(this, i10);
                        i40++;
                        if (this.y && i40 >= this.G) {
                            break;
                        }
                    }
                    rectF.set(AndroidUtilities.dp(8.0f) + this.C, AndroidUtilities.dp(20.0f) + i10, getWidth() - AndroidUtilities.dp(8.0f), AndroidUtilities.dp(28.0f) + i10);
                    b(rectF);
                    canvas2.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), paint5);
                    rectF.set(AndroidUtilities.dp(8.0f) + this.C, AndroidUtilities.dp(36.0f) + i10, getWidth() - AndroidUtilities.dp(53.0f), AndroidUtilities.dp(44.0f) + i10);
                    b(rectF);
                    canvas2.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), paint5);
                } else {
                    int i41 = this.A;
                    if (i41 == 21) {
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            canvas2.drawCircle(a(AndroidUtilities.dp(20.0f) + r4), org.telegram.messenger.x3.C(6.0f, i10, r4), AndroidUtilities.dp(48.0f) >> 1, paint5);
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            canvas2.drawCircle(AndroidUtilities.dp(17.0f) + r4, org.telegram.messenger.x3.C(6.0f, i10, r4), AndroidUtilities.dp(38.0f) >> 1, paint5);
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            canvas2.drawCircle(LocaleController.isRTL ? org.telegram.messenger.x3.B(21.0f, getMeasuredWidth(), r4) : AndroidUtilities.dp(21.0f) + r4, org.telegram.messenger.x3.C(16.0f, i10, r4), AndroidUtilities.dp(21.0f) >> 1, paint5);
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            canvas2.drawCircle(a(org.telegram.messenger.x3.C(10.0f, this.C, r4)), (AndroidUtilities.dp(58.0f) >> 1) + i10, AndroidUtilities.dp(24.0f), paint5);
                            rectF.set(AndroidUtilities.dp(68.0f) + this.C, AndroidUtilities.dp(17.0f) + i10, AndroidUtilities.dp(260.0f) + this.C, AndroidUtilities.dp(25.0f) + i10);
                            b(rectF);
                            canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                            rectF.set(AndroidUtilities.dp(68.0f) + this.C, AndroidUtilities.dp(39.0f) + i10, AndroidUtilities.dp(140.0f) + this.C, AndroidUtilities.dp(47.0f) + i10);
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            ...
                            float f17 = i10;
                            rectF.set(AndroidUtilities.dp(18.0f) + this.C, ((c6 - AndroidUtilities.dp(22.0f)) / 2.0f) + f17, AndroidUtilities.dp(40.0f) + this.C, ((AndroidUtilities.dp(22.0f) + c6) / 2.0f) + f17);
                            b(rectF);
                            canvas2.drawRoundRect(rectF, AndroidUtilities.dp(11.0f), AndroidUtilities.dp(11.0f), paint5);
                            rectF.set(AndroidUtilities.dp(58.0f) + this.C, ((c6 - AndroidUtilities.dp(8.0f)) / 2.0f) + f17, Math.min(AndroidUtilities.dp(132.0f) + this.C, getMeasuredWidth() - AndroidUtilities.dp(19.0f)), ((AndroidUtilities.dp(8.0f) + c6) / 2.0f) + f17);
                            b(rectF);
                            canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                            i10 += c6;
                            int i47 = i12 + 1;
                        ...
                        while (i10 <= getMeasuredHeight()) {
                            ...
                            float f18 = i10;
                            rectF.set(AndroidUtilities.dp(10.0f) + this.C, ((c10 - AndroidUtilities.dp(32.0f)) / 2.0f) + f18, AndroidUtilities.dp(42.0f) + this.C, ((AndroidUtilities.dp(32.0f) + c10) / 2.0f) + f18);
                            b(rectF);
                            canvas2.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint5);
                            rectF.set(AndroidUtilities.dp(64.0f) + this.C, (((c10 - AndroidUtilities.dp(14.0f)) - AndroidUtilities.dp(10.0f)) / 2.0f) + f18, Math.min(AndroidUtilities.dp(118.0f) + this.C, getMeasuredWidth() - AndroidUtilities.dp(19.0f)), ((AndroidUtilities.dp(10.0f) + (c10 - AndroidUtilities.dp(14.0f))) / 2.0f) + f18);
                            b(rectF);
                            canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                            rectF.set(AndroidUtilities.dp(64.0f) + this.C, (((AndroidUtilities.dp(14.0f) + c10) - AndroidUtilities.dp(8.0f)) / 2.0f) + f18, Math.min(AndroidUtilities.dp(144.0f) + this.C, getMeasuredWidth() - AndroidUtilities.dp(19.0f)), ((AndroidUtilities.dp(8.0f) + (AndroidUtilities.dp(14.0f) + c10)) / 2.0f) + f18);
                            b(rectF);
                            canvas2.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint5);
                            i10 += c10;
                            int i48 = i12 + 1;
                            if (this.y && i48 >= this.G) {
                                break;
                            } else {
                                i12 = i48;
                            }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int i12 = this.G;
        if (i12 > 1 && this.O) {
            super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(getAdditionalHeight() + (c(View.MeasureSpec.getSize(i10)) * this.G), TLObject.FLAG_30));
            ...
            super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(getAdditionalHeight() + Math.min(View.MeasureSpec.getSize(i11), c(View.MeasureSpec.getSize(i10)) * this.G), TLObject.FLAG_30));
        }
    }
    ...
    public void setViewType(int i10) {
        ...
        if (i10 == 11) {
            ...
            for (int i11 = 0; i11 < 2; i11++) {
                this.I[i11] = org.telegram.ui.th.f(random, MediaDataController.MAX_STYLE_RUNS_COUNT) / 1000.0f;
            }
        }
        invalidate();
    }
    ...
    public p00(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        this.E = org.telegram.ui.ActionBar.g6.i6;
        this.F = -1;
        this.G = 1;
        this.H = c6Var;
        this.h = new Matrix();
