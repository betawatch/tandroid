...
public abstract class n9 {
    public static void a(org.telegram.ui.zn znVar, int i10, TLRPC.Chat chat, TLRPC.User user, TLRPC.TL_forumTopic tL_forumTopic, long j3, int i11, int i12) {
        ...
        for (m9 m9Var : parentLayout.getPulledDialogs()) {
            if (tL_forumTopic == null && m9Var.f == j3) {
                return;
            }
            if (tL_forumTopic != null && (tL_forumTopic2 = m9Var.e) != null && tL_forumTopic2.id == tL_forumTopic.id) {
                return;
            }
        }
        m9 m9Var2 = new m9();
        m9Var2.a = org.telegram.ui.zn.class;
        m9Var2.b = i10;
        m9Var2.f = j3;
        m9Var2.h = i12;
        m9Var2.g = i11;
        m9Var2.c = chat;
        m9Var2.d = user;
        m9Var2.e = tL_forumTopic;
        parentLayout.getPulledDialogs().add(m9Var2);
    }
            ...
            if (parentLayout2 != null) {
                ...
                if (pulledDialogs != null) {
                    for (int size2 = pulledDialogs.size() - 1; size2 >= 0; size2--) {
                        m9 m9Var3 = (m9) pulledDialogs.get(size2);
                        if (m9Var3.f != j3) {
                            int i18 = 0;
                            while (true) {
                                if (i18 >= arrayList.size()) {
                                    arrayList.add(m9Var3);
                                    break;
                                }
                                if (((m9) arrayList.get(i18)).f == m9Var3.f) {
                                    break;
                                }
                                i18++;
                            }
                ...
                while (i19 < size3) {
                    ...
                    m9 m9Var4 = (m9) arrayList2.get(i19);
                    TLRPC.Chat chat2 = m9Var4.c;
                    TLRPC.User user3 = m9Var4.d;
                    TLRPC.TL_forumTopic tL_forumTopic = m9Var4.e;
                    ...
                    if (chat2 == null && user3 == null) {
                        v9Var.setRoundRadius(0);
                    } else {
                        v9Var.setRoundRadius((chat2 == null || !chat2.forum) ? AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(8.0f));
                    }
                    frameLayout.addView(v9Var, w7.y5.i(32.0f, 32.0f, 8388627, 8.0f, 0.0f, 0.0f, 0.0f));
                    ...
                    if (tL_forumTopic != null) {
                        if (tL_forumTopic.id == 1) {
                            v9Var.setImageDrawable(ng.d.c(fragmentView.getContext(), 1.0f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ac, f6Var), false));
                            i15 = i19;
                        } else if (tL_forumTopic.icon_emoji_id != j11) {
                            i15 = i19;
                            v9Var.setAnimatedEmojiDrawable(new p5(10, n2Var.getCurrentAccount(), tL_forumTopic.icon_emoji_id));
                        } else {
                            i15 = i19;
                        ...
                        i15 = i19;
                        if (chat2 != null) {
                            g9Var.k(n2Var.getCurrentAccount(), chat2);
                            TLRPC.ChatPhoto chatPhoto = chat2.photo;
                            if (chatPhoto != null && (r82 = chatPhoto.strippedBitmap) != 0) {
                                g9Var = r82;
                            }
                            v9Var.h(ImageLocation.getForChat(n2Var.getCurrentAccount(), chat2, 1), "50_50", g9Var, chat2);
                            ...
                            if (m9Var4.a == org.telegram.ui.zn.class && UserObject.isUserSelf(user3)) {
                                ...
                                if (UserObject.isDeleted(user3)) {
                                    ...
                                    g9Var.m(n2Var.getCurrentAccount(), user3);
                                    m9Var = m9Var4;
                                    v9Var.h(ImageLocation.getForUser(n2Var.getCurrentAccount(), user3, 1), "50_50", g9Var, user3);
                                } else {
                                    m9Var = m9Var4;
                                    String userName = UserObject.getUserName(user3);
                                    g9Var.m(n2Var.getCurrentAccount(), user3);
                                    v9Var.h(ImageLocation.getForUser(n2Var.getCurrentAccount(), user3, 1), "50_50", drawable, user3);
                                    str = userName;
                                }
                                ...
                                frameLayout.setOnClickListener(new ai.s0(atomicReference, m9Var, d5Var3, tL_forumTopic, n2Var, 10));
                            ...
                            atomicReference = atomicReference2;
                            frameLayout.setOnClickListener(new ai.s0(atomicReference, m9Var, d5Var32, tL_forumTopic, n2Var, 10));
                            actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.y5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                            if (!z11) {
                            }
                            i19 = i15 + 1;
                            ...
                            m9Var = m9Var4;
                            v9Var.setImageDrawable(parentActivity.getDrawable(R.drawable.msg_viewchats).mutate());
                            v9Var.s(AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f));
                            v9Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.F8, f6Var), PorterDuff.Mode.MULTIPLY));
                            ...
                            atomicReference = atomicReference2;
                            frameLayout.setOnClickListener(new ai.s0(atomicReference, m9Var, d5Var322, tL_forumTopic, n2Var, 10));
                            actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.y5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                            if (!z11) {
                            }
                            i19 = i15 + 1;
                    ...
                    atomicReference = atomicReference2;
                    frameLayout.setOnClickListener(new ai.s0(atomicReference, m9Var, d5Var3222, tL_forumTopic, n2Var, 10));
                    actionBarPopupWindow$ActionBarPopupWindowLayout.a(frameLayout, w7.y5.p(-1, 44, 0.0f, 0, 0, !z13 ? 3 : 0, 0, !z14 ? 3 : 0));
                    if (!z11) {
                    }
                    i19 = i15 + 1;
            ...
            if (parentLayout3 == null) {
                ...
                if (pulledDialogs2 != null) {
                    ...
                    for (int i21 = 0; i21 < pulledDialogs2.size(); i21++) {
                        m9 m9Var5 = (m9) pulledDialogs2.get(i21);
                        if (m9Var5.e != null && r5.id != j10) {
                            int i22 = m9Var5.b;
                            if (i22 >= i16) {
                                i16 = i22;
                            }
                            arrayList.add(m9Var5);
                        }
                    }
                } else {
                    i16 = -1;
                ...
                if (parentLayout3.getFragmentStack().size() <= 1 || !(parentLayout3.getFragmentStack().get(parentLayout3.getFragmentStack().size() - 2) instanceof fg1)) {
                    m9 m9Var6 = new m9();
                    arrayList.add(m9Var6);
                    m9Var6.b = -1;
                    m9Var6.a = fg1.class;
                    m9Var6.c = MessagesController.getInstance(n2Var.getCurrentAccount()).getChat(Long.valueOf(-j3));
                } else {
                    m9 m9Var7 = new m9();
                    arrayList.add(m9Var7);
                    m9Var7.b = i16 + 1;
                    m9Var7.a = org.telegram.ui.uy.class;
                    m9 m9Var8 = new m9();
                    arrayList.add(m9Var8);
                    m9Var8.b = -1;
                    m9Var8.a = fg1.class;
                    m9Var8.c = MessagesController.getInstance(n2Var.getCurrentAccount()).getChat(Long.valueOf(-j3));
                }
