...
public final class n9 extends Drawable {
    ...
    public final le.j c = new le.j(new ji.u4(this, 10), pr.h, 380);
    ...
    public final void a() {
        ...
        while (i10 < size) {
            ...
            i10++;
            m9 m9Var = (m9) obj;
            if (m9Var.c != 0 && !m9Var.d) {
                m9Var.d = true;
                m9Var.a.onAttachedToWindow();
            }
        }
    }
    ...
    public final void c(Canvas canvas) {
        ...
        for (int size = jVar.b.size() - 1; size >= 0; size--) {
            ...
            m9 m9Var = (m9) obj;
            m9Var.a.setImageCoords(f13, f10, width, width);
            m9Var.a.setAlpha((this.i / 255.0f) * n10.c());
            m9Var.a.draw(canvas);
            canvas.restore();
        }
        canvas.restore();
    ...
    public final void d(List list, boolean z10) {
        ...
        while (it.hasNext()) {
            ...
            if (m9Var == null) {
                m9Var = new m9(this, this.a);
                arrayList2.add(m9Var);
            }
            ImageReceiver imageReceiver = m9Var.a;
            i9 i9Var = m9Var.b;
            if (m9Var.c != peerDialogId) {
                m9Var.c = peerDialogId;
                int i12 = this.b;
