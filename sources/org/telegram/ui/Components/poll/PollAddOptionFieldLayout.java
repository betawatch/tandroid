...
public class PollAddOptionFieldLayout extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
    ...
    public PollAddOptionFieldLayout(final BaseFragment baseFragment, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        FactorAnimator.Target target = new FactorAnimator.Target() { // from class: org.telegram.ui.Components.poll.PollAddOptionFieldLayout$$ExternalSyntheticLambda1
            ...
            public final void onFactorChanged(int i, float f, float f2, FactorAnimator factorAnimator) {
                PollAddOptionFieldLayout.this.checkLimitText(i, f, f2, factorAnimator);
            }
        };
        ...
        1 r1 = new 1(context, resourcesProvider);
        this.textView = r1;
        r1.setAllowTextEntitiesIntersection(true);
        r1.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, resourcesProvider));
        r1.setLinkTextColor(Theme.getColor(Theme.key_chat_messageLinkIn, resourcesProvider));
        r1.setHintTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteHintText, resourcesProvider));
        r1.setHint(LocaleController.getString(R.string.PollAddAnOptionHint));
        r1.setTextSize(1, 15.0f);
        r1.setMaxLines(ConnectionsManager.DEFAULT_DATACENTER_ID);
        r1.setBackground(null);
        r1.setImeOptions(268435462);
        r1.setInputType(r1.getInputType() | 16384);
        r1.addTextChangedListener(new TextWatcherImpl() { // from class: org.telegram.ui.Components.poll.PollAddOptionFieldLayout.2
        ...
        this.viewsContainer.addView(r1, LayoutHelper.createFrame(-1, -2.0f, 119, 39.0f, 0.0f, 47.0f, 0.0f));
        r1.setPadding(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(11.0f), AndroidUtilities.dp(5.0f), AndroidUtilities.dp(11.0f));
    }
    ...
    class 1 extends EditTextCaption {
        ...
        1(Context context, Theme.ResourcesProvider resourcesProvider) {
