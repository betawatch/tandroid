...
public class RecentVotersCell extends FrameLayout {
    ...
    public RecyclerListView createListView(BaseFragment baseFragment, long j, int i, byte[] bArr, final int i2, Utilities.Callback callback) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.poll.RecentVotersCell$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                RecentVotersCell.VotesList.this.load();
            }
        }, 1000L);
        UniversalRecyclerView universalRecyclerView2 = new UniversalRecyclerView(baseFragment, new Utilities.Callback2() { // from class: org.telegram.ui.Components.poll.RecentVotersCell$$ExternalSyntheticLambda2
            ...
            public final void run(Object obj, Object obj2) {
                RecentVotersCell.VotesList.this.fillItems((ArrayList) obj, (UniversalAdapter) obj2);
            }
        }, null, null) { // from class: org.telegram.ui.Components.poll.RecentVotersCell.1
            @Override // org.telegram.ui.Components.RecyclerListView, androidx.recyclerview.widget.RecyclerView, android.view.View
            protected void onMeasure(int i3, int i4) {
                int min = Math.min(AndroidUtilities.dp(220.0f), View.MeasureSpec.getSize(i3));
                View.MeasureSpec.getSize(i4);
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(min, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(MathUtils.clamp(i2, 1, 5) * 48), TLObject.FLAG_30));
            }
        };
