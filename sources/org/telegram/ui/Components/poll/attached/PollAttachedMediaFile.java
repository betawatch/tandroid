...
public class PollAttachedMediaFile extends PollAttachedMedia {
    ...
    public static Drawable createMessagePreviewDrawable(View view, String str, String str2, TLRPC.Document document, MessageObject messageObject) {
        ...
        view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.Components.poll.attached.PollAttachedMediaFile.1
            ...
            public void onViewAttachedToWindow(View view2) {
                FileInfoDrawable.this.radialProgress.onAttachedToWindow();
            }

            @Override // android.view.View.OnAttachStateChangeListener
            public void onViewDetachedFromWindow(View view2) {
                FileInfoDrawable.this.radialProgress.onDetachedFromWindow();
            }
        });
    ...
    public static class FileInfoDrawable extends Drawable {
        ...
        private void ensureLayout() {
            ...
            if (width != this.lastLayoutWidth || this.titleLayout == null || this.subtitleLayout == null) {
                this.lastLayoutWidth = width;
                int i = (width - this.paddingStart) - this.paddingEnd;
                if (i <= 0) {
                    this.titleLayout = null;
                    this.subtitleLayout = null;
                    return;
                ...
                float f = i;
                CharSequence ellipsize = TextUtils.ellipsize(this.title, this.titlePaint, f, TextUtils.TruncateAt.MIDDLE);
                CharSequence ellipsize2 = TextUtils.ellipsize(this.subtitle, this.subtitlePaint, f, TextUtils.TruncateAt.END);
                TextPaint textPaint = this.titlePaint;
                Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                this.titleLayout = new StaticLayout(ellipsize, textPaint, i, alignment, 1.0f, 0.0f, false);
                this.subtitleLayout = new StaticLayout(ellipsize2, this.subtitlePaint, i, alignment, 1.0f, 0.0f, false);
            }
        }
