...
public class PollAttachedMediaLocation extends PollAttachedMedia {
    ...
    public Drawable createMessagePreviewDrawable(View view) {
        ...
        imageReceiver.setImage(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(this.media.geo, NotificationCenter.onActivityResultReceived, NotificationCenter.groupCallScreencastStateChanged, 15, Math.min(2, (int) Math.ceil(AndroidUtilities.density)))), (String) null, (ImageLocation) null, (String) null, new ClipRoundedDrawable(svgThumb), (Object) null, 0);
        ...
        final Drawable mutate = view.getContext().getResources().getDrawable(R.drawable.map_pin).mutate();
        return new Drawable() { // from class: org.telegram.ui.Components.poll.attached.PollAttachedMediaLocation.2
            ...
            public void draw(Canvas canvas) {
                ...
                int intrinsicWidth = (int) (mutate.getIntrinsicWidth() * 0.8f);
                int intrinsicHeight = (int) (mutate.getIntrinsicHeight() * 0.8f);
                ...
                mutate.setAlpha((int) (Math.min(1.0f, imageReceiver.getCurrentAlpha() * 5.0f) * 255.0f * imageReceiver.getAlpha()));
                mutate.setBounds(imageX, imageY, intrinsicWidth + imageX, intrinsicHeight + imageY);
                mutate.draw(canvas);
            }
