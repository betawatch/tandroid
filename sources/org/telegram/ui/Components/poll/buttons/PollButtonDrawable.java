...
public class PollButtonDrawable extends Drawable implements DownloadController.FileDownloadProgressListener {
    ...
    private boolean setMediaImpl(TLRPC.MessageMedia messageMedia, Object obj, String str) {
        ...
        if (messageMedia != null && !(messageMedia instanceof TLRPC.TL_messageMediaEmpty)) {
            ...
            if (messageMedia instanceof TLRPC.TL_messageMediaPhoto) {
                ...
                this.imageReceiver.setImage(ImageLocation.getForObject(closestPhotoSizeWithSize2, photo), "36_36", ImageLocation.getForObject(closestPhotoSizeWithSize, photo), "36_36_b", null, closestPhotoSizeWithSize2.size, null, obj, 1);
                return true;
            }
            if (messageMedia instanceof TLRPC.TL_messageMediaDocument) {
                ...
                if (z || isAnimatedStickerDocument) {
    ...
    public void draw(Canvas canvas, Paint paint) {
        ...
        int dp = AndroidUtilities.dp(this.hasMediaPadding ? 56.33f : 19.0f);
        if (this.animatorShowVoters.getFloatValue() > 0.0f) {
            ...
            int lerp = (bounds.right - dp) - AndroidUtilities.lerp(AndroidUtilities.dp(2.0f), AndroidUtilities.dp(4.0f) + animatedWidth, totalVisibility);
        ...
        if (this.hasMedia) {
            ...
            rect.set((bounds.right - AndroidUtilities.dp(9.0f)) - dp3, (bounds.bottom - AndroidUtilities.dp(4.0f)) - dp3, bounds.right - AndroidUtilities.dp(9.0f), bounds.bottom - AndroidUtilities.dp(4.0f));
