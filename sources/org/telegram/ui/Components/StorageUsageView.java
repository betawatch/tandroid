...
public class StorageUsageView extends FrameLayout {
    ...
    public StorageUsageView(Context context) {
        ...
        this.cellFlickerDrawable = new CellFlickerDrawable(NotificationCenter.starBalanceUpdated, NotificationCenter.didReplacedPhotoInMemCache);
        ...
        this.totlaSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.dp(10.0f), ColorUtils.setAlphaComponent(this.lastProgressColor, NotificationCenter.messageTranslated)), (Drawable) null, (Drawable) null, (Drawable) null);
    ...
    private class ProgressView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            StorageUsageView.this.paintProgress.setAlpha(NotificationCenter.didReplacedPhotoInMemCache);
