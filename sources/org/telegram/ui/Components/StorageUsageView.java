...
public class StorageUsageView extends FrameLayout {
    ...
    public StorageUsageView(Context context) {
        ...
        this.cellFlickerDrawable = new CellFlickerDrawable(NotificationCenter.starBalanceUpdated, NotificationCenter.closeOtherAppActivities);
    ...
    private class ProgressView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            StorageUsageView.this.paintProgress.setAlpha(NotificationCenter.closeOtherAppActivities);
