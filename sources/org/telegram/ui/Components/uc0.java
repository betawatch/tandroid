...
public class uc0 extends LinearLayout {
    ...
    public uc0(LaunchActivity launchActivity) {
    ...
    public static int g(int i10, int i11) {
        if (i11 != -1) {
            ...
            if (mode != 1073741824) {
                throw new IllegalArgumentException(hg.k0.i(mode, "Unknown measure mode: "));
            }
        }
        return i10;
    }
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.E) {
            ...
            if (strArr != null) {
                ...
                qc0 qc0Var = this.K;
                str = qc0Var != null ? qc0Var.e(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.G;
                    qc0 qc0Var = this.K;
                    str = qc0Var != null ? qc0Var.e(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z10) {
        ...
        if (z10 && (sc0Var = this.I) != null) {
            sc0Var.q(this, this.G);
        }
        f();
        invalidate();
        if (this.k0 != 0 || (rc0Var = this.J) == null) {
            return;
        }
        rc0Var.n(0);
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (f7 < this.l0) {
            if (this.k0 == 0) {
                ...
                tc0Var.c = 1;
                tc0Var.b = 2;
                ((uc0) tc0Var.d).postDelayed(tc0Var, ViewConfiguration.getTapTimeout());
            }
            ...
            tc0Var2.c = 1;
            tc0Var2.b = 1;
            ((uc0) tc0Var2.d).postDelayed(tc0Var2, ViewConfiguration.getTapTimeout());
        }
        ...
        if (f10 < this.l0) {
            ...
            pc0 pc0Var = this.V;
            pc0Var.a = false;
            postDelayed(pc0Var, longPressTimeout);
            return true;
        }
        if (f10 > this.m0) {
            ...
            pc0 pc0Var2 = this.V;
            pc0Var2.a = true;
            postDelayed(pc0Var2, longPressTimeout2);
        }
        return true;
    }
    ...
    public void setFormatter(qc0 qc0Var) {
        if (qc0Var == this.K) {
            return;
        }
        this.K = qc0Var;
    ...
    public void setOnScrollListener(rc0 rc0Var) {
        this.J = rc0Var;
    }

    public void setOnValueChangedListener(sc0 sc0Var) {
        this.I = sc0Var;
    }
    ...
    */
    ...
    public uc0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        this(context, 18, f6Var);
    }

    public uc0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.a = 3;
        this.b = 1;
        this.L = 300L;
        ...
        setAccessibilityDelegate(new oc0(this));
    }
}
