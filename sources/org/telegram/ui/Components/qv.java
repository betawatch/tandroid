            ...
            for (int i12 = 0; i12 < this.b.size(); i12++) {
                if (this.b.get(i12) == null) {
                    ...
                    if (this.b.size() == 1 && stickerSet2 != null && (stickerSet = stickerSet2.set) != null && !stickerSet.emojis) {
                        ...
                        org.telegram.ui.jk jkVar = n2Var2 instanceof org.telegram.ui.xn ? ((org.telegram.ui.xn) n2Var2).Y : null;
                        d6Var = ((org.telegram.ui.ActionBar.f3) tvVar).resourcesProvider;
                        new ux0(context, n2Var, inputStickerSet, null, jkVar, d6Var).show();
                        return;
                    }
