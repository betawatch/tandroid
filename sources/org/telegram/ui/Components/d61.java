...
public class d61 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        i14 = ((org.telegram.ui.ActionBar.f3) f61Var).backgroundPaddingTop;
        float translationY2 = getTranslationY() + i14 + i26;
        float f10 = AndroidUtilities.statusBarHeight;
        if (translationY2 < f10) {
            i20 = ((org.telegram.ui.ActionBar.f3) f61Var).backgroundPaddingTop;
        ...
        if (!f61Var.O) {
            if (f9 != 1.0f) {
                org.telegram.ui.ActionBar.g6.t0.setColor(f61Var.B);
                i16 = ((org.telegram.ui.ActionBar.f3) f61Var).backgroundPaddingLeft;
                i17 = ((org.telegram.ui.ActionBar.f3) f61Var).backgroundPaddingTop;
            ...
            org.telegram.ui.ActionBar.g6.t0.setColor(org.telegram.ui.ActionBar.g6.w0(null, f61Var.E, false));
        ...
        if (bool == null || bool.booleanValue() != z10) {
            boolean z11 = AndroidUtilities.computePerceivedBrightness(f61Var.getThemedColor(org.telegram.ui.ActionBar.g6.h5)) > 0.721f;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.g6.v(f61Var.getThemedColor(org.telegram.ui.ActionBar.g6.s8), 855638016)) > 0.721f;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            if (i16 != 0) {
                ...
                this.a = ofFloat;
                ofFloat.addUpdateListener(new v51(i14, this));
                this.a.setDuration(250L);
                this.a.setInterpolator(org.telegram.ui.ActionBar.q1.w);
                this.a.addListener(new p11(this, 6));
                this.a.start();
            } else if (this.a != null) {
