...
public final class yi0 extends Path {
    ...
    public yi0(final org.telegram.ui.Cells.u1 u1Var, int i10, int i11) {
        ...
        this.a = u1Var;
        final int i12 = 0;
        this.k = new e6(0.0f, new Runnable() { // from class: org.telegram.ui.Components.wi0
    ...
    public final void a(float f7, float f10, float f11, float f12) {
        ...
        float f18 = max2 + f14;
        xi0 xi0Var = new xi0();
        xi0Var.a = f15 - AndroidUtilities.dp(3.0f);
        xi0Var.b = f18 + AndroidUtilities.dp(3.0f);
        xi0Var.c = f17;
        xi0Var.d = f12 + f16;
        xi0 xi0Var2 = this.q;
        if (xi0Var2 != null) {
            float f19 = xi0Var2.d;
            xi0Var2.h = (f19 + f17) / 2.0f;
            xi0Var.g = (f19 + f17) / 2.0f;
        }
        this.l.add(xi0Var);
        this.q = xi0Var;
    }
    ...
    public final void b(Canvas canvas, float f7, float f10, Rect rect, float f11) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                uqVar.addRect(AndroidUtilities.lerp(rect.left - f7, xi0Var.a, d), AndroidUtilities.lerp(xi0Var.e ? rect.top - f10 : xi0Var.g, xi0Var.c, d), AndroidUtilities.lerp(rect.right - f7, xi0Var.b, d), AndroidUtilities.lerp(xi0Var.f ? rect.bottom - f10 : xi0Var.h, xi0Var.d, d), Path.Direction.CW);
                i10++;
            }
            uqVar.a();
        }
    ...
    public yi0(org.telegram.ui.Cells.u1 u1Var, ViewParent viewParent, int i10, ArrayList arrayList, int i11, int i12, float f7) {
        ...
        this.m = new ArrayList();
        this.a = null;
        this.k = new e6(0.0f, new uw(25, u1Var, viewParent), 350L, 420L, qr.h);
        this.b = i10;
        this.c = i14;
        this.d = i12;
        int i15 = 0;
        ...
        if (this.l.size() > 0) {
            xi0 xi0Var = (xi0) this.l.get(0);
            xi0 xi0Var2 = (xi0) hg.k0.g(1, this.l);
            xi0Var.e = true;
            xi0Var.c -= AndroidUtilities.dp(0.66f);
            xi0Var2.f = true;
