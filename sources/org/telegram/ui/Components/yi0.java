...
public class yi0 extends BitmapDrawable implements Animatable, yf.c {
    ...
    */
    public yi0(File file, String str, int i10, int i11, b2.n1 n1Var, boolean z10, int i12, boolean z11) {
        char c10;
        RLottieNative a2;
        int[] iArr = new int[3];
        this.e = iArr;
        ...
        this.i0 = new RectF[2];
        this.j0 = new Paint[2];
        this.v0 = new xi0(this, 1);
        this.w0 = new xi0(this, 2);
        this.y0 = new xi0(this, 3);
        this.z0 = new xi0(this, 4);
    ...
    public static void e(yi0 yi0Var) {
        if (yi0Var.l0 || yi0Var.V || !yi0Var.k() || yi0Var.O != null) {
            return;
        }
        yi0Var.x0 = true;
        if (T0 == null) {
    ...
    public static void f(yi0 yi0Var) {
        ...
        try {
            ...
            if (i10 == 1) {
                if (yi0Var.S != null) {
                    ...
                    createBitmap = Bitmap.createBitmap(yi0Var.b, yi0Var.c, yi0Var.G ? Bitmap.Config.ALPHA_8 : Bitmap.Config.ARGB_8888);
        ...
        if (i10 == 1) {
            yi0Var.G0 = 0;
            AndroidUtilities.runOnUIThread(yi0Var.w0);
        } else if (i10 == 2) {
            AndroidUtilities.runOnUIThread(yi0Var.v0, yi0Var.G0);
            yi0Var.G0 = Math.min((Math.max(yi0Var.G0, 2) * 3) / 2, 2000);
        } else if (i10 == 3) {
            AndroidUtilities.runOnUIThread(yi0Var.v0);
        }
    ...
    public static void h(yi0 yi0Var) {
        yi0Var.X = true;
        if ((!yi0Var.k0 && yi0Var.W) || (yi0Var.Q == null && yi0Var.R != null)) {
            yi0Var.x();
        }
        yi0Var.p();
    }
