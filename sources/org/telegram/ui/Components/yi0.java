...
public final class yi0 extends Path {
    ...
    public final void b(Canvas canvas, float f7, float f10, Rect rect, float f11) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                vqVar.addRect(AndroidUtilities.lerp(rect.left - f7, xi0Var.a, d), AndroidUtilities.lerp(xi0Var.e ? rect.top - f10 : xi0Var.g, xi0Var.c, d), AndroidUtilities.lerp(rect.right - f7, xi0Var.b, d), AndroidUtilities.lerp(xi0Var.f ? rect.bottom - f10 : xi0Var.h, xi0Var.d, d), Path.Direction.CW);
                i10++;
            }
            vqVar.a();
        }
    ...
    public yi0(org.telegram.ui.Cells.u1 u1Var, ViewParent viewParent, int i10, ArrayList arrayList, int i11, int i12, float f7) {
        ...
        if (this.l.size() > 0) {
            ...
            xi0 xi0Var2 = (xi0) hg.c.g(1, this.l);
            xi0Var.e = true;
