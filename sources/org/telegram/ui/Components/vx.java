...
public final class vx extends ll0 {
    ...
    public final void J0(Canvas canvas, RectF rectF, long j3) {
        ...
        sparseArray.clear();
        int i13 = 1;
        boolean z11 = kzVar.u2 > 0 && SystemClock.elapsedRealtime() - kzVar.u2 < w1() && kzVar.r2 != null && kzVar.s2 >= 0;
        float f7 = 0.0f;
        if (kzVar.d2 != null && vxVar != null) {
            ...
            while (i14 < vxVar.getChildCount()) {
                ...
                if (z11 && childAt != null && RecyclerView.R(childAt) == kzVar.s2 - i13) {
                    z10 = z11;
        ...
        while (true) {
            ...
            if (txVar == null) {
                txVar = !arrayList2.isEmpty() ? (tx) hg.c.z(1, arrayList2) : new tx(this);
                txVar.M = i16;
                txVar.e();
            }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        sparseArray.clear();
        boolean z10 = kzVar.u2 > 0 && SystemClock.elapsedRealtime() - kzVar.u2 < w1() && kzVar.r2 != null && kzVar.s2 >= 0;
        if (kzVar.d2 != null && vxVar != null) {
            for (int i12 = 0; i12 < vxVar.getChildCount(); i12++) {
                ...
                if (z10 && childAt != null && RecyclerView.R(childAt) == kzVar.s2 - 1) {
