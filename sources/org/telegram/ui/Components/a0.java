...
public final class a0 extends ReplacementSpan {
    ...
    public a0(View[] viewArr) {
        this.a = 2;
        this.b = new nr(0.33d, 0.0d, 0.67d, 1.0d);
        this.c = viewArr;
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f10, int i12, int i13, int i14, Paint paint) {
        switch (this.a) {
            case 0:
                ...
                rectF.set(f10, f11 - AndroidUtilities.dp(7.66f), ((k01) this.c).c + f10 + AndroidUtilities.dp(6.66f), AndroidUtilities.dp(7.66f) + f11);
                canvas.saveLayerAlpha(rectF, 255, 31);
                Paint paint2 = (Paint) this.b;
                paint2.setColor(paint.getColor());
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), paint2);
                ((k01) this.c).c(AndroidUtilities.dp(3.33f) + f10, f11, 1.0f, -1, canvas);
                canvas.restore();
                break;
            case 1:
            ...
            default:
                ...
                for (int i16 = 0; i16 < 3; i16++) {
                    ...
                    canvas.drawCircle(AndroidUtilities.dpf2((nrVar.getInterpolation(min) * 16.0f) + 1.667f), AndroidUtilities.dp(3.0f), AndroidUtilities.dpf2((min <= 0.425f ? nrVar.getInterpolation(min / 0.425f) : 1.0f - nrVar.getInterpolation((min - 0.425f) / 0.575f)) * 2.0f), paint);
                }
                canvas.restore();
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.a) {
            case 0:
                return (int) (((k01) this.c).c + AndroidUtilities.dp(6.66f));
            case 1:
                return (int) (((k01) this.c).c + AndroidUtilities.dp(10.0f));
            default:
    ...
    public a0(int i10) {
        this.a = 1;
        this.b = new Paint(1);
        this.c = new k01(LocaleController.formatPluralString("BusinessRepliesMore", i10, new Object[0]), 9.33f, AndroidUtilities.bold());
    }
