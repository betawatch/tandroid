...
public abstract class cr {
    public static void a(Context context, final int i10, TLRPC.User user, TLRPC.TL_requestPeerTypeCreateBot tL_requestPeerTypeCreateBot, boolean z10, final Utilities.Callback callback, org.telegram.ui.ActionBar.f6 f6Var, vc vcVar) {
        vc vcVar2;
        String userName;
        if (!user.bot_can_manage_bots) {
            ...
            vcVar2.Q(R.raw.error, 36, AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(R.string.CreateManagedBotUnsupported, userName), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Gi, f6Var))).j();
            callback.run(null);
            return;
        }
        ...
        org.telegram.messenger.wl.n(i12, f6Var, h, 1, 14.0f);
        ...
        final int[] iArr = {-1};
        int[] iArr2 = {4};
        org.telegram.messenger.jb jbVar = new org.telegram.messenger.jb(i3Var2, new int[]{-1}, i10, strArr, new String[1], g10, e9Var2, f6Var, iArr2);
        xq xqVar = new xq(strArr, jbVar, i3Var, iArr2, g10, z10, i10, user, iArr, zArr, callback, i11, f6Var, context);
