...
public abstract class cr {
    public static void a(Context context, final int i10, TLRPC.User user, TLRPC.TL_requestPeerTypeCreateBot tL_requestPeerTypeCreateBot, boolean z10, final Utilities.Callback callback, org.telegram.ui.ActionBar.e6 e6Var, xc xcVar) {
        xc xcVar2;
        String userName;
        if (!user.bot_can_manage_bots) {
            ...
            xcVar2.Q(R.raw.error, 36, AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(R.string.CreateManagedBotUnsupported, userName), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Gi, e6Var))).j();
            callback.run(null);
            return;
        }
        org.telegram.ui.ActionBar.f3 i11 = org.telegram.messenger.wh.i(1, context, e6Var, true);
        ...
        org.telegram.messenger.wh.m(i12, e6Var, textView, 1, 20.0f);
        org.telegram.messenger.wh.k(R.string.CreateManagedBotTitle, textView, 17);
        TextView h = com.google.android.gms.internal.vision.e2.h(linearLayout, textView, w7.y5.t(-1, -2, 55, 16, 0, 16, 8), context);
        org.telegram.messenger.wh.m(i12, e6Var, h, 1, 14.0f);
        h.setText(AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(R.string.CreateManagedBotText, UserObject.getUserName(user)), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, e6Var)));
        h.setGravity(17);
        ...
        j3Var.setBackground(org.telegram.ui.ActionBar.j6.b0(dp, org.telegram.ui.ActionBar.j6.v0(i13, e6Var)));
        ...
        org.telegram.ui.Cells.j3 j3Var2 = new org.telegram.ui.Cells.j3(context, LocaleController.getString(R.string.CreateManagedBotUsername), false, false, 29, e6Var);
        LinearLayout linearLayout2 = new LinearLayout(context);
        linearLayout2.setOrientation(0);
        org.telegram.ui.Cells.h3 h3Var2 = j3Var2.b;
        j3Var2.removeView(h3Var2);
        h3Var2.setHintColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.H6, e6Var));
        ...
        j3Var2.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(16.0f), org.telegram.ui.ActionBar.j6.v0(i13, e6Var)));
        ...
        linearLayout3.addView(f7, w7.y5.p(0, 48, 119.0f, 1, 5, 0, 0, 0));
        i11.useBackgroundTopPadding = false;
        i11.smoothKeyboardAnimationEnabled = true;
        i11.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.a7, e6Var));
        i11.fixNavigationBar();
        final boolean[] zArr = new boolean[1];
        String[] strArr = new String[1];
        final int[] iArr = {-1};
        int[] iArr2 = {4};
        org.telegram.messenger.jb jbVar = new org.telegram.messenger.jb(j3Var2, new int[]{-1}, i10, strArr, new String[1], f7, e9Var2, e6Var, iArr2);
        xq xqVar = new xq(strArr, jbVar, j3Var, iArr2, f7, z10, i10, user, iArr, zArr, callback, i11, e6Var, context);
        h3Var2.addTextChangedListener(new br(jbVar));
        if (!TextUtils.isEmpty(str)) {
            jbVar.run();
        }
        h3Var2.setOnEditorActionListener(new e1(xqVar, 2));
        dVar.setOnClickListener(new e3(i11, 2));
        f7.setEnabled(false);
        f7.setOnClickListener(new f0(xqVar, 10));
        i11.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Components.yq
