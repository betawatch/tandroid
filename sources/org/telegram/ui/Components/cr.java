...
public abstract class cr {
    public static void a(Context context, final int i10, TLRPC.User user, TLRPC.TL_requestPeerTypeCreateBot tL_requestPeerTypeCreateBot, boolean z10, final Utilities.Callback callback, org.telegram.ui.ActionBar.e6 e6Var, vc vcVar) {
        ...
        org.telegram.ui.ActionBar.f3 j3 = org.telegram.messenger.vl.j(1, context, e6Var, true);
        ...
        org.telegram.messenger.vl.o(i11, e6Var, textView, 1, 20.0f);
        org.telegram.messenger.vl.l(R.string.CreateManagedBotTitle, textView, 17);
        TextView h = com.google.android.gms.internal.vision.e2.h(linearLayout, textView, w7.x5.t(-1, -2, 55, 16, 0, 16, 8), context);
        org.telegram.messenger.vl.o(i11, e6Var, h, 1, 14.0f);
        ...
        i3Var.setBackground(org.telegram.ui.ActionBar.i6.b0(dp, org.telegram.ui.ActionBar.i6.v0(i12, e6Var)));
        ...
        i3Var2.setBackground(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(16.0f), org.telegram.ui.ActionBar.i6.v0(i12, e6Var)));
        ...
        j3.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.a7, e6Var));
        j3.fixNavigationBar();
        ...
        xq xqVar = new xq(strArr, jbVar, i3Var, iArr2, g10, z10, i10, user, iArr, zArr, callback, j3, e6Var, context);
        g3Var2.addTextChangedListener(new br(jbVar));
        if (!TextUtils.isEmpty(str)) {
            jbVar.run();
        }
        g3Var2.setOnEditorActionListener(new e1(xqVar, 2));
        dVar.setOnClickListener(new c3(j3, 2));
        g10.setEnabled(false);
        g10.setOnClickListener(new f0(xqVar, 10));
        j3.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Components.yq
