...
public abstract class ja extends View {
    ...
    public ja(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.a = f6Var;
        da0 da0Var = (da0) this;
        this.b = new ia[]{new ia(da0Var, 0, R.raw.msg_stories_saved, 20, 40, LocaleController.getString(R.string.ProfileMyStoriesTab)), new ia(da0Var, 1, R.raw.msg_stories_archive, 0, 0, LocaleController.getString(R.string.ProfileStoriesArchiveTab))};
