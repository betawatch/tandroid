...
public final /* synthetic */ class lr0 implements Runnable {
    ...
    public /* synthetic */ lr0(org.telegram.ui.ActionBar.d2[] d2VarArr, int i10, int i11, int i12) {
        this.a = i12;
        this.b = d2VarArr;
        this.c = i10;
        this.d = i11;
        ...
        switch (this.a) {
            case 0:
                ...
                if (d2Var != null) {
                    ...
                    d2Var.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.Components.rr0
            ...
            default:
                ...
                if (d2Var2 != null) {
                    ...
                    d2Var2.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.Components.rr0
                        @Override // android.content.DialogInterface.OnCancelListener
                        public final void onCancel(DialogInterface dialogInterface) {
                            switch (i13) {
                                case 0:
