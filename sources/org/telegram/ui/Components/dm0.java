...
public final class dm0 {
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.d6 d6Var, int i10) {
        ...
        if (messageObject == null) {
            ...
            this.A = v02;
            this.z = v02;
            this.x = org.telegram.ui.ActionBar.h6.l1(a2 ? 0.12f : 0.1f, v02);
            this.C = h();
        ...
        if (i10 != 4 || (message4 = messageObject.messageOwner) == null || MessageObject.getMedia(message4) == null || !(MessageObject.getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaContact)) {
            ...
            if (i10 != 0 && (messageObject.overrideLinkColor >= 0 || (messageObject.messageOwner != null && (((messageObject.isFromUser() || DialogObject.isEncryptedDialog(messageObject.getDialogId())) && user2 != null) || ((messageObject.isFromChannel() && chat != null) || (((message3 = messageObject.messageOwner) != null && (messageFwdHeader3 = message3.fwd_from) != null && messageFwdHeader3.from_id != null) || (messageObject.isSponsored() && (peerColor2 = messageObject.sponsoredColor) != null && peerColor2.color != -1))))))) {
                ...
                this.x = org.telegram.ui.ActionBar.h6.l1(0.1f, this.z);
                this.y = this.z;
                ...
                this.A = v04;
                this.z = v04;
                this.x = org.telegram.ui.ActionBar.h6.l1(0.1f, v04);
                this.y = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Wc, d6Var);
            } else {
                ...
                m(messageObject.replyMessageObject, i14, d6Var);
                this.x = org.telegram.ui.ActionBar.h6.l1(0.1f, this.z);
                this.y = this.z;
            }
        } else {
            long j3 = MessageObject.getMedia(messageObject.messageOwner).user_id;
            TLRPC.User user6 = j3 != 0 ? MessagesController.getInstance(messageObject.currentAccount).getUser(Long.valueOf(j3)) : null;
        ...
        if (messageObject.shouldDrawWithoutBackground()) {
            ...
            this.z = -1;
            this.x = 0;
            this.y = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Xc, d6Var);
        } else if (messageObject.isOutOwner() || i10 == 2) {
            if (i10 != 2 || messageObject.isOutOwner()) {
                int v05 = org.telegram.ui.ActionBar.h6.v0((this.i || this.j) ? org.telegram.ui.ActionBar.h6.bb : org.telegram.ui.ActionBar.h6.ab, d6Var);
                this.B = v05;
                this.A = v05;
                this.z = v05;
            } else {
                int v06 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.pk, d6Var);
                this.B = v06;
                this.A = v06;
                this.z = v06;
            }
            if (this.j) {
                this.R = true;
                this.z = org.telegram.ui.ActionBar.h6.l1(0.2f, this.z);
                this.A = org.telegram.ui.ActionBar.h6.l1(0.5f, this.A);
            } else if (this.i) {
                this.R = true;
                this.z = org.telegram.ui.ActionBar.h6.l1(0.35f, this.z);
            }
            this.x = org.telegram.ui.ActionBar.h6.l1(a2 ? 0.12f : 0.1f, this.B);
            this.y = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.cb, d6Var);
        }
        ...
        if (this.v != 0 && this.t == null && (view = this.D) != null) {
            this.t = new o5(AndroidUtilities.dp(20.0f), 13, view, false);
    ...
    public final void d(Canvas canvas, RectF rectF, float f7, boolean z10, boolean z11) {
        ...
        o5 o5Var;
        if (!z11) {
            int l1 = org.telegram.ui.ActionBar.h6.l1(f7, this.E.a(this.x, false));
            Paint paint = this.g;
            paint.setColor(l1);
            float[] fArr = this.e;
            if (yf.e0.c(fArr)) {
            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof q5) && (l4Var = ((q5) drawable).k) != null && l4Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (i10 != 0 || (o5Var = this.u) == null || this.w == 0) {
                            o5Var = this.t;
                        }
                        cm0 cm0Var = cm0VarArr[i10];
                        if (!cm0Var.e || z10) {
                            o5Var.v = (int) ((o5Var == this.u ? 1.0f : 0.3f) * 255.0f * cm0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(cm0Var.a);
                            float dp2 = AndroidUtilities.dp(cm0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * cm0Var.c * e;
    ...
    */
    public final void e(Canvas canvas, RectF rectF, float f7) {
        ...
        int l1 = org.telegram.ui.ActionBar.h6.l1(f7, a2);
        Paint paint = this.b;
        paint.setColor(l1);
        ...
        if (e > 0.0f && !this.i) {
            ...
            float f13 = floor;
            canvas.drawRoundRect(rectF2, AndroidUtilities.dp(f13), AndroidUtilities.dp(f13), paint);
            paint.setAlpha(alpha);
            i();
            float pow = ((float) Math.pow((this.T / 240.0f) / 4.0f, 0.8500000238418579d)) * 4.0f;
            rectF2.set(rectF.left, (AndroidUtilities.lerp(0.0f, 1.0f - rr.i.getInterpolation(w7.q.a(((Math.max(pow, 0.5f) + 1.5f) % 3.5f) * 0.5f, 0.0f, 1.0f)), e) * rectF.height()) + rectF.top, rectF.left + AndroidUtilities.dp(6.0f), (AndroidUtilities.lerp(1.0f, 1.0f - rr.g.getInterpolation(w7.q.a((((pow + 1.5f) % 3.5f) - 1.5f) * 0.5f, 0.0f, 1.0f)), e) * rectF.height()) + rectF.top);
        ...
        int l12 = org.telegram.ui.ActionBar.h6.l1(f7, a2);
        int h = i0.a.h(org.telegram.ui.ActionBar.h6.l1(e7 * f7, a10), l12);
        int h10 = this.j ? i0.a.h(org.telegram.ui.ActionBar.h6.l1(f7 * e10, a11), l12) : 0;
        int round = Math.round(AndroidUtilities.dpf2(6.33f));
        int max2 = Math.max(1, AndroidUtilities.dp(3.0f));
        int dp3 = this.j ? AndroidUtilities.dp(18.99f) : AndroidUtilities.dp(f10);
        ...
        paint2.setAlpha(255);
        rectF2.set(0.0f, 0.0f, f11 - rectF.left, rectF.bottom - rectF.top);
        float f16 = rectF2.left;
        canvas.clipRect(f16, rectF2.top, AndroidUtilities.dp(3.0f) + f16, rectF2.bottom);
        float f17 = floor;
        canvas.drawRoundRect(rectF2, AndroidUtilities.dp(f17), AndroidUtilities.dp(f17), paint2);
        canvas.restore();
    }
    ...
    public final void f(Canvas canvas, RectF rectF, float f7, float f10, float f11, float f12) {
        ...
        this.h.f(org.telegram.ui.ActionBar.h6.l1(0.1f, this.z), org.telegram.ui.ActionBar.h6.l1(0.3f, this.z), org.telegram.ui.ActionBar.h6.l1(0.3f, this.z), org.telegram.ui.ActionBar.h6.l1(1.25f, this.z));
        this.h.d(rectF);
        this.h.i(fArr);
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        if (this.w != 0 && this.u == null && view != null) {
            this.u = new o5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.u1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.u1) view).M0) {
                this.u.a();
            }
        }
    ...
    public final void m(MessageObject messageObject, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        if (i10 < 7) {
            int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.r8[i10], d6Var);
            this.B = v02;
            this.A = v02;
            this.z = v02;
            this.j = false;
        ...
        if (color == null) {
            int v03 = org.telegram.ui.ActionBar.h6.v0((messageObject == null || !messageObject.isOutOwner()) ? org.telegram.ui.ActionBar.h6.Uc : org.telegram.ui.ActionBar.h6.ab, d6Var);
            this.B = v03;
            this.A = v03;
            this.z = v03;
            this.j = false;
        ...
        this.z = color.getColor(0, d6Var);
        this.A = color.getColor(1, d6Var);
        int color2 = color.getColor(2, d6Var);
        this.B = color2;
        int i11 = this.A;
        int i12 = this.z;
        this.i = i11 != i12;
    ...
    public final int o(org.telegram.ui.ActionBar.d6 d6Var) {
        View view;
        int i10 = org.telegram.ui.ActionBar.h6.q7;
        this.y = org.telegram.ui.ActionBar.h6.v0(i10, d6Var);
        this.z = org.telegram.ui.ActionBar.h6.v0(i10, d6Var);
        this.i = false;
        this.j = false;
        this.x = org.telegram.ui.ActionBar.h6.l1(0.1f, org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        if (this.v != 0 && this.t == null && (view = this.D) != null) {
            this.t = new o5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.u1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.u1) view).M0) {
                this.t.a();
    ...
    public final void q(int i10, boolean z10) {
        ...
        this.A = i10;
        this.z = i10;
        this.x = org.telegram.ui.ActionBar.h6.l1(z10 ? 0.12f : 0.1f, i10);
        this.C = i10;
    }
}
