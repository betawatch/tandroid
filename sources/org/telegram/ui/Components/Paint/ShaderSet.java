...
public abstract class ShaderSet {
    ...
    private static Map createMap() {
        ...
        hashMap.put("maskingBlit", Collections.unmodifiableMap(hashMap4));
        ...
        hashMap.put("blitWithMask", Collections.unmodifiableMap(hashMap5));
        ...
        hashMap.put("blitWithMask_masking", Collections.unmodifiableMap(hashMap6));
        ...
        hashMap.put("blitWithMaskBlurer", Collections.unmodifiableMap(hashMap8));
        ...
        hashMap.put("compositeWithMaskBlurer", Collections.unmodifiableMap(hashMap9));
        ...
        hashMap.put("videoBlur", Collections.unmodifiableMap(hashMap10));
        ...
        hashMap.put("brushLight", Collections.unmodifiableMap(hashMap11));
        ...
        hashMap.put("blitWithMaskLight", Collections.unmodifiableMap(hashMap12));
        ...
        hashMap.put("compositeWithMaskLight", Collections.unmodifiableMap(hashMap13));
        ...
        hashMap.put("blitWithMaskEraser", Collections.unmodifiableMap(hashMap14));
        ...
        hashMap.put("blitWithMaskEraser_masking", Collections.unmodifiableMap(hashMap15));
        ...
        hashMap.put("compositeWithMaskEraser", Collections.unmodifiableMap(hashMap16));
        ...
        hashMap.put("nonPremultipliedBlit", Collections.unmodifiableMap(hashMap17));
        ...
        hashMap.put("shape", Collections.unmodifiableMap(hashMap18));
