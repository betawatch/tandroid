...
public abstract class EntityView extends FrameLayout {
    private static final List STICKY_ANGLES = Arrays.asList(-90, 0, 90, Integer.valueOf(NotificationCenter.suggestedFiltersLoaded));
    private float angle;
                    ...
                    if (actionMasked == 2) {
                        ...
                        if (i == 3) {
                            ...
                            if (EntityView.this.hasTransformed || Math.abs(f4) > AndroidUtilities.dp(2.0f) || Math.abs(f5) > AndroidUtilities.dp(2.0f)) {
                                ...
                                float distance2 = MathUtils.distance(centerLocation[0], centerLocation[1], f2, f3);
                                float f6 = 0.0f;
                                if (distance > 0.0f) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x0132, code lost:
        ...
        if (java.lang.Math.abs((r9.position.y + (((height() / 2.0f) - getStickyPaddingBottom()) * getScaleY())) - (r10.getMeasuredHeight() - org.telegram.messenger.AndroidUtilities.dp(64.0f))) <= org.telegram.messenger.AndroidUtilities.dp(12.0f)) goto L36;
     */
