...
public class StickerMakerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StickerMakerView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        paint.setAlpha(NotificationCenter.fileLoadFailed);
    ...
    public class SegmentedObject {
        ...
        public void drawAnimationBorders(Canvas canvas, float f, float f2, View view) {
            ...
            if (this.points == null) {
                ...
                float f11 = this.pointsCount;
                int i2 = (int) (f * f11);
                int min2 = Math.min(500, (int) (f11 * 0.6f)) + i2;
                if (this.pointsCount > 0) {
                    for (int i3 = i2; i3 <= min2; i3++) {
                        float f12 = (i3 - i2) / (min2 - i2);
                        this.pointsPaint.setAlpha((int) (Math.min(1.0f, Math.min(f12, 1.0f - f12) * 4.0f) * 255.0f * f2));
    ...
    */
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.objects != null && this.bordersAnimator != null) {
            ...
            while (true) {
                ...
                boolean z = segmentedObjectArr[i] == objectBehind && motionEvent.getAction() != 3;
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.fileUploadProgressChanged) {
            ...
            if (longValue2 > 0) {
                ...
                stickerUploader4.uploadProgress = Utilities.clamp(longValue / longValue2, 1.0f, stickerUploader4.uploadProgress);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$afterUploadingMedia$25(final TLObject tLObject, int i, final StickerUploader stickerUploader, TLRPC.TL_error tL_error) {
        boolean z;
        if (tLObject instanceof TLRPC.TL_messages_stickerSet) {
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) tLObject;
            MediaDataController.getInstance(i).putStickerSet(tL_messages_stickerSet);
