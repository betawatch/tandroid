...
public final class t81 extends View {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        int i21;
        v81 v81Var = this.r;
        TextPaint textPaint = v81Var.d;
        TextPaint textPaint2 = v81Var.e;
        Paint paint = v81Var.f;
        org.telegram.ui.ActionBar.d6 d6Var = v81Var.j0;
        TextPaint textPaint3 = v81Var.c;
        canvas.save();
        ...
        if (v81Var.E == 9) {
            textPaint3.setColor(org.telegram.ui.ActionBar.h6.v0(v81Var.R, d6Var));
        } else if ((v81Var.J || i24 != -1) && (i22 == i10 || i22 == i11)) {
            textPaint3.setColor(i0.a.d(v81Var.K, org.telegram.ui.ActionBar.h6.v0(i13, d6Var), org.telegram.ui.ActionBar.h6.v0(i12, d6Var)));
        } else {
        ...
        if (this.a.a != Integer.MAX_VALUE) {
            if (v81Var.n) {
                ...
                if ((charSequence != null && this.d != null) || !TextUtils.equals(charSequence, this.d)) {
                    s81 s81Var = this.a;
                    CharSequence replaceEmoji = Emoji.replaceEmoji(s81Var.b, textPaint3.getFontMetricsInt(), false);
                    s81Var.b = replaceEmoji;
                    this.d = replaceEmoji;
                    t01 t01Var2 = this.e;
                    if (t01Var2 != null) {
                        z5.release(t01Var2.j, t01Var2.k);
                    }
                ...
                if (this.a.a != Integer.MAX_VALUE) {
                    if (v81Var.n) {
                        textPaint.setColor(org.telegram.ui.ActionBar.h6.v0(v81Var.T, d6Var));
                        if (org.telegram.ui.ActionBar.h6.c1(i14) && org.telegram.ui.ActionBar.h6.c1(i15)) {
                            ...
                            if ((v81Var.J || v81Var.L != -1) && ((i21 = this.a.a) == i19 || i21 == i20)) {
                                paint.setColor(i0.a.d(v81Var.K, org.telegram.ui.ActionBar.h6.v0(i15, d6Var), v02));
                            } else {
                                paint.setColor(v02);
                            }
                        } else {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        s81 s81Var = this.a;
        accessibilityNodeInfo.setSelected((s81Var == null || (i10 = this.r.G) == -1 || s81Var.a != i10) ? false : true);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        s81 s81Var = this.a;
        v81 v81Var = this.r;
        setMeasuredDimension(AndroidUtilities.dp(v81Var.r * 2) + s81Var.a(v81Var.c) + v81Var.I, View.MeasureSpec.getSize(i11));
    }
