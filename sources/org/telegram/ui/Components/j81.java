...
public class j81 extends FrameLayout {
    ...
    */
                ...
                if (motionEvent != null && motionEvent.getAction() == 0 && !this.H && !this.I) {
                    ...
                    if (this.H) {
                        ...
                        if (this.d < 0) {
                            ...
                            ofFloat.addUpdateListener(new x71(this, i10));
                        ...
                        this.w.addListener(new y71(this, i10));
                        this.w.start();
                        this.x = true;
                        this.H = false;
                        x(false);
    ...
    public final void E(int i10) {
        if (i10 != this.b) {
            ...
            if (valueAnimator == null || this.d != i10) {
                ...
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.R = ofFloat;
                ofFloat.addUpdateListener(new x71(this, i11));
                this.R.addListener(new y71(this, i11));
    ...
    public final i81 n(int i10, boolean z10) {
        z71 z71Var = new z71(this, getContext(), z10, i10, this.a);
        this.M = z71Var;
        z71Var.r = H();
    ...
    public void setAdapter(b81 b81Var) {
        ...
        b81Var.b(viewArr[0], this.b, iArr[0]);
        addView(viewArr[0]);
        viewArr[0].setVisibility(0);
        o(false);
    }
