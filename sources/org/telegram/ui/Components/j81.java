...
public final class j81 extends View {
    ...
    public j81(Context context, boolean z10, View view, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.F = new int[4];
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (e6Var == null ? org.telegram.ui.ActionBar.i6.a1() : e6Var.p0()) {
        ...
        int y3 = org.telegram.messenger.vl.y(28.0f, getMeasuredWidth() - this.h, 2);
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.vl.C(56.0f, this.n, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), TLObject.FLAG_30));
    }
