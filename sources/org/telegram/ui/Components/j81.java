...
public final class j81 extends View {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        int i21;
        l81 l81Var = this.r;
        TextPaint textPaint = l81Var.d;
        TextPaint textPaint2 = l81Var.e;
        Paint paint = l81Var.f;
        org.telegram.ui.ActionBar.g6 g6Var = l81Var.g0;
        TextPaint textPaint3 = l81Var.c;
        canvas.save();
        ...
        if (l81Var.B == 9) {
            textPaint3.setColor(org.telegram.ui.ActionBar.k6.v0(l81Var.O, g6Var));
        } else if ((l81Var.G || i24 != -1) && (i22 == i10 || i22 == i11)) {
            textPaint3.setColor(i0.a.d(l81Var.H, org.telegram.ui.ActionBar.k6.v0(i13, g6Var), org.telegram.ui.ActionBar.k6.v0(i12, g6Var)));
        } else {
        ...
        if (this.a.a != Integer.MAX_VALUE) {
            if (l81Var.n) {
                ...
                if ((charSequence != null && this.d != null) || !TextUtils.equals(charSequence, this.d)) {
                    i81 i81Var = this.a;
                    CharSequence replaceEmoji = Emoji.replaceEmoji(i81Var.b, textPaint3.getFontMetricsInt(), false);
                    i81Var.b = replaceEmoji;
                    this.d = replaceEmoji;
                    l01 l01Var2 = this.e;
                    if (l01Var2 != null) {
                        u5.release(l01Var2.j, l01Var2.k);
                    }
                    l01 l01Var3 = new l01(this.d, textPaint3.getTextSize() / AndroidUtilities.density, textPaint3.getTypeface());
                    l01Var3.s(this);
                    this.e = l01Var3;
                }
                l01Var = this.e;
                if (l01Var == null) {
                    l01Var.p = AndroidUtilities.dp(400.0f);
                    i20 = i11;
                    i19 = i10;
                    i18 = measuredWidth;
                    l01Var.c(measuredWidth, getMeasuredHeight() / 2, 1.0f, textPaint3.getColor(), canvas);
                    canvas2 = canvas;
                } else {
                    canvas2 = canvas;
                    i18 = measuredWidth;
                ...
                if (this.a.a != Integer.MAX_VALUE) {
                    if (l81Var.n) {
                        textPaint.setColor(org.telegram.ui.ActionBar.k6.v0(l81Var.Q, g6Var));
                        if (org.telegram.ui.ActionBar.k6.c1(i14) && org.telegram.ui.ActionBar.k6.c1(i15)) {
                            ...
                            if ((l81Var.G || l81Var.I != -1) && ((i21 = this.a.a) == i19 || i21 == i20)) {
                                paint.setColor(i0.a.d(l81Var.H, org.telegram.ui.ActionBar.k6.v0(i15, g6Var), v02));
                            } else {
                                paint.setColor(v02);
                            }
                        } else {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        i81 i81Var = this.a;
        accessibilityNodeInfo.setSelected((i81Var == null || (i10 = this.r.D) == -1 || i81Var.a != i10) ? false : true);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        i81 i81Var = this.a;
        l81 l81Var = this.r;
        setMeasuredDimension(AndroidUtilities.dp(l81Var.r * 2) + i81Var.a(l81Var.c) + l81Var.F, View.MeasureSpec.getSize(i11));
    }
