...
public class kj0 extends BitmapDrawable implements Animatable, yf.c {
    ...
    */
    public kj0(File file, String str, int i10, int i11, b2.n1 n1Var, boolean z10, int i12, boolean z11) {
        char c10;
        RLottieNative a2;
        int[] iArr = new int[3];
        this.e = iArr;
        ...
        this.i0 = new RectF[2];
        this.j0 = new Paint[2];
        this.v0 = new jj0(this, 1);
        this.w0 = new jj0(this, 2);
        this.y0 = new jj0(this, 3);
        this.z0 = new jj0(this, 4);
    ...
    public static void e(kj0 kj0Var) {
        if (kj0Var.l0 || kj0Var.V || !kj0Var.k() || kj0Var.O != null) {
            return;
        }
        kj0Var.x0 = true;
        if (T0 == null) {
    ...
    public static void f(kj0 kj0Var) {
        ...
        try {
            ...
            if (i10 == 1) {
                if (kj0Var.S != null) {
                    ...
                    createBitmap = Bitmap.createBitmap(kj0Var.b, kj0Var.c, kj0Var.G ? Bitmap.Config.ALPHA_8 : Bitmap.Config.ARGB_8888);
        ...
        if (i10 == 1) {
            kj0Var.G0 = 0;
            AndroidUtilities.runOnUIThread(kj0Var.w0);
        } else if (i10 == 2) {
            AndroidUtilities.runOnUIThread(kj0Var.v0, kj0Var.G0);
            kj0Var.G0 = Math.min((Math.max(kj0Var.G0, 2) * 3) / 2, 2000);
        } else if (i10 == 3) {
            AndroidUtilities.runOnUIThread(kj0Var.v0);
        }
    ...
    public static void h(kj0 kj0Var) {
        kj0Var.X = true;
        if ((!kj0Var.k0 && kj0Var.W) || (kj0Var.Q == null && kj0Var.R != null)) {
            kj0Var.x();
        }
        kj0Var.p();
    }
