...
public final class i30 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public i30(int i10, Context context, boolean z4) {
        ...
        this.b.b();
        this.c.b();
        ij0 ij0Var = new ij0(R.raw.voice_outlined, "" + R.raw.voice_outlined, AndroidUtilities.dp(22.0f), AndroidUtilities.dp(30.0f), true, null);
        this.D = ij0Var;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (z12) {
            ...
            if (f14 != 1.0f) {
                ...
                float interpolation = pr.f.getInterpolation(this.K) * 0.1f;
                float f16 = interpolation + 1.0f;
                lj0 lj0Var = this.C;
                lj0Var.setScaleY(f16);
                lj0Var.setScaleX(f16);
                z4 = this.F;
                if (z4) {
                    long currentTimeMillis = System.currentTimeMillis();
                    if (currentTimeMillis - this.E > 1000) {
                        this.E = currentTimeMillis;
                        float d = android.support.v4.media.a.d(org.telegram.ui.yh.f(this.G, 100), 0.5f, 100.0f, 0.5f);
                        this.e = d;
                                    ...
                                    if (i11 != 0 || this.n != null) {
                                        ...
                                        if (i11 == 0) {
                                            if (this.v != f26) {
                                                ...
                                                if (h30Var.i == i14) {
                                                    paint.setShader(r12);
                                                    paint.setColor(org.telegram.ui.ActionBar.k6.w0(r12, org.telegram.ui.ActionBar.k6.bh, false));
                                                } else {
                                                    paint.setShader(h30Var.g);
                                                }
        ...
        float interpolation3 = pr.f.getInterpolation(this.K) * 0.1f;
        float f162 = interpolation3 + 1.0f;
        lj0 lj0Var2 = this.C;
        lj0Var2.setScaleY(f162);
        lj0Var2.setScaleX(f162);
        z4 = this.F;
        if (z4) {
        }
        f10 = this.e;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        c30 c30Var = c30.a0;
        if (c30Var != null) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString(c30Var.w ? R.string.AccDescrCloseMenu : R.string.AccDescrOpenMenu2)));
        }
    }
