...
public class cd0 extends LinearLayout {
    ...
    public cd0(LaunchActivity launchActivity) {
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.E) {
            ...
            if (strArr != null) {
                ...
                yc0 yc0Var = this.K;
                str = yc0Var != null ? yc0Var.e(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
    ...
    public final boolean h(zm0 zm0Var) {
        zm0Var.q = true;
        int i10 = zm0Var.e - zm0Var.k;
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.G;
                    yc0 yc0Var = this.K;
                    str = yc0Var != null ? yc0Var.e(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z10) {
        ...
        if (z10 && (ad0Var = this.I) != null) {
            ad0Var.q(this, this.G);
        }
        f();
        invalidate();
        if (this.k0 != 0 || (zc0Var = this.J) == null) {
            return;
        }
        zc0Var.n(0);
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (f7 < this.l0) {
            if (this.k0 == 0) {
                ...
                bd0Var.c = 1;
                bd0Var.b = 2;
                ((cd0) bd0Var.d).postDelayed(bd0Var, ViewConfiguration.getTapTimeout());
            }
            ...
            bd0Var2.c = 1;
            bd0Var2.b = 1;
            ((cd0) bd0Var2.d).postDelayed(bd0Var2, ViewConfiguration.getTapTimeout());
        }
        ...
        if (f10 < this.l0) {
            ...
            xc0 xc0Var = this.V;
            xc0Var.a = false;
            postDelayed(xc0Var, longPressTimeout);
            return true;
        }
        if (f10 > this.m0) {
            ...
            xc0 xc0Var2 = this.V;
            xc0Var2.a = true;
            postDelayed(xc0Var2, longPressTimeout2);
        }
        return true;
    }
    ...
    public void setFormatter(yc0 yc0Var) {
        if (yc0Var == this.K) {
            return;
        }
        this.K = yc0Var;
    ...
    public void setOnScrollListener(zc0 zc0Var) {
        this.J = zc0Var;
    }

    public void setOnValueChangedListener(ad0 ad0Var) {
        this.I = ad0Var;
    }
    ...
    */
    ...
    public cd0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        this(context, 18, f6Var);
    }

    public cd0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.a = 3;
        this.b = 1;
        this.L = 300L;
        ...
        this.O = paint2;
        this.S = new zm0(getContext(), null);
        this.T = new zm0(getContext(), new DecelerateInterpolator(2.5f));
        n();
        setImportantForAccessibility(1);
        setAccessibilityDelegate(new wc0(this));
    }
}
