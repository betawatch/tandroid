...
public final class lv0 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i13 >= length) {
                ...
                paint.setColor(i0.a.k(org.telegram.ui.ActionBar.g6.v0(i16, c6Var2), 80));
                float f13 = dp;
            ...
            float f14 = i13;
            float f15 = f14 - d;
            float max = Math.max(f9, f10 - Math.abs(f15));
            float a2 = i7.w.a((d - f14) + f10, f9, f10);
            ...
            int i21 = this.F;
            int d11 = i0.a.d(a2, v02, org.telegram.ui.ActionBar.g6.l1((i21 == Integer.MIN_VALUE || i13 > i21) ? 1.0f : 0.5f, v03));
            paint.setColor(d11);
            Paint paint2 = this.c;
            paint2.setColor(d11);
            float f16 = dp;
            ...
            if (i13 != 0) {
                ...
                if (i25 == -1 || i13 - 1 < i25) {
                    ...
                    int dp2 = (int) (i23 - (AndroidUtilities.dp(3.0f) * i7.w.a(1.0f - Math.min(Math.abs(f15), Math.abs(f17)), 0.0f, 1.0f)));
                    canvas2 = canvas;
            ...
            int d12 = i0.a.d(max, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.y6, c6Var), org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.n6, c6Var));
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float a2 = i7.w.a(((this.f / 2.0f) + (x4 - this.n)) / (((this.h * 2) + this.r) + r3), 0.0f, this.B.length - 1);
        ...
        if (motionEvent.getAction() == 2) {
            if (!this.v && Math.abs(this.x - x4) > Math.abs(this.y - y8)) {
                getParent().requestDisallowInterceptTouchEvent(true);
            }
            if (this.w && Math.abs(this.x - x4) >= AndroidUtilities.touchSlop) {
                this.v = true;
                this.w = false;
            }
            if (this.v) {
