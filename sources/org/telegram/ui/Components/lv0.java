...
public final class lv0 extends ul0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i11 = c1Var.f;
        if (i11 == 0) {
            ((org.telegram.ui.Cells.x7) c1Var.a).setDialog(nv0.p(i10 - 1));
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            nv0Var.e = textView;
            textView.setTextColor(nv0Var.getThemedColor(org.telegram.ui.ActionBar.j6.J5));
            nv0Var.e.setTextSize(1, 14.0f);
            nv0Var.e.setGravity(17);
            nv0Var.e.setPadding(0, 0, 0, AndroidUtilities.dp(8.0f));
            x7Var.addView(nv0Var.e, w7.y5.c(40.0f, -1));
        } else {
            f6Var = ((org.telegram.ui.ActionBar.f3) nv0Var).resourcesProvider;
