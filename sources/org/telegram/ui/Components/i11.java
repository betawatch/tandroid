...
public final class i11 extends FrameLayout {
    public boolean E;
    public boolean F;
    public boolean G;
    ...
    public i11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        super(context);
        this.I = editorAlert;
        ...
        while (i10 < 4) {
            ...
            this.n[i10].addTextChangedListener(new h11(this, i10));
            this.n[i10].setOnEditorActionListener(new s2(2));
            i10++;
        }
    }
    ...
    public final void d(boolean z10) {
        ...
        ObjectAnimator ofInt = ObjectAnimator.ofInt(e3Var, t6.d, z10 ? 0 : 51);
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        int f7 = i2.g.f(20.0f, (i10 / 2) - (this.b * 2), 1);
        this.r = f7;
        int i14 = f7 * 2;
        int i15 = f7 * 2;
