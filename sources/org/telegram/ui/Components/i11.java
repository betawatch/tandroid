...
public final class i11 implements TextWatcher {
    ...
    */
    public final void afterTextChanged(Editable editable) {
        ...
        int i12;
        j11 j11Var = this.b;
        EditTextBoldCursor[] editTextBoldCursorArr = j11Var.n;
        ThemeEditorView.EditorAlert editorAlert = j11Var.I;
        if (editorAlert.K) {
            return;
        }
        editorAlert.K = true;
        ...
        if (i13 == 2) {
            ...
            if (i13 != 0) {
                ...
                for (i12 = 0; i12 < ThemeEditorView.this.c.size(); i12++) {
                    ((org.telegram.ui.ActionBar.k6) ThemeEditorView.this.c.get(i12)).d(j11Var.b(), false, true);
                }
                editorAlert.K = false;
            }
            i10 = b10 & (-16711681);
