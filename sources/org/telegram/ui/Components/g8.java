...
public final class g8 extends kl0 {
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        e6Var = ((org.telegram.ui.ActionBar.f3) h8Var).resourcesProvider;
        xVar.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(i11, e6Var));
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 1) {
            ...
            knVar.setTag(-33024);
            return new vk0(knVar);
        }
        boolean currentPlaylistIsGlobalSearch = MediaController.getInstance().currentPlaylistIsGlobalSearch();
        e6Var = ((org.telegram.ui.ActionBar.f3) this.n).resourcesProvider;
        return new vk0(new org.telegram.ui.Cells.x(context, currentPlaylistIsGlobalSearch ? 1 : 0, e6Var));
    }
}
