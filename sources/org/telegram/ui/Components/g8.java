...
public final /* synthetic */ class g8 implements Runnable {
    ...
    public /* synthetic */ g8(h8 h8Var, String str, ArrayList arrayList) {
        this.b = h8Var;
        this.d = str;
        this.c = arrayList;
    }
        ...
        switch (i10) {
            case 0:
                ...
                if (lowerCase.length() == 0) {
                    AndroidUtilities.runOnUIThread(new g8(h8Var, new ArrayList(), str2));
                    break;
                } else {
            ...
            default:
                ...
                if (i8Var.h) {
                    ...
                    h8Var.l();
                    i8Var.r.n0(0);
                    org.telegram.messenger.rk.q(R.string.NoAudioFoundPlayerInfo, new Object[]{str2}, i8Var.y);
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ g8(h8 h8Var, ArrayList arrayList, String str) {
        this.b = h8Var;
        this.c = arrayList;
        this.d = str;
    }
