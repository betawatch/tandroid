...
public final class c6 extends BitmapDrawable implements Animatable, xf.c {
    ...
    public final void D(long j3) {
        ...
        if (this.r != null) {
            if (z5Var2 == null || (z10 && !this.a && this.M < 0)) {
                z5 z5Var3 = this.n;
                if (z5Var3 != null) {
                    this.h.add(z5Var3);
                }
    ...
    */
    ...
    public final Bitmap r(boolean z10) {
        ...
        if (this.v == null) {
            if (this.h.isEmpty()) {
                float f7 = this.d[0];
                float f10 = this.m0;
                this.v = new z5(Bitmap.createBitmap((int) (f7 * f10), (int) (r0[1] * f10), Bitmap.Config.ARGB_8888));
            } else {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public c6(File file, boolean z10, long j3, int i10, TLRPC.Document document, ImageLocation imageLocation, Object obj, long j10, int i11, boolean z11, int i12, int i13, b2.n1 n1Var, int i14, boolean z12) {
        char c10;
        char c11;
        long j11;
        boolean z13;
        ...
        this.w0 = true;
        this.B0 = new a6(this, 2);
        this.E0 = new a6(this, 3);
        this.F0 = new a6(this, 4);
        this.G0 = 0;
        this.H0 = new a6(this, 5);
        this.I0 = new a6(this, 6);
        this.S0 = new b6(this, 0);
        this.G = file;
        ...
        if (z14) {
            ...
            if (this.d0 == null || (iArr[c10] <= 3840 && iArr[c11] <= 3840)) {
                j11 = j10;
                z13 = false;
                eVar = new xf.e(file, this, n1Var, this.j0, this.i0, !this.x0, 0);
                this.z0 = eVar;
                if (j11 == 0) {
                    y(j11, z13, z13);
                    return;
