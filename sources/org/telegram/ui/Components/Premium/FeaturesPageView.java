    ...
    private class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            if (i == 1) {
                ...
                addView(starParticlesView, LayoutHelper.createFrame(-1, NotificationCenter.boostedChannelByUser, 55));
                ...
                addView(this.iconTextureView, LayoutHelper.createFrame(NotificationCenter.screenshotTook, NotificationCenter.screenshotTook, 1));
