        ...
        private void generateBitmaps() {
            ...
            for (int i8 = 0; i8 < 3; i8++) {
                ...
                if (i10 == 9) {
                    ...
                    if (i8 == 0) {
                        this.stars[i8] = SvgHelper.getBitmap(R.raw.filled_premium_dollar, i9, i9, ColorUtils.setAlphaComponent(Theme.getColor(this.colorKey, this.resourcesProvider), NotificationCenter.cameraInitied));
                        this.flip[i8] = true;
                    }
                    ...
                    if (this.type != 6 && (i8 == 1 || i8 == 2)) {
                        ...
                        if (!this.useGradient) {
                            ...
                            if (this.forceMaxAlpha) {
                                mainGradientPaint.setAlpha(NotificationCenter.cameraInitied);
