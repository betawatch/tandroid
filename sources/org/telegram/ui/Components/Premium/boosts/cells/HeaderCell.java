...
public class HeaderCell extends FrameLayout {
    ...
    public HeaderCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        linearLayout.addView(gLIconTextureView, LayoutHelper.createLinear(NotificationCenter.screenshotTook, NotificationCenter.screenshotTook, 1));
        ...
        addView(starParticlesView, LayoutHelper.createFrame(-1, NotificationCenter.botDownloadsUpdate, 48));
