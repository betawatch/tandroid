    ...
    static class TopCell extends LinearLayout {
        ...
        public void showChats(List list, TLRPC.Chat chat) {
            ...
            while (true) {
                ...
                avatarHolderView3.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setInterpolator(cubicBezierInterpolator).setDuration(NotificationCenter.savedMessagesForwarded).start();
                if (size == 0) {
            ...
            if (this.addedChats.isEmpty() || this.addedChats.size() == 1) {
                this.avatarsContainer.animate().setInterpolator(cubicBezierInterpolator).translationX(0.0f).setDuration(NotificationCenter.savedMessagesForwarded).start();
            } else {
                this.avatarsContainer.animate().setInterpolator(cubicBezierInterpolator).translationX(AndroidUtilities.dp(11.5f) * (this.addedChats.size() - 1)).setDuration(NotificationCenter.savedMessagesForwarded).start();
            }
            ...
            if (this.addedChats.isEmpty()) {
                ...
                long j2 = NotificationCenter.savedMessagesForwarded;
            ...
            long j3 = NotificationCenter.savedMessagesForwarded;
