    ...
    static class TopCell extends LinearLayout {
        ...
        public void showChats(List list, TLRPC.Chat chat) {
            ...
            while (true) {
                ...
                avatarHolderView3.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setInterpolator(cubicBezierInterpolator).setDuration(NotificationCenter.smsJobStatusUpdate).start();
                if (size == 0) {
            ...
            for (TLRPC.Chat chat5 : arrayList) {
                ...
                if (avatarHolderView != null) {
                    ...
                    long j2 = NotificationCenter.smsJobStatusUpdate;
            ...
            if (this.addedChats.isEmpty()) {
                ...
                j = NotificationCenter.smsJobStatusUpdate;
