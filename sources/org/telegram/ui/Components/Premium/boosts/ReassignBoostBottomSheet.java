...
public class ReassignBoostBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public ReassignBoostBottomSheet(BaseFragment baseFragment, TL_stories.TL_premium_myBoosts tL_premium_myBoosts, final TLRPC.Chat chat) {
        ...
        gradientButtonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                ReassignBoostBottomSheet.$r8$lambda$LaVYreQxl216RF4nDb6eGL7VfsE(ReassignBoostBottomSheet.this, chat, view);
            }
        });
        ...
        this.recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$$ExternalSyntheticLambda1
            ...
            public final void onItemClick(View view, int i4) {
                ReassignBoostBottomSheet.$r8$lambda$7cpvv40vUA6PdKgxhwXexC8OBUQ(ReassignBoostBottomSheet.this, chat, view, i4);
            }
        });
        fixNavigationBar();
        updateTitle();
    ...
    public static /* synthetic */ void $r8$lambda$LaVYreQxl216RF4nDb6eGL7VfsE(final ReassignBoostBottomSheet reassignBoostBottomSheet, final TLRPC.Chat chat, View view) {
        ...
        BoostRepository.applyBoost(chat.id, arrayList, new Utilities.Callback() { // from class: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$$ExternalSyntheticLambda2
            ...
            public final void run(Object obj) {
                MessagesController.getInstance(r0.currentAccount).getBoostsController().getBoostsStats(-chat.id, new Consumer() { // from class: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$$ExternalSyntheticLambda4
                    @Override // com.google.android.exoplayer2.util.Consumer
                    public final void accept(Object obj2) {
                        ReassignBoostBottomSheet.$r8$lambda$PKawwpZhA1iVaKkYrGH58Adn50U(ReassignBoostBottomSheet.this, r2, r3, r4, (TL_stories.TL_premium_boostsStatus) obj2);
                    }
                });
            }
            ...
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                ReassignBoostBottomSheet.$r8$lambda$Xi7OdF22Ep2bfMug90Fs6De0CP4(ReassignBoostBottomSheet.this, (TLRPC.TL_error) obj);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$PKawwpZhA1iVaKkYrGH58Adn50U(ReassignBoostBottomSheet reassignBoostBottomSheet, TL_stories.TL_premium_myBoosts tL_premium_myBoosts, List list, HashSet hashSet, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus) {
    ...
    public static /* synthetic */ void $r8$lambda$Xi7OdF22Ep2bfMug90Fs6De0CP4(ReassignBoostBottomSheet reassignBoostBottomSheet, TLRPC.TL_error tL_error) {
    ...
    public static /* synthetic */ void $r8$lambda$7cpvv40vUA6PdKgxhwXexC8OBUQ(ReassignBoostBottomSheet reassignBoostBottomSheet, TLRPC.Chat chat, View view, int i) {
    ...
    static class TopCell extends LinearLayout {
            ...
            try {
                ...
                SpannableStringBuilder replaceSingleTag = AndroidUtilities.replaceSingleTag(LocaleController.getString("BoostingReassignBoostTextLink", R.string.BoostingReassignBoostTextLink), Theme.key_chat_messageLinkIn, 2, new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$TopCell$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ReassignBoostBottomSheet.TopCell.$r8$lambda$gWjA69fY9828v8mIfgoMFjI1LEs(BottomSheet.this);
                    }
                });
                ...
                this.description.post(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$TopCell$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ReassignBoostBottomSheet.TopCell.$r8$lambda$obDywsXXdigYdh_1vzUK2-wRSoI(ReassignBoostBottomSheet.TopCell.this, indexOf);
                    }
                });
            } catch (Exception e) {
                FileLog.e(e);
        ...
        public static /* synthetic */ void $r8$lambda$obDywsXXdigYdh_1vzUK2-wRSoI(TopCell topCell, int i) {
            topCell.getClass();
            try {
        ...
        public void showChats(List list, TLRPC.Chat chat) {
            ...
            while (true) {
                ...
                avatarHolderView3.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setInterpolator(cubicBezierInterpolator).setDuration(NotificationCenter.dialogPhotosUpdate).start();
                if (size2 == 0) {
            ...
            while (i4 < size3) {
                ...
                if (avatarHolderView != null) {
                    ...
                    ViewPropertyAnimator interpolator = avatarHolderView.animate().alpha(f).translationXBy(AndroidUtilities.dp(23.0f)).scaleX(0.1f).scaleY(0.1f).setInterpolator(cubicBezierInterpolator);
            ...
            if (this.addedChats.isEmpty() || this.addedChats.size() == 1) {
                this.avatarsContainer.animate().setInterpolator(cubicBezierInterpolator).translationX(0.0f).setDuration(NotificationCenter.dialogPhotosUpdate).start();
            } else {
                this.avatarsContainer.animate().setInterpolator(cubicBezierInterpolator).translationX(AndroidUtilities.dp(11.5f) * (this.addedChats.size() - 1)).setDuration(NotificationCenter.dialogPhotosUpdate).start();
            }
            ...
            if (this.addedChats.isEmpty()) {
                ...
                long j2 = NotificationCenter.dialogPhotosUpdate;
            ...
            long j3 = NotificationCenter.dialogPhotosUpdate;
