...
public final class cl0 extends View {
    ...
    public cl0(tl0 tl0Var, Context context, int i10) {
        super(context);
        org.telegram.ui.ActionBar.g6 g6Var = tl0Var.m2;
        this.l0 = tl0Var;
        this.a = true;
        this.b = new RectF();
        this.c = new Paint(1);
        ...
        if (layoutManager instanceof f2.j0) {
            ...
            if (j0Var.o == 1) {
                ...
                if (adapter instanceof dl0) {
                    ...
                    float f10 = this.e;
                    int[] iArr = this.T;
                    dl0Var.G(tl0Var, f10, iArr);
                    if (z4) {
                        j0Var.h1(iArr[0], (-iArr[1]) + tl0Var.t1);
                    }
    ...
    public final void c() {
        tl0 tl0Var = this.l0;
        int i10 = this.O;
        this.P = i10 == 0 ? org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.m7, tl0Var.m2) : i0.a.k(-16777216, 102);
        this.Q = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.l7, tl0Var.m2);
        this.c.setColor(this.P);
        TextPaint textPaint = this.E;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.n7, tl0Var.m2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.G6, tl0Var.m2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i11 == 0) {
            ...
            tl0 tl0Var = this.l0;
            f12 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.k6.v0(i12, tl0Var.m2), -1));
            ...
            paint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.G6, tl0Var.m2));
            canvas.save();
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        f2.p0 adapter2 = tl0Var.getAdapter();
        if (this.n && !this.h0 && System.currentTimeMillis() - this.i0 < 150 && (adapter2 instanceof dl0)) {
            ((dl0) adapter2).I();
        }
        this.h0 = false;
        this.n = false;
