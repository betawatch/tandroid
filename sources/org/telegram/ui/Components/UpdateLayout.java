...
public class UpdateLayout extends IUpdateLayout {
    ...
    public void createUpdateUI(final int i) {
        ...
        FrameLayout frameLayout = new FrameLayout(this.activity) { // from class: org.telegram.ui.Components.UpdateLayout.1
        ...
        this.updateTextViews[0].setText(LocaleController.getString(R.string.AppUpdateBeta));
