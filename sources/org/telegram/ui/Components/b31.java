...
public abstract class b31 extends org.telegram.ui.ActionBar.e3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public b31(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        p80Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.g6.uf));
        ...
        j9Var.T(o21Var);
        j9Var.E0 = k0Var;
        org.telegram.ui.Cells.v9 o10 = j9Var.o(context);
        this.G = o10;
        AndroidUtilities.removeFromParent(o10);
        this.containerView.addView(o10, h7.z5.e(-1, -1, 119));
    ...
    public static TLRPC.TL_textWithEntities F(TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2) {
        ...
        if (tL_textWithEntities != null && tL_textWithEntities.text != null && !tL_textWithEntities.entities.isEmpty()) {
            HashMap D = D(tL_textWithEntities.text);
            HashMap D2 = D(tL_textWithEntities2.text);
            for (int i12 = 0; i12 < tL_textWithEntities.entities.size(); i12++) {
                ...
                if (messageEntity2 instanceof TLRPC.TL_messageEntityCustomEmoji) {
                    ...
                    if (!TextUtils.isEmpty(substring2)) {
                        ArrayList arrayList2 = (ArrayList) D.get(substring2);
                        ArrayList arrayList3 = (ArrayList) D2.get(substring2);
    ...
    public static void m(b31 b31Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_textWithEntities2 != null) {
            ...
            b31Var.B.setText(b31Var.G(valueOf));
            a31Var.D(n21Var);
            return;
        }
        if (b31Var.K) {
    ...
    public static void p(b31 b31Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = b31Var.r;
        b31Var.b = null;
    ...
    public static boolean v(b31 b31Var) {
        ...
        for (int i10 = 0; i10 < o21Var.getChildCount(); i10++) {
            if (RecyclerView.R(o21Var.getChildAt(i10)) == 1) {
                f10 += r3.getHeight();
            }
        }
        return f10 >= ((float) ((o21Var.getHeight() - o21Var.getPaddingTop()) - o21Var.getPaddingBottom()));
    }
    ...
    public static void y(String str, String str2, String str3, Utilities.Callback2 callback2) {
        ...
        if (encode.length() <= 5000) {
            new r21(str2, str3, encode, callback2).start();
            return;
        }
        ...
        while (i13 < arrayList.size()) {
            ...
            new r21(str2, str3, (String) arrayList.get(i13), new hh.j0(zArr, arrayList2, i13, callback22, 6)).start();
            i13++;
    ...
    public final void M() {
        ...
        if (this.f && inputPeer != null) {
            ...
            this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new org.telegram.messenger.a(), new cg.u0(19, this, tL_textWithEntities)));
            return;
        }
        ...
        this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.gg(21, this, tL_textWithEntities)));
    }
    ...
    public final void N() {
        ...
        y(charSequence2, str, "nb".equals(str2) ? "no" : str2, new d(this, 21));
    }
