...
public final class b31 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        if (k31Var.U == animator) {
            ...
            k31Var.U = null;
            MessagesController.getInstance(k31Var.b).getMainSettings().edit().putBoolean(a4.a.p(j3, "topicssidetabs"), k31Var.Q).putBoolean(a4.a.p(j3, "topicssidetabsb"), k31Var.P).apply();
