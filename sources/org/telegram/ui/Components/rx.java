...
public class rx extends jm0 {
    ...
    @Override // org.telegram.ui.Components.jm0, android.widget.HorizontalScrollView, android.view.ViewGroup
    ...
    @Override // org.telegram.ui.Components.jm0, android.widget.HorizontalScrollView, android.view.View
            ...
            if (motionEvent.getAction() == 1) {
                ...
                if (aVar.d()) {
                    ...
                    if ((!aVar.a || yVelocity < AndroidUtilities.dp(200.0f)) && ((aVar.a || yVelocity > AndroidUtilities.dp(-200.0f)) && ((!(z10 = aVar.a) || chatActivityEnterView.B3 > 0.6f) && (z10 || chatActivityEnterView.B3 < 0.4f)))) {
                        chatActivityEnterView.o1(z10, true, true, true);
                    } else {
                        chatActivityEnterView.o1(!aVar.a, true, true, true);
                    }
                }
            } else {
                ...
                if (chatActivityEnterView2.w3) {
                    ...
                    chatActivityEnterView2.o1(aVar2.a, true, false, true);
                }
            }
            this.x0 = true;
            this.B0 = false;
