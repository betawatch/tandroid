...
public class tc0 extends LinearLayout {
    public static final rr v0 = new rr(0.0f, 0.5f, 0.5f, 1.0f);
    public int E;
    public boolean F;
    public int G;
    public int H;
    ...
    public tc0(LaunchActivity launchActivity) {
    ...
    public static int g(int i10, int i11) {
        if (i11 != -1) {
            ...
            if (mode != 1073741824) {
                throw new IllegalArgumentException(hg.c.i(mode, "Unknown measure mode: "));
            }
        }
        return i10;
    }
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.E) {
            ...
            if (strArr != null) {
                ...
                pc0 pc0Var = this.K;
                str = pc0Var != null ? pc0Var.e(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
    ...
    public final boolean h(om0 om0Var) {
        om0Var.q = true;
        int i10 = om0Var.e - om0Var.k;
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.G;
                    pc0 pc0Var = this.K;
                    str = pc0Var != null ? pc0Var.e(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z10) {
        ...
        if (z10 && (rc0Var = this.I) != null) {
            rc0Var.q(this, this.G);
        }
        f();
        invalidate();
        if (this.k0 != 0 || (qc0Var = this.J) == null) {
            return;
        }
        qc0Var.n(0);
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (f7 < this.l0) {
            if (this.k0 == 0) {
                ...
                sc0Var.c = 1;
                sc0Var.b = 2;
                ((tc0) sc0Var.d).postDelayed(sc0Var, ViewConfiguration.getTapTimeout());
            }
            ...
            sc0Var2.c = 1;
            sc0Var2.b = 1;
            ((tc0) sc0Var2.d).postDelayed(sc0Var2, ViewConfiguration.getTapTimeout());
        }
        ...
        if (f10 < this.l0) {
            ...
            oc0 oc0Var = this.V;
            oc0Var.a = false;
            postDelayed(oc0Var, longPressTimeout);
            return true;
        }
        if (f10 > this.m0) {
            ...
            oc0 oc0Var2 = this.V;
            oc0Var2.a = true;
            postDelayed(oc0Var2, longPressTimeout2);
        }
        return true;
    }
    ...
    public void setFormatter(pc0 pc0Var) {
        if (pc0Var == this.K) {
            return;
        }
        this.K = pc0Var;
    ...
    public void setOnScrollListener(qc0 qc0Var) {
        this.J = qc0Var;
    }

    public void setOnValueChangedListener(rc0 rc0Var) {
        this.I = rc0Var;
    }
    ...
    */
    ...
    public tc0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        this(context, 18, d6Var);
    }

    public tc0(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.a = 3;
        this.b = 1;
        this.L = 300L;
        ...
        this.O = paint2;
        this.S = new om0(getContext(), null);
        this.T = new om0(getContext(), new DecelerateInterpolator(2.5f));
        n();
        setImportantForAccessibility(1);
        setAccessibilityDelegate(new nc0(this));
    }
}
