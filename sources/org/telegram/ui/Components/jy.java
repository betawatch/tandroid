...
public final class jy extends ll0 {
    ...
    public jy(kz kzVar, Context context) {
        this.F = kzVar;
        ey eyVar = new ey(context, kzVar.c1, new d(this, 11), new lv(this, 1), kzVar.Z1);
        this.c = eyVar;
        eyVar.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(5.0f));
        eyVar.setClipToPadding(false);
        eyVar.Y2.r = false;
        eyVar.setNestedScrollingEnabled(false);
        eyVar.setDrawSelection(false);
        eyVar.setOnTouchListener(new m.c2(this, 1));
    }
    ...
    public static void E(jy jyVar, Runnable runnable, ArrayList arrayList, boolean z10) {
        ...
        MediaDataController.getInstance(kzVar.c1).searchStickers(true, str, str2, new ai.e4((Object) jyVar, str2, arrayList, (Object) runnable, 8), z10);
    }
    ...
    public final void F(String str, boolean z10) {
        ...
        this.x = iyVar2;
        AndroidUtilities.runOnUIThread(iyVar2, z10 ? 300L : 0L);
    }
    ...
    */
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            ai.f0 f0Var = new ai.f0(this, kzVar.getContext(), 13);
            ...
            f0Var.addView(textView, w7.x5.d(-2, -2.0f, 49, 0.0f, 10.0f, 0.0f, 0.0f));
