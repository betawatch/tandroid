...
public final class i41 extends FrameLayout {
    ...
    public i41(k41 k41Var, Context context) {
        ...
        int themedColor = k41Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5);
        String str = k41Var.s;
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(k41Var.getThemedColor(org.telegram.ui.ActionBar.j6.i6), 1, -1));
                    ...
                    default:
                        ...
                        while (i12 < locales.size()) {
                            ...
                            if (!localeInfo.pluralLangCode.equals(k41Var2.s) && "remote".equals(localeInfo.pathToFile)) {
                                ...
                                h41Var.addView(f1Var);
                                z10 = false;
                            }
                            i12++;
                        }
                        org.telegram.ui.ActionBar.n1 n1Var = new org.telegram.ui.ActionBar.n1(h41Var, -2, -2);
        ...
        this.b = rkVar;
        rkVar.setTextColor(k41Var.getThemedColor(i10));
        ...
        if (LocaleController.isRTL) {
            bc1Var.addView(g41Var, w7.y5.t(-2, -2, 16, 0, 0, this.d != null ? 3 : 0, 0));
            if (this.d != null) {
            ...
            bc1Var.addView(g41Var, w7.y5.t(-2, -2, 16, this.d != null ? 3 : 0, 0, 0, 0));
        }
