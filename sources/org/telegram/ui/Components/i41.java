...
public final class i41 extends yk0 {
    ...
    public final void E(View view, int i10, boolean z10) {
        ...
        boolean z13;
        j41 j41Var = this.x;
        LongSparseArray longSparseArray = j41Var.e;
        LongSparseArray longSparseArray2 = j41Var.d;
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = j41Var.c;
        int i11 = j41Var.a;
    ...
    */
    public final void F(TLRPC.StickerSetCovered stickerSetCovered, FrameLayout frameLayout) {
        ...
        while (true) {
            ...
            if (stickerSetCoveredArr[i10] != null) {
                TLRPC.TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(j41Var.a).getStickerSetById(stickerSetCoveredArr[i10].set.id);
                if (stickerSetById != null && !stickerSetById.set.archived) {
    ...
    public final void G() {
        ...
        arrayList.clear();
        this.w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(j41Var.a);
    ...
    public final void v(f2.o1 o1Var, int i10) {
        ...
        View view = o1Var.a;
        if (i11 == 0) {
            ((org.telegram.ui.Cells.a8) view).d((TLRPC.Document) this.d.get(i10), null, this.f.get(i10), null, false, false);
        } else {
            if (i11 == 1) {
    ...
    public final f2.o1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            org.telegram.ui.Cells.p3 p3Var = new org.telegram.ui.Cells.p3(17, this.c, j41Var.L, true, true);
            final int i11 = 0;
            p3Var.setAddOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.h41
                ...
                public final void onClick(View view) {
                    switch (i11) {
                        case 0:
                            ...
                            LongSparseArray longSparseArray2 = j41Var2.e;
                        ...
                        default:
                            ...
                            i41 i41Var2 = this.b;
                            j41 j41Var3 = i41Var2.x;
                            LongSparseArray longSparseArray3 = j41Var3.d;
                            LongSparseArray longSparseArray4 = j41Var3.e;
            ...
            final int i12 = 1;
            m3Var.setAddOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.h41
                public final /* synthetic */ i41 b;
