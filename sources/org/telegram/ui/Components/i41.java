...
public abstract class i41 extends org.telegram.ui.ActionBar.h3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public i41(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        tVar.setText(Emoji.replaceEmoji(charSequence == null ? "" : charSequence.toString(), tVar.getPaint().getFontMetricsInt(), true));
        ...
        m90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.uf));
    ...
    public static void p(i41 i41Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            org.telegram.messenger.a2.p(bool.booleanValue() ? R.string.TranslationFailedAlert1 : R.string.TranslationFailedAlert2, new wc((FrameLayout) i41Var.containerView, i41Var.resourcesProvider), null);
            e41 e41Var = i41Var.x.e;
    ...
    public final void M() {
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new z1(this, 16)));
            return;
        }
        ...
        if (this.f && inputPeer != null) {
            ...
            this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new org.telegram.messenger.a(), new bi.k6(11, this, tL_textWithEntities)));
            return;
        }
        ...
        this.b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new th(12, this, tL_textWithEntities)));
    }
    ...
    public final void N() {
        ...
        x(charSequence2, str, "nb".equals(str2) ? "no" : str2, new e(this, 21));
    }
