...
public final class e70 extends vl0 {
    ...
    public final TLObject E(int i10) {
        ...
        if (DialogObject.isUserDialog(dialog.id)) {
            i12 = ((org.telegram.ui.ActionBar.f3) k70Var).currentAccount;
            return MessagesController.getInstance(i12).getUser(Long.valueOf(dialog.id));
        }
        i11 = ((org.telegram.ui.ActionBar.f3) k70Var).currentAccount;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 2) {
            ...
            if (i10 == 3) {
                ...
                org.telegram.ui.fu fuVar = k70Var.m0;
                vh.o oVar = d70Var.d;
                if (fuVar != null) {
