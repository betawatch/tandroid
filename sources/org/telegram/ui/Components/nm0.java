...
public final class nm0 extends Dialog {
    ...
    public final void e(w70 w70Var) {
        ...
        w70Var.Q(this.n, eh.b.k(e6Var), false);
        this.w = w70Var;
        this.y = w70Var.A;
    ...
    /* JADX WARN: Type inference failed for: r5v6, types: [android.graphics.Path, org.telegram.ui.Components.f90, org.telegram.ui.Components.uq] */
    /* JADX WARN: Type inference failed for: r7v16, types: [android.graphics.Path, org.telegram.ui.Components.f90] */
    /*
                        ...
                        for (CharacterStyle characterStyle2 : characterStyleArr) {
                            if (characterStyle2 == characterStyle) {
                                ...
                                if (charSequence != null) {
                                    ...
                                    ?? f90Var = new f90(0);
                                    f90Var.d(r14, i22, 0.0f);
                                    r14.getSelectionPath(i22, i23, f90Var);
                                    RectF rectF2 = new RectF();
                                    f90Var.computeBounds(rectF2, true);
                                ...
                                ?? f90Var2 = new f90(0);
                                f90Var2.c = true;
                                f90Var2.d(r12, i22, 0.0f);
                                r12.getSelectionPath(i22, i23, f90Var2);
                                f90Var2.a();
                                RectF rectF3 = new RectF();
                                f90Var2.computeBounds(rectF3, true);
                                ...
                                if (!u1Var.C1() || width2 <= 0) {
                                    ...
                                    if (rectF3.height() > 0.0f) {
                                        ...
                                        canvas.drawPath(f90Var2, paint4);
                                        bitmap = createBitmap;
                                        ...
                                        this.E = new mm0(f90Var2, new int[]{iArr[0] + ((int) f21), iArr[1] + ((int) f14)}, u1Var, iArr, bitmap, rectF3, paint5, paint, makeStaticLayout2);
                                ...
                                this.E = new mm0(f90Var2, new int[]{iArr2[0] + ((int) f21), iArr2[1] + ((int) f14)}, u1Var, iArr2, bitmap, rectF3, paint52, paint, makeStaticLayout22);
