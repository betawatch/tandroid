...
public final class nm0 extends Transition {
    public final /* synthetic */ int a;
    public final /* synthetic */ Object b;

    public /* synthetic */ nm0(Object obj, int i10) {
        this.a = i10;
        this.b = obj;
    }
    ...
    public final void captureEndValues(TransitionValues transitionValues) {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                viewGroup = ((org.telegram.ui.ActionBar.h3) yx0Var).containerView;
                map.put("offset", Integer.valueOf(viewGroup.getTop() + yx0Var.b0));
                break;
            case 2:
    ...
    public final void captureStartValues(TransitionValues transitionValues) {
        ...
        switch (this.a) {
            ...
            case 2:
                View view = transitionValues.view;
                org.telegram.ui.it0 it0Var = ((PhotoViewer) this.b).Q1;
                if (view == it0Var) {
                    transitionValues.values.put("scrollY", Integer.valueOf(it0Var.getScrollY()));
                    break;
                }
                break;
            default:
                View view2 = transitionValues.view;
                org.telegram.ui.it0 it0Var2 = ((SecretMediaViewer) this.b).X;
                if (view2 == it0Var2) {
                    transitionValues.values.put("scrollY", Integer.valueOf(it0Var2.getScrollY()));
                    break;
                }
                break;
        }
    ...
    public final Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                ofFloat2.addUpdateListener(new eg.e0(this, intValue3, i13, 4));
                return ofFloat2;
            case 2:
                PhotoViewer photoViewer = (PhotoViewer) obj;
                if (transitionValues.view == photoViewer.Q1) {
                    ValueAnimator ofInt = ValueAnimator.ofInt(((Integer) transitionValues.values.get("scrollY")).intValue(), 0);
                    ofInt.addListener(new org.telegram.ui.kt0(this, i12));
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(photoViewer.N1, (Property<org.telegram.ui.yt0, Float>) View.TRANSLATION_Y, 0.0f, intValue);
                ofFloat3.addListener(new org.telegram.ui.kt0(this, i11));
                return ofFloat3;
            default:
                ...
                if (transitionValues.view == secretMediaViewer.X) {
                    ...
                    ofInt2.addListener(new org.telegram.ui.h41(this, i12));
                    ofInt2.addUpdateListener(new org.telegram.ui.j11(this, 6));
                    return ofInt2;
                }
                if (transitionValues2.view != secretMediaViewer.W || (intValue2 = ((Integer) transitionValues2.values.get("translationY")).intValue()) == 0) {
                    return null;
                }
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(secretMediaViewer.W, (Property<org.telegram.ui.yt0, Float>) View.TRANSLATION_Y, 0.0f, intValue2);
                ofFloat4.addListener(new org.telegram.ui.h41(this, i11));
                return ofFloat4;
        }
    }
