...
public final class zh extends ml0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        switch (this.X2) {
            case 0:
                ...
                ((le.c) this.c3).a(this.a3, true);
                ((le.c) this.d3).a(this.b3, true);
                break;
            default:
                super.dispatchDraw(canvas);
        ...
        switch (this.X2) {
            case 0:
                ...
                if (z11) {
                    ...
                    canvas.save();
                    canvas.translate(com.google.android.gms.internal.vision.e2.b(1.0f, ((le.c) this.c3).e, AndroidUtilities.dp(8.0f), dp), 0.0f);
                ...
                if (z12) {
                    ...
                    super.drawChild(canvas, view, j3);
                    canvas.save();
                    canvas.translate(com.google.android.gms.internal.vision.e2.z(1.0f, ((le.c) this.d3).e, AndroidUtilities.dp(8.0f), measuredWidth), 0.0f);
            ...
            case 0:
                ...
                for (int i13 = 0; i13 < childCount; i13++) {
                    ...
                    if (childAt2 instanceof ri) {
                        ((ri) childAt2).a.setAdditionalWidth(floor);
                    }
                }
