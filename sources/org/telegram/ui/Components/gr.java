...
public final class gr implements Interpolator {
    public static final gr f = new gr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final gr g = new gr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final gr h = new gr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final gr i = new gr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final gr j = new gr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final gr k = new gr(0.34d, 1.56d, 0.64d, 1.0d);
