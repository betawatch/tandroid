...
public class w51 extends View {
    ...
    public final void a(String str, boolean z10) {
        ...
        this.B = ofFloat;
        ofFloat.addUpdateListener(new v51(i10, this));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.s != null) {
            ...
            if (this.C == 1.0f || this.w == null) {
                ...
                float f12 = alpha;
                textPaint.setAlpha((int) ((f11 - this.C) * f12));
                this.w.draw(canvas);
                canvas.restore();
                canvas.save();
                canvas.translate(((getMeasuredWidth() - this.x) / 2) - (this.h / 2), getTopOffset() + ((getMeasuredHeight() - this.s.getHeight()) / 2));
                canvas.translate(this.r != null ? AndroidUtilities.dp(f10) + (r9.getIntrinsicWidth() / 2) : 0, (f11 - this.C) * (this.D ? 1.0f : -1.0f) * AndroidUtilities.dp(18.0f));
                Drawable drawable3 = this.r;
                if (drawable3 != null) {
                    drawable3.setBounds((-drawable3.getIntrinsicWidth()) - AndroidUtilities.dp(f9), AndroidUtilities.dp(f11) + ((this.s.getHeight() - this.r.getIntrinsicHeight()) / 2), -AndroidUtilities.dp(f9), AndroidUtilities.dp(f11) + ((this.r.getIntrinsicHeight() + this.s.getHeight()) / 2));
                    this.r.setAlpha((int) (this.C * f12));
                    this.r.draw(canvas);
                }
                textPaint.setAlpha((int) (f12 * this.C));
                this.s.draw(canvas);
                canvas.restore();
        ...
        int dp3 = AndroidUtilities.dp(f9) + ((((getMeasuredWidth() - ceil) / 2) + ceil) - (this.h / 2));
        float f13 = dp3;
