...
public final class n91 extends FrameLayout {
    ...
    public n91(r91 r91Var, Context context) {
        super(context);
        this.H = r91Var;
        this.x = true;
        this.G = new j71(this, 5);
    ...
    public final void a() {
        j71 j71Var = this.G;
        AndroidUtilities.cancelRunOnUIThread(j71Var);
        if (this.x && this.H.a.y()) {
            AndroidUtilities.runOnUIThread(j71Var, 3000L);
        }
    }
    ...
    public final void d(boolean z10, boolean z11) {
        ...
        if (z12) {
            if (z11) {
                ...
                this.y = animatorSet2;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, (Property<n91, Float>) property, 1.0f));
                this.y.setDuration(150L);
                this.y.addListener(new m91(this, 0));
                this.y.start();
            } else {
                setAlpha(1.0f);
            }
            ...
            this.y = animatorSet3;
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this, (Property<n91, Float>) property, 0.0f));
            this.y.setDuration(150L);
            this.y.addListener(new m91(this, 1));
            this.y.start();
        } else {
            setAlpha(0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        r91 r91Var = this.H;
        if (r91Var.P) {
            if (r91Var.M && r91Var.N != 0.0f) {
                long currentTimeMillis = System.currentTimeMillis();
                long j3 = currentTimeMillis - r91Var.L;
                r91Var.L = currentTimeMillis;
                float f7 = r91Var.N - (j3 / 150.0f);
                r91Var.N = f7;
                if (f7 < 0.0f) {
                    r91Var.N = 0.0f;
                }
        ...
        if (!r91Var.U) {
            if (this.d != null) {
                canvas.save();
                canvas.translate((measuredWidth - AndroidUtilities.dp(58.0f)) - this.r, measuredHeight - AndroidUtilities.dp((r91Var.T ? 6 : 10) + 29));
                this.d.draw(canvas);
                canvas.restore();
            }
            if (this.e != null) {
                canvas.save();
                canvas.translate(AndroidUtilities.dp(18.0f), measuredHeight - AndroidUtilities.dp((r91Var.T ? 6 : 10) + 29));
                this.e.draw(canvas);
                canvas.restore();
            }
        }
