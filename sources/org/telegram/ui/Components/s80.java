...
public abstract class s80 extends LinearLayout {
    ...
    public s80(Context context, TLRPC.Chat chat) {
        ...
        final int i10 = 0;
        x8Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.p80
            ...
            public final void onClick(View view) {
                switch (i10) {
                    case 0:
                        s80 s80Var = this.b;
                        boolean z12 = s80Var.f;
                        boolean z13 = !z12;
                        if (s80Var.b(z13, new r80(s80Var, s80Var.h, z12, 0))) {
                            s80Var.setJoinRequest(false);
                            s80Var.setJoinToSend(z13);
                            break;
                        }
                        break;
                    default:
                        s80 s80Var2 = this.b;
                        boolean z14 = s80Var2.h;
                        boolean z15 = !z14;
                        if (s80Var2.a(z15, new q80(s80Var2, z14, 0))) {
                            s80Var2.setJoinRequest(z15);
                            break;
                        }
                        break;
                }
        ...
        final int i11 = 1;
        x8Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.p80
            public final /* synthetic */ s80 b;
    ...
    public void setJoinToSend(boolean z10) {
        ...
        this.r.addUpdateListener(new p70(this, 1));
