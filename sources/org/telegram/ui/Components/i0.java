...
public final class i0 extends ab {
    ...
    public final org.telegram.ui.p20 c0;
    public boolean d0;
    public boolean e0;
    public boolean f0;
    ...
    */
    public static void P(i0 i0Var, View view, int i10, float f7) {
        boolean z10;
        ArrayList arrayList;
        v51 G = i0Var.X.G(i10 - 1);
        if (G == null) {
            return;
        }
        int i11 = G.a;
            ...
            if (i11 == 41) {
                ...
                switch (G.d) {
                    case 2:
                        ...
                        break;
                    case 3:
                        TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter3 = i0Var.Y;
                        boolean b12 = z1Var.b();
                        tL_channelAdminLogEventsFilter3.demote = b12;
                        tL_channelAdminLogEventsFilter3.promote = b12;
                        break;
                    case 4:
                        TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter4 = i0Var.Y;
                        boolean b13 = z1Var.b();
                        ...
                        break;
                    case 5:
                        TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter5 = i0Var.Y;
                        boolean b14 = z1Var.b();
                        tL_channelAdminLogEventsFilter5.join = b14;
                        tL_channelAdminLogEventsFilter5.invite = b14;
                        break;
                    case 6:
                        i0Var.Y.leave = z1Var.b();
                        break;
                    case 7:
                        i0Var.Y.edit_rank = z1Var.b();
                        break;
                    case 8:
                        if (!z10) {
                            TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter6 = i0Var.Y;
                            boolean b15 = z1Var.b();
                    ...
                    case 9:
                        TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter7 = i0Var.Y;
                        boolean b16 = z1Var.b();
                        tL_channelAdminLogEventsFilter7.settings = b16;
                        tL_channelAdminLogEventsFilter7.info = b16;
                        break;
                    case 10:
                        i0Var.Y.invites = z1Var.b();
                        break;
                    case 11:
                        i0Var.Y.group_call = z1Var.b();
                        break;
                    case 12:
                        if (!z10) {
                            TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter8 = i0Var.Y;
                            boolean b17 = z1Var.b();
                    ...
                    case 13:
                        i0Var.Y.delete = z1Var.b();
                        break;
                    case 14:
                        i0Var.Y.edit = z1Var.b();
                        break;
                    case 15:
                        i0Var.Y.pinned = z1Var.b();
                        break;
                    case 16:
                        if (i0Var.a0 == null) {
                            i0Var.a0 = new a0.i();
                        ...
                        i0Var.a0.b();
                        if (z1Var.b() && (arrayList = i0Var.Z) != null) {
                            ...
                            while (i12 < size) {
                                ...
                                i0Var.a0.k(MessagesController.getInstance(i0Var.currentAccount).getUser(Long.valueOf(peerDialogId)), peerDialogId);
                            }
                            break;
                        }
                        break;
        ...
        if (i13 < 0) {
            ...
            int i14 = (-i13) - 1;
            if (i14 < 0 || i14 >= i0Var.Z.size()) {
                return;
            }
            long peerDialogId2 = DialogObject.getPeerDialogId(((TLRPC.ChannelParticipant) i0Var.Z.get(i14)).peer);
            TLRPC.User user = MessagesController.getInstance(i0Var.currentAccount).getUser(Long.valueOf(peerDialogId2));
            if (i0Var.a0 == null) {
                i0Var.a0 = new a0.i();
            }
            if (i0Var.a0.d(peerDialogId2)) {
                i0Var.a0.l(peerDialogId2);
                z1Var3.c(false, true);
            } else {
                i0Var.a0.k(user, peerDialogId2);
                z1Var3.c(true, true);
            }
            i0Var.X.N(true);
        }
