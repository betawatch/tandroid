...
public final class yn extends LinearLayout {
    ...
    public yn(Activity activity, View view, int i10, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        G = G == null ? org.telegram.ui.ActionBar.g6.S0("paintChatActionBackground") : G;
        ...
        if (i10 == 0) {
            ...
            textView.setTextColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.ic, c6Var));
            ...
            textView2.setTextColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.ic, c6Var));
            ...
            aj0Var.f(R.raw.utyan_saved_messages, 120, 120, null);
            aj0Var.d();
            addView(aj0Var, i7.f6.t(-2, -2, 49, 0, 2, 0, 0));
        }
        ...
        textView3.setTextColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.ic, c6Var));
        arrayList.add(textView3);
        textView3.setMaxWidth(AndroidUtilities.dp(260.0f));
        addView(textView3, i7.f6.t(-2, -2, (i10 != 2 ? LocaleController.isRTL ? 5 : 3 : 1) | 48, 0, 8, 0, i10 != 2 ? 0 : 8));
        for (int i12 = 0; i12 < 4; i12++) {
            LinearLayout f9 = org.telegram.messenger.x3.f(activity, 0);
            addView(f9, i7.f6.t(-2, -2, LocaleController.isRTL ? 5 : 3, 0, 8, 0, 0));
            ImageView imageView = new ImageView(activity);
            int i13 = org.telegram.ui.ActionBar.g6.ic;
            imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.v0(i13, this.a), PorterDuff.Mode.MULTIPLY));
            if (i10 == 0) {
            ...
            textView4.setTextColor(org.telegram.ui.ActionBar.g6.v0(i13, this.a));
            ...
            if (LocaleController.isRTL) {
                ...
                if (i10 == 0) {
                    f9.addView(imageView, i7.f6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    f9.addView(imageView, i7.f6.k(8.0f, 7.0f, 0.0f, 0.0f, -2, -2));
                } else {
                    f9.addView(imageView, i7.f6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                }
            } else {
                if (i10 == 0) {
                    f9.addView(imageView, i7.f6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    f9.addView(imageView, i7.f6.k(0.0f, 8.0f, 8.0f, 0.0f, -2, -2));
                } else {
                    f9.addView(imageView, i7.f6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                }
                f9.addView(textView4, i7.f6.n(-2, -2));
    ...
    public void setTextColor(int i10) {
        ...
        while (true) {
            ...
            ((ImageView) arrayList2.get(i11)).setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.ic, this.a), PorterDuff.Mode.MULTIPLY));
            i11++;
        }
    }
}
