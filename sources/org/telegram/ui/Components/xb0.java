...
public final class xb0 implements org.telegram.ui.Cells.l1 {
    ...
    public final void V0(org.telegram.ui.Cells.u1 u1Var, CharacterStyle characterStyle, boolean z10) {
        yb0 yb0Var = this.a;
        zb0 zb0Var = yb0Var.c;
        if (zb0Var.a != 2 || zb0Var.c0.d.currentLink == characterStyle || u1Var.getMessageObject() == null || !(characterStyle instanceof URLSpan)) {
            return;
        }
        String url = ((URLSpan) characterStyle).getURL();
        fc0 fc0Var = yb0Var.c.c0;
        ...
        org.telegram.ui.wn wnVar = fc0Var.c;
        if (wnVar != null && url != null) {
            wnVar.Ya(url, true);
        }
        zb0.b(yb0Var.c, u1Var);
    }
