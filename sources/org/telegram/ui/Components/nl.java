...
public final class nl implements dv0 {
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [org.telegram.ui.Components.ml] */
    public final boolean a() {
        ...
        if ((i10 == 2 || (p2Var instanceof org.telegram.ui.xn)) && !chatAttachAlertPhotoLayout.p0 && !liVar.S && chatAttachAlertPhotoLayout.M != null && !liVar.D) {
            if (p2Var == null) {
            ...
            if (p2Var != null && p2Var.getParentActivity() != null) {
                ...
                for (int i11 = 0; i11 < 2; i11++) {
                    chatAttachAlertPhotoLayout.P[i11].animate().alpha(0.0f).translationX(AndroidUtilities.dp(30.0f)).setDuration(150L).setInterpolator(nr.f).start();
                }
                ...
                chatAttachAlertPhotoLayout.n0.animate().alpha(0.0f).setDuration(150L).setInterpolator(nrVar).start();
                org.telegram.ui.ActionBar.p2 p2Var2 = liVar.c0;
                this.a = AndroidUtilities.generateVideoPath((p2Var2 instanceof org.telegram.ui.xn) && ((org.telegram.ui.xn) p2Var2).v());
                ...
                final int i12 = 0;
                chatAttachAlertPhotoLayout.e0 = new Runnable(this) { // from class: org.telegram.ui.Components.ml
                ...
                final int i13 = 1;
                CameraController.getInstance().recordVideo(chatAttachAlertPhotoLayout.M.getCameraSessionObject(), this.a, liVar.N0 != 0, new t(this, 21), new Runnable(this) { // from class: org.telegram.ui.Components.ml
                    public final /* synthetic */ nl b;
    ...
    public final void b() {
        ...
        if (chatAttachAlertPhotoLayout.p0 || (amVar = chatAttachAlertPhotoLayout.M) == null || amVar.getCameraSession() == null) {
            return;
        }
        if (shutterButton.getState() == ev0.b) {
            ...
            org.telegram.ui.ActionBar.p2 p2Var = liVar.c0;
            File generatePicturePath = AndroidUtilities.generatePicturePath((p2Var instanceof org.telegram.ui.xn) && ((org.telegram.ui.xn) p2Var).v(), null);
            boolean isSameTakePictureOrientation = chatAttachAlertPhotoLayout.M.getCameraSession().isSameTakePictureOrientation();
            chatAttachAlertPhotoLayout.M.getCameraSession().setFlipFront((liVar.c0 instanceof org.telegram.ui.xn) || liVar.N0 == 2);
            chatAttachAlertPhotoLayout.p0 = CameraController.getInstance().takePicture(generatePicturePath, false, chatAttachAlertPhotoLayout.M.getCameraSessionObject(), new ll(this, generatePicturePath, isSameTakePictureOrientation));
