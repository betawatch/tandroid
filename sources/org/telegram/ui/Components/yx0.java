...
public final class yx0 {
    ...
    public final void b(MessageObject messageObject) {
        ...
        Paint N = c6Var != null ? c6Var.N("paintChatActionText3") : null;
        if (N == null) {
            N = org.telegram.ui.ActionBar.g6.S0("paintChatActionText3");
        }
        TextPaint textPaint = (TextPaint) N;
        this.g = AndroidUtilities.dp(14.0f) * 2;
        ArrayList arrayList = this.c;
        arrayList.clear();
        hf.a aVar = of2.amount;
        if (aVar != null && !aVar.k()) {
            arrayList.add(new xx0(new pz0(LocaleController.getString(R.string.SuggestionOfferInfoPrice), textPaint), new pz0(LocaleController.bold(of2.amount.f()), textPaint)));
        }
        ...
        while (i11 < size) {
            ...
            i11++;
            xx0 xx0Var = (xx0) obj;
            f11 = Math.max(f11, xx0Var.a.l());
            f12 = Math.max(f12, xx0Var.b.l());
            int j10 = ((int) xx0Var.a.j()) + this.g;
            this.g = j10;
        ...
        int D = org.telegram.messenger.y1.D(24.0f, 2, Math.max(dp, i19));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
