...
public class PhotoCropView extends FrameLayout {
    ...
    public PhotoCropView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.ANIMATION_VALUE = new AnimationProperties.FloatProperty("thumbAnimationProgress") { // from class: org.telegram.ui.Components.PhotoCropView.1
        ...
        this.PROGRESS_VALUE = new AnimationProperties.FloatProperty("thumbImageVisibleProgress") { // from class: org.telegram.ui.Components.PhotoCropView.2
            @Override // org.telegram.ui.Components.AnimationProperties.FloatProperty
            public void setValue(PhotoCropView photoCropView, float f) {
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.thumbImageVisible && view == (cropView = this.cropView)) {
            ...
            this.circlePaint.setAlpha(Math.min(NotificationCenter.invalidateMotionBackground, (int) (this.thumbAnimationProgress * 255.0f * this.thumbImageVisibleProgress)));
