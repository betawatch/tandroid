...
public final class rh0 implements sh0 {
    ...
    public rh0(th0 th0Var, float f7) {
        this.k = th0Var;
    ...
    public final void c(lv lvVar, Canvas canvas) {
        ...
        Paint paint;
        th0 th0Var = this.k;
        Paint paint2 = th0Var.a;
        Path path = th0Var.b;
        if (canvas.isHardwareAccelerated()) {
            float width = th0Var.getWidth();
            float height = th0Var.getHeight();
            RectF rectF = this.g;
            rectF.set(0.0f, 0.0f, width, height);
            int childCount = th0Var.getChildCount();
            RectF rectF2 = this.j;
            if (childCount > 0) {
                View childAt = th0Var.getChildAt(0);
                ...
                NotchInfoUtils.NotchInfo notchInfo = th0Var.n;
                if (notchInfo != null) {
            ...
            int ilerp = (int) ((1.0f - AndroidUtilities.ilerp(th0Var.e, 0.5f, 1.0f)) * 255.0f);
            int b10 = w7.p.b(ilerp, 0, 255);
            th0.a((th0) lvVar.b, beginRecording);
            this.b.endRecording();
            float f20 = this.f;
            float z10 = com.google.android.gms.internal.vision.e2.z(f20, 1.0f, 2.0f, com.google.android.gms.internal.vision.e2.x(th0Var.f, 0.5f, f20, (f20 / 4.0f) + 1.0f));
            ...
            float lerp = AndroidUtilities.lerp(0.0f, AndroidUtilities.dp(7.0f) * f22, 0.0f, 0.5f, th0Var.e);
            if (th0Var.getChildCount() > 0) {
                View childAt2 = th0Var.getChildAt(0);
            ...
            if (th0Var.n != null) {
                ...
                NotchInfoUtils.NotchInfo notchInfo2 = th0Var.n;
                if (notchInfo2.isLikelyCircle) {
                    float min = Math.min(notchInfo2.bounds.width(), th0Var.n.bounds.height()) / 2.0f;
                    RectF rectF3 = th0Var.n.bounds;
                    float width2 = rectF3.bottom - (rectF3.width() / 2.0f);
                    beginRecording4.drawCircle(th0Var.n.bounds.centerX(), width2, min, paint2);
                    path.rewind();
                    float f24 = f7 / 2.0f;
                    path.moveTo(th0Var.n.bounds.centerX() - f24, width2);
                    path.lineTo(th0Var.n.bounds.centerX(), min + width2 + f7);
                    path.lineTo(th0Var.n.bounds.centerX() + f24, width2);
                    path.close();
                    beginRecording4.drawPath(path, paint2);
                } else if (notchInfo2.isAccurate) {
                    beginRecording4.drawPath(notchInfo2.path, paint2);
                } else {
                    float max = Math.max(notchInfo2.bounds.width(), th0Var.n.bounds.height()) / 2.0f;
                    RectF rectF4 = th0Var.n.bounds;
                    RectF rectF5 = this.h;
                    rectF5.set(rectF4);
            ...
            NotchInfoUtils.NotchInfo notchInfo3 = th0Var.n;
            if (notchInfo3 != null) {
