...
public abstract class jm0 extends HorizontalScrollView {
    ...
    public jm0(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        super(context);
        this.a = 1;
        this.b = im0.a;
        this.h = new HashMap();
    ...
    public final cx0 c(int i10, Drawable drawable) {
        ...
        if (cx0Var != null) {
            ...
            cx0Var.setOnClickListener(new cm0(this, 4));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (ub1Var.getChildAt(i11) instanceof cx0) {
                cx0 cx0Var = (cx0) ub1Var.getChildAt(i11);
                ...
                if (left != f13 && cx0Var.E) {
                    ...
                    cx0Var.x.addListener(new qk0(3, cx0Var, this));
                    cx0Var.x.start();
                }
                cx0Var.E = false;
                if (this.g0) {
    ...
    public final boolean f(MotionEvent motionEvent) {
        ...
        if (action2 != 2 || this.s == null) {
            ...
            if (this.s != null) {
                ...
                ofFloat.addUpdateListener(new i70(this, 12));
        ...
        if (this.U != ceil && e(ceil)) {
            for (int i14 = 0; i14 < ub1Var.getChildCount(); i14++) {
                if (i14 != this.U) {
                    cx0 cx0Var = (cx0) ub1Var.getChildAt(i14);
        ...
        if (this.f0 != z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.dm0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    ub1 ub1Var = jm0Var.e;
                    if (!z10) {
                        float childCount = jm0Var.k0 * ub1Var.getChildCount();
                        float scrollX = jm0Var.getScrollX();
                        float f10 = f7;
                        float childCount2 = (scrollX + f10) / (jm0Var.j0 * ub1Var.getChildCount());
            ...
            if (childAt instanceof cx0) {
                ...
                if (cx0Var.a == 2) {
                    ...
                    if (tag3 instanceof TLRPC.Document) {
                        if (!cx0Var.c) {
                            cx0Var.v = DocumentObject.getSvgThumb((TLRPC.Document) tag3, org.telegram.ui.ActionBar.h6.c7, 0.2f);
                        }
                        ...
                        if (tag4 instanceof TLRPC.TL_messages_stickerSet) {
                            ...
                            if (cx0Var.c) {
                                ...
                                i10 = paddingLeft;
                                i11 = min;
                                cx0Var.v = DocumentObject.getSvgThumb(arrayList, org.telegram.ui.ActionBar.h6.c7, 0.2f, DocumentObject.containsPhotoSizeType(arrayList, "v"));
                            }
                        } else {
                            i10 = paddingLeft;
                            i11 = min;
                    ...
                    if (!cx0Var.c && cx0Var.v == null && document != null) {
                        cx0Var.v = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.h6.c7, 0.2f);
                    }
                    if (forSticker != null) {
                        cx0Var.c = true;
