...
public final class jm0 extends Dialog {
    ...
    public final void e(q70 q70Var) {
        ...
        q70Var.Q(this.n, sg.b.j(g6Var), false);
        this.w = q70Var;
        this.y = q70Var.A;
        FrameLayout frameLayout = new FrameLayout(this.a);
        this.x = frameLayout;
        frameLayout.addView(this.y, k7.c6.c(-2.0f, -2));
        this.v.addView(this.x, k7.c6.c(-2.0f, -2));
    }
    ...
    /* JADX WARN: Type inference failed for: r5v6, types: [android.graphics.Path, org.telegram.ui.Components.uq, org.telegram.ui.Components.z80] */
    /* JADX WARN: Type inference failed for: r7v16, types: [android.graphics.Path, org.telegram.ui.Components.z80] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void f(org.telegram.ui.Cells.t1 t1Var, CharacterStyle characterStyle, CharSequence charSequence, boolean z4) {
        float f10;
        float f11;
        ...
        int i19 = 0;
        boolean z11 = t1Var.getExplanationLayout() != null && messageObject.expandedExplanation;
        if (z11 && z4) {
                    ...
                    if (characterStyleArr != null) {
                        for (CharacterStyle characterStyle2 : characterStyleArr) {
                            if (characterStyle2 == characterStyle) {
                                ...
                                f13 = i18 + f18;
                                f14 = textLayoutBlock.textYOffset(arrayList, t1Var.Wc) + textLayoutBlock.padTop + f19;
                                ...
                                if (charSequence != null) {
                                    ...
                                    ?? z80Var = new z80(0);
                                    z80Var.d(r14, i22, 0.0f);
                                    r14.getSelectionPath(i22, i23, z80Var);
                                    RectF rectF2 = new RectF();
                                    z80Var.computeBounds(rectF2, true);
                                ...
                                paint2.setColor(org.telegram.ui.ActionBar.k6.v0(messageObject.isOutOwner() ? org.telegram.ui.ActionBar.k6.Aa : org.telegram.ui.ActionBar.k6.ra, this.b));
                                paint2.setPathEffect(new CornerPathEffect(AndroidUtilities.dp(5.0f)));
                                ?? z80Var2 = new z80(0);
                                z80Var2.c = true;
                                z80Var2.d(r12, i22, 0.0f);
                                r12.getSelectionPath(i22, i23, z80Var2);
                                z80Var2.a();
                                RectF rectF3 = new RectF();
                                z80Var2.computeBounds(rectF3, true);
                                ...
                                if (!t1Var.C1() || width2 <= 0) {
                                    ...
                                    if (rectF3.height() > 0.0f) {
                                        ...
                                        canvas.drawPath(z80Var2, paint4);
                                        bitmap = createBitmap;
                                        ...
                                        this.B = new im0(z80Var2, new int[]{iArr[0] + ((int) f22), iArr[1] + ((int) f15)}, t1Var, iArr, bitmap, rectF3, paint5, paint, makeStaticLayout2);
                                ...
                                this.B = new im0(z80Var2, new int[]{iArr2[0] + ((int) f22), iArr2[1] + ((int) f15)}, t1Var, iArr2, bitmap, rectF3, paint52, paint, makeStaticLayout22);
