...
public final class d60 extends FrameLayout {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (this.b) {
            ...
            if (i31 < i32) {
                ...
                if (i12 > 0) {
                    ...
                    canvas.drawRect(f12, f13, measuredWidth2 - i14, AndroidUtilities.statusBarHeight, org.telegram.ui.ActionBar.i6.t0);
                }
                ...
                boolean z11 = AndroidUtilities.computePerceivedBrightness(r60Var.getThemedColor(org.telegram.ui.ActionBar.i6.h5)) <= 0.721f;
                boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v(r60Var.getThemedColor(org.telegram.ui.ActionBar.i6.s8), 855638016)) > 0.721f;
        ...
        if (AndroidUtilities.computePerceivedBrightness(r60Var.getThemedColor(org.telegram.ui.ActionBar.i6.h5)) <= 0.721f) {
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v(r60Var.getThemedColor(org.telegram.ui.ActionBar.i6.s8), 855638016)) > 0.721f) {
        }
        this.c = Boolean.valueOf(z10);
        if (!z10) {
        }
