    ...
    class EmojiTabsView extends ScrollableHorizontalScrollView {
        ...
        public EmojiTabsView(Context context) {
            ...
            LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.Components.EmojiTabsStrip.EmojiTabsView.1
                ...
                protected void onMeasure(int i, int i2) {
                    super.onMeasure(Math.max(View.MeasureSpec.getSize(i), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(EmojiTabsView.this.contentView.getChildCount() * 32), TLObject.FLAG_30)), i2);
                }
            };
        ...
        public void show(boolean z, boolean z2) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.EmojiTabsStrip$EmojiTabsView$$ExternalSyntheticLambda1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
            ...
            protected void onLayout(boolean z5, int i3, int i4, int i5, int i6) {
                ...
                for (int i9 = 0; i9 < getChildCount(); i9++) {
                    ...
                    if (childAt2 != EmojiTabsStrip.this.settingsTab && !EmojiTabsStrip.this.removingViews.containsKey(childAt2) && childAt2 != null) {
                        ...
                        Long id = z6 ? ((EmojiTabButton) childAt2).id() : childAt2 instanceof EmojiTabsView ? Long.valueOf(((EmojiTabsView) childAt2).id) : null;
                ...
                if (z2) {
                    ...
                    this.giftsTab.animate().alpha(z ? 1.0f : 0.0f).setDuration(200L).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).withEndAction(new Runnable() { // from class: org.telegram.ui.Components.EmojiTabsStrip$$ExternalSyntheticLambda4
                        ...
                        public final void run() {
                            EmojiTabsStrip.this.lambda$showGifts$0(z);
                        }
                    }).start();
                }
