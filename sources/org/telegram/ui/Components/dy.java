...
public final class dy extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public dy(lz lzVar, Context context) {
        ...
        lj0Var.setColorFilter(lzVar.z(i10));
        addView(lj0Var, w7.y5.i(20.0f, 20.0f, 8388611, 10.0f, 15.0f, 0.0f, 0.0f));
    ...
    public final void a(boolean z10) {
        ...
        boolean z11 = yxVar.f;
        lz lzVar = this.E;
        int i10 = (this.s.e || UserConfig.getInstance(lzVar.c1).isPremium() || lzVar.U0) ? this.s.g ? z11 || lzVar.p1.contains(Long.valueOf(yxVar.b.id)) ? 3 : 2 : 0 : 1;
        if ((i10 == 0) != (this.x == 0)) {
            requestLayout();
        }
        this.x = i10;
