...
public final class hh0 extends View {
    public int A;
    public float B;
    public int C;
    public boolean D;
    ...
    public hh0(Context context, org.telegram.ui.ActionBar.b6 b6Var) {
        super(context);
    ...
    public final void a() {
        ...
        this.h.setColor(org.telegram.ui.ActionBar.f6.l1(0.85f, this.A));
        invalidate();
    }
    ...
    public final void c(String str, String str2) {
        this.d = new nz0(str, 11.0f, AndroidUtilities.bold());
        this.e = new nz0(str2, 11.0f, null);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        pc pcVar = this.y;
        if (action == 0) {
            pcVar.c(rectF.contains(motionEvent.getX(), motionEvent.getY()));
        } else if (motionEvent.getAction() == 2 && pcVar.h) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10 && SharedConfig.shadowsInSections) {
            paint2.setShadowLayer(AndroidUtilities.dpf2(2.0f), 0.0f, AndroidUtilities.dpf2(0.33f), org.telegram.ui.ActionBar.f6.l1(clamp01, 167772160));
            paint.setShadowLayer(AndroidUtilities.dpf2(0.33f), 0.0f, 0.0f, org.telegram.ui.ActionBar.f6.l1(clamp01, 201326592));
            paint.setColor(0);
        } else {
        ...
        drawable.setBounds(0, i11, dp2, i12);
    ...
    public final void onMeasure(int i9, int i10) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i9), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(37.0f), TLObject.FLAG_30));
    }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        ...
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.s8, b6Var);
            bgColor2 = bgColor1;
        } else {
            bgColor1 = peerColor.getBgColor1(org.telegram.ui.ActionBar.f6.I.q());
            bgColor2 = peerColor.getBgColor2(org.telegram.ui.ActionBar.f6.I.q());
        }
        if (peerColor == null) {
            this.C = org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.d6, b6Var);
            this.D = true;
        } else {
            this.C = org.telegram.ui.ActionBar.f6.b(0.04f, -0.09f, i0.a.d(0.15f, bgColor1, bgColor2));
            this.D = false;
        }
    ...
    public void setMusicDocument(TLRPC.Document document) {
        ...
        if (document != null) {
            while (true) {
                if (i9 < document.attributes.size()) {
                    TLRPC.DocumentAttribute documentAttribute2 = document.attributes.get(i9);
        ...
        if (TextUtils.isEmpty(str)) {
            if (TextUtils.isEmpty(str2)) {
                ...
                str2 = org.telegram.messenger.l0.h(R.string.AudioUnknownTitle, new StringBuilder(" - "));
            } else {
                str = "";
            }
