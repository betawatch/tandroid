...
public final class l00 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (nz0Var4 != null) {
            ...
            float f16 = nz0Var4.c;
            f10 = 15.32f;
            CharSequence charSequence = i6Var.g;
        ...
        CharSequence charSequence2 = i6Var.g;
        if (charSequence2 == null || charSequence2.length() == 0) {
            ...
            f14 = 2.0f;
            int dp = (int) (nz0Var4.c + f11 + AndroidUtilities.dp(4.66f));
            int dp2 = (int) (measuredHeight - AndroidUtilities.dp(9.0f));
            f13 = measuredHeight;
            int d = (int) (i6Var.d() + nz0Var4.c + f11 + AndroidUtilities.dp(f10));
            nz0Var = nz0Var4;
        ...
        if (nz0Var3 != null) {
            canvas.save();
            canvas.translate(f19 + dp3, (f13 - (nz0Var3.j() / f14)) + AndroidUtilities.dp(1.0f));
            nz0Var3.d(canvas);
            canvas.restore();
            f19 += dp3 + nz0Var3.c;
        }
        float f20 = f19;
        float dp4 = AndroidUtilities.dp(12.0f) + (nz0Var.j() / f14) + f13;
