...
public class ce0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ce0(Context context) {
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.td0
        ...
        final int i12 = 1;
        imageView2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.td0
            public final /* synthetic */ ce0 b;
        ...
        while (true) {
            ...
            ae0Var.setTag(Integer.valueOf(i13));
            if (i13 == 11) {
                ...
                ae0Var.setContentDescription(i13 + "");
                ae0Var.setNum(i13);
                if (i13 == 0) {
            ...
            ae0Var.setId(iArr[i13]);
            final int i14 = 2;
            ae0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.td0
                public final /* synthetic */ ce0 b;
    ...
    public static void a(ce0 ce0Var) {
        FrameLayout frameLayout = ce0Var.b;
        ci.j9 j9Var = ce0Var.s;
        boolean z10 = j9Var == null || ((StringBuilder) j9Var.d).length() > 0;
        if (frameLayout != null) {
            frameLayout.animate().cancel();
            org.telegram.messenger.ok.s(frameLayout.animate().alpha(z10 ? 0.0f : 1.0f).scaleX(z10 ? 0.8f : 1.0f).scaleY(z10 ? 0.8f : 1.0f), rr.h, 320L);
        }
    }
    ...
    public final void b(mc0 mc0Var) {
        ...
        this.L = kVar2;
        int i10 = 4;
        kVar2.a(new ei.m4(i10, this, mc0Var));
        this.L.b(new k7(mc0Var, i10));
        this.L.f();
    }
    ...
    */
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.n80 n80Var) {
        ...
        if (drawable instanceof mc0) {
            ...
            this.a = new mc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (mc0Var.u == null || mc0Var.q >= 0) {
                m6Var.setBackgroundColor(570425344);
            } else {
