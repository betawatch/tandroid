...
public final class r51 extends ul0 {
    ...
    public final void E(View view, int i10, boolean z10) {
        ...
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = s51Var.c;
        int i11 = s51Var.a;
    ...
    */
    public final void F(TLRPC.StickerSetCovered stickerSetCovered, FrameLayout frameLayout) {
        ...
        while (true) {
            ...
            if (stickerSetCoveredArr[i10] != null) {
                TLRPC.TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(s51Var.a).getStickerSetById(stickerSetCoveredArr[i10].set.id);
                if (stickerSetById != null && !stickerSetById.set.archived) {
    ...
    public final void G() {
        ...
        arrayList.clear();
        this.w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(s51Var.a);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            org.telegram.ui.Cells.t3 t3Var = new org.telegram.ui.Cells.t3(17, this.c, s51Var.P, true, true);
            final int i11 = 0;
            t3Var.setAddOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.q51
            ...
            final int i12 = 1;
            q3Var.setAddOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.q51
                public final /* synthetic */ r51 b;
