...
public class jx0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            ViewPropertyAnimator translationY = gc1Var.animate().translationY(dp);
            wr wrVar = wr.f;
            translationY.setInterpolator(wrVar).setDuration(250L);
            if (radialProgressView != null) {
                radialProgressView.animate().translationY(dp).setInterpolator(wrVar).setDuration(250L);
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            ...
            if (!this.x) {
                gc1Var.animate().translationY(0.0f).setInterpolator(wr.f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(wr.f).setDuration(250L);
                }
            }
        }
    ...
    public jx0(Context context, View view, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.y = new org.telegram.ui.Cells.l9(this, 22);
