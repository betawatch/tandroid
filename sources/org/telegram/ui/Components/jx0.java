...
public final class jx0 extends w9 implements NotificationCenter.NotificationCenterDelegate {
    public final int G;
    public int H;
    public String I;

    public jx0(Context context, int i10) {
        super(context);
    ...
    public final void t() {
        ...
        if (tL_messages_stickerSet != null) {
            ...
            if (size > i11) {
                ...
                svgThumb = document != null ? DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.h6.c7, 0.2f) : null;
                if (svgThumb != null) {
