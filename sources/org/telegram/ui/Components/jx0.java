...
public abstract class jx0 extends yl0 {
    public static final hx0 x3 = new hx0();
    public static final ix0 y3 = new ix0();
    public float X2;
    public fx0[] Y2;
    public final ax0 Z2;
    public final d6 a3;
    ...
    public jx0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.Y2 = null;
        qr qrVar = qr.h;
        this.a3 = new d6(this, 360L, qrVar);
        Paint paint = new Paint(1);
        this.e3 = paint;
        this.m3 = -1;
        this.o3 = 0.0f;
        this.q3 = true;
        this.r3 = new d6(this, 350L, qrVar);
        this.s3 = new d6(this, 350L, qrVar);
        this.t3 = new RectF();
        this.u3 = new RectF();
        this.v3 = new RectF();
    ...
    public static void A1(RectF rectF, View view) {
        ...
        if (view instanceof ex0) {
            ex0 ex0Var = (ex0) view;
            f7 = com.google.android.gms.internal.vision.e2.z(1.0f, ex0Var.E, 0.15f, 0.85f) * ex0Var.y;
        }
        float f10 = width * f7;
    ...
    private int getScrollToStartWidth() {
        ...
        return Math.max(0, getHeight() * (RecyclerView.S(childAt) - 1)) + this.f3 + (-childAt.getLeft());
    }
    ...
    public static void y1(jx0 jx0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j3) {
        ...
        for (int i10 = 0; i10 < tL_messages_emojiGroups.groups.size(); i10++) {
            ...
            fx0 fx0Var = new fx0();
            fx0Var.c = emojiGroup.icon_emoji_id;
            if (emojiGroup instanceof TLRPC.TL_emojiGroupPremium) {
                fx0Var.a = "premium";
            } else {
                fx0Var.a = TextUtils.concat((CharSequence[]) emojiGroup.emoticons.toArray(new String[0])).toString();
            }
            fx0Var.b = emojiGroup instanceof TLRPC.TL_emojiGroupGreeting;
            fx0Var.d = emojiGroup.title;
            fx0VarArr[i10] = fx0Var;
        }
        jx0Var.Y2 = jx0Var.C1(jx0Var.Y2);
        jx0Var.Z2.l();
        jx0Var.setCategoriesShownT(0.0f);
        jx0Var.H1(jx0Var.q3, System.currentTimeMillis() - j3 > 16);
    }
    ...
    public void F1(int i10) {
        ...
        for (int i11 = 0; i11 < getChildCount(); i11++) {
            ...
            if (childAt instanceof ex0) {
                ((ex0) childAt).l(this.m3 == RecyclerView.S(childAt) - 1, true);
            }
        }
        invalidate();
    }
    ...
    public final void H1(boolean z10, boolean z11) {
        ...
        this.p3.addListener(new gd0(this, 17));
    ...
    */
    ...
    public fx0 getSelectedCategory() {
        int i10;
        fx0[] fx0VarArr = this.Y2;
        if (fx0VarArr == null || (i10 = this.m3) < 0 || i10 >= fx0VarArr.length) {
            return null;
        }
