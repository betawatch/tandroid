...
public class QuickShareSelectorDrawable extends Drawable implements Animator.AnimatorListener {
    ...
    public static class Interpolators {
        ...
        static {
            ...
            closeAlpha = QuickShareSelectorDrawable.interpolator(new DecelerateInterpolator(), 0, NotificationCenter.onActivityResultReceived, NotificationCenter.onActivityResultReceived);
            closeAvatarPosition = QuickShareSelectorDrawable.interpolator(linearInterpolator, 0, NotificationCenter.onActivityResultReceived, NotificationCenter.onActivityResultReceived);
            closeAvatarAlpha = QuickShareSelectorDrawable.interpolator(new DecelerateInterpolator(), 256, NotificationCenter.onActivityResultReceived, NotificationCenter.onActivityResultReceived);
            ...
            buttonJumpDown = QuickShareSelectorDrawable.interpolator(new DecelerateInterpolator(), NotificationCenter.starGiftOptionsLoaded, 425, 650);
            ...
            avatar3 = QuickShareSelectorDrawable.interpolator(new DecelerateInterpolator(), NotificationCenter.onActivityResultReceived, 550, 650);
    ...
    public void draw(Canvas canvas) {
        draw(canvas, NotificationCenter.proxyCheckDone, false);
    }
