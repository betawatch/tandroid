...
public class QuickShareSelectorDrawable extends Drawable implements Animator.AnimatorListener {
    ...
    public void draw(Canvas canvas) {
        draw(canvas, NotificationCenter.cameraInitied, false);
    }
    ...
    public static class Interpolators {
        ...
        static {
            ...
            closeAvatarAlpha = QuickShareSelectorDrawable.interpolator(new DecelerateInterpolator(), 220, NotificationCenter.appConfigUpdated, NotificationCenter.appConfigUpdated);
            ...
            bgOpacity = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 0, NotificationCenter.chatlistFolderUpdate, 560);
            bgScale = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 40, NotificationCenter.chatlistFolderUpdate, 560);
            ...
            bubbleY = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 0, NotificationCenter.onReceivedChannelDifference, 560);
            ...
            avatar1 = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 60, NotificationCenter.chatlistFolderUpdate, 560);
