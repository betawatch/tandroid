...
public class QuickShareSelectorDrawable extends Drawable implements Animator.AnimatorListener {
    ...
    public void draw(Canvas canvas) {
        draw(canvas, NotificationCenter.didReplacedPhotoInMemCache, false);
    }
    ...
    public static class Interpolators {
        ...
        static {
            ...
            bgOpacity = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 0, NotificationCenter.uploadStoryProgress, 560);
            bgScale = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 40, NotificationCenter.uploadStoryProgress, 560);
            ...
            bubbleY = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 0, NotificationCenter.storiesReadUpdated, 560);
            ...
            avatar1 = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 60, NotificationCenter.uploadStoryProgress, 560);
