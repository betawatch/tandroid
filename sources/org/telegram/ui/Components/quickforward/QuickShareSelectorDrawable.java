...
public class QuickShareSelectorDrawable extends Drawable implements Animator.AnimatorListener {
    ...
    public void draw(Canvas canvas) {
        draw(canvas, NotificationCenter.closeOtherAppActivities, false);
    }
    ...
    public static class Interpolators {
        ...
        static {
            ...
            bgOpacity = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 0, NotificationCenter.storiesDraftsUpdated, 560);
            bgScale = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 40, NotificationCenter.storiesDraftsUpdated, 560);
            ...
            bubbleY = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 0, NotificationCenter.stealthModeChanged, 560);
            ...
            avatar1 = QuickShareSelectorDrawable.interpolator(cubicBezierInterpolator, 60, NotificationCenter.storiesDraftsUpdated, 560);
