...
public class zh0 extends xp implements NotificationCenter.NotificationCenterDelegate {
    public boolean A0;
    public boolean B0;
    public final wl0 C0;
    public final yh0 D0;
    ...
    public final View E(int i10) {
        ...
        ArrayList arrayList = yh0Var.c;
        if (arrayList.size() <= i10 || i10 < 0) {
            return null;
        }
        vh0 vh0Var = (vh0) arrayList.get(i10);
        wh0 wh0Var = vh0Var.b;
        return wh0Var == null ? vh0Var.c : wh0Var;
    }
            ...
            if (imageLocation3 == null || imageLocation3.location.local_id != imageLocation.location.local_id) {
                ...
                if (!isEmpty) {
                    ...
                    if (z10 && (dialogPhotos2 = this.S0) != null) {
                        dialogPhotos2.reset();
                        this.S0.loadAfter(getCurrentItem() - (yh0Var != null ? yh0Var.j() : 0), true);
                    }
                    return true;
                }
    ...
    public final void N(int i10, int i11) {
        ...
        yh0 yh0Var = this.D0;
        if (yh0Var != null) {
            for (int i12 = 0; i12 < yh0Var.c.size(); i12++) {
                if (((vh0) yh0Var.c.get(i12)).c != null) {
                    th0 th0Var = ((vh0) yh0Var.c.get(i12)).c;
                    int i13 = this.m1;
                    int i14 = this.n1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 != i14) {
            ...
            SparseArray sparseArray = zh0Var2.d1;
            if (i10 == i15) {
            ...
            if (i10 != NotificationCenter.fileLoadProgressChanged) {
                if (i10 == NotificationCenter.reloadDialogPhotos && zh0Var2.c1 == 0 && (dialogPhotos = zh0Var2.S0) != null) {
                    dialogPhotos.reset();
                    MessagesController.DialogPhotos dialogPhotos2 = zh0Var2.S0;
                    int currentItem = zh0Var2.getCurrentItem();
                    yh0 yh0Var = zh0Var2.D0;
                    dialogPhotos2.loadAfter(currentItem - (yh0Var != null ? yh0Var.j() : 0), true);
                    return;
                }
                return;
            }
        ...
        if (zh0Var2.S0 == dialogPhotos3) {
            ArrayList arrayList7 = new ArrayList(dialogPhotos3.photos);
            if (!arrayList7.isEmpty() || !dialogPhotos3.fromCache) {
                zh0Var2.j1 = -1;
                zh0Var2.k1 = -1;
                int i18 = zh0Var2.L0;
                TLRPC.User user4 = MessagesController.getInstance(i18).getUser(Long.valueOf(zh0Var2.E0));
                TLRPC.UserFull userFull = MessagesController.getInstance(i18).getUserFull(zh0Var2.E0);
                ...
                arrayList12.clear();
                ArrayList arrayList13 = zh0Var2.a1;
                arrayList13.clear();
                ArrayList arrayList14 = zh0Var2.b1;
                arrayList14.clear();
                if (DialogObject.isChatDialog(zh0Var2.E0)) {
                    TLRPC.Chat chat = MessagesController.getInstance(i18).getChat(Long.valueOf(-zh0Var2.E0));
                    ...
                    if (imageLocation != null) {
                        ...
                        if (chatFull == null || !FileLoader.isSamePhoto((TLRPC.FileLocation) imageLocation.location, chatFull.chat_photo)) {
                            ...
                            if (zh0Var2.F0.chat_photo.video_sizes.isEmpty()) {
                                ...
                                TLRPC.VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(zh0Var2.F0.chat_photo.video_sizes, MediaDataController.MAX_STYLE_RUNS_COUNT);
                        ...
                        if (closestPhotoSizeWithSize2 != null) {
                            ...
                            if (forPhoto != null) {
                                ...
                                if (imageLocation3 == null) {
                                    arrayList14 = arrayList4;
                                    user2 = user;
                                } else if (imageLocation3.photoId != forPhoto.photoId || z10 || zh0Var2.E0 == UserConfig.getInstance(i12).getClientUserId()) {
                                    user2 = user;
                                    arrayList14 = arrayList4;
                                } else {
                                    arrayList5.add(null);
                ...
                ImageLocation imageLocation5 = zh0Var.q1;
                if (imageLocation5 != null) {
                    zh0Var.A(imageLocation5, zh0Var.r1);
                }
            }
        }
    }
    ...
    public w9 getCurrentItemView() {
        yh0 yh0Var = this.D0;
        if (yh0Var == null || yh0Var.c.isEmpty()) {
            return null;
        }
        return ((vh0) yh0Var.c.get(getCurrentItem())).c;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        qh0 qh0Var = this.p1;
        if (qh0Var != null) {
            qh0Var.setTranslationY(getHeight() - this.p1.getMeasuredHeight());
        }
    }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (yh0Var != null) {
            wl0 wl0Var = this.C0;
            if (wl0Var.getScrollState() != 0 && !this.A0 && this.B0) {
                this.B0 = false;
            ...
            if (action == 0) {
                ...
                if (yh0Var.c.size() > 1 && uh0Var != null) {
                    uh0Var.b(motionEvent.getX() < ((float) getWidth()) / 3.0f);
                }
                this.I0 = false;
            } else if (action == 1) {
                if (!this.I0) {
                    ...
                    if (realCount > 1) {
                        if (motionEvent.getX() > getWidth() / 3.0f) {
                            ...
                            i10 = i12 < yh0Var.j() ? (realCount + r0) - 1 : i12;
                        }
                        if (uh0Var != null) {
                            uh0Var.a();
                        }
            ...
            boolean onTouchEvent = this.A0 ? wl0Var.onTouchEvent(motionEvent) : false;
            if (this.B0) {
                try {
    ...
    public zh0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, wl0 wl0Var, org.telegram.ui.d01 d01Var, uh0 uh0Var, qh0 qh0Var) {
        super(context);
        this.x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.k1 = -1;
        this.p1 = qh0Var;
        setPadding(0, 0, 0, qh0Var == null ? 0 : qh0Var.n);
        if (qh0Var != null) {
            qh0Var.setView(this);
        }
        setVisibility(8);
        ...
        this.C0 = wl0Var;
        this.z0 = kVar;
        yh0 yh0Var = new yh0(this, getContext(), d01Var);
        this.D0 = yh0Var;
        setAdapter((wp) yh0Var);
        this.y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = uh0Var;
        b(new sh0((org.telegram.ui.gz0) this));
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.dialogPhotosLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoaded);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.fileLoadProgressChanged);
        NotificationCenter.getInstance(i10).addObserver(this, NotificationCenter.reloadDialogPhotos);
