...
public final class eg extends FrameLayout {
    ...
    public final void a() {
        lh.w3 w3Var = this.a;
        if (w3Var != null) {
            w3Var.h0 = new cg(this, w3Var, 1);
            w3Var.e(true);
            this.a = null;
        }
        lh.w3 w3Var2 = this.b;
        if (w3Var2 != null) {
            w3Var2.h0 = new cg(this, w3Var2, 2);
            w3Var2.e(true);
            this.b = null;
        }
    }
    ...
    public final void b() {
        ...
        lh.w3 w3Var2 = this.b;
        w3Var2.h = lh.w3.a(w3Var2.getText(), this.b.getTextPaint());
        ...
        addView(this.b, h7.z5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
        lh.w3 w3Var3 = this.b;
        w3Var3.h0 = new cg(this, w3Var3, 0);
        w3Var3.v();
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:143:0x0351, code lost:
        ...
        r3 = org.telegram.ui.Components.er.j;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x01ce, code lost:
        ...
        r46.restore();
        r46.save();
        r4.setBounds(r7 - (r4.getIntrinsicWidth() / 2), (int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14)), org.telegram.messenger.rl.A(2, r7, r4), r4.getIntrinsicHeight() + ((int) (org.telegram.messenger.AndroidUtilities.dpf2(20.0f) + (r45.f.getHeight() + r14))));
        r4.draw(r46);
        r46.restore();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x0324, code lost:
        ...
        r5 = org.telegram.ui.Components.er.j;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x03e8, code lost:
        ...
        r2 = org.telegram.messenger.y1.z(1.0f, r2, (1.0f - r10) * r8.d4, r5);
        r9 = r7;
        r6 = r30 + r26;
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (chatActivityEnterView.n4) {
            ...
            f13 = org.telegram.ui.Cells.pa.b(1.0f, f20, f21 * 15.0f, (1.0f - f21) * (1.0f - dp3) * 9.0f);
            f14 = dp3;
        } else {
            f11 = 0.25f;
            f12 = 26.0f;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.P && rectF2.contains(x8, y10)) {
                ...
                mediaDataController.toggleDraftVoiceOnce(j10, (rnVar == null || !rnVar.d4) ? 0L : rnVar.b(), chatActivityEnterView.K);
                if (chatActivityEnterView.K) {
                    b();
                } else {
                    a();
    ...
    public void setBlurredBackgroundFactory(jg.a aVar) {
        this.M = true;
        if (this.L == null) {
            this.L = new mg.b(org.telegram.ui.ActionBar.g6.ae, this.R.R3);
        }
        lg.d c10 = aVar.c(this, this.L, false);
        this.N = c10;
        c10.p(AndroidUtilities.dp(18.0f));
        this.N.o(AndroidUtilities.dp(3.0f));
        lg.d c11 = aVar.c(this, this.L, false);
        this.O = c11;
