    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.a) {
            case 0:
                ...
                obtain2.recycle();
                boolean z10 = !eg0Var.s.isInProgress() && eg0Var.v.y(motionEvent);
                if (actionMasked == 1 || actionMasked == 3 || actionMasked == 6) {
                    eg0Var.w = false;
                    eg0Var.x = false;
                    if (eg0Var.d0) {
        ...
        switch (this.a) {
            case 0:
                ...
                if (eg0Var.H != eg0Var.t() * eg0Var.J || eg0Var.I != eg0Var.r() * eg0Var.J) {
                    ...
                    kVar.b = f7;
                    kVar.c = true;
                    kVar.u.i = a4.a.B(eg0Var.t(), eg0Var.J, 2.0f, f7) >= AndroidUtilities.displaySize.x / 2.0f ? (r3 - (eg0Var.t() * eg0Var.J)) - AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(16.0f);
                    eg0Var.M.f();
                    o1.k kVar2 = eg0Var.N;
                    kVar2.b = eg0Var.L;
                    kVar2.c = true;
