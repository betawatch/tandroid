...
public final class dg0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        org.telegram.ui.ActionBar.j5 j5Var = org.telegram.ui.ActionBar.k6.k3;
        if (j5Var != null) {
            j5Var.setAlpha((int) (getAlpha() * 255.0f));
            org.telegram.ui.ActionBar.k6.k3.setBounds(AndroidUtilities.dp(1.0f), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(125.0f), AndroidUtilities.dp(125.0f));
            org.telegram.ui.ActionBar.k6.k3.draw(canvas);
            org.telegram.ui.ActionBar.k6.S1.setColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.ra, false));
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (abs > dp) {
            ...
            if (i17 >= 0 || i17 <= (-pipRoundVideoView.h) / 4) {
                if (Math.abs(b11 - i17) > dp) {
                    ...
                    if (i18 <= i19 - i20 || i18 >= i19 - ((i20 / 4) * 3)) {
                        if (pipRoundVideoView.a.getAlpha() != 1.0f) {
                            ...
                            if (z4) {
                                z10 = true;
                                arrayList.add(ObjectAnimator.ofFloat(pipRoundVideoView.a, (Property<dg0, Float>) property, 0.0f));
                                animatorSet.addListener(new fg0(pipRoundVideoView, 1));
                            } else {
                                z10 = true;
                            }
                ...
                edit.putInt("sidex", 1);
                if (pipRoundVideoView.a.getAlpha() != 1.0f) {
                    dg0 dg0Var = pipRoundVideoView.a;
                    float[] fArr = new float[1];
                    fArr[c3] = 1.0f;
                    arrayList.add(ObjectAnimator.ofFloat(dg0Var, (Property<dg0, Float>) property, fArr));
                }
        ...
        if (pipRoundVideoView.a.getAlpha() != f10) {
            arrayList2.add(ObjectAnimator.ofFloat(pipRoundVideoView.a, (Property<dg0, Float>) property, f10));
        }
