                            ...
                            if (messageObject2 != null) {
                                ...
                                if (id2 == messageObject.getId()) {
                                    ...
                                    if (linkImageView != null) {
                                        ...
                                        vu0Var.n = -iArr[c11];
                                        vu0Var.a = linkImageView;
                                        vu0Var.o = true;
                                        vu0Var.h = linkImageView.getRoundRadius(true);
                                        vu0Var.e = vu0Var.a.getBitmapSafe();
                                        vu0Var.d.getLocationInWindow(iArr);
                                        vu0Var.j = 0;
                                        vu0Var.q = jv0Var.t1[0].m;
                                        if (vs0Var != null && vs0Var.getVisibility() == 0) {
                                            vu0Var.j = AndroidUtilities.dp(36.0f) + vu0Var.j;
                                        }
