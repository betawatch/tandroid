...
public class ShareTopView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
            ...
            for (int i3 = 0; i3 < longSparseArray.size(); i3++) {
                ...
                if (webPage != null && webPage.id == this.loadedWebPage.id) {
                    ...
                    if (webPage instanceof TLRPC.TL_webPage) {
                        ...
                        String str = this.foundUrls.isEmpty() ? "" : TextUtils.join(" ", this.foundUrls).toString();
                        if (!this.linkPreviewCache.containsKey(str)) {
    ...
    private void doLinkSearch(CharSequence charSequence, boolean z) {
        OnModeChangeListener onModeChangeListener;
        ArrayList extractUrls = extractUrls(charSequence);
        if (z || !sameUrls(extractUrls)) {
            this.foundUrls.clear();
            if (extractUrls != null) {
                this.foundUrls.addAll(extractUrls);
            }
            boolean z2 = false;
            ...
            String str = TextUtils.join(" ", extractUrls).toString();
            if (!this.previewEnabled) {
                String str2 = this.dismissedMessage;
            ...
            TLRPC.WebPage webPage = (TLRPC.WebPage) this.linkPreviewCache.get(str);
            if (webPage != null) {
                this.loadedWebPage = webPage;
                bindLinkLoaded(current(), webPage, str);
            } else {
                bindLinkLoading(current(), str);
                requestLinkPreview(str);
            }
            applyHintText(current());
            int i3 = this.currentMode;
            if (i2 == i3 || (onModeChangeListener = this.modeChangeListener) == null) {
    ...
    public void setRecipients(int i, ArrayList arrayList) {
        ...
        if (this.currentMode == 1) {
            current.obj.setText(buildRecipientText(current));
        }
    }
    ...
    private void switchLayouts(boolean z) {
        ...
        if (z) {
            ...
            ViewPropertyAnimator translationY = this.layouts[0].animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).translationY(0.0f);
            ...
            layout3.animate().scaleX(0.8f).scaleY(0.8f).alpha(0.0f).translationY(-AndroidUtilities.dp(20.0f)).setInterpolator(cubicBezierInterpolator).setDuration(320L).withEndAction(new Runnable() { // from class: org.telegram.ui.Components.ShareTopView$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ShareTopView.Layout.this.setVisibility(8);
                }
            }).start();
            return;
        }
    ...
    private void requestLinkPreview(final String str) {
        ...
        this.linkRequestId = AccountInstance.getInstance(this.currentAccount).getConnectionsManager().sendRequest(getwebpagepreview, new RequestDelegate() { // from class: org.telegram.ui.Components.ShareTopView$$ExternalSyntheticLambda0
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ShareTopView.$r8$lambda$A6ZiDmaA01FOWLNWhPbQ_iufumE(ShareTopView.this, i, str, tLObject, tL_error);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$A6ZiDmaA01FOWLNWhPbQ_iufumE(final ShareTopView shareTopView, final int i, final String str, final TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ShareTopView$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ShareTopView.$r8$lambda$mKFoh2HtvAFSQQxf684zGN4-Dd8(ShareTopView.this, i, tLObject, str);
            }
        });
    }
    ...
    */
    public static /* synthetic */ void $r8$lambda$mKFoh2HtvAFSQQxf684zGN4-Dd8(ShareTopView shareTopView, int i, TLObject tLObject, String str) {
    ...
    private CharSequence buildRecipientText(Layout layout) {
        ...
        while (i < size) {
            ...
            if (longValue == this.selfId) {
                sb.append(LocaleController.getString(R.string.SavedMessages));
            } else {
                if (this.recipients.size() == 1) {
                    shortName = DialogObject.getName(this.currentAccount, longValue);
                } else {
                    shortName = DialogObject.getShortName(this.currentAccount, longValue);
                }
                sb.append(shortName);
            }
        }
        String formatString = LocaleController.formatString(R.string.ShareSendToChats, sb.toString());
        return (this.recipients.size() > 2 || layout.obj.getPaint().measureText(formatString) > ((float) (layout.obj.getMeasuredWidth() <= 0 ? AndroidUtilities.displaySize.x - AndroidUtilities.dp(140.0f) : layout.obj.getMeasuredWidth()))) ? LocaleController.formatPluralString("ShareSendToMany", this.recipients.size(), new Object[0]) : formatString;
    }
    ...
    public void startHintRotation(CharSequence charSequence) {
        ...
        applyHintText(current());
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.ShareTopView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                ShareTopView.$r8$lambda$Nb22ItWQJ08gUUbIUXFzK7iiFYw(ShareTopView.this);
            }
        };
    ...
    public static /* synthetic */ void $r8$lambda$Nb22ItWQJ08gUUbIUXFzK7iiFYw(ShareTopView shareTopView) {
