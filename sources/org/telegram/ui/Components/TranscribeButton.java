...
public abstract class TranscribeButton {
    ...
    public TranscribeButton(ChatMessageCell chatMessageCell, SeekBarWaveform seekBarWaveform) {
        ...
        this.outIconDrawable.setOnFinishCallback(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda5
            ...
            public final void run() {
                TranscribeButton.$r8$lambda$cqcbubnGAceS7ybU7Dkfna_qyXE(TranscribeButton.this);
            }
        }, 19);
        ...
        this.inIconDrawable.setOnFinishCallback(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                TranscribeButton.$r8$lambda$FrJ-YLe3gnPp-9wjHBzKhPAAp5c(TranscribeButton.this);
            }
        }, 19);
    ...
    public static /* synthetic */ void $r8$lambda$cqcbubnGAceS7ybU7Dkfna_qyXE(TranscribeButton transcribeButton) {
    ...
    public static /* synthetic */ void $r8$lambda$FrJ-YLe3gnPp-9wjHBzKhPAAp5c(TranscribeButton transcribeButton) {
        transcribeButton.inIconDrawable.stop();
        transcribeButton.outIconDrawable.stop();
        transcribeButton.shouldBeOpen = false;
        transcribeButton.isOpen = false;
        transcribeButton.outIconDrawable.setCurrentFrame(0);
    }
    ...
    public void draw(Canvas canvas, float f) {
        ...
        if (f4 > 0.0f) {
            ...
            float f11 = this.b;
            addLine(path6, i2, i5, i2, i6, f9, f10, f11, 180.0f - f11);
            ...
            float f12 = this.a;
            addLine(path8, i9, i10, i11, i10, f9, f10, 180.0f - f12, f12 + 180.0f);
            ...
            float f13 = this.b;
            addLine(path10, i12, i15, i12, i16, f9, f10, f13 + 180.0f, 360.0f - f13);
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, AndroidUtilities.dp(26.0f), AndroidUtilities.dp(26.0f), NotificationCenter.didReceiveSmsCode, 31);
        if (this.isOpen) {
    ...
    private static class LoadingPointsDrawable extends Drawable {
        ...
        public LoadingPointsDrawable(TextPaint textPaint) {
            Drawable.Callback callback = new Drawable.Callback() { // from class: org.telegram.ui.Components.TranscribeButton.LoadingPointsDrawable.1
            ...
            float textSize = textPaint.getTextSize() * 0.89f;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(org.telegram.messenger.R.raw.dots_loading, "dots_loading", (int) textSize, (int) (textSize * 1.25f));
    ...
    public static boolean isTranscribing(MessageObject messageObject) {
        ...
        if (hashMap != null && (hashMap.containsValue(messageObject) || transcribeOperationsByDialogPosition.containsKey(Integer.valueOf(reqInfoHash(messageObject))))) {
            return true;
        }
        HashMap hashMap2 = transcribeOperationsById;
    ...
    private static void transcribePressed(final MessageObject messageObject, boolean z, final ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate) {
        ...
        if (z) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(tL_messages_transcribeAudio, new RequestDelegate() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda3
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    TranscribeButton.$r8$lambda$LBE0JIMr3dRPKNY7rzjqcGZgi0g(i, chatMessageCellDelegate, messageObject, elapsedRealtime, peerDialogId, i2, tLObject, tL_error);
                }
    ...
    public static /* synthetic */ void $r8$lambda$LBE0JIMr3dRPKNY7rzjqcGZgi0g(final int i, final ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate, final MessageObject messageObject, long j, long j2, int i2, TLObject tLObject, TLRPC.TL_error tL_error) {
        int i3;
        long j3;
        boolean z;
        String str;
        ...
        if (tLObject instanceof TLRPC.TL_messages_transcribedAudio) {
            ...
            if ((tL_messages_transcribedAudio.flags & 2) != 0) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        TranscribeButton.$r8$lambda$a2o22si0EBawg-KyJsqzCtlJsVw(ChatMessageCell.ChatMessageCellDelegate.this, tL_messages_transcribedAudio);
                    }
                });
            }
            ...
            transcribeOperationsById.put(Long.valueOf(j3), messageObject);
            messageObject.messageOwner.voiceTranscriptionId = j3;
            i3 = i;
            z = z3;
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    TranscribeButton.$r8$lambda$oaPhGEe95pO5I2f8R2G6iDB-Ayg(MessageObject.this, chatMessageCellDelegate, i);
                }
            });
            return;
        } else {
        ...
        final long j4 = j3;
        MessagesStorage.getInstance(i3).updateMessageVoiceTranscription(j2, i2, str4, messageObject.messageOwner);
        if (z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    TranscribeButton.finishTranscription(MessageObject.this, j4, str4);
                }
            }, Math.max(0L, 350 - elapsedRealtime));
        }
    }

    public static /* synthetic */ void $r8$lambda$a2o22si0EBawg-KyJsqzCtlJsVw(ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate, TLRPC.TL_messages_transcribedAudio tL_messages_transcribedAudio) {
        if (chatMessageCellDelegate != null) {
            chatMessageCellDelegate.needShowPremiumBulletin(tL_messages_transcribedAudio.trial_remains_num > 0 ? 1 : 2);
        }
    }

    public static /* synthetic */ void $r8$lambda$oaPhGEe95pO5I2f8R2G6iDB-Ayg(MessageObject messageObject, ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate, int i) {
        HashMap hashMap = transcribeOperationsByDialogPosition;
        if (hashMap != null) {
            hashMap.remove(Integer.valueOf(reqInfoHash(messageObject)));
        }
        ...
        NotificationCenter.getInstance(i).postNotificationName(NotificationCenter.voiceTranscriptionUpdate, messageObject);
        NotificationCenter.getInstance(i).postNotificationName(NotificationCenter.updateTranscriptionLock, new Object[0]);
    }
        ...
        try {
            ...
            if (messageObject != null && messageObject.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        TranscribeButton.$r8$lambda$1syPhlF9Qci0KK0OZ3VrvJKETVo(MessageObject.this, j, str);
                    }
                });
                return true;
            }
    ...
    public static /* synthetic */ void $r8$lambda$1syPhlF9Qci0KK0OZ3VrvJKETVo(MessageObject messageObject, long j, String str) {
        NotificationCenter notificationCenter = NotificationCenter.getInstance(messageObject.currentAccount);
        int i = NotificationCenter.voiceTranscriptionUpdate;
        Long valueOf = Long.valueOf(j);
        Boolean bool = Boolean.TRUE;
        notificationCenter.postNotificationName(i, messageObject, valueOf, str, bool, bool);
    }
    ...
    public static void showOffTranscribe(final MessageObject messageObject, boolean z) {
        ...
        if (z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    NotificationCenter.getInstance(r0.currentAccount).postNotificationName(NotificationCenter.voiceTranscriptionUpdate, MessageObject.this);
                }
            });
        }
    }
