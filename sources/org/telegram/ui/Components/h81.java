...
public final class h81 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        drawable.setBounds(org.telegram.ui.Cells.c1.r(2, this.c.getWidth() / 2, drawable), (int) (AndroidUtilities.dpf2(4.0f) + this.c.getHeight()), org.telegram.ui.Cells.c1.v(2, this.c.getWidth() / 2, drawable), drawable.getIntrinsicHeight() + ((int) (AndroidUtilities.dpf2(4.0f) + this.c.getHeight())));
