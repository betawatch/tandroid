...
public final class s61 extends View {
    ...
    public s61(Context context) {
        ...
        m6Var2.a.setXfermode(new PorterDuffXfermode(mode));
    ...
    public final void a(int i10, boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            m6Var.q(i10 >= 720 ? "HD" : "SD", true, true);
            int[] iArr = this.n;
            ...
            if (length < 0) {
                ...
                m6Var2.q("2K", TextUtils.isEmpty(m6Var2.g), true);
            } else if (length == 7) {
                m6Var2.q("4K", TextUtils.isEmpty(m6Var2.g), true);
            } else {
                m6Var2.q("" + iArr[length], TextUtils.isEmpty(m6Var2.g), true);
            }
        }
        setClickable(!this.f);
        invalidate();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        m6Var.draw(canvas);
        m6 m6Var2 = this.b;
        rect.set((int) ((AndroidUtilities.dpf2(16.0f) + (getWidth() / 2.0f)) - (m6Var2.d() + (AndroidUtilities.dpf2(2.0f) * m6Var2.g()))), (int) ((getHeight() / 2.0f) - AndroidUtilities.dpf2(14.0f)), (int) (AndroidUtilities.dpf2(16.0f) + (getWidth() / 2.0f)), (int) (((getHeight() / 2.0f) - AndroidUtilities.dpf2(14.0f)) + AndroidUtilities.dpf2(8.33f)));
        rectF.set(rect);
