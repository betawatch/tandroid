...
public class tl0 extends RecyclerView implements pg.a {
    ...
    public q0.a l2;
    public ArrayList m1;
    public final org.telegram.ui.ActionBar.g6 m2;
    public ArrayList n1;
    public boolean n2;
    public View o1;
    public final fe o2;
    ...
    public static void N0(Canvas canvas, RectF rectF, float f10, float f11, float f12, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.k6.l1(f12, org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.d6, g6Var)));
        if (f10 == f11) {
            ...
            if (layoutManager instanceof f2.j0) {
                ...
                if (j0Var.o == 1) {
                    if (this.d1 == null) {
                        ...
                        if ((!this.H1 && !z4) || (cl0Var = this.c1) == null || cl0Var.n) {
                            return;
                        }
                        ...
                        if (adapter instanceof dl0) {
                            ...
                            this.c1.setIsVisible(dl0Var.E(this));
                    ...
                    if ((this.H1 || z4) && (cl0Var2 = this.c1) != null && !cl0Var2.n && (getAdapter() instanceof dl0)) {
    ...
    public final void P0(Canvas canvas, View view, View view2, boolean z4, boolean z10) {
        ...
        float bottomInfoMargin = view2 instanceof n80 ? ((n80) view2).getBottomInfoMargin() : 0.0f;
        RectF rectF = AndroidUtilities.rectTmp;
    ...
    */
            ...
            for (int i14 = 0; i14 < getChildCount(); i14++) {
                ...
                if (childAt2 != this.Z0 && childAt2.getVisibility() == 0 && childAt2.getAlpha() > 0.0f && ((Boolean) this.E2.a.run(childAt2)).booleanValue()) {
                    ...
                    if (!T.j() || childAt2.getAlpha() >= 1.0f) {
                        ...
                        ql0Var2.b = G0;
                        ql0Var2.c = alpha2;
                        arrayList2.add(ql0Var2);
                    }
                }
            }
            ArrayList arrayList3 = this.L2;
            float f13 = this.I2;
            ArrayList arrayList4 = rl0.a;
            if (arrayList3 == null || arrayList3.isEmpty()) {
                f10 = 1.0f;
            } else {
                Collections.sort(arrayList3, new oh.k0(24));
                arrayList4.clear();
                int i16 = 0;
                while (i16 < arrayList3.size()) {
                    float f14 = ((ql0) arrayList3.get(i16)).b;
                    int i17 = i16 + 1;
                    while (i17 < arrayList3.size() && ((ql0) arrayList3.get(i17)).a <= f14 + 1.5f) {
                        f14 = Math.max(f14, ((ql0) arrayList3.get(i17)).b);
                        i17++;
                    }
                    ...
                    for (int i18 = i16; i18 < i17; i18++) {
                        ql0 ql0Var3 = (ql0) arrayList3.get(i18);
                        if (ql0Var3.c >= 0.99f) {
                            f17 = Math.min(f17, ql0Var3.a);
                            f18 = Math.max(f18, ql0Var3.b);
                        }
                    }
                    boolean z4 = f17 != Float.MAX_VALUE;
                    float f19 = 0.0f;
                    for (int i19 = i16; i19 < i17; i19++) {
                        ql0 ql0Var4 = (ql0) arrayList3.get(i19);
                        f15 = Math.min(f15, ql0Var4.a);
                        f16 = Math.max(f16, ql0Var4.b);
                        f19 = Math.max(f19, ql0Var4.c);
                    }
                    if (f19 >= 0.001f) {
                        if (z4) {
                            float f20 = 0.0f;
                            ...
                            for (int i20 = i16; i20 < i17; i20++) {
                                ql0 ql0Var6 = (ql0) arrayList3.get(i20);
                                float f21 = ql0Var6.c;
                                if (f21 < 0.99f) {
                                    float f22 = ql0Var6.a;
                                    if (f22 < f17) {
                            ...
                            float f24 = 0.0f;
                            while (i16 < i17) {
                                ql0 ql0Var8 = (ql0) arrayList3.get(i16);
                                float f25 = ql0Var8.c;
                                if (f25 < 0.99f) {
                                    float f26 = ql0Var8.b;
                                    if (f26 > f18) {
    ...
    public final Drawable V0(View view, boolean z4) {
        ...
        if (z10 && z11 && !z4) {
            ...
            if (z10 && z12) {
                return org.telegram.ui.ActionBar.k6.b0(0, org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.d6, this.m2));
            }
            z11 = z12;
        }
        Path path = new Path();
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (al0Var != null) {
            tl0 tl0Var = al0Var.a;
            if (al0Var.d || al0Var.e) {
                for (int i10 = 0; i10 < tl0Var.getChildCount(); i10++) {
                    View childAt = tl0Var.getChildAt(i10);
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !al0Var.c.contains(childAt)) {
                        Float f10 = (Float) al0Var.b.get(R, null);
                        if (f10 == null) {
    ...
    public final void i1(int i10, View view) {
        ...
        if (this.z1 == 8) {
            ...
            org.telegram.ui.ActionBar.k6.A1(this.A1, i10 == 0 ? this.Y1 : 0, i10 == getAdapter().h() + (-2) ? this.Y1 : 0);
        }
    ...
    public final void n1(ml0 ml0Var, long j10) {
        this.V0 = ml0Var;
        ai aiVar = this.J1;
        boolean z4 = ml0Var != null;
        m20 m20Var = (m20) aiVar.b;
        m20Var.t = z4;
        m20Var.u = j10;
    }
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (cl0Var != null) {
            this.G1 = true;
            int paddingTop = i11 + (cl0Var.a ? getPaddingTop() : cl0Var.e0);
            cl0 cl0Var2 = this.c1;
            if (cl0Var2.d0) {
                cl0Var2.layout(0, paddingTop, cl0Var2.getMeasuredWidth(), this.c1.getMeasuredHeight() + paddingTop);
            } else {
                int measuredWidth = getMeasuredWidth() - this.c1.getMeasuredWidth();
                cl0 cl0Var3 = this.c1;
                cl0Var3.layout(measuredWidth, paddingTop, cl0Var3.getMeasuredWidth() + measuredWidth, this.c1.getMeasuredHeight() + paddingTop);
            }
            this.G1 = false;
        }
        K0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (cl0Var != null && cl0Var.getLayoutParams() != null) {
            cl0 cl0Var2 = this.c1;
            int measuredHeight = (getMeasuredHeight() - (cl0Var2.a ? getPaddingTop() : cl0Var2.e0)) - getPaddingBottom();
    ...
    public final void r1(Utilities.CallbackReturn callbackReturn, int i10, float f10, Utilities.Callback5 callback5, boolean z4) {
        ...
        int i11 = 2;
        Pair pair = new Pair(new i(this, callbackReturn, sparseIntArray, i11), new oi(sparseIntArray, i11));
    ...
    public final void s1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f10, Utilities.Callback5 callback5, boolean z4) {
        setSelectorDrawableColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.j6, this.m2));
    ...
    public void setAdapter(f2.p0 p0Var) {
        ...
        f2.e1 e1Var = this.q2;
        if (adapter != null) {
            adapter.a.unregisterObserver(e1Var);
        }
    ...
    public void setFastScrollEnabled(int i10) {
        this.c1 = new cl0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.c1);
        }
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        org.telegram.ui.Cells.z zVar = this.A1;
        if (num == null) {
            intValue = org.telegram.ui.ActionBar.k6.v0(b1() ? org.telegram.ui.ActionBar.k6.j6 : org.telegram.ui.ActionBar.k6.i6, this.m2);
        } else {
    ...
    public tl0(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        setGlowColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.s8, g6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.k6.f0(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.i6, g6Var), 2, -1);
        this.A1 = f02;
