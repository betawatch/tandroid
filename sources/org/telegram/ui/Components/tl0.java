            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof o5) && (l4Var = ((o5) drawable).k) != null && l4Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (!sl0Var.e || z10) {
                            m5Var.v = (int) ((m5Var == this.u ? 1.0f : 0.3f) * 255.0f * sl0Var.d * this.r);
                            float dp = max - AndroidUtilities.dp(sl0Var.a);
                            float dp2 = AndroidUtilities.dp(sl0Var.b) + min;
                            float dp3 = AndroidUtilities.dp(10.0f) * sl0Var.c * e;
