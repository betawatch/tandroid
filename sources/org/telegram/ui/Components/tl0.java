            ...
            if (!this.Y) {
                ...
                if ((drawable instanceof q5) && (l4Var = ((q5) drawable).k) != null && l4Var.hasImageLoaded()) {
                    ...
                    while (true) {
                        ...
                        if (!sl0Var.e || z10) {
                            o5Var.v = (int) ((o5Var == this.u ? 1.0f : 0.3f) * 255.0f * sl0Var.d * this.r);
    ...
    */
    public final void e(Canvas canvas, RectF rectF, float f7) {
        ...
        if (e > 0.0f && !this.i) {
            ...
            rectF2.set(rectF.left, (AndroidUtilities.lerp(0.0f, 1.0f - rr.i.getInterpolation(w7.p.a(((Math.max(pow, 0.5f) + 1.5f) % 3.5f) * 0.5f, 0.0f, 1.0f)), e) * rectF.height()) + rectF.top, rectF.left + AndroidUtilities.dp(6.0f), (AndroidUtilities.lerp(1.0f, 1.0f - rr.g.getInterpolation(w7.p.a((((pow + 1.5f) % 3.5f) - 1.5f) * 0.5f, 0.0f, 1.0f)), e) * rectF.height()) + rectF.top);
