...
public final class vy0 {
    ...
    public final void a(Canvas canvas, View view, boolean z10) {
        ...
        boolean z13 = i13 == i14;
        boolean z14 = this.q + this.l == cz0Var.A;
        int dp = AndroidUtilities.dp(8.0f);
        boolean z15 = this.c.header;
        if (z15 || (cz0Var.D && this.a.a.b.a % 2 == 0)) {
            int i15 = this.p;
            if (i15 == 0 && this.q == 0) {
                float f9 = dp;
                fArr[1] = f9;
            ...
            if (z12) {
                ...
                canvas2.drawRect(i15, this.q, i15 + this.k, r4 + this.l, bz0Var.getHeaderPaint());
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.drawRect(i15, this.q, this.k + i15, r1 + this.l, bz0Var.getStripPaint());
            }
        }
        if (z10 && this.b != null) {
            canvas2.save();
            canvas2.translate(b(), c());
            if (this.r >= 0 && (k9Var = cz0Var.a) != null) {
                k9Var.a0(canvas2, (org.telegram.ui.Cells.j9) cz0Var.getParent().getParent(), this.r);
            }
    ...
    */
    public final void d(int i10, int i11, boolean z10) {
        ...
        if (this.c != null) {
            uy0 uy0Var = this.b;
            if (uy0Var != null) {
                Layout layout = uy0Var.getLayout();
                ...
                if (!z10) {
                    ...
                    cz0 cz0Var = this.s;
                    e(cz0Var.K.createTextLayout(this.c, this.k - (cz0Var.v * 2)));
                    this.m = this.f + cz0Var.r + cz0Var.s;
                }
                f();
            }
            g();
    ...
    public final void e(uy0 uy0Var) {
        this.b = uy0Var;
        Layout layout = uy0Var != null ? uy0Var.getLayout() : null;
        int i10 = 0;
        if (layout == null) {
            this.i = 0;
            this.e = 0;
    ...
    public final void f() {
        ...
        cz0 cz0Var = this.s;
        if (z10) {
            this.g = ((this.k - this.e) - cz0Var.v) + i10;
