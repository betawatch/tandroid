...
public class pz extends f2.i0 {
    ...
    public pz(int i10, int i11, rl0 rl0Var) {
        super(1, false);
        this.I = new SparseArray();
        this.J = -1;
        this.P = true;
