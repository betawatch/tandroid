    ...
    public final boolean onPreDraw() {
        ...
        if (adapter == jv0Var.H || adapter == jv0Var.K || adapter == jv0Var.M || adapter == jv0Var.L) {
            ...
            if (sparseBooleanArray != null) {
                ...
                for (int i13 = 0; i13 < childCount; i13++) {
                    int p5 = jv0.p(wl0Var.getChildAt(i13));
                    if (p5 != 0 && sparseBooleanArray.get(p5, false)) {
                        jv0Var.O1.put(p5, Float.valueOf(0.0f));
                        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                        ofFloat.addUpdateListener(new ci.w4(this, p5, wl0Var));
                        ...
                        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.dt0
        ...
        for (int i14 = 0; i14 < childCount2; i14++) {
            ...
            if (childAt != view && RecyclerView.R(childAt) >= this.d - 1) {
                ...
                ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.dt0
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        switch (i11) {
                            case 0:
            ...
            if (view != null && view.getParent() == null) {
                ...
                if (layoutManager != null) {
                    ...
                    ofFloat3.addListener(new fd0(this, layoutManager));
                    ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.dt0
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            switch (i10) {
                                case 0:
