...
public class QuoteCollapseButton {
    ...
    public float draw(Canvas canvas, RectF rectF, float f, float f2, int i, boolean z, boolean z2) {
        ...
        int dp = (int) (AndroidUtilities.dp(23.66f) + this.text.getCurrentWidth());
        float dp2 = AndroidUtilities.dp(17.66f);
        rectF.set(f - dp, f2 - dp2, f, f2);
        ...
        if (scale > 0.0f) {
            ...
            float f4 = dp3;
            int dp4 = (int) ((rectF.right - AndroidUtilities.dp(3.33f)) - f4);
            float f5 = f4 / 2.0f;
            expandDrawable.setBounds(dp4, (int) ((rectF.centerY() - f5) + AndroidUtilities.dp(0.33f)), (int) (rectF.right - AndroidUtilities.dp(3.33f)), (int) (rectF.centerY() + f5 + AndroidUtilities.dp(0.33f)));
