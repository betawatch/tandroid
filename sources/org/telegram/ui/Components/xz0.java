...
public final class xz0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10 || this.c) {
            ...
            float f12 = a01Var.h;
            rectF.set(f12, f12, getWidth() - a01Var.h, (a01Var.h * AndroidUtilities.dp(this.c ? -1.0f : 1.0f)) + getHeight());
            if (!this.e) {
                rectF.right += a01Var.f;
            }
            ...
            float f13 = a01Var.h;
            canvas2 = canvas;
            canvas2.drawRect(f13, f13, getWidth() - a01Var.h, getHeight() + a01Var.h, a01Var.e);
        }
