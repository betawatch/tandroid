...
public class CheckBoxBase {
    ...
    */
            ...
            if (i12 >= 0) {
                if (this.z) {
                    ...
                    if (this.A == 8) {
                        ...
                        paint2.setColor(AndroidUtilities.getOffsetColor(-1, org.telegram.ui.ActionBar.g6.v0(this.r, this.F), f13, this.m));
                    }
                } else if (this.x != 0) {
                    paint2.setColor(0);
                } else {
                    ...
                    paint2.setColor(AndroidUtilities.getOffsetColor(16777215, org.telegram.ui.ActionBar.g6.v0(i26, this.F), f13, this.m));
                }
                    ...
                    if (i16 != i15 || i16 == i14 || i16 == 8 || i16 == 9 || i16 == 10 || i16 == 14) {
                        ...
                        if (i16 != 12 && i16 != 13) {
                            ...
                            if (f12 > f14) {
                                ...
                                if (this.h < f16 && org.telegram.ui.ActionBar.g6.I.q()) {
                                    paint3.setColor(i0.b.d(this.h, I.getColor(), paint3.getColor()));
                                }
                                if (this.A != -1) {
                                    ...
                                    if (i31 == 12 || i31 == 13) {
                                        ...
                                        if (!z13 || f34 <= 0.0f) {
                                            ...
                                            float f36 = dp3 + f34;
                                            canvas2 = canvas;
                                            canvas2.drawRoundRect(f35, f35, f36, f36, lerp3, lerp3, org.telegram.ui.ActionBar.g6.Il);
                                        }
                                    } else {
                                        canvas2 = canvas;
                                        ...
                                        if (z13 && f37 > 0.0f) {
                                            canvas2.drawCircle(dp3, dp3, f37, org.telegram.ui.ActionBar.g6.Il);
                                        }
                                    }
                ...
                paint2.setColor(AndroidUtilities.getOffsetColor(16777215, org.telegram.ui.ActionBar.g6.v0(i34, this.F), f13, this.m));
            }
            if (this.z) {
            }
            paint = paint2;
    ...
    public final void f(int i10, boolean z10, boolean z11) {
        ...
        this.p = ofFloat;
        ofFloat.addListener(new org.telegram.ui.am(this, 21));
        this.p.setInterpolator(er.g);
