...
public final class s71 {
    ...
    public static s71 d(int i10, TLRPC.Document document, TLRPC.Document document2, int i11, boolean z10) {
        ...
        s71Var.a = i10;
        s71Var.g = document;
        s71Var.c = document.id;
        s71Var.d = a(i10, i11, document);
        if (document2 != null) {
            s71Var.h = document2;
            s71Var.e = document2.id;
            s71Var.f = a(i10, i11, document2);
            ...
            if (pathToAttach == null || !pathToAttach.exists()) {
                ...
                if (pathToAttach2 != null && pathToAttach2.exists()) {
                    s71Var.f = Uri.fromFile(pathToAttach2);
                }
            } else {
                s71Var.f = Uri.fromFile(pathToAttach);
            }
        }
        s71Var.m = lowerCase;
        ...
        if (tL_documentAttributeVideo != null) {
            ...
            s71Var.i = tL_documentAttributeVideo.w;
            s71Var.j = tL_documentAttributeVideo.h;
            s71Var.l = j3 / d;
        }
        File pathToAttach3 = FileLoader.getInstance(i10).getPathToAttach(document, null, false, z10);
        if (pathToAttach3 != null && pathToAttach3.exists()) {
            s71Var.d = Uri.fromFile(pathToAttach3);
            return s71Var;
        }
        ...
        if (pathToAttach4 != null && pathToAttach4.exists()) {
            s71Var.d = Uri.fromFile(pathToAttach4);
        }
        return s71Var;
    }
