...
public abstract class s71 extends View {
    ...
    public s71(Context context) {
        ...
        this.b0 = paint6;
        this.c0 = new c6(0.0f, this, 0L, 200L, qr.j);
        this.d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            q71 q71Var = (q71) this.F.get(i10);
            if (q71Var != null && (bitmap = q71Var.a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public final void d(int i10) {
        ...
        this.G = p71Var;
        p71Var.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, Integer.valueOf(i10), null, null);
    }
        ...
        if (isEmpty && this.G == null) {
            ...
            if (!z10) {
                ...
                while (true) {
                    ...
                    if (((q71) arrayList.get(i10)).a == null) {
                        this.e0 = true;
                        break;
                    }
                    i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                q71 q71Var = (q71) arrayList.get(i12);
                Bitmap bitmap = q71Var.a;
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        int interpolation = (int) (qr.h.getInterpolation(q71Var.b) * 255.0f);
                        Paint paint = this.Q;
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.y != null) {
                    ...
                    if (dp3 != dp && dp2 - dp5 <= x10 && x10 <= dp5 + dp2 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        r71 r71Var = this.E;
                        if (r71Var != null) {
                            ((com.google.android.gms.common.api.internal.v) r71Var).c(2);
                        }
                        this.r = true;
                        this.v = (int) (x10 - dp2);
                        invalidate();
                    ...
                    if (dp - dp4 <= x10 && x10 <= Math.min(dp + dp4, dp3) && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        r71 r71Var2 = this.E;
                        if (r71Var2 != null) {
                            ((com.google.android.gms.common.api.internal.v) r71Var2).c(0);
                        }
                        this.h = true;
                        this.v = (int) (x10 - dp);
                        invalidate();
                    ...
                    if (dp3 - dp4 <= x10 && x10 <= dp4 + dp3 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        r71 r71Var3 = this.E;
                        if (r71Var3 != null) {
                            ((com.google.android.gms.common.api.internal.v) r71Var3).c(1);
                        }
                        this.n = true;
                        this.v = (int) (x10 - dp3);
                        invalidate();
                    ...
                    if (dp <= x10 && x10 <= dp3 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        r71 r71Var4 = this.E;
                        if (r71Var4 != null) {
                            ((com.google.android.gms.common.api.internal.v) r71Var4).c(2);
                        }
                        this.r = true;
                        ...
                        r71 r71Var5 = this.E;
                        if (r71Var5 != null) {
                            com.google.android.gms.common.api.internal.v vVar = (com.google.android.gms.common.api.internal.v) r71Var5;
                ...
                if (this.h) {
                    r71 r71Var6 = this.E;
                    if (r71Var6 != null) {
                        ((com.google.android.gms.common.api.internal.v) r71Var6).d(0);
                    }
                    this.h = false;
                    return true;
                }
                if (this.n) {
                    r71 r71Var7 = this.E;
                    if (r71Var7 != null) {
                        ((com.google.android.gms.common.api.internal.v) r71Var7).d(1);
                    }
                    this.n = false;
                    return true;
                }
                if (this.r) {
                    r71 r71Var8 = this.E;
                    if (r71Var8 != null) {
                        ((com.google.android.gms.common.api.internal.v) r71Var8).d(2);
                    }
                    this.r = false;
                }
                ...
                if (this.r) {
                    ...
                    if (r71Var9 != null) {
                        float f12 = this.s;
                        com.google.android.gms.common.api.internal.v vVar2 = (com.google.android.gms.common.api.internal.v) r71Var9;
                ...
                if (this.h) {
                    ...
                    r71 r71Var10 = this.E;
                    if (r71Var10 != null) {
                        com.google.android.gms.common.api.internal.v vVar3 = (com.google.android.gms.common.api.internal.v) r71Var10;
                        PhotoViewer photoViewer3 = (PhotoViewer) vVar3.d;
                        h71 h71Var = photoViewer3.F2;
                        if (h71Var != null) {
                            if (h71Var.y()) {
                ...
                if (this.n) {
                    ...
                    r71 r71Var11 = this.E;
                    if (r71Var11 != null) {
                        ((com.google.android.gms.common.api.internal.v) r71Var11).f(this.e);
                    }
                    invalidate();
                    return true;
                }
    ...
    public void setDelegate(r71 r71Var) {
        this.E = r71Var;
    }
    ...
    public void setRightProgress(float f7) {
        ...
        r71 r71Var = this.E;
        if (r71Var != null) {
            ((com.google.android.gms.common.api.internal.v) r71Var).c(1);
        }
        r71 r71Var2 = this.E;
        if (r71Var2 != null) {
            ((com.google.android.gms.common.api.internal.v) r71Var2).f(this.e);
        }
        r71 r71Var3 = this.E;
        if (r71Var3 != null) {
            ((com.google.android.gms.common.api.internal.v) r71Var3).d(1);
        }
        invalidate();
    }
}
