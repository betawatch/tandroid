...
public abstract class jb extends FrameLayout {
    ...
    public final void b() {
        ...
        setLayoutParams(h7.z5.e(i10, -2, r2));
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.blurVisibilityDrawable.i = h7.n.b((int) org.telegram.messenger.rl.t(this.inOutOffset, getMeasuredHeight(), 1.0f, 255.0f), 0, 255);
    ...
    public void dispatchDrawImpl(Canvas canvas, boolean z10, int i10) {
        ...
        float h = dbVar.h(this.bulletin.a) - getY();
    ...
    public float getBottomOffset() {
        ...
        ec ecVar;
        o1.j jVar;
        if (this.bulletin == null || !(((dbVar = this.delegate) == null || dbVar.e()) && (jVar = (ecVar = this.bulletin).d) != null && jVar.f)) {
            db dbVar2 = this.delegate;
            if (dbVar2 == null) {
                return 0.0f;
            }
            ec ecVar2 = this.bulletin;
            f10 = dbVar2.f(ecVar2 != null ? ecVar2.a : 0);
        } else {
            f10 = ecVar.o;
        }
        return f10;
