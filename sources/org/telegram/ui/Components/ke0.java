...
public final class ke0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f10 != 1.0f) {
            paint.setColor(te0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
        ...
        int themedColor = te0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            te0 te0Var = this.d;
            if (te0Var.w != 0 && motionEvent.getY() < te0Var.w && te0Var.e.getAlpha() == 0.0f) {
                te0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) te0Var.f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.b = true;
        int dp = AndroidUtilities.dp(80.0f);
        qe0 qe0Var = te0Var.b;
        int i15 = qe0Var.a.B;
        for (int i16 = 0; i16 < i15; i16++) {
            ViewGroup a2 = qe0Var.a(this.c, i16);
        ...
        if (le0Var.getPaddingTop() != i17) {
            le0Var.getPaddingTop();
            le0Var.setPadding(0, i17, 0, 0);
        }
        this.b = false;
