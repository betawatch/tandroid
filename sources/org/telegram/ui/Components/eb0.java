...
public final class eb0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public eb0(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, ArrayList arrayList, int i11) {
        super(context);
        String str;
        ...
        if (arrayList.size() > 1) {
            ...
            for (int i12 = 0; v51VarArr != null && i12 < v51VarArr.length; i12++) {
                int spanStart = replaceTags.getSpanStart(v51VarArr[i12]);
                int spanEnd = replaceTags.getSpanEnd(v51VarArr[i12]);
                replaceTags.removeSpan(v51VarArr[i12]);
        ...
        if (str == null || document == null) {
            ...
            this.f = r90Var;
            r90Var.l = org.telegram.ui.ActionBar.j6.G8;
            r90Var.m = org.telegram.ui.ActionBar.j6.i6;
            r90Var.j(4.0f);
            return;
        }
        SpannableString spannableString = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString.setSpan(new bb0(this, document, this.h.getFontMetricsInt()), 0, spannableString.length(), 33);
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        spannableString.setSpan(new cb0(this, 0), 0, 1, 33);
        SpannableString spannableString2 = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString2.setSpan(new db0(this, document, this.h.getFontMetricsInt()), 0, spannableString2.length(), 33);
