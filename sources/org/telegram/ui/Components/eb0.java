...
public final class eb0 extends jl0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        s1Var.u3(true);
        s1Var.V1(canvas);
        if (s1Var.getCurrentMessagesGroup() == null || ((s1Var.getCurrentPosition() != null && (((s1Var.getCurrentPosition().flags & s1Var.t0()) != 0 && (s1Var.getCurrentPosition().flags & 1) != 0) || (s1Var.getCurrentMessagesGroup() != null && s1Var.getCurrentMessagesGroup().isDocuments))) || s1Var.getTransitionParams().w0)) {
