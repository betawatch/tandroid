...
public final class e91 extends AsyncTask {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:136:0x0282, code lost:
        ...
        r0 = org.telegram.ui.Components.f91.r0.matcher(r4);
     */
    ...
    */
    public final Object doInBackground(Object[] objArr) {
        ...
        boolean z11 = true;
        String c11 = f91.c(this, str5, null, true);
        if (!isCancelled()) {
            ...
            if (c11 != null) {
                Matcher matcher = f91.q0.matcher(c11);
                if (matcher.find()) {
            ...
            while (true) {
                ...
                f91Var2.getClass();
                String c13 = f91.c(this, str7, hashMap, z11);
                if (isCancelled()) {
                    return hashMap;
                }
                if (c13 != null) {
        ...
        String str10 = null;
        if (str10 != null) {
            Matcher matcher2 = f91.x0.matcher(str10);
            if (matcher2.find()) {
            ...
            if (str2 == null) {
                ...
                this.e.getClass();
                obj = null;
                String c14 = f91.c(this, str10, null, true);
                if (!isCancelled()) {
                    if (c14 != null) {
                        Matcher matcher3 = f91.s0.matcher(c14);
                        if (matcher3.find()) {
                            str3 = matcher3.group(1);
                        } else {
                            Matcher matcher4 = f91.t0.matcher(c14);
                            if (matcher4.find()) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                try {
                    AndroidUtilities.runOnUIThread(new l41(6, this, str2 + str3 + "('" + this.d.substring(3) + "');"));
                    this.b.await();
                } catch (Exception e15) {
                    FileLog.e(e15);
                    z15 = true;
