...
public class pk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void a(pk0 pk0Var) {
        ...
        zg.b0 b0Var = new zg.b0(pk0Var.M0, pk0Var.t0, pk0Var.V, pk0Var.d0, pk0Var, pk0Var.k0, pk0Var.a);
        pk0Var.x0 = b0Var;
        ah.c cVar = pk0Var.Z0;
        boolean z10 = true;
        if (cVar != null) {
            dh.e eVar = pk0Var.a1;
            org.telegram.ui.a61 a61Var = b0Var.m.f0;
            a61Var.x = true;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (f23 != 1.0f) {
                ...
                o0Var = this.l0;
                i10 = this.M0;
                if (o0Var != null && i10 != 5 && ((ok0Var = this.g0) == null || ok0Var.j())) {
                    f22 = this.n0;
                    if (f22 != 1.0f) {
                ...
                if (this.v != 0.0f) {
                    ...
                    if (getAlpha() == 1.0f || i18 == 5) {
                        ...
                        while (i19 < w0Var3.getChildCount()) {
                            ...
                            float f34 = f25;
                            if (childAt instanceof nk0) {
                                nk0 nk0Var = (nk0) w0Var3.getChildAt(i19);
                                i14 = i19;
                                if (this.B0 != 0.0f) {
                                    i13 = save3;
                                ...
                                if (o0Var3.equals(this.l0)) {
                                    ...
                                    if (!this.r0) {
                                        if (this.Q == null) {
                                            ...
                                            if (mk0Var3.getImageReceiver().hasBitmapImage() || ((p5Var = mk0Var3.e) != null && (l4Var = p5Var.k) != null && l4Var.hasBitmapImage())) {
                                        ...
                                        if (this.n0 == f21) {
                                            ...
                                            if (System.currentTimeMillis() - this.s0 > 300) {
                                                ...
                                                w0Var2 = w0Var3;
                                                this.g0.h(nk0Var, nk0Var.e, true, false);
                                                canvas2.save();
                                                x10 = nk0Var.getX() + w0Var2.getX();
                                                ...
                                                canvas2.translate(nk0Var.getX() + w0Var2.getX(), nk0Var.getY() + w0Var2.getY());
                                    ...
                                    w0Var2 = w0Var3;
                                    int S2 = RecyclerView.S(nk0Var);
                                    float measuredWidth = (((this.p0 - 1.0f) * nk0Var.getMeasuredWidth()) / 3.0f) - (((1.0f - this.q0) * nk0Var.getMeasuredWidth()) * (Math.abs(this.m0 - S2) - 1));
                                    if (S2 < this.m0) {
                                ...
                                if (!this.N0 && (!nk0Var.r || mk0Var.getImageReceiver().getLottieAnimation() != null)) {
                                    if ((nk0Var.getMeasuredWidth() / f14) + nk0Var.getX() > 0.0f && (nk0Var.getMeasuredWidth() / f14) + nk0Var.getX() < w0Var2.getWidth()) {
                                            ...
                                            if ((childAt.getMeasuredWidth() / f14) + childAt.getX() <= f17 || (childAt.getMeasuredWidth() / f14) + childAt.getX() >= w0Var2.getWidth()) {
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    ...
                                                    if (z11) {
                                                        ...
                                                        ((ValueAnimator) srVar3.b).addUpdateListener(new p70(srVar3, 7));
                                                        ((ValueAnimator) srVar3.b).setStartDelay((long) (abs * ((pk0) srVar3.c).c));
                        ...
                        if (pullingLeftProgress > 0.0f) {
                            ...
                            nk0Var2.setTranslationX(((w0Var.getX() + f36) - clamp2) + (-((i18 == 1 || i18 == 2) ? AndroidUtilities.dp(8.0f) : AndroidUtilities.dp(20.0f))));
    ...
    public final void p(MessageObject messageObject, TLRPC.ChatFull chatFull, boolean z10) {
        ...
        if (q()) {
            ...
            if (i16 < arrayList2.size()) {
                nk0.a(this.z0, (zg.o0) arrayList2.get(i16), -1);
            }
        } else {
        ...
        for (int i18 = 0; i18 < arrayList8.size(); i18++) {
            ...
            arrayList9.add(new gk0(o0Var3.f == null ? 3 : 0, o0Var3));
        }
