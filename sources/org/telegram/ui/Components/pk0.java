...
public class pk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float S0;
    public final org.telegram.ui.dr T;
    public pg.b T0;
    public final fk0 U;
    public pg.b U0;
    ...
    public final org.telegram.ui.ActionBar.f6 h0;
    public mg.q0 i0;
    public int j0;
    public float k0;
    public float l0;
    ...
    public pk0(int i10, int i11, Context context, org.telegram.ui.ActionBar.p2 p2Var, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        org.telegram.ui.dr drVar = new org.telegram.ui.dr((ViewGroup) this, 3);
        this.T = drVar;
        ...
        e1Var.j(new mb0(this, 2));
        e1Var.i(new bk0(this, 1));
        e1Var.setOnItemClickListener(new k(this, 11));
        e1Var.setOnItemLongClickListener((jl0) new gg.m2(this, i10, 8));
    ...
    public static void a(pk0 pk0Var) {
        ...
        mg.d0 d0Var = new mg.d0(pk0Var.J0, pk0Var.q0, pk0Var.S, pk0Var.a0, pk0Var, pk0Var.h0, pk0Var.a);
        pk0Var.u0 = d0Var;
        ng.a aVar = pk0Var.W0;
        boolean z4 = true;
        if (aVar != null) {
            ...
            n51Var.e();
            n51Var.invalidate();
            pg.b c3 = aVar.c(d0Var.a, null, true);
            c3.n(dVar);
            c3.p(AndroidUtilities.dp(12.0f));
            c3.o(AndroidUtilities.dp(8.0f));
            d0Var.z = c3;
        }
        mg.d0 d0Var2 = pk0Var.u0;
        ok0 ok0Var = pk0Var.d0;
        if (ok0Var != null && !ok0Var.i()) {
            z4 = false;
        }
        d0Var2.m.setLongPressEnabled(z4);
        pk0Var.j();
        pk0Var.u0.p = new dc0(pk0Var, 16);
        pk0Var.m();
    }
    ...
    public final void d() {
        ...
        if (d0Var != null) {
            if (!d0Var.q) {
                ...
                int i10 = 0;
                ofFloat.addUpdateListener(new mg.y(d0Var, i10));
                ofFloat.addListener(new mg.b0(d0Var, i10));
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (z4) {
            ...
            if (f24 != 1.0f) {
                ...
                q0Var = this.i0;
                i10 = this.J0;
                if (q0Var != null && i10 != 5 && ((ok0Var = this.d0) == null || ok0Var.i())) {
                    f23 = this.k0;
                    if (f23 != 1.0f) {
                ...
                float f30 = max;
                RectF rectF5 = this.w;
                rectF5.set(getPaddingLeft() + width2, (((1.0f - this.n0) * e1Var3.getMeasuredHeight()) + paddingTop) - g10, (getWidth() - getPaddingRight()) * max, (getHeight() - getPaddingBottom()) + g10);
                ...
                if (this.Z0) {
                    ...
                    if (i10 == 1 || this.d0.o()) {
                        ...
                        f14 = f28;
                        i16 = 1;
                        this.d0.l(canvas, rectF, this.y, getX(), getY(), 255, false);
                        canvas2 = canvas;
                    } else {
                        pg.b bVar = this.T0;
                        Paint paint = this.f;
                    ...
                    if (this.W) {
                        ...
                        while (true) {
                            if (!it.hasNext()) {
                                ...
                                if (this.g1 == null) {
                                    int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Jj, this.h0);
                ...
                if (this.v != 0.0f) {
                    ...
                    if (getAlpha() == 1.0f || i18 == 5) {
                        ...
                        while (i19 < e1Var3.getChildCount()) {
                            ...
                            int abs = (this.v == 1.0f || !SharedConfig.deviceIsHigh()) ? i21 : (int) (Math.abs((((childAt.getMeasuredWidth() / f15) + childAt.getLeft()) / e1Var3.getMeasuredWidth()) - 0.8f) * 200.0f);
                            float f35 = f26;
                            if (childAt instanceof nk0) {
                                nk0 nk0Var = (nk0) e1Var3.getChildAt(i19);
                                i14 = i19;
                                if (this.y0 != 0.0f) {
                                    i13 = save3;
                                    f20 = AndroidUtilities.dp(46.0f) * Utilities.clamp(nk0Var.getLeft() / (getMeasuredWidth() - AndroidUtilities.dp(34.0f)), 1.0f, 0.0f) * getPullingLeftProgress();
                                } else {
                                    i13 = save3;
                                    f20 = 0.0f;
                                }
                                ...
                                if (q0Var3.equals(this.i0)) {
                                    ...
                                    nk0Var.setScaleX(this.m0);
                                    nk0Var.setScaleY(this.m0);
                                    if (!this.o0) {
                                        if (this.N == null) {
                                            mk0Var3.setVisibility(0);
                                            mk0Var3.setAlpha(1.0f);
                                            if (mk0Var3.getImageReceiver().hasBitmapImage() || ((l5Var = mk0Var3.e) != null && (y2Var = l5Var.k) != null && y2Var.hasBitmapImage())) {
                                                mk0Var4.setAlpha(0.0f);
                                            }
                                            f22 = 1.0f;
                                        } else {
                                            f22 = 1.0f;
                                            mk0Var3.setAlpha(1.0f - this.l0);
                                            mk0Var4.setAlpha(this.l0);
                                        }
                                        if (this.k0 == f22) {
                                            this.o0 = true;
                                            if (System.currentTimeMillis() - this.p0 > 300) {
                                                ...
                                                e1Var2 = e1Var3;
                                                this.d0.j(nk0Var, nk0Var.e, true, false);
                                                canvas2.save();
                                                x10 = nk0Var.getX() + e1Var2.getX();
                                                scaleX = ((nk0Var.getScaleX() * nk0Var.getMeasuredWidth()) - nk0Var.getMeasuredWidth()) / f15;
                                                f21 = x10 - scaleX;
                                                if (f21 >= 0.0f && nk0Var.getTranslationX() >= 0.0f) {
                                                    nk0Var.setTranslationX((-f21) - f36);
                                                } else if (nk0Var.getMeasuredWidth() + x10 + scaleX > getMeasuredWidth() || nk0Var.getTranslationX() > 0.0f) {
                                                    nk0Var.setTranslationX(0.0f - f36);
                                                } else {
                                                    nk0Var.setTranslationX((((getMeasuredWidth() - x10) - nk0Var.getMeasuredWidth()) - scaleX) - f36);
                                                }
                                                canvas2.translate(nk0Var.getX() + e1Var2.getX(), nk0Var.getY() + e1Var2.getY());
                                    ...
                                    float measuredWidth = (((this.m0 - 1.0f) * nk0Var.getMeasuredWidth()) / 3.0f) - (((1.0f - this.n0) * nk0Var.getMeasuredWidth()) * (Math.abs(this.j0 - R2) - 1));
                                    if (R2 < this.j0) {
                                        nk0Var.setPivotX(0.0f);
                                        nk0Var.setTranslationX(-measuredWidth);
                                    } else {
                                        nk0Var.setPivotX(nk0Var.getMeasuredWidth() - f36);
                                        nk0Var.setTranslationX(measuredWidth - f36);
                                    }
                                    nk0Var.setPivotY(mk0Var.getY() + mk0Var.getMeasuredHeight());
                                    nk0Var.setScaleX(this.n0);
                                    nk0Var.setScaleY(this.n0);
                                ...
                                if (!this.K0 && (!nk0Var.r || mk0Var.getImageReceiver().getLottieAnimation() != null)) {
                                    if ((nk0Var.getMeasuredWidth() / f15) + nk0Var.getX() > 0.0f && (nk0Var.getMeasuredWidth() / f15) + nk0Var.getX() < e1Var2.getWidth()) {
                                ...
                                e1Var2 = e1Var3;
                                if (childAt == this.O) {
                                    if ((childAt.getMeasuredWidth() / f15) + childAt.getX() <= 0.0f || (childAt.getMeasuredWidth() / f15) + childAt.getX() >= e1Var2.getWidth()) {
                                        eg.s1 s1Var = this.r0;
                                        f18 = 0.0f;
                                        s1Var.setScaleX(0.0f);
                                        s1Var.setScaleY(0.0f);
                                        if (childAt == this.P) {
                                            if ((childAt.getMeasuredWidth() / f15) + childAt.getX() <= f18 || (childAt.getMeasuredWidth() / f15) + childAt.getX() >= e1Var2.getWidth()) {
                                                or orVar = this.s0;
                                                orVar.setScaleX(0.0f);
                                                orVar.setScaleY(0.0f);
                                                ((pk0) orVar.c).P.invalidate();
                                                ValueAnimator valueAnimator = (ValueAnimator) orVar.b;
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    if (this.v != 1.0f) {
                                                        or orVar2 = this.s0;
                                                        orVar2.setScaleX(0.0f);
                                                        orVar2.setScaleY(0.0f);
                                                        ((pk0) orVar2.c).P.invalidate();
                                                        ValueAnimator valueAnimator2 = (ValueAnimator) orVar2.b;
                                                    ...
                                                    orVar3.invalidate();
                                                    ValueAnimator valueAnimator3 = (ValueAnimator) orVar3.b;
                                                    if (valueAnimator3 != null) {
                                                        valueAnimator3.removeAllListeners();
                                                        ((ValueAnimator) orVar3.b).cancel();
                                                    }
                                                    if (z10) {
                                                        ValueAnimator ofFloat = ValueAnimator.ofFloat(orVar3.getScaleX(), 1.0f);
                                                        orVar3.b = ofFloat;
                                                        ofFloat.setInterpolator(AndroidUtilities.overshootInterpolator);
                                                        ((ValueAnimator) orVar3.b).addUpdateListener(new j70(orVar3, 7));
                                                        ((ValueAnimator) orVar3.b).setStartDelay((long) (abs * ((pk0) orVar3.c).c));
                                                        ((ValueAnimator) orVar3.b).setDuration(300L);
                                                        ((ValueAnimator) orVar3.b).start();
                                                    } else {
                                                        orVar3.setScaleX(1.0f);
                                                        orVar3.setScaleY(1.0f);
                                                    }
                                                    abs += 30;
                                                }
                                        ...
                                        if (!hashSet.contains(childAt)) {
                                            if (this.v != 1.0f) {
                                                eg.s1 s1Var2 = this.r0;
                                                f19 = 0.0f;
                                                s1Var2.setScaleX(0.0f);
                                                s1Var2.setScaleY(0.0f);
                                            } else {
                                                f19 = 0.0f;
                                            }
                                            eg.s1 s1Var3 = this.r0;
                                            org.telegram.ui.Components.voip.h hVar = s1Var3.G;
                                            if (hVar != null) {
                                                hVar.g = f19;
                                                hVar.j = false;
                                            }
                                            s1Var3.invalidate();
                                            s1Var3.animate().scaleX(1.1f).scaleY(1.1f).setStartDelay(abs).setInterpolator(AndroidUtilities.overshootInterpolator).setDuration(300L);
                                            abs += 30;
                                        }
                                        hashSet2.add(childAt);
                                    }
                        ...
                        if (pullingLeftProgress > 0.0f) {
                            ...
                            int measuredWidth3 = nk0Var2.getMeasuredWidth() - AndroidUtilities.dp(f15);
                            float f37 = i20 + measuredWidth3;
                            float clamp2 = Utilities.clamp(f37 / (getMeasuredWidth() - nk0Var2.getMeasuredWidth()), 1.0f, 0.0f) * pullingLeftProgress2 * measuredWidth3;
                            ...
                            nk0Var2.setTranslationX(((e1Var.getX() + f37) - clamp2) + (-((i18 == 1 || i18 == 2) ? AndroidUtilities.dp(8.0f) : AndroidUtilities.dp(20.0f))));
                            if (nk0Var2.getVisibility() != 0) {
                                nk0Var2.setVisibility(0);
                            }
                        } else {
                            if (nk0Var2.getVisibility() != 8 && this.L0) {
        ...
        lh.e1 e1Var32 = this.b;
        float f292 = f12;
        float f302 = max;
        RectF rectF52 = this.w;
        rectF52.set(getPaddingLeft() + width22, (((1.0f - this.n0) * e1Var32.getMeasuredHeight()) + paddingTop2) - g102, (getWidth() - getPaddingRight()) * max, (getHeight() - getPaddingBottom()) + g102);
    ...
    public final void f(float f10, float f11, float f12, int i10, Canvas canvas) {
        ...
        RectF rectF = this.w;
        if (z4) {
            canvas.clipRect(0.0f, 0.0f, getMeasuredWidth(), (AndroidUtilities.lerp(rectF.top, getMeasuredHeight(), mr.f.getInterpolation(this.L)) - ((int) Math.ceil((1.0f - this.v) * (rectF.height() / 2.0f)))) + 1.0f);
        } else {
            float f14 = rectF.bottom;
            mr mrVar = mr.f;
            canvas.clipRect(0.0f, (AndroidUtilities.lerp(f14, 0.0f, mrVar.getInterpolation(this.L)) - ((int) Math.ceil((1.0f - this.v) * (rectF.height() / 2.0f)))) - 1.0f, getMeasuredWidth(), AndroidUtilities.lerp(AndroidUtilities.dp(8.0f) + getMeasuredHeight(), getPaddingTop() - g(), mrVar.getInterpolation(this.L)));
        }
        ...
        if (o10) {
            ...
            f13 = f10;
            this.d0.l(canvas, rectF2, f13, getX(), getY(), i10, false);
        } else {
            f13 = f10;
            if (this.U0 != null) {
        ...
        boolean z11 = this.I;
        float f23 = this.C;
        float lerp = AndroidUtilities.lerp(z11 ? (getPaddingTop() - g()) - AndroidUtilities.dp(16.0f) : ((getHeight() - f23) - f16) + g(), (f23 + f16) - g(), mr.f.getInterpolation(this.L));
        ...
        if (this.d0.o()) {
            ...
            this.d0.l(canvas, rectF2, f12, getX(), getY(), i10, false);
    ...
    public final void h(ArrayList arrayList) {
        ...
        if (!this.B0 || i11 == 4) {
            if (i11 != 3) {
                ...
                while (i10 < enabledReactionsList2.size()) {
                    arrayList.add(mg.q0.c(enabledReactionsList2.get(i10)));
                    i10++;
                }
                return;
            }
            ...
            while (i10 < savedReactions.size()) {
                mg.q0 d = mg.q0.d(savedReactions.get(i10));
        ...
        if (i11 == 3) {
            ...
            if (savedReactionTags != null) {
                for (int i14 = 0; i14 < savedReactionTags.tags.size(); i14++) {
                    mg.q0 d10 = mg.q0.d(savedReactionTags.tags.get(i14).reaction);
            ...
            for (int i15 = 0; i15 < savedReactions2.size(); i15++) {
                mg.q0 d11 = mg.q0.d(savedReactions2.get(i15));
            ...
            for (int i16 = 0; i16 < savedReactions2.size(); i16++) {
                mg.q0 d12 = mg.q0.d(savedReactions2.get(i16));
        ...
        if (i11 != 3 || UserConfig.getInstance(this.G).isPremium()) {
            ...
            for (int i17 = 0; i17 < recentReactions.size(); i17++) {
                mg.q0 d13 = mg.q0.d(recentReactions.get(i17));
            ...
            while (i10 < enabledReactionsList3.size()) {
                mg.q0 c10 = mg.q0.c(enabledReactionsList3.get(i10));
    ...
    public final void p(MessageObject messageObject, TLRPC.ChatFull chatFull, boolean z4) {
        ...
        while (i15 < arrayList2.size()) {
            if (hashSet.contains(arrayList2.get(i15))) {
                ...
                hashSet.add((mg.q0) arrayList2.get(i15));
            }
            i15++;
        }
        ...
        if (q()) {
            ...
            while (i16 < Math.min(arrayList2.size(), dp)) {
                arrayList5.add((mg.q0) arrayList2.get(i16));
                i16++;
            }
            if (i16 < arrayList2.size()) {
                nk0.a(this.w0, (mg.q0) arrayList2.get(i16), -1);
            }
        } else {
        ...
        for (int i17 = 0; i17 < arrayList5.size(); i17++) {
            if (((mg.q0) arrayList5.get(i17)).g != 0) {
                this.D0 = false;
            }
        }
        ...
        for (int i18 = 0; i18 < arrayList8.size(); i18++) {
            mg.q0 q0Var3 = (mg.q0) arrayList8.get(i18);
            arrayList9.add(new gk0(q0Var3.f == null ? 3 : 0, q0Var3));
        }
        ...
        for (int i19 = 0; i19 < messageObject.messageOwner.reactions.results.size(); i19++) {
            if (messageObject.messageOwner.reactions.results.get(i19).chosen) {
                this.a0.add(mg.q0.d(messageObject.messageOwner.reactions.results.get(i19).reaction));
            }
        }
    }
    ...
    public void setChatScrimView(no noVar) {
        this.a1 = noVar;
    }
    ...
    public void setCustomEmojiReactionsBackground(boolean z4) {
        if (z4) {
            this.s0.setBackground(org.telegram.ui.ActionBar.j6.h0(AndroidUtilities.dp(28.0f), 0, i0.a.k(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.i6, false), 40)));
        } else {
    ...
    public void setHint(CharSequence charSequence) {
        ...
        if (this.O0 == null) {
            ...
            org.telegram.ui.ActionBar.f6 f6Var = this.h0;
            ...
            if (i10 == 1 || i10 == 2 || i10 == 4) {
                ...
                this.O0.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.z6, f6Var));
            }
    ...
    public void setParentLayout(no noVar) {
        this.G0 = noVar;
    }
    ...
    public void setSelectedEmojis(ArrayList<String> arrayList) {
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.b, (h5.d) new ak0(this, 0));
    }
    ...
    public void setTransitionProgress(float f10) {
        ...
        if (noVar != null) {
            ...
            noVar.setReactionsTransitionProgress(f10);
        }
        invalidate();
    }
