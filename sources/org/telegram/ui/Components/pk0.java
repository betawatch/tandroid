...
public class pk0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void a(pk0 pk0Var) {
        ...
        if (aVar != null) {
            qg.d dVar = pk0Var.X0;
            org.telegram.ui.g51 g51Var = d0Var.m.c0;
            g51Var.x = true;
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (z4) {
            ...
            if (f24 != 1.0f) {
                ...
                q0Var = this.i0;
                i10 = this.J0;
                if (q0Var != null && i10 != 5 && ((ok0Var = this.d0) == null || ok0Var.h())) {
                    f23 = this.k0;
                    if (f23 != 1.0f) {
                ...
                if (this.Z0) {
                    ...
                    if (i10 == 1 || this.d0.s()) {
                        ...
                        f14 = f28;
                        i16 = 1;
                        this.d0.n(canvas, rectF, this.y, getX(), getY(), 255, false);
                        canvas2 = canvas;
                    } else {
                        pg.b bVar = this.T0;
                        Paint paint = this.f;
                                    ...
                                    if (!this.o0) {
                                        ...
                                        if (this.k0 == f22) {
                                            ...
                                            if (System.currentTimeMillis() - this.p0 > 300) {
                                                ...
                                                e1Var2 = e1Var3;
                                                this.d0.i(nk0Var, nk0Var.e, true, false);
                                                canvas2.save();
                                    ...
                                    if ((childAt.getMeasuredWidth() / f15) + childAt.getX() <= 0.0f || (childAt.getMeasuredWidth() / f15) + childAt.getX() >= e1Var2.getWidth()) {
                                        ...
                                        if (childAt == this.P) {
                                            if ((childAt.getMeasuredWidth() / f15) + childAt.getX() <= f18 || (childAt.getMeasuredWidth() / f15) + childAt.getX() >= e1Var2.getWidth()) {
                                                pr prVar = this.s0;
                                                prVar.setScaleX(0.0f);
                                                prVar.setScaleY(0.0f);
                                                ((pk0) prVar.c).P.invalidate();
                                                ValueAnimator valueAnimator = (ValueAnimator) prVar.b;
                                                ...
                                                if (!hashSet.contains(childAt)) {
                                                    if (this.v != 1.0f) {
                                                        pr prVar2 = this.s0;
                                                        prVar2.setScaleX(0.0f);
                                                        prVar2.setScaleY(0.0f);
                                                        ((pk0) prVar2.c).P.invalidate();
                                                        ValueAnimator valueAnimator2 = (ValueAnimator) prVar2.b;
                                                    ...
                                                    prVar3.invalidate();
                                                    ValueAnimator valueAnimator3 = (ValueAnimator) prVar3.b;
                                                    if (valueAnimator3 != null) {
                                                        valueAnimator3.removeAllListeners();
                                                        ((ValueAnimator) prVar3.b).cancel();
                                                    }
                                                    if (z10) {
                                                        ValueAnimator ofFloat = ValueAnimator.ofFloat(prVar3.getScaleX(), 1.0f);
                                                        prVar3.b = ofFloat;
                                                        ofFloat.setInterpolator(AndroidUtilities.overshootInterpolator);
                                                        ((ValueAnimator) prVar3.b).addUpdateListener(new i70(prVar3, 7));
                                                        ((ValueAnimator) prVar3.b).setStartDelay((long) (abs * ((pk0) prVar3.c).c));
                                                        ((ValueAnimator) prVar3.b).setDuration(300L);
                                                        ((ValueAnimator) prVar3.b).start();
                                                    } else {
                                                        prVar3.setScaleX(1.0f);
                                                        prVar3.setScaleY(1.0f);
                                                    }
                                                    abs += 30;
                                                }
    ...
    public final void f(float f10, float f11, float f12, int i10, Canvas canvas) {
        ...
        RectF rectF = this.w;
        if (z4) {
            canvas.clipRect(0.0f, 0.0f, getMeasuredWidth(), (AndroidUtilities.lerp(rectF.top, getMeasuredHeight(), nr.f.getInterpolation(this.L)) - ((int) Math.ceil((1.0f - this.v) * (rectF.height() / 2.0f)))) + 1.0f);
        } else {
            float f14 = rectF.bottom;
            nr nrVar = nr.f;
            canvas.clipRect(0.0f, (AndroidUtilities.lerp(f14, 0.0f, nrVar.getInterpolation(this.L)) - ((int) Math.ceil((1.0f - this.v) * (rectF.height() / 2.0f)))) - 1.0f, getMeasuredWidth(), AndroidUtilities.lerp(AndroidUtilities.dp(8.0f) + getMeasuredHeight(), getPaddingTop() - g(), nrVar.getInterpolation(this.L)));
        }
        ...
        boolean s6 = this.d0.s();
        float f21 = paddingTop;
        RectF rectF2 = this.V;
        if (s6) {
            rectF2.set(f15, f18, f19, f20);
            f13 = f10;
            this.d0.n(canvas, rectF2, f13, getX(), getY(), i10, false);
        } else {
            f13 = f10;
            if (this.U0 != null) {
        ...
        boolean z11 = this.I;
        float f23 = this.C;
        float lerp = AndroidUtilities.lerp(z11 ? (getPaddingTop() - g()) - AndroidUtilities.dp(16.0f) : ((getHeight() - f23) - f16) + g(), (f23 + f16) - g(), nr.f.getInterpolation(this.L));
        ...
        if (this.d0.s()) {
            ...
            this.d0.n(canvas, rectF2, f12, getX(), getY(), i10, false);
    ...
    public void setTransitionProgress(float f10) {
        ...
        if (ooVar != null) {
            ...
            ooVar.setReactionsTransitionProgress(f10);
        }
        invalidate();
    }
