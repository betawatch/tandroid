...
public class pk0 {
    ...
    public void c(int i10, int i11, boolean z10, boolean z11) {
        ...
        aVar.b = 0;
        of.e eVar = ml0Var.b;
        s4.h0 h0Var3 = ml0Var.w;
        eVar.d(h0Var3, h0Var3);
        ml0Var.t0.f = true;
        ml0Var.e.S();
        eVar.l();
        nk0 nk0Var = h0Var2 instanceof nk0 ? (nk0) h0Var2 : null;
        c0Var.i1(i10, i11, z10);
        if (h0Var2 != null) {
            h0Var2.l();
        }
        ...
        ml0Var.addOnLayoutChangeListener(new mk0(this, h0Var2, arrayList, z12, nk0Var));
    }
    ...
    public pk0(p4.e eVar, p4.v vVar, p4.q qVar, int i10, p4.v vVar2, Collection collection) {
        ...
        eVar.a.postDelayed(new org.telegram.ui.web.t0(this, 8), 15000L);
    }
}
