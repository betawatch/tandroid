...
public final class cd extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        switch (this.a) {
            case 0:
                dd ddVar = (dd) this.c;
                if (ddVar.c <= 1) {
                    ddVar.c(canvas, (Paint) this.b);
                    break;
                } else {
                    ddVar.c(canvas, ddVar.o);
                    break;
                }
            case 1:
                ...
                if (chatActivityEnterView.U0 != null) {
                    ...
                    canvas.drawRect(0.0f, 0.0f, width, y3 + (ofVar == null ? 0.0f : ofVar.getOffsetY()), paint);
                    break;
                }
                break;
            case 2:
            ...
            case 3:
                ...
                m6Var.a.setStrokeWidth(AndroidUtilities.dpf2(0.3f));
    ...
    public void l(float f7, boolean z10) {
        m6 m6Var = (m6) this.c;
        String str = a(f7) + "X";
        if (z10 && TextUtils.equals(m6Var.g, str)) {
            return;
        }
        m6Var.b();
    ...
    public void onBoundsChange(Rect rect) {
        switch (this.a) {
            case 5:
                ((ImageReceiver) this.b).setImageCoords(AndroidUtilities.dp(2.0f) + rect.left, AndroidUtilities.dp(2.0f) + rect.top, org.telegram.messenger.vl.w(2.0f, rect.left, rect.right - AndroidUtilities.dp(2.0f)), org.telegram.messenger.vl.w(2.0f, rect.top, rect.bottom - AndroidUtilities.dp(2.0f)));
                break;
            default:
