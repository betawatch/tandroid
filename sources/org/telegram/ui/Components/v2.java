    ...
    public final void run(Object obj) {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = ((em) this.b).v;
                chatAttachAlertPhotoLayout.r0(null, null, ((Long) obj).longValue());
                chatAttachAlertPhotoLayout.b.dismiss();
                break;
            case 3:
                MessagesController.getInstance(((ps) this.b).K).openApp((TLRPC.User) obj, 0);
                break;
            case 4:
                ((vt) this.b).performMenuAction(((Integer) obj).intValue());
                break;
            case 5:
                ...
                break;
            case 6:
                ((da0) this.b).S.Y0(((Integer) obj).intValue() + 8);
                break;
            case 7:
                ...
                xa0 xa0Var = wb0Var.f;
                if (((tb0) arrayList.get(xa0Var.getCurrentPosition())).a != num.intValue()) {
                    int i10 = 0;
                    int i11 = 0;
                    while (true) {
            ...
            case 8:
                ...
                if (vd0Var.getContext() != null) {
                    boolean z4 = vd0Var.getContext().getResources().getConfiguration().orientation == 2;
                    ...
                    if (SharedConfig.passcodeType == 1) {
                        ...
                        if (intValue <= AndroidUtilities.dp(20.0f)) {
                            ...
                            height = (((vd0Var.getHeight() - intValue) / 2.0f) - (frameLayout.getHeight() / (z4 ? 1.0f : 2.0f))) - frameLayout.getTop();
                        }
                        ViewPropertyAnimator duration = animate.translationY(height).setDuration(320L);
                        nr nrVar = nr.h;
                        duration.setInterpolator(nrVar).start();
                        vd0Var.F.animate().alpha(intValue > AndroidUtilities.dp(20.0f) ? 0.0f : 1.0f).setDuration(320L).setInterpolator(nrVar);
                        break;
                    }
                }
                break;
