    ...
    */
    public h11(i11 i11Var, ArrayList arrayList, Runnable runnable) {
        ...
        if (arrayList.size() > 0 && (((View) arrayList.get(0)).getParent() instanceof wl0)) {
            ...
            if (wl0Var2.getParent() instanceof org.telegram.ui.pm) {
                org.telegram.ui.pm pmVar2 = (org.telegram.ui.pm) wl0Var2.getParent();
                org.telegram.ui.wn chatActivity = pmVar2.getChatActivity();
                ...
                while (i19 < 3) {
                    ...
                    if (i19 != 2 || wl0Var2.X1) {
                        ...
                        while (i27 < arrayList7.size()) {
                            ...
                            transitionParams4.cell.B1(canvas, (int) f23, (int) f20, (int) f24, (int) f21, transitionParams4.pinnedTop, transitionParams4.pinnedBotton, false, pmVar.getKeyboardHeight());
