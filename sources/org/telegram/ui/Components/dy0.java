...
public abstract class dy0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final long a() {
        ...
        for (int i10 = 0; i10 < this.b.length; i10++) {
            ...
            cy0 cy0Var = this.b[i10];
            if (cy0Var != null && (cy0Var.c || f7 > 0)) {
                if (f7 <= 0) {
                    f7 = cy0Var.e;
                }
                j3 += f7;
    ...
    public final void c(boolean z10) {
        ...
        for (int i11 = 0; i11 < cy0VarArr.length; i11++) {
            ...
            if (cy0Var2 != null && (cy0Var2.c || f12 > 0)) {
                this.y++;
            }
            if (cy0Var2 == null || (!(z11 = cy0Var2.c) && f12 <= 0)) {
                this.d[i11] = 0.0f;
            } else {
                if (f12 <= 0) {
                    f12 = cy0Var2.e;
        ...
        if (f10 > 1.0f) {
            float f14 = 1.0f / f10;
            for (int i12 = 0; i12 < cy0VarArr.length; i12++) {
                if (cy0VarArr[i12] != null) {
                    float[] fArr = this.d;
        ...
        if (!z10) {
            System.arraycopy(this.d, 0, this.c, 0, cy0VarArr.length);
            return;
        }
        System.arraycopy(this.c, 0, this.e, 0, cy0VarArr.length);
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (cy0Var != null) {
                ...
                if (f18 != 0.0f) {
                    if (cy0Var.d) {
                        ...
                        cy0Var.b.setColor(org.telegram.ui.ActionBar.i6.w0(null, cy0Var.a, z11));
            ...
            if (cy0Var2 != null) {
                ...
                if (f20 != 0.0f) {
                    if (cy0Var2.d) {
                        ...
                        cy0Var2.b.setColor(org.telegram.ui.ActionBar.i6.w0(null, cy0Var2.a, false));
        ...
        if (this.x != null) {
            ...
            this.w.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.j5, false));
            this.x.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.v != null) {
            ...
            this.x = jw0.d(charSequence, textPaint, size, false, size, 1);
        }
        if (imageReceiver != null) {
