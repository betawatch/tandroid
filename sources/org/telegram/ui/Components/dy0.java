...
public final class dy0 extends ul0 {
    ...
    public final void l() {
        ...
        if (hy0Var.W != null) {
            ...
            this.h = 0;
            this.n = 0;
            for (int i12 = 0; i12 < hy0Var.W.size(); i12++) {
                TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) hy0Var.W.get(i12);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList == null) {
            ...
            if (c1Var.f != 3) {
                ...
                g8Var.d(tL_messages_stickerSet.documents.get(i10), null, hy0Var.S, null, hy0Var.h0, hy0Var.R);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 == 1) {
                ...
                FrameLayout by0Var = new by0(context);
                ...
                w7.c6.a(view);
                by0Var.addView(view, w7.a6.e(56, 56, 17));
                frameLayout = by0Var;
            }
