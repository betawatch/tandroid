...
public final class x90 extends qv0 {
    ...
    public /* synthetic */ x90(org.telegram.ui.ActionBar.p2 p2Var, Context context, FrameLayout frameLayout, int i10) {
        super(context, null);
        this.t0 = i10;
        this.v0 = p2Var;
        this.u0 = frameLayout;
    ...
    public void L(Canvas canvas, ArrayList arrayList) {
        switch (this.t0) {
            case 0:
                ((da0) this.v0).S.Q(canvas, arrayList);
                break;
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.t0) {
            case 0:
                da0 da0Var = (da0) this.v0;
                aa0 aa0Var = da0Var.S;
                if (aa0Var != null && (qt0Var = (qt0VarArr = aa0Var.h0)[0]) != null && qt0Var.h.getFastScroll() != null && qt0VarArr[0].h.getFastScroll().n) {
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        switch (this.t0) {
            ...
            case 2:
                ...
                og1 og1Var = (og1) this.v0;
                if (og1Var.b0.getVisibility() == 8 || R() < AndroidUtilities.dp(20.0f)) {
                    if (og1Var.b0.getVisibility() != 8) {
                ...
                og1Var.b0.layout(0, measuredHeight2, getMeasuredWidth(), AndroidUtilities.dp(230.0f) + measuredHeight2);
                break;
            default:
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.t0) {
            case 0:
                ...
                kVar = ((org.telegram.ui.ActionBar.p2) da0Var).actionBar;
                ...
                kVar2 = ((org.telegram.ui.ActionBar.p2) da0Var).actionBar;
                ...
                ((FrameLayout.LayoutParams) da0Var.y.getLayoutParams()).topMargin = org.telegram.ui.b.x(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
            ...
            default:
                ...
                og1Var.b0.measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(230.0f), TLObject.FLAG_30));
                break;
        }
    }
}
