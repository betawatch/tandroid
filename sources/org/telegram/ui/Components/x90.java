...
public final class x90 extends v7.i0 {
    ...
    public static void C(w90 w90Var, List list, int i10) {
        String str;
        ad.a aVar = w90Var.a;
        ArrayList arrayList = w90Var.c;
        String str2 = aVar.a;
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        i11++;
                        boolean z10 = obj instanceof w90;
                        if (z10) {
                            w90 w90Var2 = (w90) obj;
                            if ("summary".equalsIgnoreCase(w90Var2.a.a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(w90Var2.c, sb2);
                                String trim = sb2.toString().trim();
                                pageblockdetails.title = trim.isEmpty() ? new TL_iv.textEmpty() : ba0.j(trim);
                            }
                        }
                        if (obj instanceof v90) {
                            arrayList2.add(((v90) obj).a);
                        } else if (z10) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof v90) {
                TL_iv.PageBlock pageBlock = ((v90) obj).a;
                if (pageBlock instanceof TL_iv.pageBlockParagraph) {
                    if (sb2.length() > 0) {
                        sb2.append('\n');
                    }
                    sb2.append(ba0.l(((TL_iv.pageBlockParagraph) pageBlock).text));
                } else if (pageBlock instanceof TL_iv.pageBlockHeader) {
                    if (sb2.length() > 0) {
                        sb2.append('\n');
                    }
                    sb2.append(ba0.l(((TL_iv.pageBlockHeader) pageBlock).text));
    ...
    public final void a(bf.b bVar) {
        for (TL_iv.RichText richText : ba0.b(ba0.a(bVar, null))) {
    ...
    public final void b(bf.c cVar) {
        ...
        for (bf.p pVar = (bf.p) cVar.c; pVar != null; pVar = (bf.p) pVar.f) {
            if (pVar instanceof bf.o) {
                ...
                tL_pageListItemText.text = ba0.d(ba0.a(pVar, pageblocklist));
    ...
    public final void f(bf.h hVar) {
        ...
        pageblockpreformatted.text = ba0.d(ba0.j(hVar.k));
        String str = hVar.j;
        if (str == null) {
            str = "";
        }
    ...
    public final void j(bf.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = ba0.d(ba0.j(lVar.g));
    ...
    public final void k(bf.n nVar) {
        if (!(nVar instanceof we.a)) {
            ...
            pageblockparagraph.text = ba0.c(((zc.a) nVar).g);
    ...
    */
            ...
            if (pVar instanceof bf.o) {
                if (z10) {
                    ...
                    if (!arrayDeque.isEmpty()) {
                        ...
                        tL_pageListOrderedItemText.text = ba0.d(ba0.a(pVar, pageblockorderedlist));
                ...
                tL_pageListOrderedItemText2.text = ba0.d(ba0.a(pVar, pageblockorderedlist));
    ...
    public final void n(bf.r rVar) {
        for (TL_iv.RichText richText : ba0.b(ba0.a(rVar, null))) {
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.c.add(new v90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        while (i10 < size) {
            ...
            i10++;
            v90 v90Var = (v90) obj;
            hashMap.put(Integer.valueOf(v90Var.b), v90Var);
        }
        ...
        while (it.hasNext()) {
            ...
            if (num2 != null && num3.intValue() > num2.intValue()) {
                ...
                if (intValue2 - intValue == 1 && hashMap.containsKey(num2)) {
                    arrayList5.add((v90) hashMap.get(num2));
                } else {
                    String trim = sb2.substring(intValue, intValue2).trim();
                    if (!trim.isEmpty()) {
                        TL_iv.pageBlockParagraph pageblockparagraph = new TL_iv.pageBlockParagraph();
                        pageblockparagraph.text = ba0.d(ba0.j(trim));
                        arrayList5.add(new v90(intValue, pageblockparagraph));
                    }
                }
            }
            num2 = num3;
        ...
        w90 w90Var = new w90(null, ConnectionsManager.DEFAULT_DATACENTER_ID);
        ArrayDeque arrayDeque = new ArrayDeque();
        arrayDeque.push(w90Var);
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).b <= v90Var2.b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.b;
                if (i15 >= v90Var2.b) {
                    while (arrayDeque.peek() != w90Var && ((w90) arrayDeque.peek()).b <= i16) {
                        arrayDeque.pop();
                    }
                    w90 w90Var2 = new w90(aVar4, aVar4.d);
                    ((w90) arrayDeque.peek()).c.add(w90Var2);
                    arrayDeque.push(w90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != w90Var && ((w90) arrayDeque.peek()).b <= v90Var2.b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = v90Var2.a;
            ((w90) arrayDeque.peek()).c.add(v90Var2);
        }
        A(0, w90Var.c, this.a);
    }
}
