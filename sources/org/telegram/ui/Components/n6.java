...
public final class n6 extends eb {
    public n6(LaunchActivity launchActivity, org.telegram.ui.pa0 pa0Var) {
        super(launchActivity, null);
        org.telegram.ui.Cells.q qVar = new org.telegram.ui.Cells.q(getContext());
        TextView textView = new TextView(getContext());
        addView(qVar, g7.e6.i(30.0f, 30.0f, 8388627, 12.0f, 8.0f, 12.0f, 8.0f));
        ...
        qVar.setImageDrawable(launchActivity.getDrawable(pa0Var.b));
        ...
        org.telegram.messenger.ll.q(R.string.AppIconChangedTo, new Object[]{LocaleController.getString(pa0Var.d)}, textView);
    }
}
