    ...
    */
    ...
    public final void q(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        l6 l6Var = new l6(this) { // from class: org.telegram.ui.Components.i6
            ...
            public final void c(CharSequence charSequence3) {
                switch (i12) {
                    case 0:
                        n6 n6Var2 = this.b;
                        k6 k6Var2 = new k6(n6Var2, n6Var2.h(i16 - ((int) Math.ceil(n6Var2.d)), charSequence3), n6Var2.d, -1);
                    ...
                    default:
                        n6 n6Var3 = this.b;
                        k6 k6Var3 = new k6(n6Var3, n6Var3.h(i16 - ((int) Math.ceil(n6Var3.h)), charSequence3), n6Var3.h, -1);
        ...
        if (this.F) {
            ...
            if (this.A) {
                ...
                for (int i19 = 0; i19 <= min; i19++) {
                    int length = (m6Var2.length() - i19) - 1;
                    int length2 = (m6Var.length() - i19) - 1;
                    int i20 = (length < 0 || length2 < 0 || !j(length, length2, m6Var2, m6Var)) ? 0 : 1;
                    if (i14 != i20 || i19 == min) {
                        int i21 = i19 - i18;
                        if (i21 > 0) {
                ...
                while (size >= 0) {
                    ...
                    if ((size % 2 == 0 ? 1 : 0) == i17) {
                        ...
                        if (m6Var2.length() > m6Var.length()) {
                            eaVar.c(m6Var2.subSequence(length3, length3 + intValue));
                        } else {
                            eaVar.c(m6Var.subSequence(length4, length4 + intValue));
                        }
                    } else {
                        i11 = size;
                        int i22 = length3 + intValue;
                        i(l6Var, m6Var2.subSequence(length3, i22), length3, i22);
                        int i23 = length4 + intValue;
                        i(l6Var2, m6Var.subSequence(length4, i23), length4, i23);
                    }
                    length3 += intValue;
                    length4 += intValue;
                    size = i11 - 1;
                ...
                boolean z13 = true;
                while (i24 <= min) {
                    boolean z14 = i24 < min && j(i24, i24, m6Var2, m6Var);
                    if (z13 != z14 || i24 == min) {
                        if (i24 - i25 > 0) {
                            if (z13) {
                                i(eaVar, m6Var2.subSequence(i25, i24), i25, i24);
                            } else {
                                i(l6Var, m6Var2.subSequence(i25, i24), i25, i24);
                                i(l6Var2, m6Var.subSequence(i25, i24), i25, i24);
                            }
                        }
                        i25 = i24;
                        z13 = z14;
            ...
            boolean z15 = true;
            while (i26 <= min2) {
                boolean z16 = i26 < min2 && j(i26, i27, m6Var2, m6Var);
                if (z15 != z16 || i26 == min2) {
                    if (i26 == min2) {
                        i26 = m6Var2.length();
                        i27 = m6Var.length();
                    ...
                    if (i30 > 0 || i31 > 0) {
                        if (i30 == i31 && z17) {
                            eaVar.c(m6Var2.subSequence(i28, i26));
                        } else {
                            if (i30 > 0) {
                                i(l6Var, m6Var2.subSequence(i28, i26), i28, i26);
                            }
                            if (i31 > 0) {
                                i(l6Var2, m6Var.subSequence(i29, i27), i29, i27);
                            }
                        }
                    }
                    i28 = i26;
        ...
        if (this.j != null) {
            ...
            while (true) {
                k6[] k6VarArr2 = this.j;
                if (i32 >= k6VarArr2.length) {
                    break;
                }
                k6 k6Var2 = k6VarArr2[i32];
                n6 n6Var2 = k6Var2.g;
        ...
        this.o.addListener(new org.telegram.ui.Cells.v5(this, 18));
    ...
    public final void s(int i10, boolean z10) {
        ...
        this.S = ofFloat;
        ofFloat.addUpdateListener(new bi.z5(this, this.a.getColor(), i10, 2));
