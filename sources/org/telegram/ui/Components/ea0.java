...
public final class ea0 extends org.telegram.ui.ActionBar.p2 implements ru0, zf.b, NotificationCenter.NotificationCenterDelegate {
    ...
    public final List B() {
        ...
        return Arrays.asList(new zf.a((parentActivity.getSharedPreferences("shapedetector_conf", 0).getBoolean("learning", false) ? "Disable" : "Enable").concat(" shape detector learning debug"), new up(this, 26)));
    }
    ...
    public final void M() {
        qu0 qu0Var;
        ba0 ba0Var = this.S;
        if (ba0Var != null && (qu0Var = this.b) != null) {
            ba0Var.setNewMediaCounts(qu0Var.c);
        }
        a0();
    }
    ...
    */
    public final void a0() {
        ...
        if (ba0Var != null) {
            ...
            int closestTab = ba0Var.getClosestTab();
            int i10 = this.a;
            if (i10 != 3 || closestTab == 8) {
                ...
                if (g1Var3 != null) {
                    ba0 ba0Var2 = this.S;
                    qt0[] qt0VarArr = ba0Var2.h0;
                    if (qt0VarArr != null && (qt0Var = qt0VarArr[0]) != null) {
                        boolean p02 = yu0.p0(qt0Var.C);
                        int i12 = ba0Var2.j1[p02 ? 1 : 0];
                        if (i12 != ba0Var2.X(p02 ? 1 : 0, i12, true)) {
                            z4 = true;
                ...
                if (this.D != null) {
                    ba0 ba0Var3 = this.S;
                    boolean z12 = ba0Var3.c0(ba0Var3.getClosestTab()) <= 0;
                    if (!z12) {
                        this.D.setVisibility(0);
                    }
                    this.D.animate().alpha(z12 ? 0.0f : 1.0f).withEndAction(new jh.f(25, this, z12)).setDuration(220L).setInterpolator(mr.h).start();
                }
                ph.d dVar = this.Q;
                if (dVar != null) {
    ...
    */
    public final View createView(Context context) {
        ...
        y90 y90Var = new y90(this, context, frameLayout, 0);
        y90Var.K = true;
        this.fragmentView = y90Var;
        y90Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.a7));
        ...
        if (i13 == 1 || i13 == 2) {
            ...
            this.E.setOnClickListener(new a80(n10, 2));
            ...
            final int i16 = 0;
            this.D.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.w90
                ...
                public final void onClick(View view) {
                    ...
                    switch (i18) {
                        case 0:
                            ea0Var.D.M(null, null);
                            break;
                        case 1:
                            Boolean w12 = ea0Var.S.w1(null, null);
                            if (w12 != null) {
                                boolean booleanValue = w12.booleanValue();
                                ea0Var.N.setEnabled(true);
                                ea0Var.N.animate().alpha(ea0Var.N.isEnabled() ? 1.0f : 0.5f).start();
                                ea0Var.M.setEnabled(booleanValue);
                                ea0Var.M.animate().alpha(ea0Var.M.isEnabled() ? 1.0f : 0.5f).start();
                                break;
                            }
                            break;
                        case 2:
                            Boolean x12 = ea0Var.S.x1(null, null);
                            if (x12 != null) {
                                ea0Var.N.setEnabled(x12.booleanValue());
                                ea0Var.N.animate().alpha(ea0Var.N.isEnabled() ? 1.0f : 0.5f).start();
                                ea0Var.M.setEnabled(true);
                                ea0Var.M.animate().alpha(ea0Var.M.isEnabled() ? 1.0f : 0.5f).start();
                                break;
                            }
                            break;
                        case 3:
                            ...
                            if (z4 && !ea0Var.J) {
                                ...
                                org.telegram.ui.ActionBar.g1 g1Var = ea0Var.G;
                                int i19 = -ea0Var.K;
                                ea0Var.K = i19;
                                AndroidUtilities.shakeViewSpring(g1Var, i19);
                                break;
                            } else {
                                org.telegram.ui.ActionBar.g1 g1Var2 = ea0Var.G;
                                boolean z10 = !z4;
                                ea0Var.I = z10;
                                g1Var2.setChecked(z10);
                                ba0 ba0Var2 = ea0Var.S;
                                boolean z11 = ea0Var.I;
                                boolean z12 = ea0Var.J;
                                ft0 ft0Var = ba0Var2.W;
                                if (ft0Var != null && (l6Var2 = ft0Var.s) != null) {
                                    l6Var2.n = z11;
                                    l6Var2.o = z12;
                                    l6Var2.d(true);
                                }
                                mr0 mr0Var = ba0Var2.b0;
                            ...
                            break;
                        case 4:
                            boolean z13 = ea0Var.J;
                            if (z13 && !ea0Var.I) {
                                BotWebViewVibrationEffect.APP_ERROR.vibrate();
                                org.telegram.ui.ActionBar.g1 g1Var3 = ea0Var.H;
                                int i20 = -ea0Var.K;
                                ea0Var.K = i20;
                                AndroidUtilities.shakeViewSpring(g1Var3, i20);
                                break;
                            } else {
                                org.telegram.ui.ActionBar.g1 g1Var4 = ea0Var.H;
                                boolean z14 = !z13;
                                ea0Var.J = z14;
                                g1Var4.setChecked(z14);
                                ba0 ba0Var3 = ea0Var.S;
                                boolean z15 = ea0Var.I;
                                boolean z16 = ea0Var.J;
                                ft0 ft0Var2 = ba0Var3.W;
                                if (ft0Var2 != null && (l6Var4 = ft0Var2.s) != null) {
                                    l6Var4.n = z15;
                                    l6Var4.o = z16;
                                    l6Var4.d(true);
                                }
                                mr0 mr0Var2 = ba0Var3.b0;
                        ...
                        default:
                            ea0 ea0Var2 = this.b;
                            lh.r5 r5Var = ea0Var2.R;
                            if (r5Var != null) {
                                r5Var.run();
                                ea0Var2.R = null;
                            }
                            ic.e();
                            boolean z17 = ea0Var2.S.getClosestTab() == 9;
                            ArrayList arrayList = new ArrayList();
                            if (ea0Var2.F != null) {
                                i17 = 0;
                                for (int i21 = 0; i21 < ea0Var2.F.size(); i21++) {
                                    TL_stories.StoryItem storyItem = ((MessageObject) ea0Var2.F.valueAt(i21)).storyItem;
                                    if (storyItem != null) {
                            ...
                            if (!arrayList.isEmpty()) {
                                ...
                                ea0Var2.getMessagesController().getStoriesController().n0(ea0Var2.e, arrayList, false);
                                boolean[] zArr2 = {false};
                                ea0Var2.R = new lh.r5(ea0Var2, arrayList, z17, 15);
                                org.telegram.ui.kh khVar = new org.telegram.ui.kh(ea0Var2, zArr2, arrayList, zArr, 18);
                                (z17 ? qc.a0(ea0Var2).K(R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i17, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), khVar).j() : qc.a0(ea0Var2).I(R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i17, new Object[0]), LocaleController.getString("Undo"), 5000, false, khVar).j()).v = new z80(2, ea0Var2, zArr2);
                                break;
                            }
                            break;
                    }
            ...
            this.M = e;
            final int i17 = 1;
            e.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.w90
                public final /* synthetic */ ea0 b;
                    ...
                    switch (i18) {
                        ...
                        default:
                            ...
                            if (!arrayList.isEmpty()) {
                                ...
                                ea0Var2.R = new lh.r5(ea0Var2, arrayList, z17, 15);
                                org.telegram.ui.kh khVar = new org.telegram.ui.kh(ea0Var2, zArr2, arrayList, zArr, 18);
                                (z17 ? qc.a0(ea0Var2).K(R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i172, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), khVar).j() : qc.a0(ea0Var2).I(R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i172, new Object[0]), LocaleController.getString("Undo"), 5000, false, khVar).j()).v = new z80(2, ea0Var2, zArr2);
                                break;
                            }
                            break;
                    }
            ...
            this.N = e6;
            final int i18 = 2;
            e6.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.w90
                public final /* synthetic */ ea0 b;
            ...
            d.setChecked(this.I);
            final int i19 = 3;
            this.G.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.w90
                public final /* synthetic */ ea0 b;
            ...
            final int i20 = 4;
            this.H.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.w90
                public final /* synthetic */ ea0 b;
        ...
        this.y = z90Var;
        z90Var.getImageReceiver().setAllowDecodeSingleFrame(true);
        ...
        if (this.a == 1) {
            da0 da0Var = new da0(context, getResourceProvider());
            this.O = da0Var;
            da0Var.setOnTabClick(new v2(this, 6));
            ...
            final int i25 = 5;
            this.Q.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.w90
                public final /* synthetic */ ea0 b;
                ...
                public final void onClick(View view) {
                    ...
                    switch (i182) {
                        ...
                        default:
                            ...
                            if (ea0Var2.F != null) {
                                i172 = 0;
                                for (int i212 = 0; i212 < ea0Var2.F.size(); i212++) {
                                    TL_stories.StoryItem storyItem = ((MessageObject) ea0Var2.F.valueAt(i212)).storyItem;
                                    if (storyItem != null) {
                                        arrayList.add(storyItem);
                                        i172++;
                                    }
        ...
        ba0 ba0Var2 = new ba0(this, context, this.e, this.b, this.c, this.d, this.T, this, new aa0(this), getResourceProvider(), frameLayout, y90Var);
        this.S = ba0Var2;
        ba0Var2.F0.setOpen(true);
        if (this.S.getSearchOptionsItem() != null) {
        ...
        int i26 = this.a;
        if (i26 == 1 || i26 == 2) {
            y90Var.addView(this.S, k7.b6.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 64.0f));
        } else {
            y90Var.addView(this.S);
        }
        y90Var.addView(this.actionBar);
        y90Var.addView(frameLayout);
        y90Var.Q.add(this.S);
        if (this.a == 1) {
            Y(0, false, false);
            Y(1, false, false);
        ...
        if (da0Var2 != null) {
            i10 = -1;
            y90Var.addView(da0Var2, k7.b6.e(-1, -2, 87));
        } else {
            i10 = -1;
        }
        FrameLayout frameLayout6 = this.P;
        if (frameLayout6 != null) {
            y90Var.addView(frameLayout6, k7.b6.e(i10, 64, 87));
        }
        long j10 = this.e;
            ...
            if (i27 != 1) {
                if (j10 == UserObject.ANONYMOUS) {
                    ...
                    if (this.f == 0 || j10 != getUserConfig().getClientUserId()) {
                        ...
                        ba0Var = this.S;
                        if (ba0Var.s0(ba0Var.h0[0].C) && this.a != 1) {
                        ...
                        this.actionBar.setDrawBlurBackground(y90Var);
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        ...
        ba0 ba0Var = this.S;
        return ba0Var.getSelectedTab() == ba0Var.F0.getFirstTabId();
    }
