...
public final class ru0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ru0(org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        if (p2Var instanceof rg) {
            ...
            if (a2 != p2Var.getUserConfig().getClientUserId()) {
                p2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a2, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.qu0
                    ...
                    public final void run(Object obj) {
                        ...
                        switch (i11) {
                            case 0:
                                ru0 ru0Var = this.b;
                                ArrayList arrayList = ru0Var.x;
                                boolean booleanValue = bool.booleanValue();
                                ru0Var.f = booleanValue;
                                ru0Var.h = true;
                                if (booleanValue) {
                                    int size = arrayList.size();
                                    for (int i12 = 0; i12 < size; i12++) {
                                        ((su0) arrayList.get(i12)).M();
                                    }
                                    break;
                                }
                                break;
                            default:
                                ru0 ru0Var2 = this.b;
                                ArrayList arrayList2 = ru0Var2.x;
                                boolean booleanValue2 = bool.booleanValue();
                                ru0Var2.f = booleanValue2;
                                ru0Var2.h = true;
                                if (booleanValue2) {
                                    int size2 = arrayList2.size();
                                    for (int i13 = 0; i13 < size2; i13++) {
                                        ((su0) arrayList2.get(i13)).M();
                                    }
                                    break;
                                }
                                break;
            ...
            if (profileActivity.e1) {
                ...
                if (a10 != p2Var.getUserConfig().getClientUserId()) {
                    p2Var.getMessagesController().getSavedMessagesController().hasSavedMessages(a10, new Utilities.Callback(this) { // from class: org.telegram.ui.Components.qu0
                        public final /* synthetic */ ru0 b;
        ...
        int i12 = 0;
        while (true) {
            ou0[] ou0VarArr = this.n;
            if (i12 >= ou0VarArr.length) {
                break;
            }
            ou0VarArr[i12] = new ou0();
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
                ...
                for (int i24 = 0; i24 < arrayList.size(); i24++) {
                    ...
                    if (!messageObject.isEphemeral()) {
                        ...
                        if ((j12 == 0 || j12 == MessageObject.getTopicId(currentAccount, messageObject.messageOwner, true)) && MessageObject.getMedia(messageObject.messageOwner) != null && !messageObject.needDrawBluredPreview() && (mediaType = MediaDataController.getMediaType(messageObject.messageOwner)) != -1 && ((mediaType != 0 || this.n[0].q != 2 || messageObject.isVideo()) && (mediaType != 0 || this.n[0].q != 1 || !messageObject.isVideo()))) {
                            ou0 ou0Var = this.n[mediaType];
                            if (ou0Var.l) {
                                ou0Var.a(messageObject, i23, true, isEncryptedDialog);
                            }
                            if (this.s == 0) {
                            ...
                            if (i23 == 0) {
                                for (int i25 = 0; i25 < this.n[mediaType].e.size(); i25++) {
                                    ((wt0) this.n[mediaType].e.get(i25)).b++;
                                }
                            }
                        }
                    }
        ...
        if (i10 != NotificationCenter.messageReceivedByServer) {
            ...
            if (i10 == NotificationCenter.messagesDeleted) {
                ...
                for (int i28 = 0; i28 < size3; i28++) {
                    ...
                    while (true) {
                        ou0[] ou0VarArr = this.n;
                        if (i29 < ou0VarArr.length) {
                            MessageObject b10 = ou0VarArr[i29].b(((Integer) arrayList3.get(i28)).intValue(), 0);
                            if (b10 != null) {
            ...
            if (i10 != NotificationCenter.replaceMessagesObjects) {
                ...
                if (i10 == NotificationCenter.fileLoaded) {
                    ...
                    int i34 = 0;
                    while (true) {
                        ou0[] ou0VarArr2 = this.n;
                        if (i34 >= ou0VarArr2.length) {
                            break;
                        }
                        arrayList4.addAll(ou0VarArr2[i34].a);
                        i34++;
                    }
            ...
            if (longValue8 == j14 || longValue8 == this.v) {
                ...
                while (i37 < size6) {
                    ...
                    if (j15 == 0 || topicId == j15) {
                        int i38 = 0;
                        while (true) {
                            ou0[] ou0VarArr3 = this.n;
                            if (i38 >= ou0VarArr3.length) {
                                break;
                            }
                            MessageObject messageObject3 = (MessageObject) ou0VarArr3[i38].b[i36].get(id2);
        ...
        while (true) {
            ou0[] ou0VarArr4 = this.n;
            if (i17 >= ou0VarArr4.length) {
                return;
            }
            ou0VarArr4[i17].f(i41, num.intValue(), num2.intValue());
            i17++;
        }
    }
}
