...
public final class ma0 extends org.telegram.ui.ActionBar.n2 implements ev0, mg.b, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void M() {
        dv0 dv0Var;
        ja0 ja0Var = this.V;
        if (ja0Var != null && (dv0Var = this.b) != null) {
            ja0Var.setNewMediaCounts(dv0Var.c);
        }
        a0();
    }
    ...
    */
    public final void a0() {
        ...
        if (ja0Var != null) {
            ...
            int closestTab = ja0Var.getClosestTab();
            int i10 = this.a;
            if (i10 != 3 || closestTab == 8) {
                ...
                if (f1Var3 != null) {
                    ja0 ja0Var2 = this.V;
                    eu0[] eu0VarArr = ja0Var2.k0;
                    if (eu0VarArr != null && (eu0Var = eu0VarArr[0]) != null) {
                        boolean p02 = lv0.p0(eu0Var.F);
                        int i12 = ja0Var2.m1[p02 ? 1 : 0];
                        if (i12 != ja0Var2.X(p02 ? 1 : 0, i12, true)) {
                            z10 = true;
                ...
                if (this.G != null) {
                    ja0 ja0Var3 = this.V;
                    boolean z13 = ja0Var3.c0(ja0Var3.getClosestTab()) <= 0;
                    if (!z13) {
                        this.G.setVisibility(0);
                    }
                    this.G.animate().alpha(z13 ? 0.0f : 1.0f).withEndAction(new bi.f(27, this, z13)).setDuration(220L).setInterpolator(qr.h).start();
                }
                ci.d dVar = this.T;
                if (dVar != null) {
    ...
    */
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new fa0(this));
        FrameLayout frameLayout = new FrameLayout(context);
        ga0 ga0Var = new ga0(this, context, frameLayout, 0);
        ga0Var.N = true;
        this.fragmentView = ga0Var;
        ga0Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.a7));
        ...
        if (i13 == 1 || i13 == 2) {
            ...
            this.G.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ea0
                ...
                public final void onClick(View view) {
                    ...
                    switch (i18) {
                        case 0:
                            ma0Var.G.M(null, null);
                            break;
                        case 1:
                            Boolean w12 = ma0Var.V.w1(null, null);
                            if (w12 != null) {
                                boolean booleanValue = w12.booleanValue();
                                ma0Var.Q.setEnabled(true);
                                ma0Var.Q.animate().alpha(ma0Var.Q.isEnabled() ? 1.0f : 0.5f).start();
                                ma0Var.P.setEnabled(booleanValue);
                                ma0Var.P.animate().alpha(ma0Var.P.isEnabled() ? 1.0f : 0.5f).start();
                                break;
                            }
                            break;
                        case 2:
                            Boolean x12 = ma0Var.V.x1(null, null);
                            if (x12 != null) {
                                ma0Var.Q.setEnabled(x12.booleanValue());
                                ma0Var.Q.animate().alpha(ma0Var.Q.isEnabled() ? 1.0f : 0.5f).start();
                                ma0Var.P.setEnabled(true);
                                ma0Var.P.animate().alpha(ma0Var.P.isEnabled() ? 1.0f : 0.5f).start();
                                break;
                            }
                            break;
                        case 3:
                            boolean z10 = ma0Var.L;
                            if (z10 && !ma0Var.M) {
                                BotWebViewVibrationEffect.APP_ERROR.vibrate();
                                org.telegram.ui.ActionBar.f1 f1Var = ma0Var.J;
                                int i19 = -ma0Var.N;
                                ma0Var.N = i19;
                                AndroidUtilities.shakeViewSpring(f1Var, i19);
                                break;
                            } else {
                                org.telegram.ui.ActionBar.f1 f1Var2 = ma0Var.J;
                                boolean z11 = !z10;
                                ma0Var.L = z11;
                                f1Var2.setChecked(z11);
                                ja0 ja0Var2 = ma0Var.V;
                                boolean z12 = ma0Var.L;
                                boolean z13 = ma0Var.M;
                                tt0 tt0Var = ja0Var2.c0;
                                if (tt0Var != null && (d9Var2 = tt0Var.s) != null) {
                                    d9Var2.n = z12;
                                    d9Var2.o = z13;
                                    d9Var2.d(true);
                                }
                                yr0 yr0Var = ja0Var2.e0;
                            ...
                            break;
                        case 4:
                            boolean z14 = ma0Var.M;
                            if (z14 && !ma0Var.L) {
                                BotWebViewVibrationEffect.APP_ERROR.vibrate();
                                org.telegram.ui.ActionBar.f1 f1Var3 = ma0Var.K;
                                int i20 = -ma0Var.N;
                                ma0Var.N = i20;
                                AndroidUtilities.shakeViewSpring(f1Var3, i20);
                                break;
                            } else {
                                org.telegram.ui.ActionBar.f1 f1Var4 = ma0Var.K;
                                boolean z15 = !z14;
                                ma0Var.M = z15;
                                f1Var4.setChecked(z15);
                                ja0 ja0Var3 = ma0Var.V;
                                boolean z16 = ma0Var.L;
                                boolean z17 = ma0Var.M;
                                tt0 tt0Var2 = ja0Var3.c0;
                                if (tt0Var2 != null && (d9Var4 = tt0Var2.s) != null) {
                                    d9Var4.n = z16;
                                    d9Var4.o = z17;
                                    d9Var4.d(true);
                                }
                                yr0 yr0Var2 = ja0Var3.e0;
                        ...
                        default:
                            ma0 ma0Var2 = this.b;
                            ci.y0 y0Var = ma0Var2.U;
                            if (y0Var != null) {
                                y0Var.run();
                                ma0Var2.U = null;
                            }
                            pc.e();
                            boolean z18 = ma0Var2.V.getClosestTab() == 9;
                            ArrayList arrayList = new ArrayList();
                            if (ma0Var2.I != null) {
                                i17 = 0;
                                for (int i21 = 0; i21 < ma0Var2.I.size(); i21++) {
                                    TL_stories.StoryItem storyItem = ((MessageObject) ma0Var2.I.valueAt(i21)).storyItem;
                                    if (storyItem != null) {
                            ...
                            if (!arrayList.isEmpty()) {
                                ...
                                ma0Var2.getMessagesController().getStoriesController().n0(ma0Var2.e, arrayList, false);
                                boolean[] zArr2 = {false};
                                ma0Var2.U = new ci.y0(ma0Var2, arrayList, z18, 20);
                                org.telegram.ui.ActionBar.n5 n5Var = new org.telegram.ui.ActionBar.n5(ma0Var2, zArr2, arrayList, zArr, 27);
                                (z18 ? xc.a0(ma0Var2).K(R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i17, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), n5Var).j() : xc.a0(ma0Var2).I(R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i17, new Object[0]), LocaleController.getString("Undo"), 5000, false, n5Var).j()).v = new bv(21, ma0Var2, zArr2);
                                break;
                            }
                            break;
                    }
                    ...
                    switch (i18) {
                        ...
                        default:
                            ...
                            if (!arrayList.isEmpty()) {
                                ...
                                ma0Var2.U = new ci.y0(ma0Var2, arrayList, z18, 20);
                                org.telegram.ui.ActionBar.n5 n5Var = new org.telegram.ui.ActionBar.n5(ma0Var2, zArr2, arrayList, zArr, 27);
                                (z18 ? xc.a0(ma0Var2).K(R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i172, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), n5Var).j() : xc.a0(ma0Var2).I(R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i172, new Object[0]), LocaleController.getString("Undo"), 5000, false, n5Var).j()).v = new bv(21, ma0Var2, zArr2);
                                break;
                            }
                            break;
                    }
        ...
        this.y = ha0Var;
        ha0Var.getImageReceiver().setAllowDecodeSingleFrame(true);
        ...
        if (this.a == 1) {
            la0 la0Var = new la0(context, getResourceProvider());
            this.R = la0Var;
            la0Var.setOnTabClick(new x2(this, 6));
                ...
                public final void onClick(View view) {
                    ...
                    switch (i182) {
                        ...
                        default:
                            ...
                            if (ma0Var2.I != null) {
                                i172 = 0;
                                for (int i212 = 0; i212 < ma0Var2.I.size(); i212++) {
                                    TL_stories.StoryItem storyItem = ((MessageObject) ma0Var2.I.valueAt(i212)).storyItem;
                                    if (storyItem != null) {
                                        arrayList.add(storyItem);
                                        i172++;
                                    }
        ...
        ja0 ja0Var2 = new ja0(this, context, this.e, this.b, this.c, this.d, this.W, this, new ia0(this), getResourceProvider(), frameLayout, ga0Var);
        this.V = ja0Var2;
        ja0Var2.I0.setOpen(true);
        if (this.V.getSearchOptionsItem() != null) {
        ...
        int i26 = this.a;
        if (i26 == 1 || i26 == 2) {
            ga0Var.addView(this.V, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 64.0f));
        } else {
            ga0Var.addView(this.V);
        }
        ga0Var.addView(this.actionBar);
        ga0Var.addView(frameLayout);
        ga0Var.T.add(this.V);
        if (this.a == 1) {
            Y(0, false, false);
            Y(1, false, false);
        ...
        if (la0Var2 != null) {
            i10 = -1;
            ga0Var.addView(la0Var2, w7.y5.e(-1, -2, 87));
        } else {
            i10 = -1;
        }
        FrameLayout frameLayout6 = this.S;
        if (frameLayout6 != null) {
            ga0Var.addView(frameLayout6, w7.y5.e(i10, 64, 87));
        }
        long j3 = this.e;
            ...
            if (i27 != 1) {
                if (j3 == UserObject.ANONYMOUS) {
                    ...
                    if (this.f == 0 || j3 != getUserConfig().getClientUserId()) {
                        ...
                        ja0Var = this.V;
                        if (ja0Var.s0(ja0Var.k0[0].F) && this.a != 1) {
                        ...
                        this.actionBar.setDrawBlurBackground(ga0Var);
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        ...
        ja0 ja0Var = this.V;
        return ja0Var.getSelectedTab() == ja0Var.I0.getFirstTabId();
    }
    ...
    public final List z() {
        ...
        return Arrays.asList(new mg.a((parentActivity.getSharedPreferences("shapedetector_conf", 0).getBoolean("learning", false) ? "Disable" : "Enable").concat(" shape detector learning debug"), new xp(this, 27)));
    }
}
