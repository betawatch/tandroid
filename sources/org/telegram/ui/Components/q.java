...
public final class q extends qa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public q(Context context, TL_aicompose.AiComposeTone aiComposeTone, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        e9.rightMargin += i14;
        this.containerView.addView(frameLayout3, e9);
        ...
        g10.setOnClickListener(new gg.f(this, aiComposeTone, c6Var, 16));
        frameLayout3.addView(g10, h7.z5.e(-1, 48, 119));
        this.b0.N(false);
    }
                ...
                ConnectionsManager.getInstance(qVar.currentAccount).sendRequestTyped(gettoneexample, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.Components.o
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        if (aicomposetoneexample == null) {
                            ...
                            qVar2.d0[i11] = aicomposetoneexample;
                            qVar2.b0.N(true);
                        }
                    }
                });
    ...
    public static void S(q qVar, org.telegram.ui.ActionBar.c6 c6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        ...
        if (U != null) {
            mc.a0(U).p(aiComposeTone.emoji_id, LocaleController.getString(R.string.AIEditorToneAddedTitle), LocaleController.formatString(R.string.AIEditorToneAddedText, aiComposeTone.title)).j();
        }
    }
    ...
    public static SpannableStringBuilder V() {
        ...
        for (int i10 = 0; i10 < 5; i10++) {
            ...
            u80 u80Var = new u80(null, dp, 0, null);
