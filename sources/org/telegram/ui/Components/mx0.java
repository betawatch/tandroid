...
public abstract class mx0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final long a() {
        ...
        for (int i10 = 0; i10 < this.b.length; i10++) {
            long f10 = this.B.f(i10);
            lx0 lx0Var = this.b[i10];
            if (lx0Var != null && (lx0Var.c || f10 > 0)) {
                if (f10 <= 0) {
                    f10 = lx0Var.e;
                }
                j10 += f10;
    ...
    public final void c(boolean z10) {
        ...
        for (int i11 = 0; i11 < lx0VarArr.length; i11++) {
            long f13 = this.B.f(i11);
            lx0 lx0Var2 = lx0VarArr[i11];
            if (lx0Var2 != null && (lx0Var2.c || f13 > 0)) {
                this.y++;
            }
            if (lx0Var2 == null || (!(z11 = lx0Var2.c) && f13 <= 0)) {
                this.d[i11] = 0.0f;
            } else {
                if (f13 <= 0) {
                    f13 = lx0Var2.e;
        ...
        if (!z10) {
            System.arraycopy(this.d, 0, this.c, 0, lx0VarArr.length);
            return;
        }
        System.arraycopy(this.c, 0, this.e, 0, lx0VarArr.length);
        ...
        this.A = ofFloat;
        ofFloat.addUpdateListener(new ag.t2(13, this, lx0VarArr));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (lx0Var != null) {
                ...
                if (f19 != 0.0f) {
                    if (lx0Var.d) {
                        float z12 = com.google.android.recaptcha.internal.a.z(f12, this.f, 10.0f, f19 * (-360.0f));
                        if (z12 > 0.0f) {
                            z12 = 0.0f;
                        }
                        lx0Var.b.setColor(org.telegram.ui.ActionBar.g6.w0(null, lx0Var.a, z11));
                        ...
                        if (Math.abs((float) (((3.141592653589793d * width) / 180.0d) * z12)) <= f12) {
                            ...
                            canvas.drawArc(rectF, (-90.0f) - (360.0f * f18), z12, false, this.b[i11].b);
                        }
                    } else {
                        i11 = i12;
                    }
            ...
            if (lx0Var2 != null) {
                ...
                if (f21 != 0.0f) {
                    if (lx0Var2.d) {
                        ...
                        float z13 = com.google.android.recaptcha.internal.a.z(1.0f, this.f, f10, f21 * (-360.0f));
                        if (z13 > 0.0f) {
                            z13 = 0.0f;
                        }
                        lx0Var2.b.setColor(org.telegram.ui.ActionBar.g6.w0(null, lx0Var2.a, false));
                        ...
                        if (Math.abs((float) (z13 * ((width2 * 3.141592653589793d) / 180.0d))) <= 1.0f) {
                            ...
                            canvas.drawArc(rectF, (-90.0f) - (f20 * 360.0f), z13, false, this.b[i13].b);
                            f20 += f11;
                            i13++;
                            i10 = 255;
                            f10 = 10.0f;
        ...
        if (i6Var2 != null) {
            ...
            if (this.n != null) {
                float d11 = i6Var.d() + i6Var2.d() + AndroidUtilities.dp(4.0f);
                ...
                i6Var.setBounds((int) ((width3 + d11) - i6Var.d()), AndroidUtilities.dp(118.0f), getWidth(), AndroidUtilities.dp(148.0f));
            }
            i6Var2.draw(canvas);
            i6Var.draw(canvas);
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (l10 != null) {
            ...
            i12 = org.telegram.messenger.rl.x(110.0f, View.MeasureSpec.getSize(i10), 2);
        ...
        if (l10 != null) {
            ...
            int i13 = textSize + dp;
            i6Var2.setBounds(0, dp, getMeasuredWidth(), i13);
            i6Var.setBounds(0, AndroidUtilities.dp(2.0f) + i13, getMeasuredWidth(), AndroidUtilities.dp(2.0f) + i13 + textSize2);
            i6Var2.b = 17;
            i6Var.b = 17;
        }
        if (this.v != null) {
            ...
            this.x = tv0.d(charSequence, textPaint, size, false, size, 1);
        }
        if (imageReceiver != null) {
    ...
    public void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            if (f10 != 0.0f) {
                ...
                this.D = ofFloat;
                ofFloat.addUpdateListener(new v60(this, 25));
