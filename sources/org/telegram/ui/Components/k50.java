...
public final class k50 implements TextureView.SurfaceTextureListener {
    ...
    public /* synthetic */ k50(Object obj, int i10) {
        this.a = i10;
        this.b = obj;
    }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
        switch (this.a) {
            case 0:
                ...
                if (x50Var.h0 == null && surfaceTexture != null && !x50Var.g0) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.d("InstantCamera start create thread");
                    }
                    x50Var.h0 = new o50(x50Var, surfaceTexture, i10, i11);
                    break;
                }
                break;
            case 1:
    ...
    public final boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        switch (this.a) {
            case 0:
                x50 x50Var = (x50) this.b;
                Camera2Session[] camera2SessionArr = x50Var.q0;
                ...
                if (!x50Var.n0) {
                    ...
                    CameraController.getInstance().close(x50Var.o0, null, null);
                    return true;
                }
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        switch (this.a) {
            case 3:
                b91 b91Var = (b91) this.b;
                if (b91Var.r == 1) {
                    b91Var.n.getViewTreeObserver().addOnPreDrawListener(new org.telegram.ui.Cells.ga(this, 4));
                    b91Var.n.invalidate();
                    break;
                }
                break;
