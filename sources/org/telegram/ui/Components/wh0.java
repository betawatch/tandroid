...
public final class wh0 extends View {
    public int E;
    public float F;
    public int G;
    public boolean H;
    ...
    public wh0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
    ...
    public void setMusicDocument(TLRPC.Document document) {
        ...
        if (TextUtils.isEmpty(str)) {
            if (TextUtils.isEmpty(str2)) {
                ...
                str2 = org.telegram.messenger.z0.h(R.string.AudioUnknownTitle, new StringBuilder(" - "));
            } else {
                str = "";
            }
