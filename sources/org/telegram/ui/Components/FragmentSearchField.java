...
public class FragmentSearchField extends FrameLayout implements FactorAnimator.Target, Theme.Colorable {
    ...
    public void setClipHeight(float f) {
        ...
        this.clipHeight = f;
        invalidate();
        float lerp = AndroidUtilities.lerp(0.75f, 1.0f, this.clipHeight);
        this.editText.setScaleX(lerp);
        this.editText.setScaleY(lerp);
        this.searchIcon.setScaleX(lerp);
        this.searchIcon.setScaleY(lerp);
    ...
    public void onFiltersChanged() {
        ...
        this.animatorSearchIconVisible.setValue(isEmpty, true);
