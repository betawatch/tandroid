...
public class FragmentSearchField extends FrameLayout implements FactorAnimator.Target {
    ...
    public FragmentSearchField(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        editTextBoldCursor.addTextChangedListener(new TextWatcher() { // from class: org.telegram.ui.Components.FragmentSearchField.1
    ...
    public void updateColors() {
        ...
        setBackground(Theme.createRoundRectDrawable(dp, getThemedColor(i, 0.05f)));
    ...
    public void onFactorChanged(int i, float f, float f2, FactorAnimator factorAnimator) {
        float lerp = AndroidUtilities.lerp(0.4f, 1.0f, f);
        this.closeIcon.setScaleX(lerp);
        this.closeIcon.setScaleY(lerp);
