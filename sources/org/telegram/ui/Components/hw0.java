...
public final class hw0 extends o9 implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public final void t() {
        ...
        int i9 = this.C;
        TLRPC.TL_messages_stickerSet stickerSetByName = MediaDataController.getInstance(i9).getStickerSetByName(this.E);
        if (stickerSetByName == null) {
            stickerSetByName = MediaDataController.getInstance(i9).getStickerSetByEmojiOrName(this.E);
        }
        ...
        if (tL_messages_stickerSet != null) {
            ...
            if (size > i10) {
                ...
                svgThumb = document != null ? DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.f6.c7, 0.2f) : null;
                if (svgThumb != null) {
                ...
                if (document == null) {
                    ...
                    this.a.clearImage();
                    MediaDataController.getInstance(i9).loadStickersByEmojiOrName(this.E, false, tL_messages_stickerSet == null);
                    return;
                }
            }
        }
