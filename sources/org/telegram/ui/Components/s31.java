...
public abstract class s31 {
    ...
    public s31(org.telegram.ui.Cells.u1 u1Var, vo0 vo0Var) {
        ...
        final int i10 = 0;
        hj0Var.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.q31
        ...
        hj0Var2.R(u1Var);
        final int i11 = 1;
        hj0Var2.S(19, new Runnable(this) { // from class: org.telegram.ui.Components.q31
            public final /* synthetic */ s31 b;
    ...
    public static boolean g(MessageObject messageObject, long j3, String str) {
        try {
            ...
            if (messageObject2 != null && messageObject2.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new n31(str, messageObject2, j3, 0));
                return true;
            }
            return false;
    ...
    public static void w(final MessageObject messageObject, boolean z10, final org.telegram.ui.Cells.l1 l1Var) {
        ...
        if (!z10) {
            ...
            final int i12 = 1;
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.o31
                @Override // java.lang.Runnable
                public final void run() {
                    int i13 = i12;
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_messages_transcribeAudio, new RequestDelegate() { // from class: org.telegram.ui.Components.p31
