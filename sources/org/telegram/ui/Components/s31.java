...
public final class s31 extends FrameLayout {
    ...
    public s31(u31 u31Var, Context context) {
        ...
        int themedColor = u31Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5);
        String str = u31Var.s;
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.h6.f0(u31Var.getThemedColor(org.telegram.ui.ActionBar.h6.i6), 1, -1));
        ...
        this.b = pkVar;
        pkVar.setTextColor(u31Var.getThemedColor(i10));
        ...
        if (LocaleController.isRTL) {
            ub1Var.addView(q31Var, w7.x5.t(-2, -2, 16, 0, 0, this.d != null ? 3 : 0, 0));
            if (this.d != null) {
            ...
            ub1Var.addView(q31Var, w7.x5.t(-2, -2, 16, this.d != null ? 3 : 0, 0, 0, 0));
        }
