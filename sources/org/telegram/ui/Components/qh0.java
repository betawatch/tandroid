...
public final class qh0 extends View {
    ...
    public qh0(Context context) {
        ...
        this.H = false;
        this.N = new yv0[3];
        e6 e6Var = new e6(this, 0L, 350L, qr.f);
        this.O = e6Var;
    ...
    */
    public final boolean d() {
        ...
        zh0 zh0Var = this.h;
        boolean z10 = false;
        if (zh0Var != null && ((pv0Var = zh0Var.h1) == null || !pv0Var.n)) {
            ...
            if (measuredWidth > 0 && i10 > 0) {
                ...
                for (yv0 yv0Var3 : yv0VarArr) {
                    if (yv0Var3 != null) {
                        yv0Var3.g(ph0Var);
                    }
                }
                if ((E != null && yv0VarArr[0] == null) || (this.x != 0 && E2 != null && yv0VarArr[1] == null)) {
                    z10 = true;
                }
                this.F = z10;
                return true;
            ...
            if (canvas2.isHardwareAccelerated()) {
                if (m01Var != null || getVisibility() != 0 || getAlpha() <= 0.0f) {
                    if (m01Var != null) {
                        ...
                        q5 q5Var = m01Var.e;
                        g(q5Var != null ? q5Var.k : m01Var.a, beginRecording, f15, f10);
