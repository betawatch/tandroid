...
public final class ca extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void a(boolean z10) {
        ...
        if (z10) {
            ...
            this.h.playTogether(ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property3, 0.1f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property2, 0.1f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property, 0.0f), ObjectAnimator.ofFloat(ldVar2, (Property<bi.ld, Float>) property3, 1.0f), ObjectAnimator.ofFloat(ldVar2, (Property<bi.ld, Float>) property2, 1.0f), ObjectAnimator.ofFloat(ldVar2, (Property<bi.ld, Float>) property, 1.0f));
        } else {
            textView.setVisibility(0);
            ldVar.setEnabled(true);
            this.h.playTogether(ObjectAnimator.ofFloat(ldVar2, (Property<bi.ld, Float>) property3, 0.1f), ObjectAnimator.ofFloat(ldVar2, (Property<bi.ld, Float>) property2, 0.1f), ObjectAnimator.ofFloat(ldVar2, (Property<bi.ld, Float>) property, 0.0f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property3, 1.0f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property2, 1.0f), ObjectAnimator.ofFloat(textView, (Property<TextView, Float>) property, 1.0f));
        }
