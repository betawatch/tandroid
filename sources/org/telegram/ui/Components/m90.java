...
public final class m90 extends v7.i0 {
    ...
    public m90(ArrayList arrayList, ArrayDeque arrayDeque) {
        this.a = arrayList;
        this.f = arrayDeque;
    }
    ...
    public static void C(l90 l90Var, List list, int i10) {
        String str;
        ad.a aVar = l90Var.a;
        ArrayList arrayList = l90Var.c;
        String str2 = aVar.a;
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        i11++;
                        boolean z10 = obj instanceof l90;
                        if (z10) {
                            l90 l90Var2 = (l90) obj;
                            if ("summary".equalsIgnoreCase(l90Var2.a.a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(l90Var2.c, sb2);
                                String trim = sb2.toString().trim();
                                pageblockdetails.title = trim.isEmpty() ? new TL_iv.textEmpty() : q90.j(trim);
                            }
                        }
                        if (obj instanceof k90) {
                            arrayList2.add(((k90) obj).a);
                        } else if (z10) {
                            C((l90) obj, arrayList2, i10 + 1);
                        }
                    }
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof k90) {
                TL_iv.PageBlock pageBlock = ((k90) obj).a;
                if (pageBlock instanceof TL_iv.pageBlockParagraph) {
                    if (sb2.length() > 0) {
                        sb2.append('\n');
                    }
                    sb2.append(q90.l(((TL_iv.pageBlockParagraph) pageBlock).text));
                } else if (pageBlock instanceof TL_iv.pageBlockHeader) {
                    if (sb2.length() > 0) {
                        sb2.append('\n');
                    }
                    sb2.append(q90.l(((TL_iv.pageBlockHeader) pageBlock).text));
                } else if (pageBlock instanceof TL_iv.pageBlockSubheader) {
                    if (sb2.length() > 0) {
                        sb2.append('\n');
                    }
                    sb2.append(q90.l(((TL_iv.pageBlockSubheader) pageBlock).text));
                }
            } else if (obj instanceof l90) {
                w(((l90) obj).c, sb2);
            }
    ...
    public final void a(bf.b bVar) {
        for (TL_iv.RichText richText : q90.b(q90.a(bVar, null))) {
    ...
    public final void b(bf.c cVar) {
        ...
        for (bf.p pVar = (bf.p) cVar.c; pVar != null; pVar = (bf.p) pVar.f) {
            if (pVar instanceof bf.o) {
                ...
                tL_pageListItemText.text = q90.d(q90.a(pVar, pageblocklist));
    ...
    public final void f(bf.h hVar) {
        ...
        pageblockpreformatted.text = q90.d(q90.j(hVar.k));
        String str = hVar.j;
        if (str == null) {
            str = "";
        }
    ...
    public final void g(bf.i iVar) {
        TL_iv.RichText d = q90.d(q90.a(iVar, null));
        if (this.c.isEmpty()) {
            this.b = d;
        }
        switch (iVar.g) {
    ...
    public final void j(bf.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = q90.d(q90.j(lVar.g));
    ...
    public final void k(bf.n nVar) {
        if (!(nVar instanceof we.a)) {
            ...
            pageblockparagraph.text = q90.c(((zc.a) nVar).g);
                    ...
                    if (pVar2 instanceof we.f) {
                        ...
                        for (bf.p pVar3 = (bf.p) ((we.f) pVar2).c; pVar3 != null; pVar3 = (bf.p) pVar3.f) {
                            if (pVar3 instanceof we.d) {
                                ...
                                pagetablecell.text = q90.d(q90.a(dVar, null));
    ...
    */
            ...
            if (pVar instanceof bf.o) {
                if (z10) {
                    ...
                    if (!arrayDeque.isEmpty()) {
                        ...
                        tL_pageListOrderedItemText.text = q90.d(q90.a(pVar, pageblockorderedlist));
                ...
                tL_pageListOrderedItemText2.text = q90.d(q90.a(pVar, pageblockorderedlist));
    ...
    public final void n(bf.r rVar) {
        for (TL_iv.RichText richText : q90.b(q90.a(rVar, null))) {
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.c.add(new k90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        while (i10 < size) {
            ...
            i10++;
            k90 k90Var = (k90) obj;
            hashMap.put(Integer.valueOf(k90Var.b), k90Var);
        }
        ...
        while (it.hasNext()) {
            ...
            if (num2 != null && num3.intValue() > num2.intValue()) {
                ...
                if (intValue2 - intValue == 1 && hashMap.containsKey(num2)) {
                    arrayList5.add((k90) hashMap.get(num2));
                } else {
                    String trim = sb2.substring(intValue, intValue2).trim();
                    if (!trim.isEmpty()) {
                        TL_iv.pageBlockParagraph pageblockparagraph = new TL_iv.pageBlockParagraph();
                        pageblockparagraph.text = q90.d(q90.j(trim));
                        arrayList5.add(new k90(intValue, pageblockparagraph));
                    }
                }
            }
            num2 = num3;
        ...
        l90 l90Var = new l90(null, ConnectionsManager.DEFAULT_DATACENTER_ID);
        ArrayDeque arrayDeque = new ArrayDeque();
        arrayDeque.push(l90Var);
        ...
        while (i13 < size3) {
            ...
            i13++;
            k90 k90Var2 = (k90) obj3;
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).b <= k90Var2.b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.b;
                if (i15 >= k90Var2.b) {
                    while (arrayDeque.peek() != l90Var && ((l90) arrayDeque.peek()).b <= i16) {
                        arrayDeque.pop();
                    }
                    l90 l90Var2 = new l90(aVar4, aVar4.d);
                    ((l90) arrayDeque.peek()).c.add(l90Var2);
                    arrayDeque.push(l90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != l90Var && ((l90) arrayDeque.peek()).b <= k90Var2.b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = k90Var2.a;
            ((l90) arrayDeque.peek()).c.add(k90Var2);
        }
        A(0, l90Var.c, this.a);
    }
}
