...
public final class w81 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f6Var == null ? org.telegram.ui.ActionBar.j6.a1() : f6Var.m0()) {
            ...
            Paint F2 = f6Var != null ? f6Var.F("paintChatActionBackgroundDarken") : null;
            if (F2 == null) {
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.em.C(56.0f, this.n, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), TLObject.FLAG_30));
    }
