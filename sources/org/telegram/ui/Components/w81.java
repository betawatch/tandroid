...
public class w81 extends FrameLayout {
    public static final ur0 S = new ur0(1);
    public float E;
    public boolean F;
    public final int G;
    public boolean H;
    ...
    */
    ...
    public final void C(boolean z10) {
        ...
        n81 n81Var = this.L;
        n81Var.getClass();
        if (!(n81Var instanceof org.telegram.ui.e7)) {
            z10 = false;
        }
    ...
    public final ValueAnimator H(View view, float f7) {
        ...
        ofFloat.addUpdateListener(new mx0(this, view, 1));
    ...
    public final v81 n(int i10, boolean z10) {
