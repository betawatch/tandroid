...
public final class h80 extends org.telegram.ui.zn {
    public boolean Nc;
    public final /* synthetic */ boolean Oc;
    public final /* synthetic */ long Pc;
    public final /* synthetic */ i80 Qc;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h80(i80 i80Var, Bundle bundle, boolean z4, long j10) {
        super(bundle);
        this.Qc = i80Var;
        this.Oc = z4;
        this.Pc = j10;
    ...
    public static void Xc(h80 h80Var, long j10, TLRPC.Chat chat) {
        org.telegram.ui.ActionBar.f6 f6Var;
        if (AndroidUtilities.isContextSafe(h80Var.getParentActivity())) {
            Activity parentActivity = h80Var.getParentActivity();
            int i10 = h80Var.currentAccount;
            long j11 = -j10;
            TLRPC.User currentUser = h80Var.getUserConfig().getCurrentUser();
            boolean z4 = chat.admin_rights != null;
            boolean z10 = chat.creator;
            f6Var = ((org.telegram.ui.ActionBar.g3) h80Var.Qc).resourcesProvider;
