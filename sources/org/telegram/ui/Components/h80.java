...
public final class h80 extends org.telegram.ui.ActionBar.f3 {
    ...
    public static void v(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.n2 n2Var, int i10, TLRPC.Peer peer, f80 f80Var) {
        ...
        if (i10 == 0) {
            ...
            Dialog grVar = new gr(n2Var, arrayList, j3, f80Var);
        ...
        d80Var.setOnItemClickListener(new ai.o6(11, h80Var, chat));
        if (i10 != 0) {
        ...
        h80Var.f.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.k5, false));
        if (i10 == 0) {
        ...
        l00 l00Var = new l00(h80Var, context, false);
        h80Var.c = l00Var;
        ((View) l00Var.c).setOnClickListener(new dt(9, h80Var, f80Var));
        if (h80Var.s == 0) {
            viewGroup.addView(l00Var, w7.y5.t(-1, 50, 51, 0, 0, 0, 0));
            l00 l00Var2 = new l00(h80Var, context, true);
            if (ChatObject.isChannelOrGiga(chat)) {
            ...
            ((View) l00Var2.c).setOnClickListener(new f0(h80Var, 29));
