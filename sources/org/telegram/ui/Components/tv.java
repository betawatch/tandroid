...
public class tv extends ViewGroup {
    ...
    public final void c() {
        ...
        if (this.x && this.y) {
            ...
            if (l5Var != null || (this.s == null && this.r == null)) {
                ...
                xv xvVar = this.G;
                if (document != null) {
                    this.w = l5.m(UserConfig.selectedAccount, xvVar.P, document);
                } else {
                    this.w = l5.n(UserConfig.selectedAccount, this.r.longValue(), null, xvVar.P);
                }
                this.w.a(p9Var);
    ...
    public tv(xv xvVar, Context context, TLRPC.Document document) {
        ...
        addView(qvVar);
        int i10 = eg.s1.I;
        rv rvVar = new rv(context, 1, xvVar.v);
        this.f = rvVar;
        rvVar.setAlpha(0.0f);
    ...
    public tv(xv xvVar, Context context, long j10) {
        ...
        addView(y3Var);
        int i10 = eg.s1.I;
        sv svVar = new sv(context, 1, xvVar.v);
        this.f = svVar;
        svVar.setAlpha(0.0f);
