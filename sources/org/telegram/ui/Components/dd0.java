...
public class dd0 extends LinearLayout {
    public static final wr v0 = new wr(0.0f, 0.5f, 0.5f, 1.0f);
    public int E;
    public boolean F;
    public int G;
    public int H;
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.E) {
            ...
            if (strArr != null) {
                ...
                zc0 zc0Var = this.K;
                str = zc0Var != null ? zc0Var.k(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.G;
                    zc0 zc0Var = this.K;
                    str = zc0Var != null ? zc0Var.k(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
