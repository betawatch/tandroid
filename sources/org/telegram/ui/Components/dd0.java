...
public class dd0 extends LinearLayout {
    ...
    public final void b(int i10) {
        ...
        if (i10 < i11 || i10 > this.E) {
            ...
            if (strArr != null) {
                ...
                zc0 zc0Var = this.K;
                str = zc0Var != null ? zc0Var.j(i10) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i10));
            }
        }
    ...
    */
        ...
        if (i10 == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                ...
                if (strArr == null) {
                    int i11 = this.G;
                    zc0 zc0Var = this.K;
                    str = zc0Var != null ? zc0Var.j(i11) : String.format(Locale.getDefault(), "%d", Integer.valueOf(i11));
                } else {
    ...
    public final void l(int i10, boolean z10) {
        ...
        f();
        invalidate();
        if (this.k0 != 0 || (ad0Var = this.J) == null) {
            return;
        }
        ad0Var.n(0);
    }
    ...
    */
    ...
    public dd0(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.n = -1;
        this.r = true;
        this.p0 = new cd0(this);
        setWillNotDraw(false);
        TextView textView = new TextView(getContext());
        this.d = textView;
        textView.setGravity(17);
        this.d.setSingleLine(true);
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.j5, e6Var));
