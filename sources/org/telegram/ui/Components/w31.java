...
public abstract class w31 extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public w31(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        c90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.uf));
    ...
    public static void p(w31 w31Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            org.telegram.messenger.w1.p(bool.booleanValue() ? R.string.TranslationFailedAlert1 : R.string.TranslationFailedAlert2, new vc((FrameLayout) w31Var.containerView, w31Var.resourcesProvider), null);
            s31 s31Var = w31Var.x.e;
    ...
    public static boolean u(w31 w31Var) {
        ...
        for (int i10 = 0; i10 < j31Var.getChildCount(); i10++) {
            if (RecyclerView.S(j31Var.getChildAt(i10)) == 1) {
                f7 += r3.getHeight();
            }
        }
        return f7 >= ((float) ((j31Var.getHeight() - j31Var.getPaddingTop()) - j31Var.getPaddingBottom()));
    }
