...
public final class bi extends qv0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        di diVar2 = liVar.v0;
        om omVar = liVar.n0;
        if ((diVar2 == omVar || (diVar = liVar.w0) == omVar || (diVar2 == liVar.g0 && diVar == null)) && diVar2 != null) {
            canvas.save();
            float f14 = liVar.i2;
            boolean z4 = liVar.d0;
            ah.d dVar3 = liVar.L0;
            ...
            int h = diVar2.h();
            int dp3 = AndroidUtilities.dp(13.0f) + ((int) ((mhVar != null ? mhVar.getAlpha() : 0.0f) * AndroidUtilities.dp(26.0f))) + ((int) (dVar3 != null ? dVar3.getAlpha() * dVar3.getMeasuredHeight() : 0.0f));
            int p12 = liVar.p1(0);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (!(view instanceof di) || view.getAlpha() <= 0.0f) {
            ...
            if (diVar2 != null) {
                int h = diVar2.h();
                int dp5 = AndroidUtilities.dp(13.0f) + ((int) ((mhVar != null ? mhVar.getAlpha() : 0.0f) * AndroidUtilities.dp(26.0f))) + ((int) (dVar != null ? dVar.getAlpha() * dVar.getMeasuredHeight() : 0.0f));
                int p12 = liVar.p1(0);
                i10 = ((org.telegram.ui.ActionBar.g3) liVar).backgroundPaddingTop;
                int i27 = (p12 - i10) - dp5;
                i11 = ((org.telegram.ui.ActionBar.g3) liVar).currentSheetAnimationType;
        ...
        di diVar3 = (di) view;
        int h9 = diVar3.h();
        int dp7 = AndroidUtilities.dp(13.0f) + (mhVar != null ? AndroidUtilities.dp(mhVar.getAlpha() * 26.0f) : 0) + ((int) (dVar != null ? dVar.getAlpha() * dVar.getMeasuredHeight() : 0.0f));
        ...
        di diVar4 = liVar.v0;
        om omVar = liVar.n0;
        boolean z10 = (diVar4 == omVar || (diVar = liVar.w0) == omVar || (diVar4 == liVar.g0 && diVar == null)) ? false : true;
        RectF rectF = this.u0;
        if (z10) {
            drawable = ((org.telegram.ui.ActionBar.g3) liVar).shadowDrawable;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            if (iArr[0] != 0) {
                ...
                mh mhVar = liVar.f1;
                int dp2 = AndroidUtilities.dp(20.0f) + ((i12 - (dp + (mhVar != null ? AndroidUtilities.dp(mhVar.getAlpha() * 26.0f) : 0))) - ((int) (dVar != null ? dVar.getAlpha() * dVar.getMeasuredHeight() : 0.0f)));
                if (!liVar.d0) {
    ...
    */
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (!z10) {
            qn qnVar3 = liVar.j0;
            if (qnVar3 == null || liVar.v0 != qnVar3 || qnVar3.B == null) {
                qn qnVar4 = liVar.k0;
                if (qnVar4 == null || liVar.v0 != qnVar4 || qnVar4.B == null) {
            ...
            if (childAt.getVisibility() != i22) {
                ...
                if (i28 == 1) {
                    ...
                    if (i27 == 16) {
                        ...
                        qhVar = liVar.B0;
                        if ((qhVar == null && qhVar.l(childAt)) || (((thVar = liVar.M0) != null && thVar.l(childAt)) || (((qnVar = liVar.j0) != null && childAt == qnVar.B) || ((qnVar2 = liVar.k0) != null && childAt == qnVar2.B)))) {
        ...
        if (chatAttachAlertPhotoLayout == null || (plVar = chatAttachAlertPhotoLayout.B) == null || plVar.getFastScroll() == null) {
            return;
        }
        chatAttachAlertPhotoLayout.B.getFastScroll().e0 = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + chatAttachAlertPhotoLayout.m1 + (liVar.Z ? (int) (dVar.getAlpha() * dVar.getMeasuredHeight()) : 0);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (liVar.j0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            qn qnVar3 = liVar.j0;
            if (!qnVar3.D && !qnVar3.X0 && !qnVar3.c1 && !qnVar3.e1) {
                biVar.v0 = true;
                qnVar3.a0();
                biVar.v0 = false;
            }
        ...
        if (liVar.k0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            qn qnVar4 = liVar.k0;
            if (!qnVar4.D && !qnVar4.X0 && !qnVar4.c1 && !qnVar4.e1) {
                biVar.v0 = true;
                qnVar4.a0();
                biVar.v0 = false;
            }
        ...
        if (AndroidUtilities.dp(20.0f) >= 0) {
            ...
            if (z4) {
                di diVar = liVar.v0;
                qn qnVar5 = liVar.j0;
                if (diVar == qnVar5 && qnVar5.B != null && qnVar5.e1) {
                    o12 = AndroidUtilities.dp(120.0f);
                } else {
                    qn qnVar6 = liVar.k0;
                    o12 = (diVar == qnVar6 && qnVar6.B != null && qnVar6.e1) ? AndroidUtilities.dp(120.0f) : 0;
                }
            } else {
                o12 = liVar.o1();
            }
        ...
        while (i20 < childCount) {
            ...
            if (childAt == null || childAt.getVisibility() == 8) {
                ...
                if (!qhVar.l(childAt) && !thVar.l(childAt) && (((qnVar = liVar.j0) == null || childAt != qnVar.B) && ((qnVar2 = liVar.k0) == null || childAt != qnVar2.B))) {
