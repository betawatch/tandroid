    ...
    public final void q(boolean z10, boolean z11, String str, long j3, int i10, int i11, boolean z12, boolean z13) {
        ...
        if (niVar == q4Var) {
            if (q4Var.P || this.c != null) {
                ...
                n6Var.setBackground(org.telegram.ui.ActionBar.j6.g0(i10, i0.a.f(i10) >= 0.30000001192092896d ? 301989888 : 385875967));
                if (viVar.D1 != z10) {
                    viVar.D1 = z10;
    ...
    public final void v(TLRPC.User user, String str, ArrayList arrayList) {
        ...
        if (isEmpty) {
            ...
            if (o2Var instanceof org.telegram.ui.bo) {
                ((org.telegram.ui.bo) o2Var).Y.setFieldText("@" + UserObject.getPublicUsername(user) + " " + str);
            }
            viVar.dismiss(true);
            return;
        }
