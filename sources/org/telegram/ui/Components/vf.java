...
public final class vf implements Runnable {
    ...
    public final void run() {
        ...
        if (!chatActivityEnterView.Y0) {
            ...
            mediaController.startRecording(i10, j10, messageObject, threadMessage, T0, i11, true, rnVar != null ? rnVar.C8() : null, chatActivityEnterView.getSendMonoForumPeerId(), chatActivityEnterView.getSendMessageSuggestionParams());
            ...
            gg ggVar = chatActivityEnterView.g1;
            if (ggVar != null) {
                ggVar.h = false;
            }
