...
public final class ka0 extends org.telegram.ui.ActionBar.n2 implements dv0, mg.b, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void M() {
        cv0 cv0Var;
        ha0 ha0Var = this.V;
        if (ha0Var != null && (cv0Var = this.b) != null) {
            ha0Var.setNewMediaCounts(cv0Var.c);
        }
        a0();
    }
    ...
    */
    public final void a0() {
        ...
        if (ha0Var != null) {
            ...
            int closestTab = ha0Var.getClosestTab();
            int i10 = this.a;
            if (i10 != 3 || closestTab == 8) {
                ...
                if (f1Var3 != null) {
                    ha0 ha0Var2 = this.V;
                    du0[] du0VarArr = ha0Var2.k0;
                    if (du0VarArr != null && (du0Var = du0VarArr[0]) != null) {
                        boolean p02 = kv0.p0(du0Var.F);
                        int i12 = ha0Var2.m1[p02 ? 1 : 0];
                        if (i12 != ha0Var2.X(p02 ? 1 : 0, i12, true)) {
                            z10 = true;
                ...
                if (this.G != null) {
                    ha0 ha0Var3 = this.V;
                    boolean z13 = ha0Var3.c0(ha0Var3.getClosestTab()) <= 0;
                    if (!z13) {
    ...
    */
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new da0(this));
        FrameLayout frameLayout = new FrameLayout(context);
        ea0 ea0Var = new ea0(this, context, frameLayout, 0);
        ea0Var.N = true;
        this.fragmentView = ea0Var;
        ea0Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.a7));
        ...
        if (i13 == 1 || i13 == 2) {
            ...
            final int i16 = 0;
            this.G.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ca0
                ...
                public final void onClick(View view) {
                    ...
                    switch (i18) {
                        case 0:
                            ka0Var.G.M(null, null);
                            break;
                        case 1:
                            Boolean w12 = ka0Var.V.w1(null, null);
                            if (w12 != null) {
                                boolean booleanValue = w12.booleanValue();
                                ka0Var.Q.setEnabled(true);
                                ka0Var.Q.animate().alpha(ka0Var.Q.isEnabled() ? 1.0f : 0.5f).start();
                                ka0Var.P.setEnabled(booleanValue);
                                ka0Var.P.animate().alpha(ka0Var.P.isEnabled() ? 1.0f : 0.5f).start();
                                break;
                            }
                            break;
                        case 2:
                            Boolean x12 = ka0Var.V.x1(null, null);
                            if (x12 != null) {
                                ka0Var.Q.setEnabled(x12.booleanValue());
                                ka0Var.Q.animate().alpha(ka0Var.Q.isEnabled() ? 1.0f : 0.5f).start();
                                ka0Var.P.setEnabled(true);
                                ka0Var.P.animate().alpha(ka0Var.P.isEnabled() ? 1.0f : 0.5f).start();
                                break;
                            }
                            break;
                        case 3:
                            boolean z10 = ka0Var.L;
                            if (z10 && !ka0Var.M) {
                                BotWebViewVibrationEffect.APP_ERROR.vibrate();
                                org.telegram.ui.ActionBar.f1 f1Var = ka0Var.J;
                                int i19 = -ka0Var.N;
                                ka0Var.N = i19;
                                AndroidUtilities.shakeViewSpring(f1Var, i19);
                                break;
                            } else {
                                org.telegram.ui.ActionBar.f1 f1Var2 = ka0Var.J;
                                boolean z11 = !z10;
                                ka0Var.L = z11;
                                f1Var2.setChecked(z11);
                                ha0 ha0Var2 = ka0Var.V;
                                boolean z12 = ka0Var.L;
                                boolean z13 = ka0Var.M;
                                st0 st0Var = ha0Var2.c0;
                                if (st0Var != null && (d9Var2 = st0Var.s) != null) {
                                    d9Var2.n = z12;
                                    d9Var2.o = z13;
                                    d9Var2.d(true);
                                }
                                xr0 xr0Var = ha0Var2.e0;
                                if (xr0Var != null && (d9Var = xr0Var.s) != null) {
                                    d9Var.n = z12;
                                    d9Var.o = z13;
                                    d9Var.d(true);
                                    break;
                            ...
                            break;
                        case 4:
                            boolean z14 = ka0Var.M;
                            if (z14 && !ka0Var.L) {
                                BotWebViewVibrationEffect.APP_ERROR.vibrate();
                                org.telegram.ui.ActionBar.f1 f1Var3 = ka0Var.K;
                                int i20 = -ka0Var.N;
                                ka0Var.N = i20;
                                AndroidUtilities.shakeViewSpring(f1Var3, i20);
                                break;
                            } else {
                                org.telegram.ui.ActionBar.f1 f1Var4 = ka0Var.K;
                                boolean z15 = !z14;
                                ka0Var.M = z15;
                                f1Var4.setChecked(z15);
                                ha0 ha0Var3 = ka0Var.V;
                                boolean z16 = ka0Var.L;
                                boolean z17 = ka0Var.M;
                                st0 st0Var2 = ha0Var3.c0;
                                if (st0Var2 != null && (d9Var4 = st0Var2.s) != null) {
                                    d9Var4.n = z16;
                                    d9Var4.o = z17;
                                    d9Var4.d(true);
                                }
                                xr0 xr0Var2 = ha0Var3.e0;
                                if (xr0Var2 != null && (d9Var3 = xr0Var2.s) != null) {
                                    d9Var3.n = z16;
                                    d9Var3.o = z17;
                                    d9Var3.d(true);
                                    break;
                        ...
                        default:
                            ka0 ka0Var2 = this.b;
                            ci.y0 y0Var = ka0Var2.U;
                            if (y0Var != null) {
                                y0Var.run();
                                ka0Var2.U = null;
                            }
                            qc.e();
                            boolean z18 = ka0Var2.V.getClosestTab() == 9;
                            ArrayList arrayList = new ArrayList();
                            if (ka0Var2.I != null) {
                                i17 = 0;
                                for (int i21 = 0; i21 < ka0Var2.I.size(); i21++) {
                                    TL_stories.StoryItem storyItem = ((MessageObject) ka0Var2.I.valueAt(i21)).storyItem;
                                    if (storyItem != null) {
                            ...
                            if (!arrayList.isEmpty()) {
                                ...
                                ka0Var2.getMessagesController().getStoriesController().n0(ka0Var2.e, arrayList, false);
                                boolean[] zArr2 = {false};
                                ka0Var2.U = new ci.y0(ka0Var2, arrayList, z18, 20);
                                org.telegram.ui.ActionBar.n5 n5Var = new org.telegram.ui.ActionBar.n5(ka0Var2, zArr2, arrayList, zArr, 27);
                                (z18 ? xc.a0(ka0Var2).K(R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i17, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), n5Var).j() : xc.a0(ka0Var2).I(R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i17, new Object[0]), LocaleController.getString("Undo"), 5000, false, n5Var).j()).v = new uw(19, ka0Var2, zArr2);
                                break;
                            }
                            break;
                    }
            ...
            this.P = e;
            final int i17 = 1;
            e.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ca0
                public final /* synthetic */ ka0 b;
                    ...
                    switch (i18) {
                        ...
                        default:
                            ...
                            if (!arrayList.isEmpty()) {
                                ...
                                ka0Var2.U = new ci.y0(ka0Var2, arrayList, z18, 20);
                                org.telegram.ui.ActionBar.n5 n5Var = new org.telegram.ui.ActionBar.n5(ka0Var2, zArr2, arrayList, zArr, 27);
                                (z18 ? xc.a0(ka0Var2).K(R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i172, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), n5Var).j() : xc.a0(ka0Var2).I(R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i172, new Object[0]), LocaleController.getString("Undo"), 5000, false, n5Var).j()).v = new uw(19, ka0Var2, zArr2);
                                break;
                            }
                            break;
                    }
            ...
            this.Q = e7;
            final int i18 = 2;
            e7.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ca0
                public final /* synthetic */ ka0 b;
            ...
            d.setChecked(this.L);
            final int i19 = 3;
            this.J.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ca0
                public final /* synthetic */ ka0 b;
            ...
            final int i20 = 4;
            this.K.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ca0
                public final /* synthetic */ ka0 b;
        ...
        while (true) {
            ...
            frameLayoutArr[i22].addView(j5VarArr[i22], w7.y5.d(-2, -2.0f, 51, z10 ? 118.0f : 72.0f, 0.0f, 56.0f, 0.0f));
            p6 p6Var = new p6(context, true, true, true);
            p6VarArr[i22] = p6Var;
            p6Var.b(0.4f, 320L, qr.h);
            p6VarArr[i22].setTextSize(AndroidUtilities.dp(14.0f));
            p6VarArr[i22].setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Pi, false));
        ...
        this.y = fa0Var;
        fa0Var.getImageReceiver().setAllowDecodeSingleFrame(true);
        ...
        if (this.a == 1) {
            ja0 ja0Var = new ja0(context, getResourceProvider());
            this.R = ja0Var;
            ja0Var.setOnTabClick(new y2(this, 6));
            ...
            final int i25 = 5;
            this.T.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.Components.ca0
                public final /* synthetic */ ka0 b;
                ...
                public final void onClick(View view) {
                    ...
                    switch (i182) {
                        ...
                        default:
                            ...
                            if (ka0Var2.I != null) {
                                i172 = 0;
                                for (int i212 = 0; i212 < ka0Var2.I.size(); i212++) {
                                    TL_stories.StoryItem storyItem = ((MessageObject) ka0Var2.I.valueAt(i212)).storyItem;
                                    if (storyItem != null) {
                                        arrayList.add(storyItem);
                                        i172++;
                                    }
        ...
        ha0 ha0Var2 = new ha0(this, context, this.e, this.b, this.c, this.d, this.W, this, new ga0(this), getResourceProvider(), frameLayout, ea0Var);
        this.V = ha0Var2;
        ha0Var2.I0.setOpen(true);
        if (this.V.getSearchOptionsItem() != null) {
        ...
        int i26 = this.a;
        if (i26 == 1 || i26 == 2) {
            ea0Var.addView(this.V, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 64.0f));
        } else {
            ea0Var.addView(this.V);
        }
        ea0Var.addView(this.actionBar);
        ea0Var.addView(frameLayout);
        ea0Var.T.add(this.V);
        if (this.a == 1) {
            Y(0, false, false);
            Y(1, false, false);
        ...
        if (ja0Var2 != null) {
            i10 = -1;
            ea0Var.addView(ja0Var2, w7.y5.e(-1, -2, 87));
        } else {
            i10 = -1;
        }
        FrameLayout frameLayout6 = this.S;
        if (frameLayout6 != null) {
            ea0Var.addView(frameLayout6, w7.y5.e(i10, 64, 87));
        }
        long j3 = this.e;
        ...
        if (i27 == 3) {
            ...
            if (i27 != 1) {
                if (j3 == UserObject.ANONYMOUS) {
                    ...
                    if (this.f == 0 || j3 != getUserConfig().getClientUserId()) {
                        if (DialogObject.isEncryptedDialog(j3)) {
                            TLRPC.EncryptedChat m10 = org.telegram.messenger.q.m(getMessagesController(), j3);
                            h9Var2 = h9Var5;
                            if (m10 != null) {
                        ...
                        ha0Var = this.V;
                        if (ha0Var.s0(ha0Var.k0[0].F) && this.a != 1) {
                        ...
                        du0[] du0VarArr = this.V.k0;
                        i12 = du0VarArr[r10].F;
                        if ((i12 != 0 || kv0.p0(i12) || du0VarArr[r10].F == i11) && this.a != 1) {
                            this.V.r0.setVisibility(r10);
                        } else {
                            this.V.r0.setVisibility(4);
                        }
                        this.actionBar.setDrawBlurBackground(ea0Var);
                ...
                r10 = 0;
                du0[] du0VarArr2 = this.V.k0;
                i12 = du0VarArr2[r10].F;
                if (i12 != 0) {
                }
                this.V.r0.setVisibility(r10);
                this.actionBar.setDrawBlurBackground(ea0Var);
        ...
        r10 = 0;
        du0[] du0VarArr22 = this.V.k0;
        i12 = du0VarArr22[r10].F;
        if (i12 != 0) {
        }
        this.V.r0.setVisibility(r10);
        this.actionBar.setDrawBlurBackground(ea0Var);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        ArrayList arrayList = new ArrayList();
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, y6Var, org.telegram.ui.ActionBar.j6.d6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, y6Var, org.telegram.ui.ActionBar.j6.z8));
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        ...
        ha0 ha0Var = this.V;
        return ha0Var.getSelectedTab() == ha0Var.I0.getFirstTabId();
    }
