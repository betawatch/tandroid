...
public final class m01 {
    ...
    public m01(n01 n01Var, Matrix matrix, Bitmap bitmap, Runnable runnable, Runnable runnable2) {
        ...
        this.i = fArr[0];
        this.j = fArr[1];
        this.t = (int) i7.z5.a(fArr[2], fArr[3], fArr[6], fArr[7]);
        this.u = (int) i7.z5.a(fArr[4], fArr[5], fArr[6], fArr[7]);
        this.o = true;
        matrix2.set(matrix);
        c();
        this.e = runnable;
     ...
     */
    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Object, org.telegram.ui.Components.m01] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public m01(n01 n01Var, ArrayList arrayList, Runnable runnable) {
        jl0 jl0Var;
        org.telegram.ui.km kmVar;
        int i10;
        float f9;
        float f10;
        ...
        if (arrayList.size() > 0 && (((View) arrayList.get(0)).getParent() instanceof jl0)) {
            jl0 jl0Var2 = (jl0) ((View) arrayList.get(0)).getParent();
            if (jl0Var2.getParent() instanceof org.telegram.ui.km) {
                org.telegram.ui.km kmVar2 = (org.telegram.ui.km) jl0Var2.getParent();
                org.telegram.ui.tn chatActivity = kmVar2.getChatActivity();
                    ...
                    if (i19 != 2 || jl0Var2.T1) {
                        ...
                        while (true) {
                            ...
                            if (view2 instanceof org.telegram.ui.Cells.s1) {
                                ...
                                if (view2.getY() <= jl0Var.getHeight() && view2.getY() + view2.getHeight() >= 0.0f) {
                                    i12 = i20;
                        ...
                        while (i27 < arrayList7.size()) {
                            ...
                            f16 = f16 < (chatActivity.o9 - ((float) chatActivity.q9)) - ((float) AndroidUtilities.dp(20.0f)) ? (chatActivity.o9 - chatActivity.q9) - AndroidUtilities.dp(20.0f) : f16;
                            f18 = f18 > ((float) (AndroidUtilities.dp(20.0f) + jl0Var.getMeasuredHeight())) ? AndroidUtilities.dp(20.0f) + jl0Var.getMeasuredHeight() : f18;
                            float f19 = m01Var2.j;
                            float f20 = f16 - f19;
                            float f21 = f18 - f19;
                            float f22 = m01Var2.i;
                            ...
                            if (z11) {
                                ...
                                canvas.scale(groupedMessages.transitionParams.cell.getScaleX(), groupedMessages.transitionParams.cell.getScaleY(), com.google.android.recaptcha.internal.a.A(f24, f23, 2.0f, f23), com.google.android.recaptcha.internal.a.A(f21, f20, 2.0f, f20));
                            } else {
                                z10 = z11;
                                arrayList3 = arrayList7;
                                arrayList4 = arrayList9;
                            ...
                            transitionParams4.cell.B1(canvas, (int) f23, (int) f20, (int) f24, (int) f21, transitionParams4.pinnedTop, transitionParams4.pinnedBotton, false, kmVar.getKeyboardHeight());
                ...
                if (size2 > 0) {
                    for (int i32 = 0; i32 < size2; i32++) {
                        ...
                        b(canvas, s1Var4, 1, s1Var4.getX() - f26, s1Var4.getY() - f25);
                    }
                    arrayList17.clear();
                }
                ...
                if (size3 > 0) {
                    for (int i33 = 0; i33 < size3; i33++) {
                        ...
                        if (s1Var5.getCurrentPosition() != null || s1Var5.getTransitionParams().w0) {
                            b(canvas, s1Var5, 2, s1Var5.getX() - f26, s1Var5.getY() - f25);
                        }
                    }
                    arrayList18.clear();
                }
                ...
                if (size4 > 0) {
                    for (int i34 = 0; i34 < size4; i34++) {
                        ...
                        if (s1Var6.getCurrentPosition() != null || s1Var6.getTransitionParams().w0) {
                            b(canvas, s1Var6, 3, s1Var6.getX() - f26, s1Var6.getY() - f25);
                        }
                    }
                    arrayList11.clear();
                }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public m01(n01 n01Var, View view, float f9, Runnable runnable) {
        this.E = n01Var;
        ...
        this.f = runnable;
        this.e = new fq0(this, 15);
        this.l = 1.5f * f9;
        this.m = 1.15f / (((f9 - 1.0f) / 3.0f) + 1.0f);
