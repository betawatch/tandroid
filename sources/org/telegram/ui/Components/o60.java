...
public final class o60 extends FrameLayout {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        i11 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingTop;
        int i24 = i11 + dp2;
        int i25 = AndroidUtilities.statusBarHeight;
        int i26 = dp + i25;
        int i27 = i24 - i25;
        if (this.b) {
            i19 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingTop;
            int i28 = i19 + i26;
            int i29 = AndroidUtilities.statusBarHeight;
            int i30 = i29 * 2;
            if (i28 < i30) {
                i22 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingTop;
            ...
            i20 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingTop;
            int i31 = i20 + i26;
            int i32 = AndroidUtilities.statusBarHeight;
            if (i31 < i32) {
                i21 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingTop;
                i12 = Math.min(i32, (i32 - i26) - i21);
                drawable = ((org.telegram.ui.ActionBar.f3) c70Var).shadowDrawable;
                drawable.setBounds(0, i26, getMeasuredWidth(), AndroidUtilities.dp(10.0f) + i27 + AndroidUtilities.navigationBarHeight);
                drawable2 = ((org.telegram.ui.ActionBar.f3) c70Var).shadowDrawable;
                drawable2.draw(canvas);
                if (f7 != 1.0f) {
                    org.telegram.ui.ActionBar.j6.t0.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.h5, false));
                    i15 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingLeft;
                    i16 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingTop;
                    float f10 = i16 + i26;
                    int measuredWidth = getMeasuredWidth();
                    i17 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingLeft;
                    float f11 = measuredWidth - i17;
                    i18 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingTop;
                ...
                if (i12 > 0) {
                    ...
                    i14 = ((org.telegram.ui.ActionBar.f3) c70Var).backgroundPaddingLeft;
                ...
                boolean z11 = AndroidUtilities.computePerceivedBrightness(c70Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) <= 0.721f;
                boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(c70Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f;
        ...
        if (AndroidUtilities.computePerceivedBrightness(c70Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) <= 0.721f) {
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(c70Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f) {
        }
        this.c = Boolean.valueOf(z10);
        if (!z10) {
        }
