...
public final class r10 extends LinearLayout {
    ...
    public r10(Context context, int i9) {
        ...
        j3.r0.w(org.telegram.ui.ActionBar.f6.c7, null, false, textView, 1);
        textView.setText(LocaleController.getString(UserConfig.getInstance(i9).isPremium() ? R.string.GalleryAccessAllowAccessTextPremium : R.string.GalleryAccessAllowAccessTextNonPremium));
