...
public final /* synthetic */ class bn0 implements Runnable {
    ...
    public /* synthetic */ bn0(jn0 jn0Var, String str, ArrayList arrayList, ArrayList arrayList2) {
        this.b = jn0Var;
        this.c = str;
        this.d = arrayList;
        this.e = arrayList2;
    ...
    public final void run() {
        switch (this.a) {
            ...
            default:
                jn0 jn0Var2 = this.b;
                kx0 kx0Var = jn0Var2.a;
                if (this.c.equals(jn0Var2.L)) {
                    if (jn0Var2.r == 0) {
                        jn0Var2.N.b(0);
                    }
    ...
    public /* synthetic */ bn0(jn0 jn0Var, ArrayList arrayList, String str, ArrayList arrayList2) {
        this.b = jn0Var;
        this.d = arrayList;
        this.c = str;
        this.e = arrayList2;
