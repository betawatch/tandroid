        ...
        switch (i12) {
                ...
                if (animatorSet2 == null || !animatorSet2.isRunning()) {
                    ...
                    if (chatActivityEnterView.Y2 != null) {
                        if (BuildVars.LOGS_ENABLED) {
                            org.telegram.ui.yh.w(chatActivityEnterView.Y2, new StringBuilder("delete file "));
                        }
            ...
            case 7:
                ...
                if (chatActivityEnterView.j0()) {
                    ...
                    if (chatActivityEnterView.j0 == null) {
                        ...
                        ph.e1 e1Var = dfVar2.c;
                        chatActivityEnterView.getContext();
                        e1Var.setLayoutManager(new f2.i0());
                        ph.e1 e1Var2 = chatActivityEnterView.j0.c;
                        rh.z zVar = new rh.z();
                        zVar.c = new ArrayList();
                        zVar.d = new ArrayList();
                        zVar.e = new ArrayList();
                        chatActivityEnterView.k0 = zVar;
                        e1Var2.setAdapter(zVar);
            ...
            case 8:
                ...
                if (egVar3 != null && !egVar3.k()) {
                    ...
                    egVar4.v1(mgVar, mgVar.a.getText(), true);
                    break;
                }
                break;
            case 9:
            ...
            case 16:
                ...
                if (!chatActivityEnterView4.h5 ? chatActivityEnterView4.getTranslationY() == 0.0f : !chatActivityEnterView4.t0()) {
                    if (chatActivityEnterView4.V2.l() > AndroidUtilities.dp(20.0f)) {
                        int c12 = chatActivityEnterView4.V2.c1();
                    ...
                    if (chatActivityEnterView4.V2.G() != null) {
                        try {
                        ...
                        if (veVar != null) {
                            ...
                            if (peer == null && chatActivityEnterView4.V2.G() != null && !chatActivityEnterView4.V2.G().peers.isEmpty()) {
                                peer = chatActivityEnterView4.V2.G().peers.get(0).peer;
                            }
                            ...
                            ve veVar2 = new ve(chatActivityEnterView4, chatActivityEnterView4.getContext(), chatActivityEnterView4.L2, messagesController, isChannelAndNotMegaGroup, peer2, chatActivityEnterView4.V2.G(), new androidx.car.app.utils.a(chatActivityEnterView4, chatFull, messagesController, 17), chatActivityEnterView4.S3);
                            ...
                            int c13 = chatActivityEnterView4.V2.c1();
                            ...
                            if (measuredHeight < (((i16 * 2) + c13) - ((xnVar4 == null || !xnVar4.isInBubbleMode()) ? AndroidUtilities.statusBarHeight : 0)) - chatActivityEnterView4.n0.p.getMeasuredHeight()) {
                                ...
                                chatActivityEnterView4.n0.o.getLayoutParams().height = ((c13 - i17) - AndroidUtilities.dp(14.0f)) - chatActivityEnterView4.getHeightWithTopView();
                                i11 = i17;
                            }
