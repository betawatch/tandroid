...
public final class om0 extends Dialog {
    ...
    public final void e(y70 y70Var) {
        ...
        y70Var.Q(this.n, eh.b.k(f6Var), false);
        this.w = y70Var;
        this.y = y70Var.A;
    ...
    /* JADX WARN: Type inference failed for: r5v6, types: [android.graphics.Path, org.telegram.ui.Components.h90, org.telegram.ui.Components.uq] */
                            ...
                            if (characterStyle2 == characterStyle) {
                                ...
                                if (!u1Var.C1() || width2 <= 0) {
                                    ...
                                    if (rectF3.height() > 0.0f) {
                                        ...
                                        this.E = new nm0(h90Var2, new int[]{iArr[0] + ((int) f21), iArr[1] + ((int) f14)}, u1Var, iArr, bitmap, rectF3, paint5, paint, makeStaticLayout2);
                                ...
                                this.E = new nm0(h90Var2, new int[]{iArr2[0] + ((int) f21), iArr2[1] + ((int) f14)}, u1Var, iArr2, bitmap, rectF3, paint52, paint, makeStaticLayout22);
