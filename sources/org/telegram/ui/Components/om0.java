...
public abstract class om0 extends HorizontalScrollView {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            pb1Var = this.e;
            if (i11 >= pb1Var.getChildCount()) {
                break;
            }
            if (pb1Var.getChildAt(i11) instanceof fx0) {
        ...
        if (this.d0) {
            height = org.telegram.ui.ai.c(1.0f, this.f0, AndroidUtilities.dp(50.0f), getHeight());
        }
        float f15 = height;
        ...
        if (isInEditMode() || this.x == 0 || this.G < 0) {
            ...
            View view = null;
            View childAt = (floor < 0 || floor >= pb1Var.getChildCount()) ? null : pb1Var.getChildAt(floor);
            if (ceil >= 0 && ceil < pb1Var.getChildCount()) {
                view = pb1Var.getChildAt(ceil);
            }
            float f17 = f15 / 2.0f;
            ...
            float interpolation = mr.i.getInterpolation(this.f0);
        ...
        Paint paint2 = this.E;
        paint2.setColor(i12);
        canvas2.drawRect(0.0f, f15 - this.J, pb1Var.getWidth(), f15, paint2);
    }
    ...
    public final boolean f(MotionEvent motionEvent) {
            ...
            if (this.s != null) {
                ...
                if (i10 != i11) {
                    ...
                    for (int i12 = 0; i12 < pb1Var.getChildCount(); i12++) {
                        pb1Var.getChildAt(i12).setTag(R.id.index_tag, Integer.valueOf(i12));
                    }
                }
        ...
        if (this.R != ceil && e(ceil)) {
            for (int i14 = 0; i14 < pb1Var.getChildCount(); i14++) {
                if (i14 != this.R) {
                    fx0 fx0Var = (fx0) pb1Var.getChildAt(i14);
            ...
            this.R = ceil;
            pb1Var.removeView(this.s);
            pb1Var.addView(this.s, this.R);
            invalidate();
        }
    ...
    public final void h() {
        ...
        if (hashMap != null) {
            ...
            while (it.hasNext()) {
                pb1Var.removeView((View) ((Map.Entry) it.next()).getValue());
            }
            this.n.clear();
        }
    ...
    public final void i(final float f10, final boolean z4) {
        if (this.c0 != z4) {
            ...
            this.e0 = ofFloat;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.jm0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (!z4) {
                        ...
                        float f11 = f10;
                        float childCount2 = (scrollX + f11) / (om0Var.g0 * pb1Var.getChildCount());
                        ...
                        om0Var.i0 = (om0Var.getScrollX() + f11) - f12;
                    }
                    om0Var.f0 = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
            ...
            if (z4) {
                float childCount = this.g0 * pb1Var.getChildCount() * ((getScrollX() + f10) / (this.h0 * pb1Var.getChildCount()));
    ...
    */
    public final void n() {
        ...
        pb1 pb1Var2 = this.e;
        int paddingLeft = (int) ((scrollX - pb1Var2.getPaddingLeft()) / f11);
        int i13 = 1;
        int min = Math.min(pb1Var2.getChildCount(), ((int) Math.ceil(getMeasuredWidth() / f11)) + paddingLeft + 1);
        if (this.d0) {
            paddingLeft -= 2;
            min += 2;
            if (paddingLeft < 0) {
            ...
            if (min > pb1Var2.getChildCount()) {
                min = pb1Var2.getChildCount();
            }
        }
        ...
        while (paddingLeft < min) {
            View childAt = pb1Var2.getChildAt(paddingLeft);
            if (childAt instanceof fx0) {
                fx0 fx0Var = (fx0) childAt;
                int i15 = fx0Var.s;
                p9 p9Var = fx0Var.e;
