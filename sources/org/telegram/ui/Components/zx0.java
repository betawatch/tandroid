...
public final class zx0 extends FrameLayout {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        hy0 hy0Var = this.e;
        int i23 = hy0Var.e0;
        i10 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
        int dp = AndroidUtilities.dp(6.0f) + (i23 - i10);
        int i24 = hy0Var.e0;
        i11 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
        int dp2 = (i24 - i11) - AndroidUtilities.dp(13.0f);
        int i25 = AndroidUtilities.statusBarHeight;
        int i26 = dp2 + i25;
        int i27 = dp + i25;
        if (this.c) {
            i19 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
            int i28 = i19 + i26;
            int i29 = AndroidUtilities.statusBarHeight;
            int i30 = i29 * 2;
            if (i28 < i30) {
                i22 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
                i26 -= Math.min(i29, (i30 - i26) - i22);
                f7 = 1.0f - Math.min(1.0f, (r3 * 2) / AndroidUtilities.statusBarHeight);
            } else {
                f7 = 1.0f;
            }
            i20 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
            int i31 = i20 + i26;
            int i32 = AndroidUtilities.statusBarHeight;
            if (i31 < i32) {
                i21 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
                i12 = Math.min(i32, (i32 - i26) - i21);
                drawable = ((org.telegram.ui.ActionBar.f3) hy0Var).shadowDrawable;
                drawable.setBounds(0, i26, getMeasuredWidth(), getMeasuredHeight());
                drawable2 = ((org.telegram.ui.ActionBar.f3) hy0Var).shadowDrawable;
                drawable2.draw(canvas);
                RectF rectF = this.b;
                if (f7 != 1.0f) {
                    org.telegram.ui.ActionBar.j6.t0.setColor(hy0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
                    i15 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingLeft;
                    i16 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
                    int measuredWidth = getMeasuredWidth();
                    i17 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingLeft;
                    float f10 = measuredWidth - i17;
                    i18 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
                ...
                org.telegram.ui.ActionBar.j6.t0.setColor(hy0Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
                ...
                if (bool != null || bool.booleanValue() != z10) {
                    boolean z11 = AndroidUtilities.computePerceivedBrightness(hy0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) <= 0.721f;
                    boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(hy0Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f;
                ...
                if (i12 <= 0) {
                    org.telegram.ui.ActionBar.j6.t0.setColor(hy0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5));
                    i13 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingLeft;
                    float f11 = i13;
                    float f12 = AndroidUtilities.statusBarHeight - i12;
                    int measuredWidth2 = getMeasuredWidth();
                    i14 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingLeft;
        ...
        if (AndroidUtilities.computePerceivedBrightness(hy0Var.getThemedColor(org.telegram.ui.ActionBar.j6.h5)) <= 0.721f) {
        }
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(hy0Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8), 855638016)) > 0.721f) {
        }
        this.d = Boolean.valueOf(z10);
        if (!z10) {
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        hy0Var.g0 = true;
        i12 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingLeft;
        ...
        if (arrayList != null) {
            ...
            if (hy0Var.W != null) {
                ...
                i14 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
                i15 = i14 + max2;
