...
public class g61 extends View {
    ...
    public final void a(String str, boolean z10) {
        ...
        this.F = ofFloat;
        ofFloat.addUpdateListener(new f61(i10, this));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int v02 = org.telegram.ui.ActionBar.i6.v0(isEnabled() ? this.M : org.telegram.ui.ActionBar.i6.y6, getResourceProvider());
        int i10 = this.I;
        TextPaint textPaint = this.y;
        if (i10 != v02) {
            this.I = v02;
        ...
        int v04 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.tf, getResourceProvider());
        int i12 = this.K;
        Paint paint = this.e;
        if (i12 != v04) {
            this.K = v04;
        ...
        if (getParent() != null) {
            ...
            if (this.n != org.telegram.ui.ActionBar.i6.v0(this.M, getResourceProvider()) || this.E == null) {
