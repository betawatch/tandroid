...
public final class xa0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public xa0(int i10, Context context, org.telegram.ui.ActionBar.g6 g6Var, ArrayList arrayList, int i11) {
        super(context);
        String str;
        ...
        this.J = 0.0f;
        this.a = i10;
        setBackground(org.telegram.ui.ActionBar.k6.Y(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.i6, g6Var), 0, 16));
        TextPaint textPaint = new TextPaint(1);
        this.h = textPaint;
        textPaint.setTextSize(AndroidUtilities.dp(13.0f));
        textPaint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.E8, g6Var));
        if (arrayList.size() > 1) {
        ...
        if (arrayList.size() != 1) {
            if (i11 == 4) {
                this.n = AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StickersCheckStickersBotForMoreOptions), org.telegram.ui.ActionBar.k6.gc, 2, null, g6Var);
                return;
            }
            return;
        }
        ...
        if (str == null || document == null) {
            ...
            this.f = k90Var;
            k90Var.l = org.telegram.ui.ActionBar.k6.G8;
            k90Var.m = org.telegram.ui.ActionBar.k6.i6;
            k90Var.j(4.0f);
            return;
        }
        SpannableString spannableString = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString.setSpan(new ua0(this, document, this.h.getFontMetricsInt()), 0, spannableString.length(), 33);
        l5 m9 = l5.m(i10, 0, document);
        this.d = m9;
        m9.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.n6, g6Var), PorterDuff.Mode.SRC_IN));
        this.d.a(this);
        SpannableString spannableString2 = new SpannableString(str);
        spannableString2.setSpan(new wa0(0, this), 0, spannableString2.length(), 33);
    ...
    */
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        spannableString.setSpan(new hg.o2(this, 1), 0, 1, 33);
        SpannableString spannableString2 = new SpannableString(MessageObject.findAnimatedEmojiEmoticon(document));
        spannableString2.setSpan(new va0(this, document, this.h.getFontMetricsInt()), 0, spannableString2.length(), 33);
        SpannableString spannableString3 = new SpannableString(str);
        spannableString3.setSpan(new wa0(i13, this), 0, spannableString3.length(), 33);
        ...
        this.I = ofFloat;
        ofFloat.addUpdateListener(new eg.z0(8, this, z4));
