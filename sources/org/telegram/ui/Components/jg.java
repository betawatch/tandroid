...
public final class jg extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (chatActivityEnterView.Y0 && j10 >= 59500 && !this.b) {
            ...
            chatActivityEnterView.U2.X1(3, 0, chatActivityEnterView.K ? ConnectionsManager.DEFAULT_DATACENTER_ID : 0, chatActivityEnterView.N4, 0L, true);
        ...
        if (formatTimerDurationFast.length() < 3 || (str = this.c) == null || str.length() < 3 || formatTimerDurationFast.length() != this.c.length() || formatTimerDurationFast.charAt(formatTimerDurationFast.length() - 3) == this.c.charAt(formatTimerDurationFast.length() - 3)) {
            ...
            for (int i17 = 0; i17 < length - 1; i17++) {
                if (this.c.charAt(i17) != formatTimerDurationFast.charAt(i17)) {
                    ...
                    if (i15 != 0) {
                        ...
                        int i18 = i15 + i13;
                        spannableStringBuilder.setSpan(zyVar, i13, i18, 33);
                    ...
                    i15++;
                    if (i16 != 0) {
                        this.r.setSpan(new zy(false), i14, i16 + i14, 33);
                        i16 = 0;
                    }
                }
            }
            if (i15 != 0) {
                ...
                int i19 = i15 + i13 + 1;
                spannableStringBuilder.setSpan(zyVar2, i13, i19, 33);
        ...
        if (this.w == 0.0f) {
            ...
            if (this.v != null) {
                ...
                canvas.translate(0.0f, com.google.android.recaptcha.internal.a.z(1.0f, this.w, f12, measuredHeight - (this.v.getHeight() / 2.0f)));
                this.v.draw(canvas);
                canvas.restore();
            }
            canvas.save();
