...
public final class y30 extends sa {
    public final LinearLayout U;
    public w51 V;

    public y30(Activity activity, org.telegram.ui.ActionBar.f6 f6Var, TLRPC.User user, TLObject tLObject, org.telegram.ui.zp zpVar) {
        ...
        org.telegram.ui.tz0 P = P(activity, AndroidUtilities.dp(60.0f), user);
        org.telegram.ui.tz0 P2 = P(activity, AndroidUtilities.dp(60.0f), tLObject);
        ...
        dVar.setOnClickListener(new w2(21, this, zpVar));
    ...
    public static org.telegram.ui.tz0 P(Context context, int i10, TLObject tLObject) {
        org.telegram.ui.tz0 tz0Var = new org.telegram.ui.tz0(context);
        tz0Var.setRoundRadius(i10 / 2);
        z8 z8Var = new z8((org.telegram.ui.ActionBar.f6) null);
        z8Var.p(tLObject);
        tz0Var.setImageDrawable(z8Var);
        tz0Var.setLayoutParams(new FrameLayout.LayoutParams(i10, i10));
        return tz0Var;
    }
