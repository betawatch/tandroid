        ...
        if (layout != null) {
            ...
            if (text != null && (text instanceof Spannable)) {
                ...
                while (i12 < cj0VarArr2.length) {
                    ...
                    yi0 yi0Var = new yi0(duVar2, layout, spannable, cj0Var);
                    if (cj0Var.a) {
                        int i13 = cj0Var.c;
                        if (i13 == 0 || text.charAt(i13 - 1) == '\n') {
                            if (cj0Var.d != text.length() && text.charAt(cj0Var.d) != '\n') {
                                ...
                                yi0Var = new yi0(duVar2, layout, spannable, cj0VarArr2[i12]);
                            }
                            ...
                            if (z13) {
                                ...
                                if (yi0Var.b()) {
                                    ...
                                    if (i16 - 2 >= 0) {
                                        z10 = true;
                                        if (layout.getLineRight(layout.getLineForOffset(i16 - 1)) - AndroidUtilities.dp(12.0f) > yi0Var.d - (cj0Var2.J != null ? org.telegram.messenger.l0.D(3.333f, 2, AndroidUtilities.dp(23.66f) + r12.c) : org.telegram.messenger.l0.D(3.333f, 2, AndroidUtilities.dp(23.66f)))) {
                                            z11 = true;
                                            if (z14 != z11) {
                                                int i17 = cj0Var2.d;
                                                if (z14) {
