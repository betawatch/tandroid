...
public class i40 extends FrameLayout {
    ...
    public final void a() {
        ...
        this.b.setColorFilter(new PorterDuffColorFilter(i0.a.k(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.pf, this.F), 125), PorterDuff.Mode.MULTIPLY));
    ...
    public final void d() {
        ...
        int i10 = this.n;
        p4Var.setBackground(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp((i10 == 7 || i10 == 8) ? 6.0f : 3.0f), -366530760));
    }
        ...
        if ((i14 != 5 || i11 != this.v || this.d != t1Var) && (i14 == 5 || ((i14 != 0 || getTag() == null) && this.d != t1Var))) {
            ...
            if (i14 == 0) {
                ...
                if (i12 > AndroidUtilities.dp(10.0f) + getMeasuredHeight() && i17 <= (imageHeight / 4) + measuredHeight) {
                    ...
                    if (i14 == 5) {
                        int f12 = hg.c.f(19.1f, forwardNameCenterX - (getMeasuredWidth() / 2), 0);
                        setTranslationX(f12);
                        dp3 += f12;
                ...
                if (i14 == 5) {
                    ...
                    if (messageObject != null && (MessageObject.getMedia(messageObject) instanceof TLRPC.TL_messageMediaPoll)) {
                        ...
                        if (MessageObject.isVoted(tL_messageMediaPoll) && !MessageObject.isVoteResultsIsNotEmpty(tL_messageMediaPoll)) {
                            ...
                            if (!poll.closed && poll.hide_results_until_close) {
                                p4Var.setText(LocaleController.getString(R.string.PollResultsWillLater));
                                measure(View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31));
                    ...
                    if (num.intValue() == -1) {
                        p4Var.setText(LocaleController.getString(R.string.PollSelectOption));
                        measure(View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(MediaDataController.MAX_STYLE_RUNS_COUNT, TLObject.FLAG_31));
                        forwardNameCenterX = i10;
                    ...
                    if (currentUser == null || currentUser.id != 0) {
                        ...
                        dp = org.telegram.messenger.vl.D(50.0f, t1Var.getMeasuredHeight() - Math.max(0, t1Var.getBottom() - view.getMeasuredHeight()), i16);
                    }
                    i12 = dp;
                    if (!z11) {
                    }
    ...
    */
    public final void g(View view) {
        ...
        if (i12 == 4) {
            ...
            dp = org.telegram.messenger.y0.C(10.0f, getMeasuredHeight() + view.getMeasuredHeight(), dp);
        } else if (i12 == 7 || (i12 == 8 && z10)) {
            dp = org.telegram.messenger.y0.C(8.0f, getMeasuredHeight() + view.getMeasuredHeight(), dp);
        } else if (i12 == 8) {
    ...
    public i40(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        if (i10 == 3) {
            p4Var.setGravity(19);
            p4Var.setBackground(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.qf, e6Var)));
            ...
            p4Var.setGravity(51);
            p4Var.setBackground(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.qf, e6Var)));
        ...
        if (i10 == 0) {
            ...
            this.b.setScaleType(ImageView.ScaleType.CENTER);
            this.b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i11, e6Var), PorterDuff.Mode.MULTIPLY));
        ...
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.qf, e6Var), PorterDuff.Mode.MULTIPLY));
