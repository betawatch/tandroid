...
public class o6 extends Drawable {
    ...
    */
    public static boolean j(int i10, int i11, CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (!(charSequence instanceof n6) || !(charSequence2 instanceof n6)) {
            return charSequence.charAt(i10) == charSequence2.charAt(i11);
        }
        n6 n6Var = (n6) charSequence;
        CharSequence charSequence4 = null;
        if (i10 >= 0) {
            CharSequence[] charSequenceArr = n6Var.a;
            if (i10 < charSequenceArr.length) {
                charSequence3 = charSequenceArr[i10];
                n6 n6Var2 = (n6) charSequence2;
                if (i11 >= 0) {
                    CharSequence[] charSequenceArr2 = n6Var2.a;
        ...
        if (this.j != null) {
            ...
            while (true) {
                ...
                if (o6Var.getCallback() instanceof View) {
                    z5.release((View) o6Var.getCallback(), l6Var.a);
                }
                i10++;
            }
        }
    ...
    */
    public final void draw(Canvas canvas) {
            ...
            if (f16 != 1.0f) {
                ...
                while (true) {
                    ...
                    if (!this.c || this.E) {
                        ...
                        f13 = 0.0f;
                        f17 = this.d - (f17 + l6Var.f);
                    }
                    float f18 = this.m;
                    float f19 = this.t;
                    if (f19 > f13) {
                        f18 = AndroidUtilities.cascade(f18, i10, l6VarArr.length, f19);
                    }
                    if (i11 >= 0) {
                        l6 l6Var2 = this.j[i11];
                        float f20 = l6Var2.c;
                        if (this.c && !this.E) {
                            f20 = this.h - (f20 + l6Var2.f);
                        }
                        f14 = AndroidUtilities.lerp(f20 - l6Var2.e, f17 - l6Var.e, this.m);
                        a(1.0f);
                        f15 = 0.0f;
                    } else {
                        f14 = f17 - l6Var.e;
                    ...
                    if (i11 < 0) {
                        ...
                        if (f22 > f13) {
                            ...
                            canvas.scale(lerp3, lerp3, l6Var.f / 2.0f, l6Var.b.getHeight() / 2.0f);
                        }
                    }
                    l6Var.a(canvas, i11 >= 0 ? 1.0f : this.m);
                    canvas.restore();
                    i10++;
                }
                int i13 = 0;
                while (true) {
                    l6[] l6VarArr2 = this.j;
                    if (i13 >= l6VarArr2.length) {
                        break;
                    }
                    l6 l6Var3 = l6VarArr2[i13];
                    if (l6Var3.d < 0) {
                        float f23 = this.m;
                        float f24 = this.t;
                        if (f24 > 0.0f) {
                            f23 = AndroidUtilities.cascade(f23, i13, l6VarArr2.length, f24);
                        }
                        float f25 = l6Var3.c;
                        ...
                        boolean z11 = this.c;
                        if (z11 && !this.E) {
                            f25 = this.h - (f25 + l6Var3.f);
                        }
                        float f27 = f25 - l6Var3.e;
                        int i14 = this.b;
                        if ((i14 | (-4)) != -1) {
                            if ((i14 | (-6)) == -1) {
                                f11 = width;
                        ...
                        if (f28 > 0.0f) {
                            ...
                            canvas.scale(lerp4, lerp4, l6Var3.f / 2.0f, l6Var3.b.getHeight() / 2.0f);
                        }
                        l6Var3.a(canvas, f26);
                        canvas.restore();
                    }
        ...
        if (this.f != null) {
            ...
            for (int i15 = 0; i15 < this.f.length; i15++) {
                canvas.save();
                l6 l6Var4 = this.f[i15];
                float f30 = l6Var4.c;
                boolean z12 = this.c;
                if (z12 && !this.E) {
                    f30 = this.d - (f30 + l6Var4.f);
                }
                float f31 = f30 - l6Var4.e;
                int i16 = this.b;
                if ((i16 | (-4)) != -1) {
                    if ((i16 | (-6)) == -1) {
                        f31 += width - this.d;
    ...
    public final void q(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        if (!z12) {
            ...
            if (!charSequence2.equals(this.g)) {
                if (this.j != null) {
                    ...
                    while (true) {
                        l6[] l6VarArr = this.j;
                        if (i15 >= l6VarArr.length) {
                            break;
                        }
                        l6 l6Var = l6VarArr[i15];
                        o6 o6Var = l6Var.g;
                        if (o6Var.getCallback() instanceof View) {
                            z5.release((View) o6Var.getCallback(), l6Var.a);
                        }
                ...
                this.j = null;
                this.f = new l6[]{new l6(this, h(i13, charSequence2), 0.0f, -1)};
        ...
        m6 m6Var = new m6(this) { // from class: org.telegram.ui.Components.j6
            ...
            public final void b(CharSequence charSequence3) {
                switch (i12) {
                    case 0:
                        o6 o6Var2 = this.b;
                        l6 l6Var2 = new l6(o6Var2, o6Var2.h(i16 - ((int) Math.ceil(o6Var2.d)), charSequence3), o6Var2.d, -1);
                        arrayList.add(l6Var2);
                        o6Var2.d += l6Var2.f;
                        o6Var2.e = Math.max(o6Var2.e, r5.getHeight());
                        break;
                    default:
                        o6 o6Var3 = this.b;
                        l6 l6Var3 = new l6(o6Var3, o6Var3.h(i16 - ((int) Math.ceil(o6Var3.h)), charSequence3), o6Var3.h, -1);
                        arrayList.add(l6Var3);
                        o6Var3.h += l6Var3.f;
                        o6Var3.i = Math.max(o6Var3.i, r5.getHeight());
                        break;
                }
            }
        };
        m6 m6Var2 = new m6(this) { // from class: org.telegram.ui.Components.j6
            public final /* synthetic */ o6 b;
        ...
        CharSequence n6Var = this.y ? new n6(this.k) : this.k;
        CharSequence n6Var2 = this.y ? new n6(this.g) : this.g;
        if (this.F) {
            i(m6Var2, n6Var, 0, n6Var.length());
            i(m6Var, n6Var2, 0, n6Var2.length());
        } else if (this.z) {
            int min = Math.min(n6Var2.length(), n6Var.length());
            if (this.A) {
                ArrayList arrayList3 = new ArrayList();
                int i17 = 1;
                int i18 = 0;
                for (int i19 = 0; i19 <= min; i19++) {
                    int length = (n6Var2.length() - i19) - 1;
                    int length2 = (n6Var.length() - i19) - 1;
                    int i20 = (length < 0 || length2 < 0 || !j(length, length2, n6Var2, n6Var)) ? 0 : 1;
                    if (i14 != i20 || i19 == min) {
                        int i21 = i19 - i18;
                        if (i21 > 0) {
                ...
                int length3 = n6Var2.length() - min;
                int length4 = n6Var.length() - min;
                if (length3 > 0) {
                    i(m6Var, n6Var2.subSequence(0, length3), 0, length3);
                }
                if (length4 > 0) {
                    i(m6Var2, n6Var.subSequence(0, length4), 0, length4);
                }
                ...
                while (size >= 0) {
                    ...
                    if ((size % 2 == 0 ? 1 : 0) == i17) {
                        ...
                        if (n6Var2.length() > n6Var.length()) {
                            eaVar.b(n6Var2.subSequence(length3, length3 + intValue));
                        } else {
                            eaVar.b(n6Var.subSequence(length4, length4 + intValue));
                        }
                    } else {
                        i11 = size;
                        int i22 = length3 + intValue;
                        i(m6Var, n6Var2.subSequence(length3, i22), length3, i22);
                        int i23 = length4 + intValue;
                        i(m6Var2, n6Var.subSequence(length4, i23), length4, i23);
                    }
                    length3 += intValue;
                    length4 += intValue;
                    size = i11 - 1;
                ...
                boolean z13 = true;
                while (i24 <= min) {
                    boolean z14 = i24 < min && j(i24, i24, n6Var2, n6Var);
                    if (z13 != z14 || i24 == min) {
                        if (i24 - i25 > 0) {
                            if (z13) {
                                i(eaVar, n6Var2.subSequence(i25, i24), i25, i24);
                            } else {
                ...
                if (n6Var2.length() - min > 0) {
                    i(m6Var, n6Var2.subSequence(min, n6Var2.length()), min, n6Var2.length());
                }
                if (n6Var.length() - min > 0) {
                    i(m6Var2, n6Var.subSequence(min, n6Var.length()), min, n6Var.length());
                }
            }
        } else {
            int min2 = Math.min(n6Var2.length(), n6Var.length());
            int i26 = 0;
            int i27 = 0;
            int i28 = 0;
            int i29 = 0;
            boolean z15 = true;
            while (i26 <= min2) {
                boolean z16 = i26 < min2 && j(i26, i27, n6Var2, n6Var);
                if (z15 != z16 || i26 == min2) {
                    if (i26 == min2) {
                        i26 = n6Var2.length();
                        i27 = n6Var.length();
                    ...
                    if (i30 > 0 || i31 > 0) {
                        if (i30 == i31 && z17) {
                            eaVar.b(n6Var2.subSequence(i28, i26));
                        } else {
                            if (i30 > 0) {
                                i(m6Var, n6Var2.subSequence(i28, i26), i28, i26);
                            }
                            if (i31 > 0) {
                                i(m6Var2, n6Var.subSequence(i29, i27), i29, i27);
                            }
                        }
                    }
                    i28 = i26;
        ...
        if (this.j != null) {
            ...
            while (true) {
                l6[] l6VarArr2 = this.j;
                if (i32 >= l6VarArr2.length) {
                    break;
                }
                l6 l6Var2 = l6VarArr2[i32];
                o6 o6Var2 = l6Var2.g;
                if (o6Var2.getCallback() instanceof View) {
                    z5.release((View) o6Var2.getCallback(), l6Var2.a);
                }
                i32++;
            }
        }
        this.j = null;
        l6[] l6VarArr3 = this.f;
        if (l6VarArr3 == null || l6VarArr3.length != arrayList.size()) {
            this.f = new l6[arrayList.size()];
        }
        arrayList.toArray(this.f);
        c();
        l6[] l6VarArr4 = this.j;
        if (l6VarArr4 == null || l6VarArr4.length != arrayList2.size()) {
            this.j = new l6[arrayList2.size()];
        }
        ...
        if (Math.abs(textSize - f7) > 0.5f) {
            ...
            if (this.f != null) {
                ...
                while (true) {
                    ...
                    StaticLayout h = h(i10 - ((int) Math.ceil(Math.min(this.d, this.h))), l6VarArr[i12].b.getText());
                    l6[] l6VarArr2 = this.f;
                    l6 l6Var = l6VarArr2[i12];
                    l6VarArr2[i12] = new l6(this, h, l6Var.c, l6Var.d);
            ...
            if (this.j != null) {
                ...
                while (true) {
                    ...
                    StaticLayout h10 = h(i10 - ((int) Math.ceil(Math.min(this.d, this.h))), l6VarArr3[i11].b.getText());
                    l6[] l6VarArr4 = this.j;
                    l6 l6Var2 = l6VarArr4[i11];
                    l6VarArr4[i11] = new l6(this, h10, l6Var2.c, l6Var2.d);
