...
public final class ub0 extends View {
    ...
    public ub0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (f6Var instanceof org.telegram.ui.vn) {
            ...
            if ((vnVar.d() instanceof dc0) && (iArr = ((dc0) vnVar.d()).a) != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF = this.r;
        if (z4 && z10) {
            AndroidUtilities.lerp(((tb0) arrayList.get(floor)).c, ((tb0) arrayList.get(ceil)).c, f10 - floor, rectF);
        } else if (z4) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            tb0Var.b.c(tb0Var.c.left + this.h, getMeasuredHeight() / 2.0f, 1.0f, i0.a.d(1.0f - Math.abs(f10 - i10), this.d, this.e), canvas);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            f10 += ((tb0) arrayList.get(i12)).b.l() + this.h + this.h;
            i12++;
        }
        ...
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            float l10 = ((tb0) arrayList.get(i13)).b.l() + this.h + this.h;
            ((tb0) arrayList.get(i13)).c.set(f13, dp, f13 + l10, dp2);
