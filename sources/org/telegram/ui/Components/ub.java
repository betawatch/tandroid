...
public abstract class ub extends FrameLayout {
    ...
    public ub(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.blurVisibilityDrawable.i = w7.q.b((int) org.telegram.messenger.wh.x(this.inOutOffset, getMeasuredHeight(), 1.0f, 255.0f), 0, 255);
    ...
    public void dispatchDrawImpl(Canvas canvas, boolean z10, int i10) {
        ...
        float h = obVar.h(this.bulletin.a) - getY();
    ...
    public float getBottomOffset() {
        ...
        qc qcVar;
        o1.k kVar;
        if (this.bulletin == null || !(((obVar = this.delegate) == null || obVar.e()) && (kVar = (qcVar = this.bulletin).d) != null && kVar.f)) {
            ob obVar2 = this.delegate;
            if (obVar2 == null) {
                return 0.0f;
            }
            qc qcVar2 = this.bulletin;
            f7 = obVar2.f(qcVar2 != null ? qcVar2.a : 0);
        } else {
            f7 = qcVar.o;
        }
        return f7;
