...
public final class eo0 extends Drawable {
    ...
    public eo0(Runnable runnable, boolean z10) {
        ...
        Path path = new Path();
        this.f = path;
        this.g = new zz0(LocaleController.getString(R.string.SeekSpeedHint), 14.0f, null);
        Path path2 = new Path();
        this.h = path2;
        Path path3 = new Path();
        this.i = path3;
        ...
        this.l = d6Var;
        d6Var.d(0.0f, true);
        this.m = new d6(runnable, 320L, jrVar, 0);
        this.n = new d6(runnable, 200L, jrVar, 0);
    ...
    public final void c(float f9, boolean z10) {
        ...
        this.b.run();
        if (!this.q || Math.abs(f9) <= 3.0f || this.w) {
            return;
        }
        this.w = true;
    ...
    public final void draw(Canvas canvas) {
        ...
        this.b.run();
        float f9 = d / 2.0f;
        this.r.set(bounds.centerX() - f9, AndroidUtilities.dp(9.0f) + bounds.top, bounds.centerX() + f9, AndroidUtilities.dp(37.0f) + bounds.top);
        canvas.save();
        float f10 = e10 * 0.4f;
        float f11 = 0.6f + f10;
        ...
        this.c.setColor(org.telegram.ui.ActionBar.g6.l1(f10, -16777216));
        RectF rectF = this.r;
        canvas.drawRoundRect(rectF, rectF.height() / 2.0f, this.r.height() / 2.0f, this.c);
        this.p.m(this.r);
        canvas.save();
        float f12 = -d10;
        canvas.translate(((this.r.centerX() - f9) + AndroidUtilities.dp(9.0f)) - ((1.0f - Math.max(0.0f, f12)) * AndroidUtilities.dp(30.0f)), this.r.centerY());
        this.d.setColor(org.telegram.ui.ActionBar.g6.l1(((((((float) Math.sin(this.t * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, f12) * e10, -1));
        canvas.drawPath(this.h, this.d);
        canvas.translate(AndroidUtilities.dp(10.66f), 0.0f);
        this.d.setColor(org.telegram.ui.ActionBar.g6.l1(((((((float) Math.sin((this.t + 0.17f) * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, f12) * e10, -1));
        canvas.drawPath(this.h, this.d);
        canvas.restore();
        canvas.save();
        canvas.translate(((-AndroidUtilities.dp(28.0f)) / 2.0f) * d10, 0.0f);
        do0 do0Var = this.p;
        do0Var.w = (int) (e10 * 255.0f);
        do0Var.draw(canvas);
        canvas.restore();
        canvas.save();
        canvas.translate(((1.0f - Math.max(0.0f, d10)) * AndroidUtilities.dp(30.0f)) + ((this.r.centerX() + f9) - AndroidUtilities.dp(30.0f)), this.r.centerY());
        this.d.setColor(org.telegram.ui.ActionBar.g6.l1(((((((float) Math.sin(this.t * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, d10) * e10, -1));
        canvas.drawPath(this.i, this.d);
        canvas.translate(AndroidUtilities.dp(10.66f), 0.0f);
        this.d.setColor(org.telegram.ui.ActionBar.g6.l1(((((((float) Math.sin((this.t - 0.17f) * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f) * Math.max(0.0f, d10) * e10, -1));
        canvas.drawPath(this.i, this.d);
        canvas.restore();
        canvas.restore();
        ...
        if (e11 > 0.0f) {
            if (this.e == null) {
                xi0 xi0Var = new xi0(R.raw.seek_speed_hint, "" + R.raw.seek_speed_hint, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), true, null);
                this.e = xi0Var;
                xi0Var.H(true);
                this.e.setCallback(new hg.a(this, 7));
                this.e.I(1);
                this.e.start();
            }
            ...
            this.c.setColor(org.telegram.ui.ActionBar.g6.l1(e11 * 0.4f, -16777216));
            canvas.save();
