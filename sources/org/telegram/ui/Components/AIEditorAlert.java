...
public class AIEditorAlert extends BottomSheetWithRecyclerListView {
    ...
    public AIEditorAlert(final Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        while (it.hasNext()) {
            ...
            this.toneEmojis[i] = split[0];
            this.tones[i] = split[1];
            if (split.length > 2) {
                try {
                    this.toneDocumentId[i] = Long.valueOf(Long.parseLong(split[2]));
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
        ...
        while (true) {
            ...
            this.styleTabs.addTab(this.toneEmojis[i3], styleName(strArr[i3]), this.toneDocumentId[i3], new Utilities.Callback() { // from class: org.telegram.ui.Components.AIEditorAlert$$ExternalSyntheticLambda2
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (selectedTab == 0) {
            ...
            sb.append(str);
            arrayList.add(TranslateAlert3.Header.Factory.of(5, str3, sb.toString(), new View.OnClickListener() { // from class: org.telegram.ui.Components.AIEditorAlert$$ExternalSyntheticLambda15
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            if (tabs2 != null && tabs2.getSelectedTab() < 0 && !this.emojify) {
                arrayList.add(TranslateAlert3.Header.Factory.of(5, LocaleController.getString(R.string.AIEditorOriginal), null, null, this.emojify, new View.OnClickListener() { // from class: org.telegram.ui.Components.AIEditorAlert$$ExternalSyntheticLambda16
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        AIEditorAlert.this.toggleEmojify(view);
                    }
                ...
                arrayList.add(TranslateAlert3.Header.Factory.of(5, LocaleController.getString(R.string.AIEditorResult), null, null, this.emojify, new View.OnClickListener() { // from class: org.telegram.ui.Components.AIEditorAlert$$ExternalSyntheticLambda16
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        AIEditorAlert.this.toggleEmojify(view);
                    }
