...
public final class sn extends LinearLayout {
    ...
    public sn(Activity activity, View view, int i10, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        N = N == null ? org.telegram.ui.ActionBar.g6.S0("paintChatActionBackground") : N;
        int i11 = org.telegram.ui.ActionBar.g6.a;
        setBackground(new org.telegram.ui.ActionBar.t5(this, view, dp, N));
        ...
        for (int i12 = 0; i12 < 4; i12++) {
            ...
            addView(f10, h7.z5.t(-2, -2, LocaleController.isRTL ? 5 : 3, 0, 8, 0, 0));
            ...
            if (LocaleController.isRTL) {
                f10.addView(textView4, h7.z5.n(-2, -2));
                if (i10 == 0) {
                    f10.addView(imageView, h7.z5.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    f10.addView(imageView, h7.z5.k(8.0f, 7.0f, 0.0f, 0.0f, -2, -2));
                } else {
                    f10.addView(imageView, h7.z5.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                }
            } else {
                if (i10 == 0) {
                    f10.addView(imageView, h7.z5.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    f10.addView(imageView, h7.z5.k(0.0f, 8.0f, 8.0f, 0.0f, -2, -2));
                } else {
                    f10.addView(imageView, h7.z5.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                }
                f10.addView(textView4, h7.z5.n(-2, -2));
