...
public final class sk0 extends View {
    ...
    public sk0(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        this.b = new Paint(1);
        this.c = new Paint(1);
        this.d = new Paint(1);
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        byte b11;
        float clamp;
        int i14 = org.telegram.ui.ActionBar.k6.kf;
        org.telegram.ui.ActionBar.g6 g6Var = this.a;
        int v02 = org.telegram.ui.ActionBar.k6.v0(i14, g6Var);
        Paint paint4 = this.b;
        paint4.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.lf, g6Var);
        Paint paint5 = this.c;
        paint5.setColor(v03);
        int i15 = org.telegram.ui.ActionBar.k6.hf;
        int v04 = org.telegram.ui.ActionBar.k6.v0(i15, g6Var);
        j6 j6Var2 = this.h;
        j6Var2.r(v04);
        int v05 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.ff, g6Var);
        og0 og0Var2 = this.f;
        og0Var2.a.setColor(v05);
        int v06 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.gf, g6Var);
        Paint paint6 = this.d;
        paint6.setColor(v06);
        ...
        int i19 = org.telegram.ui.ActionBar.k6.gf;
        ...
        if (clamp2 < f11) {
            ...
            if (!this.w || clamp >= this.s || this.R) {
                ...
                paint6.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.hf, g6Var));
            }
            canvas.drawPath(path, paint6);
            canvas.restore();
        }
        ...
        if (e6 > 0.0f) {
            ...
            float e10 = this.K.e(d <= ((float) ((i10 - lerp) - AndroidUtilities.dp(8.0f))));
            ...
            og0 og0Var3 = og0Var;
            og0Var3.setBounds(0, (-dp8) / 2, dp8, dp8 / 2);
            og0Var3.g = (int) (e6 * 255.0f);
            og0Var3.draw(canvas);
            canvas.restore();
            if (e10 > 0.0f) {
                canvas.save();
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z12) {
                ...
                if (k71Var != null) {
                    ...
                    this.S = clamp;
                    k71Var.L((long) (clamp * this.n.p()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.Q) {
                ...
                k71 k71Var2 = this.n;
                if (k71Var2 != null) {
                    k71Var2.L((long) (this.s * k71Var2.p()), false);
                }
                setPlaying(true);
            } else if (this.P && this.w) {
                k71 k71Var3 = this.n;
                if (k71Var3 != null) {
                    k71Var3.L(Math.max((long) (this.s * k71Var3.p()), ((long) (this.v * this.n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.R && !b()) {
                setPlaying(true);
