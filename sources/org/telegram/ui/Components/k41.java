...
public final /* synthetic */ class k41 implements Runnable {
    ...
    public /* synthetic */ k41(org.telegram.ui.zk zkVar, boolean[] zArr, String str, LinearLayout linearLayout, ArrayList arrayList, String str2, TranslateController translateController, org.telegram.ui.ActionBar.n1 n1Var, ArrayList arrayList2) {
        this.d = zkVar;
        this.e = zArr;
        this.f = str;
        this.n = linearLayout;
                ...
                if (!zArr[0]) {
                    ...
                    while (i10 < size) {
                        ...
                        if (TextUtils.equals(str3, str2)) {
                            ...
                            if (z10) {
                                ...
                                f1Var = f1Var3;
                                final int i12 = 0;
                                f1Var.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.i41
                    ...
                    while (i13 < size2) {
                        ...
                        if (!TextUtils.equals(str4, str2)) {
                            ...
                            if (!z11) {
                                final int i15 = 1;
                                f1Var4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.i41
                                    @Override // android.view.View.OnClickListener
                                    public final void onClick(View view) {
                                        switch (i15) {
                                            case 0:
