...
public abstract class k41 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public k41(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        this.E = new w31(context);
        l90 l90Var = new l90(context, null);
        this.F = l90Var;
        l90Var.setDisablePaddingsOffsetY(true);
        l90Var.setPadding(AndroidUtilities.dp(22.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(6.0f));
        l90Var.setTextSize(1, SharedConfig.fontSize);
        l90Var.setTextColor(getThemedColor(i11));
        l90Var.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.gc));
        l90Var.setTextIsSelectable(true);
        l90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.vf);
        try {
            if (Build.VERSION.SDK_INT >= 29 && !XiaomiUtilities.isMIUI()) {
                Drawable textSelectHandleLeft = l90Var.getTextSelectHandleLeft();
                PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
                textSelectHandleLeft.setColorFilter(themedColor, mode);
                l90Var.setTextSelectHandleLeft(textSelectHandleLeft);
                Drawable textSelectHandleRight = l90Var.getTextSelectHandleRight();
                textSelectHandleRight.setColorFilter(themedColor, mode);
                l90Var.setTextSelectHandleRight(textSelectHandleRight);
            }
        ...
        this.H = x31Var;
        x31Var.setOverScrollMode(1);
        x31Var.setPadding(0, AndroidUtilities.dp(56.0f) + AndroidUtilities.statusBarHeight, 0, AndroidUtilities.dp(80.0f));
        x31Var.setClipToPadding(true);
        ...
        j41Var.d = view;
        this.I = j41Var;
        x31Var.setAdapter(j41Var);
        x31Var.setOnScrollListener(new y31(this));
        z31 z31Var = new z31(this);
        z31Var.n(180L);
        z31Var.o(new LinearInterpolator());
        x31Var.setItemAnimator(z31Var);
        this.containerView.addView(x31Var, w7.y5.e(-1, -2, 80));
    ...
    public static c41 J(Activity activity, org.telegram.ui.zn znVar, TLRPC.InputPeer inputPeer, int i10, boolean z10, String str, String str2, CharSequence charSequence, boolean z11, org.telegram.ui.wf wfVar, Runnable runnable) {
        c41 c41Var = new c41(activity, str, str2, charSequence, inputPeer, i10, z10, runnable);
        c41Var.H(z11);
        c41Var.M = znVar;
        c41Var.N = wfVar;
        if (znVar.getParentActivity() != null) {
            znVar.showDialog(c41Var);
        }
        return c41Var;
    }
    ...
    public static void K(Context context, org.telegram.ui.ActionBar.n2 n2Var, String str, String str2, CharSequence charSequence, org.telegram.ui.m20 m20Var, org.telegram.ui.Cells.g gVar) {
        ...
        e41 e41Var = new e41(context, str, str2, charSequence, gVar);
        e41Var.H(false);
        e41Var.M = n2Var;
        e41Var.N = m20Var;
        if (n2Var == null) {
    ...
    public static void m(k41 k41Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_textWithEntities2 != null) {
            ...
            k41Var.F.setText(k41Var.G(valueOf));
            j41Var.D(w31Var);
            return;
        }
        if (k41Var.O) {
        ...
        org.telegram.messenger.wh.o(R.string.TranslationFailedAlert2, new xc((FrameLayout) k41Var.containerView, k41Var.resourcesProvider), null);
    ...
    public static void o(k41 k41Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = k41Var.r;
        k41Var.b = null;
    ...
    public static void p(k41 k41Var, String str, Boolean bool) {
        w31 w31Var = k41Var.E;
        j41 j41Var = k41Var.I;
        if (str != null) {
            k41Var.O = false;
            k41Var.F.setText(k41Var.G(str));
            j41Var.D(w31Var);
        } else {
            if (k41Var.isDismissed()) {
                return;
            }
            if (k41Var.O) {
                k41Var.dismiss();
            ...
            org.telegram.messenger.wh.o(bool.booleanValue() ? R.string.TranslationFailedAlert1 : R.string.TranslationFailedAlert2, new xc((FrameLayout) k41Var.containerView, k41Var.resourcesProvider), null);
            g41 g41Var = k41Var.x.e;
    ...
    public static boolean u(k41 k41Var) {
        x31 x31Var = k41Var.H;
        float f7 = 0.0f;
        for (int i10 = 0; i10 < x31Var.getChildCount(); i10++) {
            if (RecyclerView.S(x31Var.getChildAt(i10)) == 1) {
                f7 += r3.getHeight();
            }
        }
        return f7 >= ((float) ((x31Var.getHeight() - x31Var.getPaddingTop()) - x31Var.getPaddingBottom()));
    }

    public static void x(String str, String str2, String str3, Utilities.Callback2 callback2) {
        if (str2 == null) {
            LanguageDetector.detectLanguage(str, new v31(str, str3, callback2), new v31(str, str3, callback2));
            return;
        }
        String encode = Uri.encode(str);
        if (encode.length() <= 5000) {
            new a41(str2, str3, encode, callback2).start();
            return;
        }
        ...
        while (i13 < arrayList.size()) {
            ...
            new a41(str2, str3, (String) arrayList.get(i13), new ei.h1(zArr, arrayList2, i13, callback22, 5)).start();
            i13++;
        ...
        if (this.N != null || this.M != null) {
            for (URLSpan uRLSpan : (URLSpan[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length(), URLSpan.class)) {
                ...
                if (spanStart != -1 && spanEnd != -1) {
                    ...
                    spannableStringBuilder.setSpan(new b41(this, uRLSpan), spanStart, spanEnd, 33);
                }
            }
        }
    ...
    public final void H(boolean z10) {
        l90 l90Var = this.F;
        if (l90Var != null) {
            l90Var.setTextIsSelectable(!z10);
        }
        if (z10) {
    ...
    public final float z(boolean z10) {
        e6 e6Var;
        x31 x31Var = this.H;
        float top = x31Var.getTop();
        if (x31Var.getChildCount() >= 1) {
            top += Math.max(0, x31Var.getChildAt(x31Var.getChildCount() - 1).getTop());
        }
