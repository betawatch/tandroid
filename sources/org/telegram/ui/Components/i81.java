...
public final class i81 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            drawable4.setBounds(i10, i12 - AndroidUtilities.dp(3.0f), this.x, AndroidUtilities.dp(3.0f) + this.w);
            drawable3.setBounds(this.v, this.w - AndroidUtilities.dp(3.0f), i13, AndroidUtilities.dp(3.0f) + this.w);
        } else {
            drawable4.setBounds(i12, 0, i11, AndroidUtilities.dp(6.0f));
            drawable3.setBounds(this.w, 0, i14, AndroidUtilities.dp(6.0f));
            canvas.save();
            canvas.rotate(90.0f);
        ...
        drawable5.setBounds(i13 - intrinsicWidth, i14 - intrinsicWidth, i13 + intrinsicWidth, i14 + intrinsicWidth);
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int i11 = this.w;
        float f13 = i11;
        float f14 = this.y - i11;
        int i12 = (int) ((f12 * f14) + f13);
        if (action == 1 || action == 0) {
            if (x10 < i10 - AndroidUtilities.dp(20.0f) || x10 > AndroidUtilities.dp(20.0f) + i10 || y10 < i12 - AndroidUtilities.dp(25.0f) || y10 > AndroidUtilities.dp(25.0f) + i12) {
                try {
                    ...
                    if (z11) {
                        if (x10 >= this.v && x10 <= this.x) {
                            if (action == 0) {
                                this.D = x10;
                                this.B = true;
                            } else if (Math.abs(this.D - x10) <= AndroidUtilities.dp(10.0f)) {
