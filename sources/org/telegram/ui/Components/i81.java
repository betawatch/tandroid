...
public abstract class i81 extends FrameLayout {
    ...
    public i81(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.a = 1.0f;
        ...
        w0Var.setOnItemClickListener(new c81(this));
        w0Var.setOnItemLongClickListener(new c81(this));
        w0Var.setOnScrollListener(new kb0(this, i12));
        if (i10 == 9 || i10 == 10) {
    ...
    public final void a(int i10, CharSequence charSequence) {
        ...
        f81 f81Var = new f81();
        f81Var.a = i10;
        f81Var.b = charSequence;
        this.H = org.telegram.messenger.w1.C(this.r * 2, f81Var.a(this.c), this.H);
    ...
    public final void d(int i10, int i11) {
        ...
        this.k0 = ofFloat;
        ofFloat.addUpdateListener(new g61(2, this));
                ...
                if (f7 != 1.0f) {
                    ...
                    if (this.J && this.L == -1) {
                        ...
                        if (L2 != null) {
                            g81 g81Var = (g81) L2.a;
                            i13 = g81Var.b;
                            dp = (int) (g81Var.getX() + ((g81Var.getMeasuredWidth() - i13) / 2));
                            int i15 = i13;
                            i10 = dp;
                            i14 = i15;
                        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            for (int i15 = 0; i15 < size2; i15++) {
                int a2 = ((f81) arrayList.get(i15)).a(this.c);
