...
public final class oe0 implements DialogInterface.OnClickListener {
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        Integer num12 = 6;
        te0 te0Var2 = this.a;
        ArrayList arrayList3 = te0Var2.J;
        ArrayList arrayList4 = te0Var2.I;
        Integer num13 = 0;
        if (i10 == 0) {
        ...
        TLRPC.TL_userContact_old2 tL_userContact_old2 = te0Var2.K;
        ...
        try {
            te0Var.r.getParentActivity().startActivity(intent3);
            te0Var.dismiss();
        } catch (Exception e) {
            FileLog.e(e);
        }
