...
public final class yg1 extends LinearLayout {
    ...
    public yg1(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        setOrientation(0);
        this.a = f6Var;
        ...
        TextView j10 = yh.j(linearLayout, textView, k7.b6.t(-1, -2, 7, 0, 0, 0, 0), context);
        this.e = j10;
        j10.setTextSize(1, 13.0f);
        linearLayout.addView(j10, k7.b6.r(-1, -2, 7, 0.0f, 4.33f, 0.0f, 0.0f));
