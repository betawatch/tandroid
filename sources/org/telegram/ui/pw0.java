...
public final class pw0 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        ax0Var2.d.b.q = (premiumPreviewFragment.U.c.getY() + ax0Var2.getY()) / getMeasuredHeight();
        if (!premiumPreviewFragment.Z) {
            invalidate();
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        ax0 ax0Var = premiumPreviewFragment.U;
        ax0Var.d.b.p = (premiumPreviewFragment.U.d.getX() + ax0Var.getX()) / getMeasuredWidth();
        ax0 ax0Var2 = premiumPreviewFragment.U;
        ax0Var2.d.b.q = (premiumPreviewFragment.U.d.getY() + ax0Var2.getY()) / getMeasuredHeight();
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        for (int i15 = 0; i15 < arrayList2.size(); i15++) {
            ...
            ((bx0) arrayList2.get(i15)).e = i14;
            i14 += premiumPreviewFragment.L.getMeasuredHeight();
        }
        for (int i16 = 0; i16 < arrayList.size(); i16++) {
            premiumPreviewFragment.L.a((bx0) arrayList.get(i16), false);
            premiumPreviewFragment.L.measure(View.MeasureSpec.makeMeasureSpec(i10, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i11, TLObject.FLAG_31));
            ((bx0) arrayList.get(i16)).e = i14;
            i14 += premiumPreviewFragment.L.getMeasuredHeight();
        }
