...
public final class j21 extends View {
    ...
    public Bitmap n;
    public boolean r;
    public final org.telegram.ui.Components.oo0 s;
    public TextPaint v;
    ...
    public j21(Context context) {
        ...
        oo0Var.a.setShader(bitmapShader2);
        oo0Var.b = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.C != null) {
            ...
            if (this.J || (a21Var = this.e) == null) {
                return;
            }
            o21 o21Var = a21Var.a;
            o21Var.c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    */
        ...
        if (!this.r) {
            ...
            for (int i18 = 2; i17 <= i18; i18 = 2) {
                ...
                if (i17 > 1 || measureText <= z4) {
                    ...
                    i12 = 2;
                    f10 = 30.0f;
                    staticLayout = org.telegram.ui.Components.lw0.c(spannableStringBuilder, textPaint, i20, Layout.Alignment.ALIGN_CENTER, 0.0f, false, null, Math.min(AndroidUtilities.dp(10.0f) + i20, createBitmap.getWidth()), i19, true);
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.i21
                        ...
                        public final void run() {
                            j21 j21Var = j21.this;
                            Bitmap bitmap2 = j21Var.h;
                            j21Var.h = createBitmap.extractAlpha();
                            if (!j21Var.P) {
                                j21Var.x.d(0.0f, true);
                            }
                            j21Var.P = false;
                            Bitmap bitmap3 = j21Var.n;
                            if (bitmap3 != null) {
                                bitmap3.recycle();
                            }
                            j21Var.n = bitmap2;
                            ...
                            if (a21Var != null) {
                                ...
                                float f15 = width3;
                                o21 o21Var = a21Var.a;
                                o21Var.c.set((int) (f14 - f13), (int) (f15 - f13), (int) (f14 + f13), (int) (f15 + f13));
                                o21Var.B.requestLayout();
                                j21Var.J = true;
                            }
                            j21Var.invalidate();
    ...
    public final void d(boolean z4) {
        if (this.r) {
            ...
            this.w = org.telegram.ui.Components.lw0.c(Emoji.replaceEmoji(str, this.v.getFontMetricsInt(), false), this.v, getWidth(), Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, getWidth() - AndroidUtilities.dp(60.0f), 1, true);
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (d < 1.0f) {
            ...
            if (z4) {
                ...
                org.telegram.ui.Components.oo0 oo0Var = this.s;
                oo0Var.setBounds(0, i12, width, dp4);
                oo0Var.draw(canvas);
                return;
            }
        }
