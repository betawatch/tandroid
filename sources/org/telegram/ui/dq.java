...
public class dq extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void V(final dq dqVar, org.telegram.ui.ActionBar.a3 a3Var, View view) {
        Runnable runnable;
        ...
        if (intValue == 0) {
            ...
            try {
                DatePickerDialog datePickerDialog = new DatePickerDialog(dqVar.getParentActivity(), new DatePickerDialog.OnDateSetListener() { // from class: org.telegram.ui.wp
                    ...
                    public final void onDateSet(DatePicker datePicker, int i10, int i11, int i12) {
                        ...
                        try {
                            TimePickerDialog timePickerDialog = new TimePickerDialog(dqVar2.getParentActivity(), new TimePickerDialog.OnTimeSetListener() { // from class: org.telegram.ui.zp
                            ...
                            timePickerDialog.setButton(-2, LocaleController.getString(R.string.Cancel), new xp());
                ...
                datePickerDialog.setButton(-2, LocaleController.getString(R.string.Cancel), new xp());
    ...
    public static /* synthetic */ boolean W(dq dqVar, TLRPC.TL_error tL_error) {
        ...
        if (!ChatObject.isChannel(dqVar.w)) {
            ...
            v0Var.I1(dqVar.w, arrayList, null, null, null);
            v0Var.show();
        }
        return false;
    }
    ...
    */
    public static void X(dq dqVar, Context context, View view, int i10) {
        ...
        if (dqVar.E || (dqVar.w.creator && i11 == 0 && i10 == dqVar.a0)) {
            boolean z15 = false;
            if (i10 == dqVar.v0) {
                if (!(view instanceof org.telegram.ui.Cells.p8) || ((org.telegram.ui.Cells.p8) view).isEnabled()) {
                    dqVar.w0 = !dqVar.w0;
                    dqVar.u0(false);
                    dqVar.a.m(dqVar.v0);
                    if (dqVar.w0) {
            ...
            if (i10 == dqVar.I0) {
                ...
                k4Var.setHeight(47);
                k4Var.setText(LocaleController.getString(R.string.UserRestrictionsDuration));
                linearLayout.addView(k4Var);
                LinearLayout linearLayout2 = new LinearLayout(context);
                linearLayout2.setOrientation(1);
                int i14 = -2;
                linearLayout.addView(linearLayout2, i7.f6.n(-1, -2));
                ...
                for (int i16 = 5; i15 < i16; i16 = 5) {
                    ...
                    y2VarArr[i15].setBackgroundDrawable(org.telegram.ui.ActionBar.g6.K0(false));
                    ...
                    linearLayout2.addView(y2VarArr[i15], i7.f6.n(-1, i14));
                    y2VarArr[i15].setOnClickListener(new nh.r7(25, dqVar, a3Var));
                    i15++;
                    i14 = -2;
                }
                a3Var.b(linearLayout);
                dqVar.showDialog(f3Var);
                return;
            }
            ...
            if (view instanceof org.telegram.ui.Cells.p8) {
                ...
                if (i10 == dqVar.S) {
                    ...
                    while (i19 < childCount) {
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.p8) {
                            ...
                            if (z17) {
                                ...
                                org.telegram.ui.Cells.p8 p8Var2 = (org.telegram.ui.Cells.p8) childAt;
                                p8Var2.setChecked(z17);
                                p8Var2.b(z11, true);
                                i19++;
                                z15 = false;
                                ...
                                org.telegram.ui.Cells.p8 p8Var3 = (org.telegram.ui.Cells.p8) childAt;
                                p8Var3.setChecked(z15);
                                p8Var3.b(R == dqVar.S, true);
                            } else {
                                org.telegram.ui.Cells.p8 p8Var4 = (org.telegram.ui.Cells.p8) childAt;
                                p8Var4.setChecked(true);
                                p8Var4.b(z15, z15);
                            }
                        }
                        i19++;
                    ...
                    dqVar.a.l();
                    org.telegram.ui.Components.o6 o6Var = dqVar.f;
                    if (o6Var != null) {
                        ...
                        o6Var.c(sb2.toString(), true, dqVar.G);
                    }
                    ...
                    dqVar.Y0 = ofFloat;
                    ofFloat.addUpdateListener(new up(dqVar, 1));
    ...
    public static void Y(dq dqVar, TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, TLRPC.TL_channels_editCreator tL_channels_editCreator) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            if (inputCheckPasswordSRP == null) {
                ...
                c2Var.P = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, dqVar.w.title, UserObject.getFirstName(user)));
                alertDialog$Builder.k(LocaleController.getString(R.string.EditAdminTransferChangeOwner), new sp(dqVar, i10));
        ...
        if (!"PASSWORD_MISSING".equals(tL_error.text) && !tL_error.text.startsWith("PASSWORD_TOO_FRESH_") && !tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
            if ("SRP_ID_INVALID".equals(tL_error.text)) {
                ConnectionsManager.getInstance(dqVar.currentAccount).sendRequest(new TL_account.getPassword(), new zg(i10, dqVar, twoStepVerificationActivity), 8);
                return;
            }
    ...
    public static void Z(dq dqVar, long j10) {
        ...
        if (user != null && j10 != 0 && user.id != j10) {
            new org.telegram.ui.Components.u30(dqVar.getParentActivity(), dqVar.resourceProvider, user, dqVar.v, new tp(dqVar, j10, 0)).show();
            return;
        }
        dqVar.n = j10;
        dqVar.r = true;
    ...
    public static void f0(dq dqVar, View view) {
        if (view instanceof org.telegram.ui.Cells.k4) {
            ...
            k4Var.setText2(String.format("%d", Integer.valueOf(codePointCount)));
    ...
    public final View createView(Context context) {
        ...
        if (this.E || (!this.A && this.w.creator && UserObject.isUserSelf(this.v))) {
            ...
            this.h = new org.telegram.ui.Components.ir(mutate, new org.telegram.ui.Components.np(org.telegram.ui.ActionBar.g6.w0(null, i11, false)));
        ...
        s7Var.setBackgroundColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.a7, false));
        ...
        this.b.setOnItemClickListener(new eg.w0(8, this, context));
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        f fVar = new f(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 16, new Class[]{org.telegram.ui.Cells.ra.class, org.telegram.ui.Cells.y9.class, org.telegram.ui.Cells.p8.class, org.telegram.ui.Cells.k4.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.a6.class}, null, null, null, org.telegram.ui.ActionBar.g6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 262144, new Class[]{org.telegram.ui.Cells.y9.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.g6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 262144, new Class[]{org.telegram.ui.Cells.y9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.y9.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.m6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.g6.z6;
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.p8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.p8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.p8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.p8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.V6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 262144, new Class[]{org.telegram.ui.Cells.k4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 262144, new Class[]{org.telegram.ui.Cells.k4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 4, new Class[]{org.telegram.ui.Cells.a6.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, TLObject.FLAG_23, new Class[]{org.telegram.ui.Cells.a6.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.H6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.ra.class}, new String[]{"statusColor"}, null, null, -1, fVar, org.telegram.ui.ActionBar.g6.y6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.b, 0, new Class[]{org.telegram.ui.Cells.ra.class}, new String[]{"statusOnlineColor"}, null, null, -1, fVar, org.telegram.ui.ActionBar.g6.n6));
        ...
        if (i10 != 2) {
            if (!(i10 == 1 ? this.N.equals(ChatObject.getBannedRightsString(this.K)) : this.P.equals(this.O))) {
                ...
                if (z10) {
                    ...
                    alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new sp(this, i11));
    ...
    public final void n0() {
        ...
        int i10 = this.g0;
        if (i10 >= 0) {
            org.telegram.ui.Cells.p8 p8Var = (org.telegram.ui.Cells.p8) this.c.m(i10);
            if (p8Var == null) {
                this.a.m(this.g0);
                return;
            }
    ...
    public final void p0(TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        if (inputCheckPasswordSRP != null && !ChatObject.isChannel(this.w)) {
            MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.s, this, new z6(this, inputCheckPasswordSRP, twoStepVerificationActivity, 10));
            return;
        }
    ...
    */
    public final void r0(boolean z10) {
        ...
        if (!isChannel) {
            ...
            MessagesController.getInstance(dqVar.currentAccount).convertToMegaGroup(dqVar.getParentActivity(), dqVar.s, dqVar, new sp(dqVar, 7));
            return;
        }
        boolean z11 = dqVar.B;
        TLRPC.User user = dqVar.v;
        ...
        if (i10 == 0) {
            ...
            dqVar.t0(true);
            MessagesController.getInstance(dqVar.currentAccount).setUserAdminRole(dqVar.s, dqVar.v, dqVar.I, dqVar.O, dqVar.A, dqVar, (!dqVar.V0 || z11) ? 0 : 1, false, null, new vp(dqVar, i11), new sp(dqVar, 8));
            dqVar = dqVar;
            r6 = i12;
        } else {
            if (i10 == 1) {
                ...
                c2Var.P = AndroidUtilities.replaceTags(dqVar.G ? z13 ? LocaleController.formatString(R.string.AddBotMessageAdminChannel, str4) : LocaleController.formatString(R.string.AddBotMessageAdminGroup, str4) : LocaleController.formatString(R.string.AddMembersAlertNamesText, UserObject.getUserName(user), str4));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                alertDialog$Builder.k(LocaleController.getString(dqVar.G ? R.string.AddAsAdmin : R.string.AddBot), new sp(dqVar, r6));
                dqVar.showDialog(c2Var);
                r6 = 0;
            }
        }
    ...
    public final void t0(boolean z10) {
        ...
        if (irVar != null) {
            ValueAnimator ofFloat = ValueAnimator.ofFloat(irVar.c, this.D ? 1.0f : 0.0f);
            this.X0 = ofFloat;
