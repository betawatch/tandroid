...
public final class ly extends FrameLayout {
    ...
    public ly(my myVar, Context context) {
        ...
        if (i10 == 0) {
            while (i9 < 2) {
                this.n[i9] = (ViewGroup) myVar.getParentActivity().getLayoutInflater().inflate(R.layout.shortcut_widget_item, (ViewGroup) null);
                linearLayout.addView(this.n[i9], g7.e6.n(-1, -2));
                i9++;
            }
            ...
            while (i9 < 2) {
                this.n[i9] = (ViewGroup) myVar.getParentActivity().getLayoutInflater().inflate(R.layout.contacts_widget_item, (ViewGroup) null);
                linearLayout.addView(this.n[i9], g7.e6.n(160, -2));
                i9++;
            }
        ...
        a();
        this.e = org.telegram.ui.ActionBar.f6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.f6.b7);
    }
        ...
        if (i11 == 0) {
            ...
            while (i15 < i13) {
                if (arrayList.isEmpty()) {
                    dialog2 = i15 < myVar.getMessagesController().dialogsServerOnly.size() ? myVar.getMessagesController().dialogsServerOnly.get(i15) : null;
                    j10 = 0;
                } else if (i15 < arrayList.size()) {
                    j10 = 0;
                    TLRPC.Dialog dialog3 = (TLRPC.Dialog) myVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i15)).longValue());
                    if (dialog3 == null) {
                        dialog3 = new TLRPC.TL_dialog();
                        dialog3.id = ((Long) arrayList.get(i15)).longValue();
                    }
                    dialog2 = dialog3;
                } else {
                    j10 = 0;
                ...
                if (dialog2 == null) {
                    viewGroupArr[i15].setVisibility(i12);
                    i10 = i15;
                } else {
                    viewGroupArr[i15].setVisibility(i14);
                    if (DialogObject.isUserDialog(dialog2.id)) {
                        user2 = myVar.getMessagesController().getUser(Long.valueOf(dialog2.id));
                        if (user2 != null) {
                            ...
                            if (UserObject.isReplyUser(user2) || UserObject.isUserSelf(user2) || (userProfilePhoto2 = user2.photo) == null || (fileLocation2 = userProfilePhoto2.photo_small) == null) {
                                ...
                                if (fileLocation2.volume_id != j10 && fileLocation2.local_id != 0) {
                                    chat2 = null;
                                    ((TextView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_text)).setText(str2);
                                    if (fileLocation2 == null) {
                                        try {
                                            decodeFile2 = BitmapFactory.decodeFile(myVar.getFileLoader().getPathToAttach(fileLocation2, r12).toString());
                                        } catch (Throwable th) {
                                            th = th;
                                            c10 = 1;
                                            FileLog.e(th);
                                            ArrayList arrayList2 = (ArrayList) myVar.getMessagesController().dialogMessage.f(dialog2.id);
                                            if (arrayList2 != null) {
                                            }
                                    ...
                                    if (decodeFile2 != null) {
                                        if (user2 != null) {
                                            org.telegram.ui.Components.z8 z8Var3 = new org.telegram.ui.Components.z8(i14, user2);
                                        ...
                                        z8Var2.setBounds(i14, i14, dp, dp);
                                        z8Var2.draw(canvas2);
                                        canvas = canvas2;
                                        c10 = 1;
                                    } else {
                                    ...
                                    ((ImageView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_avatar)).setImageBitmap(createBitmap);
                                    ArrayList arrayList22 = (ArrayList) myVar.getMessagesController().dialogMessage.f(dialog2.id);
                                    messageObject = (arrayList22 != null || arrayList22.size() <= 0) ? null : (MessageObject) arrayList22.get(i14);
                                    if (messageObject == null) {
                                        long fromChatId = messageObject.getFromChatId();
                                        if (fromChatId > j10) {
                                            user3 = myVar.getMessagesController().getUser(Long.valueOf(fromChatId));
                                            chat3 = null;
                                        } else {
                                            chat3 = myVar.getMessagesController().getChat(Long.valueOf(-fromChatId));
                                            user3 = null;
                                        }
                                            ...
                                            if (chat2 == null || chat2.id <= j10 || chat3 != null || (ChatObject.isChannel(chat2) && !ChatObject.isMegagroup(chat2))) {
                                                ...
                                                try {
                                                    if (charSequence5 != null) {
                                                        ...
                                                        n11.append(charSequence6.replace('\n', ' '));
                                                        ...
                                                        if (messageObject.messageOwner.media == null || messageObject.isMediaEmpty()) {
                                                            ...
                                                            if (messageMedia2 instanceof TLRPC.TL_messageMediaPoll) {
                                                                h = aa.d.o("📊 \u2068", ((TLRPC.TL_messageMediaPoll) messageMedia2).poll.question.text, "\u2069");
                                                            } else if (messageMedia2 instanceof TLRPC.TL_messageMediaGame) {
                                                                h = aa.d.o("🎮 \u2068", messageMedia2.game.title, "\u2069");
                                                            } else {
                                                                h = messageObject.type == 14 ? org.telegram.ui.Cells.j2.h("🎧 \u2068", messageObject.getMusicAuthor(), " - ", messageObject.getMusicTitle(), "\u2069") : messageObject.messageText.toString();
                                                                c12 = '\n';
                                                            }
                                                            String replace = h.replace(c12, ' ');
                                                            Object[] objArr3 = new Object[2];
                                                            objArr3[0] = replace;
                                                            objArr3[c10] = string;
                                                            SpannableStringBuilder valueOf2 = SpannableStringBuilder.valueOf(String.format("%2$s: \u2068%1$s\u2069", objArr3));
                                                            try {
                                                                valueOf2.setSpan(new org.telegram.ui.Components.p00(org.telegram.ui.ActionBar.f6.o9, null), string.length() + 2, valueOf2.length(), 33);
                                                                spannableStringBuilder = valueOf2;
                                                            } catch (Exception e10) {
                                                                FileLog.e(e10);
                                                                spannableStringBuilder = valueOf2;
                                                            }
                                                            spannableStringBuilder.setSpan(new org.telegram.ui.Components.p00(org.telegram.ui.ActionBar.f6.k9, null), 0, string.length() + 1, 33);
                                        ...
                                        ((TextView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_time)).setText(LocaleController.stringForMessageListDate(messageObject.messageOwner.date));
                                        ((TextView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_message)).setText(charSequence2.toString());
                                        ((TextView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_message)).setTextColor(color);
                                    } else {
                                        if (dialog2.last_message_date != 0) {
                                            ((TextView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_time)).setText(LocaleController.stringForMessageListDate(dialog2.last_message_date));
                                        } else {
                                            ((TextView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_time)).setText("");
                                        }
                                        ((TextView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_message)).setText("");
                                    }
                                    if (dialog2.unread_count <= 0) {
                                        ((TextView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_badge)).setText(String.format("%d", Integer.valueOf(dialog2.unread_count)));
                                        viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_badge).setVisibility(0);
                                        if (myVar.getMessagesController().isDialogMuted(dialog2.id, j10)) {
                                            viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_badge).setBackgroundResource(R.drawable.widget_counter_muted);
                                        } else {
                                            viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_badge).setBackgroundResource(R.drawable.widget_counter);
                                        }
                                    } else {
                                        viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_badge).setVisibility(8);
                                    }
                                }
                            }
                        } else {
                        ...
                        createBitmap2.eraseColor(i14);
                        Canvas canvas22 = new Canvas(createBitmap2);
                        if (decodeFile2 != null) {
                        }
                        canvas.setBitmap(null);
                        ((ImageView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_avatar)).setImageBitmap(createBitmap2);
                        ArrayList arrayList222 = (ArrayList) myVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        i10 = i15;
                        TLRPC.Chat chat4 = myVar.getMessagesController().getChat(Long.valueOf(-dialog2.id));
                        if (chat4 != null) {
                            str2 = chat4.title;
                            ...
                            if (chatPhoto == null || (fileLocation2 = chatPhoto.photo_small) == null || fileLocation2.volume_id == j10 || fileLocation2.local_id == 0) {
                                ...
                                createBitmap22.eraseColor(i14);
                                Canvas canvas222 = new Canvas(createBitmap22);
                                if (decodeFile2 != null) {
                                }
                                canvas.setBitmap(null);
                                ((ImageView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_avatar)).setImageBitmap(createBitmap22);
                                ArrayList arrayList2222 = (ArrayList) myVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        createBitmap222.eraseColor(i14);
                        Canvas canvas2222 = new Canvas(createBitmap222);
                        if (decodeFile2 != null) {
                        }
                        canvas.setBitmap(null);
                        ((ImageView) viewGroupArr[i10].findViewById(R.id.shortcut_widget_item_avatar)).setImageBitmap(createBitmap222);
                        ArrayList arrayList22222 = (ArrayList) myVar.getMessagesController().dialogMessage.f(dialog2.id);
            ...
            while (true) {
                ...
                for (int i18 = 2; i17 < i18; i18 = 2) {
                    int i19 = (i16 * 2) + i17;
                    if (arrayList.isEmpty()) {
                        if (i19 < myVar.getMediaDataController().hints.size()) {
                            long j11 = myVar.getMediaDataController().hints.get(i19).peer.user_id;
                            dialog = (TLRPC.Dialog) myVar.getMessagesController().dialogs_dict.f(j11);
                            if (dialog == null) {
                        ...
                        if (i19 < arrayList.size()) {
                            dialog = (TLRPC.Dialog) myVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i19)).longValue());
                            if (dialog == null) {
                                dialog = new TLRPC.TL_dialog();
                                dialog.id = ((Long) arrayList.get(i19)).longValue();
                            }
                        }
                        dialog = null;
                    }
                    if (dialog == null) {
                        viewGroupArr[i16].findViewById(i17 == 0 ? R.id.contacts_widget_item1 : R.id.contacts_widget_item2).setVisibility(4);
                        if (i19 == 0 || i19 == 2) {
                            viewGroupArr[i16].setVisibility(8);
                        }
                    } else {
                        viewGroupArr[i16].findViewById(i17 == 0 ? R.id.contacts_widget_item1 : R.id.contacts_widget_item2).setVisibility(0);
                        if (i19 == 0 || i19 == 2) {
                            viewGroupArr[i16].setVisibility(0);
                        }
                        if (DialogObject.isUserDialog(dialog.id)) {
                            user = myVar.getMessagesController().getUser(Long.valueOf(dialog.id));
                            ...
                            TLRPC.Chat chat5 = myVar.getMessagesController().getChat(Long.valueOf(-dialog.id));
                        ...
                        ((TextView) viewGroupArr[i16].findViewById(i17 == 0 ? R.id.contacts_widget_item_text1 : R.id.contacts_widget_item_text2)).setText(str);
                        if (fileLocation != null) {
                            try {
                                decodeFile = BitmapFactory.decodeFile(myVar.getFileLoader().getPathToAttach(fileLocation, true).toString());
                            } catch (Throwable th2) {
                                th = th2;
                                FileLog.e(th);
                        ...
                        try {
                            ...
                            ((ImageView) viewGroupArr[i16].findViewById(i17 == 0 ? R.id.contacts_widget_item_avatar1 : R.id.contacts_widget_item_avatar2)).setImageBitmap(createBitmap3);
                        } catch (Throwable th6) {
                            th = th6;
                            FileLog.e(th);
                            i9 = dialog.unread_count;
                        ...
                        i9 = dialog.unread_count;
                        if (i9 > 0) {
                            ((TextView) viewGroupArr[i16].findViewById(i17 == 0 ? R.id.contacts_widget_item_badge1 : R.id.contacts_widget_item_badge2)).setText(i9 > 99 ? String.format("%d+", 99) : String.format("%d", Integer.valueOf(i9)));
                            viewGroupArr[i16].findViewById(i17 == 0 ? R.id.contacts_widget_item_badge_bg1 : R.id.contacts_widget_item_badge_bg2).setVisibility(0);
                        } else {
                            viewGroupArr[i16].findViewById(i17 == 0 ? R.id.contacts_widget_item_badge_bg1 : R.id.contacts_widget_item_badge_bg2).setVisibility(8);
                        }
                    }
                    i17++;
                }
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (s02 != drawable && s02 != null) {
            if (org.telegram.ui.ActionBar.f6.sl != null) {
                ...
                org.telegram.ui.Components.m9 m9Var2 = this.a;
                if (m9Var2 != null) {
                    m9Var2.dispose();
                    this.a = null;
                }
        ...
        my myVar = this.r;
        b5Var = ((org.telegram.ui.ActionBar.o2) myVar).parentLayout;
        float themeAnimationValue = b5Var.getThemeAnimationValue();
        int i9 = 0;
        while (i9 < 2) {
            Drawable drawable2 = i9 == 0 ? this.d : this.c;
            if (drawable2 != null) {
                if (i9 == 1 && this.d != null) {
                    b5Var2 = ((org.telegram.ui.ActionBar.o2) myVar).parentLayout;
                    if (b5Var2 != null) {
                        ...
                        if (!(drawable2 instanceof ColorDrawable) || (drawable2 instanceof GradientDrawable) || (drawable2 instanceof org.telegram.ui.Components.jb0)) {
                            ...
                            if (drawable2 instanceof org.telegram.ui.Components.n9) {
                                drawable2.draw(canvas);
                            } else {
                                this.a = ((org.telegram.ui.Components.n9) drawable2).c(canvas, this);
                            }
    ...
    public final void onMeasure(int i9, int i10) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i9), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(264.0f), TLObject.FLAG_30));
    }
