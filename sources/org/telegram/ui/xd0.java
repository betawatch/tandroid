...
public final class xd0 extends org.telegram.ui.Components.mv0 {
    ...
    public String v;
    public String w;
    public final org.telegram.ui.Components.uc0 x;
    ...
    */
    public xd0(fg0 fg0Var, Context context) {
        super(context);
        int i10;
        this.y = fg0Var;
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                editTextBoldCursor.setOnFocusChangeListener(new kd(this, 4));
                uc0Var.e(editTextBoldCursor);
                uc0Var.addView(editTextBoldCursor, i7.f6.e(-1, -2, 48));
                editTextBoldCursor.setOnEditorActionListener(new da(this, 5));
                addView(uc0Var, i7.f6.t(-1, -2, 1, 16, 32, 16, 0));
                ...
                frameLayout2.addView(textView3, i7.f6.d(-1, 56.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
                addView(frameLayout2, i7.f6.q(-1, -1, 80));
                oc.i.K1(textView3);
                textView3.setOnClickListener(new t70(7, this, context));
            }
        }
        i10 = 8;
        frameLayout.setVisibility(i10);
        ...
        addView(textView4, i7.f6.d(-1, -2.0f, 1, 32.0f, 16.0f, 32.0f, 0.0f));
        ...
        editTextBoldCursor2.setOnFocusChangeListener(new kd(this, 4));
        uc0Var2.e(editTextBoldCursor2);
        uc0Var2.addView(editTextBoldCursor2, i7.f6.e(-1, -2, 48));
        editTextBoldCursor2.setOnEditorActionListener(new da(this, 5));
        addView(uc0Var2, i7.f6.t(-1, -2, 1, 16, 32, 16, 0));
        ...
        frameLayout22.addView(textView32, i7.f6.d(-1, 56.0f, 80, 0.0f, 0.0f, 0.0f, 32.0f));
        addView(frameLayout22, i7.f6.q(-1, -1, 80));
        oc.i.K1(textView32);
        textView32.setOnClickListener(new t70(7, this, context));
    }
    ...
    @Override // org.telegram.ui.Components.mv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new q00(this, 19), fg0.p0);
    }
