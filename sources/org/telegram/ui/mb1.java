    ...
    public final int compare(Object obj, Object obj2) {
        ...
        switch (this.a) {
            ...
            case 13:
                ...
                int i12 = 17;
                return e9.x.f(x2.p.c((x2.p) Collections.max(list, new mb1(16)), (x2.p) Collections.max(list2, new mb1(16)))).a(list.size(), list2.size()).b((x2.p) Collections.max(list, new mb1(i12)), (x2.p) Collections.max(list2, new mb1(i12)), new mb1(i12)).e();
            case 14:
                return ((x2.e) Collections.max((List) obj)).compareTo((x2.e) Collections.max((List) obj2));
            case 15:
                return ((x2.m) ((List) obj).get(0)).compareTo((x2.m) ((List) obj2).get(0));
            case 16:
                return x2.p.c((x2.p) obj, (x2.p) obj2);
            case 17:
                x2.p pVar = (x2.p) obj;
                x2.p pVar2 = (x2.p) obj2;
                boolean z10 = pVar.e;
                int i13 = pVar.s;
                e9.y0 a2 = (z10 && pVar.n) ? x2.q.l : x2.q.l.a();
                boolean z11 = pVar.f.B;
                e9.z zVar = e9.z.a;
                if (z11) {
                    zVar = zVar.b(Integer.valueOf(i13), Integer.valueOf(pVar2.s), x2.q.l.a());
                }
                return zVar.b(Integer.valueOf(pVar.v), Integer.valueOf(pVar2.v), a2).b(Integer.valueOf(i13), Integer.valueOf(pVar2.s), a2).e();
            case 18:
