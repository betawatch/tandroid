...
public final class mb1 extends org.telegram.ui.Components.sl0 {
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (i23 == 21) {
            ((qo0) view).set(themeActivity.getUserConfig().getCurrentUser());
            return;
        }
        switch (i23) {
            case 10:
            ...
            case 12:
                ...
                ob1 ob1Var = (ob1) tl0Var.getAdapter();
                ob1Var.l();
                int indexOf = ob1Var.e.indexOf(ob1Var.d.k(false));
                if (indexOf == -1) {
                    indexOf = ob1Var.h() - 1;
                }
                if (indexOf != -1) {
                    ((f2.j0) tl0Var.getLayoutManager()).h1(indexOf, (themeActivity.b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                    break;
                }
                break;
        }
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [android.view.View, android.view.ViewGroup, android.widget.LinearLayout, java.lang.Object, org.telegram.ui.ib1] */
    /* JADX WARN: Type inference failed for: r2v28 */
    /* JADX WARN: Type inference failed for: r2v29, types: [org.telegram.ui.qo0] */
    @Override // f2.p0
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 5:
                ...
                break;
            case 6:
                j5Var = new hb1(this, context);
                break;
            case 7:
                j5Var = new org.telegram.ui.Cells.s8(context);
                break;
            case 8:
                j5Var = new nb1(themeActivity, context);
                break;
            case 9:
                faVar = new ib1(context);
            ...
            case 11:
                this.d = true;
                jb1 jb1Var = new jb1(this, this.c, themeActivity, themeActivity.f, themeActivity.e, themeActivity.d);
                themeActivity.c = jb1Var;
                jb1Var.setDrawDivider(themeActivity.v);
                ...
                break;
            case 12:
                kb1 kb1Var = new kb1(context, 0, g6Var);
                kb1Var.setFocusable(false);
                kb1Var.setItemAnimator(null);
                kb1Var.setLayoutAnimation(null);
                kb1Var.setPadding(AndroidUtilities.dp(11.0f), 0, AndroidUtilities.dp(11.0f), 0);
                kb1Var.setClipToPadding(false);
                f2.j0 j0Var = new f2.j0();
                j0Var.j1(0);
                kb1Var.setLayoutManager(j0Var);
                ob1 ob1Var = new ob1(themeActivity, context);
                kb1Var.setAdapter(ob1Var);
                kb1Var.setOnItemClickListener(new fb1(this, ob1Var, kb1Var, 0));
                kb1Var.setOnItemLongClickListener(new vl0(21, this, ob1Var));
                kb1Var.setLayoutParams(new f2.x0(-1, AndroidUtilities.dp(62.0f)));
                j5Var = kb1Var;
                break;
            case 13:
                j5Var = new cb1(themeActivity, context);
                break;
            case 14:
            case 18:
            default:
            ...
            case 15:
                ...
                org.telegram.ui.Components.xy0 xy0Var = new org.telegram.ui.Components.xy0(context);
                Paint paint = new Paint(1);
                xy0Var.a = paint;
                xy0Var.b = new Paint(1);
                Paint paint2 = new Paint(1);
                xy0Var.c = paint2;
                Paint paint3 = new Paint(1);
                xy0Var.d = paint3;
                xy0Var.e = new RectF();
                xy0Var.h = new String[]{LocaleController.getString(R.string.SwipeSettingsPin), LocaleController.getString(R.string.SwipeSettingsRead), LocaleController.getString(R.string.SwipeSettingsArchive), LocaleController.getString(R.string.SwipeSettingsMute), LocaleController.getString(R.string.SwipeSettingsDelete), LocaleController.getString(R.string.SwipeSettingsFolders)};
                xy0Var.n = new int[]{r14, r14, r14, r14, org.telegram.ui.ActionBar.k6.Y5, org.telegram.ui.ActionBar.k6.d9};
                xy0Var.r = new org.telegram.ui.Components.ij0[6];
                xy0Var.v = new org.telegram.ui.Components.lj0[2];
                xy0Var.x = 1.0f;
                ...
                org.telegram.ui.Components.wy0 wy0Var = new org.telegram.ui.Components.wy0(xy0Var, context);
                xy0Var.f = wy0Var;
                wy0Var.setMinValue(0);
                wy0Var.setDrawDividers(false);
                boolean isEmpty = MessagesController.getInstance(i11).dialogFilters.isEmpty();
                wy0Var.setMaxValue(isEmpty ? 4 : 5);
                wy0Var.setAllItemsCount(isEmpty ? 5 : 6);
                wy0Var.setWrapSelectorWheel(true);
                wy0Var.setFormatter(new org.telegram.ui.Components.vy0(xy0Var));
                wy0Var.setOnValueChangedListener(new org.telegram.ui.Components.vy0(xy0Var));
                wy0Var.setImportantForAccessibility(2);
                wy0Var.setValue(SharedConfig.getChatSwipeAction(i11));
                xy0Var.addView(wy0Var, k7.c6.d(132, -1.0f, 5, 21.0f, 0.0f, 21.0f, 0.0f));
                xy0Var.setWillNotDraw(false);
                xy0Var.s = 0;
                for (int i16 = 0; i16 < 2; i16++) {
                    xy0Var.v[i16] = new org.telegram.ui.Components.lj0(context);
                    xy0Var.addView(xy0Var.v[i16], k7.c6.d(28, 28.0f, 21, 0.0f, 0.0f, 184.0f, 0.0f));
                }
                org.telegram.ui.Components.ij0 a2 = xy0Var.a(xy0Var.f.getValue());
                if (a2 != null) {
                    xy0Var.v[0].setImageDrawable(a2);
                    a2.K(a2.e[0] - 1);
                }
                AndroidUtilities.updateViewVisibilityAnimated(xy0Var.v[0], true, 0.5f, false);
                AndroidUtilities.updateViewVisibilityAnimated(xy0Var.v[1], false, 0.5f, false);
                xy0Var.w = xy0Var.f.getValue() != 5 ? 0.0f : 1.0f;
                xy0Var.C = xy0Var.f.getValue();
                j5Var = xy0Var;
                break;
            case 16:
                f5Var = ((org.telegram.ui.ActionBar.p2) themeActivity).parentLayout;
                View lb1Var = new lb1(context, f5Var, 0);
                lb1Var.setImportantForAccessibility(4);
                j5Var = lb1Var;
                break;
            case 17:
            ...
            case 21:
                ...
                faVar = new qo0(i13, 0L, this.c, themeActivity.getResourceProvider());
                j5Var = faVar;
                break;
        }
