...
public final class yy extends FrameLayout {
    ...
    public yy(zy zyVar, Context context) {
        ...
        if (i11 == 0) {
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) zyVar.getParentActivity().getLayoutInflater().inflate(R.layout.shortcut_widget_item, (ViewGroup) null);
            ...
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) zyVar.getParentActivity().getLayoutInflater().inflate(R.layout.contacts_widget_item, (ViewGroup) null);
    ...
    */
    public final void a() {
        ...
        if (i12 == 0) {
            ...
            while (i16 < i14) {
                if (arrayList.isEmpty()) {
                    dialog2 = i16 < zyVar.getMessagesController().dialogsServerOnly.size() ? zyVar.getMessagesController().dialogsServerOnly.get(i16) : null;
                    j10 = 0;
                } else if (i16 < arrayList.size()) {
                    j10 = 0;
                    TLRPC.Dialog dialog3 = (TLRPC.Dialog) zyVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i16)).longValue());
                    if (dialog3 == null) {
                ...
                if (dialog2 == null) {
                    ...
                    if (DialogObject.isUserDialog(dialog2.id)) {
                        user2 = zyVar.getMessagesController().getUser(Long.valueOf(dialog2.id));
                        if (user2 != null) {
                            ...
                            if (UserObject.isReplyUser(user2) || UserObject.isUserSelf(user2) || (userProfilePhoto2 = user2.photo) == null || (fileLocation2 = userProfilePhoto2.photo_small) == null) {
                                ...
                                if (fileLocation2.volume_id != j10 && fileLocation2.local_id != 0) {
                                    ...
                                    if (fileLocation2 == null) {
                                        try {
                                            decodeFile2 = BitmapFactory.decodeFile(zyVar.getFileLoader().getPathToAttach(fileLocation2, r12).toString());
                                        } catch (Throwable th2) {
                                            th = th2;
                                            c3 = 1;
                                            FileLog.e(th);
                                            ArrayList arrayList2 = (ArrayList) zyVar.getMessagesController().dialogMessage.f(dialog2.id);
                                            if (arrayList2 != null) {
                                            }
                                    ...
                                    ArrayList arrayList22 = (ArrayList) zyVar.getMessagesController().dialogMessage.f(dialog2.id);
                                    messageObject = (arrayList22 != null || arrayList22.size() <= 0) ? null : (MessageObject) arrayList22.get(i15);
                                    if (messageObject == null) {
                                        long fromChatId = messageObject.getFromChatId();
                                        if (fromChatId > j10) {
                                            user3 = zyVar.getMessagesController().getUser(Long.valueOf(fromChatId));
                                            chat3 = null;
                                        } else {
                                            chat3 = zyVar.getMessagesController().getChat(Long.valueOf(-fromChatId));
                                            user3 = null;
                                        }
                                        ...
                                        if (messageObject.messageOwner instanceof TLRPC.TL_messageService) {
                                            ...
                                            if (chat2 == null || chat2.id <= j10 || chat3 != null || (ChatObject.isChannel(chat2) && !ChatObject.isMegagroup(chat2))) {
                                                ...
                                                if ((messageMedia instanceof TLRPC.TL_messageMediaPhoto) && (messageMedia.photo instanceof TLRPC.TL_photoEmpty) && messageMedia.ttl_seconds != 0) {
                                                    ...
                                                    l10.append((Object) messageObject.caption);
                                                    charSequence2 = l10.toString();
                                                } else {
                                                ...
                                                try {
                                                    if (charSequence5 != null) {
                                                        ...
                                                        l11.append(charSequence6.replace('\n', ' '));
                                                        Object[] objArr = new Object[2];
                                                        objArr[0] = l11.toString();
                                                        objArr[c3] = string;
                                                        ...
                                                        if (messageObject.messageOwner.media == null || messageObject.isMediaEmpty()) {
                                                            ...
                                                            if (messageMedia2 instanceof TLRPC.TL_messageMediaPoll) {
                                                                k10 = android.support.v4.media.a.o("📊 \u2068", ((TLRPC.TL_messageMediaPoll) messageMedia2).poll.question.text, "\u2069");
                                                            } else if (messageMedia2 instanceof TLRPC.TL_messageMediaGame) {
                                                                k10 = android.support.v4.media.a.o("🎮 \u2068", messageMedia2.game.title, "\u2069");
                                                            } else {
                                                                k10 = messageObject.type == 14 ? ai.k("🎧 \u2068", messageObject.getMusicAuthor(), " - ", messageObject.getMusicTitle(), "\u2069") : messageObject.messageText.toString();
                                                                c11 = '\n';
                                                            }
                                                            String replace = k10.replace(c11, ' ');
                                                            Object[] objArr3 = new Object[2];
                                                            objArr3[0] = replace;
                                                            objArr3[c3] = string;
                                                            SpannableStringBuilder valueOf2 = SpannableStringBuilder.valueOf(String.format("%2$s: \u2068%1$s\u2069", objArr3));
                                                            try {
                                                                valueOf2.setSpan(new org.telegram.ui.Components.f10(org.telegram.ui.ActionBar.j6.o9, null), string.length() + 2, valueOf2.length(), 33);
                                                                spannableStringBuilder = valueOf2;
                                                            } catch (Exception e) {
                                                                FileLog.e(e);
                                                                spannableStringBuilder = valueOf2;
                                                            }
                                                            spannableStringBuilder.setSpan(new org.telegram.ui.Components.f10(org.telegram.ui.ActionBar.j6.k9, null), 0, string.length() + 1, 33);
                                    ...
                                    if (dialog2.unread_count <= 0) {
                                        ...
                                        if (zyVar.getMessagesController().isDialogMuted(dialog2.id, j10)) {
                        ...
                        ArrayList arrayList222 = (ArrayList) zyVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        i11 = i16;
                        TLRPC.Chat chat4 = zyVar.getMessagesController().getChat(Long.valueOf(-dialog2.id));
                        if (chat4 != null) {
                            str2 = chat4.title;
                            ...
                            if (chatPhoto == null || (fileLocation2 = chatPhoto.photo_small) == null || fileLocation2.volume_id == j10 || fileLocation2.local_id == 0) {
                                ...
                                ArrayList arrayList2222 = (ArrayList) zyVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        ArrayList arrayList22222 = (ArrayList) zyVar.getMessagesController().dialogMessage.f(dialog2.id);
            ...
            while (true) {
                ...
                for (int i19 = 2; i18 < i19; i19 = 2) {
                    int i20 = (i17 * 2) + i18;
                    if (arrayList.isEmpty()) {
                        if (i20 < zyVar.getMediaDataController().hints.size()) {
                            long j11 = zyVar.getMediaDataController().hints.get(i20).peer.user_id;
                            dialog = (TLRPC.Dialog) zyVar.getMessagesController().dialogs_dict.f(j11);
                            if (dialog == null) {
                        ...
                        if (i20 < arrayList.size()) {
                            dialog = (TLRPC.Dialog) zyVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i20)).longValue());
                            if (dialog == null) {
                                dialog = new TLRPC.TL_dialog();
                    ...
                    if (dialog == null) {
                        ...
                        if (DialogObject.isUserDialog(dialog.id)) {
                            user = zyVar.getMessagesController().getUser(Long.valueOf(dialog.id));
                            ...
                            TLRPC.Chat chat5 = zyVar.getMessagesController().getChat(Long.valueOf(-dialog.id));
                        ...
                        if (fileLocation != null) {
                            try {
                                decodeFile = BitmapFactory.decodeFile(zyVar.getFileLoader().getPathToAttach(fileLocation, true).toString());
                            } catch (Throwable th3) {
                                th = th3;
                                FileLog.e(th);
        ...
        if (viewGroupArr[0].getVisibility() == 0) {
            zyVar.d.setVisibility(8);
        } else {
            zyVar.d.setVisibility(0);
        }
    }
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        zy zyVar = this.r;
        e5Var = ((org.telegram.ui.ActionBar.p2) zyVar).parentLayout;
        ...
        while (i10 < 2) {
            ...
            if (drawable2 != null) {
                if (i10 == 1 && this.d != null) {
                    e5Var2 = ((org.telegram.ui.ActionBar.p2) zyVar).parentLayout;
                    if (e5Var2 != null) {
