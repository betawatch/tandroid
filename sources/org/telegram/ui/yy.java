...
public final class yy extends FrameLayout {
    ...
    public yy(zy zyVar, Context context) {
        ...
        if (i11 == 0) {
            while (i10 < 2) {
                ...
                linearLayout.addView(this.n[i10], w7.y5.n(-1, -2));
                i10++;
            }
            ...
            while (i10 < 2) {
                ...
                linearLayout.addView(this.n[i10], w7.y5.n(160, -2));
                i10++;
            }
                            ...
                            if (UserObject.isReplyUser(user2) || UserObject.isUserSelf(user2) || (userProfilePhoto2 = user2.photo) == null || (fileLocation2 = userProfilePhoto2.photo_small) == null) {
                                ...
                                if (fileLocation2.volume_id != j3 && fileLocation2.local_id != 0) {
                                    ...
                                    if (dialog2.unread_count <= 0) {
                                        ...
                                        if (zyVar.getMessagesController().isDialogMuted(dialog2.id, j3)) {
                ...
                for (int i19 = 2; i18 < i19; i19 = 2) {
                    ...
                    if (arrayList.isEmpty()) {
                        if (i20 < zyVar.getMediaDataController().hints.size()) {
                            long j10 = zyVar.getMediaDataController().hints.get(i20).peer.user_id;
                            dialog = (TLRPC.Dialog) zyVar.getMessagesController().dialogs_dict.f(j10);
                            if (dialog == null) {
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        zy zyVar = this.r;
        b5Var = ((org.telegram.ui.ActionBar.m2) zyVar).parentLayout;
