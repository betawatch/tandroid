...
public class StakedDiceSheet extends BottomSheetWithRecyclerListView {
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            spannableStringBuilder.setSpan(new ReplacementSpan() { // from class: org.telegram.ui.StakedDiceSheet.1
                ...
                public void draw(Canvas canvas, CharSequence charSequence, int i4, int i5, float f, int i6, int i7, int i8, Paint paint) {
                    float dp = ((i6 + i8) / 2.0f) + AndroidUtilities.dp(1.0f);
                    this.bgPaint.setColor(Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider));
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(f, dp - AndroidUtilities.dp(9.0f), AndroidUtilities.dp(16.0f) + f + this.text.getCurrentWidth(), AndroidUtilities.dp(9.0f) + dp);
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(9.0f), AndroidUtilities.dp(9.0f), this.bgPaint);
                    this.text.draw(canvas, f + AndroidUtilities.dp(8.0f), dp, -1, 1.0f);
                }
            }, length, spannableStringBuilder.length(), 33);
            makeTextView.setText(spannableStringBuilder);
            this.topView.addView(makeTextView, LayoutHelper.createLinear(-1, -2, 32.0f, 0.0f, 32.0f, 8.0f));
            TextView makeTextView2 = TextHelper.makeTextView(context, 14.0f, i3, false);
            makeTextView2.setGravity(17);
            makeTextView2.setText(LocaleController.getString(R.string.StakeDiceText));
            this.topView.addView(makeTextView2, LayoutHelper.createLinear(-1, -2, 32.0f, 0.0f, 32.0f, 12.0f));
            LinearLayout linearLayout2 = new LinearLayout(context);
            linearLayout2.setOrientation(1);
            TextView makeTextView3 = TextHelper.makeTextView(context, 14.0f, Theme.key_windowBackgroundWhiteBlueHeader, true);
            makeTextView3.setText(LocaleController.getString(R.string.StakeDiceReturns));
            linearLayout2.addView(makeTextView3, LayoutHelper.createLinear(-1, -2, 0.0f, 0.0f, 0.0f, 8.0f));
            ...
            Utilities.Callback2Return callback2Return = new Utilities.Callback2Return() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda4
                ...
                public final Object run(Object obj, Object obj2) {
                    TableView.TableRowContent lambda$new$1;
                    lambda$new$1 = StakedDiceSheet.lambda$new$1(context, iArr, resourcesProvider, tableView, (Integer) obj, (Float) obj2);
                    return lambda$new$1;
                }
            };
            ...
            TextView makeTextView4 = TextHelper.makeTextView(context, 14.0f, Theme.key_windowBackgroundWhiteGrayText, false);
            makeTextView4.setGravity(17);
            ...
            makeTextView4.setText(AndroidUtilities.replaceMultipleCharSequence("🎲", LocaleController.getString(R.string.StakeDiceReturnsInfo), spannableStringBuilder2));
            linearLayout2.addView(makeTextView4, LayoutHelper.createLinear(-1, -2, 0.0f, 4.0f, 0.0f, 16.0f));
            ...
            editTextBoldCursor.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda5
                ...
                public final void onFocusChange(View view, boolean z) {
                    StakedDiceSheet.lambda$new$2(OutlineTextContainerView.this, editTextBoldCursor, view, z);
                }
            });
            ...
            Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda6
                ...
                public final Object run(Object obj) {
                    View lambda$new$4;
                    lambda$new$4 = StakedDiceSheet.lambda$new$4(context, resourcesProvider, editTextBoldCursor, (Long) obj);
                    return lambda$new$4;
                }
            };
            ...
            buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    StakedDiceSheet.this.lambda$new$6(editTextBoldCursor, i, outlineTextContainerView, iArr2, context, resourcesProvider, callback, view);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ TableView.TableRowContent lambda$new$1(Context context, int[] iArr, Theme.ResourcesProvider resourcesProvider, TableView tableView, Integer num, Float f) {
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        LinearLayout linearLayout2 = new LinearLayout(context);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$new$2(OutlineTextContainerView outlineTextContainerView, EditTextBoldCursor editTextBoldCursor, View view, boolean z) {
        outlineTextContainerView.animateSelection(z, !TextUtils.isEmpty(editTextBoldCursor.getText()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ View lambda$new$4(Context context, Theme.ResourcesProvider resourcesProvider, final EditTextBoldCursor editTextBoldCursor, final Long l) {
        TextView textView = new TextView(context);
        textView.setGravity(17);
        textView.setTextSize(1, 13.0f);
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                StakedDiceSheet.lambda$new$3(EditTextBoldCursor.this, l, view);
            }
        });
        return textView;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$new$3(EditTextBoldCursor editTextBoldCursor, Long l, View view) {
    ...
    public /* synthetic */ void lambda$new$6(EditTextBoldCursor editTextBoldCursor, int i, OutlineTextContainerView outlineTextContainerView, int[] iArr, Context context, Theme.ResourcesProvider resourcesProvider, Utilities.Callback callback, View view) {
        ...
        try {
            ...
            if (parseDouble > MessagesController.getInstance(i).tonStakeddiceStakeAmountMax / 1.0E9d) {
            ...
            if (TextUtils.isEmpty(text) || parseDouble >= MessagesController.getInstance(i).tonStakeddiceStakeAmountMin / 1.0E9d) {
                if (StarsController.getInstance(i, true).balance.toDouble() < parseDouble) {
                    new TONIntroActivity.StarsNeededSheet(context, resourcesProvider, AmountUtils$Amount.fromNano((long) (parseDouble * 1.0E9d), AmountUtils$Currency.TON), true, new Runnable() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda8
                    ...
                    callback.run(Long.valueOf((long) (parseDouble * 1.0E9d)));
                    lambda$new$0();
                    return;
                }
            }
    ...
    protected RecyclerListView.SelectionAdapter createAdapter(RecyclerListView recyclerListView) {
        UniversalAdapter universalAdapter = new UniversalAdapter(recyclerListView, getContext(), this.currentAccount, 0, new Utilities.Callback2() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda2
            ...
            public final void run(Object obj, Object obj2) {
                StakedDiceSheet.this.fillItems((ArrayList) obj, (UniversalAdapter) obj2);
            }
    ...
    public static void showStakeToast(BaseFragment baseFragment, int i, long j, final Utilities.Callback callback) {
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            lottieLayout.setButton(new Bulletin.UndoButton(safeLastFragment.getContext(), true, safeLastFragment.getResourceProvider()).setText(LocaleController.getString(R.string.StakeDiceToastButton)).setUndoAction(new Runnable() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    StakedDiceSheet.lambda$showStakeToast$8(Utilities.Callback.this, j2);
                }
            }));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showStakeToast$7(BaseFragment baseFragment, Utilities.Callback callback) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showStakeToast$8(Utilities.Callback callback, long j) {
