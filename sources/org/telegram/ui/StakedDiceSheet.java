...
public class StakedDiceSheet extends BottomSheetWithRecyclerListView {
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            Utilities.Callback2Return callback2Return = new Utilities.Callback2Return() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda4
                ...
                public final Object run(Object obj, Object obj2) {
                    return StakedDiceSheet.$r8$lambda$Avzvs7HEBCdk-CHlzfUQfHJlva8(context, iArr, resourcesProvider, tableView, (Integer) obj, (Float) obj2);
                }
            };
            ...
            Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda6
                ...
                public final Object run(Object obj) {
                    return StakedDiceSheet.$r8$lambda$U3QzNjIEL4No-d70FOH84Lt4RXk(context, resourcesProvider, editTextBoldCursor, (Long) obj);
                }
            };
            ...
            buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    StakedDiceSheet.$r8$lambda$HSdzoQwWTn8d3fxJFrqvkYCT0kg(StakedDiceSheet.this, editTextBoldCursor, i, outlineTextContainerView, iArr2, context, resourcesProvider, callback, view);
                }
            });
    ...
    public static /* synthetic */ TableView.TableRowContent $r8$lambda$Avzvs7HEBCdk-CHlzfUQfHJlva8(Context context, int[] iArr, Theme.ResourcesProvider resourcesProvider, TableView tableView, Integer num, Float f) {
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        LinearLayout linearLayout2 = new LinearLayout(context);
    ...
    public static /* synthetic */ View $r8$lambda$U3QzNjIEL4No-d70FOH84Lt4RXk(Context context, Theme.ResourcesProvider resourcesProvider, final EditTextBoldCursor editTextBoldCursor, final Long l) {
        TextView textView = new TextView(context);
        textView.setGravity(17);
        textView.setTextSize(1, 13.0f);
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                StakedDiceSheet.$r8$lambda$zzvBunEOVdmRliQ0b4YCyQVjPHw(EditTextBoldCursor.this, l, view);
            }
        });
        return textView;
    }
    ...
    public static /* synthetic */ void $r8$lambda$HSdzoQwWTn8d3fxJFrqvkYCT0kg(StakedDiceSheet stakedDiceSheet, EditTextBoldCursor editTextBoldCursor, int i, OutlineTextContainerView outlineTextContainerView, int[] iArr, Context context, Theme.ResourcesProvider resourcesProvider, Utilities.Callback callback, View view) {
    ...
    public static void showStakeToast(BaseFragment baseFragment, int i, long j, final Utilities.Callback callback) {
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            spannableStringBuilder.append((CharSequence) "  ").append(ButtonSpan.make(LocaleController.getString(R.string.StakeDiceToastChange), new Runnable() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    new StakedDiceSheet(r0.getContext(), r0.getCurrentAccount(), BaseFragment.this.getResourceProvider(), callback).show();
                }
            ...
            lottieLayout.setButton(new Bulletin.UndoButton(safeLastFragment.getContext(), true, safeLastFragment.getResourceProvider()).setText(LocaleController.getString(R.string.StakeDiceToastButton)).setUndoAction(new Runnable() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    Utilities.Callback.this.run(Long.valueOf(j2));
                }
            }));
