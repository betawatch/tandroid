...
public final class y70 extends DispatchQueue {
    ...
    public final rs v;
    public final x5 w;
    public final /* synthetic */ a80 x;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public y70(a80 a80Var, SurfaceTexture surfaceTexture) {
        super("EGLThread");
        this.x = a80Var;
        this.n = new int[24];
        this.v = new rs(6);
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.ul.t(this.b, new StringBuilder("eglGetDisplay failed "));
            }
            finish();
            ...
            a80 a80Var = this.x;
            if (!this.b.eglChooseConfig(this.c, EmuDetector.with(a80Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    org.telegram.messenger.ul.t(this.b, new StringBuilder("eglChooseConfig failed "));
                }
                finish();
            } else if (iArr[0] > 0) {
                ...
                if (eglCreateContext == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.ul.t(this.b, new StringBuilder("eglCreateContext failed "));
                    }
                    finish();
                } else {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.ul.t(this.b, new StringBuilder("createWindowSurface failed "));
                            }
                            finish();
                            ...
                            b(R.drawable.intro_powerful_mask, 17, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.d6, false), false);
                            ...
                            a80Var.J = System.currentTimeMillis() - 1000;
                            z10 = true;
                        } else {
                            if (BuildVars.LOGS_ENABLED) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.ul.t(this.b, new StringBuilder("eglInitialize failed "));
            }
            finish();
        }
        this.h = z10;
