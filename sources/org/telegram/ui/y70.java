...
public final class y70 extends ActionBarPopupWindow$ActionBarPopupWindowLayout {
    ...
    public w70 a0;
    public ArrayList b0;
    public final org.telegram.ui.ActionBar.n2 c0;
    ...
    public y70(Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        c15.c(org.telegram.ui.ActionBar.g6.w0(null, i10, false), org.telegram.ui.ActionBar.g6.w0(null, i10, false));
        arrayList.add(new x70(c10, CacheByChatsController.KEEP_MEDIA_ONE_DAY));
        arrayList.add(new x70(c11, CacheByChatsController.KEEP_MEDIA_TWO_DAY));
        arrayList.add(new x70(c12, CacheByChatsController.KEEP_MEDIA_ONE_WEEK));
        arrayList.add(new x70(c13, CacheByChatsController.KEEP_MEDIA_ONE_MONTH));
        arrayList.add(new x70(c14, CacheByChatsController.KEEP_MEDIA_FOREVER));
        arrayList.add(new x70(c15, CacheByChatsController.KEEP_MEDIA_DELETE));
        ...
        for (int i11 = 0; i11 < this.T.size(); i11++) {
            ((x70) this.T.get(i11)).a.setOnClickListener(new hh.z0(this, ((x70) this.T.get(i11)).b, 17));
        }
    ...
    public final void f() {
        if (this.b0 != null) {
            ((org.telegram.ui.Components.b9) this.U.d).setTranslationX((3 - Math.min(3, this.b0.size())) * AndroidUtilities.dp(12.0f));
        }
    }
