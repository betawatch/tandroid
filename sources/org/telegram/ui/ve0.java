...
public final class ve0 extends org.telegram.ui.Components.uv0 {
    ...
    */
    public ve0(rg0 rg0Var, Context context) {
        super(context);
        int i10;
        this.y = rg0Var;
        this.x = new te0(this, 1);
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                yd0 yd0Var = new yd0(this, context, 1);
                this.a = yd0Var;
                yd0Var.b(6, 1);
                for (bs bsVar : yd0Var.f) {
                    bsVar.setShowSoftInputOnFocusCompat(AndroidUtilities.isAccessibilityTouchExplorationEnabled());
                    bsVar.addTextChangedListener(new m0(this, 8));
                    bsVar.setOnFocusChangeListener(new od(this, 6));
                }
                ...
                oVar.setMaxLines(2);
                oVar.setOnClickListener(new h60(this, 6));
        ...
        yd0 yd0Var2 = new yd0(this, context, 1);
        this.a = yd0Var2;
        yd0Var2.b(6, 1);
        while (r12 < r11) {
        }
        ...
        oVar2.setMaxLines(2);
        oVar2.setOnClickListener(new h60(this, 6));
    ...
    @Override // org.telegram.ui.Components.uv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new te0(this, 0), rg0.t0);
    }
    ...
    public final void n() {
        ...
        this.c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.D6, false));
