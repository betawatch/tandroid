...
public final class vc extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    ...
    public vc(cd cdVar, Activity activity) {
        ...
        this.b = ucVar;
        boolean z10 = cdVar.d;
        addView(ucVar, w7.x5.d(-1, z10 ? 230.0f : 190.0f, 80, 0.0f, 0.0f, 0.0f, z10 ? 24.0f : 0.0f));
        if (cdVar instanceof u60) {
            ...
            k5Var.setTextColor(cdVar.getThemedColor(i11));
    ...
    public final void e() {
        ...
        if (k5Var != null) {
            cd cdVar = this.h;
            int i10 = -1;
            k5Var.setTextColor((!cdVar.d || cdVar.s == -1) ? cdVar.getThemedColor(org.telegram.ui.ActionBar.j6.A8) : -1);
