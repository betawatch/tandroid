...
public final class e11 extends View {
    ...
    public e11(ProfileActivity profileActivity, Context context) {
        ...
        ofFloat.addListener(new j70(5, this, profileActivity.n1));
        profileActivity.n0.b(new d11(this));
    ...
    public final void c() {
        rz0 rz0Var;
        ProfileActivity profileActivity = this.n;
        if (profileActivity.T0 == null || (rz0Var = profileActivity.n0) == null || !profileActivity.p2) {
            return;
        }
