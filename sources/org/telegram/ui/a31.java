...
public final class a31 extends View {
    ...
    public String R;
    public boolean S;
    public final org.telegram.ui.Components.dc0 a;
    ...
    public a31(Context context) {
        ...
        this.x = new org.telegram.ui.Components.e6(1.0f, this, 0L, 2000L, prVar);
        ...
        dc0Var.N = true;
        dc0Var.r(this);
        Bitmap bitmap = dc0Var.k;
        Shader.TileMode tileMode = Shader.TileMode.MIRROR;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.c = bitmapShader;
        BitmapShader bitmapShader2 = new BitmapShader(dc0Var.k, tileMode, tileMode);
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.F != null) {
            ...
            if (this.M || (r21Var = this.e) == null) {
                return;
            }
            g31 g31Var = r21Var.a;
            g31Var.c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    */
    public final void b(int i10, int i11) {
        ...
        if ((TextUtils.isEmpty(this.G) && !this.r) || TextUtils.isEmpty(this.I)) {
            AndroidUtilities.runOnUIThread(new x21(this, 1));
            return;
        }
        ...
        int A = org.telegram.messenger.wl.A(20.0f, 2, createBitmap.getWidth());
        if (!this.r) {
            int i17 = 0;
            for (int i18 = 2; i17 <= i18; i18 = 2) {
                ...
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(org.telegram.ui.Cells.p6.i(" ", upperCase));
                if (!this.H) {
                ...
                if (i17 > 1 || measureText <= A) {
                    ...
                    i12 = 2;
                    f7 = 30.0f;
                    staticLayout = org.telegram.ui.Components.iw0.c(spannableStringBuilder, textPaint, i20, Layout.Alignment.ALIGN_CENTER, 0.0f, false, null, Math.min(AndroidUtilities.dp(10.0f) + i20, createBitmap.getWidth()), i19, true);
                    float lineCount = (staticLayout != null ? 0 : staticLayout.getLineCount()) * (textPaint.descent() - textPaint.ascent());
                    int A2 = org.telegram.messenger.wl.A(f7, i12, i10);
                    ...
                    this.Q = str;
                    this.R = this.I;
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.z21
                        @Override // java.lang.Runnable
                        public final void run() {
                            a31 a31Var = a31.this;
                            Bitmap bitmap2 = a31Var.h;
                            a31Var.h = createBitmap.extractAlpha();
                            if (!a31Var.S) {
                                a31Var.x.d(0.0f, true);
                            }
                            a31Var.S = false;
                            Bitmap bitmap3 = a31Var.n;
                            if (bitmap3 != null) {
                                bitmap3.recycle();
                            }
                            a31Var.n = bitmap2;
                            ...
                            if (r21Var != null) {
                                ...
                                float f14 = width3;
                                g31 g31Var = r21Var.a;
                                g31Var.c.set((int) (f13 - f12), (int) (f14 - f12), (int) (f13 + f12), (int) (f14 + f12));
                                g31Var.E.requestLayout();
                                a31Var.M = true;
                            }
                            a31Var.invalidate();
        ...
        int A22 = org.telegram.messenger.wl.A(f7, i12, i10);
    ...
    public final void d(boolean z10) {
        if (this.r) {
            ...
            this.w = org.telegram.ui.Components.iw0.c(Emoji.replaceEmoji(str, this.v.getFontMetricsInt(), false), this.v, getWidth(), Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, getWidth() - AndroidUtilities.dp(60.0f), 1, true);
        }
    }
