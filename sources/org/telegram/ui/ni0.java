...
public final class ni0 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.a) {
            ...
            default:
                cj0 cj0Var2 = this.b;
                lb0 lb0Var = cj0Var2.d;
                if (lb0Var != null) {
                    lb0Var.a(cj0Var2.E == 1.0f && cj0Var2.n != null);
                }
            ...
            case 1:
                ...
                if (!cj0Var.g0 || cj0Var.h0) {
                    ...
                    if (cj0Var.F.getWidth() > 0) {
                        int[] iArr = {org.telegram.messenger.wh.D(6.0f, cj0Var.W.getWidth() - cj0Var.W.l(), r2), 0};
                        ...
                        if (cj0Var.g0) {
                            org.telegram.messenger.wh.r(vi0Var.animate().translationY(((cj0Var.X.getHeight() + iArr[1]) - vi0Var.getMeasuredHeight()) - vi0Var.getTop()), ji.n.V, 250L);
                        } else {
                        ...
                        if (frameLayout != null) {
                            frameLayout.setX(org.telegram.messenger.q.c(6.0f, (cj0Var.X.l() + iArr[0]) - cj0Var.d0.getMeasuredWidth(), 0));
