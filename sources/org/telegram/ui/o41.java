...
public final class o41 extends og.b {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (((p41) arrayList.get(i10)).a != 7) {
            if (((p41) arrayList.get(i10)).a == 5) {
                ((org.telegram.ui.Cells.m4) view).setText(((p41) arrayList.get(i10)).d);
                return;
            }
            if (((p41) arrayList.get(i10)).a == 2) {
                org.telegram.ui.Cells.za zaVar = (org.telegram.ui.Cells.za) view;
                SaveToGallerySettingsHelper.DialogException dialogException = ((p41) arrayList.get(i10)).c;
                ...
                zaVar.d(userOrChat, str, dialogException.createDescription(i11), i10 == arrayList.size() - 1 || ((p41) arrayList.get(i10 + 1)).a == 2);
                return;
            }
            return;
        }
        ...
        if (i10 != saveToGallerySettingsActivity.h) {
            e9Var.setText(((p41) arrayList.get(i10)).d);
            return;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 8:
                ...
                q41 q41Var = new q41(saveToGallerySettingsActivity, saveToGallerySettingsActivity.getParentActivity());
                q41Var.setTextSize(AndroidUtilities.dp(13.0f));
                q41Var.setText(AndroidUtilities.formatFileSize(524288L, true, false));
                frameLayout.addView(q41Var, w7.y5.e(-2, -2, 83));
                q41 q41Var2 = new q41(saveToGallerySettingsActivity, saveToGallerySettingsActivity.getParentActivity());
                q41Var2.setTextSize(AndroidUtilities.dp(13.0f));
                frameLayout.addView(q41Var2, w7.y5.e(-2, -2, 81));
                q41 q41Var3 = new q41(saveToGallerySettingsActivity, saveToGallerySettingsActivity.getParentActivity());
                q41Var3.setTextSize(AndroidUtilities.dp(13.0f));
                q41Var3.setText(AndroidUtilities.formatFileSize(4194304000L, true, false));
                frameLayout.addView(q41Var3, w7.y5.e(-2, -2, 85));
                linearLayout.addView(frameLayout, w7.y5.t(-1, 20, 0, 21, 10, 21, 0));
                linearLayout.addView(to0Var, w7.y5.t(-1, 38, 0, 5, 0, 5, 4));
                long j3 = saveToGallerySettingsActivity.X().limitVideo;
                if (j3 < 0 || j3 > 4194304000L) {
                    j3 = 4194304000L;
                }
                to0Var.setReportChanges(true);
                to0Var.setDelegate(new n41(this, to0Var, q41Var, q41Var2, q41Var3));
                to0Var.setProgress(((float) j3) > ((float) SaveToGallerySettingsHelper.DEFAULT_VIDEO_LIMIT) * 0.7f ? a4.a.e(j3 - SaveToGallerySettingsHelper.DEFAULT_VIDEO_LIMIT, 4089446400L, 0.3f, 0.7f) : ((j3 - 524288) / 104333312) * 0.7f);
                to0Var.w.X(to0Var.getProgress(), false);
            ...
            case 10:
                ...
                b7Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.U0(saveToGallerySettingsActivity.getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.b7, saveToGallerySettingsActivity.getResourceProvider())));
                view2 = b7Var;
                view3 = view2;
                break;
        }
