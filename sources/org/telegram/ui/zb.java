...
public final class zb extends og.b {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i13 == 0) {
            ma1 ma1Var = (ma1) view;
            ma1Var.a(Integer.toString(bcVar.d.level), 0, null, LocaleController.getString(R.string.BoostsLevel2));
            TL_stats.TL_statsPercentValue tL_statsPercentValue = bcVar.d.premium_audience;
            if (tL_statsPercentValue != null) {
                double d = tL_statsPercentValue.total;
                if (d != 0.0d) {
                    ma1Var.a("≈" + ((int) bcVar.d.premium_audience.part), 1, String.format(Locale.US, "%.1f", Float.valueOf((((float) tL_statsPercentValue.part) / ((float) d)) * 100.0f)).concat("%"), LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? R.string.PremiumSubscribers : R.string.PremiumMembers));
                    ma1Var.a(String.valueOf(bcVar.d.boosts), 2, null, LocaleController.getString(R.string.BoostsExisting));
            ...
            ma1Var.a("≈0", 1, "0%", LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? R.string.PremiumSubscribers : R.string.PremiumMembers));
            ma1Var.a(String.valueOf(bcVar.d.boosts), 2, null, LocaleController.getString(R.string.BoostsExisting));
        ...
        if (i13 == 6) {
            ((org.telegram.ui.Cells.e9) view).setText(((ac) arrayList.get(i10)).c);
            return;
        }
        if (i13 == 9) {
        ...
        if (i13 == 3) {
            ((org.telegram.ui.Components.g90) view).setLink(((ac) arrayList.get(i10)).c);
            return;
        }
        if (i13 == 11) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                view = new ma1(bcVar.getContext(), 2);
                break;
            case 1:
                ...
                break;
            case 2:
                view = new org.telegram.ui.Cells.b7(viewGroup.getContext(), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.a7, false), 0);
                break;
            case 3:
                org.telegram.ui.Components.g90 g90Var = new org.telegram.ui.Components.g90(bcVar.getContext(), bcVar.c, null, false, false);
            ...
            case 9:
                ...
                n5Var.a(org.telegram.ui.ActionBar.h6.v6, org.telegram.ui.ActionBar.h6.u6);
                view = n5Var;
                break;
            case 10:
            ...
            case 13:
                ...
                ci.m6 m6Var = new ci.m6(this, sa1Var.getParentActivity());
                bcVar.f.setDelegate(new g(this, 11));
                m6Var.addView(bcVar.f, w7.y5.c(48.0f, -2));
                view = m6Var;
                break;
            default:
