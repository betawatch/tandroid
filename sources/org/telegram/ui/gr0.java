...
public final class gr0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public gr0(HashMap hashMap, ArrayList arrayList, int i10, boolean z10, bo boVar) {
        super(null);
        this.e = true;
        this.f = new Paint();
        this.n = new er0[2];
        this.a = new ar0(0, null, hashMap, arrayList, i10, z10, boVar, false);
        this.b = new ar0(1, null, hashMap, arrayList, i10, z10, boVar, false);
    }
    ...
    public final View createView(Context context) {
        ...
        this.d = juVar;
        juVar.setSizeNotifierLayout(dr0Var);
        int i13 = 0;
        while (i13 < 4) {
            View view = i13 != 0 ? i13 != 1 ? i13 != 2 ? ar0Var.c0 : ar0Var.b0 : ar0Var.a0 : ar0Var.Z;
            ((ViewGroup) view.getParent()).removeView(view);
            i13++;
        }
        FrameLayout frameLayout = ar0Var.Z;
        j0 j0Var = ar0Var.a0;
        s50 s50Var = ar0Var.b0;
        View view2 = ar0Var.c0;
        ...
        while (true) {
            ...
            er0Var6.addView(er0Var6.b, w7.x5.c(-1.0f, -1));
            er0 er0Var7 = er0VarArr[i14];
            er0Var7.addView(er0Var7.c, w7.x5.c(-2.0f, -1));
            er0VarArr[i14].c.setVisibility(8);
            er0VarArr[i14].d.setOnScrollListener(new ii.m3(7, this, er0VarArr[i14].d.getOnScrollListener()));
            i14++;
        }
        dr0Var.addView(this.actionBar, w7.x5.c(-2.0f, -1));
        dr0Var.addView(ar0Var.Z, w7.x5.e(-1, 48, 83));
        dr0Var.addView(ar0Var.a0, w7.x5.d(60, 60.0f, 85, 0.0f, 0.0f, 12.0f, 10.0f));
        dr0Var.addView(ar0Var.b0, w7.x5.d(42, 24.0f, 85, 0.0f, 0.0f, -2.0f, 9.0f));
