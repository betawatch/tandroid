...
public abstract class j00 extends FrameLayout {
    ...
    public j00(Context context, org.telegram.ui.ActionBar.n2 n2Var, int i10, int i11) {
        ...
        j6Var2.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.z6, false));
    ...
    public final void a() {
        ...
        ConnectionsManager.getInstance(this.b).sendRequest(tL_chatlists_deleteExportedInvite, new gg(25, this, i00Var));
    ...
    public void c() {
        ...
        if (n2Var instanceof q00) {
            hh.f1 f1Var = ((q00) n2Var).a;
            org.telegram.ui.Components.b70 H = org.telegram.ui.Components.b70.H(n2Var, this);
            H.W(f1Var.V0(this, false));
            H.c(R.drawable.msg_qrcode, LocaleController.getString(R.string.GetQRCode), new i00(this, 0), false);
            H.c(R.drawable.msg_delete, LocaleController.getString(R.string.DeleteLink), new i00(this, 1), true);
    ...
    public final void d() {
        ...
        org.telegram.ui.Components.yh0 yh0Var = new org.telegram.ui.Components.yh0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.s) {
            ...
            this.w.addListener(new go(29, this, z12));
            this.w.setInterpolator(org.telegram.ui.Components.er.h);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        String str = "";
        sb2.append((tL_exportedChatlistInvite == null || TextUtils.isEmpty(tL_exportedChatlistInvite.title)) ? "" : a9.p.p(new StringBuilder(), this.y.title, "\n "));
