                        ...
                        switch (i10) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    keVar3.c1.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.qr.h).withEndAction(new od(keVar3, 6)).start();
                                    keVar3.a0();
                                    break;
                                }
                                break;
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    keVar32.c1.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.qr.h).withEndAction(new od(keVar32, 6)).start();
                                    keVar32.a0();
                                    break;
                                }
                                break;
