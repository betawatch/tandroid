...
public final class fv extends LinearLayout {
    ...
    public fv(int i10, Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        this.c = kpVar;
        ec1 ec1Var = new ec1(getContext(), 8, e6Var);
        this.a = ec1Var;
        ec1Var.setAdapter(kpVar);
        ...
        ec1Var.setOnItemClickListener(new ai.o6(15, this, n2Var));
    ...
    public final void a() {
        ...
        if (i10 == 0 || i10 == -1) {
            ...
            if (xi0Var != null) {
                xi0Var.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.q6, false), PorterDuff.Mode.SRC_IN));
            }
    ...
    public final void d() {
        ...
        while (true) {
            ...
            org.telegram.ui.ActionBar.h6 j3 = ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).a.j(this.v);
            if (tL_theme != null) {
                if (org.telegram.ui.ActionBar.i6.I.a.equals(org.telegram.ui.ActionBar.i6.q0(tL_theme.settings.get(((org.telegram.ui.ActionBar.c4) ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).a.f.get(this.v)).d)))) {
                ...
                if (j3 != null) {
                    if (org.telegram.ui.ActionBar.i6.I.a.equals(j3.m())) {
                        if (((org.telegram.ui.ActionBar.c4) ((org.telegram.ui.Components.lp) kpVar.d.get(i10)).a.f.get(this.v)).e == org.telegram.ui.ActionBar.i6.I.Y) {
                            this.r = i10;
                            break;
                        }
                    } else {
