...
public final /* synthetic */ class le implements Runnable {
    ...
    public /* synthetic */ le(bo boVar, int i10) {
        this.a = i10;
        this.b = boVar;
    }
        ...
        switch (i11) {
            case 0:
                ...
                if (boVar.getParentActivity() != null) {
                    ...
                    alertDialog$Builder.k(LocaleController.getString(R.string.JoinByPeekJoin), new ue(boVar, i12));
                    alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new ue(boVar, 1));
            ...
            case 3:
                ...
                break;
            case 4:
                if (!org.telegram.ui.ActionBar.n2.hasSheets(boVar) && (mkVar = boVar.Y) != null) {
            ...
            case 5:
                boVar.o9();
                AndroidUtilities.forEachViews((RecyclerView) boVar.x0, (e2.h) new hg(boVar, 1));
                boVar.u7();
                dk dkVar = boVar.X2;
                if (dkVar != null) {
                ...
                ck ckVar = boVar.Y2;
                if (ckVar != null) {
                    ckVar.setTranslationX(boVar.R8() / 2.0f);
                }
            ...
            case 21:
                ...
                if (glVar != null) {
                    ...
                    animatorSet.addListener(new xi(boVar, i12));
                    animatorSet.start();
                    break;
                }
                break;
                        ...
                        for (int i14 = 0; i14 < childCount2; i14++) {
                            ...
                            if ((childAt2 instanceof org.telegram.ui.Cells.t1) && (messageObject = (t1Var = (org.telegram.ui.Cells.t1) childAt2).getMessageObject()) != null && messageObject.isOutOwner() && messageObject.isSent()) {
                                ...
                                if (i16 > AndroidUtilities.dp(10.0f) + qpVar3.getMeasuredHeight()) {
                                    int C = org.telegram.messenger.y0.C(6.0f, t1Var.getChecksY(), i16);
