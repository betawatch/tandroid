...
public final class lc1 extends org.telegram.ui.Components.yk0 {
    ...
    public final void v(f2.o1 o1Var, int i10) {
        BlendMode blendMode;
        org.telegram.ui.Cells.h5 h5Var = (org.telegram.ui.Cells.h5) o1Var.a;
        nc1 nc1Var = this.d;
        h5Var.setPattern((TLRPC.TL_wallPaper) nc1Var.Q0.get(i10));
        h5Var.getImageReceiver().setColorFilter(new PorterDuffColorFilter(nc1Var.f1, nc1Var.o1));
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            } else if (nc1Var.x1 instanceof wh1) {
                i11 = nc1Var.Y0;
            }
            if (i11 == 0 || nc1Var.h1 < 0.0f) {
                h5Var.getImageReceiver().setBlendMode(null);
                return;
            }
            ImageReceiver imageReceiver = nc1Var.t0.getImageReceiver();
    ...
    public final f2.o1 x(ViewGroup viewGroup, int i10) {
        ...
        org.telegram.ui.Cells.h5 h5Var = new org.telegram.ui.Cells.h5(this.c);
        h5Var.C = new RectF();
