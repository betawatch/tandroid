...
public abstract class cg1 extends org.telegram.ui.Components.ga {
            ...
            if (eg1Var.getParentLayout() == null || !((ActionBarLayout) eg1Var.getParentLayout()).y()) {
                ...
                if ((action == 1 || action == 3) && eg1Var.y == 2 && eg1Var.x > 0 && (L0 = (c0Var = (s4.c0) getLayoutManager()).L0()) == 0) {
                    ...
                    if (measuredHeight < dp || currentTimeMillis < 200) {
                        ...
                        if (this.f3 == 0.0f) {
                            v0(0, m10.getTop() - paddingTop, org.telegram.ui.Components.qr.h);
                        }
                        if (!eg1Var.Z) {
                            eg1Var.Z = true;
                            try {
                    ...
                    if (f7 != 0.0f) {
                        ...
                        ofFloat.addUpdateListener(new a21(this, 19));
                        ...
                        ofFloat.addListener(new cr0(this, 24));
                        ofFloat.start();
                    }
                }
                return onTouchEvent;
