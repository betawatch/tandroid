...
public final class z60 extends org.telegram.ui.Components.uk0 {
        ...
        if (b70Var.P || b70Var.O || z10) {
            ...
            if (z10) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    if (DialogObject.isUserDialog(dialog.id) && !hashSet.contains(Long.valueOf(dialog.id)) && (user = b70Var.getMessagesController().getUser(Long.valueOf(dialog.id))) != null && !UserObject.isDeleted(user) && !UserObject.isUserSelf(user) && !UserObject.isBot(user) && !UserObject.isService(dialog.id) && !MessagesController.isSupportUser(user)) {
                        this.r.add(user);
                ...
                for (int i12 = 0; i12 < size2; i12++) {
                    ...
                    if (DialogObject.isChatDialog(dialog2.id) && (chat = b70Var.getMessagesController().getChat(Long.valueOf(-dialog2.id))) != null && chat.migrated_to == null && (!ChatObject.isChannel(chat) || chat.megagroup)) {
                        this.r.add(chat);
                    }
                }
            }
            Collections.sort(this.r, new v60());
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        return !(object instanceof TLRPC.User) || b70Var.J.h(((TLRPC.User) object).id) < 0;
    }
    ...
    public final void L(String str) {
        ...
        gg.c2 c2Var = this.f;
        b70 b70Var = this.I;
        c2Var.g(null, true, b70Var.O || b70Var.P, false, false, 0L, false, 0, 0);
        l();
        if (TextUtils.isEmpty(str)) {
            return;
        }
    ...
    public final int j(int i10) {
        ...
        ArrayList arrayList = this.r;
        return (i11 >= arrayList.size() || !(arrayList.get(i10 - this.E) instanceof a70)) ? 1 : 0;
    }
            ...
            if (this.n) {
                ...
                if (i12 >= 0 && i12 < arrayList.size()) {
                    ...
                    if (tLObject2 instanceof a70) {
                        v3Var.setText(((a70) tLObject2).a.toUpperCase());
                    }
                }
            }
            if (i10 == this.v) {
                v3Var.b((b70Var.X == null && b70Var.Z.i()) ? "" : LocaleController.getString(R.string.DeselectAll), new h60(this, 2));
                return;
            }
            return;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        return new org.telegram.ui.Components.wk0(v3Var);
    }
}
