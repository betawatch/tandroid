...
public class z60 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate, le.e, View.OnClickListener, ph.d {
    ...
    public static void U(z60 z60Var, Context context, View view, int i10) {
        ...
        if (i10 == x60Var.w) {
            ...
            ConnectionsManager.getInstance(i13).sendRequest(createconferencecall, new ai.ya(i13, a2Var, context, d6Var, p60Var, 3));
            return;
        }
    ...
    public static void Z(z60 z60Var) {
        ...
        z60Var.c.a(!z60Var.Z.i(), true);
    }

    public static void a0(z60 z60Var, Canvas canvas, RectF rectF, Paint paint) {
        fh.d dVar;
        canvas.drawRect(rectF, paint);
        if (Build.VERSION.SDK_INT < 29 || !SharedConfig.chatBlurEnabled() || (dVar = z60Var.q0) == null) {
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        if (z13) {
            ...
            dVar2.setOnClickListener(new q60(this, i15));
    ...
    */
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.g4) {
                ...
                if (RecyclerView.R(childAt) == this.v.v) {
                    ((org.telegram.ui.Cells.v3) childAt).b((this.X == null && this.Z.i()) ? "" : LocaleController.getString(R.string.DeselectAll), new q60(this, 4));
                }
            }
        }
    }
            ...
            if (!z10) {
                ...
                if (this.E) {
                    ...
                    if (this.O || this.P) {
                        v60 v60Var = this.w;
                        if (v60Var != null) {
                            v60Var.b(arrayList2, this.X != null, this.Y != null);
                        }
                        finishFragment();
                        return true;
                    }
                ...
                if (this.Z.m() > 5) {
                    ...
                    a2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.AddMembersAlertNamesText, sb2, chat != null ? chat.title : ""));
                }
                ...
                if (!ChatObject.isChannel(chat)) {
                    ...
                    a2VarArr[0].setOnClickListener(new r20(a2VarArr, i12));
                    alertDialog$Builder.n(linearLayout);
                }
                alertDialog$Builder.k(LocaleController.getString(R.string.Add), new ow(i17, this, a2VarArr));
    ...
    public final void q0(int i10) {
        ...
        AndroidUtilities.doOnPreDraw(this.n, new org.telegram.ui.Components.ld(this, i10, 16));
    }
    ...
    public final void r0() {
        ...
        if (this.R || ((x60Var = this.v) != null && x60Var.G == 0)) {
