...
public final class bm0 implements om0 {
    ...
    public final void c(TLRPC.TL_secureRequiredType tL_secureRequiredType, String str, String str2, TLRPC.TL_secureRequiredType tL_secureRequiredType2, String str3, ArrayList arrayList, SecureDocument secureDocument, ArrayList arrayList2, SecureDocument secureDocument2, SecureDocument secureDocument3, Runnable runnable, i6 i6Var) {
        ...
        if (!isEmpty) {
            ...
            af.h k12 = xm0Var.k1(AndroidUtilities.getStringBytes(str2));
        ...
        if (tL_secureRequiredType2 != null) {
            ...
            if (!TextUtils.isEmpty(str3)) {
                ...
                af.h k13 = xm0Var.k1(AndroidUtilities.getStringBytes(str3));
            ...
            if (!z10) {
                ...
                ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue, new am0(this, i6Var, str, savesecurevalue, tL_secureRequiredType2, tL_secureRequiredType, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, runnable, this, tL_inputSecureValue2));
            }
        ...
        savesecurevalue2.secure_secret_id = xm0Var.X0;
        i10 = ((org.telegram.ui.ActionBar.n2) xm0Var).currentAccount;
        ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue2, new am0(this, i6Var, str, savesecurevalue2, tL_secureRequiredType2, tL_secureRequiredType, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, runnable, this, tL_inputSecureValue2));
    }
}
