...
public final class xz0 extends org.telegram.ui.Components.qv0 implements r0.n {
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        if (viewGroup == profileActivity.a) {
            ...
            if (i11 >= 0) {
                if (z4) {
                    org.telegram.ui.Components.rl0 currentListView2 = profileActivity.L.getCurrentListView();
                    iArr[1] = i11;
                    if (top > 0) {
                        iArr[1] = 0;
                    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.j50 j50Var = profileActivity.u0;
        ...
        if (profileActivity.t0 != null) {
            ...
            if (view2 == kVar.getBackButton()) {
                ...
                paint2.setAlpha((int) (((j50Var.getAlpha() / 255.0f) * alpha) / 0.3f));
                float f10 = max;
        ...
        canvas.translate(ty0Var != null ? ty0Var.getTranslationX() : 0.0f, 0.0f);
        int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.d6, profileActivity.w0);
        int i13 = profileActivity.i6;
        ty0 ty0Var2 = profileActivity.a;
        AndroidUtilities.drawNavigationBarProtection(canvas, this, v03, i13, ty0Var2 != null ? ty0Var2.getAlpha() : 0.0f);
        canvas.restore();
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (zz0Var != null && (qt0Var = (qt0VarArr = zz0Var.h0)[0]) != null && qt0Var.h.getFastScroll() != null && qt0VarArr[0].h.getFastScroll().n) {
    ...
    public final void i(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ...
        try {
            if (viewGroup == profileActivity.a && profileActivity.N) {
                org.telegram.ui.Components.rl0 currentListView = profileActivity.L.getCurrentListView();
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        boolean z4;
        char c3;
        org.telegram.ui.Components.lr[] lrVarArr;
        int measuredWidth;
        int max;
        View view;
        int i12;
        ...
        ProfileActivity profileActivity = this.A0;
        org.telegram.ui.Components.lr[] lrVarArr2 = profileActivity.H;
        org.telegram.ui.Components.lr[] lrVarArr3 = profileActivity.G;
        ...
        org.telegram.ui.Components.rl0 rl0Var = profileActivity.b;
        if (rl0Var != null) {
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) rl0Var.getLayoutParams();
        ...
        if (profileActivity.z0 == getMeasuredWidth() && profileActivity.A0 == getMeasuredHeight()) {
            ...
            while (i15 < i18) {
                ...
                org.telegram.ui.Components.lr[] lrVarArr4 = lrVarArr2;
        ...
        if (!z14 && ((z13 = profileActivity.k1) || (profileActivity.D1 && profileActivity.G1 == 2))) {
            ...
            if (z13) {
                ...
                if (em0Var != null) {
                    em0Var.b(Color.argb(179, 255, 255, 255));
                }
                Drawable drawable = profileActivity.x;
                if (drawable != null) {
                    drawable.setColorFilter(-1, PorterDuff.Mode.MULTIPLY);
                }
                org.telegram.ui.Components.lr lrVar = lrVarArr3[0];
                if (lrVar != null) {
                    lrVar.b(1.0f);
                }
                org.telegram.ui.Components.lr lrVar2 = lrVarArr3[1];
                if (lrVar2 != null) {
                    lrVar2.b(1.0f);
                }
                org.telegram.ui.Components.lr lrVar3 = lrVarArr[0];
                if (lrVar3 != null) {
                    lrVar3.b(1.0f);
                }
                org.telegram.ui.Components.lr lrVar4 = lrVarArr[1];
                if (lrVar4 != null) {
                    lrVar4.b(1.0f);
                }
                ...
                if (kh0Var != null) {
                    kh0Var.setParentExpanded(1.0f);
                }
                org.telegram.ui.Components.di0 di0Var = profileActivity.Z;
                if (di0Var != null) {
                    di0Var.setParentExpanded(1.0f);
                }
            ...
            ty0 ty0Var2 = profileActivity.a;
            ty0Var2.layout(0, i16, ty0Var2.getMeasuredWidth(), profileActivity.a.getMeasuredHeight() + i16);
            this.v0 = false;
            ...
            if (view == null && (view = profileActivity.a.getChildAt(0)) != null) {
                ty0 ty0Var3 = profileActivity.a;
                View F = ty0Var3.F(view);
                f2.l1 T = F == null ? null : ty0Var3.T(F);
                i12 = T.b();
                if (i12 == -1 && (i12 = T.g) == -1) {
                    i12 = T.c;
                }
                    ...
                    if (i21 >= 0) {
                        ...
                        if ((z4 && profileActivity.l2) || view == null) {
                            ...
                            if (z11) {
                                measureChildWithMargins(profileActivity.a, i10, 0, i11, 0);
                                try {
                                    ty0 ty0Var4 = profileActivity.a;
                                    ty0Var4.layout(0, i16, ty0Var4.getMeasuredWidth(), profileActivity.a.getMeasuredHeight() + i16);
                                } catch (Exception e) {
                                    FileLog.e(e);
                                }
                            }
