...
public final class hc1 extends org.telegram.ui.Components.ll0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        switch (i23) {
            ...
            case 12:
                ...
                jc1 jc1Var = (jc1) ml0Var.getAdapter();
                jc1Var.l();
                ...
                if (indexOf != -1) {
                    ((s4.c0) ml0Var.getLayoutManager()).h1(indexOf, (themeActivity.b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                    break;
                }
                break;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 5:
                ...
                break;
            case 6:
                i5Var = new cc1(this, context);
                break;
            case 7:
                i5Var = new org.telegram.ui.Cells.w8(context);
                break;
            case 8:
                i5Var = new ic1(themeActivity, context);
                break;
            case 9:
            ...
            case 12:
                ...
                fc1Var.setOnItemLongClickListener(new tv0(12, this, jc1Var));
                fc1Var.setLayoutParams(new s4.p0(-1, AndroidUtilities.dp(62.0f)));
                i5Var = fc1Var;
                break;
            case 13:
                i5Var = new xb1(themeActivity, context);
                break;
            case 14:
            case 18:
            default:
            ...
            case 15:
                ...
                uy0Var.a = paint;
                uy0Var.b = new Paint(1);
                Paint paint2 = new Paint(1);
                uy0Var.c = paint2;
                Paint paint3 = new Paint(1);
                uy0Var.d = paint3;
                uy0Var.e = new RectF();
                uy0Var.h = new String[]{LocaleController.getString(R.string.SwipeSettingsPin), LocaleController.getString(R.string.SwipeSettingsRead), LocaleController.getString(R.string.SwipeSettingsArchive), LocaleController.getString(R.string.SwipeSettingsMute), LocaleController.getString(R.string.SwipeSettingsDelete), LocaleController.getString(R.string.SwipeSettingsFolders)};
                uy0Var.n = new int[]{r14, r14, r14, r14, org.telegram.ui.ActionBar.j6.Y5, org.telegram.ui.ActionBar.j6.d9};
                uy0Var.r = new org.telegram.ui.Components.yi0[6];
                uy0Var.v = new org.telegram.ui.Components.bj0[2];
                uy0Var.x = 1.0f;
                ...
                org.telegram.ui.Components.ty0 ty0Var = new org.telegram.ui.Components.ty0(uy0Var, context);
                uy0Var.f = ty0Var;
                ty0Var.setMinValue(0);
                ty0Var.setDrawDividers(false);
                boolean isEmpty = MessagesController.getInstance(i11).dialogFilters.isEmpty();
                ty0Var.setMaxValue(isEmpty ? 4 : 5);
                ty0Var.setAllItemsCount(isEmpty ? 5 : 6);
                ty0Var.setWrapSelectorWheel(true);
                ty0Var.setFormatter(new org.telegram.ui.Components.sy0(uy0Var));
                ty0Var.setOnValueChangedListener(new org.telegram.ui.Components.sy0(uy0Var));
                ty0Var.setImportantForAccessibility(2);
                ty0Var.setValue(SharedConfig.getChatSwipeAction(i11));
                uy0Var.addView(ty0Var, w7.x5.d(132, -1.0f, 5, 21.0f, 0.0f, 21.0f, 0.0f));
                uy0Var.setWillNotDraw(false);
                uy0Var.s = 0;
                for (int i16 = 0; i16 < 2; i16++) {
                    uy0Var.v[i16] = new org.telegram.ui.Components.bj0(context);
                    uy0Var.addView(uy0Var.v[i16], w7.x5.d(28, 28.0f, 21, 0.0f, 0.0f, 184.0f, 0.0f));
                }
                org.telegram.ui.Components.yi0 a2 = uy0Var.a(uy0Var.f.getValue());
                if (a2 != null) {
                    uy0Var.v[0].setImageDrawable(a2);
                    a2.M(a2.e[0] - 1);
                }
                AndroidUtilities.updateViewVisibilityAnimated(uy0Var.v[0], true, 0.5f, false);
                AndroidUtilities.updateViewVisibilityAnimated(uy0Var.v[1], false, 0.5f, false);
                uy0Var.w = uy0Var.f.getValue() != 5 ? 0.0f : 1.0f;
                uy0Var.F = uy0Var.f.getValue();
                i5Var = uy0Var;
                break;
            case 16:
                e5Var = ((org.telegram.ui.ActionBar.o2) themeActivity).parentLayout;
                View gc1Var = new gc1(context, e5Var, 0);
        ...
        return new org.telegram.ui.Components.wk0(i5Var);
    }
