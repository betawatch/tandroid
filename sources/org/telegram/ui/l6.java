...
public final class l6 extends FrameLayout {
    ...
    public l6(a7 a7Var, Context context) {
        super(context);
        this.E = a7Var;
    ...
    public final void b(float f7, float f10, boolean z10) {
        ...
        if (z10) {
            ...
            if (f7 < 0.01f) {
                textViewArr[1].setText(LocaleController.formatString(R.string.StorageUsageTelegramLess, a7.a0(a7Var, f7)));
            } else {
                textViewArr[1].setText(LocaleController.formatString(R.string.StorageUsageTelegram, a7.a0(a7Var, f7)));
            }
            c(1);
        } else {
            c(2);
    ...
    public final void d(TextView textView, boolean z10, boolean z11) {
        ...
        if (!z10) {
            final int i10 = 1;
            textView.animate().alpha(0.0f).translationY(AndroidUtilities.dp(8.0f)).setListener(new org.telegram.ui.Components.aa(textView)).setInterpolator(org.telegram.ui.Components.qr.h).setDuration(340L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.k6
        ...
        final int i11 = 0;
        textView.animate().alpha(1.0f).translationY(0.0f).setInterpolator(org.telegram.ui.Components.qr.h).setDuration(340L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.k6
            public final /* synthetic */ l6 b;
