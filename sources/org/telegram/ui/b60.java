...
public final class b60 extends FrameLayout {
    ...
    public final void a(double d, boolean z4) {
        ...
        if (z4) {
            ...
            if (groupCallParticipant.volume == 0) {
                ...
                e60Var.d1(true);
                e60Var.x1(groupCallParticipant, peerId, e60Var.Q0() ? 0 : 5);
            } else {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        fArr[1] = dp2;
        fArr[0] = dp2;
        float dp3 = AndroidUtilities.dp(6.0f) * (b60Var.n < AndroidUtilities.dp(12.0f) ? Math.max(0.0f, (b60Var.n - AndroidUtilities.dp(6.0f)) / AndroidUtilities.dp(6.0f)) : 1.0f);
        fArr[5] = dp3;
        fArr[4] = dp3;
        fArr[3] = dp3;
        fArr[2] = dp3;
        float f13 = b60Var.n;
        float measuredHeight = b60Var.getMeasuredHeight();
        RectF rectF = b60Var.y;
        rectF.set(0.0f, 0.0f, f13, measuredHeight);
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        path.close();
        Canvas canvas2 = canvas;
        canvas2.drawPath(path, paint);
        int participantVolume = (int) (ChatObject.getParticipantVolume(b60Var.c) / 100.0d);
        org.telegram.ui.Components.jj0 jj0Var = b60Var.a;
