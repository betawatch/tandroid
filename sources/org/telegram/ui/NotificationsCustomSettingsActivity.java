...
public class NotificationsCustomSettingsActivity extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public NotificationsCustomSettingsActivity(int i10, ArrayList arrayList, ArrayList arrayList2, boolean z10) {
        ...
        if (arrayList != null) {
            ...
            for (int i14 = 0; i14 < size; i14++) {
                bk0 bk0Var = (bk0) this.w.get(i14);
                this.x.put(Long.valueOf(bk0Var.d), bk0Var);
            }
        }
        ...
        if (arrayList3 != null) {
            ...
            for (int i15 = 0; i15 < size2; i15++) {
                ...
                this.x.put(Long.valueOf(bk0Var2.d), bk0Var2);
            }
        }
        if (z10) {
            j0();
    ...
    */
    public static void U(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, Context context, View view, int i10, float f9, float f10) {
        HashMap hashMap;
        bk0 bk0Var;
        ArrayList arrayList;
        boolean z10;
        ...
        vj0 vj0Var = (notificationsCustomSettingsActivity2.a.getAdapter() != notificationsCustomSettingsActivity2.b || i10 < 0 || i10 >= arrayList2.size()) ? null : (vj0) arrayList2.get(i10);
        if (vj0Var != null && vj0Var.a == 8) {
        ...
        if (i12 != 3 || vj0Var == null) {
            hashMap = hashMap2;
        } else {
            hashMap = hashMap2;
            bk0 bk0Var4 = vj0Var.g;
            if (bk0Var4 != null) {
                org.telegram.ui.Components.j70 H = org.telegram.ui.Components.j70.H(notificationsCustomSettingsActivity2, view);
                H.i = 3;
                H.m(bk0Var4.c <= 0 || bk0Var4.f, R.drawable.msg_mute, LocaleController.getString(R.string.NotificationsStoryMute), false, new oj0(notificationsCustomSettingsActivity2, bk0Var4, view, i10, 5));
                H.m(bk0Var4.c > 0 || bk0Var4.f, R.drawable.msg_unmute, LocaleController.getString(R.string.NotificationsStoryUnmute), false, new oj0(notificationsCustomSettingsActivity, bk0Var4, view, i10, 0));
                H.m(!bk0Var4.f, R.drawable.msg_delete, LocaleController.getString("DeleteException", R.string.DeleteException), true, new oj0(notificationsCustomSettingsActivity, bk0Var4, view, i10, 1));
        ...
        if (i12 == 3) {
            ...
            yj0 yj0Var = notificationsCustomSettingsActivity2.d;
            if (adapter == yj0Var) {
                Object E = yj0Var.E(i10);
                if (E instanceof bk0) {
                    bk0Var3 = (bk0) E;
                } else {
                    ...
                    if (!hashMap.containsKey(Long.valueOf(j10))) {
                        ...
                        bk0Var5.d = j10;
                        if (z16) {
                            bk0Var5.d = ((TLRPC.User) E).id;
                        } else {
                            bk0Var5.d = -((TLRPC.Chat) E).id;
                        }
                        bk0Var2 = bk0Var5;
                        z15 = true;
                        if (bk0Var2 != null) {
                        ...
                        org.telegram.ui.Components.j70 H2 = org.telegram.ui.Components.j70.H(notificationsCustomSettingsActivity2, view);
                        H2.i = 3;
                        H2.m(bk0Var2.c <= 0 || bk0Var2.f, R.drawable.msg_mute, LocaleController.getString(R.string.NotificationsStoryMute), false, new oj0(notificationsCustomSettingsActivity2, bk0Var2, view, z15, 2));
                        H2.m(bk0Var2.c > 0 || bk0Var2.f, R.drawable.msg_unmute, LocaleController.getString(R.string.NotificationsStoryUnmute), false, new oj0(notificationsCustomSettingsActivity, bk0Var2, view, z15, 3));
                        H2.m((z15 || bk0Var2.f) ? false : true, R.drawable.msg_delete, LocaleController.getString("DeleteException", R.string.DeleteException), true, new oj0(notificationsCustomSettingsActivity, bk0Var2, view, i10, 4));
                        H2.W(notificationsCustomSettingsActivity.a.V0(view, false));
                        H2.Z();
                        return;
                    }
                    bk0Var3 = (bk0) hashMap.get(Long.valueOf(j10));
                }
                bk0Var2 = bk0Var3;
                z15 = false;
                if (bk0Var2 != null) {
        ...
        if (notificationsCustomSettingsActivity2.a.getAdapter() == notificationsCustomSettingsActivity2.d || !(vj0Var == null || vj0Var.g == null)) {
            f2.p0 adapter2 = notificationsCustomSettingsActivity2.a.getAdapter();
            yj0 yj0Var2 = notificationsCustomSettingsActivity2.d;
            if (adapter2 == yj0Var2) {
                Object E2 = yj0Var2.E(i10);
                if (E2 instanceof bk0) {
                    ...
                    if (hashMap.containsKey(Long.valueOf(j11))) {
                        bk0Var = (bk0) hashMap.get(Long.valueOf(j11));
                        z11 = false;
                    } else {
                        bk0 bk0Var6 = new bk0();
                        bk0Var6.d = j11;
                        if (z17) {
                            bk0Var6.d = ((TLRPC.User) E2).id;
                        } else {
                            bk0Var6.d = -((TLRPC.Chat) E2).id;
                        }
                        bk0Var = bk0Var6;
                        z11 = true;
                    }
            ...
            long j12 = bk0Var7.d;
            org.telegram.ui.Components.jo joVar = new org.telegram.ui.Components.jo(context, notificationsCustomSettingsActivity2.currentAccount, null, true, new sj0(notificationsCustomSettingsActivity2, j12, NotificationsController.getInstance(notificationsCustomSettingsActivity2.currentAccount).isGlobalNotificationsEnabled(j12, false, false), bk0Var7, z10, i10, arrayList3), notificationsCustomSettingsActivity.getResourceProvider());
            joVar.d(j12, 0, null);
            joVar.c(notificationsCustomSettingsActivity, view, f9, f10, false);
            return;
        }
        if (vj0Var == null) {
            return;
        ...
        if (i13 == 6) {
            ...
            fyVar.y2 = new pj0(notificationsCustomSettingsActivity2);
            notificationsCustomSettingsActivity2.presentFragment(fyVar);
            return;
        }
        if (i13 == 7) {
            ...
            alertDialog$Builder.k(LocaleController.getString("Delete", R.string.Delete), new pj0(notificationsCustomSettingsActivity2));
        ...
        if (i13 == 100 || i13 == 101) {
            ...
            final pa paVar = new pa(notificationsCustomSettingsActivity2, i14);
            ...
            while (i17 < 5) {
                if (strArr2[i17] == null) {
                    ...
                    if (i17 == 4) {
                        strArr = strArr2;
                        textView2.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.q7, r12));
                        i11 = i16;
                        drawable2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.p7, r12), PorterDuff.Mode.MULTIPLY));
                        drawable = null;
                        z13 = false;
                    } else {
                        i11 = i16;
                        strArr = strArr2;
                        drawable = null;
                        textView2.setTextColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.j5, r12));
                        z13 = false;
                        drawable2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.J5, r12), PorterDuff.Mode.MULTIPLY));
                    }
                    ...
                    linearLayout.addView(textView2, i7.f6.q(-1, 48, 51));
                    final NotificationsCustomSettingsActivity notificationsCustomSettingsActivity3 = notificationsCustomSettingsActivity2;
                    final int i18 = i11;
                    View.OnClickListener onClickListener = new View.OnClickListener(i18, isGlobalNotificationsEnabled2, i15, notificationsCustomSettingsActivity3, arrayList4, arrayList5, paVar, alertDialog$Builder2) { // from class: org.telegram.ui.Components.s2
                        public final /* synthetic */ int a;
                        public final /* synthetic */ int b;
                        public final /* synthetic */ NotificationsCustomSettingsActivity c;
                        public final /* synthetic */ ArrayList d;
                        public final /* synthetic */ ArrayList e;
                        public final /* synthetic */ org.telegram.ui.pa f;
                        ...
                        public final void onClick(View view2) {
                            ...
                            if (i22 < 0 || !tc.a(notificationsCustomSettingsActivity4)) {
                                return;
                            }
                            tc.z(notificationsCustomSettingsActivity4, i22, 0, null).j();
                        }
                    };
        ...
        if (i13 == 3) {
            if (view.isEnabled()) {
                try {
                    ...
                    notificationsCustomSettingsActivity2.presentFragment(new gk0(bundle2, notificationsCustomSettingsActivity2.getResourceProvider()));
                    return;
                } catch (Exception e10) {
                    FileLog.e(e10);
                    return;
        ...
        if (vj0Var.a == 3) {
            if (view.isEnabled()) {
                notificationsCustomSettingsActivity2.showDialog(org.telegram.ui.Components.c5.u(notificationsCustomSettingsActivity2.getParentActivity(), 0L, 0, notificationsCustomSettingsActivity2.s, new qj0(notificationsCustomSettingsActivity2, view, i10, 0), null));
                return;
            }
            return;
        }
        if (i13 == 2) {
            if (view.isEnabled()) {
                ...
                qj0 qj0Var = new qj0(notificationsCustomSettingsActivity2, view, i10, 1);
                ...
                LinearLayout f11 = org.telegram.messenger.x3.f(parentActivity, 1);
                AlertDialog$Builder alertDialog$Builder3 = new AlertDialog$Builder(parentActivity);
                int i19 = 0;
                while (i19 < 4) {
                    org.telegram.ui.Cells.i6 i6Var = new org.telegram.ui.Cells.i6(parentActivity, null);
                    ...
                    i6Var.b(strArr3[i19], iArr2[0] == i19);
                    f11.addView(i6Var);
                    i6Var.setOnClickListener(new lh.n5(iArr2, i12, alertDialog$Builder3, qj0Var, 2));
                    i19++;
                }
        ...
        if (i13 == 1) {
            if (view.isEnabled()) {
                ...
                notificationsCustomSettingsActivity2.showDialog(org.telegram.ui.Components.c5.Y(notificationsCustomSettingsActivity2.getParentActivity(), 0L, 0L, str, new vs(notificationsCustomSettingsActivity2, view, str, i10, 4), null));
                return;
            }
            return;
        }
        if (i13 == 4) {
            if (view.isEnabled()) {
                notificationsCustomSettingsActivity2.showDialog(org.telegram.ui.Components.c5.I(notificationsCustomSettingsActivity2.getParentActivity(), 0L, 0, notificationsCustomSettingsActivity2.s, new qj0(notificationsCustomSettingsActivity2, view, i10, 2), null));
                return;
            }
            return;
        }
        if (i13 == 102) {
            if (view.isEnabled()) {
                ...
                if (view instanceof org.telegram.ui.Cells.q8) {
                    ((org.telegram.ui.Cells.q8) view).setChecked(notificationsCustomSettingsActivity2.r);
                }
                edit2.commit();
        ...
        if (i13 == 103 || i13 == 104) {
            boolean z23 = !LocaleController.isRTL ? f9 <= ((float) (view.getMeasuredWidth() - AndroidUtilities.dp(76.0f))) : f9 >= ((float) AndroidUtilities.dp(76.0f));
            SharedPreferences notificationsSettings4 = notificationsCustomSettingsActivity2.getNotificationsSettings();
            if (z23) {
                String str2 = vj0Var.c == 103 ? "EnableReactionsMessages" : "EnableReactionsStories";
            ...
            String str3 = vj0Var.c == 103 ? "EnableReactionsMessagesContacts" : "EnableReactionsStoriesContacts";
            ...
            int i20 = 0;
            while (i20 < 2) {
                org.telegram.ui.Cells.i6 i6Var2 = new org.telegram.ui.Cells.i6(context, notificationsCustomSettingsActivity2.getResourceProvider());
                i6VarArr[i20] = i6Var2;
                i6Var2.setPadding(AndroidUtilities.dp(4.0f), 0, AndroidUtilities.dp(4.0f), 0);
                i6VarArr[i20].a(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.g7, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.E5, false));
                i6VarArr[i20].b(LocaleController.getString(i20 == 0 ? R.string.NotifyAboutReactionsFromEveryone : R.string.NotifyAboutReactionsFromContacts), i20 == 0 ? !zArr[0] : zArr[0]);
                i6VarArr[i20].setBackground(org.telegram.ui.ActionBar.g6.f0(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.i6, false), 2, -1));
                g10.addView(i6VarArr[i20]);
                i6VarArr[i20].setOnClickListener(new bg.p2(zArr, i20, i6VarArr, 17));
                i20++;
            }
    ...
    */
    public static void W(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, ArrayList arrayList) {
        ...
        if (arrayList != null) {
            Collections.sort(arrayList, Comparator$-CC.comparingDouble(new jh.z0(5)));
                ...
                if (arrayList18.isEmpty()) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.y31(notificationsCustomSettingsActivity, arrayList3, arrayList2, arrayList4, arrayList11, arrayList12, arrayList30, arrayList31, arrayList15));
                        }
                    } catch (Exception e11) {
                        e = e11;
                        arrayList4 = arrayList29;
    ...
    public static boolean c0(int i10, long j10) {
        ...
        sb2.append(j10);
        return notificationsSettings.contains(sb2.toString()) ? org.telegram.messenger.x3.v(NotificationsSettingsFacade.PROPERTY_STORIES_NOTIFY, j10, notificationsSettings, true) : notificationsSettings.contains("EnableAllStories") ? notificationsSettings.getBoolean("EnableAllStories", true) : i0(i10, j10);
    }
    ...
    public final View createView(Context context) {
        ...
        this.a.setOnItemClickListener(new xr(29, this, context));
        ...
        tj0Var.d = 0L;
        tj0Var.C = false;
        tj0Var.i = new OvershootInterpolator(1.1f);
        tj0Var.o = org.telegram.ui.Components.jr.h;
        tj0Var.m = false;
        this.a.setItemAnimator(tj0Var);
        this.a.setOnScrollListener(new m3(this, 22));
    ...
    */
    public final void d0() {
        ...
        if (isEmpty || i12 == 3) {
            ...
            for (int i13 = 0; i13 < childCount; i13++) {
                ...
                if (R >= 0) {
                    ...
                    if (R < arrayList3.size()) {
                        vj0Var = (vj0) arrayList3.get(R);
                        boolean z10 = (vj0Var == null && ((i11 = vj0Var.c) == 102 || i11 == 101 || i11 == 100)) ? true : isGlobalNotificationsEnabled;
                        i10 = vk0Var.f;
                        View view = vk0Var.a;
                        if (i10 != 0) {
                            ((org.telegram.ui.Cells.k4) view).a(arrayList2, z10);
                        } else if (i10 == 1) {
                            ((org.telegram.ui.Cells.q8) view).e(arrayList2, z10);
                        } else if (i10 == 3) {
                            ((org.telegram.ui.Cells.s8) view).a(arrayList2, z10);
                        } else if (i10 == 5) {
                            ((org.telegram.ui.Cells.y9) view).a(arrayList2, z10);
                        }
                    }
                }
                vj0Var = null;
            ...
            this.e.addListener(new e50(this, 6));
    ...
    public final int f0() {
        ...
        for (int i12 = 0; i12 < 9; i12++) {
            if (org.telegram.ui.Cells.s8.f[i12] == i10) {
                return org.telegram.ui.Cells.s8.e[i12];
            }
        }
        return i10;
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 16, new Class[]{org.telegram.ui.Cells.k4.class, org.telegram.ui.Cells.q8.class, org.telegram.ui.Cells.s8.class, org.telegram.ui.Cells.y9.class, org.telegram.ui.Cells.sa.class, org.telegram.ui.Cells.h5.class}, null, null, null, org.telegram.ui.ActionBar.g6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 0, new Class[]{org.telegram.ui.Cells.s3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.f7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.a, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, i10));
    ...
    public final void k0(bk0 bk0Var, View view, boolean z10) {
        ...
        bk0Var.c = z10 ? ConnectionsManager.DEFAULT_DATACENTER_ID : 0;
        if (bk0Var.f) {
            bk0Var.f = false;
            edit.putBoolean(u3.c.e(NotificationsSettingsFacade.PROPERTY_STORIES_NOTIFY, sharedPrefKey), !z10).commit();
            ArrayList arrayList = this.v;
            if (arrayList != null) {
                arrayList.remove(bk0Var);
            }
    ...
    public final void l0(boolean z10) {
        ...
        if (i10 != -1) {
            ...
            if (i10 == 3) {
                ...
                if (!notificationsSettings.getBoolean("EnableAllStories", false)) {
                    ...
                    arrayList3.add(vj0.b(102, LocaleController.getString(R.string.NotifyMeAboutImportantStories), this.r && ((bool = this.n) == null || !bool.booleanValue())));
                }
                ...
                vj0 vj0Var2 = new vj0(6, true);
                vj0Var2.c = 103;
                vj0Var2.d = i11;
                vj0Var2.e = string3;
                vj0Var2.f = string4;
                vj0Var2.i = z11;
                arrayList3.add(vj0Var2);
                ...
                vj0 vj0Var3 = new vj0(6, true);
                vj0Var3.c = 104;
                vj0Var3.d = i12;
                vj0Var3.e = string5;
                vj0Var3.f = string6;
                vj0Var3.i = z12;
                arrayList3.add(vj0Var3);
                ...
                arrayList3.add(vj0.b(100, LocaleController.getString(i13), getNotificationsController().isGlobalNotificationsEnabled(i10)));
                arrayList3.add(vj0.d(-1, null));
            }
            String string7 = LocaleController.getString(R.string.SETTINGS);
            vj0 vj0Var4 = new vj0(0, true);
            vj0Var4.e = string7;
            arrayList3.add(vj0Var4);
            arrayList3.size();
            if (i10 == 3) {
                ...
                arrayList3.add(vj0.b(0, LocaleController.getString(R.string.MessagePreview), z13));
            }
            ...
            if (j10 != 0) {
                ...
                string = c3 == null ? LocaleController.getString("CustomSound", R.string.CustomSound) : gk0.a0(c3, FileLoader.getDocumentFileName(c3));
            ...
            if (this.C) {
                ...
                int[] iArr = this.y;
                arrayList3.add(vj0.c(1, string11, LocaleController.getString(iArr[Utilities.clamp(i14, iArr.length - 1, 0)])));
                if (i10 == 1 || i10 == 0) {
                ...
                vj0 vj0Var6 = new vj0(8, true);
                vj0Var6.e = string12;
                vj0Var6.d = 0;
                arrayList3.add(vj0Var6);
            } else {
                String string13 = LocaleController.getString(R.string.NotifyMoreOptions);
                vj0 vj0Var7 = new vj0(8, true);
                vj0Var7.e = string13;
                vj0Var7.d = 1;
                arrayList3.add(vj0Var7);
            }
            arrayList3.size();
        ...
        if (i10 != 4 && i10 != 5) {
            if (i10 != -1) {
                ...
                vj0 vj0Var8 = new vj0(7, true);
                vj0Var8.c = 6;
                vj0Var8.d = i15;
                vj0Var8.e = string14;
                arrayList3.add(vj0Var8);
            }
            arrayList3.size();
            if (this.v != null && this.h) {
                for (int i16 = 0; i16 < this.v.size(); i16++) {
                    bk0 bk0Var = (bk0) this.v.get(i16);
                    vj0 vj0Var9 = new vj0(2, true);
                    vj0Var9.g = bk0Var;
                    arrayList3.add(vj0Var9);
                }
            }
            if (this.w != null) {
                for (int i17 = 0; i17 < this.w.size(); i17++) {
                    bk0 bk0Var2 = (bk0) this.w.get(i17);
                    vj0 vj0Var10 = new vj0(2, true);
                    vj0Var10.g = bk0Var2;
                    arrayList3.add(vj0Var10);
                }
            }
            arrayList3.size();
            ...
            if (arrayList4 != null && !arrayList4.isEmpty()) {
                ...
                vj0 vj0Var11 = new vj0(7, true);
                vj0Var11.c = 7;
                vj0Var11.d = 0;
                vj0Var11.e = string15;
                arrayList3.add(vj0Var11);
            }
        }
        wj0 wj0Var = this.b;
        if (wj0Var != null) {
