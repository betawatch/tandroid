...
public final /* synthetic */ class s80 implements Runnable {
    ...
    public /* synthetic */ s80(LaunchActivity launchActivity, Bundle bundle, Long l10, int[] iArr, x20 x20Var, boolean z10, ve.d dVar, Long l11, Integer num, Integer num2, byte[] bArr, org.telegram.ui.ActionBar.o2 o2Var, int i9) {
        ...
        switch (i9) {
            ...
            default:
                ...
                if (!((ActionBarLayout) O).P(new qn(bundle2))) {
                    ...
                    iArr[0] = ConnectionsManager.getInstance(launchActivity2.K).sendRequest(tL_channels_getChannels, new org.telegram.messenger.h1(launchActivity2, this.e, this.f, l12, this.h, this.n, this.r, this.s, this.v, this.w, this.x, bundle2));
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ s80(LaunchActivity launchActivity, x20 x20Var, TLObject tLObject, boolean z10, Long l10, ve.d dVar, Long l11, Integer num, Integer num2, byte[] bArr, org.telegram.ui.ActionBar.o2 o2Var, int i9, Bundle bundle) {
        this.b = launchActivity;
        this.e = x20Var;
        this.y = tLObject;
        this.f = z10;
