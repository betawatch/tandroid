    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockembedpost != null) {
            ...
            if (z10) {
                ...
                f3 p10 = m4.p(this.a, this, null, pageblockembedpost3.caption.credit, dp, 0, pageblockembedpost3, k4Var.C ? org.telegram.ui.Components.bw0.a() : Layout.Alignment.ALIGN_NORMAL, 0, this.b);
                this.n = p10;
                if (p10 != null) {
                ...
                if (z11) {
                    ...
                    if (z12) {
                        ...
                        e9Var.n(0L, str, null);
                        this.c.setImage(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(e10.sizes, AndroidUtilities.dp(40.0f), true), e10), "40_40", e9Var, 0L, (String) null, k4Var.A, 1);
                    }
                }
                ...
                f3 p11 = m4.p(this.a, this, str2, null, dp2, 0, pageblockembedpost4, alignment, 1, this.b);
                this.f = p11;
                if (p11 != null) {
                ...
                if (this.y.blocks.isEmpty()) {
                    ...
                    f3 p12 = m4.p(this.a, this, null, pageblockembedpost6.caption.credit, dp4, 0, pageblockembedpost6, k4Var.C ? org.telegram.ui.Components.bw0.a() : alignment, 0, this.b);
                    this.n = p12;
