...
public final class df0 extends org.telegram.ui.Components.vv0 {
    ...
    public final org.telegram.ui.Components.l90 f;
    ...
    */
    public df0(ng0 ng0Var, Context context) {
        super(context);
        int i10;
        this.B = ng0Var;
        setOrientation(1);
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                int i11 = 3;
                textView.setText(LocaleController.getString(ng0Var.C != 3 ? R.string.EnterNewEmail : R.string.AddEmailTitle));
                ...
                e90Var.setText(LocaleController.getString(R.string.AddEmailSubtitle));
                addView(e90Var, k7.b6.t(-2, -2, 1, 32, 8, 32, 0));
                org.telegram.ui.Components.ad0 ad0Var = new org.telegram.ui.Components.ad0(context, null);
                this.a = ad0Var;
                ad0Var.setText(LocaleController.getString(ng0Var.C != 3 ? R.string.YourNewEmail : R.string.YourEmail));
                ...
                addView(ad0Var, k7.b6.k(16.0f, 24.0f, 16.0f, 0.0f, -1, 58));
                ...
                org.telegram.ui.Components.l90 l90Var = new org.telegram.ui.Components.l90(context);
                this.f = l90Var;
                addView(new Space(context), k7.b6.l(1.0f, 0, 0));
                FrameLayout frameLayout2 = new FrameLayout(context);
                frameLayout2.addView(textView2, k7.b6.d(-2, -2.0f, 83, 0.0f, 0.0f, 0.0f, 24.0f));
                frameLayout2.addView(l90Var, k7.b6.d(-2, 16.0f, 83, 0.0f, 0.0f, 0.0f, 70.0f));
                l90Var.setMeasureAfter(textView2);
                addView(frameLayout2, k7.b6.n(-1, -2));
                n7.qa.N0(frameLayout2);
                frameLayout2.setOnClickListener(new e60(this, 8));
            }
        }
        i10 = 8;
        frameLayout.setVisibility(i10);
        ...
        int i112 = 3;
        textView3.setText(LocaleController.getString(ng0Var.C != 3 ? R.string.EnterNewEmail : R.string.AddEmailTitle));
        textView3.setGravity(17);
        textView3.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        addView(textView3, k7.b6.d(-1, -2.0f, 1, 32.0f, 16.0f, 32.0f, 0.0f));
        org.telegram.ui.Components.e90 e90Var2 = new org.telegram.ui.Components.e90(context, null);
        this.d = e90Var2;
        e90Var2.setTextSize(1, 14.0f);
        e90Var2.setGravity(17);
        e90Var2.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        e90Var2.setText(LocaleController.getString(R.string.AddEmailSubtitle));
        addView(e90Var2, k7.b6.t(-2, -2, 1, 32, 8, 32, 0));
        org.telegram.ui.Components.ad0 ad0Var2 = new org.telegram.ui.Components.ad0(context, null);
        this.a = ad0Var2;
        ad0Var2.setText(LocaleController.getString(ng0Var.C != 3 ? R.string.YourNewEmail : R.string.YourEmail));
        ...
        addView(ad0Var2, k7.b6.k(16.0f, 24.0f, 16.0f, 0.0f, -1, 58));
        ...
        org.telegram.ui.Components.l90 l90Var2 = new org.telegram.ui.Components.l90(context);
        this.f = l90Var2;
        addView(new Space(context), k7.b6.l(1.0f, 0, 0));
        FrameLayout frameLayout22 = new FrameLayout(context);
        frameLayout22.addView(textView22, k7.b6.d(-2, -2.0f, 83, 0.0f, 0.0f, 0.0f, 24.0f));
        frameLayout22.addView(l90Var2, k7.b6.d(-2, 16.0f, 83, 0.0f, 0.0f, 0.0f, 70.0f));
        l90Var2.setMeasureAfter(textView22);
        addView(frameLayout22, k7.b6.n(-1, -2));
        n7.qa.N0(frameLayout22);
        frameLayout22.setOnClickListener(new e60(this, 8));
    }
    ...
    @Override // org.telegram.ui.Components.vv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new bf0(this, 0), ng0.q0);
    }
    ...
    public final void o() {
        org.telegram.ui.Components.ad0 ad0Var = this.a;
        ng0 ng0Var = this.B;
