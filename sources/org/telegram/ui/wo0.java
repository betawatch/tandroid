...
public final class wo0 extends View {
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.f != null) {
            ...
            while (true) {
                ...
                Path path = vo0Var.e;
                canvas.save();
                float a2 = vo0Var.l.a(0.05f);
                RectF rectF = vo0Var.p;
                ...
                if (vo0Var.g) {
                    ...
                    float f9 = width / 2.0f;
                    rectF2.set(rectF.centerX() - f9, rectF.centerY() - f9, rectF.centerX() + f9, rectF.centerY() + f9);
                    canvas.rotate(45.0f, rectF.centerX(), rectF.centerY());
                    canvas.drawRoundRect(rectF2, AndroidUtilities.dp(2.33f), AndroidUtilities.dp(2.33f), vo0Var.c);
                    canvas.restore();
                }
                float e10 = vo0Var.n.e(vo0Var.m);
                if (e10 > 0.0f) {
                    Paint paint = wo0Var.b;
                    Paint paint2 = wo0Var.b;
                    paint.setStrokeWidth(AndroidUtilities.dpf2(2.0f));
                    paint2.setColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.d6, wo0Var.a));
                ...
                if (vo0Var.h) {
                    if (wo0Var.e) {
                        ...
                        vo0Var.k.setBounds((int) org.telegram.messenger.x3.A(vo0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) org.telegram.messenger.x3.A(vo0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()), (int) u3.c.c(vo0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) u3.c.c(vo0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()));
                        vo0Var.k.draw(canvas);
                    } else {
                        if (vo0Var.i == null) {
                            vo0Var.i = new Path();
                        }
                        if (vo0Var.j == null) {
                            ...
                            vo0Var.j = paint3;
                            paint3.setColor(-1);
                            vo0Var.j.setStyle(Paint.Style.STROKE);
                            vo0Var.j.setStrokeCap(Paint.Cap.ROUND);
                        }
                        vo0Var.j.setStrokeWidth(AndroidUtilities.dp(2.0f));
                        vo0Var.i.rewind();
                        float lerp = AndroidUtilities.lerp(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(4.0f), e10);
                        vo0Var.i.moveTo(rectF.centerX() - lerp, rectF.centerY() - lerp);
                        vo0Var.i.lineTo(rectF.centerX() + lerp, rectF.centerY() + lerp);
                        vo0Var.i.moveTo(rectF.centerX() + lerp, rectF.centerY() - lerp);
                        vo0Var.i.lineTo(rectF.centerX() - lerp, rectF.centerY() + lerp);
                        canvas.drawPath(vo0Var.i, vo0Var.j);
                    }
                }
                canvas.restore();
                i10++;
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f != null) {
            ...
            while (true) {
                ...
                if (vo0VarArr[i10].q.contains(motionEvent.getX(), motionEvent.getY())) {
                    vo0Var = this.f[i10];
                    break;
                }
                i10++;
            ...
            if (motionEvent.getAction() != 0) {
                ...
                if (vo0Var3 != vo0Var) {
                    ...
                    if (this.w != null && vo0Var != null && (callback2 = this.v) != null) {
                        callback2.run(Integer.valueOf(vo0Var.o));
                    }
                    this.w = vo0Var;
                    return true;
                }
            } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                if (motionEvent.getAction() == 1 && (vo0Var2 = this.w) != null && (callback = this.v) != null) {
                    callback.run(Integer.valueOf(vo0Var2.o));
                }
                if (this.f != null) {
                    int i11 = 0;
                    while (true) {
                        vo0[] vo0VarArr2 = this.f;
                        if (i11 >= vo0VarArr2.length) {
                            break;
                        }
                        vo0VarArr2[i11].l.c(false);
                        i11++;
                    }
                }
                this.w = null;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        vo0[] vo0VarArr = this.f;
        if (vo0VarArr == null || vo0VarArr.length != size2) {
            this.f = new vo0[size2];
            int i16 = 0;
            while (i16 < size2) {
                this.f[i16] = new vo0(this);
                if (i13 == i15) {
                    vo0 vo0Var = this.f[i16];
                    int i17 = this.h[i16];
                    vo0Var.o = i17;
                    vo0Var.h = i17 < 0;
                    if (i17 < 0) {
        ...
        if (this.f != null) {
            ...
            for (int i18 = 0; i18 < this.f.length; i18++) {
                ...
                vo0 vo0Var2 = this.f[i18];
                boolean z10 = vo0Var2.o == this.s;
                vo0Var2.m = z10;
                vo0Var2.n.f(z10, true);
                vo0Var2.r.invalidate();
                if (i18 % i14 == i14 - 1) {
                    f14 += min + min3;
                    f13 = f12;
                } else {
