...
public final /* synthetic */ class he0 implements RequestDelegate {
    ...
    public /* synthetic */ he0(je0 je0Var, int i10) {
        this.a = i10;
        this.b = je0Var;
    }
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                ...
                                break;
                            case 1:
                                qg0 qg0Var = je0Var2.y;
                                qg0Var.k1(false, true);
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        qg0Var.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), tL_error2.text);
                                        break;
                                    } else {
                                        int intValue = Utilities.parseInt((CharSequence) tL_error2.text).intValue();
                                        qg0Var.l1(LocaleController.getString(R.string.WrongCodeTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue < 60 ? LocaleController.formatPluralString("Seconds", intValue, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue / 60, new Object[0])));
                                        break;
                                    }
                                } else {
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    ...
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                            ...
                                            qg0Var2.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue2 < 60 ? LocaleController.formatPluralString("Seconds", intValue2, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue2 / 60, new Object[0])));
                                            break;
                                        }
                                    } else if (qg0Var2.getParentActivity() != null) {
                                        je0Var2.a.setText("");
                                        qg0.U0(qg0Var2, je0Var2.x, true);
                                        break;
                                    }
                                } else {
                            ...
                            default:
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    ...
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        ...
                                        je0Var22.a.setText("");
                                        qg0.U0(qg0Var2, je0Var22.x, true);
                                        break;
                                    }
                                } else {
                                    qg0Var2.v1(false, true);
