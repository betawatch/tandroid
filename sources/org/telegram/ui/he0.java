...
public final class he0 extends org.telegram.ui.Components.uv0 {
    ...
    public he0(rg0 rg0Var, Context context, int i10) {
        ...
        while (i12 < this.b.length) {
            ...
            editTextBoldCursor.addTextChangedListener(new ge0(this, z10));
            this.b[i12].setOnFocusChangeListener(new od(yc0Var, 3));
            if (z10) {
                ...
                final int i13 = 0;
                imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.de0
                    ...
                    public final void onClick(View view) {
                        switch (i13) {
                            case 0:
                                he0 he0Var = this.b;
                                ImageView imageView2 = he0Var.f;
                                EditTextBoldCursor[] editTextBoldCursorArr = he0Var.b;
                                he0Var.y = !he0Var.y;
                                for (int i14 = 0; i14 < editTextBoldCursorArr.length; i14++) {
                                    ...
                                    editTextBoldCursorArr[i14].setInputType((he0Var.y ? 144 : 128) | 1);
                                    editTextBoldCursorArr[i14].setSelection(selectionStart, selectionEnd);
                                }
                                imageView2.setTag(Boolean.valueOf(he0Var.y));
                                imageView2.setColorFilter(org.telegram.ui.ActionBar.h6.w0(null, he0Var.y ? org.telegram.ui.ActionBar.h6.l6 : org.telegram.ui.ActionBar.h6.H6, false));
                                break;
                            default:
                                he0 he0Var2 = this.b;
                                if (he0Var2.x == 0) {
            ...
            this.b[i12].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.ee0
                ...
                switch (i14) {
                    case 0:
                        ...
                        for (int i142 = 0; i142 < editTextBoldCursorArr.length; i142++) {
                            ...
                            editTextBoldCursorArr[i142].setInputType((he0Var.y ? 144 : 128) | 1);
    ...
    @Override // org.telegram.ui.Components.uv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new d10(this, 18), rg0.t0);
    }
