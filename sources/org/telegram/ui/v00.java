...
public abstract class v00 extends FrameLayout {
    ...
    public final void a() {
        ...
        ConnectionsManager.getInstance(this.b).sendRequest(tL_chatlists_deleteExportedInvite, new no(21, this, u00Var));
    ...
    public final void d() {
        ...
        org.telegram.ui.Components.ri0 ri0Var = new org.telegram.ui.Components.ri0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z4) {
        ...
        if ((z11 ? 1.0f : 0.0f) != this.s) {
            ...
            this.w.addListener(new org.telegram.ui.Components.m00(20, this, z11));
            this.w.setInterpolator(org.telegram.ui.Components.mr.h);
