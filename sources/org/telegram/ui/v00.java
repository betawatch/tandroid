...
public final class v00 extends org.telegram.ui.Cells.l4 {
    ...
    */
    public v00(h10 h10Var, Context context) {
        ...
        org.telegram.messenger.wl.k(h10Var.getUserConfig().isPremium() ? R.string.FolderTagNoColor : R.string.FolderTagNoColorPremium, textView, 5);
        ...
        this.s = u00Var;
        this.w = new org.telegram.ui.Components.f5(u00Var, 320L, org.telegram.ui.Components.qr.h, 0);
        ...
        float f10 = this.b;
        addView(u00Var, w7.x5.d(-1, -1.0f, i12 | 48, f10, 16.66f, f10, this.c));
    }
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (z11 != this.x) {
            ...
            u00Var.animate().alpha(z11 ? 0.0f : 1.0f).setDuration(320L).setInterpolator(qrVar).start();
        }
    }
