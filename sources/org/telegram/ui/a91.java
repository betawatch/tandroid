...
public abstract class a91 extends FrameLayout {
    ...
    public a91(Context context, int i10, rf.f fVar, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        final int i11 = 0;
        cVar.d.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.w81
        ...
        if (i10 == 1) {
            this.b = new rf.k(getContext(), c6Var);
            rf.k kVar = new rf.k(getContext(), c6Var);
            this.c = kVar;
            kVar.p0.y = true;
        } else if (i10 == 2) {
            this.b = new rf.p(getContext(), c6Var);
            ...
            this.b = new rf.m(getContext(), null);
            rf.m mVar2 = new rf.m(getContext(), null);
            this.c = mVar2;
            mVar2.p0.y = true;
        } else {
            this.b = new rf.l(getContext(), null);
        ...
        this.b.p0.setOnTouchListener(new org.telegram.ui.Components.kk0());
        final int i13 = 1;
        this.b.p0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.w81
            public final /* synthetic */ a91 b;
        ...
        final int i14 = 2;
        this.c.p0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.w81
            public final /* synthetic */ a91 b;
        ...
        g10.addView(this.d, h7.z5.c(52.0f, -1));
        g10.addView(frameLayout, h7.z5.c(-2.0f, -1));
        g10.addView(this.h, h7.z5.d(-1, -2.0f, 7, 10.0f, 0.0f, 10.0f, 0.0f));
        if (this.s == 4) {
    ...
    public final ValueAnimator a(long j10, boolean z10) {
        ...
        for (int i10 = 0; i10 < this.r.d.d.size(); i10++) {
            if (((sf.a) this.r.d.d.get(i10)).a[binarySearch] > j11) {
                j11 = ((sf.a) this.r.d.d.get(i10)).a[binarySearch];
            }
            if (((sf.a) this.r.d.d.get(i10)).a[binarySearch] < j12) {
                j12 = ((sf.a) this.r.d.d.get(i10)).a[binarySearch];
            }
        }
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.x81
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                float f14 = jVar3.l;
                float f15 = jVar3.k;
                float f16 = ((f13 / (f14 - f15)) * f15) - rf.g.g1;
    ...
    public final void d() {
        ...
        if (c91Var != null && (bVar = c91Var.d) != null && (arrayList = bVar.d) != null && arrayList.size() > 1) {
            for (int i10 = 0; i10 < this.r.d.d.size(); i10++) {
                int w02 = (((sf.a) this.r.d.d.get(i10)).g < 0 || !org.telegram.ui.ActionBar.g6.c1(((sf.a) this.r.d.d.get(i10)).g)) ? i0.b.f(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false)) < 0.5d ? ((sf.a) this.r.d.d.get(i10)).i : ((sf.a) this.r.d.d.get(i10)).h : org.telegram.ui.ActionBar.g6.w0(null, ((sf.a) this.r.d.d.get(i10)).g, false);
                ArrayList arrayList2 = this.n;
                if (i10 < arrayList2.size()) {
                    org.telegram.ui.Components.g00 g00Var = ((z81) arrayList2.get(i10)).a;
                    g00Var.getClass();
                    g00Var.r = org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false);
                    g00Var.v = -1;
                    g00Var.s = w02;
                    g00Var.invalidate();
                }
    ...
    public final void e(c91 c91Var, boolean z10) {
        ...
        tf.e eVar = gVar.p0;
        boolean z13 = c91Var.n;
        eVar.a = z13;
        cVar.c(!z13);
        if (c91Var.d == null && c91Var.f != null) {
        ...
        cVar.setUseWeekInterval(c91Var.o);
        gVar.p0.setUseWeek(c91Var.o);
        tf.e eVar2 = gVar.p0;
        ...
        if (z10) {
            ...
            ofFloat.addListener(new y81(this, 2));
            ofFloat.start();
        }
    }
        ...
        if (this.r.d.d.size() > 1) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (((sf.a) bVar.d.get(i12)).c.equals(((sf.a) this.r.d.d.get(i10)).c)) {
                        boolean z12 = ((z81) arrayList.get(i10)).a.b;
                        ((tf.f) arrayList2.get(i12)).n = z12;
                        ((tf.f) arrayList2.get(i12)).o = z12 ? 1.0f : 0.0f;
                        ((z81) arrayList.get(i10)).a.c = true;
                        ((z81) arrayList.get(i10)).a.animate().alpha(1.0f).start();
                        if (z12) {
                            i11++;
                        }
                        z11 = true;
                ...
                if (!z11) {
                    ((z81) arrayList.get(i10)).a.c = false;
                    ((z81) arrayList.get(i10)).a.animate().alpha(0.0f).start();
                }
                i10++;
            }
            if (i11 == 0) {
                for (int i13 = 0; i13 < this.r.d.d.size(); i13++) {
                    ((z81) arrayList.get(i13)).a.c = true;
                    ((z81) arrayList.get(i13)).a.animate().alpha(1.0f).start();
                }
                return;
            }
        }
    ...
    public final void h(boolean z10) {
        sf.b bVar;
        c91 c91Var = this.r;
        if (c91Var == null || (bVar = c91Var.d) == null || bVar.a == null) {
            return;
        }
        tf.c cVar = this.d;
        ...
        if (z10) {
            ...
            a2.addListener(new y81(this, 1));
            int size = arrayList.size();
            while (i10 < size) {
                Object obj = arrayList.get(i10);
                i10++;
                z81 z81Var = (z81) obj;
                z81Var.a.animate().alpha(1.0f).start();
                z81Var.a.c = true;
            }
            a2.start();
            return;
