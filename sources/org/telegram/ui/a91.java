...
public final class a91 extends LinearLayout implements org.telegram.ui.ActionBar.z5 {
    ...
    public a91(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Sh, e6Var));
        textView.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, e6Var)));
        ...
        if (!LocaleController.isRTL) {
            ...
            addView(j5Var, w7.y5.p(0, -1, 1.0f, 119, 0, 0, 18, 0));
        ...
        addView(textView, w7.y5.p(-2, 20, 0.0f, 16, 0, 0, 0, 0));
        addView(j5Var, w7.y5.p(0, -1, 1.0f, 119, 18, 0, 0, 0));
    ...
    public final void e() {
        ...
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, e6Var));
        this.e.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, e6Var)));
        this.f.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.m6, e6Var), PorterDuff.Mode.SRC_IN));
        this.n.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.zh, e6Var)));
    }
    ...
    */
    public void set(int i10) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.a;
        o5Var.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0(i11, e6Var)));
        if (currentUser != null) {
            long j3 = currentUser.bot_verification_icon;
            if (j3 != 0) {
                o5Var.j(j3, false);
                emojiStatusDocumentId = UserObject.getEmojiStatusDocumentId(currentUser);
                o5Var2.k(Integer.valueOf(org.telegram.ui.ActionBar.j6.v0(i11, e6Var)));
