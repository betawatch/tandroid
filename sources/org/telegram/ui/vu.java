...
public final class vu extends org.telegram.ui.Components.ll0 {
    ...
    public final void A1(boolean z10) {
        ...
        while (true) {
            ...
            if (j11 > j10 || z11) {
                ...
                int i17 = zu.f[i15];
                int[] iArr = zu.d[i15];
                arrayList3.add(new qu(i14, i17, iArr[0], iArr[1], j11 == j10 ? LocaleController.getString(zu.h[i15]) : TextUtils.concat(LocaleController.getString(zu.h[i15]), "  ", spannableString3), AndroidUtilities.formatFileSize(j11)));
            }
            i14++;
            j3 = j10;
            i13 = 1;
        ...
        if (!arrayList3.isEmpty()) {
            ...
            int v02 = org.telegram.ui.ActionBar.i6.v0(i18, e6Var);
            ...
            mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i18, e6Var), mode));
        ...
        if (!this.m3) {
            ...
            arrayList2.add(new qu(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.l3)));
            arrayList2.add(new qu(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.k3)));
        }
        if (arrayList3.isEmpty()) {
            i10 = 3;
        } else {
