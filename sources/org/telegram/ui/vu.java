    ...
    public final void z1(boolean z4) {
        ...
        while (true) {
            ...
            if (j12 > j11 || z10) {
                ...
                int i17 = zu.f[i15];
                int[] iArr = zu.d[i15];
                arrayList3.add(new qu(i14, i17, iArr[0], iArr[1], j12 == j11 ? LocaleController.getString(zu.h[i15]) : TextUtils.concat(LocaleController.getString(zu.h[i15]), "  ", spannableString3), AndroidUtilities.formatFileSize(j12)));
            }
            i14++;
            j10 = j11;
            i13 = 1;
            ...
            while (i19 < arrayList3.size()) {
                ...
                if (i20 < 0 || this.f3[i20]) {
                    ...
                    if (i24 == 0) {
                        if (j15 > j13 || i23 > 0) {
                            i19++;
                            arrayList3.add(i19, qu.b(LocaleController.formatPluralStringComma("OutgoingCallsCount", i23), AndroidUtilities.formatFileSize(j15)));
                        }
                        if (j14 > j13 || i22 > 0) {
                            i19++;
                            arrayList3.add(i19, qu.b(LocaleController.formatPluralStringComma("IncomingCallsCount", i22), AndroidUtilities.formatFileSize(j14)));
                        }
                    } else if (i24 != 1) {
                        if (j15 > j13 || i23 > 0) {
                            i19++;
                            arrayList3.add(i19, qu.b(TextUtils.concat(spannableString, " ", AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("FilesSentCount", i23))), AndroidUtilities.formatFileSize(j15)));
                        }
                        if (j14 > j13 || i22 > 0) {
                            i19++;
                            arrayList3.add(i19, qu.b(TextUtils.concat(spannableString2, " ", AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("FilesReceivedCount", i22))), AndroidUtilities.formatFileSize(j14)));
                        }
                    } else {
                        if (j15 > j13 || i23 > 0) {
                            i19++;
                            arrayList3.add(i19, qu.b(TextUtils.concat(spannableString, " ", LocaleController.getString(R.string.BytesSent)), AndroidUtilities.formatFileSize(j15)));
                        }
                        if (j14 > j13 || i22 > 0) {
                            i19++;
                            arrayList3.add(i19, qu.b(TextUtils.concat(spannableString2, " ", LocaleController.getString(R.string.BytesReceived)), AndroidUtilities.formatFileSize(j14)));
                            i19++;
        ...
        if (!this.j3) {
            ...
            arrayList2.add(new qu(-1, R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(R.string.BytesSent), AndroidUtilities.formatFileSize(this.i3)));
            arrayList2.add(new qu(-1, R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(R.string.BytesReceived), AndroidUtilities.formatFileSize(this.h3)));
        }
        if (arrayList3.isEmpty()) {
            i10 = 3;
        } else {
