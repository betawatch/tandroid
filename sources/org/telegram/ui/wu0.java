...
public final class wu0 extends org.telegram.ui.Components.bw0 {
    ...
    public final void Z() {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (photoViewer.u4 == 1 || photoViewer.o6 == 1) {
                ...
                this.D0.add(new Rect(0, org.telegram.messenger.em.y(200.0f, measuredHeight, 2), AndroidUtilities.dp(100.0f), (AndroidUtilities.dp(200.0f) + measuredHeight) / 2));
                this.D0.add(new Rect(measuredWidth - AndroidUtilities.dp(100.0f), org.telegram.messenger.em.y(200.0f, measuredHeight, 2), measuredWidth, (AndroidUtilities.dp(200.0f) + measuredHeight) / 2));
            }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        PhotoViewer photoViewer = this.E0;
        org.telegram.ui.Cells.ea o9 = photoViewer.Q.o(getContext());
        org.telegram.ui.Cells.fa faVar = o9.r;
        if (motionEvent.getAction() == 0) {
            o9.h = motionEvent.getX();
            o9.n = motionEvent.getY();
            faVar.e = faVar.y();
        } else if (faVar.e && Math.abs(motionEvent.getX() - o9.h) < AndroidUtilities.touchSlop && Math.abs(motionEvent.getY() - o9.n) < AndroidUtilities.touchSlop && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1)) {
            motionEvent.getX();
            motionEvent.getY();
            org.telegram.ui.Cells.fa faVar2 = o9.r;
            if (!faVar2.i && faVar2.e) {
                faVar2.f(false);
            }
        }
        if (!photoViewer.Q.y()) {
    ...
    public final void draw(Canvas canvas) {
        ...
        org.telegram.ui.Components.j71 j71Var = photoViewer.z1;
        if (j71Var != null && j71Var.j) {
            j71Var.setBounds(photoViewer.f0.getLeft(), (photoViewer.f0.getWebView().getTop() - measuredHeight) + ((int) (photoViewer.Y5 / photoViewer.a6)), photoViewer.f0.getRight(), photoViewer.f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.a6)));
            photoViewer.z1.draw(canvas);
        }
        org.telegram.ui.Components.to0 to0Var = photoViewer.A1;
    ...
    public final void onAttachedToWindow() {
        ...
        org.telegram.ui.Components.pc.a(this, new z8(this, 6));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int alpha = (int) (y7Var.getAlpha() * 255.0f * 0.498f);
        Paint paint = this.A0;
    ...
    */
                                ...
                                if (childAt == photoViewer.e1 || childAt == photoViewer.f1 || childAt == photoViewer.g1) {
                                    ...
                                    if (arrayList == null || !arrayList.contains(childAt)) {
                                        ...
                                        if (arrayList2 != null && arrayList2.contains(childAt)) {
                                            ...
                                            i19 = org.telegram.messenger.em.v(31.0f, photoViewer.P0.getHeight(), i19);
                                        }
                                    } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i15 = size2;
        wu0Var.setMeasuredDimension(size, i15);
        ...
        if (f40Var == null || f40Var.getVisibility() == 8) {
            i12 = i10;
            i13 = 0;
        } else {
            ((ViewGroup.MarginLayoutParams) photoViewer.l1.getLayoutParams()).bottomMargin = dp;
            i12 = i10;
            wu0Var.measureChildWithMargins(photoViewer.l1, i12, 0, i11, 0);
        ...
        lv0 lv0Var = photoViewer.i3;
        if (lv0Var != null) {
            lv0Var.e = size;
            lv0Var.f = i15;
        }
        int paddingLeft = size - (wu0Var.getPaddingLeft() + wu0Var.getPaddingRight());
        int paddingBottom = i15 - wu0Var.getPaddingBottom();
        int childCount = wu0Var.getChildCount();
        int i17 = 0;
        while (i17 < childCount) {
            View childAt = wu0Var.getChildAt(i17);
            if (childAt.getVisibility() != 8 && childAt != photoViewer.l1) {
                ...
                if (childAt == rt0Var) {
                    ...
                    wu0Var.measureChildWithMargins(childAt, i12, 0, i11, 0);
                }
            }
            i17++;
            z10 = true;
