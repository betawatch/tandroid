...
public final class km0 implements RequestDelegate {
    ...
    public final void a(final TLRPC.TL_error tL_error, final TLRPC.TL_secureValue tL_secureValue, final TLRPC.TL_secureValue tL_secureValue2) {
        lm0 lm0Var = this.p;
        final boolean z10 = lm0Var.b;
        final int i10 = lm0Var.c;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.jm0
            @Override // java.lang.Runnable
            public final void run() {
                in0 in0Var;
                TLRPC.TL_secureRequiredType tL_secureRequiredType3;
                int i11;
                lm0 lm0Var2 = km0.this.p;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            ...
            if (tL_error.text.equals("PHONE_VERIFICATION_NEEDED")) {
                AndroidUtilities.runOnUIThread(new kf0(km0Var.a, tL_error, str, 11));
                return;
            }
        } else {
            km0Var = this;
        }
        if (tL_error != null || (tL_inputSecureValue = km0Var.o) == null) {
