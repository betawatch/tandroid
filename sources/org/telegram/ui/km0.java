...
public final class km0 extends FrameLayout {
    ...
    public /* synthetic */ km0(Context context, EditTextBoldCursor editTextBoldCursor, int i10) {
        super(context);
        this.a = i10;
    ...
    public final void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            default:
                super.onMeasure(i10, i11);
                org.telegram.ui.Components.bj0 bj0Var = ((org.telegram.ui.Components.ki0) this.d).h;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public km0(org.telegram.ui.Components.ki0 ki0Var, Context context, hg.k kVar) {
        super(context);
        this.a = 3;
        this.d = ki0Var;
        this.b = kVar;
