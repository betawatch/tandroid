...
public final class dd extends org.telegram.ui.Components.hv0 {
    ...
    public /* synthetic */ dd(int i10, Context context, org.telegram.ui.ActionBar.o2 o2Var) {
        super(context, null);
        this.s0 = i10;
        this.u0 = o2Var;
    }
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i24;
        int i25;
        org.telegram.ui.Components.au auVar2;
        int measuredHeight3;
        int measuredHeight4;
        int i26;
        int i27;
        ...
        int i30;
        int i31;
        org.telegram.ui.Components.au auVar3;
        int measuredHeight5;
        int measuredHeight6;
        int i32;
        int i33;
        ...
        switch (this.s0) {
            case 0:
                ...
                int R = R();
                int emojiPadding = (R > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : hdVar.c.getEmojiPadding();
            ...
            case 1:
                ...
                int R2 = R();
                int emojiPadding2 = (R2 > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : koVar.v.getEmojiPadding();
                ...
                break;
            case 2:
                t60 t60Var = (t60) this.u0;
                int childCount3 = getChildCount();
                int R3 = R();
                int emojiPadding3 = (R3 > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : t60Var.c.getEmojiPadding();
                    ...
                    if (childAt3.getVisibility() != 8) {
                        ...
                        if (i49 == 1) {
                            ...
                            if (i48 == 16) {
                                ...
                                auVar3 = t60Var.c;
                                if (auVar3 != null && auVar3.l(childAt3)) {
                                    if (AndroidUtilities.isTablet()) {
                ...
                break;
            default:
                vu0 vu0Var = (vu0) this.u0;
                int childCount4 = getChildCount();
                int R4 = R();
                int i50 = (R4 > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : vu0Var.R;
                setBottomClip(i50);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.s0) {
            case 0:
                ...
                hd hdVar = (hd) this.u0;
                lVar = ((org.telegram.ui.ActionBar.o2) hdVar).actionBar;
                ...
                for (int i12 = 0; i12 < childCount; i12++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8) {
                        lVar2 = ((org.telegram.ui.ActionBar.o2) hdVar).actionBar;
                        if (childAt != lVar2) {
            ...
            case 1:
                ...
                ko koVar = (ko) this.u0;
                lVar3 = ((org.telegram.ui.ActionBar.o2) koVar).actionBar;
                ...
                for (int i13 = 0; i13 < childCount2; i13++) {
                    ...
                    if (childAt2 != null && childAt2.getVisibility() != 8) {
                        lVar4 = ((org.telegram.ui.ActionBar.o2) koVar).actionBar;
                        if (childAt2 != lVar4) {
            ...
            case 2:
                ...
                t60 t60Var = (t60) this.u0;
                lVar5 = ((org.telegram.ui.ActionBar.o2) t60Var).actionBar;
                measureChildWithMargins(lVar5, i10, 0, i11, 0);
                if (R() > AndroidUtilities.dp(20.0f)) {
                    org.telegram.ui.Components.au auVar3 = t60Var.c;
                    if (!auVar3.e) {
                        this.t0 = true;
                        auVar3.j();
                        this.t0 = false;
                ...
                for (int i14 = 0; i14 < childCount3; i14++) {
                    ...
                    if (childAt3 != null && childAt3.getVisibility() != 8) {
                        lVar6 = ((org.telegram.ui.ActionBar.o2) t60Var).actionBar;
                        if (childAt3 != lVar6) {
                            org.telegram.ui.Components.au auVar4 = t60Var.c;
            ...
            default:
                ...
                vu0 vu0Var = (vu0) this.u0;
                lVar7 = ((org.telegram.ui.ActionBar.o2) vu0Var).actionBar;
                measureChildWithMargins(lVar7, i10, 0, i11, 0);
                int R = R();
                if (R > AndroidUtilities.dp(20.0f) && !vu0Var.L && !vu0Var.x0) {
                    this.t0 = true;
                    vu0Var.l0();
                    this.t0 = false;
                }
                int i15 = (R > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : vu0Var.R;
                if (R > AndroidUtilities.dp(20.0f) && vu0Var.x0) {
                ...
                for (int i17 = 0; i17 < childCount4; i17++) {
                    ...
                    if (childAt4 != null && childAt4.getVisibility() != 8) {
                        lVar8 = ((org.telegram.ui.ActionBar.o2) vu0Var).actionBar;
                        if (childAt4 != lVar8) {
                            org.telegram.ui.Components.fz fzVar = vu0Var.N;
                            if (fzVar == null || fzVar != childAt4) {
                                if (vu0Var.c == childAt4) {
