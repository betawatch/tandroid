...
public final class e41 extends org.telegram.ui.ActionBar.f3 {
        ...
        if (context != null) {
            ...
            if (z10) {
                ...
                if (z11) {
                    ...
                    tL_reportMessage.option = bArr;
                    tL_messages_report = tL_reportMessage;
                    ConnectionsManager.getInstance(i10).sendRequestTyped(tL_messages_report, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.u31
    ...
    public static void M(co coVar, MessageObject messageObject) {
        ...
        K(currentAccount, parentActivity, messageObject.getDialogId(), false, messageObject.isEphemeral(), new ArrayList(Collections.singleton(Integer.valueOf(messageObject.isEphemeral() ? messageObject.getEphemeralId() : messageObject.getId()))), org.telegram.ui.Components.yc.a0(coVar), coVar.getResourceProvider(), new byte[0], null, null);
    }
    ...
    public static void m(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11, long j3, ArrayList arrayList, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.Components.yc ycVar, TLRPC.ReportResult reportResult) {
        ...
        e41Var.s = new v31(zArr, callback, ycVar);
    ...
    public static void n(e41 e41Var, TLObject tLObject, CharSequence charSequence, TLRPC.TL_error tL_error, byte[] bArr, String str) {
        ...
        a41 a41Var2;
        di.d dVar;
        di.i1 i1Var = e41Var.b;
        if ((i1Var.getCurrentView() instanceof d41) && (dVar = ((d41) i1Var.getCurrentView()).s) != null) {
        ...
        if (tLObject == null) {
            if (tL_error != null) {
                if (!e41Var.d && "MESSAGE_ID_REQUIRED".equals(tL_error.text)) {
                    ...
                    a41 a41Var3 = e41Var.s;
                    if (a41Var3 != null) {
                        a41Var3.c();
                    }
                } else if ("AD_EXPIRED".equals(tL_error.text) && (a41Var = e41Var.s) != null) {
                    a41Var.a();
                }
                e41Var.dismiss();
                return;
        ...
        if (!z10 && !(tLObject instanceof TLRPC.TL_reportResultChooseOption) && !(tLObject instanceof TLRPC.TL_reportResultAddComment)) {
            ...
            if (((tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) || (tLObject instanceof TLRPC.TL_reportResultReported)) && (a41Var2 = e41Var.s) != null) {
                a41Var2.a();
                e41Var.dismiss();
                return;
            }
        ...
        if (d41Var != null) {
            ...
            if (tLObject instanceof TLRPC.TL_reportResultChooseOption) {
                d41Var.b = null;
                d41Var.c = (TLRPC.TL_reportResultChooseOption) tLObject;
                d41Var.d = null;
                d61Var.Y2.N(false);
            } else if (tLObject instanceof TLRPC.TL_reportResultAddComment) {
                d41Var.b((TLRPC.TL_reportResultAddComment) tLObject);
            } else if (z10) {
                d41Var.b = (TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject;
                d41Var.c = null;
                d41Var.d = null;
                d61Var.Y2.N(false);
            }
    ...
    public final boolean canDismissWithSwipe() {
        if (this.b.getCurrentView() instanceof d41) {
            return !((d41) r0).f.canScrollVertically(-1);
        }
        return true;
    }
    ...
    public final void onBackPressed() {
        c41 c41Var;
        di.i1 i1Var = this.b;
        if ((i1Var.getCurrentView() instanceof d41) && (c41Var = ((d41) i1Var.getCurrentView()).n) != null) {
