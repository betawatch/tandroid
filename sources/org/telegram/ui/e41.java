...
public final class e41 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(e41 e41Var, View view, int i10) {
        ...
        int i11 = 0;
        boolean z10 = e41Var.b.getAdapter() == e41Var.c;
        if (!z10 || (arrayList = e41Var.f) == null) {
            int i12 = e41Var.e;
            if (i12 >= 0 && i10 > i12) {
                i10--;
            }
            language = (i10 < 0 || i10 >= e41Var.h.size()) ? null : (TranslateController.Language) e41Var.h.get(i10);
        } else {
        ...
        if (e41Var.r.contains(str)) {
            Collection.-EL.removeIf(e41Var.r, new r80(str, 2));
        } else {
            e41Var.r.add(str);
        }
        if (e41Var.r.size() == 1 && e41Var.r.contains(currentLocaleInfo.pluralLangCode)) {
            a0(null, null);
        } else {
            a0(e41Var.r, Boolean.TRUE);
        }
        if (z10) {
            int i13 = 0;
            while (i11 < e41Var.f.size()) {
                if (TextUtils.equals(str, ((TranslateController.Language) e41Var.f.get(i11)).code)) {
                    e41Var.Z(i13);
                }
                i11++;
                i13++;
    ...
    public static void V(boolean z10) {
        ...
        if (MessagesController.getGlobalMainSettings().getInt("translate_button_restricted_languages_version", 0) != 2 || (z10 && !z11)) {
            ...
            final int i12 = 1;
            Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.c41
            ...
            }, new Utilities.Callback() { // from class: org.telegram.ui.c41
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    switch (i12) {
                        case 0:
    ...
    public final View createView(Context context) {
        ...
        this.a = new d41(this, context, false);
        this.c = new d41(this, context, true);
        ...
        this.b.setOnItemClickListener(new z21(this, 2));
