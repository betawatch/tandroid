...
public final class vg0 extends ReplacementSpan {
    public final String a;
    public final boolean b;
    public final TextPaint c;
    public final Paint d;
    public final float e;
    public final /* synthetic */ xg0 f;

    public vg0(xg0 xg0Var, int i10, boolean z4) {
        this.f = xg0Var;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f10, int i12, int i13, int i14, Paint paint) {
        ...
        xg0 xg0Var = this.f;
        int themedColor = xg0Var.getThemedColor(i15);
        Paint paint2 = this.d;
        paint2.setColor(themedColor);
        int themedColor2 = xg0Var.getThemedColor(org.telegram.ui.ActionBar.j6.s8);
