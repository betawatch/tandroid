...
public final class j8 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(j8 j8Var, TLRPC.TL_error tL_error, TLObject tLObject, Calendar calendar) {
        ...
        if (tL_error == null) {
            ...
            if (tL_messages_searchResultsCalendar.messages.isEmpty()) {
                ...
                j8Var.V = ((TLRPC.Message) hg.k0.h(1, tL_messages_searchResultsCalendar.messages)).id;
                j8Var.T = false;
                j8Var.p0();
            }
            if (j8Var.Y) {
    ...
    public final View createView(Context context) {
        ...
        int i11 = this.Z;
        if (i11 != 0) {
            int g10 = hg.k0.g(this.I, i11, 12, i10) - this.a0;
            this.K = g10 + 1;
                ...
                public final void onClick(View view) {
                    switch (i13) {
                        ...
                        default:
                            ...
                            int i14 = j8Var2.l0;
                            if (i14 != 0) {
                                org.telegram.ui.Components.c5.r(j8Var2, i14, j8Var2.getMessagesController().getUser(Long.valueOf(j8Var2.x)), null, false, new x7(j8Var2), null);
                                break;
                            } else {
                                if (j8Var2.O == null) {
                                    org.telegram.ui.Components.i40 i40Var = new org.telegram.ui.Components.i40(j8Var2.a.getContext(), 8);
                                    j8Var2.O = i40Var;
                                    i40Var.setExtraTranslationY(AndroidUtilities.dp(24.0f));
                                    j8Var2.a.addView(j8Var2.O, w7.x5.d(-2, -2.0f, 51, 19.0f, 0.0f, 19.0f, 0.0f));
                                    j8Var2.O.setText(LocaleController.getString(R.string.SelectDaysTooltip));
                                }
                                j8Var2.O.f(j8Var2.b0, true);
                                break;
                            }
                    }
                }
                ...
                public final void onClick(View view) {
                    switch (i14) {
                        ...
                        default:
                            ...
                            int i142 = j8Var2.l0;
                            if (i142 != 0) {
                                org.telegram.ui.Components.c5.r(j8Var2, i142, j8Var2.getMessagesController().getUser(Long.valueOf(j8Var2.x)), null, false, new x7(j8Var2), null);
                                break;
                            } else {
                                if (j8Var2.O == null) {
                                    org.telegram.ui.Components.i40 i40Var = new org.telegram.ui.Components.i40(j8Var2.a.getContext(), 8);
    ...
    public final void s0(g8 g8Var, boolean z10) {
        ...
        if (!z10) {
            ...
            while (i13 < sparseArray2.size()) {
                g8Var.c(sparseArray2.keyAt(i13), 0, 0, false, z11);
                i13++;
                z11 = false;
            }
        }
        ...
        int i19 = i17;
        if (i15 == -1 || i16 == -1) {
            g8Var.c(i19, 0, 0, false, z10);
        } else {
            g8Var.c(i19, i15, i16, true, z10);
        }
    }
