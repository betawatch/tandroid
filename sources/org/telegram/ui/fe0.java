...
public final class fe0 extends org.telegram.ui.Components.vv0 {
    ...
    public fe0(pg0 pg0Var, Context context, int i10) {
        ...
        this.a = new org.telegram.ui.Components.bd0[i11];
        ...
        while (i12 < this.b.length) {
            ...
            this.a[i12] = bd0Var;
            bd0Var.setText(LocaleController.getString(i10 == 0 ? i12 == 0 ? R.string.PleaseEnterNewFirstPasswordHint : R.string.PleaseEnterNewSecondPasswordHint : R.string.PasswordHintPlaceholder));
            ...
            this.b[i12].setOnFocusChangeListener(new sd(bd0Var, 3));
            if (z4) {
                ...
                imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ce0
                    ...
                    public final void onClick(View view) {
                        switch (i13) {
                            case 0:
                                fe0 fe0Var = this.b;
                                ImageView imageView2 = fe0Var.f;
                                EditTextBoldCursor[] editTextBoldCursorArr = fe0Var.b;
                                fe0Var.y = !fe0Var.y;
                                for (int i14 = 0; i14 < editTextBoldCursorArr.length; i14++) {
                                    ...
                                    editTextBoldCursorArr[i14].setInputType((fe0Var.y ? 144 : 128) | 1);
                                    editTextBoldCursorArr[i14].setSelection(selectionStart, selectionEnd);
                                }
                                imageView2.setTag(Boolean.valueOf(fe0Var.y));
                                imageView2.setColorFilter(org.telegram.ui.ActionBar.j6.w0(null, fe0Var.y ? org.telegram.ui.ActionBar.j6.l6 : org.telegram.ui.ActionBar.j6.H6, false));
                                break;
                            default:
                                fe0 fe0Var2 = this.b;
                                if (fe0Var2.x == 0) {
                ...
                bd0Var.addView(this.b[i12], k7.b6.c(-2.0f, -1));
            }
            bd0Var.e(this.b[i12]);
                ...
                switch (i14) {
                    case 0:
                        ...
                        for (int i142 = 0; i142 < editTextBoldCursorArr.length; i142++) {
                            ...
                            editTextBoldCursorArr[i142].setInputType((fe0Var.y ? 144 : 128) | 1);
    ...
    @Override // org.telegram.ui.Components.vv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new d10(this, 18), pg0.q0);
    }
    ...
    public final void n() {
        ...
        for (org.telegram.ui.Components.bd0 bd0Var : this.a) {
            bd0Var.f();
        }
