...
public final /* synthetic */ class fe0 implements RequestDelegate {
    ...
    public /* synthetic */ fe0(ie0 ie0Var, int i10) {
        this.a = i10;
        this.b = ie0Var;
    }
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                ie0Var2.getClass();
                                if (tL_error2 == null) {
                                    ie0Var2.n = (TL_account.Password) tLObject2;
                                    ie0Var2.h(null);
                                    break;
                                }
                                break;
                            case 1:
                                og0 og0Var = ie0Var2.y;
                                ...
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        ...
                                        og0Var.l1(LocaleController.getString(R.string.WrongCodeTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue < 60 ? LocaleController.formatPluralString("Seconds", intValue, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue / 60, new Object[0])));
                                        break;
                                    }
                                } else {
                                    ...
                                    if (og0Var.getParentActivity() != null) {
                                        ...
                                        if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
                                            ...
                                            t01Var.c = i14;
                                            valueOf.setSpan(new org.telegram.ui.Components.u01(t01Var, 0), indexOf, i14, 0);
                                        }
                            ...
                            default:
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    ...
                                    ConnectionsManager.getInstance(i11).sendRequest(getpassword, new fe0(ie0Var2, i13), 8);
                                    break;
                                    ...
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                            ...
                                            og0Var2.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue2 < 60 ? LocaleController.formatPluralString("Seconds", intValue2, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue2 / 60, new Object[0])));
                                            break;
                                        }
                                    } else if (og0Var2.getParentActivity() != null) {
                                        ie0Var2.a.setText("");
                                        og0.U0(og0Var2, ie0Var2.x, true);
                                        break;
                                    }
                                } else {
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                ie0Var22.getClass();
                                if (tL_error2 == null) {
                                    ie0Var22.n = (TL_account.Password) tLObject2;
                                    ie0Var22.h(null);
                                    break;
                                }
                                break;
                            case 1:
                                og0 og0Var = ie0Var22.y;
                                og0Var.k1(false, true);
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        og0Var.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), tL_error2.text);
                                ...
                                break;
                            default:
                                og0 og0Var2 = ie0Var22.y;
                                ie0Var22.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i112 = ((org.telegram.ui.ActionBar.p2) og0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i112).sendRequest(getpassword, new fe0(ie0Var22, i13), 8);
                                    break;
                                } else if (!(tLObject2 instanceof TLRPC.TL_auth_authorization)) {
                                    og0Var2.k1(false, true);
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        ...
                                        ie0Var22.a.setText("");
                                        og0.U0(og0Var2, ie0Var22.x, true);
                                        break;
                                    }
                                } else {
                                    og0Var2.v1(false, true);
