...
public final class vp0 extends FrameLayout {
    ...
    public final void b(boolean z10) {
        ...
        if (j3 != 0) {
            ...
            o5Var.g(null, z10);
            if (this.b == null) {
                this.b = new org.telegram.ui.Components.v01(LocaleController.getString(wp0Var.p0.a ? R.string.ChannelReplyIconOff : R.string.UserReplyIconOff), 16.0f, null);
            }
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (v01Var != null) {
            v01Var.c((getMeasuredWidth() - this.b.l()) - AndroidUtilities.dp(19.0f), getMeasuredHeight() / 2.0f, 1.0f, this.d.p0.getThemedColor(org.telegram.ui.ActionBar.j6.q6), canvas);
        } else {
            o5Var.draw(canvas);
        }
    }
