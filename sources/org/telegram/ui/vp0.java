...
public final class vp0 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.m5 c;
    ...
    public vp0(wp0 wp0Var, Context context) {
        ...
        this.c = new org.telegram.ui.Components.m5(AndroidUtilities.dp(24.0f), 13, this, false);
    }
    ...
    public final void b(boolean z10) {
        ...
        if (j3 != 0) {
            ...
            m5Var.g(null, z10);
            if (this.b == null) {
                this.b = new org.telegram.ui.Components.h01(LocaleController.getString(wp0Var.p0.a ? R.string.ChannelReplyIconOff : R.string.UserReplyIconOff), 16.0f, null);
            }
        }
    }
    ...
    public final void c() {
        ...
        org.telegram.ui.Components.m5 m5Var = this.c;
        m5Var.setBounds(z10 ? AndroidUtilities.dp(21.0f) : (getWidth() - m5Var.s) - AndroidUtilities.dp(21.0f), (getHeight() - m5Var.s) / 2, LocaleController.isRTL ? AndroidUtilities.dp(21.0f) + m5Var.s : getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + m5Var.s) / 2);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (h01Var != null) {
            h01Var.c((getMeasuredWidth() - this.b.l()) - AndroidUtilities.dp(19.0f), getMeasuredHeight() / 2.0f, 1.0f, this.d.p0.getThemedColor(org.telegram.ui.ActionBar.j6.q6), canvas);
        } else {
            m5Var.draw(canvas);
        }
    }
