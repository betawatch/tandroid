...
public final class he extends LinearLayout {
    ...
    public void set(ge geVar) {
        ...
        int indexOf;
        this.e.setText(geVar.c);
        int i11 = 0;
        while (i11 < 2) {
            String str = i11 == 0 ? geVar.b : geVar.h;
            long j3 = i11 == 0 ? geVar.e : geVar.j;
            ...
            if (i11 == 0 && !geVar.a) {
                ...
                if (equalsIgnoreCase) {
                    String format = this.f.format(geVar.d / 1.0E9d);
                ...
                this.d[i10].setText("≈" + BillingController.getInstance().formatCurrency(j3, geVar.f));
                i11 = i10 + 1;
            } else {
                linearLayoutArr[i11].setVisibility(8);
            }
