...
public final class o5 extends og.b {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i13 == 0) {
            ...
            if (tL_statsPercentValue != null) {
                ...
                if (d != 0.0d) {
                    ma1Var.a("≈" + ((int) v5Var.R.premium_audience.part), 1, String.format(Locale.US, "%.1f", Float.valueOf((((float) tL_statsPercentValue.part) / ((float) d)) * 100.0f)).concat("%"), LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? R.string.PremiumSubscribers : R.string.PremiumMembers));
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                view = new ma1(v5Var.getParentActivity(), 2);
            ...
            case 7:
                ...
                return com.google.android.gms.internal.vision.e2.k(view, view, -1, -2);
            case 8:
                ai.w5 w5Var = new ai.w5(v5Var.getParentActivity(), 7);
