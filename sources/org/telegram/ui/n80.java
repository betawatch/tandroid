...
public final class n80 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener, le.d, ph.d {
    ...
    public static void U(n80 n80Var, View view, int i10) {
        ...
        if ((view instanceof org.telegram.ui.Cells.o4) && (contact = (o4Var = (org.telegram.ui.Cells.o4) view).getContact()) != null) {
            ...
            if (m30Var != null) {
                ...
                m80Var.a = animatorSet2;
                animatorSet2.addListener(new org.telegram.ui.Components.w81(m80Var, 23));
                m80Var.a.setInterpolator(org.telegram.ui.Components.qr.h);
                m80Var.a.setDuration(320L);
                m80Var.d = m30Var2;
                arrayList.clear();
                arrayList.add(ObjectAnimator.ofFloat(m80Var.d, (Property<org.telegram.ui.Components.m30, Float>) View.SCALE_X, 0.75f, 1.0f));
                arrayList.add(ObjectAnimator.ofFloat(m80Var.d, (Property<org.telegram.ui.Components.m30, Float>) View.SCALE_Y, 0.75f, 1.0f));
                arrayList.add(ObjectAnimator.ofFloat(m80Var.d, (Property<org.telegram.ui.Components.m30, Float>) View.ALPHA, 0.0f, 1.0f));
                m80Var.addView(m30Var2);
                m30Var2.setOnClickListener(n80Var);
            }
            n80Var.c.e(!n80Var.G.isEmpty(), true);
            if (n80Var.E || n80Var.y) {
                return;
            }
    ...
    public static /* synthetic */ void V(n80 n80Var) {
    ...
    public final View createView(Context context) {
        ...
        j0Var.addView(this.h, w7.x5.d(-1, -1.0f, 119, 0.0f, -this.a, 0.0f, 0.0f));
        ...
        this.N = new ah.o(ml0Var2, j0Var, new zs(ml0Var2, 0));
        this.h.D0(new g80(this, 0));
        j80 j80Var = this.s;
        if (j80Var != null && !this.E) {
            this.r.setVisibility(j80Var.h() != 2 ? 4 : 0);
        }
