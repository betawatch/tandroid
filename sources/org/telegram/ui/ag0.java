...
public final class ag0 extends org.telegram.ui.Components.uv0 {
    ...
    public ag0(rg0 rg0Var, Context context) {
        super(context);
        ...
        zf0 zf0Var = new zf0(context, 1, 1, 0);
        zf0Var.setStarParticlesView(fVar);
        Bitmap createBitmap = Bitmap.createBitmap(50, 50, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        int i11 = org.telegram.ui.ActionBar.h6.Mj;
        canvas.drawColor(i0.a.d(0.5f, org.telegram.ui.ActionBar.h6.w0(null, i11, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.h5, false)));
        zf0Var.setBackgroundBitmap(createBitmap);
        sg.a aVar = zf0Var.b;
        aVar.w = i11;
        aVar.x = org.telegram.ui.ActionBar.h6.Lj;
        aVar.b();
        frameLayout.addView(zf0Var, w7.x5.e(160, 160, 1));
        ...
        d6Var2 = ((org.telegram.ui.ActionBar.n2) rg0Var).resourceProvider;
        ...
        d6Var3 = ((org.telegram.ui.ActionBar.n2) rg0Var).resourceProvider;
        ...
        d6Var4 = ((org.telegram.ui.ActionBar.n2) rg0Var).resourceProvider;
        yh.r rVar3 = new yh.r(context, 1, d6Var4);
        rVar3.a(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.SMSFee3Title), new wf0(this, 4)), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)), LocaleController.getString(R.string.SMSFee3Text), R.drawable.menu_feature_hands);
    ...
    public static /* synthetic */ void o(ag0 ag0Var, String str, String str2, String str3) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    TelephonyManager telephonyManager = (TelephonyManager) ag0Var.getContext().getSystemService(TelephonyManager.class);
            ...
            sb2.append("Wi-Fi: ");
            sb2.append(AndroidUtilities.isWifiEnabled(ag0Var.getContext()));
            sb2.append("\n");
            sb2.append("Airplane Mode: ");
            sb2.append(AndroidUtilities.isInAirplaneMode(ag0Var.getContext()));
            sb2.append("\n");
            sb2.append("\n");
            sb2.append("App: ");
            ...
            ag0Var.v.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
