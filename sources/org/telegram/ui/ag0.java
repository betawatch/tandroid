...
public final class ag0 extends org.telegram.ui.Components.gw0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public ag0(xg0 xg0Var, Context context, int i10) {
        super(context);
        ViewGroup viewGroup;
        this.s0 = xg0Var;
        this.U = new Object();
        ...
        if (i10 == 11) {
            ...
            org.telegram.messenger.q.n(R.string.MissedCallDescriptionSubtitle, textView3);
            ...
            e.addView(textView4, w7.y5.t(-2, -1, 16, 0, 0, 4, 0));
            e.addView(xf0Var, w7.y5.n(-2, -1));
            addView(e, w7.y5.t(-2, 34, 1, 0, 28, 0, 0));
            TextView textView5 = new TextView(context);
            this.K = textView5;
            textView5.setTextSize(1, 14.0f);
            textView5.setGravity(1);
            textView5.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
            org.telegram.messenger.q.n(R.string.MissedCallDescriptionSubtitle2, textView5);
            ...
            if (i10 == 3) {
                ...
                if (i10 != 11) {
                    ...
                    this.f = xf0Var2;
                    addView(xf0Var2, w7.y5.t(-2, 42, 1, 0, 32, 0, 0));
                }
                if (i10 == 3) {
                ...
                n2Var.setTextColor(xg0Var.getThemedColor(i11));
                ...
                final int i12 = 0;
                n2Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.vf0
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (i12) {
                                ...
                                if (ag0Var.V <= 0 || ag0Var.R == null) {
                                    ...
                                    if (i14 != 4 && i14 != 2 && i14 != 17 && i14 != 16 && i14 != 11 && i14 != 15) {
                                        if (i14 == 3) {
                                            ...
                                            NotificationCenter.getGlobalInstance().removeObserver(ag0Var, NotificationCenter.didReceiveSmsCode);
                                            ag0Var.c0 = false;
                                            ag0Var.v();
                                            ag0Var.i0 = false;
                                            ag0Var.x();
                                        ...
                                        bundle.putString("phone", ag0Var.b);
                                        bundle.putString("ephone", ag0Var.e);
                                        bundle.putString("phoneFormated", ag0Var.d);
                                        bundle.putInt("prevType", ag0Var.f0);
                                        ag0Var.s();
                                        TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                                        tL_auth_resendCode.phone_number = ag0Var.d;
                                        tL_auth_resendCode.phone_code_hash = ag0Var.c;
                                        i13 = ((org.telegram.ui.ActionBar.n2) ag0Var.s0).currentAccount;
                                        ConnectionsManager.getInstance(i13).sendRequest(tL_auth_resendCode, new sf0(ag0Var, bundle, 0), 10);
                                        break;
                                    }
                                }
                                break;
                            default:
                                ...
                                ag0Var2.getClass();
                                try {
                                    ag0Var2.getContext().startActivity(new Intent("android.intent.action.VIEW", Uri.parse(ag0Var2.n0)));
                                    break;
                                } catch (Exception e7) {
                                    FileLog.e(e7);
                                }
                ...
                this.v = yf0Var;
                yf0Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
                ...
                yf0Var.setGravity(51);
                final int i13 = 1;
                yf0Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.vf0
                    public final /* synthetic */ ag0 b;
                            ...
                            case 1:
                                ...
                                if (ag0Var.V <= 0 || ag0Var.R == null) {
                                    ...
                                    if (i14 != 4 && i14 != 2 && i14 != 17 && i14 != 16 && i14 != 11 && i14 != 15) {
                                        ...
                                        tL_auth_resendCode.phone_number = ag0Var.d;
                                        tL_auth_resendCode.phone_code_hash = ag0Var.c;
                                        i132 = ((org.telegram.ui.ActionBar.n2) ag0Var.s0).currentAccount;
                                        ConnectionsManager.getInstance(i132).sendRequest(tL_auth_resendCode, new sf0(ag0Var, bundle, 0), 10);
                                        break;
                                    }
                                }
                                break;
                ...
                if (i10 == 15) {
                    ...
                    frameLayout4.addView(yf0Var2, w7.y5.e(-1, -2, 17));
                    ge0Var.addView(frameLayout4, w7.y5.e(-2, -2, 17));
                } else {
                    ...
                    ge0Var.setInAnimation(loadAnimation3);
                    ...
                    ge0Var.setOutAnimation(loadAnimation4);
                    ...
                    final int i14 = 2;
                    linearLayout2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.vf0
                        public final /* synthetic */ ag0 b;
                    ...
                    ge0Var.addView(linearLayout2, w7.y5.c(52.0f, -1));
                ...
                this.E = textView7;
                textView7.setLineSpacing(org.telegram.ui.Cells.c1.b(2.0f, R.string.WrongCode, textView7), 1.0f);
                ...
                ge0Var.addView(textView7, w7.y5.e(-2, -2, 17));
                if (viewGroup != null) {
                    FrameLayout frameLayout5 = new FrameLayout(context);
                    frameLayout5.addView(ge0Var, w7.y5.d(i10 == 15 ? -1 : -2, -2.0f, 81, 0.0f, 0.0f, 0.0f, 32.0f));
                    addView(frameLayout5, w7.y5.l(1.0f, -1, 0));
                } else {
                    viewGroup.addView(ge0Var, w7.y5.d(-2, -2.0f, 81, 0.0f, 0.0f, 0.0f, 32.0f));
                }
                n7.z0.k(ge0Var);
                if (i10 == 15) {
            ...
            if (i10 == 1) {
                float f7 = i15;
                this.a = new org.telegram.ui.Components.ij0(R.raw.code_laptop, AndroidUtilities.dp(f7), AndroidUtilities.dp(f7), true, null);
            } else {
                float f10 = i15;
                this.a = new org.telegram.ui.Components.ij0(R.raw.sms_incoming_info, AndroidUtilities.dp(f10), AndroidUtilities.dp(f10), true, null);
                this.N = new org.telegram.ui.Components.ij0(R.raw.phone_stars_to_dots, AndroidUtilities.dp(f10), AndroidUtilities.dp(f10), true, null);
                this.O = new org.telegram.ui.Components.ij0(R.raw.phone_dots, AndroidUtilities.dp(f10), AndroidUtilities.dp(f10), true, null);
                this.P = new org.telegram.ui.Components.ij0(R.raw.phone_dots_to_stars, AndroidUtilities.dp(f10), AndroidUtilities.dp(f10), true, null);
            }
        ...
        n2Var2.setTextColor(xg0Var.getThemedColor(i112));
        ...
        final int i122 = 0;
        n2Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.vf0
            public final /* synthetic */ ag0 b;
        ...
        yf0 yf0Var3 = new yf0(this, context, 0);
        this.v = yf0Var3;
        yf0Var3.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, i112, false));
        yf0Var3.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        yf0Var3.setPadding(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(14.0f), AndroidUtilities.dp(16.0f));
        yf0Var3.setTextSize(1, 15.0f);
        yf0Var3.setGravity(51);
        final int i132 = 1;
        yf0Var3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.vf0
            public final /* synthetic */ ag0 b;
                    ...
                    case 1:
                        ...
                        if (ag0Var.V <= 0 || ag0Var.R == null) {
                            ...
                            if (i142 != 4 && i142 != 2 && i142 != 17 && i142 != 16 && i142 != 11 && i142 != 15) {
                                ...
                                tL_auth_resendCode.phone_number = ag0Var.d;
                                tL_auth_resendCode.phone_code_hash = ag0Var.c;
                                i1322 = ((org.telegram.ui.ActionBar.n2) ag0Var.s0).currentAccount;
                                ConnectionsManager.getInstance(i1322).sendRequest(tL_auth_resendCode, new sf0(ag0Var, bundle, 0), 10);
                                break;
                            }
                        }
                        break;
        ...
        frameLayout42.addView(yf0Var3, w7.y5.e(-2, -2, 49));
        ge0 ge0Var2 = new ge0(context, 1);
        this.w = ge0Var2;
        if (i10 == 15) {
        }
        TextView textView72 = new TextView(context);
        this.E = textView72;
        textView72.setLineSpacing(org.telegram.ui.Cells.c1.b(2.0f, R.string.WrongCode, textView72), 1.0f);
        ...
        ge0Var2.addView(textView72, w7.y5.e(-2, -2, 17));
        if (viewGroup != null) {
        }
        n7.z0.k(ge0Var2);
        if (i10 == 15) {
    ...
    public static /* synthetic */ void o(ag0 ag0Var, Context context) {
        try {
            ...
            sb2.append(str);
            sb2.append(ag0Var.s0.e ? " #paidauth" : "");
            ...
            sb3.append("\n");
            sb3.append("Issue: ");
            sb3.append(ag0Var.s0.e ? "no_otp" : "no_otp_paid");
            sb3.append("\n");
            if (!TextUtils.isEmpty(ag0Var.e0)) {
                sb3.append("Error: ");
                sb3.append(ag0Var.e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            ag0Var.s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (ij0Var2.a0 != ij0Var2.e[0] - 1) {
            ij0Var2.t0 = new tf0(this, i10, 0);
            return;
        }
        ij0Var.t0 = new nf0(this, 3);
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            alertDialog$Builder.h(LocaleController.getString(R.string.Edit), new pf0(this, i11));
    ...
    public final void j() {
        ...
        AndroidUtilities.runOnUIThread(new nf0(this, 0), xg0.t0);
    }
    ...
    */
                ...
                if (i21 != 4) {
                    ...
                    if (i12 != 1) {
                        ...
                        if (i12 == 2) {
                            ...
                            yf0 yf0Var3 = this.x;
                            if (yf0Var3 != null) {
                                yf0Var3.setVisibility(this.V < 1000 ? 0 : 8);
                            }
                        ...
                        if (i12 == i10) {
                            ...
                            yf0 yf0Var4 = this.x;
                            if (yf0Var4 != null) {
                                yf0Var4.setVisibility(this.V < 1000 ? 0 : 8);
                            }
                            u();
                        }
                        if (i12 == 11) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        ds dsVar = this.f;
        if (dsVar == null || (gsVarArr = dsVar.f) == null) {
            return;
        }
    ...
    public final void q(Runnable runnable) {
        ...
        while (true) {
            ds dsVar = this.f;
            if (i10 >= dsVar.f.length) {
                dsVar.postDelayed(new y80(24, this, runnable), (r2.length * 75) + 400);
                return;
            } else {
    ...
    public final void y() {
        ...
        dsVar.f[0].requestFocus();
        AndroidUtilities.shakeViewSpring(dsVar, this.f0 == 11 ? 3.5f : 10.0f, new nf0(this, 7));
        nf0 nf0Var = this.r0;
