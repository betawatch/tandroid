...
public final class b1 extends View implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.l9 {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockaudio != null) {
            ...
            d3 q10 = l4.q(this.a, this, null, pageblockaudio2.caption.text, dp2, this.r, pageblockaudio2, this.b);
            this.c = q10;
            if (q10 != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (this.F == 1) {
                ...
                RadialProgress2 radialProgress2 = this.e;
                if (i11 == 0) {
                    if (j4Var != null && MediaController.getInstance().setPlaylist(j4Var.v, this.J, 0L, false, null)) {
                        this.E = 1;
                    ...
                    FileLoader.getInstance(i10).loadFile(this.I, j4Var == null ? null : j4Var.B, 1, 1);
                    this.E = 3;
