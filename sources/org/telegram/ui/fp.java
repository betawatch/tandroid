...
public final class fp extends org.telegram.ui.Components.ml0 {
    public static final /* synthetic */ int b3 = 0;
    public final ep X2;
    public boolean Y2;
    public final Paint Z2;
    public final /* synthetic */ gp a3;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public fp(gp gpVar, Context context) {
        super(context, null);
        this.a3 = gpVar;
        this.Y2 = false;
        this.Z2 = new Paint(1);
        ...
        setOnItemClickListener(new dp(this));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (i10 < i11) {
            int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, this.p2);
            Paint paint = this.Z2;
            paint.setColor(v02);
            canvas2 = canvas;
    ...
    public final void w1(TLRPC.TL_username tL_username, boolean z10, boolean z11) {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if (arrayList.get(i11) == tL_username) {
                ...
                while (true) {
                    ...
                    if (RecyclerView.R(childAt) == i12) {
                        ...
                        if (childAt instanceof na) {
                            na naVar = (na) childAt;
                            naVar.setLoading(gpVar.P.contains(tL_username2.username));
                ...
                int i18 = i13 - 1;
                ep epVar = this.X2;
                ArrayList arrayList2 = epVar.c.a3.N;
