...
public final class o extends org.telegram.ui.Components.ll0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (j(i10) != 0) {
            if (j(i10) == 2) {
                ...
                if (i10 == pVar.w) {
                    ...
                    f9Var.setText(LocaleController.getString(pVar.H == 5 ? R.string.ArchivedEmojiInfo : R.string.ArchivedStickersInfo));
                    return;
                } else {
        ...
        wVar.setOnCheckedChangeListener(new ah.b(29, this, stickerSetCovered));
    }
