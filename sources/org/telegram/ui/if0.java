...
public final /* synthetic */ class if0 implements Runnable {
    ...
    public /* synthetic */ if0(KeyEvent.Callback callback, TLObject tLObject, Object obj, int i10) {
        this.a = i10;
        this.b = callback;
        this.c = tLObject;
        this.d = obj;
    ...
    */
        ...
        switch (this.a) {
            case 0:
                ...
                if (tL_error == null) {
                    ...
                    i15 = ((org.telegram.ui.ActionBar.p2) og0Var).currentAccount;
                    ...
                    og0Var.getMessagesController().removeSuggestion(0L, "VALIDATE_PHONE_NUMBER");
                    if (i24 == 3) {
                        AndroidUtilities.endIncomingCall();
                    }
                    sf0Var.q(new ff0(sf0Var, 5));
                    break;
                } else {
                    sf0Var.b0 = tL_error.text;
                    sf0Var.a0 = false;
                    ...
                    if (i24 == 3) {
                        ...
                        if (i24 != 3) {
                            ...
                            while (true) {
                                zr zrVar = sf0Var.f;
                                cs[] csVarArr = zrVar.f;
                                if (i26 >= csVarArr.length) {
                                    zrVar.e = false;
                                    csVarArr[0].requestFocus();
                                    break;
                                } else {
                                    csVarArr[i26].setText("");
                                    i26++;
                                }
                            }
                        }
            ...
            case 1:
                ...
                sf0Var2.p0.g1(bundle, tL_auth_sentCode, true);
                break;
            case 2:
                ...
                qh.d dVar = xf0Var.b;
                og0 og0Var2 = xf0Var.v;
                xf0Var.s = -1;
                if (tLObject3 instanceof TLRPC.auth_SentCode) {
                    xf0Var.f = false;
                    dVar.setLoading(false);
                    org.telegram.ui.ActionBar.f5 parentLayout = og0Var2.getParentLayout();
                    if (parentLayout != null && parentLayout.getFragmentStack() != null) {
                        List fragmentStack = parentLayout.getFragmentStack();
                        org.telegram.ui.ActionBar.p2 p2Var = fragmentStack.isEmpty() ? null : (org.telegram.ui.ActionBar.p2) yh.j(1, fragmentStack);
                        ...
                        if (p2Var instanceof lo0) {
                            ...
                            og0Var2.g1(xf0Var.d, (TLRPC.auth_SentCode) tLObject3, z10);
                            break;
                        }
                    }
                    z10 = true;
                    ...
                    if (str2 == null || !str2.startsWith("FLOOD_WAIT_")) {
                        ...
                        if (str3 == null || !"PHONE_CODE_EXPIRED".equalsIgnoreCase(str3)) {
                            xf0Var.e = tL_error2.text;
                            xf0Var.f = false;
                            dVar.setLoading(false);
                            new org.telegram.ui.Components.qc(og0Var2.W, null).H(R.raw.error, LocaleController.formatString(R.string.UnknownErrorCode, tL_error2.text));
                            break;
                        } else {
                        ...
                        AndroidUtilities.runOnUIThread(new uf0(xf0Var, 2), Integer.parseInt(tL_error2.text.substring(11)) * MediaDataController.MAX_STYLE_RUNS_COUNT);
                        break;
                    }
                }
                break;
            case 3:
                ...
                og0 og0Var3 = xf0Var2.v;
                og0Var3.e = true;
                og0 og0Var4 = (og0) LaunchActivity.N();
                if (og0Var4 == null) {
                    i16 = ((org.telegram.ui.ActionBar.p2) og0Var3).currentAccount;
                    og0Var4 = new og0(i16);
                    org.telegram.ui.ActionBar.p2 U = LaunchActivity.U();
                    if (U != null) {
                        U.presentFragment(og0Var4);
                    }
                }
                og0Var4.q1(tL_inputStorePaymentAuthCode.phone_number, tL_updateSentPhoneCode.sent_code);
                break;
            case 4:
                ...
                if (tLObject4 != null) {
                    ...
                    if (rj0Var.length() == 0) {
                        ...
                        ArrayList arrayList4 = ng0Var.B;
                        if (((String) hashMap.get(upperCase)) != null && arrayList4 != null) {
                            int i30 = 0;
                            while (true) {
                                if (i30 >= arrayList4.size()) {
                                    ttVar = null;
                                } else if (arrayList4.get(i30) == null || !((tt) arrayList4.get(i30)).a.equals(upperCase)) {
                                    i30++;
                                } else {
                                    ttVar = (tt) arrayList4.get(i30);
                                }
                            }
                            if (ttVar != null) {
                                rj0Var.setText(ttVar.c);
                                ng0Var.x = 0;
                                break;
                            }
                        }
            ...
            case 5:
                ...
                if (tL_error3 != null) {
                    ...
                    qh0 qh0Var2 = qh0Var.p0.a;
                    int i31 = 0;
                    while (true) {
                        ArrayList arrayList5 = qh0Var2.g0;
            ...
            case 8:
                ...
                if (lowerCase.length() == 0) {
                    AndroidUtilities.runOnUIThread(new b30(ik0Var, new ArrayList(), new ArrayList(), new ArrayList(), 16));
                    break;
                } else {
                    ...
                    AndroidUtilities.runOnUIThread(new b30(ik0Var, arrayList8, arrayList9, arrayList7, 16));
                    break;
                }
                break;
            case 9:
            ...
            case 10:
                ...
                break;
            case 11:
                ((tm0) this.b).C(((TLRPC.TL_error) this.d).text, (String) this.c);
                break;
            case 12:
    ...
    public /* synthetic */ if0(Object obj, Object obj2, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = obj2;
        this.c = obj3;
