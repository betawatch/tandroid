...
public final class lf0 extends org.telegram.ui.Components.uv0 {
    ...
    public final org.telegram.ui.Components.yc0 a;
    public final EditTextBoldCursor b;
    public final TextView c;
    public final org.telegram.ui.Components.c90 d;
    public final TextView e;
    public final org.telegram.ui.Components.j90 f;
    ...
    */
    public lf0(wg0 wg0Var, Context context) {
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                c90Var.setText(LocaleController.getString(R.string.AddEmailSubtitle));
                addView(c90Var, w7.x5.t(-2, -2, 1, 32, 8, 32, 0));
                org.telegram.ui.Components.yc0 yc0Var = new org.telegram.ui.Components.yc0(context, null);
                this.a = yc0Var;
                yc0Var.setText(LocaleController.getString(wg0Var.F != 3 ? R.string.YourNewEmail : R.string.YourEmail));
                ...
                addView(yc0Var, w7.x5.k(16.0f, 24.0f, 16.0f, 0.0f, -1, 58));
                ...
                org.telegram.ui.Components.j90 j90Var = new org.telegram.ui.Components.j90(context);
                this.f = j90Var;
                addView(new Space(context), w7.x5.l(1.0f, 0, 0));
                FrameLayout frameLayout2 = new FrameLayout(context);
                frameLayout2.addView(textView2, w7.x5.d(-2, -2.0f, 83, 0.0f, 0.0f, 0.0f, 24.0f));
                frameLayout2.addView(j90Var, w7.x5.d(-2, 16.0f, 83, 0.0f, 0.0f, 0.0f, 70.0f));
                j90Var.setMeasureAfter(textView2);
                addView(frameLayout2, w7.x5.n(-1, -2));
                n7.a1.j(frameLayout2);
                frameLayout2.setOnClickListener(new k60(this, 8));
            }
        }
        i10 = 8;
        frameLayout.setVisibility(i10);
        ...
        org.telegram.ui.Components.c90 c90Var2 = new org.telegram.ui.Components.c90(context, null);
        this.d = c90Var2;
        c90Var2.setTextSize(1, 14.0f);
        c90Var2.setGravity(17);
        c90Var2.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        c90Var2.setText(LocaleController.getString(R.string.AddEmailSubtitle));
        addView(c90Var2, w7.x5.t(-2, -2, 1, 32, 8, 32, 0));
        org.telegram.ui.Components.yc0 yc0Var2 = new org.telegram.ui.Components.yc0(context, null);
        this.a = yc0Var2;
        yc0Var2.setText(LocaleController.getString(wg0Var.F != 3 ? R.string.YourNewEmail : R.string.YourEmail));
        ...
        addView(yc0Var2, w7.x5.k(16.0f, 24.0f, 16.0f, 0.0f, -1, 58));
        ...
        org.telegram.ui.Components.j90 j90Var2 = new org.telegram.ui.Components.j90(context);
        this.f = j90Var2;
        addView(new Space(context), w7.x5.l(1.0f, 0, 0));
        FrameLayout frameLayout22 = new FrameLayout(context);
        frameLayout22.addView(textView22, w7.x5.d(-2, -2.0f, 83, 0.0f, 0.0f, 0.0f, 24.0f));
        frameLayout22.addView(j90Var2, w7.x5.d(-2, 16.0f, 83, 0.0f, 0.0f, 0.0f, 70.0f));
        j90Var2.setMeasureAfter(textView22);
        addView(frameLayout22, w7.x5.n(-1, -2));
        n7.a1.j(frameLayout22);
        frameLayout22.setOnClickListener(new k60(this, 8));
    }
    ...
    public final void o() {
        org.telegram.ui.Components.yc0 yc0Var = this.a;
        wg0 wg0Var = this.E;
