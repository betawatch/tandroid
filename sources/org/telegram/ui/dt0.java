...
public final class dt0 extends org.telegram.ui.Components.jd {
    public final Path t1;
    public final /* synthetic */ PhotoViewer u1;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public dt0(PhotoViewer photoViewer, Context context, ev0 ev0Var, org.telegram.ui.Components.qv0 qv0Var, FrameLayout frameLayout, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ha haVar, kr0 kr0Var) {
        super(context, ev0Var, qv0Var, frameLayout, f6Var, haVar, kr0Var);
        this.u1 = photoViewer;
        this.t1 = new Path();
    }
    ...
    public final void I() {
        ...
        D(dv0Var != null && dv0Var.l() && (photoViewer.U1.L.c() || !(photoViewer.r1 || TextUtils.isEmpty(photoViewer.f1().getText()))), true);
    }
    ...
    */
    public final void x(int i10) {
        ...
        boolean z10 = false;
        if (frameLayout != null) {
            frameLayout.animate().translationY(-Math.max(0, (i10 - r1.bottom) - photoViewer.P0.getHeight())).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.q1.w).start();
        }
