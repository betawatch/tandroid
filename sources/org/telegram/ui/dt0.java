...
public final class dt0 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        if (bitmap != null || photoViewer.o1) {
            photoViewer.z1.b(bitmap, photoViewer.z4.getOrientation(), photoViewer.Z1 != 1, false, photoViewer.A1, photoViewer.o1 ? (org.telegram.ui.Components.y61) photoViewer.y2 : null, zt0Var.c);
            photoViewer.z1.a();
            int bitmapWidth = photoViewer.z4.getBitmapWidth();
            int bitmapHeight = photoViewer.z4.getBitmapHeight();
            MediaController.CropState cropState = zt0Var.c;
            if (cropState != null) {
        ...
        photoViewer.m6.addListener(new ns0(this, 1));
