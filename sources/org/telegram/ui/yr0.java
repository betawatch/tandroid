...
public final class yr0 extends org.telegram.ui.Components.ad {
    ...
    public final void I() {
        ...
        D(zt0Var != null && zt0Var.l() && (photoViewer.Q1.H.c() || !(photoViewer.n1 || TextUtils.isEmpty(photoViewer.f1().getText()))), true);
    }
    ...
    public final void u(float f10) {
        super.u(f10);
        PhotoViewer photoViewer = this.q1;
        org.telegram.ui.ActionBar.l0 l0Var = photoViewer.a1;
        float f11 = 1.0f - f10;
        l0Var.setAlpha((l0Var.getTag() != null ? 1 : 0) * f11);
        org.telegram.ui.Components.n80 n80Var = photoViewer.b1;
        n80Var.setAlpha((n80Var.getTag() != null ? 1 : 0) * f11);
    ...
    */
    public final void x(int i9) {
        ...
        boolean z10 = false;
        if (frameLayout != null) {
            frameLayout.animate().translationY(-Math.max(0, (i9 - r1.bottom) - photoViewer.L0.getHeight())).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.q1.w).start();
        }
