            ...
            while (i11 < this.O.size()) {
                ...
                if (!s61Var.b) {
                    ...
                    if (!z10 || j71Var.N1 < 0 || j71Var.O1 < 0 || j71Var.P1 <= 0) {
                        ...
                        int S = RecyclerView.S(s61Var);
                        int i13 = j71Var.N1;
                        int i14 = S - i13;
                        int i15 = j71Var.O1 - i13;
                        if (i14 >= 0 && i14 < i15) {
                            float a2 = w7.q.a((SystemClock.elapsedRealtime() - j71Var.P1) / j71Var.f(), 0.0f, 1.0f);
                            float f13 = i14;
                            float f14 = i15;
                            float f15 = f14 / 4.0f;
                    ...
                    if (j71Var.P1 > 0) {
                        ...
                        if (SystemClock.elapsedRealtime() - j71Var.P1 >= j71Var.g() || j71Var.N1 < 0 || j71Var.O1 < 0 || j71Var.P1 <= 0) {
                            ...
                            if (imageReceiver.getLottieAnimation() != null) {
                                s61Var.r.getLottieAnimation().V(j3);
                            }
