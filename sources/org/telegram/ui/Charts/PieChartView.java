                ...
                if (f17 != f7) {
                    ...
                    if (((PieChartViewData) this.lines.get(i7)).selectionA > f7) {
                        ...
                        if (canvas3 != null) {
                            ...
                            ((PieChartViewData) this.lines.get(i4)).paint.setAlpha(NotificationCenter.invalidateMotionBackground);
                            f16 += f17 * 360.0f;
                            i7 = i4 + 1;
                            f14 = f4;
                            i5 = i3;
        ...
        if (canvas3 != null) {
            ...
            while (i9 < size) {
                if (((PieChartViewData) this.lines.get(i9)).alpha > 0.0f || ((PieChartViewData) this.lines.get(i9)).enabled) {
                    ...
                    canvas.restore();
                    ((PieChartViewData) this.lines.get(i9)).paint.setAlpha(NotificationCenter.invalidateMotionBackground);
                    f15 += f3 * 360.0f;
                } else {
                    canvas2 = canvas3;
                    i2 = i8;
