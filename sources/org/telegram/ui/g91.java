...
public final class g91 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40, fh0, le.d {
    ...
    public org.telegram.ui.Components.f61 c;
    public ci.s6 d;
    ...
    public static /* synthetic */ void V(g91 g91Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
    ...
    public static /* synthetic */ void W(g91 g91Var) {
        ...
        org.telegram.ui.Components.u40 u40Var = g91Var.n;
        TLRPC.UserProfilePhoto userProfilePhoto = user.photo;
        u40Var.o((userProfilePhoto == null || userProfilePhoto.photo_big == null || (userProfilePhoto instanceof TLRPC.TL_userProfilePhotoEmpty)) ? false : true, new t81(g91Var, 4), new ci.f1(6), 0);
    }

    public static /* synthetic */ void X(g91 g91Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
    ...
    */
    public static void Z(g91 g91Var) {
        String str;
        int i10;
        String string;
        String str2;
        ...
        if (i12 < 2 && !BuildVars.DEBUG_PRIVATE_VERSION) {
            try {
                Toast.makeText(g91Var.getParentActivity(), LocaleController.getString(R.string.DebugMenuLongPress), 0).show();
                return;
            } catch (Exception e) {
                FileLog.e(e);
                return;
        ...
        String string15 = LocaleController.getString(ci.d1.q(g91Var.getParentActivity()) ? "DebugMenuDualOff" : "DebugMenuDualOn");
        ...
        String str19 = !SharedConfig.isUsingCamera2(g91Var.currentAccount) ? "Use Camera 2 API" : "Use old Camera 1 API";
        ...
        if (SharedConfig.canBlurChat()) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                alertDialog$Builder.f(charSequenceArr, new wv(g91Var, 3));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                g91Var.showDialog(c2Var);
            }
        } else {
            str4 = string2;
        }
        ...
        alertDialog$Builder.f(charSequenceArr2, new wv(g91Var, 3));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
        g91Var.showDialog(c2Var);
    }

    public static /* synthetic */ void a0(g91 g91Var, ValueAnimator valueAnimator) {
    ...
    public static void b0(g91 g91Var, ArrayList arrayList) {
        ...
        if (r0Var != null && r0Var.getTag() != null) {
            ...
            if (y81Var.w) {
                ...
                while (i13 < size) {
                    ...
                    i13++;
                    int i14 = i12 + 1;
                    CharSequence charSequence = (CharSequence) y81Var.n.get(i12);
                ...
                ArrayList arrayList7 = y81Var.s;
                int size2 = arrayList7.size();
                while (i11 < size2) {
                    Object obj2 = arrayList7.get(i11);
                    i11++;
                    int i16 = i12 + 1;
                    CharSequence charSequence2 = (CharSequence) y81Var.n.get(i12);
        ...
        FrameLayout frameLayout = g91Var.x;
        ...
        while (true) {
            ...
            if (UserConfig.getInstance(i22).isClientActivated() && g91Var.currentAccount != i22) {
        ...
        if (set.contains("PREMIUM_GRACE")) {
            arrayList.add(e91.a(LocaleController.getString(R.string.GraceSuggestionTitle), LocaleController.getString(R.string.GraceSuggestionMessage), null, null, LocaleController.getString(R.string.GraceSuggestionButton), new u81(g91Var, i11)));
            ...
            arrayList.add(e91.a(LocaleController.formatString(R.string.CheckPhoneNumber, org.telegram.messenger.w1.j(new StringBuilder("+"), g91Var.getUserConfig().getCurrentUser().phone, gf.b.c())), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.CheckPhoneNumberInfo), new t81(g91Var, i23)), LocaleController.getString(R.string.CheckPhoneNumberNo), new u81(g91Var, i23), yh.a4.g2(LocaleController.getString(R.string.CheckPhoneNumberYes2)), new u81(g91Var, 2)));
            arrayList.add(org.telegram.ui.Components.j51.B(null));
        } else if (set.contains("VALIDATE_PASSWORD")) {
            arrayList.add(e91.a(LocaleController.getString(R.string.YourPasswordHeader), LocaleController.getString(R.string.YourPasswordRemember), LocaleController.getString(R.string.YourPasswordRememberNo), new u81(g91Var, 3), LocaleController.getString(R.string.YourPasswordRememberYes), new u81(g91Var, i10)));
            arrayList.add(org.telegram.ui.Components.j51.B(null));
        }
        ...
        if (g91Var.getMessagesController().starsPurchaseAvailable()) {
            ...
            arrayList.add(c91.a(12, -1071598, -1608430, R.drawable.settings_stars, LocaleController.getString(R.string.TelegramStars), null, (!y3.e || y3.p().amount <= 0) ? "" : yh.y7.J0(y3.p(), 0.85f, ' ')));
        }
        ...
        if (ApplicationLoader.isBetaBuild() || ApplicationLoader.isStandaloneBuild() || ApplicationLoader.isHuaweiStoreBuild() || (yh.v5.y(g91Var.currentAccount, true).e && (yh.v5.y(g91Var.currentAccount, true).O(0) || yh.v5.y(g91Var.currentAccount, true).p().positive()))) {
            ...
            if (y10.e && j3 > 0) {
                charSequence3 = yh.y7.J0(y10.p(), 0.85f, ' ');
            }
            arrayList.add(c91.a(13, -14965523, -15431455, i26, string, null, charSequence3));
        }
        ...
        if (((org.telegram.ui.Components.j51) hg.k0.h(1, arrayList)).a != 7) {
            arrayList.add(org.telegram.ui.Components.j51.B(null));
        }
    ...
    public static /* synthetic */ void c0(g91 g91Var, TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        g91Var.U = -1;
        if (tL_error == null) {
            ...
            } else if (closestPhotoSizeWithSize2 != null && g91Var.w != null) {
                FileLoader.getInstance(g91Var.currentAccount).getPathToAttach(g91Var.w, true).renameTo(FileLoader.getInstance(g91Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize2, true));
            }
            g91Var.getMessagesController().getDialogPhotos(user.id).addPhotoAtStart(tL_photos_photo.photo);
    ...
    public static void d0(g91 g91Var, int i10) {
        ...
        if (i10 == 6) {
            ...
            for (String str2 : MessagesController.getNotificationsSettings(g91Var.currentAccount).getAll().keySet()) {
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(g91Var.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 == 19) {
                ...
                g91Var.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new v81(g91Var, i12));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                ...
                if (i10 == 23) {
                    ...
                    Toast.makeText(g91Var.getParentActivity(), LocaleController.getString(!q6 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i12 < g91Var.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.o2) g91Var.getParentLayout().getFragmentStack().get(i12)).clearSheets();
                        i12++;
                    }
                    return;
                }
    ...
    public static /* synthetic */ void e0(g91 g91Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            TLRPC.FileLocation fileLocation = photoSize.location;
            g91Var.v = fileLocation;
            g91Var.w = photoSize2.location;
    ...
    public final View createView(Context context) {
        ...
        int i10 = 0;
        this.actionBar.setActionBarMenuOnItemClick(new x81(this, i10));
        ...
        org.telegram.ui.Components.f61 f61Var2 = this.c;
        y8 y8Var = this.b;
        Objects.requireNonNull(f61Var2);
        this.Y = new ah.o(f61Var2, y8Var, new x8(f61Var2, i10));
        this.c.D0(new t81(this, 2));
        ...
        this.y.setOnClickListener(new u81(this, 5));
        w7.z5.a(this.y);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.updateInterfaces) {
            ...
            if (i10 != NotificationCenter.newSuggestionsAvailable || (f61Var = this.c) == null) {
                return;
            }
            f61Var.Y2.N(true);
        }
    ...
    public final void n0(boolean z10, boolean z11) {
        ...
        this.r.addListener(new j70(9, this, z10));
        this.r.start();
    }
    ...
    public final void o0(boolean z10, boolean z11) {
        ...
        if (r0Var == null || r0Var.getTag() == null) {
            ...
            if (this.P == z12 || z10) {
                ...
                this.Q = ofFloat;
                ofFloat.addUpdateListener(new k21(this, 10));
