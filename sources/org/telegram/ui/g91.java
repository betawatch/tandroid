...
public final class g91 extends org.telegram.ui.Components.sa {
    ...
    public g91(final Context context, final int i10, final org.telegram.ui.ActionBar.f6 f6Var, final kh.a1 a1Var) {
        super(context, null, true, false, false, 1, f6Var);
        this.currentAccount = i10;
        this.v = 0.2f;
        this.smoothKeyboardAnimationEnabled = true;
        this.smoothKeyboardByBottom = true;
        lh.c cVar = new lh.c(context, i10, lf.b.b, f6Var);
        this.U = cVar;
        cVar.setScaleX(0.6f);
        cVar.setScaleY(0.6f);
        cVar.setAlpha(0.0f);
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            spannableStringBuilder.setSpan(new e91(f6Var), length, spannableStringBuilder.length(), 33);
            ...
            org.telegram.ui.Components.lq lqVar = new org.telegram.ui.Components.lq(R.drawable.dice6, 0);
            lqVar.recolorDrawable = false;
            lqVar.setScale(0.8f, 0.8f);
            spannableStringBuilder2.setSpan(lqVar, 0, spannableStringBuilder2.length(), 33);
            ...
            final org.telegram.ui.Components.bd0 bd0Var = new org.telegram.ui.Components.bd0(context, f6Var);
            bd0Var.setForceForceUseCenter(true);
            bd0Var.setText(LocaleController.getString(R.string.StakeDicePlaceholder));
            ...
            editTextBoldCursor.setOnFocusChangeListener(new lh.n8(bd0Var, editTextBoldCursor, 1));
            ...
            bd0Var.addView(linearLayout4, k7.b6.e(-1, -2, 48));
            linearLayout3.addView(bd0Var, k7.b6.n(-1, -2));
            TextView textView = new TextView(context);
            textView.setTextSize(1, 16.0f);
            textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.A6, false));
            bd0Var.addView(textView, k7.b6.d(-2, -2.0f, 21, 0.0f, 0.0f, 14.0f, 0.0f));
            ...
            final int[] iArr = {2};
            bd0Var.c(false, TextUtils.isEmpty(editTextBoldCursor.getText()) ^ true);
            editTextBoldCursor.addTextChangedListener(new f91(i10, editTextBoldCursor, bd0Var, iArr, textView));
            Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.c91
                ...
                public final Object run(Object obj) {
                    ...
                    k7.d6.a(textView2);
                    textView2.setOnClickListener(new ib0(20, editTextBoldCursor, l10));
                    return textView2;
                }
            };
            ...
            org.telegram.ui.Components.lq lqVar2 = new org.telegram.ui.Components.lq(R.drawable.mini_roll, 0);
            lqVar2.setTranslateY(AndroidUtilities.dp(1.0f));
            spannableStringBuilder3.setSpan(lqVar2, 0, spannableStringBuilder3.length(), 33);
            ...
            dVar2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.d91
                ...
                public final void onClick(View view) {
                    ...
                    try {
                        ...
                        org.telegram.ui.Components.bd0 bd0Var2 = bd0Var;
                        int[] iArr2 = iArr;
                        if (parseDouble > d) {
                            ...
                            int i22 = -iArr2[0];
                            iArr2[0] = i22;
                            AndroidUtilities.shakeViewSpring(bd0Var2, i22);
                            return;
                        }
                        if (TextUtils.isEmpty(text) || parseDouble >= MessagesController.getInstance(i21).tonStakeddiceStakeAmountMin / 1.0E9d) {
                            if (lh.t7.y(i21, true).f.toDouble() < parseDouble) {
                                new qh.f(context, f6Var, lf.a.i((long) (parseDouble * 1.0E9d), lf.b.b), true, new j21(3));
                                return;
                            } else {
                        ...
                        int i23 = -iArr2[0];
                        iArr2[0] = i23;
                        AndroidUtilities.shakeViewSpring(bd0Var2, i23);
            ...
            rl0Var.setPadding(i22, 0, i22, AndroidUtilities.dp(68.0f));
            this.Z.N(false);
        }
    }
    ...
    public final org.telegram.ui.Components.ql0 v(org.telegram.ui.Components.rl0 rl0Var) {
        org.telegram.ui.Components.w51 w51Var = new org.telegram.ui.Components.w51(rl0Var, getContext(), this.currentAccount, 0, false, new f5(this, 27), this.resourcesProvider);
        this.Z = w51Var;
        return w51Var;
    }
