...
public final class rm implements org.telegram.ui.Components.mg {
    ...
    public final void E0(int i10, int i11) {
            ...
            if (yVar.o == null) {
                ...
                if (boVar.i0.l != 0) {
                    if (!(boVar.R3 == 3 && boVar.I8() == boVar.getUserConfig().getClientUserId()) && (boVar.R3 != 0 || (!(boVar.d4 == 0 || boVar.h4) || UserObject.isReplyUser(boVar.f) || boVar.A9()))) {
                        ...
                        org.telegram.ui.ActionBar.y yVar2 = boVar.e0;
                        if (yVar2 != null) {
                            yVar2.f(8);
                        }
                        hs hsVar = boVar.d0;
        ...
        org.telegram.ui.ActionBar.y yVar3 = boVar.i0;
        if (yVar3.o != null) {
            yVar3.o = null;
            if (yVar3.l != 8) {
                if (!(boVar.R3 == 3 && boVar.I8() == boVar.getUserConfig().getClientUserId()) && (boVar.R3 != 0 || (!(boVar.d4 == 0 || boVar.h4) || UserObject.isReplyUser(boVar.f) || boVar.A9()))) {
                ...
                if (boVar.Y.l0() && TextUtils.isEmpty(boVar.Y.getSlowModeTimer())) {
                    ...
                    org.telegram.ui.ActionBar.y yVar4 = boVar.e0;
                    if (yVar4 != null) {
                        yVar4.f(0);
                    }
                    hs hsVar2 = boVar.d0;
                ...
                org.telegram.ui.ActionBar.y yVar5 = boVar.e0;
                if (yVar5 != null) {
                    yVar5.f(8);
                }
                hs hsVar3 = boVar.d0;
    ...
    public final void H(CharSequence charSequence, boolean z10, int i10, int i11, long j3) {
        ...
        if (!TextUtils.isEmpty(charSequence) && (messagePreviewParams = boVar.f5) != null && (messages = messagePreviewParams.forwardMessages) != null && !messages.messages.isEmpty() && boVar.f5.quote == null && j3 <= 0) {
            ...
            if (z11) {
                ...
                org.telegram.ui.Components.aj0 aj0Var = ((org.telegram.ui.Components.lc) M.e).a;
    ...
    public final void d2() {
        org.telegram.ui.Components.ny0 ny0Var = this.c.d1;
        if (ny0Var != null) {
            ny0Var.e();
        }
    }
    ...
    public final void l1(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        ij ijVar = boVar.g2;
        if ((ijVar != null && ijVar.getVisibility() == 0) || ((i40Var = boVar.i2) != null && i40Var.getVisibility() == 0)) {
            ij ijVar2 = boVar.g2;
            if (ijVar2 != null) {
                ijVar2.b(true);
            }
    ...
    public final void s1() {
        ...
        float f7 = 0.0f;
        if (fkVar != null) {
            fkVar.animate().alpha((z10 || boVar.isInPreviewMode()) ? 0.0f : 1.0f).setInterpolator(org.telegram.ui.Components.qr.f).start();
        }
        org.telegram.ui.Components.ny0 ny0Var = boVar.d1;
        if (ny0Var != null) {
    ...
    public final void t1(View view, CharSequence charSequence, boolean z10) {
        ...
        org.telegram.ui.ActionBar.y yVar = boVar.e0;
        if (yVar != null) {
            yVar.f(8);
        }
        hs hsVar = boVar.d0;
