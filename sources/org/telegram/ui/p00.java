...
public final class p00 extends org.telegram.ui.Cells.m4 {
    ...
    */
    public p00(b10 b10Var, Context context) {
        ...
        textView.setTextColor(b10Var.getThemedColor(org.telegram.ui.ActionBar.j6.z6));
        ...
        this.s = x9Var;
        this.w = new org.telegram.ui.Components.c5(x9Var, 320L, org.telegram.ui.Components.nr.h, 0);
    ...
    public final void d(int i10, boolean z4) {
        ...
        if (z10 != this.x) {
            ...
            x9Var.animate().alpha(z10 ? 0.0f : 1.0f).setDuration(320L).setInterpolator(nrVar).start();
        }
    }
