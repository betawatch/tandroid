...
public final class c01 extends org.telegram.ui.Components.pv0 implements r0.m {
    public boolean A0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && hVar != null) {
            ...
            if (dVar != null && !dVar.n) {
                ...
                a2.drawColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.a7, profileActivity.z0));
        ...
        paint.setColor(org.telegram.ui.ActionBar.h6.v0(i10, profileActivity.z0));
        if (profileActivity.a.getVisibility() == 0) {
            int v02 = org.telegram.ui.ActionBar.h6.v0(i10, profileActivity.z0);
        ...
        canvas.translate(yy0Var != null ? yy0Var.getTranslationX() : 0.0f, 0.0f);
        int v03 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, profileActivity.z0);
        int i13 = profileActivity.l6;
        yy0 yy0Var2 = profileActivity.a;
        AndroidUtilities.drawNavigationBarProtection(canvas, this, v03, i13, yy0Var2 != null ? yy0Var2.getAlpha() : 0.0f);
        canvas.restore();
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (e01Var != null && (rt0Var = (rt0VarArr = e01Var.k0)[0]) != null && rt0Var.h.getFastScroll() != null && rt0VarArr[0].h.getFastScroll().n) {
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        org.telegram.ui.Components.ml0 ml0Var = profileActivity.b;
        if (ml0Var != null) {
            FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) ml0Var.getLayoutParams();
        ...
        if (profileActivity.g5 != null) {
            org.telegram.ui.ActionBar.i5 i5Var = i5VarArr[c10];
            i5Var.setRightPadding(i5Var.getMeasuredWidth() - profileActivity.g5.n().getTitleTextView().getMeasuredWidth());
        }
        ...
        if (!z15 && ((z14 = profileActivity.n1) || (profileActivity.G1 && profileActivity.J1 == 2))) {
            ...
            if (z14) {
                ...
                i5VarArr[1].setPivotY(r8.getMeasuredHeight());
                i5VarArr[1].setScaleX(1.38f);
                i5VarArr[1].setScaleY(1.38f);
                org.telegram.ui.Components.yl0 yl0Var = profileActivity.L;
                if (yl0Var != null) {
                    yl0Var.b(Color.argb(MessagesStorage.LAST_DB_VERSION, 255, 255, 255));
                }
                ...
                if (eh0Var != null) {
                    eh0Var.setParentExpanded(1.0f);
                }
                org.telegram.ui.Components.wh0 wh0Var = profileActivity.c0;
                if (wh0Var != null) {
                    wh0Var.setParentExpanded(1.0f);
                }
                org.telegram.ui.Components.iw0 iw0Var = profileActivity.T;
                if (iw0Var != null) {
                    iw0Var.setParentExpanded(1.0f);
                }
                c11 = 0;
            ...
            yy0 yy0Var2 = profileActivity.a;
            yy0Var2.layout(0, i16, yy0Var2.getMeasuredWidth(), profileActivity.a.getMeasuredHeight() + i16);
            this.y0 = false;
            ...
            if (view == null && (view = profileActivity.a.getChildAt(0)) != null) {
                yy0 yy0Var3 = profileActivity.a;
                View F = yy0Var3.F(view);
                s4.c1 T = F == null ? null : yy0Var3.T(F);
                i12 = T.b();
                if (i12 == -1 && (i12 = T.g) == -1) {
                    i12 = T.c;
                }
                    ...
                    if (i21 >= 0) {
                        ...
                        if ((z10 && profileActivity.o2) || view == null) {
                            ...
                            if (z12) {
                                measureChildWithMargins(profileActivity.a, i10, 0, i11, 0);
                                try {
                                    yy0 yy0Var4 = profileActivity.a;
                                    yy0Var4.layout(0, i16, yy0Var4.getMeasuredWidth(), profileActivity.a.getMeasuredHeight() + i16);
                                } catch (Exception e) {
                                    FileLog.e(e);
                                }
                            }
