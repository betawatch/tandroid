...
public final class lo0 implements TextWatcher {
    ...
    */
    public final void afterTextChanged(Editable editable) {
        ...
        boolean z10 = true;
        EditTextBoldCursor editTextBoldCursor = qo0Var.f[1];
        ...
        qo0Var.o0 = true;
        qo0Var.f[1].setTextColor(qo0Var.getThemedColor(org.telegram.ui.ActionBar.h6.G6));
        if (sb2.length() > 4) {
            sb2.setLength(4);
        }
        if (sb2.length() < 2) {
        ...
        if (!this.b) {
            if (sb2.length() == 1) {
                ...
                if (intValue2 > 12 || intValue2 == 0) {
                    qo0Var.f[1].setTextColor(qo0Var.getThemedColor(org.telegram.ui.ActionBar.h6.p7));
                } else {
                    z10 = false;
                }
                selectionStart++;
        ...
        if (sb2.length() == 4 && i13 == 2) {
            ...
            i10 = ((org.telegram.ui.ActionBar.n2) qo0Var).currentAccount;
            boolean z11 = UserConfig.getInstance(i10).getClientPhone().startsWith("7") || ((stVar = qo0Var.A0) != null && stVar.c.equals("7"));
        ...
        if (intValue5 > 12 || intValue5 == 0) {
            qo0Var.f[1].setTextColor(qo0Var.getThemedColor(org.telegram.ui.ActionBar.h6.p7));
            if (!z10 && sb2.length() == 4) {
                qo0Var.f[qo0Var.i0 ? (char) 2 : (char) 3].requestFocus();
            }
            if (sb2.length() == 2) {
