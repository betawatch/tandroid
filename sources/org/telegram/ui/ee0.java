...
public final class ee0 extends org.telegram.ui.Components.vv0 {
    ...
    public ee0(og0 og0Var, Context context, int i10) {
        ...
        this.a = new org.telegram.ui.Components.cd0[i11];
        ...
        addView(textView, k7.c6.t(-2, -2, 1, 8, AndroidUtilities.isSmallScreen() ? 16 : 72, 8, 0));
        ...
        while (i12 < this.b.length) {
            ...
            this.a[i12] = cd0Var;
            cd0Var.setText(LocaleController.getString(i10 == 0 ? i12 == 0 ? R.string.PleaseEnterNewFirstPasswordHint : R.string.PleaseEnterNewSecondPasswordHint : R.string.PasswordHintPlaceholder));
            ...
            boolean z4 = i12 == 0 && i10 == 0;
            editTextBoldCursor.addTextChangedListener(new eg.y3(this, z4));
            this.b[i12].setOnFocusChangeListener(new qd(cd0Var, 3));
            if (z4) {
                LinearLayout linearLayout = new LinearLayout(context);
                linearLayout.setOrientation(0);
                linearLayout.setGravity(16);
                linearLayout.addView(this.b[i12], k7.c6.l(1.0f, 0, -2));
                ImageView imageView = new ImageView(context);
                this.f = imageView;
                imageView.setImageResource(R.drawable.msg_message);
                AndroidUtilities.updateViewVisibilityAnimated(imageView, true, 0.1f, false);
                final int i13 = 0;
                imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.be0
                    ...
                    public final void onClick(View view) {
                        switch (i13) {
                            case 0:
                                ee0 ee0Var = this.b;
                                ImageView imageView2 = ee0Var.f;
                                EditTextBoldCursor[] editTextBoldCursorArr = ee0Var.b;
                                ee0Var.y = !ee0Var.y;
                                for (int i14 = 0; i14 < editTextBoldCursorArr.length; i14++) {
                                    ...
                                    editTextBoldCursorArr[i14].setInputType((ee0Var.y ? 144 : 128) | 1);
                                    editTextBoldCursorArr[i14].setSelection(selectionStart, selectionEnd);
                                }
                                imageView2.setTag(Boolean.valueOf(ee0Var.y));
                                imageView2.setColorFilter(org.telegram.ui.ActionBar.k6.w0(null, ee0Var.y ? org.telegram.ui.ActionBar.k6.l6 : org.telegram.ui.ActionBar.k6.H6, false));
                                break;
                            default:
                                ee0 ee0Var2 = this.b;
                                if (ee0Var2.x == 0) {
                ...
                cd0Var.addView(this.b[i12], k7.c6.c(-2.0f, -1));
            }
            cd0Var.e(this.b[i12]);
            addView(cd0Var, k7.c6.t(-1, -2, 1, 16, 16, 16, 0));
            this.b[i12].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.ce0
                ...
                switch (i14) {
                    case 0:
                        ...
                        for (int i142 = 0; i142 < editTextBoldCursorArr.length; i142++) {
                            ...
                            editTextBoldCursorArr[i142].setInputType((ee0Var.y ? 144 : 128) | 1);
    ...
    public final void n() {
        ...
        for (EditTextBoldCursor editTextBoldCursor : this.b) {
            ...
            editTextBoldCursor.setCursorColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.l6, false));
        }
        for (org.telegram.ui.Components.cd0 cd0Var : this.a) {
            cd0Var.f();
        }
        this.e.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.q6, false));
        ImageView imageView = this.f;
        if (imageView != null) {
            imageView.setColorFilter(org.telegram.ui.ActionBar.k6.w0(null, this.y ? org.telegram.ui.ActionBar.k6.l6 : org.telegram.ui.ActionBar.k6.H6, false));
            imageView.setBackground(org.telegram.ui.ActionBar.k6.f0(this.B.getThemedColor(org.telegram.ui.ActionBar.k6.i6), 1, -1));
        }
    }
