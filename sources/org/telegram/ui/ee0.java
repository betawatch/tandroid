...
public final /* synthetic */ class ee0 implements RequestDelegate {
    ...
    public /* synthetic */ ee0(he0 he0Var, int i10) {
        this.a = i10;
        this.b = he0Var;
    }
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                he0Var2.getClass();
                                if (tL_error2 == null) {
                                    he0Var2.n = (TL_account.Password) tLObject2;
                                    he0Var2.h(null);
                                    break;
                                }
                                break;
                            case 1:
                                ng0 ng0Var = he0Var2.y;
                                ...
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        ...
                                        ng0Var.l1(LocaleController.getString(R.string.WrongCodeTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue < 60 ? LocaleController.formatPluralString("Seconds", intValue, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue / 60, new Object[0])));
                                        break;
                                    }
                                } else {
                                    ...
                                    if (ng0Var.getParentActivity() != null) {
                                        ...
                                        if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
                                            ...
                                            s01Var.c = i14;
                                            valueOf.setSpan(new org.telegram.ui.Components.t01(s01Var, 0), indexOf, i14, 0);
                                        }
                            ...
                            default:
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    ...
                                    ConnectionsManager.getInstance(i11).sendRequest(getpassword, new ee0(he0Var2, i13), 8);
                                    break;
                                    ...
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                            ...
                                            ng0Var2.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue2 < 60 ? LocaleController.formatPluralString("Seconds", intValue2, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue2 / 60, new Object[0])));
                                            break;
                                        }
                                    } else if (ng0Var2.getParentActivity() != null) {
                                        he0Var2.a.setText("");
                                        ng0.U0(ng0Var2, he0Var2.x, true);
                                        break;
                                    }
                                } else {
                                    ng0Var2.v1(false, true);
                                    he0Var2.postDelayed(new fe0(i13, he0Var2, tLObject2), 150L);
                                    break;
                                }
                                break;
                        }
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                he0Var22.getClass();
                                if (tL_error2 == null) {
                                    he0Var22.n = (TL_account.Password) tLObject2;
                                    he0Var22.h(null);
                                    break;
                                }
                                break;
                            case 1:
                                ng0 ng0Var = he0Var22.y;
                                ng0Var.k1(false, true);
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        ng0Var.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), tL_error2.text);
                                ...
                                break;
                            default:
                                ng0 ng0Var2 = he0Var22.y;
                                he0Var22.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i112 = ((org.telegram.ui.ActionBar.p2) ng0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i112).sendRequest(getpassword, new ee0(he0Var22, i13), 8);
                                    break;
                                } else if (!(tLObject2 instanceof TLRPC.TL_auth_authorization)) {
                                    ng0Var2.k1(false, true);
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        ...
                                        he0Var22.a.setText("");
                                        ng0.U0(ng0Var2, he0Var22.x, true);
                                        break;
                                    }
                                } else {
                                    ng0Var2.v1(false, true);
                                    he0Var22.postDelayed(new fe0(i13, he0Var22, tLObject2), 150L);
                                    break;
                                }
                                break;
                        }
