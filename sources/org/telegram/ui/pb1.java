...
public final class pb1 extends LinearLayout {
            ...
            case 10:
                ...
                if (motionEvent.getAction() == 0) {
                    ...
                    if (view2 != null) {
                        ...
                        if (i10 != indexOfChild) {
                            org.telegram.ui.Components.sm0 sm0Var = scrollSlidingTextTabStrip.b;
                    ...
                    if (view3 != null) {
                        final int i12 = 0;
                        view3.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.qm0
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i12) {
                                    case 0:
                                        pb1 pb1Var = this.b;
                                        pb1Var.invalidate();
                                        ((ScrollSlidingTextTabStrip) pb1Var.b).invalidate();
                                        break;
                                    default:
                                        pb1 pb1Var2 = this.b;
                                        pb1Var2.invalidate();
                                        ((ScrollSlidingTextTabStrip) pb1Var2.b).invalidate();
                                        break;
                                }
                            }
                    ...
                    if (view4 != null) {
                        final int i13 = 1;
                        view4.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.qm0
                            public final /* synthetic */ pb1 b;
        ...
        switch (this.a) {
            ...
            case 9:
                ...
                if (view instanceof org.telegram.ui.Components.fx0) {
                    ((org.telegram.ui.Components.fx0) view).a(om0Var.f0);
                }
                if (view == om0Var.s) {
                    return true;
                }
        ...
        switch (this.a) {
            case 7:
                ...
                for (int i15 = 0; i15 < getChildCount(); i15++) {
                    ...
                    if (childAt != ((org.telegram.ui.Components.uv) this.b).s.C && childAt != null) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            ...
            case 5:
                ...
                break;
            case 7:
                super.onMeasure(Math.max(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(((org.telegram.ui.Components.uv) this.b).b.getChildCount() * 32), TLObject.FLAG_30)), i11);
                break;
            case 12:
                super.onMeasure(i10, i11);
            ...
            case 16:
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) wg1Var.c.getLayoutParams();
                int i15 = 0;
                int dp = AndroidUtilities.dp(8.0f) + (wg1Var.a.getVisibility() == 8 ? AndroidUtilities.statusBarHeight : 0);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ pb1(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
