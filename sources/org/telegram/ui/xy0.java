...
public final class xy0 extends org.telegram.ui.Components.q6 {
    ...
    public final void b(Object obj, float f9) {
        ...
        int offsetColor = AndroidUtilities.getOffsetColor(v03, v04, f9, 1.0f);
        ...
        if (profileActivity.H != null) {
            profileActivity.H.b(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.h8, profileActivity.v0), v04, f9, 1.0f));
        }
        ...
        lVar.C(AndroidUtilities.getOffsetColor(v05, v06, f9, 1.0f), false);
        ...
        lVar2.B(AndroidUtilities.getOffsetColor(v07, v08, f9, 1.0f), false);
        profileActivity.Z0.invalidate();
        ...
        if (drawableArr3[0] != null) {
            drawableArr3[0].setColorFilter(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.zh, profileActivity.v0), org.telegram.ui.ActionBar.g6.v0(i10, profileActivity.v0), f9, 1.0f), PorterDuff.Mode.MULTIPLY);
        }
        if (drawableArr3[1] != null) {
            MessagesController.PeerColor peerColor2 = profileActivity.M5;
            if (peerColor2 != null) {
                v02 = org.telegram.ui.ActionBar.g6.b(0.1f, org.telegram.ui.ActionBar.g6.I.q() ? -0.1f : -0.08f, i0.a.d(0.4f, peerColor2.getColor2(), profileActivity.M5.hasColor6(org.telegram.ui.ActionBar.g6.I.q()) ? profileActivity.M5.getColor5() : profileActivity.M5.getColor3()));
            } else {
                v02 = org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.zh, profileActivity.v0);
            }
            drawableArr3[1].setColorFilter(AndroidUtilities.getOffsetColor(v02, org.telegram.ui.ActionBar.g6.v0(i10, profileActivity.v0), f9, 1.0f), PorterDuff.Mode.MULTIPLY);
        }
        if (drawableArr2[0] != null) {
            drawableArr2[0].setColorFilter(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Ah, profileActivity.v0), org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.d6, profileActivity.v0), f9, 1.0f), PorterDuff.Mode.MULTIPLY);
        }
        if (drawableArr2[1] != null) {
            drawableArr2[1].setColorFilter(AndroidUtilities.getOffsetColor(profileActivity.M5 == null ? org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.Ah, profileActivity.v0) : -1, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.d6, profileActivity.v0), f9, 1.0f), PorterDuff.Mode.MULTIPLY);
        }
        if (drawableArr[0] != null) {
            drawableArr[0].setColorFilter(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.zh, profileActivity.v0), org.telegram.ui.ActionBar.g6.v0(i10, profileActivity.v0), f9, 1.0f), PorterDuff.Mode.MULTIPLY);
        }
        if (drawableArr[1] != null) {
            drawableArr[1].setColorFilter(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.zh, profileActivity.v0), org.telegram.ui.ActionBar.g6.v0(i10, profileActivity.v0), f9, 1.0f), PorterDuff.Mode.MULTIPLY);
        }
        profileActivity.X4();
