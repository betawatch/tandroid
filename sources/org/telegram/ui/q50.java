...
public final class q50 {
    ...
    public final s50[] c = new s50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.e6 i = new org.telegram.ui.Components.e6(new d10(this, 7), 320, org.telegram.ui.Components.rr.h, 0);
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        s50[] s50VarArr = this.c;
        boolean b10 = s50VarArr[0].b(canvas, rectF3, f10);
        ...
        AndroidUtilities.lerpCentered(rectF2, rectF3, f10, rectF3);
        if (s50VarArr[1].b(canvas, rectF3, f10)) {
            z10 = true;
        }
        org.telegram.ui.Components.f01 f01Var2 = this.d;
        f01Var2.c(f14 - (f01Var2.l() / 2.0f), dp / 2.0f, AndroidUtilities.lerp(1.0f, 0.75f, e) * (1.0f - f10), -1, canvas);
        ...
        AndroidUtilities.lerpCentered(rectF2, rectF3, f10, rectF3);
        if (s50VarArr[2].b(canvas, rectF3, f10)) {
            z10 = true;
        }
        ...
        AndroidUtilities.lerpCentered(rectF2, rectF3, f10, rectF3);
        boolean z11 = s50VarArr[3].b(canvas, rectF3, f10) ? true : z10;
        if (f10 > 0.0f) {
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            s50 s50Var = this.c[i10];
            String str = strArr == null ? null : strArr[i10];
            r50 r50Var = s50Var.k;
            boolean z10 = s50Var.f;
            s50Var.f = str != null;
            if (str != null && (s50Var.d == null || !TextUtils.equals(s50Var.l, str))) {
                org.telegram.ui.Components.q5 q5Var = s50Var.d;
                if (q5Var != null) {
                    q5Var.p(r50Var);
                }
                s50Var.c = Emoji.getEmojiDrawable(str);
