...
public final class zx0 extends org.telegram.ui.Components.xl0 {
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i24 == 0) {
            ...
            faVar.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.j6.G6));
            ...
            if (i10 != privacyControlActivity.T) {
                if (i10 == privacyControlActivity.b0) {
                    ...
                    if (i10 == privacyControlActivity.e0) {
                        ...
                        faVar.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.j6.n6));
                        return;
                    }
                    return;
                }
        ...
        if (i24 == 1) {
            ...
            if (i10 == privacyControlActivity.Q) {
                ...
                if (i10 == i34 && i23 == 10) {
                    ...
                    f9Var.setText(AndroidUtilities.replaceSingleTag(string, new Runnable(this) { // from class: org.telegram.ui.wx0
                    ...
                    if (i10 == i12) {
                        f9Var.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.PrivacyBirthdaySet), new Runnable(this) { // from class: org.telegram.ui.wx0
                            public final /* synthetic */ zx0 b;
                        ...
                        if (i23 == 6) {
                            if (privacyControlActivity.I == 1 && privacyControlActivity.J == 1) {
                                ...
                                String g10 = v7.j0.g("https://t.me/+", privacyControlActivity.getUserConfig().getClientPhone());
                                SpannableString spannableString = new SpannableString(g10);
                                spannableString.setSpan(new yx0(this, g10), 0, g10.length(), 33);
                        ...
                        if (i23 == 6) {
                            ...
                            int i36 = privacyControlActivity.I;
                            if (i36 == 2) {
        ...
        if (i24 == 2) {
            ...
            if (i10 != privacyControlActivity.N) {
                if (i10 == privacyControlActivity.R) {
                    if (i23 == 10) {
                        n4Var.setText(LocaleController.getString(R.string.PrivateMessagesExceptionsHeader));
                        return;
                    } else {
                        n4Var.setText(LocaleController.getString(R.string.AddExceptions));
                        return;
                    }
                }
                if (i10 == privacyControlActivity.a0) {
                    n4Var.setText(LocaleController.getString(R.string.PrivacyP2PHeader));
                    return;
                }
                if (i10 == privacyControlActivity.V) {
                    n4Var.setText(LocaleController.getString(R.string.PrivacyPhoneTitle2));
                    return;
                }
                if (i10 == privacyControlActivity.h0) {
                    n4Var.setText(LocaleController.getString(R.string.PrivateMessagesPriceHeader));
                    return;
                }
                i13 = privacyControlActivity.giftTypesHeaderRow;
                if (i10 == i13) {
                    n4Var.setText(LocaleController.getString(R.string.PrivacyGiftsTypeHeader));
                    return;
                }
                return;
            }
            if (i23 == 6) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyPhoneTitle));
                return;
            }
            if (i23 == 5) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyForwardsTitle));
                return;
            }
            if (i23 == 4) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyProfilePhotoTitle));
                return;
            }
            if (i23 == 9) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyBioTitle));
                return;
            }
            if (i23 == 14) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyMusicTitle));
                return;
            }
            if (i23 == 3) {
                n4Var.setText(LocaleController.getString(R.string.P2PEnabledWith));
                return;
            }
            if (i23 == 2) {
                n4Var.setText(LocaleController.getString(R.string.WhoCanCallMe));
                return;
            }
            if (i23 == 1) {
                n4Var.setText(LocaleController.getString(R.string.WhoCanAddMe));
                return;
            }
            if (i23 == 8) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyVoiceMessagesTitle));
                return;
            }
            if (i23 == 10) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyMessagesTitle));
                return;
            }
            if (i23 == 11) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyBirthdayTitle));
                return;
            } else if (i23 == 12) {
                n4Var.setText(LocaleController.getString(R.string.PrivacyGiftsTitle));
                return;
            } else {
                n4Var.setText(LocaleController.getString(R.string.LastSeenTitle));
                return;
            }
        }
        if (i24 != 3) {
            if (i24 != 8) {
                ...
                if (i10 == i22) {
                    ...
                    ol0 ol0Var = new ol0(this, i25);
                    org.telegram.ui.Cells.z7 z7Var = new org.telegram.ui.Cells.z7();
                    z7Var.c = a2;
                    z7Var.d = 20;
                    z7Var.e = ol0Var;
                    a8Var.d((int) Utilities.clamp(privacyControlActivity.L, privacyControlActivity.getMessagesController().starsPaidMessageAmountMax, 1L), z7Var, new xx0(this, r8 ? 1 : 0));
                    return;
                }
                return;
            }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 6:
                ...
                break;
            case 7:
                privacyControlActivity.v0 = new org.telegram.ui.Components.v9(privacyControlActivity.getParentActivity());
                ...
                if (photoSize != null) {
                    ...
                    if (photo != null) {
                        org.telegram.ui.Components.v9 v9Var = privacyControlActivity.v0;
                        ...
                        v9Var.h(forPhoto, "50_50", null, UserConfig.getInstance(i12).getCurrentUser());
                    } else {
                        org.telegram.ui.Components.v9 v9Var2 = privacyControlActivity.v0;
                        ImageLocation forLocal = ImageLocation.getForLocal(photoSize.location);
                        i11 = ((org.telegram.ui.ActionBar.n2) privacyControlActivity).currentAccount;
                        v9Var2.h(forLocal, "50_50", null, UserConfig.getInstance(i11).getCurrentUser());
                    }
                }
                privacyControlActivity.w0.addView(privacyControlActivity.v0, w7.y5.d(30, 30.0f, 16, 21.0f, 0.0f, 21.0f, 0.0f));
            ...
            case 10:
                ...
                dVar.setOnClickListener(new k60(this, 24));
