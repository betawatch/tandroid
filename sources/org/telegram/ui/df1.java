...
public final class df1 extends org.telegram.ui.Components.pv0 {
    ...
    public final void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            ...
            if (wf1Var.g1 != null) {
                ...
                wf1Var.g1.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (wf1Var.isInPreviewMode()) {
            int themedColor = wf1Var.getThemedColor(org.telegram.ui.ActionBar.h6.d6);
            Paint paint = this.x0;
            paint.setColor(themedColor);
            paint.setAlpha((int) (wf1Var.W * 255.0f));
            canvas2 = canvas;
            canvas2.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.statusBarHeight, paint);
            canvas2.drawLine(0.0f, 0.0f, 0.0f, getHeight(), org.telegram.ui.ActionBar.h6.k0);
        } else {
            canvas2 = canvas;
        }
        if (wf1Var.M0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, wf1Var.getThemedColor(org.telegram.ui.ActionBar.h6.d6), wf1Var.e1);
        }
    }
        ...
        if (view == kVar && !wf1Var.isInPreviewMode()) {
            ...
            if (f7 > 0.0f) {
                if (f7 < 1.0f) {
                    ...
                    org.telegram.ui.ActionBar.h6.k0.setAlpha((int) (alpha * wf1Var.W));
                    float f10 = measuredHeight;
                    canvas.drawLine(0.0f, f10, getMeasuredWidth(), f10, org.telegram.ui.ActionBar.h6.k0);
                    org.telegram.ui.ActionBar.h6.k0.setAlpha(alpha);
                } else {
                    float f11 = measuredHeight;
                    canvas.drawLine(0.0f, f11, getMeasuredWidth(), f11, org.telegram.ui.ActionBar.h6.k0);
                }
            }
        }
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (l51Var != null) {
            ...
            wf1Var.o0.setPadding(0, 0, 0, i13);
            this.w0 = false;
        }
        int i14 = 0;
