...
public class UserInfoActivity extends org.telegram.ui.Components.m61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void U(ArrayList arrayList, org.telegram.ui.Components.j61 j61Var) {
        ...
        if (!getContactsController().getLoadingPrivacyInfo(11) && (privacyRules = getContactsController().getPrivacyRules(11)) != null && this.r == null) {
            ...
            this.r = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(string, new ph1(this, i11)), true);
        }
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (UserConfig.hasPremiumOnAccounts()) {
                ...
                arrayList.add(org.telegram.ui.Components.v51.B(TextUtils.concat(max > 0 ? LocaleController.formatPluralStringComma("AddAccountInfo1", max) + " " : "", AndroidUtilities.replaceSingleTag(LocaleController.formatPluralStringComma("AddAccountInfo2", UserConfig.getMaxAccountCount()), new ph1(this, 3)))));
            }
        }
    ...
    public final void W(org.telegram.ui.Components.v51 v51Var, View view) {
        ...
        if (i13 == 1 || i13 == 9) {
            ...
            TL_account.TL_birthday tL_birthday = this.J;
            showDialog(org.telegram.ui.Components.d5.m(parentActivity, string, string2, tL_birthday, new rh1(this, 0), null, false, tL_birthday != null, getResourceProvider()).a);
            return;
        }
        if (i13 == 2) {
            this.J = null;
        ...
        if (i13 == 3) {
            ...
            vh1Var.e = j3;
            vh1Var.f = rh1Var;
            uh1 uh1Var = new uh1(vh1Var, 1);
            if (th1Var.c) {
                uh1Var.run();
            } else {
                th1Var.f.add(uh1Var);
            }
            presentFragment(vh1Var);
            return;
        }
        if (i13 == 5) {
    ...
    */
    ...
    public final void c0(boolean z10) {
        if (this.v.c <= 0.0f) {
            if (z10 && TextUtils.isEmpty(this.d.getText())) {
                ...
                int i10 = -this.Q;
                this.Q = i10;
                AndroidUtilities.shakeViewSpring(sh1Var, i10);
                return;
            }
            this.v.a(1.0f);
            TLRPC.User currentUser = getUserConfig().getCurrentUser();
    ...
    public final View createView(Context context) {
        ...
        org.telegram.ui.Cells.g3 g3Var = sh1Var2.b;
        ...
        org.telegram.ui.Cells.g3 g3Var2 = sh1Var3.b;
        ...
        e0();
        this.n = AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.EditProfileBioInfo2), new ph1(this, 0));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.updatedChatbot) {
            TL_account.connectedBots connectedbots = gg.f.a(this.currentAccount).c;
    ...
    public final void e0() {
        ...
        if (sh1Var == null || TextUtils.isEmpty(sh1Var.getText())) {
            ...
            if (privacyRules == null) {
                ...
                if (i12 == 0) {
                    if (i13 <= 0) {
                        this.n = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.EditProfileBioInfoEveryone), new ph1(this, i11)), true);
                    } else {
                        this.n = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.EditProfileBioInfoEveryoneExcept, Integer.valueOf(i13)), new ph1(this, i11)), true);
                    }
                } else if (i12 == 2) {
                    if (i13 > 0 || i14 > 0) {
                        String j3 = i14 > 0 ? hc.b.j(i14, "+") : "";
                        if (i13 > 0) {
                            if (j3.length() > 0) {
                                j3 = j3.concat(", ");
                            }
                        ...
                        this.n = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.EditProfileBioInfoContactsExtra, j3), new ph1(this, i11)), true);
                    } else {
                        this.n = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.EditProfileBioInfoContacts), new ph1(this, i11)), true);
                    }
                } else if (i12 != 0) {
                    this.n = AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.EditProfileBioInfoUnknown), new ph1(this, i11));
                } else if (i14 <= 0) {
                    this.n = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.EditProfileBioInfoNobody), new ph1(this, i11)), true);
                } else {
                    this.n = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.EditProfileBioInfoNobodyExcept, Integer.valueOf(i14)), new ph1(this, i11)), true);
                }
    ...
    public final void onResume() {
        ...
        th1 th1Var = this.N;
        th1Var.c = false;
        th1Var.f.add(new ph1(this, 1));
        if (!th1Var.c && !th1Var.d) {
            th1Var.d = true;
            TLRPC.TL_channels_getAdminedPublicChannels tL_channels_getAdminedPublicChannels = new TLRPC.TL_channels_getAdminedPublicChannels();
            tL_channels_getAdminedPublicChannels.for_personal = th1Var.b;
            ConnectionsManager.getInstance(th1Var.a).sendRequest(tL_channels_getAdminedPublicChannels, new m(th1Var, 23));
        }
        this.r = null;
        org.telegram.ui.Components.l61 l61Var = this.x;
        if (l61Var != null) {
