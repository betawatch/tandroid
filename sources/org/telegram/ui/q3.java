...
public final class q3 extends FrameLayout {
    ...
    public int w;
    public int x;
    public org.telegram.ui.web.d2 y;
    ...
    public float getProgress() {
        ...
        if (c()) {
            ...
            if (j0Var.m(L0) != null) {
                ...
                if (iArr != null) {
                    int i10 = L0 - 1;
                    return Utilities.clamp01((((i10 < 0 || i10 >= iArr.length) ? 0 : iArr[i10]) + ((L0 != 0 || z3Var == null) ? -r4.getTop() : 0)) / Math.max(1, r5.F - vVar.getHeight()));
                }
                int N0 = j0Var.N0();
                if (z3Var != null) {
                    if (L0 < 1) {
                ...
                int B = j0Var.B() - 2;
                View m10 = N0 >= B ? j0Var.m(B) : j0Var.m(L0);
                if (m10 != null) {
            ...
            try {
                if (!e()) {
                    try {
                        ...
                        if (split.length > 2 && (o0Var = this.G.d0) != null && nh.t3.g(a2, o0Var.A) > AndroidUtilities.displaySize.x - AndroidUtilities.dp(162.0f)) {
    ...
    public void setTranslationX(float f9) {
        ...
        if (m4Var.b0.e) {
            m4Var.c0.invalidate();
            m4Var.X((int) (((AndroidUtilities.dp(56.0f) - m4Var.b0.h) * (f9 / getMeasuredWidth())) + m4Var.b0.h));
        }
        z3 z3Var = m4Var.G;
        if (z3Var != null) {
            z3Var.n();
    ...
    public void setWeb(d3 d3Var) {
        ...
        if (d3Var2 != d3Var) {
            ...
            org.telegram.ui.web.d2 d2Var = this.y;
            if (d2Var != null) {
                d2Var.a();
                org.telegram.ui.web.d2 d2Var2 = this.y;
