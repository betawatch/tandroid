...
public final class n70 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40 {
    ...
    public static /* synthetic */ void U(n70 n70Var, ArrayList arrayList, ArrayList arrayList2, CountDownLatch countDownLatch) {
    ...
    public final void Z(boolean z10, boolean z11) {
        ...
        this.h.addListener(new j70(i10, this, z10));
        this.h.start();
    }
    ...
    */
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new to(this, 27));
        ...
        jdVar.addView(dc1Var, w7.x5.c(-1.0f, -1));
        ...
        this.d.setImageDrawable(f9Var);
        this.d.setContentDescription(LocaleController.getString(R.string.ChoosePhoto));
        FrameLayout frameLayout2 = this.s;
        ai.z5 z5Var2 = this.d;
        boolean z10 = LocaleController.isRTL;
        frameLayout2.addView(z5Var2, w7.x5.d(64, 64.0f, (z10 ? 5 : 3) | 48, z10 ? 0.0f : 16.0f, 16.0f, z10 ? 16.0f : 0.0f, 16.0f));
        Paint paint = new Paint(1);
        paint.setColor(1426063360);
        ci.s6 s6Var = new ci.s6(this, context, paint, 10);
        this.e = s6Var;
        FrameLayout frameLayout3 = this.s;
        boolean z11 = LocaleController.isRTL;
        frameLayout3.addView(s6Var, w7.x5.d(64, 64.0f, (z11 ? 5 : 3) | 48, z11 ? 0.0f : 16.0f, 16.0f, z11 ? 16.0f : 0.0f, 16.0f));
        this.e.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.h70
            ...
            public final void onClick(View view) {
                switch (i12) {
                    case 0:
                        n70 n70Var = this.b;
                        n70Var.N.o(n70Var.y != null, new i10(n70Var, 8), new r5(n70Var, 7), 0);
                        n70Var.R.M(0);
                        n70Var.R.P(43);
                        n70Var.f.d();
                        break;
                    default:
                        n70 n70Var2 = this.b;
                        if (!n70Var2.M) {
                            if (n70Var2.c.a.length() != 0) {
                                n70Var2.M = true;
                                AndroidUtilities.hideKeyboard(n70Var2.c);
                                n70Var2.c.setEnabled(false);
                                if (!n70Var2.N.h()) {
                                    org.telegram.ui.Components.y10 y10Var = n70Var2.v;
                                    if (y10Var != null) {
                                        y10Var.f(true, true);
                                    }
                                    n70Var2.V = n70Var2.getMessagesController().createChat(n70Var2.c.getText().toString(), n70Var2.K, null, n70Var2.P, n70Var2.S, n70Var2.U, n70Var2.T, n70Var2.W, n70Var2);
                                    break;
                                } else {
                                    n70Var2.L = true;
                                    break;
                                ...
                                Vibrator vibrator = (Vibrator) n70Var2.getParentActivity().getSystemService("vibrator");
                                if (vibrator != null) {
                                    vibrator.vibrate(200L);
                                }
                                AndroidUtilities.shakeView(n70Var2.c);
                                break;
                            }
                        }
                        break;
        ...
        frameLayout4.addView(kdVar2, w7.x5.d(64, 64.0f, (z12 ? 5 : 3) | 48, z12 ? 0.0f : 15.0f, 16.0f, z12 ? 15.0f : 0.0f, 16.0f));
        ...
        frameLayout5.addView(ldVar2, w7.x5.d(64, 64.0f, (z13 ? 5 : 3) | 48, z13 ? 0.0f : 16.0f, 16.0f, z13 ? 16.0f : 0.0f, 16.0f));
        Z(false, false);
        org.telegram.ui.Components.ju juVar2 = new org.telegram.ui.Components.ju(context, jdVar, this, 0, false, null);
        this.c = juVar2;
        juVar2.setHint(LocaleController.getString((i13 == 0 || i13 == 4 || i13 == 5) ? R.string.EnterGroupNamePlaceholder : R.string.EnterListName));
        String str = this.O;
        if (str != null) {
            this.c.setText(str);
            org.telegram.ui.Components.ju juVar3 = this.c;
            juVar3.setSelection(juVar3.getText().length());
            this.O = null;
        }
        ...
        if (size >= 2 && size <= 5 && TextUtils.isEmpty(this.c.getText())) {
            ...
            if (size == 2) {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    ...
                    juVar4.w(0, juVar4.getText().length());
                }
            } else {
        ...
        frameLayout6.addView(juVar5, w7.x5.d(-1, -2.0f, 16, z14 ? 5.0f : 96.0f, 0.0f, z14 ? 96.0f : 5.0f, 0.0f));
        ...
        this.a = l70Var;
        ml0Var2.setAdapter(l70Var);
        this.b.setLayoutManager(this.X);
        this.b.setVerticalScrollBarEnabled(false);
        this.b.setVerticalScrollbarPosition(LocaleController.isRTL ? 1 : 2);
        dc1Var.addView(this.b, w7.x5.n(-1, -1));
        this.b.setOnScrollListener(new h3(this, 14));
        this.b.setOnItemClickListener(new i70(this));
        org.telegram.ui.Components.y10 y10Var = new org.telegram.ui.Components.y10(context, this.resourceProvider, false);
        this.v = y10Var;
        n7.a1.j(y10Var);
        jdVar.addView(this.v, org.telegram.ui.Components.y10.b());
        this.v.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.h70
            public final /* synthetic */ n70 b;
                    ...
                    default:
                        ...
                        if (!n70Var2.M) {
                            if (n70Var2.c.a.length() != 0) {
                                ...
                                n70Var2.c.setEnabled(false);
                                if (!n70Var2.N.h()) {
                                    org.telegram.ui.Components.y10 y10Var2 = n70Var2.v;
                                    if (y10Var2 != null) {
                                        y10Var2.f(true, true);
                                    }
                                    n70Var2.V = n70Var2.getMessagesController().createChat(n70Var2.c.getText().toString(), n70Var2.K, null, n70Var2.P, n70Var2.S, n70Var2.U, n70Var2.T, n70Var2.W, n70Var2);
