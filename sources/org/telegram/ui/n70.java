...
public final class n70 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(n70 n70Var, View view, int i10) {
        ...
        if (!n70Var.J) {
            ...
            if (i10 == n70Var.G) {
                n70Var.d0(n70Var.r, true, false);
                return;
            }
            return;
        }
        if (i10 > n70Var.f.d.size()) {
            boolean a2 = ((org.telegram.ui.Cells.k8) view).a();
            m70 m70Var = n70Var.f;
            n70Var.d0((TLRPC.TL_messages_stickerSet) m70Var.e.get((i10 - m70Var.d.size()) - 1), a2, false);
        } else if (i10 != n70Var.f.d.size()) {
            n70Var.d0((TLRPC.TL_messages_stickerSet) n70Var.f.d.get(i10), ((org.telegram.ui.Cells.k8) view).a(), true);
        }
    }
    ...
    public static void V(n70 n70Var, TLRPC.TL_error tL_error) {
        ...
        TLRPC.TL_messages_stickerSet tL_messages_stickerSet = n70Var.r;
        if (tL_messages_stickerSet != null) {
            ...
            MediaDataController.getInstance(n70Var.currentAccount).putGroupStickerSet(n70Var.r);
        } else if (z4) {
        ...
        NotificationCenter.getInstance(n70Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupPackUpdated, Long.valueOf(n70Var.v.id), Boolean.valueOf(z4));
    ...
    public static void a0(n70 n70Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (tL_messages_stickerSet == null) {
            ...
            n70Var.r = tL_messages_stickerSet;
            n70Var.s = false;
            l.d.v(R.string.GroupsEmojiPackUpdated, org.telegram.ui.Components.qc.a0(n70Var), R.raw.done, 36);
        }
        n70Var.h0();
        n70Var.f0(n70Var.r, false);
        if (i10 != -1) {
            if (!n70Var.J) {
    ...
    public final View createView(Context context) {
        ...
        this.e = new l70(this, context);
        this.f = new m70(this, context);
        ...
        this.a = frameLayout2;
        frameLayout2.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.d6, false));
        ...
        this.a.addView(this.c, k7.c6.c(-1.0f, -1));
        org.telegram.ui.Components.ax0 ax0Var = new org.telegram.ui.Components.ax0(context, this.c, 1, null);
        this.b = ax0Var;
        n7.qa.M0(ax0Var);
    ...
    public final void d0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z4, boolean z10) {
        ...
        org.telegram.ui.Components.yx0 yx0Var = new org.telegram.ui.Components.yx0(getParentActivity(), this, tL_inputStickerSetShortName, !z10 ? tL_messages_stickerSet : null, null, null);
        yx0Var.a0 = new i70(this, z4, tL_messages_stickerSet);
        yx0Var.B0();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 16, new Class[]{org.telegram.ui.Cells.k8.class, org.telegram.ui.Cells.aa.class}, null, null, null, org.telegram.ui.ActionBar.k6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.d, 0, new Class[]{org.telegram.ui.Cells.k8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.z6));
