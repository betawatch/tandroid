...
public final class go extends Drawable {
    ...
    public static go d(Drawable drawable, TLRPC.WallPaper wallPaper, boolean z10) {
        ...
        if (drawable instanceof go) {
            ...
            boolean z11 = goVar.a;
            TLRPC.WallPaper wallPaper2 = goVar.g;
            String str = wallPaper.uploadingImage;
    ...
    public final Drawable c(boolean z10) {
        ...
        bi.y3 y3Var = this.e;
        return (!z10 || y3Var.getStaticThumb() == null) ? y3Var.getThumb() != null ? y3Var.getThumb() : y3Var.getDrawable() != null ? y3Var.getDrawable() : y3Var.getStaticThumb() : y3Var.getStaticThumb();
    }
