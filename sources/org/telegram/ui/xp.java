...
public final class xp extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void V(int i10, boolean z4) {
        ...
        if (i10 == 1) {
            ...
            wp wpVar2 = this.h;
            if (wpVar2 != null && z4) {
                wpVar2.s(this.D ? 1 : 2, arrayList2.size() + 1);
            }
        } else if (!this.d.isEmpty()) {
            this.d.clear();
            wp wpVar3 = this.h;
            if (wpVar3 != null && z4) {
                wpVar3.t(this.D ? 1 : 2, arrayList2.size() + 1);
            }
        }
    ...
    public final View createView(Context context) {
        ...
        if (this.D) {
            ...
            s8Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, s8Var2.e.h ? org.telegram.ui.ActionBar.j6.f6 : org.telegram.ui.ActionBar.j6.e6, false));
            this.n.setTypeface(AndroidUtilities.bold());
            final int i10 = 0;
            this.n.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.up
        ...
        this.s.addView(m4Var, k7.b6.n(-1, -2));
        ...
        final int i11 = 1;
        this.x.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.up
            public final /* synthetic */ xp b;
        ...
        final int i12 = 2;
        this.y.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.up
            public final /* synthetic */ xp b;
        ...
        final int i13 = 3;
        this.B.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.up
            public final /* synthetic */ xp b;
