...
public final /* synthetic */ class vb implements RequestDelegate {
    ...
    public /* synthetic */ vb(yb ybVar, CountDownLatch countDownLatch, Runnable runnable, int i10) {
        this.a = i10;
        this.b = ybVar;
                        ...
                        switch (i10) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    boolean z10 = false;
                                    MessagesController.getInstance(ybVar2.b).putUsers(tL_premium_boostsList.users, false);
                                    ...
                                    while (true) {
                                        int i13 = 1;
                                        if (i12 >= size) {
                                            ybVar2.s = Math.max(0, tL_premium_boostsList.count - i11);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList.next_offset) && ybVar2.s > 0) {
                                                z10 = true;
                                            }
                                            ybVar2.r = z10;
                            ...
                            default:
                                ...
                                if (tLObject3 != null) {
                                    ...
                                    boolean z11 = false;
                                    MessagesController.getInstance(ybVar3.b).putUsers(tL_premium_boostsList2.users, false);
                                    ...
                                    while (true) {
                                        int i17 = 1;
                                        if (i16 >= size2) {
                                            ybVar3.w = Math.max(0, tL_premium_boostsList2.count - i15);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList2.next_offset) && ybVar3.w > 0) {
                                                z11 = true;
                                            }
                                            ybVar3.v = z11;
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                if (tLObject2 != null) {
                                    ...
                                    TL_stories.TL_premium_boostsList tL_premium_boostsList = (TL_stories.TL_premium_boostsList) tLObject2;
                                    boolean z10 = false;
                                    MessagesController.getInstance(ybVar22.b).putUsers(tL_premium_boostsList.users, false);
                                    ybVar22.G = tL_premium_boostsList.next_offset;
                                    arrayList.addAll(tL_premium_boostsList.boosts);
                                    int size = arrayList.size();
                                    int i112 = 0;
                                    int i12 = 0;
                                    while (true) {
                                        int i13 = 1;
                                        if (i12 >= size) {
                                            ybVar22.s = Math.max(0, tL_premium_boostsList.count - i112);
                                            if (!TextUtils.isEmpty(tL_premium_boostsList.next_offset) && ybVar22.s > 0) {
                                                z10 = true;
                                            }
                                            ybVar22.r = z10;
                                            ybVar22.L = tL_premium_boostsList.count;
