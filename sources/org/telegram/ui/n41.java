...
public final class n41 extends org.telegram.ui.Cells.t1 {
    public boolean Ce;
    ...
    public final /* synthetic */ p41 Pe;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n41(p41 p41Var, Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var, int i11, int i12) {
    ...
    public final void E1(Canvas canvas) {
        ...
        if (paint != null) {
            ...
            if (f10 > 0.0f) {
                if (p41Var.N) {
                    if (this.le) {
                        Bitmap bitmap = p41Var.M.getBitmap();
                        if (bitmap != null) {
                            canvas.save();
                            Path path = this.Ie;
                            path.rewind();
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Me.e(p41Var.N), 1.0f - p41Var.s));
            ...
            this.He.reset();
            float width2 = (rectF.width() / 76.8f) * p41Var.v;
        ...
        canvas.saveLayerAlpha(p41Var.O, (int) (p41Var.v * 178.0f), 31);
        ...
        canvas.drawArc(rectF2, -90.0f, (1.0f - p41Var.X) * (-360.0f), false, paint3);
        if (this.Le == null) {
        ...
        this.Le.a((1.0f - p41Var.X) * (-360.0f), 1.0f, canvas, paint3, rectF2);
        canvas.restore();
    }
    ...
    public final void d2(Canvas canvas, float f10, Integer num) {
        ...
        int i10 = -this.K.c;
        p41 p41Var = this.Pe;
        canvas.translate(AndroidUtilities.lerp(0, i10, p41Var.s), AndroidUtilities.lerp(p41Var.L.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), r0.p, p41Var.s));
        super.d2(canvas, (1.0f - p41Var.s) * f10, num);
        canvas.restore();
    }
    ...
    public final void m2(float f10, Canvas canvas, boolean z4) {
        ...
        if (p41Var.P) {
            int i10 = this.mb;
            MessageObject messageObject = p41Var.J;
            int i11 = 0;
            if (messageObject != null && messageObject.isOutOwner()) {
                MessageObject messageObject2 = p41Var.J;
                if (messageObject2 != null && messageObject2.type == 19) {
                    i11 = 4;
                }
                i11 += 20;
            }
            canvas.translate(((this.Ee.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.ob) * p41Var.s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z4) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, p41Var.s, rectF);
            U3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (p41Var.s <= 0.0f || !p41Var.N) {
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            }
            this.se = 1.0f - p41Var.s;
        } else {
            canvas2 = canvas;
        }
        S1(canvas2);
        if (p41Var.P && p41Var.s > 0.0f && p41Var.N) {
            canvas2.restore();
        }
    }
