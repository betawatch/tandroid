...
public final class ik0 extends og.b {
    ...
    public final int j(int i10) {
        ...
        return ((hk0) notificationsCustomSettingsActivity.I.get(i10)).a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i11 = i10 + 1;
        boolean z10 = i11 < arrayList.size() && ((hk0) arrayList.get(i11)).a != 4;
        int i12 = c1Var.f;
        View view = c1Var.a;
        switch (i12) {
            case 0:
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i10 == 3 || ((arrayList2 = notificationsCustomSettingsActivity.w) != null && arrayList2.isEmpty())) {
            ...
            int b10 = c1Var.b();
            View view = c1Var.a;
            hk0 hk0Var = (b10 < 0 || b10 >= arrayList3.size()) ? null : (hk0) arrayList3.get(b10);
            if (hk0Var == null || hk0Var.c != 102) {
                int i11 = c1Var.f;
                if (i11 == 0) {
