    ...
    public final boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (this.a) {
            case 0:
                n4 n4Var = (n4) this.b;
                n4Var.getClass();
                if (motionEvent.getActionMasked() == 0 && (p1Var = n4Var.E) != null && p1Var.isShowing()) {
                    view.getHitRect(n4Var.z0);
                    if (!n4Var.z0.contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
                        n4Var.E.d(true);
                        break;
                    }
                }
            ...
            case 6:
                ...
                x61Var.getClass();
                if (motionEvent.getAction() == 0 && (runnable = x61Var.Q1) != null) {
                    runnable.run();
                    break;
                }
                break;
            default:
                ...
                if (yd1Var.P != null && motionEvent.getAction() == 0) {
                    Drawable backgroundDrawable2 = ((ActionBarPopupWindow$ActionBarPopupWindowLayout) yd1Var.P).getBackgroundDrawable();
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    rectF2.set(backgroundDrawable2.getBounds());
                    rectF2.offset(yd1Var.P.getX(), yd1Var.P.getY());
