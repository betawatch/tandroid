...
public final class h60 extends FrameLayout {
    ...
    public final void a(double d, boolean z10) {
        ...
        if (z10) {
            ...
            if (groupCallParticipant.volume == 0) {
                ...
                k60Var.d1(true);
                k60Var.x1(groupCallParticipant, peerId, k60Var.Q0() ? 0 : 5);
            } else {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        fArr[1] = dp2;
        fArr[0] = dp2;
        float dp3 = AndroidUtilities.dp(6.0f) * (h60Var.n < AndroidUtilities.dp(12.0f) ? Math.max(0.0f, (h60Var.n - AndroidUtilities.dp(6.0f)) / AndroidUtilities.dp(6.0f)) : 1.0f);
        fArr[5] = dp3;
        fArr[4] = dp3;
        fArr[3] = dp3;
        fArr[2] = dp3;
        float f12 = h60Var.n;
        float measuredHeight = h60Var.getMeasuredHeight();
        RectF rectF = h60Var.y;
        rectF.set(0.0f, 0.0f, f12, measuredHeight);
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        path.close();
        Canvas canvas2 = canvas;
        canvas2.drawPath(path, paint);
        int participantVolume = (int) (ChatObject.getParticipantVolume(h60Var.c) / 100.0d);
        org.telegram.ui.Components.bj0 bj0Var = h60Var.a;
