...
public final /* synthetic */ class w10 implements Runnable {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                    if (((org.telegram.ui.Components.voip.t) arrayList2.get(i12)).w != null) {
                        arrayList.remove(((org.telegram.ui.Components.voip.t) arrayList2.get(i12)).w);
                    }
                }
            ...
            case 5:
                ((e60) ((b6) obj2).b).R0.setNewColors((int[]) obj);
                break;
            case 6:
            ...
            case 7:
                ...
                l70Var.c = l70Var.h.getConnectionsManager().sendRequest(tL_messages_getStickerSet, new no(24, k70Var, str), 66);
                break;
            case 8:
            ...
            case 9:
                ...
                n70Var.n = o70Var.getConnectionsManager().sendRequest(tL_messages_searchStickerSets, new da(n70Var, str2, str2, 14), 66);
                break;
            case 10:
            ...
            case 12:
                ...
                if (str3.trim().toLowerCase().length() == 0) {
                    AndroidUtilities.runOnUIThread(new w10(i13, languageSelectActivity2, new ArrayList()));
                    break;
                } else {
                    ...
                    while (i11 < size2) {
                        LocaleController.LocaleInfo localeInfo2 = (LocaleController.LocaleInfo) languageSelectActivity2.f.get(i11);
                    ...
                    AndroidUtilities.runOnUIThread(new w10(i13, languageSelectActivity2, arrayList3));
                    break;
                }
                break;
            case 13:
            ...
            case 23:
                ...
                yb0Var.a();
                if (tLObject3 != null) {
                    yb0Var.a.j0((TL_account.Password) tLObject3);
                    break;
                }
                break;
            case 24:
                ((FiltersSetupActivity) obj2).X(((yb0) obj).a.O());
                break;
            case 25:
                cd0 cd0Var = (cd0) obj2;
    ...
    public /* synthetic */ w10(yb0 yb0Var, FiltersSetupActivity filtersSetupActivity) {
        this.a = 24;
        this.c = yb0Var;
