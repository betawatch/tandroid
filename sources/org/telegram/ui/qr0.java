        ...
        switch (this.a) {
            case 0:
                ...
                try {
                    ...
                    photoViewer.C4.setImageBitmap(m2Var2 == null ? p2Var.I : (isEmpty || bitmap == null) ? m2Var2.b() : p2Var.e(bitmap));
                    photoViewer.t5.setUndoCutState(true);
                    photoViewer.Z2(true, true);
                    photoViewer.t5.post(new kr0(photoViewer, i11));
                    break;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            case 1:
                org.telegram.ui.Components.vc.F(this.b.e0, true).j();
                break;
            case 2:
                ...
                float dp = (!(photoViewer2.L1.S0 instanceof qg.x2) || max <= 0) ? 0.0f : ((AndroidUtilities.displaySize.y - max) - AndroidUtilities.dp(80.0f)) - photoViewer2.L1.getSelectedEntityBottom();
                ...
                ofFloat.addUpdateListener(new jr0(photoViewer2, i11));
                ...
                ofFloat2.addUpdateListener(new jr0(photoViewer2, i12));
                AnimatorSet animatorSet2 = new AnimatorSet();
                photoViewer2.J1 = animatorSet2;
                qg.z1 z1Var = photoViewer2.L1.l1;
                Property property = View.TRANSLATION_Y;
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(z1Var, (Property<qg.z1, Float>) property, (-max) / 2.5f);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(photoViewer2.L1.c1, (Property<qg.m0, Float>) property, Math.min(0, AndroidUtilities.dp(40.0f) + r15));
                ci.x5 x5Var = photoViewer2.L1.f1;
                Property property2 = View.ALPHA;
                animatorSet2.playTogether(ofFloat3, ofFloat4, ObjectAnimator.ofFloat(x5Var, (Property<ci.x5, Float>) property2, max > AndroidUtilities.dp(20.0f) ? 0.0f : 1.0f), ObjectAnimator.ofFloat(photoViewer2.L1.A0, (Property<qg.i1, Float>) property2, max > AndroidUtilities.dp(20.0f) ? 0.0f : 1.0f), ObjectAnimator.ofFloat(photoViewer2.L1.B0, (Property<qg.m1, Float>) property2, max > AndroidUtilities.dp(20.0f) ? 0.0f : 1.0f), ofFloat2);
                animatorSet2.setDuration(320L);
                animatorSet2.setInterpolator(qrVar);
                animatorSet2.start();
                cu0 cu0Var = photoViewer2.L1;
                qg.r1 r1Var = cu0Var.u1;
                if (r1Var != null) {
                    if (cu0Var.h2) {
                ...
                AndroidUtilities.updateViewShow(cu0Var.y1, (cu0Var.h2 || cu0Var.g2) ? false : true, false, 1.0f, true, null);
                AndroidUtilities.updateViewShow(cu0Var.w1, (cu0Var.h2 || cu0Var.g2) ? false : true, false, 1.0f, true, null);
                AndroidUtilities.updateViewShow(cu0Var.A1, cu0Var.h2 || cu0Var.g2, false, 1.0f, true, null);
                AndroidUtilities.updateViewShow(cu0Var.z1, cu0Var.h2 || cu0Var.g2, false, 1.0f, true, null);
                break;
            case 3:
                ...
                if (!photoViewer3.q5.b.N && (i10 = photoViewer3.P4) >= 0 && i10 < photoViewer3.g7.size() && (photoViewer3.g7.get(photoViewer3.P4) instanceof MediaController.PhotoEntry)) {
                    ...
                    Utilities.globalQueue.postRunnable(new org.telegram.ui.Components.kn0(photoViewer3, photoEntry, (MediaController.PhotoEntry) photoViewer3.g7.get(photoViewer3.P4), PhotoViewer.y1(), 28));
                    break;
                }
                break;
            case 4:
            ...
            case 5:
                ...
                if (frameLayout != null && frameLayout.getVisibility() != 8) {
                    photoViewer5.R7.setTranslationY(photoViewer5.P0.getTranslationY() - (photoViewer5.U1.getAlpha() * hg.k0.f(46.0f, photoViewer5.U1.getEditTextHeight(), 0)));
                }
                photoViewer5.e1.setTranslationY(photoViewer5.U1.getAlpha() * (-hg.k0.f(46.0f, num2.intValue(), 0)));
                photoViewer5.f1.setTranslationY(photoViewer5.U1.getAlpha() * (-hg.k0.f(46.0f, num2.intValue(), 0)));
                photoViewer5.g1.setTranslationY(photoViewer5.U1.getAlpha() * (-hg.k0.f(46.0f, num2.intValue(), 0)));
