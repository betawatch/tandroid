...
public abstract class x91 extends FrameLayout {
    ...
    public x91(Context context, int i10, wf.f fVar, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        final int i11 = 0;
        cVar.d.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.t91
        ...
        final int i13 = 1;
        this.b.q0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.t91
            public final /* synthetic */ x91 b;
        ...
        final int i14 = 2;
        this.c.q0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.t91
            public final /* synthetic */ x91 b;
    ...
    public final ValueAnimator a(long j10, boolean z4) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.u91
        ...
        if (z91Var != null && (bVar = z91Var.d) != null && (arrayList = bVar.d) != null && arrayList.size() > 1) {
            for (int i10 = 0; i10 < this.r.d.d.size(); i10++) {
                ...
                if (i10 < arrayList2.size()) {
                    org.telegram.ui.Components.t00 t00Var = ((w91) arrayList2.get(i10)).a;
                    t00Var.getClass();
    ...
    public final void e(z91 z91Var, boolean z4) {
        ...
        yf.e eVar = gVar.q0;
        boolean z12 = z91Var.n;
        eVar.a = z12;
        cVar.c(!z12);
        if (z91Var.d == null && z91Var.f != null) {
        ...
        cVar.setUseWeekInterval(z91Var.o);
        gVar.q0.setUseWeek(z91Var.o);
        yf.e eVar2 = gVar.q0;
        ...
        if (size > 1) {
            for (int i10 = 0; i10 < size; i10++) {
                ...
                t00Var.setOnTouchListener(new org.telegram.ui.Components.dl0());
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (((xf.a) bVar.d.get(i12)).c.equals(((xf.a) this.r.d.d.get(i10)).c)) {
                        boolean z11 = ((w91) arrayList.get(i10)).a.b;
                        ((yf.f) arrayList2.get(i12)).n = z11;
                        ((yf.f) arrayList2.get(i12)).o = z11 ? 1.0f : 0.0f;
                        ((w91) arrayList.get(i10)).a.c = true;
                        ((w91) arrayList.get(i10)).a.animate().alpha(1.0f).start();
                        if (z11) {
                            i11++;
                        }
                        z10 = true;
                ...
                if (!z10) {
                    ((w91) arrayList.get(i10)).a.c = false;
                    ((w91) arrayList.get(i10)).a.animate().alpha(0.0f).start();
                }
                i10++;
            }
            if (i11 == 0) {
                for (int i13 = 0; i13 < this.r.d.d.size(); i13++) {
                    ((w91) arrayList.get(i13)).a.c = true;
                    ((w91) arrayList.get(i13)).a.animate().alpha(1.0f).start();
                }
                return;
            }
        }
    ...
    public final void h(boolean z4) {
        xf.b bVar;
        z91 z91Var = this.r;
        if (z91Var == null || (bVar = z91Var.d) == null || bVar.a == null) {
            return;
        }
        yf.c cVar = this.d;
        ...
        if (z4) {
            ...
            while (i10 < size) {
                ...
                i10++;
                w91 w91Var = (w91) obj;
                w91Var.a.animate().alpha(1.0f).start();
                w91Var.a.c = true;
            }
            a2.start();
            return;
