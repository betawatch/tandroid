...
public final class kd1 extends org.telegram.ui.Components.w9 {
    public Drawable G;
    public final boolean H;
    public float I;
    public float J;
    public final /* synthetic */ vd1 K;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if ((drawable instanceof ColorDrawable) || (drawable instanceof GradientDrawable) || (drawable instanceof org.telegram.ui.Components.lc0)) {
                ...
                if (((BitmapDrawable) drawable).getTileModeX() == Shader.TileMode.REPEAT) {
                    ...
                    int ceil = (int) Math.ceil(this.G.getIntrinsicWidth() * max * vd1Var.y1);
                    int ceil2 = (int) Math.ceil(this.G.getIntrinsicHeight() * max * vd1Var.y1);
        ...
        if (vd1Var.a2) {
            if (!vd1Var.c.isFinished() && vd1Var.c.computeScrollOffset()) {
                if (vd1Var.c.getStartX() < vd1Var.W1 && vd1Var.c.getStartX() > 0) {
                    vd1Var.X1 = vd1Var.c.getCurrX();
                }
                vd1Var.V0();
                invalidate();
            }
        ...
        if (vd1Var.M1) {
            float f11 = vd1Var.n1;
            if (f11 > 0.0f) {
                canvas.drawColor(i0.a.k(-16777216, (int) (f11 * 255.0f * vd1Var.o1)));
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        vd1 vd1Var = this.K;
        org.telegram.ui.Components.a91 a91Var = vd1Var.v1;
        ...
        if (vd1Var.b2 != measuredWidth2) {
            vd1Var.a2 = false;
            if (vd1Var.C1 != null) {
                int measuredHeight2 = (int) ((getMeasuredHeight() / vd1Var.C1.getHeight()) * r1.getWidth());
