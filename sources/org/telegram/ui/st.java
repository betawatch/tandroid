...
public final class st {
    ...
    public View h;
    public boolean i;
    public org.telegram.ui.Components.s11 j;
    ...
    public static int d(st stVar, int i10) {
        return org.telegram.ui.ActionBar.i6.v0(i10, stVar.c0);
    }
    ...
    public static boolean h(st stVar, ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        if (z11) {
            qh.q qVar2 = new qh.q(actionBarPopupWindow$ActionBarPopupWindowLayout.getContext(), stVar.r, stVar.c0);
            ...
            n70Var.T(org.telegram.ui.ActionBar.i6.l1(0.06f, org.telegram.ui.ActionBar.i6.v0(i10, stVar.c0)));
            ah.c cVar = stVar.t;
            dh.e k10 = eh.b.k(stVar.c0);
            ...
            if ((activity instanceof LaunchActivity) && z14 != null) {
                ...
                if (n2Var != null) {
                    org.telegram.ui.Components.e61 a2 = qVar2.a(n2Var, z14.getDialogId(), z14.getId(), g10.option, pollResult.voters, new nf(23, stVar, n2Var));
                    qVar = qVar2;
                    n70Var.q(a2);
                    ...
                    qVar.setBackground(org.telegram.ui.ActionBar.i6.Y(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.I5, stVar.c0), 12, 0));
                    ...
                    k1Var.setColor(org.telegram.ui.ActionBar.i6.l1(0.06f, org.telegram.ui.ActionBar.i6.v0(i10, stVar.c0)));
            ...
            k1Var2.setColor(org.telegram.ui.ActionBar.i6.l1(0.06f, org.telegram.ui.ActionBar.i6.v0(i10, stVar.c0)));
        ...
        if (!z11 && (z12 || z13)) {
            ...
            k1Var3.setColor(org.telegram.ui.ActionBar.i6.l1(f7, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.E8, stVar.c0)));
    ...
    public final void n() {
        ...
        ih1 ih1Var = this.O;
        if (ih1Var != null) {
            ih1Var.animate().alpha(0.0f).translationY(AndroidUtilities.dp(56.0f)).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f).start();
        }
        FrameLayout frameLayout = this.Q;
        if (frameLayout != null) {
            frameLayout.animate().alpha(0.0f).setDuration(150L).scaleX(0.6f).scaleY(0.6f).setInterpolator(org.telegram.ui.Components.qr.f).start();
        }
    ...
    public final void o() {
        ...
        if (xbVar != null && (reactionsWindow = xbVar.getReactionsWindow()) != null && !reactionsWindow.q) {
            reactionsWindow.d();
            return;
        }
        this.K = false;
    ...
    public final void p() {
        ...
        if (actionBarPopupWindow$ActionBarPopupWindowLayout != null) {
            org.telegram.messenger.vl.r(actionBarPopupWindow$ActionBarPopupWindowLayout.animate().alpha(0.0f).scaleX(0.8f).scaleY(0.8f).translationY(AndroidUtilities.dp(-12.0f)), org.telegram.ui.Components.qr.h, 320L);
            this.L = null;
            this.K = false;
            if (this.R) {
                n();
    ...
    public final boolean r(MotionEvent motionEvent, org.telegram.ui.Components.ll0 ll0Var, qt qtVar, org.telegram.ui.ActionBar.e6 e6Var) {
        int i10;
        this.l = qtVar;
        if (qtVar != null) {
            this.m = qtVar.k();
                ...
                if (top > y3 || bottom < y3 || left > x10 || right < x10) {
                    ...
                    if (z10) {
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.e2) {
                            ...
                            if ((childAt instanceof org.telegram.ui.Components.my0) && (((org.telegram.ui.Components.my0) childAt).b instanceof org.telegram.ui.Components.o5)) {
                                imageReceiver.setRoundRadius(0);
                            }
                            i10 = -1;
                        } else {
                    ...
                    if (i10 != -1) {
                        ...
                        this.b = y3;
                        this.h = childAt;
                        org.telegram.ui.Components.s11 s11Var = new org.telegram.ui.Components.s11(this, ll0Var, i10, e6Var, 1);
                        this.j = s11Var;
                        AndroidUtilities.runOnUIThread(s11Var, 200L);
                        return true;
                    }
                }
            }
    ...
    */
    public final boolean s(MotionEvent motionEvent, org.telegram.ui.Components.ll0 ll0Var, Object obj, qt qtVar, org.telegram.ui.ActionBar.e6 e6Var) {
        int i10;
        int i11;
        qt qtVar2;
        View view;
        ...
        if ((qtVar3 == null || qtVar3.h()) && (this.j != null || this.E)) {
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3 || motionEvent.getAction() == 6) {
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.ar0(23, ll0Var, obj), 150L);
                org.telegram.ui.Components.s11 s11Var = this.j;
                if (s11Var != null) {
                    AndroidUtilities.cancelRunOnUIThread(s11Var);
                    this.j = null;
                    return false;
                }
                if (this.E) {
                                ...
                                if (top > y3 || bottom < y3 || left > x10 || right < x10) {
                                    ...
                                    if (z10) {
                                        ...
                                        if (childAt instanceof org.telegram.ui.Cells.e2) {
                                            ...
                                            if (childAt instanceof org.telegram.ui.Components.jv) {
                                                imageReceiver.setRoundRadius(0);
                                            } else if (!(childAt instanceof org.telegram.ui.Components.ty) || ((org.telegram.ui.Components.ty) childAt).getSpan() == null) {
                                                i10 = -1;
                                            } else {
                                        ...
                                        if (i10 != -1 && childAt != this.h) {
                                            ...
                                            if (!(view2 instanceof org.telegram.ui.Cells.f8)) {
                                                ...
                                                qt qtVar4 = this.l;
                                                t(sticker, stickerPath, findAnimatedEmojiEmoticon, qtVar4 != null ? qtVar4.F(false) : null, null, i10, f8Var.y, f8Var.getParentObject(), e6Var, 0);
                                                ...
                                                qt qtVar5 = this.l;
                                                t(sticker2, null, findAnimatedEmojiEmoticon2, qtVar5 != null ? qtVar5.F(false) : null, null, i10, false, d8Var.getParentObject(), e6Var, 0);
                                                ...
                                                qt qtVar6 = this.l;
                                                t(document2, null, null, qtVar6 != null ? qtVar6.F(true) : null, e2Var2.getBotInlineResult(), i10, false, e2Var2.getBotInlineResult() != null ? e2Var2.getInlineBot() : e2Var2.getParentObject(), e6Var, 0);
                                                if (i10 != 1 || this.m) {
                                                    e2Var2.setScaled(true);
                                                }
                                            } else if (view2 instanceof org.telegram.ui.Components.jv) {
                                                TLRPC.Document document3 = ((org.telegram.ui.Components.jv) view2).getDocument();
                                                if (document3 != null) {
                                                ...
                                                org.telegram.ui.Components.x5 span = ((org.telegram.ui.Components.ty) view2).getSpan();
                                                if (span != null) {
                                                    TLRPC.Document document4 = span.document;
                                                    if (document4 == null) {
                                                        document4 = org.telegram.ui.Components.o5.f(this.r, span.getDocumentId());
                                                    }
                                                    document = document4;
                                                } else {
                                                    document = null;
                                            ...
                                            } else if (view2 instanceof org.telegram.ui.Components.my0) {
                                                Drawable drawable = ((org.telegram.ui.Components.my0) view2).b;
                                                TLRPC.Document document5 = drawable instanceof org.telegram.ui.Components.o5 ? ((org.telegram.ui.Components.o5) drawable).e : null;
                                                if (document5 != null) {
    ...
    public final void t(TLRPC.Document document, SendMessagesHelper.ImportingSticker importingSticker, String str, String str2, TLRPC.BotInlineResult botInlineResult, int i10, boolean z10, Object obj, org.telegram.ui.ActionBar.e6 e6Var, int i11) {
        ...
        this.p = z10;
        this.G = null;
        this.u.setColor(AndroidUtilities.isDarkColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.d6, e6Var)) ? 1895825408 : 1692853990);
        this.S = false;
            ...
            if (document != null) {
                ...
                if (importingSticker != null) {
                    ...
                    if (importingSticker.videoEditedInfo != null) {
                        if (this.C == null) {
                            org.telegram.ui.Components.fd0 fd0Var = new org.telegram.ui.Components.fd0(this.z.getContext());
                            this.C = fd0Var;
                            this.z.addView(fd0Var, new FrameLayout.LayoutParams(512, 512));
                        }
                        z11 = false;
