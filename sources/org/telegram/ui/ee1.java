...
public final /* synthetic */ class ee1 implements Runnable {
    ...
    public /* synthetic */ ee1(fe1 fe1Var, String str, int i10, int i11) {
        this.a = i11;
        this.b = fe1Var;
        this.c = str;
        this.d = i10;
    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                int i10 = this.d;
                fe1Var.getClass();
                Utilities.searchQueue.postRunnable(new ee1(fe1Var, str, i10, 1));
                break;
            default:
                fe1 fe1Var2 = this.b;
                String str2 = this.c;
                int i11 = this.d;
                ge1 ge1Var = fe1Var2.h;
                ...
                if (lowerCase.length() != 0) {
                        ...
                        while (true) {
                            ...
                            if (publicUsername != null) {
                                ...
                                while (i13 < i12) {
                                    ...
                                    if (!z4) {
                                        arrayList2.add(chat);
                                        arrayList3.add((String) ge1Var.h.get(i14));
                                    }
                                }
                                if (!z4) {
                                }
                    ...
                    AndroidUtilities.runOnUIThread(new et(fe1Var2, i11, arrayList2, arrayList3, 11));
                    break;
                } else {
                    AndroidUtilities.runOnUIThread(new et(fe1Var2, i11, str3, str3, 11));
                    break;
                }
                break;
        }
