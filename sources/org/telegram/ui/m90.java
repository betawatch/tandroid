...
public final /* synthetic */ class m90 implements Runnable {
    ...
    public /* synthetic */ m90(TLObject tLObject, int i10, org.telegram.ui.ActionBar.d2 d2Var, Context context, long j10, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.web.u uVar, dh.v vVar) {
        this.b = tLObject;
        this.c = i10;
        this.e = d2Var;
        this.f = context;
                ...
                if (tLObject instanceof TLRPC.TL_attachMenuBotsBot) {
                    ...
                    if (str != null) {
                        ...
                        if (arrayList4.isEmpty()) {
                            ...
                            oyVar = new oy(bundle);
                            oyVar.z2 = new u90(launchActivity, user, str3, i11);
                        }
                        if (tL_attachMenuBot.inactive) {
                            ...
                            si1.a(launchActivity, new h5.d() { // from class: org.telegram.ui.v90
                                @Override // h5.d
                                public final void accept(Object obj) {
                                    ...
                                    ConnectionsManager.getInstance(i12).sendRequest(tL_messages_toggleBotInAttachMenu, new org.telegram.messenger.ki(LaunchActivity.this, i12, oyVar2, p2Var2, user, str3), 66);
                                }
                            }, null);
                            break;
                        } else if (oyVar != null) {
                ...
                if (tLObject2 instanceof TLRPC.TL_messages_preparedInlineMessage) {
                    ...
                    if (z4) {
                        ...
                        if (!TextUtils.isEmpty(tL_botInlineMessageMediaWebPage.url)) {
                            ...
                            iArr[0] = ConnectionsManager.getInstance(i13).sendRequestTyped(getwebpagepreview, new org.telegram.messenger.a(), new lh.i0(iArr, x0Var, notificationCenterDelegateArr, i13, 6));
                    ...
                    if (webDocument != null && !TextUtils.isEmpty(webDocument.url)) {
                        ...
                        if ((botInlineMessage2 instanceof TLRPC.TL_botInlineMessageMediaAuto) || (botInlineMessage2 instanceof TLRPC.TL_botInlineMessageMediaWebPage)) {
                            ...
                            File file = new File(FileLoader.getDirectory(4), Utilities.MD5(str6) + (TextUtils.isEmpty(httpUrlExtension) ? FileLoader.getExtensionByMimeType(tL_messages_preparedInlineMessage.result.content.mime_type) : vh.v2.e(".", httpUrlExtension)));
                            if (file.exists()) {
                                r70Var.run();
                                break;
                            } else {
    ...
    public /* synthetic */ m90(LaunchActivity launchActivity, TLObject tLObject, int i10, String str, String str2, TLRPC.User user, String str3, long j10) {
