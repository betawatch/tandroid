...
public final class ua1 extends LinearLayout {
    ...
    public void setData(wa1 wa1Var) {
        TextView[] textViewArr = this.a;
        textViewArr[0].setText(wa1Var.b);
        textViewArr[1].setText(wa1Var.f);
        textViewArr[2].setText(wa1Var.j);
        textViewArr[3].setText(wa1Var.n);
        TextView[] textViewArr2 = this.b;
        textViewArr2[0].setText(wa1Var.c);
        textViewArr2[0].setTag(Integer.valueOf(wa1Var.d ? org.telegram.ui.ActionBar.j6.x6 : org.telegram.ui.ActionBar.j6.p7));
        textViewArr2[1].setText(wa1Var.g);
        textViewArr2[1].setTag(Integer.valueOf(wa1Var.h ? org.telegram.ui.ActionBar.j6.x6 : org.telegram.ui.ActionBar.j6.p7));
        textViewArr2[2].setText(wa1Var.k);
        textViewArr2[2].setTag(Integer.valueOf(wa1Var.l ? org.telegram.ui.ActionBar.j6.x6 : org.telegram.ui.ActionBar.j6.p7));
        textViewArr2[3].setText(wa1Var.o);
        textViewArr2[3].setTag(Integer.valueOf(wa1Var.p ? org.telegram.ui.ActionBar.j6.x6 : org.telegram.ui.ActionBar.j6.p7));
        TextView[] textViewArr3 = this.c;
        textViewArr3[0].setText(wa1Var.a);
        textViewArr3[1].setText(wa1Var.e);
        textViewArr3[2].setText(wa1Var.i);
        textViewArr3[3].setText(wa1Var.m);
        b();
    }
}
