...
public final class so0 extends LinearLayout {
    ...
    public so0(uo0 uo0Var, Context context) {
        ...
        org.telegram.ui.Components.l80 a2 = g7.i6.a(context2, 14.0f, i9, false, b6Var);
        this.a = a2;
        a2.setGravity(17);
        a2.setText(LocaleController.getString(uo0Var.c0 == 0 ? R.string.Gift2PeerColorProfileEmptyTitle : R.string.Gift2PeerColorReplyEmptyTitle));
        ...
        org.telegram.ui.Components.l80 a3 = g7.i6.a(context3, 14.0f, i10, false, b6Var2);
        this.b = a3;
        a3.setGravity(17);
    ...
    public final void a() {
        zo0 zo0Var = this.c.f0;
        setBackgroundColor(zo0Var.getThemedColor(org.telegram.ui.ActionBar.f6.d6));
        this.a.setTextColor(zo0Var.getThemedColor(org.telegram.ui.ActionBar.f6.y6));
