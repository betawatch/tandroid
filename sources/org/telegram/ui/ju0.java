...
public final class ju0 extends org.telegram.ui.Components.ql0 {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        y5Var.f = dp;
        org.telegram.ui.Components.kp kpVar = y5Var.c;
        org.telegram.ui.Components.p9 p9Var = y5Var.a;
        dg.s1 s1Var = y5Var.e;
        y5Var.h = dp2;
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        y5Var.addView(p9Var, k7.b6.c(-1.0f, -1));
        FrameLayout frameLayout = new FrameLayout(context);
        y5Var.b = frameLayout;
        y5Var.addView(frameLayout, k7.b6.e(42, 42, 53));
        ...
        y5Var.addView(s1Var, k7.b6.e(-1, 16, 83));
        ...
        y5Var.addView(kpVar, k7.b6.d(26, 26.0f, 51, 55.0f, 4.0f, 0.0f, 0.0f));
        kpVar.setVisibility(0);
        y5Var.setFocusable(true);
        frameLayout.setOnClickListener(new g60(this, 20));
        return new org.telegram.ui.Components.dl0(y5Var);
    }
}
