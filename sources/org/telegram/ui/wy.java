...
public final class wy extends org.telegram.ui.Components.vl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 1) {
            ...
            Long l4 = (Long) zyVar.e.get(i10 - zyVar.n);
            long longValue = l4.longValue();
            if (DialogObject.isUserDialog(longValue)) {
                g4Var.e(zyVar.getMessagesController().getUser(l4), null, null, i10 != zyVar.r - 1);
                return;
            } else {
                g4Var.e(zyVar.getMessagesController().getChat(Long.valueOf(-longValue)), null, null, i10 != zyVar.r - 1);
                return;
            }
        }
