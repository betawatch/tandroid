...
public final /* synthetic */ class vh1 implements Runnable {
    ...
    public /* synthetic */ vh1(wh1 wh1Var, String str, boolean z10, boolean z11, int i10) {
        this.a = i10;
        this.b = wh1Var;
        this.c = str;
        this.d = z10;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                boolean z13 = this.e;
                wh1Var.getClass();
                AndroidUtilities.runOnUIThread(new vh1(wh1Var, str4, z12, z13, 1));
                break;
            case 1:
                wh1 wh1Var2 = this.b;
                String str5 = this.c;
                boolean z14 = this.d;
                boolean z15 = this.e;
                wh1Var2.f.g(str5, true, z14, z14, wh1Var2.v.G, 0L, false, 0, 0);
                DispatchQueue dispatchQueue = Utilities.searchQueue;
                vh1 vh1Var = new vh1(wh1Var2, str5, z15, z14, 2);
                wh1Var2.h = vh1Var;
                dispatchQueue.postRunnable(vh1Var);
                break;
            default:
                wh1 wh1Var3 = this.b;
                String str6 = this.c;
                boolean z16 = this.d;
                boolean z17 = this.e;
                ArrayList arrayList2 = wh1Var3.r;
                ...
                if (lowerCase.length() != 0) {
                                ...
                                while (i14 < 3) {
                                    ...
                                    if (str8 != null) {
                                        if (!str8.startsWith(str7)) {
                                            i10 = i14;
                                            if (org.telegram.messenger.l0.v(" ", str7, str8)) {
                                            }
                                        }
                                        c11 = 1;
                                        ...
                                        if (c11 == 0) {
                                            if (c11 != 1) {
                                                str3 = str;
                                                arrayList4.add(AndroidUtilities.generateSearchName(v7.j0.g("@", str2), str3, "@" + str7));
                                            } else if (z18) {
                    ...
                    AndroidUtilities.runOnUIThread(new zd1(wh1Var3, arrayList3, arrayList4, 6));
                    break;
                } else {
                    AndroidUtilities.runOnUIThread(new zd1(wh1Var3, new ArrayList(), new ArrayList(), 6));
                    break;
                }
        }
    }
