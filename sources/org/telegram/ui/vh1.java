...
public final class vh1 extends ViewGroup {
    ...
    public vh1(UsersSelectActivity usersSelectActivity, Context context) {
        super(context);
    ...
    public final void a(org.telegram.ui.Components.m30 m30Var, boolean z10) {
        ...
        if (z10) {
            ...
            this.a = animatorSet2;
            animatorSet2.addListener(new gp0(this, 27));
    ...
    public final void b(org.telegram.ui.Components.m30 m30Var) {
        ...
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.a = animatorSet2;
        animatorSet2.addListener(new org.telegram.ui.Components.al0(16, this, m30Var));
        this.a.setDuration(150L);
        this.e = m30Var;
        ArrayList arrayList = this.c;
        arrayList.clear();
