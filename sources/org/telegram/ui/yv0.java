...
public final class yv0 extends org.telegram.ui.ActionBar.p2 {
    ...
    public static /* synthetic */ void U(yv0 yv0Var, TLRPC.TL_error tL_error, TLObject tLObject, TL_stars.updatePaidMessagesPrice updatepaidmessagesprice) {
        if (tL_error != null) {
            yv0Var.e.a(0.0f);
        ...
        yv0Var.getMessagesController().putChats(updates.chats, false);
        yv0Var.getMessagesController().processUpdates(updates, false);
        if (yv0Var.isFinished || yv0Var.finishing) {
            return;
        }
        io ioVar = yv0Var.v;
        if (ioVar != null) {
    ...
    public final String W() {
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, rh.k.G0(getMessagesController().starsPaidMessageCommissionPermille), String.valueOf(((int) (((this.s * (r0 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }
    ...
    public final void Y() {
        ...
        getConnectionsManager().sendRequest(updatepaidmessagesprice, new sb0(12, this, updatepaidmessagesprice));
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new jl0(this, 5));
        ...
        this.e = new org.telegram.ui.Components.mr(mutate, new org.telegram.ui.Components.rp(org.telegram.ui.ActionBar.j6.w0(null, i10, false)));
        ...
        org.telegram.ui.Components.g61 g61Var = new org.telegram.ui.Components.g61(context, this.currentAccount, this.classGuid, false, new d5(this, 16), new xv0(this, 2), null, this.resourceProvider);
        this.d = g61Var;
        g61Var.p1();
    ...
    public final boolean onBackPressed(boolean z4) {
        ...
        alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new xv0(this, 0));
        alertDialog$Builder.h(LocaleController.getString(R.string.Discard), new xv0(this, 1));
