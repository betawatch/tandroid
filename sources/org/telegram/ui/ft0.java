...
public final class ft0 implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        ...
        photoViewer.o3.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(grVar).start();
        ...
        ObjectAnimator duration2 = ObjectAnimator.ofFloat(gVar, (Property<bh.g, Float>) View.TRANSLATION_Y, gVar.getTranslationY(), 0.0f).setDuration(220L);
        duration2.setInterpolator(grVar);
        bh.g gVar2 = photoViewer.L0;
        Property property = View.ALPHA;
        ObjectAnimator duration3 = ObjectAnimator.ofFloat(gVar2, (Property<bh.g, Float>) property, 1.0f).setDuration(220L);
        duration3.setInterpolator(grVar);
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer.a0, (Property<tt0, Float>) property, 0.0f, 1.0f).setDuration(220L), ObjectAnimator.ofFloat(photoViewer.f0, (Property<View, Float>) property, 0.0f, 1.0f).setDuration(220L), duration2, duration3);
