...
public final class lm0 implements ym0 {
    ...
    public lm0(in0 in0Var, TLRPC.SecureValueType secureValueType, boolean z10, int i10) {
        this.d = in0Var;
    ...
    public static void a(lm0 lm0Var, SecureDocument secureDocument, TLRPC.TL_secureFile tL_secureFile) {
        lm0Var.getClass();
    ...
    public final void c(TLRPC.TL_secureRequiredType tL_secureRequiredType, String str, String str2, TLRPC.TL_secureRequiredType tL_secureRequiredType2, String str3, ArrayList arrayList, SecureDocument secureDocument, ArrayList arrayList2, SecureDocument secureDocument2, SecureDocument secureDocument3, Runnable runnable, o0.a aVar) {
        ...
        if (!isEmpty) {
            ...
            cf.c k12 = in0Var.k1(AndroidUtilities.getStringBytes(str2));
        ...
        if (tL_secureRequiredType2 != null) {
            ...
            if (!TextUtils.isEmpty(str3)) {
                ...
                cf.c k13 = in0Var.k1(AndroidUtilities.getStringBytes(str3));
            ...
            if (!z10) {
                ...
                savesecurevalue.secure_secret_id = in0Var.b1;
                i10 = ((org.telegram.ui.ActionBar.n2) in0Var).currentAccount;
                ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue, new km0(this, aVar, str, savesecurevalue, tL_secureRequiredType2, tL_secureRequiredType, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, runnable, this, tL_inputSecureValue2));
            }
        ...
        savesecurevalue2.secure_secret_id = in0Var.b1;
        i10 = ((org.telegram.ui.ActionBar.n2) in0Var).currentAccount;
        ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue2, new km0(this, aVar, str, savesecurevalue2, tL_secureRequiredType2, tL_secureRequiredType, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, runnable, this, tL_inputSecureValue2));
    }
}
