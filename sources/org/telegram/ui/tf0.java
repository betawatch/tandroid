...
public final class tf0 extends org.telegram.ui.Components.fw0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public tf0(qg0 qg0Var, Context context, int i10) {
        super(context);
        ViewGroup viewGroup;
        this.s0 = qg0Var;
        this.U = new Object();
        ...
        String string = qg0Var.F != 1 ? null : LocaleController.getString(R.string.CancelAccountReset);
        if (i10 == 11) {
            ...
            addView(frameLayout, w7.y5.t(64, 64, 1, 0, 16, 0, 0));
            addView(textView2, w7.y5.t(-2, -2, 49, 0, 8, 0, 0));
            ...
            addView(textView3, w7.y5.t(-1, -2, 49, 36, 16, 36, 0));
            ...
            f7.addView(textView4, w7.y5.t(-2, -1, 16, 0, 0, 4, 0));
            f7.addView(qf0Var, w7.y5.n(-2, -1));
            addView(f7, w7.y5.t(-2, 34, 1, 0, 28, 0, 0));
            ...
            addView(textView5, w7.y5.t(-1, -2, 49, 36, 28, 36, 12));
        } else {
            if (i10 == 3) {
                textView.setGravity(1);
                ViewGroup frameLayout2 = new FrameLayout(context);
                addView(frameLayout2, w7.y5.l(1.0f, -1, 0));
                LinearLayout linearLayout = new LinearLayout(context);
                linearLayout.setOrientation(1);
                linearLayout.setGravity(1);
                frameLayout2.addView(linearLayout, w7.y5.e(-1, -2, 17));
                ...
                if (i10 != 11) {
                    ...
                    this.f = qf0Var2;
                    addView(qf0Var2, w7.y5.t(-2, 42, 1, 0, 32, 0, 0));
                }
                if (i10 == 3) {
                ...
                o2Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, i11, false));
                o2Var.setTextColor(qg0Var.getThemedColor(i11));
                ...
                final int i12 = 0;
                o2Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.of0
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (i12) {
                            ...
                            default:
                                ...
                                tf0Var2.getClass();
                                try {
                                    tf0Var2.getContext().startActivity(new Intent("android.intent.action.VIEW", Uri.parse(tf0Var2.n0)));
                                    break;
                                } catch (Exception e) {
                                    FileLog.e(e);
                                }
                ...
                this.v = rf0Var;
                rf0Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, i11, false));
                            ...
                            case 1:
                                ...
                                if (tf0Var.V <= 0 || tf0Var.R == null) {
                                    ...
                                    if (i14 != 4 && i14 != 2 && i14 != 17 && i14 != 16 && i14 != 11 && i14 != 15) {
                                        ...
                                        tL_auth_resendCode.phone_number = tf0Var.d;
                                        tL_auth_resendCode.phone_code_hash = tf0Var.c;
                                        i132 = ((org.telegram.ui.ActionBar.m2) tf0Var.s0).currentAccount;
                ...
                frameLayout4.addView(rf0Var, w7.y5.e(-2, -2, 49));
                ...
                if (i10 == 15) {
                    ...
                    frameLayout4.addView(rf0Var2, w7.y5.e(-1, -2, 17));
                ...
                this.E = textView7;
                textView7.setLineSpacing(org.telegram.ui.Cells.c1.c(2.0f, R.string.WrongCode, textView7), 1.0f);
                ...
                zd0Var.addView(textView7, w7.y5.e(-2, -2, 17));
                if (viewGroup != null) {
                    FrameLayout frameLayout5 = new FrameLayout(context);
                    frameLayout5.addView(zd0Var, w7.y5.d(i10 == 15 ? -1 : -2, -2.0f, 81, 0.0f, 0.0f, 0.0f, 32.0f));
                    addView(frameLayout5, w7.y5.l(1.0f, -1, 0));
                } else {
                    viewGroup.addView(zd0Var, w7.y5.d(-2, -2.0f, 81, 0.0f, 0.0f, 0.0f, 32.0f));
                }
                n7.z0.k(zd0Var);
                if (i10 == 15) {
                    this.x.setOnClickListener(new ov(20, this, context));
                    return;
                }
                return;
            }
            ...
            addView(frameLayout6, w7.y5.t(-2, -2, 49, 0, 16, 0, 0));
            ...
            addView(textView2, w7.y5.t(-2, -2, 49, 0, 18, 0, 0));
            int i16 = i10 == 15 ? 16 : 0;
            addView(textView, w7.y5.t(-2, -2, 49, i16, 17, i16, 0));
        }
        viewGroup = null;
        if (i10 != 11) {
        }
        ...
        o2Var2.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, i112, false));
        o2Var2.setTextColor(qg0Var.getThemedColor(i112));
        ...
        final int i122 = 0;
        o2Var2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.of0
            public final /* synthetic */ tf0 b;
        ...
        this.v = rf0Var3;
        rf0Var3.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, i112, false));
                    ...
                    case 1:
                        ...
                        if (tf0Var.V <= 0 || tf0Var.R == null) {
                            ...
                            if (i142 != 4 && i142 != 2 && i142 != 17 && i142 != 16 && i142 != 11 && i142 != 15) {
                                ...
                                tL_auth_resendCode.phone_number = tf0Var.d;
                                tL_auth_resendCode.phone_code_hash = tf0Var.c;
                                i1322 = ((org.telegram.ui.ActionBar.m2) tf0Var.s0).currentAccount;
        ...
        frameLayout42.addView(rf0Var3, w7.y5.e(-2, -2, 49));
        ...
        this.E = textView72;
        textView72.setLineSpacing(org.telegram.ui.Cells.c1.c(2.0f, R.string.WrongCode, textView72), 1.0f);
        ...
        zd0Var2.addView(textView72, w7.y5.e(-2, -2, 17));
        if (viewGroup != null) {
        }
        n7.z0.k(zd0Var2);
        if (i10 == 15) {
    ...
    public static /* synthetic */ void o(tf0 tf0Var, Context context) {
        try {
            ...
            sb2.append(str);
            sb2.append(tf0Var.s0.e ? " #paidauth" : "");
            ...
            sb3.append("\n");
            sb3.append("Issue: ");
            sb3.append(tf0Var.s0.e ? "no_otp" : "no_otp_paid");
            sb3.append("\n");
            if (!TextUtils.isEmpty(tf0Var.e0)) {
                sb3.append("Error: ");
                sb3.append(tf0Var.e0);
                sb3.append("\n");
            }
            sb3.append("\n\n================================================\n");
            ...
            tf0Var.s0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            a2Var.R = string;
            a2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.b));
    ...
    */
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (i19 == 15) {
            ...
            if (i19 == 2) {
                ...
                if (z10) {
                    AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.th(25));
                }
            }
        }
        this.H = bundle;
        ...
        for (as asVar : this.f.f) {
            asVar.setShowSoftInputOnFocusCompat(!a() || AndroidUtilities.isAccessibilityTouchExplorationEnabled());
            asVar.addTextChangedListener(new m0(this, 9));
            asVar.setOnFocusChangeListener(new od(this, i17));
        }
        int i20 = this.h0;
        if (i20 == 17) {
                ...
                if (i21 != 4) {
                    ...
                    if (i12 != 1) {
                        ...
                        if (i12 == 2) {
                            ...
                            rf0 rf0Var3 = this.x;
                            if (rf0Var3 != null) {
                                rf0Var3.setVisibility(this.V < 1000 ? 0 : 8);
                            }
                        ...
                        if (i12 == i10) {
                            ...
                            rf0 rf0Var4 = this.x;
                            if (rf0Var4 != null) {
                                rf0Var4.setVisibility(this.V < 1000 ? 0 : 8);
                            }
                            u();
                        }
                        if (i12 == 11) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        yr yrVar = this.f;
        if (yrVar == null || (asVarArr = yrVar.f) == null) {
            return;
        }
    ...
    public final void q(Runnable runnable) {
        ...
        while (true) {
            ...
            if (i10 >= yrVar.f.length) {
                yrVar.postDelayed(new n80(25, this, runnable), (r2.length * 75) + 400);
                return;
            } else {
    ...
    public final void y() {
        ...
        AndroidUtilities.shakeViewSpring(yrVar, this.f0 == 11 ? 3.5f : 10.0f, new gf0(this, 7));
        gf0 gf0Var = this.r0;
