...
public final class n31 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(n31 n31Var, View view, int i10) {
        ...
        int i11 = 0;
        boolean z4 = n31Var.b.getAdapter() == n31Var.c;
        if (!z4 || (arrayList = n31Var.f) == null) {
            int i12 = n31Var.e;
            if (i12 >= 0 && i10 > i12) {
                i10--;
            }
            language = (i10 < 0 || i10 >= n31Var.h.size()) ? null : (TranslateController.Language) n31Var.h.get(i10);
        } else {
        ...
        if (n31Var.r.contains(str)) {
            Collection.-EL.removeIf(n31Var.r, new i80(str, 2));
        } else {
            n31Var.r.add(str);
        }
        if (n31Var.r.size() == 1 && n31Var.r.contains(currentLocaleInfo.pluralLangCode)) {
            a0(null, null);
        } else {
            a0(n31Var.r, Boolean.TRUE);
        }
        if (z4) {
            int i13 = 0;
            while (i11 < n31Var.f.size()) {
                if (TextUtils.equals(str, ((TranslateController.Language) n31Var.f.get(i11)).code)) {
                    n31Var.Z(i13);
                }
                i11++;
                i13++;
    ...
    public static void V(boolean z4) {
        ...
        if (MessagesController.getGlobalMainSettings().getInt("translate_button_restricted_languages_version", 0) != 2 || (z4 && !z10)) {
            ...
            final int i12 = 1;
            Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.l31
            ...
            }, new Utilities.Callback() { // from class: org.telegram.ui.l31
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    switch (i12) {
                        case 0:
    ...
    public final View createView(Context context) {
        ...
        this.a = new m31(this, context, false);
        this.c = new m31(this, context, true);
