...
public class PasskeysActivity extends org.telegram.ui.ActionBar.o2 {
    public org.telegram.ui.Components.f61 a;
    ...
    public static /* synthetic */ void V(PasskeysActivity passkeysActivity, TL_account.Passkey passkey, String str, int i10) {
        ...
        ConnectionsManager.getInstance(passkeysActivity.currentAccount).sendRequestTyped(deletepasskey, new org.telegram.messenger.a(), new mg(passkeysActivity, i10, passkey, 2));
    }
    ...
    public static void a0(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        bj0Var.f(R.raw.passkey, AndroidUtilities.dp(115.0f), AndroidUtilities.dp(115.0f), null);
        bj0Var.d();
        f7.addView(bj0Var, w7.x5.t(115, 115, 17, 0, 0, 0, 9));
    ...
    public final void Y(TL_account.Passkey passkey) {
        ...
        this.b.add(passkey);
        org.telegram.ui.Components.f61 f61Var = this.a;
    ...
    public final View createView(Context context) {
        ...
        this.a = f61Var;
        f61Var.q1();
        org.telegram.ui.Components.f61 f61Var2 = this.a;
        f61Var2.Y2.r = false;
