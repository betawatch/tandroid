...
public class PasskeysActivity extends org.telegram.ui.ActionBar.o2 {
    ...
    public static /* synthetic */ void U(PasskeysActivity passkeysActivity, TL_account.Passkey passkey, String str, int i9) {
        ...
        ConnectionsManager.getInstance(passkeysActivity.currentAccount).sendRequestTyped(deletepasskey, new org.telegram.messenger.a(), new ag(passkeysActivity, i9, passkey, 2));
    }
    ...
    public static void Z(int i9, Context context, org.telegram.ui.ActionBar.b6 b6Var, boolean z10) {
        ...
        pi0Var.f(R.raw.passkey, AndroidUtilities.dp(115.0f), AndroidUtilities.dp(115.0f), null);
        pi0Var.d();
        f10.addView(pi0Var, g7.e6.t(115, 115, 17, 0, 0, 0, 9));
    ...
    public final void Y(View view) {
        ...
        while (true) {
            ...
            if (i10 >= arrayList.size()) {
                ...
                if (str.equals(((TL_account.Passkey) arrayList.get(i10)).id)) {
                    i9 = i10;
                    break;
                }
                i10++;
    ...
    public final View createView(Context context) {
        ...
        this.a = i51Var;
        i51Var.p1();
        org.telegram.ui.Components.i51 i51Var2 = this.a;
        i51Var2.U2.r = false;
