...
public final class bv extends org.telegram.ui.ActionBar.o2 {
    ...
    public static final int[] s = {org.telegram.ui.ActionBar.j6.hj, org.telegram.ui.ActionBar.j6.ij, org.telegram.ui.ActionBar.j6.lj, org.telegram.ui.ActionBar.j6.kj, org.telegram.ui.ActionBar.j6.jj, org.telegram.ui.ActionBar.j6.pj, org.telegram.ui.ActionBar.j6.qj};
    ...
    public org.telegram.ui.Components.j81 a;
    public org.telegram.ui.Components.i81 b;
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.w8));
        ...
        x5Var.addView(this.a, w7.x5.e(-1, -1, 119));
        ...
        this.c.addView(this.b, w7.x5.c(48.0f, -1));
        ...
        ch.d c10 = getBaseSimpleGlass().b.c(this.c, null, false);
        ...
        org.telegram.ui.Components.j81 j81Var2 = this.a;
        org.telegram.ui.ActionBar.k kVar2 = this.actionBar;
        org.telegram.ui.ActionBar.f6 f6Var = this.resourceProvider;
        baseSimpleGlass.e = x5Var;
        baseSimpleGlass.f = j81Var2;
        ki.i iVar = baseSimpleGlass.a;
        iVar.getClass();
        ...
        ah.e eVar = new ah.e(baseSimpleGlass.c.c(kVar2, null, false));
        eVar.b(-AndroidUtilities.dp(50.0f), true);
        eVar.q = 224;
        kVar2.setBackground(eVar);
        kVar2.setExtraHeight(AndroidUtilities.dp(12.0f));
        getBaseSimpleGlass().g = new ki.a(2, this, x5Var);
        getBaseSimpleGlass().f = null;
        x5Var.addView(this.c, w7.x5.d(-1, -2.0f, 48, -4.0f, 0.0f, -4.0f, 0.0f));
    ...
    public final boolean isLightStatusBar() {
        return !this.f ? super.isLightStatusBar() : AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.w8, false)) > 0.721f;
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        ...
        while (it.hasNext()) {
            xu xuVar = (xu) it.next();
            bv bvVar = xuVar.o3;
            ki.b.a(xuVar, bvVar.h, bvVar.n, AndroidUtilities.dp(42.0f) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight());
        }
    }
