...
public final class sz extends FrameLayout {
    ...
    public /* synthetic */ sz(Context context) {
        super(context);
    }
            ...
            case 1:
                ...
                while (i14 < viewPages.length) {
                    ...
                    if (view == null) {
                        ...
                        ph.y7 y7Var = (ph.y7) view;
                        float clamp = Utilities.clamp(1.0f - Math.abs(y7Var.getTranslationX() / y7Var.getMeasuredWidth()), 1.0f, f12);
                        float f13 = this.b;
                        org.telegram.ui.Components.rl0 rl0Var = y7Var.f;
                        FrameLayout frameLayout = y7Var.e;
                        f2.i0 i0Var = y7Var.h;
                        float f14 = (i0Var.t || y7Var.a == 0) ? AndroidUtilities.displaySize.y : 0.0f;
                        int i15 = 0;
                        while (i15 < rl0Var.getChildCount()) {
                            ...
                            if (i0Var.t) {
                                ...
                                } else if (!(childAt instanceof ph.x7)) {
                                    viewArr = viewPages;
                ...
                canvas.drawRoundRect(rectF, lerp, lerp, e8Var.O);
                canvas.save();
                path.rewind();
