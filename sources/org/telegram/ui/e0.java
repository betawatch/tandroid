    ...
    public final boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (this.a) {
            case 0:
                j4 j4Var = (j4) this.b;
                j4Var.getClass();
                if (motionEvent.getActionMasked() == 0 && (p1Var = j4Var.H) != null && p1Var.isShowing()) {
                    view.getHitRect(j4Var.C0);
                    if (!j4Var.C0.contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
                        j4Var.H.d(true);
                        break;
                    }
                }
            ...
            case 6:
                ...
                l71Var.getClass();
                if (motionEvent.getAction() == 0 && (runnable = l71Var.T1) != null) {
                    runnable.run();
                    break;
                }
                break;
            default:
                ...
                if (pe1Var.S != null && motionEvent.getAction() == 0) {
                    Drawable backgroundDrawable2 = ((ActionBarPopupWindow$ActionBarPopupWindowLayout) pe1Var.S).getBackgroundDrawable();
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    rectF2.set(backgroundDrawable2.getBounds());
                    rectF2.offset(pe1Var.S.getX(), pe1Var.S.getY());
