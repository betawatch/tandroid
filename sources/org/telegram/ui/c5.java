...
public abstract class c5 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public c5(Context context, org.telegram.ui.ActionBar.c6 c6Var, v4 v4Var) {
        ...
        cg.l1 l1Var = gf.r0.a;
        u4Var.setOutlineProvider(new gf.q0(0, dp));
        ...
        lg.d w10 = bVar.w();
        w10.n(null);
        jVar.d(actionBarPopupWindow$ActionBarPopupWindowLayout, this, new ag.h0(29, w10, actionBarPopupWindow$ActionBarPopupWindowLayout), false);
        w10.n(ng.c.j(c6Var));
        w10.o(AndroidUtilities.dp(8.0f));
        w10.h.e = true;
        w10.p(AndroidUtilities.dp(12.0f));
        actionBarPopupWindow$ActionBarPopupWindowLayout.setBackground(w10);
    ...
    public final void a(x4 x4Var) {
        ...
        while (true) {
            ...
            c10.setOnClickListener(new nh.x1(12, this, d5Var));
            i11++;
    ...
    public final void b(final boolean z10) {
        ...
        ofFloat.setInterpolator(z10 ? this.a : org.telegram.ui.Components.er.h);
        final int i10 = 0;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (i10) {
                    case 0:
                        ...
                        float a2 = h7.n.a(floatValue, 0.0f, 1.0f);
                        float f10 = (0.3f * floatValue) + 0.7f;
                        n0Var.setScaleX(f10);
                        n0Var.setScaleY(f10);
                        n0Var.setAlpha(a2);
                        float f11 = 1.0f - floatValue;
                        c5Var.c.setTranslationY(AndroidUtilities.dp(40.0f) * f11);
        ...
        this.n.addListener(new ag.x(21, this, z10));
        this.n.start();
    }
