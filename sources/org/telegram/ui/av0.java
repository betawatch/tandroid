...
public abstract class av0 {
    public final View i;
    public boolean p;
    public final org.telegram.ui.Components.vq q;
    ...
    public av0(PhotoViewer photoViewer, View view) {
        ...
        while (true) {
            ...
            if (i10 >= fArr.length) {
                ...
                this.r = pg0Var;
                pg0Var.h = 200;
                this.q = new org.telegram.ui.Components.vq(photoViewer.y.getDrawable(R.drawable.circle_big).mutate(), pg0Var);
                return;
            }
            this.m[i10] = 1.0f;
            fArr[i10] = 1.0f;
    ...
    public final void c(Canvas canvas) {
        ...
        if (i14 >= 0) {
            ...
            if (i14 < drawableArr2.length + 2) {
                ...
                if (drawable != null) {
                    if (this.k != -2) {
                        drawable.setAlpha((int) org.telegram.messenger.a2.A(1.0f, this.l, 255.0f, f10));
                    } else {
