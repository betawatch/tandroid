...
public final class l81 extends org.telegram.ui.Components.xa {
    ...
    public l81(final Context context, final int i10, final org.telegram.ui.ActionBar.c6 c6Var, final tm tmVar) {
        ...
        jh.b bVar = new jh.b(context, i10, kf.b.b, c6Var);
        this.T = bVar;
        bVar.setScaleX(0.6f);
        bVar.setScaleY(0.6f);
        bVar.setAlpha(0.0f);
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            a1.d dVar = new a1.d(context, new int[]{i12, i13, i14, i15, i16, i17, i17}, c6Var, hz0Var, 19);
            ...
            TextView b13 = i7.j6.b(context, 14.0f, org.telegram.ui.ActionBar.g6.y6, false, null);
            b13.setGravity(17);
            ...
            Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.h81
            ...
            for (int i18 = 0; i18 < Utilities.divCeil(jArr.length, 3); i18++) {
                ...
                while (true) {
                    ...
                    if (i19 < Math.min(3, jArr.length - i20)) {
                        g10.addView((View) callbackReturn.run(Long.valueOf(jArr[i20 + i19])), i7.f6.p(0, 26, 1.0f, 112, 0, 0, i19 == 2 ? 0 : 6, 0));
                        i19++;
                    }
                }
            ...
            dVar2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.i81
                ...
                public final void onClick(View view) {
                    ...
                    try {
                        ...
                        if (parseDouble > d) {
                            ...
                            int i22 = -iArr2[0];
                            iArr2[0] = i22;
                            AndroidUtilities.shakeViewSpring(uc0Var2, i22);
                            return;
                        }
                        if (TextUtils.isEmpty(text) || parseDouble >= MessagesController.getInstance(i21).tonStakeddiceStakeAmountMin / 1.0E9d) {
                            if (jh.s7.y(i21, true).f.toDouble() < parseDouble) {
                                new oh.f(context, c6Var, kf.a.i((long) (parseDouble * 1.0E9d), kf.b.b), true, new ef0(7));
                                return;
                            } else {
                        ...
                        int i23 = -iArr2[0];
                        iArr2[0] = i23;
                        AndroidUtilities.shakeViewSpring(uc0Var2, i23);
            ...
            viewGroup.addView(frameLayout, i7.f6.f(-2.0f, 87, i21, 0, i21, 0));
            org.telegram.ui.Components.jl0 jl0Var = this.d;
            int i22 = this.backgroundPaddingLeft;
            jl0Var.setPadding(i22, 0, i22, AndroidUtilities.dp(68.0f));
            this.Y.N(false);
        }
    }
