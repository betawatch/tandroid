...
public final class b51 extends Dialog {
    ...
    public final void d() {
        ...
        if (u1Var != null) {
            ...
            i0.b bVar2 = this.e;
            this.G = org.telegram.messenger.f0.x(((height - bVar2.b) - bVar2.d) - this.O.getHeight(), this.K, 2.0f, f10);
            if (!this.J) {
                this.J = true;
    ...
    public final void dismiss() {
        ...
        org.telegram.ui.ActionBar.a2 a2Var = this.c0;
        if (a2Var != null) {
            a2Var.dismiss();
            this.c0 = null;
        }
