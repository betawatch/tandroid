...
public final class z41 extends org.telegram.ui.Cells.u1 {
        ...
        if (paint != null) {
            ...
            if (f7 > 0.0f) {
                if (b51Var.Q) {
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Qe.e(b51Var.Q), 1.0f - b51Var.s));
    ...
    public final void d2(Canvas canvas, float f7, Integer num) {
        ...
        int i10 = -this.N.c;
        b51 b51Var = this.Te;
        canvas.translate(AndroidUtilities.lerp(0, i10, b51Var.s), AndroidUtilities.lerp(b51Var.O.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), r0.p, b51Var.s));
        super.d2(canvas, (1.0f - b51Var.s) * f7, num);
        canvas.restore();
    }
    ...
    public final void m2(float f7, Canvas canvas, boolean z10) {
        ...
        if (b51Var.S) {
            ...
            canvas.translate(((this.Ie.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.rb) * b51Var.s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, b51Var.s, rectF);
            U3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (b51Var.s <= 0.0f || !b51Var.Q) {
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            }
            this.we = 1.0f - b51Var.s;
        } else {
            canvas2 = canvas;
        }
        S1(canvas2);
        if (b51Var.S && b51Var.s > 0.0f && b51Var.Q) {
            canvas2.restore();
        }
    }
