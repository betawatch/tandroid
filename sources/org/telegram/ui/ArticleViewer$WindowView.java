...
class ArticleViewer$WindowView extends FrameLayout {
        ...
        if (m4Var.r0 == null && !m4Var.P0 && m4Var.L.getVisibility() != 0 && !m4Var.K0.y()) {
            if (motionEvent != null && motionEvent.getAction() == 0 && !this.d && !this.c) {
                ...
                if (this.d) {
                    ...
                    float x8 = (z10 || z3Var == null) ? view.getX() : z3Var.E * z3Var.c.getWidth();
                    ...
                    animatorSet.setDuration(Math.max((int) ((420.0f / view.getMeasuredWidth()) * x8), MediaDataController.MAX_LINKS_COUNT));
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        org.telegram.ui.Cells.v9 o10 = m4Var.K0.o(getContext());
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (m4Var.G == null) {
            ...
            canvas.drawRect(this.v, 0.0f, f11, measuredHeight, m4Var.h0);
            ...
            if (windowInsets != null) {
                ...
                if (m4Var.Q) {
                    ...
                    if (windowInsets.getSystemWindowInsetRight() != 0) {
                        ...
                        canvas.drawRect(0.0f, r9 - windowInsets.getStableInsetBottom(), f10, measuredHeight, m4Var.u0);
                    }
                }
                f10 = f11;
                canvas.drawRect(0.0f, r9 - windowInsets.getStableInsetBottom(), f10, measuredHeight, m4Var.u0);
    ...
    public void setInnerTranslationX(float f10) {
        ...
        gf.t0 t0Var = m4Var.Q0;
        if (t0Var != null) {
            t0Var.a(m4Var.R && this.w == 1.0f && f10 == 0.0f);
        }
        invalidate();
    }
}
