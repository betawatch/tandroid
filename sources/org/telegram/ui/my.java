...
public final class my extends org.telegram.ui.Components.ia implements ai.s9 {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f16 > 0.0f) {
            canvas2.clipRect(0, 0, AndroidUtilities.lerp(getMeasuredWidth(), AndroidUtilities.dp(d41.getRightPaddingSize()), this.i3), getMeasuredHeight());
            ...
            canvas2 = canvas;
            canvas2.drawRect(AndroidUtilities.dp(d41.getRightPaddingSize()), 0.0f, AndroidUtilities.dp(d41.getRightPaddingSize()) - 1, getMeasuredHeight(), org.telegram.ui.ActionBar.h6.k0);
        ...
        qy qyVar2 = this.u3;
        float f17 = qyVar2.E ? 0.0f : qyVar2.N;
        ...
        while (i20 < getChildCount()) {
            ...
            if (childAt2 instanceof org.telegram.ui.Cells.s2) {
                ...
                if (AndroidUtilities.isTablet()) {
                    paint2 = paint;
                    s2Var4.setDialogSelected(s2Var4.getDialogId() == qyVar2.p2.dialogId);
                } else {
                    paint2 = paint;
                }
                ...
                if (this.d3 && s2Var4.b0(0, true) && (R = RecyclerView.R(s2Var4)) >= 0) {
                    getAdapter().m(R);
                }
                if (s2Var4.getDialogId() == qyVar.F3.getCurrentFragmetDialogId()) {
                    s2Var3 = s2Var4;
                    s2Var = s2Var3;
                } else {
                    s2Var = s2Var4;
        ...
        if (this.s3 == null) {
            i10 = ((org.telegram.ui.ActionBar.m2) qyVar3).currentAccount;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (L0 != -1 && pyVar.e.y == 0 && pyVar.c.y < 0 && pyVar.a.getScrollState() != 1) {
            ...
            if (K != null) {
                ...
                this.f3 = true;
                pyVar.c.h1(L0, (int) ((top - this.h3) + qyVar.x3 + 0));
                this.f3 = false;
            }
        } else if (L0 == -1 && this.e3) {
            pyVar.c.h1((pyVar.s == 0 && qyVar.Z3()) ? 1 : 0, (int) qyVar.N);
        }
        this.f3 = true;
        ...
        this.f3 = false;
        if (this.e3 && qyVar.getMessagesController().dialogsLoaded) {
        ...
        if (qyVar.l2 || dp2 == 0 || (pyVarArr = qyVar.e0) == null || pyVarArr.length <= 1 || qyVar.l3 || (animatorSet = qyVar.f3) == null) {
            return;
        }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 1 || action == 3) {
            ...
            if (yVar.y != 0) {
                ...
                if (oyVar.e) {
                    oyVar.f = true;
                    if (yVar.g(null, 4) != 0 && (c1Var = pyVar.f.d) != null) {
                        View view = c1Var.a;
                                    ...
                                    if (ChatObject.isCommunity(qyVar.getMessagesController().getChat(Long.valueOf(-dialogId)))) {
                                        ...
                                        if (SharedConfig.getChatSwipeAction(i10) == 1) {
                                            ...
                                            if (SharedConfig.getChatSwipeAction(i11) != 3) {
                                                ...
                                                qyVar.O2 = !MessagesController.getInstance(i14).isDialogMuted(dialogId, 0L) ? 1 : 0;
                                                qyVar.P2 = qyVar.O2 > 0 ? 0 : 1;
        ...
        if (pyVar.s == 0 && ((action == 1 || action == 3) && pyVar.v == 2 && qyVar.Z3() && ((s4.c0) getLayoutManager()).L0() == 0)) {
            int paddingTop = getPaddingTop();
            ...
            if (Q3 != null) {
                ...
                long currentTimeMillis = System.currentTimeMillis() - qyVar.c3;
        ...
        if (s2Var != null) {
            if (ixVar != null) {
                ...
                if (F >= 0) {
                    ...
                    ((s4.c0) ixVar.getLayoutManager()).h1(F, top);
                }
            }
