        ...
        switch (i10) {
            ...
            case 3:
                if (!launchActivity.q0.getFragmentStack().isEmpty()) {
                    launchActivity.q0.getFragmentStack().get(0).showDialog(new org.telegram.ui.Components.wx0(launchActivity, launchActivity.j0, launchActivity.h0, launchActivity.i0));
                    break;
                }
                break;
            case 4:
            ...
            case 6:
                if (!launchActivity.v1) {
                    try {
                        ...
                        C.setOnDismissListener(new j90(launchActivity, i11));
