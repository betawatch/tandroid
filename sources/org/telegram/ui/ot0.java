...
public final class ot0 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        if (i10 == 1) {
            ...
            photoViewer.e0.post(new gl0(17, this, photoViewer.N1));
            photoViewer.N1 = null;
        ...
        photoViewer.o6 = -1;
        photoViewer.e0.invalidate();
        zu0 zu0Var = photoViewer.i7;
        if (zu0Var != null) {
            PhotoViewer photoViewer2 = zu0Var.d;
            photoViewer2.d = zu0Var.c;
            ...
            int i12 = zu0Var.a;
            photoViewer2.Y1(null, null, null, null, arrayList, null, null, i12, zu0Var.c.E((MessageObject) arrayList.get(i12), null, zu0Var.a, true, false));
            photoViewer.i7 = null;
            eu0 eu0Var = new eu0();
            eu0Var.c = false;
        ...
        if (photoViewer.i2) {
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.Q1, (Property<ku0, Float>) property, 0.0f));
        }
        ...
        if (photoViewer.f1.getTag() != null) {
            photoViewer.f1.setVisibility((!photoViewer.d2 && photoViewer.J4 && ((uu0Var = photoViewer.d) == null || uu0Var.N())) ? 0 : 8);
        ...
        if (photoViewer.g1.getTag() != null) {
            ...
            arrayList2.add(ObjectAnimator.ofFloat(photoViewer.g1, (Property<ss0, Float>) property2, 1.0f));
        }
        ...
        animatorSet.addListener(new nt0(this, i11));
        animatorSet.start();
    }
}
