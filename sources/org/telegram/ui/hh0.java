...
public final class hh0 extends org.telegram.ui.Components.f6 {
    ...
    public hh0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.L = kVar2;
        kVar.u = org.telegram.ui.Cells.r6.l(1.0f, 1500.0f, 0.75f);
    ...
    public static void m(hh0 hh0Var, float f7, boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                if (childAt3.getVisibility() == 0 && (childAt3 instanceof nh.b) && ((nh.b) childAt3).h.f) {
                    view2 = childAt3;
                    break;
                }
                i12++;
        ...
        if (view != null) {
            ...
            for (int i13 = 0; i13 < childCount2; i13++) {
                ...
                if (childAt4 instanceof nh.b) {
                    ((nh.b) childAt4).e(childAt4 == view, true);
                }
            }
            if (z11) {
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            ...
            ((nh.b) ((org.telegram.ui.Components.e6) n10.a).a).setVisualWidth(n10.b().width());
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < childCount3; i18++) {
            ...
            if (childAt2 instanceof gh0) {
                ((nh.b) ((gh0) childAt2)).setTextSizeDp(f14);
            }
        }
