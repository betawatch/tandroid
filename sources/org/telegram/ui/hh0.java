...
public final class hh0 extends FrameLayout {
    ...
    public final int a(float f10, int i10) {
        ...
        if (f10 > 0.5f) {
            return i0.b.d(1.0f - ((f10 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.na, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.oa, false));
        }
        return i0.b.d(1.0f - (f10 / 0.5f), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.oa, false), org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.ka, false));
    }
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            SpannableStringBuilder X0 = hh.oa.X0(false, i0.a.m(tL_chatInviteExported.subscription_pricing.amount, ',', new StringBuilder("⭐️ ")), 0.75f, null);
            ...
            dp = AndroidUtilities.dp(28.0f) + ((int) Math.max(lh.w3.g(textView.getText(), textView.getPaint()), lh.w3.g(textView2.getText(), textView2.getPaint())));
        } else {
        ...
        if (!isEmpty) {
            ...
            i11 = ((org.telegram.ui.ActionBar.n2) kh0Var).currentAccount;
            ...
            if (i15 > 0 && i14 == 0 && !tL_chatInviteExported.expired && !tL_chatInviteExported.revoked) {
                ...
                if (tL_chatInviteExported.requested > 0) {
                    if (tL_chatInviteExported.usage > 0) {
                        formatPluralString = s3.c.l(formatPluralString, ", ");
                    }
                    StringBuilder o10 = com.google.android.recaptcha.internal.a.o(formatPluralString);
                    o10.append(LocaleController.formatPluralString("JoinRequests", tL_chatInviteExported.requested, new Object[0]));
                    formatPluralString = o10.toString();
                }
            }
        }
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((kh0Var.j0 * 1000) + System.currentTimeMillis());
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            psVar4.b = AndroidUtilities.dp(1.5f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z11 || tL_chatInviteExported2.revoked) {
            ...
            if (i12 > 0 || tL_chatInviteExported2.usage_limit > 0) {
                if (i12 > 0) {
                    long currentTimeMillis = (kh0Var.j0 * 1000) + System.currentTimeMillis();
        ...
        int d = this.A != 1.0f ? i0.b.d(this.A, a(f12, this.y), a(f12, i10)) : a(f12, i10);
        Paint paint = this.s;
        paint.setColor(d);
        ...
        if (!z12) {
            ...
            if (tL_chatInviteExported.subscription_pricing == null) {
                kh0Var.W.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                kh0Var.W.draw(canvas2);
            } else if (tL_chatInviteExported.revoked) {
                kh0Var.V.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                kh0Var.V.draw(canvas2);
            } else {
                kh0Var.U.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
        ...
        z10 = ((org.telegram.ui.ActionBar.n2) kh0Var).isPaused;
        if (!z10) {
            invalidate();
        }
        this.B = f15;
