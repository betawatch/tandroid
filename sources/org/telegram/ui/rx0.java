    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i24 == 0) {
            ...
            faVar.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.h6.G6));
            if (i10 == privacyControlActivity.S) {
                ...
                if (i23 == 10) {
                    faVar.c(LocaleController.getString(R.string.PrivateMessagesExceptions), formatPluralString, false, false);
                } else if (i23 == 0 || i23 == 4 || i23 == 9 || i23 == 14) {
                    faVar.c(LocaleController.getString(R.string.AlwaysShareWith), formatPluralString, false, privacyControlActivity.T != -1);
                } else {
                    faVar.c(LocaleController.getString(R.string.AlwaysAllow), formatPluralString, false, privacyControlActivity.T != -1);
                }
                if (i23 == 12) {
                    faVar.setEnabled(!privacyControlActivity.u0());
                    return;
                }
                return;
            }
            if (i10 != privacyControlActivity.T) {
                if (i10 == privacyControlActivity.b0) {
                    ...
                    faVar.c(LocaleController.getString(R.string.PrivacyP2P2), ContactsController.getInstance(i11).getLoadingPrivacyInfo(3) ? LocaleController.getString(R.string.Loading) : PrivacySettingsActivity.x0(3, privacyControlActivity.getAccountInstance()), false, false);
                    return;
                } else {
                    if (i10 == privacyControlActivity.e0) {
                        faVar.b(LocaleController.getString(privacyControlActivity.getUserConfig().isPremium() ? R.string.PrivacyLastSeenPremiumForPremium : R.string.PrivacyLastSeenPremium), false);
                        faVar.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.h6.n6));
                        return;
                    }
                    return;
                }
            ...
            if (i23 == 0 || i23 == 4 || i23 == 9 || i23 == 14) {
                faVar.c(LocaleController.getString(R.string.NeverShareWith), formatPluralString2, false, false);
            } else {
                faVar.c(LocaleController.getString(R.string.NeverAllow), formatPluralString2, false, false);
            }
            if (i23 == 12) {
                faVar.setEnabled(!privacyControlActivity.u0());
                return;
        ...
        if (i24 == 1) {
            ...
            if (i10 == privacyControlActivity.Q) {
                ...
                if (i10 == i34 && i23 == 10) {
                    ...
                    f9Var.setText(AndroidUtilities.replaceSingleTag(string, new Runnable(this) { // from class: org.telegram.ui.ox0
                    ...
                    if (i10 == i12) {
                        f9Var.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.PrivacyBirthdaySet), new Runnable(this) { // from class: org.telegram.ui.ox0
                            public final /* synthetic */ rx0 b;
                        ...
                        if (i23 == 6) {
                            if (privacyControlActivity.I == 1 && privacyControlActivity.J == 1) {
                                ...
                                String i36 = org.telegram.ui.Cells.q3.i("https://t.me/+", privacyControlActivity.getUserConfig().getClientPhone());
                                SpannableString spannableString = new SpannableString(i36);
                                spannableString.setSpan(new qx0(this, i36), 0, i36.length(), 33);
                        ...
                        f9Var.setText(LocaleController.formatString(R.string.PrivateMessagesPriceInfo, ei.l.G0(privacyControlActivity.getMessagesController().starsPaidMessageCommissionPermille), String.valueOf(((int) (((privacyControlActivity.L * (privacyControlActivity.getMessagesController().starsPaidMessageCommissionPermille / 1000.0f)) / 1000.0d) * privacyControlActivity.getMessagesController().starsUsdWithdrawRate1000)) / 100.0d)));
        ...
        if (i24 != 3) {
            if (i24 != 8) {
                ...
                if (i10 == i22) {
                    ...
                    nl0 nl0Var = new nl0(this, i25);
                    org.telegram.ui.Cells.z7 z7Var = new org.telegram.ui.Cells.z7();
                    z7Var.c = a2;
                    z7Var.d = 20;
                    z7Var.e = nl0Var;
                    a8Var.d((int) Utilities.clamp(privacyControlActivity.L, privacyControlActivity.getMessagesController().starsPaidMessageAmountMax, 1L), z7Var, new px0(this, r8 ? 1 : 0));
                    return;
                }
                return;
            }
        ...
        if (i10 != i14 && i10 != privacyControlActivity.O) {
            ...
            if (i10 != i19 && i10 != privacyControlActivity.g0) {
                if (i10 == privacyControlActivity.X) {
                    k6Var.c(LocaleController.getString(R.string.LastSeenContacts), privacyControlActivity.J == 1, false);
                } else if (i10 == privacyControlActivity.W) {
                    k6Var.c(LocaleController.getString(R.string.LastSeenEverybody), privacyControlActivity.J == 0, true);
                }
                if (i23 != 12) {
                    k6Var.b(null, !privacyControlActivity.u0());
                    return;
                }
                return;
            }
        ...
        if (i10 == i15) {
            if (i23 == 3) {
                k6Var.c(LocaleController.getString(R.string.P2PEverybody), privacyControlActivity.I == 0, true);
            } else {
                k6Var.c(LocaleController.getString(R.string.LastSeenEverybody), privacyControlActivity.I == 0, true);
            }
            ...
            if ((i23 == 8 && !privacyControlActivity.getUserConfig().isPremium()) || (i23 == 10 && !privacyControlActivity.getMessagesController().newNoncontactPeersRequirePremiumWithoutOwnpremium && !privacyControlActivity.getUserConfig().isPremium())) {
                k6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            if (i23 == 3) {
                ...
                k6Var.c(string2, z10, (i18 == -1 && privacyControlActivity.g0 == -1) ? false : true);
            } else if (i23 == 10) {
                ...
                k6Var.c(string3, z11, (i17 == -1 && privacyControlActivity.g0 == -1) ? false : true);
            } else {
                ...
                k6Var.c(string4, z12, (i16 == -1 && privacyControlActivity.g0 == -1) ? false : true);
            }
        } else if (i10 == privacyControlActivity.g0) {
            if (i23 == 10 && !privacyControlActivity.getUserConfig().isPremium()) {
                k6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            k6Var.c(LocaleController.getString(R.string.PrivateMessagesChargePrice), privacyControlActivity.I == 3, false);
        } else {
            if ((i23 == 8 && !privacyControlActivity.getUserConfig().isPremium()) || (i23 == 10 && !privacyControlActivity.getMessagesController().newNoncontactPeersRequirePremiumWithoutOwnpremium && !privacyControlActivity.getUserConfig().isPremium())) {
                k6Var.setRadioIcon(privacyControlActivity.getParentActivity().getResources().getDrawable(R.drawable.mini_switch_lock).mutate());
            }
            if (i23 == 3) {
                k6Var.c(LocaleController.getString(R.string.P2PNobody), privacyControlActivity.I == 1, false);
            } else {
                k6Var.c(LocaleController.getString(R.string.LastSeenNobody), privacyControlActivity.I == 1, false);
            }
        }
        if (i23 != 12) {
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 6:
                ...
                privacyControlActivity.t0 = new org.telegram.ui.Components.yi0(R.raw.camera_outline, AndroidUtilities.dp(50.0f), AndroidUtilities.dp(50.0f), false, null);
            ...
            case 7:
                ...
                privacyControlActivity.w0 = new ls(this, privacyControlActivity.getParentActivity());
                ...
                privacyControlActivity.w0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.K0(false));
                ls lsVar = privacyControlActivity.w0;
