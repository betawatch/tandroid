...
public final class ao0 implements TextWatcher {
    public boolean a;
    public String b;
    public boolean c;
    public int d;
    ...
    public final /* synthetic */ yo0 n;

    public ao0(yo0 yo0Var) {
        this.n = yo0Var;
    }
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        int a2 = a(str);
        boolean z10 = a2 >= 0;
        int currencyExpDivider = LocaleController.getCurrencyExpDivider(yo0Var.C0.invoice.currency);
        ...
        yo0Var.H0 = valueOf;
        if (yo0Var.C0.invoice.max_tip_amount != 0) {
            long longValue4 = valueOf.longValue();
            long j3 = yo0Var.C0.invoice.max_tip_amount;
            if (longValue4 > j3) {
                yo0Var.H0 = Long.valueOf(j3);
            }
        }
        int selectionStart = yo0Var.f[0].getSelectionStart();
        yo0Var.m0 = true;
        if (yo0Var.H0.longValue() == 0) {
            yo0Var.f[0].setText("");
        } else {
            EditTextBoldCursor editTextBoldCursor = yo0Var.f[0];
            str2 = LocaleController.getInstance().formatCurrencyString(yo0Var.H0.longValue(), false, z10, true, yo0Var.C0.invoice.currency);
            editTextBoldCursor.setText(str2);
        }
        if (longValue < yo0Var.H0.longValue() && longValue != 0 && this.a && selectionStart >= 0) {
            EditTextBoldCursor editTextBoldCursor2 = yo0Var.f[0];
            editTextBoldCursor2.setSelection(Math.min(selectionStart, editTextBoldCursor2.length()));
        } else if (this.c && this.d != yo0Var.f[0].length()) {
            EditTextBoldCursor editTextBoldCursor3 = yo0Var.f[0];
            editTextBoldCursor3.setSelection(Math.max(0, Math.min(selectionStart, editTextBoldCursor3.length())));
        } else if (this.f || !z10 || a2 < 0) {
            EditTextBoldCursor editTextBoldCursor4 = yo0Var.f[0];
            editTextBoldCursor4.setSelection(editTextBoldCursor4.length());
        } else {
            int a10 = a(str2);
            if (a10 > 0) {
                yo0Var.f[0].setSelection(a10 + 1);
            } else {
                EditTextBoldCursor editTextBoldCursor5 = yo0Var.f[0];
