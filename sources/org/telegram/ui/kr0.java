...
public final /* synthetic */ class kr0 implements Runnable {
    ...
    public /* synthetic */ kr0(ks0 ks0Var, int[] iArr, int[] iArr2, boolean z10, boolean z11, boolean z12) {
        this.e = ks0Var;
        this.f = iArr;
        this.h = iArr2;
        this.b = z10;
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                photoViewer.d = new wt0(photoViewer, photoViewer.d, messageObject, orientation, this.c, this.d);
                photoViewer.p1.l();
    ...
    public /* synthetic */ kr0(PhotoViewer photoViewer, File file, boolean z10, MessageObject messageObject, boolean z11, boolean z12) {
        this.e = photoViewer;
        this.f = file;
        this.b = z10;
