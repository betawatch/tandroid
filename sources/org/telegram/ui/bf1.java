...
public final class bf1 extends org.telegram.ui.ActionBar.o2 {
    ...
    public static bf1 a0(long j3, long j10) {
        ...
        bf1Var.h = new org.telegram.ui.Components.u9[2];
        bf1Var.n = "";
    ...
    public final void b0(Long l4, boolean z10) {
        ...
        if (longValue != 0) {
            ...
            o5Var.setColorFilter(org.telegram.ui.ActionBar.j6.v3);
            ...
            u9VarArr[1].setImageDrawable(this.s);
    ...
    public final View createView(Context context) {
        ...
        for (int i12 = 0; i12 < 2; i12++) {
            ...
            u9VarArr[i12] = u9Var;
            ze1Var.addView(u9Var, w7.x5.e(28, 28, 17));
        }
        frameLayout.addView(ze1Var, w7.x5.d(40, 40.0f, 16, 10.0f, 0.0f, 0.0f, 0.0f));
        ...
        if (tL_forumTopic2 == null || tL_forumTopic2.id != 1) {
            ...
            u9VarArr[0].setImageDrawable(this.s);
            ...
            this.x.d.add(u9VarArr[0]);
            this.x.d.add(u9VarArr[1]);
        } else {
