...
public abstract class na extends FrameLayout {
    ...
    public final org.telegram.ui.Components.sp e;
    public final org.telegram.ui.Components.q6 f;
    ...
    public na(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.a = false;
        this.y = new org.telegram.ui.Components.e6(this, 300L, org.telegram.ui.Components.pr.f);
        ...
        this.d = imageView;
        org.telegram.ui.Components.sp spVar = new org.telegram.ui.Components.sp(AndroidUtilities.dp(7.0f), AndroidUtilities.dp(1.35f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.n6, f6Var));
        this.e = spVar;
        ...
        q6Var.b(0.4f, 120L, org.telegram.ui.Components.pr.g);
    ...
    public final void a(TLRPC.TL_username tL_username, boolean z10, boolean z11, long j3) {
        ...
        boolean z12 = this.a;
        org.telegram.ui.Components.q6 q6Var = this.f;
        if (z12) {
            q6Var.c(LocaleController.getString(this.H ? R.string.UsernameProfileLinkEditable : this.G ? R.string.UsernameProfileLinkActive : R.string.UsernameProfileLinkInactive), z11, !this.G);
        } else {
            q6Var.c(LocaleController.getString(this.H ? R.string.UsernameLinkEditable : this.G ? R.string.UsernameLinkActive : R.string.UsernameLinkInactive), z11, !this.G);
        }
        ...
        if (z11) {
            ...
            this.F.setInterpolator(org.telegram.ui.Components.pr.g);
            this.F.start();
            return;
        }
    ...
    public void setLoading(boolean z10) {
        if (this.r != z10) {
            ...
            this.s = ofFloat;
            ofFloat.addUpdateListener(new ma(this, i10));
            this.s.addListener(new ah.q0(27, this, z10));
