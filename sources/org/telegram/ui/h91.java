...
public final class h91 extends LinearLayout {
    public final org.telegram.ui.ActionBar.f1[] a;

    public h91(ContextThemeWrapper contextThemeWrapper, final rr0 rr0Var) {
        ...
        c10.c(-328966, -328966);
        final int i10 = 0;
        c10.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.g91
            ...
            public final void onClick(View view) {
                ...
                switch (i11) {
                    case 0:
                        PhotoViewer photoViewer = rr0Var2.a;
                        Drawable[] drawableArr = PhotoViewer.U8;
                        photoViewer.D0(true, true, 0.2f);
                        break;
                    case 1:
                        PhotoViewer photoViewer2 = rr0Var2.a;
                        Drawable[] drawableArr2 = PhotoViewer.U8;
                        photoViewer2.D0(true, true, 0.5f);
                        break;
                    case 2:
                        PhotoViewer photoViewer3 = rr0Var2.a;
                        Drawable[] drawableArr3 = PhotoViewer.U8;
                        photoViewer3.D0(true, true, 1.0f);
                        break;
                    case 3:
                        PhotoViewer photoViewer4 = rr0Var2.a;
                        Drawable[] drawableArr4 = PhotoViewer.U8;
                        photoViewer4.D0(true, true, 1.5f);
                        break;
                    default:
                        PhotoViewer photoViewer5 = rr0Var2.a;
        ...
        c11.c(-328966, -328966);
        final int i11 = 1;
        c11.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.g91
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i11;
                rr0 rr0Var2 = rr0Var;
        ...
        c12.c(-328966, -328966);
        final int i12 = 2;
        c12.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.g91
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i12;
                rr0 rr0Var2 = rr0Var;
        ...
        c13.c(-328966, -328966);
        final int i13 = 3;
        c13.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.g91
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i13;
                rr0 rr0Var2 = rr0Var;
        ...
        c14.c(-328966, -328966);
        final int i14 = 4;
        c14.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.g91
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i14;
                rr0 rr0Var2 = rr0Var;
        ...
        View r41Var = new r41(contextThemeWrapper, 2);
        r41Var.setMinimumWidth(AndroidUtilities.dp(196.0f));
        r41Var.setBackgroundColor(-15198184);
        addView(r41Var);
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) r41Var.getLayoutParams();
