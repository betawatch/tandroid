...
public final class qr extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(qr qrVar, long j3) {
        if (j3 != 0) {
            qrVar.N = j3;
            qrVar.r = MessagesController.getInstance(qrVar.currentAccount).getChat(Long.valueOf(j3));
            qrVar.u0();
        }
    }
    ...
    */
    public static void V(final qr qrVar, View view, int i10) {
        ...
        i14 = 0;
        final int i15 = 1;
        boolean z15 = qrVar.c.getAdapter() == qrVar.a;
        if (i10 == qrVar.h1) {
            boolean z16 = !qrVar.v1;
            qrVar.v1 = z16;
            ...
            qrVar.A0(w02);
            qrVar.a.m(qrVar.j1);
        } else if (i10 == qrVar.i1) {
            boolean z17 = !qrVar.w1;
            qrVar.w1 = z17;
            ...
            if (qrVar.p0(i10)) {
                ...
                if (i10 == qrVar.V) {
                    qrVar.E.send_photos = !r15.send_photos;
                } else if (i10 == qrVar.W) {
                    qrVar.E.send_videos = !r14.send_videos;
                } else if (i10 == qrVar.X) {
                    ...
                    qrVar.E.send_audios = !r14.send_audios;
                } else if (i10 == qrVar.Z) {
                    qrVar.E.send_docs = !r14.send_docs;
                } else if (i10 == qrVar.a0) {
                    qrVar.E.send_voices = !r14.send_voices;
                } else if (i10 == qrVar.b0) {
                    qrVar.E.send_roundvideos = !r14.send_roundvideos;
                } else if (i10 == qrVar.c0) {
                    if (qrVar.E.send_plain && (m10 = qrVar.d.m(qrVar.T)) != null) {
                        AndroidUtilities.shakeViewSpring(m10);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        qrVar.E.embed_links = !r14.embed_links;
                    }
                } else if (i10 == qrVar.d0) {
                    qrVar.E.send_polls = !r14.send_polls;
                } else if (i10 == qrVar.k0) {
                    qrVar.E.send_reactions = !r14.send_reactions;
                }
                ...
                if (i10 == qrVar.z0) {
                    if (i13 == 0 || i13 == 3) {
                        ...
                        qr qrVar2 = new qr(bundle);
                        qrVar2.x0(qrVar.s);
                        TLRPC.TL_chatBannedRights tL_chatBannedRights3 = qrVar.E;
                        if (tL_chatBannedRights3 != null) {
                            qrVar2.E = tL_chatBannedRights3;
                        }
                        qrVar2.m1 = new er(qrVar);
                        qrVar.presentFragment(qrVar2);
                        return;
                    }
                    if (i13 == 1) {
                        Bundle bundle2 = new Bundle();
                        bundle2.putLong("chat_id", qrVar.N);
                        bundle2.putInt(TeXSymbolParser.TYPE_ATTR, 2);
                        bundle2.putInt("selectType", 1);
                        qr qrVar3 = new qr(bundle2);
                        qrVar3.m1 = new fr(qrVar);
                        qrVar3.x0(qrVar.s);
                        qrVar.presentFragment(qrVar3);
                        return;
                    }
                    if (i13 == 2) {
                        Bundle i16 = a4.a.i("addToGroup", true);
                        i16.putLong(z14 ? "channelId" : "chatId", qrVar.r.id);
                        b70 b70Var = new b70(i16);
                        b70Var.I = qrVar.s;
                        if (iVar2 != null && iVar2.m() != 0) {
                            iVar = iVar2;
                        }
                        b70Var.J = iVar;
                        b70Var.x = new hr(qrVar, b70Var);
                        qrVar.presentFragment(b70Var);
                        return;
                    }
                    return;
                }
                if (i10 == qrVar.v0) {
                    qrVar.presentFragment(new ub(qrVar.r));
                    return;
                }
                if (i10 == qrVar.x0) {
                    final org.telegram.ui.Cells.s8 s8Var = (org.telegram.ui.Cells.s8) view;
                    TLRPC.ChatFull chatFull3 = qrVar.s;
                    if (chatFull3 != null && !chatFull3.antispam && qrVar.l0() < qrVar.getMessagesController().telegramAntispamGroupSizeMin) {
                        org.telegram.ui.Components.xc.a0(qrVar).Q(R.raw.msg_antispam, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelAntiSpamForbidden", qrVar.getMessagesController().telegramAntispamGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (qrVar.s == null || !ChatObject.canUserDoAdminAction(qrVar.r, 13) || qrVar.w0) {
                        return;
                    }
                    qrVar.w0 = true;
                    final boolean z21 = qrVar.s.antispam;
                    TLRPC.TL_channels_toggleAntiSpam tL_channels_toggleAntiSpam = new TLRPC.TL_channels_toggleAntiSpam();
                    tL_channels_toggleAntiSpam.channel = qrVar.getMessagesController().getInputChannel(qrVar.N);
                    ...
                    qrVar.getConnectionsManager().sendRequest(tL_channels_toggleAntiSpam, new RequestDelegate(qrVar) { // from class: org.telegram.ui.pq
                        ...
                        public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                            switch (i14) {
                                case 0:
                                    final qr qrVar4 = this.b;
                                    if (tLObject3 != null) {
                                        qrVar4.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        qrVar4.getMessagesController().putChatFull(qrVar4.s);
                                    }
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.sq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        qr qrVar5 = qrVar4;
                                                        if (qrVar5.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = qrVar5.s;
                                                            boolean z24 = z23;
                                                            chatFull7.antispam = z24;
                                                            org.telegram.ui.Cells.s8 s8Var3 = s8Var2;
                                                            s8Var3.setChecked(z24);
                                                            s8Var3.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar5.r, 13) || ((chatFull5 = qrVar5.s) != null && chatFull5.antispam && qrVar5.l0() < qrVar5.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.xc.a0(qrVar5).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                                                        qr qrVar6 = qrVar4;
                                                        if (qrVar6.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull8 = qrVar6.s;
                                                            boolean z25 = z23;
                                                            chatFull8.participants_hidden = z25;
                                                            org.telegram.ui.Cells.s8 s8Var4 = s8Var2;
                                                            s8Var4.setChecked(z25);
                                                            s8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar6.r, 2) || ((chatFull6 = qrVar6.s) != null && chatFull6.participants_hidden && qrVar6.l0() < qrVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.xc.a0(qrVar6).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                }
                                    ...
                                    break;
                                default:
                                    final qr qrVar5 = this.b;
                                    if (tLObject3 != null) {
                                        qrVar5.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        qrVar5.getMessagesController().putChatFull(qrVar5.s);
                                    }
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i18 = 1;
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.sq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i18) {
                                                    case 0:
                                                        qr qrVar52 = qrVar5;
                                                        if (qrVar52.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = qrVar52.s;
                                                            boolean z242 = z24;
                                                            chatFull7.antispam = z242;
                                                            org.telegram.ui.Cells.s8 s8Var32 = s8Var3;
                                                            s8Var32.setChecked(z242);
                                                            s8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar52.r, 13) || ((chatFull5 = qrVar52.s) != null && chatFull5.antispam && qrVar52.l0() < qrVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.xc.a0(qrVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                ...
                if (i10 == qrVar.J0) {
                    ...
                    if (qrVar.l0() < qrVar.getMessagesController().hiddenMembersGroupSizeMin) {
                        org.telegram.ui.Components.xc.a0(qrVar).Q(R.raw.contacts_sync_off, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelHiddenMembersForbidden", qrVar.getMessagesController().hiddenMembersGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (qrVar.s == null || !ChatObject.canUserDoAdminAction(qrVar.r, 2) || qrVar.I0) {
                        return;
                    }
                    qrVar.I0 = true;
                    final boolean z23 = qrVar.s.participants_hidden;
                    ...
                    tL_channels_toggleParticipantsHidden.channel = qrVar.getMessagesController().getInputChannel(qrVar.N);
                    ...
                    if (!ChatObject.canUserDoAdminAction(qrVar.r, 2) || ((chatFull = qrVar.s) != null && !chatFull.participants_hidden && qrVar.l0() < qrVar.getMessagesController().hiddenMembersGroupSizeMin)) {
                        i14 = R.drawable.permission_locked;
                    }
                    checkBox.setIcon(i14);
                    qrVar.getConnectionsManager().sendRequest(tL_channels_toggleParticipantsHidden, new RequestDelegate(qrVar) { // from class: org.telegram.ui.pq
                        public final /* synthetic */ qr b;
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        ...
                                                        if (qrVar52.getParentActivity() != null) {
                                                            ...
                                                            s8Var32.setChecked(z242);
                                                            s8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar52.r, 13) || ((chatFull52 = qrVar52.s) != null && chatFull52.antispam && qrVar52.l0() < qrVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.xc.a0(qrVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                ...
                if (i10 == qrVar.L0) {
                    ...
                    tL_messages_editChatDefaultBannedRights.peer = MessagesController.getInputPeer(qrVar.r);
                    TLRPC.Chat chat = qrVar.r;
                    if (chat.default_banned_rights == null) {
                        chat.default_banned_rights = new TLRPC.TL_chatBannedRights();
                    }
                    TLRPC.TL_chatBannedRights tL_chatBannedRights4 = qrVar.r.default_banned_rights;
                    tL_messages_editChatDefaultBannedRights.banned_rights = tL_chatBannedRights4;
                    tL_chatBannedRights4.edit_rank = !s8Var3.b();
                    qrVar.getConnectionsManager().sendRequestTyped(tL_messages_editChatDefaultBannedRights, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.qq
                        ...
                        public final void run(Object obj, Object obj2) {
                            ...
                            qr qrVar4 = qr.this;
                            if (updates != null) {
                                qrVar4.getMessagesController().processUpdates(updates, false);
                                return;
                            }
                            qrVar4.getClass();
                            if (tL_error != null) {
                                s8Var3.setChecked(b10);
                                org.telegram.ui.Components.xc.a0(qrVar4).d0(tL_error, false);
                            }
                        }
                    });
                } else {
                    if (i10 == qrVar.B0) {
                        ...
                        bundle3.putLong("chat_id", qrVar.N);
                        bundle3.putInt(TeXSymbolParser.TYPE_ATTR, 0);
                        qr qrVar4 = new qr(bundle3);
                        qrVar4.x0(qrVar.s);
                        qrVar.presentFragment(qrVar4);
                        return;
                    }
                    if (i10 == qrVar.t0) {
                        qrVar.showDialog(new ir(qrVar, qrVar.getParentActivity(), qrVar));
                    } else {
                        if (i10 == qrVar.A0) {
                            if (qrVar.s != null) {
                                th0 th0Var = new th0(qrVar.N, 0L, 0);
                                TLRPC.ChatFull chatFull6 = qrVar.s;
                                th0Var.g0(chatFull6, chatFull6.exported_invite);
                                qrVar.presentFragment(th0Var);
                                return;
                            }
                            return;
                        }
                        if ((i10 > qrVar.S && i10 <= Math.max(qrVar.l0, qrVar.g0)) || i10 == qrVar.m0) {
                            org.telegram.ui.Cells.w8 w8Var2 = (org.telegram.ui.Cells.w8) view;
                            boolean isEnabled = w8Var2.isEnabled();
                            Switch r42 = w8Var2.d;
                            if (isEnabled) {
                                if (r42.F != null) {
                                    if (ChatObject.isPublic(qrVar.r) && (i10 == qrVar.i0 || i10 == qrVar.g0)) {
                                        org.telegram.messenger.z0.p(R.string.EditCantEditPermissionsPublic, org.telegram.ui.Components.xc.a0(qrVar), null);
                                        return;
                                    } else if (ChatObject.isDiscussionGroup(qrVar.currentAccount, qrVar.N) && (i10 == qrVar.i0 || i10 == qrVar.g0)) {
                                        org.telegram.messenger.z0.p(R.string.EditCantEditPermissionsDiscussion, org.telegram.ui.Components.xc.a0(qrVar), null);
                                        return;
                                    } else {
                                        org.telegram.ui.Components.xc.a0(qrVar).t(LocaleController.getString("EditCantEditPermissions", R.string.EditCantEditPermissions), null).j();
                                        return;
                                    }
                                }
                                if (i10 == qrVar.U) {
                                ...
                                if (i10 == qrVar.g0) {
                                    qrVar.E.change_info = !r0.change_info;
                                    return;
                                }
                                if (i10 == qrVar.m0) {
                                    qrVar.E.manage_linked_peers = !r0.manage_linked_peers;
                                    return;
                                }
                                if (i10 == qrVar.h0) {
                                    qrVar.E.invite_users = !r0.invite_users;
                                    return;
                                }
                                if (i10 == qrVar.l0) {
                                    qrVar.E.manage_topics = !r0.manage_topics;
                                    return;
                                }
                                if (i10 == qrVar.i0) {
                                    qrVar.E.pin_messages = !r0.pin_messages;
                                    return;
                                }
                                if (i10 == qrVar.j0) {
                                    qrVar.E.edit_rank = !r0.edit_rank;
                                    return;
                                }
                                if (i10 == qrVar.T) {
                                    qrVar.E.send_plain = !r1.send_plain;
                                    int i17 = qrVar.c0;
                                    if (i17 >= 0) {
                                        qrVar.a.m(i17);
                                    }
                                ...
                                if (i10 == qrVar.e0) {
                                    TLRPC.TL_chatBannedRights tL_chatBannedRights5 = qrVar.E;
                                ...
                                if (i10 == qrVar.f0) {
                                    qrVar.E.embed_links = !r0.embed_links;
                                    return;
                                } else {
                                    if (i10 == qrVar.d0) {
                                        qrVar.E.send_polls = !r0.send_polls;
                                        return;
                                    }
                                    return;
                                }
                ...
                if (z15) {
                    TLObject E = qrVar.e.E(i10);
                    if (E instanceof TLRPC.User) {
                        TLRPC.User user = (TLRPC.User) E;
                        qrVar.getMessagesController().putUser(user, false);
                        long j12 = user.id;
                        int i19 = 0;
                        while (true) {
                            if (i19 >= 3) {
                            ...
                            tLObject2 = (TLObject) (i19 == 0 ? iVar2 : i19 == 1 ? qrVar.L : iVar).f(j12);
                            if (tLObject2 != null) {
                                break;
                            } else {
                                i19++;
                    ...
                    if (E2 instanceof TLRPC.User) {
                        ...
                        if (i12 != 0) {
                            ...
                            if (i12 != 3 && i12 != 1) {
                                if (ChatObject.isChannel(qrVar.r)) {
                                    qrVar.getMessagesController().deleteParticipantFromChat(qrVar.N, qrVar.getMessagesController().getUser(Long.valueOf(j10)));
                                    jr jrVar = qrVar.m1;
                                    if (jrVar != null) {
                                        jrVar.d(j10);
                                    }
                            ...
                            if (i12 == 1) {
                                ...
                                if (!z11) {
                                    ...
                                    z13 = z11;
                                    i20 = 1;
                                    qrVar.t0(j11, tLObject, tL_chatAdminRights, tL_chatBannedRights, str2, z13, i12 != i20 ? 0 : 1, i12 != i20 || i12 == 3);
                                    return;
                                }
                                if ((tLObject instanceof TLRPC.TL_channelParticipantAdmin) || (tLObject instanceof TLRPC.TL_chatParticipantAdmin)) {
                                    TLRPC.User user2 = qrVar.getMessagesController().getUser(Long.valueOf(j10));
                                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(qrVar.getParentActivity());
                                    ...
                                    alertDialog$Builder.k(LocaleController.getString("OK", R.string.OK), new rq(qrVar, user2, tLObject, tL_chatAdminRights, tL_chatBannedRights, str, z11));
                                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                                    qrVar.showDialog(b2Var);
                                    return;
                                }
                                j11 = j10;
                                str2 = str;
                        ...
                        boolean z27 = z11;
                        if (i13 == 1) {
                            canBlockUsers = j14 != qrVar.getUserConfig().getClientUserId() && (qrVar.r.creator || z27);
                        } else {
                            if (i13 != 0 && i13 != 3) {
                                z12 = false;
                                if (i13 != 0 || ((i13 != 1 && z10) || (i13 == 2 && i12 == 0))) {
                                    if (j14 != qrVar.getUserConfig().getClientUserId()) {
                                        return;
                                    }
                                    ...
                                    qrVar.presentFragment(new ProfileActivity(bundle4, null));
                                    return;
                                }
                                ...
                                lq lqVar = new lq(j14, qrVar.N, tL_chatAdminRights, qrVar.E, tL_chatBannedRights, str, i13 == i11 ? 0 : 1, z12, tLObject == null, null);
                                lqVar.X0 = new wq(qrVar, tLObject);
                                qrVar.presentFragment(lqVar);
                                return;
                            }
                            canBlockUsers = ChatObject.canBlockUsers(qrVar.r);
                        }
                        z12 = canBlockUsers;
                        if (i13 != 0) {
                        }
    ...
    public static void W(qr qrVar, TLRPC.ChannelParticipant channelParticipant, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights) {
        int i10 = 0;
        while (i10 < 3) {
            TLObject tLObject = (TLObject) (i10 == 0 ? qrVar.M : i10 == 1 ? qrVar.L : qrVar.K).f(MessageObject.getPeerId(channelParticipant.peer));
    ...
    public static void c0(qr qrVar, TLRPC.User user) {
        ...
        UndoView undoView = qrVar.n;
        long j3 = -qrVar.N;
        boolean z12 = qrVar.v;
        undoView.m(j3, user, z12 ? 9 : 10);
        qrVar.r.creator = false;
        int i10 = 0;
        boolean z13 = false;
        while (i10 < 3) {
            boolean z14 = true;
    ...
    */
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 16, new Class[]{org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.b5.class, org.telegram.ui.Cells.y4.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.fa.class, org.telegram.ui.Components.tv0.class}, null, null, null, org.telegram.ui.ActionBar.h6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.v3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f7));
        int i11 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.h6.y6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.n6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 32, null, null, null, null, org.telegram.ui.ActionBar.h6.Fi));
        int i13 = org.telegram.ui.ActionBar.h6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.h6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 262144, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Components.xw0.class}, new String[]{"title"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Components.xw0.class}, new String[]{"subtitle"}, null, null, -1, null, i11));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        if (i13 != 2) {
            ...
            if (i13 == 3 && ChatObject.canBlockUsers(this.r)) {
                qrVar = this;
                H.c(R.drawable.msg_permissions, LocaleController.getString(R.string.ChannelEditPermissions), new org.telegram.messenger.voip.f(qrVar, j12, (TLObject) tL_chatBannedRights, str, tLObject, 1), false);
                final int i14 = 0;
                H.c(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), new Runnable(qrVar) { // from class: org.telegram.ui.nq
                    public final /* synthetic */ qr b;
                    ...
                    public final void run() {
                        switch (i14) {
                            ...
                            case 1:
                                ...
                                long j13 = j12;
                                qrVar2.i0(j13);
                                qrVar2.getMessagesController().addUserToChat(qrVar2.N, qrVar2.getMessagesController().getUser(Long.valueOf(j13)), 0, null, qrVar2, null);
                                break;
                            case 2:
                                this.b.i0(j12);
                                break;
                            default:
                                ...
                                long j15 = j12;
                                messagesController.setUserAdminRole(j14, messagesController2.getUser(Long.valueOf(j15)), new TLRPC.TL_chatAdminRights(), "", !qrVar3.v, qrVar3, false, false, null, null);
                                qrVar3.v0(j15);
                                break;
                        }
                    }
                ...
                String str3 = str;
                qrVar = this;
                if (i13 == 0 && ChatObject.canBlockUsers(qrVar.r)) {
                    if (ChatObject.canAddUsers(qrVar.r) && j3 > 0 && !ChatObject.isCommunity(qrVar.r)) {
                        final int i15 = 1;
                        H.c(R.drawable.msg_contact_add, LocaleController.getString(z15 ? R.string.ChannelAddToChannel : R.string.ChannelAddToGroup), new Runnable(qrVar) { // from class: org.telegram.ui.nq
                            public final /* synthetic */ qr b;
                ...
                } else if (i13 == 1 && ChatObject.canAddAdmins(qrVar.r) && z11) {
                    if (qrVar.r.creator || !(tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                        j10 = j12;
                        H.c(R.drawable.msg_admins, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), new org.telegram.messenger.voip.f(qrVar, j10, (TLObject) tL_chatAdminRights2, str3, tLObject, 2), false);
                    } else {
                        j10 = j12;
                    }
                    final int i17 = 3;
                    H.c(R.drawable.msg_remove, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), new Runnable(qrVar) { // from class: org.telegram.ui.nq
                        public final /* synthetic */ qr b;
        ...
        boolean z22 = z20;
        vq vqVar = new vq(this, j11, i11, tLObject, tL_chatAdminRights, tL_chatBannedRights2, str, z13);
        long j13 = j11;
        org.telegram.ui.Components.o70 H2 = org.telegram.ui.Components.o70.H(this, view);
        H2.W(this.c.V0(view, false));
        H2.l(R.drawable.msg_admins, LocaleController.getString(z19 ? R.string.EditAdminRights : R.string.SetAsAdmin), new aj(vqVar, 11), z12);
        H2.l(R.drawable.msg_permissions, LocaleController.getString("ChangePermissions", R.string.ChangePermissions), new org.telegram.ui.ActionBar.m5((org.telegram.ui.ActionBar.n2) this, tLObject, (TLObject) user, (Object) vqVar, 13), z22);
    ...
    public final void i0(long j3) {
        if (this.w) {
            ...
            getConnectionsManager().sendRequestTyped(tL_communities_toggleParticipantBanned, new org.telegram.messenger.a(), new c5(this, 5));
            return;
        }
    ...
    public final void r0() {
        ...
        if (ChatObject.isChannel(this.r)) {
            ...
            for (int i14 = 0; i14 < s02.size(); i14++) {
                arrayList6.add(null);
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest((TLObject) s02.get(i14), new ai.ya(arrayList6, i14, atomicInteger, s02, tqVar)), this.classGuid);
            }
            return;
        }
        this.Q = false;
    ...
    public final void t0(long j3, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z10, int i10, boolean z11) {
        lq lqVar = new lq(j3, this.N, tL_chatAdminRights, this.E, tL_chatBannedRights, str, i10, z10, tLObject == null, null);
    ...
    */
    public final void u0() {
        ...
        if (i10 == 3) {
            ...
            if (chat.creator && !ChatObject.isChannel(chat) && ((this.p1 != this.q1 || this.y1) && this.s != null)) {
                MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.N, this, new oq(this, 0));
                return;
            }
            ...
            if (z11 != this.x1 || (z11 && this.z1 != this.A1)) {
                ...
                getConnectionsManager().sendRequest(updatepaidmessagesprice, new ai.u7(11));
    ...
    public final kr w0() {
        ...
        krVar.j = this.Y0;
        krVar.l.clear();
        krVar.l.addAll(this.G);
        krVar.h = this.V0;
        krVar.g = this.U0;
        krVar.m.clear();
        krVar.m.addAll(this.H);
        krVar.e = this.E0;
        krVar.f = this.F0;
        krVar.k.clear();
        krVar.k.addAll(this.F);
        krVar.f(krVar.c);
        return krVar;
    }
