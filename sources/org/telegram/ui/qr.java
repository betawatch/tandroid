...
public final class qr extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(qr qrVar, long j10) {
        if (j10 != 0) {
            qrVar.K = j10;
            qrVar.r = MessagesController.getInstance(qrVar.currentAccount).getChat(Long.valueOf(j10));
            qrVar.u0();
        }
    }
    ...
    */
    public static void V(final qr qrVar, View view, int i10) {
        ...
        i14 = 0;
        final int i15 = 1;
        boolean z14 = qrVar.c.getAdapter() == qrVar.a;
        if (i10 == qrVar.e1) {
            boolean z15 = !qrVar.s1;
            qrVar.s1 = z15;
            ...
            qrVar.A0(w02);
            qrVar.a.m(qrVar.g1);
        } else if (i10 == qrVar.f1) {
            boolean z16 = !qrVar.t1;
            qrVar.t1 = z16;
            ((org.telegram.ui.Cells.s8) view).setChecked(z16);
            AndroidUtilities.updateVisibleRows(qrVar.c);
            kr w03 = qrVar.w0();
            qrVar.B0();
            qrVar.A0(w03);
            ...
            if (qrVar.p0(i10)) {
                ...
                if (i10 == qrVar.S) {
                    qrVar.B.send_photos = !r15.send_photos;
                } else if (i10 == qrVar.T) {
                    qrVar.B.send_videos = !r14.send_videos;
                } else if (i10 == qrVar.U) {
                    ...
                    qrVar.B.send_audios = !r14.send_audios;
                } else if (i10 == qrVar.W) {
                    qrVar.B.send_docs = !r14.send_docs;
                } else if (i10 == qrVar.X) {
                    qrVar.B.send_voices = !r14.send_voices;
                } else if (i10 == qrVar.Y) {
                    qrVar.B.send_roundvideos = !r14.send_roundvideos;
                } else if (i10 == qrVar.Z) {
                    if (qrVar.B.send_plain && (m9 = qrVar.d.m(qrVar.Q)) != null) {
                        AndroidUtilities.shakeViewSpring(m9);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        qrVar.B.embed_links = !r14.embed_links;
                    }
                } else if (i10 == qrVar.a0) {
                    qrVar.B.send_polls = !r14.send_polls;
                } else if (i10 == qrVar.h0) {
                    qrVar.B.send_reactions = !r14.send_reactions;
                }
                ...
                boolean z19 = !r8Var.d.h;
                qrVar.o1 = z19;
                r8Var.setChecked(z19);
                AndroidUtilities.updateVisibleRows(qrVar.c);
                kr w06 = qrVar.w0();
                qrVar.B0();
                qrVar.A0(w06);
                ...
                if (i10 == qrVar.w0) {
                    if (i13 == 0 || i13 == 3) {
                        ...
                        qrVar2.x0(qrVar.s);
                        TLRPC.TL_chatBannedRights tL_chatBannedRights3 = qrVar.B;
                        if (tL_chatBannedRights3 != null) {
                            qrVar2.B = tL_chatBannedRights3;
                        }
                        qrVar2.j1 = new er(qrVar);
                        qrVar.presentFragment(qrVar2);
                        return;
                    }
                    if (i13 == 1) {
                        Bundle bundle2 = new Bundle();
                        bundle2.putLong("chat_id", qrVar.K);
                        bundle2.putInt(TeXSymbolParser.TYPE_ATTR, 2);
                        bundle2.putInt("selectType", 1);
                        qr qrVar3 = new qr(bundle2);
                        qrVar3.j1 = new fr(qrVar);
                        qrVar3.x0(qrVar.s);
                    ...
                    if (i13 == 2) {
                        ...
                        i16.putLong(z13 ? "channelId" : "chatId", qrVar.r.id);
                        z60 z60Var = new z60(i16);
                        z60Var.F = qrVar.s;
                        if (hVar2 != null && hVar2.m() != 0) {
                            hVar = hVar2;
                        }
                        z60Var.G = hVar;
                        z60Var.x = new hr(qrVar, z60Var);
                        qrVar.presentFragment(z60Var);
                        return;
                    }
                    return;
                }
                if (i10 == qrVar.s0) {
                    qrVar.presentFragment(new sb(qrVar.r));
                    return;
                }
                if (i10 == qrVar.u0) {
                    ...
                    if (chatFull3 != null && !chatFull3.antispam && qrVar.l0() < qrVar.getMessagesController().telegramAntispamGroupSizeMin) {
                        org.telegram.ui.Components.qc.a0(qrVar).Q(R.raw.msg_antispam, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelAntiSpamForbidden", qrVar.getMessagesController().telegramAntispamGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (qrVar.s == null || !ChatObject.canUserDoAdminAction(qrVar.r, 13) || qrVar.t0) {
                        return;
                    }
                    qrVar.t0 = true;
                    final boolean z20 = qrVar.s.antispam;
                    TLRPC.TL_channels_toggleAntiSpam tL_channels_toggleAntiSpam = new TLRPC.TL_channels_toggleAntiSpam();
                    tL_channels_toggleAntiSpam.channel = qrVar.getMessagesController().getInputChannel(qrVar.K);
                    ...
                    qrVar.getConnectionsManager().sendRequest(tL_channels_toggleAntiSpam, new RequestDelegate(qrVar) { // from class: org.telegram.ui.oq
                            ...
                            switch (i14) {
                                case 0:
                                    ...
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i17 = 0;
                                        final org.telegram.ui.Cells.o8 o8Var2 = o8Var;
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        ...
                                                        if (qrVar5.getParentActivity() != null) {
                                                            ...
                                                            org.telegram.ui.Cells.o8 o8Var3 = o8Var2;
                                                            o8Var3.setChecked(z23);
                                                            o8Var3.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar5.r, 13) || ((chatFull5 = qrVar5.s) != null && chatFull5.antispam && qrVar5.l0() < qrVar5.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(qrVar5).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                                                        ...
                                                        if (qrVar6.getParentActivity() != null) {
                                                            ...
                                                            org.telegram.ui.Cells.o8 o8Var4 = o8Var2;
                                                            o8Var4.setChecked(z24);
                                                            o8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar6.r, 2) || ((chatFull6 = qrVar6.s) != null && chatFull6.participants_hidden && qrVar6.l0() < qrVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(qrVar6).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                }
                                ...
                                default:
                                    ...
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i18 = 1;
                                        final org.telegram.ui.Cells.o8 o8Var3 = o8Var;
                                                ...
                                                switch (i18) {
                                                    case 0:
                                                        ...
                                                        if (qrVar52.getParentActivity() != null) {
                                                            ...
                                                            org.telegram.ui.Cells.o8 o8Var32 = o8Var3;
                                                            o8Var32.setChecked(z232);
                                                            o8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar52.r, 13) || ((chatFull5 = qrVar52.s) != null && chatFull5.antispam && qrVar52.l0() < qrVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(qrVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                                                        ...
                                                        if (qrVar6.getParentActivity() != null) {
                                                            ...
                                                            boolean z24 = z23;
                                                            chatFull8.participants_hidden = z24;
                                                            org.telegram.ui.Cells.o8 o8Var4 = o8Var3;
                                                            o8Var4.setChecked(z24);
                                                            o8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar6.r, 2) || ((chatFull6 = qrVar6.s) != null && chatFull6.participants_hidden && qrVar6.l0() < qrVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(qrVar6).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                ...
                if (i10 == qrVar.G0) {
                    final org.telegram.ui.Cells.o8 o8Var2 = (org.telegram.ui.Cells.o8) view;
                    if (qrVar.l0() < qrVar.getMessagesController().hiddenMembersGroupSizeMin) {
                        org.telegram.ui.Components.qc.a0(qrVar).Q(R.raw.contacts_sync_off, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelHiddenMembersForbidden", qrVar.getMessagesController().hiddenMembersGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (qrVar.s == null || !ChatObject.canUserDoAdminAction(qrVar.r, 2) || qrVar.F0) {
                        return;
                    }
                    qrVar.F0 = true;
                    final boolean z22 = qrVar.s.participants_hidden;
                    ...
                    tL_channels_toggleParticipantsHidden.channel = qrVar.getMessagesController().getInputChannel(qrVar.K);
                    ...
                    o8Var2.setChecked(z23);
                    Switch checkBox = o8Var2.getCheckBox();
                    ...
                    qrVar.getConnectionsManager().sendRequest(tL_channels_toggleParticipantsHidden, new RequestDelegate(qrVar) { // from class: org.telegram.ui.oq
                        public final /* synthetic */ qr b;
                        ...
                        public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                            switch (i15) {
                                case 0:
                                    ...
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i17 = 0;
                                        final org.telegram.ui.Cells.o8 o8Var22 = o8Var2;
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        ...
                                                        if (qrVar52.getParentActivity() != null) {
                                                            ...
                                                            boolean z232 = z222;
                                                            chatFull7.antispam = z232;
                                                            org.telegram.ui.Cells.o8 o8Var32 = o8Var22;
                                                            o8Var32.setChecked(z232);
                                                            o8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar52.r, 13) || ((chatFull52 = qrVar52.s) != null && chatFull52.antispam && qrVar52.l0() < qrVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(qrVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                                                        ...
                                                        if (qrVar6.getParentActivity() != null) {
                                                            ...
                                                            boolean z24 = z222;
                                                            chatFull8.participants_hidden = z24;
                                                            org.telegram.ui.Cells.o8 o8Var4 = o8Var22;
                                                            o8Var4.setChecked(z24);
                                                            o8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(qrVar6.r, 2) || ((chatFull6 = qrVar6.s) != null && chatFull6.participants_hidden && qrVar6.l0() < qrVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(qrVar6).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                ...
                                default:
                                    ...
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i18 = 1;
                                        final org.telegram.ui.Cells.o8 o8Var3 = o8Var2;
                ...
                if (i10 == qrVar.I0) {
                    ...
                    final org.telegram.ui.Cells.o8 o8Var3 = (org.telegram.ui.Cells.o8) view;
                    final boolean b10 = o8Var3.b();
                    o8Var3.setChecked(!o8Var3.b());
                    ...
                    tL_chatBannedRights4.edit_rank = !o8Var3.b();
                    qrVar.getConnectionsManager().sendRequestTyped(tL_messages_editChatDefaultBannedRights, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.pq
                        ...
                        public final void run(Object obj, Object obj2) {
                            ...
                            qrVar4.getClass();
                            if (tL_error != null) {
                                o8Var3.setChecked(b10);
                                org.telegram.ui.Components.qc.a0(qrVar4).d0(tL_error, false);
                            }
                        }
                    });
                } else {
                    if (i10 == qrVar.y0) {
                        ...
                        bundle3.putLong("chat_id", qrVar.K);
                    ...
                    if (i10 == qrVar.q0) {
                        ...
                        if (i10 == qrVar.x0) {
                            if (qrVar.s != null) {
                                qh0 qh0Var = new qh0(qrVar.K, 0L, 0);
                                TLRPC.ChatFull chatFull6 = qrVar.s;
                                qh0Var.g0(chatFull6, chatFull6.exported_invite);
                                qrVar.presentFragment(qh0Var);
                                return;
                            }
                            return;
                        }
                        if ((i10 > qrVar.P && i10 <= Math.max(qrVar.i0, qrVar.d0)) || i10 == qrVar.j0) {
                            org.telegram.ui.Cells.r8 r8Var2 = (org.telegram.ui.Cells.r8) view;
                            boolean isEnabled = r8Var2.isEnabled();
                            Switch r42 = r8Var2.d;
                            if (isEnabled) {
                                if (r42.C != null) {
                                    if (ChatObject.isPublic(qrVar.r) && (i10 == qrVar.f0 || i10 == qrVar.d0)) {
                                        org.telegram.messenger.y3.s(R.string.EditCantEditPermissionsPublic, org.telegram.ui.Components.qc.a0(qrVar), null);
                                        return;
                                    } else if (ChatObject.isDiscussionGroup(qrVar.currentAccount, qrVar.K) && (i10 == qrVar.f0 || i10 == qrVar.d0)) {
                                        org.telegram.messenger.y3.s(R.string.EditCantEditPermissionsDiscussion, org.telegram.ui.Components.qc.a0(qrVar), null);
                                        return;
                                    } else {
                                        org.telegram.ui.Components.qc.a0(qrVar).t(LocaleController.getString("EditCantEditPermissions", R.string.EditCantEditPermissions), null).j();
                                        return;
                                    }
                                }
                                if (i10 == qrVar.R) {
                                ...
                                r8Var2.setChecked(!r42.h);
                                if (i10 == qrVar.d0) {
                                    qrVar.B.change_info = !r0.change_info;
                                    return;
                                }
                                if (i10 == qrVar.j0) {
                                    qrVar.B.manage_linked_peers = !r0.manage_linked_peers;
                                    return;
                                }
                                if (i10 == qrVar.e0) {
                                    qrVar.B.invite_users = !r0.invite_users;
                                    return;
                                }
                                if (i10 == qrVar.i0) {
                                    qrVar.B.manage_topics = !r0.manage_topics;
                                    return;
                                }
                                if (i10 == qrVar.f0) {
                                    qrVar.B.pin_messages = !r0.pin_messages;
                                    return;
                                }
                                if (i10 == qrVar.g0) {
                                    qrVar.B.edit_rank = !r0.edit_rank;
                                    return;
                                }
                                if (i10 == qrVar.Q) {
                                    qrVar.B.send_plain = !r1.send_plain;
                                    int i17 = qrVar.Z;
                                    if (i17 >= 0) {
                                        qrVar.a.m(i17);
                                    }
                                ...
                                if (i10 == qrVar.b0) {
                                    TLRPC.TL_chatBannedRights tL_chatBannedRights5 = qrVar.B;
                                ...
                                if (i10 == qrVar.c0) {
                                    qrVar.B.embed_links = !r0.embed_links;
                                    return;
                                } else {
                                    if (i10 == qrVar.a0) {
                                        qrVar.B.send_polls = !r0.send_polls;
                                        return;
                                    }
                                    return;
                                }
                ...
                if (z14) {
                    ...
                    if (E instanceof TLRPC.User) {
                        ...
                        while (true) {
                            ...
                            tLObject2 = (TLObject) (i19 == 0 ? hVar2 : i19 == 1 ? qrVar.I : hVar).f(j13);
                            if (tLObject2 != null) {
                                break;
                            } else {
                                i19++;
                    ...
                    if (E2 instanceof TLRPC.User) {
                        ...
                        if (i12 != 0) {
                            ...
                            if (i12 != 3 && i12 != 1) {
                                if (ChatObject.isChannel(qrVar.r)) {
                                    qrVar.getMessagesController().deleteParticipantFromChat(qrVar.K, qrVar.getMessagesController().getUser(Long.valueOf(j11)));
                                    jr jrVar = qrVar.j1;
                                    if (jrVar != null) {
                                        jrVar.d(j11);
                                    }
                            ...
                            if (i12 == 1) {
                                ...
                                if (!z10) {
                                    ...
                                    z12 = z10;
                                    i20 = 1;
                                    qrVar.t0(j12, tLObject, tL_chatAdminRights, tL_chatBannedRights, str2, z12, i12 != i20 ? 0 : 1, i12 != i20 || i12 == 3);
                                    return;
                                }
                                if ((tLObject instanceof TLRPC.TL_channelParticipantAdmin) || (tLObject instanceof TLRPC.TL_chatParticipantAdmin)) {
                                    TLRPC.User user2 = qrVar.getMessagesController().getUser(Long.valueOf(j11));
                                    ...
                                    alertDialog$Builder.k(LocaleController.getString("OK", R.string.OK), new qq(qrVar, user2, tLObject, tL_chatAdminRights, tL_chatBannedRights, str, z10));
                                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                                    qrVar.showDialog(d2Var);
                                    return;
                                }
                                j12 = j11;
                                str2 = str;
                        ...
                        boolean z26 = z10;
                        if (i13 == 1) {
                            canBlockUsers = j15 != qrVar.getUserConfig().getClientUserId() && (qrVar.r.creator || z26);
                        } else {
                            if (i13 != 0 && i13 != 3) {
                                z11 = false;
                                if (i13 != 0 || ((i13 != 1 && z4) || (i13 == 2 && i12 == 0))) {
                                    if (j15 != qrVar.getUserConfig().getClientUserId()) {
                                        return;
                                    }
                                ...
                                kq kqVar = new kq(j15, qrVar.K, tL_chatAdminRights, qrVar.B, tL_chatBannedRights, str, i13 == i11 ? 0 : 1, z11, tLObject == null, null);
                                kqVar.U0 = new vq(qrVar, tLObject);
                                qrVar.presentFragment(kqVar);
                                return;
                            }
    ...
    public static void W(qr qrVar, TLRPC.ChannelParticipant channelParticipant, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights) {
        int i10 = 0;
        while (i10 < 3) {
            TLObject tLObject = (TLObject) (i10 == 0 ? qrVar.J : i10 == 1 ? qrVar.I : qrVar.H).f(MessageObject.getPeerId(channelParticipant.peer));
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.k6.a7));
        ...
        int i12 = org.telegram.ui.ActionBar.k6.G8;
        int i13 = org.telegram.ui.ActionBar.k6.i6;
        u00Var3.f(i12, i13, i13);
        frameLayout3.addView(this.z1, k7.c6.d(-1, -1.0f, 0, 12.0f, 30.0f, 12.0f, 0.0f));
        ...
        this.c.setOnItemClickListener(new nq(this, 3));
        this.c.setOnItemLongClickListener(new nq(this, 4));
        if (this.f != null) {
    ...
    */
    public final boolean g0(boolean z4) {
        if (!this.M) {
            ...
            if (z4) {
                ...
                alertDialog$Builder.k(LocaleController.getString("ApplyTheme", R.string.ApplyTheme), new nq(this, 1));
                alertDialog$Builder.h(LocaleController.getString("PassportDiscard", R.string.PassportDiscard), new nq(this, 2));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 32, new Class[]{org.telegram.ui.Cells.z6.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.u3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.f7));
        int i11 = org.telegram.ui.ActionBar.k6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.k6.y6;
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusColor"}, null, null, -1, fVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusOnlineColor"}, null, null, -1, fVar, org.telegram.ui.ActionBar.k6.n6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.n, 32, null, null, null, null, org.telegram.ui.ActionBar.k6.Fi));
        int i13 = org.telegram.ui.ActionBar.k6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.n, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.n, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.k6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.n, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.n, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.n, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.n, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.c, 262144, new Class[]{org.telegram.ui.Cells.y4.class}, new String[]{"textView"}, null, null, -1, null, i11));
    ...
    public final boolean h0(TLObject tLObject, boolean z4, View view) {
        ...
        if (i13 != 2) {
            ...
            if (i13 == 3 && ChatObject.canBlockUsers(this.r)) {
                qrVar = this;
                H.c(R.drawable.msg_permissions, LocaleController.getString(R.string.ChannelEditPermissions), new lh.g1(qrVar, j13, tL_chatBannedRights, str, tLObject, 9), false);
                final int i14 = 0;
                H.c(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), new Runnable(qrVar) { // from class: org.telegram.ui.mq
                    public final /* synthetic */ qr b;
                    ...
                    public final void run() {
                        switch (i14) {
                            ...
                            case 1:
                                ...
                                long j14 = j13;
                                qrVar2.i0(j14);
                                qrVar2.getMessagesController().addUserToChat(qrVar2.K, qrVar2.getMessagesController().getUser(Long.valueOf(j14)), 0, null, qrVar2, null);
                                break;
                            case 2:
                                this.b.i0(j13);
                                break;
                ...
                if (i13 == 0 && ChatObject.canBlockUsers(qrVar.r)) {
                    if (ChatObject.canAddUsers(qrVar.r) && j10 > 0 && !ChatObject.isCommunity(qrVar.r)) {
                        final int i15 = 1;
                        H.c(R.drawable.msg_contact_add, LocaleController.getString(z14 ? R.string.ChannelAddToChannel : R.string.ChannelAddToGroup), new Runnable(qrVar) { // from class: org.telegram.ui.mq
                            public final /* synthetic */ qr b;
                ...
                } else if (i13 == 1 && ChatObject.canAddAdmins(qrVar.r) && z10) {
                    if (qrVar.r.creator || !(tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                        j11 = j13;
                        H.c(R.drawable.msg_admins, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), new lh.g1(qrVar, j11, tL_chatAdminRights2, str3, tLObject, 10), false);
                    } else {
                        j11 = j13;
                    }
                    final int i17 = 3;
                    H.c(R.drawable.msg_remove, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), new Runnable(qrVar) { // from class: org.telegram.ui.mq
                        public final /* synthetic */ qr b;
    ...
    public final void i0(long j10) {
        if (this.w) {
            ...
            getConnectionsManager().sendRequestTyped(tL_communities_toggleParticipantBanned, new org.telegram.messenger.a(), new d5(this, 5));
            return;
        }
    ...
    public final void r0() {
        ...
        if (ChatObject.isChannel(this.r)) {
            ...
            for (int i14 = 0; i14 < s02.size(); i14++) {
                arrayList6.add(null);
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest((TLObject) s02.get(i14), new lf.i0(arrayList6, i14, atomicInteger, s02, sqVar, 6)), this.classGuid);
            }
            return;
        }
        this.N = false;
    ...
    public final void t0(long j10, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z4, int i10, boolean z10) {
        kq kqVar = new kq(j10, this.K, tL_chatAdminRights, this.B, tL_chatBannedRights, str, i10, z4, tLObject == null, null);
    ...
    */
    public final void u0() {
        ...
        if (i10 == 3) {
            ...
            if (chat.creator && !ChatObject.isChannel(chat) && ((this.m1 != this.n1 || this.v1) && this.s != null)) {
                MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.K, this, new nq(this, 0));
                return;
            }
            ...
            if (z10 != this.u1 || (z10 && this.w1 != this.x1)) {
                ...
                getConnectionsManager().sendRequest(updatepaidmessagesprice, new oh.p5(7));
    ...
    public final kr w0() {
        ...
        krVar.j = this.V0;
        krVar.l.clear();
        krVar.l.addAll(this.D);
        krVar.h = this.S0;
        krVar.g = this.R0;
        krVar.m.clear();
        krVar.m.addAll(this.E);
        krVar.e = this.B0;
        krVar.f = this.C0;
        krVar.k.clear();
        krVar.k.addAll(this.C);
        krVar.f(krVar.c);
        return krVar;
    }
