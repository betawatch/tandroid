...
public final class qr extends org.telegram.ui.Components.kl0 {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:474:0x0881  */
    /* JADX WARN: Removed duplicated region for block: B:645:0x0b2a  */
    /* JADX WARN: Removed duplicated region for block: B:649:0x0b2d  */
    /* JADX WARN: Removed duplicated region for block: B:674:0x086c  */
    @Override // s4.h0
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
        ...
        switch (i15) {
            case 0:
                ...
                if (E instanceof TLRPC.User) {
                    ...
                    charSequence = "";
                    j10 = channelParticipant.kicked_by;
                    long j12 = channelParticipant.promoted_by;
                    tL_chatBannedRights = channelParticipant.banned_rights;
                    int i17 = channelParticipant.date;
                    boolean z22 = channelParticipant instanceof TLRPC.TL_channelParticipantBanned;
                    ...
                    if (j3 <= 0) {
                        z14 = z12;
                        z15 = z11;
                        chat = urVar.getMessagesController().getUser(Long.valueOf(j3));
                        i12 = i11;
                    } else {
                        z14 = z12;
                        z15 = z11;
                        i12 = i11;
                        chat = urVar.getMessagesController().getChat(Long.valueOf(-j3));
                    }
                    if (chat == null) {
                        if (i14 != 3) {
                            if (i14 != 0) {
                                if (i14 != 1) {
                                    ...
                                    if (!z14) {
                                        if (!z15 || (user = urVar.getMessagesController().getUser(Long.valueOf(j11))) == null) {
                                            charSequence2 = null;
                                        } else if (user.id == j3) {
                                ...
                                b5Var.b(chat, null, (!z13 || (user2 = urVar.getMessagesController().getUser(Long.valueOf(j10))) == null) ? null : LocaleController.formatString(R.string.UserRemovedBy, UserObject.getUserName(user2)), i10 != i12 + (-1));
                                break;
                            }
                        } else {
                            if (tL_chatBannedRights == null) {
                                ...
                                boolean z23 = tL_chatBannedRights.view_messages;
                                if (z23 && urVar.E.view_messages != z23) {
                                ...
                                boolean z24 = tL_chatBannedRights.send_media;
                                if (!z24 || urVar.E.send_media == z24) {
                                    boolean z25 = tL_chatBannedRights.send_photos;
                                    if (z25 && urVar.E.send_photos != z25) {
                                        if (sb3.length() != 0) {
                                            sb3.append(", ");
                                        }
                                        sb3.append(LocaleController.getString("UserRestrictionsNoSendPhotos", R.string.UserRestrictionsNoSendPhotos));
                                    }
                                    boolean z26 = tL_chatBannedRights.send_videos;
                                    if (z26 && urVar.E.send_videos != z26) {
                                        if (sb3.length() != 0) {
                                            sb3.append(", ");
                                        }
                                        sb3.append(LocaleController.getString("UserRestrictionsNoSendVideos", R.string.UserRestrictionsNoSendVideos));
                                    }
                                    boolean z27 = tL_chatBannedRights.send_audios;
                                    if (z27 && urVar.E.send_audios != z27) {
                                        if (sb3.length() != 0) {
                                            sb3.append(", ");
                                        }
                                        sb3.append(LocaleController.getString("UserRestrictionsNoSendMusic", R.string.UserRestrictionsNoSendMusic));
                                    }
                                    boolean z28 = tL_chatBannedRights.send_docs;
                                    if (z28 && urVar.E.send_docs != z28) {
                                        if (sb3.length() != 0) {
                                            sb3.append(", ");
                                        }
                                        sb3.append(LocaleController.getString("UserRestrictionsNoSendDocs", R.string.UserRestrictionsNoSendDocs));
                                    }
                                    boolean z29 = tL_chatBannedRights.send_voices;
                                    if (z29 && urVar.E.send_voices != z29) {
                                        if (sb3.length() != 0) {
                                            sb3.append(", ");
                                        }
                                        sb3.append(LocaleController.getString("UserRestrictionsNoSendVoice", R.string.UserRestrictionsNoSendVoice));
                                    }
                                    boolean z30 = tL_chatBannedRights.send_roundvideos;
                                    if (z30 && urVar.E.send_roundvideos != z30) {
                                        if (sb3.length() != 0) {
                                            sb3.append(", ");
                                        }
                    ...
                    if (E instanceof TLRPC.ChatParticipant) {
                        ...
                        boolean z39 = chatParticipant instanceof TLRPC.TL_chatParticipantCreator;
            ...
            case 2:
                ...
                if (i10 != urVar.z0) {
                    if (i10 != urVar.v0) {
                        ...
                        y4Var.b(LocaleController.getString(R.string.EventLog), R.drawable.msg_log, 5, urVar.x0 > urVar.v0);
                        break;
                    }
                } else if (i14 != 3) {
                    if (i14 != 0) {
                        if (i14 != 1) {
                            ...
                            y4Var.a(org.telegram.ui.ActionBar.i6.v6, org.telegram.ui.ActionBar.i6.u6);
                            y4Var.b(LocaleController.getString("ChannelAddAdmin", R.string.ChannelAddAdmin), R.drawable.msg_admin_add, 5, !urVar.Q || urVar.R);
                            break;
                        }
                    } else {
                    ...
                    y4Var.a(org.telegram.ui.ActionBar.i6.v6, org.telegram.ui.ActionBar.i6.u6);
                    y4Var.b(LocaleController.getString("ChannelAddException", R.string.ChannelAddException), R.drawable.msg_contact_add, 5, urVar.E0 != -1);
                    break;
                }
                break;
            case 5:
            ...
            case 14:
                ...
                if (i10 == urVar.g0) {
                    v8Var.d(LocaleController.getString(z16 ? R.string.CommunityAdminRightEditCommunityName : R.string.UserRestrictionsChangeInfo), (urVar.E.change_info || ChatObject.isPublic(urVar.r)) ? false : true, urVar.l0 != -1, z40);
                } else if (i10 == urVar.m0) {
                    v8Var.d(LocaleController.getString(R.string.CommunityAdminRightEditGroupList), !urVar.E.manage_linked_peers, false, z40);
                } else if (i10 == urVar.h0) {
                    v8Var.d(LocaleController.getString("UserRestrictionsInviteUsers", R.string.UserRestrictionsInviteUsers), !urVar.E.invite_users, true, z40);
                } else if (i10 == urVar.i0) {
                    v8Var.d(LocaleController.getString(R.string.UserRestrictionsPinMessages), (urVar.E.pin_messages || ChatObject.isPublic(urVar.r)) ? false : true, true, z40);
                } else if (i10 == urVar.j0) {
                    v8Var.d(LocaleController.getString(R.string.UserRestrictionsEditTags), !urVar.E.edit_rank, true, z40);
                } else if (i10 == urVar.T) {
                    v8Var.d(LocaleController.getString("UserRestrictionsSendText", R.string.UserRestrictionsSendText), !urVar.E.send_plain, true, z40);
                } else if (i10 == urVar.Q0) {
                    v8Var.d(LocaleController.getString(R.string.GroupNotRestrictBoosters), urVar.r1, false, z40);
                    ...
                    v8Var.a(new i9.s(this, v8Var, false, 22), a4.a.n(n02, "/10"), !urVar.l1);
                } else if (i10 == urVar.e0) {
                    v8Var.d(LocaleController.getString("UserRestrictionsSendStickers", R.string.UserRestrictionsSendStickers), !urVar.E.send_stickers, true, z40);
                } else if (i10 == urVar.f0) {
                    v8Var.d(LocaleController.getString("UserRestrictionsEmbedLinks", R.string.UserRestrictionsEmbedLinks), !urVar.E.embed_links, true, z40);
                    ...
                    v8Var.d(LocaleController.getString("CreateTopicsPermission", R.string.CreateTopicsPermission), !urVar.E.manage_topics, false, z40);
                }
                if (i10 == urVar.i0 || i10 == urVar.g0) {
                    i13 = ((org.telegram.ui.ActionBar.n2) urVar).currentAccount;
            ...
            case 13:
                ...
                boolean z41 = z1Var.getTag() != null && ((Integer) z1Var.getTag()).intValue() == i10;
                                            ...
                                            if (i10 != urVar.c0) {
                                                if (i10 != urVar.k0) {
                                                    if (i10 != urVar.d0) {
                                                        ...
                                                        z1Var.e(LocaleController.getString("SendMediaPolls", R.string.SendMediaPolls), "", !urVar.E.send_polls, true, z41);
                                                        break;
                                                    }
                                                } else {
                                                    z1Var.e(LocaleController.getString(R.string.UserRestrictionsSendReactions), "", !urVar.E.send_reactions, false, z41);
                                                    break;
                                                }
                                            } else {
                                                String string5 = LocaleController.getString("SendMediaEmbededLinks", R.string.SendMediaEmbededLinks);
                                                TLRPC.TL_chatBannedRights tL_chatBannedRights3 = urVar.E;
                                                z1Var.e(string5, "", (tL_chatBannedRights3.embed_links || tL_chatBannedRights3.send_plain) ? false : true, true, z41);
                                                break;
                                            }
                                        } else {
                                            z1Var.e(LocaleController.getString("SendMediaPermissionRound", R.string.SendMediaPermissionRound), "", !urVar.E.send_roundvideos, true, z41);
                                            break;
                                        }
                                    } else {
                                        z1Var.e(LocaleController.getString("SendMediaPermissionVoice", R.string.SendMediaPermissionVoice), "", !urVar.E.send_voices, true, z41);
                                        break;
                                    }
                                } else {
                                    z1Var.e(LocaleController.getString("SendMediaPermissionFiles", R.string.SendMediaPermissionFiles), "", !urVar.E.send_docs, true, z41);
                                    break;
                                }
                            } else {
                                z1Var.e(LocaleController.getString("SendMediaPermissionMusic", R.string.SendMediaPermissionMusic), "", !urVar.E.send_audios, true, z41);
                                break;
                            }
                        } else {
                            z1Var.e(LocaleController.getString("SendMediaPermissionStickersGifs", R.string.SendMediaPermissionStickersGifs), "", !urVar.E.send_stickers, true, z41);
                            break;
                        }
                    } else {
                        z1Var.e(LocaleController.getString("SendMediaPermissionVideos", R.string.SendMediaPermissionVideos), "", !urVar.E.send_videos, true, z41);
                        break;
                    }
                } else {
                    z1Var.e(LocaleController.getString("SendMediaPermissionPhotos", R.string.SendMediaPermissionPhotos), "", !urVar.E.send_photos, true, z41);
                    break;
                }
                break;
            case 16:
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                int i11 = urVar.O;
                org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5((i11 == 0 || i11 == 3) ? 7 : 6, (i11 == 0 || i11 == 3) ? 6 : 2, this.c, null, urVar.e1 == 0);
                b5Var.setDelegate(new pr(this, 0));
                view2 = b5Var;
                view = view2;
                break;
            case 1:
            ...
            case 15:
                ...
                tv0Var2.setCallback(new pr(this, 2));
                view2 = tv0Var2;
                view = view2;
                break;
            case 16:
