...
public final class a41 extends org.telegram.ui.Cells.s1 {
        ...
        if (paint != null) {
            ...
            if (f10 > 0.0f) {
                if (c41Var.M) {
                    ...
                    getPhotoImage().setAlpha(Math.max(1.0f - this.Le.e(c41Var.M), 1.0f - c41Var.s));
            ...
            this.Ge.reset();
            float width2 = (rectF.width() / 76.8f) * c41Var.v;
    ...
    public final void c2(Canvas canvas, float f10, Integer num) {
        ...
        int i10 = -this.J.c;
        c41 c41Var = this.Oe;
        canvas.translate(AndroidUtilities.lerp(0, i10, c41Var.s), AndroidUtilities.lerp(c41Var.K.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), r0.p, c41Var.s));
        super.c2(canvas, (1.0f - c41Var.s) * f10, num);
        canvas.restore();
    }
    ...
    public final void l2(float f10, Canvas canvas, boolean z10) {
        ...
        if (c41Var.O) {
            ...
            canvas.translate(((this.De.right - (AndroidUtilities.dp(8 + i11) + i10)) - this.nb) * c41Var.s, 0.0f);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            AndroidUtilities.lerp(rectF3, rectF2, c41Var.s, rectF);
            T3(rectF.left, rectF.top, rectF.width(), rectF.height());
            getPhotoImage().setRoundRadius((int) rectF.width());
            if (c41Var.s <= 0.0f || !c41Var.M) {
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
            }
            this.re = 1.0f - c41Var.s;
        } else {
            canvas2 = canvas;
        }
        R1(canvas2);
        if (c41Var.O && c41Var.s > 0.0f && c41Var.M) {
            canvas2.restore();
        }
    }
