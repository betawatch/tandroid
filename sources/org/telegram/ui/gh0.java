    ...
    public final void R0(a0.h hVar, int i10, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        if (z10) {
            if (hVar == null || hVar.m() != 1) {
                ...
                formatString = (j10 == 0 || j10 == kh0Var.getUserConfig().getClientUserId()) ? LocaleController.getString(R.string.InvLinkToSavedMessages) : LocaleController.formatString(R.string.InvLinkToUser, kh0Var.getMessagesController().getPeerName(j10, true));
            }
            org.telegram.ui.Components.ec Q = org.telegram.ui.Components.mc.a0(kh0Var).Q(R.raw.forward, 36, AndroidUtilities.replaceTags(formatString));
            Q.r = false;
            Q.k(true);
        }
    }
