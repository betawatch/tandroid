...
public final class gh0 extends org.telegram.ui.Components.g6 {
    ...
    public static void m(gh0 gh0Var, float f7, boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                if (childAt3.getVisibility() == 0 && (childAt3 instanceof ph.b) && ((ph.b) childAt3).h.f) {
                    view2 = childAt3;
                    break;
                }
                i12++;
        ...
        if (view != null) {
            ...
            for (int i13 = 0; i13 < childCount2; i13++) {
                ...
                if (childAt4 instanceof ph.b) {
                    ((ph.b) childAt4).e(childAt4 == view, true);
                }
            }
            if (z11) {
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            ...
            ((ph.b) ((org.telegram.ui.Components.f6) n10.a).a).setVisualWidth(n10.b().width());
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < childCount3; i18++) {
            ...
            if (childAt2 instanceof fh0) {
                ((ph.b) ((fh0) childAt2)).setTextSizeDp(f14);
            }
        }
