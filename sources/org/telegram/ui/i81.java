...
public final class i81 extends org.telegram.ui.Components.qa {
    ...
    public i81(final Context context, final int i10, final org.telegram.ui.ActionBar.c6 c6Var, final df dfVar) {
        ...
        hh.b bVar = new hh.b(context, i10, hf.b.b, c6Var);
        this.T = bVar;
        bVar.setScaleX(0.6f);
        bVar.setScaleY(0.6f);
        bVar.setAlpha(0.0f);
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            linearLayout.addView(b10, h7.z5.k(32.0f, 0.0f, 32.0f, 8.0f, -1, -2));
            TextView b11 = h7.d6.b(context, 14.0f, i11, false, null);
            b11.setGravity(17);
            b11.setText(LocaleController.getString(R.string.StakeDiceText));
            linearLayout.addView(b11, h7.z5.k(32.0f, 0.0f, 32.0f, 12.0f, -1, -2));
            LinearLayout linearLayout2 = new LinearLayout(context);
            linearLayout2.setOrientation(1);
            TextView b12 = h7.d6.b(context, 14.0f, org.telegram.ui.ActionBar.g6.L6, true, null);
            b12.setText(LocaleController.getString(R.string.StakeDiceReturns));
            linearLayout2.addView(b12, h7.z5.k(0.0f, 0.0f, 0.0f, 8.0f, -1, -2));
            ...
            TextView b13 = h7.d6.b(context, 14.0f, org.telegram.ui.ActionBar.g6.y6, false, null);
            b13.setGravity(17);
            ...
            linearLayout2.addView(b13, h7.z5.k(0.0f, 4.0f, 0.0f, 16.0f, -1, -2));
            ...
            Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.e81
            ...
            for (int i18 = 0; i18 < Utilities.divCeil(jArr.length, 3); i18++) {
                ...
                while (true) {
                    ...
                    if (i19 < Math.min(3, jArr.length - i20)) {
                        g10.addView((View) callbackReturn.run(Long.valueOf(jArr[i20 + i19])), h7.z5.p(0, 26, 1.0f, 112, 0, 0, i19 == 2 ? 0 : 6, 0));
                        i19++;
                    }
                }
                this.V.addView(g10, h7.z5.k(0.0f, 7.0f, 0.0f, 0.0f, -1, -2));
            }
            ...
            dVar2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.f81
                ...
                public final void onClick(View view) {
                    ...
                    try {
                        ...
                        if (TextUtils.isEmpty(text) || parseDouble >= MessagesController.getInstance(i21).tonStakeddiceStakeAmountMin / 1.0E9d) {
                            if (hh.u7.y(i21, true).f.toDouble() < parseDouble) {
                                new mh.f(context, c6Var, hf.a.i((long) (parseDouble * 1.0E9d), hf.b.b), true, new tq0(4));
                                return;
                            } else {
