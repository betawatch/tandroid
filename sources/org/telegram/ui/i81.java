...
public final class i81 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public i81(SessionsActivity sessionsActivity, Context context) {
        ...
        if (indexOf != -1 && indexOf2 != -1 && indexOf != indexOf2) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.l51(LocaleController.getString(R.string.AuthAnotherClientDownloadClientUrl), (org.telegram.ui.Components.s01) null), indexOf, indexOf2 - 1, 33);
        }
        ...
        if (indexOf3 != -1 && indexOf4 != -1 && indexOf3 != indexOf4) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.l51(LocaleController.getString(R.string.AuthAnotherWebClientUrl), (org.telegram.ui.Components.s01) null), indexOf3, indexOf4 - 1, 33);
        }
        ...
        pkVar.setOnClickListener(new v31(this, 5));
    ...
    public static void a(i81 i81Var) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && sessionsActivity.getParentActivity().checkSelfPermission("android.permission.CAMERA") != 0) {
            ...
            v9.e0(sessionsActivity.getParentActivity(), 2, new g81(sessionsActivity));
        }
    }
