...
public final class ap0 extends FrameLayout {
    ...
    public ap0(bp0 bp0Var, Context context) {
        super(context);
        this.d = bp0Var;
        ...
        boolean z4 = gp0Var.a;
        textView.setTextColor(gp0Var.getThemedColor(org.telegram.ui.ActionBar.j6.G6));
        if (bp0Var.d0 == 1) {
    ...
    public final int a() {
        ...
        if (i12 >= 0) {
            if (i12 < 7) {
                return gp0Var.getThemedColor(org.telegram.ui.ActionBar.j6.r8[i12]);
            }
            if (bp0Var.d0 == 1) {
            ...
            return (peerColors == null || (color = peerColors.getColor(bp0Var.n)) == null) ? gp0Var.getThemedColor(org.telegram.ui.ActionBar.j6.r8[0]) : color.getColor1();
        }
        int i13 = org.telegram.ui.ActionBar.j6.s8;
        if (AndroidUtilities.computePerceivedBrightness(gp0Var.getThemedColor(i13)) > 0.8f) {
        ...
        if (AndroidUtilities.computePerceivedBrightness(gp0Var.getThemedColor(i13)) < 0.2f) {
        ...
        return org.telegram.ui.ActionBar.j6.v(v02, org.telegram.ui.ActionBar.j6.l1(0.7f, gp0.u0(org.telegram.ui.ActionBar.j6.v0(i13, f6Var2))));
    }
    ...
    public final void b(boolean z4) {
        ...
        if (j10 != 0) {
            ...
            j5Var.g(null, z4);
            if (this.b == null) {
                this.b = new org.telegram.ui.Components.k01(LocaleController.getString(bp0Var.g0.a ? R.string.ChannelReplyIconOff : R.string.UserReplyIconOff), 16.0f, null);
            }
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (k01Var != null) {
            k01Var.c((getMeasuredWidth() - this.b.l()) - AndroidUtilities.dp(19.0f), getMeasuredHeight() / 2.0f, 1.0f, this.d.g0.getThemedColor(org.telegram.ui.ActionBar.j6.q6), canvas);
        } else {
            j5Var.draw(canvas);
        }
    }
