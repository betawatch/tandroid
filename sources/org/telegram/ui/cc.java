...
public final class cc extends og.b {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i13 == 0) {
            ...
            if (tL_statsPercentValue != null) {
                ...
                if (d != 0.0d) {
                    ua1Var.a("≈" + ((int) ecVar.d.premium_audience.part), 1, String.format(Locale.US, "%.1f", Float.valueOf((((float) tL_statsPercentValue.part) / ((float) d)) * 100.0f)).concat("%"), LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? R.string.PremiumSubscribers : R.string.PremiumMembers));
            ...
            ua1Var.a("≈0", 1, "0%", LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? R.string.PremiumSubscribers : R.string.PremiumMembers));
            ua1Var.a(String.valueOf(ecVar.d.boosts), 2, null, LocaleController.getString(R.string.BoostsExisting));
        ...
        if (i13 == 6) {
            ((org.telegram.ui.Cells.e9) view).setText(((dc) arrayList.get(i10)).c);
            return;
        }
        if (i13 == 9) {
            org.telegram.ui.Cells.x4 x4Var = (org.telegram.ui.Cells.x4) view;
            if (ecVar.y == 0) {
                x4Var.b(LocaleController.formatPluralString("BoostingShowMoreBoosts", ecVar.s, new Object[0]), R.drawable.arrow_more, 5, false);
                return;
            } else {
                x4Var.b(LocaleController.formatPluralString("BoostingShowMoreGifts", ecVar.w, new Object[0]), R.drawable.arrow_more, 5, false);
                return;
            }
        }
        if (i13 == 3) {
            ((org.telegram.ui.Components.v80) view).setLink(((dc) arrayList.get(i10)).c);
            return;
        }
        if (i13 == 11) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                view = new ua1(ecVar.getContext(), 2);
                break;
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                org.telegram.ui.Components.v80 v80Var = new org.telegram.ui.Components.v80(ecVar.getContext(), ecVar.c, null, false, false);
            ...
            case 4:
                ...
                break;
            case 5:
                view = new yg.b(ecVar.getContext());
                break;
            case 6:
            ...
            case 10:
                ...
                break;
            case 11:
                view = new yg.c(ecVar.getContext());
                break;
            case 12:
            ...
            case 13:
                ...
                ci.n6 n6Var = new ci.n6(this, ab1Var.getParentActivity());
                ecVar.f.setDelegate(new g(this, 11));
                n6Var.addView(ecVar.f, w7.x5.c(48.0f, -2));
                view = n6Var;
                break;
            default:
