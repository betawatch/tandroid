    ...
    */
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i24 == 0) {
            ...
            aaVar.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.j6.G6));
            ...
            if (i10 != privacyControlActivity.Q) {
                if (i10 == privacyControlActivity.Y) {
                    ...
                    if (i10 == privacyControlActivity.b0) {
                        ...
                        aaVar.setTextColor(privacyControlActivity.getThemedColor(org.telegram.ui.ActionBar.j6.n6));
                        return;
                    }
                    return;
                }
        ...
        if (i24 == 1) {
            ...
            if (i10 == privacyControlActivity.N) {
                ...
                if (i10 == i34 && i23 == 10) {
                    ...
                    a9Var.setText(AndroidUtilities.replaceSingleTag(string, new Runnable(this) { // from class: org.telegram.ui.bx0
                    ...
                    if (i10 == i12) {
                        a9Var.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.PrivacyBirthdaySet), new Runnable(this) { // from class: org.telegram.ui.bx0
                            public final /* synthetic */ ex0 b;
                        ...
                        if (i23 == 6) {
                            if (privacyControlActivity.F == 1 && privacyControlActivity.G == 1) {
                                ...
                                String e = vh.v2.e("https://t.me/+", privacyControlActivity.getUserConfig().getClientPhone());
                                SpannableString spannableString = new SpannableString(e);
                                spannableString.setSpan(new dx0(this, e), 0, e.length(), 33);
                        ...
                        a9Var.setText(LocaleController.formatString(R.string.PrivateMessagesPriceInfo, rh.k.G0(privacyControlActivity.getMessagesController().starsPaidMessageCommissionPermille), String.valueOf(((int) (((privacyControlActivity.I * (privacyControlActivity.getMessagesController().starsPaidMessageCommissionPermille / 1000.0f)) / 1000.0d) * privacyControlActivity.getMessagesController().starsUsdWithdrawRate1000)) / 100.0d)));
                    } else if (i10 == privacyControlActivity.h0) {
                        SpannableString spannableString2 = new SpannableString(ImageLoader.AUTOPLAY_FILTER);
                        org.telegram.ui.Components.mq mqVar = new org.telegram.ui.Components.mq(R.drawable.msg_input_gift, 0);
                        mqVar.setScale(0.583f, 0.583f);
        ...
        if (i24 != 3) {
            if (i24 != 8) {
                ...
                if (i10 == i22) {
                    ...
                    il0 il0Var = new il0(this, i25);
                    org.telegram.ui.Cells.w7 w7Var = new org.telegram.ui.Cells.w7();
                    w7Var.c = a2;
                    w7Var.d = 20;
                    w7Var.e = il0Var;
                    x7Var.d((int) Utilities.clamp(privacyControlActivity.I, privacyControlActivity.getMessagesController().starsPaidMessageAmountMax, 1L), w7Var, new cx0(this, r8 ? 1 : 0));
                    return;
                }
                return;
            }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 6:
                ...
                privacyControlActivity.q0 = new org.telegram.ui.Components.gj0(R.raw.camera_outline, "" + R.raw.camera_outline, AndroidUtilities.dp(50.0f), AndroidUtilities.dp(50.0f), false, null);
                privacyControlActivity.r0.e.setTranslationX((float) (-AndroidUtilities.dp(8.0f)));
            ...
            case 7:
                ...
                privacyControlActivity.t0 = new ls(this, privacyControlActivity.getParentActivity());
                ...
                ls lsVar = privacyControlActivity.t0;
