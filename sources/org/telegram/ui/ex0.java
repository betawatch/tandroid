...
public final class ex0 extends org.telegram.ui.Components.ll0 {
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        org.telegram.ui.Components.q01[] q01VarArr = (org.telegram.ui.Components.q01[]) spannableString.getSpans(0, spannableString.length(), org.telegram.ui.Components.q01.class);
        int length = q01VarArr.length;
        int i15 = 0;
        while (i15 < length) {
            org.telegram.ui.Components.p01 p01Var = q01VarArr[i15].b;
            TLRPC.MessageEntity messageEntity = p01Var.d;
            ...
            TLRPC.MessageEntity messageEntity2 = p01Var.d;
            if (messageEntity2 instanceof TLRPC.TL_messageEntityBotCommand) {
                spannableString.setSpan(new org.telegram.ui.Components.k51(str, 0, p01Var), p01Var.b, p01Var.c, 33);
            } else {
                if ((messageEntity2 instanceof TLRPC.TL_messageEntityHashtag) || (messageEntity2 instanceof TLRPC.TL_messageEntityMention) || (messageEntity2 instanceof TLRPC.TL_messageEntityCashtag)) {
                    str2 = str3;
                    i11 = 33;
                    spannableString.setSpan(new org.telegram.ui.Components.n51(str, p01Var), p01Var.b, p01Var.c, 33);
                } else if (messageEntity2 instanceof TLRPC.TL_messageEntityEmail) {
                    spannableString.setSpan(new org.telegram.ui.Components.p51(org.telegram.ui.Cells.p6.i("mailto:", str), p01Var), p01Var.b, p01Var.c, 33);
                } else if (messageEntity2 instanceof TLRPC.TL_messageEntityUrl) {
                    if (str.toLowerCase().contains("://")) {
                        spannableString.setSpan(new org.telegram.ui.Components.l51(str, p01Var), p01Var.b, p01Var.c, 33);
                    } else {
                        spannableString.setSpan(new org.telegram.ui.Components.l51("http://".concat(str), p01Var), p01Var.b, p01Var.c, 33);
                    }
                } else if (messageEntity2 instanceof TLRPC.TL_messageEntityBankCard) {
                    spannableString.setSpan(new org.telegram.ui.Components.n51(org.telegram.ui.Cells.p6.i("card:", str), p01Var), p01Var.b, p01Var.c, 33);
                } else if (messageEntity2 instanceof TLRPC.TL_messageEntityPhone) {
                    String d = gf.b.d(str, z11);
                    if (str.startsWith("+")) {
                        d = org.telegram.ui.Cells.p6.i("+", d);
                    }
                    spannableString.setSpan(new org.telegram.ui.Components.l51(org.telegram.ui.Cells.p6.i("tel:", d), p01Var), p01Var.b, p01Var.c, 33);
                } else if (messageEntity2 instanceof TLRPC.TL_messageEntityTextUrl) {
                    org.telegram.ui.Components.p51 p51Var = new org.telegram.ui.Components.p51(p01Var.d.url, p01Var);
                    p51Var.b = true;
                    spannableString.setSpan(p51Var, p01Var.b, p01Var.c, 33);
                    if (!z10) {
                        spannableString.setSpan(new org.telegram.ui.Components.g51(AndroidUtilities.bold()), p01Var.b, p01Var.c, 33);
                    }
                } else {
                    if (messageEntity2 instanceof TLRPC.TL_messageEntityMentionName) {
                        StringBuilder sb2 = new StringBuilder(str3);
                        str2 = str3;
                        sb2.append(((TLRPC.TL_messageEntityMentionName) p01Var.d).user_id);
                        spannableString.setSpan(new org.telegram.ui.Components.q51(sb2.toString(), 0, p01Var), p01Var.b, p01Var.c, 33);
                    } else {
                        str2 = str3;
                        if (messageEntity2 instanceof TLRPC.TL_inputMessageEntityMentionName) {
                            spannableString.setSpan(new org.telegram.ui.Components.q51(str2 + ((TLRPC.TL_inputMessageEntityMentionName) p01Var.d).user_id.user_id, 0, p01Var), p01Var.b, p01Var.c, 33);
                        } else if ((p01Var.a & 4) != 0) {
                            str2 = str2;
                            i11 = 33;
                            spannableString.setSpan(new org.telegram.ui.Components.m51(spannableString, p01Var.b, p01Var.c, (byte) 0, p01Var), p01Var.b, p01Var.c, 33);
                        } else {
                            str2 = str2;
                            spannableString.setSpan(new org.telegram.ui.Components.q01(p01Var, 0), p01Var.b, p01Var.c, 33);
                            i15++;
                            str3 = str2;
                            z11 = false;
                        }
                ...
                if ((p01Var.a & 256) != 0) {
                    spannableString.setSpan(new org.telegram.ui.Components.q01(p01Var, 0), p01Var.b, p01Var.c, i11);
                    i15++;
                    str3 = str2;
                    z11 = false;
                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 7:
                ...
                break;
            case 8:
                f6Var = ((org.telegram.ui.ActionBar.o2) this.c).resourceProvider;
