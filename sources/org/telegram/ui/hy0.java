...
public final /* synthetic */ class hy0 implements Runnable {
    public final /* synthetic */ int a;
    public final /* synthetic */ ProfileActivity b;
    public final /* synthetic */ TLRPC.User c;

    public /* synthetic */ hy0(ProfileActivity profileActivity, TLRPC.User user, int i10) {
        this.a = i10;
    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                profileActivity.presentFragment(bo.R9(user.id));
                break;
            case 1:
            ...
            default:
                ...
                try {
                    ...
                    if (AndroidUtilities.shouldShowClipboardToast()) {
                        org.telegram.ui.Components.vc.a0(profileActivity5).i(LocaleController.getString(R.string.PhoneCopied)).j();
                        break;
                    }
                } catch (Exception e7) {
                    FileLog.e(e7);
