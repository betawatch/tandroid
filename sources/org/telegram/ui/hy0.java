...
public final class hy0 implements org.telegram.ui.Components.bl0 {
    ...
    public static void a(hy0 hy0Var, Context context, int i10) {
        ...
        if (i10 == 6) {
            ...
            i17 = ((org.telegram.ui.ActionBar.o2) hy0Var.c).currentAccount;
        ...
        if (i10 == 7) {
            org.telegram.ui.Components.voip.h2.j(hy0Var.c.getParentActivity());
            return;
        }
        if (i10 == 8) {
        ...
        try {
            ...
            if (i10 == 18) {
                i7.o8.a((LaunchActivity) hy0Var.c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
            ...
            if (i10 != 20) {
                ...
                if (i10 == 23) {
                    boolean q6 = nh.c1.q(hy0Var.c.getParentActivity());
                ...
                if (i10 == 24) {
                    ...
                    while (i18 < hy0Var.c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.o2) hy0Var.c.getParentLayout().getFragmentStack().get(i18)).clearSheets();
                        i18++;
                    }
                    return;
                }
            ...
            ProfileActivity.S0(hy0Var.c, MediaController.VIDEO_MIME_TYPE, sb3);
            ProfileActivity.S0(hy0Var.c, "video/hevc", sb3);
            ProfileActivity.S0(hy0Var.c, "video/x-vnd.on2.vp8", sb3);
            ProfileActivity.S0(hy0Var.c, "video/x-vnd.on2.vp9", sb3);
            hy0Var.c.showDialog(new gy0(hy0Var, hy0Var.c.getParentActivity(), sb3.toString()));
    ...
    public final boolean c(int i10, View view) {
        ...
        if (i10 != profileActivity.v3) {
            ...
            try {
                ...
                org.telegram.ui.Components.tc.a0(profileActivity).i(LocaleController.getString(R.string.BirthdayCopied)).j();
                return true;
            } catch (Exception e10) {
                FileLog.e(e10);
                return true;
        ...
        String string15 = LocaleController.getString(nh.c1.q(profileActivity.getParentActivity()) ? "DebugMenuDualOff" : "DebugMenuDualOn");
        ...
        i13 = ((org.telegram.ui.ActionBar.o2) profileActivity).currentAccount;
        ...
        if (SharedConfig.canBlurChat()) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                alertDialog$Builder.f(charSequenceArr, new ag.y1(10, this, this.b));
                alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
        ...
        alertDialog$Builder.f(charSequenceArr2, new ag.y1(10, this, this.b));
        alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
        profileActivity.showDialog(c2Var);
        return true;
    }
