...
public final /* synthetic */ class c0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            case 0:
                ...
                new org.telegram.ui.Components.mc(q3Var.f, null).k(false).k(true);
                break;
            case 1:
                e7 e7Var = (e7) obj3;
            ...
            case 7:
                ...
                org.telegram.ui.ActionBar.n2 n2Var2 = dnVar.a;
                n2Var2.finishPreviewFragment();
                chat.left = false;
                if (s1Var != null && s1Var.v != null) {
                    n2Var2.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.channelRecommendationsLoaded, Long.valueOf(s1Var.v.e));
                }
                n2Var2.getMessagesController().addUserToChat(chat.id, n2Var2.getUserConfig().getCurrentUser(), 0, null, n2Var2, new rm(dnVar, chat, i11));
                break;
            case 8:
                jo joVar = (jo) obj3;
            ...
            case 9:
                ...
                PhotoViewer photoViewer = ((nr) obj3).c.a;
                    ...
                    while (true) {
                        if (i13 < size) {
                            ...
                            for (int i14 = 0; i14 < arrayList.size(); i14++) {
                                ...
                                if (k61Var3.k < j11 && org.telegram.ui.Components.m61.Y(k61Var3.m)) {
                                    j11 = k61Var3.k;
                                    k61Var2 = k61Var3;
                                }
                            }
                            document = k61Var2 != null ? k61Var2.g : ((org.telegram.ui.Components.k61) arrayList.get(0)).g;
                        }
                    }
                }
                if (document != null) {
                    ...
                    if (pathToAttach == null || !pathToAttach.exists()) {
                        ...
                        MediaController.saveFilesFromMessages(photoViewer.y, AccountInstance.getInstance(photoViewer.P), arrayList2, new ra(photoViewer, i11));
                    } else {
                        MediaController.saveFile(pathToAttach.toString(), photoViewer.y, 1, null, null, new nq0(photoViewer, i12));
                    }
            ...
            case 10:
                ...
                org.telegram.ui.Components.y4.O((Context) obj2, LocaleController.getString(R.string.ResetToOriginalPhotoTitle), LocaleController.formatString(R.string.ResetToOriginalPhotoMessage, user.first_name), LocaleController.getString(R.string.Reset), new as(jsVar, user, i12), jsVar.r).o();
                break;
            case 11:
                qg0 qg0Var = (qg0) obj3;
                ((org.telegram.ui.Components.b70) obj2).u();
                int i15 = ((MessagesController.DialogFilter) obj).id;
                if (qg0Var.c.getCurrentPosition() != 0 || (gyVar = qg0Var.F) == null) {
                    if (qg0Var.F == null) {
                        qg0Var.l0(null);
                    }
    ...
    public /* synthetic */ c0(org.telegram.ui.ActionBar.e3[] e3VarArr, Utilities.Callback callback, String str) {
        this.a = 12;
        this.b = e3VarArr;
        this.d = callback;
        this.c = str;
