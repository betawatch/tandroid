        ...
        public void onItemClick(int i) {
            if (i == -1) {
                if (ChannelCreateActivity.this.donePressed) {
                    ...
                    ChannelCreateActivity.this.lambda$onBackPressed$355();
                    return;
                }
            }
            if (i == 1) {
                            ...
                            if (i16 == 1) {
                                ...
                                if (i15 == 16) {
                                    if (i15 == 48) {
                                        ...
                                        i11 = ((i8 - emojiPadding) - i6) - measuredHeight;
                                    }
                                    if (ChannelCreateActivity.this.nameTextView != null && ChannelCreateActivity.this.nameTextView.isPopupView(childAt)) {
                                        i12 = (!AndroidUtilities.isTablet() ? getMeasuredHeight() : getMeasuredHeight() + measureKeyboardHeight) - childAt.getMeasuredHeight();
                                    }
                                    childAt.layout(i10, i12, measuredWidth + i10, measuredHeight + i12);
                                } else {
                                    i11 = ((((i8 - emojiPadding) - i6) - measuredHeight) / 2) + layoutParams.topMargin;
                                }
