...
public final /* synthetic */ class f6 implements Runnable {
    ...
    public /* synthetic */ f6(b7 b7Var, int i10) {
        this.a = i10;
        this.b = b7Var;
    }
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < longSparseArray.size(); i10++) {
                    ...
                    arrayList.add(u6Var);
                    if (b7Var2.getMessagesController().getUserOrChat(((u6) arrayList.get(i10)).a) == null) {
                        long j10 = u6Var.a;
                        if (j10 > 0) {
            ...
            default:
                ...
                if (!b7.h0) {
                    b7Var3.r = b7.q0(4, FileLoader.checkDirectory(4));
                    if (!b7.h0) {
                        long q02 = b7.q0(0, FileLoader.checkDirectory(0));
                        b7Var3.y = q02;
                        b7Var3.y = b7.q0(0, FileLoader.checkDirectory(100)) + q02;
                        if (!b7.h0) {
                            ...
                            if (!b7.h0) {
                                ...
                                if (!b7.h0) {
                                    ...
                                    b7Var3.s = q05;
                                    b7Var3.s = b7.q0(1, FileLoader.checkDirectory(5)) + q05;
                                    if (!b7.h0) {
                                        long q06 = b7.q0(2, FileLoader.checkDirectory(3));
                                        b7Var3.x = q06;
                                        b7Var3.x = b7.q0(2, FileLoader.checkDirectory(5)) + q06;
                                        if (!b7.h0) {
                                            b7Var3.D = b7.q0(0, new File(FileLoader.checkDirectory(4), "acache"));
                                            if (!b7.h0) {
                                                b7Var3.n = b7.q0(3, FileLoader.checkDirectory(4));
                                                if (!b7.h0) {
                                                    b7Var3.D += b7Var3.n;
                                                    b7Var3.v = b7.q0(0, FileLoader.checkDirectory(1));
                                                    b7Var3.w = b7.q0(0, FileLoader.checkDirectory(6));
                                                    if (!b7.h0) {
                                                        long j11 = b7Var3.h + b7Var3.r + b7Var3.B + b7Var3.C + b7Var3.v + b7Var3.y + b7Var3.s + b7Var3.x + b7Var3.w + b7Var3.D;
                                                        b7.j0 = Long.valueOf(j11);
                                                        b7Var3.E = j11;
