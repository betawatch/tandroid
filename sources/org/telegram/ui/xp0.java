    ...
    public final void b() {
        ...
        while (true) {
            ...
            if (i11 == 2) {
                ...
                int i14 = iArr[i12];
                wp0Var2.o = i14;
                int v03 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.r8[i14], e6Var);
                wp0Var2.g = false;
                wp0Var2.f = false;
        ...
        if (this.f != null) {
            ...
            while (true) {
                ...
                if (e > 0.0f) {
                    ...
                    paint2.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.d6, xp0Var.a));
                ...
                if (wp0Var.h) {
                    if (xp0Var.e) {
                        ...
                        wp0Var.k.setBounds((int) org.telegram.messenger.vl.c(wp0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) org.telegram.messenger.vl.c(wp0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()), (int) a4.a.e(wp0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) a4.a.e(wp0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()));
