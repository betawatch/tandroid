...
public final class nk extends ChatActivityEnterView {
    ...
    public final void U1() {
        ...
        if (i11 != 0 && backgroundTop != i11 && this.o5 == boVar.X0.getMeasuredHeight()) {
            ...
            boVar.p9 = ofFloat;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.mk
        ...
        if (this.m3) {
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.mk
                public final /* synthetic */ nk b;
