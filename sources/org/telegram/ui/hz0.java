...
public final class hz0 extends org.telegram.ui.Components.hu0 {
    ...
    public final void D0(SparseArray sparseArray) {
        ...
        if (profileActivity.o1) {
            ...
            char c10 = (org.telegram.ui.Components.hu0.w0(selectedTab) || selectedTab == 8) ? (char) 0 : selectedTab == 9 ? (char) 1 : (char) 65535;
            if (c10 >= 0) {
                if (c10 == 0) {
    ...
    */
    public final void b1(boolean z10) {
        ...
        if (profileActivity.o1) {
            ...
            if (!z10) {
                ...
                animate.translationY(f10).setDuration(320L).setInterpolator(org.telegram.ui.Components.er.h).setUpdateListener(new g3(this, 27)).start();
            }
            f10 = 0.0f;
            animate.translationY(f10).setDuration(320L).setInterpolator(org.telegram.ui.Components.er.h).setUpdateListener(new g3(this, 27)).start();
        }
    ...
    public final void v1(boolean z10) {
        ...
        if (z11 && !profileActivity.s1 && this.E0.e(14)) {
            if (!this.b2 && (i11 = profileActivity.q1) > 0 && wq0Var != null) {
                this.b2 = true;
                wq0Var.I = i11;
                wq0Var.e();
            }
        ...
        if (!profileActivity.p1 || !profileActivity.s1 || this.b2 || (i10 = profileActivity.q1) <= 0 || wq0Var == null) {
            return;
        }
        this.b2 = true;
        wq0Var.I = i10;
