...
public final class yx0 extends org.telegram.ui.Components.ll0 {
    public final Context c;
    public final /* synthetic */ zx0 d;

    public yx0(zx0 zx0Var, Context context) {
        this.d = zx0Var;
        this.c = context;
    }
    ...
    public final int j(int i10) {
        ...
        return (i10 == zx0Var.h || i10 == zx0Var.v) ? 1 : 0;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 == 0) {
            ...
            long keyAt = zx0Var.getMessagesController().blockePeers.keyAt(i10 - zx0Var.r);
            b5Var.setTag(Long.valueOf(keyAt));
            if (keyAt <= 0) {
                TLRPC.Chat chat = zx0Var.getMessagesController().getChat(Long.valueOf(-keyAt));
                if (chat != null) {
                    int i13 = chat.participants_count;
                    b5Var.b(chat, null, i13 != 0 ? LocaleController.formatPluralString("Members", i13, new Object[0]) : chat.has_geo ? LocaleController.getString(R.string.MegaLocation) : !ChatObject.isPublic(chat) ? LocaleController.getString(R.string.MegaPrivate) : LocaleController.getString(R.string.MegaPublic), i10 != zx0Var.s - 1);
                    return;
                }
                return;
            }
            TLRPC.User user = zx0Var.getMessagesController().getUser(Long.valueOf(keyAt));
            if (user != null) {
                if (user.bot) {
                    ...
                    string = (str == null || str.length() == 0) ? LocaleController.getString(R.string.NumberUnknown) : org.telegram.messenger.ul.h(new StringBuilder("+"), user.phone, gf.b.c());
                }
                b5Var.b(user, null, string, i10 != zx0Var.s - 1);
                return;
            }
            return;
        }
        ...
        if (i10 == zx0Var.n) {
            if (i11 == 1) {
                m4Var.setText(LocaleController.formatPluralString("BlockedUsersCount", zx0Var.getMessagesController().totalBlockedCount, new Object[0]));
            } else {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            b5Var.setDelegate(new nl0(this, 10));
            frameLayout = b5Var;
        }
