...
public class lw0 extends FrameLayout {
    ...
    public final void a(bx0 bx0Var, boolean z10) {
        ...
        if (isPremium && bx0Var.a == 12 && bx0Var.b == R.drawable.filled_premium_status2) {
        ...
        this.f = bx0Var;
        this.a.l(bx0Var.c, false);
        this.b.setText(bx0Var.d);
        this.c.setImageResource(bx0Var.b);
        this.e = z10;
    }
    ...
    public final void b(long j3, boolean z10) {
        ...
        if (this.n == null) {
            ...
            this.n = mutate;
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.v6, false), PorterDuff.Mode.SRC_IN));
        }
        this.h.g(this.n, z10);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.h != null) {
            c();
            this.h.k(Integer.valueOf(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.v6, false)));
            this.h.draw(canvas);
        }
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.h6.k0);
        }
    }
