...
public final class c2 extends FrameLayout implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.q9 {
    public boolean E;
    public int F;
    public int G;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (imageReceiver.hasBitmapImage() && imageReceiver.getCurrentAlpha() == 1.0f) {
            ...
            canvas2 = canvas;
            canvas2.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX2(), imageReceiver.getImageY2(), h4.o1);
        }
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        if (i23 == 1) {
            ...
            if (i23 != 2) {
                ...
                if (pageblockphoto != null) {
                    this.L = e4.d(pageblockphoto.photo_id, this.O);
                    ...
                    if (i23 != 0 || (i22 = this.N.level) <= 0) {
                        ...
                        this.s = i15;
                        i14 = org.telegram.messenger.rk.x(18.0f, i15, i12);
                        dp = i14;
                    }
                    ...
                    if (photo == null || (this.H == null && !(photo instanceof org.telegram.ui.web.i2))) {
                        ...
                        if (i23 == 0) {
                            ...
                            this.K = "80_80_b";
                            h4 h4Var = (h4) this.a;
                            this.T = (DownloadController.getInstance(h4Var.X).getCurrentDownloadMask() & 1) == 0;
                            if (!this.Q) {
                                if (this.L instanceof org.telegram.ui.web.i2) {
                                    this.T = true;
                                    imageReceiver.setStrippedLocation(null);
                                    org.telegram.ui.web.j2.g((org.telegram.ui.web.i2) this.L, imageReceiver, new mu0(this, 9));
                                } else {
                                    File pathToAttach = FileLoader.getInstance(h4Var.X).getPathToAttach(this.H, true);
                                    if (this.T || pathToAttach.exists()) {
                                        imageReceiver.setStrippedLocation(null);
                                        imageReceiver.setImage(ImageLocation.getForPhoto(this.H, this.L), this.I, ImageLocation.getForPhoto(this.J, this.L), this.K, this.H.size, null, f4Var2 != null ? f4Var2.E : null, 1);
                                    } else {
                                        imageReceiver.setStrippedLocation(ImageLocation.getForPhoto(this.H, this.L));
                                        imageReceiver.setImage(null, this.I, ImageLocation.getForPhoto(this.J, this.L), this.K, this.H.size, null, f4Var2 != null ? f4Var2.E : null, 1);
                                    }
                                }
                            }
                            float f11 = dp2;
                        ...
                        this.K = "80_80_b";
                        h4 h4Var2 = (h4) this.a;
                        this.T = (DownloadController.getInstance(h4Var2.X).getCurrentDownloadMask() & 1) == 0;
                        if (!this.Q) {
                        }
                        float f112 = dp2;
                    ...
                    if (i23 == 0) {
                        TL_iv.pageBlockPhoto pageblockphoto2 = this.N;
                        a3 q6 = h4.q(this.a, this, null, pageblockphoto2.caption.text, dp, imageHeight3, pageblockphoto2, this.b);
                        this.c = q6;
                        if (q6 != null) {
                        ...
                        f4Var = f4Var2;
                        a3 p5 = h4.p(this.a, this, null, pageblockphoto3.caption.credit, dp, this.v + this.w, pageblockphoto3, (f4Var2 == null || !f4Var2.G) ? Layout.Alignment.ALIGN_NORMAL : org.telegram.ui.Components.uw0.a(), 0, this.b);
                        this.d = p5;
                    ...
                    i24 = (i23 == 2 || ((this.P instanceof TL_iv.pageBlockCover) && f4Var != null && (arrayList = f4Var.e) != null && arrayList.size() > 1 && (arrayList.get(1) instanceof TL_iv.pageBlockChannel))) ? i16 : AndroidUtilities.dp(8.0f) + i16;
                    a3 a3Var = this.c;
                    if (a3Var != null) {
                        a3Var.s = this.s;
                        a3Var.v = this.v;
                    ...
                    if (a3Var2 != null) {
                        a3Var2.s = this.s;
                        a3Var2.v = this.v + this.w;
                    }
                }
                c1 c1Var = this.h;
                c1Var.measure(i10, i11);
                c1Var.setTranslationY(imageReceiver.getImageHeight() - AndroidUtilities.dp(39.0f));
        ...
        c1 c1Var2 = this.h;
        c1Var2.measure(i10, i11);
        c1Var2.setTranslationY(imageReceiver2.getImageHeight() - AndroidUtilities.dp(39.0f));
        setMeasuredDimension(i12, i24);
    }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        f4 f4Var = this.b;
        if (visibility != 0 || y3 <= c1Var.getTranslationY() || y3 >= c1Var.getTranslationY() + AndroidUtilities.dp(39.0f)) {
            ...
            if (!this.E && this.G == 0) {
                if (!h4.l(this.a, this.b, motionEvent, this, this.c, this.s, this.v)) {
                    if (!h4.l(this.a, this.b, motionEvent, this, this.d, this.s, this.v + this.w) && !super.onTouchEvent(motionEvent)) {
                        return false;
                    }
                }
            }
        } else if (f4Var != null && f4Var.F != null) {
