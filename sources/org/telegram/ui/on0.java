...
public final class on0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public on0(qn0 qn0Var, Activity activity) {
        ...
        this.c = u9Var;
        addView(u9Var, w7.x5.d(48, 48.0f, (LocaleController.isRTL ? 5 : 3) | 48, 21.0f, 8.0f, 21.0f, 0.0f));
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int measuredWidth = ((u9Var.getMeasuredWidth() - AndroidUtilities.dp(24.0f)) / 2) + u9Var.getLeft();
        int measuredHeight = ((u9Var.getMeasuredHeight() - AndroidUtilities.dp(24.0f)) / 2) + u9Var.getTop();
