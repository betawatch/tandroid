...
public final /* synthetic */ class lv implements Runnable {
    ...
    public /* synthetic */ lv(qy qyVar, int i10) {
        this.a = i10;
        this.b = qyVar;
    }
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 3:
                qy qyVar3 = this.b;
                qyVar3.X.r.requestFocus();
                AndroidUtilities.showKeyboard(qyVar3.X.r);
                break;
            case 4:
                qy qyVar4 = this.b;
                qyVar4.getClass();
                Bundle bundle = new Bundle();
                bundle.putLong("community_id", qyVar4.X2);
                qyVar4.presentFragment(new fi.p(bundle));
                break;
            case 5:
                qy qyVar5 = this.b;
                qyVar5.e0[0].a.requestLayout();
                kx kxVar = qyVar5.F3;
                if (kxVar != null && (kxVar.getFragment() instanceof wf1)) {
                    wf1Var = (wf1) qyVar5.F3.getFragment();
                }
                if (wf1Var != null) {
                    wf1Var.B0();
                }
            ...
            case 6:
                qy qyVar6 = this.b;
                qyVar6.getClass();
                qyVar6.presentFragment(new z81(null));
                break;
            case 7:
                qy qyVar7 = this.b;
                if (!qyVar7.Y2.collapsed_in_dialogs) {
                    qyVar7.getMessagesController().toggleCommunityCollapsedInDialogs(qyVar7.X2, true);
            ...
            case 8:
                qy qyVar8 = this.b;
                if (qyVar8.Y2.collapsed_in_dialogs) {
                    qyVar8.getMessagesController().toggleCommunityCollapsedInDialogs(qyVar8.X2, false);
                ...
                if (!qy.w4) {
                    ...
                    if (string.equals(string2)) {
                        if (g6Var.q() || string.equals("Dark Blue") || string.equals("Night")) {
                            ...
                            u0Var = qyVar10.k0;
                            if (u0Var != null) {
                                int[] iArr = {(qyVar10.k0.getIconView().getMeasuredWidth() / 2) + r7, (qyVar10.k0.getIconView().getMeasuredHeight() / 2) + r7};
                            ...
                            if (i10 == 0) {
                                if (a02 != null) {
                                    try {
                                        a02.I(R.raw.auto_night_off, i10 == 3 ? LocaleController.getString("AutoNightSystemModeOff", R.string.AutoNightSystemModeOff) : LocaleController.getString("AutoNightModeOff", R.string.AutoNightModeOff), LocaleController.getString("Settings", R.string.Settings), 5000, false, lvVar).j();
                                    } catch (Exception e) {
                                        FileLog.e(e);
                                    }
                                }
            ...
            case 12:
                qy qyVar11 = this.b;
                qyVar11.getClass();
                qyVar11.presentFragment(new z60(new Bundle()));
                break;
            case 13:
                qy.b0(this.b);
                break;
            ...
            case 17:
                ...
                k2Var.a = true;
                qyVar12.showAsSheet(new PrivacyControlActivity(11, false), k2Var);
                break;
            case 18:
            ...
            case 19:
                qy qyVar13 = this.b;
                ArrayList arrayList = qyVar13.I2;
                qyVar13.J2 = false;
                if (qyVar13.C2 != null && !arrayList.isEmpty()) {
                    ArrayList arrayList2 = new ArrayList();
                    for (int i14 = 0; i14 < arrayList.size(); i14++) {
                        arrayList2.add(MessagesStorage.TopicKey.of(((Long) arrayList.get(i14)).longValue(), 0L));
                    }
                    qyVar13.C2.u(qyVar13, arrayList2, qyVar13.B1.getFieldText(), false, qyVar13.J2, qyVar13.K2, qyVar13.L2, null);
                    break;
                }
                break;
            case 20:
                qy qyVar14 = this.b;
                org.telegram.ui.Components.e5.M(qyVar14.getParentActivity(), -1L, new xx(qyVar14), qyVar14.getResourceProvider());
                break;
            case 21:
                qy.y0(this.b);
                break;
            ...
            default:
                qy qyVar20 = this.b;
                zx zxVar2 = qyVar20.C0;
                if (zxVar2 == null || !zxVar2.y0) {
                    qyVar20.X.r.getText().clear();
                    AndroidUtilities.hideKeyboard(qyVar20.X.r);
                    qyVar20.X.r.clearFocus();
                    qyVar20.Y.b(false);
                    break;
                } else {
                    zxVar2.Q(false);
