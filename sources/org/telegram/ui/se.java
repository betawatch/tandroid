...
public final /* synthetic */ class se implements Runnable {
    ...
    public /* synthetic */ se(bo boVar, String str, CharacterStyle characterStyle, MessageObject messageObject, org.telegram.ui.Cells.t1 t1Var, boolean z10, boolean z11) {
        this.e = boVar;
        this.c = str;
    ...
    public final void run() {
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            default:
                yh.a4.A0((yh.a4) this.e, (TLObject) this.c, this.b, (TLRPC.Document) this.f, this.d, (TLRPC.TL_error) this.h, (TL_stars.saveStarGift) this.n);
                break;
        }
    }
    ...
    public /* synthetic */ se(yh.a4 a4Var, TLObject tLObject, boolean z10, TLRPC.Document document, boolean z11, TLRPC.TL_error tL_error, TL_stars.saveStarGift savestargift) {
        this.e = a4Var;
        this.c = tLObject;
        this.b = z10;
        this.f = document;
