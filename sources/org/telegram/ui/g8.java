...
public final class g8 extends FrameLayout {
    ...
    public g8(j8 j8Var, Context context) {
        ...
        this.s = uVar;
        ((GestureDetector) uVar.b).setIsLongpressEnabled(j8Var.e0 == 0);
    }
    ...
    public static void b(g8 g8Var, float f7) {
        if (g8Var.n != null) {
            for (int i10 = 0; i10 < g8Var.d; i10++) {
                ...
                if (h8Var != null) {
                    float f10 = h8Var.m;
                    h8Var.l = com.google.android.gms.internal.vision.e2.z(h8Var.n, f10, f7, f10);
                    float f11 = h8Var.j;
                    h8Var.i = com.google.android.gms.internal.vision.e2.z(h8Var.k, f11, f7, f11);
                }
            }
        }
        g8Var.invalidate();
    ...
    public final void c(int i10, int i11, int i12, boolean z10, boolean z11) {
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.z7
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                float f22 = f14;
                float f23 = f16;
                i8Var3.b = com.google.android.gms.internal.vision.e2.z(f22, f23, floatValue, f23);
                float f24 = f17;
                float f25 = f11;
                i8Var3.c = com.google.android.gms.internal.vision.e2.z(f24, f25, floatValue, f25);
                g8Var.invalidate();
            }
        });
        duration.addListener(new f8(this, i8Var2, f19, f14, f17, i10, z10));
        duration.start();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i8Var != null) {
                ...
                float f18 = dp2 / 2.0f;
                i14 = dp2;
                rectF.set(i8Var.a - f18, dp3 - f18, i8Var.b + f18, dp3 + f18);
        ...
        while (i18 < g8Var.d) {
            ...
            int i22 = g8Var.h;
            int i23 = i18 + 1;
            if (currentTimeMillis < (i23 * 86400) + i22 || ((i11 = j8Var2.c0) > 0 && i11 > ((i18 + 2) * 86400) + i22)) {
                paint = paint7;
                paint2 = paint9;
                f10 = measuredWidth;
                paint3 = paint10;
                ...
                if (g8Var.r.get(i18) != null) {
                    ...
                    if (h8Var.e >= f21) {
                        ...
                        if (f24 != 1.0f) {
                            ...
                            paint5 = paint6;
                            ((ImageReceiver) g8Var.r.get(i13)).setImageCoords(f12 - ((AndroidUtilities.dp(44.0f) - i12) / 2.0f), f13 - ((AndroidUtilities.dp(44.0f) - i12) / 2.0f), AndroidUtilities.dp(44.0f) - i12, AndroidUtilities.dp(44.0f) - i12);
                            ...
                            if (g8Var.n.get(i13) != null && ((h8) g8Var.n.get(i13)).a != null && ((h8) g8Var.n.get(i13)).a.hasMediaSpoilers()) {
                                ...
                                hVar.h(i0.a.k(-1, (int) (Color.alpha(-1) * 0.325f * h8Var.d)));
