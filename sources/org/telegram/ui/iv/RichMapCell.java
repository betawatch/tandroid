...
public class RichMapCell extends RichBlockCell implements Theme.Colorable, TextSelectionHelper.ArticleSelectableView, RichCaptionHost {
    ...
    public RichMapCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        view.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.iv.RichMapCell$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view2) {
                RichMapCell.$r8$lambda$oAtZD4Guvuz8abQ26JVD59i2l7c(RichMapCell.this, view2);
            }
        });
    ...
    public static /* synthetic */ void $r8$lambda$oAtZD4Guvuz8abQ26JVD59i2l7c(RichMapCell richMapCell, View view) {
        Delegate delegate;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (map != null && map.w > 0 && map.h > 0) {
            this.mapImageH = Math.max(Math.min((int) (((max - AndroidUtilities.dp(32.0f)) * map.h) / map.w), AndroidUtilities.dp(420.0f)), AndroidUtilities.dp(120.0f));
        } else {
            this.mapImageH = (AndroidUtilities.dp(200.0f) - getPaddingTop()) - getPaddingBottom();
        }
        int measure = this.caption.measure(paddingLeft, paddingRight, size);
        this.clickView.measure(View.MeasureSpec.makeMeasureSpec(max, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(this.mapImageH, TLObject.FLAG_30));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.imageReceiver.setImageCoords(paddingLeft, getPaddingTop(), max, this.mapImageH);
        this.clickView.layout(paddingLeft, getPaddingTop(), max + paddingLeft, getPaddingTop() + this.mapImageH);
