...
public class RichEditorHistory {
    ...
    private final Runnable commitRunnable = new Runnable() { // from class: org.telegram.ui.iv.RichEditorHistory$$ExternalSyntheticLambda0
        @Override // java.lang.Runnable
        public final void run() {
            RichEditorHistory.this.commit();
        }
    };
    ...
    public void commit() {
        ...
        this.dirty = false;
        if (sameAs(this.baseline, capture)) {
            return;
        }
        this.undoStack.addLast(this.baseline);
    ...
    private static TL_iv.PageBlock deserializeBlock(byte[] bArr) {
        try {
            ...
            TL_iv.PageBlock TLdeserialize = TL_iv.PageBlock.TLdeserialize(serializedData, serializedData.readInt32(true), true);
            serializedData.cleanup();
