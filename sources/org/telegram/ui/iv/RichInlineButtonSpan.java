...
public class RichInlineButtonSpan extends ReplacementSpan {
    ...
    private RichMessageLayout.RichButtonSpan ensureRenderer() {
        if (this.renderedSpan == null) {
            RichMessageLayout.RichButtonSpan createEditorButtonSpan = RichMessageLayout.createEditorButtonSpan(this.currentAccount, AndroidUtilities.dp(240.0f), this.resourcesProvider, this.button);
            this.renderedSpan = createEditorButtonSpan;
