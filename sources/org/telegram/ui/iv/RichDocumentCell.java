...
public class RichDocumentCell extends RichBlockCell implements Theme.Colorable, TextSelectionHelper.ArticleSelectableView, RichCaptionHost, DownloadController.FileDownloadProgressListener {
    ...
    public RichDocumentCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        RichCaptionController richCaptionController = new RichCaptionController(context, resourcesProvider, new RichCaptionController.Host() { // from class: org.telegram.ui.iv.RichDocumentCell.1
    ...
    private void rebuildLayouts() {
        ...
        int max = Math.max(AndroidUtilities.dp(40.0f), (((getMeasuredWidth() > 0 ? getMeasuredWidth() : AndroidUtilities.displaySize.x) - (i + AndroidUtilities.dp(f))) - AndroidUtilities.dp(16.0f)) - (this.blockRtl ? blockInset() : 0));
        ...
        CharSequence ellipsize = TextUtils.ellipsize(documentFileName, this.textPaint, max, TextUtils.TruncateAt.END);
        ...
        if (j <= 0) {
            ...
            j = (mediaUploadState2 == null || TextUtils.isEmpty(mediaUploadState2.localPath)) ? 0L : new File(this.currentRow.media.localPath).length();
        }
        this.sizeLayout = new StaticLayout(AndroidUtilities.formatFileSize(j), this.sizePaint, max, alignment, 1.0f, 0.0f, false);
    }
    ...
    protected void onBlockInsetChanged(int i) {
        ...
        this.buttonX = i2;
        int dp2 = this.hasPreview ? AndroidUtilities.dp(31.0f) : this.buttonY;
        RadialProgress2 radialProgress2 = this.radialProgress;
        int i3 = this.buttonX;
        int i4 = this.buttonSize;
        radialProgress2.setProgressRect(i3, dp2, i3 + i4, i4 + dp2);
        requestLayout();
    }
    ...
    private void bindPreview(TLRPC.Document document) {
        ...
        this.hasPreview = z || isDocumentHasThumb;
        int dp = AndroidUtilities.dp(16.0f) + (this.blockRtl ? 0 : blockInset());
        this.mediaX = dp;
        if (this.hasPreview) {
        ...
        radialProgress2.setProgressRect(i, dp2, i + i2, i2 + dp2);
        if (z) {
        ...
        if (isDocumentHasThumb) {
            ...
            imageReceiver.setImage(forDocument, "86_86", createStripedBitmap, null, fileRefParentObject, 1);
            return;
        }
    ...
    private void pressButton() {
        ...
        if (isUploading()) {
            ...
            if (i == 0) {
                ...
                if (findActivity != null && (messageObject = this.messageObject) != null) {
                    AndroidUtilities.openForView(messageObject, findActivity, this.resourcesProvider, false);
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int dp = i + AndroidUtilities.dp(f);
        ...
        int height = dp2 + (staticLayout == null ? 0 : staticLayout.getHeight()) + AndroidUtilities.dp(2.0f);
