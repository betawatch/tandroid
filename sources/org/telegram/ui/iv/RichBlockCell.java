...
public abstract class RichBlockCell extends FrameLayout implements RichInsetCell {
    ...
    protected void onBlockInsetChanged(int i) {
        ...
        int nestedContentMargin = (i > 0 || insetEndFor > 0) ? nestedContentMargin() : 0;
        BlockRow blockRow = this.currentRow;
        int quoteTopPad = (blockRow == null || !blockRow.quoteFirst) ? this.basePadTop : RichBlockChrome.quoteTopPad(blockRow);
        BlockRow blockRow2 = this.currentRow;
        RichBlockChrome.applyInsetPx(this, i + nestedContentMargin, insetEndFor + nestedContentMargin, this.basePadLeft, quoteTopPad, this.basePadRight, (blockRow2 == null || !blockRow2.quoteLast) ? this.basePadBottom : RichBlockChrome.quoteBottomPad(blockRow2));
    }
    ...
    @Override // org.telegram.ui.iv.RichInsetCell
