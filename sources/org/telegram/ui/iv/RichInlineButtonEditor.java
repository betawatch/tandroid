...
public abstract class RichInlineButtonEditor {
    ...
    public static ItemOptions show(ItemOptions itemOptions, final BaseFragment baseFragment, final Context context, final Theme.ResourcesProvider resourcesProvider, final RichEditorListView.InlineButtonEdit inlineButtonEdit, final boolean z) {
        ...
        itemOptions.add(R.drawable.media_link_24, LocaleController.getString(R.string.ChatLink), new Runnable() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda1
            ...
            public final void run() {
                RichInlineButtonEditor.showInlineLinkDialog(RichEditorListView.InlineButtonEdit.this);
            }
            ...
            @Override // java.lang.Runnable
            public final void run() {
                RichInlineButtonEditor.showInlineCopyDialog(RichEditorListView.InlineButtonEdit.this);
            }
            ...
            @Override // java.lang.Runnable
            public final void run() {
                RichInlineButtonEditor.showInlineUserPicker(BaseFragment.this, context, resourcesProvider, inlineButtonEdit, z);
            }
        });
    ...
    public static void showInlineLinkDialog(final RichEditorListView.InlineButtonEdit inlineButtonEdit) {
        ...
        inlineButtonEdit.showInputDialog(LocaleController.getString(z ? R.string.RichEditorEditLinkButton : R.string.RichEditorCreateLinkButton), LocaleController.getString(R.string.RichEditorButtonURL), str, true, new EditTextCaption.InputDialogCallback() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda6
    ...
    public static void showInlineCopyDialog(final RichEditorListView.InlineButtonEdit inlineButtonEdit) {
        ...
        inlineButtonEdit.hideSelectionUi();
        inlineButtonEdit.showInputDialog(LocaleController.getString(z ? R.string.RichEditorEditCopyButton : R.string.RichEditorCreateCopyButton), LocaleController.getString(R.string.RichEditorButtonCopyText), label, false, new EditTextCaption.InputDialogCallback() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda4
            @Override // org.telegram.ui.Components.EditTextCaption.InputDialogCallback
    ...
    public static void showInlineUserPicker(BaseFragment baseFragment, Context context, Theme.ResourcesProvider resourcesProvider, final RichEditorListView.InlineButtonEdit inlineButtonEdit, boolean z) {
        ...
        showUserPicker(baseFragment, context, resourcesProvider, z, new UserPicked() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda5
    ...
    public static void showBlockLinkDialog(Context context, Theme.ResourcesProvider resourcesProvider, final RichEditorListView.BlockButtonEdit blockButtonEdit) {
        ...
        TL_keyboard.InlineButtonType type = blockButtonEdit.getType();
        showBlockTextAndValueDialog(context, resourcesProvider, blockButtonEdit, LocaleController.getString(exists ? R.string.RichEditorEditLinkButton : R.string.RichEditorCreateLinkButton), LocaleController.getString(R.string.RichEditorButtonURL), type instanceof TL_keyboard.TL_inlineButtonTypeUrl ? ((TL_keyboard.TL_inlineButtonTypeUrl) type).url : "http://", new BlockApply() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda11
    ...
    public static void showBlockCopyDialog(Context context, Theme.ResourcesProvider resourcesProvider, final RichEditorListView.BlockButtonEdit blockButtonEdit) {
        boolean exists = blockButtonEdit.exists();
        TL_keyboard.InlineButtonType type = blockButtonEdit.getType();
        showBlockTextAndValueDialog(context, resourcesProvider, blockButtonEdit, LocaleController.getString(exists ? R.string.RichEditorEditCopyButton : R.string.RichEditorCreateCopyButton), LocaleController.getString(R.string.RichEditorButtonCopyText), type instanceof TL_keyboard.TL_inlineButtonTypeCopy ? ((TL_keyboard.TL_inlineButtonTypeCopy) type).copy_text : "", new BlockApply() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda16
            @Override // org.telegram.ui.iv.RichInlineButtonEditor.BlockApply
            public final void run(String str, String str2) {
    ...
    private static void showBlockTextAndValueDialog(Context context, Theme.ResourcesProvider resourcesProvider, RichEditorListView.BlockButtonEdit blockButtonEdit, String str, String str2, String str3, final BlockApply blockApply) {
        ...
        AlertDialog.Builder positiveButton = new AlertDialogDecor.Builder(context, resourcesProvider).setTitle(str).setView(linearLayout).setPositiveButton(LocaleController.getString(R.string.OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda18
        ...
        showInputDialog(positiveButton, createField, blockButtonEdit.exists() ? -3 : 0, resourcesProvider);
    }
    ...
    public static void showBlockProfileDialog(final BaseFragment baseFragment, final Context context, final Theme.ResourcesProvider resourcesProvider, final RichEditorListView.BlockButtonEdit blockButtonEdit, final boolean z) {
        ...
        final Runnable runnable = new Runnable() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                RichInlineButtonEditor.lambda$showBlockProfileDialog$13(EditTextBoldCursor.this, baseFragment, context, resourcesProvider, z, blockButtonEdit);
            }
        };
        AlertDialog.Builder positiveButton = new AlertDialogDecor.Builder(context, resourcesProvider).setTitle(LocaleController.getString(exists ? R.string.RichEditorEditProfileButton : R.string.RichEditorCreateProfileButton)).setView(linearLayout).setPositiveButton(LocaleController.getString(R.string.OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda13
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
        ...
        if (exists) {
            i = -4;
            positiveButton.setNeutralButton(LocaleController.getString(R.string.RichEditorChangeUser), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda14
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
                    runnable.run();
                }
        ...
        showInputDialog(positiveButton, createField, i, resourcesProvider);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showBlockProfileDialog$13(EditTextBoldCursor editTextBoldCursor, BaseFragment baseFragment, Context context, Theme.ResourcesProvider resourcesProvider, boolean z, final RichEditorListView.BlockButtonEdit blockButtonEdit) {
        final String trim = editTextBoldCursor.getText().toString().trim();
        if (TextUtils.isEmpty(trim)) {
            return;
        }
        showUserPicker(baseFragment, context, resourcesProvider, z, new UserPicked() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda19
            @Override // org.telegram.ui.iv.RichInlineButtonEditor.UserPicked
            public final void run(long j) {
    ...
    private static void showUserPicker(BaseFragment baseFragment, Context context, Theme.ResourcesProvider resourcesProvider, boolean z, final UserPicked userPicked) {
        ...
        dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.iv.RichInlineButtonEditor$$ExternalSyntheticLambda7
            ...
            public final boolean didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z2, boolean z3, int i, int i2, TopicsFragment topicsFragment) {
                ...
                lambda$showUserPicker$19 = RichInlineButtonEditor.lambda$showUserPicker$19(RichInlineButtonEditor.UserPicked.this, overlayActionBarLayoutDialog, dialogsActivity2, arrayList, charSequence, z2, z3, i, i2, topicsFragment);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$showUserPicker$19(UserPicked userPicked, OverlayActionBarLayoutDialog overlayActionBarLayoutDialog, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, int i2, TopicsFragment topicsFragment) {
