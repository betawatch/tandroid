...
public final class h21 extends View {
    ...
    public h21(Context context) {
        ...
        this.x = new org.telegram.ui.Components.z5(1.0f, this, 0L, 2000L, nrVar);
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.C != null) {
            ...
            m21 m21Var = x11Var.a;
            m21Var.c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    public final void b(int i10, int i11) {
        ...
        if (!this.r) {
            ...
            for (int i18 = 2; i17 <= i18; i18 = 2) {
                ...
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(vh.v2.e(" ", upperCase));
                if (!this.E) {
                ...
                if (i17 > 1 || measureText <= z4) {
                    ...
                    this.N = str;
                    this.O = this.F;
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.g21
                        @Override // java.lang.Runnable
                        public final void run() {
                            h21 h21Var = h21.this;
                            Bitmap bitmap2 = h21Var.h;
                            h21Var.h = createBitmap.extractAlpha();
                            if (!h21Var.P) {
                                h21Var.x.d(0.0f, true);
                            }
                            h21Var.P = false;
                            Bitmap bitmap3 = h21Var.n;
                            if (bitmap3 != null) {
                                bitmap3.recycle();
                            }
                            h21Var.n = bitmap2;
                            ...
                            if (x11Var != null) {
                                ...
                                float f15 = width3;
                                m21 m21Var = x11Var.a;
                                m21Var.c.set((int) (f14 - f13), (int) (f15 - f13), (int) (f14 + f13), (int) (f15 + f13));
                                m21Var.B.requestLayout();
                                h21Var.J = true;
                            }
                            h21Var.invalidate();
