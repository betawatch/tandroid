...
public final class h21 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Cells.fa n;
    ...
    public final void U(boolean z10) {
        ...
        if (this.F != z11) {
            ...
            if (valueAnimator != null) {
                ...
                this.G.addUpdateListener(new s11(this, 1));
            }
            if (z10) {
                float[] fArr = this.E;
                fArr[0] = this.y;
                ...
                this.h.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, z11 ? org.telegram.ui.ActionBar.h6.q6 : org.telegram.ui.ActionBar.h6.z6, false));
    ...
    public final void V(int i10, boolean z10, org.telegram.ui.Components.kd kdVar) {
        ...
        if (this.v != i10) {
            ...
            if (z10) {
                ...
                if (kdVar != null) {
                    duration.addListener((Transition.TransitionListener) new g21(kdVar));
                }
            ...
            if (i11 == 1) {
                ...
                org.telegram.messenger.ul.m(R.string.UseProxyTelegramInfo, "\n\n", sb2);
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        AndroidUtilities.setScrollViewEdgeEffectColor(this.b, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.s8, false));
        int i10 = -1;
        frameLayout.addView(this.b, w7.x5.c(-1.0f, -1));
        this.c.setOrientation(1);
        this.b.addView(this.c, new FrameLayout.LayoutParams(-1, -2));
        final int i11 = 0;
        View.OnClickListener onClickListener = new View.OnClickListener(this) { // from class: org.telegram.ui.b21
                        ...
                        if (bVar != null) {
                            ...
                            while (true) {
                                ...
                                if (i13 >= editTextBoldCursorArr.length) {
                                    ...
                                    h21Var.V(i12, true, new org.telegram.ui.Components.kd(h21Var, i12, 25));
                                    break;
                                } else {
                                    if ((i12 != 1 || i13 != 4) && (i12 != 2 || (i13 != 2 && i13 != 3))) {
                                        ...
                                        if (TextUtils.isEmpty(str)) {
                                            h21Var.a[i13].setText((CharSequence) null);
                                        } else {
                                            try {
                                                h21Var.a[i13].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                h21Var.a[i13].setText(str);
                                            }
                                        }
                                    }
                                    i13++;
        ...
        while (i14 < i13) {
            ...
            this.a[i14].setHintColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.H6, false));
            ...
            this.a[i14].setCursorColor(org.telegram.ui.ActionBar.h6.w0(null, i15, false));
            ...
            this.a[i14].setHeaderHintColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.L6, false));
            this.a[i14].setTransformHintToHeader(true);
            this.a[i14].setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.k6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.l6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.p7, false));
            if (i14 == 0) {
                this.a[i14].setInputType(524305);
                this.a[i14].addTextChangedListener(new f21(this, 0));
            } else if (i14 == 1) {
                this.a[i14].setInputType(2);
                this.a[i14].addTextChangedListener(new f21(this, 1));
            } else if (i14 == 3) {
            ...
            if (i14 == 4) {
                this.a[i14].addTextChangedListener(new f21(this, 2));
            }
        ...
        for (int i16 = 0; i16 < 2; i16++) {
            ...
            this.c.addView(f9VarArr[i16], w7.x5.n(-1, -2));
        }
        org.telegram.ui.Cells.fa faVar = new org.telegram.ui.Cells.fa(this.fragmentView.getContext());
        this.n = faVar;
        faVar.setBackground(org.telegram.ui.ActionBar.h6.K0(true));
        this.n.b(LocaleController.getString(R.string.PasteFromClipboard), false);
        org.telegram.ui.Cells.fa faVar2 = this.n;
        int i17 = org.telegram.ui.ActionBar.h6.q6;
        faVar2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i17, false));
        final int i18 = 1;
        this.n.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.b21
            public final /* synthetic */ h21 b;
                        ...
                        if (bVar != null) {
                            ...
                            while (true) {
                                ...
                                if (i132 >= editTextBoldCursorArr.length) {
                                    ...
                                    h21Var.V(i122, true, new org.telegram.ui.Components.kd(h21Var, i122, 25));
                                    break;
                                } else {
                                    if ((i122 != 1 || i132 != 4) && (i122 != 2 || (i132 != 2 && i132 != 3))) {
                                        ...
                                        if (TextUtils.isEmpty(str)) {
                                            h21Var.a[i132].setText((CharSequence) null);
                                        } else {
                                            try {
                                                h21Var.a[i132].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                h21Var.a[i132].setText(str);
                                            }
                                        }
                                    }
                                    i132++;
        ...
        this.h = faVar3;
        faVar3.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.K0(true));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, TLObject.FLAG_28, null, null, null, null, i11));
        org.telegram.ui.Cells.fa faVar = this.h;
        int i12 = org.telegram.ui.ActionBar.h6.i6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(faVar, TLObject.FLAG_28, null, null, null, null, i12));
        int i13 = org.telegram.ui.ActionBar.h6.q6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, null, -1, qy0Var, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, null, -1, qy0Var, org.telegram.ui.ActionBar.h6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, TLObject.FLAG_28, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, TLObject.FLAG_28, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i13));
        for (int i14 = 0; i14 < k6VarArr.length; i14++) {
            ...
            arrayList.add(new org.telegram.ui.ActionBar.j6(k6VarArr[i14], TLObject.FLAG_28, null, null, null, null, org.telegram.ui.ActionBar.h6.i6));
            ...
            arrayList.add(new org.telegram.ui.ActionBar.j6(k6VarArr[i14], 8192, new Class[]{org.telegram.ui.Cells.k6.class}, new String[]{"radioButton"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.g7));
            arrayList.add(new org.telegram.ui.ActionBar.j6(k6VarArr[i14], 16384, new Class[]{org.telegram.ui.Cells.k6.class}, new String[]{"radioButton"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.h7));
        }
        if (this.a != null) {
            int i15 = 0;
            while (true) {
                ...
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.a[i15], TLObject.FLAG_23, null, null, null, null, org.telegram.ui.ActionBar.h6.H6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.a[i15], 8390656, null, null, null, null, org.telegram.ui.ActionBar.h6.L6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.a[i15], 16777216, null, null, null, null, i16));
                arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, qy0Var, org.telegram.ui.ActionBar.h6.k6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, qy0Var, org.telegram.ui.ActionBar.h6.l6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 1, null, null, null, null, org.telegram.ui.ActionBar.h6.d6));
        ...
        while (true) {
            ...
            if (a7Var != null) {
                arrayList.add(new org.telegram.ui.ActionBar.j6(a7Var, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, org.telegram.ui.ActionBar.h6.b7));
            }
            i17++;
        }
        for (int i18 = 0; i18 < f9VarArr.length; i18++) {
            arrayList.add(new org.telegram.ui.ActionBar.j6(f9VarArr[i18], 32, new Class[]{org.telegram.ui.Cells.f9.class}, null, null, null, org.telegram.ui.ActionBar.h6.b7));
            arrayList.add(new org.telegram.ui.ActionBar.j6(f9VarArr[i18], 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
            arrayList.add(new org.telegram.ui.ActionBar.j6(f9VarArr[i18], 2, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.J6));
        }
        return arrayList;
    }
