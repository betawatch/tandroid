    ...
    public h01(ProfileActivity profileActivity, Context context) {
        ...
        if (kVar.getOccupyStatusBar()) {
            ...
            if (!z4) {
                ...
                ofFloat.addListener(new ls0(this, 13));
            }
        }
        i10 = 0;
        this.a = i10;
        ...
        ofFloat2.setInterpolator(org.telegram.ui.Components.nr.j);
        ofFloat2.addUpdateListener(new e3(this, 28));
        ofFloat2.addListener(new ls0(this, 13));
    }
            ...
            while (i16 < realCount) {
                ...
                if (i16 != i17 || Math.abs(this.G - f13) <= 1.0E-4f) {
                    ...
                    if (i16 != this.J) {
                        ...
                        paint4.setAlpha((int) (AndroidUtilities.lerp(i11, 255, org.telegram.ui.Components.nr.j.getInterpolation(this.E[i16])) * this.D));
                    }
