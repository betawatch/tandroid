...
public final class ci1 implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate, ef.a {
    ...
    public static /* synthetic */ void i(ci1 ci1Var) {
        AndroidUtilities.cancelRunOnUIThread(ci1Var.P0);
        ci1Var.O0 = false;
        if (Build.VERSION.SDK_INT < 23 || ci1Var.b.checkSelfPermission("android.permission.CAMERA") == 0) {
            ci1Var.C();
        } else {
            ci1Var.b.requestPermissions(new String[]{"android.permission.CAMERA"}, 102);
        }
    }
    ...
    public static void j(ci1 ci1Var) {
        ...
        if (ci1Var.d1) {
            ...
            ci1Var.f1 = ofFloat;
            ci1Var2 = ci1Var;
            ofFloat.addUpdateListener(new gg.c(ci1Var2, ci1Var.c1, ci1Var.V0, ci1Var.W0, 2));
            ci1Var2.f1.addListener(new qh1(ci1Var2, i10));
            ci1Var2.f1.setDuration(350L);
            ci1Var2.f1.setInterpolator(org.telegram.ui.Components.pr.f);
            ci1Var2.f1.start();
        } else {
            ci1Var2 = ci1Var;
        }
        ...
        if (ci1Var != null) {
            if (i10 == 101) {
                ...
                if (iArr.length > 0 && iArr[0] == 0) {
                    ci1Var.r(new sj0(7));
                } else if (!ci1Var.b.shouldShowRequestPermissionRationale("android.permission.RECORD_AUDIO")) {
                    if (VoIPService.getSharedState() != null) {
                        VoIPService.getSharedState().declineIncomingCall();
                    }
                    org.telegram.ui.Components.voip.g2.i(ci1Var.b, new mh1(ci1Var, 2), i10);
                    return;
                }
            }
            if (i10 == 102) {
    ...
    public static void w(Activity activity, int i10) {
        ci1 ci1Var = k1;
        if (ci1Var != null && ci1Var.r0.getParent() == null) {
            ci1 ci1Var2 = k1;
            if (ci1Var2 != null) {
                ci1Var2.Z.d.release();
                k1.a0.d.release();
        ...
        ci1Var3.q0 = ViewConfiguration.get(activity).getScaledTouchSlop();
        ci1Var3.t0 = (AccessibilityManager) f0.e.f(activity, AccessibilityManager.class);
        ...
        org.telegram.ui.Components.voip.o1 o1Var = ci1Var3.r;
        ...
        if (LiteMode.isEnabled(512)) {
            ...
            if ((i13 == 11 && i14 >= 24 && i14 <= 31) || (i13 == 0 && i14 == 1)) {
                f3Var.a = new org.telegram.ui.Components.cw0(0);
            }
        }
        ci1Var3.x = f3Var;
        xh1Var.addView(f3Var, k7.c6.c(220.0f, -1));
        ...
        ci1Var3.a0.d.setUseCameraRotation(true);
        ci1Var3.V.setOnTapListener(new nh1(ci1Var3, 1));
        ci1Var3.a0.d.setMirror(true);
        ci1Var3.V.addView(ci1Var3.a0);
        ...
        ci1Var3.W.setOnTapListener(new nh1(ci1Var3, i11));
        ...
        while (i15 < 4) {
            ...
            ci1Var3.K.addView(p9VarArr[i15], k7.c6.k(i15 == 0 ? 0.0f : 6.0f, 0.0f, 0.0f, 0.0f, 25, 25));
            i15++;
        }
        ...
        ci1Var3.y = new org.telegram.ui.Components.voip.r0(activity);
        org.telegram.ui.Components.z8 z8Var = new org.telegram.ui.Components.z8((org.telegram.ui.ActionBar.g6) null);
        z8Var.r(user);
        org.telegram.ui.Components.voip.r0 r0Var = ci1Var3.y;
        int i16 = ci1Var3.a;
        r0Var.b.h(ImageLocation.getForUserOrChat(i16, user, 0), null, z8Var, user);
        ci1Var3.y.setRoundRadius(AndroidUtilities.dp(135.0f) / 2);
        ...
        if (sharedState != null && sharedState.getUser() != null && sharedState.isConference() && sharedState.getGroupCall() != null) {
            ...
            if (groupParticipants != null || i19 > 0) {
                ...
                org.telegram.ui.Components.c9 c9Var = bi1Var.b;
                c9Var.k(min);
                int i20 = 0;
                while (i20 < min) {
                ...
                if (max == 1 && (groupParticipants == null || groupParticipants.size() == 0 || (groupParticipants.size() == 1 && DialogObject.getPeerDialogId(groupParticipants.get(0).peer) == j11))) {
                    ...
                    bi1Var.c = new org.telegram.ui.Components.l01(LocaleController.formatPluralStringComma("Participants", max), 14.0f, AndroidUtilities.bold());
        ...
        xh1Var.addView(ci1Var3.y, k7.c6.d(204, 204.0f, 1, 0.0f, 93.0f, 0.0f, 0.0f));
        ...
        ci1Var3.g0 = new org.telegram.ui.Components.voip.p1(activity);
        ci1Var3.e = new org.telegram.ui.Components.voip.l3(activity, o1Var);
        ci1Var3.f = new org.telegram.ui.Components.voip.l3(activity, o1Var);
        ci1Var3.h = new org.telegram.ui.Components.voip.l3(activity, o1Var);
        ci1Var3.n = new zh1(activity, 52.0f);
        ci1Var3.e.setTranslationY(AndroidUtilities.dp(100.0f));
        ci1Var3.e.setScaleX(0.0f);
        ci1Var3.e.setScaleY(0.0f);
        ci1Var3.e.animate().setStartDelay(ImageReceiver.DEFAULT_CROSSFADE_DURATION).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
        ci1Var3.f.setTranslationY(AndroidUtilities.dp(100.0f));
        ci1Var3.f.setScaleX(0.0f);
        ci1Var3.f.setScaleY(0.0f);
        ci1Var3.f.animate().setStartDelay(166).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
        ...
        ci1Var3.n.setTranslationY(AndroidUtilities.dp(100.0f));
        ci1Var3.n.setScaleX(0.0f);
        ci1Var3.n.setScaleY(0.0f);
        ci1Var3.n.animate().setStartDelay(198).translationY(0.0f).scaleY(1.0f).scaleX(1.0f).setDuration(250L).start();
        ci1Var3.g0.addView(ci1Var3.e);
        ci1Var3.g0.addView(ci1Var3.f);
        ci1Var3.g0.addView(ci1Var3.h);
        ci1Var3.g0.addView(ci1Var3.n);
        org.telegram.ui.Components.voip.e eVar = new org.telegram.ui.Components.voip.e(activity);
        ci1Var3.b0 = eVar;
        eVar.setListener(new ai1(ci1Var3));
        ci1Var3.b0.setScaleX(1.15f);
        ci1Var3.b0.setScaleY(1.15f);
        xh1Var.addView(ci1Var3.g0, k7.c6.e(-1, -2, 80));
        float f10 = AndroidUtilities.isTablet() ? 100 : 27;
        xh1Var.addView(ci1Var3.b0, k7.c6.d(-1, 186.0f, 80, f10, 0.0f, f10, 0.0f));
        ...
        int i21 = 6;
        ci1Var3.E.setOnClickListener(new nh1(ci1Var3, i21));
        ...
        if (sharedInstance != null) {
            if (!ci1Var3.R0) {
                ...
                ci1Var3.R0 = phoneCall != null && phoneCall.video;
            }
            ci1Var3.o();
        }
        ...
        if (z4) {
            ...
            if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                ci1Var3.Z.setStub(org.telegram.ui.Components.voip.n2.k().r);
                ci1Var3.a0.setStub(org.telegram.ui.Components.voip.n2.k().n);
            }
            ci1Var3.r0.setAlpha(0.0f);
            ci1Var3.H();
            ci1Var3.B0 = true;
    ...
    public final void C() {
        ...
        if (sharedInstance != null) {
            ...
            if (this.l0 == null) {
                ...
                vh1 vh1Var = new vh1(this, this.s.getContext(), r0[0], r0[1]);
                this.l0 = vh1Var;
    ...
    public final void D(boolean z4) {
        ...
        if (i10 == 15 || i10 == 17) {
            ...
            this.n.setOnClickListener(new nh1(this, 0));
        }
    ...
    */
    public final void E(boolean z4) {
        ...
        if (i15 == 4) {
            ...
            this.L0.postDelayed(new mh1(this, 9), 1000L);
        }
    }
    ...
    */
            ...
            if (i15 != 3) {
                if (i15 == 4) {
                    ...
                    if (TextUtils.equals(lastError, Instance.ERROR_UNKNOWN)) {
                        AndroidUtilities.runOnUIThread(new mh1(this, 3), 1000L);
                        ...
                        if (this.R0) {
                            ...
                            for (int i17 = 0; i17 < 3; i17++) {
                                if (zArr2[i17] && (textView = (TextView) y3Var.d(-(i17 + 1))) != null) {
                        ...
                        AndroidUtilities.runOnUIThread(new mh1(this, 1), 1000L);
                    }
                } else if (i15 != 5) {
                    switch (i15) {
                        case 11:
                            ...
                            if (!z21 || this.D0) {
                                num = 1;
                                AndroidUtilities.runOnUIThread(new mh1(this, 0), 200L);
                                break;
                            } else {
                                if (this.u0) {
                                    int[] iArr = new int[2];
                                    ...
                                    AndroidUtilities.runOnUIThread(new mg1(i16, this, sharedInstance), 2L);
                                    i14 = 0;
                                } else {
                                    ...
                                    i14 = 0;
                                    this.R.a(new lh1(this, sharedInstance, i14), false);
                                }
                                this.N.setVisibility(i14);
                                org.telegram.ui.Components.voip.m1 m1Var = this.N;
                                kh1 kh1Var2 = new kh1(this, true ? 1 : 0);
                                ...
                                while (i19 < l1VarArr.length) {
                                    ...
                                    l1VarArr[i19].setAlpha(0.0f);
                                    animatorSet2.playTogether(ObjectAnimator.ofFloat(l1VarArr[i19], (Property<org.telegram.ui.Components.voip.l1, Float>) property, 0.0f, 1.0f), ObjectAnimator.ofFloat(l1VarArr[i19], (Property<org.telegram.ui.Components.voip.l1, Float>) property2, 0.3f, 1.0f), ObjectAnimator.ofFloat(l1VarArr[i19], (Property<org.telegram.ui.Components.voip.l1, Float>) property3, 0.3f, 1.0f), ObjectAnimator.ofFloat(l1VarArr[i19], (Property<org.telegram.ui.Components.voip.l1, Float>) property4, AndroidUtilities.dp(30.0f), 0.0f));
                                ...
                                this.B.animate().alpha(0.0f).setDuration(70L).setListener(new th1(this)).start();
                        ...
                        if (!this.Z.d.isFirstFrameRendered() && !this.F0) {
                            ...
                            if (z20) {
                                ...
                                if (!z19 && this.b0.getTag() != null) {
                                    this.b0.animate().setListener(null).cancel();
                                    i11 = 8;
                                    this.b0.animate().setListener(new qh1(this, i11)).alpha(0.0f);
                                    ...
                                    if (!z12 && this.W.getTag() == null) {
                                        ...
                                        t1Var3.W = true;
                                        t1Var3.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.pr.f).setStartDelay(150L).withEndAction(new mh1(this, 4)).start();
                                        this.W.setTag(num);
                                    } else if (!z12 && this.W.getTag() != null) {
                                        this.W.setIsActive(false);
                                        this.W.animate().alpha(0.0f).scaleX(0.5f).scaleY(0.5f).setListener(new qh1(this, 5)).setDuration(150L).setInterpolator(org.telegram.ui.Components.pr.f).start();
                                        this.W.setTag(null);
                                    }
                                    this.V.a();
                                    this.W.a();
                                    ...
                                    mh1 mh1Var2 = this.Q0;
                                    AndroidUtilities.cancelRunOnUIThread(mh1Var2);
                                    if (this.m0 != 3) {
                                    }
                                }
                            }
                            ...
                            mh1 mh1Var22 = this.Q0;
                            AndroidUtilities.cancelRunOnUIThread(mh1Var22);
                            if (this.m0 != 3) {
                            }
                        }
                    }
                    ...
                    mh1 mh1Var222 = this.Q0;
                    AndroidUtilities.cancelRunOnUIThread(mh1Var222);
                    if (this.m0 != 3) {
                    }
                }
            }
    ...
    public final void a(c2.p pVar) {
        ...
        uh1 uh1Var = this.r0;
        uh1Var.getClass();
        windowManager.addView(uh1Var, org.telegram.ui.Components.voip.x2.a());
        this.j1 = false;
        H();
        this.r0.invalidate();
    ...
    public final ValueAnimator k(boolean z4) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ph1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (z10) {
                    ...
                    ci1Var.V.setScaleX(f24);
                    ci1Var.V.setScaleY(f24);
                    ci1Var.V.setTranslationX((f10 * floatValue) + (x10 * f23));
                    ci1Var.V.setTranslationY((f18 * floatValue) + (y10 * f23));
                    ci1Var.V.setCornerRadius((dp2 * floatValue) + (f21 * f23));
                    ci1Var.V.setAlpha((f16 * floatValue) + (1.0f * f23));
                }
                float f25 = (f22 * floatValue) + (1.0f * f23);
                ci1Var.Z.setScaleX(f25);
                ci1Var.Z.setScaleY(f25);
                float f26 = 0.0f * f23;
                float f27 = (measuredWidth * floatValue) + f26;
                float f28 = (measuredHeight2 * floatValue) + f26;
                ci1Var.Z.setTranslationX(f27);
                ci1Var.Z.setTranslationY(f28);
                ci1Var.Z.setRoundCorners(((AndroidUtilities.dp(4.0f) * floatValue) * 1.0f) / f25);
                if (!ci1Var.V.M) {
                    ci1Var.a0.d(floatValue, false);
                }
                ci1Var.r0.invalidate();
            }
        });
        return ofFloat;
    }
    ...
    public final void o() {
        this.a0.d.init(VideoCapturerDevice.getEglBase().getEglBaseContext(), new rh1(this));
    ...
    public final void p() {
        ...
        if (ff.d.a(this.b) <= 0) {
            org.telegram.ui.Components.z4.B(this.b, new kh1(this, 0), true).o();
            return;
        }
        if (this.D0 || k1 == null) {
            return;
        ...
        if (VoIPService.getSharedInstance() != null) {
            ...
            ci1 ci1Var = k1;
            org.telegram.ui.Components.voip.n2.l(ci1Var.b, ci1Var.a, ci1Var.r0.getMeasuredWidth(), measuredHeight, 1);
    ...
    public final void r(Runnable runnable) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.oh1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                ci1 ci1Var = ci1.this;
                ci1Var.getClass();
                float floatValue = ((Float) valueAnimator3.getAnimatedValue()).floatValue();
                ci1Var.b0.setTranslationY(dp2 * floatValue);
                int i10 = (int) (marginEnd - ((r1 + dp) * floatValue));
                ViewGroup.MarginLayoutParams marginLayoutParams2 = marginLayoutParams;
                marginLayoutParams2.leftMargin = i10;
                marginLayoutParams2.rightMargin = i10;
                ci1Var.b0.requestLayout();
            }
        });
    ...
    public final void x(boolean z4, boolean z10) {
        ...
        if (!z4) {
            ...
            this.y.animate().setListener(null).cancel();
            this.y.setTranslationY(0.0f);
            this.y.animate().alpha(0.0f).setDuration(150L).scaleX(0.1f).scaleY(0.1f).setInterpolator(org.telegram.ui.Components.pr.f).setListener(new qh1(this, 7)).start();
        }
    ...
    public final void z(int i10, boolean z4) {
        ...
        if (i10 != 0) {
            ...
            animatorSet5.addListener(new qh1(this, 6));
