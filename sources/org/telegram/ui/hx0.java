...
public final class hx0 extends sg.e {
    ...
    public final void g() {
        ...
        if (premiumPreviewFragment.r0 == null && BuildVars.DEBUG_PRIVATE_VERSION) {
            ...
            zdVar.addView(textView, w7.x5.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, 0.0f));
            org.telegram.ui.Components.go0 go0Var = new org.telegram.ui.Components.go0(context);
            go0Var.setDelegate(new l20(aVar, 0));
            sg.f fVar = aVar.c;
            go0Var.setProgress(fVar == null ? 0.0f : fVar.v / 2.0f);
            ...
            zdVar.addView(textView2, w7.x5.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, 0.0f));
            org.telegram.ui.Components.go0 go0Var2 = new org.telegram.ui.Components.go0(context);
            go0Var2.setDelegate(new l20(aVar, 1));
            sg.f fVar2 = aVar.c;
            go0Var2.setProgress(fVar2 == null ? 0.0f : fVar2.w / 2.0f);
            ...
            textView3.setOnClickListener(new m20(context, aVar, i12));
            ...
            zdVar.addView(textView4, w7.x5.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, 0.0f));
            org.telegram.ui.Components.go0 go0Var3 = new org.telegram.ui.Components.go0(context);
            go0Var3.setDelegate(new l20(aVar, 2));
            sg.f fVar3 = aVar.c;
            go0Var3.setProgress(fVar3 == null ? 0.0f : fVar3.x);
            ...
            zdVar.addView(textView5, w7.x5.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, 0.0f));
            org.telegram.ui.Components.go0 go0Var4 = new org.telegram.ui.Components.go0(context);
            go0Var4.setDelegate(new l20(aVar, 3));
            sg.f fVar4 = aVar.c;
            go0Var4.setProgress(fVar4 == null ? 0.0f : fVar4.A / 2.0f);
            ...
            textView6.setOnClickListener(new m20(context, aVar, i10));
            ...
            zdVar.addView(textView7, w7.x5.d(-2, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, 21.0f, 13.0f, 21.0f, 0.0f));
            org.telegram.ui.Components.go0 go0Var5 = new org.telegram.ui.Components.go0(context);
            go0Var5.setDelegate(new t7.u());
            go0Var5.setProgress(zd.b / 2.0f);
