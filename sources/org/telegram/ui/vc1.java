...
public final class vc1 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void V(vc1 vc1Var, TLRPC.TL_theme tL_theme) {
        try {
            vc1Var.r.dismiss();
            vc1Var.r = null;
        } catch (Exception e10) {
    ...
    public static /* synthetic */ void W(vc1 vc1Var, TLRPC.TL_error tL_error, TL_account.updateTheme updatetheme) {
        try {
            vc1Var.r.dismiss();
            vc1Var.r = null;
        } catch (Exception e10) {
    ...
    public static /* synthetic */ void X(vc1 vc1Var, String str) {
        ...
        vc1Var.y = ConnectionsManager.getInstance(vc1Var.currentAccount).sendRequest(createtheme, new u80(28, vc1Var, str), 2);
    }

    public static void Y(vc1 vc1Var) {
        org.telegram.ui.ActionBar.f6 f6Var = vc1Var.F;
        TLRPC.TL_theme tL_theme = vc1Var.H;
        if (vc1Var.Z(vc1Var.a.getText().toString(), true) && vc1Var.getParentActivity() != null) {
            if (vc1Var.b.length() == 0) {
            ...
            if (vc1Var.E) {
                ...
                vc1Var.r = c2Var;
                c2Var.setOnCancelListener(new tc1());
                vc1Var.r.show();
                String obj = vc1Var.b.getText().toString();
                tL_theme.title = obj;
                f6Var.a = obj;
                f6Var.B.slug = vc1Var.a.getText().toString();
            ...
            String obj2 = vc1Var.a.getText().toString();
            String obj3 = vc1Var.b.getText().toString();
            if (str2.equals(obj2) && str4.equals(obj3)) {
                vc1Var.finishFragment();
                return;
            }
            vc1Var.r = new org.telegram.ui.ActionBar.c2(vc1Var.getParentActivity(), 3, null);
            ...
            vc1Var.r.setOnCancelListener(new jh.w(vc1Var, sendRequest, 9));
            vc1Var.r.show();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        linearLayout2.addView(this.x, i7.f6.n(-1, -2));
        ...
        this.x.addView(this.b, i7.f6.k(23.0f, 0.0f, 23.0f, 0.0f, -1, 50));
        this.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.rc1
            ...
            public final boolean onEditorAction(TextView textView, int i14, KeyEvent keyEvent) {
                ...
                switch (i11) {
                    case 0:
                        vc1 vc1Var = this.b;
                        if (i14 == 6) {
                            AndroidUtilities.hideKeyboard(vc1Var.b);
                            return true;
                        }
                        vc1Var.getClass();
                        return false;
        ...
        this.s = fnVar;
        this.x.addView(fnVar, new LinearLayout.LayoutParams(-1, 1));
        LinearLayout linearLayout4 = new LinearLayout(context);
        linearLayout4.setOrientation(0);
        this.x.addView(linearLayout4, i7.f6.k(23.0f, 0.0f, 23.0f, 0.0f, -1, 50));
        ...
        linearLayout4.addView(this.w, i7.f6.n(-2, 50));
        ...
        linearLayout4.addView(this.a, i7.f6.n(-1, 50));
        this.a.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.rc1
            public final /* synthetic */ vc1 b;
        ...
        this.a.addTextChangedListener(new uc1(this));
        if (z10) {
            this.a.setOnFocusChangeListener(new kd(this, 11));
        }
        ...
        y8Var.setBackgroundDrawable(org.telegram.ui.ActionBar.g6.V0(context, i14, i15));
        this.e.setVisibility(8);
        this.e.setBottomPadding(0);
        linearLayout2.addView(this.e, i7.f6.n(-1, -2));
        ...
        if (z10) {
            ...
            linearLayout2.addView(this.n, i7.f6.n(-1, -2));
        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (f6Var2 == f6Var && e6Var2 == e6Var && (c2Var2 = this.r) != null) {
                try {
                    c2Var2.dismiss();
                    this.r = null;
                } catch (Exception e10) {
        ...
        if (i10 == NotificationCenter.themeUploadError) {
            ...
            if (f6Var3 == f6Var && e6Var3 == e6Var && (c2Var = this.r) != null) {
                try {
                    c2Var.dismiss();
                    this.r = null;
                } catch (Exception e11) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.n, 32, new Class[]{org.telegram.ui.Cells.y8.class}, null, null, null, i11));
        int i12 = org.telegram.ui.ActionBar.g6.B6;
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.n, 0, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.e, 32, new Class[]{org.telegram.ui.Cells.y8.class}, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.e, 262144, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.p7));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.e, 262144, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.F6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.e, 262144, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.w6));
        int i13 = org.telegram.ui.ActionBar.g6.G6;
        ...
        org.telegram.ui.Components.fn fnVar = this.s;
        ...
        org.telegram.ui.Cells.ca caVar = this.f;
        ...
        org.telegram.ui.Cells.ca caVar2 = this.f;
