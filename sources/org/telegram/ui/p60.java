...
public final class p60 extends ad {
    public float A0;
    public boolean B0;
    public tc z0;
    ...
    public static void e1(p60 p60Var, int i10, ChannelBoostsController.CanApplyBoost canApplyBoost) {
        if (canApplyBoost == null || p60Var.getParentActivity() == null) {
            p60Var.B0 = false;
            return;
        }
        o60 o60Var = new o60(p60Var, p60Var, p60Var.getParentActivity(), i10, p60Var.currentAccount, p60Var.resourceProvider);
        o60Var.G1(canApplyBoost);
        o60Var.F1(p60Var.c, true);
        o60Var.H1(p60Var.a);
        o60Var.show();
    }
    ...
    public final void x0() {
        n60 n60Var = new n60(this, getParentActivity(), this.resourceProvider, 0);
        this.M = n60Var;
        n60Var.setOnScrollListener(new i3(this, 12));
