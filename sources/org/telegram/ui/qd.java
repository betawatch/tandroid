...
public final /* synthetic */ class qd implements RequestDelegate {
    ...
    public /* synthetic */ qd(fe feVar, int i10) {
        this.a = i10;
        this.b = feVar;
    }
                        ...
                        switch (i10) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    c91 f02 = q91.f0(tL_payments_starsRevenueStats.top_hours_graph, LocaleController.getString(R.string.MonetizationGraphImpressions), 0, false);
                                    fe feVar3 = feVar2;
                                    feVar3.k1 = f02;
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    feVar32.l1 = q91.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    c91 c91Var = feVar32.k1;
                                    if (c91Var != null) {
                                        c91Var.n = true;
                                    }
                                    feVar32.f1 = tL_payments_starsRevenueStats.usd_rate;
                                    feVar32.g0(true, tL_payments_starsRevenueStats.status);
                                    feVar32.Y0.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.er.h).withEndAction(new kd(feVar32, 6)).start();
                                    feVar32.a0();
                                    break;
                                }
                                break;
