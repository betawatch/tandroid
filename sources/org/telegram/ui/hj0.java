...
public final class hj0 extends org.telegram.ui.Components.kl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i15 == 0) {
            ...
            int i16 = jj0Var.I;
            MessageObject messageObject = (i10 < i16 || i10 >= jj0Var.J) ? null : (MessageObject) jj0Var.x.get(i10 - i16);
            long dialogId = MessageObject.getDialogId(messageObject.messageOwner);
            if (messageObject.isStory()) {
                TLObject user2 = DialogObject.isUserDialog(dialogId) ? jj0Var.getMessagesController().getUser(Long.valueOf(dialogId)) : jj0Var.getMessagesController().getChat(Long.valueOf(-dialogId));
                TL_stories.StoryViews storyViews = messageObject.storyItem.views;
                b5Var.b(user2, null, (storyViews == null || (i11 = storyViews.views_count) == 0) ? LocaleController.getString(R.string.NoViews) : LocaleController.formatPluralString("Views", i11, new Object[0]), i10 != jj0Var.J - 1);
                TL_stories.StoryItem storyItem = messageObject.storyItem;
                sv svVar = new sv(22, this, messageObject);
                b5Var.r = storyItem;
                b5Var.a.setOnClickListener(svVar);
                return;
            }
            b5Var.r = null;
            ...
            if (DialogObject.isUserDialog(dialogId)) {
                ...
                TLRPC.Chat chat = jj0Var.getMessagesController().getChat(Long.valueOf(-dialogId));
            ...
            if (user != null) {
                b5Var.b(user, null, str, i10 != jj0Var.J - 1);
                return;
            }
            return;
        }
        ...
        if (i15 != 5) {
            ...
            ja1Var2.e(jj0Var.s, false);
            ja1Var2.setLayoutParams(new s4.p0(-1, -2));
            return;
        }
        ij0 ij0Var = (ij0) view;
        TextView[] textViewArr = ij0Var.a;
        TextView[] textViewArr2 = ij0Var.b;
        jj0 jj0Var2 = ij0Var.c;
        wa1 wa1Var = jj0Var2.e0;
        MessageObject messageObject2 = jj0Var2.n;
        if (wa1Var != null) {
            i13 = wa1Var.d();
            i12 = wa1Var.a();
            i14 = wa1Var.c();
        ...
        TLRPC.ChatFull chatFull = jj0Var2.a;
        ...
        textViewArr[3].setText(AndroidUtilities.formatWholeNumber(Math.max(0, i12 - jj0Var2.U), 0));
