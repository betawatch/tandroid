...
public final class nd1 extends View {
    public org.telegram.ui.Components.h01 a;
    ...
    public final CharSequence b() {
        org.telegram.ui.Components.h01 h01Var = this.a;
        if (h01Var != null) {
            return h01Var.k();
        }
        return null;
    ...
    public final void c(SpannableStringBuilder spannableStringBuilder, boolean z10) {
        if (spannableStringBuilder != null) {
            this.b = new org.telegram.ui.Components.h01(spannableStringBuilder, 12.0f, null);
        }
    ...
    public final void d(CharSequence charSequence) {
        this.a = new org.telegram.ui.Components.h01(charSequence, 14.0f, AndroidUtilities.bold());
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.h01 h01Var = this.a;
        if (h01Var != null) {
            h01Var.p = getWidth() - AndroidUtilities.dp(14.0f);
            h01Var.c((getWidth() - this.a.l()) / 2.0f, ((AndroidUtilities.dp(24.0f) * 0.0f) + (getHeight() / 2.0f)) - (AndroidUtilities.dp(7.0f) * e), 1.0f, -1, canvas);
        }
        if (this.b != null) {
            canvas.save();
            canvas.scale(e, e, getWidth() / 2.0f, (getHeight() / 2.0f) + AndroidUtilities.dp(11.0f));
            org.telegram.ui.Components.h01 h01Var2 = this.b;
            h01Var2.p = getWidth() - AndroidUtilities.dp(14.0f);
            h01Var2.c((getWidth() - this.b.l()) / 2.0f, AndroidUtilities.dp(11.0f) + (0.0f * AndroidUtilities.dp(24.0f)) + (getHeight() / 2.0f), 1.0f, org.telegram.ui.ActionBar.j6.l1(0.75f, -1), canvas);
            canvas.restore();
        }
        int width = getWidth();
