...
public final class yk0 extends org.telegram.ui.ActionBar.n2 implements org.telegram.ui.Components.fk, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public static void U(yk0 yk0Var, Context context, View view, int i10) {
        yk0 yk0Var2;
        Context context2;
        File file;
        if (i10 == yk0Var.v) {
            yk0Var2 = yk0Var;
            context2 = context;
            org.telegram.ui.Components.vi viVar = new org.telegram.ui.Components.vi(context2, yk0Var2, false, false, true, yk0Var.h);
            yk0Var2.O = viVar;
            viVar.N = true;
        ...
        if (view instanceof xk0) {
            xk0 xk0Var = (xk0) view;
            if (yk0Var2.actionBar.s() || xk0Var.e == null) {
                yk0Var2.Z(xk0Var.e);
                return;
            }
            Ringtone ringtone = yk0Var2.P;
            if (ringtone != null) {
                ringtone.stop();
            }
            try {
                ...
                if (wk0Var.b) {
                    ...
                    String str = wk0Var.g;
                    if (str != null && !wk0Var.a) {
                        Ringtone ringtone3 = RingtoneManager.getRingtone(context2.getApplicationContext(), Uri.parse(xk0Var.e.g));
                        ringtone3.setStreamType(4);
                        yk0Var2.P = ringtone3;
                        ringtone3.play();
                    } else if (wk0Var.a) {
                        if (!TextUtils.isEmpty(str)) {
                            file = new File(xk0Var.e.g);
                            if (file.exists()) {
                                if (file == null) {
                                    file = yk0Var2.getFileLoader().getPathToAttach(xk0Var.e.e);
                                }
                                if (file == null && file.exists()) {
                                    ...
                                    FileLoader fileLoader = yk0Var2.getFileLoader();
                                    TLRPC.Document document = xk0Var.e.e;
                        ...
                        FileLoader fileLoader2 = yk0Var2.getFileLoader();
                        TLRPC.Document document2 = xk0Var.e.e;
            ...
            yk0Var2.H = xk0Var.e;
            yk0Var2.I = true;
            vk0 vk0Var = yk0Var2.f;
            vk0Var.q(0, vk0Var.c.n);
        }
    }
    ...
    public final void Z(wk0 wk0Var) {
        ...
        if (sparseArray.get(i10) != null) {
            sparseArray.remove(wk0Var.c);
        } else if (!wk0Var.a) {
            return;
        } else {
            sparseArray.put(wk0Var.c, wk0Var);
        }
        b0();
        vk0 vk0Var = this.f;
        vk0Var.q(0, vk0Var.c.n);
    ...
    public final View createView(Context context) {
        ...
        this.d.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.y8, this.h));
        ...
        for (int i11 = 0; i11 < getMediaDataController().ringtoneDataStore.e.size(); i11++) {
            ...
            wk0Var.f = str;
            wk0Var.e = document3;
            wk0Var.f = a0(document3, str);
            wk0Var.g = bVar.b;
            wk0 wk0Var2 = this.N;
            if (wk0Var2 != null && (document = wk0Var2.e) != null && (document2 = bVar.a) != null && document.id == document2.id) {
                this.N = null;
                this.H = wk0Var;
            }
            this.a.add(wk0Var);
        ...
        this.G = i13 + 1;
        wk0Var3.c = i13;
        wk0Var3.f = LocaleController.getString(R.string.NoSound);
        this.b.add(wk0Var3);
        wk0 wk0Var4 = new wk0();
        int i14 = this.G;
        this.G = i14 + 1;
        wk0Var4.c = i14;
        wk0Var4.f = LocaleController.getString(R.string.DefaultRingtone);
        wk0Var4.b = true;
        this.b.add(wk0Var4);
        wk0 wk0Var5 = this.N;
        if (wk0Var5 != null && wk0Var5.e == null && wk0Var5.g.equals("NoSound")) {
            this.N = null;
            this.H = wk0Var3;
        }
        wk0 wk0Var6 = this.N;
        if (wk0Var6 != null && wk0Var6.e == null && wk0Var6.g.equals("Default")) {
            this.N = null;
            this.H = wk0Var4;
        }
        while (cursor.moveToNext()) {
            ...
            wk0Var7.g = str2;
            wk0 wk0Var8 = this.N;
            if (wk0Var8 != null && wk0Var8.e == null && wk0Var8.g.equals(str2)) {
                this.N = null;
                this.H = wk0Var7;
            }
            this.b.add(wk0Var7);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.onUserRingtonesUpdated) {
            ...
            for (int i13 = 0; i13 < getMediaDataController().ringtoneDataStore.e.size(); i13++) {
                ...
                wk0 wk0Var = new wk0();
                wk0 wk0Var2 = (wk0) hashMap.get(Integer.valueOf(bVar.c));
                if (wk0Var2 != null) {
                    if (wk0Var2 == this.H) {
                        this.H = wk0Var;
                    }
                ...
                TLRPC.Document document3 = bVar.a;
                if (document3 != null) {
                    wk0Var.f = document3.file_name_fixed;
                } else {
                    wk0Var.f = new File(bVar.b).getName();
                }
                TLRPC.Document document4 = bVar.a;
                wk0Var.e = document4;
                wk0Var.f = a0(document4, wk0Var.f);
                wk0Var.g = bVar.b;
                wk0 wk0Var3 = this.N;
                if (wk0Var3 != null && (document = wk0Var3.e) != null && (document2 = bVar.a) != null && document.id == document2.id) {
                    this.N = null;
                    this.H = wk0Var;
                }
    ...
    public final boolean onFragmentCreate() {
        ...
        this.N = wk0Var;
        if (j10 != 0) {
            wk0Var.e = new TLRPC.TL_document();
            this.N.e.id = j10;
        } else {
            wk0Var.g = string;
        }
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.L != 0) {
            str = org.telegram.messenger.y0.i(this.L, this.Q, new StringBuilder("sound_"));
            str2 = org.telegram.messenger.y0.i(this.L, this.Q, new StringBuilder("sound_path_"));
            str3 = org.telegram.messenger.y0.i(this.L, this.Q, new StringBuilder("sound_document_id_"));
            edit.putBoolean(org.telegram.messenger.y0.i(this.L, this.Q, new StringBuilder("sound_enabled_")), true);
        } else {
            int i10 = this.M;
            if (i10 == 1) {
                str = "GlobalSound";
        ...
        wk0 wk0Var = this.H;
        if (wk0Var.a && (document = wk0Var.e) != null) {
            edit.putLong(str3, document.id);
            edit.putString(str, this.H.f);
            edit.putString(str2, "NoSound");
        } else if (wk0Var.g != null) {
            edit.putString(str, wk0Var.f);
