...
public final class jp0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        lp0 lp0Var = this.D;
        BitmapDrawable bitmapDrawable = lp0Var.b;
        if (bitmapDrawable != null) {
            try {
                int i9 = this.x;
                int i10 = this.y;
                bitmapDrawable.setBounds(i9, i10, this.v + i9, this.w + i10);
                lp0Var.b.draw(canvas);
            } catch (Throwable th) {
                FileLog.e(th);
            }
        }
        ...
        for (int i11 = 1; i11 < 3; i11++) {
            ...
            float f30 = i11;
            float f31 = this.h;
            canvas.drawRect(((f29 / 3.0f) * f30) + f28, f31 + f17, org.telegram.ui.Cells.j2.b(f29, 3.0f, f30, f28 + f17), (f31 + this.e) - f17, this.b);
            float f32 = this.f;
            float f33 = this.h;
            float f34 = this.e;
            canvas.drawRect(f32 + f17, org.telegram.ui.Cells.j2.b(f34, 3.0f, f30, f33), this.d + (f32 - f17), ((f34 / 3.0f) * f30) + f33 + f17, this.b);
        }
    }
    ...
    public final void onLayout(boolean z10, int i9, int i10, int i11, int i12) {
        ...
        this.B = dp;
        if (this.A == 0 || dp == 0 || (bitmap = (lp0Var = this.D).a) == null) {
            return;
        }
        ...
        float height = lp0Var.a.getHeight();
        int i13 = this.A;
        float f18 = i13 / width;
        int i14 = this.B;
        if (f18 > i14 / height) {
