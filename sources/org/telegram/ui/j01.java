...
public final class j01 extends View {
    ...
    public j01(ProfileActivity profileActivity, Context context) {
        ...
        ofFloat.addListener(new org.telegram.ui.Components.l00(27, this, profileActivity.k1));
        profileActivity.k0.b(new i01(this));
    ...
    public final void c() {
        xy0 xy0Var;
        ProfileActivity profileActivity = this.n;
        if (profileActivity.Q0 == null || (xy0Var = profileActivity.k0) == null || !profileActivity.m2) {
            return;
        }
