...
public final class gz0 extends org.telegram.ui.Components.ll0 implements ai.s9 {
    ...
    public gz0(ProfileActivity profileActivity, Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context, e6Var);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (m01Var != null) {
            ...
            if (profileActivity.O.C()) {
                ...
                if (m01Var3.C1 && (m01Var3.getClosestTab() == 8 || org.telegram.ui.Components.yu0.w0(profileActivity.O.getClosestTab()))) {
                    return false;
                }
            }
        ...
        if ((action == 1 || action == 3) && (m10 = profileActivity.c.m(0)) != null) {
            ...
            if (profileActivity.o2) {
                if (!profileActivity.p2) {
                    profileActivity.a.v0(0, m10.getTop() - profileActivity.T3(), org.telegram.ui.Components.qr.h);
                    return onTouchEvent;
                }
                int currentActionBarHeight2 = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
                kVar = ((org.telegram.ui.ActionBar.n2) profileActivity).actionBar;
                profileActivity.a.v0(0, ((m10.getTop() - profileActivity.a.getMeasuredWidth()) - profileActivity.O3()) + currentActionBarHeight2 + (kVar.getOccupyStatusBar() ? AndroidUtilities.statusBarHeight : 0), org.telegram.ui.Components.qr.h);
                return onTouchEvent;
            }
            ...
            if (z10) {
                ...
                if (f7 > 0.0f && ((f7 < profileActivity.T3() * 0.6f || profileActivity.i2 < -1000.0f) && profileActivity.Q1 > profileActivity.O3() * 0.6f)) {
                    profileActivity.a.v0(0, (int) (profileActivity.Q1 - profileActivity.O3()), org.telegram.ui.Components.qr.h);
                    return onTouchEvent;
                }
            }
            if (z10) {
                ...
                if (f10 > 0.0f && f10 < profileActivity.O3() * 0.6f) {
                    profileActivity.a.v0(0, (int) (profileActivity.O3() - profileActivity.Q1), org.telegram.ui.Components.qr.h);
                    return onTouchEvent;
                }
            }
            if (!z10) {
                ...
                if (f11 > 0.0f && profileActivity.i2 < -1000.0f) {
                    profileActivity.a.v0(0, (int) f11, org.telegram.ui.Components.qr.h);
                    return onTouchEvent;
                }
            }
