...
public final class q41 implements org.telegram.ui.Components.sk0 {
    ...
    public final boolean c(float f10, float f11, int i10, View view) {
        ...
        if (i12 != 11 && i12 != 13 && a61Var.d1) {
            ...
            if (z10 && (i12 == 1 || i12 == 8)) {
                ...
                j51 j51Var = (j51) view;
                if (!j51Var.s && !UserConfig.getInstance(i11).isPremium()) {
                    ...
                    a61Var.p(j51Var, Long.valueOf(j51Var.e.documentId), document, j51Var.v, null);
                    return true;
                }
                a61Var.O0 = j51Var;
                a61Var.Q0 = 0.0f;
                ...
                if (j51Var.s) {
                    ...
                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i11).getReactionsMap().get(a61Var.O0.x.f);
                    if (tL_availableReaction != null) {
                        a61Var.R0.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, null, 0L, "tgs", a61Var.O0.x, 0);
                    }
                } else {
                    a61Var.setBigReactionAnimatedEmoji(new org.telegram.ui.Components.k5(4, i11, a61Var.O0.e.documentId));
                }
            ...
            if (z10) {
                ...
                if (j51Var2.e != null && (i12 == 0 || i12 == 12 || i12 == 9 || i12 == 10)) {
                    TL_stars.TL_starGiftUnique tL_starGiftUnique = j51Var2.v;
                    p41 p41Var = new p41(this, this.b, a61Var.P1, a61Var, j51Var2, this.c, view, tL_starGiftUnique);
                    a61Var.T0 = p41Var;
                    p41Var.show();
                    try {
    ...
    public final void i() {
        ...
        if (a61Var.O0 != null) {
            a61Var.P0 = true;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(a61Var.Q0, 0.0f);
            ofFloat.addUpdateListener(new w01(this, 8));
            ofFloat.addListener(new f50(this, 27));
