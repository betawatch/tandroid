...
public final class nc0 extends FrameLayout {
    ...
    public int w;
    public int x;
    public final /* synthetic */ oc0 y;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public nc0(oc0 oc0Var, Context context) {
        super(context);
        this.y = oc0Var;
        ...
        addView(imageView, w7.y5.d(24, 24.0f, (LocaleController.isRTL ? 5 : 3) | 16, 20.0f, 0.0f, 20.0f, 0.0f));
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        ...
        this.d = p6Var;
        p6Var.b(0.35f, 200L, org.telegram.ui.Components.qr.h);
        ...
        addView(linearLayout, w7.y5.d(-1, -2.0f, (LocaleController.isRTL ? 5 : 3) | 16, 64.0f, 0.0f, 8.0f, 0.0f));
        ...
        addView(npVar, w7.y5.d(21, 21.0f, (z10 ? 5 : 3) | 16, z10 ? 0.0f : 64.0f, 0.0f, z10 ? 64.0f : 0.0f, 0.0f));
        setFocusable(true);
    }
    ...
    */
    ...
    public final void b(boolean z10, boolean z11) {
        if (this.s != z10) {
            ...
            if (z11) {
                ...
                org.telegram.messenger.wh.q(npVar.animate(), z10 ? 0.5f : 1.0f, 220L);
            } else {
                imageView.setAlpha(z10 ? 0.5f : 1.0f);
                linearLayout.setAlpha(z10 ? 0.5f : 1.0f);
                r12.setAlpha(z10 ? 0.5f : 1.0f);
                npVar.setAlpha(z10 ? 0.5f : 1.0f);
            }
            setEnabled(!z10);
        }
    }

    public final void c(ic0 ic0Var, boolean z10) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (this.n) {
                canvas.drawLine((getMeasuredWidth() - AndroidUtilities.dp(64.0f)) + (p4Var.getTranslationX() < 0.0f ? AndroidUtilities.dp(-32.0f) : 0), getMeasuredHeight() - 1, 0.0f, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.k0);
                return;
            }
            return;
        }
        ...
        if (this.n) {
            canvas.drawLine(p4Var.getTranslationX() + AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.k0);
        }
    }
