...
public final class d3 implements org.telegram.ui.Cells.x9, jj0, org.telegram.ui.Components.fz0 {
    ...
    public org.telegram.ui.Components.z80 e;
    public org.telegram.ui.Components.z80 f;
    ...
    public final void draw(Canvas canvas, View view) {
        ...
        if (z80Var2 != null) {
            canvas.drawPath(z80Var2, l4.v1);
        }
        org.telegram.ui.Components.z80 z80Var3 = this.e;
        if (z80Var3 != null) {
            canvas.drawPath(z80Var3, l4.u1);
        }
        org.telegram.ui.Components.z80 z80Var4 = this.f;
        if (z80Var4 != null) {
            canvas.drawPath(z80Var4, l4.w1);
        }
        if (o70Var.c.g(canvas, this)) {
            view.invalidate();
        }
        if (o70Var.d == this && o70Var.b == null && o70Var.h) {
