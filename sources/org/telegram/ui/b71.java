...
public final class b71 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public b71(int i10, long j10, TLRPC.ChannelParticipantsFilter channelParticipantsFilter) {
        this.a = i10;
        this.b = MessagesController.getInstance(i10).getChat(Long.valueOf(j10));
    ...
    public final void b() {
        ...
        if (ChatObject.isChannel(chat)) {
            ...
            ConnectionsManager.getInstance(this.a).sendRequestTyped(tL_channels_getParticipants, new org.telegram.messenger.a(), new d5(this, 24));
        }
    }
