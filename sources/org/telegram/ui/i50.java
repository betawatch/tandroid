    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.J0 != null) {
            ...
            if (call != null && call.isScheduled()) {
                long currentTimeMillis = (c60Var.X0.call.schedule_date * 1000) - c60Var.d.getConnectionsManager().getCurrentTimeMillis();
                ...
                float f13 = j10;
                A = e2.c.A(f13 * 0.02f, c60Var.L0, 1.0f * f13, this.P0);
                this.P0 = A;
                f12 = this.O0;
                if (A > f12) {
                    this.P0 = f12;
                }
                float interpolation = org.telegram.ui.Components.nr.g.getInterpolation(this.P0 / f12);
                float f14 = this.Q0;
                float f15 = this.N0;
            ...
            this.M0 = ((Utilities.random.nextInt(100) - 50) * 0.2f) / 50.0f;
            float f132 = j10;
            A = e2.c.A(f132 * 0.02f, c60Var.L0, 1.0f * f132, this.P0);
            this.P0 = A;
            f12 = this.O0;
            if (A > f12) {
            }
            float interpolation2 = org.telegram.ui.Components.nr.g.getInterpolation(this.P0 / f12);
            float f142 = this.Q0;
            float f152 = this.N0;
