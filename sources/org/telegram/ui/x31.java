...
public final class x31 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(x31 x31Var, View view, int i10) {
        ...
        int i11 = 0;
        boolean z10 = x31Var.b.getAdapter() == x31Var.c;
        if (!z10 || (arrayList = x31Var.f) == null) {
            int i12 = x31Var.e;
            if (i12 >= 0 && i10 > i12) {
                i10--;
            }
            language = (i10 < 0 || i10 >= x31Var.h.size()) ? null : (TranslateController.Language) x31Var.h.get(i10);
        } else {
        ...
        if (x31Var.r.contains(str)) {
            Collection.-EL.removeIf(x31Var.r, new o80(str, 2));
        } else {
            x31Var.r.add(str);
        }
        if (x31Var.r.size() == 1 && x31Var.r.contains(currentLocaleInfo.pluralLangCode)) {
            a0(null, null);
        } else {
            a0(x31Var.r, Boolean.TRUE);
        }
        if (z10) {
            int i13 = 0;
            while (i11 < x31Var.f.size()) {
                if (TextUtils.equals(str, ((TranslateController.Language) x31Var.f.get(i11)).code)) {
                    x31Var.Z(i13);
                }
                i11++;
                i13++;
    ...
    public static void V(boolean z10) {
        ...
        if (MessagesController.getGlobalMainSettings().getInt("translate_button_restricted_languages_version", 0) != 2 || (z10 && !z11)) {
            ...
            final int i12 = 1;
            Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.v31
            ...
            }, new Utilities.Callback() { // from class: org.telegram.ui.v31
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    switch (i12) {
                        case 0:
    ...
    public final View createView(Context context) {
        ...
        this.a = new w31(this, context, false);
        this.c = new w31(this, context, true);
        ...
        this.b.setOnItemClickListener(new s21(this, 2));
