...
public abstract class ca1 extends FrameLayout {
    ...
    public ca1(Context context, int i10, ig.f fVar, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        final int i14 = 2;
        this.c.t0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.y91
            public final /* synthetic */ ca1 b;
    ...
    public final ValueAnimator a(long j3, boolean z10) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.z91
    ...
    public final void e(ea1 ea1Var, boolean z10) {
        ...
        kg.e eVar = gVar.t0;
        boolean z13 = ea1Var.n;
        eVar.a = z13;
        cVar.c(!z13);
        if (ea1Var.d == null && ea1Var.f != null) {
        ...
        cVar.setUseWeekInterval(ea1Var.o);
        gVar.t0.setUseWeek(ea1Var.o);
        kg.e eVar2 = gVar.t0;
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (((jg.a) bVar.d.get(i12)).c.equals(((jg.a) this.r.d.d.get(i10)).c)) {
                        boolean z12 = ((ba1) arrayList.get(i10)).a.b;
                        ((kg.f) arrayList2.get(i12)).n = z12;
                        ((kg.f) arrayList2.get(i12)).o = z12 ? 1.0f : 0.0f;
                        ((ba1) arrayList.get(i10)).a.c = true;
                        ((ba1) arrayList.get(i10)).a.animate().alpha(1.0f).start();
                        if (z12) {
                            i11++;
                        }
                        z11 = true;
                ...
                if (!z11) {
                    ((ba1) arrayList.get(i10)).a.c = false;
                    ((ba1) arrayList.get(i10)).a.animate().alpha(0.0f).start();
                }
                i10++;
            }
            if (i11 == 0) {
                for (int i13 = 0; i13 < this.r.d.d.size(); i13++) {
                    ((ba1) arrayList.get(i13)).a.c = true;
                    ((ba1) arrayList.get(i13)).a.animate().alpha(1.0f).start();
                }
                return;
            }
        }
    ...
    public final void h(boolean z10) {
        jg.b bVar;
        ea1 ea1Var = this.r;
        if (ea1Var == null || (bVar = ea1Var.d) == null || bVar.a == null) {
            return;
        }
        kg.c cVar = this.d;
        ...
        if (z10) {
            ...
            while (i10 < size) {
                ...
                i10++;
                ba1 ba1Var = (ba1) obj;
                ba1Var.a.animate().alpha(1.0f).start();
                ba1Var.a.c = true;
            }
            a2.start();
            return;
