...
public final class j60 {
    ...
    public final void b(int i10, int i11, int i12, long j3, float f7) {
        ...
        float interpolation = org.telegram.ui.Components.qr.g.getInterpolation(this.f / f13);
        float f14 = i12;
        float f15 = this.c;
        ...
        int i13 = this.i;
        float dp = (AndroidUtilities.dp(122.0f) / 400.0f) * (k60.p1(i13) ? 1.0f : i13 == 1 ? 4.0f : 2.5f);
