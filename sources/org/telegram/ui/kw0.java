...
public final class kw0 extends org.telegram.ui.Components.n81 {
    ...
    public final void b(View view, int i10, int i11) {
        ...
        switch (i12) {
            ...
            case 3:
                gi1 gi1Var = (gi1) obj;
                SparseArray sparseArray = gi1Var.a;
                ...
                if (p2Var.getFragmentView() == null) {
                    ...
                    p2Var.setTitleOverlayText(gi1Var.n, gi1Var.r, gi1Var.s);
                }
            ...
            default:
                ...
                if (i11 == 0) {
                    ...
                    wh.l2 l2Var = x3Var.b0;
                    if (l2Var != null) {
                        u5Var = l2Var.Y;
                    }
                } else if (i11 == 2) {
                    xh.x3.j1(x3Var, true);
                    wh.l2 l2Var2 = x3Var.c0;
                    if (l2Var2 != null) {
                        u5Var = l2Var2.Y;
                    }
                }
    ...
    public final View d(int i10) {
        ...
        switch (this.a) {
            case 0:
                ...
                return frameLayout;
            case 1:
                return new g41((h41) this.c, (Context) this.b);
            case 2:
                FrameLayout frameLayout2 = new FrameLayout((Context) this.b);
                frameLayout2.setOnClickListener(new m41(this, 7));
                return frameLayout2;
            case 3:
                return new m91((Context) this.b, 6);
            case 4:
                return i10 == 0 ? ((sg.a0) this.b).getContainerView() : ((sg.c1) this.c).getContainerView();
            default:
    ...
    public int h(int i10) {
        switch (this.a) {
            ...
            case 4:
                return i10;
            case 5:
                return (i10 - (((xh.x3) this.c).L1(false) ? 1 : 0)) + 1;
        }
    }
