...
public final class kw0 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        vw0Var2.d.b.q = (premiumPreviewFragment.R.c.getY() + vw0Var2.getY()) / getMeasuredHeight();
        if (!premiumPreviewFragment.W) {
            invalidate();
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        vw0 vw0Var = premiumPreviewFragment.R;
        vw0Var.d.b.p = (premiumPreviewFragment.R.d.getX() + vw0Var.getX()) / getMeasuredWidth();
        vw0 vw0Var2 = premiumPreviewFragment.R;
        vw0Var2.d.b.q = (premiumPreviewFragment.R.d.getY() + vw0Var2.getY()) / getMeasuredHeight();
    }
