...
public final /* synthetic */ class oe0 implements RequestDelegate {
    ...
    public /* synthetic */ oe0(qe0 qe0Var, int i10) {
        this.a = i10;
        this.b = qe0Var;
    }
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                qe0Var2.getClass();
                                if (tL_error2 == null) {
                                    qe0Var2.n = (TL_account.Password) tLObject2;
                                    qe0Var2.h(null);
                                    break;
                                }
                                break;
                            case 1:
                                xg0 xg0Var = qe0Var2.y;
                                ...
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        ...
                                        xg0Var.l1(LocaleController.getString(R.string.WrongCodeTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue < 60 ? LocaleController.formatPluralString("Seconds", intValue, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue / 60, new Object[0])));
                                        break;
                                    }
                                } else {
                                    ...
                                    if (xg0Var.getParentActivity() != null) {
                                        ...
                                        alertDialog$Builder.k(LocaleController.getString(R.string.Continue), new z10(17, qe0Var2, tL_auth_passwordRecovery));
                            ...
                            default:
                                ...
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    ...
                                    ConnectionsManager.getInstance(i11).sendRequest(getpassword, new oe0(qe0Var2, i13), 8);
                                    break;
                                    ...
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                            ...
                                            xg0Var2.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue2 < 60 ? LocaleController.formatPluralString("Seconds", intValue2, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue2 / 60, new Object[0])));
                                            break;
                                        }
                                    } else if (xg0Var2.getParentActivity() != null) {
                                        qe0Var2.a.setText("");
                                        xg0.U0(xg0Var2, qe0Var2.x, true);
                                        break;
                                    }
                                } else {
                                    xg0Var2.v1(false, true);
                                    qe0Var2.postDelayed(new y80(16, qe0Var2, tLObject2), 150L);
                                    break;
                                }
                                break;
                        }
                    ...
                    public final void run() {
                        ...
                        switch (i12) {
                            case 0:
                                qe0Var22.getClass();
                                if (tL_error2 == null) {
                                    qe0Var22.n = (TL_account.Password) tLObject2;
                                    qe0Var22.h(null);
                                    break;
                                }
                                break;
                            case 1:
                                xg0 xg0Var = qe0Var22.y;
                                xg0Var.k1(false, true);
                                if (tL_error2 != null) {
                                    if (!tL_error2.text.startsWith("FLOOD_WAIT")) {
                                        xg0Var.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), tL_error2.text);
                                    ...
                                    if (xg0Var.getParentActivity() != null) {
                                        ...
                                        b2Var.T = formatSpannable;
                                        b2Var.R = LocaleController.getString("RestoreEmailSentTitle", R.string.RestoreEmailSentTitle);
                                        alertDialog$Builder.k(LocaleController.getString(R.string.Continue), new z10(17, qe0Var22, tL_auth_passwordRecovery));
                                        Dialog showDialog = xg0Var.showDialog(b2Var);
                                        if (showDialog != null) {
                                            showDialog.setCanceledOnTouchOutside(false);
                                            showDialog.setCancelable(false);
                                ...
                                break;
                            default:
                                xg0 xg0Var2 = qe0Var22.y;
                                qe0Var22.h = false;
                                if (tL_error2 != null && "SRP_ID_INVALID".equals(tL_error2.text)) {
                                    TL_account.getPassword getpassword = new TL_account.getPassword();
                                    i112 = ((org.telegram.ui.ActionBar.n2) xg0Var2).currentAccount;
                                    ConnectionsManager.getInstance(i112).sendRequest(getpassword, new oe0(qe0Var22, i13), 8);
                                    break;
                                } else if (!(tLObject2 instanceof TLRPC.TL_auth_authorization)) {
                                    xg0Var2.k1(false, true);
                                    if (!tL_error2.text.equals("PASSWORD_HASH_INVALID")) {
                                        ...
                                        qe0Var22.a.setText("");
                                        xg0.U0(xg0Var2, qe0Var22.x, true);
                                        break;
                                    }
                                } else {
                                    xg0Var2.v1(false, true);
                                    qe0Var22.postDelayed(new y80(16, qe0Var22, tLObject2), 150L);
                                    break;
                                }
                                break;
                        }
