...
public final class oe0 extends org.telegram.ui.Components.hw0 {
    ...
    public oe0(yg0 yg0Var, Context context, int i10) {
        ...
        this.a = new org.telegram.ui.Components.kd0[i11];
        ...
        while (i12 < this.b.length) {
            ...
            this.a[i12] = kd0Var;
            kd0Var.setText(LocaleController.getString(i10 == 0 ? i12 == 0 ? R.string.PleaseEnterNewFirstPasswordHint : R.string.PleaseEnterNewSecondPasswordHint : R.string.PasswordHintPlaceholder));
            ...
            editTextBoldCursor.addTextChangedListener(new ne0(this, z10));
            this.b[i12].setOnFocusChangeListener(new pd(kd0Var, 3));
            if (z10) {
                ...
                final int i13 = 0;
                imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ke0
                    ...
                    public final void onClick(View view) {
                        switch (i13) {
                            case 0:
                                oe0 oe0Var = this.b;
                                ImageView imageView2 = oe0Var.f;
                                EditTextBoldCursor[] editTextBoldCursorArr = oe0Var.b;
                                oe0Var.y = !oe0Var.y;
                                for (int i14 = 0; i14 < editTextBoldCursorArr.length; i14++) {
                                    ...
                                    editTextBoldCursorArr[i14].setInputType((oe0Var.y ? 144 : 128) | 1);
                                    editTextBoldCursorArr[i14].setSelection(selectionStart, selectionEnd);
                                }
                                imageView2.setTag(Boolean.valueOf(oe0Var.y));
                                imageView2.setColorFilter(org.telegram.ui.ActionBar.j6.w0(null, oe0Var.y ? org.telegram.ui.ActionBar.j6.l6 : org.telegram.ui.ActionBar.j6.H6, false));
                                break;
                            default:
                                oe0 oe0Var2 = this.b;
                                if (oe0Var2.x == 0) {
                ...
                kd0Var.addView(this.b[i12], w7.y5.c(-2.0f, -1));
            }
            kd0Var.e(this.b[i12]);
            addView(kd0Var, w7.y5.t(-1, -2, 1, 16, 16, 16, 0));
            this.b[i12].setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.le0
                ...
                switch (i14) {
                    case 0:
                        ...
                        for (int i142 = 0; i142 < editTextBoldCursorArr.length; i142++) {
                            ...
                            editTextBoldCursorArr[i142].setInputType((oe0Var.y ? 144 : 128) | 1);
    ...
    @Override // org.telegram.ui.Components.hw0
    public final void j() {
        AndroidUtilities.runOnUIThread(new g10(this, 18), yg0.t0);
    }
    ...
    public final void n() {
        ...
        for (org.telegram.ui.Components.kd0 kd0Var : this.a) {
            kd0Var.f();
        }
