...
public final class oe0 extends org.telegram.ui.Components.vv0 {
    ...
    public oe0(yg0 yg0Var, Context context, int i10) {
        ...
        this.a = new org.telegram.ui.Components.yc0[i11];
        ...
        while (i12 < this.b.length) {
            ...
            this.a[i12] = yc0Var;
            yc0Var.setText(LocaleController.getString(i10 == 0 ? i12 == 0 ? R.string.PleaseEnterNewFirstPasswordHint : R.string.PleaseEnterNewSecondPasswordHint : R.string.PasswordHintPlaceholder));
            ...
            this.b[i12].setOnFocusChangeListener(new qd(yc0Var, 3));
            if (z10) {
                ...
                yc0Var.addView(this.b[i12], w7.x5.c(-2.0f, -1));
            }
            yc0Var.e(this.b[i12]);
    ...
    @Override // org.telegram.ui.Components.vv0
    public final void j() {
        AndroidUtilities.runOnUIThread(new i10(this, 18), yg0.t0);
    }
    ...
    public final void n() {
        ...
        for (org.telegram.ui.Components.yc0 yc0Var : this.a) {
            yc0Var.f();
        }
