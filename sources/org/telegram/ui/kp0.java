...
public final class kp0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        mp0 mp0Var = this.D;
        BitmapDrawable bitmapDrawable = mp0Var.b;
        if (bitmapDrawable != null) {
            try {
                int i10 = this.x;
                int i11 = this.y;
                bitmapDrawable.setBounds(i10, i11, this.v + i10, this.w + i11);
                mp0Var.b.draw(canvas);
            } catch (Throwable th) {
                FileLog.e(th);
            }
        }
        ...
        for (int i12 = 1; i12 < 3; i12++) {
            ...
            float f30 = i12;
            float f31 = this.h;
            canvas.drawRect(((f29 / 3.0f) * f30) + f28, f31 + f17, s3.c.c(f29, 3.0f, f30, f28 + f17), (f31 + this.e) - f17, this.b);
            float f32 = this.f;
            float f33 = this.h;
            float f34 = this.e;
            canvas.drawRect(f32 + f17, s3.c.c(f34, 3.0f, f30, f33), this.d + (f32 - f17), ((f34 / 3.0f) * f30) + f33 + f17, this.b);
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.B = dp;
        if (this.A == 0 || dp == 0 || (bitmap = (mp0Var = this.D).a) == null) {
            return;
        }
        ...
        float height = mp0Var.a.getHeight();
        int i14 = this.A;
        float f18 = i14 / width;
        int i15 = this.B;
        if (f18 > i15 / height) {
