...
public final class kp0 extends FrameLayout {
    ...
    public final void c(TLRPC.Document document, TL_stars.StarGift starGift) {
        ...
        if (document == null) {
            ...
            v9Var.l(ImageLocation.getForDocument(document), "100_100", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), "100_100", DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.a7, 0.3f), starGift);
        }
    }
