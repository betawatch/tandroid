...
public final /* synthetic */ class aj1 implements org.telegram.ui.ActionBar.b2, qy {
    public final /* synthetic */ cj1 a;

    public /* synthetic */ aj1(cj1 cj1Var) {
        this.a = cj1Var;
    }
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        wallpapersListActivity.N = c2Var2;
        c2Var2.g0 = false;
        c2Var2.show();
        new ArrayList();
        int[] iArr = {0};
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof fj1) {
                fj1 fj1Var = (fj1) valueAt;
                TLRPC.WallPaper wallPaper = fj1Var.l;
                if (wallPaper == null || wallPaper.id >= 0) {
                    valueAt = wallPaper;
                } else {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(fj1Var.l.id);
                    wallpapersListActivity.d0.remove(fj1Var);
                    wallpapersListActivity.b0.remove(fj1Var.a());
                }
            }
            if (valueAt instanceof TLRPC.WallPaper) {
                ...
                if (str != null && str.equals(wallpapersListActivity.Q)) {
                    wallpapersListActivity.Q = org.telegram.ui.ActionBar.j6.d1() ? "t" : "d";
                ...
                ConnectionsManager.getInstance(i11).sendRequest(savewallpaper, new bj1(0, cj1Var, iArr));
            }
        }
        if (iArr[0] == 0) {
    ...
    public boolean u(wy wyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, fg1 fg1Var) {
        ...
        while (true) {
            ...
            } else if (valueAt instanceof fj1) {
                b10 = ((fj1) valueAt).b();
            } else {
                i18++;
            }
        ...
        if (arrayList.size() <= 1) {
            ...
            if (j3 != UserConfig.getInstance(i14).getClientUserId() && charSequence == null) {
                ...
                wallpapersListActivity.presentFragment(new bo(i19), true);
