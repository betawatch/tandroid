...
public final class nu0 extends org.telegram.ui.Components.bw0 {
    ...
    */
                ...
                if (i22 == 1) {
                    ...
                    if (i23 != 16) {
                        ...
                        if (childAt != ts0Var.M) {
                            ...
                            } else if (ts0Var.f.l(childAt) || photoViewer.V1.f.l(childAt)) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i15 = size2;
        nu0Var.setMeasuredDimension(size, i15);
        ...
        if (w30Var == null || w30Var.getVisibility() == 8) {
            ...
            i12 = i10;
            nu0Var.measureChildWithMargins(photoViewer.l1, i12, 0, i11, 0);
        ...
        cv0 cv0Var = photoViewer.i3;
        if (cv0Var != null) {
            cv0Var.e = size;
            cv0Var.f = i15;
        }
        int paddingLeft = size - (nu0Var.getPaddingLeft() + nu0Var.getPaddingRight());
        int paddingBottom = i15 - nu0Var.getPaddingBottom();
        int childCount = nu0Var.getChildCount();
        int i17 = 0;
        while (i17 < childCount) {
            View childAt = nu0Var.getChildAt(i17);
            if (childAt.getVisibility() != 8 && childAt != photoViewer.l1) {
                ...
                if (childAt == kt0Var) {
                    ...
                    nu0Var.measureChildWithMargins(childAt, i12, 0, i11, 0);
                }
            }
            i17++;
            z10 = true;
