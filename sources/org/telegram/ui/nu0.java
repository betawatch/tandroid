...
public final class nu0 extends org.telegram.ui.ActionBar.k {
    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (vu0Var.H && vu0Var.a.getAlpha() != 1.0f) {
                int i22 = 0;
                ...
                if (i22 <= 0) {
                    ...
                    for (int i23 = vu0Var.j0; i23 < vu0Var.j0 + vu0Var.y; i23++) {
                        f2.n1 K = vu0Var.c.K(i23);
                        if (K != null) {
                            View view = K.a;
            ...
            ArrayList arrayList = new ArrayList(vu0Var.n);
            int i25 = 0;
            while (i25 < charSequenceArr.length) {
                if (!TextUtils.isEmpty(org.telegram.ui.Components.on.Y(charSequenceArr[i25]))) {
                    CharSequence[] charSequenceArr5 = new CharSequence[1];
                    charSequenceArr5[i17] = org.telegram.ui.Components.on.Y(charSequenceArr[i25]);
            ...
            if (tnVar.c()) {
                ...
                vu0Var.a0.a(tL_messageMediaPoll);
                vu0Var.finishFragment();
            }
        }
    }
