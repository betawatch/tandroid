...
public class ze1 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.ug, mg0 {
    ...
    public org.telegram.ui.Components.xn f;
    ...
    public ze1(Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT < 31) {
            ...
            this.c1 = null;
            this.d1 = null;
            this.e1 = new lg.a(cVar);
            return;
        }
        this.b1 = new lg.e(false);
        this.c1 = new qg.d(null);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0042, code lost:
        ...
        if (((org.telegram.ui.ze1) r0).a == (-r6.a())) goto L13;
     */
    /*
    ...
    */
    public static void I0(tn tnVar) {
        ...
        if (tnVar.getParentLayout().getFragmentStack().size() > 1) {
            org.telegram.ui.ActionBar.o2 o2Var = (org.telegram.ui.ActionBar.o2) tnVar.getParentLayout().getFragmentStack().get(tnVar.getParentLayout().getFragmentStack().size() - 2);
            if (o2Var instanceof ze1) {
            }
        }
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", -tnVar.a());
        ((ActionBarLayout) tnVar.getParentLayout()).c(tnVar.getParentLayout().getFragmentStack().size() - 1, new ze1(bundle));
        tnVar.fa = true;
    ...
    public static boolean U(ze1 ze1Var, TLRPC.TL_error tL_error) {
        ...
        MessagesController.getNotificationsSettings(ze1Var.currentAccount).edit().putLong("dialog_join_requested_time_" + (-ze1Var.a), System.currentTimeMillis()).commit();
    ...
    public static void V(ze1 ze1Var, View view) {
        ...
        long j11 = -j10;
        long peerDialogId = tL_forumTopic == null ? 0L : ze1Var.getMessagesController().isMonoForum(j11) ? DialogObject.getPeerDialogId(tL_forumTopic.from_id) : tL_forumTopic.id;
        if (ze1Var.p0) {
            af1 af1Var = ze1Var.v;
            if (af1Var != null) {
                cf1 cf1Var = af1Var.a;
                Bundle bundle = new Bundle();
                ff1 ff1Var = cf1Var.a;
                bundle.putLong("dialog_id", ff1Var.c);
                bundle.putLong("topic_id", tL_forumTopic.id);
                bundle.putBoolean("exception", true);
                t01 t01Var = new t01(bundle, null);
                t01Var.r = new kl0(26, cf1Var, tL_forumTopic);
                ff1Var.presentFragment(t01Var);
            }
            fy fyVar = ze1Var.H0;
            if (fyVar != null) {
                fyVar.O3(j11, peerDialogId, true, ze1Var);
                return;
            }
            return;
        }
        ...
        if (ze1Var.inPreviewMode && AndroidUtilities.isTablet()) {
            for (org.telegram.ui.ActionBar.o2 o2Var : ze1Var.getParentLayout().getFragmentStack()) {
                if (o2Var instanceof fy) {
                    fy fyVar2 = (fy) o2Var;
                    if (fyVar2.h4()) {
                        MessagesStorage.TopicKey topicKey = fyVar2.l2;
            ...
            ze1Var.M0 = peerDialogId;
            ze1Var.U0(false, false);
        }
        yf.d.m(ze1Var, j10, tL_forumTopic, 0);
    }

    public static /* synthetic */ boolean W(ze1 ze1Var, View view, float f9) {
        if (ze1Var.p0 || ze1Var.getParentLayout() == null || ((ActionBarLayout) ze1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(ze1 ze1Var) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            if (i10 == 0) {
                ...
                viewGroup = ve1Var != null ? ve1Var.Q : null;
            }
            if (viewGroup != null) {
        ...
        if (op0Var != null && Build.VERSION.SDK_INT >= 23) {
            op0Var.setForeground(new ColorDrawable(i0.a.k(ze1Var.getThemedColor(org.telegram.ui.ActionBar.g6.d6), 100)));
        }
        ze1Var.P0();
    }
    ...
    public static void b0(ze1 ze1Var, boolean z10) {
        ...
        int i10 = 0;
        if (ze1Var.W0 == null) {
            org.telegram.ui.Components.y71 n10 = ze1Var.n0.n(8, false);
            ze1Var.W0 = n10;
            if (ze1Var.I0 != null) {
                n10.setBackgroundColor(ze1Var.getThemedColor(org.telegram.ui.ActionBar.g6.d6));
            }
            ze1Var.e.addView(ze1Var.W0, i7.f6.c(44.0f, -1));
        }
        ze1Var.U0 = ValueAnimator.ofFloat(ze1Var.S, z10 ? 1.0f : 0.0f);
        AndroidUtilities.updateViewVisibilityAnimated(ze1Var.n0, false, 1.0f, true);
        fy fyVar = ze1Var.I0;
        if (fyVar != null && (axVar = fyVar.B3) != null) {
            axVar.I = !z10;
        }
        ze1Var.V0 = !z10 && ze1Var.n0.getVisibility() == 0 && ze1Var.n0.getAlpha() == 1.0f;
        ze1Var.U0.addUpdateListener(new w01(ze1Var, 17));
        ze1Var.n0.setVisibility(0);
        if (z10) {
        ...
        ze1Var.U0.addListener(new he1(ze1Var, z10, i10));
        ze1Var.U0.setDuration(200L);
        ze1Var.U0.setInterpolator(org.telegram.ui.Components.jr.f);
        ze1Var.U0.start();
    ...
    public final void A0() {
        ...
        if (this.z0 != null) {
            ...
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((pe1) arrayList.get(0)).c != null && ((pe1) arrayList.get(0)).c.id == 1)) {
    ...
    public final void B0() {
        ...
        if (fyVar != null) {
            ...
            float c3 = (fsVar != null ? fsVar.c(dp) : 0.0f) + 0.0f;
            ...
            if (fsVar2 != null) {
                ...
                fsVar2.setTranslationY(c3 - ((fsVar3 != null ? fsVar3.getMetadata().c.a : 0.0f) * dp2));
                org.telegram.ui.Components.fs fsVar4 = this.Q0;
                int dp3 = AndroidUtilities.dp(14.0f);
                int dp4 = AndroidUtilities.dp(7.0f);
                r2 = fsVar4.c(AndroidUtilities.lerp(dp3, dp4, this.I0.F1 != null ? r5.getMetadata().c.a : 0.0f)) + c3;
            } else {
                r2 = c3;
            }
        } else {
            org.telegram.ui.Components.fs fsVar5 = this.Q0;
            if (fsVar5 != null) {
                r2 = 0.0f + fsVar5.c(AndroidUtilities.dp(14.0f));
            }
        }
    ...
    public final void M0(org.telegram.ui.Cells.p2 p2Var) {
        ...
        int b10 = r32[0].b(joVar.f);
        joVar.o = 1;
        long j10 = this.a;
        long j11 = -j10;
        joVar.d(j11, tL_forumTopic.id, null);
        if (ChatObject.canManageTopics(g())) {
            ...
            g1Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.xd1
                ...
                public final void onClick(View view) {
                    switch (i10) {
                        case 0:
                            ...
                            ze1Var.y0 = true;
                            ze1Var.J0 = true;
                            ze1Var.s.pinTopic(ze1Var.a, tL_forumTopic.id, !r0.pinned, ze1Var);
                            ze1Var.finishPreviewFragment();
                            break;
                        case 1:
                            ze1 ze1Var2 = this.b;
                            ze1Var2.J0 = true;
                            TopicsController topicsController = ze1Var2.s;
                            long j12 = ze1Var2.a;
        ...
        if (ChatObject.canManageTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            g1Var3.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.xd1
                public final /* synthetic */ ze1 b;
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            g1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.g6.p7));
            g1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.g6.q7));
            g1Var4.setMinimumWidth(160);
            final int i12 = 2;
            g1Var4.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.xd1
                public final /* synthetic */ ze1 b;
        ...
        tn tnVar = new tn(j7.l1.g(j10, "chat_id"));
        yf.d.a(tnVar, MessagesStorage.TopicKey.of(j11, isMonoForum ? DialogObject.getPeerDialogId(p2Var.J.from_id) : p2Var.J.id));
    ...
    public final void N0(View view) {
        ...
        we1Var.V(hashSet.contains(Integer.valueOf(i10)), true);
    ...
    */
    public final void O0(boolean z10) {
        ...
        boolean v = org.telegram.messenger.x3.v("dialog_bar_report", j12, notificationsSettings, false);
        boolean v10 = org.telegram.messenger.x3.v("dialog_bar_block", j12, notificationsSettings, false);
        boolean z15 = this.p0;
        if (z15) {
            j10 = 0;
            if (this.s0) {
            ...
            org.telegram.ui.Components.xn xnVar = this.f;
            if (xnVar != null && xnVar.getLayoutParams() != null) {
        ...
        long j13 = MessagesController.getNotificationsSettings(this.currentAccount).getLong(a4.w.m(j12, "dialog_join_requested_time_"), -1L);
        if (chat != null && ChatObject.isNotInChat(chat) && j13 > j10 && System.currentTimeMillis() - j13 < 120000) {
            ...
            if (!z14 || (!v10 && !v)) {
                ...
                if (this.R != z11) {
                    ...
                    if (z16) {
                        this.k0.animate().translationY(z11 ? 0.0f : AndroidUtilities.dp(53.0f)).setListener(new he1(this, z11, 1));
                    } else {
    ...
    public final void S0(float f9) {
        ...
        this.actionBar.B(i0.a.d(this.S, getThemedColor(org.telegram.ui.ActionBar.g6.t8), getThemedColor(org.telegram.ui.ActionBar.g6.z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.S, getThemedColor(org.telegram.ui.ActionBar.g6.s8), getThemedColor(org.telegram.ui.ActionBar.g6.d6)));
        }
        float f10 = 1.0f - f9;
        ...
        this.n0.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
        this.n0.setAlpha(f9);
        if (isInPreviewMode()) {
            this.e.invalidate();
        }
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        if (topics != null) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (pe1Var != null && (tL_forumTopic = pe1Var.c) != null && tL_forumTopic.hidden) {
                    this.x++;
                }
            }
            je1 je1Var = this.J;
            if (je1Var != null) {
                if (je1Var.getItemAnimator() != (z10 ? this.E0 : null)) {
            ...
            if ((this.y0 || size == 0) && (zd1Var = this.B) != null) {
                zd1Var.h1(0, 0);
                this.y0 = false;
            }
        }
    ...
    @Override // org.telegram.ui.Components.ug, org.telegram.ui.Components.l50
    public final long a() {
        return -this.a;
    }
    ...
    public final View createView(Context context) {
        ...
        fy fyVar = this.I0;
        final int i10 = 0;
        this.Y0 = (fyVar == null || !fyVar.S) ? 0 : AndroidUtilities.dp(72.0f);
        fy fyVar2 = this.I0;
        this.Z0 = (fyVar2 == null || !fyVar2.S) ? 0 : AndroidUtilities.dp(64.0f);
        ee1 ee1Var = new ee1(this, context);
        this.d = ee1Var;
        this.fragmentView = ee1Var;
        ee1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.g6.d6));
        ...
        final int i12 = 2;
        this.actionBar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ud1
            public final /* synthetic */ ze1 b;
            ...
            public final void onClick(View view) {
                ...
                switch (i12) {
                    case 0:
                        ze1 ze1Var = this.b;
                        ze1Var.presentFragment(td1.a0(ze1Var.a, 0L));
                        break;
                    case 1:
                        ze1 ze1Var2 = this.b;
                        ze1Var2.getMessagesController().hidePeerSettingsBar(-ze1Var2.a, null, ze1Var2.g());
                        ze1Var2.O0(false);
                        break;
                    case 2:
                        ze1 ze1Var3 = this.b;
                    ...
                    default:
                        fy fyVar3 = this.b.I0;
                        if (fyVar3 != null && (w0Var = fyVar3.f0) != null) {
                            w0Var.performClick();
                            break;
                        }
                        break;
        ...
        if (this.I0 != null) {
            ...
            this.l0 = a2;
            a2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ud1
                public final /* synthetic */ ze1 b;
        ...
        this.P = w0Var.d(14, 0, new org.telegram.ui.Components.xi0(R.raw.boosts, AndroidUtilities.dp(24.0f), "" + R.raw.boosts, AndroidUtilities.dp(24.0f)), LocaleController.getString(R.string.BoostingBoostGroupMenu), true, false, w0Var.i0);
        int i15 = 3;
        ...
        org.telegram.ui.Components.xn xnVar2 = this.f;
        long j10 = -this.a;
        xnVar2.b = j10 < 0;
        xnVar2.setClipChildren(false);
        this.actionBar.addView(this.f, 0, i7.f6.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.p0) {
            this.f.getAvatarImageView().setOnClickListener(new w7(this, i15));
        }
        ...
        this.f1 = new lg.k(je1Var, viewGroup, new t8(je1Var2, i12));
        ...
        this.J.setOnScrollListener(new ae1(this, i11));
        je1 je1Var4 = this.J;
        je1Var4.U1 = true;
        je1Var4.V1 = 0;
        ...
        this.J.setOnScrollListener(new ae1(this, i12));
        je1 je1Var5 = this.J;
        ...
        this.h.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ud1
            public final /* synthetic */ ze1 b;
            ...
            public final void onClick(View view) {
                ...
                switch (i10) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        fy fyVar32 = this.b.I0;
                        if (fyVar32 != null && (w0Var2 = fyVar32.f0) != null) {
                            w0Var2.performClick();
                            break;
                        }
                        break;
        ...
        oe1Var.addView(textView, i7.f6.d(-2, -2.0f, 81, z10 ? 72.0f : 32.0f, 0.0f, z10 ? 32.0f : 72.0f, 32.0f));
        this.n = oe1Var;
        ...
        T0();
        this.n.addView(p00Var);
        this.n.addView(this.z0);
        this.d.addView(this.n);
        this.J.setEmptyView(this.n);
        int i17 = 7;
        this.k0 = new n31(context, i17);
        org.telegram.ui.Components.w51 w51Var = new org.telegram.ui.Components.w51(context);
        this.H = w51Var;
        this.k0.addView(w51Var);
        this.d.addView(this.k0, i7.f6.e(-1, 51, 80));
        this.H.setOnClickListener(new ce1(this));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.j0 = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(22.0f));
        this.j0.setVisibility(4);
        this.k0.addView(this.j0, i7.f6.e(30, 30, 17));
        ImageView imageView = new ImageView(context);
        this.S0 = imageView;
        imageView.setImageResource(R.drawable.miniplayer_close);
        this.S0.setContentDescription(LocaleController.getString(R.string.Close));
        ImageView imageView2 = this.S0;
        int i18 = org.telegram.ui.ActionBar.g6.de;
        imageView2.setBackground(org.telegram.ui.ActionBar.w5.c(null, org.telegram.ui.ActionBar.w5.b(getThemedColor(i18))));
        this.S0.setColorFilter(new PorterDuffColorFilter(getThemedColor(i18), PorterDuff.Mode.MULTIPLY));
        this.S0.setScaleType(ImageView.ScaleType.CENTER);
        this.k0.addView(this.S0, i7.f6.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        this.S0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ud1
            public final /* synthetic */ ze1 b;
        ...
        this.e.addView(this.n0, i7.f6.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        ve1 ve1Var2 = this.n0;
        int i19 = org.telegram.ui.ActionBar.g6.d6;
        ve1Var2.setBackgroundColor(getThemedColor(i19));
        ...
        this.Q0.setOnAnimatedHeightChangedListener(new vd1(this, i10));
        ...
        y0();
        op0 op0Var = new op0(this, context, i17);
        this.L0 = op0Var;
        if (Build.VERSION.SDK_INT >= 23) {
            op0Var.setForeground(new ColorDrawable(i0.a.k(getThemedColor(i19), 100)));
        }
        this.L0.setFocusable(false);
        this.L0.setImportantForAccessibility(2);
        final int i20 = 3;
        this.L0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ud1
            public final /* synthetic */ ze1 b;
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (o2Var instanceof fy) {
                    fy fyVar4 = (fy) o2Var;
                    if (fyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = fyVar4.l2;
    ...
    public final void setPreviewReplaceProgress(float f9) {
        ...
        if (xnVar != null) {
            xnVar.setAlpha(f9);
            this.f.setTranslationX((1.0f - f9) * AndroidUtilities.dp(40.0f));
        }
    }
    ...
    public final void x0() {
        ...
        fy fyVar = this.I0;
        View view = fyVar != null ? fyVar.fragmentView : this.fragmentView;
        org.telegram.ui.ActionBar.l actionBar = fyVar != null ? fyVar.getActionBar() : this.actionBar;
    ...
    public final void z0(boolean z10) {
        ...
        if (this.D0 != null && ((str = this.u0) != null || this.v0)) {
            org.telegram.ui.Components.voip.h2.m(chat, str, false, Boolean.valueOf(!r1.call.rtmp_stream), getParentActivity(), this, getAccountInstance());
            this.u0 = null;
            this.v0 = false;
        } else {
