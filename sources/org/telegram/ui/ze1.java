...
public final class ze1 extends org.telegram.ui.ActionBar.n2 {
    ...
    public static ze1 a0(long j3, long j10) {
        ...
        ze1 ze1Var = new ze1(f7);
        ze1Var.h = new org.telegram.ui.Components.w9[2];
        ze1Var.n = "";
        ze1Var.F = new AnimationNotificationsLocker();
        return ze1Var;
    }
    ...
    public final void b0(Long l4, boolean z10) {
        ...
        if (!z10 && longValue != 0 && !getUserConfig().isPremium()) {
            ...
            if (f7 != null) {
                org.telegram.ui.Components.xc.a0(this).q(f7, AndroidUtilities.replaceTags(LocaleController.getString(R.string.UnlockPremiumEmojiHint)), LocaleController.getString(R.string.PremiumMore), new ue1(this, 0)).j();
                return;
            }
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        we1 we1Var = new we1(context, null);
        this.fragmentView = we1Var;
        we1Var.setBackgroundColor(getThemedColor(i10));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        we1Var.addView(linearLayout);
        ...
        final int i11 = 0;
        xe1Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.te1
        ...
        for (int i12 = 0; i12 < 2; i12++) {
            ...
            w9VarArr[i12] = w9Var;
            xe1Var.addView(w9Var, w7.y5.e(28, 28, 17));
        }
        frameLayout.addView(xe1Var, w7.y5.d(40, 40.0f, 16, 10.0f, 0.0f, 0.0f, 0.0f));
        ...
        if (tL_forumTopic2 == null || tL_forumTopic2.id != 1) {
            ...
            xe1Var.addView(imageView, w7.y5.e(22, 22, 17));
            ...
            final int i14 = 1;
            this.d.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.te1
                public final /* synthetic */ ze1 b;
            ...
            frameLayout2.addView(e9Var, w7.y5.d(-1, -2.0f, 48, 0.0f, 58.0f, 0.0f, 0.0f));
        }
