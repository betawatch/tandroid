...
public final /* synthetic */ class c6 implements Runnable {
    ...
    public /* synthetic */ c6(x6 x6Var, int i10) {
        this.a = i10;
        this.b = x6Var;
    }
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < longSparseArray.size(); i10++) {
                    ...
                    arrayList.add(q6Var);
                    if (x6Var2.getMessagesController().getUserOrChat(((q6) arrayList.get(i10)).a) == null) {
                        long j10 = q6Var.a;
                        if (j10 > 0) {
                ...
                Collections.sort(bVar.e, new c5.e(22));
                Collections.sort(bVar.f, new c5.e(22));
                Collections.sort(bVar.g, new c5.e(22));
            ...
            default:
                ...
                if (!x6.g0) {
                    x6Var3.r = x6.q0(4, FileLoader.checkDirectory(4));
                    if (!x6.g0) {
                        long q02 = x6.q0(0, FileLoader.checkDirectory(0));
                        x6Var3.y = q02;
                        x6Var3.y = x6.q0(0, FileLoader.checkDirectory(100)) + q02;
                        if (!x6.g0) {
                            ...
                            if (!x6.g0) {
                                ...
                                if (!x6.g0) {
                                    ...
                                    x6Var3.s = q05;
                                    x6Var3.s = x6.q0(1, FileLoader.checkDirectory(5)) + q05;
                                    if (!x6.g0) {
                                        long q06 = x6.q0(2, FileLoader.checkDirectory(3));
                                        x6Var3.x = q06;
                                        x6Var3.x = x6.q0(2, FileLoader.checkDirectory(5)) + q06;
                                        if (!x6.g0) {
                                            x6Var3.C = x6.q0(0, new File(FileLoader.checkDirectory(4), "acache"));
                                            if (!x6.g0) {
                                                x6Var3.n = x6.q0(3, FileLoader.checkDirectory(4));
                                                if (!x6.g0) {
                                                    x6Var3.C += x6Var3.n;
                                                    x6Var3.v = x6.q0(0, FileLoader.checkDirectory(1));
                                                    x6Var3.w = x6.q0(0, FileLoader.checkDirectory(6));
                                                    if (!x6.g0) {
                                                        long j11 = x6Var3.h + x6Var3.r + x6Var3.A + x6Var3.B + x6Var3.v + x6Var3.y + x6Var3.s + x6Var3.x + x6Var3.w + x6Var3.C;
                                                        x6.i0 = Long.valueOf(j11);
                                                        x6Var3.D = j11;
