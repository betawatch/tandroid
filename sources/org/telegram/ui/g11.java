...
public final class g11 extends View implements org.telegram.ui.Components.th0 {
    ...
    */
    public g11(ProfileActivity profileActivity, Context context) {
        super(context);
        ...
        if (lVar.getOccupyStatusBar()) {
            ...
            if (!z10) {
                ...
                ofFloat.addUpdateListener(new d3(this, 28));
                ofFloat.addListener(new mv0(this, 4));
            }
        }
        i10 = 0;
        this.a = i10;
        ...
        ofFloat2.setInterpolator(org.telegram.ui.Components.wr.j);
        ofFloat2.addUpdateListener(new d3(this, 28));
        ofFloat2.addListener(new mv0(this, 4));
    }
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        if (realCount <= 1 || realCount > 20) {
            ...
            z11 = ((org.telegram.ui.ActionBar.p2) profileActivity).inBubbleMode;
            ...
            while (i16 < realCount) {
                ...
                if (i16 != i17 || Math.abs(this.J - f12) <= 1.0E-4f) {
                    ...
                    if (i16 != this.M) {
                        ...
                        paint4.setAlpha((int) (AndroidUtilities.lerp(i11, 255, org.telegram.ui.Components.wr.j.getInterpolation(this.H[i16])) * this.G));
                    }
