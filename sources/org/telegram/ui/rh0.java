...
public final class rh0 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.yk0 e0;
    public final long f;
    public final ArrayList f0;
    public final ArrayList g0;
    public final boolean h;
    public final HashMap h0;
    public org.telegram.ui.Components.t60 i0;
    ...
    public rh0(long j10, long j11, int i10) {
        ...
        this.n0 = new gh0(this);
        boolean z4 = false;
        this.o0 = false;
        this.p0 = new hh0(this);
    ...
    */
    public static /* synthetic */ void U(rh0 rh0Var, TLRPC.TL_chatInviteExported tL_chatInviteExported, TLRPC.TL_error tL_error, TLObject tLObject, boolean z4) {
        boolean z10;
        boolean z11;
        long j10 = rh0Var.f;
        ArrayList arrayList = rh0Var.g0;
        ArrayList arrayList2 = rh0Var.f0;
        ih0 f02 = rh0Var.f0();
        rh0Var.T = false;
        rh0Var.Y = false;
        if (tL_chatInviteExported != null) {
            rh0Var.e = tL_chatInviteExported;
            TLRPC.ChatFull chatFull = rh0Var.d;
            if (chatFull != null) {
        ...
        if (tL_error == null) {
            ...
            if (z4) {
                ...
                if (j10 != rh0Var.getAccountInstance().getUserConfig().clientUserId && arrayList2.size() == 0 && tL_messages_exportedChatInvites.invites.size() > 0) {
                    rh0Var.e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInvites.invites.get(0);
                ...
                for (int i11 = 0; i11 < tL_messages_exportedChatInvites.invites.size(); i11++) {
                    ...
                    rh0Var.c0(tL_chatInviteExported3);
                    arrayList2.add(tL_chatInviteExported3);
                }
            }
            for (int i12 = 0; i12 < tL_messages_exportedChatInvites.users.size(); i12++) {
                rh0Var.h0.put(Long.valueOf(tL_messages_exportedChatInvites.users.get(i12).id), tL_messages_exportedChatInvites.users.get(i12));
            }
            int i13 = rh0Var.U;
            if (tL_messages_exportedChatInvites.invites.size() == 0) {
                rh0Var.Y = false;
            } else if (z4) {
                rh0Var.Y = arrayList.size() + 1 < tL_messages_exportedChatInvites.count;
            } else {
                rh0Var.Y = arrayList2.size() + 1 < tL_messages_exportedChatInvites.count;
            }
            if (tL_messages_exportedChatInvites.invites.size() <= 0 || !rh0Var.d0) {
                z10 = true;
            } else {
                org.telegram.ui.Components.yk0 yk0Var = rh0Var.e0;
                if (yk0Var != null && !rh0Var.isPaused) {
                    yk0Var.b(i13 + 1);
                }
                z10 = false;
            }
            TLRPC.ChatFull chatFull2 = rh0Var.d;
            if (chatFull2 != null && !z4) {
                chatFull2.invitesCount = tL_messages_exportedChatInvites.count;
                rh0Var.getMessagesStorage().saveChatLinksCount(rh0Var.n, rh0Var.d.invitesCount);
            }
        } else {
            rh0Var.Y = false;
            z10 = false;
        }
        if (rh0Var.Y || rh0Var.o0 || j10 != rh0Var.getAccountInstance().getUserConfig().clientUserId) {
            if (rh0Var.Y || rh0Var.o0) {
                z11 = false;
                if (rh0Var.Y) {
                }
                rh0Var.resumeDelayedFragmentAnimation();
                if (z11) {
                    rh0Var.d0(false);
                }
                if (!z10 && rh0Var.a != null && rh0Var.b.getChildCount() > 0) {
                    rh0Var.h0(f02);
                    return;
                }
                rh0Var.i0(true);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static /* synthetic */ void V(rh0 rh0Var, TLRPC.TL_error tL_error, TLObject tLObject) {
        org.telegram.ui.Components.yk0 yk0Var;
        ArrayList arrayList = rh0Var.j0;
        rh0Var.T = false;
        if (tL_error == null) {
            ...
            for (int i10 = 0; i10 < tL_messages_chatAdminsWithInvites.admins.size(); i10++) {
                ...
                if (tL_chatAdminWithInvites.admin_id != rh0Var.getAccountInstance().getUserConfig().clientUserId) {
            ...
            for (int i11 = 0; i11 < tL_messages_chatAdminsWithInvites.users.size(); i11++) {
                ...
                rh0Var.h0.put(Long.valueOf(user.id), user);
            }
        }
        int i12 = rh0Var.U;
        rh0Var.b0 = true;
        rh0Var.Y = false;
        if (arrayList.size() > 0 && (yk0Var = rh0Var.e0) != null && !rh0Var.isPaused && rh0Var.d0) {
            yk0Var.b(i12 + 1);
        }
        if (rh0Var.Y) {
        }
    ...
    public static void W(rh0 rh0Var) {
        if (rh0Var.f != rh0Var.getAccountInstance().getUserConfig().clientUserId) {
            rh0Var.e0(rh0Var.e);
            return;
        }
        TLRPC.TL_messages_exportChatInvite tL_messages_exportChatInvite = new TLRPC.TL_messages_exportChatInvite();
        tL_messages_exportChatInvite.peer = rh0Var.getMessagesController().getInputPeer(-rh0Var.n);
    ...
    public final View createView(Context context) {
        ...
        n0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        ...
        this.e0 = new org.telegram.ui.Components.yk0(this.b, false);
        f2.l lVar = new f2.l();
        lVar.n(420L);
        ...
        this.b.setOnItemLongClickListener(new dh0(this));
    ...
    public final ih0 f0() {
        ...
        ih0Var.b = this.U;
        ih0Var.k.clear();
        ih0Var.k.addAll(this.f0);
        ih0Var.l.clear();
        ih0Var.l.addAll(this.g0);
        return ih0Var;
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 16, new Class[]{org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.e2.class, org.telegram.ui.Components.x80.class, oh0.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.a5.class}, new String[]{"statusColor"}, null, null, -1, fVar, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{kh0.class}, new String[]{"messageTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.g9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.e2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.o6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 32, new Class[]{org.telegram.ui.Cells.e2.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.e2.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.k7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{oh0.class}, new String[]{"titleView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{oh0.class}, new String[]{"subtitleView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 8, new Class[]{oh0.class}, new String[]{"optionsView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Uh));
        return arrayList;
    }
    ...
    public final void onTransitionAnimationEnd(boolean z4, boolean z10) {
        ...
        if (z4) {
            this.d0 = true;
            if (z10 && (t60Var = this.i0) != null && t60Var.i0) {
                t60Var.show();
            }
        }
        this.q0.unlock();
