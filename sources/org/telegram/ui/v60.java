...
public final /* synthetic */ class v60 implements Runnable {
    ...
    public /* synthetic */ v60(w60 w60Var, String str, int i10) {
        this.a = i10;
        this.b = w60Var;
        this.c = str;
    }
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                String str2 = this.c;
                w60Var.getClass();
                AndroidUtilities.runOnUIThread(new v60(w60Var, str2, 1));
                break;
            case 1:
                w60 w60Var2 = this.b;
                String str3 = this.c;
                tf.k1 k1Var = w60Var2.f;
                y60 y60Var = w60Var2.F;
                k1Var.g(str3, true, y60Var.L || y60Var.M, true, false, 0L, false, 0, 0);
                DispatchQueue dispatchQueue = Utilities.searchQueue;
                v60 v60Var = new v60(w60Var2, str3, 2);
                w60Var2.h = v60Var;
                dispatchQueue.postRunnable(v60Var);
                break;
            default:
                w60 w60Var3 = this.b;
                String str4 = this.c;
                ArrayList arrayList2 = w60Var3.r;
                ...
                if (!lowerCase.isEmpty()) {
                    ...
                    AndroidUtilities.runOnUIThread(new rq(w60Var3, arrayList3, arrayList4, 10));
                    break;
                } else {
                    AndroidUtilities.runOnUIThread(new rq(w60Var3, new ArrayList(), new ArrayList(), 10));
                    break;
                }
                break;
        }
