...
public final class b2 extends m61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void W(v51 v51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.c2(this) { // from class: org.telegram.ui.web.w1
        ...
        if (i10 == 3) {
            ...
            d2Var2.T = LocaleController.formatString(i16, str);
            alertDialog$Builder2.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.c2(this) { // from class: org.telegram.ui.web.w1
                public final /* synthetic */ b2 b;
        ...
        if (i10 == 7) {
            ...
            alertDialog$Builder3.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.c2(this) { // from class: org.telegram.ui.web.w1
                public final /* synthetic */ b2 b;
        ...
        if (i10 == 5) {
            ...
            alertDialog$Builder4.k(LocaleController.getString(R.string.Delete), new org.telegram.ui.ActionBar.c2(this) { // from class: org.telegram.ui.web.w1
                public final /* synthetic */ b2 b;
        ...
        if (i18 == 6) {
            ...
            while (i19 < size2) {
                ...
                m6Var.b(charSequenceArr[i19], i19 == SharedConfig.searchEngineType);
                m6Var.setBackground(j6.f0(j6.w0(null, j6.i6, false), 2, -1));
                linearLayout.addView(m6Var);
                m6Var.setOnClickListener(new wa(i19, view, atomicReference));
                i19++;
            }
        ...
        if (i18 == 15 || i18 == 16) {
            ...
            d2Var6.R = string6;
            d2Var6.T = LocaleController.getString(isWebBrowserInAppEnabled2 ? R.string.BrowserSettingsAddText : R.string.BrowserSettingsAddTextExternal);
            ...
            da daVar = new da(editTextBoldCursor, veVar, d2VarArr, currentFocus, 12);
            editTextBoldCursor.setOnEditorActionListener(new org.telegram.ui.Components.g1(daVar, i12));
            ...
            alertDialog$Builder6.k(LocaleController.getString(R.string.Done), new org.telegram.ui.Components.t(daVar, i13));
            alertDialog$Builder6.h(LocaleController.getString(R.string.Cancel), new org.telegram.ui.Components.b(5));
            d2VarArr[0] = d2Var6;
            d2Var6.h0 = false;
            d2Var6.setOnDismissListener(new org.telegram.ui.Components.d1(editTextBoldCursor, i11));
            d2VarArr[0].setOnShowListener(new org.telegram.ui.Components.h1(i12, editTextBoldCursor));
            d2VarArr[0].show();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        i01Var.x = AndroidUtilities.dp(2.0f);
        this.d = i01Var;
