                ...
                */
                public final void run() {
                    ...
                    switch (i11) {
                        case 0:
                            w0 w0Var = j0Var.a;
                            e3 o10 = org.telegram.messenger.y1.o(w0Var.getContext(), null, false, false);
                            try {
                                                    ...
                                                    if (i14 != 0) {
                                                        if (i14 != 1) {
                                                            if (i14 == 2) {
                                                                ...
                                                                z0 z0Var = w0Var2.M;
                                                                if (z0Var != null) {
                                                                    new mc(z0Var, z0Var.e).k(false).k(true);
                                                                    break;
                                                                }
                                                            }
                                                        } else {
                                                            try {
                                                                ...
                                                                z0 z0Var2 = w0Var2.M;
                                                                if (z0Var2 != null) {
                                                                    new mc(z0Var2, z0Var2.e).Q(R.raw.ic_download, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.WebDownloadingFile, guessFileName))).k(true);
                                                                    break;
                                                                }
                                                            } catch (Exception e11) {
                                                                FileLog.e(e11);
                                                    ...
                                                    if (i14 != 0) {
                                                        if (i14 != 1) {
                                                            if (i14 == 2) {
                                                                ...
                                                                z0 z0Var3 = w0Var3.M;
                                                                if (z0Var3 != null) {
                                                                    new mc(z0Var3, z0Var3.e).k(false).k(true);
                                                                    break;
                                                                }
                                                            }
                                                        } else {
                            ...
                            if (parse != null && !parse.getScheme().equalsIgnoreCase("data")) {
                                str = we.e.v(parse, null, null, we.e.a(parse.getHost()), null);
                        ...
                        default:
                            w0 w0Var2 = j0Var.a;
                            e3 o11 = org.telegram.messenger.y1.o(w0Var2.getContext(), null, false, false);
                            try {
                                Uri parse2 = Uri.parse(str5);
                                str3 = we.e.v(parse2, null, null, we.e.a(parse2.getHost()), null);
                            } catch (Exception e11) {
                                try {
