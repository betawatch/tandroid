...
public final class i2 {
    ...
    public static void a(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            a((TL_iv.RichText) hg.k0.h(1, richText.texts));
            return;
        }
    ...
    public static void b(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            b((TL_iv.RichText) hg.k0.h(1, richText.texts));
            return;
        }
    ...
    public static u0 e(z0 z0Var, Utilities.Callback callback) {
        ...
        boolean[] zArr = {false};
        i2 i2Var = new i2();
        i2Var.a = z0Var.getUrl();
        Timer create = Timer.create("WebInstantView");
        a2 a2Var = new a2(Timer.start(create, "getHTML"), zArr, create, i2Var, callback, 0);
        System.currentTimeMillis();
        z0Var.evaluateJavascript(AndroidUtilities.readRes(R.raw.open_collapsed).replace("$OPEN$", "true"), new b2(i2Var, z0Var, new File(AndroidUtilities.getCacheDir(), "archive.mht"), a2Var, 0));
        ...
        try {
            ...
            if (l1Var == null) {
                ...
                if (arrayList == null) {
                    ...
                    new i1(new oj0(12, i2Var, h2Var)).execute(h2Var.b);
                    return;
                }
            ...
            if (h2Var.d <= 0 || h2Var.e <= 0) {
                ...
                if (i11 == 0 && h2Var.e == 0) {
                    ...
                    h2Var.e = options.outHeight;
                } else if (i11 == 0) {
                    h2Var.d = (int) ((options.outWidth / options.outHeight) * h2Var.e);
                } else if (h2Var.e == 0) {
                    h2Var.e = (int) ((options.outHeight / options.outWidth) * i11);
                }
                runnable.run();
            }
    ...
    public static void o(TLRPC.WebPage webPage) {
        ...
        if (i2Var != null) {
            ...
            hashMap2.clear();
            TLRPC.TL_webPage tL_webPage = i2Var.c;
    ...
    public static TL_iv.RichText p(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            ...
            q((TL_iv.RichText) hg.k0.h(1, richText.texts));
            return richText;
        }
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        h2 h2Var = new h2();
        h2Var.a = this;
        h2Var.id = (-1) - tL_page.photos.size();
        h2Var.b = optString2;
        h2Var.c.add(optString2);
        try {
            h2Var.d = Integer.parseInt(jSONObject.optString("width"));
        } catch (Exception unused) {
        }
        try {
            h2Var.e = Integer.parseInt(jSONObject.optString("height"));
        ...
        pageblockphoto.photo_id = h2Var.id;
    ...
    /* JADX WARN: Type inference failed for: r17v0, types: [org.telegram.ui.web.i2] */
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 >= tL_page.photos.size()) {
                                    h2Var = null;
                                } else if ((tL_page.photos.get(i12) instanceof h2) && tL_page.photos.get(i12).id == pageblockphoto2.photo_id) {
                ...
                switch (c10) {
                    ...
                    case 4:
                        if (!arrayList.isEmpty()) {
                            b((TL_iv.RichText) hg.k0.h(1, arrayList));
                        }
                        richText = l(jSONObject, tL_page);
                        break;
                    case 5:
                    ...
                    case 7:
                        if (!arrayList.isEmpty()) {
                            a((TL_iv.RichText) hg.k0.h(1, arrayList));
                        }
