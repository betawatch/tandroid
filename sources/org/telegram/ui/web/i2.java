...
public final class i2 {
    ...
    public static q0 e(y0 y0Var, Utilities.Callback callback) {
        ...
        boolean[] zArr = {false};
        i2 i2Var = new i2();
        i2Var.a = y0Var.getUrl();
        Timer create = Timer.create("WebInstantView");
        a2 a2Var = new a2(Timer.start(create, "getHTML"), zArr, create, i2Var, callback, 0);
        System.currentTimeMillis();
        y0Var.evaluateJavascript(AndroidUtilities.readRes(R.raw.open_collapsed).replace("$OPEN$", "true"), new b2(i2Var, y0Var, new File(AndroidUtilities.getCacheDir(), "archive.mht"), a2Var, 0));
