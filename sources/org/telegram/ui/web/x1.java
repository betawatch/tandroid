...
public final class x1 extends b61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void U(ArrayList arrayList, w51 w51Var) {
        ...
        long j11 = this.h;
        arrayList.add(h51.d(3, i12, string3, j11 > 0 ? AndroidUtilities.formatFileSize(j11) : ""));
        arrayList.size();
        int i13 = R.drawable.menu_clear_cache;
        String string4 = LocaleController.getString(R.string.BrowserSettingsCacheClear);
        long j12 = this.f;
        arrayList.add(h51.d(2, i13, string4, j12 > 0 ? AndroidUtilities.formatFileSize(j12) : ""));
        ...
        arrayList.size();
        arrayList.add(h51.d(6, R.drawable.msg_search, LocaleController.getString(R.string.SearchEngine), m1.a().a));
    ...
    public final void W(h51 h51Var, View view) {
        ...
        if (h51Var.G(v1.class)) {
            w1 w1Var = (w1) view;
            String str2 = w1Var.e;
            q70 F = q70.F((ViewGroup) this.fragmentView, null, w1Var);
            F.s = 40;
            F.c(R.drawable.menu_delete_old, LocaleController.getString(R.string.Remove), new bh1(i11, this, str2), false);
            F.Z();
            return;
        }
        int i19 = h51Var.d;
