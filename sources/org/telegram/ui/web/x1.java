...
public final class x1 extends b61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void U(ArrayList arrayList, w51 w51Var) {
        ...
        arrayList.size();
        arrayList.add(i51.d(6, R.drawable.msg_search, LocaleController.getString(R.string.SearchEngine), l1.a().a));
    ...
    public final void W(i51 i51Var, View view) {
        ...
        if (i10 == 1) {
            ...
            s8Var.b(j6.w0(null, isWebBrowserInAppEnabled ? j6.f6 : j6.e6, false), isWebBrowserInAppEnabled);
            this.a.V2.N(true);
            return;
        }
        if (i10 == 10) {
        ...
        if (i10 == 2) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.c2(this) { // from class: org.telegram.ui.web.t1
        ...
        if (i10 == 3) {
            ...
            alertDialog$Builder2.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.c2(this) { // from class: org.telegram.ui.web.t1
                public final /* synthetic */ x1 b;
        ...
        if (i10 == 7) {
            ...
            alertDialog$Builder3.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.c2(this) { // from class: org.telegram.ui.web.t1
                public final /* synthetic */ x1 b;
        ...
        if (i10 == 5) {
            ...
            alertDialog$Builder4.k(LocaleController.getString(R.string.Delete), new org.telegram.ui.ActionBar.c2(this) { // from class: org.telegram.ui.web.t1
                public final /* synthetic */ x1 b;
        ...
        if (i18 == 6) {
            ...
            int i19 = 0;
            while (i19 < size2) {
                charSequenceArr[i19] = ((l1) b10.get(i19)).a;
                ...
                k6Var.b(charSequenceArr[i19], i19 == SharedConfig.searchEngineType);
                k6Var.setBackground(j6.f0(j6.w0(null, j6.i6, false), 2, -1));
                linearLayout.addView(k6Var);
                k6Var.setOnClickListener(new m2(i19, view, atomicReference));
                i19++;
            }
        ...
        if (i18 == 15 || i18 == 16) {
            ...
            editTextBoldCursor.setOnEditorActionListener(new org.telegram.ui.Components.d1(ihVar, i12));
            ...
            alertDialog$Builder6.k(LocaleController.getString(R.string.Done), new org.telegram.ui.Components.t(ihVar, i13));
