...
public final class u1 extends d51 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void T(ArrayList arrayList, z41 z41Var) {
        ...
        long j11 = this.h;
        arrayList.add(l41.d(3, i11, string3, j11 > 0 ? AndroidUtilities.formatFileSize(j11) : ""));
        arrayList.size();
        int i12 = R.drawable.menu_clear_cache;
        String string4 = LocaleController.getString(R.string.BrowserSettingsCacheClear);
        long j12 = this.f;
        arrayList.add(l41.d(2, i12, string4, j12 > 0 ? AndroidUtilities.formatFileSize(j12) : ""));
        ...
        if (this.n > 0) {
            ...
            arrayList.size();
            arrayList.add(l41.d(7, R.drawable.menu_clear_cache, LocaleController.getString(R.string.BrowserSettingsHistoryClear), LocaleController.formatPluralStringComma("BrowserSettingsHistoryPages", (int) this.n, ',')));
            arrayList.add(l41.B(null));
        }
        ...
        arrayList.size();
        arrayList.add(l41.d(6, R.drawable.msg_search, LocaleController.getString(R.string.SearchEngine), j1.a().a));
    ...
    public final void V(l41 l41Var, View view) {
        ...
        if (i9 == 1) {
            ...
            t8Var.b(f6.w0(null, isWebBrowserInAppEnabled ? f6.f6 : f6.e6, false), isWebBrowserInAppEnabled);
            this.a.U2.N(true);
            return;
        }
        if (i9 == 10) {
        ...
        if (i9 == 2) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.b2(this) { // from class: org.telegram.ui.web.r1
        ...
        if (i9 == 3) {
            ...
            alertDialog$Builder2.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.b2(this) { // from class: org.telegram.ui.web.r1
                public final /* synthetic */ u1 b;
        ...
        if (i9 == 7) {
            ...
            alertDialog$Builder3.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.b2(this) { // from class: org.telegram.ui.web.r1
                public final /* synthetic */ u1 b;
        ...
        if (i9 == 5) {
            ...
            alertDialog$Builder4.k(LocaleController.getString(R.string.Delete), new org.telegram.ui.ActionBar.b2(this) { // from class: org.telegram.ui.web.r1
                public final /* synthetic */ u1 b;
        ...
        if (i17 == 6) {
            ...
            int i19 = 0;
            while (i19 < size2) {
                charSequenceArr[i19] = ((j1) b10.get(i19)).a;
                k6 k6Var = new k6(getParentActivity(), null);
                k6Var.setPadding(AndroidUtilities.dp(4.0f), 0, AndroidUtilities.dp(4.0f), 0);
                k6Var.a(f6.w0(null, f6.g7, false), f6.w0(null, f6.E5, false));
                k6Var.b(charSequenceArr[i19], i19 == SharedConfig.searchEngineType);
                k6Var.setBackground(f6.f0(f6.w0(null, f6.i6, false), 2, -1));
                linearLayout.addView(k6Var);
                k6Var.setOnClickListener(new a3(i19, view, atomicReference));
                i19++;
            }
        ...
        if (i17 == 15 || i17 == 16) {
            ...
            p6 p6Var = new p6(i18, this, isWebBrowserInAppEnabled2);
            ...
            int i20 = f6.j5;
            editTextBoldCursor.setTextColor(f6.v0(i20, resourceProvider));
            ...
            editTextBoldCursor.setCursorColor(f6.v0(f6.q6, resourceProvider));
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setCornerRadius(AndroidUtilities.dp(22.0f));
            gradientDrawable.setColor(f6.l1(0.06f, f6.v0(i20, resourceProvider)));
            editTextBoldCursor.setBackground(gradientDrawable);
            org.telegram.ui.k6 k6Var2 = new org.telegram.ui.k6(editTextBoldCursor, p6Var, c2VarArr, currentFocus, 15);
            editTextBoldCursor.setOnEditorActionListener(new org.telegram.ui.Components.c1(k6Var2, i11));
            ...
            alertDialog$Builder6.k(LocaleController.getString(R.string.Done), new org.telegram.ui.Components.s(k6Var2, i12));
            alertDialog$Builder6.h(LocaleController.getString(R.string.Cancel), new tr(9));
            c2VarArr[0] = c2Var6;
            c2Var6.d0 = false;
            c2Var6.setOnDismissListener(new org.telegram.ui.Components.a1(editTextBoldCursor, i10));
            c2VarArr[0].setOnShowListener(new org.telegram.ui.Components.d1(i11, editTextBoldCursor));
            c2VarArr[0].show();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        mutate2.setColorFilter(new PorterDuffColorFilter(getThemedColor(f6.k7), mode));
    ...
    public final void didReceivedNotification(int i9, int i10, Object... objArr) {
        c51 c51Var;
        if (i9 != NotificationCenter.webBrowserSettingsUpdate || (c51Var = this.a) == null) {
            return;
        }
        c51Var.U2.N(true);
    }
