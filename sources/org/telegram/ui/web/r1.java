...
public final class r1 {
    ...
    public final /* synthetic */ org.telegram.ui.m0 h;
    ...
    public r1(org.telegram.ui.m0 m0Var) {
        ...
        this.b = j6Var2;
        this.c = new z5(m0Var, 0L, 300L, nr.h);
        this.e = false;
        j6Var.E = true;
        ...
        j6Var2.G = 9999999;
        this.g = m0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }
    ...
    public final void a(Canvas canvas, float f10, float f11, float f12) {
        ...
        canvas.save();
        canvas.translate(0.0f, yh.c(1.0f, f13, AndroidUtilities.dp(4.0f), (AndroidUtilities.dp(14.0f) * f13) + ((1.0f - m0Var.D) * f14 * f13) + (-AndroidUtilities.dp(1.0f))));
        float lerp2 = AndroidUtilities.lerp(1.15f, 0.9f, f13) * m0Var.D;
        canvas.scale(lerp2, lerp2, 0.0f, 0.0f);
        j6Var2.r(i0.a.d(e, this.d, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q7, false)));
        if (e > 0.0f) {
            int i10 = this.f;
        ...
        m0Var.o0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
