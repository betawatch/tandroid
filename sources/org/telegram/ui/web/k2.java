...
public final class k2 {
    ...
    public static void a(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            a((TL_iv.RichText) hc.b.i(1, richText.texts));
            return;
        }
    ...
    public static void b(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            b((TL_iv.RichText) hc.b.i(1, richText.texts));
            return;
        }
    ...
    public static org.telegram.ui.Components.voip.x e(y0 y0Var, Utilities.Callback callback) {
        if (y0Var == null) {
            callback.run(null);
            return null;
        }
        boolean[] zArr = {false};
        k2 k2Var = new k2();
        k2Var.a = y0Var.getUrl();
        Timer create = Timer.create("WebInstantView");
        c2 c2Var = new c2(Timer.start(create, "getHTML"), zArr, create, k2Var, callback, 0);
        System.currentTimeMillis();
        y0Var.evaluateJavascript(AndroidUtilities.readRes(R.raw.open_collapsed).replace("$OPEN$", "true"), new d2(k2Var, y0Var, new File(AndroidUtilities.getCacheDir(), "archive.mht"), c2Var, 0));
        return new org.telegram.ui.Components.voip.x(zArr, 17);
    }
    ...
    public static void g(j2 j2Var, ImageReceiver imageReceiver, Runnable runnable) {
        k2 k2Var;
        l1 l1Var;
        Bitmap decodeStream;
        if (j2Var == null || (k2Var = j2Var.a) == null) {
            return;
        }
        HashMap hashMap = k2Var.d;
        try {
            if (k2Var.b != null) {
                Iterator it = j2Var.c.iterator();
                l1Var = null;
                while (it.hasNext()) {
                    l1Var = (l1) ((HashMap) k2Var.b.c).get((String) it.next());
                    if (l1Var != null) {
                        break;
                    }
                }
            ...
            if (l1Var == null) {
                if (hashMap.containsKey(j2Var.b)) {
                    imageReceiver.setImageBitmap((Bitmap) hashMap.get(j2Var.b));
                    return;
                }
                if (f == null) {
                    f = new HashMap();
                }
                ArrayList arrayList = (ArrayList) f.get(j2Var.b);
                if (arrayList == null) {
                    f.put(j2Var.b, new ArrayList());
                    new i1(new nj0(12, k2Var, j2Var)).execute(j2Var.b);
                    return;
                }
            ...
            if ((m1Var == null ? null : m1Var.a).contains("svg")) {
                if (j2Var.d > 0 && j2Var.e > 0) {
                    decodeStream = SvgHelper.getBitmap((InputStream) l1Var.a(), AndroidUtilities.dp(j2Var.d), AndroidUtilities.dp(j2Var.e), false);
                }
                return;
            }
            if (j2Var.d <= 0 || j2Var.e <= 0) {
                ...
                int i11 = j2Var.d;
                if (i11 == 0 && j2Var.e == 0) {
                    j2Var.d = options.outWidth;
                    j2Var.e = options.outHeight;
                } else if (i11 == 0) {
                    j2Var.d = (int) ((options.outWidth / options.outHeight) * j2Var.e);
                } else if (j2Var.e == 0) {
                    j2Var.e = (int) ((options.outHeight / options.outWidth) * i11);
                }
                runnable.run();
            }
    ...
    public static void o(TLRPC.WebPage webPage) {
        ...
        HashMap hashMap = e;
        k2 k2Var = (k2) hashMap.remove(webPage);
        if (k2Var != null) {
            hashMap.remove(k2Var.c);
            HashMap hashMap2 = k2Var.d;
            Iterator it = hashMap2.entrySet().iterator();
            while (it.hasNext()) {
                AndroidUtilities.recycleBitmap((Bitmap) ((Map.Entry) it.next()).getValue());
            }
            hashMap2.clear();
            TLRPC.TL_webPage tL_webPage = k2Var.c;
            ...
            while (i10 < size) {
                ...
                if (photo2 instanceof j2) {
                    j2 j2Var = (j2) photo2;
                    HashMap hashMap3 = f;
                    if (hashMap3 != null) {
                        hashMap3.remove(j2Var.b);
                    }
                }
            }
        }
    ...
    public static TL_iv.RichText p(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            ...
            q((TL_iv.RichText) hc.b.i(1, richText.texts));
            return richText;
        }
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        j2 j2Var = new j2();
        j2Var.a = this;
        j2Var.id = (-1) - tL_page.photos.size();
        j2Var.b = optString2;
        j2Var.c.add(optString2);
        try {
            j2Var.d = Integer.parseInt(jSONObject.optString("width"));
        } catch (Exception unused) {
        }
        try {
            j2Var.e = Integer.parseInt(jSONObject.optString("height"));
        ...
        pageblockphoto.photo_id = j2Var.id;
        pageblockphoto.url = optString2;
        tL_page.photos.add(j2Var);
    ...
    /* JADX WARN: Type inference failed for: r17v0, types: [org.telegram.ui.web.k2] */
    /* JADX WARN: Type inference failed for: r8v5, types: [org.telegram.tgnet.tl.TL_iv$pageBlockList] */
    /* JADX WARN: Type inference failed for: r8v6, types: [java.lang.Object] */
    /* JADX WARN: Type inference failed for: r8v7, types: [org.telegram.tgnet.tl.TL_iv$pageBlockOrderedList] */
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 >= tL_page.photos.size()) {
                                    j2Var = null;
                                } else if ((tL_page.photos.get(i12) instanceof j2) && tL_page.photos.get(i12).id == pageblockphoto2.photo_id) {
                                    j2Var = (j2) tL_page.photos.get(i12);
                                } else {
                                    i12++;
                                }
                            }
                            if (j2Var != null) {
                                j2Var.c.addAll(arrayList2);
                            }
    ...
    public final TL_iv.RichText k(JSONArray jSONArray, TL_iv.TL_page tL_page) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            ...
            if (obj instanceof String) {
                ...
                switch (c10) {
                    ...
                    case 4:
                        if (!arrayList.isEmpty()) {
                            b((TL_iv.RichText) hc.b.i(1, arrayList));
                        }
                        richText = l(jSONObject, tL_page);
                        break;
                    case 5:
                    ...
                    case 7:
                        if (!arrayList.isEmpty()) {
                            a((TL_iv.RichText) hc.b.i(1, arrayList));
                        }
                ...
                if (richText != null) {
                    arrayList.add(c(richText, jSONObject));
                }
            }
        }
        if (arrayList.isEmpty()) {
