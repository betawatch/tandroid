...
public final class e1 extends b61 {
    ...
    public zw0 w;
    public ArrayList e = c1.a(new y0(this, 1));
    public final ArrayList f = new ArrayList();
    public final HashSet s = new HashSet();

    public e1(org.telegram.ui.c0 c0Var, Utilities.Callback callback) {
        this.d = callback;
    }
        ...
        if (TextUtils.isEmpty(this.n)) {
            ...
            if (arrayList2 != null) {
                ...
                for (int size = arrayList2.size() - 1; size >= 0; size--) {
                    ...
                    if (i12 != i13) {
                        arrayList.add(i51.q(LocaleController.formatDateChat(b1Var.b / 1000)));
                        i12 = i13;
                    }
                    String str = this.n;
                    int i14 = g.a;
            ...
            while (size2 >= 0) {
                ...
                if (i15 != i16) {
                    arrayList.add(i51.q(LocaleController.formatDateChat(b1Var2.b / 1000)));
                    i15 = i16;
                }
                String str2 = this.n;
                int i17 = g.a;
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new jl0(this, 26));
