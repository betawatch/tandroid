...
public final class y1 extends y51 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void U(ArrayList arrayList, v51 v51Var) {
        ...
        arrayList.size();
        arrayList.add(h51.d(6, R.drawable.msg_search, LocaleController.getString(R.string.SearchEngine), n1.a().a));
    ...
    public final void W(h51 h51Var, View view) {
        ...
        if (i10 == 1) {
            ...
            x8Var.b(h6.w0(null, isWebBrowserInAppEnabled ? h6.f6 : h6.e6, false), isWebBrowserInAppEnabled);
            this.a.Y2.N(true);
            return;
        }
        if (i10 == 10) {
        ...
        if (i18 == 6) {
            ...
            while (i19 < size2) {
                ...
                l6Var.setOnClickListener(new wa(i19, view, atomicReference));
                i19++;
            }
