...
public final class v1 extends f51 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void U(ArrayList arrayList, b51 b51Var) {
        ...
        n41Var.d = 1;
        n41Var.l = string;
        n41Var.K(isWebBrowserInAppEnabled);
        ...
        if (!isWebBrowserInAppEnabled) {
            ...
            n41 i10 = n41.i(17, LocaleController.getString(R.string.WebBrowserShowCloseButton));
            ...
            arrayList.size();
            n41 e9 = n41.e(5, LocaleController.getString(R.string.BrowserSettingsNeverOpenInClearList2));
            e9.r = true;
            arrayList.add(e9);
        ...
        long j11 = this.h;
        arrayList.add(n41.d(3, i12, string3, j11 > 0 ? AndroidUtilities.formatFileSize(j11) : ""));
        arrayList.size();
        int i13 = R.drawable.menu_clear_cache;
        String string4 = LocaleController.getString(R.string.BrowserSettingsCacheClear);
        long j12 = this.f;
        arrayList.add(n41.d(2, i13, string4, j12 > 0 ? AndroidUtilities.formatFileSize(j12) : ""));
        ...
        if (this.n > 0) {
            ...
            arrayList.size();
            arrayList.add(n41.d(7, R.drawable.menu_clear_cache, LocaleController.getString(R.string.BrowserSettingsHistoryClear), LocaleController.formatPluralStringComma("BrowserSettingsHistoryPages", (int) this.n, ',')));
            arrayList.add(n41.B(null));
        }
        ...
        if (!webBrowserExceptionsList2.isEmpty()) {
            arrayList.size();
            n41 e10 = n41.e(5, LocaleController.getString(R.string.BrowserSettingsNeverOpenInClearList2));
            e10.r = true;
            arrayList.add(e10);
            arrayList.add(n41.B(null));
        }
        arrayList.size();
        arrayList.add(n41.d(6, R.drawable.msg_search, LocaleController.getString(R.string.SearchEngine), k1.a().a));
        pa.A(R.string.BrowserSettingsSearchEngineInfo, arrayList);
        if (BuildVars.DEBUG_PRIVATE_VERSION) {
            n41 i15 = n41.i(12, "adaptable colors");
            i15.K(SharedConfig.adaptableColorInBrowser);
            arrayList.add(i15);
            n41 i16 = n41.i(13, "only local IV");
    ...
    public final void W(n41 n41Var, View view) {
        ...
        if (i10 == 1) {
            ...
            boolean isWebBrowserInAppEnabled = getMessagesController().isWebBrowserInAppEnabled();
            p8 p8Var = (p8) view;
            p8Var.setChecked(isWebBrowserInAppEnabled);
            p8Var.b(g6.w0(null, isWebBrowserInAppEnabled ? g6.f6 : g6.e6, false), isWebBrowserInAppEnabled);
            this.a.U2.N(true);
            return;
        }
        if (i10 == 10) {
        ...
        if (i10 == 2) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.a2(this) { // from class: org.telegram.ui.web.s1
        ...
        if (i10 == 3) {
            ...
            alertDialog$Builder2.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.a2(this) { // from class: org.telegram.ui.web.s1
                public final /* synthetic */ v1 b;
        ...
        if (i10 == 7) {
            ...
            b2Var3.N = string3;
            b2Var3.P = LocaleController.formatString(R.string.BrowserSettingsHistoryClearText, LocaleController.formatDateChat(j10 / 1000));
            alertDialog$Builder3.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.a2(this) { // from class: org.telegram.ui.web.s1
                public final /* synthetic */ v1 b;
        ...
        if (i10 == 5) {
            ...
            alertDialog$Builder4.k(LocaleController.getString(R.string.Delete), new org.telegram.ui.ActionBar.a2(this) { // from class: org.telegram.ui.web.s1
                public final /* synthetic */ v1 b;
        ...
        if (n41Var.G(t1.class)) {
            u1 u1Var = (u1) view;
            String str2 = u1Var.e;
            b70 F = b70.F((ViewGroup) this.fragmentView, null, u1Var);
            F.s = 40;
            F.c(R.drawable.menu_delete_old, LocaleController.getString(R.string.Remove), new zh1(8, this, str2), false);
            F.Z();
            return;
        }
        int i18 = n41Var.d;
        ...
        if (i18 == 15 || i18 == 16) {
            ...
            o6 o6Var = new o6(i19, this, isWebBrowserInAppEnabled2);
            ...
            b2Var6.N = string6;
            b2Var6.P = LocaleController.getString(isWebBrowserInAppEnabled2 ? R.string.BrowserSettingsAddText : R.string.BrowserSettingsAddTextExternal);
    ...
    public final View createView(Context context) {
        ...
        jh.i2 i2Var = new jh.i2(mutate, mutate2, 4);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        e51 e51Var;
        if (i10 != NotificationCenter.webBrowserSettingsUpdate || (e51Var = this.a) == null) {
            return;
        }
        e51Var.U2.N(true);
    }
