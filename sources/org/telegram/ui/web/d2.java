...
public final class d2 {
    ...
    public String a;
    public com.google.firebase.messaging.t b;
    ...
    public static void g(c2 c2Var, ImageReceiver imageReceiver, Runnable runnable) {
        ...
        try {
            if (d2Var.b != null) {
                ...
                g1Var = null;
                while (it.hasNext()) {
                    g1Var = (g1) ((HashMap) d2Var.b.d).get((String) it.next());
                    if (g1Var != null) {
                        break;
                    }
                }
            ...
            if (g1Var == null) {
                if (hashMap.containsKey(c2Var.b)) {
                    imageReceiver.setImageBitmap((Bitmap) hashMap.get(c2Var.b));
                    return;
                }
                if (f == null) {
                    f = new HashMap();
                }
                ArrayList arrayList = (ArrayList) f.get(c2Var.b);
                if (arrayList == null) {
                    f.put(c2Var.b, new ArrayList());
                    new d1(new eb0(16, d2Var, c2Var)).execute(c2Var.b);
                    return;
                }
            ...
            if ((h1Var == null ? null : h1Var.a).contains("svg")) {
                if (c2Var.d > 0 && c2Var.e > 0) {
                    decodeStream = SvgHelper.getBitmap((InputStream) g1Var.a(), AndroidUtilities.dp(c2Var.d), AndroidUtilities.dp(c2Var.e), false);
                }
                return;
            }
            if (c2Var.d <= 0 || c2Var.e <= 0) {
                ...
                if (i10 == 0 && c2Var.e == 0) {
                    ...
                    c2Var.e = options.outHeight;
                } else if (i10 == 0) {
                    c2Var.d = (int) ((options.outWidth / options.outHeight) * c2Var.e);
                } else if (c2Var.e == 0) {
                    c2Var.e = (int) ((options.outHeight / options.outWidth) * i10);
                }
                runnable.run();
            }
    ...
    public static void o(TLRPC.WebPage webPage) {
        ...
        if (d2Var != null) {
            ...
            hashMap2.clear();
            TLRPC.TL_webPage tL_webPage = d2Var.c;
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        c2 c2Var = new c2();
        c2Var.a = this;
        c2Var.id = (-1) - tL_page.photos.size();
        c2Var.b = optString2;
        c2Var.c.add(optString2);
        try {
            c2Var.d = Integer.parseInt(jSONObject.optString("width"));
        } catch (Exception unused) {
        }
        try {
            c2Var.e = Integer.parseInt(jSONObject.optString("height"));
        ...
        pageblockphoto.photo_id = c2Var.id;
    ...
    /* JADX WARN: Type inference failed for: r17v0, types: [org.telegram.ui.web.d2] */
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i11 >= tL_page.photos.size()) {
                                    c2Var = null;
                                } else if ((tL_page.photos.get(i11) instanceof c2) && tL_page.photos.get(i11).id == pageblockphoto2.photo_id) {
