...
public final class h2 {
    ...
    public static void a(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            a((TL_iv.RichText) hg.c.h(1, richText.texts));
            return;
        }
    ...
    public static void b(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            b((TL_iv.RichText) hg.c.h(1, richText.texts));
            return;
        }
    ...
    public static t0 e(y0 y0Var, Utilities.Callback callback) {
        if (y0Var == null) {
            callback.run(null);
            return null;
        }
        ...
        try {
            ...
            if (k1Var == null) {
                ...
                if (arrayList == null) {
                    ...
                    new h1(new dt(21, h2Var, g2Var)).execute(g2Var.b);
                    return;
                }
            ...
            if (g2Var.d <= 0 || g2Var.e <= 0) {
                ...
                if (i11 == 0 && g2Var.e == 0) {
                    ...
                    g2Var.e = options.outHeight;
                } else if (i11 == 0) {
                    g2Var.d = (int) ((options.outWidth / options.outHeight) * g2Var.e);
                } else if (g2Var.e == 0) {
                    g2Var.e = (int) ((options.outHeight / options.outWidth) * i11);
                }
                runnable.run();
            }
    ...
    public static void o(TLRPC.WebPage webPage) {
        ...
        HashMap hashMap = e;
        h2 h2Var = (h2) hashMap.remove(webPage);
        if (h2Var != null) {
            hashMap.remove(h2Var.c);
            HashMap hashMap2 = h2Var.d;
            Iterator it = hashMap2.entrySet().iterator();
            while (it.hasNext()) {
                AndroidUtilities.recycleBitmap((Bitmap) ((Map.Entry) it.next()).getValue());
            }
            hashMap2.clear();
            TLRPC.TL_webPage tL_webPage = h2Var.c;
            ...
            while (i10 < size) {
                ...
                if (photo2 instanceof g2) {
                    g2 g2Var = (g2) photo2;
                    HashMap hashMap3 = f;
                    if (hashMap3 != null) {
                        hashMap3.remove(g2Var.b);
                    }
                }
            }
        }
    ...
    public static TL_iv.RichText p(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            ...
            q((TL_iv.RichText) hg.c.h(1, richText.texts));
            return richText;
        }
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        g2 g2Var = new g2();
        g2Var.a = this;
        g2Var.id = (-1) - tL_page.photos.size();
        g2Var.b = optString2;
        g2Var.c.add(optString2);
        try {
            g2Var.d = Integer.parseInt(jSONObject.optString("width"));
        } catch (Exception unused) {
        }
        try {
            g2Var.e = Integer.parseInt(jSONObject.optString("height"));
        ...
        pageblockphoto.photo_id = g2Var.id;
        pageblockphoto.url = optString2;
        tL_page.photos.add(g2Var);
    ...
    /* JADX WARN: Type inference failed for: r17v0, types: [org.telegram.ui.web.h2] */
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 >= tL_page.photos.size()) {
                                    g2Var = null;
                                } else if ((tL_page.photos.get(i12) instanceof g2) && tL_page.photos.get(i12).id == pageblockphoto2.photo_id) {
                                    g2Var = (g2) tL_page.photos.get(i12);
                                } else {
                                    i12++;
                                }
                            }
                            if (g2Var != null) {
                                g2Var.c.addAll(arrayList2);
                            }
                ...
                switch (c10) {
                    ...
                    case 4:
                        if (!arrayList.isEmpty()) {
                            b((TL_iv.RichText) hg.c.h(1, arrayList));
                        }
                        richText = l(jSONObject, tL_page);
                        break;
                    case 5:
                    ...
                    case 7:
                        if (!arrayList.isEmpty()) {
                            a((TL_iv.RichText) hg.c.h(1, arrayList));
                        }
