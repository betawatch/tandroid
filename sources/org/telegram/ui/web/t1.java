...
public final class t1 {
    ...
    public t1(org.telegram.ui.o0 o0Var) {
        ...
        this.b = j6Var2;
        this.c = new z5(o0Var, 0L, 300L, mr.h);
        this.e = false;
        j6Var.E = true;
    ...
    public final void a(Canvas canvas, float f10, float f11, float f12) {
        ...
        canvas.save();
        canvas.translate(0.0f, ai.c(1.0f, f13, AndroidUtilities.dp(4.0f), (AndroidUtilities.dp(14.0f) * f13) + ((1.0f - o0Var.D) * f14 * f13) + (-AndroidUtilities.dp(1.0f))));
        ...
        o0Var.o0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
