...
public final class z1 extends z51 implements NotificationCenter.NotificationCenterDelegate {
    public t3 d;
    ...
    public final void U(ArrayList arrayList, w51 w51Var) {
        ...
        long j10 = this.h;
        arrayList.add(i51.d(3, i12, string3, j10 > 0 ? AndroidUtilities.formatFileSize(j10) : ""));
        arrayList.size();
        int i13 = R.drawable.menu_clear_cache;
        String string4 = LocaleController.getString(R.string.BrowserSettingsCacheClear);
        long j11 = this.f;
        arrayList.add(i51.d(2, i13, string4, j11 > 0 ? AndroidUtilities.formatFileSize(j11) : ""));
        ...
        if (!webBrowserExceptionsList2.isEmpty()) {
            arrayList.size();
            i51 e7 = i51.e(5, LocaleController.getString(R.string.BrowserSettingsNeverOpenInClearList2));
            e7.r = true;
            arrayList.add(e7);
            arrayList.add(i51.B(null));
        }
        arrayList.size();
        arrayList.add(i51.d(6, R.drawable.msg_search, LocaleController.getString(R.string.SearchEngine), o1.a().a));
    ...
    public final void W(i51 i51Var, View view) {
        ...
        if (i10 == 9) {
            h1[] h1VarArr = {null};
            org.telegram.ui.ActionBar.n2 h1Var = new h1(null, new mj0(11, this, h1VarArr));
            h1VarArr[0] = h1Var;
        ...
        if (i51Var.G(x1.class)) {
            y1 y1Var = (y1) view;
            String str2 = y1Var.e;
            n70 F = n70.F((ViewGroup) this.fragmentView, null, y1Var);
            F.s = 40;
            F.c(R.drawable.menu_delete_old, LocaleController.getString(R.string.Remove), new pb1(27, this, str2), false);
            F.Z();
            return;
        }
        int i19 = i51Var.d;
        if (i19 == 6) {
            ...
            while (i20 < size2) {
                ...
                l6Var.setOnClickListener(new va(i20, view, atomicReference));
                i20++;
            }
        ...
        if (i19 == 15 || i19 == 16) {
            ...
            int i21 = i6.j5;
            editTextBoldCursor.setTextColor(i6.v0(i21, resourceProvider));
            ...
            gradientDrawable.setColor(i6.l1(0.06f, i6.v0(i21, resourceProvider)));
            ...
            alertDialog$Builder6.h(LocaleController.getString(R.string.Cancel), new es(6));
            b2VarArr[0] = b2Var6;
            b2Var6.h0 = false;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        y51 y51Var;
        if (i10 != NotificationCenter.webBrowserSettingsUpdate || (y51Var = this.a) == null) {
            return;
        }
        y51Var.Y2.N(true);
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        ...
        y51 y51Var = this.a;
        y51Var.setPadding(0, y51Var.getPaddingTop(), 0, i13);
