...
public final class e2 {
    ...
    public static nh.f0 e(w0 w0Var, Utilities.Callback callback) {
        ...
        boolean[] zArr = {false};
        e2 e2Var = new e2();
        e2Var.a = w0Var.getUrl();
        Timer create = Timer.create("WebInstantView");
        w1 w1Var = new w1(Timer.start(create, "getHTML"), zArr, create, e2Var, callback, 0);
    ...
    public static void g(d2 d2Var, ImageReceiver imageReceiver, Runnable runnable) {
        ...
        h1 h1Var;
        Bitmap decodeStream;
        if (d2Var == null || (e2Var = d2Var.a) == null) {
            return;
        }
        ...
        try {
            if (e2Var.b != null) {
                ...
                h1Var = null;
                while (it.hasNext()) {
                    h1Var = (h1) ((HashMap) e2Var.b.d).get((String) it.next());
                    if (h1Var != null) {
                        break;
                    }
                }
            ...
            if (h1Var == null) {
                if (hashMap.containsKey(d2Var.b)) {
                    imageReceiver.setImageBitmap((Bitmap) hashMap.get(d2Var.b));
                    return;
                }
                if (f == null) {
                    f = new HashMap();
                }
                ArrayList arrayList = (ArrayList) f.get(d2Var.b);
                if (arrayList == null) {
                    f.put(d2Var.b, new ArrayList());
                    new e1(new ib0(16, e2Var, d2Var)).execute(d2Var.b);
                    return;
                }
            ...
            if ((i1Var == null ? null : i1Var.a).contains("svg")) {
                if (d2Var.d > 0 && d2Var.e > 0) {
                    decodeStream = SvgHelper.getBitmap((InputStream) h1Var.a(), AndroidUtilities.dp(d2Var.d), AndroidUtilities.dp(d2Var.e), false);
                }
                return;
            }
            if (d2Var.d <= 0 || d2Var.e <= 0) {
                ...
                if (i11 == 0 && d2Var.e == 0) {
                    ...
                    d2Var.e = options.outHeight;
                } else if (i11 == 0) {
                    d2Var.d = (int) ((options.outWidth / options.outHeight) * d2Var.e);
                } else if (d2Var.e == 0) {
                    d2Var.e = (int) ((options.outHeight / options.outWidth) * i11);
                }
                runnable.run();
            }
    ...
    public static void o(TLRPC.WebPage webPage) {
        ...
        HashMap hashMap = e;
        e2 e2Var = (e2) hashMap.remove(webPage);
        if (e2Var != null) {
            hashMap.remove(e2Var.c);
            HashMap hashMap2 = e2Var.d;
            Iterator it = hashMap2.entrySet().iterator();
            while (it.hasNext()) {
                AndroidUtilities.recycleBitmap((Bitmap) ((Map.Entry) it.next()).getValue());
            }
            hashMap2.clear();
            TLRPC.TL_webPage tL_webPage = e2Var.c;
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        d2 d2Var = new d2();
        d2Var.a = this;
        d2Var.id = (-1) - tL_page.photos.size();
        d2Var.b = optString2;
        d2Var.c.add(optString2);
        try {
            d2Var.d = Integer.parseInt(jSONObject.optString("width"));
        } catch (Exception unused) {
        }
        try {
            d2Var.e = Integer.parseInt(jSONObject.optString("height"));
        ...
        pageblockphoto.photo_id = d2Var.id;
    ...
    /* JADX WARN: Type inference failed for: r17v0, types: [org.telegram.ui.web.e2] */
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 >= tL_page.photos.size()) {
                                    d2Var = null;
                                } else if ((tL_page.photos.get(i12) instanceof d2) && tL_page.photos.get(i12).id == pageblockphoto2.photo_id) {
