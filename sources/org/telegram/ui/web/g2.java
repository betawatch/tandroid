...
public final class g2 {
    ...
    public static void a(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            a((TL_iv.RichText) kh.a2.i(1, richText.texts));
            return;
        }
    ...
    public static void b(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            b((TL_iv.RichText) kh.a2.i(1, richText.texts));
            return;
        }
    ...
    public static o0 e(w0 w0Var, Utilities.Callback callback) {
        if (w0Var == null) {
            callback.run(null);
            return null;
        }
        boolean[] zArr = {false};
        g2 g2Var = new g2();
        g2Var.a = w0Var.getUrl();
        Timer create = Timer.create("WebInstantView");
        y1 y1Var = new y1(Timer.start(create, "getHTML"), zArr, create, g2Var, callback, 0);
        System.currentTimeMillis();
        w0Var.evaluateJavascript(AndroidUtilities.readRes(R.raw.open_collapsed).replace("$OPEN$", "true"), new z1(g2Var, w0Var, new File(AndroidUtilities.getCacheDir(), "archive.mht"), y1Var, 0));
        return new o0(zArr, 6);
    }
    ...
    public static void g(f2 f2Var, ImageReceiver imageReceiver, Runnable runnable) {
        g2 g2Var;
        i1 i1Var;
        Bitmap decodeStream;
        if (f2Var == null || (g2Var = f2Var.a) == null) {
            return;
        }
        HashMap hashMap = g2Var.d;
        try {
            if (g2Var.b != null) {
                Iterator it = f2Var.c.iterator();
                i1Var = null;
                while (it.hasNext()) {
                    i1Var = (i1) ((HashMap) g2Var.b.d).get((String) it.next());
                    if (i1Var != null) {
                        break;
                    }
                }
            ...
            if (i1Var == null) {
                if (hashMap.containsKey(f2Var.b)) {
                    imageReceiver.setImageBitmap((Bitmap) hashMap.get(f2Var.b));
                    return;
                }
                if (f == null) {
                    f = new HashMap();
                }
                ArrayList arrayList = (ArrayList) f.get(f2Var.b);
                if (arrayList == null) {
                    f.put(f2Var.b, new ArrayList());
                    new f1(new u1(1, g2Var, f2Var)).execute(f2Var.b);
                    return;
                }
            ...
            if ((j1Var == null ? null : j1Var.a).contains("svg")) {
                if (f2Var.d > 0 && f2Var.e > 0) {
                    decodeStream = SvgHelper.getBitmap((InputStream) i1Var.a(), AndroidUtilities.dp(f2Var.d), AndroidUtilities.dp(f2Var.e), false);
                }
                return;
            }
            if (f2Var.d <= 0 || f2Var.e <= 0) {
                ...
                BitmapFactory.decodeStream(i1Var.a(), null, options);
                int i11 = f2Var.d;
                if (i11 == 0 && f2Var.e == 0) {
                    f2Var.d = options.outWidth;
                    f2Var.e = options.outHeight;
                } else if (i11 == 0) {
                    f2Var.d = (int) ((options.outWidth / options.outHeight) * f2Var.e);
                } else if (f2Var.e == 0) {
                    f2Var.e = (int) ((options.outHeight / options.outWidth) * i11);
                }
                runnable.run();
            }
            decodeStream = BitmapFactory.decodeStream(i1Var.a());
    ...
    public static void o(TLRPC.WebPage webPage) {
        ...
        HashMap hashMap = e;
        g2 g2Var = (g2) hashMap.remove(webPage);
        if (g2Var != null) {
            hashMap.remove(g2Var.c);
            HashMap hashMap2 = g2Var.d;
            Iterator it = hashMap2.entrySet().iterator();
            while (it.hasNext()) {
                AndroidUtilities.recycleBitmap((Bitmap) ((Map.Entry) it.next()).getValue());
            }
            hashMap2.clear();
            TLRPC.TL_webPage tL_webPage = g2Var.c;
            ...
            while (i10 < size) {
                ...
                if (photo2 instanceof f2) {
                    f2 f2Var = (f2) photo2;
                    HashMap hashMap3 = f;
                    if (hashMap3 != null) {
                        hashMap3.remove(f2Var.b);
                    }
                }
            }
        }
    ...
    public static TL_iv.RichText p(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            ...
            q((TL_iv.RichText) kh.a2.i(1, richText.texts));
            return richText;
        }
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        f2 f2Var = new f2();
        f2Var.a = this;
        f2Var.id = (-1) - tL_page.photos.size();
        f2Var.b = optString2;
        f2Var.c.add(optString2);
        try {
            f2Var.d = Integer.parseInt(jSONObject.optString("width"));
        } catch (Exception unused) {
        }
        try {
            f2Var.e = Integer.parseInt(jSONObject.optString("height"));
        ...
        pageblockphoto.photo_id = f2Var.id;
        pageblockphoto.url = optString2;
        tL_page.photos.add(f2Var);
    ...
    /* JADX WARN: Type inference failed for: r17v0, types: [org.telegram.ui.web.g2] */
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 >= tL_page.photos.size()) {
                                    f2Var = null;
                                } else if ((tL_page.photos.get(i12) instanceof f2) && tL_page.photos.get(i12).id == pageblockphoto2.photo_id) {
                                    f2Var = (f2) tL_page.photos.get(i12);
                                } else {
                                    i12++;
                                }
                            }
                            if (f2Var != null) {
                                f2Var.c.addAll(arrayList2);
                            }
                ...
                switch (c3) {
                    ...
                    case 4:
                        if (!arrayList.isEmpty()) {
                            b((TL_iv.RichText) kh.a2.i(1, arrayList));
                        }
                        richText = l(jSONObject, tL_page);
                        break;
                    case 5:
                    ...
                    case 7:
                        if (!arrayList.isEmpty()) {
                            a((TL_iv.RichText) kh.a2.i(1, arrayList));
                        }
