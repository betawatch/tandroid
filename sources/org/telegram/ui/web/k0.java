                ...
                */
                public final void run() {
                    ...
                    switch (i11) {
                        case 0:
                            y0 y0Var = k0Var.a;
                            g3 o10 = y3.o(y0Var.getContext(), null, false, false);
                            try {
                                                    ...
                                                    if (i14 != 0) {
                                                        if (i14 != 1) {
                                                            if (i14 == 2) {
                                                                ...
                                                                c1 c1Var = y0Var2.N;
                                                                if (c1Var != null) {
                                                                    new qc(c1Var, c1Var.e).k(false).k(true);
                                                                    break;
                                                                }
                                                            }
                                                        } else {
                                                            try {
                                                                ...
                                                                c1 c1Var2 = y0Var2.N;
                                                                if (c1Var2 != null) {
                                                                    new qc(c1Var2, c1Var2.e).Q(R.raw.ic_download, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.WebDownloadingFile, guessFileName))).k(true);
                                                                    break;
                                                                }
                                                            } catch (Exception e10) {
                                                                FileLog.e(e10);
                                                    ...
                                                    if (i14 != 0) {
                                                        if (i14 != 1) {
                                                            if (i14 == 2) {
                                                                ...
                                                                c1 c1Var3 = y0Var3.N;
                                                                if (c1Var3 != null) {
                                                                    new qc(c1Var3, c1Var3.e).k(false).k(true);
                                                                    break;
                                                                }
                                                            }
                                                        } else {
                            ...
                            if (parse != null && !parse.getScheme().equalsIgnoreCase("data")) {
                                str = ze.d.v(parse, null, null, ze.d.a(parse.getHost()), null);
                        ...
                        default:
                            y0 y0Var2 = k0Var.a;
                            g3 o11 = y3.o(y0Var2.getContext(), null, false, false);
                            try {
                                Uri parse2 = Uri.parse(str5);
                                str3 = ze.d.v(parse2, null, null, ze.d.a(parse2.getHost()), null);
                            } catch (Exception e10) {
                                try {
