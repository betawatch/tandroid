...
public final class p1 {
    ...
    public final /* synthetic */ org.telegram.ui.n0 h;
    ...
    public p1(org.telegram.ui.n0 n0Var) {
        ...
        this.b = i6Var2;
        this.c = new y5(n0Var, 0L, 300L, gr.h);
        this.e = false;
        i6Var.E = true;
        ...
        i6Var2.G = 9999999;
        this.g = n0Var.getContext().getResources().getDrawable(R.drawable.warning_sign).mutate();
    }
    ...
    public final void a(Canvas canvas, float f10, float f11, float f12) {
        ...
        canvas.save();
        canvas.translate(0.0f, j3.r0.C(1.0f, f13, AndroidUtilities.dp(4.0f), (AndroidUtilities.dp(14.0f) * f13) + ((1.0f - n0Var.C) * f14 * f13) + (-AndroidUtilities.dp(1.0f))));
        float lerp2 = AndroidUtilities.lerp(1.15f, 0.9f, f13) * n0Var.C;
        canvas.scale(lerp2, lerp2, 0.0f, 0.0f);
        i6Var2.r(i0.a.d(e10, this.d, f6.w0(null, f6.q7, false)));
        if (e10 > 0.0f) {
            int i9 = this.f;
        ...
        n0Var.n0.b(canvas, rectF, 2, 1.0f);
        canvas.restore();
    }
}
