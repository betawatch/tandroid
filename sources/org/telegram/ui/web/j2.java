...
public final class j2 {
    ...
    public static void a(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            a((TL_iv.RichText) i2.g.h(1, richText.texts));
            return;
        }
    ...
    public static void b(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            b((TL_iv.RichText) i2.g.h(1, richText.texts));
            return;
        }
    ...
    public static b e(z0 z0Var, Utilities.Callback callback) {
        if (z0Var == null) {
            callback.run(null);
            return null;
        }
        ...
        try {
            ...
            if (m1Var == null) {
                ...
                if (arrayList == null) {
                    ...
                    new j1(new oj0(12, j2Var, i2Var)).execute(i2Var.b);
                    return;
                }
            ...
            if (i2Var.d <= 0 || i2Var.e <= 0) {
                ...
                if (i11 == 0 && i2Var.e == 0) {
                    ...
                    i2Var.e = options.outHeight;
                } else if (i11 == 0) {
                    i2Var.d = (int) ((options.outWidth / options.outHeight) * i2Var.e);
                } else if (i2Var.e == 0) {
                    i2Var.e = (int) ((options.outHeight / options.outWidth) * i11);
                }
                runnable.run();
            }
    ...
    public static void o(TLRPC.WebPage webPage) {
        ...
        if (j2Var != null) {
            ...
            hashMap2.clear();
            TLRPC.TL_webPage tL_webPage = j2Var.c;
    ...
    public static TL_iv.RichText p(TL_iv.RichText richText) {
        ...
        if (!richText.texts.isEmpty()) {
            ...
            q((TL_iv.RichText) i2.g.h(1, richText.texts));
            return richText;
        }
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        i2 i2Var = new i2();
        i2Var.a = this;
        i2Var.id = (-1) - tL_page.photos.size();
        i2Var.b = optString2;
        i2Var.c.add(optString2);
        try {
            i2Var.d = Integer.parseInt(jSONObject.optString("width"));
        } catch (Exception unused) {
        }
        try {
            i2Var.e = Integer.parseInt(jSONObject.optString("height"));
        ...
        pageblockphoto.photo_id = i2Var.id;
    ...
    /* JADX WARN: Type inference failed for: r17v0, types: [org.telegram.ui.web.j2] */
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 >= tL_page.photos.size()) {
                                    i2Var = null;
                                } else if ((tL_page.photos.get(i12) instanceof i2) && tL_page.photos.get(i12).id == pageblockphoto2.photo_id) {
                ...
                switch (c10) {
                    ...
                    case 4:
                        if (!arrayList.isEmpty()) {
                            b((TL_iv.RichText) i2.g.h(1, arrayList));
                        }
                        richText = l(jSONObject, tL_page);
                        break;
                    case 5:
                    ...
                    case 7:
                        if (!arrayList.isEmpty()) {
                            a((TL_iv.RichText) i2.g.h(1, arrayList));
                        }
