...
public final class f2 {
    ...
    public static void g(e2 e2Var, ImageReceiver imageReceiver, Runnable runnable) {
        ...
        h1 h1Var;
        Bitmap decodeStream;
        if (e2Var == null || (f2Var = e2Var.a) == null) {
            return;
        }
        ...
        try {
            if (f2Var.b != null) {
                ...
                h1Var = null;
                while (it.hasNext()) {
                    h1Var = (h1) ((HashMap) f2Var.b.d).get((String) it.next());
                    if (h1Var != null) {
                        break;
                    }
                }
            ...
            if (h1Var == null) {
                if (hashMap.containsKey(e2Var.b)) {
                    imageReceiver.setImageBitmap((Bitmap) hashMap.get(e2Var.b));
                    return;
                }
                if (f == null) {
                    f = new HashMap();
                }
                ArrayList arrayList = (ArrayList) f.get(e2Var.b);
                if (arrayList == null) {
                    f.put(e2Var.b, new ArrayList());
                    new e1(new yu0(9, f2Var, e2Var)).execute(e2Var.b);
                    return;
                }
            ...
            if ((i1Var == null ? null : i1Var.a).contains("svg")) {
                if (e2Var.d > 0 && e2Var.e > 0) {
                    decodeStream = SvgHelper.getBitmap((InputStream) h1Var.a(), AndroidUtilities.dp(e2Var.d), AndroidUtilities.dp(e2Var.e), false);
                }
                return;
            }
            if (e2Var.d <= 0 || e2Var.e <= 0) {
                ...
                if (i11 == 0 && e2Var.e == 0) {
                    ...
                    e2Var.e = options.outHeight;
                } else if (i11 == 0) {
                    e2Var.d = (int) ((options.outWidth / options.outHeight) * e2Var.e);
                } else if (e2Var.e == 0) {
                    e2Var.e = (int) ((options.outHeight / options.outWidth) * i11);
                }
                runnable.run();
            }
    ...
    public static void o(TLRPC.WebPage webPage) {
        ...
        if (f2Var != null) {
            ...
            hashMap2.clear();
            TLRPC.TL_webPage tL_webPage = f2Var.c;
    ...
    public final TL_iv.pageBlockPhoto h(JSONObject jSONObject, TL_iv.TL_page tL_page) {
        ...
        e2 e2Var = new e2();
        e2Var.a = this;
        e2Var.id = (-1) - tL_page.photos.size();
        e2Var.b = optString2;
        e2Var.c.add(optString2);
        try {
            e2Var.d = Integer.parseInt(jSONObject.optString("width"));
        } catch (Exception unused) {
        }
        try {
            e2Var.e = Integer.parseInt(jSONObject.optString("height"));
        ...
        pageblockphoto.photo_id = e2Var.id;
    ...
    /* JADX WARN: Type inference failed for: r17v0, types: [org.telegram.ui.web.f2] */
                        ...
                        if (pageblockphoto2 == null) {
                            ...
                            while (true) {
                                if (i12 >= tL_page.photos.size()) {
                                    e2Var = null;
                                } else if ((tL_page.photos.get(i12) instanceof e2) && tL_page.photos.get(i12).id == pageblockphoto2.photo_id) {
