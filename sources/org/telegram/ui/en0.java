...
public final class en0 extends org.telegram.ui.Components.uv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public en0(in0 in0Var, Context context, int i10) {
        super(context);
        this.Q = in0Var;
        this.x = new Object();
        this.y = 60000;
        ...
        org.telegram.messenger.z0.q(textView2, org.telegram.ui.ActionBar.h6.w0(null, i12, false), 1, 18.0f);
        ...
        if (i10 == 3) {
            ...
            if (i10 == 1) {
                ...
                imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.P9, false), mode));
                ...
                imageView4.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.P9, false), PorterDuff.Mode.MULTIPLY));
        ...
        bn0 bn0Var = new bn0(context, 0);
        this.n = bn0Var;
        bn0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i11, false));
        bn0Var.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        if (i10 == 3) {
            bn0Var.setTextSize(1, 14.0f);
            addView(bn0Var, w7.x5.q(-2, -2, LocaleController.isRTL ? 5 : 3));
            fn0 fn0Var = new fn0(context);
            Paint paint = new Paint();
            fn0Var.a = paint;
            Paint paint2 = new Paint();
            fn0Var.b = paint2;
            paint.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.gi, false));
            paint2.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.hi, false));
            this.s = fn0Var;
            bn0Var.setGravity(LocaleController.isRTL ? 5 : 3);
            addView(fn0Var, w7.x5.k(0.0f, 12.0f, 0.0f, 0.0f, -1, 3));
        } else {
            bn0Var.setPadding(0, AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(10.0f));
            bn0Var.setTextSize(1, 15.0f);
            bn0Var.setGravity(49);
            addView(bn0Var, w7.x5.q(-2, -2, 49));
        }
        bn0 bn0Var2 = new bn0(context, 1);
        this.r = bn0Var2;
        bn0Var2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.q6, false));
        bn0Var2.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        bn0Var2.setPadding(0, AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(10.0f));
        bn0Var2.setTextSize(1, 15.0f);
        bn0Var2.setGravity(49);
        if (i10 == 1) {
            bn0Var2.setText(LocaleController.getString(R.string.DidNotGetTheCodeSms));
        } else {
            bn0Var2.setText(LocaleController.getString(R.string.DidNotGetTheCode));
        }
        addView(bn0Var2, w7.x5.q(-2, -2, 49));
        bn0Var2.setOnClickListener(new h60(this, 16));
    }
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            alertDialog$Builder.h(LocaleController.getString(R.string.Stop), new zm0(this, 1));
    ...
    public final void h(String str) {
        ...
        in0Var.y1();
        i10 = ((org.telegram.ui.ActionBar.n2) in0Var).currentAccount;
        ConnectionsManager.getInstance(i10).sendRequest(verifyphone, new wb0(8, this, verifyphone), 2);
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.O) {
            ...
            while (i16 < this.O) {
                ...
                editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i17, false));
                this.d[i16].setCursorColor(org.telegram.ui.ActionBar.h6.w0(null, i17, false));
                ...
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.l6, false), PorterDuff.Mode.MULTIPLY));
                ...
                this.d[i16].addTextChangedListener(new cn0(this, i16));
                this.d[i16].setOnKeyListener(new View.OnKeyListener() { // from class: org.telegram.ui.an0
                    ...
                    public final boolean onKey(View view, int i18, KeyEvent keyEvent) {
                        ...
                        EditTextBoldCursor[] editTextBoldCursorArr3 = en0Var.d;
                        int i19 = i16;
                        if (editTextBoldCursorArr3[i19].length() != 0 || i19 <= 0) {
                            return false;
                        }
                        int i20 = i19 - 1;
                        EditTextBoldCursor editTextBoldCursor2 = en0Var.d[i20];
                        editTextBoldCursor2.setSelection(editTextBoldCursor2.length());
                        en0Var.d[i20].requestFocus();
                        en0Var.d[i20].dispatchKeyEvent(keyEvent);
                        return true;
                    }
                });
        ...
        fn0 fn0Var = this.s;
        if (fn0Var != null) {
            fn0Var.setVisibility(this.M != 0 ? 0 : 8);
        }
        if (this.a == null) {
            return;
        }
        String h = org.telegram.messenger.ul.h(new StringBuilder("+"), this.a, gf.b.c());
        if (i12 == 2) {
        ...
        if (i12 == 3) {
            ...
            if (i18 == 4 || i18 == 2) {
                ...
                bn0Var2.setVisibility(0);
                int i19 = this.M;
                if (i19 == 4) {
                    bn0Var2.setText(LocaleController.formatString("CallText", R.string.CallText, 1, 0));
                } else if (i19 == 2) {
                    bn0Var2.setText(LocaleController.formatString("SmsText", R.string.SmsText, 1, 0));
                }
                q();
                return;
            }
        ...
        if (i12 == i10 && ((i11 = this.M) == 4 || i11 == 3)) {
            ...
            objArr[0] = 2;
            objArr[1] = 0;
            bn0Var2.setText(LocaleController.formatString("CallText", i20, objArr));
            bn0Var.setVisibility(this.y < 1000 ? 0 : 8);
            bn0Var2.setVisibility(this.y < 1000 ? 8 : 0);
            q();
            return;
        }
        if (i12 != 4 || this.M != 2) {
            bn0Var2.setVisibility(8);
            bn0Var.setVisibility(8);
            p();
        } else {
            bn0Var2.setText(LocaleController.formatString("SmsText", R.string.SmsText, 2, 0));
            bn0Var.setVisibility(this.y < 1000 ? 0 : 8);
            bn0Var2.setVisibility(this.y < 1000 ? 8 : 0);
            q();
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        bn0 bn0Var = this.r;
        if (bn0Var.getVisibility() == 0) {
            int measuredHeight2 = bn0Var.getMeasuredHeight();
            i14 = (measuredHeight + bottom) - measuredHeight2;
            bn0Var.layout(bn0Var.getLeft(), i14, bn0Var.getRight(), measuredHeight2 + i14);
        } else {
            bn0 bn0Var2 = this.n;
            if (bn0Var2.getVisibility() == 0) {
                int measuredHeight3 = bn0Var2.getMeasuredHeight();
                i14 = (measuredHeight + bottom) - measuredHeight3;
                bn0Var2.layout(bn0Var2.getLeft(), i14, bn0Var2.getRight(), measuredHeight3 + i14);
            } else {
        ...
        int C = hg.c.C(i14 - bottom, measuredHeight4, 2, bottom);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (in0Var.s0 - dp < dp2) {
            ...
            setMeasuredDimension(getMeasuredWidth(), Math.min(in0Var.s0, dp3));
        }
    }
    ...
    public final void q() {
        ...
        this.v = timer;
        timer.schedule(new dn0(this), 0L, 1000L);
    }
