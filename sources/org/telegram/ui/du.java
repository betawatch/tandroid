...
public final class du extends org.telegram.ui.Components.il0 {
    ...
    */
        ...
        switch (i30) {
            case 1:
                ...
                if (i10 != i11) {
                    ...
                    if (i10 != i12) {
                        ...
                        if (i10 != i13) {
                            if (i10 != dataSettingsActivity.J) {
                                ...
                                if (i10 == i14) {
                                    y9Var.setIcon(0);
                                    y9Var.b(LocaleController.getString(R.string.PrivacyDeleteCloudDrafts), false);
                                    break;
                                }
                            } else {
                                y9Var.setIcon(0);
                                y9Var.b(LocaleController.getString(R.string.VoipQuickReplies), false);
                                break;
                            }
                        } else {
                            y9Var.setIcon(0);
                            ...
                            y9Var.b(LocaleController.getString(R.string.ResetAutomaticMediaDownload), false);
                            break;
                        }
                    } else {
                        y9Var.setIcon(0);
                        y9Var.b(LocaleController.getString(R.string.ProxySettings), false);
                        break;
                    }
                } else {
                    y9Var.setIcon(0);
                    int i32 = MessagesController.getGlobalMainSettings().getInt("VoipDataSaving", org.telegram.ui.Components.voip.h2.c());
                    if (i32 == 0) {
                    ...
                    y9Var.c(LocaleController.getString(R.string.VoipUseLessData), str, dataSettingsActivity.R, true);
                                ...
                                if (i10 != dataSettingsActivity.x) {
                                    if (i10 != dataSettingsActivity.E) {
                                        if (i10 == dataSettingsActivity.O) {
                                            k4Var.setText(LocaleController.getString(R.string.SaveToGallerySettings));
                                            break;
                                        }
                                    } else {
                                        k4Var.setText(LocaleController.getString(R.string.AutoplayMedia));
                                        break;
                                    }
                                } else {
                                    k4Var.setText(LocaleController.getString(R.string.Streaming));
                                    break;
                                }
                            } else {
                                k4Var.setText(LocaleController.getString(R.string.Proxy));
                                break;
                            }
                        } else {
                            k4Var.setText(LocaleController.getString(R.string.Calls));
                            break;
                        }
                    } else {
                        k4Var.setText(LocaleController.getString(R.string.DataUsage));
                        break;
                    }
                } else {
                    k4Var.setText(LocaleController.getString(R.string.AutomaticMediaDownload));
                    break;
                }
                break;
            case 3:
                            ...
                            if (i10 != dataSettingsActivity.B) {
                                if (i10 != dataSettingsActivity.F) {
                                    if (i10 == dataSettingsActivity.G) {
                                        q8Var.f(LocaleController.getString(R.string.AutoplayVideo), SharedConfig.isAutoplayVideo(), false);
                                        break;
                                    }
                                } else {
                                    q8Var.f(LocaleController.getString(R.string.AutoplayGIF), SharedConfig.isAutoplayGifs(), true);
                                    break;
                                }
                            } else {
                                q8Var.f("(beta only) Stream All Videos", SharedConfig.streamAllVideo, false);
                                break;
                            }
                        } else {
                            q8Var.f("(beta only) Show MKV as Video", SharedConfig.streamMkv, true);
                            break;
                        }
                    }
                } else {
                    q8Var.f(LocaleController.getString(R.string.EnableStreaming), SharedConfig.streamMedia, dataSettingsActivity.B != -1);
                    break;
                }
                break;
            case 4:
                ...
                if (i10 == dataSettingsActivity.D) {
                    y8Var.setText(LocaleController.getString(R.string.EnableAllStreamingInfo));
                    break;
                }
                break;
            case 5:
                    ...
                    if (i10 != i16) {
                        ...
                        if (i10 == i17) {
                            ...
                            if (i10 == dataSettingsActivity.e) {
                                ...
                                i19 = ((org.telegram.ui.ActionBar.o2) dataSettingsActivity).currentAccount;
                        ...
                        h5Var.setAnimationsEnabled(true);
                        h5Var.b(charSequence2, charSequence5, 0, z12, 0, true, z11, false);
                        break;
                    } else {
                        ...
                        i26 = ((org.telegram.ui.ActionBar.o2) dataSettingsActivity).currentAccount;
                ...
                h5Var.setAnimationsEnabled(true);
                h5Var.b(charSequence2, charSequence52, 0, z12, 0, true, z11, false);
                break;
            case 6:
                ...
                if (i10 != dataSettingsActivity.s) {
                    if (i10 != dataSettingsActivity.v) {
                        if (i10 == dataSettingsActivity.n) {
                            ...
                            m8Var.p(LocaleController.getString(R.string.StoragePath), LocaleController.getString((absolutePath == null || absolutePath.contains("/storage/emulated/")) ? R.string.InternalStorage : R.string.SdCard), true, R.drawable.msg_filled_sdcard, -1007845, -1996271, false);
                            break;
                        }
                    } else {
                        i29 = ((org.telegram.ui.ActionBar.o2) dataSettingsActivity).currentAccount;
                        StatsController statsController = StatsController.getInstance(i29);
                        m8Var.p(LocaleController.getString(R.string.NetworkUsage), AndroidUtilities.formatFileSize(statsController.getSentBytesCount(2, 6) + statsController.getSentBytesCount(1, 6) + statsController.getSentBytesCount(0, 6) + statsController.getReceivedBytesCount(2, 6) + statsController.getReceivedBytesCount(1, 6) + statsController.getReceivedBytesCount(0, 6)), true, R.drawable.msg_filled_datausage, -11154873, -14175180, dataSettingsActivity.n != -1);
                        break;
                    }
                } else {
                    if (dataSettingsActivity.T) {
                        m8Var.p(LocaleController.getString(R.string.StorageUsage), "", false, R.drawable.msg_filled_storageusage, -11565578, -13276952, true);
                        m8Var.f(45, true, dataSettingsActivity.S);
                    } else {
                        String string4 = LocaleController.getString(R.string.StorageUsage);
                        long j10 = dataSettingsActivity.U;
                        m8Var.p(string4, j10 <= 0 ? "" : AndroidUtilities.formatFileSize(j10), true, R.drawable.msg_filled_storageusage, -11565578, -13276952, true);
                        m8Var.f(45, false, dataSettingsActivity.S);
                    }
    ...
    public final f2.n1 x(ViewGroup viewGroup, int i10) {
        ...
        View m8Var = i10 != 0 ? i10 != 1 ? i10 != 2 ? i10 != 3 ? i10 != 4 ? i10 != 5 ? new org.telegram.ui.Cells.m8(context) : new org.telegram.ui.Cells.h5(context) : new org.telegram.ui.Cells.y8(context) : new org.telegram.ui.Cells.q8(context) : new org.telegram.ui.Cells.k4(context, 22) : new org.telegram.ui.Cells.y9(context) : new org.telegram.ui.Cells.x6(context, (b) null);
        return th.m(m8Var, m8Var, -1, -2);
    }
