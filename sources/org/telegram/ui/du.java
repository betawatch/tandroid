...
public final class du extends org.telegram.ui.Components.ab {
    ...
    public du(Activity activity, HashSet hashSet) {
        ...
        org.telegram.ui.Components.m90 a2 = w7.e6.a(activity, 20.0f, i11, true, this.resourcesProvider);
        a2.setText(LocaleController.getString(R.string.GroupCallCreateTitle));
        a2.setGravity(17);
        f7.addView(a2, w7.a6.t(-1, -2, 1, 2, 0, 2, 4));
        org.telegram.ui.Components.m90 a10 = w7.e6.a(activity, 14.0f, i11, false, this.resourcesProvider);
    ...
    public static void Q(du duVar, TLObject tLObject, bi.d dVar, boolean z10, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (!(tLObject instanceof TLRPC.Updates)) {
            ...
            duVar.dismiss();
            org.telegram.ui.Components.voip.e2.g(LaunchActivity.G1, duVar.currentAccount, tL_inputGroupCall, z10, groupcall.call, hashSet);
            return;
        }
        ...
        duVar.dismiss();
        org.telegram.ui.Components.voip.e2.g(LaunchActivity.G1, duVar.currentAccount, tL_inputGroupCall2, z10, groupCall2, hashSet);
    }
