...
public final class d60 {
    ...
    public final void b(int i10, int i11, int i12, long j10, float f10) {
        ...
        float interpolation = org.telegram.ui.Components.mr.g.getInterpolation(this.f / f14);
        float f15 = i12;
        float f16 = this.c;
        ...
        int i13 = this.i;
        float dp = (AndroidUtilities.dp(122.0f) / 400.0f) * (e60.p1(i13) ? 1.0f : i13 == 1 ? 4.0f : 2.5f);
