...
public final class uv0 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (cw0Var.L && cw0Var.a.getAlpha() != 1.0f) {
                int i22 = 0;
                ...
                if (i22 <= 0) {
                    ...
                    for (int i23 = cw0Var.n0; i23 < cw0Var.n0 + cw0Var.y; i23++) {
                        s4.c1 L = cw0Var.c.L(i23);
                        if (L != null) {
                            View view = L.a;
            ...
            ArrayList arrayList = new ArrayList(cw0Var.n);
            int i25 = 0;
            while (i25 < charSequenceArr.length) {
                if (!TextUtils.isEmpty(org.telegram.ui.Components.un.Y(charSequenceArr[i25]))) {
                    CharSequence[] charSequenceArr5 = new CharSequence[1];
                    charSequenceArr5[i17] = org.telegram.ui.Components.un.Y(charSequenceArr[i25]);
