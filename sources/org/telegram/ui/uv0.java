...
public final class uv0 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float dp3 = AndroidUtilities.dp(24.0f) + AndroidUtilities.dp(premiumPreviewFragment.Q.e.getVisibility() == 0 ? 24.0f : 16.0f) + (i9 - ((premiumPreviewFragment.Q.getMeasuredHeight() + kVar3.getMeasuredHeight()) - premiumPreviewFragment.T));
        ...
        float z11 = e2.c.z(1.0f, f14, 0.4f, 0.6f);
        ...
        premiumPreviewFragment.Q.a.setTranslationX((1.0f - org.telegram.ui.Components.gr.h.getInterpolation(1.0f - (f16 > 0.3f ? (f16 - 0.3f) / 0.7f : 0.0f))) * dp5);
        ...
        if (z10) {
            ...
            if (premiumPreviewFragment.m0 > 0.0f) {
                ...
                if (kVar6 != null) {
                    paint.setColor(i0.a.d(premiumPreviewFragment.m0, premiumPreviewFragment.getThemedColor(i10), premiumPreviewFragment.getThemedColor(org.telegram.ui.ActionBar.f6.d6)));
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        PremiumPreviewFragment premiumPreviewFragment = this.d;
        float x10 = premiumPreviewFragment.Q.c.getX() + premiumPreviewFragment.Q.getX();
        float y10 = premiumPreviewFragment.Q.c.getY() + premiumPreviewFragment.Q.getY();
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(x10, y10, (premiumPreviewFragment.Q.d == null ? 0 : r4.getMeasuredWidth()) + x10, (premiumPreviewFragment.Q.d == null ? 0 : r6.getMeasuredHeight()) + y10);
        ...
        float x11 = premiumPreviewFragment.Q.e.getX() + premiumPreviewFragment.Q.getX();
        float y11 = premiumPreviewFragment.Q.e.getY() + premiumPreviewFragment.Q.getY();
        rectF.set(x11, y11, premiumPreviewFragment.Q.e.getWidth() + x11, premiumPreviewFragment.Q.e.getHeight() + y11);
    ...
    public final void onSizeChanged(int i9, int i10, int i11, int i12) {
        ...
        for (int i14 = 0; i14 < arrayList2.size(); i14++) {
            ...
            premiumPreviewFragment.H.measure(View.MeasureSpec.makeMeasureSpec(i9, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i10, TLObject.FLAG_31));
            ((gw0) arrayList2.get(i14)).e = i13;
            i13 += premiumPreviewFragment.H.getMeasuredHeight();
        }
        for (int i15 = 0; i15 < arrayList.size(); i15++) {
            premiumPreviewFragment.H.a((gw0) arrayList.get(i15), false);
            premiumPreviewFragment.H.measure(View.MeasureSpec.makeMeasureSpec(i9, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i10, TLObject.FLAG_31));
            ((gw0) arrayList.get(i15)).e = i13;
            i13 += premiumPreviewFragment.H.getMeasuredHeight();
        }
