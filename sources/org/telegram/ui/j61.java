...
public final class j61 extends View {
    ...
    public final void b() {
        ...
        if (i61Var != null) {
            i61Var.h = false;
            i61Var.n = -1;
            if (i61Var.a != 2 || (paint = i61Var.x) == null) {
                return;
            }
    ...
    public final void c(TLRPC.Document document, c61 c61Var) {
        this.d = document;
        a(c61Var);
        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.h6.m6, 0.2f);
        if (this.V.W == 6) {
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.H) {
            ...
            if (drawable instanceof org.telegram.ui.Components.q5) {
                ...
                ai.l4 l4Var = ((org.telegram.ui.Components.q5) this.E).k;
                if (l4Var != null) {
    ...
    public void setDrawable(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (z10 && drawable2 != null && (drawable2 instanceof org.telegram.ui.Components.q5)) {
                ((org.telegram.ui.Components.q5) drawable2).p(p50Var);
            }
            this.E = drawable;
            if (this.H && (drawable instanceof org.telegram.ui.Components.q5)) {
                ((org.telegram.ui.Components.q5) drawable).b(p50Var);
            }
        }
    }
