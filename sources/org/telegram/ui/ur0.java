...
public final /* synthetic */ class ur0 implements Runnable {
    ...
    public /* synthetic */ ur0(us0 us0Var, int[] iArr, int[] iArr2, boolean z10, boolean z11, boolean z12) {
        this.e = us0Var;
        this.f = iArr;
        this.h = iArr2;
        this.b = z10;
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                photoViewer.d = new gu0(photoViewer, photoViewer.d, messageObject, orientation, this.c, this.d);
                photoViewer.p1.l();
            ...
            default:
                ...
                int i13 = ((int[]) obj)[0];
                if (i12 == i13) {
                    xu0 xu0Var = us0Var.b.e0;
                    boolean z11 = this.b;
                    int i14 = (this.c ? 1 : 0) + (z11 ? 1 : 0);
                    boolean z12 = this.d;
                    new org.telegram.ui.Components.vc(xu0Var, null).m(i14 + (z12 ? 1 : 0) > 1 ? org.telegram.ui.Components.uc.v : z12 ? i13 > 1 ? org.telegram.ui.Components.uc.s : org.telegram.ui.Components.uc.r : z11 ? i13 > 1 ? org.telegram.ui.Components.uc.n : org.telegram.ui.Components.uc.h : i13 > 1 ? org.telegram.ui.Components.uc.f : org.telegram.ui.Components.uc.e, i13, -115203550, -1, null).j();
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ ur0(PhotoViewer photoViewer, File file, boolean z10, MessageObject messageObject, boolean z11, boolean z12) {
        this.e = photoViewer;
        this.f = file;
        this.b = z10;
