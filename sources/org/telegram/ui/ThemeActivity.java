...
public class ThemeActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final bc1 R0;
    public int S;
    public org.telegram.ui.Components.hj0 S0;
    public int T;
    public boolean T0;
    public int U;
    public boolean U0;
    ...
    public ThemeActivity(int i10) {
        ...
        this.Q0 = new bc1(this);
        this.R0 = new bc1(this);
        this.f = i10;
        A0(true);
    }
    ...
    public static void C0(final int i10, final Context context, final Utilities.Callback callback, final org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        frameLayout.addView(imageView, w7.a6.e(50, 50, 17));
        f7.addView(frameLayout, w7.a6.t(80, 80, 1, 0, 20, 0, 8));
        int i13 = org.telegram.ui.ActionBar.j6.j5;
        TextView b10 = w7.e6.b(context, 20.0f, i13, true, f6Var);
        org.telegram.messenger.em.k(R.string.AgeVerificationTitle, b10, 17);
        f7.addView(b10, w7.a6.t(-1, -2, 7, 24, 8, 24, 8));
        TextView b11 = w7.e6.b(context, 14.0f, i13, false, f6Var);
        b11.setText(AndroidUtilities.replaceTags(LocaleController.getString("AgeVerificationText" + str2)));
        b11.setGravity(17);
        f7.addView(b11, w7.a6.t(-1, -2, 7, 24, 0, 24, 0));
        final bi.d dVar = new bi.d(context, f6Var, true);
        dVar.g(LocaleController.getString(R.string.AgeVerificationButton), false, true);
        dVar.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.yb1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                final bi.d dVar2 = bi.d.this;
                if (dVar2.N) {
                    return;
                }
                ...
                org.telegram.ui.Components.me0.e(i14, i15, new String[]{"android.permission.CAMERA"}, new String[]{"android.permission.CAMERA"}, new Utilities.Callback() { // from class: org.telegram.ui.ub1
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        boolean booleanValue = ((Boolean) obj).booleanValue();
                        final bi.d dVar3 = bi.d.this;
                        if (!booleanValue) {
                        ...
                        userNameResolver.resolve(str3, new e2.h() { // from class: org.telegram.ui.vb1
                            /* JADX WARN: Multi-variable type inference failed */
                            /* JADX WARN: Type inference failed for: r6v2, types: [org.telegram.messenger.Utilities$Callback4, org.telegram.ui.wb1] */
                            @Override // e2.h
                            public final void accept(Object obj2) {
                                Long l4 = (Long) obj2;
                                bi.d dVar4 = bi.d.this;
                                if (l4 == null) {
                                ...
                                di.j5 b12 = di.j5.b(i18, l4.longValue(), l4.longValue(), null, null, 4, 0, 0L, null, false, null, user, 0, false, false);
                                final di.n3 n3Var = new di.n3(context3, f6Var3);
                                final int i20 = i19;
                                final Utilities.Callback callback4 = callback3;
                                ?? r62 = new Utilities.Callback4() { // from class: org.telegram.ui.wb1
                                    ...
                                    public final void run(Object obj3, Object obj4, Object obj5, Object obj6) {
                                        ...
                                        org.telegram.messenger.a2.o(R.string.AgeVerificationPassedTitle, org.telegram.ui.Components.wc.a0(U2), R.raw.contact_check, 36);
                                    }
                                };
                                n3Var.H0 = r62;
                                di.e3 e3Var = n3Var.x;
                                if (e3Var != 0) {
                                    e3Var.setOnVerifiedAge(r62);
                                }
                                n3Var.w(true);
                                n3Var.A0 = false;
                                n3Var.k0 = U.getParentActivity();
                                n3Var.s(U, b12);
                                n3Var.show();
                                dVar4.setLoading(false);
                                h3VarArr2[0].dismiss();
        ...
        f7.addView(dVar, w7.a6.t(-1, 48, 7, 2, 29, 2, 14));
        i12.show();
        final org.telegram.ui.ActionBar.h3[] h3VarArr = {i12};
    ...
    public static void U(ThemeActivity themeActivity, TL_account.contentSettings contentsettings) {
        ...
        if (vl0Var == null || !vl0Var.G || (kc1Var = themeActivity.a) == null) {
            return;
        }
    ...
    public static void W(final ThemeActivity themeActivity, Context context, View view, final int i10, float f7) {
        ...
        if (i10 == themeActivity.E) {
            ...
            if (view instanceof org.telegram.ui.Cells.x8) {
                ((org.telegram.ui.Cells.x8) view).setChecked(SharedConfig.raiseToSpeak);
                return;
            }
            return;
        }
        if (i10 == themeActivity.F) {
            ...
            if (view instanceof org.telegram.ui.Cells.x8) {
                ((org.telegram.ui.Cells.x8) view).setChecked(SharedConfig.nextMediaTap);
                return;
            }
            return;
        }
        if (i10 == themeActivity.raiseToListenRow) {
            ...
            if (view instanceof org.telegram.ui.Cells.x8) {
                ((org.telegram.ui.Cells.x8) view).setChecked(SharedConfig.raiseToListen);
            }
                ...
                for (int i15 = 0; i15 < themeActivity.b.getChildCount(); i15++) {
                    ...
                    if (childAt instanceof org.telegram.ui.Cells.x8) {
                        ...
                        if (RecyclerView.R(childAt) == themeActivity.E) {
                            ((org.telegram.ui.Cells.x8) childAt).setChecked(false);
                        }
                    }
                }
            }
        ...
        if (i10 == themeActivity.pauseOnRecordRow) {
            ...
            if (view instanceof org.telegram.ui.Cells.x8) {
                ((org.telegram.ui.Cells.x8) view).setChecked(SharedConfig.pauseMusicOnRecord);
                return;
            }
            return;
        }
        if (i10 == themeActivity.pauseOnMediaRow) {
            ...
            if (view instanceof org.telegram.ui.Cells.x8) {
                ((org.telegram.ui.Cells.x8) view).setChecked(SharedConfig.pauseMusicOnMedia);
                return;
            }
            return;
        }
        ...
        if (i10 == themeActivity.K) {
            ...
            final int i17 = 0;
            while (i17 < 3) {
                org.telegram.ui.Cells.m6 m6Var = new org.telegram.ui.Cells.m6(themeActivity.getParentActivity(), null);
                ...
                m6Var.b(charSequenceArr[i17], i17 == SharedConfig.distanceSystemType);
                ...
                f11.addView(m6Var);
                m6Var.setOnClickListener(new View.OnClickListener(themeActivity) { // from class: org.telegram.ui.qb1
        ...
        if (i10 == themeActivity.L) {
            ...
            LinearLayout f12 = org.telegram.messenger.em.f(context, 1);
            ...
            while (i18 < size) {
                ...
                org.telegram.ui.Cells.m6 m6Var2 = new org.telegram.ui.Cells.m6(themeActivity.getParentActivity(), null);
                m6Var2.setPadding(AndroidUtilities.dp(f10), 0, AndroidUtilities.dp(4.0f), 0);
                m6Var2.a(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.g7, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.E5, false));
                m6Var2.b(charSequenceArr2[i18], i18 == SharedConfig.searchEngineType);
                m6Var2.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.i6, false), 2, -1));
                f12.addView(m6Var2);
                m6Var2.setOnClickListener(new View.OnClickListener(themeActivity) { // from class: org.telegram.ui.qb1
                    public final /* synthetic */ ThemeActivity b;
        ...
        if (i10 == themeActivity.M) {
            ...
            LinearLayout f13 = org.telegram.messenger.em.f(context, 1);
            org.telegram.ui.Cells.m6 m6Var3 = new org.telegram.ui.Cells.m6(themeActivity.getParentActivity(), null);
            m6Var3.setPadding(AndroidUtilities.dp(4.0f), 0, AndroidUtilities.dp(4.0f), 0);
            ...
            m6Var3.a(w02, org.telegram.ui.ActionBar.j6.w0(null, i20, false));
            m6Var3.b(LocaleController.getString(R.string.MicrophoneForVoiceMessagesBuiltIn), !SharedConfig.recordViaSco);
            int i21 = org.telegram.ui.ActionBar.j6.i6;
            m6Var3.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, i21, false), 2, -1));
            f13.addView(m6Var3);
            m6Var3.setOnClickListener(new View.OnClickListener(themeActivity) { // from class: org.telegram.ui.rb1
                public final /* synthetic */ ThemeActivity b;
                ...
                public final void onClick(View view2) {
                    switch (i14) {
                        ...
                        default:
                            ...
                            org.telegram.ui.Components.me0.e(i22, i23, new String[]{"android.permission.BLUETOOTH_CONNECT"}, new String[]{"android.permission.BLUETOOTH_CONNECT"}, new nj0(9, themeActivity3, atomicReference4));
            ...
            org.telegram.ui.Cells.m6 m6Var4 = new org.telegram.ui.Cells.m6(themeActivity.getParentActivity(), null);
            m6Var4.setPadding(AndroidUtilities.dp(4.0f), 0, AndroidUtilities.dp(4.0f), 0);
            m6Var4.a(org.telegram.ui.ActionBar.j6.w0(null, i19, false), org.telegram.ui.ActionBar.j6.w0(null, i20, false));
            ...
            m6Var4.a.setText(string3);
            TextView textView = m6Var4.b;
            textView.setVisibility(0);
            textView.setText(string4);
            m6Var4.c.a(z14, false);
            m6Var4.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, i21, false), 2, -1));
            f13.addView(m6Var4);
            m6Var4.setOnClickListener(new View.OnClickListener(themeActivity) { // from class: org.telegram.ui.rb1
                public final /* synthetic */ ThemeActivity b;
        ...
        if (i10 == themeActivity.y) {
            ...
            if (view instanceof org.telegram.ui.Cells.x8) {
                ((org.telegram.ui.Cells.x8) view).setChecked(SharedConfig.directShare);
                return;
            }
            return;
        }
        if (i10 == themeActivity.sensitiveContentRow) {
            ...
            r91 r91Var = new r91(i16, themeActivity, view);
            ...
            d2Var4.R = string6;
            d2Var4.T = LocaleController.getString(R.string.ConfirmSensitiveContentText);
            alertDialog$Builder4.k(LocaleController.getString(R.string.Confirm), new fz0(6, themeActivity, r91Var));
        ...
        if (i10 == themeActivity.Q) {
            ...
            d2Var5.R = string7;
            alertDialog$Builder5.f(new CharSequence[]{LocaleController.getString("Default", R.string.Default), LocaleController.getString("SortFirstName", R.string.SortFirstName), LocaleController.getString("SortLastName", R.string.SortLastName)}, new az(themeActivity, i10, i16));
        ...
        if (i10 == themeActivity.s0) {
            ...
            if (view instanceof org.telegram.ui.Cells.x8) {
                ((org.telegram.ui.Cells.x8) view).setChecked(SharedConfig.chatBlurEnabled());
                return;
            }
            return;
        }
        ...
        if (i10 == themeActivity.browserRow) {
            if ((!LocaleController.isRTL || f7 > AndroidUtilities.dp(76.0f)) && (LocaleController.isRTL || f7 < view.getMeasuredWidth() - AndroidUtilities.dp(76.0f))) {
                themeActivity.presentFragment(new org.telegram.ui.web.b2(null));
                return;
            } else {
        ...
        if (i10 == themeActivity.a0 || i10 == themeActivity.b0) {
            ...
            int i23 = i11 - (i12 * 60);
            final org.telegram.ui.Cells.ga gaVar = (org.telegram.ui.Cells.ga) view;
            themeActivity.showDialog(new TimePickerDialog(themeActivity.getParentActivity(), new TimePickerDialog.OnTimeSetListener() { // from class: org.telegram.ui.sb1
                @Override // android.app.TimePickerDialog.OnTimeSetListener
                public final void onTimeSet(TimePicker timePicker, int i24, int i25) {
                    int i26 = (i24 * 60) + i25;
                    int i27 = ThemeActivity.this.a0;
                    int i28 = i10;
                    org.telegram.ui.Cells.ga gaVar2 = gaVar;
                    if (i28 == i27) {
                        org.telegram.ui.ActionBar.j6.r = i26;
                        gaVar2.c(LocaleController.getString("AutoNightFrom", R.string.AutoNightFrom), String.format("%02d:%02d", Integer.valueOf(i24), Integer.valueOf(i25)), false, true);
                    } else {
                        org.telegram.ui.ActionBar.j6.s = i26;
                        gaVar2.c(LocaleController.getString("AutoNightTo", R.string.AutoNightTo), String.format("%02d:%02d", Integer.valueOf(i24), Integer.valueOf(i25)), false, true);
                    }
                }
            }, i12, i23, true));
            return;
    ...
    public static void X(ThemeActivity themeActivity, r91 r91Var) {
        C0(themeActivity.currentAccount, themeActivity.getParentActivity(), new nj0(10, themeActivity, r91Var), themeActivity.getResourceProvider());
    }
    ...
    public static boolean Y(ThemeActivity themeActivity, int i10, boolean z10) {
        ...
        if (K != null) {
            ...
            if (view instanceof lc1) {
                lc1 lc1Var = (lc1) view;
                org.telegram.ui.Cells.t1[] cells = lc1Var.a.getCells();
        ...
        if (K2 != null) {
            View view2 = K2.a;
            if (view2 instanceof ac1) {
                ac1 ac1Var = (ac1) view2;
                if (z10) {
                    ac1Var.requestLayout();
                } else {
                    ac1Var.invalidate();
                }
            }
        ...
        if (i10 != SharedConfig.fontSize) {
            ...
            if (sharedPreferences != null) {
                ...
                if (K != null) {
                    View view = K.a;
                    if (view instanceof lc1) {
                        org.telegram.ui.Cells.t1[] cells = ((lc1) view).a.getCells();
                        for (int i11 = 0; i11 < cells.length; i11++) {
                            cells[i11].getMessageObject().resetLayout();
                            cells[i11].requestLayout();
                        }
    ...
    public final void A0(boolean z10) {
        ...
        Collections.sort(arrayList, new org.telegram.ui.Components.m9(23));
        if (i10 == 3) {
            int i21 = this.J0;
            this.w0 = i21;
            this.p0 = i21 + 1;
        ...
        if (hc1Var3 != null) {
            ...
            int i40 = hc1Var3.g3;
            org.telegram.ui.Cells.qa qaVar = hc1Var3.c3;
            if (i40 != qaVar.h()) {
                qaVar.l();
                if (hc1Var3.b3 != (hc1Var3.f3 == 1 ? org.telegram.ui.ActionBar.j6.J : org.telegram.ui.ActionBar.j6.A0())) {
                    hc1Var3.w1(width);
                }
            }
        }
                    ...
                    while (i43 < 4) {
                        ...
                        if (fl0Var != null) {
                            ...
                            if (view instanceof org.telegram.ui.Cells.la) {
                                ((org.telegram.ui.Cells.la) view).setTypeChecked(i43 == org.telegram.ui.ActionBar.j6.o);
                            }
                        }
                        i43++;
                    }
    ...
    public final void B0(Location location, boolean z10) {
        ...
        if (getParentActivity() != null) {
            ...
            try {
                if (!((LocationManager) ApplicationLoader.applicationContext.getSystemService("location")).isProviderEnabled("gps")) {
                    ...
                    alertDialog$Builder.k(LocaleController.getString("ConnectingToProxyEnable", R.string.ConnectingToProxyEnable), new tb1(this, 2));
                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
        ...
        Utilities.globalQueue.postRunnable(new xb1(this, 1));
        org.telegram.ui.Components.fl0 fl0Var = (org.telegram.ui.Components.fl0) this.b.K(this.Z);
        if (fl0Var != null) {
            View view = fl0Var.a;
            if (view instanceof org.telegram.ui.Cells.f9) {
                ((org.telegram.ui.Cells.f9) view).setText(y0());
            }
        }
    ...
    public final View createView(Context context) {
        ...
        if (i10 == 3) {
            ...
            org.telegram.ui.Components.hj0 hj0Var2 = this.S0;
            hj0Var2.h = true;
            this.s = n10.d(5, hj0Var2);
        } else if (i10 == 0) {
            ...
            if (getMessagesController().getContentSettings() == null) {
                getMessagesController().getContentSettings(new u3(this, 20));
            }
        } else {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new zb1(this));
        this.a = new kc1(this, context);
        FrameLayout frameLayout = new FrameLayout(context);
        ...
        this.b.setOnItemClickListener(new fz0(7, this, context));
        if (i10 == 0) {
            s4.j jVar = new s4.j();
            jVar.n(350L);
        ...
        if (this.T0) {
            ...
            AndroidUtilities.runOnUIThread(new xb1(this, 0), 200L);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.webBrowserSettingsUpdate) {
            kc1 kc1Var = this.a;
            if (kc1Var == null || (i14 = this.browserRow) == -1) {
                return;
            }
            kc1Var.m(i14);
            return;
        ...
        if (i10 == NotificationCenter.themeUploadedToServer) {
            ...
            if (i6Var == this.h && h6Var == this.n) {
                ...
                showDialog(new org.telegram.ui.Components.sq0(getParentActivity(), null, sb3, false, sb3, false, null));
        ...
        if (i10 == NotificationCenter.needShareTheme) {
            ...
            this.r = d2Var3;
            d2Var3.g0 = true;
            showDialog(d2Var3, new s5(this, 17));
            return;
        }
        ...
        if (this.U0 != z10) {
            this.U0 = z10;
            org.telegram.ui.Components.hj0 hj0Var = this.S0;
            hj0Var.P(!f12 ? hj0Var.e[0] - 1 : 0);
            this.s.getIconView().d();
        }
        if (this.p0 >= 0) {
            for (int i16 = 0; i16 < this.b.getChildCount(); i16++) {
                if (this.b.getChildAt(i16) instanceof hv) {
                    ((hv) this.b.getChildAt(i16)).b();
                }
            }
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 16, new Class[]{org.telegram.ui.Cells.ga.class, org.telegram.ui.Cells.x8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.k0.class, org.telegram.ui.Cells.la.class, lc1.class, ac1.class, gc1.class, org.telegram.ui.Cells.j5.class, org.telegram.ui.Cells.ra.class, ic1.class, org.telegram.ui.Cells.s8.class, fp0.class, org.telegram.ui.Components.fz0.class, hv.class, org.telegram.ui.Cells.t.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"valueTextView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"imageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i14 = org.telegram.ui.ActionBar.j6.M6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, i14));
        int i15 = org.telegram.ui.ActionBar.j6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, i15));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.la.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.la.class}, new String[]{"checkImage"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Mh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 2048, new Class[]{lc1.class}, new String[]{"sizeBar"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, new String[]{"sizeBar"}, null, null, -1, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 2048, new Class[]{ac1.class}, new String[]{"sizeBar"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{ac1.class}, new String[]{"sizeBar"}, null, null, -1, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{gc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.g7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{gc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.h7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"checkBox"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.j5.class}, new String[]{"checkBox"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.m3, org.telegram.ui.ActionBar.j6.q3}, null, org.telegram.ui.ActionBar.j6.ra));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.n3, org.telegram.ui.ActionBar.j6.r3}, null, org.telegram.ui.ActionBar.j6.dc));
        Drawable[] drawableArr = org.telegram.ui.ActionBar.j6.m3.y;
        int i19 = org.telegram.ui.ActionBar.j6.ta;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, drawableArr, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, org.telegram.ui.ActionBar.j6.q3.y, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.o3, org.telegram.ui.ActionBar.j6.s3}, null, org.telegram.ui.ActionBar.j6.Aa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.o3, org.telegram.ui.ActionBar.j6.s3}, null, org.telegram.ui.ActionBar.j6.Da));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.o3, org.telegram.ui.ActionBar.j6.s3}, null, org.telegram.ui.ActionBar.j6.Ea));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.o3, org.telegram.ui.ActionBar.j6.s3}, null, org.telegram.ui.ActionBar.j6.Fa));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.p3, org.telegram.ui.ActionBar.j6.t3}, null, org.telegram.ui.ActionBar.j6.Ba));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.o3, org.telegram.ui.ActionBar.j6.s3}, null, org.telegram.ui.ActionBar.j6.Ca));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.m3, org.telegram.ui.ActionBar.j6.q3}, null, i19));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.ec));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.fc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.y3}, null, org.telegram.ui.ActionBar.j6.Ja));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.z3}, null, org.telegram.ui.ActionBar.j6.Ka));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.A3, org.telegram.ui.ActionBar.j6.C3}, null, org.telegram.ui.ActionBar.j6.La));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.B3, org.telegram.ui.ActionBar.j6.D3}, null, org.telegram.ui.ActionBar.j6.Ma));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.F3, org.telegram.ui.ActionBar.j6.G3}, null, org.telegram.ui.ActionBar.j6.sc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Uc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.ab));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Wc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.cb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.Yc));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.db));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.ad));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.fb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.nd));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.sb));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.od));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{lc1.class}, null, null, null, org.telegram.ui.ActionBar.j6.nb));
        ...
        arrayList.addAll(w7.d6.a(new zy0(6, this), i20, i11, i12));
        return arrayList;
    }
    ...
    public final void w0() {
        ...
        alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
        alertDialog$Builder.k(LocaleController.getString("CreateTheme", R.string.CreateTheme), new tb1(this, 1));
        showDialog(alertDialog$Builder.a);
    }

    public final void x0() {
        org.telegram.ui.ActionBar.i6 A0 = org.telegram.ui.ActionBar.j6.A0();
        presentFragment(new ae1(A0, false, 1, A0.k(false).a >= 100, this.f == 1));
    }
    ...
    public final void z0() {
        ...
        if (SharedConfig.fontSize == i10 && SharedConfig.bubbleRadius == 17 && A02.S && A02.Y == org.telegram.ui.ActionBar.j6.n && (k10 == null || (c6Var = k10.y) == null || "d".equals(c6Var.c))) {
            this.s.r(4);
        } else {
            this.s.K(4);
        }
