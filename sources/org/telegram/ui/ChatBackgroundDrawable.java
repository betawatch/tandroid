...
public class ChatBackgroundDrawable extends Drawable {
    ...
    int alpha = NotificationCenter.closeOtherAppActivities;
    ...
    public static Drawable createThumb(TLRPC.WallPaper wallPaper) {
        ...
        if (wallPaper.document != null) {
            ...
            if (wallPaperSettings == null || wallPaperSettings.intensity < 0) {
                ...
                bitmapDrawableOf = bitmapDrawableOf(new ColorDrawable(ColorUtils.setAlphaComponent(wallPaper.settings.background_color, NotificationCenter.closeOtherAppActivities)));
            } else if (wallPaperSettings.third_background_color == 0) {
                bitmapDrawableOf = bitmapDrawableOf(new GradientDrawable(BackgroundGradientDrawable.getGradientOrientation(wallPaper.settings.rotation), new int[]{ColorUtils.setAlphaComponent(wallPaperSettings.background_color, NotificationCenter.closeOtherAppActivities), ColorUtils.setAlphaComponent(wallPaper.settings.second_background_color, NotificationCenter.closeOtherAppActivities)}));
            } else {
                int alphaComponent = ColorUtils.setAlphaComponent(wallPaperSettings.background_color, NotificationCenter.closeOtherAppActivities);
                ...
                int alphaComponent3 = ColorUtils.setAlphaComponent(wallPaper.settings.third_background_color, NotificationCenter.closeOtherAppActivities);
                int i = wallPaper.settings.fourth_background_color;
                r2 = i != 0 ? ColorUtils.setAlphaComponent(i, NotificationCenter.closeOtherAppActivities) : 0;
                MotionBackgroundDrawable motionBackgroundDrawable = new MotionBackgroundDrawable();
