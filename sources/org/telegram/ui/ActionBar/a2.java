...
public class a2 extends Dialog implements Drawable.Callback, NotificationCenter.NotificationCenterDelegate {
    ...
    public final ViewGroup f(boolean z10) {
        ...
        if ((z11 || i11 == 3) && i11 != 2) {
            ...
            if (z12) {
                ...
                ai.k2 k2Var = yf.i0.a;
                y1Var2.setOutlineProvider(new yf.h0(dp, dp2));
        ...
        if (z13) {
            if (this.Y0 == null) {
                ...
                this.Y0 = frameLayout;
                frameLayout.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ActionBar.r1
            ...
            if (this.Z0 == null) {
                ...
                this.Z0 = aVar;
                w7.a6.a(aVar);
                this.Z0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ActionBar.r1
                    public final /* synthetic */ a2 b;
            ...
            this.Y0.addView(this.a1, w7.y5.e(-2, -2, 17));
        ...
        if (this.U == 0 && this.X == 0 && this.b0 == null) {
            ...
            if (drawable2 != null) {
                ...
                if (drawable3 instanceof x6) {
                    ...
                    this.k0.addOnAttachStateChangeListener(new s1(x6Var));
                    x6Var.a(this.k0);
                }
            } else {
                int i14 = this.U;
            ...
            if (this.W) {
                ...
                this.k0.setBackground(new t1(this, gradientDrawable));
                this.a0 = 92;
            } else {
                this.k0.setBackground(h6.c0(AndroidUtilities.dp(10.0f), 0, this.c0));
            }
            if (this.W) {
            ...
            this.a1.addView(this.k0, w7.y5.t(-1, this.a0, 51, 0, 0, 0, 0));
        }
        if (this.R != null) {
            FrameLayout frameLayout2 = new FrameLayout(getContext());
            this.s = frameLayout2;
            this.a1.addView(frameLayout2, w7.y5.t(-2, -2, this.W ? 1 : 0, 24, 0, 24, 0));
            ...
            vh.n nVar3 = this.f;
            boolean z15 = this.W;
            frameLayout3.addView(nVar3, w7.y5.d(-2, -2.0f, (z15 ? 1 : LocaleController.isRTL ? 5 : 3) | 48, 0.0f, 19.0f, 0.0f, z15 ? 4.0f : this.S != null ? 2 : this.P != null ? 14 : 10));
        }
        if (this.S != null) {
            ...
            this.a1.addView(this.h, w7.y5.t(-2, -2, (LocaleController.isRTL ? 5 : 3) | 48, 24, 0, 24, this.P != null ? 14 : 10));
        }
        if (i11 == 0) {
        ...
        this.n.setLinkTextColor(e(h6.k5));
        if (!this.f0) {
        ...
        if (i11 == 2) {
            ...
            this.v0.setTextColor(e(h6.q5));
            this.v0.setTextSize(1, 14.0f);
            this.a1.addView(this.v0, w7.y5.t(-2, -2, (LocaleController.isRTL ? 5 : 3) | 48, 23, 4, 23, 24));
            ...
            this.U0 = e(h6.M5);
            if (!this.T0) {
                this.r.setBackgroundDrawable(h6.b0(AndroidUtilities.dp(18.0f), this.U0));
            }
            this.a1.addView(this.r, w7.y5.q(86, 86, 17));
        ...
        if (this.P != null) {
            ...
            while (true) {
                ...
                if (charSequenceArr[i18] != null) {
                    ...
                    int[] iArr = this.Q;
                    w1Var.a(iArr != null ? iArr[i18] : 0, charSequence);
                    w1Var.setTag(Integer.valueOf(i18));
                    this.N0.add(w1Var);
                    this.w.addView(w1Var, w7.y5.n(-1, 50));
                    final int i19 = 2;
                    w1Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ActionBar.r1
                        public final /* synthetic */ a2 b;
        ...
        if (view2 != null) {
            ...
            this.w.addView(this.b, w7.y5.n(-1, this.e));
        }
        if (z14) {
            if (!this.I0) {
            ...
            if (this.I0) {
                ...
                this.t0 = new s2(this, getContext(), i10);
            }
            if (this.c != null) {
            ...
            this.a1.addView(this.t0, w7.y5.n(-1, this.K0 ? 96 : 52));
            if (this.W) {
                this.t0.setTranslationY(-AndroidUtilities.dp(8.0f));
            }
            if (this.l0 != null) {
                v1 v1Var = new v1(getContext(), i13);
                ...
                if (this.I0) {
                    f12 = 6.0f;
                    this.t0.addView(v1Var, w7.y5.q(-1, 40, 7));
                } else {
                    f12 = 6.0f;
                    this.t0.addView(v1Var, w7.y5.e(-2, 40, 53));
                }
            ...
            if (this.n0 != null) {
                v1 v1Var2 = new v1(getContext(), i10);
                ...
                v1Var2.setText(this.n0.toString());
                ...
                if (this.I0) {
                    this.t0.addView(v1Var2, 0, w7.y5.q(-1, 40, 7));
                } else {
                    this.t0.addView(v1Var2, w7.y5.e(-2, 40, 53));
                }
                v1Var2.setOnClickListener(new ai.f2(i17, this, v1Var2));
            }
            if (this.r0 != null) {
                ...
                v1Var3.setText(this.r0.toString());
                ...
                if (this.I0) {
                    this.t0.addView(v1Var3, 1, w7.y5.q(-1, 40, 7));
                } else {
                    this.t0.addView(v1Var3, w7.y5.e(-2, 40, 51));
                }
                v1Var3.setOnClickListener(new ai.f2(20, this, v1Var3));
            }
            if (this.p0 != null) {
                v1 v1Var4 = new v1(getContext(), i12);
                ...
                v1Var4.setText(this.p0.toString());
                ...
                if (this.I0) {
                    this.t0.addView(v1Var4, 0, w7.y5.q(-1, 40, 7));
                } else {
                    this.t0.addView(v1Var4, w7.y5.e(-2, 40, 53));
                }
        ...
        if (this.T0) {
            AndroidUtilities.makeGlobalBlurBitmap(new w0(this, i10), 8.0f);
        }
    ...
    public final void l(int i10, int i11, int i12) {
        if (i10 >= 0) {
            ...
            w1Var.a.setTextColor(i11);
            w1Var.b.setColorFilter(new PorterDuffColorFilter(i12, PorterDuff.Mode.MULTIPLY));
        }
    }
