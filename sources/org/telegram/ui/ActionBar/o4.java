...
public final class o4 extends Animation {
    ...
    public /* synthetic */ o4(w4 w4Var, int i10, int i11, float f7, float f10, int i12) {
        this.a = i12;
        this.e = w4Var;
        this.b = i10;
        this.c = i11;
    ...
    public final void applyTransformation(float f7, Transformation transformation) {
        switch (this.a) {
            ...
            case 1:
                ...
                w4.l(relativeLayout2, ((int) (f7 * (i13 - i14))) + i14, relativeLayout2.getLayoutParams().height);
            ...
            default:
                ...
                w4.l(relativeLayout4, ((int) (f7 * (i18 - i19))) + i19, relativeLayout4.getLayoutParams().height);
    ...
    public /* synthetic */ o4(w4 w4Var, int i10, int i11, float f7, int i12) {
        this.a = i12;
        this.e = w4Var;
        this.b = i10;
        this.c = i11;
