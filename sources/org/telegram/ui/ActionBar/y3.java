...
public final class y3 extends View {
    ...
    public static void g(ViewGroup viewGroup, float f7, final ci.m2 m2Var) {
        ...
        PixelCopy.request(surface, createBitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: org.telegram.ui.ActionBar.s3
    ...
    public final void b(v3 v3Var) {
        ...
        for (int i10 = 0; i10 < tabDrawables.size(); i10++) {
            ...
            int indexOf = tabs.indexOf(m3Var2.a);
            m3Var2.c = indexOf;
            if (indexOf >= 0) {
                m3Var2.b = indexOf;
            }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int[] iArr = y3Var.a0;
        int[] iArr2 = y3Var.b0;
        RectF rectF3 = y3Var.c0;
        if (v3Var != null) {
            y3Var.getLocationOnScreen(iArr2);
            y3Var.a.getLocationOnScreen(iArr);
            y3Var.a.d(rectF3, 0.0f);
            rectF3.offset(iArr[0] - iArr2[0], iArr[1] - iArr2[1]);
            canvas.save();
            canvas.clipRect(0, 0, y3Var.getMeasuredWidth(), y3Var.getMeasuredHeight() - y3Var.s);
            w3 windowView = y3Var.b.getWindowView();
            float f15 = y3Var.e;
            RectF rectF4 = y3Var.e0;
            ...
            if (y3Var.c != null) {
                ...
                y3Var.a.setupTab(y3Var.c);
                y3Var.c.a(canvas, rectF3, x10, y3Var.e, 1.0f);
                rectF = rectF3;
                canvas.restore();
            } else {
                rectF = rectF3;
        ...
        if (view != null) {
            ...
            y3Var.getLocationOnScreen(iArr2);
            rectF5.set(iArr[0] - iArr2[0], iArr[1] - iArr2[1], y3Var.S.getWidth() + r1, y3Var.S.getHeight() + (iArr[1] - iArr2[1]));
        } else {
            iArr[1] = 0;
            iArr[0] = 0;
        ...
        while (true) {
            ...
            f19 += ((x3) arrayList.get(i13)).d.c >= 0 ? 1.0f : 0.0f;
            i13++;
        }
        float d = y3Var.f.d(f19, false);
        float lerp = AndroidUtilities.lerp(0.0f, 1.0f - Utilities.clamp(y3Var.getScrollWindow() <= 0.0f ? 0.0f : ((y3Var.getScrollMin() - y3Var.getScrollOffset()) / (y3Var.getScrollWindow() * 0.15f)) * 0.2f, 1.0f, 0.0f), y3Var.V);
        int i14 = 0;
        while (i14 < arrayList.size() + 1) {
            if (i14 == arrayList.size()) {
                ...
                float[] fArr = x3Var.g;
                float f20 = dp;
                Matrix matrix = x3Var.f;
                float[] fArr2 = x3Var.h;
                float f21 = m3Var2 == null ? 1.0f : lerp;
                ...
                float f24 = min / 2.0f;
                i11 = min;
                RectF rectF6 = y3Var.d0;
                rectF6.set(f18 - f24, f23, f18 + f24, f22 + f23);
                boolean z10 = (rectF6.top > f17 || rectF6.bottom < 0.0f || lerp < 0.1f) && c10 < d - 3.0f;
                y3Var.a.d(rectF, Utilities.clamp(m3Var2.c(), 1.0f, 0.0f));
                rectF.offset(y3Var.a.getX(), y3Var.a.getY());
                ...
                if (rectF6.top > f17 || rectF6.bottom < 0.0f) {
                    ...
                    matrix.setPolyToPoly(x3Var.g, 0, x3Var.h, 0, 4);
                    ...
                    RadialGradient radialGradient = x3Var.p;
                    Paint paint = x3Var.o;
                    Paint paint2 = x3Var.r;
                    f10 = lerp;
                    Matrix matrix2 = x3Var.q;
                    o3 o3Var = x3Var.c;
                    f12 = d;
                    Path path2 = x3Var.n;
                    arrayList2 = arrayList;
                    ...
                    rectF2 = rectF;
                    RectF rectF7 = x3Var.m;
                    i12 = height2;
                    Paint paint4 = x3Var.l;
                    f13 = f17;
                    f11 = f16;
                    float clamp = Utilities.clamp(1.0f - ((Math.abs(x3Var.i) - 0.3f) / 0.7f), 1.0f, 0.0f) * lerp2;
                    if (clamp > 0.0f) {
                        float f28 = f27 * 1.0f;
                        ...
                        canvas.save();
                        canvas.rotate(x3Var.i * 20.0f, (x3Var.i * AndroidUtilities.dp(50.0f)) + rectF6.centerX(), rectF6.bottom + AndroidUtilities.dp(350.0f));
                        float a2 = x3Var.k.a(0.01f);
                        ...
                        if (z10) {
                            ...
                            if (o3Var != null && o3Var.m != null) {
                                float width3 = rectF6.width() / o3Var.m.getWidth();
                                canvas.scale(width3, width3);
                                paint.setAlpha(i15);
                                canvas.drawBitmap(o3Var.m, 0.0f, 0.0f, paint);
                            }
                            canvas.restore();
                            canvas.save();
        ...
        canvas.restore();
        if (this.g0 == null) {
            this.g0 = new h01(LocaleController.getString(R.string.BotCloseAllTabs), 14.0f, AndroidUtilities.bold());
        }
    ...
    /* JADX WARN: Type inference failed for: r8v3, types: [android.view.VelocityTracker, org.telegram.ui.ActionBar.x3] */
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.V >= 1.0f) {
                ...
                for (int size = arrayList.size() - 1; size >= 0; size--) {
                    x3Var = (x3) arrayList.get(size);
                    if (Math.abs(x3Var.i) < 0.4f && x3Var.a.contains(x10, y3)) {
                        break;
                    }
                }
            }
            ...
            x3 x3Var2 = this.w;
            if (x3Var2 != null) {
                ValueAnimator valueAnimator = x3Var2.j;
                if (valueAnimator != null) {
                    valueAnimator.cancel();
                }
        ...
        if (motionEvent.getAction() == 2) {
            ...
            if (x3Var3 != null) {
                ...
                if (!x3Var4.k.h) {
                    if (this.H) {
                        x3Var4.i = (motionEvent.getX() - this.E) / AndroidUtilities.dp(300.0f);
                    } else if (this.G) {
        ...
        x3 x3Var6 = this.w;
        if (x3Var6 != null) {
            if (this.a == null || Math.abs(x3Var6.i) <= 0.4f) {
                this.w.a(0.0f);
                if (this.a != null && this.w.k.h) {
                    ...
                    if (this.L < getScrollMin() - (getScrollWindow() * 0.15f)) {
                        ...
                        if (this.x) {
                            final x3 x3Var8 = this.w;
                            final int i10 = 1;
                            this.a.g(x3Var8.c, new Utilities.Callback(this) { // from class: org.telegram.ui.ActionBar.r3
                                    ...
                                    switch (i10) {
                                        case 0:
                                            ...
                                            if (!booleanValue) {
                                                ...
                                                x3Var9.a(x3Var9.i < 0.0f ? -1.0f : 1.0f);
                                                y3Var.h(Utilities.clamp(y3Var.L, y3Var.c(false), y3Var.d(false)));
                                        ...
                                        default:
                                            ...
                                            if (!booleanValue2) {
                                                ...
                                                x3Var10.a(1.0f);
                                                y3Var2.h(Utilities.clamp(y3Var2.L, y3Var2.c(false), y3Var2.d(false)));
                                                if (y3Var2.a.getTabs().isEmpty()) {
                                                    y3Var2.a(false);
                                                    break;
                                                }
                                            }
                ...
                final x3 x3Var9 = this.w;
                final int i11 = 0;
                this.a.g(x3Var9.c, new Utilities.Callback(this) { // from class: org.telegram.ui.ActionBar.r3
                    public final /* synthetic */ y3 b;
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                if (!booleanValue) {
                                    ...
                                    x3Var92.a(x3Var92.i < 0.0f ? -1.0f : 1.0f);
                                    y3Var.h(Utilities.clamp(y3Var.L, y3Var.c(false), y3Var.d(false)));
                                    if (y3Var.a.getTabs().isEmpty()) {
                                        y3Var.a(false);
                                        break;
    ...
    public final float e(boolean z10) {
        ...
        while (true) {
            ...
            f7 += ((x3) arrayList.get(i10)).d.c >= 0 ? 1.0f : 0.0f;
            i10++;
        }
    ...
    public final void f() {
        ...
        ArrayList arrayList = this.R;
        arrayList.clear();
        ArrayList<o3> tabs = this.a.getTabs();
        ArrayList<m3> tabDrawables = this.a.getTabDrawables();
