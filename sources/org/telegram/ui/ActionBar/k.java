...
public class k extends FrameLayout implements ud.b, x5 {
    ...
    public k(Context context, c6 c6Var) {
        ...
        this.a1 = new ud.a(0, this, erVar, 320L, false);
        this.m1 = true;
        this.n1 = 1.0f;
        this.E0 = c6Var;
    ...
    public final void K(String str, int i10, Runnable runnable) {
        ...
        if (str2 == null || !str2.equals(str)) {
            this.b0 = str;
            if (this.h1 != null) {
                this.h1.a(i10 == R.string.ConnectingToProxyWithDots ? AndroidUtilities.replaceArrows(LocaleController.getString(R.string.TitleSetupProxy), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(2.0f)) : null);
            }
    ...
    public final void b() {
        if (this.i1) {
            ...
            setBackgroundColor(i0.b.d(f10, v02, v03));
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (dVar == null || this.L0) {
            ...
            rn rnVar = this.N0;
            ud.a aVar2 = this.Y0;
            int lerp = AndroidUtilities.lerp(i14, max, rnVar == null ? 0.0f : f10 - aVar2.e);
            int lerp2 = AndroidUtilities.lerp(z10 ? i15 : 0, i15, this.N0 == null ? 0.0f : f10 - aVar2.e);
        ...
        if (this.G0 && this.x != 0) {
            ...
            if (this.i1) {
                ...
                zu0Var.getClass();
                zu0Var.K(canvas, y10, this.I0, paint, true, AndroidUtilities.lerp(255, Color.alpha(g6.v0((zu0.F() && SharedConfig.getDevicePerformanceClass() == 2) ? g6.xf : g6.yf, zu0Var.getResourceProvider())), f11));
            } else {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (this.N0 != null && this.K0 && motionEvent.getAction() == 0) {
            ...
            float f10 = x8;
            float f11 = y10;
            View r10 = r(this, f10, f11, this.N0);
            if (r10 == null) {
                r10 = r(this, f10, f11, null);
            }
            lg.d dVar = this.a;
            boolean z10 = dVar != null && dVar.getBounds().contains(x8, y10);
            if (r10 != null && r10 != this.N0) {
                lg.d dVar2 = this.b;
    ...
    */
                    ...
                    if (d00Var != null) {
                        ...
                        if (canvas != null) {
                            ...
                            for (int i10 = 0; i10 < size; i10++) {
                                c00 c00Var2 = (c00) arrayList2.get(i10);
                                Paint paint = c00Var2.k.a;
                                paint.setColor(c00Var2.j);
                                paint.setStrokeWidth(AndroidUtilities.dp(1.5f) * c00Var2.i);
                                paint.setAlpha((int) (c00Var2.f * f10));
                                canvas.drawPoint(c00Var2.a, c00Var2.b, paint);
                            }
                            if (Utilities.random.nextBoolean()) {
                                if (arrayList2.size() + 8 < 150) {
                                    ...
                                    float nextFloat2 = (Utilities.random.nextFloat() * org.telegram.messenger.y1.B(20.0f, getMeasuredHeight(), i11)) + i11;
                                    ...
                                    for (int i14 = 8; i13 < i14; i14 = 8) {
                                        ...
                                        c00Var.f = 1.0f;
                                        c00Var.h = 0.0f;
                                        c00Var.i = Math.max(1.0f, Utilities.random.nextFloat() * 1.5f);
                                        c00Var.g = Utilities.random.nextInt(MediaDataController.MAX_STYLE_RUNS_COUNT) + MediaDataController.MAX_STYLE_RUNS_COUNT;
                                        c00Var.e = (Utilities.random.nextFloat() * 4.0f) + 20.0f;
                            ...
                            long min = Math.min(17L, currentTimeMillis - d00Var.b);
                            ...
                            while (i15 < size2) {
                                ...
                                if (f12 >= f13) {
                                    ...
                                    c00Var3.f = 1.0f - AndroidUtilities.decelerateInterpolator.getInterpolation(f12 / f13);
                                    float f14 = c00Var3.a;
                                    float f15 = c00Var3.c;
                                    float f16 = c00Var3.e;
                                    float f17 = min;
                                    z11 = N;
                                    c00Var3.a = a9.p.d(f15 * f16, f17, 500.0f, f14);
                                    float f18 = c00Var3.b;
                                    float f19 = c00Var3.d;
                                    c00Var3.b = (((f16 * f19) * f17) / 500.0f) + f18;
    ...
    public final void l() {
        ...
        addView(this.s, 0, h7.z5.e(-2, -2, 51));
    }
    ...
    public final void m() {
        ...
        addView(this.e, h7.z5.e(54, 54, 51));
    ...
    */
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (zVar != null && zVar.getVisibility() != 8) {
            ...
            z zVar2 = this.A;
            zVar2.layout(dp2, i19, zVar2.getMeasuredWidth() + dp2, this.A.getMeasuredHeight() + i19);
        }
        int i21 = 0;
        while (true) {
            h5VarArr = this.n;
        ...
        n9 n9Var = this.f;
        if (n9Var != null) {
            n9Var.layout(AndroidUtilities.dp(64.0f), ((getCurrentActionBarHeight() - this.f.getMeasuredHeight()) / 2) + i19, this.f.getMeasuredWidth() + AndroidUtilities.dp(64.0f), ((this.f.getMeasuredHeight() + getCurrentActionBarHeight()) / 2) + i19);
        }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (zVar != null && zVar.getVisibility() != 8) {
            ...
            if (kVar.A.p() && !kVar.j0) {
                ...
                makeMeasureSpec = rl.d(f10, size, TLObject.FLAG_30);
                if (!kVar.y) {
                    kVar.A.r(0.0f);
                }
            } else {
        ...
        while (true) {
            ...
            if ((h5Var3 != null && h5Var3.getVisibility() != 8) || ((h5Var = kVar.r) != null && h5Var.getVisibility() != 8)) {
                z zVar2 = kVar.A;
                int max = Math.max(org.telegram.messenger.y1.B(16.0f, size - (zVar2 != null ? zVar2.getMeasuredWidth() : 0), dp) - kVar.T, 0);
                boolean z10 = kVar.u0;
                int i14 = 20;
                if (((z10 && i13 == 0) || (!z10 && i13 == i12)) && kVar.s0 && kVar.t0) {
        ...
        n9 n9Var = kVar.f;
        if (n9Var != null) {
            n9Var.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(42.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(42.0f), TLObject.FLAG_30));
        }
    ...
    public final void p() {
        ...
        addView(this.r, 0, h7.z5.e(-2, -2, 51));
    }
    ...
    public void setAdaptiveBackground(RecyclerView recyclerView) {
        z(recyclerView, false, g6.a7, g6.s8);
    }
    ...
    public void w(boolean z10) {
        ...
        if (n9Var != null) {
            ...
            this.R0.playTogether(ObjectAnimator.ofFloat(this.f, (Property<n9, Float>) property, z10 ? 1.0f : 0.0f));
        }
        this.v0 = true;
        requestLayout();
        this.R0.addListener(new f(this, arrayList, z10, v));
    ...
    public void setAdaptiveBackground(kn0 kn0Var) {
        ...
        this.i1 = true;
        boolean canScrollVertically = kn0Var.canScrollVertically(-1);
        this.m1 = !canScrollVertically;
        this.n1 = !canScrollVertically ? 1.0f : 0.0f;
        b();
    }
