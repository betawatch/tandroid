...
public final class u2 extends FrameLayout {
    ...
    public /* synthetic */ u2(Dialog dialog, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = dialog;
    }
        ...
        switch (this.a) {
            case 1:
                ...
                if (!((d2) this.b).H0) {
                    ...
                    while (i18 < childCount) {
                        ...
                        if (num == null) {
                            ...
                            if (LocaleController.isRTL) {
                                ...
                                if (view != null) {
                                    paddingLeft = org.telegram.messenger.y3.C(8.0f, view.getMeasuredWidth(), paddingLeft);
                                }
                                ...
                                if (view != null) {
                                    paddingRight = org.telegram.ui.b.t(8.0f, view.getMeasuredWidth(), paddingRight);
                                }
                    ...
                    int i20 = z10 ? paddingRight2 - max : paddingLeft3;
                    if (!z10) {
