                    ...
                    while (i18 < childCount) {
                        ...
                        if (num == null) {
                            ...
                            if (LocaleController.isRTL) {
                                ...
                                if (view != null) {
                                    paddingLeft = org.telegram.messenger.w1.C(8.0f, view.getMeasuredWidth(), paddingLeft);
                                }
                                ...
                                if (view != null) {
                                    paddingRight = wl.v(8.0f, view.getMeasuredWidth(), paddingRight);
                                }
    ...
    public void setTranslationY(float f7) {
        switch (this.a) {
            case 0:
                ...
                g3Var.onContainerTranslationYChanged(f7);
                break;
            default:
                super.setTranslationY(f7);
                break;
