...
public final class t4 {
    ...
    public t4(v4 v4Var, Context context, View view) {
        ...
        int i12 = 4;
        if (aVar != null) {
            lg.d c10 = aVar.c(relativeLayout2, null, true);
            ...
            if (i11 == 0) {
                gradientDrawable.setColor(g6.v0(g6.h5, c6Var));
            } else if (i11 == 2) {
                gradientDrawable.setColor(-115203550);
            } else if (i11 == 1) {
                gradientDrawable.setColor(g6.v0(g6.d6, c6Var));
            }
        ...
        lh.m5 m5Var = new lh.m5(relativeLayout2.getContext(), 2);
        PopupWindow popupWindow = new PopupWindow(m5Var);
        popupWindow.setClippingEnabled(false);
        popupWindow.setAnimationStyle(0);
        popupWindow.setBackgroundDrawable(new ColorDrawable(0));
        popupWindow.setSplitTouchEnabled(true);
        relativeLayout2.setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
        m5Var.addView(relativeLayout2);
        this.c = popupWindow;
        ...
        if (i11 == 0) {
            ...
            if (i11 == 2) {
                ...
                view2.setBackgroundColor(g6.v0(g6.d7, c6Var));
            }
        }
        mutate2.setTint(v02);
        mutate.setTint(v02);
        ...
        this.g = new ra1(this, context, 6);
        this.q = new com.google.firebase.messaging.o(this, context, i10);
        ...
        this.x = v4.a(relativeLayout3, 0, new q4(this, i16));
    }
    ...
    public final void g() {
        ...
        if (z10) {
            ...
            this.N = false;
            n();
            ra1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.u).setDuration(100L).start();
    ...
    public final void k() {
        ...
        if (z10) {
            ...
            if (this.M) {
                ...
                ra1Var.setY(r2.getHeight() - relativeLayout.getHeight());
