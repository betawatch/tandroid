...
public final class x extends FrameLayout {
    ...
    public final void a(Canvas canvas, boolean z10, int i10) {
        ...
        Paint l02 = j6.l0(i10);
        b4 b4Var = b4.c;
        if (paddingLeft <= 0 || this.w == b4Var) {
            canvas2 = canvas;
        } else {
            canvas2 = canvas;
            canvas2.drawRect(0.0f, 0.0f, paddingLeft + 1, getHeight(), l02);
        }
        if (paddingRight > 0 && this.w != b4Var) {
    ...
    */
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        a4 a4Var = actionBarLayout.x;
        boolean z10 = false;
        int color = a4Var != null ? a4Var.getInternalNavbarPaint().getColor() : j6.w0(null, j6.a7, false);
        if (this == actionBarLayout.w) {
            ...
            if (lastFragment != null && !lastFragment.inPreviewMode) {
                if (this == actionBarLayout.s && this.w != b4.a) {
                    int childCount = getChildCount();
                    int i10 = 0;
                    while (true) {
                        if (i10 >= childCount) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        ActionBarLayout actionBarLayout = this.E;
        o2 o2Var = !actionBarLayout.O0.isEmpty() ? (o2) p6.g(1, actionBarLayout.O0) : null;
        t tVar = actionBarLayout.G;
