...
public final class i6 {
    ...
    public static void g(SparseIntArray sparseIntArray) {
        ...
        for (int i12 = k6.Ub; i12 < k6.cc; i12++) {
    ...
    public final boolean c(SparseIntArray sparseIntArray, SparseIntArray sparseIntArray2) {
        ...
        if (this.c != this.b.U || this.d != 0) {
            ...
            while (true) {
                ...
                if (!k6.pl.contains(Integer.valueOf(i16))) {
                    int indexOfKey = sparseIntArray.indexOfKey(i16);
                    if (indexOfKey < 0) {
                        int i17 = k6.ol.get(i16, -1);
                    ...
                    int D = k6.D(M0, M02, valueAt, q10, valueAt);
                    if (D != valueAt) {
        ...
        if ((i18 == 0 && this.c == 0) || this.f == 0) {
            ...
            int colorDistance = AndroidUtilities.getColorDistance(i18, k6.D(M0, M02, i20, q10, i20));
            c3 = 1;
        ...
        if (z10 || this.d != 0) {
            ...
            for (int i23 = k6.Ha; i23 < k6.Tb; i23++) {
                int indexOfKey2 = sparseIntArray.indexOfKey(i23);
                if (indexOfKey2 < 0) {
                    int i24 = k6.ol.get(i23, -1);
                ...
                int D2 = k6.D(M0, M02, valueAt3, q10, valueAt3);
                if (D2 != valueAt3) {
            ...
            for (int i25 : k6.Hk) {
                ...
                int valueAt4 = indexOfKey3 < 0 ? k6.nl[i25] : sparseIntArray.valueAt(indexOfKey3);
                int D3 = k6.D(M0, M02, valueAt4, q10, valueAt4);
                if (D3 != valueAt4) {
            ...
            if (z10) {
                Color.colorToHSV(i18, M02);
                for (int i26 = k6.za; i26 < k6.Ga; i26++) {
                    int indexOfKey4 = sparseIntArray.indexOfKey(i26);
                    if (indexOfKey4 < 0) {
                        int i27 = k6.ol.get(i26, -1);
                    ...
                    int D4 = k6.D(M0, M02, valueAt2, q10, valueAt2);
                    if (D4 != valueAt2) {
        ...
        if (!z4 && (i10 = this.f) != 0) {
            ...
            if (this.d == 0) {
                sparseIntArray2.put(k6.qb, i12);
                sparseIntArray2.put(k6.rb, i12);
                sparseIntArray2.put(k6.wb, i12);
                sparseIntArray2.put(k6.xb, i12);
                sparseIntArray2.put(k6.yb, i12);
                sparseIntArray2.put(k6.zb, i13);
                sparseIntArray2.put(k6.Ab, i12);
                sparseIntArray2.put(k6.Bb, i12);
                sparseIntArray2.put(k6.Cb, i13);
                sparseIntArray2.put(k6.hc, i13);
                sparseIntArray2.put(k6.Ya, i13);
                sparseIntArray2.put(k6.Za, i13);
                sparseIntArray2.put(k6.ab, i13);
                sparseIntArray2.put(k6.bb, i13);
                sparseIntArray2.put(k6.cb, i13);
                sparseIntArray2.put(k6.gb, i13);
                sparseIntArray2.put(k6.hb, i13);
                sparseIntArray2.put(k6.Va, i13);
                sparseIntArray2.put(k6.Wa, i13);
                sparseIntArray2.put(k6.Xa, i13);
                sparseIntArray2.put(k6.Ra, i13);
                sparseIntArray2.put(k6.Sa, i13);
                sparseIntArray2.put(k6.tb, i13);
                sparseIntArray2.put(k6.Fb, i13);
                sparseIntArray2.put(k6.ib, i13);
                sparseIntArray2.put(k6.lb, i13);
                sparseIntArray2.put(k6.mb, i13);
                sparseIntArray2.put(k6.Ja, i13);
                sparseIntArray2.put(k6.Ka, i13);
                sparseIntArray2.put(k6.La, i13);
                sparseIntArray2.put(k6.Ma, i13);
                sparseIntArray2.put(k6.Na, i13);
                sparseIntArray2.put(k6.Oa, i13);
                sparseIntArray2.put(k6.Ta, i13);
                sparseIntArray2.put(k6.Ua, i13);
                sparseIntArray2.put(k6.sb, i13);
                sparseIntArray2.put(k6.nb, i13);
                sparseIntArray2.put(k6.ub, i11);
                sparseIntArray2.put(k6.vb, i11);
                sparseIntArray2.put(k6.jb, i11);
                sparseIntArray2.put(k6.kb, i11);
                sparseIntArray2.put(k6.Gb, i11);
                sparseIntArray2.put(k6.Hb, i11);
                sparseIntArray2.put(k6.Kb, i11);
                sparseIntArray2.put(k6.Lb, i11);
                sparseIntArray2.put(k6.Nb, i13);
                sparseIntArray2.put(k6.Ob, i13);
                sparseIntArray2.put(k6.Db, this.e);
                sparseIntArray2.put(k6.Eb, this.e);
                sparseIntArray2.put(k6.Pa, this.e);
                sparseIntArray2.put(k6.Qa, this.e);
            }
            sparseIntArray2.put(k6.db, i13);
            sparseIntArray2.put(k6.eb, i13);
            sparseIntArray2.put(k6.fb, i13);
            sparseIntArray2.put(k6.fc, i13);
        }
        if (z4) {
            int i29 = k6.Nb;
        ...
        int i30 = this.e;
        if (i30 != 0 && this.f != 0) {
            sparseIntArray2.put(k6.Aa, i30);
            sparseIntArray2.put(k6.Da, this.f);
            int i31 = this.g;
            if (i31 != 0) {
                sparseIntArray2.put(k6.Ea, i31);
                int i32 = this.h;
                if (i32 != 0) {
                    sparseIntArray2.put(k6.Fa, i32);
                }
            }
            sparseIntArray2.put(k6.ac, this.i ? 1 : 0);
        }
        long j10 = this.j;
        int i33 = (int) j10;
        if (i33 != 0) {
            sparseIntArray2.put(k6.Nd, i33);
        } else if (j10 != 0) {
            sparseIntArray2.delete(k6.Nd);
        }
        long j11 = this.k;
        int i34 = (int) j11;
        if (i34 != 0) {
            sparseIntArray2.put(k6.Od, i34);
        } else if (j11 != 0) {
            sparseIntArray2.delete(k6.Od);
        }
        long j12 = this.l;
        int i35 = (int) j12;
        if (i35 != 0) {
            sparseIntArray2.put(k6.Pd, i35);
        } else if (j12 != 0) {
            sparseIntArray2.delete(k6.Pd);
        }
        long j13 = this.m;
        int i36 = (int) j13;
        if (i36 != 0) {
            sparseIntArray2.put(k6.Qd, i36);
        } else if (j13 != 0) {
            sparseIntArray2.delete(k6.Qd);
        }
        int i37 = this.n;
        if (i37 != 45) {
            sparseIntArray2.put(k6.Rd, i37);
        }
        int i38 = k6.Aa;
        int i39 = sparseIntArray2.get(i38);
        if (i39 == 0) {
            i39 = k6.w0(null, i38, false);
        }
        int i40 = k6.ra;
        int i41 = sparseIntArray2.get(i40);
        if (i41 == 0) {
            i41 = k6.w0(null, i40, false);
        }
        TLRPC.TL_theme tL_theme = this.r;
        if (tL_theme != null && tL_theme.emoticon != null && !q10) {
            sparseIntArray2.delete(k6.Hc);
            int a11 = a(sparseIntArray2, k6.Od, k6.Pd, k6.Qd);
            if (a11 == 0) {
                a11 = a(sparseIntArray2, k6.Nd);
            }
            if (a11 == 0) {
                a11 = this.c;
            }
            int b10 = b(i39, a11);
            sparseIntArray2.put(k6.Yb, b10);
            sparseIntArray2.put(k6.bc, b10);
            sparseIntArray2.put(k6.Ba, k6.v(i39, b10));
            int b11 = b(i41, this.c);
            sparseIntArray2.put(k6.sa, b11);
            sparseIntArray2.put(k6.dc, k6.v(i41, b11));
        }
        float[] fArr = this.A;
        if (!q10) {
            sparseIntArray2.put(k6.uf, h(i41, this.c));
            sparseIntArray2.put(k6.Vb, h(i39, this.c));
            int i42 = k6.Wb;
            ...
            if (f13 > 0.0f) {
                ...
                sparseIntArray2.put(i42, k6.v(i39, Color.HSVToColor(255, fArr)));
            }
            fArr[0] = f12;
            fArr[c3] = Math.max(0.0f, Math.min(1.0f, f13 + 0.6f));
            float f152 = fArr[c10];
        ...
        Color.colorToHSV(k6.w0(null, k6.n6, false), fArr);
        float f16 = fArr[0];
        sparseIntArray2.put(k6.Xb, f(i39, f16, q10));
        sparseIntArray2.put(k6.wf, f(i41, f16, q10));
        int i43 = k6.gc;
        int i44 = sparseIntArray2.get(i43);
        if (i44 == 0) {
            i44 = k6.w0(null, i43, false);
        }
        int i45 = k6.hc;
        int i46 = sparseIntArray2.get(i45);
        if (i46 == 0) {
            i46 = k6.w0(null, i45, false);
        }
        sparseIntArray2.put(k6.Ld, e(i44, i41, q10));
        sparseIntArray2.put(k6.Mb, e(i46, i39, q10));
        int i47 = k6.G8;
        int i48 = sparseIntArray2.get(i47);
        if (i48 == 0) {
            i48 = k6.w0(null, i47, false);
        }
        sparseIntArray2.put(k6.H8, Color.argb(Color.alpha(i48), Math.max(0, Color.red(i48) - 10), Math.max(0, Color.green(i48) - 10), Math.max(0, Color.blue(i48) - 10)));
        int i49 = 64;
        if (q10) {
            int i50 = k6.Da;
            if (sparseIntArray2.get(i50) != 0) {
                Color.colorToHSV(a(sparseIntArray2, i50, k6.Ea, k6.Fa), fArr);
                fArr[c3] = Utilities.clamp(fArr[c3] + 0.1f, 1.0f, 0.0f);
                fArr[c10] = Utilities.clamp(fArr[c10] - 0.8f, 1.0f, 0.0f);
                sparseIntArray2.put(k6.qk, Color.HSVToColor(64, fArr));
                k6.g(sparseIntArray, sparseIntArray2, q10);
                k6.f(sparseIntArray, sparseIntArray2, q10);
                return !z4;
            }
        }
        int i51 = k6.qk;
