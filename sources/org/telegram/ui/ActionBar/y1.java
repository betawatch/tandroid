...
public final class y1 extends LinearLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        a2 a2Var = this.d;
        Drawable drawable = a2Var.z0;
        if (a2Var.i0 && !a2Var.T0) {
            drawable.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            View view = a2Var.V;
            if (view == null || !a2Var.j0) {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (a2Var.T0) {
            if (a2Var.d0 != 3 || a2Var.r == null) {
                ...
                float scaleX = a2Var.r.getScaleX() * a2Var.r.getWidth();
                float scaleY = a2Var.r.getScaleY() * a2Var.r.getHeight();
                AndroidUtilities.rectTmp.set((getWidth() - scaleX) / 2.0f, (getHeight() - scaleY) / 2.0f, (getWidth() + scaleX) / 2.0f, (getHeight() + scaleY) / 2.0f);
            }
            float d = this.b.d(a2Var.F0 != null ? 1.0f : 0.0f, false);
    ...
    /* JADX WARN: Type inference failed for: r7v2, types: [org.telegram.ui.ActionBar.x1] */
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int[] iArr = a2Var.x0;
        if (a2Var.d0 == 3) {
            int measuredWidth = ((i12 - i10) - a2Var.r.getMeasuredWidth()) / 2;
            int measuredHeight = ((i13 - i11) - a2Var.r.getMeasuredHeight()) / 2;
            FrameLayout frameLayout = a2Var.r;
            frameLayout.layout(measuredWidth, measuredHeight, frameLayout.getMeasuredWidth() + measuredWidth, a2Var.r.getMeasuredHeight() + measuredHeight);
        } else {
            u1 u1Var = a2Var.v;
            if (u1Var != null) {
                if (a2Var.x == null) {
                    a2Var.x = new ViewTreeObserver.OnScrollChangedListener() { // from class: org.telegram.ui.ActionBar.x1
                        @Override // android.view.ViewTreeObserver.OnScrollChangedListener
                        public final void onScrollChanged() {
                            a2 a2Var2 = y1.this.d;
                            boolean z11 = false;
                            a2.a(a2Var2, 0, a2Var2.f != null && a2Var2.v.getScrollY() > a2Var2.w.getTop());
                            if (a2Var2.t0 != null) {
                                if (a2Var2.v.getHeight() + a2Var2.v.getScrollY() < a2Var2.w.getBottom()) {
                                    z11 = true;
                                }
                            }
                            a2.a(a2Var2, 1, z11);
                    ...
                    u1Var.getViewTreeObserver().addOnScrollChangedListener(a2Var.x);
                }
                a2Var.x.onScrollChanged();
            }
        }
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        int i14 = a2Var.d0;
        if (i14 == 3) {
            a2Var.r.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(86.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(86.0f), TLObject.FLAG_30));
        ...
        ViewGroup viewGroup = a2Var.t0;
        if (viewGroup != null) {
            int childCount = viewGroup.getChildCount();
            for (int i16 = 0; i16 < childCount; i16++) {
                View childAt = a2Var.t0.getChildAt(i16);
                if (childAt instanceof TextView) {
                    ((TextView) childAt).setMaxWidth(AndroidUtilities.dp(ok.A(24.0f, paddingLeft, 2)));
                }
            }
            a2Var.t0.measure(makeMeasureSpec, i11);
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) a2Var.t0.getLayoutParams();
            i12 = paddingTop - ((a2Var.t0.getMeasuredHeight() + layoutParams.bottomMargin) + layoutParams.topMargin);
        } else {
            i12 = paddingTop;
        }
        vh.n nVar = a2Var.f;
        ...
        FrameLayout frameLayout = a2Var.s;
        if (frameLayout != null) {
            frameLayout.measure(c10, i11);
            LinearLayout.LayoutParams layoutParams2 = (LinearLayout.LayoutParams) a2Var.s.getLayoutParams();
            i12 -= (a2Var.s.getMeasuredHeight() + layoutParams2.bottomMargin) + layoutParams2.topMargin;
        }
        TextView textView = a2Var.h;
        if (textView != null) {
            textView.measure(c10, i11);
        ...
        if (view != null) {
            ...
            if (f10 >= 0.0f) {
                ...
                a2Var.V.getLayoutParams().height = i17;
            } else {
                view.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), i11);
            }
            i12 -= a2Var.V.getMeasuredHeight();
        }
        if (i14 == 0) {
            LinearLayout.LayoutParams layoutParams4 = (LinearLayout.LayoutParams) a2Var.v.getLayoutParams();
            if (a2Var.b != null) {
                layoutParams4.topMargin = (a2Var.f == null && a2Var.n.getVisibility() == 8 && a2Var.P == null) ? AndroidUtilities.dp(16.0f) : 0;
                layoutParams4.bottomMargin = a2Var.t0 == null ? AndroidUtilities.dp(8.0f) : 0;
            } else if (a2Var.P != null) {
                layoutParams4.topMargin = (a2Var.f == null && a2Var.n.getVisibility() == 8) ? AndroidUtilities.dp(8.0f) : 0;
                layoutParams4.bottomMargin = AndroidUtilities.dp(8.0f);
            } else if (a2Var.n.getVisibility() == 0) {
                layoutParams4.topMargin = a2Var.f == null ? AndroidUtilities.dp(19.0f) : 0;
                layoutParams4.bottomMargin = AndroidUtilities.dp(20.0f);
            }
            int i18 = i12 - (layoutParams4.bottomMargin + layoutParams4.topMargin);
            a2Var.v.measure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(i18, TLObject.FLAG_31));
            i12 = i18 - a2Var.v.getMeasuredHeight();
        } else {
            FrameLayout frameLayout2 = a2Var.r;
            if (frameLayout2 != null) {
                frameLayout2.measure(c10, View.MeasureSpec.makeMeasureSpec(i12, TLObject.FLAG_31));
                LinearLayout.LayoutParams layoutParams5 = (LinearLayout.LayoutParams) a2Var.r.getLayoutParams();
                ...
                if (x80Var != null) {
                    ...
                    LinearLayout.LayoutParams layoutParams8 = (LinearLayout.LayoutParams) a2Var.v0.getLayoutParams();
                    i12 = measuredHeight2 - ((a2Var.v0.getMeasuredHeight() + layoutParams8.bottomMargin) + layoutParams8.topMargin);
                }
            }
        ...
        this.a = false;
        if (a2Var.L != AndroidUtilities.displaySize.x) {
