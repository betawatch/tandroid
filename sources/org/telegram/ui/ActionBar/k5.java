...
public class k5 extends View implements Drawable.Callback {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.w == null || this.z0 || this.E <= 0.0f || this.i0 || this.j0) {
            ...
            if ((this.n & 112) == 16) {
                ...
                d17 = kh.a2.d(this.d0, intrinsicHeight, 2, getPaddingTop());
                i18 = this.H;
            }
            int i28 = d17 + i18;
            f10 = 0.0f;
        ...
        if (this.x != null && !this.z0 && this.E > f10 && !this.i0 && !this.j0) {
            ...
            if ((this.n & 112) == 16) {
                ...
                d16 = kh.a2.d(this.d0, intrinsicHeight2, 2, getPaddingTop());
                i17 = this.H;
            }
            int i31 = d16 + i17;
        ...
        if (f15 != f10) {
            ...
            if (this.w == null || this.i0) {
                ...
                if ((this.n & 112) == 16) {
                    ...
                    d15 = kh.a2.d(this.d0, intrinsicHeight3, 2, getPaddingTop());
                    i16 = this.H;
                }
                int i34 = d15 + i16;
                f11 = 16.0f;
            ...
            if (this.x != null && !this.i0) {
                ...
                if ((this.n & 112) == 16) {
                    ...
                    d14 = kh.a2.d(this.d0, intrinsicHeight4, 2, getPaddingTop());
                    i15 = this.H;
                }
                int i36 = d14 + i15;
        ...
        if (this.c != null) {
            ...
            if (this.w != null && !this.z0 && this.E > 0.0f && !this.i0 && this.j0) {
                ...
                if ((this.n & 112) == 16) {
                    ...
                    d13 = kh.a2.d(this.d0, intrinsicHeight5, 2, getPaddingTop());
                    i14 = this.H;
                }
                int i43 = d13 + i14;
            ...
            if (this.x != null && !this.z0 && this.E > 0.0f && !this.i0 && this.j0) {
                ...
                if ((this.n & 112) == 16) {
                    ...
                    d12 = kh.a2.d(this.d0, intrinsicHeight6, 2, getPaddingTop());
                    i13 = this.H;
                }
                int i46 = d12 + i13;
            ...
            if (!this.M || (!this.N && this.O == 0.0f)) {
                ...
                if (i47 > 0) {
                    ...
                    if (this.O < AndroidUtilities.dp(100.0f)) {
                        A = vh.v2.c(this.O, AndroidUtilities.dp(100.0f), 20.0f, 30.0f);
                        z4 = true;
                    } else {
                        z4 = true;
        ...
        if (drawable8 != null && this.h0) {
            ...
            if ((this.n & 112) == 16) {
                ...
                d11 = kh.a2.d(this.d0, intrinsicHeight7, 2, getPaddingTop());
                i12 = this.G;
            }
            int i48 = d11 + i12;
        ...
        if (this.w != null && this.i0) {
            ...
            if ((this.n & 112) == 16) {
                ...
                d10 = kh.a2.d(this.d0, intrinsicHeight8, 2, getPaddingTop());
                i11 = this.H;
            }
            int i50 = d10 + i11;
        ...
        if ((this.n & 112) == 16) {
            ...
            d = kh.a2.d(this.d0, intrinsicHeight9, 2, getPaddingTop());
            i10 = this.H;
        }
        int i52 = d + i10;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if ((this.n & 112) == 16) {
            this.a0 = kh.a2.d((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), this.d0, 2, getPaddingTop());
        } else {
            this.a0 = getPaddingTop();
        }
    }
