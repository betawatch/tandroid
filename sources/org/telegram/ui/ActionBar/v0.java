...
public class v0 extends FrameLayout implements xd.b {
    ...
    public final void a() {
        ...
        boolean z4 = this.r;
        f6 f6Var = this.n;
        int l1 = z4 ? j6.l1(0.075f, j6.v0(j6.G6, f6Var)) : j6.v0(j6.ci, f6Var);
        int i10 = j6.Oh;
        ...
        nq nqVar = this.b;
        if (nqVar != null) {
            j6.v1(nqVar, j6.v0(i10, f6Var), false);
    ...
    public void setData(tf.e0 e0Var) {
        ...
        this.e.setText(str);
        nq L = j6.L(AndroidUtilities.dp(32.0f), e0Var.a);
        this.b = L;
        int i10 = j6.Oh;
        f6 f6Var = this.n;
        ...
        nq nqVar = this.b;
        int i11 = j6.Sh;
        j6.v1(nqVar, j6.v0(i11, f6Var), true);
        int i12 = e0Var.d;
        p9 p9Var = this.c;
        if (i12 != 4) {
            if (i12 != 7) {
            ...
            nq L2 = j6.L(AndroidUtilities.dp(32.0f), R.drawable.chats_archive);
