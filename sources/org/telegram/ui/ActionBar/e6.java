    ...
    */
    public final boolean c(SparseIntArray sparseIntArray, SparseIntArray sparseIntArray2) {
        ...
        if (tL_theme != null && tL_theme.emoticon != null && !q6) {
            ...
            int a10 = a(sparseIntArray2, g6.Od, g6.Pd, g6.Qd);
            if (a10 == 0) {
                a10 = a(sparseIntArray2, g6.Nd);
            }
            if (a10 == 0) {
                a10 = this.c;
            }
        ...
        float f16 = fArr[0];
        sparseIntArray2.put(g6.Xb, f(i39, f16, q6));
        sparseIntArray2.put(g6.wf, f(i41, f16, q6));
        int i43 = g6.gc;
