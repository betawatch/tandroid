...
public class EmojiThemes {
    ...
    */
    public static /* synthetic */ void lambda$loadWallpaperImage$1(int i, Utilities.Callback callback, int i2, long j, ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
        ...
        WallpaperBitmapHolder wallpaperBitmapHolder2 = new WallpaperBitmapHolder(bitmap, i, list);
        if (callback != null) {
        }
        ChatThemeController.getInstance(i2).saveWallpaperBitmap(wallpaperBitmapHolder2, j);
    }
