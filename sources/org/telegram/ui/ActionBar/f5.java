...
public class f5 extends Drawable {
    ...
    public final void a() {
        ...
        if (this.a instanceof BitmapShader) {
            ...
            if (z10 && (bitmap = this.L) != null) {
                ...
                float min = 1.0f / Math.min(bitmap.getWidth() / dc0VarArr[c11].getBounds().width(), this.L.getHeight() / dc0VarArr[c11].getBounds().height());
                matrix.postScale(min, min);
            } else {
                if (!this.v) {
                    c10 = i10 == 2 ? (char) 1 : (char) 0;
                }
                Bitmap bitmap2 = dc0VarArr[c10].k;
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (z10 || this.O != 0) {
            ...
            int i13 = i11;
            path2 = path;
            f5Var.e(path2, bounds, b11, i13, b12, i10, max, true, true, paint != null);
        } else {
            f5Var = this;
            path2 = path;
        }
    ...
    public final Drawable f() {
        ...
        if (z14 != z13 || iArr4[c11][c10] != i12 || ((z13 && iArr3[c10] != g11) || iArr2[c11][c10] != g10)) {
            ...
            try {
                ...
                i10 = g10;
                try {
                    drawableArr2[c11][c10] = new NinePatchDrawable(createBitmap, e8.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i10).array(), new Rect(), null);
                    setBounds(rect);
    ...
    public int h(int i10) {
        ...
        f6 f6Var = this.p;
        return f6Var != null ? f6Var.h1(i10) : j6.rl.get(i10);
    }
    ...
    public final Drawable j() {
        ...
        if (i11 != b10) {
            ...
            try {
                ...
                drawableArr[c10] = new NinePatchDrawable(createBitmap, e8.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i10).array(), new Rect(), null);
                z11 = true;
            } catch (Throwable unused) {
            }
        }
                    ...
                    if (dc0Var != null) {
                        ...
                        if (!z13 && i19 != 0 && z12) {
                            if (i16 != this.b || this.M == null || this.e != g10 || this.f != i18 || this.g != i19 || this.h != i20 || this.i != z12) {
                                ...
                                if (dc0VarArr[c12] == null) {
                                    dc0 dc0Var2 = new dc0();
                                    dc0VarArr[c12] = dc0Var2;
                                    if (i22 != 2) {
                                        c11 = 1;
                                        dc0Var2.t = true;
                                    } else {
                            ...
                            if (i19 != 0 && z12) {
                                if (dc0VarArr[c12] == null) {
                                    dc0 dc0Var4 = new dc0();
                                    dc0VarArr[c12] = dc0Var4;
                                    if (i22 != 2) {
                                        dc0Var4.t = true;
                                    }
                                    dc0Var4.w(b(1.0f));
                                }
                                dc0VarArr[c12].n(g10, i18, i19, i20);
                                this.a = dc0VarArr[c12].v;
                            } else if (i19 == 0) {
                        ...
                        if (this.a instanceof BitmapShader) {
                            i21 = 0;
                            dc0VarArr[c12].setBounds(0, i17, i11, i16 - i13);
                        } else {
                            i21 = 0;
                        }
                        this.b = i16;
