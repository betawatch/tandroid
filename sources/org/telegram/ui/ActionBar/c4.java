...
public final class c4 {
    ...
    public static c4 c(int i10) {
        ...
        c4Var.f.add(b4Var2);
        b4 b4Var3 = new b4();
        b4Var3.a = h6.N0("Night");
        b4Var3.e = 0;
        c4Var.f.add(b4Var3);
        b4 b4Var4 = new b4();
        b4Var4.a = h6.N0("Dark Blue");
        b4Var4.e = 0;
        c4Var.f.add(b4Var4);
        return c4Var;
    }
    ...
    public final SparseIntArray h(int i10, int i11) {
        ...
        if (j3 == null) {
            ...
            TLRPC.TL_theme tL_theme = ((b4) arrayList.get(i11)).b;
            g6 N0 = aVar != null ? h6.N0(h6.q0(((b4) aVar).b(i12))) : h6.N0("Blue");
            if (N0 != null) {
                g6 g6Var2 = new g6(N0);
                if (aVar != null) {
                    b4 b4Var = (b4) aVar;
    ...
    public final void n(int i10) {
        ...
        while (true) {
            ...
            if (arrayList.get(i11) != null) {
                ...
                ((b4) arrayList.get(i11)).h = g(h10, h6.ra);
                ((b4) arrayList.get(i11)).i = g(h10, h6.Aa);
                ((b4) arrayList.get(i11)).j = g(h10, h6.Oh);
                ((b4) arrayList.get(i11)).k = h10.get(h6.Nd, 0);
                ((b4) arrayList.get(i11)).l = h10.get(h6.Od, 0);
                ((b4) arrayList.get(i11)).m = h10.get(h6.Pd, 0);
                ((b4) arrayList.get(i11)).n = h10.get(h6.Qd, 0);
                ((b4) arrayList.get(i11)).o = h10.get(h6.Rd, 0);
                if (((b4) arrayList.get(i11)).a != null && ((b4) arrayList.get(i11)).a.m().equals("Blue")) {
                    if ((((b4) arrayList.get(i11)).e >= 0 ? ((b4) arrayList.get(i11)).e : ((b4) arrayList.get(i11)).a.Y) == 99) {
                        ((b4) arrayList.get(i11)).k = -2368069;
                        ((b4) arrayList.get(i11)).l = -9722489;
                        ((b4) arrayList.get(i11)).m = -2762611;
                        ((b4) arrayList.get(i11)).n = -7817084;
                    }
                }
            }
            i11++;
    ...
    public c4(int i10, TLRPC.TL_chatThemeUniqueGift tL_chatThemeUniqueGift) {
        ...
        b4 b4Var = new b4();
        b4Var.c = tL_chatThemeUniqueGift;
        b4Var.d = 0;
        arrayList.add(b4Var);
        b4 b4Var2 = new b4();
        b4Var2.c = tL_chatThemeUniqueGift;
        b4Var2.d = 1;
        arrayList.add(b4Var2);
    }
}
