...
public abstract class d1 extends FrameLayout {
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (z10) {
            ...
            this.T.addListener(new a1(this, a2, i10));
        ...
        int i11 = j6.sj;
        f6 f6Var = c1Var.x;
        this.J.setColor(i0.a.d(w7.p.a((((a2 * 2.8f) + 0.2f) - 1.0f) / 1.0f, 0.0f, 1.0f), j6.v0(i11, f6Var), j6.v0(j6.tj, f6Var)));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.s), AndroidUtilities.dp(this.s), this.G);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.s), AndroidUtilities.dp(this.s), this.H);
            paint.setColor(-1);
        } else {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z11) {
            ...
            if (r02 instanceof ColorDrawable) {
                ...
                Pair pair = null;
                Bitmap bitmap = r02 instanceof cc0 ? ((cc0) r02).k : r02 instanceof BitmapDrawable ? ((BitmapDrawable) r02).getBitmap() : null;
                if (bitmap != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.w && this.f == null && !this.U && z10) {
            this.V.run();
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 2 || action == 1) {
            ...
            if (action == 1) {
                this.d0 = false;
                if (System.currentTimeMillis() - this.c0 < ViewConfiguration.getTapTimeout()) {
            ...
            float max = ((x10 - this.a0) / Math.max(1, (getWidth() - getPaddingLeft()) - getPaddingRight())) + this.b0;
            if (this.M != null) {
                int i11 = 0;
                while (true) {
                    float[] fArr2 = this.M;
