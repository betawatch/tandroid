...
public abstract class d1 extends FrameLayout {
    ...
    public d1(Context context, f6 f6Var) {
        ...
        this.a = 0.5f;
        nr nrVar = nr.h;
        this.e = new org.telegram.ui.Components.z5(1.0f, this, 0L, 320L, nrVar);
        this.r = new int[2];
        this.s = 0.0f;
