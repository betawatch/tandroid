...
public class j5 extends View implements Drawable.Callback {
            ...
            try {
                ...
                if (this.L) {
                    ...
                    if (this.n0 || ellipsize.equals(charSequence4)) {
                        ...
                        StaticLayout c10 = iw0.c(charSequence4, textPaint, i16, alignment, 0.0f, false, truncateAt, i16, this.x0, false);
                        i14 = i16;
                        this.e = c10;
                        if (c10 != null) {
                            ...
                            this.e = iw0.c(valueOf2, textPaint, i14 + AndroidUtilities.dp(8.0f) + this.t0, getAlignment(), 0.0f, false, truncateAt, i14 + this.t0, this.x0, false);
                        }
                    }
                    i13 = i14;
                } else if (this.r > 1) {
                    StaticLayout c11 = iw0.c(charSequence4, textPaint, i16, getAlignment(), 0.0f, false, TextUtils.TruncateAt.END, i16, this.r, false);
                    i13 = i16;
                    this.c = c11;
                } else {
                    i13 = i16;
                ...
                if (staticLayout2 != null && (staticLayout2.getText() instanceof Spannable)) {
                    wh.h.b(this, this.c, -2, -2, stack, arrayList);
                }
                a(i13);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.w == null || this.C0 || this.H <= 0.0f || this.l0 || this.m0) {
            ...
            if ((this.n & 112) == 16) {
                ...
                C9 = i2.g.C(this.g0, intrinsicHeight, 2, getPaddingTop());
                i18 = this.K;
            }
            int i28 = C9 + i18;
            f7 = 0.0f;
        ...
        if (this.x != null && !this.C0 && this.H > f7 && !this.l0 && !this.m0) {
            ...
            if ((this.n & 112) == 16) {
                ...
                C8 = i2.g.C(this.g0, intrinsicHeight2, 2, getPaddingTop());
                i17 = this.K;
            }
            int i31 = C8 + i17;
        ...
        if (f14 != f7) {
            ...
            if (this.w == null || this.l0) {
                ...
                if ((this.n & 112) == 16) {
                    ...
                    C7 = i2.g.C(this.g0, intrinsicHeight3, 2, getPaddingTop());
                    i16 = this.K;
                }
                int i34 = C7 + i16;
                f10 = 16.0f;
            ...
            if (this.x != null && !this.l0) {
                ...
                if ((this.n & 112) == 16) {
                    ...
                    C6 = i2.g.C(this.g0, intrinsicHeight4, 2, getPaddingTop());
                    i15 = this.K;
                }
                int i36 = C6 + i15;
        ...
        if (this.c != null) {
            ...
            if (this.w != null && !this.C0 && this.H > 0.0f && !this.l0 && this.m0) {
                ...
                if ((this.n & 112) == 16) {
                    ...
                    C5 = i2.g.C(this.g0, intrinsicHeight5, 2, getPaddingTop());
                    i14 = this.K;
                }
                int i43 = C5 + i14;
            ...
            if (this.x != null && !this.C0 && this.H > 0.0f && !this.l0 && this.m0) {
                ...
                if ((this.n & 112) == 16) {
                    ...
                    C4 = i2.g.C(this.g0, intrinsicHeight6, 2, getPaddingTop());
                    i13 = this.K;
                }
                int i46 = C4 + i13;
            ...
            if (z11) {
                if (this.R < AndroidUtilities.dp(10.0f)) {
                    ...
                    if (this.R > (AndroidUtilities.dp(f10) + this.f0) - AndroidUtilities.dp(10.0f)) {
                        this.U.setAlpha((int) vl.u(this.R - ((AndroidUtilities.dp(f10) + this.f0) - AndroidUtilities.dp(10.0f)), AndroidUtilities.dp(10.0f), 1.0f, 255.0f));
                    } else {
                        this.U.setAlpha(255);
                    }
                }
            ...
            if (!this.P || (!this.Q && this.R == 0.0f)) {
                ...
                if (i47 > 0) {
                    ...
                    if (this.R < AndroidUtilities.dp(100.0f)) {
                        ...
                        z10 = true;
                        c10 = this.R >= ((float) (dp2 - AndroidUtilities.dp(100.0f))) ? vl.c(this.R - (dp2 - AndroidUtilities.dp(100.0f)), AndroidUtilities.dp(100.0f), 20.0f, 50.0f) : 50.0f;
                    }
        ...
        if (drawable8 != null && this.k0) {
            ...
            if ((this.n & 112) == 16) {
                ...
                C3 = i2.g.C(this.g0, intrinsicHeight7, 2, getPaddingTop());
                i12 = this.J;
            }
            int i48 = C3 + i12;
        ...
        if (this.w != null && this.l0) {
            ...
            if ((this.n & 112) == 16) {
                ...
                C2 = i2.g.C(this.g0, intrinsicHeight8, 2, getPaddingTop());
                i11 = this.K;
            }
            int i50 = C2 + i11;
        ...
        if ((this.n & 112) == 16) {
            ...
            C = i2.g.C(this.g0, intrinsicHeight9, 2, getPaddingTop());
            i10 = this.K;
        }
        int i52 = C + i10;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if ((this.n & 112) == 16) {
            this.d0 = i2.g.C((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), this.g0, 2, getPaddingTop());
        } else {
            this.d0 = getPaddingTop();
        }
    }
