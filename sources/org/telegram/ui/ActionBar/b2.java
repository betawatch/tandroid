    ...
    public final ViewGroup f(boolean z10) {
        ...
        if ((z11 || i11 == 3) && i11 != 2) {
            ...
            if (z12) {
                ...
                ai.k2 k2Var = yf.j0.a;
                z1Var2.setOutlineProvider(new yf.h0(dp, dp2));
                ...
                frameLayout.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ActionBar.s1
                    ...
                    public final void onClick(View view) {
                        switch (i13) {
                            ...
                            case 1:
                                b2 b2Var = this.b;
                                new m7(b2Var.getContext(), b2Var.R0).show();
                                break;
                            default:
                                b2 b2Var2 = this.b;
        ...
        if (this.U == 0 && this.X == 0 && this.b0 == null) {
            ...
            if (drawable2 != null) {
                ...
                if (drawable3 instanceof w6) {
                    ...
                    this.k0.addOnAttachStateChangeListener(new t1(w6Var));
                    w6Var.a(this.k0);
                }
            } else {
                int i14 = this.U;
        ...
        if (this.R != null) {
            ...
            vh.o oVar3 = this.f;
            boolean z15 = this.W;
            frameLayout3.addView(oVar3, w7.y5.d(-2, -2.0f, (z15 ? 1 : LocaleController.isRTL ? 5 : 3) | 48, 0.0f, 19.0f, 0.0f, z15 ? 4.0f : this.S != null ? 2 : this.P != null ? 14 : 10));
        }
        if (this.S != null) {
        ...
        if (i11 == 2) {
            ...
            ku kuVar2 = this.d;
            if (kuVar2 != null) {
                this.w.addView(kuVar2, w7.y5.k(22.0f, 4.0f, 22.0f, 12.0f, -1, -2));
            }
            ...
            linearLayout2.addView(kuVar3, w7.y5.t(-2, -2, r15 | 48, 24, 0, 24, (this.b == null && this.P == null) ? 0 : this.G));
        ...
        if (this.P != null) {
            ...
            while (true) {
                ...
                if (charSequenceArr[i18] != null) {
                    ...
                    this.N0.add(x1Var);
                    this.w.addView(x1Var, w7.y5.n(-1, 50));
                    final int i19 = 2;
        ...
        if (z14) {
            ...
            if (this.l0 != null) {
                ...
                if (this.I0) {
                    f12 = 6.0f;
                    this.t0.addView(w1Var, w7.y5.q(-1, 40, 7));
                } else {
                    f12 = 6.0f;
                    this.t0.addView(w1Var, w7.y5.e(-2, 40, 53));
                }
            ...
            if (this.n0 != null) {
                ...
                if (this.I0) {
                    this.t0.addView(w1Var2, 0, w7.y5.q(-1, 40, 7));
                } else {
                    this.t0.addView(w1Var2, w7.y5.e(-2, 40, 53));
                }
                w1Var2.setOnClickListener(new ai.f2(i17, this, w1Var2));
            }
            if (this.r0 != null) {
                ...
                if (this.I0) {
                    this.t0.addView(w1Var3, 1, w7.y5.q(-1, 40, 7));
                } else {
                    this.t0.addView(w1Var3, w7.y5.e(-2, 40, 51));
                }
            ...
            if (this.p0 != null) {
                ...
                if (this.I0) {
                    this.t0.addView(w1Var4, 0, w7.y5.q(-1, 40, 7));
                } else {
                    this.t0.addView(w1Var4, w7.y5.e(-2, 40, 53));
                }
