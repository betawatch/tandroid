...
public final class b2 extends LinearLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        d2 d2Var = this.d;
        Drawable drawable = d2Var.z0;
        if (d2Var.i0 && !d2Var.T0) {
            drawable.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            View view = d2Var.V;
            if (view == null || !d2Var.j0) {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (d2Var.T0) {
            ...
            float d = this.b.d(d2Var.F0 != null ? 1.0f : 0.0f, false);
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        int d = em.d(48.0f, paddingLeft, TLObject.FLAG_30);
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft, TLObject.FLAG_30);
        ViewGroup viewGroup = d2Var.t0;
        if (viewGroup != null) {
            int childCount = viewGroup.getChildCount();
            for (int i16 = 0; i16 < childCount; i16++) {
                View childAt = d2Var.t0.getChildAt(i16);
                if (childAt instanceof TextView) {
                    ((TextView) childAt).setMaxWidth(AndroidUtilities.dp(em.y(24.0f, paddingLeft, 2)));
                }
            }
            d2Var.t0.measure(makeMeasureSpec, i11);
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) d2Var.t0.getLayoutParams();
            i12 = paddingTop - ((d2Var.t0.getMeasuredHeight() + layoutParams.bottomMargin) + layoutParams.topMargin);
        } else {
            i12 = paddingTop;
        }
        uh.o oVar = d2Var.f;
        ...
        kj0 kj0Var = d2Var.k0;
        if (kj0Var != null) {
            kj0Var.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(d2Var.a0), TLObject.FLAG_30));
            i12 -= d2Var.k0.getMeasuredHeight();
        }
        View view = d2Var.V;
        if (view != null) {
            float f10 = d2Var.O0;
            if (f10 >= 0.0f) {
                ...
                d2Var.V.getLayoutParams().height = i17;
            } else {
                view.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), i11);
            }
            i12 -= d2Var.V.getMeasuredHeight();
        }
        if (i14 == 0) {
            LinearLayout.LayoutParams layoutParams4 = (LinearLayout.LayoutParams) d2Var.v.getLayoutParams();
            if (d2Var.b != null) {
                layoutParams4.topMargin = (d2Var.f == null && d2Var.n.getVisibility() == 8 && d2Var.P == null) ? AndroidUtilities.dp(16.0f) : 0;
                layoutParams4.bottomMargin = d2Var.t0 == null ? AndroidUtilities.dp(8.0f) : 0;
            } else if (d2Var.P != null) {
            ...
            if (frameLayout2 != null) {
                ...
                ou ouVar = d2Var.n;
                if (ouVar != null) {
                    ouVar.measure(d, View.MeasureSpec.makeMeasureSpec(i12, TLObject.FLAG_31));
                ...
                w80Var = d2Var.u0;
                if (w80Var != null) {
                    w80Var.measure(d, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(4.0f), TLObject.FLAG_30));
                    LinearLayout.LayoutParams layoutParams7 = (LinearLayout.LayoutParams) d2Var.u0.getLayoutParams();
                    int measuredHeight2 = i12 - ((d2Var.u0.getMeasuredHeight() + layoutParams7.bottomMargin) + layoutParams7.topMargin);
                    d2Var.v0.measure(d, View.MeasureSpec.makeMeasureSpec(measuredHeight2, TLObject.FLAG_31));
                    LinearLayout.LayoutParams layoutParams8 = (LinearLayout.LayoutParams) d2Var.v0.getLayoutParams();
                    i12 = measuredHeight2 - ((d2Var.v0.getMeasuredHeight() + layoutParams8.bottomMargin) + layoutParams8.topMargin);
                }
            }
        ...
        setMeasuredDimension(size, (getPaddingBottom() + (getPaddingTop() + (paddingTop - i12))) - (d2Var.W ? AndroidUtilities.dp(8.0f) : 0));
        this.a = false;
        if (d2Var.L != AndroidUtilities.displaySize.x) {
