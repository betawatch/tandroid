...
public final class x4 {
    ...
    public x4(z4 z4Var, Context context, View view) {
        ...
        w4Var.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: org.telegram.ui.ActionBar.o4
            ...
            public final void onItemClick(AdapterView adapterView, View view3, int i15, long j3) {
                ...
                z4 z4Var2 = x4Var.Q;
                if (z4Var2.j == null || !z4.r.contains(Integer.valueOf(menuItem.getItemId()))) {
        ...
        this.v = animatorSet;
        this.w = z4.a(relativeLayout3, ImageReceiver.DEFAULT_CROSSFADE_DURATION, new u4(this, 0));
        this.x = z4.a(relativeLayout3, 0, new u4(this, i15));
    }

    public static void a(x4 x4Var) {
        FrameLayout frameLayout = x4Var.i;
        RelativeLayout relativeLayout = x4Var.f;
        if (x4Var.M) {
            x4Var.g.setY(relativeLayout.getHeight() - x4Var.J.getHeight());
    ...
    public static boolean b(x4 x4Var) {
        AnimationSet animationSet = x4Var.z;
        AnimationSet animationSet2 = x4Var.y;
    ...
    public final void g() {
        ...
        if (z10) {
            ...
            int i10 = 0;
            p4 p4Var2 = new p4(this, this.J.getHeight(), relativeLayout.getHeight(), relativeLayout.getY() + relativeLayout.getHeight(), i10);
            float x11 = frameLayout.getX();
            q4 q4Var = new q4(this, x11, (width2 + x11) - t4Var.getWidth(), width2, i10);
            ...
            this.N = false;
            n();
            gc1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.u).setDuration(100L).start();
    ...
    public final void k() {
        ...
        if (z10) {
            ...
            if (this.M) {
                ...
                gc1Var.setY(r2.getHeight() - relativeLayout.getHeight());
