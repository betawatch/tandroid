...
public final class d6 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void a(boolean z10) {
        ...
        if (c == null || z10) {
            ...
            while (i10 < 5) {
                ...
                if (i6Var != null && (arrayList = i6Var.b0) != null && !arrayList.isEmpty()) {
                    ...
                    for (int i11 = 0; i11 < size; i11++) {
                        g6 g6Var = (g6) i6Var.b0.get(i11);
                        if (g6Var.a != j6.n && !TextUtils.isEmpty(g6Var.o)) {
                            if (arrayList2 == null) {
            ...
            if (arrayList2 != null) {
                Utilities.globalQueue.postRunnable(new ki.c0(28, d6Var, arrayList2));
            }
            c = d6Var;
        }
    }
    ...
    public static Bitmap b(Bitmap bitmap, boolean z10, File file, g6 g6Var) {
        ...
        try {
            ...
            if (i17 != 0) {
                ...
                Drawable v9Var = new v9(v9.d(g6Var.n), new int[]{i14, i15});
