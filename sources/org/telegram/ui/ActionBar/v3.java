    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (s3Var != null) {
            ...
            if (v3Var.c != null) {
                ...
                v3Var.c.a(canvas, rectF3, x10, v3Var.e, 1.0f);
                rectF = rectF3;
                canvas.restore();
            } else {
                rectF = rectF3;
        ...
        if (view != null) {
            ...
            v3Var.getLocationOnScreen(iArr2);
            rectF5.set(iArr[0] - iArr2[0], iArr[1] - iArr2[1], v3Var.S.getWidth() + r1, v3Var.S.getHeight() + (iArr[1] - iArr2[1]));
        } else {
            iArr[1] = 0;
            iArr[0] = 0;
        ...
        float lerp = AndroidUtilities.lerp(0.0f, 1.0f - Utilities.clamp(v3Var.getScrollWindow() <= 0.0f ? 0.0f : ((v3Var.getScrollMin() - v3Var.getScrollOffset()) / (v3Var.getScrollWindow() * 0.15f)) * 0.2f, 1.0f, 0.0f), v3Var.V);
        int i14 = 0;
            ...
            if (i14 == arrayList.size()) {
                ...
                if (rectF6.top > f17 || rectF6.bottom < 0.0f) {
                    ...
                    if (clamp > 0.0f) {
                        ...
                        if (z10) {
                            paint4.setColor(0);
                            paint4.setShadowLayer(AndroidUtilities.dp(30.0f), 0.0f, AndroidUtilities.dp(10.0f), h6.l1(clamp * f27 * 1.0f, TLObject.FLAG_29));
                            ...
                            if (l3Var != null && l3Var.m != null) {
                                float width3 = rectF6.width() / l3Var.m.getWidth();
                                canvas.scale(width3, width3);
                                paint.setAlpha(i15);
                                canvas.drawBitmap(l3Var.m, 0.0f, 0.0f, paint);
                            }
                            canvas.restore();
                            canvas.save();
        ...
        if (this.i0 == null || this.h0 != h6.I.q()) {
            ...
            this.h0 = q6;
            if (q6) {
                this.i0 = h6.i0(64, 64, 64, 64, 553648127, 872415231, 872415231);
            } else {
                this.i0 = h6.i0(64, 64, 64, 64, 771751936, 1140850688, 1140850688);
            }
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.V >= 1.0f) {
                ...
                for (int size = arrayList.size() - 1; size >= 0; size--) {
                    ...
                    if (Math.abs(u3Var.i) < 0.4f && u3Var.a.contains(x10, y3)) {
                        break;
                    }
                }
            }
        ...
        if (motionEvent.getAction() == 2) {
            ...
            if (u3Var3 != null) {
                ...
                if (!u3Var4.k.h) {
                    if (this.H) {
                        u3Var4.i = (motionEvent.getX() - this.E) / AndroidUtilities.dp(300.0f);
                    } else if (this.G) {
                                    ...
                                    switch (i10) {
                                        case 0:
                                            ...
                                            if (!booleanValue) {
                                                ...
                                                v3Var.h(Utilities.clamp(v3Var.L, v3Var.c(false), v3Var.d(false)));
                                        ...
                                        default:
                                            ...
                                            if (!booleanValue2) {
                                                ...
                                                u3Var10.a(1.0f);
                                                v3Var2.h(Utilities.clamp(v3Var2.L, v3Var2.c(false), v3Var2.d(false)));
    ...
    public final float e(boolean z10) {
        ...
        while (true) {
            ...
            f7 += ((u3) arrayList.get(i10)).d.c >= 0 ? 1.0f : 0.0f;
            i10++;
        }
    ...
    public final void f() {
        ...
        AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, h6.I.q() ? 0.08f : 0.25f);
