...
public abstract class c1 extends FrameLayout {
    ...
    public c1(Context context, f6 f6Var) {
        ...
        this.a = 0.5f;
        pr prVar = pr.h;
        this.e = new org.telegram.ui.Components.e6(1.0f, this, 0L, 320L, prVar);
        this.r = new int[2];
        this.s = 0.0f;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z11) {
            ...
            if (r02 instanceof ColorDrawable) {
                ...
                Pair pair = null;
                Bitmap bitmap = r02 instanceof dc0 ? ((dc0) r02).k : r02 instanceof BitmapDrawable ? ((BitmapDrawable) r02).getBitmap() : null;
                if (bitmap != null) {
