...
public final class f6 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean a(e6 e6Var, TLRPC.ThemeSettings themeSettings) {
        ...
        if (wallPaper == null || (wallPaperSettings = wallPaper.settings) == null) {
            ...
            if (!(wallPaper2 instanceof TLRPC.TL_wallPaperNoFile) && wallPaper2.pattern) {
                ...
                return (themeSettings.accent_color != e6Var.c && themeSettings.outbox_accent_color == e6Var.d && intValue == e6Var.e && intValue2 == e6Var.f && intValue3 == e6Var.g && intValue4 == e6Var.h && themeSettings.message_colors_animated == e6Var.i && ((long) i10) == e6Var.j && j10 == e6Var.k && j11 == e6Var.l && j12 == e6Var.m && i11 == e6Var.n && TextUtils.equals(str, e6Var.o) && ((double) Math.abs(f10 - e6Var.p)) < 0.001d) ? z11 : z10;
            }
            str = null;
        }
        f10 = 0.0f;
    ...
    public static void c(f6 f6Var, SharedPreferences sharedPreferences) {
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            f6Var.r(sharedPreferences, null, a9.p.p(new StringBuilder(), f6Var.a, "_owp"));
            return;
        }
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            sb2.append(f6Var.a);
            sb2.append("_");
            f6Var.r(sharedPreferences, e6Var, a9.p.k(e6Var.a, "_owp", sb2));
        }
    }
    ...
    public final boolean d(File file, String str) {
        ...
        try {
            ...
            if (scaledBitmap != null && this.r != 0) {
                ...
                int i10 = this.v;
                if (i10 != 0) {
                    patternColor = nb0.g(this.r, this.s, i10, this.w);
                } else {
                    int i11 = this.s;
                    if (i11 != 0) {
                        patternColor = AndroidUtilities.getAverageColor(this.r, i11);
                        GradientDrawable gradientDrawable = new GradientDrawable(m9.d(this.x), new int[]{this.r, this.s});
        ...
        if (i10 == i12 || i10 == NotificationCenter.fileLoadFailed) {
            ...
            if (str.equals(FileLoader.getAttachFileName(this.B.document))) {
                ...
                if (i10 == i12) {
                    ...
                    ConnectionsManager.getInstance(k02.A).sendRequest(getwallpaper, new cg.g0(25, this, k02));
                }
            }
        }
    }
    ...
    public final String j(e6 e6Var, boolean z10) {
        ...
        if (e6Var == null) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append(z10 ? a9.p.p(new StringBuilder(), this.a, "_wp_o") : a9.p.p(new StringBuilder(), this.a, "_wp"));
        ...
        if (z10) {
            ...
            sb4.append(this.a);
            sb4.append("_");
            k10 = a9.p.k(e6Var.a, "_wp_o", sb4);
        } else {
            StringBuilder sb5 = new StringBuilder();
            sb5.append(this.a);
            sb5.append("_");
            k10 = a9.p.k(e6Var.a, "_wp", sb5);
        }
        sb3.append(k10);
