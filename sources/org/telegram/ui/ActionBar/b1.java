...
public abstract class b1 extends FrameLayout {
    ...
    public b1(Context context, d6 d6Var) {
        ...
        x0Var.b = LocaleController.isRTL ? 5 : 3;
        ...
        x0Var2.b = LocaleController.isRTL ? 3 : 5;
        paint.setColor(0);
        ...
        this.L = z10;
        x0Var.r(z10 ? -1 : -16777216);
        x0Var2.r(this.L ? -1 : -16777216);
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (str2 != null) {
            x0 x0Var = this.c;
            if (!TextUtils.equals(x0Var.g, str2)) {
                x0Var.b();
        ...
        if (str != null) {
            x0 x0Var2 = this.d;
            if (!TextUtils.equals(x0Var2.g, str)) {
                x0Var2.b();
        ...
        int i11 = h6.sj;
        d6 d6Var = a1Var.x;
        this.J.setColor(i0.a.d(w7.q.a((((a2 * 2.8f) + 0.2f) - 1.0f) / 1.0f, 0.0f, 1.0f), h6.v0(i11, d6Var), h6.v0(h6.tj, d6Var)));
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z11) {
            ...
            if (r02 instanceof ColorDrawable) {
                ...
                v02 = h6.l1(0.25f, h6.v0(h6.d6, d6Var));
            }
        } else {
            v02 = h6.v0(h6.d6, d6Var);
            if (!h6.I.q()) {
