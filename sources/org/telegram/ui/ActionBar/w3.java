...
public final class w3 extends View {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (view != null) {
            ...
            w3Var.getLocationOnScreen(iArr2);
            rectF5.set(iArr[0] - iArr2[0], iArr[1] - iArr2[1], w3Var.S.getWidth() + r1, w3Var.S.getHeight() + (iArr[1] - iArr2[1]));
        } else {
            iArr[1] = 0;
            iArr[0] = 0;
        ...
        if (action == 0) {
            ...
            if (this.V >= 1.0f) {
                ...
                for (int size = arrayList.size() - 1; size >= 0; size--) {
                    ...
                    if (Math.abs(v3Var.i) < 0.4f && v3Var.a.contains(x10, y3)) {
                        break;
                    }
                }
            }
                                    ...
                                    switch (i10) {
                                        case 0:
                                            ...
                                            if (!booleanValue) {
                                                ...
                                                w3Var.h(Utilities.clamp(w3Var.L, w3Var.c(false), w3Var.d(false)));
                                        ...
                                        default:
                                            ...
                                            if (!booleanValue2) {
                                                ...
                                                v3Var10.a(1.0f);
                                                w3Var2.h(Utilities.clamp(w3Var2.L, w3Var2.c(false), w3Var2.d(false)));
