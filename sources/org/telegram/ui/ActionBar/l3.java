...
public final class l3 {
    ...
    public l3(View view, n3 n3Var) {
        ...
        this.e = new org.telegram.ui.Components.z5(view, 320L, prVar);
        this.q = n3Var.D;
        String b10 = n3Var.b();
    ...
    public final void a(Canvas canvas, RectF rectF, float f10, float f11, float f12) {
        ...
        paint.setShadowLayer(AndroidUtilities.dp(2.33f), 0.0f, AndroidUtilities.dp(1.0f), k6.l1(f11, TLObject.FLAG_28));
        float[] fArr = this.w;
        fArr[3] = f10;
        fArr[2] = f10;
        fArr[1] = f10;
        ...
        if (f14 > 0.0f && this.v > 0.0f && f11 > 0.0f) {
            ...
            int l1 = k6.l1(0.07f * f11 * this.v, AndroidUtilities.computePerceivedBrightness(d) > 0.721f ? -16777216 : -1);
            Paint paint2 = this.g;
            paint2.setColor(l1);
