...
public final class FloatingToolbar {
    ...
    final class FloatingToolbarPopup {
        ...
        public List layoutMainPanelItems(List list, int i) {
            ...
            while (it.hasNext()) {
                ...
                if (menuItem == null || FloatingToolbar.this.premiumLockClickListener == null || !FloatingToolbar.premiumOptions.contains(Integer.valueOf(menuItem.getItemId()))) {
                    View createMenuItemButton = FloatingToolbar.this.createMenuItemButton(this.mContext, menuItem, this.mIconTextSpacing, false, z, z2);
        ...
        private OverflowPanel createOverflowPanel() {
            ...
            ArrayAdapter arrayAdapter = new ArrayAdapter(this.mContext, 0) { // from class: org.telegram.ui.ActionBar.FloatingToolbar.FloatingToolbarPopup.13
        ...
        final class OverflowPanel extends ListView {
            ...
            OverflowPanel(FloatingToolbarPopup floatingToolbarPopup) {
                ...
                int[] generateColors = generateColors(-16777216);
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                LinearGradient linearGradient = new LinearGradient(0.0f, dp, 0.0f, 0.0f, generateColors, (float[]) null, tileMode);
        ...
        private final class OverflowPanelViewHelper {
            ...
            private View createMenuButton(MenuItem menuItem) {
                View createMenuItemButton = FloatingToolbar.this.createMenuItemButton(this.mContext, menuItem, this.mIconTextSpacing, true, false, false);
