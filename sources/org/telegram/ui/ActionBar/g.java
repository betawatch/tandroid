        ...
        switch (this.a) {
            ...
            case 3:
                ...
                if (animator.equals(giVar.I0)) {
                    if (!z11) {
                        if (!giVar.J) {
                            giVar.z0.setVisibility(4);
                        }
                        giVar.D0.setVisibility(4);
                    } else if (giVar.O0 && ((yhVar = giVar.u0) == null || yhVar.J())) {
            ...
            case 4:
                ...
                if (l90Var.b2 != null) {
                    ...
                    if (!this.b) {
                        ...
                        if (this.c && (v0Var = o90Var.C) != null) {
                            v0Var.setVisibility(8);
                            break;
                        }
                    } else {
                        o90Var.s.setVisibility(4);
                        v0 v0Var3 = o90Var.C;
                        if (v0Var3 != null) {
            ...
            default:
                ...
                AnimatorSet[] animatorSetArr = ig0Var.G;
                boolean z12 = this.b;
                if (animatorSetArr[!z12 ? 1 : 0] != null && animatorSetArr[!z12 ? 1 : 0].equals(animator) && !this.c && z12 && ig0Var.I.getAlpha() != 1.0f) {
