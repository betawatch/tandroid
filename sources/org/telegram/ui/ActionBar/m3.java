...
public final class m3 {
    ...
    public m3(View view, o3 o3Var) {
        ...
        this.q = o3Var.F;
        String b10 = o3Var.b();
        textPaint = p3.getTextPaint();
        this.t = new h01(Emoji.replaceEmoji(b10, textPaint.getFontMetricsInt(), false), 17.0f, AndroidUtilities.bold());
        int i10 = o3Var.q;
        this.m = i10;
    ...
    public final void a(Canvas canvas, RectF rectF, float f7, float f10, float f11) {
        ...
        h01 h01Var = this.u;
        if (h01Var != null) {
            h01Var.p = (int) ((rectF.width() - AndroidUtilities.dp(100.0f)) - r3);
            h01Var.c(rectF.left + AndroidUtilities.dp(60.0f) + i10, rectF.centerY(), org.telegram.messenger.w1.A(1.0f, this.v, f10, f11), d10, canvas2);
        }
        float width = rectF.width() - AndroidUtilities.dp(100.0f);
        float f19 = i10;
        h01 h01Var2 = this.t;
        h01Var2.p = (int) (width - f19);
        h01Var2.c(f19 + rectF.left + AndroidUtilities.dp(60.0f), rectF.centerY(), (this.u == null ? 1.0f : this.v) * f10 * f11, d10, canvas);
    }
