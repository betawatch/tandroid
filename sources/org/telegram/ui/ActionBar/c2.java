...
public class c2 extends Dialog implements Drawable.Callback, NotificationCenter.NotificationCenterDelegate {
    ...
    public static void a(c2 c2Var, int i10, boolean z10) {
        ...
        animatorSetArr[i10].addListener(new y2(c2Var, i10, i11));
        try {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ku kuVar;
        if (i10 != NotificationCenter.emojiLoaded || (kuVar = this.n) == null) {
            return;
        }
        kuVar.invalidate();
    }
    ...
    public final ViewGroup f(boolean z10) {
        ...
        if ((z11 || i11 == 3) && i11 != 2) {
            ...
            if (z12) {
                ...
                ai.k2 k2Var = yf.j0.a;
                a2Var2.setOutlineProvider(new yf.h0(dp, dp2));
        ...
        if (z13) {
            ...
            if (this.Z0 == null) {
                ...
                this.Z0 = aVar;
                w7.z5.a(aVar);
                this.Z0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ActionBar.t1
                    public final /* synthetic */ c2 b;
        ...
        if (this.U == 0 && this.X == 0 && this.b0 == null) {
            ...
            if (drawable2 != null) {
                bj0Var.setImageDrawable(drawable2);
                Drawable drawable3 = this.b0;
                if (drawable3 instanceof v6) {
                    v6 v6Var = (v6) drawable3;
                    this.k0.addOnAttachStateChangeListener(new u1(v6Var));
                    v6Var.a(this.k0);
                }
            } else {
                int i14 = this.U;
                if (i14 != 0) {
                    bj0Var.setImageResource(i14);
                } else {
                    bj0Var.setAutoRepeat(this.S0);
                    bj0 bj0Var2 = this.k0;
                    int i15 = this.X;
                    int i16 = this.Y;
                    bj0Var2.f(i15, i16, i16, null);
                    if (this.Z != null) {
                        yi0 animatedDrawable = this.k0.getAnimatedDrawable();
            ...
            if (this.W) {
                ...
                this.k0.setBackground(new v1(this, gradientDrawable));
                this.a0 = 92;
            } else {
        ...
        if (this.R != null) {
            ...
            vh.o oVar3 = this.f;
            boolean z15 = this.W;
            frameLayout3.addView(oVar3, w7.x5.d(-2, -2.0f, (z15 ? 1 : LocaleController.isRTL ? 5 : 3) | 48, 0.0f, 19.0f, 0.0f, z15 ? 4.0f : this.S != null ? 2 : this.P != null ? 14 : 10));
        }
        if (this.S != null) {
        ...
        if (i11 == 2) {
            ...
            ku kuVar2 = this.d;
            if (kuVar2 != null) {
                this.w.addView(kuVar2, w7.x5.k(22.0f, 4.0f, 22.0f, 12.0f, -1, -2));
            }
            ...
            linearLayout2.addView(kuVar3, w7.x5.t(-2, -2, r15 | 48, 24, 0, 24, (this.b == null && this.P == null) ? 0 : this.G));
        ...
        if (this.P != null) {
            ...
            while (true) {
                ...
                if (charSequenceArr[i18] != null) {
                    ...
                    this.N0.add(y1Var);
                    this.w.addView(y1Var, w7.x5.n(-1, 50));
                    final int i19 = 2;
        ...
        if (z14) {
            ...
            if (this.I0) {
                ...
                this.t0 = new u2(this, getContext(), i10);
            }
            if (this.c != null) {
            ...
            if (this.l0 != null) {
                ...
                if (this.I0) {
                    f12 = 6.0f;
                    this.t0.addView(x1Var, w7.x5.q(-1, 40, 7));
                } else {
                    f12 = 6.0f;
                    this.t0.addView(x1Var, w7.x5.e(-2, 40, 53));
                }
            ...
            if (this.n0 != null) {
                ...
                x1Var2.setText(this.n0.toString());
                ...
                if (this.I0) {
                    this.t0.addView(x1Var2, 0, w7.x5.q(-1, 40, 7));
                } else {
                    this.t0.addView(x1Var2, w7.x5.e(-2, 40, 53));
                }
                x1Var2.setOnClickListener(new ai.f2(i17, this, x1Var2));
            }
            if (this.r0 != null) {
                ...
                x1Var3.setText(this.r0.toString());
                ...
                if (this.I0) {
                    this.t0.addView(x1Var3, 1, w7.x5.q(-1, 40, 7));
                } else {
                    this.t0.addView(x1Var3, w7.x5.e(-2, 40, 51));
                }
            ...
            if (this.p0 != null) {
                ...
                x1Var4.setText(this.p0.toString());
                ...
                if (this.I0) {
                    this.t0.addView(x1Var4, 0, w7.x5.q(-1, 40, 7));
                } else {
                    this.t0.addView(x1Var4, w7.x5.e(-2, 40, 53));
                }
