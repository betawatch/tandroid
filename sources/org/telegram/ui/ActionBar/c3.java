...
public abstract class c3 extends FrameLayout {
    ...
    public final void b(float f7, float f10) {
        boolean z10;
        e3 e3Var = this.G;
        if ((e3Var.containerView.getTranslationY() >= AndroidUtilities.getPixelsInCM(0.8f, false) || (f10 >= 3500.0f && Math.abs(f10) >= Math.abs(f7))) && (f10 >= 0.0f || Math.abs(f10) < 3500.0f)) {
    ...
    public final void c(Canvas canvas, float f7) {
        ...
        if (!z10 || e3Var.containerView.getVisibility() == 0) {
            ...
            if (!e3Var.scrollNavBar && (i13 < 29 || e3.access$1400(e3Var) <= 0)) {
                ...
                max = Math.max(0.0f, Math.min(bottomInset - f11, e3Var.containerView.getTranslationY()));
            } else {
            ...
            if (z11) {
                f7 *= e3Var.containerView.getAlpha();
            }
            z12 = e3Var.transitionFromRight;
            int x10 = z12 ? (int) e3Var.containerView.getX() : e3Var.containerView.getLeft();
            if (f7 < 1.0f) {
                paint.setAlpha((int) (alpha * f7));
            }
            f12 = e3Var.currentPanTranslationY;
            canvas.drawRect(e3Var.backgroundPaddingLeft + x10, ((getMeasuredHeight() - bottomInset) + max) - f12, e3Var.containerView.getRight() - e3Var.backgroundPaddingLeft, getMeasuredHeight() + max, paint);
            ...
            if (i10 != 0) {
                ...
                if (paint.getAlpha() > 0) {
                    ...
                    canvas.drawRect(x10 + e3Var.backgroundPaddingLeft, ((getMeasuredHeight() - bottomInset) + f14) - f13, e3Var.containerView.getRight() - e3Var.backgroundPaddingLeft, getMeasuredHeight() + f14, paint);
                }
                ...
                if (e3Var.canSwipeToBack(motionEvent) || this.E) {
                    if (motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f && !this.e && motionEvent.getPointerCount() == 1)) {
                        ...
                        if (this.f) {
                            float f7 = this.y + x10;
                            this.y = f7;
                            e3Var.containerView.setTranslationX(Math.max(f7, 0.0f));
                            this.b = (int) motionEvent.getX();
                    ...
                    this.c = y10;
                    if (e3Var.isTouchOutside(this.b, y10)) {
                    ...
                    boolean onScrollUp = e3Var.onScrollUp(this.x + y11);
                    this.a.addMovement(motionEvent);
    ...
    */
    public void dispatchDraw(Canvas canvas) {
        ...
        if (paint3.getAlpha() >= 255 || !e3Var.drawNavigationBar) {
            ...
            canvas.clipRect(e3Var.containerView.getLeft() + e3Var.backgroundPaddingLeft, ((getMeasuredHeight() - bottomInset) + f10) - f7, e3Var.containerView.getRight() - e3Var.backgroundPaddingLeft, getMeasuredHeight() + f10, Region.Op.DIFFERENCE);
            super.dispatchDraw(canvas);
            canvas.restore();
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:39:0x00f1, code lost:
        ...
        r3.keyboardContentAnimator.setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.o1.w);
        ...
        if (viewGroup != null) {
            ...
            if (windowInsets2 != null) {
                ...
                if (e3Var2.useSmoothKeyboard) {
                    ...
                    f7 = e3Var2.hideSystemVerticalInsetsProgress;
                    measuredHeight = (int) (f10 - (((1.0f - f7) * systemWindowInsetBottom) - (e3Var2.drawNavigationBar ? 0 : e3Var2.getBottomInset())));
            ...
            j3 = e3Var2.smoothContainerViewLayoutUntil;
            if (j3 > 0) {
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        if (rect.bottom == 0 || rect.top == 0) {
            ...
            f11 = e3Var.hideSystemVerticalInsetsProgress;
            e3Var.keyboardHeight = Math.max(0, ((int) ((height - f10) - ((1.0f - f11) * viewInset))) - (rect.bottom - rect.top));
        ...
        if (windowInsets != null) {
            ...
            if (!e3Var.drawNavigationBar && !e3Var.occupyNavigationBar && !e3Var.occupyNavigationBarWithoutKeyboard) {
                ...
                if (windowInsets2 != null && !e3Var.occupyNavigationBar) {
                    ...
                    float systemWindowInsetBottom = windowInsets4.getSystemWindowInsetBottom();
                    f7 = e3Var.hideSystemVerticalInsetsProgress;
    ...
    public final void onNestedPreScroll(View view, int i10, int i11, int[] iArr) {
        ...
        iArr[1] = i11;
        e3Var.containerView.setTranslationY(f7 >= 0.0f ? f7 : 0.0f);
        e3Var.onContainerViewTranslation();
        e3Var.container.invalidate();
    }
