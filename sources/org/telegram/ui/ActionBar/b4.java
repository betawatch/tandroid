...
public final class b4 {
    ...
    public final void o(int i10, ResultCallback resultCallback) {
        ...
        long i11 = i(i10);
        long j10 = k10.id;
        b9 b9Var = new b9(resultCallback, i11, 1);
        boolean z10 = k10.pattern;
        int i12 = this.g;
        ChatThemeController.getInstance(i12).loadWallpaperBitmap(j10, z10 ? 1 : 0, new z3(b9Var, k10, z10 ? 1 : 0, i12, j10));
    }
    ...
    public final void p(int i10, ResultCallback resultCallback) {
        ...
        if (k10 != null) {
            ...
            if (i11 != 0) {
                ...
                File file = new File(ApplicationLoader.getFilesDirFixed(), com.google.android.recaptcha.internal.a.m(i11, "wallpaper_thumb_", ".png"));
                ...
                if (document == null) {
                    ...
                    imageReceiver.setDelegate(new c3.f(resultCallback, i11, file, 6));
    ...
    public b4(int i10, TLRPC.TL_chatThemeUniqueGift tL_chatThemeUniqueGift) {
        ...
        this.c = of.b.c(tL_chatThemeUniqueGift);
