...
public class l extends FrameLayout implements le.d, a6 {
    ...
    public l(Context context, f6 f6Var) {
        ...
        wr wrVar = wr.h;
        this.b1 = new le.e(0, this, wrVar, 380L);
        this.c1 = new le.b(0, this, wrVar, 380L, false);
        this.d1 = new le.e(0, this, wrVar, 320L);
        this.e1 = new le.b(0, this, wrVar, 320L, false);
        this.q1 = true;
        this.r1 = 1.0f;
        this.I0 = f6Var;
    ...
    public final void I(CharSequence charSequence, org.telegram.ui.Components.n5 n5Var) {
        ...
        l5 l5Var = l5VarArr[0];
        if (l5Var != null) {
            l5Var.setVisibility((charSequence == null || this.n0) ? 4 : 0);
            ...
            l5VarArr[0].setRightDrawableOnClick(this.e0);
        }
        this.y0 = false;
    }
        ...
        if (str2 == null || !str2.equals(str)) {
            ...
            if ((charSequence == null || l5VarArr[0] != null) && getMeasuredWidth() != 0 && ((l5Var = l5VarArr[0]) == null || l5Var.getVisibility() == 0)) {
                ...
                if (l5Var2 != null) {
                    ...
                    l5VarArr[1].setRightDrawableOnClick(this.e0);
                    if (drawable instanceof org.telegram.ui.Components.n5) {
                    ...
                    l5VarArr[0].animate().alpha(this.n1 ? 1.0f - this.r1 : 1.0f).translationY(0.0f).setDuration(220L).start();
                    ViewPropertyAnimator alpha = l5VarArr[1].animate().alpha(0.0f);
                    if (this.r == null) {
    ...
    public boolean N(View view) {
        if (this.L) {
            l5[] l5VarArr = this.n;
            if (view == l5VarArr[0] || view == l5VarArr[1] || view == this.r || view == this.E || view == this.e || view == this.s || view == this.F0) {
                return true;
            }
        }
        return false;
    ...
    public final void b() {
        if (this.m1) {
            if (this.n1) {
                bi.l4 l4Var = this.F0;
                if (l4Var != null) {
                    l4Var.setAlpha(1.0f - this.r1);
                } else {
                    l5 l5Var = this.n[0];
                    if (l5Var != null) {
                        l5Var.setAlpha(1.0f - this.r1);
                    }
                }
            }
            float f7 = this.r1;
    ...
    public final void d(boolean z10) {
        ...
        fo foVar = joVar.e;
        boolean z11 = foVar != null && foVar.getVisibility() == 0;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (dVar == null || this.P0) {
            ...
            jo joVar = this.R0;
            le.b bVar2 = this.c1;
            int lerp = AndroidUtilities.lerp(i14, max, joVar == null ? 0.0f : f7 - bVar2.e);
        ...
        if (this.K0 && this.x != 0) {
            ...
            if (this.m1) {
                ...
                aw0Var.getClass();
                aw0Var.K(canvas, y3, this.M0, paint, true, AndroidUtilities.lerp(255, Color.alpha(j6.v0((aw0.F() && SharedConfig.getDevicePerformanceClass() == 2) ? j6.xf : j6.yf, aw0Var.getResourceProvider())), f10));
            } else {
    ...
    */
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (this.R && !this.i0 && !LocaleController.isRTL) {
            l5[] l5VarArr = this.n;
            if ((view == l5VarArr[0] || view == l5VarArr[1] || (view == this.F0 && this.G0)) && (y02 = j6.y0()) != null) {
                l5 l5Var = view == this.F0 ? l5VarArr[0] : (l5) view;
                if (l5Var != null && l5Var.getVisibility() == 0 && (l5Var.getText() instanceof String)) {
                    ...
                    textPaint.getTextBounds((String) l5Var.getText(), 0, 1, this.W);
                    int width = ((this.W.width() - (y02.getIntrinsicWidth() + j6.D1)) / 2) + l5Var.getTextStartX() + j6.D1;
                    f7 = 255.0f;
                    int textStartY = l5Var.getTextStartY() + j6.E1 + ((int) Math.ceil((l5Var.getTextHeight() - this.W.height()) / 2.0f)) + ((int) ((1.0f - this.F0.getScaleY()) * AndroidUtilities.dp(8.0f)));
                    y02.setBounds(width, textStartY - y02.getIntrinsicHeight(), y02.getIntrinsicWidth() + width, textStartY);
                    y02.setAlpha((int) (l5Var.getAlpha() * this.F0.getAlpha() * 255.0f));
                    y02.draw(canvas);
                    if (this.Y0) {
                        view.invalidate();
                        invalidate();
                ...
                if (lw0Var != null) {
                    ...
                    w00 w00Var = this.T;
                    if (w00Var != null) {
                        ArrayList arrayList = w00Var.d;
                        ArrayList arrayList2 = w00Var.c;
                        if (canvas != null) {
                            int size = arrayList2.size();
                            for (int i10 = 0; i10 < size; i10++) {
                                v00 v00Var2 = (v00) arrayList2.get(i10);
                                Paint paint = v00Var2.k.a;
                                paint.setColor(v00Var2.j);
                                paint.setStrokeWidth(AndroidUtilities.dp(1.5f) * v00Var2.i);
                                paint.setAlpha((int) (v00Var2.f * f7));
                                canvas.drawPoint(v00Var2.a, v00Var2.b, paint);
                            }
                            if (Utilities.random.nextBoolean()) {
                                if (arrayList2.size() + 8 < 150) {
                                    ...
                                    float nextFloat2 = (Utilities.random.nextFloat() * org.telegram.messenger.a2.B(20.0f, getMeasuredHeight(), i11)) + i11;
                                    ...
                                    for (int i14 = 8; i13 < i14; i14 = 8) {
                                        ...
                                        if (arrayList.isEmpty()) {
                                            v00Var = new v00(w00Var);
                                        } else {
                                            v00Var = (v00) arrayList.get(0);
                                            arrayList.remove(0);
                                        }
                                        v00Var.a = f10;
                                        v00Var.b = nextFloat2;
                                        ...
                                        v00Var.f = 1.0f;
                                        v00Var.h = 0.0f;
                                        v00Var.i = Math.max(1.0f, Utilities.random.nextFloat() * 1.5f);
                                        v00Var.g = Utilities.random.nextInt(MediaDataController.MAX_STYLE_RUNS_COUNT) + MediaDataController.MAX_STYLE_RUNS_COUNT;
                                        v00Var.e = (Utilities.random.nextFloat() * 4.0f) + 20.0f;
                            ...
                            long min = Math.min(17L, currentTimeMillis - w00Var.b);
                            int size2 = arrayList2.size();
                            while (i15 < size2) {
                                v00 v00Var3 = (v00) arrayList2.get(i15);
                                float f11 = v00Var3.h;
                                float f12 = v00Var3.g;
                                if (f11 >= f12) {
                                    if (arrayList.size() < 40) {
                                        arrayList.add(v00Var3);
                                    }
                                    ...
                                    v00Var3.f = 1.0f - AndroidUtilities.decelerateInterpolator.getInterpolation(f11 / f12);
                                    float f13 = v00Var3.a;
                                    float f14 = v00Var3.c;
                                    float f15 = v00Var3.e;
                                    float f16 = min;
                                    z11 = N;
                                    v00Var3.a = a4.a.A(f14 * f15, f16, 500.0f, f13);
                                    float f17 = v00Var3.b;
                                    float f18 = v00Var3.d;
                                    v00Var3.b = (((f15 * f18) * f16) / 500.0f) + f17;
                                    v00Var3.d = (f16 / 100.0f) + f18;
                                    v00Var3.h += f16;
                                }
                                i15++;
                                N = z11;
    ...
    public final void l() {
        ...
        addView(this.s, 0, w7.a6.e(-2, -2, 51));
    }
    ...
    public final void o() {
        ...
        addView(this.r, 0, w7.a6.e(-2, -2, 51));
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.R && !this.i0 && !LocaleController.isRTL && motionEvent.getAction() == 0 && (y02 = j6.y0()) != null && y02.getBounds().contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
            ...
            if (lw0Var == null) {
                ...
                this.S = null;
                w00 w00Var = new w00();
                w00Var.c = new ArrayList();
                w00Var.d = new ArrayList();
    ...
    */
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.l1 != null) {
            ...
            jVar.layout(i20, i23, jVar.getMeasuredWidth() + i20, this.l1.getMeasuredHeight() + i23);
        }
        l5 l5Var4 = this.r;
        ...
        for (int i27 = 0; i27 < childCount; i27++) {
            ...
            if (childAt.getVisibility() != 8 && childAt != l5VarArr[0] && childAt != l5VarArr[1] && childAt != this.l1 && childAt != this.r && childAt != this.E && childAt != this.e && childAt != this.s && childAt != this.f) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        d dVar = lVar.F;
        if (dVar != null) {
            dVar.setPadding(0, lVar.I ? AndroidUtilities.statusBarHeight : 0, 0, 0);
        }
        lVar.H = false;
        lVar.setMeasuredDimension(size, currentActionBarHeight + (lVar.I ? AndroidUtilities.statusBarHeight : 0) + lVar.O);
        ...
        if (zVar != null && zVar.getVisibility() != 8) {
            float f7 = 66.0f;
            if (lVar.E.p() && !lVar.n0) {
                lVar.E.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_31), makeMeasureSpec2);
                int l4 = lVar.E.l();
                if (lVar.m0) {
                    f7 = 0.0f;
                ...
                makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(lVar.E.l() + (size - AndroidUtilities.dp(f7)), TLObject.FLAG_30);
                if (!lVar.y) {
                    lVar.E.r(-l4);
                }
            } else if (lVar.n0) {
                ...
                makeMeasureSpec = em.d(f7, size, TLObject.FLAG_30);
                if (!lVar.y) {
                    lVar.E.r(0.0f);
                }
            } else {
        ...
        while (true) {
            ...
            l5 l5Var3 = l5VarArr[0];
            if ((l5Var3 != null && l5Var3.getVisibility() != 8) || ((l5Var = lVar.r) != null && l5Var.getVisibility() != 8)) {
                z zVar2 = lVar.E;
                int max = Math.max(org.telegram.messenger.a2.B(16.0f, size - (zVar2 != null ? zVar2.getMeasuredWidth() : 0), dp) - lVar.a0, 0);
                boolean z10 = lVar.y0;
                int i14 = 20;
                if (((z10 && i13 == 0) || (!z10 && i13 == i12)) && lVar.w0 && lVar.x0) {
                    ...
                    if (l5Var5 == null || l5Var5.getVisibility() == 8 || (l5Var2 = lVar.r) == null || l5Var2.getVisibility() == 8) {
                        ...
                        l5 l5Var9 = lVar.s;
                        if (l5Var9 != null) {
                            l5Var9.setTextSize((AndroidUtilities.isTablet() || lVar.getResources().getConfiguration().orientation != 2) ? 16 : 14);
                        }
                    } else {
        ...
        while (i15 < childCount) {
            ...
            if (childAt.getVisibility() != 8 && childAt != l5VarArr[0] && childAt != l5VarArr[1] && childAt != lVar.l1 && childAt != lVar.r && childAt != lVar.E && childAt != lVar.e && childAt != lVar.s && childAt != lVar.f) {
    ...
    public final void p(int i10) {
        ...
        if (i11 != 0) {
            ...
            l5VarArr[i10].setTextColor(j6.v0(j6.A8, this.I0));
        }
        ...
        if (this.G0) {
            this.F0.addView(l5VarArr[i10], 0, w7.a6.e(-2, -2, 51));
        } else {
            addView(l5VarArr[i10], 0, w7.a6.e(-2, -2, 51));
        }
    }
    ...
    public void setRightDrawableOnClick(View.OnClickListener onClickListener) {
        ...
        if (l5Var2 != null) {
            l5Var2.setRightDrawableOnClick(this.e0);
        }
    }
