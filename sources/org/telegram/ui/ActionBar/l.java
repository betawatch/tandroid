...
public class l extends FrameLayout implements vd.b, x5 {
    ...
    public l(Context context, c6 c6Var) {
        ...
        this.a1 = new vd.a(0, this, jrVar, 320L, false);
        this.m1 = true;
        this.n1 = 1.0f;
        this.E0 = c6Var;
    ...
    public final void J(String str, int i10, Runnable runnable) {
        ...
        if (str2 == null || !str2.equals(str)) {
            this.b0 = str;
            if (this.h1 != null) {
                this.h1.c(i10 == R.string.ConnectingToProxyWithDots ? AndroidUtilities.replaceArrows(LocaleController.getString(R.string.TitleSetupProxy), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(2.0f)) : null);
            }
            CharSequence string = str != null ? LocaleController.getString(str, i10) : this.V;
    ...
    public void O(View[] viewArr, boolean[] zArr) {
        ...
        arrayList.add(ObjectAnimator.ofFloat(this.B, (Property<e, Float>) property, 0.0f, 1.0f));
        if (viewArr != null) {
        ...
        if (this.w == 0) {
            ...
            a0 a0Var = this.A;
            if (a0Var != null) {
                arrayList.add(ObjectAnimator.ofFloat(a0Var, (Property<a0, Float>) property, 0.0f));
            }
        }
        int i11 = this.w;
        if (i11 == 0) {
        ...
        if (imageView != null) {
            ...
            this.e.setBackgroundDrawable(g6.f0(this.m0, 1, -1));
        }
    }
    ...
    public final void b() {
        if (this.i1) {
            ...
            int i10 = this.l1;
            c6 c6Var = this.E0;
            int v02 = i10 == -1 ? 0 : g6.v0(i10, c6Var);
            int i11 = this.k1;
            int v03 = i11 == -1 ? 0 : g6.v0(i11, c6Var);
            if (v03 == 0) {
                v03 = i0.a.k(v02, 0);
            }
            if (v02 == 0) {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        int i11 = this.d1 ? this.b1 : (int) this.Z0.e;
        if (this.e1) {
            i11 = Math.max((int) ((1.0f - this.W0) * this.c1), i11);
        }
        ImageView imageView = this.e;
        ...
        if (dVar == null || this.L0) {
            ...
            xn xnVar = this.N0;
            vd.a aVar2 = this.Y0;
            int lerp = AndroidUtilities.lerp(i14, max, xnVar == null ? 0.0f : f9 - aVar2.e);
            int lerp2 = AndroidUtilities.lerp(z10 ? i15 : 0, i15, this.N0 == null ? 0.0f : f9 - aVar2.e);
            int width = getWidth() - lerp;
            int i16 = width - lerp2;
            if (this.N0 != null) {
                int lerp3 = AndroidUtilities.lerp(Math.min(i16, ((int) this.X0.e) + i12), i16, Math.max(this.W0, actionModeFactor));
        ...
        ng.d dVar3 = this.c;
        if (dVar3 != null && i11 > 0 && !this.L0 && !this.g1) {
        ...
        if (this.G0 && this.x != 0) {
            ...
            if (this.i1) {
                hv0 hv0Var = this.F0;
                float y8 = getY();
                float f10 = f9 - this.n1;
                hv0Var.getClass();
                hv0Var.K(canvas, y8, this.I0, paint, true, AndroidUtilities.lerp(255, Color.alpha(g6.v0((hv0.F() && SharedConfig.getDevicePerformanceClass() == 2) ? g6.xf : g6.yf, hv0Var.getResourceProvider())), f10));
            } else {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (this.N0 != null && this.K0 && motionEvent.getAction() == 0) {
            ...
            ng.d dVar = this.a;
            boolean z10 = dVar != null && dVar.getBounds().contains(x4, y8);
            if (q6 != null && q6 != this.N0) {
                ng.d dVar2 = this.b;
                boolean z11 = z10 | (dVar2 != null && dVar2.getBounds().contains(x4, y8));
                ng.d dVar3 = this.c;
                z10 = z11 | (dVar3 != null && dVar3.getBounds().contains(x4, y8));
            }
            if (!z10) {
                return false;
            }
    ...
    */
    public boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (this.N && !this.e0 && !LocaleController.isRTL) {
            h5[] h5VarArr = this.n;
            if ((view == h5VarArr[0] || view == h5VarArr[1] || (view == this.B0 && this.C0)) && (y02 = g6.y0()) != null) {
                ...
                if (h5Var != null && h5Var.getVisibility() == 0 && (h5Var.getText() instanceof String)) {
                    ...
                    int width = ((this.S.width() - (y02.getIntrinsicWidth() + g6.D1)) / 2) + h5Var.getTextStartX() + g6.D1;
                    f9 = 255.0f;
                ...
                if (sv0Var != null) {
                    ...
                    if (l00Var != null) {
                        ...
                        ArrayList arrayList2 = l00Var.c;
                        if (canvas != null) {
                            int size = arrayList2.size();
                            for (int i10 = 0; i10 < size; i10++) {
                                k00 k00Var2 = (k00) arrayList2.get(i10);
                                Paint paint = k00Var2.k.a;
                                paint.setColor(k00Var2.j);
                                paint.setStrokeWidth(AndroidUtilities.dp(1.5f) * k00Var2.i);
                                paint.setAlpha((int) (k00Var2.f * f9));
                                canvas.drawPoint(k00Var2.a, k00Var2.b, paint);
                            }
                            if (Utilities.random.nextBoolean()) {
                                if (arrayList2.size() + 8 < 150) {
                                    ...
                                    float nextFloat2 = (Utilities.random.nextFloat() * org.telegram.messenger.x3.B(20.0f, getMeasuredHeight(), i11)) + i11;
                                    ...
                                    for (int i14 = 8; i13 < i14; i14 = 8) {
                                        ...
                                        if (arrayList.isEmpty()) {
                                            k00Var = new k00(l00Var);
                                        } else {
                                            k00Var = (k00) arrayList.get(0);
                                            arrayList.remove(0);
                                        }
                                        k00Var.a = f10;
                                        k00Var.b = nextFloat2;
                                        ...
                                        k00Var.f = 1.0f;
                                        k00Var.h = 0.0f;
                                        k00Var.i = Math.max(1.0f, Utilities.random.nextFloat() * 1.5f);
                                        k00Var.g = Utilities.random.nextInt(MediaDataController.MAX_STYLE_RUNS_COUNT) + MediaDataController.MAX_STYLE_RUNS_COUNT;
                                        k00Var.e = (Utilities.random.nextFloat() * 4.0f) + 20.0f;
                            ...
                            long min = Math.min(17L, currentTimeMillis - l00Var.b);
                            int size2 = arrayList2.size();
                            while (i15 < size2) {
                                k00 k00Var3 = (k00) arrayList2.get(i15);
                                float f11 = k00Var3.h;
                                float f12 = k00Var3.g;
                                if (f11 >= f12) {
                                    if (arrayList.size() < 40) {
                                        arrayList.add(k00Var3);
                                    }
                                    ...
                                    k00Var3.f = 1.0f - AndroidUtilities.decelerateInterpolator.getInterpolation(f11 / f12);
                                    float f13 = k00Var3.a;
                                    float f14 = k00Var3.c;
                                    float f15 = k00Var3.e;
                                    float f16 = min;
                                    z11 = M;
                                    k00Var3.a = a4.w.d(f14 * f15, f16, 500.0f, f13);
                                    float f17 = k00Var3.b;
                                    float f18 = k00Var3.d;
                                    k00Var3.b = (((f15 * f18) * f16) / 500.0f) + f17;
                                    k00Var3.d = (f16 / 100.0f) + f18;
                                    k00Var3.h += f16;
                                }
                                i15++;
                                M = z11;
    ...
    public final void f() {
        ...
        Drawable drawable = imageView.getDrawable();
        int i10 = ((drawable instanceof h2) || (drawable instanceof c5)) ? 2 : 0;
    ...
    public final void g() {
        a0 a0Var = this.A;
        int max = Math.max(0, a0Var != null ? (a0Var.getItemsWidth() - AndroidUtilities.dp(1.0f)) - AndroidUtilities.dp(1.0f) : 0);
        e eVar = this.B;
        int max2 = Math.max(0, eVar != null ? (eVar.getItemsWidth() - AndroidUtilities.dp(1.0f)) - AndroidUtilities.dp(1.0f) : 0);
    ...
    public final a0 j(String str) {
        ...
        this.B = eVar2;
        eVar2.setTranslationX(this.K0 ? -AndroidUtilities.dp(10.0f) : 0.0f);
        this.B.setGlassMode(this.K0);
        e eVar3 = this.B;
        eVar3.c = true;
        eVar3.setClickable(true);
        if (!this.K0) {
            this.B.setBackgroundColor(g6.v0(g6.w8, this.E0));
        }
    ...
    public final void l() {
        ...
        this.s.setTextColor(g6.v0(g6.B8, this.E0));
        addView(this.s, 0, i7.f6.e(-2, -2, 51));
    }
    ...
    public final void m() {
        ...
        this.e.setBackgroundDrawable(g6.f0(this.l0, 1, -1));
        this.e.setPadding(AndroidUtilities.dp(1.0f), 0, 0, 0);
        addView(this.e, i7.f6.e(54, 54, 51));
    ...
    public final void o() {
        ...
        this.r.setTextColor(g6.v0(g6.B8, this.E0));
        addView(this.r, 0, i7.f6.e(-2, -2, 51));
    }
    ...
    public final void onAttachedToWindow() {
        ...
        Drawable drawable = this.W;
        if (drawable instanceof org.telegram.ui.Components.n5) {
            ((org.telegram.ui.Components.n5) drawable).l(this.n[0]);
        }
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        Drawable y02;
        if (this.N && !this.e0 && !LocaleController.isRTL && motionEvent.getAction() == 0 && (y02 = g6.y0()) != null && y02.getBounds().contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
            this.R = true;
            sv0 sv0Var = this.O;
            h5[] h5VarArr = this.n;
            if (sv0Var == null) {
    ...
    */
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (a0Var != null && a0Var.getVisibility() != 8) {
            ...
            a0 a0Var2 = this.A;
            a0Var2.layout(dp2, i19, a0Var2.getMeasuredWidth() + dp2, this.A.getMeasuredHeight() + i19);
        }
        int i21 = 0;
        while (true) {
            h5VarArr = this.n;
            ...
            if (h5Var != null && h5Var.getVisibility() != 8) {
                boolean z11 = this.u0;
                if (((z11 && i21 == 0) || (!z11 && i21 == 1)) && this.s0 && this.t0) {
        ...
        if (this.h1 != null) {
            ...
            iVar.layout(i20, i23, iVar.getMeasuredWidth() + i20, this.h1.getMeasuredHeight() + i23);
        }
        h5 h5Var4 = this.r;
        ...
        t9 t9Var = this.f;
        if (t9Var != null) {
            t9Var.layout(AndroidUtilities.dp(64.0f), ((getCurrentActionBarHeight() - this.f.getMeasuredHeight()) / 2) + i19, this.f.getMeasuredWidth() + AndroidUtilities.dp(64.0f), ((this.f.getMeasuredHeight() + getCurrentActionBarHeight()) / 2) + i19);
        }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        e eVar = lVar.B;
        if (eVar != null) {
            eVar.setPadding(0, lVar.E ? AndroidUtilities.statusBarHeight : 0, 0, 0);
        }
        lVar.D = false;
        lVar.setMeasuredDimension(size, currentActionBarHeight + (lVar.E ? AndroidUtilities.statusBarHeight : 0) + lVar.K);
        ImageView imageView = lVar.e;
        if (imageView == null || imageView.getVisibility() == 8) {
            dp = AndroidUtilities.dp(AndroidUtilities.isTablet() ? 26.0f : 18.0f);
        } else {
            lVar.e.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(54.0f), TLObject.FLAG_30), makeMeasureSpec2);
        ...
        if (a0Var != null && a0Var.getVisibility() != 8) {
            float f9 = 66.0f;
            if (lVar.A.p() && !lVar.j0) {
                lVar.A.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_31), makeMeasureSpec2);
                int l10 = lVar.A.l();
                if (lVar.i0) {
                    f9 = 0.0f;
                ...
                makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(lVar.A.l() + (size - AndroidUtilities.dp(f9)), TLObject.FLAG_30);
                if (!lVar.y) {
                    lVar.A.r(-l10);
                }
            } else if (lVar.j0) {
                ...
                makeMeasureSpec = org.telegram.ui.b.d(f9, size, TLObject.FLAG_30);
                if (!lVar.y) {
                    lVar.A.r(0.0f);
                }
            } else {
        ...
        while (true) {
            ...
            h5 h5Var3 = h5VarArr[0];
            if ((h5Var3 != null && h5Var3.getVisibility() != 8) || ((h5Var = lVar.r) != null && h5Var.getVisibility() != 8)) {
                a0 a0Var2 = lVar.A;
                int max = Math.max(org.telegram.messenger.x3.B(16.0f, size - (a0Var2 != null ? a0Var2.getMeasuredWidth() : 0), dp) - lVar.T, 0);
                boolean z10 = lVar.u0;
                int i14 = 20;
                if (((z10 && i13 == 0) || (!z10 && i13 == i12)) && lVar.s0 && lVar.t0) {
                    ...
                    if (h5Var5 == null || h5Var5.getVisibility() == 8 || (h5Var2 = lVar.r) == null || h5Var2.getVisibility() == 8) {
                        ...
                        if (h5Var8 != null && h5Var8.getVisibility() != 8) {
                            lVar.r.setTextSize((AndroidUtilities.isTablet() || lVar.getResources().getConfiguration().orientation != 2) ? 16 : 14);
                        }
                        h5 h5Var9 = lVar.s;
                        if (h5Var9 != null) {
                            h5Var9.setTextSize((AndroidUtilities.isTablet() || lVar.getResources().getConfiguration().orientation != 2) ? 16 : 14);
                        }
                    } else {
                        ...
                        lVar.r.setTextSize(AndroidUtilities.isTablet() ? 16 : 14);
                        h5 h5Var11 = lVar.s;
                        if (h5Var11 != null) {
                ...
                if (h5Var14 != null && h5Var14.getVisibility() != 8) {
                    lVar.r.measure(View.MeasureSpec.makeMeasureSpec(max, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_31));
                }
                lh.i iVar = lVar.h1;
                if (iVar != null) {
                ...
                if (h5Var15 != null && h5Var15.getVisibility() != 8) {
                    lVar.s.measure(View.MeasureSpec.makeMeasureSpec(max, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_31));
                }
            }
            i13++;
            i12 = 1;
        ...
        t9 t9Var = lVar.f;
        if (t9Var != null) {
            t9Var.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(42.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(42.0f), TLObject.FLAG_30));
        }
        int childCount = lVar.getChildCount();
        int i15 = 0;
        while (i15 < childCount) {
            View childAt = lVar.getChildAt(i15);
            if (childAt.getVisibility() != 8 && childAt != h5VarArr[0] && childAt != h5VarArr[1] && childAt != lVar.h1 && childAt != lVar.r && childAt != lVar.A && childAt != lVar.e && childAt != lVar.s && childAt != lVar.f) {
                lVar.measureChildWithMargins(childAt, i10, 0, View.MeasureSpec.makeMeasureSpec(lVar.getMeasuredHeight(), TLObject.FLAG_30), 0);
            }
            i15++;
            lVar = this;
        }
    ...
    public final void p(int i10) {
        ...
        if (this.C0) {
            this.B0.addView(h5VarArr[i10], 0, i7.f6.e(-2, -2, 51));
        } else {
            addView(h5VarArr[i10], 0, i7.f6.e(-2, -2, 51));
        }
    }
    ...
    public void r() {
        ...
        ArrayList arrayList = new ArrayList();
        Property property = View.ALPHA;
        arrayList.add(ObjectAnimator.ofFloat(this.B, (Property<e, Float>) property, 0.0f));
        if (this.M != null) {
            int i12 = 0;
            while (true) {
                View[] viewArr = this.M;
        ...
        a0 a0Var = this.A;
        if (a0Var != null) {
            arrayList.add(ObjectAnimator.ofFloat(a0Var, (Property<a0, Float>) property, 1.0f));
        }
        int i13 = this.x;
        if (i13 == 0 || this.K0) {
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needCheckSystemBarColors, new Object[0]);
        ...
        this.L.setDuration(200L);
        this.L.addListener(new f(this, i10));
        this.L.start();
        if (!this.j0) {
            h5 h5Var2 = h5VarArr[0];
            if (h5Var2 != null) {
    ...
    public void setAdaptiveBackground(RecyclerView recyclerView) {
        y(recyclerView, false, g6.a7, g6.s8);
    }
    ...
    public void setOccupyStatusBar(boolean z10) {
        ...
        e eVar = this.B;
        if (eVar != null) {
            eVar.setPadding(0, z10 ? AndroidUtilities.statusBarHeight : 0, 0, 0);
        }
    }
    ...
    public void v(boolean z10) {
        ...
        while (true) {
            ...
            animatorSet2.playTogether(ObjectAnimator.ofFloat(view, (Property<View, Float>) View.SCALE_X, f9));
            i10++;
        }
        t9 t9Var = this.f;
        if (t9Var != null) {
            t9Var.setVisibility(0);
            this.R0.playTogether(ObjectAnimator.ofFloat(this.f, (Property<t9, Float>) property, z10 ? 1.0f : 0.0f));
        }
        this.v0 = true;
        requestLayout();
