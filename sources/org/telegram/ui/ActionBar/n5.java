...
public final /* synthetic */ class n5 implements Runnable {
    ...
    public /* synthetic */ n5(int i10, TLObject tLObject) {
        this.a = 0;
        this.c = i10;
        this.b = tLObject;
    }
    ...
    */
            ...
            case 0:
                ...
                if (tLObject instanceof TL_account.TL_themes) {
                    ...
                    while (i16 < size) {
                        ...
                        if (i6Var2.C == null || i6Var2.B != i15) {
                            obj = obj2;
                            if (i6Var2.Y != null) {
                                for (int i17 = 0; i17 < i6Var2.Y.size(); i17++) {
                                    h6 h6Var = (h6) i6Var2.Y.get(i17);
                        ...
                        if (tL_theme != null) {
                            ...
                            if (arrayList5 == null || arrayList5.size() <= 0) {
                                ...
                                if (i6Var3 == null) {
                                    i6Var3 = new i6();
                                    i6Var3.B = i15;
                                    i6Var3.b = new File(ApplicationLoader.getFilesDirFixed(), vh.w2.k(str, ".attheme")).getAbsolutePath();
                                ...
                                while (i19 < tL_theme.settings.size()) {
                                    ...
                                    if (themeSettings == null || (q02 = j6.q0(themeSettings)) == null || (i6Var = (i6) hashMap.get(q02)) == null) {
                                        ...
                                        if (i6Var.Y != null) {
                                            ...
                                            i13 = i18;
                                            h6 h6Var2 = (h6) i6Var.Z.get(tL_theme.id);
                                            if (h6Var2 != null) {
                                                if (i6.a(h6Var2, themeSettings)) {
                                                    ...
                                                    i6 i6Var4 = j6.I;
                                                    if (i6Var4 == i6Var && i6Var4.V == h6Var2.a) {
                                                        j6.n1(false, false);
                    ...
                    j6.s1(true, false);
                    Collections.sort(j6.F, new nh.e4(6));
                    if (z11) {
    ...
    public /* synthetic */ n5(int i10, TLObject tLObject, int i11) {
        this.a = i11;
        this.b = tLObject;
        this.c = i10;
    }
