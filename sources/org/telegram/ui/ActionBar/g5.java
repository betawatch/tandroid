...
public class g5 extends Drawable {
    ...
    public final void a() {
        ...
        if (this.a instanceof BitmapShader) {
            ...
            if (z4 && (bitmap = this.L) != null) {
                ...
                Bitmap bitmap2 = dc0VarArr[c3].k;
                float min2 = 1.0f / Math.min(bitmap2.getWidth() / dc0VarArr[c3].getBounds().width(), bitmap2.getHeight() / dc0VarArr[c3].getBounds().height());
    ...
    public final dc0 i() {
        ...
        return dc0VarArr[this.l == 2 ? (char) 1 : (char) 0];
    }
                    ...
                    if (dc0Var != null) {
                        ...
                        if (!z12 && i19 != 0 && z11) {
                            if (i16 != this.b || this.M == null || this.e != g10 || this.f != i18 || this.g != i19 || this.h != i20 || this.i != z11) {
                                ...
                                if (dc0VarArr[c11] == null) {
                                    dc0 dc0Var2 = new dc0();
                                    dc0VarArr[c11] = dc0Var2;
                                    if (i22 != 2) {
                                        c10 = 1;
                                        dc0Var2.t = true;
                                    } else {
                                ...
                                iArr2[2] = i19;
                                iArr2[c3] = i20;
                                Utilities.generateGradient(bitmap2, dc0Var3.i, dc0Var3.e.getInterpolation(dc0Var3.h), iArr2);
                            ...
                            if (i19 != 0 && z11) {
                                if (dc0VarArr[c11] == null) {
                                    dc0 dc0Var4 = new dc0();
                                    dc0VarArr[c11] = dc0Var4;
                                    if (i22 != 2) {
                                        dc0Var4.t = true;
                                    }
                                    dc0Var4.w(b(1.0f));
                                }
                                dc0VarArr[c11].n(g10, i18, i19, i20);
                                this.a = dc0VarArr[c11].v;
                            } else if (i19 == 0) {
                        ...
                        if (this.a instanceof BitmapShader) {
                            i21 = 0;
                            dc0VarArr[c11].setBounds(0, i17, i11, i16 - i13);
                        } else {
                            i21 = 0;
                        }
                        this.b = i16;
