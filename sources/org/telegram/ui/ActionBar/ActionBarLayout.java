...
public class ActionBarLayout extends FrameLayout implements INavigationLayout, FloatingDebugProvider {
    ...
    static /* synthetic */ float access$1616(ActionBarLayout actionBarLayout, float f) {
    ...
    */
            ...
            if (Build.VERSION.SDK_INT >= 31 && !this.isSheet && (paddingRight != 0 || this.overrideWidthOffset != -1)) {
                if (view != this.containerView) {
                    ...
                    if (rootWindowInsets2 != null) {
                        ...
                        if (view != this.containerView) {
                            int clamp2 = MathUtils.clamp((i6 * NotificationCenter.cameraInitied) / AndroidUtilities.dp(20.0f), 0, NotificationCenter.cameraInitied);
                            if (clamp2 > 0) {
                                int i9 = getBottomTabsHeight(false) == 0 ? ((ViewGroup.MarginLayoutParams) view.getLayoutParams()).bottomMargin : 0;
                    ...
                    if (view == this.containerViewBack && rootWindowInsets != null) {
    ...
    private void animateBackEndAnimation(final boolean z) {
        ...
        if (!z) {
            ...
            int max2 = Math.max((int) ((320.0f / this.containerView.getMeasuredWidth()) * x), newBackTransitions() ? NotificationCenter.chatlistFolderUpdate : 120);
            if (!shouldOverrideSlideTransition) {
                long j2 = max2;
