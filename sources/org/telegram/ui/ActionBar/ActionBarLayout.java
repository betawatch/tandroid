...
public class ActionBarLayout extends FrameLayout implements c5, mg.b {
    ...
    public ActionBarLayout(Context context, boolean z10) {
        ...
        int i10 = 1;
        n7.a1 a1Var = new n7.a1(i10);
        a1Var.b = new SparseIntArray();
        a1Var.c = new int[]{h6.Aa, h6.Da, h6.Ea, h6.Fa, h6.ac, h6.Ca};
        this.d0 = a1Var;
    ...
    public static void a(ActionBarLayout actionBarLayout, boolean z10) {
        ...
        if (z10) {
            if (actionBarLayout.O0.size() >= 2) {
                ...
                n2 n2Var = (n2) org.telegram.ui.Cells.q3.g(2, actionBarLayout.O0);
            ...
            if (actionBarLayout.O0.size() > 0) {
                n2 n2Var3 = (n2) org.telegram.ui.Cells.q3.g(1, actionBarLayout.O0);
    ...
    */
    public final boolean R(a5 a5Var) {
        ...
        if (z13) {
            ...
            if (previewHeight > 0 && previewHeight < getMeasuredHeight() - i14) {
                ...
                if (actionBarPopupWindow$ActionBarPopupWindowLayout != null) {
                    layoutParams2.bottomMargin = org.telegram.messenger.z0.C(8.0f, i10, layoutParams2.bottomMargin);
                }
        ...
        if (this.A0 && this.O0.size() == 1) {
            ...
            this.W = true;
            this.z0 = new m4.g0(23, n2Var, n2Var2);
        ...
        if (!this.s.b && !this.v.b) {
            ...
            ji.g gVar = new ji.g(this, n2Var2, z13, i12);
            this.e = gVar;
    ...
    public final void b0(n2 n2Var, boolean z10) {
        if (this.O0.contains(n2Var)) {
            ...
            if (org.telegram.ui.Cells.q3.g(1, this.O0) == n2Var && this.O0.size() > 1) {
    ...
    */
    ...
    public final void e(boolean z10) {
        ...
        n2 n2Var = !this.O0.isEmpty() ? (n2) org.telegram.ui.Cells.q3.g(1, this.O0) : null;
        if (n2Var == null) {
            return;
        }
    ...
    */
    public final void f(b5 b5Var, Runnable runnable) {
        ...
        int i11 = b5Var.b;
        if (i11 != -1 && (g6Var = b5Var.a) != null) {
            g6Var.u(i11);
            h6.t1(b5Var.a, true, false, true, false, false);
        }
        if (runnable == null) {
            h6.t(b5Var.a, true, b5Var.c);
            c9Var.run();
            return;
        }
        g6 g6Var2 = b5Var.a;
        ...
        final ai.s4 s4Var = new ai.s4(strArr, g6Var2, z10, qVar, 9);
        String str = g6Var2.d;
        if (str != null) {
    ...
    public n2 getLastFragmentIncludeMainTabs() {
        n2 lastFragment = getLastFragment();
        return lastFragment instanceof zg0 ? ((zg0) lastFragment).X() : lastFragment;
    }
    ...
    public final void l(boolean z10, boolean z11) {
        ...
        if (lastFragment == null || !lastFragment.closeLastFragment()) {
            ...
            n2 n2Var2 = this.O0.size() > 1 ? (n2) org.telegram.ui.Cells.q3.g(2, this.O0) : null;
            if (n2Var2 != null) {
                AndroidUtilities.setLightStatusBar(activity, h6.w0(null, h6.s8, false) == -1 || (n2Var2.hasForceLightStatusBar() && !h6.A0().q()));
                w wVar = this.s;
                this.s = this.v;
                this.v = wVar;
                n2Var2.setParentLayout(this);
                ...
                this.v0 = System.currentTimeMillis();
                this.W = true;
                this.y0 = new m4.g0(22, this, n2Var);
    ...
    */
            ...
            if (this.O0.size() > 1 && ((sVar = this.G) == null || sVar.getLastSheet() == null || !this.G.getLastSheet().isShown())) {
                if (motionEvent == null || motionEvent.getAction() != 0) {
                    if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.x0) {
                        ...
                        } else if (((n2) org.telegram.ui.Cells.q3.g(1, this.O0)).canBeginSlide() && u(this, motionEvent.getX(), motionEvent.getY()) == null) {
                ...
                } else if (((n2) org.telegram.ui.Cells.q3.g(1, this.O0)).isSwipeBackEnabled(motionEvent)) {
    ...
    public final void r() {
        ...
        try {
            Activity activity = this.K0;
            if (h6.w0(null, h6.s8, false) != -1 && (!n2Var2.hasForceLightStatusBar() || h6.A0().q())) {
                z10 = false;
            }
    ...
    public final boolean s(Menu menu) {
        return !this.O0.isEmpty() && ((n2) org.telegram.ui.Cells.q3.g(1, this.O0)).extendActionMode(menu);
    }
