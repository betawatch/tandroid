...
public class ActionBarLayout extends FrameLayout implements INavigationLayout, FloatingDebugProvider {
    ...
    */
    ...
    public /* synthetic */ void drawHeaderShadow(Canvas canvas, int i) {
        drawHeaderShadow(canvas, NotificationCenter.suggestedLangpack, i);
    }
    ...
    */
                ...
                if (this.startedTracking) {
                    ...
                    if (z) {
                        ...
                        if (!shouldOverrideSlideTransition) {
                            long j = max2;
                            animatorSet.playTogether(ObjectAnimator.ofFloat(this.containerView, (Property<LayoutContainer, Float>) View.TRANSLATION_X, 0.0f).setDuration(j), ObjectAnimator.ofFloat(this, "innerTranslationX", 0.0f).setDuration(j));
    ...
    public boolean presentFragment(INavigationLayout.NavigationParams navigationParams) {
        ...
        if (this.useAlphaAnimations && this.fragmentsStack.size() == 1) {
            ...
            AnimatorSet onCustomTransitionAnimation = !z4 ? baseFragment2.onCustomTransitionAnimation(true, new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void setThemeAnimationValue(float f) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            while (i2 < size2) {
                ...
                int i3 = size;
                int argb = Color.argb(Math.min(NotificationCenter.suggestedLangpack, (int) (Color.alpha(iArr[i2]) + ((alpha - r2) * f))), Math.min(NotificationCenter.suggestedLangpack, (int) (red2 + ((red - red2) * f))), Math.min(NotificationCenter.suggestedLangpack, (int) (green2 + ((green - green2) * f))), Math.min(NotificationCenter.suggestedLangpack, (int) (blue2 + ((blue - blue2) * f))));
