...
public final class k3 {
    ...
    public final void a(Canvas canvas, RectF rectF, float f7, float f10, float f11) {
        ...
        paint.setShadowLayer(AndroidUtilities.dp(2.33f), 0.0f, AndroidUtilities.dp(1.0f), h6.l1(f10, TLObject.FLAG_28));
        float[] fArr = this.w;
        fArr[3] = f7;
        fArr[2] = f7;
        fArr[1] = f7;
        ...
        if (f13 > 0.0f && this.v > 0.0f && f10 > 0.0f) {
            ...
            int l1 = h6.l1(0.07f * f10 * this.v, AndroidUtilities.computePerceivedBrightness(d) > 0.721f ? -16777216 : -1);
            Paint paint2 = this.g;
            paint2.setColor(l1);
        ...
        if (f01Var != null) {
            ...
            f01Var.c(rectF.left + AndroidUtilities.dp(60.0f) + i10, rectF.centerY(), org.telegram.messenger.z0.A(1.0f, this.v, f10, f11), d10, canvas2);
        }
