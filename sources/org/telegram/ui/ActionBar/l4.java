...
public final class l4 extends Animation {
    ...
    public /* synthetic */ l4(t4 t4Var, int i10, int i11, float f7, float f10, int i12) {
        this.a = i12;
        this.e = t4Var;
        this.b = i10;
        this.c = i11;
    ...
    public final void applyTransformation(float f7, Transformation transformation) {
        switch (this.a) {
            ...
            case 1:
                ...
                t4.l(relativeLayout2, ((int) (f7 * (i13 - i14))) + i14, relativeLayout2.getLayoutParams().height);
            ...
            default:
                ...
                t4.l(relativeLayout4, ((int) (f7 * (i18 - i19))) + i19, relativeLayout4.getLayoutParams().height);
    ...
    public /* synthetic */ l4(t4 t4Var, int i10, int i11, float f7, int i12) {
        this.a = i12;
        this.e = t4Var;
        this.b = i10;
        this.c = i11;
