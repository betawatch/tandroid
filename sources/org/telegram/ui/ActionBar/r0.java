        ...
        switch (this.a) {
            ...
            case 2:
                ...
                if (z11) {
                    ...
                    u9 u9Var = g31Var.y;
                    u9Var.layout(measuredWidth3, dp, u9Var.getMeasuredWidth() + measuredWidth3, g31Var.y.getMeasuredHeight() + dp);
                }
                if (g31Var.x.getVisibility() == 0) {
                    if (z11) {
        ...
        switch (this.a) {
            case 0:
                ...
                if (!LocaleController.isRTL) {
                    ...
                    measureChildWithMargins(w0Var.e, wl.d(12.0f, size2, 0), i12 + measuredWidth2, i11, 0);
                    this.b = false;
