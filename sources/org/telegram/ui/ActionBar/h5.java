...
public class h5 extends Drawable {
    ...
    public final void a() {
        ...
        if (this.a instanceof BitmapShader) {
            ...
            if (z4 && (bitmap = this.L) != null) {
                ...
                float min = 1.0f / Math.min(bitmap.getWidth() / fc0VarArr[c10].getBounds().width(), this.L.getHeight() / fc0VarArr[c10].getBounds().height());
                matrix.postScale(min, min);
            } else {
                if (!this.v) {
                    c3 = i10 == 2 ? (char) 1 : (char) 0;
                }
                Bitmap bitmap2 = fc0VarArr[c3].k;
                float min2 = 1.0f / Math.min(bitmap2.getWidth() / fc0VarArr[c3].getBounds().width(), bitmap2.getHeight() / fc0VarArr[c3].getBounds().height());
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (z4 || this.O != 0) {
            ...
            int i13 = i11;
            path2 = path;
            h5Var.e(path2, bounds, b11, i13, b12, i10, max, true, true, paint != null);
        } else {
            h5Var = this;
            path2 = path;
        }
        canvas.drawPath(path2, paint2);
        if (h5Var.a != null && h5Var.m && paint == null) {
            int k10 = i0.a.k(g(k6.bc), (int) ((Color.alpha(r15) * h5Var.F) / 255.0f));
    ...
    public final Drawable f() {
        ...
        boolean z11 = this.q;
        if (z10) {
            g10 = g(z11 ? k6.Ba : k6.dc);
        } else {
            g10 = g(z11 ? k6.Aa : k6.ra);
        }
        boolean z12 = (this.a != null || z10 || this.J) ? false : true;
        int g11 = g(z11 ? k6.Ca : k6.ta);
        boolean z13 = this.K;
        ...
        if (z13 != z12 || iArr4[c10][c3] != i12 || ((z12 && iArr3[c3] != g11) || iArr2[c10][c3] != g10)) {
            ...
            try {
                ...
                i10 = g10;
                try {
                    drawableArr2[c10][c3] = new NinePatchDrawable(createBitmap, c8.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i10).array(), new Rect(), null);
                    setBounds(rect);
    ...
    public int h(int i10) {
        ...
        g6 g6Var = this.p;
        return g6Var != null ? g6Var.Z0(i10) : k6.rl.get(i10);
    }
    ...
    public final fc0 i() {
        ...
        return fc0VarArr[this.l == 2 ? (char) 1 : (char) 0];
    }
    ...
    public final Drawable j() {
        ...
        if (i11 != b10) {
            ...
            try {
                ...
                drawableArr[c3] = new NinePatchDrawable(createBitmap, c8.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i10).array(), new Rect(), null);
                z10 = true;
            } catch (Throwable unused) {
            }
        }
        int g10 = g(this.q ? k6.Ca : k6.ta);
    ...
    public final Path m() {
        ...
        int max = Math.max(bounds.top, 0);
        boolean z11 = true;
        if (e3Var == null || bounds.height() >= this.b) {
    ...
    */
    public void o(int i10, int i11, int i12, int i13, int i14, int i15, boolean z4, boolean z10) {
        ...
        if (h5Var != null) {
            i16 = i12;
            i17 = i14;
            h5Var.o(i10, i11, i16, i13, i17, i15, z4, z10);
        } else {
            i16 = i12;
            i17 = i14;
        }
                    ...
                    if (fc0Var != null) {
                        ...
                        if (!z12 && i19 != 0 && z11) {
                            if (i16 != this.b || this.M == null || this.e != g10 || this.f != i18 || this.g != i19 || this.h != i20 || this.i != z11) {
                                ...
                                if (fc0VarArr[c11] == null) {
                                    fc0 fc0Var2 = new fc0();
                                    fc0VarArr[c11] = fc0Var2;
                                    if (i22 != 2) {
                                        c10 = 1;
                                        fc0Var2.t = true;
                                    } else {
                                ...
                                iArr2[2] = i19;
                                iArr2[c3] = i20;
                                Utilities.generateGradient(bitmap2, fc0Var3.i, fc0Var3.e.getInterpolation(fc0Var3.h), iArr2);
                            ...
                            if (i19 != 0 && z11) {
                                if (fc0VarArr[c11] == null) {
                                    fc0 fc0Var4 = new fc0();
                                    fc0VarArr[c11] = fc0Var4;
                                    if (i22 != 2) {
                                        fc0Var4.t = true;
                                    }
                                    fc0Var4.w(b(1.0f));
                                }
                                fc0VarArr[c11].n(g10, i18, i19, i20);
                                this.a = fc0VarArr[c11].v;
                            } else if (i19 == 0) {
                        ...
                        if (this.a instanceof BitmapShader) {
                            i21 = 0;
                            fc0VarArr[c11].setBounds(0, i17, i11, i16 - i13);
                        } else {
                            i21 = 0;
                        }
                        this.b = i16;
    ...
    public final void setAlpha(int i10) {
        ...
        if (i11 != i10 || paint.getAlpha() != i10) {
            ...
            paint.setAlpha(i10);
            if (this.q) {
                this.d.setAlpha((int) ((i10 / 255.0f) * Color.alpha(g(k6.bc))));
            }
        }
        if (this.a == null) {
            Drawable f10 = f();
