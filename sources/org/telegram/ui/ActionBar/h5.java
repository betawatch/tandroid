...
public class h5 extends View implements Drawable.Callback {
                ...
                if (this.E != null) {
                    ...
                    if (this.y != null) {
                        ...
                        if (indexOf >= 0) {
                            ...
                            org.telegram.ui.Cells.q2 q2Var = new org.telegram.ui.Cells.q2(this.y.getIntrinsicWidth());
                            int i15 = this.F;
    ...
    public final void e(Canvas canvas) {
        ...
        float f13 = -this.u0;
        float f14 = this.M;
        this.a = org.telegram.ui.Cells.c1.b(this.v0, f14, f13 * f14, f12);
        canvas.save();
        c(canvas);
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.a = 0.0f;
        this.b = 0.0f;
        boolean z20 = this.P && (this.Q || this.R != 0.0f);
        this.f0 = this.e0;
        Drawable drawable = this.v;
        if (drawable == null || this.k0) {
        ...
        if (this.w == null || this.C0 || this.H <= 0.0f || this.l0 || this.m0) {
            ...
            if ((this.n & 112) == 16) {
                z19 = (getMeasuredHeight() - intrinsicHeight) / 2;
                i18 = this.K;
            } else {
                z19 = hg.c.z(this.g0, intrinsicHeight, 2, getPaddingTop());
                i18 = this.K;
            }
            int i28 = z19 + i18;
            f7 = 0.0f;
        ...
        if (this.x != null && !this.C0 && this.H > f7 && !this.l0 && !this.m0) {
            ...
            if ((this.n & 112) == 16) {
                z18 = (getMeasuredHeight() - intrinsicHeight2) / 2;
                i17 = this.K;
            } else {
                z18 = hg.c.z(this.g0, intrinsicHeight2, 2, getPaddingTop());
                i17 = this.K;
            }
            int i31 = z18 + i17;
        ...
        if (f14 != f7) {
            ...
            if (this.w == null || this.l0) {
                ...
                if ((this.n & 112) == 16) {
                    z17 = (getMeasuredHeight() - intrinsicHeight3) / 2;
                    i16 = this.K;
                } else {
                    z17 = hg.c.z(this.g0, intrinsicHeight3, 2, getPaddingTop());
                    i16 = this.K;
                }
                int i34 = z17 + i16;
                f10 = 16.0f;
            ...
            if (this.x != null && !this.l0) {
                ...
                if ((this.n & 112) == 16) {
                    z16 = (getMeasuredHeight() - intrinsicHeight4) / 2;
                    i15 = this.K;
                } else {
                    z16 = hg.c.z(this.g0, intrinsicHeight4, 2, getPaddingTop());
                    i15 = this.K;
                }
                int i36 = z16 + i15;
        ...
        if (this.c != null) {
            ...
            if (this.w != null && !this.C0 && this.H > 0.0f && !this.l0 && this.m0) {
                ...
                if ((this.n & 112) == 16) {
                    z15 = (getMeasuredHeight() - intrinsicHeight5) / 2;
                    i14 = this.K;
                } else {
                    z15 = hg.c.z(this.g0, intrinsicHeight5, 2, getPaddingTop());
                    i14 = this.K;
                }
                int i43 = z15 + i14;
            ...
            if (this.x != null && !this.C0 && this.H > 0.0f && !this.l0 && this.m0) {
                ...
                if ((this.n & 112) == 16) {
                    z14 = (getMeasuredHeight() - intrinsicHeight6) / 2;
                    i13 = this.K;
                } else {
                    z14 = hg.c.z(this.g0, intrinsicHeight6, 2, getPaddingTop());
                    i13 = this.K;
                }
                int i46 = z14 + i13;
            ...
            if (!this.P || (!this.Q && this.R == 0.0f)) {
                ...
                if (i47 > 0) {
                    ...
                    if (this.R < AndroidUtilities.dp(100.0f)) {
                        b10 = a4.a.e(this.R, AndroidUtilities.dp(100.0f), 20.0f, 30.0f);
                        z13 = true;
                    } else {
                        z13 = true;
            ...
            Emoji.emojiDrawingUseAlpha = z13;
            if (this.k0 || this.l0 || this.n0 || this.r0 > 0) {
                canvas.restore();
            }
        }
        ...
        if (drawable8 != null && this.k0) {
            ...
            if ((this.n & 112) == 16) {
                z12 = (getMeasuredHeight() - intrinsicHeight7) / 2;
                i12 = this.J;
            } else {
                z12 = hg.c.z(this.g0, intrinsicHeight7, 2, getPaddingTop());
                i12 = this.J;
            }
            int i48 = z12 + i12;
        ...
        if (this.w != null && this.l0) {
            ...
            if ((this.n & 112) == 16) {
                z11 = (getMeasuredHeight() - intrinsicHeight8) / 2;
                i11 = this.K;
            } else {
                z11 = hg.c.z(this.g0, intrinsicHeight8, 2, getPaddingTop());
                i11 = this.K;
            }
            int i50 = z11 + i11;
        ...
        if ((this.n & 112) == 16) {
            z10 = (getMeasuredHeight() - intrinsicHeight9) / 2;
            i10 = this.K;
        } else {
            z10 = hg.c.z(this.g0, intrinsicHeight9, 2, getPaddingTop());
            i10 = this.K;
        }
        int i52 = z10 + i10;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if ((this.n & 112) == 16) {
            this.d0 = hg.c.z((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), this.g0, 2, getPaddingTop());
        } else {
            this.d0 = getPaddingTop();
        }
    }
