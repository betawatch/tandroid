...
public class h5 extends Drawable {
    ...
    public h5(int i10, boolean z10, boolean z11, f6 f6Var) {
        this.p = f6Var;
        this.q = z10;
        this.l = i10;
        this.m = z11;
    ...
    public final void a() {
        ...
        if (this.a instanceof BitmapShader) {
            ...
            if (z10 && (bitmap = this.L) != null) {
                ...
                float min = 1.0f / Math.min(bitmap.getWidth() / lc0VarArr[c11].getBounds().width(), this.L.getHeight() / lc0VarArr[c11].getBounds().height());
                matrix.postScale(min, min);
            } else {
                if (!this.v) {
                    c10 = i10 == 2 ? (char) 1 : (char) 0;
                }
                Bitmap bitmap2 = lc0VarArr[c10].k;
                float min2 = 1.0f / Math.min(bitmap2.getWidth() / lc0VarArr[c10].getBounds().width(), bitmap2.getHeight() / lc0VarArr[c10].getBounds().height());
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (paint == null && this.a == null && this.O == 0 && this.P <= 0.0f && (f7 = f()) != null) {
            f7.setBounds(bounds);
            f7.draw(canvas);
            return;
        }
        ...
        if (h5Var.a != null && h5Var.m && paint == null) {
            int k10 = i0.a.k(g(j6.bc), (int) ((Color.alpha(r15) * h5Var.F) / 255.0f));
    ...
    public final Drawable f() {
        ...
        int[] iArr3 = this.z;
        int[][] iArr4 = this.A;
        if (z14 != z13 || iArr4[c11][c10] != i12 || ((z13 && iArr3[c10] != g11) || iArr2[c11][c10] != g10)) {
            iArr4[c11][c10] = i12;
            try {
                ...
                i10 = g10;
                try {
                    drawableArr2[c11][c10] = new NinePatchDrawable(createBitmap, j7.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i10).array(), new Rect(), null);
                    setBounds(rect);
    ...
    public final lc0 i() {
        ...
        return lc0VarArr[this.l == 2 ? (char) 1 : (char) 0];
    }
    ...
    public final Drawable j() {
        ...
        if (i11 != b10) {
            ...
            try {
                ...
                drawableArr[c10] = new NinePatchDrawable(createBitmap, j7.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i10).array(), new Rect(), null);
                z11 = true;
            } catch (Throwable unused) {
            }
        }
    ...
    */
    public void o(int i10, int i11, int i12, int i13, int i14, int i15, boolean z10, boolean z11) {
        ...
        if (h5Var != null) {
            i16 = i12;
            i17 = i14;
            h5Var.o(i10, i11, i16, i13, i17, i15, z10, z11);
        } else {
            i16 = i12;
            i17 = i14;
        }
                    ...
                    if (lc0Var != null) {
                        ...
                        if (!z13 && i19 != 0 && z12) {
                            if (i16 != this.b || this.M == null || this.e != g10 || this.f != i18 || this.g != i19 || this.h != i20 || this.i != z12) {
                                ...
                                if (lc0VarArr[c12] == null) {
                                    lc0 lc0Var2 = new lc0();
                                    lc0VarArr[c12] = lc0Var2;
                                    if (i22 != 2) {
                                        c11 = 1;
                                        lc0Var2.t = true;
                                    } else {
                                ...
                                iArr2[2] = i19;
                                iArr2[c10] = i20;
                                Utilities.generateGradient(bitmap2, lc0Var3.i, lc0Var3.e.getInterpolation(lc0Var3.h), iArr2);
                            ...
                            if (i19 != 0 && z12) {
                                if (lc0VarArr[c12] == null) {
                                    lc0 lc0Var4 = new lc0();
                                    lc0VarArr[c12] = lc0Var4;
                                    if (i22 != 2) {
                                        lc0Var4.t = true;
                                    }
                                    lc0Var4.w(b(1.0f));
                                }
                                lc0VarArr[c12].n(g10, i18, i19, i20);
                                this.a = lc0VarArr[c12].v;
                            } else if (i19 == 0) {
                        ...
                        if (this.a instanceof BitmapShader) {
                            i21 = 0;
                            lc0VarArr[c12].setBounds(0, i17, i11, i16 - i13);
                        } else {
                            i21 = 0;
                        }
                        this.b = i16;
