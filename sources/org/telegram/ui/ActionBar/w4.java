...
public final class w4 {
    ...
    public final void g() {
        ...
        if (z4) {
            ...
            this.N = false;
            n();
            hb1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.u).setDuration(100L).start();
    ...
    public final void k() {
        ...
        if (z4) {
            ...
            if (this.M) {
                ...
                hb1Var.setY(r2.getHeight() - relativeLayout.getHeight());
