...
public final class w4 {
    ...
    public w4(y4 y4Var, Context context, View view) {
        ...
        if (i12 == 0) {
            ...
            if (i12 == 2) {
                ...
                int i15 = j6.i6;
                s4Var.setBackground(j6.f0(j6.v0(i15, f6Var), 1, -1));
        ...
        v4Var.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: org.telegram.ui.ActionBar.n4
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view3, int i16, long j10) {
                w4 w4Var = w4.this;
                w4Var.getClass();
                MenuItem menuItem = (MenuItem) v4Var.getAdapter().getItem(i16);
                y4 y4Var2 = w4Var.Q;
                if (y4Var2.j == null || !y4.r.contains(Integer.valueOf(menuItem.getItemId()))) {
        ...
        this.v = animatorSet;
        this.w = y4.a(relativeLayout3, ImageReceiver.DEFAULT_CROSSFADE_DURATION, new t4(this, 0));
        this.x = y4.a(relativeLayout3, 0, new t4(this, i16));
    }

    public static void a(w4 w4Var) {
        FrameLayout frameLayout = w4Var.i;
        RelativeLayout relativeLayout = w4Var.f;
        if (w4Var.M) {
            w4Var.g.setY(relativeLayout.getHeight() - w4Var.J.getHeight());
    ...
    public static boolean b(w4 w4Var) {
        AnimationSet animationSet = w4Var.z;
        AnimationSet animationSet2 = w4Var.y;
    ...
    public final void g() {
        ...
        if (z4) {
            ...
            int i10 = 0;
            o4 o4Var2 = new o4(this, this.J.getHeight(), relativeLayout.getHeight(), relativeLayout.getY() + relativeLayout.getHeight(), i10);
            float x11 = frameLayout.getX();
            p4 p4Var = new p4(this, x11, (width2 + x11) - s4Var.getWidth(), width2, i10);
            ...
            this.N = false;
            n();
            pb1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.u).setDuration(100L).start();
        ...
        this.N = true;
        n();
        pb1Var.animate().alpha(0.0f).withLayer().setInterpolator(interpolator).setDuration(250L).start();
    ...
    public final void k() {
        ...
        if (z4) {
            ...
            pb1Var.setX(-relativeLayout.getX());
            frameLayout.setX(0.0f);
            v4Var.setX(0.0f);
            if (this.M) {
                relativeLayout.setY(i11);
                pb1Var.setY(r2.getHeight() - relativeLayout.getHeight());
        ...
        v4Var.setX(r2.getWidth() - this.I.getWidth());
        if (this.M) {
            relativeLayout.setY((this.I.getHeight() + i11) - r2.getHeight());
            pb1Var.setY(0.0f);
            frameLayout.setY(0.0f);
            v4Var.setY(r2.getHeight() - this.I.getHeight());
            return;
        }
        relativeLayout.setY(i11);
        pb1Var.setY(0.0f);
