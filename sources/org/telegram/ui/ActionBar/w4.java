...
public final class w4 extends ListView {
    ...
    public w4(x4 x4Var) {
        ...
        int[] iArr = new int[8];
        PathInterpolator pathInterpolator = xf.z.i;
        xf.z.a(pathInterpolator, -16777216, iArr);
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        LinearGradient linearGradient = new LinearGradient(0.0f, dp, 0.0f, 0.0f, iArr, (float[]) null, tileMode);
        float dp2 = AndroidUtilities.dp(16.0f);
        int[] iArr2 = new int[8];
        xf.z.a(pathInterpolator, -16777216, iArr2);
    ...
    public final void onMeasure(int i10, int i11) {
        x4 x4Var = this.a;
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(x4Var.I.getHeight() - x4Var.H.getHeight(), TLObject.FLAG_30));
    }
