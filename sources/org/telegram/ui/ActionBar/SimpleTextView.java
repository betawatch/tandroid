...
public class SimpleTextView extends View implements Drawable.Callback {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int saveLayerAlpha = (z || this.ellipsizeByGradient) ? canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), NotificationCenter.didApplyNewTheme, 31) : TLObject.FLAG_31;
        ...
        if (this.layout != null) {
            ...
            if (z) {
                if (this.scrollingOffset < AndroidUtilities.dp(10.0f)) {
                    ...
                    this.fadePaint.setAlpha(NotificationCenter.didApplyNewTheme);
                }
