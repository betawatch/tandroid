...
public class d5 extends Drawable {
    ...
    public final void a() {
        ...
        if (this.a instanceof BitmapShader) {
            ...
            if (z10 && (bitmap = this.L) != null) {
                ...
                float min = 1.0f / Math.min(bitmap.getWidth() / nb0VarArr[c11].getBounds().width(), this.L.getHeight() / nb0VarArr[c11].getBounds().height());
                matrix.postScale(min, min);
            } else {
                if (!this.v) {
                    c10 = i10 == 2 ? (char) 1 : (char) 0;
                }
                Bitmap bitmap2 = nb0VarArr[c10].k;
                float min2 = 1.0f / Math.min(bitmap2.getWidth() / nb0VarArr[c10].getBounds().width(), bitmap2.getHeight() / nb0VarArr[c10].getBounds().height());
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (d5Var.a != null && d5Var.m && paint == null) {
            int k10 = i0.b.k(g(g6.bc), (int) ((Color.alpha(r15) * d5Var.F) / 255.0f));
    ...
    public final Drawable f() {
        ...
        if (z14 != z13 || iArr4[c11][c10] != i12 || ((z13 && iArr3[c10] != g11) || iArr2[c11][c10] != g10)) {
            ...
            try {
                ...
                i10 = g10;
                try {
                    drawableArr2[c11][c10] = new NinePatchDrawable(createBitmap, l6.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i10).array(), new Rect(), null);
                    setBounds(rect);
    ...
    public final nb0 i() {
        ...
        return nb0VarArr[this.l == 2 ? (char) 1 : (char) 0];
    }
    ...
    public final Drawable j() {
        ...
        if (i11 != b10) {
            ...
            try {
                ...
                drawableArr[c10] = new NinePatchDrawable(createBitmap, l6.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i10).array(), new Rect(), null);
                z11 = true;
            } catch (Throwable unused) {
            }
        }
                    ...
                    if (nb0Var != null) {
                        ...
                        if (!z13 && i19 != 0 && z12) {
                            if (i16 != this.b || this.M == null || this.e != g10 || this.f != i18 || this.g != i19 || this.h != i20 || this.i != z12) {
                                ...
                                if (nb0VarArr[c12] == null) {
                                    nb0 nb0Var2 = new nb0();
                                    nb0VarArr[c12] = nb0Var2;
                                    if (i22 != 2) {
                                        c11 = 1;
                                        nb0Var2.t = true;
                                    } else {
                                ...
                                iArr2[2] = i19;
                                iArr2[c10] = i20;
                                Utilities.generateGradient(bitmap2, nb0Var3.i, nb0Var3.e.getInterpolation(nb0Var3.h), iArr2);
                            ...
                            if (i19 != 0 && z12) {
                                if (nb0VarArr[c12] == null) {
                                    nb0 nb0Var4 = new nb0();
                                    nb0VarArr[c12] = nb0Var4;
                                    if (i22 != 2) {
                                        nb0Var4.t = true;
                                    }
                                    nb0Var4.w(b(1.0f));
                                }
                                nb0VarArr[c12].n(g10, i18, i19, i20);
                                this.a = nb0VarArr[c12].v;
                            } else if (i19 == 0) {
                        ...
                        if (this.a instanceof BitmapShader) {
                            i21 = 0;
                            nb0VarArr[c12].setBounds(0, i17, i11, i16 - i13);
                        } else {
                            i21 = 0;
                        }
                        this.b = i16;
