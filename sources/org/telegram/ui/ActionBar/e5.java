...
public class e5 extends Drawable {
    ...
    public final void a() {
        ...
        if (this.a instanceof BitmapShader) {
            ...
            if (z10 && (bitmap = this.L) != null) {
                ...
                float min = 1.0f / Math.min(bitmap.getWidth() / bc0VarArr[c11].getBounds().width(), this.L.getHeight() / bc0VarArr[c11].getBounds().height());
                matrix.postScale(min, min);
            } else {
                if (!this.v) {
                    c10 = i10 == 2 ? (char) 1 : (char) 0;
                }
                Bitmap bitmap2 = bc0VarArr[c10].k;
                float min2 = 1.0f / Math.min(bitmap2.getWidth() / bc0VarArr[c10].getBounds().width(), bitmap2.getHeight() / bc0VarArr[c10].getBounds().height());
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (z10 || this.O != 0) {
            ...
            int i13 = i11;
            path2 = path;
            e5Var.e(path2, bounds, b11, i13, b12, i10, max, true, true, paint != null);
        } else {
            e5Var = this;
            path2 = path;
        }
        canvas.drawPath(path2, paint2);
        if (e5Var.a != null && e5Var.m && paint == null) {
            int k10 = i0.a.k(g(h6.bc), (int) ((Color.alpha(r15) * e5Var.F) / 255.0f));
    ...
    public final Drawable f() {
        ...
        boolean z12 = this.q;
        if (z11) {
            g10 = g(z12 ? h6.Ba : h6.dc);
        } else {
            g10 = g(z12 ? h6.Aa : h6.ra);
        }
        boolean z13 = (this.a != null || z11 || this.J) ? false : true;
        int g11 = g(z12 ? h6.Ca : h6.ta);
        boolean z14 = this.K;
    ...
    public final bc0 i() {
        ...
        return bc0VarArr[this.l == 2 ? (char) 1 : (char) 0];
    }
    ...
    */
    public void o(int i10, int i11, int i12, int i13, int i14, int i15, boolean z10, boolean z11) {
        ...
        if (e5Var != null) {
            i16 = i12;
            i17 = i14;
            e5Var.o(i10, i11, i16, i13, i17, i15, z10, z11);
        } else {
            i16 = i12;
            i17 = i14;
        }
                    ...
                    if (bc0Var != null) {
                        ...
                        if (!z13 && i19 != 0 && z12) {
                            if (i16 != this.b || this.M == null || this.e != g10 || this.f != i18 || this.g != i19 || this.h != i20 || this.i != z12) {
                                ...
                                if (bc0VarArr[c12] == null) {
                                    bc0 bc0Var2 = new bc0();
                                    bc0VarArr[c12] = bc0Var2;
                                    if (i22 != 2) {
                                        c11 = 1;
                                        bc0Var2.t = true;
                                    } else {
                                ...
                                iArr2[2] = i19;
                                iArr2[c10] = i20;
                                Utilities.generateGradient(bitmap2, bc0Var3.i, bc0Var3.e.getInterpolation(bc0Var3.h), iArr2);
                            ...
                            if (i19 != 0 && z12) {
                                if (bc0VarArr[c12] == null) {
                                    bc0 bc0Var4 = new bc0();
                                    bc0VarArr[c12] = bc0Var4;
                                    if (i22 != 2) {
                                        bc0Var4.t = true;
                                    }
                                    bc0Var4.w(b(1.0f));
                                }
                                bc0VarArr[c12].n(g10, i18, i19, i20);
                                this.a = bc0VarArr[c12].v;
                            } else if (i19 == 0) {
                        ...
                        if (this.a instanceof BitmapShader) {
                            i21 = 0;
                            bc0VarArr[c12].setBounds(0, i17, i11, i16 - i13);
                        } else {
                            i21 = 0;
                        }
                        this.b = i16;
    ...
    public final void setAlpha(int i10) {
        ...
        if (i11 != i10 || paint.getAlpha() != i10) {
            ...
            paint.setAlpha(i10);
            if (this.q) {
                this.d.setAlpha((int) ((i10 / 255.0f) * Color.alpha(g(h6.bc))));
            }
        }
        if (this.a == null) {
            Drawable f7 = f();
