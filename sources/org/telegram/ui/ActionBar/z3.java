...
public final class z3 extends View {
    ...
    public z3(LaunchActivity launchActivity) {
        ...
        this.f = new org.telegram.ui.Components.d6(this, 0L, 350L, wr.h);
        this.Q = new RectF();
    ...
    public static void g(ViewGroup viewGroup, float f7, final bi.y2 y2Var) {
        ...
        PixelCopy.request(surface, createBitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: org.telegram.ui.ActionBar.t3
    ...
    public final void b(w3 w3Var) {
        ...
        for (int i10 = 0; i10 < tabDrawables.size(); i10++) {
            ...
            int indexOf = tabs.indexOf(n3Var2.a);
            n3Var2.c = indexOf;
            if (indexOf >= 0) {
                n3Var2.b = indexOf;
            }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int[] iArr = z3Var.a0;
        int[] iArr2 = z3Var.b0;
        RectF rectF3 = z3Var.c0;
        if (w3Var != null) {
            z3Var.getLocationOnScreen(iArr2);
            z3Var.a.getLocationOnScreen(iArr);
            z3Var.a.d(rectF3, 0.0f);
            rectF3.offset(iArr[0] - iArr2[0], iArr[1] - iArr2[1]);
            canvas.save();
            canvas.clipRect(0, 0, z3Var.getMeasuredWidth(), z3Var.getMeasuredHeight() - z3Var.s);
            x3 windowView = z3Var.b.getWindowView();
            float f15 = z3Var.e;
            RectF rectF4 = z3Var.e0;
            float w10 = windowView.w(canvas, rectF3, f15, rectF4, f15);
            if (z3Var.c != null) {
                Path path = z3Var.f0;
                path.rewind();
                ...
                z3Var.a.setupTab(z3Var.c);
                z3Var.c.a(canvas, rectF3, w10, z3Var.e, 1.0f);
                rectF = rectF3;
                canvas.restore();
            } else {
                rectF = rectF3;
        ...
        if (view != null) {
            ...
            z3Var.getLocationOnScreen(iArr2);
            rectF5.set(iArr[0] - iArr2[0], iArr[1] - iArr2[1], z3Var.S.getWidth() + r1, z3Var.S.getHeight() + (iArr[1] - iArr2[1]));
        } else {
            iArr[1] = 0;
            iArr[0] = 0;
        ...
        while (true) {
            ...
            f19 += ((y3) arrayList.get(i13)).d.c >= 0 ? 1.0f : 0.0f;
            i13++;
        }
        float d = z3Var.f.d(f19, false);
        float lerp = AndroidUtilities.lerp(0.0f, 1.0f - Utilities.clamp(z3Var.getScrollWindow() <= 0.0f ? 0.0f : ((z3Var.getScrollMin() - z3Var.getScrollOffset()) / (z3Var.getScrollWindow() * 0.15f)) * 0.2f, 1.0f, 0.0f), z3Var.V);
        int i14 = 0;
        while (i14 < arrayList.size() + 1) {
            if (i14 == arrayList.size()) {
                ...
                float[] fArr = y3Var.g;
                float f20 = dp;
                Matrix matrix = y3Var.f;
                float[] fArr2 = y3Var.h;
                float f21 = n3Var2 == null ? 1.0f : lerp;
                ...
                float f24 = min / 2.0f;
                i11 = min;
                RectF rectF6 = z3Var.d0;
                rectF6.set(f18 - f24, f23, f18 + f24, f22 + f23);
                boolean z10 = (rectF6.top > f17 || rectF6.bottom < 0.0f || lerp < 0.1f) && c10 < d - 3.0f;
                z3Var.a.d(rectF, Utilities.clamp(n3Var2.c(), 1.0f, 0.0f));
                rectF.offset(z3Var.a.getX(), z3Var.a.getY());
                ...
                if (rectF6.top > f17 || rectF6.bottom < 0.0f) {
                    ...
                    matrix.setPolyToPoly(y3Var.g, 0, y3Var.h, 0, 4);
                    ...
                    RadialGradient radialGradient = y3Var.p;
                    Paint paint = y3Var.o;
                    Paint paint2 = y3Var.r;
                    f10 = lerp;
                    Matrix matrix2 = y3Var.q;
                    p3 p3Var = y3Var.c;
                    f12 = d;
                    Path path2 = y3Var.n;
                    arrayList2 = arrayList;
                    ...
                    rectF2 = rectF;
                    RectF rectF7 = y3Var.m;
                    i12 = height2;
                    Paint paint4 = y3Var.l;
                    f13 = f17;
                    f11 = f16;
                    float clamp = Utilities.clamp(1.0f - ((Math.abs(y3Var.i) - 0.3f) / 0.7f), 1.0f, 0.0f) * lerp2;
                    if (clamp > 0.0f) {
                        float f28 = f27 * 1.0f;
                        ...
                        canvas.save();
                        canvas.rotate(y3Var.i * 20.0f, (y3Var.i * AndroidUtilities.dp(50.0f)) + rectF6.centerX(), rectF6.bottom + AndroidUtilities.dp(350.0f));
                        float a10 = y3Var.k.a(0.01f);
                        ...
                        if (z10) {
                            ...
                            if (p3Var != null && p3Var.m != null) {
                                float width3 = rectF6.width() / p3Var.m.getWidth();
                                canvas.scale(width3, width3);
                                paint.setAlpha(i15);
                                canvas.drawBitmap(p3Var.m, 0.0f, 0.0f, paint);
                            }
                            canvas.restore();
                            canvas.save();
    ...
    /* JADX WARN: Type inference failed for: r8v3, types: [android.view.VelocityTracker, org.telegram.ui.ActionBar.y3] */
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (this.V >= 1.0f) {
                ...
                for (int size = arrayList.size() - 1; size >= 0; size--) {
                    y3Var = (y3) arrayList.get(size);
                    if (Math.abs(y3Var.i) < 0.4f && y3Var.a.contains(x10, y3)) {
                        break;
                    }
                }
            }
            ...
            y3 y3Var2 = this.w;
            if (y3Var2 != null) {
                ValueAnimator valueAnimator = y3Var2.j;
                if (valueAnimator != null) {
                    valueAnimator.cancel();
                }
        ...
        if (motionEvent.getAction() == 2) {
            ...
            if (y3Var3 != null) {
                ...
                if (!y3Var4.k.h) {
                    if (this.H) {
                        y3Var4.i = (motionEvent.getX() - this.E) / AndroidUtilities.dp(300.0f);
                    } else if (this.G) {
        ...
        y3 y3Var6 = this.w;
        if (y3Var6 != null) {
            if (this.a == null || Math.abs(y3Var6.i) <= 0.4f) {
                this.w.a(0.0f);
                if (this.a != null && this.w.k.h) {
                    ...
                    if (this.L < getScrollMin() - (getScrollWindow() * 0.15f)) {
                        ...
                        if (this.x) {
                            final y3 y3Var8 = this.w;
                            final int i10 = 1;
                            this.a.g(y3Var8.c, new Utilities.Callback(this) { // from class: org.telegram.ui.ActionBar.s3
                                    ...
                                    switch (i10) {
                                        case 0:
                                            ...
                                            if (!booleanValue) {
                                                ...
                                                y3Var9.a(y3Var9.i < 0.0f ? -1.0f : 1.0f);
                                                z3Var.h(Utilities.clamp(z3Var.L, z3Var.c(false), z3Var.d(false)));
                                                if (z3Var.a.getTabs().isEmpty()) {
                                                    z3Var.a(false);
                                                    break;
                                                }
                                            }
                                        ...
                                        default:
                                            ...
                                            if (!booleanValue2) {
                                                ...
                                                y3Var10.a(1.0f);
                                                z3Var2.h(Utilities.clamp(z3Var2.L, z3Var2.c(false), z3Var2.d(false)));
                                                if (z3Var2.a.getTabs().isEmpty()) {
                                                    z3Var2.a(false);
                                                    break;
                                                }
                                            }
                ...
                final y3 y3Var9 = this.w;
                final int i11 = 0;
                this.a.g(y3Var9.c, new Utilities.Callback(this) { // from class: org.telegram.ui.ActionBar.s3
                    public final /* synthetic */ z3 b;
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                if (!booleanValue) {
                                    ...
                                    y3Var92.a(y3Var92.i < 0.0f ? -1.0f : 1.0f);
                                    z3Var.h(Utilities.clamp(z3Var.L, z3Var.c(false), z3Var.d(false)));
                                    if (z3Var.a.getTabs().isEmpty()) {
                                        z3Var.a(false);
                                        break;
    ...
    public final float e(boolean z10) {
        ...
        while (true) {
            ...
            f7 += ((y3) arrayList.get(i10)).d.c >= 0 ? 1.0f : 0.0f;
            i10++;
        }
    ...
    public final void f() {
        ...
        ArrayList arrayList = this.R;
        arrayList.clear();
        ArrayList<p3> tabs = this.a.getTabs();
        ArrayList<n3> tabDrawables = this.a.getTabDrawables();
