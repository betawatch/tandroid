...
public final class e4 {
    ...
    public final SparseIntArray b(int i10, int i11) {
        ...
        if (j3 == null) {
            ...
            d4 d4Var = (d4) ((fg.a) arrayList.get(i11));
    ...
    public final void n(int i10) {
        ...
        while (true) {
            ...
            if (arrayList.get(i11) != null) {
                ...
                ((d4) arrayList.get(i11)).h = g(h10, j6.ra);
                ((d4) arrayList.get(i11)).i = g(h10, j6.Aa);
                ((d4) arrayList.get(i11)).j = g(h10, j6.Oh);
                ((d4) arrayList.get(i11)).k = h10.get(j6.Nd, 0);
                ((d4) arrayList.get(i11)).l = h10.get(j6.Od, 0);
                ((d4) arrayList.get(i11)).m = h10.get(j6.Pd, 0);
                ((d4) arrayList.get(i11)).n = h10.get(j6.Qd, 0);
                ((d4) arrayList.get(i11)).o = h10.get(j6.Rd, 0);
                if (((d4) arrayList.get(i11)).a != null && ((d4) arrayList.get(i11)).a.m().equals("Blue")) {
                    if ((((d4) arrayList.get(i11)).e >= 0 ? ((d4) arrayList.get(i11)).e : ((d4) arrayList.get(i11)).a.Y) == 99) {
    ...
    public final void o(int i10, ResultCallback resultCallback) {
        ...
        int i12 = this.g;
        ChatThemeController.getInstance(i12).loadWallpaperBitmap(j3, z10 ? 1 : 0, new c4(s9Var, k10, z10 ? 1 : 0, i12, j3));
    }
