...
public final class jd extends org.telegram.ui.Components.aw0 {
    ...
    */
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i24;
        int i25;
        org.telegram.ui.Components.nu nuVar2;
        int measuredHeight3;
        int measuredHeight4;
        int i26;
        int i27;
        ...
        int i30;
        int i31;
        org.telegram.ui.Components.nu nuVar3;
        int measuredHeight5;
        int measuredHeight6;
        int i32;
        int i33;
        ...
        switch (this.w0) {
            ...
            case 1:
                ...
                int R2 = R();
                int emojiPadding2 = (R2 > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : yoVar.v.getEmojiPadding();
                ...
                break;
            case 2:
                k70 k70Var = (k70) this.y0;
                int childCount3 = getChildCount();
                int R3 = R();
                int emojiPadding3 = (R3 > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : k70Var.c.getEmojiPadding();
                    ...
                    if (childAt3.getVisibility() != 8) {
                        ...
                        if (i49 == 1) {
                            ...
                            if (i48 == 16) {
                                ...
                                nuVar3 = k70Var.c;
                                if (nuVar3 != null && nuVar3.l(childAt3)) {
                                    if (AndroidUtilities.isTablet()) {
                ...
                break;
            default:
                bw0 bw0Var = (bw0) this.y0;
                int childCount4 = getChildCount();
                int R4 = R();
                int i50 = (R4 > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : bw0Var.V;
                setBottomClip(i50);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.w0) {
            case 0:
                ...
                nd ndVar = (nd) this.y0;
                lVar = ((org.telegram.ui.ActionBar.p2) ndVar).actionBar;
                ...
                for (int i12 = 0; i12 < childCount; i12++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8) {
                        lVar2 = ((org.telegram.ui.ActionBar.p2) ndVar).actionBar;
                        if (childAt != lVar2) {
            ...
            case 1:
                ...
                yo yoVar = (yo) this.y0;
                lVar3 = ((org.telegram.ui.ActionBar.p2) yoVar).actionBar;
                ...
                for (int i13 = 0; i13 < childCount2; i13++) {
                    ...
                    if (childAt2 != null && childAt2.getVisibility() != 8) {
                        lVar4 = ((org.telegram.ui.ActionBar.p2) yoVar).actionBar;
                        if (childAt2 != lVar4) {
            ...
            case 2:
                ...
                k70 k70Var = (k70) this.y0;
                lVar5 = ((org.telegram.ui.ActionBar.p2) k70Var).actionBar;
                measureChildWithMargins(lVar5, i10, 0, i11, 0);
                if (R() > AndroidUtilities.dp(20.0f)) {
                    org.telegram.ui.Components.nu nuVar3 = k70Var.c;
                    if (!nuVar3.e) {
                        this.x0 = true;
                        nuVar3.j();
                        this.x0 = false;
                ...
                for (int i14 = 0; i14 < childCount3; i14++) {
                    ...
                    if (childAt3 != null && childAt3.getVisibility() != 8) {
                        lVar6 = ((org.telegram.ui.ActionBar.p2) k70Var).actionBar;
                        if (childAt3 != lVar6) {
                            org.telegram.ui.Components.nu nuVar4 = k70Var.c;
            ...
            default:
                ...
                bw0 bw0Var = (bw0) this.y0;
                lVar7 = ((org.telegram.ui.ActionBar.p2) bw0Var).actionBar;
                ...
                int i15 = (R > AndroidUtilities.dp(20.0f) || AndroidUtilities.isInMultiwindow || AndroidUtilities.isTablet()) ? 0 : bw0Var.V;
                ...
                for (int i17 = 0; i17 < childCount4; i17++) {
                    ...
                    if (childAt4 != null && childAt4.getVisibility() != 8) {
                        lVar8 = ((org.telegram.ui.ActionBar.p2) bw0Var).actionBar;
                        if (childAt4 != lVar8) {
                            org.telegram.ui.Components.rz rzVar = bw0Var.R;
                            if (rzVar == null || rzVar != childAt4) {
                                if (bw0Var.c == childAt4) {
