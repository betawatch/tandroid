...
public final class pi0 extends org.telegram.ui.Components.ml0 {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        wi0 wi0Var3 = this.b3;
        oi0 oi0Var = wi0Var3.G;
        int measuredHeight = oi0Var.getMeasuredHeight();
        pi0 pi0Var3 = wi0Var3.K;
        int childCount = pi0Var3.getChildCount();
        boolean z10 = false;
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = pi0Var3.getChildAt(i10);
            if (childAt instanceof org.telegram.ui.Cells.t1) {
                org.telegram.ui.Cells.t1 t1Var2 = (org.telegram.ui.Cells.t1) childAt;
                RectF rectF = hh.k.h;
                hh.k.c(t1Var2, oi0Var, rectF);
                float f7 = rectF.top;
                int i11 = (int) f7;
                ...
                t1Var2.b4(i12, measuredHeight2 - i12, measuredHeight, f7, f7, oi0Var.getMeasuredWidth(), oi0Var.getMeasuredHeight(), 0, 0, 0);
            }
        }
        boolean z11 = true;
            ...
            if (i14 != 2 || pi0Var3.X1) {
                ...
                while (i21 < arrayList.size()) {
                    ...
                    if (groupedMessages2 == null) {
                        ...
                        float f14 = f11;
                        if (f13 > AndroidUtilities.dp(20.0f) + pi0Var3.getMeasuredHeight()) {
                            f13 = AndroidUtilities.dp(20.0f) + pi0Var3.getMeasuredHeight();
                        }
                        float f15 = f13;
                        ...
                        if (z12) {
                            ...
                            for (int i22 = 0; i22 < childCount2; i22++) {
                                View childAt4 = pi0Var2.getChildAt(i22);
        ...
        while (i23 < childCount3) {
            ...
            if (!(childAt5 instanceof org.telegram.ui.Cells.t1) || ((currentMessagesGroup2 = (t1Var = (org.telegram.ui.Cells.t1) childAt5).getCurrentMessagesGroup()) != null && currentMessagesGroup2 == groupedMessages3)) {
                ...
                if (currentMessagesGroup2 == null) {
                    ...
                    wi0Var = wi0Var4;
                    wi0Var.j(canvas, boundsLeft, y11, boundsRight, y12);
                } else {
                    wi0Var = wi0Var4;
                }
        ...
        while (i24 < 3) {
            ...
            if (i24 != 2 || pi0Var4.X1) {
                ...
                while (i25 < childCount3) {
                    View childAt6 = pi0Var4.getChildAt(i25);
                    if (childAt6 instanceof org.telegram.ui.Cells.t1) {
                        org.telegram.ui.Cells.t1 t1Var5 = (org.telegram.ui.Cells.t1) childAt6;
                        if (childAt6.getY() <= pi0Var4.getHeight() && childAt6.getY() + childAt6.getHeight() >= 0.0f && (currentMessagesGroup = t1Var5.getCurrentMessagesGroup()) != null) {
                            int i26 = i24 == 0 ? 1 : 1;
                ...
                for (int i31 = 0; i31 < arrayList2.size(); i31++) {
                    ...
                    if (f19 > AndroidUtilities.dp(20.0f) + pi0Var4.getMeasuredHeight()) {
                        f19 = AndroidUtilities.dp(20.0f) + pi0Var4.getMeasuredHeight();
                    }
                    wi0Var5.j(canvas, f16, f17, f18, f19);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        org.telegram.ui.Cells.t1 t1Var;
        wi0 wi0Var = this.b3;
        if (wi0Var.w && ((view == (t1Var = wi0Var.Q) && t1Var != null && t1Var.getCurrentPosition() == null) || view == wi0Var.X)) {
            return false;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        wi0 wi0Var = this.b3;
        int dp = AndroidUtilities.dp(wi0Var.N.isEmpty() ? -6.0f : 48.0f);
        ViewGroup viewGroup = wi0Var.Z;
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(Math.max(0, ((AndroidUtilities.displaySize.y - (dp + (viewGroup == null ? 0 : viewGroup.getMeasuredHeight()))) - AndroidUtilities.dp(8.0f)) - wi0Var.e.b), TLObject.FLAG_31));
        int max = Math.max(AndroidUtilities.dp(12.0f) + (wi0Var.m0 ? wi0Var.Y : wi0Var.W.l()), -((AndroidUtilities.dp(7.0f) + wi0Var.o0[0]) - getMeasuredWidth()));
        float max2 = Math.max(1, getMeasuredWidth() - max) / Math.max(1, ((getMeasuredWidth() - max) - AndroidUtilities.dp(8.0f)) + Math.max(0, wi0Var.O - ((getMeasuredWidth() - max) - AndroidUtilities.dp((wi0Var.P.i() ? 0 : 40) + 8))));
