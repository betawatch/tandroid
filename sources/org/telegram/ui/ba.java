    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i11) {
            ...
            case 5:
                ...
                AndroidUtilities.runOnUIThread(new qg((org.telegram.ui.ActionBar.d2[]) obj2, i14));
                if (tL_error != null) {
            ...
            case 8:
                ...
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new qv((py) obj3, (TLRPC.TL_attachMenuBot) obj2, (LaunchActivity) obj, i14));
                break;
            case 10:
            ...
            case 11:
                ...
                if (tLObject == null) {
                    AndroidUtilities.runOnUIThread(new z10(i12, d60Var, tL_error));
                    break;
                } else {
            ...
            case 25:
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = na1.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), yi0Var.r.i, false);
            ...
            default:
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_validatedRequestedInfo)) {
                    AndroidUtilities.runOnUIThread(new mn0(lo0Var, tL_error, tLObject2, i12));
                    break;
                } else {
