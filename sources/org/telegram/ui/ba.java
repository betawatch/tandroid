    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i11) {
            ...
            case 8:
                ...
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new pv((oy) obj3, (TLRPC.TL_attachMenuBot) obj2, (LaunchActivity) obj, i13));
                break;
            case 10:
                    ...
                    while (true) {
                        if (i14 < updates.updates.size()) {
                            ...
                            if (update instanceof TL_update.TL_updateGroupCall) {
                                AndroidUtilities.runOnUIThread(new ih((Object) c60Var, (Object) chat, (Object) inputPeer, update, 28));
                            } else {
                                i14++;
                            }
                        }
            ...
            case 14:
                ...
                if (Objects.equals(l70Var.h, (String) obj2) && (tLObject instanceof TLRPC.TL_messages_foundStickerSets)) {
                    ...
                    i10 = ((org.telegram.ui.ActionBar.p2) m70Var).currentAccount;
                    ArrayList<TLRPC.TL_messages_stickerSet> stickerSets = MediaDataController.getInstance(i10).getStickerSets(m70Var.c0());
            ...
            case 25:
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = ga1.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), xi0Var.r.i, false);
