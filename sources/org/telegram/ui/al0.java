...
public final class al0 extends org.telegram.ui.ActionBar.p2 implements org.telegram.ui.Components.kk, NotificationCenter.NotificationCenterDelegate {
    public int E;
    public int F;
    public int G;
    public yk0 H;
    ...
    public org.telegram.ui.Components.jo K;
    public long L;
    public int M;
    public yk0 N;
    ...
    public al0(Bundle bundle, org.telegram.ui.ActionBar.f6 f6Var) {
        super(bundle);
    ...
    */
    public static void U(al0 al0Var, Context context, View view, int i10) {
        al0 al0Var2;
        Context context2;
        File file;
        if (i10 == al0Var.v) {
            al0Var2 = al0Var;
            context2 = context;
            org.telegram.ui.Components.yi yiVar = new org.telegram.ui.Components.yi(context2, al0Var2, false, false, true, al0Var.h);
            al0Var2.O = yiVar;
            yiVar.N = true;
        ...
        if (view instanceof zk0) {
            zk0 zk0Var = (zk0) view;
            if (al0Var2.actionBar.s() || zk0Var.e == null) {
                al0Var2.Z(zk0Var.e);
                return;
            }
            Ringtone ringtone = al0Var2.P;
            if (ringtone != null) {
                ringtone.stop();
            }
            try {
                ...
                if (yk0Var.b) {
                    ...
                    String str = yk0Var.g;
                    if (str != null && !yk0Var.a) {
                        Ringtone ringtone3 = RingtoneManager.getRingtone(context2.getApplicationContext(), Uri.parse(zk0Var.e.g));
                        ringtone3.setStreamType(4);
                        al0Var2.P = ringtone3;
                        ringtone3.play();
                    } else if (yk0Var.a) {
                        if (!TextUtils.isEmpty(str)) {
                            file = new File(zk0Var.e.g);
                            if (file.exists()) {
                                if (file == null) {
                                    file = al0Var2.getFileLoader().getPathToAttach(zk0Var.e.e);
                                }
                                if (file == null && file.exists()) {
                                    ...
                                    FileLoader fileLoader = al0Var2.getFileLoader();
                                    TLRPC.Document document = zk0Var.e.e;
                        ...
                        FileLoader fileLoader2 = al0Var2.getFileLoader();
                        TLRPC.Document document2 = zk0Var.e.e;
            ...
            al0Var2.H = zk0Var.e;
            al0Var2.I = true;
            xk0 xk0Var = al0Var2.f;
            xk0Var.q(0, xk0Var.c.n);
        }
    }
    ...
    public final void Z(yk0 yk0Var) {
        ...
        if (sparseArray.get(i10) != null) {
            sparseArray.remove(yk0Var.c);
        } else if (!yk0Var.a) {
            return;
        } else {
            sparseArray.put(yk0Var.c, yk0Var);
        }
        b0();
        xk0 xk0Var = this.f;
        xk0Var.q(0, xk0Var.c.n);
    ...
    public final View createView(Context context) {
        ...
        if (this.L == 0) {
            ...
            org.telegram.ui.Components.jo joVar = new org.telegram.ui.Components.jo(context, null, false, this.h);
            this.K = joVar;
            joVar.setOccupyStatusBar(!AndroidUtilities.isTablet());
            this.actionBar.addView(this.K, 0, w7.a6.d(-2, -1.0f, 51, !this.inPreviewMode ? 56.0f : 0.0f, 0.0f, 40.0f, 0.0f));
            if (this.L >= 0) {
                ...
                mg.d.p(this.K.getAvatarImageView(), findTopic, false, true, this.h);
        ...
        j3.addView(this.d, w7.a6.m(1.0f, 0, -1, 72, 0, 0));
        this.d.setOnTouchListener(new ai.h(2));
        ...
        this.e.setOnItemClickListener(new ai.b0(19, this, context));
        ...
        for (int i11 = 0; i11 < getMediaDataController().ringtoneDataStore.e.size(); i11++) {
            tf.b bVar = (tf.b) getMediaDataController().ringtoneDataStore.e.get(i11);
            yk0 yk0Var = new yk0();
            int i12 = this.G;
            this.G = i12 + 1;
            yk0Var.c = i12;
            ...
            yk0Var.f = str;
            yk0Var.e = document3;
            yk0Var.f = a0(document3, str);
            yk0Var.g = bVar.b;
            yk0 yk0Var2 = this.N;
            if (yk0Var2 != null && (document = yk0Var2.e) != null && (document2 = bVar.a) != null && document.id == document2.id) {
                this.N = null;
                this.H = yk0Var;
            }
            this.a.add(yk0Var);
        ...
        this.G = i13 + 1;
        yk0Var3.c = i13;
        yk0Var3.f = LocaleController.getString(R.string.NoSound);
        this.b.add(yk0Var3);
        yk0 yk0Var4 = new yk0();
        int i14 = this.G;
        this.G = i14 + 1;
        yk0Var4.c = i14;
        yk0Var4.f = LocaleController.getString(R.string.DefaultRingtone);
        yk0Var4.b = true;
        this.b.add(yk0Var4);
        yk0 yk0Var5 = this.N;
        if (yk0Var5 != null && yk0Var5.e == null && yk0Var5.g.equals("NoSound")) {
            this.N = null;
            this.H = yk0Var3;
        }
        yk0 yk0Var6 = this.N;
        if (yk0Var6 != null && yk0Var6.e == null && yk0Var6.g.equals("Default")) {
            this.N = null;
            this.H = yk0Var4;
        }
        while (cursor.moveToNext()) {
            ...
            yk0Var7.g = str2;
            yk0 yk0Var8 = this.N;
            if (yk0Var8 != null && yk0Var8.e == null && yk0Var8.g.equals(str2)) {
                this.N = null;
                this.H = yk0Var7;
            }
            this.b.add(yk0Var7);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.onUserRingtonesUpdated) {
            ...
            for (int i13 = 0; i13 < getMediaDataController().ringtoneDataStore.e.size(); i13++) {
                tf.b bVar = (tf.b) getMediaDataController().ringtoneDataStore.e.get(i13);
                yk0 yk0Var = new yk0();
                yk0 yk0Var2 = (yk0) hashMap.get(Integer.valueOf(bVar.c));
                if (yk0Var2 != null) {
                    if (yk0Var2 == this.H) {
                        this.H = yk0Var;
                    }
                ...
                TLRPC.Document document3 = bVar.a;
                if (document3 != null) {
                    yk0Var.f = document3.file_name_fixed;
                } else {
                    yk0Var.f = new File(bVar.b).getName();
                }
                TLRPC.Document document4 = bVar.a;
                yk0Var.e = document4;
                yk0Var.f = a0(document4, yk0Var.f);
                yk0Var.g = bVar.b;
                yk0 yk0Var3 = this.N;
                if (yk0Var3 != null && (document = yk0Var3.e) != null && (document2 = bVar.a) != null && document.id == document2.id) {
                    this.N = null;
                    this.H = yk0Var;
                }
    ...
    public final boolean onFragmentCreate() {
        ...
        if (j3 != 0) {
            ...
            str = org.telegram.ui.Cells.r6.i("sound_path_", sharedPrefKey);
        } else {
            int i10 = this.M;
            if (i10 == 1) {
                str = "GlobalSoundPath";
        ...
        this.N = yk0Var;
        if (j10 != 0) {
            yk0Var.e = new TLRPC.TL_document();
            this.N.e.id = j10;
        } else {
            yk0Var.g = string;
        }
    ...
    public final void onFragmentDestroy() {
        ...
        if (this.L != 0) {
            str = org.telegram.messenger.a2.i(this.L, this.Q, new StringBuilder("sound_"));
            str2 = org.telegram.messenger.a2.i(this.L, this.Q, new StringBuilder("sound_path_"));
            str3 = org.telegram.messenger.a2.i(this.L, this.Q, new StringBuilder("sound_document_id_"));
            edit.putBoolean(org.telegram.messenger.a2.i(this.L, this.Q, new StringBuilder("sound_enabled_")), true);
        } else {
            int i10 = this.M;
            if (i10 == 1) {
                str = "GlobalSound";
        ...
        yk0 yk0Var = this.H;
        if (yk0Var.a && (document = yk0Var.e) != null) {
            edit.putLong(str3, document.id);
            edit.putString(str, this.H.f);
            edit.putString(str2, "NoSound");
        } else if (yk0Var.g != null) {
            edit.putString(str, yk0Var.f);
