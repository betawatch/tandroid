...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public class PhotoBackgroundDrawable extends ColorDrawable {
        ...
        public final void draw(Canvas canvas) {
            ...
            super.draw(canvas);
            if (getAlpha() != 0) {
                if (this.b != 2 || (ky0Var = this.a) == null) {
                    invalidateSelf();
                } else {
                    ky0Var.run();
                    this.a = null;
            ...
            if (secretMediaViewer.m0 != 3) {
                ...
                if (!secretMediaViewer.e1) {
                    ...
                    if (f13 > f40) {
                        ...
                        f21 = 1.0f - min;
                        f13 = secretMediaViewer.W0;
                        k4 k4Var = secretMediaViewer.w;
                        z11 = k4Var == null && k4Var.getVisibility() == 0;
                        canvas.save();
                        float f41 = f11 - f22;
    ...
    */
    public final boolean e(boolean z10, boolean z11) {
        ...
        if (dv0Var != null) {
            ...
            if (!(messageMedia.photo instanceof TLRPC.TL_photoEmpty) && !(messageMedia.document instanceof TLRPC.TL_documentEmpty)) {
                fv0Var = dv0Var.E(messageObject, null, 0, true, false);
                c51Var = this.y;
                if (c51Var != null) {
                    c51Var.B();
                }
                ...
                if (z10) {
                    ...
                    ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this.a0, (Property<du0, Float>) property, 0.0f);
                    ...
                    this.m0 = 2;
                    this.o0 = new w41(this, fv0Var, i10);
                    ...
                    if (fv0Var == null || fv0Var.a.getThumbBitmap() == null || z11 || this.p1 != null) {
                        c10 = 7;
                        c11 = 6;
                        c12 = 5;
                        c13 = 4;
                        ...
                        RectF drawRegion = fv0Var.a.getDrawRegion();
                        c10 = 7;
                        ...
                        this.A0 = ((f10 / 2.0f) + (fv0Var.c + drawRegion.top)) - (r6 / 2);
                        this.G0 = Math.abs(f12 - fv0Var.a.getImageX());
                        int abs = (int) Math.abs(drawRegion.top - fv0Var.a.getImageY());
                        fv0Var.d.getLocationInWindow(new int[2]);
                        float f13 = (r7[1] - (fv0Var.c + drawRegion.top)) + fv0Var.j;
                        this.C0 = f13;
                        float f14 = abs;
                        this.C0 = Math.max(0.0f, Math.max(f13, f14));
                        float height = (((fv0Var.c + drawRegion.top) + ((int) f10)) - (fv0Var.d.getHeight() + r7[1])) + fv0Var.i;
                        this.D0 = height;
                    ...
                    if (z12) {
                        ...
                        ObjectAnimator ofFloat8 = ObjectAnimator.ofFloat(this.a0, (Property<du0, Float>) property2, 0.0f);
                        ...
                        ObjectAnimator ofFloat16 = ObjectAnimator.ofFloat(this.a0, (Property<du0, Float>) property3, 0.0f);
                    ...
                    this.o0 = new w41(this, fv0Var, 0);
                    this.K0.setInterpolator(new DecelerateInterpolator());
                    this.K0.setDuration(250L);
                    this.K0.addListener(new org.telegram.ui.Components.qk0(14, this, fv0Var));
                    this.n0 = System.currentTimeMillis();
                    this.e.setLayerType(2, null);
                    this.K0.start();
                    runnable = null;
    ...
    public final void j(MessageObject messageObject, CharSequence charSequence, boolean z10) {
        ...
        tu0 tu0Var = this.Z;
        TextView nextView = z10 ? tu0Var.getNextView() : tu0Var.getCurrentView();
    ...
    public final void k(boolean z10, boolean z11) {
        ...
        if (z11) {
            this.V.animate().scaleX(z12 ? 1.0f : 0.6f).scaleY(z12 ? 1.0f : 0.6f).alpha(z12 ? 1.0f : 0.0f).setDuration(340L).setInterpolator(org.telegram.ui.Components.qr.h).start();
            return;
        }
    ...
    public final void m(boolean z10, boolean z11) {
        ...
        arrayList.add(ObjectAnimator.ofFloat(this.a0, (Property<du0, Float>) property, z10 ? 1.0f : 0.0f));
