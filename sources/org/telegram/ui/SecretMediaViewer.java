...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public org.telegram.ui.Components.an0 g1;
    ...
    public class PhotoBackgroundDrawable extends ColorDrawable {
        ...
        public final void draw(Canvas canvas) {
            ...
            super.draw(canvas);
            if (getAlpha() != 0) {
                if (this.b != 2 || (cy0Var = this.a) == null) {
                    invalidateSelf();
                } else {
                    cy0Var.run();
                    this.a = null;
        ...
        public void setAlpha(int i10) {
            ...
            if (lb0Var != null) {
                lb0Var.a(secretMediaViewer.j0 && i10 == 255);
            }
            super.setAlpha(i10);
        }
    ...
    public static void b(SecretMediaViewer secretMediaViewer, Canvas canvas) {
        ...
        if (secretMediaViewer.j0) {
            if (secretMediaViewer.K0 != null) {
                org.telegram.ui.Components.an0 an0Var = secretMediaViewer.g1;
                if (!an0Var.q) {
                    an0Var.a();
                }
                ...
                org.telegram.ui.Components.an0 an0Var2 = secretMediaViewer.g1;
                if (!an0Var2.q && an0Var2.b()) {
                    org.telegram.ui.Components.an0 an0Var3 = secretMediaViewer.g1;
                    float f37 = an0Var3.b;
                    if (f37 < secretMediaViewer.W0 && f37 > secretMediaViewer.V0) {
                        secretMediaViewer.w0 = an0Var3.j;
                    }
                    float f38 = an0Var3.c;
                    if (f38 < secretMediaViewer.Y0 && f38 > secretMediaViewer.X0) {
                        secretMediaViewer.x0 = an0Var3.k;
                    }
                    secretMediaViewer.e.invalidate();
                }
        ...
        if (bv0Var != null) {
            ...
            if (!(messageMedia.photo instanceof TLRPC.TL_photoEmpty) && !(messageMedia.document instanceof TLRPC.TL_documentEmpty)) {
                ...
                if (z10) {
                    ...
                    if (dv0Var == null || dv0Var.a.getThumbBitmap() == null || z11 || this.p1 != null) {
                        c10 = 7;
                        c11 = 6;
                        c12 = 5;
                        c13 = 4;
                        ...
                        RectF drawRegion = dv0Var.a.getDrawRegion();
                        c10 = 7;
                        ...
                        this.A0 = ((f10 / 2.0f) + (dv0Var.c + drawRegion.top)) - (r6 / 2);
                        this.G0 = Math.abs(f12 - dv0Var.a.getImageX());
                        int abs = (int) Math.abs(drawRegion.top - dv0Var.a.getImageY());
                        dv0Var.d.getLocationInWindow(new int[2]);
                        float f13 = (r7[1] - (dv0Var.c + drawRegion.top)) + dv0Var.j;
                        this.C0 = f13;
                        float f14 = abs;
                        this.C0 = Math.max(0.0f, Math.max(f13, f14));
                        float height = (((dv0Var.c + drawRegion.top) + ((int) f10)) - (dv0Var.d.getHeight() + r7[1])) + dv0Var.i;
                        this.D0 = height;
                    ...
                    this.K0.addListener(new org.telegram.ui.Components.al0(14, this, dv0Var));
                    this.n0 = System.currentTimeMillis();
                    this.e.setLayerType(2, null);
                    this.K0.start();
                    runnable = null;
    ...
    */
    public final boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        if (f7 == 1.0f) {
            float b10 = org.telegram.messenger.wh.b(3.0f, this.y0, (motionEvent.getX() - (this.e.getWidth() / 2)) - this.w0, motionEvent.getX() - (this.e.getWidth() / 2));
            float b11 = org.telegram.messenger.wh.b(3.0f, this.y0, (motionEvent.getY() - (this.e.getHeight() / 2)) - this.x0, motionEvent.getY() - (this.e.getHeight() / 2));
            n(3.0f);
            float f10 = this.V0;
            if (b10 >= f10) {
                f10 = this.W0;
