...
public final class c41 extends Dialog {
    ...
    public float s;
    public float v;
    public org.telegram.ui.Components.m61 w;
    public lh.w3 x;
    public TextView y;
    ...
    public final void c(boolean z10, x31 x31Var) {
        ...
        this.Z = ofFloat;
        int i10 = 11;
        ofFloat.addUpdateListener(new ig.y(i10, this, z10));
        ...
        this.a0.addListener(new n40(8, this, z10));
    ...
    public final void d() {
        ...
        if (s1Var != null) {
            ...
            i0.c cVar = this.e;
            this.B = f10 - ((((width - cVar.a) - cVar.c) - this.K.getWidth()) / 2.0f);
            float f11 = iArr[1] - this.e.b;
            int height = n0Var.getHeight();
            i0.c cVar2 = this.e;
            this.C = org.telegram.messenger.y1.a(((height - cVar2.b) - cVar2.d) - this.K.getHeight(), this.G, 2.0f, f11);
            if (!this.F) {
                this.F = true;
    ...
    public final void dismiss() {
        ...
        org.telegram.ui.Components.m61 m61Var = this.w;
        if (m61Var != null) {
            m61Var.C();
            this.w.I();
            this.w = null;
        ...
        if (uVar != null) {
            ...
            this.U = null;
            org.telegram.ui.Components.f01 f01Var = new org.telegram.ui.Components.f01(this.a, null);
            this.d = f01Var;
            n0Var.addView(f01Var, h7.z5.e(-1, -1, 119));
            org.telegram.ui.Components.f01 f01Var2 = this.d;
            a41 a41Var2 = this.J;
            x31 x31Var = new x31(this, 1);
            org.telegram.ui.Components.d01 d01Var = f01Var2.a;
            if (d01Var != null) {
        ...
        if (vsVar != null) {
            ...
            SensorManager sensorManager = vsVar.a;
            if (vsVar.n) {
                Sensor sensor = vsVar.f;
                if (sensor != null) {
                    sensorManager.unregisterListener(vsVar, sensor);
                }
                Sensor sensor2 = vsVar.e;
                if (sensor2 != null) {
                ...
                sensorManager.unregisterListener(vsVar, vsVar.c);
    ...
    public final void e() {
        ...
        lh.w3 w3Var = this.x;
        if (w3Var != null) {
            w3Var.setTranslationX(AndroidUtilities.lerp(this.B, 0.0f, this.s));
    ...
    public final void show() {
        if (AndroidUtilities.isSafeToShow(getContext())) {
            ...
            if (vsVar != null) {
                ...
                sensorManager.registerListener(vsVar, vsVar.c, 3);
