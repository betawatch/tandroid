...
public final class uk extends TextView {
    ...
    public /* synthetic */ uk(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
    ...
    public void draw(Canvas canvas) {
        switch (this.a) {
            ...
            case 3:
                ...
                org.telegram.ui.Components.voip.h hVar = w81Var.c;
                if (hVar.g <= 1.0f) {
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            case 6:
                super.onMeasure(i10, i11);
                ((org.telegram.ui.web.a2) this.b).c.setPivotY(getMeasuredHeight() / 2.0f);
                break;
            default:
                super.onMeasure(i10, i11);
                break;
