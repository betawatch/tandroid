...
public final class zf0 extends org.telegram.ui.Components.fw0 {
    ...
    public zf0(qg0 qg0Var, Context context) {
        ...
        yf0 yf0Var = new yf0(context, 1, 1, 0);
        ...
        d6Var2 = ((org.telegram.ui.ActionBar.m2) qg0Var).resourceProvider;
        ...
        d6Var3 = ((org.telegram.ui.ActionBar.m2) qg0Var).resourceProvider;
        ...
        d6Var4 = ((org.telegram.ui.ActionBar.m2) qg0Var).resourceProvider;
        yh.r rVar3 = new yh.r(context, 1, d6Var4);
        rVar3.a(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.SMSFee3Title), new vf0(this, 4)), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)), LocaleController.getString(R.string.SMSFee3Text), R.drawable.menu_feature_hands);
    ...
    public static /* synthetic */ void o(zf0 zf0Var, String str, String str2, String str3) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    TelephonyManager telephonyManager = (TelephonyManager) zf0Var.getContext().getSystemService(TelephonyManager.class);
            ...
            sb2.append("Wi-Fi: ");
            sb2.append(AndroidUtilities.isWifiEnabled(zf0Var.getContext()));
            sb2.append("\n");
            sb2.append("Airplane Mode: ");
            sb2.append(AndroidUtilities.isInAirplaneMode(zf0Var.getContext()));
            sb2.append("\n");
            sb2.append("\n");
            sb2.append("App: ");
            ...
            zf0Var.v.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
