...
public final class ib1 extends LinearLayout {
    ...
    public /* synthetic */ ib1(Context context) {
        super(context);
        this.a = 0;
    }
            ...
            case 10:
                ...
                if (motionEvent.getAction() == 0) {
                    ...
                    if (view2 != null) {
                        ...
                        if (i10 != indexOfChild) {
                            org.telegram.ui.Components.um0 um0Var = scrollSlidingTextTabStrip.b;
                    ...
                    if (view3 != null) {
                        final int i12 = 0;
                        view3.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.sm0
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i12) {
                                    case 0:
                                        ib1 ib1Var = this.b;
                                        ib1Var.invalidate();
                                        ((ScrollSlidingTextTabStrip) ib1Var.b).invalidate();
                                        break;
                                    default:
                                        ib1 ib1Var2 = this.b;
                                        ib1Var2.invalidate();
                                        ((ScrollSlidingTextTabStrip) ib1Var2.b).invalidate();
                                        break;
                                }
                            }
                    ...
                    if (view4 != null) {
                        final int i13 = 1;
                        view4.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.Components.sm0
                            public final /* synthetic */ ib1 b;
    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.a) {
            ...
            case 6:
                ...
                return super.drawChild(canvas, view, j10);
            case 9:
                org.telegram.ui.Components.qm0 qm0Var = (org.telegram.ui.Components.qm0) this.b;
                if (view instanceof org.telegram.ui.Components.gx0) {
                    ((org.telegram.ui.Components.gx0) view).a(qm0Var.f0);
                }
                if (view == qm0Var.s) {
                    return true;
                }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.a) {
            case 17:
                ...
                accessibilityNodeInfo.setVisibleToUser(((ci1) this.b).y0);
                break;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                break;
        ...
        switch (this.a) {
            ...
            case 12:
                ...
                if (LocaleController.isRTL) {
                    ((org.telegram.ui.Components.u31) this.b).c.setPivotX(getMeasuredWidth());
                    break;
                }
                break;
            case 15:
            ...
            case 16:
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) qg1Var.c.getLayoutParams();
                int i15 = 0;
                int dp = AndroidUtilities.dp(8.0f) + (qg1Var.a.getVisibility() == 8 ? AndroidUtilities.statusBarHeight : 0);
    ...
    public void setVisibility(int i10) {
        switch (this.a) {
            case 11:
                org.telegram.ui.Components.ax0 ax0Var = (org.telegram.ui.Components.ax0) this.b;
                org.telegram.ui.Components.p9 p9Var = ax0Var.b;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ib1(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
