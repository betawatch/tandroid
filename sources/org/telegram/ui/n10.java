...
public final class n10 extends FrameLayout {
    ...
    public final void onLayout(boolean z10, int i9, int i10, int i11, int i12) {
        ...
        int dp2 = !LocaleController.isRTL ? AndroidUtilities.dp(20.0f) : (i13 - imageView.getMeasuredWidth()) - AndroidUtilities.dp(20.0f);
    ...
    public final void onMeasure(int i9, int i10) {
        ...
        this.a.measure(org.telegram.messenger.ll.d(94.0f, size, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), TLObject.FLAG_30));
