...
public final class j3 extends pt0 {
    ...
    public final zt0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ...
        zt0Var.b = iArr[0];
        zt0Var.c = iArr[1];
        zt0Var.d = m4Var.q0[0].b;
        zt0Var.a = c02;
        zt0Var.e = c02.getBitmapSafe();
    ...
    */
    public final void X(int i10) {
        ...
        if (i10 >= 0) {
            ...
            if (i10 < list.size()) {
                ...
                if (b3Var != null && x61Var != null && textureView != null) {
                ...
                if (b3Var != null && x61Var != null && surfaceView != null) {
    ...
    public final ImageReceiver d0(View view, TL_iv.PageBlock pageBlock, int[] iArr) {
        ...
        if (!(view instanceof e2) || (vk0Var = ((e2) view).d) == null || (d02 = d0(vk0Var.a, pageBlock, iArr)) == null) {
            return null;
        }
        return d02;
    }
