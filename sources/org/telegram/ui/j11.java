...
public final class j11 extends org.telegram.ui.ActionBar.n2 {
    ...
    public j11() {
        super(null);
        this.e = new org.telegram.ui.Cells.w6[3];
        this.f = new org.telegram.ui.Cells.x8[2];
        this.s = new org.telegram.ui.Cells.g6[2];
        this.v = -1;
        this.w = -1;
        this.A = 1.0f;
        this.B = new float[2];
    ...
    public final void V(int i10, boolean z10, ky0 ky0Var) {
        ...
        org.telegram.ui.Cells.x8[] x8VarArr = this.f;
        if (this.v != i10) {
            this.v = i10;
            ...
            if (z10) {
                TransitionSet duration = new TransitionSet().addTransition(new Fade(2)).addTransition(new ChangeBounds()).addTransition(new Fade(1)).setInterpolator((TimeInterpolator) org.telegram.ui.Components.er.f).setDuration(250L);
                if (ky0Var != null) {
    ...
    */
    public final void W() {
        String str;
        char c10;
        org.telegram.ui.Cells.w6[] w6VarArr = this.e;
    ...
    public final View createView(Context context) {
                ...
                switch (i11) {
                    ...
                    default:
                        ...
                        if (j11Var.w != -1) {
                            int i12 = 0;
                            while (true) {
                                String[] strArr = j11Var.y;
                                if (i12 >= strArr.length) {
                                    EditTextBoldCursor editTextBoldCursor = j11Var.a[0];
                                    editTextBoldCursor.setSelection(editTextBoldCursor.length());
                                    j11Var.V(j11Var.w, true, new ky0(j11Var, 8));
                                    break;
                                } else {
                                    int i13 = j11Var.w;
                                    if ((i13 != 0 || i12 != 4) && (i13 != 1 || (i12 != 2 && i12 != 3))) {
                                        ...
                                        if (str != null) {
                                            try {
                                                j11Var.a[i12].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                j11Var.a[i12].setText(j11Var.y[i12]);
                                            }
                                        } else {
        ...
        while (i12 < 2) {
            ...
            this.c.addView(g6VarArr[i12], h7.z5.n(-1, 50));
        ...
        w6VarArr[0] = w6Var;
        this.c.addView(w6Var, h7.z5.n(-1, -2));
        LinearLayout linearLayout2 = new LinearLayout(context);
        this.d = linearLayout2;
        linearLayout2.setOrientation(1);
        this.d.setBackgroundColor(org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false));
        this.d.setElevation(AndroidUtilities.dp(1.0f));
        this.d.setOutlineProvider(null);
        this.c.addView(this.d, h7.z5.n(-1, -2));
        int i13 = 5;
        ...
        while (i14 < i13) {
            ...
            if (i14 == 0) {
                ...
                this.a[i14].addTextChangedListener(new h11(this, 0));
            } else if (i14 == 1) {
                this.a[i14].setInputType(2);
                this.a[i14].addTextChangedListener(new h11(this, 1));
            } else if (i14 == 3) {
            ...
            frameLayout2.addView(this.a[i14], h7.z5.d(-1, -1.0f, 51, 17.0f, i14 == 0 ? 12.0f : 0.0f, 17.0f, 0.0f));
            this.a[i14].setOnEditorActionListener(new fa(this, 10));
            i14++;
            i13 = 5;
            i10 = -1;
        }
        for (int i16 = 0; i16 < 2; i16++) {
            ...
            this.c.addView(x8VarArr[i16], h7.z5.n(-1, -2));
        }
        ...
        org.telegram.ui.Cells.x9 x9Var2 = this.n;
                        ...
                        if (j11Var.w != -1) {
                            ...
                            while (true) {
                                ...
                                if (i122 >= strArr.length) {
                                    EditTextBoldCursor editTextBoldCursor3 = j11Var.a[0];
                                    ...
                                    if ((i132 != 0 || i122 != 4) && (i132 != 1 || (i122 != 2 && i122 != 3))) {
                                        ...
                                        if (str != null) {
                                            try {
                                                j11Var.a[i122].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                j11Var.a[i122].setText(j11Var.y[i122]);
                                            }
                                        } else {
                                            j11Var.a[i122].setText((CharSequence) null);
                                        }
                                    }
                                    i122++;
                                }
        ...
        this.c.addView(this.n, 0, h7.z5.n(-1, -2));
        this.n.setVisibility(8);
        ...
        int i20 = org.telegram.ui.ActionBar.g6.b7;
        w6Var2.setBackground(org.telegram.ui.ActionBar.g6.V0(context2, i19, i20));
        this.c.addView(w6VarArr[2], 1, h7.z5.n(-1, -2));
        w6VarArr[2].setVisibility(8);
        ...
        this.c.addView(this.h, h7.z5.n(-1, -2));
        ...
        this.c.addView(w6VarArr[1], h7.z5.n(-1, -2));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(x9Var, TLObject.FLAG_28, null, null, null, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.n, 0, new Class[]{org.telegram.ui.Cells.x9.class}, new String[]{"textView"}, null, null, -1, null, i13));
        for (int i14 = 0; i14 < g6VarArr.length; i14++) {
            ...
            arrayList.add(new org.telegram.ui.ActionBar.i6(g6VarArr[i14], TLObject.FLAG_28, null, null, null, null, org.telegram.ui.ActionBar.g6.i6));
            ...
            arrayList.add(new org.telegram.ui.ActionBar.i6(g6VarArr[i14], 8192, new Class[]{org.telegram.ui.Cells.g6.class}, new String[]{"radioButton"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.g7));
            arrayList.add(new org.telegram.ui.ActionBar.i6(g6VarArr[i14], 16384, new Class[]{org.telegram.ui.Cells.g6.class}, new String[]{"radioButton"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.h7));
        }
        if (this.a != null) {
            int i15 = 0;
            while (true) {
                ...
                arrayList.add(new org.telegram.ui.ActionBar.i6(null, 0, null, null, null, sx0Var, org.telegram.ui.ActionBar.g6.k6));
                arrayList.add(new org.telegram.ui.ActionBar.i6(null, 0, null, null, null, sx0Var, org.telegram.ui.ActionBar.g6.l6));
        ...
        while (true) {
            ...
            if (w6Var != null) {
                arrayList.add(new org.telegram.ui.ActionBar.i6(w6Var, 32, new Class[]{org.telegram.ui.Cells.w6.class}, null, null, null, org.telegram.ui.ActionBar.g6.b7));
            }
            i17++;
        }
        for (int i18 = 0; i18 < x8VarArr.length; i18++) {
            arrayList.add(new org.telegram.ui.ActionBar.i6(x8VarArr[i18], 32, new Class[]{org.telegram.ui.Cells.x8.class}, null, null, null, org.telegram.ui.ActionBar.g6.b7));
