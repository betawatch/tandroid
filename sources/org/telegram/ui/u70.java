...
public final class u70 extends ActionBarPopupWindow$ActionBarPopupWindowLayout {
    ...
    public u70(Context context, org.telegram.ui.ActionBar.o2 o2Var) {
        ...
        view.setBackground(org.telegram.ui.ActionBar.f6.U0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.b7, null)));
        ...
        for (int i10 = 0; i10 < this.T.size(); i10++) {
            ((t70) this.T.get(i10)).a.setOnClickListener(new gh.z0(this, ((t70) this.T.get(i10)).b, 17));
        }
    ...
    public final void f() {
        if (this.b0 != null) {
            ((org.telegram.ui.Components.c9) this.U.d).setTranslationX((3 - Math.min(3, this.b0.size())) * AndroidUtilities.dp(12.0f));
        }
    }
