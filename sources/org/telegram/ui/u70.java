...
public final class u70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(u70 u70Var, View view, int i10) {
        ...
        if (!u70Var.M) {
            ...
            if (i10 == u70Var.J) {
                u70Var.d0(u70Var.r, true, false);
                return;
            }
            return;
        }
        if (i10 > u70Var.f.d.size()) {
            boolean a2 = ((org.telegram.ui.Cells.m8) view).a();
            t70 t70Var = u70Var.f;
            u70Var.d0((TLRPC.TL_messages_stickerSet) t70Var.e.get((i10 - t70Var.d.size()) - 1), a2, false);
        } else if (i10 != u70Var.f.d.size()) {
            u70Var.d0((TLRPC.TL_messages_stickerSet) u70Var.f.d.get(i10), ((org.telegram.ui.Cells.m8) view).a(), true);
        }
    }
    ...
    public static void V(u70 u70Var, TLRPC.TL_error tL_error) {
        ...
        TLRPC.TL_messages_stickerSet tL_messages_stickerSet = u70Var.r;
        if (tL_messages_stickerSet != null) {
            ...
            MediaDataController.getInstance(u70Var.currentAccount).putGroupStickerSet(u70Var.r);
        } else if (z10) {
        ...
        NotificationCenter.getInstance(u70Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupPackUpdated, Long.valueOf(u70Var.v.id), Boolean.valueOf(z10));
    ...
    public static void a0(u70 u70Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (tL_messages_stickerSet == null) {
            ...
            u70Var.r = tL_messages_stickerSet;
            u70Var.s = false;
            org.telegram.messenger.w1.o(R.string.GroupsEmojiPackUpdated, org.telegram.ui.Components.yc.a0(u70Var), R.raw.done, 36);
        }
        u70Var.h0();
        u70Var.f0(u70Var.r, false);
        if (i10 != -1) {
            if (!u70Var.M) {
    ...
    public final View createView(Context context) {
        ...
        this.e = new s70(this, context);
        this.f = new t70(this, context);
        ...
        this.a.addView(this.c, w7.x5.c(-1.0f, -1));
        org.telegram.ui.Components.xw0 xw0Var = new org.telegram.ui.Components.xw0(context, this.c, 1, null);
        this.b = xw0Var;
        n7.z0.g(xw0Var);
    ...
    public final void d0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.ux0 ux0Var = new org.telegram.ui.Components.ux0(getParentActivity(), this, tL_inputStickerSetShortName, !z11 ? tL_messages_stickerSet : null, null, null);
        ux0Var.d0 = new p70(this, z10, tL_messages_stickerSet);
        ux0Var.B0();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 16, new Class[]{org.telegram.ui.Cells.m8.class, org.telegram.ui.Cells.ea.class}, null, null, null, org.telegram.ui.ActionBar.j6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.z6));
