...
public final class nb0 extends org.telegram.ui.ActionBar.p2 {
    ...
    public final void Y(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        ...
        kb0 kb0Var = this.f;
        if (kb0Var != null) {
            kb0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false));
        ...
        lb0 lb0Var = this.r;
        if (lb0Var != null) {
            lb0Var.setVisibility(tL_chatInviteExported.subscription_pricing != null ? 0 : 8);
    ...
    public final View createView(Context context) {
        ...
        final int i11 = 0;
        this.J.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.fb0
            ...
            public final void onClick(View view) {
                ...
                switch (i11) {
                    case 0:
                        ...
                        long j11 = nb0Var.b;
                        ArrayList arrayList = nb0Var.O;
                        ArrayList arrayList2 = nb0Var.M;
                        if (!nb0Var.S) {
                            int selectedIndex = nb0Var.d.getSelectedIndex();
                            if (selectedIndex < arrayList2.size() && ((Integer) arrayList2.get(selectedIndex)).intValue() < 0) {
                                AndroidUtilities.shakeView(nb0Var.w);
                                Vibrator vibrator = (Vibrator) nb0Var.w.getContext().getSystemService("vibrator");
                                if (vibrator != null) {
                                ...
                                if (s8Var != null && s8Var.e.h) {
                                    try {
                                        j10 = Long.parseLong(nb0Var.r.b.getText().toString());
                                    } catch (Exception e) {
                                        FileLog.e(e);
                                    }
                                    i12 = nb0Var.a;
                                    if (i12 != 0) {
                                        org.telegram.ui.ActionBar.d2 d2Var = nb0Var.R;
                                        if (d2Var != null) {
                                            d2Var.dismiss();
                                        }
                                        nb0Var.S = true;
                                        org.telegram.ui.ActionBar.d2 d2Var2 = new org.telegram.ui.ActionBar.d2(nb0Var.getParentActivity(), 3, null);
                                        nb0Var.R = d2Var2;
                                        d2Var2.q(500L);
                                        TLRPC.TL_messages_exportChatInvite tL_messages_exportChatInvite = new TLRPC.TL_messages_exportChatInvite();
                                        tL_messages_exportChatInvite.peer = nb0Var.getMessagesController().getInputPeer(-j11);
                                        tL_messages_exportChatInvite.legacy_revoke_permanent = false;
                                        int selectedIndex2 = nb0Var.d.getSelectedIndex();
                                        tL_messages_exportChatInvite.flags |= 1;
                                        if (selectedIndex2 < arrayList2.size()) {
                                            tL_messages_exportChatInvite.expire_date = nb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList2.get(selectedIndex2)).intValue();
                                        } else {
                                            tL_messages_exportChatInvite.expire_date = 0;
                                        }
                                        int selectedIndex3 = nb0Var.c.getSelectedIndex();
                                        ...
                                        kb0 kb0Var2 = nb0Var.f;
                                        boolean z11 = kb0Var2 != null && kb0Var2.e.h;
                                        tL_messages_exportChatInvite.request_needed = z11;
                                        if (z11) {
                                            tL_messages_exportChatInvite.usage_limit = 0;
                                        }
                                        String obj2 = nb0Var.H.getText().toString();
                                        ...
                                        if (j10 > 0) {
                                            ...
                                            tL_starsSubscriptionPricing.period = nb0Var.getConnectionsManager().isTestBackend() ? 300 : 2592000;
                                            tL_messages_exportChatInvite.subscription_pricing.amount = j10;
                                        }
                                        final int i13 = 0;
                                        nb0Var.getConnectionsManager().sendRequest(tL_messages_exportChatInvite, new RequestDelegate() { // from class: org.telegram.ui.db0
                                            ...
                                            public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                                                switch (i13) {
                                                            ...
                                                            public final void run() {
                                                                switch (i14) {
                                                                    case 0:
                                                                        nb0 nb0Var3 = nb0Var2;
                                                                        nb0Var3.S = false;
                                                                        org.telegram.ui.ActionBar.d2 d2Var3 = nb0Var3.R;
                                                                        if (d2Var3 != null) {
                                                                            d2Var3.dismiss();
                                                                        }
                                                                        TLRPC.TL_error tL_error2 = tL_error;
                                                                        if (tL_error2 != null) {
                                                                            org.telegram.ui.Components.z4.u0(nb0Var3, null, tL_error2.text, null);
                                                                            break;
                                                                        } else {
                                                                            mb0 mb0Var = nb0Var3.Q;
                                                                            if (mb0Var != null) {
                                                                                mb0Var.c(tLObject);
                                                                            }
                                                                            nb0Var3.finishFragment();
                                                                            break;
                                                                        }
                                                                    default:
                                                                        nb0 nb0Var4 = nb0Var2;
                                                                        nb0Var4.S = false;
                                                                        org.telegram.ui.ActionBar.d2 d2Var4 = nb0Var4.R;
                                                                        if (d2Var4 != null) {
                                                                            d2Var4.dismiss();
                                                                        }
                                                                        TLRPC.TL_error tL_error3 = tL_error;
                                                                        if (tL_error3 != null) {
                                                                            org.telegram.ui.Components.z4.u0(nb0Var4, null, tL_error3.text, null);
                                                                            break;
                                                                        } else {
                                                                            TLObject tLObject2 = tLObject;
                                                                            if (tLObject2 instanceof TLRPC.TL_messages_exportedChatInvite) {
                                                                                nb0Var4.e = (TLRPC.TL_chatInviteExported) ((TLRPC.TL_messages_exportedChatInvite) tLObject2).invite;
                                                                            }
                                                                            mb0 mb0Var2 = nb0Var4.Q;
                                                                            if (mb0Var2 != null) {
                                                                                mb0Var2.b(nb0Var4.e, tLObject2);
                                                                            }
                                                                            nb0Var4.finishFragment();
                                                                            break;
                                                                        }
                                                                }
                                                            }
                                                    ...
                                                    default:
                                                        final int i15 = 1;
                                                        final nb0 nb0Var3 = nb0Var;
                                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.eb0
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                switch (i15) {
                                                                    case 0:
                                                                        nb0 nb0Var32 = nb0Var3;
                                                                        nb0Var32.S = false;
                                                                        org.telegram.ui.ActionBar.d2 d2Var3 = nb0Var32.R;
                                                                        if (d2Var3 != null) {
                                                                            d2Var3.dismiss();
                                                                        }
                                                                        TLRPC.TL_error tL_error2 = tL_error;
                                                                        if (tL_error2 != null) {
                                                                            org.telegram.ui.Components.z4.u0(nb0Var32, null, tL_error2.text, null);
                                                                            break;
                                                                        } else {
                                                                            mb0 mb0Var = nb0Var32.Q;
                                                                            if (mb0Var != null) {
                                                                                mb0Var.c(tLObject);
                                                                            }
                                                                            nb0Var32.finishFragment();
                                                                            break;
                                                                        }
                                                                    default:
                                                                        nb0 nb0Var4 = nb0Var3;
                                        ...
                                        org.telegram.ui.ActionBar.d2 d2Var3 = nb0Var.R;
                                        if (d2Var3 != null) {
                                            d2Var3.dismiss();
                                        }
                                        TLRPC.TL_messages_editExportedChatInvite tL_messages_editExportedChatInvite = new TLRPC.TL_messages_editExportedChatInvite();
                                        tL_messages_editExportedChatInvite.link = nb0Var.e.link;
                                        tL_messages_editExportedChatInvite.revoked = false;
                                        tL_messages_editExportedChatInvite.peer = nb0Var.getMessagesController().getInputPeer(-j11);
                                        int selectedIndex4 = nb0Var.d.getSelectedIndex();
                                        if (selectedIndex4 < arrayList2.size()) {
                                            if (nb0Var.T != ((Integer) arrayList2.get(selectedIndex4)).intValue()) {
                                                tL_messages_editExportedChatInvite.flags |= 1;
                                                tL_messages_editExportedChatInvite.expire_date = nb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList2.get(selectedIndex4)).intValue();
                                                z4 = true;
                                            }
                                            z4 = false;
                                        } else {
                                        ...
                                        if (selectedIndex5 < arrayList.size()) {
                                            ...
                                            obj = nb0Var.H.getText().toString();
                                            if (!TextUtils.equals(nb0Var.e.title, obj)) {
                                            ...
                                            if (!z4) {
                                                nb0Var.S = true;
                                                org.telegram.ui.ActionBar.d2 d2Var4 = new org.telegram.ui.ActionBar.d2(nb0Var.getParentActivity(), 3, null);
                                                nb0Var.R = d2Var4;
                                                d2Var4.q(500L);
                                                final int i15 = 1;
                                                nb0Var.getConnectionsManager().sendRequest(tL_messages_editExportedChatInvite, new RequestDelegate() { // from class: org.telegram.ui.db0
                                                    @Override // org.telegram.tgnet.RequestDelegate
                                                    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
                                                        switch (i15) {
                                                            case 0:
                                                                ...
                                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.eb0
                                                                    ...
                                                                    public final void run() {
                                                                        switch (i142) {
                                                                            case 0:
                                                                                nb0 nb0Var32 = nb0Var2;
                                                                                nb0Var32.S = false;
                                                                                org.telegram.ui.ActionBar.d2 d2Var32 = nb0Var32.R;
                                                                                if (d2Var32 != null) {
                                                                                    d2Var32.dismiss();
                                                                                }
                                                                                TLRPC.TL_error tL_error2 = tL_error;
                                                                            ...
                                                                            default:
                                                                                nb0 nb0Var4 = nb0Var2;
                                                                                nb0Var4.S = false;
                                                                                org.telegram.ui.ActionBar.d2 d2Var42 = nb0Var4.R;
                                                                                if (d2Var42 != null) {
                                                                                    d2Var42.dismiss();
                                                                                }
                                                                                TLRPC.TL_error tL_error3 = tL_error;
                    ...
                    default:
                        nb0 nb0Var2 = this.b;
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(nb0Var2.getParentActivity());
                        ...
                        alertDialog$Builder.k(LocaleController.getString(R.string.RevokeButton), new cb0(nb0Var2, 1));
                        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                        nb0Var2.showDialog(alertDialog$Builder.a);
                        break;
                }
            }
        });
        ...
        while (true) {
            ...
            i13 = yh.e(iArr[i13], i13, 1, arrayList);
        }
        ...
        ib0Var.addView(this.w, k7.b6.n(-1, 50));
        ...
        this.c = uv0Var2;
        uv0Var2.setCallback(new cb0(this, i12));
        X();
        ib0Var.addView(this.c);
        ...
        kb0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
        ...
        ib0Var.addView(this.f, k7.b6.n(-1, 56));
        ...
        if (chat == null || chat.username == null) {
            ...
            if ((this.e == null && ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j10))) && chatFull != null && chatFull.paid_media_allowed) || ((tL_chatInviteExported = this.e) != null && tL_chatInviteExported.subscription_pricing != null)) {
                ...
                this.n = s8Var;
                s8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
                ...
                this.n.setOnClickListener(new gb0(i11, this, new Runnable[1]));
                ib0Var.addView(this.n, k7.b6.n(-1, 48));
                TextView textView3 = new TextView(context);
                this.s = textView3;
                textView3.setTextSize(1, 16.0f);
                this.s.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.A6, false));
                lb0 lb0Var = new lb0(this, context, LocaleController.getString(getConnectionsManager().isTestBackend() ? R.string.RequireMonthlyFeePriceHintTest5Minutes : R.string.RequireMonthlyFeePriceHint), this.resourceProvider);
                this.r = lb0Var;
                lb0Var.b.setInputType(2);
                ...
                org.telegram.ui.Cells.g3 g3Var = lb0Var2.b;
                ...
                org.telegram.ui.Cells.g3 g3Var2 = lb0Var3.b;
                ...
                ib0Var.addView(this.r, k7.b6.n(-1, 48));
        ...
        jb0Var3.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
        this.H.setLines(1);
        this.H.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        this.H.setSingleLine();
        jb0 jb0Var4 = this.H;
        int i16 = org.telegram.ui.ActionBar.j6.G6;
        jb0Var4.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i16, false));
        ...
        if (i10 == 1) {
            ...
            this.F = aaVar;
            aaVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
            ...
            final int i17 = 1;
            this.F.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.fb0
                public final /* synthetic */ nb0 b;
                ...
                public final void onClick(View view) {
                    ...
                    switch (i17) {
                        case 0:
                            final nb0 nb0Var = this.b;
                            long j11 = nb0Var.b;
                            ArrayList arrayList2 = nb0Var.O;
                            ArrayList arrayList22 = nb0Var.M;
                            if (!nb0Var.S) {
                                int selectedIndex = nb0Var.d.getSelectedIndex();
                                if (selectedIndex < arrayList22.size() && ((Integer) arrayList22.get(selectedIndex)).intValue() < 0) {
                                    ...
                                    org.telegram.ui.Cells.s8 s8Var2 = nb0Var.n;
                                    if (s8Var2 != null && s8Var2.e.h) {
                                        try {
                                            j102 = Long.parseLong(nb0Var.r.b.getText().toString());
                                        } catch (Exception e) {
                                            FileLog.e(e);
                                        }
                                        i122 = nb0Var.a;
                                        if (i122 != 0) {
                                            ...
                                            if (selectedIndex2 < arrayList22.size()) {
                                                tL_messages_exportChatInvite.expire_date = nb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList22.get(selectedIndex2)).intValue();
                                            } else {
                                                tL_messages_exportChatInvite.expire_date = 0;
                                            }
                                            int selectedIndex3 = nb0Var.c.getSelectedIndex();
                                            ...
                                            kb0 kb0Var22 = nb0Var.f;
                                            boolean z11 = kb0Var22 != null && kb0Var22.e.h;
                                            tL_messages_exportChatInvite.request_needed = z11;
                                            if (z11) {
                                                tL_messages_exportChatInvite.usage_limit = 0;
                                            }
                                            ...
                                            if (selectedIndex4 < arrayList22.size()) {
                                                if (nb0Var.T != ((Integer) arrayList22.get(selectedIndex4)).intValue()) {
                                                    tL_messages_editExportedChatInvite.flags |= 1;
                                                    tL_messages_editExportedChatInvite.expire_date = nb0Var.getConnectionsManager().getCurrentTime() + ((Integer) arrayList22.get(selectedIndex4)).intValue();
                                                    z42 = true;
                                                }
                                                z42 = false;
                                            } else {
        ...
        j4Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i18, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.x, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.y, 0, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, i12));
