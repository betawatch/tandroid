...
public final class qa extends FrameLayout {
    ...
    public qa(ra raVar, Activity activity) {
        ...
        n90Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        n90Var.setGravity(LocaleController.isRTL ? 5 : 3);
        int i11 = org.telegram.ui.ActionBar.j6.J6;
        n90Var.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        int i12 = org.telegram.ui.ActionBar.j6.K6;
        n90Var.setHighlightColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
        ...
        if (raVar.x == 0) {
            org.telegram.ui.Cells.c1.r(R.string.UsernameHelp, n90Var);
            return;
        }
        ...
        if (indexOf != -1 && lastIndexOf != -1 && indexOf != lastIndexOf) {
            ...
            spannableStringBuilder.setSpan(new org.telegram.ui.Components.c61("https://fragment.com", (org.telegram.ui.Components.e11) null), indexOf, lastIndexOf - 1, 33);
        }
        n90Var.setText(spannableStringBuilder);
    }

    public static void a(final qa qaVar) {
        org.telegram.ui.Components.n90 n90Var = qaVar.a;
