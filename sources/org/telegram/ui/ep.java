    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.w != -1) {
            ...
            if (kpVar.h != null) {
                ...
                this.v = ofFloat;
                ofFloat.addUpdateListener(new pg(arrayList, height, i14));
    ...
    public final void setText(CharSequence charSequence) {
        if (charSequence != 0) {
            ...
            if (indexOf >= 0) {
                ...
                charSequence.setSpan(new ForegroundColorSpan(kpVar.getThemedColor(org.telegram.ui.ActionBar.j6.p7)), 0, indexOf, 33);
            }
