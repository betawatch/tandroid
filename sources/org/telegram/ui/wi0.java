    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.u1) {
                ...
                u1Var2.b4(i12, measuredHeight2 - i12, measuredHeight, f7, f7, vi0Var.getMeasuredWidth(), vi0Var.getMeasuredHeight(), 0, 0, 0);
            }
        }
        boolean z11 = true;
            ...
            if (i24 != 2 || wi0Var4.X1) {
                ...
                while (i25 < childCount3) {
                    ...
                    if (childAt6 instanceof org.telegram.ui.Cells.u1) {
                        ...
                        if (childAt6.getY() <= wi0Var4.getHeight() && childAt6.getY() + childAt6.getHeight() >= 0.0f && (currentMessagesGroup = u1Var5.getCurrentMessagesGroup()) != null) {
                            int i26 = i24 == 0 ? 1 : 1;
