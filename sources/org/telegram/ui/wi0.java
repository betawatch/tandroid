    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = wi0Var3.getChildAt(i10);
            if (childAt instanceof org.telegram.ui.Cells.t1) {
                org.telegram.ui.Cells.t1 t1Var2 = (org.telegram.ui.Cells.t1) childAt;
                RectF rectF = hh.k.h;
                hh.k.c(t1Var2, vi0Var, rectF);
                float f7 = rectF.top;
                int i11 = (int) f7;
                ...
                t1Var2.b4(i12, measuredHeight2 - i12, measuredHeight, f7, f7, vi0Var.getMeasuredWidth(), vi0Var.getMeasuredHeight(), 0, 0, 0);
            }
        }
        boolean z11 = true;
        ...
        while (true) {
            ...
            if (i14 != 2 || wi0Var3.X1) {
                ...
                while (i16 < childCount2) {
                    View childAt3 = wi0Var3.getChildAt(i16);
                ...
                while (i21 < arrayList.size()) {
                    ...
                    if (groupedMessages2 == null) {
                        ...
                        float f14 = f11;
                        if (f13 > AndroidUtilities.dp(20.0f) + wi0Var3.getMeasuredHeight()) {
                            f13 = AndroidUtilities.dp(20.0f) + wi0Var3.getMeasuredHeight();
                        }
                        float f15 = f13;
                        ...
                        if (z12) {
                            ...
                            for (int i22 = 0; i22 < childCount2; i22++) {
                                View childAt4 = wi0Var2.getChildAt(i22);
        ...
        while (i24 < 3) {
            ...
            if (i24 != 2 || wi0Var4.X1) {
                ...
                while (i25 < childCount3) {
                    View childAt6 = wi0Var4.getChildAt(i25);
                    if (childAt6 instanceof org.telegram.ui.Cells.t1) {
                        org.telegram.ui.Cells.t1 t1Var5 = (org.telegram.ui.Cells.t1) childAt6;
                        if (childAt6.getY() <= wi0Var4.getHeight() && childAt6.getY() + childAt6.getHeight() >= 0.0f && (currentMessagesGroup = t1Var5.getCurrentMessagesGroup()) != null) {
                            int i26 = i24 == 0 ? 1 : 1;
                ...
                for (int i31 = 0; i31 < arrayList2.size(); i31++) {
                    ...
                    if (f19 > AndroidUtilities.dp(20.0f) + wi0Var4.getMeasuredHeight()) {
                        f19 = AndroidUtilities.dp(20.0f) + wi0Var4.getMeasuredHeight();
                    }
                    dj0Var5.j(canvas, f16, f17, f18, f19);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        org.telegram.ui.Cells.t1 t1Var;
        dj0 dj0Var = this.b3;
        if (dj0Var.w && ((view == (t1Var = dj0Var.Q) && t1Var != null && t1Var.getCurrentPosition() == null) || view == dj0Var.X)) {
            return false;
        }
