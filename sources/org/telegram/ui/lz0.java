...
public final class lz0 implements org.telegram.ui.Components.ml0 {
    ...
    public lz0(ProfileActivity profileActivity, Context context) {
        this.c = profileActivity;
        this.b = context;
    }

    public static void a(lz0 lz0Var, Context context, int i10) {
        int i11;
        int i12;
        long j3;
        Long l4;
        ...
        int i18 = 0;
        if (i10 == 0) {
            lz0Var.c.getUserConfig().syncContacts = true;
            lz0Var.c.getUserConfig().saveConfig(false);
            lz0Var.c.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            lz0Var.c.getContactsController().loadContacts(false, 0L);
            return;
        }
        if (i10 == 2) {
            lz0Var.c.getContactsController().resetImportedContacts();
            return;
        }
        if (i10 == 3) {
            lz0Var.c.getMessagesController().forceResetDialogs();
            return;
        }
        if (i10 == 4) {
        ...
        if (i10 == 6) {
            ...
            edit.apply();
            i16 = ((org.telegram.ui.ActionBar.n2) lz0Var.c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i16).edit();
            i17 = ((org.telegram.ui.ActionBar.n2) lz0Var.c).currentAccount;
        ...
        if (i10 == 7) {
            org.telegram.ui.Components.voip.f2.i(lz0Var.c.getParentActivity());
            return;
        }
        if (i10 == 8) {
        ...
        if (i10 == 9) {
            ((LaunchActivity) lz0Var.c.getParentActivity()).z(true);
            return;
        }
        if (i10 == 10) {
            lz0Var.c.getMessagesStorage().readAllDialogs(-1);
            return;
        }
        if (i10 == 11) {
        ...
        if (i10 == 13) {
            Set<String> set = lz0Var.c.getMessagesController().pendingSuggestions;
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(lz0Var.c.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 == 18) {
                w7.y.a((LaunchActivity) lz0Var.c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                return;
            }
            if (i10 == 19) {
                lz0Var.c.getMessagesController().loadAppConfig();
                TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                lz0Var.c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new iz0(lz0Var, i18));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(lz0Var.c.getParentActivity(), 0, lz0Var.c.z0);
                ...
                if (i10 == 23) {
                    boolean q6 = ci.d1.q(lz0Var.c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Toast.makeText(lz0Var.c.getParentActivity(), LocaleController.getString(!q6 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i18 < lz0Var.c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.n2) lz0Var.c.getParentLayout().getFragmentStack().get(i18)).clearSheets();
                        i18++;
                    }
                    return;
                }
                ...
                if (i10 == 27) {
                    lz0Var.c.getMediaDataController().loadAttachMenuBots(false, true);
                    return;
                }
                if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.n2) lz0Var.c).currentAccount;
                ...
                if (i10 == 35) {
                    i11 = ((org.telegram.ui.ActionBar.n2) lz0Var.c).currentAccount;
            ...
            ProfileActivity.S0(lz0Var.c, MediaController.VIDEO_MIME_TYPE, sb3);
            ProfileActivity.S0(lz0Var.c, "video/hevc", sb3);
            ProfileActivity.S0(lz0Var.c, "video/x-vnd.on2.vp8", sb3);
            ProfileActivity.S0(lz0Var.c, "video/x-vnd.on2.vp9", sb3);
            lz0Var.c.showDialog(new kz0(lz0Var, lz0Var.c.getParentActivity(), sb3.toString()));
