...
public final class mk extends org.telegram.ui.Components.od {
    public final /* synthetic */ boolean e;
    public final /* synthetic */ xn f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public mk(xn xnVar, Context context, boolean z10) {
        super(context);
        this.f = xnVar;
        this.e = z10;
    }
    ...
    public final void d() {
        ...
        xn xnVar = this.f;
        setBackground(org.telegram.ui.ActionBar.h6.W(AndroidUtilities.dp(19.0f), 436207615 & xnVar.getThemedColor(i10), dp, AndroidUtilities.dp(3.0f), 0, AndroidUtilities.dp(3.0f)));
