...
public class b70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, le.e, View.OnClickListener, ph.d {
    ...
    public int l0;
    public int m0;
    public org.telegram.ui.Components.ml0 n;
    public int n0;
    ...
    public static void U(b70 b70Var, Context context, View view, int i10) {
        ...
        int i13 = 0;
        if (i10 == z60Var.w) {
            int i14 = b70Var.currentAccount;
            org.telegram.ui.ActionBar.d6 d6Var = b70Var.resourceProvider;
            r60 r60Var = new r60(b70Var, i13);
            org.telegram.ui.ActionBar.b2 b2Var = new org.telegram.ui.ActionBar.b2(context, 3, null);
            b2Var.q(500L);
            TL_phone.createConferenceCall createconferencecall = new TL_phone.createConferenceCall();
            createconferencecall.random_id = Utilities.random.nextInt();
            ConnectionsManager.getInstance(i14).sendRequest(createconferencecall, new ai.ya(i14, b2Var, context, d6Var, r60Var, 3));
            return;
        }
        if (i10 == 0 && z60Var.F != 0 && !z60Var.n) {
            org.telegram.ui.Components.ae0 ae0Var = new org.telegram.ui.Components.ae0(context, b70Var, b70Var.I, b70Var.G, j10 != 0);
            b70Var.d0 = ae0Var;
        ...
        if (view instanceof org.telegram.ui.Cells.g4) {
            ...
            if (g4Var.r) {
                ...
                if (n30Var == null) {
                    org.telegram.ui.Components.n30 n30Var2 = new org.telegram.ui.Components.n30(b70Var.f.r.getContext(), "premium");
                    b70Var.X = n30Var2;
                    b70Var.h.a(n30Var2);
            ...
            if (g4Var.s) {
                ...
                if (n30Var3 == null) {
                    org.telegram.ui.Components.n30 n30Var4 = new org.telegram.ui.Components.n30(b70Var.f.r.getContext(), "miniapps");
                    b70Var.Y = n30Var4;
                    b70Var.h.a(n30Var4);
            ...
            if (iVar == null || iVar.h(j3) < 0) {
                if (g4Var.O) {
                    int i15 = -b70Var.l0;
                    b70Var.l0 = i15;
                    AndroidUtilities.shakeViewSpring(g4Var, i15);
                    BotWebViewVibrationEffect.APP_ERROR.vibrate();
                    String userName = j3 >= 0 ? UserObject.getUserName(MessagesController.getInstance(b70Var.currentAccount).getUser(Long.valueOf(j3))) : "";
                    (MessagesController.getInstance(b70Var.currentAccount).premiumFeaturesBlocked() ? org.telegram.ui.Components.xc.a0(b70Var).Q(R.raw.star_premium_2, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserBlockedNonPremium, userName))) : org.telegram.ui.Components.xc.a0(b70Var).J(R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserBlockedNonPremium, userName)), LocaleController.getString(R.string.UserBlockedNonPremiumButton), new r60(b70Var, 2))).j();
                    return;
                }
                ...
                if (n30Var5 != null) {
                        ...
                        if (b70Var.R && user.bot) {
                            ...
                            if (j10 != 0) {
                                ...
                                if (canAddAdmins) {
                                    ...
                                    alertDialog$Builder2.k(LocaleController.getString(R.string.AddAsAdmin), new w10(i12, b70Var, user));
                    ...
                    org.telegram.ui.Components.n30 n30Var6 = new org.telegram.ui.Components.n30(b70Var.f.r.getContext(), object);
                    b70Var.h.a(n30Var6);
    ...
    public static void Z(b70 b70Var) {
        ...
        b70Var.c.a(!b70Var.Z.i(), true);
    }

    public static void a0(b70 b70Var, Canvas canvas, RectF rectF, Paint paint) {
        fh.d dVar;
        canvas.drawRect(rectF, paint);
        if (Build.VERSION.SDK_INT < 29 || !SharedConfig.chatBlurEnabled() || (dVar = b70Var.q0) == null) {
            return;
        }
    ...
    public final void D(int i10, float f7, float f10, le.f fVar) {
        ...
        if (paddingTop2 == paddingTop || ((le.c) this.e.c).f) {
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.h = t60Var;
        t60Var.setDelegate(new q60(this, i10));
        this.h.getSpansContainer().setOnClickListener(new s60(this, i10));
        t60 t60Var2 = this.h;
        this.Z = t60Var2.b;
        this.a0 = t60Var2.c;
        r0();
        this.f.r.setOnEditorActionListener(new ia(this, 4));
        this.f.r.setOnKeyListener(new u60(i10, this));
        ...
        org.telegram.ui.Components.ml0 ml0Var2 = this.n;
        ...
        org.telegram.ui.Components.ml0 ml0Var3 = this.n;
        float f7 = -this.a;
        k0Var.addView(ml0Var3, w7.x5.d(-1, -1.0f, 119, 0.0f, f7, 0.0f, f7));
        this.n.setOnItemClickListener(new ai.n6(17, this, context));
        this.n.setOnScrollListener(new i3(this, 13));
        org.telegram.ui.Components.ml0 ml0Var4 = this.n;
        ml0Var4.Y1 = true;
        ml0Var4.Z1 = 0;
        ...
        this.y.setOnClickListener(new s60(this, i11));
        ...
        if (z13) {
            ...
            dVar.setOnClickListener(new s60(this, i13));
            ...
            dVar2.setOnClickListener(new s60(this, i15));
        ...
        k0Var.addView(this.f, w7.x5.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        k0Var.addView(this.h);
        org.telegram.ui.Components.ml0 ml0Var5 = this.n;
        Objects.requireNonNull(ml0Var5);
        this.r0 = new ah.n(ml0Var5, k0Var, new ts(ml0Var5, i10));
        this.n.C0(new r60(this, i15));
    ...
    public final void e0() {
        ah.h hVar;
        if (Build.VERSION.SDK_INT < 31 || (hVar = this.p0) == null) {
            return;
        }
        ...
        hVar.g((this.F == null || this.c.e <= 0.0f) ? 1 : 2, this.s0);
        hVar.e(this.r0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
    }
    ...
    */
                ...
                if (this.h0 != (this.Y == null) && hashSet.size() == hashSet2.size()) {
                    ...
                    if (z11) {
                        if (z10) {
                            ...
                            alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new q60(this, 1));
                            alertDialog$Builder.h(LocaleController.getString(R.string.PassportDiscard), new q60(this, 2));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 32768, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 33554432, null, null, null, null, org.telegram.ui.ActionBar.h6.l7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 33554432, null, null, null, null, org.telegram.ui.ActionBar.h6.m7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 33554432, null, null, null, null, org.telegram.ui.ActionBar.h6.n7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 16, new Class[]{org.telegram.ui.Cells.f4.class}, null, null, null, org.telegram.ui.ActionBar.h6.e7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{org.telegram.ui.Cells.f4.class}, new String[]{"drawable"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.Zh));
        int i12 = org.telegram.ui.ActionBar.h6.ai;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 4, new Class[]{org.telegram.ui.Cells.f4.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 4, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 4, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.i7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 4, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.j7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 4, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.k7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 262148, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"statusTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.n6));
        int i13 = org.telegram.ui.ActionBar.h6.y6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 262148, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"statusTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{org.telegram.ui.Cells.g4.class}, null, org.telegram.ui.ActionBar.h6.r0, null, org.telegram.ui.ActionBar.h6.J7));
    ...
    public final void i0() {
        ...
        int B = org.telegram.messenger.z0.B(i10, this.n.getMeasuredHeight(), dp);
        Rect rect = this.o0;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.g4) {
                ...
                if (RecyclerView.R(childAt) == this.v.v) {
                    ((org.telegram.ui.Cells.v3) childAt).b((this.X == null && this.Z.i()) ? "" : LocaleController.getString(R.string.DeselectAll), new s60(this, 4));
                }
            }
        }
    }
            ...
            if (!z10) {
                ...
                if (this.E) {
                    ...
                    if (this.O || this.P) {
                        x60 x60Var = this.w;
                        if (x60Var != null) {
                            x60Var.b(arrayList2, this.X != null, this.Y != null);
                        }
                        finishFragment();
                        return true;
                    }
                ...
                if (!ChatObject.isChannel(chat)) {
                    ...
                    z1VarArr[0].setOnClickListener(new t20(z1VarArr, i12));
    ...
    public final void r0() {
        ...
        if (this.R || ((z60Var = this.v) != null && z60Var.G == 0)) {
