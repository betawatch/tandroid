...
public final /* synthetic */ class dg implements org.telegram.ui.Components.pj0 {
    public final /* synthetic */ int a;
    public final /* synthetic */ bo b;
    public final /* synthetic */ boolean c;
    public final /* synthetic */ MessageObject d;

    public /* synthetic */ dg(bo boVar, boolean z10, MessageObject messageObject, int i10) {
        this.a = i10;
        this.b = boVar;
        this.c = z10;
        ...
        switch (this.a) {
            case 0:
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    ...
                    if (j3 != boVar.getUserConfig().getClientUserId() && this.c) {
                        ...
                        final int i10 = 1;
                        boVar.getConnectionsManager().sendRequestTyped(tL_channels_getParticipant, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.mh
            ...
            default:
                ...
                if (messagePeerReaction != null && messagePeerReaction.reaction != null && j3 != boVar2.getUserConfig().getClientUserId() && this.c) {
                    ...
                    final int i11 = 0;
                    boVar2.getConnectionsManager().sendRequestTyped(tL_channels_getParticipant2, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.mh
                        @Override // org.telegram.messenger.Utilities.Callback2
                        public final void run(Object obj, Object obj2) {
                            TLRPC.TL_channels_channelParticipant tL_channels_channelParticipant = (TLRPC.TL_channels_channelParticipant) obj;
                            switch (i11) {
