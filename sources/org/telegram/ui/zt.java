...
public final class zt extends org.telegram.ui.Components.bb {
    ...
    public zt(Activity activity, HashSet hashSet) {
        ...
        w7.z5.a(imageView);
        final int i10 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.yt
        ...
        LinearLayout f10 = org.telegram.messenger.z0.f(activity, 0);
        ...
        final int i12 = 1;
        dVar.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.yt
            public final /* synthetic */ zt b;
        ...
        final int i13 = 2;
        dVar2.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.yt
            public final /* synthetic */ zt b;
    ...
    public static void Q(zt ztVar, TLObject tLObject, ci.d dVar, boolean z10, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (!(tLObject instanceof TLRPC.Updates)) {
            if (!(tLObject instanceof TL_phone.groupCall)) {
                if (tL_error != null) {
                    org.telegram.ui.Cells.q3.r(ztVar.topBulletinContainer, ztVar.resourcesProvider, tL_error, false);
                    return;
                }
                return;
            }
            TL_phone.groupCall groupcall = (TL_phone.groupCall) tLObject;
            MessagesController.getInstance(ztVar.currentAccount).putUsers(groupcall.users, false);
            MessagesController.getInstance(ztVar.currentAccount).putChats(groupcall.chats, false);
            ...
            ztVar.dismiss();
            org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, ztVar.currentAccount, tL_inputGroupCall, z10, groupcall.call, hashSet);
            return;
        }
        TLRPC.Updates updates = (TLRPC.Updates) tLObject;
        MessagesController.getInstance(ztVar.currentAccount).putUsers(updates.users, false);
        MessagesController.getInstance(ztVar.currentAccount).putChats(updates.chats, false);
        ...
        Utilities.stageQueue.postRunnable(new org.telegram.ui.Components.ar0(26, ztVar, updates));
        ...
        ztVar.dismiss();
        org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, ztVar.currentAccount, tL_inputGroupCall2, z10, groupCall2, hashSet);
    }

    public static void R(zt ztVar, ArrayList arrayList) {
        arrayList.add(org.telegram.ui.Components.h51.k(ztVar.X));
        arrayList.add(org.telegram.ui.Components.h51.B(null));
        ArrayList arrayList2 = ztVar.a0;
        ...
        for (int i10 = 0; i10 < arrayList2.size(); i10++) {
            ...
            l4.getClass();
            TLRPC.User user = MessagesController.getInstance(ztVar.currentAccount).getUser(l4);
            if (user == null) {
                return;
            }
            int i11 = xg.k.a;
            org.telegram.ui.Components.h51 J = org.telegram.ui.Components.h51.J(xg.k.class);
            J.G = user;
            J.K(ztVar.b0.contains(l4));
            arrayList.add(J);
        }
    }
    ...
    public final org.telegram.ui.Components.ll0 v(org.telegram.ui.Components.ml0 ml0Var) {
        org.telegram.ui.Components.v51 v51Var = new org.telegram.ui.Components.v51(ml0Var, getContext(), this.currentAccount, 0, true, new c5(this, 10), this.resourcesProvider);
        this.d0 = v51Var;
        return v51Var;
    }
