...
public final class zt extends org.telegram.ui.Components.il0 {
    ...
    public zt(cu cuVar, Context context, ArrayList arrayList, boolean z10) {
        ...
        if (arrayList != null) {
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ...
                String upperCase = xtVar.a.substring(0, 1).toUpperCase();
            ...
            try {
                ...
                while (true) {
                    ...
                    if (!str.equals("FT") || !z10) {
                        String upperCase2 = xtVar2.a.substring(0, 1).toUpperCase();
        ...
        while (it.hasNext()) {
            Collections.sort((ArrayList) it.next(), new yt(lb1Var, 0));
        }
    }
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        String str;
        if (c1Var.f == 0) {
            xt xtVar = (xt) ((ArrayList) this.s.get(this.v.get(i10))).get(i11);
