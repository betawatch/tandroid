...
public final class nu extends org.telegram.ui.Components.ql0 {
    ...
    */
        ...
        switch (i30) {
            case 1:
                ...
                if (i10 != i11) {
                    ...
                    if (i10 != i12) {
                        ...
                        if (i10 != i13) {
                            if (i10 != dataSettingsActivity.K) {
                                ...
                                if (i10 == i14) {
                                    z9Var.setIcon(0);
                                    z9Var.b(LocaleController.getString(R.string.PrivacyDeleteCloudDrafts), false);
                                    break;
                                }
                            } else {
                                z9Var.setIcon(0);
                                z9Var.b(LocaleController.getString(R.string.VoipQuickReplies), false);
                                break;
                            }
                        } else {
                            z9Var.setIcon(0);
                            ...
                            z9Var.b(LocaleController.getString(R.string.ResetAutomaticMediaDownload), false);
                            break;
                        }
                    } else {
                        z9Var.setIcon(0);
                        z9Var.b(LocaleController.getString(R.string.ProxySettings), false);
                        break;
                    }
                } else {
                    z9Var.setIcon(0);
                    ...
                    z9Var.c(LocaleController.getString(R.string.VoipUseLessData), str, dataSettingsActivity.S, true);
                            ...
                            if (i10 != dataSettingsActivity.C) {
                                if (i10 != dataSettingsActivity.G) {
                                    if (i10 == dataSettingsActivity.H) {
                                        r8Var.f(LocaleController.getString(R.string.AutoplayVideo), SharedConfig.isAutoplayVideo(), false);
                                        break;
                                    }
                                } else {
                                    r8Var.f(LocaleController.getString(R.string.AutoplayGIF), SharedConfig.isAutoplayGifs(), true);
                                    break;
                                }
                            } else {
                                r8Var.f("(beta only) Stream All Videos", SharedConfig.streamAllVideo, false);
                                break;
                            }
                        } else {
                            r8Var.f("(beta only) Show MKV as Video", SharedConfig.streamMkv, true);
                            break;
                        }
                    }
                } else {
                    r8Var.f(LocaleController.getString(R.string.EnableStreaming), SharedConfig.streamMedia, dataSettingsActivity.C != -1);
                    break;
                }
                break;
            case 4:
                ...
                if (i10 == dataSettingsActivity.E) {
                    z8Var.setText(LocaleController.getString(R.string.EnableAllStreamingInfo));
                    break;
                }
                break;
            case 5:
                ...
                if (i10 != i15) {
                    ...
                    if (i10 != i16) {
                        ...
                        i5Var.b(charSequence2, charSequence5, 0, z11, 0, true, z10, false);
                        break;
                    } else {
                ...
                i5Var.setAnimationsEnabled(true);
                i5Var.b(charSequence2, charSequence52, 0, z11, 0, true, z10, false);
                break;
            case 6:
                ...
                if (i10 != dataSettingsActivity.s) {
                    if (i10 != dataSettingsActivity.v) {
                        if (i10 == dataSettingsActivity.n) {
                            ...
                            n8Var.p(LocaleController.getString(R.string.StoragePath), LocaleController.getString((absolutePath == null || absolutePath.contains("/storage/emulated/")) ? R.string.InternalStorage : R.string.SdCard), true, R.drawable.msg_filled_sdcard, -1007845, -1996271, false);
                            break;
                        }
                    } else {
                        ...
                        n8Var.p(LocaleController.getString(R.string.NetworkUsage), AndroidUtilities.formatFileSize(statsController.getSentBytesCount(2, 6) + statsController.getSentBytesCount(1, 6) + statsController.getSentBytesCount(0, 6) + statsController.getReceivedBytesCount(2, 6) + statsController.getReceivedBytesCount(1, 6) + statsController.getReceivedBytesCount(0, 6)), true, R.drawable.msg_filled_datausage, -11154873, -14175180, dataSettingsActivity.n != -1);
                        break;
                    }
                } else {
                    if (dataSettingsActivity.U) {
                        n8Var.p(LocaleController.getString(R.string.StorageUsage), "", false, R.drawable.msg_filled_storageusage, -11565578, -13276952, true);
                        n8Var.f(45, true, dataSettingsActivity.T);
                    } else {
                        String string4 = LocaleController.getString(R.string.StorageUsage);
                        long j10 = dataSettingsActivity.V;
                        n8Var.p(string4, j10 <= 0 ? "" : AndroidUtilities.formatFileSize(j10), true, R.drawable.msg_filled_storageusage, -11565578, -13276952, true);
                        n8Var.f(45, false, dataSettingsActivity.T);
                    }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        View n8Var = i10 != 0 ? i10 != 1 ? i10 != 2 ? i10 != 3 ? i10 != 4 ? i10 != 5 ? new org.telegram.ui.Cells.n8(context) : new org.telegram.ui.Cells.i5(context) : new org.telegram.ui.Cells.z8(context) : new org.telegram.ui.Cells.r8(context) : new org.telegram.ui.Cells.l4(context, 22) : new org.telegram.ui.Cells.z9(context) : new org.telegram.ui.Cells.y6(context, (b) null);
        return ai.n(n8Var, n8Var, -1, -2);
    }
