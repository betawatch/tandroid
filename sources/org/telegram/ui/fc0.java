...
public final class fc0 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.kp h;
    public boolean n;
    public boolean r;
    public boolean s;
    public boolean v;
    ...
    public fc0(gc0 gc0Var, Context context) {
        super(context);
        this.y = gc0Var;
        ...
        this.d = k6Var;
        k6Var.b(0.35f, 200L, org.telegram.ui.Components.mr.h);
        ...
        kpVar.setImportantForAccessibility(2);
        boolean z4 = LocaleController.isRTL;
        addView(kpVar, k7.b6.d(21, 21.0f, (z4 ? 5 : 3) | 16, z4 ? 0.0f : 64.0f, 0.0f, z4 ? 64.0f : 0.0f, 0.0f));
        setFocusable(true);
    }
    ...
    */
    ...
    public final void b(boolean z4, boolean z10) {
        if (this.s != z4) {
            this.s = z4;
            org.telegram.ui.Components.kp kpVar = this.h;
            Switch r12 = this.f;
            ...
            if (z10) {
                ...
                kpVar.animate().alpha(z4 ? 0.5f : 1.0f).setDuration(220L).start();
            } else {
                imageView.setAlpha(z4 ? 0.5f : 1.0f);
                linearLayout.setAlpha(z4 ? 0.5f : 1.0f);
                r12.setAlpha(z4 ? 0.5f : 1.0f);
                kpVar.setAlpha(z4 ? 0.5f : 1.0f);
            }
            setEnabled(!z4);
        }
    }

    public final void c(ac0 ac0Var, boolean z4) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        org.telegram.ui.Components.kp kpVar = this.h;
        accessibilityNodeInfo.setClassName(kpVar.getVisibility() == 0 ? "android.widget.CheckBox" : "android.widget.Switch");
