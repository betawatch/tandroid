...
public final class bh0 extends org.telegram.ui.Components.g6 {
    ...
    public bh0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.H = new d10(this, 26);
        this.J = new Paint(1);
        new ArrayList();
        new ArrayList();
        o1.c cVar = o1.h.s;
        ...
        this.L = kVar2;
        kVar.u = org.telegram.ui.Cells.q3.l(1.0f, 1500.0f, 0.75f);
        ...
        kVar2.u = lVar3;
        this.P = new HashSet();
        this.Q = new le.c(0, new eu(this, 22), org.telegram.ui.Components.rr.h, 380L, false);
        this.R = new me.b(new g(this, 25));
        this.s = d6Var;
    }

    public static void k(bh0 bh0Var, View view, float f7, float f10) {
        float f11;
        float f12;
    ...
    public static void m(bh0 bh0Var, float f7, boolean z10, boolean z11) {
        View view;
        o1.k kVar = bh0Var.L;
        float f10 = Float.MAX_VALUE;
        if (bh0Var.getChildCount() != 0) {
            float f11 = -3.4028235E38f;
            boolean z12 = false;
            float f12 = Float.MAX_VALUE;
            for (int i10 = 0; i10 < bh0Var.getChildCount(); i10++) {
                View childAt = bh0Var.getChildAt(i10);
        ...
        if (bh0Var.getChildCount() == 0) {
            ...
            view = null;
            for (int i11 = 0; i11 < bh0Var.getChildCount(); i11++) {
                View childAt2 = bh0Var.getChildAt(i11);
        ...
        if (z10) {
            int childCount = bh0Var.getChildCount();
            int i12 = 0;
            while (true) {
                if (i12 >= childCount) {
                    break;
                }
                View childAt3 = bh0Var.getChildAt(i12);
                if (childAt3.getVisibility() == 0 && (childAt3 instanceof oh.b) && ((oh.b) childAt3).h.f) {
                    view2 = childAt3;
                    break;
                }
                i12++;
        ...
        if (view != null) {
            bh0Var.O = view;
            int childCount2 = bh0Var.getChildCount();
            for (int i13 = 0; i13 < childCount2; i13++) {
                View childAt4 = bh0Var.getChildAt(i13);
                if (childAt4 instanceof oh.b) {
                    ((oh.b) childAt4).e(childAt4 == view, true);
                }
            }
            if (z11) {
    ...
    public void setSkipDrawSelector(boolean z10) {
        this.I = z10;
        if (z10) {
            this.J.setColor(org.telegram.ui.ActionBar.h6.l1(0.09f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.al, this.s)));
        }
            ...
            if (getChildCount() != 0) {
                ...
                if (view != null || view2 != null) {
                    if (view == null) {
                        ...
                        float p5 = p(view);
                        float p10 = p(view2);
                        width = (view == view2 || p5 == p10) ? view.getWidth() : AndroidUtilities.lerp(view.getWidth(), view2.getWidth(), (f7 - p5) / (p10 - p5));
                    }
                    f10 = width;
                }
            }
    ...
    public final void o() {
        ...
        for (int i10 = 0; i10 < entriesCount; i10++) {
            le.h n10 = this.c.n(i10);
            ((oh.b) ((org.telegram.ui.Components.f6) n10.a).a).setVisualWidth(n10.b().width());
        }
    }
    ...
    @Override // org.telegram.ui.Components.g6, android.widget.LinearLayout, android.view.View
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (fArr[i14] != f11) {
                ...
                for (int i16 = 0; i16 < childCount; i16++) {
                    ...
                    if (d(childAt)) {
                        if (childAt instanceof ah0) {
                            oh.b bVar = (oh.b) ((ah0) childAt);
                            if (bVar.T == null) {
                                bVar.T = new TextPaint(bVar.F);
                            }
                            bVar.T.setTextSize(AndroidUtilities.dp(r9));
                            f10 = bVar.T.measureText(bVar.a.getText().toString());
                        } else {
                            f10 = 0.0f;
                        }
                        this.w[i16] = f10;
        ...
        for (int i18 = 0; i18 < childCount3; i18++) {
            ...
            if (childAt2 instanceof ah0) {
                ((oh.b) ((ah0) childAt2)).setTextSizeDp(f14);
            }
        }
        ...
        for (int i26 = 0; i26 < childCount8; i26++) {
            if (d(getChildAt(i26))) {
                this.E[i26] = Math.round(this.x[i26]);
                this.F[i26] = i25;
                i25 += this.E[i26];
            }
        }
        ...
        for (int i27 = 0; i27 < childCount9; i27++) {
            getChildAt(i27).measure(View.MeasureSpec.makeMeasureSpec(this.E[i27], TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(paddingTop, TLObject.FLAG_30));
        }
        a();
    }
