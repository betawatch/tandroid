...
public final /* synthetic */ class vf1 implements Runnable {
    ...
    public /* synthetic */ vf1(zf1 zf1Var, TLRPC.TL_error tL_error, int i10) {
        this.a = i10;
        this.b = zf1Var;
        this.c = tL_error;
    }
                ...
                if (tL_error != null) {
                    if (!tL_error.text.startsWith("CODE_INVALID")) {
                        if (!tL_error.text.startsWith("FLOOD_WAIT")) {
                            ...
                            zf1Var.G0(LocaleController.getString(R.string.AppName), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue2 < 60 ? LocaleController.formatPluralString("Seconds", intValue2, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue2 / 60, new Object[0])));
                            break;
                        }
                    } else {
                        zf1Var.y0();
