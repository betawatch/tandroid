...
public final class b80 extends DispatchQueue {
    ...
    public float r;
    public long s;
    public final org.telegram.ui.Components.wo0 v;
    public final w5 w;
    ...
    public b80(d80 d80Var, SurfaceTexture surfaceTexture) {
        ...
        this.x = d80Var;
        this.n = new int[24];
        this.v = new org.telegram.ui.Components.wo0(20);
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.vl.s(this.b, new StringBuilder("eglGetDisplay failed "));
            }
            finish();
            ...
            if (!this.b.eglChooseConfig(this.c, EmuDetector.with(d80Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    org.telegram.messenger.vl.s(this.b, new StringBuilder("eglChooseConfig failed "));
                }
                finish();
            } else if (iArr[0] > 0) {
                ...
                if (eglCreateContext == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.vl.s(this.b, new StringBuilder("eglCreateContext failed "));
                    }
                    finish();
                } else {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.vl.s(this.b, new StringBuilder("createWindowSurface failed "));
                            }
                            finish();
                            ...
                            c(new org.telegram.ui.Components.wo0(21), 22, false);
                            c(this.v, 23, false);
            ...
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.vl.s(this.b, new StringBuilder("eglInitialize failed "));
            }
            finish();
        }
        this.h = z10;
