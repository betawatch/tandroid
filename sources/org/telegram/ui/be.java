...
public final class be extends LinearLayout {
    ...
    public be(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.a.addView(this.b[i10], i7.f6.o(-1, -2, 1.0f, 119));
            ...
            this.b[i10].addView(this.c[i10], i7.f6.t(-2, -2, 80, 0, 0, 5, 0));
            ...
            this.b[i10].addView(this.d[i10], i7.f6.q(-2, -2, 80));
        }
    ...
    public void set(ae aeVar) {
        ...
        int i11 = 0;
        while (i11 < 2) {
            String str = i11 == 0 ? aeVar.b : aeVar.h;
            long j10 = i11 == 0 ? aeVar.e : aeVar.j;
            LinearLayout[] linearLayoutArr = this.b;
            if (i11 == 0 && !aeVar.a) {
                linearLayoutArr[i11].setVisibility(8);
            } else if (i11 != 1 || aeVar.g) {
                ...
                if (equalsIgnoreCase) {
                    String format = this.f.format(aeVar.d / 1.0E9d);
                    ...
                    if ("XTR".equalsIgnoreCase(str)) {
                        if (i10 == 0) {
                            ...
                            spannableStringBuilder2.append((CharSequence) jh.ia.J0(aeVar.i, 0.8f, ' '));
                        }
                ...
                this.d[i10].setText("≈" + BillingController.getInstance().formatCurrency(j10, aeVar.f));
                i11 = i10 + 1;
            } else {
                linearLayoutArr[i11].setVisibility(8);
            }
