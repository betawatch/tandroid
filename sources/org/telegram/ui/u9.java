    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.a) {
            case 0:
                ...
                if (!x9Var.a0() || view != x9Var.c) {
                    return drawChild;
                }
                float min = Math.min(1.0f, Math.max(0.0f, (SystemClock.elapsedRealtime() - x9Var.H) / 75.0f));
                if (min < 1.0f) {
                ...
                paint2.setAlpha((int) (Math.max(0.0f, 1.0f - x9Var.y) * 255.0f));
                canvas.drawRect(f14, f12, f15, f13, paint2);
                int lerp = AndroidUtilities.lerp(0, AndroidUtilities.dp(4.0f), Math.min(1.0f, x9Var.y * 20.0f));
                int i16 = lerp / 2;
                int lerp2 = AndroidUtilities.lerp(Math.min(i10, i11), AndroidUtilities.dp(20.0f), Math.min(1.2f, (float) Math.pow(x9Var.y, 1.7999999523162842d)));
                paint.setAlpha((int) (Math.min(1.0f, x9Var.y) * 255.0f));
                path.reset();
                int i17 = i13 + lerp2;
        ...
        switch (this.a) {
            case 0:
                ...
                if (i16 == 0) {
                    ...
                    if (cameraView != null) {
                        cameraView.layout(0, 0, cameraView.getMeasuredWidth(), x9Var.c.getMeasuredHeight());
                    }
                    x9Var.f.setTextSize(0, i15 / 22);
                    x9Var.f.setPadding(0, 0, 0, i15 / 15);
                    int i17 = (int) (i15 * 0.65f);
                    x9Var.a.layout(AndroidUtilities.dp(36.0f), i17, x9Var.a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), x9Var.a.getMeasuredHeight() + i17);
                } else {
                    ...
                    if (cameraView2 != null) {
                        cameraView2.layout(0, 0, cameraView2.getMeasuredWidth(), x9Var.c.getMeasuredHeight());
                    }
                    int min = (int) (Math.min(i14, i15) / 1.5f);
                    if (i16 == 1) {
                        measuredHeight = ((i15 - min) / 2) - x9Var.a.getMeasuredHeight();
                    ...
                    x9Var.a.layout(AndroidUtilities.dp(36.0f), i18, x9Var.a.getMeasuredWidth() + AndroidUtilities.dp(36.0f), x9Var.a.getMeasuredHeight() + i18);
                    if (i16 == 3) {
                        int C = org.telegram.messenger.y3.C(8.0f, x9Var.a.getMeasuredHeight(), i18);
                        x9Var.b.layout(AndroidUtilities.dp(36.0f), C, x9Var.b.getMeasuredWidth() + AndroidUtilities.dp(36.0f), x9Var.b.getMeasuredHeight() + C);
                    }
                    x9Var.f.layout(0, getMeasuredHeight() - x9Var.f.getMeasuredHeight(), getMeasuredWidth(), getMeasuredHeight());
                    int measuredWidth2 = (i14 / 2) - (x9Var.r.getMeasuredWidth() / 2);
                    int dp2 = AndroidUtilities.dp(80.0f) + kf.k0.d(i15, min, 2, min);
                    ImageView imageView = x9Var.r;
                    imageView.layout(measuredWidth2, dp2, imageView.getMeasuredWidth() + measuredWidth2, x9Var.r.getMeasuredHeight() + dp2);
                }
                if (i16 != 3) {
                    int i19 = (int) (i15 * 0.74f);
                    int i20 = (int) (i14 * 0.05f);
                    TextView textView = x9Var.b;
                    textView.layout(i20, i19, textView.getMeasuredWidth() + i20, x9Var.b.getMeasuredHeight() + i19);
                }
                x9Var.h0();
                break;
            default:
                ...
                i0Var.layout(0, 0, i0Var.getMeasuredWidth(), wg1Var.y.getMeasuredHeight());
                org.telegram.ui.Components.y90 y90Var = (org.telegram.ui.Components.y90) this.b;
        ...
        switch (this.a) {
            case 0:
                ...
                if (i12 == 0) {
                    ...
                    x9Var.f.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                    x9Var.r.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(60.0f), TLObject.FLAG_30));
                }
                x9Var.a.measure(b.d(72.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                if (i12 == 3) {
                    x9Var.b.measure(b.d(72.0f, size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                } else {
                    x9Var.b.measure(View.MeasureSpec.makeMeasureSpec((int) (size * 0.9f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                }
            ...
            default:
                ...
                ((org.telegram.ui.Components.y90) this.b).measure(View.MeasureSpec.makeMeasureSpec(size3, TLObject.FLAG_30), i11);
