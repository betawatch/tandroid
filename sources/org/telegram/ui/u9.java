...
public final class u9 extends TextView {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.a) {
            case 1:
                int l1 = org.telegram.ui.ActionBar.j6.l1(0.15f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.o6, ((org.telegram.ui.Components.jn0) this.e).c));
                Paint paint = this.b;
                paint.setColor(l1);
    ...
    public void onDraw(Canvas canvas) {
        switch (this.a) {
            case 0:
                org.telegram.ui.Components.w80 w80Var = (org.telegram.ui.Components.w80) this.c;
                if (w80Var != null) {
                    canvas.drawPath(w80Var, this.b);
                }
                ...
                if (getText() instanceof Spanned) {
                    ...
                    if (n51VarArr != null && n51VarArr.length > 0) {
                        ...
                        for (int i12 = 0; i12 < n51VarArr.length; i12++) {
                            ...
                            ((org.telegram.ui.Components.w80) this.c).d(getLayout(), spanStart, 0.0f);
                            int i13 = getText() != null ? getPaint().baselineShift : 0;
                            org.telegram.ui.Components.w80 w80Var2 = (org.telegram.ui.Components.w80) this.c;
                            w80Var2.o = i13 != 0 ? AndroidUtilities.dp(i13 > 0 ? 5.0f : -2.0f) + i13 : 0;
                            getLayout().getSelectionPath(spanStart, spanEnd, (org.telegram.ui.Components.w80) this.c);
                        }
                        ((org.telegram.ui.Components.w80) this.c).n = true;
                        break;
                    }
                }
                break;
                        ...
                        if (clickableSpanArr.length != 0) {
                            ...
                            if (motionEvent.getAction() != 0) {
                                if (motionEvent.getAction() == 1) {
                                    org.telegram.ui.Components.d90 d90Var = (org.telegram.ui.Components.d90) this.d;
                                    if (d90Var != null) {
                                ...
                                org.telegram.ui.Components.d90 d90Var2 = new org.telegram.ui.Components.d90(clickableSpanArr[0], null, motionEvent.getX(), motionEvent.getY(), 0);
                                this.d = d90Var2;
                                d90Var2.d(771751935);
                                z80Var.a((org.telegram.ui.Components.d90) this.d, null);
                                int spanStart = spannable.getSpanStart(((org.telegram.ui.Components.d90) this.d).i);
                                int spanEnd = spannable.getSpanEnd(((org.telegram.ui.Components.d90) this.d).i);
