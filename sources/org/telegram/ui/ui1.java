...
public final class ui1 implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate, rf.a {
    ...
    public static void j(ui1 ui1Var) {
        ...
        if (ui1Var.g1) {
            ...
            ui1Var.i1 = ofFloat;
            ui1Var2 = ui1Var;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.x(ui1Var2, ui1Var.f1, ui1Var.Y0, ui1Var.Z0, 1));
            ui1Var2.i1.addListener(new ii1(ui1Var2, i10));
            ui1Var2.i1.setDuration(350L);
            ui1Var2.i1.setInterpolator(org.telegram.ui.Components.qr.f);
            ui1Var2.i1.start();
        } else {
            ui1Var2 = ui1Var;
        }
        ...
        if (ui1Var != null) {
            if (i10 == 101) {
                ...
                if (iArr.length > 0 && iArr[0] == 0) {
                    ...
                    org.telegram.ui.Components.voip.f2.h(ui1Var.b, new ei1(ui1Var, 2), i10);
                    return;
                }
            }
            if (i10 == 102) {
    ...
    public static void w(Activity activity, int i10) {
        ...
        org.telegram.ui.Components.voip.q1 q1Var = ui1Var3.r;
        ...
        ui1Var3.x = e3Var;
        pi1Var.addView(e3Var, w7.x5.c(220.0f, -1));
        ...
        while (i15 < 4) {
            ...
            ui1Var3.N.addView(u9VarArr[i15], w7.x5.k(i15 == 0 ? 0.0f : 6.0f, 0.0f, 0.0f, 0.0f, 25, 25));
            i15++;
        }
        ...
        ui1Var3.y = new org.telegram.ui.Components.voip.t0(activity);
        org.telegram.ui.Components.f9 f9Var = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.e6) null);
        f9Var.r(user);
        org.telegram.ui.Components.voip.t0 t0Var = ui1Var3.y;
        int i16 = ui1Var3.a;
        ...
        if (sharedState != null && sharedState.getUser() != null && sharedState.isConference() && sharedState.getGroupCall() != null) {
            ...
            if (groupParticipants != null || i19 > 0) {
                ...
                org.telegram.ui.Components.h9 h9Var = ti1Var.b;
                h9Var.k(min);
                int i20 = 0;
                while (i20 < min) {
                ...
                if (max == 1 && (groupParticipants == null || groupParticipants.size() == 0 || (groupParticipants.size() == 1 && DialogObject.getPeerDialogId(groupParticipants.get(0).peer) == j10))) {
                    ...
                    ti1Var.c = new org.telegram.ui.Components.g01(LocaleController.formatPluralStringComma("Participants", max), 14.0f, AndroidUtilities.bold());
        ...
        ui1Var3.j0 = new org.telegram.ui.Components.voip.r1(activity);
        ui1Var3.e = new org.telegram.ui.Components.voip.k3(activity, q1Var);
        ui1Var3.f = new org.telegram.ui.Components.voip.k3(activity, q1Var);
        ...
        if (z10) {
            ...
            if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                ui1Var3.c0.setStub(org.telegram.ui.Components.voip.m2.k().r);
                ui1Var3.d0.setStub(org.telegram.ui.Components.voip.m2.k().n);
            }
        ...
        if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && sf.c.a(activity) == 1) {
            ...
            org.telegram.ui.Components.voip.s2 s2Var3 = ui1Var4.c0;
            dVar.j = s2Var3.d;
            ...
            for (int i17 = 0; i17 < 4; i17++) {
                if (r62[i17].getVisibility() != 0) {
                    ...
                    if (z10) {
                        ...
                        org.telegram.messenger.vl.r(r62[i17].animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), org.telegram.ui.Components.qr.k, 250L);
                    }
                }
            }
    ...
    */
                ...
                if (i15 == 4) {
                    ...
                    if (TextUtils.equals(lastError, Instance.ERROR_UNKNOWN)) {
                        ...
                        if (this.U0) {
                            ...
                            rv0 rv0Var = new rv0(18, this, zArr);
                            y3Var.l0 = string2;
                            y3Var.m0 = rv0Var;
                            y3Var.show();
                            for (int i16 = 0; i16 < 3; i16++) {
                                if (zArr2[i16] && (textView = (TextView) y3Var.d(-(i16 + 1))) != null) {
                                    textView.setTextColor(y3Var.e(org.telegram.ui.ActionBar.i6.q7));
                                }
                            }
                        ...
                        case 11:
                            ...
                            if (!z21 || this.G0) {
                                ...
                                if (this.x0) {
                                    ...
                                    AndroidUtilities.runOnUIThread(new pb1(15, this, sharedInstance), 2L);
                                } else {
                                ...
                                org.telegram.ui.Components.qr qrVar2 = org.telegram.ui.Components.qr.f;
                                org.telegram.messenger.vl.r(alpha, qrVar2, 250L);
                            ...
                            if (z20) {
                                ...
                                if (!z19 && this.e0.getTag() != null) {
                                    ...
                                    if (!z12 && this.Z.getTag() == null) {
                                        ...
                                        u1Var3.c0 = true;
                                        u1Var3.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f).setStartDelay(150L).withEndAction(new ei1(this, 4)).start();
                                        this.Z.setTag(num);
                                    } else if (!z12 && this.Z.getTag() != null) {
                                        this.Z.setIsActive(false);
                                        this.Z.animate().alpha(0.0f).scaleX(0.5f).scaleY(0.5f).setListener(new ii1(this, 5)).setDuration(150L).setInterpolator(org.telegram.ui.Components.qr.f).start();
                                        this.Z.setTag(null);
                                    }
                                    this.Y.a();
                                    this.Z.a();
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        mi1 mi1Var = this.u0;
        mi1Var.getClass();
        windowManager.addView(mi1Var, org.telegram.ui.Components.voip.w2.a());
        this.m1 = false;
        H();
        this.u0.invalidate();
    ...
    public final void p() {
        ...
        if (sf.c.a(this.b) <= 0) {
            org.telegram.ui.Components.c5.B(this.b, new ci1(this, 0), true).o();
            return;
        }
        if (this.G0 || n1 == null) {
            return;
        ...
        if (VoIPService.getSharedInstance() != null) {
            ...
            ui1 ui1Var = n1;
            org.telegram.ui.Components.voip.m2.l(ui1Var.b, ui1Var.a, ui1Var.u0.getMeasuredWidth(), measuredHeight, 1);
    ...
    public final void x(boolean z10, boolean z11) {
        ...
        if (!z10) {
            ...
            this.y.animate().setListener(null).cancel();
            this.y.setTranslationY(0.0f);
            this.y.animate().alpha(0.0f).setDuration(150L).scaleX(0.1f).scaleY(0.1f).setInterpolator(org.telegram.ui.Components.qr.f).setListener(new ii1(this, 7)).start();
        }
