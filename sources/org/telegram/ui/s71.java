...
public final /* synthetic */ class s71 implements RequestDelegate {
    public final /* synthetic */ int a;
    public final /* synthetic */ SessionsActivity b;

    public /* synthetic */ s71(SessionsActivity sessionsActivity, int i10) {
        this.a = i10;
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.a) {
            case 0:
                AndroidUtilities.runOnUIThread(new xy0(this.b, 18));
                break;
            case 1:
                final int i10 = 1;
                final SessionsActivity sessionsActivity = this.b;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.u71
