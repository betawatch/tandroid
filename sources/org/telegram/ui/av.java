...
public final class av extends org.telegram.ui.ActionBar.n2 {
    ...
    public final View createView(Context context) {
        ...
        this.c.addView(this.b, w7.y5.c(48.0f, -1));
        ...
        getBaseSimpleGlass().g = new li.a(2, this, x5Var);
        getBaseSimpleGlass().f = null;
        x5Var.addView(this.c, w7.y5.d(-1, -2.0f, 48, -4.0f, 0.0f, -4.0f, 0.0f));
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        ...
        while (it.hasNext()) {
            wu wuVar = (wu) it.next();
            av avVar = wuVar.o3;
            li.b.a(wuVar, avVar.h, avVar.n, AndroidUtilities.dp(42.0f) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight());
        }
    }
