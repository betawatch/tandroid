    ...
    */
    public final void onClick(View view) {
        ...
        if (!string.equals(string2)) {
            ...
            org.telegram.ui.Components.yi0 yi0Var = this.c.d;
            yi0Var.P(q6 ? yi0Var.e[0] - 1 : 0);
            this.c.e.getImageView().d();
            int[] iArr = {(this.c.e.getImageView().getMeasuredWidth() / 2) + r2, org.telegram.messenger.z0.C(3.0f, this.c.e.getImageView().getMeasuredHeight() / 2, r2)};
        ...
        org.telegram.ui.Components.yi0 yi0Var2 = this.c.d;
        yi0Var2.P(q62 ? yi0Var2.e[0] - 1 : 0);
        this.c.e.getImageView().d();
        int[] iArr2 = {(this.c.e.getImageView().getMeasuredWidth() / 2) + i10, org.telegram.messenger.z0.C(3.0f, this.c.e.getImageView().getMeasuredHeight() / 2, i11)};
