...
public final class th0 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.rk0 h0;
    public final ArrayList i0;
    public final ArrayList j0;
    public final HashMap k0;
    public org.telegram.ui.Components.s60 l0;
    ...
    public th0(long j3, long j10, int i10) {
        ...
        this.q0 = new ih0(this);
        boolean z10 = false;
        this.r0 = false;
        this.s0 = new jh0(this);
    ...
    */
    public static /* synthetic */ void U(th0 th0Var, TLRPC.TL_chatInviteExported tL_chatInviteExported, TLRPC.TL_error tL_error, TLObject tLObject, boolean z10) {
        boolean z11;
        boolean z12;
        long j3 = th0Var.f;
        ArrayList arrayList = th0Var.j0;
        ArrayList arrayList2 = th0Var.i0;
        kh0 f02 = th0Var.f0();
        th0Var.W = false;
        th0Var.b0 = false;
        if (tL_chatInviteExported != null) {
            th0Var.e = tL_chatInviteExported;
            TLRPC.ChatFull chatFull = th0Var.d;
            if (chatFull != null) {
        ...
        if (tL_error == null) {
            ...
            if (z10) {
                ...
                if (j3 != th0Var.getAccountInstance().getUserConfig().clientUserId && arrayList2.size() == 0 && tL_messages_exportedChatInvites.invites.size() > 0) {
                    th0Var.e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInvites.invites.get(0);
                ...
                for (int i11 = 0; i11 < tL_messages_exportedChatInvites.invites.size(); i11++) {
                    ...
                    th0Var.c0(tL_chatInviteExported3);
                    arrayList2.add(tL_chatInviteExported3);
                }
            }
            for (int i12 = 0; i12 < tL_messages_exportedChatInvites.users.size(); i12++) {
                th0Var.k0.put(Long.valueOf(tL_messages_exportedChatInvites.users.get(i12).id), tL_messages_exportedChatInvites.users.get(i12));
            }
            int i13 = th0Var.X;
            if (tL_messages_exportedChatInvites.invites.size() == 0) {
                th0Var.b0 = false;
            } else if (z10) {
                th0Var.b0 = arrayList.size() + 1 < tL_messages_exportedChatInvites.count;
            } else {
                th0Var.b0 = arrayList2.size() + 1 < tL_messages_exportedChatInvites.count;
            }
            if (tL_messages_exportedChatInvites.invites.size() <= 0 || !th0Var.g0) {
                z11 = true;
            } else {
                org.telegram.ui.Components.rk0 rk0Var = th0Var.h0;
                if (rk0Var != null && !th0Var.isPaused) {
                    rk0Var.b(i13 + 1);
                }
                z11 = false;
            }
            TLRPC.ChatFull chatFull2 = th0Var.d;
            if (chatFull2 != null && !z10) {
                chatFull2.invitesCount = tL_messages_exportedChatInvites.count;
                th0Var.getMessagesStorage().saveChatLinksCount(th0Var.n, th0Var.d.invitesCount);
            }
        } else {
            th0Var.b0 = false;
            z11 = false;
        }
        if (th0Var.b0 || th0Var.r0 || j3 != th0Var.getAccountInstance().getUserConfig().clientUserId) {
            if (th0Var.b0 || th0Var.r0) {
                z12 = false;
                if (th0Var.b0) {
                }
                th0Var.resumeDelayedFragmentAnimation();
                if (z12) {
                    th0Var.d0(false);
                }
                if (!z11 && th0Var.a != null && th0Var.b.getChildCount() > 0) {
                    th0Var.h0(f02);
                    return;
                }
                th0Var.i0(true);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static /* synthetic */ void V(th0 th0Var, TLRPC.TL_error tL_error, TLObject tLObject) {
        org.telegram.ui.Components.rk0 rk0Var;
        ArrayList arrayList = th0Var.m0;
        th0Var.W = false;
        if (tL_error == null) {
            ...
            for (int i10 = 0; i10 < tL_messages_chatAdminsWithInvites.admins.size(); i10++) {
                ...
                if (tL_chatAdminWithInvites.admin_id != th0Var.getAccountInstance().getUserConfig().clientUserId) {
            ...
            for (int i11 = 0; i11 < tL_messages_chatAdminsWithInvites.users.size(); i11++) {
                ...
                th0Var.k0.put(Long.valueOf(user.id), user);
            }
        }
        int i12 = th0Var.X;
        th0Var.e0 = true;
        th0Var.b0 = false;
        if (arrayList.size() > 0 && (rk0Var = th0Var.h0) != null && !th0Var.isPaused && th0Var.g0) {
            rk0Var.b(i12 + 1);
        }
        if (th0Var.b0) {
        }
    ...
    public static void W(th0 th0Var) {
        if (th0Var.f != th0Var.getAccountInstance().getUserConfig().clientUserId) {
            th0Var.e0(th0Var.e);
            return;
        }
        TLRPC.TL_messages_exportChatInvite tL_messages_exportChatInvite = new TLRPC.TL_messages_exportChatInvite();
        tL_messages_exportChatInvite.peer = th0Var.getMessagesController().getInputPeer(-th0Var.n);
        ...
        AndroidUtilities.updateVisibleRows(th0Var.b);
    ...
    public final View createView(Context context) {
        ...
        this.h0 = new org.telegram.ui.Components.rk0(this.b, false);
        s4.j jVar = new s4.j();
        jVar.n(420L);
        ...
        this.b.setOnItemLongClickListener(new fh0(this));
    ...
    public final kh0 f0() {
        ...
        kh0Var.b = this.X;
        kh0Var.k.clear();
        kh0Var.k.addAll(this.i0);
        kh0Var.l.clear();
        kh0Var.l.addAll(this.j0);
        return kh0Var;
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 16, new Class[]{org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.f2.class, org.telegram.ui.Components.w80.class, qh0.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{mh0.class}, new String[]{"messageTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.g9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.f2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.o6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 32, new Class[]{org.telegram.ui.Cells.f2.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{org.telegram.ui.Cells.f2.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.k7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{qh0.class}, new String[]{"titleView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 0, new Class[]{qh0.class}, new String[]{"subtitleView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.b, 8, new Class[]{qh0.class}, new String[]{"optionsView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.Uh));
        return arrayList;
    }
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10) {
            this.g0 = true;
            if (z11 && (s60Var = this.l0) != null && s60Var.l0) {
                s60Var.show();
            }
        }
        this.t0.unlock();
