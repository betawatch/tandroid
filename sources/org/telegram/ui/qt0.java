...
public final class qt0 implements org.telegram.ui.Components.r71 {
    ...
    public final void onStateChanged(boolean z10, int i10) {
        ...
        if (u71Var2 != null) {
            u71Var2.O(b5.d.u() || photoViewer.r);
        }
        if (this.a && (u71Var = photoViewer.F2) != null && u71Var.p() != -9223372036854775807L) {
            this.a = false;
    ...
    public final boolean onSurfaceDestroyed(SurfaceTexture surfaceTexture) {
        ...
        PhotoViewer photoViewer = this.b;
        if (p5 != null && org.telegram.ui.Components.pg0.p().b.a != 0 && (textureView = photoViewer.w3) != null && textureView.getSurfaceTexture() == surfaceTexture) {
    ...
    public final void onVideoSizeChanged(int i10, int i11, int i12, float f7) {
        ...
        if (photoViewer.y2 != null) {
            ...
            if (photoViewer.B2 instanceof org.telegram.ui.Components.j71) {
                ...
                j71Var.d = i13;
                j71Var.e = i11;
                org.telegram.ui.Components.vz vzVar = j71Var.b;
                if (vzVar != null) {
