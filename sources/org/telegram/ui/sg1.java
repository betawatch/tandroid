...
public final class sg1 extends ViewGroup {
    ...
    public final void a(org.telegram.ui.Components.j30 j30Var, boolean z10) {
        ...
        ig.f fVar = usersSelectActivity.c;
        ...
        if (z10) {
            ...
            arrayList.clear();
            arrayList.add(ObjectAnimator.ofFloat(this.d, (Property<org.telegram.ui.Components.j30, Float>) View.SCALE_X, 0.01f, 1.0f));
            arrayList.add(ObjectAnimator.ofFloat(this.d, (Property<org.telegram.ui.Components.j30, Float>) View.SCALE_Y, 0.01f, 1.0f));
            arrayList.add(ObjectAnimator.ofFloat(this.d, (Property<org.telegram.ui.Components.j30, Float>) View.ALPHA, 0.0f, 1.0f));
        }
        addView(j30Var);
    }
    ...
    public final void b(org.telegram.ui.Components.j30 j30Var) {
        ...
        ArrayList arrayList = this.c;
        arrayList.clear();
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.j30, Float>) View.SCALE_X, 1.0f, 0.01f));
        arrayList.add(ObjectAnimator.ofFloat(this.e, (Property<org.telegram.ui.Components.j30, Float>) View.SCALE_Y, 1.0f, 0.01f));
                ...
                if (!this.b) {
                    ...
                    if (childAt == j30Var) {
                        ...
                        if (childAt.getTranslationX() != f9) {
                            i12 = 1;
                            arrayList.add(ObjectAnimator.ofFloat(childAt, (Property<View, Float>) property2, f9));
                        } else {
                            i12 = 1;
                        }
                        float f10 = dp2;
        ...
        if (!this.b) {
            ...
            if (this.a != null) {
                ...
                if (usersSelectActivity.c.getTranslationX() != f11) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.c, (Property<ig.f, Float>) property2, f11));
                }
                float translationY = usersSelectActivity.c.getTranslationY();
                float f12 = usersSelectActivity.M;
                if (translationY != f12) {
                    arrayList.add(ObjectAnimator.ofFloat(usersSelectActivity.c, (Property<ig.f, Float>) property, f12));
                }
