...
public final class j70 extends DispatchQueue {
    ...
    public float r;
    public long s;
    public final org.telegram.ui.Components.xo0 v;
    public final w5 w;
    public final /* synthetic */ k70 x;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j70(k70 k70Var, SurfaceTexture surfaceTexture) {
        super("EGLThread");
        this.x = k70Var;
        this.n = new int[24];
        this.v = new org.telegram.ui.Components.xo0(19);
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            ...
            k70 k70Var = this.x;
            if (!this.b.eglChooseConfig(this.c, EmuDetector.with(k70Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                ...
                if (eglCreateContext == null) {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            b(R.drawable.intro_powerful_mask, 17, org.telegram.ui.ActionBar.g6.w0(null, org.telegram.ui.ActionBar.g6.d6, false), false);
                            ...
                            c(new org.telegram.ui.Components.xo0(20), 22, false);
                            c(this.v, 23, false);
                            ...
                            k70Var.F = System.currentTimeMillis() - 1000;
                            z10 = true;
                        } else {
                            if (BuildVars.LOGS_ENABLED) {
