...
public abstract class y91 extends FrameLayout {
    ...
    public y91(Context context, int i10, vf.f fVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.d = cVar;
        cVar.d.setOnTouchListener(new org.telegram.ui.Components.cl0());
        final int i11 = 0;
        cVar.d.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.u91
        ...
        this.b.q0.setOnTouchListener(new org.telegram.ui.Components.cl0());
        final int i13 = 1;
        this.b.q0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.u91
            public final /* synthetic */ y91 b;
        ...
        final int i14 = 2;
        this.c.q0.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.u91
            public final /* synthetic */ y91 b;
        ...
        if (aa1Var != null && (bVar = aa1Var.d) != null && (arrayList = bVar.d) != null && arrayList.size() > 1) {
            for (int i10 = 0; i10 < this.r.d.d.size(); i10++) {
                ...
                if (i10 < arrayList2.size()) {
                    org.telegram.ui.Components.t00 t00Var = ((x91) arrayList2.get(i10)).a;
                    t00Var.getClass();
                    t00Var.r = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.d6, false);
                    t00Var.v = -1;
                    t00Var.s = w02;
                    t00Var.invalidate();
                }
    ...
    public final void e(aa1 aa1Var, boolean z4) {
        ...
        xf.e eVar = gVar.q0;
        boolean z12 = aa1Var.n;
        eVar.a = z12;
        cVar.c(!z12);
        if (aa1Var.d == null && aa1Var.f != null) {
        ...
        cVar.setUseWeekInterval(aa1Var.o);
        gVar.q0.setUseWeek(aa1Var.o);
        xf.e eVar2 = gVar.q0;
        ...
        if (size > 1) {
            for (int i10 = 0; i10 < size; i10++) {
                ...
                t00Var.setOnTouchListener(new org.telegram.ui.Components.cl0());
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (((wf.a) bVar.d.get(i12)).c.equals(((wf.a) this.r.d.d.get(i10)).c)) {
                        boolean z11 = ((x91) arrayList.get(i10)).a.b;
                        ((xf.f) arrayList2.get(i12)).n = z11;
                        ((xf.f) arrayList2.get(i12)).o = z11 ? 1.0f : 0.0f;
                        ((x91) arrayList.get(i10)).a.c = true;
                        ((x91) arrayList.get(i10)).a.animate().alpha(1.0f).start();
                        if (z11) {
                            i11++;
                        }
                        z10 = true;
                ...
                if (!z10) {
                    ((x91) arrayList.get(i10)).a.c = false;
                    ((x91) arrayList.get(i10)).a.animate().alpha(0.0f).start();
                }
                i10++;
            }
            if (i11 == 0) {
                for (int i13 = 0; i13 < this.r.d.d.size(); i13++) {
                    ((x91) arrayList.get(i13)).a.c = true;
                    ((x91) arrayList.get(i13)).a.animate().alpha(1.0f).start();
                }
                return;
            }
        }
    ...
    public final void h(boolean z4) {
        wf.b bVar;
        aa1 aa1Var = this.r;
        if (aa1Var == null || (bVar = aa1Var.d) == null || bVar.a == null) {
            return;
        }
        xf.c cVar = this.d;
        ...
        if (z4) {
            ...
            while (i10 < size) {
                ...
                i10++;
                x91 x91Var = (x91) obj;
                x91Var.a.animate().alpha(1.0f).start();
                x91Var.a.c = true;
            }
            a2.start();
            return;
