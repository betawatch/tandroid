...
public class nq extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public boolean A0;
    public int B0;
    public int C0;
    public int D0;
    ...
    public static void U(nq nqVar, long j3) {
        if (j3 != 0) {
            nqVar.s = j3;
            nqVar.w = MessagesController.getInstance(nqVar.currentAccount).getChat(Long.valueOf(j3));
            nqVar.r0(true);
        }
    }

    public static void V(final nq nqVar, org.telegram.ui.ActionBar.a3 a3Var, View view) {
        Runnable runnable;
        ...
        if (intValue == 0) {
            ...
            try {
                DatePickerDialog datePickerDialog = new DatePickerDialog(nqVar.getParentActivity(), new DatePickerDialog.OnDateSetListener() { // from class: org.telegram.ui.gq
                    ...
                    public final void onDateSet(DatePicker datePicker, int i10, int i11, int i12) {
                        ...
                        try {
                            TimePickerDialog timePickerDialog = new TimePickerDialog(nqVar2.getParentActivity(), new TimePickerDialog.OnTimeSetListener() { // from class: org.telegram.ui.jq
                                @Override // android.app.TimePickerDialog.OnTimeSetListener
                                public final void onTimeSet(TimePicker timePicker, int i13, int i14) {
                                    nq nqVar3 = nq.this;
                                    nqVar3.O.until_date = (i14 * 60) + (i13 * 3600) + time;
                                    nqVar3.a.m(nqVar3.M0);
                                }
                            }, 0, 0, true);
                            timePickerDialog.setButton(-1, LocaleController.getString(R.string.Set), timePickerDialog);
                            timePickerDialog.setButton(-2, LocaleController.getString(R.string.Cancel), new hq());
                            nqVar2.showDialog(timePickerDialog);
                        } catch (Exception e) {
                            FileLog.e(e);
                        }
                    }
                ...
                datePickerDialog.setButton(-2, LocaleController.getString(R.string.Cancel), new hq());
                datePickerDialog.setOnShowListener(new iq(0, datePicker));
                nqVar.showDialog(datePickerDialog);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
    ...
    public static /* synthetic */ boolean W(nq nqVar, TLRPC.TL_error tL_error) {
        nqVar.t0(false);
        if (tL_error == null || !"USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
            return true;
        }
        if (!ChatObject.isChannel(nqVar.w)) {
            ...
            j0Var.I1(nqVar.w, arrayList, null, null, null);
            j0Var.show();
        }
        return false;
    }
    ...
    */
    public static void X(nq nqVar, Context context, View view, int i10) {
        ...
        TLRPC.TL_chatBannedRights tL_chatBannedRights2 = nqVar.P;
        int i11 = nqVar.y;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = nqVar.M;
        if (nqVar.I || (nqVar.w.creator && i11 == 0 && i10 == nqVar.e0)) {
            boolean z15 = false;
            if (i10 == nqVar.z0) {
                if (!(view instanceof org.telegram.ui.Cells.w8) || ((org.telegram.ui.Cells.w8) view).isEnabled()) {
                    ...
                    nqVar.a.m(nqVar.z0);
                    if (nqVar.A0) {
                        nqVar.a.s(nqVar.z0 + 1, 10);
                        return;
                    } else {
                        nqVar.a.t(nqVar.z0 + 1, 10);
                        return;
                    }
                }
                return;
            ...
            if (i10 == i12) {
                if (!(view instanceof org.telegram.ui.Cells.w8) || ((org.telegram.ui.Cells.w8) view).isEnabled()) {
                    ...
                    nqVar.a.m(nqVar.N0);
                    if (nqVar.O0) {
                        nqVar.a.s(nqVar.N0 + 1, 3);
                        return;
                    } else {
                        nqVar.a.t(nqVar.N0 + 1, 3);
                        return;
                    }
                }
                return;
            ...
            if (i10 == i13) {
                if (!(view instanceof org.telegram.ui.Cells.w8) || ((org.telegram.ui.Cells.w8) view).isEnabled()) {
                    ...
                    nqVar.a.m(nqVar.S0);
                    if (nqVar.T0) {
                        nqVar.a.s(nqVar.S0 + 1, 3);
                        return;
                    } else {
                        nqVar.a.t(nqVar.S0 + 1, 3);
                        return;
                    }
                }
                return;
            ...
            if (i10 == 0) {
                ...
                nqVar.presentFragment(new ProfileActivity(bundle, null));
                return;
            }
            if (i10 == nqVar.p0) {
                if (i11 == 0) {
                    MessagesController.getInstance(nqVar.currentAccount).setUserAdminRole(nqVar.s, nqVar.v, new TLRPC.TL_chatAdminRights(), nqVar.S, nqVar.E, nqVar.getFragmentForAlert(0), nqVar.Z0, false, null, null);
                    kq kqVar = nqVar.X0;
                    if (kqVar != null) {
                        kqVar.b(0, tL_chatAdminRights, nqVar.O, nqVar.S);
                    }
            ...
            if (i10 == nqVar.M0) {
                if (nqVar.getParentActivity() == null) {
                    return;
                }
                ...
                n4Var.setHeight(47);
                n4Var.setText(LocaleController.getString(R.string.UserRestrictionsDuration));
                linearLayout.addView(n4Var);
                LinearLayout linearLayout2 = new LinearLayout(context);
                linearLayout2.setOrientation(1);
                int i14 = -2;
                linearLayout.addView(linearLayout2, w7.y5.n(-1, -2));
            ...
            if (view instanceof org.telegram.ui.Cells.a2) {
                ...
                if (i10 == nqVar.B0) {
                    ...
                    if ((nqVar.O.send_plain || tL_chatBannedRights2.send_plain) && (m10 = nqVar.c.m(nqVar.y0)) != null) {
                        AndroidUtilities.shakeViewSpring(m10);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        TLRPC.TL_chatBannedRights tL_chatBannedRights12 = nqVar.O;
                        z15 = !tL_chatBannedRights12.embed_links;
                        tL_chatBannedRights12.embed_links = z15;
                    }
                } else if (i10 == nqVar.I0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights13 = nqVar.O;
            ...
            if (view instanceof org.telegram.ui.Cells.w8) {
                ...
                if (!w8Var.isEnabled()) {
                    if (i11 == 2 || i11 == 0) {
                        if ((i10 != nqVar.X || tL_chatBannedRights2 == null || tL_chatBannedRights2.change_info) && ((i10 != nqVar.h0 || tL_chatBannedRights2 == null || tL_chatBannedRights2.pin_messages) && (i10 != nqVar.i0 || tL_chatBannedRights2 == null || tL_chatBannedRights2.edit_rank))) {
                            return;
                        }
                        AlertDialog$Builder alertDialog$Builder3 = new AlertDialog$Builder(nqVar.getParentActivity());
                ...
                if (i10 == nqVar.W) {
                    z16 = !nqVar.K;
                    nqVar.K = z16;
                    TLRPC.TL_chatAdminRights tL_chatAdminRights2 = nqVar.N;
                    FrameLayout frameLayout = nqVar.e;
                    if (frameLayout != null) {
                        frameLayout.invalidate();
                    }
                    int childCount = nqVar.b.getChildCount();
                    int i19 = 0;
                    while (i19 < childCount) {
                        View childAt = nqVar.b.getChildAt(i19);
                        nqVar.b.getClass();
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.w8) {
                            ...
                            if (z17) {
                                ...
                                i19++;
                                z15 = false;
                            } else if ((S != nqVar.X || tL_chatBannedRights2.change_info) && ((S != nqVar.h0 || tL_chatBannedRights2.pin_messages) && (S != nqVar.i0 || tL_chatBannedRights2.edit_rank))) {
                                org.telegram.ui.Cells.w8 w8Var3 = (org.telegram.ui.Cells.w8) childAt;
                                w8Var3.setChecked(z15);
                                w8Var3.b(S == nqVar.W, true);
                            } else {
                    ...
                    nqVar.a.l();
                    org.telegram.ui.Components.o6 o6Var = nqVar.f;
                    if (o6Var != null) {
                        ...
                        o6Var.c(sb2.toString(), true, nqVar.K);
                    }
                    ValueAnimator valueAnimator = nqVar.c1;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        nqVar.c1 = null;
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(nqVar.J, nqVar.K ? 1.0f : 0.0f);
                    nqVar.c1 = ofFloat;
                    ofFloat.addUpdateListener(new eq(nqVar, 1));
                    nqVar.c1.setDuration((long) (Math.abs(nqVar.J - (nqVar.K ? 1.0f : 0.0f)) * 200.0f));
                    nqVar.c1.start();
                } else if (i10 == nqVar.X) {
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights14 = nqVar.O;
                    ...
                    org.telegram.ui.Components.d5.v0(nqVar, LocaleController.getString(R.string.ApproveNewMembersTitle), AndroidUtilities.replaceTags(LocaleController.formatString(z16 ? z14 ? R.string.ApproveNewMembersDisabledMessageChannel : R.string.ApproveNewMembersDisabledMessageGroup : z14 ? R.string.ApproveNewMembersMessageChannel : R.string.ApproveNewMembersMessageGroup, DialogObject.getShortName(user))), LocaleController.getString(!z16 ? R.string.ApproveNewMembersEnable : R.string.ApproveNewMembersDisable), false, new dq(nqVar, !z16 ? user.id : 0L, 1));
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights15 = nqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights16 = nqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights17 = nqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights18 = nqVar.O;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights19 = nqVar.O;
                        z16 = !tL_chatBannedRights19.edit_rank;
                        tL_chatBannedRights19.edit_rank = z16;
                    }
                } else if (i11 == 1 && (tL_chatBannedRights = nqVar.O) != null) {
                    if (i10 == nqVar.y0) {
    ...
    public static void Y(nq nqVar, TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, TLRPC.TL_channels_editCreator tL_channels_editCreator) {
        boolean z10 = nqVar.E;
        TLRPC.User user = nqVar.v;
        if (tL_error == null) {
            if (inputCheckPasswordSRP != null) {
                nqVar.X0.a(user);
                nqVar.removeSelfFromStack();
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            if (inputCheckPasswordSRP == null) {
                ...
                b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, nqVar.w.title, UserObject.getFirstName(user)));
                alertDialog$Builder.k(LocaleController.getString(R.string.EditAdminTransferChangeOwner), new cq(nqVar, i11));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                nqVar.showDialog(b2Var);
                return;
            }
            return;
        }
        if (!"PASSWORD_MISSING".equals(tL_error.text) && !tL_error.text.startsWith("PASSWORD_TOO_FRESH_") && !tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
            if ("SRP_ID_INVALID".equals(tL_error.text)) {
                ConnectionsManager.getInstance(nqVar.currentAccount).sendRequest(new TL_account.getPassword(), new oo(i10, nqVar, twoStepVerificationActivity), 8);
                return;
            }
            if (!tL_error.text.equals("CHANNELS_TOO_MUCH")) {
                ...
                org.telegram.ui.Components.d5.h0(tL_error, nqVar, z10, nqVar.F, tL_channels_editCreator);
                return;
            }
            if (nqVar.getParentActivity() == null || AccountInstance.getInstance(nqVar.currentAccount).getUserConfig().isPremium()) {
                nqVar.presentFragment(new ue1(1));
                return;
            } else {
                nqVar.showDialog(new rg.j0(5, nqVar.currentAccount, nqVar.getParentActivity(), nqVar, null));
                return;
            }
        }
        if (twoStepVerificationActivity != null) {
        ...
        LinearLayout linearLayout3 = new LinearLayout(nqVar.getParentActivity());
        linearLayout3.setOrientation(0);
        linearLayout.addView(linearLayout3, w7.y5.k(0.0f, 11.0f, 0.0f, 0.0f, -1, -2));
        ImageView imageView2 = new ImageView(nqVar.getParentActivity());
        ...
        TextView textView3 = new TextView(nqVar.getParentActivity());
        ...
        if ("PASSWORD_MISSING".equals(tL_error.text)) {
            alertDialog$Builder2.k(LocaleController.getString(R.string.EditAdminTransferSetPassword), new cq(nqVar, 6));
            alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), null);
        } else {
            TextView textView4 = new TextView(nqVar.getParentActivity());
        ...
        nqVar.showDialog(b2Var2);
    }

    public static void Z(nq nqVar, long j3) {
        TLRPC.ChatFull chatFull = nqVar.x;
        long j10 = chatFull != null ? chatFull.guard_bot_id : 0L;
        TLRPC.User user = j10 != 0 ? nqVar.getMessagesController().getUser(Long.valueOf(j10)) : null;
        if (user != null && j3 != 0 && user.id != j3) {
            new org.telegram.ui.Components.w30(nqVar.getParentActivity(), nqVar.resourceProvider, user, nqVar.v, new dq(nqVar, j3, 0)).show();
            return;
        }
        nqVar.n = j3;
        nqVar.r = true;
    ...
    public static /* synthetic */ void a0(nq nqVar, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, long j3) {
        if (j3 != 0) {
            nqVar.s = j3;
            nqVar.w = MessagesController.getInstance(nqVar.currentAccount).getChat(Long.valueOf(j3));
    ...
    public static void f0(nq nqVar, View view) {
        if (view instanceof org.telegram.ui.Cells.n4) {
            ...
            n4Var.setText2(String.format("%d", Integer.valueOf(codePointCount)));
            org.telegram.ui.ActionBar.j5 textView2 = n4Var.getTextView2();
    ...
    public static boolean l0(nq nqVar) {
    ...
    public final View createView(Context context) {
        ...
        if (this.I || (!this.E && this.w.creator && UserObject.isUserSelf(this.v))) {
            ...
            this.h = new org.telegram.ui.Components.pr(mutate, new org.telegram.ui.Components.tp(org.telegram.ui.ActionBar.j6.w0(null, i11, false)));
            n10.h(1, 0, LocaleController.getString(R.string.Done), AndroidUtilities.dp(56.0f));
            n10.k(1).setIcon(this.h);
        }
        v7 v7Var = new v7(this, context, 1);
        this.fragmentView = v7Var;
        ...
        this.b = w0Var;
        w0Var.setClipChildren(i10 != 2);
        gg.b0 b0Var = new gg.b0(r1, z10, 5);
        this.c = b0Var;
        b0Var.E = 100;
        ...
        this.b.q1();
        this.b.setOnScrollListener(new h3(this, 6));
        this.b.setOnItemClickListener(new ai.o6(7, this, context));
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        e eVar = new e(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 16, new Class[]{org.telegram.ui.Cells.za.class, org.telegram.ui.Cells.fa.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.n4.class, org.telegram.ui.Cells.d9.class, org.telegram.ui.Cells.e6.class}, null, null, null, org.telegram.ui.ActionBar.j6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 262144, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 262144, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.m6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 262144, new Class[]{org.telegram.ui.Cells.n4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 262144, new Class[]{org.telegram.ui.Cells.n4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.A6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.za.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.za.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.za.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.za.class}, null, org.telegram.ui.ActionBar.j6.r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.j5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.q5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 8192, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"radioButton"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.D5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 16384, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"radioButton"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.E5));
        return arrayList;
    }
        ...
        if (i10 != 2) {
            if (!(i10 == 1 ? this.R.equals(ChatObject.getBannedRightsString(this.O)) : this.T.equals(this.S))) {
                ...
                if (z10) {
                    ...
                    alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new cq(this, i11));
    ...
    */
    public final void r0(boolean z10) {
        ...
        boolean isChannel = ChatObject.isChannel(nqVar.w);
        int i10 = nqVar.y;
        int i11 = 2;
        if (!isChannel) {
            if (i10 != 1) {
            ...
            MessagesController.getInstance(nqVar.currentAccount).convertToMegaGroup(nqVar.getParentActivity(), nqVar.s, nqVar, new cq(nqVar, 7));
            return;
        }
        boolean z11 = nqVar.F;
        TLRPC.User user = nqVar.v;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = nqVar.M;
        if (z10 && z11 && !nqVar.L && tL_chatAdminRights.manage_linked_peers && tL_chatAdminRights.change_info) {
            org.telegram.ui.Components.d5.v0(nqVar, LocaleController.getString(R.string.CommunityMakeAdminTitle), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.CommunityMakeAdminMessage, DialogObject.getShortName(user))), LocaleController.getString(R.string.CommunityMakeAdminPromote), false, new fq(nqVar, r6));
            return;
        }
        if (nqVar.v0 != -1 && (str = nqVar.S) != null && str.codePointCount(0, str.length()) > 16) {
            nqVar.b.y0(nqVar.v0);
            Vibrator vibrator = (Vibrator) nqVar.getParentActivity().getSystemService("vibrator");
            if (vibrator != null) {
                vibrator.vibrate(200L);
            }
            s4.c1 L = nqVar.b.L(nqVar.v0);
            if (L != null) {
                AndroidUtilities.shakeView(L.a);
                return;
            }
            return;
        }
        ...
        if (i10 == 0) {
            int i12 = nqVar.X0 == null ? 1 : 0;
            nqVar.t0(true);
            MessagesController.getInstance(nqVar.currentAccount).setUserAdminRole(nqVar.s, nqVar.v, nqVar.M, nqVar.S, nqVar.E, nqVar, (!nqVar.Z0 || z11) ? 0 : 1, false, null, new fq(nqVar, i11), new cq(nqVar, 8));
            nqVar = nqVar;
            r6 = i12;
        } else {
            if (i10 == 1) {
                if (nqVar.v0 >= 0) {
                    ...
                    tL_messages_editChatParticipantRank.peer = MessagesController.getInputPeer(nqVar.w);
                    ...
                    ConnectionsManager.getInstance(nqVar.currentAccount).sendRequest(tL_messages_editChatParticipantRank, null);
                }
                MessagesController.getInstance(nqVar.currentAccount).setParticipantBannedRole(nqVar.s, nqVar.v, null, nqVar.O, nqVar.E, nqVar.getFragmentForAlert(1));
                TLRPC.TL_chatBannedRights tL_chatBannedRights = nqVar.O;
                ...
                kq kqVar = nqVar.X0;
                if (kqVar != null) {
                    kqVar.b(i11, tL_chatAdminRights, tL_chatBannedRights, nqVar.S);
                }
            } else if (i10 == 2) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(nqVar.getParentActivity());
                String string = nqVar.K ? LocaleController.getString(R.string.AddBotAdmin) : LocaleController.getString(R.string.AddBot);
                org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.a;
                b2Var.R = string;
                boolean z13 = ChatObject.isChannel(nqVar.w) && !nqVar.w.megagroup;
                TLRPC.Chat chat = nqVar.w;
                String str4 = chat != null ? chat.title : "";
                b2Var.T = AndroidUtilities.replaceTags(nqVar.K ? z13 ? LocaleController.formatString(R.string.AddBotMessageAdminChannel, str4) : LocaleController.formatString(R.string.AddBotMessageAdminGroup, str4) : LocaleController.formatString(R.string.AddMembersAlertNamesText, UserObject.getUserName(user), str4));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                alertDialog$Builder.k(LocaleController.getString(nqVar.K ? R.string.AddAsAdmin : R.string.AddBot), new cq(nqVar, r6));
                nqVar.showDialog(b2Var);
                r6 = 0;
            }
        }
    ...
    public final void t0(boolean z10) {
        ...
        if (prVar != null) {
            ValueAnimator ofFloat = ValueAnimator.ofFloat(prVar.c, this.H ? 1.0f : 0.0f);
            this.b1 = ofFloat;
