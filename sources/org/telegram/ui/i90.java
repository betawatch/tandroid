...
public final /* synthetic */ class i90 implements Runnable {
    ...
    public /* synthetic */ i90(KeyEvent.Callback callback, TLObject tLObject, Object obj, TLRPC.TL_error tL_error, TLObject tLObject2, int i10) {
        this.a = i10;
        this.b = callback;
        this.d = tLObject;
        this.c = obj;
    ...
    /* JADX WARN: Type inference failed for: r0v72, types: [org.telegram.ui.ActionBar.o2, org.telegram.ui.yg0] */
    /* JADX WARN: Type inference failed for: r0v91, types: [org.telegram.ui.ActionBar.o2, org.telegram.ui.PrivacyControlActivity] */
    ...
    /* JADX WARN: Type inference failed for: r14v2, types: [org.telegram.ui.fj1] */
    ...
    /* JADX WARN: Type inference failed for: r6v20, types: [org.telegram.ui.ActionBar.o2, org.telegram.ui.ProfileActivity] */
    /* JADX WARN: Type inference failed for: r6v5, types: [org.telegram.ui.hc0] */
    ...
    */
    public final void run() {
        yo0 yo0Var;
        org.telegram.ui.Components.vc b10;
        int i10;
        int i11;
        int i12;
        int i13;
        ...
        switch (i17) {
            case 0:
                ...
                if (tLObject instanceof TLRPC.TL_wallPaper) {
                    ...
                    r62.B0(org.telegram.ui.Components.c5.N(r62, null, sb2.toString()));
                    break;
                }
            case 1:
            ...
            case 2:
                ...
                if (tLObject2 != null) {
                    if (tLObject2 instanceof TLRPC.TL_urlAuthResultRequest) {
                        kl0.b(false, launchActivity2.O, tL_messages_requestUrlAuth, (TLRPC.TL_urlAuthResultRequest) tLObject2, null, null, null, false, null);
                        break;
                    } else if (tLObject2 instanceof TLRPC.TL_urlAuthResultAccepted) {
                        kl0.b(false, launchActivity2.O, tL_messages_requestUrlAuth, (TLRPC.TL_urlAuthResultAccepted) tLObject2, null, null, null, false, null);
                        break;
                    } else if (tLObject2 instanceof TLRPC.TL_urlAuthResultDefault) {
                        org.telegram.ui.Components.c5.q0(U, str4, false, true);
                        break;
                    }
            ...
            case 3:
                ...
                if (i18 != 0) {
                    ...
                    if (i18 == 1) {
                        launchActivity3.B0(org.telegram.ui.Components.c5.N(launchActivity3, LocaleController.getString(R.string.Theme), LocaleController.getString(R.string.ThemeNotSupported)));
                        break;
                    } else {
                        launchActivity3.B0(org.telegram.ui.Components.c5.N(launchActivity3, LocaleController.getString(R.string.Theme), LocaleController.getString(R.string.ThemeNotFound)));
                        break;
                    }
                }
                break;
            case 4:
                ...
                if (tL_error4 != null) {
                    ...
                    if (tLObject4 instanceof TLRPC.TL_payments_paymentFormStars) {
                        xh.o4 o4Var = launchActivity4.Y0;
                        launchActivity4.Y0 = null;
                        yh.v5.y(i21, false).Y(null, tL_inputInvoiceSlug, (TLRPC.TL_payments_paymentFormStars) tLObject4, new bc0(r63, 1), new l90(o4Var, i19));
                        break;
                    } else {
                        if (tLObject4 instanceof TLRPC.PaymentForm) {
                            ...
                            yo0Var = new yo0(paymentForm, null, str5, LaunchActivity.U());
                        } else {
                            yo0Var = tLObject4 instanceof TLRPC.PaymentReceipt ? new yo0((TLRPC.PaymentReceipt) tLObject4) : null;
                        }
                        if (yo0Var != null) {
                            xh.o4 o4Var2 = launchActivity4.Y0;
                            if (o4Var2 != null) {
                                launchActivity4.Y0 = null;
                                yo0Var.Z0 = new nf(10, o4Var2);
                            }
                            r63.n(yo0Var, false);
                        }
                    }
            ...
            case 6:
                ...
                if (tLObject5 instanceof TLRPC.TL_auth_sentCode) {
                    ...
                    org.telegram.ui.Components.c5.f0(i11, tL_error5, yg0Var, tL_auth_resendCode, new Object[0]);
                    break;
                }
                break;
            case 7:
                    ...
                    if (str6 != null) {
                        if (str6.contains("EMAIL_INVALID")) {
                            ...
                            if (tL_error6.text.contains("PHONE_CODE_EXPIRED")) {
                                ...
                                i12 = ((org.telegram.ui.ActionBar.o2) yg0Var2).currentAccount;
                                org.telegram.ui.Components.c5.f0(i12, tL_error6, yg0Var2, sendverifyemailcode, nf0Var.w);
                                break;
                            }
                        } else {
                ...
                if (!(tLObject7 instanceof TL_account.TL_emailVerified) || yg0Var3.F != 3) {
                    if (tLObject7 instanceof TL_account.TL_emailVerifiedLogin) {
                        ...
                        if (tL_error7.text.contains("EMAIL_NOT_ALLOWED")) {
                            ...
                            i13 = ((org.telegram.ui.ActionBar.o2) yg0Var3).currentAccount;
                            org.telegram.ui.Components.c5.f0(i13, tL_error7, yg0Var3, verifyemail, new Object[0]);
                            break;
                        }
                    }
                } else {
            ...
            case 9:
                ...
                if (tLObject8 instanceof TLRPC.PaymentForm) {
                    ...
                    yo0 yo0Var2 = new yo0(tL_inputInvoicePremiumAuthCode, paymentForm2, null, null, 4, null, null, null, null, null, null, false, null, r03, true);
                    yo0Var2.V0 = true;
                    yo0Var2.c1 = new Utilities.Callback() { // from class: org.telegram.ui.cg0
                    ...
                    yo0Var2.d1 = new Utilities.Callback() { // from class: org.telegram.ui.cg0
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj6) {
                            switch (i19) {
                                case 0:
                    ...
                    yo0Var2.e1 = new o20(hg0Var, i19);
                    r03.presentFragment(yo0Var2);
                    break;
                } else if (tL_error8 != null) {
                    if ("PHONE_CODE_EXPIRED".equalsIgnoreCase(tL_error8.text)) {
                        AndroidUtilities.runOnUIThread(new dg0(hg0Var, r12));
                        break;
                    } else {
                        String str7 = tL_error8.text;
                        hg0Var.e = str7;
                        new org.telegram.ui.Components.vc(r03.Z, null).H(R.raw.error, LocaleController.formatString(R.string.UnknownErrorCode, str7));
                        break;
                    }
                } else {
                    new org.telegram.ui.Components.vc(r03.Z, null).H(R.raw.error, LocaleController.getString(R.string.UnknownError));
                    break;
                }
            case 10:
                lj0 lj0Var = (lj0) obj5;
            ...
            case 12:
                ...
                qn0 qn0Var = ((ym0) obj5).a;
                if (tL_error10 == null) {
                    ((tm0) qn0Var.B1).c(qn0Var.E, (String) qn0Var.s1.get("email"), null, null, null, null, null, null, null, null, sl0Var, aVar);
                    break;
                } else {
                    i14 = ((org.telegram.ui.ActionBar.o2) qn0Var).currentAccount;
                    org.telegram.ui.Components.c5.f0(i14, tL_error10, qn0Var, verifyemail2, new Object[0]);
                    aVar.b(null, null);
                    break;
                }
            case 13:
                ...
                qn0 qn0Var2 = mn0Var.Q;
                mn0Var.J = false;
                if (tL_error11 == null) {
                    qn0Var2.l1(bundle4, (TLRPC.TL_auth_sentCode) tLObject9, true);
                } else {
                    i15 = ((org.telegram.ui.ActionBar.o2) qn0Var2).currentAccount;
                    org.telegram.ui.ActionBar.c2 f02 = org.telegram.ui.Components.c5.f0(i15, tL_error11, qn0Var2, tL_auth_resendCode2, new Object[0]);
                    if (f02 != null && tL_error11.text.contains("PHONE_CODE_EXPIRED")) {
                        f02.m0 = new hn0(mn0Var, r12);
                    }
                }
                qn0Var2.x1();
                break;
            case 14:
                yo0.f0((yo0) obj5, (TLRPC.TL_error) obj2, (TLObject) obj4, (String) obj3, (TL_account.getPassword) obj);
                break;
            case 15:
                ClippingImageView[] clippingImageViewArr = (ClippingImageView[]) obj3;
                ArrayList arrayList = (ArrayList) obj4;
                Integer num = (Integer) obj;
                dv0 dv0Var2 = (dv0) obj2;
                PhotoViewer photoViewer = ((hu0) obj5).r;
                photoViewer.p4 = null;
                xu0 xu0Var = photoViewer.e0;
                if (xu0Var != null && photoViewer.g0 != null) {
                    ...
                    fv0 fv0Var = photoViewer.q4;
                    if (fv0Var != null) {
                        fv0Var.a.setVisible(true, true);
                    }
                    fv0 fv0Var2 = photoViewer.r4;
                    if (fv0Var2 != null && !fv0Var2.s) {
                        fv0Var2.a.setVisible(false, true);
                    }
                    if (arrayList != null && (i16 = photoViewer.c2) != 3 && i16 != 1 && ((dv0Var = photoViewer.d) == null || !dv0Var.O())) {
                        photoViewer.R1();
                    }
                    org.telegram.ui.Components.h71 h71Var = photoViewer.F2;
                    if (h71Var != null && h71Var.y() && photoViewer.r1 && !photoViewer.g7.isEmpty()) {
            ...
            case 17:
                ...
                if (((TLObject) obj4) instanceof TLRPC.TL_boolTrue) {
                    org.telegram.ui.Components.oc Q = org.telegram.ui.Components.vc.a0(r04).Q(R.raw.contact_check, 36, LocaleController.getString(R.string.PrivacyBirthdaySetDone));
                    Q.j = 5000;
                    Q.j();
                    break;
                } else {
                    ...
                    if (tL_error12 != null && (str = tL_error12.text) != null && str.startsWith("FLOOD_WAIT_")) {
                        if (r04.getParentActivity() != null) {
                            ...
                            f6Var = ((org.telegram.ui.ActionBar.o2) r04).resourceProvider;
                            ...
                            c2Var2.R = string;
                            c2Var2.T = LocaleController.getString(R.string.PrivacyBirthdayTooOftenMessage);
                            alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                            r04.showDialog(c2Var2);
                            break;
                        }
                    } else {
                        org.telegram.messenger.w1.o(R.string.UnknownError, org.telegram.ui.Components.vc.a0(r04), R.raw.error, 36);
                        break;
                    }
                }
                break;
            case 18:
                ...
                if (!(((TLRPC.ChannelParticipant) obj3) instanceof TLRPC.TL_channelParticipantAdmin) && !(chatParticipant instanceof TLRPC.TL_chatParticipantAdmin)) {
                    ...
                    c2Var3.R = string2;
                    c2Var3.T = LocaleController.formatString(R.string.AdminWillBeRemoved, ContactsController.formatName(user2.first_name, user2.last_name));
                    alertDialog$Builder2.k(LocaleController.getString(R.string.OK), new nl0(nkVar, 12));
                    alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), null);
                    r64.showDialog(c2Var3);
                    break;
                }
                break;
            case 19:
                ...
                if (tLObject10 instanceof TL_fragment.TL_collectibleInfo) {
                    ...
                    org.telegram.ui.Components.oc w10 = new org.telegram.ui.Components.vc(a01Var.w, profileActivity.z0).w(R.drawable.filled_username, AndroidUtilities.withLearnMore(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FragmentChannelUsername, str9, format, formatCurrency, TextUtils.isEmpty(formatCurrency2) ? "" : a4.a.p("(", formatCurrency2, ")"))), new ky0(i18, profileActivity, tL_collectibleInfo)));
                    uv uvVar = new uv(29, profileActivity, tL_collectibleInfo);
                    org.telegram.ui.Components.sb sbVar = w10.e;
                    if (sbVar != null) {
                        sbVar.setOnClickListener(uvVar);
                    }
                    w10.k(false);
                    break;
                } else {
                    org.telegram.ui.Components.vc.b0(tL_error13);
                    break;
                }
            case 20:
                ...
                if (tLObject11 instanceof TL_fragment.TL_collectibleInfo) {
                    k20.a(profileActivity2.getParentActivity(), 1, str10, user3, (TL_fragment.TL_collectibleInfo) tLObject11, profileActivity2.z0);
                    break;
                } else {
                    org.telegram.ui.Components.vc.b0(tL_error14);
                    break;
                }
            case 21:
            ...
            case 22:
                ...
                if (((String) obj3).equals(l11Var.y)) {
                    if (!l11Var.w && (o2Var2 instanceof ProfileActivity)) {
                        try {
                            ((ProfileActivity) o2Var2).P.b.getImageReceiver().startAnimation();
                            ((ProfileActivity) o2Var2).P.d.setText(LocaleController.getString(R.string.SettingsNoResults));
                        } catch (Exception e11) {
                            FileLog.e(e11);
                        }
                    }
            ...
            case 23:
                i71 i71Var = (i71) obj5;
                i71Var.getClass();
                i71Var.p((View) obj3, Long.valueOf(((org.telegram.ui.Components.x5) obj4).documentId), (TLRPC.Document) obj, ((r61) obj2).v, null);
                break;
            case 24:
                s71 s71Var = (s71) obj5;
                ...
                if (tL_error15 == null) {
                    ...
                    s71Var.T(user4, twoStepVerificationActivity.l0(), twoStepVerificationActivity);
                    break;
                }
                break;
            case 25:
            ...
            default:
                ...
                int i23 = y4Var.Y;
                org.telegram.ui.ActionBar.o2 o2Var3 = y4Var.n;
                if (((TLObject) obj4) instanceof TLRPC.TL_boolTrue) {
                    BillingController billingController = BillingController.getInstance();
                    Activity parentActivity2 = o2Var3.getParentActivity();
                    ...
                    org.telegram.ui.Components.c5.f0(i23, tL_error19, o2Var3, tL_payments_canPurchaseStore, new Object[0]);
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ i90(Object obj, Object obj2, Object obj3, Object obj4, Object obj5, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
        this.d = obj3;
    ...
    public /* synthetic */ i90(Object obj, TLObject tLObject, Object obj2, Object obj3, TLRPC.TL_error tL_error, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = tLObject;
        this.c = obj2;
    ...
    public /* synthetic */ i90(Object obj, TLRPC.TL_error tL_error, Object obj2, Object obj3, Object obj4, int i10) {
        this.a = i10;
        this.b = obj;
        this.f = tL_error;
        this.c = obj2;
    ...
    public /* synthetic */ i90(Object obj, TLRPC.TL_error tL_error, TLObject tLObject, Object obj2, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.f = tL_error;
        this.d = tLObject;
    ...
    public /* synthetic */ i90(TLObject tLObject, MessagesController messagesController, ai.e4 e4Var, tg.h hVar, TLRPC.TL_error tL_error) {
        this.a = 27;
        this.d = tLObject;
    ...
    public /* synthetic */ i90(TLRPC.TL_error tL_error, Utilities.Callback callback, TLObject tLObject, MessagesController messagesController, Utilities.Callback callback2, int i10) {
        this.a = i10;
        this.f = tL_error;
        this.b = callback;
        this.d = tLObject;
    ...
    public /* synthetic */ i90(LaunchActivity launchActivity, TLObject tLObject, org.telegram.ui.ActionBar.c2 c2Var, oa0 oa0Var, TLRPC.TL_error tL_error) {
        this.a = 3;
    ...
    public /* synthetic */ i90(ek0 ek0Var, TLRPC.TL_contacts_importedContacts tL_contacts_importedContacts, TLRPC.TL_inputPhoneContact tL_inputPhoneContact, TLRPC.TL_error tL_error, TLRPC.TL_contacts_importContacts tL_contacts_importContacts) {
        this.a = 11;
        this.b = ek0Var;
