...
public final class mh0 extends FrameLayout {
    ...
    public mh0(ph0 ph0Var, Context context) {
        super(context);
        this.H = ph0Var;
        this.s = new Paint(1);
        ...
        imageView.setOnClickListener(new e60(this, 9));
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            SpannableStringBuilder X0 = lh.ja.X0(false, kh.a2.l(tL_chatInviteExported.subscription_pricing.amount, ',', new StringBuilder("⭐️ ")), 0.75f, null);
        ...
        if (!isEmpty) {
            ...
            i11 = ((org.telegram.ui.ActionBar.p2) ph0Var).currentAccount;
            ...
            if (i15 > 0 && i14 == 0 && !tL_chatInviteExported.expired && !tL_chatInviteExported.revoked) {
                ...
                if (tL_chatInviteExported.requested > 0) {
                    if (tL_chatInviteExported.usage > 0) {
                        formatPluralString = vh.v2.k(formatPluralString, ", ");
                    }
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            org.telegram.ui.Components.zs zsVar = new org.telegram.ui.Components.zs();
            zsVar.b = AndroidUtilities.dp(1.5f);
            spannableStringBuilder2.append((CharSequence) "  .  ").setSpan(zsVar, spannableStringBuilder2.length() - 3, spannableStringBuilder2.length() - 2, 0);
            ...
            org.telegram.ui.Components.zs zsVar2 = new org.telegram.ui.Components.zs();
            zsVar2.b = AndroidUtilities.dp(1.5f);
            spannableStringBuilder2.append((CharSequence) "  .  ").setSpan(zsVar2, spannableStringBuilder2.length() - 3, spannableStringBuilder2.length() - 2, 0);
            ...
            org.telegram.ui.Components.zs zsVar3 = new org.telegram.ui.Components.zs();
            zsVar3.b = AndroidUtilities.dp(1.5f);
            spannableStringBuilder2.append((CharSequence) "  .  ").setSpan(zsVar3, spannableStringBuilder2.length() - 3, spannableStringBuilder2.length() - 2, 0);
            long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((ph0Var.k0 * 1000) + System.currentTimeMillis());
        ...
        if (tL_chatInviteExported.request_needed) {
            org.telegram.ui.Components.zs zsVar4 = new org.telegram.ui.Components.zs();
            zsVar4.b = AndroidUtilities.dp(1.5f);
            spannableStringBuilder2.append((CharSequence) "  .  ").setSpan(zsVar4, spannableStringBuilder2.length() - 3, spannableStringBuilder2.length() - 2, 0);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10 || tL_chatInviteExported2.revoked) {
            ...
            if (i12 > 0 || tL_chatInviteExported2.usage_limit > 0) {
                if (i12 > 0) {
                    long currentTimeMillis = (ph0Var.k0 * 1000) + System.currentTimeMillis();
        ...
        if (!z11) {
            ...
            if (tL_chatInviteExported.subscription_pricing == null) {
                ph0Var.X.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                ph0Var.X.draw(canvas2);
            } else if (tL_chatInviteExported.revoked) {
                ph0Var.W.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                ph0Var.W.draw(canvas2);
            } else {
                ph0Var.V.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                ph0Var.V.draw(canvas2);
            }
            if (this.E) {
                return;
            }
        ...
        z4 = ((org.telegram.ui.ActionBar.p2) ph0Var).isPaused;
        if (!z4) {
            invalidate();
        }
        this.C = f15;
