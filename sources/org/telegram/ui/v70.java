...
public final class v70 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(v70 v70Var, View view, int i10) {
        ...
        if (!v70Var.M) {
            ...
            if (i10 == v70Var.J) {
                v70Var.d0(v70Var.r, true, false);
                return;
            }
            return;
        }
        if (i10 > v70Var.f.d.size()) {
        ...
        } else if (i10 != v70Var.f.d.size()) {
            v70Var.d0((TLRPC.TL_messages_stickerSet) v70Var.f.d.get(i10), ((org.telegram.ui.Cells.m8) view).a(), true);
        }
    }
    ...
    public static void V(v70 v70Var, TLRPC.TL_error tL_error) {
        ...
        TLRPC.TL_messages_stickerSet tL_messages_stickerSet = v70Var.r;
        if (tL_messages_stickerSet != null) {
            ...
            MediaDataController.getInstance(v70Var.currentAccount).putGroupStickerSet(v70Var.r);
        } else if (z10) {
        ...
        NotificationCenter.getInstance(v70Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupPackUpdated, Long.valueOf(v70Var.v.id), Boolean.valueOf(z10));
    ...
    public static void a0(v70 v70Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (tL_messages_stickerSet == null) {
            ...
            v70Var.r = tL_messages_stickerSet;
            v70Var.s = false;
            org.telegram.messenger.w1.o(R.string.GroupsEmojiPackUpdated, org.telegram.ui.Components.vc.a0(v70Var), R.raw.done, 36);
        }
        v70Var.h0();
        v70Var.f0(v70Var.r, false);
        if (i10 != -1) {
            if (!v70Var.M) {
    ...
    public final void d0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.wx0 wx0Var = new org.telegram.ui.Components.wx0(getParentActivity(), this, tL_inputStickerSetShortName, !z11 ? tL_messages_stickerSet : null, null, null);
        wx0Var.d0 = new q70(this, z10, tL_messages_stickerSet);
        wx0Var.B0();
