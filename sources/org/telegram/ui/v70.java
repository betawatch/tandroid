...
public final class v70 extends DispatchQueue {
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            ...
            w70 w70Var = this.x;
            if (!this.b.eglChooseConfig(this.c, EmuDetector.with(w70Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
