...
public final /* synthetic */ class g90 implements Runnable {
    ...
    public /* synthetic */ g90(KeyEvent.Callback callback, TLObject tLObject, Object obj, TLRPC.TL_error tL_error, TLObject tLObject2, int i10) {
        this.a = i10;
        this.b = callback;
        this.d = tLObject;
        this.c = obj;
    ...
    /* JADX WARN: Type inference failed for: r0v72, types: [org.telegram.ui.ActionBar.n2, org.telegram.ui.wg0] */
    ...
    /* JADX WARN: Type inference failed for: r14v2, types: [org.telegram.ui.gj1] */
    ...
    /* JADX WARN: Type inference failed for: r6v5, types: [org.telegram.ui.fc0] */
    ...
    */
        ...
        switch (i17) {
            ...
            case 2:
                ...
                if (tLObject2 != null) {
                    if (tLObject2 instanceof TLRPC.TL_urlAuthResultRequest) {
                        il0.b(false, launchActivity2.O, tL_messages_requestUrlAuth, (TLRPC.TL_urlAuthResultRequest) tLObject2, null, null, null, false, null);
                        break;
                    } else if (tLObject2 instanceof TLRPC.TL_urlAuthResultAccepted) {
                        il0.b(false, launchActivity2.O, tL_messages_requestUrlAuth, (TLRPC.TL_urlAuthResultAccepted) tLObject2, null, null, null, false, null);
                        break;
                    ...
                    if ("URL_EXPIRED".equalsIgnoreCase(tL_error2.text)) {
                        il0.a().M(LocaleController.getString(R.string.BotAuthLoggedInFailTitle), LocaleController.getString(R.string.BotAuthLoggedInFailNoDomain), R.raw.error).j();
                        break;
                    } else {
                        il0.a().d0(tL_error2, false);
                        break;
                    }
                }
                break;
            ...
            case 4:
                ...
                if (tL_error4 != null) {
                    ...
                    org.telegram.messenger.y0.p(i10, b10, null);
                    ...
                    if (tLObject4 instanceof TLRPC.TL_payments_paymentFormStars) {
                        ...
                        yh.u5.y(i21, false).Y(null, tL_inputInvoiceSlug, (TLRPC.TL_payments_paymentFormStars) tLObject4, new zb0(r63, 1), new j90(o4Var, i19));
                        break;
                    } else {
                        if (tLObject4 instanceof TLRPC.PaymentForm) {
                            ...
                            wo0Var = new wo0(paymentForm, null, str5, LaunchActivity.U());
                        } else {
                            wo0Var = tLObject4 instanceof TLRPC.PaymentReceipt ? new wo0((TLRPC.PaymentReceipt) tLObject4) : null;
                        }
                        if (wo0Var != null) {
                            xh.o4 o4Var2 = launchActivity4.Y0;
                            if (o4Var2 != null) {
                                launchActivity4.Y0 = null;
                                wo0Var.Z0 = new lf(10, o4Var2);
                            }
                            r63.n(wo0Var, false);
                        }
                    }
            ...
            case 6:
                ...
                if (tLObject5 instanceof TLRPC.TL_auth_sentCode) {
                    ...
                    org.telegram.ui.Components.c5.f0(i11, tL_error5, wg0Var, tL_auth_resendCode, new Object[0]);
                    break;
                }
                break;
            case 7:
                    ...
                    if (str6 != null) {
                        if (str6.contains("EMAIL_INVALID")) {
                            ...
                            if (tL_error6.text.contains("PHONE_CODE_EXPIRED")) {
                                ...
                                org.telegram.ui.Components.c5.f0(i12, tL_error6, wg0Var2, sendverifyemailcode, lf0Var.w);
                                break;
                            }
                        } else {
                ...
                if (!(tLObject7 instanceof TL_account.TL_emailVerified) || wg0Var3.F != 3) {
                    if (tLObject7 instanceof TL_account.TL_emailVerifiedLogin) {
                        ...
                        if (tL_error7.text.contains("EMAIL_NOT_ALLOWED")) {
                            ...
                            org.telegram.ui.Components.c5.f0(i13, tL_error7, wg0Var3, verifyemail, new Object[0]);
                            break;
                        }
                    }
                } else {
            ...
            case 9:
                ...
                if (tLObject8 instanceof TLRPC.PaymentForm) {
                    ...
                    wo0 wo0Var2 = new wo0(tL_inputInvoicePremiumAuthCode, paymentForm2, null, null, 4, null, null, null, null, null, null, false, null, r03, true);
                    wo0Var2.V0 = true;
                    wo0Var2.c1 = new Utilities.Callback() { // from class: org.telegram.ui.ag0
                    ...
                    wo0Var2.d1 = new Utilities.Callback() { // from class: org.telegram.ui.ag0
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj6) {
                            switch (i19) {
                                case 0:
                    ...
                    wo0Var2.e1 = new m20(fg0Var, i19);
                    r03.presentFragment(wo0Var2);
                    break;
                } else if (tL_error8 != null) {
                    if ("PHONE_CODE_EXPIRED".equalsIgnoreCase(tL_error8.text)) {
                        AndroidUtilities.runOnUIThread(new bg0(fg0Var, r12));
                        break;
                    } else {
            ...
            case 11:
                ck0.n((ck0) obj5, (TLRPC.TL_contacts_importedContacts) obj3, (TLRPC.TL_inputPhoneContact) obj4, (TLRPC.TL_error) obj2, (TLRPC.TL_contacts_importContacts) obj);
                break;
            case 12:
                ...
                if (tL_error10 == null) {
                    ((rm0) on0Var.B1).c(on0Var.E, (String) on0Var.s1.get("email"), null, null, null, null, null, null, null, null, pl0Var, aVar);
                    break;
                } else {
                    i14 = ((org.telegram.ui.ActionBar.n2) on0Var).currentAccount;
                    org.telegram.ui.Components.c5.f0(i14, tL_error10, on0Var, verifyemail2, new Object[0]);
                    aVar.b(null, null);
                    break;
                }
            case 13:
                ...
                kn0Var.J = false;
                if (tL_error11 == null) {
                    on0Var2.l1(bundle4, (TLRPC.TL_auth_sentCode) tLObject9, true);
                } else {
                    i15 = ((org.telegram.ui.ActionBar.n2) on0Var2).currentAccount;
                    org.telegram.ui.ActionBar.b2 f02 = org.telegram.ui.Components.c5.f0(i15, tL_error11, on0Var2, tL_auth_resendCode2, new Object[0]);
                    if (f02 != null && tL_error11.text.contains("PHONE_CODE_EXPIRED")) {
                        f02.m0 = new fn0(kn0Var, r12);
                    }
                }
                on0Var2.x1();
                break;
            case 14:
                wo0.f0((wo0) obj5, (TLRPC.TL_error) obj2, (TLObject) obj4, (String) obj3, (TL_account.getPassword) obj);
                break;
            case 15:
            ...
            case 17:
                ...
                if (((TLObject) obj4) instanceof TLRPC.TL_boolTrue) {
                    ...
                    if (tL_error12 != null && (str = tL_error12.text) != null && str.startsWith("FLOOD_WAIT_")) {
                        ...
                        org.telegram.messenger.y0.o(R.string.UnknownError, org.telegram.ui.Components.vc.a0(r04), R.raw.error, 36);
                        break;
                    }
                }
                break;
            case 18:
                ...
                if (!(((TLRPC.ChannelParticipant) obj3) instanceof TLRPC.TL_channelParticipantAdmin) && !(chatParticipant instanceof TLRPC.TL_chatParticipantAdmin)) {
                    ...
                    alertDialog$Builder2.k(LocaleController.getString(R.string.OK), new tl0(nkVar, 11));
            ...
            case 19:
                ...
                if (tLObject10 instanceof TL_fragment.TL_collectibleInfo) {
                    ...
                    org.telegram.ui.Components.oc w10 = new org.telegram.ui.Components.vc(zz0Var.w, profileActivity.z0).w(R.drawable.filled_username, AndroidUtilities.withLearnMore(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.FragmentChannelUsername, str9, format, formatCurrency, TextUtils.isEmpty(formatCurrency2) ? "" : a4.a.q("(", formatCurrency2, ")"))), new iy0(i18, profileActivity, tL_collectibleInfo)));
                    sv svVar = new sv(29, profileActivity, tL_collectibleInfo);
                    org.telegram.ui.Components.sb sbVar = w10.e;
                    if (sbVar != null) {
                        sbVar.setOnClickListener(svVar);
                    }
                    w10.k(false);
                    break;
                } else {
            ...
            case 22:
                ...
                if (((String) obj3).equals(k11Var.y)) {
                    if (!k11Var.w && (n2Var2 instanceof ProfileActivity)) {
                        try {
            ...
            case 23:
                h71 h71Var = (h71) obj5;
                h71Var.getClass();
                h71Var.p((View) obj3, Long.valueOf(((org.telegram.ui.Components.x5) obj4).documentId), (TLRPC.Document) obj, ((q61) obj2).v, null);
                break;
            case 24:
                r71 r71Var = (r71) obj5;
                ...
                if (tL_error15 == null) {
                    ...
                    r71Var.T(user4, twoStepVerificationActivity.l0(), twoStepVerificationActivity);
                    break;
                }
                break;
            case 25:
            ...
            default:
                ...
                int i23 = y4Var.Y;
                org.telegram.ui.ActionBar.n2 n2Var3 = y4Var.n;
                if (((TLObject) obj4) instanceof TLRPC.TL_boolTrue) {
                    ...
                    org.telegram.ui.Components.c5.f0(i23, tL_error19, n2Var3, tL_payments_canPurchaseStore, new Object[0]);
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ g90(TLObject tLObject, MessagesController messagesController, ai.e4 e4Var, tg.h hVar, TLRPC.TL_error tL_error) {
        this.a = 27;
        this.d = tLObject;
    ...
    public /* synthetic */ g90(TLRPC.TL_error tL_error, Utilities.Callback callback, TLObject tLObject, MessagesController messagesController, Utilities.Callback callback2, int i10) {
        this.a = i10;
        this.f = tL_error;
        this.b = callback;
        this.d = tLObject;
    ...
    public /* synthetic */ g90(LaunchActivity launchActivity, TLObject tLObject, org.telegram.ui.ActionBar.b2 b2Var, ma0 ma0Var, TLRPC.TL_error tL_error) {
        this.a = 3;
    ...
    public /* synthetic */ g90(ck0 ck0Var, TLRPC.TL_contacts_importedContacts tL_contacts_importedContacts, TLRPC.TL_inputPhoneContact tL_inputPhoneContact, TLRPC.TL_error tL_error, TLRPC.TL_contacts_importContacts tL_contacts_importContacts) {
        this.a = 11;
        this.b = ck0Var;
