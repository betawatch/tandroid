...
public final class nz extends LinearLayout {
    ...
    public nz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.c = u9Var;
        u9Var.setImageDrawable(new org.telegram.ui.Components.yi0(R.raw.topics_tabs, AndroidUtilities.dp(160.0f), AndroidUtilities.dp(160.0f)));
        ...
        this.f = u9Var2;
        u9Var2.setImageDrawable(new org.telegram.ui.Components.yi0(R.raw.topics_list, AndroidUtilities.dp(160.0f), AndroidUtilities.dp(160.0f)));
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        org.telegram.ui.Components.u9 u9Var2 = this.c;
        ...
        if (z11) {
            ...
            this.n.addListener(new org.telegram.ui.Components.aa(27, this, z10));
            ...
            u9Var2.invalidate();
            u9Var.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.r, org.telegram.ui.ActionBar.j6.v0(i10, f6Var), org.telegram.ui.ActionBar.j6.v0(i11, f6Var)), mode));
            u9Var.invalidate();
        }
        if (z10) {
            u9Var = u9Var2;
        }
        org.telegram.ui.Components.yi0 lottieAnimation = u9Var.getImageReceiver().getLottieAnimation();
