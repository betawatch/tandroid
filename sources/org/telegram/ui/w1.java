    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockembed != null) {
            if (pageblockembed.level > 0) {
                ...
                this.n = dp2;
                this.e = dp2;
                i13 = org.telegram.messenger.rl.u(18.0f, dp2, size);
                i14 = i13;
            } else {
                this.n = 0;
            ...
            org.telegram.ui.Components.i81 i81Var = this.b;
            if (i81Var != null && i81Var.getParent() == this) {
                i81Var.measure(View.MeasureSpec.makeMeasureSpec(i13, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(10.0f) + i18, TLObject.FLAG_30));
            }
            ...
            m4 m4Var = this.x;
            f3 p6 = m4.p(m4Var, this, null, richText, i14, dp4, pageblockembed3, alignment, 0, this.w);
            this.c = p6;
            if (p6 != null) {
                int height = this.c.d.getHeight() + AndroidUtilities.dp(4.0f);
                this.h = height;
                i18 = org.telegram.messenger.y1.C(4.0f, height, i18);
            } else {
                this.h = 0;
            }
            ...
            f3 p9 = m4.p(m4Var, this, null, richText2, i14, 0, pageblockembed4, alignment, 0, this.w);
            this.d = p9;
            if (p9 != null) {
