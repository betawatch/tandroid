...
public final class wn extends Drawable {
    ...
    public final lh.x2 e;
    public final org.telegram.ui.Components.yb0 f;
    ...
    public static Drawable b(TLRPC.WallPaper wallPaper) {
        ...
        if (wallPaper.document != null) {
            ...
            if (wallPaperSettings == null || wallPaperSettings.intensity < 0) {
                ...
                org.telegram.ui.Components.yb0 yb0Var = new org.telegram.ui.Components.yb0();
                yb0Var.n(k9, k10, k11, r2);
                a2 = new BitmapDrawable(yb0Var.k);
            }
        }
    ...
    public static wn d(Drawable drawable, TLRPC.WallPaper wallPaper, boolean z10) {
        ...
        if (drawable instanceof wn) {
            ...
            boolean z11 = wnVar.a;
            TLRPC.WallPaper wallPaper2 = wnVar.g;
            String str = wallPaper.uploadingImage;
    ...
    public final Drawable c(boolean z10) {
        org.telegram.ui.Components.yb0 yb0Var = this.f;
        if (yb0Var != null) {
            return yb0Var;
        }
        lh.x2 x2Var = this.e;
        return (!z10 || x2Var.getStaticThumb() == null) ? x2Var.getThumb() != null ? x2Var.getThumb() : x2Var.getDrawable() != null ? x2Var.getDrawable() : x2Var.getStaticThumb() : x2Var.getStaticThumb();
    }
