...
public final /* synthetic */ class zg implements Runnable {
    ...
    public /* synthetic */ zg(org.telegram.ui.ActionBar.c2[] c2VarArr, int i10) {
        this.a = i10;
        this.b = c2VarArr;
    }
    ...
    public final void run() {
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new zg(this.b, 4));
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new zg(this.b, 5));
                break;
            case 4:
                this.b[0].dismiss();
                break;
