...
public final class w70 extends DispatchQueue {
    ...
    public w70(y70 y70Var, SurfaceTexture surfaceTexture) {
        super("EGLThread");
        this.x = y70Var;
        this.n = new int[24];
        this.v = new org.telegram.ui.Components.voip.e1(8);
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            ...
            y70 y70Var = this.x;
            if (!this.b.eglChooseConfig(this.c, EmuDetector.with(y70Var.getParentActivity()).detect() ? new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12344} : new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                ...
                if (eglCreateContext == null) {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            c(new org.telegram.ui.Components.voip.e1(9), 22, false);
                            c(this.v, 23, false);
                            ...
                            y70Var.J = System.currentTimeMillis() - 1000;
                            z10 = true;
                        } else {
                            if (BuildVars.LOGS_ENABLED) {
