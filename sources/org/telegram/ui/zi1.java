...
public final /* synthetic */ class zi1 implements org.telegram.ui.ActionBar.a2, oy {
    public final /* synthetic */ bj1 a;

    public /* synthetic */ zi1(bj1 bj1Var) {
        this.a = bj1Var;
    }
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof ej1) {
                ej1 ej1Var = (ej1) valueAt;
                TLRPC.WallPaper wallPaper = ej1Var.l;
                if (wallPaper == null || wallPaper.id >= 0) {
                    valueAt = wallPaper;
                } else {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(ej1Var.l.id);
                    wallpapersListActivity.d0.remove(ej1Var);
                    wallpapersListActivity.b0.remove(ej1Var.a());
                }
            }
            if (valueAt instanceof TLRPC.WallPaper) {
                ...
                ConnectionsManager.getInstance(i11).sendRequest(savewallpaper, new aj1(0, bj1Var, iArr));
            }
        }
        if (iArr[0] == 0) {
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, dg1 dg1Var) {
        ...
        while (true) {
            ...
            } else if (valueAt instanceof ej1) {
                b10 = ((ej1) valueAt).b();
            } else {
                i18++;
            }
