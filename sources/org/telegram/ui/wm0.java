    ...
    */
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            org.telegram.ui.Components.c90 c90Var = new org.telegram.ui.Components.c90(on0Var.getParentActivity(), null);
            ...
            c90Var.setLinkTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.k5, false));
            c90Var.setHighlightColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.l5, false));
            ...
            c90Var.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.j5, false));
        ...
        if (i10 == 2) {
            ...
            pl0 pl0Var = new pl0(this, 3);
            o0.a aVar = new o0.a(this, pl0Var, false, 6);
            if (i15 == 4) {
                if (on0Var.f) {
                    obj = on0Var.d1;
                ...
                ((rm0) on0Var.B1).c(on0Var.E, obj, null, null, null, null, null, null, null, null, pl0Var, aVar);
            } else if (i15 == 3) {
                if (on0Var.f) {
                    i14 = ((org.telegram.ui.ActionBar.n2) on0Var).currentAccount;
                ...
                ((rm0) on0Var.B1).c(on0Var.E, str, null, null, null, null, null, null, null, null, pl0Var, aVar);
            } else if (i15 == 2) {
                ...
                if (!on0Var.v0) {
                    ...
                    ((rm0) on0Var.B1).c(on0Var.E, null, jSONObject != null ? jSONObject.toString() : null, on0Var.F, null, on0Var.i1, on0Var.j1, on0Var.k1, null, null, pl0Var, aVar);
                }
                jSONObject = null;
                hashMap = on0Var.w1;
                if (hashMap != null) {
                ...
                int sendRequest = ConnectionsManager.getInstance(i11).sendRequest(verifyemail, new ai.p3(this, pl0Var, aVar, verifyemail, 10));
                ...
                i13 = ((org.telegram.ui.ActionBar.n2) on0Var).classGuid;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean c(pl0 pl0Var, o0.a aVar) {
        char c10;
        char c11;
        char c12;
        JSONObject jSONObject;
        ...
        if (on0Var.o1.isEmpty() && !on0.D0(on0Var)) {
                    ...
                    if (zArr[i12]) {
                        ...
                        if (!z10) {
                            ...
                            if (TextUtils.isEmpty(translitString) || TextUtils.isEmpty(translitString2) || TextUtils.isEmpty(translitString3)) {
                                ...
                                alertDialog$Builder.k(LocaleController.getString(R.string.Done), new org.telegram.ui.Components.d1(this, translitString, translitString2, translitString3, pl0Var, aVar, 1));
            ...
            if (on0Var.F != null) {
                ...
                ((rm0) en0Var).c(tL_secureRequiredType, null, jSONObject3, tL_secureRequiredType2, jSONObject4, null, secureDocument2, arrayList3, secureDocument3, secureDocument, pl0Var, aVar);
                return true;
            }
            jSONObject2 = null;
            hashMap = on0Var.w1;
            ...
            ((rm0) en0Var2).c(tL_secureRequiredType3, null, jSONObject3, tL_secureRequiredType22, jSONObject4, null, secureDocument22, arrayList32, secureDocument32, secureDocument, pl0Var, aVar);
            return true;
        }
        return false;
    }
