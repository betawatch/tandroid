    ...
    */
        ...
        try {
            ...
            if (!(view instanceof org.telegram.ui.Cells.x8)) {
                if (view instanceof org.telegram.ui.Cells.fa) {
                    languageSelectActivity.presentFragment(new x31());
                    return;
                }
                if (languageSelectActivity.getParentActivity() != null && languageSelectActivity.parentLayout != null && (view instanceof org.telegram.ui.Cells.h9)) {
                    ...
                    if (localeInfo2 != null) {
                        ...
                        int applyLanguage = LocaleController.getInstance().applyLanguage(localeInfo2, true, false, false, true, languageSelectActivity.currentAccount, new ci.y0(languageSelectActivity, b2Var, z13, 27));
                        if (applyLanguage != 0) {
                        ...
                        if (Y.contains(str2) && !Y.contains(str)) {
                            Collection.-EL.removeIf(hashSet, new o80(str2, 0));
                        }
                        if (str != null && !BuildConfig.BETA_URL.equals(str)) {
                            hashSet.add(str);
                        }
                        x31.a0(hashSet, Boolean.FALSE);
                ...
                if (!languageSelectActivity.h0() && !languageSelectActivity.g0()) {
                    ...
                    if (z11 == z10) {
                        ...
                        for (int i12 = 0; i12 < languageSelectActivity.b.getChildCount(); i12++) {
                            ...
                            if (RecyclerView.R(childAt) == i11 && (childAt instanceof org.telegram.ui.Cells.x8)) {
    ...
    public static /* synthetic */ void X(LanguageSelectActivity languageSelectActivity, LocaleController.LocaleInfo localeInfo) {
        if (LocaleController.getInstance().deleteLanguage(localeInfo, languageSelectActivity.currentAccount)) {
            ...
            q80 q80Var = languageSelectActivity.a;
            if (q80Var != null) {
                q80Var.l();
            }
            q80 q80Var2 = languageSelectActivity.c;
            if (q80Var2 != null) {
                q80Var2.l();
            }
        }
    ...
    public final View createView(Context context) {
        ...
        this.a = new q80(this, context, false);
        this.c = new q80(this, context, true);
