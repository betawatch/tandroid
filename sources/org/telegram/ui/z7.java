    ...
    public final void onClick(View view) {
        switch (this.a) {
            ...
            case 1:
                ...
                break;
            case 2:
                if (((q81) this.b).a.getImageReceiver().getLottieAnimation() != null && !((q81) this.b).a.getImageReceiver().getLottieAnimation().k0) {
                    ((q81) this.b).a.getImageReceiver().getLottieAnimation().N(0, false, false);
                    ((q81) this.b).a.getImageReceiver().getLottieAnimation().H(false);
                    break;
                }
                break;
            default:
