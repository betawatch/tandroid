...
public class AuctionWearingSheet extends BottomSheetWithRecyclerListView implements GiftAuctionController.OnAuctionUpdateListener {
    ...
    public AuctionWearingSheet(final Context context, final Theme.ResourcesProvider resourcesProvider, final long j, final TL_stars.StarGift starGift, final ArrayList arrayList, final Runnable runnable, boolean z) {
        ...
        int i4 = z ? 220 : NotificationCenter.storyQualityUpdate;
        ...
        GiftSheet.GiftCell giftCell2 = new GiftSheet.GiftCell(context, this.currentAccount, resourcesProvider) { // from class: org.telegram.ui.Gifts.AuctionWearingSheet.4
            RectF rectF = new RectF();
            RectF rectF2 = new RectF();
            Path path = new Path();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$new$6(Context context, Theme.ResourcesProvider resourcesProvider, long j, TL_stars.StarGift starGift, ArrayList arrayList, View view) {
