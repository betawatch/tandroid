...
public class AuctionJoinSheet extends BottomSheetWithRecyclerListView implements GiftAuctionController.OnAuctionUpdateListener {
    ...
    private AuctionJoinSheet(final Context context, final Theme.ResourcesProvider resourcesProvider, final long j, final TL_stars.StarGift starGift, final Runnable runnable) {
        ...
        if (auction2 != null && auction2.previewAttributes != null) {
            ...
            this.headerContainer.addView(topView, 0, LayoutHelper.createFrame(-1, NotificationCenter.suggestedLangpack, 48));
            ...
            textView3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Gifts.AuctionJoinSheet$$ExternalSyntheticLambda6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    */
    private void updateTable(boolean z) {
        ...
        if (auction3 != null) {
            ...
            i2 = this.starGift.availability_total;
            if (i != i2) {
            ...
            i3 = this.auction.auctionUserState.acquired_count;
            if (i3 <= 0) {
            ...
            if ((auction == null && auction.auctionStateFinished != null) || this.starGift.sold_out) {
