...
public class ResaleGiftsFragment extends BaseFragment {
    ...
    public static class LargeEmptyView extends FrameLayout {
        ...
        public LargeEmptyView(Context context, View.OnClickListener onClickListener, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.imageView = backupImageView;
            backupImageView.setImageDrawable(new RLottieDrawable(R.raw.utyan_empty, "utyan_empty", AndroidUtilities.dp(130.0f), AndroidUtilities.dp(130.0f)));
            linearLayout.addView(backupImageView, LayoutHelper.createLinear(NotificationCenter.walletSyncProgressChanged, NotificationCenter.walletSyncProgressChanged, 17));
            TextView textView = new TextView(context);
                ...
                if (!resalestargifts.counters.isEmpty()) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (starGiftAttributeId instanceof TL_stars.starGiftAttributeIdBackdrop) {
                            hashMap = this.backdropAttributesCounter;
                            valueOf = Integer.valueOf(starGiftAttributeId.backdrop_id);
                        } else {
                            if (starGiftAttributeId instanceof TL_stars.starGiftAttributeIdPattern) {
                                hashMap = this.patternAttributesCounter;
                            } else if (starGiftAttributeId instanceof TL_stars.starGiftAttributeIdModel) {
                                hashMap = this.modelAttributesCounter;
                            }
                            valueOf = Long.valueOf(starGiftAttributeId.document_id);
                        }
                        hashMap.put(valueOf, Integer.valueOf(next2.count));
                    }
                }
    ...
    public /* synthetic */ void lambda$createView$15(String[] strArr, ArrayList arrayList, ArrayList arrayList2, UniversalAdapter universalAdapter) {
        ...
        while (it.hasNext()) {
            ...
            boolean z = true;
            boolean z2 = !this.list.notSelectedBackdropAttributes.contains(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
    ...
    public /* synthetic */ void lambda$createView$21(String[] strArr, ArrayList arrayList, ArrayList arrayList2, UniversalAdapter universalAdapter) {
        ...
        while (it.hasNext()) {
            ...
            boolean z = true;
            boolean z2 = !this.list.notSelectedPatternAttributes.contains(Long.valueOf(stargiftattributepattern.document.id));
    ...
    public /* synthetic */ void lambda$createView$9(String[] strArr, ArrayList arrayList, ArrayList arrayList2, UniversalAdapter universalAdapter) {
        ...
        while (it.hasNext()) {
            TL_stars.starGiftAttributeModel stargiftattributemodel = (TL_stars.starGiftAttributeModel) it.next();
            boolean z = true;
            boolean z2 = !this.list.notSelectedModelAttributes.contains(Long.valueOf(stargiftattributemodel.document.id));
