...
public final class lf1 extends org.telegram.ui.Components.pv0 {
    public boolean w0;
    ...
    public final void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            ...
            if (eg1Var.g1 != null) {
                ...
                eg1Var.g1.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (eg1Var.isInPreviewMode()) {
            int themedColor = eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.d6);
            Paint paint = this.x0;
            paint.setColor(themedColor);
            paint.setAlpha((int) (eg1Var.W * 255.0f));
            canvas2 = canvas;
            canvas2.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.statusBarHeight, paint);
            canvas2.drawLine(0.0f, 0.0f, 0.0f, getHeight(), org.telegram.ui.ActionBar.i6.k0);
        } else {
            canvas2 = canvas;
        }
        if (eg1Var.M0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.d6), eg1Var.e1);
        }
    }
        ...
        if (view == kVar && !eg1Var.isInPreviewMode()) {
            ...
            if (f7 > 0.0f) {
                if (f7 < 1.0f) {
                    ...
                    org.telegram.ui.ActionBar.i6.k0.setAlpha((int) (alpha * eg1Var.W));
                    float f10 = measuredHeight;
                    canvas.drawLine(0.0f, f10, getMeasuredWidth(), f10, org.telegram.ui.ActionBar.i6.k0);
                    org.telegram.ui.ActionBar.i6.k0.setAlpha(alpha);
                } else {
                    float f11 = measuredHeight;
                    canvas.drawLine(0.0f, f11, getMeasuredWidth(), f11, org.telegram.ui.ActionBar.i6.k0);
                }
            }
        }
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (t51Var != null) {
            this.w0 = true;
            ViewGroup.LayoutParams layoutParams = t51Var.getLayoutParams();
