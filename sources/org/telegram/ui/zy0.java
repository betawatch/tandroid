...
public final class zy0 implements org.telegram.ui.Components.jl0 {
    ...
    public static void a(zy0 zy0Var, Context context, int i10) {
        ...
        int i18 = 0;
        if (i10 == 0) {
            zy0Var.c.getUserConfig().syncContacts = true;
            zy0Var.c.getUserConfig().saveConfig(false);
            zy0Var.c.getContactsController().forceImportContacts();
            return;
        }
        long j11 = 0;
        if (i10 == 1) {
            zy0Var.c.getContactsController().loadContacts(false, 0L);
            return;
        }
        if (i10 == 2) {
            zy0Var.c.getContactsController().resetImportedContacts();
            return;
        }
        if (i10 == 3) {
            zy0Var.c.getMessagesController().forceResetDialogs();
            return;
        }
        if (i10 == 4) {
        ...
        if (i10 == 6) {
            ...
            i14 = ((org.telegram.ui.ActionBar.p2) zy0Var.c).currentAccount;
            ...
            edit.apply();
            i16 = ((org.telegram.ui.ActionBar.p2) zy0Var.c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i16).edit();
            i17 = ((org.telegram.ui.ActionBar.p2) zy0Var.c).currentAccount;
        ...
        if (i10 == 9) {
            ((LaunchActivity) zy0Var.c.getParentActivity()).z(true);
            return;
        }
        if (i10 == 10) {
            zy0Var.c.getMessagesStorage().readAllDialogs(-1);
            return;
        }
        if (i10 == 11) {
        ...
        if (i10 == 13) {
            Set<String> set = zy0Var.c.getMessagesController().pendingSuggestions;
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(zy0Var.c.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 == 19) {
                zy0Var.c.getMessagesController().loadAppConfig();
                TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                zy0Var.c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new wy0(zy0Var, i18));
                return;
            }
            if (i10 != 20) {
                if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(zy0Var.c.getParentActivity(), 0, zy0Var.c.w0);
                ...
                if (i10 == 24) {
                    ...
                    while (i18 < zy0Var.c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.p2) zy0Var.c.getParentLayout().getFragmentStack().get(i18)).clearSheets();
                        i18++;
                    }
                    return;
                }
                ...
                if (i10 == 27) {
                    zy0Var.c.getMediaDataController().loadAttachMenuBots(false, true);
                    return;
                }
                if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.p2) zy0Var.c).currentAccount;
                ...
                if (i10 == 35) {
                    i11 = ((org.telegram.ui.ActionBar.p2) zy0Var.c).currentAccount;
            ...
            ProfileActivity.S0(zy0Var.c, MediaController.VIDEO_MIME_TYPE, sb2);
            ProfileActivity.S0(zy0Var.c, "video/hevc", sb2);
            ProfileActivity.S0(zy0Var.c, "video/x-vnd.on2.vp8", sb2);
            ProfileActivity.S0(zy0Var.c, "video/x-vnd.on2.vp9", sb2);
            zy0Var.c.showDialog(new yy0(zy0Var, zy0Var.c.getParentActivity(), sb2.toString()));
