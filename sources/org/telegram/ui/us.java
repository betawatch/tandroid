...
public final class us extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40 {
    public ss E;
    ...
    public org.telegram.ui.Components.f61 W;
    public boolean X;
    public boolean Y;
    ...
    public static /* synthetic */ void U(us usVar, TL_account.TL_birthday tL_birthday) {
        TLRPC.TL_users_suggestBirthday tL_users_suggestBirthday = new TLRPC.TL_users_suggestBirthday();
        tL_users_suggestBirthday.id = usVar.getMessagesController().getInputUser(usVar.H);
        tL_users_suggestBirthday.birthday = tL_birthday;
        ConnectionsManager.getInstance(usVar.currentAccount).sendRequest(tL_users_suggestBirthday, new m(usVar, 5));
    }

    public static /* synthetic */ void V(us usVar, TLRPC.User user) {
        usVar.Q = null;
        usVar.d0(null, null, null, null, null, 0.0d, 2);
        TLRPC.User user2 = usVar.getMessagesController().getUser(Long.valueOf(usVar.H));
        user2.photo.personal = false;
        TLRPC.UserFull userFull = MessagesController.getInstance(usVar.currentAccount).getUserFull(usVar.H);
        if (userFull != null) {
            userFull.personal_photo = null;
            userFull.flags &= -2097153;
            usVar.getMessagesStorage().updateUserInfo(userFull, true);
        }
        TLRPC.Photo photo = usVar.T;
        if (photo != null) {
        ...
        arrayList2.add(user);
        usVar.getMessagesStorage().putUsersAndChats(arrayList2, null, false, true);
        usVar.g0();
        usVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.reloadDialogPhotos, new Object[0]);
        usVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.updateInterfaces, Integer.valueOf(MessagesController.UPDATE_MASK_AVATAR));
    }

    public static /* synthetic */ void W(us usVar) {
        TLRPC.User user;
        if (usVar.e == null || (user = usVar.getMessagesController().getUser(Long.valueOf(usVar.H))) == null) {
            return;
        }
        usVar.n.m(usVar.currentAccount, user);
        usVar.e.invalidate();
    }

    public static void X(us usVar, TLRPC.PhotoSize photoSize, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.PhotoSize photoSize2, TLRPC.VideoSize videoSize, double d, boolean z10) {
        org.telegram.ui.Components.u40 u40Var = usVar.P;
        if (u40Var.T) {
            return;
        }
        int i10 = usVar.S;
        if (i10 == 2) {
            usVar.Q = photoSize.location;
        } else if (i10 == 1 && usVar.getParentLayout() != null) {
            org.telegram.ui.ActionBar.e5 parentLayout = usVar.getParentLayout();
            org.telegram.ui.ActionBar.o2 lastFragment = usVar.getParentLayout().getLastFragment();
        ...
        if (inputFile == null && inputFile2 == null) {
            usVar.e.h(ImageLocation.getForLocal(usVar.Q), "50_50", usVar.n, usVar.getMessagesController().getUser(Long.valueOf(usVar.H)));
            if (usVar.S == 2) {
                usVar.e0(true, false);
            } else {
                TLRPC.TL_messageService tL_messageService = new TLRPC.TL_messageService();
                tL_messageService.random_id = SendMessagesHelper.getInstance(usVar.currentAccount).getNextRandomId();
                tL_messageService.dialog_id = usVar.H;
                tL_messageService.unread = true;
                tL_messageService.out = true;
                int newMessageId = usVar.getUserConfig().getNewMessageId();
                tL_messageService.id = newMessageId;
                tL_messageService.local_id = newMessageId;
                TLRPC.TL_peerUser tL_peerUser = new TLRPC.TL_peerUser();
                tL_messageService.from_id = tL_peerUser;
                tL_peerUser.user_id = usVar.getUserConfig().getClientUserId();
                tL_messageService.flags |= 256;
                TLRPC.TL_peerUser tL_peerUser2 = new TLRPC.TL_peerUser();
                tL_messageService.peer_id = tL_peerUser2;
                tL_peerUser2.user_id = usVar.H;
                tL_messageService.date = usVar.getConnectionsManager().getCurrentTime();
                ...
                MessageObject messageObject = new MessageObject(usVar.currentAccount, tL_messageService, false, false);
                usVar.Z = messageObject;
                arrayList2.add(messageObject);
                new ArrayList().add(tL_messageService);
                MessagesController.getInstance(usVar.currentAccount).updateInterfaceWithMessages(usVar.H, arrayList2, 0);
                usVar.getMessagesController().photoSuggestion.put(tL_messageService.local_id, u40Var);
            }
        } else {
            TLRPC.User user = usVar.getMessagesController().getUser(Long.valueOf(usVar.H));
            if (usVar.Z == null && user != null) {
                ...
                arrayList3.add(user);
                usVar.getMessagesStorage().putUsersAndChats(arrayList3, null, false, true);
                usVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.reloadDialogPhotos, new Object[0]);
                usVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.updateInterfaces, Integer.valueOf(MessagesController.UPDATE_MASK_AVATAR));
            }
            usVar.d0(usVar.Q, photoSize2.location, inputFile, inputFile2, videoSize, d, usVar.S);
            usVar.e0(false, true);
        }
        usVar.g0();
    }

    public static void Y(us usVar, TLRPC.FileLocation fileLocation, TLRPC.InputFile inputFile, TLObject tLObject, TLRPC.FileLocation fileLocation2, int i10) {
        if (usVar.Z != null) {
            return;
        }
        ...
        if (user != null) {
            ...
            if (closestPhotoSizeWithSize != null && fileLocation != null) {
                FileLoader.getInstance(usVar.currentAccount).getPathToAttach(fileLocation, true).renameTo(FileLoader.getInstance(usVar.currentAccount).getPathToAttach(closestPhotoSizeWithSize, true));
                ...
                sb3.append("_");
                ImageLoader.getInstance().replaceImageInCache(n10, a4.a.n(closestPhotoSizeWithSize.location.local_id, "@50_50", sb3), ImageLocation.getForUser(usVar.currentAccount, user, 1), false);
            }
            if (closestPhotoSizeWithSize2 != null && fileLocation2 != null) {
                FileLoader.getInstance(usVar.currentAccount).getPathToAttach(fileLocation2, true).renameTo(FileLoader.getInstance(usVar.currentAccount).getPathToAttach(closestPhotoSizeWithSize2, true));
            }
            yf.d0.a(tL_photos_photo.photo, user, true);
            ArrayList arrayList2 = new ArrayList();
            arrayList2.add(user);
            usVar.getMessagesStorage().putUsersAndChats(arrayList2, null, false, true);
            usVar.getMessagesController().getDialogPhotos(usVar.H).addPhotoAtStart(tL_photos_photo.photo);
            usVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.reloadDialogPhotos, new Object[0]);
            usVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.updateInterfaces, Integer.valueOf(MessagesController.UPDATE_MASK_AVATAR));
            if (usVar.getParentActivity() != null) {
                if (i10 == 2) {
                    org.telegram.ui.Components.vc.a0(usVar).V(arrayList2, AndroidUtilities.replaceTags(LocaleController.formatString("UserCustomPhotoSeted", R.string.UserCustomPhotoSeted, user.first_name)), null, null).j();
                } else {
                    org.telegram.ui.Components.vc.a0(usVar).V(arrayList2, AndroidUtilities.replaceTags(LocaleController.formatString("UserCustomPhotoSeted", R.string.UserCustomPhotoSeted, user.first_name)), null, null).j();
                }
            }
    ...
    public static /* synthetic */ void Z(us usVar) {
        if (usVar.Z != null) {
            ArrayList arrayList = new ArrayList();
            arrayList.add(Integer.valueOf(usVar.Z.getId()));
            NotificationCenter.getInstance(usVar.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.messagesDeleted, arrayList, 0L, Boolean.FALSE);
        }
    }
    ...
    @Override // org.telegram.ui.Components.t40
    public final void P() {
        AndroidUtilities.runOnUIThread(new ms(this, 1));
    }
    ...
    public final void Q(final TLRPC.InputFile inputFile, final TLRPC.InputFile inputFile2, final double d, String str, final TLRPC.PhotoSize photoSize, final TLRPC.PhotoSize photoSize2, final boolean z10, final TLRPC.VideoSize videoSize) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ks
            ...
            public final void run() {
                us.X(us.this, photoSize2, inputFile, inputFile2, photoSize, videoSize, d, z10);
            }
        });
    }
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new qs(this));
        ...
        this.v = s6Var;
        this.V.addView(s6Var, w7.x5.d(64, 64.0f, (LocaleController.isRTL ? 5 : 3) | 48, 16.0f, 13.0f, 16.0f, 13.0f));
        ...
        this.b.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.os
            ...
            public final boolean onEditorAction(TextView textView5, int i15, KeyEvent keyEvent) {
                switch (i11) {
                    case 0:
                        if (i15 == 5) {
                            us usVar = this.b;
                            usVar.c.b.requestFocus();
                            org.telegram.ui.Cells.g3 g3Var = usVar.c.b;
                    ...
                    case 1:
                        ...
                        if (i15 != 6) {
                            if (i15 == 5) {
                                usVar2.d.b.requestFocus();
                                usVar2.d.b.setSelection(usVar2.c.b.length());
                                break;
                            }
                        } else {
                            usVar2.a.performClick();
                            break;
                        }
                        break;
                    default:
        ...
        this.b.b.setOnFocusChangeListener(new rs());
        ...
        this.c.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.os
            public final /* synthetic */ us b;
        ...
        final int i15 = 2;
        this.d.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.os
            public final /* synthetic */ us b;
        ...
        if (!this.I) {
            ...
            int i17 = org.telegram.ui.ActionBar.j6.v6;
            int i18 = org.telegram.ui.ActionBar.j6.u6;
            r8Var2.e(i17, i18);
            ...
            this.x.e.setAnimation(yi0Var);
            this.x.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ps
                public final /* synthetic */ us b;
                ...
                public final void onClick(View view) {
                    switch (i11) {
                        case 0:
                            ...
                            u40Var.o(z12, fVar, new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.ns
                                @Override // android.content.DialogInterface.OnDismissListener
                                public final void onDismiss(DialogInterface dialogInterface) {
                                    switch (i19) {
                                        case 0:
                                            us usVar2 = usVar;
                                            boolean h = usVar2.P.h();
                            ...
                            break;
                        default:
                            final us usVar2 = this.b;
                            usVar2.R = 2;
                            org.telegram.ui.Components.u40 u40Var2 = usVar2.P;
                            ...
                            u40Var2.o(z13, fVar2, new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.ns
                                @Override // android.content.DialogInterface.OnDismissListener
                                public final void onDismiss(DialogInterface dialogInterface) {
                                    switch (i20) {
                                        case 0:
                                            us usVar22 = usVar2;
                                            boolean h = usVar22.P.h();
            ...
            this.y.e.setAnimation(yi0Var2);
            this.y.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ps
                public final /* synthetic */ us b;
            ...
            this.E = new ss(this, context, f6Var);
            if (this.n == null) {
                this.n = new org.telegram.ui.Components.f9(0, user);
            }
            ...
            this.F.setOnClickListener(new org.telegram.ui.Components.dt(i16, this, user));
        ...
        org.telegram.ui.Components.f61 f61Var = new org.telegram.ui.Components.f61(this, new b5(this, 7), new y0(this, i16), null);
        this.W = f61Var;
        f61Var.q1();
    ...
    public final void e0(boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(radialProgressView, (Property<RadialProgressView, Float>) property, 1.0f), ObjectAnimator.ofFloat(this.v, (Property<ci.s6, Float>) property, 1.0f));
        } else {
            RadialProgressView radialProgressView2 = this.s;
            Property property2 = View.ALPHA;
            animatorSet2.playTogether(ObjectAnimator.ofFloat(radialProgressView2, (Property<RadialProgressView, Float>) property2, 0.0f), ObjectAnimator.ofFloat(this.v, (Property<ci.s6, Float>) property2, 0.0f));
        }
        this.w.setDuration(180L);
        this.w.addListener(new org.telegram.ui.Components.aa(26, this, z10));
        this.w.start();
    }
    ...
    public us(Bundle bundle, org.telegram.ui.ActionBar.f6 f6Var) {
        super(bundle);
        this.X = false;
        this.Y = true;
        this.r = f6Var;
