...
public final /* synthetic */ class eg implements bh.a {
    public final /* synthetic */ int a;
    public final /* synthetic */ tm b;

    public /* synthetic */ eg(tm tmVar, int i10) {
        this.a = i10;
        this.b = tmVar;
    }
    ...
    public final void f(Canvas canvas, RectF rectF) {
        switch (this.a) {
            case 0:
                ...
                if (f7 > 0.0f) {
                    canvas.drawColor(org.telegram.ui.ActionBar.i6.l1(f7 * 0.85f, boVar.getThemedColor(org.telegram.ui.ActionBar.i6.d6)));
                }
                gh.d.b(new eg(tmVar, 1), canvas, rectF, boVar.x0, tmVar2, i10);
                ...
                if (i1Var != null && i1Var.getVisibility() == 0) {
                    ...
                    for (int i12 = 0; i12 < childCount; i12++) {
                        ...
                        if ((childAt instanceof eo) && childAt.getVisibility() == 0) {
                            ...
                            gh.d.a(new eg(tmVar3, 0), canvas, rectF, coVar.X0, eoVar);
                        }
                    }
                    break;
                }
