...
public final /* synthetic */ class hw implements Runnable {
    ...
    public /* synthetic */ hw(oy oyVar, TLRPC.Chat chat, long j10, boolean z4, TLRPC.User user, boolean z10) {
        this.e = oyVar;
        this.f = chat;
        this.c = j10;
        this.b = z4;
            ...
            case 0:
                ...
                if (chat != null) {
                    ...
                    if (user != null && user.bot && this.d) {
                        oyVar.getMessagesController().blockPeer(user.id);
                    }
                }
    ...
    public /* synthetic */ hw(ph.da daVar, boolean z4, TL_stories.StoryItem storyItem, long j10, TLRPC.InputGroupCall inputGroupCall, boolean z10) {
        this.e = daVar;
        this.b = z4;
        this.f = storyItem;
        this.c = j10;
