...
public final /* synthetic */ class hw implements Runnable {
    ...
    public /* synthetic */ hw(int i10, Object obj, Object obj2) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
    }
    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ((qy) obj).a.postOnAnimation(new mv((ry) obj2, i11));
                break;
            case 1:
                ry ryVar = (ry) obj2;
                ryVar.getMessagesController().addDialogToFolder((ArrayList) obj, (ryVar.V2 == 0 && ryVar.X2 == 0) ? 0 : 1, -1, null, 0L);
                break;
            case 2:
            ...
            case 6:
                dz dzVar = (dz) obj2;
                xn xnVar = dzVar.a;
                org.telegram.ui.Components.ux0 ux0Var = new org.telegram.ui.Components.ux0(xnVar.getParentActivity(), dzVar.a, ((MessageObject) obj).getInputStickerSet(), null, xnVar.Y, xnVar.getResourceProvider());
            ...
            case 8:
                c10 c10Var = (c10) obj2;
                zz zzVar2 = new zz(c10Var.r, ((t00) obj).m);
                zzVar2.y = new c00(c10Var, 1);
                zzVar2.x = new c00(c10Var, 2);
            ...
            case 10:
                ...
                ArrayList arrayList2 = c10Var3.L;
                c10Var3.N = false;
            ...
            case 15:
                ...
                ArrayList arrayList4 = ((f60) obj2).Y1;
            ...
            case 18:
                ((f60) ((x5) obj2).b).U0.setNewColors((int[]) obj);
                break;
            case 19:
            ...
            case 20:
                ...
                n70Var.c = n70Var.h.getConnectionsManager().sendRequest(tL_messages_getStickerSet, new mo(i12, m70Var, str), 66);
                break;
            case 21:
                TLObject tLObject2 = (TLObject) obj;
                n70 n70Var2 = ((m70) obj2).a;
                if (tLObject2 != null) {
            ...
            case 22:
                ...
                p70Var.n = q70Var.getConnectionsManager().sendRequest(tL_messages_searchStickerSets, new aa(p70Var, str2, str2, i11), 66);
                break;
            case 23:
                AndroidUtilities.runOnUIThread(new m4(i13, (j80) obj2, (CacheByChatsController.KeepMediaException) obj), 150L);
                break;
            case 24:
            ...
            case 25:
                ...
                if (str3.trim().toLowerCase().length() == 0) {
                    AndroidUtilities.runOnUIThread(new hw(i12, languageSelectActivity2, new ArrayList()));
                    break;
                } else {
                    ...
                    AndroidUtilities.runOnUIThread(new hw(i12, languageSelectActivity2, arrayList5));
                    break;
                }
                break;
            case 26:
                ...
                if (tLObject3 instanceof TL_account.resolvedBusinessChatLinks) {
                    ...
                    xnVar2.ia = resolvedbusinesschatlinks;
