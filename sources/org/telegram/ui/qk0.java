...
public final class qk0 extends org.telegram.ui.ActionBar.p2 implements org.telegram.ui.Components.zj, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public static void U(qk0 qk0Var, Context context, View view, int i10) {
        qk0 qk0Var2;
        Context context2;
        File file;
        if (i10 == qk0Var.v) {
            qk0Var2 = qk0Var;
            context2 = context;
            org.telegram.ui.Components.mi miVar = new org.telegram.ui.Components.mi(context2, qk0Var2, false, false, true, qk0Var.h);
            qk0Var2.L = miVar;
            miVar.K = true;
            miVar.u1.setVisibility(8);
            miVar.g1.setText(LocaleController.getString(R.string.ChoosePhotoOrVideo));
            qk0Var2.L.r1();
            qk0Var2.L.show();
        } else {
            qk0Var2 = qk0Var;
        ...
        if (view instanceof pk0) {
            pk0 pk0Var = (pk0) view;
            if (qk0Var2.actionBar.s() || pk0Var.e == null) {
                qk0Var2.Z(pk0Var.e);
                return;
            }
            Ringtone ringtone = qk0Var2.M;
            if (ringtone != null) {
                ringtone.stop();
            }
            try {
                ...
                if (ok0Var.b) {
                    ...
                    String str = ok0Var.g;
                    if (str != null && !ok0Var.a) {
                        Ringtone ringtone3 = RingtoneManager.getRingtone(context2.getApplicationContext(), Uri.parse(pk0Var.e.g));
                        ringtone3.setStreamType(4);
                        qk0Var2.M = ringtone3;
                        ringtone3.play();
                    } else if (ok0Var.a) {
                        if (!TextUtils.isEmpty(str)) {
                            file = new File(pk0Var.e.g);
                            if (file.exists()) {
                                if (file == null) {
                                    file = qk0Var2.getFileLoader().getPathToAttach(pk0Var.e.e);
                                }
                                if (file == null && file.exists()) {
                                    ...
                                    FileLoader fileLoader = qk0Var2.getFileLoader();
                                    TLRPC.Document document = pk0Var.e.e;
                        ...
                        FileLoader fileLoader2 = qk0Var2.getFileLoader();
                        TLRPC.Document document2 = pk0Var.e.e;
            ...
            qk0Var2.E = pk0Var.e;
            qk0Var2.F = true;
            nk0 nk0Var = qk0Var2.f;
            nk0Var.q(0, nk0Var.c.n);
        }
    }
    ...
    public final void Z(ok0 ok0Var) {
        ...
        if (sparseArray.get(i10) != null) {
            sparseArray.remove(ok0Var.c);
        } else if (!ok0Var.a) {
            return;
        } else {
            sparseArray.put(ok0Var.c, ok0Var);
        }
        b0();
        nk0 nk0Var = this.f;
        nk0Var.q(0, nk0Var.c.n);
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.B(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f8, this.h), false);
        this.actionBar.C(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.v8, this.h), false);
        ...
        if (this.I == 0) {
            ...
            if (this.I >= 0) {
                ...
                bg.e.p(this.H.getAvatarImageView(), findTopic, false, true, this.h);
        ...
        this.d.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.y8, this.h));
        ...
        this.e.setOnItemClickListener(new hg.v0(20, this, context));
        this.e.setOnItemLongClickListener(new gu(this, 27));
        ...
        for (int i11 = 0; i11 < getMediaDataController().ringtoneDataStore.e.size(); i11++) {
            ...
            ok0Var.f = str;
            ok0Var.e = document3;
            ok0Var.f = a0(document3, str);
            ok0Var.g = dVar.b;
            ok0 ok0Var2 = this.K;
            if (ok0Var2 != null && (document = ok0Var2.e) != null && (document2 = dVar.a) != null && document.id == document2.id) {
                this.K = null;
                this.E = ok0Var;
            }
            this.a.add(ok0Var);
        ...
        this.D = i13 + 1;
        ok0Var3.c = i13;
        ok0Var3.f = LocaleController.getString(R.string.NoSound);
        this.b.add(ok0Var3);
        ok0 ok0Var4 = new ok0();
        int i14 = this.D;
        this.D = i14 + 1;
        ok0Var4.c = i14;
        ok0Var4.f = LocaleController.getString(R.string.DefaultRingtone);
        ok0Var4.b = true;
        this.b.add(ok0Var4);
        ok0 ok0Var5 = this.K;
        if (ok0Var5 != null && ok0Var5.e == null && ok0Var5.g.equals("NoSound")) {
            this.K = null;
            this.E = ok0Var3;
        }
        ok0 ok0Var6 = this.K;
        if (ok0Var6 != null && ok0Var6.e == null && ok0Var6.g.equals("Default")) {
            this.K = null;
            this.E = ok0Var4;
        }
        while (cursor.moveToNext()) {
            ...
            ok0Var7.g = str2;
            ok0 ok0Var8 = this.K;
            if (ok0Var8 != null && ok0Var8.e == null && ok0Var8.g.equals(str2)) {
                this.K = null;
                this.E = ok0Var7;
            }
            this.b.add(ok0Var7);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.onUserRingtonesUpdated) {
            ...
            for (int i13 = 0; i13 < getMediaDataController().ringtoneDataStore.e.size(); i13++) {
                ...
                ok0 ok0Var = new ok0();
                ok0 ok0Var2 = (ok0) hashMap.get(Integer.valueOf(dVar.c));
                if (ok0Var2 != null) {
                    if (ok0Var2 == this.E) {
                        this.E = ok0Var;
                    }
                ...
                TLRPC.Document document3 = dVar.a;
                if (document3 != null) {
                    ok0Var.f = document3.file_name_fixed;
                } else {
                    ok0Var.f = new File(dVar.b).getName();
                }
                TLRPC.Document document4 = dVar.a;
                ok0Var.e = document4;
                ok0Var.f = a0(document4, ok0Var.f);
                ok0Var.g = dVar.b;
                ok0 ok0Var3 = this.K;
                if (ok0Var3 != null && (document = ok0Var3.e) != null && (document2 = dVar.a) != null && document.id == document2.id) {
                    this.K = null;
                    this.E = ok0Var;
                }
    ...
    public final boolean onFragmentCreate() {
        ...
        if (j10 != 0) {
            ...
            str2 = yh.k("sound_document_id_", sharedPrefKey);
            str = yh.k("sound_path_", sharedPrefKey);
        } else {
            int i10 = this.J;
            if (i10 == 1) {
                str = "GlobalSoundPath";
        ...
        this.K = ok0Var;
        if (j11 != 0) {
            ok0Var.e = new TLRPC.TL_document();
            this.K.e.id = j11;
        } else {
            ok0Var.g = string;
        }
    ...
    public final void onFragmentDestroy() {
        ...
        ok0 ok0Var = this.E;
        if (ok0Var.a && (document = ok0Var.e) != null) {
            edit.putLong(str3, document.id);
            edit.putString(str, this.E.f);
            edit.putString(str2, "NoSound");
        } else if (ok0Var.g != null) {
            edit.putString(str, ok0Var.f);
