...
public final class kf1 extends org.telegram.ui.Components.bw0 {
    ...
    public final void J(Canvas canvas, float f7, Rect rect, Paint paint, boolean z10) {
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            ...
            if (dg1Var.g1 != null) {
                ...
                dg1Var.g1.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                canvas.restore();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (dg1Var.isInPreviewMode()) {
            int themedColor = dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6);
            Paint paint = this.x0;
        ...
        if (dg1Var.M0 == null) {
            AndroidUtilities.drawNavigationBarProtection(canvas2, this, dg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.d6), dg1Var.e1);
        }
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == kVar && !dg1Var.isInPreviewMode()) {
            ...
            org.telegram.ui.Components.w81 w81Var = dg1Var.a1;
            int measuredHeight = (int) (y3 + ((int) ((((w81Var == null || w81Var.getVisibility() == 8) ? 0.0f : dg1Var.a1.getMeasuredHeight()) * dg1Var.W) + height)));
            ((ActionBarLayout) dg1Var.getParentLayout()).p(canvas, (int) ((1.0f - dg1Var.W) * 255.0f), measuredHeight);
            float f7 = dg1Var.W;
            if (f7 > 0.0f) {
                if (f7 < 1.0f) {
                    int alpha = org.telegram.ui.ActionBar.j6.k0.getAlpha();
                    org.telegram.ui.ActionBar.j6.k0.setAlpha((int) (alpha * dg1Var.W));
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (r41Var != null) {
            ...
            dg1Var.o0.setPadding(0, 0, 0, i13);
            this.w0 = false;
        }
        int i14 = 0;
