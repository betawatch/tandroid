...
public final class q70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(q70 q70Var, View view, int i10) {
        ...
        if (!q70Var.M) {
            ...
            if (i10 == q70Var.J) {
                q70Var.d0(q70Var.r, true, false);
                return;
            }
            return;
        }
        if (i10 > q70Var.f.d.size()) {
        ...
        } else if (i10 != q70Var.f.d.size()) {
            q70Var.d0((TLRPC.TL_messages_stickerSet) q70Var.f.d.get(i10), ((org.telegram.ui.Cells.n8) view).a(), true);
        }
    }
    ...
    public static void V(q70 q70Var, TLRPC.TL_error tL_error) {
        ...
        TLRPC.TL_messages_stickerSet tL_messages_stickerSet = q70Var.r;
        if (tL_messages_stickerSet != null) {
            ...
            MediaDataController.getInstance(q70Var.currentAccount).putGroupStickerSet(q70Var.r);
        } else if (z10) {
        ...
        NotificationCenter.getInstance(q70Var.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupPackUpdated, Long.valueOf(q70Var.v.id), Boolean.valueOf(z10));
    ...
    public static void a0(q70 q70Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (tL_messages_stickerSet == null) {
            ...
            q70Var.r = tL_messages_stickerSet;
            q70Var.s = false;
            org.telegram.messenger.z0.o(R.string.GroupsEmojiPackUpdated, org.telegram.ui.Components.xc.a0(q70Var), R.raw.done, 36);
        }
        q70Var.h0();
        q70Var.f0(q70Var.r, false);
        if (i10 != -1) {
            if (!q70Var.M) {
    ...
    public final void d0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z10, boolean z11) {
        ...
        ux0Var.d0 = new l70(this, z10, tL_messages_stickerSet);
        ux0Var.B0();
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.d, 16, new Class[]{org.telegram.ui.Cells.n8.class, org.telegram.ui.Cells.fa.class}, null, null, null, org.telegram.ui.ActionBar.h6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.d, 0, new Class[]{org.telegram.ui.Cells.n8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.z6));
