...
public class jq extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void U(jq jqVar, long j10) {
        if (j10 != 0) {
            jqVar.s = j10;
            jqVar.w = MessagesController.getInstance(jqVar.currentAccount).getChat(Long.valueOf(j10));
            jqVar.r0(true);
        }
    }

    public static void V(final jq jqVar, org.telegram.ui.ActionBar.b3 b3Var, View view) {
        ...
        if (intValue == 0) {
            ...
            try {
                DatePickerDialog datePickerDialog = new DatePickerDialog(jqVar.getParentActivity(), new DatePickerDialog.OnDateSetListener() { // from class: org.telegram.ui.cq
                    ...
                    public final void onDateSet(DatePicker datePicker, int i10, int i11, int i12) {
                        ...
                        try {
                            TimePickerDialog timePickerDialog = new TimePickerDialog(jqVar2.getParentActivity(), new TimePickerDialog.OnTimeSetListener() { // from class: org.telegram.ui.fq
                                @Override // android.app.TimePickerDialog.OnTimeSetListener
                                public final void onTimeSet(TimePicker timePicker, int i13, int i14) {
                                    jq jqVar3 = jq.this;
                                    jqVar3.L.until_date = (i14 * 60) + (i13 * 3600) + time;
                                    jqVar3.a.m(jqVar3.J0);
                                }
                            }, 0, 0, true);
                            timePickerDialog.setButton(-1, LocaleController.getString(R.string.Set), timePickerDialog);
                            timePickerDialog.setButton(-2, LocaleController.getString(R.string.Cancel), new dq());
                ...
                datePickerDialog.setButton(-2, LocaleController.getString(R.string.Cancel), new dq());
    ...
    public static /* synthetic */ boolean W(jq jqVar, TLRPC.TL_error tL_error) {
        jqVar.t0(false);
        if (tL_error == null || !"USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
            return true;
        }
        if (!ChatObject.isChannel(jqVar.w)) {
            ...
            v0Var.I1(jqVar.w, arrayList, null, null, null);
            v0Var.show();
        }
        return false;
    }
    ...
    */
    public static void X(jq jqVar, Context context, View view, int i10) {
        ...
        TLRPC.TL_chatBannedRights tL_chatBannedRights2 = jqVar.M;
        int i11 = jqVar.y;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = jqVar.J;
        if (jqVar.F || (jqVar.w.creator && i11 == 0 && i10 == jqVar.b0)) {
            boolean z14 = false;
            if (i10 == jqVar.w0) {
                if (!(view instanceof org.telegram.ui.Cells.r8) || ((org.telegram.ui.Cells.r8) view).isEnabled()) {
                    ...
                    jqVar.a.m(jqVar.w0);
                    if (jqVar.x0) {
                        jqVar.a.s(jqVar.w0 + 1, 10);
                        return;
                    } else {
                        jqVar.a.t(jqVar.w0 + 1, 10);
                        return;
                    }
                }
                return;
            ...
            if (i10 == i12) {
                if (!(view instanceof org.telegram.ui.Cells.r8) || ((org.telegram.ui.Cells.r8) view).isEnabled()) {
                    ...
                    jqVar.a.m(jqVar.K0);
                    if (jqVar.L0) {
                        jqVar.a.s(jqVar.K0 + 1, 3);
                        return;
                    } else {
                        jqVar.a.t(jqVar.K0 + 1, 3);
                        return;
                    }
                }
                return;
            ...
            if (i10 == i13) {
                if (!(view instanceof org.telegram.ui.Cells.r8) || ((org.telegram.ui.Cells.r8) view).isEnabled()) {
                    ...
                    jqVar.a.m(jqVar.P0);
                    if (jqVar.Q0) {
                        jqVar.a.s(jqVar.P0 + 1, 3);
                        return;
                    } else {
                        jqVar.a.t(jqVar.P0 + 1, 3);
                        return;
                    }
                }
                return;
            ...
            if (i10 == 0) {
                ...
                jqVar.presentFragment(new ProfileActivity(bundle, null));
                return;
            }
            if (i10 == jqVar.m0) {
                if (i11 == 0) {
                    MessagesController.getInstance(jqVar.currentAccount).setUserAdminRole(jqVar.s, jqVar.v, new TLRPC.TL_chatAdminRights(), jqVar.P, jqVar.B, jqVar.getFragmentForAlert(0), jqVar.W0, false, null, null);
                    gq gqVar = jqVar.U0;
                    if (gqVar != null) {
                        gqVar.b(0, tL_chatAdminRights, jqVar.L, jqVar.P);
                    }
            ...
            if (i10 == jqVar.J0) {
                ...
                for (int i16 = 5; i15 < i16; i16 = 5) {
                    ...
                    z2VarArr[i15].setOnClickListener(new org.telegram.messenger.video.g(22, jqVar, b3Var));
                    i15++;
                    i14 = -2;
                }
                b3Var.b(linearLayout);
                jqVar.showDialog(g3Var);
                return;
            }
            if (view instanceof org.telegram.ui.Cells.z1) {
                org.telegram.ui.Cells.z1 z1Var = (org.telegram.ui.Cells.z1) view;
                int i17 = jqVar.M0;
                if (i10 == i17 || i10 == jqVar.N0 || i10 == jqVar.O0) {
                    if (i10 == i17) {
                        z11 = !tL_chatAdminRights.post_messages;
                        tL_chatAdminRights.post_messages = z11;
                    } else if (i10 == jqVar.N0) {
                ...
                if (i10 == jqVar.y0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights4 = jqVar.L;
                    z14 = !tL_chatBannedRights4.send_photos;
                    tL_chatBannedRights4.send_photos = z14;
                } else if (i10 == jqVar.z0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights5 = jqVar.L;
                    z14 = !tL_chatBannedRights5.send_videos;
                    tL_chatBannedRights5.send_videos = z14;
                } else if (i10 == jqVar.A0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights6 = jqVar.L;
                    z14 = !tL_chatBannedRights6.send_audios;
                    tL_chatBannedRights6.send_audios = z14;
                } else if (i10 == jqVar.g0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights7 = jqVar.L;
                    z14 = !tL_chatBannedRights7.send_reactions;
                    tL_chatBannedRights7.send_reactions = z14;
                } else if (i10 == jqVar.B0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights8 = jqVar.L;
                    z14 = !tL_chatBannedRights8.send_docs;
                    tL_chatBannedRights8.send_docs = z14;
                } else if (i10 == jqVar.D0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights9 = jqVar.L;
                    z14 = !tL_chatBannedRights9.send_roundvideos;
                    tL_chatBannedRights9.send_roundvideos = z14;
                } else if (i10 == jqVar.C0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights10 = jqVar.L;
                    z14 = !tL_chatBannedRights10.send_voices;
                    tL_chatBannedRights10.send_voices = z14;
                } else if (i10 == jqVar.E0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights11 = jqVar.L;
                    ...
                    if ((jqVar.L.send_plain || tL_chatBannedRights2.send_plain) && (m9 = jqVar.c.m(jqVar.v0)) != null) {
                        AndroidUtilities.shakeViewSpring(m9);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        TLRPC.TL_chatBannedRights tL_chatBannedRights12 = jqVar.L;
                        z14 = !tL_chatBannedRights12.embed_links;
                        tL_chatBannedRights12.embed_links = z14;
                    }
                } else if (i10 == jqVar.F0) {
                    TLRPC.TL_chatBannedRights tL_chatBannedRights13 = jqVar.L;
            ...
            if (view instanceof org.telegram.ui.Cells.r8) {
                ...
                if (!r8Var.isEnabled()) {
                    if (i11 == 2 || i11 == 0) {
                        if ((i10 != jqVar.U || tL_chatBannedRights2 == null || tL_chatBannedRights2.change_info) && ((i10 != jqVar.e0 || tL_chatBannedRights2 == null || tL_chatBannedRights2.pin_messages) && (i10 != jqVar.f0 || tL_chatBannedRights2 == null || tL_chatBannedRights2.edit_rank))) {
                            return;
                        }
                        AlertDialog$Builder alertDialog$Builder3 = new AlertDialog$Builder(jqVar.getParentActivity());
                ...
                if (i10 == jqVar.T) {
                    z15 = !jqVar.H;
                    jqVar.H = z15;
                    TLRPC.TL_chatAdminRights tL_chatAdminRights2 = jqVar.K;
                    FrameLayout frameLayout = jqVar.e;
                    if (frameLayout != null) {
                        frameLayout.invalidate();
                    }
                    int childCount = jqVar.b.getChildCount();
                    int i19 = 0;
                    while (i19 < childCount) {
                        View childAt = jqVar.b.getChildAt(i19);
                        jqVar.b.getClass();
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.r8) {
                            ...
                            if (z16) {
                                ...
                                i19++;
                                z14 = false;
                            } else if ((R != jqVar.U || tL_chatBannedRights2.change_info) && ((R != jqVar.e0 || tL_chatBannedRights2.pin_messages) && (R != jqVar.f0 || tL_chatBannedRights2.edit_rank))) {
                                org.telegram.ui.Cells.r8 r8Var3 = (org.telegram.ui.Cells.r8) childAt;
                                r8Var3.setChecked(z14);
                                r8Var3.b(R == jqVar.T, true);
                            } else {
                    ...
                    jqVar.a.l();
                    org.telegram.ui.Components.k6 k6Var = jqVar.f;
                    if (k6Var != null) {
                        StringBuilder sb = new StringBuilder();
                        b.i(R.string.AddBotButton, " ", sb);
                        sb.append(LocaleController.getString(jqVar.H ? R.string.AddBotButtonAsAdmin : R.string.AddBotButtonAsMember));
                        k6Var.c(sb.toString(), true, jqVar.H);
                    }
                    ValueAnimator valueAnimator = jqVar.Z0;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        jqVar.Z0 = null;
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(jqVar.G, jqVar.H ? 1.0f : 0.0f);
                    jqVar.Z0 = ofFloat;
                    ofFloat.addUpdateListener(new aq(jqVar, 1));
                    jqVar.Z0.setDuration((long) (Math.abs(jqVar.G - (jqVar.H ? 1.0f : 0.0f)) * 200.0f));
                    jqVar.Z0.start();
                } else if (i10 == jqVar.U) {
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights14 = jqVar.L;
                ...
                } else if (i10 == jqVar.h0) {
                    org.telegram.ui.Components.z4.v0(jqVar, LocaleController.getString(R.string.ApproveNewMembersTitle), AndroidUtilities.replaceTags(LocaleController.formatString(z15 ? z13 ? R.string.ApproveNewMembersDisabledMessageChannel : R.string.ApproveNewMembersDisabledMessageGroup : z13 ? R.string.ApproveNewMembersMessageChannel : R.string.ApproveNewMembersMessageGroup, DialogObject.getShortName(user))), LocaleController.getString(!z15 ? R.string.ApproveNewMembersEnable : R.string.ApproveNewMembersDisable), false, new zp(jqVar, !z15 ? user.id : 0L, 1));
                } else if (i10 == jqVar.X) {
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights17 = jqVar.L;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights18 = jqVar.L;
                    ...
                    if (i11 == 0 || i11 == 2) {
                        ...
                        TLRPC.TL_chatBannedRights tL_chatBannedRights19 = jqVar.L;
                        z15 = !tL_chatBannedRights19.edit_rank;
                        tL_chatBannedRights19.edit_rank = z15;
                    }
                } else if (i11 == 1 && (tL_chatBannedRights = jqVar.L) != null) {
                    if (i10 == jqVar.v0) {
    ...
    public static void Y(jq jqVar, TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, TLRPC.TL_channels_editCreator tL_channels_editCreator) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            if (inputCheckPasswordSRP == null) {
                ...
                d2Var.Q = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, jqVar.w.title, UserObject.getFirstName(user)));
                alertDialog$Builder.k(LocaleController.getString(R.string.EditAdminTransferChangeOwner), new yp(jqVar, i11));
        ...
        if (!"PASSWORD_MISSING".equals(tL_error.text) && !tL_error.text.startsWith("PASSWORD_TOO_FRESH_") && !tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
            if ("SRP_ID_INVALID".equals(tL_error.text)) {
                ConnectionsManager.getInstance(jqVar.currentAccount).sendRequest(new TL_account.getPassword(), new lo(i10, jqVar, twoStepVerificationActivity), 8);
                return;
            }
    ...
    public static void Z(jq jqVar, long j10) {
        TLRPC.ChatFull chatFull = jqVar.x;
        long j11 = chatFull != null ? chatFull.guard_bot_id : 0L;
        TLRPC.User user = j11 != 0 ? jqVar.getMessagesController().getUser(Long.valueOf(j11)) : null;
        if (user != null && j10 != 0 && user.id != j10) {
            new org.telegram.ui.Components.y30(jqVar.getParentActivity(), jqVar.resourceProvider, user, jqVar.v, new zp(jqVar, j10, 0)).show();
            return;
        }
        jqVar.n = j10;
        jqVar.r = true;
    ...
    public static /* synthetic */ void a0(jq jqVar, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, long j10) {
        if (j10 != 0) {
            jqVar.s = j10;
            jqVar.w = MessagesController.getInstance(jqVar.currentAccount).getChat(Long.valueOf(j10));
    ...
    public final View createView(Context context) {
        ...
        if (this.F || (!this.B && this.w.creator && UserObject.isUserSelf(this.v))) {
            ...
            this.h = new org.telegram.ui.Components.mr(mutate, new org.telegram.ui.Components.rp(org.telegram.ui.ActionBar.j6.w0(null, i11, false)));
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        f fVar = new f(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 16, new Class[]{org.telegram.ui.Cells.ua.class, org.telegram.ui.Cells.aa.class, org.telegram.ui.Cells.r8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.y8.class, org.telegram.ui.Cells.c6.class}, null, null, null, org.telegram.ui.ActionBar.j6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 262144, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 262144, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.j6.z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.ua.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.ua.class}, new String[]{"statusColor"}, null, null, -1, fVar, org.telegram.ui.ActionBar.j6.y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.ua.class}, new String[]{"statusOnlineColor"}, null, null, -1, fVar, org.telegram.ui.ActionBar.j6.n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.b, 0, new Class[]{org.telegram.ui.Cells.ua.class}, null, org.telegram.ui.ActionBar.j6.r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        if (i10 != 2) {
            if (!(i10 == 1 ? this.O.equals(ChatObject.getBannedRightsString(this.L)) : this.Q.equals(this.P))) {
                ...
                if (z4) {
                    ...
                    alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new yp(this, i11));
    ...
    */
    public final void r0(boolean z4) {
        ...
        boolean isChannel = ChatObject.isChannel(jqVar.w);
        int i10 = jqVar.y;
        int i11 = 2;
        if (!isChannel) {
            if (i10 != 1) {
            ...
            MessagesController.getInstance(jqVar.currentAccount).convertToMegaGroup(jqVar.getParentActivity(), jqVar.s, jqVar, new yp(jqVar, 7));
            return;
        }
        boolean z10 = jqVar.C;
        TLRPC.User user = jqVar.v;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = jqVar.J;
        if (z4 && z10 && !jqVar.I && tL_chatAdminRights.manage_linked_peers && tL_chatAdminRights.change_info) {
            org.telegram.ui.Components.z4.v0(jqVar, LocaleController.getString(R.string.CommunityMakeAdminTitle), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.CommunityMakeAdminMessage, DialogObject.getShortName(user))), LocaleController.getString(R.string.CommunityMakeAdminPromote), false, new bq(jqVar, r6));
            return;
        }
        if (jqVar.s0 != -1 && (str = jqVar.P) != null && str.codePointCount(0, str.length()) > 16) {
            jqVar.b.x0(jqVar.s0);
            Vibrator vibrator = (Vibrator) jqVar.getParentActivity().getSystemService("vibrator");
            if (vibrator != null) {
                vibrator.vibrate(200L);
            }
            f2.l1 K = jqVar.b.K(jqVar.s0);
            if (K != null) {
        ...
        if (i10 == 0) {
            int i12 = jqVar.U0 == null ? 1 : 0;
            jqVar.t0(true);
            MessagesController.getInstance(jqVar.currentAccount).setUserAdminRole(jqVar.s, jqVar.v, jqVar.J, jqVar.P, jqVar.B, jqVar, (!jqVar.W0 || z10) ? 0 : 1, false, null, new bq(jqVar, i11), new yp(jqVar, 8));
            jqVar = jqVar;
            r6 = i12;
        } else {
            if (i10 == 1) {
                if (jqVar.s0 >= 0) {
                    ...
                    tL_messages_editChatParticipantRank.peer = MessagesController.getInputPeer(jqVar.w);
                    ...
                    ConnectionsManager.getInstance(jqVar.currentAccount).sendRequest(tL_messages_editChatParticipantRank, null);
                }
                MessagesController.getInstance(jqVar.currentAccount).setParticipantBannedRole(jqVar.s, jqVar.v, null, jqVar.L, jqVar.B, jqVar.getFragmentForAlert(1));
                TLRPC.TL_chatBannedRights tL_chatBannedRights = jqVar.L;
                ...
                gq gqVar = jqVar.U0;
                if (gqVar != null) {
                    gqVar.b(i11, tL_chatAdminRights, tL_chatBannedRights, jqVar.P);
                }
            } else if (i10 == 2) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(jqVar.getParentActivity());
                String string = jqVar.H ? LocaleController.getString(R.string.AddBotAdmin) : LocaleController.getString(R.string.AddBot);
                org.telegram.ui.ActionBar.d2 d2Var = alertDialog$Builder.a;
                d2Var.O = string;
                boolean z12 = ChatObject.isChannel(jqVar.w) && !jqVar.w.megagroup;
                TLRPC.Chat chat = jqVar.w;
                String str4 = chat != null ? chat.title : "";
                d2Var.Q = AndroidUtilities.replaceTags(jqVar.H ? z12 ? LocaleController.formatString(R.string.AddBotMessageAdminChannel, str4) : LocaleController.formatString(R.string.AddBotMessageAdminGroup, str4) : LocaleController.formatString(R.string.AddMembersAlertNamesText, UserObject.getUserName(user), str4));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                alertDialog$Builder.k(LocaleController.getString(jqVar.H ? R.string.AddAsAdmin : R.string.AddBot), new yp(jqVar, r6));
                jqVar.showDialog(d2Var);
                r6 = 0;
            }
        }
    ...
    public final void t0(boolean z4) {
        ...
        if (mrVar != null) {
            ValueAnimator ofFloat = ValueAnimator.ofFloat(mrVar.c, this.E ? 1.0f : 0.0f);
            this.Y0 = ofFloat;
