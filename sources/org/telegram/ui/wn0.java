...
public final class wn0 implements TextWatcher {
    ...
    */
    public final void afterTextChanged(Editable editable) {
        ...
        boolean z10 = true;
        EditTextBoldCursor editTextBoldCursor = bo0Var.f[1];
        ...
        bo0Var.k0 = true;
        bo0Var.f[1].setTextColor(bo0Var.getThemedColor(org.telegram.ui.ActionBar.g6.G6));
        if (sb2.length() > 4) {
            sb2.setLength(4);
        }
        if (sb2.length() < 2) {
        ...
        if (!this.b) {
            if (sb2.length() == 1) {
                ...
                if (intValue2 > 12 || intValue2 == 0) {
                    bo0Var.f[1].setTextColor(bo0Var.getThemedColor(org.telegram.ui.ActionBar.g6.p7));
                } else {
                    z10 = false;
                }
                selectionStart++;
        ...
        if (sb2.length() == 4 && i13 == 2) {
            ...
            i10 = ((org.telegram.ui.ActionBar.o2) bo0Var).currentAccount;
            boolean z11 = UserConfig.getInstance(i10).getClientPhone().startsWith("7") || ((ltVar = bo0Var.w0) != null && ltVar.c.equals("7"));
        ...
        if (intValue5 > 12 || intValue5 == 0) {
            bo0Var.f[1].setTextColor(bo0Var.getThemedColor(org.telegram.ui.ActionBar.g6.p7));
            if (!z10 && sb2.length() == 4) {
                bo0Var.f[bo0Var.e0 ? (char) 2 : (char) 3].requestFocus();
            }
            if (sb2.length() == 2) {
