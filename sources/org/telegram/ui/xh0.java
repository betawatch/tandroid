    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 == 2) {
            ...
            v80Var.setCanEdit(j3 == yh0Var.getAccountInstance().getUserConfig().clientUserId);
            if (yh0Var.o0 && j3 == yh0Var.getAccountInstance().getUserConfig().clientUserId) {
                if (yh0Var.d != null) {
                    v80Var.setLink("https://t.me/" + ChatObject.getPublicUsername(yh0Var.c));
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                break;
            case 2:
                org.telegram.ui.Components.v80 v80Var = new org.telegram.ui.Components.v80(this.c, yh0Var, null, true, yh0Var.h);
                v80Var.setPermanent(true);
                v80Var.setDelegate(new wh0(this, v80Var));
                view = v80Var;
                break;
            case 3:
                e6Var = ((org.telegram.ui.ActionBar.n2) yh0Var).resourceProvider;
                view = new org.telegram.ui.Cells.f2(context, 64, e6Var);
                break;
            case 4:
            ...
            case 11:
                ...
                view = new org.telegram.ui.Cells.e9(context, e6Var2);
                break;
            default:
                FrameLayout rh0Var = new rh0(context);
                rh0Var.addView(new qh0(context), w7.x5.d(-2, -2.0f, 49, 0.0f, 10.0f, 0.0f, 0.0f));
                TextView textView = new TextView(context);
                textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.g9, false));
