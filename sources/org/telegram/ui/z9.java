...
public final /* synthetic */ class z9 implements RequestDelegate {
    ...
    public /* synthetic */ z9(Object obj, Object obj2, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
        this.d = obj3;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i11) {
            ...
            case 5:
                ...
                AndroidUtilities.runOnUIThread(new og((org.telegram.ui.ActionBar.b2[]) obj2, i13));
                if (tL_error != null) {
            ...
            case 8:
                ...
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new jv((gy) obj3, (TLRPC.TL_attachMenuBot) obj2, (LaunchActivity) obj, i13));
                break;
            case 10:
            ...
            case 14:
                ...
                if (Objects.equals(b70Var.h, (String) obj2) && (tLObject instanceof TLRPC.TL_messages_foundStickerSets)) {
                    ...
                    i10 = ((org.telegram.ui.ActionBar.n2) c70Var).currentAccount;
            ...
            case 24:
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = q91.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), 1, false);
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.l20(vi0Var, tL_error, bVar, str3, tL_loadAsyncGraph, 18));
                break;
            case 25:
                si0 si0Var = (si0) obj3;
                ...
                if (tLObject instanceof TL_stats.TL_statsGraph) {
                    try {
                        bVar = q91.e0(new JSONObject(((TL_stats.TL_statsGraph) tLObject).json.data), si0Var.r.i, false);
                ...
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.l11(si0Var, bVar, str4, p91Var, 19));
                break;
            case 26:
    ...
    public /* synthetic */ z9(Object obj, TLObject tLObject, String str, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = tLObject;
        this.c = str;
