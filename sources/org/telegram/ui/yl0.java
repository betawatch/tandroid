...
public final class yl0 implements lm0 {
    ...
    public yl0(vm0 vm0Var, TLRPC.SecureValueType secureValueType, boolean z10, int i10) {
        this.d = vm0Var;
    ...
    public static void a(yl0 yl0Var, SecureDocument secureDocument, TLRPC.TL_secureFile tL_secureFile) {
        yl0Var.getClass();
    ...
    public final void c(TLRPC.TL_secureRequiredType tL_secureRequiredType, String str, String str2, TLRPC.TL_secureRequiredType tL_secureRequiredType2, String str3, ArrayList arrayList, SecureDocument secureDocument, ArrayList arrayList2, SecureDocument secureDocument2, SecureDocument secureDocument3, Runnable runnable, oc.i iVar) {
        ...
        if (!isEmpty) {
            ...
            a5.j k12 = vm0Var.k1(AndroidUtilities.getStringBytes(str2));
        ...
        if (tL_secureRequiredType2 != null) {
            ...
            if (!TextUtils.isEmpty(str3)) {
                ...
                a5.j k13 = vm0Var.k1(AndroidUtilities.getStringBytes(str3));
            ...
            if (!z10) {
                ...
                ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue, new xl0(this, iVar, str, savesecurevalue, tL_secureRequiredType2, tL_secureRequiredType, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, runnable, this, tL_inputSecureValue2));
            }
        ...
        savesecurevalue2.secure_secret_id = vm0Var.X0;
        i10 = ((org.telegram.ui.ActionBar.o2) vm0Var).currentAccount;
        ConnectionsManager.getInstance(i10).sendRequest(savesecurevalue2, new xl0(this, iVar, str, savesecurevalue2, tL_secureRequiredType2, tL_secureRequiredType, arrayList, secureDocument, secureDocument2, secureDocument3, arrayList2, str2, str3, runnable, this, tL_inputSecureValue2));
    }
}
