...
public final class nc extends View {
    ...
    public /* synthetic */ nc(org.telegram.ui.ActionBar.o2 o2Var, Activity activity, Canvas canvas, float f7, float f10, float f11, Paint paint, Bitmap bitmap, Paint paint2, float f12, float f13, int i10) {
        super(activity);
        this.a = i10;
        this.v = o2Var;
        this.b = canvas;
