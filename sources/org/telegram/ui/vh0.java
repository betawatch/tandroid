...
public final class vh0 extends FrameLayout {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            SpannableStringBuilder X0 = zh.v7.X0(false, i2.g.k(tL_chatInviteExported.subscription_pricing.amount, ',', new StringBuilder("⭐️ ")), 0.75f, null);
            ...
            dp = AndroidUtilities.dp(28.0f) + ((int) Math.max(di.f4.g(textView.getText(), textView.getPaint()), di.f4.g(textView2.getText(), textView2.getPaint())));
        } else {
        ...
        if (!isEmpty) {
            ...
            i11 = ((org.telegram.ui.ActionBar.n2) yh0Var).currentAccount;
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            org.telegram.ui.Components.at atVar = new org.telegram.ui.Components.at();
            atVar.b = AndroidUtilities.dp(1.5f);
            spannableStringBuilder2.append((CharSequence) "  .  ").setSpan(atVar, spannableStringBuilder2.length() - 3, spannableStringBuilder2.length() - 2, 0);
            ...
            org.telegram.ui.Components.at atVar2 = new org.telegram.ui.Components.at();
            atVar2.b = AndroidUtilities.dp(1.5f);
            spannableStringBuilder2.append((CharSequence) "  .  ").setSpan(atVar2, spannableStringBuilder2.length() - 3, spannableStringBuilder2.length() - 2, 0);
            ...
            org.telegram.ui.Components.at atVar3 = new org.telegram.ui.Components.at();
            atVar3.b = AndroidUtilities.dp(1.5f);
            spannableStringBuilder2.append((CharSequence) "  .  ").setSpan(atVar3, spannableStringBuilder2.length() - 3, spannableStringBuilder2.length() - 2, 0);
            long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((yh0Var.n0 * 1000) + System.currentTimeMillis());
        ...
        if (tL_chatInviteExported.request_needed) {
            org.telegram.ui.Components.at atVar4 = new org.telegram.ui.Components.at();
            atVar4.b = AndroidUtilities.dp(1.5f);
            spannableStringBuilder2.append((CharSequence) "  .  ").setSpan(atVar4, spannableStringBuilder2.length() - 3, spannableStringBuilder2.length() - 2, 0);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z11 || tL_chatInviteExported2.revoked) {
            ...
            if (i12 > 0 || tL_chatInviteExported2.usage_limit > 0) {
                if (i12 > 0) {
                    long currentTimeMillis = (yh0Var.n0 * 1000) + System.currentTimeMillis();
        ...
        if (!z12) {
            ...
            if (tL_chatInviteExported.subscription_pricing == null) {
                yh0Var.a0.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                yh0Var.a0.draw(canvas2);
            } else if (tL_chatInviteExported.revoked) {
                yh0Var.Z.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                yh0Var.Z.draw(canvas2);
            } else {
                yh0Var.Y.setBounds(dp - AndroidUtilities.dp(12.0f), measuredHeight - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + dp, AndroidUtilities.dp(12.0f) + measuredHeight);
                yh0Var.Y.draw(canvas2);
            }
            if (this.H) {
                return;
            }
        ...
        z10 = ((org.telegram.ui.ActionBar.n2) yh0Var).isPaused;
        if (!z10) {
            invalidate();
        }
        this.F = f14;
