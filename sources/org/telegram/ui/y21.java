...
public final class y21 extends View {
    ...
    public Bitmap n;
    public boolean r;
    public final org.telegram.ui.Components.xo0 s;
    public TextPaint v;
    ...
    public y21(Context context) {
        ...
        this.x = new org.telegram.ui.Components.e6(1.0f, this, 0L, 2000L, qrVar);
        ...
        org.telegram.ui.Components.xo0 xo0Var = new org.telegram.ui.Components.xo0(this);
        this.s = xo0Var;
        xo0Var.k(0.35f, 300L, qrVar);
        xo0Var.setCallback(this);
        xo0Var.u(AndroidUtilities.getTypeface("fonts/rcondensedbold.ttf"));
        xo0Var.a.setShader(bitmapShader2);
        xo0Var.b = 17;
        xo0Var.t(AndroidUtilities.dp(35.0f));
        xo0Var.q("", true, true);
    ...
    public final void a(Canvas canvas) {
        p21 p21Var;
        if (this.F != null) {
            int A = org.telegram.messenger.wh.A(60.0f, getWidth(), 33);
            int i10 = (A * 33) + 32;
            ...
            float round = ((Math.round((r8 / 4.65f) / r6) * A) / 2) * 0.75f;
            canvas.drawCircle(width2, width3, round, paint);
            TelegramQRCodeWriter.drawSideQuads(canvas, f10, f7, paint, 7.0f, A, 16, i10, 0.75f, this.L, true);
            if (this.M || (p21Var = this.e) == null) {
                return;
            }
            e31 e31Var = p21Var.a;
            e31Var.c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    */
    public final void b(int i10, int i11) {
        ...
        if ((TextUtils.isEmpty(this.G) && !this.r) || TextUtils.isEmpty(this.I)) {
            AndroidUtilities.runOnUIThread(new v21(this, 1));
            return;
        }
        ...
        int B = org.telegram.messenger.wh.B(20.0f, 2, createBitmap.getWidth());
        if (!this.r) {
            int i17 = 0;
            for (int i18 = 2; i17 <= i18; i18 = 2) {
                ...
                if (i17 > 1 || measureText <= B) {
                    ...
                    i12 = 2;
                    f7 = 30.0f;
                    staticLayout = org.telegram.ui.Components.vw0.c(spannableStringBuilder, textPaint, i20, Layout.Alignment.ALIGN_CENTER, 0.0f, false, null, Math.min(AndroidUtilities.dp(10.0f) + i20, createBitmap.getWidth()), i19, true);
                    float lineCount = (staticLayout != null ? 0 : staticLayout.getLineCount()) * (textPaint.descent() - textPaint.ascent());
                    int B2 = org.telegram.messenger.wh.B(f7, i12, i10);
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.x21
                        ...
                        public final void run() {
                            y21 y21Var = y21.this;
                            Bitmap bitmap2 = y21Var.h;
                            y21Var.h = createBitmap.extractAlpha();
                            if (!y21Var.S) {
                                y21Var.x.d(0.0f, true);
                            }
                            y21Var.S = false;
                            Bitmap bitmap3 = y21Var.n;
                            if (bitmap3 != null) {
                                bitmap3.recycle();
                            }
                            y21Var.n = bitmap2;
                            ...
                            if (p21Var != null) {
                                ...
                                float f14 = width3;
                                e31 e31Var = p21Var.a;
                                e31Var.c.set((int) (f13 - f12), (int) (f14 - f12), (int) (f13 + f12), (int) (f14 + f12));
                                e31Var.E.requestLayout();
                                y21Var.M = true;
                            }
                            y21Var.invalidate();
        ...
        int B22 = org.telegram.messenger.wh.B(f7, i12, i10);
    ...
    public final void d(boolean z10) {
        if (this.r) {
            ...
            this.w = org.telegram.ui.Components.vw0.c(Emoji.replaceEmoji(str, this.v.getFontMetricsInt(), false), this.v, getWidth(), Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, getWidth() - AndroidUtilities.dp(60.0f), 1, true);
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (d < 1.0f) {
            ...
            if (z10) {
                ...
                xo0Var.setBounds(0, i12, width, dp4);
                xo0Var.draw(canvas);
                return;
            }
        }
