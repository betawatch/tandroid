            ...
            if (i22 != 2) {
                ...
                if (pageblockvideo == null) {
                    if (i22 != 0 || (i21 = pageblockvideo.level) <= 0) {
                        ...
                        this.x = i16;
                        i15 = org.telegram.messenger.rl.u(18.0f, i16, i12);
                        dp = i15;
                    }
                    ...
                    if (document != null) {
                        ...
                        if (i22 == 0) {
                            ...
                            if ((this.P.flags & 8) == 0) {
                                ...
                                float f13 = dp2;
                                this.B = (int) com.google.android.recaptcha.internal.a.A(imageReceiver.getImageWidth(), f13, 2.0f, imageReceiver.getImageX());
                        ...
                        imageReceiver.setAspectFit(true);
                        float f132 = dp2;
                        this.B = (int) com.google.android.recaptcha.internal.a.A(imageReceiver.getImageWidth(), f132, 2.0f, imageReceiver.getImageX());
                    ...
                    if (i22 == 0) {
                        ...
                        if (q6 != null) {
                            ...
                            this.A = height;
                            i17 = org.telegram.messenger.y1.C(4.0f, height, i17);
                            f3 f3Var = this.c;
                            f3Var.s = this.x;
                            f3Var.v = this.y;
                        }
                        ...
                        k4Var = k4Var2;
                        f3 p6 = m4.p(this.a, this, null, pageblockvideo3.caption.credit, dp, 0, pageblockvideo3, (k4Var2 == null || !k4Var2.C) ? Layout.Alignment.ALIGN_NORMAL : org.telegram.ui.Components.tv0.a(), 0, this.b);
                        this.d = p6;
                        if (p6 != null) {
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (visibility != 0 || y10 <= g1Var.getTranslationY() || y10 >= g1Var.getTranslationY() + AndroidUtilities.dp(39.0f)) {
            if (motionEvent.getAction() == 0 && this.e.isInsideImage(x8, y10)) {
                if (this.E != -1) {
                    if (x8 >= this.B && x8 <= AndroidUtilities.dp(48.0f) + r2) {
                        if (y10 >= this.C) {
                        }
                    }
                }
