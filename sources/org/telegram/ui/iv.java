    ...
    */
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.b && !this.c) {
            ...
            if (this.b && (((z10 = kvVar.r) && x10 > 0) || (!z10 && x10 < 0))) {
            ...
            if (this.b) {
                ...
                boolean z11 = Math.abs(x11) < ((float) jvVarArr[0].getMeasuredWidth()) / 3.0f && (Math.abs(f7) < 3500.0f || Math.abs(f7) < Math.abs(f10));
                kvVar.s = z11;
                ...
                kvVar.h.setDuration(Math.max(ImageReceiver.DEFAULT_CROSSFADE_DURATION, Math.min(Math.abs(f7) > 0.0f ? Math.round(Math.abs(distanceInfluenceForSnapDuration / r4) * 1000.0f) * 4 : (int) (((measuredWidth / getMeasuredWidth()) + 1.0f) * 100.0f), 600)));
