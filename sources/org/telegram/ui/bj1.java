...
public final /* synthetic */ class bj1 implements org.telegram.ui.ActionBar.a2, oy {
    public final /* synthetic */ dj1 a;

    public /* synthetic */ bj1(dj1 dj1Var) {
        this.a = dj1Var;
    }
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof gj1) {
                ...
                if (wallPaper == null || wallPaper.id >= 0) {
                    ...
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(gj1Var.l.id);
                    wallpapersListActivity.f0.remove(gj1Var);
                    wallpapersListActivity.d0.remove(gj1Var.a());
                }
            }
            if (valueAt instanceof TLRPC.WallPaper) {
                ...
                if (str != null && str.equals(wallpapersListActivity.S)) {
                    wallpapersListActivity.S = org.telegram.ui.ActionBar.j6.d1() ? "t" : "d";
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, eg1 eg1Var) {
        ...
        int i18 = 0;
        while (true) {
            longSparseArray = wallpapersListActivity.i0;
