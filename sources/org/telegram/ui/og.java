...
public final /* synthetic */ class og implements Utilities.Callback2 {
    ...
    public /* synthetic */ og(bo boVar, aj ajVar, org.telegram.ui.Cells.t1 t1Var, String str, CharacterStyle characterStyle) {
        this.b = boVar;
        this.d = ajVar;
        this.c = t1Var;
        this.e = str;
        ...
        switch (this.a) {
            case 0:
                ...
                if (j3 != 0) {
                    bool = bool2;
                    z12 = false;
                    I.c(z10 ? R.drawable.msg_channel : R.drawable.msg_discussion, LocaleController.getString(z10 ? R.string.ViewChannel : R.string.SendMessage), new me(boVar, j3, 3), false);
                } else {
                    bool = bool2;
                    z12 = false;
                }
                ...
                I.k();
                if (j3 != 0) {
                    I.n(tLObject, LocaleController.getString(z11 ? R.string.ViewProfile : z13 ? R.string.ViewChannelProfile : R.string.ViewGroupProfile), new me(boVar, j3, 4));
                } else {
    ...
    public /* synthetic */ og(bo boVar, bj bjVar, int[] iArr, org.telegram.ui.Cells.t1 t1Var, MessageObject messageObject) {
        this.b = boVar;
        this.d = bjVar;
        this.e = iArr;
        this.c = t1Var;
