...
public final class z81 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.u40, xg0, le.e {
    ...
    public static /* synthetic */ void V(z81 z81Var) {
    ...
    public static /* synthetic */ void X(z81 z81Var, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
    ...
    */
    public static void Z(z81 z81Var) {
        String str;
        int i10;
        String string;
        String str2;
        ...
        if (i12 < 2 && !BuildVars.DEBUG_PRIVATE_VERSION) {
            try {
                Toast.makeText(z81Var.getParentActivity(), LocaleController.getString(R.string.DebugMenuLongPress), 0).show();
                return;
            } catch (Exception e) {
                FileLog.e(e);
                return;
        ...
        String str19 = !SharedConfig.isUsingCamera2(z81Var.currentAccount) ? "Use Camera 2 API" : "Use old Camera 1 API";
        ...
        if (SharedConfig.canBlurChat()) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                alertDialog$Builder.f(charSequenceArr, new qv(z81Var, 3));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                z81Var.showDialog(a2Var);
            }
        } else {
            str4 = string2;
        }
        ...
        alertDialog$Builder.f(charSequenceArr2, new qv(z81Var, 3));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
        z81Var.showDialog(a2Var);
    }

    public static /* synthetic */ void a0(z81 z81Var, ValueAnimator valueAnimator) {
    ...
    public static void b0(z81 z81Var, ArrayList arrayList) {
        ...
        while (true) {
            ...
            if (UserConfig.getInstance(i22).isClientActivated() && z81Var.currentAccount != i22) {
        ...
        if (ApplicationLoader.isBetaBuild() || ApplicationLoader.isStandaloneBuild() || ApplicationLoader.isHuaweiStoreBuild() || (yh.s5.y(z81Var.currentAccount, true).e && (yh.s5.y(z81Var.currentAccount, true).O(0) || yh.s5.y(z81Var.currentAccount, true).p().positive()))) {
            ...
            arrayList.add(v81.a(13, -14965523, -15431455, i26, string, null, charSequence3));
        }
    ...
    public static /* synthetic */ void c0(z81 z81Var, TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        ...
        if (tL_error == null) {
            ...
            } else if (closestPhotoSizeWithSize2 != null && z81Var.w != null) {
                FileLoader.getInstance(z81Var.currentAccount).getPathToAttach(z81Var.w, true).renameTo(FileLoader.getInstance(z81Var.currentAccount).getPathToAttach(closestPhotoSizeWithSize2, true));
            }
            z81Var.getMessagesController().getDialogPhotos(user.id).addPhotoAtStart(tL_photos_photo.photo);
    ...
    public static void d0(z81 z81Var, int i10) {
        ...
        if (i10 == 6) {
            ...
            for (String str2 : MessagesController.getNotificationsSettings(z81Var.currentAccount).getAll().keySet()) {
        ...
        try {
            ...
            if (i10 == 16) {
                ...
                Toast.makeText(z81Var.getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? R.string.DebugMenuWebViewDebugEnabled : R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i10 == 17) {
            ...
            if (i10 != 20) {
                ...
                if (i10 == 23) {
                    ...
                    Toast.makeText(z81Var.getParentActivity(), LocaleController.getString(!q6 ? R.string.DebugMenuDualOnToast : R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i10 == 24) {
                    SharedConfig.toggleSurfaceInStories();
                    while (i12 < z81Var.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.m2) z81Var.getParentLayout().getFragmentStack().get(i12)).clearSheets();
                        i12++;
                    }
                    return;
                }
                ...
                if (i10 == 42) {
                    ...
                    synchronized (aVar) {
                        try {
                            if (!aVar.b) {
                                aVar.c = pi.d.a.getBoolean("experimental_settings_allowed", true);
                                aVar.b = true;
                            }
                            boolean z12 = !aVar.c;
                            aVar.c = z12;
    ...
    public static /* synthetic */ void e0(z81 z81Var, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2) {
        if (inputFile == null && inputFile2 == null && videoSize == null) {
            TLRPC.FileLocation fileLocation = photoSize.location;
            z81Var.v = fileLocation;
            z81Var.w = photoSize2.location;
    ...
    public static void f0(z81 z81Var, org.telegram.ui.Components.v51 v51Var) {
        ...
        switch (v51Var.d) {
            ...
            case 24:
                z81Var.presentFragment(new f41(null));
                break;
        }
    }
    ...
    public final void n0(boolean z10, boolean z11) {
        ...
        this.r.addListener(new c70(9, this, z10));
        this.r.start();
    }
    ...
    */
    public final void o0(boolean z10, boolean z11) {
        ...
        org.telegram.ui.ActionBar.p0 p0Var = this.e.F;
        if (p0Var == null || p0Var.getTag() == null) {
