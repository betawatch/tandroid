...
public final class py extends org.telegram.ui.Components.qv0 {
        ...
        if (Build.VERSION.SDK_INT >= 29 && SharedConfig.chatBlurEnabled()) {
            ...
            if (wyVar.l4 != null) {
                ...
                if (eh.b.c(i10, f6Var)) {
                    ...
                    if (f6Var2 != null) {
                        f6Var3 = ((org.telegram.ui.ActionBar.o2) wyVar).resourceProvider;
                    }
                    canvas.save();
                    canvas.translate(0.0f, -f7);
                    wyVar.l4.y(canvas, rect.left, rect.top + f7, rect.right, rect.bottom + f7);
                    canvas.restore();
    ...
    public final void L(Canvas canvas, ArrayList arrayList) {
        ...
        if (wyVar.p3 && (gyVar = wyVar.C0) != null && gyVar.getVisibility() == 0) {
            ...
            for (int i10 = 0; i10 < viewArr.length; i10++) {
                ...
                if (view != null && view.getVisibility() == 0 && (p5 = org.telegram.ui.Components.j81.p(viewArr[i10])) != null) {
    ...
    */
    ...
    public final int b0() {
        ...
        float f7 = wyVar.N;
        qx qxVar = wyVar.F3;
        return (int) com.google.android.gms.internal.vision.e2.z(1.0f, wyVar.x1, org.telegram.messenger.w1.A(1.0f, (qxVar == null || !qxVar.c()) ? 0.0f : wyVar.F3.e, 1.0f - wyVar.t3, f7), -getY());
    }
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && wyVar.k4 != null) {
            wyVar.m3();
        }
        if (wyVar.Q && (((qxVar2 = wyVar.F3) == null || !qxVar2.c()) && wyVar.t3 == 0.0f)) {
            ...
            s4.c1 M2 = syVar.M(i10, false);
            if (M2 != null) {
                float paddingTop = syVar.getPaddingTop() - M2.a.getY();
                if (paddingTop >= 0.0f) {
        ...
        int a02 = a0();
        z10 = ((org.telegram.ui.ActionBar.o2) wyVar).inPreviewMode;
        ...
        if (z12) {
            ...
            f7 = 1.0f;
            f10 = 81.0f;
            z11 = ((org.telegram.ui.ActionBar.o2) wyVar).inPreviewMode;
            if (!z11) {
                if (wyVar.t3 > 0.0f) {
                    paint2.setColor(wyVar.getThemedColor(org.telegram.ui.ActionBar.j6.d6));
                ...
                if (!wyVar.W && wyVar.X2 == 0) {
                    AndroidUtilities.drawNavigationBarProtection(canvas2, this, wyVar.getThemedColor(org.telegram.ui.ActionBar.j6.d6), wyVar.f4);
                }
                wyVar.V = true;
            }
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (org.telegram.ui.Components.qv0.v0) {
        ...
        if (view == vyVarArr[0] || ((vyVarArr.length > 1 && view == vyVarArr[1]) || view == wyVar.J1 || view == wyVar.z0)) {
            ...
            if (f7 != 1.0f) {
                if (wyVar.X3) {
                    canvas.translate((1.0f - wyVar.W3) * AndroidUtilities.dp(40.0f) * (-1), 0.0f);
                } else {
                    float b10 = com.google.android.gms.internal.vision.e2.b(1.0f, f7, 0.05f, 1.0f);
                    canvas.translate((1.0f - wyVar.W3) * (-AndroidUtilities.dp(4.0f)), 0.0f);
                    canvas.scale(b10, b10, 0.0f, (-getY()) + wyVar.N + a0());
                }
            }
        ...
        if (wyVar.X3) {
            ...
            float b11 = com.google.android.gms.internal.vision.e2.b(1.0f, wyVar.W3, 0.05f, 1.0f);
            canvas.translate((1.0f - wyVar.W3) * (-AndroidUtilities.dp(4.0f)), 0.0f);
                    ...
                    if (i22 == 16) {
                        ...
                        if (childAt != wyVar.X || childAt == wyVar.Z || childAt == (nxVar2 = wyVar.E0)) {
                            ...
                            if (childAt == nxVar && nxVar.getPremiumHint() != null) {
                                wyVar.E0.getPremiumHint().layout(i16, org.telegram.messenger.wl.D(54.0f, i19, measuredHeight2), i16 + measuredWidth2, wyVar.E0.getPremiumHint().getMeasuredHeight() + org.telegram.messenger.wl.D(54.0f, i19, measuredHeight2));
                            }
                            if (childAt == wyVar.X) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                if (childAt != kVar2) {
                    if (childAt instanceof dv) {
                        ...
                        int i15 = wyVar.Y3 ? (int) (i14 * 0.05f) : 0;
                        ...
                        if (childAt == gyVar) {
                            ...
                            wyVar.C0.q0.setKeyboardHeight(R);
                            ...
                            gx gxVar = wyVar.B1;
                            if (gxVar == null || !gxVar.v0(childAt)) {
                                if (childAt == wyVar.F3) {
                                    int size4 = View.MeasureSpec.getSize(i11);
                                    int i16 = wyVar.Y3 ? (int) (size4 * 0.05f) : 0;
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        Object[] objArr = 0;
        if (e5Var != null && (uwVar = wyVar.z0) != null && !uwVar.n && !wyVar.j2 && !wyVar.F3.c()) {
            e5Var2 = ((org.telegram.ui.ActionBar.o2) wyVar).parentLayout;
            if (!((ActionBarLayout) e5Var2).j()) {
                e5Var3 = ((org.telegram.ui.ActionBar.o2) wyVar).parentLayout;
                if (!((ActionBarLayout) e5Var3).y()) {
                    e5Var4 = ((org.telegram.ui.ActionBar.o2) wyVar).parentLayout;
                    if (!((ActionBarLayout) e5Var4).n && (motionEvent == null || wyVar.l3 || (motionEvent.getY() > a0() + b0() && ((gVar = wyVar.y1) == null || gVar.getVisibility() != 0 || motionEvent.getY() < wyVar.y1.getY())))) {
                        if (wyVar.R0 != 3) {
                            i10 = ((org.telegram.ui.ActionBar.o2) wyVar).currentAccount;
                        ...
                        if (motionEvent != null && motionEvent.getAction() == 0 && Z()) {
                            ...
                            if (wyVar.h3) {
                                if (x10 < wyVar.e0[0].getTranslationX() + wyVar.e0[0].getMeasuredWidth()) {
                                    ...
                                    wyVar.z0.g(wyVar.i3 / r10[0].getMeasuredWidth(), wyVar.e0[1].h);
                                    wyVar.R4(true);
                        ...
                        if (motionEvent != null && motionEvent.getAction() == 0 && !wyVar.l3 && !wyVar.m3 && wyVar.z0.getVisibility() == 0) {
                            ...
                            if (wyVar.l3) {
                                ...
                                if (z12) {
                                    ...
                                    if (wyVar.h3) {
                                        wyVar.f3.playTogether(ObjectAnimator.ofFloat(wyVar.e0[0], (Property<vy, Float>) property, 0.0f), ObjectAnimator.ofFloat(wyVar.e0[1], (Property<vy, Float>) property, r12.getMeasuredWidth()));
                                    } else {
                                        wyVar.f3.playTogether(ObjectAnimator.ofFloat(wyVar.e0[0], (Property<vy, Float>) property, 0.0f), ObjectAnimator.ofFloat(wyVar.e0[1], (Property<vy, Float>) property, -r12.getMeasuredWidth()));
                                    }
                                } else {
                                    ...
                                    if (wyVar.h3) {
                                        wyVar.f3.playTogether(ObjectAnimator.ofFloat(wyVar.e0[0], (Property<vy, Float>) property, -r11.getMeasuredWidth()), ObjectAnimator.ofFloat(wyVar.e0[1], (Property<vy, Float>) property, 0.0f));
                                    } else {
                                        wyVar.f3.playTogether(ObjectAnimator.ofFloat(wyVar.e0[0], (Property<vy, Float>) property, r11.getMeasuredWidth()), ObjectAnimator.ofFloat(wyVar.e0[1], (Property<vy, Float>) property, 0.0f));
                                    }
                                }
                                wyVar.f3.setInterpolator(wy.y4);
                                ...
                                wyVar.f3.setDuration(Math.max(ImageReceiver.DEFAULT_CROSSFADE_DURATION, Math.min(Math.abs(f7) > 0.0f ? Math.round(Math.abs(distanceInfluenceForSnapDuration / r6) * 1000.0f) * 4 : (int) (((measuredWidth / getMeasuredWidth()) + 1.0f) * 100.0f), 600)));
                                wyVar.f3.addListener(new org.telegram.ui.Components.w81(this, 18));
                                wyVar.f3.start();
                                wyVar.g3 = true;
                                wyVar.l3 = false;
                            } else {
