...
public final /* synthetic */ class o80 implements ky, org.telegram.ui.ActionBar.c2 {
    ...
    public /* synthetic */ o80(LaunchActivity launchActivity, int i10, TLRPC.User user, String str, String str2, qy qyVar) {
    ...
    public boolean w(qy qyVar, ArrayList arrayList, CharSequence charSequence, boolean z4, boolean z10, int i10, int i11, sf1 sf1Var) {
        ...
        if (chat == null || (!chat.creator && ((tL_chatAdminRights = chat.admin_rights) == null || !tL_chatAdminRights.add_admins))) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.AddBot), new org.telegram.ui.ActionBar.c2() { // from class: org.telegram.ui.k90
                @Override // org.telegram.ui.ActionBar.c2
                public final void l(org.telegram.ui.ActionBar.d2 d2Var2, int i13) {
                    ...
                    MessagesController.getInstance(i15).addUserToChat(j11, user, 0, str2, znVar, null);
                    ((ActionBarLayout) LaunchActivity.this.O()).S(znVar, true, false);
                }
            });
            alertDialog$Builder.o();
        } else {
            MessagesController.getInstance(i12).checkIsInChat(false, chat, user, new MessagesController.IsInChatCheckedCallback() { // from class: org.telegram.ui.j90
                @Override // org.telegram.messenger.MessagesController.IsInChatCheckedCallback
                public final void run(boolean z11, TLRPC.TL_chatAdminRights tL_chatAdminRights2, String str3) {
                    Pattern pattern2 = LaunchActivity.y1;
                    AndroidUtilities.runOnUIThread(new org.telegram.messenger.p8(LaunchActivity.this, str, tL_chatAdminRights2, z11, str2, i12, chat, qyVar2, user, j10, str3));
                }
            });
        }
        return true;
    ...
    public /* synthetic */ o80(uf.g1 g1Var, gg.c1 c1Var, int i10, uf.o1 o1Var, TextView textView, Utilities.Callback callback) {
        this.b = g1Var;
        this.c = c1Var;
        this.a = i10;
        this.d = o1Var;
