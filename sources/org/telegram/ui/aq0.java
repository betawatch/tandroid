...
public final class aq0 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean a0;
    public final yh.m5 b;
    public i0.b b0;
    public final yh.m5 c;
    public yf.b0 c0;
    public j0 d;
    ...
    public static void U(aq0 aq0Var, boolean[] zArr, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, yo0 yo0Var, yh.c3 c3Var, nf.e eVar) {
        zArr[0] = true;
        eVar.d();
        yh.u5.x(aq0Var.currentAccount, c3Var.a).h(c3Var.b, tL_starGiftUnique, j3, null, true, new ai.m0(18, eVar, yo0Var));
    }
    ...
    */
    public final void E0() {
        ...
        if (this.H != null) {
            ...
            if (z10) {
                ...
                up0 up0Var = this.h;
                if (up0Var.h >= 0) {
                    org.telegram.ui.Components.vc.a0(this.H).L(vp0.a(this.currentAccount, this.h.h), LocaleController.getString(z11 ? R.string.ChannelColorApplied : R.string.UserColorApplied)).j();
                } else {
                    if (up0Var.s == null) {
                        return;
                    }
            ...
            if (this.V) {
                ...
                up0 up0Var2 = this.n;
                if (up0Var2.h >= 0) {
                    org.telegram.ui.Components.vc.a0(this.H).L(vp0.c(this.currentAccount, this.n.h), LocaleController.getString(z11 ? R.string.ChannelProfileColorApplied : R.string.UserProfileColorApplied)).j();
                } else if (up0Var2.n != 0) {
                    ...
                    org.telegram.ui.Components.aj0 aj0Var = wbVar.a;
                    if (isTextColorEmoji) {
                    ...
                    org.telegram.messenger.y0.o(z11 ? R.string.ChannelProfileColorResetApplied : R.string.UserProfileColorResetApplied, org.telegram.ui.Components.vc.a0(this.H), R.raw.contact_check, 36);
                }
            }
            this.H = null;
        }
    ...
    public final void F0() {
        ...
        dp0 dp0Var = this.e;
        if (dp0Var != null) {
            dp0Var.a = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.a7, dp0Var.b);
            dp0Var.a();
            dp0Var.invalidate();
        }
        G0();
    ...
    public final View createView(Context context) {
        ...
        this.c0 = new yf.b0(context, new xo0(this, i11));
        ...
        if (dVar3 != null && C0 != null && C0 != this.R) {
            this.R = C0;
            n7.a1 a1Var = C0.e;
            dVar3.g((CharSequence) a1Var.b, false, true);
        ...
        dp0 dp0Var3 = this.e;
        dp0Var3.getClass();
        dp0Var3.a = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.a7, dp0Var3.b);
        dp0Var3.a();
        dp0Var3.invalidate();
        z0();
