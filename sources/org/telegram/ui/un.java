...
public final class un extends Drawable {
    ...
    public final jh.y2 e;
    public final org.telegram.ui.Components.nb0 f;
    ...
    public un(TLRPC.WallPaper wallPaper, boolean z10, boolean z11) {
        ...
        if (z11) {
            k10 = "150_150_wallpaper";
        } else {
            StringBuilder sb2 = new StringBuilder();
            sb2.append((int) (min / AndroidUtilities.density));
            sb2.append("_");
            k10 = a9.p.k((int) (max / AndroidUtilities.density), "_wallpaper", sb2);
        }
        StringBuilder o10 = com.google.android.recaptcha.internal.a.o(k10);
        o10.append(wallPaper.id);
        StringBuilder o11 = com.google.android.recaptcha.internal.a.o(o10.toString());
        o11.append(e(wallPaper.settings));
        String sb3 = o11.toString();
        Drawable b10 = b(wallPaper);
        String str = wallPaper.uploadingImage;
        if (str != null) {
            y2Var.setImage(ImageLocation.getForPath(str), sb3, b10, null, wallPaper, 1);
            return;
        }
        TLRPC.Document document = wallPaper.document;
        if (document != null) {
            y2Var.setImage(ImageLocation.getForDocument(document), sb3, b10, null, wallPaper, 1);
        } else {
    ...
    public static Drawable b(TLRPC.WallPaper wallPaper) {
        ...
        if (wallPaper.document != null) {
            ...
            if (wallPaperSettings == null || wallPaperSettings.intensity < 0) {
                ...
                a2 = a(new ColorDrawable(i0.b.k(wallPaper.settings.background_color, 255)));
            } else if (wallPaperSettings.third_background_color == 0) {
                a2 = a(new GradientDrawable(org.telegram.ui.Components.m9.d(wallPaper.settings.rotation), new int[]{i0.b.k(wallPaperSettings.background_color, 255), i0.b.k(wallPaper.settings.second_background_color, 255)}));
            } else {
                int k10 = i0.b.k(wallPaperSettings.background_color, 255);
                int k11 = i0.b.k(wallPaper.settings.second_background_color, 255);
                int k12 = i0.b.k(wallPaper.settings.third_background_color, 255);
                int i10 = wallPaper.settings.fourth_background_color;
                r2 = i10 != 0 ? i0.b.k(i10, 255) : 0;
                org.telegram.ui.Components.nb0 nb0Var = new org.telegram.ui.Components.nb0();
                nb0Var.n(k10, k11, k12, r2);
                a2 = new BitmapDrawable(nb0Var.k);
            }
        }
    ...
    public static un d(Drawable drawable, TLRPC.WallPaper wallPaper, boolean z10) {
        ...
        if (drawable instanceof un) {
            ...
            boolean z11 = unVar.a;
            TLRPC.WallPaper wallPaper2 = unVar.g;
            String str = wallPaper.uploadingImage;
    ...
    public final Drawable c(boolean z10) {
        org.telegram.ui.Components.nb0 nb0Var = this.f;
        if (nb0Var != null) {
            return nb0Var;
        }
        jh.y2 y2Var = this.e;
        return (!z10 || y2Var.getStaticThumb() == null) ? y2Var.getThumb() != null ? y2Var.getThumb() : y2Var.getDrawable() != null ? y2Var.getDrawable() : y2Var.getStaticThumb() : y2Var.getStaticThumb();
    }
