...
public final class jx0 extends LinearLayout {
    ...
    public jx0(PremiumPreviewFragment premiumPreviewFragment, Context context) {
        ...
        fx0 fx0Var = new fx0(this, context, premiumPreviewFragment.h0 ? 1 : 0, i10 == 1 ? 1 : 0, context);
        this.d = fx0Var;
        ...
        gx0Var.setSelectorTransformer(new q0.a() { // from class: org.telegram.ui.dx0
            @Override // q0.a
            public final void accept(Object obj) {
                Canvas canvas = (Canvas) obj;
                gx0 gx0Var2 = jx0.this.e;
                View pressedChildView = gx0Var2.getPressedChildView();
                int b10 = pressedChildView == null ? -1 : gx0Var2.T(pressedChildView).b();
                Path path2 = path;
                path2.rewind();
    ...
    */
    public final void a() {
        ...
        if (premiumPreviewFragment.getMediaDataController().getPremiumPromo() != null) {
            ...
            while (i10 < size) {
                ...
                lx0 lx0Var = new lx0(tL_premiumSubscriptionOption2);
                ...
                if (tL_premiumSubscriptionOption2.current) {
                    premiumPreviewFragment.f = lx0Var;
                }
                if (BuildVars.useInvoiceBilling() && lx0Var.i() > j3) {
                    j3 = lx0Var.i();
                }
            }
        } else {
        ...
        if (BuildVars.useInvoiceBilling()) {
            ...
            while (i12 < size3) {
                ...
                i12++;
                lx0 lx0Var3 = (lx0) obj2;
                lx0Var3.f = BillingController.PREMIUM_PRODUCT_DETAILS;
                if (lx0Var3.i() > j10) {
                    j10 = lx0Var3.i();
                }
                lx0Var3.a();
            ...
            if (z10) {
                ...
                while (i13 < arrayList.size()) {
                    lx0 lx0Var4 = (lx0) arrayList.get(i13);
                    lx0Var4.a();
                    if (lx0Var4.g == null) {
        ...
        if (premiumPreviewFragment.e == -1) {
            ...
            while (true) {
                ...
                if (((lx0) arrayList.get(i15)).a.months == 12) {
    ...
    public final void b() {
        ...
        if (i10 == 0) {
            ...
            org.telegram.messenger.y0.m((premiumPreviewFragment.getUserConfig().isPremium() || premiumPreviewFragment.p0) ? R.string.TelegramPremiumSubscribedSubtitle : R.string.TelegramPremiumSubtitle, textView2);
        } else if (i10 == 1) {
            ...
            org.telegram.messenger.y0.m((premiumPreviewFragment.getUserConfig().isPremium() || premiumPreviewFragment.p0) ? R.string.TelegramBusinessSubscribedSubtitleTemp : R.string.TelegramBusinessSubtitleTemp, textView2);
        }
