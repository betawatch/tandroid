...
public final class qp0 extends View {
    ...
    public final void b() {
        ...
        while (true) {
            ...
            if (i11 == 2) {
                ...
                pp0Var.h = i13 < 0;
                if (i13 < 0) {
                    i10 = org.telegram.ui.ActionBar.h6.c8;
                } else {
                    int[] iArr2 = org.telegram.ui.ActionBar.h6.r8;
                    i10 = iArr2[i13 % iArr2.length];
                }
                int v02 = org.telegram.ui.ActionBar.h6.v0(i10, d6Var);
                pp0Var.g = false;
                pp0Var.f = false;
                pp0Var.a.setColor(v02);
            } else if (i12 < 7 && i11 == 1) {
                pp0 pp0Var2 = pp0VarArr[i12];
                int i14 = iArr[i12];
                pp0Var2.o = i14;
                int v03 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.r8[i14], d6Var);
                pp0Var2.g = false;
                pp0Var2.f = false;
                pp0Var2.a.setColor(v03);
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.f != null) {
            ...
            while (true) {
                ...
                Path path = pp0Var.e;
                canvas.save();
                float a2 = pp0Var.l.a(0.05f);
                RectF rectF = pp0Var.p;
                ...
                if (pp0Var.g) {
                    ...
                    canvas.drawRoundRect(rectF2, AndroidUtilities.dp(2.33f), AndroidUtilities.dp(2.33f), pp0Var.c);
                    canvas.restore();
                }
                float e = pp0Var.n.e(pp0Var.m);
                if (e > 0.0f) {
                    Paint paint = qp0Var.b;
                    Paint paint2 = qp0Var.b;
                    paint.setStrokeWidth(AndroidUtilities.dpf2(2.0f));
                    paint2.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.d6, qp0Var.a));
                ...
                if (pp0Var.h) {
                    if (qp0Var.e) {
                        ...
                        pp0Var.k.setBounds((int) org.telegram.messenger.ok.b(pp0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) org.telegram.messenger.ok.b(pp0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()), (int) a4.a.e(pp0Var.k.getIntrinsicWidth(), 2.0f, 1.2f, rectF.centerX()), (int) a4.a.e(pp0Var.k.getIntrinsicHeight(), 2.0f, 1.2f, rectF.centerY()));
                        pp0Var.k.draw(canvas);
                    } else {
                        if (pp0Var.i == null) {
                            pp0Var.i = new Path();
                        }
                        if (pp0Var.j == null) {
                            ...
                            pp0Var.j = paint3;
                            paint3.setColor(-1);
                            pp0Var.j.setStyle(Paint.Style.STROKE);
                            pp0Var.j.setStrokeCap(Paint.Cap.ROUND);
                        }
                        pp0Var.j.setStrokeWidth(AndroidUtilities.dp(2.0f));
                        pp0Var.i.rewind();
                        float lerp = AndroidUtilities.lerp(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(4.0f), e);
                        pp0Var.i.moveTo(rectF.centerX() - lerp, rectF.centerY() - lerp);
                        pp0Var.i.lineTo(rectF.centerX() + lerp, rectF.centerY() + lerp);
                        pp0Var.i.moveTo(rectF.centerX() + lerp, rectF.centerY() - lerp);
                        pp0Var.i.lineTo(rectF.centerX() - lerp, rectF.centerY() + lerp);
                        canvas.drawPath(pp0Var.i, pp0Var.j);
                    }
                }
                canvas.restore();
                i10++;
    ...
    */
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f != null) {
            ...
            while (true) {
                ...
                if (pp0VarArr[i10].q.contains(motionEvent.getX(), motionEvent.getY())) {
                    pp0Var = this.f[i10];
                    break;
                }
                i10++;
            ...
            if (motionEvent.getAction() != 0) {
                ...
                if (pp0Var3 != pp0Var) {
                    ...
                    if (this.w != null && pp0Var != null && (callback2 = this.v) != null) {
                        callback2.run(Integer.valueOf(pp0Var.o));
                    }
                    this.w = pp0Var;
                    return true;
                }
            } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                if (motionEvent.getAction() == 1 && (pp0Var2 = this.w) != null && (callback = this.v) != null) {
                    callback.run(Integer.valueOf(pp0Var2.o));
                }
                if (this.f != null) {
                    int i11 = 0;
                    while (true) {
                        pp0[] pp0VarArr2 = this.f;
                        if (i11 >= pp0VarArr2.length) {
                            break;
                        }
                        pp0VarArr2[i11].l.c(false);
                        i11++;
                    }
                }
                this.w = null;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        pp0[] pp0VarArr = this.f;
        if (pp0VarArr == null || pp0VarArr.length != size2) {
            this.f = new pp0[size2];
            int i16 = 0;
            while (i16 < size2) {
                this.f[i16] = new pp0(this);
                if (i13 == i15) {
                    pp0 pp0Var = this.f[i16];
                    int i17 = this.h[i16];
                    pp0Var.o = i17;
                    pp0Var.h = i17 < 0;
                    if (i17 < 0) {
                        i12 = org.telegram.ui.ActionBar.h6.c8;
                    } else {
        ...
        if (this.f != null) {
            ...
            for (int i18 = 0; i18 < this.f.length; i18++) {
                ...
                pp0 pp0Var2 = this.f[i18];
                boolean z10 = pp0Var2.o == this.s;
                pp0Var2.m = z10;
                pp0Var2.n.f(z10, true);
                pp0Var2.r.invalidate();
                if (i18 % i14 == i14 - 1) {
                    f14 += min + min3;
                    f13 = f12;
                } else {
