...
public final class qp0 extends st0 {
    ...
    public final cu0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        aq0 aq0Var = this.a;
        org.telegram.ui.Cells.q5 V = aq0.V(aq0Var, i10);
        if (V == null) {
            return null;
        }
        org.telegram.ui.Components.n9 imageView = V.getImageView();
        int[] iArr = new int[2];
    ...
    public final int Q(Object obj) {
        ...
        aq0 aq0Var = this.a;
        if (!aq0Var.b.containsKey(valueOf)) {
            return -1;
        }
        aq0Var.b.remove(valueOf);
        int indexOf = aq0Var.c.indexOf(valueOf);
        if (indexOf >= 0) {
            aq0Var.c.remove(indexOf);
        }
        if (aq0Var.e) {
            aq0Var.h0();
        }
    ...
    public final void W(int i10) {
        ...
        if (V != null) {
            if (albumEntry == null) {
                V.e((MediaController.SearchImage) aq0Var.f.get(i10));
                return;
            }
            org.telegram.ui.Components.n9 imageView = V.getImageView();
            imageView.q(0, true);
    ...
    public final ImageReceiver.BitmapHolder j(int i10) {
        org.telegram.ui.Cells.q5 V = aq0.V(this.a, i10);
        if (V != null) {
    ...
    public final int k(int i10, VideoEditedInfo videoEditedInfo) {
        ...
        if (albumEntry != null) {
            ...
            Y = aq0Var.Y(-1, photoEntry);
            if (Y == -1) {
                photoEntry.editedInfo = videoEditedInfo;
                Y = aq0Var.c.indexOf(Integer.valueOf(photoEntry.imageId));
                z10 = true;
            } else {
        ...
        while (true) {
            ...
            if (((Integer) childAt.getTag()).intValue() == i10) {
                ((org.telegram.ui.Cells.q5) childAt).b(aq0Var.e ? Y : -1, z10, false);
            } else {
                i11++;
            }
        }
    ...
    public final boolean x(int i10) {
        aq0 aq0Var = this.a;
        MediaController.AlbumEntry albumEntry = aq0Var.F;
        return albumEntry != null ? i10 >= 0 && i10 < albumEntry.photos.size() && aq0Var.b.containsKey(Integer.valueOf(aq0Var.F.photos.get(i10).imageId)) : i10 >= 0 && i10 < aq0Var.f.size() && aq0Var.b.containsKey(((MediaController.SearchImage) aq0Var.f.get(i10)).id);
    }
