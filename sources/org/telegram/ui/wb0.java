...
public final class wb0 extends FrameLayout {
    ...
    public wb0(xb0 xb0Var, Context context) {
        ...
        addView(r32, h7.z5.d(37, 50.0f, (LocaleController.isRTL ? 3 : 5) | 16, 19.0f, 0.0f, 19.0f, 0.0f));
    ...
    */
    public final int a(int i10) {
        ...
        return (org.telegram.ui.Components.f01.c() || (i10 & 65536) <= 0) ? bitCount : bitCount - 1;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (z10) {
            ...
            if (this.n) {
                canvas.drawLine((getMeasuredWidth() - AndroidUtilities.dp(64.0f)) + (qVar.getTranslationX() < 0.0f ? AndroidUtilities.dp(-32.0f) : 0), getMeasuredHeight() - 1, 0.0f, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.g6.k0);
                return;
            }
            return;
        }
        ...
        if (this.n) {
            canvas.drawLine(qVar.getTranslationX() + AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.g6.k0);
        }
    }
