...
public final class i80 extends ActionBarPopupWindow$ActionBarPopupWindowLayout {
    ...
    public int W;
    public final CacheByChatsController a0;
    public g80 b0;
    public ArrayList c0;
    public final org.telegram.ui.ActionBar.p2 d0;
    ...
    public i80(Context context, org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        this.U = arrayList;
        this.d0 = p2Var;
        this.a0 = p2Var.getMessagesController().getCacheByChatsController();
        setFitItems(true);
        ...
        for (int i11 = 0; i11 < this.U.size(); i11++) {
            ((h80) this.U.get(i11)).a.setOnClickListener(new lh.y0(this, ((h80) this.U.get(i11)).b, 15));
        }
    ...
    public final void f() {
        if (this.c0 != null) {
            ((org.telegram.ui.Components.d9) this.V.d).setTranslationX((3 - Math.min(3, this.c0.size())) * AndroidUtilities.dp(12.0f));
        }
    }
