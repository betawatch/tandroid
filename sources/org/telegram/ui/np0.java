...
public final /* synthetic */ class np0 implements Runnable {
    ...
    public /* synthetic */ np0(Object obj, Object obj2, boolean z10, int i9) {
        this.a = i9;
        this.c = obj;
        this.d = obj2;
        this.b = z10;
    ...
    */
    public final void run() {
        ...
        switch (i10) {
            case 0:
                zp0.T((zp0) obj2, (TLObject) obj, z11);
                return;
            case 1:
            ...
            case 3:
                ...
                if (pg0Var != null) {
                    org.telegram.ui.Components.mg0 j10 = org.telegram.ui.Components.pg0.j(7, pg0Var.a);
                    if (j10 == null || !j10.s) {
                        r42 = 0;
                    } else {
                        r42 = 0;
                    ...
                    if (zArr[r42]) {
                        org.telegram.ui.Components.pg0 pg0Var2 = profileActivity.W;
                        pg0Var2.E = true;
                        pg0Var2.o(7, r42);
                        profileActivity.W.o(9, true);
                        org.telegram.ui.Components.pg0 pg0Var3 = profileActivity.W;
                        if (pg0Var3.E) {
                            pg0Var3.E = r42;
                            pg0Var3.d();
                            return;
                    ...
                    try {
                        ...
                        try {
                            ...
                            while (i13 < arrayList.size()) {
                                File file5 = (File) arrayList.get(i13);
                                ...
                                if (file5.exists() && !file5.isDirectory()) {
                                    BufferedInputStream bufferedInputStream2 = new BufferedInputStream(new FileInputStream(file5), i12);
                                    try {
                                        zipOutputStream.putNextEntry(new ZipEntry(file5.getName()));
                                        while (true) {
                                            int read = bufferedInputStream2.read(bArr, 0, i12);
                                            if (read != -1) {
                                        ...
                                        try {
                                            ...
                                            AndroidUtilities.runOnUIThread(new ir0(c2Var, zArr2, activity, file, 4));
                                            return;
                                        } catch (Throwable th) {
                                            th = th;
                                            if (bufferedInputStream != null) {
            ...
            case 5:
                n31.O((n31) obj2, z11, (org.telegram.ui.Components.jg0) obj);
                return;
            case 6:
            ...
            case 7:
                ...
                int i14 = wallpapersListActivity.v;
                    ...
                    while (i15 < size) {
                        ...
                        if (!"fqv01SQemVIBAAAApND8LDRUhRU".equals(wallPaper.slug)) {
                            if ((wallPaper instanceof TLRPC.TL_wallPaper) && !(wallPaper.document instanceof TLRPC.TL_documentEmpty)) {
                                ...
                                if (i14 != i11 && ((!(z10 = wallPaper.pattern) || ((wallPaperSettings3 = wallPaper.settings) != null && wallPaperSettings3.background_color != 0)) && ((i14 != 2 || z10) && (org.telegram.ui.ActionBar.f6.I.q() || (wallPaperSettings2 = wallPaper.settings) == null || wallPaperSettings2.intensity >= 0)))) {
                                    arrayList3.add(wallPaper);
                                }
                            } else if (wallPaper.settings.background_color != 0 && (org.telegram.ui.ActionBar.f6.I.q() || (wallPaperSettings = wallPaper.settings) == null || wallPaperSettings.intensity >= 0)) {
                                TLRPC.WallPaperSettings wallPaperSettings4 = wallPaper.settings;
                                int i16 = wallPaperSettings4.second_background_color;
                                if (i16 == 0 || (i9 = wallPaperSettings4.third_background_color) == 0) {
                                    hashMap = hashMap2;
                                    xh1Var = new xh1(wallPaperSettings4.background_color, i16, null, wallPaperSettings4.rotation);
                                } else {
                                    xh1Var = new xh1(null, wallPaperSettings4.background_color, i16, i9, wallPaperSettings4.fourth_background_color);
                                    hashMap = hashMap2;
                                }
            ...
            case 8:
                ...
                arrayList4.clear();
                org.telegram.ui.web.j1.a().getClass();
            ...
            case 10:
                ...
                try {
                    try {
                        ...
                        for (int i20 = 0; i20 < arrayList6.size(); i20++) {
                            TL_account.TL_businessChatLink tL_businessChatLink = (TL_account.TL_businessChatLink) arrayList6.get(i20);
                            if (!tL_businessChatLink.entities.isEmpty()) {
                                for (int i21 = 0; i21 < tL_businessChatLink.entities.size(); i21++) {
                                    TLRPC.MessageEntity messageEntity = tL_businessChatLink.entities.get(i21);
                ...
                sQLiteCursor2.dispose();
                AndroidUtilities.runOnUIThread(new bg.m(uVar, arrayList6, arrayList7, arrayList8, this.b, 22));
                return;
            case 11:
                ((ph.a) obj2).O((Utilities.Callback) obj, z11, false);
                return;
            case 12:
            ...
            case 13:
                ...
                qh.f5 f5Var = (qh.f5) obj;
                boolean z12 = !z11;
                qh.h5 h5Var = f5Var.v;
                Iterator it = f5Var.D.iterator();
                while (it.hasNext()) {
                    TL_iv.pageTableCell pagetablecell = (TL_iv.pageTableCell) it.next();
                    qh.i5 m10 = h5Var.m(pagetablecell);
                    if (m10 == null) {
                        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(qh.w5.h(pagetablecell));
                        boolean z13 = spannableStringBuilder.length() > 0 && (qh.u5.q(0, spannableStringBuilder.length(), spannableStringBuilder) & 1) != 0;
                        qh.w5.l(pagetablecell, z12);
                        if (!z11 && spannableStringBuilder.length() > 0) {
                            qh.u5.o(spannableStringBuilder, 0, spannableStringBuilder.length(), 1, true, null);
                        } else if (z11 && z13) {
                            qh.u5.o(spannableStringBuilder, 0, spannableStringBuilder.length(), 1, false, null);
                        }
                        qh.w5.d(pagetablecell, spannableStringBuilder);
                    } else if (m10.b != null) {
                        SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(m10.a.getText());
                        boolean z14 = spannableStringBuilder2.length() > 0 && (qh.u5.q(0, spannableStringBuilder2.length(), spannableStringBuilder2) & 1) != 0;
                        qh.w5.l(m10.b, z12);
                        if (z11) {
                            if (z14) {
                                qh.u5.o(spannableStringBuilder2, 0, spannableStringBuilder2.length(), 1, false, null);
                            }
                        } else if (spannableStringBuilder2.length() > 0) {
                            qh.u5.o(spannableStringBuilder2, 0, spannableStringBuilder2.length(), 1, true, null);
                        }
                        qh.w5.d(m10.b, spannableStringBuilder2);
                        m10.b(m10.b);
                    }
                }
                h5Var.invalidate();
                ...
                return;
            default:
                qh.n3 n3Var = (qh.n3) obj;
                n3Var.f.o3(true);
                qh.a4.k((org.telegram.ui.ActionBar.o2) obj2, z11, new qh.x3(n3Var, 2));
                return;
        }
    }

    public /* synthetic */ np0(Object obj, boolean z10, Object obj2, int i9) {
        this.a = i9;
        this.c = obj;
        this.b = z10;
        this.d = obj2;
