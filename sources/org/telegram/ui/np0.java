...
public final class np0 extends FrameLayout {
    ...
    public final int a() {
        ...
        if (i12 >= 0) {
            if (i12 < 7) {
                return up0Var.getThemedColor(org.telegram.ui.ActionBar.h6.r8[i12]);
            }
            if (op0Var.m0 == 1) {
            ...
            return (peerColors == null || (color = peerColors.getColor(op0Var.h)) == null) ? up0Var.getThemedColor(org.telegram.ui.ActionBar.h6.r8[0]) : color.getColor1();
        }
        ...
        if (AndroidUtilities.computePerceivedBrightness(up0Var.getThemedColor(i13)) < 0.2f) {
    ...
    public final void b(boolean z10) {
        ...
        if (j3 != 0) {
            ...
            o5Var.g(null, z10);
            if (this.b == null) {
                this.b = new org.telegram.ui.Components.f01(LocaleController.getString(op0Var.p0.a ? R.string.ChannelReplyIconOff : R.string.UserReplyIconOff), 16.0f, null);
            }
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f01Var != null) {
            f01Var.c((getMeasuredWidth() - this.b.l()) - AndroidUtilities.dp(19.0f), getMeasuredHeight() / 2.0f, 1.0f, this.d.p0.getThemedColor(org.telegram.ui.ActionBar.h6.q6), canvas);
        } else {
            o5Var.draw(canvas);
        }
    }
