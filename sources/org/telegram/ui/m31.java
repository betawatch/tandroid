...
public final class m31 extends org.telegram.ui.ActionBar.h3 {
        ...
        if (context != null) {
            ...
            if (z4) {
                ...
                if (z10) {
                    ...
                    tL_reportMessage.option = bArr;
                    tL_messages_report = tL_reportMessage;
                    ConnectionsManager.getInstance(i10).sendRequestTyped(tL_messages_report, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.b31
    ...
    public static void m(Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4, boolean z10, long j10, ArrayList arrayList, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.Components.qc qcVar, TLRPC.ReportResult reportResult) {
        ...
        m31Var.s = new c31(zArr, callback, qcVar);
    ...
    public static void n(m31 m31Var, TLObject tLObject, CharSequence charSequence, TLRPC.TL_error tL_error, byte[] bArr, String str) {
        ...
        qh.d dVar;
        ek ekVar = m31Var.b;
        if ((ekVar.getCurrentView() instanceof l31) && (dVar = ((l31) ekVar.getCurrentView()).s) != null) {
        ...
        if (tLObject == null) {
            if (tL_error != null) {
                if (!m31Var.d && "MESSAGE_ID_REQUIRED".equals(tL_error.text)) {
                    ...
                    h31 h31Var3 = m31Var.s;
                    if (h31Var3 != null) {
                        h31Var3.c();
                    }
                } else if ("AD_EXPIRED".equals(tL_error.text) && (h31Var = m31Var.s) != null) {
                    h31Var.a();
                }
                m31Var.dismiss();
                return;
        ...
        if (!z4 && !(tLObject instanceof TLRPC.TL_reportResultChooseOption) && !(tLObject instanceof TLRPC.TL_reportResultAddComment)) {
            ...
            if (((tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) || (tLObject instanceof TLRPC.TL_reportResultReported)) && (h31Var2 = m31Var.s) != null) {
                h31Var2.a();
                m31Var.dismiss();
                return;
            }
        ...
        if (l31Var != null) {
            ...
            if (tLObject instanceof TLRPC.TL_reportResultChooseOption) {
                l31Var.b = null;
                l31Var.c = (TLRPC.TL_reportResultChooseOption) tLObject;
                l31Var.d = null;
                i61Var.V2.N(false);
            } else if (tLObject instanceof TLRPC.TL_reportResultAddComment) {
                l31Var.b((TLRPC.TL_reportResultAddComment) tLObject);
            } else if (z4) {
                l31Var.b = (TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject;
                l31Var.c = null;
                l31Var.d = null;
                i61Var.V2.N(false);
            }
            if (charSequence != null) {
                ...
                ((TextView) q1Var.c).setText(charSequence);
                ((TextView) q1Var.c).getText();
    ...
    public final boolean canDismissWithSwipe() {
        if (this.b.getCurrentView() instanceof l31) {
            return !((l31) r0).f.canScrollVertically(-1);
        }
        return true;
    }
    ...
    public final void onBackPressed() {
        j31 j31Var;
        ek ekVar = this.b;
        if ((ekVar.getCurrentView() instanceof l31) && (j31Var = ((l31) ekVar.getCurrentView()).n) != null) {
