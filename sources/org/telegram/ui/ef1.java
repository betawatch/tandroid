...
public final class ef1 extends org.telegram.ui.ActionBar.p2 {
    ...
    public static ef1 a0(long j3, long j10) {
        ...
        ef1Var.h = new org.telegram.ui.Components.w9[2];
        ef1Var.n = "";
        ef1Var.F = new AnimationNotificationsLocker();
        return ef1Var;
    }
    ...
    public final View createView(Context context) {
        ...
        bf1 bf1Var = new bf1(context, null);
        this.fragmentView = bf1Var;
        bf1Var.setBackgroundColor(getThemedColor(i10));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        bf1Var.addView(linearLayout);
        ...
        final int i11 = 0;
        cf1Var.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ye1
        ...
        for (int i12 = 0; i12 < 2; i12++) {
            ...
            w9VarArr[i12] = w9Var;
            cf1Var.addView(w9Var, w7.a6.e(28, 28, 17));
        }
        frameLayout.addView(cf1Var, w7.a6.d(40, 40.0f, 16, 10.0f, 0.0f, 0.0f, 0.0f));
        ...
        if (tL_forumTopic2 == null || tL_forumTopic2.id != 1) {
            ...
            frameLayout2.addView(this.f, w7.a6.d(-1, -1.0f, 0, 12.0f, 12.0f, 12.0f, 12.0f));
            ...
            vqVar.w = true;
            this.f.setForumIconDrawable(vqVar);
            this.s = vqVar;
            ...
            cf1Var.addView(imageView, w7.a6.e(22, 22, 17));
            frameLayout2.addView(new View(context), w7.a6.c(8.0f, -1));
            ...
            final int i14 = 1;
            this.d.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.ye1
                public final /* synthetic */ ef1 b;
            ...
            frameLayout3.addView(this.d, w7.a6.e(-1, 50, 119));
            frameLayout2.addView(frameLayout3, w7.a6.d(-1, 56.0f, 48, 9.0f, 8.0f, 9.0f, 0.0f));
            ...
            frameLayout2.addView(f9Var, w7.a6.d(-1, -2.0f, 48, 0.0f, 58.0f, 0.0f, 0.0f));
        }
        linearLayout.addView(frameLayout2, w7.a6.c(-1.0f, -1));
    ...
    public final boolean onFragmentCreate() {
        ...
        if (j3 != 0) {
            ...
            this.E = mg.a.k[Math.abs(Utilities.random.nextInt() % 6)];
        }
