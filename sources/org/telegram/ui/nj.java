    ...
    public final void b(int i10) {
        ...
        if (i10 == -1) {
            ...
            if (boVar.R3 == 5 && (boVar.u6.isEmpty() || boVar.d4 == 0)) {
                ...
                boVar.wb(new Runnable(this) { // from class: org.telegram.ui.kj
            ...
            if (i10 != 12) {
                ...
                if (i10 != 70) {
                    ...
                    if (i10 == 25) {
                        ...
                        boVar.yc(0, true);
                        boVar.Wc(false);
                        MediaController.saveFilesFromMessages(boVar.getParentActivity(), boVar.getAccountInstance(), arrayList2, new lj(0, this, z10));
                        return;
                    }
                    int i25 = 13;
                    if (i10 == 13) {
                    ...
                    if (i10 == 15 || i10 == 16 || i10 == 26) {
                        ...
                        if (i10 != 26 && (i10 != 15 || boVar.h != null || (((user = boVar.f) == null || UserObject.isUserSelf(user) || UserObject.isDeleted(boVar.f)) && ((chatFull = boVar.Z7) == null || !chatFull.can_delete_channel)))) {
                            ...
                            boolean z12 = z11;
                            org.telegram.ui.Components.c5.r(boVar, -1, boVar.f, boVar.e, z12, new mj(this, z12), boVar.getResourceProvider());
                            return;
                        }
                    }
                    int i26 = 17;
                    ...
                    if (i10 == 14) {
                        org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(0, this.a, boVar.getResourceProvider(), true, true);
                    ...
                    if (i10 == 68) {
                        ...
                        if (textView2 != null) {
                            textView2.setTextColor(boVar.getThemedColor(org.telegram.ui.ActionBar.i6.q7));
                            return;
                        }
                        return;
                    }
