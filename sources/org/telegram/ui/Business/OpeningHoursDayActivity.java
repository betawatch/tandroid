...
public class OpeningHoursDayActivity extends BaseFragment {
    ...
    public void onClick(UItem uItem, final View view, int i, float f, float f2) {
        ...
        if (i3 == -1) {
            ...
            int i7 = uItem.id % 3;
            if (i7 == 0) {
                AlertsCreator.createTimePickerDialog(getContext(), LocaleController.getString(R.string.BusinessHoursDayOpenHourPicker), period3.start, period2 == null ? this.min : period2.end + 1, period3.end - 1, new Utilities.Callback() { // from class: org.telegram.ui.Business.OpeningHoursDayActivity$$ExternalSyntheticLambda2
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.Business.OpeningHoursDayActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    OpeningHoursDayActivity.this.lambda$onBackPressed$355();
                }
            }
        });
