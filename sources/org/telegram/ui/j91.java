...
public final class j91 extends org.telegram.ui.Components.bb {
    ...
    public j91(final Context context, final int i10, final org.telegram.ui.ActionBar.d6 d6Var, final oc ocVar) {
        ...
        w7.z5.a(aVar);
        aVar.setOnClickListener(new d91(context, 0, d6Var));
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            spannableStringBuilder.setSpan(new h91(d6Var), length, spannableStringBuilder.length(), 33);
            ...
            org.telegram.ui.Components.oz0 oz0Var = new org.telegram.ui.Components.oz0(context, d6Var);
            ...
            a1.d dVar = new a1.d(context, new int[]{i12, i13, i14, i15, i16, i17, i17}, d6Var, oz0Var, 18);
            ...
            TextView b13 = w7.b6.b(context, 14.0f, org.telegram.ui.ActionBar.h6.y6, false, null);
            b13.setGravity(17);
            ...
            final org.telegram.ui.Components.yc0 yc0Var = new org.telegram.ui.Components.yc0(context, d6Var);
            ...
            editTextBoldCursor.addTextChangedListener(new i91(i10, editTextBoldCursor, yc0Var, iArr, textView));
            Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.e91
            ...
            dVar2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.f91
                    ...
                    try {
                        ...
                        if (TextUtils.isEmpty(text) || parseDouble >= MessagesController.getInstance(i21).tonStakeddiceStakeAmountMin / 1.0E9d) {
                            if (yh.t5.y(i21, true).f.toDouble() < parseDouble) {
                                new di.h(context, d6Var, zf.a.i((long) (parseDouble * 1.0E9d), zf.b.b), true, new g91(0));
                                return;
                            } else {
    ...
    public final org.telegram.ui.Components.ll0 v(org.telegram.ui.Components.ml0 ml0Var) {
        org.telegram.ui.Components.v51 v51Var = new org.telegram.ui.Components.v51(ml0Var, getContext(), this.currentAccount, 0, false, new c5(this, 27), this.resourcesProvider);
        this.c0 = v51Var;
        return v51Var;
    }
