...
public final class ce1 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void V(ce1 ce1Var, TLRPC.TL_theme tL_theme) {
        try {
            ce1Var.r.dismiss();
            ce1Var.r = null;
        } catch (Exception e) {
    ...
    public static /* synthetic */ void W(ce1 ce1Var, TLRPC.TL_error tL_error, TL_account.updateTheme updatetheme) {
        try {
            ce1Var.r.dismiss();
            ce1Var.r = null;
        } catch (Exception e) {
    ...
    public static /* synthetic */ void X(ce1 ce1Var, String str) {
        ...
        ce1Var.y = ConnectionsManager.getInstance(ce1Var.currentAccount).sendRequest(createtheme, new dc0(25, ce1Var, str), 2);
    }

    public static void Y(ce1 ce1Var) {
        org.telegram.ui.ActionBar.i6 i6Var = ce1Var.J;
        TLRPC.TL_theme tL_theme = ce1Var.L;
        if (ce1Var.Z(ce1Var.a.getText().toString(), true) && ce1Var.getParentActivity() != null) {
            if (ce1Var.b.length() == 0) {
            ...
            if (ce1Var.I) {
                ...
                ce1Var.r = c2Var;
                c2Var.setOnCancelListener(new ae1());
                ce1Var.r.show();
                String obj = ce1Var.b.getText().toString();
                tL_theme.title = obj;
                i6Var.a = obj;
                i6Var.F.slug = ce1Var.a.getText().toString();
            ...
            String obj2 = ce1Var.a.getText().toString();
            String obj3 = ce1Var.b.getText().toString();
            if (str2.equals(obj2) && str4.equals(obj3)) {
                ce1Var.finishFragment();
                return;
            }
            ce1Var.r = new org.telegram.ui.ActionBar.c2(ce1Var.getParentActivity(), 3, null);
            ...
            ce1Var.r.setOnCancelListener(new da(ce1Var, sendRequest, 8));
            ce1Var.r.show();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.yd1
            ...
            public final boolean onEditorAction(TextView textView, int i14, KeyEvent keyEvent) {
                ...
                switch (i11) {
                    case 0:
                        ce1 ce1Var = this.b;
                        if (i14 == 6) {
                            AndroidUtilities.hideKeyboard(ce1Var.b);
                            return true;
                        }
                        ce1Var.getClass();
                        return false;
        ...
        this.a.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: org.telegram.ui.yd1
            public final /* synthetic */ ce1 b;
        ...
        this.a.addTextChangedListener(new be1(this));
        if (z10) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (i6Var2 == i6Var && h6Var2 == h6Var && (c2Var2 = this.r) != null) {
                try {
                    c2Var2.dismiss();
                    this.r = null;
                } catch (Exception e) {
        ...
        if (i10 == NotificationCenter.themeUploadError) {
            ...
            if (i6Var3 == i6Var && h6Var3 == h6Var && (c2Var = this.r) != null) {
                try {
                    c2Var.dismiss();
                    this.r = null;
                } catch (Exception e7) {
