...
public final class ce1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void Y(ce1 ce1Var) {
        ...
        if (ce1Var.Z(ce1Var.a.getText().toString(), true) && ce1Var.getParentActivity() != null) {
            ...
            if (ce1Var.I) {
                ...
                ce1Var.r = b2Var;
                b2Var.setOnCancelListener(new ae1());
                ce1Var.r.show();
            ...
            ce1Var.r = new org.telegram.ui.ActionBar.b2(ce1Var.getParentActivity(), 3, null);
            ...
            ce1Var.r.setOnCancelListener(new ca(ce1Var, sendRequest, 8));
            ce1Var.r.show();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        f9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, i14, i15));
        this.e.setVisibility(8);
