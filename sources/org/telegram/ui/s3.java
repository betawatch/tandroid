    ...
    public final CharSequence i(int i10) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockPhoto) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                org.telegram.ui.Components.d01[] d01VarArr = (org.telegram.ui.Components.d01[]) spannable.getSpans(0, C.length(), org.telegram.ui.Components.d01.class);
                ...
                if (d01VarArr != null && d01VarArr.length > 0) {
                    for (int i11 = 0; i11 < d01VarArr.length; i11++) {
                        spannableStringBuilder2.setSpan(new r3(this, d01VarArr[i11].b, 1), spannable.getSpanStart(d01VarArr[i11]), spannable.getSpanEnd(d01VarArr[i11]), 33);
                    }
                }
