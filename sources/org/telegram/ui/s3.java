...
public final class s3 implements wt0 {
    ...
    @Override // org.telegram.ui.wt0
    public final boolean a(int i10) {
        return i10 < this.b.size() && i10 >= 0 && j4.g(this.a, get(i10));
    }
    ...
    public final File b(int i10) {
        ...
        if (i10 < this.b.size() && i10 >= 0) {
            ...
            if (z10) {
                TLRPC.Photo e9 = j4.e(webPage, ((TL_iv.pageBlockPhoto) pageBlock).photo_id);
                if (e9 != null && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(e9.sizes, AndroidUtilities.getPhotoSize())) != null) {
    ...
    public final boolean e(int i10) {
        if (i10 < this.b.size() && i10 >= 0 && !j4.g(this.a, get(i10))) {
            k4 k4Var = this.c.q0[0].c;
            TL_iv.PageBlock pageBlock = get(i10);
            k4Var.getClass();
            if (k4.I(pageBlock) == 5) {
                return true;
    ...
    public final void h(TL_iv.PageBlock pageBlock) {
        m4 m4Var = this.c;
        int childCount = m4Var.q0[0].b.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = m4Var.q0[0].b.getChildAt(i10);
            if (childAt instanceof u2) {
                u2 u2Var = (u2) childAt;
                int indexOf = u2Var.d.items.indexOf(pageBlock);
                if (indexOf != -1) {
                    u2Var.a.x(indexOf, false);
                    return;
                }
            }
        }
    ...
    public final CharSequence i(int i10) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockPhoto) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                m4 m4Var = this.c;
                m4Var.getClass();
                TL_iv.RichText w10 = m4.w(2, pageBlock);
                CharSequence C = m4.C(m4Var, this.a, null, w10, w10, pageBlock, -AndroidUtilities.dp(100.0f));
                if (!(C instanceof Spannable)) {
                    return C;
                }
                Spannable spannable = (Spannable) C;
                org.telegram.ui.Components.tz0[] tz0VarArr = (org.telegram.ui.Components.tz0[]) spannable.getSpans(0, C.length(), org.telegram.ui.Components.tz0.class);
                ...
                if (tz0VarArr != null && tz0VarArr.length > 0) {
                    for (int i11 = 0; i11 < tz0VarArr.length; i11++) {
                        spannableStringBuilder2.setSpan(new r3(this, tz0VarArr[i11].b, 1), spannable.getSpanStart(tz0VarArr[i11]), spannable.getSpanEnd(tz0VarArr[i11]), 33);
                    }
                }
