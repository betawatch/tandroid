...
public final class l2 extends View implements org.telegram.ui.Cells.j9, i3 {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (pageblockpullquote != null) {
            ...
            d70Var2.getClass();
            float f10 = 36;
            f3 q6 = m4.q(d70Var2, this, null, richText, size - AndroidUtilities.dp(f10), this.h, this.n, this.b);
            this.c = q6;
            if (q6 != null) {
                d70Var.getClass();
                int height = this.c.d.getHeight() + AndroidUtilities.dp(f9);
                f3 f3Var = this.c;
                f3Var.s = this.f;
                f3Var.v = this.h;
                i12 = height;
            ...
            d70 d70Var3 = this.a;
            d70Var3.getClass();
            f3 q9 = m4.q(d70Var3, this, null, richText2, size - AndroidUtilities.dp(f10), this.e, this.n, this.b);
            this.d = q9;
            if (q9 != null) {
                d70Var.getClass();
