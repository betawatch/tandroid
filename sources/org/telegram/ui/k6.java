...
public final class k6 extends FrameLayout {
    ...
    public k6(z6 z6Var, Context context) {
        ...
        this.n = new org.telegram.ui.Components.y5(this, 450L, erVar);
        this.r = new org.telegram.ui.Components.y5(this, 450L, erVar);
        this.s = new Paint(1);
        this.v = new Paint(1);
        this.w = new Paint(1);
        ...
        while (i10 < 3) {
            ...
            addView(this.b[i10], h7.z5.d(-2, -2.0f, 17, 0.0f, i10 == 2 ? 12.0f : -6.0f, 0.0f, 0.0f));
            i10++;
        }
    ...
    public final void d(TextView textView, boolean z10, boolean z11) {
        ...
        if (!z10) {
            final int i10 = 1;
            textView.animate().alpha(0.0f).translationY(AndroidUtilities.dp(8.0f)).setListener(new go(textView)).setInterpolator(org.telegram.ui.Components.er.h).setDuration(340L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.j6
        ...
        final int i11 = 0;
        textView.animate().alpha(1.0f).translationY(0.0f).setInterpolator(org.telegram.ui.Components.er.h).setDuration(340L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.j6
            public final /* synthetic */ k6 b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float d10 = y5Var.d(floatValue, false);
        Float f11 = this.f;
        ...
        t80Var.d(rectF);
        t80Var.setAlpha((int) (255.0f * alpha * d));
        t80Var.draw(canvas);
        int i12 = org.telegram.ui.ActionBar.g6.h7;
        int d12 = i0.b.d(0.75f, org.telegram.ui.ActionBar.g6.w0(null, i12, false), org.telegram.ui.ActionBar.g6.w0(null, i11, false));
        Paint paint2 = this.w;
        paint2.setColor(d12);
