...
public final class pr extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(pr prVar, long j3) {
        if (j3 != 0) {
            prVar.N = j3;
            prVar.r = MessagesController.getInstance(prVar.currentAccount).getChat(Long.valueOf(j3));
            prVar.u0();
        }
    }
    ...
    */
    public static void V(final pr prVar, View view, int i10) {
        ...
        i14 = 0;
        final int i15 = 1;
        boolean z15 = prVar.c.getAdapter() == prVar.a;
        if (i10 == prVar.h1) {
            boolean z16 = !prVar.v1;
            prVar.v1 = z16;
            ...
            prVar.A0(w02);
            prVar.a.m(prVar.j1);
        } else if (i10 == prVar.i1) {
            boolean z17 = !prVar.w1;
            prVar.w1 = z17;
            ...
            if (prVar.p0(i10)) {
                ...
                if (i10 == prVar.V) {
                    prVar.E.send_photos = !r15.send_photos;
                } else if (i10 == prVar.W) {
                    prVar.E.send_videos = !r14.send_videos;
                } else if (i10 == prVar.X) {
                    ...
                    prVar.E.send_audios = !r14.send_audios;
                } else if (i10 == prVar.Z) {
                    prVar.E.send_docs = !r14.send_docs;
                } else if (i10 == prVar.a0) {
                    prVar.E.send_voices = !r14.send_voices;
                } else if (i10 == prVar.b0) {
                    prVar.E.send_roundvideos = !r14.send_roundvideos;
                } else if (i10 == prVar.c0) {
                    if (prVar.E.send_plain && (m10 = prVar.d.m(prVar.T)) != null) {
                        AndroidUtilities.shakeViewSpring(m10);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        prVar.E.embed_links = !r14.embed_links;
                    }
                } else if (i10 == prVar.d0) {
                    prVar.E.send_polls = !r14.send_polls;
                } else if (i10 == prVar.k0) {
                    prVar.E.send_reactions = !r14.send_reactions;
                }
                ...
                if (i10 == prVar.z0) {
                    if (i13 == 0 || i13 == 3) {
                        ...
                        prVar2.x0(prVar.s);
                        TLRPC.TL_chatBannedRights tL_chatBannedRights3 = prVar.E;
                        if (tL_chatBannedRights3 != null) {
                            prVar2.E = tL_chatBannedRights3;
                        }
                        prVar2.m1 = new dr(prVar);
                        prVar.presentFragment(prVar2);
                        return;
                    }
                    if (i13 == 1) {
                        Bundle bundle2 = new Bundle();
                        bundle2.putLong("chat_id", prVar.N);
                        bundle2.putInt(TeXSymbolParser.TYPE_ATTR, 2);
                        bundle2.putInt("selectType", 1);
                        pr prVar3 = new pr(bundle2);
                        prVar3.m1 = new er(prVar);
                        prVar3.x0(prVar.s);
                    ...
                    if (i13 == 2) {
                        ...
                        i16.putLong(z14 ? "channelId" : "chatId", prVar.r.id);
                        ...
                        z60Var.J = iVar;
                        z60Var.x = new gr(prVar, z60Var);
                        prVar.presentFragment(z60Var);
                        return;
                    }
                    return;
                }
                if (i10 == prVar.v0) {
                    prVar.presentFragment(new ub(prVar.r));
                    return;
                }
                if (i10 == prVar.x0) {
                    ...
                    prVar.w0 = true;
                    final boolean z21 = prVar.s.antispam;
                    TLRPC.TL_channels_toggleAntiSpam tL_channels_toggleAntiSpam = new TLRPC.TL_channels_toggleAntiSpam();
                    tL_channels_toggleAntiSpam.channel = prVar.getMessagesController().getInputChannel(prVar.N);
                    ...
                    prVar.getConnectionsManager().sendRequest(tL_channels_toggleAntiSpam, new RequestDelegate(prVar) { // from class: org.telegram.ui.oq
                ...
                if (i10 == prVar.J0) {
                    ...
                    prVar.I0 = true;
                    final boolean z23 = prVar.s.participants_hidden;
                    ...
                    tL_channels_toggleParticipantsHidden.channel = prVar.getMessagesController().getInputChannel(prVar.N);
                    ...
                    prVar.getConnectionsManager().sendRequest(tL_channels_toggleParticipantsHidden, new RequestDelegate(prVar) { // from class: org.telegram.ui.oq
                        public final /* synthetic */ pr b;
                ...
                if (i10 == prVar.L0) {
                    ...
                    prVar.getConnectionsManager().sendRequestTyped(tL_messages_editChatDefaultBannedRights, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.pq
                    ...
                    if (i10 == prVar.B0) {
                        ...
                        bundle3.putLong("chat_id", prVar.N);
                    ...
                    if (i10 == prVar.t0) {
                        ...
                        if (i10 == prVar.A0) {
                            if (prVar.s != null) {
                                sh0 sh0Var = new sh0(prVar.N, 0L, 0);
                                TLRPC.ChatFull chatFull6 = prVar.s;
                                sh0Var.g0(chatFull6, chatFull6.exported_invite);
                                prVar.presentFragment(sh0Var);
                                return;
                            }
                            return;
                        }
                        if ((i10 > prVar.S && i10 <= Math.max(prVar.l0, prVar.g0)) || i10 == prVar.m0) {
                            ...
                            if (isEnabled) {
                                ...
                                if (i10 == prVar.g0) {
                                    prVar.E.change_info = !r0.change_info;
                                    return;
                                }
                                if (i10 == prVar.m0) {
                                    prVar.E.manage_linked_peers = !r0.manage_linked_peers;
                                    return;
                                }
                                if (i10 == prVar.h0) {
                                    prVar.E.invite_users = !r0.invite_users;
                                    return;
                                }
                                if (i10 == prVar.l0) {
                                    prVar.E.manage_topics = !r0.manage_topics;
                                    return;
                                }
                                if (i10 == prVar.i0) {
                                    prVar.E.pin_messages = !r0.pin_messages;
                                    return;
                                }
                                if (i10 == prVar.j0) {
                                    prVar.E.edit_rank = !r0.edit_rank;
                                    return;
                                }
                                if (i10 == prVar.T) {
                                    prVar.E.send_plain = !r1.send_plain;
                                    int i17 = prVar.c0;
                                    if (i17 >= 0) {
                                        prVar.a.m(i17);
                                    }
                                ...
                                if (i10 == prVar.e0) {
                                    TLRPC.TL_chatBannedRights tL_chatBannedRights5 = prVar.E;
                                ...
                                if (i10 == prVar.f0) {
                                    prVar.E.embed_links = !r0.embed_links;
                                    return;
                                } else {
                                    if (i10 == prVar.d0) {
                                        prVar.E.send_polls = !r0.send_polls;
                                        return;
                                    }
                                    return;
                                }
                ...
                if (z15) {
                    ...
                    if (E instanceof TLRPC.User) {
                        ...
                        while (true) {
                            ...
                            tLObject2 = (TLObject) (i19 == 0 ? iVar2 : i19 == 1 ? prVar.L : iVar).f(j12);
                            if (tLObject2 != null) {
                                break;
                            } else {
                                i19++;
                    ...
                    if (E2 instanceof TLRPC.User) {
                        ...
                        if (i12 != 0) {
                            ...
                            if (i12 != 3 && i12 != 1) {
                                if (ChatObject.isChannel(prVar.r)) {
                                    prVar.getMessagesController().deleteParticipantFromChat(prVar.N, prVar.getMessagesController().getUser(Long.valueOf(j10)));
                                    ir irVar = prVar.m1;
                                    if (irVar != null) {
                                        irVar.d(j10);
                                    }
                            ...
                            if (i12 == 1) {
                                ...
                                if (!z11) {
                                    ...
                                    z13 = z11;
                                    i20 = 1;
                                    prVar.t0(j11, tLObject, tL_chatAdminRights, tL_chatBannedRights, str2, z13, i12 != i20 ? 0 : 1, i12 != i20 || i12 == 3);
                                    return;
                                }
                                if ((tLObject instanceof TLRPC.TL_channelParticipantAdmin) || (tLObject instanceof TLRPC.TL_chatParticipantAdmin)) {
                                    TLRPC.User user2 = prVar.getMessagesController().getUser(Long.valueOf(j10));
                                    ...
                                    a2Var2.R = string;
                                    a2Var2.T = LocaleController.formatString("AdminWillBeRemoved", R.string.AdminWillBeRemoved, UserObject.getUserName(user2));
                                    alertDialog$Builder.k(LocaleController.getString("OK", R.string.OK), new qq(prVar, user2, tLObject, tL_chatAdminRights, tL_chatBannedRights, str, z11));
                                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                                    prVar.showDialog(a2Var2);
                                    return;
                                }
                                j11 = j10;
                                str2 = str;
                        ...
                        boolean z27 = z11;
                        if (i13 == 1) {
                            canBlockUsers = j14 != prVar.getUserConfig().getClientUserId() && (prVar.r.creator || z27);
                        } else {
                            if (i13 != 0 && i13 != 3) {
                                z12 = false;
                                if (i13 != 0 || ((i13 != 1 && z10) || (i13 == 2 && i12 == 0))) {
                                    if (j14 != prVar.getUserConfig().getClientUserId()) {
                                        return;
                                    }
                                ...
                                kq kqVar = new kq(j14, prVar.N, tL_chatAdminRights, prVar.E, tL_chatBannedRights, str, i13 == i11 ? 0 : 1, z12, tLObject == null, null);
                                kqVar.X0 = new vq(prVar, tLObject);
    ...
    public static void W(pr prVar, TLRPC.ChannelParticipant channelParticipant, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights) {
        int i10 = 0;
        while (i10 < 3) {
            TLObject tLObject = (TLObject) (i10 == 0 ? prVar.M : i10 == 1 ? prVar.L : prVar.K).f(MessageObject.getPeerId(channelParticipant.peer));
    ...
    */
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 32, new Class[]{org.telegram.ui.Cells.b7.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.c, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.V6));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        if (i13 != 2) {
            ...
            if (i13 == 3 && ChatObject.canBlockUsers(this.r)) {
                ...
                final int i14 = 0;
                H.c(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), new Runnable(prVar) { // from class: org.telegram.ui.mq
                    public final /* synthetic */ pr b;
                    ...
                    public final void run() {
                        switch (i14) {
                            ...
                            case 1:
                                ...
                                long j13 = j12;
                                prVar2.i0(j13);
                                prVar2.getMessagesController().addUserToChat(prVar2.N, prVar2.getMessagesController().getUser(Long.valueOf(j13)), 0, null, prVar2, null);
                                break;
                            case 2:
                                this.b.i0(j12);
                                break;
                            default:
                                ...
                                long j15 = j12;
                                messagesController.setUserAdminRole(j14, messagesController2.getUser(Long.valueOf(j15)), new TLRPC.TL_chatAdminRights(), "", !prVar3.v, prVar3, false, false, null, null);
                                prVar3.v0(j15);
                                break;
                        }
                    }
                ...
                if (i13 == 0 && ChatObject.canBlockUsers(prVar.r)) {
                    if (ChatObject.canAddUsers(prVar.r) && j3 > 0 && !ChatObject.isCommunity(prVar.r)) {
                        final int i15 = 1;
                        H.c(R.drawable.msg_contact_add, LocaleController.getString(z15 ? R.string.ChannelAddToChannel : R.string.ChannelAddToGroup), new Runnable(prVar) { // from class: org.telegram.ui.mq
                            public final /* synthetic */ pr b;
                ...
                } else if (i13 == 1 && ChatObject.canAddAdmins(prVar.r) && z11) {
                    if (prVar.r.creator || !(tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                        j10 = j12;
                        H.c(R.drawable.msg_admins, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), new org.telegram.messenger.voip.f(prVar, j10, (TLObject) tL_chatAdminRights2, str3, tLObject, 2), false);
                    } else {
                        j10 = j12;
                    }
                    final int i17 = 3;
                    H.c(R.drawable.msg_remove, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), new Runnable(prVar) { // from class: org.telegram.ui.mq
                        public final /* synthetic */ pr b;
    ...
    public final void r0() {
        ...
        if (ChatObject.isChannel(this.r)) {
            ...
            for (int i14 = 0; i14 < s02.size(); i14++) {
                arrayList6.add(null);
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest((TLObject) s02.get(i14), new ai.ya(arrayList6, i14, atomicInteger, s02, sqVar)), this.classGuid);
            }
            return;
        }
        this.Q = false;
    ...
    public final void t0(long j3, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z10, int i10, boolean z11) {
        kq kqVar = new kq(j3, this.N, tL_chatAdminRights, this.E, tL_chatBannedRights, str, i10, z10, tLObject == null, null);
    ...
    */
    public final void u0() {
        ...
        if (i10 == 3) {
            ...
            if (chat.creator && !ChatObject.isChannel(chat) && ((this.p1 != this.q1 || this.y1) && this.s != null)) {
                MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.N, this, new nq(this, 0));
                return;
            }
    ...
    public final jr w0() {
        ...
        jrVar.j = this.Y0;
        jrVar.l.clear();
        jrVar.l.addAll(this.G);
        jrVar.h = this.V0;
        jrVar.g = this.U0;
        jrVar.m.clear();
        jrVar.m.addAll(this.H);
        jrVar.e = this.E0;
        jrVar.f = this.F0;
        jrVar.k.clear();
        jrVar.k.addAll(this.F);
        jrVar.f(jrVar.c);
        return jrVar;
    }
