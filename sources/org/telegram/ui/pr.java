...
public final class pr extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void U(pr prVar, long j10) {
        if (j10 != 0) {
            prVar.K = j10;
            prVar.r = MessagesController.getInstance(prVar.currentAccount).getChat(Long.valueOf(j10));
            prVar.u0();
        }
    }
    ...
    */
    public static void V(final pr prVar, View view, int i10) {
        ...
        i14 = 0;
        final int i15 = 1;
        boolean z14 = prVar.c.getAdapter() == prVar.a;
        if (i10 == prVar.e1) {
            boolean z15 = !prVar.s1;
            prVar.s1 = z15;
            ...
            prVar.A0(w02);
            prVar.a.m(prVar.g1);
        } else if (i10 == prVar.f1) {
            boolean z16 = !prVar.t1;
            prVar.t1 = z16;
            ...
            prVar.A0(w03);
            prVar.a.m(prVar.g1);
        } else if (i10 == prVar.k0) {
            boolean z17 = !prVar.v1;
            prVar.v1 = z17;
            ...
            if (prVar.p0(i10)) {
                ...
                if (i10 == prVar.S) {
                    prVar.B.send_photos = !r15.send_photos;
                } else if (i10 == prVar.T) {
                    prVar.B.send_videos = !r14.send_videos;
                } else if (i10 == prVar.U) {
                    ...
                    prVar.B.send_audios = !r14.send_audios;
                } else if (i10 == prVar.W) {
                    prVar.B.send_docs = !r14.send_docs;
                } else if (i10 == prVar.X) {
                    prVar.B.send_voices = !r14.send_voices;
                } else if (i10 == prVar.Y) {
                    prVar.B.send_roundvideos = !r14.send_roundvideos;
                } else if (i10 == prVar.Z) {
                    if (prVar.B.send_plain && (m9 = prVar.d.m(prVar.Q)) != null) {
                        AndroidUtilities.shakeViewSpring(m9);
                        BotWebViewVibrationEffect.APP_ERROR.vibrate();
                        return;
                    } else {
                        prVar.B.embed_links = !r14.embed_links;
                    }
                } else if (i10 == prVar.a0) {
                    prVar.B.send_polls = !r14.send_polls;
                } else if (i10 == prVar.h0) {
                    prVar.B.send_reactions = !r14.send_reactions;
                }
                ...
                if (i10 == prVar.w0) {
                    if (i13 == 0 || i13 == 3) {
                        ...
                        pr prVar2 = new pr(bundle);
                        prVar2.x0(prVar.s);
                        TLRPC.TL_chatBannedRights tL_chatBannedRights3 = prVar.B;
                        if (tL_chatBannedRights3 != null) {
                            prVar2.B = tL_chatBannedRights3;
                        }
                        prVar2.j1 = new dr(prVar);
                        prVar.presentFragment(prVar2);
                        return;
                    }
                    if (i13 == 1) {
                        Bundle bundle2 = new Bundle();
                        bundle2.putLong("chat_id", prVar.K);
                        bundle2.putInt(TeXSymbolParser.TYPE_ATTR, 2);
                        bundle2.putInt("selectType", 1);
                        pr prVar3 = new pr(bundle2);
                        prVar3.j1 = new er(prVar);
                        prVar3.x0(prVar.s);
                        prVar.presentFragment(prVar3);
                        return;
                    }
                    if (i13 == 2) {
                        Bundle i16 = android.support.v4.media.a.i("addToGroup", true);
                        i16.putLong(z13 ? "channelId" : "chatId", prVar.r.id);
                        y60 y60Var = new y60(i16);
                        y60Var.F = prVar.s;
                        if (hVar2 != null && hVar2.m() != 0) {
                            hVar = hVar2;
                        }
                        y60Var.G = hVar;
                        y60Var.x = new gr(prVar, y60Var);
                        prVar.presentFragment(y60Var);
                        return;
                    }
                    return;
                }
                if (i10 == prVar.s0) {
                    prVar.presentFragment(new sb(prVar.r));
                    return;
                }
                if (i10 == prVar.u0) {
                    ...
                    if (chatFull3 != null && !chatFull3.antispam && prVar.l0() < prVar.getMessagesController().telegramAntispamGroupSizeMin) {
                        org.telegram.ui.Components.qc.a0(prVar).Q(R.raw.msg_antispam, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelAntiSpamForbidden", prVar.getMessagesController().telegramAntispamGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (prVar.s == null || !ChatObject.canUserDoAdminAction(prVar.r, 13) || prVar.t0) {
                        return;
                    }
                    prVar.t0 = true;
                    final boolean z20 = prVar.s.antispam;
                    TLRPC.TL_channels_toggleAntiSpam tL_channels_toggleAntiSpam = new TLRPC.TL_channels_toggleAntiSpam();
                    tL_channels_toggleAntiSpam.channel = prVar.getMessagesController().getInputChannel(prVar.K);
                    ...
                    prVar.getConnectionsManager().sendRequest(tL_channels_toggleAntiSpam, new RequestDelegate(prVar) { // from class: org.telegram.ui.nq
                        ...
                        public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                            switch (i14) {
                                case 0:
                                    final pr prVar4 = this.b;
                                    if (tLObject3 != null) {
                                        prVar4.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        prVar4.getMessagesController().putChatFull(prVar4.s);
                                    }
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.qq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        pr prVar5 = prVar4;
                                                        if (prVar5.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = prVar5.s;
                                                            boolean z23 = z22;
                                                            chatFull7.antispam = z23;
                                                            org.telegram.ui.Cells.o8 o8Var3 = o8Var2;
                                                            o8Var3.setChecked(z23);
                                                            o8Var3.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(prVar5.r, 13) || ((chatFull5 = prVar5.s) != null && chatFull5.antispam && prVar5.l0() < prVar5.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(prVar5).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                                                        pr prVar6 = prVar4;
                                                        if (prVar6.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull8 = prVar6.s;
                                                            boolean z24 = z22;
                                                            chatFull8.participants_hidden = z24;
                                                            org.telegram.ui.Cells.o8 o8Var4 = o8Var2;
                                                            o8Var4.setChecked(z24);
                                                            o8Var4.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(prVar6.r, 2) || ((chatFull6 = prVar6.s) != null && chatFull6.participants_hidden && prVar6.l0() < prVar6.getMessagesController().hiddenMembersGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(prVar6).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                }
                                    ...
                                    break;
                                default:
                                    final pr prVar5 = this.b;
                                    if (tLObject3 != null) {
                                        prVar5.getMessagesController().processUpdates((TLRPC.Updates) tLObject3, false);
                                        prVar5.getMessagesController().putChatFull(prVar5.s);
                                    }
                                    if (tL_error != null && !"CHAT_NOT_MODIFIED".equals(tL_error.text)) {
                                        final int i18 = 1;
                                        ...
                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.qq
                                            ...
                                            public final void run() {
                                                ...
                                                switch (i18) {
                                                    case 0:
                                                        pr prVar52 = prVar5;
                                                        if (prVar52.getParentActivity() != null) {
                                                            TLRPC.ChatFull chatFull7 = prVar52.s;
                                                            boolean z232 = z23;
                                                            chatFull7.antispam = z232;
                                                            org.telegram.ui.Cells.o8 o8Var32 = o8Var3;
                                                            o8Var32.setChecked(z232);
                                                            o8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(prVar52.r, 13) || ((chatFull5 = prVar52.s) != null && chatFull5.antispam && prVar52.l0() < prVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(prVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                                                    default:
                ...
                if (i10 == prVar.G0) {
                    ...
                    if (prVar.l0() < prVar.getMessagesController().hiddenMembersGroupSizeMin) {
                        org.telegram.ui.Components.qc.a0(prVar).Q(R.raw.contacts_sync_off, 36, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ChannelHiddenMembersForbidden", prVar.getMessagesController().hiddenMembersGroupSizeMin, new Object[0]))).j();
                        return;
                    }
                    if (prVar.s == null || !ChatObject.canUserDoAdminAction(prVar.r, 2) || prVar.F0) {
                        return;
                    }
                    prVar.F0 = true;
                    final boolean z22 = prVar.s.participants_hidden;
                    ...
                    tL_channels_toggleParticipantsHidden.channel = prVar.getMessagesController().getInputChannel(prVar.K);
                    ...
                    if (!ChatObject.canUserDoAdminAction(prVar.r, 2) || ((chatFull = prVar.s) != null && !chatFull.participants_hidden && prVar.l0() < prVar.getMessagesController().hiddenMembersGroupSizeMin)) {
                        i14 = R.drawable.permission_locked;
                    }
                    checkBox.setIcon(i14);
                    prVar.getConnectionsManager().sendRequest(tL_channels_toggleParticipantsHidden, new RequestDelegate(prVar) { // from class: org.telegram.ui.nq
                        public final /* synthetic */ pr b;
                                                ...
                                                switch (i17) {
                                                    case 0:
                                                        ...
                                                        if (prVar52.getParentActivity() != null) {
                                                            ...
                                                            o8Var32.setChecked(z232);
                                                            o8Var32.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(prVar52.r, 13) || ((chatFull52 = prVar52.s) != null && chatFull52.antispam && prVar52.l0() < prVar52.getMessagesController().telegramAntispamGroupSizeMin)) ? R.drawable.permission_locked : 0);
                                                            org.telegram.ui.Components.qc.a0(prVar52).Q(R.raw.error, 36, LocaleController.getString("UnknownError", R.string.UnknownError)).j();
                                                            break;
                                                        }
                                                        break;
                ...
                if (i10 == prVar.I0) {
                    ...
                    tL_messages_editChatDefaultBannedRights.peer = MessagesController.getInputPeer(prVar.r);
                    TLRPC.Chat chat = prVar.r;
                    if (chat.default_banned_rights == null) {
                        chat.default_banned_rights = new TLRPC.TL_chatBannedRights();
                    }
                    TLRPC.TL_chatBannedRights tL_chatBannedRights4 = prVar.r.default_banned_rights;
                    tL_messages_editChatDefaultBannedRights.banned_rights = tL_chatBannedRights4;
                    tL_chatBannedRights4.edit_rank = !o8Var3.b();
                    prVar.getConnectionsManager().sendRequestTyped(tL_messages_editChatDefaultBannedRights, new org.telegram.messenger.a(), new Utilities.Callback2() { // from class: org.telegram.ui.oq
                        ...
                        public final void run(Object obj, Object obj2) {
                            ...
                            pr prVar4 = pr.this;
                            if (updates != null) {
                                prVar4.getMessagesController().processUpdates(updates, false);
                                return;
                            }
                            prVar4.getClass();
                            if (tL_error != null) {
                                o8Var3.setChecked(b10);
                                org.telegram.ui.Components.qc.a0(prVar4).d0(tL_error, false);
                            }
                        }
                    });
                } else {
                    if (i10 == prVar.y0) {
                        ...
                        bundle3.putLong("chat_id", prVar.K);
                        bundle3.putInt(TeXSymbolParser.TYPE_ATTR, 0);
                        pr prVar4 = new pr(bundle3);
                        prVar4.x0(prVar.s);
                        prVar.presentFragment(prVar4);
                        return;
                    }
                    if (i10 == prVar.q0) {
                        prVar.showDialog(new hr(prVar, prVar.getParentActivity(), prVar));
                    } else {
                        if (i10 == prVar.x0) {
                            if (prVar.s != null) {
                                ph0 ph0Var = new ph0(prVar.K, 0L, 0);
                                TLRPC.ChatFull chatFull6 = prVar.s;
                                ph0Var.g0(chatFull6, chatFull6.exported_invite);
                                prVar.presentFragment(ph0Var);
                                return;
                            }
                            return;
                        }
                        if ((i10 > prVar.P && i10 <= Math.max(prVar.i0, prVar.d0)) || i10 == prVar.j0) {
                            org.telegram.ui.Cells.r8 r8Var2 = (org.telegram.ui.Cells.r8) view;
                            boolean isEnabled = r8Var2.isEnabled();
                            Switch r42 = r8Var2.d;
                            if (isEnabled) {
                                if (r42.C != null) {
                                    if (ChatObject.isPublic(prVar.r) && (i10 == prVar.f0 || i10 == prVar.d0)) {
                                        org.telegram.messenger.y3.s(R.string.EditCantEditPermissionsPublic, org.telegram.ui.Components.qc.a0(prVar), null);
                                        return;
                                    } else if (ChatObject.isDiscussionGroup(prVar.currentAccount, prVar.K) && (i10 == prVar.f0 || i10 == prVar.d0)) {
                                        org.telegram.messenger.y3.s(R.string.EditCantEditPermissionsDiscussion, org.telegram.ui.Components.qc.a0(prVar), null);
                                        return;
                                    } else {
                                        org.telegram.ui.Components.qc.a0(prVar).t(LocaleController.getString("EditCantEditPermissions", R.string.EditCantEditPermissions), null).j();
                                        return;
                                    }
                                }
                                if (i10 == prVar.R) {
                                ...
                                if (i10 == prVar.d0) {
                                    prVar.B.change_info = !r0.change_info;
                                    return;
                                }
                                if (i10 == prVar.j0) {
                                    prVar.B.manage_linked_peers = !r0.manage_linked_peers;
                                    return;
                                }
                                if (i10 == prVar.e0) {
                                    prVar.B.invite_users = !r0.invite_users;
                                    return;
                                }
                                if (i10 == prVar.i0) {
                                    prVar.B.manage_topics = !r0.manage_topics;
                                    return;
                                }
                                if (i10 == prVar.f0) {
                                    prVar.B.pin_messages = !r0.pin_messages;
                                    return;
                                }
                                if (i10 == prVar.g0) {
                                    prVar.B.edit_rank = !r0.edit_rank;
                                    return;
                                }
                                if (i10 == prVar.Q) {
                                    prVar.B.send_plain = !r1.send_plain;
                                    int i17 = prVar.Z;
                                    if (i17 >= 0) {
                                        prVar.a.m(i17);
                                    }
                                ...
                                if (i10 == prVar.b0) {
                                    TLRPC.TL_chatBannedRights tL_chatBannedRights5 = prVar.B;
                                ...
                                if (i10 == prVar.c0) {
                                    prVar.B.embed_links = !r0.embed_links;
                                    return;
                                } else {
                                    if (i10 == prVar.a0) {
                                        prVar.B.send_polls = !r0.send_polls;
                                        return;
                                    }
                                    return;
                                }
                ...
                if (z14) {
                    TLObject E = prVar.e.E(i10);
                    if (E instanceof TLRPC.User) {
                        TLRPC.User user = (TLRPC.User) E;
                        prVar.getMessagesController().putUser(user, false);
                        long j13 = user.id;
                        int i19 = 0;
                        while (true) {
                            if (i19 >= 3) {
                            ...
                            tLObject2 = (TLObject) (i19 == 0 ? hVar2 : i19 == 1 ? prVar.I : hVar).f(j13);
                            if (tLObject2 != null) {
                                break;
                            } else {
                                i19++;
                    ...
                    if (E2 instanceof TLRPC.User) {
                        ...
                        if (i12 != 0) {
                            ...
                            if (i12 != 3 && i12 != 1) {
                                if (ChatObject.isChannel(prVar.r)) {
                                    prVar.getMessagesController().deleteParticipantFromChat(prVar.K, prVar.getMessagesController().getUser(Long.valueOf(j11)));
                                    ir irVar = prVar.j1;
                                    if (irVar != null) {
                                        irVar.d(j11);
                                    }
                            ...
                            if (i12 == 1) {
                                ...
                                if (!z10) {
                                    ...
                                    z12 = z10;
                                    i20 = 1;
                                    prVar.t0(j12, tLObject, tL_chatAdminRights, tL_chatBannedRights, str2, z12, i12 != i20 ? 0 : 1, i12 != i20 || i12 == 3);
                                    return;
                                }
                                if ((tLObject instanceof TLRPC.TL_channelParticipantAdmin) || (tLObject instanceof TLRPC.TL_chatParticipantAdmin)) {
                                    TLRPC.User user2 = prVar.getMessagesController().getUser(Long.valueOf(j11));
                                    ...
                                    alertDialog$Builder.k(LocaleController.getString("OK", R.string.OK), new pq(prVar, user2, tLObject, tL_chatAdminRights, tL_chatBannedRights, str, z10));
                                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                                    prVar.showDialog(d2Var);
                                    return;
                                }
                                j12 = j11;
                                str2 = str;
                        ...
                        boolean z26 = z10;
                        if (i13 == 1) {
                            canBlockUsers = j15 != prVar.getUserConfig().getClientUserId() && (prVar.r.creator || z26);
                        } else {
                            if (i13 != 0 && i13 != 3) {
                                z11 = false;
                                if (i13 != 0 || ((i13 != 1 && z4) || (i13 == 2 && i12 == 0))) {
                                    if (j15 != prVar.getUserConfig().getClientUserId()) {
                                        return;
                                    }
                                    ...
                                    prVar.presentFragment(new ProfileActivity(bundle4, null));
                                    return;
                                }
                                ...
                                jq jqVar = new jq(j15, prVar.K, tL_chatAdminRights, prVar.B, tL_chatBannedRights, str, i13 == i11 ? 0 : 1, z11, tLObject == null, null);
                                jqVar.U0 = new uq(prVar, tLObject);
                                prVar.presentFragment(jqVar);
                                return;
                            }
                            canBlockUsers = ChatObject.canBlockUsers(prVar.r);
                        }
                        z11 = canBlockUsers;
                        if (i13 != 0) {
                        }
    ...
    public static void W(pr prVar, TLRPC.ChannelParticipant channelParticipant, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights) {
        int i10 = 0;
        while (i10 < 3) {
            TLObject tLObject = (TLObject) (i10 == 0 ? prVar.J : i10 == 1 ? prVar.I : prVar.H).f(MessageObject.getPeerId(channelParticipant.peer));
    ...
    public static void c0(pr prVar, TLRPC.User user) {
        ...
        UndoView undoView = prVar.n;
        long j10 = -prVar.K;
        boolean z11 = prVar.v;
        undoView.m(j10, user, z11 ? 9 : 10);
        prVar.r.creator = false;
        int i10 = 0;
        boolean z12 = false;
        while (i10 < 3) {
            boolean z13 = true;
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        org.telegram.ui.Components.t00 t00Var2 = this.z1;
        t00Var2.w = false;
        t00Var2.setUseHeaderOffset(false);
        org.telegram.ui.Components.t00 t00Var3 = this.z1;
        ...
        this.c.setOnItemClickListener(new mq(this, 3));
        this.c.setOnItemLongClickListener(new mq(this, 4));
        if (this.f != null) {
    ...
    */
    public final boolean g0(boolean z4) {
        if (!this.M) {
            ...
            if (z4) {
                ...
                alertDialog$Builder.k(LocaleController.getString("ApplyTheme", R.string.ApplyTheme), new mq(this, 1));
                alertDialog$Builder.h(LocaleController.getString("PassportDiscard", R.string.PassportDiscard), new mq(this, 2));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 16, new Class[]{org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.b5.class, org.telegram.ui.Cells.y4.class, org.telegram.ui.Cells.r8.class, org.telegram.ui.Cells.aa.class, org.telegram.ui.Components.uv0.class}, null, null, null, org.telegram.ui.ActionBar.j6.d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 32, new Class[]{org.telegram.ui.Cells.a9.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 32, new Class[]{org.telegram.ui.Cells.z6.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusColor"}, null, null, -1, fVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.c, 0, new Class[]{org.telegram.ui.Cells.b5.class}, new String[]{"statusOnlineColor"}, null, null, -1, fVar, org.telegram.ui.ActionBar.j6.n6));
    ...
    public final boolean h0(TLObject tLObject, boolean z4, View view) {
        ...
        if (i13 != 2) {
            ...
            if (i13 == 3 && ChatObject.canBlockUsers(this.r)) {
                prVar = this;
                H.c(R.drawable.msg_permissions, LocaleController.getString(R.string.ChannelEditPermissions), new kh.g1(prVar, j13, tL_chatBannedRights, str, tLObject, 9), false);
                final int i14 = 0;
                H.c(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), new Runnable(prVar) { // from class: org.telegram.ui.lq
                    public final /* synthetic */ pr b;
                    ...
                    public final void run() {
                        switch (i14) {
                            ...
                            case 1:
                                ...
                                long j14 = j13;
                                prVar2.i0(j14);
                                prVar2.getMessagesController().addUserToChat(prVar2.K, prVar2.getMessagesController().getUser(Long.valueOf(j14)), 0, null, prVar2, null);
                                break;
                            case 2:
                                this.b.i0(j13);
                                break;
                ...
                String str3 = str;
                prVar = this;
                if (i13 == 0 && ChatObject.canBlockUsers(prVar.r)) {
                    if (ChatObject.canAddUsers(prVar.r) && j10 > 0 && !ChatObject.isCommunity(prVar.r)) {
                        final int i15 = 1;
                        H.c(R.drawable.msg_contact_add, LocaleController.getString(z14 ? R.string.ChannelAddToChannel : R.string.ChannelAddToGroup), new Runnable(prVar) { // from class: org.telegram.ui.lq
                            public final /* synthetic */ pr b;
                ...
                } else if (i13 == 1 && ChatObject.canAddAdmins(prVar.r) && z10) {
                    if (prVar.r.creator || !(tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                        j11 = j13;
                        H.c(R.drawable.msg_admins, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), new kh.g1(prVar, j11, tL_chatAdminRights2, str3, tLObject, 10), false);
                    } else {
                        j11 = j13;
                    }
                    final int i17 = 3;
                    H.c(R.drawable.msg_remove, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), new Runnable(prVar) { // from class: org.telegram.ui.lq
                        public final /* synthetic */ pr b;
        ...
        boolean z21 = z19;
        tq tqVar = new tq(this, j12, i11, tLObject, tL_chatAdminRights, tL_chatBannedRights2, str, z12);
        long j14 = j12;
        org.telegram.ui.Components.o70 H2 = org.telegram.ui.Components.o70.H(this, view);
        H2.W(this.c.V0(view, false));
        H2.l(R.drawable.msg_admins, LocaleController.getString(z18 ? R.string.EditAdminRights : R.string.SetAsAdmin), new zi(tqVar, 11), z11);
        H2.l(R.drawable.msg_permissions, LocaleController.getString("ChangePermissions", R.string.ChangePermissions), new ih((Object) this, (Object) tLObject, (Object) user, (Object) tqVar, 4), z21);
    ...
    public final void r0() {
        ...
        if (ChatObject.isChannel(this.r)) {
            ...
            for (int i14 = 0; i14 < s02.size(); i14++) {
                arrayList6.add(null);
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest((TLObject) s02.get(i14), new lf.i0(arrayList6, i14, atomicInteger, s02, rqVar, 6)), this.classGuid);
            }
            return;
        }
        this.N = false;
    ...
    public final void t0(long j10, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z4, int i10, boolean z10) {
        jq jqVar = new jq(j10, this.K, tL_chatAdminRights, this.B, tL_chatBannedRights, str, i10, z4, tLObject == null, null);
    ...
    */
    public final void u0() {
        ...
        if (i10 == 3) {
            ...
            if (chat.creator && !ChatObject.isChannel(chat) && ((this.m1 != this.n1 || this.v1) && this.s != null)) {
                MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.K, this, new mq(this, 0));
                return;
            }
    ...
    public final jr w0() {
        ...
        jrVar.j = this.V0;
        jrVar.l.clear();
        jrVar.l.addAll(this.D);
        jrVar.h = this.S0;
        jrVar.g = this.R0;
        jrVar.m.clear();
        jrVar.m.addAll(this.E);
        jrVar.e = this.B0;
        jrVar.f = this.C0;
        jrVar.k.clear();
        jrVar.k.addAll(this.C);
        jrVar.f(jrVar.c);
        return jrVar;
    }
    ...
    public final void y0(int i10) {
        ...
        this.c.getViewTreeObserver().addOnPreDrawListener(new vq(this, (org.telegram.ui.Components.t00) view, i10, 0));
    }
