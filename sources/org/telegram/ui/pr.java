...
public final class pr extends org.telegram.ui.Components.ll0 {
    ...
    public final void F(String str) {
        ...
        gg.c2 c2Var = this.h;
        qr qrVar = this.y;
        c2Var.g(null, qrVar.O != 0, false, true, false, ChatObject.isChannel(qrVar.r) ? this.y.N : 0L, false, this.y.O, 0);
        l();
    ...
    public final void l() {
        ...
        qr qrVar = this.y;
        if (qrVar.o1 && (w0Var = qrVar.c) != null) {
    ...
    */
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(2, 2, this.c, null, qrVar.e1 == 0);
            b5Var.G = true;
