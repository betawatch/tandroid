...
public final class q11 extends View {
    ...
    public final boolean a() {
        n11 n11Var = this.b;
        if (!n11Var.b || this.h < 1.0f) {
            return false;
        }
        if (n11Var.c.getLottieAnimation() != null) {
    ...
    public final void b(n11 n11Var) {
        ...
        if (this.f) {
            for (int i10 = 0; i10 < this.b.e.size(); i10++) {
                ((p11) this.b.e.get(i10)).setParentView(null);
            }
            this.f = false;
        }
        n11 n11Var2 = this.b;
        ArrayList arrayList2 = n11Var2.j;
        arrayList2.remove(this);
        if (arrayList2.isEmpty() && n11Var2.i) {
            n11Var2.b(true);
            n11Var2.i = false;
        }
        this.b = n11Var;
    ...
    public final void onDetachedFromWindow() {
        ...
        n11 n11Var = this.b;
        ArrayList arrayList = n11Var.j;
        arrayList.remove(this);
        if (arrayList.isEmpty() && n11Var.i) {
            n11Var.b(true);
            n11Var.i = false;
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.b.b) {
            if (!this.f) {
                for (int i10 = 0; i10 < this.b.e.size(); i10++) {
                    ((p11) this.b.e.get(i10)).setParentView(this);
                }
                this.f = true;
                if (!this.e) {
                    this.e = true;
            ...
            if (this.r) {
                ...
                if (i11 >= 0) {
                    ...
                    while (true) {
                        ...
                        if (i11 == RecyclerView.S(childAt) && (childAt instanceof org.telegram.ui.Cells.d9)) {
                            vh.n nVar = ((org.telegram.ui.Cells.d9) childAt).a;
                ...
                while (size >= 0) {
                    p11 p11Var = (p11) this.b.d.get(size);
                    float f11 = size;
                    ...
                    p11Var.setImageCoords(f16 - f17, pow - f17, f18, f18);
                    p11Var.draw(canvas);
                    size--;
                    f7 = 2.0f;
                }
