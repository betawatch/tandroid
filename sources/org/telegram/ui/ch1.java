...
public final /* synthetic */ class ch1 implements Runnable {
    ...
    public /* synthetic */ ch1(gh1 gh1Var, TLRPC.TL_error tL_error, int i10) {
        this.a = i10;
        this.b = gh1Var;
        this.c = tL_error;
    }
    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                if (tL_error != null) {
                    if (!tL_error.text.startsWith("CODE_INVALID")) {
                        if (!tL_error.text.startsWith("FLOOD_WAIT")) {
                            ...
                            gh1Var.G0(LocaleController.getString(R.string.AppName), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, intValue2 < 60 ? LocaleController.formatPluralString("Seconds", intValue2, new Object[0]) : LocaleController.formatPluralString("Minutes", intValue2 / 60, new Object[0])));
                            break;
                        }
                    } else {
                        gh1Var.y0();
                ...
                } else if (gh1Var.getParentActivity() != null) {
