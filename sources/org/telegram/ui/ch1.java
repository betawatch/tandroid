...
public final /* synthetic */ class ch1 implements Runnable {
    ...
    public /* synthetic */ ch1(dh1 dh1Var, String str, boolean z4, boolean z10, int i10) {
        this.a = i10;
        this.b = dh1Var;
        this.c = str;
        this.d = z4;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                boolean z12 = this.e;
                dh1Var.getClass();
                AndroidUtilities.runOnUIThread(new ch1(dh1Var, str4, z11, z12, 1));
                break;
            case 1:
                dh1 dh1Var2 = this.b;
                String str5 = this.c;
                boolean z13 = this.d;
                boolean z14 = this.e;
                dh1Var2.f.g(str5, true, z13, z13, dh1Var2.v.D, 0L, false, 0, 0);
                DispatchQueue dispatchQueue = Utilities.searchQueue;
                ch1 ch1Var = new ch1(dh1Var2, str5, z14, z13, 2);
                dh1Var2.h = ch1Var;
                dispatchQueue.postRunnable(ch1Var);
                break;
            default:
                dh1 dh1Var3 = this.b;
                String str6 = this.c;
                boolean z15 = this.d;
                boolean z16 = this.e;
                ArrayList arrayList2 = dh1Var3.r;
                ...
                if (lowerCase.length() != 0) {
                                ...
                                while (i14 < 3) {
                                    ...
                                    if (str8 != null) {
                                        ...
                                        if (c10 == 0) {
                                            if (c10 != 1) {
                                                str3 = str;
                                                arrayList4.add(AndroidUtilities.generateSearchName(vh.v2.e("@", str2), str3, "@" + str7));
                                            } else if (z17) {
                    ...
                    AndroidUtilities.runOnUIThread(new ed1(dh1Var3, arrayList3, arrayList4, 6));
                    break;
                } else {
                    AndroidUtilities.runOnUIThread(new ed1(dh1Var3, new ArrayList(), new ArrayList(), 6));
                    break;
                }
        }
    }
