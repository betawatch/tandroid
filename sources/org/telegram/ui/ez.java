...
public final class ez extends FrameLayout {
    ...
    public ez(fz fzVar, Context context) {
        ...
        f7.addView(w0Var, w7.a6.t(-2, -2, 17, 0, 0, 0, 4));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        linearLayout.setBackgroundResource(R.drawable.widget_bg);
        f7.addView(linearLayout, w7.a6.t(-2, -2, 17, 10, 0, 10, 0));
        fzVar.d = new ImageView(context);
        int i11 = fzVar.w;
        if (i11 == 0) {
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) fzVar.getParentActivity().getLayoutInflater().inflate(R.layout.shortcut_widget_item, (ViewGroup) null);
                linearLayout.addView(this.n[i10], w7.a6.n(-1, -2));
                i10++;
            }
            linearLayout.addView(fzVar.d, w7.a6.q(218, 160, 17));
            fzVar.d.setImageResource(R.drawable.chats_widget_preview);
        } else if (i11 == 1) {
            while (i10 < 2) {
                this.n[i10] = (ViewGroup) fzVar.getParentActivity().getLayoutInflater().inflate(R.layout.contacts_widget_item, (ViewGroup) null);
                linearLayout.addView(this.n[i10], w7.a6.n(160, -2));
                i10++;
            }
            linearLayout.addView(fzVar.d, w7.a6.q(160, 160, 17));
            fzVar.d.setImageResource(R.drawable.contacts_widget_preview);
        }
        a();
        ...
        if (i12 == 0) {
            ...
            while (i16 < i14) {
                if (arrayList.isEmpty()) {
                    dialog2 = i16 < fzVar.getMessagesController().dialogsServerOnly.size() ? fzVar.getMessagesController().dialogsServerOnly.get(i16) : null;
                    j3 = 0;
                } else if (i16 < arrayList.size()) {
                    j3 = 0;
                    TLRPC.Dialog dialog3 = (TLRPC.Dialog) fzVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i16)).longValue());
                    if (dialog3 == null) {
                ...
                if (dialog2 == null) {
                    ...
                    if (DialogObject.isUserDialog(dialog2.id)) {
                        user2 = fzVar.getMessagesController().getUser(Long.valueOf(dialog2.id));
                        if (user2 != null) {
                            ...
                            if (UserObject.isReplyUser(user2) || UserObject.isUserSelf(user2) || (userProfilePhoto2 = user2.photo) == null || (fileLocation2 = userProfilePhoto2.photo_small) == null) {
                                ...
                                if (fileLocation2.volume_id != j3 && fileLocation2.local_id != 0) {
                                    ...
                                    if (fileLocation2 == null) {
                                        try {
                                            decodeFile2 = BitmapFactory.decodeFile(fzVar.getFileLoader().getPathToAttach(fileLocation2, r12).toString());
                                        } catch (Throwable th2) {
                                            th = th2;
                                            c10 = 1;
                                            FileLog.e(th);
                                            ArrayList arrayList2 = (ArrayList) fzVar.getMessagesController().dialogMessage.f(dialog2.id);
                                            if (arrayList2 != null) {
                                            }
                                    ...
                                    ArrayList arrayList22 = (ArrayList) fzVar.getMessagesController().dialogMessage.f(dialog2.id);
                                    messageObject = (arrayList22 != null || arrayList22.size() <= 0) ? null : (MessageObject) arrayList22.get(i15);
                                    if (messageObject == null) {
                                        long fromChatId = messageObject.getFromChatId();
                                        if (fromChatId > j3) {
                                            user3 = fzVar.getMessagesController().getUser(Long.valueOf(fromChatId));
                                            chat3 = null;
                                        } else {
                                            chat3 = fzVar.getMessagesController().getChat(Long.valueOf(-fromChatId));
                                            user3 = null;
                                        }
                                            ...
                                            if (chat2 == null || chat2.id <= j3 || chat3 != null || (ChatObject.isChannel(chat2) && !ChatObject.isMegagroup(chat2))) {
                                                ...
                                                if ((messageMedia instanceof TLRPC.TL_messageMediaPhoto) && (messageMedia.photo instanceof TLRPC.TL_photoEmpty) && messageMedia.ttl_seconds != 0) {
                                                    ...
                                                    if (messageMedia instanceof TLRPC.TL_messageMediaPoll) {
                                                        ...
                                                        charSequence = com.google.android.gms.internal.vision.e2.i("🎧 ", messageObject.getMusicAuthor(), " - ", messageObject.getMusicTitle());
                                                    } else {
                                                    ...
                                                    if (charSequence5 != null) {
                                                        ...
                                                        if (messageObject.messageOwner.media == null || messageObject.isMediaEmpty()) {
                                                            ...
                                                            if (messageMedia2 instanceof TLRPC.TL_messageMediaPoll) {
                                                                ...
                                                                j10 = messageObject.type == 14 ? org.telegram.ui.Cells.r6.j("🎧 \u2068", messageObject.getMusicAuthor(), " - ", messageObject.getMusicTitle(), "\u2069") : messageObject.messageText.toString();
                                                                c12 = '\n';
                                                            }
                                                            ...
                                                            try {
                                                                valueOf2.setSpan(new org.telegram.ui.Components.m10(org.telegram.ui.ActionBar.j6.o9, null), string.length() + 2, valueOf2.length(), 33);
                                                                spannableStringBuilder = valueOf2;
                                                            } catch (Exception e) {
                                                                FileLog.e(e);
                                                                spannableStringBuilder = valueOf2;
                                                            }
                                                            spannableStringBuilder.setSpan(new org.telegram.ui.Components.m10(org.telegram.ui.ActionBar.j6.k9, null), 0, string.length() + 1, 33);
                                    ...
                                    if (dialog2.unread_count <= 0) {
                                        ...
                                        if (fzVar.getMessagesController().isDialogMuted(dialog2.id, j3)) {
                        ...
                        ArrayList arrayList222 = (ArrayList) fzVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        i11 = i16;
                        TLRPC.Chat chat4 = fzVar.getMessagesController().getChat(Long.valueOf(-dialog2.id));
                        if (chat4 != null) {
                            str2 = chat4.title;
                            ...
                            if (chatPhoto == null || (fileLocation2 = chatPhoto.photo_small) == null || fileLocation2.volume_id == j3 || fileLocation2.local_id == 0) {
                                ...
                                ArrayList arrayList2222 = (ArrayList) fzVar.getMessagesController().dialogMessage.f(dialog2.id);
                        ...
                        ArrayList arrayList22222 = (ArrayList) fzVar.getMessagesController().dialogMessage.f(dialog2.id);
            ...
            while (true) {
                ...
                for (int i19 = 2; i18 < i19; i19 = 2) {
                    int i20 = (i17 * 2) + i18;
                    if (arrayList.isEmpty()) {
                        if (i20 < fzVar.getMediaDataController().hints.size()) {
                            long j11 = fzVar.getMediaDataController().hints.get(i20).peer.user_id;
                            dialog = (TLRPC.Dialog) fzVar.getMessagesController().dialogs_dict.f(j11);
                            if (dialog == null) {
                        ...
                        if (i20 < arrayList.size()) {
                            dialog = (TLRPC.Dialog) fzVar.getMessagesController().dialogs_dict.f(((Long) arrayList.get(i20)).longValue());
                            if (dialog == null) {
                                dialog = new TLRPC.TL_dialog();
                    ...
                    if (dialog == null) {
                        ...
                        if (DialogObject.isUserDialog(dialog.id)) {
                            user = fzVar.getMessagesController().getUser(Long.valueOf(dialog.id));
                            ...
                            TLRPC.Chat chat5 = fzVar.getMessagesController().getChat(Long.valueOf(-dialog.id));
                        ...
                        if (fileLocation != null) {
                            try {
                                decodeFile = BitmapFactory.decodeFile(fzVar.getFileLoader().getPathToAttach(fileLocation, true).toString());
                            } catch (Throwable th3) {
                                th = th3;
                                FileLog.e(th);
    ...
    */
    public final void onDraw(Canvas canvas) {
        ...
        fz fzVar = this.r;
        f5Var = ((org.telegram.ui.ActionBar.p2) fzVar).parentLayout;
        float themeAnimationValue = f5Var.getThemeAnimationValue();
        int i10 = 0;
        while (i10 < 2) {
            Drawable drawable2 = i10 == 0 ? this.d : this.c;
            if (drawable2 != null) {
                if (i10 == 1 && this.d != null) {
                    f5Var2 = ((org.telegram.ui.ActionBar.p2) fzVar).parentLayout;
                    if (f5Var2 != null) {
