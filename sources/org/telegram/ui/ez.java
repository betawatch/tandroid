...
public final class ez extends FrameLayout {
    ...
    public ez(fz fzVar, Context context) {
        ...
        if (i11 == 0) {
            ...
            linearLayout.addView(fzVar.d, w7.x5.q(218, 160, 17));
            ...
            linearLayout.addView(fzVar.d, w7.x5.q(160, 160, 17));
                        ...
                        if (user2 != null) {
                            ...
                            if (UserObject.isReplyUser(user2) || UserObject.isUserSelf(user2) || (userProfilePhoto2 = user2.photo) == null || (fileLocation2 = userProfilePhoto2.photo_small) == null) {
                                ...
                                if (fileLocation2.volume_id != j3 && fileLocation2.local_id != 0) {
                                    ...
                                    if (decodeFile2 != null) {
                                        if (user2 != null) {
                                            org.telegram.ui.Components.f9 f9Var3 = new org.telegram.ui.Components.f9(i15, user2);
                                            ...
                                            f9Var2 = new org.telegram.ui.Components.f9(chat2);
                                        }
                                        f9Var2.setBounds(i15, i15, dp, dp);
                                        f9Var2.draw(canvas2);
                                        canvas = canvas2;
                                        c10 = 1;
                                    } else {
                    ...
                    if (dialog == null) {
                        ...
                        if (decodeFile == null) {
                            if (user != null) {
                                ...
                                f9Var = new org.telegram.ui.Components.f9(chat);
                            }
                            f9Var.setBounds(0, 0, dp3, dp3);
                            f9Var.draw(canvas3);
                        } else {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (s02 != drawable && s02 != null) {
            if (org.telegram.ui.ActionBar.j6.sl != null) {
                ...
                org.telegram.ui.Components.s9 s9Var2 = this.a;
                if (s9Var2 != null) {
                    s9Var2.dispose();
                    this.a = null;
                }
        ...
        fz fzVar = this.r;
        e5Var = ((org.telegram.ui.ActionBar.o2) fzVar).parentLayout;
        ...
        while (i10 < 2) {
            ...
            if (drawable2 != null) {
                if (i10 == 1 && this.d != null) {
                    e5Var2 = ((org.telegram.ui.ActionBar.o2) fzVar).parentLayout;
                    if (e5Var2 != null) {
                        ...
                        if (!(drawable2 instanceof ColorDrawable) || (drawable2 instanceof GradientDrawable) || (drawable2 instanceof org.telegram.ui.Components.cc0)) {
                            ...
                            if (drawable2 instanceof org.telegram.ui.Components.t9) {
                                drawable2.draw(canvas);
                            } else {
                                this.a = ((org.telegram.ui.Components.t9) drawable2).c(canvas, this);
                            }
