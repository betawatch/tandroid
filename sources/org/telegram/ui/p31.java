    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (i12 < length) {
            ...
            if (view == null) {
                ...
                float clamp = Utilities.clamp(1.0f - Math.abs(t31Var.getTranslationX() / t31Var.getMeasuredWidth()), 1.0f, f7);
                float f10 = this.b;
        ...
        canvas.drawRoundRect(rectF, lerp, lerp, u31Var.c);
        canvas.save();
        Path path = this.c;
        path.rewind();
        ...
        if (bool == null || bool.booleanValue() != z10) {
            boolean z11 = AndroidUtilities.computePerceivedBrightness(u31Var.getThemedColor(org.telegram.ui.ActionBar.h6.h5)) > 0.721f;
            boolean z12 = AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v(u31Var.getThemedColor(org.telegram.ui.ActionBar.h6.s8), 855638016)) > 0.721f;
