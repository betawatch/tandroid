...
public final class gw0 extends View {
    ...
    public /* synthetic */ gw0(Object obj, Context context, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
    }
    ...
    public void onDraw(Canvas canvas) {
        switch (this.a) {
            case 2:
                ...
                canvas.drawColor(m21Var.H ? -15590870 : -6569073);
                org.telegram.ui.Components.dc0 dc0Var = m21Var.n;
                if (dc0Var != null) {
                    dc0Var.setBounds(0, 0, getWidth(), getHeight());
                }
                m21Var.h.setBounds(0, 0, getWidth(), getHeight());
                org.telegram.ui.Components.dc0 dc0Var2 = m21Var.n;
                if (dc0Var2 != null) {
                    dc0Var2.draw(canvas);
                }
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        switch (this.a) {
            case 4:
                ...
                AndroidUtilities.lerp(e51Var.c, rect, e51Var.F, e51Var.e);
                break;
            default:
                super.onLayout(z4, i10, i11, i12, i13);
                break;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.a) {
            case 0:
                ...
                PremiumPreviewFragment premiumPreviewFragment = hw0Var.c;
                if (premiumPreviewFragment.T) {
                    premiumPreviewFragment.V = 0;
                } else {
                    int dp = AndroidUtilities.dp(64.0f);
                    if (AndroidUtilities.dp(8.0f) + hw0Var.c.R.getMeasuredHeight() > dp) {
                        dp = hw0Var.c.R.getMeasuredHeight() + AndroidUtilities.dp(8.0f);
                    }
                    hw0Var.c.V = dp;
                }
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(hw0Var.c.V, TLObject.FLAG_30));
                break;
            case 7:
                ...
                break;
            case 8:
                rh.k kVar3 = (rh.k) this.b;
                if (kVar3.E) {
                    int i16 = kVar3.F;
                    kVar2 = ((org.telegram.ui.ActionBar.p2) kVar3).actionBar;
                    i13 = (kVar2.getMeasuredHeight() + i16) - AndroidUtilities.dp(16.0f);
                } else {
                    int dp3 = AndroidUtilities.dp(140.0f) + kVar3.F;
                    if (AndroidUtilities.dp(24.0f) + kVar3.y.getMeasuredHeight() > dp3) {
                        dp3 = AndroidUtilities.dp(24.0f) + kVar3.y.getMeasuredHeight();
                    }
                    i13 = dp3;
                }
    ...
    public void setAlpha(float f10) {
        switch (this.a) {
            ...
            case 5:
                super.setAlpha(f10);
                View view2 = ((kf1) this.b).fragmentView;
                if (view2 != null) {
                    view2.invalidate();
                    break;
                }
