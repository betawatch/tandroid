...
public final class ij1 extends org.telegram.ui.Components.kl0 {
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i15 = i13 * i14;
        fbVar.d(i14, i15 == 0, i15 / i14 == wallpapersListActivity.e - 1);
        for (int i16 = 0; i16 < wallpapersListActivity.R; i16++) {
            ...
            if (obj2 instanceof TLRPC.TL_wallPaper) {
                ...
                obj = (wallpapersListActivity.S.equals(tL_wallPaper.slug) && (!wallpapersListActivity.S.equals(tL_wallPaper.slug) || (wallPaperSettings = tL_wallPaper.settings) == null || (wallpapersListActivity.T == org.telegram.ui.ActionBar.i6.X0(wallPaperSettings.background_color) && wallpapersListActivity.U == org.telegram.ui.ActionBar.i6.X0(tL_wallPaper.settings.second_background_color) && wallpapersListActivity.V == org.telegram.ui.ActionBar.i6.X0(tL_wallPaper.settings.third_background_color) && wallpapersListActivity.W == org.telegram.ui.ActionBar.i6.X0(tL_wallPaper.settings.fourth_background_color) && (wallpapersListActivity.U == 0 || wallpapersListActivity.V != 0 || wallpapersListActivity.X == AndroidUtilities.getWallpaperRotation(tL_wallPaper.settings.rotation, false) || !tL_wallPaper.pattern || Math.abs(org.telegram.ui.ActionBar.i6.R0(((float) tL_wallPaper.settings.intensity) / 100.0f) - wallpapersListActivity.Y) <= 0.001f)))) ? tL_wallPaper : null;
                j3 = tL_wallPaper.id;
            ...
            fbVar.e(wallpapersListActivity.v, obj2, obj, i16);
            kVar = ((org.telegram.ui.ActionBar.n2) wallpapersListActivity).actionBar;
            if (kVar.s()) {
                fbVar.c(i16, wallpapersListActivity.i0.indexOfKey(j3) >= 0, !wallpapersListActivity.j0);
            } else {
                fbVar.c(i16, false, !wallpapersListActivity.j0);
            }
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        return new org.telegram.ui.Components.vk0(i10 != 0 ? i10 != 1 ? i10 != 3 ? new org.telegram.ui.Components.ij(this, context, 1) : new org.telegram.ui.Cells.e9(context) : new org.telegram.ui.Cells.a7(context, (org.telegram.ui.Cells.q3) null) : new org.telegram.ui.Cells.r8(context));
    }
}
