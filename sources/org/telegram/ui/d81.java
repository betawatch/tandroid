...
public final class d81 extends LinearLayout {
    ...
    public d81(ContextThemeWrapper contextThemeWrapper, final oq0 oq0Var) {
        ...
        c3.c(-328966, -328966);
        final int i10 = 0;
        c3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.c81
        ...
        c6.c(-328966, -328966);
        final int i11 = 1;
        c6.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.c81
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i11;
                oq0 oq0Var2 = oq0Var;
        ...
        c10.c(-328966, -328966);
        final int i12 = 2;
        c10.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.c81
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i12;
                oq0 oq0Var2 = oq0Var;
        ...
        c11.c(-328966, -328966);
        final int i13 = 3;
        c11.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.c81
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i13;
                oq0 oq0Var2 = oq0Var;
        ...
        c12.c(-328966, -328966);
        final int i14 = 4;
        c12.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.c81
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int i112 = i14;
                oq0 oq0Var2 = oq0Var;
