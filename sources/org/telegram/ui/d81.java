...
public final class d81 extends FrameLayout {
    ...
    public d81(Activity activity, boolean z10) {
        super(activity);
        this.e = false;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.i6.k0);
        }
    }
