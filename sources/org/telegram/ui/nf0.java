    ...
    public nf0(yg0 yg0Var, Context context) {
        ...
        if (!AndroidUtilities.isSmallScreen()) {
            ...
            if (point.x <= point.y || AndroidUtilities.isTablet()) {
                ...
                this.a = yc0Var;
                yc0Var.setText(LocaleController.getString(yg0Var.F != 3 ? R.string.YourNewEmail : R.string.YourEmail));
                ...
                editTextBoldCursor.setOnEditorActionListener(new ka(this, i12));
                ...
                frameLayout2.setOnClickListener(new m60(this, 8));
            }
        }
        i10 = 8;
        frameLayout.setVisibility(i10);
        ...
        this.a = yc0Var2;
        yc0Var2.setText(LocaleController.getString(yg0Var.F != 3 ? R.string.YourNewEmail : R.string.YourEmail));
        ...
        editTextBoldCursor2.setOnEditorActionListener(new ka(this, i122));
        ...
        frameLayout22.setOnClickListener(new m60(this, 8));
    }
