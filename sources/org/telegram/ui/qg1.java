...
public final /* synthetic */ class qg1 implements RequestDelegate {
    public final /* synthetic */ int a;
    public final /* synthetic */ TwoStepVerificationActivity b;

    public /* synthetic */ qg1(TwoStepVerificationActivity twoStepVerificationActivity, int i10) {
        this.a = i10;
                        ...
                        switch (i11) {
                            case 0:
                                ...
                                if (!(tLObject2 instanceof TL_account.resetPasswordOk)) {
                                    ...
                                    d2Var.R = string;
                                    d2Var.T = LocaleController.getString(R.string.RestorePasswordResetPasswordOk);
                                    twoStepVerificationActivity2.showDialog(d2Var, new s5(twoStepVerificationActivity2, 18));
                                    break;
                                }
                                break;
                            default:
                        ...
                        switch (i112) {
                            case 0:
                                ...
                                if (!(tLObject2 instanceof TL_account.resetPasswordOk)) {
                                    ...
                                    d2Var.R = string;
                                    d2Var.T = LocaleController.getString(R.string.RestorePasswordResetPasswordOk);
                                    twoStepVerificationActivity22.showDialog(d2Var, new s5(twoStepVerificationActivity22, 18));
                                    break;
                                }
                                break;
                            default:
