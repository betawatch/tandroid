...
public final class im0 implements RequestDelegate {
    ...
    public final /* synthetic */ jm0 n;
    public final /* synthetic */ TLRPC.TL_inputSecureValue o;
    public final /* synthetic */ jm0 p;
    ...
    public final void a(final TLRPC.TL_error tL_error, final TLRPC.TL_secureValue tL_secureValue, final TLRPC.TL_secureValue tL_secureValue2) {
        jm0 jm0Var = this.p;
        final boolean z10 = jm0Var.b;
        final int i10 = jm0Var.c;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            ...
            if (tL_error.text.equals("PHONE_VERIFICATION_NEEDED")) {
                AndroidUtilities.runOnUIThread(new jf0(im0Var.a, tL_error, str, 11));
                return;
            }
        } else {
            im0Var = this;
        }
        if (tL_error != null || (tL_inputSecureValue = im0Var.o) == null) {
