...
public final class im0 extends FrameLayout {
    ...
    public /* synthetic */ im0(Context context, EditTextBoldCursor editTextBoldCursor, int i10) {
        super(context);
        this.a = i10;
    ...
    public final void onMeasure(int i10, int i11) {
        switch (this.a) {
            ...
            default:
                ...
                float measuredHeight = (r0.f / 768.0f) * ((gg.k) this.b).getMeasuredHeight();
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public im0(org.telegram.ui.Components.ti0 ti0Var, Context context, gg.k kVar) {
        super(context);
        this.a = 3;
        this.d = ti0Var;
        this.b = kVar;
