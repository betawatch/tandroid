...
public final class f21 extends org.telegram.ui.ActionBar.m2 {
    ...
    */
    ...
    public final View createView(Context context) {
        ...
        this.c = new b21(context);
        c21 c21Var = new c21(context, this.c, this.resourceProvider, true);
        this.b = c21Var;
        this.actionBar.setAdaptiveBackground(c21Var);
        ...
        final int i11 = 0;
        View.OnClickListener onClickListener = new View.OnClickListener(this) { // from class: org.telegram.ui.z11
                                ...
                                if (i13 >= editTextBoldCursorArr.length) {
                                    ...
                                    if ((i12 != 1 || i13 != 4) && (i12 != 2 || (i13 != 2 && i13 != 3))) {
                                        ...
                                        if (TextUtils.isEmpty(str)) {
                                            f21Var.a[i13].setText((CharSequence) null);
                                        } else {
                                            try {
                                                f21Var.a[i13].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                f21Var.a[i13].setText(str);
                                            }
                                        }
                                    }
                                    i13++;
        ...
        for (int i12 = 0; i12 < 3; i12++) {
            ...
            this.c.addView(k6VarArr[i12], w7.y5.n(-1, 50));
        ...
        while (i14 < i13) {
            ...
            if (i14 == 0) {
                ...
                this.a[i14].addTextChangedListener(new d21(this, 0));
            } else if (i14 == 1) {
                this.a[i14].setInputType(2);
                this.a[i14].addTextChangedListener(new d21(this, 1));
            } else if (i14 == 3) {
            ...
            if (i14 == 4) {
                this.a[i14].addTextChangedListener(new d21(this, 2));
            }
            ...
            frameLayout2.addView(this.a[i14], w7.y5.d(-1, -1.0f, 51, 17.0f, i14 == 0 ? 12.0f : 0.0f, 17.0f, 0.0f));
        ...
        for (int i16 = 0; i16 < 2; i16++) {
            ...
            this.c.addView(e9VarArr[i16], w7.y5.n(-1, -2));
        }
        ...
        final int i18 = 1;
        this.n.setOnClickListener(new View.OnClickListener(this) { // from class: org.telegram.ui.z11
            public final /* synthetic */ f21 b;
                            ...
                            while (true) {
                                ...
                                if (i132 >= editTextBoldCursorArr.length) {
                                    ...
                                    if ((i122 != 1 || i132 != 4) && (i122 != 2 || (i132 != 2 && i132 != 3))) {
                                        ...
                                        if (TextUtils.isEmpty(str)) {
                                            f21Var.a[i132].setText((CharSequence) null);
                                        } else {
                                            try {
                                                f21Var.a[i132].setText(URLDecoder.decode(str, "UTF-8"));
                                            } catch (UnsupportedEncodingException unused) {
                                                f21Var.a[i132].setText(str);
                                            }
                                        }
                                    }
                                    i132++;
        ...
        this.c.addView(this.h, w7.y5.n(-1, -2));
        ...
        b7VarArr[1] = b7Var3;
        this.c.addView(b7Var3, w7.y5.n(-1, -2));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(eaVar, TLObject.FLAG_28, null, null, null, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.n, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i13));
        ...
        if (this.a != null) {
            ...
            while (true) {
                ...
                arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, oy0Var, org.telegram.ui.ActionBar.h6.k6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, null, null, null, oy0Var, org.telegram.ui.ActionBar.h6.l6));
        ...
        while (true) {
            ...
            if (b7Var != null) {
                arrayList.add(new org.telegram.ui.ActionBar.j6(b7Var, 32, new Class[]{org.telegram.ui.Cells.b7.class}, null, null, null, org.telegram.ui.ActionBar.h6.b7));
            }
            i17++;
        }
        for (int i18 = 0; i18 < e9VarArr.length; i18++) {
            arrayList.add(new org.telegram.ui.ActionBar.j6(e9VarArr[i18], 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, org.telegram.ui.ActionBar.h6.b7));
