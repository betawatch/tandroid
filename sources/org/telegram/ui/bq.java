...
public final class bq implements NotificationCenter.NotificationCenterDelegate {
    public int E;
    ...
    public boolean b0;
    public int c;
    public final org.telegram.ui.Components.br c0;
    public float d;
    public final int[] d0;
    ...
    public bq(int i10, View view, long j3, int i11, int i12, long j10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.I = 0L;
        this.b0 = true;
        org.telegram.ui.Components.br brVar = new org.telegram.ui.Components.br(null, true, null);
        this.c0 = brVar;
        this.d0 = new int[3];
        this.T = view;
        this.e0 = i10;
        ...
        brVar.I = 1;
        brVar.g = true;
        brVar.d = d("paintChatActionBackground");
        brVar.e = textPaint;
    ...
    public final void a(Canvas canvas, wj wjVar, float f7, float f10) {
        int i10;
        int i11;
        RectF rectF;
        int i12;
        ...
        org.telegram.ui.Components.br brVar2 = this.c0;
        brVar2.H = wjVar;
        RectF rectF3 = brVar2.f;
        float dp = AndroidUtilities.dp(110.0f) * f7;
        if (dp < AndroidUtilities.dp(8.0f)) {
            return;
        }
        float f21 = f7 < 0.2f ? 5.0f * f7 * f10 : f10;
        org.telegram.ui.ActionBar.j6.q(0.0f, wjVar.getMeasuredHeight() - dp, this.c, wjVar.getMeasuredHeight());
        ...
        if ((f7 < 1.0f || this.Q >= 1.0f) && (f7 >= 1.0f || this.Q != 1.0f)) {
            ...
            if (currentTimeMillis - this.P > 100) {
                try {
                    wjVar.performHapticFeedback(3, 2);
        ...
        if (f26 < 1.0f || this.R) {
            ...
            canvas2.restore();
            if (this.R) {
                float a2 = org.telegram.ui.Cells.r6.a(f13 - AndroidUtilities.dp(2.0f), this.K, (1.0f - this.K) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f7)) - f14), f17);
        ...
        if (!this.R && f14 > 0.0f) {
            float a10 = org.telegram.ui.Cells.r6.a((-f18) + AndroidUtilities.dp(4.0f), this.K, (1.0f - this.K) * (((-AndroidUtilities.dp(8.0f)) - (AndroidUtilities.dp2(8.0f) * f7)) - f14), f17);
            ...
            if (this.X && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.vq) && (((org.telegram.ui.Components.vq) imageReceiver2.getDrawable()).b instanceof org.telegram.ui.Components.v80)) {
                ((org.telegram.ui.Components.v80) ((org.telegram.ui.Components.vq) imageReceiver2.getDrawable()).b).i = f7;
            }
            if (this.K <= 0.0f || !this.b0) {
                ...
                imageReceiver2.draw(canvas2);
                float f53 = this.K;
                org.telegram.ui.Components.br brVar3 = brVar;
                brVar3.e(brVar3.s);
                canvas2.scale(f53, f53, (brVar3.s / 2.0f) + brVar3.A + AndroidUtilities.dp(12.0f) + f16, (a10 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                ...
                if (f55 != 1.0f) {
                    ...
                    if (i20 == 0 || i20 == 1) {
                        ...
                        f20 = 14.0f;
                        brVar3.e(brVar3.s);
                        float dp14 = (brVar3.x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                        float f56 = brVar3.B;
                        rectF2.set(f56, dp14, brVar3.s + f56 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f57 = f55 * 2.0f;
                        if (f57 > 1.0f) {
                            f57 = 1.0f;
                        }
                        float dp15 = (brVar3.x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                        int i21 = brVar3.s;
                        int i22 = brVar3.r;
                        if (i21 == i22) {
                            z10 = i21;
                    ...
                    f20 = 14.0f;
                    brVar3.e(brVar3.s);
                    float dp16 = (brVar3.x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                    float f59 = brVar3.B;
                    rectF2.set(f59, dp16, brVar3.s + f59 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                ...
                float f60 = this.K;
                brVar3.e(brVar3.s);
                canvas2.scale(f60, f60, (brVar3.s / 2.0f) + brVar3.A + AndroidUtilities.dp(12.0f) + f16, (a10 - AndroidUtilities.dp(f19)) + AndroidUtilities.dp(f20));
    ...
    public final void g(final View view, boolean z10) {
        ...
        if (!z10) {
            ...
            final int i13 = 4;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.zp
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (i13) {
                        case 0:
                            bq bqVar = this.b;
                            bqVar.getClass();
                            bqVar.K = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            bqVar.T.invalidate();
                            break;
                        case 1:
                            bq bqVar2 = this.b;
                            bqVar2.getClass();
                            bqVar2.L = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            break;
                        case 2:
                            bq bqVar3 = this.b;
                            bqVar3.getClass();
                            bqVar3.L = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            view.invalidate();
                            break;
                        case 3:
                            bq bqVar4 = this.b;
        ...
        ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.zp
            public final /* synthetic */ bq b;
        ...
        ofFloat2.setInterpolator(org.telegram.ui.Components.wr.h);
        ofFloat2.setDuration(250L);
        this.L = 0.0f;
        ValueAnimator ofFloat3 = ValueAnimator.ofFloat(0.0f, 1.0f);
        ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.zp
            public final /* synthetic */ bq b;
        ...
        org.telegram.ui.Components.wr wrVar = org.telegram.ui.Components.wr.j;
        ofFloat3.setInterpolator(wrVar);
        ofFloat3.setDuration(180L);
        ValueAnimator ofFloat4 = ValueAnimator.ofFloat(1.0f, -0.5f);
        ofFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.zp
            public final /* synthetic */ bq b;
        ...
        final int i14 = 3;
        ofFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: org.telegram.ui.zp
            public final /* synthetic */ bq b;
        ...
        ofFloat5.setInterpolator(wrVar);
        ofFloat5.setDuration(100L);
        AnimatorSet animatorSet3 = new AnimatorSet();
        this.J = animatorSet3;
        animatorSet3.addListener(new bi.u3(13, this, view));
    ...
    public final void j() {
        ...
        if (i12 == 1) {
            ...
            this.k0 = null;
            imageReceiver.setImageBitmap(mg.d.c(this.T.getContext(), 1.0f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ac, f6Var), true));
            ...
            this.k0 = null;
            imageReceiver.setImageBitmap(mg.d.e(tL_forumTopic));
        }
