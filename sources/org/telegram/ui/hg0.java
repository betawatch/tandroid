...
public final class hg0 extends org.telegram.ui.Components.vv0 {
    ...
    public hg0(yg0 yg0Var, Context context) {
        super(context);
        ...
        gg0 gg0Var = new gg0(context, 1, 1, 0);
        ...
        aVar.b();
        frameLayout.addView(gg0Var, w7.x5.e(160, 160, 1));
        ...
        f6Var2 = ((org.telegram.ui.ActionBar.o2) yg0Var).resourceProvider;
        yh.r rVar = new yh.r(context, 1, f6Var2);
        ...
        f6Var3 = ((org.telegram.ui.ActionBar.o2) yg0Var).resourceProvider;
        yh.r rVar2 = new yh.r(context, 1, f6Var3);
        ...
        f6Var4 = ((org.telegram.ui.ActionBar.o2) yg0Var).resourceProvider;
        yh.r rVar3 = new yh.r(context, 1, f6Var4);
        rVar3.a(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.SMSFee3Title), new dg0(this, 4)), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)), LocaleController.getString(R.string.SMSFee3Text), R.drawable.menu_feature_hands);
    ...
    public static /* synthetic */ void o(hg0 hg0Var, String str, String str2, String str3) {
        try {
            ...
            try {
                if (i10 >= 22) {
                    SubscriptionManager from = SubscriptionManager.from(hg0Var.getContext());
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    TelephonyManager telephonyManager = (TelephonyManager) hg0Var.getContext().getSystemService(TelephonyManager.class);
            ...
            sb2.append("Wi-Fi: ");
            sb2.append(AndroidUtilities.isWifiEnabled(hg0Var.getContext()));
            sb2.append("\n");
            sb2.append("Airplane Mode: ");
            sb2.append(AndroidUtilities.isInAirplaneMode(hg0Var.getContext()));
            sb2.append("\n");
            sb2.append("\n");
            sb2.append("App: ");
            ...
            hg0Var.getContext().startActivity(Intent.createChooser(intent, "Send email..."));
        } catch (Exception unused) {
            hg0Var.v.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
