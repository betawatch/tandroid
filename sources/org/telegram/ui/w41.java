...
public final class w41 extends Dialog {
    ...
    public float s;
    public float v;
    public org.telegram.ui.Components.j71 w;
    public qh.e3 x;
    public TextView y;
    ...
    public w41(Activity activity) {
        ...
        this.b = l0Var;
        l0Var.setOnClickListener(new s41(this, i10));
    ...
    public final void dismiss() {
        ...
        org.telegram.ui.Components.j71 j71Var = this.w;
        if (j71Var != null) {
            j71Var.B();
            this.w.H();
            this.w = null;
    ...
    public final void e() {
        ...
        qh.e3 e3Var = this.x;
        if (e3Var != null) {
            e3Var.setTranslationX(AndroidUtilities.lerp(this.C, 0.0f, this.s));
