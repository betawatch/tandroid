...
public final class yh0 extends org.telegram.ui.Components.vl0 {
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 == 2) {
            org.telegram.ui.Components.e90 e90Var = (org.telegram.ui.Components.e90) view;
            e90Var.setCanEdit(j3 == zh0Var.getAccountInstance().getUserConfig().clientUserId);
            if (zh0Var.o0 && j3 == zh0Var.getAccountInstance().getUserConfig().clientUserId) {
                if (zh0Var.d != null) {
                    e90Var.setLink("https://t.me/" + ChatObject.getPublicUsername(zh0Var.c));
            ...
            if (tL_chatInviteExported2 != null) {
                e90Var.setLink(tL_chatInviteExported2.link);
                e90Var.c(tL_chatInviteExported2, j10);
                return;
            } else {
                e90Var.setLink(null);
                e90Var.d(0, null, false);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                break;
            case 2:
                org.telegram.ui.Components.e90 e90Var = new org.telegram.ui.Components.e90(this.c, zh0Var, null, true, zh0Var.h);
                e90Var.setPermanent(true);
                e90Var.setDelegate(new xh0(this, e90Var));
                view = e90Var;
                break;
            case 3:
                e6Var = ((org.telegram.ui.ActionBar.n2) zh0Var).resourceProvider;
                view = new org.telegram.ui.Cells.g2(context, 64, e6Var);
                break;
            case 4:
            ...
            default:
                ...
                sh0Var.addView(new rh0(context), w7.y5.d(-2, -2.0f, 49, 0.0f, 10.0f, 0.0f, 0.0f));
                ...
                sh0Var.addView(textView, w7.y5.d(-1, -2.0f, 51, 52.0f, 143.0f, 52.0f, 18.0f));
                sh0Var.setTag(-33024);
                view = sh0Var;
                break;
        }
