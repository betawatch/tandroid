...
public final class tr extends org.telegram.ui.Components.kl0 {
    ...
    public final void F(String str) {
        ...
        gg.c2 c2Var = this.h;
        ur urVar = this.y;
        c2Var.g(null, urVar.O != 0, false, true, false, ChatObject.isChannel(urVar.r) ? this.y.N : 0L, false, this.y.O, 0);
        l();
    ...
    public final void l() {
        ...
        ur urVar = this.y;
        if (urVar.o1 && (w0Var = urVar.c) != null) {
            ...
            if (adapter != trVar) {
                ...
                urVar.c.setFastScrollVisible(false);
                urVar.c.setVerticalScrollBarEnabled(true);
            }
        }
        super.l();
    }
    ...
    */
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (!z11) {
            if (E instanceof TLRPC.ChannelParticipant) {
                ...
                if (peerId >= 0) {
                    TLRPC.User user = urVar.getMessagesController().getUser(Long.valueOf(peerId));
                    tLObject2 = user;
                    if (user != null) {
                                            ...
                                            if (charSequence.toString().startsWith("@" + publicUsername)) {
                                                        ...
                                                        if (size2 + 1 > i10) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (indexOfIgnoreCase2 != -1) {
                                                                    ...
                                                                    spannableStringBuilder2.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.q6, false)), indexOfIgnoreCase2, length + indexOfIgnoreCase2, 33);
                                                                    str3 = spannableStringBuilder2;
                                                                }
                                                            } catch (Exception e) {
                                                                FileLog.e(e);
                                                ...
                                                if (str != null && publicUsername != null) {
                                                    ...
                                                    if (indexOfIgnoreCase != -1) {
                                                        spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.q6, false)), indexOfIgnoreCase, str.length() + indexOfIgnoreCase, 33);
                                                    }
                                                }
                ...
                tLObject2 = urVar.getMessagesController().getUser(Long.valueOf(((TLRPC.ChatParticipant) E).user_id));
            }
        }
        publicUsername = null;
        tLObject = tLObject2;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(2, 2, this.c, null, urVar.e1 == 0);
            b5Var.G = true;
