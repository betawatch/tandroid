    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                yo0 yo0Var = paymentFormActivity$TelegramWebviewProxy.a;
                if (yo0Var.getParentActivity() != null && str5.equals("payment_form_submit")) {
                    try {
                        JSONObject jSONObject = new JSONObject(str6);
                        yo0Var.w0 = jSONObject.getJSONObject("credentials").toString();
                        yo0Var.x0 = jSONObject.getString("title");
                    } catch (Throwable th2) {
                        yo0Var.w0 = str6;
                        FileLog.e(th2);
                    }
            ...
            case 3:
                ...
                AndroidUtilities.runOnUIThread(new l4(3, a7Var, c2Var));
                return;
            case 4:
                u7 u7Var = (u7) this.d;
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            str2 = str;
                            AndroidUtilities.runOnUIThread(new ai.m3(u7Var, aVar, tL_documentAttributeAudio, str2, str7, 12));
                            return;
                        }
                        try {
            ...
            case 5:
                ...
                return;
            case 6:
                m9.W((m9) this.d, (TLRPC.TL_error) this.b, (TLObject) this.c);
                return;
            case 7:
                ...
                org.telegram.messenger.wl.o(R.string.LinkCopied, new org.telegram.ui.Components.vc(g3Var.topBulletinContainer, f6Var));
                return;
            case 8:
                sa.X((sa) this.d, (org.telegram.ui.ActionBar.c2) this.b, (TLRPC.User) this.c);
                return;
            case 9:
                wb.Z((wb) this.d, (TLRPC.TL_error) this.b, (TLObject) this.c);
                return;
            case 10:
                ad adVar = (ad) this.d;
            ...
            case 11:
                ...
                ndVar.b0 = false;
                org.telegram.ui.Components.v80 v80Var = ndVar.P;
            ...
            case 12:
                ...
                AndroidUtilities.runOnUIThread(new pd(leVar, 5), 1000L);
                return;
            case 13:
                ((ab1) this.d).showDialog(le.d0((Context) this.b, (org.telegram.ui.ActionBar.f6) this.c, false));
                return;
            case 14:
                AndroidUtilities.runOnUIThread(new l4(21, (ua) this.c, ((bo) this.d).getMessagesStorage().getUser(((TLRPC.TL_contact) this.b).user_id)));
                return;
            case 15:
            ...
            case 17:
                ...
                n70Var.u();
                ek0 ek0Var = new ek0(boVar3.getParentActivity(), boVar3);
                ek0Var.v(str8, false);
                ek0Var.show();
                return;
            case 18:
                ...
                org.telegram.ui.Components.c5.T(boVar4.getParentActivity(), suggestedPost != null ? suggestedPost.schedule_date : 0L, new c7(boVar4, suggestedPost, (MessageObject) this.c, 5), boVar4.getResourceProvider(), 0).a.show();
                return;
            case 19:
            ...
            case 23:
                ...
                if (tLObject5 instanceof TLRPC.TL_photos_photo) {
                    ...
                    if ((tL_photos_photo.photo instanceof TLRPC.TL_photo) && user2 != null) {
                        ...
                        org.telegram.ui.Components.vc.a0(boVar6).V(Collections.singletonList(user2), AndroidUtilities.replaceTags(LocaleController.getString(R.string.ApplyAvatarHintTitle)), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ApplyAvatarHint), new ej(dmVar, 5)), null).j();
                    }
                }
