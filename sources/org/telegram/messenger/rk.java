...
public abstract /* synthetic */ class rk {
    ...
    public static org.telegram.ui.ActionBar.f3 j(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
    ...
    public static void p(int i10, org.telegram.ui.Components.xc xcVar, org.telegram.ui.ActionBar.f6 f6Var) {
        xcVar.t(LocaleController.getString(i10), f6Var).j();
    }
    ...
    public static void s(ViewPropertyAnimator viewPropertyAnimator, qr qrVar, long j3) {
    ...
    public static int x(float f7, int i10, int i11) {
        return i11 - (AndroidUtilities.dp(f7) + i10);
    }
