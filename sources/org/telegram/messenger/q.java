...
public abstract /* synthetic */ class q {
    ...
    public static int d(String str, String str2, SharedPreferences sharedPreferences, int i10) {
        return sharedPreferences.getInt(str + str2, i10);
    }

    public static SharedPreferences.Editor e(SharedPreferences.Editor editor, String str, String str2, String str3, String str4) {
    ...
    public static String i(long j3, char c10, StringBuilder sb2) {
        sb2.append(LocaleController.formatNumber(j3, c10));
        return sb2.toString();
    }

    public static String j(long j3, long j10, StringBuilder sb2) {
    ...
    public static void q(int i10, org.telegram.ui.Components.xc xcVar, int i11, int i12) {
        xcVar.Q(i11, i12, LocaleController.getString(i10)).j();
    }

    public static void r(TextView textView, int i10, int i11, float f7) {
        textView.setTextColor(i10);
        textView.setTextSize(i11, f7);
        textView.setTypeface(AndroidUtilities.bold());
    }

    public static void s(StringBuilder sb2, long j3) {
        sb2.append(j3);
        FileLog.d(sb2.toString());
    }
    ...
    public static void w(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String str4) {
        sQLiteDatabase.executeFast(str).stepThis().dispose();
        sQLiteDatabase.executeFast(str2).stepThis().dispose();
        sQLiteDatabase.executeFast(str3).stepThis().dispose();
    ...
    public static boolean x(String str, long j3, SharedPreferences sharedPreferences, boolean z10) {
