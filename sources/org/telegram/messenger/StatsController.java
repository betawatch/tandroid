...
public class StatsController extends BaseController {
    ...
    private StatsController(int i9) {
        ...
        this.saveRunnable = new Runnable() { // from class: org.telegram.messenger.StatsController.2
            ...
            public void run() {
                ...
                try {
                    ...
                    randomAccessFile.write(d0Var.a, 0, d0Var.b);
        ...
        SharedPreferences sharedPreferences = i9 == 0 ? ApplicationLoader.applicationContext.getSharedPreferences("stats", 0) : ApplicationLoader.applicationContext.getSharedPreferences("stats" + i9, 0);
        boolean z11 = false;
        for (int i13 = 0; i13 < 3; i13++) {
            this.callsTotalTime[i13] = sharedPreferences.getInt("callsTotalTime" + i13, 0);
            this.resetStatsDate[i13] = sharedPreferences.getLong("resetStatsDate" + i13, 0L);
            ...
            if (jArr2[i13] == 0) {
                jArr2[i13] = System.currentTimeMillis();
                z11 = true;
            }
        }
        if (z11) {
