...
public final /* synthetic */ class hi implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new gg.e1(tLObject, (org.telegram.ui.ActionBar.b2) obj5, (Context) obj4, this.b, (TL_phone.exportGroupCallInvite) obj3, (org.telegram.ui.ActionBar.d6) obj2, (r60) obj));
                break;
            case 3:
            ...
            case 4:
                ...
                AndroidUtilities.runOnUIThread(new gg.e1((LaunchActivity) obj5, tLObject, this.b, (ry) obj4, (org.telegram.ui.ActionBar.n2) obj3, (TLRPC.User) obj2, str));
                break;
            case 5:
                AndroidUtilities.runOnUIThread(new y5(tLObject, (org.telegram.ui.ActionBar.n2) obj5, (TLRPC.TL_inputStorePaymentPremiumSubscription) obj4, (ex0) obj3, (c5.f) obj2, this.b, tL_error, (TLRPC.TL_payments_canPurchaseStore) obj));
                break;
            default:
    ...
    public /* synthetic */ hi(Context context, org.telegram.ui.ActionBar.d6 d6Var, byte[] bArr, org.telegram.ui.ActionBar.n2 n2Var, oy oyVar, int i10) {
        this.a = 6;
        this.d = context;
        this.e = d6Var;
        this.f = bArr;
    ...
    public /* synthetic */ hi(org.telegram.ui.ActionBar.b2 b2Var, Context context, int i10, TL_phone.exportGroupCallInvite exportgroupcallinvite, org.telegram.ui.ActionBar.d6 d6Var, r60 r60Var) {
        this.a = 2;
        this.d = b2Var;
        this.e = context;
        this.b = i10;
    ...
    public /* synthetic */ hi(LaunchActivity launchActivity, int i10, ry ryVar, org.telegram.ui.ActionBar.n2 n2Var, TLRPC.User user, String str) {
        this.a = 4;
