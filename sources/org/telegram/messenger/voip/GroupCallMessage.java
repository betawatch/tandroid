...
public class GroupCallMessage {
    ...
    public final yg.p0 visibleReaction;
        ...
        if (arrayList != null && arrayList.size() == 1) {
            ...
            if (messageEntity instanceof TLRPC.TL_messageEntityCustomEmoji) {
                ...
                if (j11 == 0) {
                    ...
                    c10 = ((arrayList2 == null || arrayList2.isEmpty()) && (tL_availableReaction = MediaDataController.getInstance(i10).getReactionsMap().get(tL_textWithEntities.text)) != null) ? yg.p0.c(tL_availableReaction) : null;
                }
