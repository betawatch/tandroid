...
public class ConferenceCall {
    ...
    */
    private void checkParticipants() {
        ...
        if (j3 >= 0) {
            try {
                CallState call_get_state = call_get_state(j3);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$kick$12(long j3, TLObject tLObject, TLRPC.TL_error tL_error) {
        processUpdates(null, Long.valueOf(j3), tLObject, tL_error);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$kick$13(long j3, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new a(this, j3, tLObject, tL_error, 1));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$poll$7(TL_phone.getGroupCallChainBlocks getgroupcallchainblocks, long j3, TLObject tLObject, TLRPC.TL_error tL_error, AtomicBoolean atomicBoolean, AtomicInteger atomicInteger) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$poll$8(TL_phone.getGroupCallChainBlocks getgroupcallchainblocks, long j3, AtomicBoolean atomicBoolean, AtomicInteger atomicInteger, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new f(j3, atomicBoolean, atomicInteger, this, tLObject, tL_error, getgroupcallchainblocks));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$pull_outbound$5(long j3, TLObject tLObject, TLRPC.TL_error tL_error) {
        processUpdates(null, Long.valueOf(j3), tLObject, tL_error);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$pull_outbound$6(long j3, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new a(this, j3, tLObject, tL_error, 0));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$requestLastBlock$2(long j3, TLObject tLObject, TLRPC.TL_error tL_error, Runnable runnable) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$requestLastBlock$3(long j3, Runnable runnable, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new g(this, j3, tLObject, tL_error, runnable, 0));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateParticipants$10(long j3, TLObject tLObject, TLRPC.TL_error tL_error) {
        processUpdates(null, Long.valueOf(j3), tLObject, tL_error);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateParticipants$11(long j3, TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public void poll() {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.pollRequestId[i10] = ConnectionsManager.getInstance(this.currentAccount).sendRequest(getgroupcallchainblocks, new c(this, getgroupcallchainblocks, System.currentTimeMillis(), atomicBoolean, atomicInteger));
        }
        if (this.call_id >= 0) {
            try {
            ...
            try {
                ...
                sb2.append(TextUtils.join("\n ", (Iterable) DesugarArrays.stream(call_get_state(this.call_id).participants).map(new d()).collect(Collectors.toSet())));
    ...
    private boolean processUpdates(Integer num, Long l4, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Utilities.stageQueue.postRunnable(new m4.w(15, this, updates));
        return z10;
    }
    ...
    */
    private void pull_outbound() {
        ...
        int i11 = 0;
        try {
            byte[][] call_pull_outbound_messages = call_pull_outbound_messages(j3);
            ...
            while (i11 < call_pull_outbound_messages.length) {
                try {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(sendconferencecallbroadcast, new e(this, System.currentTimeMillis(), 1), 64);
                    i11++;
                    i10 = 1;
                } catch (Exception e) {
                    e = e;
    ...
    private void readQueue(int i10) {
        ...
        while (true) {
            ...
            if (bArr == null) {
                StringBuilder n10 = hc.b.n("[tde2e] {subchain: ", i10, "} got into hole (might be the end) in ", i10, " subchain at #");
                hc.b.w(n10, max, ", when our last_offset[", i10, "] = ");
                hc.b.q(this.last_offset[i10], n10);
    ...
    public boolean applyUpdate(Integer num, TL_update.TL_updateGroupCallChainBlocks tL_updateGroupCallChainBlocks, boolean z10, Long l4) {
        ...
        sb3.append(num);
        hc.b.v(l4 != null ? " in " + (System.currentTimeMillis() - l4.longValue()) + "ms" : "", sb3);
    ...
    public void kick(long j3) {
        ...
        if (this.call_id < 0 || !getBlockchainParticipants().contains(Long.valueOf(j3))) {
            return;
        }
    ...
    public void requestLastBlock(Runnable runnable) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(getgroupcallchainblocks, new h(this, currentTimeMillis, runnable, 0));
    }
