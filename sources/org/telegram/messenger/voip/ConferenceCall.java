...
public class ConferenceCall {
    ...
    */
    ...
    private boolean processUpdates(Integer num, Long l4, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Utilities.stageQueue.postRunnable(new ki.l(18, this, updates));
        return z10;
    }
    ...
    */
    ...
    public void requestLastBlock(Runnable runnable) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(getgroupcallchainblocks, new u1(this, currentTimeMillis, runnable, 1));
    }
