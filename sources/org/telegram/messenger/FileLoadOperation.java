                ...
                if (fileLoadOperation.streamPriorityStartOffset != 0 || fileLoadOperation.nextPartWasPreloaded || ((fileLoadOperation.isPreloadVideoOperation && fileLoadOperation.moovFound == 0) || fileLoadOperation.totalBytesCount <= 0)) {
                    ...
                    while (i12 < i11) {
                        ...
                        if (fileLoadOperation.streamPriorityStartOffset != j10) {
                            if (BuildVars.DEBUG_VERSION) {
                                l.d.x(new StringBuilder("frame get offset = "), fileLoadOperation.streamPriorityStartOffset);
                            }
                            j12 = j10;
                        ...
                        if ((inputFileLocation instanceof TLRPC.TL_inputPeerPhotoFileLocation) && ((TLRPC.TL_inputPeerPhotoFileLocation) inputFileLocation).photo_id == j12) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                ...
                                sb.append(i13);
                                sb.append(" priority=");
                                l.d.t(fileLoadOperation.priority, sb);
                            }
    ...
    */
    public boolean start(final FileLoadOperationStream fileLoadOperationStream, final long j10, final boolean z4) {
        ...
        if (this.webLocation != null) {
            ...
            if (this.encryptFile) {
                str4 = w.c.e(MD5, ".temp.enc");
                str = android.support.v4.media.a.r(w.c.f(MD5, "."), this.ext, ".enc");
                if (this.key != null) {
                    e6 = w.c.e(MD5, "_64.iv.enc");
                    String str5 = str4;
                    str2 = e6;
                    q10 = str5;
                    j11 = 0;
                ...
                String e10 = w.c.e(MD5, ".temp");
                StringBuilder f10 = w.c.f(MD5, ".");
                f10.append(this.ext);
            ...
            if (exists) {
                ...
                if (this.ungzip) {
                    this.cacheFileGzipTemp = new File(this.tempPath, w.c.e(q10, ".gz"));
                }
                if (this.encryptFile) {
                    File file = new File(FileLoader.getInternalCacheDir(), w.c.e(str, ".key"));
                    try {
