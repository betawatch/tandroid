            ...
            for (int i11 = 0; i11 < this.requestInfos.size(); i11++) {
                ...
                if (requestInfo.requestToken != 0) {
                    ...
                    if (runnable == null) {
                        ...
                        f0.n(requestInfo.requestToken, new StringBuilder("cancelRequests cancel "));
    ...
    */
    ...
    public /* synthetic */ void lambda$startDownloadRequest$29(RequestInfo requestInfo, int i10, int i11, TLObject tLObject, TLObject tLObject2, TLRPC.TL_error tL_error) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            ...
            sb2.append(i11);
            sb2.append(" reqId");
            f0.n(requestInfo.requestToken, sb2);
        }
        ...
        if (this.state == 1 || this.state == 5) {
            ...
            if (BuildVars.DEBUG_VERSION) {
                if (i10 == 1) {
                    ...
                    sb2.append(" prefSize=");
                    f0.n(this.preloadPrefixSize, sb2);
                }
            }
    ...
    private void requestFileOffsets(long j3) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_upload_getCdnFileHashes, new h0(this, 2), null, null, 0, this.datacenterId, 1, true);
    }
                    ...
                    while (i12 < i11) {
                        ...
                        if ((inputFileLocation instanceof TLRPC.TL_inputPeerPhotoFileLocation) && ((TLRPC.TL_inputPeerPhotoFileLocation) inputFileLocation).photo_id == j11) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                ...
                                sb2.append(i13);
                                sb2.append(" priority=");
                                f0.n(fileLoadOperation.priority, sb2);
                            }
