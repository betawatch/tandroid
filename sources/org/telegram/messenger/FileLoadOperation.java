            ...
            for (int i11 = 0; i11 < this.requestInfos.size(); i11++) {
                ...
                if (requestInfo.requestToken != 0) {
                    ...
                    if (runnable == null) {
                        ...
                        l0.m(requestInfo.requestToken, new StringBuilder("cancelRequests cancel "));
    ...
    */
    ...
    public /* synthetic */ void lambda$startDownloadRequest$29(RequestInfo requestInfo, int i10, int i11, TLObject tLObject, TLObject tLObject2, TLRPC.TL_error tL_error) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            ...
            sb2.append(i11);
            sb2.append(" reqId");
            l0.m(requestInfo.requestToken, sb2);
        }
        ...
        if (this.state == 1 || this.state == 5) {
            ...
            if (BuildVars.DEBUG_VERSION) {
                if (i10 == 1) {
                    ...
                    sb2.append(" prefSize=");
                    l0.m(this.preloadPrefixSize, sb2);
                }
            }
            if (this.fileMetadata != null) {
                if (this.cacheFileTemp != null) {
                    FileLoader.getInstance(this.currentAccount).getFileDatabase().removeFiles(Collections.singletonList(new zh.a(this.cacheFileTemp)));
                }
                if (this.cacheFileParts != null) {
                    FileLoader.getInstance(this.currentAccount).getFileDatabase().removeFiles(Collections.singletonList(new zh.a(this.cacheFileParts)));
                }
            }
            this.delegate.didPreFinishLoading(this, this.cacheFileFinal);
            this.delegate.didFinishLoadingFile(this, this.cacheFileFinal);
                ...
                if (fileLoadOperation.streamPriorityStartOffset != 0 || fileLoadOperation.nextPartWasPreloaded || ((fileLoadOperation.isPreloadVideoOperation && fileLoadOperation.moovFound == 0) || fileLoadOperation.totalBytesCount <= 0)) {
                    ...
                    while (i12 < i11) {
                        ...
                        if (fileLoadOperation.streamPriorityStartOffset != j3) {
                            if (BuildVars.DEBUG_VERSION) {
                                hg.k0.u(new StringBuilder("frame get offset = "), fileLoadOperation.streamPriorityStartOffset);
                            }
                            j11 = j3;
                        ...
                        if ((inputFileLocation instanceof TLRPC.TL_inputPeerPhotoFileLocation) && ((TLRPC.TL_inputPeerPhotoFileLocation) inputFileLocation).photo_id == j11) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                ...
                                sb2.append(i13);
                                sb2.append(" priority=");
                                l0.m(fileLoadOperation.priority, sb2);
                            }
    ...
    */
    public boolean start(final FileLoadOperationStream fileLoadOperationStream, final long j3, final boolean z10) {
        ...
        if (this.webLocation != null) {
            ...
            if (this.encryptFile) {
                str4 = v7.j0.s(MD5, ".temp.enc");
                str = a4.a.s(v7.j0.h(MD5, "."), this.ext, ".enc");
                if (this.key != null) {
                    s10 = v7.j0.s(MD5, "_64.iv.enc");
                    String str5 = str4;
                    str2 = s10;
                    r10 = str5;
                    j10 = 0;
                ...
                String s11 = v7.j0.s(MD5, ".temp");
                StringBuilder h = v7.j0.h(MD5, ".");
                h.append(this.ext);
                String sb2 = h.toString();
                if (this.key != null) {
                    s10 = v7.j0.s(MD5, "_64.iv");
                    str4 = s11;
                    str = sb2;
                    String str522 = str4;
                    str2 = s10;
            ...
            if (exists) {
                ...
                if (this.ungzip) {
                    this.cacheFileGzipTemp = new File(this.tempPath, v7.j0.s(r10, ".gz"));
                }
                if (this.encryptFile) {
                    File file = new File(FileLoader.getInternalCacheDir(), v7.j0.s(str, ".key"));
                    try {
