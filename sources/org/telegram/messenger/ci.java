...
public final /* synthetic */ class ci implements Runnable {
    ...
    public /* synthetic */ ci(Object obj, Object obj2, long j10, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
        this.d = j10;
    ...
    */
    public final void run() {
        ...
        switch (i12) {
            ...
            case 3:
                ...
                new lh.s0(context, i14, this.d, messageSuggestionParams, xnVar, f6Var, 0, new kh.a1(28, liVar, xnVar)).show();
                return;
            case 4:
                w21 w21Var = (w21) obj3;
            ...
            case 6:
                ...
                if (dialogFilter == null || !oyVar.g4(dialog)) {
                ...
                long j11 = this.d;
                TLRPC.EncryptedChat n10 = DialogObject.isEncryptedDialog(j11) ? y3.n(oyVar.getMessagesController(), j11) : null;
                UndoView Y3 = oyVar.Y3();
                if (Y3 == null) {
                    return;
                }
                if (oyVar.g4(dialog)) {
                    oyVar.s4(j11, false, dialogFilter, i10, true);
                    Y3.k(0L, 79, 1, 1600, null, null);
                } else {
                    oyVar.s4(j11, true, dialogFilter, i10, true);
                ...
                if (dialogFilter != null) {
                    b10.t0(dialogFilter, dialogFilter.flags, dialogFilter.name, dialogFilter.entities, dialogFilter.title_noanimate, dialogFilter.color, dialogFilter.alwaysShow, dialogFilter.neverShow, dialogFilter.pinnedDialogs, false, false, true, true, false, oyVar, null);
                }
                oyVar.getMessagesController().reorderPinnedDialogs(oyVar.S2, null, 0L);
                oyVar.T4(true);
                if (oyVar.b0 != null) {
                    int i18 = 0;
                    while (true) {
                        ...
                        if (i18 < nyVarArr.length) {
                            nyVarArr[i18].d.E = false;
                            i18++;
                        }
                    }
                }
                oyVar.g5(MessagesController.UPDATE_MASK_REORDER | MessagesController.UPDATE_MASK_CHECK, true);
                return;
            case 7:
                c60 c60Var = (c60) obj3;
                ...
                if (call == null || c60Var.p0) {
                    return;
                }
                call.addInvitedUser(j10);
                c60Var.O0(true);
                t30 t30Var = c60Var.B1;
                if (t30Var != null) {
                    t30Var.dismiss();
                }
                try {
                ...
                d2VarArr[0] = null;
                c60Var.k1().k(0L, 34, user2, c60Var.W0, null, null);
                return;
            case 8:
            ...
            case 9:
                qa0 qa0Var = (qa0) obj3;
                LaunchActivity launchActivity = qa0Var.g;
                ...
                if (((String) obj2) != null) {
                    ...
                    if (messagesController2.getGroupCall(j13, false) != null) {
                        ...
                        org.telegram.ui.Components.voip.f2.m(chat2, null, false, Boolean.valueOf(!r0.call.rtmp_stream), launchActivity, p2Var, accountInstance);
                        return;
                    }
                    TLRPC.ChatFull chatFull = accountInstance.getMessagesController().getChatFull(j13);
                    if (chatFull != null) {
                        if (chatFull.call != null) {
                            accountInstance.getMessagesController().getGroupCall(j13, true, new pa0(qa0Var, accountInstance, j12, p2Var, 0));
                            return;
                        } else {
                            if (p2Var.getParentActivity() != null) {
                                kh.a2.v(R.string.InviteExpired, org.telegram.ui.Components.qc.a0(p2Var), R.raw.linkbroken, 36);
                                return;
                            }
                            return;
                        }
            ...
            case 10:
                ...
                if (photoViewer.A2) {
                    ...
                    AndroidUtilities.getBitmapFromSurface(photoViewer.z2, createBitmap, new zq0(0, y0Var, createBitmap));
                    return;
                }
            ...
            case 11:
                ...
                if (loadChatInfoInQueue == null || (chatParticipants = loadChatInfoInQueue.participants) == null || ((arrayList = chatParticipants.participants) != null && arrayList.size() < loadChatInfoInQueue.participants_count - 1)) {
                    AndroidUtilities.runOnUIThread(new lh.pa(z7Var, isChannel, j15, 5));
                    return;
                } else {
                    AndroidUtilities.runOnUIThread(new hv0(z7Var, j15, loadChatInfoInQueue, 1));
                    return;
                }
            case 12:
                            ...
                            try {
                                try {
                                    ...
                                    try {
                                        ...
                                        AndroidUtilities.runOnUIThread(new s61(p1Var, arrayList7, arrayList8, arrayList2, runnable, 4));
                                        return;
                                    } catch (Throwable th2) {
                                        th = th2;
                                        if (sQLiteCursor != null) {
            ...
            default:
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new s61(p1Var3, arrayList11, arrayList12, o1Var3, messageObject, 5));
                    queryFinalized.dispose();
                    return;
                } catch (Exception e19) {
                    e = e19;
    ...
    public /* synthetic */ ci(Object obj, Object obj2, Object obj3, long j10, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = obj2;
        this.e = obj3;
    ...
    public /* synthetic */ ci(org.telegram.ui.ActionBar.g3 g3Var, long j10, Object obj, Object obj2, int i10) {
        this.a = i10;
        this.b = g3Var;
        this.d = j10;
        this.c = obj;
    ...
    public /* synthetic */ ci(ph.z7 z7Var, TLRPC.Chat chat, MessagesStorage messagesStorage, long j10) {
        this.a = 11;
        this.b = z7Var;
        this.e = chat;
