...
public class VideoEditedInfo {
    ...
    public String getString() {
        ...
        if (this.avatarStartTime == -1 && this.filterState == null && this.paintPath == null && this.blurPath == null && (((arrayList = this.mediaEntities) == null || arrayList.isEmpty()) && this.cropState == null)) {
            ...
            if (this.filterState != null) {
                ...
                int i11 = 0;
                while (i11 < 4) {
                    of0 of0Var = i11 == 0 ? this.filterState.curvesToolValue.a : i11 == 1 ? this.filterState.curvesToolValue.b : i11 == 2 ? this.filterState.curvesToolValue.c : this.filterState.curvesToolValue.d;
                    serializedData.writeFloat(of0Var.a);
                    serializedData.writeFloat(of0Var.b);
                    serializedData.writeFloat(of0Var.c);
                    serializedData.writeFloat(of0Var.d);
                    serializedData.writeFloat(of0Var.e);
                    i11++;
                }
            } else {
                ...
                if (split[12].startsWith("-")) {
                    ...
                    if (substring.length() > 0) {
                        ...
                        if (serializedData.readByte(false) != 0) {
                            ...
                            while (i11 < 4) {
                                of0 of0Var = i11 == 0 ? this.filterState.curvesToolValue.a : i11 == 1 ? this.filterState.curvesToolValue.b : i11 == 2 ? this.filterState.curvesToolValue.c : this.filterState.curvesToolValue.d;
                                of0Var.a = serializedData.readFloat(false);
                                of0Var.b = serializedData.readFloat(false);
                                of0Var.c = serializedData.readFloat(false);
                                of0Var.d = serializedData.readFloat(false);
                                of0Var.e = serializedData.readFloat(false);
                                i11++;
                            }
                        }
                        if (serializedData.readByte(false) != 0) {
                        ...
                        if (readInt32 >= 11 && serializedData.readInt32(false) == -559038737) {
                            ...
                            for (int i13 = 0; i13 < this.collage.e.size(); i13++) {
                                Part part = new Part();
                                part.part = (ci.s) this.collage.e.get(i13);
    ...
    public static class Part extends TLObject {
        ...
        public static ArrayList<Part> toParts(ci.o8 o8Var) {
            if (o8Var == null || o8Var.T == null) {
                return null;
            }
            ArrayList<Part> arrayList = new ArrayList<>();
            for (int i10 = 0; i10 < o8Var.T.size(); i10++) {
                Part part = new Part((ci.o8) o8Var.T.get(i10));
                part.part = (ci.s) o8Var.S.e.get(i10);
                arrayList.add(part);
            }
            return arrayList;
        }

        public static ArrayList<ci.o8> toStoryEntries(ArrayList<Part> arrayList) {
            if (arrayList == null) {
                return null;
            }
            ArrayList<ci.o8> arrayList2 = new ArrayList<>();
        ...
        public MediaEntity(AbstractSerializedData abstractSerializedData, boolean z10, boolean z11) {
            ...
            if (readString != null && !TextUtils.isEmpty(readString)) {
                ...
                for (int i11 = 0; i11 < c10.size(); i11++) {
                    ...
                    if (k0Var != null && TextUtils.equals(readString, k0Var.a)) {
                        break;
                    }
                }
            }
