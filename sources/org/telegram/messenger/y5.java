...
public final /* synthetic */ class y5 implements Runnable {
    ...
    public /* synthetic */ y5(int i10, File file, String str, org.telegram.ui.ActionBar.c2 c2Var, boolean[] zArr, String str2, Utilities.Callback callback, boolean[] zArr2) {
        this.c = i10;
        this.f = file;
        this.d = str;
        this.b = c2Var;
            ...
            case 1:
                ...
                if (tLObject != null) {
                    ...
                    if (AndroidUtilities.isTablet()) {
                        ...
                        externalActionActivity.c.c(-1, qn0Var);
                    }
                    if (!AndroidUtilities.isTablet()) {
    ...
    public /* synthetic */ y5(TLObject tLObject, org.telegram.ui.ActionBar.o2 o2Var, TLRPC.TL_inputStorePaymentPremiumSubscription tL_inputStorePaymentPremiumSubscription, nx0 nx0Var, c5.f fVar, int i10, TLRPC.TL_error tL_error, TLRPC.TL_payments_canPurchaseStore tL_payments_canPurchaseStore) {
        this.f = tLObject;
        this.d = o2Var;
    ...
    public /* synthetic */ y5(ExternalActionActivity externalActionActivity, org.telegram.ui.ActionBar.c2 c2Var, TLObject tLObject, int i10, TL_account.authorizationForm authorizationform, TL_account.getAuthorizationForm getauthorizationform, String str, String str2) {
