...
public final /* synthetic */ class rj implements Runnable {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                if (n1Var != null && xnVar.fragmentView != null && !n1Var.isShowing() && AndroidUtilities.isActivityRunning(xnVar.getParentActivity())) {
                    xnVar.Q8.showAtLocation(xnVar.x0, 51, this.b, this.c);
    ...
    public /* synthetic */ rj(xn xnVar, int i10, int i11, boolean z10, gk0 gk0Var) {
        this.e = xnVar;
        this.b = i10;
        this.c = i11;
        this.d = z10;
    ...
    public /* synthetic */ rj(org.telegram.ui.Components.ac acVar, zg.p0 p0Var, boolean z10, int i10, int i11) {
        this.e = acVar;
        this.f = p0Var;
        this.d = z10;
        this.b = i10;
