...
public final /* synthetic */ class xi implements Runnable {
    ...
    public /* synthetic */ xi(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, boolean z10, boolean z11, TLRPC.Message message, ArrayList arrayList2, ArrayList arrayList3, int i10) {
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            default:
                ...
                TLRPC.User user = MessagesController.getInstance(i10).getUser(Long.valueOf(naVar.g0()));
                naVar.getMessagesController().updateUsernameActiveness(user, tL_username2.username, tL_username2.active);
                if (naVar.x != 0 && arrayList2 != null) {
    ...
    public /* synthetic */ xi(org.telegram.ui.ca caVar, String str, TLObject tLObject, int i10, boolean z10, TLRPC.TL_error tL_error, TLRPC.TL_username tL_username, boolean z11) {
        this.e = caVar;
        this.f = str;
        this.h = tLObject;
        this.b = i10;
