...
public final /* synthetic */ class tf implements Runnable {
    ...
    public /* synthetic */ tf(int i10, int i11, long j10, long j11, MessagesStorage messagesStorage, TLRPC.InputChannel inputChannel) {
    ...
    */
    public final void run() {
        ...
        switch (i11) {
            case 0:
                ...
                return;
            default:
                final org.telegram.ui.Cells.d6 d6Var = (org.telegram.ui.Cells.d6) obj;
                long j11 = this.e;
                ...
                if (i12 <= 0) {
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                final int i14 = i10;
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.c6
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        d6.b(d6.this, i13, arrayList, j12, i14, messagesStorage);
                                    }
                                });
                                return;
                            } catch (Throwable th2) {
                    ...
                    try {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.c6
                            @Override // java.lang.Runnable
                            public final void run() {
                                d6.b(d6.this, i132, arrayList, j12, i142, messagesStorage);
                            }
                        });
                        return;
                    } catch (Throwable th4) {
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.c6
                        @Override // java.lang.Runnable
                        public final void run() {
                            d6.b(d6.this, i1322, arrayList, j12, i1422, messagesStorage);
                        }
                    });
                    return;
                } catch (Throwable th5) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.c6
                    @Override // java.lang.Runnable
                    public final void run() {
                        d6.b(d6.this, i13222, arrayList, j12, i14222, messagesStorage);
                    }
                });
                return;
        }
    ...
    public /* synthetic */ tf(org.telegram.ui.Cells.d6 d6Var, int i10, MessagesStorage messagesStorage, long j10, long j11, int i11) {
        this.h = d6Var;
        this.b = i10;
        this.c = messagesStorage;
        this.d = j10;
