...
public abstract /* synthetic */ class a2 {
    ...
    public static void o(int i10, org.telegram.ui.Components.wc wcVar, int i11, int i12) {
        wcVar.Q(i11, i12, LocaleController.getString(i10)).j();
    }

    public static void p(int i10, org.telegram.ui.Components.wc wcVar, org.telegram.ui.ActionBar.f6 f6Var) {
        wcVar.t(LocaleController.getString(i10), f6Var).j();
    }
