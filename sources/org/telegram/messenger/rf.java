...
public final /* synthetic */ class rf implements Runnable {
    ...
    public /* synthetic */ rf(int i10, int i11, long j3, long j10, MessagesStorage messagesStorage, TLRPC.InputChannel inputChannel) {
    ...
    */
            ...
            default:
                ...
                if (i12 <= 0) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.e6
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        f6.b(f6.this, i13, arrayList, j11, i14, messagesStorage);
                                    }
                                });
                                return;
                            } catch (Throwable th2) {
                    ...
                    try {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.e6
                            @Override // java.lang.Runnable
                            public final void run() {
                                f6.b(f6.this, i132, arrayList, j11, i142, messagesStorage);
                            }
                        });
                        return;
                    } catch (Throwable th4) {
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.e6
                        @Override // java.lang.Runnable
                        public final void run() {
                            f6.b(f6.this, i1322, arrayList, j11, i1422, messagesStorage);
                        }
                    });
                    return;
                } catch (Throwable th5) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Cells.e6
                    @Override // java.lang.Runnable
                    public final void run() {
                        f6.b(f6.this, i13222, arrayList, j11, i14222, messagesStorage);
                    }
                });
                return;
        }
    ...
    public /* synthetic */ rf(org.telegram.ui.Cells.f6 f6Var, int i10, MessagesStorage messagesStorage, long j3, long j10, int i11) {
        this.h = f6Var;
        this.b = i10;
        this.c = messagesStorage;
        this.d = j3;
