...
public class TranslateController extends BaseController {
    ...
    private void checkDialogTranslatable(MessageObject messageObject) {
        ...
        if (size3 < (isChatAutoTranslated(dialogId) ? 2 : 8) || size / (size + r2) < REQUIRED_PERCENTAGE_MESSAGES_TRANSLATABLE || size2 / size3 >= REQUIRED_MIN_PERCENTAGE_MESSAGES_UNKNOWN) {
            return;
        }
