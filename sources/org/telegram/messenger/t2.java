...
public final /* synthetic */ class t2 implements RequestDelegate {
    ...
    public /* synthetic */ t2(Object obj, Object obj2, int i10, int i11, TLObject tLObject, int i12) {
        this.a = i12;
        this.d = obj;
        this.e = obj2;
        this.b = i10;
            ...
            case 1:
                ...
                if (tL_error == null) {
                    ...
                    for (int i12 = 0; i12 < messages_messages.messages.size(); i12++) {
                        MessageObject messageObject = new MessageObject(a0Var.o0, messages_messages.messages.get(i12), hVar2, hVar, false, true);
                        arrayList.add(messageObject);
                        messageObject.setQuery(str);
                    }
                }
                AndroidUtilities.runOnUIThread(new n7(a0Var, this.b, this.c, tL_error, str, tLObject, tL_messages_search, arrayList, 1));
                break;
            default:
                ...
                if (tL_error == null) {
                    ...
                    for (int i16 = 0; i16 < messages_messages2.messages.size(); i16++) {
                        MessageObject messageObject2 = new MessageObject(a0Var2.o0, messages_messages2.messages.get(i16), hVar4, hVar3, false, true);
                ...
                n7 n7Var = new n7(a0Var2, this.b, this.c, tL_error, str2, tLObject, tL_messages_searchGlobal, arrayList2, 2);
                if (hashSet.isEmpty()) {
