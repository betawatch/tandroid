...
public final /* synthetic */ class r1 implements Runnable {
    ...
    */
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                RLottieNative[] rLottieNativeArr2 = hv0Var.e1;
                int[] iArr = hv0Var.e;
                if (hv0Var.S0) {
                ...
                while (true) {
                    ...
                    if (i22 >= length) {
                        if (z11) {
                            ...
                            AndroidUtilities.runOnUIThread(new org.telegram.messenger.voip.j0(hv0Var, this.d, i23, s1Var));
                            return;
                        }
                    }
                    if (i22 <= 2) {
                        if (rLottieNativeArr2[i22] == null) {
                            ...
                            if (TextUtils.isEmpty(readRes)) {
                                ...
                                if (i22 <= 2) {
                                    ...
                                    hv0Var.f1[i22] = iArr[0];
                                } else {
                                    rLottieNativeArr[i22 == 3 ? (char) 0 : (char) 4] = b10;
                                    hv0Var.c1[i22 == 3 ? (char) 0 : (char) 4] = iArr[0];
                                }
                            } else {
                                AndroidUtilities.runOnUIThread(new gv0(document, i23, messageObject, s1Var, tL_messages_stickerSet, 0));
                                z11 = true;
                            }
                        }
            ...
            case 4:
                ...
                HashMap hashMap = aq0Var.h;
                ArrayList arrayList = aq0Var.f;
                ArrayList arrayList2 = aq0Var.n;
                ...
                if (tLObject != null) {
                    ...
                    aq0Var.w = messages_botresults.next_offset;
                    ...
                    aq0Var.s = size2 == arrayList.size() || aq0Var.w == null;
                } else {
                    i11 = 0;
                }
                aq0Var.r = false;
                if (i11 != 0) {
                    aq0Var.H.s(size2, i11);
                } else if (aq0Var.s) {
                    z10 = true;
                ...
                break;
            default:
                final rh.p3 p3Var = (rh.p3) this.e;
                Uri uri = (Uri) this.c;
                        ...
                        try {
                            ...
                            if (extractMetadata2 != null) {
                                try {
                                    ...
                                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: rh.n2
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            p3 p3Var2 = p3.this;
                                            p3Var2.getClass();
    ...
    public /* synthetic */ r1(hv0 hv0Var, TLRPC.TL_messages_stickerSet tL_messages_stickerSet, int i10, MessageObject messageObject, org.telegram.ui.Cells.s1 s1Var, boolean z10) {
        this.e = hv0Var;
    ...
    public /* synthetic */ r1(aq0 aq0Var, String str, int i10, TLObject tLObject, boolean z10, TLRPC.User user) {
        this.e = aq0Var;
        this.c = str;
        this.b = i10;
        this.f = tLObject;
    ...
    public /* synthetic */ r1(rh.p3 p3Var, Uri uri, boolean z10, String str, int i10, rh.a aVar) {
        this.e = p3Var;
        this.c = uri;
        this.d = z10;
        this.f = str;
