...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_MEDIUM(new long[]{7}, new int[]{NotificationCenter.fileNewChunkAvailable}, new long[]{70}),
    IMPACT_HEAVY(new long[]{7}, new int[]{NotificationCenter.didReceiveSmsCode}, new long[]{80}),
    IMPACT_RIGID(new long[]{3}, new int[]{NotificationCenter.botStarsUpdated}, new long[]{50}),
    IMPACT_SOFT(new long[]{10}, new int[]{NotificationCenter.groupCallVisibilityChanged}, new long[]{55}),
    NOTIFICATION_ERROR(new long[]{14, 48, 14, 48, 14, 48, 20}, new int[]{NotificationCenter.dialogPhotosUpdate, 0, NotificationCenter.dialogPhotosUpdate, 0, NotificationCenter.didReceiveSmsCode, 0, NotificationCenter.fileNewChunkAvailable}, new long[]{40, 60, 40, 60, 65, 60, 40}),
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{NotificationCenter.groupCallVisibilityChanged, 0, NotificationCenter.didReceiveSmsCode}, new long[]{50, 60, 65}),
    NOTIFICATION_WARNING(new long[]{14, 64, 14}, new int[]{NotificationCenter.botStarsUpdated, 0, NotificationCenter.groupCallVisibilityChanged}, new long[]{65, 60, 40}),
