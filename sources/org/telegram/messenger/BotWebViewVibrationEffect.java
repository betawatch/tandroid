...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_HEAVY(new long[]{7}, new int[]{NotificationCenter.didReceiveCall}, new long[]{80}),
    ...
    NOTIFICATION_ERROR(new long[]{14, 48, 14, 48, 14, 48, 20}, new int[]{NotificationCenter.dialogPhotosUpdate, 0, NotificationCenter.dialogPhotosUpdate, 0, NotificationCenter.didReceiveCall, 0, NotificationCenter.fileNewChunkAvailable}, new long[]{40, 60, 40, 60, 65, 60, 40}),
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{NotificationCenter.groupCallVisibilityChanged, 0, NotificationCenter.didReceiveCall}, new long[]{50, 60, 65}),
