...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_HEAVY(new long[]{7}, new int[]{NotificationCenter.cameraInitied}, new long[]{80}),
    ...
    NOTIFICATION_ERROR(new long[]{14, 48, 14, 48, 14, 48, 20}, new int[]{NotificationCenter.channelRecommendationsLoaded, 0, NotificationCenter.channelRecommendationsLoaded, 0, NotificationCenter.cameraInitied, 0, NotificationCenter.filePreparingFailed}, new long[]{40, 60, 40, 60, 65, 60, 40}),
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{NotificationCenter.liveStoryUpdated, 0, NotificationCenter.cameraInitied}, new long[]{50, 60, 65}),
