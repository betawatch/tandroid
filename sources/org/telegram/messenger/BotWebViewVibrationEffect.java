...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_HEAVY(new long[]{7}, new int[]{NotificationCenter.didApplyNewTheme}, new long[]{80}),
    IMPACT_RIGID(new long[]{3}, new int[]{NotificationCenter.updateAllMessages}, new long[]{50}),
    IMPACT_SOFT(new long[]{10}, new int[]{NotificationCenter.configLoaded}, new long[]{55}),
    NOTIFICATION_ERROR(new long[]{14, 48, 14, 48, 14, 48, 20}, new int[]{NotificationCenter.userIsPremiumBlockedUpadted, 0, NotificationCenter.userIsPremiumBlockedUpadted, 0, NotificationCenter.didApplyNewTheme, 0, NotificationCenter.filePreparingFailed}, new long[]{40, 60, 40, 60, 65, 60, 40}),
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{NotificationCenter.configLoaded, 0, NotificationCenter.didApplyNewTheme}, new long[]{50, 60, 65}),
    NOTIFICATION_WARNING(new long[]{14, 64, 14}, new int[]{NotificationCenter.updateAllMessages, 0, NotificationCenter.configLoaded}, new long[]{65, 60, 40}),
