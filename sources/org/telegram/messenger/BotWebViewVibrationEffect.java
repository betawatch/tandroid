...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_HEAVY(new long[]{7}, new int[]{NotificationCenter.needCheckSystemBarColors}, new long[]{80}),
    ...
    NOTIFICATION_ERROR(new long[]{14, 48, 14, 48, 14, 48, 20}, new int[]{NotificationCenter.savedMessagesForwarded, 0, NotificationCenter.savedMessagesForwarded, 0, NotificationCenter.needCheckSystemBarColors, 0, NotificationCenter.messagePlayingProgressDidChanged}, new long[]{40, 60, 40, 60, 65, 60, 40}),
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{NotificationCenter.newEmojiSuggestionsAvailable, 0, NotificationCenter.needCheckSystemBarColors}, new long[]{50, 60, 65}),
