...
public enum BotWebViewVibrationEffect {
    ...
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{175, 0, NotificationCenter.didReceiveSmsCode}, new long[]{50, 60, 65}),
    NOTIFICATION_WARNING(new long[]{14, 64, 14}, new int[]{NotificationCenter.botStarsUpdated, 0, 175}, new long[]{65, 60, 40}),
