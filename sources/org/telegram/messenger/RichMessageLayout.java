...
public class RichMessageLayout {
    ...
    public static class PreviewView extends View implements org.telegram.ui.Cells.m9 {
        ...
        public static final class Factory extends k41 {
            ...
            public void bindView(View view, l41 l41Var, boolean z10, z41 z41Var, i51 i51Var) {
                ...
                previewView.setTranslationLoading(l41Var.e);
            }

            @Override // org.telegram.ui.Components.k41
            public boolean contentsEquals(l41 l41Var, l41 l41Var2) {
                return l41Var.d == l41Var2.d && l41Var.G == l41Var2.G && l41Var.e == l41Var2.e;
            }
    ...
    public static abstract class RichBlock implements cj0 {
        ...
        private boolean canToggleCheckbox() {
            return (this.checkbox == null || this.checkboxItem == null || this.root.getCell() == null || this.root.getDelegate() == null || !this.root.getDelegate().X(this.root.getCell())) ? false : true;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ int lambda$withReplacements$0(Spanned spanned, org.telegram.ui.Cells.t9 t9Var, org.telegram.ui.Cells.t9 t9Var2) {
        ...
        public static CharSequence withReplacements(CharSequence charSequence) {
            ...
            for (org.telegram.ui.Cells.t9 t9Var : t9VarArr) {
                ...
                if (spanStart >= 0 && spanEnd >= 0 && spanStart <= spanEnd && spanEnd <= spannableStringBuilder.length()) {
                    CharSequence charSequence2 = t9Var.a;
        ...
        public void drawWithTyping(Canvas canvas) {
            ...
            if (ej0Var != null && ej0Var.h && ej0Var.d(this) >= 0) {
                ...
                if (ej0Var.g(this)) {
                    draw(canvas, ej0Var.g(this) ? ej0Var.e : -1, ej0Var.g(this) ? ej0Var.f : 0.0f);
                    return;
                }
        ...
        public final void getAccessibilityElementBounds(int i9, Rect rect) {
            ...
            int min = Math.min(minWidth, Math.max(rect.left, i11));
            rect.left = min;
        ...
        public CharSequence getAccessibilityLabel() {
            ...
            String string = i9 == 0 ? null : LocaleController.getString(i9);
            int i10 = this.accessibilityLabelResId;
            String string2 = i10 != 0 ? LocaleController.getString(i10) : null;
        ...
        public final boolean isAccessibilityElementCheckbox(int i9) {
            return this.checkbox != null && i9 == 0;
        }

        public final boolean isAccessibilityElementChecked(int i9) {
            return isAccessibilityElementCheckbox(i9) && getCheckboxChecked();
        }

        public final boolean isAccessibilityElementClickable(int i9) {
            return !isAccessibilityElementCheckbox(i9) || canToggleCheckbox();
        }

        public final boolean isAccessibilityElementText(int i9) {
            return !isAccessibilityElementCheckbox(i9) && isBlockAccessibilityElementText(i9 - getCheckboxAccessibilityElementCount());
        }
        ...
        public void setNum(String str) {
            ...
            str2 = str;
            int i9 = this.listMarkerWidth;
            if (i9 <= 0) {
                i9 = Math.max(this.root.isRtl() ? this.padding.right : this.padding.left, AndroidUtilities.dp(this.root.fontSize + 4));
            }
            int i10 = i9;
            RichMessageLayout richMessageLayout = this.root;
            this.numLayout = new StaticLayout(str2, richMessageLayout.numTextPaint, i10, richMessageLayout.isRtl() ? Layout.Alignment.ALIGN_NORMAL : Layout.Alignment.ALIGN_OPPOSITE, 1.0f, 0.0f, false);
            this.numLayoutLeft = AndroidUtilities.dp(this.root.fontSize + 4);
            this.numLayoutRight = 0;
            for (int i11 = 0; i11 < this.numLayout.getLineCount(); i11++) {
                this.numLayoutLeft = Math.min(this.numLayoutLeft, (int) this.numLayout.getLineLeft(i11));
                this.numLayoutRight = Math.max(this.numLayoutRight, (int) this.numLayout.getLineRight(i11));
            }
            updateListMarkerY();
        }
        ...
        public boolean drawOverlay(Canvas canvas, ColorFilter colorFilter) {
            ...
            for (org.telegram.ui.Cells.y9 y9Var : text2) {
                if ((y9Var instanceof Text) && (p5Var = (text = (Text) y9Var).animatedEmojiStack) != null && !p5Var.a.isEmpty()) {
                    canvas.save();
    ...
    public static class RichButton {
        ...
        private static int getButtonIcon(TL_keyboard.InlineButtonType inlineButtonType) {
            ...
            if (inlineButtonType instanceof TL_keyboard.TL_inlineButtonTypeUrl) {
                return kb0.l(((TL_keyboard.TL_inlineButtonTypeUrl) inlineButtonType).url) ? R.drawable.bot_webview : R.drawable.mini_inline_arrow_16;
            }
        ...
        public boolean contains(float f10) {
            int i9 = this.x;
            return f10 >= ((float) i9) && f10 <= ((float) (i9 + this.width));
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (this.layout.isOverlayActive()) {
                canvas2.translate(0.0f, AndroidUtilities.dp(z13 ? 0.0f : this.link ? 0.66f : 2.0f));
                if (this.link) {
                    int i9 = this.text.layout.getPaint().linkColor;
                    if (this.lastLinkColorFilterColor != i9 || this.linkColorFilter == null) {
                        this.lastLinkColorFilterColor = i9;
                        this.linkColorFilter = new PorterDuffColorFilter(i9, PorterDuff.Mode.SRC_IN);
                    }
                    Text text = this.text;
                    f10 = 0.0f;
                    f11 = 2.0f;
            ...
            if (drawable != null) {
                ff.s.d(drawable, this.width - AndroidUtilities.dp(ICON_OFFSET_X), AndroidUtilities.dp(this.inline ? ICON_OFFSET_Y_INLINE : ICON_OFFSET_Y), 17);
        ...
        public float getPressScale() {
            ...
            return e2.c.z(1.0f, this.pressT, f11, 1.0f - f11);
        }
        ...
        public void setLoading(boolean z10) {
            ...
            if (z10) {
                ...
                if (p80Var == null) {
                    ...
                    p80Var2.C = true;
                    p80Var2.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                } else {
                    p80Var.b = -1L;
                    p80Var.c = -1L;
                }
        ...
        */
        public void updateColors() {
            boolean z10;
            org.telegram.ui.ActionBar.x5 x5Var;
            int i9;
            int i10;
            org.telegram.ui.ActionBar.b6 b6Var = this.layout.resourcesProvider;
            boolean a2 = b6Var != null ? b6Var.a() : org.telegram.ui.ActionBar.f6.I.q();
            if (this.out && a2) {
                int themedColor = this.layout.getThemedColor(org.telegram.ui.ActionBar.f6.Da);
                int themedColor2 = this.layout.getThemedColor(org.telegram.ui.ActionBar.f6.Ea);
                int themedColor3 = this.layout.getThemedColor(org.telegram.ui.ActionBar.f6.Fa);
                if (themedColor != 0 || themedColor2 != 0 || themedColor3 != 0) {
                    z10 = true;
                    x5Var = this.styleKeys;
                    if (z10 && x5Var != org.telegram.ui.ActionBar.x5.n) {
                        x5Var = org.telegram.ui.ActionBar.x5.h;
                    }
                    boolean z11 = this.out;
                    i9 = !z11 ? x5Var.d : x5Var.a;
                    i10 = !z11 ? x5Var.e : x5Var.b;
                    int i11 = !z11 ? x5Var.f : x5Var.c;
                    int themedColor4 = this.layout.getThemedColor(i11);
                    this.needSaveLayer = false;
                    if (z10 || x5Var != org.telegram.ui.ActionBar.x5.n) {
                        if (!org.telegram.ui.ActionBar.f6.c1(i9) || x5Var == org.telegram.ui.ActionBar.x5.n) {
                            this.backgroundColor = this.layout.getThemedColor(i9);
                            if (org.telegram.ui.ActionBar.f6.c1(i10)) {
                                this.backgroundPressedColor = i0.a.d(0.1f, this.backgroundColor, themedColor4);
                            } else {
                                this.backgroundPressedColor = this.layout.getThemedColor(i10);
                            }
                        } else {
                            this.backgroundColor = org.telegram.ui.ActionBar.f6.l1(x5Var == org.telegram.ui.ActionBar.x5.h ? 0.08f : 0.1f, this.layout.getThemedColor(i11));
                            this.backgroundPressedColor = org.telegram.ui.ActionBar.f6.l1(0.16f, this.layout.getThemedColor(i11));
                        }
                    } else {
                        int themedColor5 = this.layout.getThemedColor(i11);
            ...
            int themedColor42 = this.layout.getThemedColor(i11);
            this.needSaveLayer = false;
            if (z10) {
            }
            if (org.telegram.ui.ActionBar.f6.c1(i9)) {
            }
            this.backgroundColor = this.layout.getThemedColor(i9);
            if (org.telegram.ui.ActionBar.f6.c1(i10)) {
            }
        ...
        */
        public RichButton(RichMessageLayout richMessageLayout, int i9, CharSequence charSequence, TL_keyboard.PageButton pageButton, TL_keyboard.InlineButtonType inlineButtonType, TL_keyboard.RichButtonStyle richButtonStyle, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, Boolean bool, Runnable runnable) {
            ...
            if (richButtonStyle != null) {
                org.telegram.ui.ActionBar.x5 x5Var2 = org.telegram.ui.ActionBar.x5.h;
                if (richButtonStyle.bg_primary) {
                    x5Var = org.telegram.ui.ActionBar.x5.n;
                } else if (richButtonStyle.bg_danger) {
                    x5Var = org.telegram.ui.ActionBar.x5.r;
                } else if (richButtonStyle.bg_success) {
                    x5Var = org.telegram.ui.ActionBar.x5.s;
                }
                if (x5Var == org.telegram.ui.ActionBar.x5.h && z15) {
                    x5Var = org.telegram.ui.ActionBar.x5.v;
                }
                this.styleKeys = x5Var;
                p00 p00Var = new p00(!booleanValue ? x5Var.f : x5Var.c, null);
                this.colorSpan = p00Var;
                p00Var.c = !z10 ? 0.5f : 1.0f;
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(charSequence);
                if (z14) {
                    spannableStringBuilder.setSpan(p00Var, 0, spannableStringBuilder.length(), 33);
                } else {
                    spannableStringBuilder.setSpan(new p41("", (vz0) null), 0, spannableStringBuilder.length(), 33);
                }
                ...
                buttonIcon = z11 ? getButtonIcon(inlineButtonType) : 0;
                if (buttonIcon != 0) {
            ...
            x5Var = org.telegram.ui.ActionBar.x5.h;
            if (x5Var == org.telegram.ui.ActionBar.x5.h) {
                x5Var = org.telegram.ui.ActionBar.x5.v;
            }
            this.styleKeys = x5Var;
            p00 p00Var2 = new p00(!booleanValue ? x5Var.f : x5Var.c, null);
            this.colorSpan = p00Var2;
            p00Var2.c = !z10 ? 0.5f : 1.0f;
    ...
    public static class RichButtonRowBlock extends RichBlock {
        ...
        public RichButtonRowBlock(RichMessageLayout richMessageLayout, Rect rect, int i9, TL_iv.pageBlockButtonRow pageblockbuttonrow) {
            ...
            this.layoutWidth = -1;
            this.clickHelper = new ud.b(new ud.a() { // from class: org.telegram.messenger.RichMessageLayout.RichButtonRowBlock.1
                @Override // ud.a
        ...
        private void layout(int i9) {
            ...
            for (RichButton richButton2 : this.buttons) {
                i10 += richButton2.width;
            }
            int ordinal = this.align.ordinal();
            int i12 = ordinal != 1 ? ordinal != 2 ? 0 : (i9 - i10) / 2 : i9 - i10;
            for (RichButton richButton3 : this.buttons) {
                richButton3.x = i12;
                i12 += richButton3.width + dp;
            }
        }
        ...
        private void squeeze(int i9, int i10) {
            ...
            int i12 = 0;
            for (RichButton richButton : this.buttons) {
                i12 += richButton.width - richButton.getMinWidth();
            }
            if (i12 <= 0) {
                RichButton[] richButtonArr = this.buttons;
                int length = richButtonArr.length;
                while (i11 < length) {
                    RichButton richButton2 = richButtonArr[i11];
            ...
            while (true) {
                ...
                if (i11 >= richButtonArr2.length) {
                    return;
                }
                RichButton richButton3 = richButtonArr2[i11];
                int minWidth = richButton3.width - richButton3.getMinWidth();
                int min2 = Math.min(i11 == this.buttons.length + (-1) ? min - i13 : (int) ((min * minWidth) / i12), minWidth);
        ...
        private void stretch(int i9) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (i12 < richButtonArr2.length) {
                        if (!zArr[i12] && (i10 = richButtonArr2[i12].width) > i11) {
                            zArr[i12] = true;
                            i9 -= i10;
                            length--;
                            z11 = true;
            ...
            int i13 = i9 / length;
            int i14 = i9 - (length * i13);
            int i15 = 0;
            while (true) {
                RichButton[] richButtonArr3 = this.buttons;
                if (i15 >= richButtonArr3.length) {
                    return;
                }
                if (!zArr[i15]) {
                    int i16 = i14 - 1;
                    richButtonArr3[i15].width = (i14 > 0 ? 1 : 0) + i13;
                    i14 = i16;
                }
                i15++;
            }
        ...
        private void updateLayout() {
            ...
            int i10 = ((minWidth + i9) + richMessageLayout.padRight) - (i9 * 2);
            Rect rect = this.padding;
            int max = Math.max(0, (i10 - rect.left) - rect.right);
    ...
    public static class RichButtonSpan extends ReplacementSpan {
        ...
        public void draw(Canvas canvas, CharSequence charSequence, int i9, int i10, float f10, int i11, int i12, int i13, Paint paint) {
            float f11;
            int i14 = (this.button.text.getEmojiOnlyCount() <= 0 || this.minimumLineHeight <= 0) ? 0 : 1;
            if (i14 == 0 && this.button.text.getEmojiOnlyCount() > 0 && (charSequence instanceof Spanned)) {
                ...
                while (true) {
                    ...
                    if ((styleSpanArr[i15].flags & 15) == 14) {
                        i14 = 1;
                        break;
                    }
                    i15++;
        ...
        public int getSize(Paint paint, CharSequence charSequence, int i9, int i10, Paint.FontMetricsInt fontMetricsInt) {
            ...
            int i11 = z10 ? fontMetricsInt.top : 0;
            int i12 = z10 ? fontMetricsInt.ascent : 0;
            int i13 = z10 ? fontMetricsInt.descent : 0;
            int i14 = z10 ? fontMetricsInt.bottom : 0;
            int i15 = z10 ? fontMetricsInt.leading : 0;
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        private RichButtonSpan(RichMessageLayout richMessageLayout, int i9, TL_iv.textButton textbutton, Boolean bool) {
            boolean z10;
            boolean z11;
            boolean z12;
            int blockFlags;
            ...
            if (richText instanceof TL_iv.textConcat) {
                ...
                if (!textconcat.texts.isEmpty()) {
                    ...
                    z11 = j3.r0.j(1, textconcat.texts) instanceof TL_iv.textCustomEmoji;
                    z10 = z13;
                    ...
                    RichButton richButton = new RichButton(richMessageLayout, i9, formatText, null, inlineButtonType, textbutton.style, inlineButtonType instanceof TL_keyboard.TL_inlineButtonTypeDisabled, true, z10, z11, z12, true, bool, new ng(this, 8));
            ...
            RichButton richButton2 = new RichButton(richMessageLayout, i9, formatText2, null, inlineButtonType2, textbutton.style, inlineButtonType2 instanceof TL_keyboard.TL_inlineButtonTypeDisabled, true, z10, z11, z12, true, bool, new ng(this, 8));
    ...
    public static class RichCollageBlock extends RichBlock {
        ...
        private void layoutCells() {
            ...
            if (this.cells.size() == 1) {
                ...
                mediaCell.setRect(0, 0, i9, i10);
                this.cellFlags[0] = 15;
                this.contentHeight = i10;
                return;
            }
            float[] fArr = new float[this.cells.size()];
            for (int i11 = 0; i11 < this.cells.size(); i11++) {
                fArr[i11] = this.cells.get(i11).aspectRatio;
            }
            ...
            for (MessageObject.GroupedMessagePosition groupedMessagePosition : computeGrouped) {
                i12 = Math.max(i12, (int) groupedMessagePosition.maxY);
            }
            int i13 = i12 + 1;
            ...
            for (MessageObject.GroupedMessagePosition groupedMessagePosition3 : computeGrouped) {
                ...
                if (i14 != b12) {
                    ...
                    if (fArr3 == null || fArr3.length != i15) {
                        float f12 = groupedMessagePosition3.ph / i15;
            ...
            for (int i17 = 0; i17 <= i12; i17++) {
                iArr[i17] = Math.round(f10 * max2);
                f10 += fArr2[i17];
            }
            iArr[i13] = Math.round(f10 * max2);
            int dp = AndroidUtilities.dp(2.0f);
            int i18 = 0;
            while (i18 < computeGrouped.length) {
                MessageObject.GroupedMessagePosition groupedMessagePosition4 = computeGrouped[i18];
                ...
                if (groupedMessagePosition4.leftSpanOffset > 0) {
                    ...
                    int i21 = 0;
                    for (int i22 = 0; i22 < computeGrouped.length; i22++) {
                        if (i22 != i18) {
                            MessageObject.GroupedMessagePosition groupedMessagePosition5 = computeGrouped[i22];
                            ...
                            if (b14 <= b15 && groupedMessagePosition5.maxY >= b15 && groupedMessagePosition5.minX < groupedMessagePosition4.minX) {
                                i21 += groupedMessagePosition5.pw;
                            }
                        }
                    }
                    round = Math.round((i21 * this.maxWidth) / 1000.0f);
                }
                ...
                this.cells.get(i18).setRect(round, i19, Math.max(0, round2), Math.max(0, i20));
        ...
        private void updateRoundRadius(ImageReceiver imageReceiver, int i9, boolean z10) {
            ...
            if (z10) {
                int dp = AndroidUtilities.dp(8.0f);
                int i11 = (z11 && z13) ? dp : 0;
                int i12 = (z11 && z14) ? dp : 0;
                int i13 = (z12 && z14) ? dp : 0;
                if (z12 && z13) {
                    i10 = dp;
                }
                imageReceiver.setRoundRadius(i11, i12, i13, i10);
                return;
            }
            int i14 = SharedConfig.bubbleRadius;
            int dp2 = i14 > 2 ? AndroidUtilities.dp(i14 - 2) : AndroidUtilities.dp(i14);
            int min = Math.min(AndroidUtilities.dp(3.0f), dp2);
            int i15 = (z11 && z13) ? (!this.first || this.root.hasNameOffset() || (!this.root.isOut() && this.root.isPinnedTop())) ? min : dp2 : 0;
            if (!z11 || !z14) {
                dp2 = 0;
            } else if (!this.first || this.root.hasNameOffset() || (this.root.isOut() && this.root.isPinnedTop())) {
                dp2 = min;
            }
            int i16 = (z12 && z14) ? min : 0;
            if (z12 && z13) {
                i10 = min;
            }
            imageReceiver.setRoundRadius(i15, dp2, i16, i10);
        }
        ...
        public void getBlockAccessibilityElementBounds(int i9, Rect rect) {
            ...
            Rect rect2 = this.padding;
            int i10 = rect2.left + mediaCell.x;
            int i11 = ((int) this.currY) + rect2.top + mediaCell.y;
            rect.set(i10, i11, mediaCell.w + i10, mediaCell.h + i11);
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            int dp = AndroidUtilities.dp(2.0f);
            int i9 = isInQuote ? 0 : this.root.padLeft - dp;
            int i10 = isInQuote ? 0 : this.root.padRight - dp;
            int i11 = this.maxWidth;
            float f10 = (i11 <= 0 || (i9 <= 0 && i10 <= 0)) ? 1.0f : ((i11 + i9) + i10) / i11;
            int i12 = 0;
            while (i12 < this.cells.size()) {
                MediaCell mediaCell = this.cells.get(i12);
                int round = Math.round(mediaCell.x * f10) - i9;
                int round2 = Math.round(mediaCell.w * f10);
                ImageReceiver imageReceiver = mediaCell.imageReceiver;
                int[] iArr = this.cellFlags;
                updateRoundRadius(imageReceiver, (iArr == null || i12 >= iArr.length) ? 0 : iArr[i12], isInQuote);
                float f11 = round;
    ...
    public static class RichDetailsBlock extends RichBlock {
        ...
        public RichDetailsBlock(RichMessageLayout richMessageLayout, Rect rect, int i9, TL_iv.pageBlockDetails pageblockdetails, CharSequence charSequence) {
            ...
            Text text = new Text(richMessageLayout, charSequence, l0.b(TEXT_RIGHT_DP, this.maxWidth - AndroidUtilities.dp(TEXT_LEFT_DP), 0));
            this.title = text;
            this.texts = new Text[]{text};
            AnimatedArrowDrawable animatedArrowDrawable = new AnimatedArrowDrawable(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.Ek : org.telegram.ui.ActionBar.f6.Dk));
        ...
        private int getContentHeight() {
            return l0.z(12.66f, this.title.getHeight() + AndroidUtilities.dp(TEXT_TOP_DP), AndroidUtilities.dp(27.82f));
        }
        ...
        public boolean findLink(CharacterStyle characterStyle, int i9, FoundLink foundLink) {
            ...
            foundLink.y = AndroidUtilities.dp(TEXT_TOP_DP) + i9 + this.padding.top;
            return true;
        }

        @Override // org.telegram.messenger.RichMessageLayout.RichBlock
        public void getBlockAccessibilityElementBounds(int i9, Rect rect) {
            int i10 = (int) this.currY;
            Rect rect2 = this.padding;
        ...
        public void onDraw(Canvas canvas) {
            ...
            float a2 = pcVar != null ? pcVar.a(0.02f) : 1.0f;
            RichMessageLayout richMessageLayout = this.root;
            ...
            int themedColor = richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.Ek : org.telegram.ui.ActionBar.f6.Dk);
            ...
            this.linePaint.setColor(richMessageLayout3.getThemedColor(richMessageLayout3.isOut() ? org.telegram.ui.ActionBar.f6.Gk : org.telegram.ui.ActionBar.f6.Fk));
        ...
        public void placeTexts(int i9, int i10, int i11) {
            ...
            this.layoutY = i10;
            this.layoutRow = i11;
            this.title.setX((AndroidUtilities.dp(TEXT_LEFT_DP) + (i9 - this.root.padLeft)) - this.title.left);
            this.title.setY(AndroidUtilities.dp(TEXT_TOP_DP) + i10);
    ...
    public static class RichDetailsEndBlock extends RichBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            RichMessageLayout richMessageLayout = this.root;
            paint.setColor(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.Gk : org.telegram.ui.ActionBar.f6.Fk));
            RichMessageLayout richMessageLayout2 = this.root;
            float f10 = -richMessageLayout2.padLeft;
            int minWidth = richMessageLayout2.getMinWidth();
            RichMessageLayout richMessageLayout3 = this.root;
            int i9 = minWidth + richMessageLayout3.padRight;
            Rect rect = this.padding;
            float f11 = (i9 - rect.left) - rect.right;
            if (richMessageLayout3.detailsAnimating) {
    ...
    public static class RichDividerBlock extends RichBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            RichMessageLayout richMessageLayout = this.root;
            int i9 = richMessageLayout.padLeft;
            int i10 = minWidth + i9 + richMessageLayout.padRight;
            Rect rect = this.padding;
            int i11 = rect.left;
            int i12 = ((i10 - i11) - rect.right) / 2;
            float f10 = (((r0 - i12) / 2.0f) - i9) + i11;
            float dp = (AndroidUtilities.dp(12.0f) - AndroidUtilities.dp(1.0f)) / 2.0f;
            Paint paint = this.paint;
            RichMessageLayout richMessageLayout2 = this.root;
            paint.setColor(richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.wk : org.telegram.ui.ActionBar.f6.vk));
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(f10, dp, i12 + f10, AndroidUtilities.dp(1.0f) + dp);
    ...
    public static class RichMapBlock extends RichBlock {
        ...
        private void applyImage() {
            ...
            int i10 = MessagesController.getInstance(i9).mapProvider;
            this.currentMapProvider = i10;
            float f10 = this.imgWidth;
            float f11 = AndroidUtilities.density;
            int i11 = (int) (f10 / f11);
            int i12 = (int) (this.imgHeight / f11);
            TL_iv.pageBlockMap pageblockmap = this.block;
            int i13 = pageblockmap.zoom;
            int i14 = i13 > 0 ? i13 : 15;
            if (i10 == 2) {
                WebFile createWithGeoPoint = WebFile.createWithGeoPoint(pageblockmap.geo, i11, i12, i14, Math.min(2, (int) Math.ceil(f11)));
            ...
            String formapMapUrl = AndroidUtilities.formapMapUrl(i9, geoPoint.lat, geoPoint._long, i11, i12, true, i14, -1);
        ...
        public void onDraw(Canvas canvas) {
            ...
            mapBgPaint.setColor(this.root.getThemedColor(org.telegram.ui.ActionBar.f6.pe));
            boolean isInQuote = isInQuote();
            int i9 = isInQuote ? 0 : this.root.padLeft;
            int i10 = isInQuote ? 0 : this.root.padRight;
            float f10 = -i9;
            canvas.drawRect(f10, 0.0f, this.imgWidth + i10, this.imgHeight, mapBgPaint);
            Drawable drawable = org.telegram.ui.ActionBar.f6.S4[this.root.isOut() ? 1 : 0];
            if (drawable != null) {
            ...
            if (this.photoPressed) {
                ...
                if (z10 && this.block.geo != null && (view = this.view) != null) {
                    ...
                    try {
                        ...
                        this.view.getContext().startActivity(new Intent("android.intent.action.VIEW", Uri.parse("geo:" + d + "," + d9 + "?q=" + d + "," + d9)));
                    } catch (Exception e10) {
                        FileLog.e(e10);
                    }
                    return true;
    ...
    public static class RichMathBlock extends RichBlock {
        ...
        public RichMathBlock(RichMessageLayout richMessageLayout, Rect rect, int i9, TL_iv.pageBlockMath pageblockmath) {
            ...
            qh.q a2 = (pageblockmath == null || TextUtils.isEmpty(pageblockmath.source)) ? null : qh.q.a(pageblockmath.source, AndroidUtilities.dp(richMessageLayout.fontSize + 4), false);
            if (a2 != null) {
                this.bitmap = a2.a;
                this.contentW = a2.b;
                this.contentH = a2.c;
        ...
        public void onDraw(Canvas canvas) {
            ...
            Paint paint = this.paint;
            RichMessageLayout richMessageLayout = this.root;
            paint.setColor(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.fc : org.telegram.ui.ActionBar.f6.ec));
            ...
            if (this.maxScrollX > 0) {
                canvas2.restore();
                RectF rectF = AndroidUtilities.rectTmp;
                int i9 = this.root.padLeft;
                float f11 = D;
                rectF.set(-i9, 0.0f, AndroidUtilities.dp(12.0f) + (-i9), f11);
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (actionMasked == 2) {
                ...
                int i9 = (int) (this.downScrollX - x10);
                int i10 = i9 >= 0 ? i9 : 0;
    ...
    public static class RichPhotoBlock extends RichMediaBlock {
        ...
        public RichPhotoBlock(RichMessageLayout richMessageLayout, Rect rect, int i9, TL_iv.pageBlockPhoto pageblockphoto, boolean z10) {
            ...
            int i10 = photoSize != null ? photoSize.w : 100;
    ...
    public static class RichPreformattedBlock extends RichBlock {
        ...
        private void drawBackground(Canvas canvas) {
            ...
            RichMessageLayout richMessageLayout = this.root;
            paint.setColor(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.yk : org.telegram.ui.ActionBar.f6.xk));
        ...
        private void drawScrollbar(Canvas canvas) {
            ...
            Paint paint = this.bgPaint;
            RichMessageLayout richMessageLayout2 = this.root;
            paint.setColor(richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.Bk : org.telegram.ui.ActionBar.f6.zk));
            ...
            RichMessageLayout richMessageLayout3 = this.root;
            paint2.setColor(richMessageLayout3.getThemedColor(richMessageLayout3.isOut() ? org.telegram.ui.ActionBar.f6.Ck : org.telegram.ui.ActionBar.f6.Ak));
        ...
        private void drawTextContent(Canvas canvas, boolean z10, int i9, float f10) {
            ...
            rectF.set(-i10, 0.0f, AndroidUtilities.dp(12.0f) + (-i10), f13);
        ...
        public boolean findLink(CharacterStyle characterStyle, int i9, FoundLink foundLink) {
            ...
            foundLink.y = AndroidUtilities.dp(15.0f) + i9 + this.padding.top;
            return true;
        }
        ...
        @Override // org.telegram.messenger.RichMessageLayout.RichBlock, org.telegram.ui.cj0
        public Layout getLayout() {
    ...
    public static class RichSlideshowBlock extends RichBlock {
        ...
        private void settle(float f10) {
            ...
            if (f10 >= 0.0f || this.currentPage >= this.cells.size() - 1) {
                ...
                final int i10 = i9 + this.currentPage;
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.pageOffset, i10 - r7);
                ...
                this.settleAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.messenger.RichMessageLayout.RichSlideshowBlock.1
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        RichSlideshowBlock.this.currentPage = i10;
            ...
            i9 = 1;
            final int i102 = i9 + this.currentPage;
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.pageOffset, i102 - r7);
            ...
            this.settleAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.messenger.RichMessageLayout.RichSlideshowBlock.1
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    RichSlideshowBlock.this.currentPage = i102;
                    RichSlideshowBlock.this.pageOffset = 0.0f;
                    View view = RichSlideshowBlock.this.view;
                    if (view != null) {
                        view.invalidate();
        ...
        public void onDraw(Canvas canvas) {
            ...
            boolean isInQuote = isInQuote();
            int dp = AndroidUtilities.dp(2.0f);
            int i14 = isInQuote ? 0 : this.root.padLeft - dp;
            int i15 = isInQuote ? 0 : this.root.padRight - dp;
            ...
            if (isInQuote) {
                ...
                int dp3 = i17 > 2 ? AndroidUtilities.dp(i17 - 2) : AndroidUtilities.dp(i17);
                int min = Math.min(AndroidUtilities.dp(3.0f), dp3);
                int i18 = ((this.root.isOut() || !this.root.isPinnedTop()) && !this.root.hasNameOffset()) ? dp3 : min;
            ...
            if ((i19 == 0 && this.pageOffset < 0.0f) || (i19 == this.cells.size() - 1 && this.pageOffset > 0.0f)) {
                RichMessageLayout richMessageLayout = this.root;
                canvas.drawColor(org.telegram.ui.ActionBar.f6.l1(0.2f, richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.cb : org.telegram.ui.ActionBar.f6.Wc)));
            }
            float f19 = i16;
            ...
            for (int i21 = 1; i20 <= this.currentPage + i21; i21 = 1) {
                if (i20 < 0 || i20 >= this.cells.size()) {
                    ...
                    MediaCell mediaCell2 = this.cells.get(i20);
                    canvas.save();
                    canvas.translate(((i20 - this.currentPage) * i16) + f20, f18);
                    mediaCell2.imageReceiver.setRoundRadius(i20 == 0 ? i9 : 0, i20 == this.cells.size() - i21 ? i10 : 0, i20 == this.cells.size() + (-1) ? i11 : 0, i20 == 0 ? i12 : 0);
                    mediaCell2.blurImageReceiver.setRoundRadius(i20 == 0 ? i9 : 0, i20 == this.cells.size() + (-1) ? i10 : 0, i20 == this.cells.size() + (-1) ? i11 : 0, i20 == 0 ? i12 : 0);
                    float f21 = -i14;
            ...
            if (size > 1) {
                ...
                int dp5 = AndroidUtilities.dp(4.0f) + l0.D(6.0f, size - 1, AndroidUtilities.dp(7.0f) * size);
                ...
                if (dp5 < i16) {
                    ...
                    clamp = dp6 - (Utilities.clamp(f22 - (((i16 - AndroidUtilities.dp(f12)) / 2) / dp7), Math.max(0, (size - (r11 * 2)) - 1), 0.0f) * dp7);
                }
                canvas.save();
                canvas.clipRect(0, this.slideHeight - AndroidUtilities.dp(23.0f), i16, this.slideHeight);
                for (int i22 = 0; i22 < size; i22++) {
                    float max = Math.max(0.0f, 1.0f - Math.abs(i22 - f22));
                    slideDotPaint.setAlpha((int) ((max * 95.0f) + 160.0f));
                    canvas.drawCircle(AndroidUtilities.dp(4.0f) + clamp + (AndroidUtilities.dp(13.0f) * i22), dp4, (AndroidUtilities.dp(1.0f) * max) + AndroidUtilities.dp(f10), slideDotPaint);
                }
                canvas.restore();
            }
        }
                ...
                if (actionMasked == 0) {
                    ...
                    if (!this.verticalDragging) {
                        ...
                        if (this.dragging || Math.abs(y10) <= this.touchSlop || Math.abs(y10) <= Math.abs(x10)) {
                            ...
                            if (i13 == this.cells.size() - 1 && f11 > 0.0f) {
                                f11 *= 0.3f;
                            }
                            this.pageOffset = f11;
                            View view2 = this.view;
    ...
    public static class RichTableBlock extends RichBlock implements qy0 {
        ...
        public RichTableBlock(RichMessageLayout richMessageLayout, Rect rect, int i9, TL_iv.pageBlockTable pageblocktable) {
            ...
            if (pageblocktable.compact) {
                ...
                if (ry0Var.v != dp || ry0Var.r != dp2 || ry0Var.s != dp3) {
                    ry0Var.v = dp;
                    ry0Var.r = dp2;
                    ry0Var.s = dp3;
            ...
            ry0Var.setMinimumCellHeight(AndroidUtilities.dp(pageblocktable.compact ? 18.0f : 36.0f));
            ...
            for (int i13 = 0; i13 < pageblocktable.rows.size(); i13++) {
                TL_iv.pageTableRow pagetablerow2 = pageblocktable.rows.get(i13);
                int i14 = 0;
                for (int i15 = 0; i15 < pagetablerow2.cells.size(); i15++) {
                    ...
                    if (pagetablecell.text != null) {
                        this.tableLayout.b(pagetablecell, i14, i13, i16);
                    } else {
                        this.tableLayout.a(i14, i13, i16, i17);
                    }
                    i14 += i16;
                }
            }
            ...
            for (int i18 = 0; i18 < this.tableLayout.getChildCount(); i18++) {
                ky0 d = this.tableLayout.d(i18);
                jy0 jy0Var = d.b;
        ...
        private void drawCellsWithTyping(Canvas canvas, ej0 ej0Var, float f10) {
            ...
            while (i10 < childCount) {
                ...
                if (i9 >= this.cellBlocks.size() || this.cellBlocks.get(i9).child != d) {
                    cellBlock = null;
                } else {
                    cellBlock = this.cellBlocks.get(i9);
                    i9++;
                }
                int i11 = i9;
                if (cellBlock == null) {
                    ...
                    if (d.b instanceof Text) {
                        ...
                        ((Text) d.b).drawFade(canvas, ej0Var.g(cellBlock) ? ej0Var.e : -1, ej0Var.g(cellBlock) ? ej0Var.f : 0.0f);
                        canvas.restore();
                    }
                } else {
                    ...
                    if (c10 >= 1.0f) {
                        ...
                        canvas.save();
                        canvas.translate(d.b(), d.c());
                        int saveLayerAlpha2 = canvas.saveLayerAlpha(0.0f, 0.0f, d.k, d.l, (int) (c10 * 255.0f), 31);
        ...
        private void ensurePaints() {
            ...
            RichMessageLayout richMessageLayout = this.root;
            int themedColor = richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.uk : org.telegram.ui.ActionBar.f6.tk);
            this.linePaint.setColor(themedColor);
            this.halfLinePaint.setColor(themedColor);
            Paint paint3 = this.headerPaint;
            RichMessageLayout richMessageLayout2 = this.root;
            paint3.setColor(richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.sk : org.telegram.ui.ActionBar.f6.rk));
        ...
        private int titleDrawX() {
            ...
            int i10 = text.right;
            return Math.round(((i9 - (i10 - r0)) / 2.0f) - text.left);
        }
        ...
        public boolean drawOverlay(Canvas canvas, ColorFilter colorFilter) {
            ...
            Text text2 = this.title;
            boolean z11 = true;
            if (text2 == null || (p5Var2 = text2.animatedEmojiStack) == null || p5Var2.a.isEmpty()) {
                z10 = false;
            } else {
                canvas.save();
                canvas.translate(titleDrawX(), 0.0f);
            ...
            while (true) {
                ...
                if (p5Var3 == null || p5Var3.a.isEmpty()) {
                    i10++;
                } else {
                    RichMessageLayout richMessageLayout = this.root;
                    float f10 = -richMessageLayout.padLeft;
                    ...
                    while (i11 < childCount) {
                        jy0 jy0Var = this.tableLayout.d(i11).b;
                        if (!(jy0Var instanceof Text) || (p5Var = (text = (Text) jy0Var).animatedEmojiStack) == null || p5Var.a.isEmpty()) {
                            i9 = i11;
                        } else {
                            canvas.save();
        ...
        public boolean findLink(CharacterStyle characterStyle, int i9, FoundLink foundLink) {
            ...
            if (text != null && text.fillFoundLink(characterStyle, foundLink)) {
                ...
                foundLink.y = i9 + this.padding.top;
                return true;
            }
            int childCount = this.tableLayout.getChildCount();
            for (int i10 = 0; i10 < childCount; i10++) {
                jy0 jy0Var = this.tableLayout.d(i10).b;
                if (jy0Var instanceof Text) {
                    if (((Text) jy0Var).fillFoundLink(characterStyle, foundLink)) {
                        foundLink.x = ((r4.b() + this.padding.left) - this.scrollX) - r5.drawLeft();
                        foundLink.y = r4.c() + i9 + this.padding.top + this.titleHeight;
                        return true;
                    }
                }
            }
        ...
        public void onDraw(Canvas canvas) {
            ...
            int childCount = this.tableLayout.getChildCount();
            for (int i9 = 0; i9 < childCount; i9++) {
                this.tableLayout.d(i9).a(canvas, this.view, true);
            }
            canvas.restore();
            RectF rectF = AndroidUtilities.rectTmp;
            int i10 = this.root.padLeft;
            rectF.set(-i10, 0.0f, AndroidUtilities.dp(12.0f) + (-i10), this.contentHeight);
            this.root.clip.b(canvas, rectF, 0, 1.0f);
            int minWidth2 = this.root.getMinWidth() + this.root.padRight;
            Rect rect2 = this.padding;
        ...
        public Text createTextLayout(TL_iv.pageTableCell pagetablecell, int i9) {
            ...
            Text text = new Text(this.root, this.root.formatText(pagetablecell.text, RichMessageLayout.setBlockFlags(0, 14)), i9, pagetablecell.align_right ? Layout.Alignment.ALIGN_OPPOSITE : pagetablecell.align_center ? Layout.Alignment.ALIGN_CENTER : Layout.Alignment.ALIGN_NORMAL);
            text.setDrawAtOrigin(true);
            return text;
        }

        @Override // org.telegram.ui.Components.qy0
        public /* bridge */ /* synthetic */ void onLayoutChild(jy0 jy0Var, int i9, int i10) {
        }
    }
    ...
    public static class RichTextBlock extends RichBlock {
        ...
        public boolean findLink(CharacterStyle characterStyle, int i9, FoundLink foundLink) {
            ...
            foundLink.y = i9 + this.padding.top + this.contentPaddingTop;
            return true;
        }
    ...
    public static class RichTextBlockQuote extends RichTextBlock {
        ...
        public void onDraw(Canvas canvas) {
            Canvas canvas2;
            org.telegram.ui.Components.pc pcVar = this.bounce;
            float a2 = pcVar != null ? pcVar.a(0.01f) : 1.0f;
            if (a2 != 1.0f) {
                canvas.save();
                canvas.scale(a2, a2, this.maxWidth / 2.0f, getHeight() / 2.0f);
            }
            boolean z10 = this.collapsedProgress > 0.0f;
            int i9 = (this.collapsedHeightToDraw - this.padding.bottom) - this.contentPaddingBottom;
            canvas.save();
            canvas.clipRect(0, 0, this.maxWidth, i9);
            if (z10) {
                canvas2 = canvas;
                canvas2.saveLayer(0.0f, 0.0f, this.maxWidth, i9, null);
            } else {
                canvas2 = canvas;
            }
            ...
            if (z10) {
                ...
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(0.0f, i9 - AndroidUtilities.dp(24.0f), this.maxWidth, i9 + 1);
            ...
            ff.s.e(this.quoteArrow, this.root.getMinWidth() - AndroidUtilities.dp(24.0f), AndroidUtilities.dp(8.0f) + ((i9 - AndroidUtilities.dp(16.0f)) - AndroidUtilities.dp(2.0f)), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), 17);
            canvas2.save();
    ...
    public static class RichTextWithAuthorBlock extends RichBlock {
        ...
        public boolean findLink(CharacterStyle characterStyle, int i9, FoundLink foundLink) {
            ...
            foundLink.y = this.text.getHeight() + i9 + this.padding.top + gap();
            return true;
        }
    ...
    public static class RichThinkingBlock extends RichBlock {
        ...
        public void onDrawFaded(Canvas canvas, int i9, float f10) {
            ...
            RichMessageLayout richMessageLayout = this.root;
            richMessageLayout.textPaint.linkColor = richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.hc : org.telegram.ui.ActionBar.f6.gc);
        ...
        public RichVideoBlock(RichMessageLayout richMessageLayout, Rect rect, int i9, TL_iv.pageBlockVideo pageblockvideo, boolean z10) {
            ...
            if (document != null) {
                ...
                if (i11 <= 0 || i10 <= 0) {
                    ...
                    i11 = photoSize != null ? photoSize.w : 100;
    ...
    public static final class SpoilerReveal {
        ...
        public void start(final View view, float f10, float f11, float f12, float f13) {
            ...
            this.animator.setInterpolator(gr.j);
    ...
    public static class StyleSpan extends MetricAffectingSpan {
        ...
        public int getTextColor() {
            ...
            if (i9 == 11) {
                RichMessageLayout richMessageLayout = this.root;
                return richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.cb : org.telegram.ui.ActionBar.f6.Wc);
            }
            if (i9 == 10) {
                RichMessageLayout richMessageLayout2 = this.root;
                return org.telegram.ui.ActionBar.f6.l1(0.5f, richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.fc : org.telegram.ui.ActionBar.f6.ec));
            }
            RichMessageLayout richMessageLayout3 = this.root;
            return richMessageLayout3.getThemedColor(richMessageLayout3.isOut() ? org.telegram.ui.ActionBar.f6.fc : org.telegram.ui.ActionBar.f6.ec);
        }
        ...
        public Typeface getTypeface() {
            ...
            boolean z10 = true;
            if (i10 >= 1 && i10 <= 6) {
                return TLObject.hasFlag(i9, 32) ? AndroidUtilities.getTypeface("fonts/mw_bolditalic.ttf") : AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_MERRIWEATHER_BOLD);
            }
            if (TLObject.hasFlag(i9, 256)) {
                return Typeface.MONOSPACE;
            }
    ...
    public static class Text implements org.telegram.ui.Cells.y9, jy0 {
        ...
        public static class EmojiLineMetrics {
            ...
            public static /* synthetic */ int access$1412(EmojiLineMetrics emojiLineMetrics, int i9) {
            ...
            public static /* synthetic */ int access$1512(EmojiLineMetrics emojiLineMetrics, int i9) {
            ...
            public boolean allowsEmojiLineHeight() {
                ...
                return i9 > 0 && ((long) this.emojiCount) * 100 >= ((long) i9) * 70;
            }
        }
        ...
        private void dispatchLinkClick(CharacterStyle characterStyle, boolean z10) {
            ...
            CharacterStyle o41Var = ((characterStyle instanceof StyleSpan) && TLObject.hasFlag(((StyleSpan) characterStyle).flags, 256)) ? new o41(this.layout.getText(), this.pressedLinkStart, this.pressedLinkEnd, this.root.isOut() ? (byte) 1 : (byte) 0, null) : characterStyle;
            org.telegram.ui.Cells.k1 delegate = this.root.getDelegate();
            org.telegram.ui.Cells.t1 cell = this.root.getCell();
        ...
        private void drawTranslationLoading(Canvas canvas) {
            ...
            RichMessageLayout richMessageLayout2 = this.root;
            int themedColor = richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.hc : org.telegram.ui.ActionBar.f6.gc);
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$drawFade$1(View view, int i9, Canvas canvas) {
            ...
            if (i12 > 0) {
                ...
                while (i13 < length) {
                    ...
                    if (spanStart < i9 || spanStart >= i10 || min <= spanStart) {
                        ...
                        iArr[i15] = Math.max(iArr[i15], min);
                        i11 = i14;
                ...
                for (Emoji.EmojiSpan emojiSpan : emojiSpanArr) {
                    ...
                    if (spanStart2 >= i9 && spanStart2 < i10 && min2 > spanStart2) {
                        int i16 = spanStart2 - i9;
                        iArr[i16] = Math.max(iArr[i16], min2);
                ...
                if (richButtonSpanArr2.length > 0) {
                    ...
                    for (RichButtonSpan richButtonSpan : richButtonSpanArr2) {
                        ...
                        if (richButtonSpan.button.text.getEmojiOnlyCount() > 0 && spanStart3 >= i9 && spanStart3 < i10) {
                            ...
                            richButtonSpanArr[spanStart3 - i9] = richButtonSpan;
                        }
                    }
                } else {
                    richButtonSpanArr = null;
                ...
                if (iArr != null || richButtonSpanArr != null) {
                    ...
                    while (i17 < i10) {
                        ...
                        if (richButtonSpan2 == null || !(richButtonSpan2.button.text.layout.getText() instanceof Spanned)) {
                            ...
                            i17 = Math.min(i10, spanned.getSpanEnd(richButtonSpan2));
                        }
                    }
                }
            }
        ...
        private void revealSpoilers(int i9, int i10) {
            ...
            View view = this.view;
            this.pressedSpoiler.q = new qh(this, view, this.root);
            Iterator<dh.l> it = this.spoilers.iterator();
            while (it.hasNext()) {
                it.next().j(i9, i10, sqrt, false);
            }
            if (view != null) {
                view.playSoundEffect(0);
            }
        ...
        public void drawFade(Canvas canvas, int i9, float f10) {
            ...
            RichMessageLayout richMessageLayout = this.root;
            final int themedColor = richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.fc : org.telegram.ui.ActionBar.f6.ec);
            this.root.textPaint.setColor(themedColor);
            RichMessageLayout richMessageLayout2 = this.root;
            richMessageLayout2.textPaint.linkColor = richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.hc : org.telegram.ui.ActionBar.f6.gc);
            final View view = this.view;
            ej0.b(canvas, this.layout, i9, f10, new dj0() { // from class: org.telegram.messenger.ph
        ...
        public void refreshAnimatedEmoji(int i9) {
            ...
            this.animatedEmojiStack = null;
            this.animatedEmojiStack = org.telegram.ui.Components.t5.update(i9, this.view, this.root.invalidateAnimatedEmojiInParent && !this.doNotInvalidateEmojiInParent, (org.telegram.ui.Components.p5) null, this.layout);
        }
        ...
        public Text(RichMessageLayout richMessageLayout, CharSequence charSequence, int i9, Layout.Alignment alignment, float f10) {
            ...
            if (configureEmojiLineHeights instanceof Spanned) {
                ...
                for (int i13 = 0; i13 < length2 && (styleSpanArr[i13].flags & 15) == 0; i13++) {
                }
            }
    ...
    private void applyListPaddingFromBlocks() {
        int i9 = 0;
        while (i9 < this.blocks.size()) {
            RichBlock richBlock = this.blocks.get(i9);
            if ((richBlock instanceof RichTextBlock) && richBlock.listLevel > 0) {
                int i10 = i9 + 1;
                ((RichTextBlock) richBlock).setContentPadding(AndroidUtilities.dp(i9 > 0 && this.blocks.get(i9 + (-1)).listLevel > 0 ? 2.0f : 6.0f), AndroidUtilities.dp(i10 < this.blocks.size() && this.blocks.get(i10).listLevel > 0 ? 5.0f : 9.0f));
            }
            i9++;
        }
    }
    ...
    private void closeLists(StringBuilder sb2, ArrayList<Boolean> arrayList) {
        while (!arrayList.isEmpty()) {
            sb2.append(((Boolean) e2.c.k(1, arrayList)).booleanValue() ? "</ol>" : "</ul>");
        }
    }
    ...
    */
    public static MessageObject.GroupedMessagePosition[] computeGrouped(float[] fArr) {
        ...
        for (int i9 = 0; i9 < length; i9++) {
            ...
            groupedMessagePositionArr2[i9] = groupedMessagePosition;
        ...
        if (!z10 && (length == 2 || length == 3 || length == 4)) {
            if (length == 2) {
                ...
                float min3 = Math.min(814.0f, Math.round(Math.min(i10 / groupedMessagePosition2.aspectRatio, max / groupedMessagePosition3.aspectRatio))) / 814.0f;
                groupedMessagePosition2.set(0, 0, 0, 0, i10, min3, 13);
            ...
            if (length == 3) {
                ...
                if (sb2.charAt(0) == 'n') {
                    ...
                    int max2 = (int) Math.max(i10, Math.min(f14 * 0.5f, Math.round(Math.min(groupedMessagePosition6.aspectRatio * min4, groupedMessagePosition5.aspectRatio * r7))));
            ...
            if (sb2.charAt(0) != 'w') {
                int max3 = Math.max(i10, Math.round(814.0f / ((1.0f / groupedMessagePosition10.aspectRatio) + ((1.0f / groupedMessagePosition9.aspectRatio) + (1.0f / groupedMessagePosition8.aspectRatio)))));
                float f21 = dp;
                float f22 = max3;
            ...
            int i13 = (1000 - max4) - max5;
            if (i13 < AndroidUtilities.dp(58.0f)) {
                int dp5 = AndroidUtilities.dp(58.0f) - i13;
                i13 = AndroidUtilities.dp(58.0f);
                int i14 = dp5 / 2;
                max4 -= i14;
                max5 -= dp5 - i14;
            }
            ...
            groupedMessagePosition8.set(0, 0, 1, 1, i15, f25, 9);
            groupedMessagePosition9.set(1, 1, 1, 1, i13, f25, 8);
        ...
        for (int i17 = 0; i17 < length; i17++) {
            float f26 = groupedMessagePositionArr2[i17].aspectRatio;
            if (f13 > 1.1f) {
                fArr2[i17] = Math.max(1.0f, f26);
            } else {
                fArr2[i17] = Math.min(1.0f, f26);
            }
        ...
        for (int i20 = 1; i20 < length - 1; i20++) {
            ...
            while (true) {
                ...
                if (i21 < i22) {
                    int i23 = i22 - i21;
                    if (i20 <= 3) {
                        if (i21 <= (f13 < 0.85f ? 4 : 3) && i23 <= 3) {
                            arrayList.add(new int[]{i20, i21, i23});
                            int i24 = i20 + i21;
                            arrayList2.add(new float[]{multiHeight(fArr2, 0, i20, MediaDataController.MAX_STYLE_RUNS_COUNT), multiHeight(fArr2, i20, i24, MediaDataController.MAX_STYLE_RUNS_COUNT), multiHeight(fArr2, i24, length, MediaDataController.MAX_STYLE_RUNS_COUNT)});
                        }
                    }
                    i21++;
                }
            ...
            while (true) {
                ...
                if (i26 < i27) {
                    ...
                    while (true) {
                        ...
                        if (i28 < i29) {
                            int i30 = i29 - i28;
                            if (i25 > i11 || i26 > i11 || i28 > i11 || i30 > i11) {
                                groupedMessagePositionArr = groupedMessagePositionArr2;
                            } else {
                                arrayList.add(new int[]{i25, i26, i28, i30});
                                int i31 = i25 + i26;
                                int i32 = i31 + i28;
                                groupedMessagePositionArr = groupedMessagePositionArr2;
                                arrayList2.add(new float[]{multiHeight(fArr2, 0, i25, i16), multiHeight(fArr2, i25, i31, i16), multiHeight(fArr2, i31, i32, i16), multiHeight(fArr2, i32, length, i16)});
                            }
                            i28++;
        ...
        for (int i34 = 0; i34 < arrayList.size(); i34++) {
            float[] fArr3 = (float[]) arrayList2.get(i34);
            int[] iArr = (int[]) arrayList.get(i34);
        ...
        if (i33 == -1) {
            ...
            while (i37 < length) {
                int i38 = i37;
                groupedMessagePositionArr3[i37].set(0, 0, i38, i37, MediaDataController.MAX_STYLE_RUNS_COUNT, 0.4f, 3);
                i37 = i38 + 1;
            }
            return groupedMessagePositionArr3;
        }
        int[] iArr2 = (int[]) arrayList.get(i33);
        float[] fArr4 = (float[]) arrayList2.get(i33);
        int i39 = 0;
        int i40 = 0;
        while (i40 < iArr2.length) {
            int i41 = iArr2[i40];
            float f32 = fArr4[i40];
            MessageObject.GroupedMessagePosition groupedMessagePosition11 = null;
            int i42 = MediaDataController.MAX_STYLE_RUNS_COUNT;
            for (int i43 = 0; i43 < i41; i43++) {
                int i44 = (int) (fArr2[i39] * f32);
                i42 -= i44;
                MessageObject.GroupedMessagePosition groupedMessagePosition12 = groupedMessagePositionArr3[i39];
                int i45 = i40 == 0 ? 4 : 0;
                ...
                groupedMessagePosition12.set(i43, i43, i40, i40, i44, Math.max(dp4, f32 / 814.0f), i45);
                i39++;
            }
            if (groupedMessagePosition11 != null) {
                groupedMessagePosition11.pw += i42;
                groupedMessagePosition11.spanSize += i42;
            }
            i40++;
        }
        return groupedMessagePositionArr3;
    ...
    private void drawPullquoteBackground(Canvas canvas, RichPullquoteBlock richPullquoteBlock, org.telegram.ui.Cells.s1 s1Var) {
        ...
        boolean z10 = s1Var != null && (this.detailsAnimating || this.blockquoteAnimating);
        float max = z10 ? Math.max(0.0f, Math.min(1.0f, s1Var.K1)) : 1.0f;
        if (z10) {
        ...
        float lerp = z10 ? AndroidUtilities.lerp(richPullquoteBlock.prevY, richPullquoteBlock.currY, max) : richPullquoteBlock.currY;
        float dp3 = lerp + AndroidUtilities.dp(8.0f);
        float lerp2 = (lerp + (z10 ? AndroidUtilities.lerp(richPullquoteBlock.prevH, richPullquoteBlock.currH, max) : richPullquoteBlock.getHeight())) - AndroidUtilities.dp(8.0f);
        if (lerp2 <= dp3) {
            return;
        }
        RectF rectF = AndroidUtilities.rectTmp;
    ...
    private void drawShowMoreButton(Canvas canvas, int i9) {
        ...
        int themedColor = getThemedColor(isOut() ? org.telegram.ui.ActionBar.f6.Xa : org.telegram.ui.ActionBar.f6.Kc);
        ...
        float dp2 = AndroidUtilities.dp(4.0f) + i9;
        float f12 = minWidth / 2.0f;
        this.showMoreRect.set(f11 - f12, dp2, f11 + f12, dp + dp2);
        org.telegram.ui.Cells.t1 t1Var = this.cell;
        boolean z10 = (t1Var == null || (k1Var = this.delegate) == null || !k1Var.Y0(7, t1Var)) ? false : true;
        ...
        if (p80Var2 == null && z10) {
            ...
            p80Var3.w.setStrokeWidth(AndroidUtilities.dp(1.25f));
    ...
    private RichBlock emitBlock(TL_iv.PageBlock pageBlock, int i9, Rect rect, int i10, boolean z10) {
        ...
        if (org.telegram.ui.l4.K(pageBlock) || (pageBlock instanceof TL_iv.pageBlockFooter) || (pageBlock instanceof TL_iv.pageBlockParagraph)) {
            boolean K = org.telegram.ui.l4.K(pageBlock);
            RichTextBlock richTextBlock = new RichTextBlock(this, rect, this.maxWidth, formatText(pageBlock.text, setBlockFlags(i15, getBlockTextFlag(pageBlock))));
            if (K) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockList) {
            ...
            for (int i17 = 0; i17 < pageblocklist.items.size(); i17++) {
                dp = Math.max(dp, pageblocklist.items.get(i17).checkbox ? AndroidUtilities.dp(26.0f) : AndroidUtilities.dp(18.0f));
            }
            ...
            int i18 = 0;
            while (i18 < pageblocklist.items.size()) {
                TL_iv.PageListItem pageListItem = pageblocklist.items.get(i18);
                if (pageListItem instanceof TL_iv.TL_pageListItemText) {
                    TL_iv.TL_pageListItemText tL_pageListItemText = (TL_iv.TL_pageListItemText) pageListItem;
                    richBlock = richBlock2;
                    RichTextBlock richTextBlock2 = new RichTextBlock(this, new Rect(rect2), this.maxWidth, formatText(tL_pageListItemText.text, i15));
                    ...
                    if (tL_pageListItemText.checkbox) {
                        ...
                        richTextBlock2.setNum("•◦▪".charAt(i9 % 3) + "");
                    }
                    markListItem(richTextBlock2, i16, false, tL_pageListItemText.checkbox, tL_pageListItemText.checked);
                    ...
                    if (pageListItem instanceof TL_iv.TL_pageListItemBlocks) {
                        ...
                        if (!tL_pageListItemBlocks.blocks.isEmpty()) {
                            ...
                            int i19 = 0;
                            boolean z11 = false;
                            while (i19 < tL_pageListItemBlocks.blocks.size()) {
                                int i20 = i19;
                                RichBlock emitBlock = emitBlock(tL_pageListItemBlocks.blocks.get(i19), i16, new Rect(rect2), i15, previousBlockIsParagraph(tL_pageListItemBlocks.blocks, i19));
                                if (emitBlock != null && !z11) {
                                    ...
                                    markListItem(emitBlock, i16, false, tL_pageListItemBlocks.checkbox, tL_pageListItemBlocks.checked);
                                    z11 = true;
                                }
                                i19 = i20 + 1;
                            }
                            markListMembership(size, this.blocks.size(), i16, false);
                            i18++;
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            for (int i22 = 0; i22 < pageblockorderedlist.items.size(); i22++) {
                dp2 = Math.max(dp2, AndroidUtilities.dp(10.0f) + ((int) Math.ceil(r6.measureText(orderedListMarker(pageblockorderedlist, r11, i22)))) + (pageblockorderedlist.items.get(i22).checkbox ? AndroidUtilities.dp(26.0f) : 0));
            }
            ...
            int i23 = 0;
            while (i23 < pageblockorderedlist.items.size()) {
                ...
                if (pageListOrderedItem instanceof TL_iv.TL_pageListOrderedItemText) {
                    ...
                    RichTextBlock richTextBlock3 = new RichTextBlock(this, new Rect(rect3), this.maxWidth, formatText(tL_pageListOrderedItemText.text, i15));
                    richTextBlock3.setListMarkerWidth(dp2);
                    richTextBlock3.setNum(orderedListMarker(pageblockorderedlist, tL_pageListOrderedItemText, i23));
                    ...
                    markListItem(richTextBlock3, i21, true, tL_pageListOrderedItemText.checkbox, tL_pageListOrderedItemText.checked);
                    ...
                    if (!tL_pageListOrderedItemBlocks.blocks.isEmpty()) {
                        ...
                        boolean z12 = false;
                        int i24 = 0;
                        while (i24 < tL_pageListOrderedItemBlocks.blocks.size()) {
                            RichBlock emitBlock2 = emitBlock(tL_pageListOrderedItemBlocks.blocks.get(i24), i21, new Rect(rect3), i15, previousBlockIsParagraph(tL_pageListOrderedItemBlocks.blocks, i24));
                            int i25 = i15;
                            if (emitBlock2 != null && !z12) {
                                ...
                                emitBlock2.setNum(orderedListMarker(pageblockorderedlist, tL_pageListOrderedItemBlocks, i23));
                                if (tL_pageListOrderedItemBlocks.checkbox) {
                                    emitBlock2.setCheckbox(tL_pageListOrderedItemBlocks.checked, tL_pageListOrderedItemBlocks);
                                }
                                markListItem(emitBlock2, i21, true, tL_pageListOrderedItemBlocks.checkbox, tL_pageListOrderedItemBlocks.checked);
                                z12 = true;
                            }
                            i24++;
                            i15 = i25;
                        ...
                        i14 = i15;
                        markListMembership(size2, this.blocks.size(), i21, true);
                        i23++;
                        i15 = i14;
                    }
                }
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
            ...
            CharSequence formatText = formatText(pageBlock.text, setBlockFlags(i26, getBlockTextFlag(pageBlock)));
            TL_iv.RichText richText = pageblockblockquote2.caption;
            CharSequence formatText2 = (richText == null || TextUtils.isEmpty(getString(richText))) ? null : formatText(pageblockblockquote2.caption, setBlockFlags(i26, 11));
            if (pageblockblockquote2.collapsed) {
                ...
                richTextBlockQuote.quoteAuthorStart = i13;
            ...
            arrayList.add(new QuoteBackground(size3, size4, i11, i9, dp3, i12));
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            ...
            int i31 = 0;
            while (i31 < pageblockblockquoteblocks.blocks.size()) {
                emitBlock(pageblockblockquoteblocks.blocks.get(i31), i30, new Rect(AndroidUtilities.dp(12.0f) + rect.left, rect.top + (i31 == 0 ? AndroidUtilities.dp(4.0f) : 0), AndroidUtilities.dp(12.0f) + rect.right, rect.bottom + ((!(i31 == pageblockblockquoteblocks.blocks.size() + (-1)) || z13) ? 0 : AndroidUtilities.dp(4.0f))), setBlockFlags(i26, i28), previousBlockIsParagraph(pageblockblockquoteblocks.blocks, i31));
                i31++;
                size5 = size5;
                i28 = 9;
            }
            int i32 = size5;
            if (this.blocks.size() > i32) {
                this.blocks.get(i32).accessibilityParentLabelResId = R.string.ArticleQuote;
            }
            if (z13) {
                RichTextBlock richTextBlock4 = new RichTextBlock(this, new Rect(AndroidUtilities.dp(12.0f) + rect.left, rect.top, AndroidUtilities.dp(12.0f) + rect.right, AndroidUtilities.dp(6.0f) + rect.bottom), this.maxWidth, new SpannableStringBuilder(formatText(pageblockblockquoteblocks.caption, setBlockFlags(i26, 11))));
            ...
            this.quotes.add(new QuoteBackground(i32, this.blocks.size() - 1, i29, i9));
            return null;
        }
        if (pageBlock instanceof TL_iv.pageBlockPullquote) {
            TL_iv.pageBlockPullquote pageblockpullquote = (TL_iv.pageBlockPullquote) pageBlock;
            CharSequence formatText3 = formatText(pageBlock.text, setBlockFlags(i26, getBlockTextFlag(pageBlock)));
            TL_iv.RichText richText3 = pageblockpullquote.caption;
            RichPullquoteBlock richPullquoteBlock = new RichPullquoteBlock(this, new Rect(AndroidUtilities.dp(30.0f) + rect.left, AndroidUtilities.dp(16.0f) + rect.top, AndroidUtilities.dp(30.0f) + rect.right, AndroidUtilities.dp(16.0f) + rect.bottom), this.maxWidth, formatText3, (richText3 == null || TextUtils.isEmpty(getString(richText3))) ? null : formatText(pageblockpullquote.caption, setBlockFlags(i26, 11)));
        ...
        if (pageBlock instanceof TL_iv.pageBlockPhoto) {
            ...
            emitCaption(pageblockphoto.caption, rect, i26);
        ...
        if (pageBlock instanceof TL_iv.pageBlockVideo) {
            ...
            emitCaption(pageblockvideo.caption, rect, i26);
        ...
        if (pageBlock instanceof TL_iv.pageBlockCollage) {
            ...
            emitCaption(pageblockcollage.caption, rect, i26);
        ...
        if (pageBlock instanceof TL_iv.pageBlockSlideshow) {
            ...
            emitCaption(pageblockslideshow.caption, rect, i26);
        ...
        if (pageBlock instanceof TL_iv.pageBlockMap) {
            ...
            emitCaption(pageblockmap.caption, rect, i26);
            return richMapBlock;
        }
        if (pageBlock instanceof TL_iv.pageBlockAudio) {
            ...
            if (this.audioBlocks.get(pageblockaudio) == null && (document = getDocument(pageblockaudio.audio_id)) != null) {
                TLRPC.TL_message tL_message = new TLRPC.TL_message();
                tL_message.out = true;
                int i33 = -Long.valueOf(pageblockaudio.audio_id).hashCode();
                pageblockaudio.mid = i33;
                tL_message.id = i33;
            ...
            emitCaption(pageblockaudio.caption, rect, i26);
        ...
        if (pageBlock instanceof TL_iv.pageBlockDocument) {
            ...
            emitCaption(pageblockdocument.caption, rect, i26);
            return richDocumentBlock;
        }
        if (pageBlock instanceof TL_iv.pageBlockCover) {
            return emitBlock(((TL_iv.pageBlockCover) pageBlock).cover, i9, rect, i26, false);
        }
        ...
        if (pageBlock instanceof TL_iv.pageBlockUnsupported) {
            int dp4 = g7.z7.a(i26, 9) ? AndroidUtilities.dp(6.0f) : i9 > 0 ? AndroidUtilities.dp(4.0f) : 0;
            RichUnsupportedBlock richUnsupportedBlock = new RichUnsupportedBlock(this, new Rect((rect.left + dp4) - AndroidUtilities.dp(7.0f), Math.max(AndroidUtilities.dp(14.0f), rect.top), (rect.right + dp4) - AndroidUtilities.dp(7.0f), Math.max(AndroidUtilities.dp(14.0f), rect.bottom)), this.maxWidth, this.blocks.size(), i9);
        ...
        RichDetailsBlock richDetailsBlock = new RichDetailsBlock(this, rect, this.maxWidth, pageblockdetails, formatText(pageblockdetails.title, i26 & (-17)));
        this.blocks.add(richDetailsBlock);
        int i34 = 0;
        while (i34 < pageblockdetails.blocks.size()) {
            int i35 = i26;
            emitBlock(pageblockdetails.blocks.get(i34), i9 + 1, rect, i35, previousBlockIsParagraph(pageblockdetails.blocks, i34));
            i34++;
            i26 = i35;
        }
    ...
    private int getBlockBottom(int i9, org.telegram.ui.Cells.s1 s1Var) {
        ...
        while (r3 < this.blocks.size()) {
            ...
            if (isVisible) {
                int height = ((s1Var == null || !(this.detailsAnimating || this.blockquoteAnimating)) ? richBlock2.getHeight() : AndroidUtilities.lerp(richBlock2.prevH, richBlock2.currH, Math.max(0.0f, Math.min(1.0f, s1Var.K1)))) + i10;
                i10 = (r3 != i9 || richBlock2.padding.bottom <= AndroidUtilities.dp(4.0f)) ? height : l0.A(4.0f, richBlock2.padding.bottom, height);
            }
            if (r3 == i9) {
                return i10;
            }
    ...
    private int getBlockTop(int i9, org.telegram.ui.Cells.s1 s1Var) {
        ...
        for (int i11 = 0; i11 < this.blocks.size(); i11++) {
            ...
            if (isVisible) {
                i10 = ((s1Var == null || !(this.detailsAnimating || this.blockquoteAnimating)) ? richBlock2.getHeight() : AndroidUtilities.lerp(richBlock2.prevH, richBlock2.currH, Math.max(0.0f, Math.min(1.0f, s1Var.K1)))) + i10;
                z10 = true;
            }
        }
        return this.height;
    ...
    public Drawable getThemedDrawable(String str) {
        ...
        return drawable != null ? drawable : org.telegram.ui.ActionBar.f6.O0(str);
    }
    ...
    private static String orderedListMarker(TL_iv.pageBlockOrderedList pageblockorderedlist, TL_iv.PageListOrderedItem pageListOrderedItem, int i9) {
        if (!TextUtils.isEmpty(pageListOrderedItem.num)) {
            return pageListOrderedItem.num.endsWith(".") ? pageListOrderedItem.num : aa.d.r(new StringBuilder(), pageListOrderedItem.num, ".");
        }
    ...
    private static boolean previousBlockIsParagraph(List<TL_iv.PageBlock> list, int i9) {
        return i9 > 0 && (list.get(i9 - 1) instanceof TL_iv.pageBlockParagraph);
    }
    ...
    private boolean scrollToPageBlockAnchor(int i9) {
        ...
        recyclerView.v0(0, (((this.cell.getTop() + this.cell.n0) + getBlockTop(i9, null)) - recyclerView.getPaddingTop()) - AndroidUtilities.dp(8.0f), null);
        return true;
    }

    public static int setBlockFlags(int i9, int i10) {
        return i10 == 0 ? i9 : (i9 & (-16)) | i10;
    }
    ...
    private void setSpansWithoutClash(Object obj, final SpannableStringBuilder spannableStringBuilder, int i9, int i10) {
        ...
        Arrays.sort(styleSpanArr, Comparator$-CC.comparingInt(new ToIntFunction() { // from class: org.telegram.messenger.mh
    ...
    private void setStyleRange(SpannableStringBuilder spannableStringBuilder, int i9, int i10, int i11) {
        while (i9 < i10) {
            ...
            spannableStringBuilder.setSpan(new StyleSpan(this, i11, ((URLSpan[]) spannableStringBuilder.getSpans(i9, nextSpanTransition, URLSpan.class)).length > 0), i9, nextSpanTransition, 33);
    ...
    private boolean showFootnoteSheet(TL_iv.textAnchor textanchor) {
        ...
        CharSequence formatText = formatText(org.telegram.ui.web.d2.d(textanchor.text, "", str == null ? "" : str.toLowerCase()));
        ...
        g10.setTextColor(getThemedColor(i9));
        ...
        l80Var.setTextColor(getThemedColor(i9));
    ...
    private SpannableStringBuilder toRichHtmlSpannable(CharSequence charSequence) {
        ...
        for (StyleSpan styleSpan : (StyleSpan[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length(), StyleSpan.class)) {
            ...
            if (spanEnd > spanStart && (textStyleFlags = toTextStyleFlags(styleSpan.flags)) != 0) {
                vz0 vz0Var = new vz0();
                vz0Var.a = textStyleFlags;
                spannableStringBuilder.setSpan(new wz0(vz0Var, 0), spanStart, spanEnd, 33);
            }
        }
        return spannableStringBuilder;
    }
    ...
    private static int toTextStyleFlags(int i9) {
        ...
        return (i9 & 8192) != 0 ? 65536 | i10 : i10;
    }
    ...
    public void checkQuoteLine(TLRPC.User user, TLRPC.Chat chat) {
        ...
        org.telegram.ui.ActionBar.b6 b6Var = this.resourcesProvider;
        this.quoteLine.q(org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.Oh, this.resourcesProvider), b6Var != null ? b6Var.a() : org.telegram.ui.ActionBar.f6.I.q());
    }
    ...
    public void draw(Canvas canvas, int i9, int i10, org.telegram.ui.Cells.s1 s1Var) {
        ...
        this.textPaint.linkColor = getThemedColor(isOut() ? org.telegram.ui.ActionBar.f6.hc : org.telegram.ui.ActionBar.f6.gc);
    ...
    public String getSelectionHtml(int i9, int i10) {
        ...
        while (i11 < richMessageLayout.textBlocks.size()) {
            ...
            if (layout != null && layout.getText() != null) {
                ...
                int intValue = i11 < richMessageLayout.textBlockCharOffsets.size() ? richMessageLayout.textBlockCharOffsets.get(i11).intValue() : 0;
                int length = text.length() + intValue;
                int max2 = Math.max(min, intValue);
                int min2 = Math.min(max, length);
                if (min2 > max2) {
                    int intValue2 = i11 < richMessageLayout.textBlockBlockIndex.size() ? richMessageLayout.textBlockBlockIndex.get(i11).intValue() : -1;
                    ...
                    if (!(richBlock instanceof RichTableBlock)) {
                        ...
                        int i13 = max2 - intValue;
                        int i14 = min2 - intValue;
                        int i15 = richBlock instanceof RichTextBlock ? ((RichTextBlock) richBlock).quoteAuthorStart : -1;
                        boolean z10 = (richBlock instanceof RichTextWithAuthorBlock) && ((RichTextWithAuthorBlock) richBlock).author == richMessageLayout.textBlocks.get(i11);
                        int i16 = richBlock != null ? richBlock.listLevel : 0;
                        if (i16 <= 0 || i15 >= 0) {
                            richMessageLayout.closeLists(sb2, arrayList2);
                            if (richBlock instanceof RichPreformattedBlock) {
                                SpannableStringBuilder richHtmlSpannable = richMessageLayout.toRichHtmlSpannable(text.subSequence(i13, i14));
                                ...
                                if (!sb4.isEmpty()) {
                                    ...
                                    if (TextUtils.isEmpty(str2)) {
                                        ...
                                        sb5.append(qh.u3.s(str2));
                                        sb5.append("\">");
                                    }
                                    str = aa.d.r(sb5, sb4, "</pre>");
                                }
                                sb2.append(str);
                            } else if (z10) {
                                richMessageLayout.appendSelectionPiece(sb2, text, i13, i14, true);
                                richMessageLayout = this;
                            } else if (i15 < 0) {
                                richMessageLayout = this;
                                richMessageLayout.appendSelectionPiece(sb2, text, i13, i14, false);
                            } else {
                                richMessageLayout = this;
                                richMessageLayout.appendSelectionPiece(sb2, text, i13, Math.min(i14, i15 > 0 ? i15 - 1 : 0), false);
                                richMessageLayout.appendSelectionPiece(sb2, text, Math.max(i13, i15), i14, true);
                            }
                        } else {
                            richMessageLayout.syncLists(sb2, arrayList2, i16, richBlock.listOrdered);
                            sb2.append("<li");
                            ...
                            sb2.append('>');
                            SpannableStringBuilder richHtmlSpannable2 = richMessageLayout.toRichHtmlSpannable(text.subSequence(i13, i14));
                            StringBuilder sb6 = new StringBuilder();
                            qh.u3.g(sb6, richHtmlSpannable2);
                            sb2.append(sb6.toString());
                            sb2.append("</li>");
                        }
                    } else if (intValue2 != i12) {
                        richMessageLayout.closeLists(sb2, arrayList2);
                        richMessageLayout.syncQuotes(sb2, arrayList, richMessageLayout.quotesFor(intValue2));
                        TL_iv.pageBlockTable pageblocktable = ((RichTableBlock) richBlock).pageBlock;
                        if (pageblocktable != null) {
                            StringBuilder sb7 = new StringBuilder();
                            qh.u3.H(sb7, pageblocktable);
                            str = sb7.toString();
                        }
                        sb2.append(str);
                        i12 = intValue2;
    ...
    public boolean hasOverlay() {
        ...
        for (int i9 = 0; i9 < this.textBlocks.size(); i9++) {
            ...
            if ((y9Var instanceof Text) && (p5Var = ((Text) y9Var).animatedEmojiStack) != null && !p5Var.a.isEmpty()) {
                return true;
            }
        }
        return false;
    ...
    public boolean isOverlayActive() {
        ej0 ej0Var = this.typingAnimator;
        return ej0Var == null || !ej0Var.h;
    }

    public boolean isPinnedTop() {
        org.telegram.ui.Cells.t1 t1Var = this.cell;
        return t1Var != null && t1Var.n3();
    }
    ...
    public void layout(RichMessageLayout richMessageLayout) {
        ...
        int i10 = 0;
        while (i10 < this.richMessage.blocks.size()) {
            TL_iv.PageBlock pageBlock = this.richMessage.blocks.get(i10);
            RichBlock emitBlock = emitBlock(pageBlock, 0, new Rect(), 0, previousBlockIsParagraph(this.richMessage.blocks, i10));
            if ((emitBlock instanceof RichTextBlock) && (((z10 = pageBlock instanceof TL_iv.pageBlockParagraph)) || org.telegram.ui.l4.K(pageBlock))) {
                ...
                richTextBlock.setContentPadding((i10 == 0 && z10) ? 0 : richTextBlock.contentPaddingTop, i10 == this.richMessage.blocks.size() + (-1) ? 0 : richTextBlock.contentPaddingBottom);
            }
            i10++;
        }
        ...
        if (this.typingAnimator != null) {
            for (int i11 = 0; i11 < this.blocks.size(); i11++) {
                this.blocks.get(i11).typingAnimator = this.typingAnimator;
            }
            this.typingAnimator.l(getAnimatorBlocks());
        }
        if (view != null) {
            for (int i12 = 0; i12 < this.blocks.size(); i12++) {
                this.blocks.get(i12).attach(view);
            }
        }
        reposition();
    ...
    public boolean needsUpdate(TL_iv.RichMessage richMessage, int i9) {
        return (this.richMessage == richMessage && this.fontSize == SharedConfig.fontSize && Math.abs(this.density - AndroidUtilities.density) <= 0.1f && i9 == this.maxWidth) ? false : true;
    }
            ...
            if (this.isPart) {
                ...
                if (actionMasked == 0) {
                    ...
                    if (actionMasked == 2) {
                        ...
                        boolean z10 = actionMasked == 1 && this.showMoreRect.contains(x10, y10);
                        this.showMorePressed = false;
    ...
    public CharSequence formatText(TL_iv.RichText richText, int i9) {
        return i9 == 0 ? formatText(richText, new SpannableStringBuilder(), 0) : formatTextAndSetSpan(richText, new SpannableStringBuilder(), i9, new StyleSpan(this, i9));
    }
    ...
    public static class RichUnsupportedBlock extends RichBlock implements Drawable.Callback {
        ...
        public RichUnsupportedBlock(RichMessageLayout richMessageLayout, Rect rect, int i9, int i10, int i11) {
            ...
            l51Var.n = LocaleController.getString(R.string.UnsupportedBlockTitle);
            l51Var.o = LocaleController.getString(R.string.UnsupportedBlockMessage);
            l51Var.p = LocaleController.getString(R.string.UnsupportedUpdate);
            l51Var.j = new ng(richMessageLayout, 9);
            int i12 = this.maxWidth;
    ...
    public CharSequence formatText(TL_iv.RichText richText, SpannableStringBuilder spannableStringBuilder, int i9) {
        ...
        if (richText instanceof TL_iv.textDiff) {
            ...
            if (richText instanceof TL_iv.textEmail) {
                formatTextAndSetSpan(richText.text, spannableStringBuilder, i9, new r41("mailto:" + ((TL_iv.textEmail) richText).email, getTextStyleRun(1024)));
                return spannableStringBuilder;
            }
            if (richText instanceof TL_iv.textConcat) {
                ...
                if (richText instanceof TL_iv.textAnchor) {
                    ...
                    formatTextAndSetSpan(richText2, spannableStringBuilder, i9, new AnchorSpan(str2 != null ? str2.toLowerCase() : ""));
                    return spannableStringBuilder;
                }
                if (richText instanceof TL_iv.textMath) {
                    ...
                    spannableStringBuilder.setSpan(new oz0(null, textmath.bitmap, textmath.w, textmath.h, org.telegram.ui.ActionBar.f6.v0(org.telegram.ui.ActionBar.f6.G6, this.resourcesProvider), textmath.depth), length, length2, 33);
                    ...
                    if (richText instanceof TL_iv.textMention) {
                        ...
                        vz0 vz0Var = new vz0();
                        vz0Var.d = tL_messageEntityMention;
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i9, new p41(getString(richText), vz0Var));
                        return spannableStringBuilder;
                    }
                    if (richText instanceof TL_iv.textHashtag) {
                        ...
                        vz0 vz0Var2 = new vz0();
                        vz0Var2.d = tL_messageEntityHashtag;
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i9, new p41(getString(richText), vz0Var2));
                        return spannableStringBuilder;
                    }
                    ...
                    if (richText instanceof TL_iv.textCashtag) {
                        ...
                        vz0 vz0Var3 = new vz0();
                        vz0Var3.d = tL_messageEntityCashtag;
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i9, new p41(getString(richText), vz0Var3));
                        return spannableStringBuilder;
                    }
                    ...
                    if (richText instanceof TL_iv.textMentionName) {
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i9, new s41("" + ((TL_iv.textMentionName) richText).user_id, isOut() ? 1 : 0, null));
                        return spannableStringBuilder;
                    }
    ...
    public static class MediaCell implements DownloadController.FileDownloadProgressListener {
        ...
        private MediaCell(RichMessageLayout richMessageLayout, TL_iv.pageBlockPhoto pageblockphoto) {
            ...
            TLRPC.PhotoSize photoSize = this.sizeFull;
            this.aspectRatio = (photoSize == null || (i9 = photoSize.h) <= 0) ? 1.0f : photoSize.w / i9;
        ...
        private void didPressButton(View view, boolean z10) {
            ...
            if (i9 != 2) {
                if (i9 != 3 || this.root.delegate == null) {
                    return;
                }
        ...
        private boolean isOnButton(float f10, float f11) {
            ...
            return f11 >= ((float) i10) && f11 <= ((float) (i10 + i9));
        }
        ...
        public void ensureProgress(View view) {
            ...
            if (radialProgress2 != null || view == null) {
                ...
                radialProgress22.q(i9, i10, i9 + i11, i11 + i10);
                return;
            }
        ...
        public boolean isInside(float f10, float f11) {
            ...
            int i9 = this.y;
            return f11 >= ((float) i9) && f11 <= ((float) (i9 + this.h));
        }
        ...
        public void updateButtonState(View view, boolean z10) {
            ...
            if (fileExists() || (this.isVideo && z11)) {
                ...
                if (this.realVideo && !z11) {
                    ...
                    RadialProgress2 radialProgress22 = this.radialProgress;
                    if (radialProgress22 != null) {
                        radialProgress22.setIcon(0, false, z10);
                    }
                } else if (!this.isVideo || z11 || allowAutoplay() || this.mediaForced) {
                    this.buttonState = -1;
                    RadialProgress2 radialProgress23 = this.radialProgress;
                    if (radialProgress23 != null) {
                        radialProgress23.setIcon(4, false, z10);
                    }
                } else {
                    this.buttonState = 2;
                    RadialProgress2 radialProgress24 = this.radialProgress;
                    if (radialProgress24 != null) {
                        radialProgress24.setIcon(8, false, z10);
                    }
                }
            } else {
    ...
    public static class RichAudioBlock extends RichBlock implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
        ...
        public void onDraw(Canvas canvas) {
            ...
            int i10 = this.maxWidth;
            RichMessageLayout richMessageLayout = this.root;
            if (i9 != i10 + richMessageLayout.padLeft + richMessageLayout.padRight) {
                layoutInner();
            }
            canvas.save();
            canvas.translate(-this.root.padLeft, 0.0f);
            this.radialProgress.g(this.root.isOut() ? org.telegram.ui.ActionBar.f6.Nb : org.telegram.ui.ActionBar.f6.ie, this.root.isOut() ? org.telegram.ui.ActionBar.f6.Ob : org.telegram.ui.ActionBar.f6.je, this.root.isOut() ? org.telegram.ui.ActionBar.f6.Pa : org.telegram.ui.ActionBar.f6.uc, this.root.isOut() ? org.telegram.ui.ActionBar.f6.Qa : org.telegram.ui.ActionBar.f6.vc);
            RadialProgress2 radialProgress2 = this.radialProgress;
            RichMessageLayout richMessageLayout2 = this.root;
            radialProgress2.d = richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.Db : org.telegram.ui.ActionBar.f6.Bd);
            this.radialProgress.draw(canvas);
            ln0 ln0Var = this.seekBar;
            RichMessageLayout richMessageLayout3 = this.root;
            int themedColor = richMessageLayout3.getThemedColor(richMessageLayout3.isOut() ? org.telegram.ui.ActionBar.f6.wb : org.telegram.ui.ActionBar.f6.ud);
            RichMessageLayout richMessageLayout4 = this.root;
            int themedColor2 = richMessageLayout4.getThemedColor(richMessageLayout4.isOut() ? org.telegram.ui.ActionBar.f6.xb : org.telegram.ui.ActionBar.f6.vd);
            RichMessageLayout richMessageLayout5 = this.root;
            int themedColor3 = richMessageLayout5.getThemedColor(richMessageLayout5.isOut() ? org.telegram.ui.ActionBar.f6.zb : org.telegram.ui.ActionBar.f6.xd);
            RichMessageLayout richMessageLayout6 = this.root;
            int themedColor4 = richMessageLayout6.getThemedColor(richMessageLayout6.isOut() ? org.telegram.ui.ActionBar.f6.zb : org.telegram.ui.ActionBar.f6.xd);
            RichMessageLayout richMessageLayout7 = this.root;
            ln0Var.h(themedColor, themedColor2, themedColor3, themedColor4, richMessageLayout7.getThemedColor(richMessageLayout7.isOut() ? org.telegram.ui.ActionBar.f6.yb : org.telegram.ui.ActionBar.f6.wd));
            canvas.save();
        ...
        public void updateButtonState(boolean z10) {
            ...
            File pathToAttach = this.currentDocument == null ? null : FileLoader.getInstance(i9).getPathToAttach(this.currentDocument, true);
        ...
        public void updatePlayingMessageProgress() {
            ...
            if (!MediaController.getInstance().isPlayingMessage(this.currentMessageObject)) {
                ...
                int i10 = 0;
                while (true) {
                    if (i10 >= this.currentDocument.attributes.size()) {
                        break;
                    }
                    TLRPC.DocumentAttribute documentAttribute = this.currentDocument.attributes.get(i10);
            ...
            RichMessageLayout richMessageLayout = this.root;
            textPaint.setColor(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.fc : org.telegram.ui.ActionBar.f6.ec));
            View view = this.view;
            if (view != null) {
                view.invalidate();
            }
    ...
    public static class RichDocumentBlock extends RichBlock implements DownloadController.FileDownloadProgressListener {
        ...
        private void rebuildLayouts() {
            ...
            int b10 = l0.b(48.0f, this.layoutWidth - (this.hasPreview ? AndroidUtilities.dp(97.0f) + this.previewX : this.buttonTextSpacing + (this.buttonX + this.buttonSize)), AndroidUtilities.dp(40.0f));
            ...
            TLRPC.Document document = this.document;
            CharSequence ellipsize = TextUtils.ellipsize(document == null ? "" : FileLoader.getDocumentFileName(document), this.titlePaint, b10, TextUtils.TruncateAt.END);
            ...
            this.sizeLayout = new StaticLayout(document2 != null ? AndroidUtilities.formatFileSize(document2.size) : "", this.sizePaint, b10, alignment, 1.0f, 0.0f, false);
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (!this.hasPreview || this.previewImage.draw(canvas)) {
                ...
                RichMessageLayout richMessageLayout = this.root;
                paint.setColor(richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.Ib : org.telegram.ui.ActionBar.f6.Gd));
                canvas2 = canvas;
            ...
            TextPaint textPaint = this.titlePaint;
            RichMessageLayout richMessageLayout2 = this.root;
            textPaint.setColor(richMessageLayout2.getThemedColor(richMessageLayout2.isOut() ? org.telegram.ui.ActionBar.f6.Fb : org.telegram.ui.ActionBar.f6.Dd));
            TextPaint textPaint2 = this.sizePaint;
            RichMessageLayout richMessageLayout3 = this.root;
            textPaint2.setColor(richMessageLayout3.getThemedColor(richMessageLayout3.isOut() ? org.telegram.ui.ActionBar.f6.sb : org.telegram.ui.ActionBar.f6.nd));
            ...
            canvas2.restore();
            if (canShowOptions()) {
                Drawable themedDrawable = this.root.isOut() ? this.root.getThemedDrawable("drawableMsgOutMenu") : org.telegram.ui.ActionBar.f6.c4;
                int menuX = getMenuX();
        ...
        */
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.optionsPressed) {
                ...
                if (motionEvent.getActionMasked() == 1 || motionEvent.getActionMasked() == 3) {
                    boolean z11 = motionEvent.getActionMasked() == 1 && contains;
                    this.optionsPressed = false;
                    if (z11 && this.document != null && canShowOptions()) {
                        ...
                        int i9 = this.padding.left;
                        int i10 = this.root.padLeft;
                        getMenuX();
                        this.root.cell.getTextY();
                        int i11 = this.padding.top;
                        AndroidUtilities.dp(7.0f);
                        this.root.delegate.g1(this.root.cell, this.document);
                        return true;
                    }
                    return true;
                }
        ...
        public void updateButtonState(boolean z10) {
            if (this.hasPreview) {
                this.radialProgress.g(org.telegram.ui.ActionBar.f6.le, org.telegram.ui.ActionBar.f6.me, org.telegram.ui.ActionBar.f6.ne, org.telegram.ui.ActionBar.f6.oe);
                this.radialProgress.d = this.root.getThemedColor(org.telegram.ui.ActionBar.f6.hd);
            } else {
                this.radialProgress.g(this.root.isOut() ? org.telegram.ui.ActionBar.f6.Nb : org.telegram.ui.ActionBar.f6.ie, this.root.isOut() ? org.telegram.ui.ActionBar.f6.Ob : org.telegram.ui.ActionBar.f6.je, this.root.isOut() ? org.telegram.ui.ActionBar.f6.Pa : org.telegram.ui.ActionBar.f6.uc, this.root.isOut() ? org.telegram.ui.ActionBar.f6.Qa : org.telegram.ui.ActionBar.f6.vc);
                RadialProgress2 radialProgress2 = this.radialProgress;
                RichMessageLayout richMessageLayout = this.root;
                radialProgress2.d = richMessageLayout.getThemedColor(richMessageLayout.isOut() ? org.telegram.ui.ActionBar.f6.Db : org.telegram.ui.ActionBar.f6.Bd);
            }
    ...
    public static abstract class RichMediaBlock extends RichBlock implements DownloadController.FileDownloadProgressListener {
        ...
        private void updateRoundRadius(ImageReceiver imageReceiver, boolean z10) {
            ...
            int dp = i9 > 2 ? AndroidUtilities.dp(i9 - 2) : AndroidUtilities.dp(i9);
            int min = Math.min(AndroidUtilities.dp(3.0f), dp);
            int i10 = (!this.first || this.root.hasNameOffset() || (!this.root.isOut() && this.root.isPinnedTop())) ? min : dp;
        ...
        public void onDraw(Canvas canvas) {
            ...
            int minWidth = this.root.getMinWidth();
            Rect rect = this.padding;
            int i9 = (minWidth - rect.left) - rect.right;
            boolean isInQuote = isInQuote();
            int dp = AndroidUtilities.dp(2.0f);
            ...
            if (isInQuote) {
                canvas.save();
                this.clipPath.rewind();
                this.clipPath.addRoundRect(0.0f, 0.0f, i9, this.imgHeight, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), Path.Direction.CW);
                canvas.clipPath(this.clipPath);
            }
            if (!this.imageReceiver.hasBitmapImage() || this.imageReceiver.getCurrentAlpha() != 1.0f) {
                canvas.drawRect(-i10, 0.0f, i9 + i11, this.imgHeight, mediaBgPaint);
            }
            if (z10) {
                prepareBlurImage();
                updateRoundRadius(this.blurImageReceiver, false);
                ...
                if (this.blurImageReceiver.getBitmap() != null) {
                    this.blurImageReceiver.setImageCoords(-i10, 0.0f, i10 + i9 + i11, this.imgHeight);
                    this.blurImageReceiver.setAlpha(this.imageReceiver.getCurrentAlpha());
                    this.blurImageReceiver.draw(canvas);
                }
                ...
                this.imageReceiver.setImageCoords(-i10, 0.0f, i10 + i9 + i11, this.imgHeight);
            }
            this.imageReceiver.draw(canvas);
            if (isSpoiler() && !this.spoilerReveal.fullyRevealed()) {
        ...
        */
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            float y10 = motionEvent.getY() - this.padding.top;
            boolean z11 = x10 >= 0.0f && x10 <= ((float) this.imgWidth) && y10 >= 0.0f && y10 <= ((float) this.imgHeight);
            int i9 = this.buttonState;
            if (i9 != -1) {
                if (x10 >= this.buttonX) {
                    int i10 = this.buttonSize;
                    if (x10 <= r6 + i10) {
                        if (y10 >= this.buttonY && y10 <= r1 + i10) {
                            z10 = true;
                            if (actionMasked != 0) {
                                if (!z11 || (!z10 && i9 != 0 && i9 != 2)) {
                                    if (!z11) {
                                        return false;
                                    }
                                    this.photoPressed = true;
