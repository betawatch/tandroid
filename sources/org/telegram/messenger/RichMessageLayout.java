...
public class RichMessageLayout {
    ...
    public static class PreviewView extends View implements org.telegram.ui.Cells.q9 {
        ...
        public static final class Factory extends x51 {
            ...
            public boolean contentsEquals(y51 y51Var, y51 y51Var2) {
                return y51Var.d == y51Var2.d && y51Var.G == y51Var2.G && y51Var.e == y51Var2.e;
            }
        ...
        public void setLoading(boolean z10) {
            ...
            if (z10) {
                ...
                if (r90Var == null) {
                    ...
                    r90Var2.C = true;
                    r90Var2.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                } else {
                    r90Var.b = -1L;
                    r90Var.c = -1L;
                }
        ...
        public RichButton(RichMessageLayout richMessageLayout, int i10, CharSequence charSequence, TL_keyboard.PageButton pageButton, TL_keyboard.InlineButtonType inlineButtonType, TL_keyboard.RichButtonStyle richButtonStyle, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, Boolean bool, Runnable runnable) {
            ...
            if (richButtonStyle != null) {
                ...
                if (z14) {
                    ...
                    spannableStringBuilder.setSpan(new c61("", (e11) null), 0, spannableStringBuilder.length(), 33);
                }
    ...
    public static class RichTableBlock extends RichBlock implements wz0 {
        ...
        public RichTableBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, TL_iv.pageBlockTable pageblocktable) {
            ...
            if (pageblocktable.compact) {
                ...
                if (xz0Var.v != dp || xz0Var.r != dp2 || xz0Var.s != dp3) {
                    xz0Var.v = dp;
                    xz0Var.r = dp2;
                    xz0Var.s = dp3;
            ...
            xz0Var.setMinimumCellHeight(AndroidUtilities.dp(pageblocktable.compact ? 18.0f : 36.0f));
            ...
            while (true) {
                ...
                if (u5Var3 == null || u5Var3.a.isEmpty()) {
                    ...
                    while (i12 < childCount) {
                        pz0 pz0Var = this.tableLayout.d(i12).b;
                        if (!(pz0Var instanceof Text) || (u5Var = (text = (Text) pz0Var).animatedEmojiStack) == null || u5Var.a.isEmpty()) {
                            i10 = i12;
                        } else {
                            canvas.save();
        ...
        public boolean findLink(CharacterStyle characterStyle, int i10, FoundLink foundLink) {
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                pz0 pz0Var = this.tableLayout.d(i11).b;
                if (pz0Var instanceof Text) {
                    if (((Text) pz0Var).fillFoundLink(characterStyle, foundLink)) {
        ...
        @Override // org.telegram.ui.Components.wz0
        public /* bridge */ /* synthetic */ void onLayoutChild(pz0 pz0Var, int i10, int i11) {
        }
    }
    ...
    public static class Text implements org.telegram.ui.Cells.ca, pz0 {
        ...
        private void dispatchLinkClick(CharacterStyle characterStyle, boolean z10) {
            ...
            CharacterStyle b61Var = ((characterStyle instanceof StyleSpan) && TLObject.hasFlag(((StyleSpan) characterStyle).flags, 256)) ? new b61(this.layout.getText(), this.pressedLinkStart, this.pressedLinkEnd, this.root.isOut() ? (byte) 1 : (byte) 0, null) : characterStyle;
            org.telegram.ui.Cells.l1 delegate = this.root.getDelegate();
            org.telegram.ui.Cells.u1 cell = this.root.getCell();
    ...
    */
    ...
    private void drawShowMoreButton(Canvas canvas, int i10) {
        ...
        if (r90Var2 == null && z10) {
            ...
            r90Var3.w.setStrokeWidth(AndroidUtilities.dp(1.25f));
    ...
    private boolean showFootnoteSheet(TL_iv.textAnchor textanchor) {
        ...
        n90Var.setTextColor(getThemedColor(i10));
    ...
    private SpannableStringBuilder toRichHtmlSpannable(CharSequence charSequence) {
        ...
        for (StyleSpan styleSpan : (StyleSpan[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length(), StyleSpan.class)) {
            ...
            if (spanEnd > spanStart && (textStyleFlags = toTextStyleFlags(styleSpan.flags)) != 0) {
                e11 e11Var = new e11();
                e11Var.a = textStyleFlags;
                spannableStringBuilder.setSpan(new f11(e11Var, 0), spanStart, spanEnd, 33);
            }
        }
        return spannableStringBuilder;
    }
    ...
    public static class RichUnsupportedBlock extends RichBlock implements Drawable.Callback {
        ...
        public RichUnsupportedBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, int i11, int i12) {
            ...
            x61Var.n = LocaleController.getString(R.string.UnsupportedBlockTitle);
            x61Var.o = LocaleController.getString(R.string.UnsupportedBlockMessage);
            x61Var.p = LocaleController.getString(R.string.UnsupportedUpdate);
            x61Var.j = new vg(richMessageLayout, 9);
            int i13 = this.maxWidth;
    ...
    public CharSequence formatText(TL_iv.RichText richText, SpannableStringBuilder spannableStringBuilder, int i10) {
        ...
        if (richText instanceof TL_iv.textDiff) {
            ...
            if (richText instanceof TL_iv.textEmail) {
                formatTextAndSetSpan(richText.text, spannableStringBuilder, i10, new e61("mailto:" + ((TL_iv.textEmail) richText).email, getTextStyleRun(1024)));
                return spannableStringBuilder;
            }
            if (richText instanceof TL_iv.textConcat) {
                ...
                if (richText instanceof TL_iv.textMath) {
                    ...
                    spannableStringBuilder.setSpan(new x01(null, textmath.bitmap, textmath.w, textmath.h, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.resourcesProvider), textmath.depth), length, length2, 33);
                    ...
                    if (richText instanceof TL_iv.textMention) {
                        ...
                        e11 e11Var = new e11();
                        e11Var.d = tL_messageEntityMention;
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i10, new c61(getString(richText), e11Var));
                        return spannableStringBuilder;
                    }
                    if (richText instanceof TL_iv.textHashtag) {
                        ...
                        e11 e11Var2 = new e11();
                        e11Var2.d = tL_messageEntityHashtag;
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i10, new c61(getString(richText), e11Var2));
                        return spannableStringBuilder;
                    }
                    ...
                    if (richText instanceof TL_iv.textCashtag) {
                        ...
                        e11 e11Var3 = new e11();
                        e11Var3.d = tL_messageEntityCashtag;
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i10, new c61(getString(richText), e11Var3));
                        return spannableStringBuilder;
                    }
                    ...
                    if (richText instanceof TL_iv.textMentionName) {
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i10, new f61("" + ((TL_iv.textMentionName) richText).user_id, isOut() ? 1 : 0, null));
                        return spannableStringBuilder;
                    }
    ...
    public static class RichAudioBlock extends RichBlock implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
        ...
        public void onDraw(Canvas canvas) {
            ...
            qo0Var.h(themedColor, themedColor2, themedColor3, themedColor4, richMessageLayout7.getThemedColor(richMessageLayout7.isOut() ? org.telegram.ui.ActionBar.j6.yb : org.telegram.ui.ActionBar.j6.wd));
            canvas.save();
