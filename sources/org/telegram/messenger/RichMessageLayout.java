...
public class RichMessageLayout {
    ...
    public static class PreviewView extends View implements org.telegram.ui.Cells.i9 {
        ...
        public static final class Factory extends m41 {
            ...
            public void bindView(View view, n41 n41Var, boolean z10, b51 b51Var, k51 k51Var) {
                ...
                previewView.setTranslationLoading(n41Var.e);
            }

            @Override // org.telegram.ui.Components.m41
            public boolean contentsEquals(n41 n41Var, n41 n41Var2) {
                return n41Var.d == n41Var2.d && n41Var.G == n41Var2.G && n41Var.e == n41Var2.e;
            }
    ...
    public static abstract class RichBlock implements ej0 {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static /* synthetic */ int lambda$withReplacements$0(Spanned spanned, org.telegram.ui.Cells.p9 p9Var, org.telegram.ui.Cells.p9 p9Var2) {
        ...
        public static CharSequence withReplacements(CharSequence charSequence) {
            ...
            for (org.telegram.ui.Cells.p9 p9Var : p9VarArr) {
                ...
                if (spanStart >= 0 && spanEnd >= 0 && spanStart <= spanEnd && spanEnd <= spannableStringBuilder.length()) {
                    CharSequence charSequence2 = p9Var.a;
        ...
        public void drawWithTyping(Canvas canvas) {
            ...
            if (gj0Var != null && gj0Var.h && gj0Var.d(this) >= 0) {
                ...
                if (gj0Var.g(this)) {
                    draw(canvas, gj0Var.g(this) ? gj0Var.e : -1, gj0Var.g(this) ? gj0Var.f : 0.0f);
                    return;
                }
                float c10 = gj0Var.c(this);
                if (c10 <= 0.0f) {
                    return;
                }
                if (c10 < 1.0f) {
        ...
        public boolean findLink(CharacterStyle characterStyle, int i10, FoundLink foundLink) {
            ...
            for (org.telegram.ui.Cells.u9 u9Var : text) {
                if (u9Var instanceof Text) {
                    if (((Text) u9Var).fillFoundLink(characterStyle, foundLink)) {
                        Rect rect = this.padding;
        ...
        public void draw(Canvas canvas, int i10, float f10) {
            ...
            if (this.checkbox != null) {
                ...
                org.telegram.ui.Components.nc ncVar = this.checkboxBounce;
                float a2 = ncVar != null ? ncVar.a(0.1f) : 1.0f;
                canvas.save();
        ...
        public boolean drawOverlay(Canvas canvas, ColorFilter colorFilter) {
            ...
            for (org.telegram.ui.Cells.u9 u9Var : text2) {
                if ((u9Var instanceof Text) && (p5Var = (text = (Text) u9Var).animatedEmojiStack) != null && !p5Var.a.isEmpty()) {
                    canvas.save();
    ...
    public static class RichButton {
        ...
        public void draw(Canvas canvas) {
            ...
            if (drawable != null) {
                gf.s.d(drawable, this.width - AndroidUtilities.dp(ICON_OFFSET_X), AndroidUtilities.dp(this.inline ? ICON_OFFSET_Y_INLINE : ICON_OFFSET_Y), 17);
        ...
        public void setLoading(boolean z10) {
            ...
            if (z10) {
                ...
                if (t80Var == null) {
                    ...
                    t80Var2.C = true;
                    t80Var2.w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                } else {
                    t80Var.b = -1L;
                    t80Var.c = -1L;
                }
        ...
        */
        public RichButton(RichMessageLayout richMessageLayout, int i10, CharSequence charSequence, TL_keyboard.PageButton pageButton, TL_keyboard.InlineButtonType inlineButtonType, TL_keyboard.RichButtonStyle richButtonStyle, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, Boolean bool, Runnable runnable) {
            ...
            if (richButtonStyle != null) {
                ...
                s00 s00Var = new s00(!booleanValue ? y5Var.f : y5Var.c, null);
                this.colorSpan = s00Var;
                s00Var.c = !z10 ? 0.5f : 1.0f;
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(charSequence);
                if (z14) {
            ...
            this.styleKeys = y5Var;
            s00 s00Var2 = new s00(!booleanValue ? y5Var.f : y5Var.c, null);
            this.colorSpan = s00Var2;
            s00Var2.c = !z10 ? 0.5f : 1.0f;
    ...
    public static class RichButtonRowBlock extends RichBlock {
        ...
        public RichButtonRowBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, TL_iv.pageBlockButtonRow pageblockbuttonrow) {
            ...
            this.layoutWidth = -1;
            this.clickHelper = new vd.b(new vd.a() { // from class: org.telegram.messenger.RichMessageLayout.RichButtonRowBlock.1
                @Override // vd.a
        ...
        private RichButtonSpan(RichMessageLayout richMessageLayout, int i10, TL_iv.textButton textbutton, Boolean bool) {
            ...
            if (richText instanceof TL_iv.textConcat) {
                ...
                if (!textconcat.texts.isEmpty()) {
                    ...
                    RichButton richButton = new RichButton(richMessageLayout, i10, formatText, null, inlineButtonType, textbutton.style, inlineButtonType instanceof TL_keyboard.TL_inlineButtonTypeDisabled, true, z10, z11, z12, true, bool, new rg(this, 8));
            ...
            RichButton richButton2 = new RichButton(richMessageLayout, i10, formatText2, null, inlineButtonType2, textbutton.style, inlineButtonType2 instanceof TL_keyboard.TL_inlineButtonTypeDisabled, true, z10, z11, z12, true, bool, new rg(this, 8));
    ...
    public static class RichDetailsBlock extends RichBlock {
        ...
        public RichDetailsBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, TL_iv.pageBlockDetails pageblockdetails, CharSequence charSequence) {
            ...
            Text text = new Text(richMessageLayout, charSequence, i0.a.d(TEXT_RIGHT_DP, this.maxWidth - AndroidUtilities.dp(TEXT_LEFT_DP), 0));
            this.title = text;
        ...
        private int getContentHeight() {
            return y1.b(12.66f, this.title.getHeight() + AndroidUtilities.dp(TEXT_TOP_DP), AndroidUtilities.dp(27.82f));
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            float a2 = ncVar != null ? ncVar.a(0.02f) : 1.0f;
            RichMessageLayout richMessageLayout = this.root;
    ...
    public static class RichMathBlock extends RichBlock {
        ...
        public RichMathBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, TL_iv.pageBlockMath pageblockmath) {
            ...
            rh.q a2 = (pageblockmath == null || TextUtils.isEmpty(pageblockmath.source)) ? null : rh.q.a(pageblockmath.source, AndroidUtilities.dp(richMessageLayout.fontSize + 4), false);
            if (a2 != null) {
                this.bitmap = a2.a;
                this.contentW = a2.b;
                this.contentH = a2.c;
            }
            int D = y1.D(0.0f, 2, this.contentW);
            this.contentWidth = D;
        ...
        public void onDraw(Canvas canvas) {
            ...
            int D = y1.D(8.0f, 2, this.contentH);
    ...
    public static class RichPreformattedBlock extends RichBlock {
        ...
        public RichPreformattedBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, TL_iv.pageBlockPreformatted pageblockpreformatted, RichPreformattedBlock richPreformattedBlock) {
            ...
            this.text = text;
            this.texts = new Text[]{text};
            int D = y1.D(0.0f, 2, Math.max(0, text.right - text.left));
            this.contentWidth = D;
        ...
        private void drawTextContent(Canvas canvas, boolean z10, int i10, float f10) {
            ...
            int D = y1.D(8.0f, 2, this.text.getHeight());
            if (this.padding.left > 0) {
                canvas.save();
        ...
        @Override // org.telegram.messenger.RichMessageLayout.RichBlock, org.telegram.ui.ej0
        public Layout getLayout() {
    ...
    public static class RichSlideshowBlock extends RichBlock {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (size > 1) {
                ...
                int dp5 = AndroidUtilities.dp(4.0f) + y1.D(6.0f, size - 1, AndroidUtilities.dp(7.0f) * size);
    ...
    public static class RichTableBlock extends RichBlock implements sy0 {
        ...
        public RichTableBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, TL_iv.pageBlockTable pageblocktable) {
            ...
            if (pageblocktable.compact) {
                ...
                if (ty0Var.v != dp || ty0Var.r != dp2 || ty0Var.s != dp3) {
                    ty0Var.v = dp;
                    ty0Var.r = dp2;
                    ty0Var.s = dp3;
            ...
            while (i11 < childCount) {
                ...
                if (cellBlock == null) {
                    ...
                    if (d.b instanceof Text) {
                        ...
                        ((Text) d.b).drawFade(canvas, gj0Var.g(cellBlock) ? gj0Var.e : -1, gj0Var.g(cellBlock) ? gj0Var.f : 0.0f);
                        canvas.restore();
                    }
                } else {
                    float c10 = gj0Var.c(cellBlock);
                    if (c10 >= 1.0f) {
                        d.a(canvas, this.view, true);
            ...
            while (true) {
                ...
                if (p5Var3 == null || p5Var3.a.isEmpty()) {
                    ...
                    while (i12 < childCount) {
                        ly0 ly0Var = this.tableLayout.d(i12).b;
                        if (!(ly0Var instanceof Text) || (p5Var = (text = (Text) ly0Var).animatedEmojiStack) == null || p5Var.a.isEmpty()) {
                            i10 = i12;
                        } else {
                            canvas.save();
        ...
        public void drawWithTyping(Canvas canvas) {
            ...
            float c10 = gj0Var.c(this.cellBlocks.get(0));
            if (c10 <= 0.0f) {
                return;
            }
            canvas.save();
            ...
            drawTitle(canvas);
            canvas.translate(0.0f, this.titleHeight);
            drawCellsWithTyping(canvas, gj0Var, c10);
            canvas.restore();
        }
        ...
        public boolean findLink(CharacterStyle characterStyle, int i10, FoundLink foundLink) {
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                ly0 ly0Var = this.tableLayout.d(i11).b;
                if (ly0Var instanceof Text) {
                    if (((Text) ly0Var).fillFoundLink(characterStyle, foundLink)) {
        ...
        @Override // org.telegram.ui.Components.sy0
        public /* bridge */ /* synthetic */ void onLayoutChild(ly0 ly0Var, int i10, int i11) {
        }
    }
    ...
    public static class RichTextBlockQuote extends RichTextBlock {
        ...
        public void onDraw(Canvas canvas) {
            Canvas canvas2;
            org.telegram.ui.Components.nc ncVar = this.bounce;
            float a2 = ncVar != null ? ncVar.a(0.01f) : 1.0f;
            if (a2 != 1.0f) {
                canvas.save();
    ...
    public static final class SpoilerReveal {
        ...
        public void start(final View view, float f10, float f11, float f12, float f13) {
            ...
            this.animator.setInterpolator(er.j);
    ...
    public static class Text implements org.telegram.ui.Cells.u9, ly0 {
        ...
        private static EmojiLineMetrics measureEmojiLine(Spanned spanned, int i10, int i11, TextPaint textPaint) {
            ...
            if (i13 > 0) {
                ...
                int[] iArr = (t5VarArr.length == 0 && emojiSpanArr.length == 0) ? null : new int[i13];
                ...
                while (i14 < length) {
                    ...
                    int spanStart = spanned.getSpanStart(t5Var);
                    int min = Math.min(i11, spanned.getSpanEnd(t5Var));
        ...
        private void revealSpoilers(int i10, int i11) {
            ...
            View view = this.view;
            this.pressedSpoiler.q = new uh(this, view, this.root);
        ...
        public void drawFade(Canvas canvas, int i10, float f10) {
            ...
            gj0.b(canvas, this.layout, i10, f10, new fj0() { // from class: org.telegram.messenger.th
        ...
        public Text(RichMessageLayout richMessageLayout, CharSequence charSequence, int i10, Layout.Alignment alignment, float f10) {
            ...
            int d = rh.v5.d(configureEmojiLineHeights);
    ...
    */
    ...
    private void drawShowMoreButton(Canvas canvas, int i10) {
        ...
        if (t80Var2 == null && z10) {
            ...
            t80Var3.w.setStrokeWidth(AndroidUtilities.dp(1.25f));
    ...
    private RichBlock emitBlock(TL_iv.PageBlock pageBlock, int i10, Rect rect, int i11, boolean z10) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockUnsupported) {
            int dp4 = h7.a8.a(i27, 9) ? AndroidUtilities.dp(6.0f) : i10 > 0 ? AndroidUtilities.dp(4.0f) : 0;
    ...
    private int getBlockBottom(int i10, org.telegram.ui.Cells.r1 r1Var) {
        if (i10 >= 0 && i10 < this.blocks.size() && r1Var != null && (this.detailsAnimating || this.blockquoteAnimating)) {
            ...
            RichBlock richBlock = this.blocks.get(i10);
            int d = i0.a.d(4.0f, richBlock.padding.bottom, 0);
        ...
        while (r3 < this.blocks.size()) {
            ...
            if (isVisible) {
                ...
                i11 = (r3 != i10 || richBlock2.padding.bottom <= AndroidUtilities.dp(4.0f)) ? height : y1.A(4.0f, richBlock2.padding.bottom, height);
            }
            if (r3 == i10) {
                return i11;
            }
    ...
    private void setSpansWithoutClash(Object obj, final SpannableStringBuilder spannableStringBuilder, int i10, int i11) {
        ...
        Arrays.sort(styleSpanArr, Comparator$-CC.comparingInt(new ToIntFunction() { // from class: org.telegram.messenger.qh
    ...
    private boolean showFootnoteSheet(TL_iv.textAnchor textanchor) {
        ...
        CharSequence formatText = formatText(org.telegram.ui.web.e2.d(textanchor.text, "", str == null ? "" : str.toLowerCase()));
                ...
                if (min2 > max2) {
                    ...
                    if (!(richBlock instanceof RichTableBlock)) {
                        ...
                        if (i17 <= 0 || i16 >= 0) {
                            ...
                            if (richBlock instanceof RichPreformattedBlock) {
                                ...
                                if (!sb4.isEmpty()) {
                                    ...
                                    if (TextUtils.isEmpty(str2)) {
                                        ...
                                        sb5.append(rh.v3.s(str2));
                                        sb5.append("\">");
                                    }
                                    str = a9.p.p(sb5, sb4, "</pre>");
                                }
                                sb2.append(str);
                            } else if (z10) {
                            ...
                            rh.v3.g(sb6, richHtmlSpannable2);
    ...
    public boolean hasOverlay() {
        ...
        for (int i10 = 0; i10 < this.textBlocks.size(); i10++) {
            ...
            if ((u9Var instanceof Text) && (p5Var = ((Text) u9Var).animatedEmojiStack) != null && !p5Var.a.isEmpty()) {
                return true;
            }
        }
        return false;
    ...
    public static class RichUnsupportedBlock extends RichBlock implements Drawable.Callback {
        ...
        public RichUnsupportedBlock(RichMessageLayout richMessageLayout, Rect rect, int i10, int i11, int i12) {
            ...
            n51Var.n = LocaleController.getString(R.string.UnsupportedBlockTitle);
            n51Var.o = LocaleController.getString(R.string.UnsupportedBlockMessage);
            n51Var.p = LocaleController.getString(R.string.UnsupportedUpdate);
            n51Var.j = new rg(richMessageLayout, 9);
            int i13 = this.maxWidth;
    ...
    public CharSequence formatText(TL_iv.RichText richText, SpannableStringBuilder spannableStringBuilder, int i10) {
        ...
        if (richText instanceof TL_iv.textDiff) {
            TL_iv.textDiff textdiff = (TL_iv.textDiff) richText;
            boolean j10 = rh.v5.j(textdiff.text);
            boolean j11 = rh.v5.j(textdiff.old_text);
            if (j10 && !j11) {
            ...
            if (richText instanceof TL_iv.textConcat) {
                ...
                if (richText instanceof TL_iv.textPhone) {
                    ...
                    formatTextAndSetSpan(richText.text, spannableStringBuilder, i10, new t41(s3.c.e("tel:", d), getTextStyleRun(1024)));
                    return spannableStringBuilder;
                }
                ...
                if (richText instanceof TL_iv.textMath) {
                    ...
                    if (textmath.bitmap == null && !textmath.tried) {
                        textmath.tried = true;
                        rh.q a2 = rh.q.a(textmath.source, AndroidUtilities.dp(this.fontSize + 4), true);
                        if (a2 != null) {
                            textmath.w = a2.b;
                            textmath.h = a2.c;
                            textmath.depth = a2.d;
                    ...
                    spannableStringBuilder.setSpan(new qz0(null, textmath.bitmap, textmath.w, textmath.h, org.telegram.ui.ActionBar.g6.v0(org.telegram.ui.ActionBar.g6.G6, this.resourcesProvider), textmath.depth), length, length2, 33);
                    ...
                    if (richText instanceof TL_iv.textAutoPhone) {
                        ...
                        String d10 = oe.b.d(string, false);
                        if (string.startsWith("+")) {
                            d10 = s3.c.e("+", d10);
                        }
                        formatTextAndSetSpan(richText.text, spannableStringBuilder, i10, new t41(s3.c.e("tel:", d10), getTextStyleRun(1024)));
                        return spannableStringBuilder;
                    }
    ...
    public static class MediaCell implements DownloadController.FileDownloadProgressListener {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent, View view) {
            ...
            float x8 = motionEvent.getX();
            float y10 = motionEvent.getY();
            boolean isInside = isInside(x8, y10);
            boolean isOnButton = isOnButton(x8, y10);
            if (actionMasked == 0) {
        ...
        public void setRect(int i10, int i11, int i12, int i13) {
            ...
            int B = i0.a.B(i12, i14, 2, i10);
            this.buttonX = B;
            int B2 = i0.a.B(i13, i14, 2, i11);
            this.buttonY = B2;
            RadialProgress2 radialProgress2 = this.radialProgress;
            if (radialProgress2 != null) {
                radialProgress2.q(B, B2, B + i14, i14 + B2);
            }
    ...
    public static class RichAudioBlock extends RichBlock implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
        ...
        private void layoutInner() {
            ...
            this.seekBarX = dp;
            this.seekBarWidth = i0.a.d(18.0f, this.layoutWidth - dp, 0);
            MessageObject messageObject = this.currentMessageObject;
            ...
            if (TextUtils.isEmpty(musicTitle) && TextUtils.isEmpty(musicAuthor)) {
                ...
                SpannableStringBuilder spannableStringBuilder = (TextUtils.isEmpty(musicTitle) || TextUtils.isEmpty(musicAuthor)) ? !TextUtils.isEmpty(musicTitle) ? new SpannableStringBuilder(musicTitle) : new SpannableStringBuilder(musicAuthor) : new SpannableStringBuilder(a9.p.w(musicAuthor, " - ", musicTitle));
        ...
        public void onDraw(Canvas canvas) {
            ...
            mn0Var.h(themedColor, themedColor2, themedColor3, themedColor4, richMessageLayout7.getThemedColor(richMessageLayout7.isOut() ? org.telegram.ui.ActionBar.g6.yb : org.telegram.ui.ActionBar.g6.wd));
            canvas.save();
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (actionMasked == 0) {
                if (this.buttonState != -1) {
                    if (x8 >= this.buttonX && x8 <= AndroidUtilities.dp(48.0f) + r0) {
    ...
    public static class RichDocumentBlock extends RichBlock implements DownloadController.FileDownloadProgressListener {
        ...
        private void rebuildLayouts() {
            ...
            int d = i0.a.d(48.0f, this.layoutWidth - (this.hasPreview ? AndroidUtilities.dp(97.0f) + this.previewX : this.buttonTextSpacing + (this.buttonX + this.buttonSize)), AndroidUtilities.dp(40.0f));
        ...
        */
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            float x8 = motionEvent.getX() + this.root.padLeft;
            float y10 = motionEvent.getY();
            boolean contains = this.optionsHit.contains(x8, y10);
            ...
            if (x8 >= (this.hasPreview ? this.previewX : this.buttonX) && x8 <= this.layoutWidth - AndroidUtilities.dp(12.0f) && y10 >= AndroidUtilities.dp(10.0f)) {
