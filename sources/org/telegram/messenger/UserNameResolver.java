...
public class UserNameResolver {
    ...
    public void lambda$resolve$0(String str, TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        a2.p(R.string.FloodWait, org.telegram.ui.Components.wc.a0(R), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$resolve$1(String str, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new ii(str, this, tLObject, tL_error), 2L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$resolve$2(String str, int i10) {
        this.resolvingConsumers.remove(str);
        ConnectionsManager.getInstance(this.currentAccount).cancelRequest(i10, true);
    }

    public Runnable resolve(String str, e2.h hVar) {
        return resolve(str, null, hVar);
    }
    ...
    public Runnable resolve(String str, String str2, e2.h hVar) {
        return resolve(str, str2, false, hVar);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public Runnable resolve(String str, String str2, boolean z10, e2.h hVar) {
        ...
        if (TextUtils.isEmpty(str2) && !z10 && (cachedPeer = this.resolvedCache.get(str)) != null) {
            if (System.currentTimeMillis() - cachedPeer.time < CACHE_TIME) {
                ...
                sb2.append(str);
                sb2.append(" ");
                hc.b.x(sb2, cachedPeer.peerId);
                return null;
            }
            this.resolvedCache.remove(str);
        }
        ArrayList<e2.h> arrayList = this.resolvingConsumers.get(str);
        if (arrayList != null) {
            arrayList.add(hVar);
            return null;
        }
        ArrayList<e2.h> arrayList2 = new ArrayList<>();
        arrayList2.add(hVar);
        ...
        return new v4(this, str, ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_resolveUsername, new v1(11, this, str)), 22);
    }
