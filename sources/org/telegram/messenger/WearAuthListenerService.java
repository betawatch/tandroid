...
public class WearAuthListenerService extends l8.k {
    ...
    public static void lambda$onMessageReceived$0(String str, String str2, byte[] bArr) {
        ...
        FileLog.d("wear-auth: new session " + ri1.d(copyOfRange) + " from " + str2);
        c5.j jVar2 = new c5.j();
        jVar2.a = copyOfRange;
        ...
        org.telegram.ui.ActionBar.g3 g3Var2 = ri1.c;
        if (g3Var2 != null) {
            g3Var2.dismiss();
            ri1.c = null;
        }
        ...
        Collections.sort(arrayList, new cu(13));
        ...
        p10.setOnClickListener(new gb0(26, p10, iArr));
        ri1.c = o10;
        o10.show();
    }
    ...
    public void onMessageReceived(l8.g gVar) {
        ...
        AndroidUtilities.runOnUIThread(new d9(str, str2, bArr));
    }
}
