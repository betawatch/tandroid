...
public class WearAuthListenerService extends x8.k {
    ...
    public static void lambda$onMessageReceived$0(String str, String str2, byte[] bArr) {
        ...
        org.telegram.ui.ActionBar.f3 i11 = vl.i(1, context, resourceProvider, false);
        ...
        di.d g10 = vl.g(24, context, resourceProvider, true);
    ...
    public void onMessageReceived(x8.g gVar) {
        ...
        AndroidUtilities.runOnUIThread(new y8(str, str2, bArr, 29));
    }
}
