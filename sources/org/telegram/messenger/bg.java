...
public final /* synthetic */ class bg implements Runnable {
    ...
    public /* synthetic */ bg(zh.s5 s5Var, TLObject tLObject, Runnable runnable, TLRPC.TL_error tL_error, boolean z10, long j3, int i10, MessageObject messageObject, long j10) {
        this.f = s5Var;
        this.h = tLObject;
        this.n = runnable;
        this.r = tL_error;
