        ...
        switch (i10) {
            ...
            default:
                ...
                if (!z10 || tL_chatAdminRights != null || TextUtils.isEmpty(str2)) {
                    qq qqVar = new qq(user.id, -this.d, tL_chatAdminRights2, null, null, str3, 2, true, !z10, str2);
                    qqVar.X0 = new ya0(uyVar, i11);
                    ((ActionBarLayout) launchActivity.O()).Q(qqVar, false);
                    break;
                } else {
                    MessagesController.getInstance(launchActivity.O).addUserToChat(chat.id, user, 0, str2, uyVar, true, new r11(launchActivity, i11, chat, uyVar, 3), null);
                    break;
                }
        }
    }

    public /* synthetic */ m8(LaunchActivity launchActivity, String str, TLRPC.TL_chatAdminRights tL_chatAdminRights, boolean z10, String str2, int i10, TLRPC.Chat chat, uy uyVar, TLRPC.User user, long j3, String str3) {
