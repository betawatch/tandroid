...
public final /* synthetic */ class m8 implements Runnable {
    ...
    public /* synthetic */ m8(MediaDataController mediaDataController, Timer.Task task, a0.h hVar, AtomicInteger atomicInteger, Runnable runnable, int i10, Timer timer, a0.h hVar2, a0.h hVar3, boolean z10, long j10) {
        ...
        switch (i10) {
            ...
            default:
                ...
                if (!z10 || tL_chatAdminRights != null || TextUtils.isEmpty(str2)) {
                    dq dqVar = new dq(user.id, -this.d, tL_chatAdminRights2, null, null, str3, 2, true, !z10, str2);
                    dqVar.T0 = new ha0(gyVar, i11);
                    ((ActionBarLayout) launchActivity.O()).Q(dqVar, false);
                    break;
                } else {
                    MessagesController.getInstance(launchActivity.K).addUserToChat(chat.id, user, 0, str2, gyVar, true, new xs(launchActivity, i11, chat, gyVar, 2), null);
                    break;
                }
        }
    }

    public /* synthetic */ m8(LaunchActivity launchActivity, String str, TLRPC.TL_chatAdminRights tL_chatAdminRights, boolean z10, String str2, int i10, TLRPC.Chat chat, gy gyVar, TLRPC.User user, long j10, String str3) {
