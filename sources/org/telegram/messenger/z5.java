...
public final /* synthetic */ class z5 implements Runnable {
            ...
            case 1:
                ...
                if (tLObject != null) {
                    ...
                    if (AndroidUtilities.isTablet()) {
                        ...
                        externalActionActivity.c.c(-1, xm0Var);
                    }
                    if (!AndroidUtilities.isTablet()) {
    ...
    public /* synthetic */ z5(TLObject tLObject, org.telegram.ui.ActionBar.n2 n2Var, TLRPC.TL_inputStorePaymentPremiumSubscription tL_inputStorePaymentPremiumSubscription, hw0 hw0Var, n2.e eVar, int i10, TLRPC.TL_error tL_error, TLRPC.TL_payments_canPurchaseStore tL_payments_canPurchaseStore) {
        this.f = tLObject;
        this.d = n2Var;
