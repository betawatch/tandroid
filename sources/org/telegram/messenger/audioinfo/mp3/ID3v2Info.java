...
public class ID3v2Info extends AudioInfo {
    ...
    */
                    ...
                    if (this.cover == null || (b = parseAttachedPictureFrame.type) == 3 || b == 0) {
                        ...
                        if (i <= 800) {
                            ...
                            if (decodeByteArray != null) {
                                ...
                                if (max > 0.0f) {
                                    this.smallCover = Bitmap.createScaledBitmap(this.cover, (int) (r1.getWidth() / max), (int) (this.cover.getHeight() / max), true);
                                } else {
                    ...
                    try {
                        if (parseTextFrame.charAt(0) == '(') {
                            ...
                            if (indexOf > 1) {
                                ...
                                if (genre == null && parseTextFrame.length() > (i2 = indexOf + 1)) {
                                    this.genre = parseTextFrame.substring(i2);
                                }
                            } else {
                                genre = null;
                            }
    ...
    CommentOrUnsynchronizedLyrics parseCommentOrUnsynchronizedLyricsFrame(ID3v2FrameBody iD3v2FrameBody) {
        ...
        return new CommentOrUnsynchronizedLyrics(iD3v2FrameBody.readFixedLengthString(3, ID3v2Encoding.ISO_8859_1), iD3v2FrameBody.readZeroTerminatedString(NotificationCenter.channelRecommendationsLoaded, readEncoding), iD3v2FrameBody.readFixedLengthString((int) iD3v2FrameBody.getRemainingLength(), readEncoding));
    }
    ...
    AttachedPicture parseAttachedPictureFrame(ID3v2FrameBody iD3v2FrameBody) {
        ...
        return new AttachedPicture(iD3v2FrameBody.getData().readByte(), iD3v2FrameBody.readZeroTerminatedString(NotificationCenter.channelRecommendationsLoaded, readEncoding), readZeroTerminatedString, iD3v2FrameBody.getData().readFully((int) iD3v2FrameBody.getRemainingLength()));
    }
}
