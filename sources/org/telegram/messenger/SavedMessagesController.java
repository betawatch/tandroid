...
public class SavedMessagesController {
    ...
    */
    public /* synthetic */ void lambda$saveCache$11(MessagesStorage messagesStorage, ArrayList arrayList) {
        ...
        try {
            ...
            sQLitePreparedStatement.dispose();
            AndroidUtilities.runOnUIThread(new hi(this, 3));
        } catch (Throwable th2) {
    ...
    */
    ...
    public void loadDialogs(boolean z10) {
        ...
        SavedDialog savedDialog = this.loadedDialogs.isEmpty() ? null : (SavedDialog) hc.b.i(1, this.loadedDialogs);
        if (savedDialog != null) {
    ...
    */
    public void update(long j3, TLRPC.messages_Messages messages_messages) {
        ...
        if (updateSavedDialogs) {
            AndroidUtilities.runOnUIThread(new hi(this, 0));
        }
    }
