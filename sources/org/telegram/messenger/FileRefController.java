    ...
    */
        ...
        if (str2 != null) {
            ...
            if (fileReferenceFromResponse != null) {
                ...
                if (tLObject2 instanceof jh.a6) {
                    ...
                    TLRPC.MessageMedia messageMedia4 = ((jh.a6) tLObject2).media;
    ...
    public static String getKeyForParentObject(Object obj) {
        ...
        if (obj instanceof jh.a6) {
            ...
            if (messageMedia.document != null) {
                return "botstory_doc_" + a6Var.media.document.id;
            }
            if (messageMedia.photo != null) {
                return "botstory_photo_" + a6Var.media.photo.id;
            }
            return "botstory_" + a6Var.id;
        }
    ...
    private String getObjectString(Object obj) {
        ...
        if (obj instanceof TL_stories.StoryItem) {
            ...
            sb2.append(" id=");
            return a9.p.k(storyItem.id, ")", sb2);
        }
        if (!(obj instanceof MessageObject)) {
            if (obj == null) {
                return null;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$requestReferenceFromServer$0(String str, String str2, jh.a6 a6Var) {
        onRequestComplete(str, str2, a6Var, null, true, false);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$requestReferenceFromServer$1(String str, String str2, jh.a6 a6Var) {
            ...
            if (!(tLObject4 instanceof TLRPC.TL_messages_favedStickers)) {
                ...
                while (i17 < size2) {
                    ...
                    if (requester4.completed) {
                        ...
                        if (tLObject2 instanceof jh.a6) {
                            TLRPC.MessageMedia messageMedia2 = ((jh.a6) tLObject2).media;
                                                    ...
                                                    while (i32 < size8) {
                                                        ...
                                                        if (obj2 instanceof TLRPC.User) {
                                                            ...
                                                            if (!z10 || bArr3 == null) {
                                                                ...
                                                                AndroidUtilities.runOnUIThread(new d2(9, fileRefController, user));
                                                            }
                                                        } else {
                                                            vector = vector2;
                                                            i10 = size8;
    ...
    */
    ...
    public Pair<TLRPC.InputFileLocation, String> getLocationAndKey(Object obj, Object... objArr) {
        ...
        if (obj2 instanceof jh.a6) {
            ...
            if (messageMedia.document != null) {
                TLRPC.TL_inputDocumentFileLocation tL_inputDocumentFileLocation = new TLRPC.TL_inputDocumentFileLocation();
                tL_inputDocumentFileLocation.id = a6Var.media.document.id;
                return new Pair<>(tL_inputDocumentFileLocation, "botstory_doc_" + a6Var.media.document.id);
            }
            if (messageMedia.photo == null) {
                return new Pair<>(new TLRPC.TL_inputDocumentFileLocation(), "botstory_" + a6Var.id);
            }
            TLRPC.TL_inputPhotoFileLocation tL_inputPhotoFileLocation = new TLRPC.TL_inputPhotoFileLocation();
            tL_inputPhotoFileLocation.id = a6Var.media.photo.id;
            return new Pair<>(tL_inputPhotoFileLocation, "botstory_photo_" + a6Var.media.photo.id);
        }
