...
public final /* synthetic */ class x4 implements Runnable {
    ...
    public /* synthetic */ x4(int i9, String str, TLRPC.InputFile inputFile, TLRPC.InputEncryptedFile inputEncryptedFile, byte[] bArr, byte[] bArr2, long j10) {
        this.c = i9;
        this.d = str;
        this.e = inputFile;
    ...
    public /* synthetic */ x4(MessagesController messagesController, HashMap hashMap, String str, TLObject tLObject, a0.h hVar, long j10, int i9) {
    ...
    public /* synthetic */ x4(MessagesController messagesController, boolean[] zArr, TLRPC.Chat chat, Runnable[] runnableArr, long j10, int i9, MessagesController.MessagesLoadedCallback messagesLoadedCallback) {
