...
public class HashtagSearchController {
    ...
    public /* synthetic */ void lambda$searchHashtag$0(SearchResult searchResult, String str, String str2, Runnable[] runnableArr, int i10, int i11, int i12, Long l4) {
    ...
    public /* synthetic */ void lambda$searchHashtag$1(int[] iArr, SearchResult searchResult, TLRPC.messages_Messages messages_messages, ArrayList arrayList, int i10, int i11, int i12) {
        if (iArr[0] == searchResult.reqId) {
            ...
            if (!messages_messages.messages.isEmpty()) {
                TLRPC.Message message2 = (TLRPC.Message) hg.k0.h(1, messages_messages.messages);
    ...
    private void saveHistoryToPref() {
        ...
        for (int i10 = 0; i10 < this.history.size(); i10++) {
            edit.putString(hg.k0.i(i10, "e_"), this.history.get(i10));
        }
        edit.apply();
    }
