...
public final /* synthetic */ class mk implements Utilities.Callback {
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (this.b) {
                    ...
                    MediaDataController.getInstance(i10).getEmojiSuggestions(z61.a2, str2, false, new ai.g6(z61Var, linkedHashSet, hashMap, arrayList3, runnable), null, true, z61Var.W == 3, false, 30);
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ mk(z61 z61Var, boolean z10, LinkedHashSet linkedHashSet, String str, HashMap hashMap, ArrayList arrayList) {
        this.c = z61Var;
        this.b = z10;
