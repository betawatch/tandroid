        ...
        switch (this.a) {
            ...
            default:
                ...
                if (this.b) {
                    ...
                    MediaDataController.getInstance(i10).getEmojiSuggestions(j71.a2, str2, false, new ai.h6(j71Var, linkedHashSet, hashMap, arrayList3, runnable), null, true, j71Var.W == 3, false, 30);
                    break;
                }
                break;
        }
