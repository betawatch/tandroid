...
public class BotForumHelper extends BaseController {
    ...
    public boolean beforeSendingFinalRequest(final TLObject tLObject, MessageObject messageObject, final Runnable runnable) {
        ...
        performSendBotTopicCreate(inputPeerFromSendMessageRequest, str, nextLong, new MessagesStorage.IntCallback() { // from class: org.telegram.messenger.BotForumHelper$$ExternalSyntheticLambda2
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$beforeSendingFinalRequest$2(TLObject tLObject, final long j, final long j2, final Runnable runnable, final int i) {
        ...
        getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.BotForumHelper$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$beforeSendingFinalRequest$1(long j, long j2, int i, Runnable runnable) {
    ...
    private void performSendBotTopicCreate(TLRPC.InputPeer inputPeer, final String str, long j, MessagesStorage.IntCallback intCallback) {
        ...
        getConnectionsManager().sendRequestTyped(tL_messages_createForumTopic, new Executor() { // from class: org.telegram.messenger.BotForumHelper$$ExternalSyntheticLambda3
            @Override // java.util.concurrent.Executor
            public final void execute(Runnable runnable) {
                AndroidUtilities.runOnUIThread(runnable);
            }
        }, new Utilities.Callback2() { // from class: org.telegram.messenger.BotForumHelper$$ExternalSyntheticLambda4
