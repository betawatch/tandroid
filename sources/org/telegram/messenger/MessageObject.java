...
public class MessageObject {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:1456:0x2548, code lost:
    
        if ((((org.telegram.tgnet.TLRPC.TL_messageExtendedMediaPreview) r5).flags & 4) != 0) goto L1436;
     */
    /* JADX WARN: Removed duplicated region for block: B:1360:0x2331  */
    /* JADX WARN: Removed duplicated region for block: B:1378:0x239f  */
    /* JADX WARN: Removed duplicated region for block: B:1380:0x23a2  */
    /* JADX WARN: Removed duplicated region for block: B:1556:0x003d  */
    /* JADX WARN: Removed duplicated region for block: B:17:0x27d1  */
    /* JADX WARN: Removed duplicated region for block: B:315:0x08bc  */
    /* JADX WARN: Removed duplicated region for block: B:324:0x08db  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:366:0x0929  */
    /* JADX WARN: Removed duplicated region for block: B:381:0x09b4  */
    /* JADX WARN: Removed duplicated region for block: B:389:0x09da  */
    /* JADX WARN: Removed duplicated region for block: B:652:0x10c7  */
    /* JADX WARN: Removed duplicated region for block: B:656:0x10e1  */
    /* JADX WARN: Removed duplicated region for block: B:675:0x113b  */
    /* JADX WARN: Removed duplicated region for block: B:676:0x114f  */
    /* JADX WARN: Removed duplicated region for block: B:692:0x1195  */
    /* JADX WARN: Removed duplicated region for block: B:693:0x119f  */
    /* JADX WARN: Removed duplicated region for block: B:6:0x003b  */
    /* JADX WARN: Removed duplicated region for block: B:785:0x1392  */
    /* JADX WARN: Removed duplicated region for block: B:805:0x1433  */
                ...
                if (!(message instanceof TLRPC.TL_messageService)) {
                    ...
                    if (messageAction != null) {
                        ...
                        if (messageAction instanceof TLRPC.TL_messageActionNewCreatorPending) {
                            ...
                            int i6 = messageAction.duration;
                            if (i6 != 0) {
                                int i7 = i6 / 86400;
                                if (i7 > 0) {
                                    formatPluralString2 = LocaleController.formatPluralString("Days", i7, new Object[0]);
                                } else {
                                    int i8 = i6 / 3600;
                                    if (i8 > 0) {
                                        formatPluralString2 = LocaleController.formatPluralString("Hours", i8, new Object[0]);
                                    } else {
                                        int i9 = i6 / 60;
                                        if (i9 > 0) {
                                            formatPluralString2 = LocaleController.formatPluralString("Minutes", i9, new Object[0]);
                                        } else {
                                            formatPluralString2 = LocaleController.formatPluralString("Seconds", i6, new Object[0]);
                                        }
                                    }
                                }
                                    ...
                                    if (messageAction instanceof TLRPC.TL_messageActionPaymentRefunded) {
                                        ...
                                        if (messageAction2 instanceof TLRPC.TL_messageActionSuggestedPostRefund) {
                                            ...
                                            if (obtainSuggestionOfferFromReply == null || (amountUtils$Amount2 = obtainSuggestionOfferFromReply.amount) == null) {
                                                if (z2) {
                                                    i5 = R.string.SuggestedOfferRefundByUserAmountUnknown;
                                                } else {
                                                    i5 = R.string.SuggestedOfferRefundByAdminAmountUnknown;
                                                }
                                                this.messageText = LocaleController.formatString(i5, name, monoForumTitle);
                                            } else {
                                        ...
                                        if (messageAction3 instanceof TLRPC.TL_messageActionChatAddUser) {
                                            ...
                                            if (isOut()) {
                                                if (isChannelAndNotMegaGroup2) {
                                                    i4 = R.string.ActionJoinedFromCommunityYouChannel;
                                                } else {
                                                    i4 = R.string.ActionJoinedFromCommunityYou;
                                                }
                                                this.messageText = replaceWithLink(LocaleController.getString(i4), "un1", chat24);
                                            } else {
                                            ...
                                            if (peer4 != null) {
                                                ...
                                                if (j6 != 0) {
                                                    ...
                                                    if ((tL_messageActionGiveawayLaunch.flags & 1) == 0) {
                                                        this.messageText = LocaleController.formatPluralStringComma(isChannelAndNotMegaGroup3 ? "BoostingStarsGiveawayJustStarted" : "BoostingStarsGiveawayJustStartedGroup", (int) tL_messageActionGiveawayLaunch.stars, chat16 != null ? chat16.title : str3);
                                                    } else {
                                                        this.messageText = LocaleController.formatString(isChannelAndNotMegaGroup3 ? R.string.BoostingGiveawayJustStarted : R.string.BoostingGiveawayJustStartedGroup, chat16 != null ? chat16.title : str3);
                                                    }
                                                }
                                            }
                                            chat16 = null;
                                                ...
                                                if (j7 != 0) {
                                                    ...
                                                    if (!z) {
                                                        ...
                                                        if (i10 <= 1) {
                                                            ...
                                                            this.messageText = LocaleController.formatPluralString(isChannelAndNotMegaGroup4 ? "BoostingBoostsChannelByYouServiceMsgCount" : "BoostingBoostsGroupByYouServiceMsgCount", i10, new Object[0]);
                                                        }
                                                    } else {
                                                        int i11 = tL_messageActionBoostApply.boosts;
                                                        if (i11 <= 1) {
                                                            this.messageText = LocaleController.formatString(isChannelAndNotMegaGroup4 ? R.string.BoostingBoostsChannelByUserServiceMsg : R.string.BoostingBoostsGroupByUserServiceMsg, str7);
                                                        } else {
                                                            this.messageText = LocaleController.formatPluralString(isChannelAndNotMegaGroup4 ? "BoostingBoostsChannelByUserServiceMsgCount" : "BoostingBoostsGroupByUserServiceMsgCount", i11, str7);
                                                        }
                                                    }
                                                }
                                            }
                                            ...
                                            if (TlUtils.isInstance(messageAction3, TLRPC.TL_messageActionGiftPremium.class, TLRPC.TL_messageActionGiftCode.class, TLRPC.TL_messageActionGiftTon.class)) {
                                                ...
                                                if (messageAction6 instanceof TLRPC.TL_messageActionSuggestBirthday) {
                                                    ...
                                                    if (i12 > 0 && i12 != arrayList4.size()) {
                                                        this.messageText = LocaleController.getPluralString("ActionRequestedPeerUserPlural", i12);
                                                    } else if (i13 > 0 && i13 != arrayList4.size()) {
                                                        this.messageText = LocaleController.getPluralString("ActionRequestedPeerChannelPlural", i13);
                                                    } else if (i14 > 0 && i14 != arrayList4.size()) {
                                                        this.messageText = LocaleController.getPluralString("ActionRequestedPeerChatPlural", i14);
                                                    } else {
                                                        SpannableStringBuilder spannableStringBuilder5 = new SpannableStringBuilder();
                                                        int i15 = 0;
                                                        while (i15 < arrayList4.size()) {
                                                            String str11 = str10;
                                                            spannableStringBuilder5.append(replaceWithLink(str11, str11, (TLObject) arrayList4.get(i15)));
                                                            String str12 = str8;
                                                    ...
                                                    if (peer17 != null) {
                                                        ...
                                                        if (j12 != 0) {
                                                            ...
                                                            if (chat5 == null && !chat5.megagroup) {
                                                                int i16 = tL_messageActionSetMessagesTTL.period;
                                                                if (i16 != 0) {
                                                                    this.messageText = LocaleController.formatString(R.string.ActionTTLChannelChanged, LocaleController.formatTTLString(i16));
                                                                } else {
                                                                    this.messageText = LocaleController.getString(R.string.ActionTTLChannelDisabled);
                                                                }
                                                            } else {
                                                    ...
                                                    int i17 = R.string.NotificationUnrecognizedDevice;
                                                    TLRPC.MessageAction messageAction7 = this.messageOwner.action;
                                                    this.messageText = LocaleController.formatString(i17, firstName, sb, messageAction7.title, messageAction7.address);
                                                } else {
                                                    str2 = str3;
                                                    if ((messageAction6 instanceof TLRPC.TL_messageActionUserJoined) || (messageAction6 instanceof TLRPC.TL_messageActionContactSignUp)) {
                                                        ...
                                                        int i20 = tL_messageActionConferenceCall.duration;
                                                        if (i20 > 0) {
                                                            String formatCallDuration = LocaleController.formatCallDuration(i20);
                                                        ...
                                                        int i21 = tL_messageActionPhoneCall.duration;
                                                        if (i21 > 0) {
                                                            String formatCallDuration2 = LocaleController.formatCallDuration(i21);
                                                        ...
                                                        if (z8) {
                                                            ...
                                                            for (int i22 = 0; i22 < size; i22++) {
                                                                TLRPC.SecureValueType secureValueType = tL_messageActionSecureValuesSent.types.get(i22);
                                                                if (sb3.length() > 0) {
                                                                    sb3.append(str8);
                                                                }
                                                            ...
                                                            if (messageObject != null && (getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaToDo)) {
                                                                ...
                                                                for (int i23 = 0; i23 < tL_messageMediaToDo.todo.list.size(); i23++) {
                                                                    TLRPC.TodoItem todoItem2 = tL_messageMediaToDo.todo.list.get(i23);
                                                            ...
                                                            this.messageText = AndroidUtilities.replaceTags(LocaleController.formatString(i, shortName4, asFormatString, str16));
                        ...
                        if (richMessage != null) {
                            ...
                            if (getMedia(this.messageOwner) instanceof TLRPC.TL_messageMediaGiveaway) {
                                ...
                                for (int i24 = 0; i24 < size2; i24++) {
                                    TLRPC.MessageExtendedMedia messageExtendedMedia = tL_messageMediaPaidMedia.extended_media.get(i24);
                                    if (messageExtendedMedia instanceof TLRPC.TL_messageExtendedMedia) {
                                        TLRPC.MessageMedia messageMedia = ((TLRPC.TL_messageExtendedMedia) messageExtendedMedia).media;
                                ...
                                this.messageText = StarsIntroActivity.replaceStars(LocaleController.formatString(i25, objArr));
        ...
        if ((pageBlock instanceof TL_iv.pageBlockTitle) || (pageBlock instanceof TL_iv.pageBlockHeader) || (pageBlock instanceof TL_iv.pageBlockSubheader) || (pageBlock instanceof TL_iv.pageBlockHeading1) || (pageBlock instanceof TL_iv.pageBlockHeading2) || (pageBlock instanceof TL_iv.pageBlockHeading3) || (pageBlock instanceof TL_iv.pageBlockHeading4) || (pageBlock instanceof TL_iv.pageBlockHeading5) || (pageBlock instanceof TL_iv.pageBlockHeading6) || (pageBlock instanceof TL_iv.pageBlockBlockquote) || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
                ...
                if (findDocument != null) {
                    ...
                    SpannableStringBuilder append = spannableStringBuilder.append((CharSequence) span("📎", R.drawable.msg_filled_data_files)).append(" ");
                    if (TextUtils.isEmpty(documentFileName)) {
    ...
    public static CharSequence formatRichText(TL_iv.RichText richText, boolean z, boolean z2, int i, SpannableStringBuilder spannableStringBuilder, int i2) {
        ...
        if (richText instanceof TL_iv.textPlain) {
            ...
            if (spannableStringBuilder.length() > length) {
                ...
                spannableStringBuilder.setSpan(new URLSpanNoUnderline("tel:" + stripExceptNumbers, textStyleRun3), length, spannableStringBuilder.length(), 33);
            }
    ...
    */
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(48:164|(1:166)|167|(1:169)(1:436)|170|(1:172)(1:435)|173|(1:175)|(1:177)|(1:434)(1:182)|183|(1:433)(1:190)|191|(2:193|(2:(1:416)|417)(1:196))(2:418|(7:420|(1:422)(1:432)|423|(1:425)(1:431)|426|(1:428)(1:430)|429))|197|(3:199|(1:201)(1:(1:412)(1:413))|202)(1:414)|203|(1:205)(2:407|(1:409)(1:410))|206|(5:208|(1:383)(8:214|(1:216)(1:382)|217|218|(1:220)(1:381)|221|(1:223)(1:380)|224)|225|(2:227|(2:229|(2:231|(1:233))(1:234))(1:235))|236)(3:384|(2:386|387)(8:388|389|390|(1:401)(1:394)|395|396|(1:398)(1:400)|399)|349)|237|238|239|240|(2:244|245)|376|251|252|253|(1:255)(17:370|(1:372)|257|(1:259)|260|(1:262)|263|(3:265|(7:267|268|269|270|271|273|274)|280)|281|(6:283|(16:285|286|287|288|289|(1:291)(11:320|(1:322)|293|294|295|(1:297)|298|(2:300|(3:302|(5:305|306|(1:311)|308|309)|310))(1:317)|316|(1:315)(5:305|306|(0)|308|309)|310)|292|293|294|295|(0)|298|(0)(0)|316|(0)(0)|310)|325|326|(2:(1:329)|330)(1:(1:356))|331)(3:357|(5:359|(1:361)(1:368)|362|(1:364)(1:367)|365)(1:369)|366)|332|(3:334|(1:336)(1:338)|337)|339|(1:354)(3:343|(1:345)(3:350|(1:352)|353)|346)|347|348|349)|256|257|(0)|260|(0)|263|(0)|281|(0)(0)|332|(0)|339|(1:341)|354|347|348|349|162) */
    /* JADX WARN: Code restructure failed: missing block: B:319:0x0646, code lost:
    
        r13 = 0.0f;
     */
    /* JADX WARN: Code restructure failed: missing block: B:374:0x059a, code lost:
    
        r0 = move-exception;
     */
    /* JADX WARN: Code restructure failed: missing block: B:375:0x059b, code lost:
    ...
    /* JADX WARN: Removed duplicated region for block: B:149:0x0274 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:304:0x0680 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:311:0x068b A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:315:0x068b A[ADDED_TO_REGION, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:317:0x066b  */
    /* JADX WARN: Removed duplicated region for block: B:334:0x0724  */
    /* JADX WARN: Removed duplicated region for block: B:341:0x0752  */
    /* JADX WARN: Removed duplicated region for block: B:357:0x06da  */
    /* JADX WARN: Removed duplicated region for block: B:370:0x05ac  */
    /* JADX WARN: Removed duplicated region for block: B:440:0x07a4  */
    /* JADX WARN: Removed duplicated region for block: B:455:0x02a1  */
    /* JADX WARN: Removed duplicated region for block: B:469:0x02eb  */
    /* JADX WARN: Removed duplicated region for block: B:472:0x02ee  */
    /* JADX WARN: Removed duplicated region for block: B:480:0x027d  */
    /* JADX WARN: Removed duplicated region for block: B:482:0x026c  */
    /* JADX WARN: Removed duplicated region for block: B:483:0x0254  */
    /* JADX WARN: Removed duplicated region for block: B:488:0x016a  */
    /* JADX WARN: Removed duplicated region for block: B:489:0x0161  */
    /* JADX WARN: Removed duplicated region for block: B:493:0x0152  */
    ...
    public void generateLayout(TLRPC.User user) {
        ...
        try {
            if (this.hasSingleQuote) {
                ...
                StaticLayout makeStaticLayout = makeStaticLayout(charSequence6, textPaint, maxMessageTextWidth2, 1.0f, this.totalAnimatedEmojiCount < 4 ? -1.0f : 0.0f, this.emojiOnlyCount <= 0);
                ...
                if (this.isRepostPreview) {
                    ...
                    if (makeStaticLayout.getLineCount() > i11) {
                        ...
                        try {
                            makeStaticLayout = makeStaticLayout(append, textPaint, maxMessageTextWidth2, 1.0f, this.totalAnimatedEmojiCount >= 4 ? -1.0f : 0.0f, this.emojiOnlyCount > 0);
                            charSequence = append;
                        } catch (Exception e) {
                            FileLog.e(e);
                            return;
            ...
            StaticLayout makeStaticLayout3 = makeStaticLayout(charSequence6, textPaint, maxMessageTextWidth2, 1.0f, this.totalAnimatedEmojiCount < 4 ? -1.0f : 0.0f, this.emojiOnlyCount <= 0);
            charSequence = charSequence6;
            if (this.isRepostPreview) {
            }
            if (!this.hasSingleQuote) {
