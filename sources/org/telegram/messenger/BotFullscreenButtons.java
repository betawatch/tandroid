...
public class BotFullscreenButtons extends View {
    ...
    public static class OptionsIcon extends Drawable {
        ...
        public OptionsIcon(Context context) {
            ...
            this.animatedDownloading = new org.telegram.ui.Components.z5(new e1(this, 14), 420L, nr.h, 0);
    ...
    public BotFullscreenButtons(Context context) {
        ...
        nr nrVar = nr.h;
        this.animatedBack = new org.telegram.ui.Components.z5(this, 0L, 320L, nrVar);
        this.preview = true;
        this.animatedPreview = new org.telegram.ui.Components.z5(this, 0L, 420L, nrVar);
        this.downloading = false;
        this.animatedDownloading = new org.telegram.ui.Components.z5(this, 0L, 420L, nrVar);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.parentRenderNode == null || Build.VERSION.SDK_INT < 31 || !canvas.isHardwareAccelerated() || !((webView = this.webView) == null || webView.getLayerType() == 2)) {
            ...
            f12 = 16.0f;
            this.blurNode.setPosition(0, 0, kh.a2.c(16.0f, c3.getWidth(), 1), Math.max(1, (int) Math.min(this.insets.top + AndroidUtilities.dp(46.0f), c3.getHeight())));
        ...
        if (e6 <= 0.0f || this.previewText == null) {
            ...
            canvas2.save();
            canvas2.translate(org.telegram.ui.yh.c(1.0f, e6, min, this.leftMenu.left + AndroidUtilities.dp(30.0f)), this.leftMenu.centerY());
