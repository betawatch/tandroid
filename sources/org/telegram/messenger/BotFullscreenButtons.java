...
public class BotFullscreenButtons extends View {
    ...
    public BotFullscreenButtons(Context context) {
        ...
        this.backText = new w01(LocaleController.getString(R.string.BotFullscreenBack), 13.0f, AndroidUtilities.bold());
        this.closeText = new w01(LocaleController.getString(R.string.BotFullscreenClose), 13.0f, AndroidUtilities.bold());
    ...
    public void onDraw(Canvas canvas) {
        ...
        w01 w01Var = this.previewText;
        if (w01Var == null) {
            dp = 0.0f;
            f7 = 18.0f;
        } else {
            f7 = 18.0f;
            dp = w01Var.c + AndroidUtilities.dp(this.verifiedBackground != null ? 30.0f : 12.0f);
        }
        ...
        if (e7 <= 0.0f || this.previewText == null) {
            ...
            w01 w01Var2 = this.previewText;
            w01Var2.p = ((this.leftMenu.right - AndroidUtilities.dp(this.verifiedBackground != null ? 30.0f : 12.0f)) - (this.leftMenu.left + AndroidUtilities.dp(30.0f))) + 2.0f;
            f13 = 1.0f;
            w01Var2.c(0.0f, 0.0f, e7, -1, canvas);
            f12 = e7;
            canvas2 = canvas;
    ...
    public void setName(String str, boolean z10) {
        this.previewText = new w01(str, 13.0f, AndroidUtilities.bold());
        if (z10) {
