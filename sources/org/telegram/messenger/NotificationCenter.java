...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 300;
    public static final int adminedChannelsLoaded = 231;
    ...
    public static final int appConfigUpdated = 234;
    public static final int appDidLogout = 172;
    public static final int appUpdateAvailable = 276;
    public static final int appUpdateLoading = 277;
    ...
    public static final int attachMenuBotsDidLoad = 282;
    ...
    public static final int billingConfirmPurchaseError = 295;
    public static final int billingProductDetailsUpdated = 294;
    ...
    public static final int botDownloadsUpdate = 228;
    ...
    public static final int cameraInitied = 245;
    public static final int changeRepliesCounter = 11;
    public static final int channelConnectedBotsUpdate = 230;
    ...
    public static final int channelSuggestedBotsUpdate = 229;
    public static final int chatAvailableReactionsUpdated = 283;
    ...
    public static final int chatSwitchedForum = 302;
    public static final int chatWasBoostedByUser = 205;
    public static final int chatlistFolderUpdate = 309;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 170;
    public static final int closeOtherAppActivities = 244;
    public static final int closeSearchByActiveAction = 268;
    public static final int commentsRead = 10;
    public static final int commonChatsLoaded = 233;
    public static final int conferenceEmojiUpdated = 235;
    ...
    public static final int contentSettingsLoaded = 236;
    public static final int currentUserPremiumStatusChanged = 290;
    public static final int currentUserShowLimitReachedDialog = 293;
    public static final int customStickerCreated = 208;
    public static final int customTypefacesLoaded = 312;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 284;
    public static final int diceStickersDidLoad = 59;
    public static final int didApplyNewTheme = 249;
    public static final int didClearDatabase = 271;
    ...
    public static final int didReceiveCall = 241;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 240;
    ...
    public static final int didReplacedPhotoInMemCache = 246;
    public static final int didSetNewTheme = 247;
    public static final int didSetNewWallpapper = 259;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 303;
    ...
    public static final int emojiLoaded = 242;
    public static final int emojiPreviewThemesChanged = 280;
    ...
    public static final int goingToPreviewTheme = 254;
    ...
    public static final int invalidateMotionBackground = 243;
    public static final int liveLocationsCacheChanged = 265;
    public static final int liveLocationsChanged = 263;
    public static final int loadingMessagesFailed = 17;
    public static final int locationPermissionDenied = 256;
    public static final int locationPermissionGranted = 255;
    ...
    public static final int messagePlayingSpeedChanged = 269;
    ...
    public static final int messagesFeeUpdated = 232;
    ...
    public static final int nearEarEvent = 316;
    public static final int needAddArchivedStickers = 84;
    public static final int needCheckSystemBarColors = 251;
    ...
    public static final int needSetDayNightTheme = 253;
    public static final int needShareTheme = 252;
    ...
    public static final int newLocationAvailable = 264;
    ...
    public static final int notificationsCountUpdated = 266;
    public static final int notificationsSettingsUpdated = 40;
    public static final int onActivityResultReceived = 287;
    public static final int onDatabaseMigration = 278;
    public static final int onDatabaseOpened = 285;
    public static final int onDatabaseReset = 304;
    public static final int onDownloadingFilesChanged = 286;
    public static final int onEmojiInteractionsReceived = 279;
    public static final int onReceivedChannelDifference = 314;
    public static final int onRequestPermissionResultReceived = 288;
    public static final int onUserRingtonesUpdated = 289;
    ...
    public static final int permissionsGranted = 299;
    public static final int pinnedInfoDidLoad = 66;
    public static final int playerDidStartPlaying = 267;
    public static final int premiumFloodWaitReceived = 209;
    public static final int premiumPromoUpdated = 291;
    public static final int premiumStatusChangedGlobal = 292;
    public static final int premiumStickersPreviewLoaded = 296;
    public static final int privacyRulesUpdated = 45;
    public static final int proxyChangedByRotation = 262;
    public static final int proxyCheckDone = 261;
    public static final int proxySettingsChanged = 260;
    public static final int pushMessagesUpdated = 237;
    public static final int quickRepliesDeleted = 119;
    public static final int quickRepliesUpdated = 118;
    public static final int reactionsDidLoad = 281;
    ...
    public static final int reloadInterface = 257;
    ...
    public static final int requestPermissions = 298;
    ...
    public static final int starGiftSoldOut = 226;
    ...
    public static final int starUserGiftCollectionsLoaded = 225;
    ...
    public static final int stealthModeChanged = 313;
    ...
    public static final int storiesDraftsUpdated = 308;
    public static final int storiesEnabledUpdate = 189;
    public static final int storiesLimitUpdate = 191;
    public static final int storiesListUpdated = 307;
    public static final int storiesReadUpdated = 315;
    public static final int storiesSendAsUpdate = 192;
    public static final int storiesUpdated = 306;
    public static final int storyQualityUpdate = 202;
    public static final int suggestedFiltersLoaded = 180;
    public static final int suggestedLangpack = 258;
    public static final int themeAccentListUpdated = 250;
    public static final int themeListUpdated = 248;
    ...
    public static final int topicsDidLoaded = 301;
    private static int totalEvents = 319;
    public static final int translationModelDownloaded = 318;
    public static final int translationModelDownloading = 317;
    ...
    public static final int updateStories = 227;
    public static final int updateTranscriptionLock = 116;
    public static final int uploadStoryEnd = 311;
    public static final int uploadStoryProgress = 310;
    public static final int userEmojiStatusUpdated = 297;
    ...
    public static final int voipServiceCreated = 272;
    public static final int walletPendingTransactionsChanged = 130;
    public static final int walletSyncProgressChanged = 131;
    public static final int wallpaperSettedToUser = 305;
    public static final int wallpapersDidLoad = 238;
    public static final int wallpapersNeedReload = 239;
    public static final int wasUnableToFindCurrentLocation = 78;
    public static final int webRtcMicAmplitudeEvent = 273;
    public static final int webRtcSpeakerAmplitudeEvent = 274;
