...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 311;
    ...
    public static final int appUpdateAvailable = 287;
    public static final int appUpdateLoading = 288;
    ...
    public static final int attachMenuBotsDidLoad = 293;
    ...
    public static final int billingConfirmPurchaseError = 306;
    public static final int billingProductDetailsUpdated = 305;
    ...
    public static final int botForumDraftDelete = 333;
    public static final int botForumDraftUpdate = 332;
    public static final int botForumTopicDidCreate = 331;
    ...
    public static final int callTabsVisibleToggled = 335;
    public static final int cameraInitied = 256;
    ...
    public static final int chatAvailableReactionsUpdated = 294;
    ...
    public static final int chatSwitchedForum = 313;
    public static final int chatWasBoostedByUser = 211;
    public static final int chatlistFolderUpdate = 321;
    ...
    public static final int closeOtherAppActivities = 255;
    public static final int closeProfileActivity = 6;
    public static final int closeSearchByActiveAction = 279;
    ...
    public static final int contactsPermissionBadgeCheck = 336;
    public static final int contentSettingsLoaded = 243;
    public static final int currentUserPremiumStatusChanged = 301;
    public static final int currentUserShowLimitReachedDialog = 304;
    public static final int customStickerCreated = 214;
    public static final int customTypefacesLoaded = 324;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 295;
    public static final int diceStickersDidLoad = 61;
    public static final int didApplyNewTheme = 260;
    public static final int didClearDatabase = 282;
    ...
    public static final int didReceiveCall = 252;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 251;
    ...
    public static final int didReplacedPhotoInMemCache = 257;
    public static final int didSetNewTheme = 258;
    public static final int didSetNewWallpapper = 270;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 314;
    ...
    public static final int emojiLoaded = 253;
    public static final int emojiPreviewThemesChanged = 291;
    ...
    public static final int goingToPreviewTheme = 265;
    ...
    public static final int invalidateMotionBackground = 254;
    public static final int liveLocationsCacheChanged = 276;
    public static final int liveLocationsChanged = 274;
    ...
    public static final int locationPermissionDenied = 267;
    public static final int locationPermissionGranted = 266;
    ...
    public static final int messagePlayingSpeedChanged = 280;
    ...
    public static final int nearEarEvent = 328;
    public static final int needAddArchivedStickers = 86;
    public static final int needCheckSystemBarColors = 262;
    ...
    public static final int needSetDayNightTheme = 264;
    public static final int needShareTheme = 263;
    ...
    public static final int newLocationAvailable = 275;
    ...
    public static final int notificationsCountUpdated = 277;
    public static final int notificationsSettingsUpdated = 42;
    public static final int onActivityResultReceived = 298;
    public static final int onDatabaseMigration = 289;
    public static final int onDatabaseOpened = 296;
    public static final int onDatabaseReset = 315;
    public static final int onDownloadingFilesChanged = 297;
    public static final int onEmojiInteractionsReceived = 290;
    public static final int onReceivedChannelDifference = 326;
    public static final int onRequestPermissionResultReceived = 299;
    public static final int onUserRingtonesUpdated = 300;
    ...
    public static final int permissionsGranted = 310;
    public static final int pinnedInfoDidLoad = 68;
    public static final int playerDidStartPlaying = 278;
    public static final int premiumFloodWaitReceived = 215;
    public static final int premiumPromoUpdated = 302;
    public static final int premiumStatusChangedGlobal = 303;
    public static final int premiumStickersPreviewLoaded = 307;
    public static final int privacyRulesUpdated = 47;
    public static final int profileMusicUpdated = 246;
    public static final int proxyChangedByRotation = 273;
    public static final int proxyCheckDone = 272;
    public static final int proxySettingsChanged = 271;
    public static final int pushMessagesUpdated = 248;
    public static final int quickRepliesDeleted = 121;
    public static final int quickRepliesUpdated = 120;
    public static final int reactionsDidLoad = 292;
    ...
    public static final int reloadInterface = 268;
    ...
    public static final int requestPermissions = 309;
    ...
    public static final int stealthModeChanged = 325;
    ...
    public static final int storiesDraftsUpdated = 320;
    public static final int storiesEnabledUpdate = 194;
    public static final int storiesLimitUpdate = 196;
    public static final int storiesListUpdated = 319;
    public static final int storiesReadUpdated = 327;
    public static final int storiesSendAsUpdate = 197;
    public static final int storiesUpdated = 317;
    public static final int storyAlbumsCollectionsUpdate = 204;
    public static final int storyDeleted = 318;
    ...
    public static final int suggestedLangpack = 269;
    public static final int themeAccentListUpdated = 261;
    public static final int themeListUpdated = 259;
    ...
    public static final int tlSchemeParseException = 334;
    public static final int topicsDidLoaded = 312;
    private static int totalEvents = 337;
    public static final int translationModelDownloaded = 330;
    public static final int translationModelDownloading = 329;
    ...
    public static final int uploadStoryEnd = 323;
    public static final int uploadStoryProgress = 322;
    public static final int userEmojiStatusUpdated = 308;
    ...
    public static final int voipServiceCreated = 283;
    public static final int walletPendingTransactionsChanged = 132;
    public static final int walletSyncProgressChanged = 133;
    public static final int wallpaperSettedToUser = 316;
    public static final int wallpapersDidLoad = 249;
    public static final int wallpapersNeedReload = 250;
    public static final int wasUnableToFindCurrentLocation = 80;
    public static final int webRtcMicAmplitudeEvent = 284;
    public static final int webRtcSpeakerAmplitudeEvent = 285;
