...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 310;
    ...
    public static final int appUpdateAvailable = 286;
    public static final int appUpdateLoading = 287;
    ...
    public static final int attachMenuBotsDidLoad = 292;
    ...
    public static final int billingConfirmPurchaseError = 305;
    public static final int billingProductDetailsUpdated = 304;
    ...
    public static final int botForumDraftDelete = 332;
    public static final int botForumDraftUpdate = 331;
    public static final int botForumTopicDidCreate = 330;
    ...
    public static final int chatAvailableReactionsUpdated = 293;
    ...
    public static final int chatSwitchedForum = 312;
    public static final int chatWasBoostedByUser = 211;
    public static final int chatlistFolderUpdate = 320;
    ...
    public static final int closeOtherAppActivities = 254;
    public static final int closeProfileActivity = 6;
    public static final int closeSearchByActiveAction = 278;
    ...
    public static final int customTypefacesLoaded = 323;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 294;
    public static final int diceStickersDidLoad = 61;
    public static final int didApplyNewTheme = 259;
    public static final int didClearDatabase = 281;
    ...
    public static final int didReceiveCall = 251;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 250;
    ...
    public static final int didReplacedPhotoInMemCache = 256;
    public static final int didSetNewTheme = 257;
    public static final int didSetNewWallpapper = 269;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 313;
    ...
    public static final int emojiLoaded = 252;
    public static final int emojiPreviewThemesChanged = 290;
    ...
    public static final int goingToPreviewTheme = 264;
    ...
    public static final int invalidateMotionBackground = 253;
    public static final int liveLocationsCacheChanged = 275;
    public static final int liveLocationsChanged = 273;
    ...
    public static final int locationPermissionDenied = 266;
    public static final int locationPermissionGranted = 265;
    ...
    public static final int messagePlayingSpeedChanged = 279;
    ...
    public static final int nearEarEvent = 327;
    public static final int needAddArchivedStickers = 86;
    public static final int needCheckSystemBarColors = 261;
    ...
    public static final int needSetDayNightTheme = 263;
    public static final int needShareTheme = 262;
    ...
    public static final int newLocationAvailable = 274;
    ...
    public static final int notificationsCountUpdated = 276;
    public static final int notificationsSettingsUpdated = 42;
    public static final int onActivityResultReceived = 297;
    public static final int onDatabaseMigration = 288;
    public static final int onDatabaseOpened = 295;
    public static final int onDatabaseReset = 314;
    public static final int onDownloadingFilesChanged = 296;
    public static final int onEmojiInteractionsReceived = 289;
    public static final int onReceivedChannelDifference = 325;
    public static final int onRequestPermissionResultReceived = 298;
    public static final int onUserRingtonesUpdated = 299;
    ...
    public static final int permissionsGranted = 309;
    public static final int pinnedInfoDidLoad = 68;
    public static final int playerDidStartPlaying = 277;
    public static final int premiumFloodWaitReceived = 215;
    public static final int premiumPromoUpdated = 301;
    public static final int premiumStatusChangedGlobal = 302;
    public static final int premiumStickersPreviewLoaded = 306;
    public static final int privacyRulesUpdated = 47;
    public static final int profileMusicUpdated = 246;
    public static final int proxyChangedByRotation = 272;
    public static final int proxyCheckDone = 271;
    public static final int proxySettingsChanged = 270;
    public static final int pushMessagesUpdated = 247;
    public static final int quickRepliesDeleted = 121;
    public static final int quickRepliesUpdated = 120;
    public static final int reactionsDidLoad = 291;
    ...
    public static final int reloadInterface = 267;
    ...
    public static final int requestPermissions = 308;
    ...
    public static final int stealthModeChanged = 324;
    ...
    public static final int storiesDraftsUpdated = 319;
    public static final int storiesEnabledUpdate = 194;
    public static final int storiesLimitUpdate = 196;
    public static final int storiesListUpdated = 318;
    public static final int storiesReadUpdated = 326;
    public static final int storiesSendAsUpdate = 197;
    public static final int storiesUpdated = 316;
    public static final int storyAlbumsCollectionsUpdate = 204;
    public static final int storyDeleted = 317;
    ...
    public static final int suggestedLangpack = 268;
    public static final int themeAccentListUpdated = 260;
    public static final int themeListUpdated = 258;
    ...
    public static final int uploadStoryEnd = 322;
    public static final int uploadStoryProgress = 321;
    public static final int userEmojiStatusUpdated = 307;
    ...
    public static final int voipServiceCreated = 282;
    public static final int walletPendingTransactionsChanged = 132;
    public static final int walletSyncProgressChanged = 133;
    public static final int wallpaperSettedToUser = 315;
    public static final int wallpapersDidLoad = 248;
    public static final int wallpapersNeedReload = 249;
    public static final int wasUnableToFindCurrentLocation = 80;
    public static final int webRtcMicAmplitudeEvent = 283;
    public static final int webRtcSpeakerAmplitudeEvent = 284;
