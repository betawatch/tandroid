...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 301;
    public static final int adminedChannelsLoaded = 232;
    ...
    public static final int appConfigUpdated = 235;
    public static final int appDidLogout = 172;
    public static final int appUpdateAvailable = 277;
    public static final int appUpdateLoading = 278;
    ...
    public static final int attachMenuBotsDidLoad = 283;
    ...
    public static final int availableEffectsUpdate = 211;
    public static final int billingConfirmPurchaseError = 296;
    public static final int billingProductDetailsUpdated = 295;
    ...
    public static final int botDownloadsUpdate = 229;
    public static final int botInfoDidLoad = 64;
    public static final int botKeyboardDidLoad = 67;
    public static final int botStarsTransactionsLoaded = 220;
    public static final int botStarsUpdated = 219;
    ...
    public static final int cameraInitied = 246;
    public static final int changeRepliesCounter = 11;
    public static final int channelConnectedBotsUpdate = 231;
    public static final int channelRecommendationsLoaded = 195;
    public static final int channelRightsUpdated = 87;
    public static final int channelStarsUpdated = 221;
    public static final int channelSuggestedBotsUpdate = 230;
    public static final int chatAvailableReactionsUpdated = 284;
    ...
    public static final int chatSwitchedForum = 303;
    public static final int chatWasBoostedByUser = 206;
    public static final int chatlistFolderUpdate = 310;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 170;
    public static final int closeOtherAppActivities = 245;
    public static final int closeSearchByActiveAction = 269;
    public static final int commentsRead = 10;
    public static final int commonChatsLoaded = 234;
    public static final int conferenceEmojiUpdated = 236;
    ...
    public static final int contentSettingsLoaded = 237;
    public static final int currentUserPremiumStatusChanged = 291;
    public static final int currentUserShowLimitReachedDialog = 294;
    public static final int customStickerCreated = 209;
    public static final int customTypefacesLoaded = 313;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 285;
    public static final int diceStickersDidLoad = 59;
    public static final int didApplyNewTheme = 250;
    public static final int didClearDatabase = 272;
    ...
    public static final int didReceiveCall = 242;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 241;
    ...
    public static final int didReplacedPhotoInMemCache = 247;
    public static final int didSetNewTheme = 248;
    public static final int didSetNewWallpapper = 260;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 304;
    ...
    public static final int emojiKeywordsLoaded = 201;
    public static final int emojiLoaded = 243;
    public static final int emojiPreviewThemesChanged = 281;
    public static final int encryptedChatCreated = 35;
    public static final int encryptedChatUpdated = 33;
    public static final int factCheckLoaded = 218;
    ...
    public static final int goingToPreviewTheme = 255;
    ...
    public static final int groupPackUpdated = 207;
    public static final int groupRestrictionsUnlockedByBoosts = 205;
    ...
    public static final int invalidateMotionBackground = 244;
    public static final int liveLocationsCacheChanged = 266;
    public static final int liveLocationsChanged = 264;
    public static final int loadingMessagesFailed = 17;
    public static final int locationPermissionDenied = 257;
    public static final int locationPermissionGranted = 256;
    ...
    public static final int messagePlayingSpeedChanged = 270;
    ...
    public static final int messagesFeeUpdated = 233;
    ...
    public static final int nearEarEvent = 317;
    public static final int needAddArchivedStickers = 84;
    public static final int needCheckSystemBarColors = 252;
    ...
    public static final int needSetDayNightTheme = 254;
    public static final int needShareTheme = 253;
    ...
    public static final int newLocationAvailable = 265;
    ...
    public static final int notificationsCountUpdated = 267;
    public static final int notificationsSettingsUpdated = 40;
    public static final int onActivityResultReceived = 288;
    public static final int onDatabaseMigration = 279;
    public static final int onDatabaseOpened = 286;
    public static final int onDatabaseReset = 305;
    public static final int onDownloadingFilesChanged = 287;
    public static final int onEmojiInteractionsReceived = 280;
    public static final int onReceivedChannelDifference = 315;
    public static final int onRequestPermissionResultReceived = 289;
    public static final int onUserRingtonesUpdated = 290;
    public static final int openArticle = 88;
    public static final int openBoostForUsersDialog = 204;
    ...
    public static final int permissionsGranted = 300;
    public static final int pinnedInfoDidLoad = 66;
    public static final int playerDidStartPlaying = 268;
    public static final int premiumFloodWaitReceived = 210;
    public static final int premiumPromoUpdated = 292;
    public static final int premiumStatusChangedGlobal = 293;
    public static final int premiumStickersPreviewLoaded = 297;
    public static final int privacyRulesUpdated = 45;
    public static final int proxyChangedByRotation = 263;
    public static final int proxyCheckDone = 262;
    public static final int proxySettingsChanged = 261;
    public static final int pushMessagesUpdated = 238;
    public static final int quickRepliesDeleted = 119;
    public static final int quickRepliesUpdated = 118;
    public static final int reactionsDidLoad = 282;
    ...
    public static final int reloadInterface = 258;
    ...
    public static final int requestPermissions = 299;
    public static final int savedMessagesDialogsUpdate = 196;
    public static final int savedMessagesForwarded = 200;
    public static final int savedReactionTagsUpdate = 197;
    public static final int scheduledMessagesUpdated = 103;
    public static final int screenStateChanged = 271;
    public static final int screenshotTook = 157;
    public static final int sendingMessagesChanged = 99;
    public static final int showBulletin = 276;
    public static final int smsJobStatusUpdate = 202;
    public static final int starBalanceUpdated = 215;
    public static final int starGiftOptionsLoaded = 213;
    public static final int starGiftSoldOut = 227;
    public static final int starGiftsLoaded = 224;
    public static final int starGiveawayOptionsLoaded = 214;
    public static final int starOptionsLoaded = 212;
    public static final int starReactionAnonymousUpdate = 121;
    public static final int starSubscriptionsLoaded = 217;
    public static final int starTransactionsLoaded = 216;
    public static final int starUserGiftCollectionsLoaded = 226;
    public static final int starUserGiftsLoaded = 225;
    public static final int startAllHeavyOperations = 96;
    public static final int startSpoilers = 98;
    public static final int stealthModeChanged = 314;
    ...
    public static final int storiesDraftsUpdated = 309;
    public static final int storiesEnabledUpdate = 189;
    public static final int storiesLimitUpdate = 191;
    public static final int storiesListUpdated = 308;
    public static final int storiesReadUpdated = 316;
    public static final int storiesSendAsUpdate = 192;
    public static final int storiesUpdated = 307;
    public static final int storyAlbumsCollectionsUpdate = 199;
    public static final int storyQualityUpdate = 203;
    public static final int suggestedFiltersLoaded = 180;
    public static final int suggestedLangpack = 259;
    public static final int themeAccentListUpdated = 251;
    public static final int themeListUpdated = 249;
    ...
    public static final int timezonesUpdated = 208;
    public static final int topicsDidLoaded = 302;
    private static int totalEvents = 320;
    public static final int translationModelDownloaded = 319;
    public static final int translationModelDownloading = 318;
    public static final int twoStepPasswordChanged = 50;
    public static final int unconfirmedAuthUpdate = 193;
    public static final int updateAllMessages = 223;
    ...
    public static final int updateStories = 228;
    public static final int updateTranscriptionLock = 116;
    public static final int uploadStoryEnd = 312;
    public static final int uploadStoryProgress = 311;
    public static final int userEmojiStatusUpdated = 298;
    ...
    public static final int voipServiceCreated = 273;
    public static final int walletPendingTransactionsChanged = 130;
    public static final int walletSyncProgressChanged = 131;
    public static final int wallpaperSettedToUser = 306;
    public static final int wallpapersDidLoad = 239;
    public static final int wallpapersNeedReload = 240;
    public static final int wasUnableToFindCurrentLocation = 78;
    public static final int webRtcMicAmplitudeEvent = 274;
    public static final int webRtcSpeakerAmplitudeEvent = 275;
    public static final int webViewResolved = 222;
    ...
    public void lambda$postNotificationNameOnUIThread$1(int i, Object... objArr) {
        ...
        if (i != startAllHeavyOperations) {
            if (i == stopAllHeavyOperations) {
                intValue = ((Integer) objArr[0]).intValue() | this.currentHeavyOperationFlags;
            }
        ...
        intValue = (((Integer) objArr[0]).intValue() ^ (-1)) & this.currentHeavyOperationFlags;
        this.currentHeavyOperationFlags = intValue;
