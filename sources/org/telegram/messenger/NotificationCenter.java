...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 296;
    public static final int adminedChannelsLoaded = 228;
    ...
    public static final int appConfigUpdated = 231;
    public static final int appDidLogout = 171;
    public static final int appUpdateAvailable = 272;
    public static final int appUpdateLoading = 273;
    ...
    public static final int attachMenuBotsDidLoad = 278;
    ...
    public static final int billingConfirmPurchaseError = 291;
    public static final int billingProductDetailsUpdated = 290;
    ...
    public static final int botDownloadsUpdate = 225;
    public static final int botInfoDidLoad = 63;
    public static final int botKeyboardDidLoad = 66;
    public static final int botStarsTransactionsLoaded = 217;
    public static final int botStarsUpdated = 216;
    ...
    public static final int cameraInitied = 241;
    public static final int changeRepliesCounter = 10;
    public static final int channelConnectedBotsUpdate = 227;
    public static final int channelRecommendationsLoaded = 193;
    public static final int channelRightsUpdated = 86;
    public static final int channelStarsUpdated = 218;
    public static final int channelSuggestedBotsUpdate = 226;
    public static final int chatAvailableReactionsUpdated = 279;
    ...
    public static final int chatSwithcedToForum = 298;
    public static final int chatWasBoostedByUser = 203;
    public static final int chatlistFolderUpdate = 305;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 169;
    public static final int closeOtherAppActivities = 240;
    public static final int closeSearchByActiveAction = 264;
    public static final int commentsRead = 9;
    public static final int commonChatsLoaded = 230;
    public static final int conferenceEmojiUpdated = 232;
    ...
    public static final int currentUserPremiumStatusChanged = 286;
    public static final int currentUserShowLimitReachedDialog = 289;
    public static final int customStickerCreated = 206;
    public static final int customTypefacesLoaded = 308;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 280;
    public static final int diceStickersDidLoad = 58;
    public static final int didApplyNewTheme = 245;
    public static final int didClearDatabase = 267;
    ...
    public static final int didReceiveCall = 237;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 236;
    ...
    public static final int didReplacedPhotoInMemCache = 242;
    public static final int didSetNewTheme = 243;
    public static final int didSetNewWallpapper = 255;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 299;
    ...
    public static final int emojiLoaded = 238;
    public static final int emojiPreviewThemesChanged = 276;
    public static final int encryptedChatCreated = 34;
    public static final int encryptedChatUpdated = 32;
    public static final int factCheckLoaded = 215;
    ...
    public static final int goingToPreviewTheme = 250;
    ...
    public static final int invalidateMotionBackground = 239;
    public static final int liveLocationsCacheChanged = 261;
    public static final int liveLocationsChanged = 259;
    public static final int loadingMessagesFailed = 16;
    public static final int locationPermissionDenied = 252;
    public static final int locationPermissionGranted = 251;
    ...
    public static final int messagePlayingSpeedChanged = 265;
    ...
    public static final int messagesFeeUpdated = 229;
    ...
    public static final int nearEarEvent = 312;
    public static final int needAddArchivedStickers = 83;
    public static final int needCheckSystemBarColors = 247;
    ...
    public static final int needSetDayNightTheme = 249;
    public static final int needShareTheme = 248;
    ...
    public static final int newLocationAvailable = 260;
    ...
    public static final int notificationsCountUpdated = 262;
    public static final int notificationsSettingsUpdated = 39;
    public static final int onActivityResultReceived = 283;
    public static final int onDatabaseMigration = 274;
    public static final int onDatabaseOpened = 281;
    public static final int onDatabaseReset = 300;
    public static final int onDownloadingFilesChanged = 282;
    public static final int onEmojiInteractionsReceived = 275;
    public static final int onReceivedChannelDifference = 310;
    public static final int onRequestPermissionResultReceived = 284;
    public static final int onUserRingtonesUpdated = 285;
    ...
    public static final int permissionsGranted = 295;
    public static final int pinnedInfoDidLoad = 65;
    public static final int playerDidStartPlaying = 263;
    public static final int premiumFloodWaitReceived = 207;
    public static final int premiumPromoUpdated = 287;
    public static final int premiumStatusChangedGlobal = 288;
    public static final int premiumStickersPreviewLoaded = 292;
    public static final int privacyRulesUpdated = 44;
    public static final int proxyChangedByRotation = 258;
    public static final int proxyCheckDone = 257;
    public static final int proxySettingsChanged = 256;
    public static final int pushMessagesUpdated = 233;
    public static final int quickRepliesDeleted = 118;
    public static final int quickRepliesUpdated = 117;
    public static final int reactionsDidLoad = 277;
    ...
    public static final int reloadInterface = 253;
    ...
    public static final int requestPermissions = 294;
    ...
    public static final int screenStateChanged = 266;
    public static final int screenshotTook = 156;
    public static final int sendingMessagesChanged = 98;
    public static final int showBulletin = 271;
    public static final int smsJobStatusUpdate = 199;
    public static final int starBalanceUpdated = 212;
    public static final int starGiftOptionsLoaded = 210;
    public static final int starGiftSoldOut = 223;
    public static final int starGiftsLoaded = 221;
    public static final int starGiveawayOptionsLoaded = 211;
    public static final int starOptionsLoaded = 209;
    public static final int starReactionAnonymousUpdate = 120;
    public static final int starSubscriptionsLoaded = 214;
    public static final int starTransactionsLoaded = 213;
    public static final int starUserGiftsLoaded = 222;
    public static final int startAllHeavyOperations = 95;
    public static final int startSpoilers = 97;
    public static final int stealthModeChanged = 309;
    ...
    public static final int storiesDraftsUpdated = 304;
    public static final int storiesEnabledUpdate = 187;
    public static final int storiesLimitUpdate = 189;
    public static final int storiesListUpdated = 303;
    public static final int storiesReadUpdated = 311;
    public static final int storiesSendAsUpdate = 190;
    public static final int storiesUpdated = 302;
    public static final int storyQualityUpdate = 200;
    public static final int suggestedFiltersLoaded = 179;
    public static final int suggestedLangpack = 254;
    public static final int themeAccentListUpdated = 246;
    public static final int themeListUpdated = 244;
    ...
    public static final int topicsDidLoaded = 297;
    private static int totalEvents = 313;
    public static final int twoStepPasswordChanged = 49;
    public static final int unconfirmedAuthUpdate = 191;
    public static final int updateAllMessages = 220;
    ...
    public static final int updateStories = 224;
    public static final int updateTranscriptionLock = 115;
    public static final int uploadStoryEnd = 307;
    public static final int uploadStoryProgress = 306;
    public static final int userEmojiStatusUpdated = 293;
    ...
    public static final int voipServiceCreated = 268;
    public static final int walletPendingTransactionsChanged = 129;
    public static final int walletSyncProgressChanged = 130;
    public static final int wallpaperSettedToUser = 301;
    public static final int wallpapersDidLoad = 234;
    public static final int wallpapersNeedReload = 235;
    public static final int wasUnableToFindCurrentLocation = 77;
    public static final int webRtcMicAmplitudeEvent = 269;
    public static final int webRtcSpeakerAmplitudeEvent = 270;
    public static final int webViewResolved = 219;
