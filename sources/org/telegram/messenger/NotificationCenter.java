...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 294;
    ...
    public static final int appUpdateAvailable = 270;
    public static final int appUpdateLoading = 271;
    ...
    public static final int attachMenuBotsDidLoad = 276;
    ...
    public static final int billingConfirmPurchaseError = 289;
    public static final int billingProductDetailsUpdated = 288;
    ...
    public static final int cameraInitied = 239;
    ...
    public static final int chatAvailableReactionsUpdated = 277;
    ...
    public static final int chatSwithcedToForum = 296;
    public static final int chatWasBoostedByUser = 203;
    public static final int chatlistFolderUpdate = 303;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 169;
    public static final int closeOtherAppActivities = 238;
    public static final int closeSearchByActiveAction = 262;
    ...
    public static final int currentUserPremiumStatusChanged = 284;
    public static final int currentUserShowLimitReachedDialog = 287;
    public static final int customStickerCreated = 206;
    public static final int customTypefacesLoaded = 306;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 278;
    public static final int diceStickersDidLoad = 58;
    public static final int didApplyNewTheme = 243;
    public static final int didClearDatabase = 265;
    ...
    public static final int didReceiveCall = 235;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 234;
    ...
    public static final int didReplacedPhotoInMemCache = 240;
    public static final int didSetNewTheme = 241;
    public static final int didSetNewWallpapper = 253;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 297;
    ...
    public static final int emojiLoaded = 236;
    public static final int emojiPreviewThemesChanged = 274;
    ...
    public static final int goingToPreviewTheme = 248;
    ...
    public static final int invalidateMotionBackground = 237;
    public static final int liveLocationsCacheChanged = 259;
    public static final int liveLocationsChanged = 257;
    public static final int loadingMessagesFailed = 16;
    public static final int locationPermissionDenied = 250;
    public static final int locationPermissionGranted = 249;
    ...
    public static final int messagePlayingSpeedChanged = 263;
    ...
    public static final int nearEarEvent = 310;
    public static final int needAddArchivedStickers = 83;
    public static final int needCheckSystemBarColors = 245;
    ...
    public static final int needSetDayNightTheme = 247;
    public static final int needShareTheme = 246;
    ...
    public static final int newLocationAvailable = 258;
    ...
    public static final int notificationsCountUpdated = 260;
    public static final int notificationsSettingsUpdated = 39;
    public static final int onActivityResultReceived = 281;
    public static final int onDatabaseMigration = 272;
    public static final int onDatabaseOpened = 279;
    public static final int onDatabaseReset = 298;
    public static final int onDownloadingFilesChanged = 280;
    public static final int onEmojiInteractionsReceived = 273;
    public static final int onReceivedChannelDifference = 308;
    public static final int onRequestPermissionResultReceived = 282;
    public static final int onUserRingtonesUpdated = 283;
    ...
    public static final int permissionsGranted = 293;
    public static final int pinnedInfoDidLoad = 65;
    public static final int playerDidStartPlaying = 261;
    public static final int premiumFloodWaitReceived = 207;
    public static final int premiumPromoUpdated = 285;
    public static final int premiumStatusChangedGlobal = 286;
    public static final int premiumStickersPreviewLoaded = 290;
    public static final int privacyRulesUpdated = 44;
    public static final int proxyChangedByRotation = 256;
    public static final int proxyCheckDone = 255;
    public static final int proxySettingsChanged = 254;
    public static final int pushMessagesUpdated = 231;
    public static final int quickRepliesDeleted = 118;
    public static final int quickRepliesUpdated = 117;
    public static final int reactionsDidLoad = 275;
    ...
    public static final int reloadInterface = 251;
    ...
    public static final int requestPermissions = 292;
    ...
    public static final int stealthModeChanged = 307;
    ...
    public static final int storiesDraftsUpdated = 302;
    public static final int storiesEnabledUpdate = 187;
    public static final int storiesLimitUpdate = 189;
    public static final int storiesListUpdated = 301;
    public static final int storiesReadUpdated = 309;
    public static final int storiesSendAsUpdate = 190;
    public static final int storiesUpdated = 300;
    public static final int storyQualityUpdate = 200;
    public static final int suggestedFiltersLoaded = 179;
    public static final int suggestedLangpack = 252;
    public static final int themeAccentListUpdated = 244;
    public static final int themeListUpdated = 242;
    ...
    public static final int topicsDidLoaded = 295;
    private static int totalEvents = 311;
    ...
    public static final int uploadStoryEnd = 305;
    public static final int uploadStoryProgress = 304;
    public static final int userEmojiStatusUpdated = 291;
    ...
    public static final int voipServiceCreated = 266;
    public static final int walletPendingTransactionsChanged = 129;
    public static final int walletSyncProgressChanged = 130;
    public static final int wallpaperSettedToUser = 299;
    public static final int wallpapersDidLoad = 232;
    public static final int wallpapersNeedReload = 233;
    public static final int wasUnableToFindCurrentLocation = 77;
    public static final int webRtcMicAmplitudeEvent = 267;
    public static final int webRtcSpeakerAmplitudeEvent = 268;
