...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 309;
    ...
    public static final int appUpdateAvailable = 285;
    public static final int appUpdateLoading = 286;
    ...
    public static final int attachMenuBotsDidLoad = 291;
    ...
    public static final int billingConfirmPurchaseError = 304;
    public static final int billingProductDetailsUpdated = 303;
    ...
    public static final int botForumDraftDelete = 331;
    public static final int botForumDraftUpdate = 330;
    public static final int botForumTopicDidCreate = 329;
    ...
    public static final int cameraInitied = 254;
    ...
    public static final int chatAvailableReactionsUpdated = 292;
    ...
    public static final int chatSwitchedForum = 311;
    public static final int chatWasBoostedByUser = 211;
    public static final int chatlistFolderUpdate = 319;
    ...
    public static final int closeOtherAppActivities = 253;
    public static final int closeProfileActivity = 6;
    public static final int closeSearchByActiveAction = 277;
    public static final int commentsRead = 12;
    public static final int commonChatsLoaded = 239;
    public static final int conferenceEmojiUpdated = 241;
    ...
    public static final int contentSettingsLoaded = 242;
    public static final int currentUserPremiumStatusChanged = 299;
    public static final int currentUserShowLimitReachedDialog = 302;
    public static final int customStickerCreated = 214;
    public static final int customTypefacesLoaded = 322;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 293;
    public static final int diceStickersDidLoad = 61;
    public static final int didApplyNewTheme = 258;
    public static final int didClearDatabase = 280;
    ...
    public static final int didReceiveCall = 250;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 249;
    ...
    public static final int didReplacedPhotoInMemCache = 255;
    public static final int didSetNewTheme = 256;
    public static final int didSetNewWallpapper = 268;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 312;
    ...
    public static final int emojiLoaded = 251;
    public static final int emojiPreviewThemesChanged = 289;
    ...
    public static final int goingToPreviewTheme = 263;
    ...
    public static final int invalidateMotionBackground = 252;
    public static final int liveLocationsCacheChanged = 274;
    public static final int liveLocationsChanged = 272;
    ...
    public static final int locationPermissionDenied = 265;
    public static final int locationPermissionGranted = 264;
    ...
    public static final int messagePlayingSpeedChanged = 278;
    ...
    public static final int musicIdsLoaded = 244;
    public static final int musicListLoaded = 243;
    public static final int nearEarEvent = 326;
    public static final int needAddArchivedStickers = 86;
    public static final int needCheckSystemBarColors = 260;
    ...
    public static final int needSetDayNightTheme = 262;
    public static final int needShareTheme = 261;
    ...
    public static final int newLocationAvailable = 273;
    ...
    public static final int notificationsCountUpdated = 275;
    public static final int notificationsSettingsUpdated = 42;
    public static final int onActivityResultReceived = 296;
    public static final int onDatabaseMigration = 287;
    public static final int onDatabaseOpened = 294;
    public static final int onDatabaseReset = 313;
    public static final int onDownloadingFilesChanged = 295;
    public static final int onEmojiInteractionsReceived = 288;
    public static final int onReceivedChannelDifference = 324;
    public static final int onRequestPermissionResultReceived = 297;
    public static final int onUserRingtonesUpdated = 298;
    ...
    public static final int permissionsGranted = 308;
    public static final int pinnedInfoDidLoad = 68;
    public static final int playerDidStartPlaying = 276;
    public static final int premiumFloodWaitReceived = 215;
    public static final int premiumPromoUpdated = 300;
    public static final int premiumStatusChangedGlobal = 301;
    public static final int premiumStickersPreviewLoaded = 305;
    public static final int privacyRulesUpdated = 47;
    public static final int profileMusicUpdated = 245;
    public static final int proxyChangedByRotation = 271;
    public static final int proxyCheckDone = 270;
    public static final int proxySettingsChanged = 269;
    public static final int pushMessagesUpdated = 246;
    public static final int quickRepliesDeleted = 121;
    public static final int quickRepliesUpdated = 120;
    public static final int reactionsDidLoad = 290;
    ...
    public static final int reloadInterface = 266;
    ...
    public static final int requestPermissions = 307;
    ...
    public static final int stealthModeChanged = 323;
    ...
    public static final int storiesDraftsUpdated = 318;
    public static final int storiesEnabledUpdate = 194;
    public static final int storiesLimitUpdate = 196;
    public static final int storiesListUpdated = 317;
    public static final int storiesReadUpdated = 325;
    public static final int storiesSendAsUpdate = 197;
    public static final int storiesUpdated = 315;
    public static final int storyAlbumsCollectionsUpdate = 204;
    public static final int storyDeleted = 316;
    ...
    public static final int suggestedLangpack = 267;
    public static final int themeAccentListUpdated = 259;
    public static final int themeListUpdated = 257;
    ...
    public static final int tlSchemeParseException = 332;
    public static final int topicsDidLoaded = 310;
    private static int totalEvents = 333;
    public static final int translationModelDownloaded = 328;
    public static final int translationModelDownloading = 327;
    ...
    public static final int uploadStoryEnd = 321;
    public static final int uploadStoryProgress = 320;
    public static final int userEmojiStatusUpdated = 306;
    ...
    public static final int voipServiceCreated = 281;
    public static final int walletPendingTransactionsChanged = 132;
    public static final int walletSyncProgressChanged = 133;
    public static final int wallpaperSettedToUser = 314;
    public static final int wallpapersDidLoad = 247;
    public static final int wallpapersNeedReload = 248;
    public static final int wasUnableToFindCurrentLocation = 80;
    public static final int webRtcMicAmplitudeEvent = 282;
    public static final int webRtcSpeakerAmplitudeEvent = 283;
