...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 304;
    ...
    public static final int appUpdateAvailable = 280;
    public static final int appUpdateLoading = 281;
    ...
    public static final int attachMenuBotsDidLoad = 286;
    ...
    public static final int billingConfirmPurchaseError = 299;
    public static final int billingProductDetailsUpdated = 298;
    ...
    public static final int cameraInitied = 249;
    ...
    public static final int chatAvailableReactionsUpdated = 287;
    ...
    public static final int chatSwitchedForum = 306;
    public static final int chatWasBoostedByUser = 206;
    public static final int chatlistFolderUpdate = 313;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 170;
    public static final int closeOtherAppActivities = 248;
    public static final int closeSearchByActiveAction = 272;
    ...
    public static final int currentUserPremiumStatusChanged = 294;
    public static final int currentUserShowLimitReachedDialog = 297;
    public static final int customStickerCreated = 209;
    public static final int customTypefacesLoaded = 316;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 288;
    public static final int diceStickersDidLoad = 59;
    public static final int didApplyNewTheme = 253;
    public static final int didClearDatabase = 275;
    ...
    public static final int didReceiveCall = 245;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 244;
    ...
    public static final int didReplacedPhotoInMemCache = 250;
    public static final int didSetNewTheme = 251;
    public static final int didSetNewWallpapper = 263;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 307;
    ...
    public static final int emojiLoaded = 246;
    public static final int emojiPreviewThemesChanged = 284;
    ...
    public static final int goingToPreviewTheme = 258;
    ...
    public static final int invalidateMotionBackground = 247;
    public static final int liveLocationsCacheChanged = 269;
    public static final int liveLocationsChanged = 267;
    public static final int loadingMessagesFailed = 17;
    public static final int locationPermissionDenied = 260;
    public static final int locationPermissionGranted = 259;
    ...
    public static final int messagePlayingSpeedChanged = 273;
    ...
    public static final int musicIdsLoaded = 239;
    public static final int musicListLoaded = 238;
    public static final int nearEarEvent = 320;
    public static final int needAddArchivedStickers = 84;
    public static final int needCheckSystemBarColors = 255;
    ...
    public static final int needSetDayNightTheme = 257;
    public static final int needShareTheme = 256;
    ...
    public static final int newLocationAvailable = 268;
    ...
    public static final int notificationsCountUpdated = 270;
    public static final int notificationsSettingsUpdated = 40;
    public static final int onActivityResultReceived = 291;
    public static final int onDatabaseMigration = 282;
    public static final int onDatabaseOpened = 289;
    public static final int onDatabaseReset = 308;
    public static final int onDownloadingFilesChanged = 290;
    public static final int onEmojiInteractionsReceived = 283;
    public static final int onReceivedChannelDifference = 318;
    public static final int onRequestPermissionResultReceived = 292;
    public static final int onUserRingtonesUpdated = 293;
    ...
    public static final int permissionsGranted = 303;
    public static final int pinnedInfoDidLoad = 66;
    public static final int playerDidStartPlaying = 271;
    public static final int premiumFloodWaitReceived = 210;
    public static final int premiumPromoUpdated = 295;
    public static final int premiumStatusChangedGlobal = 296;
    public static final int premiumStickersPreviewLoaded = 300;
    public static final int privacyRulesUpdated = 45;
    public static final int profileMusicUpdated = 240;
    public static final int proxyChangedByRotation = 266;
    public static final int proxyCheckDone = 265;
    public static final int proxySettingsChanged = 264;
    public static final int pushMessagesUpdated = 241;
    public static final int quickRepliesDeleted = 119;
    public static final int quickRepliesUpdated = 118;
    public static final int reactionsDidLoad = 285;
    ...
    public static final int reloadInterface = 261;
    ...
    public static final int requestPermissions = 302;
    ...
    public static final int stealthModeChanged = 317;
    ...
    public static final int storiesDraftsUpdated = 312;
    public static final int storiesEnabledUpdate = 189;
    public static final int storiesLimitUpdate = 191;
    public static final int storiesListUpdated = 311;
    public static final int storiesReadUpdated = 319;
    public static final int storiesSendAsUpdate = 192;
    public static final int storiesUpdated = 310;
    ...
    public static final int suggestedLangpack = 262;
    public static final int themeAccentListUpdated = 254;
    public static final int themeListUpdated = 252;
    ...
    public static final int topicsDidLoaded = 305;
    private static int totalEvents = 323;
    public static final int translationModelDownloaded = 322;
    public static final int translationModelDownloading = 321;
    ...
    public static final int uploadStoryEnd = 315;
    public static final int uploadStoryProgress = 314;
    public static final int userEmojiStatusUpdated = 301;
    ...
    public static final int voipServiceCreated = 276;
    public static final int walletPendingTransactionsChanged = 130;
    public static final int walletSyncProgressChanged = 131;
    public static final int wallpaperSettedToUser = 309;
    public static final int wallpapersDidLoad = 242;
    public static final int wallpapersNeedReload = 243;
    public static final int wasUnableToFindCurrentLocation = 78;
    public static final int webRtcMicAmplitudeEvent = 277;
    public static final int webRtcSpeakerAmplitudeEvent = 278;
