...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 312;
    ...
    public static final int billingConfirmPurchaseError = 307;
    public static final int billingProductDetailsUpdated = 306;
    ...
    public static final int botForumDraftDelete = 334;
    public static final int botForumDraftUpdate = 333;
    public static final int botForumTopicDidCreate = 332;
    ...
    public static final int callTabsVisibleToggled = 336;
    ...
    public static final int chatSwitchedForum = 314;
    public static final int chatWasBoostedByUser = 211;
    public static final int chatlistFolderUpdate = 322;
    ...
    public static final int contactsPermissionBadgeCheck = 337;
    public static final int contentSettingsLoaded = 243;
    public static final int currentUserPremiumStatusChanged = 302;
    public static final int currentUserShowLimitReachedDialog = 305;
    public static final int customStickerCreated = 214;
    public static final int customTypefacesLoaded = 325;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 315;
    ...
    public static final int nearEarEvent = 329;
    ...
    public static final int onActivityResultReceived = 299;
    public static final int onDatabaseMigration = 290;
    public static final int onDatabaseOpened = 297;
    public static final int onDatabaseReset = 316;
    public static final int onDownloadingFilesChanged = 298;
    public static final int onEmojiInteractionsReceived = 291;
    public static final int onReceivedChannelDifference = 327;
    public static final int onRequestPermissionResultReceived = 300;
    public static final int onUserRingtonesUpdated = 301;
    ...
    public static final int permissionsGranted = 311;
    ...
    public static final int premiumPromoUpdated = 303;
    public static final int premiumStatusChangedGlobal = 304;
    public static final int premiumStickersPreviewLoaded = 308;
    ...
    public static final int requestPermissions = 310;
    ...
    public static final int stealthModeChanged = 326;
    ...
    public static final int storiesDraftsUpdated = 321;
    public static final int storiesEnabledUpdate = 194;
    public static final int storiesLimitUpdate = 196;
    public static final int storiesListUpdated = 320;
    public static final int storiesReadUpdated = 328;
    public static final int storiesSendAsUpdate = 197;
    public static final int storiesUpdated = 318;
    public static final int storyAlbumsCollectionsUpdate = 204;
    public static final int storyDeleted = 319;
    ...
    public static final int tlSchemeParseException = 335;
    public static final int topicsDidLoaded = 313;
    private static int totalEvents = 338;
    public static final int translationModelDownloaded = 331;
    public static final int translationModelDownloading = 330;
    ...
    public static final int uploadStoryEnd = 324;
    public static final int uploadStoryProgress = 323;
    public static final int userEmojiStatusUpdated = 309;
    ...
    public static final int wallpaperSettedToUser = 317;
