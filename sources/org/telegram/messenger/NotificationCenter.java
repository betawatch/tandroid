...
public class NotificationCenter {
    ...
    public static final int botForumDraftDelete = 330;
    public static final int botForumDraftUpdate = 329;
    public static final int botForumTopicDidCreate = 328;
    ...
    public static final int chatlistFolderUpdate = 318;
    ...
    public static final int customTypefacesLoaded = 321;
    ...
    public static final int nearEarEvent = 325;
    ...
    public static final int onReceivedChannelDifference = 323;
    ...
    public static final int stealthModeChanged = 322;
    ...
    public static final int storiesDraftsUpdated = 317;
    public static final int storiesEnabledUpdate = 194;
    public static final int storiesLimitUpdate = 196;
    public static final int storiesListUpdated = 316;
    public static final int storiesReadUpdated = 324;
    ...
    public static final int tlSchemeParseException = 331;
    public static final int topicsDidLoaded = 310;
    private static int totalEvents = 332;
    public static final int translationModelDownloaded = 327;
    public static final int translationModelDownloading = 326;
    ...
    public static final int uploadStoryEnd = 320;
    public static final int uploadStoryProgress = 319;
