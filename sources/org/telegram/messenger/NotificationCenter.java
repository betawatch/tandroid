...
public class NotificationCenter {
    ...
    public static final int activeGroupCallsUpdated = 168;
    public static final int activityPermissionsGranted = 306;
    public static final int adminedChannelsLoaded = 234;
    ...
    public static final int appConfigUpdated = 237;
    public static final int appDidLogout = 174;
    public static final int appUpdateAvailable = 282;
    public static final int appUpdateLoading = 283;
    public static final int applyGroupCallVisibleParticipants = 169;
    public static final int archivedStickersCountDidLoad = 87;
    public static final int articleClosed = 91;
    public static final int attachMenuBotsDidLoad = 288;
    ...
    public static final int availableEffectsUpdate = 213;
    public static final int billingConfirmPurchaseError = 301;
    public static final int billingProductDetailsUpdated = 300;
    ...
    public static final int botStarsUpdated = 221;
    ...
    public static final int cameraInitied = 251;
    public static final int changeRepliesCounter = 13;
    public static final int channelConnectedBotsUpdate = 233;
    public static final int channelRecommendationsLoaded = 197;
    public static final int channelRightsUpdated = 89;
    public static final int channelStarsUpdated = 223;
    public static final int channelSuggestedBotsUpdate = 232;
    public static final int chatAvailableReactionsUpdated = 289;
    ...
    public static final int chatSwitchedForum = 308;
    public static final int chatWasBoostedByUser = 208;
    public static final int chatlistFolderUpdate = 315;
    public static final int closeChatActivity = 5;
    public static final int closeChats = 4;
    public static final int closeInCallActivity = 172;
    public static final int closeOtherAppActivities = 250;
    public static final int closeProfileActivity = 6;
    public static final int closeSearchByActiveAction = 274;
    public static final int commentsRead = 12;
    public static final int commonChatsLoaded = 236;
    public static final int conferenceEmojiUpdated = 238;
    public static final int configLoaded = 175;
    public static final int contactsDidLoad = 25;
    public static final int contactsImported = 26;
    public static final int contentSettingsLoaded = 239;
    public static final int currentUserPremiumStatusChanged = 296;
    public static final int currentUserShowLimitReachedDialog = 299;
    public static final int customStickerCreated = 211;
    public static final int customTypefacesLoaded = 318;
    public static final int dialogDeleted = 112;
    public static final int dialogFiltersUpdated = 180;
    public static final int dialogIsTranslatable = 129;
    public static final int dialogPhotosLoaded = 38;
    public static final int dialogPhotosUpdate = 196;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 290;
    public static final int diceStickersDidLoad = 61;
    public static final int didApplyNewTheme = 255;
    public static final int didClearDatabase = 277;
    public static final int didCreatedNewDeleteTask = 45;
    public static final int didEndCall = 171;
    ...
    public static final int didReceiveCall = 247;
    public static final int didReceiveNewMessages = 1;
    public static final int didReceiveSmsCode = 246;
    ...
    public static final int didReplacedPhotoInMemCache = 252;
    public static final int didSetNewTheme = 253;
    public static final int didSetNewWallpapper = 265;
    ...
    public static final int didStartedMultiGiftsSelector = 185;
    public static final int didUpdateConnectionState = 136;
    public static final int didUpdateExtendedMedia = 103;
    public static final int didUpdateGlobalAutoDeleteTimer = 309;
    public static final int didUpdateMessagesViews = 77;
    public static final int didUpdatePollResults = 93;
    public static final int didUpdatePremiumGiftFieldIcon = 190;
    public static final int didUpdatePremiumGiftStickers = 188;
    public static final int didUpdateReactions = 102;
    public static final int didUpdateTonGiftStickers = 189;
    public static final int didVerifyMessagesStickers = 104;
    public static final int emojiKeywordsLoaded = 203;
    public static final int emojiLoaded = 248;
    public static final int emojiPreviewThemesChanged = 286;
    public static final int encryptedChatCreated = 37;
    public static final int encryptedChatUpdated = 35;
    public static final int factCheckLoaded = 220;
    ...
    public static final int filterSettingsUpdated = 181;
    public static final int folderBecomeEmpty = 40;
    public static final int forceImportContactsStart = 24;
    public static final int giftsToUserSent = 184;
    private static volatile NotificationCenter globalInstance = null;
    public static final int goingToPreviewTheme = 260;
    public static final int groupCallScreencastStateChanged = 167;
    public static final int groupCallSpeakingUsersUpdated = 166;
    public static final int groupCallTypingsUpdated = 170;
    public static final int groupCallUpdated = 165;
    public static final int groupCallVisibilityChanged = 173;
    public static final int groupPackUpdated = 209;
    public static final int groupRestrictionsUnlockedByBoosts = 207;
    ...
    public static final int invalidateMotionBackground = 249;
    public static final int liveLocationsCacheChanged = 271;
    public static final int liveLocationsChanged = 269;
    public static final int loadingMessagesFailed = 19;
    public static final int locationPermissionDenied = 262;
    public static final int locationPermissionGranted = 261;
    ...
    public static final int messagePlayingSpeedChanged = 275;
    ...
    public static final int messagesFeeUpdated = 235;
    ...
    public static final int musicIdsLoaded = 241;
    public static final int musicListLoaded = 240;
    public static final int nearEarEvent = 322;
    public static final int needAddArchivedStickers = 86;
    public static final int needCheckSystemBarColors = 257;
    public static final int needDeleteBusinessLink = 126;
    public static final int needDeleteDialog = 176;
    public static final int needReloadRecentDialogsSearch = 78;
    public static final int needSetDayNightTheme = 259;
    public static final int needShareTheme = 258;
    ...
    public static final int newEmojiSuggestionsAvailable = 177;
    public static final int newLocationAvailable = 270;
    ...
    public static final int notificationsCountUpdated = 272;
    public static final int notificationsSettingsUpdated = 42;
    public static final int onActivityResultReceived = 293;
    public static final int onDatabaseMigration = 284;
    public static final int onDatabaseOpened = 291;
    public static final int onDatabaseReset = 310;
    public static final int onDownloadingFilesChanged = 292;
    public static final int onEmojiInteractionsReceived = 285;
    public static final int onReceivedChannelDifference = 320;
    public static final int onRequestPermissionResultReceived = 294;
    public static final int onUserRingtonesUpdated = 295;
    public static final int openArticle = 90;
    public static final int openBoostForUsersDialog = 206;
    ...
    public static final int permissionsGranted = 305;
    public static final int pinnedInfoDidLoad = 68;
    public static final int playerDidStartPlaying = 273;
    public static final int premiumFloodWaitReceived = 212;
    public static final int premiumPromoUpdated = 297;
    public static final int premiumStatusChangedGlobal = 298;
    public static final int premiumStickersPreviewLoaded = 302;
    public static final int privacyRulesUpdated = 47;
    public static final int profileMusicUpdated = 242;
    public static final int proxyChangedByRotation = 268;
    public static final int proxyCheckDone = 267;
    public static final int proxySettingsChanged = 266;
    public static final int pushMessagesUpdated = 243;
    public static final int quickRepliesDeleted = 121;
    public static final int quickRepliesUpdated = 120;
    public static final int reactionsDidLoad = 287;
    ...
    public static final int reloadInterface = 263;
    ...
    public static final int requestPermissions = 304;
    public static final int savedMessagesDialogsUpdate = 198;
    public static final int savedMessagesForwarded = 202;
    public static final int savedReactionTagsUpdate = 199;
    public static final int scheduledMessagesUpdated = 105;
    public static final int screenStateChanged = 276;
    public static final int screenshotTook = 159;
    public static final int sendingMessagesChanged = 101;
    public static final int showBulletin = 281;
    public static final int smsJobStatusUpdate = 204;
    public static final int starBalanceUpdated = 217;
    public static final int starGiftOptionsLoaded = 215;
    public static final int starGiftSoldOut = 229;
    public static final int starGiftsLoaded = 226;
    public static final int starGiveawayOptionsLoaded = 216;
    public static final int starOptionsLoaded = 214;
    public static final int starReactionAnonymousUpdate = 123;
    public static final int starSubscriptionsLoaded = 219;
    public static final int starTransactionsLoaded = 218;
    public static final int starUserGiftCollectionsLoaded = 228;
    public static final int starUserGiftsLoaded = 227;
    public static final int startAllHeavyOperations = 98;
    public static final int startSpoilers = 100;
    public static final int stealthModeChanged = 319;
    ...
    public static final int storiesBlocklistUpdate = 192;
    public static final int storiesDraftsUpdated = 314;
    public static final int storiesEnabledUpdate = 191;
    public static final int storiesLimitUpdate = 193;
    public static final int storiesListUpdated = 313;
    public static final int storiesReadUpdated = 321;
    public static final int storiesSendAsUpdate = 194;
    public static final int storiesUpdated = 312;
    public static final int storyAlbumsCollectionsUpdate = 201;
    public static final int storyQualityUpdate = 205;
    public static final int suggestedFiltersLoaded = 182;
    public static final int suggestedLangpack = 264;
    public static final int themeAccentListUpdated = 256;
    public static final int themeListUpdated = 254;
    public static final int themeUploadError = 179;
    public static final int themeUploadedToServer = 178;
    ...
    public static final int unconfirmedAuthUpdate = 195;
    public static final int updateAllMessages = 225;
    public static final int updateBotMenuButton = 183;
    ...
    public static final int updateStories = 230;
    public static final int updateTranscriptionLock = 118;
    public static final int uploadStoryEnd = 317;
    public static final int uploadStoryProgress = 316;
    public static final int userEmojiStatusUpdated = 303;
    public static final int userInfoDidLoad = 67;
    public static final int userIsPremiumBlockedUpadted = 200;
    public static final int videoLoadingStateChanged = 95;
    public static final int voiceTranscriptionUpdate = 114;
    public static final int voipServiceCreated = 278;
    public static final int walletPendingTransactionsChanged = 132;
    public static final int walletSyncProgressChanged = 133;
    public static final int wallpaperSettedToUser = 311;
    public static final int wallpapersDidLoad = 244;
    public static final int wallpapersNeedReload = 245;
    public static final int wasUnableToFindCurrentLocation = 80;
    public static final int webRtcMicAmplitudeEvent = 279;
    public static final int webRtcSpeakerAmplitudeEvent = 280;
    public static final int webViewResolved = 224;
