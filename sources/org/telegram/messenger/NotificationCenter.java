...
public class NotificationCenter {
    ...
    public static final int activityPermissionsGranted = 293;
    ...
    public static final int attachMenuBotsDidLoad = 275;
    ...
    public static final int billingConfirmPurchaseError = 288;
    public static final int billingProductDetailsUpdated = 287;
    ...
    public static final int chatAvailableReactionsUpdated = 276;
    ...
    public static final int chatSwithcedToForum = 295;
    public static final int chatWasBoostedByUser = 203;
    public static final int chatlistFolderUpdate = 302;
    ...
    public static final int currentUserPremiumStatusChanged = 283;
    public static final int currentUserShowLimitReachedDialog = 286;
    public static final int customStickerCreated = 206;
    public static final int customTypefacesLoaded = 305;
    ...
    public static final int dialogsUnreadReactionsCounterChanged = 277;
    ...
    public static final int didUpdateGlobalAutoDeleteTimer = 296;
    ...
    public static final int emojiPreviewThemesChanged = 273;
    ...
    public static final int nearEarEvent = 309;
    ...
    public static final int onActivityResultReceived = 280;
    public static final int onDatabaseMigration = 271;
    public static final int onDatabaseOpened = 278;
    public static final int onDatabaseReset = 297;
    public static final int onDownloadingFilesChanged = 279;
    public static final int onEmojiInteractionsReceived = 272;
    public static final int onReceivedChannelDifference = 307;
    public static final int onRequestPermissionResultReceived = 281;
    public static final int onUserRingtonesUpdated = 282;
    ...
    public static final int permissionsGranted = 292;
    ...
    public static final int premiumPromoUpdated = 284;
    public static final int premiumStatusChangedGlobal = 285;
    public static final int premiumStickersPreviewLoaded = 289;
    ...
    public static final int reactionsDidLoad = 274;
    ...
    public static final int requestPermissions = 291;
    ...
    public static final int stealthModeChanged = 306;
    ...
    public static final int storiesDraftsUpdated = 301;
    public static final int storiesEnabledUpdate = 187;
    public static final int storiesLimitUpdate = 189;
    public static final int storiesListUpdated = 300;
    public static final int storiesReadUpdated = 308;
    public static final int storiesSendAsUpdate = 190;
    public static final int storiesUpdated = 299;
    ...
    public static final int topicsDidLoaded = 294;
    private static int totalEvents = 310;
    ...
    public static final int uploadStoryEnd = 304;
    public static final int uploadStoryProgress = 303;
    public static final int userEmojiStatusUpdated = 290;
    ...
    public static final int wallpaperSettedToUser = 298;
