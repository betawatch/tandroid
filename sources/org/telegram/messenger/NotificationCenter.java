...
public class NotificationCenter {
    ...
    static {
        ...
        int i10 = i9 + ImageReceiver.DEFAULT_CROSSFADE_DURATION;
        messagePlayingDidStart = i9 + 149;
        messagePlayingDidSeek = i10;
        ...
        int i11 = i9 + MessagesStorage.LAST_DB_VERSION;
        appDidLogout = i9 + 176;
        configLoaded = i11;
        ...
        int i12 = i9 + VoIPService.ID_INCOMING_CALL_PRENOTIFICATION;
        userIsPremiumBlockedUpadted = i9 + 202;
        storyAlbumsCollectionsUpdate = i12;
        ...
        int i13 = i9 + TLRPC.LAYER;
        starUserGiftsLoaded = i9 + 228;
        starUserGiftCollectionsLoaded = i13;
        ...
        int i14 = i9 + MediaDataController.MAX_LINKS_COUNT;
        activeAccountChanged = i9 + 249;
        pushMessagesUpdated = i14;
    ...
    public void checkForExpiredNotifications() {
        ...
        if (j10 != Long.MAX_VALUE) {
            AndroidUtilities.runOnUIThread(new pg(this, 0), Math.max(17L, EXPIRE_NOTIFICATIONS_TIME - (elapsedRealtime - j10)));
        }
    }

    private ArrayList<NotificationCenterDelegate> createArrayForId(int i9) {
        return (i9 == didReplacedPhotoInMemCache || i9 == stopAllHeavyOperations || i9 == startAllHeavyOperations) ? new UniqArrayList() : new ArrayList<>();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$listen$4(int i9, Utilities.Callback callback, int i10, int i11, Object[] objArr) {
        if (i10 == i9) {
            callback.run(objArr);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$listen$5(View view, View.OnAttachStateChangeListener onAttachStateChangeListener, NotificationCenterDelegate notificationCenterDelegate, int i9) {
        view.removeOnAttachStateChangeListener(onAttachStateChangeListener);
        removeObserver(notificationCenterDelegate, i9);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$postNotificationDebounced$2(int i9, Object[] objArr, int i10) {
    ...
    public SparseArray<Integer> dumpObservers() {
        ...
        for (int i9 = 0; i9 < this.observers.size(); i9++) {
            int keyAt = this.observers.keyAt(i9);
            ArrayList<NotificationCenterDelegate> valueAt = this.observers.valueAt(i9);
    ...
    public boolean hasObservers(int i9) {
        return this.observers.indexOfKey(i9) >= 0;
    }
    ...
    public Runnable listen(View view, final int i9, final Utilities.Callback<Object[]> callback) {
        ...
        final NotificationCenterDelegate notificationCenterDelegate = new NotificationCenterDelegate() { // from class: org.telegram.messenger.qg
    ...
    public void lambda$postNotificationNameOnUIThread$1(int i9, Object... objArr) {
        boolean z10 = i9 == startAllHeavyOperations || i9 == stopAllHeavyOperations || i9 == didReplacedPhotoInMemCache || i9 == closeChats || i9 == invalidateMotionBackground || i9 == needCheckSystemBarColors || i9 == messageReceivedByServer2;
        ArrayList arrayList = null;
    ...
    public void removeObserver(NotificationCenterDelegate notificationCenterDelegate, int i9) {
        ...
        ArrayList<NotificationCenterDelegate> arrayList2 = this.removeAfterBroadcast.get(i9);
        if (arrayList2 == null) {
            arrayList2 = new ArrayList<>();
            this.removeAfterBroadcast.put(i9, arrayList2);
        }
        arrayList2.add(notificationCenterDelegate);
    }
    ...
    public int setAnimationInProgress(int i9, int[] iArr, boolean z10) {
        ...
        if (this.checkForExpiredNotifications == null) {
            pg pgVar = new pg(this, i10);
            this.checkForExpiredNotifications = pgVar;
            AndroidUtilities.runOnUIThread(pgVar, EXPIRE_NOTIFICATIONS_TIME);
        }
