...
public class MusicSongsScreen extends Screen implements DefaultLifecycleObserver, NotificationCenter.NotificationCenterDelegate {
    ...
    public Template onGetTemplate() {
        ...
        int min = Math.min(musicMessages.size(), NotificationCenter.dialogPhotosUpdate);
        for (final int i = 0; i < min; i++) {
            ...
            if (messageObject != null) {
                ...
                title.setOnClickListener(new OnClickListener() { // from class: org.telegram.messenger.car.MusicSongsScreen$$ExternalSyntheticLambda0
                    @Override // androidx.car.app.model.OnClickListener
                    public final void onClick() {
                        MusicSongsScreen.this.lambda$onGetTemplate$0(i);
                    }
                });
    ...
    /* renamed from: playAtIndex, reason: merged with bridge method [inline-methods] */
