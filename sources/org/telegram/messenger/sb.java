    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.a) {
            case 0:
                ...
                break;
            default:
                AndroidUtilities.runOnUIThread(new s1((fq0) this.e, (String) this.f, this.b, tLObject, this.c, this.d));
                break;
        }
    }

    public /* synthetic */ sb(fq0 fq0Var, String str, int i10, boolean z4, TLRPC.User user) {
        this.e = fq0Var;
        this.f = str;
        this.b = i10;
        this.c = z4;
