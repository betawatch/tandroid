...
public class ContactsWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i9) {
        ...
        if (sharedPreferences.getBoolean("deleted" + i9, false)) {
            i10 = i9;
            i11 = R.layout.contacts_widget_layout_1;
        } else {
            ...
            if (i12 >= 0) {
                i10 = i9;
                AccountInstance.getInstance(i12).getMessagesStorage().getWidgetDialogIds(i10, 1, arrayList, null, null, false);
            } else {
                i10 = i9;
            }
            int ceil = (int) Math.ceil(arrayList.size() / 2.0f);
            i11 = (cellsForSize == 1 || ceil <= 1) ? R.layout.contacts_widget_layout_1 : (cellsForSize == 2 || ceil <= 2) ? R.layout.contacts_widget_layout_2 : (cellsForSize == 3 || ceil <= 3) ? R.layout.contacts_widget_layout_3 : R.layout.contacts_widget_layout_4;
        }
