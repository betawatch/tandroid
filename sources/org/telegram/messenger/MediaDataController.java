...
public class MediaDataController extends BaseController {
    ...
    public /* synthetic */ void lambda$getStickerSet$33(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, final String str, final Utilities.Callback callback, boolean z, TLRPC.InputStickerSet inputStickerSet) {
        if (tL_messages_stickerSet == null) {
            if (z) {
                ...
                fetchStickerSetInternal(inputStickerSet, new Utilities.Callback2() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda153
    ...
    public /* synthetic */ void lambda$loadBotInfo$199(long j, long j2, final Utilities.Callback callback, final int i) {
        ...
        try {
            ...
            if (loadBotInfoInternal != null) {
                ...
                runnable = new Runnable() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda159
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    */
    ...
    public /* synthetic */ void lambda$searchStickers$249(final SearchStickersKey searchStickersKey, final SearchStickersResult searchStickersResult, final Utilities.Callback callback, ArrayList arrayList, String str) {
        if (this.loadingSearchStickersKeys.containsKey(searchStickersKey)) {
            ...
            this.loadingSearchStickersKeys.put(searchStickersKey, Integer.valueOf(getConnectionsManager().sendRequest(tL_messages_searchStickers, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda152
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    */
    private void loadAvatarConstructor(final boolean z) {
        ...
        if (string != null) {
            ...
            try {
                ...
                try {
                    ...
                    getConnectionsManager().sendRequest(getdefaultprofilephotoemojis, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda174
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_emojiList2 != null || System.currentTimeMillis() - j > 86400000 || BuildVars.DEBUG_PRIVATE_VERSION) {
            ...
            getConnectionsManager().sendRequest(getdefaultprofilephotoemojis2, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda174
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    MediaDataController.this.lambda$loadAvatarConstructor$242(sharedPreferences, z, tLObject, tL_error);
                }
        ...
        if (i != 3) {
            if (MessageObject.isStickerDocument(document) || MessageObject.isAnimatedStickerDocument(document, true)) {
                ...
                if (i == 2) {
                    ...
                    getConnectionsManager().sendRequest(tL_messages_faveSticker, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda160
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ...
                    if (i == 0 && z) {
                        ...
                        getConnectionsManager().sendRequest(tL_messages_saveRecentSticker, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda161
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public void getMediaCount(final long j, final long j2, final int i, final int i2, boolean z) {
        ...
        if (i == 0) {
            ...
            if (i != 4) {
                ...
                getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tL_messages_getSearchCounters, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda154
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:142:0x00d1 A[Catch: Exception -> 0x0014, TryCatch #4 {Exception -> 0x0014, blocks: (B:3:0x000a, B:5:0x000e, B:9:0x0020, B:13:0x0026, B:15:0x002c, B:18:0x0040, B:21:0x0046, B:22:0x005f, B:26:0x0081, B:31:0x008b, B:33:0x008f, B:36:0x00ce, B:41:0x01d3, B:43:0x01d9, B:46:0x01e3, B:48:0x0203, B:49:0x0230, B:51:0x0235, B:52:0x0268, B:55:0x0276, B:57:0x0272, B:60:0x020a, B:62:0x020e, B:63:0x0212, B:64:0x0217, B:65:0x021c, B:67:0x0222, B:69:0x0226, B:70:0x022b, B:72:0x027a, B:74:0x0281, B:75:0x02b4, B:78:0x0289, B:80:0x028d, B:81:0x0291, B:82:0x02b1, B:83:0x0298, B:84:0x029d, B:86:0x02a3, B:88:0x02a7, B:89:0x02ac, B:112:0x01d0, B:132:0x00a9, B:134:0x00af, B:135:0x00b1, B:137:0x00b6, B:139:0x00bc, B:140:0x00c2, B:142:0x00d1, B:144:0x00d7, B:145:0x0051, B:147:0x0057, B:148:0x0066, B:150:0x006c, B:152:0x02d1, B:155:0x0017), top: B:2:0x000a }] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:72:0x027a A[Catch: Exception -> 0x0014, TryCatch #4 {Exception -> 0x0014, blocks: (B:3:0x000a, B:5:0x000e, B:9:0x0020, B:13:0x0026, B:15:0x002c, B:18:0x0040, B:21:0x0046, B:22:0x005f, B:26:0x0081, B:31:0x008b, B:33:0x008f, B:36:0x00ce, B:41:0x01d3, B:43:0x01d9, B:46:0x01e3, B:48:0x0203, B:49:0x0230, B:51:0x0235, B:52:0x0268, B:55:0x0276, B:57:0x0272, B:60:0x020a, B:62:0x020e, B:63:0x0212, B:64:0x0217, B:65:0x021c, B:67:0x0222, B:69:0x0226, B:70:0x022b, B:72:0x027a, B:74:0x0281, B:75:0x02b4, B:78:0x0289, B:80:0x028d, B:81:0x0291, B:82:0x02b1, B:83:0x0298, B:84:0x029d, B:86:0x02a3, B:88:0x02a7, B:89:0x02ac, B:112:0x01d0, B:132:0x00a9, B:134:0x00af, B:135:0x00b1, B:137:0x00b6, B:139:0x00bc, B:140:0x00c2, B:142:0x00d1, B:144:0x00d7, B:145:0x0051, B:147:0x0057, B:148:0x0066, B:150:0x006c, B:152:0x02d1, B:155:0x0017), top: B:2:0x000a }] */
        ...
        if (DialogObject.isChatDialog(j) && ChatObject.isChannel(-j, this.currentAccount)) {
            ...
            if (i4 != 0) {
                ...
                if (i4 != 4) {
                    ...
                    final boolean z2 = z;
                    getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tL_messages_search, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda165
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    */
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: IfRegionVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r1v30 long, still in use, count: 2, list:
          (r1v30 long) from 0x0221: PHI (r1v31 long) = (r1v30 long), (r1v36 long), (r1v37 long) binds: [B:194:0x021d, B:160:0x0220, B:159:0x0214] A[DONT_GENERATE, DONT_INLINE]
          (r1v30 long) from 0x021b: CMP_L (r1v30 long), (0 long) A[WRAPPED]
    ...
    /* JADX WARN: Removed duplicated region for block: B:144:0x03e0 A[ADDED_TO_REGION, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    */
    public void loadRestrictedStatusEmojis() {
        ...
        if (string != null) {
            ...
            try {
                ...
                try {
                    ...
                    getConnectionsManager().sendRequest(getchannelrestrictedstatusemojis, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda115
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_emojiList2 != null || System.currentTimeMillis() - j > 86400000) {
            ...
            getConnectionsManager().sendRequest(getchannelrestrictedstatusemojis2, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda115
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    MediaDataController.this.lambda$loadRestrictedStatusEmojis$246(sharedPreferences, tLObject, tL_error);
                }
    ...
    public void removeInline(long j) {
        for (int i = 0; i < this.inlineBots.size(); i++) {
            if (this.inlineBots.get(i).peer.user_id == j) {
                ...
                getConnectionsManager().sendRequest(tL_contacts_resetTopPeerRating, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda164
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public void removeMultipleStickerSets(final Context context, final BaseFragment baseFragment, final ArrayList<TLRPC.TL_messages_stickerSet> arrayList) {
        ...
        final boolean[] zArr = new boolean[1];
        final int i7 = i;
        Bulletin.UndoButton delayedAction = new Bulletin.UndoButton(context, false).setUndoAction(new Runnable() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda169
            @Override // java.lang.Runnable
            public final void run() {
                MediaDataController.this.lambda$removeMultipleStickerSets$108(zArr, arrayList, i7, iArr);
            }
        }).setDelayedAction(new Runnable() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda170
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void removeRecentGif(final TLRPC.Document document) {
        ...
        getConnectionsManager().sendRequest(tL_messages_saveGif, new RequestDelegate() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda171
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    */
            ...
            if (j2 != 0) {
                ...
                if (user == null) {
                    ...
                    if (z4 || visibleReaction2 == null || !z5) {
                        ...
                        j8 = 0;
                        tL_messages_search = tL_messages_search3;
                        messagesStorage.searchSavedByTag(tLReaction, j10, str2, NotificationCenter.storiesListUpdated, arrayList2 == null ? 0 : arrayList2.size(), new Utilities.Callback4() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda134
    ...
    public SearchStickersKey searchStickers(boolean z, String str, String str2, final Utilities.Callback<ArrayList<TLRPC.Document>> callback, boolean z2) {
        ...
        if ((searchStickersResult == null || (searchStickersResult.next_offset != null && z2)) && !this.loadingSearchStickersKeys.containsKey(searchStickersKey)) {
            ...
            getInstance(this.currentAccount).getEmojiSuggestions(new String[]{str}, str2, true, new KeywordResultCallback() { // from class: org.telegram.messenger.MediaDataController$$ExternalSyntheticLambda173
    ...
    /* JADX WARN: Removed duplicated region for block: B:27:0x00c5 A[Catch: Exception -> 0x0039, TryCatch #0 {Exception -> 0x0039, blocks: (B:2:0x0000, B:4:0x0006, B:6:0x000f, B:7:0x003c, B:9:0x0040, B:10:0x0054, B:12:0x005d, B:16:0x0070, B:18:0x0077, B:21:0x008a, B:22:0x00a3, B:27:0x00c5, B:29:0x00c9, B:30:0x00de, B:32:0x00e2, B:33:0x00eb, B:35:0x00e7, B:36:0x00d2, B:38:0x00d6, B:40:0x00dc, B:41:0x0095, B:43:0x009b, B:44:0x00ab, B:46:0x00b1), top: B:1:0x0000 }] */
    /* JADX WARN: Removed duplicated region for block: B:32:0x00e2 A[Catch: Exception -> 0x0039, TryCatch #0 {Exception -> 0x0039, blocks: (B:2:0x0000, B:4:0x0006, B:6:0x000f, B:7:0x003c, B:9:0x0040, B:10:0x0054, B:12:0x005d, B:16:0x0070, B:18:0x0077, B:21:0x008a, B:22:0x00a3, B:27:0x00c5, B:29:0x00c9, B:30:0x00de, B:32:0x00e2, B:33:0x00eb, B:35:0x00e7, B:36:0x00d2, B:38:0x00d6, B:40:0x00dc, B:41:0x0095, B:43:0x009b, B:44:0x00ab, B:46:0x00b1), top: B:1:0x0000 }] */
    /* JADX WARN: Removed duplicated region for block: B:35:0x00e7 A[Catch: Exception -> 0x0039, TryCatch #0 {Exception -> 0x0039, blocks: (B:2:0x0000, B:4:0x0006, B:6:0x000f, B:7:0x003c, B:9:0x0040, B:10:0x0054, B:12:0x005d, B:16:0x0070, B:18:0x0077, B:21:0x008a, B:22:0x00a3, B:27:0x00c5, B:29:0x00c9, B:30:0x00de, B:32:0x00e2, B:33:0x00eb, B:35:0x00e7, B:36:0x00d2, B:38:0x00d6, B:40:0x00dc, B:41:0x0095, B:43:0x009b, B:44:0x00ab, B:46:0x00b1), top: B:1:0x0000 }] */
    /* JADX WARN: Removed duplicated region for block: B:40:0x00dc A[Catch: Exception -> 0x0039, TryCatch #0 {Exception -> 0x0039, blocks: (B:2:0x0000, B:4:0x0006, B:6:0x000f, B:7:0x003c, B:9:0x0040, B:10:0x0054, B:12:0x005d, B:16:0x0070, B:18:0x0077, B:21:0x008a, B:22:0x00a3, B:27:0x00c5, B:29:0x00c9, B:30:0x00de, B:32:0x00e2, B:33:0x00eb, B:35:0x00e7, B:36:0x00d2, B:38:0x00d6, B:40:0x00dc, B:41:0x0095, B:43:0x009b, B:44:0x00ab, B:46:0x00b1), top: B:1:0x0000 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
