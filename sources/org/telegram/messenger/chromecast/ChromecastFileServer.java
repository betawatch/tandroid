...
public class ChromecastFileServer extends NanoHTTPD {
    ...
    private static String formatIp4(int i) {
        return String.valueOf(i & NotificationCenter.goingToPreviewTheme) + '.' + ((i >> 8) & NotificationCenter.goingToPreviewTheme) + '.' + ((i >> 16) & NotificationCenter.goingToPreviewTheme) + '.' + ((i >> 24) & NotificationCenter.goingToPreviewTheme);
    }
