...
public class ChromecastFileServer extends NanoHTTPD {
    ...
    private static String formatIp4(int i) {
        return String.valueOf(i & NotificationCenter.proxyCheckDone) + '.' + ((i >> 8) & NotificationCenter.proxyCheckDone) + '.' + ((i >> 16) & NotificationCenter.proxyCheckDone) + '.' + ((i >> 24) & NotificationCenter.proxyCheckDone);
    }
