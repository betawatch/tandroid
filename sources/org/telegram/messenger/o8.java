...
public final /* synthetic */ class o8 implements Runnable {
    ...
    public /* synthetic */ o8(MediaDataController mediaDataController, Timer.Task task, a0.h hVar, AtomicInteger atomicInteger, Runnable runnable, int i10, Timer timer, a0.h hVar2, a0.h hVar3, boolean z10, long j10) {
        ...
        switch (i10) {
            ...
            default:
                ...
                if (!z10 || tL_chatAdminRights != null || TextUtils.isEmpty(str2)) {
                    ...
                    MessagesController.getInstance(launchActivity.K).addUserToChat(chat.id, user, 0, str2, fyVar, true, new vs(launchActivity, i11, chat, fyVar, 2), null);
                    break;
                }
        }
    }

    public /* synthetic */ o8(LaunchActivity launchActivity, String str, TLRPC.TL_chatAdminRights tL_chatAdminRights, boolean z10, String str2, int i10, TLRPC.Chat chat, fy fyVar, TLRPC.User user, long j10, String str3) {
