...
public abstract class ViewOutlineProviderImpl {
    ...
    public static ViewOutlineProvider boundsWithPaddingRoundRect(final int i) {
        return new ViewOutlineProvider() { // from class: org.telegram.messenger.utils.ViewOutlineProviderImpl.5
            @Override // android.view.ViewOutlineProvider
            public void getOutline(View view, Outline outline) {
                int i2 = i;
                outline.setRoundRect(i2, i2, view.getWidth() - i, view.getHeight() - i, Math.min(view.getWidth() - (i * 2), view.getHeight() - (i * 2)) / 2.0f);
            }
        };
    }
}
