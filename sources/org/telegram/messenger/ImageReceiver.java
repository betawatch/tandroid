    ...
    */
                                        ...
                                        if (drawable11 != drawable && drawable11 != drawable3) {
                                            if (drawable11 != drawable8 && drawable11 != drawable2) {
                                                if (drawable11 == drawable10 && drawable2 != null) {
                                                    ...
                                                    if (drawable10 != null) {
                                                        int A = ((drawable10 instanceof SvgHelper.SvgDrawable) || (drawable10 instanceof Emoji.EmojiDrawable)) ? (int) q.A(1.0f, f12, f7, 255.0f) : (int) (f11 * f7 * 255.0f);
    ...
    public void setImageBitmap(Drawable drawable) {
        ...
        if (drawable2 instanceof tk0) {
            gd0 gd0Var = (gd0) ((tk0) drawable2);
            DownloadController.getInstance(gd0Var.r.currentAccount).removeLoadingFileObserver(gd0Var);
            gd0Var.n = null;
            gd0Var.r = null;
        }
        if (drawable instanceof org.telegram.ui.Components.q5) {
        ...
        if (drawable instanceof BitmapDrawable) {
                ...
                if (obj != null && this.gradientShader == null) {
                    ...
                    if (bitmapShader == null && backgroundThreadDrawHolder == null) {
                        if (this.isAspectFit) {
                            ...
                            rectF.set(com.google.android.gms.internal.vision.e2.A(f12, f26, 2.0f, f7), com.google.android.gms.internal.vision.e2.A(f11, f27, 2.0f, f10), q.b(f12, f26, 2.0f, f7), q.b(f11, f27, 2.0f, f10));
                            if (this.isVisible) {
                            ...
                            if (Math.abs(f25 - f24) > 5.0E-4f) {
                                ...
                                if (f32 > f20) {
                                    float f33 = (int) f32;
                                    rectF.set(q.y(f33, f20, 2.0f, f7), f10, q.b(f33, f20, 2.0f, f7), f10 + f21);
                                    f18 = f21;
                                } else {
                                    float f34 = (int) (intrinsicWidth / f25);
                                    f18 = f21;
                                    rectF.set(f7, q.y(f34, f18, 2.0f, f10), f7 + f20, q.b(f34, f18, 2.0f, f10));
                                }
                            } else {
                                f18 = f21;
                                ...
                                if (this.composeShader != null) {
                                    ...
                                    if (Math.abs(f38 - f39) > 5.0E-4f) {
                                        ...
                                        if (f40 > f20) {
                                            width = (int) f40;
                                            float f41 = width;
                                            rectF.set(q.y(f41, f20, 2.0f, f7), f10, q.b(f41, f20, 2.0f, f7), f10 + f18);
                                        } else {
                                            height = (int) (height / f38);
                                            float f42 = height;
                                            rectF.set(f7, q.y(f42, f18, 2.0f, f10), f7 + f20, q.b(f42, f18, 2.0f, f10));
                                        }
                                    } else {
                                        rectF.set(f7, f10, f7 + f20, f10 + f18);
                                    }
                        ...
                        if (!this.isAspectFit) {
                            ...
                            if (backgroundThreadDrawHolder == null) {
                                ...
                                float f48 = i28;
                                f16 = f46;
                                rectF.set(com.google.android.gms.internal.vision.e2.A(f17, f47, 2.0f, f7), com.google.android.gms.internal.vision.e2.A(f16, f48, 2.0f, f10), q.b(f17, f47, 2.0f, f7), q.b(f16, f48, 2.0f, f10));
                            ...
                            if (Math.abs(f25 - f24) > 1.0E-5f) {
                                ...
                                if (f49 > f45) {
                                    float f50 = (int) f49;
                                    rectF.set(q.y(f50, f45, 2.0f, f7), f10, q.b(f50, f45, 2.0f, f7), f10 + f46);
                                } else {
                                    float f51 = (int) (intrinsicWidth / f25);
                                    rectF.set(f7, q.y(f51, f46, 2.0f, f10), f7 + f45, q.b(f51, f46, 2.0f, f10));
                                }
                                if (z12) {
            ...
            if (backgroundThreadDrawHolder == null) {
                if (this.isAspectFit) {
                    ...
                    rectF.set(com.google.android.gms.internal.vision.e2.A(f12, f53, 2.0f, f7), com.google.android.gms.internal.vision.e2.A(f11, f54, 2.0f, f10), q.b(f12, f53, 2.0f, f7), q.b(f11, f54, 2.0f, f10));
                } else {
