    ...
    */
                                                ...
                                                if (drawable11 == drawable10 && drawable2 != null) {
                                                    ...
                                                    if (drawable10 != null) {
                                                        ...
                                                        if (imageReceiver.crossfadeByScale > 0.0f || f13 >= 1.0f || !z11) {
                                                            ...
                                                            float w10 = e2.c.w(1.0f, nr.i.getInterpolation(f11), imageReceiver.crossfadeByScale, 1.0f);
    ...
    public void setImageBitmap(Drawable drawable) {
        ...
        if (drawable2 instanceof tk0) {
            ...
            DownloadController.getInstance(yc0Var.r.currentAccount).removeLoadingFileObserver(yc0Var);
            yc0Var.n = null;
            yc0Var.r = null;
        }
        if (drawable instanceof org.telegram.ui.Components.l5) {
        ...
        if (drawable instanceof BitmapDrawable) {
                ...
                if (obj != null && this.gradientShader == null) {
                    ...
                    if (bitmapShader == null && backgroundThreadDrawHolder == null) {
                        if (this.isAspectFit) {
                            ...
                            rectF.set(e2.c.x(f13, f27, 2.0f, f10), e2.c.x(f12, f28, 2.0f, f11), kh.a2.b(f13, f27, 2.0f, f10), kh.a2.b(f12, f28, 2.0f, f11));
                            if (this.isVisible) {
                            ...
                            if (Math.abs(f26 - f25) > 5.0E-4f) {
                                ...
                                if (f33 > f21) {
                                    float f34 = (int) f33;
                                    rectF.set(y3.a(f34, f21, 2.0f, f10), f11, kh.a2.b(f34, f21, 2.0f, f10), f11 + f22);
                                    f19 = f22;
                                } else {
                                    float f35 = (int) (intrinsicWidth / f26);
                                    f19 = f22;
                                    rectF.set(f10, y3.a(f35, f19, 2.0f, f11), f10 + f21, kh.a2.b(f35, f19, 2.0f, f11));
                                }
                            } else {
                                f19 = f22;
                                ...
                                if (this.composeShader != null) {
                                    ...
                                    if (Math.abs(f39 - f40) > 5.0E-4f) {
                                        ...
                                        if (f41 > f21) {
                                            width = (int) f41;
                                            float f42 = width;
                                            rectF.set(y3.a(f42, f21, 2.0f, f10), f11, kh.a2.b(f42, f21, 2.0f, f10), f11 + f19);
                                        } else {
                                            height = (int) (height / f39);
                                            float f43 = height;
                                            rectF.set(f10, y3.a(f43, f19, 2.0f, f11), f10 + f21, kh.a2.b(f43, f19, 2.0f, f11));
                                        }
                                    } else {
                                        rectF.set(f10, f11, f10 + f21, f11 + f19);
                                    }
                        ...
                        if (!this.isAspectFit) {
                            ...
                            if (backgroundThreadDrawHolder == null) {
                                ...
                                float f49 = i28;
                                f17 = f47;
                                rectF.set(e2.c.x(f18, f48, 2.0f, f10), e2.c.x(f17, f49, 2.0f, f11), kh.a2.b(f18, f48, 2.0f, f10), kh.a2.b(f17, f49, 2.0f, f11));
                            ...
                            if (Math.abs(f26 - f25) > 1.0E-5f) {
                                ...
                                if (f50 > f46) {
                                    float f51 = (int) f50;
                                    rectF.set(y3.a(f51, f46, 2.0f, f10), f11, kh.a2.b(f51, f46, 2.0f, f10), f11 + f47);
                                } else {
                                    float f52 = (int) (intrinsicWidth / f26);
                                    rectF.set(f10, y3.a(f52, f47, 2.0f, f11), f10 + f46, kh.a2.b(f52, f47, 2.0f, f11));
                                }
                                if (z11) {
            ...
            if (backgroundThreadDrawHolder == null) {
                if (this.isAspectFit) {
                    ...
                    rectF.set(e2.c.x(f13, f54, 2.0f, f10), e2.c.x(f12, f55, 2.0f, f11), kh.a2.b(f13, f54, 2.0f, f10), kh.a2.b(f12, f55, 2.0f, f11));
                } else {
            ...
            if (drawable instanceof SvgHelper.SvgDrawable) {
                ...
                if (drawable instanceof cq) {
                    Drawable drawable2 = ((cq) drawable).a;
