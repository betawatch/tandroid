...
public final /* synthetic */ class nk implements Utilities.Callback {
    ...
    public /* synthetic */ nk(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, SendMessagesHelper.DelayedMessage delayedMessage, boolean z10) {
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (this.b) {
                    ...
                    MediaDataController.getInstance(i10).getEmojiSuggestions(h71.a2, str2, false, new ai.h6(h71Var, linkedHashSet, hashMap, arrayList3, runnable), null, true, h71Var.W == 3, false, 30);
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ nk(ProfileActivity profileActivity, TLRPC.ChannelParticipant channelParticipant, TLRPC.User user, TLRPC.ChatParticipant chatParticipant, boolean z10, String str) {
    ...
    public /* synthetic */ nk(h71 h71Var, boolean z10, LinkedHashSet linkedHashSet, String str, HashMap hashMap, ArrayList arrayList) {
        this.c = h71Var;
        this.b = z10;
