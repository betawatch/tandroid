...
public final /* synthetic */ class ib implements Runnable {
    ...
    public /* synthetic */ ib(MessagesController messagesController, TLRPC.messages_Dialogs messages_dialogs, ArrayList arrayList, TLRPC.messages_Dialogs messages_dialogs2, int i10, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, Runnable runnable) {
        this.a = 0;
    ...
    public final void run() {
        ...
        switch (i10) {
                ...
                if (str.length() >= 4) {
                    if (str.length() <= 32) {
                        if (!TextUtils.equals(strArr2[0], str)) {
                            ...
                            iArr[0] = ConnectionsManager.getInstance(i11).sendRequestTyped(checkusername, new a(), new Utilities.Callback2() { // from class: org.telegram.ui.Components.yq
                                ...
                                public final void run(Object obj9, Object obj10) {
                                    ...
                                    if (z10) {
                                        ...
                                        e9Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.w6, f6Var2));
                                        return;
                                    }
                                    strArr3[0] = null;
                                    dVar2.setEnabled(false);
                                    e9Var2.setText(LocaleController.getString(R.string.UsernameInUse));
                                    e9Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.q7, f6Var2));
                                    int[] iArr3 = iArr2;
                                    int i12 = -iArr3[0];
                                    iArr3[0] = i12;
                                    AndroidUtilities.shakeViewSpring(e9Var2, i12);
                                }
                            });
                            break;
                        }
                        ...
                        e9Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.q7, f6Var));
                        int i12 = -iArr2[0];
                        iArr2[0] = i12;
            ...
            case 3:
                ...
                if (tLObject2 instanceof TLRPC.TL_messages_chats) {
                    ...
                    if (!tL_messages_chats.chats.isEmpty()) {
                        ...
                        iArr3[0] = launchActivity2.v0(this.b, r80Var2, num, num2, l4, num3, null, tL_messages_chats.chats.get(0), null, null, 0, -1);
                        break;
                    }
                }
                try {
            ...
            default:
                ...
                ((boolean[]) obj7)[0] = true;
                s5Var.a0((MessageObject) obj6, (TLRPC.InputInvoice) obj5, (TLRPC.TL_payments_paymentFormStars) obj4, new zh.z4(s5Var, (boolean[]) obj3, this.b, (Utilities.Callback) obj2, (Utilities.Callback) obj));
                break;
        }
    }

    public /* synthetic */ ib(org.telegram.ui.Cells.i3 i3Var, int[] iArr, int i10, String[] strArr, String[] strArr2, di.d dVar, org.telegram.ui.Cells.e9 e9Var, org.telegram.ui.ActionBar.f6 f6Var, int[] iArr2) {
        this.a = 1;
        this.c = i3Var;
        this.d = iArr;
        this.b = i10;
    ...
    public /* synthetic */ ib(LaunchActivity launchActivity, Object obj, Object obj2, int i10, Object obj3, Object obj4, Object obj5, Object obj6, Object obj7, int i11) {
        this.a = i11;
    ...
    public /* synthetic */ ib(fg0 fg0Var, TLObject tLObject, TLRPC.TL_error tL_error, c5.k kVar, int i10, c5.o oVar, TLRPC.TL_inputStorePaymentAuthCode tL_inputStorePaymentAuthCode, String str, TLRPC.TL_payments_canPurchaseStore tL_payments_canPurchaseStore) {
        this.a = 4;
        this.c = fg0Var;
        this.d = tLObject;
        this.e = tL_error;
    ...
    public /* synthetic */ ib(zh.s5 s5Var, boolean[] zArr, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, boolean[] zArr2, int i10, Utilities.Callback callback, Utilities.Callback callback2) {
        this.a = 5;
        this.c = s5Var;
        this.d = zArr;
