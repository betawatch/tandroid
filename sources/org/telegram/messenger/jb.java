...
public final /* synthetic */ class jb implements Runnable {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (tLObject != null) {
                    ...
                    launchActivity.p0(new qn0(5, getauthorizationform.bot_id, getauthorizationform.scope, getauthorizationform.public_key, str2, str3, str4, authorizationform, (TL_account.Password) tLObject));
                    break;
                }
                break;
            case 3:
                ...
                if (tLObject2 instanceof TLRPC.TL_messages_chats) {
                    ...
                    if (!tL_messages_chats.chats.isEmpty()) {
                        ...
                        iArr3[0] = launchActivity2.v0(this.b, oa0Var2, num, num2, l4, num3, null, tL_messages_chats.chats.get(0), null, null, 0, -1);
                        break;
                    }
                }
                try {
            ...
            case 4:
                ...
                if (!(tLObject3 instanceof TLRPC.TL_boolTrue)) {
                    if (!(tLObject3 instanceof TLRPC.TL_boolFalse)) {
                        if (tL_error != null) {
                            ...
                            new org.telegram.ui.Components.vc(yg0Var.Z, null).d0(tL_error, false);
                            break;
                        }
                    } else {
                        hg0Var.e = "RESPONSE_FALSE";
                        new org.telegram.ui.Components.vc(yg0Var.Z, null).H(R.raw.error, LocaleController.formatString(R.string.UnknownErrorCode, "RESPONSE_FALSE"));
                        break;
                    }
                } else {
                ...
                break;
            default:
                yh.v5 v5Var = (yh.v5) obj8;
                ((boolean[]) obj7)[0] = true;
                v5Var.a0((MessageObject) obj6, (TLRPC.InputInvoice) obj5, (TLRPC.TL_payments_paymentFormStars) obj4, new yh.d5(v5Var, (boolean[]) obj3, this.b, (Utilities.Callback) obj2, (Utilities.Callback) obj));
                break;
        }
    }

    public /* synthetic */ jb(org.telegram.ui.Cells.i3 i3Var, int[] iArr, int i10, String[] strArr, String[] strArr2, ci.d dVar, org.telegram.ui.Cells.e9 e9Var, org.telegram.ui.ActionBar.f6 f6Var, int[] iArr2) {
        this.a = 1;
        this.c = i3Var;
        this.d = iArr;
        this.b = i10;
    ...
    public /* synthetic */ jb(yh.v5 v5Var, boolean[] zArr, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, boolean[] zArr2, int i10, Utilities.Callback callback, Utilities.Callback callback2) {
        this.a = 5;
        this.c = v5Var;
        this.d = zArr;
