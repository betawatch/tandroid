...
public final /* synthetic */ class uh implements Runnable {
    ...
    public /* synthetic */ uh(RichMessageLayout.Text text, View view, RichMessageLayout richMessageLayout) {
        this.b = text;
        this.d = view;
    ...
    public /* synthetic */ uh(RichMessageLayout.Text text, RichMessageLayout richMessageLayout, View view) {
        this.b = text;
        this.c = richMessageLayout;
        this.d = view;
    }
