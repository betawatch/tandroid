...
public final /* synthetic */ class b8 implements Runnable {
    ...
    public /* synthetic */ b8(MediaDataController mediaDataController, int i10, TLObject tLObject, org.telegram.ui.ActionBar.p2 p2Var, boolean z4, int i11) {
        ...
        switch (i13) {
            ...
            case 3:
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    ...
                    AndroidUtilities.runOnUIThread(new gg.j(gaVar, str, createBitmap, this.b, bitmap, 12));
                    break;
                }
                break;
            default:
                ...
                cv cvVar = bvVar.c;
                cvVar.b();
                org.telegram.ui.Cells.o8 o8Var = cvVar.e;
                cvVar.d();
                ...
                ofFloat.addUpdateListener(new a51(bvVar, i15, w02));
                ofFloat.addListener(new org.telegram.ui.v0(bvVar, w02, i17));
                ...
                if ((activity != null ? activity.getWindow() : null) != null) {
                    ...
                    gj0Var = gj0Var2;
                    ofFloat2.addUpdateListener(new av(bvVar, f15, i22, w03, activity));
                    cvVar.h.addListener(new org.telegram.ui.v0(activity, w03, i16));
    ...
    public /* synthetic */ b8(SendMessagesHelper sendMessagesHelper, boolean z4, TLRPC.Message message, int i10, ArrayList arrayList, int i11) {
    ...
    public /* synthetic */ b8(org.telegram.ui.kl klVar, boolean z4, ArrayList arrayList, ArrayList arrayList2, int i10, int i11) {
        this.e = klVar;
        this.b = z4;
        this.f = arrayList;
        this.h = arrayList2;
    ...
    public /* synthetic */ b8(org.telegram.ui.Components.ga gaVar, Bitmap bitmap, int i10, int i11, String str, boolean z4) {
        this.e = gaVar;
        this.f = bitmap;
        this.c = i10;
        this.d = i11;
    ...
    public /* synthetic */ b8(bv bvVar, int i10, Context context, int i11, boolean z4, org.telegram.ui.ActionBar.p2 p2Var) {
        this.e = bvVar;
        this.c = i10;
        this.f = context;
        this.d = i11;
