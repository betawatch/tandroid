...
public final /* synthetic */ class jh implements Utilities.Callback2 {
                ...
                if (!(urlAuthResult instanceof TLRPC.TL_urlAuthResultAccepted)) {
                    ...
                    if (queryParameter == null) {
                        ...
                        try {
                            ...
                            t0Var.b.d(0, eVar);
                            n6.l.n(eVar, y8.j0.a).addOnSuccessListener(new kv0(20, cVar, dVar)).addOnFailureListener(new cj1(dVar, 1));
                            f3Var.dismiss();
                            break;
                        } catch (Exception e) {
                            FileLog.e(e);
    ...
    public /* synthetic */ jh(org.telegram.ui.ActionBar.b2 b2Var, Utilities.Callback2 callback2, l5.j jVar, Context context, int i10) {
        this.c = b2Var;
        this.d = callback2;
        this.e = jVar;
        this.f = context;
