...
public class VideoPlayerHolderBase {
    ...
    Runnable progressRunnable = new Runnable() { // from class: org.telegram.messenger.video.VideoPlayerHolderBase.1
        ...
        public void run() {
            ...
            j71 j71Var = videoPlayerHolderBase.videoPlayer;
            if (j71Var != null) {
                if (videoPlayerHolderBase.lastState == 4) {
                    videoPlayerHolderBase.progress = 1.0f;
                } else {
                    videoPlayerHolderBase.currentPosition = j71Var.n();
    ...
    private void ensurePlayerCreated(boolean z4) {
        ...
        j71 j71Var2 = new j71(false, z4);
        this.videoPlayer = j71Var2;
        j71Var2.y = this.allowMultipleInstances;
        j71Var2.G = new 2();
    ...
    public /* synthetic */ void lambda$play$6() {
        ...
        if (j71Var != null) {
            ...
            if (surface != null) {
                ...
                if (surfaceView != null) {
                    j71Var.U(surfaceView);
                } else {
                    j71Var.V(this.textureView);
                }
            }
