...
public class VideoFramesRewinder {
    ...
    private Runnable prepareRunnable = new Runnable() { // from class: org.telegram.messenger.video.VideoFramesRewinder$$ExternalSyntheticLambda2
        ...
        public final void run() {
            VideoFramesRewinder.$r8$lambda$bvA2FqZic6EBa6TWfLMCKCnBDcY(VideoFramesRewinder.this);
        }
    };
    ...
    public VideoFramesRewinder() {
        ...
        if (devicePerformanceClass == 1) {
            this.maxFramesCount = NotificationCenter.dialogPhotosUpdate;
    ...
    public static /* synthetic */ void $r8$lambda$bvA2FqZic6EBa6TWfLMCKCnBDcY(final VideoFramesRewinder videoFramesRewinder) {
        Frame frame;
        int i;
        int i2;
        int i3;
        ...
        int i4 = iArr[4];
        int i5 = 0;
        int min = Math.min(videoFramesRewinder.w / 4, iArr[0]);
        int min2 = Math.min(videoFramesRewinder.h / 4, videoFramesRewinder.meta[1]);
        ...
        for (char c = 3; videoFramesRewinder.meta[c] <= videoFramesRewinder.until.get() && i7 < videoFramesRewinder.maxFramesCount && !videoFramesRewinder.stop.get(); c = 3) {
            ...
            while (true) {
                ...
                i2 = i4;
                i3 = min2;
                if (videoFramesRewinder.meta[3] + ((long) Math.ceil(f)) >= j3) {
                    break;
                }
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.video.VideoFramesRewinder$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                VideoFramesRewinder.$r8$lambda$gsXQuVCSPGa8HapsEQavJGKCFkA(VideoFramesRewinder.this, arrayList, currentTimeMillis);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$gsXQuVCSPGa8HapsEQavJGKCFkA(VideoFramesRewinder videoFramesRewinder, ArrayList arrayList, long j) {
        videoFramesRewinder.getClass();
