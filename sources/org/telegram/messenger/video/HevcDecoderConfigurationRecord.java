...
public class HevcDecoderConfigurationRecord {
    ...
    public void parse(ByteBuffer byteBuffer) {
        ...
        this.general_profile_space = (readUInt8 & NotificationCenter.unconfirmedAuthUpdate) >> 6;
        ...
        this.reserved2 = (readUInt82 & NotificationCenter.locationPermissionGranted) >> 2;
        this.parallelismType = readUInt82 & 3;
        int readUInt83 = IsoTypeReader.readUInt8(byteBuffer);
        this.reserved3 = (readUInt83 & NotificationCenter.locationPermissionGranted) >> 2;
        this.chromaFormat = readUInt83 & 3;
        int readUInt84 = IsoTypeReader.readUInt8(byteBuffer);
        this.reserved4 = (readUInt84 & NotificationCenter.needCheckSystemBarColors) >> 3;
        this.bitDepthLumaMinus8 = readUInt84 & 7;
        int readUInt85 = IsoTypeReader.readUInt8(byteBuffer);
        this.reserved5 = (readUInt85 & NotificationCenter.needCheckSystemBarColors) >> 3;
        ...
        this.constantFrameRate = (readUInt86 & NotificationCenter.unconfirmedAuthUpdate) >> 6;
