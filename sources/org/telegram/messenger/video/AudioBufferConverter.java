...
public class AudioBufferConverter {
    ...
    private final ag.a mRemixer = new na.d(2);
    private final bg.a mResampler = new u();
    ...
    private void checkChannels(int i10, int i11) {
        ...
        if (i10 != 1 && i10 != 2) {
            throw new UnsupportedOperationException(hc.b.k(i10, "Input channel count (", ") not supported."));
        }
        if (i11 != 1 && i11 != 2) {
            throw new UnsupportedOperationException(hc.b.k(i11, "Output channel count (", ") not supported."));
        }
    }
    ...
    public int calculateRequiredOutputSize(int i10, int i11, int i12, int i13, int i14) {
        ...
        return (int) Math.ceil((this.mRemixer.J1(i10, i12, i14) * i13) / i11);
    }

    public ShortBuffer convert(ShortBuffer shortBuffer, int i10, int i11, int i12, int i13) {
        checkChannels(i11, i13);
        int J1 = this.mRemixer.J1(shortBuffer.remaining(), i11, i13);
        ShortBuffer createBuffer = createBuffer(J1);
        this.mRemixer.S0(shortBuffer, i11, createBuffer, i13);
        createBuffer.rewind();
        ShortBuffer createBuffer2 = createBuffer(((int) Math.ceil((J1 * i12) / i10)) + 10);
        this.mResampler.s0(createBuffer, i10, createBuffer2, i12, i13);
