    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i10) {
        ...
        if (sharedPreferences.getBoolean("deleted" + i10, false)) {
            ...
            if (i13 == -1) {
                ...
                edit.putInt(j7.l1.k(i10, "account"), UserConfig.selectedAccount);
            ...
            i12 = (cellsForSize == 1 || arrayList.size() <= 1) ? R.layout.shortcut_widget_layout_1 : (cellsForSize == 2 || arrayList.size() <= 2) ? R.layout.shortcut_widget_layout_2 : (cellsForSize == 3 || arrayList.size() <= 3) ? R.layout.shortcut_widget_layout_3 : R.layout.shortcut_widget_layout_4;
        }
