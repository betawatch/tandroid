...
public final /* synthetic */ class vk implements Utilities.Callback {
    ...
    public /* synthetic */ vk(SendMessagesHelper sendMessagesHelper, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, SendMessagesHelper.DelayedMessage delayedMessage, boolean z10) {
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (this.b) {
                    ...
                    MediaDataController.getInstance(i10).getEmojiSuggestions(l71.a2, str2, false, new f1.a(l71Var, linkedHashSet, hashMap, arrayList3, runnable), null, true, l71Var.W == 3, false, 30);
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ vk(ProfileActivity profileActivity, TLRPC.ChannelParticipant channelParticipant, TLRPC.User user, TLRPC.ChatParticipant chatParticipant, boolean z10, String str) {
    ...
    public /* synthetic */ vk(l71 l71Var, boolean z10, LinkedHashSet linkedHashSet, String str, HashMap hashMap, ArrayList arrayList) {
        this.c = l71Var;
        this.b = z10;
