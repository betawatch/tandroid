...
public class FileUploadOperation {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$startUploadRequest$6(int i10, int[] iArr, int i11, byte[] bArr, int i12, int i13, int i14, long j10, TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (this.estimatedSize == 0 && !this.uploadFirstPartLater && !this.nextPartFirst) {
                    ...
                    if (i14 == i17) {
                        ...
                        if ((z10 && j12 % 1048576 == 0) || (!z10 && this.saveInfoTimes == 0)) {
                            ...
                            edit.putLong(a9.p.p(new StringBuilder(), this.fileKey, "_uploaded"), j12);
                            if (this.isEncrypted) {
                                edit.putString(a9.p.p(new StringBuilder(), this.fileKey, "_ivc"), Utilities.bytesToHex(bArr2));
                            }
                            edit.commit();
                        }
                    } else {
    ...
    */
    ...
    private void storeFileUploadInfo() {
        SharedPreferences.Editor edit = this.preferences.edit();
        edit.putInt(a9.p.p(new StringBuilder(), this.fileKey, "_time"), this.uploadStartTime);
        edit.putLong(a9.p.p(new StringBuilder(), this.fileKey, "_size"), this.totalFileSize);
        edit.putLong(a9.p.p(new StringBuilder(), this.fileKey, "_id"), this.currentFileId);
        edit.remove(this.fileKey + "_uploaded");
        if (this.isEncrypted) {
            edit.putString(a9.p.p(new StringBuilder(), this.fileKey, "_iv"), Utilities.bytesToHex(this.iv));
            edit.putString(a9.p.p(new StringBuilder(), this.fileKey, "_ivc"), Utilities.bytesToHex(this.ivChange));
            edit.putString(a9.p.p(new StringBuilder(), this.fileKey, "_key"), Utilities.bytesToHex(this.key));
        }
        edit.commit();
    }
