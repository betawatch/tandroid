                                                        ...
                                                        if (this.isEncrypted) {
                                                            try {
                                                                ...
                                                                for (int i6 = 0; i6 < 4; i6++) {
                                                                    this.fingerprint |= ((digest[i6] ^ digest[i6 + 4]) & NotificationCenter.locationPermissionGranted) << (i6 * 8);
                                                                }
                                                            } catch (Exception e) {
                                                                FileLog.e(e);
                                                            }
