    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                break;
            default:
                this.b.lambda$performSendMessageRequest$83((org.telegram.ui.ActionBar.p2) this.v, (TLRPC.TL_inputMediaStakeDice) this.w, (TLRPC.TL_messages_sendMedia) this.x, this.c, this.d, this.e, this.f, this.h, this.n, this.r, this.s);
                break;
        }
    }
