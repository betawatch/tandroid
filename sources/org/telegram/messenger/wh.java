...
public abstract /* synthetic */ class wh {
    ...
    public static String g(StringBuilder sb2, String str, gf.b bVar) {
        sb2.append(str);
    ...
    public static void l(int i10, org.telegram.ui.ActionBar.n2 n2Var) {
        n2Var.presentFragment(new ThemeActivity(i10));
    }

    public static void m(int i10, org.telegram.ui.ActionBar.e6 e6Var, TextView textView, int i11, float f7) {
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(i10, e6Var));
        textView.setTextSize(i11, f7);
    }

    public static void n(int i10, org.telegram.ui.Components.xc xcVar) {
        xcVar.i(LocaleController.getString(i10)).j();
    }

    public static void o(int i10, org.telegram.ui.Components.xc xcVar, org.telegram.ui.ActionBar.e6 e6Var) {
        xcVar.t(LocaleController.getString(i10), e6Var).j();
    }
    ...
    public static void q(ViewPropertyAnimator viewPropertyAnimator, float f7, long j3) {
    ...
    public static /* synthetic */ boolean v(TLRPC.TL_game tL_game) {
        return tL_game != null;
    }

    public static /* synthetic */ boolean w(TLRPC.TL_inputMediaUploadedDocument tL_inputMediaUploadedDocument) {
