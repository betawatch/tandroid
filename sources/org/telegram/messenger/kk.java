...
public final /* synthetic */ class kk implements Runnable {
    ...
    public final void run() {
        switch (this.a) {
            ...
            case 3:
                ...
                if (f1Var != null) {
                    f1Var.g(LocaleController.getString(m5Var.e ? R.string.Gift2FilterSortByValue : R.string.Gift2FilterSortByDate), m5Var.e ? R.drawable.menu_sort_value : R.drawable.menu_sort_date, null);
                }
                f1Var2.setChecked(TLObject.hasFlag(m5Var.g, 1));
                f1Var3.setChecked(TLObject.hasFlag(m5Var.g, 2));
                f1Var4.setChecked(TLObject.hasFlag(m5Var.g, 4));
                f1Var5.setChecked(TLObject.hasFlag(m5Var.g, 8));
                if (this.r) {
                    f1Var6.setChecked(TLObject.hasFlag(m5Var.g, 256));
                    f1Var7.setChecked(TLObject.hasFlag(m5Var.g, 512));
                    break;
                }
                break;
            default:
                ...
                yh.m5 m5Var2 = i4Var.c.Y;
                f1Var8.g(LocaleController.getString(m5Var2.e ? R.string.Gift2FilterSortByValue : R.string.Gift2FilterSortByDate), m5Var2.e ? R.drawable.menu_sort_value : R.drawable.menu_sort_date, null);
                f1Var9.setChecked(TLObject.hasFlag(m5Var2.g, 1));
                f1Var10.setChecked(TLObject.hasFlag(m5Var2.g, 2));
                f1Var11.setChecked(TLObject.hasFlag(m5Var2.g, 4));
                f1Var12.setChecked(TLObject.hasFlag(m5Var2.g, 8));
                if (this.r) {
                    f1Var13.setChecked(TLObject.hasFlag(m5Var2.g, 256));
                    f1Var14.setChecked(TLObject.hasFlag(m5Var2.g, 512));
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ kk(SendMessagesHelper sendMessagesHelper, TLRPC.TL_error tL_error, TLRPC.Message message, TLObject tLObject, MessageObject messageObject, String str, HashMap hashMap, boolean z10, TLMethod tLMethod, int i10) {
        this.a = i10;
    ...
    public /* synthetic */ kk(SendMessagesHelper sendMessagesHelper, boolean z10, TLRPC.TL_error tL_error, TLRPC.Message message, TLObject tLObject, MessageObject messageObject, HashMap hashMap, String str, TLObject tLObject2) {
        this.a = 2;
        this.b = sendMessagesHelper;
        this.r = z10;
        this.c = tL_error;
