...
public class SendMessagesHelper extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public void sendSticker(TLRPC.Document document, String str, final long j, final CharSequence charSequence, final VideoEditedInfo videoEditedInfo, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final MessageObject.SendAnimationData sendAnimationData, final boolean z, final int i, final int i2, boolean z2, final Object obj, final String str2, final int i3, final long j2, final long j3, final MessageSuggestionParams messageSuggestionParams, final boolean z3) {
        ...
        if (MessageObject.isGifDocument(document2)) {
            mediaSendQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda10
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.this.lambda$sendSticker$6(document2, videoEditedInfo, j, messageObject, messageObject2, z, i, i2, obj, sendAnimationData, storyItem, replyQuote, str2, i3, j2, j3, messageSuggestionParams, charSequence, z3);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void lambda$sendSticker$6(final TLRPC.Document document, final VideoEditedInfo videoEditedInfo, final long j, final MessageObject messageObject, final MessageObject messageObject2, final boolean z, final int i, final int i2, final Object obj, final MessageObject.SendAnimationData sendAnimationData, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final String str, final int i3, final long j2, final long j3, final MessageSuggestionParams messageSuggestionParams, final CharSequence charSequence, final boolean z2) {
        ...
        final String[] strArr = {getKeyForPhotoSize(getAccountInstance(), FileLoader.getClosestPhotoSizeWithSize(document.thumbs, NotificationCenter.storiesListUpdated), bitmapArr, true, true)};
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda26
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$sendSticker$5(bitmapArr, strArr, document, videoEditedInfo, j, messageObject, messageObject2, z, i, i2, obj, sendAnimationData, storyItem, replyQuote, str, i3, j2, j3, messageSuggestionParams, charSequence, z2);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$sendSticker$5(Bitmap[] bitmapArr, String[] strArr, TLRPC.Document document, VideoEditedInfo videoEditedInfo, long j, MessageObject messageObject, MessageObject messageObject2, boolean z, int i, int i2, Object obj, MessageObject.SendAnimationData sendAnimationData, TL_stories.StoryItem storyItem, ChatActivity.ReplyQuote replyQuote, String str, int i3, long j2, long j3, MessageSuggestionParams messageSuggestionParams, CharSequence charSequence, boolean z2) {
        ...
        SendMessageParams of = SendMessageParams.of((TLRPC.TL_document) document, videoEditedInfo, null, j, messageObject, messageObject2, null, null, null, null, z, i, i2, 0, obj, sendAnimationData, false);
        of.replyToStoryItem = storyItem;
        of.replyQuote = replyQuote;
        ...
        of.monoForumPeer = j3;
        of.suggestionParams = messageSuggestionParams;
        of.caption = charSequence != null ? charSequence.toString() : null;
        of.invert_media = z2;
        sendMessage(of);
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$sendMessage$17(final TLRPC.TL_messages_forwardMessages tL_messages_forwardMessages, final long j, final int i, final boolean z, final boolean z2, final LongSparseArray longSparseArray, final ArrayList arrayList, final ArrayList arrayList2, final MessageObject messageObject, final TLRPC.Peer peer) {
        getConnectionsManager().sendRequest(tL_messages_forwardMessages, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda18
            @Override // org.telegram.tgnet.RequestDelegate
    ...
    */
                    ...
                    if (z3) {
                        ...
                        if (j2 != 0 || (message3 = (TLRPC.Message) longSparseArray.get(j2)) == null || (indexOf = arrayList3.indexOf(message3)) == -1) {
                            ...
                            if (i11 != i3) {
                                ...
                                getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda41
                                    @Override // java.lang.Runnable
                                    public final void run() {
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:102:0x05ac A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:109:0x05d2 A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:112:0x05e6 A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:117:0x0605 A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:120:0x0614 A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:131:0x065c A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:134:0x0661 A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:136:0x0679  */
    /* JADX WARN: Removed duplicated region for block: B:181:0x05db A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:189:0x034e  */
    /* JADX WARN: Removed duplicated region for block: B:346:0x0161 A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:349:0x0171 A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:350:0x0181  */
    /* JADX WARN: Removed duplicated region for block: B:69:0x029f A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /* JADX WARN: Removed duplicated region for block: B:88:0x030c A[Catch: Exception -> 0x004b, TryCatch #0 {Exception -> 0x004b, blocks: (B:9:0x0024, B:11:0x002e, B:13:0x0040, B:19:0x0057, B:22:0x0061, B:25:0x0066, B:27:0x006a, B:28:0x0097, B:31:0x009d, B:33:0x00a3, B:34:0x00aa, B:35:0x01c5, B:37:0x01c9, B:38:0x01cd, B:43:0x01e5, B:48:0x01ee, B:50:0x01f2, B:52:0x0200, B:54:0x0204, B:55:0x0219, B:57:0x021d, B:59:0x0223, B:60:0x020d, B:62:0x0213, B:63:0x0229, B:65:0x022d, B:66:0x0269, B:67:0x026c, B:69:0x029f, B:71:0x02a7, B:74:0x02ac, B:75:0x02b3, B:76:0x02b6, B:78:0x02e4, B:80:0x02ec, B:88:0x030c, B:90:0x0310, B:92:0x0314, B:95:0x032e, B:97:0x0332, B:100:0x05a8, B:102:0x05ac, B:107:0x05b5, B:109:0x05d2, B:110:0x05e2, B:112:0x05e6, B:114:0x05f6, B:115:0x05fe, B:117:0x0605, B:118:0x0610, B:120:0x0614, B:122:0x062a, B:124:0x0656, B:125:0x0632, B:127:0x0646, B:129:0x064c, B:131:0x065c, B:134:0x0661, B:141:0x0681, B:143:0x0696, B:150:0x06a3, B:152:0x06ba, B:156:0x06c2, B:163:0x06e1, B:165:0x06f7, B:172:0x0704, B:174:0x071a, B:178:0x0722, B:181:0x05db, B:183:0x05df, B:186:0x031a, B:188:0x031e, B:191:0x0353, B:193:0x035c, B:195:0x0364, B:197:0x0375, B:199:0x038c, B:200:0x0395, B:203:0x03c5, B:205:0x03db, B:207:0x03e1, B:209:0x03e7, B:212:0x03ea, B:213:0x03a2, B:215:0x03bc, B:216:0x03c1, B:219:0x040b, B:221:0x0414, B:223:0x041e, B:225:0x042f, B:227:0x0440, B:229:0x044f, B:232:0x045f, B:235:0x046c, B:237:0x0472, B:239:0x047b, B:242:0x04b1, B:244:0x04c9, B:246:0x04d6, B:247:0x04da, B:249:0x04e4, B:251:0x04fc, B:253:0x04f3, B:255:0x04f7, B:256:0x048a, B:258:0x04a8, B:259:0x04ad, B:265:0x050f, B:268:0x054f, B:271:0x0565, B:274:0x056c, B:276:0x0579, B:278:0x057e, B:279:0x052b, B:281:0x0546, B:282:0x054b, B:285:0x058d, B:287:0x0597, B:296:0x0238, B:298:0x024c, B:300:0x0252, B:301:0x025b, B:303:0x0263, B:306:0x01da, B:308:0x01e2, B:310:0x0072, B:312:0x0076, B:317:0x0086, B:319:0x0089, B:324:0x00b9, B:326:0x00cb, B:327:0x00d0, B:329:0x00fa, B:331:0x010d, B:333:0x0113, B:335:0x0119, B:337:0x01b3, B:338:0x011c, B:340:0x0142, B:346:0x0161, B:347:0x016b, B:349:0x0171, B:351:0x0183, B:353:0x01a7), top: B:8:0x0024 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    public /* synthetic */ void lambda$sendNotificationCallback$23(long j, int i, byte[] bArr) {
        ...
        getConnectionsManager().sendRequest(tL_messages_getBotCallbackAnswer, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda33
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public int sendVote(final MessageObject messageObject, ArrayList<TLRPC.PollAnswer> arrayList, final Runnable runnable) {
        ...
        return getConnectionsManager().sendRequest(tL_messages_sendVote, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda13
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public void requestUrlAuth(final String str, final ChatActivity chatActivity, final boolean z) {
        ...
        getConnectionsManager().sendRequest(tL_messages_requestUrlAuth, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda98
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                SendMessagesHelper.this.lambda$requestUrlAuth$30(tL_messages_requestUrlAuth, chatActivity, str, z, tLObject, tL_error);
            }
        }, 2);
    }
    ...
    public /* synthetic */ void lambda$requestUrlAuth$30(final TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth, final ChatActivity chatActivity, final String str, final boolean z, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda45
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$requestUrlAuth$29(tLObject, tL_messages_requestUrlAuth, chatActivity, str, z);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$sendCallback$38(final String str, final List list, boolean z, TLObject tLObject, final MessageObject messageObject, final TLRPC.KeyboardButton keyboardButton, final ChatActivity chatActivity, final TwoStepVerificationActivity twoStepVerificationActivity, TLObject[] tLObjectArr, TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, final boolean z2) {
        ...
        if (tLObject != null) {
            ...
            if (keyboardButton instanceof TLRPC.TL_keyboardButtonBuy) {
                if (tLObject instanceof TLRPC.TL_payments_paymentFormStars) {
                    StarsController.getInstance(this.currentAccount).openPaymentForm(messageObject, ((TLRPC.TL_payments_getPaymentForm) tLObjectArr[0]).invoice, (TLRPC.TL_payments_paymentFormStars) tLObject, new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda93
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.this.lambda$sendCallback$31(str, list);
                        }
                    }, new Utilities.Callback() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda94
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            if (inputCheckPasswordSRP == null) {
                ...
                builder2.setPositiveButton(LocaleController.getString(R.string.BotOwnershipTransferChangeOwner), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda95
        ...
        if ("PASSWORD_MISSING".equals(tL_error.text) || tL_error.text.startsWith("PASSWORD_TOO_FRESH_") || tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
            ...
            if ("PASSWORD_MISSING".equals(tL_error.text)) {
                builder3.setPositiveButton(LocaleController.getString(R.string.EditAdminTransferSetPassword), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda97
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
        ...
        if ("SRP_ID_INVALID".equals(tL_error.text)) {
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account.getPassword(), new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda96
                @Override // org.telegram.tgnet.RequestDelegate
    ...
    */
    private void updateMediaPaths(MessageObject messageObject, TLRPC.Message message, int i, List<String> list, boolean z, int i2) {
        ...
        if ((messageMedia instanceof TLRPC.TL_messageMediaDocument) && messageMedia.document != null && (messageMedia2 instanceof TLRPC.TL_messageMediaDocument) && messageMedia2.document != null) {
            ...
            if (photo11 != null && (photo = messageMedia.video_cover) != null) {
                ...
                TLRPC.PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(messageMedia3.document.thumbs, NotificationCenter.storiesListUpdated);
                TLRPC.PhotoSize closestPhotoSizeWithSize3 = FileLoader.getClosestPhotoSizeWithSize(messageMedia.document.thumbs, NotificationCenter.storiesListUpdated);
    ...
    /* JADX WARN: Removed duplicated region for block: B:131:0x047d A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:156:0x0529 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:159:0x0532  */
    /* JADX WARN: Removed duplicated region for block: B:162:0x053d  */
    /* JADX WARN: Removed duplicated region for block: B:168:0x0597 A[ADDED_TO_REGION] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:20:0x04d9 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:24:0x04e4  */
    /* JADX WARN: Removed duplicated region for block: B:33:0x0521  */
    /* JADX WARN: Removed duplicated region for block: B:39:0x0569  */
        ...
        if (!"game".equals(botInlineResult.type)) {
            if (botInlineResult instanceof TLRPC.TL_botInlineMediaResult) {
                ...
                if (webDocument2 != null) {
                        ...
                        case 6:
                            ...
                            switch (c2) {
                                ...
                                case 1:
                                    ...
                                    int i6 = isEncryptedDialog ? 90 : NotificationCenter.storiesListUpdated;
                                    try {
                                        if (str2.endsWith("mp4")) {
                    ...
                    if (!MessageObject.isGifDocument((TLRPC.Document) tLObject)) {
                        TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(tLObject.thumbs, NotificationCenter.storiesListUpdated);
    ...
    */
    ...
    public static void ensureMediaThumbExists(AccountInstance accountInstance, boolean z, TLObject tLObject, String str, Uri uri, long j, boolean z2) {
        ...
        if (tLObject instanceof TLRPC.TL_document) {
            ...
            if ((MessageObject.isVideoDocument(tL_document) || MessageObject.isNewGifDocument(tL_document)) && MessageObject.isDocumentHasThumb(tL_document)) {
                ...
                int i = NotificationCenter.storiesListUpdated;
                TLRPC.PhotoSize closestPhotoSizeWithSize3 = FileLoader.getClosestPhotoSizeWithSize(arrayList, NotificationCenter.storiesListUpdated);
    ...
    public static void prepareSendingMedia(final AccountInstance accountInstance, final ArrayList<SendingMediaInfo> arrayList, final long j, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final boolean z, boolean z2, final MessageObject messageObject3, final boolean z3, final int i, final int i2, int i3, final boolean z4, final InputContentInfoCompat inputContentInfoCompat, final String str, final int i4, final long j2, final boolean z5, final long j3, final long j4, final MessageSuggestionParams messageSuggestionParams) {
        ...
        mediaSendQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda34
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code restructure failed: missing block: B:339:0x0a5a, code lost:
     ...
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:148:0x03db A[Catch: Exception -> 0x03be, TRY_LEAVE, TryCatch #8 {Exception -> 0x03be, blocks: (B:189:0x03b6, B:146:0x03c3, B:183:0x03d2, B:148:0x03db), top: B:188:0x03b6 }] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:167:0x03e8 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:180:0x03cd A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:336:0x0a34  */
    /* JADX WARN: Removed duplicated region for block: B:345:0x0a6a  */
    /* JADX WARN: Removed duplicated region for block: B:37:0x0123  */
    /* JADX WARN: Removed duplicated region for block: B:386:0x090d  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:475:0x0b3a  */
    /* JADX WARN: Removed duplicated region for block: B:520:0x0ce2  */
    /* JADX WARN: Removed duplicated region for block: B:563:0x0df3  */
    /* JADX WARN: Removed duplicated region for block: B:57:0x019c  */
    /* JADX WARN: Removed duplicated region for block: B:596:0x0f3c  */
    /* JADX WARN: Removed duplicated region for block: B:600:0x0f4b A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:613:0x0fa7  */
    /* JADX WARN: Removed duplicated region for block: B:616:0x0fae  */
    /* JADX WARN: Removed duplicated region for block: B:62:0x0206  */
    /* JADX WARN: Removed duplicated region for block: B:654:0x0e60  */
    /* JADX WARN: Removed duplicated region for block: B:656:0x0df9  */
    /* JADX WARN: Removed duplicated region for block: B:65:0x020c  */
    /* JADX WARN: Removed duplicated region for block: B:665:0x0e77  */
    /* JADX WARN: Removed duplicated region for block: B:712:0x10b6  */
    /* JADX WARN: Removed duplicated region for block: B:714:0x10d4  */
    /* JADX WARN: Removed duplicated region for block: B:715:0x0b3c  */
    /* JADX WARN: Removed duplicated region for block: B:741:0x119b  */
                                    ...
                                    if (!z6) {
                                        try {
                                            if (sendingMediaInfo5.ttl == 0) {
                                                i27 = NotificationCenter.storiesListUpdated;
    ...
    */
    ...
    public static void prepareSendingVideo(final AccountInstance accountInstance, final String str, final VideoEditedInfo videoEditedInfo, final String str2, final TLRPC.Photo photo, final long j, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final ArrayList<TLRPC.MessageEntity> arrayList, final int i, final MessageObject messageObject3, final boolean z, final int i2, final int i3, final boolean z2, final boolean z3, final CharSequence charSequence, final String str3, final int i4, final long j2, final long j3, final long j4, final MessageSuggestionParams messageSuggestionParams, final boolean z4) {
        ...
        new Thread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.lambda$prepareSendingVideo$114(VideoEditedInfo.this, str, j, i, accountInstance, str2, photo, charSequence, messageObject3, z3, messageObject, messageObject2, arrayList, z, i2, i3, storyItem, replyQuote, i4, str3, j2, j3, j4, messageSuggestionParams, z4, z2);
            }
        }).start();
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:88:0x0457 A[ADDED_TO_REGION] */
    ...
    */
    public static /* synthetic */ void lambda$prepareSendingVideo$114(VideoEditedInfo videoEditedInfo, String str, final long j, final int i, final AccountInstance accountInstance, String str2, TLRPC.Photo photo, CharSequence charSequence, final MessageObject messageObject, final boolean z, final MessageObject messageObject2, final MessageObject messageObject3, final ArrayList arrayList, final boolean z2, final int i2, final int i3, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final int i4, final String str3, final long j2, final long j3, final long j4, final MessageSuggestionParams messageSuggestionParams, final boolean z3, boolean z4) {
        ...
        if (createCompressionSettings != null || str9.endsWith("mp4") || z6) {
            ...
            if (createCompressionSettings != null) {
                ...
                if (j5 >= 0) {
                        ...
                        if (sentFile != null) {
                            ...
                            if (obj instanceof TLRPC.TL_document) {
                                ...
                                if (tL_document == null) {
                                    ...
                                    int i8 = (isEncryptedDialog || i != 0) ? 90 : NotificationCenter.storiesListUpdated;
                                    float f = i8;
                                    ...
                                    if (bitmap3 == null || scaleAndSaveImage == null) {
                                        ...
                                        tL_documentAttributeVideo.round_message = z6;
                                    ...
                                    if (tL_document.thumbs.isEmpty()) {
                                        ...
                                        int i10 = (isEncryptedDialog || i != 0) ? 90 : NotificationCenter.storiesListUpdated;
                                        float f2 = i10;
                                ...
                                fileToSize = ImageLoader.fileToSize(str2, z5);
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda68
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SendMessagesHelper.lambda$prepareSendingVideo$113(bitmap, str7, messageObject, accountInstance, videoEditedInfo3, tL_document5, str9, photoSize, hashMap, z, str13, j, messageObject2, messageObject3, charSequence2, arrayList, z2, i2, i3, i, storyItem, replyQuote, i4, str3, j2, j3, j4, messageSuggestionParams, z3);
                                    }
                                });
                                return;
                            }
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda68
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.lambda$prepareSendingVideo$113(bitmap, str7, messageObject, accountInstance, videoEditedInfo32, tL_document52, str9, photoSize2, hashMap2, z, str132, j, messageObject2, messageObject3, charSequence2, arrayList, z2, i2, i3, i, storyItem, replyQuote, i4, str3, j2, j3, j4, messageSuggestionParams, z3);
                        }
                    });
                    return;
                }
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda68
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.lambda$prepareSendingVideo$113(bitmap, str7, messageObject, accountInstance, videoEditedInfo322, tL_document522, str9, photoSize22, hashMap22, z, str1322, j, messageObject2, messageObject3, charSequence2, arrayList, z2, i2, i3, i, storyItem, replyQuote, i4, str3, j2, j3, j4, messageSuggestionParams, z3);
                }
            });
            return;
        }
