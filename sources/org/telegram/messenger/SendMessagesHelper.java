...
public class SendMessagesHelper extends BaseController implements NotificationCenter.NotificationCenterDelegate {
                        ...
                        if (tLObject instanceof TLRPC.TL_messages_sendEncryptedMultiMedia) {
                            ...
                            if (tLObject instanceof TLRPC.TL_messages_sendMedia) {
                                ...
                                if (tL_messages_sendMedia.media instanceof TLRPC.TL_inputMediaPaidMedia) {
                                    SendMessagesHelper.this.lambda$performSendMessageRequestMulti$50(tL_messages_sendMedia, delayedMessageSendAfterRequest.msgObjs, delayedMessageSendAfterRequest.originalPaths, delayedMessageSendAfterRequest.parentObjects, delayedMessageSendAfterRequest.delayedMessage, delayedMessageSendAfterRequest.scheduled);
                                }
                            }
                ...
                while (i12 < arrayList6.size()) {
                    ...
                    if (inputFile2 == null || inputMedia == null) {
                        ...
                        if (i14 == 0) {
                            ...
                            str3 = str9;
                            str6 = str8;
                            lambda$performSendMessageRequest$61(delayedMessage2.sendRequest, delayedMessage2.obj, delayedMessage2.originalPath, delayedMessage2, true, null, delayedMessage2.parentObject, null, delayedMessage2.scheduled);
                        } else {
                            i9 = i12;
                            arrayList5 = arrayList6;
                            inputEncryptedFile = inputEncryptedFile2;
    ...
    */
    public void processForwardFromMyName(MessageObject messageObject, long j, long j2, long j3, MessageSuggestionParams messageSuggestionParams) {
        ...
        if (messageMedia != null && !(messageMedia instanceof TLRPC.TL_messageMediaEmpty) && !(messageMedia instanceof TLRPC.TL_messageMediaWebPage) && !(messageMedia instanceof TLRPC.TL_messageMediaGame) && !(messageMedia instanceof TLRPC.TL_messageMediaInvoice)) {
                ...
                if (message2.peer_id != null) {
                    ...
                    if ((messageMedia2.photo instanceof TLRPC.TL_photo) || (messageMedia2.document instanceof TLRPC.TL_document)) {
                        ...
                        if (!(photo instanceof TLRPC.TL_photo)) {
                            SendMessageParams of = SendMessageParams.of((TLRPC.TL_photo) photo, null, j, messageObject.replyMessageObject, null, message3.message, message3.entities, null, hashMap, true, 0, messageMedia3.ttl_seconds, messageObject, false);
                            of.payStars = j2;
                            of.monoForumPeer = j3;
                        ...
                        if (document instanceof TLRPC.TL_document) {
                            SendMessageParams of2 = SendMessageParams.of((TLRPC.TL_document) document, null, message3.attachPath, j, messageObject.replyMessageObject, null, message3.message, message3.entities, null, hashMap, true, 0, messageMedia3.ttl_seconds, messageObject, null, false);
                            of2.payStars = j2;
                        ...
                        if ((messageMedia3 instanceof TLRPC.TL_messageMediaVenue) || (messageMedia3 instanceof TLRPC.TL_messageMediaGeo)) {
                            SendMessageParams of3 = SendMessageParams.of(messageMedia3, j, messageObject.replyMessageObject, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, true, 0);
                            of3.payStars = j2;
                        ...
                        if (messageMedia3.phone_number != null) {
                            ...
                            SendMessageParams of4 = SendMessageParams.of((TLRPC.User) tL_userContact_old2, j, messageObject.replyMessageObject, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, true, 0);
            ...
            if (message.message != null) {
                ...
                SendMessageParams of5 = SendMessageParams.of(messageObject.messageOwner.message, j, messageObject.replyMessageObject, null, webPage, true, arrayList, null, null, true, 0, null, false);
                of5.payStars = j2;
    ...
    public void sendScreenshotMessage(TLRPC.User user, int i, TLRPC.Message message) {
        ...
        if (message2 != null) {
            ...
            message2.flags |= NotificationCenter.suggestedLangpack;
    ...
    public void sendSticker(TLRPC.Document document, String str, final long j, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final MessageObject.SendAnimationData sendAnimationData, final boolean z, final int i, boolean z2, final Object obj, final String str2, final int i2, final long j2, final long j3, final MessageSuggestionParams messageSuggestionParams) {
        ...
        if (MessageObject.isGifDocument(document2)) {
            mediaSendQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$sendSticker$6(final TLRPC.Document document, final long j, final MessageObject messageObject, final MessageObject messageObject2, final boolean z, final int i, final Object obj, final MessageObject.SendAnimationData sendAnimationData, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final String str, final int i2, final long j2, final long j3, final MessageSuggestionParams messageSuggestionParams) {
        ...
        final String[] strArr = {getKeyForPhotoSize(getAccountInstance(), FileLoader.getClosestPhotoSizeWithSize(document.thumbs, NotificationCenter.onReceivedChannelDifference), bitmapArr, true, true)};
    ...
    /* JADX WARN: Code restructure failed: missing block: B:264:0x080f, code lost:
    
        if (r2.contains(java.lang.Integer.valueOf(r5.reply_to_msg_id)) != false) goto L351;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:263:0x0805  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:287:0x08c4  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:307:0x098c  */
    /* JADX WARN: Removed duplicated region for block: B:310:0x09a8  */
    /* JADX WARN: Removed duplicated region for block: B:313:0x09cc  */
    /* JADX WARN: Removed duplicated region for block: B:318:0x09f3  */
    /* JADX WARN: Removed duplicated region for block: B:320:0x0a01  */
    /* JADX WARN: Removed duplicated region for block: B:323:0x0a11  */
    /* JADX WARN: Removed duplicated region for block: B:329:0x0a5a  */
    /* JADX WARN: Removed duplicated region for block: B:334:0x0a73  */
    /* JADX WARN: Removed duplicated region for block: B:336:0x0a7f  */
    /* JADX WARN: Removed duplicated region for block: B:338:0x0a99  */
    /* JADX WARN: Removed duplicated region for block: B:343:0x0abf  */
    /* JADX WARN: Removed duplicated region for block: B:346:0x0b15  */
    /* JADX WARN: Removed duplicated region for block: B:349:0x0b20  */
    /* JADX WARN: Removed duplicated region for block: B:352:0x0ac2  */
    /* JADX WARN: Removed duplicated region for block: B:353:0x0a95  */
    /* JADX WARN: Removed duplicated region for block: B:355:0x0a6b A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:356:0x0a3b  */
    /* JADX WARN: Removed duplicated region for block: B:358:0x09aa  */
    /* JADX WARN: Removed duplicated region for block: B:359:0x098f  */
    /* JADX WARN: Removed duplicated region for block: B:361:0x08c6  */
    /* JADX WARN: Removed duplicated region for block: B:364:0x08bc  */
    /* JADX WARN: Removed duplicated region for block: B:365:0x0862  */
    /* JADX WARN: Removed duplicated region for block: B:376:0x0775  */
    ...
    public int sendMessage(final ArrayList<MessageObject> arrayList, final long j, final boolean z, final boolean z2, final boolean z3, final int i, final MessageObject messageObject, final int i2, long j2, final long j3, final MessageSuggestionParams messageSuggestionParams) {
        ...
        if (!DialogObject.isEncryptedDialog(j)) {
            ...
            if (sendPaidMessagesStars != j2) {
                AlertsCreator.ensurePaidMessageConfirmation(this.currentAccount, j, Math.max(1, arrayList.size()), new Utilities.Callback() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda97
            ...
            ArrayList<MessageObject> arrayList17 = arrayList13;
            ArrayList arrayList18 = arrayList14;
            ArrayList<Long> arrayList19 = arrayList15;
            ...
            while (i5 < arrayList.size()) {
                int i7 = i5;
                final MessageObject messageObject2 = arrayList.get(i5);
                if (messageObject2.getId() <= 0 || messageObject2.needDrawBluredPreview()) {
                    ...
                    if (messageObject2.type == 0 && !TextUtils.isEmpty(messageObject2.messageText)) {
                        ...
                        SendMessageParams of = SendMessageParams.of(messageObject2.messageText.toString(), j, null, messageObject, webPage, webPage != null, messageObject2.messageOwner.entities, null, null, z3, i, null, false);
                        of.suggestionParams = messageSuggestionParams;
                        of.monoForumPeer = j3;
                    ...
                    boolean z21 = messageObject2.isSticker() || messageObject2.isAnimatedSticker() || messageObject2.isGif() || messageObject2.isGame();
                    if (!z6 && z21) {
                        if (i6 == 0) {
                        ...
                        peer = peer4;
                        z12 = z9;
                    } else if (!z8 && (messageObject2.messageOwner.media instanceof TLRPC.TL_messageMediaPhoto) && !messageObject2.isVideo() && !z21) {
                        if (i6 == 0) {
                        ...
                        peer = peer4;
                        z12 = z9;
                    } else if (!z10 && (messageObject2.messageOwner.media instanceof TLRPC.TL_messageMediaPhoto) && messageObject2.isVideo() && !z21) {
                        if (i6 == 0) {
                        ...
                        if (canSendRoundVideo || !MessageObject.isRoundVideoMessage(messageObject2.messageOwner)) {
                            if (z11 || !(messageObject2.messageOwner.media instanceof TLRPC.TL_messageMediaDocument) || z21) {
                                    ...
                                    if (messageObject2.getDialogId() == clientUserId && messageObject2.isFromUser()) {
                                        ...
                                        if (messageObject2.messageOwner.from_id.user_id == clientUserId) {
                                            ...
                                            if (messageObject2.isForwarded()) {
                                                ...
                                                if (!z16) {
                                                    ...
                                                    if (messageObject2.isFromUser()) {
                                                        ...
                                                        TLRPC.Peer peer5 = messageFwdHeader3.from_id;
                                                        ...
                                                        if (message3.post && fromChatId > 0) {
                                                            ...
                                                            messageFwdHeader3.from_id = peer6;
                                                        }
                                                    }
                                                ...
                                                if ((j == clientUserId || z9) && (messageFwdHeader5.flags & 16) != 0 && !UserObject.isReplyUser(messageObject2.getDialogId())) {
                                                    TLRPC.MessageFwdHeader messageFwdHeader6 = tL_message.fwd_from;
                                                    messageFwdHeader6.flags |= 16;
                                                    TLRPC.MessageFwdHeader messageFwdHeader7 = messageObject2.messageOwner.fwd_from;
                                            ...
                                            if (j == clientUserId) {
                                                ...
                                                peer3 = messageObject2.messageOwner.peer_id;
                                                messageFwdHeader42.saved_from_peer = peer3;
                                                if (peer3.user_id == clientUserId) {
                                                }
                                            }
                                        }
                                ...
                                if (message5.reply_markup instanceof TLRPC.TL_replyInlineMarkup) {
                                    ...
                                    while (true) {
                                        ...
                                        TLRPC.TL_keyboardButtonRow tL_keyboardButtonRow2 = messageObject2.messageOwner.reply_markup.rows.get(i8);
                                    ...
                                    if (z22) {
                                        ...
                                        tL_message.out = true;
                                        j12 = messageObject2.messageOwner.grouped_id;
                                        if (j12 != 0) {
                                            Long l = (Long) longSparseArray5.get(j12);
                                            if (l == null) {
                                        ...
                                        ArrayList<Long> arrayList21 = arrayList7;
                                        ...
                                        ArrayList<Integer> arrayList22 = arrayList20;
                                        arrayList22.add(Integer.valueOf(tL_message.fwd_msg_id));
                                        if (i == 0) {
                                        ...
                                        if (!MessageObject.isVoiceMessage(tL_message) || MessageObject.isRoundVideoMessage(tL_message)) {
                                            if (!z13 && messageObject2.getChannelId() != 0) {
                                        ...
                                        ArrayList<MessageObject> arrayList23 = arrayList17;
                                        ...
                                        if (messageObject2.replyMessageObject == null) {
                                            ...
                                            while (true) {
                                                ...
                                                arrayList9 = arrayList21;
                                                arrayList10 = arrayList23;
                                                if (arrayList11.get(i11).getId() == messageObject2.replyMessageObject.getId()) {
                                        ...
                                        if (messageObject != null && messageSuggestionParams == null) {
                                            ...
                                            if (messageObject.isTopicMainMessage) {
                                                ...
                                                if (arrayList8.size() == 100 && i7 != arrayList.size() - 1 && (i7 == arrayList.size() - 1 || arrayList11.get(i7 + 1).getDialogId() == messageObject2.getDialogId())) {
                                                    ...
                                                    ArrayList<MessageObject> arrayList24 = arrayList10;
                                                    ...
                                                    if (z3) {
                                                        if (!MessagesController.getNotificationsSettings(this.currentAccount).getBoolean(NotificationsSettingsFacade.PROPERTY_SILENT + j13, false)) {
                                                            ...
                                                            tL_messages_forwardMessages.id = arrayList22;
                                                            tL_messages_forwardMessages.drop_author = z;
                                                            tL_messages_forwardMessages.drop_media_captions = z2;
                                                            if (arrayList.size() == 1 && arrayList11.get(0).messageOwner.with_my_score) {
                                                                z15 = true;
                                                                tL_messages_forwardMessages.with_my_score = z15;
                                                                if (i2 >= 0) {
                                                                ...
                                                                arrayList5 = arrayList8;
                                                                chat2 = chat6;
                                                                runnable = new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda98
                                                                    @Override // java.lang.Runnable
                                                                    public final void run() {
                                                                        SendMessagesHelper.this.lambda$sendMessage$17(tL_messages_forwardMessages, j, i, z25, z26, longSparseArray9, arrayList8, arrayList12, messageObject2, peer);
                                                                    }
                                                                };
                                                                if (StarsController.getInstance(sendMessagesHelper.currentAccount).beforeSendingFinalRequest(tL_messages_forwardMessages, arrayList12, runnable)) {
                                                                    runnable.run();
                                                                }
                                                            ...
                                                            arrayList3 = arrayList22;
                                                            arrayList4 = arrayList24;
                                                            final LongSparseArray longSparseArray92 = longSparseArray3;
                                                            inputPeer = inputPeer2;
                                                            arrayList2 = arrayList25;
                                                            j7 = j11;
                                                            str3 = str7;
                                                            ...
                                                            runnable = new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda98
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                                                    SendMessagesHelper.this.lambda$sendMessage$17(tL_messages_forwardMessages, j, i, z252, z262, longSparseArray92, arrayList8, arrayList12, messageObject2, peer);
                                                                }
                                                            };
                                                            if (StarsController.getInstance(sendMessagesHelper.currentAccount).beforeSendingFinalRequest(tL_messages_forwardMessages, arrayList12, runnable)) {
                                                            }
                                                    ...
                                                    if (arrayList.size() == 1) {
                                                        ...
                                                        arrayList3 = arrayList22;
                                                        arrayList4 = arrayList24;
                                                        final LongSparseArray longSparseArray922 = longSparseArray3;
                                                        inputPeer = inputPeer2;
                                                        ...
                                                        i3 = i7;
                                                        sendMessagesHelper = this;
                                                        longSparseArray2 = longSparseArray922;
                                                        arrayList5 = arrayList8;
                                                        chat2 = chat6;
                                                        runnable = new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda98
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                SendMessagesHelper.this.lambda$sendMessage$17(tL_messages_forwardMessages, j, i, z2522, z2622, longSparseArray922, arrayList8, arrayList12, messageObject2, peer);
                                                            }
                                                        };
                                                        if (StarsController.getInstance(sendMessagesHelper.currentAccount).beforeSendingFinalRequest(tL_messages_forwardMessages, arrayList12, runnable)) {
                                                        }
                                                    ...
                                                    arrayList3 = arrayList22;
                                                    arrayList4 = arrayList24;
                                                    final LongSparseArray longSparseArray9222 = longSparseArray3;
                                                    inputPeer = inputPeer2;
                                                    arrayList2 = arrayList252;
                                                    j7 = j11;
                                                    str3 = str7;
                                                    ...
                                                    i3 = i7;
                                                    sendMessagesHelper = this;
                                                    longSparseArray2 = longSparseArray9222;
                                                    arrayList5 = arrayList8;
                                                    chat2 = chat6;
                                                    runnable = new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda98
                                                        @Override // java.lang.Runnable
                                                        public final void run() {
                                                            SendMessagesHelper.this.lambda$sendMessage$17(tL_messages_forwardMessages, j, i, z25222, z26222, longSparseArray9222, arrayList8, arrayList12, messageObject2, peer);
                                                        }
                                                    };
                                                    if (StarsController.getInstance(sendMessagesHelper.currentAccount).beforeSendingFinalRequest(tL_messages_forwardMessages, arrayList12, runnable)) {
                                                    }
                                        ...
                                        getMessagesStorage().putMessages(new ArrayList<>(arrayList8), false, true, false, 0, i != 0 ? 1 : 0, 0L);
                                        ArrayList<MessageObject> arrayList242 = arrayList10;
                                        ...
                                        final LongSparseArray longSparseArray92222 = longSparseArray3;
                                        inputPeer = inputPeer2;
                                        ...
                                        i3 = i7;
                                        sendMessagesHelper = this;
                                        longSparseArray2 = longSparseArray92222;
                                        arrayList5 = arrayList8;
                                        chat2 = chat6;
                                        runnable = new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda98
                                            @Override // java.lang.Runnable
                                            public final void run() {
                                                SendMessagesHelper.this.lambda$sendMessage$17(tL_messages_forwardMessages, j, i, z252222, z262222, longSparseArray92222, arrayList8, arrayList12, messageObject2, peer);
                                            }
                                        };
                                        if (StarsController.getInstance(sendMessagesHelper.currentAccount).beforeSendingFinalRequest(tL_messages_forwardMessages, arrayList12, runnable)) {
                                        }
                                ...
                                ArrayList<Long> arrayList212 = arrayList7;
                                arrayList212.add(Long.valueOf(tL_message.random_id));
                                LongSparseArray longSparseArray82 = longSparseArray7;
                                longSparseArray82.put(tL_message.random_id, tL_message);
                                ArrayList<Integer> arrayList222 = arrayList20;
                                arrayList222.add(Integer.valueOf(tL_message.fwd_msg_id));
                                if (i == 0) {
                                }
                                tL_message.date = currentTime;
                                String str72 = str5;
                                ...
                                ArrayList<MessageObject> arrayList232 = arrayList17;
                                ...
                                getMessagesStorage().putMessages(new ArrayList<>(arrayList8), false, true, false, 0, i != 0 ? 1 : 0, 0L);
                                ArrayList<MessageObject> arrayList2422 = arrayList10;
                                getMessagesController().updateInterfaceWithMessages(j13, arrayList2422, i != 0 ? 1 : 0);
                                getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.dialogsNeedReload, new Object[0]);
                                getUserConfig().saveConfig(false);
                                tL_messages_forwardMessages = new TLRPC.TL_messages_forwardMessages();
                                ...
                                tL_messages_forwardMessages.id = arrayList222;
                                tL_messages_forwardMessages.drop_author = z;
                                tL_messages_forwardMessages.drop_media_captions = z2;
                                if (arrayList.size() == 1) {
                                }
                                ...
                                applyMonoForumPeerId(tL_messages_forwardMessages, j3);
                                arrayList12 = new ArrayList(arrayList2422);
                                peer = peer82;
                                arrayList3 = arrayList222;
                                arrayList4 = arrayList2422;
                                final LongSparseArray longSparseArray922222 = longSparseArray3;
                                inputPeer = inputPeer2;
                                ...
                                i3 = i7;
                                sendMessagesHelper = this;
                                longSparseArray2 = longSparseArray922222;
                                arrayList5 = arrayList8;
                                chat2 = chat62;
                                runnable = new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda98
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SendMessagesHelper.this.lambda$sendMessage$17(tL_messages_forwardMessages, j, i, z2522222, z2622222, longSparseArray922222, arrayList8, arrayList12, messageObject2, peer);
                                    }
                                };
                                if (StarsController.getInstance(sendMessagesHelper.currentAccount).beforeSendingFinalRequest(tL_messages_forwardMessages, arrayList12, runnable)) {
                                }
        ...
        boolean z27 = (!DialogObject.isUserDialog(j16) || getMessagesController().getUser(Long.valueOf(j16)) == null || (userFull = getMessagesController().getUserFull(j16)) == null) ? true : !userFull.voice_messages_forbidden;
        int i12 = 0;
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            MessageObject messageObject5 = arrayList.get(i13);
            if (z27 || !MessageObject.isVoiceMessage(messageObject5.messageOwner)) {
                if (!z27 && MessageObject.isRoundVideoMessage(messageObject5.messageOwner) && i12 == 0) {
                    i12 = 8;
                }
            } else if (i12 == 0) {
                i12 = 7;
        ...
        if (i12 == 0) {
            for (int i14 = 0; i14 < arrayList.size(); i14++) {
                processForwardFromMyName(arrayList.get(i14), j, j2, j3, messageSuggestionParams);
            }
        }
        return i12;
    }
    ...
    */
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:102:0x05b0 A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:109:0x05d6 A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:112:0x05ea A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:115:0x05fd A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:118:0x060c A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:129:0x0654 A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:132:0x0659 A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:134:0x0671  */
    /* JADX WARN: Removed duplicated region for block: B:179:0x05df A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:187:0x0351  */
    /* JADX WARN: Removed duplicated region for block: B:344:0x0164 A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:347:0x0174 A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:348:0x0184  */
    /* JADX WARN: Removed duplicated region for block: B:69:0x02a2 A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /* JADX WARN: Removed duplicated region for block: B:88:0x030f A[Catch: Exception -> 0x004d, TryCatch #0 {Exception -> 0x004d, blocks: (B:9:0x0026, B:11:0x0030, B:13:0x0042, B:19:0x0059, B:22:0x0063, B:25:0x0068, B:27:0x006c, B:28:0x0099, B:31:0x009f, B:33:0x00a5, B:34:0x00ac, B:35:0x01c8, B:37:0x01cc, B:38:0x01d0, B:43:0x01e8, B:48:0x01f1, B:50:0x01f5, B:52:0x0203, B:54:0x0207, B:55:0x021c, B:57:0x0220, B:59:0x0226, B:60:0x0210, B:62:0x0216, B:63:0x022c, B:65:0x0230, B:66:0x026c, B:67:0x026f, B:69:0x02a2, B:71:0x02aa, B:74:0x02af, B:75:0x02b6, B:76:0x02b9, B:78:0x02e7, B:80:0x02ef, B:88:0x030f, B:90:0x0313, B:92:0x0317, B:95:0x0331, B:97:0x0335, B:100:0x05ac, B:102:0x05b0, B:107:0x05b9, B:109:0x05d6, B:110:0x05e6, B:112:0x05ea, B:113:0x05f6, B:115:0x05fd, B:116:0x0608, B:118:0x060c, B:120:0x0622, B:122:0x064e, B:123:0x062a, B:125:0x063e, B:127:0x0644, B:129:0x0654, B:132:0x0659, B:139:0x0679, B:141:0x068e, B:148:0x069b, B:150:0x06b2, B:154:0x06ba, B:161:0x06d9, B:163:0x06ef, B:170:0x06fc, B:172:0x0712, B:176:0x071a, B:179:0x05df, B:181:0x05e3, B:184:0x031d, B:186:0x0321, B:189:0x0356, B:191:0x035f, B:193:0x0367, B:195:0x0378, B:197:0x038f, B:198:0x0398, B:201:0x03c8, B:203:0x03de, B:205:0x03e4, B:207:0x03ea, B:210:0x03ed, B:211:0x03a5, B:213:0x03bf, B:214:0x03c4, B:217:0x040e, B:219:0x0417, B:221:0x0421, B:223:0x0432, B:225:0x0443, B:227:0x0452, B:230:0x0462, B:233:0x046f, B:235:0x0475, B:237:0x047f, B:240:0x04b5, B:242:0x04cd, B:244:0x04da, B:245:0x04de, B:247:0x04e8, B:249:0x0500, B:251:0x04f7, B:253:0x04fb, B:254:0x048e, B:256:0x04ac, B:257:0x04b1, B:263:0x0513, B:266:0x0553, B:269:0x0569, B:272:0x0570, B:274:0x057d, B:276:0x0582, B:277:0x052f, B:279:0x054a, B:280:0x054f, B:283:0x0591, B:285:0x059b, B:294:0x023b, B:296:0x024f, B:298:0x0255, B:299:0x025e, B:301:0x0266, B:304:0x01dd, B:306:0x01e5, B:308:0x0074, B:310:0x0078, B:315:0x0088, B:317:0x008b, B:322:0x00bb, B:324:0x00cd, B:325:0x00d2, B:327:0x00fd, B:329:0x0110, B:331:0x0116, B:333:0x011c, B:335:0x01b6, B:336:0x011f, B:338:0x0145, B:344:0x0164, B:345:0x016e, B:347:0x0174, B:349:0x0186, B:351:0x01aa), top: B:8:0x0026 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
        ...
        try {
            ...
            if (c2 >= 1) {
                ...
                if (charSequence != null) {
                    ...
                    tL_messages_editMessage.flags = i5 | 2048;
                    ...
                    if (arrayList7 != null) {
                        ...
                        tL_messages_editMessage.flags = i5 | 2056;
                    } else {
                ...
                if (c3 == 2) {
                    if (!z4 && !z6) {
                        lambda$performSendMessageRequest$61(tL_messages_editMessage, messageObject, str5, null, true, delayedMessage, obj2, hashMap3, messageObject.scheduled);
                        return;
                    }
                    performSendDelayedMessage(delayedMessage);
                    return;
    ...
    public int editMessage(MessageObject messageObject, String str, boolean z, final BaseFragment baseFragment, ArrayList<TLRPC.MessageEntity> arrayList, int i) {
        ...
        return getConnectionsManager().sendRequest(tL_messages_editMessage, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda89
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$sendNotificationCallback$22(long j, int i, byte[] bArr) {
        ...
        getConnectionsManager().sendRequest(tL_messages_getBotCallbackAnswer, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda100
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public int sendVote(final MessageObject messageObject, ArrayList<TLRPC.PollAnswer> arrayList, final Runnable runnable) {
        ...
        return getConnectionsManager().sendRequest(tL_messages_sendVote, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda12
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public int toggleTodo(final MessageObject messageObject, final TLRPC.TodoItem todoItem, final boolean z, final Runnable runnable) {
        ...
        return getConnectionsManager().sendRequest(tL_messages_toggleTodoCompleted, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda33
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public void sendReaction(MessageObject messageObject, ArrayList<ReactionsLayoutInBubble.VisibleReaction> arrayList, ReactionsLayoutInBubble.VisibleReaction visibleReaction, boolean z, boolean z2, BaseFragment baseFragment, final Runnable runnable) {
        ...
        getConnectionsManager().sendRequest(tL_messages_sendReaction, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda101
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    */
    public void lambda$sendCallback$32(final boolean z, final MessageObject messageObject, final TLRPC.KeyboardButton keyboardButton, final TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, final TwoStepVerificationActivity twoStepVerificationActivity, final ChatActivity chatActivity) {
        ...
        if (z3) {
            ...
            if (!(keyboardButton instanceof TLRPC.TL_keyboardButtonGame)) {
                ...
                final boolean z4 = z2;
                RequestDelegate requestDelegate = new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda108
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        RequestDelegate requestDelegate2 = new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda108
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$sendCallback$37(final String str, final List list, boolean z, TLObject tLObject, final MessageObject messageObject, final TLRPC.KeyboardButton keyboardButton, final ChatActivity chatActivity, final TwoStepVerificationActivity twoStepVerificationActivity, TLObject[] tLObjectArr, TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, final boolean z2) {
        ...
        if (tLObject != null) {
            ...
            if (keyboardButton instanceof TLRPC.TL_keyboardButtonBuy) {
                if (tLObject instanceof TLRPC.TL_payments_paymentFormStars) {
                    StarsController.getInstance(this.currentAccount).openPaymentForm(messageObject, ((TLRPC.TL_payments_getPaymentForm) tLObjectArr[0]).invoice, (TLRPC.TL_payments_paymentFormStars) tLObject, new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda6
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.this.lambda$sendCallback$30(str, list);
                        }
                    }, new Utilities.Callback() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda7
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            if (inputCheckPasswordSRP == null) {
                ...
                builder2.setPositiveButton(LocaleController.getString(R.string.BotOwnershipTransferChangeOwner), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda8
        ...
        if ("PASSWORD_MISSING".equals(tL_error.text) || tL_error.text.startsWith("PASSWORD_TOO_FRESH_") || tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
            ...
            if ("PASSWORD_MISSING".equals(tL_error.text)) {
                builder3.setPositiveButton(LocaleController.getString(R.string.EditAdminTransferSetPassword), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda10
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
        ...
        if ("SRP_ID_INVALID".equals(tL_error.text)) {
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account.getPassword(), new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda9
                @Override // org.telegram.tgnet.RequestDelegate
    ...
    public /* synthetic */ void lambda$sendCallback$33(final boolean z, final MessageObject messageObject, final TLRPC.KeyboardButton keyboardButton, final ChatActivity chatActivity, AlertDialog alertDialog, int i) {
        ...
        twoStepVerificationActivity.setDelegate(0, new TwoStepVerificationActivity.TwoStepVerificationActivityDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda99
    ...
    public void sendMessage(org.telegram.messenger.SendMessagesHelper.SendMessageParams r109) {
        /*
            Method dump skipped, instructions count: 10166
    ...
    */
                ...
                if (inputPhoto == null && delayedMessage.coverFile != null && delayedMessage.performCoverUpload) {
                    ...
                    getConnectionsManager().sendRequest(tL_messages_uploadMedia, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda76
                        ...
                        public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                            SendMessagesHelper.this.lambda$performSendDelayedMessage$42(inputMedia4, delayedMessage, tLObject3, tL_error);
                        }
                    });
                    return;
                }
            ...
            if (i2 == 5) {
                ...
                getConnectionsManager().sendRequest(tL_messages_getStickerSet, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda78
                    ...
                    public final void run(TLObject tLObject4, TLRPC.TL_error tL_error) {
                        SendMessagesHelper.this.lambda$performSendDelayedMessage$46(delayedMessage, str15, tLObject4, tL_error);
                    }
                });
                                    ...
                                    if (photoSize == null && delayedMessage.coverFile != null && inputMedia8 != null && inputMedia8.video_cover == null) {
                                        ...
                                        getConnectionsManager().sendRequest(tL_messages_uploadMedia2, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda77
                                            ...
                                            public final void run(TLObject tLObject5, TLRPC.TL_error tL_error) {
                                                SendMessagesHelper.this.lambda$performSendDelayedMessage$44(inputMedia8, delayedMessage, str18, messageObject7, tLObject5, tL_error);
                                            }
                                        });
    ...
    public /* synthetic */ void lambda$performSendDelayedMessage$42(final TLRPC.InputMedia inputMedia, final DelayedMessage delayedMessage, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda102
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    ...
    private void sendReadyToSendGroup(DelayedMessage delayedMessage, boolean z, boolean z2) {
        ...
        TLObject tLObject2 = delayedMessage.sendRequest;
        if (tLObject2 instanceof TLRPC.TL_messages_sendMultiMedia) {
            lambda$performSendMessageRequestMulti$50((TLRPC.TL_messages_sendMultiMedia) tLObject2, delayedMessage.messageObjects, delayedMessage.originalPaths, delayedMessage.parentObjects, delayedMessage, delayedMessage.scheduled);
        } else if (tLObject2 instanceof TLRPC.TL_messages_sendMedia) {
            lambda$performSendMessageRequestMulti$50((TLRPC.TL_messages_sendMedia) tLObject2, delayedMessage.messageObjects, delayedMessage.originalPaths, delayedMessage.parentObjects, delayedMessage, delayedMessage.scheduled);
        } else {
    ...
    */
    ...
    public /* synthetic */ void lambda$performSendMessageRequestMulti$58(TLRPC.TL_error tL_error, TLObject tLObject, final boolean z, ArrayList arrayList, ArrayList arrayList2, TLObject tLObject2) {
        ...
        if (tL_error == null) {
            ...
            while (i5 < arrayList6.size()) {
                ...
                if (update instanceof TLRPC.TL_updateMessageID) {
                    ...
                    if (update instanceof TLRPC.TL_updateNewMessage) {
                        ...
                        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda92
                            @Override // java.lang.Runnable
                            public final void run() {
                        ...
                        if (tL_updateNewChannelMessage.message.pinned) {
                            Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda93
                                @Override // java.lang.Runnable
                                public final void run() {
            ...
            while (i7 < arrayList.size()) {
                ...
                getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda94
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void performSendMessageRequest(TLObject tLObject, MessageObject messageObject, String str, DelayedMessage delayedMessage, Object obj, HashMap<String, String> hashMap, boolean z) {
        lambda$performSendMessageRequest$61(tLObject, messageObject, str, null, false, delayedMessage, obj, hashMap, z);
    }
    ...
    public void lambda$performSendMessageRequest$61(final TLObject tLObject, final MessageObject messageObject, final String str, final DelayedMessage delayedMessage, final boolean z, final DelayedMessage delayedMessage2, final Object obj, final HashMap<String, String> hashMap, final boolean z2) {
        DelayedMessage findMaxDelayedMessageForMessageId;
        ...
        if (StarsController.getInstance(this.currentAccount).beforeSendingFinalRequest(tLObject, messageObject, new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda84
            @Override // java.lang.Runnable
            public final void run() {
        ...
        }) && BotForumHelper.getInstance(this.currentAccount).beforeSendingFinalRequest(tLObject, messageObject, new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda85
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$performSendMessageRequest$61(tLObject, messageObject, str, delayedMessage, z, delayedMessage2, obj, hashMap, z2);
            }
        })) {
            message.reqId = getConnectionsManager().sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda86
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    SendMessagesHelper.this.lambda$performSendMessageRequest$76(tLObject, messageObject, str, delayedMessage, z, delayedMessage2, obj, hashMap, z2, message, tLObject2, tL_error);
                }
            }, new QuickAckDelegate() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda87
                @Override // org.telegram.tgnet.QuickAckDelegate
                public final void run() {
                    SendMessagesHelper.this.lambda$performSendMessageRequest$78(message);
                }
    ...
    public /* synthetic */ void lambda$performSendMessageRequest$76(final TLObject tLObject, final MessageObject messageObject, final String str, DelayedMessage delayedMessage, boolean z, final DelayedMessage delayedMessage2, Object obj, HashMap hashMap, final boolean z2, final TLRPC.Message message, final TLObject tLObject2, final TLRPC.TL_error tL_error) {
        if (tL_error != null && (((tLObject instanceof TLRPC.TL_messages_sendMedia) || (tLObject instanceof TLRPC.TL_messages_editMessage)) && FileRefController.isFileRefError(tL_error.text))) {
            if (FileRefController.isFileRefErrorCover(tL_error.text)) {
                if (removeCoverFromRequest(tLObject)) {
                    lambda$performSendMessageRequest$61(tLObject, messageObject, str, delayedMessage, z, delayedMessage2, obj, hashMap, z2);
                    return;
                }
            } else if (obj != null) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda36
                    @Override // java.lang.Runnable
                    public final void run() {
                        SendMessagesHelper.this.lambda$performSendMessageRequest$62(message, z2, tLObject, delayedMessage2);
                    }
                });
                return;
            }
        ...
        if (tLObject instanceof TLRPC.TL_messages_editMessage) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda37
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.this.lambda$performSendMessageRequest$65(tL_error, message, tLObject2, messageObject, str, z2, tLObject);
                }
            });
        } else {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda38
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.this.lambda$performSendMessageRequest$75(z2, tL_error, message, tLObject2, messageObject, str, tLObject);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$62(TLRPC.Message message, boolean z, TLObject tLObject, DelayedMessage delayedMessage) {
        removeFromSendingMessages(message.id, z);
        if (tLObject instanceof TLRPC.TL_messages_sendMedia) {
            TLRPC.TL_messages_sendMedia tL_messages_sendMedia = (TLRPC.TL_messages_sendMedia) tLObject;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$65(TLRPC.TL_error tL_error, final TLRPC.Message message, TLObject tLObject, MessageObject messageObject, String str, final boolean z, TLObject tLObject2) {
        int i = 0;
        ...
        if (tL_error == null) {
            ...
            Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda103
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.this.lambda$performSendMessageRequest$64(updates, message, z);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$64(TLRPC.Updates updates, final TLRPC.Message message, final boolean z) {
        getMessagesController().processUpdates(updates, false);
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda106
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$performSendMessageRequest$63(message, z);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$63(TLRPC.Message message, boolean z) {
        processSentMessage(message.id);
        removeFromSendingMessages(message.id, z);
    }
    ...
    public /* synthetic */ void lambda$performSendMessageRequest$75(final boolean z, TLRPC.TL_error tL_error, final TLRPC.Message message, TLObject tLObject, MessageObject messageObject, String str, TLObject tLObject2) {
        TLRPC.TL_error tL_error2;
        boolean z2;
        ?? r10;
        String str2;
        ...
        if (tL_error == null) {
            ...
            if (tLObject instanceof TLRPC.TL_updateShortSentMessage) {
                ...
                Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda69
                    @Override // java.lang.Runnable
                    public final void run() {
                        SendMessagesHelper.this.lambda$performSendMessageRequest$66(tL_updateShortSentMessage);
                    }
                });
                ...
                if (tLObject instanceof TLRPC.Updates) {
                        ...
                        if (update instanceof TLRPC.TL_updateNewMessage) {
                            ...
                            if (message3.action == null) {
                                ...
                                Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda70
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SendMessagesHelper.this.lambda$performSendMessageRequest$67(tL_updateNewMessage);
                                    }
                                });
                            ...
                            if (update instanceof TLRPC.TL_updateNewChannelMessage) {
                                ...
                                Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda71
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SendMessagesHelper.this.lambda$performSendMessageRequest$68(tL_updateNewChannelMessage);
                                    }
                                });
                                arrayList2.remove(i7);
                                i7--;
                                if (tL_updateNewChannelMessage.message.pinned) {
                                    Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda72
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            SendMessagesHelper.this.lambda$performSendMessageRequest$69(tL_updateNewChannelMessage, updateChannelId);
                                        }
                                    });
                                }
                                i4 = 1;
                    ...
                    Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda73
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.this.lambda$performSendMessageRequest$70(updates);
                        }
                    });
                    i2 = i3;
                    z4 = z6;
            ...
            if (z4) {
                ...
                if (z15 != z3) {
                    ...
                    getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda74
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.this.lambda$performSendMessageRequest$72(arrayList, z, z3, message, arrayList3, arrayList4, i13);
                        }
                    });
                    z8 = z15;
                } else {
                    ...
                    getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda75
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.this.lambda$performSendMessageRequest$74(z, message, i14, arrayList, i15);
                        }
                    });
                    z10 = z15;
                    tL_error2 = tL_error;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$66(TLRPC.TL_updateShortSentMessage tL_updateShortSentMessage) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$67(TLRPC.TL_updateNewMessage tL_updateNewMessage) {
        getMessagesController().processNewDifferenceParams(-1, tL_updateNewMessage.pts, -1, tL_updateNewMessage.pts_count);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$68(TLRPC.TL_updateNewChannelMessage tL_updateNewChannelMessage) {
        getMessagesController().processNewChannelDifferenceParams(tL_updateNewChannelMessage.pts, tL_updateNewChannelMessage.pts_count, tL_updateNewChannelMessage.message.peer_id.channel_id);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$69(TLRPC.TL_updateNewChannelMessage tL_updateNewChannelMessage, long j) {
        ArrayList<Integer> arrayList = new ArrayList<>();
        arrayList.add(Integer.valueOf(tL_updateNewChannelMessage.message.id));
        getMessagesStorage().updatePinnedMessages(-j, arrayList, true, -1, 0, false, null);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$70(TLRPC.Updates updates) {
        getMessagesController().processUpdates(updates, false);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$72(ArrayList arrayList, final boolean z, final boolean z2, final TLRPC.Message message, final ArrayList arrayList2, final ArrayList arrayList3, final int i) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda25
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$performSendMessageRequest$71(z2, message, arrayList2, z, arrayList3, i);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$71(boolean z, TLRPC.Message message, ArrayList arrayList, boolean z2, ArrayList arrayList2, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$74(final boolean z, final TLRPC.Message message, final int i, ArrayList arrayList, final int i2) {
        int i3 = (message.quick_reply_shortcut_id == 0 && message.quick_reply_shortcut == null) ? z ? 1 : 0 : 5;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda90
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$performSendMessageRequest$73(message, i, i2, z);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$73(TLRPC.Message message, int i, int i2, boolean z) {
        getMediaDataController().increasePeerRaiting(message.dialog_id);
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.messageReceivedByServer, Integer.valueOf(i), Integer.valueOf(message.id), message, Long.valueOf(message.dialog_id), 0L, Integer.valueOf(i2), Boolean.valueOf(z));
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.messageReceivedByServer2, Integer.valueOf(i), Integer.valueOf(message.id), message, Long.valueOf(message.dialog_id), 0L, Integer.valueOf(i2), Boolean.valueOf(z));
        processSentMessage(i);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$78(final TLRPC.Message message) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda26
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$performSendMessageRequest$77(message, i);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSendMessageRequest$77(TLRPC.Message message, int i) {
        message.send_state = 0;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:286:0x06fd, code lost:
    ...
    /* JADX WARN: Removed duplicated region for block: B:218:0x09fe  */
    /* JADX WARN: Removed duplicated region for block: B:241:0x0a44  */
    /* JADX WARN: Removed duplicated region for block: B:243:0x0a47  */
    /* JADX WARN: Removed duplicated region for block: B:245:0x09a7  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private void updateMediaPaths(MessageObject messageObject, TLRPC.Message message, int i, List<String> list, boolean z, int i2) {
                        ...
                        while (i6 < messageMedia.photo.sizes.size()) {
                            ...
                            if (photoSize9 == null || photoSize9.location == null || (photoSize9 instanceof TLRPC.TL_photoSizeEmpty) || (str12 = photoSize9.type) == null || !((photoSize8.location.volume_id == -2147483648L && str12.equals(photoSize8.type)) || (photoSize9.w == photoSize8.w && photoSize9.h == photoSize8.h))) {
                                ...
                                if (!str14.equals(str15)) {
                                    ...
                                    if (messageMedia.ttl_seconds == 0 && ((messageMedia.photo.sizes.size() == 1 || photoSize9.w > 90 || photoSize9.h > 90) && !z2)) {
                                        file2 = FileLoader.getInstance(sendMessagesHelper3.currentAccount).getPathToAttach(photoSize9);
                                    } else {
        ...
        if ((messageMedia instanceof TLRPC.TL_messageMediaDocument) && messageMedia.document != null && (messageMedia2 instanceof TLRPC.TL_messageMediaDocument) && messageMedia2.document != null) {
            ...
            if (photo11 != null && (photo = messageMedia.video_cover) != null) {
                ...
                if (photo11.sizes.size() == 1 && (photo11.sizes.get(0).location instanceof TLRPC.TL_fileLocationUnavailable)) {
                    ...
                    while (i7 < photo11.sizes.size()) {
                        ...
                        if (photoSize10 == null || photoSize10.location == null || photoSize10.type == null) {
                                ...
                                if (photoSize11 == null || photoSize11.location == null || (photoSize11 instanceof TLRPC.TL_photoSizeEmpty) || (str9 = photoSize11.type) == null) {
                                    ...
                                    if ((photoSize10.location.volume_id == -2147483648L && str9.equals(photoSize10.type)) || (photoSize11.w == photoSize10.w && photoSize11.h == photoSize10.h)) {
                                        ...
                                        if (str17.equals(str18)) {
                                            ...
                                            String str19 = str;
                                            sb8.append(str19);
                                            File file4 = new File(directory, sb8.toString());
                                            ...
                                            z3 = z2;
                                            file = new File(FileLoader.getDirectory(4), str18 + str19);
                                            file4.renameTo(file);
                                            ImageLoader.getInstance().replaceImageInCache(str17, str18, ImageLocation.getForPhoto(photoSize11, photo), z);
                                            photoSize10.location = photoSize11.location;
                                            photoSize10.size = photoSize11.size;
                            ...
                            new File(FileLoader.getDirectory(4), str21 + str20).delete();
                            str7 = str2;
                            if (!str7.equals(photoSize10.type) || closestPhotoSizeWithSize == null) {
                                str5 = str20;
                                message5 = message;
                            } else {
                                ...
                                str5 = str20;
                                message5 = message;
                                ImageLoader.getInstance().replaceImageInCache(str21, forPhoto2.getKey(message5, null, false), forPhoto2, z);
                            }
                        }
                        i7++;
                        sendMessagesHelper = this;
                ...
                TLRPC.MessageMedia messageMedia16 = messageMedia2;
                str3 = str13;
                bArr = null;
                photo11.id = photo.id;
                photo11.dc_id = photo.dc_id;
                photo11.access_hash = photo.access_hash;
                messageMedia3 = messageMedia16;
            } else {
                String str22 = str;
                str3 = str13;
                bArr = null;
                messageMedia3 = messageMedia2;
                TLRPC.PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(messageMedia3.document.thumbs, NotificationCenter.onReceivedChannelDifference);
                TLRPC.PhotoSize closestPhotoSizeWithSize3 = FileLoader.getClosestPhotoSizeWithSize(messageMedia.document.thumbs, NotificationCenter.onReceivedChannelDifference);
                if (closestPhotoSizeWithSize2 != null && (fileLocation2 = closestPhotoSizeWithSize2.location) != null && fileLocation2.volume_id == -2147483648L && closestPhotoSizeWithSize3 != null && closestPhotoSizeWithSize3.location != null && !(closestPhotoSizeWithSize3 instanceof TLRPC.TL_photoSizeEmpty) && !(closestPhotoSizeWithSize2 instanceof TLRPC.TL_photoSizeEmpty)) {
                    ...
                    if (!str23.equals(str24)) {
                        new File(FileLoader.getDirectory(4), str23 + str22).renameTo(new File(FileLoader.getDirectory(4), str24 + str22));
                        ImageLoader.getInstance().replaceImageInCache(str23, str24, ImageLocation.getForDocument(closestPhotoSizeWithSize3, messageMedia.document), z);
            ...
            TLRPC.MessageMedia messageMedia17 = message5.media;
            if ((messageMedia17 instanceof TLRPC.TL_messageMediaContact) && (message6.media instanceof TLRPC.TL_messageMediaContact)) {
                message6.media = messageMedia17;
                return;
            }
            if (messageMedia17 instanceof TLRPC.TL_messageMediaWebPage) {
                message6.media = messageMedia17;
                return;
            }
    ...
    protected void processUnsentMessages(final ArrayList<TLRPC.Message> arrayList, final ArrayList<TLRPC.Message> arrayList2, final ArrayList<TLRPC.User> arrayList3, final ArrayList<TLRPC.Chat> arrayList4, final ArrayList<TLRPC.EncryptedChat> arrayList5) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda83
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$processUnsentMessages$79(arrayList3, arrayList4, arrayList5, arrayList, arrayList2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$processUnsentMessages$79(ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, ArrayList arrayList5) {
    ...
    public void prepareImportHistory(final long j, final Uri uri, final ArrayList<Uri> arrayList, final MessagesStorage.LongCallback longCallback) {
            ...
            if (chat != null && !chat.megagroup) {
                getMessagesController().convertToMegaGroup(null, j2, null, new MessagesStorage.LongCallback() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda41
                    ...
                    public final void run(long j3) {
                        SendMessagesHelper.this.lambda$prepareImportHistory$80(uri, arrayList, longCallback, j3);
                    }
                });
                return;
            }
        ...
        new Thread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda42
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$prepareImportHistory$85(arrayList, j, uri, longCallback);
            }
        }).start();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$prepareImportHistory$80(Uri uri, ArrayList arrayList, MessagesStorage.LongCallback longCallback, long j) {
        if (j != 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$prepareImportHistory$85(ArrayList arrayList, final long j, Uri uri, final MessagesStorage.LongCallback longCallback) {
        int i;
                            ...
                            if (i != 0) {
                                ...
                                if (length > 33554432) {
                                    ...
                                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda61
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            SendMessagesHelper.lambda$prepareImportHistory$83(MessagesStorage.LongCallback.this);
                                        }
                                    });
                                    return;
                                }
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda64
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$prepareImportHistory$84(hashMap, j, importingHistory, longCallback);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$prepareImportHistory$83(MessagesStorage.LongCallback longCallback) {
        Toast.makeText(ApplicationLoader.applicationContext, LocaleController.getString(R.string.ImportFileTooLarge), 0).show();
        longCallback.run(0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$prepareImportHistory$84(HashMap hashMap, long j, ImportingHistory importingHistory, MessagesStorage.LongCallback longCallback) {
    ...
    public void prepareImportStickers(final String str, final String str2, final String str3, final ArrayList<ImportingSticker> arrayList, final MessagesStorage.StringCallback stringCallback) {
        if (this.importingStickersMap.get(str2) != null) {
            ...
            new Thread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda16
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.this.lambda$prepareImportStickers$88(str, str2, str3, arrayList, stringCallback);
                }
            }).start();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$prepareImportStickers$88(String str, final String str2, String str3, ArrayList arrayList, final MessagesStorage.StringCallback stringCallback) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda81
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.this.lambda$prepareImportStickers$87(importingStickers, hashMap, str2, stringCallback);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$prepareImportStickers$87(ImportingStickers importingStickers, HashMap hashMap, String str, MessagesStorage.StringCallback stringCallback) {
    ...
    */
        ...
        if (uri == null || str != null) {
            ...
            if (z11) {
                ...
                if (!file.exists() && file.length() != 0) {
                    ...
                    if (str6 == null) {
                        ...
                        if (lastIndexOf == -1) {
                                                    ...
                                                    try {
                                                        ...
                                                        try {
                                                            ...
                                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                                                    SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document4, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                                }
                                                            });
                                                            return 0;
                                                        } catch (Throwable th2) {
                                                    ...
                                                    try {
                                                        ...
                                                        try {
                                                            ...
                                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                                                    SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document42, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                                }
                                                            });
                                                            return 0;
                                                        }
                                                        ...
                                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document422, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                            }
                                                        });
                                                        return 0;
                                                    }
                                                ...
                                                try {
                                                    ...
                                                    if (embeddedPicture != null) {
                                                        ...
                                                        try {
                                                            ...
                                                            if (mediaMetadataRetriever2 != null) {
                                                                try {
                                                                    ...
                                                                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                                        @Override // java.lang.Runnable
                                                                        public final void run() {
                                                                            SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document4222, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                                        }
                                                                    });
                                                                    return 0;
                                                                }
                                                            ...
                                                            Integer valueOf2222 = Integer.valueOf(i4);
                                                            if (numArr != null) {
                                                            }
                                                            z9 = false;
                                                            if (z8) {
                                                            ...
                                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                                                    SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document42222, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                                }
                                                            });
                                                            return 0;
                                                        }
                                            ...
                                            try {
                                                if (messageObject3 == null) {
                                                    ...
                                                    try {
                                                        ...
                                                        Integer valueOf22222 = Integer.valueOf(i4);
                                                        if (numArr != null) {
                                                        }
                                                        z9 = false;
                                                        if (z8) {
                                                        ...
                                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document422222, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                            }
                                                        });
                                                        return 0;
                                                    }
                                                ...
                                                Integer valueOf222222 = Integer.valueOf(i4);
                                                if (numArr != null) {
                                                }
                                                z9 = false;
                                                if (z8) {
                                                ...
                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                    @Override // java.lang.Runnable
                                                    public final void run() {
                                                        SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document4222222, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                    }
                                                });
                                                return 0;
                                            }
                            ...
                            if (i3 != 0) {
                                ...
                                obj = "m4a";
                                obj2 = "mp3";
                                tL_documentAttributeAudio4.duration = i3;
                                tL_documentAttributeAudio4.title = str11;
                                tL_documentAttributeAudio4.performer = str10;
                                if (str11 == null) {
                                    tL_documentAttributeAudio4.title = "";
                                }
                                int i11 = tL_documentAttributeAudio4.flags;
                                tL_documentAttributeAudio4.flags = i11 | 1;
                                if (str10 == null) {
                                    tL_documentAttributeAudio4.performer = "";
                                }
                                tL_documentAttributeAudio4.flags = i11 | 3;
                                if (z5) {
                            ...
                            if (str2 == null) {
                                ...
                                if (str2.endsWith("attheme")) {
                                        ...
                                        if (!z3 && tL_document5.mime_type.equals("image/gif") && (messageObject3 == null || messageObject3.getGroupIdForUse() == j6)) {
                                            ...
                                            if (loadBitmap != null) {
                                                ...
                                                try {
                                                    ...
                                                    Integer valueOf2222222 = Integer.valueOf(i4);
                                                    if (numArr != null) {
                                                    }
                                                    z9 = false;
                                                    if (z8) {
                                                    ...
                                                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                        @Override // java.lang.Runnable
                                                        public final void run() {
                                                            SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document42222222, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                        }
                                                    });
                                                    return 0;
                                                }
                                                ...
                                                if (tL_document5.mime_type.equals("image/webp") || messageObject3 != null) {
                                                    ...
                                                    try {
                                                        ...
                                                        if (i7 != 0) {
                                                            ...
                                                            Integer valueOf22222222 = Integer.valueOf(i4);
                                                            if (numArr != null) {
                                                            }
                                                            z9 = false;
                                                            if (z8) {
                                                            ...
                                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                                                    SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document422222222, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                                }
                                                            });
                                                            return 0;
                                                        }
                                                        ...
                                                        Integer valueOf222222222 = Integer.valueOf(i4);
                                                        if (numArr != null) {
                                                        }
                                                        z9 = false;
                                                        if (z8) {
                                                        ...
                                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document4222222222, str17, hashMap, str16, j, messageObject, messageObject2, r14, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                            }
                                                        });
                                                        return 0;
                                                    }
                                                    i7 = options.outWidth;
                                                    if (i7 != 0 && (i8 = options.outHeight) != 0 && i7 <= 800 && i8 <= 800) {
                                    ...
                                    Integer valueOf2222222222 = Integer.valueOf(i4);
                                    if (numArr != null) {
                                        valueOf2222222222 = numArr[i4];
                                        String str28 = tL_document2.mime_type;
                                        if (str28 != null && str28.toLowerCase().startsWith("image/webp")) {
                                            numArr[i4] = Integer.valueOf(i6);
                                            z9 = true;
                                            if (z8 && jArr != null) {
                                                if (numArr != null && valueOf2222222222 != null && valueOf2222222222 != numArr[i4]) {
                                                    finishGroup(accountInstance, jArr[i4], i);
                                                    jArr[i4] = Utilities.random.nextLong();
                                                }
                                                if (!z9) {
                                                    hashMap.put("groupId", str18 + jArr[i4]);
                                                    if (z) {
                                                        hashMap.put("final", "1");
                                                    }
                                                }
                                            ...
                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                                @Override // java.lang.Runnable
                                                public final void run() {
                                                    SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document42222222222, str17, hashMap, str16, j, messageObject, messageObject2, charSequence2, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                                }
                                            });
                                            return 0;
                                        }
                                    ...
                                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document422222222222, str17, hashMap, str16, j, messageObject, messageObject2, charSequence2, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                        }
                                    });
                                    return 0;
                                }
                            ...
                            Integer valueOf22222222222 = Integer.valueOf(i4);
                            if (numArr != null) {
                            }
                            z9 = false;
                            if (z8) {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                                @Override // java.lang.Runnable
                                public final void run() {
                                    SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document4222222222222, str17, hashMap, str16, j, messageObject, messageObject2, charSequence2, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                                }
                            });
                            return 0;
                        }
                    ...
                    Integer valueOf222222222222 = Integer.valueOf(i4);
                    if (numArr != null) {
                    }
                    z9 = false;
                    if (z8) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda107
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.lambda$prepareSendingDocumentInternal$89(MessageObject.this, accountInstance, tL_document42222222222222, str17, hashMap, str16, j, messageObject, messageObject2, charSequence2, arrayList, z2, i, storyItem, replyQuote, str4, i2, j2, z4, j3, j4, messageSuggestionParams);
                        }
                    });
                    return 0;
                }
    ...
    public static void prepareSendingAudioDocuments(final AccountInstance accountInstance, final ArrayList<MessageObject> arrayList, final CharSequence charSequence, final long j, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final boolean z, final int i, final MessageObject messageObject3, final String str, final int i2, final long j2, final boolean z2, final long j3) {
        new Thread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.lambda$prepareSendingAudioDocuments$91(arrayList, j, accountInstance, charSequence, messageObject3, messageObject, messageObject2, z, i, storyItem, str, i2, j2, z2, j3);
            }
        }).start();
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static /* synthetic */ void lambda$prepareSendingAudioDocuments$91(ArrayList arrayList, final long j, final AccountInstance accountInstance, CharSequence charSequence, final MessageObject messageObject, final MessageObject messageObject2, final MessageObject messageObject3, final boolean z, final int i, final TL_stories.StoryItem storyItem, final String str, final int i2, final long j2, final boolean z2, final long j3) {
        ...
        while (i3 < size) {
            ...
            if (!isEncryptedDialog) {
                ...
                if (sentFile != null) {
                    ...
                    if (obj instanceof TLRPC.TL_document) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda104
                            @Override // java.lang.Runnable
                            public final void run() {
                                SendMessagesHelper.lambda$prepareSendingAudioDocuments$90(MessageObject.this, accountInstance, tL_document, messageObject4, hashMap, str5, j, messageObject2, messageObject3, charSequence2, entities, z, i, storyItem, str, i2, j2, z2, j3);
                            }
                        });
                        i3++;
                    }
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda104
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.lambda$prepareSendingAudioDocuments$90(MessageObject.this, accountInstance, tL_document, messageObject4, hashMap, str52, j, messageObject2, messageObject3, charSequence22, entities, z, i, storyItem, str, i2, j2, z2, j3);
                }
            });
            i3++;
        }
    ...
    private static void finishGroup(final AccountInstance accountInstance, final long j, final int i) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda45
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.lambda$finishGroup$92(AccountInstance.this, j, i);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$finishGroup$92(AccountInstance accountInstance, long j, int i) {
    ...
    public static void prepareSendingDocuments(final AccountInstance accountInstance, final ArrayList<String> arrayList, final ArrayList<String> arrayList2, final ArrayList<Uri> arrayList3, final String str, final ArrayList<TLRPC.MessageEntity> arrayList4, final String str2, final long j, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final MessageObject messageObject3, final boolean z, final int i, final InputContentInfoCompat inputContentInfoCompat, final String str3, final int i2, final long j2, final boolean z2, final long j3, final long j4, final MessageSuggestionParams messageSuggestionParams) {
        ...
        if (arrayList == null || arrayList2 == null || arrayList.size() == arrayList2.size()) {
            Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda56
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.lambda$prepareSendingDocuments$93(j, arrayList, str, accountInstance, i, arrayList2, str2, messageObject, messageObject2, storyItem, replyQuote, arrayList4, messageObject3, z, inputContentInfoCompat, str3, i2, j2, z2, j3, j4, messageSuggestionParams, arrayList3);
                }
            });
        }
    }
    ...
    private static void handleError(final int i, final AccountInstance accountInstance) {
        if (i != 0) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda40
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.lambda$handleError$94(i, accountInstance);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$handleError$94(int i, AccountInstance accountInstance) {
        try {
            if (i == 1) {
    ...
    public static void prepareSendingBotContextResult(final BaseFragment baseFragment, final AccountInstance accountInstance, final TLRPC.BotInlineResult botInlineResult, final HashMap<String, String> hashMap, final long j, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final boolean z, final int i, final String str, final int i2, final long j2) {
        ...
        if (botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaAuto) {
            new Thread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda65
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.lambda$prepareSendingBotContextResult$98(j, botInlineResult, accountInstance, hashMap, baseFragment, messageObject, messageObject2, z, i, str, i2, storyItem, replyQuote, j2);
                }
            }).run();
            return;
        }
        if (botInlineMessage instanceof TLRPC.TL_botInlineMessageText) {
            if (DialogObject.isEncryptedDialog(j)) {
                for (int i3 = 0; i3 < botInlineResult.send_message.entities.size(); i3++) {
                    ...
                    if (messageEntity instanceof TLRPC.TL_messageEntityUrl) {
                        ...
                        tL_webPagePending.url = str2.substring(i4, messageEntity.length + i4);
                        break;
                    }
                }
            }
            ...
            SendMessageParams of2 = SendMessageParams.of(botInlineMessage2.message, j, messageObject, messageObject2, tL_webPagePending2, !botInlineMessage2.no_webpage, botInlineMessage2.entities, botInlineMessage2.reply_markup, hashMap, z, i, null, false);
        ...
        if (botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaVenue) {
            ...
            SendMessageParams of3 = SendMessageParams.of(tL_messageMediaVenue, j, messageObject, messageObject2, botInlineMessage3.reply_markup, hashMap, z, i);
        ...
        if (botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaGeo) {
            if (botInlineMessage.period != 0 || botInlineMessage.proximity_notification_radius != 0) {
                ...
                int i5 = botInlineMessage4.period;
                if (i5 == 0) {
                    i5 = 900;
                }
                ...
                of = SendMessageParams.of(tL_messageMediaGeoLive, j, messageObject, messageObject2, botInlineMessage4.reply_markup, hashMap, z, i);
            } else {
                TLRPC.TL_messageMediaGeo tL_messageMediaGeo = new TLRPC.TL_messageMediaGeo();
                ...
                of = SendMessageParams.of(tL_messageMediaGeo, j, messageObject, messageObject2, botInlineMessage5.reply_markup, hashMap, z, i);
            }
            of.quick_reply_shortcut = str;
            of.quick_reply_shortcut_id = i2;
            of.replyQuote = replyQuote;
        ...
        if (botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaContact) {
            ...
            SendMessageParams of4 = SendMessageParams.of(tL_user, j, messageObject, messageObject2, botInlineResult.send_message.reply_markup, hashMap, z, i);
        ...
        if (botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaInvoice) {
            ...
            SendMessageParams of5 = SendMessageParams.of(tL_messageMediaInvoice, j, messageObject, messageObject2, botInlineResult.send_message.reply_markup, hashMap, z, i);
        ...
        if (botInlineMessage instanceof TLRPC.TL_botInlineMessageMediaWebPage) {
            ...
            SendMessageParams of6 = SendMessageParams.of(botInlineMessage7.message, j, messageObject, messageObject2, tL_webPagePending3, !botInlineMessage7.no_webpage, botInlineMessage7.entities, botInlineMessage7.reply_markup, hashMap, z, i, null, false);
    ...
    /* JADX WARN: Removed duplicated region for block: B:20:0x04dd A[ADDED_TO_REGION] */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static /* synthetic */ void lambda$prepareSendingBotContextResult$98(final long j, final TLRPC.BotInlineResult botInlineResult, final AccountInstance accountInstance, final HashMap hashMap, final BaseFragment baseFragment, final MessageObject messageObject, final MessageObject messageObject2, final boolean z, final int i, final String str, final int i2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final long j2) {
        String str2;
        Object obj;
        char c;
        String str3;
        ...
        if (!"game".equals(botInlineResult.type)) {
            if (botInlineResult instanceof TLRPC.TL_botInlineMediaResult) {
                ...
                if (webDocument2 != null) {
                        ...
                        case 6:
                            ...
                            switch (c2) {
                                        ...
                                        if (botInlineResult.thumb != null) {
                                            ...
                                            try {
                                                ...
                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda2
                                                    @Override // java.lang.Runnable
                                                    public final void run() {
                                                        SendMessagesHelper.lambda$prepareSendingBotContextResult$97(TLRPC.TL_document.this, bitmapArr, strArr, str8, j, messageObject, messageObject2, botInlineResult, hashMap, z, i, tL_photo4, r15, str, i2, storyItem, replyQuote, j2, accountInstance);
                                                    }
                                                });
                                            }
                                        }
                                ...
                                case 1:
                                    ...
                                    int i5 = isEncryptedDialog ? 90 : NotificationCenter.onReceivedChannelDifference;
                                    try {
                                        if (str2.endsWith("mp4")) {
                    ...
                    if (isEncryptedDialog && tLObject != 0) {
                        for (i4 = 0; i4 < tLObject.attributes.size(); i4++) {
                            if (tLObject.attributes.get(i4) instanceof TLRPC.TL_documentAttributeVideo) {
                                TLRPC.TL_documentAttributeVideo tL_documentAttributeVideo2 = (TLRPC.TL_documentAttributeVideo) tLObject.attributes.get(i4);
                                TLRPC.TL_documentAttributeVideo_layer159 tL_documentAttributeVideo_layer159 = new TLRPC.TL_documentAttributeVideo_layer159();
                                ...
                                tLObject.attributes.set(i4, tL_documentAttributeVideo_layer159);
                            }
                        }
                    }
                    if (!MessageObject.isGifDocument((TLRPC.Document) tLObject)) {
                        TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(tLObject.thumbs, NotificationCenter.onReceivedChannelDifference);
                    ...
                    final TLRPC.TL_game r152 = tL_photo3;
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.lambda$prepareSendingBotContextResult$97(TLRPC.TL_document.this, bitmapArr, strArr, str82, j, messageObject, messageObject2, botInlineResult, hashMap, z, i, tL_photo42, r152, str, i2, storyItem, replyQuote, j2, accountInstance);
                        }
                    });
                }
            }
            ...
            strArr = new String[1];
            if (isEncryptedDialog) {
                while (i4 < tLObject.attributes.size()) {
                }
            }
            if (!MessageObject.isGifDocument((TLRPC.Document) tLObject)) {
            }
            ...
            final TLRPC.TL_game r1522 = tL_photo3;
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.lambda$prepareSendingBotContextResult$97(TLRPC.TL_document.this, bitmapArr, strArr, str822, j, messageObject, messageObject2, botInlineResult, hashMap, z, i, tL_photo422, r1522, str, i2, storyItem, replyQuote, j2, accountInstance);
                }
            });
        }
        if (isEncryptedDialog) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$prepareSendingText$101(final String str, final long j, final AccountInstance accountInstance, final long j2, final boolean z, final int i, final long j3) {
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda88
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.lambda$prepareSendingText$100(str, j, accountInstance, j2, z, i, j3);
            }
        });
    }
    ...
    public static void prepareSendingText(final AccountInstance accountInstance, final String str, final long j, final long j2, final boolean z, final int i, final long j3) {
        accountInstance.getMessagesStorage().getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda43
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.lambda$prepareSendingText$101(str, j2, accountInstance, j, z, i, j3);
            }
        });
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static /* synthetic */ void lambda$prepareSendingText$99(String str, long j, AccountInstance accountInstance, long j2, boolean z, int i, long j3) {
        MessageObject messageObject;
    ...
    public static void ensureMediaThumbExists(AccountInstance accountInstance, boolean z, TLObject tLObject, String str, Uri uri, long j, boolean z2) {
        ...
        if (tLObject instanceof TLRPC.TL_document) {
            ...
            if ((MessageObject.isVideoDocument(tL_document) || MessageObject.isNewGifDocument(tL_document)) && MessageObject.isDocumentHasThumb(tL_document)) {
                ...
                int i = NotificationCenter.onReceivedChannelDifference;
                TLRPC.PhotoSize closestPhotoSizeWithSize3 = FileLoader.getClosestPhotoSizeWithSize(arrayList, NotificationCenter.onReceivedChannelDifference);
    ...
    public static void prepareSendingMedia(final AccountInstance accountInstance, final ArrayList<SendingMediaInfo> arrayList, final long j, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final boolean z, boolean z2, final MessageObject messageObject3, final boolean z3, final int i, int i2, final boolean z4, final InputContentInfoCompat inputContentInfoCompat, final String str, final int i3, final long j2, final boolean z5, final long j3, final long j4, final MessageSuggestionParams messageSuggestionParams) {
        ...
        mediaSendQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda68
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.lambda$prepareSendingMedia$107(arrayList, j, z, z6, accountInstance, messageObject3, messageObject, messageObject2, z3, i, storyItem, replyQuote, str, i3, j2, z5, j3, j4, messageSuggestionParams, inputContentInfoCompat, z4);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code restructure failed: missing block: B:339:0x0a5c, code lost:
     ...
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:148:0x03dd A[Catch: Exception -> 0x03c0, TRY_LEAVE, TryCatch #7 {Exception -> 0x03c0, blocks: (B:189:0x03b8, B:146:0x03c5, B:183:0x03d4, B:148:0x03dd), top: B:188:0x03b8 }] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:167:0x03ea A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:180:0x03cf A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:212:0x0559  */
    /* JADX WARN: Removed duplicated region for block: B:298:0x0815  */
    /* JADX WARN: Removed duplicated region for block: B:303:0x0865  */
    /* JADX WARN: Removed duplicated region for block: B:336:0x0a36  */
    /* JADX WARN: Removed duplicated region for block: B:345:0x0a6c  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:437:0x0771 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:475:0x0b32  */
    /* JADX WARN: Removed duplicated region for block: B:520:0x0cda  */
    /* JADX WARN: Removed duplicated region for block: B:563:0x0deb  */
    /* JADX WARN: Removed duplicated region for block: B:57:0x019d  */
    /* JADX WARN: Removed duplicated region for block: B:596:0x0f35  */
    /* JADX WARN: Removed duplicated region for block: B:600:0x0f44 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:613:0x0fa0  */
    /* JADX WARN: Removed duplicated region for block: B:616:0x0fa7  */
    /* JADX WARN: Removed duplicated region for block: B:62:0x0207  */
    /* JADX WARN: Removed duplicated region for block: B:654:0x0e58  */
    /* JADX WARN: Removed duplicated region for block: B:656:0x0df1  */
    /* JADX WARN: Removed duplicated region for block: B:65:0x020d  */
    /* JADX WARN: Removed duplicated region for block: B:665:0x0e6f  */
    /* JADX WARN: Removed duplicated region for block: B:712:0x10af  */
    /* JADX WARN: Removed duplicated region for block: B:714:0x10cd  */
    /* JADX WARN: Removed duplicated region for block: B:715:0x0b34  */
    /* JADX WARN: Removed duplicated region for block: B:741:0x1194  */
    ...
    */
    public static /* synthetic */ void lambda$prepareSendingMedia$107(ArrayList arrayList, final long j, boolean z, boolean z2, final AccountInstance accountInstance, final MessageObject messageObject, final MessageObject messageObject2, final MessageObject messageObject3, final boolean z3, final int i, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final String str, final int i2, final long j2, final boolean z4, final long j3, final long j4, final MessageSuggestionParams messageSuggestionParams, InputContentInfoCompat inputContentInfoCompat, final boolean z5) {
        ...
        String str74 = "parentObject";
        String str75 = "masks";
        String str76 = "-2147483648_";
        String str77 = "x";
        String str78 = "video/mp4";
            ...
            while (i30 < size2) {
                ...
                if (sendingMediaInfo4.searchImage == null && !sendingMediaInfo4.isVideo && sendingMediaInfo4.videoEditedInfo == null) {
                    ...
                    if (photoEntry != null && sendingMediaInfo4.highQuality) {
                        ...
                        String str83 = sendingMediaInfo4.originalPhotoEntry.imagePath;
                        if (str83 != null) {
                            sendingMediaInfo4.path = str83;
                        }
                    }
                    String str84 = sendingMediaInfo4.path;
                    if (str84 != null || (uri5 = sendingMediaInfo4.uri) == null) {
                        str68 = str84;
                    } else {
                        str84 = AndroidUtilities.getPath(uri5);
                        str68 = sendingMediaInfo4.uri.toString();
                    }
                    if (str84 == null || sendingMediaInfo4.ttl > 0) {
                        str69 = str80;
                        str70 = str79;
                        z14 = false;
                    } else {
                        if (str84.endsWith(str80)) {
                            str69 = str80;
                            z14 = false;
                        } else {
                            z14 = str84.endsWith(str79);
                            str69 = str80;
                            if (!z14) {
                                str70 = str79;
                            }
                        ...
                        str70 = str79;
                        if (arrayList.size() > 1 || ((z14 && !shouldSendWebPAsSticker(str84, null)) || !TextUtils.isEmpty(sendingMediaInfo4.caption))) {
                            ...
                            if (z15 && sendingMediaInfo4.ttl == 0) {
                                ...
                                Object[] sentFile2 = accountInstance.getMessagesStorage().getSentFile(str71, i32);
                                if (sentFile2 != null) {
                                    Object obj10 = sentFile2[0];
                                    if (obj10 instanceof TLRPC.TL_photo) {
                                        str73 = (String) sentFile2[1];
                            ...
                            if (tL_photo5 != null) {
                                mediaSendPrepareWorker.parentObject = str72;
                                mediaSendPrepareWorker.photo = tL_photo5;
                                i29 = 1;
                            } else {
                                i29 = 1;
                                mediaSendPrepareWorker.sync = new CountDownLatch(1);
                                mediaSendThreadPool.execute(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda27
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SendMessagesHelper.lambda$prepareSendingMedia$102(SendMessagesHelper.MediaSendPrepareWorker.this, accountInstance, sendingMediaInfo3, z13);
                                    }
                                });
                            }
                            i30 += i29;
                    ...
                    if (!ImageLoader.shouldSendImageAsDocument(sendingMediaInfo4.path, sendingMediaInfo4.uri)) {
                        if (str84 == null && (uri4 = sendingMediaInfo4.uri) != null && (MediaController.isGif(uri4) || (z14 = MediaController.isWebp(sendingMediaInfo4.uri)))) {
                            if (arrayList.size() <= 1) {
                ...
                if (i33 % 10 == 0) {
                    ...
                    if (searchImage == null && sendingMediaInfo5.videoEditedInfo == null) {
                        ...
                        if (searchImage.type == 1) {
                                    ...
                                    if (!z6) {
                                        try {
                                            if (sendingMediaInfo5.ttl == 0) {
                                                i27 = NotificationCenter.onReceivedChannelDifference;
                                                if (!file2.getAbsolutePath().endsWith("mp4")) {
                                                    try {
                                                        ...
                                                        str59 = sendingMediaInfo5.searchImage.imageUrl;
                                                        if (str59 != null) {
                                                        }
                                                        ...
                                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda28
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                SendMessagesHelper.lambda$prepareSendingMedia$103(MessageObject.this, accountInstance, tL_document5, r7, hashMap6, sendingMediaInfo5, str86, j, messageObject2, messageObject3, z3, i, storyItem, replyQuote, str, i2, z18, j2, z4, j3, j4, messageSuggestionParams);
                                                            }
                                                        });
                                                        i13 = i3;
                                                        i33 = i8;
                                                ...
                                                if (createVideoThumbnail != null) {
                                                    try {
                                                        ...
                                                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda28
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                SendMessagesHelper.lambda$prepareSendingMedia$103(MessageObject.this, accountInstance, tL_document52, r7, hashMap6, sendingMediaInfo5, str862, j, messageObject2, messageObject3, z3, i, storyItem, replyQuote, str, i2, z182, j2, z4, j3, j4, messageSuggestionParams);
                                                            }
                                                        });
                                                        i13 = i3;
                                                        i33 = i8;
                                            ...
                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda28
                                                @Override // java.lang.Runnable
                                                public final void run() {
                                                    SendMessagesHelper.lambda$prepareSendingMedia$103(MessageObject.this, accountInstance, tL_document522, r7, hashMap6, sendingMediaInfo5, str8622, j, messageObject2, messageObject3, z3, i, storyItem, replyQuote, str, i2, z1822, j2, z4, j3, j4, messageSuggestionParams);
                                                }
                                            });
                                            i13 = i3;
                                            i33 = i8;
                            ...
                            str59 = sendingMediaInfo5.searchImage.imageUrl;
                            if (str59 != null) {
                                hashMap6.put("originalPath", str59);
                            }
                            final String str86222 = null;
                            String str87222 = str57;
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda28
                                @Override // java.lang.Runnable
                                public final void run() {
                                    SendMessagesHelper.lambda$prepareSendingMedia$103(MessageObject.this, accountInstance, tL_document5222, file5, hashMap6, sendingMediaInfo5, str86222, j, messageObject2, messageObject3, z3, i, storyItem, replyQuote, str, i2, z18222, j2, z4, j3, j4, messageSuggestionParams);
                                }
                            });
                            i13 = i3;
                            i33 = i8;
                            ...
                            String str92 = sendingMediaInfo5.searchImage.imageUrl;
                            if (str92 != null) {
                                hashMap7.put("originalPath", str92);
                            }
                            if (z2) {
                                int i36 = i8 + 1;
                                StringBuilder sb2 = new StringBuilder();
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda29
                                @Override // java.lang.Runnable
                                public final void run() {
                                    SendMessagesHelper.lambda$prepareSendingMedia$104(MessageObject.this, accountInstance, tL_photo4, z19, sendingMediaInfo5, hashMap7, str93, j, messageObject2, messageObject3, z3, i, storyItem, replyQuote, i2, str, j2, z4, j3, j4, messageSuggestionParams);
                                }
                            });
                            i33 = i8;
                            str17 = str2;
                        ...
                        if (!sendingMediaInfo5.isVideo || sendingMediaInfo5.videoEditedInfo != null) {
                            ...
                            if (z && (videoEditedInfo != null || sendingMediaInfo5.path.endsWith("mp4"))) {
                                ...
                                String str94 = sendingMediaInfo5.path;
                                File file8 = new File(str94);
                                String str95 = str94 + file8.length() + str15 + file8.lastModified();
                                if (videoEditedInfo != null) {
                                    ...
                                    long j16 = videoEditedInfo.startTime;
                                    if (j16 >= 0) {
                                        z9 = z20;
                                        str21 = sb4;
                                        j8 = j16;
                                    ...
                                    if (sendingMediaInfo5.ttl == 0 && (videoEditedInfo == null || (videoEditedInfo.filterState == null && videoEditedInfo.paintPath == null && videoEditedInfo.mediaEntities == null && videoEditedInfo.cropState == null))) {
                                        ...
                                        if (sentFile3 != null) {
                                            ...
                                            if (obj12 instanceof TLRPC.TL_document) {
                                                ...
                                                String str97 = (String) sentFile3[1];
                                                j9 = j17;
                                                str22 = str96;
                                                str17 = str15;
                                                str24 = str94;
                                                ...
                                                str25 = str97;
                                                if (tL_document != null) {
                                                    String str98 = sendingMediaInfo5.thumbPath;
                                                    Bitmap decodeFile = str98 != null ? BitmapFactory.decodeFile(str98) : null;
                                                    ...
                                                    tL_document7.file_reference = new byte[i18];
                                                    if (photoSize2 != null) {
                                                    ...
                                                    if (tL_document.thumbs.isEmpty()) {
                                                        ...
                                                        String str99 = sendingMediaInfo2.thumbPath;
                                                        Bitmap decodeFile2 = str99 != null ? BitmapFactory.decodeFile(str99) : null;
                                                        if (decodeFile2 == null && (decodeFile2 = createVideoThumbnailAtTime(sendingMediaInfo2.path, j18)) == null) {
                                                ...
                                                if (videoEditedInfo != null && videoEditedInfo.muted) {
                                                    ...
                                                    while (true) {
                                                        if (i17 >= size) {
                                                            if (tL_document2.attributes.get(i17) instanceof TLRPC.TL_documentAttributeAnimated) {
                                                                break;
                                                            } else {
                                                                i17++;
                                                            }
                                                ...
                                                if (videoEditedInfo != null || (!videoEditedInfo.needConvert() && sendingMediaInfo2.isVideo)) {
                                                    ...
                                                    String str100 = videoEditedInfo.isSticker ? "webm" : str23;
                                                    StringBuilder sb5 = new StringBuilder();
                                                    str28 = str11;
                                                    sb5.append(str28);
                                                ...
                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda31
                                                    @Override // java.lang.Runnable
                                                    public final void run() {
                                                        SendMessagesHelper.lambda$prepareSendingMedia$105(bitmap, str26, messageObject, accountInstance, videoEditedInfo4, tL_document8, str29, hashMap8, sendingMediaInfo6, str101, j, messageObject2, messageObject3, z3, i, storyItem, replyQuote, str, i2, j2, z4, photoSize3, j3, j4, messageSuggestionParams);
                                                    }
                                                });
                                                i33 = i16;
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda31
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SendMessagesHelper.lambda$prepareSendingMedia$105(bitmap, str26, messageObject, accountInstance, videoEditedInfo42, tL_document82, str29, hashMap82, sendingMediaInfo62, str1012, j, messageObject2, messageObject3, z3, i, storyItem, replyQuote, str, i2, j2, z4, photoSize32, j3, j4, messageSuggestionParams);
                                    }
                                });
                                i33 = i16;
                                arrayList18 = arrayList29;
                            ...
                            if (str102 != null || (uri2 = sendingMediaInfo5.uri) == null) {
                                str36 = str102;
                                str37 = str36;
                            } else {
                            ...
                            if (z || ImageLoader.shouldSendImageAsDocument(sendingMediaInfo5.path, sendingMediaInfo5.uri)) {
                                ...
                                if (!sendingMediaInfo5.forceImage && str37 == null && (uri = sendingMediaInfo5.uri) != null) {
                                    ...
                                    if (z10) {
                                        ...
                                        arrayList19.add(str42);
                                        arrayList18.add(str36);
                                        ...
                                        if (hashMap4 != null) {
                                            ...
                                            String str103 = mediaSendPrepareWorker3.parentObject;
                                            if (tL_photo9 == null) {
                                                try {
                                            ...
                                            if (z8 || sendingMediaInfo5.ttl != 0) {
                                                ...
                                                Object[] sentFile4 = accountInstance.getMessagesStorage().getSentFile(str44, i40);
                                                String str104 = str44;
                                                if (sentFile4 != null) {
                                                    Object obj13 = sentFile4[0];
                                                    if (obj13 instanceof TLRPC.TL_photo) {
                                                        tL_photo2 = (TLRPC.TL_photo) obj13;
                                                        str50 = (String) sentFile4[1];
                                                        if (tL_photo2 == null) {
                                                            str48 = str50;
                                        ...
                                        if (tL_photo != null) {
                                            ...
                                            if (z21) {
                                                ...
                                                str54 = str10;
                                                hashMap11.put(str54, Utilities.bytesToHex(serializedData2.toByteArray()));
                                                serializedData2.cleanup();
                                            } else {
                                                str54 = str10;
                                            }
                                            ...
                                            if (z2) {
                                                try {
                                                    ...
                                                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda30
                                                        @Override // java.lang.Runnable
                                                        public final void run() {
                                                            SendMessagesHelper.lambda$prepareSendingMedia$106(bitmapArr, strArr, messageObject, accountInstance, tL_photo, hashMap11, sendingMediaInfo5, str106, j, messageObject2, messageObject3, z3, i, z5, storyItem, replyQuote, str, i2, j2, z4, j3, j4, messageSuggestionParams, z22);
                                                        }
                                                    });
                                                    i33 = i25;
                                                ...
                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda30
                                                    @Override // java.lang.Runnable
                                                    public final void run() {
                                                        SendMessagesHelper.lambda$prepareSendingMedia$106(bitmapArr, strArr, messageObject, accountInstance, tL_photo, hashMap11, sendingMediaInfo5, str1062, j, messageObject2, messageObject3, z3, i, z5, storyItem, replyQuote, str, i2, j2, z4, j3, j4, messageSuggestionParams, z222);
                                                    }
                                                });
                                                i33 = i25;
                                                arrayList19 = arrayList11;
                                            ...
                                            if (closestPhotoSizeWithSize != null) {
                                                ...
                                                try {
                                                    ...
                                                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda30
                                                        @Override // java.lang.Runnable
                                                        public final void run() {
                                                            SendMessagesHelper.lambda$prepareSendingMedia$106(bitmapArr, strArr, messageObject, accountInstance, tL_photo, hashMap11, sendingMediaInfo5, str10622, j, messageObject2, messageObject3, z3, i, z5, storyItem, replyQuote, str, i2, j2, z4, j3, j4, messageSuggestionParams, z2222);
                                                        }
                                                    });
                                                    i33 = i25;
                                                    arrayList19 = arrayList11;
                                                ...
                                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda30
                                                    @Override // java.lang.Runnable
                                                    public final void run() {
                                                        SendMessagesHelper.lambda$prepareSendingMedia$106(bitmapArr, strArr, messageObject, accountInstance, tL_photo, hashMap11, sendingMediaInfo5, str106222, j, messageObject2, messageObject3, z3, i, z5, storyItem, replyQuote, str, i2, j2, z4, j3, j4, messageSuggestionParams, z22222);
                                                    }
                                                });
                                                i33 = i25;
                                                arrayList19 = arrayList11;
                                            ...
                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda30
                                                @Override // java.lang.Runnable
                                                public final void run() {
                                                    SendMessagesHelper.lambda$prepareSendingMedia$106(bitmapArr, strArr, messageObject, accountInstance, tL_photo, hashMap11, sendingMediaInfo5, str1062222, j, messageObject2, messageObject3, z3, i, z5, storyItem, replyQuote, str, i2, j2, z4, j3, j4, messageSuggestionParams, z222222);
                                                }
                                            });
                                            i33 = i25;
                                            arrayList19 = arrayList11;
        ...
        if (arrayList36 != null && !arrayList36.isEmpty()) {
            ...
            while (i44 < size3) {
                if (!z || z23) {
                    ...
                    if (i5 > i43) {
                        ...
                        if (i33 % 10 == 0) {
                            ...
                            String str108 = (String) arrayList38.get(i44);
                            ArrayList arrayList39 = arrayList35;
                            String str109 = (String) arrayList39.get(i44);
                            ...
                            handleError(prepareSendingDocumentInternal(accountInstance, str108, str109, uri6, arrayList23, j, messageObject2, messageObject3, storyItem, replyQuote, arrayList42, messageObject, jArr, z7, (CharSequence) arrayList3.get(i44), z3, i, null, z, str, i2, j2, z4, j3, j4, messageSuggestionParams), accountInstance);
                            i44++;
                            ...
                            String str1082 = (String) arrayList382.get(i44);
                            ArrayList arrayList392 = arrayList35;
                            String str1092 = (String) arrayList392.get(i44);
                            ...
                            handleError(prepareSendingDocumentInternal(accountInstance, str1082, str1092, uri62, arrayList23, j, messageObject2, messageObject3, storyItem, replyQuote, arrayList422, messageObject, jArr, z7, (CharSequence) arrayList3.get(i44), z3, i, null, z, str, i2, j2, z4, j3, j4, messageSuggestionParams), accountInstance);
                            i44++;
                ...
                String str10822 = (String) arrayList3822.get(i44);
                ArrayList arrayList3922 = arrayList35;
                String str10922 = (String) arrayList3922.get(i44);
                ...
                handleError(prepareSendingDocumentInternal(accountInstance, str10822, str10922, uri622, arrayList23, j, messageObject2, messageObject3, storyItem, replyQuote, arrayList4222, messageObject, jArr, z7, (CharSequence) arrayList3.get(i44), z3, i, null, z, str, i2, j2, z4, j3, j4, messageSuggestionParams), accountInstance);
                i44++;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$prepareSendingMedia$102(MediaSendPrepareWorker mediaSendPrepareWorker, AccountInstance accountInstance, SendingMediaInfo sendingMediaInfo, boolean z) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$prepareSendingMedia$103(MessageObject messageObject, AccountInstance accountInstance, TLRPC.TL_document tL_document, String str, HashMap hashMap, SendingMediaInfo sendingMediaInfo, String str2, long j, MessageObject messageObject2, MessageObject messageObject3, boolean z, int i, TL_stories.StoryItem storyItem, ChatActivity.ReplyQuote replyQuote, String str3, int i2, boolean z2, long j2, boolean z3, long j3, long j4, MessageSuggestionParams messageSuggestionParams) {
        if (messageObject != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$prepareSendingMedia$104(MessageObject messageObject, AccountInstance accountInstance, TLRPC.TL_photo tL_photo, boolean z, SendingMediaInfo sendingMediaInfo, HashMap hashMap, String str, long j, MessageObject messageObject2, MessageObject messageObject3, boolean z2, int i, TL_stories.StoryItem storyItem, ChatActivity.ReplyQuote replyQuote, int i2, String str2, long j2, boolean z3, long j3, long j4, MessageSuggestionParams messageSuggestionParams) {
        if (messageObject != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$prepareSendingMedia$105(Bitmap bitmap, String str, MessageObject messageObject, AccountInstance accountInstance, VideoEditedInfo videoEditedInfo, TLRPC.TL_document tL_document, String str2, HashMap hashMap, SendingMediaInfo sendingMediaInfo, String str3, long j, MessageObject messageObject2, MessageObject messageObject3, boolean z, int i, TL_stories.StoryItem storyItem, ChatActivity.ReplyQuote replyQuote, String str4, int i2, long j2, boolean z2, TLRPC.PhotoSize photoSize, long j3, long j4, MessageSuggestionParams messageSuggestionParams) {
    ...
    */
    ...
    public static void prepareSendingVideo(final AccountInstance accountInstance, final String str, final VideoEditedInfo videoEditedInfo, final String str2, final TLRPC.Photo photo, final long j, final MessageObject messageObject, final MessageObject messageObject2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final ArrayList<TLRPC.MessageEntity> arrayList, final int i, final MessageObject messageObject3, final boolean z, final int i2, final boolean z2, final boolean z3, final CharSequence charSequence, final String str3, final int i3, final long j2, final long j3, final long j4, final MessageSuggestionParams messageSuggestionParams) {
        ...
        new Thread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda34
            @Override // java.lang.Runnable
            public final void run() {
                SendMessagesHelper.lambda$prepareSendingVideo$109(VideoEditedInfo.this, str, j, i, accountInstance, str2, photo, charSequence, messageObject3, z3, messageObject, messageObject2, arrayList, z, i2, storyItem, replyQuote, i3, str3, j2, j3, j4, messageSuggestionParams, z2);
            }
        }).start();
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:88:0x046d A[ADDED_TO_REGION] */
    ...
    */
    public static /* synthetic */ void lambda$prepareSendingVideo$109(VideoEditedInfo videoEditedInfo, String str, final long j, final int i, final AccountInstance accountInstance, String str2, TLRPC.Photo photo, CharSequence charSequence, final MessageObject messageObject, final boolean z, final MessageObject messageObject2, final MessageObject messageObject3, final ArrayList arrayList, final boolean z2, final int i2, final TL_stories.StoryItem storyItem, final ChatActivity.ReplyQuote replyQuote, final int i3, final String str3, final long j2, final long j3, final long j4, final MessageSuggestionParams messageSuggestionParams, boolean z3) {
        ...
        if (createCompressionSettings != null || str9.endsWith("mp4") || z5) {
            ...
            if (createCompressionSettings != null) {
                ...
                if (j5 >= 0) {
                        ...
                        if (sentFile != null) {
                            ...
                            if (obj instanceof TLRPC.TL_document) {
                                ...
                                if (tL_document == null) {
                                    ...
                                    int i7 = (isEncryptedDialog || i != 0) ? 90 : NotificationCenter.onReceivedChannelDifference;
                                    float f = i7;
                                    ...
                                    if (tL_document.thumbs.isEmpty()) {
                                        ...
                                        int i9 = (isEncryptedDialog || i != 0) ? 90 : NotificationCenter.onReceivedChannelDifference;
                                        float f2 = i9;
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda13
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        SendMessagesHelper.lambda$prepareSendingVideo$108(bitmap, str7, messageObject, accountInstance, videoEditedInfo3, tL_document5, str9, photoSize, hashMap, z, str13, j, messageObject2, messageObject3, charSequence2, arrayList, z2, i2, i, storyItem, replyQuote, i3, str3, j2, j3, j4, messageSuggestionParams);
                                    }
                                });
                                return;
                            }
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda13
                        @Override // java.lang.Runnable
                        public final void run() {
                            SendMessagesHelper.lambda$prepareSendingVideo$108(bitmap, str7, messageObject, accountInstance, videoEditedInfo32, tL_document52, str9, photoSize2, hashMap2, z, str132, j, messageObject2, messageObject3, charSequence2, arrayList, z2, i2, i, storyItem, replyQuote, i3, str3, j2, j3, j4, messageSuggestionParams);
                        }
                    });
                    return;
                }
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SendMessagesHelper$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
                    SendMessagesHelper.lambda$prepareSendingVideo$108(bitmap, str7, messageObject, accountInstance, videoEditedInfo322, tL_document522, str9, photoSize22, hashMap22, z, str1322, j, messageObject2, messageObject3, charSequence2, arrayList, z2, i2, i, storyItem, replyQuote, i3, str3, j2, j3, j4, messageSuggestionParams);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$prepareSendingVideo$108(Bitmap bitmap, String str, MessageObject messageObject, AccountInstance accountInstance, VideoEditedInfo videoEditedInfo, TLRPC.TL_document tL_document, String str2, TLRPC.PhotoSize photoSize, HashMap hashMap, boolean z, String str3, long j, MessageObject messageObject2, MessageObject messageObject3, String str4, ArrayList arrayList, boolean z2, int i, int i2, TL_stories.StoryItem storyItem, ChatActivity.ReplyQuote replyQuote, int i3, String str5, long j2, long j3, long j4, MessageSuggestionParams messageSuggestionParams) {
        if (bitmap != null && str != null) {
            ImageLoader.getInstance().putImageToCache(new BitmapDrawable(bitmap), str, false);
        }
        if (messageObject != null) {
