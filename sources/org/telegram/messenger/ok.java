...
public final /* synthetic */ class ok implements Utilities.Callback {
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (this.b) {
                    ...
                    MediaDataController.getInstance(i10).getEmojiSuggestions(x61.X1, str2, false, new f1.a(x61Var, linkedHashSet, hashMap, arrayList3, runnable), null, true, x61Var.T == 3, false, 30);
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ ok(x61 x61Var, boolean z4, LinkedHashSet linkedHashSet, String str, HashMap hashMap, ArrayList arrayList) {
        this.c = x61Var;
        this.b = z4;
