...
public final /* synthetic */ class i implements OnSuccessListener, OnFailureListener, ImageReceiver.ImageReceiverDelegate {
    public final /* synthetic */ int a;
    public final /* synthetic */ long b;
    public final /* synthetic */ int c;
    public final /* synthetic */ Object d;

    public /* synthetic */ i(int i10, int i11, long j3, Utilities.Callback callback) {
        this.a = i10;
        this.d = callback;
        this.c = i11;
        this.b = j3;
    ...
    */
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        ...
        if (drawableSafe != null) {
            ...
            if (drawable instanceof cg.b) {
                list = ((cg.b) drawable).a;
                ...
                cg.a aVar = new cg.a(bitmap, this.a, list);
                if (callback != null) {
                    callback.run(aVar);
                }
        ...
        cg.a aVar2 = new cg.a(bitmap, this.a, list);
        if (callback != null) {
        }
    ...
    public /* synthetic */ i(int i10, long j3, String str, int i11) {
        this.a = i10;
        this.b = j3;
        this.c = i11;
        this.d = str;
