...
public class TL_stories {
    ...
    public static class TL_geoPointAddress extends TLObject {
        ...
        public String toString() {
            ...
            sb2.append(", ");
            String str = "";
            sb2.append(this.state != null ? a4.a.t(new StringBuilder("state="), this.state, ", ") : "");
            sb2.append(this.city != null ? a4.a.t(new StringBuilder("city="), this.city, ", ") : "");
            if (this.street != null) {
    ...
    public static class TL_stories_report extends TLMethod<TLRPC.ReportResult> {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            this.peer.serializeToStream(outputSerializedData);
            Vector.serialize(outputSerializedData, new w(outputSerializedData, 1), this.id);
    ...
    public static class TL_storyViews extends StoryViews {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z10) {
            ...
            if (TLObject.hasFlag(this.flags, 8)) {
                this.reactions = Vector.deserialize(inputSerializedData, new q(22), z10);
            }
            if (TLObject.hasFlag(this.flags, 16)) {
