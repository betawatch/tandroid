...
import org.telegram.messenger.MessagesStorage$$ExternalSyntheticLambda114;
...
public class TL_account {
    ...
    public static class TL_inputBusinessChatLink extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            if (TLObject.hasFlag(this.flags, 1)) {
                this.entities = Vector.deserialize(inputSerializedData, new MessagesStorage$$ExternalSyntheticLambda114(), z);
            }
            if (TLObject.hasFlag(this.flags, 2)) {
    ...
    public static class TL_reactionsNotifySettings extends TLObject {
        ...
        public static TL_reactionsNotifySettings TLdeserialize(InputSerializedData inputSerializedData, int i, boolean z) {
            return (TL_reactionsNotifySettings) TLObject.TLdeserialize(TL_reactionsNotifySettings.class, 1910827608 != i ? null : new TL_reactionsNotifySettings(), inputSerializedData, i, z);
        }
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            if (TLObject.hasFlag(this.flags, 4)) {
                this.poll_votes_notify_from = ReactionNotificationsFrom.TLdeserialize(inputSerializedData, inputSerializedData.readInt32(z), z);
            }
    ...
    public static class TL_webBrowserSettings extends WebBrowserSettings {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            this.external_exceptions = Vector.deserialize(inputSerializedData, new Vector.TLDeserializer() { // from class: org.telegram.tgnet.tl.TL_account$TL_webBrowserSettings$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.Vector.TLDeserializer
                public final TLObject deserialize(InputSerializedData inputSerializedData2, int i, boolean z2) {
                    return TL_account.WebDomainException.TLdeserialize(inputSerializedData2, i, z2);
                }
            }, z);
            this.inapp_exceptions = Vector.deserialize(inputSerializedData, new Vector.TLDeserializer() { // from class: org.telegram.tgnet.tl.TL_account$TL_webBrowserSettings$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.Vector.TLDeserializer
                public final TLObject deserialize(InputSerializedData inputSerializedData2, int i, boolean z2) {
                    return TL_account.WebDomainException.TLdeserialize(inputSerializedData2, i, z2);
                }
