...
public class TL_stats {
    ...
    public static class BroadcastRevenueTransaction extends TLObject {
        public static BroadcastRevenueTransaction TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (BroadcastRevenueTransaction) TLObject.TLdeserialize(BroadcastRevenueTransaction.class, i9 != 1121127726 ? i9 != 1434332356 ? i9 != 1515784568 ? null : new TL_broadcastRevenueTransactionWithdrawal() : new TL_broadcastRevenueTransactionProceeds() : new TL_broadcastRevenueTransactionRefund(), inputSerializedData, i9, z10);
        }
    }
    ...
    public static abstract class PostInteractionCounters extends TLObject {
        public static PostInteractionCounters TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (PostInteractionCounters) TLObject.TLdeserialize(PostInteractionCounters.class, i9 != -1974989273 ? i9 != -419066241 ? null : new TL_postInteractionCountersMessage() : new TL_postInteractionCountersStory(), inputSerializedData, i9, z10);
        }
    }
    ...
    public static abstract class PublicForward extends TLObject {
        public static PublicForward TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (PublicForward) TLObject.TLdeserialize(PublicForward.class, i9 != -302797360 ? i9 != 32685898 ? null : new TL_publicForwardMessage() : new TL_stories.TL_publicForwardStory(), inputSerializedData, i9, z10);
        }
    }
    ...
    public static abstract class StatsGraph extends TLObject {
        ...
        public static StatsGraph TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (StatsGraph) TLObject.TLdeserialize(StatsGraph.class, i9 != -1901828938 ? i9 != -1092839390 ? i9 != 1244130093 ? null : new TL_statsGraphAsync() : new TL_statsGraphError() : new TL_statsGraph(), inputSerializedData, i9, z10);
        }
    }
    ...
    public static class TL_broadcastRevenueStats extends TLObject {
        ...
        public static TL_broadcastRevenueStats TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_broadcastRevenueStats) TLObject.TLdeserialize(TL_broadcastRevenueStats.class, 1409802903 != i9 ? null : new TL_broadcastRevenueStats(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_broadcastRevenueTransactionWithdrawal extends BroadcastRevenueTransaction {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            int i9 = this.pending ? this.flags | 1 : this.flags & (-2);
            this.flags = i9;
            this.flags = this.failed ? i9 | 1 : i9 & (-2);
            outputSerializedData.writeInt64(this.amount);
    ...
    public static class TL_broadcastRevenueTransactions extends TLObject {
        ...
        public static TL_broadcastRevenueTransactions TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_broadcastRevenueTransactions) TLObject.TLdeserialize(TL_broadcastRevenueTransactions.class, -2028632986 != i9 ? null : new TL_broadcastRevenueTransactions(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_broadcastRevenueWithdrawalUrl extends TLObject {
        ...
        public static TL_broadcastRevenueWithdrawalUrl TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_broadcastRevenueWithdrawalUrl) TLObject.TLdeserialize(TL_broadcastRevenueWithdrawalUrl.class, -328886473 != i9 ? null : new TL_broadcastRevenueWithdrawalUrl(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_broadcastStats extends TLObject {
        ...
        public static TL_broadcastStats TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_broadcastStats) TLObject.TLdeserialize(TL_broadcastStats.class, constructor != i9 ? null : new TL_broadcastStats(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_megagroupStats extends TLObject {
        ...
        public static TL_megagroupStats TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_megagroupStats) TLObject.TLdeserialize(TL_megagroupStats.class, -276825834 != i9 ? null : new TL_megagroupStats(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_messageStats extends TLObject {
        ...
        public static TL_messageStats TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_messageStats) TLObject.TLdeserialize(TL_messageStats.class, 2145983508 != i9 ? null : new TL_messageStats(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_publicForwards extends TLObject {
        ...
        public static TL_publicForwards TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_publicForwards) TLObject.TLdeserialize(TL_publicForwards.class, -1828487648 != i9 ? null : new TL_publicForwards(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_statsAbsValueAndPrev extends TLObject {
        ...
        public static TL_statsAbsValueAndPrev TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_statsAbsValueAndPrev) TLObject.TLdeserialize(TL_statsAbsValueAndPrev.class, -884757282 != i9 ? null : new TL_statsAbsValueAndPrev(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_statsDateRangeDays extends TLObject {
        ...
        public static TL_statsDateRangeDays TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_statsDateRangeDays) TLObject.TLdeserialize(TL_statsDateRangeDays.class, -1237848657 != i9 ? null : new TL_statsDateRangeDays(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_statsGroupTopAdmin extends TLObject {
        ...
        public static TL_statsGroupTopAdmin TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_statsGroupTopAdmin) TLObject.TLdeserialize(TL_statsGroupTopAdmin.class, -682079097 != i9 ? null : new TL_statsGroupTopAdmin(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_statsGroupTopInviter extends TLObject {
        ...
        public static TL_statsGroupTopInviter TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_statsGroupTopInviter) TLObject.TLdeserialize(TL_statsGroupTopInviter.class, 1398765469 != i9 ? null : new TL_statsGroupTopInviter(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_statsGroupTopPoster extends TLObject {
        ...
        public static TL_statsGroupTopPoster TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_statsGroupTopPoster) TLObject.TLdeserialize(TL_statsGroupTopPoster.class, -1660637285 != i9 ? null : new TL_statsGroupTopPoster(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_statsPercentValue extends TLObject {
        ...
        public static TL_statsPercentValue TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_statsPercentValue) TLObject.TLdeserialize(TL_statsPercentValue.class, -875679776 != i9 ? null : new TL_statsPercentValue(), inputSerializedData, i9, z10);
        }
    ...
    public static class TL_statsPollStats extends TLObject {
        ...
        public static TL_statsPollStats TLdeserialize(InputSerializedData inputSerializedData, int i9, boolean z10) {
            return (TL_statsPollStats) TLObject.TLdeserialize(TL_statsPollStats.class, i9 != constructor ? null : new TL_statsPollStats(), inputSerializedData, i9, z10);
        }
