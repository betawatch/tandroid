...
public abstract class g implements b1 {
    ...
    public boolean M0() {
        i2.f0 f0Var = (i2.f0) this;
        k1 w02 = f0Var.w0();
        return !w02.p() && w02.m(f0Var.l0(), (j1) this.a, 0L).a();
    }
    ...
    public boolean d0() {
        i2.f0 f0Var = (i2.f0) this;
        k1 w02 = f0Var.w0();
        return !w02.p() && w02.m(f0Var.l0(), (j1) this.a, 0L).h;
    }
    ...
    public boolean i0() {
        i2.f0 f0Var = (i2.f0) this;
        return f0Var.d() == 3 && f0Var.u() && f0Var.u0() == 0;
    }
    ...
    public boolean t0() {
        i2.f0 f0Var = (i2.f0) this;
        k1 w02 = f0Var.w0();
        return !w02.p() && w02.m(f0Var.l0(), (j1) this.a, 0L).i;
    }

    @Override // b2.b1
    public void v() {
        ((i2.f0) this).S(0, ConnectionsManager.DEFAULT_DATACENTER_ID);
    }

    @Override // b2.b1
    public void v0(List list) {
        ((i2.f0) this).b0(ConnectionsManager.DEFAULT_DATACENTER_ID, list);
    }
    ...
    public k0 w() {
        ...
        return w02.m(f0Var.l0(), (j1) this.a, 0L).c;
    }
    ...
    public int y() {
        ...
        return e2.d0.h(x7.b((d == Long.MAX_VALUE || d == Long.MIN_VALUE) ? c02 / (duration / 100) : d / duration), 0, 100);
    }
