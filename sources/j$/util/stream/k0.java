...
public final /* synthetic */ class k0 implements Supplier, Consumer {
    ...
    public Object get() {
        switch (this.a) {
            case 0:
                return new n0((j$.util.function.b0) this.c, (q0) this.b);
            case 1:
                return new m0((j$.util.function.I) this.c, (q0) this.b);
            case 2:
                return new o0((j$.util.function.p) this.c, (q0) this.b);
            default:
    ...
    public void r(Object obj) {
        switch (this.a) {
            case 4:
                ((Z2) this.b).f((Consumer) this.c, obj);
                break;
            case 5:
                if (obj != null) {
