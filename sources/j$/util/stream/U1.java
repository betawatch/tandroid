...
public final class U1 extends c2 {
    ...
    public U1(T t, g2 g2Var) {
        super(g2Var);
        this.e = t;
        g2 g2Var2 = this.a;
        Objects.requireNonNull(g2Var2);
        this.d = new j$.util.G(g2Var2, 1);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public U1(v vVar, g2 g2Var) {
        super(g2Var);
        this.e = vVar;
        g2 g2Var2 = this.a;
        Objects.requireNonNull(g2Var2);
        this.d = new j$.util.C(g2Var2, 1);
    }
    ...
    public final void s(Object obj) {
        switch (this.b) {
            case 0:
                LongStream longStream = (LongStream) ((j$.time.t) ((d0) this.e).n).apply((j$.time.t) obj);
                if (longStream != null) {
                    try {
                        boolean z = this.c;
                ...
                return;
            case 1:
                IntStream intStream = (IntStream) ((j$.time.t) ((T) this.e).n).apply((j$.time.t) obj);
                if (intStream != null) {
                    try {
                        boolean z2 = this.c;
                ...
                return;
            default:
                B b = (B) ((j$.time.t) ((v) this.e).n).apply((j$.time.t) obj);
                if (b != null) {
                    try {
                        boolean z3 = this.c;
                        ...
                        if (!z3) {
                            ...
                            j$.util.T spliterator3 = b.sequential().spliterator();
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public U1(d0 d0Var, g2 g2Var) {
        super(g2Var);
        this.e = d0Var;
        g2 g2Var2 = this.a;
        Objects.requireNonNull(g2Var2);
        this.d = new j$.util.K(g2Var2, 1);
    }
}
