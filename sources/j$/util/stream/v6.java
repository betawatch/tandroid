...
public final class v6 {
    ...
    static {
        ...
        v6 v6Var2 = new v6("SORTED", 1, 1, q10);
        SORTED = v6Var2;
        j$.time.t q11 = q(u6Var);
        q11.D(u6Var2);
        ((EnumMap) ((Map) q11.b)).put((EnumMap) u6Var3, (u6) 3);
        u6 u6Var4 = u6.TERMINAL_OP;
        ((EnumMap) ((Map) q11.b)).put((EnumMap) u6Var4, (u6) 2);
        u6 u6Var5 = u6.UPSTREAM_TERMINAL_OP;
        ((EnumMap) ((Map) q11.b)).put((EnumMap) u6Var5, (u6) 2);
        v6 v6Var3 = new v6("ORDERED", 2, 2, q11);
        ORDERED = v6Var3;
        j$.time.t q12 = q(u6Var);
        q12.D(u6Var2);
        ((EnumMap) ((Map) q12.b)).put((EnumMap) u6Var3, (u6) 2);
        v6 v6Var4 = new v6("SIZED", 3, 3, q12);
        SIZED = v6Var4;
        j$.time.t q13 = q(u6Var3);
        q13.D(u6Var4);
        int i10 = 0;
        v6 v6Var5 = new v6("SHORT_CIRCUIT", 4, 12, q13);
