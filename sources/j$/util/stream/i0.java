...
abstract class i0 extends b implements LongStream {
    i0(Spliterator spliterator, int i) {
    ...
    public final boolean C(j$.util.function.W w) {
        return ((Boolean) i0(u0.a0(w, r0.ANY))).booleanValue();
    }

    @Override // j$.util.stream.LongStream
    public final boolean E(j$.util.function.W w) {
        return ((Boolean) i0(u0.a0(w, r0.NONE))).booleanValue();
    }

    @Override // j$.util.stream.LongStream
    public final LongStream K(j$.util.function.W w) {
        w.getClass();
        return new x(this, R2.t, w, 4);
    }
    ...
    public final Object W(Supplier supplier, j$.util.function.l0 l0Var, BiConsumer biConsumer) {
        s sVar = new s(biConsumer, 2);
        supplier.getClass();
        l0Var.getClass();
        return i0(new v1(S2.LONG_VALUE, sVar, l0Var, supplier, 0));
    }

    @Override // j$.util.stream.LongStream
    public final E asDoubleStream() {
        return new y(this, R2.p | R2.n, 2);
    }

    @Override // j$.util.stream.LongStream
    public final j$.util.j average() {
        long[] jArr = (long[]) W(new r(29), new d0(0), new d0(1));
        long j = jArr[0];
        if (j <= 0) {
            return j$.util.j.a();
        }
    ...
    public final j$.util.l findAny() {
        return (j$.util.l) i0(new F(false, S2.LONG_VALUE, j$.util.l.a(), new r(6), new l(7)));
    }

    @Override // j$.util.stream.LongStream
    public final j$.util.l findFirst() {
        return (j$.util.l) i0(new F(true, S2.LONG_VALUE, j$.util.l.a(), new r(6), new l(7)));
    }

    @Override // j$.util.stream.LongStream
    public final j$.util.l g(j$.util.function.O o) {
        o.getClass();
        return (j$.util.l) i0(new z1(S2.LONG_VALUE, o, 3));
    }
    ...
    final G0 k0(b bVar, Spliterator spliterator, boolean z, IntFunction intFunction) {
        return u0.H(bVar, spliterator, z);
    }

    @Override // j$.util.stream.LongStream
    public final LongStream limit(long j) {
        if (j >= 0) {
            return u0.Z(this, 0L, j);
        }
    ...
    public final Stream mapToObj(LongFunction longFunction) {
        ...
        return new v(this, R2.p | R2.n, longFunction, 2);
    }
    ...
    public final LongStream n(LongFunction longFunction) {
        return new x(this, R2.p | R2.n | R2.t, longFunction, 3);
    }
    ...
    public final E p(j$.util.function.X x) {
        x.getClass();
        return new u(this, R2.p | R2.n, x, 5);
    }

    @Override // j$.util.stream.LongStream
    public final boolean s(j$.util.function.W w) {
        return ((Boolean) i0(u0.a0(w, r0.ALL))).booleanValue();
    }
    ...
    public final LongStream skip(long j) {
        if (j >= 0) {
            return j == 0 ? this : u0.Z(this, j, -1L);
        }
        throw new IllegalArgumentException(Long.toString(j));
    }
    ...
    public final j$.util.i summaryStatistics() {
        return (j$.util.i) W(new l(16), new r(21), new r(25));
    }

    @Override // j$.util.stream.LongStream
    public final LongStream t(j$.util.function.c0 c0Var) {
        c0Var.getClass();
        return new x(this, R2.p | R2.n, c0Var, 2);
    }

    @Override // j$.util.stream.LongStream
    public final long[] toArray() {
        return (long[]) u0.Q((E0) j0(new r(26))).e();
    }
    ...
    public final IntStream y(j$.util.function.Y y) {
        y.getClass();
        return new w(this, R2.p | R2.n, y, 5);
    }
