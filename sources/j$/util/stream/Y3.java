...
final class Y3 extends z implements Z3 {
    ...
    final Spliterator O(b bVar, Spliterator spliterator) {
        return a3.ORDERED.m(bVar.J()) ? N(bVar, spliterator, new c0(20)).spliterator() : new d4((j$.util.V) bVar.W(spliterator), 0);
    }
    ...
    final m2 Q(int i, m2 m2Var) {
        return new X3(this, m2Var, false);
    }

    @Override // j$.util.stream.Z3
    public final a4 j(A0 a0, boolean z) {
        return new X3(this, a0, z);
    }
}
