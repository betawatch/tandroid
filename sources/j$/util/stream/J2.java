...
class J2 extends N2 implements j$.util.function.E {
    ...
    public final String toString() {
        ...
        return String.format("%s[length=%d, chunks=%d]%s...", getClass().getSimpleName(), Integer.valueOf(iArr.length), Integer.valueOf(this.c), Arrays.toString(Arrays.copyOf(iArr, NotificationCenter.emojiKeywordsLoaded)));
    }
