...
final class u2 extends z {
    ...
    final Spliterator O(b bVar, Spliterator spliterator) {
        ...
        if (F > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.V v = (j$.util.V) bVar.W(spliterator);
            long j4 = this.m;
            return new q3(v, j4, w0.B(j4, j3));
        }
        if (a3.ORDERED.m(bVar.J())) {
            return ((I0) new w2(this, bVar, spliterator, new c0(12), this.m, this.n).invoke()).spliterator();
        }
        j$.util.V v2 = (j$.util.V) bVar.W(spliterator);
        long j5 = this.m;
        if (j5 <= F) {
            long j6 = F - j5;
            if (j3 >= 0) {
    ...
    final I0 N(b bVar, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (!a3.ORDERED.m(bVar.J())) {
            ...
            return w0.F(this, new w3(v, j2, j), true);
        }
