...
public final class k2 extends X {
    ...
    public k2(Y y, int i, long j, long j2) {
        super(y, i, 0);
        this.m = j;
        this.n = j2;
    }
    ...
    public final Spliterator K(a aVar, Spliterator spliterator) {
        ...
        if (F > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            long j2 = this.m;
            return new j3(w, j2, r1.A(j2, j));
        }
        if (S2.ORDERED.q(aVar.f)) {
            return ((C0) new q2(this, aVar, spliterator, new Z(21), this.m, this.n).invoke()).spliterator();
        }
    ...
    public final C0 J(a aVar, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (F <= 0 || !spliterator.hasCharacteristics(16384)) {
            if (!S2.ORDERED.q(aVar.f)) {
                ...
                return r1.D(this, new p3(w, j2, j), true);
            }
        ...
        return r1.D(aVar, r1.y(aVar2.H(), spliterator, this.m, this.n), true);
    }

    @Override // j$.util.stream.a
    public final g2 M(int i, g2 g2Var) {
        return new j2(this, g2Var);
    }
}
