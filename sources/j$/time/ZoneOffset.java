...
public final class ZoneOffset extends ZoneId implements j$.time.temporal.l, j$.time.temporal.m, Comparable<ZoneOffset>, Serializable {
    ...
    */
    ...
    public static int P(CharSequence charSequence, int i9, boolean z10) {
        if (z10) {
    ...
    public static ZoneOffset N(int i9, int i10, int i11) {
        if (i9 < -18 || i9 > 18) {
            throw new b("Zone offset hours not in valid range: value " + i9 + " is not in the range -18 to 18");
        }
        if (i9 > 0) {
            if (i10 < 0 || i11 < 0) {
        ...
        return O((i10 * 60) + (i9 * 3600) + i11);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static ZoneOffset O(int i9) {
        if (i9 < -64800 || i9 > 64800) {
            throw new b("Zone offset not in valid range: -18:00 to +18:00");
        }
        if (i9 % RichMessageLayout.PART_MAX_HEIGHT_DP == 0) {
            ...
            concurrentHashMap.putIfAbsent(valueOf, new ZoneOffset(i9));
    ...
    public final void R(DataOutput dataOutput) {
        int i9 = this.b;
        int i10 = i9 % RichMessageLayout.PART_MAX_HEIGHT_DP == 0 ? i9 / RichMessageLayout.PART_MAX_HEIGHT_DP : 127;
