    ...
    public final void writeExternal(ObjectOutput objectOutput) {
        ...
        switch (b) {
            ...
            case 7:
                B b2 = (B) obj;
                b2.getClass();
                objectOutput.writeInt(j$.time.temporal.p.a(b2, j$.time.temporal.a.YEAR));
                objectOutput.writeByte(j$.time.temporal.p.a(b2, j$.time.temporal.a.MONTH_OF_YEAR));
                objectOutput.writeByte(j$.time.temporal.p.a(b2, j$.time.temporal.a.DAY_OF_MONTH));
                return;
            case 8:
                H h = (H) obj;
                h.getClass();
                objectOutput.writeInt(j$.time.temporal.p.a(h, j$.time.temporal.a.YEAR));
                objectOutput.writeByte(j$.time.temporal.p.a(h, j$.time.temporal.a.MONTH_OF_YEAR));
                objectOutput.writeByte(j$.time.temporal.p.a(h, j$.time.temporal.a.DAY_OF_MONTH));
                return;
            case 9:
                g gVar = (g) obj;
    ...
    public final void readExternal(ObjectInput objectInput) {
        ...
        switch (readByte) {
            case 1:
                ...
                break;
            case 2:
                W = ((b) objectInput.readObject()).w((j$.time.h) objectInput.readObject());
                break;
            case 3:
                W = ((ChronoLocalDateTime) objectInput.readObject()).t((ZoneOffset) objectInput.readObject()).k((ZoneId) objectInput.readObject());
                break;
            case 4:
            ...
            case 7:
                ...
                z.c.getClass();
                W = new B(LocalDate.of(readInt3 + 1911, readByte6, readByte7));
                break;
            case 8:
                ...
                F.c.getClass();
                W = new H(LocalDate.of(readInt4 - 543, readByte8, readByte9));
                break;
            case 9:
                int i = g.e;
