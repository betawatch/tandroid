...
public final class DateTimeFormatter {
    ...
    static {
        ...
        DateTimeFormatter u = pVar.u(wVar, gVar);
        ISO_LOCAL_DATE = u;
        p pVar2 = new p();
        pVar2.r();
        pVar2.a(u);
        ...
        pVar7.e('T');
        pVar7.a(u2);
        DateTimeFormatter u3 = pVar7.u(wVar, gVar);
        p pVar8 = new p();
        pVar8.r();
        pVar8.a(u3);
        pVar8.h();
        DateTimeFormatter u4 = pVar8.u(wVar, gVar);
        p pVar9 = new p();
        pVar9.a(u4);
        pVar9.q();
        pVar9.e('[');
        ...
        pVar15.e(' ');
        pVar15.g("+HHMM", "GMT");
        pVar15.u(w.SMART, gVar);
    }

    DateTimeFormatter(e eVar, Locale locale, w wVar, j$.time.chrono.g gVar) {
        v vVar = v.a;
        this.a = eVar;
        A.z(locale, "locale");
        this.b = locale;
