...
public final class m implements j$.time.temporal.m, j$.time.temporal.n, Comparable, Serializable {
    ...
    public final j$.time.temporal.u o(j$.time.temporal.p pVar) {
        ...
        J.getClass();
        int i = j.a[J.ordinal()];
        return j$.time.temporal.u.k(i != 1 ? (i == 2 || i == 3 || i == 4 || i == 5) ? 30 : 31 : 28, k.J(r5).I());
    }
    ...
    static m G(ObjectInput objectInput) {
        ...
        if (readByte2 > J.I()) {
            throw new c("Illegal value for DayOfMonth field, value " + ((int) readByte2) + " is not valid for month " + J.name());
        }
        return new m(J.getValue(), readByte2);
    }
}
