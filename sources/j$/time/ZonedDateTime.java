...
public final class ZonedDateTime implements Temporal, ChronoZonedDateTime<LocalDate>, Serializable {
    ...
    public static ZonedDateTime H(LocalDateTime localDateTime, ZoneId zoneId, ZoneOffset zoneOffset) {
        ...
        if (f10.size() == 1) {
            ...
            localDateTime = localDateTime.M(Duration.j(e9.d.getTotalSeconds() - e9.c.getTotalSeconds(), 0).getSeconds());
            zoneOffset = e9.d;
    ...
    public static ZonedDateTime G(j$.time.temporal.l lVar) {
        ...
        try {
            ...
            throw new b("Unable to obtain ZonedDateTime from TemporalAccessor: " + lVar + " of type " + lVar.getClass().getName(), e9);
        }
    }
