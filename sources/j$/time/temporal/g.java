...
abstract class g implements l {
    ...
    static {
        ...
        a = new int[]{0, 90, NotificationCenter.updateBotMenuButton, NotificationCenter.showBulletin, 0, 91, NotificationCenter.giftsToUserSent, NotificationCenter.appUpdateAvailable};
    }
