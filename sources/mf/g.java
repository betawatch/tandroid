...
public final class g extends kf.a {
    ...
    public static u c(e eVar) {
        b b10 = eVar.b();
        eVar.c(3, b.c);
        return new u(1, eVar.d(200, b10), eVar.c((int) eVar.a.e(), b10));
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:275:0x045c A[Catch: all -> 0x043f, TryCatch #10 {all -> 0x043f, blocks: (B:268:0x0428, B:270:0x043a, B:273:0x0452, B:275:0x045c, B:277:0x0473, B:278:0x0490, B:280:0x0494, B:282:0x048c, B:285:0x0441, B:287:0x0449), top: B:267:0x0428 }] */
    /*
        ...
        switch (str2) {
            ...
            case "APIC":
                if (this.o == null || this.r != 3) {
                    ...
                    int i13 = 0;
                    while (i13 < e7) {
                        int read = ((com.google.firebase.messaging.d) dVar.b).read(bArr, i13, e7 - i13);
                        if (read <= 0) {
                            throw new EOFException();
                        }
                        i13 += read;
                    }
                    if (this.o == null || y3 == 3 || y3 == 0) {
                        try {
                ...
                if (e10.length() > 0) {
                    ...
                    try {
                        if (e10.charAt(0) == '(') {
                            ...
                            if (indexOf > 1 && (i10 = i2.g.a(Integer.parseInt(e10.substring(1, indexOf)))) == 0 && e10.length() > (i12 = indexOf + 1)) {
                                this.h = e10.substring(i12);
                            }
                        } else {
                            i10 = i2.g.a(Integer.parseInt(e10));
                        }
                        if (i10 != 0) {
                            this.h = i2.g.c(i10);
                            return;
