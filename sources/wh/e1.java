...
public final class e1 extends Drawable {
    ...
    public e1(ViewGroup viewGroup, f6 f6Var, boolean z10) {
        ...
        this.q = paint3;
        this.r = new d6(new qg.q0(this, 22), 320L, wr.h);
    ...
    public final void b(Canvas canvas, float f7) {
            ...
            if (this.h != null) {
                if (z12) {
                    ...
                    if (l1Var.b == null || l1Var.h != v02) {
                        ...
                        l1Var.b = j7.b(bitmapArr, fArr, dp, dp2, 0, new fh.f() { // from class: fh.e
                            @Override // fh.f
                    ...
                    xf.p.h(ninePatchDrawable2, rect);
                ...
                if (z12) {
                    ...
                    if (l1Var2.f == null || (l1Var2.j != v03 && l1Var2.k != v02)) {
                        ...
                        l1Var2.f = j7.b(bitmapArr2, fArr2, dp3, dp4, v03, new fh.f() { // from class: fh.e
                            @Override // fh.f
                    ...
                    if (l1Var3.d == null || l1Var3.i != v03) {
                        ...
                        l1Var3.d = j7.b(l1Var3.c, l1Var3.g, 0.0f, 0.0f, v03, new fh.f() { // from class: fh.e
                            @Override // fh.f
                            public final void a(Canvas canvas3, RectF rectF2, float[] fArr22) {
                                Path path = new Path();
                                path.addRoundRect(rectF2, fArr22, Path.Direction.CW);
        ...
        if (this.h == null || d1Var.d()) {
            ...
            if (i15 >= 29) {
                ...
                f10 = 1.0f;
                if (drawable != null && d1Var.d.c == 1.0f && (drawable instanceof p5)) {
                    ...
                    if (h1Var != null) {
                        ...
                        if (bitmap != null) {
                            ...
                            if (f7 < 1.0f) {
                                bitmap2 = bitmap;
                                xh.j0.b(canvas2, 2, this.A, bitmap2, bounds.width(), bounds.height(), 1.0f - f7);
                            } else {
                                bitmap2 = bitmap;
                            }
                            if (f7 > 0.0f) {
                                canvas2.translate(0.0f, AndroidUtilities.dp(-31.0f));
                                xh.j0.b(canvas2, 0, this.A, bitmap2, bounds.width(), bounds.height(), f7);
                            }
                            canvas2 = canvas;
                            canvas2.restore();
                        }
            ...
            if (f7 < f10) {
                canvas2 = canvas;
                xh.j0.a(canvas2, 2, d1Var, bounds.width(), bounds.height(), f10 - f7, 1.0f);
            } else {
                canvas2 = canvas;
            }
            if (f7 > 0.0f) {
                canvas2.translate(0.0f, AndroidUtilities.dp(-31.0f));
                xh.j0.a(canvas2, 0, d1Var, bounds.width(), bounds.height(), f7, 1.0f);
            }
            canvas2.restore();
        }
        if (z13) {
