    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                u4 u4Var = this.b;
                String str = u4Var.b;
                TLRPC.Document document = u4Var.r;
                String str2 = null;
                        ...
                        if (bitmap != null) {
                            try {
                                ...
                                if (scaleAndSaveImage != null) {
                                    ...
                                    document.flags |= 1;
                                    File pathToAttach = FileLoader.getInstance(u4Var.a).getPathToAttach(scaleAndSaveImage, true);
                                ...
                                u4Var.C = str2;
                                AndroidUtilities.runOnUIThread(new s4(u4Var, 2));
                                return;
                            }
                        } else if (bitmap != null) {
                            break;
            ...
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new vf.k0(12, u4Var2, str4));
                return;
            default:
                u4 u4Var3 = this.b;
                if (u4Var3.w || u4Var3.x) {
                    return;
                }
                u4Var3.a(u4Var3.b);
                return;
