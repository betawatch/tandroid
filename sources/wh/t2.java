...
public final /* synthetic */ class t2 implements Utilities.Callback2 {
    ...
    public /* synthetic */ t2(h4 h4Var, String[] strArr, ArrayList arrayList, int i10) {
        this.a = i10;
        this.b = h4Var;
        this.c = strArr;
        this.d = arrayList;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                ...
                u3 u3Var = h4Var.d;
                boolean isEmpty = u3Var.l.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = u3Var.l.contains(Long.valueOf(stargiftattributepattern.document.id));
                    boolean z10 = !contains;
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.a2.w(" ", lowerCase, stargiftattributepattern.name.toLowerCase()) || org.telegram.messenger.a2.w(" ", translitSafe, stargiftattributepattern.name.toLowerCase())) {
                        Integer num = (Integer) u3Var.o.get(Long.valueOf(stargiftattributepattern.document.id));
                        int intValue = num == null ? 0 : num.intValue();
                        int i12 = q3.a;
                        v51 J = v51.J(q3.class);
            ...
            default:
                ...
                u3 u3Var3 = h4Var.d;
                boolean isEmpty3 = u3Var3.j.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = u3Var3.j.contains(Long.valueOf(stargiftattributemodel.document.id));
                    boolean z12 = !contains3;
                    if (TextUtils.isEmpty(lowerCase3) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase3) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe3) || org.telegram.messenger.a2.w(str4, lowerCase3, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.a2.w(str4, translitSafe3, stargiftattributemodel.name.toLowerCase())) {
                        str3 = str4;
                        Integer num3 = (Integer) u3Var3.m.get(Long.valueOf(stargiftattributemodel.document.id));
                        int intValue3 = num3 == null ? 0 : num3.intValue();
                        int i16 = n3.a;
                        v51 J3 = v51.J(n3.class);
