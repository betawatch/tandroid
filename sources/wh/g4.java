...
public final class g4 extends ab {
    ...
    public g4(final Context context, String str, final f4 f4Var) {
        ...
        final int i10 = 0;
        k3Var2.setOnClickListener(new View.OnClickListener(this) { // from class: wh.a4
        ...
        final int i11 = 1;
        k3Var3.setOnClickListener(new View.OnClickListener(this) { // from class: wh.a4
            public final /* synthetic */ g4 b;
        ...
        final int i12 = 2;
        k3Var4.setOnClickListener(new View.OnClickListener(this) { // from class: wh.a4
            public final /* synthetic */ g4 b;
    ...
    public static void P(g4 g4Var, f4 f4Var) {
        w70 F = w70.F(g4Var.container, g4Var.resourcesProvider, g4Var.a0);
    ...
    public static void Q(g4 g4Var, f4 f4Var, int i10) {
        ...
        if (obj instanceof TL_stars.StarGift) {
            ...
            if (z10 && (starGift instanceof TL_stars.TL_starGiftUnique)) {
                ...
                v5.x(g4Var.currentAccount, bVar).H(tL_starGiftUnique, clientUserId, null, true, new bp0(g4Var, d2Var2, bVar, tL_starGiftUnique, clientUserId));
                return;
            }
            if (!z10) {
    ...
    public static void R(g4 g4Var, f4 f4Var, Context context) {
        ...
        w70 w70Var = new w70(g4Var.container, g4Var.resourcesProvider, g4Var.b0, false, true, false);
        w70Var.t = false;
        w70Var.Y = true;
        w70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        w70Var.R = true;
        w70Var.p = new hi.i(w70Var, 8);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(u3Var.f);
        Collections.sort(arrayList, new z3(f4Var, 2));
        int i10 = 0;
        b4 b4Var = new b4(context, g4Var.currentAccount, 0, false, new v3(strArr, f4Var, arrayList, i10), new w3(f4Var, w70Var, i10), null, g4Var.resourcesProvider);
        b4Var.Y2.r = false;
        ...
        fuVar.addTextChangedListener(new og.x(strArr, b4Var, false, 11));
        if (arrayList.size() > 8) {
    ...
    public static void S(g4 g4Var, f4 f4Var, Context context) {
        ...
        w70 w70Var = new w70(g4Var.container, g4Var.resourcesProvider, g4Var.d0, false, true, false);
        w70Var.t = false;
        w70Var.Y = true;
        w70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        w70Var.R = true;
        w70Var.p = new hi.i(w70Var, 7);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(u3Var.h);
        Collections.sort(arrayList, new z3(f4Var, 1));
        int i10 = 2;
        d4 d4Var = new d4(context, g4Var.currentAccount, 0, false, new v3(strArr, f4Var, arrayList, i10), new w3(f4Var, w70Var, i10), null, g4Var.resourcesProvider);
        d4Var.Y2.r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        fuVar.setBackground(null);
        frameLayout.addView(fuVar, a6.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        fuVar.addTextChangedListener(new og.x(strArr, d4Var, false, 13));
        if (arrayList.size() > 8) {
            w70Var.r(frameLayout, a6.n(-1, 44));
            w70Var.k();
        }
    ...
    public static /* synthetic */ void U(g4 g4Var, org.telegram.ui.ActionBar.d2 d2Var, yf.b bVar, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift) {
        d2Var.dismiss();
    ...
    public static void V(g4 g4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, xh.a3 a3Var, nf.e eVar) {
        eVar.d();
        v5.x(g4Var.currentAccount, a3Var.a).h(a3Var.b, tL_starGiftUnique, j3, null, true, new org.telegram.tgnet.g(g4Var, eVar, tL_starGiftUnique, 6));
    }
    ...
    public static void W(g4 g4Var, f4 f4Var, Context context) {
        ...
        w70 w70Var = new w70(g4Var.container, g4Var.resourcesProvider, g4Var.c0, false, true, false);
        w70Var.t = false;
        w70Var.Y = true;
        w70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        w70Var.R = true;
        w70Var.p = new hi.i(w70Var, 6);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(u3Var.g);
        Collections.sort(arrayList, new z3(f4Var, 0));
        int i10 = 1;
        c4 c4Var = new c4(context, g4Var.currentAccount, 0, false, new v3(strArr, f4Var, arrayList, i10), new w3(f4Var, w70Var, i10), null, g4Var.resourcesProvider);
        c4Var.Y2.r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        fuVar.setBackground(null);
        frameLayout.addView(fuVar, a6.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        fuVar.addTextChangedListener(new og.x(strArr, c4Var, false, 12));
        if (arrayList.size() > 8) {
            w70Var.r(frameLayout, a6.n(-1, 44));
            w70Var.k();
        }
    ...
    public final void Z() {
        ...
        while (true) {
            ...
            if ((childAt instanceof a10) && (R = RecyclerView.R(childAt) - 1) >= 0 && (G = this.i0.G(R)) != null) {
                if (G.d < 10) {
                    z10 = true;
                } else {
                    z11 = true;
