...
public final class w extends sa {
    ...
    public w(int i10, Context context, Utilities.Callback callback, g6 g6Var) {
        ...
        e6.a(imageView);
        final int i13 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: wh.u
            ...
            public final void onClick(View view) {
                switch (i13) {
                    ...
                    default:
                        w wVar = this.b;
                        org.telegram.ui.Cells.i3 i3Var = wVar.b0;
                        if (!wVar.d0) {
                            ...
                            if (richMessage == null) {
                                ...
                                if (!TextUtils.isEmpty(trim)) {
                                    ...
                                    wVar.e0 = ConnectionsManager.getInstance(wVar.U).sendRequest(tL_messages_composeRichMessageWithAI, new gf.a(wVar, 28));
        ...
        int i14 = k6.d6;
        previewView.setBackground(k6.b0(dp, k6.v0(i14, g6Var)));
        ...
        g3Var.setMaxLines(5);
        i3Var.setBackground(k6.b0(AndroidUtilities.dp(20.0f), k6.v0(i14, g6Var)));
        ...
        final int i15 = 1;
        p10.setOnClickListener(new View.OnClickListener(this) { // from class: wh.u
            public final /* synthetic */ w b;
            ...
            public final void onClick(View view) {
                switch (i15) {
                    ...
                    default:
                        w wVar = this.b;
                        org.telegram.ui.Cells.i3 i3Var2 = wVar.b0;
                        if (!wVar.d0) {
                            TL_iv.RichMessage richMessage = wVar.f0;
                            if (richMessage == null) {
    ...
    public final void P() {
        TL_iv.RichMessage richMessage = this.f0;
        qh.d dVar = this.c0;
        if (richMessage != null) {
            dVar.setEnabled(true);
        } else {
            dVar.setEnabled(!TextUtils.isEmpty(this.b0.b.getText().toString().trim()));
        }
    }
    ...
    public final void dismiss() {
        if (this.e0 != 0) {
            ConnectionsManager.getInstance(this.U).cancelRequest(this.e0, true);
            this.e0 = 0;
        }
        AndroidUtilities.hideKeyboard(this.b0.b);
        super.dismiss();
    }
