            ...
            if (xnVar == null || !(view instanceof xa)) {
                if (view instanceof t1) {
                    ...
                    if (mVar2.v == 0 && mVar2.t == 0 && mVar2.u == 0 && mVar2.s == 0) {
                        ...
                        ofFloat3.addUpdateListener(new r(mVar2, s1Var, t1Var, 4));
                        z10 = false;
                    ...
                    if (mVar2.j) {
                        ...
                        final sl0 sl0Var2 = (sl0) view.getParent();
    ...
    public final void m() {
        ...
        if (z20) {
            ...
            while (i17 < arrayList9.size()) {
                if (this.Q) {
                    i17 = ((l1) arrayList9.get(i17)).c() != (sl0Var.getAdapter() == null ? 0 : sl0Var.getAdapter().h()) - 1 ? i17 + 1 : 0;
                    z4 = true;
                } else {
                                        ...
                                        if (z19) {
                                            if (t1Var2.getMessageObject().isVoice()) {
                                                if (Math.abs(view2.getTranslationY()) < view2.getMeasuredHeight() * 3.0f) {
                                                    new di1(t1Var2, xnVar2.V, this.G, xnVar2.J9, this.R).f.start();
                                                }
                                            } else if (SharedConfig.getDevicePerformanceClass() != 0 && Math.abs(view2.getTranslationY()) < sl0Var.getMeasuredHeight()) {
                                                xnVar = xnVar2;
                                                ValueAnimator valueAnimator = new qa1(t1Var2, xnVar2, this.G, xnVar2.J9, this.R).d;
                                                ...
                                                if (runnable != null) {
                                                    ...
                                                    jkVar2.c0.run();
                                                    jkVar2.c0 = null;
                                                    animate.translationY(0.0f).setDuration(250L).setInterpolator(this.o).setListener(new vs((f2.l) this, l1Var, (Object) view2, (Object) animate, 5)).start();
                                                    i18 = i18;
                                                    i21 = i22;
                                                    size4 = i16;
                                                    f11 = 1.0f;
                ...
                if (z21) {
                    ...
                    while (i23 < arrayList6.size()) {
                        ...
                        if (arrayList16.contains(l1Var2)) {
                            ...
                            View view4 = l1Var2.a;
                            z17 = isEmpty11;
                            if ((view4 instanceof t1) && ((t1) view4).getCurrentMessagesGroup() != null && (messageObject = ((t1) l1Var2.a).getMessageObject()) != null && messageObject.getGroupId() != 0) {
                    ...
                    if (longSparseArray != null) {
                        ...
                        while (i24 < longSparseArray.size()) {
                            ...
                            if (arrayList19.size() > 0) {
                                ...
                                if (!(view5 instanceof t1) || (currentMessagesGroup = ((t1) view5).getCurrentMessagesGroup()) == null || currentMessagesGroup.messages.size() <= arrayList19.size()) {
                                    ...
                                    y01 y01Var = a11Var.a;
                                    if (y01Var != null) {
                                        y01Var.f(arrayList20, h1Var);
                                        Choreographer.getInstance().postFrameCallback(a11Var.b);
                                    } else {
                                        a11Var.c.add(new z01(arrayList20, h1Var));
                                    }
                        ...
                        while (true) {
                            ...
                            if (!z23 || (ugVar = this.U) == null) {
                                ...
                                a11 a11Var2 = (a11) ugVar.run();
                                i13 = i27;
                                h1 h1Var2 = new h1(this, view6, l1Var3, 15);
                                y01 y01Var2 = a11Var2.a;
                                if (y01Var2 != null) {
                                    y01Var2.e(view6, 1.0f, h1Var2);
                                    Choreographer.getInstance().postFrameCallback(a11Var2.b);
                                } else {
                                    a11Var2.c.add(new z01(view6, h1Var2));
                                }
                        ...
                        if (!z11) {
                            ...
                            arrayList8.clear();
                            yy yyVar = new yy(10, this, arrayList22);
                            if (!this.C || isEmpty9) {
                                yyVar.run();
                            } else {
                                View view8 = ((f2.j) arrayList22.get(0)).a.a;
                                WeakHashMap weakHashMap2 = j0.a;
                                view8.postOnAnimationDelayed(yyVar, 0L);
                            }
                        }
                        if (!isEmpty12) {
                            ...
                            arrayList9.clear();
                            Collections.sort(arrayList23, new cu(25));
                            ...
                            while (i28 < size5) {
                                ...
                                long max = (long) ((1.0f - Math.max(f10, Math.min(1.0f, view9.getBottom() / sl0Var.getMeasuredHeight()))) * 100.0f);
                                if (!(view9 instanceof t1)) {
                                    i11 = size5;
                                } else if (l1Var4 == this.O) {
                                    fo foVar = this.P;
                                    if (foVar != null) {
                                        foVar.h.setAlpha(0.0f);
                                    }
                                    sl0Var.setClipChildren(false);
                                    ...
                                    float x11 = t1Var4.getX() + sl0Var.getX() + t1Var4.getPhotoImage().getImageX();
                                    float y11 = t1Var4.getY() + sl0Var.getY() + t1Var4.getPhotoImage().getImageY();
        ...
        if (t1Var != null) {
            ...
            if (currentMessagesGroup != null) {
                ...
                if (arrayList.contains(currentMessagesGroup)) {
                    ...
                    int i26 = 0;
                    int i27 = 0;
                    while (i23 < sl0Var2.getChildCount()) {
                        View childAt = sl0Var2.getChildAt(i23);
                        if (childAt instanceof t1) {
