...
public abstract class n extends f2.l {
    ...
    */
    public final void T(final l1 l1Var, f2.k kVar, boolean z4) {
        l1 l1Var2;
        r1 r1Var;
        s1 s1Var;
        int i10;
        ...
        if (znVar != null && (view instanceof h0)) {
            ...
            if (znVar == null || !(view instanceof wa)) {
                if (view instanceof s1) {
                    final s1 s1Var3 = (s1) view;
                    final r1 transitionParams = s1Var3.getTransitionParams();
                    animatorSet.playTogether(ObjectAnimator.ofFloat(s1Var3, s1Var3.xe, 0.0f));
                    if (mVar2.n) {
                        s1Var3.U3(mVar2.o, mVar2.p, mVar2.q, mVar2.r);
                        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
                        float f12 = s1Var3.getCurrentMessagesGroup() == null ? transitionParams.u0 : s1Var3.getCurrentMessagesGroup().transitionParams.captionEnterProgress;
                        ...
                        i10 = 2;
                        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: wh.a
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ...
                                float f16 = (r1Var4.m0 * floatValue) + f15;
                                float f17 = (r1Var4.n0 * floatValue) + (mVar3.p * f14);
                                float f18 = (r1Var4.o0 * floatValue) + (mVar3.q * f14);
                                float f19 = (r1Var4.p0 * floatValue) + (mVar3.r * f14);
                                boolean z12 = z11;
                                s1 s1Var4 = s1Var3;
                                if (z12) {
                                    ...
                                    if (s1Var4.getCurrentMessagesGroup() != null) {
                                        s1Var4.getCurrentMessagesGroup().transitionParams.captionEnterProgress = f20;
                                    }
                                }
                                if (r1Var4.B0) {
                    ...
                    if (mVar2.v == 0 && mVar2.t == 0 && mVar2.u == 0 && mVar2.s == 0) {
                        ...
                        if (mVar2.l) {
                            ...
                            r1Var.k0 = (-mVar2.s) - s1Var.getAnimationOffsetX();
                            r1Var.l0 = (-mVar2.t) - s1Var.getAnimationOffsetX();
                        }
                        ofFloat3.addUpdateListener(new r(mVar2, r1Var, s1Var, 4));
                        z10 = false;
                    ...
                    if (mVar2.j) {
                        ...
                        final rl0 rl0Var2 = (rl0) view.getParent();
                        ...
                        mVar = mVar2;
                        s1Var2 = s1Var;
                        ofFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: wh.b
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                m mVar3 = mVar;
                    ...
                    if (mVar.k) {
                        ...
                        r1Var3 = r1Var2;
                        ofFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: wh.c
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i11) {
                                    case 0:
                    ...
                    if (mVar.m) {
                        ...
                        r1Var3.g = true;
                        ofFloat6.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: wh.c
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i16) {
                                    case 0:
                ...
                animatorSet.addListener(new j(this, l1Var2, i14, view));
                animatorSet.start();
                this.J.put(l1Var2, animatorSet);
            }
            wa waVar = (wa) view;
            float translationY2 = waVar.getTranslationY();
            ValueAnimator ofFloat8 = ValueAnimator.ofFloat(0.0f, 1.0f);
            ofFloat8.addUpdateListener(new h(this, waVar, translationY2, i16));
        ...
        if (a2 && this.N) {
            ...
            if (z4) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    i10 += ((l1) arrayList.get(i12)).a.getHeight();
                }
            } else {
                i10 = 0;
            }
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                ((l1) arrayList.get(i13)).a.setTranslationY(i10);
            }
        }
        return a2;
    }
    ...
    */
    public final void m() {
        ...
        if (z20) {
            ...
            while (i17 < arrayList9.size()) {
                if (this.Q) {
                    i17 = ((l1) arrayList9.get(i17)).c() != (rl0Var.getAdapter() == null ? 0 : rl0Var.getAdapter().h()) - 1 ? i17 + 1 : 0;
                    z4 = true;
                } else {
                    if (((l1) arrayList9.get(i17)).c() != 0) {
                    }
                    z4 = true;
                }
            }
        ...
        if (z4) {
            ...
            if (!isEmpty5 || !isEmpty6 || !isEmpty8 || !isEmpty7) {
                ...
                if (!isEmpty8) {
                    ...
                    while (i21 < size4) {
                        int i22 = i21 + 1;
                        l1 l1Var = (l1) arrayList12.get(i21);
                        View view2 = l1Var.a;
                        ViewPropertyAnimator animate = view2.animate();
                        arrayList10.add(l1Var);
                        ...
                        zn znVar2 = this.F;
                        if (znVar2 != null) {
                            ArrayList arrayList13 = znVar2.r4;
                            if (s1Var2 != null && arrayList13.contains(s1Var2.getMessageObject())) {
                                arrayList13.remove(s1Var2.getMessageObject());
                                lk lkVar = znVar2.V;
                                if (lkVar.c0 == null || !((cfVar = lkVar.I0) == null || cfVar.n0)) {
                                    i16 = size4;
                                } else {
                                    i16 = size4;
                                    if (System.currentTimeMillis() - lkVar.J0 > 300) {
                                        z19 = true;
                                        lkVar.J0 = -1L;
                                        if (z19) {
                                            if (s1Var2.getMessageObject().isVoice()) {
                                                if (Math.abs(view2.getTranslationY()) < view2.getMeasuredHeight() * 3.0f) {
                                                    new li1(s1Var2, znVar2.V, this.G, znVar2.J9, this.R).f.start();
                                                }
                                            } else if (SharedConfig.getDevicePerformanceClass() != 0 && Math.abs(view2.getTranslationY()) < rl0Var.getMeasuredHeight()) {
                                                znVar = znVar2;
                                                ValueAnimator valueAnimator = new ya1(s1Var2, znVar2, this.G, znVar2.J9, this.R).d;
                                                ...
                                                if (runnable != null) {
                                                    ...
                                                    lkVar2.c0.run();
                                                    lkVar2.c0 = null;
                                                    animate.translationY(0.0f).setDuration(250L).setInterpolator(this.o).setListener(new us((f2.l) this, l1Var, (Object) view2, (Object) animate, 5)).start();
                                                    i18 = i18;
                                                    i21 = i22;
                                                    size4 = i16;
                                                    f11 = 1.0f;
            ...
            if (!isEmpty9 || !isEmpty10 || !isEmpty12 || !isEmpty11) {
                boolean z21 = (this.U == null || (wgVar2 = this.T) == null || !((Boolean) wgVar2.run()).booleanValue()) ? false : true;
                ...
                if (z21) {
                    ...
                    while (i23 < arrayList6.size()) {
                        ...
                        if (arrayList16.contains(l1Var2)) {
                            z16 = isEmpty10;
                            View view4 = l1Var2.a;
                            z17 = isEmpty11;
                            if ((view4 instanceof s1) && ((s1) view4).getCurrentMessagesGroup() != null && (messageObject = ((s1) l1Var2.a).getMessageObject()) != null && messageObject.getGroupId() != 0) {
                                ...
                                arrayList16.remove(l1Var2);
                                arrayList6.remove(i23);
                                i23--;
                                arrayList17.add(l1Var2);
                                i23++;
                                z21 = z18;
                                isEmpty10 = z16;
                                isEmpty11 = z17;
                    ...
                    if (longSparseArray != null) {
                        ...
                        while (i24 < longSparseArray.size()) {
                            ...
                            if (arrayList19.size() > 0) {
                                View view5 = ((l1) arrayList19.get(0)).a;
                                if (!(view5 instanceof s1) || (currentMessagesGroup = ((s1) view5).getCurrentMessagesGroup()) == null || currentMessagesGroup.messages.size() <= arrayList19.size()) {
                                    ...
                                    a11 a11Var = (a11) this.U.run();
                                    for (int i25 = 0; i25 < arrayList19.size(); i25++) {
                                    }
                                    ArrayList arrayList20 = new ArrayList();
                                    i14 = i24;
                                    for (int i26 = 0; i26 < arrayList19.size(); i26++) {
                                        arrayList20.add(((l1) arrayList19.get(i26)).a);
                                    }
                                    k1 k1Var = new k1(this, arrayList20, arrayList19, 13);
                                    y01 y01Var = a11Var.a;
                                    if (y01Var != null) {
                                        y01Var.f(arrayList20, k1Var);
                                        Choreographer.getInstance().postFrameCallback(a11Var.b);
                                    } else {
                                        a11Var.c.add(new z01(arrayList20, k1Var));
                                    }
                        ...
                        while (true) {
                            ...
                            int i27 = i10 + 1;
                            l1 l1Var3 = (l1) obj3;
                            boolean z23 = arrayList16.remove(l1Var3) && z12;
                            if (BuildVars.LOGS_ENABLED) {
                            ...
                            View view6 = l1Var3.a;
                            arrayList15.add(l1Var3);
                            if (!z23 || (wgVar = this.U) == null) {
                                i13 = i27;
                                z15 = z12;
                                ...
                                ofFloat.addListener(new g(this, view6, l1Var3));
                                hashMap.put(l1Var3, ofFloat);
                                ofFloat.start();
                            } else {
                                a11 a11Var2 = (a11) wgVar.run();
                                i13 = i27;
                                k1 k1Var2 = new k1(this, view6, l1Var3, 14);
                                y01 y01Var2 = a11Var2.a;
                                if (y01Var2 != null) {
                                    y01Var2.e(view6, 1.0f, k1Var2);
                                    Choreographer.getInstance().postFrameCallback(a11Var2.b);
                                } else {
                                    a11Var2.c.add(new z01(view6, k1Var2));
                                }
                        ...
                        if (!z10) {
                            ...
                            arrayList7.clear();
                            kc.j jVar = new kc.j(this, arrayList21, z22, 2);
                            if (!this.C || isEmpty9) {
                                jVar.run();
                            } else {
                                View view7 = ((f2.k) arrayList21.get(0)).a.a;
                                WeakHashMap weakHashMap = j0.a;
                                view7.postOnAnimationDelayed(jVar, 0L);
                            }
                        }
                        if (!z11) {
                            ...
                            arrayList8.clear();
                            az azVar = new az(10, this, arrayList22);
                            if (!this.C || isEmpty9) {
                                azVar.run();
                            } else {
                                View view8 = ((f2.j) arrayList22.get(0)).a.a;
                                WeakHashMap weakHashMap2 = j0.a;
                                view8.postOnAnimationDelayed(azVar, 0L);
                            }
                        }
                        if (!isEmpty12) {
                            ...
                            arrayList9.clear();
                            Collections.sort(arrayList23, new eu(25));
                            int size5 = arrayList23.size();
                            int i28 = 0;
                            while (i28 < size5) {
                                int i29 = i28 + 1;
                                l1 l1Var4 = (l1) arrayList23.get(i28);
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.d("animate add impl");
                                }
                                View view9 = l1Var4.a;
                                ArrayList arrayList24 = arrayList;
                                arrayList24.add(l1Var4);
                                if (l1Var4 == this.O) {
                                    view9.setAlpha(1.0f);
                                }
                                AnimatorSet animatorSet = new AnimatorSet();
                                ...
                                long max = (long) ((1.0f - Math.max(f10, Math.min(1.0f, view9.getBottom() / rl0Var.getMeasuredHeight()))) * 100.0f);
                                if (!(view9 instanceof s1)) {
                                    i11 = size5;
                                } else if (l1Var4 == this.O) {
                                    eo eoVar = this.P;
                                    if (eoVar != null) {
                                        eoVar.h.setAlpha(0.0f);
                                    }
                                    rl0Var.setClipChildren(false);
                                    ...
                                    float x11 = s1Var4.getX() + rl0Var.getX() + s1Var4.getPhotoImage().getImageX();
                                    float y11 = s1Var4.getY() + rl0Var.getY() + s1Var4.getPhotoImage().getImageY();
                                    ...
                                    ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
                                    ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: wh.e
                                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                    ...
                                    i11 = size5;
                                    ofFloat2.addListener(new f(this, s1Var4, imageX, imageY, imageWidth, imageHeight));
                                    ...
                                    animatorSet.addListener(new g(this, l1Var4, view9));
                                    hashMap.put(l1Var4, animatorSet);
                                    animatorSet.start();
                                    i28 = i29;
        ...
        ofFloat3.addUpdateListener(new e5(this, 27));
    ...
    public final boolean q(l1 l1Var, l1 l1Var2, c5.e eVar, int i10, int i11, int i12, int i13) {
        ...
        view2.setAlpha(0.0f);
        this.s.add(new f2.j(l1Var, l1Var2, i10, i11, i12, i13));
        F();
        return true;
    }
    ...
    public final boolean r(l1 l1Var, c5.e eVar, int i10, int i11, int i12, int i13) {
        ...
        v0 v0Var2 = v0Var;
        float f17 = f12;
        m mVar = new m(l1Var, i17, translationY, i12, i13);
        if (s1Var != null) {
            ...
            if (z10) {
                ...
                if (z11) {
                    ...
                    if (f18 == f19 && transitionParams.n0 == lVar.d && transitionParams.p0 == lVar.f && transitionParams.o0 == lVar.e && !transitionParams.B0) {
                        ...
                        s1Var.U3(mVar.o, mVar.p, mVar.q, mVar.r);
                    }
                }
                if (currentMessagesGroup == null && transitionParams.v0 && (((isOutOwner = s1Var.getMessageObject().isOutOwner()) && rect.left != s1Var.getBackgroundDrawableLeft()) || ((!isOutOwner && rect.right != s1Var.getBackgroundDrawableRight()) || rect.top != s1Var.getBackgroundDrawableTop() || rect.bottom != s1Var.getBackgroundDrawableBottom()))) {
                    mVar.v = s1Var.getBackgroundDrawableBottom() - rect.bottom;
                    mVar.u = s1Var.getBackgroundDrawableTop() - rect.top;
                    if (s1Var.D8 != transitionParams.E0) {
                        mVar.s = s1Var.getBackgroundDrawableLeft() - rect.left;
                        mVar.t = s1Var.getBackgroundDrawableRight() - rect.right;
                    } else if (isOutOwner) {
                        mVar.s = s1Var.getBackgroundDrawableLeft() - rect.left;
                    } else {
                        mVar.t = s1Var.getBackgroundDrawableRight() - rect.right;
            ...
            if (currentMessagesGroup != null) {
                ...
                if (arrayList.contains(currentMessagesGroup)) {
                    ...
                    int i26 = 0;
                    int i27 = 0;
                    while (i23 < rl0Var2.getChildCount()) {
                        View childAt = rl0Var2.getChildAt(i23);
                        if (childAt instanceof s1) {
            ...
            if (groupedMessages2 != null) {
                ...
                if (transitionParams.v0) {
                    ...
                    transitionParams.h0 = (int) ((-mVar.t) - s1Var.getAnimationOffsetX());
                    transitionParams.j0 = (int) ((-mVar.u) - s1Var.getTranslationY());
                    transitionParams.i0 = (int) ((-mVar.v) - s1Var.getTranslationY());
            ...
            if (transitionParams.y0 != (s1Var.h8 || s1Var.G || (groupedMessagePosition != null && (groupedMessagePosition.flags & 8) == 0 && s1Var.H.isDocuments))) {
                z4 = true;
                mVar.k = true;
                f15 = 0.0f;
    ...
    public final void s(l1 l1Var, c5.e eVar) {
        ...
        if (eVar != null) {
            ...
            if (eVar instanceof l) {
                l lVar = (l) eVar;
                s1Var.U3(lVar.c, lVar.d, lVar.e, lVar.f);
            }
        }
    }
}
