...
public abstract class x3 {
    ...
    */
    ...
    public static void F(StringBuilder sb, List list, int[] iArr, int i10, int i11, int i12, int i13, int i14, oh.h4 h4Var, boolean z4, int i15, Map map) {
        ...
        oh.h4 h4Var2 = h4Var;
        int i18 = i15;
        ArrayList arrayList = (ArrayList) h4Var2.b;
        while (true) {
            int i19 = iArr[0];
            if (i19 > i17) {
                return;
                ...
                if (aVar.k.size() > i18) {
                    ...
                    if (r3.x3(aVar)) {
                        ...
                        if (aVar.c <= 0 || l(aVar.b) == null) {
                            ...
                            if (!arrayList.isEmpty() && ((Boolean) l.d.i(1, arrayList)).booleanValue() != z11) {
                                h4Var2.a0(sb2);
                    ...
                    if (str.charAt(i12) != '<') {
                        ...
                        if (!substring.isEmpty()) {
                            ...
                            if (arrayList3.isEmpty()) {
                                ...
                                ((w3) l.d.i(1, arrayList3)).e.add(w3Var);
                            }
                        }
                        ...
                        if (i13 >= 0) {
                            ...
                            if (!trim.isEmpty()) {
                                int i14 = 0;
                                while (i14 < trim.length() && !n8.a(trim.charAt(i14))) {
                                    i14++;
                                }
                                ...
                                if (!lowerCase.isEmpty()) {
                                    ...
                                    while (i14 < trim.length()) {
                                        ...
                                        if (i14 < trim.length()) {
                                            int i15 = i14;
                                            while (i15 < trim.length() && trim.charAt(i15) != '=' && !n8.a(trim.charAt(i15))) {
                                                i15++;
                                            }
                                            String lowerCase2 = trim.substring(i14, i15).toLowerCase();
                                            while (i15 < trim.length() && n8.a(trim.charAt(i15))) {
                                                i15++;
                                            }
                                            if (i15 >= trim.length() || trim.charAt(i15) != '=') {
                                                ...
                                                do {
                                                    ...
                                                    if (i15 < trim.length() || !(trim.charAt(i15) == '\"' || trim.charAt(i15) == c3)) {
                                                        i11 = i15;
                                                        while (i11 < trim.length() && !n8.a(trim.charAt(i11))) {
                                                            i11++;
                                                        }
                            ...
                            if (w3Var2 != null) {
                                if (arrayList3.isEmpty()) {
                                    ...
                                    ((w3) l.d.i(1, arrayList3)).e.add(w3Var2);
                                }
                                if (!endsWith) {
                            ...
                            if (!substring3.isEmpty()) {
                                ...
                                if (arrayList3.isEmpty()) {
                                    ...
                                    ((w3) l.d.i(1, arrayList3)).e.add(w3Var3);
                                }
                            }
                        }
                    } else {
