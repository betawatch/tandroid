...
public final class l0 extends Drawable {
    ...
    public final void a() {
        if (this.a == null) {
            ...
            this.a = j7.a(createBitmap, new Rect((intrinsicWidth * 27) / 168, i10, (intrinsicWidth * 5) / 168, i10), (intrinsicWidth * 94) / 168, (intrinsicHeight * 71) / 144);
        }
        if (this.b == null) {
            ...
            this.b = j7.a(createBitmap2, new Rect((intrinsicWidth2 * 27) / 168, i11, (intrinsicWidth2 * 5) / 168, i11), (intrinsicWidth2 * 94) / 168, (intrinsicHeight2 * 71) / 144);
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        int i11 = this.g;
        int i12 = this.f;
        xf.p.g(ninePatchDrawable, i10 + (z10 ? i11 + i12 : 0), bounds.top, bounds.right, bounds.bottom);
        this.a.draw(canvas);
        xf.p.g(this.b, bounds.left + (this.l ? i11 + i12 : 0), bounds.top, bounds.right, bounds.bottom);
        this.b.draw(canvas);
        if (this.n != null) {
            canvas.save();
