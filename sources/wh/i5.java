...
public final class i5 extends z implements b6, l9 {
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (m9 != null && (layout = (e1Var = m9.a).getLayout()) != null) {
                ...
                h5 h5Var = this.w;
                arrayList.add(new e5(layout, e1Var.getPaddingLeft() + e1Var.getLeft() + m9.getLeft() + ((k5Var.getLeft() + (h5Var.getLeft() + left)) - g2Var.getScrollX()), e1Var.getPaddingTop() + e1Var.getTop() + m9.getTop() + k5Var.getTop() + h5Var.getTop() + g2Var.getTop(), this.C.b(pagetablecell) + 10, pagetablecell));
            }
        }
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        e1Var.layout(AndroidUtilities.dp(16.0f) + i17, i18, l.d.c(16.0f, i19, AndroidUtilities.dp(16.0f) + i17), i20);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i14 = 0;
        int max = Math.max(0, (size - this.c) - l8.d(this.a));
