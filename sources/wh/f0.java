...
public final class f0 extends z implements b6 {
    ...
    public f0(Context context, int i10, g6 g6Var) {
        ...
        final int i11 = 0;
        u1Var.setOnClickListener(new View.OnClickListener(this) { // from class: wh.b0
        ...
        final int i12 = 1;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: wh.b0
            public final /* synthetic */ f0 b;
    ...
    */
        ...
        if (aVar != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockButtonRow) {
                ...
                while (i10 < size) {
                    ...
                    linearLayout.addView(c0Var, c6.t(-2, -1, 16, i10 == 0 ? 0 : 7, 0, 0, 0));
                    i10++;
                }
                boolean z4 = size >= 8;
    ...
    public final void j() {
        ...
        int v = k6.v(k6.v0(k6.d6, g6Var), k6.l1(0.1f, v02));
