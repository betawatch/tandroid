...
public final class h extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (aVarArr[0] == null) {
            ...
            i10 = 128;
            jVar.a(new Canvas((Bitmap) aVarArr[0].b), new Rect(0, 0, i11, i11));
            jVar.g.setShader((BitmapShader) aVarArr[0].c);
    ...
    public final void e(Path path) {
        path.addCircle(this.k, this.l, w7.p.a(this.n, 0.0f, 1.0f) * this.m, Path.Direction.CW);
    }
    ...
    public final void j(float f7, float f10, float f11, boolean z10) {
        ...
        ValueAnimator duration = ValueAnimator.ofFloat(this.n, z10 ? 0.0f : 1.0f).setDuration((long) w7.p.a(this.m * 0.3f, 250.0f, 550.0f));
        this.r = duration;
        duration.setInterpolator(this.t);
        this.r.addUpdateListener(new q2(this, alpha, 6));
        this.r.addListener(new oj1(this, 10));
        this.r.start();
        invalidateSelf();
    }
