...
public class p extends TextView implements z9 {
    ...
    public final void b() {
        ...
        if (getLayout() != null && (getText() instanceof Spanned)) {
            ...
            h.a(this, getLayout(), 0, measuredWidth > 0 ? measuredWidth : -2, (Spanned) getText(), stack, arrayList, null);
        }
        invalidate();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        boolean z10 = ((h) arrayList.get(0)).n != -1.0f;
        if (z10) {
            canvas2 = canvas;
    ...
    public p(Context context, f6 f6Var, boolean z10) {
        ...
        this.s = new a90(this);
        this.v = f6Var;
        this.a = new m(this, arrayList, new bi.h(11, this, z10));
    }
