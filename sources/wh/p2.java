...
public final class p2 extends org.telegram.ui.ActionBar.h3 {
    ...
    public p2(Context context, long j3, TL_stars.SavedStarGift savedStarGift, f6 f6Var, Utilities.Callback0Return callback0Return) {
        ...
        TextView b11 = e6.b(context, 14.0f, j6.y6, false, f6Var);
        ...
        o2 o2Var = new o2(context, this.currentAccount, 0, false, new k6(20, this, G), new sg.f0(7, this, dVar), null, f6Var);
        o2Var.setSpanCount(3);
        o2Var.setOverScrollMode(2);
        o2Var.setScrollEnabled(false);
        linearLayout.addView(o2Var, a6.k(11.0f, 0.0f, 11.0f, 0.0f, -1, -2));
