...
public final class w6 extends FrameLayout {
    ...
    public w6(Activity activity, int i10, ai.d dVar) {
        ...
        v7Var.addView(b6Var, w7.x5.d(-1, -2.0f, 55, 0.0f, 17.0f, 0.0f, 0.0f));
        ...
        v7Var.addView(imageView, w7.x5.d(40, 40.0f, 53, 12.0f, 15.0f, 12.0f, 0.0f));
        addView(v7Var, w7.x5.c(-2.0f, -1));
    ...
    public final void b(CharSequence charSequence) {
        this.e.b0.b(org.telegram.ui.Components.x5.cloneSpans(new SpannableString(charSequence)), null, null, false, false);
    }
