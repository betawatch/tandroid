...
public abstract class m extends FrameLayout {
    ...
    public m(Context context, FrameLayout frameLayout, bw0 bw0Var, FrameLayout frameLayout2, org.telegram.ui.ActionBar.e6 e6Var, org.telegram.ui.Components.ja jaVar) {
        super(context);
        ah.m mVar = new ah.m();
        this.c = mVar;
        ah.m mVar2 = new ah.m();
        ...
        qr qrVar = qr.h;
        this.v0 = new org.telegram.ui.Components.e6(this, 0L, 300L, qrVar);
        this.y0 = false;
        this.z0 = new RectF();
        this.A0 = new RectF();
        this.B0 = new RectF();
        this.J0 = new Path();
        this.M0 = new org.telegram.ui.Components.e6(this, 500L, qrVar);
        this.a = e6Var;
        this.J = frameLayout;
        this.K = bw0Var;
        this.b = frameLayout2;
        ...
        mVar.a(new f(e6Var, i10, 0.0f, 0));
        mVar.g.setColor(0);
        mVar.invalidateSelf();
        mVar2.j = true;
        mVar2.a(new f(e6Var, i10, 0.0f, 1));
        mVar2.g.setColor(0);
        mVar2.invalidateSelf();
        paint.setColor(TLObject.FLAG_31);
        this.L = new j4(frameLayout, false, new ai.y1(this, 5));
        g gVar = new g(this, context, bw0Var, getEditTextStyle(), new ai.d(), e6Var, jaVar);
        this.f = gVar;
        gVar.S = true;
        ...
        pq pqVar = new pq(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.zf, e6Var)), mutate, 0, AndroidUtilities.dp(1.0f));
        this.n = pqVar;
    ...
    */
    ...
    public void x(int i10) {
        ...
        int max = Math.max(0, i10 - (bw0Var == null ? 0 : bw0Var.getBottomPadding()));
