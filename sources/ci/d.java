...
public class d extends FrameLayout implements o90 {
    public boolean E;
    public int F;
    public ai.ba G;
    public float H;
    ...
    public final void j() {
        ...
        if (z10) {
            ...
            int l1 = org.telegram.ui.ActionBar.j6.l1(0.1f, o6Var.a.getColor());
            int i11 = this.b;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.L) {
            if (this.N) {
                if (this.K == null) {
                    ...
                    this.K = p90Var;
                    p90Var.setCallback(this);
                    p90 p90Var2 = this.K;
                    p90Var2.t = 2.0f;
                    p90Var2.C = true;
                    p90Var2.w.setStrokeWidth(0.0f);
                    this.K.e(org.telegram.ui.ActionBar.j6.l1(0.02f, -1), org.telegram.ui.ActionBar.j6.l1(0.375f, -1));
                }
                p90 p90Var3 = this.K;
                p90Var3.c = -1L;
                p90Var3.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
                this.K.j(this.b);
                this.K.draw(canvas);
            } else {
                p90 p90Var4 = this.K;
        ...
        if (f10 > 0.0f) {
            if (this.b0 == null) {
                this.b0 = new tp(o6Var.a.getColor());
            }
        ...
        if (f11 < 1.0f) {
            ...
            rect.set((int) (((getMeasuredWidth() - a2) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - o6Var.e) / 2.0f) - AndroidUtilities.dp(1.0f)), (int) org.telegram.messenger.q.b(getMeasuredWidth() - a2, getWidth(), 2.0f, d), (int) (((getMeasuredHeight() + o6Var.e) / 2.0f) - AndroidUtilities.dp(1.0f)));
            ...
            if (this.J) {
                ...
                a2 = o6Var3.d();
                rect.set((int) (((getMeasuredWidth() - a2) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - o6Var3.e) / 2.0f) - AndroidUtilities.dp(1.0f)), (int) org.telegram.messenger.q.b(getMeasuredWidth() - a2, getWidth(), 2.0f, a2), (int) (((getMeasuredHeight() + o6Var3.e) / 2.0f) - AndroidUtilities.dp(1.0f)));
                ...
                o6Var3.w = (int) (AndroidUtilities.lerp(0.5f, 1.0f, this.V) * (1.0f - this.M) * 200.0f * this.H);
                o6Var3.setBounds(rect);
                o6Var3.draw(canvas);
                canvas.restore();
            }
            rect.set((int) (com.google.android.gms.internal.vision.e2.A(getMeasuredWidth(), a2, 2.0f, d) + AndroidUtilities.dp(this.E ? 5.0f : 2.0f)), (int) ((getMeasuredHeight() - AndroidUtilities.dp(18.0f)) / 2.0f), (int) (Math.max(AndroidUtilities.dp(9.0f), o6Var2.d() + dp2) + com.google.android.gms.internal.vision.e2.A(getMeasuredWidth(), a2, 2.0f, d) + AndroidUtilities.dp((this.E ? 5 : 2) + 8)), (int) ((AndroidUtilities.dp(18.0f) + getMeasuredHeight()) / 2.0f));
            ...
            float A = org.telegram.messenger.q.A(1.0f, this.M, this.c0, d10);
            if (this.E) {
                f7 = 1.0f;
            }
            o6Var2.w = (int) (A * f7);
    ...
    public void setCountFilled(boolean z10) {
        ...
        org.telegram.ui.Components.o6 o6Var = this.f;
        o6Var.t(dp);
        o6Var.r(this.E ? this.y : this.d.a.getColor());
    }
    ...
    public d(Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        this.b = 8;
        qr qrVar = qr.h;
        this.n = new org.telegram.ui.Components.e6(350L, qrVar);
        this.E = true;
        this.F = 0;
        this.H = 0.0f;
        this.M = 0.0f;
        ...
        this.c = paint;
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Sh, e6Var));
