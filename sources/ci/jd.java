...
public final /* synthetic */ class jd implements Runnable {
    ...
    public final void run() {
        ...
        iArr[0] = this.f.sendRequest(tL_messages_getInlineBotResults, new RequestDelegate() { // from class: ci.gd
            ...
            public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: ci.fd
                    @Override // java.lang.Runnable
                    public final void run() {
                        iArr2[0] = 0;
