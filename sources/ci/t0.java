...
public final class t0 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d = this.F.d(this.E ? 1.0f : 0.0f, false);
        float d10 = this.I.d(this.G ? 0.0f : 1.0f, false);
        float f11 = 1.0f - d10;
        Paint paint = this.a;
        paint.setAlpha((int) (90.0f * f11 * d));
    ...
    public t0(Context context, String str) {
        ...
        this.E = false;
        this.F = new org.telegram.ui.Components.d6(0.0f, this, 0L, 350L, qr.h);
        this.G = true;
        this.H = 0.0f;
