...
public final /* synthetic */ class u1 implements Runnable {
    ...
    public final void run() {
        ...
        switch (i18) {
            ...
            case 2:
                ...
                break;
            case 3:
                ii.j4.f((org.telegram.ui.ActionBar.o2) obj5, (Context) obj3, (org.telegram.ui.ActionBar.f6) obj2, (ii.t3) obj4, z11);
                break;
            case 4:
                ((FactCheckController) obj5).lambda$applyFactCheck$15((TLObject) obj3, (TLRPC.TL_textWithEntities) obj2, z11, (org.telegram.ui.ActionBar.c2) obj4);
                break;
            case 5:
                ((MediaDataController) obj5).lambda$loadStickersByEmojiOrName$84((TLRPC.TL_error) obj2, (TLObject) obj3, (String) obj4, z11);
                break;
            case 6:
                ((MessagesController) obj5).lambda$setParticipantBannedRole$91((TLRPC.TL_error) obj3, (org.telegram.ui.ActionBar.o2) obj2, (TLRPC.TL_channels_editBanned) obj4, z11);
                break;
            case 7:
            ...
            case 8:
                ...
                break;
            case 9:
                ((SendMessagesHelper) obj5).lambda$sendEditRichMessageRequest$23((TLRPC.TL_messages_editMessage) obj3, (MessageObject) obj2, (org.telegram.ui.ActionBar.o2) obj4, z11);
                break;
            case 10:
            ...
            case 14:
                ...
                if (tLObject3 instanceof TLRPC.TL_contacts_resolvedPeer) {
                    ...
                    boVar.getMessagesController().putUsers(tL_contacts_resolvedPeer.users, false);
                    boVar.getMessagesController().putChats(tL_contacts_resolvedPeer.chats, false);
                    long peerDialogId = DialogObject.getPeerDialogId(tL_contacts_resolvedPeer.peer);
                    if (peerDialogId >= 0) {
                        obj = boVar.getMessagesController().getUser(Long.valueOf(peerDialogId));
                    } else if (peerDialogId < 0) {
                        obj = boVar.getMessagesController().getChat(Long.valueOf(-peerDialogId));
                    }
                    ogVar.run(obj, Boolean.valueOf(z11));
                    break;
                }
                obj = null;
                ogVar.run(obj, Boolean.valueOf(z11));
            case 15:
                org.telegram.ui.Components.ma maVar = (org.telegram.ui.Components.ma) obj5;
                Bitmap bitmap = (Bitmap) obj3;
                Bitmap bitmap2 = (Bitmap) obj2;
                if (TextUtils.equals(maVar.a, (String) obj4)) {
                    maVar.f = null;
                    Bitmap bitmap3 = maVar.b;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                    }
                    maVar.b = bitmap;
                    Runnable runnable = maVar.e;
                    if (runnable != null) {
                        runnable.run();
                    }
                } else {
            ...
            case 16:
                ...
                ClipboardManager clipboardManager = (ClipboardManager) ((bu) obj5).getContext().getSystemService("clipboard");
                ...
                wl.q(textView.animate().alpha(z12 ? 1.0f : 0.0f).scaleX(z12 ? 1.0f : 0.7f).scaleY(z12 ? 1.0f : 0.7f), qr.h, 300L);
                break;
            case 17:
                sy syVar = (sy) obj5;
            ...
            case 18:
                ...
                bo boVar2 = (bo) obj4;
                File w10 = o8.w(o2Var.getCurrentAccount(), "webp");
                ...
                PhotoViewer.t1().f2(arrayList3, 0, 11, false, new nx0(), boVar2);
                PhotoViewer.t1().X0(document, z11 ? document : null, true, null);
                ut.q().T = z11 ? tL_messages_stickerSet : null;
                break;
            case 19:
                ...
                wy wyVar = ((ky) obj5).a;
                if (tL_error == null) {
                    TLRPC.User user = wyVar.getMessagesController().getUser(Long.valueOf(wyVar.getUserConfig().getClientUserId()));
                    if (user == null) {
                        user = wyVar.getUserConfig().getCurrentUser();
                        if (user != null) {
                            wyVar.getMessagesController().putUser(user, false);
                        }
                    } else {
                        wyVar.getUserConfig().setCurrentUser(user);
                    }
                    ...
                    if (closestPhotoSizeWithSize == null || wyVar.b4 == null) {
                        z10 = z11;
                    } else {
                        ...
                        FileLoader.getInstance(i16).getPathToAttach(wyVar.b4, true).renameTo(pathToAttach2);
                        StringBuilder sb2 = new StringBuilder();
                        sb2.append(wyVar.b4.volume_id);
                        sb2.append("_");
                        String n10 = a4.a.n(wyVar.b4.local_id, "@50_50", sb2);
                    ...
                    if (closestVideoSizeWithSize != null && str5 != null) {
                    ...
                    } else if (closestPhotoSizeWithSize2 != null && wyVar.c4 != null) {
                        ...
                        FileLoader.getInstance(i13).getPathToAttach(wyVar.c4, true).renameTo(pathToAttach3);
                    }
                    wyVar.getMessagesController().getDialogPhotos(user.id).addPhotoAtStart(tL_photos_photo.photo);
                    ArrayList arrayList6 = new ArrayList();
                    arrayList6.add(user);
                    i19 = 0;
                    wyVar.getMessagesStorage().putUsersAndChats(arrayList6, null, false, true);
                ...
                wyVar.b4 = null;
                wyVar.c4 = null;
                NotificationCenter notificationCenter = wyVar.getNotificationCenter();
                ...
                wyVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.mainUserInfoChanged, new Object[i19]);
                wyVar.getUserConfig().saveConfig(true);
                ...
                if (ocVar2 != null) {
                    org.telegram.ui.Components.fc fcVar = (org.telegram.ui.Components.fc) ocVar2.e;
                    fcVar.d.c(LocaleController.getString(z10 ? R.string.YourProfileVideoDone : R.string.YourProfilePhotoDone), true, true);
                    fcVar.setProgress(1.0f);
                    org.telegram.ui.Components.kb button = fcVar.getButton();
                    button.setScaleX(0.6f);
                    button.setScaleY(0.6f);
                    button.setAlpha(0.0f);
                    button.setVisibility(0);
                    wl.q(button.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f), qr.h, 360L);
                    org.telegram.ui.Components.oc ocVar3 = wyVar.d4;
                    ocVar3.j = 5000;
                    ocVar3.i(false);
                    wyVar.d4.i(true);
                    break;
                ...
                break;
            case 20:
                yo0.a0((yo0) obj5, z11, (String) obj4, (String) obj3, (TL_account.updatePasswordSettings) obj2);
                break;
            case 21:
                yo0.i0((yo0) obj5, (TLRPC.TL_error) obj2, z11, (TLObject) obj3, (String) obj4);
                break;
            case 22:
                ih1.U((ih1) obj5, (TLObject) obj3, z11, (String) obj4, (TL_account.passwordInputSettings) obj2);
                break;
            default:
                ...
                if (!z15) {
                    if (payments_giveawayinfo instanceof TLRPC.TL_payments_giveawayInfoResults) {
                        tg.k.e(z16, str6, (TLRPC.TL_payments_giveawayInfoResults) payments_giveawayinfo, tL_messageMediaGiveaway, o2Var2.getParentActivity(), o2Var2.getResourceProvider());
                        break;
                    }
                } else {
                    tg.k.d(z16, str6, (TLRPC.TL_payments_giveawayInfo) payments_giveawayinfo, tL_messageMediaGiveaway, o2Var2.getParentActivity(), o2Var2.getResourceProvider());
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ u1(TLRPC.payments_GiveawayInfo payments_giveawayinfo, boolean z10, String str, long j3, TLRPC.TL_messageMediaGiveaway tL_messageMediaGiveaway, org.telegram.ui.ActionBar.o2 o2Var) {
        this.a = 23;
    ...
    public /* synthetic */ u1(org.telegram.ui.Components.ma maVar, String str, Bitmap bitmap, boolean z10, Bitmap bitmap2) {
        this.a = 15;
        this.c = maVar;
        this.f = str;
        this.d = bitmap;
    ...
    public /* synthetic */ u1(yo0 yo0Var, boolean z10, String str, String str2, TL_account.updatePasswordSettings updatepasswordsettings) {
        this.a = 20;
        this.c = yo0Var;
        this.b = z10;
        this.f = str;
