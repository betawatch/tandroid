...
public final class fa extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public fa(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        j1(context);
        int i14 = 0;
        this.b.setAdapter(new z8(this, context, i14));
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.currentAccount);
        messagesStorage.getStorageQueue().postRunnable(new y8(i14, this, messagesStorage));
    ...
    public static int d1(fa faVar, TLRPC.Chat chat) {
        Integer num;
        int i10;
        TLRPC.ChatFull chatFull = MessagesController.getInstance(faVar.currentAccount).getChatFull(chat.id);
    ...
    public final void dismiss() {
        ...
        if (callback != null) {
            ...
            if (i10 == 3) {
                ...
                daVar = i10 == 2 ? new da(i10, this.currentAccount, arrayList) : new da(i10, this.currentAccount, (ArrayList) null);
            }
            this.U.run(daVar);
            this.U = null;
        }
    ...
    public final void f1() {
        ...
        for (View view : this.b.getViewPages()) {
            if ((view instanceof y9) && (r9Var = ((y9) view).x) != null) {
                AndroidUtilities.hideKeyboard(r9Var.a);
            }
        }
    }
    ...
    public final void g1(da daVar, Runnable runnable, boolean z10) {
        ...
        if (arrayList.isEmpty() || z10) {
            ...
            d dVar = view instanceof y9 ? ((y9) view).v : null;
            if (dVar != null) {
                dVar.setLoading(true);
            }
            h9 h9Var = this.T;
            if (h9Var != null) {
                h9Var.k(daVar, this.w, this.x, this.y, this.G, this.c, this.H, new y8(2, dVar, runnable), new androidx.fragment.app.a0(dVar, 21));
                return;
            } else {
                runnable.run();
                return;
    ...
    public fa(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.Z = false;
        j1(context);
        this.b.setAdapter(new z8(this, context, 1));
    }
}
