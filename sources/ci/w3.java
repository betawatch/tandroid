...
public abstract class w3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public w3(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, MediaController.AlbumEntry albumEntry, boolean z10, float f7, boolean z11, boolean z12) {
        ...
        final int i11 = 0;
        e3Var.setOnItemClickListener(new al0(this) { // from class: ci.y2
            ...
            public final void d(int i12, View view) {
                ...
                switch (i11) {
                    case 0:
                        ...
                        ArrayList arrayList3 = w3Var.h0;
                        if (i12 >= 2 && w3Var.W != null && (view instanceof r3)) {
                            r3 r3Var = (r3) view;
                            int i13 = i12 - 2;
                            if (!w3Var.c0) {
                                if (w3Var.d0) {
                            ...
                            if (i13 >= 0 && i13 < w3Var.f0.size()) {
                                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) w3Var.f0.get(i13);
                                if (arrayList3.isEmpty() && !w3Var.Q) {
                                    ...
                                    if (arrayList3.contains(photoEntry)) {
                                        ...
                                        int i14 = -w3Var.N;
                                        w3Var.N = i14;
                                        AndroidUtilities.shakeViewSpring(r3Var, i14);
        ...
        kVar.addView(k3Var, 0, w7.x5.d(-2, -1.0f, 51, AndroidUtilities.isTablet() ? 64.0f : 56.0f, 0.0f, 40.0f, 0.0f));
        final int i12 = 0;
        ...
        frameLayout.addView(b3Var, w7.x5.e(-1, -1, 119));
        xw0 xw0Var = new xw0(context, b3Var, 11, d6Var);
        this.s = xw0Var;
        vh.o oVar = xw0Var.d;
        oVar.setTextSize(1, 16.0f);
        oVar.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.y6, d6Var));
        ...
        final int i13 = 1;
        ml0Var.setOnItemClickListener(new al0(this) { // from class: ci.y2
            public final /* synthetic */ w3 b;
            ...
            public final void d(int i122, View view) {
                ...
                switch (i13) {
                    case 0:
                        ...
                        ArrayList arrayList2 = w3Var.b0;
                        ArrayList arrayList3 = w3Var.h0;
                        if (i122 >= 2 && w3Var.W != null && (view instanceof r3)) {
                            r3 r3Var = (r3) view;
                            int i132 = i122 - 2;
                            if (!w3Var.c0) {
                                if (w3Var.d0) {
                            ...
                            if (i132 >= 0 && i132 < w3Var.f0.size()) {
                                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) w3Var.f0.get(i132);
                                if (arrayList3.isEmpty() && !w3Var.Q) {
                                    Utilities.Callback2 callback22 = w3Var.W;
                                    if (photoEntry.isVideo && !photoEntry.isLivePhoto()) {
                                        r5 = w3.d(r3Var);
    ...
    public static Bitmap d(r3 r3Var) {
        Bitmap bitmap;
        if (r3Var == null || (bitmap = r3Var.a) == null || bitmap.isRecycled()) {
            return null;
        }
    ...
    public final int g() {
        ...
        return e3Var == null ? padding : AndroidUtilities.lerp(0, padding, e3Var.getAlpha());
    }
    ...
    public final void h() {
        a aVar;
        k3 k3Var = this.F;
        ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = k3Var.b;
    ...
    public final void j() {
        ...
        if (imageView != null) {
            ul.r(imageView.animate().alpha(!isEmpty ? 1.0f : 0.0f).scaleX(!isEmpty ? 1.0f : 0.7f).scaleY(isEmpty ? 0.7f : 1.0f).translationY(!isEmpty ? -AndroidUtilities.navigationBarHeight : AndroidUtilities.dp(8.0f)), rr.h, 320L);
        }
