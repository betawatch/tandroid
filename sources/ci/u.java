    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i11) {
            ...
            case 7:
                ...
                arrayList2.add(h51.k(x8Var.a0));
                break;
            case 8:
                pc pcVar = (pc) obj3;
                Float f7 = (Float) obj2;
                long duration = pcVar.X0.getDuration() < 100 ? pcVar.K1.h0 : pcVar.X0.getDuration();
            ...
            case 23:
                ...
                v51Var2.E = 1;
                LinearLayout linearLayout = k0Var.a0;
                ...
                if (tL_connectedBot != null) {
                    ...
                    a0 a0Var = k0Var.Z;
                    if (a0Var != null) {
                        a0Var.a(arrayList5, v51Var2, true);
                    }
            ...
            case 24:
                ...
                if (u0Var.M != null) {
                    ...
                    h51Var3.D = new View.OnClickListener() { // from class: ig.o0
                    ...
                    v51Var3.U();
                    arrayList6.add(h51.k(u0Var.e));
                    longSparseArray.clear();
                    int i20 = 0;
                    boolean z12 = false;
                    while (i20 < u0Var.d.d.size()) {
                        TLObject tLObject = (TLObject) u0Var.d.d.get(i20);
                    ...
                    str2 = str4;
                    for (int i21 = 0; i21 < u0Var.d.e.size(); i21++) {
                        TLObject tLObject2 = (TLObject) u0Var.d.e.get(i21);
                ...
                u0Var.v.a(arrayList6, v51Var3, u0Var.M != null);
                ...
                if (u0Var.M != null) {
                    ...
                    m10.f = !u0Var.P;
                    final int i22 = 1;
                    m10.D = new View.OnClickListener() { // from class: ig.o0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i22) {
                                case 0:
                    ...
                    m11.f = !u0Var.Q;
                    final int i23 = 2;
                    m11.D = new View.OnClickListener() { // from class: ig.o0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i23) {
                                case 0:
                    ...
                    m12.f = !u0Var.R;
                    final int i24 = 3;
                    m12.D = new View.OnClickListener() { // from class: ig.o0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i24) {
                                case 0:
                    ...
                    final int i25 = 4;
                    m13.D = new View.OnClickListener() { // from class: ig.o0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            switch (i25) {
                                case 0:
            ...
            default:
                ...
                if (i1Var.r) {
                    for (int i28 = 0; i28 < arrayList9.size(); i28++) {
                        ...
                        f1 f1Var = (f1) arrayList9.get(i28);
                        if (!i1Var.U()) {
                            int i29 = i28 * 3;
                            arrayList8.add(h51.f(LocaleController.getString(R.string.BusinessHoursDayOpenHour), f1.a(f1Var.a), i29));
                            arrayList8.add(h51.f(LocaleController.getString(R.string.BusinessHoursDayCloseHour), f1.a(f1Var.b), i29 + 1));
                            h51 e10 = h51.e(i29 + 2, LocaleController.getString(R.string.Remove));
                            e10.r = true;
                            arrayList8.add(e10);
                        }
                    }
