...
public final class x2 {
    ...
    public x2(Context context, WindowManager windowManager, View view, WindowManager.LayoutParams layoutParams) {
        ...
        this.f = view;
        this.g = layoutParams;
        this.b = new u2(this, context, 0);
        this.c = new u2(this, context, 1);
        paint.setAlpha(0);
    }
    ...
    public final void g() {
        ...
        int i11 = this.n;
        u2 u2Var = this.b;
        if (i10 == i11 && this.j == u2Var.getMeasuredWidth() && this.k == u2Var.getMeasuredHeight() && Math.abs(this.m - this.h) <= 0.005f) {
            return;
        }
        this.l = this.n;
        this.j = u2Var.getMeasuredWidth();
