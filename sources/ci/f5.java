...
public final /* synthetic */ class f5 implements Runnable {
    ...
    public /* synthetic */ f5(r6 r6Var, qg.j jVar, int i10) {
        this.a = i10;
        this.b = r6Var;
        this.c = jVar;
    }
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (!z10) {
                    ...
                    final int i10 = 0;
                    textView.setOnClickListener(new View.OnClickListener() { // from class: ci.k5
                        ...
                        public final void onClick(View view) {
                            ...
                            switch (i10) {
                                ...
                                case 1:
                                    ...
                                    r6Var3.getClass();
                                    try {
                                        ((qg.u2) jVar4).getEditText().onTextContextMenuItem(android.R.id.pasteAsPlainText);
                                    } catch (Exception e) {
                                        FileLog.e(e);
                                    }
                                ...
                                case 3:
                                    ...
                                    r6Var5.D0(null, true);
                                    qg.j jVar5 = jVar;
                                    r6Var5.L0((qg.t0) jVar5, new ai.m0(2, r6Var5, jVar5));
                                ...
                                default:
                                    ...
                                    if (jVar7 != null) {
                                        ...
                                        if (jVar7 instanceof qg.n2) {
                                            qg.j n2Var = new qg.n2(r6Var9.getContext(), (qg.n2) jVar7, Q0);
                                            n2Var.setDelegate(r6Var9);
                                            k6Var2.addView(n2Var);
                                            r6Var9.g0();
                                            jVar2 = n2Var;
                                        } else if (jVar7 instanceof qg.u2) {
                                            qg.u2 u2Var = new qg.u2(r6Var9.getContext(), (qg.u2) jVar7, Q0);
                                            u2Var.setDelegate(r6Var9);
                                            u2Var.setMaxWidth(r6Var9.R1 - AndroidUtilities.dp(32.0f));
                                            k6Var2.addView(u2Var, w7.y5.c(-2.0f, -2));
                                            r6Var9.g0();
                                            jVar2 = u2Var;
                                        }
                                        r6Var9.B0(jVar2);
                ...
                if (jVar instanceof qg.u2) {
                    ...
                    if ((!t5Var.c() || t5Var.d) && r6Var.t2 <= 0) {
                        textView2.setTag(1);
                        textView2.setText(LocaleController.getString(R.string.PaintEdit));
                        final int i11 = 2;
                        textView2.setOnClickListener(new View.OnClickListener() { // from class: ci.k5
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                qg.j jVar2;
                                switch (i11) {
                ...
                if (k6Var.indexOfChild(jVar) != k6Var.getChildCount() - 1 && !(jVar instanceof qg.a2)) {
                    ...
                    final int i16 = 6;
                    textView3.setOnClickListener(new View.OnClickListener() { // from class: ci.k5
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            qg.j jVar2;
                            switch (i16) {
                    ...
                    final int i17 = 7;
                    textView4.setOnClickListener(new View.OnClickListener() { // from class: ci.k5
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            qg.j jVar2;
                            switch (i17) {
