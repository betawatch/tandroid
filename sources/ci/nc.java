    ...
    */
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (qbVar != null) {
            ...
            fk0 fk0Var = ocVar.v1.Z1;
            if (fk0Var != null) {
                int i21 = ocVar.Y;
                fk0Var.layout(i21, ocVar.Z, fk0Var.getMeasuredWidth() + i21, ocVar.v1.Z1.getMeasuredHeight() + ocVar.Z);
                yh.v3 v3Var = ocVar.v1.Z1.getReactionsWindow() != null ? ocVar.v1.Z1.getReactionsWindow().c : null;
                if (v3Var != null) {
                    int i22 = ocVar.Y;
