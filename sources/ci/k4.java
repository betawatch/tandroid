...
public final class k4 extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void d(long j3, ai.d6 d6Var) {
        ...
        if (this.s != j3) {
            ...
            if (j3 == 0) {
                ...
                if (j3 > 0) {
                    ...
                    int d = user != null ? org.telegram.ui.Components.h9.d(user.id) : i0.a.d(0.2f, -16777216, -1);
                    ...
                    int d10 = chat != null ? org.telegram.ui.Components.h9.d(chat.id) : i0.a.d(0.2f, -16777216, -1);
        ...
        this.s = j3;
        this.v = d6Var;
        if (this.r && d6Var != null && !d6Var.a) {
            d6Var.a = true;
            d6Var.b();
        }
        boolean z10 = (d6Var == null || (d2Var2 = (ai.d2) d6Var.b) == null || !d2Var2.n()) ? false : true;
        if (d6Var == null || (d2Var = (ai.d2) d6Var.b) == null || !d2Var.a()) {
            t1Var = null;
        } else {
            ai.d2 d2Var3 = (ai.d2) d6Var.b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.liveStoryUpdated) {
            ...
            ai.d6 d6Var = this.v;
            if (d6Var == null || (d2Var = (ai.d2) d6Var.b) == null || d2Var.g() != longValue) {
                return;
            }
