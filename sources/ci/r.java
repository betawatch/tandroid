...
public abstract class r extends m {
    ...
    public r(Context context, FrameLayout frameLayout, qv0 qv0Var, FrameLayout frameLayout2, ai.d dVar, org.telegram.ui.Components.ha haVar) {
        super(context, frameLayout, qv0Var, frameLayout2, dVar, haVar);
        this.W0 = true;
        this.X0 = 0;
        ec ecVar = (ec) this;
    ...
    */
    ...
    public final void j(Canvas canvas, RectF rectF) {
        ...
        if (this.D1 != null) {
            ...
            if (f7 > 0.0f) {
                if (this.x1 == null) {
                    this.x1 = new h01(LocaleController.getString(R.string.SlideToCancel2), 15.0f, null);
                }
                if (this.y1 == null) {
                    Path path = new Path();
                    this.y1 = path;
            ...
            if (e7 > f13) {
                if (this.A1 == null) {
                    this.A1 = new h01(LocaleController.getString(R.string.CancelRound), f12, AndroidUtilities.bold());
                }
                ...
                canvas2 = canvas;
                this.A1.c(width, rectF.centerY(), 1.0f, org.telegram.ui.ActionBar.j6.l1(e7, paint != null ? -1 : -2130706433), canvas2);
