...
public final class zc extends View {
    ...
    public zc(Context context, ViewGroup viewGroup, ac acVar, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ia iaVar) {
        super(context);
        this.n = 0;
        ...
        this.b0 = 1;
        qr qrVar = qr.h;
        this.c0 = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        this.d0 = new org.telegram.ui.Components.d6(this, 360L, qrVar);
        this.e0 = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        this.f0 = new org.telegram.ui.Components.d6(this, 360L, qrVar);
        this.g0 = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        this.h0 = new org.telegram.ui.Components.d6(this, 0L, 360L, qrVar);
        this.i0 = new org.telegram.ui.Components.d6(this, 0L, 320L, qrVar);
        this.j0 = true;
        this.o0 = new RectF();
        this.p0 = new Path();
        this.s0 = new yc();
        ...
        this.Z0 = -1L;
        this.a1 = -1L;
        this.b1 = new org.telegram.ui.Components.d6(0.0f, this, 0L, 340L, qrVar);
        this.c1 = -1L;
        this.h1 = -1;
        this.i1 = -1;
        this.j1 = -1;
        ...
        this.q0 = new w01(LocaleController.getString(R.string.StoryTimeline), 12.0f, AndroidUtilities.bold());
        ...
        this.Y0 = new ai.m3(this, viewGroup, f6Var, iaVar, acVar, 5);
    }

    public static void a(final zc zcVar, ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ia iaVar, View view) {
        int i10;
        ...
        try {
            if (i11 == 2 && zcVar.N) {
                ...
                i8Var.d(zcVar.V);
                final int i12 = 0;
                i8Var.h = new Utilities.Callback(zcVar) { // from class: ci.qc
                ...
                y70 F = y70.F(viewGroup, f6Var, zcVar);
                F.q(i8Var);
                F.o();
                ...
                i8Var2.d(zcVar.L);
                final int i16 = 1;
                i8Var2.h = new Utilities.Callback(zcVar) { // from class: ci.qc
                    public final /* synthetic */ zc b;
                ...
                y70 F2 = y70.F(viewGroup, f6Var, zcVar);
                F2.q(i8Var2);
                F2.o();
                ...
                F2.Z();
                F2.R(iaVar, -view.getX(), -view.getY());
                zcVar.performHapticFeedback(0, 1);
                ...
                i8Var3.d(zcVar.h.i);
                final int i20 = 2;
                i8Var3.h = new Utilities.Callback(zcVar) { // from class: ci.qc
                    public final /* synthetic */ zc b;
    ...
    public long getBaseDuration() {
        ...
        tc tcVar2 = this.v;
        return tcVar2 != null ? Math.max(1L, tcVar2.e) : this.E ? Math.max(1L, this.H) : Math.max(1L, this.R);
    }
    ...
    private float getCollageHeight() {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            f7 += AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), ((tc) arrayList.get(i10)).k.c);
        }
        return f7;
    }
    ...
    */
    public final int c(MotionEvent motionEvent) {
        ...
        tc tcVar2 = this.v;
        float f7 = min;
        float f10 = (this.u1 * (((clamp + (tcVar2 != null ? (tcVar2.g * tcVar2.e) + tcVar2.f : this.h == null ? this.Q : 0L)) - this.f) / f7)) + this.y1 + this.x1;
                ...
                if (y3 < ((((this.w1 - this.z1) - getVideoHeight()) - AndroidUtilities.dp(2.0f)) - getCollageHeight()) - AndroidUtilities.dp(arrayList.isEmpty() ? 0.0f : 4.0f)) {
                    ...
                    if (z12) {
                        ...
                        if (z11) {
                            ...
                            float f17 = ((((tcVar3.h * f13) - f14) / f7) * f15) + f11;
                            if (this.X0) {
                            ...
                            if (x10 >= f16 && x10 <= f17) {
                                tc tcVar4 = this.h;
                                if (tcVar4.g > 0.01f || tcVar4.h < 0.99f) {
                                    return 4;
                                }
                            }
                        } else if (z10) {
                        ...
                        for (int i11 = 0; i11 < arrayList.size(); i11++) {
                            tc tcVar5 = (tc) arrayList.get(i11);
                            ...
                            if (rectF.contains(x10, y3)) {
                                ...
                                float f47 = ((((tcVar5.h * f45) + f41) / f7) * f42) + f40;
                                ...
                                if (x10 < f46 || x10 > f47 || (tcVar5.g <= 0.01f && tcVar5.h >= 0.99f)) {
                    ...
                    tcVar = this.h;
                    if (tcVar != null || tcVar.e <= getMaxScrollDuration() || !z11) {
                        return -1;
                    }
                }
            }
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.ia iaVar = zcVar.k0;
        RectF rectF8 = zcVar.F0;
        ArrayList arrayList21 = zcVar.s;
        RectF rectF9 = zcVar.o0;
        org.telegram.ui.Components.ma maVar3 = zcVar.l0;
        ...
        if (e10 < 1.0f) {
            ...
            if (arrayList20.isEmpty() || !iaVar.c()) {
                ...
                if (!arrayList20.isEmpty()) {
                    ...
                    drawable.setBounds(centerX, rk.d(2, centerY, drawable), drawable.getIntrinsicWidth() + centerX, rk.A(2, centerY, drawable));
                    ...
                    maVar = maVar2;
                    f7 = 0.4f;
                    w01Var.c(centerX2, f63, 0.75f, -1, canvas);
                    canvas.restore();
                }
            } else {
            ...
            drawable.setBounds(centerX3, rk.d(2, centerY2, drawable), drawable.getIntrinsicWidth() + centerX3, rk.A(2, centerY2, drawable));
            drawable.setAlpha(191);
            drawable.draw(canvas);
            w01 w01Var2 = zcVar.q0;
            ...
            maVar = maVar2;
            f7 = 0.4f;
            w01Var2.c(centerX22, f632, 0.75f, -1, canvas);
            canvas.restore();
        } else {
            rectF = rectF6;
            j3 = min;
        ...
        if (e10 > 0.0f) {
            if (e10 < 1.0f) {
                ...
                j11 = j3;
                f11 = 0.0f;
                canvas2.saveLayerAlpha(0.0f, 0.0f, zcVar.getWidth(), zcVar.getHeight(), (int) (e10 * 255.0f), 31);
                z10 = true;
            } else {
                canvas2 = canvas;
                j11 = j3;
            ...
            tc tcVar4 = zcVar.h;
            float f64 = tcVar4 != null ? 1.0f : 0.0f;
            float e11 = tcVar4 != null ? tcVar4.k.e((zcVar.P || zcVar.G) ? false : true) : 0.0f;
            ...
            if (zcVar.h != null) {
                ...
                float x11 = com.google.android.gms.internal.vision.e2.x(tcVar5.h, f67, e11, f11);
                if (j15 <= 0) {
                    f12 = e11;
                    f59 = f64;
                    j12 = j11;
            ...
            if (arrayList2.isEmpty()) {
                ...
                while (i26 < arrayList2.size()) {
                    ...
                    org.telegram.ui.Components.d6 d6Var = tcVar7.k;
                    RectF rectF12 = tcVar7.j;
                    float f87 = f15;
                    float e12 = d6Var.e((zcVar.P || zcVar.G || zcVar.n != i26) ? false : true);
                    if (tcVar7 != zcVar.v) {
                        i15 = i26;
                        arrayList9 = arrayList22;
                        float f88 = j12;
                        f49 = f16;
                        f50 = ((((AndroidUtilities.lerp(tcVar7.g, 0.0f, e12) * tcVar7.e) + (tcVar7.f - zcVar.f)) / f88) * zcVar.u1) + zcVar.y1 + zcVar.x1;
                        rectF5 = rectF7;
                        e7 = (com.google.android.gms.internal.vision.e2.y(AndroidUtilities.lerp(tcVar7.h, 1.0f, e12), tcVar7.e, tcVar7.f - zcVar.f, f88) * zcVar.u1) + zcVar.y1 + zcVar.x1;
                        path = path2;
                    } else {
                        i15 = i26;
                        rectF5 = rectF7;
                        ...
                        float f90 = j12;
                        float f91 = (tcVar7.f - zcVar.f) / f90;
                        float f92 = zcVar.u1;
                        f50 = (f91 * f92) + f89;
                        path = path2;
                        e7 = a4.a.e(r8 + tcVar7.e, f90, f92, f89);
                    }
                    float f93 = f50;
                    canvas2.save();
                    ...
                    if (xcVar2 != null) {
                        ...
                        if (j16 <= 0) {
                            ...
                            j14 = j16;
                            f54 = zcVar.y1 + zcVar.x1 + (((tcVar7.f - zcVar.f) / j12) * zcVar.u1);
                        }
                        float f99 = zcVar.x1;
                        float f100 = f54 - f99;
                        if (j16 <= 0) {
                            ...
                            f55 = f99;
                            f56 = ((((tcVar7.f + j14) - zcVar.f) / j12) * zcVar.u1) + zcVar.y1 + r7;
                        }
                        float f101 = f56 + f55;
                        int i27 = xcVar2.f;
                        float f102 = i27;
                        int max3 = (int) Math.max(0.0d, Math.floor((f100 - ((((tcVar7.f - zcVar.f) / j12) * zcVar.u1) + (zcVar.y1 + zcVar.x1))) / f102));
                        int min3 = (int) Math.min(tcVar7.c.c, Math.ceil((f101 - f100) / f102) + 1.0d);
                        int i28 = (int) rectF12.top;
                        arrayList10 = tcVar7.c.d;
                        boolean z17 = arrayList10.size() >= min3;
                        if (z17) {
                            for (int i29 = max3; i29 < Math.min(arrayList13.size(), min3); i29++) {
                                arrayList14 = tcVar7.c.d;
            ...
            Path path3 = path2;
            float e13 = zcVar.c0.e(zcVar.E);
            float e14 = zcVar.d0.e(zcVar.E && zcVar.G);
            float roundHeight = zcVar.getRoundHeight() * e13;
            float f116 = ((zcVar.h == null && !zcVar.N && arrayList3.isEmpty()) ? 1.0f : e14) * e13;
            if (e13 > 0.0f) {
                long j17 = zcVar.I;
                float f117 = j17;
                float f118 = zcVar.J;
                ...
                if (zcVar.h != null) {
                    float f120 = j12;
                    float lerp3 = ((((zcVar.H * AndroidUtilities.lerp(f118, 0.0f, e14)) + (j17 - zcVar.f)) / f120) * zcVar.u1) + zcVar.y1 + zcVar.x1;
                    f42 = f16;
                    f22 = f21;
                    e = (com.google.android.gms.internal.vision.e2.y(AndroidUtilities.lerp(zcVar.K, 1.0f, e14), zcVar.H, zcVar.I - zcVar.f, f120) * zcVar.u1) + zcVar.y1 + zcVar.x1;
                    f43 = lerp3;
                } else {
                    f22 = f21;
                    f42 = f16;
            ...
            float e15 = zcVar.e0.e(zcVar.N);
            float e16 = zcVar.f0.e(zcVar.N && zcVar.P);
            float audioHeight = zcVar.getAudioHeight() * e15;
            float f148 = ((zcVar.h == null && !zcVar.E && arrayList3.isEmpty()) ? 1.0f : e16) * e15;
            if (e15 > 0.0f) {
                float f149 = zcVar.Q;
                float f150 = zcVar.S;
                float f151 = zcVar.R;
                ...
                if (zcVar.h == null && !zcVar.E && arrayList3.isEmpty()) {
                    ...
                    paint2 = paint;
                    float f157 = j12;
                    lerp = ((((AndroidUtilities.lerp(zcVar.S, 0.0f, e16) * zcVar.R) + (zcVar.Q - zcVar.f)) / f157) * zcVar.u1) + zcVar.y1 + zcVar.x1;
                    y3 = zcVar.y1 + zcVar.x1 + (com.google.android.gms.internal.vision.e2.y(AndroidUtilities.lerp(zcVar.T, 1.0f, e16), zcVar.R, zcVar.Q - zcVar.f, f157) * zcVar.u1);
                }
                float f158 = y3;
                float f159 = zcVar.x1;
                ...
                if (zcVar.a0 == null || iaVar == null || !iaVar.c()) {
                    f37 = e16;
                    rectF4 = rectF16;
                    if (zcVar.a0 != null && c12 != null) {
                        Paint c13 = zcVar.n0.c(e15 * f7);
                        if (c13 == null) {
                            c13 = zcVar.H0;
                        ...
                        zcVar.U = rcVar.c > 0;
                        long j20 = j12;
                        zcVar.I0.b((((zcVar.Q - zcVar.f) / j12) * zcVar.u1) + zcVar.y1 + zcVar.x1, lerp, f158, f37, j20, audioHeight, d12, rectF4.bottom, rcVar);
                        f38 = f37;
                        j10 = j20;
                    ...
                    rectF4 = rectF16;
                    f37 = e16;
                    zcVar.I0.b((((zcVar.Q - zcVar.f) / j12) * zcVar.u1) + zcVar.y1 + zcVar.x1, lerp, f158, f37, j12, audioHeight, d13, rectF4.bottom, rcVar2);
            ...
            if (f29 > d || f30 > d || f27 > d || f22 > d) {
                ...
                tc tcVar8 = zcVar.h;
                if (tcVar8 != null && ((zcVar.N || zcVar.E) && (f31 > 0.0f || f23 > 0.0f))) {
                    ...
                    float f185 = zcVar.f;
                    float f186 = zcVar.u1;
                    float f187 = ((((tcVar8.h * f184) - f185) / f176) * f186) + f182;
                    canvas3 = canvas;
                    ...
                    float f197 = (((((tcVar9.h * f193) + f191) - f194) / f176) * f195) + f190;
                    canvas3 = canvas;
                    zcVar.e(canvas3, paint5, f188, f189, f196, f197, 0.8f);
                }
                if (zcVar.b0 > 1 && (tcVar3 = zcVar.h) != null) {
                    float f198 = tcVar3.e;
                    float f199 = tcVar3.h;
                    float f200 = tcVar3.g;
                    ...
                    if (j21 > 68999) {
                        ...
                        while (i41 <= min8) {
                            ...
                            tc tcVar10 = zcVar.h;
                            float f208 = ((((((long) (tcVar10.e * tcVar10.g)) + r2) - zcVar.f) / f176) * zcVar.u1) + f207;
                        ...
                        if (d10 <= 0.0f) {
                            ...
                            if (j23 == -1) {
                                tc tcVar11 = zcVar.h;
                                if (tcVar11 != null) {
                                    j23 = (long) (tcVar11.e * tcVar11.h);
                                } else {
                                    tc tcVar12 = zcVar.v;
                                    if (tcVar12 != null) {
                                        j23 = (long) ((tcVar12.h - tcVar12.g) * tcVar12.e);
                                    } else {
                                        if (zcVar.E) {
                                            f33 = zcVar.H;
                                            f34 = zcVar.K;
        ...
        if (zcVar.m1) {
            ...
            if (i42 == 4 && (tcVar2 = zcVar.h) != null) {
                ...
                zcVar.e += j26;
                tc tcVar13 = zcVar.h;
                float f214 = (r3 - j24) / tcVar13.e;
                if (f214 > 0.0f) {
                    f10 = 1.0f;
                    max = Math.min(1.0f - tcVar13.h, f214);
                } else {
                    f10 = 1.0f;
                    max = Math.max(0.0f - tcVar13.g, f214);
                }
                tc tcVar14 = zcVar.h;
                tcVar14.g = Utilities.clamp(tcVar14.g + max, f10, 0.0f);
                tc tcVar15 = zcVar.h;
                tcVar15.h = Utilities.clamp(tcVar15.h + max, f10, 0.0f);
                sc scVar = zcVar.a;
                if (scVar != null) {
                    scVar.D(zcVar.h.g, false);
                    zcVar.a.X(zcVar.h.h);
                }
                zcVar.invalidate();
            } else if (i42 == 8) {
                ...
                if (i10 != 0) {
                    if (zcVar.P && (tcVar = zcVar.h) != null) {
                        long j29 = j27 - (i10 * dp2);
                        float f218 = tcVar.h;
                        float f219 = tcVar.e;
                        zcVar.Q = Utilities.clamp(j29, (long) ((f218 * f219) - (f215 * f217)), (long) ((tcVar.g * f219) - (zcVar.T * f217)));
    ...
    public final void e(Canvas canvas, Paint paint, float f7, float f10, float f11, float f12, float f13) {
        ...
        rectF.set(org.telegram.messenger.l0.x(AndroidUtilities.dp(this.X0 ? 2.0f : 10.0f), dp, 2.0f, f11), f15, f11 - ((AndroidUtilities.dp(this.X0 ? 2.0f : 10.0f) + dp) / 2.0f), f16);
        if (!this.X0) {
        ...
        rectF.set(com.google.android.gms.internal.vision.e2.A(AndroidUtilities.dp(this.X0 ? 2.5f : 10.0f), dp, 2.0f, f12), f15, org.telegram.messenger.l0.a(AndroidUtilities.dp(this.X0 ? 2.5f : 10.0f), dp, 2.0f, f12), f16);
        if (!this.X0) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), paint5);
            if (paint != null) {
                paint4.setAlpha((int) (f13 * 48.0f));
    ...
    public final void h(float f7) {
        ...
        if (tcVar == null && !this.E) {
            ...
            float f14 = f11 * j10;
            float f15 = tcVar != null ? (tcVar.h - tcVar.g) * tcVar.e : this.H * (this.K - this.J);
            float f16 = this.T;
            float f17 = this.R;
        ...
        sc scVar5 = this.a;
        if (scVar5 != null) {
            scVar5.h0(this.Q + ((long) (this.S * this.R)));
        }
        boolean z10 = this.m1;
        if (z10 || (scVar = this.a) == null) {
            if (z10 || this.r1) {
                ...
                if (tcVar2 != null) {
                    ...
                    float f23 = tcVar2.h;
                    float f24 = tcVar2.e;
                    this.e = Utilities.clamp(j26, (long) (f23 * f24), (long) (tcVar2.g * f24));
                } else if (!this.E || tcVar2 == null) {
                    float f25 = this.S;
                    long j27 = this.R;
        ...
        if (tcVar3 != null) {
            ...
            float f28 = tcVar3.h;
            float f29 = tcVar3.e;
            clamp = Utilities.clamp(j29, (long) (f28 * f29), (long) (tcVar3.g * f29));
        } else if (this.E) {
    ...
    public final void i(tc tcVar, float f7) {
        ...
        if (tcVar2 != tcVar && tcVar2 != null) {
            if (this.n == this.s.indexOf(tcVar)) {
                tc tcVar3 = this.v;
                float f10 = tcVar3.e;
                float f11 = tcVar.h;
                float f12 = tcVar.e;
                ...
                float min = Math.min(f11 - f13, ((tcVar3.h - tcVar3.g) * f10) / f12);
                long j15 = tcVar.f;
                long j16 = (long) f7;
                long j17 = j15 + j16;
                if (j17 > j13) {
                    float clamp2 = Utilities.clamp((((this.v.h * r2.e) - j15) - j16) / tcVar.e, 1.0f, min);
                    tcVar.h = clamp2;
                    ...
                    long j19 = (long) ((tcVar4.g * f15) - (clamp3 * f17));
                    if (j18 < j19) {
                        j12 = j19;
                        j11 = j18;
                    } else {
                    ...
                    sc scVar2 = this.a;
                    if (scVar2 != null) {
                        scVar2.O(tcVar.g, tcVar.a);
                        this.a.W(tcVar.h, tcVar.a);
                    }
                } else if (j17 < j14) {
                    ...
                    long j21 = (long) ((tcVar5.g * f19) - (tcVar.g * f20));
                    if (j20 < j21) {
                        j10 = j21;
                        j3 = j20;
                    } else {
                ...
                long j22 = tcVar.f + ((long) f7);
                float baseDuration = getBaseDuration();
                float f21 = tcVar.e;
                tcVar.f = Utilities.clamp(j22, (long) (baseDuration - (tcVar.h * f21)), (long) ((-tcVar.g) * f21));
            }
        }
        invalidate();
        sc scVar4 = this.a;
        if (scVar4 != null) {
            scVar4.c0(tcVar.a, tcVar.f);
        }
        boolean z10 = this.m1;
        if (z10 || (scVar = this.a) == null) {
            if (z10 || this.r1) {
                tc tcVar6 = this.v;
                if (tcVar6 == tcVar || tcVar6 == null) {
                    float f22 = tcVar.g;
                    long j23 = tcVar.e;
                    this.e = Utilities.clamp((long) (f22 * j23), j23, 0L);
                } else {
                    long j24 = tcVar.f + ((long) (tcVar.g * tcVar.e));
                    float f23 = tcVar6.h;
                    float f24 = tcVar6.e;
                    this.e = Utilities.clamp(j24, (long) (f23 * f24), (long) (tcVar6.g * f24));
                }
                sc scVar5 = this.a;
                if (scVar5 != null) {
                    scVar5.m(this.e, false);
                    return;
                }
                return;
            }
        ...
        scVar.u(true);
        tc tcVar7 = this.v;
        if (tcVar7 == tcVar || tcVar7 == null) {
            float f25 = tcVar.g;
            long j25 = tcVar.e;
            clamp = Utilities.clamp((long) (f25 * j25), j25, 0L);
        } else {
            long j26 = tcVar.f + ((long) (tcVar.g * tcVar.e));
            float f26 = tcVar7.h;
            float f27 = tcVar7.e;
            clamp = Utilities.clamp(j26, (long) (f26 * f27), (long) (tcVar7.g * f27));
        }
        tc tcVar8 = this.v;
        if (tcVar8 != tcVar && tcVar8 != null && Math.abs(this.e - clamp) > 400) {
            this.c1 = this.e;
            this.b1.d(1.0f, true);
        }
        sc scVar6 = this.a;
        this.e = clamp;
        scVar6.m(clamp, false);
    }
    ...
    public final void j(float f7) {
        ...
        if (tcVar == null) {
            ...
            if (j18 > j14) {
                ...
                long j20 = (long) ((tcVar2.g * f18) - (clamp4 * f20));
                if (j19 < j20) {
                    j12 = j20;
                    j11 = j19;
                } else {
                ...
                long j22 = (long) ((tcVar3.g * f22) - (this.J * f23));
                if (j21 < j22) {
                    j10 = j22;
                    j3 = j21;
                } else {
        ...
        if (z10 || (scVar = this.a) == null) {
            if (z10 || this.r1) {
                ...
                if (tcVar4 != null) {
                    ...
                    float f25 = tcVar4.h;
                    float f26 = tcVar4.e;
                    this.e = Utilities.clamp(j24, (long) (f25 * f26), (long) (tcVar4.g * f26));
                } else {
                    float f27 = this.J;
                    long j25 = this.H;
        ...
        if (tcVar5 != null) {
            ...
            float f28 = tcVar5.h;
            float f29 = tcVar5.e;
            clamp = Utilities.clamp(j26, (long) (f28 * f29), (long) (tcVar5.g * f29));
        } else {
            float f30 = this.J;
            long j27 = this.H;
    ...
    public final boolean m(float f7, boolean z10) {
        tc tcVar = this.h;
        ArrayList arrayList = this.s;
        if (tcVar == null && !this.N && arrayList.isEmpty()) {
            return false;
        }
        long min = Math.min(getBaseDuration(), getMaxScrollDuration());
        float f10 = ((f7 - this.y1) - this.x1) / this.u1;
        tc tcVar2 = this.v;
        long j3 = tcVar2 != null ? (long) ((tcVar2.g * tcVar2.e) + tcVar2.f) : 0L;
        float f11 = f10 * min;
        if (tcVar2 == null) {
        ...
        tc tcVar3 = this.h;
        if (tcVar3 != null) {
            float f12 = clamp / tcVar3.e;
            if (f12 < tcVar3.g || f12 > tcVar3.h) {
                return false;
            }
        }
        tc tcVar4 = this.v;
        if (tcVar4 != null && (clamp < 0 || clamp >= ((long) ((tcVar4.h - tcVar4.g) * tcVar4.e)))) {
            return false;
        }
        if (this.N && tcVar3 == null && arrayList.isEmpty()) {
    ...
    public final void n(String str, long j3, long j10, float f7, float f10, float f11, boolean z10) {
        ...
        if (str != null) {
            ...
            if (getMeasuredWidth() <= 0 || this.M != null || ((tcVar = this.h) != null && tcVar.e < 1)) {
                ...
                z12 = false;
                z11 = true;
                this.M = new xc(this, false, str2, i12, dp, valueOf, tcVar2 != null ? tcVar2.e : getMaxScrollDuration(), -1L, -1L, new pc(this, 0));
            }
            if (this.h == null) {
                this.P = z12;
                this.G = z11;
    ...
    public final void o(boolean z10, String str, long j3, float f7) {
        tc tcVar = this.h;
        if (TextUtils.equals(tcVar == null ? null : tcVar.d, str)) {
            return;
        }
        tc tcVar2 = this.h;
        if (tcVar2 != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        tc tcVar = this.h;
        if (tcVar != null && tcVar.d != null && tcVar.c == null) {
            tc.a(tcVar, false);
        }
        ArrayList arrayList = this.s;
        if (!arrayList.isEmpty()) {
            ...
            while (i12 < size2) {
                ...
                i12++;
                tc tcVar2 = (tc) obj;
                if (tcVar2.d != null && tcVar2.c == null) {
                    tc.a(tcVar2, false);
                    tc.b(tcVar2);
                }
            }
    ...
    */
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        tc tcVar = this.h;
        ArrayList arrayList = this.s;
        if (tcVar != null || !arrayList.isEmpty() || this.N || this.E) {
                ...
                if (action == 0) {
                    ...
                    if (this.j1 == -1 && !arrayList.isEmpty()) {
                        for (int i13 = 0; i13 < arrayList.size(); i13++) {
                            f14 = 2.0f;
                            float lerp = AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), ((tc) arrayList.get(i13)).k.c);
                            float f16 = i12;
                    ...
                    if (this.j0 && (this.m1 || Math.abs(x10) > AndroidUtilities.touchSlop)) {
                        ...
                        tc tcVar2 = this.h;
                        if (tcVar2 != null && this.h1 == 1) {
                            this.f = (long) Utilities.clamp(this.f - ((x10 / this.u1) * min3), tcVar2.e - min3, 0.0f);
                            invalidate();
                            if (!this.m1) {
                                this.n1 = 1.0f;
                            }
                            this.m1 = true;
                            this.l1 = false;
                        } else if (tcVar2 == null || !((i11 = this.h1) == 2 || i11 == 3 || i11 == 4)) {
                            int i15 = this.h1;
                            if (i15 == 6 || i15 == 7 || i15 == 8) {
                                ...
                                if (i15 == 6) {
                                    ...
                                    tc tcVar3 = this.h;
                                    if (tcVar3 != null) {
                                        max = Math.max(f21, (((tcVar3.g * tcVar3.e) + this.f) - this.Q) / f20);
                                    } else {
                                        tc tcVar4 = this.v;
                                        if (tcVar4 != null) {
                                            max = Math.max(f21, (((tcVar4.g * tcVar4.e) + this.f) - this.Q) / f20);
                                        } else if (this.E) {
                                    ...
                                    tc tcVar5 = this.h;
                                    if (tcVar5 != null) {
                                        min = Math.min(min4, (((tcVar5.h * tcVar5.e) + this.f) - this.Q) / f24);
                                    } else {
                                        tc tcVar6 = this.v;
                                        if (tcVar6 != null) {
                                            min = Math.min(min4, (((tcVar6.h * tcVar6.e) + this.f) - this.Q) / f24);
                                        } else if (this.E) {
                                ...
                                if (this.h1 == 8) {
                                    ...
                                    if (scVar8 != null) {
                                        scVar8.U(f27);
                                        this.a.h0(this.Q + ((long) (this.S * this.R)));
                                        this.a.Q(this.T);
                                    }
                                    sc scVar9 = this.a;
                                    if (scVar9 != null) {
                                ...
                                if (i15 == 10) {
                                    ...
                                    tc tcVar7 = this.h;
                                    if (tcVar7 != null) {
                                        max2 = Math.max(f30, (((tcVar7.g * tcVar7.e) + this.f) - this.I) / f29);
                                    } else {
                                        tc tcVar8 = this.v;
                                        if (tcVar8 != null) {
                                            max2 = Math.max(f30, (((tcVar8.g * tcVar8.e) + this.f) - this.I) / f29);
                                        } else {
                                    ...
                                    tc tcVar9 = this.h;
                                    if (tcVar9 != null) {
                                        min6 = Math.min(min6, (((tcVar9.h * tcVar9.e) + this.f) - this.I) / f33);
                                    }
                                    tc tcVar10 = this.v;
                                    if (tcVar10 != null) {
                                        min2 = Math.min(min6, (((tcVar10.h * tcVar10.e) + this.f) - this.I) / this.H);
                                    } else {
                                ...
                                if (i16 < 0 || i16 >= arrayList.size() || !((i10 = this.h1) == 13 || i10 == 14 || i10 == 15)) {
                                    ...
                                    if (i17 == 5) {
                                        ...
                                        if (i18 >= 0 && i18 < arrayList.size() && this.h1 == 16) {
                                            i((tc) arrayList.get(this.i1), (x10 / this.u1) * min3);
                                            if (!this.m1) {
                                                this.n1 = 1.0f;
                                            }
                                            this.m1 = true;
                                    ...
                                    tc tcVar11 = (tc) arrayList.get(this.i1);
                                    float f37 = (min3 / tcVar11.e) * (x10 / this.u1);
                                    int i19 = this.h1;
                                    if (i19 == 13) {
                                        float g14 = tcVar11.h - (g() / tcVar11.e);
                                        float max5 = Math.max(0L, this.f - tcVar11.f) / tcVar11.e;
                                        if (tcVar11 == this.v) {
                                            f10 = f37;
                                            max5 = Math.max(max5, tcVar11.h - (f() / tcVar11.e));
                                            if (!this.o1 && f10 < 0.0f) {
                                                f11 = 0.0f;
                                                if (tcVar11.g <= tcVar11.h - (f() / tcVar11.e)) {
                                                    this.h1 = 15;
                                                }
                                                f12 = tcVar11.g;
                                                ...
                                                scVar3 = this.a;
                                                if (scVar3 != null) {
                                                    scVar3.c0(tcVar11.a, tcVar11.f);
                                                }
                                                scVar4 = this.a;
                                                if (scVar4 != null) {
                                                    scVar4.O(tcVar11.g, tcVar11.a);
                                                }
                                            }
                                        } else {
                                            f10 = f37;
                                        ...
                                        f11 = 0.0f;
                                        if (i19 == 14) {
                                            float min8 = Math.min(1.0f, Math.max(0L, (this.f - tcVar11.f) + min3) / tcVar11.e);
                                            float g15 = (g() / tcVar11.e) + tcVar11.g;
                                            if (tcVar11 == this.v) {
                                                min8 = Math.min(min8, (f() / tcVar11.e) + tcVar11.g);
                                                if (!this.o1 && f10 > 0.0f) {
                                                    if (tcVar11.h >= (f() / tcVar11.e) + tcVar11.g) {
                                                        this.h1 = 15;
                                                    }
                                                }
                                            }
                                            ...
                                            sc scVar17 = this.a;
                                            if (scVar17 != null) {
                                                scVar17.W(tcVar11.h, tcVar11.a);
                                            }
                                        }
                                    }
                                    if (this.h1 == 15) {
                                        float min9 = f10 > f11 ? Math.min(Math.min(1.0f, Math.max(0L, (this.f - tcVar11.f) + min3) / tcVar11.e) - tcVar11.h, f10) : Math.max((Math.max(0L, this.f - tcVar11.f) / tcVar11.e) - tcVar11.g, f10);
                                        float f39 = tcVar11.g + min9;
                                        tcVar11.g = f39;
                                        tcVar11.h += min9;
                                        sc scVar18 = this.a;
                                        if (scVar18 != null) {
                                            scVar18.O(f39, tcVar11.a);
                                            this.a.c0(tcVar11.a, tcVar11.f);
                                            this.a.W(tcVar11.h, tcVar11.a);
                                        }
                                        sc scVar19 = this.a;
                                        if (scVar19 != null) {
                                            z15 = true;
                            ...
                            if (i11 == 2) {
                                ...
                                sc scVar20 = this.a;
                                if (scVar20 != null) {
                                    scVar20.D(this.h.g, false);
                                }
                                tc tcVar12 = this.h;
                                float f42 = tcVar12.h - tcVar12.g;
                                float f43 = f();
                                tc tcVar13 = this.h;
                                if (f42 > f43 / tcVar13.e) {
                                ...
                                float f45 = f();
                                tc tcVar15 = this.h;
                                if (f44 > f45 / tcVar15.e) {
                                    tcVar15.g = Math.max(0.0f, tcVar15.h - (f() / this.h.e));
                                    sc scVar23 = this.a;
                                    if (scVar23 != null) {
                                        scVar23.D(this.h.g, false);
                                    }
                                }
                            } else if (i11 == 4) {
                                float min10 = f41 > 0.0f ? Math.min(1.0f - tcVar2.h, f41) : Math.max(-tcVar2.g, f41);
                                tc tcVar16 = this.h;
                                float f46 = tcVar16.g + min10;
                                tcVar16.g = f46;
                                tcVar16.h += min10;
                                sc scVar24 = this.a;
                                if (scVar24 != null) {
                    ...
                    if (motionEvent.getAction() == 1) {
                        if ((System.currentTimeMillis() - this.f1 > ViewConfiguration.getTapTimeout() || this.m1) && this.j0) {
                            ...
                            if (this.m1 || !z10 || (scVar = this.a) == null) {
                                z11 = false;
                            } else {
                                z11 = false;
                                scVar.u(false);
                            ...
                            if (!this.X0 || this.h == null) {
                                ...
                                tc tcVar20 = this.h;
                                float f67 = tcVar20.h - tcVar20.g;
                                tcVar20.g = (1.0f - f67) * (clamp7 / getBaseDuration());
                                tc tcVar21 = this.h;
                                float f68 = tcVar21.g;
                                tcVar21.h = f67 + f68;
                                sc scVar30 = this.a;
    ...
    public final void p() {
        if (getMeasuredWidth() > 0) {
            if (this.a0 == null || this.W) {
                this.a0 = new rc(this, this.O, (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight());
                this.U = false;
                this.g0.d(1.0f, true);
            }
        }
    ...
    public final void q() {
        ...
        tc tcVar = arrayList.isEmpty() ? null : (tc) arrayList.get(0);
        this.v = tcVar;
        if (tcVar != null) {
            long j3 = tcVar.f;
        }
    ...
    public void setCollage(ArrayList<o8> arrayList) {
        ...
        while (true) {
            ...
            if (tcVar != null && (xcVar = tcVar.c) != null) {
                xcVar.b();
            }
            i10++;
        }
    ...
    public void setProgress(long j3) {
        ...
        if (tcVar != null) {
            if (j3 < this.e) {
                float f7 = j3;
                long j10 = tcVar.e;
                if (f7 <= (j10 * tcVar.g) + 240.0f) {
                }
            }
        }
        if (this.N && !this.E && tcVar == null) {
            if (j3 < this.e) {
                float f10 = j3;
                long j11 = this.R;
