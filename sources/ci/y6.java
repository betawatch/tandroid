...
public final /* synthetic */ class y6 implements j8, org.telegram.ui.Components.d5, org.telegram.ui.ActionBar.a2, t5.b, r9.g, u40 {
    ...
    public void J(int i10, int i11, boolean z10) {
        xn.s0((xn) this.c, (ArrayList) this.d, this.b, (bm0) this.e, z10, i10);
    }
    ...
    public void Q(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2, boolean z10, TLRPC.VideoSize videoSize) {
        ...
        xnVar.getConnectionsManager().sendRequest(tL_photos_uploadProfilePhoto, new ai.fa(xnVar, fileLocationArr, str, fileLocationArr2, this.b));
    }
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.a) {
            case 2:
                ...
                f60.w1(call, z10, this.b, runnable);
                break;
            default:
                ...
                if (profileActivity.getMessagesController().checkCanOpenChat(i11, ryVar)) {
                    xn xnVar = new xn(i11);
    ...
    @Override // org.telegram.ui.Components.u40
    public /* synthetic */ wu0 getCloseIntoObject() {
        return null;
    }
    ...
    public /* synthetic */ y6(a01 a01Var, long j3, ry ryVar, TLRPC.User user) {
        this.a = 3;
        this.c = a01Var;
        this.b = j3;
        this.d = ryVar;
