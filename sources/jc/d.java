...
public abstract class d {
    ...
    */
    public static void b(dc.a aVar, hc.c cVar, hc.f fVar, int i10, b bVar) {
                        ...
                        if (i29 >= 0 && g(bVar.a(i29, i27))) {
                            ...
                            while (true) {
                                ...
                                for (int i35 = 5; i34 < i35; i35 = 5) {
                                    int i36 = i34;
                                    bVar.b(i30 + i34, i31 + i33, iArr2[i36]);
                                    i34 = i36 + 1;
                                    length3 = length3;
                                }
                                i32 = i33 + 1;
                        ...
                        if (i10 != -1) {
                            switch (i10) {
                                ...
                                case 7:
                                    ...
                                    break;
                                default:
                                    throw new IllegalArgumentException(k0.i(i10, "Invalid mask pattern: "));
                            }
                        }
        ...
        throw new k("Not all bits consumed: " + i52 + '/' + aVar.b);
    }
