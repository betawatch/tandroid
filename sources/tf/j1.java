...
public class j1 {
    ...
    public final void a(CharSequence charSequence) {
        ...
        if (z4) {
            MessagesStorage.getInstance(this.m).getStorageQueue().postRunnable(new e6(27, this, this.q));
        }
    }
    ...
    */
    public final void h(final String str, boolean z4, final boolean z10, final boolean z11, boolean z12, final boolean z13, long j10, boolean z14, int i10, final int i11, final long j11, final kh khVar) {
        int i12;
        boolean z15;
        boolean z16;
        boolean z17;
                                            ...
                                            if (i1Var != null) {
                                                ...
                                                if (X0 != null) {
                                                    ...
                                                    for (int i20 = 0; i20 < m9; i20++) {
                                                        TLRPC.User user2 = (TLRPC.User) hVar4.f(X0.j(i20));
                                                        if (user2 != null) {
                                                ...
                                                if (H0 != null) {
                                                    ...
                                                    for (int i21 = 0; i21 < m10; i21++) {
                                                        TLRPC.User user3 = (TLRPC.User) hVar4.f(H0.j(i21));
                                                        if (user3 != null) {
            ...
            arrayList6.add(new Pair(tL_contacts_search, new RequestDelegate() { // from class: tf.d1
                ...
                */
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    ...
                    a0.h hVar7 = j1Var.f;
                    if (j1Var.a.t1(i11) && tL_error == null) {
                        ...
                        while (true) {
                            ...
                            while (i21 < arrayList11.size()) {
                                ...
                                if (chat2 != null) {
                                    if (z20 && ((!z21 || ChatObject.canAddBotsToChat(chat2)) && ((j1Var.p || !ChatObject.isNotInChat(chat2)) && j1Var.d(chat2)))) {
                        ...
                        if (!z25) {
                            ...
                            while (i23 < tL_contacts_found2.my_results.size()) {
                                ...
                                if (chat == null) {
                                    ...
                                    hVar5 = hVar9;
                                    if (user2 != null && !z21 && ((z22 || !user2.bot) && ((z23 || !user2.self) && user2.id != j18 && j1Var.d(user2)))) {
