...
public final class l1 implements Runnable {
    ...
    */
    public final void run() {
        ...
        dq progressDrawable = s41Var.b.h.getProgressDrawable();
        ...
        m1Var.K = ConnectionsManager.getInstance(i10).sendRequest(tL_messages_searchStickerSets, new ii1(8, this, tL_messages_searchStickerSets));
        if (Emoji.isValidEmoji(m1Var.O)) {
            TLRPC.TL_messages_getStickers tL_messages_getStickers = new TLRPC.TL_messages_getStickers();
            tL_messages_getStickers.emoticon = m1Var.O;
            tL_messages_getStickers.hash = 0L;
            m1Var.L = ConnectionsManager.getInstance(i10).sendRequest(tL_messages_getStickers, new kh.b1(this, tL_messages_getStickers, arrayList2, longSparseArray, 19));
        }
        m1Var.l();
    }
}
