...
public final class s0 extends LinearLayout {
    ...
    public s0(Context context, f6 f6Var, boolean z4) {
        ...
        j10.setTextColor(z4 ? j6.l1(0.5f, j6.v0(i10, f6Var)) : j6.v0(j6.z6, f6Var));
    ...
    public final void a(int i10, String str, TLRPC.Chat chat) {
        ...
        p9 p9Var = this.b;
        if (i10 == 0) {
            nq nqVar = new nq(j6.b0(AndroidUtilities.dp(28.0f), j6.v0(j6.Oh, this.a)), getContext().getResources().getDrawable(R.drawable.menu_hashtag).mutate());
            nqVar.s = AndroidUtilities.dp(-0.66f);
            nqVar.v = 0;
        ...
        z00Var.f = j6.w0(null, j6.Lj, false);
