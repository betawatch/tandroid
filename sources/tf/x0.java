...
public final class x0 extends FrameLayout {
    ...
    public final void b(int i10, String str, String str2) {
        ...
        if (isEmpty) {
            ...
            textViewArr[1].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagMessagesFoundChannel", i10, w2.e("@", str2)), j6.v0(j6.Oh, this.a), null));
        }
