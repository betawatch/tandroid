...
public abstract class c {
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder r10 = p.r("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            r10.append(e(e9));
            throw new j(r10.toString(), e9);
        }
    }
}
