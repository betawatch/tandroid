...
public final class r extends View {
    ...
    public final void b(float f10) {
        ...
        float a2 = h7.n.a(((f10 - dp) + (AndroidUtilities.dp(13.0f) - (this.b.getStrokeWidth() / 2.0f))) / (getWidth() - (dp * 2.0f)), 0.0f, 1.0f);
        int i10 = this.c;
        x xVar = this.e;
        xVar.m(i0.b.k(i10 != 1 ? i10 != 2 ? Color.argb(255, (int) (a2 * 255.0f), Color.green(xVar.f), Color.blue(xVar.f)) : Color.argb(255, Color.red(xVar.f), Color.green(xVar.f), (int) (a2 * 255.0f)) : Color.argb(255, Color.red(xVar.f), (int) (a2 * 255.0f), Color.blue(xVar.f)), Color.alpha(xVar.f)), 4);
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        zf.i1.x1(max, height, strokeWidth, this.d, canvas);
    }
