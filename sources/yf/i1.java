...
public abstract class i1 extends wk0 {
    ...
    public i1(Context context) {
        ...
        setLayoutManager(new f2.y(7));
        setAdapter(new g1(this, context));
        setOverScrollMode(2);
        setOnItemClickListener(new eh.j(this, 22));
    }

    public static void w1(Canvas canvas, RectF rectF, int i9) {
    ...
    public static void x1(float f10, float f11, float f12, int i9, Canvas canvas) {
        Paint paint = b3;
        paint.setColor(i9);
        ...
        path.lineTo((float) j3.r0.b(-1.5707963267948966d, rectF.width() / 2.0f, rectF.centerX()), (float) ((Math.sin(-1.5707963267948966d) * (rectF.height() / 2.0f)) + rectF.centerY()));
        path.moveTo(rectF.centerX(), rectF.centerY());
        path.lineTo((float) j3.r0.b(4.71238898038469d, rectF.width() / 2.0f, rectF.centerX()), (float) ((Math.sin(4.71238898038469d) * (rectF.height() / 2.0f)) + rectF.centerY()));
    ...
    public void setColorPalette(xf.s0 s0Var) {
        this.W2 = s0Var;
        getAdapter().l();
    }

    public void setSelectedColorIndex(int i9) {
        this.V2 = i9;
        getAdapter().l();
    }

    public final void y1(float f10, boolean z10) {
        float interpolation = z10 ? gr.g.getInterpolation(f10) : gr.i.getInterpolation(f10);
