...
public final class v extends BaseController {
    public static volatile v[] a = new v[4];
    ...
    public static TLRPC.TL_message b(TL_ephemeral.EphemeralMessage ephemeralMessage) {
        ...
        if (messageReplyHeader != null) {
            TLRPC.MessageReplyHeader messageReplyHeader2 = (TLRPC.MessageReplyHeader) TLObject.deepCopy(messageReplyHeader, new q(0));
