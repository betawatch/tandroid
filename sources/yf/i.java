...
public abstract class i extends FrameLayout {
    ...
    public i(j jVar, Context context) {
        ...
        this.c = paint3;
        this.e = new y5(this, 0L, 250L, gr.h);
        this.f = true;
                ...
                if (actionMasked == 2) {
                    ...
                    if (i9 == 3) {
                        ...
                        if (jVar.s || Math.abs(f14) > AndroidUtilities.dp(2.0f) || Math.abs(f15) > AndroidUtilities.dp(2.0f)) {
                            ...
                            int[] b10 = jVar.B.b(jVar);
                            float a2 = g7.w.a(b10[0], b10[1], jVar.b, jVar.c);
                            float a3 = g7.w.a(b10[0], b10[1], f10, f11);
                            float f16 = 0.0f;
                            if (a2 > 0.0f) {
                                jVar.j(a3 / a2);
                            }
