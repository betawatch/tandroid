...
public final class j0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (childAt.getAlpha() != 0.0f) {
            ...
            View view = childAt;
            if (i10 != -1) {
                ViewGroup viewGroup = i10 == 0 ? xs0Var.p1 : i10 == 2 ? xs0Var.q1 : null;
                ...
                x10 = AndroidUtilities.lerp(x10, (((childAt2.getWidth() - childAt2.getPaddingLeft()) - childAt2.getPaddingRight()) / 2.0f) + childAt2.getX() + childAt2.getPaddingLeft(), xs0Var.e1);
                y10 = AndroidUtilities.lerp(y10, (((childAt2.getHeight() - childAt2.getPaddingTop()) - childAt2.getPaddingBottom()) / 2.0f) + childAt2.getY() + childAt2.getPaddingTop(), xs0Var.e1);
            }
            if (i0Var != null && i0Var.getChildCount() > 0) {
                ...
                i9 = i0.a.d(xs0Var.J1, q1Var.a, xs0Var.R1.b(0));
            }
            float f10 = x10;
            float f11 = y10;
