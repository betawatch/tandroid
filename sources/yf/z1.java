...
public final class z1 extends i {
    ...
    public /* synthetic */ z1(j jVar, Context context, int i9) {
        super(jVar, context);
        this.n = i9;
    }
    ...
    public final int a(float f10, float f11) {
        switch (this.n) {
            case 0:
                ...
                float f12 = dp + dp2;
                float f13 = f12 * 2.0f;
                float A = e2.c.A(getMeasuredHeight(), f13, 2.0f, f12);
                if (f10 <= f12 - dp2 || f11 <= A - dp2 || f10 >= f12 + dp2 || f11 >= A + dp2) {
                    if (f10 <= ((getMeasuredWidth() - f13) + f12) - dp2 || f11 <= A - dp2 || f10 >= (getMeasuredWidth() - f13) + f12 + dp2 || f11 >= A + dp2) {
            ...
            case 1:
                ...
                float f14 = dp3 + dp4;
                float f15 = f14 * 2.0f;
                float A2 = e2.c.A(getMeasuredHeight(), f15, 2.0f, f14);
                if (f10 <= f14 - dp4 || f11 <= A2 - dp4 || f10 >= f14 + dp4 || f11 >= A2 + dp4) {
                    if (f10 <= ((getMeasuredWidth() - f15) + f14) - dp4 || f11 <= A2 - dp4 || f10 >= (getMeasuredWidth() - f15) + f14 + dp4 || f11 >= A2 + dp4) {
                        if (Math.pow(f11 - r0, 2.0d) + Math.pow(f10 - r0, 2.0d) < Math.pow(getMeasuredWidth() / 2.0f, 2.0d)) {
                        }
                    }
                }
            ...
            default:
                ...
                float f16 = dp5 + dp6;
                float f17 = f16 * 2.0f;
                float A3 = e2.c.A(getMeasuredHeight(), f17, 2.0f, f16);
                if (f10 <= f16 - dp6 || f11 <= A3 - dp6 || f10 >= f16 + dp6 || f11 >= A3 + dp6) {
                    if (f10 <= ((getMeasuredWidth() - f17) + f16) - dp6 || f11 <= A3 - dp6 || f10 >= (getMeasuredWidth() - f17) + f16 + dp6 || f11 >= A3 + dp6) {
                        if (Math.pow(f11 - r0, 2.0d) + Math.pow(f10 - r0, 2.0d) < Math.pow(getMeasuredWidth() / 2.0f, 2.0d)) {
                        }
                    }
                }
