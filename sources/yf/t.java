...
public final class t extends View {
    ...
    public t(x xVar, Context context) {
        ...
        for (int i10 = 0; i10 < 12; i10++) {
            for (int i11 = 0; i11 < 10; i11++) {
                if (i11 == 0) {
                    this.n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(i0.b.d(i10 / 11.0f, -1, -16777216)));
                } else {
                    this.n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(i11 < 6 ? i0.b.d(((5 - i11) / 4.0f) * 0.5f, this.b[i10], -16777216) : i0.b.d(rl.c(9 - i11, 5.0f, 0.5f, 0.5f), this.b[i10], -1)));
                }
            }
        }
    }
    ...
    public final void c(MotionEvent motionEvent) {
        ...
        Integer num = (Integer) this.n.get(Long.valueOf((x8 << 16) + y10));
        if (num != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            paint2.setStrokeWidth(er.h.getInterpolation(min) * AndroidUtilities.dp(3.0f));
            Path path2 = this.f;
            path2.rewind();
