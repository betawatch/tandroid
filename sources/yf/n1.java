    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.a) {
            ...
            if (LocaleController.isRTL) {
                this.b.setBounds(AndroidUtilities.dp(7.0f), y10, AndroidUtilities.dp(23.0f), AndroidUtilities.dp(16.0f) + y10);
            } else {
                this.b.setBounds(getWidth() - AndroidUtilities.dp(23.0f), y10, getWidth() - AndroidUtilities.dp(7.0f), AndroidUtilities.dp(16.0f) + y10);
            }
            this.b.draw(canvas);
        }
    }
