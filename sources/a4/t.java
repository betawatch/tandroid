...
public abstract class t extends j3.e {
    ...
    public final boolean N(t0 t0Var) {
        if (d0.a >= 23 && this.I != null && this.o0 != 3 && getState() != 0) {
    ...
    public final boolean a(long j10, long j11) {
        ...
        if (i10 > 0) {
            iVar = iVar2;
            if (!C(j10, j11, null, iVar2.b, this.e0, 0, i10, iVar2.d, iVar2.isDecodeOnly(), iVar2.isEndOfStream(), this.A)) {
                return false;
            }
            z(iVar.n);
            iVar.clear();
        ...
        return iVar.r > 0 || this.u0 || this.k0;
    }
    ...
    public final boolean g() {
        ...
        long j10;
        n nVar = this.I;
        if (nVar != null && this.n0 != 2 && !this.u0) {
            if (this.d0 < 0) {
                int e10 = nVar.e();
                this.d0 = e10;
                if (e10 >= 0) {
                    this.e.b = this.I.getInputBuffer(e10);
                    this.e.clear();
                }
            }
            if (this.n0 == 1) {
                ...
                if (readSource != -3) {
                    ...
                    if (!this.e.isEndOfStream()) {
                        if (this.p0 || this.e.isKeyFrame()) {
                            ...
                            if (jVar != null) {
                                ...
                                if (!jVar.c) {
                                    ...
                                    if (i17 == -1) {
                                        ...
                                        z10 = flag;
                                        long max = jVar.a + Math.max(0L, ((jVar.b - 529) * 1000000) / t0Var.P);
                                        jVar.b += i17;
                                        j11 = max;
                                        long j12 = this.s0;
                                        j jVar2 = this.b0;
                                        t0 t0Var2 = this.y;
                                        jVar2.getClass();
                                        long max2 = Math.max(j12, Math.max(0L, ((jVar2.b - 529) * 1000000) / t0Var2.P) + jVar2.a);
                                        tVar = this;
                                        tVar.s0 = max2;
                                        j10 = j11;
                                    }
                                ...
                                t0 t0Var22 = this.y;
                                jVar22.getClass();
                                long max22 = Math.max(j122, Math.max(0L, ((jVar22.b - 529) * 1000000) / t0Var22.P) + jVar22.a);
                                tVar = this;
                                tVar.s0 = max22;
                                j10 = j11;
                            } else {
                            ...
                            if (tVar.e.isDecodeOnly()) {
                                tVar.r.add(Long.valueOf(j10));
                            }
                            if (tVar.w0) {
                                f5.b0 b0Var = tVar.n;
                                t0 t0Var3 = tVar.y;
                                synchronized (b0Var) {
                                    if (b0Var.b > 0) {
                                        if (j10 <= ((long[]) b0Var.c)[((b0Var.a + r4) - 1) % ((Object[]) b0Var.d).length]) {
                                            b0Var.b();
                                        }
                                    }
                                    b0Var.c();
                                    ...
                                    ((long[]) b0Var.c)[length] = j10;
                                    objArr[length] = t0Var3;
                                    b0Var.b = i19 + 1;
                                }
                                tVar.w0 = false;
                            }
                            tVar.s0 = Math.max(tVar.s0, j10);
                            tVar.e.c();
                            if (tVar.e.hasSupplementalData()) {
                                tVar.p(tVar.e);
                            }
                            tVar.onQueueInputBuffer(tVar.e);
                            try {
                                if (z10) {
                                    tVar.I.b(tVar.d0, tVar.e.a, j10);
                                } else {
                                    tVar.I.c(j10, tVar.d0, tVar.e.b.limit(), 0);
                                }
                                tVar.d0 = -1;
                                tVar.e.b = null;
                                tVar.p0 = true;
                                ...
                                throw tVar.createRendererException(e11, tVar.y, d0.q(e11.getErrorCode()));
                            }
                        }
                        this.e.clear();
                        if (this.m0 == 2) {
                    ...
                    try {
                        ...
                        throw createRendererException(e12, this.y, d0.q(e12.getErrorCode()));
                    }
                }
            } catch (m3.h e13) {
                t(e13);
    ...
    public final List j(boolean z10) {
        ...
        ArrayList m11 = m(uVar, this.y, false);
        if (!m11.isEmpty()) {
            f5.a.K("MediaCodecRenderer", "Drm session requires secure decoder for " + this.y.B + ", but no secure decoder available. Trying to proceed with " + m11 + ".");
        }
        return m11;
    }
    ...
    public final n3.j n(n3.e eVar) {
        ...
        throw createRendererException(new IllegalArgumentException("Expecting FrameworkCryptoConfig but found: " + E), this.y, 6001);
    }
    ...
    public final void onStreamChanged(t0[] t0VarArr, long j10, long j11) {
        if (this.B0 == -9223372036854775807L) {
            f5.a.i(this.A0 == -9223372036854775807L);
            this.A0 = j10;
            J(j11);
            return;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x033d A[ADDED_TO_REGION] */
    ...
    */
    public final void q(q qVar, MediaCrypto mediaCrypto) {
        long j10;
        float f9;
        long j11;
        int i10;
        ...
        l o10 = o(qVar, this.y, mediaCrypto, l10);
        if (i11 >= 31) {
            r.a(o10, getPlayerId());
        }
        try {
            f5.a.c("createCodec:" + str2);
            this.I = this.a.x(o10);
            f5.a.q();
            ...
            if (qVar.d(this.y)) {
                ...
                if (t0Var == null) {
                    ...
                    int i17 = t0Var.d;
                    int i18 = t0Var.e;
                    StringBuilder n10 = com.google.android.recaptcha.internal.a.n("id=");
                    n10.append(t0Var.a);
                    n10.append(", mimeType=");
                    n10.append(t0Var.B);
                    int i19 = -1;
                    ...
                    if (cVar2 != null) {
                        ...
                        n10.append(", drm=[");
                        new com.google.android.gms.internal.clearcut.e(String.valueOf(','), 1).a(n10, linkedHashSet);
                        n10.append(']');
                        i19 = -1;
                    } else {
                        c3 = ',';
                    ...
                    if (i17 != 0) {
                        ...
                        new com.google.android.gms.internal.clearcut.e(String.valueOf(c3), 1).a(n10, arrayList);
                        n10.append("]");
                    }
                    if (i18 != 0) {
                        ...
                        new com.google.android.gms.internal.clearcut.e(String.valueOf(c3), 1).a(n10, arrayList2);
                        n10.append("]");
                    }
                    sb2 = n10.toString();
                }
                Locale locale = Locale.US;
                f5.a.K("MediaCodecRenderer", th.j("Format exceeds selected codec's capabilities [", sb2, ", ", str2, "]"));
            }
            this.P = qVar;
            this.M = f9;
            this.J = this.y;
            ...
            if (i21 <= 25 && "OMX.Exynos.avc.dec.secure".equals(str2)) {
                ...
                if (str6.startsWith("SM-T585") || str6.startsWith("SM-A510") || str6.startsWith("SM-A520") || str6.startsWith("SM-J700")) {
                    ...
                    this.S = i21 >= 18 || (i21 == 18 && ("OMX.SEC.avc.dec".equals(str2) || "OMX.SEC.avc.dec.secure".equals(str2))) || (i21 == 19 && d0.d.startsWith("SM-G800") && ("OMX.Exynos.avc.dec".equals(str2) || "OMX.Exynos.avc.dec.secure".equals(str2)));
                    ...
                    if (i21 <= 23 || !"OMX.google.vorbis.decoder".equals(str2)) {
                        ...
                        if (i21 < 21 && "OMX.SEC.mp3.dec".equals(str2) && "samsung".equals(d0.c)) {
                            str = d0.b;
        ...
        if (eVar != null) {
            ...
            if (n3.j.a) {
                ...
                if (t10 == 1) {
                    n3.d D = this.B.D();
                    D.getClass();
                    throw createRendererException(D, this.y, D.a);
                }
                if (t10 != 4) {
                    return;
                }
        ...
        if (this.N == null) {
            try {
                ...
                if (!arrayList.isEmpty()) {
                    this.N.add((q) arrayList.get(0));
                }
                this.O = null;
            } catch (y e10) {
                throw new s(this.y, e10, z10, -49998);
            }
        }
        if (this.N.isEmpty()) {
            throw new s(this.y, null, z10, -49999);
        }
        q qVar = (q) this.N.peekFirst();
        while (this.I == null) {
            q qVar2 = (q) this.N.peekFirst();
            if (!K(qVar2)) {
                return;
            }
            try {
                ...
                try {
                    f5.a.K("MediaCodecRenderer", "Preferred decoder instantiation failed. Sleeping for 50ms then retrying.");
                    Thread.sleep(50L);
                    q(qVar2, mediaCrypto);
                } catch (Exception e12) {
                    f5.a.L("MediaCodecRenderer", "Failed to initialize decoder: " + qVar2, e12);
                    this.N.removeFirst();
                    t0 t0Var = this.y;
                    String str2 = "Decoder init failed: " + qVar2.a + ", " + t0Var;
                    String str3 = t0Var.B;
                    if (d0.a < 21) {
                    ...
                    s sVar2 = new s(str2, e12, str3, z10, qVar2, str);
                    t(sVar2);
                    sVar = this.O;
                    if (sVar != null) {
                        this.O = sVar2;
                    } else {
                        this.O = new s(sVar.getMessage(), sVar.getCause(), sVar.a, sVar.b, sVar.c, sVar.d);
                    }
                    if (!this.N.isEmpty()) {
                        throw this.O;
                    }
                ...
                this.N.removeFirst();
                t0 t0Var2 = this.y;
                String str22 = "Decoder init failed: " + qVar2.a + ", " + t0Var2;
                String str32 = t0Var2.B;
                if (d0.a < 21) {
                }
                s sVar22 = new s(str22, e12, str32, z10, qVar2, str);
                t(sVar22);
                sVar = this.O;
                if (sVar != null) {
                }
    ...
    */
    public m3.l w(u0 u0Var) {
        ...
        n3.e eVar2 = this.B;
        if (eVar2 != eVar) {
            if (eVar != null && eVar2 != null && eVar.e().equals(eVar2.e()) && d0.a >= 23) {
                UUID uuid = j3.h.e;
                if (!uuid.equals(eVar2.e()) && !uuid.equals(eVar.e())) {
                    n(eVar);
                }
            }
            if (this.p0) {
            ...
            return new m3.l(qVar.a, t0Var2, t0Var, 0, 128);
        }
        int i10 = 0;
        boolean z11 = this.C != this.B;
        f5.a.i(!z11 || d0.a >= 23);
        m3.l b10 = b(qVar, t0Var2, t0Var);
        int i11 = b10.d;
        if (i11 != 0) {
            if (i11 == 1) {
                if (N(t0Var)) {
        ...
        return (i11 == 0 || (this.I == nVar && this.o0 != 3)) ? b10 : new m3.l(qVar.a, t0Var2, t0Var, 0, i10);
    }
