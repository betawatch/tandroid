...
public abstract class n {
    public static SpannableStringBuilder a(String str) {
        try {
            Spanned fromHtml = Build.VERSION.SDK_INT >= 24 ? Html.fromHtml("<inject>" + str + "</inject>", 63, null, new l(new db.a(11))) : Html.fromHtml("<inject>" + str + "</inject>", null, new l(new db.a(11)));
            if (fromHtml == null) {
                return null;
            }
            ...
            for (int i12 = 0; i12 < arrayList3.size(); i12++) {
                ...
                bj0.c(spannableStringBuilder, fromHtml.getSpanStart(mVar3), fromHtml.getSpanEnd(mVar3), mVar3.a == 3);
            }
            return spannableStringBuilder;
        } catch (Exception e6) {
            FileLog.e("Html.fromHtml", e6);
            return null;
        }
    }
}
