...
public final class g extends jf.a {
    ...
    public static c5.a c(e eVar) {
        b b10 = eVar.b();
        eVar.c(3, b.c);
        return new c5.a(2, eVar.d(200, b10), eVar.c((int) eVar.a.e(), b10));
    }
        ...
        switch (str2) {
            ...
            case "APIC":
                if (this.o == null || this.r != 3) {
                    b b10 = eVar.b();
                    android.support.v4.media.c cVar = eVar.d;
                    if (eVar.b.a == 2) {
                    ...
                    int i13 = 0;
                    while (i13 < e) {
                        int read = ((com.google.firebase.messaging.d) cVar.b).read(bArr, i13, e - i13);
                        if (read <= 0) {
                            throw new EOFException();
                        }
                        i13 += read;
                    }
                    if (this.o == null || s02 == 3 || s02 == 0) {
                        try {
