        ...
        switch (str2) {
            ...
            case "APIC":
                if (this.o == null || this.r != 3) {
                    ...
                    int i13 = 0;
                    while (i13 < e) {
                        int read = ((com.google.firebase.messaging.d) gVar.b).read(bArr, i13, e - i13);
                        if (read <= 0) {
                            throw new EOFException();
                        }
                        i13 += read;
                    }
                    if (this.o == null || F == 3 || F == 0) {
                        try {
                ...
                if (e7.length() > 0) {
                    ...
                    try {
                        if (e7.charAt(0) == '(') {
                            ...
                            if (indexOf > 1 && (i10 = hc.b.b(Integer.parseInt(e7.substring(1, indexOf)))) == 0 && e7.length() > (i12 = indexOf + 1)) {
                                this.h = e7.substring(i12);
                            }
                        } else {
                            i10 = hc.b.b(Integer.parseInt(e7));
                        }
                        if (i10 != 0) {
                            this.h = hc.b.d(i10);
                            return;
