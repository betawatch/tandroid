...
public abstract class r {
    ...
    public static void c(Rect rect, float f10, float f11, int i10, int i11, int i12) {
        int i13 = i12 & 7;
        int round = i13 != 3 ? i13 != 5 ? Math.round(f10 - (i10 / 2.0f)) : Math.round(f10 - i10) : Math.round(f10);
        int i14 = i12 & 112;
        int round2 = i14 != 48 ? i14 != 80 ? Math.round(f11 - (i11 / 2.0f)) : Math.round(f11 - i11) : Math.round(f11);
