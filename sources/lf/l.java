...
public final class l {
    ...
    public l(int i10, int i11, int i12) {
        ...
        this.a = i13;
        if (i13 == 1) {
            throw new j("Reserved version");
        }
        int i14 = (i10 >> 1) & 3;
        this.b = i14;
        if (i14 == 0) {
            throw new j("Reserved layer");
        }
        int i15 = (i11 >> 4) & 15;
        this.d = i15;
        if (i15 == 15) {
            throw new j("Reserved bitrate");
        }
        if (i15 == 0) {
            throw new j("Free bitrate");
        }
        int i16 = (i11 >> 2) & 3;
        this.c = i16;
        if (i16 == 3) {
            throw new j("Reserved frequency");
        }
        int i17 = (i12 >> 6) & 3;
        this.e = i17;
        this.f = (i11 >> 1) & 1;
        ...
        if (b() < i19) {
            throw new j(hc.b.j(i19, "Frame size must be at least "));
        }
    }
    ...
    public final boolean d(l lVar) {
        return this.b == lVar.b && this.a == lVar.a && this.c == lVar.c && this.e == lVar.e;
    }
}
