...
public abstract class g extends m {
    ...
    public static final void g(Iterable iterable, StringBuilder sb2, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, CharSequence charSequence4, bd.l lVar) {
    ...
    public static String h(Iterable iterable, String str, String str2, String str3, bd.l lVar, int i10) {
        if ((i10 & 1) != 0) {
            str = ", ";
        }
        String str4 = str;
    ...
    public static List i(Iterable iterable, int i10) {
        ...
        kotlin.jvm.internal.j.e(iterable, "<this>");
        if (i10 < 0) {
            throw new IllegalArgumentException(l1.l(i10, "Requested element count ", " is less than zero.").toString());
        }
        o oVar = o.a;
        if (i10 == 0) {
            return oVar;
        ...
        return size != 0 ? size != 1 ? arrayList : m7.a(arrayList.get(0)) : oVar;
    }
    ...
    public static List m(Iterable iterable) {
        ...
        if (z10) {
            ...
            return m7.a(iterable instanceof List ? ((List) iterable).get(0) : collection.iterator().next());
        }
        if (z10) {
        ...
        return size2 != 0 ? size2 != 1 ? arrayList : m7.a(arrayList.get(0)) : oVar;
    }
