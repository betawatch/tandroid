...
public final class e extends AbstractList implements List {
    ...
    public final boolean addAll(int i10, Collection elements) {
        ...
        if (i10 >= ((this.c + 1) >> 1)) {
            ...
            if (r9 < r6) {
                ...
                if (i13 <= objArr.length) {
                    f.c(i12, r9, r6, objArr, objArr);
                } else if (i12 >= objArr.length) {
                    f.c(i12 - objArr.length, r9, r6, objArr, objArr);
                } else {
                    int length = r6 - (i13 - objArr.length);
                    f.c(0, length, r6, objArr, objArr);
                    Object[] objArr2 = this.b;
                    f.c(i12, r9, length, objArr2, objArr2);
                }
            } else {
                Object[] objArr3 = this.b;
                f.c(size, 0, r6, objArr3, objArr3);
                Object[] objArr4 = this.b;
                if (i12 >= objArr4.length) {
                    f.c(i12 - objArr4.length, r9, objArr4.length, objArr4, objArr4);
                } else {
                    f.c(0, objArr4.length - size, objArr4.length, objArr4, objArr4);
                    Object[] objArr5 = this.b;
                    f.c(i12, r9, objArr5.length - size, objArr5, objArr5);
                }
            }
            i(r9, elements);
            return true;
        ...
        if (r9 < i14) {
            ...
            if (size >= r9) {
                Object[] objArr7 = this.b;
                f.c(objArr7.length - size, 0, r9, objArr7, objArr7);
            } else {
                Object[] objArr8 = this.b;
                f.c(objArr8.length - size, 0, size, objArr8, objArr8);
                Object[] objArr9 = this.b;
                f.c(0, size, r9, objArr9, objArr9);
            }
        } else if (i15 >= 0) {
            Object[] objArr10 = this.b;
            f.c(i15, i14, r9, objArr10, objArr10);
        } else {
            ...
            if (length2 >= i16) {
                f.c(i15, i14, r9, objArr11, objArr11);
            } else {
                f.c(i15, i14, i14 + length2, objArr11, objArr11);
                Object[] objArr12 = this.b;
                f.c(0, this.a + length2, r9, objArr12, objArr12);
            }
        }
        this.a = i15;
    ...
    public final void removeRange(int i10, int i11) {
        ...
        s();
        if (i10 < this.c - i11) {
            int r6 = r((i10 - 1) + this.a);
            int r9 = r((i11 - 1) + this.a);
            while (i10 > 0) {
                int i13 = r6 + 1;
            ...
            int r10 = r(this.a + i12);
            q(this.a, r10);
            this.a = r10;
        } else {
            int r11 = r(this.a + i11);
            int r12 = r(this.a + i10);
            int i16 = this.c;
            while (true) {
                i16 -= i11;
                if (i16 <= 0) {
    ...
    public final Object[] toArray(Object[] array) {
        ...
        int i11 = this.a;
        if (i11 < r6) {
            f.d(i11, r6, 2, this.b, array);
        } else if (!isEmpty()) {
            Object[] objArr = this.b;
            f.c(0, this.a, objArr.length, objArr, array);
            Object[] objArr2 = this.b;
            f.c(objArr2.length - this.a, 0, r6, objArr2, array);
        }
        int i12 = this.c;
        if (i12 < array.length) {
            array[i12] = null;
