    ...
    */
    public static Date b(String str, ParsePosition parsePosition) {
        ...
        try {
            ...
            ParseException parseException = new ParseException(i0.a.n("Failed to parse date [", str3, "]: ", message), parsePosition.getIndex());
            ...
            message = "(" + e.getClass().getName() + ")";
            ParseException parseException2 = new ParseException(i0.a.n("Failed to parse date [", str3, "]: ", message), parsePosition.getIndex());
