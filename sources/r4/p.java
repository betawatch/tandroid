...
public final class p implements s0 {
    ...
    public static n3.c b(String str, n3.b[] bVarArr) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            ...
            bVarArr2[i10] = new n3.b(bVar.b, bVar.c, bVar.d, null);
        }
    ...
    public static n3.b c(String str, String str2, HashMap hashMap) {
        ...
        if ("com.widevine".equals(str2)) {
            UUID uuid = j3.h.d;
            int i10 = d0.a;
            return new n3.b(uuid, null, "hls", str.getBytes(p8.d.c));
        }
    ...
    */
    public static j e(m mVar, j jVar, g0 g0Var, String str) {
        ArrayList arrayList;
        i iVar;
        g gVar;
        long j10;
        ...
        while (g0Var.v()) {
            String y8 = g0Var.y();
            if (y8.startsWith("#EXT")) {
                arrayList7.add(y8);
            }
            if (y8.startsWith("#EXT-X-PLAYLIST-TYPE")) {
                String k9 = k(y8, H, hashMap);
                if ("VOD".equals(k9)) {
                    i12 = 1;
                } else if ("EVENT".equals(k9)) {
                    i12 = 2;
                }
            } else if (y8.equals("#EXT-X-I-FRAMES-ONLY")) {
                z16 = true;
            } else {
                if (y8.startsWith("#EXT-X-START")) {
                    double parseDouble = Double.parseDouble(k(y8, T, Collections.EMPTY_MAP));
                    ...
                    arrayList = arrayList7;
                    iVar = iVar2;
                    if (y8.startsWith("#EXT-X-SERVER-CONTROL")) {
                        double h10 = h(y8, I);
                        ...
                        double h12 = h(y8, M);
                        iVar = new i(j25, g10, j26, h12 == -9.223372036854776E18d ? -9223372036854775807L : (long) (h12 * 1000000.0d), g(y8, N));
                    } else if (y8.startsWith("#EXT-X-PART-INF")) {
                        j23 = (long) (Double.parseDouble(k(y8, F, Collections.EMPTY_MAP)) * 1000000.0d);
                    } else {
                        boolean startsWith = y8.startsWith("#EXT-X-MAP");
                        Pattern pattern = V;
                        boolean z18 = z13;
                        Pattern pattern2 = b0;
                        if (startsWith) {
                            String k10 = k(y8, pattern2, hashMap);
                            String j27 = j(y8, pattern, null, hashMap);
                            if (j27 != null) {
                                int i16 = d0.a;
                            ...
                            String str10 = str7;
                            g gVar4 = new g(k10, j17, j28, str10, str8);
                            str7 = str10;
                            String str11 = str8;
                            if (j28 != -1) {
                                j17 += j28;
                            ...
                            if (y8.startsWith("#EXT-X-TARGETDURATION")) {
                                j22 = Integer.parseInt(k(y8, D, Collections.EMPTY_MAP)) * 1000000;
                            } else if (y8.startsWith("#EXT-X-MEDIA-SEQUENCE")) {
                                j16 = Long.parseLong(k(y8, O, Collections.EMPTY_MAP));
                                j24 = j16;
                            } else if (y8.startsWith("#EXT-X-VERSION")) {
                                i15 = Integer.parseInt(k(y8, G, Collections.EMPTY_MAP));
                            } else {
                                if (y8.startsWith("#EXT-X-DEFINE")) {
                                    String j29 = j(y8, r0, null, hashMap);
                                    if (j29 != null) {
                                        ...
                                        hashMap.put(k(y8, g0, hashMap), k(y8, q0, hashMap));
                                    }
                                    gVar = gVar3;
                                    j10 = j14;
                                    str2 = str7;
                                    j11 = j21;
                                    str3 = str9;
                                } else if (y8.startsWith("#EXTINF")) {
                                    j19 = new BigDecimal(k(y8, P, Collections.EMPTY_MAP)).multiply(new BigDecimal(1000000L)).longValue();
                                    str6 = j(y8, Q, "", hashMap);
                                } else if (y8.startsWith("#EXT-X-SKIP")) {
                                    int parseInt = Integer.parseInt(k(y8, K, Collections.EMPTY_MAP));
                                    f5.a.i(jVar2 != null && arrayList4.isEmpty());
                                    int i17 = d0.a;
                                    long j30 = jVar2.k;
                                    z zVar = jVar2.r;
                                    int i18 = (int) (j24 - j30);
                                    ...
                                    j18 = j31;
                                } else if (y8.startsWith("#EXT-X-KEY")) {
                                    String k11 = k(y8, Y, hashMap);
                                    String j35 = j(y8, Z, "identity", hashMap);
                                    if ("NONE".equals(k11)) {
                                        treeMap.clear();
                                        cVar5 = null;
                                        str7 = null;
                                        ...
                                        String j36 = j(y8, c0, null, hashMap);
                                        if (!"identity".equals(j35)) {
                                            String str16 = str9;
                                            str9 = str16 == null ? ("SAMPLE-AES-CENC".equals(k11) || "SAMPLE-AES-CTR".equals(k11)) ? "cenc" : "cbcs" : str16;
                                            n3.b c6 = c(y8, j35, hashMap);
                                            if (c6 != null) {
                                                treeMap.put(j35, c6);
                                                str8 = j36;
                                                cVar5 = null;
                                    ...
                                    str3 = str9;
                                    if (y8.startsWith("#EXT-X-BYTERANGE")) {
                                        String k12 = k(y8, U, hashMap);
                                        int i23 = d0.a;
                                    ...
                                    } else if (y8.startsWith("#EXT-X-DISCONTINUITY-SEQUENCE")) {
                                        i14 = Integer.parseInt(y8.substring(y8.indexOf(58) + 1));
                                        mVar2 = mVar;
                                        jVar2 = jVar;
                                        str9 = str3;
                                        iVar2 = iVar;
                                        ...
                                        arrayList5 = arrayList8;
                                        z15 = true;
                                    } else if (y8.equals("#EXT-X-DISCONTINUITY")) {
                                        i13++;
                                    } else if (y8.startsWith("#EXT-X-PROGRAM-DATE-TIME")) {
                                        if (j15 == 0) {
                                            j15 = d0.H(d0.K(y8.substring(y8.indexOf(58) + 1))) - j18;
                                        } else {
                                            gVar = gVar3;
                                            j10 = j14;
                                            str2 = str7;
                                        ...
                                        arrayList5 = arrayList8;
                                        z17 = true;
                                    } else if (y8.equals("#EXT-X-INDEPENDENT-SEGMENTS")) {
                                        mVar2 = mVar;
                                        jVar2 = jVar;
                                        str9 = str3;
                                        iVar2 = iVar;
                                        ...
                                        arrayList5 = arrayList8;
                                        z12 = true;
                                    } else if (y8.equals("#EXT-X-ENDLIST")) {
                                        mVar2 = mVar;
                                        jVar2 = jVar;
                                        str9 = str3;
                                        iVar2 = iVar;
                                        ...
                                        if (y8.startsWith("#EXT-X-RENDITION-REPORT")) {
                                            long i24 = i(y8, R);
                                            Matcher matcher = S.matcher(y8);
                                            if (matcher.find()) {
                                            ...
                                            f fVar = new f(Uri.parse(f5.a.G(str, k(y8, pattern2, hashMap))), i24, i10);
                                            arrayList2 = arrayList9;
                                            arrayList2.add(fVar);
                                        } else {
                                            arrayList2 = arrayList9;
                                            if (!y8.startsWith("#EXT-X-PRELOAD-HINT")) {
                                                n3.c cVar8 = cVar6;
                                                g gVar7 = gVar3;
                                                if (y8.startsWith("#EXT-X-PART")) {
                                                    String hexString = str7 == null ? null : str12 != null ? str12 : Long.toHexString(j16);
                                                    String k13 = k(y8, pattern2, hashMap);
                                                    long parseDouble2 = (long) (Double.parseDouble(k(y8, E, Collections.EMPTY_MAP)) * 1000000.0d);
                                                    boolean g11 = g(y8, n0) | (z12 && arrayList8.isEmpty());
                                                    boolean g12 = g(y8, o0);
                                                    String j37 = j(y8, pattern, null, hashMap);
                                                    if (j37 != null) {
                                                        int i25 = d0.a;
                                                    ...
                                                    if (cVar5 != null || treeMap.isEmpty()) {
                                                        cVar2 = cVar5;
                                                    } else {
                                                        n3.b[] bVarArr = (n3.b[]) treeMap.values().toArray(new n3.b[0]);
                                                        n3.c cVar9 = new n3.c(str3, true, bVarArr);
                                                        if (cVar8 == null) {
                                                            cVar8 = b(str3, bVarArr);
                                                        }
                                                        cVar2 = cVar9;
                                                    }
                                                    long j39 = j14;
                                                    arrayList8.add(new e(k13, gVar7, parseDouble2, i13, j39, cVar2, str7, hexString, j38, j12, g12, g11, false));
                                                    ...
                                                    if (y8.startsWith("#")) {
                                                        ...
                                                        if (cVar5 != null || treeMap.isEmpty()) {
                                                            ...
                                                            cVar3 = cVar8;
                                                            str5 = l10;
                                                            n3.b[] bVarArr2 = (n3.b[]) treeMap.values().toArray(new n3.b[0]);
                                                            n3.c cVar10 = new n3.c(str3, true, bVarArr2);
                                                            if (cVar3 == null) {
                                                                cVar4 = b(str3, bVarArr2);
                                                                cVar5 = cVar10;
                                                                int i26 = i13;
                                                                String str17 = str7;
                                                                long j41 = j21;
                                                                ...
                                                                n3.c cVar11 = cVar5;
                                                                i13 = i26;
                                                                arrayList4.add(new g(str5, gVar == null ? gVar : gVar2, str6, j44, i26, j43, cVar11, str17, hexString2, j42, j41, z17, arrayList3));
                                                                j14 = j43 + j44;
                                                        ...
                                                        n3.c cVar112 = cVar5;
                                                        i13 = i262;
                                                        arrayList4.add(new g(str5, gVar == null ? gVar : gVar2, str6, j442, i262, j432, cVar112, str172, hexString2, j422, j412, z17, arrayList3));
                                                        j14 = j432 + j442;
                                            ...
                                            } else if (eVar == null && "PART".equals(k(y8, e0, hashMap))) {
                                                n3.c cVar12 = cVar6;
                                                g gVar9 = gVar3;
                                                String k14 = k(y8, pattern2, hashMap);
                                                long i27 = i(y8, W);
                                                long i28 = i(y8, X);
                                                ...
                                                if (cVar5 != null || treeMap.isEmpty()) {
                                                    ...
                                                    n3.b[] bVarArr3 = (n3.b[]) treeMap.values().toArray(new n3.b[0]);
                                                    n3.c cVar13 = new n3.c(str3, true, bVarArr3);
                                                    if (cVar12 == null) {
                                                        cVar12 = b(str3, bVarArr3);
                                                    }
                                                    cVar = cVar13;
                                                }
                                                if (i27 == -1 || i28 != -1) {
                                                    long j45 = j14;
                                                    j14 = j45;
                                                    eVar = new e(k14, gVar9, 0L, i13, j45, cVar, str7, hexString3, i27 != -1 ? i27 : 0L, i28, false, false, true);
                                                }
                                                arrayList6 = arrayList2;
                                                str9 = str3;
                                                gVar3 = gVar9;
        ...
        for (int i29 = 0; i29 < arrayList12.size(); i29++) {
            ...
            if (i30 == -1 && j23 != -9223372036854775807L) {
                i30 = (arrayList14.isEmpty() ? ((g) q8.l.g(arrayList4)).x : arrayList14).size() - 1;
            }
            Uri uri = fVar2.a;
        ...
        return new j(i12, str, arrayList13, j13, z19, j15, z15, i14, j24, i15, j22, j23, z12, z14, j15 != 0, cVar6, arrayList4, arrayList14, iVar3, hashMap3);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static m f(g0 g0Var, String str) {
        int i10;
        int i11;
        char c3;
        ArrayList arrayList;
        ...
        while (true) {
            ...
            if (!v10) {
                ...
                for (int i15 = 0; i15 < arrayList24.size(); i15++) {
                    ...
                    if (hashSet.add(uri)) {
                        ...
                        b4.c cVar = new b4.c(new u(null, null, arrayList26));
                        j3.s0 a2 = t0Var.a();
                        a2.i = cVar;
                ...
                while (i16 < arrayList18.size()) {
                    ...
                    String k9 = k(str6, h0, hashMap4);
                    String k10 = k(str6, pattern2, hashMap4);
                    ...
                    Uri H3 = j11 == null ? null : f5.a.H(str5, j11);
                    arrayList18 = arrayList27;
                    b4.c cVar2 = new b4.c(new u(k9, k10, Collections.EMPTY_LIST));
                    String k11 = k(str6, d0, hashMap4);
                    switch (k11.hashCode()) {
                        case -959297733:
                    ...
                    switch (c3) {
                        case 0:
                            ...
                            if (H3 != null) {
                                ...
                                arrayList2.add(new k(H3, new t0(s0Var), k10));
                                break;
                            } else {
                                arrayList2 = arrayList21;
                                f5.a.K("HlsPlaylistParser", "EXT-X-MEDIA tag with missing mandatory URI attribute: skipping");
                                break;
                            }
                        case 1:
                            arrayList = arrayList20;
                            String k12 = k(str6, j0, hashMap4);
                        ...
                        case 2:
                            ...
                            if (H3 != null) {
                                s0Var.i = cVar2;
                                arrayList = arrayList20;
                                arrayList.add(new k(H3, new t0(s0Var), k10));
                            } else {
                                arrayList = arrayList20;
                                if (lVar2 != null) {
                                    t0Var2 = new t0(s0Var);
                        ...
                        case 3:
                            ...
                            if (H3 != null) {
                                s0Var.i = cVar2;
                                arrayList19.add(new k(H3, new t0(s0Var), k10));
                            }
                        default:
                            arrayList2 = arrayList21;
                            arrayList = arrayList20;
            ...
            boolean startsWith = y8.startsWith("#EXT-X-I-FRAME-STREAM-INF");
            ArrayList arrayList33 = arrayList16;
            if (y8.startsWith("#EXT-X-DEFINE")) {
                hashMap4.put(k(y8, pattern2, hashMap4), k(y8, q0, hashMap4));
            } else if (y8.equals("#EXT-X-INDEPENDENT-SEGMENTS")) {
            ...
            } else if (y8.startsWith("#EXT-X-MEDIA")) {
                arrayList14.add(y8);
            } else if (y8.startsWith("#EXT-X-SESSION-KEY")) {
                n3.b c6 = c(y8, j(y8, Z, "identity", hashMap4), hashMap4);
                if (c6 != null) {
                    String k13 = k(y8, Y, hashMap4);
                    arrayList15.add(new n3.c(("SAMPLE-AES-CENC".equals(k13) || "SAMPLE-AES-CTR".equals(k13)) ? "cenc" : "cbcs", true, c6));
                }
            } else if (y8.startsWith("#EXT-X-STREAM-INF") || startsWith) {
                boolean contains = z12 | y8.contains("CLOSED-CAPTIONS=NONE");
                int i24 = startsWith ? 16384 : 0;
                int parseInt2 = Integer.parseInt(k(y8, n, Collections.EMPTY_MAP));
                Matcher matcher = c.matcher(y8);
                if (matcher.find()) {
                    arrayList3 = arrayList15;
                    String group = matcher.group(1);
                    group.getClass();
                ...
                boolean z15 = z11;
                String j13 = j(y8, s, null, hashMap4);
                arrayList4 = arrayList12;
                String j14 = j(y8, v, null, hashMap4);
                arrayList5 = arrayList11;
                boolean equals = TextUtils.equals(j(y8, w, null, hashMap4), "true");
                arrayList6 = arrayList10;
                String j15 = j(y8, x, null, hashMap4);
                String j16 = j(y8, y, null, hashMap4);
                arrayList7 = arrayList14;
                String j17 = j(y8, A, null, hashMap4);
                String j18 = j(y8, B, null, hashMap4);
                if (j18 != null) {
                    int i25 = d0.a;
                    hashMap = hashMap3;
                ...
                String j19 = j(y8, C, null, hashMap4);
                float parseFloat = j19 != null ? Float.parseFloat(j19) : -1.0f;
                String j20 = j(y8, d, null, hashMap4);
                String j21 = j(y8, e, null, hashMap4);
                String j22 = j(y8, f, null, hashMap4);
                String j23 = j(y8, h, null, hashMap4);
                if (startsWith) {
                    H2 = f5.a.H(str5, k(y8, pattern, hashMap4));
                } else {
                    if (!g0Var.v()) {
                        throw t1.b("#EXT-X-STREAM-INF must be followed by another line", null);
                    }
                    H2 = f5.a.H(str5, l(g0Var.y(), hashMap4));
                }
                Uri uri2 = H2;
    ...
    public final Object d(Uri uri, com.google.android.exoplayer2.upstream.o oVar) {
        ...
        try {
            ...
            if (read == 239) {
                ...
                while (true) {
                    ...
                    if (!trim.isEmpty()) {
                        if (!trim.startsWith("#EXT-X-STREAM-INF")) {
                            ...
                            arrayDeque.add(trim);
                            m f9 = f(new g0(arrayDeque, bufferedReader), uri.toString());
                            try {
                                bufferedReader.close();
                ...
                arrayDeque.add(trim);
                j e10 = e(this.a, this.b, new g0(arrayDeque, bufferedReader), uri.toString());
                try {
                    bufferedReader.close();
