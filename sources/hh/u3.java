    ...
    public final void run(Object obj) {
        ...
        switch (i11) {
            case 0:
                ...
                if (this.b == this.c) {
                    g4Var.W = arrayList;
                    s5Var.animate().alpha(g4Var.s ? 0.0f : g4Var.W != null ? 1.0f : 0.25f).setInterpolator(er.h).setDuration(420L).start();
                ...
                break;
            case 1:
                rn.m1((rn) obj2, this.b, this.c, (Long) obj);
                break;
            default:
                dj djVar = (dj) obj2;
                Long l10 = (Long) obj;
                ...
                if (rnVar.getParentActivity() != null) {
                    ...
                    int i13 = ChatObject.isMonoForum(rnVar.e) ? R.string.RemoveMessageFeeMessageChannel : R.string.RemoveMessageFeeMessage;
                    long j10 = this.b;
                    ...
                    eh ehVar = new eh(djVar, j10, this.c, l10, 1);
                    c6Var = ((org.telegram.ui.ActionBar.n2) rnVar).resourceProvider;
                    org.telegram.ui.Components.y4.i0(parentActivity, string, replaceTags, formatPluralStringComma, string2, ehVar, c6Var, true);
                    break;
                }
                break;
        }
