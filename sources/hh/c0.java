...
public final class c0 {
    public static volatile c0[] m = new c0[4];
    ...
    public final void f(Context context, long j10, long j11, Utilities.Callback callback) {
        ...
        int sendRequest = ConnectionsManager.getInstance(i11).sendRequest(getconnectedstarrefbot, new w(this, b2Var, j11, callback, 0));
        b2Var.c0 = true;
        b2Var.setOnCancelListener(new x(this, sendRequest, 0));
        b2Var.q(200L);
    }
    ...
    public final TLRPC.TL_payments_starsRevenueStats j(long j10, boolean z10) {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_payments_getStarsRevenueStats, new s(this, j10, 1), null, null, 0, chatFull != null ? chatFull.stats_dc : ConnectionsManager.DEFAULT_DATACENTER_ID, 1, true);
        return tL_payments_starsRevenueStats;
    }
    ...
    public final void n() {
        ...
        this.i = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_bots.getAdminedBots(), new t(this, 0));
    }
    ...
    public final void o() {
        ...
        this.k = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new t(this, 1));
    }
    ...
    public final void p(int i10, long j10) {
        ...
        ConnectionsManager.getInstance(i11).sendRequest(tL_payments_getStarsTransactions, new v(this, k10, i10, j10, 0));
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        fe feVar = fe.t1;
        if (feVar == null || feVar.v0 != DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
            return;
        }
        fe feVar2 = fe.t1;
