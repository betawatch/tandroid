...
public final /* synthetic */ class g6 implements Runnable {
    ...
    public /* synthetic */ g6(u7 u7Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.c6 c6Var, long j10, String str, long j11, TLObject tLObject2, TLRPC.TL_textWithEntities tL_textWithEntities) {
        this.b = u7Var;
        this.c = tLObject;
        this.d = tL_error;
        this.e = callback2;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                        if (!MessagesController.getInstance(u7Var.a).starsPurchaseAvailable()) {
                        ...
                        callback2.run(Boolean.FALSE, null);
                        org.telegram.ui.Cells.pa.r(R.string.UnknownErrorCode, new Object[]{tL_error != null ? tL_error.text : "FAILED_SEND_STARS"}, X, R.raw.error, 36);
                        break;
                    }
                } else {
                    ...
                    if (BirthdayController.getInstance(u7Var.a).contains(j11)) {
                        MessagesController.getInstance(u7Var.a).getMainSettings().edit().putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j11, false).apply();
                    }
                    MessagesController.getInstance(u7Var.a).getMainSettings().edit().putBoolean("show_gift_for_" + j11, true).putBoolean(Calendar.getInstance().get(1) + "show_gift_for_" + j11, true).apply();
            ...
            default:
                ...
                mc X2 = (R2 == null || R2.visibleDialog != null) ? mc.X() : mc.a0(R2);
                if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                        if (!MessagesController.getInstance(u7Var2.a).starsPurchaseAvailable()) {
                            ...
                            boolean[] zArr2 = {false};
                            ea eaVar2 = new ea(context2, c6Var2, j12, 6, str2, new p2(u7Var2, zArr2, j13, tLObject3, tL_textWithEntities, callback22), 0L);
                            eaVar2.setOnDismissListener(new i6(callback22, zArr2, 1));
                            eaVar2.show();
                            break;
                        }
                        ...
                        callback22.run(Boolean.FALSE, null);
                        org.telegram.ui.Cells.pa.r(R.string.UnknownErrorCode, new Object[]{tL_error2 != null ? tL_error2.text : "FAILED_SEND_STARS"}, X2, R.raw.error, 36);
                        break;
                    }
                } else {
                    ...
                    if (BirthdayController.getInstance(u7Var2.a).contains(j13)) {
                        MessagesController.getInstance(u7Var2.a).getMainSettings().edit().putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j13, false).apply();
                    }
                    MessagesController.getInstance(u7Var2.a).getMainSettings().edit().putBoolean("show_gift_for_" + j13, true).putBoolean(Calendar.getInstance().get(1) + "show_gift_for_" + j13, true).apply();
                    LaunchActivity launchActivity2 = LaunchActivity.C1;
                    if (launchActivity2 != null && (pa0Var2 = launchActivity2.t0) != null) {
                        pa0Var2.c(true);
                        break;
                    }
                }
    ...
    public /* synthetic */ g6(u7 u7Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.c6 c6Var, long j10, String str, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j11) {
        this.b = u7Var;
        this.c = tLObject;
        this.d = tL_error;
        this.e = callback2;
