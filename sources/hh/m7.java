...
public final class m7 implements n7 {
    ...
    public final void a() {
        ...
        int sendRequest = ConnectionsManager.getInstance(i10).sendRequest(getsavedstargifts, new l7(this, r2, z10, 0));
        this.m = sendRequest;
            ...
            if (contains) {
                ...
                if (h.size() + 1 <= MessagesController.getInstance(i10).stargiftsPinnedToTopLimit) {
                    ...
                    while (h.size() > 0 && h.size() + 1 > MessagesController.getInstance(i10).stargiftsPinnedToTopLimit) {
                        ((TL_stars.SavedStarGift) com.google.android.recaptcha.internal.a.k(1, h)).pinned_to_top = false;
                    }
                    z12 = true;
                }
                h.add(savedStarGift);
