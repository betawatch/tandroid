...
public final class ba extends FrameLayout {
    ...
    public ba(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        super(context);
        this.r = new org.telegram.ui.Components.y5(this, 0L, 500L, er.h);
        this.a = c6Var;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.h) {
            ...
            canvas.drawRect(LocaleController.isRTL ? 0.0f : AndroidUtilities.dp(22.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.dp(22.0f) : 0), getMeasuredHeight(), N);
        }
    }
