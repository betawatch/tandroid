...
public final class wa extends View {
    ...
    public wa(Context context, org.telegram.ui.ActionBar.c6 c6Var) {
        ...
        this.c = new Paint(1);
        this.d = new Paint(1);
        this.e = new pz0(LocaleController.getString(R.string.StarsReactionTopSenders), 14.16f, AndroidUtilities.bold());
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        pz0 pz0Var = this.e;
        float dp = pz0Var.c + AndroidUtilities.dp(30.0f);
        ...
        this.e.c((getWidth() - pz0Var.c) / 2.0f, getHeight() / 2.0f, 1.0f, -1, canvas);
    }
}
