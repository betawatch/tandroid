...
public final class x9 extends org.telegram.ui.Components.qa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public x9(Context context, org.telegram.ui.ActionBar.c6 c6Var, TLRPC.User user, cg.j2 j2Var) {
        ...
        this.T = w9Var;
        ((TextView) w9Var.c).setText(LocaleController.getString(R.string.GiftStarsTitle));
        p80 p80Var = (p80) w9Var.d;
        final int i12 = 1;
        p80Var.setText(TextUtils.concat(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.GiftStarsSubtitle, UserObject.getForcedFirstName(user))), " ", AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.GiftStarsSubtitleLinkName).replace(' ', (char) 160), new Runnable(this) { // from class: hh.u9
            ...
            public final void run() {
                ...
                switch (i11) {
                    case 0:
                        ...
                        break;
                    default:
                        we.e.s(this.b.getContext(), LocaleController.getString(R.string.StarsTOSLink));
                        break;
                }
            }
        }), true)));
        ...
        y8Var.r(user);
        ((org.telegram.ui.Components.n9) w9Var.b).e(user, y8Var);
        ...
        p80Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StarsTOS), new Runnable(this) { // from class: hh.u9
            public final /* synthetic */ x9 b;
    ...
    public static void P(x9 x9Var, int i10) {
        ...
        if (G.d == -1) {
            x9Var.Y = !x9Var.Y;
            b51Var2.N(true);
            x9Var.d.v0(0, AndroidUtilities.dp(200.0f), er.g);
            return;
        }
        if (G.G(aa.class) && (G.G instanceof TL_stars.TL_starsGiftOption)) {
            Context findActivity = AndroidUtilities.findActivity(x9Var.getContext());
            ...
            if (!MessagesController.getInstance(i11).starsPurchaseAvailable()) {
                ...
                if (R == null || R.getContext() == null) {
                    ...
                    u7.e0(R.getContext(), R.getResourceProvider());
                    return;
                }
            }
            if (!BuildVars.useInvoiceBilling() && BillingController.getInstance().isReady()) {
                ...
                c9.b bVar = new c9.b();
                bVar.c = "inapp";
                bVar.b = tL_starsGiftOption.store_product;
                BillingController.getInstance().queryProductDetails(Arrays.asList(bVar.a()), new f1.a(y10, p5Var, tL_inputStorePaymentStarsGift, tL_starsGiftOption, context));
                return;
            }
            ...
            JSONObject p6 = nh.b3.p(u7.I(), false);
            if (p6 != null) {
            ...
            ConnectionsManager.getInstance(i11).sendRequest(tL_payments_getPaymentForm, new cg.y(y10, p5Var, tL_inputInvoiceStars, 8));
        }
    }
    ...
    public static void Q(x9 x9Var, n41 n41Var, long j10, Boolean bool, String str) {
        ...
        if (!bool.booleanValue()) {
            ...
            ec K = mc.a0(U).K(R.raw.stars_send, LocaleController.getString(R.string.StarsGiftSentPopup), AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsGiftSentPopupInfo", (int) n41Var.B, UserObject.getForcedFirstName(x9Var.V))), LocaleController.getString(R.string.ViewInChat), new v9(j10, i10));
            K.j = 5000;
            K.k(true);
            if (pa0Var != null) {
                pa0Var.c(true);
    ...
    public final void R(ArrayList arrayList, b51 b51Var) {
        ...
        ArrayList u10 = u7.y(this.currentAccount, false).u();
