...
public final /* synthetic */ class l8 implements Runnable {
    ...
    public /* synthetic */ l8(MessagesController messagesController, TLRPC.Chat chat, boolean z10, int i10, q0.a aVar) {
        this.a = 1;
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                int i13 = fsVar.J;
                if (this.c == fsVar.Z && TextUtils.equals(tL_messages_searchGlobal.q, fsVar.a0)) {
                    fsVar.V = false;
                    if (!this.b) {
                        arrayList.clear();
                    }
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        ...
                        while (i14 < size) {
                            ...
                            messageObject.setQuery(fsVar.a0);
            ...
            case 3:
                ...
                int i15 = hsVar.J;
                if (this.c == hsVar.W && TextUtils.equals(tL_messages_searchGlobal2.q, hsVar.X)) {
                    hsVar.S = false;
                    if (!this.b) {
                        arrayList3.clear();
                    }
            ...
            default:
                ...
                yf.q0 q0Var = (yf.q0) this.e;
                Runnable runnable = (Runnable) this.f;
                boolean z11 = this.b;
                p0Var.d(q0Var, this.c, z11 ? p0Var.h : null);
                if (z11) {
                    p0Var.h = null;
                }
                if (runnable != null) {
    ...
    public /* synthetic */ l8(b51 b51Var, int i10, TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, boolean z10, TLObject tLObject, int i11) {
        this.a = i11;
        this.d = b51Var;
        this.c = i10;
    ...
    public /* synthetic */ l8(yf.p0 p0Var, yf.q0 q0Var, int i10, boolean z10, Runnable runnable) {
        this.a = 4;
        this.d = p0Var;
        this.e = q0Var;
        this.c = i10;
    ...
    public /* synthetic */ l8(boolean z10, int i10, String str, ImageReceiver imageReceiver, boolean[] zArr) {
        this.a = 0;
        this.b = z10;
        this.c = i10;
        this.d = str;
