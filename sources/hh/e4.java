...
public final class e4 extends FrameLayout {
    ...
    public e4(Context context) {
        ...
        y1Var.s = AndroidUtilities.dp(18.0f);
        y1Var.u = false;
    ...
    public final void a(TL_stars.StarGift starGift, boolean z10) {
        ...
        if (starGift != null) {
            ...
            String G0 = nh.k.G0(starGift.craft_chance_permille);
            TextView textView = this.d;
            textView.setText(G0);
            textView.setBackground(new u4(AndroidUtilities.dp(10.0f), b10));
            this.e.setBackground(new u4(AndroidUtilities.dp(10.0f), b10));
        }
        b(starGift != null, z10);
    }
    ...
    public final void b(final boolean z10, boolean z11) {
        ...
        er erVar = er.h;
        final int i10 = 0;
        alpha.setInterpolator(erVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: hh.d4
        ...
        final int i11 = 1;
        textView.animate().alpha(z10 ? 1.0f : 0.0f).setInterpolator(erVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: hh.d4
            public final /* synthetic */ e4 b;
        ...
        final int i12 = 2;
        frameLayout2.animate().alpha(z10 ? 1.0f : 0.0f).setInterpolator(erVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: hh.d4
            public final /* synthetic */ e4 b;
