...
public abstract class y0 {
    ...
    public static void b(Canvas canvas, int i10, Paint paint, Bitmap bitmap, float f10, float f11, float f12) {
        ...
        while (true) {
            ...
            float f19 = f15 * 1.0f;
            int i13 = i11 / 4;
            e0.i0.c((float[]) i0Var.b, i13, AndroidUtilities.dp(f17) - (AndroidUtilities.dp(f19) / 2.0f), AndroidUtilities.dp(f18) - (AndroidUtilities.dp(f19) / 2.0f), (AndroidUtilities.dp(f19) / 2.0f) + AndroidUtilities.dp(f17), (AndroidUtilities.dp(f19) / 2.0f) + AndroidUtilities.dp(f18));
    ...
    public static void c(Canvas canvas, org.telegram.ui.Components.i5 i5Var, int i10, float f10, float f11, RectF rectF, float f12) {
        ...
        for (int i13 = 54; i12 < i13; i13 = 54) {
            ...
            if (i12 == 18 || i12 == 19 || i12 == 6 || i12 == 7) {
                f14 = er.i.getInterpolation(f14);
            }
            float[] fArr3 = fArr;
            float b10 = org.telegram.ui.Cells.pa.b(1.0f, f16, AndroidUtilities.dp(12.0f), f48);
            if (f14 < 1.0f) {
                f47 = AndroidUtilities.lerp(f19, f47, er.i.getInterpolation(f14));
                b10 = AndroidUtilities.lerp(f20, b10, f14);
                dpf27 = AndroidUtilities.lerp(AndroidUtilities.dpf2(8.0f), dpf27, f14);
            }
            if (b10 > f52 + AndroidUtilities.dp(8.0f)) {
                f46 = 1.0f;
                f15 = 1.0f - Utilities.clamp01((((b10 - max) - f13) - AndroidUtilities.dp(8.0f)) / AndroidUtilities.dp(56.0f));
            } else {
                f46 = 1.0f;
                f15 = 1.0f;
            }
            float clamp013 = (f46 - Utilities.clamp01(h7.y.a(f22, f24, f47, b10) / (max2 * 2.0f))) * f12 * 0.5f * f15;
            if (f14 < 1.0f) {
                clamp013 = AndroidUtilities.lerp(0.0f, clamp013, f14);
            }
            i5Var.setBounds((int) (f47 - dpf27), (int) (b10 - dpf27), (int) (f47 + dpf27), (int) (b10 + dpf27));
