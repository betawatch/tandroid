...
public final /* synthetic */ class e2 implements Runnable {
    ...
    public /* synthetic */ e2(u7 u7Var, Object obj, long j10, Object obj2, int i10) {
        this.a = i10;
        this.d = u7Var;
        this.b = obj;
        this.c = j10;
    ...
    */
    public final void run() {
        ...
        switch (i11) {
            ...
            case 2:
                ...
                break;
            case 3:
                ((u7) obj2).d0((MessageObject) obj, ((o5) obj3).a, this.c, true, true, null);
                break;
            case 4:
                u7 u7Var = (u7) obj2;
            ...
            case 5:
                ...
                if (!u7Var2.e) {
                    ...
                    u7Var2.H(starGift, this.c, null, true, callback3);
                    break;
                }
            case 6:
                CharSequence charSequence = (CharSequence) obj;
                mc a02 = mc.a0((rn) obj3);
                ...
                if (peerStories == null) {
                    ...
                    if (!(storyItem2 instanceof TL_stories.TL_storyItemDeleted)) {
                        if (!jh.l7.w(i13, storyItem2)) {
                            if (j10 > 0 && (user == null || (!user.self && !s6Var.M(user)))) {
                                ...
                                i0.a.v(tL_updateStory.story.id, new StringBuilder("StoriesController add new user with story id="));
                    ...
                    while (true) {
                        if (i15 >= peerStories.stories.size()) {
                            ...
                            i0.a.v(storyItem3.id, new StringBuilder("StoriesController remove story id="));
                            z11 = true;
                            z12 = true;
                        } else {
                            TL_stories.StoryItem storyItem4 = peerStories.stories.get(i15);
                            storyItem3 = jh.s6.f(storyItem4, storyItem3);
                            ...
                            i0.a.v(storyItem3.id, new StringBuilder("StoriesController update story id="));
                            z11 = true;
                        }
                    }
                    z12 = false;
            ...
            case 12:
                ...
                if (loadChatInfoInQueue != null && (chatParticipants = loadChatInfoInQueue.participants) != null && ((arrayList = chatParticipants.participants) == null || arrayList.size() >= loadChatInfoInQueue.participants_count - 1)) {
                    AndroidUtilities.runOnUIThread(new e5.u(k9Var, j12, loadChatInfoInQueue, 11));
                    break;
                } else {
                    AndroidUtilities.runOnUIThread(new ua(k9Var, isChannel, j12, 1));
                    break;
                }
                break;
            case 13:
    ...
    public /* synthetic */ e2(u7 u7Var, Utilities.Callback callback, TL_stars.StarGift starGift, long j10) {
        this.a = 5;
        this.d = u7Var;
        this.e = callback;
        this.b = starGift;
    ...
    public /* synthetic */ e2(Object obj, long j10, Object obj2, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.c = j10;
        this.d = obj2;
    ...
    public /* synthetic */ e2(Object obj, Object obj2, long j10, Object obj3, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = obj2;
        this.c = j10;
    ...
    public /* synthetic */ e2(Object obj, Object obj2, Object obj3, long j10, int i10) {
        this.a = i10;
        this.b = obj;
        this.d = obj2;
        this.e = obj3;
