...
public final class v3 extends FrameLayout {
    ...
    public v3(Context context) {
        ...
        this.b = b4Var;
        b4Var.e = AndroidUtilities.dp(18.0f);
        b4Var.a.setStrokeWidth(AndroidUtilities.dp(3.0f));
    ...
    public final void b(TL_stars.starGiftAttributePattern stargiftattributepattern) {
        ...
        n9Var.setAnimatedEmojiDrawable(m10);
    }
    ...
    public final void c(float f10, boolean z10) {
        ...
        b4Var.invalidate();
        this.c.c(Math.round(f10 * 100.0f) + "%", z10, true);
    }
}
