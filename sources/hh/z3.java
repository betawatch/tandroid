...
public final class z3 extends FrameLayout {
    ...
    public static void b(float f10, float f11, float f12, float[] fArr) {
        ...
        fArr[2] = f17 - f18;
        fArr[6] = f20 + f21;
        fArr[10] = com.google.android.recaptcha.internal.a.x(f13, 0.0f, 0.0f, cos);
        fArr[14] = 0.0f;
        fArr[3] = 0.0f;
        fArr[7] = 0.0f;
        fArr[11] = 0.0f;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (indexOfChild >= 6) {
            ...
            if (view instanceof e4) {
                e4 e4Var = (e4) view;
                float f12 = 1.0f - (z10 ? this.A : 1.0f);
                e4Var.d.setAlpha(f12);
                e4Var.e.setAlpha(f12);
                if (!z10 || this.A >= 1.0f) {
        ...
        if (z11 && (view instanceof e4)) {
            f10 = 1.0f;
            c10 = 6;
            f11 = ((z10 ? this.A : 1.0f) * AndroidUtilities.dp(2.0f)) + AndroidUtilities.dp(-6.0f);
        } else {
            f10 = 1.0f;
            c10 = 6;
            f11 = 0.0f;
        ...
        for (int i14 = 4; i13 < i14; i14 = 4) {
            ...
            float[] fArr12 = fArr8;
            float[] fArr13 = fArr9;
            fArr11[0] = com.google.android.recaptcha.internal.a.B(fArr7[0], f23, (fArr9[0] * f22) + fArr8[0], dp);
            fArr11[1] = com.google.android.recaptcha.internal.a.B(fArr7[1], f23, (fArr13[1] * f22) + fArr12[1], dp);
            fArr11[2] = com.google.android.recaptcha.internal.a.B(fArr7[2], f23, (fArr13[2] * f22) + fArr12[2], dp);
            i13++;
            fArr9 = fArr13;
            fArr8 = fArr12;
            i12 = 1;
