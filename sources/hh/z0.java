...
public final /* synthetic */ class z0 implements View.OnClickListener {
    ...
    public /* synthetic */ z0(Object obj, int i10, int i11) {
        this.a = i11;
        this.c = obj;
        this.b = i10;
    }
    ...
    public final void onClick(View view) {
        ...
        switch (i11) {
            ...
            case 2:
                ...
                if (!kaVar.e.contains(Integer.valueOf(i15))) {
                    kaVar.e.add(Integer.valueOf(i15));
                } else if (kaVar.e.size() > 1) {
                    kaVar.e.remove(Integer.valueOf(i15));
                }
                AndroidUtilities.forEachViews((RecyclerView) kaVar.b, (d5.d) new ig.i(kaVar, i12));
                break;
            case 3:
                lh.i6 i6Var = ((lh.g6) obj).b;
            ...
            case 7:
                ...
                break;
            case 8:
                ((z20) obj).b.x(i15, true);
                break;
            case 9:
                z20 z20Var = ((y20) obj).c;
                z20Var.n(i15);
                z20Var.dismiss();
                break;
            case 10:
                ...
                if (oc0Var.e.getAdapter() instanceof mc0) {
                    yy yyVar = ((qx) ((mc0) oc0Var.e.getAdapter())).c;
                    if ((i15 != 1 && i15 != 2) || !yyVar.s1) {
                        if (i15 == 0 && yyVar.r1) {
            ...
            case 17:
                ...
                if (i18 >= 0) {
                    ...
                    w70 w70Var = y70Var.a0;
                    if (w70Var != null) {
                        w70Var.a(i15);
                        break;
                    }
                } else {
                    w70 w70Var2 = y70Var.a0;
                    if (w70Var2 != null) {
                        w70Var2.a(i15);
                        break;
                    }
            ...
            case 18:
                qg0 qg0Var = (qg0) obj;
                ValueAnimator valueAnimator = qg0Var.c.M;
            ...
            case 19:
                ...
                if (i15 == 1) {
                    ...
                    arrayList.add(xm0Var.f1);
                    PhotoViewer.t1().b2(arrayList, 0, xl0Var);
                    break;
                } else if (i15 == 2) {
                    ArrayList arrayList2 = new ArrayList();
                    arrayList2.add(xm0Var.h1);
                    PhotoViewer.t1().b2(arrayList2, 0, xl0Var);
                    break;
                } else if (i15 == 3) {
                    ArrayList arrayList3 = new ArrayList();
                    arrayList3.add(xm0Var.i1);
                    PhotoViewer.t1().b2(arrayList3, 0, xl0Var);
                    break;
                } else if (i15 == 0) {
                    PhotoViewer t12 = PhotoViewer.t1();
                    ArrayList arrayList4 = xm0Var.e1;
                    t12.b2(arrayList4, arrayList4.indexOf(secureDocument), xl0Var);
                    break;
                } else {
                    PhotoViewer t13 = PhotoViewer.t1();
                    ArrayList arrayList5 = xm0Var.g1;
                    t13.b2(arrayList5, arrayList5.indexOf(secureDocument), xl0Var);
                    break;
                }
            case 20:
                jp0 jp0Var = (jp0) obj;
            ...
            case 21:
                aq0 aq0Var = (aq0) obj;
                org.telegram.ui.ActionBar.n1 n1Var2 = aq0Var.i0;
            ...
            case 23:
                ...
                if (!hu0.w0(profileActivity.K.getClosestTab())) {
                    ...
                    org.telegram.messenger.t8 t8Var = profileActivity.t5;
                    if (t8Var != null) {
                        t8Var.run();
                    ...
                    if (!arrayList6.isEmpty()) {
                        ...
                        boolean[] zArr3 = {false};
                        boolean z13 = z12;
                        profileActivity.t5 = new org.telegram.messenger.t8(profileActivity, clientUserId, arrayList6, z13, 9);
                    ...
                    org.telegram.messenger.t8 t8Var2 = profileActivity.t5;
                    if (t8Var2 != null) {
                        t8Var2.run();
                        profileActivity.t5 = null;
                    }
                    ...
                    if (!arrayList7.isEmpty()) {
                        b9 b9Var = new b9(profileActivity, a2, h12, arrayList7, 14);
                        profileActivity.getMessagesController().getStoriesController().c0(h12, a2, arrayList7);
                        mc.a0(profileActivity).J(R.raw.chats_archived, AndroidUtilities.replaceTags(LocaleController.formatPluralString("StoryRemovedFromAlbumTitle", arrayList7.size(), w10)), LocaleController.getString(R.string.UndoNoCaps), b9Var).j();
                        break;
                    }
                }
                break;
            ...
            case 25:
                ...
                break;
            case 26:
                View.OnClickListener onClickListener = ((sg.e) obj).b[i15];
    ...
    public /* synthetic */ z0(MessageObject messageObject, int i10) {
        this.a = 22;
        this.b = i10;
