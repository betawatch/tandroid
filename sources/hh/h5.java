...
public final class h5 extends View {
    ...
    public h5(Activity activity, org.telegram.ui.ActionBar.c6 c6Var) {
        super(activity);
        this.c = new ud.a(this, er.h, 380L);
        this.b = new Paint(1);
        this.d = c6Var;
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.a) {
            ...
            default:
                ...
                float f11 = ((ud.a) this.c).e;
                float f12 = 1.0f - f11;
                if (f12 > 0.0f) {
                    gf.s.b(canvas, (l41) this.e, f12 * 1.35f);
                    invalidate();
                }
                if (f11 > 0.0f) {
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.a) {
            case 2:
                ...
                gf.s.d((l41) this.e, i10 / 2.0f, i11 / 2.0f, 17);
                break;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                break;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.a) {
            case 2:
                return super.verifyDrawable(drawable) || (drawable == ((l41) this.e) && !((ud.a) this.c).f);
            default:
