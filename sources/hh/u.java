...
public final class u extends Dialog {
    ...
    public u(v vVar, Activity activity, jl0 jl0Var, c6 c6Var, boolean z10) {
        ...
        int i10 = g6.G8;
        o2 o2Var = vVar.g;
        int v02 = g6.v0(i10, o2Var.getResourceProvider());
        ...
        this.n = qVar;
        kh0 kh0Var = new kh0(activity, o2Var.getActionBar(), jl0Var, qVar);
        this.h = kh0Var;
        kh0Var.setCreateThumbFromParent(true);
        tVar.addView(kh0Var);
        qVar.setProfileGalleryView(kh0Var);
        tVar.addView(qVar);
        ...
        textView2.setTextColor(g6.v0(g6.y6, o2Var.getResourceProvider()));
        ...
        int i12 = g6.F8;
        g1Var.c(v03, g6.v0(i12, c6Var));
        int i13 = g6.I5;
        g1Var.setSelectorColor(g6.v0(i13, c6Var));
        g1Var.g(LocaleController.getString(z10 ? R.string.AddToChannel : R.string.AddToGroup), R.drawable.msg_requests, null);
        final int i14 = 0;
        g1Var.setOnClickListener(new View.OnClickListener(this) { // from class: hh.p
        ...
        g1Var2.c(g6.v0(i11, c6Var), g6.v0(i12, c6Var));
        g1Var2.setSelectorColor(g6.v0(i13, c6Var));
        g1Var2.g(LocaleController.getString(R.string.SendMessage), R.drawable.msg_msgbubble3, null);
        final int i15 = 1;
        g1Var2.setOnClickListener(new View.OnClickListener(this) { // from class: hh.p
            public final /* synthetic */ u b;
        ...
        g1Var3.c(g6.v0(g6.q7, c6Var), g6.v0(g6.p7, c6Var));
        g1Var3.setSelectorColor(g6.v0(i13, c6Var));
        g1Var3.g(LocaleController.getString(R.string.DismissRequest), R.drawable.msg_remove, null);
        final int i16 = 2;
        g1Var3.setOnClickListener(new View.OnClickListener(this) { // from class: hh.p
            public final /* synthetic */ u b;
    ...
    public final void e(boolean z10) {
        ...
        int i10 = 0;
        float f9 = 1.0f - width;
        final float left = iArr[0] - (kh0Var.getLeft() + ((int) ((kh0Var.getMeasuredWidth() * f9) / 2.0f)));
        final float top = iArr[1] - (kh0Var.getTop() + ((int) ((d() * f9) / 2.0f)));
        final int i11 = (-this.f.getTop()) / 2;
        ValueAnimator ofFloat = ValueAnimator.ofFloat(z10 ? 0.0f : 1.0f, z10 ? 1.0f : 0.0f);
        this.s = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: hh.o
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                uVar.x = floatValue;
                float f10 = width;
                float z11 = com.google.android.recaptcha.internal.a.z(1.0f, f10, floatValue, f10);
                t tVar = uVar.y;
                tVar.setScaleX(z11);
                tVar.setScaleY(z11);
                ...
                uVar.h.N(i12, i12);
                float a2 = w.a((uVar.x * 2.0f) - 1.0f, 0.0f, 1.0f);
