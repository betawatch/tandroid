...
public final /* synthetic */ class l7 implements RequestDelegate {
    ...
    public /* synthetic */ l7(Object obj, Object obj2, boolean z10, int i10) {
        this.a = i10;
        this.c = obj;
        this.d = obj2;
        this.b = z10;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.a) {
            case 0:
                AndroidUtilities.runOnUIThread(new cg.c((m7) this.c, (int[]) this.d, tLObject, this.b, 1));
                break;
            case 1:
                AndroidUtilities.runOnUIThread(new cg.c((lh.s1) this.c, tLObject, (String) this.d, this.b, 3));
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new cg.j((fe) this.c, tL_error, tLObject, (TwoStepVerificationActivity) this.d, this.b, 12));
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new cg.c((tw0) this.c, tLObject, this.b, (org.telegram.ui.ActionBar.b2) this.d, 16));
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new cg.j(this.c, tL_error, tLObject, (String) this.d, this.b, 18));
                break;
            case 5:
                AndroidUtilities.runOnUIThread(new cg.c((s50) this.c, tLObject, (TLRPC.ChatFull) this.d, this.b, 18));
                break;
            case 6:
                    ...
                    if (tL_messages_exportedChatInvites.invites.size() > 0 && tL_chatInviteExported2 != null) {
                        for (int i10 = 0; i10 < tL_messages_exportedChatInvites.invites.size(); i10++) {
                            if (((TLRPC.TL_chatInviteExported) tL_messages_exportedChatInvites.invites.get(i10)).link.equals(tL_chatInviteExported2.link)) {
                                ...
                                AndroidUtilities.runOnUIThread(new xg0(kh0Var, tL_chatInviteExported, tL_error, tLObject, this.b, 0));
                                break;
                            }
                        }
                    }
                ...
                AndroidUtilities.runOnUIThread(new xg0(kh0Var, tL_chatInviteExported, tL_error, tLObject, this.b, 0));
            case 7:
                AndroidUtilities.runOnUIThread(new cg.j(this.c, (TLObject) tL_error, this.b, tLObject, (String) this.d, 20));
                break;
            default:
                pf.j1 j1Var = (pf.j1) this.c;
    ...
    public /* synthetic */ l7(Object obj, boolean z10, Object obj2, int i10) {
        this.a = i10;
        this.c = obj;
        this.b = z10;
        this.d = obj2;
