...
public final /* synthetic */ class v1 implements Runnable {
    ...
    public /* synthetic */ v1(i5 i5Var, int i10) {
        this.a = i10;
        this.b = i5Var;
    }
        ...
        switch (i10) {
            ...
            case 15:
                ...
                if (U != null && K1 != null) {
                    ...
                    gyVar.y2 = new ag.l0(i5Var, K1, gyVar, 8);
            ...
            case 20:
                if (i5Var.B1() != null) {
                    ...
                    sb2.append(" #");
                    str = i0.a.m(i5Var.B1().num, ',', sb2);
                } else {
                    str = "";
                }
                ec M = i5Var.getBulletinFactory().M(LocaleController.getString(R.string.Gift2UpgradedTitle), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2UpgradedText, str)), R.raw.gift_upgrade);
                M.j = 5000;
                M.t = true;
                M.j();
                f00 f00Var = i5Var.W;
            ...
            case 23:
                ...
                lh.d dVar = i5Var.f0;
                p4 p4Var = i5Var.I0.h;
                ImageReceiver imageReceiver = (p4Var == null || (o4Var = p4Var.c) == null) ? null : ((r4) o4Var).d;
                ...
                if (i5Var.m0 && i5Var.V != null && i5Var.z0 != null && i5Var.G1() >= 0 && i5Var.z0.b(i5Var.G1()) >= 0) {
                    ...
                    dVar.f(null, true);
                    dVar.setOnClickListener(new z1(i5Var, b10, 0));
                    break;
                } else {
                    dVar.setFilled(true);
