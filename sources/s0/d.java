...
public final class d {
    ...
    public final ArrayList d() {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            arrayList.add(new c(actionList.get(i9), 0, null, null));
        }
        return arrayList;
    }
    ...
    public final CharSequence g() {
        ...
        for (int i9 = 0; i9 < c10.size(); i9++) {
            spannableString.setSpan(new a(((Integer) c13.get(i9)).intValue(), this, accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) c10.get(i9)).intValue(), ((Integer) c11.get(i9)).intValue(), ((Integer) c12.get(i9)).intValue());
        }
    ...
    public final String toString() {
        ...
        sb2.append(i9 >= 30 ? g0.f.l(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.STATE_DESCRIPTION_KEY"));
        ...
        sb2.append("; uniqueId: ");
        sb2.append(i9 >= 33 ? g0.a.d(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getString("androidx.view.accessibility.AccessibilityNodeInfoCompat.UNIQUE_ID_KEY"));
        ...
        sb2.append(i9 >= 23 ? accessibilityNodeInfo.isContextClickable() : false);
        sb2.append("; enabled: ");
        ...
        sb2.append(i9 >= 34 ? g1.a.h(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.CONTAINER_TITLE_KEY"));
        sb2.append("; granularScrollingSupported: ");
        sb2.append(f(67108864));
        sb2.append("; importantForAccessibility: ");
        sb2.append(i9 >= 24 ? accessibilityNodeInfo.isImportantForAccessibility() : true);
        sb2.append("; visible: ");
        sb2.append(accessibilityNodeInfo.isVisibleToUser());
        sb2.append("; isTextSelectable: ");
        sb2.append(i9 >= 33 ? g0.a.e(accessibilityNodeInfo) : f(TLObject.FLAG_23));
        sb2.append("; accessibilityDataSensitive: ");
        sb2.append(i9 >= 34 ? g1.a.k(accessibilityNodeInfo) : f(64));
        sb2.append("; [");
        ArrayList d = d();
