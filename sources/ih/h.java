...
public final class h implements TextureView.SurfaceTextureListener {
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
        switch (this.a) {
            ...
            case 1:
                ...
                if (y50Var.e0 == null && surfaceTexture != null && !y50Var.d0) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.d("InstantCamera start create thread");
                    }
                    y50Var.e0 = new q50(y50Var, surfaceTexture, i10, i11);
                    break;
                }
                break;
            case 3:
    ...
    public final boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        switch (this.a) {
            ...
            case 1:
                y50 y50Var = (y50) this.b;
                Camera2Session[] camera2SessionArr = y50Var.n0;
                ...
                if (y50Var.k0) {
                    ...
                    break;
                } else if (y50Var.l0 != null) {
                    CameraController.getInstance().close(y50Var.l0, null, null);
                    break;
                }
                break;
            case 2:
                ((mg0) this.b).S.t3.setSurfaceTexture(surfaceTexture);
                break;
            case 3:
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        switch (this.a) {
            ...
            default:
                e91 e91Var = (e91) this.b;
                if (e91Var.r == 1) {
                    e91Var.n.getViewTreeObserver().addOnPreDrawListener(new aa(this, 4));
                    e91Var.n.invalidate();
                    break;
                }
                break;
