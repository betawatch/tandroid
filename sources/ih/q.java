...
public final /* synthetic */ class q implements o, b7, c2, kf.o, MessagesController.ErrorDelegate, jh1 {
    ...
    public void l(d2 d2Var, int i10) {
        switch (this.a) {
            case 2:
                d7.V((d7) this.c, this.b);
                break;
            case 3:
            default:
                e60 e60Var = ((i50) this.c).b;
                e60Var.X0.toggleRecord(null, 0);
                e60Var.k1().j(this.b ? 101 : 40, 0L, null);
                break;
            case 4:
                zn znVar = (zn) this.c;
                lk lkVar = znVar.V;
    ...
    public boolean run(TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "INVITE_REQUEST_SENT".equals(tL_error.text)) {
            i80Var.setOnDismissListener(new e80(0, i80Var, this.b));
        }
        i80Var.dismiss();
        return false;
    }
