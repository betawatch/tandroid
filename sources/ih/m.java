...
public final class m {
    ...
    public final w[] b = new w[k.C.length];
    public final f7.b[] c = new f7.b[2];
    public int d = 0;
    public final Rect m = new Rect();
    public final cf.b n = new cf.b(this, 2);
    ...
    public final void a(Canvas canvas, Rect rect) {
                ...
                if (wVarArr != null) {
                    ...
                    if (length == fArr3.length) {
                        ...
                        while (i16 < size) {
                            ...
                            float f26 = eVar.a;
                            float f27 = eVar.b;
                            boolean z4 = f26 < f14 || f26 > f25 || f27 < f15 || f27 > f17;
                            if (min2 >= eVar.f || z4) {
                                if (stack.size() < i15) {
                                    stack.push(eVar);
                                }
                        ...
                        for (int i36 = 0; i36 < length2; i36++) {
                            ...
                            if (i38 > fArr6.length) {
                                wVar2.c = Arrays.copyOf((float[]) wVar2.c, Math.max(i38, fArr6.length * 2));
                            }
                            System.arraycopy(fArr5, 0, (float[]) wVar2.c, wVar2.b, i37);
                            wVar2.b += i37;
                        }
                        i14 = i10 + 1;
                        rect2 = rect;
        ...
        for (int i39 = 0; i39 < fArr7.length; i39++) {
            ...
            int i40 = wVar3.b;
            if (i40 > 0) {
                canvas.drawPoints((float[]) wVar3.c, 0, i40, paint);
            }
        }
    }
}
