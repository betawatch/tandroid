...
public abstract class g5 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public g5(m9 m9Var, Context context, s4 s4Var, hg.i iVar) {
        ...
        frameLayout.addView(view, g7.e6.d(-1, 8.0f, 0, 0.0f, this.e - 8, 0.0f, 0.0f));
        View view2 = new View(getContext());
        this.b = view2;
        view2.setBackgroundColor(org.telegram.ui.ActionBar.f6.v0(i9, bVar));
        frameLayout.addView(view2, g7.e6.d(-1, 10.0f, 0, 0.0f, this.e - 17, 0.0f, 0.0f));
    ...
    public static void a(g5 g5Var) {
        new zf.x0(g5Var.G.f, 14, false).show();
    }

    public static void b(g5 g5Var) {
        f5 f5Var = g5Var.A;
        if (f5Var != null) {
            f5Var.r.remove(g5Var);
        }
        f5 f5Var2 = g5Var.B;
        g5Var.A = f5Var2;
        if (f5Var2 == null) {
        ...
        g5Var.w.E();
        g5Var.x.h1(0, (int) (g5Var.getTopOffset() - g5Var.r.getPaddingTop()));
    }
    ...
    public static void f(int i9, long j10, TL_stories.StoryItem storyItem) {
        ...
        SparseArray sparseArray = (SparseArray) MessagesController.getInstance(i9).storiesController.x.f(storyItem.dialogId);
        f5 f5Var = sparseArray == null ? null : (f5) sparseArray.get(storyItem.id);
        TL_stories.StoryViews storyViews = storyItem.views;
        int i10 = storyViews == null ? 0 : storyViews.views_count;
        if (f5Var == null || f5Var.a != i10) {
            if (f5Var != null) {
                f5Var.d();
            }
            ...
            f5Var2.c();
            if (sparseArray == null) {
                a0.h hVar = MessagesController.getInstance(i9).storiesController.x;
                long j11 = storyItem.dialogId;
                sparseArray = new SparseArray();
                hVar.k(sparseArray, j11);
            }
            sparseArray.put(storyItem.id, f5Var2);
        }
    }
    ...
    public final boolean d(TL_stories.StoryView storyView) {
        ...
        if (n5Var != null) {
            ...
            u6 u6Var = n5Var.b;
            if (u6Var != null && (a8Var = u6Var.c) != null && (r9Var = a8Var.E0) != null) {
                return r9Var.b(user);
            }
        }
        return true;
    ...
    public final void didReceivedNotification(int i9, int i10, Object... objArr) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.n6) && (R = RecyclerView.R(childAt)) >= 0) {
                c5 c5Var = this.w;
                if (R < c5Var.c.size()) {
                    ((org.telegram.ui.Cells.n6) childAt).a(d(((x4) c5Var.c.get(R)).b) ? 1.0f : 0.5f, true);
                }
            }
            i11++;
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int max = i10 == 0 ? (int) Math.max(0.0f, view.getY()) : i10 > 0 ? 0 : n4Var.getPaddingTop();
        ...
        if (this.R) {
            ...
            if (frameLayout.getTranslationY() != 0.0f && frameLayout.getTranslationY() != n4Var.getPaddingTop()) {
                ...
                float paddingTop = n4Var.getPaddingTop() / 2.0f;
                a6.a aVar = this.d;
    ...
    public final void e(f5 f5Var) {
        ...
        c5 c5Var = this.w;
        int size = c5Var.c.size();
        s4 s4Var = this.K;
        if (TextUtils.isEmpty(s4Var.c) && !s4Var.b) {
            i();
        }
        c5Var.E();
        this.F.b(size - 1);
    ...
    public final void g(long j10, n5 n5Var) {
        ...
        NotificationsController.getInstance(this.v).processSeenStoryReactions(j10, n5Var.a.id);
    }
    ...
    public final void h(boolean z10) {
        ...
        w4 w4Var = this.L;
        if (z11 != w4Var.s || !z10) {
            ValueAnimator valueAnimator = w4Var.w;
            ...
            if (z10) {
                ...
                w4Var.w.addListener(new ag.e(w4Var, 17));
                w4Var.w.setDuration(250L);
                w4Var.w.setInterpolator(gr.f);
                w4Var.w.start();
            } else {
                w4Var.r = 1.0f;
                w4Var.invalidate();
        ...
        if (z12) {
            f5 f5Var = this.A;
            i9 = (f5Var == null || !f5Var.f) ? R.drawable.menu_views_reactions3 : R.drawable.menu_views_reposts3;
        } else {
    ...
    public final void i() {
        ...
        if (storyItem != null) {
            ...
            if (storyViews != null) {
                ...
                this.P = (storyItem.dialogId < 0 || i9 < 20 || storyItem.contacts || storyItem.close_friends || storyItem.selected_contacts) ? false : true;
            }
            int i10 = this.v;
            SparseArray sparseArray = (SparseArray) MessagesController.getInstance(i10).storiesController.x.f(storyItem.dialogId);
            f5 f5Var = sparseArray != null ? (f5) sparseArray.get(storyItem.id) : null;
            this.B = f5Var;
            TL_stories.StoryViews storyViews2 = storyItem.views;
            int i11 = storyViews2 == null ? 0 : storyViews2.views_count;
            s4 s4Var = this.K;
            if (f5Var == null || !(f5Var.f || f5Var.a == i11)) {
                if (f5Var != null) {
                    f5Var.d();
                }
                f5 f5Var2 = new f5(i10, this.S, storyItem);
                this.B = f5Var2;
                f5Var2.e(s4Var, this.P, this.O);
                this.B.c();
                if (sparseArray != null) {
                    ...
                    MessagesController.getInstance(i10).storiesController.x.k(sparseArray2, storyItem.dialogId);
                }
            } else {
                f5Var.e(s4Var, this.P, this.O);
            }
            f5 f5Var3 = this.A;
            if (f5Var3 != null) {
                f5Var3.r.remove(this);
            }
            f5 f5Var4 = this.B;
            this.A = f5Var4;
            if (f5Var4 != null && this.E) {
                ArrayList arrayList = f5Var4.r;
                if (!arrayList.contains(this)) {
                    arrayList.add(this);
                }
            }
            f5 f5Var5 = this.A;
            if (f5Var5 == null || !f5Var5.j || UserConfig.getInstance(i10).isPremium()) {
                f5 f5Var6 = this.A;
                if (f5Var6.e || f5Var6.m || !f5Var6.g.isEmpty() || !this.A.i.isEmpty() || !TextUtils.isEmpty(this.A.s.c)) {
                    ...
                    if (storyViews3 == null || storyViews3.views_count == 0) {
                        ...
                        f5 f5Var7 = this.A;
                        if (f5Var7.k) {
                            textView.setText(LocaleController.getString(f5Var7.f ? R.string.Reactions : R.string.Viewers));
                            this.N = false;
                            this.O = false;
                            this.P = false;
                        } else {
                            if (f5Var7.b() < 20 && this.A.b() < storyItem.views.views_count) {
                                f5 f5Var8 = this.A;
                                if (!f5Var8.e && !f5Var8.m) {
                                    this.N = false;
                                    this.O = false;
                                    this.P = false;
                                    textView.setText(LocaleController.getString(!this.A.f ? R.string.Reactions : R.string.Viewers));
                        ...
                        r4Var.setVisibility(this.N ? 0 : 8);
                        this.e = this.N ? 96 : 46;
                    }
                }
            }
        ...
        w4Var.a.setVisibility(this.O ? 0 : 8);
        w4Var.c.setVisibility(this.P ? 0 : 8);
        w4Var.d.setVisibility(this.P ? 0 : 8);
        if (this.P) {
