...
public final class w3 extends org.telegram.ui.ActionBar.f3 {
    ...
    public w3(Context context, long j10, TL_stars.SavedStarGift savedStarGift, org.telegram.ui.ActionBar.c6 c6Var, Utilities.Callback0Return callback0Return) {
        ...
        TextView b11 = j6.b(context, 14.0f, g6.y6, false, c6Var);
        ...
        v3 v3Var = new v3(context, this.currentAccount, 0, false, new bh.v(2, this, G), new a9.s(22, this, dVar), null, c6Var);
        v3Var.setSpanCount(3);
        v3Var.setOverScrollMode(2);
        v3Var.setScrollEnabled(false);
        linearLayout.addView(v3Var, i7.f6.k(11.0f, 0.0f, 11.0f, 0.0f, -1, -2));
