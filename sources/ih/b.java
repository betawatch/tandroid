...
public final class b extends v41 {
    ...
    public final void bindView(View view, w41 w41Var, boolean z10, k51 k51Var, u51 u51Var) {
        ...
        spannableStringBuilder.setSpan(new org.telegram.ui.Components.y5(auction.giftDocumentId, g6.s2.getFontMetricsInt()), 0, spannableStringBuilder.length(), 33);
        ...
        hz0 hz0Var = new hz0(cVar.getContext(), cVar.a);
        hz0Var.a(spannableStringBuilder).setFilled(true);
        hz0Var.k(LocaleController.getString(R.string.Gift2AuctionsAcquiredRecipient), cVar.b, DialogObject.getPeerDialogId(tL_StarGiftAuctionAcquiredGift.peer), new ef.c(18, cVar, onClickListener));
