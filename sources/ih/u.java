...
public final /* synthetic */ class u implements Utilities.Callback2 {
    ...
    public /* synthetic */ u(int i10, long j10, TLRPC.Photo photo, Context context, lh.b bVar) {
        this.b = i10;
        this.c = j10;
        this.e = photo;
        this.d = context;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                ...
                if (auction != null) {
                    ...
                    if (j12 != peerDialogId && j12 != 0 && peerDialogId != 0) {
                        y yVar2 = new y(context, i11, auction, j12, runnable);
                        if (peerDialogId >= 0) {
                        ...
                        g10.addView(new jh.g5(context, chat, user), i7.f6.t(-1, -2, 48, 0, -4, 0, 0));
                        TextView textView = new TextView(context);
                        NotificationCenter.listenEmojiLoading(textView);
                        textView.setText(LocaleController.getString(R.string.Gift2AuctionsChangeRecipient));
                        int i12 = g6.j5;
                        org.telegram.ui.b.w(i12, c6Var, textView, 1, 20.0f);
                        textView.setGravity(LocaleController.isRTL ? 5 : 3);
                        g10.addView(textView, i7.f6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 24.0f, 19.0f, 24.0f, 2.0f));
                        TextView textView2 = new TextView(context);
                        org.telegram.ui.b.m(i12, c6Var, textView2, 1, 16.0f);
                        org.telegram.ui.b.p(R.string.Gift2AuctionsChangeRecipient2, new Object[]{DialogObject.getShortName(j10), DialogObject.getShortName(j12)}, textView2);
                        ...
                        alertDialog$Builder.k(LocaleController.getString(R.string.Continue), new eg.n(yVar, 7));
                        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                        alertDialog$Builder.a.show();
                        break;
                    } else if (auction.auctionUserState.bid_date > 0 && !auction.isFinished()) {
                        t tVar = new t(context, c6Var, null, auction);
                        tVar.j0 = runnable;
                        tVar.show();
                        break;
                    } else {
                        new g0(context, c6Var, j12, auction.gift, runnable).show();
                        break;
                    }
                }
                break;
            default:
                ...
                new tc(hb.a(this.d), bVar).E(bVar).j();
                break;
        }
    }

    public /* synthetic */ u(Context context, org.telegram.ui.ActionBar.c6 c6Var, int i10, long j10, Runnable runnable) {
        this.d = context;
        this.e = c6Var;
        this.b = i10;
        this.c = j10;
