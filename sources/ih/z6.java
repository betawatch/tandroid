...
public final class z6 extends FrameLayout {
    ...
    public z6(Context context, a9 a9Var) {
        ...
        while (i10 < size) {
            ...
            i10++;
            y6 y6Var = (y6) obj;
            TextPaint textPaint = y6Var.e;
            String str = y6Var.a;
            int length = str.length();
            Rect rect = y6Var.r;
            textPaint.getTextBounds(str, 0, length, rect);
            int width = rect.width();
            TextPaint textPaint2 = y6Var.f;
            String str2 = y6Var.b;
    ...
    public final void a(boolean z10) {
        ...
        this.b.addListener(new ag.e(this, 18));
        this.b.addUpdateListener(new bg.b(this, 22));
        this.b.start();
        AndroidUtilities.runOnUIThread(this.e, (((y6) this.a.get(this.d)).c.p() * 2) + 100);
    }
