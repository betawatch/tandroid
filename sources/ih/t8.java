...
public final class t8 extends o8 {
    ...
    public t8(Context context, q8 q8Var, TL_stories.TL_mediaAreaSuggestedReaction tL_mediaAreaSuggestedReaction, py pyVar) {
        ...
        pyVar.getClass();
        String str = d.f;
        str = str == null ? MessageObject.findAnimatedEmojiEmoticon(org.telegram.ui.Components.k5.f(pyVar.b, d.g)) : str;
        if (str != null && (arrayList = (ArrayList) pyVar.e.get(str)) != null && !arrayList.isEmpty()) {
        ...
        if (storyViews != null) {
            for (int i9 = 0; i9 < storyViews.reactions.size(); i9++) {
                if (hg.t0.c(storyViews.reactions.get(i9).reaction, this.E)) {
                    ...
                    this.K = storyViews.reactions.get(i9).count > 0;
