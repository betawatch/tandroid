...
public final /* synthetic */ class l6 implements Runnable {
    ...
    public /* synthetic */ l6(n6 n6Var, MessagesStorage messagesStorage, int i9) {
        this.a = i9;
        this.b = n6Var;
        ...
        switch (this.a) {
            case 0:
                ...
                try {
                    ...
                    sQLiteCursor = messagesStorage.createLoadStoriesCursor(j12, n6Var2.f, n6Var2.e);
                    while (sQLiteCursor.next()) {
                        ...
                        if (byteBufferValue != null) {
                            ...
                            MessageObject messageObject = new MessageObject(n6Var2.c, TLdeserialize);
                            ...
                            try {
                                ...
                                int i9 = 0;
                                while (i9 < size) {
                                    TLRPC.PrivacyRule privacyRule = arrayList5.get(i9);
                                    i9++;
                                ...
                                for (int i10 = 0; i10 < TLdeserialize.media_areas.size(); i10++) {
                                    if (TLdeserialize.media_areas.get(i10) instanceof TL_stories.TL_mediaAreaChannelPost) {
                                        hashSet3.add(Long.valueOf(((TL_stories.TL_mediaAreaChannelPost) TLdeserialize.media_areas.get(i10)).channel_id));
                                    }
                                }
                ...
                sQLiteCursor.dispose();
                AndroidUtilities.runOnUIThread(new fh.k1(n6Var, arrayList2, arrayList, arrayList3, arrayList4, hashSet, 8));
                return;
            default:
                n6 n6Var3 = this.b;
                ...
                try {
                    ...
                    database.executeFast("DELETE FROM profile_stories WHERE dialog_id = " + n6Var3.d + " AND type = " + n6Var3.e).stepThis().dispose();
                } catch (Throwable th4) {
                    messagesStorage2.checkSQLException(th4);
                }
                AndroidUtilities.runOnUIThread(new k6(n6Var3, 3));
                return;
        }
    }
}
