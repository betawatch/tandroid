...
public final class z7 {
    ...
    public final pc i = new pc((View) null);
    public final org.telegram.ui.Cells.z j = org.telegram.ui.ActionBar.f6.Y(553648127, 0, 0);
    ...
    public static CharSequence d() {
        ...
        if (charSequenceArr[0] == null) {
            ...
            ((SpannableStringBuilder) y[0]).setSpan(eqVar, 0, 1, 33);
        }
        return y[0];
    }
    ...
    public final void a(Canvas canvas, float f10) {
        if (this.n == null) {
            ...
            this.n = new nz0(charSequence, document != null ? 12.0f : 14.0f, document != null ? null : AndroidUtilities.bold());
        }
        if (this.o == null || this.m) {
            String str = this.l;
            this.o = new nz0(str != null ? str : "", 14.0f, null);
        }
        float e10 = this.h.e(this.f);
        Paint paint = this.t;
        paint.setColor(TLObject.FLAG_30);
        int min = (int) Math.min(f10, Math.max(this.n.c, this.o.c) + AndroidUtilities.lerp(AndroidUtilities.dp(20.0f), AndroidUtilities.dp(18.0f), e10));
        this.x = min;
        ...
        nz0 nz0Var2 = this.o;
        nz0Var2.p = f13;
        nz0Var2.c(AndroidUtilities.dp(10.0f), AndroidUtilities.dp(30.0f), f12, -1, canvas);
        canvas.restore();
    }
    ...
    public final void c() {
        ...
        this.q = true;
        MessagesController.getInstance(this.a).getStoriesController().d0(this.b.longValue(), this.c.intValue(), new hg.i(this, 3));
    }
