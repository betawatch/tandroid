    ...
    public j(k kVar, t1 t1Var, ArrayList arrayList, gf.c cVar) {
        ...
        while (true) {
            ...
            if (i10 >= dVarArr.length) {
                ...
                int v02 = k6.v0(k6.G8, this.y.getResourcesProvider());
                mutate.setColorFilter(new PorterDuffColorFilter(k6.w0(null, k6.Td, false), PorterDuff.Mode.MULTIPLY));
    ...
    public final void e(Canvas canvas, boolean z4, int i10) {
        ...
        if (bVar != null && !z4) {
            ...
            if (jVar.O != -1) {
                ...
                if (dVar.e == null) {
                    final int i22 = 1;
                    b bVar2 = new b(new a() { // from class: ih.c
                        @Override // ih.a
                        public final void p(Canvas canvas3, int i23) {
                            ...
                            switch (i22) {
                                case 0:
                                    ...
                                    if (R2 || paint != null) {
                                        int alpha3 = k6.h2.getAlpha();
                                        k6.h2.setAlpha((int) (alpha3 * f23));
                                        canvas3.drawRoundRect(rectF3, dp4, dp4, k6.h2);
                                        k6.h2.setAlpha(alpha3);
                                    }
                                    canvas3.save();
                    ...
                    if (f27 <= 0.0f || dVar2.h == null) {
                        ...
                        if (dVar2.f == null) {
                            ...
                            if (!jVar2.Q) {
                                dVar2.g = jVar2.I;
                                final int i25 = 0;
                                b bVar4 = new b(new a() { // from class: ih.c
                                    @Override // ih.a
                                    public final void p(Canvas canvas3, int i232) {
                                        ...
                                        switch (i25) {
                                            case 0:
                                                ...
                                                if (R2 || paint2 != null) {
                                                    int alpha3 = k6.h2.getAlpha();
                                                    k6.h2.setAlpha((int) (alpha3 * f232));
                                                    canvas3.drawRoundRect(rectF32, dp42, dp42, k6.h2);
                                                    k6.h2.setAlpha(alpha3);
                                                }
                                                canvas3.save();
