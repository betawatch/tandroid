...
public final class s0 extends TextView {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 0:
                ...
                int i10 = g6.z6;
                c6Var = ((f3) ((u0) this.c).e).resourcesProvider;
            ...
            case 2:
                ...
                if (layout2 != null) {
                    paint2.setColor(g6.l1(0.45f, g6.v0(g6.y6, ((mh.r) this.c).S.c)));
                    float f10 = dp;
                    float f11 = max / 2.0f;
                    float f12 = f10 - f11;
                    float f13 = f10 + f11;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.a) {
            case 1:
                Paint paint = (Paint) this.b;
                paint.setColor(((eh.f) this.c).getThemedColor(g6.Oh));
            ...
            case 5:
                Paint paint2 = (Paint) this.b;
                paint2.setColor(((ni) this.c).getThemedColor(g6.Oh));
            ...
            case 10:
                Paint paint3 = (Paint) this.b;
                paint3.setColor(((qh.n) this.c).getThemedColor(g6.Oh));
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.a) {
            case 6:
                ...
                ((r2) this.b).a.set(rectF);
                ((r2) this.b).b.set(rectF);
                ((r2) this.b).f();
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        switch (this.a) {
            ...
            case 9:
                ...
                k70Var.h.setBounds(0, 0, i10, i11);
                k70Var.h.setCornerRadius(Math.min(i10, i11) / 2.0f);
                ((org.telegram.ui.Components.voip.h) this.b).f = i10;
                break;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
    ...
    public void setTextColor(int i10) {
        switch (this.a) {
            case 7:
                ...
                ((c90) this.c).f(g6.l1(0.03f, i10), g6.l1(0.175f, i10), g6.l1(0.2f, i10), g6.l1(0.45f, i10));
                break;
            default:
