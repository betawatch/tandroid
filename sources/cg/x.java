...
public final class x extends e3 {
    ...
    public x(Activity activity, d1 d1Var, i2 i2Var, c6 c6Var, boolean z10) {
        ...
        fixNavigationBar();
        AndroidUtilities.setLightStatusBar(this, i0.b.f(g6.v0(g6.h5, this.resourcesProvider)) > 0.699999988079071d);
        ...
        tVar.setPosition(0);
        setCustomView(tVar);
        d1Var.p0 = new s(this, 0);
        d1Var.n0 = new xe.b(10, this, i2Var);
        i2Var.q0 = new v(this, d1Var, c6Var);
        i2Var.o0 = new s(this, 1);
        if (!z10) {
