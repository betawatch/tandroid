...
public abstract class q0 {
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, org.telegram.ui.ActionBar.n2 n2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (h()) {
            ...
            c9.b bVar = new c9.b();
            bVar.c = "inapp";
            bVar.b = tL_premiumGiftCodeOption.store_product;
            BillingController.getInstance().queryProductDetails(Arrays.asList(bVar.a()), new d0(tL_inputStorePaymentPremiumGiftCode, tL_premiumGiftCodeOption, connectionsManager, callback2, callback, n2Var, 0));
            return;
        }
        ...
        JSONObject p6 = b3.p(n2Var.getResourceProvider(), false);
        if (p6 != null) {
        ...
        connectionsManager2.sendRequest(tL_payments_getPaymentForm, new e0(callback2, messagesController2, tL_inputInvoicePremiumGiftCode, n2Var, callback, 1));
    }
