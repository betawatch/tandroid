...
public final class e0 extends g3 {
    ...
    public e0(Context context, f6 f6Var) {
        ...
        uVar.b = xVar;
        xVar.a(this.f);
        uVar.c = new w(this, context);
        uVar.d = new d0(this, context);
        s sVar = new s(context, this.resourcesProvider);
        sVar.setAdapter(new t(uVar));
        uVar.addView(sVar, b6.l(1.0f, -1, 0));
        uVar.addView(rVar, b6.k(12.0f, 0.0f, 12.0f, 0.0f, -1, 48));
        LinearLayout linearLayout2 = new LinearLayout(context);
        linearLayout2.setOrientation(0);
        linearLayout2.setGravity(16);
        linearLayout2.addView(imageView, b6.n(28, 28));
        linearLayout2.addView(sVar.n(8, false), b6.p(-1, 40, 1.0f, 16, 12, 0, 12, 0));
    ...
    public final void m(int i10, int i11) {
        ...
        if (i11 != 0) {
            ...
            if (z4) {
                ...
                float f11 = fArr[2];
                wVar.d = f10 - (f11 <= 0.5f ? 1.0f - (((1.0f - f11) * 0.22000003f) + 0.78f) : ai.c(1.0f, f11, 0.22f, 1.0f));
        ...
        if (!editTextBoldCursor.isFocused()) {
            ...
            StringBuilder sb = new StringBuilder(Integer.toHexString(d0Var.f.f));
            while (sb.length() < 8) {
                sb.insert(0, "0");
            }
