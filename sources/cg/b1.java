    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 3:
                ...
                int i13 = psVar.K;
                if (this.c == psVar.a0 && TextUtils.equals(tL_messages_searchGlobal.q, psVar.b0)) {
                    psVar.W = false;
                    if (!this.b) {
                        arrayList.clear();
                    }
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        ...
                        while (i14 < size) {
                            ...
                            messageObject.setQuery(psVar.b0);
            ...
            default:
                ...
                int i15 = rsVar.K;
                if (this.c == rsVar.X && TextUtils.equals(tL_messages_searchGlobal2.q, rsVar.Y)) {
                    rsVar.T = false;
                    if (!this.b) {
                        arrayList3.clear();
                    }
