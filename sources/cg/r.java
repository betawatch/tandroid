...
public final class r extends View {
    ...
    public void b(float f10) {
        ...
        float a2 = k7.n.a(((f10 - dp) + (AndroidUtilities.dp(13.0f) - (this.c.getStrokeWidth() / 2.0f))) / (getWidth() - (dp * 2.0f)), 0.0f, 1.0f);
        this.d = a2;
        e0 e0Var = (e0) this.e;
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.a) {
            case 0:
                ...
                dg.e2.v1(canvas, rectF, AndroidUtilities.dp(6.0f));
                canvas.restore();
                rectF.set(dp, f10, getWidth() - dp, f11);
                ...
                dg.e2.w1(max, height, strokeWidth, i0.a.k(e0Var.f, (int) (this.d * 255.0f)), canvas);
                break;
            default:
                super.onDraw(canvas);
