        ...
        switch (i13) {
            case 0:
                ...
                if (!z4 || i16 < 0 || i16 >= arrayList2.size()) {
                    ...
                    z1Var.g.edit().putInt(kh.a2.j(i16, "score"), ((y1) arrayList2.get(i16)).c).putInt("scoreall", z1Var.a).apply();
                    z1Var.i = null;
                }
                z1Var.e.run(s1Var);
                return;
            case 1:
                q3 q3Var = (q3) obj3;
                q3Var.m((Bitmap) obj2, this.b, q3Var.Q, q3Var.R, (sq0) obj);
                return;
            case 2:
                e3.g gVar = (e3.g) obj3;
                y2.i iVar = (y2.i) obj2;
                ...
                for (int i23 = 0; i23 < i16; i23++) {
                    if (i23 == 0) {
                        ...
                        if ((actionBarLayout.h || actionBarLayout.U) && actionBarLayout.L0.size() > 1) {
                            p2Var = (p2) yh.k(2, actionBarLayout.L0);
                        }
                    }
                    if (p2Var != null) {
                        if (d5Var.m != null) {
                            ...
                            for (int i24 : (int[]) qaVar.c) {
                                sparseIntArray.put(i24, f6Var.g1(i24));
                            }
                        }
            ...
            case 10:
                ...
                org.telegram.ui.Components.voip.f2.n(user, false, userFull != null && userFull.video_calls_available, e9Var.getParentActivity(), userFull, AccountInstance.getInstance(i16));
                return;
            case 11:
                xn xnVar = (xn) obj3;
            ...
            case 15:
                ...
                omVar.G = null;
                nmVar.D = 0.0f;
                nmVar.f(mmVar, photoEntry, i16);
                nmVar.j();
                nmVar.i(omVar.M, false);
                return;
            case 16:
                z4.G(((o70) obj3).e, (f6) obj2, new m2(i16, (go) obj, i14));
                return;
            case 17:
                p2 p2Var3 = (p2) obj3;
                ...
                if (tLObject2 instanceof Vector) {
                    ...
                    c10Var = new c10(p2Var3, i16, arrayList9);
                } else {
                    c10Var = new c10(p2Var3, i16, null);
                }
                c10Var.y0 = callback;
                p2Var3.showDialog(c10Var);
                return;
            case 18:
                s30 s30Var = (s30) obj3;
                ...
                if (lowerCase.length() == 0) {
                    AndroidUtilities.runOnUIThread(new ey(s30Var, i16, new ArrayList(), i15));
                    return;
                }
                ...
                while (i29 < size2) {
                    ...
                    i11 = ((g3) s30Var.w).currentAccount;
                ...
                AndroidUtilities.runOnUIThread(new ey(s30Var, i16, arrayList11, 2));
                return;
            case 19:
                g40 g40Var = (g40) obj3;
                ...
                int i31 = g40Var.K;
                ArrayList arrayList12 = g40Var.L;
                if (i16 != g40Var.Q) {
                    return;
                }
                ...
                if (tLObject4 instanceof TLRPC.messages_Messages) {
                    ...
                    if (messages_messages instanceof TLRPC.TL_messages_messages) {
                        g40Var.T = ((TLRPC.TL_messages_messages) messages_messages).messages.size();
                    } else if (messages_messages instanceof TLRPC.TL_messages_messagesSlice) {
                        g40Var.T = ((TLRPC.TL_messages_messagesSlice) messages_messages).count;
                    }
                    g40Var.W = messages_messages.next_rate;
                    ...
                    g40Var.S = arrayList12.size() >= g40Var.T;
                    g40Var.W();
                } else {
                    g40Var.S = true;
                    g40Var.T = arrayList12.size();
                }
                g40Var.N(true);
                if (isEmpty) {
                    ((un0) g40Var).Z.q0.h1(0, 0);
                    return;
                }
                return;
            case 20:
                on0.c(((on0) obj3).getContext(), i16, ((ln0) obj2).a.g(), (f6) obj);
                return;
            case 21:
                qq0 qq0Var = (qq0) obj3;
            ...
            default:
                ...
                Drawable drawable = ((jp) obj2).b;
                if (drawable instanceof dc0) {
                    dc0 dc0Var = (dc0) drawable;
                    dc0Var.t(w11.e(bitmap), i16);
                    dc0Var.u(w11Var.I);
                    w11Var.invalidate();
                    return;
                }
