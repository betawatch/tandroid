...
public final class u extends LinearLayout {
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 3:
                ...
                kq kqVar = (kq) this.d;
                paint.setColor(j6.v0(j6.i5, kqVar.a0));
                int left = kqVar.B[0].getLeft() - AndroidUtilities.dp(13.0f);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public u(kq kqVar, Context context) {
        super(context);
        this.a = 3;
        this.d = kqVar;
        this.b = new RectF();
    ...
    public u(Context context, int i10, f6 f6Var) {
        ...
        switch (i10) {
            ...
            default:
                ...
                addView(e90Var, b6.t(-2, -2, 1, 0, 9, 0, 18));
                break;
        }
    }
}
