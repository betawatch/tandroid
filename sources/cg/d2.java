    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.r) {
            case 0:
                ...
                e2 e2Var = (e2) this.s;
                e2Var.c.l0.d(0, 0.0f, 0, getMeasuredWidth(), -this.f.e, e2Var.c.a0);
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), e2Var.c.l0.f);
            ...
            default:
                ...
                PremiumPreviewFragment premiumPreviewFragment = ((xv0) this.s).c;
