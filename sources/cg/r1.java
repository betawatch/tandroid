        ...
        for (int i11 = 0; i11 < zk0Var.getChildCount(); i11++) {
            ...
            if (childAt instanceof gg.o) {
                ...
                if (arrayList2.contains(oVar.getBoost())) {
                    ...
                    if (i12 > 0) {
                        oVar.setSubtitle(LocaleController.formatString(R.string.BoostingAvailableIn, gg.o.f((i12 * 1000) - System.currentTimeMillis())));
                        cVar.setAlpha(0.65f);
                        h5Var.setAlpha(0.65f);
                        oVar.i(0.3f, false);
                    } else {
                        oVar.setSubtitle(LocaleController.formatString(R.string.BoostExpireOn, LocaleController.getInstance().getFormatterBoostExpired().format(new Date(oVar.E.expires * 1000))));
