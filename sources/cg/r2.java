    ...
    */
    public final void a() {
        ...
        while (i13 < i10) {
            ...
            int i14 = this.N;
            if (i14 == 9) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_folder : i13 == 1 ? R.raw.premium_object_bubble : R.raw.premium_object_settings, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 27) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.filled_messages_paid : i13 == 1 ? R.raw.filled_crown_on : R.raw.premium_object_star2, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 11 || i14 == 4) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_smile1 : i13 == 1 ? R.raw.premium_object_smile2 : R.raw.premium_object_like, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 22) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_user : i13 == 1 ? R.raw.cache_photos : R.raw.cache_profile_photos, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == i12) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_adsbubble : i13 == 1 ? R.raw.premium_object_like : R.raw.premium_object_noads, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 7) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_video2 : i13 == 1 ? R.raw.premium_object_video : R.raw.premium_object_user, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 43) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_list : i13 == 1 ? R.raw.premium_object_math : i13 == 2 ? R.raw.premium_object_table : i13 == i12 ? R.raw.premium_object_superscript : i13 == 4 ? R.raw.premium_object_bold : R.raw.premium_object_code, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 1001) {
                this.d[i13] = SvgHelper.getBitmap(R.raw.premium_object_fire, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 1002) {
                this.d[i13] = SvgHelper.getBitmap(R.raw.premium_object_star2, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 24) {
                this.d[i13] = SvgHelper.getBitmap(i13 == 0 ? R.raw.premium_object_tag : i13 == 1 ? R.raw.premium_object_check : R.raw.premium_object_star, dp, dp, i0.a.k(g6.v0(this.P, this.O), 30));
                this.e[i13] = true;
            } else if (i14 == 28) {
                if (i13 == 0) {
                    this.d[i13] = SvgHelper.getBitmap(R.raw.filled_premium_dollar, dp, dp, i0.a.k(g6.v0(this.P, this.O), 255));
                    this.f[i13] = true;
                }
                ...
                if (this.N == i11 || !(i13 == 1 || i13 == 2)) {
                    ...
                    if (this.q) {
                        ...
                        if (dp >= AndroidUtilities.dp(10.0f)) {
                            s1.d().f(dp * (-2), 0.0f, dp, dp);
                        } else {
                            s1.d().f(dp * (-4), 0.0f, dp, dp);
                        }
                        Paint e10 = s1.d().e();
                        if (this.M) {
    ...
    public int b() {
        return this.N == 100 ? i0.a.k(g6.v0(this.P, this.O), 200) : g6.v0(this.P, this.O);
    }
    ...
    public final void e(Canvas canvas, float f9) {
        ...
        if (z10) {
            ...
            while (true) {
                ...
                float[] fArr = this.F;
                float f10 = ((j10 / ((i10 * 10000.0f) + 40000.0f)) * 360.0f) + fArr[i10];
                fArr[i10] = f10;
        ...
        for (int i16 = 0; i16 < arrayList.size(); i16++) {
            q2 q2Var2 = (q2) arrayList.get(i16);
            if (this.g) {
                q2Var2.a(canvas, this.Q, f9);
            } else {
                q2Var2.a(canvas, currentTimeMillis, f9);
            }
            if (this.I && currentTimeMillis > q2Var2.a) {
                q2Var2.b(currentTimeMillis);
            }
            if (this.H) {
                if (!this.b.contains(q2Var2.h, q2Var2.i)) {
                    q2Var2.b(currentTimeMillis);
                }
            }
        }
