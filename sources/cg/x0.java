...
public final /* synthetic */ class x0 implements Runnable {
    ...
    public /* synthetic */ x0(n1 n1Var, boolean z4, boolean z10, Bitmap[] bitmapArr, CountDownLatch countDownLatch) {
        this.a = 1;
        this.d = n1Var;
        this.b = z4;
        this.c = z10;
    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                d1 d1Var = ((n1) obj3).y.c;
                jv0 jv0Var = d1Var.g;
                af.c h = d1Var.h(new RectF(0.0f, 0.0f, jv0Var.a, jv0Var.b), false, z10, z4);
                if (h != null) {
            ...
            case 4:
                ...
                break;
            default:
                final x61 x61Var = (x61) obj3;
                final String str = (String) obj2;
                String[] strArr = (String[]) obj;
                final LinkedHashSet linkedHashSet = new LinkedHashSet();
                final LinkedHashSet linkedHashSet2 = new LinkedHashSet();
                HashMap<String, TLRPC.TL_availableReaction> reactionsMap = MediaDataController.getInstance(x61Var.S).getReactionsMap();
                ...
                wk0 wk0Var = new wk0(x61Var, str, this.b, arrayList4, reactionsMap, arrayList5, linkedHashSet, linkedHashSet2, arrayList7, arrayList6, this.c);
                int i17 = x61Var.T;
                if (i17 == 13) {
                    Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.c51
                        ...
                        public final void run(Object obj4) {
                            ...
                            switch (i11) {
                                case 0:
                                    MediaDataController.getInstance(x61Var.S).getEmojiSuggestions(x61.X1, str, false, new vl0(15, linkedHashSet2, runnable2), null, false, false, false, 0);
                                    break;
                                default:
                                    MediaDataController.getInstance(x61Var.S).getAnimatedEmojiByKeywords(str, new e51(linkedHashSet2, runnable2, 0));
                                    break;
                            }
                        }
                    }, wk0Var);
                        ...
                        callback = new Utilities.Callback() { // from class: org.telegram.ui.d51
                            ...
                            public final void run(Object obj4) {
                                switch (i18) {
                                            ...
                                            for (int i19 = 0; i19 < availableEffects.effects.size(); i19++) {
                                                try {
                                                    ...
                                                    if (str2.contains(tL_availableEffect.emoticon)) {
                                                        (tL_availableEffect.effect_animation_id == 0 ? arrayList5 : arrayList4).add(mg.q0.e(tL_availableEffect));
                                                    }
                                    ...
                                    default:
                                        x61 x61Var2 = x61Var;
                                        MediaDataController.getInstance(x61Var2.S).getEmojiSuggestions(x61.X1, str, false, new a1.d(x61Var2, arrayList5, arrayList4, (Runnable) obj4, 16), null, false, false, false, 0);
                                        break;
                                }
                            }
                        };
                    ...
                    final int i20 = 1;
                    Utilities.doCallbacks(new kl(fullyConsistsOfEmojis, str, linkedHashSet, 3), new Utilities.Callback() { // from class: org.telegram.ui.c51
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj4) {
                            Runnable runnable2 = (Runnable) obj4;
                            switch (i20) {
                                case 0:
                                    MediaDataController.getInstance(x61Var.S).getEmojiSuggestions(x61.X1, str, false, new vl0(15, linkedHashSet, runnable2), null, false, false, false, 0);
                                    break;
                                default:
                                    MediaDataController.getInstance(x61Var.S).getAnimatedEmojiByKeywords(str, new e51(linkedHashSet, runnable2, 0));
                                    break;
                            }
                        }
                    }, new gg.c1(x61Var, strArr, str, linkedHashSet, 13), new ok(x61Var, fullyConsistsOfEmojis, linkedHashSet, str, reactionsMap, arrayList4), new gg.c1((Object) x61Var, str, arrayList6, (Object) hashMap, 14), new org.telegram.ui.b0(x61Var, str, arrayList7, 8), wk0Var);
                    break;
                }
        }
    }

    public /* synthetic */ x0(Object obj, Object obj2, boolean z4, boolean z10, Object obj3, int i10) {
        this.a = i10;
        this.d = obj;
        this.e = obj2;
        this.b = z4;
    ...
    public /* synthetic */ x0(t6 t6Var, boolean z4, TL_stories.TL_stories_getAllStories tL_stories_getAllStories, TLObject tLObject, boolean z10) {
        this.a = 2;
        this.d = t6Var;
        this.b = z4;
    ...
    public /* synthetic */ x0(ProfileActivity profileActivity, TLRPC.User user, String str, boolean z4, boolean z10) {
        this.a = 4;
