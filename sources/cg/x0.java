    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                jv0 jv0Var = d1Var.g;
                bf.b h = d1Var.h(new RectF(0.0f, 0.0f, jv0Var.a, jv0Var.b), false, z10, z4);
                if (h != null) {
            ...
            default:
                ...
                uk0 uk0Var = new uk0(q61Var, str, this.b, arrayList4, reactionsMap, arrayList5, linkedHashSet, linkedHashSet2, arrayList7, arrayList6, this.c);
                int i17 = q61Var.T;
                if (i17 == 13) {
                    Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.v41
                    ...
                    if (fullyConsistsOfEmojis) {
                        final int i18 = 0;
                        callback = new Utilities.Callback() { // from class: org.telegram.ui.w41
                            @Override // org.telegram.messenger.Utilities.Callback
                            public final void run(Object obj4) {
                                switch (i18) {
                                    case 0:
                    ...
                    final int i20 = 1;
                    Utilities.doCallbacks(new ll(fullyConsistsOfEmojis, str, linkedHashSet, 3), new Utilities.Callback() { // from class: org.telegram.ui.v41
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj4) {
                            Runnable runnable2 = (Runnable) obj4;
                            switch (i20) {
