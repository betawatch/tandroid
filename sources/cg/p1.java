            ...
            if ((motionEvent.getButtonState() & 32) == 32) {
                ...
                if (actionMasked2 != 0) {
                    if (actionMasked2 == 1) {
                        ...
                        painting.L.setInterpolator(mr.h);
                                        ...
                                        if (i10 != 3) {
                                            ...
                                            if (m0Var.j) {
                                                ...
                                                if (a13 > 0.4f) {
                                                    ...
                                                    double d23 = atan2;
                                                    f11 = scaleX;
                                                    m0Var.k = (float) Math.atan2((Math.sin(d23) * d22) + (Math.sin(d21) * d20), kf.k0.a(d23, d22, Math.cos(d21) * d20));
