...
public abstract class r {
    ...
    public static String c(Context context, int i10) {
        ...
        if (i10 == 2) {
            return i6.b.f(context) ? resources.getString(org.telegram.messenger.beta.R.string.common_google_play_services_wear_update_text) : resources.getString(org.telegram.messenger.beta.R.string.common_google_play_services_update_text, a2);
        }
        if (i10 == 3) {
