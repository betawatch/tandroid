    ...
    public final void H(String str, Location location, boolean z10) {
        ...
        if ((location != null || this.d) && ((location2 = this.v) == null || location == null || location.distanceTo(location2) >= 200.0f)) {
            ...
            if (userOrChat instanceof TLRPC.User) {
                ...
                if (TextUtils.isEmpty(str) || !(this.d || this.e)) {
                    ...
                    if (this.d) {
                        if (currentLocale.getLanguage().contains("en")) {
                            ...
                            str2 = str;
                            location3 = location;
                            Utilities.globalQueue.postRunnable(new fh.k1(cVar, currentLocale, str2, locale, location3, str, 10));
                        } else {
                            locale2 = Locale.US;
                        }
                    }
                ...
                cVar.B = ConnectionsManager.getInstance(cVar.C).sendRequest(tL_messages_getInlineBotResults, new bg.j0(20, this, str2));
                l();
                return;
            }
            if (z10) {
                ...
                if (!this.E) {
                    ...
                    tL_contacts_resolveUsername.username = this.d ? MessagesController.getInstance(i9).storyVenueSearchBot : MessagesController.getInstance(i9).venueSearchBot;
