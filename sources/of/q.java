...
public final /* synthetic */ class q implements RequestDelegate {
    ...
    public /* synthetic */ q(Object obj, Object obj2, int i9, int i10, TLObject tLObject, int i11) {
        this.a = i11;
        this.b = obj;
        this.c = obj2;
        this.d = i9;
            ...
            case 0:
                ...
                if (tL_error == null) {
                    ...
                    while (i9 < messages_messages.messages.size()) {
                        a0.h hVar3 = hVar;
                        MessageObject messageObject = new MessageObject(f0Var.o0, messages_messages.messages.get(i9), hVar2, hVar3, false, true);
                ...
                AndroidUtilities.runOnUIThread(new r(f0Var, this.d, this.e, tL_error, str, tLObject, tL_messages_search, arrayList, 0));
                break;
            case 1:
                f0 f0Var2 = (f0) this.b;
                ...
                if (tL_error == null) {
                    ...
                    for (int i13 = 0; i13 < messages_messages2.chats.size(); i13++) {
                        ...
                        hVar4.k(chat2, chat2.id);
                    }
                    for (int i14 = 0; i14 < messages_messages2.users.size(); i14++) {
                        TLRPC.User user2 = messages_messages2.users.get(i14);
                        hVar5.k(user2, user2.id);
                    }
                    int i15 = 0;
                    while (i15 < messages_messages2.messages.size()) {
                        a0.h hVar6 = hVar4;
                        MessageObject messageObject2 = new MessageObject(f0Var2.o0, messages_messages2.messages.get(i15), hVar5, hVar6, false, true);
                ...
                if (tL_error == null) {
                    ...
                    for (int i16 = 0; i16 < messages_messages3.messages.size(); i16++) {
                        ...
                        if ((message.out ? MessagesController.getInstance(i12).dialogs_read_outbox_max : MessagesController.getInstance(i12).dialogs_read_inbox_max).get(Long.valueOf(dialogId)) == null) {
                            hashSet.add(new Pair(Boolean.valueOf(message.out), Long.valueOf(dialogId)));
                        }
                    }
                }
                r rVar = new r(f0Var2, this.d, this.e, tL_error, str2, tLObject, tL_messages_searchGlobal, arrayList2, 1);
                if (hashSet.isEmpty()) {
