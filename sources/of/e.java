    ...
    */
    public c1 j(int i10, long j3) {
        ...
        if (i10 < 0 || i10 >= z0Var.b()) {
            StringBuilder m10 = k0.m("Invalid item position ", i10, "(", i10, "). Item count:");
            m10.append(z0Var.b());
        ...
        if (c1Var == null) {
            ...
            if (g11 < 0 || g11 >= recyclerView.w.h()) {
                StringBuilder m11 = k0.m("Inconsistency detected. Invalid item position ", i10, "(offset:", g11, ").state:");
                m11.append(z0Var.b());
                m11.append(recyclerView.D());
