...
public final class o4 implements ll0 {
    ...
    public final boolean f(int i10, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n6) {
            ...
            i9 i9Var = this.a;
            if (i9Var.v != null && (storyView = ((v4) e5Var.w.c.get(i10)).b) != null && (user = (messagesController = MessagesController.getInstance(i11)).getUser(Long.valueOf(storyView.user_id))) != null) {
                ...
                F.i = 3;
                F.j = true;
                F.W(new ColorDrawable(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.h5, bVar)));
                F.s = 133;
                boolean z12 = (!d || L || z10 || isUserSelf) ? false : true;
                final int i12 = 0;
                final String str2 = str;
                F.l(R.drawable.msg_stories_myhide, LocaleController.formatString(R.string.StoryHideFrom, str), new Runnable(this) { // from class: oh.m4
                    ...
                    public final void run() {
                        ...
                        switch (i13) {
                            case 0:
                                ...
                                e5 e5Var2 = o4Var.b;
                                yh.s(R.string.StoryHidFromToast, new Object[]{str3}, new qc(e5Var2, e5Var2.s), R.raw.ic_ban, 36);
                                n6Var2.a(e5Var2.d(storyView2) ? 1.0f : 0.5f, true);
                                break;
                            default:
                                messagesController2.getStoriesController().j0(user2.id, false, true);
                                e5 e5Var3 = o4Var.b;
                                yh.s(R.string.StoryShownBackToToast, new Object[]{str3}, new qc(e5Var3, e5Var3.s), R.raw.contact_check, 36);
                                n6Var2.a(e5Var3.d(storyView2) ? 1.0f : 0.5f, true);
                                break;
                        }
                    }
                }, z12);
                ...
                F.t();
                final int i13 = 1;
                F.l(R.drawable.msg_menu_stories, LocaleController.formatString(R.string.StoryShowBackTo, str2), new Runnable(this) { // from class: oh.m4
                    public final /* synthetic */ o4 b;
                ...
                F.t();
                final int i14 = 0;
                F.m((z11 || z10 || isUserSelf) ? false : true, R.drawable.msg_user_remove, LocaleController.getString(R.string.BlockUser), true, new Runnable(this) { // from class: oh.n4
                    public final /* synthetic */ o4 b;
                    ...
                    public final void run() {
                        switch (i14) {
                            case 0:
                                ...
                                e5 e5Var2 = this.b.b;
                                new qc(e5Var2, e5Var2.s).e(true).j();
                                n6Var.a(e5Var2.d(storyView) ? 1.0f : 0.5f, true);
                                break;
                            default:
                                MessagesController messagesController2 = messagesController;
                                ...
                                e5 e5Var3 = this.b.b;
                                new qc(e5Var3, e5Var3.s).e(false).j();
                                n6Var.a(e5Var3.d(storyView) ? 1.0f : 0.5f, true);
                                break;
                        }
                    }
                });
                final int i15 = 1;
                F.l(R.drawable.msg_block, LocaleController.getString(R.string.Unblock), new Runnable(this) { // from class: oh.n4
                    public final /* synthetic */ o4 b;
                ...
                F.m(z11 && !isUserSelf, R.drawable.msg_user_remove, LocaleController.getString(R.string.StoryDeleteContact), true, new hg.j0(this, user, str2, n6Var, storyView, 16));
