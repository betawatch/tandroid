...
public final class s0 extends FrameLayout {
    ...
    public void set(u0 u0Var) {
        ...
        if (j10 >= 0) {
            TLRPC.User user = MessagesController.getInstance(UserConfig.selectedAccount).getUser(Long.valueOf(u0Var.b));
            z8Var.r(user);
            p9Var.e(user, z8Var);
        } else {
            TLRPC.Chat chat = MessagesController.getInstance(UserConfig.selectedAccount).getChat(Long.valueOf(-u0Var.b));
            z8Var.q(chat);
            p9Var.e(chat, z8Var);
        }
        int i10 = u0Var.e;
        ...
        if (i10 > 0) {
            imageView.setImageDrawable(new j0(getContext(), u0Var.e));
            imageView.setVisibility(0);
        } else {
            imageView.setVisibility(8);
        }
        this.e.setText(DialogObject.getName(u0Var.b));
        this.a.invalidate();
    }
}
