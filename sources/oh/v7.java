...
public final class v7 {
    ...
    public final org.telegram.ui.Cells.z j = org.telegram.ui.ActionBar.k6.Y(553648127, 0, 0);
    ...
    public final void a(Canvas canvas, float f10) {
        if (this.n == null) {
            ...
            this.n = new l01(charSequence, document != null ? 12.0f : 14.0f, document != null ? null : AndroidUtilities.bold());
        }
        if (this.o == null || this.m) {
            String str = this.l;
            this.o = new l01(str != null ? str : "", 14.0f, null);
        }
        float e6 = this.h.e(this.f);
        Paint paint = this.t;
        paint.setColor(TLObject.FLAG_30);
        int min = (int) Math.min(f10, Math.max(this.n.c, this.o.c) + AndroidUtilities.lerp(AndroidUtilities.dp(20.0f), AndroidUtilities.dp(18.0f), e6));
        this.x = min;
        ...
        l01 l01Var2 = this.o;
        l01Var2.p = f13;
        l01Var2.c(AndroidUtilities.dp(10.0f), AndroidUtilities.dp(30.0f), f12, -1, canvas);
        canvas.restore();
    }
    ...
    public final void c() {
        ...
        this.q = true;
        MessagesController.getInstance(this.a).getStoriesController().d0(this.b.longValue(), this.c.intValue(), new ng.i(this, 3));
    }
