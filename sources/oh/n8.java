...
public final class n8 extends View {
    ...
    public n8(Context context) {
        ...
        this.e = new org.telegram.ui.Components.z5(this, 0L, 260L, pr.h);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f) {
            ...
            if (drawable == null || d <= 0.5f) {
                ...
                c3 = 0;
                f10 = 12.0f;
                drawable2.setBounds(A, (int) (centerY - f12), (int) (f12 + dpf24), (int) w.c.c(fArr[1], 2.0f, abs, rectF.centerY()));
            ...
            if (drawableArr[c3] != null && d <= f11) {
                ...
                drawable3.setBounds(A2, (int) (centerY2 - f13), (int) (f13 + dpf25), (int) w.c.c(fArr[c3], 2.0f, abs, rectF.centerY()));
