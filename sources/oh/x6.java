...
public final class x6 extends FrameLayout {
    ...
    public final void a(boolean z4) {
        ...
        this.b.addListener(new dg.l0(this, 24));
        this.b.addUpdateListener(new f5(this, 1));
        this.b.start();
        AndroidUtilities.runOnUIThread(this.e, (((w6) this.a.get(this.d)).c.p() * 2) + 100);
    }
