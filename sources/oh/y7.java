...
public final class y7 {
    ...
    public y7(z7 z7Var) {
        this.v = z7Var;
        this.c = new d90(z7Var);
        ArrayList arrayList = new ArrayList();
        this.i = arrayList;
        this.j = new Stack();
        this.n = "";
        this.r = new org.telegram.ui.Components.z5(z7Var.G, 0L, 400L, pr.h);
        Path path = new Path();
        this.t = path;
        this.u = new AtomicReference();
        this.k = new jh.p(z7Var, arrayList, new mh.m5(this, 13));
        k90 k90Var = new k90();
        this.s = k90Var;
        k90Var.x = path;
        k90Var.j(4.0f);
                ...
                while (true) {
                    ...
                    if (w7Var != null) {
                        ...
                        if (f12 != f13) {
                            ...
                            float lerp2 = AndroidUtilities.lerp(w7Var.d, w7Var.f, pr.g.getInterpolation(z7Var.w));
    ...
    public final void d(StaticLayout staticLayout, Canvas canvas, ArrayList arrayList) {
        if (arrayList.isEmpty()) {
            ...
            jh.k.g(this.v, false, -1, 0, this.u, 0, staticLayout, arrayList, canvas, false);
        }
    }
    ...
    public final void e(int i10) {
        ...
        if (z7Var.b) {
            ...
            stack.addAll(arrayList);
            arrayList.clear();
            jh.k.c(a8Var, this.e, stack, arrayList);
            ...
            stack.addAll(arrayList);
            arrayList.clear();
            jh.k.c(z7Var, this.e, stack, arrayList);
        }
        int i13 = z7Var.B;
        int i14 = z7Var.C;
        jh.p pVar = this.k;
