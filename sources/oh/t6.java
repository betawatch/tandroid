...
public final class t6 {
    public static final Comparator X = Comparator$-CC.comparingInt(new lf.d(8));
    ...
    public t6(int i10) {
        ...
        g7 g7Var = new g7();
        g7Var.a = i10;
        g7Var.b = MessagesStorage.getInstance(i10);
        this.k = g7Var;
        ...
        g7 g7Var2 = this.k;
        g7Var2.b.getStorageQueue().postRunnable(new z1(14, g7Var2, new w5(this, 0)));
        this.K = new af.b(this, i10, 11);
        this.w = new qh.t0(i10);
    }
    ...
    public final l6 A(long j10, int i10, int i11, boolean z4) {
        if (i10 == 0 && i11 > 0) {
            ...
            l6 l6Var2 = new l6(this.a, j10, i10, i11, new dg.h0(this, 27));
        ...
        if (i10 == 4) {
            ...
            d6 d6Var = new d6(this.a, j10, null, new dg.h0(this, 27));
            hashMap4.put(valueOf2, d6Var);
            return d6Var;
        }
        HashMap hashMap5 = hashMapArr[i10];
        Long valueOf3 = Long.valueOf(j10);
        l6 l6Var4 = new l6(this.a, j10, i10, i11, new dg.h0(this, 27));
    ...
    public final h6 B(long j10, boolean z4) {
        ...
        h6 h6Var2 = new h6(this.a, j10, this);
        hVar.k(h6Var2, j10);
        return h6Var2;
    }

    public final int C(boolean z4) {
        return z4 ? this.z ? Math.max(1, this.v) : this.h.size() : this.p ? Math.max(1, this.u) : this.g.size();
    }
    ...
    public final void P() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(tL_contacts_getBlocked, new s5(this, 3));
    }
    ...
    public final void Q(boolean z4) {
        ...
        if ((z4 || !this.q) && !this.n) {
            ...
            String str = z4 ? this.y : this.o;
            boolean z11 = z4 ? this.z : this.p;
            ...
            ConnectionsManager.getInstance(this.a).sendRequest(tL_stories_getAllStories, new z5(this, z4, tL_stories_getAllStories, z10));
        }
    }
    ...
    public final void R() {
        ...
        this.U = true;
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stories.TL_stories_getChatsToSend(), new s5(this, 2));
    }
    ...
    public final void S(final TL_stories.PeerStories peerStories, final boolean z4) {
        ...
        final long j10 = peerDialogId * (z4 ? -1 : 1);
        Long valueOf = Long.valueOf(j10);
        ...
        if (arrayList != null) {
            ...
            ConnectionsManager.getInstance(i11).sendRequest(tL_stories_getStoriesByID, new RequestDelegate() { // from class: oh.u5
    ...
    public final void T() {
        if (this.A) {
            ...
            g7 g7Var = this.k;
            g7Var.b.getStorageQueue().postRunnable(new z1(15, g7Var, w5Var));
        } else {
            Q(false);
            Q(true);
        }
    ...
    public final void U(int i10, long j10) {
        AndroidUtilities.runOnUIThread(new mh.a9(this, j10, i10, 1));
    }
                ...
                for (int i11 = 0; i11 < Math.min(2, storyItem.media_areas.size()); i11++) {
                    if (storyItem.media_areas.get(i11) instanceof TL_stories.TL_mediaAreaSuggestedReaction) {
                        ...
                        if (d.f != null) {
                            ...
                            org.telegram.ui.Components.l5 l5Var = new org.telegram.ui.Components.l5(1, i10, d.g);
                            l5Var.m = true;
                            l5Var.v();
                        }
                    }
    ...
    public final void Y(TL_stories.TL_stories_allStories tL_stories_allStories, boolean z4, boolean z10, boolean z11) {
        ...
        if (!z10) {
            ...
            g7 g7Var = this.k;
            g7Var.b.getStorageQueue().postRunnable(new dg.w0(g7Var, arrayList4, z11, z4, fVar, 3));
        }
        af.b bVar = this.K;
    ...
    public final void Z(TL_stories.TL_updateStory tL_updateStory) {
        ...
        if (peerDialogId > 0) {
            ...
            if (user != null && (M(user) || user.self)) {
                g7Var.b.getStorageQueue().postRunnable(new z1(13, g7Var, tL_updateStory));
            }
        } else {
            g7Var.b.getStorageQueue().postRunnable(new z1(13, g7Var, tL_updateStory));
            user = null;
    ...
    public final void b(int i10, long j10, ArrayList arrayList) {
        ...
        while (i14 < size3) {
            ...
            i14++;
            l6 A2 = t6Var.A(B.b, 0, ((m6) obj3).a, false);
            if (A2 != null) {
    ...
    public final void g0(long j10, TL_stories.StoryItem storyItem, ng.q0 q0Var) {
        if (storyItem == null) {
            return;
        }
    ...
    public final void k0(long j10, List list) {
        ...
        while (i10 < size) {
            ...
            i10++;
            l6 A3 = t6Var.A(j10, 0, ((m6) obj).a, false);
            if (A3 != null) {
                A3.A(list);
            }
            t6Var = this;
    ...
    public final void l0(long j10, List list, boolean z4) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                ...
                if (peerStories.stories.get(i12).id == storyItem.id) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        l.d.t(storyItem.id, new StringBuilder("StoriesController update story for full peer storyId="));
                    }
                } else {
                    i12++;
                }
            ...
            if (!z10) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    l.d.t(storyItem.id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z4) {
                    l.d.t(storyItem.id, new StringBuilder("StoriesController add new story for full peer storyId="));
    ...
    public final void m(TL_stories.PeerStories peerStories) {
        ...
        while (i10 < peerStories.stories.size()) {
            if (m7.w(this.a, peerStories.stories.get(i10))) {
    ...
    */
    ...
    public final void n0(long j10, List list, boolean z4) {
        ...
        while (i10 < size2) {
            int i12 = i10 + 1;
            l6 A3 = t6Var.A(j10, 0, ((m6) arrayList.get(i10)).a, false);
            if (A3 != null) {
                A3.D(list, z4);
            }
            t6Var = this;
    ...
    public final n6 o() {
        ...
        ConnectionsManager.getInstance(i10).sendRequest(tL_stories_canSendStory, new s5(this, 1), 1024);
        return null;
    }

    public final void o0(long j10, ArrayList arrayList, boolean z4, e3 e3Var) {
    ...
    public final void q() {
        ...
        ConnectionsManager.getInstance(this.a).sendRequest(new TL_stories.TL_stories_getAllReadPeerStories(), new s5(this, 0));
    }
    ...
    public final void s(long j10, ArrayList arrayList) {
        ...
        g7 g7Var = this.k;
        g7Var.b.getStorageQueue().postRunnable(new i5.v(g7Var, arrayList2, j10, 8));
        NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.storiesUpdated, new Object[0]);
    }
    ...
    public final s6 t(long j10, TL_stories.StoryItem storyItem) {
        ...
        return (s6) hashMap.get(Integer.valueOf(storyItem.id));
    }
