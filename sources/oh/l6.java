...
public class l6 {
    ...
    public final void D(List list, boolean z4) {
        ...
        while (true) {
            ...
            if (storyItem2 != null) {
                ...
                if (z11 != z12) {
                    if (!z12) {
                        l.d.t(storyItem2.id, new StringBuilder("StoriesList remove story "));
                    ...
                    l.d.t(storyItem2.id, new StringBuilder("StoriesList update story "));
    ...
    */
    ...
    public final void z(int i10) {
        ...
        if (!arrayList.isEmpty() || (z1Var = this.x) == null) {
            return;
        }
        AndroidUtilities.cancelRunOnUIThread(z1Var);
