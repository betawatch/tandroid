...
public final /* synthetic */ class w0 implements NativeInstance.PayloadCallback, RequestDelegateTimestamp, NativeInstance.VideoSourcesCallback, NativeInstance.RequestBroadcastPartCallback, NativeInstance.RequestCurrentTimeCallback {
    ...
    public void run(long j10, int[] iArr) {
        ...
        while (i10 < iArr.length) {
            i10 = yh.d(iArr[i10], i10, 1, getgroupparticipants.sources);
        }
        ConnectionsManager.getInstance(e1Var.e).sendRequest(getgroupparticipants, new hg.c0(e1Var, iArr, j10));
    }
        ...
        switch (this.a) {
            case 3:
                ...
                if (e1Var.v != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new bh.a(e1Var, str2, AccountInstance.getInstance(e1Var.e).getConnectionsManager().sendRequest(tL_upload_getFile, new RequestDelegateTimestamp() { // from class: oh.y0
                        @Override // org.telegram.tgnet.RequestDelegateTimestamp
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error, long j12) {
                            ...
                            AndroidUtilities.runOnUIThread(new mh.m2(29, e1Var2, str2));
