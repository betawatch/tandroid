...
public final class z2 extends ImageReceiver {
    ...
    public /* synthetic */ z2(View view, View view2, int i10) {
        super(view2);
        this.a = i10;
        this.b = view;
    }
    ...
    public boolean setImageBitmapByKey(Drawable drawable, String str, int i10, boolean z4, int i11) {
        ...
        switch (i12) {
            case 0:
                ...
                if (i10 == 1 && (runnable = f4Var.f1) != null) {
                    runnable.run();
                    f4Var.f1 = null;
                    break;
                }
            ...
            case 6:
                if (drawable != null && i10 != 1) {
                    org.telegram.ui.b.p(((vf.v0) ((a4) obj).E).n.animate().alpha(1.0f).translationY(0.0f), pr.k, 250L);
                }
                break;
        }
