...
public abstract class v extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void i(boolean z4) {
        ...
        nh.t6 storiesController = MessagesController.getInstance(this.b).getStoriesController();
        long j10 = this.d;
        ...
        if (E != null) {
            ...
            while (i11 < size2) {
                ...
                i11++;
                s6 s6Var = (s6) obj2;
                if (s6Var != null && (t6Var = s6Var.c) != null && t6Var.J0 == j10 && !TextUtils.isEmpty(t6Var.K0) && !arrayList.contains(t6Var.K0)) {
