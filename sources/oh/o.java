...
public final class o extends n2 implements i40, NotificationCenter.NotificationCenterDelegate, ud.b {
    ...
    public static void V(o oVar, n41 n41Var) {
        ...
        Object obj = n41Var.G;
        if (obj instanceof TLRPC.Chat) {
            oVar.presentFragment(rn.R9(-((TLRPC.Chat) obj).id));
        } else if (obj instanceof TLRPC.User) {
            oVar.presentFragment(rn.R9(((TLRPC.User) obj).id));
        }
    }
    ...
    public final void Y() {
        this.a.a((this.f == this.h && TextUtils.equals(((hh.o) this.n.b).getText().toString(), this.e)) ? false : true, true);
    }
    ...
    public final void Z(boolean z10) {
        ...
        f6 f6Var2 = (f6) this.d.y1(ImageReceiver.DEFAULT_CROSSFADE_DURATION);
        if (f6Var2 != null) {
            f6Var2.a(z10);
        }
        this.h = z10;
    ...
    public final void a0(boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(radialProgressView, (Property<RadialProgressView, Float>) property, 1.0f), ObjectAnimator.ofFloat(this.s, (Property<t0, Float>) property, 1.0f));
        } else {
            RadialProgressView radialProgressView2 = this.x;
            Property property2 = View.ALPHA;
            animatorSet2.playTogether(ObjectAnimator.ofFloat(radialProgressView2, (Property<RadialProgressView, Float>) property2, 0.0f), ObjectAnimator.ofFloat(this.s, (Property<t0, Float>) property2, 0.0f));
        }
        this.w.setDuration(180L);
        this.w.addListener(new ag.x(18, this, z10));
        this.w.start();
    }
    ...
    public final View createView(Context context) {
        ...
        this.c = h1Var;
        h1Var.setBackgroundColor(g6.w0(null, g6.a7, false));
        this.y = new y8(this.D);
        ...
        this.n = p1Var;
        oVar.setText(name);
        ((hh.o) this.n.b).setSelection(name.length());
        ((hh.o) this.n.b).addTextChangedListener(new ch.e(this, i11));
        ...
        this.s = t0Var;
        this.r.addView(t0Var, z5.d(72, 72.0f, 81, 0.0f, 0.0f, 0.0f, 28.0f));
    ...
    public final String getInitialSearchString() {
        return ((hh.o) this.n.b).getText().toString();
    }
    ...
    public final void saveSelfArgs(Bundle bundle) {
        ...
        p1 p1Var = this.n;
        if (p1Var != null) {
            String obj = ((hh.o) p1Var.b).getText().toString();
            if (obj.isEmpty()) {
                return;
            }
