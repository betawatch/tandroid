...
public abstract class u4 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i13 < size) {
            ...
            hi0 hi0Var = (spanned == null || span != null) ? 0 : (hi0) a(spanned, i14, i15, hi0.class);
            if (span == null && hi0Var == 0) {
                ...
                CodeHighlighting.Span span2 = span != null ? span : hi0Var;
                while (true) {
                    if (i13 >= size) {
                        i10 = length;
                        break;
                    ...
                    if ((span != null ? a(spanned, i16, length, CodeHighlighting.Span.class) : a(spanned, i16, length, hi0.class)) != span2) {
                        break;
                    }
                    i15 = length;
                    i13 = i17;
                ...
                if (span != null) {
                    ...
                    pageblockblockquote.collapsed = hi0Var != 0 && hi0Var.e;
        ...
        while (it.hasNext()) {
            ...
            if (pageBlock != null) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                    SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(v5.r(pageBlock.text, pageBlock, true));
                    ...
                    if (z10 || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                        spannableStringBuilder = h(v5.r(pageBlock.text, pageBlock, true), z10 ? ((TL_iv.pageBlockBlockquote) pageBlock).caption : ((TL_iv.pageBlockPullquote) pageBlock).caption);
                        ...
                        if (arrayList4 != null && !arrayList4.isEmpty()) {
                            ...
                            while (i10 < size) {
                                ...
                                SpannableStringBuilder r11 = pageListItem2 instanceof TL_iv.TL_pageListItemText ? v5.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true) : pageListItem2 instanceof TL_iv.TL_pageListItemBlocks ? c(((TL_iv.TL_pageListItemBlocks) pageListItem2).blocks) : null;
                                if (r11 != null) {
                        ...
                        if (arrayList6 != null && !arrayList6.isEmpty()) {
                            ...
                            while (i10 < size2) {
                                ...
                                if (r12 != null) {
                                    SpannableStringBuilder spannableStringBuilder4 = new SpannableStringBuilder(s3.c.l(!TextUtils.isEmpty(pageListOrderedItem2.num) ? pageListOrderedItem2.num : String.valueOf(i11), ".  "));
                        ...
                        SpannableStringBuilder r13 = v5.r(pageblocktable.title, null, true);
                            ...
                            while (i12 < size3) {
                                ...
                                if (arrayList10 != null && !arrayList10.isEmpty()) {
                                    ...
                                    for (int i13 = 0; i13 < pagetablerow2.cells.size(); i13++) {
                                        ...
                                        spannableStringBuilder5.append((CharSequence) v5.r(pagetablerow2.cells.get(i13).text, null, true));
                                    }
                        ...
                        spannableStringBuilder = v5.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                        ...
                        spannableStringBuilder = v5.r(pageBlock.text, pageBlock, true);
                    } else if (pageBlock.caption != null) {
                        SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder();
                        SpannableStringBuilder r14 = v5.r(pageBlock.caption.text, null, true);
                        if (!TextUtils.isEmpty(r14)) {
                            spannableStringBuilder6.append((CharSequence) r14);
                        }
                        SpannableStringBuilder r15 = v5.r(pageBlock.caption.credit, null, true);
    ...
    public static SpannableStringBuilder i(a aVar, boolean z10) {
        ...
        if (z10) {
            TL_iv.PageBlock pageBlock = aVar.b;
            r10 = v5.r(pageBlock != null ? pageBlock.text : null, pageBlock, false);
        } else {
            TL_iv.PageBlock pageBlock2 = aVar.b;
            r10 = v5.r(pageBlock2 != null ? pageBlock2.text : null, pageBlock2, true);
        }
