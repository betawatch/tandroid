...
public abstract class n3 extends FrameLayout {
    ...
    public n3(Context context) {
        ...
        this.R = true;
        this.b = new org.telegram.ui.Cells.f1(context, new qr(this, ViewConfiguration.get(context).getScaledTouchSlop(), 2));
    ...
    public void setOffsetY(final float f10) {
        ...
        jVar3.b(new o1.g() { // from class: rh.l3
            @Override // o1.g
            public final void a(o1.h hVar, float f13, float f14) {
                ...
                if (z4) {
                    n3Var.r = k7.n.a(n3Var.r - (Math.max(0.0f, f15) * f17), (-n3Var.f) + n3Var.e, (n3Var.getHeight() - n3Var.f) + n3Var.e);
                }
                o1.j jVar4 = n3Var.D;
                if (jVar4 != null) {
                    o1.k kVar = jVar4.u;
                    if (((float) kVar.i) == (-f16) + n3Var.e) {
                        kVar.i = (-f10) + r1;
                    }
                }
                n3Var.c();
