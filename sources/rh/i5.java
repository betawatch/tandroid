...
public final class i5 extends ViewGroup {
    ...
    public final TL_iv.pageTableCell a() {
        ...
        if (x5Var != null && x5Var.b != 0 && x5Var.c != 0) {
            ...
            while (i12 < size) {
                ...
                if (((LinkedHashSet) ((lh.p) this.h).b).contains(pagetablecell3)) {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (a2 != null) {
            ...
            if (b11 >= 0 && a3 >= 0) {
                ...
                if (o(b11)) {
                    ...
                    int[] iArr = this.f;
                    this.G = iArr[b11];
                    this.H = iArr[Math.min(b11 + i17, this.a.b)];
                }
                if (n(a3)) {
                    this.F = true;
                    int[] iArr2 = this.e;
                    this.I = iArr2[a3];
                    this.J = iArr2[Math.min(a3 + i18, this.a.c)];
                }
            }
        }
        x5 x5Var2 = this.a;
        RectF rectF = this.y;
        if (x5Var2 != null && x5Var2.b != 0 && x5Var2.c != 0) {
            ...
            float f13 = this.f[0];
            x5 x5Var3 = this.a;
            rectF.set(f12, f13, r2[x5Var3.c], r4[x5Var3.b]);
            Path path = this.B;
            path.rewind();
            ...
            for (int i19 = 0; i19 < getChildCount(); i19++) {
                ...
                if (childAt instanceof j5) {
                    j5 j5Var = (j5) childAt;
                    int b12 = this.a.b(j5Var.b);
                    int a10 = this.a.a(j5Var.b);
                    if (b12 >= 0 && a10 >= 0) {
                        int n10 = x5.n(j5Var.b);
                        int o10 = x5.o(j5Var.b);
                        int[] iArr3 = this.e;
                        int i20 = iArr3[a10];
                        int i21 = this.f[b12];
                        int i22 = iArr3[Math.min(a10 + n10, this.a.c)];
        ...
        if (l()) {
            ...
            if (c(j10, q6)) {
                int[] iArr5 = this.e;
                g(canvas3, iArr5[j10], iArr5[q6 + 1]);
            }
        } else {
            if (this.E) {
        ...
        x5 x5Var4 = this.a;
        if (x5Var4 != null && (pageblocktable = x5Var4.a) != null && pageblocktable.bordered) {
            Paint paint = this.n;
            ...
            int[] iArr7 = this.f;
            x5 x5Var5 = this.a;
            rectF.set(iArr6[0] + strokeWidth, iArr7[0] + strokeWidth, iArr6[x5Var5.c] - strokeWidth, iArr7[x5Var5.b] - strokeWidth);
            ...
            while (i24 < this.a.c) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[] pagetablecellArr = x5Var6.d[i27];
        ...
        if (this.a != null) {
            ...
            if (d > 0.001f) {
                ...
                if (!l10) {
                    ...
                    int[] iArr10 = this.e;
                    float f32 = (iArr10[a12] + iArr10[Math.min(a12 + i45, this.a.c)]) / 2.0f;
                ...
                if (a13 == null) {
                    ...
                    min2 = Math.min(i50 + a14, this.a.c);
                }
                if (u10) {
                    int[] iArr13 = this.e;
                    f11 = iArr13[j11] + iArr13[q9 + 1];
                } else {
                    int[] iArr14 = this.e;
                    f11 = iArr14[a14] + iArr14[min2];
                }
                float f34 = f11 / f10;
                paint3.setColor((u10 && c(j11, q9)) ? this.L : this.K);
    ...
    public final boolean l() {
        ...
        if (x5Var != null && this.h != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                if (((LinkedHashSet) ((lh.p) this.h).b).contains((TL_iv.pageTableCell) obj)) {
                    return true;
                }
            }
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt instanceof j5) {
                j5 j5Var = (j5) childAt;
                int b10 = this.a.b(j5Var.b);
                int a2 = this.a.a(j5Var.b);
                if (b10 >= 0 && a2 >= 0) {
                    int i15 = this.e[a2];
                    int i16 = this.f[b10];
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.c = new int[i17];
        this.d = new int[i16];
        int dp5 = AndroidUtilities.dp(x5Var2.a.compact ? 20.0f : 50.0f);
        int i18 = this.a.a.compact ? 5 : 12;
        int d = i17 == 2 ? i0.a.d(i18 * 4, size / 2, 0) : Math.max(0, Math.round(size / 1.5f));
        float f10 = i18 * 2;
        int b10 = org.telegram.messenger.y1.b(f10, d, dp5);
        ...
        while (true) {
            ...
            if (childAt instanceof j5) {
                j5 j5Var = (j5) childAt;
                d1 d1Var = j5Var.a;
                if (x5.n(j5Var.b) == 1 && (a2 = this.a.a(j5Var.b)) >= 0 && a2 < i17) {
        ...
        while (i21 < getChildCount()) {
            ...
            if (childAt2 instanceof j5) {
                ...
                d1 d1Var2 = j5Var2.a;
                int n10 = x5.n(j5Var2.b);
                if (n10 > i12) {
                    int a3 = this.a.a(j5Var2.b);
                    int min = Math.min(i17, n10 + a3);
                    if (a3 >= 0 && a3 < min) {
                        int i22 = 0;
                        for (int i23 = a3; i23 < min; i23++) {
                            i22 += this.c[i23];
                        }
                        int min2 = Math.min((min - a3) * b10, AndroidUtilities.dp(f10) + Math.round(Layout.getDesiredWidth(d1Var2.getText(), d1Var2.getPaint()))) - i22;
                        while (a3 < min && min2 > 0) {
                            int i24 = ((min2 + r14) - 1) / (min - a3);
                            int[] iArr2 = this.c;
                            iArr2[a3] = iArr2[a3] + i24;
                            min2 -= i24;
                            a3++;
                        }
                    }
        ...
        while (i30 < getChildCount()) {
            ...
            if (childAt3 instanceof j5) {
                ...
                int b11 = this.a.b(j5Var3.b);
                int a10 = this.a.a(j5Var3.b);
                int n11 = x5.n(j5Var3.b);
                i15 = i30;
                int i31 = 0;
                for (int i32 = a10; i32 < a10 + n11 && i32 < i17; i32++) {
                    i31 += this.c[i32];
                }
                j5Var3.measure(View.MeasureSpec.makeMeasureSpec(i31, TLObject.FLAG_30), makeMeasureSpec);
                if (x5.o(j5Var3.b) == 1) {
        ...
        for (int i33 = 0; i33 < getChildCount(); i33++) {
            ...
            if (childAt4 instanceof j5) {
                ...
                int b12 = this.a.b(j5Var4.b);
                int o10 = x5.o(j5Var4.b);
                if (o10 > 1) {
                    int i34 = b12;
                    int i35 = 0;
                    while (true) {
        ...
        while (i37 < getChildCount()) {
            ...
            if (childAt5 instanceof j5) {
                ...
                int b13 = this.a.b(j5Var5.b);
                int a11 = this.a.a(j5Var5.b);
                int n12 = x5.n(j5Var5.b);
                int o11 = x5.o(j5Var5.b);
                i13 = i37;
                int i38 = 0;
                for (int i39 = a11; i39 < a11 + n12 && i39 < i17; i39++) {
                    i38 += this.c[i39];
                }
                int i40 = 0;
                ...
                j5Var5.measure(View.MeasureSpec.makeMeasureSpec(i38, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i40, TLObject.FLAG_30));
            } else {
                i13 = i37;
            }
            i37 = i13 + 1;
    ...
    public final boolean p(int i10, int i11) {
        h5 h5Var;
        x5 x5Var = this.a;
        if (x5Var == null || (h5Var = this.h) == null || i10 < 0 || i10 >= x5Var.b || i11 < 0 || i11 >= x5Var.c) {
            return false;
        }
        return ((LinkedHashSet) ((lh.p) h5Var).b).contains(x5Var.d[i10][i11]);
    }
    ...
    public final void s() {
        ...
        int size = x5Var.g.size();
        for (int i10 = 0; i10 < size; i10++) {
            TL_iv.pageTableCell pagetablecell = (TL_iv.pageTableCell) this.a.g.get(i10);
            j5 j5Var = new j5(getContext(), this.b);
            j5Var.setCompact(this.a.a.compact);
