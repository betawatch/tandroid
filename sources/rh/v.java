...
public final class v extends qa {
    ...
    public final org.telegram.ui.Cells.g3 a0;
    ...
    public v(int i10, Context context, Utilities.Callback callback, c6 c6Var) {
        ...
        b6.a(imageView);
        final int i13 = 0;
        imageView.setOnClickListener(new View.OnClickListener(this) { // from class: rh.t
            ...
            public final void onClick(View view) {
                switch (i13) {
                    ...
                    default:
                        v vVar = this.b;
                        org.telegram.ui.Cells.g3 g3Var = vVar.a0;
                        if (!vVar.c0) {
                            ...
                            if (richMessage == null) {
                                ...
                                if (!TextUtils.isEmpty(trim)) {
                                    ...
                                    vVar.d0 = ConnectionsManager.getInstance(vVar.T).sendRequest(tL_messages_composeRichMessageWithAI, new cf.a(vVar, 28));
        ...
        int i14 = g6.d6;
        previewView.setBackground(g6.b0(dp, g6.v0(i14, c6Var)));
        ...
        final int i15 = 1;
        g10.setOnClickListener(new View.OnClickListener(this) { // from class: rh.t
            public final /* synthetic */ v b;
            ...
            public final void onClick(View view) {
                switch (i15) {
                    ...
                    default:
                        v vVar = this.b;
                        org.telegram.ui.Cells.g3 g3Var2 = vVar.a0;
                        if (!vVar.c0) {
                            TL_iv.RichMessage richMessage = vVar.e0;
                            if (richMessage == null) {
                                String trim = g3Var2.b.getText().toString().trim();
                                if (!TextUtils.isEmpty(trim)) {
                                    vVar.c0 = true;
                                    vVar.b0.setLoading(true);
                                    TLRPC.TL_messages_composeRichMessageWithAI tL_messages_composeRichMessageWithAI = new TLRPC.TL_messages_composeRichMessageWithAI();
                                    ...
                                    tL_messages_composeRichMessageWithAI.tone = inputaicomposetonesingleuse;
                                    vVar.d0 = ConnectionsManager.getInstance(vVar.T).sendRequest(tL_messages_composeRichMessageWithAI, new cf.a(vVar, 28));
                                    AndroidUtilities.hideKeyboard(g3Var2.b);
                                    break;
                                }
                            } else {
                                Utilities.Callback callback2 = vVar.U;
        ...
        this.containerView.addView(g10, z5.d(-1, 48.0f, 87, 12.0f, 12.0f, 12.0f, 12.0f));
