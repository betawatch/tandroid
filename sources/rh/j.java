...
public final class j extends n20 implements NotificationCenter.NotificationCenterDelegate {
    public final long M;
    ...
    public static void A0(j jVar, int i10) {
        ...
        int i12 = j6.G6;
        textView.setTextColor(j6.v0(i12, jVar.resourceProvider));
        ...
        ym0Var.setTextColor(j6.v0(i12, jVar.resourceProvider));
        ym0Var.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.AffiliateProgramStopText1)));
        linearLayout.addView(ym0Var, b6.k(0.0f, 0.0f, 0.0f, 17.0f, -1, -2));
        ...
        ym0Var2.setTextColor(j6.v0(i12, jVar.resourceProvider));
        ym0Var2.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.AffiliateProgramStopText2)));
        linearLayout.addView(ym0Var2, b6.k(0.0f, 0.0f, 0.0f, 17.0f, -1, -2));
        ...
        ym0Var3.setTextColor(j6.v0(i12, jVar.resourceProvider));
        ym0Var3.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.AffiliateProgramStopText3)));
        linearLayout.addView(ym0Var3, b6.k(0.0f, 0.0f, 0.0f, 10.0f, -1, -2));
        ...
        alertDialog$Builder.k(LocaleController.getString(R.string.AffiliateProgramStopButton), new z8(jVar, 3));
    ...
    public static void x0(j jVar, Context context) {
        if (jVar.Q.T) {
            ...
            alertDialog$Builder.k(LocaleController.getString(jVar.T ? R.string.AffiliateProgramStartAlertButton : R.string.AffiliateProgramUpdateAlertButton), new z8(dVar, 2));
    ...
    public final void E0(ArrayList arrayList, w51 w51Var) {
        ...
        v7Var.a = i10;
        v7Var.b = i12;
        v7Var.e = new ga(yhVar, 7);
        i51Var2.G = v7Var;
        i51Var2.B = -1L;
        i51Var2.B = this.U == null ? -1 : r3.commission_permille;
        arrayList.add(i51Var2);
        ai.A(R.string.AffiliateProgramCommissionInfo, arrayList);
        ai.q(R.string.AffiliateProgramDuration, arrayList);
        ...
        ai.A(R.string.AffiliateProgramDurationInfo, arrayList);
        arrayList.add(f.a(2, getThemedColor(j6.uj), R.drawable.filled_earn_stars, LocaleController.getString(R.string.AffiliateProgramExistingProgramsTitle), LocaleController.getString(R.string.AffiliateProgramExistingProgramsText)));
    ...
    public final View createView(Context context) {
        ...
        new nw0(this, context, 8).setBackgroundColor(j6.w0(null, j6.i5, false));
        ...
        this.Q.setOnClickListener(new s8(1, this, context));
        this.P.addView(this.Q, b6.k(10.0f, 10.0f, 10.0f, 7.0f, -1, 48));
        f90 f90Var = new f90(context, this.resourceProvider);
        this.R = f90Var;
        f90Var.setTextColor(getThemedColor(j6.z6));
