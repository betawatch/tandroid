    ...
    public static void a(SpannableStringBuilder spannableStringBuilder, TL_iv.RichText richText, int i10, TL_iv.PageBlock pageBlock, boolean z10) {
        ...
        if (richText instanceof TL_iv.textDate) {
            ...
            if (spannableStringBuilder.length() > length4) {
                ...
                xz0 xz0Var3 = new xz0();
                xz0Var3.a |= 128;
                spannableStringBuilder.setSpan(new v00(charSequence2, xz0Var3, tL_messageEntityFormattedDate), length4, spannableStringBuilder.length(), 33);
                return;
            }
            return;
        }
    ...
    public static int d(CharSequence charSequence) {
        ...
        for (Emoji.EmojiSpan emojiSpan : (Emoji.EmojiSpan[]) spanned.getSpans(0, charSequence.length(), Emoji.EmojiSpan.class)) {
            ...
            while (true) {
                ...
                i10 = (spanned.getSpanStart(t5Var2) == spanStart && spanned.getSpanEnd(t5Var2) == spanEnd) ? 0 : i10 + 1;
            }
        }
    ...
    */
    public static TL_iv.RichText f(CharSequence charSequence) {
        ...
        while (i10 < length) {
            ...
            if (((q41[]) spanned.getSpans(i10, nextSpanTransition, q41.class)).length > 0) {
                u5Var2.a |= 4;
            }
            t41[] t41VarArr = (t41[]) spanned.getSpans(i10, nextSpanTransition, t41.class);
            if (t41VarArr.length > 0) {
                u5Var2.b = t41VarArr[0].getURL();
            }
            v00[] v00VarArr = (v00[]) spanned.getSpans(i10, nextSpanTransition, v00.class);
            if (v00VarArr.length > 0) {
                u5Var2.c = v00VarArr[0];
            }
            org.telegram.ui.Components.t5[] t5VarArr = (org.telegram.ui.Components.t5[]) spanned.getSpans(i10, nextSpanTransition, org.telegram.ui.Components.t5.class);
            if (t5VarArr.length > 0) {
                u5Var2.d = t5VarArr[0].getDocumentId();
            }
    ...
    public static boolean g(Editable editable, int i10, int i11) {
        ...
        if (max < max2 && com.google.android.recaptcha.internal.a.u(editable)) {
            while (max < max2) {
                int nextSpanTransition = editable.nextSpanTransition(max, max2, v00.class);
                if (((v00[]) editable.getSpans(max, nextSpanTransition, v00.class)).length != 0) {
    ...
    public static boolean h(Editable editable, int i10, int i11) {
        ...
        if (max < max2 && com.google.android.recaptcha.internal.a.u(editable)) {
            while (max < max2) {
                int nextSpanTransition = editable.nextSpanTransition(max, max2, t41.class);
                if (((t41[]) editable.getSpans(max, nextSpanTransition, t41.class)).length != 0) {
                    max = nextSpanTransition;
                }
            }
            return true;
    ...
    public static boolean i(int i10, int i11, int i12, CharSequence charSequence) {
        ...
        Spanned spanned = (Spanned) charSequence;
        while (max < max2) {
            int nextSpanTransition = spanned.nextSpanTransition(max, max2, yz0.class);
    ...
    public static void m(Editable editable, int i10, int i11) {
        ...
        for (v00 v00Var : (v00[]) editable.getSpans(max, max2, v00.class)) {
    ...
    public static void n(Editable editable, int i10, int i11) {
        ...
        for (t41 t41Var : (t41[]) editable.getSpans(max, max2, t41.class)) {
            int spanStart = editable.getSpanStart(t41Var);
            int spanEnd = editable.getSpanEnd(t41Var);
            editable.removeSpan(t41Var);
            if (spanStart < max) {
                editable.setSpan(k(t41Var.getURL()), spanStart, max, 33);
            }
            if (spanEnd > max2) {
                editable.setSpan(k(t41Var.getURL()), max2, spanEnd, 33);
            }
        }
    }
    ...
    public static void o(Spannable spannable, int i10, int i11, int i12, boolean z10, TL_iv.PageBlock pageBlock) {
        ...
        for (yz0 yz0Var : (yz0[]) spannable.getSpans(max, max2, yz0.class)) {
        ...
        if (z10) {
            while (max < max2) {
                int nextSpanTransition = spannable.nextSpanTransition(max, max2, yz0.class);
    ...
    public static yz0 p(int i10, TL_iv.PageBlock pageBlock) {
        xz0 xz0Var = new xz0();
        xz0Var.a = i10;
        xz0Var.e = (pageBlock instanceof TL_iv.pageBlockTitle) || (pageBlock instanceof TL_iv.pageBlockSubheader) || (pageBlock instanceof TL_iv.pageBlockHeader) || (pageBlock instanceof TL_iv.pageBlockHeading1) || (pageBlock instanceof TL_iv.pageBlockHeading2) || (pageBlock instanceof TL_iv.pageBlockHeading3) || (pageBlock instanceof TL_iv.pageBlockHeading4) || (pageBlock instanceof TL_iv.pageBlockHeading5) || (pageBlock instanceof TL_iv.pageBlockHeading6);
