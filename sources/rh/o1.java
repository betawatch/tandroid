...
public abstract class o1 {
    ...
    public static void a(Activity activity, final int i10, final long j10, final long j11, TL_bots.botVerifierSettings botverifiersettings, final k1 k1Var) {
        String str;
        TLRPC.Chat chat;
        if (j11 >= 0) {
        ...
        alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new org.telegram.ui.ActionBar.c2() { // from class: rh.m1
            ...
            public final void i(org.telegram.ui.ActionBar.d2 d2Var, int i11) {
                ...
                ConnectionsManager.getInstance(i12).sendRequest(setcustomverification, new ii1(4, zArr2, k1Var));
            }
        });
