...
public final class y4 extends y implements org.telegram.ui.ActionBar.x5, i9 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        w4 w4Var = this.s;
        j9 textSelectionHelper = w4Var != null ? ((v2) w4Var).a.getTextSelectionHelper() : null;
    ...
    public final void h() {
        a aVar;
        w4 w4Var = this.s;
        if (w4Var == null || (aVar = this.a) == null) {
            return;
        }
        long j10 = aVar.t;
        TL_iv.RichText f10 = v5.f(this.r.getText());
        p3 p3Var = ((v2) w4Var).a;
        if (f10 == null || (f10 instanceof TL_iv.textEmpty)) {
            p3Var.i3.remove(Long.valueOf(j10));
        } else {
            p3Var.i3.put(Long.valueOf(j10), f10);
        }
    }
}
