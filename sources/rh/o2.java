...
public final class o2 extends qv0 implements org.telegram.ui.ActionBar.u3 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (p2Var.s == null || AndroidUtilities.isTablet()) {
            ...
            getHeight();
            jVar.s(canvas, true, false, lerp, 1.0f - p2Var.c0);
            canvas.translate((1.0f - p2Var.c0) * (-rect.left), 0.0f);
            z4 = true;
        }
        ...
        if (wd0Var.getVisibility() != 0) {
            ...
            if (rect2.right > 0) {
                canvas.drawRect(ai.c(1.0f, p2Var.c0, rect2.right, getWidth()), 0.0f, getWidth(), getHeight(), paint);
            }
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (p2Var.p0.getVisibility() != 0) {
            ...
            if (jVar != null) {
                ...
                getHeight();
                canvas2 = canvas;
                jVar.s(canvas2, false, false, width, 1.0f - p2Var.c0);
            } else {
                canvas2 = canvas;
            }
            if (!p2Var.S) {
                int v02 = j6.v0(j6.d6, p2Var.B);
                paint2.setColor(v02);
            ...
            org.telegram.ui.ActionBar.n3 n3Var = p2Var.r;
