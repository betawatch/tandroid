...
public final class e3 extends l20 implements NotificationCenter.NotificationCenterDelegate {
    public final long M;
    ...
    public static void A0(e3 e3Var, TLObject tLObject, org.telegram.ui.ActionBar.d2 d2Var) {
        long j10 = e3Var.M;
        if (tLObject instanceof TL_payments.connectedStarRefBots) {
            TL_payments.connectedStarRefBots connectedstarrefbots = (TL_payments.connectedStarRefBots) tLObject;
            lh.y d = lh.b0.g(e3Var.currentAccount).d(j10);
            ...
            d.a();
            lh.z e = lh.b0.g(e3Var.currentAccount).e(j10);
            e.c = 0;
            e.d = false;
            e.i = false;
            e.f = 0L;
    ...
    public static boolean B0(e3 e3Var, Context context, View view, int i10) {
        w2 w2Var = e3Var.Q;
        if (w2Var != null) {
            Object obj = w2Var.G(i10).G;
            if (obj instanceof TL_payments.connectedBotStarRef) {
                TL_payments.connectedBotStarRef connectedbotstarref = (TL_payments.connectedBotStarRef) obj;
                TLRPC.User user = MessagesController.getInstance(e3Var.currentAccount).getUser(Long.valueOf(connectedbotstarref.bot_id));
                o70 H = o70.H(e3Var, view);
                H.l(R.drawable.msg_bot, LocaleController.getString(R.string.ProfileBotOpenApp), new f6(14, e3Var, user), user.bot_has_main_app);
                H.l(R.drawable.msg_bot, LocaleController.getString(R.string.BotWebViewOpenBot), new f6(15, e3Var, connectedbotstarref), !user.bot_has_main_app);
                H.c(R.drawable.msg_link2, LocaleController.getString(R.string.CopyLink), new m71(e3Var, connectedbotstarref, user, 24), false);
                H.m(!connectedbotstarref.revoked, R.drawable.msg_leave, LocaleController.getString(R.string.LeaveAffiliateLinkButton), true, new wx0(e3Var, context, user, connectedbotstarref, 17));
                H.V(5);
                H.Z();
                return true;
            }
    ...
    */
    public static void G0(Context context, int i10, final TL_payments.starRefProgram starrefprogram, long j10, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        long[] jArr;
        float f10;
        String str;
        String str2;
        ...
        if (starrefprogram.daily_revenue_per_user.positive()) {
            ...
            textView2.setText(ja.R0(sb.toString(), 0.75f, new mq[1]));
        ...
        mq mqVar = new mq(R.drawable.msg_link_1, 0);
        mqVar.setScale(0.65f, 0.65f);
        mqVar.spaceScaleX = 0.7f;
        mqVar.translate(AndroidUtilities.dp(-2.0f), AndroidUtilities.dp(0.0f));
        ...
        TextView j11 = yh.j(f11, textView6, b6.k(0.0f, 10.0f, 0.0f, 20.0f, -1, -2), context);
        org.telegram.ui.b.l(i12, f6Var, j11, 1, 14.0f);
        j11.setGravity(17);
        NotificationCenter.listenEmojiLoading(j11);
        ...
        if (i16 <= 0) {
            ...
            if (i16 < 12 || i16 % 12 != 0) {
                ...
                j11.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString(i15, objArr)), j11.getPaint().getFontMetricsInt(), r14));
                f11.addView(j11, b6.k(0.0f, 0.0f, 0.0f, 22.0f, -1, -2));
                if (j10 < 0) {
                ...
                e90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfo), new e2.f(context, 12)));
                e90Var.setGravity(17);
                e90Var.setTextSize(1, 12.0f);
                e90Var.setTextColor(j6.v0(j6.B6, f6Var));
                e90Var.setLinkTextColor(j6.v0(j6.gc, f6Var));
                f11.addView(e90Var, b6.t(-1, -2, 49, 14, 14, 14, 6));
                o10.customView = f11;
                final int i17 = 1;
                p9Var2.setOnClickListener(new View.OnClickListener() { // from class: rh.r2
                        ...
                        switch (i17) {
                            case 0:
                                ...
                                if (U != null) {
                                    ...
                                    U.presentFragment(new z2(bundle, g3Var));
                                    break;
                                }
                                break;
                            default:
                ...
                dg.f3 f3Var = new dg.f3(jArr, i10, p9Var3, p9Var, textView, 26);
                f3Var.run();
                ...
                final int i18 = 0;
                linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: rh.r2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        switch (i18) {
                            case 0:
        ...
        j11.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString(i15, objArr2)), j11.getPaint().getFontMetricsInt(), r14));
        f11.addView(j11, b6.k(0.0f, 0.0f, 0.0f, 22.0f, -1, -2));
        if (j10 < 0) {
        }
        ...
        e90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfo), new e2.f(context, 12)));
        e90Var2.setGravity(17);
        e90Var2.setTextSize(1, 12.0f);
        e90Var2.setTextColor(j6.v0(j6.B6, f6Var));
        e90Var2.setLinkTextColor(j6.v0(j6.gc, f6Var));
        f11.addView(e90Var2, b6.t(-1, -2, 49, 14, 14, 14, 6));
        o10.customView = f11;
        final int i172 = 1;
        p9Var2.setOnClickListener(new View.OnClickListener() { // from class: rh.r2
            @Override // android.view.View.OnClickListener
        ...
        o10.setOnDismissListener(new dg.e0(6));
        dg.f3 f3Var2 = new dg.f3(jArr, i10, p9Var3, p9Var, textView, 26);
        f3Var2.run();
        if (linearLayout == null) {
        }
        final int i182 = 0;
    ...
    public static org.telegram.ui.ActionBar.g3 H0(Context context, int i10, TL_payments.connectedBotStarRef connectedbotstarref, long j10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (connectedbotstarref.participants > 0) {
            ...
            mqVar.setScale(0.937f, 0.937f);
            mqVar.translate(-AndroidUtilities.dp(1.33f), AndroidUtilities.dp(1.0f));
        ...
        if (connectedbotstarref.revoked) {
            ...
            spannableStringBuilder2.setSpan(new mq(R.drawable.msg_copy_filled, 0), 0, 1, 33);
        ...
        e90Var.setText(formatPluralString3);
        e90Var.setGravity(17);
        e90Var.setTextSize(i13, 12.0f);
        e90Var.setTextColor(j6.v0(j6.B6, f6Var));
        e90Var.setLinkTextColor(j6.v0(j6.gc, f6Var));
        f10.addView(e90Var, b6.t(-1, -2, 49, 14, 12, 14, 2));
        org.telegram.ui.ActionBar.g3 g3Var2 = g3Var;
        g3Var2.customView = f10;
        wx0 wx0Var = new wx0(connectedbotstarref, g3Var2, f6Var, user, 16);
        if (!connectedbotstarref.revoked) {
            textView7.setOnClickListener(new oh.n(wx0Var, 15));
        }
        dVar.setOnClickListener(new v2(connectedbotstarref, i10, g3Var2, context, j10, f6Var, wx0Var));
        ...
        if (linearLayout2 != null) {
            ...
            linearLayout5.setOnClickListener(new v2(i10, g3Var2, f6Var, linearLayout5, j10, context, connectedbotstarref));
        } else {
            connectedbotstarref2 = connectedbotstarref;
            f6Var2 = f6Var;
        }
        linearLayout.setOnClickListener(new t8(3, g3Var2, connectedbotstarref2));
    ...
    public static void x0(e3 e3Var, Context context, TLRPC.User user, TL_payments.connectedBotStarRef connectedbotstarref) {
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context, 0, e3Var.resourceProvider);
        ...
        alertDialog$Builder.k(LocaleController.getString(R.string.LeaveAffiliateLinkButton), new org.telegram.ui.web.m(4, e3Var, connectedbotstarref));
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
        alertDialog$Builder.d(-1);
        alertDialog$Builder.o();
    }

    public static void y0(e3 e3Var, TL_payments.connectedBotStarRef connectedbotstarref) {
        org.telegram.ui.ActionBar.d2 d2Var = new org.telegram.ui.ActionBar.d2(e3Var.getParentActivity(), 3, null);
        d2Var.q(200L);
        ...
        editconnectedstarrefbot.peer = MessagesController.getInstance(e3Var.currentAccount).getInputPeer(e3Var.M);
        editconnectedstarrefbot.revoked = true;
        e3Var.getConnectionsManager().sendRequest(editconnectedstarrefbot, new ii1(5, e3Var, d2Var));
    }

    public static /* synthetic */ void z0(e3 e3Var, Context context, int i10) {
        w2 w2Var = e3Var.Q;
        if (w2Var == null) {
            return;
        }
        ...
        if (obj instanceof TL_payments.starRefProgram) {
            G0(context, e3Var.currentAccount, (TL_payments.starRefProgram) obj, e3Var.M, e3Var.resourceProvider, false);
        } else if (obj instanceof TL_payments.connectedBotStarRef) {
            H0(context, e3Var.currentAccount, (TL_payments.connectedBotStarRef) obj, e3Var.M, e3Var.resourceProvider);
        }
    }
    ...
    */
    public final void F0(ArrayList arrayList, w51 w51Var) {
        ...
        if (!arrayList3.isEmpty() || e.c > 0) {
            ...
            mq mqVar = new mq(R.drawable.arrow_more, 0);
            mqVar.useLinkPaintColor = true;
            mqVar.setScale(0.6f, 0.6f);
            spannableString.setSpan(mqVar, spannableString.length() - 1, spannableString.length(), 33);
            spannableString.setSpan(new y2(this, i12, lh.b0.g(this.currentAccount).e(j10)), 0, spannableString.length(), 33);
            spannableStringBuilder.append((CharSequence) spannableString);
            int i132 = c3.a;
            i51 J22 = i51.J(c3.class);
            J22.l = string;
    ...
    public final View createView(Context context) {
        ...
        hn hnVar = new hn(context, 27);
        this.P = hnVar;
        hnVar.setBackgroundColor(j6.w0(null, j6.i5, false));
        ...
        this.c.setOnScrollListener(new lb0(this, 15));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        long j10 = this.M;
        if (i10 != i12) {
            if (i10 == NotificationCenter.channelSuggestedBotsUpdate && ((Long) objArr[0]).longValue() == j10 && (w2Var = this.Q) != null) {
                w2Var.N(true);
                return;
            }
            return;
    ...
    public final f2.o0 n0() {
        w2 w2Var = new w2(this, this.c, getParentActivity(), this.currentAccount, this.classGuid, new d4(this, 12), getResourceProvider());
        this.Q = w2Var;
        return w2Var;
    }
