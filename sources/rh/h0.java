...
public final class h0 {
    ...
    public boolean k;
    public boolean l;
    public final Runnable m = new ga(this, 6);
    ...
    public h0(i0 i0Var, String str, String str2) {
        ...
        this.b = str;
        this.c = str2;
        TLRPC.User user = MessagesController.getInstance(i0Var.b).getUser(Long.valueOf(i0Var.c));
        ...
        this.a = Long.valueOf(i0Var.d.enqueue(request));
    }
