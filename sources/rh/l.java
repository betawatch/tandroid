...
public final class l extends FrameLayout {
    ...
    public l(Activity activity, f6 f6Var) {
        super(activity);
        this.a = f6Var;
    ...
    */
    public final void a(final zn znVar, final MessageObject messageObject, nf nfVar, nf nfVar2) {
        boolean z4;
        float measureText;
        float measureText2;
        ...
        f90 f90Var = this.h;
        CharSequence replaceEmoji2 = Emoji.replaceEmoji(charSequence, f90Var.getPaint().getFontMetricsInt(), false);
        ...
        if (messageMedia != null) {
            ...
            if (photo2 == null) {
                ...
                f90Var.setText(replaceEmoji2);
                f90Var.setOnLinkPressListener(new e90() { // from class: rh.k
                ...
                textView2.setOnClickListener(new oh.n(nfVar, 12));
                setOnClickListener(new kh.t3(this, znVar, messageObject, str2, 14));
                imageView.setOnClickListener(new oh.n(nfVar2, 13));
            }
        ...
        textView22.setOnClickListener(new oh.n(nfVar, 12));
        setOnClickListener(new kh.t3(this, znVar, messageObject, str2, 14));
        imageView.setOnClickListener(new oh.n(nfVar2, 13));
    }
}
