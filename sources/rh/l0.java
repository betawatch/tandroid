...
public abstract class l0 extends LinearLayout implements ch.a, xd.i {
    ...
    public l0(Context context, f6 f6Var) {
        ...
        this.x = new xd.j(this, mr.h, 320L);
        this.a = f6Var;
        setOrientation(1);
    ...
    */
    public void setButtons(TLRPC.TL_replyKeyboardMarkup tL_replyKeyboardMarkup) {
        ...
        while (i11 < tL_replyKeyboardMarkup.rows.size()) {
            ...
            k0Var2.addView(linearLayout, b6.k(8.0f, i11 == 0 ? 8.0f : 4.0f, 8.0f, i11 == tL_replyKeyboardMarkup.rows.size() - 1 ? 8.0f : 0.0f, -1, this.h));
            ...
            while (i12 < keyboardButtonRow.buttons.size()) {
                ...
                frameLayout.addView(j0Var, b6.c(-1.0f, -1));
                linearLayout.addView(frameLayout, b6.m(size, 0, -1, 0, i12 != keyboardButtonRow.buttons.size() - 1 ? 4 : 0, 0));
                j0Var.setOnClickListener(new oh.n(this, 14));
                d6.b(j0Var, 0.02f, 1.5f);
                arrayList.add(j0Var);
                j0Var.a();
                i12++;
            }
