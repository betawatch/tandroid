    ...
    public final void onClick(View view) {
        ...
        switch (this.a) {
            ...
            case 5:
                ...
                if (!x1Var2.x0) {
                    if (x1Var2.w0 == null) {
                        ...
                        FrameLayout.LayoutParams e9 = z5.e(-1, x1Var2.j0(), 87);
                        e9.bottomMargin = x1Var2.P0;
                        x1Var2.K.addView(x1Var2.w0, indexOfChild, e9);
                    }
                    int j02 = x1Var2.j0();
                    FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) x1Var2.w0.getLayoutParams();
                    if (layoutParams == null) {
                        layoutParams = z5.e(-1, j02, 87);
                    } else {
            ...
            case 6:
                ...
                b70 b70Var = x1Var3.t0;
                if (b70Var != null) {
                    b70Var.u();
                    x1Var3.t0 = null;
                }
                final b70 H = b70.H(x1Var3, view);
                H.Q = true;
                a Q2 = x1Var3.L.Q2();
                ...
                if (m22 || p22) {
                    ...
                    if (m22) {
                        final int i11 = 0;
                        H.c(R.drawable.iv_list_tab, LocaleController.getString(R.string.ArticleIndent), new Runnable() { // from class: rh.l1
                    ...
                    if (p22) {
                        final int i12 = 1;
                        H.c(R.drawable.iv_list_untab, LocaleController.getString(R.string.ArticleOutdent), new Runnable() { // from class: rh.l1
                            @Override // java.lang.Runnable
                            public final void run() {
                                switch (i12) {
                                    case 0:
