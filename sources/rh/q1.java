        ...
        switch (i10) {
            ...
            case 1:
                if (!p2Var.Z && p2Var.G != 0) {
                    ...
                    ConnectionsManager.getInstance(p2Var.D).sendRequest(tL_messages_prolongWebView, new a2(p2Var, i11));
                    break;
                }
                break;
            case 2:
            ...
            case 7:
                ...
                if (g2Var.getSwipeOffsetY() > 0.0f) {
                    paint.setAlpha((int) ((1.0f - k7.n.a(g2Var.getSwipeOffsetY() / g2Var.getHeight(), 0.0f, 1.0f)) * 64.0f));
                } else {
                    paint.setAlpha(64);
                }
                p2Var.e.invalidate();
                p2Var.x.o(false, false);
                if (p2Var.c != null) {
                    float f10 = (1.0f - (Math.min(g2Var.getTopActionBarOffsetY(), g2Var.getTranslationY() - g2Var.getTopActionBarOffsetY()) / g2Var.getTopActionBarOffsetY()) <= 0.5f ? 0 : 1) * 100.0f;
                    o1.j jVar = p2Var.c;
                    o1.k kVar = jVar.u;
                    if (((float) kVar.i) != f10) {
                        kVar.i = f10;
                ...
                break;
            case 8:
                p2Var.x.o(true, false);
                break;
            case 9:
                Activity activity = p2Var.h0;
                if (activity instanceof LaunchActivity) {
                    ((LaunchActivity) activity).p0(zn.R9(p2Var.E));
                }
                p2Var.k(true);
                break;
            case 10:
                ...
                h2Var.y("settings_button_pressed", null);
                break;
            case 11:
                n2 n2Var = p2Var.y;
                h2 h2Var2 = p2Var.x;
                ...
                h2Var2.t(p2Var.D, p2Var.E);
                NotificationCenter.getInstance(h2Var2.J).doOnIdle(new org.telegram.ui.web.t(h2Var2, 2));
                break;
            case 12:
                MediaDataController.getInstance(p2Var.D).installShortcut(p2Var.E, MediaDataController.SHORTCUT_TYPE_ATTACHED_BOT);
                break;
            case 13:
                ze.d.s(p2Var.getContext(), LocaleController.getString(R.string.BotWebViewToSLink));
                break;
            case 14:
                int i13 = p2Var.D;
