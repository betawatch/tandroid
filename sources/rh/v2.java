...
public final /* synthetic */ class v2 implements View.OnClickListener {
    ...
    public /* synthetic */ v2(int i10, org.telegram.ui.ActionBar.g3 g3Var, f6 f6Var, LinearLayout linearLayout, long j10, Context context, TL_payments.connectedBotStarRef connectedbotstarref) {
        this.b = i10;
        this.c = g3Var;
        this.d = f6Var;
        this.n = linearLayout;
        ...
        switch (this.a) {
            case 0:
                ...
                if (!connectedbotstarref.revoked) {
                    ...
                    if (user != null) {
                        MessagesController.getInstance(i10).loadFullUser(user, 0, true, new t2(this.c, this.f, i10, this.e, this.d, 0));
                        break;
                    }
                }
                break;
            default:
                ...
                while (i12 < size) {
                    ...
                    F.g(tLObject, j10 == this.e, new u6(i11, j10, this.f, this.h, g3Var, f6Var));
                    i12 = i13;
                }
                F.t = false;
                F.s = 0;
    ...
    public /* synthetic */ v2(TL_payments.connectedBotStarRef connectedbotstarref, int i10, org.telegram.ui.ActionBar.g3 g3Var, Context context, long j10, f6 f6Var, wx0 wx0Var) {
        this.h = connectedbotstarref;
        this.b = i10;
        this.c = g3Var;
        this.f = context;
