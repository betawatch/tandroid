...
public final class e0 extends y implements org.telegram.ui.ActionBar.x5 {
    ...
    public e0(Context context, int i10, c6 c6Var) {
        ...
        final int i11 = 0;
        t1Var.setOnClickListener(new View.OnClickListener(this) { // from class: rh.a0
                ...
                switch (i11) {
                    case 0:
                        ...
                        if (c0Var != null && (aVar = e0Var.a) != null) {
                            p3 p3Var = ((h3) c0Var).a;
                            p3Var.o3(false);
                            p3Var.d3.C(new m3(p3Var, aVar, -1), view);
                            break;
                        }
                        break;
                    default:
                        ...
                        if (c0Var2 != null && (aVar2 = e0Var2.a) != null) {
                            p3 p3Var2 = ((h3) c0Var2).a;
                            p3Var2.o3(false);
                            p3Var2.d3.C(new m3(p3Var2, aVar2, -1), view);
                            break;
                        }
                        break;
                }
        ...
        final int i12 = 1;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: rh.a0
            public final /* synthetic */ e0 b;
    ...
    */
    ...
    public final void j() {
        ...
        int v = g6.v(g6.v0(g6.d6, c6Var), g6.l1(0.1f, v02));
        TextView textView = this.x;
        textView.setTextColor(v02);
        textView.setBackground(g6.Z(v, g6.l1(0.16f, v02), AndroidUtilities.dp(19.0f), AndroidUtilities.dp(19.0f)));
            ...
            if (size3 != 0) {
                ...
                if (i16 <= max2) {
                    ...
                    for (int i27 = 0; i27 < size3; i27++) {
                        int i28 = iArr[i27];
                        b0 b0Var2 = (b0) arrayList.get(i27);
                        b0Var2.getClass();
                        i26 += i28 - Math.max(AndroidUtilities.dp(34.0f), b0Var2.a.getMinWidth());
                    }
                    if (i26 <= 0) {
                        for (int i29 = 0; i29 < size3; i29++) {
                            b0 b0Var3 = (b0) arrayList.get(i29);
                            b0Var3.getClass();
                            iArr[i29] = Math.max(AndroidUtilities.dp(34.0f), b0Var3.a.getMinWidth());
                        }
                    } else {
                        ...
                        while (i30 < size3) {
                            int i32 = iArr[i30];
                            b0 b0Var4 = (b0) arrayList.get(i30);
                            b0Var4.getClass();
                            int max4 = i32 - Math.max(AndroidUtilities.dp(34.0f), b0Var4.a.getMinWidth());
                            if (i30 == i15) {
                                i13 = min - i31;
                                i12 = min;
                            } else {
                ...
                for (int i33 = 0; i33 < size3; i33++) {
                    b0 b0Var5 = (b0) arrayList.get(i33);
                    int i34 = iArr[i33];
