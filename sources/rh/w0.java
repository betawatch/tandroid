...
public final class w0 extends y implements org.telegram.ui.ActionBar.x5, i9, i0, DownloadController.FileDownloadProgressListener {
    ...
    public final void k() {
        ...
        int max = Math.max(AndroidUtilities.dp(40.0f), (((getMeasuredWidth() > 0 ? getMeasuredWidth() : AndroidUtilities.displaySize.x) - (AndroidUtilities.dp(f10) + i10)) - AndroidUtilities.dp(16.0f)) - (this.I ? this.c : 0));
