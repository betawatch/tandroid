...
public final class a5 implements c1 {
    ...
    public final void N1(final d1 d1Var, final int i10, final int i11) {
        ...
        if (!(textSelectionHelper.y() && textSelectionHelper.W == g5Var) && (k10 = g5Var.k(this.a.b)) >= 0) {
            g5Var.post(new Runnable() { // from class: rh.z4
                ...
                public final void run() {
                    ...
                    int i12 = i11;
                    if (length < i12 || d1Var2.getSelectionStart() == d1Var2.getSelectionEnd() || !textSelectionHelper.k0(g5Var2, k10, i10, i12)) {
                        return;
                    }
                    g5Var2.C = true;
    ...
    @Override // rh.c1
    public final /* synthetic */ boolean f1(d1 d1Var) {
        return false;
    }
    ...
    @Override // rh.c1
    public final /* synthetic */ void w1(d1 d1Var) {
    }
}
