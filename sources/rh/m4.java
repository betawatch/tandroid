...
public final class m4 extends y implements org.telegram.ui.ActionBar.x5, i9, i0 {
    ...
    public m4(Context context, c6 c6Var) {
        ...
        addView(h, z5.d(32, 32.0f, 53, 12.0f, 12.0f, 12.0f, 12.0f));
        h.setOnClickListener(new j4(this, 1));
        ImageView h10 = h();
        this.x = h10;
        h10.setVisibility(8);
        addView(h10, z5.d(32, 32.0f, 53, 12.0f, 12.0f, 66.0f, 12.0f));
    ...
    private void settle(float f10) {
        ...
        if (f10 >= 0.0f || this.S >= size - 1) {
            ...
            this.e0.addUpdateListener(new lh.m2(this, 20));
            this.e0.addListener(new nh.n2(this, i11, 11));
            this.e0.start();
        }
        i10 = 1;
        int i112 = i10 + this.S;
        ...
        this.e0.setInterpolator(er.h);
        this.e0.addUpdateListener(new lh.m2(this, 20));
        this.e0.addListener(new nh.n2(this, i112, 11));
        this.e0.start();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (arrayList.size() >= 2 && f13 > 0.001f) {
            ...
            int dp2 = AndroidUtilities.dp(4.0f) + org.telegram.messenger.y1.D(6.0f, size - 1, AndroidUtilities.dp(7.0f) * size);
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                g0.setAlpha((int) com.google.android.recaptcha.internal.a.B(max2, 95.0f, 160.0f, f13));
                canvas.drawCircle(AndroidUtilities.dp(f12) + clamp + (AndroidUtilities.dp(f10) * i10), dp, (AndroidUtilities.dp(1.0f) * max2) + AndroidUtilities.dp(2.0f), g0);
            }
            canvas.restore();
        }
        i3 i3Var = this.J;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int dp = z6.b(this.a) > 0 ? AndroidUtilities.dp(16.0f) : 0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (size3 == 0) {
            ...
            if (size3 != 1) {
                ...
                if (size != 0) {
                    ...
                    if (size == 1) {
                        ...
                        while (i47 < size && i47 < arrayList2.size()) {
                            ...
                            float f15 = ((i47 - this.S) * this.N) + f14;
                ...
                int dp4 = z6.b(this.a) <= 0 ? AndroidUtilities.dp(16.0f) : 0;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            while (true) {
                ...
                if (((RectF) arrayList2.get(i10)).contains(x8, y10)) {
                    i11 = i10;
                    break;
                }
                i10++;
        ...
        if (z10) {
            ...
            while (true) {
                ...
                if (((RectF) arrayList2.get(i15)).contains(x8, y10)) {
                    break;
                }
                i15++;
            }
