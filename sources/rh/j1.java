        ...
        try {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    i1 i1Var = new i1();
                    i1Var.a = next;
                    i1Var.b = jSONObject2.getLong("user_id");
                    i1Var.c = jSONObject2.getString("user_name");
                    i1Var.d = jSONObject2.getLong("created_at");
                    i1Var.e = jSONObject2.getLong("edited_at");
                    hashMap.put(next, i1Var);
                }
                return hashMap;
    ...
    public static void k(HashMap hashMap) {
        try {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                jSONObject2.put("user_id", ((i1) entry.getValue()).b);
                jSONObject2.put("user_name", ((i1) entry.getValue()).c);
    ...
    public final File c() {
        ...
        if (this.d && TextUtils.isEmpty(this.e)) {
            ...
            if (TextUtils.isEmpty(this.e)) {
                ...
                i1Var.a = uuid;
                i1Var.b = j10;
                i1Var.c = DialogObject.getName(UserConfig.getInstance(this.a).getCurrentUser());
                long currentTimeMillis = System.currentTimeMillis();
                i1Var.e = currentTimeMillis;
                i1Var.d = currentTimeMillis;
                i10.put(this.e, i1Var);
                k(i10);
            }
        }
        return d(this.e);
