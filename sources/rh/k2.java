...
public final class k2 implements org.telegram.ui.web.g0 {
    public boolean a;
    public final /* synthetic */ Context b;
    public final /* synthetic */ f6 c;
    public final /* synthetic */ p2 d;

    public k2(p2 p2Var, Context context, f6 f6Var) {
        this.d = p2Var;
        this.b = context;
        this.c = f6Var;
    }
    ...
    public final void n(TLRPC.InputInvoice inputInvoice, String str, TLObject tLObject) {
        ...
        if (tLObject instanceof TLRPC.TL_payments_paymentFormStars) {
            ...
            d2Var.q(150L);
            t7.y(p2Var.D, false).Y(null, inputInvoice, (TLRPC.TL_payments_paymentFormStars) tLObject, new lh.g3(d2Var, 1), new ph.s1(11, this, str));
            return;
        }
        ...
        if (lo0Var != null) {
            ...
            cd0Var.show();
            lo0Var.W0 = new ph.l1(this, cd0Var, str);
            lo0Var.V0 = this.c;
            cd0Var.c(lo0Var);
        }
    }
    ...
    public final void v(TLRPC.User user, String str, ArrayList arrayList) {
        ...
        if (isEmpty) {
            ...
            if (activity instanceof LaunchActivity) {
                ...
                if (lastFragment instanceof zn) {
                    ((zn) lastFragment).V.setFieldText("@" + UserObject.getPublicUsername(user) + " " + str);
                    p2Var.k(false);
                    return;
                }
                return;
        ...
        cd0 cd0Var = new cd0(this.b);
        qyVar.z2 = new a1.d(this, user, str, cd0Var, 21);
        cd0Var.show();
        cd0Var.c(qyVar);
    }
