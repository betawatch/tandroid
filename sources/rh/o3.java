...
public final class o3 {
    ...
    public o3(p3 p3Var, d1 d1Var, int i10, int i11, c4 c4Var) {
        ...
        this.c = i11;
        this.d = c4Var;
        if (c4Var == null || (textbutton = c4Var.a) == null) {
            this.e = v5.f(new SpannableStringBuilder(d1Var.getText().subSequence(i10, i11)));
        } else {
    ...
    public final void a(TL_keyboard.InlineButtonType inlineButtonType) {
        ...
        int i10;
        TL_iv.textButton textbutton;
        if (c4.c(inlineButtonType) && (text = (d1Var = this.a).getText()) != null && (i10 = this.b) >= 0) {
            ...
            v5.m(text, i10, i11);
            c4 c4Var2 = this.d;
            if (c4Var2 == null || (textbutton = c4Var2.a) == null) {
            ...
            c4Var3.a(p3Var.b3, d1Var, p3Var.c3);
