...
public final class g extends FrameLayout {
    ...
    public g(Context context, f6 f6Var) {
        ...
        FrameLayout.LayoutParams d = b6.d(28, 28.0f, 51, 17.0f, 14.33f, 0.0f, 0.0f);
        this.b = d;
        addView(imageView, d);
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        FrameLayout.LayoutParams d10 = b6.d(-1, -2.0f, 55, 62.0f, 10.0f, 40.0f, 8.66f);
        this.c = d10;
        ...
        TextView i10 = ai.i(linearLayout, textView, b6.t(-1, -2, 55, 0, 0, 0, 0), context);
        this.e = i10;
        i10.setTextSize(1, 14.0f);
        i10.setTextColor(j6.v0(j6.z6, f6Var));
        linearLayout.addView(i10, b6.t(-1, -2, 55, 0, 3, 0, 0));
        ...
        addView(textView2, b6.d(-2, 18.0f, 21, 0.0f, 0.0f, 35.33f, 0.0f));
    }
