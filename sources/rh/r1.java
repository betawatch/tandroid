        ...
        switch (i10) {
            ...
            case 1:
                if (!q2Var.Z && q2Var.G != 0) {
                    ...
                    ConnectionsManager.getInstance(q2Var.D).sendRequest(tL_messages_prolongWebView, new b2(q2Var, i11));
                    break;
                }
                break;
            case 2:
            ...
            case 7:
                ...
                q2Var.e.invalidate();
                q2Var.x.n(false, false);
                if (q2Var.c != null) {
                    float f10 = (1.0f - (Math.min(h2Var.getTopActionBarOffsetY(), h2Var.getTranslationY() - h2Var.getTopActionBarOffsetY()) / h2Var.getTopActionBarOffsetY()) <= 0.5f ? 0 : 1) * 100.0f;
                    o1.j jVar = q2Var.c;
                    o1.k kVar = jVar.u;
                    if (((float) kVar.i) != f10) {
                        kVar.i = f10;
