...
public final class x1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean W(x1 x1Var, View view) {
        rn rnVar = x1Var.F;
        if (rnVar != null && x1Var.r == null && !rnVar.c() && x1Var.L.k3() && !x1Var.L.m3()) {
            if (!x1Var.L.M3()) {
                x1Var.B0();
                return false;
            }
            ...
            if (!Z2.isEmpty()) {
                ...
                hg r10 = x1Var.K0.r(x1Var.u0, true, new f1(x1Var, 10));
                if (r10 != null) {
                    r10.setBackground(new w1(g6.b0(AndroidUtilities.dp(22.0f), x1Var.getThemedColor(g6.Oh))));
                    ni0 ni0Var3 = x1Var.K0;
                    int dp = AndroidUtilities.dp(44.0f);
                    ni0Var3.i0 = true;
                    ni0Var3.U = dp;
                }
                b70 H = b70.H(x1Var, x1Var.u0);
                boolean isUserSelf = UserObject.isUserSelf(x1Var.F.i());
                if (x1Var.F.D6()) {
                    H.c(R.drawable.msg_calendar2, LocaleController.getString(isUserSelf ? R.string.SetReminder : R.string.ScheduleMessage), new org.telegram.ui.web.c0(x1Var, a2, 2), false);
                    if (!isUserSelf && a2 > 0) {
    ...
    public static /* synthetic */ void X(x1 x1Var, MessageObject messageObject, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, long j10, MessageObject messageObject2, MessageObject messageObject3, boolean z10, int i10, int i11, SendMessageChatArguments sendMessageChatArguments, long j11) {
    ...
    public static void Y(final x1 x1Var, Context context, View view) {
        ...
        final b70 I = b70.I(x1Var, view);
        I.Q = true;
        b70 J = I.J();
        J.c(R.drawable.ic_ab_back, LocaleController.getString(R.string.Back), new gh.m3(I, 8), false);
        J.k();
        final int i10 = 0;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading1), R.drawable.iv_h1, null, LocaleController.getString(R.string.ArticleHeading1), new Runnable(x1Var) { // from class: rh.j1
        ...
        final int i11 = 1;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading2), R.drawable.iv_h2, null, LocaleController.getString(R.string.ArticleHeading2), new Runnable(x1Var) { // from class: rh.j1
            public final /* synthetic */ x1 b;
        ...
        final int i12 = 2;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading3), R.drawable.iv_h3, null, LocaleController.getString(R.string.ArticleHeading3), new Runnable(x1Var) { // from class: rh.j1
            public final /* synthetic */ x1 b;
        ...
        final int i13 = 3;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading4), R.drawable.iv_h4, null, LocaleController.getString(R.string.ArticleHeading4), new Runnable(x1Var) { // from class: rh.j1
            public final /* synthetic */ x1 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 1);
        final int i14 = 4;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading5), R.drawable.iv_h5, null, LocaleController.getString(R.string.ArticleHeading5), new Runnable(x1Var) { // from class: rh.j1
            public final /* synthetic */ x1 b;
        ...
        J.y().a.setTextSize(1, SharedConfig.fontSize - 2);
        final int i15 = 5;
        J.j(Q2 != null && (Q2.b instanceof TL_iv.pageBlockHeading6), R.drawable.iv_h6, null, LocaleController.getString(R.string.ArticleHeading6), new Runnable(x1Var) { // from class: rh.j1
            public final /* synthetic */ x1 b;
        ...
        int i16 = g6.G8;
        v1Var.d = i16;
        I.j(z10, 0, v1Var, LocaleController.getString(R.string.ArticleHeading), new gh.f3(I, b70Var, 11));
    ...
    public static void Z(x1 x1Var, boolean z10, boolean z11) {
        ...
        if (z11) {
            x1Var.s0.animate().scaleX(f10).scaleY(f10).setDuration(180L).setInterpolator(er.h).start();
        } else {
            x1Var.s0.animate().cancel();
            x1Var.s0.setScaleX(f10);
            x1Var.s0.setScaleY(f10);
        }
        x1Var.s0.setColorFilter(new PorterDuffColorFilter(x1Var.getThemedColor(z10 ? g6.q7 : g6.G6), PorterDuff.Mode.SRC_IN));
        oi0 animatedDrawable = x1Var.s0.getAnimatedDrawable();
    ...
    public static void p0(Context context, final Runnable runnable, final Runnable runnable2, c6 c6Var) {
        ...
        TextView i12 = pa.i(linearLayout, textView, z5.t(-1, -2, 49, 25, 16, 25, 0), context);
        ...
        i12.setGravity(17);
        i12.setTextColor(g6.v0(i11, c6Var));
        linearLayout.addView(i12, z5.t(-1, -2, 49, 25, 11, 25, 0));
        lh.d g10 = rl.g(24, context, c6Var, true);
        g10.setText(LocaleController.getString(R.string.ArticleConversionSubscribe));
        linearLayout.addView(g10, z5.t(-1, 48, 49, 14, 31, 14, 0));
        lh.d g11 = rl.g(24, context, c6Var, false);
        g11.setText(LocaleController.getString(R.string.ArticleConversionConvert));
        linearLayout.addView(g11, z5.t(-1, 48, 49, 14, 2, 14, 6));
        o10.show();
        g10.setOnClickListener(new View.OnClickListener() { // from class: rh.h1
        ...
        final int i13 = 1;
        g11.setOnClickListener(new View.OnClickListener() { // from class: rh.h1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                switch (i13) {
                    case 0:
    ...
    public final t1 c0(int i10, int i11, boolean z10) {
        t1 t1Var = new t1(this.a0.getContext(), i10, getResourceProvider());
        if (z10) {
            t1Var.e();
            this.J.add(t1Var);
        }
    ...
    public final View createView(Context context) {
        ...
        this.L = p3Var;
        p3Var.setFileRefParentObject(this.r);
        this.K.addView(this.L, z5.e(-1, -1, 119));
        this.K.addView(this.L.getOverlayView(), z5.c(-1.0f, -1));
        TL_iv.RichMessage richMessage = this.b;
        if (richMessage != null) {
            p3 p3Var2 = this.L;
            ArrayList arrayList2 = p3Var2.h3;
            p3Var2.g3 = richMessage;
            p3.W2(arrayList2, richMessage.blocks, p3Var2.i3);
            p3Var2.V3();
            ...
            if (str != null) {
                ...
                HashMap hashMap = p3Var3.i3;
                ArrayList arrayList3 = p3Var3.h3;
        ...
        this.X.j(kg.e, false);
        this.a0.addView(this.X, z5.q(38, 38, 16));
        b6.a(this.X);
        ...
        this.c0.setBackground(g6.Z(getThemedColor(i11), getThemedColor(i12), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f)));
        this.a0.addView(this.c0, z5.t(38, 38, 16, 2, 0, 0, 0));
        b6.a(this.c0);
        ...
        this.U.addView(this.d0, z5.e(-2, 60, 81));
        ...
        this.s0.setColorFilter(new PorterDuffColorFilter(getThemedColor(i13), mode));
        this.s0.setBackground(new w1(g6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.r0.addView(this.s0, z5.e(-1, -1, 119));
        FrameLayout frameLayout8 = new FrameLayout(context);
        frameLayout8.setBackground(new w1(g6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.d0.addView(frameLayout8, z5.c(44.0f, -2));
        s1 s1Var = new s1(this, context);
        this.f0 = s1Var;
        s1Var.setHorizontalScrollBarEnabled(false);
        this.f0.setClipToOutline(true);
        this.f0.setOutlineProvider(new cg.l1(20));
        frameLayout8.addView(this.f0, z5.c(-1.0f, -1));
        ...
        linearLayout5.addView(this.q0, z5.t(38, 38, 16, linearLayout5.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
        ...
        linearLayout6.addView(this.n0, z5.t(38, 38, 16, linearLayout6.getChildCount() > 0 ? 2 : 0, 0, 0, 0));
        LinearLayout linearLayout7 = new LinearLayout(context);
        this.j0 = linearLayout7;
        linearLayout7.setOrientation(0);
        this.j0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.j0.setBackground(new w1(g6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.d0.addView(this.j0, z5.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        ...
        this.j0.addView(this.m0, z5.q(38, 38, 16));
        ...
        this.j0.addView(this.o0, z5.q(38, 38, 16));
        LinearLayout linearLayout8 = new LinearLayout(context);
        this.k0 = linearLayout8;
        linearLayout8.setOrientation(0);
        this.k0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.k0.setBackground(new w1(g6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.d0.addView(this.k0, z5.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        ...
        this.k0.addView(this.p0, z5.q(38, 38, 16));
        LinearLayout linearLayout9 = new LinearLayout(context);
        this.i0 = linearLayout9;
        linearLayout9.setOrientation(0);
        this.i0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.i0.setBackground(new w1(g6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i11))));
        this.d0.addView(this.i0, 0, z5.d(-2, 44.0f, 80, 0.0f, 0.0f, 8.0f, 0.0f));
        ...
        this.i0.addView(this.l0, z5.q(38, 38, 16));
        wo0 wo0Var = new wo0((Object) this, context, this.r != null ? R.drawable.input_done : l0() ? R.drawable.input_schedule : R.drawable.send_plane_24, getResourceProvider(), 3);
        this.u0 = wo0Var;
        wo0Var.setBackground(new w1(g6.b0(AndroidUtilities.dp(22.0f), getThemedColor(g6.Yd))));
        b6.a(this.u0);
        this.W.addView(this.u0, z5.p(44, 44, 0.0f, 5, 8, 0, 0, 0));
        this.u0.setContentDescription(LocaleController.getString(R.string.Send));
        this.u0.setOnClickListener(new f1(this, 0));
        this.u0.setOnLongClickListener(new lh.b5(this, 3));
        C0();
    ...
    public final void f0() {
        ...
        int round = Math.round((((this.K == null ? j0() : Math.max(j0(), ((r2.getMeasuredHeight() - this.K.getPaddingTop()) - AndroidUtilities.dp(240.0f)) - this.P0)) - r1) * this.M0) + j0());
    ...
    public final boolean l0() {
        rn rnVar;
        return this.r == null && (rnVar = this.F) != null && rnVar.c();
    }
    ...
    public final void o0(int i10, int i11) {
        ...
        giVar.f0.setIncludeVideosInGallery(true);
        giVar.f0.f0();
        giVar.J1(1, true);
        giVar.h1(i10);
        giVar.p2 = new m1(this, giVar);
    ...
    public final AnimatorSet onCustomTransitionAnimation(boolean z10, Runnable runnable) {
        ...
        this.A = true;
        this.K.invalidate();
        ofFloat.addUpdateListener(new g1(this, i10));
        ofFloat.addListener(new fk0(21, this, runnable));
        if (z10) {
    ...
    public final r0.m1 onInsetsInternal(View view, r0.m1 m1Var) {
        ...
        if (!this.C0 && z10 && (b70Var = this.t0) != null) {
            b70Var.u();
            this.t0 = null;
        }
    ...
    public final void onTransitionAnimationStart(boolean z10, boolean z11) {
        ...
        if (z10 && !z11 && (i10 = this.c) >= 0 && (p3Var2 = this.L) != null) {
            int i11 = this.d;
            this.d = -1;
            this.c = -1;
        ...
        if ((this.b == null && this.f == null) || (p3Var = this.L) == null || p3Var.a3()) {
            return;
        }
    ...
    public final boolean q0() {
        ...
        if (j22 != null && !this.I) {
            p3 p3Var = this.L;
            if (p3Var.k3() && !u4.f(p3Var.h3, p3Var.i3) && ckVar != null) {
                SpannableStringBuilder k10 = u4.k(this.L.h3);
                rn rnVar = ckVar.K2;
                if (ckVar.A0 == null) {
                    return true;
                }
                ...
                if (rnVar != null) {
                    ...
                    MediaDataController.getInstance(ckVar.M).saveDraft(rnVar.a(), rnVar.B7(rnVar.j5), charSequenceArr[0], MediaDataController.getInstance(ckVar.M).getEntities(charSequenceArr, true, false), null, null, null, 0L, false, false, null);
                }
        ...
        long a2 = this.F.a();
        rn rnVar2 = this.F;
        mediaDataController.saveDraft(a2, rnVar2.B7(rnVar2.j5), "", null, null, null, null, 0L, false, false, j22);
    ...
    /* JADX WARN: Type inference failed for: r0v19, types: [rh.k1] */
    public final void s0(final int i10, final int i11, final boolean z10) {
        ...
        if (!MessagesController.getInstance(this.currentAccount).richEditorAllowed()) {
            ...
            ckVar.R0(u4.k(this.L.h3), z10, i10, i11);
            finishFragment();
            return;
        }
        this.I = true;
        ...
        rn rnVar = this.F;
        final MessageObject messageObject = rnVar.j5;
        final MessageObject messageObject2 = rnVar.T3;
        final long N8 = rnVar.N8();
        final SendMessageChatArguments C8 = this.F.C8();
        final MessageObject messageObject3 = this.r;
        ?? r02 = new Runnable() { // from class: rh.k1
            @Override // java.lang.Runnable
            public final void run() {
                x1.X(x1.this, messageObject3, Z2, B2, y22, a2, a3, messageObject, messageObject2, z10, i10, i11, C8, N8);
            }
        };
    ...
    */
    public final void w0() {
        ...
        if (textSelectionHelper == null || !textSelectionHelper.y()) {
            ...
            Q2 = i12 == textSelectionHelper.x0 ? this.L.y4(i12) : null;
        }
        if (this.L.R2() == null) {
            if (Q2 != null) {
                if (!Q2.a() && !Q2.b() && !Q2.c()) {
                    ...
                    if (!(pageBlock instanceof TL_iv.pageBlockDetails)) {
                        if (!(pageBlock instanceof TL_iv.pageBlockTable)) {
                            ...
                            while (i11 < size) {
                                ...
                                t1Var.setSelected(i10 == intValue);
                                if (i10 == intValue) {
    ...
    public final void x0(int i10, boolean z10) {
        ...
        if (z10) {
            ...
            this.d0.animate().alpha(this.G0 == 1 ? 1.0f : 0.0f).scaleX(this.G0 == 1 ? 1.0f : 0.8f).scaleY(this.G0 == 1 ? 1.0f : 0.8f).translationY(this.G0 == 1 ? 0.0f : AndroidUtilities.dp(30.0f)).setDuration(420L).setInterpolator(erVar).withEndAction(new e1(this, 2)).start();
            this.r0.setVisibility(0);
            this.r0.animate().alpha(this.G0 == 2 ? 1.0f : 0.0f).scaleX(this.G0 == 2 ? 1.0f : 0.8f).scaleY(this.G0 == 2 ? 1.0f : 0.8f).setDuration(420L).setInterpolator(erVar).withEndAction(new e1(this, 3)).start();
            return;
        }
        ...
        this.d0.setVisibility(i10 == 1 ? 0 : 8);
        this.d0.setAlpha(i10 == 1 ? 1.0f : 0.0f);
        this.d0.setScaleX(i10 == 1 ? 1.0f : 0.8f);
        this.d0.setScaleY(i10 == 1 ? 1.0f : 0.8f);
        this.d0.setTranslationY(i10 == 1 ? 0.0f : AndroidUtilities.dp(30.0f));
        this.r0.setVisibility(i10 != 2 ? 8 : 0);
        this.r0.setAlpha(i10 == 2 ? 1.0f : 0.0f);
        this.r0.setScaleX(i10 == 2 ? 1.0f : 0.8f);
        this.r0.setScaleY(i10 == 2 ? 1.0f : 0.8f);
    }
    ...
    public final void y0() {
        ...
        if (t1Var != null) {
            p3 p3Var = this.L;
            int[] B4 = p3Var.B4();
            t1Var.setSelected(B4 != null && p3Var.H3(B4[0], B4[1]));
        }
        if (this.L.L3()) {
            ...
            boolean z13 = i11 == i12;
            d1 N4 = z13 ? this.L.N4(i10, i11) : null;
            int max = Math.max(0, Math.min(i13, i14));
            int max2 = N4 == null ? 0 : Math.max(0, Math.min(Math.max(i13, i14), N4.length()));
            t1 t1Var3 = this.m0;
            if (t1Var3 != null) {
                t1Var3.setSelected(N4 != null && max < max2 && v5.h(N4.getText(), max, max2));
            }
            t1 t1Var4 = this.o0;
            if (t1Var4 != null) {
                if (N4 != null && max < max2 && v5.g(N4.getText(), max, max2)) {
                    z12 = true;
                }
        ...
        if (this.L.w3()) {
            ...
            t1 t1Var6 = this.m0;
            if (t1Var6 != null) {
                t1Var6.setSelected(s22 != null && max3 < max4 && v5.h(s22.getText(), max3, max4));
            }
            t1 t1Var7 = this.o0;
            if (t1Var7 != null) {
                if (s22 != null && max3 < max4 && v5.g(s22.getText(), max3, max4)) {
                    z12 = true;
                }
        ...
        boolean z14 = i19 >= 0 && i20 >= 0 && i20 >= i19 && i20 < this.L.l4.size();
        ...
        if (t1Var9 != null) {
            if (z14) {
                ...
                if (H4 == null ? false : v5.h(H4, Math.max(0, Math.min(i21, i22)), Math.max(i21, i22))) {
                    z11 = true;
        ...
        if (t1Var10 != null) {
            if (z14) {
                ...
                if (H42 == null ? false : v5.g(H42, Math.max(0, Math.min(i21, i22)), Math.max(i21, i22))) {
                    z10 = true;
