    ...
    */
    public final void b(Canvas canvas) {
        ...
        while (i11 < arrayList.size()) {
            ...
            l5 l5Var = dVar.a;
            float f11 = cVar3.h;
            float lerp2 = f11 < 0.3f ? AndroidUtilities.lerp(cVar3.b, cVar3.d, prVar.getInterpolation(f11 / 0.3f)) : AndroidUtilities.lerp(cVar3.d, cVar3.e, pr.i.getInterpolation((f11 - 0.3f) / 0.7f));
