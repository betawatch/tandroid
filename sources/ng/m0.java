                    ...
                    if (this.p.equals(arrayList.get(i20).reaction) && arrayList.get(i20).unread) {
                        ...
                        if (peerId < j10) {
                            ...
                            if (chat != null) {
                                ...
                                l0Var.e = w.c.c(yh.f(random, 100), 100.0f, 0.1f, 0.3f);
                                l0Var.h = w.c.c(yh.f(random, 100), 100.0f, 0.4f, 0.8f);
                                l0Var.i = (Math.abs(random.nextInt() % 100) * 60) / 100.0f;
                                l0Var.b = (int) w.c.c(yh.f(random, 100), 100.0f, 200.0f, 400.0f);
                                float f16 = 0.6f;
                                float f17 = 0.2f;
                                if (this.x.isEmpty()) {
                                    int i21 = 0;
                                    ...
                                    while (i21 < 10) {
                                        int i22 = i21;
                                        float d = android.support.v4.media.a.d(yh.f(random, 100), f16, 100.0f, f17);
                                        float d10 = android.support.v4.media.a.d(yh.f(random, 100), 0.4f, 100.0f, f17);
                                    ...
                                    l0Var.f = android.support.v4.media.a.d(yh.f(random, 100), 0.6f, 100.0f, 0.2f);
                                    l0Var.g = (yh.f(random, 100) * 0.4f) / 100.0f;
                                }
                                this.x.add(l0Var);
                            }
                        } else {
                            ...
                            if (user != null) {
                                ...
                                l0Var2.e = w.c.c(yh.f(random, 100), 100.0f, 0.1f, 0.3f);
                                l0Var2.h = w.c.c(yh.f(random, 100), 100.0f, 0.4f, 0.8f);
                                l0Var2.i = (Math.abs(random.nextInt() % 100) * 60) / 100.0f;
                                l0Var2.b = (int) w.c.c(yh.f(random, 100), 100.0f, 200.0f, 400.0f);
                                float f162 = 0.6f;
                                float f172 = 0.2f;
                                if (this.x.isEmpty()) {
                                }
                ...
                if (view3 == null) {
                    ...
                    if (pk0Var == null) {
                        ...
                        if (tL_availableReaction != null) {
                            ...
                            if (i11 == 0) {
                                ...
                                if (i11 == 2) {
                                    ...
                                    if (i11 != 0 || i11 == 1) {
                                        ...
                                        l5Var3.setColorFilter(new PorterDuffColorFilter(messageObject3 == null ? k6.v0(messageObject3.shouldDrawWithoutBackground() ? messageObject3.isOutOwner() ? k6.Sb : k6.Cj : messageObject3.isOutOwner() ? k6.Gj : k6.Fj, p2Var != null ? p2Var.getResourceProvider() : null) : -1, PorterDuff.Mode.SRC_IN));
                                        boolean z13 = i11 != 0;
                            ...
                            l5Var32.setColorFilter(new PorterDuffColorFilter(messageObject3 == null ? k6.v0(messageObject3.shouldDrawWithoutBackground() ? messageObject3.isOutOwner() ? k6.Sb : k6.Cj : messageObject3.isOutOwner() ? k6.Gj : k6.Fj, p2Var != null ? p2Var.getResourceProvider() : null) : -1, PorterDuff.Mode.SRC_IN));
                            if (i11 != 0) {
                            }
