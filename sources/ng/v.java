...
public final class v extends FrameLayout {
                ...
                if (messageObject.getId() == this.e.getId()) {
                    ...
                    if (y10 > dp4 - (f16 / 2.0f) && y10 < dp5) {
                        ...
                        if (y10 < (dp4 - f16) - AndroidUtilities.dp(92.0f) || y10 > dp5) {
                            ...
                            float interpolation = (pr.f.getInterpolation(this.n) * this.s) + y10;
                            uVar = this.b;
                            if (uVar != null) {
                                return;
                            }
                            ...
                            this.b.setTranslationY(k7.o.a(interpolation, dp4, dp5));
                            this.b.setTranslationX(t1Var.E2(true));
                            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.b.getLayoutParams();
                            int c3 = l.d.c(32.0f, t1Var.getBackgroundDrawableLeft(), 0);
                            int c10 = l.d.c(32.0f, t1Var.getWidth() - t1Var.getBackgroundDrawableRight(), (int) t1Var.E2(true));
                    ...
                    float interpolation2 = (pr.f.getInterpolation(this.n) * this.s) + y10;
                    uVar = this.b;
                    if (uVar != null) {
                    }
                }
    ...
    */
    public void setSelectedMessages(List<MessageObject> list) {
        ...
        int i10 = xnVar.O3;
        boolean z4 = true;
        if (i10 != 1 && i10 != 5 && i10 != 6 && !xnVar.A9() && !xnVar.w() && (((chatFull = xnVar.W7) == null || !(chatFull.available_reactions instanceof TLRPC.TL_chatReactionsNone)) && !list.isEmpty())) {
            long j10 = 0;
            boolean z10 = false;
