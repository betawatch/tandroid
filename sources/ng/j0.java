...
public final class j0 extends FrameLayout {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (m0Var.l) {
            ...
            if (f22 != 1.0f) {
                ...
                if (f23 > 1.0f) {
                    m0Var.m = 1.0f;
                    final int i11 = 0;
                    AndroidUtilities.runOnUIThread(new Runnable(this) { // from class: ng.i0
            ...
            if (view instanceof t1) {
                ...
                if (view instanceof v0) {
                    ...
                    if (view instanceof zg.c) {
                        f11 += ((zg.c) view).getReactionCenterX();
        ...
        } else if (!this.c && !(view instanceof zg.c)) {
            return;
        }
        float f27 = (view instanceof zg.c ? this.f : this.f - f25) / 2.0f;
        float f28 = f11 - f27;
        float f29 = f12 - f27;
        if (this.c && this.h == 0) {
        ...
        if (this.h == 2) {
            f14 = pr.h.getInterpolation(interpolation);
            f15 = prVar.getInterpolation(interpolation);
            f13 = 2.0f;
        } else if (this.n) {
            f13 = 2.0f;
            f14 = pr.h.getInterpolation(this.x.g);
            f15 = prVar.getInterpolation(this.x.g);
        } else {
            f13 = 2.0f;
            f14 = this.x.g;
            f15 = f14;
            ...
            if (f21 != 1.0f) {
                ...
                if (m0Var7.h > f19) {
                    if (!this.c || i16 != 2) {
                        ...
                        animate().scaleX(0.0f).scaleY(0.0f).setStartDelay(1000L).setDuration(150L).setListener(new dg.l0(this, 14));
                    }
                }
                m0 m0Var9 = this.x;
                if (m0Var9.h >= 1.0f) {
