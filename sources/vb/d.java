...
public abstract class d {
    ...
    public static int a(b bVar, boolean z4) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            for (int i16 = 0; i16 < i10; i16++) {
                byte b11 = z4 ? bArr[i14][i16] : bArr[i16][i14];
                if (b11 == b10) {
                    i15++;
                } else {
                    if (i15 >= 5) {
    ...
    */
    public static void b(pb.a aVar, tb.b bVar, tb.e eVar, int i10, b bVar2) {
        ...
        pb.a aVar2 = new pb.a();
        if (i10 < 0 || i10 >= 8) {
            throw new b7.a("Invalid mask pattern");
        }
        ...
        if (aVar2.b != 15) {
            throw new b7.a("should not happen but we got: " + aVar2.b);
        }
        int i43 = 0;
        while (true) {
            int i44 = aVar2.b;
        ...
        if (i25 >= 7) {
            ...
            if (aVar4.b != 18) {
                throw new b7.a("should not happen but we got: " + aVar4.b);
            }
            int i46 = 17;
                        ...
                        if (i10 != -1) {
                            switch (i10) {
                                ...
                                case 7:
                                    ...
                                    break;
                                default:
                                    throw new IllegalArgumentException(a2.j(i10, "Invalid mask pattern: "));
                            }
                        }
        ...
        throw new b7.a("Not all bits consumed: " + i52 + '/' + aVar.b);
    }
