...
public final class g implements Collection, Set {
    ...
    public final boolean add(Object obj) {
        ...
        if (i11 >= iArr.length) {
            ...
            if (iArr2.length != 0) {
                ...
                qc.f.d(0, objArr.length, 6, objArr, this.b);
            }
        }
        if (i12 < i11) {
            int[] iArr3 = this.a;
    ...
    public final boolean addAll(Collection elements) {
        ...
        if (iArr.length < size) {
            ...
            if (i10 > 0) {
                ...
                qc.f.d(0, this.c, 6, objArr, this.b);
            }
        }
        if (this.c != i10) {
            throw new ConcurrentModificationException();
    ...
    public final void i(int i10) {
        ...
        if (iArr.length <= 8 || i11 >= iArr.length / 3) {
            ...
            if (i10 > 0) {
                qc.f.b(0, 0, i10, iArr, iArr2);
                qc.f.d(0, i10, 6, objArr, this.b);
            }
            if (i10 < i12) {
                int i15 = i10 + 1;
                qc.f.b(i10, i15, i11, iArr, this.a);
                qc.f.c(i10, i15, i11, objArr, this.b);
            }
        }
        if (i11 != this.c) {
            throw new ConcurrentModificationException();
    ...
    public final Object[] toArray(Object[] array) {
        ...
        qc.f.c(0, 0, this.c, this.b, array);
        return array;
    }
}
