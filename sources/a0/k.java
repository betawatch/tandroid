...
public class k {
        ...
        try {
            if (obj instanceof k) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    Object e9 = e(i11);
                    Object h = h(i11);
                    Object obj2 = kVar.get(e9);
                    if (h == null) {
                        if (obj2 != null || !kVar.containsKey(e9)) {
                            return false;
                        }
    ...
    public final Object f(int i10) {
        ...
        if (iArr.length <= 8 || i11 >= iArr.length / 3) {
            ...
            if (i10 > 0) {
                qc.f.b(0, 0, i10, iArr, this.a);
                qc.f.c(0, 0, i12, objArr, this.b);
            }
            if (i10 < i13) {
                int i17 = i10 + 1;
                qc.f.b(i10, i17, i11, iArr, this.a);
                qc.f.c(i12, i17 << 1, i11 << 1, objArr, this.b);
            }
        }
        if (i11 != this.c) {
            throw new ConcurrentModificationException();
    ...
    public final Object put(Object obj, Object obj2) {
        ...
        if (i12 < i10) {
            ...
            Object[] objArr2 = this.b;
            qc.f.c(i14 << 1, i12 << 1, this.c << 1, objArr2, objArr2);
        }
        int i15 = this.c;
        if (i10 == i15) {
            int[] iArr3 = this.a;
    ...
    public final boolean remove(Object obj, Object obj2) {
        int c10 = c(obj);
        if (c10 < 0 || !kotlin.jvm.internal.j.a(obj2, h(c10))) {
            return false;
        }
        f(c10);
        return true;
