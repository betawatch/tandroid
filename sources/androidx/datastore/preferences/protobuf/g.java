...
public class g implements Iterable, Serializable {
    ...
    public static g i(int i10, int i11, byte[] bArr) {
        ...
        if (((i12 - i10) | i10 | i12 | (length - i12)) < 0) {
            ...
            if (i12 < i10) {
                throw new IndexOutOfBoundsException(a9.p.j(i10, i12, "Beginning index larger than ending index: ", ", "));
            }
            throw new IndexOutOfBoundsException(a9.p.j(i12, length, "End index: ", " >= "));
        }
        switch (d.a) {
            case 0:
    ...
    public final boolean equals(Object obj) {
        ...
        if (size > gVar.size()) {
            StringBuilder o10 = i0.a.o(size, "Ran off end of other: 0, ", ", ");
