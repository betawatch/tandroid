    ...
    public final void Q(String str) {
        try {
            ...
            if (i10 > i11) {
                ...
                int f10 = u1.a.f(str, bArr, 0, length);
                T(f10);
                E(bArr, 0, f10);
                return;
            }
            ...
            try {
                if (z11 == z10) {
                    int i13 = i12 + z11;
                    this.f = i13;
                    int f11 = u1.a.f(str, bArr2, i13, i11 - i13);
                    this.f = i12;
                    p((f11 - i12) - z11);
                    this.f = f11;
                } else {
    ...
    public final void q(long j10) {
        ...
        if (z10) {
            while ((j10 & (-128)) != 0) {
                int i10 = this.f;
                this.f = i10 + 1;
                r1.j(bArr, i10, (byte) ((((int) j10) & 127) | 128));
                j10 >>>= 7;
            }
            int i11 = this.f;
            this.f = i11 + 1;
            r1.j(bArr, i11, (byte) j10);
            return;
        }
        while ((j10 & (-128)) != 0) {
            int i12 = this.f;
