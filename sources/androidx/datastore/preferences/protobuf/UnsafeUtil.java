...
abstract class UnsafeUtil {
    ...
    public static byte getByteBigEndian(Object obj, long j) {
        return (byte) ((getInt(obj, (-4) & j) >>> ((int) (((~j) & 3) << 3))) & NotificationCenter.didApplyNewTheme);
    }
    ...
    public static void putByteBigEndian(Object obj, long j, byte b) {
        ...
        int i = getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        putInt(obj, j2, ((255 & b) << i2) | (i & (~(NotificationCenter.didApplyNewTheme << i2))));
    }
    ...
    public static void putByteLittleEndian(Object obj, long j, byte b) {
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        putInt(obj, j2, ((255 & b) << i) | (getInt(obj, j2) & (~(NotificationCenter.didApplyNewTheme << i))));
    }
