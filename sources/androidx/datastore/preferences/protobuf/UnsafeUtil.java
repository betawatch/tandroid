...
abstract class UnsafeUtil {
    ...
    public static byte getByteBigEndian(Object obj, long j) {
        return (byte) ((getInt(obj, (-4) & j) >>> ((int) (((j ^ (-1)) & 3) << 3))) & NotificationCenter.reloadInterface);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static byte getByteLittleEndian(Object obj, long j) {
        return (byte) ((getInt(obj, (-4) & j) >>> ((int) ((j & 3) << 3))) & NotificationCenter.reloadInterface);
    }
    ...
    public static void putByteBigEndian(Object obj, long j, byte b) {
        long j2 = (-4) & j;
        int i = ((((int) j) ^ (-1)) & 3) << 3;
        putInt(obj, j2, ((255 & b) << i) | (getInt(obj, j2) & ((NotificationCenter.reloadInterface << i) ^ (-1))));
    }
