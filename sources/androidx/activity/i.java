    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 18:
                ...
                if (g1Var.k3) {
                    if (!arrayList.isEmpty() && (R = RecyclerView.R((i2) a2.i(1, arrayList))) >= 0) {
            ...
            case 23:
                ...
                return;
            case 24:
                ((ThreadLocal) ((com.google.firebase.messaging.r) this.b).e).set(Boolean.TRUE);
                return;
            case 25:
                la laVar = (la) this.b;
                u7 u7Var = u7.f;
