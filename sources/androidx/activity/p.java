...
public final class p extends kotlin.jvm.internal.k implements dd.l {
                    ...
                    if (j0Var2.h != null) {
                        ...
                        while (it.hasNext()) {
                            ...
                            while (i10 < size) {
                                ...
                                i10++;
                                ((u0) obj4).getClass();
                                tc.m.e(arrayList2, null);
                            }
                            List m9 = tc.g.m(tc.g.p(arrayList2));
                            int size2 = m9.size();
                            for (int i11 = 0; i11 < size2; i11++) {
                                ((t0) m9.get(i11)).b(backEvent, lVar.a);
                            }
                        }
