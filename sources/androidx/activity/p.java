...
public final class p extends kotlin.jvm.internal.j implements zc.l {
                    ...
                    if (j0Var2.h != null) {
                        ...
                        while (it.hasNext()) {
                            ...
                            while (i9 < size) {
                                ...
                                i9++;
                                ((u0) obj4).getClass();
                                pc.m.e(arrayList2, null);
                            }
                            List m10 = pc.g.m(pc.g.p(arrayList2));
                            int size2 = m10.size();
                            for (int i10 = 0; i10 < size2; i10++) {
                                ((t0) m10.get(i10)).b(backEvent, lVar.a);
                            }
                        }
