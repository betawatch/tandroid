...
public final class x {
    ...
    public final void a(androidx.lifecycle.t tVar, a0 onBackPressedCallback) {
        ...
        androidx.lifecycle.o m9 = tVar.m();
        if (((androidx.lifecycle.v) m9).c == androidx.lifecycle.n.a) {
            return;
        }
        onBackPressedCallback.b.add(new OnBackPressedDispatcher$LifecycleOnBackPressedCancellable(this, m9, onBackPressedCallback));
        d();
    ...
    public final void b() {
        ...
        while (it2.hasNext()) {
            ...
            while (it3.hasNext()) {
                ...
                tc.m.e(arrayList4, null);
            }
            List m9 = tc.g.m(tc.g.p(arrayList4));
            int size3 = m9.size();
            for (int i14 = 0; i14 < size3; i14++) {
                ((t0) m9.get(i14)).a(lVar.a);
            }
            int size4 = operations.size();
            for (int i15 = 0; i15 < size4; i15++) {
                lVar.a((u0) operations.get(i15));
            }
            List m10 = tc.g.m(arrayList3);
            if (m10.size() > 0) {
                ((u0) m10.get(0)).getClass();
                throw null;
            }
            i10 = 3;
        }
