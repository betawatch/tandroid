    ...
    public final void b() {
        ...
        while (it2.hasNext()) {
            ...
            while (it3.hasNext()) {
                ...
                pc.m.e(arrayList4, null);
            }
            List m10 = pc.g.m(pc.g.p(arrayList4));
            int size3 = m10.size();
            for (int i13 = 0; i13 < size3; i13++) {
                ((t0) m10.get(i13)).a(lVar.a);
            }
            int size4 = operations.size();
            for (int i14 = 0; i14 < size4; i14++) {
                lVar.a((u0) operations.get(i14));
            }
            List m11 = pc.g.m(arrayList3);
            if (m11.size() > 0) {
