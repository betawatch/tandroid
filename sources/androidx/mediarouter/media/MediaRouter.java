...
public final class MediaRouter {
    ...
    public static class RouteInfo {
        ...
        void updateDynamicDescriptors(Collection collection) {
            ...
            MediaRouter.getGlobalRouter().mCallbackHandler.post(NotificationCenter.themeListUpdated, this);
        }
    ...
    static final class PrepareTransferNotifier {
        ...
        private void unselectFromRouteAndNotify() {
            ...
            if (globalMediaRouter != null) {
                ...
                globalMediaRouter.mCallbackHandler.post(NotificationCenter.needShareTheme, routeInfo2, this.mReason);
        ...
        private void selectToRouteAndNotify() {
            ...
            if (routeInfo2 == null) {
                globalMediaRouter.mCallbackHandler.post(NotificationCenter.needCheckSystemBarColors, new Pair(this.mFromRoute, routeInfo), this.mReason);
            } else {
                globalMediaRouter.mCallbackHandler.post(NotificationCenter.needSetDayNightTheme, new Pair(routeInfo2, routeInfo), this.mReason);
            }
            globalMediaRouter.mRouteControllerMap.clear();
