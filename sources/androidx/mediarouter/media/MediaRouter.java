...
public final class MediaRouter {
    ...
    static final class PrepareTransferNotifier {
        ...
        private void selectToRouteAndNotify() {
            ...
            if (routeInfo2 == null) {
                globalMediaRouter.mCallbackHandler.post(NotificationCenter.liveLocationsCacheChanged, new Pair(this.mFromRoute, routeInfo), this.mReason);
            } else {
                globalMediaRouter.mCallbackHandler.post(NotificationCenter.playerDidStartPlaying, new Pair(routeInfo2, routeInfo), this.mReason);
            }
        ...
        private void unselectFromRouteAndNotify() {
            ...
            if (globalMediaRouter != null) {
                ...
                globalMediaRouter.mCallbackHandler.post(NotificationCenter.notificationsCountUpdated, routeInfo2, this.mReason);
    ...
    public static class RouteInfo {
        ...
        void updateDynamicDescriptors(Collection collection) {
            ...
            MediaRouter.getGlobalRouter().mCallbackHandler.post(NotificationCenter.proxyChangedByRotation, this);
        }
    }
