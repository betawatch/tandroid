...
abstract class MediaRouterThemeHelper {
    ...
    private static int getRouterThemeId(Context context) {
        ...
        return isLightTheme ? controllerColor == -570425344 ? R$style.Theme_MediaRouter_Light : R$style.Theme_MediaRouter_Light_DarkControlPanel : controllerColor == -570425344 ? R$style.Theme_MediaRouter_LightControlPanel : R$style.Theme_MediaRouter;
    }
