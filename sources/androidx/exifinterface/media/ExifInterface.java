...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.themeAccentListUpdated, 4), new ExifTag("SubfileType", NotificationCenter.needCheckSystemBarColors, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.needSetDayNightTheme, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.goingToPreviewTheme, 3), new ExifTag("Compression", NotificationCenter.locationPermissionGranted, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.suggestedLangpack, 3), new ExifTag("ImageDescription", NotificationCenter.notificationsCountUpdated, 2), new ExifTag("Make", NotificationCenter.playerDidStartPlaying, 2), new ExifTag("Model", NotificationCenter.closeSearchByActiveAction, 2), new ExifTag("StripOffsets", NotificationCenter.messagePlayingSpeedChanged, 3, 4), new ExifTag("Orientation", NotificationCenter.screenStateChanged, 3), new ExifTag("SamplesPerPixel", NotificationCenter.webRtcMicAmplitudeEvent, 3), new ExifTag("RowsPerStrip", NotificationCenter.webRtcSpeakerAmplitudeEvent, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.showBulletin, 3, 4), new ExifTag("XResolution", NotificationCenter.onDatabaseMigration, 5), new ExifTag("YResolution", NotificationCenter.onEmojiInteractionsReceived, 5), new ExifTag("PlanarConfiguration", NotificationCenter.emojiPreviewThemesChanged, 3), new ExifTag("ResolutionUnit", NotificationCenter.premiumStatusChangedGlobal, 3), new ExifTag("TransferFunction", NotificationCenter.userEmojiStatusUpdated, 3), new ExifTag("Software", NotificationCenter.topicsDidLoaded, 2), new ExifTag("DateTime", NotificationCenter.chatSwitchedForum, 2), new ExifTag("Artist", NotificationCenter.uploadStoryEnd, 2), new ExifTag("WhitePoint", NotificationCenter.onReceivedChannelDifference, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.storiesReadUpdated, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.themeAccentListUpdated, 4), new ExifTag("SubfileType", NotificationCenter.needCheckSystemBarColors, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.needSetDayNightTheme, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.goingToPreviewTheme, 3), new ExifTag("Compression", NotificationCenter.locationPermissionGranted, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.suggestedLangpack, 3), new ExifTag("ImageDescription", NotificationCenter.notificationsCountUpdated, 2), new ExifTag("Make", NotificationCenter.playerDidStartPlaying, 2), new ExifTag("Model", NotificationCenter.closeSearchByActiveAction, 2), new ExifTag("StripOffsets", NotificationCenter.messagePlayingSpeedChanged, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.screenStateChanged, 3), new ExifTag("SamplesPerPixel", NotificationCenter.webRtcMicAmplitudeEvent, 3), new ExifTag("RowsPerStrip", NotificationCenter.webRtcSpeakerAmplitudeEvent, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.showBulletin, 3, 4), new ExifTag("XResolution", NotificationCenter.onDatabaseMigration, 5), new ExifTag("YResolution", NotificationCenter.onEmojiInteractionsReceived, 5), new ExifTag("PlanarConfiguration", NotificationCenter.emojiPreviewThemesChanged, 3), new ExifTag("ResolutionUnit", NotificationCenter.premiumStatusChangedGlobal, 3), new ExifTag("TransferFunction", NotificationCenter.userEmojiStatusUpdated, 3), new ExifTag("Software", NotificationCenter.topicsDidLoaded, 2), new ExifTag("DateTime", NotificationCenter.chatSwitchedForum, 2), new ExifTag("Artist", NotificationCenter.uploadStoryEnd, 2), new ExifTag("WhitePoint", NotificationCenter.onReceivedChannelDifference, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.storiesReadUpdated, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.messagePlayingSpeedChanged, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.needSetDayNightTheme, 4), new ExifTag("PreviewImageLength", NotificationCenter.goingToPreviewTheme, 4)};
