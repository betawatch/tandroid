...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.themeListUpdated, 4), new ExifTag("SubfileType", NotificationCenter.didApplyNewTheme, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.needCheckSystemBarColors, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.needShareTheme, 3), new ExifTag("Compression", NotificationCenter.needSetDayNightTheme, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.locationPermissionDenied, 3), new ExifTag("ImageDescription", NotificationCenter.newLocationAvailable, 2), new ExifTag("Make", NotificationCenter.liveLocationsCacheChanged, 2), new ExifTag("Model", NotificationCenter.notificationsCountUpdated, 2), new ExifTag("StripOffsets", NotificationCenter.playerDidStartPlaying, 3, 4), new ExifTag("Orientation", NotificationCenter.closeSearchByActiveAction, 3), new ExifTag("SamplesPerPixel", NotificationCenter.didClearDatabase, 3), new ExifTag("RowsPerStrip", NotificationCenter.voipServiceCreated, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.webRtcMicAmplitudeEvent, 3, 4), new ExifTag("XResolution", NotificationCenter.appUpdateAvailable, 5), new ExifTag("YResolution", NotificationCenter.appUpdateLoading, 5), new ExifTag("PlanarConfiguration", NotificationCenter.onDatabaseMigration, 3), new ExifTag("ResolutionUnit", NotificationCenter.currentUserPremiumStatusChanged, 3), new ExifTag("TransferFunction", NotificationCenter.billingConfirmPurchaseError, 3), new ExifTag("Software", NotificationCenter.permissionsGranted, 2), new ExifTag("DateTime", NotificationCenter.activityPermissionsGranted, 2), new ExifTag("Artist", NotificationCenter.chatlistFolderUpdate, 2), new ExifTag("WhitePoint", NotificationCenter.customTypefacesLoaded, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.stealthModeChanged, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.themeListUpdated, 4), new ExifTag("SubfileType", NotificationCenter.didApplyNewTheme, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.needCheckSystemBarColors, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.needShareTheme, 3), new ExifTag("Compression", NotificationCenter.needSetDayNightTheme, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.locationPermissionDenied, 3), new ExifTag("ImageDescription", NotificationCenter.newLocationAvailable, 2), new ExifTag("Make", NotificationCenter.liveLocationsCacheChanged, 2), new ExifTag("Model", NotificationCenter.notificationsCountUpdated, 2), new ExifTag("StripOffsets", NotificationCenter.playerDidStartPlaying, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.closeSearchByActiveAction, 3), new ExifTag("SamplesPerPixel", NotificationCenter.didClearDatabase, 3), new ExifTag("RowsPerStrip", NotificationCenter.voipServiceCreated, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.webRtcMicAmplitudeEvent, 3, 4), new ExifTag("XResolution", NotificationCenter.appUpdateAvailable, 5), new ExifTag("YResolution", NotificationCenter.appUpdateLoading, 5), new ExifTag("PlanarConfiguration", NotificationCenter.onDatabaseMigration, 3), new ExifTag("ResolutionUnit", NotificationCenter.currentUserPremiumStatusChanged, 3), new ExifTag("TransferFunction", NotificationCenter.billingConfirmPurchaseError, 3), new ExifTag("Software", NotificationCenter.permissionsGranted, 2), new ExifTag("DateTime", NotificationCenter.activityPermissionsGranted, 2), new ExifTag("Artist", NotificationCenter.chatlistFolderUpdate, 2), new ExifTag("WhitePoint", NotificationCenter.customTypefacesLoaded, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.stealthModeChanged, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.playerDidStartPlaying, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.needCheckSystemBarColors, 4), new ExifTag("PreviewImageLength", NotificationCenter.needShareTheme, 4)};
