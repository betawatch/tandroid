...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.wallpapersNeedReload, 4), new ExifTag("SubfileType", NotificationCenter.didReceiveSmsCode, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.emojiLoaded, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.invalidateMotionBackground, 3), new ExifTag("Compression", NotificationCenter.closeOtherAppActivities, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.didSetNewTheme, 3), new ExifTag("ImageDescription", NotificationCenter.locationPermissionGranted, 2), new ExifTag("Make", NotificationCenter.locationPermissionDenied, 2), new ExifTag("Model", NotificationCenter.reloadInterface, 2), new ExifTag("StripOffsets", NotificationCenter.suggestedLangpack, 3, 4), new ExifTag("Orientation", NotificationCenter.didSetNewWallpapper, 3), new ExifTag("SamplesPerPixel", NotificationCenter.proxyChangedByRotation, 3), new ExifTag("RowsPerStrip", NotificationCenter.liveLocationsChanged, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.newLocationAvailable, 3, 4), new ExifTag("XResolution", NotificationCenter.playerDidStartPlaying, 5), new ExifTag("YResolution", NotificationCenter.closeSearchByActiveAction, 5), new ExifTag("PlanarConfiguration", NotificationCenter.messagePlayingSpeedChanged, 3), new ExifTag("ResolutionUnit", NotificationCenter.reactionsDidLoad, 3), new ExifTag("TransferFunction", NotificationCenter.onDatabaseOpened, 3), new ExifTag("Software", NotificationCenter.onUserRingtonesUpdated, 2), new ExifTag("DateTime", NotificationCenter.currentUserPremiumStatusChanged, 2), new ExifTag("Artist", NotificationCenter.permissionsGranted, 2), new ExifTag("WhitePoint", NotificationCenter.chatSwitchedForum, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.didUpdateGlobalAutoDeleteTimer, 5), new ExifTag("SubIFDPointer", NotificationCenter.stealthModeChanged, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.wallpapersNeedReload, 4), new ExifTag("SubfileType", NotificationCenter.didReceiveSmsCode, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.emojiLoaded, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.invalidateMotionBackground, 3), new ExifTag("Compression", NotificationCenter.closeOtherAppActivities, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.didSetNewTheme, 3), new ExifTag("ImageDescription", NotificationCenter.locationPermissionGranted, 2), new ExifTag("Make", NotificationCenter.locationPermissionDenied, 2), new ExifTag("Model", NotificationCenter.reloadInterface, 2), new ExifTag("StripOffsets", NotificationCenter.suggestedLangpack, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.didSetNewWallpapper, 3), new ExifTag("SamplesPerPixel", NotificationCenter.proxyChangedByRotation, 3), new ExifTag("RowsPerStrip", NotificationCenter.liveLocationsChanged, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.newLocationAvailable, 3, 4), new ExifTag("XResolution", NotificationCenter.playerDidStartPlaying, 5), new ExifTag("YResolution", NotificationCenter.closeSearchByActiveAction, 5), new ExifTag("PlanarConfiguration", NotificationCenter.messagePlayingSpeedChanged, 3), new ExifTag("ResolutionUnit", NotificationCenter.reactionsDidLoad, 3), new ExifTag("TransferFunction", NotificationCenter.onDatabaseOpened, 3), new ExifTag("Software", NotificationCenter.onUserRingtonesUpdated, 2), new ExifTag("DateTime", NotificationCenter.currentUserPremiumStatusChanged, 2), new ExifTag("Artist", NotificationCenter.permissionsGranted, 2), new ExifTag("WhitePoint", NotificationCenter.chatSwitchedForum, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.didUpdateGlobalAutoDeleteTimer, 5), new ExifTag("SubIFDPointer", NotificationCenter.stealthModeChanged, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.suggestedLangpack, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.emojiLoaded, 4), new ExifTag("PreviewImageLength", NotificationCenter.invalidateMotionBackground, 4)};
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag("SubIFDPointer", NotificationCenter.stealthModeChanged, 4), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("InteroperabilityIFDPointer", 40965, 4), new ExifTag("CameraSettingsIFDPointer", 8224, 1), new ExifTag("ImageProcessingIFDPointer", 8256, 1)};
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:69:0x018b, code lost:
        ...
        return;
     */
    /* JADX WARN: Removed duplicated region for block: B:32:0x0174 A[LOOP:0: B:9:0x0037->B:32:0x0174, LOOP_END] */
    ...
    */
    private void readImageFileDirectory(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) {
        ...
        while (s3 < readShort) {
            ...
            ExifTag exifTag3 = (ExifTag) sExifTagMapsForReading[i2].get(Integer.valueOf(readUnsignedShort2));
            boolean z3 = DEBUG;
            if (z3) {
                Integer valueOf = Integer.valueOf(i2);
                Integer valueOf2 = Integer.valueOf(readUnsignedShort2);
                c = 4;
                String str = exifTag3 != null ? exifTag3.name : null;
                ...
                if (readUnsignedShort3 > 0) {
                    if (readUnsignedShort3 < IFD_FORMAT_BYTES_PER_FORMAT.length) {
                        if (exifTag3.isFormatCompatible(readUnsignedShort3)) {
                            ...
                            exifTag = exifTag3;
                            j = r5[readUnsignedShort3] * readInt;
                            if (j < 0 || j > 2147483647L) {
                                if (z3) {
                                    StringBuilder sb = new StringBuilder();
                                    j2 = j;
                                    sb.append("Skip the tag entry since the number of components is invalid: ");
                                    sb.append(readInt);
                                ...
                                if (z) {
                                    ...
                                    if (j > 4) {
                                        ...
                                        if (this.mMimeType == 7) {
                                            ...
                                            if ("MakerNote".equals(exifTag2.name)) {
                                            ...
                                            } else if (i2 == 6 && "ThumbnailImage".equals(exifTag2.name)) {
                                                ...
                                                this.mAttributes[c].put("Compression", createUShort);
                                                this.mAttributes[c].put("JPEGInterchangeFormat", createULong);
                                                this.mAttributes[c].put("JPEGInterchangeFormatLength", createULong2);
                                            }
                                            j3 = position;
                                        } else {
                                            s2 = s3;
                                    ...
                                    if (num != null) {
                                        if (readUnsignedShort3 == 3) {
                                            ...
                                            if (!z2) {
                                                Log.d("ExifInterface", String.format("Offset: %d, tagName: %s", Long.valueOf(j4), exifTag2.name));
                                            }
                                            if (j4 <= 0) {
                                                if (!this.mAttributesOffsets.contains(Integer.valueOf((int) j4))) {
