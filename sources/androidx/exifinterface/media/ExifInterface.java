...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.cameraInitied, 4), new ExifTag("SubfileType", NotificationCenter.didReplacedPhotoInMemCache, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.themeListUpdated, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.didApplyNewTheme, 3), new ExifTag("Compression", NotificationCenter.themeAccentListUpdated, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.needSetDayNightTheme, 3), new ExifTag("ImageDescription", NotificationCenter.proxyCheckDone, 2), new ExifTag("Make", NotificationCenter.proxyChangedByRotation, 2), new ExifTag("Model", NotificationCenter.liveLocationsChanged, 2), new ExifTag("StripOffsets", NotificationCenter.newLocationAvailable, 3, 4), new ExifTag("Orientation", NotificationCenter.liveLocationsCacheChanged, 3), new ExifTag("SamplesPerPixel", NotificationCenter.closeSearchByActiveAction, 3), new ExifTag("RowsPerStrip", NotificationCenter.messagePlayingSpeedChanged, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.screenStateChanged, 3, 4), new ExifTag("XResolution", NotificationCenter.webRtcMicAmplitudeEvent, 5), new ExifTag("YResolution", NotificationCenter.webRtcSpeakerAmplitudeEvent, 5), new ExifTag("PlanarConfiguration", NotificationCenter.showBulletin, 3), new ExifTag("ResolutionUnit", NotificationCenter.onActivityResultReceived, 3), new ExifTag("TransferFunction", NotificationCenter.premiumStatusChangedGlobal, 3), new ExifTag("Software", NotificationCenter.premiumStickersPreviewLoaded, 2), new ExifTag("DateTime", NotificationCenter.userEmojiStatusUpdated, 2), new ExifTag("Artist", NotificationCenter.storiesUpdated, 2), new ExifTag("WhitePoint", NotificationCenter.storiesDraftsUpdated, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.chatlistFolderUpdate, 5), new ExifTag("SubIFDPointer", NotificationCenter.botForumDraftUpdate, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.cameraInitied, 4), new ExifTag("SubfileType", NotificationCenter.didReplacedPhotoInMemCache, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.themeListUpdated, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.didApplyNewTheme, 3), new ExifTag("Compression", NotificationCenter.themeAccentListUpdated, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.needSetDayNightTheme, 3), new ExifTag("ImageDescription", NotificationCenter.proxyCheckDone, 2), new ExifTag("Make", NotificationCenter.proxyChangedByRotation, 2), new ExifTag("Model", NotificationCenter.liveLocationsChanged, 2), new ExifTag("StripOffsets", NotificationCenter.newLocationAvailable, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.liveLocationsCacheChanged, 3), new ExifTag("SamplesPerPixel", NotificationCenter.closeSearchByActiveAction, 3), new ExifTag("RowsPerStrip", NotificationCenter.messagePlayingSpeedChanged, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.screenStateChanged, 3, 4), new ExifTag("XResolution", NotificationCenter.webRtcMicAmplitudeEvent, 5), new ExifTag("YResolution", NotificationCenter.webRtcSpeakerAmplitudeEvent, 5), new ExifTag("PlanarConfiguration", NotificationCenter.showBulletin, 3), new ExifTag("ResolutionUnit", NotificationCenter.onActivityResultReceived, 3), new ExifTag("TransferFunction", NotificationCenter.premiumStatusChangedGlobal, 3), new ExifTag("Software", NotificationCenter.premiumStickersPreviewLoaded, 2), new ExifTag("DateTime", NotificationCenter.userEmojiStatusUpdated, 2), new ExifTag("Artist", NotificationCenter.storiesUpdated, 2), new ExifTag("WhitePoint", NotificationCenter.storiesDraftsUpdated, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.chatlistFolderUpdate, 5), new ExifTag("SubIFDPointer", NotificationCenter.botForumDraftUpdate, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.newLocationAvailable, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.themeListUpdated, 4), new ExifTag("PreviewImageLength", NotificationCenter.didApplyNewTheme, 4)};
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag("SubIFDPointer", NotificationCenter.botForumDraftUpdate, 4), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("InteroperabilityIFDPointer", 40965, 4), new ExifTag("CameraSettingsIFDPointer", 8224, 1), new ExifTag("ImageProcessingIFDPointer", 8256, 1)};
