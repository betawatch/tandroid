...
public class ExifInterface {
    ...
    static {
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag("SubIFDPointer", NotificationCenter.nearEarEvent, 4), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("InteroperabilityIFDPointer", 40965, 4), new ExifTag("CameraSettingsIFDPointer", 8224, 1), new ExifTag("ImageProcessingIFDPointer", 8256, 1)};
