...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.proxySettingsChanged, 4), new ExifTag("SubfileType", NotificationCenter.proxyCheckDone, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.liveLocationsChanged, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.newLocationAvailable, 3), new ExifTag("Compression", NotificationCenter.liveLocationsCacheChanged, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.closeSearchByActiveAction, 3), new ExifTag("ImageDescription", NotificationCenter.appUpdateAvailable, 2), new ExifTag("Make", NotificationCenter.onDatabaseMigration, 2), new ExifTag("Model", NotificationCenter.onEmojiInteractionsReceived, 2), new ExifTag("StripOffsets", NotificationCenter.emojiPreviewThemesChanged, 3, 4), new ExifTag("Orientation", NotificationCenter.reactionsDidLoad, 3), new ExifTag("SamplesPerPixel", NotificationCenter.dialogsUnreadReactionsCounterChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.onDatabaseOpened, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.onDownloadingFilesChanged, 3, 4), new ExifTag("XResolution", NotificationCenter.onUserRingtonesUpdated, 5), new ExifTag("YResolution", NotificationCenter.currentUserPremiumStatusChanged, 5), new ExifTag("PlanarConfiguration", NotificationCenter.premiumPromoUpdated, 3), new ExifTag("ResolutionUnit", NotificationCenter.didUpdateGlobalAutoDeleteTimer, 3), new ExifTag("TransferFunction", NotificationCenter.storiesDraftsUpdated, 3), new ExifTag("Software", NotificationCenter.customTypefacesLoaded, 2), new ExifTag("DateTime", NotificationCenter.stealthModeChanged, 2), new ExifTag("Artist", 315, 2), new ExifTag("WhitePoint", 318, 5), new ExifTag("PrimaryChromaticities", 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.proxySettingsChanged, 4), new ExifTag("SubfileType", NotificationCenter.proxyCheckDone, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.liveLocationsChanged, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.newLocationAvailable, 3), new ExifTag("Compression", NotificationCenter.liveLocationsCacheChanged, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.closeSearchByActiveAction, 3), new ExifTag("ImageDescription", NotificationCenter.appUpdateAvailable, 2), new ExifTag("Make", NotificationCenter.onDatabaseMigration, 2), new ExifTag("Model", NotificationCenter.onEmojiInteractionsReceived, 2), new ExifTag("StripOffsets", NotificationCenter.emojiPreviewThemesChanged, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.reactionsDidLoad, 3), new ExifTag("SamplesPerPixel", NotificationCenter.dialogsUnreadReactionsCounterChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.onDatabaseOpened, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.onDownloadingFilesChanged, 3, 4), new ExifTag("XResolution", NotificationCenter.onUserRingtonesUpdated, 5), new ExifTag("YResolution", NotificationCenter.currentUserPremiumStatusChanged, 5), new ExifTag("PlanarConfiguration", NotificationCenter.premiumPromoUpdated, 3), new ExifTag("ResolutionUnit", NotificationCenter.didUpdateGlobalAutoDeleteTimer, 3), new ExifTag("TransferFunction", NotificationCenter.storiesDraftsUpdated, 3), new ExifTag("Software", NotificationCenter.customTypefacesLoaded, 2), new ExifTag("DateTime", NotificationCenter.stealthModeChanged, 2), new ExifTag("Artist", 315, 2), new ExifTag("WhitePoint", 318, 5), new ExifTag("PrimaryChromaticities", 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.emojiPreviewThemesChanged, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.liveLocationsChanged, 4), new ExifTag("PreviewImageLength", NotificationCenter.newLocationAvailable, 4)};
