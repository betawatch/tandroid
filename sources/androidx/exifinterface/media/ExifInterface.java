...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.emojiLoaded, 4), new ExifTag("SubfileType", NotificationCenter.invalidateMotionBackground, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.cameraInitied, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.didReplacedPhotoInMemCache, 3), new ExifTag("Compression", NotificationCenter.didSetNewTheme, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.themeAccentListUpdated, 3), new ExifTag("ImageDescription", NotificationCenter.suggestedLangpack, 2), new ExifTag("Make", NotificationCenter.didSetNewWallpapper, 2), new ExifTag("Model", NotificationCenter.proxySettingsChanged, 2), new ExifTag("StripOffsets", NotificationCenter.proxyCheckDone, 3, 4), new ExifTag("Orientation", NotificationCenter.proxyChangedByRotation, 3), new ExifTag("SamplesPerPixel", NotificationCenter.liveLocationsCacheChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.notificationsCountUpdated, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.playerDidStartPlaying, 3, 4), new ExifTag("XResolution", NotificationCenter.screenStateChanged, 5), new ExifTag("YResolution", NotificationCenter.didClearDatabase, 5), new ExifTag("PlanarConfiguration", NotificationCenter.voipServiceCreated, 3), new ExifTag("ResolutionUnit", NotificationCenter.dialogsUnreadReactionsCounterChanged, 3), new ExifTag("TransferFunction", NotificationCenter.onUserRingtonesUpdated, 3), new ExifTag("Software", NotificationCenter.currentUserShowLimitReachedDialog, 2), new ExifTag("DateTime", NotificationCenter.billingProductDetailsUpdated, 2), new ExifTag("Artist", NotificationCenter.didUpdateGlobalAutoDeleteTimer, 2), new ExifTag("WhitePoint", NotificationCenter.storiesUpdated, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.storyDeleted, 5), new ExifTag("SubIFDPointer", NotificationCenter.translationModelDownloading, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.emojiLoaded, 4), new ExifTag("SubfileType", NotificationCenter.invalidateMotionBackground, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.cameraInitied, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.didReplacedPhotoInMemCache, 3), new ExifTag("Compression", NotificationCenter.didSetNewTheme, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.themeAccentListUpdated, 3), new ExifTag("ImageDescription", NotificationCenter.suggestedLangpack, 2), new ExifTag("Make", NotificationCenter.didSetNewWallpapper, 2), new ExifTag("Model", NotificationCenter.proxySettingsChanged, 2), new ExifTag("StripOffsets", NotificationCenter.proxyCheckDone, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.proxyChangedByRotation, 3), new ExifTag("SamplesPerPixel", NotificationCenter.liveLocationsCacheChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.notificationsCountUpdated, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.playerDidStartPlaying, 3, 4), new ExifTag("XResolution", NotificationCenter.screenStateChanged, 5), new ExifTag("YResolution", NotificationCenter.didClearDatabase, 5), new ExifTag("PlanarConfiguration", NotificationCenter.voipServiceCreated, 3), new ExifTag("ResolutionUnit", NotificationCenter.dialogsUnreadReactionsCounterChanged, 3), new ExifTag("TransferFunction", NotificationCenter.onUserRingtonesUpdated, 3), new ExifTag("Software", NotificationCenter.currentUserShowLimitReachedDialog, 2), new ExifTag("DateTime", NotificationCenter.billingProductDetailsUpdated, 2), new ExifTag("Artist", NotificationCenter.didUpdateGlobalAutoDeleteTimer, 2), new ExifTag("WhitePoint", NotificationCenter.storiesUpdated, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.storyDeleted, 5), new ExifTag("SubIFDPointer", NotificationCenter.translationModelDownloading, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.proxyCheckDone, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.cameraInitied, 4), new ExifTag("PreviewImageLength", NotificationCenter.didReplacedPhotoInMemCache, 4)};
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag("SubIFDPointer", NotificationCenter.translationModelDownloading, 4), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("InteroperabilityIFDPointer", 40965, 4), new ExifTag("CameraSettingsIFDPointer", 8224, 1), new ExifTag("ImageProcessingIFDPointer", 8256, 1)};
