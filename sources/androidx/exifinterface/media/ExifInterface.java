...
public class ExifInterface {
        ...
        public void skipFully(int i) {
            ...
            while (i2 < i) {
                ...
                if (skip <= 0) {
                    ...
                    skip = this.mDataInputStream.read(this.mSkipBuffer, 0, Math.min(LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS_NOT_PREMIUM, i3));
                    if (skip == -1) {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.reloadInterface, 4), new ExifTag("SubfileType", NotificationCenter.suggestedLangpack, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.proxySettingsChanged, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.proxyCheckDone, 3), new ExifTag("Compression", NotificationCenter.proxyChangedByRotation, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.liveLocationsCacheChanged, 3), new ExifTag("ImageDescription", NotificationCenter.webRtcMicAmplitudeEvent, 2), new ExifTag("Make", NotificationCenter.webRtcSpeakerAmplitudeEvent, 2), new ExifTag("Model", NotificationCenter.showBulletin, 2), new ExifTag("StripOffsets", NotificationCenter.appUpdateAvailable, 3, 4), new ExifTag("Orientation", NotificationCenter.appUpdateLoading, 3), new ExifTag("SamplesPerPixel", NotificationCenter.emojiPreviewThemesChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.reactionsDidLoad, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.attachMenuBotsDidLoad, 3, 4), new ExifTag("XResolution", NotificationCenter.onDatabaseOpened, 5), new ExifTag("YResolution", NotificationCenter.onDownloadingFilesChanged, 5), new ExifTag("PlanarConfiguration", NotificationCenter.onActivityResultReceived, 3), new ExifTag("ResolutionUnit", NotificationCenter.permissionsGranted, 3), new ExifTag("TransferFunction", NotificationCenter.onDatabaseReset, 3), new ExifTag("Software", NotificationCenter.storiesDraftsUpdated, 2), new ExifTag("DateTime", NotificationCenter.chatlistFolderUpdate, 2), new ExifTag("Artist", 315, 2), new ExifTag("WhitePoint", 318, 5), new ExifTag("PrimaryChromaticities", 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.reloadInterface, 4), new ExifTag("SubfileType", NotificationCenter.suggestedLangpack, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.proxySettingsChanged, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.proxyCheckDone, 3), new ExifTag("Compression", NotificationCenter.proxyChangedByRotation, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.liveLocationsCacheChanged, 3), new ExifTag("ImageDescription", NotificationCenter.webRtcMicAmplitudeEvent, 2), new ExifTag("Make", NotificationCenter.webRtcSpeakerAmplitudeEvent, 2), new ExifTag("Model", NotificationCenter.showBulletin, 2), new ExifTag("StripOffsets", NotificationCenter.appUpdateAvailable, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.appUpdateLoading, 3), new ExifTag("SamplesPerPixel", NotificationCenter.emojiPreviewThemesChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.reactionsDidLoad, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.attachMenuBotsDidLoad, 3, 4), new ExifTag("XResolution", NotificationCenter.onDatabaseOpened, 5), new ExifTag("YResolution", NotificationCenter.onDownloadingFilesChanged, 5), new ExifTag("PlanarConfiguration", NotificationCenter.onActivityResultReceived, 3), new ExifTag("ResolutionUnit", NotificationCenter.permissionsGranted, 3), new ExifTag("TransferFunction", NotificationCenter.onDatabaseReset, 3), new ExifTag("Software", NotificationCenter.storiesDraftsUpdated, 2), new ExifTag("DateTime", NotificationCenter.chatlistFolderUpdate, 2), new ExifTag("Artist", 315, 2), new ExifTag("WhitePoint", 318, 5), new ExifTag("PrimaryChromaticities", 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.appUpdateAvailable, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.proxySettingsChanged, 4), new ExifTag("PreviewImageLength", NotificationCenter.proxyCheckDone, 4)};
