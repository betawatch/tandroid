...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.suggestedLangpack, 4), new ExifTag("SubfileType", NotificationCenter.didSetNewWallpapper, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.proxyCheckDone, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.proxyChangedByRotation, 3), new ExifTag("Compression", NotificationCenter.liveLocationsChanged, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.notificationsCountUpdated, 3), new ExifTag("ImageDescription", NotificationCenter.webRtcSpeakerAmplitudeEvent, 2), new ExifTag("Make", NotificationCenter.showBulletin, 2), new ExifTag("Model", NotificationCenter.appUpdateAvailable, 2), new ExifTag("StripOffsets", NotificationCenter.appUpdateLoading, 3, 4), new ExifTag("Orientation", NotificationCenter.onDatabaseMigration, 3), new ExifTag("SamplesPerPixel", NotificationCenter.reactionsDidLoad, 3), new ExifTag("RowsPerStrip", NotificationCenter.attachMenuBotsDidLoad, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.chatAvailableReactionsUpdated, 3, 4), new ExifTag("XResolution", NotificationCenter.onDownloadingFilesChanged, 5), new ExifTag("YResolution", NotificationCenter.onActivityResultReceived, 5), new ExifTag("PlanarConfiguration", NotificationCenter.onRequestPermissionResultReceived, 3), new ExifTag("ResolutionUnit", NotificationCenter.activityPermissionsGranted, 3), new ExifTag("TransferFunction", NotificationCenter.wallpaperSettedToUser, 3), new ExifTag("Software", NotificationCenter.chatlistFolderUpdate, 2), new ExifTag("DateTime", NotificationCenter.uploadStoryProgress, 2), new ExifTag("Artist", 315, 2), new ExifTag("WhitePoint", 318, 5), new ExifTag("PrimaryChromaticities", 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.suggestedLangpack, 4), new ExifTag("SubfileType", NotificationCenter.didSetNewWallpapper, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.proxyCheckDone, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.proxyChangedByRotation, 3), new ExifTag("Compression", NotificationCenter.liveLocationsChanged, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.notificationsCountUpdated, 3), new ExifTag("ImageDescription", NotificationCenter.webRtcSpeakerAmplitudeEvent, 2), new ExifTag("Make", NotificationCenter.showBulletin, 2), new ExifTag("Model", NotificationCenter.appUpdateAvailable, 2), new ExifTag("StripOffsets", NotificationCenter.appUpdateLoading, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.onDatabaseMigration, 3), new ExifTag("SamplesPerPixel", NotificationCenter.reactionsDidLoad, 3), new ExifTag("RowsPerStrip", NotificationCenter.attachMenuBotsDidLoad, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.chatAvailableReactionsUpdated, 3, 4), new ExifTag("XResolution", NotificationCenter.onDownloadingFilesChanged, 5), new ExifTag("YResolution", NotificationCenter.onActivityResultReceived, 5), new ExifTag("PlanarConfiguration", NotificationCenter.onRequestPermissionResultReceived, 3), new ExifTag("ResolutionUnit", NotificationCenter.activityPermissionsGranted, 3), new ExifTag("TransferFunction", NotificationCenter.wallpaperSettedToUser, 3), new ExifTag("Software", NotificationCenter.chatlistFolderUpdate, 2), new ExifTag("DateTime", NotificationCenter.uploadStoryProgress, 2), new ExifTag("Artist", 315, 2), new ExifTag("WhitePoint", 318, 5), new ExifTag("PrimaryChromaticities", 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.appUpdateLoading, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.proxyCheckDone, 4), new ExifTag("PreviewImageLength", NotificationCenter.proxyChangedByRotation, 4)};
