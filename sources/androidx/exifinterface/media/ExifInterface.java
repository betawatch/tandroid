...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.invalidateMotionBackground, 4), new ExifTag("SubfileType", NotificationCenter.closeOtherAppActivities, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.didReplacedPhotoInMemCache, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.didSetNewTheme, 3), new ExifTag("Compression", NotificationCenter.themeListUpdated, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.needCheckSystemBarColors, 3), new ExifTag("ImageDescription", NotificationCenter.didSetNewWallpapper, 2), new ExifTag("Make", NotificationCenter.proxySettingsChanged, 2), new ExifTag("Model", NotificationCenter.proxyCheckDone, 2), new ExifTag("StripOffsets", NotificationCenter.proxyChangedByRotation, 3, 4), new ExifTag("Orientation", NotificationCenter.liveLocationsChanged, 3), new ExifTag("SamplesPerPixel", NotificationCenter.notificationsCountUpdated, 3), new ExifTag("RowsPerStrip", NotificationCenter.playerDidStartPlaying, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.closeSearchByActiveAction, 3, 4), new ExifTag("XResolution", NotificationCenter.didClearDatabase, 5), new ExifTag("YResolution", NotificationCenter.voipServiceCreated, 5), new ExifTag("PlanarConfiguration", NotificationCenter.webRtcMicAmplitudeEvent, 3), new ExifTag("ResolutionUnit", NotificationCenter.onDatabaseOpened, 3), new ExifTag("TransferFunction", NotificationCenter.currentUserPremiumStatusChanged, 3), new ExifTag("Software", NotificationCenter.billingProductDetailsUpdated, 2), new ExifTag("DateTime", NotificationCenter.billingConfirmPurchaseError, 2), new ExifTag("Artist", NotificationCenter.onDatabaseReset, 2), new ExifTag("WhitePoint", NotificationCenter.storyDeleted, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.storiesListUpdated, 5), new ExifTag("SubIFDPointer", NotificationCenter.translationModelDownloaded, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.invalidateMotionBackground, 4), new ExifTag("SubfileType", NotificationCenter.closeOtherAppActivities, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.didReplacedPhotoInMemCache, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.didSetNewTheme, 3), new ExifTag("Compression", NotificationCenter.themeListUpdated, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.needCheckSystemBarColors, 3), new ExifTag("ImageDescription", NotificationCenter.didSetNewWallpapper, 2), new ExifTag("Make", NotificationCenter.proxySettingsChanged, 2), new ExifTag("Model", NotificationCenter.proxyCheckDone, 2), new ExifTag("StripOffsets", NotificationCenter.proxyChangedByRotation, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.liveLocationsChanged, 3), new ExifTag("SamplesPerPixel", NotificationCenter.notificationsCountUpdated, 3), new ExifTag("RowsPerStrip", NotificationCenter.playerDidStartPlaying, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.closeSearchByActiveAction, 3, 4), new ExifTag("XResolution", NotificationCenter.didClearDatabase, 5), new ExifTag("YResolution", NotificationCenter.voipServiceCreated, 5), new ExifTag("PlanarConfiguration", NotificationCenter.webRtcMicAmplitudeEvent, 3), new ExifTag("ResolutionUnit", NotificationCenter.onDatabaseOpened, 3), new ExifTag("TransferFunction", NotificationCenter.currentUserPremiumStatusChanged, 3), new ExifTag("Software", NotificationCenter.billingProductDetailsUpdated, 2), new ExifTag("DateTime", NotificationCenter.billingConfirmPurchaseError, 2), new ExifTag("Artist", NotificationCenter.onDatabaseReset, 2), new ExifTag("WhitePoint", NotificationCenter.storyDeleted, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.storiesListUpdated, 5), new ExifTag("SubIFDPointer", NotificationCenter.translationModelDownloaded, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.proxyChangedByRotation, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.didReplacedPhotoInMemCache, 4), new ExifTag("PreviewImageLength", NotificationCenter.didSetNewTheme, 4)};
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag("SubIFDPointer", NotificationCenter.translationModelDownloaded, 4), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("InteroperabilityIFDPointer", 40965, 4), new ExifTag("CameraSettingsIFDPointer", 8224, 1), new ExifTag("ImageProcessingIFDPointer", 8256, 1)};
