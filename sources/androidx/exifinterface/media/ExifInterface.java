...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.didReceiveSmsCode, 4), new ExifTag("SubfileType", NotificationCenter.didReceiveCall, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.invalidateMotionBackground, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.closeOtherAppActivities, 3), new ExifTag("Compression", NotificationCenter.cameraInitied, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.themeListUpdated, 3), new ExifTag("ImageDescription", NotificationCenter.locationPermissionDenied, 2), new ExifTag("Make", NotificationCenter.reloadInterface, 2), new ExifTag("Model", NotificationCenter.suggestedLangpack, 2), new ExifTag("StripOffsets", NotificationCenter.didSetNewWallpapper, 3, 4), new ExifTag("Orientation", NotificationCenter.proxySettingsChanged, 3), new ExifTag("SamplesPerPixel", NotificationCenter.liveLocationsChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.newLocationAvailable, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.liveLocationsCacheChanged, 3, 4), new ExifTag("XResolution", NotificationCenter.closeSearchByActiveAction, 5), new ExifTag("YResolution", NotificationCenter.messagePlayingSpeedChanged, 5), new ExifTag("PlanarConfiguration", NotificationCenter.screenStateChanged, 3), new ExifTag("ResolutionUnit", NotificationCenter.attachMenuBotsDidLoad, 3), new ExifTag("TransferFunction", NotificationCenter.onDownloadingFilesChanged, 3), new ExifTag("Software", NotificationCenter.currentUserPremiumStatusChanged, 2), new ExifTag("DateTime", NotificationCenter.premiumPromoUpdated, 2), new ExifTag("Artist", NotificationCenter.activityPermissionsGranted, 2), new ExifTag("WhitePoint", NotificationCenter.didUpdateGlobalAutoDeleteTimer, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.onDatabaseReset, 5), new ExifTag("SubIFDPointer", NotificationCenter.onReceivedChannelDifference, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.didReceiveSmsCode, 4), new ExifTag("SubfileType", NotificationCenter.didReceiveCall, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.invalidateMotionBackground, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.closeOtherAppActivities, 3), new ExifTag("Compression", NotificationCenter.cameraInitied, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.themeListUpdated, 3), new ExifTag("ImageDescription", NotificationCenter.locationPermissionDenied, 2), new ExifTag("Make", NotificationCenter.reloadInterface, 2), new ExifTag("Model", NotificationCenter.suggestedLangpack, 2), new ExifTag("StripOffsets", NotificationCenter.didSetNewWallpapper, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.proxySettingsChanged, 3), new ExifTag("SamplesPerPixel", NotificationCenter.liveLocationsChanged, 3), new ExifTag("RowsPerStrip", NotificationCenter.newLocationAvailable, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.liveLocationsCacheChanged, 3, 4), new ExifTag("XResolution", NotificationCenter.closeSearchByActiveAction, 5), new ExifTag("YResolution", NotificationCenter.messagePlayingSpeedChanged, 5), new ExifTag("PlanarConfiguration", NotificationCenter.screenStateChanged, 3), new ExifTag("ResolutionUnit", NotificationCenter.attachMenuBotsDidLoad, 3), new ExifTag("TransferFunction", NotificationCenter.onDownloadingFilesChanged, 3), new ExifTag("Software", NotificationCenter.currentUserPremiumStatusChanged, 2), new ExifTag("DateTime", NotificationCenter.premiumPromoUpdated, 2), new ExifTag("Artist", NotificationCenter.activityPermissionsGranted, 2), new ExifTag("WhitePoint", NotificationCenter.didUpdateGlobalAutoDeleteTimer, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.onDatabaseReset, 5), new ExifTag("SubIFDPointer", NotificationCenter.onReceivedChannelDifference, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.didSetNewWallpapper, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.invalidateMotionBackground, 4), new ExifTag("PreviewImageLength", NotificationCenter.closeOtherAppActivities, 4)};
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag("SubIFDPointer", NotificationCenter.onReceivedChannelDifference, 4), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("InteroperabilityIFDPointer", 40965, 4), new ExifTag("CameraSettingsIFDPointer", 8224, 1), new ExifTag("ImageProcessingIFDPointer", 8256, 1)};
    ...
    private void readImageFileDirectory(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) {
        ...
        while (s3 < readShort) {
            ...
            if (z2) {
                ...
                String str4 = exifTag != null ? exifTag.name : null;
                ...
                if (readUnsignedShort3 > 0) {
                    if (readUnsignedShort3 < IFD_FORMAT_BYTES_PER_FORMAT.length) {
                        if (exifTag.isFormatCompatible(readUnsignedShort3)) {
                                    ...
                                    if (readUnsignedShort3 == 3) {
                                        ...
                                        if (j3 <= 0) {
                                            if (!this.mAttributesOffsets.contains(Integer.valueOf((int) j3))) {
                                                ...
                                                Log.d(str2, "Skip jump into the IFD since it has already been read: IfdType " + num + " (at " + j3 + ")");
                                            }
                                        } else if (z2) {
                            ...
                            Log.d(str3, "Skip the tag entry since data format (" + IFD_FORMAT_NAMES[readUnsignedShort3] + ") is unexpected for tag: " + exifTag.name);
                        }
                    }
                }
                s2 = s3;
