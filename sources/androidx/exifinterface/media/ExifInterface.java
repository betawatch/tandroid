...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag("NewSubfileType", NotificationCenter.closeOtherAppActivities, 4), new ExifTag("SubfileType", NotificationCenter.cameraInitied, 4), new ExifTag("ImageWidth", 256, 3, 4), new ExifTag("ImageLength", NotificationCenter.didSetNewTheme, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.themeListUpdated, 3), new ExifTag("Compression", NotificationCenter.didApplyNewTheme, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.needShareTheme, 3), new ExifTag("ImageDescription", NotificationCenter.proxySettingsChanged, 2), new ExifTag("Make", NotificationCenter.proxyCheckDone, 2), new ExifTag("Model", NotificationCenter.proxyChangedByRotation, 2), new ExifTag("StripOffsets", NotificationCenter.liveLocationsChanged, 3, 4), new ExifTag("Orientation", NotificationCenter.newLocationAvailable, 3), new ExifTag("SamplesPerPixel", NotificationCenter.playerDidStartPlaying, 3), new ExifTag("RowsPerStrip", NotificationCenter.closeSearchByActiveAction, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.messagePlayingSpeedChanged, 3, 4), new ExifTag("XResolution", NotificationCenter.voipServiceCreated, 5), new ExifTag("YResolution", NotificationCenter.webRtcMicAmplitudeEvent, 5), new ExifTag("PlanarConfiguration", NotificationCenter.webRtcSpeakerAmplitudeEvent, 3), new ExifTag("ResolutionUnit", NotificationCenter.onDownloadingFilesChanged, 3), new ExifTag("TransferFunction", NotificationCenter.premiumPromoUpdated, 3), new ExifTag("Software", NotificationCenter.billingConfirmPurchaseError, 2), new ExifTag("DateTime", NotificationCenter.premiumStickersPreviewLoaded, 2), new ExifTag("Artist", NotificationCenter.wallpaperSettedToUser, 2), new ExifTag("WhitePoint", NotificationCenter.storiesListUpdated, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.storiesDraftsUpdated, 5), new ExifTag("SubIFDPointer", NotificationCenter.botForumTopicDidCreate, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("SensorTopBorder", 4, 4), new ExifTag("SensorLeftBorder", 5, 4), new ExifTag("SensorBottomBorder", 6, 4), new ExifTag("SensorRightBorder", 7, 4), new ExifTag("ISO", 23, 3), new ExifTag("JpgFromRaw", 46, 7), new ExifTag("Xmp", 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag("NewSubfileType", NotificationCenter.closeOtherAppActivities, 4), new ExifTag("SubfileType", NotificationCenter.cameraInitied, 4), new ExifTag("ThumbnailImageWidth", 256, 3, 4), new ExifTag("ThumbnailImageLength", NotificationCenter.didSetNewTheme, 3, 4), new ExifTag("BitsPerSample", NotificationCenter.themeListUpdated, 3), new ExifTag("Compression", NotificationCenter.didApplyNewTheme, 3), new ExifTag("PhotometricInterpretation", NotificationCenter.needShareTheme, 3), new ExifTag("ImageDescription", NotificationCenter.proxySettingsChanged, 2), new ExifTag("Make", NotificationCenter.proxyCheckDone, 2), new ExifTag("Model", NotificationCenter.proxyChangedByRotation, 2), new ExifTag("StripOffsets", NotificationCenter.liveLocationsChanged, 3, 4), new ExifTag("ThumbnailOrientation", NotificationCenter.newLocationAvailable, 3), new ExifTag("SamplesPerPixel", NotificationCenter.playerDidStartPlaying, 3), new ExifTag("RowsPerStrip", NotificationCenter.closeSearchByActiveAction, 3, 4), new ExifTag("StripByteCounts", NotificationCenter.messagePlayingSpeedChanged, 3, 4), new ExifTag("XResolution", NotificationCenter.voipServiceCreated, 5), new ExifTag("YResolution", NotificationCenter.webRtcMicAmplitudeEvent, 5), new ExifTag("PlanarConfiguration", NotificationCenter.webRtcSpeakerAmplitudeEvent, 3), new ExifTag("ResolutionUnit", NotificationCenter.onDownloadingFilesChanged, 3), new ExifTag("TransferFunction", NotificationCenter.premiumPromoUpdated, 3), new ExifTag("Software", NotificationCenter.billingConfirmPurchaseError, 2), new ExifTag("DateTime", NotificationCenter.premiumStickersPreviewLoaded, 2), new ExifTag("Artist", NotificationCenter.wallpaperSettedToUser, 2), new ExifTag("WhitePoint", NotificationCenter.storiesListUpdated, 5), new ExifTag("PrimaryChromaticities", NotificationCenter.storiesDraftsUpdated, 5), new ExifTag("SubIFDPointer", NotificationCenter.botForumTopicDidCreate, 4), new ExifTag("JPEGInterchangeFormat", 513, 4), new ExifTag("JPEGInterchangeFormatLength", 514, 4), new ExifTag("YCbCrCoefficients", 529, 5), new ExifTag("YCbCrSubSampling", 530, 3), new ExifTag("YCbCrPositioning", 531, 3), new ExifTag("ReferenceBlackWhite", 532, 5), new ExifTag("Copyright", 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("DNGVersion", 50706, 1), new ExifTag("DefaultCropSize", 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag("StripOffsets", NotificationCenter.liveLocationsChanged, 3);
        ...
        ExifTag[] exifTagArr7 = {new ExifTag("PreviewImageStart", NotificationCenter.didSetNewTheme, 4), new ExifTag("PreviewImageLength", NotificationCenter.themeListUpdated, 4)};
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag("SubIFDPointer", NotificationCenter.botForumTopicDidCreate, 4), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag("InteroperabilityIFDPointer", 40965, 4), new ExifTag("CameraSettingsIFDPointer", 8224, 1), new ExifTag("ImageProcessingIFDPointer", 8256, 1)};
