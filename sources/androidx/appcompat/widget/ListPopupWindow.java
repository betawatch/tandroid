...
public abstract class ListPopupWindow implements ShowableListMenu {
    ...
    private int buildDropDown() {
        ...
        if (i7 == -2) {
            ...
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i8 - (rect2.left + rect2.right), TLObject.FLAG_31);
        } else if (i7 == -1) {
            int i9 = this.mContext.getResources().getDisplayMetrics().widthPixels;
            Rect rect3 = this.mTempRect;
            makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i9 - (rect3.left + rect3.right), TLObject.FLAG_30);
        } else {
