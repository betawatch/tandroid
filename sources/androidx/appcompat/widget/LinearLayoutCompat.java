                            ...
                            if (f5 > 0.0f) {
                                ...
                                if (((LinearLayout.LayoutParams) layoutParams3).height == 0) {
                                    ...
                                    if (i38 == 1073741824) {
                                        ...
                                        virtualChildAt3.measure(childMeasureSpec, View.MeasureSpec.makeMeasureSpec(i47, TLObject.FLAG_30));
                    ...
                    if (z2 && i38 != 1073741824) {
                        for (int i50 = 0; i50 < i3; i50++) {
                            ...
                            if (virtualChildAt4 != null && virtualChildAt4.getVisibility() != 8 && ((LinearLayout.LayoutParams) ((LayoutParams) virtualChildAt4.getLayoutParams())).weight > 0.0f) {
                                virtualChildAt4.measure(View.MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredWidth(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i36, TLObject.FLAG_30));
                            }
                        }
                    }
                    i5 = i;
                    ...
                    if (f6 > 0.0f) {
                        ...
                        if (((LinearLayout.LayoutParams) layoutParams3).width == 0) {
                            ...
                            if (mode == 1073741824) {
                                ...
                                virtualChildAt3.measure(View.MeasureSpec.makeMeasureSpec(i44, TLObject.FLAG_30), childMeasureSpec);
