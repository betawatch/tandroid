...
public class RecyclerView extends ViewGroup {
    ...
    public final void E(s4.z0 z0Var) {
        if (getScrollState() != 2) {
            z0Var.getClass();
            return;
        }
    ...
    */
    ...
    public final void h(c1 c1Var) {
        ...
        i iVar = this.e;
        int indexOfChild = ((RecyclerView) ((c) iVar.b).b).indexOfChild(view);
        if (indexOfChild >= 0) {
            ((n) iVar.c).H(indexOfChild);
            iVar.N(view);
        } else {
                            ...
                            if (z13 && c1Var2 == V) {
                                ...
                                try {
                                    ...
                                    if (C2 == null) {
                                        ...
                                        if (f1Var.q(c1Var2, V, C2, i16, i17, i13, i14)) {
                                            m0();
                                        }
                                    }
                                } catch (Exception e) {
                ...
                while (i18 >= 0) {
                    ...
                    if (i1Var != null) {
                        ...
                        if (i20 == 3) {
                            ...
                            eVar2.getClass();
                            c1Var3.q(z11);
                            RecyclerView recyclerView2 = (RecyclerView) eVar2.b;
                            if (recyclerView2.Q) {
                            ...
                            RecyclerView recyclerView3 = (RecyclerView) eVar2.b;
                            i10 = 0;
                            c1Var3.q(false);
