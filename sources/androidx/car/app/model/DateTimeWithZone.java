...
public final class DateTimeWithZone {
    ...
    public static DateTimeWithZone create(long j10, int i9, String str) {
        if (j10 < 0) {
            throw new IllegalArgumentException("Time since epoch must be greater than or equal to zero");
        }
        if (Math.abs(i9) > MAX_ZONE_OFFSET_SECONDS) {
        ...
        return new DateTimeWithZone(j10, i9, str);
    }
    ...
    public String toString() {
        ...
        sb2.append(", zone: ");
        return aa.d.r(sb2, this.mZoneShortName, "]");
    }

    private DateTimeWithZone(long j10, int i9, String str) {
        this.mTimeSinceEpochMillis = j10;
        this.mZoneOffsetSeconds = i9;
