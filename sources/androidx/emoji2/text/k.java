...
public final class k {
    ...
    */
    public final CharSequence e(int i9, int i10, CharSequence charSequence) {
        o oVar;
        x xVar;
        int codePointAt;
        int i11;
            ...
            if (!z10) {
                try {
                    if (!(charSequence instanceof Spannable)) {
                        if ((charSequence instanceof Spanned) && ((Spanned) charSequence).nextSpanTransition(i9 - 1, i10 + 1, u.class) <= i10) {
                            xVar2 = new x(charSequence);
                        }
                        if (xVar2 != null && (uVarArr = (u[]) xVar2.b.getSpans(i9, i10, u.class)) != null && uVarArr.length > 0) {
                            for (u uVar : uVarArr) {
                        ...
                        if (i9 != i10 && i9 < charSequence.length()) {
                            ...
                            loop1: while (true) {
                                i11 = i9;
                                while (i9 < i10 && i12 < Integer.MAX_VALUE) {
                                    ...
                                    if (a2 != 1) {
                                        ...
                                        if (!bVar.E(charSequence, i11, i9, ((r) oVar.f).b)) {
                                            if (xVar == null) {
                                                xVar = new x((Spannable) new SpannableString(charSequence));
                                            }
                                            xVar.setSpan(new u(((r) oVar.f).b), i11, i9, 33);
                                            i12++;
                                        }
                                    }
                                }
                            }
                            if (oVar.a == 2 && ((r) oVar.e).b != null && ((oVar.c > 1 || oVar.e()) && i12 < Integer.MAX_VALUE && !bVar.E(charSequence, i11, i9, ((r) oVar.e).b))) {
                                if (xVar == null) {
                                    xVar = new x(charSequence);
                                }
                                xVar.setSpan(new u(((r) oVar.e).b), i11, i9, 33);
                            }
                            if (xVar == null) {
