...
public final class l {
    ...
    public final void b(ArrayList arrayList, boolean z10) {
        ...
        ((u0) arrayList.get(hd.h.a(arrayList))).getClass();
        if (arrayList.size() > 0) {
    ...
    public final void d() {
        ...
        synchronized (this.b) {
            try {
                ...
                int i13 = 0;
                while (i13 < size3) {
                    Object obj3 = o10.get(i13);
                    i13++;
                    ((u0) obj3).getClass();
                }
                int size4 = o10.size();
                while (i10 < size4) {
                    Object obj4 = o10.get(i10);
                    i10++;
                    u0 u0Var2 = (u0) obj4;
                    if (j0.K(2)) {
                        if (isAttachedToWindow) {
