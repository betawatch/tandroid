...
public final class l {
    ...
    public final void b(ArrayList arrayList, boolean z10) {
        ...
        ((u0) arrayList.get(qc.h.b(arrayList))).getClass();
        if (arrayList.size() > 0) {
    ...
    public final void e(List list) {
        ...
        List m10 = qc.g.m(qc.g.p(arrayList));
        int size2 = m10.size();
