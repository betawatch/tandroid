...
public final class x extends FrameLayout {
    ...
    public x(Context context, AttributeSet attrs, k0 k0Var) {
        super(context, attrs);
        ...
        if (classAttribute != null && C == null) {
            ...
            if (k0Var2.w != null && !k0Var2.J) {
                ...
                if (aVar2 != null) {
                    ...
                    aVar2.d();
                    if (k0.K(3)) {
                        Log.d("FragmentManager", "Reversing mTransitioningOp " + k0Var2.h + " as part of execSingleAction for action " + aVar);
                    }
                    k0Var2.h.e(false, false);
                    k0Var2.h.a(k0Var2.L, k0Var2.M);
                    ArrayList arrayList = k0Var2.h.a;
                ...
                aVar.a(k0Var2.L, k0Var2.M);
                k0Var2.b = true;
                try {
                    k0Var2.W(k0Var2.L, k0Var2.M);
                    k0Var2.d();
                    k0Var2.h0();
                    k0Var2.v();
                    ((HashMap) k0Var2.c.b).values().removeAll(Collections.singleton(null));
                } catch (Throwable th2) {
                    k0Var2.d();
                    throw th2;
                }
