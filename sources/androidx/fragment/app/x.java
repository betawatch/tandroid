...
public final class x extends FrameLayout {
    ...
    public x(Context context, AttributeSet attrs, j0 j0Var) {
        ...
        if (classAttribute != null && C == null) {
            if (id2 == -1) {
                throw new IllegalStateException(a9.p.m("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? " with tag ".concat(string) : ""));
            }
            c0 H = j0Var.H();
