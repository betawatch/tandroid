...
public abstract class r implements ComponentCallbacks, View.OnCreateContextMenuListener, androidx.lifecycle.t, androidx.lifecycle.u0, androidx.lifecycle.i, t4.e {
    ...
    public void i(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (rVar == null) {
            i0 i0Var = this.J;
            rVar = (i0Var == null || (str2 = this.n) == null) ? null : i0Var.c.l(str2);
        }
        if (rVar != null) {
            printWriter.print(str);
        ...
        q qVar8 = this.Y;
        if ((qVar8 == null ? 0 : qVar8.e) != 0) {
            printWriter.print(str);
            printWriter.print("getPopExitAnim=");
            q qVar9 = this.Y;
            printWriter.println(qVar9 != null ? qVar9.e : 0);
        }
        if (this.V != null) {
            printWriter.print(str);
        ...
        if (n() != null) {
            new o0.a(this, f()).q(str, printWriter);
        }
        printWriter.print(str);
        printWriter.println("Child " + this.L + ":");
        this.L.w(p6.t(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final void startActivityForResult(Intent intent, int i10) {
        ...
        tVar.b.startActivity(intent, null);
    }
