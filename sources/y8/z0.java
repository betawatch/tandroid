...
public final class z0 {
    ...
    public static final boolean c(PackageInfo packageInfo, boolean z10) {
        ...
        byte[] bArr = c;
        return z10 ? d(packageInfo, bArr, d) : d(packageInfo, bArr);
    }
    ...
    public final boolean b() {
        ...
        try {
            packageInfo = w6.b.a(context).c(64, "com.google.android.wearable.app.cn");
        ...
        boolean c10 = c(packageInfo, false);
        if (c10 || !c(packageInfo, true)) {
            return c10;
        }
