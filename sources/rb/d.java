    ...
    */
    public static void b(lb.a aVar, pb.b bVar, pb.e eVar, int i9, b bVar2) {
        ...
        while (true) {
            ...
            iArr3[i41] = iArr3[i41] ^ aVar3.a[i41];
            i41++;
        }
        if (aVar2.b != 15) {
            throw new s("should not happen but we got: " + aVar2.b);
        }
        int i42 = 0;
        while (true) {
            int i43 = aVar2.b;
        ...
        if (i24 >= 7) {
            ...
            if (aVar4.b != 18) {
                throw new s("should not happen but we got: " + aVar4.b);
            }
            int i45 = 17;
        ...
        throw new s("Not all bits consumed: " + i51 + '/' + aVar.b);
    }
