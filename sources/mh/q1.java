...
public final /* synthetic */ class q1 implements wx, org.telegram.ui.ActionBar.b2, ResultCallback {
    ...
    public /* synthetic */ q1(int i9, long j10, TLRPC.TL_attachMenuBot tL_attachMenuBot, Runnable runnable) {
        this.b = i9;
        this.c = j10;
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i9) {
        ...
        switch (i10) {
            case 1:
                ...
                ConnectionsManager.getInstance(i11).sendRequest(tL_messages_toggleBotInAttachMenu, new j2(i11, i12), 66);
                ...
                if (editText.getText() != null) {
                    if (j10 <= 0) {
                        ...
                        if (str != null && str.equals(obj3)) {
                            ...
                            MessagesController.getInstance(i11).changeChatTitle(j11, obj3);
    ...
    public void onComplete(Object obj) {
        ...
        if (drawable instanceof jb0) {
            ...
            jb0Var.t(a11.e((Bitmap) pair.second), this.b >= 0 ? 100 : -100);
            jb0Var.u(a11Var.H);
        }
        a11Var.invalidate();
    }
    ...
    public boolean v(dy dyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i9, int i10, we1 we1Var) {
        ...
        int i13 = f6.G6;
        textView.setTextColor(f6.w0(null, i13, false));
        ...
        textView2.setTextColor(f6.w0(null, i13, false));
        ...
        final int i14 = MessagesController.getInstance(i12).botVerificationDescriptionLengthLimit;
        ...
        editTextBoldCursor.setTextColor(f6.w0(null, i13, false));
        ...
        editTextBoldCursor.setHighlightColor(f6.w0(null, f6.uf, false));
        editTextBoldCursor.setHandlesColor(f6.w0(null, f6.vf, false));
        ...
        editTextBoldCursor.addTextChangedListener(new u1(editTextBoldCursor, i14, fc0Var));
        ...
        if (botverifiersettings.can_modify_custom_description) {
            ...
            textView3.setPadding(org.telegram.ui.Cells.j2.c(14.0f, j10 >= 0 ? R.string.BotVerifyDescriptionInfo : R.string.BotVerifyDescriptionInfoChat, textView3), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(14.0f), AndroidUtilities.dp(27.0f));
            i11 = -1;
        ...
        dVar.setOnClickListener(new View.OnClickListener() { // from class: mh.s1
            ...
            public final void onClick(View view) {
                ...
                if (z12 && editTextBoldCursor2.getText().length() > i14) {
                    fc0 fc0Var2 = fc0Var;
                    fc0Var2.a(1.0f);
                ...
                int i15 = i12;
                setcustomverification.bot = MessagesController.getInstance(i15).getInputUser(j11);
                setcustomverification.peer = MessagesController.getInstance(i15).getInputPeer(j10);
                ...
                ConnectionsManager.getInstance(i15).sendRequest(setcustomverification, new bg.b0(dVar2, f3Var, r1Var2, 13));
            }
        });
    ...
    public /* synthetic */ q1(EditText editText, long j10, int i9, EditText editText2) {
        this.d = editText;
        this.c = j10;
        this.b = i9;
        this.e = editText2;
    ...
    public /* synthetic */ q1(a11 a11Var, long j10, bp bpVar, int i9) {
        this.d = a11Var;
        this.c = j10;
        this.e = bpVar;
        this.b = i9;
    ...
    public /* synthetic */ q1(dy dyVar, int i9, long j10, TL_bots.botVerifierSettings botverifiersettings) {
        this.d = dyVar;
        this.b = i9;
        this.c = j10;
