...
public final /* synthetic */ class u7 implements Runnable {
    ...
    public /* synthetic */ u7(int i10, Context context, long j10, long j11, org.telegram.ui.ActionBar.h3[] h3VarArr, org.telegram.ui.ActionBar.g6 g6Var) {
        this.b = i10;
        this.e = context;
        this.c = j10;
        this.d = j11;
    ...
    public final void run() {
        switch (this.a) {
            case 0:
                ...
                a0 g10 = a0.g(i10);
                long j10 = this.c;
                g10.f(context, j10, this.d, new sh.s2(h3VarArr, context, i10, j10, g6Var, 2));
                break;
            case 1:
                oh.v0 v0Var = (oh.v0) this.e;
                ...
                if (!"BALANCE_TOO_LOW".equalsIgnoreCase(tL_error.text)) {
                    if (!"GROUPCALL_INVALID".equalsIgnoreCase(tL_error.text)) {
                        new qc(v0Var.b, new oh.b()).d0(tL_error, true);
                        break;
                    } else {
                        oh.e1 e1Var = v0Var.M;
                        if (e1Var != null) {
            ...
            default:
                ...
                org.telegram.ui.ActionBar.g6 g6Var2 = (org.telegram.ui.ActionBar.g6) this.h;
                q70Var.u();
                int i11 = this.b;
                ...
                if (qc.a(p2Var)) {
                    qc.z(p2Var, !isDialogMuted ? 3 : 4, !isDialogMuted ? ConnectionsManager.DEFAULT_DATACENTER_ID : 0, g6Var2).j();
                    break;
                }
                break;
        }
    ...
    public /* synthetic */ u7(oh.v0 v0Var, int i10, TLRPC.TL_error tL_error, long j10, long j11, TLRPC.TL_textWithEntities tL_textWithEntities) {
        this.e = v0Var;
        this.b = i10;
        this.f = tL_error;
        this.c = j10;
    ...
    public /* synthetic */ u7(q70 q70Var, int i10, long j10, long j11, xn xnVar, org.telegram.ui.ActionBar.g6 g6Var) {
        this.e = q70Var;
        this.b = i10;
        this.c = j10;
        this.d = j11;
