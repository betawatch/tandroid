...
public final class d4 extends FrameLayout {
    ...
    public final void b(final boolean z4, boolean z10) {
        ...
        pr prVar = pr.h;
        final int i10 = 0;
        alpha.setInterpolator(prVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: mh.c4
        ...
        final int i11 = 1;
        textView.animate().alpha(z4 ? 1.0f : 0.0f).setInterpolator(prVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: mh.c4
            public final /* synthetic */ d4 b;
        ...
        final int i12 = 2;
        frameLayout2.animate().alpha(z4 ? 1.0f : 0.0f).setInterpolator(prVar).setDuration(420L).withEndAction(new Runnable(this) { // from class: mh.c4
            public final /* synthetic */ d4 b;
