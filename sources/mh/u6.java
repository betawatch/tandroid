...
public final /* synthetic */ class u6 implements Runnable {
    ...
    public /* synthetic */ u6(int i10, long j10, Context context, TL_payments.connectedBotStarRef connectedbotstarref, org.telegram.ui.ActionBar.h3 h3Var, org.telegram.ui.ActionBar.g6 g6Var) {
        this.c = i10;
        this.d = context;
        this.b = j10;
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                ...
                int i10 = this.c;
                long j11 = this.b;
                m5Var.run(arrayList, Integer.valueOf(i10), Long.valueOf(j11), (ArrayList) this.f, (ArrayList) this.h);
                break;
            case 1:
                ...
                break;
            case 2:
                org.telegram.ui.Cells.f6.a((org.telegram.ui.Cells.f6) this.d, (TLObject) this.f, (MessagesStorage) this.h, this.b, this.c, (ArrayList) this.e);
                break;
            case 3:
                TLObject tLObject = (TLObject) this.d;
                int i11 = this.c;
                qh.d dVar = (qh.d) this.e;
                ...
                if (tL_error2 != null || !(tLObject2 instanceof Vector)) {
                    ...
                    if (arrayList2.isEmpty()) {
                        for (int i16 = 0; i16 < arrayList4.size(); i16++) {
                            ...
                            xh0Var.a.add((Long) pair.first);
                            xh0Var.b.add((Integer) pair.second);
                            xh0Var.c.add((TLObject) hashMap.get(pair.first));
                        }
                        xh0Var.b();
                        break;
                        ...
                        final int i17 = 0;
                        ConnectionsManager.getInstance(i13).sendRequest(tL_channels_getParticipants, new RequestDelegate() { // from class: org.telegram.ui.uh0
                                                                ...
                                                                if (i21 < size3) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i20 < arrayList6.size()) {
                                                                            ...
                                                                            xh0Var3.a.add((Long) pair2.first);
                                                                            xh0Var3.b.add((Integer) pair2.second);
                                                                            xh0Var3.c.add((TLObject) hashMap3.get(pair2.first));
                                                                            i20++;
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (i23 < size4) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i22 < arrayList7.size()) {
                                                                            ...
                                                                            xh0Var4.a.add((Long) pair3.first);
                                                                            xh0Var4.b.add((Integer) pair3.second);
                                                                            xh0Var4.c.add((TLObject) hashMap4.get(pair3.first));
                                                                            i22++;
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (i212 < size3) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i202 < arrayList62.size()) {
                                                                            ...
                                                                            xh0Var32.a.add((Long) pair2.first);
                                                                            xh0Var32.b.add((Integer) pair2.second);
                                                                            xh0Var32.c.add((TLObject) hashMap32.get(pair2.first));
                                                                            i202++;
                                                                        }
                                                                    }
                                                                }
                        ...
                        final int i18 = 1;
                        ConnectionsManager.getInstance(i13).sendRequest(tL_messages_getFullChat, new RequestDelegate() { // from class: org.telegram.ui.uh0
                            @Override // org.telegram.tgnet.RequestDelegate
                            public final void run(final TLObject tLObject3, TLRPC.TL_error tL_error3) {
                                switch (i18) {
                                    case 0:
    ...
    public /* synthetic */ u6(m5 m5Var, ArrayList arrayList, int i10, long j10, ArrayList arrayList2, ArrayList arrayList3) {
        this.d = m5Var;
        this.e = arrayList;
        this.c = i10;
        this.b = j10;
    ...
    public /* synthetic */ u6(TopicsController topicsController, TLRPC.TL_messages_forumTopics tL_messages_forumTopics, long j10, TLRPC.TL_messages_forumTopics tL_messages_forumTopics2, a0.h hVar, int i10) {
    ...
    public /* synthetic */ u6(TLObject tLObject, int i10, qh.d dVar, org.telegram.ui.ActionBar.h3 h3Var, long j10, TLRPC.TL_error tL_error) {
        this.d = tLObject;
        this.c = i10;
        this.e = dVar;
        this.f = h3Var;
    ...
    public /* synthetic */ u6(org.telegram.ui.Cells.f6 f6Var, TLObject tLObject, MessagesStorage messagesStorage, long j10, int i10, ArrayList arrayList) {
        this.d = f6Var;
        this.f = tLObject;
    ...
    public /* synthetic */ u6(xh0 xh0Var, TLRPC.TL_error tL_error, TLObject tLObject, long j10, int i10, TLRPC.Chat chat) {
        this.d = xh0Var;
        this.e = tL_error;
        this.f = tLObject;
        this.b = j10;
