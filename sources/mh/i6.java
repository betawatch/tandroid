...
public final /* synthetic */ class i6 implements Runnable {
    ...
    public /* synthetic */ i6(t7 t7Var, boolean[] zArr, TL_stars.StarGift starGift, boolean z4, boolean z10, long j10, TLRPC.TL_textWithEntities tL_textWithEntities, lh.s5 s5Var) {
        this.e = t7Var;
        this.f = zArr;
        this.h = starGift;
        this.b = z4;
                                    ...
                                    if (inputGroupCall != null) {
                                        ...
                                        if (e1Var != null) {
                                            ...
                                            if (oh.e1.T != null) {
                                                ...
                                                objArr[c3] = Long.valueOf(oh.e1.T.g());
