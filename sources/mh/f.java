...
public final /* synthetic */ class f implements Runnable {
            ...
            default:
                ...
                g1Var.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.j21
                    ...
                    public final void onClick(View view) {
                        ...
                        ConnectionsManager.getInstance(i10).sendRequest(tL_channels_editBanned, new y1(x21Var2, 15));
                    }
                });
                break;
        }
    ...
    public /* synthetic */ f(x21 x21Var, boolean z4, org.telegram.ui.ActionBar.g1 g1Var, q70 q70Var, long j10, TLRPC.User user, TLRPC.Chat chat) {
        this.d = x21Var;
        this.b = z4;
        this.e = g1Var;
        this.f = q70Var;
