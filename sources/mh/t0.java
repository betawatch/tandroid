...
public final class t0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public t0(Context context, int i10, long j10, org.telegram.ui.l0 l0Var) {
        super(context);
        this.d = true;
        this.y = new org.telegram.ui.Components.z5(this, 0L, 350L, pr.h);
        this.B = 1.0f;
            ...
            if (user != null) {
                    ...
                    for (int i15 = 0; i15 < this.C.l.size(); i15++) {
                        ...
                        if (!savedStarGift.unsaved && savedStarGift.pinned_to_top) {
                            ...
                            if (starGift instanceof TL_stars.TL_starGiftUnique) {
                                s0 s0Var3 = new s0(this, (TL_stars.TL_starGiftUnique) starGift);
                                long j11 = s0Var3.a;
                ...
                if (arrayList3.size() == arrayList2.size()) {
                    for (int i16 = 0; i16 < arrayList3.size(); i16++) {
                        s0 s0Var4 = (s0) arrayList3.get(i16);
                        s0 s0Var5 = (s0) arrayList2.get(i16);
                        s0Var4.getClass();
                        if (s0Var5 != null && s0Var5.a == s0Var4.a) {
                        }
                    }
                    z4 = false;
                    i10 = 0;
                    while (i10 < arrayList3.size()) {
                        s0 s0Var6 = (s0) arrayList3.get(i10);
                        int i17 = 0;
                        while (true) {
                            if (i17 >= arrayList2.size()) {
                                ...
                                if (((s0) arrayList2.get(i17)).a == s0Var6.a) {
                                    s0Var2 = (s0) arrayList2.get(i17);
                                    break;
                                }
                                i17++;
                            }
                        ...
                        if (s0Var2 != null) {
                            ...
                            int i18 = s0Var6.d;
                            s0Var6.h = new RadialGradient(0.0f, 0.0f, dp, new int[]{i18, org.telegram.ui.ActionBar.k6.l1(0.0f, i18)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
                            Paint paint = new Paint(1);
                            s0Var6.i = paint;
                            paint.setShader(s0Var6.h);
                            TLRPC.Document document = s0Var6.b;
                            if (document != null) {
                                s0Var6.j = org.telegram.ui.Components.l5.m(i13, i14, document);
                            } else {
                                s0Var6.j = org.telegram.ui.Components.l5.n(i13, s0Var6.c, null, i14);
                            }
                    ...
                    for (i11 = 0; i11 < this.G; i11 = yh.d(i11, i11, 1, arrayList)) {
                    }
                    for (i12 = 0; i12 < arrayList2.size(); i12++) {
                        s0 s0Var7 = (s0) arrayList2.get(i12);
                        int i19 = 0;
                        while (true) {
                            if (i19 >= arrayList3.size()) {
                                ...
                                if (((s0) arrayList3.get(i19)).a == s0Var7.a) {
                                    s0Var = (s0) arrayList3.get(i19);
                                    break;
                                }
                                i19++;
                            }
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        s0 s0Var;
        t0 t0Var = this;
        ArrayList arrayList2 = t0Var.E;
        if (arrayList2.isEmpty()) {
            return;
        }
        float f13 = 1.0f;
        if (t0Var.e >= 1.0f || t0Var.f <= 0.0f) {
            return;
        }
        View view = t0Var.c;
        float x10 = view.getX();
        ...
        while (i10 < arrayList2.size()) {
            ...
            float d = s0Var2.k.d(f13, z4);
            float lerp = AndroidUtilities.lerp(0.5f, f13, d);
            int i11 = i10;
            float y11 = org.telegram.messenger.y3.y(f13, t0Var.n, (f13 - t0Var.e) * d, clamp012);
            int i12 = s0Var2.g;
            float f20 = 1.6f;
            if (i12 != 0) {
                if (i12 != 1) {
                    ...
                    f20 = 0.9f;
                    float min2 = (!t0Var.h || d >= 1.0f) ? t0Var.f : Math.min(d, t0Var.f);
                    float f21 = f20 * 0.2f;
                    clamp01 = min2 >= 1.0f - f21 ? 1.0f : Utilities.clamp01(((min2 - 0.32000002f) + f21) / 0.67999995f);
                    if (clamp01 < 1.0f) {
                        dp = AndroidUtilities.lerp(f16, dp, t0Var.H.getInterpolation(clamp01));
                        f11 = AndroidUtilities.lerp(f17, f11, t0Var.I.getInterpolation(clamp01));
                    ...
                    if (y11 <= 0.0f) {
                        ...
                        f12 = f17;
                        arrayList = arrayList2;
                        s0Var2.l.set(dp - f23, f11 - f23, dp + f23, f11 + f23);
                        canvas.save();
                        canvas.translate(dp, f11);
                        canvas.rotate(0.0f);
                        float a2 = s0Var2.m.a(0.1f) * f22;
                        canvas.scale(a2, a2);
                        s0Var2.f.d();
                        s0Var2.f.b(canvas, s0Var2.d, y11);
                        Paint paint = s0Var2.i;
                        if (paint != null) {
                            paint.setAlpha((int) (y11 * 255.0f * 1.0f));
                            float f24 = (-dp3) / 2.0f;
                            s0Var = s0Var2;
                            canvas.drawRect(f24, f24, f23, f23, s0Var2.i);
                        } else {
                            s0Var = s0Var2;
                        }
                        if (s0Var.j != null) {
                            ...
                            int i13 = (-dp4) / 2;
                            int i14 = dp4 / 2;
                            s0Var.j.setBounds(i13, i13, i14, i14);
                            s0Var.j.setAlpha((int) (y11 * 255.0f));
                            s0Var.j.draw(canvas);
                        }
                        canvas.restore();
                    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (true) {
            ...
            if (((s0) arrayList.get(i10)).l.contains(x10, y10)) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            s0 s0Var4 = this.J;
            if (s0Var4 != null) {
                af.g.s(getContext(), "https://t.me/nft/" + s0Var4.e);
                this.J.m.c(false);
                this.J = null;
            }
