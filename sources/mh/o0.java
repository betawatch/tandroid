...
public final /* synthetic */ class o0 implements View.OnClickListener {
    ...
    public /* synthetic */ o0(r0 r0Var, xn xnVar, int i10, Context context, org.telegram.ui.ActionBar.g6 g6Var, long j10, Utilities.Callback callback) {
        this.d = r0Var;
        this.c = i10;
        this.e = context;
        this.f = g6Var;
        ...
        switch (this.a) {
            case 0:
                ...
                if (r0Var.s.T) {
                    ...
                    if (!MessagesController.getInstance(i10).isFrozen()) {
                        t7 x10 = t7.x(i10, r0Var.E.a);
                        mf.a l10 = x10.e ? mf.a.l(x10.p()) : null;
                        if (!r0Var.c && (l10 == null || l10.b < r0Var.E.b)) {
                            mf.a aVar = r0Var.E;
                            mf.b bVar = aVar.a;
                            if (bVar != mf.b.a) {
                                if (bVar == mf.b.b) {
                                    new rh.f(context, g6Var, aVar, true, null).show();
                                    break;
                                }
                            } else {
                                long a2 = aVar.a();
            ...
            default:
                ...
                if (U != null) {
                    ...
                    c1Var.z2 = new jy() { // from class: sh.v0
    ...
    public /* synthetic */ o0(xf0 xf0Var, String str, long j10, String str2, String str3, int i10) {
        this.d = xf0Var;
        this.e = str;
        this.b = j10;
        this.f = str2;
    ...
    public /* synthetic */ o0(sh.e1 e1Var, TLRPC.TL_messages_preparedInlineMessage tL_messages_preparedInlineMessage, eh.w wVar, int i10, long j10, org.telegram.ui.web.u uVar) {
        this.d = e1Var;
