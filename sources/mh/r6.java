...
public final /* synthetic */ class r6 implements Runnable {
    ...
    public /* synthetic */ r6(t7 t7Var, TLObject tLObject, int i10) {
        this.a = i10;
        this.b = t7Var;
        this.c = tLObject;
    }
        ...
        switch (this.a) {
            case 0:
                ...
                if (tLObject instanceof TL_stars.StarsStatus) {
                    ...
                    t7Var.z.addAll(starsStatus.subscriptions);
            ...
            case 1:
                ...
                if (tLObject2 instanceof TL_stars.StarsStatus) {
                    ...
                    t7Var2.y = (starsStatus2.flags & 4) == 0;
                    t7Var2.w = starsStatus2.subscriptions_next_offset;
            ...
            case 2:
                ...
                boolean z4 = tLObject3 instanceof Vector;
                final t7 t7Var3 = this.b;
                if (z4) {
                ...
                t7Var3.j = arrayList;
                t7Var3.h = false;
                NotificationCenter.getInstance(t7Var3.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starOptionsLoaded, new Object[0]);
                if (!arrayList2.isEmpty()) {
                    final int i13 = 0;
                    Runnable runnable = new Runnable() { // from class: mh.x6
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i13) {
                                case 0:
                                    ...
                                    while (true) {
                                        ...
                                        if (i14 >= arrayList5.size()) {
                                            ...
                                            billingController.queryProductDetails(arrayList4, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: mh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final p2.h hVar, final List list) {
                                                    switch (i15) {
                                                        case 0:
                                                            final int i16 = 1;
                                                            final t7 t7Var5 = t7Var4;
                                                            final ArrayList arrayList6 = arrayList5;
                                                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: mh.x5
                                                                @Override // java.lang.Runnable
                                                                public final void run() {
                                                                    ...
                                                                    switch (i16) {
                                                                        case 0:
                                                                            p2.h hVar2 = hVar;
                                                                            if (hVar2.a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar2.a));
                                                                                break;
                                                                            } else {
                                                                                List list2 = list;
                                                                                if (list2 != null) {
                                                                                    for (int i17 = 0; i17 < list2.size(); i17++) {
                                                                                        p2.m mVar = (p2.m) list2.get(i17);
                                                                                        int i18 = 0;
                                                                                        while (true) {
                                                                                            ArrayList arrayList7 = arrayList6;
                                                                                            if (i18 >= arrayList7.size()) {
                                                                                                tL_starsGiftOption = null;
                                                                                            } else if (((TL_stars.TL_starsGiftOption) arrayList7.get(i18)).store_product.equals(mVar.c)) {
                                                                                ...
                                                                                t7 t7Var6 = t7Var5;
                                                                                if (t7Var6.m != null) {
                                                                                    for (int i19 = 0; i19 < t7Var6.m.size(); i19++) {
                                                                                        TL_stars.TL_starsGiftOption tL_starsGiftOption2 = (TL_stars.TL_starsGiftOption) t7Var6.m.get(i19);
                                                                                        if (tL_starsGiftOption2 != null && tL_starsGiftOption2.loadingStorePrice) {
                                                                                            tL_starsGiftOption2.missingStorePrice = true;
                                                                                        }
                                                                                    }
                                                                                }
                                                                                NotificationCenter.getInstance(t7Var6.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiftOptionsLoaded, new Object[0]);
                                                                                break;
                                                                            }
                                                                            break;
                                                                        case 1:
                                                                            p2.h hVar3 = hVar;
                                                                            if (hVar3.a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar3.a));
                                                                                break;
                                                                            } else {
                                                                                List list3 = list;
                                                                                if (list3 != null) {
                                                                                    for (int i20 = 0; i20 < list3.size(); i20++) {
                                                                                        p2.m mVar2 = (p2.m) list3.get(i20);
                                                                                        int i21 = 0;
                                                                                        while (true) {
                                                                                            ArrayList arrayList8 = arrayList6;
                                                                                            if (i21 >= arrayList8.size()) {
                                                                                                tL_starsGiveawayOption = null;
                                                                                            } else if (((TL_stars.TL_starsGiveawayOption) arrayList8.get(i21)).store_product.equals(mVar2.c)) {
                                                                                ...
                                                                                t7 t7Var7 = t7Var5;
                                                                                if (t7Var7.p != null) {
                                                                                    for (int i22 = 0; i22 < t7Var7.p.size(); i22++) {
                                                                                        TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption2 = (TL_stars.TL_starsGiveawayOption) t7Var7.p.get(i22);
                                                                                        if (tL_starsGiveawayOption2 != null && tL_starsGiveawayOption2.loadingStorePrice) {
                                                                                            tL_starsGiveawayOption2.missingStorePrice = true;
                                                                                        }
                                                                                    }
                                                                                }
                                                                                NotificationCenter.getInstance(t7Var7.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiveawayOptionsLoaded, new Object[0]);
                                                                                break;
                                                                            }
                                                                            break;
                                                                        default:
                                                                            p2.h hVar4 = hVar;
                                                                            if (hVar4.a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar4.a));
                                                                                break;
                                                                            } else {
                                                                                List list4 = list;
                                                                                if (list4 != null) {
                                                                                    for (int i23 = 0; i23 < list4.size(); i23++) {
                                                                                        p2.m mVar3 = (p2.m) list4.get(i23);
                                                                                        int i24 = 0;
                                                                                        while (true) {
                                                                                            ArrayList arrayList9 = arrayList6;
                                                                                            if (i24 >= arrayList9.size()) {
                                                                                                tL_starsTopupOption2 = null;
                                                                                            } else if (((TL_stars.TL_starsTopupOption) arrayList9.get(i24)).store_product.equals(mVar3.c)) {
                                                                                ...
                                                                                t7 t7Var8 = t7Var5;
                                                                                if (t7Var8.j != null) {
                                                                                    for (int i25 = 0; i25 < t7Var8.j.size(); i25++) {
                                                                                        TL_stars.TL_starsTopupOption tL_starsTopupOption3 = (TL_stars.TL_starsTopupOption) t7Var8.j.get(i25);
                                                                                        if (tL_starsTopupOption3 != null && tL_starsTopupOption3.loadingStorePrice) {
                                                                                            tL_starsTopupOption3.missingStorePrice = true;
                                                                                        }
                                                                                    }
                                                                                }
                                                                                NotificationCenter.getInstance(t7Var8.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starOptionsLoaded, new Object[0]);
                                                                                break;
                                                                            }
                                                                            break;
                                                                    }
                                                                            ...
                                                                            if (hVar2.a != 0) {
                                                                                ...
                                                                                if (list2 != null) {
                                                                                    for (int i172 = 0; i172 < list2.size(); i172++) {
                                                                                        p2.m mVar = (p2.m) list2.get(i172);
                                                                                        int i18 = 0;
                                                                                        while (true) {
                                                                                            ArrayList arrayList72 = arrayList7;
                                                                                            if (i18 >= arrayList72.size()) {
                                                                                                tL_starsGiftOption = null;
                                                                                            } else if (((TL_stars.TL_starsGiftOption) arrayList72.get(i18)).store_product.equals(mVar.c)) {
                                                                                ...
                                                                                t7 t7Var62 = t7Var6;
                                                                                if (t7Var62.m != null) {
                                                                                    for (int i19 = 0; i19 < t7Var62.m.size(); i19++) {
                                                                                        TL_stars.TL_starsGiftOption tL_starsGiftOption2 = (TL_stars.TL_starsGiftOption) t7Var62.m.get(i19);
                                                                                        if (tL_starsGiftOption2 != null && tL_starsGiftOption2.loadingStorePrice) {
                                                                                            tL_starsGiftOption2.missingStorePrice = true;
                                                                                        }
                                                                                    }
                                                                                }
                                                                                NotificationCenter.getInstance(t7Var62.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiftOptionsLoaded, new Object[0]);
                                                                                break;
                                                                            }
                                                                            break;
                                                                        case 1:
                                                                    ...
                                                                    switch (i18) {
                                                                                    ...
                                                                                    for (int i172 = 0; i172 < list2.size(); i172++) {
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i182 >= arrayList72.size()) {
                                                                                                tL_starsGiftOption = null;
                                                                                            } else if (((TL_stars.TL_starsGiftOption) arrayList72.get(i182)).store_product.equals(mVar.c)) {
                                                                        ...
                                                                        case 1:
                                                                            ...
                                                                            if (hVar3.a != 0) {
                                                                                    ...
                                                                                    for (int i20 = 0; i20 < list3.size(); i20++) {
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i21 >= arrayList82.size()) {
                                                                                                tL_starsGiveawayOption = null;
                                                                                            } else if (((TL_stars.TL_starsGiveawayOption) arrayList82.get(i21)).store_product.equals(mVar2.c)) {
                                                                                ...
                                                                                t7 t7Var72 = t7Var7;
                                                                                if (t7Var72.p != null) {
                                                                                    for (int i22 = 0; i22 < t7Var72.p.size(); i22++) {
                                                                                        TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption2 = (TL_stars.TL_starsGiveawayOption) t7Var72.p.get(i22);
                                                                                        if (tL_starsGiveawayOption2 != null && tL_starsGiveawayOption2.loadingStorePrice) {
                                                                                            tL_starsGiveawayOption2.missingStorePrice = true;
                                                                                        }
                                                                                    }
                                                                                }
                                                                                NotificationCenter.getInstance(t7Var72.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiveawayOptionsLoaded, new Object[0]);
                                                                                break;
                                                                            }
                                                                            break;
                                                                        default:
                                            ...
                                            b6.h hVar = new b6.h();
                                            hVar.c = "inapp";
                                            hVar.b = ((TL_stars.TL_starsTopupOption) arrayList5.get(i14)).store_product;
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i16 >= arrayList7.size()) {
                                            ...
                                            billingController2.queryProductDetails(arrayList6, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: mh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (i162) {
                                                                        case 0:
                                                                            p2.h hVar22 = hVar2;
                                                                            if (hVar22.a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar22.a));
                                                                                break;
                                                                            } else {
                                                                                List list2 = list;
                                                                                if (list2 != null) {
                                                                            ...
                                                                            if (hVar22.a != 0) {
                                                                                ...
                                                                                if (list2 != null) {
                                                                                    for (int i1722 = 0; i1722 < list2.size(); i1722++) {
                                                                                        p2.m mVar = (p2.m) list2.get(i1722);
                                                                                        int i182 = 0;
                                                                                        while (true) {
                                                                                            ArrayList arrayList722 = arrayList72;
                                                                                            if (i182 >= arrayList722.size()) {
                                                                                                tL_starsGiftOption = null;
                                                                                            } else if (((TL_stars.TL_starsGiftOption) arrayList722.get(i182)).store_product.equals(mVar.c)) {
                                            ...
                                            b6.h hVar2 = new b6.h();
                                            hVar2.c = "inapp";
                                            hVar2.b = ((TL_stars.TL_starsGiftOption) arrayList7.get(i16)).store_product;
                                ...
                                default:
                                    ...
                                    while (true) {
                                        ...
                                        if (i18 >= arrayList9.size()) {
                                            ...
                                            billingController3.queryProductDetails(arrayList8, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: mh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                                ...
                                                                public final void run() {
                                                                    ...
                                                                    switch (i162) {
                                                                        case 0:
                                                                            p2.h hVar222 = hVar22;
                                                                            if (hVar222.a != 0) {
                                                                                t7.e("BILLING_" + BillingController.getResponseCodeString(hVar222.a));
                                                                                break;
                                                                            } else {
                                                                                List list2 = list;
                                                                                if (list2 != null) {
                                                                                ...
                                                                                t7 t7Var62 = t7Var52;
                                                                                if (t7Var62.m != null) {
                                                                                    for (int i192 = 0; i192 < t7Var62.m.size(); i192++) {
                                                                                        TL_stars.TL_starsGiftOption tL_starsGiftOption2 = (TL_stars.TL_starsGiftOption) t7Var62.m.get(i192);
                                                                                        if (tL_starsGiftOption2 != null && tL_starsGiftOption2.loadingStorePrice) {
                                                                                            tL_starsGiftOption2.missingStorePrice = true;
                                                                                        }
                                                                                    }
                                                                                    ...
                                                                                    for (int i23 = 0; i23 < list4.size(); i23++) {
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i24 >= arrayList92.size()) {
                                                                                                tL_starsTopupOption2 = null;
                                                                                            } else if (((TL_stars.TL_starsTopupOption) arrayList92.get(i24)).store_product.equals(mVar3.c)) {
                                                                    ...
                                                                    switch (i172) {
                                                                        case 0:
                                                                            ...
                                                                            if (hVar222.a != 0) {
                                                                                ...
                                                                                t7 t7Var622 = t7Var62;
                                                                                if (t7Var622.m != null) {
                                                                                    for (int i192 = 0; i192 < t7Var622.m.size(); i192++) {
                                                                                        TL_stars.TL_starsGiftOption tL_starsGiftOption2 = (TL_stars.TL_starsGiftOption) t7Var622.m.get(i192);
                                                                                        if (tL_starsGiftOption2 != null && tL_starsGiftOption2.loadingStorePrice) {
                                                                                            tL_starsGiftOption2.missingStorePrice = true;
                                                                                        }
                                                                                    }
                                                                                }
                                                                                NotificationCenter.getInstance(t7Var622.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiftOptionsLoaded, new Object[0]);
                                                                                break;
                                                                            }
                                                                            break;
                                                                        case 1:
                                                                                    ...
                                                                                    for (int i1722 = 0; i1722 < list2.size(); i1722++) {
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i1822 >= arrayList722.size()) {
                                                                                                tL_starsGiftOption = null;
                                                                                            } else if (((TL_stars.TL_starsGiftOption) arrayList722.get(i1822)).store_product.equals(mVar.c)) {
                                                                                    ...
                                                                                    for (int i20 = 0; i20 < list3.size(); i20++) {
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i21 >= arrayList822.size()) {
                                                                                                tL_starsGiveawayOption = null;
                                                                                            } else if (((TL_stars.TL_starsGiveawayOption) arrayList822.get(i21)).store_product.equals(mVar2.c)) {
                                            ...
                                            b6.h hVar3 = new b6.h();
                                            hVar3.c = "inapp";
                                            hVar3.b = ((TL_stars.TL_starsGiveawayOption) arrayList9.get(i18)).store_product;
            ...
            case 3:
                ...
                boolean z10 = tLObject4 instanceof Vector;
                final t7 t7Var4 = this.b;
                if (z10) {
                ...
                t7Var4.m = arrayList4;
                t7Var4.k = false;
                NotificationCenter.getInstance(t7Var4.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiftOptionsLoaded, new Object[0]);
                if (!arrayList5.isEmpty()) {
                    final int i15 = 1;
                    Runnable runnable2 = new Runnable() { // from class: mh.x6
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i15) {
                                case 0:
                                    ...
                                    while (true) {
                                        ...
                                        if (i142 >= arrayList52.size()) {
                                            ...
                                            billingController.queryProductDetails(arrayList42, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: mh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final p2.h hVar22, final List list) {
                                                    switch (i152) {
                                                        case 0:
                                                                    ...
                                                                    switch (i162) {
                                                                        case 0:
                                                                            ...
                                                                            if (hVar222.a != 0) {
                                                                                ...
                                                                                if (t7Var622.m != null) {
                                                                                    for (int i192 = 0; i192 < t7Var622.m.size(); i192++) {
                                                                                        TL_stars.TL_starsGiftOption tL_starsGiftOption22 = (TL_stars.TL_starsGiftOption) t7Var622.m.get(i192);
                                            ...
                                            b6.h hVar = new b6.h();
                                            hVar.c = "inapp";
                                            hVar.b = ((TL_stars.TL_starsTopupOption) arrayList52.get(i142)).store_product;
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i16 >= arrayList7.size()) {
                                            ...
                                            final int i17 = 2;
                                            final t7 t7Var5 = t7Var4;
                                            billingController2.queryProductDetails(arrayList62, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: mh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final p2.h hVar22, final List list) {
                                                    switch (i17) {
                                                        case 0:
            ...
            case 4:
                ...
                boolean z11 = tLObject5 instanceof Vector;
                final t7 t7Var5 = this.b;
                if (z11) {
                ...
                t7Var5.p = arrayList7;
                t7Var5.n = false;
                NotificationCenter.getInstance(t7Var5.a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starGiveawayOptionsLoaded, new Object[0]);
                if (!arrayList8.isEmpty()) {
                    final int i17 = 2;
                    Runnable runnable3 = new Runnable() { // from class: mh.x6
                        @Override // java.lang.Runnable
                        public final void run() {
                            switch (i17) {
                                case 0:
                                                                    ...
                                                                    switch (i162) {
                                                                        ...
                                                                        case 1:
                                                                            ...
                                                                            if (hVar3.a != 0) {
                                                                                ...
                                                                                if (t7Var72.p != null) {
                                                                                    for (int i22 = 0; i22 < t7Var72.p.size(); i22++) {
                                                                                        TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption22 = (TL_stars.TL_starsGiveawayOption) t7Var72.p.get(i22);
                                ...
                                case 1:
                                    ...
                                    while (true) {
                                        ...
                                        if (i162 >= arrayList72.size()) {
                                                                            ...
                                                                            if (hVar222.a != 0) {
                                                                                ...
                                                                                if (list2 != null) {
                                                                                    for (int i17222 = 0; i17222 < list2.size(); i17222++) {
                                                                                        p2.m mVar = (p2.m) list2.get(i17222);
                                                                                        int i1822 = 0;
                                                                                        while (true) {
                                                                                            ArrayList arrayList7222 = arrayList722;
                                                                                            if (i1822 >= arrayList7222.size()) {
                                                                                                tL_starsGiftOption2 = null;
                                                                                            } else if (((TL_stars.TL_starsGiftOption) arrayList7222.get(i1822)).store_product.equals(mVar.c)) {
                                            ...
                                            b6.h hVar2 = new b6.h();
                                            hVar2.c = "inapp";
                                            hVar2.b = ((TL_stars.TL_starsGiftOption) arrayList72.get(i162)).store_product;
                                            arrayList62.add(hVar2.a());
                                            i162++;
                                        }
                                    }
                                default:
                                    ...
                                    while (true) {
                                        ...
                                        if (i18 >= arrayList92.size()) {
                                            ...
                                            final int i19 = 0;
                                            final t7 t7Var6 = t7Var5;
                                            billingController3.queryProductDetails(arrayList82, new BillingController.ProductDetailsResponseListenerLegacy() { // from class: mh.v5
                                                @Override // org.telegram.messenger.BillingController.ProductDetailsResponseListenerLegacy
                                                public final void onProductDetailsResponse(final p2.h hVar22, final List list) {
                                                    switch (i19) {
                                                        case 0:
                                                                                    ...
                                                                                    for (int i23 = 0; i23 < list4.size(); i23++) {
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i24 >= arrayList922.size()) {
                                                                                                tL_starsTopupOption2 = null;
                                                                                            } else if (((TL_stars.TL_starsTopupOption) arrayList922.get(i24)).store_product.equals(mVar3.c)) {
                                                                                    ...
                                                                                    for (int i20 = 0; i20 < list3.size(); i20++) {
                                                                                        ...
                                                                                        while (true) {
                                                                                            ...
                                                                                            if (i21 >= arrayList8222.size()) {
                                                                                                tL_starsGiveawayOption2 = null;
                                                                                            } else if (((TL_stars.TL_starsGiveawayOption) arrayList8222.get(i21)).store_product.equals(mVar2.c)) {
                                            ...
                                            b6.h hVar3 = new b6.h();
                                            hVar3.c = "inapp";
                                            hVar3.b = ((TL_stars.TL_starsGiveawayOption) arrayList92.get(i18)).store_product;
