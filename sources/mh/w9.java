...
public final class w9 extends FrameLayout {
    ...
    public w9(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        this.r = new org.telegram.ui.Components.z5(this, 0L, 500L, pr.h);
        this.a = g6Var;
        Drawable mutate = context.getResources().getDrawable(R.drawable.star_small_outline).mutate();
        this.b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.h5, g6Var), PorterDuff.Mode.SRC_IN));
        ...
        k6Var.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.z6, g6Var));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.h) {
            ...
            canvas.drawRect(LocaleController.isRTL ? 0.0f : AndroidUtilities.dp(22.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.dp(22.0f) : 0), getMeasuredHeight(), F);
        }
    }
