...
public final /* synthetic */ class r8 implements View.OnClickListener {
    ...
    public /* synthetic */ r8(eb ebVar, MessageObject messageObject, xn xnVar, int i10, boolean z4, Context context, org.telegram.ui.ActionBar.g6 g6Var, long j10, TLRPC.Chat chat) {
        this.f = ebVar;
        ...
        switch (this.a) {
            case 0:
                ...
                if (!dVar.K) {
                    ...
                    long j10 = this.e;
                    lh.x xVar = new lh.x(dVar, starsSubscription, i10, h3VarArr, j10, 2);
                    ...
                    if ((ebVar.M != null || (messageObject != null && xnVar != null)) && ebVar.S == null) {
                        ...
                        if (!MessagesController.getInstance(i11).isFrozen()) {
                            ...
                            if (y11.e && y11.p().amount < value) {
                                ...
                                long j11 = this.e;
                                if (!z4) {
                                    new z9(context, g6Var, value, 5, chat == null ? "" : chat.title, g1Var, j11).show();
                                    break;
                                } else {
                                    new z9(context, g6Var, value, 17, DialogObject.getShortName(i11, j11), g1Var, j11).show();
                                    break;
                                }
                            } else {
                                g1Var.run();
    ...
    public /* synthetic */ r8(qh.d dVar, int i10, TL_stars.StarsSubscription starsSubscription, org.telegram.ui.ActionBar.h3[] h3VarArr, long j10, Activity activity, org.telegram.ui.ActionBar.g6 g6Var, boolean z4, String str) {
        this.f = dVar;
        this.b = i10;
