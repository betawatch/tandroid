...
public final /* synthetic */ class k6 implements Utilities.Callback {
    ...
    public /* synthetic */ k6(t7 t7Var, long j10, boolean[] zArr, Utilities.Callback callback, Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4, String str, MessageObject messageObject, TLRPC.InputInvoice inputInvoice, TLRPC.TL_payments_paymentFormStars tL_payments_paymentFormStars, int i10, long j11) {
        this.a = t7Var;
        this.b = j10;
        this.c = zArr;
        this.d = callback;
    ...
    public final void run(Object obj) {
        ...
        if (starsPurchaseAvailable) {
            boolean[] zArr2 = {false};
            z9 z9Var = new z9(context, g6Var, j11, this.g ? 9 : 0, this.h, new s6(t7Var, zArr2, messageObject, inputInvoice, tL_payments_paymentFormStars, zArr, i10, callback2, callback), this.m);
