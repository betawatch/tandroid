...
public final class f5 extends View {
    ...
    public f5(Activity activity, org.telegram.ui.ActionBar.g6 g6Var) {
        super(activity);
        this.c = new xd.a(this, pr.h, 380L);
        this.b = new Paint(1);
        this.d = g6Var;
    ...
    public final void onDraw(Canvas canvas) {
        switch (this.a) {
            ...
            default:
                ...
                float f12 = 1.0f - f11;
                if (f12 > 0.0f) {
                    lf.r.b(canvas, (h51) this.e, f12 * 1.35f);
                    invalidate();
                }
                if (f11 > 0.0f) {
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.a) {
            case 2:
                ...
                lf.r.d((h51) this.e, i10 / 2.0f, i11 / 2.0f, 17);
                break;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                break;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.a) {
            case 2:
                return super.verifyDrawable(drawable) || (drawable == ((h51) this.e) && !((xd.a) this.c).f);
            default:
    ...
    public f5(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.e = new RectF();
        paint2.setColor(-1);
        paint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.d6, g6Var));
