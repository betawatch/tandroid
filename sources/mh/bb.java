...
public abstract class bb extends View {
    ...
    public bb(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        this.b = new Paint(1);
        this.c = new Paint(1);
        this.d = new Paint(1);
        ...
        this.V = new Path();
        this.W = 0.0f;
        this.c0 = new xd.a(this, prVar, 320L);
        this.a = g6Var;
        ...
        j6Var2.b = 17;
        paint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.h5, g6Var));
    ...
    public final void a(float f10) {
        ...
        this.i0 = ofFloat;
        ofFloat.addUpdateListener(new eg.m1(this, 17));
        int value = getValue();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int l1 = org.telegram.ui.ActionBar.k6.l1(0.15f, this.r);
        Paint paint4 = this.b;
        paint4.setColor(l1);
        ...
        if (j10 == -1 || b((int) j10) >= 1.0f || b((int) this.M) <= 0.0f) {
            ...
            i10 = d;
            z5Var2 = z5Var4;
            canvas.drawLine(clamp01, AndroidUtilities.lerp(rectF2.top, rectF2.centerY(), e6), clamp01, AndroidUtilities.lerp(rectF2.bottom, rectF2.centerY(), e6), paint5);
            direction = direction2;
            paint2 = paint5;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.g0) {
            ...
            if (!this.h0 && motionEvent.getPointerId(0) == this.g0 && k7.o6.a(this.d0, this.e0, motionEvent.getX(), motionEvent.getY()) < AndroidUtilities.touchSlop && System.currentTimeMillis() - this.f0 <= ViewConfiguration.getTapTimeout() * 1.5f) {
