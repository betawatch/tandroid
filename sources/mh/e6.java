...
public final /* synthetic */ class e6 implements Runnable {
    ...
    public /* synthetic */ e6(t7 t7Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.g6 g6Var, long j10, String str, long j11, TLObject tLObject2, TLRPC.TL_textWithEntities tL_textWithEntities) {
        this.b = t7Var;
        this.c = tLObject;
        this.d = tL_error;
        this.e = callback2;
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                        if (!MessagesController.getInstance(t7Var.a).starsPurchaseAvailable()) {
                            ...
                            boolean[] zArr = {false};
                            z9 z9Var = new z9(context, g6Var, j10, 6, str, new n2(t7Var, zArr, tL_payments_paymentFormStarGift, starGift, j11, callback2), 0L);
                ...
                if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                        if (!MessagesController.getInstance(t7Var2.a).starsPurchaseAvailable()) {
                            ...
                            boolean[] zArr2 = {false};
                            z9 z9Var2 = new z9(context2, g6Var2, j12, 6, str2, new n2(t7Var2, zArr2, j13, tLObject3, tL_textWithEntities, callback22), 0L);
                    ...
                    if (launchActivity2 != null && (xa0Var2 = launchActivity2.u0) != null) {
                        xa0Var2.c(true);
                        break;
                    }
                }
    ...
    public /* synthetic */ e6(t7 t7Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.g6 g6Var, long j10, String str, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j11) {
        this.b = t7Var;
        this.c = tLObject;
        this.d = tL_error;
        this.e = callback2;
