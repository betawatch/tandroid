...
public final /* synthetic */ class y1 implements Runnable {
    ...
    public /* synthetic */ y1(c3 c3Var, int i9) {
        this.a = i9;
        this.b = c3Var;
    }
        ...
        switch (i9) {
            ...
            case 1:
                if (!c3Var.Y && c3Var.F != 0) {
                    ...
                    ConnectionsManager.getInstance(c3Var.C).sendRequest(tL_messages_prolongWebView, new i2(c3Var, i10));
                    break;
                }
                break;
            case 2:
            ...
            case 7:
                ...
                c3Var.e.invalidate();
                c3Var.x.n(false, false);
                if (c3Var.c != null) {
                    float f10 = (1.0f - (Math.min(t2Var.getTopActionBarOffsetY(), t2Var.getTranslationY() - t2Var.getTopActionBarOffsetY()) / t2Var.getTopActionBarOffsetY()) <= 0.5f ? 0 : 1) * 100.0f;
                    o1.j jVar = c3Var.c;
                    o1.k kVar = jVar.u;
                    if (((float) kVar.i) != f10) {
                        kVar.i = f10;
