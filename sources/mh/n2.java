...
public final /* synthetic */ class n2 implements Runnable {
    ...
    public /* synthetic */ n2(Object obj, Object obj2, long j10, Object obj3, Object obj4, Object obj5, int i10) {
        this.a = i10;
        this.d = obj;
        this.c = obj2;
        this.b = j10;
    ...
    */
    public final void run() {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                oh.l7 l7Var = (oh.l7) obj5;
                TLObject tLObject = (TLObject) obj4;
                View view = (View) obj3;
                oh.i7 i7Var = (oh.i7) obj;
                ...
                if (tLObject != null) {
                    ...
                    if (!peerStories.stories.isEmpty()) {
                        ...
                        j10 = j11;
                        oh.m7.n(peerStories, new b2(l7Var, view, j11, i7Var, 11));
                        z4 = false;
            ...
            default:
                ...
                if (p2Var.getContext() != null) {
                    if (tLObject2 instanceof TL_chatlists.TL_chatlists_exportedInvites) {
                        ...
                        new o00(p2Var, dialogFilter, tL_chatlists_exportedInvites.invites).show();
                        ...
                        new o00(p2Var, dialogFilter, null).show();
                    }
                    if (runnable != null) {
    ...
    public /* synthetic */ n2(g5 g5Var, TLObject tLObject, String str, TL_stars.InputSavedStarGift inputSavedStarGift, TLRPC.TL_error tL_error, long j10) {
        this.a = 0;
        this.d = g5Var;
        this.c = tLObject;
        this.e = str;
    ...
    public /* synthetic */ n2(t7 t7Var, boolean[] zArr, long j10, TLObject tLObject, TLRPC.TL_textWithEntities tL_textWithEntities, Utilities.Callback2 callback2) {
        this.a = 1;
        this.d = t7Var;
        this.e = zArr;
        this.b = j10;
    ...
    public /* synthetic */ n2(t7 t7Var, boolean[] zArr, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j10, Utilities.Callback2 callback2) {
        this.a = 2;
        this.d = t7Var;
        this.c = zArr;
    ...
    public /* synthetic */ n2(ConnectionsManager connectionsManager, RequestDelegate requestDelegate, TLObject tLObject, TLRPC.TL_error tL_error, RequestDelegateTimestamp requestDelegateTimestamp, long j10) {
        this.a = 4;
    ...
    public /* synthetic */ n2(org.telegram.ui.ActionBar.p2 p2Var, TLObject tLObject, MessagesController.DialogFilter dialogFilter, TLRPC.TL_error tL_error, Runnable runnable, long j10) {
        this.a = 6;
        this.d = p2Var;
        this.c = tLObject;
        this.e = dialogFilter;
