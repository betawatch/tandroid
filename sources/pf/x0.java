...
public final class x0 extends FrameLayout {
    ...
    public x0(Context context, c6 c6Var) {
        ...
        this.b = a9Var;
        a9Var.l = true;
        a9Var.p = AndroidUtilities.dp(75.0f);
        a9Var.o = AndroidUtilities.dp(48.0f);
        a9Var.x = true;
        a9Var.s = AndroidUtilities.dp(22.0f);
        int i10 = 0;
        while (i10 < 2) {
    ...
    public final boolean a(d6 d6Var) {
        ...
        while (true) {
            ...
            MessageObject messageObject = (MessageObject) d6Var.i.get(i10);
            long j10 = messageObject.storyItem.dialogId;
            TextUtils.isEmpty(str);
            a9Var.l(i11, messageObject.storyItem, d6Var.c);
            i11++;
            i10++;
        }
        a9Var.k(i11);
        ...
        if (isEmpty) {
            ...
            textViewArr[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagStoriesFoundChannel", d6Var.J, "@" + str), g6.v0(g6.Oh, this.a), null));
        }
    ...
    public final void b(int i10, String str, String str2) {
        ...
        if (isEmpty) {
            ...
            textViewArr[1].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagMessagesFoundChannel", i10, s3.c.e("@", str2)), g6.v0(g6.Oh, this.a), null));
        }
