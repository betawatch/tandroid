...
public final class m1 extends FrameLayout {
    ...
    public m1(Context context, b6 b6Var, boolean z10) {
        ...
        uVar.setTextColor(f6.v0(f6.z6, b6Var));
        uVar.setTextSize(1, 14.0f);
        boolean z11 = LocaleController.isRTL;
        addView(uVar, e6.d(-1, -2.0f, 7, z11 ? i9 : 64.0f, 7.0f, z11 ? 64.0f : i9, 0.0f));
        if (z10) {
            ...
            addView(imageView, e6.e(50, 50, (LocaleController.isRTL ? 3 : 5) | 112));
        } else {
            this.e = null;
        }
    ...
    public final void a(q1 q1Var, String str, boolean z10) {
        ...
        TLRPC.Photo photo2;
        String str3 = str;
        this.h = q1Var != null ? q1Var.g : false;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (str3 != null && str3.length() > 0 && !str3.startsWith("/")) {
            str3 = "/".concat(str3);
        }
        spannableStringBuilder.append((CharSequence) "/").append((CharSequence) q1Var.b);
        ...
        if (str3 != null) {
            spannableStringBuilder.setSpan(new ForegroundColorSpan(f6.v0(f6.o6, b6Var)), 0, Math.min(str3.length() <= 0 ? 1 : str3.length(), spannableStringBuilder.length()), 33);
        }
        MessageObject messageObject = q1Var.e;
        dh.u uVar = this.c;
        if (messageObject != null) {
            spannableStringBuilder.append((CharSequence) " ");
            CharSequence charSequence = q1Var.e.caption;
            if (TextUtils.isEmpty(charSequence)) {
                charSequence = q1Var.e.messageText;
            }
            ...
            TLRPC.Message message = q1Var.e.messageOwner;
            if (message != null) {
        ...
        if (q1Var.a() > 1) {
            ...
            int dp2 = (int) (((nz0) zVar.c).c + AndroidUtilities.dp(10.0f));
            this.n[0] = dp2;
            spannableString.setSpan(zVar, 0, spannableString.length(), 33);
            SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(TextUtils.ellipsize(spannableStringBuilder, uVar.getPaint(), (dp * 1.5f) - r12[0], TextUtils.TruncateAt.END));
        ...
        TLRPC.MessageMedia media = MessageObject.getMedia(q1Var.e);
        ...
        if (media != null && (photo2 = media.photo) != null) {
            ...
            MessageObject messageObject2 = q1Var.e;
        ...
        } else if (media != null && media.document != null && (q1Var.e.isVideo() || q1Var.e.isSticker())) {
            ...
            long j11 = j10;
            MessageObject messageObject3 = q1Var.e;
            ...
            imageReceiver.setImage(ImageLocation.getForObject(closestPhotoSizeWithSize3, media.webpage.photo), "36_36", q1Var.e.strippedThumb, closestPhotoSizeWithSize3 != null ? closestPhotoSizeWithSize3.size : 0L, (String) null, media.webpage, 0);
            imageReceiver.setRoundRadius(AndroidUtilities.dp(4.0f));
        }
        this.r = z10;
        invalidate();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.r) {
            Paint T0 = f6.T0("paintDivider", this.f);
            if (T0 == null) {
                T0 = f6.k0;
            }
    ...
    public final void onMeasure(int i9, int i10) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i9), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f) + (this.r ? 1 : 0), TLObject.FLAG_30));
    }
