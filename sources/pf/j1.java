...
public class j1 {
    ...
    public final void a(CharSequence charSequence) {
        ...
        while (matcher.find()) {
            ...
            h1 h1Var = (h1) this.r.get(charSequence2);
            if (h1Var == null) {
                h1Var = new h1();
                h1Var.a = charSequence2;
                this.r.put(charSequence2, h1Var);
            } else {
                this.q.remove(h1Var);
            }
            h1Var.b = (int) (System.currentTimeMillis() / 1000);
            this.q.add(0, h1Var);
            z10 = true;
        }
        if (z10) {
            MessagesStorage.getInstance(this.m).getStorageQueue().postRunnable(new zh1(17, this, this.q));
        }
    }
        ...
        if (z10) {
            if (str.length() <= 0) {
                ...
                while (i13 < arrayList6.size()) {
                    ...
                    atomicInteger2.set(ConnectionsManager.getInstance(i12).sendRequest(tLObject, new RequestDelegate() { // from class: pf.e1
                        ...
                        public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: pf.f1
                                ...
                                public final void run() {
                                    ...
                                    j1 j1Var2 = j1.this;
                                    ArrayList arrayList14 = j1Var2.b;
                                    if (arrayList14.contains(valueOf)) {
                                        ...
                                        if (incrementAndGet == arrayList15.size()) {
                                            ...
                                            j1Var2.i();
                                            ArrayList arrayList16 = j1Var2.k;
                                            if (arrayList16 != null) {
                                                j1Var2.f(arrayList16, j1Var2.l);
                                            }
                                            ArrayList arrayList17 = j1Var2.d;
                                            ArrayList arrayList18 = j1Var2.e;
                                            a0.h hVar4 = j1Var2.f;
                                            i1 i1Var = j1Var2.a;
                                            if (i1Var != null) {
                                                a0.h h02 = i1Var.h0();
                                                if (h02 != null) {
                                                    ...
                                                    for (int i20 = 0; i20 < m10; i20++) {
                                                        TLRPC.User user2 = (TLRPC.User) hVar4.f(h02.j(i20));
                                                        if (user2 != null) {
                                                ...
                                                if (J != null) {
                                                    ...
                                                    for (int i21 = 0; i21 < m11; i21++) {
                                                        TLRPC.User user3 = (TLRPC.User) hVar4.f(J.j(i21));
                                                        if (user3 != null) {
            ...
            arrayList6.add(new Pair(tL_contacts_search, new RequestDelegate() { // from class: pf.d1
                ...
                */
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    ...
                    boolean z26 = j1Var.o;
                    int i17 = j1Var.m;
                    ArrayList arrayList12 = j1Var.d;
                    ArrayList arrayList13 = j1Var.e;
                    a0.h hVar7 = j1Var.f;
                    if (j1Var.a.D0(i11) && tL_error == null) {
                        ...
                        while (true) {
                            ...
                            while (i21 < arrayList11.size()) {
                                ...
                                if (chat2 != null) {
                                    if (z21 && ((!z22 || ChatObject.canAddBotsToChat(chat2)) && ((j1Var.p || !ChatObject.isNotInChat(chat2)) && j1Var.d(chat2)))) {
                        ...
                        if (!z26) {
                            ...
                            while (i23 < tL_contacts_found2.my_results.size()) {
                                ...
                                if (chat == null) {
                                    ...
                                    hVar5 = hVar9;
                                    if (user2 != null && !z22 && ((z23 || !user2.bot) && ((z24 || !user2.self) && user2.id != j18 && j1Var.d(user2)))) {
