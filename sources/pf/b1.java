    ...
    public b1(Context context, b6 b6Var) {
        ...
        for (int i10 = 7; i9 < i10; i10 = 7) {
            if (i9 == 0) {
                ...
                this.h[i9].setTextSize(1, 13.0f);
                this.h[i9].setTextColor(f6.v0(f6.z6, b6Var));
                b81Var.addView(this.h[i9], e6.i(-2.0f, -2.0f, 8388659, 0.0f, 33.0f, 0.0f, 10.0f));
                LinearLayout linearLayout = new LinearLayout(context);
                this.v = linearLayout;
                linearLayout.setOrientation(1);
                this.s = new FrameLayout(context);
                this.n[i9] = new TextView[2];
                for (int i11 = 0; i11 < 2; i11++) {
                    this.n[i9][i11] = new TextView(context);
                    this.n[i9][i11].setTextSize(1, 14.0f);
                    this.n[i9][i11].setTextColor(f6.v0(f6.z6, b6Var));
                    this.n[i9][i11].setGravity(LocaleController.isRTL ? 3 : 5);
                    this.s.addView(this.n[i9][i11], e6.i(-1.0f, -1.0f, 119, 0.0f, 0.0f, 20.0f, 0.0f));
                }
                for (int i12 = 0; i12 < 2; i12++) {
                    this.c[i12] = new TextView(context);
                    this.c[i12].setTextSize(1, 14.0f);
                    this.c[i12].setTextColor(f6.v0(f6.z6, b6Var));
                    this.c[i12].setGravity(LocaleController.isRTL ? 3 : 5);
                    this.s.addView(this.c[i12], e6.i(-1.0f, -1.0f, 119, 0.0f, 0.0f, 20.0f, 0.0f));
                }
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(f6.v0(f6.z6, b6Var), PorterDuff.Mode.SRC_IN));
                this.s.addView(imageView, e6.h(20.0f, 20.0f, 8388629));
                this.v.addView(this.s, new LinearLayout.LayoutParams(e6.z(-1.0f), e6.z(-1.0f), Gravity.getAbsoluteGravity(119, LocaleController.isRTL ? 1 : 0)));
                ...
                tpVar.setGravity(LocaleController.isRTL ? 3 : 5);
                int dp = AndroidUtilities.dp(8.0f);
                int i13 = f6.o6;
                int v02 = f6.v0(i13, b6Var);
                a(v02);
                int l1 = f6.l1(0.1f, v02);
                int v03 = f6.v0(i13, b6Var);
                a(v03);
                int l12 = f6.l1(0.22f, v03);
                tpVar.setBackground(f6.i0(dp, dp, dp, dp, l1, l12, l12));
                int v04 = f6.v0(i13, b6Var);
                a(v04);
                ...
                ViewGroup f10 = ll.f(context, 0);
                this.h[i9] = new TextView(context);
                this.h[i9].setTextSize(1, 14.0f);
                this.h[i9].setTextColor(f6.v0(f6.G6, b6Var));
                this.h[i9].setGravity(LocaleController.isRTL ? 5 : 3);
                FrameLayout frameLayout2 = new FrameLayout(context);
                this.n[i9] = new TextView[2];
                for (int i14 = 0; i14 < 2; i14++) {
                    this.n[i9][i14] = new TextView(context);
                    this.n[i9][i14].setTextSize(1, 14.0f);
                    this.n[i9][i14].setTextColor(f6.v0(f6.z6, b6Var));
                    this.n[i9][i14].setGravity(LocaleController.isRTL ? 3 : 5);
                    frameLayout2.addView(this.n[i9][i14], e6.e(-1, -1, 119));
                }
                if (LocaleController.isRTL) {
                    f10.addView(frameLayout2, e6.q(-2, -1, 51));
                    f10.addView(this.h[i9], e6.q(-1, -1, 53));
                } else {
                    f10.addView(this.h[i9], e6.q(-2, -1, 51));
                    f10.addView(frameLayout2, e6.q(-1, -1, 53));
                }
                this.f[i9] = f10;
                addView(f10, e6.u(-1.0f, -2.0f, 51, 18.0f, i9 == 1 ? 1.0f : 11.66f, 28.0f, i9 == 6 ? 16.66f : 0.0f));
            }
            i9++;
        }
    ...
    */
    public final void b(TL_account.TL_businessWorkHours tL_businessWorkHours, boolean z10, boolean z11, boolean z12) {
        ...
        if (!tL_businessWorkHours.weekly_open.isEmpty()) {
            ...
            int i23 = 0;
            while (true) {
                if (i22 < tL_businessWorkHours.weekly_open.size()) {
                    TL_account.TL_businessWeeklyOpen tL_businessWeeklyOpen = tL_businessWorkHours.weekly_open.get(i22);
                    if (tL_businessWeeklyOpen.start_minute > i23 + 1) {
                        break;
                    }
                    i23 = tL_businessWeeklyOpen.end_minute;
                    i22++;
                } else if (i23 >= 10079) {
                    z13 = true;
                }
            ...
            TLRPC.TL_timezone a2 = u1.b(UserConfig.selectedAccount).a(tL_businessWorkHours.timezone_id);
            ...
            if (z14) {
                ...
                textViewArr3[1].animate().alpha((z18 || !z19) ? 0.0f : 1.0f).setDuration(320L).setInterpolator(grVar).start();
                textViewArr[0][0].animate().alpha(z18 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(grVar).start();
                textViewArr[0][1].animate().alpha(z18 ? 1.0f : 0.0f).setDuration(320L).setInterpolator(grVar).start();
                imageView.animate().rotation(z18 ? 180.0f : 0.0f).setDuration(320L).setInterpolator(grVar).start();
            } else {
            ...
            while (i10 < textViewArr.length) {
                int i25 = 0;
                while (true) {
                    TextView[] textViewArr4 = textViewArr[i10];
                    if (i25 < textViewArr4.length) {
                        if (i10 != 0 || z18) {
                            if ((i25 == i21) == z19) {
                                f11 = 1.0f;
                                if (this.y) {
                                    textViewArr4[i25].animate().alpha(f11).setDuration(320L).setInterpolator(gr.h).start();
                                } else {
                                    textViewArr4[i25].setAlpha(f11);
                                }
                                i25++;
                                i21 = 1;
                            }
            ...
            tpVar.c(LocaleController.getString(!z19 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
            this.y = false;
            ArrayList[] Y = y0.Y(new ArrayList(tL_businessWorkHours.weekly_open));
            int i26 = (calendar.get(7) + 5) % 7;
            ...
            while (i11 < arrayList.size()) {
                ...
                boolean z20 = z18;
                if (offset != 0) {
                    int i29 = tL_businessWeeklyOpen2.start_minute;
                    z17 = z13;
                    int i30 = i29 % 1440;
                    int i31 = tL_businessWeeklyOpen2.end_minute;
                    arrayListArr2 = Y;
                    int i32 = (i31 - i29) + i30;
                    if (i30 == 0) {
                        i19 = i28;
                        if (i32 == 1440 || i32 == 1439) {
                            tL_businessWeeklyOpen3.start_minute = i29;
                            tL_businessWeeklyOpen3.end_minute = i31;
                        ...
                        arrayList2.add(tL_businessWeeklyOpen3);
                        i20 = tL_businessWeeklyOpen3.start_minute;
                        if (i20 >= 0) {
                            int i33 = tL_businessWeeklyOpen3.end_minute;
                            if (i33 < 0) {
                                tL_businessWeeklyOpen3.start_minute = i20 + 10080;
            ...
            boolean z21 = z18;
            boolean z22 = z13;
            ArrayList[] arrayListArr3 = Y;
            Collections.sort(arrayList2, new jn0(21));
            int i35 = (i26 * 1440) + (i27 * 60) + i28;
            for (i12 = 0; i12 < arrayList2.size(); i12++) {
                ...
                int i36 = tL_businessWeeklyOpen6.start_minute;
                if ((i35 >= i36 && i35 <= tL_businessWeeklyOpen6.end_minute) || (((i17 = i35 + 10080) >= i36 && i17 <= tL_businessWeeklyOpen6.end_minute) || (i35 - 10080 >= i36 && i18 <= tL_businessWeeklyOpen6.end_minute))) {
                    z15 = true;
                    break;
                }
            }
            z15 = false;
            ArrayList[] Y2 = y0.Y(arrayList2);
            ...
            textView.setTextColor(f6.v0(!z15 ? f6.l8 : f6.p7, this.a));
            int i37 = this.x;
            i13 = this.w;
            this.w = 1;
            this.x = 0;
            i14 = 0;
            while (i14 < 2) {
                ArrayList[] arrayListArr4 = i14 == 0 ? arrayListArr3 : Y2;
                int i38 = 0;
                while (i38 < 7) {
                    int i39 = (i26 + i38) % 7;
                    TextView[] textViewArr5 = this.h;
                    if (i38 == 0) {
                        textViewArr5[i38].setText(LocaleController.getString(R.string.BusinessHoursProfile));
                        arrayListArr = Y2;
                        z16 = z15;
                        i15 = i26;
                    } else {
                        ...
                        textViewArr5[i38].setText(sb2.toString());
                        textViewArr[i38][0].setVisibility(z21 ? 0 : 4);
                        textViewArr[i38][1].setVisibility(z21 ? 0 : 4);
                        textViewArr5[i38].setVisibility(z21 ? 0 : 4);
                    }
                    int i40 = 0;
                    while (true) {
                        if (i40 < (i38 == 0 ? 2 : 1)) {
                            TextView textView2 = i40 == 0 ? textViewArr[i38][i14] : textViewArr3[i14];
                            if (i38 == 0 && !z16 && i40 == 1) {
                                int i41 = 0;
                                while (true) {
                                    ...
                                    i16 = ((TL_account.TL_businessWeeklyOpen) arrayList2.get(i41)).start_minute;
                                    if (i35 < i16) {
                                        break;
                                    } else {
                                        i41++;
                                ...
                                if (i16 == -1) {
                                    ...
                                    int i42 = i16 < i35 ? (10080 - i35) + i16 : i16 - i35;
                                    if (i42 < 60) {
                                        arrayList3 = arrayList2;
                                ...
                                } else if (arrayListArr4[i39].isEmpty()) {
                                    textView2.setText(LocaleController.getString(R.string.BusinessHoursProfileClose));
                                } else if (y0.b0(arrayListArr4[i39])) {
                                    textView2.setText(LocaleController.getString(R.string.BusinessHoursProfileOpen));
                                } else {
                                    StringBuilder sb3 = new StringBuilder();
                                    for (int i43 = 0; i43 < arrayListArr4[i39].size(); i43++) {
                                        if (i43 > 0) {
                                            sb3.append("\n");
                                        }
                                        sb3.append(arrayListArr4[i39].get(i43));
                                    }
                                    int size = arrayListArr4[i39].size();
            ...
            f10 = 6.0f;
            layoutParams.topMargin = AndroidUtilities.dp((this.w <= 2 || tpVar.getVisibility() == 0) ? 6.0f : 12.0f);
            if (this.w <= 2 && tpVar.getVisibility() != 0) {
                f10 = 12.0f;
            }
            layoutParams.bottomMargin = AndroidUtilities.dp(f10);
            layoutParams.gravity = ((this.w <= 2 || tpVar.getVisibility() == 0) ? 16 : 80) | (!LocaleController.isRTL ? 3 : 5);
            if (i13 == this.w || i37 != this.x) {
                requestLayout();
            }
            return;
        }
        ...
        this.v.setTranslationX(!z13 ? AndroidUtilities.dp(11.0f) : 0.0f);
        TLRPC.TL_timezone a22 = u1.b(UserConfig.selectedAccount).a(tL_businessWorkHours.timezone_id);
        ...
        tpVar2.c(LocaleController.getString(!z19 ? R.string.BusinessHoursProfileSwitchMy : R.string.BusinessHoursProfileSwitchLocal), LocaleController.isRTL && !this.y, true);
        this.y = false;
        ArrayList[] Y3 = y0.Y(new ArrayList(tL_businessWorkHours.weekly_open));
        int i262 = (calendar2.get(7) + 5) % 7;
        int i272 = calendar2.get(11);
        int i282 = calendar2.get(12);
        arrayList = new ArrayList(tL_businessWorkHours.weekly_open);
        arrayList2 = new ArrayList(arrayList.size());
        i11 = 0;
        while (i11 < arrayList.size()) {
        ...
        boolean z212 = z18;
        boolean z222 = z13;
        ArrayList[] arrayListArr32 = Y3;
        Collections.sort(arrayList2, new jn0(21));
        int i352 = (i262 * 1440) + (i272 * 60) + i282;
        while (i12 < arrayList2.size()) {
        }
        z15 = false;
        ArrayList[] Y22 = y0.Y(arrayList2);
        ...
        textView3.setTextColor(f6.v0(!z15 ? f6.l8 : f6.p7, this.a));
        int i372 = this.x;
        i13 = this.w;
        this.w = 1;
        this.x = 0;
        ...
        f10 = 6.0f;
        layoutParams2.topMargin = AndroidUtilities.dp((this.w <= 2 || tpVar2.getVisibility() == 0) ? 6.0f : 12.0f);
        if (this.w <= 2) {
            f10 = 12.0f;
        }
        layoutParams2.bottomMargin = AndroidUtilities.dp(f10);
        layoutParams2.gravity = ((this.w <= 2 || tpVar2.getVisibility() == 0) ? 16 : 80) | (!LocaleController.isRTL ? 3 : 5);
        if (i13 == this.w) {
        }
        requestLayout();
    }
    ...
    public final void onMeasure(int i9, int i10) {
        ...
        if (!this.B) {
            ...
            if (i11 > 2 || tpVar.getVisibility() == 0) {
                dp = AndroidUtilities.dp(tpVar.getVisibility() == 0 ? 21.0f : 0.0f) + AndroidUtilities.dp(15.0f) + this.x;
            } else {
                dp = 0;
            }
            i10 = View.MeasureSpec.makeMeasureSpec(Math.max(dp2, dp) + (this.A ? 1 : 0), TLObject.FLAG_30);
        }
