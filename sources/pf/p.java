...
public final class p extends FrameLayout {
    ...
    public p(Context context, b6 b6Var) {
        ...
        int i9 = f6.z6;
        h5Var2.setTextColor(f6.w0(null, i9, false));
        ...
        uVar.setTextColor(f6.v0(i9, b6Var));
    ...
    public final void onMeasure(int i9, int i10) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i9), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(56.0f) + (this.e ? 1 : 0), TLObject.FLAG_30));
    }
}
