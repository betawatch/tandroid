...
public final class j extends FrameLayout {
    ...
    */
    public final void onMeasure(int i10, int i11) {
        ...
        int i14 = kVar.r;
        boolean z10 = i14 == 0 && kVar.h == 0 && MessagesController.getInstance(kVar.B).dialogs_dict.f(DialogObject.makeFolderDialogId(1)) != null;
        View view = (View) getParent();
        int i15 = view instanceof y9 ? ((y9) view).T2 : 0;
        boolean z11 = kVar.F;
        int paddingTop = view.getPaddingTop();
        int paddingBottom = view.getPaddingBottom();
        int i16 = paddingTop - i15;
        if (i14 == 1 && size == 1 && ((i) kVar.I.get(0)).a == 19) {
            ...
            if (size != 0 && (i16 != 0 || z10)) {
                ...
                for (int i19 = 0; i19 < size; i19++) {
                    if (((i) kVar.I.get(i19)).a == 0) {
                        if (((i) kVar.I.get(i19)).f && !z11) {
                            i18 += AndroidUtilities.dp(SharedConfig.useThreeLinesLayout ? 86.0f : 91.0f);
                        }
                        i18 += dp;
                    } else {
                        if (((i) kVar.I.get(i19)).a != 1) {
                        }
                        i18 += dp;
                    }
                }
                ...
                if (arrayList != null) {
                    i20 = y1.C(52.0f, (kVar.d.size() - 1) + (AndroidUtilities.dp(58.0f) * arrayList.size()), i20);
                }
                int i21 = z10 ? dp + 1 : 0;
                if (i20 < i17) {
