...
public final class t1 extends o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void T(t1 t1Var, l41 l41Var, View view) {
        ...
        if (view.isEnabled()) {
            ...
            if (i9 >= 0) {
                ...
                b10.g();
                TLRPC.TL_timezone tL_timezone = (TLRPC.TL_timezone) arrayList.get(l41Var.d);
                t1Var.h = false;
    ...
    public static void U(t1 t1Var, ArrayList arrayList, z41 z41Var) {
        boolean z10 = t1Var.d && !TextUtils.isEmpty(t1Var.e);
        u1 b10 = u1.b(t1Var.currentAccount);
        ...
        if (!z10) {
            ...
            z41Var.T();
            arrayList.add(l41.B(LocaleController.formatString(R.string.TimezoneDetectAutomaticallyInfo, b10.d(t1Var.n, true))));
        }
        z41Var.U();
        if (!z10) {
        ...
        while (true) {
            ...
            if (z10) {
                ...
                String lowerCase = AndroidUtilities.translitSafe(t1Var.e).toLowerCase();
                if (org.telegram.messenger.l0.w(" ", lowerCase, replace) || replace.startsWith(lowerCase)) {
                    e10 = AndroidUtilities.highlightText(e10, t1Var.e, t1Var.resourceProvider);
                } else {
                    i9++;
                }
            }
            ...
            l41Var2.l = e10;
            l41Var2.n = f10;
            l41Var2.K(TextUtils.equals(tL_timezone.id, t1Var.n));
            l41Var2.g = !t1Var.h || z10;
    ...
    public final View createView(Context context) {
        ...
        frameLayout.addView(this.a, e6.c(-1.0f, -1));
        this.a.setOnScrollListener(new kn(this, 20));
        ...
        this.b.addView(o9Var, e6.t(130, 130, 49, 0, 42, 0, 12));
        TextView textView = new TextView(context);
        textView.setText(LocaleController.getString(R.string.TimezoneNotFound));
        ll.n(f6.y6, this.resourceProvider, textView, 1, 15.0f);
        this.b.addView(textView, e6.t(-2, -2, 49, 0, 0, 0, 0));
    ...
    public final void didReceivedNotification(int i9, int i10, Object... objArr) {
        i51 i51Var;
        z41 z41Var;
        if (i9 != NotificationCenter.timezonesUpdated || (i51Var = this.a) == null || (z41Var = i51Var.U2) == null) {
            return;
        }
        z41Var.N(true);
    }
