...
public final class m0 extends c2.i {
    ...
    public final void c(ByteBuffer byteBuffer) {
        ...
        f71 f71Var = this.i;
        float[] fArr = f71Var.b;
        ByteBuffer byteBuffer2 = f71Var.c;
        FourierTransform.FFT fft = f71Var.a;
        g71 g71Var = f71Var.f;
        z61 z61Var = g71Var.K;
        Handler handler = g71Var.a0;
        if (z61Var != null) {
            if (order == c2.h.a || !g71Var.I) {
                handler.postDelayed(new x61(f71Var, 1), 80L);
            } else if (z61Var.needUpdate()) {
                ...
                if (limit > 8192) {
                    ...
                    if (i11 >= 1024) {
                        ...
                        if (System.currentTimeMillis() - f71Var.e >= 64) {
                            f71Var.e = System.currentTimeMillis();
                            handler.postDelayed(new ar0(17, f71Var, fArr2), 130L);
                        }
                    }
                }
            }
