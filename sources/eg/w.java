...
public final class w extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (limitPreviewView.G) {
            ...
            canvas.drawRoundRect(rectF2, f12, f12, z4 ? paint : limitPreviewView.b0 != null ? textPaint : r1.d().e());
            Paint e = r1.d().e();
            ...
            if (!limitPreviewView.O) {
                paint = limitPreviewView.b0 != null ? textPaint : r1.d().e();
            }
        ...
        if (limitPreviewView.b0 != null) {
            ...
            canvas.drawRect(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(10.0f), getMeasuredWidth() - AndroidUtilities.dp(12.0f), getMeasuredHeight() - AndroidUtilities.dp(10.0f), ((a6) ((org.telegram.ui.c1) limitPreviewView.b0).b).t0(getX(), getY()));
            canvas.restore();
        }
    }
