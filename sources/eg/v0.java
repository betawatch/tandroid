...
public class v0 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean b0;
    public boolean c0;
    public org.telegram.ui.Cells.t1 d0;
    public final int e0;
    ...
    public static void R(v0 v0Var, ArrayList arrayList, int i10, TLRPC.TL_messages_inactiveChats tL_messages_inactiveChats) {
        ...
        v0Var.M1();
        if (v0Var.i0 >= 0 && i11 != 0) {
            ((f2.i0) sl0Var.getLayoutManager()).h1(v0Var.i0 + 1, i11);
        }
        if (v0Var.J0 == null) {
    ...
    public static void V(v0 v0Var, Context context) {
        ...
        if (canApplyBoost.empty) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.CheckPhoneNumberYes), new c0(v0Var, i12));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new androidx.emoji2.text.w(i11));
        ...
        if (z4 && canApplyBoost.replaceDialogId == 0) {
            ...
            w1Var.show();
            w1Var.setOnHideListener(new d0(v0Var, i12));
            return;
        }
        if (!z4) {
            int i14 = canApplyBoost.floodWait;
            if (i14 != 0) {
                gg.r.g(i14);
                return;
            }
        ...
        alertDialog$Builder2.k(LocaleController.getString(R.string.Replace), new c0(v0Var, i13));
        alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), new z3.k());
    ...
    public final void F(qv0 qv0Var) {
        ...
        int i11 = 2;
        sl0Var.setOnItemClickListener(new dg.n(this, i11));
        sl0Var.setOnItemLongClickListener(new c0(this, i11));
    ...
    public final void K1() {
        ...
        if (i10 != 19 && i10 != 32 && !y1()) {
            ...
            g0 g0Var2 = this.B0;
            if (g0Var2.D == null) {
                uq uqVar = new uq(g0Var2.getContext(), null);
                g0Var2.D = uqVar;
                uqVar.setGravity(3);
                uq uqVar2 = g0Var2.D;
                int i11 = j6.Oh;
    ...
    public final void L1() {
        ...
        if (i10 == 18 || i10 == 20 || i10 == 24 || i10 == 25 || i10 == 26 || i10 == 29 || i10 == 22 || i10 == 23 || i10 == 21 || i10 == 27 || i10 == 28 || i10 == 30 || i10 == 35) {
            ...
            spannableStringBuilder.setSpan(new mq(R.drawable.msg_copy_filled, 0), 0, 1, 0);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (lastFragment instanceof mg.s) {
            ...
            org.telegram.ui.ActionBar.p2 p2Var2 = fragmentStack.size() >= 2 ? (org.telegram.ui.ActionBar.p2) yh.k(2, fragmentStack) : null;
            org.telegram.ui.ActionBar.p2 p2Var3 = fragmentStack.size() >= 3 ? (org.telegram.ui.ActionBar.p2) yh.k(3, fragmentStack) : null;
            r6 = fragmentStack.size() >= 4 ? (org.telegram.ui.ActionBar.p2) yh.k(4, fragmentStack) : null;
        ...
        if ((lastFragment instanceof xn) && booleanValue) {
        ...
        if ((lastFragment instanceof bd) && booleanValue) {
            ...
            for (int size = fragmentStack2.size() - 2; size >= 0; size--) {
                ...
                if ((p2Var4 instanceof xn) || (p2Var4 instanceof oy)) {
                    r6 = p2Var4;
                    break;
                }
        ...
        r6 = fragmentStack3.size() >= 2 ? (org.telegram.ui.ActionBar.p2) yh.k(2, fragmentStack3) : null;
        p2Var.finishFragment();
        dismiss();
        if (r6 instanceof xn) {
            gg.r.f(r6, chat, true);
    ...
    public final void m1(final h90 h90Var, boolean z4) {
        if (!h90Var.b() || z4) {
            h90Var.setLoading(true);
            ...
            Utilities.Callback<TL_stories.TL_premium_myBoosts> callback = new Utilities.Callback(this) { // from class: eg.e0
                ...
                public final void run(Object obj) {
                    switch (i11) {
                        case 0:
                            MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.X, new f0(this.b, h90Var, (TL_stories.TL_premium_myBoosts) obj, 0));
                            break;
                        default:
                            ...
                            if (startsWith) {
                                ...
                                if (intValue <= 5) {
                                    AndroidUtilities.runOnUIThread(new a1.e(25, this.b, h90Var2), intValue * 1000);
                                    break;
                                } else {
                                    gg.r.g(intValue);
                                }
                            }
                            h90Var2.setLoading(false);
                            break;
                    }
                }
            };
