...
public class e2 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void D(int i10, int i11) {
        ...
        while (true) {
            ...
            pw0 pw0Var = (pw0) arrayList.get(i12);
            zv0 zv0Var = this.a0;
            zv0Var.a(pw0Var, false);
            zv0Var.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_31));
    ...
    public void W(hb1 hb1Var) {
        hb1Var.addView(this.y0, b6.p(140, 140, 1.0f, 17, 10, 10, 10, 10));
    }
        ...
        if (tL_emojiStatusCollectible != null) {
            ...
            if (indexOf >= 0) {
                ...
                if (document != null) {
                    ...
                    spannableStringBuilder.setSpan(new j90(AndroidUtilities.dp(100.0f), this.L0[0]), 0, spannableStringBuilder.length(), 33);
                }
                ...
                this.L0[1].setOnLinkPressListener(new d90() { // from class: eg.v1
                ...
                if (document != null) {
                    ...
                    if (e90VarArr2 != null) {
                        e90VarArr2[1].setText(spannableStringBuilder2);
                        if (this.L0[1].getVisibility() != 0) {
                            if (z4) {
                                ...
                                this.L0[0].animate().alpha(0.0f).setInterpolator(nrVar).setDuration(200L).withEndAction(new u1(this, i10)).start();
            ...
            if (nVar == null) {
                ...
                if (starGift != null) {
                    ...
                    e90Var.setText(AndroidUtilities.replaceSingleLink(formatString2, num2 == null ? getThemedColor(j6.u6) : num2.intValue()));
                    org.telegram.ui.b.n(R.string.TelegramPremiumUserDialogSubtitle, this.M0);
                }
            } else if (this.Z) {
                e90 e90Var2 = e90VarArr[0];
                ...
                e90Var2.setText(AndroidUtilities.replaceSingleLink(formatString3, num3 == null ? getThemedColor(j6.u6) : num3.intValue()));
                e90 e90Var3 = this.M0;
                ...
                e90Var3.setText(AndroidUtilities.replaceSingleLink(formatString4, num4 == null ? getThemedColor(j6.u6) : num4.intValue()));
                ...
                e90Var4.setText(AndroidUtilities.replaceSingleLink(formatString5, num5 == null ? getThemedColor(j6.u6) : num5.intValue()));
                org.telegram.ui.b.n(R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle, this.M0);
            } else {
                e90 e90Var5 = this.L0[0];
                ...
                e90Var5.setText(AndroidUtilities.replaceSingleLink(formatString6, num6 == null ? getThemedColor(j6.u6) : num6.intValue()));
                org.telegram.ui.b.n(R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle, this.M0);
            }
        }
        try {
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        View view4 = this.x0;
        Drawable rightDrawable = view4 instanceof k5 ? ((k5) view4).getRightDrawable() : view4 instanceof org.telegram.ui.Cells.t1 ? ((org.telegram.ui.Cells.t1) view4).cc : null;
    ...
    public e2(org.telegram.ui.ActionBar.p2 p2Var, int i10, TLRPC.User user, n nVar, TL_stars.StarGift starGift, f6 f6Var) {
        ...
        this.X = nVar;
        this.Y = starGift;
        this.a0 = new zv0(getContext(), null);
