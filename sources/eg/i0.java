...
public final class i0 extends View implements xd.b {
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.a) {
                            ...
                            if (x9Var.n && !x9Var.k) {
                                if (x9Var.g == null || x9Var.l) {
                                    ...
                                    for (int i11 = 0; i11 < 2; i11++) {
                                        ...
                                        if (background == null) {
                                            background = f6Var2 instanceof vn ? ((vn) f6Var2).d() : j6.s0();
                                        }
            ...
            case 9:
                ...
                if (e70Var.d != null && e70Var.n.getVisibility() == 0 && e70Var.d.getImageReceiver().hasNotThumb()) {
                    paint7.setAlpha((int) (e70Var.n.getAlpha() * e70Var.d.getImageReceiver().getCurrentAlpha() * 85.0f));
            ...
            case 13:
                ...
                kVar = ((org.telegram.ui.ActionBar.p2) o81Var).actionBar;
                int height = kVar.getHeight();
                Rect rect = AndroidUtilities.rectTmp2;
                rect.set(0, 0, getMeasuredWidth(), height);
                Paint paint9 = (Paint) this.b;
                int i12 = j6.s8;
                f6Var = ((org.telegram.ui.ActionBar.p2) o81Var).resourceProvider;
                paint9.setColor(j6.v0(i12, f6Var));
                o81Var.b.J(canvas, 0.0f, rect, paint9, true);
            ...
            case 14:
                ...
                int currentItem = cd1Var.g0.getCurrentItem();
                Paint paint10 = (Paint) this.b;
                int i13 = j6.Ae;
                paint10.setColor(cd1Var.d ? j6.C0(i13) : cd1Var.getThemedColor(i13));
                int i14 = 0;
                while (i14 < 2) {
            ...
            case 15:
                ...
                e5Var = ((org.telegram.ui.ActionBar.p2) ((og1) this.c)).parentLayout;
    ...
    public void setTranslationY(float f10) {
        switch (this.a) {
            case 5:
                ...
                ((a30) this.c).d.setTranslationY(f10);
                break;
            default:
                super.setTranslationY(f10);
                break;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.a) {
            case 16:
                return drawable == ((mg0) this.c) || super.verifyDrawable(drawable);
            default:
    ...
    public i0(Context context, e5 e5Var) {
        super(context);
        this.a = 10;
        this.c = new xd.a(0, this, nr.h, 380L, true);
        this.b = e5Var;
    }
