...
public final class i0 extends LinearLayout {
    ...
    public /* synthetic */ i0(Context context, Object obj, LinearLayout linearLayout, int i10) {
        super(context);
        this.a = i10;
        this.b = obj;
        this.c = linearLayout;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.a) {
            case 0:
                ...
                super.onDraw(canvas);
                c1 c1Var = (c1) this.c;
                TextView textView = (TextView) getChildAt(c1Var.d1);
                int i10 = c1Var.e1;
                ...
                float interpolation = layout2 == null ? 0.0f : pr.f.getInterpolation(c1Var.f1);
