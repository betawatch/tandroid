...
public class c1 extends FrameLayout implements i90 {
    public boolean B;
    public boolean C;
    public tq D;
    public boolean E;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (tqVar != null) {
            ...
            if (sqVar.h == 0) {
                ...
                dp = AndroidUtilities.dp(sqVar.C - 0.5f) + sqVar.s;
            }
            z5 z5Var = this.G;
