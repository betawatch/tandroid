                ...
                if (aVar3 != null) {
                    ...
                    if (width == 0 || height == 0) {
                        ...
                        for (int i16 = 0; i16 <= width; i16++) {
                            ...
                            w0 w0Var = new w0();
                            w0Var.a = ai.f(Utilities.fastRandom, height);
                        ...
                        while (i18 <= width) {
                            ...
                            while (i19 <= height) {
                                ...
                                h1Var2.getClass();
                                h1Var2.a = ai.f(Utilities.fastRandom, i17);
                                h1Var2.b = ai.f(Utilities.fastRandom, i17);
                                h1Var2.c = ai.f(Utilities.fastRandom, 300) + currentTimeMillis + 150;
                                i19++;
                                i17 = 16;
                            }
                            i18++;
                                ...
                                while (max < min) {
                                    ...
                                    if (((RectF) aVar3.c).contains(f15, f16)) {
                                        ...
                                        if (j10 < 150) {
                                            ...
                                            if (clamp2 >= 1.0f) {
                                                h1Var3.a = h1Var3.b;
                                                h1Var3.b = ai.f(Utilities.fastRandom, 16);
                                                h1Var3.c = ai.f(Utilities.fastRandom, 300) + currentTimeMillis + 150;
                                            }
                                        } else {
                                            i13 = width;
