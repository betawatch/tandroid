...
public final class s0 extends TextView {
    ...
    */
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        switch (this.a) {
            ...
            case 9:
                ...
                w70Var.h.setBounds(0, 0, i10, i11);
                w70Var.h.setCornerRadius(Math.min(i10, i11) / 2.0f);
                ((org.telegram.ui.Components.voip.h) this.b).f = i10;
                break;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
    ...
    public void setTextColor(int i10) {
        switch (this.a) {
            case 7:
                ...
                ((j90) this.c).f(j6.l1(0.03f, i10), j6.l1(0.175f, i10), j6.l1(0.2f, i10), j6.l1(0.45f, i10));
                break;
            default:
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s0(w5 w5Var, Context context) {
        super(context);
        this.a = 11;
        this.c = w5Var;
        this.b = new Paint(1);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s0(w70 w70Var, Context context) {
        super(context);
        this.a = 9;
        this.c = w70Var;
