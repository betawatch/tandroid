...
public final class y extends FrameLayout {
    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.a) {
            case 0:
                ...
                canvas.drawRect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), ((a6) ((org.telegram.ui.c1) limitPreviewView.b0).b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                canvas.restore();
                invalidate();
                return drawChild;
            default:
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 1:
                ...
                int i21 = wg0Var.B;
                i10 = ((g3) wg0Var).backgroundPaddingTop;
                int i22 = (i21 - i10) - dp;
                i11 = ((g3) wg0Var).currentSheetAnimationType;
                if (i11 == 1) {
                    i22 = (int) (wg0Var.b.getTranslationY() + i22);
                }
                int dp2 = AndroidUtilities.dp(20.0f) + i22;
                int dp3 = AndroidUtilities.dp(15.0f) + getMeasuredHeight();
                i12 = ((g3) wg0Var).backgroundPaddingTop;
                int i23 = i12 + dp3;
                i13 = ((g3) wg0Var).backgroundPaddingTop;
                if (i13 + i22 < org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) {
                    ...
                    i20 = ((g3) wg0Var).backgroundPaddingTop;
                ...
                if (f10 != 1.0f) {
                    ...
                    i16 = ((g3) wg0Var).backgroundPaddingLeft;
                    i17 = ((g3) wg0Var).backgroundPaddingTop;
                    int measuredWidth = getMeasuredWidth();
                    i18 = ((g3) wg0Var).backgroundPaddingLeft;
                    float f11 = measuredWidth - i18;
                    i19 = ((g3) wg0Var).backgroundPaddingTop;
                ...
                j6.t0.setColor(Color.argb((int) (wg0Var.f.getAlpha() * 255.0f), Color.red(w03), Color.green(w03), Color.blue(w03)));
                i14 = ((g3) wg0Var).backgroundPaddingLeft;
                float f12 = i14;
                int measuredWidth2 = getMeasuredWidth();
                i15 = ((g3) wg0Var).backgroundPaddingLeft;
        ...
        switch (this.a) {
            case 1:
                ...
                if (motionEvent.getAction() == 0 && wg0Var.B != 0) {
                    if (motionEvent.getY() < AndroidUtilities.dp(12.0f) + wg0Var.B && wg0Var.f.getAlpha() == 0.0f) {
                        wg0Var.dismiss();
                        return true;
                    }
                }
        ...
        switch (this.a) {
            case 1:
                ...
                for (int i17 = 0; i17 < R; i17++) {
                    if (i17 == 0) {
                        i13 = ((g3) wg0Var).backgroundPaddingLeft;
                        ...
                        M = ((sg0Var.M(i17) - 1) * AndroidUtilities.dp(50.0f)) + AndroidUtilities.dp(32.0f);
                    }
                    dp = M + dp;
                }
                int dp2 = AndroidUtilities.dp(8.0f) + (dp < paddingTop ? paddingTop - dp : paddingTop - ((paddingTop / 5) * 3));
                if (qg0Var.getPaddingTop() != dp2) {
                    this.b = true;
                    qg0Var.setPinnedSectionOffsetY(-dp2);
                    qg0Var.setPadding(0, dp2, 0, AndroidUtilities.navigationBarHeight);
                    this.b = false;
                }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.a) {
            case 1:
                return !((wg0) this.d).isDismissed() && super.onTouchEvent(motionEvent);
            default:
