...
public abstract class j2 extends sl0 implements NotificationCenter.NotificationCenterDelegate, x0 {
    ...
    public j2(Context context, int i10) {
        ...
        this.c3 = new nr(0.0f, 0.5f, 0.5f, 1.0f);
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.j3) {
            ...
            if ((this.X2 || this.g3) && arrayList.size() > 0 && !this.U2.isEmpty()) {
                View view = (View) kh.a2.i(1, arrayList);
                this.f3 = view;
                w1(view, !this.X2);
                this.X2 = false;
                this.g3 = false;
            } else if (this.f3 != kh.a2.i(1, arrayList)) {
                this.f3 = (View) kh.a2.i(1, arrayList);
                if (this.a3) {
                    try {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.W2 && !this.U2.isEmpty() && getChildCount() > 0) {
            this.W2 = false;
            AndroidUtilities.runOnUIThread(new ef.e(this, 4));
        }
        int i14 = this.i3;
        if (i14 > 0) {
            f2.l1 K = K(i14);
