...
public final class l1 extends org.telegram.ui.ActionBar.k {
    ...
    public boolean N(View view) {
        switch (this.q1) {
            case 4:
                return super.N(view) || view == ((oy) this.r1).j0;
            default:
                return super.N(view);
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.q1) {
            case 4:
                oy oyVar = (oy) this.r1;
                ey eyVar = oyVar.U;
                if (eyVar == null || eyVar.getAlpha() <= 0.0f || !oyVar.b.f) {
                    break;
                }
                break;
        }
    ...
    public void h(boolean z4) {
        switch (this.q1) {
            case 4:
                oy oyVar = (oy) this.r1;
                oyVar.U.r.getText().clear();
                if (z4 && oyVar.U.r.isFocused()) {
    ...
    public void setAlpha(float f10) {
        ...
        switch (this.q1) {
            ...
            case 3:
                super.setAlpha(f10);
                viewGroup4 = ((g3) ((vg0) this.r1)).containerView;
    ...
    public void setTranslationY(float f10) {
        ...
        switch (this.q1) {
            case 4:
                if (f10 != getTranslationY() && (view = ((oy) this.r1).fragmentView) != null) {
                    view.invalidate();
                }
    ...
    public boolean u() {
        switch (this.q1) {
            case 4:
                jx jxVar = ((oy) this.r1).C3;
                return jxVar != null && jxVar.c();
            default:
                return super.u();
        }
    }
