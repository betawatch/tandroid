    ...
    */
    ...
    public final void d(int i10, final String str) {
        ...
        if (isEmpty) {
            ...
            final int i11 = 0;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) { // from class: eg.h1
                ...
                public final void run(Object obj) {
                    switch (i11) {
                        case 0:
                            ...
                            j1Var.v = b10;
                            j1Var.r.setImage(ImageLocation.getForDocument(b10), "80_80", j1.c(str2), null, null, 0);
                            j1Var.s.setImage(ImageLocation.getForDocument(j1Var.w), "80_80", ImageLocation.getForDocument(j1Var.v), "80_80", null, null, j1.c(str2), 0L, null, null, 0);
                            break;
                        default:
                            j1 j1Var2 = this.b;
                            j1Var2.getClass();
                            ...
                            j1Var2.w = b11;
                            if (b11 != null) {
                                j1Var2.s.setImage(ImageLocation.getForDocument(b11), "80_80", ImageLocation.getForDocument(j1Var2.v), "80_80", null, null, j1.c(str3), 0L, null, null, 0);
                                break;
                            }
                            break;
                    }
            ...
            final int i12 = 1;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName2, 0, false, new Utilities.Callback(this) { // from class: eg.h1
                public final /* synthetic */ j1 b;
