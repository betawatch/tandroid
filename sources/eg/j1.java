...
public final class j1 extends cg.f2 {
    ...
    public static /* synthetic */ void c0(j1 j1Var, TLRPC.TL_error tL_error) {
        j1Var.M0.b(false);
        s.c(tL_error, (FrameLayout) j1Var.containerView, j1Var.resourcesProvider, new h1(j1Var, 0));
    }

    public static void d0(j1 j1Var) {
        cg.f2 f2Var = new cg.f2(j1Var.n, UserConfig.selectedAccount, null, null, null, j1Var.resourcesProvider);
        f2Var.F0 = true;
        f2Var.G0 = true;
        f2Var.Y = true;
        j1Var.n.showDialog(f2Var);
    }

    public static void e0(j1 j1Var) {
        String str = "https://t.me/giftcode/" + j1Var.N0;
        fy fyVar = new fy(x3.e(3, "onlySelect", "dialogsType", true));
        fyVar.y2 = new a9.s(15, j1Var, str);
        j1Var.n.presentFragment(fyVar);
        j1Var.dismiss();
    }
