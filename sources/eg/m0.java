...
public final /* synthetic */ class m0 implements RequestDelegate {
    ...
    public /* synthetic */ m0(int i10, HashSet hashSet, org.telegram.ui.ActionBar.o2 o2Var) {
        this.a = 4;
        this.b = i10;
        this.c = hashSet;
        this.d = o2Var;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.a) {
            ...
            case 2:
                ...
                break;
            case 3:
                AndroidUtilities.runOnUIThread(new ag.z1((a9) this.c, tLObject, this.b, (TLRPC.User) this.d, 10));
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new j3(tLObject, this.b, (HashSet) this.c, tL_error, (org.telegram.ui.ActionBar.o2) this.d, 11));
                break;
            case 5:
                AndroidUtilities.runOnUIThread(new ag.z1((org.telegram.ui.ActionBar.o2) this.c, tLObject, this.b, (Utilities.Callback) this.d, 17));
                break;
            case 6:
                AndroidUtilities.runOnUIThread(new ag.z1((c40) this.c, this.b, tLObject, (String) this.d, 19));
                break;
            case 7:
                AndroidUtilities.runOnUIThread(new ag.z1((iq0) this.c, this.b, tLObject, (String) this.d, 21));
                break;
            case 8:
                AndroidUtilities.runOnUIThread(new gx0((ProfileActivity) this.c, tL_error, tLObject, (TLRPC.TL_channels_getParticipants) this.d, 0), this.b);
                break;
            case 9:
                AndroidUtilities.runOnUIThread(new j3((org.telegram.ui.web.z0) this.c, tLObject, this.b, (org.telegram.ui.web.w0) this.d, tL_error, 25));
                break;
            default:
                rf.a0 a0Var = (rf.a0) this.c;
                String str2 = (String) this.d;
                a0Var.getClass();
                AndroidUtilities.runOnUIThread(new vs(a0Var, this.b, tLObject, str2, 15));
                break;
        }
    }
