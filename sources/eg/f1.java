...
public final class f1 extends i {
        ...
        switch (this.n) {
            case 0:
                ...
                if (f10 <= f12 - dp2 || f11 <= x10 - dp2 || f10 >= f12 + dp2 || f11 >= x10 + dp2) {
                    ...
                    if (f10 <= f14 - dp2 || f11 <= x10 - dp2 || f10 >= f14 + dp2 || f11 >= x10 + dp2) {
                    }
                }
                break;
            case 1:
                ...
                float x11 = e2.c.x(getMeasuredHeight(), f16, 2.0f, f15);
                if (f10 <= f15 - dp4 || f11 <= x11 - dp4 || f10 >= f15 + dp4 || f11 >= x11 + dp4) {
                    float f17 = f15 + measuredWidth2;
                    if (f10 <= f17 - dp4 || f11 <= x11 - dp4 || f10 >= f17 + dp4 || f11 >= x11 + dp4) {
                    }
                }
                break;
            case 2:
            ...
            case 4:
                ...
                float x12 = e2.c.x(getMeasuredHeight(), f27, 2.0f, f26);
                if (f10 <= f26 - dp10 || f11 <= x12 - dp10 || f10 >= f26 + dp10 || f11 >= x12 + dp10) {
                    float f28 = f26 + measuredWidth5;
                    if (f10 <= f28 - dp10 || f11 <= x12 - dp10 || f10 >= f28 + dp10 || f11 >= x12 + dp10) {
                    }
                }
                break;
            default:
                ...
                float x13 = e2.c.x(getMeasuredHeight(), f30, 2.0f, f29);
                if (f10 <= f29 - dp12 || f11 <= x13 - dp12 || f10 >= f29 + dp12 || f11 >= x13 + dp12) {
                    float f31 = f29 + measuredWidth6;
                    if (f10 <= f31 - dp12 || f11 <= x13 - dp12 || f10 >= f31 + dp12 || f11 >= x13 + dp12) {
                    }
                }
                break;
        }
    ...
    public f1(a4 a4Var, Context context) {
        super(a4Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
    ...
    public f1(k1 k1Var, Context context) {
        super(k1Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
    ...
    public f1(z3 z3Var, Context context) {
        super(z3Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
    ...
    public f1(t2 t2Var, Context context) {
        super(t2Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
    ...
    public f1(y1 y1Var, Context context) {
        super(y1Var, context);
        Paint paint = new Paint(1);
        this.r = paint;
        this.s = new Path();
