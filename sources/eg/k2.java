...
public class k2 extends ViewGroup {
    ...
    public k2(Context context) {
        ...
        addView(textView, b6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 0.0f, 8.0f, 0.0f, 0.0f));
        ...
        addView(textView2, b6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 80, 0.0f, 0.0f, 0.0f, 8.0f));
        ...
        addView(textView3, b6.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 80, 0.0f, 0.0f, 0.0f, 8.0f));
    ...
    */
    public final void a(qw0 qw0Var, boolean z4) {
        boolean z10;
        this.n = qw0Var;
        this.J = z4;
        TLRPC.TL_premiumSubscriptionOption tL_premiumSubscriptionOption = qw0Var.a;
        TLRPC.TL_premiumSubscriptionOption tL_premiumSubscriptionOption2 = qw0Var.a;
        ...
        if (!BuildVars.useInvoiceBilling()) {
            ...
            if (z10) {
                if (qw0Var.c() <= 0) {
                    ...
                    textView4.setText(LocaleController.formatString(R.string.GiftPremiumOptionDiscount, Integer.valueOf(qw0Var.c())));
                    textView4.setVisibility(0);
                    textView3.setVisibility(0);
                    textView5.setVisibility(0);
                }
                textView3.setText((BuildVars.useInvoiceBilling() || tL_premiumSubscriptionOption2.store_product == null) ? BillingController.getInstance().formatCurrency(qw0Var.e, qw0Var.b()) : qw0Var.f == null ? "" : BillingController.getInstance().formatCurrency(qw0Var.e, qw0Var.b(), 6));
                textView5.setText(LocaleController.formatString(R.string.PricePerYear, qw0Var.f()));
                textView2.setText(LocaleController.formatString(R.string.PricePerMonthMe, qw0Var.e()));
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        k2 k2Var = this.B;
        Paint paint = k2Var != null ? k2Var.y : this.y;
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i14 + this.f;
        int measuredWidth = lpVar.getMeasuredWidth() + AndroidUtilities.dp(i15 + 24);
        TextView textView2 = this.d;
        ...
        if (textView4.getVisibility() == 0) {
            rect.set(textView5.getMeasuredWidth() + getPaddingLeft() + lpVar.getMeasuredWidth() + AndroidUtilities.dp(i15 + 6), AndroidUtilities.dp(2.0f) + getPaddingTop(), 0, 0);
            b(textView4);
        }
        ...
        b(textView2);
        rect.set(getPaddingLeft() + lpVar.getMeasuredWidth() + AndroidUtilities.dp(f10) + (textView2.getVisibility() == 0 ? AndroidUtilities.dp(6.0f) + textView2.getMeasuredWidth() : 0), (getMeasuredHeight() - textView3.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
        b(textView3);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(size - lpVar.getMeasuredWidth(), TLObject.FLAG_31);
        ...
        this.b.measure(View.MeasureSpec.makeMeasureSpec((size - lpVar.getMeasuredWidth()) - textView.getMeasuredWidth(), TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(dp, TLObject.FLAG_31));
        TextView textView2 = this.r;
        if (textView2.getVisibility() == 0) {
            textView2.measure(View.MeasureSpec.makeMeasureSpec((size - lpVar.getMeasuredWidth()) - textView.getMeasuredWidth(), TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(dp, TLObject.FLAG_31));
        } else {
        ...
        int makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(size - lpVar.getMeasuredWidth(), TLObject.FLAG_31);
        ...
        int d = org.telegram.ui.b.d(6.0f, (size - lpVar.getMeasuredWidth()) - (textView3.getVisibility() == 0 ? textView3.getMeasuredWidth() : 0), TLObject.FLAG_31);
    ...
    public void setProgressDelegate(mp mpVar) {
        this.a.setProgressDelegate(mpVar);
    }
}
