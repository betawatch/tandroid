...
public final class y0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (childAt.getAlpha() != 0.0f) {
            ...
            View view = childAt;
            if (i11 != -1) {
                ViewGroup viewGroup = i11 == 0 ? ht0Var.q1 : i11 == 2 ? ht0Var.r1 : null;
                ...
                x10 = AndroidUtilities.lerp(x10, (((childAt2.getWidth() - childAt2.getPaddingLeft()) - childAt2.getPaddingRight()) / 2.0f) + childAt2.getX() + childAt2.getPaddingLeft(), ht0Var.f1);
                y10 = AndroidUtilities.lerp(y10, (((childAt2.getHeight() - childAt2.getPaddingTop()) - childAt2.getPaddingBottom()) / 2.0f) + childAt2.getY() + childAt2.getPaddingTop(), ht0Var.f1);
            }
            if (x0Var != null && x0Var.getChildCount() > 0) {
                ...
                i10 = i0.a.d(ht0Var.K1, e2Var.a, ht0Var.S1.b(0));
            }
            float f10 = x10;
            float f11 = y10;
