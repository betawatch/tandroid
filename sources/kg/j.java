...
public final class j extends ViewGroup {
    ...
    public void a() {
        ...
        for (int i11 = 0; i11 < arrayList2.size(); i11++) {
            ((o30) arrayList2.get(i11)).setOnClickListener(null);
        }
        c();
        this.c = false;
        AnimatorSet animatorSet = new AnimatorSet();
        this.b = animatorSet;
        animatorSet.addListener(new a8(this, arrayList2, i10));
        ...
        for (int i12 = 0; i12 < arrayList2.size(); i12++) {
            o30 o30Var = (o30) arrayList2.get(i12);
            arrayList5.add(o30Var);
            arrayList4.add(ObjectAnimator.ofFloat(o30Var, (Property<o30, Float>) View.SCALE_X, 1.0f, 0.01f));
            arrayList4.add(ObjectAnimator.ofFloat(o30Var, (Property<o30, Float>) View.SCALE_Y, 1.0f, 0.01f));
            arrayList4.add(ObjectAnimator.ofFloat(o30Var, (Property<o30, Float>) View.ALPHA, 1.0f, 0.0f));
        }
        requestLayout();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (i22) {
            ...
            default:
                ...
                fVar2.setHintVisible(fVar2.getMeasuredWidth() > b8Var.b, true);
                if (!this.c) {
                    ...
                    if (this.b != null) {
                        ...
                        if (f19 != f20) {
                            ...
                            ofFloat2.addUpdateListener(new e5(b8Var, 23));
                ...
                setMeasuredDimension(size2, (int) b8Var.F);
                break;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j(b8 b8Var, Context context) {
        super(context);
        this.n = b8Var;
        this.d = new ArrayList();
        this.e = new ArrayList();
