            ...
            if (z13) {
                ...
                if (i11 == i17) {
                    if (i21 == 0) {
                        ...
                        charSequence = le.f0("TON " + this.L.format(j11 / 1.0E9d), w5Var.getPaint(), 0.82f, 0.0f, false);
                    } else {
                    ...
                    if (i11 != i12) {
                        ...
                        textView3.setText(y7.X0(false, LocaleController.formatString(i21 == 0 ? R.string.ChartInXTR : R.string.ChartInUSD, aVar.d), 0.7f, null));
                    } else {
                    ...
                    f6 f6Var = this.J;
                    if (i13 >= 0 || !j6.c1(i13)) {
                        w5Var.setTextColor(!j6.A0().q() ? aVar.i : aVar.h);
                    } else {
                        w5Var.setTextColor(j6.v0(aVar.g, f6Var));
                    }
                    int i25 = j6.j5;
                    ...
                    charSequence = y7.X0(false, k0.k(j11, ' ', new StringBuilder("XTR ")), 0.7f, null);
                } else {
                    charSequence = "≈" + BillingController.getInstance().formatCurrency((long) (j11 / f7), "USD");
                }
                i12 = 1;
