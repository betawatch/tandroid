...
public final class e0 implements t, r3.m, g5.h0, g5.k0, j0 {
    ...
    public final void A(g5.j0 j0Var, long j10, long j11) {
        ...
        j jVar = new j();
        this.d.getClass();
        this.e.n(jVar, 1, -1, null, 0, null, b0Var.r, this.M);
        this.X = true;
        s sVar2 = this.D;
        sVar2.getClass();
        sVar2.Z(this);
    ...
    public final long X() {
        ...
        if (this.J) {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                ...
                if (((boolean[]) rVar.c)[i10] && ((boolean[]) rVar.d)[i10]) {
                    k0 k0Var = this.F[i10];
                    synchronized (k0Var) {
                        z4 = k0Var.w;
                    }
    ...
    public final long f(boolean z4) {
        ...
        while (i10 < this.F.length) {
            if (!z4) {
                com.google.firebase.messaging.r rVar = this.K;
                rVar.getClass();
                i10 = ((boolean[]) rVar.d)[i10] ? 0 : i10 + 1;
            }
    ...
    public final void j(int i10) {
        ...
        j3.n0 n0Var = ((t0) rVar.b).a(i10).d[0];
    ...
    */
    public final c4.e m(g5.j0 j0Var, IOException iOException, int i10) {
        ...
        if (!(iOException instanceof r1) && !(iOException instanceof FileNotFoundException) && !(iOException instanceof g5.b0) && !(iOException instanceof g5.l0)) {
            ...
            c4.e eVar2 = eVar;
            this.e.q(jVar, 1, -1, null, 0, null, b0Var.r, this.M, iOException, !eVar2.a());
            return eVar2;
        }
        ...
        c4.e eVar22 = eVar;
        this.e.q(jVar, 1, -1, null, 0, null, b0Var.r, this.M, iOException, !eVar22.a());
        return eVar22;
    }
    ...
    public final void o() {
        ...
        this.e.t(new j(b0Var.s), 1, -1, null, 0, null, b0Var.r, this.M);
    }
    ...
    public final void s(g5.j0 j0Var, long j10, long j11, boolean z4) {
        ...
        j jVar = new j();
        this.d.getClass();
        this.e.l(jVar, 1, -1, null, 0, null, b0Var.r, this.M);
        if (z4) {
            return;
        }
        for (k0 k0Var : this.F) {
