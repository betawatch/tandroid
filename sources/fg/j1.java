...
public final class j1 extends LinearLayout {
    ...
    public j1(Context context, f6 f6Var, boolean z10) {
        ...
        g10.setTextColor(z10 ? j6.l1(0.5f, j6.v0(i10, f6Var)) : j6.v0(j6.z6, f6Var));
    ...
    public final void a(int i10, String str, TLRPC.Chat chat) {
        ...
        w9 w9Var = this.b;
        if (i10 == 0) {
            vq vqVar = new vq(j6.b0(AndroidUtilities.dp(28.0f), j6.v0(j6.Oh, this.a)), getContext().getResources().getDrawable(R.drawable.menu_hashtag).mutate());
            vqVar.s = AndroidUtilities.dp(-0.66f);
            vqVar.v = 0;
