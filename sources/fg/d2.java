...
public class d2 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void P(d2 d2Var) {
        ...
        arrayList.add(d2Var.z0);
        x1 x1Var = new x1(d2Var, 0);
        org.telegram.ui.ActionBar.p2 p2Var = d2Var.q0;
        if (p2Var != null) {
    ...
    public void a0(boolean z4) {
        ...
        if (tL_emojiStatusCollectible != null) {
            ...
            this.L0[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.TelegramPremiumUserStatusCollectibleDialogTitle, DialogObject.getShortName(user), str), new t1(this, i12)));
            ...
            Integer num = this.r0;
            CharSequence replaceSingleLink = AndroidUtilities.replaceSingleLink(formatString, num == null ? getThemedColor(k6.u6) : num.intValue());
            try {
            ...
            if (indexOf >= 0) {
                ...
                if (document != null) {
                    ...
                    spannableStringBuilder.setSpan(new l90(AndroidUtilities.dp(100.0f), this.L0[0]), 0, spannableStringBuilder.length(), 33);
                }
                ...
                this.L0[1].setOnLinkPressListener(new f90() { // from class: fg.u1
                ...
                if (document != null) {
                    ...
                    if (g90VarArr2 != null) {
                        g90VarArr2[1].setText(spannableStringBuilder2);
                        if (this.L0[1].getVisibility() != 0) {
                            if (z4) {
                                ...
                                this.L0[0].animate().alpha(0.0f).setInterpolator(prVar).setDuration(200L).withEndAction(new t1(this, i10)).start();
                                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                                ofFloat.addUpdateListener(new w1(this, i11));
            ...
            if (nVar == null) {
                ...
                if (starGift != null) {
                    ...
                    g90Var.setText(AndroidUtilities.replaceSingleLink(formatString2, num2 == null ? getThemedColor(k6.u6) : num2.intValue()));
                    org.telegram.ui.b.n(R.string.TelegramPremiumUserDialogSubtitle, this.M0);
                }
            } else if (this.Z) {
                g90 g90Var2 = g90VarArr[0];
                ...
                g90Var2.setText(AndroidUtilities.replaceSingleLink(formatString3, num3 == null ? getThemedColor(k6.u6) : num3.intValue()));
                g90 g90Var3 = this.M0;
                ...
                g90Var3.setText(AndroidUtilities.replaceSingleLink(formatString4, num4 == null ? getThemedColor(k6.u6) : num4.intValue()));
                ...
                g90Var4.setText(AndroidUtilities.replaceSingleLink(formatString5, num5 == null ? getThemedColor(k6.u6) : num5.intValue()));
                org.telegram.ui.b.n(R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle, this.M0);
            } else {
                g90 g90Var5 = this.L0[0];
                ...
                g90Var5.setText(AndroidUtilities.replaceSingleLink(formatString6, num6 == null ? getThemedColor(k6.u6) : num6.intValue()));
                org.telegram.ui.b.n(R.string.TelegramPremiumUserGiftedPremiumDialogSubtitle, this.M0);
            }
        }
        try {
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        View view4 = this.x0;
        Drawable rightDrawable = view4 instanceof l5 ? ((l5) view4).getRightDrawable() : view4 instanceof org.telegram.ui.Cells.t1 ? ((org.telegram.ui.Cells.t1) view4).cc : null;
    ...
    public final boolean onCustomOpenAnimation() {
        ...
        this.F0.addUpdateListener(new w1(this, i10));
        this.F0.addListener(new w2(i11, this, drawable));
    ...
    public final void show() {
        ...
        if (this.G0) {
            AndroidUtilities.runOnUIThread(new t1(this, i10), 200L);
        }
    }
