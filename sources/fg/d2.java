...
public class d2 {
    ...
    public final void a(CharSequence charSequence) {
        ...
        while (matcher.find()) {
            ...
            b2 b2Var = (b2) this.r.get(charSequence2);
            if (b2Var == null) {
                b2Var = new b2();
                b2Var.a = charSequence2;
                this.r.put(charSequence2, b2Var);
            } else {
                this.q.remove(b2Var);
            }
            b2Var.b = (int) (System.currentTimeMillis() / 1000);
            this.q.add(0, b2Var);
            z10 = true;
        }
        if (z10) {
            MessagesStorage.getInstance(this.m).getStorageQueue().postRunnable(new s1(1, this, this.q));
        }
    }
    ...
    public final void c() {
        this.q = new ArrayList();
        this.r = new HashMap();
        MessagesStorage.getInstance(this.m).getStorageQueue().postRunnable(new a2(this, 0));
    }
    ...
    */
    public final void h(final String str, boolean z10, final boolean z11, final boolean z12, boolean z13, final boolean z14, long j3, boolean z15, int i10, final int i11, final long j10, final da daVar) {
        int i12;
        boolean z16;
        boolean z17;
        boolean z18;
        ...
        if (str.length() > 0) {
            if (j3 != 0) {
                ...
                z16 = z13;
                arrayList6.add(new Pair(tL_channels_getParticipants, new bi.f2(this, str, z16, 1)));
            } else {
                z16 = z13;
        ...
        if (z10) {
            if (str.length() <= 0) {
                ...
                while (i13 < arrayList6.size()) {
                    ...
                    atomicInteger2.set(ConnectionsManager.getInstance(i12).sendRequest(tLObject, new RequestDelegate() { // from class: fg.y1
                        ...
                        public final void run(final TLObject tLObject2, final TLRPC.TL_error tL_error) {
                            ...
                            final int i18 = i11;
                            final Runnable runnable = daVar;
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: fg.z1
                                ...
                                public final void run() {
                                    ...
                                    d2 d2Var2 = d2.this;
                                    ArrayList arrayList14 = d2Var2.b;
                                    if (arrayList14.contains(valueOf)) {
                                        ...
                                        if (incrementAndGet == arrayList15.size()) {
                                            ...
                                            d2Var2.i();
                                            ArrayList arrayList16 = d2Var2.k;
                                            if (arrayList16 != null) {
                                                d2Var2.f(arrayList16, d2Var2.l);
                                            }
                                            ArrayList arrayList17 = d2Var2.d;
                                            ArrayList arrayList18 = d2Var2.e;
                                            a0.i iVar4 = d2Var2.f;
                                            c2 c2Var = d2Var2.a;
                                            if (c2Var != null) {
                                                a0.i P = c2Var.P();
                                                if (P != null) {
                                                    ...
                                                    for (int i20 = 0; i20 < m10; i20++) {
                                                        TLRPC.User user2 = (TLRPC.User) iVar4.f(P.j(i20));
                                                        if (user2 != null) {
                                                ...
                                                if (D != null) {
                                                    ...
                                                    for (int i21 = 0; i21 < m11; i21++) {
                                                        TLRPC.User user3 = (TLRPC.User) iVar4.f(D.j(i21));
                                                        if (user3 != null) {
            ...
            arrayList6.add(new Pair(tL_contacts_search, new RequestDelegate() { // from class: fg.x1
                ...
                */
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    ...
                    boolean z26 = d2Var.o;
                    int i17 = d2Var.m;
                    ArrayList arrayList12 = d2Var.d;
                    ArrayList arrayList13 = d2Var.e;
                    a0.i iVar7 = d2Var.f;
                    if (d2Var.a.c0(i11) && tL_error == null) {
                        ...
                        while (true) {
                            ...
                            while (i21 < arrayList11.size()) {
                                ...
                                if (chat2 != null) {
                                    if (z21 && ((!z22 || ChatObject.canAddBotsToChat(chat2)) && ((d2Var.p || !ChatObject.isNotInChat(chat2)) && d2Var.d(chat2)))) {
                        ...
                        if (!z26) {
                            ...
                            while (i23 < tL_contacts_found2.my_results.size()) {
                                ...
                                if (chat == null) {
                                    ...
                                    iVar5 = iVar9;
                                    if (user2 != null && !z22 && ((z23 || !user2.bot) && ((z24 || !user2.self) && user2.id != j17 && d2Var.d(user2)))) {
