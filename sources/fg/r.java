            ...
            case 0:
                ...
                if (tL_error == null) {
                    ...
                    while (i10 < messages_messages.messages.size()) {
                        a0.i iVar3 = iVar;
                        MessageObject messageObject = new MessageObject(h0Var.s0, messages_messages.messages.get(i10), iVar2, iVar3, false, true);
            ...
            case 1:
                ...
                if (tL_error == null) {
                    ...
                    while (i16 < messages_messages2.messages.size()) {
                        a0.i iVar6 = iVar4;
                        MessageObject messageObject2 = new MessageObject(h0Var2.s0, messages_messages2.messages.get(i16), iVar5, iVar6, false, true);
