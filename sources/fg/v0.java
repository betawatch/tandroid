...
public class v0 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public v0(int i10, int i11, Context context, org.telegram.ui.ActionBar.p2 p2Var, g6 g6Var) {
        ...
        this.O0 = 0;
        this.Q0 = -4;
        fixNavigationBar(k6.v0(k6.h5, this.resourcesProvider));
        this.H0 = p2Var;
        ...
        if (i10 == 18 || i10 == 20 || i10 == 24 || i10 == 25 || i10 == 26 || i10 == 29 || i10 == 22 || i10 == 23 || i10 == 21 || i10 == 27 || i10 == 28 || i10 == 30 || i10 == 35 || i10 == 31) {
            ...
            int k10 = i0.a.k(k6.v0(k6.d6, g6Var), 120);
    ...
    public static void S(v0 v0Var) {
        ...
        if (v0Var.g0) {
            ...
            if (canApplyBoost.alreadyActive && hg.p0.i() && !v0Var.Z.isMaxLvl) {
        ...
        if (i10 == 5) {
            ...
            if (textView != null) {
                textView.setTextColor(k6.v0(k6.q7, v0Var.resourcesProvider));
            }
        }
    }
    ...
    public static void V(v0 v0Var, Context context) {
        ...
        if (canApplyBoost.empty) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.CheckPhoneNumberYes), new c0(v0Var, i11));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new f5.u(i12));
        ...
        if (z4 && canApplyBoost.replaceDialogId == 0) {
            ...
            w1Var.show();
            w1Var.setOnHideListener(new d0(v0Var, i11));
            return;
        }
        if (!z4) {
        ...
        paint.setColor(k6.w0(null, k6.h5, false));
        ...
        imageView.setColorFilter(k6.w0(null, k6.m6, false));
    ...
    public final boolean B1() {
        ...
        if (v0Var.b0) {
            ...
            u0Var.d.addView(u0Var.a, c6.o(-2, -2, 1.0f, 0));
            ...
            u0Var.a.setTextColor(k6.v0(k6.G6, v0Var.resourcesProvider));
            u0Var.a.setGravity(17);
            u0Var.addView(u0Var.a, indexOfChild3, c6.t(-2, -2, 1, 0, 22, 0, 0));
        }
        ...
        u0Var.b.setTextColor(k6.v0(k6.G6, v0Var.resourcesProvider));
        u0Var.addView(u0Var.b, indexOfChild, c6.t(-2, -2, 1, 24, -2, 24, 17));
    ...
    public final void D1(ArrayList arrayList) {
        ...
        TextView textView = (TextView) d2Var.d(-1);
        if (textView != null) {
            textView.setTextColor(k6.v0(k6.q7, this.resourcesProvider));
        }
    }
    ...
    public final void E1(HashMap hashMap) {
        ...
        if (hashMap2 == null && !arrayList.isEmpty()) {
            ...
            z4.c0(this.currentAccount, arrayList3, 1, new dg.h0(this, 5));
            return;
        }
        Iterator it2 = hashSet.iterator();
        boolean z4 = false;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (lastFragment instanceof ng.s) {
            ...
            org.telegram.ui.ActionBar.p2 p2Var2 = fragmentStack.size() >= 2 ? (org.telegram.ui.ActionBar.p2) yh.j(2, fragmentStack) : null;
            org.telegram.ui.ActionBar.p2 p2Var3 = fragmentStack.size() >= 3 ? (org.telegram.ui.ActionBar.p2) yh.j(3, fragmentStack) : null;
            r6 = fragmentStack.size() >= 4 ? (org.telegram.ui.ActionBar.p2) yh.j(4, fragmentStack) : null;
        ...
        if ((lastFragment instanceof bd) && booleanValue) {
            ...
            for (int size = fragmentStack2.size() - 2; size >= 0; size--) {
                ...
                if ((p2Var4 instanceof xn) || (p2Var4 instanceof py)) {
                    r6 = p2Var4;
                    break;
                }
        ...
        r6 = fragmentStack3.size() >= 2 ? (org.telegram.ui.ActionBar.p2) yh.j(2, fragmentStack3) : null;
        p2Var.finishFragment();
        dismiss();
        if (r6 instanceof xn) {
            hg.r.f(r6, chat, true);
    ...
    public final void m1(final j90 j90Var, boolean z4) {
        if (!j90Var.b() || z4) {
            ...
            int i10 = this.Z.slot;
            final int i11 = 0;
            Utilities.Callback<TL_stories.TL_premium_myBoosts> callback = new Utilities.Callback(this) { // from class: fg.e0
                ...
                public final void run(Object obj) {
                    switch (i11) {
                        case 0:
                            MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.X, new f0(this.b, j90Var, (TL_stories.TL_premium_myBoosts) obj, 0));
                            break;
                        default:
                            ...
                            if (startsWith) {
                                ...
                                if (intValue <= 5) {
                                    AndroidUtilities.runOnUIThread(new a1.e(26, this.b, j90Var2), intValue * 1000);
                                    break;
                                } else {
                                    hg.r.g(intValue);
                                }
            ...
            final int i12 = 1;
            boostsController.applyBoost(j10, i10, callback, new Utilities.Callback(this) { // from class: fg.e0
                public final /* synthetic */ v0 b;
    ...
    public final void z1() {
        ...
        t0Var.b++;
        t0Var.a = k7.o.a((i10 - r3) / i11, 0.0f, 1.0f);
        t0Var.T = true;
        t0Var.U = t0Var.n;
        t0Var.g(i10, true);
