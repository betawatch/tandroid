...
public final class i extends WebViewClient {
    ...
    public boolean a(String str) {
        ...
        ((qj1) this.b).getClass();
        ((qj1) this.b).finishFragment(false);
        try {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (sqVar != null && sqVar.getVisibility() == 0) {
                    ...
                    qj1Var.b.getContentView().setVisibility(0);
                    qj1Var.b.setEnabled(true);
                    animatorSet.playTogether(ObjectAnimator.ofFloat(qj1Var.c, "scaleX", 1.0f, 0.1f), ObjectAnimator.ofFloat(qj1Var.c, "scaleY", 1.0f, 0.1f), ObjectAnimator.ofFloat(qj1Var.c, "alpha", 1.0f, 0.0f), ObjectAnimator.ofFloat(qj1Var.b.getContentView(), "scaleX", 0.0f, 1.0f), ObjectAnimator.ofFloat(qj1Var.b.getContentView(), "scaleY", 0.0f, 1.0f), ObjectAnimator.ofFloat(qj1Var.b.getContentView(), "alpha", 0.0f, 1.0f));
