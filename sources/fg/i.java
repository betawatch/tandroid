...
public class i extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [fg.b] */
    /* JADX WARN: Type inference failed for: r2v4, types: [fg.b] */
    /* JADX WARN: Type inference failed for: r2v5, types: [fg.b] */
    public i(Context context, int i10, int i11) {
        ...
        final int i13 = 0;
        this.R = new f(this, 0);
        this.S = new ValueAnimator.AnimatorUpdateListener(this) { // from class: fg.b
        ...
        final int i14 = 1;
        this.T = new ValueAnimator.AnimatorUpdateListener(this) { // from class: fg.b
            public final /* synthetic */ i b;
        ...
        final int i15 = 2;
        this.U = new ValueAnimator.AnimatorUpdateListener(this) { // from class: fg.b
            public final /* synthetic */ i b;
    ...
    public final void i() {
        ...
        if (q2Var != null) {
            ...
            ofFloat3.addUpdateListener(o1Var);
    ...
    public void k() {
        if (this.J) {
            ...
            if (intValue != 2) {
                ...
                ofFloat8.setInterpolator(nrVar);
