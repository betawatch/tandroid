...
public final class t2 extends FrameLayout implements x0, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public t2(Context context, SvgHelper.SvgDrawable svgDrawable, int i10, int i11, g6 g6Var) {
        super(context);
        boolean[] zArr;
        ...
        paint2.setColor(i0.a.d(0.5f, k6.v0(k6.Mj, g6Var), -16777216));
            ...
            if (i12 >= 0) {
                ...
                for (int i13 = 0; i13 < document.thumbs.size(); i13++) {
                    if (document.thumbs.get(i13) instanceof TLRPC.TL_photoStrippedSize) {
                        ...
                        r2Var = new r2(this, this.H, this.I);
                        r2Var.w = true;
                    }
                }
                this.h = FileLoader.getAttachFileName(document);
                zArr = null;
                this.n.setImage(null, null, r2Var, null, premiumPromo, 1);
                FileLoader.getInstance(this.s).loadFile(document, premiumPromo, 3, 0);
                this.O = document;
                Utilities.globalQueue.postRunnable(new a1.e(27, this, document));
                if (i11 != 1) {
                    ...
                    textPaint.setColor(i0.a.k(k6.w0(zArr, k6.Zj, false), 30));
                    ...
                    m2 m2Var = new m2();
                    this.L = m2Var;
                    ArrayList arrayList = m2Var.e;
                    if (arrayList.isEmpty()) {
                        for (int i17 = 0; i17 < m2Var.g; i17++) {
                            arrayList.add(new l2(m2Var));
                        }
                    }
                    int k10 = i0.a.k(k6.w0(zArr, k6.Zj, false), 80);
                    if (m2Var.i != k10) {
                        m2Var.i = k10;
                        m2Var.c.setColor(k10);
                    }
                } else if (i11 == 13) {
                    p pVar = new p();
                    this.M = pVar;
                    ...
                    o2 o2Var2 = new o2(SharedConfig.getDevicePerformanceClass() == 2 ? 800 : SharedConfig.getDevicePerformanceClass() == 1 ? 400 : 100);
                    this.K = o2Var2;
                    o2Var2.O = g6Var;
                    o2Var2.P = k6.Zj;
                    o2Var2.r = 4;
                ...
                this.F = q2Var;
                q2Var.setResizeMode(0);
                TextureView textureView = new TextureView(context);
                this.G = textureView;
                q2Var.addView(textureView);
        ...
        this.d = true;
        q2 q2Var2 = new q2(this, context);
        this.F = q2Var2;
        q2Var2.setResizeMode(0);
        TextureView textureView2 = new TextureView(context);
        this.G = textureView2;
        q2Var2.addView(textureView2);
        setWillNotDraw(false);
        addView(q2Var2);
    }
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i14 = 0;
        o2 o2Var = this.K;
        if (o2Var != null || m2Var != null || this.M != null || aVar3 != null) {
            if (this.D < 0.5f) {
                ...
                if (aVar3 != null) {
                    ...
                    if (width == 0 || height == 0) {
                        ...
                        for (int i16 = 0; i16 <= width; i16++) {
                            ...
                            w0 w0Var = new w0();
                            w0Var.a = yh.f(Utilities.fastRandom, height);
                        ...
                        while (i18 <= width) {
                            ...
                            while (i19 <= height) {
                                ...
                                h1Var2.getClass();
                                h1Var2.a = yh.f(Utilities.fastRandom, i17);
                                h1Var2.b = yh.f(Utilities.fastRandom, i17);
                                h1Var2.c = yh.f(Utilities.fastRandom, 300) + currentTimeMillis + 150;
                                i19++;
                                i17 = 16;
                            }
                            i18++;
                                ...
                                while (max < min) {
                                    ...
                                    if (((RectF) aVar3.c).contains(f15, f16)) {
                                        ...
                                        if (j10 < 150) {
                                            ...
                                            if (clamp2 >= 1.0f) {
                                                h1Var3.a = h1Var3.b;
                                                h1Var3.b = yh.f(Utilities.fastRandom, 16);
                                                h1Var3.c = yh.f(Utilities.fastRandom, 300) + currentTimeMillis + 150;
                                            }
                                        } else {
                                            i13 = width;
                    ...
                    if (o2Var != null) {
                        ...
                        m2Var.f = (((1.0f - Utilities.clamp(this.D / 0.1f, 1.0f, 0.0f)) * 0.9f) + 0.1f) * 150.0f * f12;
                        ArrayList arrayList3 = m2Var.e;
                        long currentTimeMillis2 = System.currentTimeMillis();
                        for (int i26 = 0; i26 < arrayList3.size(); i26++) {
                            l2 l2Var = (l2) arrayList3.get(i26);
                            m2 m2Var2 = l2Var.g;
                            float[] fArr2 = m2Var2.d;
                            int i27 = i26 * 4;
                            float f18 = l2Var.a;
                            fArr2[i27] = f18;
                            fArr2[i27 + 1] = l2Var.b;
                            fArr2[i27 + 2] = (AndroidUtilities.dp(30.0f) * l2Var.c) + f18;
                            fArr2[i27 + 3] = (AndroidUtilities.dp(30.0f) * l2Var.d) + l2Var.b;
                            float dp = AndroidUtilities.dp(4.0f);
                            float f19 = m2Var2.j;
                            float f20 = (f19 / 660.0f) * dp * m2Var2.f;
                            float f21 = (l2Var.c * f20) + l2Var.a;
                            l2Var.a = f21;
                            float f22 = (l2Var.d * f20) + l2Var.b;
                            l2Var.b = f22;
                            float f23 = l2Var.f;
                            if (f23 != 1.0f) {
                            ...
                            if (currentTimeMillis2 > l2Var.e || !m2Var.b.contains(f21, f22)) {
                                l2Var.a(currentTimeMillis2, false);
                            }
                        }
                        canvas.drawLines(m2Var.d, m2Var.c);
                    } else {
                        p pVar = this.M;
                        if (pVar != null) {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.P != measuredWidth) {
            ...
            o2 o2Var = this.K;
            if (o2Var != null) {
                RectF rectF2 = o2Var.c;
                RectF rectF3 = o2Var.a;
                int i14 = this.v;
                if (i14 == 6 || i14 == 9 || i14 == 3 || i14 == 7 || i14 == 24 || i14 == 43 || i14 == 11 || i14 == 4) {
                    ...
                    o2Var.b.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                }
                o2Var.f();
            ...
            m2 m2Var = this.L;
            if (m2Var != null) {
                RectF rectF5 = m2Var.a;
                rectF5.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                m2Var.b.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
