...
public final class o1 extends FrameLayout {
    ...
    public o1(Context context, f6 f6Var) {
        ...
        while (i10 < 2) {
            ...
            addView(this.c[i10], a6.d(-1, -2.0f, 48, 76.0f, 7.0f, 40.0f, 0.0f));
            ...
            addView(this.d[i10], a6.d(-1, -2.0f, 48, 76.0f, 26.33f, 40.0f, 0.0f));
            i10++;
        }
    ...
    public final boolean a(u4 u4Var) {
        ...
        while (true) {
            ...
            MessageObject messageObject = (MessageObject) u4Var.i.get(i10);
            long j3 = messageObject.storyItem.dialogId;
            TextUtils.isEmpty(str);
            i9Var.l(i11, messageObject.storyItem, u4Var.c);
            i11++;
            i10++;
        }
        i9Var.k(i11);
        ...
        if (isEmpty) {
            ...
            textViewArr[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagStoriesFoundChannel", u4Var.J, "@" + str), j6.v0(j6.Oh, this.a), null));
        }
    ...
    public final void b(int i10, String str, String str2) {
        ...
        if (isEmpty) {
            ...
            textViewArr[1].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagMessagesFoundChannel", i10, r6.i("@", str2)), j6.v0(j6.Oh, this.a), null));
        }
