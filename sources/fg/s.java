...
public final /* synthetic */ class s implements Runnable {
    ...
    public /* synthetic */ s(h0 h0Var, int i10, int i11, TLRPC.TL_error tL_error, String str, TLObject tLObject, TLMethod tLMethod, ArrayList arrayList, int i12) {
        this.a = i12;
        this.b = h0Var;
        this.c = i10;
        this.d = i11;
    ...
    public final void run() {
        ...
        switch (i13) {
            case 0:
                ...
                int i16 = h0Var.s0;
                if (i15 == h0Var.T && (i14 <= 0 || i14 == h0Var.d0)) {
                    h0Var.D0--;
                    if (tL_error == null) {
                        h0Var.b0 = str;
                        ...
                        h0Var.c0 = messages_messages.next_rate;
                        ...
                        h0Var.N = true;
                        h0Var.X = messages_messages.messages.size() != 20;
                        if (i14 > 0) {
                            h0Var.g0 = i14;
                            if (h0Var.f0 != i14) {
                                h0Var.s.clear();
                        ...
                        yVar.f(h0Var.s, h0Var.v0);
                        iy iyVar = h0Var.U;
                        if (iyVar != null) {
                            iyVar.d(h0Var.D0 > 0, true);
                            h0Var.U.c();
                        }
                        h0Var.l();
                    }
            ...
            case 1:
                ...
                int i19 = h0Var2.s0;
                if (i15 == h0Var2.P && (i14 <= 0 || i14 == h0Var2.d0)) {
                    h0Var2.D0--;
                    if (tL_error2 == null) {
                        h0Var2.b0 = str2;
                        ...
                        h0Var2.c0 = messages_messages2.next_rate;
                        ...
                        h0Var2.N = true;
                        h0Var2.W = messages_messages2.messages.size() != 20;
                        if (i14 > 0) {
                            h0Var2.g0 = i14;
                            if (h0Var2.f0 != i14) {
                                h0Var2.s.clear();
                        ...
                        yVar2.f(h0Var2.s, h0Var2.v0);
                        iy iyVar2 = h0Var2.U;
                        if (iyVar2 != null) {
                            i11 = 1;
                            iyVar2.d(h0Var2.D0 > 0, true);
                            h0Var2.U.c();
                        } else {
                            i11 = 1;
                        }
