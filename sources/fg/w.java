...
public final class w extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (limitPreviewView.G) {
            ...
            d10.c.setColor(k6.w0(null, k6.Oh, false));
            ...
            canvas.drawRoundRect(rectF2, f12, f12, z4 ? paint : limitPreviewView.b0 != null ? textPaint : q1.d().e());
            Paint e6 = q1.d().e();
            CornerPathEffect cornerPathEffect = this.b;
            e6.setPathEffect(cornerPathEffect);
            if (limitPreviewView.b0 != null) {
                textPaint.setPathEffect(cornerPathEffect);
            }
            if (!limitPreviewView.O) {
                paint = limitPreviewView.b0 != null ? textPaint : q1.d().e();
            }
        ...
        if (limitPreviewView.b0 != null) {
            ...
            canvas.drawRect(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(10.0f), getMeasuredWidth() - AndroidUtilities.dp(12.0f), getMeasuredHeight() - AndroidUtilities.dp(10.0f), ((y5) ((org.telegram.ui.a1) limitPreviewView.b0).b).t0(getX(), getY()));
            canvas.restore();
        }
    }
