...
public final class v2 extends j {
    ...
    public yj0 getSelectionBounds() {
        ...
        u2 u2Var = this.m0;
        return new yj0(t10, (positionY - (((dp2 - u2Var.getExtendedPaddingTop()) - AndroidUtilities.dpf2(4.0f)) / 2.0f)) * scaleX, ((dp * scaleX) + t10) - t10, (dp2 - u2Var.getExtendedPaddingBottom()) * scaleX);
    }
    ...
    public void setSwatch(yf.p1 p1Var) {
        this.n0 = new yf.p1(p1Var.b, p1Var.c, p1Var.a);
        r();
    }
    ...
    public void setTypeface(String str) {
        Iterator it = yf.i0.c().iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            yf.i0 i0Var = (yf.i0) it.next();
