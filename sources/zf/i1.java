...
public abstract class i1 extends zk0 {
    ...
    public static void x1(float f10, float f11, float f12, int i10, Canvas canvas) {
        ...
        path.lineTo((float) i0.a.b(-1.5707963267948966d, rectF.width() / 2.0f, rectF.centerX()), (float) ((Math.sin(-1.5707963267948966d) * (rectF.height() / 2.0f)) + rectF.centerY()));
        path.moveTo(rectF.centerX(), rectF.centerY());
        path.lineTo((float) i0.a.b(4.71238898038469d, rectF.width() / 2.0f, rectF.centerX()), (float) ((Math.sin(4.71238898038469d) * (rectF.height() / 2.0f)) + rectF.centerY()));
    ...
    public final void y1(float f10, boolean z10) {
        float interpolation = z10 ? er.g.getInterpolation(f10) : er.i.getInterpolation(f10);
