...
public final class d extends vk0 {
    ...
    public final void v(f2.q1 q1Var, int i9) {
        if (q1Var.f == 0) {
            ...
            limitPreviewView.B = ((e) arrayList.get(i10)).e;
            limitPreviewView.c = this.n;
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v3, types: [android.view.ViewGroup, org.telegram.ui.b81] */
    /* JADX WARN: Type inference failed for: r1v7, types: [zf.f] */
    @Override // f2.r0
