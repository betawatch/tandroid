...
public class r0 extends View {
    ...
    */
    ...
    public final void a(Canvas canvas) {
        ...
        RectF rectF2 = this.d;
        if (z10) {
            float e9 = this.L.e(this.H);
            if (e9 > 0.0f) {
                float f16 = ((rectF2.left + 2.25f) * f15) + f10;
                float f17 = f15 * 21.33f;
                float A = com.google.android.recaptcha.internal.a.A(this.J, f17, 2.0f, f11);
            ...
            if (e9 < 1.0f) {
                ...
                float A2 = com.google.android.recaptcha.internal.a.A(this.J, f19, 2.0f, f11);
                ...
                imageReceiver2.setAlpha(1.0f - e9);
    ...
    public final void d(int i10, final String str) {
        ...
        if (isEmpty) {
            ...
            final int i11 = 0;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) { // from class: zf.q0
            ...
            final int i12 = 1;
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName2, 0, false, new Utilities.Callback(this) { // from class: zf.q0
                public final /* synthetic */ r0 b;
