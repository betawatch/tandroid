...
public final class m extends i {
    ...
    public final boolean equals(Object obj) {
        ...
        if ((serializable2 instanceof BigDecimal) && (serializable instanceof BigDecimal)) {
            return (serializable2 instanceof BigDecimal ? (BigDecimal) serializable2 : na.d.i(n())).compareTo(serializable instanceof BigDecimal ? (BigDecimal) serializable : na.d.i(mVar.n())) == 0;
        }
        double q10 = q();
        double q11 = mVar.q();
        if (q10 != q11) {
    ...
    public final Number r() {
        ...
        if (serializable instanceof String) {
            return new na.i((String) serializable);
        }
