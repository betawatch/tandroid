...
public class a implements Closeable {
    ...
    */
    public final int d() {
        ...
        if (s12 != 44 && s12 != 59) {
            ...
            if (s12 != 93) {
                            ...
                            if (c12 == 'E' || c12 == 'e') {
                                ...
                                if (c12 == '.') {
                                    ...
                                    if (c11 == 1 || c11 == 0) {
                                        ...
                                        z4 &= j10 > -922337203685477580L || (j10 == -922337203685477580L && j11 < j10);
                                        j10 = j11;
                                    } else if (c11 == 3) {
                                        c11 = 4;
                                    } else if (c11 == 5 || c11 == 6) {
                ...
                while (true) {
                    if (i18 < length) {
                        if ((this.c + i18 >= this.d && !g(i18 + 1)) || ((c3 = cArr[this.c + i18]) != str.charAt(i18) && c3 != str2.charAt(i18))) {
                            break;
                        }
                        i18++;
        ...
        while (true) {
            ...
            switch (i12) {
                ...
                case 8:
                    break;
                default:
                    throw new AssertionError(a2.j(i12, "Unknown scope value: "));
            }
            i10++;
        }
    }
    ...
    final String m() {
        StringBuilder m9 = e2.c.m(" at line ", this.e + 1, " column ", (this.c - this.f) + 1, " path ");
        m9.append(h());
        return m9.toString();
    }
    ...
    */
    public final String w() {
        ...
        do {
            ...
            i10 = i11;
            if (sb2 != null) {
                sb = new String(cArr, this.c, i10);
            } else {
                sb2.append(cArr, this.c, i10);
                sb = sb2.toString();
            }
            this.c += i10;
            return sb;
