...
public final /* synthetic */ class c1 implements View.OnClickListener {
        ...
        switch (this.a) {
            case 0:
                ...
                if (U != null) {
                    ...
                    n1Var.C2 = new qy() { // from class: ei.d1
                        ...
                        @Override // org.telegram.ui.qy
                        public final boolean u(wy wyVar, ArrayList arrayList2, CharSequence charSequence, boolean z10, boolean z11, int i12, int i13, fg1 fg1Var) {
            ...
            case 1:
                ...
                if (!dVar.N) {
                    ...
                    hg0Var.v.getConnectionsManager().sendRequest(tL_payments_getPaymentForm, new ca(hg0Var, tL_inputInvoicePremiumAuthCode, tL_inputStorePaymentAuthCode, 23), 74);
                    break;
                }
                break;
            default:
                    ...
                    if (!MessagesController.getInstance(i12).isFrozen()) {
                        ...
                        if (!e0Var.c && (l4 == null || l4.b < e0Var.H.b)) {
                            ...
                            if (bVar != zf.b.a) {
                                ...
                                long a2 = aVar.a();
                                long j10 = this.b;
                                new n7(context, f6Var, a2, 13, ng.d.h(i12, j10), null, j10).show();
                                break;
                            }
                        } else {
    ...
    public /* synthetic */ c1(yh.e0 e0Var, bo boVar, int i10, Context context, f6 f6Var, long j3, Utilities.Callback callback) {
        this.d = e0Var;
        this.c = i10;
        this.e = context;
        this.f = f6Var;
