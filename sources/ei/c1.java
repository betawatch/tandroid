...
public final /* synthetic */ class c1 implements View.OnClickListener {
        ...
        switch (this.a) {
            case 0:
                ...
                if (U != null) {
                    ...
                    n1Var.C2 = new oy() { // from class: ei.d1
                        ...
                        @Override // org.telegram.ui.oy
                        public final boolean u(uy uyVar, ArrayList arrayList2, CharSequence charSequence, boolean z10, boolean z11, int i12, int i13, dg1 dg1Var) {
            ...
            case 1:
                ...
                if (!dVar.N) {
                    ...
                    gg0Var.v.getConnectionsManager().sendRequest(tL_payments_getPaymentForm, new ba(gg0Var, tL_inputInvoicePremiumAuthCode, tL_inputStorePaymentAuthCode, 23), 74);
                    break;
                }
                break;
            default:
    ...
    public /* synthetic */ c1(gg0 gg0Var, String str, long j3, String str2, String str3, int i10) {
        this.d = gg0Var;
        this.e = str;
        this.b = j3;
        this.f = str2;
    ...
    public /* synthetic */ c1(yh.e0 e0Var, zn znVar, int i10, Context context, e6 e6Var, long j3, Utilities.Callback callback) {
        this.d = e0Var;
        this.c = i10;
        this.e = context;
        this.f = e6Var;
