...
public final class e4 extends m20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public static void G0(Context context, int i10, final TL_payments.starRefProgram starrefprogram, long j3, d6 d6Var, boolean z10) {
        long[] jArr;
        float f7;
        String str;
        String str2;
        ...
        final org.telegram.ui.ActionBar.e3 j10 = ok.j(1, context, d6Var, false);
        long[] jArr2 = {j3};
        ...
        if (starrefprogram.daily_revenue_per_user.positive()) {
            ...
            frameLayout3.setBackground(h6.b0(AndroidUtilities.dp(10.0f), h6.v0(h6.h5, d6Var)));
            ...
            textView2.setBackground(h6.b0(AndroidUtilities.dp(10.0f), h6.v0(h6.uj, d6Var)));
        ...
        int i11 = h6.h5;
        frameLayout5.setBackground(h6.b0(dp, h6.v0(i11, d6Var)));
        ...
        textView3.setBackground(h6.b0(AndroidUtilities.dp(f7), h6.v0(h6.Oh, d6Var)));
        ...
        int i13 = h6.a7;
        linearLayout2.setBackground(h6.b0(dp2, h6.v0(i13, d6Var)));
        ...
        int i14 = h6.r5;
        imageView2.setColorFilter(new PorterDuffColorFilter(h6.v0(i14, d6Var), mode));
        ...
        if (i16 <= 0) {
            ...
            if (i16 < 12 || i16 % 12 != 0) {
                ...
                if (j3 < 0) {
                    ...
                    linearLayout3.setBackground(h6.b0(AndroidUtilities.dp(28.0f), h6.v0(i13, d6Var)));
                    int dp3 = AndroidUtilities.dp(28.0f);
                    int v03 = h6.v0(i13, d6Var);
                    int v = h6.v(h6.v0(i13, d6Var), h6.v0(h6.i6, d6Var));
                    linearLayout3.setBackground(h6.i0(dp3, dp3, dp3, dp3, v03, v, v));
                    ...
                    textView8.setTextColor(h6.v0(i12, d6Var));
                    linearLayout3.addView(textView8, y5.t(-2, -2, 16, 6, 0, 0, 0));
                    ImageView imageView3 = new ImageView(context);
                    imageView3.setScaleType(scaleType);
                    imageView3.setColorFilter(new PorterDuffColorFilter(h6.v0(i14, d6Var), mode));
                    ...
                    public final void onClick(View view) {
                        switch (i17) {
                            case 0:
                                ...
                                if (U != null) {
                                    org.telegram.ui.ActionBar.e3 e3Var = j10;
                                    e3Var.dismiss();
                                    Bundle bundle = new Bundle();
                                    bundle.putLong("user_id", starrefprogram.bot_id);
                                    U.presentFragment(new z3(bundle, e3Var));
                                    break;
                                }
                                break;
                            default:
                ...
                dVar.setOnClickListener(new v3(dVar, jArr, i10, starrefprogram, j10, j3, z10, context, d6Var, user));
                ...
                if (linearLayout == null) {
                    ...
                    d6Var2 = d6Var;
                    linearLayout4.setOnClickListener(new m3(i10, j10, d6Var2, linearLayout4, jArr, l3Var));
                } else {
                    d6Var2 = d6Var;
                }
                final int i18 = 0;
                ...
                j10.fixNavigationBar(h6.v0(i11, d6Var2));
                j10.show();
            }
            str = userName;
        ...
        dVar2.setOnClickListener(new v3(dVar2, jArr, i10, starrefprogram, j10, j3, z10, context, d6Var, user));
        j10.setOnDismissListener(new ci.f1(6));
    ...
    public static org.telegram.ui.ActionBar.e3 H0(Context context, int i10, TL_payments.connectedBotStarRef connectedbotstarref, long j3, d6 d6Var) {
        ...
        view.setBackground(h6.K(AndroidUtilities.dp(40.0f), h6.v0(connectedbotstarref.revoked ? h6.wj : h6.Oh, d6Var)));
        ...
        if (connectedbotstarref.participants > 0) {
            FrameLayout frameLayout2 = new FrameLayout(context);
            frameLayout2.setBackground(h6.b0(AndroidUtilities.dp(50.0f), h6.v0(h6.h5, d6Var)));
            frameLayout.addView(frameLayout2, y5.d(-2, -2.0f, 49, 0.0f, 66.0f, 0.0f, 0.0f));
            TextView textView = new TextView(context);
            textView.setTypeface(AndroidUtilities.bold());
            textView.setTextSize(1, 12.0f);
            textView.setBackground(h6.b0(AndroidUtilities.dp(9.5f), h6.v0(connectedbotstarref.revoked ? h6.wj : h6.uj, d6Var)));
        ...
        int i16 = h6.a7;
        linearLayout3.setBackground(h6.b0(dp, h6.v0(i16, d6Var)));
        ...
        textView3.setTextColor(h6.v0(i15, d6Var));
        ...
        if (connectedbotstarref.revoked) {
            ...
            linearLayout4.setBackground(h6.b0(AndroidUtilities.dp(28.0f), h6.v0(i16, d6Var)));
            w9 w9Var2 = new w9(context);
            ...
            textView6.setTextColor(h6.v0(i15, d6Var));
            if (j3 >= 0) {
        ...
        textView7.setGravity(17);
        textView7.setTextColor(h6.v0(i12, d6Var));
        int dp2 = AndroidUtilities.dp(8.0f);
        int v03 = h6.v0(i16, d6Var);
        int v = h6.v(h6.v0(i16, d6Var), h6.v0(h6.i6, d6Var));
        textView7.setBackground(h6.i0(dp2, dp2, dp2, dp2, v03, v, v));
        ...
        j11.fixNavigationBar(h6.v0(h6.h5, d6Var2));
        org.telegram.ui.ActionBar.m2 U = LaunchActivity.U();
