...
public final class e4 extends o20 implements NotificationCenter.NotificationCenterDelegate {
    public final long P;
    ...
    */
    public static void G0(Context context, int i10, final TL_payments.starRefProgram starrefprogram, long j3, d6 d6Var, boolean z10) {
        ...
        final org.telegram.ui.ActionBar.f3 j10 = ul.j(1, context, d6Var, false);
        long[] jArr2 = {j3};
        ...
        w9Var2.e(user, h9Var);
        z5.a(w9Var2);
        frameLayout2.addView(w9Var2, x5.e(60, 60, 119));
        ...
        frameLayout4.addView(w9Var3, x5.e(60, 60, 119));
        ...
        int i12 = h6.G6;
        ul.o(i12, d6Var, textView4, 1, 20.0f);
        ...
        ul.o(i12, d6Var, textView6, 1, 14.0f);
        ...
        if (i16 <= 0) {
            ...
            if (i16 < 12 || i16 % 12 != 0) {
                ...
                if (j3 < 0) {
                    ...
                    ul.o(i12, d6Var, textView7, 1, 14.0f);
                    ...
                    linearLayout3.addView(w9Var4, x5.n(28, 28));
                ...
                d90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfo), new di.a(context, 1)));
                d90Var.setGravity(17);
                d90Var.setTextSize(1, 12.0f);
                d90Var.setTextColor(h6.v0(h6.B6, d6Var));
        ...
        d90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfo), new di.a(context, 1)));
        d90Var2.setGravity(17);
        d90Var2.setTextSize(1, 12.0f);
        d90Var2.setTextColor(h6.v0(h6.B6, d6Var));
        d90Var2.setLinkTextColor(h6.v0(h6.gc, d6Var));
    ...
    public static org.telegram.ui.ActionBar.f3 H0(Context context, int i10, TL_payments.connectedBotStarRef connectedbotstarref, long j3, d6 d6Var) {
        ...
        h9 h9Var = new h9((d6) null);
        linearLayout3.addView(w9Var, x5.n(28, 28));
        TextView textView3 = new TextView(context);
        ...
        z5.a(linearLayout3);
        TextView textView4 = new TextView(context);
        ul.o(i15, d6Var, textView4, 1, 14.0f);
        textView4.setGravity(17);
        if (connectedbotstarref.revoked) {
            org.telegram.messenger.z0.m(R.string.ChannelAffiliateProgramLinkTextRevoked, textView4);
            user = user2;
            linearLayout = linearLayout3;
        } else {
            user = user2;
        ...
        if (connectedbotstarref.revoked) {
            ...
            TextView textView5 = new TextView(context);
            ul.o(i15, d6Var, textView5, 1, 14.0f);
            ...
            linearLayout4.addView(w9Var2, x5.n(28, 28));
            TextView textView6 = new TextView(context);
