...
public final class e4 extends r20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public static void G0(Context context, int i10, final TL_payments.starRefProgram starrefprogram, long j3, f6 f6Var, boolean z10) {
        ...
        final org.telegram.ui.ActionBar.f3 j10 = rk.j(1, context, f6Var, false);
        long[] jArr2 = {j3};
        ...
        v9Var2.e(user, g9Var);
        b6.a(v9Var2);
        frameLayout2.addView(v9Var2, y5.e(60, 60, 119));
        if (starrefprogram.daily_revenue_per_user.positive()) {
            ...
            textView2.setText(w7.R0(sb2.toString(), 0.75f, new oq[1]));
        ...
        v9 v9Var3 = new v9(context);
        v9Var3.setRoundRadius(AndroidUtilities.dp(30.0f));
        frameLayout4.addView(v9Var3, y5.e(60, 60, 119));
        ...
        f10.addView(frameLayout, y5.t(-2, -2, 1, 0, 0, 0, 0));
        TextView textView4 = new TextView(context);
        int i12 = j6.G6;
        rk.n(i12, f6Var, textView4, 1, 20.0f);
        textView4.setGravity(17);
        textView4.setText(LocaleController.getString(R.string.ChannelAffiliateProgramJoinTitle));
        textView4.setTypeface(AndroidUtilities.bold());
        f10.addView(textView4, y5.k(0.0f, 21.0f, 0.0f, 9.0f, -1, -2));
        ...
        f10.addView(linearLayout2, y5.t(-2, 28, 1, 4, 0, 4, 0));
        b6.a(linearLayout2);
        TextView textView6 = new TextView(context);
        rk.n(i12, f6Var, textView6, 1, 14.0f);
        ...
        if (i16 <= 0) {
            ...
            if (i16 < 12 || i16 % 12 != 0) {
                ...
                f10.addView(h, y5.k(0.0f, 0.0f, 0.0f, 22.0f, -1, -2));
                if (j3 < 0) {
                    TextView textView7 = new TextView(context);
                    rk.n(i12, f6Var, textView7, 1, 14.0f);
                    textView7.setGravity(17);
                    textView7.setText(LocaleController.getString(R.string.ChannelAffiliateProgramLinkSendTo));
                    f10.addView(textView7, y5.k(20.0f, 0.0f, 20.0f, 0.0f, -1, -2));
                    ...
                    v9 v9Var4 = new v9(context);
                    v9Var4.setRoundRadius(AndroidUtilities.dp(14.0f));
                    linearLayout3.addView(v9Var4, y5.n(28, 28));
                    ...
                    f10.addView(linearLayout3, y5.t(-2, 28, 1, 0, 11, 0, 20));
                    textView = textView8;
                ...
                k90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfo), new di.a(context, 1)));
                k90Var.setGravity(17);
                k90Var.setTextSize(1, 12.0f);
                k90Var.setTextColor(j6.v0(j6.B6, f6Var));
                k90Var.setLinkTextColor(j6.v0(j6.gc, f6Var));
                f10.addView(k90Var, y5.t(-1, -2, 49, 14, 14, 14, 6));
                j10.customView = f10;
                final int i17 = 1;
                v9Var2.setOnClickListener(new View.OnClickListener() { // from class: ei.n3
                ...
                dVar.setOnClickListener(new v3(dVar, jArr, i10, starrefprogram, j10, j3, z10, context, f6Var, user));
                j10.setOnDismissListener(new ci.f1(6));
                l3 l3Var = new l3(jArr, i10, v9Var3, v9Var, textView, 0);
                l3Var.run();
                if (linearLayout == null) {
                    ...
                    f6Var2 = f6Var;
                    linearLayout4.setOnClickListener(new m3(i10, j10, f6Var2, linearLayout4, jArr, l3Var));
                } else {
                    f6Var2 = f6Var;
                }
                final int i18 = 0;
                ...
                j10.fixNavigationBar(j6.v0(i11, f6Var2));
                j10.show();
            }
            str = userName;
        ...
        k90Var2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfo), new di.a(context, 1)));
        k90Var2.setGravity(17);
        k90Var2.setTextSize(1, 12.0f);
        k90Var2.setTextColor(j6.v0(j6.B6, f6Var));
        k90Var2.setLinkTextColor(j6.v0(j6.gc, f6Var));
        f10.addView(k90Var2, y5.t(-1, -2, 49, 14, 14, 14, 6));
        j10.customView = f10;
        final int i172 = 1;
        v9Var2.setOnClickListener(new View.OnClickListener() { // from class: ei.n3
            @Override // android.view.View.OnClickListener
        ...
        dVar2.setOnClickListener(new v3(dVar2, jArr, i10, starrefprogram, j10, j3, z10, context, f6Var, user));
        j10.setOnDismissListener(new ci.f1(6));
        l3 l3Var2 = new l3(jArr, i10, v9Var3, v9Var, textView, 0);
        l3Var2.run();
        if (linearLayout == null) {
        }
        final int i182 = 0;
    ...
    public static org.telegram.ui.ActionBar.f3 H0(Context context, int i10, TL_payments.connectedBotStarRef connectedbotstarref, long j3, f6 f6Var) {
        ...
        f7.addView(frameLayout, y5.t(-2, -2, 1, 0, 0, 0, 0));
        TextView textView2 = new TextView(context);
        int i15 = j6.G6;
        ...
        textView2.setTypeface(AndroidUtilities.bold());
        f7.addView(textView2, y5.k(20.0f, 16.0f, 20.0f, 9.33f, -1, -2));
        LinearLayout linearLayout3 = new LinearLayout(context);
        linearLayout3.setOrientation(0);
        int dp = AndroidUtilities.dp(28.0f);
        int i16 = j6.a7;
        linearLayout3.setBackground(j6.b0(dp, j6.v0(i16, f6Var)));
        v9 v9Var = new v9(context);
        v9Var.setRoundRadius(AndroidUtilities.dp(14.0f));
        g9 g9Var = new g9((f6) null);
        linearLayout3.addView(v9Var, y5.n(28, 28));
        TextView textView3 = new TextView(context);
        textView3.setTextSize(1, 13.0f);
        textView3.setTextColor(j6.v0(i15, f6Var));
        ...
        f7.addView(linearLayout3, y5.t(-2, 28, 1, 4, 0, 4, 0));
        b6.a(linearLayout3);
        TextView textView4 = new TextView(context);
        rk.n(i15, f6Var, textView4, 1, 14.0f);
        textView4.setGravity(17);
        if (connectedbotstarref.revoked) {
            ...
            if (j3 < 0) {
                ...
                objArr2[1] = str;
                objArr2[2] = formatPluralString;
                rk.q(i20, objArr2, textView4);
            }
        }
        f7.addView(textView4, y5.k(20.0f, 19.0f, 20.0f, 18.0f, -1, -2));
        if (connectedbotstarref.revoked) {
            j10 = j3;
            i12 = i15;
            linearLayout2 = null;
            ...
            f7.addView(linearLayout4, y5.t(-2, 28, 1, 0, 9, 0, 22));
        ...
        int v03 = j6.v0(i16, f6Var);
        int v = j6.v(j6.v0(i16, f6Var), j6.v0(j6.i6, f6Var));
        ...
        f7.addView(textView7, y5.d(-1, -2.0f, 7, 0.0f, 0.0f, 0.0f, 12.0f));
        ci.d dVar = new ci.d(context, f6Var, true);
        if (connectedbotstarref.revoked) {
        ...
        k90Var.setText(formatPluralString3);
        k90Var.setGravity(17);
        k90Var.setTextSize(i13, 12.0f);
        k90Var.setTextColor(j6.v0(j6.B6, f6Var));
        k90Var.setLinkTextColor(j6.v0(j6.gc, f6Var));
        f7.addView(k90Var, y5.t(-1, -2, 49, 14, 12, 14, 2));
        j11.customView = f7;
        i5 i5Var = new i5(connectedbotstarref, j11, f6Var, user, 8);
        if (!connectedbotstarref.revoked) {
            textView7.setOnClickListener(new ai.v0(i5Var, 16));
        }
        dVar.setOnClickListener(new u3(connectedbotstarref, i10, j11, context, j10, f6Var, i5Var));
        ...
        if (linearLayout2 != null) {
            ...
            linearLayout5.setOnClickListener(new u3(i10, j11, f6Var, linearLayout5, j3, context, connectedbotstarref));
        } else {
            connectedbotstarref2 = connectedbotstarref;
            f6Var2 = f6Var;
        }
        linearLayout.setOnClickListener(new ai.f2(9, j11, connectedbotstarref2));
        j11.fixNavigationBar(j6.v0(j6.h5, f6Var2));
        org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void F0(ArrayList arrayList, k61 k61Var) {
