    ...
    */
        ...
        if (this.r != null) {
            ...
            if (z10) {
                ...
                if (f7 != 1.0f) {
                    ...
                    interpolation = qr.f.getInterpolation(this.h);
                    ...
                    if (this.w) {
                        ...
                        yi0 yi0Var = this.e;
                        yi0Var.setBounds(0, 0, yi0Var.b, yi0Var.c);
                        yi0Var.draw(canvas);
                        canvas.restore();
                        if (yi0Var.k0) {
                            invalidate();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.F != size || this.r == null) {
            ...
            StaticLayout c10 = kw0.c(Emoji.replaceEmoji(this.n, textPaint.getFontMetricsInt(), false), textPaint, i12, Layout.Alignment.ALIGN_NORMAL, 0.0f, false, TextUtils.TruncateAt.END, i12, 1, true);
            this.r = c10;
        ...
        if (this.f) {
            dp2 = org.telegram.messenger.w1.C(4.0f, (int) this.s, dp2);
        }
