        ...
        switch (i10) {
            ...
            default:
                ...
                if (ChatObject.canBlockUsers(k0Var.f)) {
                    arrayList.add(v51.A(1, AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.CommunityPendingRequestsInfo), new v(k0Var, i12)), true)));
                } else {
                ...
                arrayList.add(v51.s(3, LocaleController.formatPluralString("CommunityPendingRequestsSuggestedHeader", t0Var.l, new Object[0])));
                t0Var.c(arrayList);
                break;
        }
    }
