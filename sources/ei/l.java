...
public final class l extends r20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void x0(l lVar, Context context) {
        if (lVar.T.W) {
            ...
            c01Var.c(string, i10 <= 0 ? LocaleController.getString(R.string.Infinity) : (i10 < 12 || i10 % 12 != 0) ? LocaleController.formatPluralString("Months", i10, new Object[0]) : LocaleController.formatPluralString("Years", i10 / 12, new Object[0]), null, null);
    ...
    public final void E0(ArrayList arrayList, m61 m61Var) {
        ...
        y51Var2.G = z7Var;
        y51Var2.B = -1L;
        y51Var2.B = this.X == null ? -1 : r3.commission_permille;
    ...
    public final View createView(Context context) {
        ...
        this.U = n90Var;
        n90Var.setTextColor(getThemedColor(j6.z6));
