...
public final /* synthetic */ class h1 implements Utilities.Callback2 {
    ...
    public /* synthetic */ h1(int i10, org.telegram.ui.ActionBar.m2 m2Var, nf.e eVar, org.telegram.ui.ActionBar.a2 a2Var) {
        this.a = 7;
        this.b = i10;
        this.c = m2Var;
        this.d = eVar;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.a) {
            ...
            case 1:
                ...
                if (tL_error != null) {
                    ...
                    if (arrayList.isEmpty()) {
                        ...
                        m2Var.showDialog(new fi.k0(m2Var, 0L, arrayList, new r4(m2Var, chat, this.b, 1)));
                        break;
                    }
                }
                break;
            ...
            case 3:
                org.telegram.ui.Components.e0.Z((org.telegram.ui.Components.e0) this.c, (h5) this.d, this.b, (TLRPC.TL_messages_composeMessageWithAI) this.e, (TLRPC.TL_composedMessageWithAI) obj, (TLRPC.TL_error) obj2);
                break;
            case 4:
                org.telegram.ui.Components.e0.V((org.telegram.ui.Components.e0) this.c, (h5) this.d, this.b, (TLRPC.TL_messages_composeRichMessageWithAI) this.e, (TLRPC.TL_composedRichMessageWithAI) obj, (TLRPC.TL_error) obj2);
                break;
            case 5:
            ...
            case 6:
                ...
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        ...
                        alertDialog$Builder.a.setOnDismissListener(new r5(e3Var, 10));
                        ...
                        if (U != null) {
                            if (str2 != null) {
                                ...
                                if (U instanceof PasskeysActivity) {
                                    ...
                                    ConnectionsManager.getInstance(i14).sendRequestTyped(new TL_account.getPasskeys(), new org.telegram.messenger.a(), new l6(e3Var, passkey, str2, 3));
                                    break;
                                }
                            }
                        }
            ...
            default:
                ...
                AndroidUtilities.runOnUIThread(new jr0(m2Var2, tL_error3, eVar, a2Var2, 28));
                break;
        }
    }
