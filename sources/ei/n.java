...
public final class n extends FrameLayout {
    ...
    public n(Activity activity, f6 f6Var) {
        ...
        c90Var.setLinkTextColor(j6.v0(j6.gc, f6Var));
    ...
    */
    public final void a(final bo boVar, final MessageObject messageObject, sf sfVar, sf sfVar2) {
        boolean z10;
        float measureText;
        float measureText2;
        ...
        if (messageMedia != null) {
            ...
            if (photo2 == null) {
                ...
                textView2.setOnClickListener(new ai.v0(sfVar, 13));
                setOnClickListener(new p5(this, boVar, messageObject, str2, 1));
                imageView.setOnClickListener(new ai.v0(sfVar2, 14));
            }
        ...
        textView22.setOnClickListener(new ai.v0(sfVar, 13));
        setOnClickListener(new p5(this, boVar, messageObject, str2, 1));
        imageView.setOnClickListener(new ai.v0(sfVar2, 14));
    }
}
