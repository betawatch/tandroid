...
public final class n extends FrameLayout {
    ...
    public n(Activity activity, e6 e6Var) {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(i6.v0(i6.de, e6Var), PorterDuff.Mode.SRC_IN));
    ...
    */
    public final void a(final bo boVar, final MessageObject messageObject, qf qfVar, qf qfVar2) {
        boolean z10;
        float measureText;
        float measureText2;
        ...
        c90 c90Var = this.h;
        CharSequence replaceEmoji2 = Emoji.replaceEmoji(charSequence, c90Var.getPaint().getFontMetricsInt(), false);
        ...
        if (messageMedia != null) {
            ...
            if (document != null) {
                u9Var.k(ImageLocation.getForDocument(messageObject.sponsoredMedia.document), "48_48", ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 48), messageObject.sponsoredMedia.document), "48_48", 0L, null, null, 0);
            } else {
                ...
                if (photo != null) {
                    ...
                    u9Var.k(ImageLocation.getForPhoto(closestPhotoSizeWithSize, messageObject.sponsoredMedia.photo), "48_48", ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(messageObject.sponsoredMedia.photo.sizes, 48, true, closestPhotoSizeWithSize, false), messageObject.sponsoredMedia.photo), "48_48", 0L, null, null, 0);
                }
            }
        } else {
            ...
            if (photo2 == null) {
                ...
                c90Var.setText(replaceEmoji2);
                c90Var.setOnLinkPressListener(new b90() { // from class: ei.m
                    ...
                    public final void a(ClickableSpan clickableSpan) {
                        ...
                        bo boVar2 = boVar;
                        if (boVar2 != null) {
                            boVar2.J9(messageObject, false, false);
                        }
                        if (clickableSpan instanceof URLSpan) {
                            ...
                            if (boVar2 != null && url != null && (url.startsWith("$") || url.startsWith("#"))) {
                                boVar2.da(url, true);
                                return;
                            }
                        }
                ...
                textView2.setOnClickListener(new ai.v0(qfVar, 13));
                setOnClickListener(new p5(this, boVar, messageObject, str2, 1));
                imageView.setOnClickListener(new ai.v0(qfVar2, 14));
            }
            TLRPC.PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(photo2.sizes, 48, true, null, true);
            u9Var.k(ImageLocation.getForPhoto(closestPhotoSizeWithSize2, messageObject.sponsoredPhoto), "48_48", ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(messageObject.sponsoredPhoto.sizes, 48, true, closestPhotoSizeWithSize2, false), messageObject.sponsoredPhoto), "48_48", 0L, null, null, 0);
            u9Var.setVisibility(0);
            imageView.setVisibility(8);
        }
        z10 = true;
        ...
        int i102 = i6.Oh;
        e6 e6Var2 = this.a;
        spannableStringBuilder2.setSpan(new ForegroundColorSpan(i6.v0(i102, e6Var2)), 0, spannableStringBuilder2.length(), 33);
        ...
        textView22.setOnClickListener(new ai.v0(qfVar, 13));
        setOnClickListener(new p5(this, boVar, messageObject, str2, 1));
        imageView.setOnClickListener(new ai.v0(qfVar2, 14));
    }
}
