...
public abstract class x extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (e7 < 1.0f) {
                ...
                float f16 = f15 * e;
                int l1 = j6.l1(f16, f5Var.a(wVar.h, false));
                m6 m6Var3 = m6Var;
                if (m6Var3.T != l1) {
                    m6Var3.T = l1;
                    str = str2;
                ...
                m6Var3.r(j6.l1(f16, f5Var.a(wVar.h, false)));
                m6Var3.m(rectF);
                m6Var3.draw(canvas);
                canvas.restore();
            } else {
    ...
    public void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), TLObject.FLAG_30), wl.C(109.0f, 1, TLObject.FLAG_30));
    }
