...
public final /* synthetic */ class q3 implements Utilities.Callback {
    ...
    public /* synthetic */ q3(Object obj, Context context, int i10, long j3, e6 e6Var, int i11) {
        this.a = i11;
        this.b = obj;
        this.c = context;
        this.d = i10;
    ...
    public final void run(Object obj) {
        switch (this.a) {
            case 0:
                ...
                final e6 e6Var = this.f;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: ei.r3
                        ...
                        switch (i10) {
                            case 0:
                                ...
                                if (userFull2 != null && userFull2.starref_program != null) {
                                    f3Var.dismiss();
                                    e4.G0(context, i11, userFull2.starref_program, j3, e6Var, true);
                                    break;
                                }
                                break;
                            default:
                                ...
                                if (userFull3 != null && userFull3.starref_program != null) {
                                    f3Var.dismiss();
                                    e4.G0(context, i11, userFull3.starref_program, j3, e6Var, true);
                                    break;
                                }
                                break;
                        }
                        ...
                        switch (i12) {
                            case 0:
                                ...
                                if (userFull22 != null && userFull22.starref_program != null) {
                                    f3Var2.dismiss();
                                    e4.G0(context2, i13, userFull22.starref_program, j10, e6Var2, true);
                                    break;
                                }
                                break;
                            default:
                                ...
                                if (userFull3 != null && userFull3.starref_program != null) {
                                    f3Var2.dismiss();
                                    e4.G0(context2, i13, userFull3.starref_program, j10, e6Var2, true);
                                    break;
                                }
                                break;
                        }
