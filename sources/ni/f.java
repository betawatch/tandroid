...
public final class f implements n5.b {
    ...
    public boolean G(k.a aVar, MenuItem menuItem) {
        return ((ActionMode.Callback) this.a).onActionItemClicked(o(aVar), new l.r((Context) this.b, (l0.a) menuItem));
    }
    ...
    public boolean H(k.a aVar, Menu menu) {
        ...
        if (menu2 == null) {
            menu2 = new l.a0((Context) this.b, (l.k) menu);
            mVar.put(menu, menu2);
        }
    ...
    public bf.f I(String str) {
        ...
        dVar.f(dVar.n);
        cf.a F1 = dVar.j.F1(new a1(27, dVar.k, dVar.m));
    ...
    public void m(m4.e eVar) {
        ...
        while (atomicBoolean.get()) {
            ...
            m4.e eVar2 = eVar;
            d0.U(a0Var.l, new x1(a0Var, t(eVar.a), new m3(this, dVar, atomicBoolean2, eVar2, atomicBoolean, 10)));
    ...
    */
    public void y(int i10, String str, HashMap hashMap) {
        ...
        if (trim.charAt(0) == '(') {
            Matcher matcher = d91.z0.matcher(trim);
            int i11 = 0;
            while (true) {
                if (!matcher.find()) {
                    break;
    ...
    public void z(String str, HashMap hashMap, boolean[] zArr, int i10) {
        ...
        zArr[0] = false;
        String trim = str.trim();
        Matcher matcher = d91.x0.matcher(trim);
        if (matcher.find()) {
            trim = trim.substring(matcher.group(0).length());
        } else {
            Matcher matcher2 = d91.y0.matcher(trim);
            if (matcher2.find()) {
