...
public final class a extends z5.a {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof a) {
            a aVar = (a) obj;
            if (w7.a(this.a, aVar.a) && Arrays.equals(this.b, aVar.b) && w7.a(c(this.c), c(aVar.c)) && w7.a(c(this.d), c(aVar.d)) && w7.a(c(this.e), c(aVar.e)) && w7.a(c(this.f), c(aVar.f)) && w7.a(b(this.h), b(aVar.h)) && w7.a(c(this.n), c(aVar.n))) {
                return true;
            }
        }
        return false;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        r8.c(parcel, 3, this.b);
        r8.d(parcel, 4, this.c);
        r8.d(parcel, 5, this.d);
        r8.d(parcel, 6, this.e);
        r8.d(parcel, 7, this.f);
        r8.g(parcel, 8, this.h);
        r8.d(parcel, 9, this.n);
        r8.r(parcel, q6);
    }
}
