...
public abstract class v7 {
    public static NinePatchDrawable a(Bitmap bitmap, Rect rect, int i10, int i11) {
        ...
        StringBuilder l4 = hg.k0.l("center pixel is outside bitmap: (", i10, ", ", i11, ") for ");
        l4.append(bitmap.getWidth());
        l4.append("x");
        l4.append(bitmap.getHeight());
    ...
    */
    public static NinePatchDrawable b(Bitmap[] bitmapArr, float[] fArr, float f7, float f10, int i10, gh.f fVar) {
        float f11;
        int i11;
        char c10;
        Bitmap bitmap;
