...
public abstract /* synthetic */ class j0 {
    public static z3.b a(z3.m mVar, byte[] bArr, int i10) {
        e9.f0 u10 = e9.i0.u();
        mVar.M(bArr, 0, i10, z3.l.c, new ai.f3(u10, 10));
    ...
    public static ia.c f(int i10, n4.y yVar) {
        ...
        if (((HashMap) yVar.b) == null) {
            yVar.b = new HashMap();
        }
        ((HashMap) yVar.b).put(z7.w.class, sVar);
        return new ia.c((String) yVar.a, ((HashMap) yVar.b) == null ? Collections.EMPTY_MAP : DesugarCollections.unmodifiableMap(new HashMap((HashMap) yVar.b)));
    }
