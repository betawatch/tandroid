...
public final class c1 implements q {
    ...
    public final void d(int i10, m1 m1Var) {
        ...
        bundle2.putInt(m1.f, m1Var.a);
        bundle2.putString(m1.g, m1Var.b);
        bundle2.putBundle(m1.h, m1Var.c);
        h hVar = (h) this.a;
        Parcel obtain = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("androidx.media3.session.IMediaController");
    ...
    public final boolean equals(Object obj) {
        ...
        return Objects.equals(this.a.asBinder(), ((c1) obj).a.asBinder());
    }
    ...
    public final void g(int i10, i1 i1Var, b2.x0 x0Var, boolean z10, boolean z11) {
        ...
        i iVar = this.a;
        if (i11 < 2) {
            Bundle f7 = i1Var.e(x0Var, z10, true).f(i11);
            h hVar = (h) iVar;
        ...
        Bundle f10 = i1Var.e(x0Var, z10, z11).f(i11);
        Bundle bundle = new Bundle();
        bundle.putBoolean(h1.a, r32);
        bundle.putBoolean(h1.b, z12);
        h hVar2 = (h) iVar;
        obtain = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("androidx.media3.session.IMediaController");
    ...
    public final void i(int i10, q1 q1Var) {
        Bundle bundle = new Bundle();
        bundle.putInt(q1.e, q1Var.a);
        bundle.putBundle(q1.f, q1Var.b);
        bundle.putLong(q1.g, q1Var.c);
        o1 o1Var = q1Var.d;
        if (o1Var != null) {
