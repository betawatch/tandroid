...
public final class c1 {
    ...
    static {
        ...
        b2.g1 g1Var = b2.k1.a;
        b2.n0 n0Var = b2.n0.K;
        F = new c1(null, 0, j1Var, a1Var, a1Var, 0, v0Var, 0, false, x1Var, g1Var, 0, n0Var, 1.0f, b2.e.h, d2.d.d, b2.l.c, 0, false, false, 1, 0, 1, false, false, n0Var, 5000L, 15000L, 3000L, s1.b, q1.F);
        String str = e2.d0.a;
    ...
    public final c1 a(s1 s1Var) {
        ...
        boolean p5 = k1Var.p();
        j1 j1Var = this.c;
        e2.d.g(p5 || j1Var.a.b < k1Var.o());
        return new c1(this.a, this.b, j1Var, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, s1Var, this.E);
    }
    ...
    public final c1 b(int i10, int i11, boolean z10) {
        ...
        j1 j1Var = this.c;
        e2.d.g(p5 || j1Var.a.b < k1Var.o());
        return new c1(this.a, this.b, j1Var, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, z10, i10, i11, i12, z11, this.w, this.z, this.A, this.B, this.C, this.D, this.E);
    }

    public final c1 c(b2.k1 k1Var, j1 j1Var, int i10) {
        e2.d.g(k1Var.p() || j1Var.a.b < k1Var.o());
        return new c1(this.a, this.b, j1Var, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, i10, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, this.D, this.E);
    }
    ...
    public final c1 d(q1 q1Var) {
        ...
        j1 j1Var = this.c;
        e2.d.g(p5 || j1Var.a.b < k1Var.o());
        return new c1(this.a, this.b, j1Var, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, this.D, q1Var);
    }
    ...
    public final c1 e(b2.x0 x0Var, boolean z10, boolean z11) {
        ...
        d2.d dVar = !x0Var.a(28) ? d2.d.d : this.p;
        if (x0Var.a(23)) {
            i10 = this.r;
            z12 = this.s;
        } else {
        ...
        e2.d.g(z13);
        return new c1(this.a, this.b, a11, b10, b11, this.f, this.g, this.h, this.i, this.l, k1Var2, this.k, n0Var, f10, eVar, dVar, this.q, i10, z12, this.t, this.u, this.x, this.y, this.v, this.w, n0Var2, this.A, this.B, this.C, s1Var, this.E);
    }
    ...
    public final Bundle f(int i10) {
        ...
        j1 j1Var = this.c;
        if (i10 < 3 || !j1Var.equals(j1.l)) {
            bundle.putBundle(Y, j1Var.b(i10));
        }
        b2.a1 a1Var = this.d;
        if (i10 < 3 || !j1.k.a(a1Var)) {
            bundle.putBundle(a0, a1Var.c(i10));
        }
        b2.a1 a1Var2 = this.e;
        if (i10 < 3 || !j1.k.a(a1Var2)) {
        ...
        if (!dVar2.equals(dVar)) {
            ...
            bundle11.putLong(d2.d.f, dVar2.b);
        ...
        if (!s1Var2.equals(s1Var)) {
            ...
            bundle13.putParcelableArrayList(s1.c, e2.d.p(s1Var2.a, new w1(16)));
