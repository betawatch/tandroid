...
public final class g1 extends Binder implements j {
    ...
    public static i9.w I0(a0 a0Var, r rVar, int i10, f1 f1Var, e2.h hVar) {
        if (a0Var.j()) {
            return i9.u.b;
        }
        i9.w wVar = (i9.w) f1Var.h(a0Var, rVar, i10);
        i9.c0 c0Var = new i9.c0();
        wVar.a(new i5(a0Var, c0Var, hVar, wVar, 23), i9.q.a);
        return c0Var;
    }

    public static void O0(a0 a0Var, r rVar, int i10, q1 q1Var) {
        try {
            q qVar = rVar.d;
            e2.d.h(qVar);
            qVar.i(i10, q1Var);
    ...
    public static k2.v P0(e2.h hVar) {
        return new k2.v(new k2.v(hVar, 5), 4);
    }

    public final void G0(i iVar, int i10, m1 m1Var, int i11, f1 f1Var) {
        ...
        try {
            ...
            if (a0Var != null && !a0Var.j()) {
                ...
                if (t10 == null) {
                    ...
                    e2.d0.U(a0Var.l, new x0(this, t10, m1Var, a0Var, i10, i11, f1Var));
                    Binder.restoreCallingIdentity(clearCallingIdentity);
                }
            }
        } finally {
    ...
    public final i1 H0(i1 i1Var) {
        e9.i0 i0Var = i1Var.D.a;
        e9.f0 u10 = e9.i0.u();
    ...
    public final int K0(r rVar, k1 k1Var, int i10) {
        if (k1Var.m0(17)) {
            ni.f fVar = this.b;
    ...
    public final void M0(i iVar, int i10, int i11, f1 f1Var) {
        r t10 = this.b.t(iVar.asBinder());
        if (t10 != null) {
            N0(t10, i10, i11, f1Var);
        }
    }

    public final void N0(r rVar, int i10, int i11, f1 f1Var) {
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            a0 a0Var = (a0) this.a.get();
            if (a0Var != null && !a0Var.j()) {
                e2.d0.U(a0Var.l, new ii.i0(this, rVar, i11, a0Var, i10, f1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public final void R0(i iVar, int i10, Bundle bundle, boolean z10) {
        ...
        try {
            M0(iVar, i10, 31, new y0(new ah.b(25, new ai.k(2, b2.k0.a(bundle), z10), new u0(4)), 1));
        } catch (RuntimeException e) {
    ...
    public final void S0(i iVar, int i10, Bundle bundle, long j3) {
        ...
        try {
            M0(iVar, i10, 31, new y0(new ah.b(25, new z1(b2.k0.a(bundle), j3, 2), new u0(4)), 1));
        } catch (RuntimeException e) {
            e2.a.o("MediaSessionStub", "Ignoring malformed Bundle for MediaItem", e);
        }
    }
    ...
    public final void T0(i iVar, int i10, IBinder iBinder, boolean z10) {
        ...
        try {
            ...
            M0(iVar, i10, 20, new y0(new ah.b(25, new ai.k(3, u10.i(), z10), new u0(4)), 1));
        } catch (RuntimeException e) {
            e2.a.o("MediaSessionStub", "Ignoring malformed Bundle for MediaItem", e);
        }
    }
    ...
    public final void U0(i iVar, int i10, IBinder iBinder, int i11, long j3) {
        ...
        if (i11 == -1 || i11 >= 0) {
            try {
                ...
                M0(iVar, i10, 20, new y0(new ah.b(25, new j2.d(u10.i(), i11, j3, 2), new u0(4)), 1));
            } catch (RuntimeException e) {
                e2.a.o("MediaSessionStub", "Ignoring malformed Bundle for MediaItem", e);
            }
        }
        ...
        switch (i10) {
                ...
                if (G04 != null && bundle != null) {
                    try {
                        ...
                        try {
                            ...
                            int i12 = a2.a;
                            int i13 = a2.b;
                            r rVar = new r(a0Var, i12, i13, z12, new c1(G04, i13), a2.e);
            ...
            case 3016:
                ...
                if (G05 != null && bundle2 != null && bundle3 != null) {
                    try {
                        int i14 = bundle2.getInt(m1.f, 0);
                        if (i14 != 0) {
                            m1Var = new m1(i14);
                        } else {
                            String string = bundle2.getString(m1.g);
                            string.getClass();
                            Bundle bundle4 = bundle2.getBundle(m1.h);
                            if (bundle4 == null) {
                                bundle4 = Bundle.EMPTY;
                            }
                            m1Var = new m1(string, bundle4);
                        }
                        g1Var = this;
                        g1Var.G0(G05, readInt4, m1Var, 0, new y0(new j2.e(25, m1Var, bundle3), 1));
            ...
            case 3019:
                ...
                if (G08 != null && readInt9 >= 0) {
                    M0(G08, readInt8, 20, new k2.v(new n0(this, readInt9, 4), 4));
                    return true;
                }
                return true;
            case 3020:
                ...
                if (G09 != null && readInt11 >= 0 && readInt12 >= readInt11) {
                    M0(G09, readInt10, 20, new k2.v(new m0(this, readInt11, readInt12), 4));
                    return true;
                }
                return true;
            case 3021:
                ...
                if (G011 != null && readInt15 >= 0 && readInt16 >= 0) {
                    ...
                    M0(G011, readInt14, 20, P0(new e2.h() { // from class: m4.s0
                        ...
                        public final void accept(Object obj) {
                            switch (i15) {
                                case 0:
                                    ((k1) obj).M(readInt15, readInt16);
                                    break;
                                default:
                                    ((k1) obj).q0(readInt15, readInt16);
                                    break;
                            }
                        }
                    }));
            ...
            case 3023:
                ...
                if (G012 != null && readInt18 >= 0 && readInt19 >= readInt18 && readInt20 >= 0) {
                    M0(G012, readInt17, 20, P0(new e2.h() { // from class: m4.r0
                        @Override // e2.h
                        public final void accept(Object obj) {
                            ((k1) obj).r0(readInt18, readInt19, readInt20);
                        }
                    }));
                    return true;
                }
            ...
            case 3029:
                ...
                if (G018 != null && bundle6 != null) {
                    try {
                        ...
                        final int i16 = 2;
                        M0(G018, readInt26, 20, new y0(new ah.b(26, new f1() { // from class: m4.q0
                            @Override // m4.f1
            ...
            case 3030:
                ...
                if (G019 != null && bundle7 != null && readInt28 >= 0) {
                    try {
                        ...
                        final int i17 = 0;
                        M0(G019, readInt27, 20, new y0(new ah.b(26, new f1() { // from class: m4.q0
                            @Override // m4.f1
            ...
            case 3031:
                ...
                if (G020 != null && readStrongBinder != null) {
                    try {
                        ...
                        M0(G020, readInt29, 20, new y0(new ah.b(26, new i2.y(3, u10.i()), new j2.e(28)), 1));
            ...
            case 3032:
                ...
                if (G021 != null && readStrongBinder2 != null && readInt31 >= 0) {
                    try {
                        ...
                        M0(G021, readInt30, 20, new y0(new ah.b(26, new i2.y(2, u11.i()), new n0(this, readInt31, 3)), 1));
            ...
            case 3037:
                ...
                if (G026 != null && readInt36 >= 0) {
                    M0(G026, readInt35, 10, new k2.v(new n0(this, readInt36, 0), 4));
                    return true;
                }
                return true;
            case 3038:
                ...
                if (G027 != null) {
                    M0(G027, readInt37, 5, P0(new e2.h() { // from class: m4.w0
                        @Override // e2.h
                        public final void accept(Object obj) {
                            ((k1) obj).g(readLong);
                        }
            ...
            case 3039:
                ...
                if (G028 != null && readInt39 >= 0) {
                    M0(G028, readInt38, 10, new k2.v(new j2.d(this, readInt39, readLong2, 1), 4));
                    return true;
                }
                return true;
            case 3040:
            ...
            case 3049:
                ...
                if (G038 != null && readString != null && bundle12 != null) {
                    if (!TextUtils.isEmpty(readString)) {
                        try {
                            y0 y0Var = new y0(new j2.e(27, readString, b2.c1.a(bundle12)), 1);
                            g1Var = this;
                            g1Var.G0(G038, readInt48, null, 40010, y0Var);
            ...
            case 3050:
                ...
                if (G039 != null && bundle13 != null) {
                    try {
                        G0(G039, readInt49, null, 40010, new y0(new u0(b2.c1.a(bundle13), 5), 1));
                ...
                if (G040 != null && readInt51 >= 0) {
                    ...
                    M0(G040, readInt50, 33, P0(new e2.h() { // from class: m4.s0
                        ...
                        public final void accept(Object obj) {
                            switch (i20) {
                                case 0:
                                    ((k1) obj).M(readInt51, readInt52);
                                    break;
                                default:
                                    ((k1) obj).q0(readInt51, readInt52);
                                    break;
                            }
                        }
                    }));
            ...
            case 3054:
                ...
                if (G043 != null) {
                    M0(G043, readInt57, 34, P0(new e2.h() { // from class: m4.v0
                        @Override // e2.h
                        public final void accept(Object obj) {
                            ((k1) obj).J(readInt58, z14);
                        }
                    }));
                    return true;
                }
            ...
            case 3055:
                ...
                if (G044 != null && bundle14 != null && readInt60 >= 0) {
                    try {
                        ...
                        final int i21 = 1;
                        M0(G044, readInt59, 20, new y0(new ah.b(26, new f1() { // from class: m4.q0
                            @Override // m4.f1
            ...
            case 3056:
                ...
                if (G045 != null && readStrongBinder3 != null && readInt62 >= 0 && readInt63 >= readInt62) {
                    try {
                        ...
                        M0(G045, readInt61, 20, new y0(new ah.b(26, new k2.v(u12.i(), 3), new m0(this, readInt62, readInt63)), 1));
                ...
                switch (i10) {
                    case 4001:
                        ...
                        if (G047 != null) {
                            ...
                            g1Var = this;
                            g1Var.G0(G047, readInt65, null, 50000, new y0(new u0(nVar, 1), 0));
                            return true;
                        }
                        return true;
                    case 4002:
                        ...
                        if (G048 != null) {
                            ...
                            G0(G048, readInt66, null, 50004, new y0(new j2.e(readString2, 26), 0));
                            return true;
                        }
                        return true;
                    case 4003:
                        ...
                        if (G049 != null) {
                            if (TextUtils.isEmpty(readString3)) {
                                ...
                                G0(G049, readInt67, null, 50003, new y0(new j2.e(readString3, readInt68, readInt69, nVar), 0));
                            }
                        }
                        return true;
                    case 4004:
                        ...
                        if (G050 != null) {
                            if (TextUtils.isEmpty(readString4)) {
                                ...
                                G0(G050, readInt70, null, 50005, new y0(new u0(readString4, nVar, 3), 0));
                            }
                        }
                        return true;
                    case 4005:
                        ...
                        if (G051 != null) {
                            if (TextUtils.isEmpty(readString5)) {
                                ...
                                G0(G051, readInt71, null, 50006, new y0(new u0(readString5, readInt72, readInt73, nVar), 0));
                            }
                        }
                        return true;
                    case 4006:
                        ...
                        if (G052 != null) {
                            if (TextUtils.isEmpty(readString6)) {
                                ...
                                G0(G052, readInt74, null, 50001, new y0(new u0(readString6, nVar, 2), 0));
                            }
                        }
                        return true;
                    case 4007:
                        ...
                        if (G053 != null) {
                            ...
                            G0(G053, readInt75, null, 50002, new y0(new j2.e(readString7, 23), 0));
                            return true;
                        }
                        return true;
                    default:
