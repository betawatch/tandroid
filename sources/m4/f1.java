...
public final class f1 extends Binder implements j {
    ...
    public static i9.w I0(a0 a0Var, r rVar, int i10, e1 e1Var, e2.h hVar) {
        ...
        wVar.a(new i5(a0Var, c0Var, hVar, wVar, 23), i9.q.a);
        return c0Var;
    }
    ...
    public static k2.v P0(e2.h hVar) {
        return new k2.v(new k2.v(hVar, 6), 5);
    }
        ...
        try {
            ...
            if (a0Var != null && !a0Var.j()) {
                ...
                if (t10 == null) {
                    ...
                    e2.d0.U(a0Var.l, new w0(this, t10, l1Var, a0Var, i10, i11, e1Var));
                    Binder.restoreCallingIdentity(clearCallingIdentity);
                }
            }
        } finally {
    ...
    public final void N0(r rVar, int i10, int i11, e1 e1Var) {
        ...
        try {
            a0 a0Var = (a0) this.a.get();
            if (a0Var != null && !a0Var.j()) {
                e2.d0.U(a0Var.l, new ii.i0(this, rVar, i11, a0Var, i10, e1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public final void Q0(i iVar, int i10, int i11) {
        ...
        M0(iVar, i10, 25, P0(new ai.m(i11, 4)));
    }
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            ...
            case 3005:
                ...
                if (G0 != null) {
                    M0(G0, readInt, 26, P0(new ai.i(13)));
                    return true;
                }
                return true;
            case 3006:
            ...
            case 3008:
                ...
                return true;
            case 3009:
                R0(m.G0(parcel.readStrongBinder()), parcel.readInt(), (Bundle) w7.t.a(parcel, Bundle.CREATOR), parcel.readInt() != 0);
                return true;
            case 3010:
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (a0Var3 != null && !a0Var3.j()) {
                                ...
                                try {
                                    try {
                                        e2.d0.U(a0Var3.l, new i5(this, rVar, a0Var3, G04, 22));
                                    } catch (Throwable th2) {
                                        th = th2;
                                        throw th;
                                    }
            ...
            case 3016:
                ...
                Bundle bundle2 = (Bundle) w7.t.a(parcel, creator);
                ...
                if (G05 != null && bundle2 != null && bundle3 != null) {
                    try {
                        ...
                        f1Var = this;
                        f1Var.G0(G05, readInt4, l1Var, 0, new x0(new q0(0, l1Var, bundle3), 1));
            ...
            case 3017:
                ...
                if (G06 != null && (readInt6 == 2 || readInt6 == 0 || readInt6 == 1)) {
                    M0(G06, readInt5, 15, P0(new ai.m(readInt6, 3)));
                    return true;
                }
                return true;
            case 3018:
            ...
            case 3019:
                ...
                if (G08 != null && readInt9 >= 0) {
                    M0(G08, readInt8, 20, new k2.v(new m0(this, readInt9, 4), 5));
                    return true;
                }
                return true;
            case 3020:
                ...
                if (G09 != null && readInt11 >= 0 && readInt12 >= readInt11) {
                    M0(G09, readInt10, 20, new k2.v(new l0(this, readInt11, readInt12), 5));
                    return true;
                }
                return true;
            case 3021:
                ...
                if (G010 != null) {
                    M0(G010, readInt13, 20, P0(new ai.i(17)));
                    return true;
                }
                return true;
            case 3022:
                ...
                if (G011 != null && readInt15 >= 0 && readInt16 >= 0) {
                    final int i15 = 1;
                    M0(G011, readInt14, 20, P0(new e2.h() { // from class: m4.s0
                        @Override // e2.h
            ...
            case 3023:
                ...
                if (G012 != null && readInt18 >= 0 && readInt19 >= readInt18 && readInt20 >= 0) {
                    M0(G012, readInt17, 20, P0(new e2.h() { // from class: m4.r0
                        @Override // e2.h
                        public final void accept(Object obj) {
            ...
            case 3024:
                ...
                if (G013 != null && (t10 = this.b.t(G013.asBinder())) != null) {
                    N0(t10, readInt21, 1, P0(new g3(2, this, t10)));
                    return true;
                }
                return true;
            case 3025:
                ...
                if (G014 != null && (t11 = this.b.t(G014.asBinder())) != null) {
                    N0(t11, readInt22, 1, P0(new ai.i(5)));
                    return true;
                }
                return true;
            case 3026:
                ...
                if (G015 != null) {
                    M0(G015, readInt23, 2, P0(new ai.i(15)));
                    return true;
                }
                return true;
            case 3027:
                ...
                if (G016 != null && bundle5 != null) {
                    try {
                        M0(G016, readInt24, 13, P0(new f3(new b2.v0(bundle5.getFloat(b2.v0.e, 1.0f), bundle5.getFloat(b2.v0.f, 1.0f)), 6)));
            ...
            case 3029:
                ...
                if (G018 != null && bundle6 != null) {
                    try {
                        ...
                        final int i16 = 2;
                        M0(G018, readInt26, 20, new x0(new ah.b(27, new e1() { // from class: m4.p0
                            @Override // m4.e1
            ...
            case 3030:
                ...
                if (G019 != null && bundle7 != null && readInt28 >= 0) {
                    try {
                        ...
                        final int i17 = 0;
                        M0(G019, readInt27, 20, new x0(new ah.b(27, new e1() { // from class: m4.p0
                            @Override // m4.e1
            ...
            case 3031:
                ...
                if (G020 != null && readStrongBinder != null) {
                    try {
                        ...
                        int i19 = 3;
                        M0(G020, readInt29, 20, new x0(new ah.b(27, new i2.y(i19, u10.i()), new q0(i19)), 1));
            ...
            case 3032:
                ...
                if (G021 != null && readStrongBinder2 != null && readInt31 >= 0) {
                    try {
                        ...
                        e9.f0 u11 = e9.i0.u();
                        for (int i20 = 0; i20 < a13.size(); i20++) {
                            Bundle bundle9 = (Bundle) a13.get(i20);
                            bundle9.getClass();
                            u11.b(b2.k0.a(bundle9));
                        }
                        M0(G021, readInt30, 20, new x0(new ah.b(27, new i2.y(2, u11.i()), new m0(this, readInt31, 3)), 1));
            ...
            case 3033:
                ...
                Bundle bundle10 = (Bundle) w7.t.a(parcel, Bundle.CREATOR);
                if (G022 != null && bundle10 != null) {
                    try {
                        M0(G022, readInt32, 19, P0(new f3(b2.n0.b(bundle10), 8)));
            ...
            case 3034:
                ...
                if (G023 != null && (t12 = this.b.t(G023.asBinder())) != null) {
                    N0(t12, readInt33, 3, P0(new ai.i(14)));
                    return true;
                }
                return true;
            case 3035:
                ...
                if (G024 != null) {
                    ...
                    try {
                        ...
                        if (a0Var4 != null && !a0Var4.j()) {
                            e2.d0.U(a0Var4.l, new ki.l(7, this, G024));
                            return true;
                        }
                        return true;
                    } finally {
            ...
            case 3036:
                ...
                if (G025 != null) {
                    M0(G025, readInt34, 4, P0(new ai.i(16)));
                    return true;
                }
                return true;
            case 3037:
                ...
                if (G026 != null && readInt36 >= 0) {
                    M0(G026, readInt35, 10, new k2.v(new m0(this, readInt36, 0), 5));
                    return true;
                }
                return true;
            case 3038:
            ...
            case 3039:
                ...
                if (G028 != null && readInt39 >= 0) {
                    M0(G028, readInt38, 10, new k2.v(new j2.d(this, readInt39, readLong2, 1), 5));
                    return true;
                }
                return true;
            case 3040:
                ...
                if (G029 != null && (t13 = this.b.t(G029.asBinder())) != null) {
                    N0(t13, readInt40, 11, P0(new ai.i(8)));
                    return true;
                }
                return true;
            case 3041:
                ...
                if (G030 != null && (t14 = this.b.t(G030.asBinder())) != null) {
                    N0(t14, readInt41, 12, P0(new ai.i(11)));
                    return true;
                }
                return true;
            case 3042:
                ...
                if (G031 != null) {
                    M0(G031, readInt42, 6, P0(new ai.i(10)));
                    return true;
                }
                return true;
            case 3043:
                ...
                if (G032 != null) {
                    M0(G032, readInt43, 8, P0(new ai.i(6)));
                    return true;
                }
                return true;
            case 3044:
                ...
                if (G033 != null) {
                    M0(G033, readInt44, 27, P0(new f3(surface, 7)));
                    return true;
                }
                return true;
            case 3045:
                ...
                if (G034 != null) {
                    ...
                    try {
                        ...
                        if (a0Var5 != null && !a0Var5.j()) {
                            ...
                            if (t17 != null) {
                                e2.d0.U(a0Var5.l, new ki.l(8, this, t17));
                            }
                            return true;
                        }
                        return true;
            ...
            case 3046:
                ...
                if (G035 != null && (t15 = this.b.t(G035.asBinder())) != null) {
                    N0(t15, readInt45, 7, P0(new ai.i(9)));
                    return true;
                }
                return true;
            case 3047:
                ...
                if (G036 != null && (t16 = this.b.t(G036.asBinder())) != null) {
                    N0(t16, readInt46, 9, P0(new ai.i(12)));
                    return true;
                }
                return true;
            case 3048:
                ...
                if (G037 != null && bundle11 != null) {
                    try {
                        M0(G037, readInt47, 29, P0(new g3(1, this, b2.q1.b(bundle11))));
            ...
            case 3049:
                ...
                if (G038 != null && readString != null && bundle12 != null) {
                    if (!TextUtils.isEmpty(readString)) {
                        try {
                            x0 x0Var = new x0(new q0(2, readString, b2.c1.a(bundle12)), 1);
                            f1Var = this;
            ...
            case 3050:
                ...
                if (G039 != null && bundle13 != null) {
                    try {
                        G0(G039, readInt49, null, 40010, new x0(new q0(b2.c1.a(bundle13), 10), 1));
            ...
            case 3051:
                ...
                if (G040 != null && readInt51 >= 0) {
                    final int i21 = 0;
                    M0(G040, readInt50, 33, P0(new e2.h() { // from class: m4.s0
                        @Override // e2.h
                        public final void accept(Object obj) {
                            switch (i21) {
                                case 0:
            ...
            case 3052:
                ...
                if (G041 != null) {
                    M0(G041, readInt53, 34, P0(new ai.m(readInt54, 2)));
                    return true;
                }
                return true;
            case 3053:
                ...
                if (G042 != null) {
                    M0(G042, readInt55, 34, P0(new ai.m(readInt56, 1)));
                    return true;
                }
                return true;
            case 3054:
            ...
            case 3055:
                ...
                if (G044 != null && bundle14 != null && readInt60 >= 0) {
                    try {
                        ...
                        final int i22 = 1;
                        M0(G044, readInt59, 20, new x0(new ah.b(27, new e1() { // from class: m4.p0
                            @Override // m4.e1
            ...
            case 3056:
                ...
                if (G045 != null && readStrongBinder3 != null && readInt62 >= 0 && readInt63 >= readInt62) {
                    try {
                        ...
                        e9.f0 u12 = e9.i0.u();
                        for (int i23 = 0; i23 < a15.size(); i23++) {
                            Bundle bundle15 = (Bundle) a15.get(i23);
                            bundle15.getClass();
                            u12.b(b2.k0.a(bundle15));
                        }
                        M0(G045, readInt61, 20, new x0(new ah.b(27, new k2.v(u12.i(), 4), new l0(this, readInt62, readInt63)), 1));
            ...
            case 3057:
                ...
                Bundle bundle16 = (Bundle) w7.t.a(parcel, Bundle.CREATOR);
                boolean z15 = parcel.readInt() != 0;
                if (G046 != null && bundle16 != null) {
                    try {
                        M0(G046, readInt64, 35, P0(new t0(0, b2.e.a(bundle16), z15)));
                ...
                switch (i10) {
                    case 4001:
                        ...
                        if (G047 != null) {
                            ...
                            f1Var = this;
                            f1Var.G0(G047, readInt65, null, 50000, new x0(new q0(nVar, 6), 0));
                            return true;
                        }
                        return true;
                    case 4002:
                        ...
                        if (G048 != null) {
                            ...
                            G0(G048, readInt66, null, 50004, new x0(new q0(readString2, 1), 0));
                            return true;
                        }
                        return true;
                    case 4003:
                    ...
                    case 4004:
                        ...
                        if (G050 != null) {
                            if (TextUtils.isEmpty(readString4)) {
                                ...
                                G0(G050, readInt70, null, 50005, new x0(new q0(8, readString4, nVar), 0));
                            }
                        }
                        return true;
                    case 4005:
                        ...
                        if (G051 != null) {
                            if (TextUtils.isEmpty(readString5)) {
                                ...
                                G0(G051, readInt71, null, 50006, new x0(new q0(readString5, readInt72, readInt73, nVar), 0));
                            }
                        }
                        return true;
                    case 4006:
                        ...
                        if (G052 != null) {
                            if (TextUtils.isEmpty(readString6)) {
                                ...
                                G0(G052, readInt74, null, 50001, new x0(new q0(7, readString6, nVar), 0));
                            }
                        }
                        return true;
                    case 4007:
                        ...
                        if (G053 != null) {
                            ...
                            G0(G053, readInt75, null, 50002, new x0(new j2.e(readString7, 28), 0));
                            return true;
                        }
                        return true;
                    default:
