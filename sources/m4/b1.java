...
public final class b1 extends Binder implements j {
    ...
    public b1(a0 a0Var) {
        ...
        this.b = new ni.f(a0Var);
        this.c = DesugarCollections.synchronizedSet(new HashSet());
        this.d = e9.z0.r;
    }

    public static i9.w I0(a0 a0Var, r rVar, int i10, a1 a1Var, e2.h hVar) {
        if (a0Var.j()) {
            return i9.u.b;
        }
        i9.w wVar = (i9.w) a1Var.h(a0Var, rVar, i10);
        i9.c0 c0Var = new i9.c0();
        wVar.a(new h5(a0Var, c0Var, hVar, wVar, 23), i9.q.a);
        return c0Var;
    }

    public static void O0(a0 a0Var, r rVar, int i10, l1 l1Var) {
        try {
            q qVar = rVar.d;
            e2.d.h(qVar);
            qVar.i(i10, l1Var);
    ...
    public final void G0(i iVar, int i10, h1 h1Var, int i11, a1 a1Var) {
        ...
        try {
            ...
            if (a0Var != null && !a0Var.j()) {
                ...
                if (t10 == null) {
                    ...
                    e2.d0.U(a0Var.l, new t0(this, t10, h1Var, a0Var, i10, i11, a1Var));
                    Binder.restoreCallingIdentity(clearCallingIdentity);
                }
            }
        } finally {
    ...
    public final void J0(i iVar, int i10) {
        ...
        M0(iVar, i10, 26, P0(new j2.e(27)));
    }

    public final int K0(r rVar, f1 f1Var, int i10) {
        if (f1Var.m0(17)) {
            ni.f fVar = this.b;
    ...
    public final void M0(i iVar, int i10, int i11, a1 a1Var) {
        r t10 = this.b.t(iVar.asBinder());
        if (t10 != null) {
            N0(t10, i10, i11, a1Var);
        }
    }

    public final void N0(r rVar, int i10, int i11, a1 a1Var) {
        long clearCallingIdentity = Binder.clearCallingIdentity();
        try {
            a0 a0Var = (a0) this.a.get();
            if (a0Var != null && !a0Var.j()) {
                e2.d0.U(a0Var.l, new ii.i0(this, rVar, i11, a0Var, i10, a1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public final void R0(i iVar, int i10, Bundle bundle, boolean z10) {
        ...
        try {
            M0(iVar, i10, 31, new u0(new ah.b(27, new ai.k(2, b2.k0.a(bundle), z10), new p0(17)), 1));
        } catch (RuntimeException e) {
    ...
    public final void S0(i iVar, int i10, Bundle bundle, long j3) {
        ...
        try {
            M0(iVar, i10, 31, new u0(new ah.b(27, new z1(b2.k0.a(bundle), j3, 2), new p0(17)), 1));
        } catch (RuntimeException e) {
            e2.a.o("MediaSessionStub", "Ignoring malformed Bundle for MediaItem", e);
        }
    }
    ...
    public final void T0(i iVar, int i10, IBinder iBinder, boolean z10) {
        ...
        try {
            ...
            M0(iVar, i10, 20, new u0(new ah.b(27, new ai.k(4, u10.i(), z10), new p0(17)), 1));
        } catch (RuntimeException e) {
            e2.a.o("MediaSessionStub", "Ignoring malformed Bundle for MediaItem", e);
        }
    }
    ...
    public final void U0(i iVar, int i10, IBinder iBinder, int i11, long j3) {
        ...
        if (i11 == -1 || i11 >= 0) {
            try {
                ...
                M0(iVar, i10, 20, new u0(new ah.b(27, new j2.d(u10.i(), i11, j3, 2), new p0(17)), 1));
            } catch (RuntimeException e) {
                e2.a.o("MediaSessionStub", "Ignoring malformed Bundle for MediaItem", e);
            }
        }
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            ...
            case 3006:
                ...
                if (G02 != null) {
                    M0(G02, readInt2, 26, P0(new i2.y(3, z10)));
                    return true;
                }
                return true;
            case 3007:
            ...
            case 3013:
                ...
                if (G03 != null) {
                    M0(G03, readInt3, 1, P0(new i2.y(2, z11)));
                    return true;
                }
                return true;
            case 3014:
                ...
                if (G04 != null && bundle != null) {
                    try {
                        ...
                        try {
                            ...
                            int i12 = a2.a;
                            int i13 = a2.b;
                            r rVar = new r(a0Var, i12, i13, z12, new x0(G04, i13), a2.e);
            ...
            case 3016:
                ...
                if (G05 != null && bundle2 != null && bundle3 != null) {
                    try {
                        ...
                        b1Var = this;
                        b1Var.G0(G05, readInt4, h1Var, 0, new u0(new j2.e(29, h1Var, bundle3), 1));
            ...
            case 3017:
                ...
                if (G06 != null && (readInt6 == 2 || readInt6 == 0 || readInt6 == 1)) {
                    M0(G06, readInt5, 15, P0(new i2.w(readInt6, 5)));
                    return true;
                }
                return true;
            case 3018:
                ...
                if (G07 != null) {
                    M0(G07, readInt7, 14, P0(new i2.y(4, z13)));
                    return true;
                }
                return true;
            case 3019:
                ...
                if (G08 != null && readInt9 >= 0) {
                    M0(G08, readInt8, 20, new le.b(new n0(this, readInt9, 4), 5));
                    return true;
                }
                return true;
            case 3020:
                ...
                if (G09 != null && readInt11 >= 0 && readInt12 >= readInt11) {
                    M0(G09, readInt10, 20, new le.b(new m0(this, readInt11, readInt12), 5));
                    return true;
                }
                return true;
            case 3021:
                ...
                if (G010 != null) {
                    M0(G010, readInt13, 20, P0(new p0(15)));
                    return true;
                }
                return true;
            case 3022:
                ...
                if (G011 != null && readInt15 >= 0 && readInt16 >= 0) {
                    M0(G011, readInt14, 20, P0(new dh.c(readInt15, readInt16, 4)));
                    return true;
                }
                return true;
            case 3023:
            ...
            case 3024:
                ...
                if (G013 != null && (t10 = this.b.t(G013.asBinder())) != null) {
                    N0(t10, readInt21, 1, P0(new ah.b(26, this, t10)));
                    return true;
                }
                return true;
            case 3025:
                ...
                if (G014 != null && (t11 = this.b.t(G014.asBinder())) != null) {
                    N0(t11, readInt22, 1, P0(new j2.e(25)));
                    return true;
                }
                return true;
            case 3026:
                ...
                if (G015 != null) {
                    M0(G015, readInt23, 2, P0(new p0(12)));
                    return true;
                }
                return true;
            case 3027:
            ...
            case 3028:
                ...
                if (G017 != null && readFloat > 0.0f) {
                    M0(G017, readInt25, 13, P0(new i2.v(readFloat, 1)));
                    return true;
                }
                return true;
            case 3029:
                ...
                if (G018 != null && bundle6 != null) {
                    try {
                        ...
                        final int i15 = 2;
                        M0(G018, readInt26, 20, new u0(new ah.b(28, new a1() { // from class: m4.o0
                            @Override // m4.a1
                            public final Object h(a0 a0Var4, r rVar2, int i16) {
                                switch (i15) {
                                }
            ...
            case 3030:
                ...
                if (G019 != null && bundle7 != null && readInt28 >= 0) {
                    try {
                        ...
                        final int i16 = 0;
                        M0(G019, readInt27, 20, new u0(new ah.b(28, new a1() { // from class: m4.o0
                            @Override // m4.a1
                            public final Object h(a0 a0Var4, r rVar2, int i162) {
                                switch (i16) {
                                }
            ...
            case 3031:
                ...
                if (G020 != null && readStrongBinder != null) {
                    try {
                        ...
                        M0(G020, readInt29, 20, new u0(new ah.b(28, new i2.z(3, u10.i()), new p0(6)), 1));
                ...
                if (G021 != null && readStrongBinder2 != null && readInt31 >= 0) {
                    try {
                        ...
                        for (int i18 = 0; i18 < a13.size(); i18++) {
                            Bundle bundle9 = (Bundle) a13.get(i18);
                            bundle9.getClass();
                            u11.b(b2.k0.a(bundle9));
                        }
                        M0(G021, readInt30, 20, new u0(new ah.b(28, new i2.z(2, u11.i()), new n0(this, readInt31, 3)), 1));
            ...
            case 3034:
                ...
                if (G023 != null && (t12 = this.b.t(G023.asBinder())) != null) {
                    N0(t12, readInt33, 3, P0(new p0(10)));
                    return true;
                }
                return true;
            case 3035:
                ...
                if (G024 != null) {
                    ...
                    try {
                        ...
                        if (a0Var4 != null && !a0Var4.j()) {
                            e2.d0.U(a0Var4.l, new g0(1, this, G024));
                            return true;
                        }
                        return true;
                    } finally {
            ...
            case 3036:
                ...
                if (G025 != null) {
                    M0(G025, readInt34, 4, P0(new p0(13)));
                    return true;
                }
                return true;
            case 3037:
                ...
                if (G026 != null && readInt36 >= 0) {
                    M0(G026, readInt35, 10, new le.b(new n0(this, readInt36, 0), 5));
                    return true;
                }
                return true;
            case 3038:
                ...
                if (G027 != null) {
                    M0(G027, readInt37, 5, P0(new e2.h() { // from class: m4.s0
                        @Override // e2.h
                        public final void accept(Object obj) {
                            ((f1) obj).g(readLong);
                        }
            ...
            case 3040:
                ...
                if (G029 != null && (t13 = this.b.t(G029.asBinder())) != null) {
                    N0(t13, readInt40, 11, P0(new j2.e(28)));
                    return true;
                }
                return true;
            case 3041:
                ...
                if (G030 != null && (t14 = this.b.t(G030.asBinder())) != null) {
                    N0(t14, readInt41, 12, P0(new p0(3)));
                    return true;
                }
                return true;
            case 3042:
                ...
                if (G031 != null) {
                    M0(G031, readInt42, 6, P0(new p0(1)));
                    return true;
                }
                return true;
            case 3043:
                ...
                if (G032 != null) {
                    M0(G032, readInt43, 8, P0(new j2.e(26)));
                    return true;
                }
                return true;
            case 3044:
                ...
                if (G034 != null) {
                    ...
                    try {
                        ...
                        if (a0Var5 != null && !a0Var5.j()) {
                            ...
                            if (t17 != null) {
                                e2.d0.U(a0Var5.l, new g0(2, this, t17));
                            }
                            return true;
                        }
                        return true;
            ...
            case 3046:
                ...
                if (G035 != null && (t15 = this.b.t(G035.asBinder())) != null) {
                    N0(t15, readInt45, 7, P0(new p0(0)));
                    return true;
                }
                return true;
            case 3047:
                ...
                if (G036 != null && (t16 = this.b.t(G036.asBinder())) != null) {
                    N0(t16, readInt46, 9, P0(new p0(4)));
                    return true;
                }
                return true;
            case 3048:
                ...
                if (G037 != null && bundle11 != null) {
                    try {
                        M0(G037, readInt47, 29, P0(new ah.b(25, this, q1.b(bundle11))));
            ...
            case 3049:
                ...
                if (G038 != null && readString != null && bundle12 != null) {
                    if (!TextUtils.isEmpty(readString)) {
                        try {
                            u0 u0Var = new u0(new p0(readString, 5, b2.c1.a(bundle12)), 1);
                            b1Var = this;
                            b1Var.G0(G038, readInt48, null, 40010, u0Var);
            ...
            case 3050:
                ...
                if (G039 != null && bundle13 != null) {
                    try {
                        G0(G039, readInt49, null, 40010, new u0(new p0(b2.c1.a(bundle13), 18), 1));
            ...
            case 3051:
                ...
                if (G040 != null && readInt51 >= 0) {
                    M0(G040, readInt50, 33, P0(new dh.c(readInt51, readInt52, 3)));
                    return true;
                }
                return true;
            case 3052:
                ...
                if (G041 != null) {
                    M0(G041, readInt53, 34, P0(new i2.w(readInt54, 4)));
                    return true;
                }
                return true;
            case 3053:
                ...
                if (G042 != null) {
                    M0(G042, readInt55, 34, P0(new i2.w(readInt56, 3)));
                    return true;
                }
                return true;
            case 3054:
                ...
                if (G043 != null) {
                    M0(G043, readInt57, 34, P0(new e2.h() { // from class: m4.r0
                        @Override // e2.h
                        public final void accept(Object obj) {
            ...
            case 3055:
                ...
                if (G044 != null && bundle14 != null && readInt60 >= 0) {
                    try {
                        ...
                        final int i19 = 1;
                        M0(G044, readInt59, 20, new u0(new ah.b(28, new a1() { // from class: m4.o0
                            @Override // m4.a1
                            public final Object h(a0 a0Var42, r rVar2, int i162) {
                                switch (i19) {
                                }
            ...
            case 3056:
                ...
                if (G045 != null && readStrongBinder3 != null && readInt62 >= 0 && readInt63 >= readInt62) {
                    try {
                        ...
                        e9.f0 u12 = e9.i0.u();
                        for (int i20 = 0; i20 < a15.size(); i20++) {
                            Bundle bundle15 = (Bundle) a15.get(i20);
                            bundle15.getClass();
                            u12.b(b2.k0.a(bundle15));
                        }
                        M0(G045, readInt61, 20, new u0(new ah.b(28, new le.b(u12.i(), 2), new m0(this, readInt62, readInt63)), 1));
                ...
                switch (i10) {
                    case 4001:
                        ...
                        if (G047 != null) {
                            ...
                            b1Var = this;
                            b1Var.G0(G047, readInt65, null, 50000, new u0(new p0(nVar, 11), 0));
                            return true;
                        }
                        return true;
                    case 4002:
                        ...
                        if (G048 != null) {
                            ...
                            G0(G048, readInt66, null, 50004, new u0(new p0(readString2, 2), 0));
                            return true;
                        }
                        return true;
                    case 4003:
                        ...
                        if (G049 != null) {
                            if (TextUtils.isEmpty(readString3)) {
                                ...
                                G0(G049, readInt67, null, 50003, new u0(new j2.e(readString3, readInt68, readInt69, nVar), 0));
                            }
                        }
                        return true;
                    case 4004:
                        ...
                        if (G050 != null) {
                            if (TextUtils.isEmpty(readString4)) {
                                ...
                                G0(G050, readInt70, null, 50005, new u0(new p0(readString4, 16, nVar), 0));
                            }
                        }
                        return true;
                    case 4005:
                        ...
                        if (G051 != null) {
                            if (TextUtils.isEmpty(readString5)) {
                                ...
                                G0(G051, readInt71, null, 50006, new u0(new p0(readString5, readInt72, readInt73, nVar), 0));
                            }
                        }
                        return true;
                    case 4006:
                        ...
                        if (G052 != null) {
                            if (TextUtils.isEmpty(readString6)) {
                                ...
                                G0(G052, readInt74, null, 50001, new u0(new p0(readString6, 14, nVar), 0));
                            }
                        }
                        return true;
                    case 4007:
                        ...
                        if (G053 != null) {
                            ...
                            G0(G053, readInt75, null, 50002, new u0(new j2.e(readString7, 23), 0));
                            return true;
                        }
                        return true;
                    default:
