...
public final class i1 {
    ...
    static {
        ...
        b2.g1 g1Var = b2.k1.a;
        b2.n0 n0Var = b2.n0.K;
        F = new i1(null, 0, p1Var, a1Var, a1Var, 0, v0Var, 0, false, x1Var, g1Var, 0, n0Var, 1.0f, b2.e.h, d2.d.d, b2.l.c, 0, false, false, 1, 0, 1, false, false, n0Var, 5000L, 15000L, 3000L, b2.s1.b, b2.q1.F);
        String str = e2.d0.a;
    ...
    public i1(b2.u0 u0Var, int i10, p1 p1Var, b2.a1 a1Var, b2.a1 a1Var2, int i11, b2.v0 v0Var, int i12, boolean z10, x1 x1Var, b2.k1 k1Var, int i13, b2.n0 n0Var, float f7, b2.e eVar, d2.d dVar, b2.l lVar, int i14, boolean z11, boolean z12, int i15, int i16, int i17, boolean z13, boolean z14, b2.n0 n0Var2, long j3, long j10, long j11, b2.s1 s1Var, b2.q1 q1Var) {
        this.a = u0Var;
        this.b = i10;
        this.c = p1Var;
        this.d = a1Var;
    ...
    public final i1 a(b2.s1 s1Var) {
        b2.k1 k1Var = this.j;
        boolean p5 = k1Var.p();
        p1 p1Var = this.c;
        e2.d.g(p5 || p1Var.a.b < k1Var.o());
        return new i1(this.a, this.b, p1Var, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, s1Var, this.E);
    }

    public final i1 b(int i10, int i11, boolean z10) {
        int i12 = this.y;
        ...
        p1 p1Var = this.c;
        e2.d.g(p5 || p1Var.a.b < k1Var.o());
        return new i1(this.a, this.b, p1Var, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, z10, i10, i11, i12, z11, this.w, this.z, this.A, this.B, this.C, this.D, this.E);
    }

    public final i1 c(b2.k1 k1Var, p1 p1Var, int i10) {
        e2.d.g(k1Var.p() || p1Var.a.b < k1Var.o());
        return new i1(this.a, this.b, p1Var, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, i10, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, this.D, this.E);
    }

    public final i1 d(b2.q1 q1Var) {
        b2.k1 k1Var = this.j;
        boolean p5 = k1Var.p();
        p1 p1Var = this.c;
        e2.d.g(p5 || p1Var.a.b < k1Var.o());
        return new i1(this.a, this.b, p1Var, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, this.D, q1Var);
    }

    public final i1 e(b2.x0 x0Var, boolean z10, boolean z11) {
        int i10;
        boolean z12;
        int i11;
        ...
        e2.d.g(z13);
        return new i1(this.a, this.b, a11, b10, b11, this.f, this.g, this.h, this.i, this.l, k1Var2, this.k, n0Var, f10, eVar, dVar, this.q, i10, z12, this.t, this.u, this.x, this.y, this.v, this.w, n0Var2, this.A, this.B, this.C, s1Var, this.E);
    }
    ...
    public final Bundle f(int i10) {
        ...
        p1 p1Var = this.c;
        if (i10 < 3 || !p1Var.equals(p1.l)) {
            bundle.putBundle(Y, p1Var.b(i10));
        }
        b2.a1 a1Var = this.d;
        if (i10 < 3 || !p1.k.a(a1Var)) {
            bundle.putBundle(a0, a1Var.c(i10));
        }
        b2.a1 a1Var2 = this.e;
        if (i10 < 3 || !p1.k.a(a1Var2)) {
        ...
        if (!s1Var2.equals(s1Var)) {
            ...
            bundle13.putParcelableArrayList(b2.s1.c, e2.d.p(s1Var2.a, new w1(16)));
