...
public final class a1 extends Binder implements j {
        ...
        try {
            ...
            if (a0Var != null && !a0Var.j()) {
                ...
                if (t10 == null) {
                    ...
                    e2.d0.U(a0Var.l, new s0(this, t10, g1Var, a0Var, i10, i11, z0Var));
                    Binder.restoreCallingIdentity(clearCallingIdentity);
                }
            }
        } finally {
    ...
    public final void N0(r rVar, int i10, int i11, z0 z0Var) {
        ...
        try {
            a0 a0Var = (a0) this.a.get();
            if (a0Var != null && !a0Var.j()) {
                e2.d0.U(a0Var.l, new ii.i0(this, rVar, i11, a0Var, i10, z0Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        ...
        switch (i10) {
                ...
                if (G04 != null && bundle != null) {
                    try {
                        ...
                        try {
                            ...
                            int i12 = a2.a;
                            int i13 = a2.b;
                            r rVar = new r(a0Var, i12, i13, z12, new w0(G04, i13), a2.e);
            ...
            case 3016:
                ...
                if (G05 != null && bundle2 != null && bundle3 != null) {
                    try {
                        int i14 = bundle2.getInt(g1.f, 0);
                        if (i14 != 0) {
                            g1Var = new g1(i14);
                        } else {
                            String string = bundle2.getString(g1.g);
                            string.getClass();
                            Bundle bundle4 = bundle2.getBundle(g1.h);
                            if (bundle4 == null) {
            ...
            case 3023:
                ...
                if (G012 != null && readInt18 >= 0 && readInt19 >= readInt18 && readInt20 >= 0) {
                    M0(G012, readInt17, 20, P0(new e2.h() { // from class: m4.p0
                        @Override // e2.h
                        public final void accept(Object obj) {
                            ((e1) obj).r0(readInt18, readInt19, readInt20);
                        }
                    }));
                    return true;
                }
            ...
            case 3024:
                ...
                if (G013 != null && (t10 = this.b.t(G013.asBinder())) != null) {
                    N0(t10, readInt21, 1, P0(new ah.b(27, this, t10)));
                    return true;
                }
                return true;
            case 3025:
            ...
            case 3029:
                ...
                if (G018 != null && bundle6 != null) {
                    try {
                        ...
                        final int i15 = 2;
                        M0(G018, readInt26, 20, new t0(new ah.b(29, new z0() { // from class: m4.n0
                            @Override // m4.z0
            ...
            case 3030:
                ...
                if (G019 != null && bundle7 != null && readInt28 >= 0) {
                    try {
                        ...
                        final int i16 = 0;
                        M0(G019, readInt27, 20, new t0(new ah.b(29, new z0() { // from class: m4.n0
                            @Override // m4.z0
            ...
            case 3038:
                ...
                if (G027 != null) {
                    M0(G027, readInt37, 5, P0(new e2.h() { // from class: m4.r0
                        @Override // e2.h
                        public final void accept(Object obj) {
                            ((e1) obj).g(readLong);
                        }
            ...
            case 3054:
                ...
                if (G043 != null) {
                    M0(G043, readInt57, 34, P0(new e2.h() { // from class: m4.q0
                        @Override // e2.h
                        public final void accept(Object obj) {
                            ((e1) obj).J(readInt58, z14);
                        }
                    }));
                    return true;
                }
            ...
            case 3055:
                ...
                if (G044 != null && bundle14 != null && readInt60 >= 0) {
                    try {
                        ...
                        final int i19 = 1;
                        M0(G044, readInt59, 20, new t0(new ah.b(29, new z0() { // from class: m4.n0
                            @Override // m4.z0
