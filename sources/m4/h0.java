    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        if (iMarker.getTag() instanceof cd0) {
            ...
            if (!dd0Var.C0) {
                ...
                int i10 = h6.ui;
                imageView.setColorFilter(new PorterDuffColorFilter(dd0Var.getThemedColor(i10), PorterDuff.Mode.MULTIPLY));
                dd0Var.a.setTag(Integer.valueOf(i10));
                dd0Var.C0 = true;
            }
            int i11 = 0;
            while (true) {
                ...
                if (xc0Var == null || xc0Var.e != iMarker) {
                    ...
                    dd0Var.I.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(xc0Var.e.getPosition(), this.a));
                }
            }
            ad0 ad0Var = dd0Var.x;
            ...
            if (cd0Var != null && dd0Var2.n0 != cd0Var) {
                dd0Var2.y0(false);
                ...
                dd0Var2.o0 = frameLayout2;
                frameLayout2.setBackgroundResource(R.drawable.venue_tooltip);
                dd0Var2.o0.getBackground().setColorFilter(new PorterDuffColorFilter(dd0Var2.getThemedColor(h6.h5), PorterDuff.Mode.MULTIPLY));
                frameLayout.addView(dd0Var2.o0, x5.c(71.0f, -2));
                dd0Var2.o0.setAlpha(0.0f);
                dd0Var2.o0.setOnClickListener(new pv(17, ad0Var, cd0Var));
                ...
                TextView f7 = q3.f(dd0Var2.o0, textView, x5.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 18.0f, 10.0f, 18.0f, 0.0f), context);
                ...
                dd0Var2.o0.addView(f7, x5.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 18.0f, 32.0f, 18.0f, 0.0f));
                textView.setText(cd0Var.c.title);
                f7.setText(LocaleController.getString(R.string.TapToSendLocation));
                FrameLayout frameLayout3 = new FrameLayout(context);
                frameLayout3.setBackground(h6.K(AndroidUtilities.dp(36.0f), u4.a(cd0Var.a)));
                frameLayout.addView(frameLayout3, x5.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                w9 w9Var = new w9(context);
                w9Var.f(a4.a.t(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), cd0Var.c.venue_type, "_64.png"), null, null);
                frameLayout3.addView(w9Var, x5.e(30, 30, 17));
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                ofFloat.addUpdateListener(new zc0(ad0Var, frameLayout3));
