    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        if (iMarker.getTag() instanceof hd0) {
            ...
            if (hd0Var != null && id0Var2.n0 != hd0Var) {
                ...
                id0Var2.o0.getBackground().setColorFilter(new PorterDuffColorFilter(id0Var2.getThemedColor(i6.h5), PorterDuff.Mode.MULTIPLY));
                frameLayout.addView(id0Var2.o0, x5.c(71.0f, -2));
                id0Var2.o0.setAlpha(0.0f);
                id0Var2.o0.setOnClickListener(new sv(17, fd0Var, hd0Var));
                ...
                TextView f7 = q3.f(id0Var2.o0, textView, x5.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 18.0f, 10.0f, 18.0f, 0.0f), context);
                ...
                frameLayout3.setBackground(i6.K(AndroidUtilities.dp(36.0f), u4.a(hd0Var.a)));
                frameLayout.addView(frameLayout3, x5.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                u9 u9Var = new u9(context);
                u9Var.f(a4.a.t(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), hd0Var.c.venue_type, "_64.png"), null, null);
