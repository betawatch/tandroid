    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        if (iMarker.getTag() instanceof jd0) {
            ...
            if (jd0Var != null && kd0Var2.n0 != jd0Var) {
                ...
                frameLayout.addView(kd0Var2.o0, y5.c(71.0f, -2));
                kd0Var2.o0.setAlpha(0.0f);
                kd0Var2.o0.setOnClickListener(new tv(17, hd0Var, jd0Var));
                ...
                TextView h = org.telegram.ui.Cells.c1.h(kd0Var2.o0, textView, y5.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 18.0f, 10.0f, 18.0f, 0.0f), context);
                ...
                kd0Var2.o0.addView(h, y5.d(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 18.0f, 32.0f, 18.0f, 0.0f));
                textView.setText(jd0Var.c.title);
                h.setText(LocaleController.getString(R.string.TapToSendLocation));
                FrameLayout frameLayout3 = new FrameLayout(context);
                frameLayout3.setBackground(j6.K(AndroidUtilities.dp(36.0f), v4.a(jd0Var.a)));
                frameLayout.addView(frameLayout3, y5.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                v9 v9Var = new v9(context);
                v9Var.f(a4.a.s(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), jd0Var.c.venue_type, "_64.png"), null, null);
                frameLayout3.addView(v9Var, y5.e(30, 30, 17));
