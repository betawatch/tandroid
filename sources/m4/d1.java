...
public final class d1 {
    ...
    static {
        ...
        b2.g1 g1Var = b2.k1.a;
        b2.n0 n0Var = b2.n0.K;
        F = new d1(null, 0, k1Var, a1Var, a1Var, 0, v0Var, 0, false, x1Var, g1Var, 0, n0Var, 1.0f, b2.e.h, d2.d.d, b2.l.c, 0, false, false, 1, 0, 1, false, false, n0Var, 5000L, 15000L, 3000L, s1.b, q1.F);
        String str = e2.d0.a;
    ...
    public final d1 a(s1 s1Var) {
        ...
        boolean p5 = k1Var.p();
        k1 k1Var2 = this.c;
        e2.d.g(p5 || k1Var2.a.b < k1Var.o());
        return new d1(this.a, this.b, k1Var2, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, s1Var, this.E);
    }
    ...
    public final d1 b(int i10, int i11, boolean z10) {
        ...
        k1 k1Var2 = this.c;
        e2.d.g(p5 || k1Var2.a.b < k1Var.o());
        return new d1(this.a, this.b, k1Var2, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, z10, i10, i11, i12, z11, this.w, this.z, this.A, this.B, this.C, this.D, this.E);
    }

    public final d1 c(b2.k1 k1Var, k1 k1Var2, int i10) {
        e2.d.g(k1Var.p() || k1Var2.a.b < k1Var.o());
        return new d1(this.a, this.b, k1Var2, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, i10, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, this.D, this.E);
    }
    ...
    public final d1 d(q1 q1Var) {
        ...
        k1 k1Var2 = this.c;
        e2.d.g(p5 || k1Var2.a.b < k1Var.o());
        return new d1(this.a, this.b, k1Var2, this.d, this.e, this.f, this.g, this.h, this.i, this.l, k1Var, this.k, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.x, this.y, this.v, this.w, this.z, this.A, this.B, this.C, this.D, q1Var);
    }
    ...
    public final d1 e(b2.x0 x0Var, boolean z10, boolean z11) {
        ...
        if (!a10 && a2 && !k1Var2.p()) {
            ...
            if (k1Var2.o() != 1) {
                ...
                while (true) {
                    ...
                    b2.h1 f7 = k1Var2.f(i13, new b2.h1(), true);
                    f7.c = 0;
                    u10.b(f7);
                    i13++;
                }
                m10.o = i11 - m10.n;
                m10.n = 0;
                k1Var2 = new b2.i1(e9.i0.z(m10), u10.i(), new int[]{0});
            }
        } else if (z10 || !a10) {
            k1Var2 = b2.k1.a;
        }
        ...
        if (!k1Var3.p() && a11.a.b >= k1Var3.o()) {
            z13 = false;
        }
        e2.d.g(z13);
        return new d1(this.a, this.b, a11, b10, b11, this.f, this.g, this.h, this.i, this.l, k1Var3, this.k, n0Var, f10, eVar, dVar, this.q, i10, z12, this.t, this.u, this.x, this.y, this.v, this.w, n0Var2, this.A, this.B, this.C, s1Var, this.E);
    }
    ...
    public final Bundle f(int i10) {
        ...
        k1 k1Var = this.c;
        if (i10 < 3 || !k1Var.equals(k1.l)) {
            bundle.putBundle(Y, k1Var.b(i10));
        }
        b2.a1 a1Var = this.d;
        if (i10 < 3 || !k1.k.a(a1Var)) {
            bundle.putBundle(a0, a1Var.c(i10));
        }
        b2.a1 a1Var2 = this.e;
        if (i10 < 3 || !k1.k.a(a1Var2)) {
        ...
        if (!k1Var2.equals(g1Var)) {
            ...
            for (int i18 = 0; i18 < o9; i18++) {
                b2.j1 m10 = k1Var2.m(i18, j1Var, 0L);
                m10.getClass();
            ...
            int i21 = 0;
            while (i21 < h) {
                b2.h1 f7 = k1Var2.f(i21, h1Var2, z12);
                f7.getClass();
            ...
            int i29 = 1;
            while (i29 < o9) {
                iArr[i29] = k1Var2.e(iArr[i29 - 1], i11, z10);
                i29++;
                i11 = 0;
                z10 = true;
            }
