...
public abstract class k {
    ...
    public static n4.m b(b2.n0 n0Var, String str, Uri uri, long j3, Bitmap bitmap) {
        ...
        if (n0Var.t != null) {
            g3Var.z(r7.intValue(), "android.media.metadata.YEAR");
        }
        if (uri != null) {
        ...
        if (n0Var.H != null) {
            g3Var.z(r6.intValue(), "androidx.media3.session.EXTRAS_KEY_MEDIA_TYPE_COMPAT");
        }
        if (bundle != null) {
        ...
        return new n4.m((Bundle) g3Var.b);
    }
    ...
    public static b2.c1 c(n4.i0 i0Var) {
        ...
        switch (i10) {
            case 1:
                if (i0Var.b()) {
                    return new b2.u(i10 == 1 && f7 == 1.0f);
                }
                return new b2.u();
            case 2:
                if (i0Var.b()) {
                    return new b2.f1(i10 == 2 && f7 == 1.0f);
                }
                return new b2.f1();
            case 3:
                return i0Var.b() ? new b2.d1(3, i0Var.a()) : new b2.d1(3);
            case 4:
                return i0Var.b() ? new b2.d1(4, i0Var.a()) : new b2.d1(4);
            case 5:
                return i0Var.b() ? new b2.d1(5, i0Var.a()) : new b2.d1(5);
            case 6:
                if (!i0Var.b()) {
                    return new b2.t0();
                }
    ...
    public static n4.i0 d(b2.c1 c1Var) {
        if (c1Var != null) {
            ...
            switch (f7) {
                case 1:
                    return new n4.i0(1, ((b2.u) c1Var).c ? 1.0f : 0.0f);
                case 2:
                    return new n4.i0(2, ((b2.f1) c1Var).c ? 1.0f : 0.0f);
                case 3:
                case 4:
                case 5:
                    return n4.i0.d(((b2.d1) c1Var).c, f7);
                case 6:
                    return n4.i0.c(((b2.t0) c1Var).b);
            }
        }
        return null;
    }
    ...
    public static int e(b2.e eVar) {
        l2.g bVar = Build.VERSION.SDK_INT >= 26 ? new n4.b(4) : new l2.g(4);
    ...
    public static int f(b2.c1 c1Var) {
        ...
        if (!(c1Var instanceof b2.d1)) {
            return c1Var instanceof b2.t0 ? 6 : 0;
        }
        int i10 = ((b2.d1) c1Var).b;
        int i11 = 3;
        if (i10 != 3) {
            i11 = 4;
            if (i10 != 4) {
