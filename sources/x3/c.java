    ...
    */
    public final int b(l lVar, n nVar) {
        ...
        if (i11 != 2) {
            ...
            ((h) lVar).f = 0;
            k0 b11 = b8.b(1684108385, lVar, new z(8));
            h hVar3 = (h) lVar;
            hVar3.t(8);
        ...
        z zVar2 = new z(16);
        long j15 = b8.b(1718449184, lVar, zVar2).b;
        d5.a.i(j15 >= 16);
        h hVar4 = (h) lVar;
        hVar4.g(zVar2.a, 0, 16, false);
        zVar2.C(0);
        int k10 = zVar2.k();
        int k11 = zVar2.k();
        int j16 = zVar2.j();
        ...
        if (k10 == 17) {
            ...
            this.e = new p(this.a, this.b, a1Var, "audio/g711-alaw", -1);
        } else if (k10 == 7) {
            this.e = new p(this.a, this.b, a1Var, "audio/g711-mlaw", -1);
        } else {
            if (k10 != 1) {
                if (k10 == 3) {
                    if (k13 == 32) {
                        ...
                        this.e = new p(this.a, this.b, a1Var, "audio/raw", u10);
                    }
                }
                u10 = 0;
                if (u10 == 0) {
