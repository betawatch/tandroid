        ...
        switch (this.a) {
            ...
            case 24:
                ...
                if (uyVar2.G.bot_admin_rights != null) {
                    uyVar2.getMessagesController().setUserAdminRole(-j28, uyVar2.getMessagesController().getUser(Long.valueOf(uyVar2.H)), uyVar2.G.bot_admin_rights, null, false, uyVar2, true, true, null, g0Var, new iu(g0Var, i12));
                    return;
                } else {
                    g0Var.run();
                    return;
