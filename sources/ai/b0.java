...
public abstract class b0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.e {
    ...
    public b0(Context context, ry ryVar, int i10, int i11) {
        super(context);
        ...
        ix ixVar = (ix) this;
        v vVar = new v(ixVar, false);
        this.E = vVar;
        v vVar2 = new v(ixVar, true);
        this.F = vVar2;
        ...
        qVar.setOnItemClickListener(new g(ixVar, 0));
        qVar.setOnItemLongClickListener(new a1.c(ixVar, 2));
        ...
        s sVar = new s(ixVar, context, mVar);
        this.U = sVar;
        ...
        q qVar2 = new q(ixVar, getContext(), 1);
        this.r = qVar2;
        getContext();
    ...
    public final void d() {
        ...
        if (p6Var != null) {
            p6Var.setAlpha(f11);
            p6Var.setVisibility(f11 > 0.0f ? 0 : 8);
        }
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (min != 0.0f) {
            ...
            org.telegram.ui.Components.p6 p6Var = this.T;
            p6Var.setPivotX(0.0f);
            p6Var.setScaleX(AndroidUtilities.lerp(1.0f, 0.95f, sVar.getTotalVisibility()));
            p6Var.setScaleY(AndroidUtilities.lerp(1.0f, 0.95f, sVar.getTotalVisibility()));
            p6Var.setTranslationY((((f10 + AndroidUtilities.dp(14.0f)) - ((p6Var.getMeasuredHeight() - p6Var.getTextHeight()) / f11)) + AndroidUtilities.dp(f7)) - (sVar.getTotalVisibility() * AndroidUtilities.dp(6.0f)));
            ...
            float a10 = org.telegram.ui.Cells.q3.a(lerp9, 2.0f, AndroidUtilities.lerp((dp5 / f11) - lerp9, 0.0f, f32), -dp5) + AndroidUtilities.dp(12.0f) + f12;
            p6Var.setTranslationX(a10);
            ...
            float translationX2 = (p6Var.getTranslationX() - AndroidUtilities.dpf2(3.33f)) + imageView.getMeasuredWidth();
            ImageView imageView2 = this.W;
            imageView2.setTranslationX(translationX2);
            imageView2.setTranslationY(f10 + AndroidUtilities.dp(11.333f) + totalVisibility);
            sVar.setTranslationX(p6Var.getTranslationX());
    ...
    public final int f(int i10) {
        ry ryVar = this.e0;
        return (ryVar == null || ryVar.getResourceProvider() == null) ? org.telegram.ui.ActionBar.h6.w0(null, i10, false) : ryVar.getThemedColor(i10);
    }
    ...
    public final void j(long j3) {
        ...
        if (j3 == 0 && (o9 = MessagesController.getInstance(i10).getStoriesController().o()) != null && o9.a(i10, 1)) {
            ryVar.showDialog(new rg.j0(o9.b(), this.f, getContext(), this.e0, null));
            return;
        }
        int i11 = 0;
        while (true) {
        ...
        if (j3 == 0) {
            ci.lc.E(ryVar.getParentActivity(), i10).R(ci.gc.c(a0Var));
            return;
        }
        org.telegram.ui.ActionBar.d6 resourceProvider = ryVar != null ? ryVar.getResourceProvider() : null;
    ...
    public final void p(boolean z10, boolean z11) {
        ...
        if (!this.g0) {
            p6Var.c(this.f0, z10 && !LocaleController.isRTL, true);
        }
