...
public final /* synthetic */ class za implements RequestDelegate {
    ...
    public /* synthetic */ za(int i10, si0 si0Var, org.telegram.ui.ActionBar.o2 o2Var, TLRPC.TL_payments_assignPlayMarketTransaction tL_payments_assignPlayMarketTransaction) {
        this.a = 7;
        this.b = i10;
        this.c = si0Var;
        this.d = o2Var;
        ...
        switch (i10) {
            case 0:
                ...
                if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && obj3 != null) {
                    FileRefController.getInstance(this.b).requestReference(obj3, tL_messages_getAttachedStickers, yaVar);
                    break;
                } else {
            ...
            case 1:
                ...
                break;
            case 2:
                AndroidUtilities.runOnUIThread(new cb((w70) obj3, (org.telegram.ui.f4) obj2, tL_error, tLObject, this.b, (org.telegram.ui.c1) obj));
                break;
            case 3:
                ...
                if (tL_error != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new ei.l3(sharedPreferences, (TLRPC.TL_help_support) tLObject, c2Var, this.b, o2Var, 20));
                    break;
                }
            case 4:
            ...
            case 6:
                ...
                AndroidUtilities.runOnUIThread(new ei.l3((LaunchActivity) obj3, tLObject, (Uri) obj2, this.b, (org.telegram.ui.ActionBar.c2) obj, 23), 2L);
                break;
            case 7:
                si0 si0Var = (si0) obj3;
                ...
                break;
            default:
                AndroidUtilities.runOnUIThread(new cb((org.telegram.ui.web.d1) obj3, tLObject, this.b, (org.telegram.ui.web.z0) obj2, (da) obj, tL_error));
                break;
        }
    }

    public /* synthetic */ za(Object obj, int i10, Object obj2, Object obj3, int i11) {
        this.a = i11;
        this.c = obj;
        this.b = i10;
        this.d = obj2;
    ...
    public /* synthetic */ za(Object obj, Object obj2, int i10, Object obj3, int i11) {
        this.a = i11;
        this.c = obj;
        this.d = obj2;
        this.b = i10;
