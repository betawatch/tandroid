    ...
    public final void b(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        if (z12 || d6Var.b != null) {
            ...
            if ((f6Var3.C1 || f6Var3.S1.h(f6Var3.B1)) && !d6Var.f && (storyItem = d6Var.a) != null) {
                ...
                org.telegram.ui.ActionBar.f1 f1Var2 = f6Var3.E3;
                ...
                org.telegram.ui.ActionBar.k1 k1Var = new org.telegram.ui.ActionBar.k1(f6Var3.getContext(), org.telegram.ui.ActionBar.j6.H8, f6Var);
            ...
            if (f6Var3.C1 || w5Var.f) {
                org.telegram.ui.ActionBar.k1 k1Var2 = new org.telegram.ui.ActionBar.k1(f6Var3.getContext(), org.telegram.ui.ActionBar.j6.H8, f6Var);
            ...
            if (f6Var3.c3 || d6Var.f || !((f6Var3.I0() || MessagesController.getInstance(f6Var3.C2).storiesEnabled()) && w5Var.h)) {
                ...
                org.telegram.ui.ActionBar.f1 c11 = org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout3, R.drawable.msg_edit, LocaleController.getString(f6Var3.I0() ? R.string.EditBotPreview : R.string.EditStory), false, w5Var.d);
                f6Var3.s1 = c11;
                jcVar = jcVar6;
            ...
            if (d6Var.f && (f6Var3.B1 == UserConfig.getInstance(f6Var3.C2).getClientUserId() || ChatObject.canManageCalls(MessagesController.getInstance(f6Var3.C2).getChat(Long.valueOf(-f6Var3.B1))) || ((d2Var = jcVar3.A0) != null && d6Var.k(d2Var.g()) && (groupCall = jcVar3.A0.v) != null && groupCall.creator))) {
                org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.msg_settings_old, LocaleController.getString(R.string.LiveStorySettings), false, w5Var.d).setOnClickListener(new l5(w5Var, f6Var, jcVar3, 1));
            }
            if (d6Var.f) {
                        ...
                        public final void onClick(View view) {
                            ...
                            switch (i16) {
                                case 0:
                                    ...
                                    org.telegram.ui.Components.pc V = new xc(f6Var7.c1, f6Var6).V(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", R.string.NotificationsStoryMutedHint, str2)), null, null);
                                    V.a = 2;
                                    V.j();
                                    w5 w5Var3 = f6Var7.t1;
                                    if (w5Var3 != null) {
                                ...
                                default:
                                    ...
                                    org.telegram.ui.Components.pc V2 = new xc(f6Var8.c1, f6Var6).V(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", R.string.NotificationsStoryUnmutedHint, str2)), null, null);
                                    V2.a = 2;
                                    V2.j();
                                    w5 w5Var4 = f6Var8.t1;
                                    if (w5Var4 != null) {
                        ...
                        public final void onClick(View view) {
                            ...
                            switch (i162) {
                                case 0:
                                    ...
                                    MessagesController.getNotificationsSettings(f6Var7.C2).edit().putBoolean(NotificationsSettingsFacade.PROPERTY_STORIES_NOTIFY + str3, false).apply();
                                    NotificationsController.getInstance(f6Var7.C2).updateServerNotificationsSettings(f6Var7.B1, 0L);
                                    org.telegram.ui.Components.pc V = new xc(f6Var7.c1, f6Var62).V(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", R.string.NotificationsStoryMutedHint, str2)), null, null);
                                    V.a = 2;
                                    V.j();
                                    w5 w5Var3 = f6Var7.t1;
                                    if (w5Var3 != null) {
                                ...
                                default:
                                    ...
                                    MessagesController.getNotificationsSettings(f6Var8.C2).edit().putBoolean(NotificationsSettingsFacade.PROPERTY_STORIES_NOTIFY + str3, true).apply();
                                    NotificationsController.getInstance(f6Var8.C2).updateServerNotificationsSettings(f6Var8.B1, 0L);
                                    org.telegram.ui.Components.pc V2 = new xc(f6Var8.c1, f6Var62).V(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", R.string.NotificationsStoryUnmutedHint, str2)), null, null);
                                    V2.a = 2;
                                    V2.j();
                                    w5 w5Var4 = f6Var8.t1;
                                    if (w5Var4 != null) {
            ...
            if (!MessagesController.getInstance(f6Var3.C2).premiumFeaturesBlocked() && d6Var.e) {
                ...
                if (UserConfig.getInstance(f6Var3.C2).isPremium()) {
                    org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, z18 ? R.drawable.menu_quality_sd : R.drawable.menu_quality_hd, LocaleController.getString(z18 ? R.string.StoryQualityDecrease : R.string.StoryQualityIncrease), false, f6Var3.B0).setOnClickListener(new j3(0, f6Var3, z18));
                } else {
                    ...
                    t3Var.s = dp3;
                    t3Var.v = i18;
                    org.telegram.ui.ActionBar.f1 c16 = org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.menu_quality_hd, LocaleController.getString(R.string.StoryQualityIncrease), false, f6Var3.B0);
                            ...
                            if (storyItem3 != null) {
                                if (storyItem3.translated && TextUtils.equals(storyItem3.translatedLng, l41.A())) {
                                    ...
                                    if (!f6Var3.c3 || UserObject.isService(f6Var3.B1) || f6Var3.I0()) {
                                        ...
                                        f6Var = f6Var2;
                                        org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout8, R.drawable.msg_report, LocaleController.getString(R.string.ReportChat), false, w5Var.d).setOnClickListener(new l5(w5Var, jcVar5, f6Var));
                                        actionBarPopupWindow$ActionBarPopupWindowLayout6 = actionBarPopupWindow$ActionBarPopupWindowLayout;
                                    }
                                }
                            }
                ...
                for (int i19 = 0; i19 < d6Var.a.media_areas.size(); i19++) {
                    ...
                    if (mediaArea2 instanceof TL_stories.TL_mediaAreaSuggestedReaction) {
                        ...
                        if (reaction instanceof TLRPC.TL_reactionCustomEmoji) {
                            TLRPC.Document f7 = org.telegram.ui.Components.p5.f(f6Var3.C2, ((TLRPC.TL_reactionCustomEmoji) reaction).document_id);
            ...
            if (storyItem9 == null || (arrayList2 = storyItem9.entities) == null || arrayList2.isEmpty()) {
                ...
                if (k9Var != null && (o8Var = k9Var.c) != null) {
                        ...
                        for (int i20 = 0; i20 < d6Var.b.c.T0.size(); i20++) {
                            ...
                            if (mediaEntity.type == 4 && (mediaArea = mediaEntity.mediaArea) != null) {
                                ...
                                if (reaction2 instanceof TLRPC.TL_reactionCustomEmoji) {
                                    TLRPC.Document f10 = org.telegram.ui.Components.p5.f(f6Var3.C2, ((TLRPC.TL_reactionCustomEmoji) reaction2).document_id);
                    ...
                    if ((charSequence instanceof Spanned) && (y5VarArr = (org.telegram.ui.Components.y5[]) ((Spanned) charSequence).getSpans(0, charSequence.length(), org.telegram.ui.Components.y5.class)) != null) {
                        ...
                        while (i21 < y5VarArr.length) {
                            ...
                            if (document == null) {
                                num2 = num3;
                                document = org.telegram.ui.Components.p5.f(f6Var3.C2, y5Var.documentId);
                            } else {
                                num2 = num3;
                            }
                            if (document != null) {
                ...
                for (int i22 = 0; i22 < d6Var.a.entities.size(); i22++) {
                    ...
                    if (messageEntity instanceof TLRPC.TL_messageEntityCustomEmoji) {
                        ...
                        if (document2 == null) {
                            document2 = org.telegram.ui.Components.p5.f(f6Var3.C2, tL_messageEntityCustomEmoji.document_id);
                        }
                        if (document2 != null) {
