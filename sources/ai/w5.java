    ...
    public final void b(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        if (z12 || d6Var.b != null) {
            ...
            if ((f6Var.C1 || f6Var.S1.h(f6Var.B1)) && !d6Var.f && (storyItem = d6Var.a) != null) {
                ...
                n70 n70Var = new n70(actionBarPopupWindow$ActionBarPopupWindowLayout2, e6Var);
                ...
                n70.f(n70Var, B, hashSet, B2 != null && B2.a(), new a3.k0(w5Var, e6Var, storyItem, 2), new e4(w5Var, hashSet, storyItem, e6Var, 1));
                ...
                org.telegram.ui.ActionBar.k1 k1Var = new org.telegram.ui.ActionBar.k1(f6Var.getContext(), org.telegram.ui.ActionBar.i6.H8, e6Var);
            ...
            if (f6Var.C1 || w5Var.f) {
                org.telegram.ui.ActionBar.k1 k1Var2 = new org.telegram.ui.ActionBar.k1(f6Var.getContext(), org.telegram.ui.ActionBar.i6.H8, e6Var);
            ...
            if (d6Var.f) {
                ...
                c12.setSelectorColor(org.telegram.ui.ActionBar.i6.l1(0.12f, org.telegram.ui.ActionBar.i6.v0(i12, e6Var)));
            ...
            if (!d6Var.f) {
                ...
                c13.setSelectorColor(org.telegram.ui.ActionBar.i6.l1(0.12f, org.telegram.ui.ActionBar.i6.v0(i14, e6Var)));
                        ...
                        public final void onClick(View view) {
                            ...
                            switch (i16) {
                                case 0:
                                    ...
                                    org.telegram.ui.Components.oc V = new vc(f6Var2.c1, e6Var5).V(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", R.string.NotificationsStoryMutedHint, str2)), null, null);
                                    V.a = 2;
                                    V.j();
                                    w5 w5Var3 = f6Var2.t1;
                                    if (w5Var3 != null) {
                                ...
                                default:
                                    ...
                                    org.telegram.ui.Components.oc V2 = new vc(f6Var3.c1, e6Var5).V(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", R.string.NotificationsStoryUnmutedHint, str2)), null, null);
                                    V2.a = 2;
                                    V2.j();
                                    w5 w5Var4 = f6Var3.t1;
                                    if (w5Var4 != null) {
                        ...
                        public final void onClick(View view) {
                            ...
                            switch (i162) {
                                case 0:
                                    ...
                                    MessagesController.getNotificationsSettings(f6Var2.C2).edit().putBoolean(NotificationsSettingsFacade.PROPERTY_STORIES_NOTIFY + str3, false).apply();
                                    NotificationsController.getInstance(f6Var2.C2).updateServerNotificationsSettings(f6Var2.B1, 0L);
                                    org.telegram.ui.Components.oc V = new vc(f6Var2.c1, e6Var52).V(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", R.string.NotificationsStoryMutedHint, str2)), null, null);
                                    V.a = 2;
                                    V.j();
                                    w5 w5Var3 = f6Var2.t1;
                                    if (w5Var3 != null) {
                                ...
                                default:
                                    ...
                                    MessagesController.getNotificationsSettings(f6Var3.C2).edit().putBoolean(NotificationsSettingsFacade.PROPERTY_STORIES_NOTIFY + str3, true).apply();
                                    NotificationsController.getInstance(f6Var3.C2).updateServerNotificationsSettings(f6Var3.B1, 0L);
                                    org.telegram.ui.Components.oc V2 = new vc(f6Var3.c1, e6Var52).V(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", R.string.NotificationsStoryUnmutedHint, str2)), null, null);
                                    V2.a = 2;
                                    V2.j();
                                    w5 w5Var4 = f6Var3.t1;
                                    if (w5Var4 != null) {
                ...
                if (UserConfig.getInstance(f6Var.C2).isPremium()) {
                    ...
                    if (!f6Var.c3 && f6Var.S2 && !d6Var.f) {
                        if (!UserConfig.getInstance(f6Var.C2).isPremium()) {
                            ...
                            storyItem3 = d6Var.a;
                            if (storyItem3 != null) {
                                if (storyItem3.translated && TextUtils.equals(storyItem3.translatedLng, v31.A())) {
                ...
                for (int i19 = 0; i19 < d6Var.a.media_areas.size(); i19++) {
                    ...
                    if (mediaArea2 instanceof TL_stories.TL_mediaAreaSuggestedReaction) {
                        ...
                        if (reaction instanceof TLRPC.TL_reactionCustomEmoji) {
                            TLRPC.Document f7 = org.telegram.ui.Components.o5.f(f6Var.C2, ((TLRPC.TL_reactionCustomEmoji) reaction).document_id);
            ...
            if (storyItem9 == null || (arrayList2 = storyItem9.entities) == null || arrayList2.isEmpty()) {
                        ...
                        for (int i20 = 0; i20 < d6Var.b.c.T0.size(); i20++) {
                            ...
                            if (mediaEntity.type == 4 && (mediaArea = mediaEntity.mediaArea) != null) {
                                ...
                                if (reaction2 instanceof TLRPC.TL_reactionCustomEmoji) {
                                    TLRPC.Document f10 = org.telegram.ui.Components.o5.f(f6Var.C2, ((TLRPC.TL_reactionCustomEmoji) reaction2).document_id);
                ...
                for (int i22 = 0; i22 < d6Var.a.entities.size(); i22++) {
                    ...
                    if (messageEntity instanceof TLRPC.TL_messageEntityCustomEmoji) {
                        ...
                        if (document2 == null) {
                            document2 = org.telegram.ui.Components.o5.f(f6Var.C2, tL_messageEntityCustomEmoji.document_id);
                        }
                        if (document2 != null) {
        ...
        if (z19 || z20) {
            org.telegram.ui.ActionBar.k1 k1Var3 = new org.telegram.ui.ActionBar.k1(context, org.telegram.ui.ActionBar.i6.H8, e6Var);
