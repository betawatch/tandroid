                ...
                if (childAt instanceof a0) {
                    ...
                    if (n6Var.x != j3) {
                        ...
                        if (!z12) {
                            ...
                            gcVar.a = m6Var;
                            gcVar.m = n6Var.y;
                            gcVar.b = m6Var.getImageReceiver();
                            gcVar.g = (View) n6Var.getParent();
                    ...
                    if (a5Var.getStoryItem() != null && a5Var.getStoryItem().dialogId == j3 && a5Var.getStoryItem().messageId == i10) {
                        gcVar.a = a5Var.getAvatarImageView();
                        gcVar.m = a5Var.getStoryAvatarParams();
                        gcVar.b = a5Var.getAvatarImageView().getImageReceiver();
                        gcVar.g = (View) a5Var.getParent();
                        gcVar.k = 1.0f;
                        c(gcVar);
                        return true;
                    }
