...
public final /* synthetic */ class l8 implements Runnable {
    ...
    public /* synthetic */ l8(Context context, int i10, GiftAuctionController.Auction auction, long j3, Runnable runnable) {
        this.a = 10;
        this.d = context;
        this.c = i10;
        this.e = auction;
        ...
        switch (i10) {
            case 0:
                ...
                if (storyItem == null) {
                    ...
                    hashSet.add(str);
                    l9Var.l.edit().putStringSet("unsupported_stories_checked", hashSet).apply();
                    break;
                } else {
    ...
    public /* synthetic */ l8(Object obj, TLObject tLObject, int i10, Object obj2, long j3, int i11) {
        this.a = i11;
        this.d = obj;
        this.e = tLObject;
        this.c = i10;
    ...
    public /* synthetic */ l8(BotForumHelper botForumHelper, long[] jArr, long j3, int i10, Runnable runnable) {
        this.a = 1;
    ...
    public /* synthetic */ l8(MessagesStorage messagesStorage, int i10, long j3, TLRPC.Message message, String str) {
        this.a = 5;
    ...
    public /* synthetic */ l8(MessagesStorage messagesStorage, long j3, int i10, Object obj, Object obj2, int i11) {
        this.a = i11;
        this.d = messagesStorage;
        this.b = j3;
        this.c = i10;
    ...
    public /* synthetic */ l8(MessagesStorage messagesStorage, ArrayList arrayList, ArrayList arrayList2, int i10, long j3) {
        this.a = 6;
        this.d = messagesStorage;
        this.e = arrayList;
        this.f = arrayList2;
    ...
    public /* synthetic */ l8(TopicsController topicsController, TLRPC.messages_SavedDialogs messages_saveddialogs, long j3, a0.i iVar, int i10, int i11) {
        this.a = i11;
    ...
    public /* synthetic */ l8(yh.o oVar, yh.n nVar, int i10, TLObject tLObject, long j3) {
        this.a = 11;
        this.d = oVar;
        this.f = nVar;
        this.c = i10;
