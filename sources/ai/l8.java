...
public final /* synthetic */ class l8 implements Runnable {
    ...
    public /* synthetic */ l8(l9 l9Var, long j3, boolean z10, TL_stories.PeerStories peerStories, long j10, TLObject tLObject) {
        this.e = l9Var;
        this.c = j3;
        this.b = z10;
        this.f = peerStories;
            ...
            case 0:
                ...
                if (peerStories != null) {
                    if (tLObject instanceof TL_stories.TL_stories_stories) {
                        ...
                        if (!z10) {
                            y9 y9Var = l9Var.k;
                            y9Var.b.getStorageQueue().postRunnable(new w9(y9Var, peerStories, 1));
                        }
                    }
    ...
    public /* synthetic */ l8(FileLoader fileLoader, boolean z10, String str, long j3, long j10, Float f7) {
        this.e = fileLoader;
        this.b = z10;
        this.f = str;
        this.c = j3;
