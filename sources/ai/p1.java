...
public final /* synthetic */ class p1 implements NativeInstance.PayloadCallback, RequestDelegateTimestamp, NativeInstance.VideoSourcesCallback, NativeInstance.RequestBroadcastPartCallback, NativeInstance.RequestCurrentTimeCallback {
    ...
    public /* synthetic */ p1(d2 d2Var, int i10) {
        this.a = i10;
        this.b = d2Var;
    }
    ...
    public void run(int i10, String str) {
        ...
        ConnectionsManager.getInstance(i11).sendRequest(joingroupcall, new q1(d2Var, 0));
    }
    ...
    public void run(TLObject tLObject, TLRPC.TL_error tL_error, long j3) {
        if (tL_error == null) {
            ...
            if (groupcallstreamchannels.channels.isEmpty()) {
                AndroidUtilities.runOnUIThread(new t1(d2Var, 8));
            }
            if (d2Var.G == null) {
    ...
    public void run(long j3, int[] iArr) {
        ...
        getgroupparticipants.call = d2Var.f;
        ...
        ConnectionsManager.getInstance(d2Var.e).sendRequest(getgroupparticipants, new u1(d2Var, iArr, j3, 0));
    }
        ...
        switch (this.a) {
            case 3:
                ...
                if (d2Var.v != null) {
                    ...
                    tL_inputGroupCallStream.call = d2Var.f;
                    ...
                    AndroidUtilities.runOnUIThread(new s1(d2Var, str2, AccountInstance.getInstance(d2Var.e).getConnectionsManager().sendRequest(tL_upload_getFile, new RequestDelegateTimestamp() { // from class: ai.r1
                        @Override // org.telegram.tgnet.RequestDelegateTimestamp
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error, long j11) {
                            ...
                            if ("GROUPCALL_INVALID".equalsIgnoreCase(tL_error.text)) {
                                d2Var2.E.onStreamPartAvailable(j13, null, -1, j11, i12, i13);
                                AndroidUtilities.runOnUIThread(new t1(d2Var2, 4));
                                return;
                            }
                            if ("GROUPCALL_JOIN_MISSING".equals(tL_error.text)) {
                                AndroidUtilities.runOnUIThread(new t1(d2Var2, 6));
                            ...
                            d2Var2.E.onStreamPartAvailable(j13, null, i14, j11, i12, i13);
                        }
                    }, 2, 2, d2Var.h()), 0));
                    break;
                }
    ...
    public void run(long j3) {
        ...
        if (groupCall != null && groupCall.rtmp_stream) {
            ...
            getgroupcallstreamchannels.call = d2Var.f;
            if (d2Var.v == null || d2Var.E == null) {
                return;
            }
            ConnectionsManager.getInstance(i10).sendRequest(getgroupcallstreamchannels, new z1(d2Var, j3, 0), 65536, 2, d2Var.h());
            return;
        }
        NativeInstance nativeInstance = d2Var.E;
