...
public final class h5 extends xa {
    ...
    public final void F(org.telegram.ui.Components.z5 z5Var) {
        if (z5Var != null) {
            ...
            org.telegram.ui.Components.qc h = new xc(a5Var, e6Var).h(document, 2, new d5(this, this.x0, e6Var, 0));
            if (h == null) {
                return;
            }
            h.a = 1;
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        if (!(characterStyle instanceof b61)) {
            ...
            if (!(characterStyle instanceof a61)) {
                ...
                wh.n(R.string.TextCopied, new xc(f6Var.c1, this.y0));
                return;
            }
        }
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() { // from class: ai.f5
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (i10 == 0) {
                    ...
                    new xc(h5Var.z0.c1, e6Var2).k(false).j();
                }
            }
        };
    ...
    public final void I(sa saVar) {
                ...
                public final void run() {
                    switch (i10) {
                        case 0:
                            ...
                            new xc(f6Var2.c1, e6Var).Q(R.raw.saved_messages, 36, AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryAudioAddToSavedMessagesToast), -1, 2, new f(25))).k(true);
                            break;
                        default:
                            f6 f6Var3 = this.b.z0;
                            ...
                            new xc(f6Var3.c1, e6Var).Q(R.raw.ic_save_to_music, 36, LocaleController.getString(R.string.StoryAudioAddToProfileToast)).k(true);
                            break;
                    }
                }
        ...
        org.telegram.ui.Components.qc Q = new xc(f6Var.c1, e6Var).Q(R.raw.error, 36, LocaleController.getString(R.string.StoryHidAccount));
        Q.a = 3;
        Q.k(true);
    }
