...
public final /* synthetic */ class g3 implements Utilities.Callback {
    ...
    private final void a(Object obj) {
        ...
        if (num.intValue() == 7) {
            ...
            if (U != null) {
                U.showAsSheet(new org.telegram.ui.web.o(v3Var != null ? new org.telegram.ui.b0(i4Var, 5) : null, new org.telegram.ui.s(i4Var, 2)), k2Var);
                return;
            }
            return;
        }
        ...
        if (i4Var.u0[0].f()) {
            ...
            if (U3 != null) {
                ...
                k2Var3.a = true;
                U3.showAsSheet(new org.telegram.ui.web.z1(new org.telegram.ui.s(i4Var, 3)), k2Var3);
                return;
            }
            return;
        }
        ...
        for (int i11 = 2; i10 < i11; i11 = 2) {
            ...
            k0Var.addView(radioButton, w7.y5.d(22, 22.0f, (z10 ? 5 : 3) | 48, z10 ? 0 : 22, 13.0f, z10 ? 22 : 0, 0.0f));
            ...
            k0Var.addView(textView, w7.y5.d(-1, -1.0f, (z11 ? 5 : 3) | 48, z11 ? 17 : 62, 0.0f, z11 ? 62 : 17, 0.0f));
            k0VarArr[i10] = k0Var;
            if (i10 == 0) {
            ...
            linearLayout.addView(k0VarArr[i10], w7.y5.n(-1, 50));
            i10++;
        }
        ...
        switch (i14) {
            ...
            case 2:
                ...
                if (max > 0) {
                    ...
                    if ((jVar instanceof qg.v2) && ((qg.v2) jVar).getEditText().isFocused()) {
                        ...
                        arrayList.add(ObjectAnimator.ofFloat(nbVar.B0, (Property<qg.k1, Float>) property2, (z10 || nbVar.B1) ? 1.0f : 0.0f));
                        arrayList.add(ObjectAnimator.ofFloat(nbVar.A0, (Property<qg.g1, Float>) property2, (z10 || nbVar.B1) ? 1.0f : 0.0f));
                        nbVar.T0();
                ...
                arrayList.add(ObjectAnimator.ofFloat(nbVar.B0, (Property<qg.k1, Float>) property22, (z10 || nbVar.B1) ? 1.0f : 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(nbVar.A0, (Property<qg.g1, Float>) property22, (z10 || nbVar.B1) ? 1.0f : 0.0f));
                nbVar.T0();
                nbVar.N1.playTogether(arrayList);
                if (z10) {
                }
            ...
            case 24:
                ...
                if (m2Var != null) {
                    ...
                    if (m2Var.getContext() != null && m2Var.getParentActivity() != null) {
                        ei.k3 k3Var = new ei.k3(m2Var.getContext(), m2Var.getResourceProvider());
                        k3Var.k0 = m2Var.getParentActivity();
                        if (l3Var != null && l3Var.a != null) {
                            k3Var.E0 = true;
                            boolean z14 = l3Var.o;
                            k3Var.V = z14;
                            if (z14) {
                                k3Var.v(l3Var.r, false);
                            }
                            if (l3Var.n) {
                                i13 = l3Var.q;
                            } else {
                            ...
                            k3Var.t(i13, l3Var.n, false);
                            k3Var.y(l3Var.s, false);
                            k3Var.F0 = l3Var.j;
                            k3Var.G0 = l3Var.k;
                            boolean z15 = l3Var.u;
                            k3Var.w0 = z15;
                            ...
                            k3Var.v.setAllowSwipes(l3Var.l);
                            ...
                            k3Var.r0 = l3Var.y;
                            k3Var.z0 = Boolean.valueOf(l3Var.B);
                            k3Var.A0 = l3Var.C;
                            ei.a1 a1Var = l3Var.K;
                            k3Var.B0 = a1Var;
                            if (a1Var != null) {
                            ...
                            k3Var.x(l3Var.z, false, l3Var.A);
                            ei.f5 f5Var = l3Var.a;
                            k3Var.G = f5Var != null ? f5Var.a : UserConfig.selectedAccount;
                            org.telegram.ui.web.y0 y0Var2 = l3Var.b;
                            if (y0Var2 != null) {
                                y0Var2.onResume();
                                b3Var.O(k3Var.G, l3Var.b, l3Var.d, l3Var.f, l3Var.e);
                                boolean z16 = l3Var.t || l3Var.b.b;
                                String str6 = l3Var.x;
                                b3Var.h("setState(" + z16 + ", " + str6 + ")");
                                b3Var.N = z16;
                                b3Var.b = str6;
                                if (org.telegram.ui.ActionBar.h6.I.q() != l3Var.D) {
                                    b3Var.A();
                                }
                            } else {
                                f5Var.q = null;
            ...
            case 25:
                ...
                ((org.telegram.ui.ActionBar.l3) obj3).m = (Bitmap) obj;
