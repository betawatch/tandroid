...
public final /* synthetic */ class cb implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                break;
            case 3:
                ((MediaDataController) this.e).lambda$removeMultipleStickerSets$111((boolean[]) this.h, (ArrayList) this.d, (Context) this.c, (org.telegram.ui.ActionBar.o2) this.f, this.b);
                break;
            case 4:
            ...
            case 5:
                ...
                if (z10) {
                    ...
                    if (groupCall != null) {
                        ...
                        org.telegram.ui.m9.o0(context, i11, tL_inputGroupCall, groupCall.invite_link, f6Var, true, true);
                    ...
                    ConnectionsManager.getInstance(i11).sendRequest(exportgroupcallinvite, new ii(c2Var, context, i11, exportgroupcallinvite, f6Var, w60Var));
                    break;
                } else {
                    c2Var.dismiss();
                    AndroidUtilities.runOnUIThread(w60Var);
            ...
            case 6:
                ...
                new s71(context2, chat2, user, new n8(this.b, booleanCallback, 27), (org.telegram.ui.ActionBar.f6) this.h).show();
                break;
            case 7:
            ...
            case 8:
                ...
                break;
            case 9:
                us.Y((us) this.e, (TLRPC.FileLocation) this.f, (TLRPC.InputFile) this.d, (TLObject) this.c, (TLRPC.FileLocation) this.h, this.b);
                break;
            case 10:
                ...
                if (tL_urlAuthResultRequest.match_codes.isEmpty() || !TextUtils.isEmpty(strArr[0])) {
                    ...
                    kl0.c(context3, this.b, tL_urlAuthResultRequest.match_codes, tL_urlAuthResultRequest.domain, new oj0(3, strArr, il0Var), true, new f(18), o2Var.getResourceProvider());
                    break;
                }
                break;
            case 11:
                ...
                if (hVar.a == 0) {
                    ...
                    if (list != null && !list.isEmpty() && !UserConfig.getInstance(i13).isPremium()) {
                        for (Purchase purchase : list) {
                            if (purchase.b().contains(BillingController.PREMIUM_PRODUCT_ID)) {
                                ...
                                ConnectionsManager.getInstance(i13).sendRequest(tL_payments_assignPlayMarketTransaction, new za(i13, si0Var, o2Var2, tL_payments_assignPlayMarketTransaction), 66);
                                break;
                            }
                        }
                    }
                    BillingController.getInstance().addResultListener(BillingController.PREMIUM_PRODUCT_ID, new org.telegram.ui.g3(si0Var, 4));
                    ...
                    ConnectionsManager.getInstance(i13).sendRequest(tL_payments_canPurchaseStore, new ii(i13, 5, o2Var2, nx0Var, fVar, tL_payments_canPurchaseStore, tL_inputStorePaymentPremiumSubscription2));
                    break;
                }
                break;
            case 12:
            ...
            case 13:
                ...
                if (tLObject4 instanceof TLRPC.TL_photos_photo) {
                    ...
                    if ((photo instanceof TLRPC.TL_photo) && user2 != null) {
                        ...
                        ejVar.run();
                        vc.a0(e5Var.getLastFragment()).V(Collections.singletonList(user2), AndroidUtilities.replaceTags(LocaleController.getString(R.string.ApplyAvatarHintTitle)), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ApplyAvatarHint), new qg.v(i15, e5Var)), null).j();
                        break;
                    }
                }
                break;
            default:
                ...
                if (tLObject5 instanceof TLRPC.ChatInvite) {
                    ...
                    if (tL_starsSubscriptionPricing == null) {
                        ...
                        yh.v5.y(i16, false).j0(tL_messages_checkChatInvite.hash, chatInvite, new Utilities.Callback2() { // from class: yh.s6
    ...
    public /* synthetic */ cb(MediaDataController mediaDataController, boolean[] zArr, ArrayList arrayList, Context context, org.telegram.ui.ActionBar.o2 o2Var, int i10) {
        this.a = 3;
    ...
    public /* synthetic */ cb(us usVar, TLRPC.FileLocation fileLocation, TLRPC.InputFile inputFile, TLObject tLObject, TLRPC.FileLocation fileLocation2, int i10) {
        this.a = 9;
        this.e = usVar;
        this.f = fileLocation;
        this.d = inputFile;
    ...
    public /* synthetic */ cb(w70 w70Var, org.telegram.ui.f4 f4Var, TLRPC.TL_error tL_error, TLObject tLObject, int i10, org.telegram.ui.c1 c1Var) {
        this.a = 4;
        this.e = w70Var;
        this.f = f4Var;
        this.d = tL_error;
