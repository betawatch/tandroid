...
public final /* synthetic */ class cb implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            case 2:
                ...
                break;
            case 3:
                ((MediaDataController) this.e).lambda$removeMultipleStickerSets$111((boolean[]) this.h, (ArrayList) this.d, (Context) this.c, (org.telegram.ui.ActionBar.m2) this.f, this.b);
                break;
            case 4:
            ...
            case 5:
                ...
                if (z10) {
                    ...
                    ConnectionsManager.getInstance(i11).sendRequest(exportgroupcallinvite, new hi(a2Var, context, i11, exportgroupcallinvite, d6Var, p60Var));
                    break;
                } else {
                    a2Var.dismiss();
                    AndroidUtilities.runOnUIThread(p60Var);
            ...
            case 10:
                ...
                if (tL_urlAuthResultRequest.match_codes.isEmpty() || !TextUtils.isEmpty(strArr[0])) {
                    ...
                    cl0.c(context3, this.b, tL_urlAuthResultRequest.match_codes, tL_urlAuthResultRequest.domain, new bt(10, strArr, al0Var), true, new f(18), m2Var.getResourceProvider());
                    break;
                }
                break;
            case 11:
                ...
                if (hVar.a == 0) {
                    ...
                    if (list != null && !list.isEmpty() && !UserConfig.getInstance(i13).isPremium()) {
                        for (Purchase purchase : list) {
                            if (purchase.b().contains(BillingController.PREMIUM_PRODUCT_ID)) {
                                ...
                                ConnectionsManager.getInstance(i13).sendRequest(tL_payments_assignPlayMarketTransaction, new za(i13, ki0Var, m2Var2, tL_payments_assignPlayMarketTransaction), 66);
                                break;
                            }
                        }
                    }
                    BillingController.getInstance().addResultListener(BillingController.PREMIUM_PRODUCT_ID, new org.telegram.ui.h3(ki0Var, 4));
                    ...
                    ConnectionsManager.getInstance(i13).sendRequest(tL_payments_canPurchaseStore, new hi(i13, 5, m2Var2, cx0Var, fVar, tL_payments_canPurchaseStore, tL_inputStorePaymentPremiumSubscription2));
                    break;
                }
                break;
            case 12:
    ...
    public /* synthetic */ cb(MediaDataController mediaDataController, boolean[] zArr, ArrayList arrayList, Context context, org.telegram.ui.ActionBar.m2 m2Var, int i10) {
        this.a = 3;
    ...
    public /* synthetic */ cb(ms msVar, TLRPC.FileLocation fileLocation, TLRPC.InputFile inputFile, TLObject tLObject, TLRPC.FileLocation fileLocation2, int i10) {
        this.a = 9;
        this.e = msVar;
        this.f = fileLocation;
        this.d = inputFile;
    ...
    public /* synthetic */ cb(p70 p70Var, org.telegram.ui.g4 g4Var, TLRPC.TL_error tL_error, TLObject tLObject, int i10, org.telegram.ui.d1 d1Var) {
        this.a = 4;
        this.e = p70Var;
        this.f = g4Var;
        this.d = tL_error;
