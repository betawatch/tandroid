    ...
    public final void run(Object obj) {
        ...
        switch (i12) {
            case 0:
                ...
                e6 e6Var = u4Var.a;
                if (!z10 || p0Var.f == null) {
                    l0Var = new zg.l0(view.getContext(), null, e6Var.f2, null, view, e6Var.getMeasuredWidth() / 2.0f, e6Var.getMeasuredHeight() / 2.0f, p0Var, e6Var.C2, 2, true);
                } else {
                    try {
                        e6Var.performHapticFeedback(0);
                    } catch (Exception unused) {
                    }
                    l0Var = new zg.l0(view.getContext(), null, e6Var.f2, null, view, e6Var.getMeasuredWidth() / 2.0f, e6Var.getMeasuredHeight() / 2.0f, p0Var, e6Var.C2, 0, true);
                }
                zg.l0.B = l0Var;
                ...
                if (p0Var.f != null) {
                    f7 = MediaDataController.getInstance(e6Var.C2).getEmojiAnimatedSticker(p0Var.f);
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(p0Var.f, e6Var.B1);
                    of2.replyToStoryItem = c6Var.a;
                    of2.payStars = l4.longValue();
                    SendMessagesHelper.getInstance(e6Var.C2).sendMessage(of2);
                } else {
                    f7 = org.telegram.ui.Components.q5.f(e6Var.C2, p0Var.g);
            ...
            default:
                ...
                xh.r1 r1Var = new xh.r1(chatActivityEnterView.getContext(), chatActivityEnterView.Q, ((TLRPC.User) obj2).id, tg.t.c(tg.t.b(1, (List) obj)), null);
                r1Var.V(z10);
                r1Var.show();
                break;
        }
