...
public final /* synthetic */ class t4 implements Utilities.Callback {
        ...
        switch (i12) {
            ...
            case 1:
                ...
                if (((Boolean) obj).booleanValue()) {
                    ...
                    if (f6Var3.C1) {
                        new vc(a5Var, f6Var2).Q(z10 ? R.raw.contact_check : R.raw.chats_archived, 36, LocaleController.getString(z10 ? R.string.StoryPinnedToProfile : R.string.StoryArchivedFromProfile)).j();
                        break;
                    } else if (z10) {
    ...
    public /* synthetic */ t4(ChatActivityEnterView chatActivityEnterView, org.telegram.ui.ActionBar.c2 c2Var, TLRPC.User user, boolean z10) {
