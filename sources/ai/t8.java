...
public final class t8 extends d9 {
    ...
    public t8(int i10, long j3, String str, y1 y1Var) {
    ...
    public final void G(TLRPC.InputMedia inputMedia, TL_bots.botPreviewMedia botpreviewmedia) {
        ...
        MessageObject messageObject2 = new MessageObject(this.c, new s8(this, this.d, botpreviewmedia));
    ...
    public final void I(TL_bots.botPreviewMedia botpreviewmedia) {
        MessageObject messageObject = new MessageObject(this.c, new s8(this, this.d, botpreviewmedia));
