...
public abstract class m6 extends View {
    ...
    public static void a(m6 m6Var, SpannableStringBuilder spannableStringBuilder, TL_stories.StoryViews storyViews, boolean z10) {
    ...
    public l6 getCenteredImageReciever() {
        ArrayList arrayList = this.G;
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (((l6) arrayList.get(i10)).b == this.K) {
                return (l6) arrayList.get(i10);
            }
        }
        return null;
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.v = false;
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ((l6) arrayList.get(i10)).a.onDetachedFromWindow();
        }
        arrayList.clear();
    }
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (b10 > getMeasuredWidth() || this.s + b10 < 0.0f) {
                ...
                while (true) {
                    if (i16 >= arrayList4.size()) {
                        ...
                        if (((l6) arrayList4.get(i16)).b == i14) {
                            l6Var = (l6) arrayList4.remove(i16);
                            break;
                        }
                        i16++;
                    }
                ...
                if (this.y == 1.0f || i14 != this.K) {
                    ...
                    if (l6Var.c != null) {
                        ...
                        canvas.save();
                        canvas.translate(imageReceiver.getCenterX() - (this.J / 2.0f), (imageReceiver.getImageY2() - AndroidUtilities.dp(8.0f)) - l6Var.c.getHeight());
                        l6Var.d.setAlpha(B);
                        l6Var.c.draw(canvas);
                        canvas.restore();
                    }
        ...
        for (int i17 = 0; i17 < arrayList5.size(); i17++) {
            ((l6) arrayList5.get(i17)).a.onDetachedFromWindow();
        }
        arrayList5.clear();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.J != dp2) {
            ...
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                ((l6) arrayList.get(i13)).a(((l6) arrayList.get(i13)).b);
            }
        }
    }
