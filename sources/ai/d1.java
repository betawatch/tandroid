        ...
        switch (this.a) {
            case 0:
                ...
                if (((h1) this.d).a) {
                    ...
                    if (((yh.k8) this.b) == null) {
                        this.b = new yh.k8(1, MediaDataController.MAX_LINKS_COUNT);
                    }
                    ((yh.k8) this.b).f(0, 0, getWidth(), getHeight());
                    yh.k8 k8Var = (yh.k8) this.b;
                    k8Var.h = 30.0f;
                    k8Var.d();
                    ((yh.k8) this.b).b(canvas, -1, 0.85f);
                    invalidate();
                    canvas.restore();
                }
