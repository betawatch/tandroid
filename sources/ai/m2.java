...
public final class m2 implements NotificationCenter.NotificationCenterDelegate, rf.a {
    public static final jv0 X = new jv0(new w1(1), new w1(2));
    public static final jv0 Y = new jv0(new w1(3), new w1(4));
    ...
    public org.telegram.ui.Components.u9 n;
    public kn r;
    public boolean s;
    public d2 v;
    public int w;
    ...
    @Override // rf.a
    public final View h() {
        ci.l4 l4Var = new ci.l4(this.f.getContext(), this.w);
        this.V = l4Var;
        return l4Var;
    }
    ...
    public final void i() {
        ...
        if (this.s) {
            ...
            this.f.animate().alpha(1.0f).setDuration(150L).setInterpolator(qrVar).start();
            this.s = false;
        }
