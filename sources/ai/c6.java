...
public final class c6 {
    ...
    public static String c(c6 c6Var) {
        ...
        if (storyItem == null || (messageMedia = storyItem.media) == null) {
            ...
            return "uploading from " + c6Var.b.e;
        }
    ...
    public final String e() {
        ...
        if (e6Var.B1 > 0) {
            ...
            return e6Var.O1.f ? String.format(Locale.US, "https://t.me/%1$s/s/live", UserObject.getPublicUsername(user)) : String.format(Locale.US, "https://t.me/%1$s/s/%2$s", UserObject.getPublicUsername(user), Integer.valueOf(e6Var.O1.a.id));
        }
        ...
        return e6Var.O1.f ? String.format(Locale.US, "https://t.me/%1$s/s/live", ChatObject.getPublicUsername(chat)) : String.format(Locale.US, "https://t.me/%1$s/s/%2$s", ChatObject.getPublicUsername(chat), Integer.valueOf(e6Var.O1.a.id));
    }
    ...
    public final File h() {
        ...
        if (messageMedia != null && messageMedia.getDocument() != null) {
            return FileLoader.getInstance(e6Var.C2).getPathToAttach(this.a.media.getDocument());
        }
        ...
        return !pathToAttach.exists() ? FileLoader.getInstance(e6Var.C2).getPathToAttach(closestPhotoSizeWithSize, false) : pathToAttach;
    }
    ...
    public final void o() {
        ...
        if (k9Var != null) {
            ...
            this.h = charSequence;
            CharSequence replaceEmoji = Emoji.replaceEmoji(charSequence, g5Var.b0.getPaint().getFontMetricsInt(), false);
            this.h = replaceEmoji;
        ...
        TL_stories.StoryItem storyItem = c6Var.a;
        if (storyItem != null) {
            if (!storyItem.translated || storyItem.translatedText == null || !TextUtils.equals(storyItem.translatedLng, u31.A())) {
                ...
                if (replaceEmoji2 == null || c6Var.a.entities == null) {
                    return;
                }
                SpannableStringBuilder valueOf = SpannableStringBuilder.valueOf(MessageObject.replaceAnimatedEmoji(new SpannableStringBuilder(c6Var.a.caption), c6Var.a.entities, g5Var.b0.getPaint().getFontMetricsInt(), false));
                SpannableStringBuilder.valueOf(Emoji.replaceEmoji(valueOf, g5Var.b0.getPaint().getFontMetricsInt(), false));
                i10 = (e6Var.B1 < 0 || MessagesController.getInstance(e6Var.C2).storyEntitiesAllowed(MessagesController.getInstance(e6Var.C2).getUser(Long.valueOf(e6Var.B1)))) ? 1 : 0;
                if (i10 != 0) {
                    MessageObject.addLinks(true, valueOf);
                }
                MessageObject.addEntitiesToText(valueOf, c6Var.a.entities, false, true, true, false, i10 ^ 1);
                this.h = valueOf;
                return;
            }
            this.g = true;
            TLRPC.TL_textWithEntities tL_textWithEntities = c6Var.a.translatedText;
            String str2 = tL_textWithEntities.text;
            this.h = str2;
            CharSequence replaceEmoji3 = Emoji.replaceEmoji(str2, g5Var.b0.getPaint().getFontMetricsInt(), false);
            this.h = replaceEmoji3;
            if (replaceEmoji3 == null || tL_textWithEntities.entities == null) {
                return;
            }
            SpannableStringBuilder valueOf2 = SpannableStringBuilder.valueOf(MessageObject.replaceAnimatedEmoji(new SpannableStringBuilder(tL_textWithEntities.text), tL_textWithEntities.entities, g5Var.b0.getPaint().getFontMetricsInt(), false));
            SpannableStringBuilder.valueOf(Emoji.replaceEmoji(valueOf2, g5Var.b0.getPaint().getFontMetricsInt(), false));
            i10 = (e6Var.B1 < 0 || MessagesController.getInstance(e6Var.C2).storyEntitiesAllowed(MessagesController.getInstance(e6Var.C2).getUser(Long.valueOf(e6Var.B1)))) ? 1 : 0;
            if (i10 != 0) {
