...
public final class l9 {
    ...
    public l9(int i10) {
        ...
        y9 y9Var = new y9();
        y9Var.a = i10;
        y9Var.b = MessagesStorage.getInstance(i10);
        this.k = y9Var;
    ...
    public final x8 B(long j3, boolean z10) {
        ...
        x8 x8Var2 = new x8(this.a, j3, this);
        iVar.k(x8Var2, j3);
        return x8Var2;
    }
    ...
    public final int D(int i10, long j3) {
        ...
        TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.i.f(j3);
        if (peerStories == null) {
            peerStories = z(j3);
        }
        if (peerStories == null) {
        ...
        if (j3 == UserConfig.getInstance(this.a).getClientUserId() && !Utilities.isNullOrEmpty((Collection) this.b.f(j3))) {
            return 1;
        }
        int max = Math.max(peerStories.max_read_id, this.f.get(j3, 0));
        boolean z10 = false;
    ...
    public final boolean H() {
        long j3 = UserConfig.getInstance(this.a).clientUserId;
        TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.i.f(j3);
        return ((peerStories == null || peerStories.stories.isEmpty()) && Utilities.isNullOrEmpty((Collection) this.b.f(j3))) ? false : true;
    }
    ...
    public final boolean K(long j3) {
        ArrayList arrayList = (ArrayList) this.b.f(j3);
    ...
    public final boolean N(long j3) {
        ...
        return ((k9) hg.k0.h(1, arrayList)).I;
    }
    ...
    public final void S(final TL_stories.PeerStories peerStories, final boolean z10) {
        ...
        final long j3 = peerDialogId * (z10 ? -1 : 1);
        Long valueOf = Long.valueOf(j3);
    ...
    public final void b(int i10, long j3, ArrayList arrayList) {
        ...
        while (i14 < size3) {
            ...
            i14++;
            d9 A2 = l9Var.A(B.b, 0, ((e9) obj3).a, false);
            if (A2 != null) {
    ...
    public final boolean h(long j3) {
        TLRPC.Chat chat;
        if (j3 >= 0 || (chat = MessagesController.getInstance(this.a).getChat(Long.valueOf(-j3))) == null) {
            return false;
        }
        if (chat.creator) {
            return true;
    ...
    public final boolean i(long j3) {
        return UserConfig.getInstance(this.a).getClientUserId() == j3 || h(j3);
    }
    ...
    public final boolean j(long j3) {
        ...
        int i10 = this.a;
        if (j3 >= 0) {
            return j3 > 0 && (user = MessagesController.getInstance(i10).getUser(Long.valueOf(j3))) != null && user.bot && user.bot_can_edit;
        }
    ...
    public final void k0(long j3, List list) {
        ...
        while (i10 < size) {
            ...
            i10++;
            d9 A3 = l9Var.A(j3, 0, ((e9) obj).a, false);
            if (A3 != null) {
                A3.A(list);
            }
            l9Var = this;
    ...
    public final void l0(long j3, List list, boolean z10) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                ...
                if (peerStories.stories.get(i12).id == storyItem.id) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        hg.k0.p(storyItem.id, new StringBuilder("StoriesController update story for full peer storyId="));
                    }
                } else {
                    i12++;
                }
            ...
            if (!z11) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    hg.k0.p(storyItem.id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z10) {
                    hg.k0.p(storyItem.id, new StringBuilder("StoriesController add new story for full peer storyId="));
    ...
    public final void m(TL_stories.PeerStories peerStories) {
        ...
        while (i10 < peerStories.stories.size()) {
            if (ia.w(this.a, peerStories.stories.get(i10))) {
    ...
    public final void m0(long j3, TL_stories.PeerStories peerStories) {
        ...
        if (peerStories == null || (peerStories2 = (TL_stories.PeerStories) this.i.f(j3)) == null) {
            return;
        }
    ...
    */
    public final boolean n(TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && (str = tL_error.text) != null) {
            ...
            if (str.startsWith("STORY_SEND_FLOOD_WEEKLY_")) {
                try {
                    j3 = Long.parseLong(tL_error.text.substring(24));
                } catch (Exception unused) {
                }
                this.S = new f9(2, 0, j3);
            } else if (tL_error.text.startsWith("STORY_SEND_FLOOD_MONTHLY_")) {
                try {
                    j3 = Long.parseLong(tL_error.text.substring(25));
                } catch (Exception unused2) {
                }
                this.S = new f9(3, 0, j3);
            } else if (tL_error.text.equals("STORIES_TOO_MUCH")) {
                this.S = new f9(1, 0, 0L);
    ...
    public final void n0(long j3, List list, boolean z10) {
        ...
        while (i10 < size2) {
            int i12 = i10 + 1;
            d9 A3 = l9Var.A(j3, 0, ((e9) arrayList.get(i10)).a, false);
            if (A3 != null) {
                A3.D(list, z10);
            }
            l9Var = this;
    ...
    public final f9 o() {
        ...
        TL_stories.PeerStories y3 = y(UserConfig.getInstance(i10).getClientUserId());
    ...
    public final void o0(long j3, ArrayList arrayList, boolean z10, t4 t4Var) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (!(storyItem instanceof TL_stories.TL_storyItemDeleted)) {
                ...
                if (y3 != null) {
                    for (int i11 = 0; i11 < y3.stories.size(); i11++) {
                        if (y3.stories.get(i11).id == storyItem.id) {
    ...
    public final void s(long j3, ArrayList arrayList) {
        ...
        y9 y9Var = this.k;
        y9Var.b.getStorageQueue().postRunnable(new a3.h0(y9Var, arrayList2, j3, 4));
        NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.storiesUpdated, new Object[0]);
    }
    ...
    public final k9 t(long j3, TL_stories.StoryItem storyItem) {
        ...
        return (k9) hashMap.get(Integer.valueOf(storyItem.id));
    }
    ...
    public final int x(long j3) {
        ...
        return y3 != null ? Math.max(y3.max_read_id, this.f.get(j3, 0)) : this.f.get(j3, 0);
    }

    public final TL_stories.PeerStories y(long j3) {
        return (TL_stories.PeerStories) this.i.f(j3);
    }
