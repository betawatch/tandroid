...
public final /* synthetic */ class a9 implements Runnable {
    ...
    public /* synthetic */ a9(d9 d9Var, MessagesStorage messagesStorage, int i10) {
        this.a = i10;
        this.b = d9Var;
        ...
        switch (this.a) {
            case 0:
                ...
                try {
                    ...
                    sQLiteCursor = messagesStorage.createLoadStoriesCursor(j11, d9Var2.f, d9Var2.e);
                    while (sQLiteCursor.next()) {
                        ...
                        if (byteBufferValue != null) {
                            ...
                            MessageObject messageObject = new MessageObject(d9Var2.c, TLdeserialize);
                ...
                sQLiteCursor.dispose();
                AndroidUtilities.runOnUIThread(new z8(d9Var, arrayList2, arrayList, arrayList3, arrayList4, hashSet, 0));
                return;
            default:
                d9 d9Var3 = this.b;
                ...
                try {
                    ...
                    database.executeFast("DELETE FROM profile_stories WHERE dialog_id = " + d9Var3.d + " AND type = " + d9Var3.e).stepThis().dispose();
                } catch (Throwable th5) {
                    messagesStorage2.checkSQLException(th5);
                }
                AndroidUtilities.runOnUIThread(new y8(d9Var3, 3));
                return;
        }
    }
}
