...
public final class t extends TextView {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.a) {
            case 0:
                ...
                if (layout != null) {
                    paint.setColor(j6.l1(0.45f, j6.v0(j6.y6, ((a0) this.c).W.c)));
                    float f7 = dp;
                    float f10 = max / 2.0f;
                    float f11 = f7 - f10;
                    float f12 = f7 + f10;
            ...
            case 10:
                ...
                int i10 = j6.z6;
                f6Var = ((h3) ((j0) this.c).e).resourcesProvider;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.a) {
            case 2:
                Paint paint = (Paint) this.b;
                paint.setColor(((ei.p) this.c).getThemedColor(j6.Oh));
            ...
            case 5:
                Paint paint3 = (Paint) this.b;
                paint3.setColor(((yi) this.c).getThemedColor(j6.Oh));
            ...
            case 8:
                ...
                w0 w0Var = (w0) this.c;
                paintArr[w0Var.x].setAlpha(255);
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paintArr[w0Var.x]);
                float f7 = w0Var.w;
                if (f7 > 0.0f) {
                    int i10 = w0Var.x;
                    if (i10 + 1 < paintArr.length) {
                        paintArr[i10 + 1].setAlpha((int) (f7 * 255.0f));
                        canvas.drawRoundRect(rectF2, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paintArr[w0Var.x + 1]);
                    }
                }
                super.onDraw(canvas);
                break;
            ...
            case 11:
                ...
                paint4.setColor(((sh.f) this.c).getThemedColor(j6.Oh));
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.a) {
            case 6:
                ...
                ((w1) this.b).a.set(rectF);
                ((w1) this.b).b.set(rectF);
                ((w1) this.b).f();
    ...
    */
    ...
    public void setTextColor(int i10) {
        switch (this.a) {
            case 7:
                ...
                ((q90) this.c).f(j6.l1(0.03f, i10), j6.l1(0.175f, i10), j6.l1(0.2f, i10), j6.l1(0.45f, i10));
                break;
            default:
    ...
    public t(w0 w0Var, Context context) {
        ...
        this.a = 8;
        this.c = w0Var;
        this.b = new Paint[w0Var.f.length];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = (Paint[]) this.b;
