        ...
        switch (this.G) {
            ...
            case 3:
                ...
                if (!abVar.F) {
                    ...
                    ia.h(abVar.U, canvas, this.a, l6Var);
                    break;
                }
            case 4:
                super.onDraw(canvas);
                ...
                if (ebVar.e) {
                    ...
                    drawable.setBounds(wl.w(2, measuredWidth, drawable), wl.e(2, measuredHeight, ebVar.n.v), wl.B(2, measuredWidth, ebVar.n.v), wl.z(2, measuredHeight, ebVar.n.v));
