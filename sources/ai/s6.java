    ...
    public final boolean d(int i10, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n6) {
            ...
            if (jcVar.v != null && (storyView = ((z6) j7Var.w.c.get(i10)).b) != null && (user = (messagesController = MessagesController.getInstance(i11)).getUser(Long.valueOf(storyView.user_id))) != null) {
                    ...
                    public final void run() {
                        ...
                        switch (i14) {
                            case 0:
                                ...
                                j7 j7Var2 = s6Var.b;
                                hg.k0.s(R.string.StoryHidFromToast, new Object[]{str3}, new vc(j7Var2, j7Var2.s), R.raw.ic_ban, 36);
                                n6Var2.a(j7Var2.d(storyView2) ? 1.0f : 0.5f, true);
                                break;
                            default:
                                messagesController2.getStoriesController().j0(user2.id, false, true);
                                j7 j7Var3 = s6Var.b;
                                hg.k0.s(R.string.StoryShownBackToToast, new Object[]{str3}, new vc(j7Var3, j7Var3.s), R.raw.contact_check, 36);
                                n6Var2.a(j7Var3.d(storyView2) ? 1.0f : 0.5f, true);
                                break;
                        }
                    }
                }, z13);
                    ...
                    public final void run() {
                        switch (i15) {
                            case 0:
                                ...
                                j7 j7Var2 = this.b.b;
                                new vc(j7Var2, j7Var2.s).e(true).j();
                                n6Var.a(j7Var2.d(storyView) ? 1.0f : 0.5f, true);
                                break;
                            default:
                                MessagesController messagesController2 = messagesController;
                                ...
                                j7 j7Var3 = this.b.b;
                                new vc(j7Var3, j7Var3.s).e(false).j();
                                n6Var.a(j7Var3.d(storyView) ? 1.0f : 0.5f, true);
                                break;
                        }
                    }
                });
                ...
                F.m(z12 && !isUserSelf, R.drawable.msg_user_remove, LocaleController.getString(R.string.StoryDeleteContact), true, new m3(this, user, str2, n6Var, storyView, 3));
                ...
                if (!(reaction instanceof TLRPC.TL_reactionCustomEmoji) || (c10 = org.telegram.ui.Components.o5.h(i11).c(((TLRPC.TL_reactionCustomEmoji) reaction).document_id)) == null) {
                    ...
                    ta0Var.setOnClickListener(new d0(this, arrayList, F, i13));
                    F.q(ta0Var);
                    z10 = true;
                }
                if (F.x() <= 0 && !z10) {
