...
public class d9 {
    ...
    public final y8 q = new y8(this, 0);
    public int s = -1;
    public int A = -1;
    ...
    public d9(int i10, long j3, int i11, int i12, Utilities.Callback callback) {
        ...
        this.e = i11;
        this.f = i12;
        this.x = new a1.e(18, this, callback);
        if (i11 != 0 || i12 <= 0) {
    ...
    public final void D(List list, boolean z10) {
        ...
        while (true) {
            ...
            if (storyItem2 != null) {
                ...
                if (z12 != z13) {
                    if (!z13) {
                        org.telegram.messenger.l0.m(storyItem2.id, new StringBuilder("StoriesList remove story "));
                    ...
                    org.telegram.messenger.l0.m(storyItem2.id, new StringBuilder("StoriesList update story "));
    ...
    */
    ...
    public boolean q(int i10, List list, boolean z10) {
        ...
        if (this.t) {
            this.y = new b9(this, z10, i10, list);
            return false;
        }
        int i12 = this.e;
        long j3 = this.d;
