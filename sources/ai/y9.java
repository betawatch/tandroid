...
public final class y9 {
    ...
    */
                    ...
                    try {
                        ...
                        while (sQLiteCursor.next()) {
                            ...
                            if (byteBufferValue != 0) {
                                ...
                                fb.a(TLdeserialize, byteBufferValue2);
    ...
    public static void b(int i10, long j3, MessageObject messageObject, TL_stories.StoryItem storyItem) {
        ...
        if (i11 == 23 || i11 == 24) {
            n2 n2Var = new n2();
            n2Var.user_id = DialogObject.getPeerDialogId(messageObject.messageOwner.media.peer);
            TLRPC.MessageMedia messageMedia = messageObject.messageOwner.media;
            n2Var.peer = messageMedia.peer;
            n2Var.id = messageMedia.id;
            n2Var.storyItem = c(i10, j3, storyItem);
            TLRPC.Message message2 = messageObject.messageOwner;
            n2Var.via_mention = message2.media.via_mention;
            message2.media = n2Var;
        }
    ...
    public final void d(a0.i iVar, Runnable runnable, int i10, boolean z10, Timer timer) {
        ...
        while (i12 < iVar.m()) {
            ...
            while (i13 < arrayList2.size()) {
                ...
                TL_stories.StoryItem f7 = y9Var.f(e(messageObject), j3);
    ...
    public final TL_stories.StoryItem f(int i10, long j3) {
        ...
        try {
            ...
            if (queryFinalized.next()) {
                ...
                if (storyItem != null) {
                    fb.a(storyItem, byteBufferValue2);
                }
                if (byteBufferValue2 != null) {
                    byteBufferValue2.reuse();
                }
            ...
            try {
                ...
                for (int i10 = 0; i10 < arrayList.size(); i10++) {
                    ...
                    if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                        ...
                        NativeByteBuffer b10 = fb.b(storyItem);
                        if (b10 != null) {
