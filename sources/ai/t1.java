    ...
    public final void run() {
        ...
        switch (this.a) {
            ...
            default:
                d2 d2Var4 = this.b;
                if (!d2Var4.n) {
                    oe0.d(R.raw.permission_request_camera, R.string.PermissionNoCameraMicVideo, new String[]{"android.permission.CAMERA", "android.permission.RECORD_AUDIO"}, new y1(d2Var4, i10));
                    break;
                }
                break;
        }
