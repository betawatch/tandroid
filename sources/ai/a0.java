            ...
            if (!values.isEmpty()) {
                ...
                if (this.F) {
                    if (z10 && this.U && !this.N) {
                        ...
                        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                        nxVar.j0 = ofFloat;
                        ofFloat.addUpdateListener(new x(i11, this, k5Var));
                        nxVar.j0.addListener(new z(i11, this, k5Var));
                        nxVar.j0.setDuration(150L);
                        this.y.setAlpha(0.0f);
                        this.y.setTranslationY(AndroidUtilities.dp(5.0f));
                        nxVar.k0 = new y(this, i11);
                    }
                ...
                if (this.S == null) {
                    ...
                    o oVar = new o(nxVar, mutate, mutate2, mutate, mutate2);
                    oVar.w = true;
                    this.S = oVar;
                }
                this.y.l(Emoji.replaceEmoji(trim, this.y.getPaint().getFontMetricsInt(), false), false);
