    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            ...
            case 3:
                ...
                break;
            case 4:
                AndroidUtilities.runOnUIThread(new ba(i17, (ci.d8) obj, tLObject));
                break;
            case 5:
                AndroidUtilities.runOnUIThread(new ba(27, (ci.l8) obj, tLObject));
                break;
            case 6:
                AndroidUtilities.runOnUIThread(new ba(i18, (ci.u8) obj, tLObject));
                break;
            case 7:
                AndroidUtilities.runOnUIThread(new ci.y8(i13, (ei.q4) obj, tL_error));
                break;
            case 8:
                gg.c cVar = (gg.c) obj;
                if (tLObject != null) {
            ...
            case 9:
                ...
                i0Var.getClass();
                AndroidUtilities.runOnUIThread(new ci.y8(i17, i0Var, tLObject));
                break;
            case 10:
                AndroidUtilities.runOnUIThread(new gg.t((hg.d) obj, tL_error, tLObject, i15));
                break;
            case 11:
                AndroidUtilities.runOnUIThread(new gg.x1(2, (hg.g) obj, tLObject));
                break;
            case 12:
                AndroidUtilities.runOnUIThread(new gg.t((hg.n) obj, tL_error, tLObject, i11));
                break;
            case 13:
            ...
            case 14:
                ...
                break;
            case 15:
                AndroidUtilities.runOnUIThread(new gg.x1(i12, (hg.c2) obj, tLObject));
                break;
            case 16:
            ...
            case 17:
                ...
                break;
            case 18:
                AndroidUtilities.runOnUIThread(new hb1(i18, (org.telegram.ui.web.f2) obj, tLObject));
                break;
            case 19:
                ...
                if (tLObject != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new fr0(y0Var, hashMap, arrayList, i16));
                    break;
                }
                break;
            case 20:
            ...
            case 22:
                ...
                break;
            case 23:
                AndroidUtilities.runOnUIThread(new fr0((uf.d) obj, tLObject, tL_error, i18));
                break;
            case 24:
            ...
            case 26:
                ...
                break;
            case 27:
                AndroidUtilities.runOnUIThread(new uh.i(i13, tLObject, (ii.q1) obj));
                break;
            case 28:
                AndroidUtilities.runOnUIThread(new uh.i(i14, (yh.l5) obj, tLObject));
                break;
            default:
