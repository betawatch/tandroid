    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            case 0:
                ...
                xc xcVar = new xc(a5Var, f6Var3);
                y1 y1Var = new y1(jcVar, 2);
                int i12 = c41.v;
                c41.K(i11, context, storyItem.dialogId, true, false, new ArrayList(Collections.singleton(Integer.valueOf(storyItem.id))), xcVar, f6Var3, new byte[0], null, y1Var);
                w5 w5Var2 = f6Var2.t1;
                if (w5Var2 != null) {
                    w5Var2.a();
                    break;
            ...
            case 1:
                ...
                if (d2Var != null) {
                    ...
                    if (groupCall == null ? true : groupCall.messages_enabled) {
                        ...
                        iaVar.T = new ah.b(2, w5Var, iaVar);
                        iaVar.show();
                        break;
                    }
                }
