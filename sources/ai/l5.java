    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            case 0:
                ...
                vc vcVar = new vc(a5Var, e6Var2);
                y1 y1Var = new y1(jcVar, 2);
                int i13 = c41.v;
                c41.K(i12, context, storyItem.dialogId, true, false, new ArrayList(Collections.singleton(Integer.valueOf(storyItem.id))), vcVar, e6Var2, new byte[0], null, y1Var);
                w5 w5Var2 = f6Var.t1;
                if (w5Var2 != null) {
                    w5Var2.a();
                    break;
