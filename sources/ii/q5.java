...
public final class q5 extends ViewGroup {
    ...
    public final TL_iv.pageTableCell a() {
        ...
        if (h6Var != null && h6Var.b != 0 && h6Var.c != 0) {
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        h6 h6Var2 = this.a;
        RectF rectF = this.y;
        if (h6Var2 != null && h6Var2.b != 0 && h6Var2.c != 0) {
            ...
            float f12 = this.f[0];
            h6 h6Var3 = this.a;
            rectF.set(f11, f12, r2[h6Var3.c], r4[h6Var3.b]);
            Path path = this.F;
            path.rewind();
            ...
            for (int i19 = 0; i19 < getChildCount(); i19++) {
                ...
                if (childAt instanceof r5) {
                    r5 r5Var = (r5) childAt;
                    int b12 = this.a.b(r5Var.b);
                    int a11 = this.a.a(r5Var.b);
                    if (b12 >= 0 && a11 >= 0) {
                        int n10 = h6.n(r5Var.b);
                        int o9 = h6.o(r5Var.b);
                        int[] iArr3 = this.e;
                        int i20 = iArr3[a11];
                        int i21 = this.f[b12];
        ...
        h6 h6Var4 = this.a;
        if (h6Var4 != null && (pageblocktable = h6Var4.a) != null && pageblocktable.bordered) {
            Paint paint = this.n;
            ...
            int[] iArr7 = this.f;
            h6 h6Var5 = this.a;
            rectF.set(iArr6[0] + strokeWidth, iArr7[0] + strokeWidth, iArr6[h6Var5.c] - strokeWidth, iArr7[h6Var5.b] - strokeWidth);
            ...
            while (i24 < this.a.c) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[] pagetablecellArr = h6Var6.d[i27];
            ...
            for (int i28 = 1; i28 < this.a.b; i28++) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[][] pagetablecellArr2 = h6Var7.d;
    ...
    public final r5 m(TL_iv.pageTableCell pagetablecell) {
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            View childAt = getChildAt(i10);
            if (childAt instanceof r5) {
                r5 r5Var = (r5) childAt;
                if (r5Var.b == pagetablecell) {
                    return r5Var;
                }
            }
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt instanceof r5) {
                r5 r5Var = (r5) childAt;
                int b10 = this.a.b(r5Var.b);
                int a2 = this.a.a(r5Var.b);
                if (b10 >= 0 && a2 >= 0) {
                    int i15 = this.e[a2];
                    int i16 = this.f[b10];
                    r5Var.layout(i15, i16, r5Var.getMeasuredWidth() + i15, r5Var.getMeasuredHeight() + i16);
                }
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (i21 < getChildCount()) {
            ...
            if (childAt2 instanceof r5) {
                r5 r5Var2 = (r5) childAt2;
                i1 i1Var2 = r5Var2.a;
                int n10 = h6.n(r5Var2.b);
                if (n10 > i12) {
                    int a10 = this.a.a(r5Var2.b);
        ...
        while (i30 < getChildCount()) {
            ...
            if (childAt3 instanceof r5) {
                ...
                r5Var3.measure(View.MeasureSpec.makeMeasureSpec(i31, TLObject.FLAG_30), makeMeasureSpec);
                if (h6.o(r5Var3.b) == 1) {
        ...
        for (int i33 = 0; i33 < getChildCount(); i33++) {
            ...
            if (childAt4 instanceof r5) {
                ...
                if (o9 > 1) {
                    ...
                    int measuredHeight2 = r5Var4.getMeasuredHeight();
    ...
    public final boolean p(int i10, int i11) {
        p5 p5Var;
        h6 h6Var = this.a;
        if (h6Var == null || (p5Var = this.h) == null || i10 < 0 || i10 >= h6Var.b || i11 < 0 || i11 >= h6Var.c) {
            return false;
        }
        return ((LinkedHashSet) ((ei.d5) p5Var).b).contains(h6Var.d[i10][i11]);
    }
    ...
    public final void s() {
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            if (getChildAt(childCount) instanceof r5) {
        ...
        int size = h6Var.g.size();
        for (int i10 = 0; i10 < size; i10++) {
            TL_iv.pageTableCell pagetablecell = (TL_iv.pageTableCell) this.a.g.get(i10);
            r5 r5Var = new r5(getContext(), this.b);
            r5Var.setCompact(this.a.a.compact);
            r5Var.b(pagetablecell);
            addView(r5Var);
        }
    }

    public void setModel(h6 h6Var) {
        this.a = h6Var;
        s();
    }

    public void setSelectionProvider(p5 p5Var) {
        this.h = p5Var;
        invalidate();
    }
