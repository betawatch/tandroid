    ...
    */
    public static TL_iv.RichText f(CharSequence charSequence) {
        ...
        while (i10 < length) {
            ...
            if (f6Var != null) {
                l4 l4Var = f6Var.f;
                if (l4Var == null && f6Var2.f == null) {
                    if (f6Var.d == 0 && f6Var2.d == 0 && f6Var.e == null && f6Var2.e == null && f6Var.a == f6Var2.a) {
                        if ((r9 = f6Var.b) == null) {
                        }
                    }
                    arrayList.add(s(charSequence.subSequence(i11, i10).toString(), f6Var));
                    i11 = i10;
                } else {
                    i10 = (l4Var != null && l4Var == f6Var2.f) ? nextSpanTransition : 0;
                    arrayList.add(s(charSequence.subSequence(i11, i10).toString(), f6Var));
                    i11 = i10;
                }
            }
        ...
        arrayList.add(s(charSequence3, f6Var));
        if (arrayList.size() == 1) {
