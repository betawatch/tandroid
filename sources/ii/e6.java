...
public final class e6 extends FrameLayout implements org.telegram.ui.ActionBar.y5, q9 {
    ...
    public e6(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        i1Var.setDelegate(new au(this) { // from class: ii.v5
            ...
            public final void i() {
                switch (i10) {
                    case 0:
                        e6 e6Var = this.b;
                        if (!e6Var.S && e6Var.x != null) {
                            e6Var.J();
                            e6.d(e6Var.x.b, e6Var.f.getText());
                            b6 b6Var = e6Var.y;
                            if (b6Var != null) {
                                x3.O1(((f3) b6Var).a);
                                break;
        ...
        i1Var.setOnFocusChangeListener(new w5(this, i10));
    ...
    public static void a(e6 e6Var, boolean z10) {
        b6 b6Var;
        e6Var.f.setHint(e6Var.getHint());
        if (z10 || (b6Var = e6Var.y) == null) {
            return;
        }
        ((f3) b6Var).a.h3.g(e6Var, null);
    }
    ...
    public static boolean m(i1 i1Var, int i10, int i11, int i12, int i13) {
        return i1Var.length() == 0 && i12 >= i10 && i12 <= i1Var.getWidth() + i10 && i13 >= i11 && i13 <= i1Var.getHeight() + i11;
    }
    ...
    public static d6 r(a aVar, String str) {
        ...
        if (lowerCase.length() == 3 && lowerCase.charAt(0) == '/' && lowerCase.charAt(1) == 'h' && (charAt = lowerCase.charAt(2)) >= '1' && charAt <= '6') {
            return new d6(v(charAt - '0'), aVar.c, aVar.d);
        }
    ...
    public static d6 s(a aVar, String str) {
        ...
        if (str.charAt(0) == '#' && (z10 || z11)) {
            ...
            return new d6(v(i11), aVar.c, aVar.d);
        }
        if (!z10) {
            return null;
        }
    ...
    public final void D(o0 o0Var) {
        if (this.y == null || this.x == null || o0Var == null) {
            return;
        }
        List<String> list = o0Var.c;
        if (list.isEmpty()) {
            return;
        }
        for (String str : list) {
            int q6 = q(str);
            if (q6 != 0) {
                ((f3) this.y).c(this.x, q6);
                return;
            }
            d6 r10 = r(this.x, str);
            if (r10 == null) {
                r10 = s(this.x, w.c.g(str, " "));
            }
            if (r10 != null) {
    ...
    public final void E(Editable editable) {
        a aVar = this.x;
        if (aVar != null && x3.C3(aVar.b) && com.google.android.gms.internal.vision.e2.u(editable)) {
            i1 i1Var = this.f;
    ...
    public final void F() {
        b6 b6Var;
        a aVar = this.x;
        if (aVar == null || aVar.c <= 0 || (b6Var = this.y) == null) {
            return;
        }
        ...
        a aVar2 = this.x;
        if (aVar2.n) {
            b10 = aVar2.l <= 0 ? 0 : AndroidUtilities.dp(hg.c.g(r0, 1, 16, 10));
        }
        a aVar3 = this.x;
        if (aVar3.o) {
            a2 = aVar3.m <= 0 ? 0 : AndroidUtilities.dp(hg.c.g(r1, 1, 16, 10));
        }
    ...
    public final void G() {
        ...
        i1 i1Var = this.f;
        i1 i1Var2 = this.h;
        if (aVar != null && p(aVar.b) && (i1Var.length() > 0 || i1Var2.length() > 0)) {
    ...
    public final void H() {
        ...
        if (i1Var.getText() != null) {
            ...
            int i11 = -1;
            if (!o() || !((TL_iv.pageBlockBlockquote) this.x.b).collapsed || (layout = i1Var.getLayout()) == null || layout.getLineCount() <= 3 || (lineStart = layout.getLineStart(3)) >= (i10 = text.length())) {
                i10 = -1;
            } else {
                i11 = lineStart;
            }
    ...
    public final void I(TL_iv.PageBlock pageBlock, boolean z10) {
        ...
        if (linearLayout3 == null) {
            ...
            this.s.setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.i6, d6Var), AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f)));
            ...
            this.s.setOnClickListener(new u5(this, 1));
            this.s.setOnLongClickListener(new x5());
        }
        String str = ((TL_iv.pageBlockPreformatted) pageBlock).language;
        int l1 = org.telegram.ui.ActionBar.h6.l1(TextUtils.isEmpty(str) ? 0.5f : 0.75f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, d6Var));
    ...
    public final void c(a aVar) {
        ...
        if (aVar.d == 0) {
            ...
            if (b6Var != null) {
                ...
                ArrayList arrayList = ((f3) b6Var).a.l3;
                int indexOf = arrayList.indexOf(aVar);
                if (indexOf < 0 || (i10 = aVar.c) <= 0 || aVar.d <= 0) {
                    b10 = org.telegram.messenger.z0.b(10.0f, (int) Math.ceil(paint.measureText(a4.a.o(aVar.d, ".", new StringBuilder()))), AndroidUtilities.dp(28.0f));
                } else {
                    int i13 = indexOf;
                    while (i13 > 0) {
                    ...
                    b10 = org.telegram.messenger.z0.b(10.0f, (int) Math.ceil(f7), AndroidUtilities.dp(28.0f));
                }
            } else {
                int dp = AndroidUtilities.dp(28.0f);
                TextPaint paint3 = oVar.getPaint();
                b10 = org.telegram.messenger.z0.b(10.0f, (int) Math.ceil(paint3.measureText(aVar.d + ".")), dp);
            }
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
            ...
            if (aVar == null || !(aVar.b instanceof TL_iv.pageBlockBlockquote)) {
                ...
                if (aVar != null && (aVar.b instanceof TL_iv.pageBlockPullquote)) {
                    if (this.J == null) {
                        ...
                        this.J = tl0Var;
                        tl0Var.a(null, null, null, this.a, 1);
                        o8.a(this.J, d6Var);
                    }
                    if (this.K == null) {
                    ...
                    if (layout != null && !TextUtils.isEmpty(layout.getText())) {
                        ...
                        for (int i11 = 0; i11 < layout.getLineCount(); i11++) {
                            width = Math.min(width, layout.getLineLeft(i11) + i1Var.getPaddingLeft() + i1Var.getLeft() + linearLayout.getLeft());
                            f7 = Math.max(f7, layout.getLineRight(i11) + i1Var.getPaddingLeft() + i1Var.getLeft() + linearLayout.getLeft());
                        }
                    ...
                    if (i1Var3.getVisibility() == 0) {
                        ...
                        if (layout2 != null && !TextUtils.isEmpty(layout2.getText())) {
                            for (int i12 = 0; i12 < layout2.getLineCount(); i12++) {
                                width = Math.min(width, layout2.getLineLeft(i12) + i1Var3.getPaddingLeft() + i1Var3.getLeft());
                                f7 = Math.max(f7, layout2.getLineRight(i12) + i1Var3.getPaddingLeft() + i1Var3.getLeft());
                            }
                ...
                if (this.J == null) {
                    tl0 tl0Var2 = new tl0(this);
                    this.J = tl0Var2;
                    tl0Var2.a(null, null, null, this.a, 1);
                    o8.a(this.J, d6Var);
                }
        ...
        if (this.T) {
            ...
            if (layout3 != null) {
                ...
                for (int i15 = 0; i15 < layout3.getLineCount(); i15++) {
                    ...
                    width4 = Math.min(width4, layout3.getLineLeft(i15) + i1Var.getPaddingLeft() + i1Var.getLeft() + linearLayout.getLeft());
                    f10 = Math.max(f10, layout3.getLineRight(i15) + i1Var.getPaddingLeft() + i1Var.getLeft() + linearLayout.getLeft());
        ...
        b6 b6Var = this.y;
        r9 textSelectionHelper = b6Var != null ? ((f3) b6Var).a.getTextSelectionHelper() : null;
        ...
        if (o()) {
            ...
            this.L.a(canvas2, this.M, org.telegram.messenger.z0.B(16.0f, getWidth(), dp8), org.telegram.messenger.z0.B(8.0f, getHeight(), dp8), v02, pageblockblockquote.collapsed, l());
        }
    }
    ...
    */
    public final void g(a aVar, b6 b6Var, boolean z10) {
        float f7;
        float f10;
        a aVar2;
        int c10;
        ...
        TL_iv.PageBlock pageBlock = aVar.b;
        i1 i1Var = this.f;
        i1Var.setBlock(pageBlock);
        TL_iv.PageBlock pageBlock2 = aVar.b;
        int i10 = SharedConfig.fontSize;
        i1Var.setCenterEmptyHint(false);
        i1Var.setHint(getHint());
        i1Var.setTextColorKey(org.telegram.ui.ActionBar.h6.G6);
        i1Var.setLineSpacing(0.0f, 1.0f);
        if (pageBlock2 instanceof TL_iv.pageBlockPreformatted) {
            ...
            i1Var.setInputType(655505);
            i1Var.setAllowNewlines(true);
            i1Var.setSoftEnterNewline(false);
            i1Var.setGravity(8388659);
            i1Var.setTextSize(1, i10 - 1);
            i1Var.setTypeface(Typeface.MONOSPACE);
            i1Var.setLineSpacing(i1Var.getPaint().getFontSpacing() * 0.3f, 1.0f);
            ...
            if (pageBlock2 instanceof TL_iv.pageBlockBlockquote) {
                ...
                i1Var.setTextSize(1, Math.max(8, i10 - 2));
                ...
                if (!(pageBlock2 instanceof TL_iv.pageBlockPullquote)) {
                    ...
                    if (aVar3 != null && aVar3.c > 0) {
                        ...
                        b6 b6Var2 = this.y;
                        int b10 = b6Var2 != null ? ((f3) b6Var2).b(this.x) : AndroidUtilities.dp(8.0f);
                        int dp2 = AndroidUtilities.dp(16.0f);
                        b6 b6Var3 = this.y;
                        setPadding(dp, b10, dp2, b6Var3 != null ? ((f3) b6Var3).a(this.x) : AndroidUtilities.dp(11.0f));
                    }
                    if (z12) {
                        i1Var.setTextSize(1, i10 + 3);
                        i1Var.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_MERRIWEATHER_BOLD));
                    } else if (pageBlock2 instanceof TL_iv.pageBlockHeading2) {
                        i1Var.setTextSize(1, i10 + 2);
                        i1Var.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_MERRIWEATHER_BOLD));
                    } else if (pageBlock2 instanceof TL_iv.pageBlockHeading3) {
                        i1Var.setTextSize(1, i10 + 1);
                        i1Var.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_MERRIWEATHER_BOLD));
                    } else if (pageBlock2 instanceof TL_iv.pageBlockHeading4) {
                        i1Var.setTextSize(1, i10);
                        i1Var.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_MERRIWEATHER_BOLD));
                        ...
                        i1Var.setTextSize(1, i10 - 2);
                        i1Var.setTypeface(null);
                        i1Var.setTextColorKey(org.telegram.ui.ActionBar.h6.Yc);
                    } else {
                        i1Var.setTextSize(1, (!(pageBlock2 instanceof TL_iv.pageBlockParagraph) || (aVar2 = this.x) == null || aVar2.k.isEmpty()) ? i10 : Math.max(8, i10 - 2));
                        i1Var.setTypeface(null);
                    }
                    i1Var.setAccentHint(false);
                    c10 = o8.c(aVar);
                    ...
                    if (c10 <= 0 || d > 0) {
                        ...
                        if (aVar.n) {
                            paddingTop = (aVar.l <= 0 ? 0 : AndroidUtilities.dp(hg.c.g(r7, 1, 16, 10))) + (z11 ? AndroidUtilities.dp(f10) : 0);
                        }
                        if (aVar.o) {
                            paddingBottom = aVar.m <= 0 ? 0 : AndroidUtilities.dp(hg.c.g(r8, 1, 16, 10));
                        }
                        if (z11) {
                    ...
                    if (!String.valueOf(i1Var.getText()).equals(z(aVar.b))) {
                        ...
                        if (x3.C3(aVar.b)) {
                            ...
                            g6.o(spannableString, 0, spannableString.length(), 1, false, null);
                            g6.o(spannableString, 0, spannableString.length(), 2, false, null);
                            A = spannableString;
                        }
                        i1Var.setTextSilently(Emoji.replaceEmoji((CharSequence) A, i1Var.getPaint().getFontMetricsInt(), false, x3.C3(aVar.b) ? 0.85f : 1.0f));
                        E(i1Var.getText());
                    ...
                    if (p5) {
                        ...
                        j(pageBlock3);
                        i1Var2.setTextSize(1, Math.max(8, SharedConfig.fontSize - 2));
                        i1Var2.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_MEDIUM));
                        i1Var2.setTextColorKey(org.telegram.ui.ActionBar.h6.Oh);
                        i1Var2.setAccentHint(true);
                        i1Var2.setHint(LocaleController.getString(R.string.ArticleHintAuthor));
                        if (pageBlock3 instanceof TL_iv.pageBlockPullquote) {
                            i1Var2.setGravity(49);
                        } else {
                            i1Var2.setGravity(8388659);
                        }
                        if (!String.valueOf(i1Var2.getText()).equals(g6.l(k(pageBlock3)))) {
                            i1Var2.setTextSilently(Emoji.replaceEmoji(g6.r(k(pageBlock3), null, true), i1Var2.getPaint().getFontMetricsInt(), false));
                ...
                i1Var.setInputType(147457);
                i1Var.setAllowNewlines(false);
                i1Var.setSoftEnterNewline(true);
                i1Var.setGravity(49);
                ...
                i1Var.setTextSize(1, Math.max(8, i10 - 2));
                i1Var.setTypeface(AndroidUtilities.getTypeface("fonts/ritalic.ttf"));
                i1Var.setAccentHint(true);
            }
        }
        f10 = 24.0f;
    ...
    public final int h(int i10, int i11) {
        ...
        if (l()) {
            ...
            if (i1Var.getVisibility() == 0 && (layout = i1Var.getLayout()) != null && layout.getLineCount() > 0) {
                ...
                float B = org.telegram.messenger.z0.B(16.0f, i10, dp);
                this.L.getClass();
                float D = B - org.telegram.messenger.z0.D(3.333f, 2, AndroidUtilities.dp(23.66f) + r6.c);
                this.L.getClass();
                int i12 = i11 - dp;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        i1Var.measure(View.MeasureSpec.makeMeasureSpec(max, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(0, 0));
        int paddingBottom = getPaddingBottom() + i1Var.getMeasuredHeight() + linearLayout.getMeasuredHeight() + getPaddingTop();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        ...
        li0 li0Var = this.L;
        if (li0Var != null) {
            return drawable == li0Var.b || drawable == li0Var.e;
        }
        return false;
    }
