...
public abstract class d4 {
    ...
    */
                        ...
                        switch (c10) {
                            ...
                            case 1:
                                ...
                                if (aVar == null) {
                                    if (charSequence != null && charSequence.length() > 0) {
                                        ...
                                        pageblockparagraph.text = f6.f(charSequence);
                            ...
                            case 16:
                                ...
                                if (lowerCase.contains("button-row")) {
                                    ...
                                    a(B(c4Var2, false), arrayList2);
                                } else if (lowerCase.contains("slideshow")) {
                                    a(B(c4Var2, true), arrayList2);
                                } else {
                                    b(arrayList2, new TL_iv.pageBlockParagraph(), c4Var2);
                                }
                                break;
                            case 17:
                                a(m(c4Var2), arrayList2);
                                break;
                            case 18:
                            ...
                            case 24:
                                ...
                                if (a12 == null || !a12.toLowerCase().contains("pull")) {
                                    ...
                                    TL_iv.RichText f7 = (c4Var5 == null || (w10 = w(c4Var5)) == null || w10.length() == 0) ? null : f6.f(w10);
                                    if (z11) {
                                        long a13 = q0.a();
                                        ...
                                        d6.d(pageblockblockquote, L(spannableStringBuilder4));
                                        if (f7 != null) {
                                    ...
                                    d6.d(pageblockpullquote, L(spannableStringBuilder5));
                                    TL_iv.RichText f10 = (c4Var == null || (w11 = w(c4Var)) == null || w11.length() == 0) ? null : f6.f(w11);
                                    if (f10 != null) {
                            ...
                            case 25:
                                ...
                                pageblockdetails.title = f6.f(L(spannableStringBuilder6));
    ...
    public static void D(c4 c4Var, ArrayList arrayList, int i10, boolean z10) {
        ...
        while (i14 < size) {
            ...
            if (!c4Var2.b && "li".equals(c4Var2.a)) {
                ...
                TL_iv.pageBlockParagraph pageblockparagraph = new TL_iv.pageBlockParagraph();
                pageblockparagraph.text = f6.f(L(spannableStringBuilder));
                ...
                if (aVar.k.size() > i18) {
                    ...
                    if (w3.y3(aVar)) {
                        ...
                        if (aVar.c <= 0 || l(aVar.b) == null) {
                            ...
                            if (!arrayList.isEmpty() && ((Boolean) hg.k0.h(1, arrayList)).booleanValue() != z12) {
                                cVar2.a(sb3);
    ...
    public static void H(StringBuilder sb2, TL_iv.pageBlockTable pageblocktable) {
        ...
        SpannableStringBuilder r10 = richText != null ? f6.r(richText, null, true) : null;
    ...
    public static void I(TL_iv.PageBlock pageBlock, CharSequence charSequence) {
        ...
        pageCaption.text = f6.f(charSequence);
    ...
    public static void b(ArrayList arrayList, TL_iv.PageBlock pageBlock, c4 c4Var) {
        ...
        d6.d(pageBlock, L(spannableStringBuilder));
    ...
    public static void g(StringBuilder sb2, CharSequence charSequence) {
        ...
        while (i22 < length) {
            ...
            if (k4Var != null) {
                ...
                int i24 = 0;
                for (q01 q01Var : (q01[]) spanned.getSpans(i22, nextSpanTransition, q01.class)) {
                    p01 p01Var = q01Var.b;
                    if (p01Var != null) {
                        i24 |= p01Var.a;
                    }
                ...
                String url = p51VarArr.length > 0 ? p51VarArr[c10].getURL() : null;
    ...
    */
    public static void h(SpannableStringBuilder spannableStringBuilder, c4 c4Var, int i10, String str, long j3) {
        ...
        if ("button".equals(c4Var.a) && (v = v(c4Var)) != null) {
            ...
            if (spannableStringBuilder2.length() > 0) {
                ...
                textbutton.text = f6.f(spannableStringBuilder2);
                textbutton.type = v;
    ...
    public static void j(SpannableStringBuilder spannableStringBuilder, String str, int i10, String str2, long j3) {
        ...
        if (i10 != 0) {
            p01 p01Var = new p01();
            p01Var.a = i10 & 114975;
            spannableStringBuilder.setSpan(new q01(p01Var, AndroidUtilities.dp(SharedConfig.fontSize)), length, length2, 33);
        }
        if (str2 != null) {
            ...
            if (!c4Var2.b) {
                ...
                switch (str) {
                        ...
                        while (i12 < size2) {
                            ...
                            if (!c4Var3.b) {
                                if ("td".equals(c4Var3.a) || "th".equals(c4Var3.a)) {
                                    ...
                                    h6.l(pagetablecell, "th".equals(c4Var3.a) || c4Var3.b("header"));
                    ...
                    case "thead":
                        ...
                        break;
                    case "caption":
                        pageblocktable.title = f6.f(w(c4Var2));
                        break;
                }
                i10 = 0;
            }
                    ...
                    if (str.charAt(i12) != '<') {
                        ...
                        if (!substring.isEmpty()) {
                            ...
                            if (arrayList3.isEmpty()) {
                                ...
                                ((c4) hg.k0.h(1, arrayList3)).e.add(c4Var);
                            }
                        }
                        ...
                        if (i13 >= 0) {
                            ...
                            if (c4Var2 != null) {
                                if (arrayList3.isEmpty()) {
                                    ...
                                    ((c4) hg.k0.h(1, arrayList3)).e.add(c4Var2);
                                }
                                if (!endsWith) {
                            ...
                            if (!substring3.isEmpty()) {
                                ...
                                if (arrayList3.isEmpty()) {
                                    ...
                                    ((c4) hg.k0.h(1, arrayList3)).e.add(c4Var3);
                                }
                            }
                        }
                    } else {
