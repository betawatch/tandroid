...
public final class p5 extends a0 implements org.telegram.ui.ActionBar.y5, q9 {
    public d3 E;
    public i6 F;
    public boolean G;
    ...
    public p5(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        addView(b4Var, w7.x5.d(-1, -2.0f, 51, 0.0f, 6.0f, 0.0f, 0.0f));
    ...
    public final void e() {
        i1 i1Var = this.r;
        i1Var.t();
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, this.n);
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (m10 != null && (layout = (i1Var = m10.a).getLayout()) != null) {
                ...
                o5 o5Var = this.w;
                arrayList.add(new l5(layout, i1Var.getPaddingLeft() + i1Var.getLeft() + m10.getLeft() + ((r5Var.getLeft() + (o5Var.getLeft() + left)) - b4Var.getScrollX()), i1Var.getPaddingTop() + i1Var.getTop() + m10.getTop() + r5Var.getTop() + o5Var.getTop() + b4Var.getTop(), this.F.b(pagetablecell) + 10, pagetablecell));
            }
        }
    }
    ...
    public final TL_iv.pageTableCell h(int i10) {
        int i11;
        i6 i6Var = this.F;
        if (i6Var == null || i10 <= 0 || i10 - 1 >= i6Var.g.size()) {
            return null;
        }
    ...
    public final void i(boolean z10) {
        ...
        if (this.F != null) {
            ...
            linkedHashSet.clear();
            i6 i6Var = this.F;
            if (i6Var.b == 0 || (i11 = i6Var.c) == 0) {
                TL_iv.pageBlockTable pageblocktable = i6Var.a;
                ...
                while (i15 < size2) {
                    ...
                    if (a2 < i11 && a2 + i16 > i11) {
                        i16++;
                        for (int i18 = b10; i18 < b10 + o9 && i18 < i6Var.b; i18++) {
                            zArr[i18] = true;
                        }
                    }
                ...
                while (true) {
                    ...
                    if (!zArr[i19]) {
                        identityHashMap.put(i6.f(), new int[]{i19, i11, 1, 1});
                    }
                    i19++;
                }
                i6Var.j(identityHashMap, i12);
                i6Var.i();
            }
            v();
            q(0, i10);
    ...
    public final void j(boolean z10) {
        ...
        if (this.F != null) {
            ...
            if (i11 == 0 || i6Var.c == 0) {
                ...
                int max = Math.max(i6Var.c, 1);
                for (int i12 = 0; i12 < max; i12++) {
                    pagetablerow.cells.add(i6.f());
                }
                i6Var.a.rows.add(pagetablerow);
                i6Var.i();
            } else {
                int i13 = i10 < 0 ? 0 : i10;
                if (i13 <= i11) {
                ...
                IdentityHashMap identityHashMap = new IdentityHashMap();
                boolean[] zArr = new boolean[i6Var.c];
                ArrayList arrayList = i6Var.g;
                ...
                while (i14 < size) {
                    ...
                    if (b10 < i11 && b10 + o9 > i11) {
                        o9++;
                        for (int i17 = a2; i17 < a2 + i15 && i17 < i6Var.c; i17++) {
                            zArr[i17] = true;
                        }
                    }
                    identityHashMap.put(pagetablecell2, new int[]{i16, a2, o9, i15});
                }
                for (int i18 = 0; i18 < i6Var.c; i18++) {
                    if (!zArr[i18]) {
                        identityHashMap.put(i6.f(), new int[]{i11, i18, 1, 1});
                    }
                }
                i6Var.j(identityHashMap, i6Var.b + 1);
                i6Var.i();
            }
            v();
            q(i10, 0);
    ...
    public final int k(TL_iv.pageTableCell pagetablecell) {
        int indexOf;
        i6 i6Var = this.F;
        if (i6Var != null && (indexOf = i6Var.g.indexOf(pagetablecell)) >= 0) {
            return indexOf + 1;
        }
        return -1;
    }
    ...
    public final int n(int i10, int i11) {
        ...
        int top = ((i11 - b4Var.getTop()) - o5Var.getTop()) - r5Var.getTop();
        i6 i6Var = r5Var.a;
        if (i6Var == null || top < (i12 = r5Var.f[i6Var.b])) {
            return -1;
        }
        ...
        if (a10 == null || (a2 = r5Var.a.a(a10)) < 0) {
            return -1;
        }
        int i13 = a10.colspan;
        int i14 = i13 != 0 ? i13 : 1;
        int[] iArr2 = r5Var.e;
        int i15 = iArr2[a2];
        int i16 = iArr2[Math.min(i14 + a2, r5Var.a.c)];
    ...
    public final int p(int i10, int i11) {
        ...
        int scrollX = b4Var.getScrollX() + (left2 - r5Var.getLeft());
        int top = ((i11 - b4Var.getTop()) - o5Var.getTop()) - r5Var.getTop();
        if (r5Var.a == null || scrollX < (r5Var.e[0] - AndroidUtilities.dp(16.0f)) - AndroidUtilities.dp(4.0f) || scrollX >= r5Var.e[0]) {
            return -1;
        }
        if (r5Var.v()) {
            int k10 = r5Var.k();
        ...
        int[] iArr2 = r5Var.f;
        int i14 = iArr2[b10];
        int i15 = iArr2[Math.min(i13 + b10, r5Var.a.b)];
        if (top < i14 || top >= i15) {
            return -1;
        }
        return b10;
    ...
    public final void q(int i10, int i11) {
        int i12;
        i6 i6Var = this.F;
        if (i6Var == null || (i12 = i6Var.b) == 0 || i6Var.c == 0) {
            return;
        }
    ...
    public final boolean r() {
        i6 i6Var = this.F;
        if (i6Var == null || i6Var.g.isEmpty()) {
            return false;
        }
        s5 m10 = this.v.m((TL_iv.pageTableCell) this.F.g.get(0));
        if (m10 == null) {
            return false;
        }
        i1 i1Var = m10.a;
    ...
    public final boolean s(s5 s5Var, boolean z10) {
        int indexOf;
        i6 i6Var = this.F;
        if (i6Var == null || (indexOf = i6Var.g.indexOf(s5Var.b)) < 0) {
            return false;
        }
        ...
        s5 m10 = this.v.m((TL_iv.pageTableCell) this.F.g.get(i10));
        if (m10 == null) {
            return false;
        }
        i1 i1Var = m10.a;
    ...
    public final void u() {
        ...
        if (aVar != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockTable) {
                ((TL_iv.pageBlockTable) pageBlock).title = g6.f(this.r.getText());
            }
        }
    }
        ...
        while (true) {
            ...
            while (min <= min3) {
                ...
                while (min2 <= min4) {
                    ...
                    int i21 = i6Var2.f[min][min2];
                    int min5 = Math.min(i6Var2.b - 1, (i6.o(pagetablecell3) + i20) - 1);
                    int i22 = this.F.c - 1;
