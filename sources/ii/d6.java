...
public final class d6 extends FrameLayout implements org.telegram.ui.ActionBar.z5, p9 {
    ...
    public d6(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        ...
        final int i10 = 0;
        i1Var.setDelegate(new zt(this) { // from class: ii.u5
            ...
            public final void i() {
                switch (i10) {
                    case 0:
                        d6 d6Var = this.b;
                        if (!d6Var.S && d6Var.x != null) {
                            d6Var.J();
                            d6.d(d6Var.x.b, d6Var.f.getText());
                            a6 a6Var = d6Var.y;
                            if (a6Var != null) {
                                w3.O1(((e3) a6Var).a);
                                break;
        ...
        i1Var.setOnFocusChangeListener(new v5(this, i10));
        ...
        final int i11 = 1;
        i1Var2.setDelegate(new zt(this) { // from class: ii.u5
            public final /* synthetic */ d6 b;
    ...
    public static void a(d6 d6Var, boolean z10) {
        a6 a6Var;
        d6Var.f.setHint(d6Var.getHint());
        if (z10 || (a6Var = d6Var.y) == null) {
            return;
        }
        ((e3) a6Var).a.h3.g(d6Var, null);
    }
    ...
    public static c6 r(a aVar, String str) {
        ...
        if (lowerCase.length() == 3 && lowerCase.charAt(0) == '/' && lowerCase.charAt(1) == 'h' && (charAt = lowerCase.charAt(2)) >= '1' && charAt <= '6') {
            return new c6(v(charAt - '0'), aVar.c, aVar.d);
        }
    ...
    public static c6 s(a aVar, String str) {
        ...
        if (str.charAt(0) == '#' && (z10 || z11)) {
            ...
            return new c6(v(i11), aVar.c, aVar.d);
        }
        if (!z10) {
            return null;
        }
    ...
    public final void D(o0 o0Var) {
        ...
        for (String str : list) {
            ...
            if (r10 != null) {
                ((e3) this.y).d(this.x, r10.a, r10.b, r10.c, r10.d, r10.e);
                return;
            }
        }
    }
    ...
    public final void E(Editable editable) {
        a aVar = this.x;
        if (aVar != null && w3.C3(aVar.b) && com.google.android.gms.internal.vision.e2.u(editable)) {
            i1 i1Var = this.f;
            ...
            for (org.telegram.ui.Components.x5 x5Var : (org.telegram.ui.Components.x5[]) editable.getSpans(0, editable.length(), org.telegram.ui.Components.x5.class)) {
                x5Var.replaceFontMetrics(fontMetricsInt);
                x5Var.setSize(max);
            }
        }
    }
    ...
    public final void F() {
        a6 a6Var;
        a aVar = this.x;
        if (aVar == null || aVar.c <= 0 || (a6Var = this.y) == null) {
            return;
        }
        int b10 = ((e3) a6Var).b(aVar);
        int a2 = ((e3) this.y).a(this.x);
        a aVar2 = this.x;
        if (aVar2.n) {
    ...
    public final void I(TL_iv.PageBlock pageBlock, boolean z10) {
        ...
        if (linearLayout3 == null) {
            ...
            this.s.setBackground(i6.Y(i6.v0(i6.i6, e6Var), AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f)));
            ...
            this.s.setOnClickListener(new t5(this, 1));
            this.s.setOnLongClickListener(new w5());
        }
        String str = ((TL_iv.pageBlockPreformatted) pageBlock).language;
        int l1 = i6.l1(TextUtils.isEmpty(str) ? 0.5f : 0.75f, i6.v0(i6.G6, e6Var));
    ...
    public final void c(a aVar) {
        ...
        if (aVar.d == 0) {
            ...
            if (a6Var != null) {
                ...
                ArrayList arrayList = ((e3) a6Var).a.l3;
                int indexOf = arrayList.indexOf(aVar);
                if (indexOf < 0 || (i10 = aVar.c) <= 0 || aVar.d <= 0) {
                    b10 = org.telegram.messenger.y0.b(10.0f, (int) Math.ceil(paint.measureText(a4.a.o(aVar.d, ".", new StringBuilder()))), AndroidUtilities.dp(28.0f));
                } else {
                    int i13 = indexOf;
                    while (i13 > 0) {
                    ...
                    b10 = org.telegram.messenger.y0.b(10.0f, (int) Math.ceil(f7), AndroidUtilities.dp(28.0f));
                }
            } else {
                int dp = AndroidUtilities.dp(28.0f);
                TextPaint paint3 = oVar.getPaint();
                b10 = org.telegram.messenger.y0.b(10.0f, (int) Math.ceil(paint3.measureText(aVar.d + ".")), dp);
            }
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (aVar == null || !(aVar.b instanceof TL_iv.pageBlockPreformatted)) {
            ...
            paint.setColor(i6.v0(i6.xk, e6Var));
            int c10 = o8.c(this.x);
            int d = o8.d(this.x);
            int width2 = getWidth();
            if (c10 > 0 || d > 0) {
        ...
        if (this.T) {
            ...
            if (width4 < f10 && height2 < f11) {
                ...
                paint.setColor(i6.l1(0.05f, i6.v0(i6.G6, e6Var)));
        ...
        a6 a6Var = this.y;
        q9 textSelectionHelper = a6Var != null ? ((e3) a6Var).a.getTextSelectionHelper() : null;
        ...
        if (o()) {
            ...
            this.L.a(canvas2, this.M, org.telegram.messenger.y0.B(16.0f, getWidth(), dp8), org.telegram.messenger.y0.B(8.0f, getHeight(), dp8), v02, pageblockblockquote.collapsed, l());
        }
    }
    ...
    public final void e() {
        ...
        if (drawable != null) {
            drawable.setColorFilter(new PorterDuffColorFilter(i6.v0(i6.Oh, e6Var), PorterDuff.Mode.SRC_IN));
        }
        sl0 sl0Var = this.J;
        if (sl0Var != null) {
            o8.a(sl0Var, e6Var);
    ...
    */
    public final void g(a aVar, a6 a6Var, boolean z10) {
        float f7;
        float f10;
        a aVar2;
        int c10;
            ...
            if (pageBlock2 instanceof TL_iv.pageBlockBlockquote) {
                ...
                if (!(pageBlock2 instanceof TL_iv.pageBlockPullquote)) {
                    ...
                    if (aVar3 != null && aVar3.c > 0) {
                        ...
                        a6 a6Var2 = this.y;
                        int b10 = a6Var2 != null ? ((e3) a6Var2).b(this.x) : AndroidUtilities.dp(8.0f);
                        int dp2 = AndroidUtilities.dp(16.0f);
                        a6 a6Var3 = this.y;
                        setPadding(dp, b10, dp2, a6Var3 != null ? ((e3) a6Var3).a(this.x) : AndroidUtilities.dp(11.0f));
                    }
                    if (z12) {
                    ...
                    if (!String.valueOf(i1Var.getText()).equals(z(aVar.b))) {
                        ...
                        if (w3.C3(aVar.b)) {
                            ...
                            f6.o(spannableString, 0, spannableString.length(), 1, false, null);
                            f6.o(spannableString, 0, spannableString.length(), 2, false, null);
                            A = spannableString;
                        }
                        i1Var.setTextSilently(Emoji.replaceEmoji((CharSequence) A, i1Var.getPaint().getFontMetricsInt(), false, w3.C3(aVar.b) ? 0.85f : 1.0f));
                        E(i1Var.getText());
                    ...
                    if (p5) {
                        ...
                        if (!String.valueOf(i1Var2.getText()).equals(f6.l(k(pageBlock3)))) {
                            i1Var2.setTextSilently(Emoji.replaceEmoji(f6.r(k(pageBlock3), null, true), i1Var2.getPaint().getFontMetricsInt(), false));
    ...
    public final int h(int i10, int i11) {
        ...
        if (l()) {
            ...
            if (i1Var.getVisibility() == 0 && (layout = i1Var.getLayout()) != null && layout.getLineCount() > 0) {
                ...
                float B = org.telegram.messenger.y0.B(16.0f, i10, dp);
                this.L.getClass();
                float D = B - org.telegram.messenger.y0.D(3.333f, 2, AndroidUtilities.dp(23.66f) + r6.c);
                this.L.getClass();
                int i12 = i11 - dp;
