...
public final /* synthetic */ class z4 implements Runnable {
    ...
    public /* synthetic */ z4(b5 b5Var, int i10) {
        this.a = i10;
        this.b = b5Var;
    }
    ...
    public final void run() {
        ...
        switch (this.a) {
            case 0:
                b5 b5Var = this.b;
                String str = b5Var.b;
                TLRPC.Document document = b5Var.r;
                String str2 = null;
                        ...
                        if (bitmap != null) {
                            try {
                                ...
                                if (scaleAndSaveImage != null) {
                                    ...
                                    document.flags |= 1;
                                    File pathToAttach = FileLoader.getInstance(b5Var.a).getPathToAttach(scaleAndSaveImage, true);
                                ...
                                b5Var.F = str2;
                                AndroidUtilities.runOnUIThread(new z4(b5Var, 2));
                                return;
                            }
                        } else if (bitmap != null) {
                            break;
            ...
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new gg.x1(18, b5Var2, str4));
                return;
            default:
                b5 b5Var3 = this.b;
                if (b5Var3.w || b5Var3.x) {
                    return;
                }
                b5Var3.a(b5Var3.b);
                return;
