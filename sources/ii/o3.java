...
public final class o3 {
    ...
    public final TL_iv.RichMessage a() {
        ...
        int i12 = this.d;
        TL_iv.PageBlock L1 = x3.L1(x3Var, aVar, this.c, i10 == i11 ? i12 : -1);
        TL_iv.PageBlock L12 = i10 == i11 ? null : x3.L1(x3Var, aVar2, 0, i12);
        if (L1 != null) {
            aVar.b = L1;
        }
        if (L12 != null) {
        ...
        try {
            ArrayList<TL_iv.PageBlock> Y2 = x3Var.Y2(i10, i11 + 1, 0, false);
            ArrayList<TLRPC.Photo> A2 = x3Var.A2(i10, i11);
            ArrayList<TLRPC.Document> z22 = x3Var.z2(i10, i11);
            aVar.b = pageBlock;
            aVar2.b = pageBlock2;
