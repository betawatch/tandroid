...
public final class u4 extends a0 implements org.telegram.ui.ActionBar.z5, p9, m0 {
    ...
    public u4(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.L = new HashMap();
        this.T = -1;
        this.U = new org.telegram.ui.Components.e6(this, 0L, 320L, qr.h);
        this.j0 = new Path();
        this.n = e6Var;
    ...
    public final ImageView h() {
        ...
        if (!this.H || Build.VERSION.SDK_INT < 31) {
            ...
            int i11 = j6.d6;
            imageView.setBackground(new c2(j6.Z(j6.v0(i11, e6Var), j6.v(j6.v0(i11, e6Var), j6.v0(j6.i6, e6Var)), 20, 20)));
        } else {
    ...
    public final void j(Canvas canvas) {
        ...
        int paddingTop = u4Var.getPaddingTop();
        int paddingLeft = u4Var.getPaddingLeft();
        int i11 = 0;
        int max = Math.max(0, (u4Var.getWidth() - paddingLeft) - u4Var.getPaddingRight());
        canvas2.save();
        ...
        if ((aVar == null ? 0 : aVar.k.size()) > 0) {
            Path path = u4Var.j0;
            path.rewind();
            path.addRoundRect(0.0f, paddingTop, max, u4Var.P + paddingTop, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), Path.Direction.CW);
            canvas2.clipPath(path);
        } else {
            canvas2.clipRect(0, paddingTop, max, u4Var.P + paddingTop);
        }
        boolean l4 = u4Var.l();
        int i12 = 1;
        ...
        Paint paint = u4Var.r;
        if (z10 && (((i10 = u4Var.W) == 0 && u4Var.a0 < 0.0f) || (i10 == arrayList.size() - 1 && u4Var.a0 > 0.0f))) {
            canvas2.drawRect(0.0f, paddingTop, max, u4Var.P + paddingTop, paint);
        }
        int size = arrayList.size();
        ArrayList arrayList2 = u4Var.G;
        if (size == 1 && arrayList2.size() == 1) {
            RectF rectF = (RectF) arrayList2.get(0);
            if (rectF.left > 0.5f || rectF.right < max - 0.5f) {
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(0.0f, paddingTop, max, paddingTop + u4Var.P);
                x4 x4Var = (x4) arrayList.get(0);
                ImageReceiver imageReceiver = x4Var.b;
                if (x4Var.b()) {
                    imageReceiver.setImageCoords(rectF2);
                    imageReceiver.setAlpha(x4Var.a.getCurrentAlpha());
        ...
        while (i13 < arrayList.size() && i13 < arrayList2.size()) {
            x4 x4Var2 = (x4) arrayList.get(i13);
            ...
            if (z10) {
                ...
                int i17 = i13 == 0 ? dp : 0;
                x4Var2.a.setRoundRadius(i14, i15, i16, i17);
                x4Var2.b.setRoundRadius(i14, i15, i16, i17);
            } else {
                x4Var2.a.setRoundRadius(i11, i11, i11, i11);
                x4Var2.b.setRoundRadius(i11, i11, i11, i11);
            }
            boolean c10 = x4Var2.c();
            ImageReceiver imageReceiver2 = x4Var2.a;
            if (!c10) {
            ...
            RadialProgress2 radialProgress2 = x4Var2.d;
            u uVar = x4Var2.e;
            if (uVar != null && uVar.a()) {
                ...
                radialProgress2.o(x4Var2.e.f, true);
            ...
            if (uVar2 != null && uVar2.n && x4Var2.c()) {
                ...
                if (spoilerEffect != null) {
                    ...
                    spoilerEffect.c(canvas2, u4Var, Math.round(rectF3.width()), Math.round(rectF3.height()), imageReceiver2.getCurrentAlpha(), false);
                }
                canvas.restore();
            }
            i13++;
    ...
    public final void n() {
        ...
        while (true) {
            ...
            x4 x4Var = new x4(this, this.n);
            if (this.O) {
                x4Var.a.onAttachedToWindow();
                x4Var.b.onAttachedToWindow();
                x4Var.a();
            }
            arrayList.add(x4Var);
        }
        while (arrayList.size() > m10.size()) {
            x4 x4Var2 = (x4) hg.k0.v(1, arrayList);
            x4Var2.a.onDetachedFromWindow();
            x4Var2.b.onDetachedFromWindow();
            x4Var2.c = null;
        }
        for (int i10 = 0; i10 < m10.size(); i10++) {
            x4 x4Var3 = (x4) arrayList.get(i10);
            x4Var3.e = (u) m10.get(i10);
            x4Var3.a();
        }
        while (true) {
            arrayList2 = this.E;
        ...
        while (arrayList2.size() > m10.size()) {
            ImageView imageView = (ImageView) hg.k0.v(1, arrayList2);
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            x4 x4Var = (x4) arrayList.get(i10);
            x4Var.a.onDetachedFromWindow();
            x4Var.b.onDetachedFromWindow();
            x4Var.c = null;
            i10++;
        }
        vh.g gVar = this.M;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (arrayList.size() >= 2 && f12 > 0.001f) {
            ...
            int dp2 = AndroidUtilities.dp(4.0f) + wh.c(6.0f, size - 1, AndroidUtilities.dp(7.0f) * size);
        ...
        if (size3 == 0) {
            ...
            if (size3 != 1) {
                ...
                for (int i22 = 0; i22 < size3; i22++) {
                    x4 x4Var = (x4) arrayList3.get(i22);
                    int i23 = x4Var.e == null ? 0 : x4Var.d() ? x4Var.e.k : x4Var.e.j;
                    if (x4Var.e == null) {
                        i18 = 0;
                    } else {
                        boolean d10 = x4Var.d();
                ...
                for (int i45 = 0; i45 < size3; i45++) {
                    x4 x4Var2 = (x4) arrayList3.get(i45);
                    int i46 = x4Var2.e == null ? 0 : x4Var2.d() ? x4Var2.e.k : x4Var2.e.j;
                    if (x4Var2.e == null) {
                        i14 = 0;
                    } else {
                        boolean d11 = x4Var2.d();
                        u uVar2 = x4Var2.e;
            ...
            x4 x4Var3 = (x4) arrayList3.get(0);
            int i48 = x4Var3.e == null ? 0 : x4Var3.d() ? x4Var3.e.k : x4Var3.e.j;
            if (x4Var3.e == null) {
                i19 = 0;
            } else {
                boolean d12 = x4Var3.d();
                u uVar3 = x4Var3.e;
