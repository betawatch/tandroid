...
public abstract class c5 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i13 < size) {
            ...
            ti0 ti0Var = (spanned == null || span != null) ? 0 : (ti0) a(spanned, i14, i15, ti0.class);
            if (span == null && ti0Var == 0) {
                ...
                CodeHighlighting.Span span2 = span != null ? span : ti0Var;
                while (true) {
                    if (i13 >= size) {
                        i10 = length;
                        break;
                    ...
                    if ((span != null ? a(spanned, i16, length, CodeHighlighting.Span.class) : a(spanned, i16, length, ti0.class)) != span2) {
                        break;
                    }
                    i15 = length;
                    i13 = i17;
                ...
                if (span != null) {
                    ...
                    pageblockpreformatted.text = f6.f(subSequence2);
                    String str = span.lng;
                    if (str == null) {
                        str = "";
                    }
                    ...
                    pageblockblockquote.collapsed = ti0Var != 0 && ti0Var.e;
        ...
        while (it.hasNext()) {
            ...
            if (pageBlock != null) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                    SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(f6.r(pageBlock.text, pageBlock, true));
                    ...
                    if (z10 || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                        spannableStringBuilder = h(f6.r(pageBlock.text, pageBlock, true), z10 ? ((TL_iv.pageBlockBlockquote) pageBlock).caption : ((TL_iv.pageBlockPullquote) pageBlock).caption);
                        ...
                        if (arrayList4 != null && !arrayList4.isEmpty()) {
                            ...
                            while (i10 < size) {
                                ...
                                SpannableStringBuilder r11 = pageListItem2 instanceof TL_iv.TL_pageListItemText ? f6.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true) : pageListItem2 instanceof TL_iv.TL_pageListItemBlocks ? c(((TL_iv.TL_pageListItemBlocks) pageListItem2).blocks) : null;
                                if (r11 != null) {
                        ...
                        if (arrayList6 != null && !arrayList6.isEmpty()) {
                            ...
                            while (i10 < size2) {
                                ...
                                if (r12 != null) {
                                    SpannableStringBuilder spannableStringBuilder4 = new SpannableStringBuilder(p6.t(!TextUtils.isEmpty(pageListOrderedItem2.num) ? pageListOrderedItem2.num : String.valueOf(i11), ".  "));
                        ...
                        SpannableStringBuilder r13 = f6.r(pageblocktable.title, null, true);
                            ...
                            while (i12 < size3) {
                                ...
                                if (arrayList10 != null && !arrayList10.isEmpty()) {
                                    ...
                                    for (int i13 = 0; i13 < pagetablerow2.cells.size(); i13++) {
                                        ...
                                        spannableStringBuilder5.append((CharSequence) f6.r(pagetablerow2.cells.get(i13).text, null, true));
                                    }
                        ...
                        ?? l4 = l(1, f6.r(pageBlock.text, pageBlock, true));
                        if (!TextUtils.isEmpty(l4)) {
                            spannableStringBuilder = l4;
                        }
                    } else if (pageBlock instanceof TL_iv.pageBlockAuthorDate) {
                        spannableStringBuilder = f6.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                        ...
                        spannableStringBuilder = f6.r(pageBlock.text, pageBlock, true);
                    } else if (pageBlock.caption != null) {
                        SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder();
                        SpannableStringBuilder r14 = f6.r(pageBlock.caption.text, null, true);
                        if (!TextUtils.isEmpty(r14)) {
                            spannableStringBuilder6.append((CharSequence) r14);
                        }
                        SpannableStringBuilder r15 = f6.r(pageBlock.caption.credit, null, true);
                            ...
                            if (arrayList2.size() + (z10 ? 1 : 0) <= 1 && (!z10 || (richText = ((TL_iv.pageBlockBlockquote) pageBlock).caption) == null || (richText instanceof TL_iv.textEmpty) || f6.l(richText).isEmpty())) {
                                if (hashMap != null && !arrayList2.isEmpty()) {
                                    ...
                                    while (i11 < size2) {
                                        ...
                                        if (richText2 != null && !(richText2 instanceof TL_iv.textEmpty) && !f6.l(richText2).isEmpty()) {
                                            break;
                                        }
                                    }
                                }
    ...
    public static SpannableStringBuilder h(SpannableStringBuilder spannableStringBuilder, TL_iv.RichText richText) {
        ...
        SpannableStringBuilder r10 = f6.r(richText, null, true);
        if (!TextUtils.isEmpty(r10)) {
        ...
        ti0.b(spannableStringBuilder2, 0, spannableStringBuilder2.length(), false);
    ...
    public static SpannableStringBuilder i(a aVar, boolean z10) {
        ...
        if (z10) {
            TL_iv.PageBlock pageBlock = aVar.b;
            r10 = f6.r(pageBlock != null ? pageBlock.text : null, pageBlock, false);
        } else {
            TL_iv.PageBlock pageBlock2 = aVar.b;
            r10 = f6.r(pageBlock2 != null ? pageBlock2.text : null, pageBlock2, true);
        }
        ...
        while (list != null && i10 < list.size()) {
            ...
            if (aVar.k.isEmpty()) {
                ...
                if ((pageBlock instanceof TL_iv.pageBlockBlockquote) || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(z10 ? f6.r(pageBlock.text, pageBlock, false) : f6.r(pageBlock.text, pageBlock, true));
                    TL_iv.PageBlock pageBlock2 = aVar.b;
                    boolean z11 = (pageBlock2 instanceof TL_iv.pageBlockBlockquote) && ((TL_iv.pageBlockBlockquote) pageBlock2).collapsed;
                    if (spannableStringBuilder.length() > 0) {
                        ti0.b(spannableStringBuilder, 0, spannableStringBuilder.length(), z11);
                    }
                    arrayList.add(spannableStringBuilder);
                } else {
    ...
    public static SpannableStringBuilder k(ArrayList arrayList) {
        ...
        f6.o(spannableStringBuilder, 0, length, 65536, false, null);
        f6.o(spannableStringBuilder, 0, length, 16384, false, null);
        f6.o(spannableStringBuilder, 0, length, 32768, false, null);
        for (t tVar : (t[]) spannableStringBuilder.getSpans(0, length, t.class)) {
    ...
    public static CharSequence l(int i10, SpannableStringBuilder spannableStringBuilder) {
        ...
        p01 p01Var = new p01();
        p01Var.a = i10;
        spannableStringBuilder2.setSpan(new q01(p01Var, 0), 0, spannableStringBuilder2.length(), 33);
        return spannableStringBuilder2;
    }
}
