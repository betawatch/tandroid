...
public final class j2 {
    ...
    public static void b(TL_iv.PageBlock pageBlock, int i10, j2 j2Var) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
            a(((TL_iv.pageBlockBlockquote) pageBlock).caption, i10, j2Var);
            return;
        }
        if (pageBlock instanceof TL_iv.pageBlockPullquote) {
            a(((TL_iv.pageBlockPullquote) pageBlock).caption, i10, j2Var);
            return;
        }
        int i12 = 0;
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            ...
            j2Var.b = pageblockblockquoteblocks.blocks.size() + j2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockDetails) {
            ...
            j2Var.b = pageblockdetails.blocks.size() + j2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            j2Var.b = pageblockorderedlist.items.size() + j2Var.b;
            for (int i16 = 0; i16 < pageblockorderedlist.items.size(); i16++) {
                ...
                if (pageListOrderedItem instanceof TL_iv.TL_pageListOrderedItemText) {
                    a(((TL_iv.TL_pageListOrderedItemText) pageListOrderedItem).text, i17, j2Var);
                    ...
                    for (int i18 = 0; i18 < arrayList2.size(); i18++) {
                        b(arrayList2.get(i18), i17, j2Var);
                    }
                }
            }
            return;
        ...
        if (pageBlock instanceof TL_iv.pageBlockTable) {
            ...
            if (arrayList3 != null) {
                j2Var.b = arrayList3.size() + j2Var.b;
        ...
        if (pageBlock instanceof TL_iv.pageBlockButtonRow) {
            ...
            if (arrayList4 != null) {
                ...
                while (i12 < size) {
                    ...
                    if (pageButton2 != null) {
                        a(pageButton2.text, i10 + 1, j2Var);
                    }
                }
                return;
            }
        ...
        if (pageBlock instanceof TL_iv.pageBlockCollage) {
            ...
            if (pageCaption != null) {
                a(pageCaption.text, i10, j2Var);
                a(pageCaption.credit, i10, j2Var);
            }
            ArrayList<TL_iv.PageBlock> arrayList5 = ((TL_iv.pageBlockCollage) pageBlock).items;
            while (i12 < arrayList5.size()) {
                b(arrayList5.get(i12), i10 + 1, j2Var);
                i12++;
            }
            return;
        }
        ...
        a(pageCaption3.text, i10, j2Var);
        a(pageCaption3.credit, i10, j2Var);
    }
