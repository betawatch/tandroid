...
public final class h0 extends a0 implements org.telegram.ui.ActionBar.z5 {
    ...
    public h0(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        final int i11 = 0;
        z1Var.setOnClickListener(new View.OnClickListener(this) { // from class: ii.d0
        ...
        final int i12 = 1;
        textView.setOnClickListener(new View.OnClickListener(this) { // from class: ii.d0
            public final /* synthetic */ h0 b;
    ...
    */
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (size2 > 0) {
            ...
            if (size3 != 0) {
                ...
                for (int i17 = 0; i17 < size3; i17++) {
                    e0 e0Var = (e0) arrayList.get(i17);
                    e0Var.getClass();
                    int max3 = Math.max(AndroidUtilities.dp(34.0f), e0Var.a.getPreferredWidth());
                    iArr[i17] = max3;
                    i16 += max3;
                }
                if (i16 <= max2) {
                    ...
                    for (int i27 = 0; i27 < size3; i27++) {
                        int i28 = iArr[i27];
                        e0 e0Var2 = (e0) arrayList.get(i27);
                        e0Var2.getClass();
                        i26 += i28 - Math.max(AndroidUtilities.dp(34.0f), e0Var2.a.getMinWidth());
                    }
                    if (i26 <= 0) {
                        for (int i29 = 0; i29 < size3; i29++) {
                            e0 e0Var3 = (e0) arrayList.get(i29);
                            e0Var3.getClass();
                            iArr[i29] = Math.max(AndroidUtilities.dp(34.0f), e0Var3.a.getMinWidth());
                        }
                    } else {
                        ...
                        while (i30 < size3) {
                            int i32 = iArr[i30];
                            e0 e0Var4 = (e0) arrayList.get(i30);
                            e0Var4.getClass();
                            int max4 = i32 - Math.max(AndroidUtilities.dp(34.0f), e0Var4.a.getMinWidth());
                            if (i30 == i15) {
                                i13 = min - i31;
                                i12 = min;
                            } else {
                ...
                for (int i33 = 0; i33 < size3; i33++) {
                    e0 e0Var5 = (e0) arrayList.get(i33);
                    int i34 = iArr[i33];
                    RichMessageLayout.RichButton richButton = e0Var5.a;
        ...
        if (size2 > 0) {
            dp = ((e0) arrayList.get(0)).a.getHeight();
