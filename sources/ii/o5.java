...
public final class o5 extends a0 implements org.telegram.ui.ActionBar.a6, p9 {
    public c3 E;
    public h6 F;
    public boolean G;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (aVar != null && (i14 = aVar.l) > 0) {
            i18 = AndroidUtilities.dp(hg.k0.g(i14, 1, 16, 10));
        }
        int i19 = i15 - i16;
        int i20 = measuredHeight + i18;
        i1Var.layout(AndroidUtilities.dp(16.0f) + i17, i18, hg.k0.f(16.0f, i19, AndroidUtilities.dp(16.0f) + i17), i20);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        a aVar = this.a;
        int dp = (aVar != null && (i12 = aVar.l) > 0) ? AndroidUtilities.dp(hg.k0.g(i12, 1, 16, 10)) : 0;
        a aVar2 = this.a;
        if (aVar2 != null && (i13 = aVar2.m) > 0) {
            i14 = AndroidUtilities.dp(hg.k0.g(i13, 1, 16, 10));
        }
