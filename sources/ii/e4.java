...
public abstract class e4 {
    ...
    */
    public static void A(ArrayList arrayList, ArrayList arrayList2, Map map) {
        ...
        while (i12 < size) {
            ...
            i12++;
            d4 d4Var2 = (d4) obj;
            boolean z10 = d4Var2.b;
            ArrayList arrayList3 = d4Var2.e;
            if (!z10) {
                str = d4Var2.a;
                str.getClass();
                switch (str) {
                    ...
                    default:
                        ...
                        switch (c10) {
                            case 0:
                                b(arrayList2, new TL_iv.pageBlockParagraph(), d4Var2);
                                break;
                            case 1:
                                ...
                                while (i13 < size2) {
                                    ...
                                    d4 d4Var3 = (d4) obj2;
                                    if (!d4Var3.b) {
                                        if ("figcaption".equals(d4Var3.a)) {
                                            charSequence = w(d4Var3);
                                        } else if (aVar == null) {
                                            aVar = m(d4Var3);
                                        }
                                    }
                                ...
                                break;
                            case 2:
                                b(arrayList2, new TL_iv.pageBlockFooter(), d4Var2);
                                break;
                            case 3:
                                b(arrayList2, new TL_iv.pageBlockParagraph(), d4Var2);
                                break;
                            case 4:
                                b(arrayList2, new TL_iv.pageBlockHeading1(), d4Var2);
                                break;
                            case 5:
                                b(arrayList2, new TL_iv.pageBlockHeading2(), d4Var2);
                                break;
                            case 6:
                                b(arrayList2, new TL_iv.pageBlockHeading3(), d4Var2);
                                break;
                            case 7:
                                b(arrayList2, new TL_iv.pageBlockHeading4(), d4Var2);
                                break;
                            case '\b':
                                b(arrayList2, new TL_iv.pageBlockHeading5(), d4Var2);
                                break;
                            case '\t':
                                b(arrayList2, new TL_iv.pageBlockHeading6(), d4Var2);
                                break;
                            case '\n':
                            ...
                            case 11:
                            case 15:
                                D(d4Var2, arrayList2, 0, "ol".equals(str));
                                break;
                            case '\f':
                            case '\r':
                            case 14:
                            ...
                            case 16:
                                ...
                                if (lowerCase.contains("button-row")) {
                                    ...
                                    String a10 = d4Var2.a("data-align");
                                    ...
                                    while (i14 < size3) {
                                        ...
                                        } else if (!d4Var4.b && "button".equals(d4Var4.a) && (v = v(d4Var4)) != null) {
                                            SpannableStringBuilder spannableStringBuilder3 = new SpannableStringBuilder();
                                            e(spannableStringBuilder3, d4Var4, 0, null, 0L);
                                    ...
                                    a(B(d4Var2, false), arrayList2);
                                } else if (lowerCase.contains("slideshow")) {
                                    a(B(d4Var2, true), arrayList2);
                                } else {
                                    b(arrayList2, new TL_iv.pageBlockParagraph(), d4Var2);
                                }
                                break;
                            case 17:
                                a(m(d4Var2), arrayList2);
                                break;
                            case 18:
                                ...
                                b(arrayList2, pageblockpreformatted, d4Var2);
                                break;
                            case 19:
                                a(m(d4Var2), arrayList2);
                                break;
                            case 20:
                                ...
                                pageblocktable.bordered = d4Var2.b("border");
                                String a11 = d4Var2.a("class");
                            ...
                            case 24:
                                ...
                                if (a12 == null || !a12.toLowerCase().contains("pull")) {
                                    ...
                                    while (i16 < size4) {
                                        ...
                                        i16++;
                                        d4 d4Var6 = (d4) obj4;
                                        if (!d4Var6.b && (str3 = d4Var6.a) != null) {
                                            if (!"cite".equals(str3)) {
                                                String str4 = d4Var6.a;
                                                str4.getClass();
                                    ...
                                    if (z11) {
                                        ...
                                        while (i17 < size6) {
                                            ...
                                            i17++;
                                            d4 d4Var7 = (d4) obj5;
                                            if (d4Var7.b || !"cite".equals(d4Var7.a)) {
                                                arrayList5.add(d4Var7);
                                            }
                                        }
                                    ...
                                    while (true) {
                                        if (i18 < size7) {
                                            ...
                                            i18++;
                                            d4Var = (d4) obj6;
                                            if (d4Var.b || !"cite".equals(d4Var.a)) {
                                            }
                                        } else {
                                            d4Var = null;
                                        }
                            ...
                            case 25:
                                ...
                                pageblockdetails.open = d4Var2.b("open");
                                ...
                                while (i19 < size8) {
                                    ...
                                    i19++;
                                    d4 d4Var8 = (d4) obj7;
                                    if (d4Var8.b || !"summary".equals(d4Var8.a)) {
                                        arrayList6.add(d4Var8);
                                    } else {
                ...
                spannableStringBuilder.append((CharSequence) q(d4Var2.c));
            }
        }
        t(arrayList2, spannableStringBuilder);
    }
    ...
    public static a B(d4 d4Var, boolean z10) {
        ...
        while (i10 < size) {
            ...
            d4 d4Var2 = (d4) obj;
            if (!d4Var2.b) {
                if ("figcaption".equals(d4Var2.a)) {
                    charSequence = w(d4Var2);
                } else {
                    boolean equals = MediaStreamTrack.VIDEO_TRACK_KIND.equals(d4Var2.a);
                    if (equals || "img".equals(d4Var2.a)) {
    ...
    public static void D(d4 d4Var, ArrayList arrayList, int i10, boolean z10) {
        String a2;
        ArrayList arrayList2;
        int i11;
        int i12 = i10 + 1;
        ArrayList arrayList3 = d4Var.e;
        ...
        while (i14 < size) {
            ...
            i14++;
            d4 d4Var2 = (d4) obj;
            if (!d4Var2.b && "li".equals(d4Var2.a)) {
                ...
                while (i15 < size2) {
                    int i16 = i15 + 1;
                    d4 d4Var3 = (d4) arrayList5.get(i15);
                    if (!d4Var3.b && ("ul".equals(d4Var3.a) || "ol".equals(d4Var3.a))) {
                        arrayList4.add(d4Var3);
                    } else if (d4Var3.b) {
                        spannableStringBuilder.append((CharSequence) q(d4Var3.c));
                    } else {
                        arrayList2 = arrayList5;
                        i11 = size2;
                        h(spannableStringBuilder, d4Var3, 0, null, 0L);
                ...
                while (i17 < size3) {
                    ...
                    i17++;
                    d4 d4Var4 = (d4) obj2;
                    D(d4Var4, arrayList, i12, "ol".equals(d4Var4.a));
                }
                i13++;
            }
        }
    ...
    public static void e(SpannableStringBuilder spannableStringBuilder, d4 d4Var, int i10, String str, long j3) {
        SpannableStringBuilder spannableStringBuilder2;
        int i11;
        String str2;
        long j10;
        ...
        while (i12 < size) {
            ...
            if (d4Var2.b) {
                ...
                str2 = str;
                j10 = j3;
                j(spannableStringBuilder2, q(d4Var2.c), i11, str2, j10);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                i11 = i10;
                str2 = str;
                j10 = j3;
                h(spannableStringBuilder2, d4Var2, i11, str2, j10);
            }
            spannableStringBuilder = spannableStringBuilder2;
            i10 = i11;
            str = str2;
    ...
    public static void f(SpannableStringBuilder spannableStringBuilder, d4 d4Var) {
        ...
        while (i10 < size) {
            ...
            if (d4Var2.b) {
                spannableStringBuilder2 = spannableStringBuilder;
                j(spannableStringBuilder2, q(d4Var2.c), 0, null, 0L);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                if (!"cite".equals(d4Var2.a)) {
                    h(spannableStringBuilder2, d4Var2, 0, null, 0L);
                }
            }
            spannableStringBuilder = spannableStringBuilder2;
    ...
    */
    public static void g(StringBuilder sb2, CharSequence charSequence) {
        ...
        int i22 = 0;
        while (i22 < length) {
            l4[] l4VarArr = (l4[]) spanned.getSpans(i22, Math.min(length, i22 + 1), l4.class);
            ...
            while (true) {
                ...
                l4Var = l4VarArr[i23];
                int spanStart = spanned.getSpanStart(l4Var);
                i10 = spanned.getSpanEnd(l4Var);
            ...
            if (l4Var != null) {
                ...
                if (textbutton != null && l4.c(textbutton.type)) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static void h(SpannableStringBuilder spannableStringBuilder, d4 d4Var, int i10, String str, long j3) {
        int i11;
        String str2;
        int i12;
        long j10;
        TL_keyboard.InlineButtonType v;
        if ("button".equals(d4Var.a) && (v = v(d4Var)) != null) {
        ...
        switch (str3) {
            ...
            case "mark":
                ...
                break;
            case "animated-emoji":
                String a10 = d4Var.a("data-document-id");
                if (a10 != null) {
                    try {
    ...
    */
        ...
        switch (str) {
            ...
            case "location":
                ...
                if (a11 != null) {
                    ...
                    tL_geoPoint._long = d;
                    tL_geoPoint.access_hash = E(d4Var.a("access"));
                    pageblockmap.geo = tL_geoPoint;
                    pageblockmap.zoom = C(15, d4Var.a("zoom"));
                    pageblockmap.w = C(600, d4Var.a("w"));
                    pageblockmap.h = C(400, d4Var.a("h"));
                    J(pageblockmap);
    ...
    public static a n(d4 d4Var, boolean z10) {
        long E = E(d4Var.a("src"));
        if (E <= 0) {
            return null;
        }
        TL_iv.PageBlock y3 = y(E, z10, d4Var.b("data-spoiler"));
        J(y3);
        return new a(y3, 0, 0);
    }
    ...
    public static void p(d4 d4Var, TL_iv.pageBlockTable pageblocktable) {
        String lowerCase;
        int indexOf;
        ArrayList arrayList = d4Var.e;
        int size = arrayList.size();
                ...
                switch (str) {
                    case "tr":
                        ...
                        while (i12 < size2) {
                            ...
                            d4 d4Var3 = (d4) obj2;
                            if (!d4Var3.b) {
                                if ("td".equals(d4Var3.a) || "th".equals(d4Var3.a)) {
    ...
    public static TL_keyboard.RichButtonStyle u(d4 d4Var) {
        TL_keyboard.RichButtonStyle richButtonStyle = new TL_keyboard.RichButtonStyle();
        String a2 = d4Var.a("data-style");
    ...
    public static TL_keyboard.InlineButtonType v(d4 d4Var) {
        String a2 = d4Var.a("data-type");
        if ("url".equals(a2)) {
            String a10 = d4Var.a("data-url");
        ...
        if ("copy".equals(a2)) {
            String a11 = d4Var.a("data-copy-text");
    ...
    public static CharSequence w(d4 d4Var) {
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        e(spannableStringBuilder, d4Var, 0, null, 0L);
                                    ...
                                    while (i14 < trim.length()) {
                                        ...
                                        if (i14 < trim.length()) {
                                            ...
                                            if (!lowerCase2.isEmpty()) {
                                                if (d4Var2.d == null) {
                                                    d4Var2.d = new HashMap();
                                                }
                                                d4Var2.d.put(lowerCase2, q(str2));
                                            }
                                            i14 = i10;
                                            c10 = '\'';
                                        }
