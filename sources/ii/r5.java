...
public final class r5 extends ViewGroup {
    ...
    public final TL_iv.pageTableCell a() {
        ...
        if (i6Var != null && i6Var.b != 0 && i6Var.c != 0) {
            ...
            while (i12 < size) {
                ...
                if (((LinkedHashSet) ((ei.d5) this.h).b).contains(pagetablecell3)) {
    ...
    public final void b() {
        int i10 = org.telegram.ui.ActionBar.h6.qh;
        org.telegram.ui.ActionBar.d6 d6Var = this.b;
        this.n.setColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        ...
        this.r.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.ph, d6Var));
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        i6 i6Var2 = this.a;
        RectF rectF = this.y;
        if (i6Var2 != null && i6Var2.b != 0 && i6Var2.c != 0) {
            ...
            float f12 = this.f[0];
            i6 i6Var3 = this.a;
            rectF.set(f11, f12, r2[i6Var3.c], r4[i6Var3.b]);
            Path path = this.F;
            path.rewind();
            ...
            for (int i19 = 0; i19 < getChildCount(); i19++) {
                ...
                if (childAt instanceof s5) {
                    s5 s5Var = (s5) childAt;
                    int b12 = this.a.b(s5Var.b);
                    int a11 = this.a.a(s5Var.b);
                    if (b12 >= 0 && a11 >= 0) {
                        int n10 = i6.n(s5Var.b);
                        int o9 = i6.o(s5Var.b);
                        int[] iArr3 = this.e;
                        int i20 = iArr3[a11];
                        int i21 = this.f[b12];
        ...
        i6 i6Var4 = this.a;
        if (i6Var4 != null && (pageblocktable = i6Var4.a) != null && pageblocktable.bordered) {
            Paint paint = this.n;
            ...
            int[] iArr7 = this.f;
            i6 i6Var5 = this.a;
            rectF.set(iArr6[0] + strokeWidth, iArr7[0] + strokeWidth, iArr6[i6Var5.c] - strokeWidth, iArr7[i6Var5.b] - strokeWidth);
            ...
            while (i24 < this.a.c) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[] pagetablecellArr = i6Var6.d[i27];
            ...
            for (int i28 = 1; i28 < this.a.b; i28++) {
                ...
                while (true) {
                    ...
                    TL_iv.pageTableCell[][] pagetablecellArr2 = i6Var7.d;
    ...
    public final boolean l() {
        ...
        if (i6Var != null && this.h != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                if (((LinkedHashSet) ((ei.d5) this.h).b).contains((TL_iv.pageTableCell) obj)) {
                    return true;
                }
            }
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt instanceof s5) {
                s5 s5Var = (s5) childAt;
                int b10 = this.a.b(s5Var.b);
                int a2 = this.a.a(s5Var.b);
                if (b10 >= 0 && a2 >= 0) {
                    int i15 = this.e[a2];
                    int i16 = this.f[b10];
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (i21 < getChildCount()) {
            ...
            if (childAt2 instanceof s5) {
                ...
                i1 i1Var2 = s5Var2.a;
                int n10 = i6.n(s5Var2.b);
                if (n10 > i12) {
                    int a10 = this.a.a(s5Var2.b);
        ...
        while (i30 < getChildCount()) {
            ...
            if (childAt3 instanceof s5) {
                ...
                int b11 = this.a.b(s5Var3.b);
                int a11 = this.a.a(s5Var3.b);
                int n11 = i6.n(s5Var3.b);
                i15 = i30;
                int i31 = 0;
                for (int i32 = a11; i32 < a11 + n11 && i32 < i17; i32++) {
                    i31 += this.c[i32];
                }
                s5Var3.measure(View.MeasureSpec.makeMeasureSpec(i31, TLObject.FLAG_30), makeMeasureSpec);
                if (i6.o(s5Var3.b) == 1) {
        ...
        for (int i33 = 0; i33 < getChildCount(); i33++) {
            ...
            if (childAt4 instanceof s5) {
                ...
                int b12 = this.a.b(s5Var4.b);
                int o9 = i6.o(s5Var4.b);
                if (o9 > 1) {
                    int i34 = b12;
                    int i35 = 0;
                    while (true) {
        ...
        while (i37 < getChildCount()) {
            ...
            if (childAt5 instanceof s5) {
                ...
                int b13 = this.a.b(s5Var5.b);
                int a12 = this.a.a(s5Var5.b);
                int n12 = i6.n(s5Var5.b);
                int o10 = i6.o(s5Var5.b);
                i13 = i37;
                int i38 = 0;
                ...
                s5Var5.measure(View.MeasureSpec.makeMeasureSpec(i38, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i40, TLObject.FLAG_30));
            } else {
                i13 = i37;
            }
            i37 = i13 + 1;
    ...
    public final boolean p(int i10, int i11) {
        q5 q5Var;
        i6 i6Var = this.a;
        if (i6Var == null || (q5Var = this.h) == null || i10 < 0 || i10 >= i6Var.b || i11 < 0 || i11 >= i6Var.c) {
            return false;
        }
        return ((LinkedHashSet) ((ei.d5) q5Var).b).contains(i6Var.d[i10][i11]);
    }
    ...
    public final void s() {
        ...
        int size = i6Var.g.size();
        for (int i10 = 0; i10 < size; i10++) {
            TL_iv.pageTableCell pagetablecell = (TL_iv.pageTableCell) this.a.g.get(i10);
            s5 s5Var = new s5(getContext(), this.b);
            s5Var.setCompact(this.a.a.compact);
            s5Var.b(pagetablecell);
            addView(s5Var);
        }
    }
