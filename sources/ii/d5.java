...
public abstract class d5 {
        ...
        while (i13 < size) {
            ...
            if (span == null && dj0Var == 0) {
                ...
                if (span != null) {
                    ...
                    pageblockpreformatted.text = g6.f(subSequence2);
                    String str = span.lng;
                    if (str == null) {
                        str = "";
                    }
        ...
        while (it.hasNext()) {
            ...
            if (pageBlock != null) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                    SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(g6.r(pageBlock.text, pageBlock, true));
                    ...
                    if (z10 || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                        spannableStringBuilder = h(g6.r(pageBlock.text, pageBlock, true), z10 ? ((TL_iv.pageBlockBlockquote) pageBlock).caption : ((TL_iv.pageBlockPullquote) pageBlock).caption);
                        ...
                        if (arrayList4 != null && !arrayList4.isEmpty()) {
                            ...
                            while (i10 < size) {
                                ...
                                SpannableStringBuilder r11 = pageListItem2 instanceof TL_iv.TL_pageListItemText ? g6.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true) : pageListItem2 instanceof TL_iv.TL_pageListItemBlocks ? c(((TL_iv.TL_pageListItemBlocks) pageListItem2).blocks) : null;
                                if (r11 != null) {
                        ...
                        SpannableStringBuilder r13 = g6.r(pageblocktable.title, null, true);
                            ...
                            while (i12 < size3) {
                                ...
                                if (arrayList10 != null && !arrayList10.isEmpty()) {
                                    ...
                                    for (int i13 = 0; i13 < pagetablerow2.cells.size(); i13++) {
                                        ...
                                        spannableStringBuilder5.append((CharSequence) g6.r(pagetablerow2.cells.get(i13).text, null, true));
                                    }
                        ...
                        ?? l4 = l(1, g6.r(pageBlock.text, pageBlock, true));
                        if (!TextUtils.isEmpty(l4)) {
                            spannableStringBuilder = l4;
                        }
                    } else if (pageBlock instanceof TL_iv.pageBlockAuthorDate) {
                        spannableStringBuilder = g6.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                        ...
                        spannableStringBuilder = g6.r(pageBlock.text, pageBlock, true);
                    } else if (pageBlock.caption != null) {
                        SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder();
                        SpannableStringBuilder r14 = g6.r(pageBlock.caption.text, null, true);
                        if (!TextUtils.isEmpty(r14)) {
                            spannableStringBuilder6.append((CharSequence) r14);
                        }
                        SpannableStringBuilder r15 = g6.r(pageBlock.caption.credit, null, true);
                            ...
                            if (arrayList2.size() + (z10 ? 1 : 0) <= 1 && (!z10 || (richText = ((TL_iv.pageBlockBlockquote) pageBlock).caption) == null || (richText instanceof TL_iv.textEmpty) || g6.l(richText).isEmpty())) {
                                if (hashMap != null && !arrayList2.isEmpty()) {
                                    ...
                                    while (i11 < size2) {
                                        ...
                                        if (richText2 != null && !(richText2 instanceof TL_iv.textEmpty) && !g6.l(richText2).isEmpty()) {
                                            break;
                                        }
                                    }
                                }
    ...
    public static SpannableStringBuilder i(a aVar, boolean z10) {
        ...
        if (z10) {
            TL_iv.PageBlock pageBlock = aVar.b;
            r10 = g6.r(pageBlock != null ? pageBlock.text : null, pageBlock, false);
        } else {
            TL_iv.PageBlock pageBlock2 = aVar.b;
            r10 = g6.r(pageBlock2 != null ? pageBlock2.text : null, pageBlock2, true);
        }
        ...
        while (list != null && i10 < list.size()) {
            ...
            if (aVar.k.isEmpty()) {
                ...
                if ((pageBlock instanceof TL_iv.pageBlockBlockquote) || (pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(z10 ? g6.r(pageBlock.text, pageBlock, false) : g6.r(pageBlock.text, pageBlock, true));
                    TL_iv.PageBlock pageBlock2 = aVar.b;
    ...
    public static SpannableStringBuilder k(ArrayList arrayList) {
        ...
        g6.o(spannableStringBuilder, 0, length, 65536, false, null);
        g6.o(spannableStringBuilder, 0, length, 16384, false, null);
        g6.o(spannableStringBuilder, 0, length, 32768, false, null);
