...
public final class v4 extends a0 implements org.telegram.ui.ActionBar.y5, q9, m0 {
    ...
    public v4(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        l0 l0Var = new l0(context, d6Var, new a6.i(this, 28));
        this.v = l0Var;
    ...
    public final ImageView h() {
        ...
        if (!this.H || Build.VERSION.SDK_INT < 31) {
            ...
            imageView.setBackground(new d2(org.telegram.ui.ActionBar.h6.Z(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), org.telegram.ui.ActionBar.h6.v(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.i6, d6Var)), 20, 20)));
        } else {
    ...
    public final void j(Canvas canvas) {
        ...
        Paint paint = v4Var.r;
        if (z10 && (((i10 = v4Var.W) == 0 && v4Var.a0 < 0.0f) || (i10 == arrayList.size() - 1 && v4Var.a0 > 0.0f))) {
        ...
        if (size == 1 && arrayList2.size() == 1) {
            ...
            if (rectF.left > 0.5f || rectF.right < max - 0.5f) {
                ...
                ImageReceiver imageReceiver = y4Var.b;
                if (y4Var.b()) {
                    imageReceiver.setImageCoords(rectF2);
                    imageReceiver.setAlpha(y4Var.a.getCurrentAlpha());
        ...
        while (i13 < arrayList.size() && i13 < arrayList2.size()) {
            y4 y4Var2 = (y4) arrayList.get(i13);
            ...
            if (z10) {
                ...
                int i17 = i13 == 0 ? dp : 0;
                y4Var2.a.setRoundRadius(i14, i15, i16, i17);
                y4Var2.b.setRoundRadius(i14, i15, i16, i17);
            } else {
                y4Var2.a.setRoundRadius(i11, i11, i11, i11);
                y4Var2.b.setRoundRadius(i11, i11, i11, i11);
            }
            boolean c10 = y4Var2.c();
            ImageReceiver imageReceiver2 = y4Var2.a;
            if (!c10) {
            ...
            if (uVar != null && uVar.a()) {
                ...
                radialProgress2.o(y4Var2.e.f, true);
                radialProgress2.draw(canvas2);
            }
            u uVar2 = y4Var2.e;
            if (uVar2 != null && uVar2.n && y4Var2.c()) {
                vh.g spoilerEffect = v4Var.getSpoilerEffect();
                ImageReceiver imageReceiver3 = y4Var2.b;
                canvas2.save();
    ...
    public final void k(int i10) {
        ...
        x3.N1(this.a, (u) m10.get(i10), this.N.a);
    }
    ...
    public final void n() {
        ...
        while (true) {
            ...
            y4 y4Var = new y4(this, this.n);
            if (this.O) {
                y4Var.a.onAttachedToWindow();
                y4Var.b.onAttachedToWindow();
                y4Var.a();
            }
            arrayList.add(y4Var);
        }
        while (arrayList.size() > m10.size()) {
            y4 y4Var2 = (y4) hg.c.z(1, arrayList);
            y4Var2.a.onDetachedFromWindow();
            y4Var2.b.onDetachedFromWindow();
            y4Var2.c = null;
        }
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ...
            y4 y4Var = (y4) arrayList.get(i10);
            y4Var.a.onDetachedFromWindow();
            y4Var.b.onDetachedFromWindow();
            y4Var.c = null;
            i10++;
        }
        vh.g gVar = this.M;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (arrayList.size() >= 2 && f12 > 0.001f) {
            ...
            int dp2 = AndroidUtilities.dp(4.0f) + org.telegram.messenger.z0.D(6.0f, size - 1, AndroidUtilities.dp(7.0f) * size);
        ...
        if (size3 == 0) {
            ...
            if (size3 != 1) {
                ...
                for (int i22 = 0; i22 < size3; i22++) {
                    y4 y4Var = (y4) arrayList3.get(i22);
                    int i23 = y4Var.e == null ? 0 : y4Var.d() ? y4Var.e.k : y4Var.e.j;
                    if (y4Var.e == null) {
                        i18 = 0;
                    } else {
                        boolean d10 = y4Var.d();
                ...
                for (int i45 = 0; i45 < size3; i45++) {
                    y4 y4Var2 = (y4) arrayList3.get(i45);
                    int i46 = y4Var2.e == null ? 0 : y4Var2.d() ? y4Var2.e.k : y4Var2.e.j;
                    if (y4Var2.e == null) {
                        i14 = 0;
                    } else {
                        boolean d11 = y4Var2.d();
                        u uVar2 = y4Var2.e;
            ...
            y4 y4Var3 = (y4) arrayList3.get(0);
            int i48 = y4Var3.e == null ? 0 : y4Var3.d() ? y4Var3.e.k : y4Var3.e.j;
            if (y4Var3.e == null) {
                i19 = 0;
            } else {
                boolean d12 = y4Var3.d();
                u uVar3 = y4Var3.e;
