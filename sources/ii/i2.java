...
public final class i2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, i2 i2Var) {
        if (richText == null) {
            return;
        }
        i2Var.a = f6.l(richText).length() + i2Var.a;
    ...
    public static void b(TL_iv.PageBlock pageBlock, int i10, i2 i2Var) {
        int i11;
        if (pageBlock == null) {
            return;
        }
        ...
        a(pageBlock.text, i10, i2Var);
        if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
            a(((TL_iv.pageBlockBlockquote) pageBlock).caption, i10, i2Var);
            return;
        }
        if (pageBlock instanceof TL_iv.pageBlockPullquote) {
            a(((TL_iv.pageBlockPullquote) pageBlock).caption, i10, i2Var);
            return;
        }
        int i12 = 0;
        if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
            TL_iv.pageBlockBlockquoteBlocks pageblockblockquoteblocks = (TL_iv.pageBlockBlockquoteBlocks) pageBlock;
            a(pageblockblockquoteblocks.caption, i10, i2Var);
            i2Var.b = pageblockblockquoteblocks.blocks.size() + i2Var.b;
            while (i12 < pageblockblockquoteblocks.blocks.size()) {
                b(pageblockblockquoteblocks.blocks.get(i12), i10 + 1, i2Var);
                i12++;
            }
            return;
        }
        if (pageBlock instanceof TL_iv.pageBlockDetails) {
            ...
            a(pageblockdetails.title, i10, i2Var);
            i2Var.b = pageblockdetails.blocks.size() + i2Var.b;
            while (i12 < pageblockdetails.blocks.size()) {
                b(pageblockdetails.blocks.get(i12), i10 + 1, i2Var);
                i12++;
            }
            return;
        }
        ...
        if (pageBlock instanceof TL_iv.pageBlockOrderedList) {
            ...
            i2Var.b = pageblockorderedlist.items.size() + i2Var.b;
            for (int i16 = 0; i16 < pageblockorderedlist.items.size(); i16++) {
                ...
                if (pageListOrderedItem instanceof TL_iv.TL_pageListOrderedItemText) {
                    a(((TL_iv.TL_pageListOrderedItemText) pageListOrderedItem).text, i17, i2Var);
                    ...
                    for (int i18 = 0; i18 < arrayList2.size(); i18++) {
                        b(arrayList2.get(i18), i17, i2Var);
                    }
                }
            }
            return;
        ...
        if (pageBlock instanceof TL_iv.pageBlockTable) {
            ...
            a(pageblocktable.title, i10, i2Var);
            ArrayList<TL_iv.pageTableRow> arrayList3 = pageblocktable.rows;
            if (arrayList3 != null) {
                i2Var.b = arrayList3.size() + i2Var.b;
                for (int i19 = 0; i19 < pageblocktable.rows.size(); i19++) {
                    ...
                    if (pagetablerow.cells != null) {
                        ...
                        for (int i20 = 0; i20 < pagetablerow.cells.size(); i20++) {
                            ...
                            i11 += h6.n(pagetablecell);
                            a(pagetablecell.text, i10 + 1, i2Var);
                        }
                    } else {
                        i11 = 0;
                    }
        ...
        if (pageBlock instanceof TL_iv.pageBlockButtonRow) {
            ...
            if (arrayList4 != null) {
                ...
                while (i12 < size) {
                    ...
                    if (pageButton2 != null) {
                        a(pageButton2.text, i10 + 1, i2Var);
                    }
                }
                return;
            }
        ...
        if (pageBlock instanceof TL_iv.pageBlockCollage) {
            ...
            if (pageCaption != null) {
                a(pageCaption.text, i10, i2Var);
                a(pageCaption.credit, i10, i2Var);
            }
            ArrayList<TL_iv.PageBlock> arrayList5 = ((TL_iv.pageBlockCollage) pageBlock).items;
            while (i12 < arrayList5.size()) {
                b(arrayList5.get(i12), i10 + 1, i2Var);
                i12++;
            }
            return;
        }
        ...
        a(pageCaption3.text, i10, i2Var);
        a(pageCaption3.credit, i10, i2Var);
    }
