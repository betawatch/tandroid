...
public class e extends AbstractCollection implements List {
    ...
    public void i() {
        ...
        if (eVar != null) {
            ...
            ((s8.e0) this.f).d.put(this.b, this.c);
        }
    }
    ...
    public void n() {
        ...
        if (eVar != null) {
            ...
            if (!this.c.isEmpty() || (collection = (Collection) ((s8.e0) this.f).d.get(this.b)) == null) {
                return;
            }
            this.c = collection;
        }
    ...
    public final List subList(int i10, int i11) {
        switch (this.a) {
            case 0:
                ...
                Object obj = this.b;
                return z4 ? new b(hVar, obj, subList, eVar) : new e(hVar, obj, subList, eVar);
            case 1:
                zzb();
                ...
                Object obj2 = this.b;
                return z10 ? new ee(mgVar, obj2, subList2, eVar2) : new e(mgVar, obj2, subList2, eVar2);
            default:
                n();
                ...
                Object obj3 = this.b;
                return z11 ? new s8.f(e0Var, obj3, subList3, eVar3) : new e(e0Var, obj3, subList3, eVar3);
        }
    }
        ...
        switch (this.a) {
            ...
            default:
                ...
                if (eVar2 != null) {
                    ...
                    if (this.c.isEmpty()) {
                        Collection collection2 = (Collection) ((mg) this.f).c.get(this.b);
                        if (collection2 != null) {
                            this.c = collection2;
                            return;
                        }
