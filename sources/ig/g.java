...
public abstract class g extends View implements i {
    ...
    public g(Context context, f6 f6Var) {
        ...
        this.L0 = new ValueAnimator.AnimatorUpdateListener(this) { // from class: ig.b
        ...
        this.M0 = new ValueAnimator.AnimatorUpdateListener(this) { // from class: ig.b
            public final /* synthetic */ g b;
    ...
    public kg.d f(int i10, long j3, long j10) {
        return new kg.d(j3, j10, this.P0, this.h0.h, i10, this.N, this.O);
    }
    ...
    */
    public void l(Canvas canvas, kg.d dVar) {
        float f7;
        int i10;
        int i11;
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void p(Canvas canvas, kg.d dVar) {
        float f7;
        int i10;
        int i11;
        TextPaint textPaint;
    ...
    public long r(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            if (((kg.f) arrayList.get(i12)).n) {
                long rMaxQ = ((kg.f) arrayList.get(i12)).a.b.rMaxQ(i10, i11);
                if (rMaxQ > j3) {
                    j3 = rMaxQ;
                }
            }
    ...
    public long s(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            if (((kg.f) arrayList.get(i12)).n) {
                long rMinQ = ((kg.f) arrayList.get(i12)).a.b.rMinQ(i10, i11);
                if (rMinQ < j3) {
                    j3 = rMinQ;
                }
            }
