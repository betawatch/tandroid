...
public final class j0 extends FrameLayout {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:191:0x0559, code lost:
        ...
        if (((int) org.telegram.messenger.rl.c(r23.x.b.getImageReceiver().getLottieAnimation().X, r23.x.b.getImageReceiver().getLottieAnimation().e[0], r8, r8)) < r6.b) goto L262;
     */
    ...
    */
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (m0Var.l) {
            ...
            if (f22 != 1.0f) {
                ...
                if (f23 > 1.0f) {
                    m0Var.m = 1.0f;
                    final int i11 = 0;
                    AndroidUtilities.runOnUIThread(new Runnable(this) { // from class: ig.i0
        ...
        if (view != null) {
            ...
            if (view instanceof s1) {
                ...
                if (view instanceof v0) {
                    o0Var = ((v0) view).y0.l(m0Var2.p);
                    paddingTop = view.getPaddingTop();
                } else {
                    if (view instanceof ug.d) {
                        f11 += ((ug.d) view).getReactionCenterX();
        ...
        } else if (!this.c && !(view instanceof ug.d)) {
            return;
        }
        float f27 = (view instanceof ug.d ? this.f : this.f - f25) / 2.0f;
        float f28 = f11 - f27;
        float f29 = f12 - f27;
        if (this.c && this.h == 0) {
        ...
        er erVar = er.f;
        float interpolation = erVar.getInterpolation(this.x.h);
        if (this.h == 2) {
            f14 = er.h.getInterpolation(interpolation);
            f15 = erVar.getInterpolation(interpolation);
            f13 = 2.0f;
        } else if (this.n) {
            f13 = 2.0f;
            f14 = er.h.getInterpolation(this.x.g);
            f15 = erVar.getInterpolation(this.x.g);
        } else {
            f13 = 2.0f;
            f14 = this.x.g;
            f15 = f14;
            ...
            if (i10 != 2) {
                ...
                if (!m0Var6.u || i10 != 0) {
                    ...
                    if (!this.x.x.isEmpty()) {
                        k0 k0Var3 = this.x.b;
                        if (k0Var3.C) {
                            oi0 lottieAnimation = k0Var3.getImageReceiver().getLottieAnimation();
                            int i15 = 0;
                            while (i15 < this.x.x.size()) {
                                ...
                                if (f35 >= 1.0f) {
                                    l0Var.l = a9.p.d(AndroidUtilities.dp(20.0f), 16.0f, 500.0f, l0Var.l);
                                }
                                if (l0Var.k) {
                                    float f46 = l0Var.j;
                                    float f47 = l0Var.i;
